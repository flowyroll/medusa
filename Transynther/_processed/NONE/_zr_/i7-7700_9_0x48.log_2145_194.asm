...
nop
sub $50990, %rdx
lea addresses_D_ht+0x17106, %rax
sub %r8, %r8
mov (%rax), %rsi
nop
nop
...
nop
and %rdx, %rdx
lea addresses_A_ht+0xdf06, %rax
nop
dec %rsi
movl $0x61626364, (%rax)
inc %rcx
lea addresses_UC_ht+0x12f86, %rcx
nop
sub %rdx, %rdx
mov (%rcx), %ax
nop
...
{'OP': 'LOAD', 'src': {'type': 'addresses_A', 'AVXalign': False, 'congruent': 0, 'size': 8, 'same': True, 'NT': False}}
<gen_prepare_buffer>
{'OP': 'STOR', 'dst': {'type': 'addresses_normal_ht', 'AVXalign': False, 'congruent': 5, 'size': 4, 'same': True, 'NT': False}}
