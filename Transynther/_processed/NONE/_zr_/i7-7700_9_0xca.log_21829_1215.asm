...
nop
sub $62139, %rcx
lea addresses_A_ht+0x1cbc5, %rdi
clflush (%rdi)
nop
nop
nop
...
nop
cmp $28816, %rcx
lea addresses_WC_ht+0xc7c5, %rdx
nop
xor $14325, %rcx
...
nop
add $15552, %rax
lea addresses_WC_ht+0x5fc5, %rdx
nop
nop
nop
cmp %rax, %rax
...
nop
and %rcx, %rcx
lea addresses_normal_ht+0x8fc5, %rsi
lea addresses_A_ht+0x14e45, %rdi
xor %r14, %r14
mov $93, %rcx
rep movsw
nop
...
nop
dec %rdx
lea addresses_WT_ht+0xa7f9, %rcx
nop
nop
dec %rsi
...
nop
cmp %r14, %r14
lea addresses_WC_ht+0x55c5, %r12
nop
nop
nop
cmp %rbx, %rbx
...
nop
cmp $2582, %r12
lea addresses_UC_ht+0x18b5, %rdx
nop
nop
cmp $39463, %rcx
...
nop
add %rbx, %rbx
lea addresses_WT_ht+0x192c5, %rsi
nop
nop
xor %rbx, %rbx
movups (%rsi), %xmm5
...
nop
sub %rax, %rax
lea addresses_WC_ht+0x11945, %rax
nop
nop
nop
xor $5147, %rsi
...
nop
cmp $33564, %rdx
lea addresses_WT_ht+0x14dc5, %rsi
lea addresses_WC_ht+0x19027, %rdi
nop
nop
xor $39625, %rax
mov $89, %rcx
...
nop
inc %rax
lea addresses_WT_ht+0x64a5, %rbx
nop
nop
nop
nop
...
nop
sub %rdx, %rdx
lea addresses_D_ht+0x16705, %rsi
lea addresses_UC_ht+0x187c5, %rdi
nop
nop
nop
dec %rax
...
{'OP': 'STOR', 'dst': {'congruent': 11, 'AVXalign': True, 'same': False, 'size': 4, 'NT': False, 'type': 'addresses_WC_ht'}}
{'src': {'congruent': 11, 'same': False, 'type': 'addresses_normal_ht'}, 'OP': 'REPM', 'dst': {'congruent': 7, 'same': False, 'type': 'addresses_A_ht'}}
{'OP': 'STOR', 'dst': {'congruent': 0, 'AVXalign': False, 'same': False, 'size': 8, 'NT': True, 'type': 'addresses_WT_ht'}}
...
{'src': {'congruent': 6, 'same': False, 'type': 'addresses_D_ht'}, 'OP': 'REPM', 'dst': {'congruent': 11, 'same': False, 'type': 'addresses_UC_ht'}}
{'00': 21829}
