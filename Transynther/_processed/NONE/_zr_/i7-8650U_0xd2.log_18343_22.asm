...
push %rdx
push %rsi
lea addresses_normal_ht+0x1da0d, %r14
clflush (%r14)
nop
nop
nop
...
nop
sub $42640, %r13
lea addresses_WC_ht+0x1340d, %rdx
clflush (%rdx)
nop
nop
nop
...
nop
add %r12, %r12
lea addresses_WT_ht+0x260d, %r12
nop
nop
nop
nop
...
nop
and %rsi, %rsi
lea addresses_WC_ht+0xfe6d, %rdi
nop
nop
nop
nop
...
movq %r13, (%rdi)
cmp %r14, %r14
lea addresses_normal_ht+0x1680d, %rsi
lea addresses_WC_ht+0x18dbd, %rdi
clflush (%rsi)
nop
nop
sub $12523, %r8
...
lea addresses_D_ht+0x11b8d, %rdi
clflush (%rsi)
nop
dec %r12
mov $95, %rcx
...
nop
and %r12, %r12
lea addresses_D_ht+0x700d, %rsi
lea addresses_UC_ht+0xe6ad, %rdi
nop
nop
nop
cmp $13011, %rdx
...
nop
cmp %rsi, %rsi
lea addresses_WC_ht+0x1a5cd, %rdi
xor $13925, %r12
movl $0x61626364, (%rdi)
nop
nop
...
lea addresses_D_ht+0x1c55d, %rdi
clflush (%rdi)
cmp $20589, %r14
mov $126, %rcx
rep movsl
...
nop
inc %r14
lea addresses_WT_ht+0x200d, %r14
clflush (%r14)
inc %r8
mov (%r14), %dx
nop
nop
sub %r14, %r14
lea addresses_WC_ht+0x1130d, %rsi
lea addresses_WT_ht+0xcc0d, %rdi
clflush (%rsi)
dec %r8
mov $92, %rcx
rep movsq
