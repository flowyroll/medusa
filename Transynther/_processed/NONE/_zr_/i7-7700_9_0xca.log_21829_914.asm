...
push %rdi
push %rsi
lea addresses_UC_ht+0x5394, %r10
nop
nop
add $21774, %r13
mov (%r10), %r14w
...
nop
xor $11870, %r14
lea addresses_normal_ht+0x1717c, %rsi
lea addresses_WT_ht+0x1b73c, %rdi
nop
nop
nop
nop
...
nop
dec %r13
lea addresses_WC_ht+0x10594, %rsi
lea addresses_D_ht+0xa150, %rdi
nop
nop
nop
xor $61664, %r14
...
nop
inc %r14
lea addresses_normal_ht+0x19314, %r14
nop
nop
inc %rdi
movb $0x61, (%r14)
nop
add $47136, %r14
lea addresses_UC_ht+0x9794, %rsi
nop
nop
nop
nop
...
nop
add $64686, %r13
lea addresses_WC_ht+0x19594, %rsi
nop
dec %r11
movb $0x61, (%rsi)
nop
...
nop
xor %rcx, %rcx
lea addresses_normal_ht+0x9f64, %rsi
nop
cmp $10696, %r14
movb (%rsi), %r11b
nop
...
nop
add $56578, %rsi
lea addresses_A_ht+0x1e664, %r13
nop
nop
nop
nop
...
nop
sub $27587, %r13
lea addresses_WT_ht+0x1c594, %rsi
lea addresses_D_ht+0xa854, %rdi
clflush (%rdi)
nop
xor $34778, %r14
mov $110, %rcx
...
nop
xor %r10, %r10
lea addresses_WC_ht+0x1b1c6, %rcx
nop
sub $38059, %rsi
mov (%rcx), %r10
nop
...
nop
xor %r11, %r11
lea addresses_D_ht+0x1923c, %r13
nop
nop
nop
nop
...
nop
and %rdi, %rdi
lea addresses_WC_ht+0xcf94, %rcx
nop
nop
nop
nop
...
mov (%rcx), %r10
and $2095, %r14
lea addresses_WT_ht+0x18594, %r10
nop
nop
nop
sub $29642, %rcx
...
{'OP': 'STOR', 'dst': {'congruent': 5, 'AVXalign': True, 'same': False, 'size': 1, 'NT': False, 'type': 'addresses_normal_ht'}}
...
{'src': {'congruent': 11, 'same': False, 'type': 'addresses_WT_ht'}, 'OP': 'REPM', 'dst': {'congruent': 5, 'same': False, 'type': 'addresses_D_ht'}}
