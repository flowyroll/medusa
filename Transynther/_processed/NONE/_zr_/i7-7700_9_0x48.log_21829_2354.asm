...
nop
inc %rdi
lea addresses_UC_ht+0xef8e, %rbx
nop
nop
nop
inc %r9
...
nop
dec %rdi
lea addresses_WT_ht+0x1ca0e, %rsi
lea addresses_UC_ht+0x326e, %rdi
nop
nop
nop
nop
...
nop
and $19355, %rcx
lea addresses_A_ht+0x1dcce, %rsi
lea addresses_WT_ht+0x135ce, %rdi
clflush (%rdi)
nop
nop
nop
...
rep movsq
and %r9, %r9
lea addresses_UC_ht+0xa1ce, %rcx
nop
nop
nop
nop
...
nop
inc %r13
lea addresses_UC_ht+0xb20e, %r10
nop
xor $50637, %rcx
...
nop
dec %rax
lea addresses_UC_ht+0x2d8e, %rax
nop
nop
nop
nop
...
nop
sub $60682, %rbx
lea addresses_WC_ht+0xc1f4, %rax
xor $47457, %r9
mov (%rax), %ebx
nop
nop
...
nop
add $21359, %r13
lea addresses_A_ht+0xda2e, %rsi
lea addresses_UC_ht+0x83ce, %rdi
nop
nop
nop
nop
...
<gen_prepare_buffer>
{'OP': 'LOAD', 'src': {'type': 'addresses_A_ht', 'AVXalign': False, 'congruent': 10, 'size': 8, 'same': False, 'NT': True}}
...
{'OP': 'REPM', 'src': {'type': 'addresses_WT_ht', 'congruent': 6, 'same': False}, 'dst': {'type': 'addresses_UC_ht', 'congruent': 5, 'same': False}}
...
{'OP': 'REPM', 'src': {'type': 'addresses_A_ht', 'congruent': 3, 'same': False}, 'dst': {'type': 'addresses_UC_ht', 'congruent': 6, 'same': False}}
{'00': 21829}
