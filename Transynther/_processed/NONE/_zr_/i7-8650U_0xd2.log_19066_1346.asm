...
push %rdx
push %rsi
lea addresses_UC_ht+0x15117, %r12
nop
and %rbx, %rbx
...
nop
xor $50667, %rbp
lea addresses_D_ht+0x1dc97, %rsi
lea addresses_WT_ht+0x90b7, %rdi
clflush (%rdi)
nop
and %rdx, %rdx
mov $101, %rcx
...
nop
inc %rdx
lea addresses_D_ht+0x15917, %rbx
nop
nop
sub %rdi, %rdi
...
nop
and $14117, %rsi
lea addresses_WC_ht+0x53c7, %rsi
lea addresses_D_ht+0x18d97, %rdi
cmp %rbx, %rbx
mov $81, %rcx
rep movsl
nop
...
nop
add $28556, %r12
lea addresses_WT_ht+0x3b17, %rdx
xor $16405, %rsi
movl $0x61626364, (%rdx)
nop
nop
...
{'OP': 'REPM', 'src': {'type': 'addresses_D_ht', 'congruent': 6, 'same': True}, 'dst': {'type': 'addresses_WT_ht', 'congruent': 5, 'same': False}}
{'OP': 'STOR', 'dst': {'type': 'addresses_D_ht', 'size': 8, 'AVXalign': False, 'NT': False, 'congruent': 10, 'same': False}}
{'OP': 'REPM', 'src': {'type': 'addresses_WC_ht', 'congruent': 2, 'same': False}, 'dst': {'type': 'addresses_D_ht', 'congruent': 7, 'same': True}}
