...
nop
inc %r10
lea addresses_A_ht+0x17971, %r14
nop
cmp $34279, %r10
mov (%r14), %r15w
inc %rax
lea addresses_A_ht+0xdff1, %rsi
lea addresses_UC_ht+0xdb71, %rdi
nop
nop
sub $39936, %r15
mov $45, %rcx
...
nop
and %rsi, %rsi
lea addresses_UC_ht+0x5371, %rsi
lea addresses_WT_ht+0x1f11, %rdi
nop
nop
cmp $14131, %r14
mov $41, %rcx
...
nop
dec %r15
lea addresses_WC_ht+0x84cf, %rsi
...
nop
sub %r15, %r15
lea addresses_WC_ht+0x16007, %r11
nop
dec %rbx
...
nop
dec %rsi
lea addresses_normal_ht+0x13671, %r15
nop
nop
inc %r14
movw $0x6162, (%r15)
...
nop
mfence
lea addresses_D_ht+0xb071, %rsi
lea addresses_A_ht+0x2421, %rdi
nop
nop
nop
nop
...
nop
xor %r10, %r10
lea addresses_D_ht+0x5811, %rsi
lea addresses_normal_ht+0x7bd1, %rdi
nop
nop
nop
nop
...
nop
dec %rsi
lea addresses_WC_ht+0x75d1, %rsi
lea addresses_normal_ht+0x1d371, %rdi
nop
nop
nop
nop
...
nop
add $13571, %rdi
lea addresses_D_ht+0x14b71, %rsi
lea addresses_D_ht+0x6b71, %rdi
nop
nop
nop
nop
...
// Load
lea addresses_normal+0x1da31, %r10
nop
nop
nop
nop
...
{'OP': 'REPM', 'src': {'type': 'addresses_UC_ht', 'congruent': 10, 'same': False}, 'dst': {'type': 'addresses_WT_ht', 'congruent': 5, 'same': True}}
...
{'OP': 'REPM', 'src': {'type': 'addresses_D_ht', 'congruent': 5, 'same': False}, 'dst': {'type': 'addresses_normal_ht', 'congruent': 5, 'same': True}}
{'OP': 'REPM', 'src': {'type': 'addresses_WC_ht', 'congruent': 4, 'same': True}, 'dst': {'type': 'addresses_normal_ht', 'congruent': 11, 'same': False}}
