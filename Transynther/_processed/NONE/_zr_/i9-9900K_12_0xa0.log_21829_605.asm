...
push %rdi
push %rsi
lea addresses_normal_ht+0x10d7d, %rsi
lea addresses_WT_ht+0x517d, %rdi
nop
nop
nop
and $41965, %r15
...
nop
add %rbp, %rbp
lea addresses_WT_ht+0x13d7d, %r10
nop
nop
sub %r9, %r9
movw $0x6162, (%r10)
cmp $9040, %rbp
lea addresses_WC_ht+0x937d, %r15
nop
nop
nop
dec %rcx
...
<gen_prepare_buffer>
{'src': {'same': False, 'congruent': 10, 'type': 'addresses_normal_ht'}, 'OP': 'REPM', 'dst': {'same': False, 'congruent': 9, 'type': 'addresses_WT_ht'}}
{'OP': 'STOR', 'dst': {'NT': False, 'same': False, 'congruent': 8, 'type': 'addresses_WT_ht', 'AVXalign': True, 'size': 2}}
