...
nop
and $6578, %rbx
lea addresses_WT_ht+0x13449, %rcx
nop
nop
nop
nop
...
nop
and %r10, %r10
lea addresses_WC_ht+0x1d523, %r10
nop
xor %rdi, %rdi
movb (%r10), %bl
nop
...
nop
and $29100, %rsi
lea addresses_WC_ht+0x15ab9, %r9
nop
nop
nop
nop
...
{'OP': 'STOR', 'dst': {'type': 'addresses_WC_ht', 'size': 4, 'AVXalign': False, 'NT': False, 'congruent': 3, 'same': True}}
{'00': 21829}
