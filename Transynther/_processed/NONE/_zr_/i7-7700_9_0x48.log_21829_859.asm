...
push %rdi
push %rsi
lea addresses_UC_ht+0x1ded2, %rax
clflush (%rax)
nop
nop
xor $38484, %r11
...
nop
dec %r9
lea addresses_WC_ht+0x7e1f, %r8
nop
dec %r14
movl $0x61626364, (%r8)
sub %r8, %r8
lea addresses_WT_ht+0xfe1f, %r14
xor %r15, %r15
mov (%r14), %rsi
nop
nop
nop
sub %rsi, %rsi
lea addresses_UC_ht+0x1df87, %r14
nop
nop
nop
add $64514, %r9
...
nop
xor %r14, %r14
lea addresses_normal_ht+0xe6c7, %rax
nop
sub %r15, %r15
movups (%rax), %xmm5
vpextrq $1, %xmm5, %r11
sub %r9, %r9
lea addresses_normal_ht+0x10013, %rsi
lea addresses_WT_ht+0x8bba, %rdi
nop
nop
nop
nop
...
nop
and %r11, %r11
lea addresses_normal_ht+0x13890, %r9
sub $38028, %r8
movb $0x61, (%r9)
nop
nop
and $35245, %r8
lea addresses_UC_ht+0x1581b, %rsi
add $54040, %r15
mov (%rsi), %r14w
nop
nop
...
{'OP': 'LOAD', 'src': {'type': 'addresses_UC_ht', 'AVXalign': False, 'congruent': 2, 'size': 2, 'same': True, 'NT': False}}
