...
push %rbx
push %rsi
lea addresses_WT_ht+0x1bb3, %r14
nop
nop
nop
nop
...
nop
sub %r8, %r8
lea addresses_WT_ht+0x39f3, %r11
nop
nop
nop
sub $58041, %rsi
...
nop
and $8081, %r11
lea addresses_WC_ht+0x146f3, %r11
clflush (%r11)
nop
nop
nop
...
nop
inc %r13
lea addresses_WC_ht+0x1b753, %rbx
nop
nop
add %r11, %r11
...
vmovups %ymm3, (%rbx)
sub %r8, %r8
lea addresses_A_ht+0x1ce73, %r10
nop
xor %r13, %r13
movb $0x61, (%r10)
cmp $41341, %r13
lea addresses_WC_ht+0x152f3, %r14
nop
nop
nop
nop
