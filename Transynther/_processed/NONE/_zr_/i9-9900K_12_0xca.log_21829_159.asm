...
nop
sub $33744, %rdx
lea addresses_WC_ht+0x6b75, %rsi
lea addresses_WC_ht+0x10088, %rdi
clflush (%rsi)
nop
nop
nop
...
nop
sub $45743, %rcx
lea addresses_WT_ht+0x7eda, %rdx
nop
inc %rbx
movb (%rdx), %r14b
nop
...
nop
add $53355, %rbx
lea addresses_UC_ht+0x1b590, %rsi
lea addresses_WC_ht+0x698, %rdi
add $34333, %r9
mov $36, %rcx
rep movsl
nop
...
nop
dec %r14
lea addresses_WC_ht+0x58d0, %r13
nop
nop
nop
nop
...
nop
inc %rcx
lea addresses_D_ht+0x1b0d0, %rdi
nop
nop
inc %r9
movb $0x61, (%rdi)
...
nop
add $6444, %rdx
lea addresses_WC_ht+0xc9d0, %rsi
lea addresses_normal_ht+0x15f19, %rdi
dec %rbx
mov $124, %rcx
rep movsw
nop
...
nop
dec %rsi
lea addresses_UC_ht+0x1e4d0, %rbx
clflush (%rbx)
and %rsi, %rsi
...
nop
cmp $37239, %r13
lea addresses_D_ht+0x138d0, %r14
nop
nop
nop
nop
...
{'OP': 'REPM', 'src': {'same': False, 'type': 'addresses_WC_ht', 'congruent': 0}, 'dst': {'same': True, 'type': 'addresses_WC_ht', 'congruent': 3}}
{'OP': 'LOAD', 'src': {'size': 1, 'NT': True, 'type': 'addresses_WT_ht', 'same': False, 'AVXalign': False, 'congruent': 1}}
{'OP': 'REPM', 'src': {'same': False, 'type': 'addresses_UC_ht', 'congruent': 6}, 'dst': {'same': False, 'type': 'addresses_WC_ht', 'congruent': 3}}
...
{'OP': 'STOR', 'dst': {'size': 8, 'NT': False, 'type': 'addresses_UC_ht', 'same': True, 'AVXalign': False, 'congruent': 11}}
