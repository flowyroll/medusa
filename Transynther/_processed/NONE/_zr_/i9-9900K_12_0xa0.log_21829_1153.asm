...
nop
sub %r9, %r9
lea addresses_A_ht+0x1a557, %rsi
lea addresses_WT_ht+0x19097, %rdi
nop
xor %r8, %r8
mov $112, %rcx
rep movsw
...
nop
add $245, %r14
lea addresses_A_ht+0x13d97, %rsi
lea addresses_A_ht+0x123b7, %rdi
nop
nop
and %r14, %r14
mov $2, %rcx
...
lea addresses_WT_ht+0x93a7, %rdi
clflush (%rdi)
nop
nop
add $59378, %r8
...
nop
xor %r8, %r8
lea addresses_D_ht+0x1b337, %rsi
nop
nop
nop
dec %r9
...
{'src': {'same': False, 'congruent': 5, 'type': 'addresses_A_ht'}, 'OP': 'REPM', 'dst': {'same': False, 'congruent': 5, 'type': 'addresses_WT_ht'}}
{'src': {'same': False, 'congruent': 0, 'type': 'addresses_A_ht'}, 'OP': 'REPM', 'dst': {'same': False, 'congruent': 11, 'type': 'addresses_A_ht'}}
{'src': {'same': False, 'congruent': 9, 'type': 'addresses_normal_ht'}, 'OP': 'REPM', 'dst': {'same': False, 'congruent': 2, 'type': 'addresses_WT_ht'}}
