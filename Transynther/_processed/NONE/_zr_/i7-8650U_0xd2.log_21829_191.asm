...
push %rdi
push %rsi
lea addresses_normal_ht+0x11698, %r13
nop
nop
nop
nop
...
nop
inc %r10
lea addresses_WC_ht+0x18847, %r13
nop
nop
nop
nop
...
nop
sub %rbp, %rbp
lea addresses_WC_ht+0x7d47, %r13
sub $17357, %rcx
movb (%r13), %r10b
nop
nop
xor %r13, %r13
lea addresses_normal_ht+0x16a0d, %rsi
lea addresses_WT_ht+0x1cec7, %rdi
nop
nop
cmp %r9, %r9
mov $101, %rcx
