...
push %rdx
push %rsi
lea addresses_WT_ht+0x15bb4, %rsi
lea addresses_UC_ht+0x16e74, %rdi
nop
nop
nop
nop
...
nop
sub %rbx, %rbx
lea addresses_UC_ht+0x15574, %rdi
nop
nop
nop
nop
...
nop
dec %rdi
lea addresses_UC_ht+0x15674, %rsi
lea addresses_WT_ht+0x18e74, %rdi
nop
nop
dec %rdx
mov $84, %rcx
...
movl $0x61626364, (%rbx)
cmp %rdi, %rdi
lea addresses_A_ht+0x1e0d4, %r10
nop
nop
nop
nop
...
{'OP': 'REPM', 'src': {'type': 'addresses_UC_ht', 'congruent': 10, 'same': False}, 'dst': {'type': 'addresses_WT_ht', 'congruent': 11, 'same': False}}
{'OP': 'STOR', 'dst': {'type': 'addresses_A_ht', 'size': 4, 'AVXalign': False, 'NT': True, 'congruent': 5, 'same': False}}
