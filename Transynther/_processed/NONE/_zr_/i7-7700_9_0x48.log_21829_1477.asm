...
nop
cmp %r8, %r8
lea addresses_A_ht+0xc1eb, %r9
nop
cmp %rsi, %rsi
movb $0x61, (%r9)
dec %r9
lea addresses_A_ht+0x41eb, %r9
add $18202, %r10
...
lea addresses_A_ht+0x13eeb, %rdi
nop
nop
nop
nop
...
movw $0x6162, (%r13)
cmp $58002, %r9
lea addresses_D_ht+0x1bf83, %r14
nop
sub %r8, %r8
