...
nop
cmp $52843, %rbx
lea addresses_WC_ht+0x9248, %rsi
lea addresses_WC_ht+0xea97, %rdi
nop
nop
nop
nop
...
{'OP': 'REPM', 'src': {'same': False, 'type': 'addresses_WC_ht', 'congruent': 6}, 'dst': {'same': False, 'type': 'addresses_WC_ht', 'congruent': 0}}
{'00': 21829}
