...
push %rdi
push %rsi
lea addresses_UC_ht+0x135eb, %r9
inc %rax
vmovups (%r9), %ymm7
...
nop
xor %rax, %rax
lea addresses_A_ht+0x17601, %rbx
nop
nop
cmp %r15, %r15
movb $0x61, (%rbx)
cmp %rbx, %rbx
lea addresses_normal_ht+0x35, %rsi
lea addresses_normal_ht+0xf835, %rdi
nop
nop
nop
nop
...
nop
inc %r9
lea addresses_WC_ht+0x124b5, %r15
nop
nop
cmp %rdi, %rdi
movb (%r15), %al
...
nop
cmp $38446, %rax
lea addresses_D_ht+0x17161, %rsi
nop
xor $9389, %rax
movups (%rsi), %xmm7
vpextrq $1, %xmm7, %rcx
