...
push %rdi
push %rsi
lea addresses_WT_ht+0xc2ff, %rsi
lea addresses_D_ht+0x1812f, %rdi
nop
nop
nop
nop
...
rep movsb
inc %rcx
lea addresses_normal_ht+0x13daf, %rsi
lea addresses_D_ht+0x18f45, %rdi
clflush (%rdi)
dec %r14
mov $96, %rcx
rep movsw
...
nop
cmp %rsi, %rsi
lea addresses_WT_ht+0x19c2f, %rdi
nop
nop
nop
xor $49678, %rax
...
nop
inc %rdi
lea addresses_UC_ht+0x17c2f, %rax
nop
nop
nop
nop
...
nop
add %rbx, %rbx
lea addresses_D_ht+0x153af, %rdi
nop
nop
nop
nop
...
nop
xor $27868, %r14
lea addresses_D_ht+0x1c45b, %rsi
xor $1808, %rax
mov (%rsi), %di
xor %r11, %r11
pop %rsi
