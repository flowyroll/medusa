...
push %rdx
push %rsi
lea addresses_UC_ht+0xe782, %r14
nop
nop
nop
sub %rdi, %rdi
...
nop
cmp $44259, %r14
lea addresses_WT_ht+0x112ba, %rsi
...
nop
and $40326, %rcx
lea addresses_D_ht+0x11fda, %r14
xor $63468, %r8
mov $0x6162636465666768, %rbp
movq %rbp, (%r14)
dec %rdx
lea addresses_A_ht+0x79da, %r8
nop
nop
nop
nop
...
nop
cmp $2949, %rcx
lea addresses_normal_ht+0x18baa, %rsi
nop
nop
nop
xor %rdx, %rdx
...
nop
sub %rbp, %rbp
lea addresses_D_ht+0x97da, %r8
mfence
mov (%r8), %dx
nop
and %r8, %r8
lea addresses_A_ht+0xb87a, %rcx
nop
nop
nop
nop
...
nop
and $48125, %r8
lea addresses_D_ht+0x1ec8a, %r14
nop
nop
nop
nop
...
nop
sub %r14, %r14
lea addresses_WC_ht+0x52da, %rbx
clflush (%rbx)
nop
inc %r8
movw $0x6162, (%rbx)
...
nop
and %rcx, %rcx
lea addresses_normal_ht+0x37da, %r14
nop
nop
cmp %r8, %r8
mov (%r14), %cx
...
nop
mfence
lea addresses_WT_ht+0x1953a, %rbp
clflush (%rbp)
nop
sub $23081, %rsi
movw $0x6162, (%rbp)
