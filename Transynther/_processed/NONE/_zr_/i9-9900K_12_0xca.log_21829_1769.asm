...
lea addresses_D_ht+0x11cc8, %rdi
nop
nop
nop
nop
...
rep movsl
add %rdx, %rdx
lea addresses_normal_ht+0x21c8, %rbx
nop
nop
nop
nop
...
nop
and %rdi, %rdi
lea addresses_UC_ht+0x73c8, %rbx
nop
nop
nop
nop
...
nop
xor %r14, %r14
lea addresses_UC_ht+0x112e8, %rcx
nop
nop
xor $49317, %rsi
vmovups (%rcx), %ymm1
...
nop
dec %rcx
lea addresses_normal_ht+0x9472, %rdi
nop
nop
nop
nop
...
nop
sub $3742, %rcx
lea addresses_UC_ht+0x1d44e, %rsi
lea addresses_WT_ht+0x1dbc8, %rdi
nop
nop
nop
nop
...
nop
xor $6034, %rdi
lea addresses_normal_ht+0x1dc8, %rsi
inc %r9
mov (%rsi), %edx
nop
xor %r9, %r9
lea addresses_WT_ht+0x11b3a, %rsi
...
nop
cmp $50746, %rax
lea addresses_WT_ht+0xf948, %rsi
lea addresses_WC_ht+0xd448, %rdi
nop
nop
nop
cmp $41098, %rdx
...
nop
dec %rdi
lea addresses_D_ht+0x1ce28, %rbx
nop
nop
nop
cmp $55903, %r14
...
{'OP': 'REPM', 'src': {'same': False, 'type': 'addresses_UC_ht', 'congruent': 1}, 'dst': {'same': True, 'type': 'addresses_WT_ht', 'congruent': 11}}
...
{'OP': 'REPM', 'src': {'same': False, 'type': 'addresses_WT_ht', 'congruent': 4}, 'dst': {'same': False, 'type': 'addresses_WC_ht', 'congruent': 7}}
