...
nop
dec %rax
lea addresses_D_ht+0xd98a, %rsi
lea addresses_A_ht+0xc68a, %rdi
nop
nop
nop
nop
...
nop
and $59760, %r14
lea addresses_D_ht+0x16bce, %rcx
nop
nop
add %rdx, %rdx
movups (%rcx), %xmm1
...
nop
xor %rax, %rax
lea addresses_WT_ht+0xa88a, %rsi
lea addresses_WC_ht+0xda2a, %rdi
nop
nop
nop
nop
...
nop
inc %r15
lea addresses_WC_ht+0x240a, %rsi
nop
dec %rax
...
nop
sub $52534, %rsi
lea addresses_UC_ht+0xce8a, %rsi
lea addresses_UC_ht+0x3ba, %rdi
nop
nop
and %rdx, %rdx
mov $101, %rcx
...
nop
add $43997, %rdx
lea addresses_WC_ht+0x1078e, %rbx
add $49928, %rsi
movw $0x6162, (%rbx)
nop
nop
add %rsi, %rsi
lea addresses_D_ht+0xa48a, %rbx
nop
nop
add $16463, %r14
movups (%rbx), %xmm4
...
nop
cmp %rax, %rax
lea addresses_UC_ht+0x6496, %rsi
lea addresses_WC_ht+0x1825d, %rdi
nop
xor $24669, %r15
mov $58, %rcx
rep movsb
and %rdx, %rdx
lea addresses_WT_ht+0x308a, %rsi
...
rep movsw
add %rdx, %rdx
lea addresses_WT_ht+0x9c0a, %rax
nop
nop
sub %r14, %r14
movw $0x6162, (%rax)
...
nop
sub $36474, %rdi
lea addresses_A_ht+0x88ea, %rsi
lea addresses_WT_ht+0xfe8a, %rdi
nop
dec %rbx
mov $9, %rcx
rep movsq
...
nop
xor $44779, %rbx
lea addresses_WT_ht+0x85d6, %rsi
nop
nop
nop
nop
...
nop
inc %r14
lea addresses_normal_ht+0x14cca, %rsi
lea addresses_D_ht+0x4fd2, %rdi
clflush (%rsi)
clflush (%rdi)
nop
nop
...
{'OP': 'LOAD', 'src': {'type': 'addresses_WC_ht', 'AVXalign': True, 'congruent': 7, 'size': 16, 'same': False, 'NT': False}}
...
{'OP': 'STOR', 'dst': {'type': 'addresses_WT_ht', 'AVXalign': False, 'congruent': 7, 'size': 2, 'same': False, 'NT': True}}
...
{'OP': 'REPM', 'src': {'type': 'addresses_normal_ht', 'congruent': 6, 'same': False}, 'dst': {'type': 'addresses_D_ht', 'congruent': 1, 'same': True}}
{'00': 21829}
