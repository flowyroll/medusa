...
nop
xor %rcx, %rcx
lea addresses_WT_ht+0x18c8, %r13
sub $6302, %rbp
...
nop
inc %rdi
lea addresses_WT_ht+0xa5e0, %rsi
cmp %rdi, %rdi
mov (%rsi), %r8d
nop
nop
...
vpextrq $0, %xmm3, %rcx
inc %rcx
lea addresses_normal_ht+0x96c8, %rbx
nop
nop
nop
inc %rdi
...
nop
xor $41561, %r14
lea addresses_A_ht+0x17cc8, %rsi
lea addresses_D_ht+0x40c8, %rdi
clflush (%rdi)
nop
nop
nop
...
nop
and $23057, %r8
lea addresses_D_ht+0x2ec8, %rsi
lea addresses_UC_ht+0x16fe0, %rdi
nop
nop
nop
and $23428, %r13
...
nop
dec %rdi
lea addresses_normal_ht+0x11cc8, %r14
nop
nop
nop
cmp $19364, %rbp
...
{'OP': 'LOAD', 'src': {'type': 'addresses_A_ht', 'AVXalign': True, 'congruent': 7, 'size': 1, 'same': False, 'NT': False}}
...
{'OP': 'LOAD', 'src': {'type': 'addresses_A_ht', 'AVXalign': True, 'congruent': 3, 'size': 32, 'same': False, 'NT': True}}
