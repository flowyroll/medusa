...
nop
cmp %rbp, %rbp
lea addresses_WC_ht+0xf64c, %rbp
nop
nop
nop
nop
...
nop
cmp $11900, %rcx
lea addresses_normal_ht+0x1572c, %r14
clflush (%r14)
nop
nop
nop
...
nop
cmp $13648, %rbp
lea addresses_WC_ht+0x1ebcc, %rbp
nop
nop
nop
nop
...
nop
cmp %rbp, %rbp
lea addresses_A_ht+0x157fd, %rsi
lea addresses_D_ht+0xc3dc, %rdi
clflush (%rdi)
nop
nop
nop
...
nop
and $46415, %rcx
lea addresses_WC_ht+0x1e24c, %r14
nop
inc %r12
movb $0x61, (%r14)
nop
nop
add %r14, %r14
lea addresses_UC_ht+0xaa4c, %rsi
lea addresses_A_ht+0x24c, %rdi
nop
nop
nop
xor $45712, %r8
...
rep movsb
add %r8, %r8
lea addresses_UC_ht+0x62b8, %rax
nop
nop
nop
nop
...
{'src': {'congruent': 0, 'same': False, 'type': 'addresses_A_ht'}, 'OP': 'REPM', 'dst': {'congruent': 4, 'same': False, 'type': 'addresses_D_ht'}}
