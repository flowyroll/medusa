...
push %rdi
push %rsi
lea addresses_UC_ht+0x10c0a, %rbp
nop
nop
nop
xor %rsi, %rsi
...
nop
xor %r10, %r10
lea addresses_normal_ht+0x5ba2, %r13
nop
nop
nop
xor $10295, %r15
...
nop
inc %r10
lea addresses_UC_ht+0x12082, %rsi
lea addresses_WT_ht+0x17842, %rdi
nop
nop
nop
nop
...
rep movsb
add %r8, %r8
lea addresses_normal_ht+0x5642, %rsi
lea addresses_D_ht+0x10442, %rdi
nop
nop
nop
add $55430, %r13
...
rep movsq
sub %rsi, %rsi
lea addresses_A_ht+0x1b282, %rcx
nop
nop
nop
nop
...
movw $0x6162, (%rsi)
dec %r12
lea addresses_WT_ht+0x4442, %rsi
lea addresses_normal_ht+0x10a7a, %rdi
nop
nop
xor $38685, %r10
mov $30, %rcx
...
nop
dec %r12
lea addresses_UC_ht+0xe208, %r10
nop
nop
nop
xor %rcx, %rcx
...
nop
cmp $39381, %r13
lea addresses_UC_ht+0xf042, %rsi
lea addresses_normal_ht+0x15042, %rdi
nop
nop
cmp $39214, %r8
mov $77, %rcx
...
{'src': {'congruent': 4, 'AVXalign': False, 'same': False, 'size': 8, 'NT': False, 'type': 'addresses_WC'}, 'OP': 'LOAD'}
...
{'src': {'congruent': 9, 'same': True, 'type': 'addresses_normal_ht'}, 'OP': 'REPM', 'dst': {'congruent': 10, 'same': False, 'type': 'addresses_D_ht'}}
...
{'src': {'congruent': 10, 'same': False, 'type': 'addresses_WT_ht'}, 'OP': 'REPM', 'dst': {'congruent': 3, 'same': False, 'type': 'addresses_normal_ht'}}
