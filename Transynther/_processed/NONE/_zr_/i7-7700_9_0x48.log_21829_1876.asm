...
push %rdx
push %rsi
lea addresses_WC_ht+0x13b3f, %r11
nop
nop
xor $13760, %rax
movb $0x61, (%r11)
...
nop
sub $55419, %r8
lea addresses_WC_ht+0x978f, %r11
nop
nop
add $1374, %rax
mov (%r11), %bx
...
nop
add %rbp, %rbp
lea addresses_WT_ht+0x17257, %r15
nop
nop
dec %rbx
mov (%r15), %r11
xor $63930, %r11
lea addresses_normal_ht+0xde7f, %rsi
lea addresses_A_ht+0x1761f, %rdi
clflush (%rsi)
nop
nop
nop
...
nop
dec %r11
lea addresses_D_ht+0x69f, %rdx
nop
nop
cmp $59267, %rcx
movb $0x61, (%rdx)
sub $60338, %rdx
lea addresses_UC_ht+0x1332f, %r8
nop
nop
inc %rsi
...
nop
xor %r11, %r11
lea addresses_UC_ht+0x1e79f, %rsi
lea addresses_WC_ht+0x1d39f, %rdi
clflush (%rsi)
nop
nop
nop
...
nop
and %rax, %rax
lea addresses_WT_ht+0x8b9f, %rsi
nop
nop
xor %r15, %r15
mov (%rsi), %eax
...
nop
dec %r8
lea addresses_WT_ht+0x7d5f, %rsi
nop
nop
nop
nop
...
nop
xor %rax, %rax
lea addresses_normal_ht+0x151ff, %rsi
lea addresses_A_ht+0x18ccf, %rdi
nop
nop
nop
nop
...
// Store
lea addresses_normal+0x567f, %r11
nop
nop
nop
nop
...
<gen_prepare_buffer>
{'OP': 'STOR', 'dst': {'type': 'addresses_WC_ht', 'AVXalign': True, 'congruent': 1, 'size': 1, 'same': False, 'NT': False}}
{'OP': 'STOR', 'dst': {'type': 'addresses_D_ht', 'AVXalign': False, 'congruent': 8, 'size': 2, 'same': False, 'NT': False}}
{'OP': 'LOAD', 'src': {'type': 'addresses_WC_ht', 'AVXalign': True, 'congruent': 1, 'size': 2, 'same': False, 'NT': False}}
{'OP': 'LOAD', 'src': {'type': 'addresses_WT_ht', 'AVXalign': False, 'congruent': 2, 'size': 8, 'same': False, 'NT': False}}
{'OP': 'REPM', 'src': {'type': 'addresses_normal_ht', 'congruent': 5, 'same': False}, 'dst': {'type': 'addresses_A_ht', 'congruent': 7, 'same': False}}
...
{'OP': 'LOAD', 'src': {'type': 'addresses_WT_ht', 'AVXalign': True, 'congruent': 7, 'size': 2, 'same': False, 'NT': False}}
...
{'OP': 'REPM', 'src': {'type': 'addresses_normal_ht', 'congruent': 3, 'same': True}, 'dst': {'type': 'addresses_A_ht', 'congruent': 2, 'same': False}}
{'00': 21829}
