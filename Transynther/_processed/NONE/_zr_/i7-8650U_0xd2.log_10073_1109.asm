...
nop
and %r14, %r14
lea addresses_UC_ht+0x1813e, %r14
clflush (%r14)
nop
nop
nop
...
nop
and $45491, %rdx
lea addresses_normal_ht+0x393e, %rsi
lea addresses_WC_ht+0x1d6e6, %rdi
nop
nop
nop
add %r11, %r11
...
nop
cmp $34326, %rcx
lea addresses_UC_ht+0x523e, %r12
nop
add %rsi, %rsi
mov (%r12), %rdx
nop
cmp %r12, %r12
lea addresses_WT_ht+0x1c3be, %r11
nop
nop
nop
nop
...
nop
sub %r14, %r14
lea addresses_A_ht+0x10d7e, %rdx
nop
nop
nop
sub %rdi, %rdi
...
// Store
lea addresses_normal+0x6782, %r11
nop
nop
nop
nop
...
{'OP': 'LOAD', 'src': {'type': 'addresses_WT', 'size': 2, 'AVXalign': True, 'NT': False, 'congruent': 8, 'same': False}}
