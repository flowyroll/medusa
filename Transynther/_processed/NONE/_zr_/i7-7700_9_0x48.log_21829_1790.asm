...
nop
add $26979, %r13
lea addresses_normal_ht+0xd9ff, %rax
nop
nop
nop
nop
...
nop
xor %r13, %r13
lea addresses_WC_ht+0x5c5, %rsi
lea addresses_A_ht+0x1a605, %rdi
nop
nop
nop
nop
...
nop
xor %r14, %r14
lea addresses_A_ht+0x16625, %rsi
lea addresses_normal_ht+0x127f5, %rdi
xor %r8, %r8
mov $12, %rcx
rep movsw
nop
...
nop
xor $34144, %r13
lea addresses_WT_ht+0x8acd, %rdi
nop
nop
sub $35266, %r8
...
{'OP': 'LOAD', 'src': {'type': 'addresses_RW', 'AVXalign': False, 'congruent': 8, 'size': 1, 'same': False, 'NT': False}}
...
<gen_prepare_buffer>
{'OP': 'LOAD', 'src': {'type': 'addresses_D_ht', 'AVXalign': True, 'congruent': 7, 'size': 4, 'same': True, 'NT': False}}
