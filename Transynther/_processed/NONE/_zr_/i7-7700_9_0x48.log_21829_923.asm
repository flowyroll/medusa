...
mov (%rsi), %ecx
add %rax, %rax
lea addresses_normal_ht+0x2491, %rax
nop
xor %rdi, %rdi
movb (%rax), %r15b
nop
...
nop
dec %rdi
lea addresses_normal_ht+0xf591, %rcx
nop
nop
add $23913, %rax
...
vmovups %ymm3, (%rcx)
dec %rax
lea addresses_WT_ht+0xa94d, %rsi
nop
nop
nop
dec %r14
...
nop
sub %r15, %r15
lea addresses_normal_ht+0x12095, %r14
nop
nop
nop
nop
...
nop
cmp $29220, %r14
lea addresses_WC_ht+0x1ecc5, %r9
nop
nop
xor %rax, %rax
mov (%r9), %r15
...
{'OP': 'REPM', 'src': {'type': 'addresses_WC_ht', 'congruent': 5, 'same': False}, 'dst': {'type': 'addresses_WC_ht', 'congruent': 5, 'same': False}}
