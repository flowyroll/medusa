...
nop
sub %r9, %r9
lea addresses_normal_ht+0xd30e, %r11
nop
nop
xor %r13, %r13
mov (%r11), %ebp
...
nop
add $689, %rax
lea addresses_A_ht+0x161d4, %rax
nop
add $399, %rdi
movb $0x61, (%rax)
add %r9, %r9
...
nop
and %r13, %r13
lea addresses_WC_ht+0x1bf1e, %rsi
lea addresses_UC_ht+0x199f3, %rdi
nop
nop
nop
nop
...
nop
add %r9, %r9
lea addresses_WC_ht+0x1309e, %rbp
nop
nop
nop
nop
...
nop
dec %r9
lea addresses_UC_ht+0xb50e, %rsi
nop
nop
nop
add %r13, %r13
...
{'OP': 'REPM', 'src': {'type': 'addresses_WC_ht', 'congruent': 6, 'same': True}, 'dst': {'type': 'addresses_UC_ht', 'congruent': 0, 'same': True}}
{'OP': 'STOR', 'dst': {'type': 'addresses_WC_ht', 'AVXalign': False, 'congruent': 9, 'size': 1, 'same': True, 'NT': False}}
{'OP': 'LOAD', 'src': {'type': 'addresses_UC_ht', 'AVXalign': False, 'congruent': 4, 'size': 16, 'same': True, 'NT': False}}
{'00': 21829}
