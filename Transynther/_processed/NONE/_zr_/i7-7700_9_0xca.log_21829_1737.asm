...
nop
and $41617, %r8
lea addresses_WC_ht+0xc7ad, %rsi
lea addresses_WT_ht+0x1a6dd, %rdi
nop
nop
nop
nop
...
nop
add $6066, %r11
lea addresses_UC_ht+0xedad, %r13
nop
and $61332, %r10
movb $0x61, (%r13)
nop
...
nop
dec %r13
lea addresses_UC_ht+0x756d, %rdi
nop
nop
nop
sub $23875, %r8
...
nop
dec %rsi
lea addresses_D_ht+0x1b5c5, %rcx
nop
and %r11, %r11
mov (%rcx), %rsi
nop
nop
add $7778, %rdi
lea addresses_WC_ht+0x15dad, %rsi
lea addresses_D_ht+0x19c71, %rdi
and %r11, %r11
mov $78, %rcx
rep movsq
nop
