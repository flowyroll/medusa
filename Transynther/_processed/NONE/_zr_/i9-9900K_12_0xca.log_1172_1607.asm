...
push %rbx
push %rdx
lea addresses_WT_ht+0x1a404, %rdx
nop
nop
xor %rbp, %rbp
movb $0x61, (%rdx)
...
// Load
lea addresses_normal+0x169d4, %rbx
nop
nop
nop
and %rdx, %rdx
...
{'OP': 'LOAD', 'src': {'size': 1, 'NT': False, 'type': 'addresses_P', 'same': False, 'AVXalign': False, 'congruent': 4}}
{'OP': 'STOR', 'dst': {'size': 4, 'NT': False, 'type': 'addresses_A', 'same': False, 'AVXalign': True, 'congruent': 4}}
{'OP': 'LOAD', 'src': {'size': 32, 'NT': False, 'type': 'addresses_normal', 'same': False, 'AVXalign': False, 'congruent': 4}}
