...
push %rdi
push %rsi
lea addresses_normal_ht+0xc1ba, %r14
nop
nop
add $40514, %r9
movups (%r14), %xmm6
...
nop
and %r9, %r9
lea addresses_WC_ht+0xc52a, %r11
nop
nop
nop
nop
...
nop
cmp %r9, %r9
lea addresses_D_ht+0x47ba, %rsi
lea addresses_normal_ht+0x332a, %rdi
nop
sub %r8, %r8
mov $44, %rcx
rep movsb
...
nop
add %r8, %r8
lea addresses_WT_ht+0x13f2, %r11
clflush (%r11)
nop
nop
nop
...
nop
inc %r9
lea addresses_D_ht+0x10fea, %r14
nop
nop
nop
nop
...
nop
sub %r8, %r8
lea addresses_UC_ht+0x804a, %rsi
lea addresses_normal_ht+0xa590, %rdi
sub %r13, %r13
mov $63, %rcx
rep movsw
sub $47052, %r14
lea addresses_normal_ht+0x15c2a, %rdi
sub %r14, %r14
mov (%rdi), %r9d
nop
nop
nop
inc %r8
lea addresses_WT_ht+0x1350e, %r8
nop
nop
nop
and $27960, %rcx
mov (%r8), %r9d
lfence
lea addresses_WT_ht+0x1322a, %rdi
nop
nop
nop
xor $20484, %r11
...
{'OP': 'REPM', 'src': {'type': 'addresses_WT_ht', 'congruent': 3, 'same': False}, 'dst': {'type': 'addresses_A_ht', 'congruent': 3, 'same': True}}
