...
push %rdx
push %rsi
lea addresses_WC_ht+0x12517, %rdi
nop
nop
nop
nop
...
nop
sub %r8, %r8
lea addresses_WC_ht+0x12a71, %rbx
nop
and %r10, %r10
vmovups (%rbx), %ymm4
...
nop
cmp %r9, %r9
lea addresses_A_ht+0x18e71, %rdx
sub %rdi, %rdi
...
nop
inc %r14
lea addresses_WC_ht+0x1e829, %rsi
lea addresses_normal_ht+0xbe71, %rdi
clflush (%rsi)
nop
dec %rbx
mov $86, %rcx
...
// Store
lea addresses_normal+0x42ea, %rax
nop
nop
xor %rdi, %rdi
...
{'OP': 'REPM', 'src': {'type': 'addresses_WC_ht', 'congruent': 3, 'same': True}, 'dst': {'type': 'addresses_normal_ht', 'congruent': 11, 'same': False}}
{'00': 21829}
