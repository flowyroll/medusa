...
push %rdx
push %rsi
lea addresses_UC_ht+0x1a5d3, %r13
nop
add %rbx, %rbx
mov (%r13), %edx
inc %rbp
lea addresses_A_ht+0x81ef, %rdi
nop
nop
nop
add $4095, %r9
...
vmovntdq %ymm7, (%rdi)
cmp $34999, %rbp
lea addresses_normal_ht+0xd53, %r13
xor %r10, %r10
mov (%r13), %rdx
nop
nop
...
nop
sub $39523, %r10
lea addresses_UC_ht+0xc6b3, %rbx
inc %rdi
movw $0x6162, (%rbx)
nop
sub %r10, %r10
lea addresses_A_ht+0x5c73, %rsi
lea addresses_A_ht+0x1e193, %rdi
nop
nop
nop
nop
...
nop
cmp $31016, %rcx
lea addresses_UC_ht+0x114fd, %rdx
clflush (%rdx)
nop
nop
nop
...
nop
add $40260, %r9
lea addresses_D_ht+0x36e3, %rsi
lea addresses_normal_ht+0x13d73, %rdi
nop
nop
nop
xor %rbp, %rbp
...
nop
and $60512, %rbx
lea addresses_normal_ht+0x99f3, %rsi
lea addresses_WC_ht+0x1e573, %rdi
nop
nop
and $33109, %rbp
mov $63, %rcx
...
nop
sub $25072, %r10
lea addresses_normal_ht+0x5173, %r13
nop
nop
nop
nop
...
{'OP': 'LOAD', 'src': {'type': 'addresses_NC', 'AVXalign': False, 'congruent': 11, 'size': 2, 'same': False, 'NT': True}}
...
{'OP': 'STOR', 'dst': {'type': 'addresses_A_ht', 'AVXalign': False, 'congruent': 2, 'size': 32, 'same': False, 'NT': True}}
...
{'OP': 'STOR', 'dst': {'type': 'addresses_D_ht', 'AVXalign': False, 'congruent': 5, 'size': 32, 'same': True, 'NT': False}}
{'OP': 'LOAD', 'src': {'type': 'addresses_UC_ht', 'AVXalign': False, 'congruent': 1, 'size': 4, 'same': False, 'NT': False}}
{'OP': 'REPM', 'src': {'type': 'addresses_D_ht', 'congruent': 3, 'same': False}, 'dst': {'type': 'addresses_normal_ht', 'congruent': 11, 'same': True}}
