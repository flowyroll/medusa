...
push %rdi
push %rsi
lea addresses_A_ht+0x1ecf2, %rsi
lea addresses_WT_ht+0xdfd2, %rdi
nop
nop
nop
add %r14, %r14
...
nop
cmp %rbp, %rbp
lea addresses_normal_ht+0x110ba, %r8
nop
nop
nop
nop
...
movq %rdi, (%r8)
sub %rdi, %rdi
lea addresses_normal_ht+0x187d2, %rbx
nop
nop
nop
nop
...
nop
dec %rbp
lea addresses_normal_ht+0x5a82, %rdi
add $373, %r14
mov (%rdi), %ebp
nop
nop
nop
inc %rcx
lea addresses_WC_ht+0x18f2, %rcx
nop
nop
and %rdi, %rdi
movb (%rcx), %bl
inc %rdi
lea addresses_WC_ht+0x87e, %rsi
nop
nop
add $28090, %rdi
movups (%rsi), %xmm7
...
nop
add $34105, %r8
lea addresses_normal_ht+0xa22, %rsi
lea addresses_A_ht+0x18f2a, %rdi
nop
nop
nop
nop
...
nop
and %rbp, %rbp
lea addresses_normal_ht+0xe452, %rcx
nop
nop
nop
nop
...
nop
dec %r15
lea addresses_UC_ht+0x27d2, %rdi
nop
xor %rbp, %rbp
movw $0x6162, (%rdi)
nop
inc %r8
lea addresses_UC_ht+0x1bddc, %rsi
lea addresses_D_ht+0x1e72a, %rdi
nop
nop
inc %r15
mov $17, %rcx
...
<gen_prepare_buffer>
{'OP': 'REPM', 'src': {'type': 'addresses_A_ht', 'congruent': 4, 'same': False}, 'dst': {'type': 'addresses_WT_ht', 'congruent': 8, 'same': False}}
