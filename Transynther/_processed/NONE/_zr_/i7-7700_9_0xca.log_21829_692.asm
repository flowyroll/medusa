...
push %rcx
push %rsi
lea addresses_normal_ht+0x1d849, %r10
nop
nop
nop
nop
...
nop
sub $33750, %rbx
lea addresses_UC_ht+0x7ede, %r15
sub $58660, %r10
mov (%r15), %ecx
nop
nop
...
nop
xor $57337, %r15
lea addresses_WC_ht+0x1759e, %rcx
nop
nop
nop
nop
...
nop
cmp %r11, %r11
lea addresses_A_ht+0x1de5e, %r15
sub $43183, %rsi
mov (%r15), %rbx
nop
sub $35288, %rcx
lea addresses_WT_ht+0x1d4de, %r9
nop
nop
nop
nop
...
nop
sub %rsi, %rsi
lea addresses_normal_ht+0x1e5e, %rsi
nop
nop
nop
nop
...
{'OP': 'STOR', 'dst': {'congruent': 6, 'AVXalign': True, 'same': False, 'size': 2, 'NT': False, 'type': 'addresses_WC_ht'}}
...
{'OP': 'STOR', 'dst': {'congruent': 11, 'AVXalign': False, 'same': True, 'size': 1, 'NT': False, 'type': 'addresses_normal_ht'}}
{'00': 21829}
