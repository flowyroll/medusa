...
push %rdi
push %rsi
lea addresses_normal_ht+0xb557, %rdi
nop
nop
nop
nop
...
nop
xor %r9, %r9
lea addresses_WT_ht+0xe457, %rcx
nop
nop
nop
nop
...
nop
add %r9, %r9
lea addresses_WT_ht+0x1257, %rax
nop
nop
nop
nop
...
vmovups %ymm0, (%rax)
sub $5670, %rax
lea addresses_D_ht+0x11f3d, %rsi
...
nop
inc %rcx
lea addresses_D_ht+0x12e57, %rdi
cmp %r11, %r11
movw $0x6162, (%rdi)
nop
cmp %r12, %r12
lea addresses_normal_ht+0x14c57, %rsi
lea addresses_A_ht+0xe3d7, %rdi
nop
nop
xor %rax, %rax
mov $76, %rcx
...
nop
cmp %rdi, %rdi
lea addresses_UC_ht+0x1ac91, %r13
nop
nop
nop
nop
...
nop
xor $55256, %rax
lea addresses_WT_ht+0x1e257, %rax
nop
nop
nop
xor %r13, %r13
...
lea addresses_normal_ht+0x15707, %rdi
nop
nop
nop
nop
...
nop
sub %rcx, %rcx
lea addresses_normal_ht+0x14a57, %r12
clflush (%r12)
nop
nop
nop
...
nop
xor %rax, %rax
lea addresses_WC_ht+0xa177, %rsi
lea addresses_D_ht+0x18157, %rdi
clflush (%rdi)
xor $27488, %rax
mov $114, %rcx
rep movsw
...
nop
cmp $51211, %rcx
lea addresses_normal_ht+0x8657, %r11
nop
nop
nop
nop
...
{'OP': 'REPM', 'src': {'type': 'addresses_D_ht', 'congruent': 1, 'same': False}, 'dst': {'type': 'addresses_UC_ht', 'congruent': 10, 'same': False}}
{'OP': 'STOR', 'dst': {'type': 'addresses_D_ht', 'size': 2, 'AVXalign': False, 'NT': False, 'congruent': 9, 'same': False}}
{'OP': 'REPM', 'src': {'type': 'addresses_normal_ht', 'congruent': 3, 'same': False}, 'dst': {'type': 'addresses_A_ht', 'congruent': 7, 'same': False}}
{'OP': 'STOR', 'dst': {'type': 'addresses_UC_ht', 'size': 16, 'AVXalign': False, 'NT': False, 'congruent': 9, 'same': False}}
{'OP': 'LOAD', 'src': {'type': 'addresses_UC_ht', 'size': 1, 'AVXalign': False, 'NT': False, 'congruent': 1, 'same': True}}
