...
push %rdi
push %rsi
lea addresses_WT_ht+0x6b07, %rsi
lea addresses_WC_ht+0x667f, %rdi
nop
nop
nop
nop
...
nop
add %rsi, %rsi
lea addresses_A_ht+0x1a267, %r10
nop
nop
nop
nop
...
nop
dec %rdi
lea addresses_A_ht+0xd823, %rsi
lea addresses_A_ht+0x1aef3, %rdi
nop
nop
nop
nop
...
nop
sub $958, %rdi
lea addresses_WT_ht+0x96c7, %rdi
nop
nop
nop
nop
...
nop
dec %rdi
lea addresses_WC_ht+0x847, %rsi
lea addresses_UC_ht+0x18c8, %rdi
xor $10297, %r8
mov $39, %rcx
rep movsl
nop
nop
and %r10, %r10
lea addresses_A_ht+0x6807, %r8
nop
sub %rdi, %rdi
mov (%r8), %r9w
nop
xor %rbp, %rbp
lea addresses_WC_ht+0x1bc9f, %rdi
clflush (%rdi)
nop
nop
nop
...
nop
sub %r10, %r10
lea addresses_D_ht+0x13b07, %rbp
nop
nop
add $35506, %r15
...
<gen_prepare_buffer>
{'src': {'congruent': 11, 'same': False, 'type': 'addresses_WT_ht'}, 'OP': 'REPM', 'dst': {'congruent': 2, 'same': False, 'type': 'addresses_WC_ht'}}
{'src': {'congruent': 5, 'AVXalign': False, 'same': False, 'size': 2, 'NT': False, 'type': 'addresses_A_ht'}, 'OP': 'LOAD'}
{'src': {'congruent': 2, 'same': False, 'type': 'addresses_A_ht'}, 'OP': 'REPM', 'dst': {'congruent': 2, 'same': False, 'type': 'addresses_A_ht'}}
