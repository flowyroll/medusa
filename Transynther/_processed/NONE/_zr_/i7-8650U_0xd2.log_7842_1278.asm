...
push %rdi
push %rsi
lea addresses_WC_ht+0x1d82c, %rsi
lea addresses_A_ht+0x13608, %rdi
dec %r12
mov $83, %rcx
rep movsw
nop
...
nop
add $8127, %r15
lea addresses_WT_ht+0x1473c, %r8
clflush (%r8)
nop
sub %r9, %r9
mov (%r8), %r15
...
nop
cmp $45588, %r12
lea addresses_WT_ht+0x1e104, %rsi
lea addresses_UC_ht+0xd04, %rdi
nop
nop
nop
nop
...
nop
xor %r15, %r15
lea addresses_WC_ht+0x10b84, %r15
clflush (%r15)
nop
nop
nop
...
nop
sub %r15, %r15
lea addresses_normal_ht+0x14cb4, %rsi
nop
nop
xor $59185, %r8
movl $0x61626364, (%rsi)
...
nop
cmp $1136, %r9
lea addresses_A_ht+0x14296, %r13
nop
xor %r15, %r15
movl $0x61626364, (%r13)
nop
...
nop
xor $62979, %r12
lea addresses_normal_ht+0x13d04, %r13
nop
nop
nop
inc %r8
...
nop
cmp $48547, %r15
lea addresses_UC_ht+0xe04, %rsi
lea addresses_UC_ht+0xc904, %rdi
nop
nop
and $64709, %r12
mov $91, %rcx
...
nop
and %rcx, %rcx
lea addresses_WC_ht+0xa9e4, %r13
nop
nop
sub $18131, %r12
movl $0x61626364, (%r13)
...
nop
and $36370, %r12
lea addresses_normal_ht+0x13078, %rsi
lea addresses_WC_ht+0x1e504, %rdi
cmp $28224, %r12
mov $41, %rcx
rep movsq
nop
cmp %r15, %r15
lea addresses_UC_ht+0x14c04, %r13
nop
nop
nop
nop
...
nop
add %r15, %r15
lea addresses_UC_ht+0xae24, %rsi
lea addresses_normal_ht+0x5e50, %rdi
nop
nop
cmp %r9, %r9
mov $113, %rcx
...
nop
sub %rsi, %rsi
lea addresses_D_ht+0x1c0c4, %rsi
nop
nop
nop
and %rcx, %rcx
...
nop
and $42958, %r8
lea addresses_A_ht+0x17d04, %rsi
nop
nop
nop
nop
...
{'OP': 'STOR', 'dst': {'type': 'addresses_WC_ht', 'size': 1, 'AVXalign': True, 'NT': True, 'congruent': 5, 'same': False}}
...
{'OP': 'REPM', 'src': {'type': 'addresses_UC_ht', 'congruent': 6, 'same': False}, 'dst': {'type': 'addresses_UC_ht', 'congruent': 10, 'same': False}}
