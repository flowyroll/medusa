...
push %rdi
push %rsi
lea addresses_A_ht+0x1435b, %r11
clflush (%r11)
nop
nop
nop
...
nop
xor %rsi, %rsi
lea addresses_WC_ht+0xc79b, %rbx
inc %r14
movw $0x6162, (%rbx)
nop
nop
...
nop
xor $4626, %r14
lea addresses_WT_ht+0x1e65b, %r8
nop
nop
cmp $368, %r11
vmovups (%r8), %ymm2
...
nop
xor $38703, %r8
lea addresses_D_ht+0x1abfb, %rbx
nop
nop
dec %r13
...
nop
sub $56487, %r13
lea addresses_WC_ht+0x19e5b, %r12
add %r8, %r8
movw $0x6162, (%r12)
nop
nop
nop
cmp $28419, %r14
lea addresses_WT_ht+0x1a65b, %rsi
lea addresses_D_ht+0x1441f, %rdi
nop
nop
nop
nop
...
nop
sub %rdi, %rdi
lea addresses_UC_ht+0xf65b, %r11
nop
dec %rsi
mov (%r11), %r14
nop
add %rdi, %rdi
lea addresses_WT_ht+0x9967, %rsi
lea addresses_A_ht+0x7beb, %rdi
nop
add %r12, %r12
mov $56, %rcx
rep movsb
nop
and $45683, %rbx
lea addresses_WT_ht+0x8cf3, %rcx
sub %rdi, %rdi
mov (%rcx), %r14d
nop
add %rdi, %rdi
...
{'OP': 'REPM', 'src': {'type': 'addresses_WT_ht', 'congruent': 1, 'same': True}, 'dst': {'type': 'addresses_A_ht', 'congruent': 2, 'same': False}}
