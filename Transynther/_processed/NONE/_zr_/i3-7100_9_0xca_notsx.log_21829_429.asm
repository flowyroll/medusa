...
nop
and %rcx, %rcx
lea addresses_UC_ht+0x4e15, %rdi
nop
nop
cmp $30669, %rcx
movw $0x6162, (%rdi)
...
nop
cmp $25687, %rbx
lea addresses_normal_ht+0x16a35, %rsi
lea addresses_WT_ht+0x6d95, %rdi
clflush (%rsi)
nop
nop
nop
...
nop
cmp $40881, %rsi
lea addresses_UC_ht+0x187d5, %rbx
nop
nop
cmp $51343, %r11
movl $0x61626364, (%rbx)
...
nop
inc %rdi
lea addresses_UC_ht+0x14415, %rbx
nop
nop
nop
nop
...
nop
cmp %r15, %r15
lea addresses_WT_ht+0x6e85, %rsi
nop
nop
cmp $56128, %rbx
mov (%rsi), %r11w
