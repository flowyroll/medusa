...
push %rdi
push %rsi
lea addresses_WT_ht+0x1878c, %rbp
nop
nop
sub %r14, %r14
movl $0x61626364, (%rbp)
sub %r8, %r8
lea addresses_WC_ht+0x134cc, %rax
dec %r13
movl $0x61626364, (%rax)
nop
nop
...
nop
xor %rdi, %rdi
lea addresses_normal_ht+0xcb0c, %r13
nop
nop
nop
cmp $44075, %rbp
...
nop
sub $45364, %rdi
lea addresses_WC_ht+0x90c, %rsi
lea addresses_WT_ht+0x14cd4, %rdi
nop
nop
nop
cmp $56438, %r8
...
{'OP': 'REPM', 'src': {'same': False, 'type': 'addresses_WC_ht', 'congruent': 10}, 'dst': {'same': False, 'type': 'addresses_WT_ht', 'congruent': 3}}
{'00': 21829}
