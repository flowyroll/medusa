...
push %rdx
push %rsi
lea addresses_A_ht+0xafa, %rsi
lea addresses_UC_ht+0xd6fa, %rdi
nop
nop
nop
add %rdx, %rdx
...
rep movsl
add $12306, %rdx
lea addresses_WT_ht+0x1252e, %rax
clflush (%rax)
nop
nop
xor %rdi, %rdi
...
nop
xor $57054, %rax
lea addresses_D_ht+0x159fa, %rsi
dec %rbp
...
nop
and $32647, %rbp
lea addresses_WT_ht+0x163fa, %rdi
sub %rbp, %rbp
movw $0x6162, (%rdi)
nop
and %rcx, %rcx
lea addresses_UC_ht+0x1bbfa, %rsi
lea addresses_normal_ht+0x35fa, %rdi
clflush (%rdi)
nop
nop
nop
...
nop
lfence
lea addresses_D_ht+0x1e03a, %rdi
nop
cmp %r10, %r10
movw $0x6162, (%rdi)
cmp $51713, %rdi
lea addresses_WT_ht+0x1e7fa, %rbp
nop
nop
nop
dec %rcx
...
nop
dec %rsi
lea addresses_D_ht+0x1ebfa, %rax
nop
nop
add $43900, %rbp
movb $0x61, (%rax)
