...
push %rdx
push %rsi
lea addresses_WT_ht+0xd8ac, %rdx
nop
dec %rdi
movups (%rdx), %xmm0
vpextrq $1, %xmm0, %rbx
...
nop
and %r13, %r13
lea addresses_WT_ht+0x38dc, %rsi
lea addresses_WT_ht+0x196ac, %rdi
nop
nop
nop
dec %rbx
...
rep movsb
cmp $18733, %r13
lea addresses_A_ht+0x106ac, %rsi
...
nop
sub $27945, %rdi
lea addresses_normal_ht+0x3cac, %rsi
lea addresses_D_ht+0x1640c, %rdi
nop
and %r9, %r9
mov $123, %rcx
rep movsb
cmp %rcx, %rcx
lea addresses_UC_ht+0x18ac, %rdx
sub %rbx, %rbx
movups (%rdx), %xmm3
vpextrq $0, %xmm3, %rsi
nop
