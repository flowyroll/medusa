...
push %rdi
push %rsi
lea addresses_normal_ht+0x15b2a, %r15
nop
nop
nop
nop
...
nop
add $19110, %rax
lea addresses_A_ht+0x385a, %rsi
lea addresses_normal_ht+0x19a2a, %rdi
and $30647, %r9
mov $81, %rcx
rep movsl
dec %rdi
lea addresses_D_ht+0x4dea, %rax
nop
nop
sub %rcx, %rcx
...
nop
and $31037, %rdi
lea addresses_D_ht+0x1290a, %rsi
lea addresses_D_ht+0xde2a, %rdi
nop
nop
and %r9, %r9
mov $46, %rcx
...
nop
sub %rdi, %rdi
lea addresses_WT_ht+0x197aa, %rax
nop
sub $50999, %r9
movb $0x61, (%rax)
nop
...
{'OP': 'REPM', 'src': {'type': 'addresses_D_ht', 'congruent': 5, 'same': False}, 'dst': {'type': 'addresses_D_ht', 'congruent': 8, 'same': False}}
