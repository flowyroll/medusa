...
push %rdx
push %rsi
lea addresses_WC_ht+0x122e9, %rsi
nop
add %r10, %r10
movups (%rsi), %xmm2
vpextrq $0, %xmm2, %rdi
nop
dec %rdi
lea addresses_D_ht+0x191c9, %rdx
nop
dec %r13
movups (%rdx), %xmm3
vpextrq $1, %xmm3, %r8
...
nop
add %r13, %r13
lea addresses_WC_ht+0x176c9, %rsi
lea addresses_UC_ht+0xd1ab, %rdi
nop
nop
nop
nop
...
movups %xmm0, (%rsi)
sub %rsi, %rsi
lea addresses_UC_ht+0xa965, %r10
nop
nop
nop
and %r13, %r13
...
nop
dec %r13
lea addresses_UC_ht+0x15725, %rdi
nop
add $21758, %rsi
...
{'src': {'same': False, 'congruent': 8, 'type': 'addresses_WC_ht'}, 'OP': 'REPM', 'dst': {'same': False, 'congruent': 1, 'type': 'addresses_UC_ht'}}
...
{'src': {'NT': True, 'same': False, 'congruent': 0, 'type': 'addresses_UC_ht', 'AVXalign': False, 'size': 16}, 'OP': 'LOAD'}
