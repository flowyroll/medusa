...
push %rdi
push %rsi
lea addresses_A_ht+0x9653, %r8
and %rdi, %rdi
mov $0x6162636465666768, %r15
movq %r15, %xmm2
vmovups %ymm2, (%r8)
inc %r14
lea addresses_UC_ht+0xb6db, %rsi
lea addresses_D_ht+0x3d4a, %rdi
nop
nop
nop
nop
...
rep movsw
inc %r15
lea addresses_D_ht+0x14922, %r15
nop
nop
nop
nop
...
nop
and %rdi, %rdi
lea addresses_D_ht+0x11d62, %r14
sub $22508, %r8
mov (%r14), %r15w
xor $50554, %r14
lea addresses_normal_ht+0xf0ff, %rsi
lea addresses_normal_ht+0x130ea, %rdi
and %rax, %rax
mov $22, %rcx
rep movsb
inc %rax
lea addresses_WT_ht+0x151ea, %rdi
nop
nop
nop
nop
...
{'dst': {'type': 'addresses_WC', 'same': False, 'size': 8, 'congruent': 3, 'NT': False, 'AVXalign': False}, 'OP': 'STOR'}
{'src': {'type': 'addresses_NC', 'same': False, 'size': 16, 'congruent': 2, 'NT': False, 'AVXalign': False}, 'OP': 'LOAD'}
{'dst': {'type': 'addresses_US', 'same': False, 'size': 16, 'congruent': 0, 'NT': False, 'AVXalign': False}, 'OP': 'STOR'}
...
{'src': {'type': 'addresses_normal_ht', 'congruent': 0, 'same': False}, 'dst': {'type': 'addresses_normal_ht', 'congruent': 6, 'same': False}, 'OP': 'REPM'}
