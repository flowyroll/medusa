...
nop
inc %rdi
lea addresses_UC_ht+0xf426, %r15
nop
nop
nop
nop
...
nop
cmp %r11, %r11
lea addresses_normal_ht+0x95fe, %rsi
lea addresses_WC_ht+0x7702, %rdi
nop
nop
sub %r14, %r14
mov $112, %rcx
...
nop
cmp $14715, %rcx
lea addresses_A_ht+0x101c6, %rcx
nop
nop
add %r10, %r10
movw $0x6162, (%rcx)
...
nop
sub %rax, %rax
lea addresses_WT_ht+0x1d9c6, %rsi
lea addresses_normal_ht+0x199c6, %rdi
nop
nop
nop
nop
...
nop
add %r11, %r11
lea addresses_WC_ht+0x53c6, %rsi
lea addresses_WC_ht+0xd6e6, %rdi
nop
lfence
mov $64, %rcx
rep movsq
...
// Store
lea addresses_normal+0x137c6, %r15
cmp $25041, %rbx
...
// Store
lea addresses_normal+0x1bb46, %rsi
clflush (%rsi)
nop
nop
nop
...
{'OP': 'REPM', 'src': {'type': 'addresses_normal_ht', 'congruent': 3, 'same': False}, 'dst': {'type': 'addresses_WC_ht', 'congruent': 2, 'same': False}}
...
{'OP': 'REPM', 'src': {'type': 'addresses_WC_ht', 'congruent': 8, 'same': False}, 'dst': {'type': 'addresses_WC_ht', 'congruent': 5, 'same': True}}
