...
push %rdx
push %rsi
lea addresses_A_ht+0xb10a, %rsi
lea addresses_D_ht+0x2868, %rdi
nop
nop
nop
nop
...
nop
sub $27529, %rcx
lea addresses_WC_ht+0x850a, %r15
nop
nop
nop
nop
...
nop
xor $25777, %r13
lea addresses_normal_ht+0x5e0a, %rsi
lea addresses_normal_ht+0x9a8a, %rdi
and $46890, %rbp
mov $74, %rcx
rep movsw
nop
mfence
lea addresses_A_ht+0x1618a, %rsi
nop
nop
nop
nop
...
vpextrq $1, %xmm4, %rbp
add %rbp, %rbp
lea addresses_D_ht+0x1a427, %r15
nop
nop
nop
nop
...
nop
inc %r15
lea addresses_A_ht+0x19a0a, %r13
nop
nop
nop
nop
...
nop
add %r15, %r15
lea addresses_WC_ht+0x12e0a, %rax
nop
nop
nop
cmp %rbp, %rbp
...
{'OP': 'LOAD', 'src': {'type': 'addresses_WC_ht', 'AVXalign': True, 'congruent': 6, 'size': 8, 'same': False, 'NT': False}}
