...
nop
dec %rbx
lea addresses_D_ht+0x18fa6, %r10
nop
nop
nop
nop
...
nop
xor %rbp, %rbp
lea addresses_WC_ht+0x3e7e, %rcx
clflush (%rcx)
nop
nop
sub %r8, %r8
...
nop
sub %r10, %r10
lea addresses_UC_ht+0x1dbbe, %r10
cmp %r8, %r8
mov $0x6162636465666768, %r13
movq %r13, (%r10)
nop
dec %r13
lea addresses_normal_ht+0x11b7e, %rsi
lea addresses_D_ht+0x1077e, %rdi
nop
nop
nop
nop
...
nop
xor $30440, %rbp
lea addresses_WC_ht+0xa67e, %rbx
add $3280, %r8
movb $0x61, (%rbx)
nop
nop
...
nop
and %r10, %r10
lea addresses_UC_ht+0x317e, %rdi
nop
nop
nop
sub $24943, %r8
...
nop
add %rbp, %rbp
lea addresses_normal_ht+0x45fe, %rsi
lea addresses_normal_ht+0x18d7e, %rdi
nop
nop
nop
cmp %r13, %r13
...
nop
xor $38763, %r10
lea addresses_normal_ht+0x1477e, %rsi
lea addresses_A_ht+0x10d5e, %rdi
nop
nop
nop
nop
...
nop
add %r10, %r10
lea addresses_A_ht+0x128fe, %rdi
nop
nop
nop
add %r14, %r14
...
{'OP': 'STOR', 'dst': {'type': 'addresses_UC_ht', 'AVXalign': True, 'congruent': 5, 'size': 8, 'same': False, 'NT': False}}
...
{'OP': 'STOR', 'dst': {'type': 'addresses_UC_ht', 'AVXalign': False, 'congruent': 9, 'size': 1, 'same': True, 'NT': False}}
