...
push %rdx
push %rsi
lea addresses_WC_ht+0x4142, %r14
nop
nop
nop
sub $13555, %r15
...
nop
sub $23010, %rsi
lea addresses_A_ht+0xffc2, %rsi
lea addresses_normal_ht+0x16302, %rdi
nop
nop
nop
nop
...
nop
add %rdi, %rdi
lea addresses_WT_ht+0x10492, %rdi
nop
nop
nop
nop
...
nop
xor $8896, %r14
lea addresses_WT_ht+0x12470, %rsi
lea addresses_WC_ht+0x9742, %rdi
add $24198, %r12
mov $27, %rcx
rep movsl
nop
nop
xor %rsi, %rsi
lea addresses_A_ht+0x1329e, %r12
nop
xor $56922, %rcx
...
nop
add $5940, %r14
lea addresses_WT_ht+0x1542, %rsi
lea addresses_UC_ht+0xf9c2, %rdi
nop
nop
lfence
mov $13, %rcx
...
nop
and %r12, %r12
lea addresses_A_ht+0xb542, %r14
and %r15, %r15
movb $0x61, (%r14)
nop
and %rdx, %rdx
lea addresses_WC_ht+0x100e2, %rsi
lea addresses_normal_ht+0x5b42, %rdi
nop
nop
nop
nop
...
// Store
lea addresses_normal+0xc3f5, %rbx
clflush (%rbx)
xor $38357, %r10
...
{'src': {'type': 'addresses_WT_ht', 'congruent': 1, 'same': False}, 'OP': 'REPM', 'dst': {'type': 'addresses_WC_ht', 'congruent': 10, 'same': False}}
{'OP': 'STOR', 'dst': {'type': 'addresses_A_ht', 'AVXalign': False, 'size': 16, 'NT': False, 'same': False, 'congruent': 0}}
{'src': {'type': 'addresses_WT_ht', 'congruent': 6, 'same': False}, 'OP': 'REPM', 'dst': {'type': 'addresses_UC_ht', 'congruent': 3, 'same': False}}
...
{'src': {'type': 'addresses_A_ht', 'AVXalign': False, 'size': 16, 'NT': False, 'same': True, 'congruent': 3}, 'OP': 'LOAD'}
{'00': 21829}
