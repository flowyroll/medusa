...
push %rdx
push %rsi
lea addresses_WC_ht+0x1645d, %r11
nop
cmp $57171, %rdx
...
nop
and %r8, %r8
lea addresses_UC_ht+0x177ed, %rsi
lea addresses_D_ht+0x1780d, %rdi
sub $25421, %r13
mov $8, %rcx
rep movsw
nop
...
nop
and %r11, %r11
lea addresses_normal_ht+0x4a6d, %rsi
lea addresses_WC_ht+0xff2d, %rdi
nop
nop
cmp %r13, %r13
mov $16, %rcx
...
nop
and %r11, %r11
lea addresses_normal_ht+0x7f6d, %rdi
nop
nop
sub $54257, %rdx
movb (%rdi), %r8b
...
nop
xor %rsi, %rsi
lea addresses_UC_ht+0xe4cf, %r8
cmp %rsi, %rsi
movb $0x61, (%r8)
nop
add %r9, %r9
lea addresses_normal_ht+0x38bc, %rsi
lea addresses_WT_ht+0x83ed, %rdi
clflush (%rdi)
nop
sub $30148, %rdx
mov $70, %rcx
...
nop
cmp %rdi, %rdi
lea addresses_WT_ht+0x557d, %r9
nop
nop
sub %r8, %r8
movl $0x61626364, (%r9)
dec %r8
lea addresses_D_ht+0x1d657, %r11
xor $5822, %r8
movb (%r11), %dl
nop
nop
...
nop
add $49778, %r13
lea addresses_WT_ht+0x1020d, %r11
nop
nop
nop
nop
...
nop
and $26881, %rdi
lea addresses_UC_ht+0x12013, %r13
nop
nop
xor %rcx, %rcx
movb $0x61, (%r13)
...
nop
sub %rdi, %rdi
lea addresses_WT_ht+0xc5f5, %rcx
nop
nop
nop
xor %r9, %r9
...
nop
sub $53166, %rdi
lea addresses_WC_ht+0x198ed, %r9
nop
nop
add $17799, %rdi
movw $0x6162, (%r9)
...
<gen_faulty_load>
[REF]
{'src': {'NT': False, 'same': False, 'congruent': 0, 'type': 'addresses_WT', 'AVXalign': True, 'size': 8}, 'OP': 'LOAD'}
[Faulty Load]
...
{'src': {'NT': False, 'same': True, 'congruent': 7, 'type': 'addresses_normal_ht', 'AVXalign': False, 'size': 1}, 'OP': 'LOAD'}
...
{'OP': 'STOR', 'dst': {'NT': False, 'same': True, 'congruent': 3, 'type': 'addresses_WT_ht', 'AVXalign': False, 'size': 4}}
...
{'OP': 'STOR', 'dst': {'NT': False, 'same': False, 'congruent': 1, 'type': 'addresses_UC_ht', 'AVXalign': False, 'size': 1}}
{'src': {'NT': False, 'same': True, 'congruent': 3, 'type': 'addresses_WT_ht', 'AVXalign': False, 'size': 2}, 'OP': 'LOAD'}
