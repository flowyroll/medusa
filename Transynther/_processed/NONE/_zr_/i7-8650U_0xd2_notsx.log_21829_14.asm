...
nop
cmp %r15, %r15
lea addresses_A_ht+0xb836, %rsi
lea addresses_D_ht+0x11306, %rdi
nop
nop
add $15571, %rbp
mov $103, %rcx
...
nop
dec %r8
lea addresses_normal_ht+0x4db6, %r15
nop
nop
nop
nop
...
nop
xor $56766, %rsi
lea addresses_WT_ht+0x3456, %rdi
nop
nop
sub %rsi, %rsi
...
nop
sub %rbp, %rbp
lea addresses_A_ht+0x13216, %r15
sub $20378, %r14
mov $0x6162636465666768, %r8
movq %r8, (%r15)
inc %rcx
lea addresses_WT_ht+0x7616, %rsi
lea addresses_UC_ht+0xff16, %rdi
nop
nop
nop
nop
...
lea addresses_UC_ht+0x102da, %rdi
clflush (%rdi)
nop
nop
nop
...
nop
cmp $65037, %rsi
lea addresses_WT_ht+0x7272, %rsi
lea addresses_D_ht+0x1a96, %rdi
nop
nop
inc %r15
mov $62, %rcx
...
{'OP': 'LOAD', 'src': {'type': 'addresses_RW', 'size': 2, 'AVXalign': False, 'NT': True, 'congruent': 10, 'same': False}}
...
{'OP': 'REPM', 'src': {'type': 'addresses_WT_ht', 'congruent': 11, 'same': True}, 'dst': {'type': 'addresses_UC_ht', 'congruent': 0, 'same': False}}
