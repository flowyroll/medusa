...
push %rdx
push %rsi
lea addresses_A_ht+0x171b6, %rsi
lea addresses_WC_ht+0x1426, %rdi
nop
nop
nop
add $47280, %r15
...
nop
xor %rdi, %rdi
lea addresses_normal_ht+0xfbb6, %rdx
nop
nop
dec %r12
mov (%rdx), %esi
nop
cmp %r11, %r11
lea addresses_WC_ht+0x115b6, %rsi
lea addresses_D_ht+0x15e5a, %rdi
clflush (%rsi)
nop
sub $881, %rbx
mov $61, %rcx
...
nop
xor $33485, %rdi
lea addresses_normal_ht+0x125b6, %rdx
nop
nop
lfence
movl $0x61626364, (%rdx)
...
nop
dec %r11
lea addresses_WC_ht+0x29b6, %rsi
nop
nop
nop
nop
...
nop
and %rbx, %rbx
lea addresses_normal_ht+0x29b6, %r11
and $9260, %rcx
...
nop
add $57102, %rbx
lea addresses_normal_ht+0x833e, %r12
nop
nop
nop
and %r15, %r15
...
vpextrq $1, %xmm6, %rsi
and $57532, %r11
lea addresses_WC_ht+0x183b6, %rbx
nop
nop
sub $29608, %rdx
movb $0x61, (%rbx)
xor $41042, %rbx
lea addresses_A_ht+0x3792, %rsi
lea addresses_D_ht+0x180c2, %rdi
clflush (%rsi)
nop
nop
nop
...
nop
dec %rbx
lea addresses_WC_ht+0x15e96, %rsi
lea addresses_A_ht+0xfb6, %rdi
nop
nop
nop
nop
...
nop
add %r15, %r15
lea addresses_normal_ht+0x151b6, %rsi
nop
xor %r15, %r15
mov (%rsi), %r12d
nop
...
nop
add %r11, %r11
lea addresses_UC_ht+0x145b6, %rsi
lea addresses_WC_ht+0x1ddb6, %rdi
nop
nop
nop
add %r12, %r12
...
nop
lfence
lea addresses_D_ht+0x18df6, %r12
add $57336, %rdi
movw $0x6162, (%r12)
sub %rbx, %rbx
lea addresses_A_ht+0x16bb6, %rsi
lea addresses_UC_ht+0x15923, %rdi
nop
dec %r11
mov $127, %rcx
rep movsw
...
// Store
lea addresses_normal+0x1aaea, %rbp
nop
nop
nop
nop
...
{'OP': 'STOR', 'dst': {'type': 'addresses_WC_ht', 'size': 1, 'AVXalign': False, 'NT': True, 'congruent': 9, 'same': False}}
{'OP': 'STOR', 'dst': {'type': 'addresses_normal_ht', 'size': 8, 'AVXalign': True, 'NT': True, 'congruent': 7, 'same': False}}
...
{'OP': 'REPM', 'src': {'type': 'addresses_A_ht', 'congruent': 8, 'same': False}, 'dst': {'type': 'addresses_UC_ht', 'congruent': 0, 'same': True}}
{'00': 21829}
