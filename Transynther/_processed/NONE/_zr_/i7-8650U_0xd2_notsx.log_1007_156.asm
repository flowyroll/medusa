...
nop
and %r9, %r9
lea addresses_WC_ht+0x18843, %r8
nop
nop
cmp %r12, %r12
...
nop
add %r9, %r9
lea addresses_normal_ht+0xd9fa, %rdx
nop
nop
nop
cmp %rdi, %rdi
...
nop
and %r8, %r8
lea addresses_D_ht+0x14c3a, %r10
nop
nop
nop
sub $41566, %r9
...
nop
sub %rdi, %rdi
lea addresses_WT_ht+0x7dfa, %rsi
lea addresses_UC_ht+0x180fa, %rdi
nop
nop
add $2658, %rdx
mov $5, %rcx
...
nop
and %r10, %r10
lea addresses_A_ht+0xba7e, %rsi
lea addresses_WT_ht+0xbdab, %rdi
nop
nop
nop
and %r9, %r9
