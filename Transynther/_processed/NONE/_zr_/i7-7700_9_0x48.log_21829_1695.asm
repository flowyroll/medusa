...
push %rdi
push %rsi
lea addresses_normal_ht+0x12212, %rbp
nop
nop
nop
add %r8, %r8
...
nop
add $28854, %r14
lea addresses_WT_ht+0x131d2, %rsi
lea addresses_UC_ht+0xba60, %rdi
nop
dec %r8
mov $118, %rcx
rep movsb
...
nop
sub $24902, %r14
lea addresses_normal_ht+0x1e882, %r14
cmp %r8, %r8
vmovups (%r14), %ymm4
...
nop
cmp %rsi, %rsi
lea addresses_WC_ht+0x129d2, %rbp
nop
nop
nop
add $39691, %rsi
...
// Store
lea addresses_normal+0xcd52, %r8
nop
nop
nop
nop
...
{'OP': 'STOR', 'dst': {'type': 'addresses_PSE', 'AVXalign': True, 'congruent': 9, 'size': 4, 'same': False, 'NT': False}}
[Faulty Load]
...
{'OP': 'REPM', 'src': {'type': 'addresses_WT_ht', 'congruent': 6, 'same': False}, 'dst': {'type': 'addresses_UC_ht', 'congruent': 1, 'same': False}}
...
{'OP': 'STOR', 'dst': {'type': 'addresses_WC_ht', 'AVXalign': False, 'congruent': 6, 'size': 2, 'same': False, 'NT': True}}
{'00': 21829}
