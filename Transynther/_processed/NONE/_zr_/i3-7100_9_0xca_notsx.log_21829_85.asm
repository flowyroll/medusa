...
nop
xor %r13, %r13
lea addresses_WT_ht+0xeaec, %rsi
lea addresses_A_ht+0x307c, %rdi
nop
nop
sub %r14, %r14
mov $57, %rcx
...
nop
inc %r10
lea addresses_UC_ht+0x5dec, %rsi
lea addresses_WT_ht+0x18380, %rdi
xor $55642, %r12
mov $23, %rcx
rep movsl
nop
...
nop
sub %rdi, %rdi
lea addresses_WC_ht+0x6c4c, %r10
dec %r8
vmovups (%r10), %ymm2
vextracti128 $1, %ymm2, %xmm2
vpextrq $0, %xmm2, %rcx
cmp %r14, %r14
lea addresses_A_ht+0xcec, %r12
nop
nop
add $33525, %r8
mov (%r12), %r13d
...
nop
add $38783, %r12
lea addresses_UC_ht+0x1b22c, %rsi
lea addresses_WT_ht+0xc08c, %rdi
nop
and %r12, %r12
mov $39, %rcx
rep movsb
...
{'src': {'same': False, 'congruent': 6, 'NT': False, 'type': 'addresses_D', 'size': 2, 'AVXalign': False}, 'OP': 'LOAD'}
...
{'src': {'type': 'addresses_UC_ht', 'congruent': 10, 'same': False}, 'OP': 'REPM', 'dst': {'type': 'addresses_WT_ht', 'congruent': 2, 'same': True}}
