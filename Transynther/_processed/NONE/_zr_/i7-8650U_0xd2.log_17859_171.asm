...
mov (%r12), %r15w
dec %rsi
lea addresses_WT_ht+0x5f24, %rsi
lea addresses_WC_ht+0x1826a, %rdi
clflush (%rsi)
add $36780, %r10
mov $18, %rcx
rep movsl
...
nop
inc %r10
lea addresses_WT_ht+0x18644, %rsi
nop
nop
nop
nop
...
nop
inc %rsi
lea addresses_WT_ht+0x6bc4, %rsi
lea addresses_UC_ht+0xbac4, %rdi
nop
xor $49511, %rdx
mov $78, %rcx
rep movsw
...
vmovups %ymm6, (%rdi)
and %rdx, %rdx
lea addresses_UC_ht+0x1eac4, %rsi
lea addresses_A_ht+0x151c4, %rdi
clflush (%rsi)
clflush (%rdi)
nop
nop
...
// Store
lea addresses_normal+0x1522c, %r14
nop
nop
inc %r10
...
{'OP': 'LOAD', 'src': {'type': 'addresses_WT_ht', 'size': 2, 'AVXalign': True, 'NT': False, 'congruent': 4, 'same': False}}
...
{'OP': 'REPM', 'src': {'type': 'addresses_WT_ht', 'congruent': 9, 'same': False}, 'dst': {'type': 'addresses_UC_ht', 'congruent': 8, 'same': True}}
{'OP': 'STOR', 'dst': {'type': 'addresses_WC_ht', 'size': 32, 'AVXalign': False, 'NT': False, 'congruent': 4, 'same': False}}
{'OP': 'REPM', 'src': {'type': 'addresses_UC_ht', 'congruent': 7, 'same': False}, 'dst': {'type': 'addresses_A_ht', 'congruent': 10, 'same': True}}
{'00': 17859}
