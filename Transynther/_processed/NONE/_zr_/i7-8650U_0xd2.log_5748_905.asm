...
push %rdi
push %rsi
lea addresses_A_ht+0x12410, %rsi
lea addresses_D_ht+0xbb4e, %rdi
nop
nop
and %r8, %r8
mov $35, %rcx
rep movsb
cmp %r15, %r15
lea addresses_WT_ht+0x590e, %rbp
nop
cmp %r14, %r14
movb $0x61, (%rbp)
nop
sub $59400, %r15
lea addresses_D_ht+0x1578e, %r8
nop
nop
nop
nop
...
nop
add %r14, %r14
lea addresses_WT_ht+0x10f4e, %r8
nop
cmp %rdi, %rdi
mov (%r8), %rsi
and %rsi, %rsi
lea addresses_D_ht+0xf34e, %rsi
lea addresses_D_ht+0x9a2, %rdi
xor $14902, %r9
mov $43, %rcx
rep movsq
nop
...
nop
dec %r8
lea addresses_D_ht+0x1214e, %rsi
lea addresses_WC_ht+0x658e, %rdi
nop
add $57194, %r9
mov $103, %rcx
rep movsb
...
nop
cmp $58291, %r14
lea addresses_normal_ht+0x4d1e, %r14
nop
nop
nop
nop
...
nop
and $22655, %r15
lea addresses_UC_ht+0xbcce, %rdi
nop
nop
inc %r15
...
nop
add %rbp, %rbp
lea addresses_WC_ht+0x11a3a, %rdi
nop
nop
nop
cmp %rsi, %rsi
...
nop
inc %rdi
lea addresses_WT_ht+0x17e4e, %rcx
nop
nop
nop
nop
...
nop
sub $37964, %rdi
lea addresses_normal_ht+0xeece, %rsi
lea addresses_UC_ht+0x12b4e, %rdi
nop
nop
nop
cmp $49747, %r15
...
nop
cmp %r14, %r14
lea addresses_WT_ht+0x179a2, %r9
nop
nop
nop
nop
...
{'OP': 'LOAD', 'src': {'type': 'addresses_WT_ht', 'size': 16, 'AVXalign': False, 'NT': True, 'congruent': 8, 'same': False}}
