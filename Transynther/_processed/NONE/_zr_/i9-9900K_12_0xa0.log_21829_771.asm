...
push %rdi
push %rsi
lea addresses_UC_ht+0xbe4d, %r15
nop
nop
nop
nop
...
nop
cmp $11945, %r14
lea addresses_WT_ht+0x430d, %rax
nop
cmp %r8, %r8
vmovups (%rax), %ymm1
...
nop
sub $44795, %rdi
lea addresses_A_ht+0xb41, %rsi
lea addresses_normal_ht+0x9904, %rdi
nop
nop
nop
nop
...
nop
lfence
lea addresses_D_ht+0xb2f5, %rsi
lea addresses_A_ht+0x4941, %rdi
nop
nop
nop
sub %r15, %r15
...
nop
xor $12189, %r14
lea addresses_normal_ht+0xf341, %rsi
lea addresses_UC_ht+0x8b41, %rdi
xor $30765, %r8
mov $73, %rcx
rep movsw
nop
and %rsi, %rsi
lea addresses_WC_ht+0x18d41, %rsi
nop
nop
sub %rax, %rax
mov (%rsi), %r14w
...
nop
sub $40613, %r12
lea addresses_WC_ht+0xaf3d, %rsi
cmp $83, %rax
movl $0x61626364, (%rsi)
nop
and $11902, %rbx
lea addresses_A_ht+0x19563, %rsi
lea addresses_UC_ht+0xf541, %rdi
nop
nop
nop
nop
...
nop
sub %r12, %r12
lea addresses_WC_ht+0x1df13, %rbx
clflush (%rbx)
sub %rcx, %rcx
mov (%rbx), %r14w
nop
...
nop
xor %r12, %r12
lea addresses_WT_ht+0x14141, %r8
add $31565, %rbx
vmovups (%r8), %ymm0
vextracti128 $0, %ymm0, %xmm0
vpextrq $0, %xmm0, %rsi
inc %r14
lea addresses_UC_ht+0x14b21, %rsi
lea addresses_WC_ht+0x15d41, %rdi
clflush (%rdi)
nop
nop
nop
...
{'src': {'same': False, 'congruent': 0, 'type': 'addresses_D_ht'}, 'OP': 'REPM', 'dst': {'same': False, 'congruent': 9, 'type': 'addresses_A_ht'}}
...
{'OP': 'STOR', 'dst': {'NT': False, 'same': False, 'congruent': 2, 'type': 'addresses_WC_ht', 'AVXalign': True, 'size': 4}}
{'src': {'same': False, 'congruent': 1, 'type': 'addresses_A_ht'}, 'OP': 'REPM', 'dst': {'same': False, 'congruent': 9, 'type': 'addresses_UC_ht'}}
