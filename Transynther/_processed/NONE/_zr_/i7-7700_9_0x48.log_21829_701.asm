...
push %rdx
push %rsi
lea addresses_WC_ht+0x1e214, %r8
sub %rcx, %rcx
...
nop
sub %r9, %r9
lea addresses_WC_ht+0x13594, %r11
nop
nop
nop
nop
...
nop
dec %r8
lea addresses_UC_ht+0x19594, %rsi
lea addresses_WC_ht+0xad4, %rdi
nop
nop
nop
nop
...
nop
xor %rsi, %rsi
lea addresses_A_ht+0x16494, %rsi
lea addresses_A_ht+0xb464, %rdi
nop
add $16288, %r13
mov $109, %rcx
rep movsb
...
nop
cmp $8991, %rcx
lea addresses_WT_ht+0xc104, %r11
nop
nop
dec %rsi
...
{'OP': 'STOR', 'dst': {'type': 'addresses_WC_ht', 'AVXalign': False, 'congruent': 10, 'size': 8, 'same': True, 'NT': False}}
{'OP': 'REPM', 'src': {'type': 'addresses_UC_ht', 'congruent': 10, 'same': False}, 'dst': {'type': 'addresses_WC_ht', 'congruent': 6, 'same': False}}
{'OP': 'REPM', 'src': {'type': 'addresses_A_ht', 'congruent': 7, 'same': False}, 'dst': {'type': 'addresses_A_ht', 'congruent': 2, 'same': True}}
