...
push %rdx
push %rsi
lea addresses_WC_ht+0x1e4f0, %rax
nop
nop
nop
sub %rdi, %rdi
...
nop
add %r15, %r15
lea addresses_WT_ht+0x1292a, %rsi
lea addresses_UC_ht+0x16f6a, %rdi
nop
nop
nop
sub $7511, %r10
...
rep movsb
sub $16313, %rdx
lea addresses_WC_ht+0x117c2, %r10
nop
nop
cmp %rcx, %rcx
...
nop
inc %rcx
lea addresses_WC_ht+0x1284a, %rdi
nop
nop
and $42601, %rsi
movb $0x61, (%rdi)
...
nop
inc %rax
lea addresses_WT_ht+0x133ea, %rsi
nop
nop
sub $2706, %r10
mov (%rsi), %ecx
...
nop
cmp $9306, %rdi
lea addresses_WT_ht+0x1196a, %r15
nop
add $49187, %rsi
mov (%r15), %r10w
sub $51544, %rsi
lea addresses_D_ht+0x2e6a, %rdi
nop
nop
nop
inc %rdx
...
nop
cmp $63606, %r10
lea addresses_A_ht+0x19e51, %r15
nop
nop
nop
nop
...
nop
sub $15167, %r15
lea addresses_D_ht+0x1f6a, %rsi
lea addresses_WC_ht+0x88a, %rdi
nop
add %r9, %r9
mov $87, %rcx
rep movsl
...
{'OP': 'STOR', 'dst': {'NT': False, 'same': False, 'congruent': 10, 'type': 'addresses_WT_ht', 'AVXalign': True, 'size': 16}}
...
{'OP': 'STOR', 'dst': {'NT': False, 'same': True, 'congruent': 0, 'type': 'addresses_A_ht', 'AVXalign': True, 'size': 32}}
