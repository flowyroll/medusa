...
push %rdx
push %rsi
lea addresses_normal_ht+0x12e0f, %rsi
lea addresses_A_ht+0xca1f, %rdi
nop
nop
nop
cmp $63916, %r15
...
nop
xor $33885, %r15
lea addresses_UC_ht+0x15f6f, %rsi
lea addresses_WT_ht+0x7e7f, %rdi
sub $20037, %rdx
mov $111, %rcx
rep movsw
and $29560, %r9
lea addresses_UC_ht+0xb441, %rsi
lea addresses_UC_ht+0x3bb7, %rdi
nop
and %rbx, %rbx
mov $98, %rcx
rep movsq
...
// Store
lea addresses_normal+0x137cf, %r14
nop
cmp $57248, %rax
movl $0x51525354, (%r14)
nop
...
{'src': {'congruent': 0, 'same': False, 'type': 'addresses_UC_ht'}, 'OP': 'REPM', 'dst': {'congruent': 3, 'same': False, 'type': 'addresses_UC_ht'}}
{'00': 21829}
