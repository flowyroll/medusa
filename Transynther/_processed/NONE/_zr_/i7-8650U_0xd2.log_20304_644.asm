...
nop
add $27544, %r9
lea addresses_UC_ht+0x959c, %rsi
clflush (%rsi)
nop
xor %rax, %rax
movb (%rsi), %r12b
...
{'OP': 'LOAD', 'src': {'type': 'addresses_PSE', 'size': 4, 'AVXalign': False, 'NT': False, 'congruent': 10, 'same': False}}
