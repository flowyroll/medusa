...
nop
and %rbx, %rbx
lea addresses_normal_ht+0xa5e7, %r12
nop
nop
nop
xor %r9, %r9
...
nop
add %rcx, %rcx
lea addresses_WC_ht+0xf6e7, %rsi
lea addresses_A_ht+0x186a7, %rdi
nop
nop
nop
sub %rbx, %rbx
...
nop
and %r10, %r10
lea addresses_normal_ht+0x8347, %rdi
clflush (%rdi)
nop
nop
nop
...
nop
xor %r10, %r10
lea addresses_D_ht+0x1ae27, %rsi
nop
nop
cmp $47372, %r13
...
movq %rcx, (%rsi)
xor $23552, %rcx
lea addresses_normal_ht+0xd327, %rsi
lea addresses_UC_ht+0x3c7, %rdi
nop
nop
nop
nop
...
rep movsq
cmp $58104, %r13
lea addresses_normal_ht+0x12537, %rcx
cmp $36222, %r10
movb $0x61, (%rcx)
nop
nop
...
nop
cmp $40023, %r13
lea addresses_A_ht+0x12f3f, %rsi
lea addresses_WT_ht+0x8ca7, %rdi
xor $21853, %r13
mov $3, %rcx
rep movsl
nop
and $64798, %rcx
lea addresses_UC_ht+0x91e7, %rsi
lea addresses_D_ht+0x1a3e7, %rdi
nop
nop
nop
xor %r13, %r13
...
nop
and $23982, %rdi
lea addresses_D_ht+0x61c7, %rsi
lea addresses_normal_ht+0x111e7, %rdi
nop
nop
nop
nop
...
nop
add $32105, %rdi
lea addresses_normal_ht+0x135e7, %rbx
nop
nop
nop
nop
...
{'OP': 'REPM', 'src': {'type': 'addresses_WC_ht', 'congruent': 8, 'same': False}, 'dst': {'type': 'addresses_A_ht', 'congruent': 6, 'same': False}}
{'OP': 'STOR', 'dst': {'type': 'addresses_normal_ht', 'AVXalign': True, 'congruent': 5, 'size': 1, 'same': False, 'NT': False}}
...
{'OP': 'REPM', 'src': {'type': 'addresses_UC_ht', 'congruent': 9, 'same': False}, 'dst': {'type': 'addresses_D_ht', 'congruent': 8, 'same': False}}
