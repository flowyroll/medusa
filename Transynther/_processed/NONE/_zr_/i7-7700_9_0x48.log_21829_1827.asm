...
push %rdi
push %rsi
lea addresses_UC_ht+0x8a33, %rsi
xor %r15, %r15
...
nop
and $60635, %r9
lea addresses_normal_ht+0x1b023, %rsi
lea addresses_normal_ht+0x12dc3, %rdi
nop
nop
nop
nop
...
rep movsw
add %r9, %r9
lea addresses_A_ht+0x16943, %rsi
lea addresses_WC_ht+0xfc9f, %rdi
nop
nop
nop
nop
...
nop
xor %r12, %r12
lea addresses_WC_ht+0x4bcf, %rsi
nop
nop
nop
nop
...
nop
xor $30620, %r12
lea addresses_UC_ht+0x9e43, %rsi
add $25252, %rcx
...
nop
xor $62214, %rdi
lea addresses_WT_ht+0x690b, %r13
nop
nop
add %rcx, %rcx
movl $0x61626364, (%r13)
...
nop
cmp %rdi, %rdi
lea addresses_UC_ht+0x129bf, %r9
nop
nop
nop
and $58876, %r12
...
lea addresses_A_ht+0x163de, %rdi
nop
nop
cmp %r10, %r10
mov $101, %rcx
...
<gen_prepare_buffer>
{'OP': 'STOR', 'dst': {'type': 'addresses_UC_ht', 'AVXalign': True, 'congruent': 4, 'size': 8, 'same': False, 'NT': True}}
