...
push %rdi
push %rsi
lea addresses_WT_ht+0xe1ad, %rsi
lea addresses_WC_ht+0xe14d, %rdi
and %r15, %r15
mov $17, %rcx
rep movsq
nop
add %r10, %r10
lea addresses_UC_ht+0x1e94d, %rsi
nop
nop
and %rbx, %rbx
mov (%rsi), %rdi
...
nop
sub %rbx, %rbx
lea addresses_UC_ht+0x109ef, %rsi
lea addresses_A_ht+0x9b05, %rdi
nop
nop
add %r8, %r8
mov $69, %rcx
...
nop
sub $22627, %r10
lea addresses_UC_ht+0x1cb4d, %r8
nop
nop
nop
nop
...
nop
sub %rsi, %rsi
lea addresses_UC_ht+0x1c6e5, %r10
nop
dec %r15
movb $0x61, (%r10)
nop
nop
add %rbx, %rbx
lea addresses_normal_ht+0x18a0d, %rsi
and $16268, %r15
...
lea addresses_normal_ht+0x6b4d, %rdi
nop
nop
nop
and $53846, %r11
...
{'OP': 'STOR', 'dst': {'type': 'addresses_normal_ht', 'size': 32, 'AVXalign': True, 'NT': True, 'congruent': 6, 'same': True}}
