...
push %rdx
push %rsi
lea addresses_WT_ht+0xf0ec, %rsi
lea addresses_D_ht+0x1a70c, %rdi
nop
nop
nop
nop
...
rep movsq
add $24492, %r10
lea addresses_WT_ht+0x3a9e, %rdi
nop
nop
xor $43076, %r8
mov (%rdi), %si
...
nop
add %rcx, %rcx
lea addresses_WT_ht+0xb568, %rsi
sub $49567, %r13
...
vpextrq $0, %xmm4, %rdx
sub $7277, %rsi
lea addresses_normal_ht+0xd8ec, %rcx
nop
nop
nop
nop
...
nop
xor $52510, %r13
lea addresses_UC_ht+0x1746c, %rcx
sub %r13, %r13
mov (%rcx), %esi
nop
nop
...
nop
cmp $16681, %rsi
lea addresses_WT_ht+0xe2ec, %rsi
lea addresses_UC_ht+0x15c7, %rdi
nop
nop
nop
nop
