...
push %rdi
push %rsi
lea addresses_WC_ht+0x69ac, %rsi
...
nop
and $23310, %r13
lea addresses_A_ht+0x1730c, %rax
nop
nop
nop
sub %r10, %r10
...
nop
sub $17576, %rsi
lea addresses_UC_ht+0x13bd8, %rsi
lea addresses_D_ht+0x1301c, %rdi
sub %r9, %r9
mov $52, %rcx
rep movsw
nop
...
// Store
lea addresses_normal+0xaddc, %rax
nop
nop
nop
cmp %r8, %r8
