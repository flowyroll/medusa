...
nop
and %rdi, %rdi
lea addresses_D_ht+0x18ee0, %rsi
lea addresses_A_ht+0xa740, %rdi
sub $43794, %r11
mov $73, %rcx
rep movsb
xor %rbp, %rbp
lea addresses_normal_ht+0x268, %rbx
nop
sub %rcx, %rcx
mov (%rbx), %r12w
nop
and $60534, %r12
lea addresses_WC_ht+0x1be60, %rsi
nop
nop
nop
nop
...
vpextrq $1, %xmm4, %rbp
and $37958, %rdi
lea addresses_normal_ht+0x1bee0, %rsi
nop
nop
nop
nop
...
<gen_prepare_buffer>
{'OP': 'REPM', 'src': {'same': False, 'type': 'addresses_WT_ht', 'congruent': 11}, 'dst': {'same': False, 'type': 'addresses_UC_ht', 'congruent': 11}}
{'OP': 'STOR', 'dst': {'size': 8, 'NT': False, 'type': 'addresses_D_ht', 'same': False, 'AVXalign': False, 'congruent': 3}}
{'OP': 'REPM', 'src': {'same': False, 'type': 'addresses_D_ht', 'congruent': 10}, 'dst': {'same': False, 'type': 'addresses_A_ht', 'congruent': 3}}
