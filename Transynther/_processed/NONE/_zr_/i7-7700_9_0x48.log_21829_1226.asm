...
push %rdx
push %rsi
lea addresses_normal_ht+0x7c5b, %rsi
lea addresses_WC_ht+0x3d82, %rdi
nop
nop
sub %r15, %r15
mov $48, %rcx
...
nop
sub $31153, %rdx
lea addresses_A_ht+0x110e2, %r11
nop
nop
nop
nop
...
nop
sub $24859, %rdi
lea addresses_WT_ht+0x9c02, %rsi
add $58049, %rbx
mov (%rsi), %r15
nop
nop
...
nop
cmp %rbx, %rbx
lea addresses_UC_ht+0x19802, %rsi
lea addresses_D_ht+0x3762, %rdi
clflush (%rdi)
add $39257, %r12
mov $113, %rcx
rep movsb
...
nop
sub $10660, %rcx
lea addresses_WT_ht+0xbd02, %rdx
xor $28405, %rbx
movb (%rdx), %cl
nop
nop
...
// Store
lea addresses_normal+0xef82, %r15
sub $24069, %r11
movl $0x51525354, (%r15)
nop
nop
...
{'OP': 'REPM', 'src': {'type': 'addresses_UC_ht', 'congruent': 7, 'same': False}, 'dst': {'type': 'addresses_D_ht', 'congruent': 5, 'same': True}}
