...
push %rdx
push %rsi
lea addresses_D_ht+0x1a16f, %rsi
lea addresses_WC_ht+0x44e3, %rdi
clflush (%rsi)
nop
nop
nop
...
rep movsq
inc %rsi
lea addresses_UC_ht+0x1e2bb, %rbx
nop
nop
nop
nop
...
nop
cmp %r12, %r12
lea addresses_WC_ht+0x84e3, %rbx
nop
nop
nop
nop
...
mov (%rbx), %r11w
xor %r11, %r11
lea addresses_WT_ht+0xe473, %rsi
...
nop
dec %rcx
lea addresses_UC_ht+0x1bbe3, %r11
nop
nop
xor %rcx, %rcx
mov (%r11), %rax
...
{'OP': 'REPM', 'src': {'type': 'addresses_WT_ht', 'congruent': 4, 'same': True}, 'dst': {'type': 'addresses_WT_ht', 'congruent': 2, 'same': False}}
