...
nop
dec %r11
lea addresses_normal_ht+0x146eb, %rdi
nop
nop
sub %rbx, %rbx
movb $0x61, (%rdi)
cmp %rax, %rax
lea addresses_WT_ht+0xb6c7, %rsi
...
nop
dec %rdi
lea addresses_UC_ht+0x1954b, %rsi
lea addresses_WC_ht+0xe4cb, %rdi
nop
nop
nop
nop
...
lea addresses_WC_ht+0x1311b, %rdi
nop
cmp $51675, %r9
mov $95, %rcx
rep movsw
...
nop
and %rax, %rax
lea addresses_WC_ht+0x1caeb, %r9
nop
nop
and %r10, %r10
...
nop
xor $27643, %r11
lea addresses_WC_ht+0x2ceb, %rsi
nop
nop
nop
nop
...
nop
cmp $29855, %rax
lea addresses_normal_ht+0x1c8eb, %rbx
nop
nop
nop
nop
...
nop
dec %rdi
lea addresses_normal_ht+0x2547, %rsi
lea addresses_UC_ht+0x1843b, %rdi
nop
nop
nop
nop
...
nop
add $516, %r9
lea addresses_WC_ht+0x43d3, %rcx
nop
nop
nop
nop
...
nop
xor %rsi, %rsi
lea addresses_UC_ht+0x7aeb, %rsi
...
nop
xor %rcx, %rcx
lea addresses_A_ht+0x1578b, %rsi
lea addresses_UC_ht+0xbd9b, %rdi
nop
nop
nop
nop
...
{'OP': 'REPM', 'src': {'type': 'addresses_WT_ht', 'congruent': 2, 'same': True}, 'dst': {'type': 'addresses_normal_ht', 'congruent': 5, 'same': False}}
{'OP': 'REPM', 'src': {'type': 'addresses_UC_ht', 'congruent': 4, 'same': False}, 'dst': {'type': 'addresses_WC_ht', 'congruent': 5, 'same': False}}
{'OP': 'REPM', 'src': {'type': 'addresses_normal_ht', 'congruent': 4, 'same': False}, 'dst': {'type': 'addresses_WC_ht', 'congruent': 4, 'same': False}}
...
{'OP': 'REPM', 'src': {'type': 'addresses_UC_ht', 'congruent': 9, 'same': False}, 'dst': {'type': 'addresses_UC_ht', 'congruent': 0, 'same': False}}
