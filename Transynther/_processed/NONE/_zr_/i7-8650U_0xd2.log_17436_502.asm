...
push %rdi
push %rsi
lea addresses_D_ht+0xcee8, %rsi
lea addresses_WT_ht+0xe6e8, %rdi
clflush (%rdi)
nop
inc %r12
mov $89, %rcx
...
nop
and $56454, %r14
lea addresses_normal_ht+0x440c, %r13
clflush (%r13)
nop
nop
add %rcx, %rcx
...
nop
inc %rdi
lea addresses_UC_ht+0xf8f8, %rsi
lea addresses_A_ht+0xac10, %rdi
clflush (%rdi)
nop
nop
sub %r9, %r9
...
nop
sub $63316, %rcx
lea addresses_A_ht+0x1b3c8, %rsi
sub $58372, %r13
movl $0x61626364, (%rsi)
nop
nop
nop
and %rdi, %rdi
lea addresses_WC_ht+0x1a6e8, %rsi
lea addresses_D_ht+0x6abc, %rdi
nop
nop
nop
nop
...
nop
sub $35088, %r9
lea addresses_WT_ht+0xcee8, %rcx
nop
nop
nop
nop
...
nop
inc %r9
lea addresses_A_ht+0x1409c, %rsi
clflush (%rsi)
nop
sub %r14, %r14
movb $0x61, (%rsi)
...
nop
cmp %r12, %r12
lea addresses_normal_ht+0x1e0b8, %rsi
nop
nop
nop
nop
...
<gen_prepare_buffer>
{'OP': 'REPM', 'src': {'type': 'addresses_D_ht', 'congruent': 11, 'same': False}, 'dst': {'type': 'addresses_WT_ht', 'congruent': 8, 'same': False}}
