...
nop
sub $27503, %r11
lea addresses_UC_ht+0x70c2, %rsi
...
nop
xor $21788, %rsi
lea addresses_WT_ht+0xb202, %rsi
lea addresses_A_ht+0x2ec2, %rdi
nop
nop
nop
xor %r12, %r12
...
nop
cmp %rdi, %rdi
lea addresses_WC_ht+0x12102, %r11
nop
cmp $16756, %rdi
movups (%r11), %xmm1
vpextrq $0, %xmm1, %rsi
...
{'src': {'same': False, 'congruent': 9, 'type': 'addresses_UC_ht'}, 'OP': 'REPM', 'dst': {'same': True, 'congruent': 7, 'type': 'addresses_UC_ht'}}
{'src': {'same': False, 'congruent': 5, 'type': 'addresses_WT_ht'}, 'OP': 'REPM', 'dst': {'same': False, 'congruent': 9, 'type': 'addresses_A_ht'}}
