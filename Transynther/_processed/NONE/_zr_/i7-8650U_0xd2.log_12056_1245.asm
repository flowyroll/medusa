...
nop
cmp $46561, %rsi
lea addresses_UC_ht+0x18d4, %r15
clflush (%r15)
add $5977, %rax
...
nop
and %rax, %rax
lea addresses_WT_ht+0xf818, %rsi
lea addresses_D_ht+0xdc14, %rdi
nop
nop
nop
nop
...
nop
and %rbp, %rbp
lea addresses_A_ht+0x11ade, %rsi
lea addresses_A_ht+0x1e054, %rdi
clflush (%rdi)
nop
nop
nop
...
nop
and %rsi, %rsi
lea addresses_UC_ht+0x1a894, %r11
nop
nop
nop
nop
...
nop
add $19890, %r15
lea addresses_D_ht+0x10954, %rcx
and %rsi, %rsi
mov (%rcx), %r11w
nop
sub $39579, %rcx
...
nop
sub $45020, %rbp
lea addresses_D_ht+0x11154, %rsi
lea addresses_WC_ht+0xbadc, %rdi
and %r11, %r11
mov $76, %rcx
rep movsl
nop
...
{'OP': 'REPM', 'src': {'type': 'addresses_D_ht', 'congruent': 10, 'same': True}, 'dst': {'type': 'addresses_WC_ht', 'congruent': 3, 'same': False}}
{'00': 12056}
