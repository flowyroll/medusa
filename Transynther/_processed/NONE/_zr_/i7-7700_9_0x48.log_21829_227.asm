...
push %rdi
push %rsi
lea addresses_normal_ht+0x62a3, %r12
clflush (%r12)
sub $17436, %rsi
mov (%r12), %r14d
nop
...
nop
xor %r8, %r8
lea addresses_WT_ht+0x2d83, %rdi
nop
nop
nop
nop
...
nop
xor $22481, %r8
lea addresses_UC_ht+0xda3, %rsi
lea addresses_WC_ht+0xaf63, %rdi
clflush (%rdi)
nop
nop
nop
...
nop
sub $8444, %r12
lea addresses_WC_ht+0x15da3, %rsi
nop
nop
nop
inc %r9
mov (%rsi), %r14w
sub %r8, %r8
lea addresses_UC_ht+0x89fc, %rsi
lea addresses_WT_ht+0x2b13, %rdi
nop
nop
add $62238, %r14
mov $87, %rcx
rep movsw
and %rdi, %rdi
lea addresses_UC_ht+0x5c93, %rsi
lea addresses_A_ht+0x1c203, %rdi
nop
nop
nop
and $2292, %r8
...
{'OP': 'LOAD', 'src': {'type': 'addresses_WT_ht', 'AVXalign': False, 'congruent': 1, 'size': 16, 'same': False, 'NT': True}}
...
{'OP': 'REPM', 'src': {'type': 'addresses_UC_ht', 'congruent': 4, 'same': False}, 'dst': {'type': 'addresses_A_ht', 'congruent': 5, 'same': True}}
{'00': 21829}
