...
nop
cmp $8595, %r14
lea addresses_D_ht+0x5b92, %rsi
lea addresses_WT_ht+0xae6, %rdi
nop
sub $8889, %r10
mov $17, %rcx
rep movsw
...
nop
inc %rbp
lea addresses_WC_ht+0xcb47, %rcx
nop
nop
sub $28016, %r8
...
nop
dec %r14
lea addresses_UC_ht+0x162ea, %rsi
lea addresses_A_ht+0x1e5f6, %rdi
nop
cmp $33191, %rbp
mov $96, %rcx
rep movsw
...
nop
xor %r10, %r10
lea addresses_WT_ht+0x15111, %rsi
lea addresses_normal_ht+0x1b6d6, %rdi
nop
nop
sub %r12, %r12
mov $38, %rcx
...
nop
xor %rbp, %rbp
lea addresses_UC_ht+0x16f4e, %rsi
lea addresses_D_ht+0xe5b6, %rdi
nop
nop
nop
nop
...
nop
and %rbp, %rbp
lea addresses_normal_ht+0x1c44a, %rsi
lea addresses_WC_ht+0x4a76, %rdi
nop
nop
dec %rbp
mov $115, %rcx
...
nop
and %r10, %r10
lea addresses_UC_ht+0x12cf6, %rsi
lea addresses_WT_ht+0x1976, %rdi
nop
nop
xor $3627, %r12
mov $96, %rcx
...
nop
xor %r10, %r10
lea addresses_normal_ht+0x8576, %rsi
lea addresses_UC_ht+0x2d4e, %rdi
clflush (%rdi)
and %r14, %r14
mov $89, %rcx
rep movsl
...
{'OP': 'LOAD', 'src': {'size': 16, 'NT': False, 'type': 'addresses_UC', 'same': False, 'AVXalign': True, 'congruent': 0}}
...
<gen_prepare_buffer>
{'OP': 'REPM', 'src': {'same': False, 'type': 'addresses_WC_ht', 'congruent': 2}, 'dst': {'same': True, 'type': 'addresses_normal_ht', 'congruent': 5}}
{'OP': 'LOAD', 'src': {'size': 2, 'NT': False, 'type': 'addresses_WC_ht', 'same': False, 'AVXalign': False, 'congruent': 11}}
{'OP': 'REPM', 'src': {'same': False, 'type': 'addresses_D_ht', 'congruent': 2}, 'dst': {'same': False, 'type': 'addresses_WT_ht', 'congruent': 3}}
{'OP': 'STOR', 'dst': {'size': 8, 'NT': False, 'type': 'addresses_WC_ht', 'same': False, 'AVXalign': False, 'congruent': 0}}
{'OP': 'REPM', 'src': {'same': False, 'type': 'addresses_UC_ht', 'congruent': 2}, 'dst': {'same': False, 'type': 'addresses_A_ht', 'congruent': 7}}
...
{'OP': 'REPM', 'src': {'same': True, 'type': 'addresses_normal_ht', 'congruent': 8}, 'dst': {'same': False, 'type': 'addresses_UC_ht', 'congruent': 2}}
{'00': 21829}
