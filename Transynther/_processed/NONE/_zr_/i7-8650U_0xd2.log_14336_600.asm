...
push %rdi
push %rsi
lea addresses_WT_ht+0x54c5, %r10
clflush (%r10)
nop
nop
nop
...
nop
and $30071, %rbp
lea addresses_normal_ht+0x105c5, %r10
nop
and $14778, %rcx
...
lea addresses_WT_ht+0xc4f5, %rdi
nop
nop
nop
nop
...
nop
cmp %rsi, %rsi
lea addresses_normal_ht+0x1c0c5, %rsi
lea addresses_A_ht+0xa8c5, %rdi
clflush (%rsi)
clflush (%rdi)
nop
nop
...
nop
cmp %rsi, %rsi
lea addresses_UC_ht+0x3825, %rsi
nop
nop
cmp %r10, %r10
movb (%rsi), %r8b
nop
and %rcx, %rcx
lea addresses_normal_ht+0xdcc5, %rcx
clflush (%rcx)
nop
sub %rdi, %rdi
...
{'OP': 'REPM', 'src': {'type': 'addresses_normal_ht', 'congruent': 11, 'same': True}, 'dst': {'type': 'addresses_A_ht', 'congruent': 11, 'same': False}}
