...
push %rdi
push %rsi
lea addresses_WT_ht+0x1679b, %rsi
lea addresses_D_ht+0x14b9b, %rdi
nop
nop
cmp $49295, %r9
mov $69, %rcx
...
nop
cmp %rcx, %rcx
lea addresses_WC_ht+0xd655, %rsi
lea addresses_WT_ht+0x1b9bb, %rdi
nop
nop
nop
nop
...
nop
add %rcx, %rcx
lea addresses_WC_ht+0xe2db, %rsi
nop
nop
mfence
movb $0x61, (%rsi)
...
nop
dec %rdi
lea addresses_WC_ht+0x185a6, %rsi
lea addresses_WT_ht+0xa79b, %rdi
nop
inc %r12
mov $30, %rcx
rep movsq
...
nop
and %rsi, %rsi
lea addresses_D_ht+0x12a1b, %rsi
lea addresses_A_ht+0x18feb, %rdi
nop
nop
nop
nop
...
nop
inc %r13
lea addresses_normal_ht+0x249b, %rsi
lea addresses_normal_ht+0x1a79b, %rdi
clflush (%rsi)
nop
lfence
mov $69, %rcx
...
nop
cmp %r13, %r13
lea addresses_UC_ht+0x103fb, %rsi
lea addresses_D_ht+0x19899, %rdi
nop
nop
nop
nop
...
nop
and %r12, %r12
lea addresses_WT_ht+0x1339b, %rsi
lea addresses_WC_ht+0x185c3, %rdi
nop
nop
nop
xor $39087, %r14
...
nop
dec %rdi
lea addresses_WT_ht+0x1c99b, %r9
nop
nop
xor %r12, %r12
movl $0x61626364, (%r9)
...
nop
and $63028, %rcx
lea addresses_A_ht+0x1a5bb, %r15
nop
xor %r13, %r13
movb (%r15), %r9b
nop
...
<gen_prepare_buffer>
{'OP': 'REPM', 'src': {'type': 'addresses_WT_ht', 'congruent': 6, 'same': True}, 'dst': {'type': 'addresses_D_ht', 'congruent': 5, 'same': False}}
...
{'OP': 'STOR', 'dst': {'type': 'addresses_WT_ht', 'AVXalign': True, 'congruent': 8, 'size': 4, 'same': False, 'NT': False}}
{'OP': 'STOR', 'dst': {'type': 'addresses_A_ht', 'AVXalign': True, 'congruent': 6, 'size': 8, 'same': False, 'NT': True}}
