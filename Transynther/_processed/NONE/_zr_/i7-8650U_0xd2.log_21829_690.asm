...
push %rdi
push %rsi
lea addresses_normal_ht+0x7c1, %rsi
lea addresses_A_ht+0x1db25, %rdi
inc %r8
mov $102, %rcx
rep movsl
nop
nop
cmp %r14, %r14
lea addresses_WC_ht+0xd265, %rsi
...
nop
sub %r10, %r10
lea addresses_WC_ht+0x1a165, %r14
xor %rbp, %rbp
mov (%r14), %r10w
nop
nop
...
nop
add %r8, %r8
lea addresses_D_ht+0x1d4e5, %r10
nop
nop
xor %r8, %r8
movw $0x6162, (%r10)
...
nop
cmp %r10, %r10
lea addresses_WC_ht+0x12165, %rdi
clflush (%rdi)
nop
nop
dec %rcx
...
nop
dec %r14
lea addresses_WC_ht+0x10365, %r8
nop
nop
add %rbp, %rbp
movb (%r8), %r14b
...
lea addresses_UC_ht+0xca71, %rdi
nop
nop
cmp $18855, %r8
mov $36, %rcx
rep movsq
dec %rbp
lea addresses_normal_ht+0x14c25, %r8
dec %r10
movw $0x6162, (%r8)
nop
nop
...
nop
xor %r10, %r10
lea addresses_D_ht+0x17565, %rcx
clflush (%rcx)
nop
nop
and %rsi, %rsi
...
nop
xor %rsi, %rsi
lea addresses_D_ht+0x1d165, %rsi
lea addresses_WT_ht+0xc165, %rdi
and %rbp, %rbp
mov $25, %rcx
rep movsl
nop
...
nop
and %r8, %r8
lea addresses_normal_ht+0x1dce5, %rbp
nop
nop
and %r10, %r10
movb (%rbp), %cl
...
{'OP': 'LOAD', 'src': {'type': 'addresses_WT', 'size': 4, 'AVXalign': False, 'NT': False, 'congruent': 10, 'same': False}}
[Faulty Load]
...
{'OP': 'REPM', 'src': {'type': 'addresses_WC_ht', 'congruent': 6, 'same': True}, 'dst': {'type': 'addresses_WT_ht', 'congruent': 4, 'same': False}}
