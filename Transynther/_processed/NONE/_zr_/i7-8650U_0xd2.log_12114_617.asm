...
lea addresses_UC_ht+0x1944a, %rdi
clflush (%rsi)
and $34548, %r9
mov $74, %rcx
rep movsw
xor %rsi, %rsi
lea addresses_WC_ht+0x43cc, %rbp
cmp %r8, %r8
mov (%rbp), %rsi
nop
nop
...
nop
and %rbp, %rbp
lea addresses_UC_ht+0x214a, %rbp
nop
nop
nop
nop
...
nop
add %r9, %r9
lea addresses_WT_ht+0x1434a, %rsi
nop
nop
nop
nop
...
nop
cmp %rbp, %rbp
lea addresses_A_ht+0x1c33e, %rcx
and %rdx, %rdx
mov (%rcx), %rsi
nop
nop
...
nop
dec %rcx
lea addresses_WC_ht+0x1d48a, %rdi
nop
nop
nop
nop
...
nop
and %rdi, %rdi
lea addresses_UC_ht+0x1554a, %rsi
lea addresses_A_ht+0x173e2, %rdi
dec %r10
mov $77, %rcx
rep movsl
and $59798, %r9
lea addresses_WC_ht+0x18eec, %rsi
lea addresses_normal_ht+0x754a, %rdi
nop
nop
nop
nop
...
{'OP': 'STOR', 'dst': {'type': 'addresses_P', 'size': 8, 'AVXalign': True, 'NT': False, 'congruent': 4, 'same': False}}
[Faulty Load]
...
{'OP': 'STOR', 'dst': {'type': 'addresses_WC_ht', 'size': 2, 'AVXalign': True, 'NT': False, 'congruent': 5, 'same': False}}
{'OP': 'REPM', 'src': {'type': 'addresses_UC_ht', 'congruent': 10, 'same': False}, 'dst': {'type': 'addresses_A_ht', 'congruent': 3, 'same': False}}
{'OP': 'REPM', 'src': {'type': 'addresses_WC_ht', 'congruent': 1, 'same': True}, 'dst': {'type': 'addresses_normal_ht', 'congruent': 9, 'same': False}}
{'00': 12114}
