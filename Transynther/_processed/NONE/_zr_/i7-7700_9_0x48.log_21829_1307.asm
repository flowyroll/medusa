...
push %rdx
push %rsi
lea addresses_WC_ht+0x104ed, %rsi
lea addresses_A_ht+0x9205, %rdi
sub %rdx, %rdx
mov $43, %rcx
rep movsb
nop
...
nop
add %r10, %r10
lea addresses_D_ht+0x17205, %rdx
cmp %rsi, %rsi
...
nop
xor $15005, %rsi
lea addresses_D_ht+0x11b05, %r15
nop
nop
nop
lfence
...
movups %xmm4, (%r15)
xor $26352, %rdx
lea addresses_WC_ht+0x5205, %rdi
nop
sub %rdx, %rdx
...
nop
add %r8, %r8
lea addresses_UC_ht+0x1c605, %rsi
lea addresses_WC_ht+0x11605, %rdi
nop
nop
nop
nop
...
nop
add %r15, %r15
lea addresses_WT_ht+0x1d6fd, %r8
clflush (%r8)
nop
xor %rdi, %rdi
mov (%r8), %cx
...
nop
xor %r10, %r10
lea addresses_D_ht+0x1b205, %rsi
lea addresses_UC_ht+0xac03, %rdi
nop
nop
nop
sub %rax, %rax
...
nop
add $30268, %rcx
lea addresses_normal_ht+0x146bd, %r8
nop
nop
nop
xor $39935, %rdx
...
{'OP': 'LOAD', 'src': {'type': 'addresses_UC_ht', 'AVXalign': True, 'congruent': 6, 'size': 2, 'same': False, 'NT': False}}
