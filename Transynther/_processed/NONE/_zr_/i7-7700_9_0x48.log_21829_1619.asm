...
push %rdi
push %rsi
lea addresses_WC_ht+0x1669e, %rsi
lea addresses_normal_ht+0x1579e, %rdi
nop
dec %rbp
mov $69, %rcx
rep movsw
...
nop
and %r10, %r10
lea addresses_WT_ht+0xd786, %rsi
lea addresses_D_ht+0x20da, %rdi
cmp $34923, %r10
mov $92, %rcx
rep movsl
nop
...
nop
and %r10, %r10
lea addresses_normal_ht+0xde9e, %r12
cmp %rsi, %rsi
movups (%r12), %xmm0
vpextrq $1, %xmm0, %rcx
nop
nop
sub %r10, %r10
lea addresses_normal_ht+0xc0be, %rbp
nop
nop
nop
nop
...
{'OP': 'STOR', 'dst': {'type': 'addresses_UC', 'AVXalign': True, 'congruent': 9, 'size': 8, 'same': False, 'NT': False}}
[Faulty Load]
