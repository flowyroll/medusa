...
lea addresses_UC_ht+0x19365, %rdi
nop
cmp %rbx, %rbx
mov $75, %rcx
rep movsq
...
nop
cmp %rbx, %rbx
lea addresses_A_ht+0x33ad, %r12
and $39560, %rcx
mov $0x6162636465666768, %rdx
movq %rdx, (%r12)
add $3860, %r12
lea addresses_WC_ht+0x1aca5, %rsi
lea addresses_D_ht+0x1cca5, %rdi
nop
nop
nop
nop
...
nop
xor %rcx, %rcx
lea addresses_D_ht+0x194a5, %rbx
nop
nop
inc %rdx
...
nop
sub $30184, %rdx
lea addresses_D_ht+0x1dca5, %rbx
xor %rsi, %rsi
...
lea addresses_D_ht+0x18915, %rdi
clflush (%rsi)
nop
nop
nop
...
rep movsq
add %rdi, %rdi
lea addresses_WT_ht+0x2797, %r10
nop
nop
nop
nop
...
nop
dec %rdx
lea addresses_UC_ht+0x1cba5, %rdx
nop
nop
cmp %r12, %r12
mov (%rdx), %r10w
...
{'OP': 'LOAD', 'src': {'size': 16, 'NT': False, 'type': 'addresses_D_ht', 'same': False, 'AVXalign': True, 'congruent': 10}}
