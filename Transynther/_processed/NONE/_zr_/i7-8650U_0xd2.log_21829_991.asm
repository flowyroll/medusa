...
push %rdx
push %rsi
lea addresses_D_ht+0x17540, %rsi
...
nop
dec %rdx
lea addresses_WT_ht+0xb140, %rbx
and $22418, %r10
...
nop
and $17859, %rcx
lea addresses_WC_ht+0xe7c8, %rsi
nop
lfence
mov (%rsi), %rdi
nop
...
nop
cmp %rdx, %rdx
lea addresses_D_ht+0x1ba40, %rsi
clflush (%rsi)
nop
nop
xor %rbx, %rbx
...
nop
xor %rbx, %rbx
lea addresses_D_ht+0xea0, %rsi
lea addresses_UC_ht+0x140, %rdi
clflush (%rdi)
nop
nop
xor $47639, %r12
...
<gen_prepare_buffer>
{'OP': 'REPM', 'src': {'type': 'addresses_D_ht', 'congruent': 9, 'same': True}, 'dst': {'type': 'addresses_D_ht', 'congruent': 5, 'same': False}}
