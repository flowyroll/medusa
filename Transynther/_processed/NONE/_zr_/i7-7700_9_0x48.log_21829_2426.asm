...
push %rdx
push %rsi
lea addresses_WC_ht+0xe66b, %rdx
dec %r13
mov (%rdx), %r10d
nop
nop
...
nop
and $29543, %rdi
lea addresses_normal_ht+0x1566b, %rsi
lea addresses_UC_ht+0x18e6b, %rdi
nop
nop
add %rax, %rax
mov $51, %rcx
...
nop
sub $55172, %rdx
lea addresses_normal_ht+0x1c25b, %rdi
and %r10, %r10
movups (%rdi), %xmm3
vpextrq $1, %xmm3, %rax
nop
...
nop
inc %r13
lea addresses_D_ht+0x20b1, %rsi
lea addresses_WT_ht+0x1206b, %rdi
nop
nop
inc %r10
mov $52, %rcx
...
nop
and $47712, %rsi
lea addresses_normal_ht+0x53c5, %rax
nop
nop
nop
nop
...
movl $0x61626364, (%rax)
and $41187, %rdi
lea addresses_WC_ht+0x666b, %rax
clflush (%rax)
nop
nop
add %rdx, %rdx
...
nop
sub %r10, %r10
lea addresses_WC_ht+0x1a26b, %rsi
...
{'OP': 'REPM', 'src': {'type': 'addresses_D_ht', 'congruent': 1, 'same': True}, 'dst': {'type': 'addresses_WT_ht', 'congruent': 9, 'same': False}}
{'OP': 'STOR', 'dst': {'type': 'addresses_normal_ht', 'AVXalign': False, 'congruent': 1, 'size': 4, 'same': False, 'NT': True}}
