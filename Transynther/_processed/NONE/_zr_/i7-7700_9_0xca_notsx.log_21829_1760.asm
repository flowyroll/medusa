...
push %rbp
push %rbx
lea addresses_WT_ht+0x19b52, %rax
clflush (%rax)
nop
nop
cmp %r9, %r9
...
nop
inc %r11
lea addresses_UC_ht+0x4552, %r10
nop
nop
nop
cmp %rbx, %rbx
...
nop
and $33496, %rbp
lea addresses_normal_ht+0xa752, %r9
nop
nop
nop
nop
...
// Store
lea addresses_normal+0x14692, %rbp
nop
nop
nop
sub $10302, %r13
...
// REPMOV
lea addresses_US+0xe422, %rsi
lea addresses_RW+0xbd52, %rdi
clflush (%rdi)
dec %r8
mov $1, %rcx
rep movsb
...
// Store
lea addresses_normal+0x9d52, %rax
nop
nop
dec %r8
movw $0x5152, (%rax)
...
{'src': {'congruent': 4, 'same': False, 'type': 'addresses_US'}, 'dst': {'congruent': 0, 'same': True, 'type': 'addresses_RW'}, 'OP': 'REPM'}
{'dst': {'NT': False, 'AVXalign': False, 'size': 32, 'congruent': 0, 'same': True, 'type': 'addresses_RW'}, 'OP': 'STOR'}
{'dst': {'NT': True, 'AVXalign': False, 'size': 2, 'congruent': 9, 'same': False, 'type': 'addresses_normal'}, 'OP': 'STOR'}
[Faulty Load]
...
{'src': {'NT': False, 'AVXalign': True, 'size': 32, 'congruent': 5, 'same': False, 'type': 'addresses_normal_ht'}, 'OP': 'LOAD'}
{'00': 21829}
