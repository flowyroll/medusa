...
nop
and %rdi, %rdi
lea addresses_normal_ht+0x435, %rdi
nop
nop
sub %r15, %r15
...
nop
sub $34090, %rbx
lea addresses_A_ht+0x16e75, %rsi
lea addresses_WT_ht+0x3775, %rdi
nop
nop
nop
nop
...
nop
xor $57680, %rdx
lea addresses_WC_ht+0x4ef5, %rdi
nop
add %rcx, %rcx
movl $0x61626364, (%rdi)
nop
