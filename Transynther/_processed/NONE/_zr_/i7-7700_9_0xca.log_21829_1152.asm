...
push %rdi
push %rsi
lea addresses_WC_ht+0x1a941, %r15
nop
nop
nop
nop
...
mov (%r15), %rdi
dec %rsi
lea addresses_WC_ht+0x7576, %rbx
nop
nop
sub %rbp, %rbp
vmovups (%rbx), %ymm2
...
nop
dec %r8
lea addresses_WC_ht+0xe376, %rsi
lea addresses_normal_ht+0xb176, %rdi
nop
nop
mfence
mov $60, %rcx
...
nop
cmp %rcx, %rcx
lea addresses_A_ht+0x15c2c, %r10
nop
inc %rbx
...
// Load
lea addresses_normal+0x3696, %r12
nop
nop
nop
nop
...
{'src': {'congruent': 8, 'same': False, 'type': 'addresses_WC_ht'}, 'OP': 'REPM', 'dst': {'congruent': 4, 'same': False, 'type': 'addresses_normal_ht'}}
