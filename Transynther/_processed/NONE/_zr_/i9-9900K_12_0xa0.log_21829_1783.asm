...
nop
cmp %r10, %r10
lea addresses_normal_ht+0x19b84, %r9
nop
nop
nop
nop
...
nop
xor %rdx, %rdx
lea addresses_WT_ht+0x6304, %r10
nop
nop
add %r9, %r9
...
nop
cmp $20621, %r15
lea addresses_WC_ht+0x71c4, %rsi
nop
nop
nop
inc %rdi
...
nop
cmp $3278, %r10
lea addresses_A_ht+0x1c704, %rsi
lea addresses_WT_ht+0x3304, %rdi
clflush (%rdi)
inc %r9
mov $69, %rcx
rep movsb
