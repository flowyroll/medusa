...
push %rdi
push %rsi
lea addresses_D_ht+0x121a2, %rsi
nop
nop
nop
nop
...
nop
xor $8831, %r14
lea addresses_UC_ht+0x505a, %rsi
lea addresses_normal_ht+0x4342, %rdi
nop
nop
nop
nop
...
nop
xor %rax, %rax
lea addresses_D_ht+0x1306c, %rsi
...
nop
inc %rbp
lea addresses_WC_ht+0x8f22, %rsi
sub %r14, %r14
movb (%rsi), %r8b
nop
nop
...
{'OP': 'REPM', 'src': {'same': True, 'type': 'addresses_D_ht', 'congruent': 0}, 'dst': {'same': False, 'type': 'addresses_WC_ht', 'congruent': 10}}
