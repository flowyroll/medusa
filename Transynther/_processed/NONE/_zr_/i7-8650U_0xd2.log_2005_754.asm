...
push %rdx
push %rsi
lea addresses_WT_ht+0x16a2e, %rbp
nop
nop
nop
nop
...
nop
and %rdx, %rdx
lea addresses_WC_ht+0x17a42, %rbx
nop
add $23241, %rcx
movb (%rbx), %al
nop
and $36927, %rax
lea addresses_D_ht+0x1ea6a, %rsi
lea addresses_A_ht+0xb7ae, %rdi
nop
add %r10, %r10
mov $44, %rcx
rep movsq
add %rdx, %rdx
lea addresses_WT_ht+0x1d756, %rsi
...
nop
sub %rsi, %rsi
lea addresses_D_ht+0x18b69, %rdi
nop
nop
nop
nop
...
nop
cmp $65214, %rbp
lea addresses_UC_ht+0xccce, %rbx
add $3023, %r10
mov (%rbx), %edi
nop
sub $26789, %rcx
...
{'OP': 'STOR', 'dst': {'type': 'addresses_US', 'size': 32, 'AVXalign': True, 'NT': False, 'congruent': 2, 'same': False}}
...
{'OP': 'LOAD', 'src': {'type': 'addresses_D_ht', 'size': 8, 'AVXalign': False, 'NT': False, 'congruent': 0, 'same': True}}
