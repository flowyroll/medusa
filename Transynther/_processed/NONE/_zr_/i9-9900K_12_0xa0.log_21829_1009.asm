...
push %rdi
push %rsi
lea addresses_UC_ht+0x17b52, %rsi
...
rep movsb
xor %r12, %r12
lea addresses_WT_ht+0xd352, %rsi
nop
nop
cmp %r9, %r9
movups (%rsi), %xmm6
...
nop
add %rcx, %rcx
lea addresses_A_ht+0x124f2, %rdi
nop
nop
nop
nop
...
nop
cmp $39380, %rdi
lea addresses_UC_ht+0x2352, %r12
cmp $61162, %r11
movb $0x61, (%r12)
nop
nop
nop
sub %r9, %r9
lea addresses_UC_ht+0x14f12, %rbp
nop
nop
nop
dec %r9
...
nop
inc %r12
lea addresses_A_ht+0xc152, %rsi
lea addresses_WC_ht+0xbb52, %rdi
nop
nop
add %rbp, %rbp
mov $56, %rcx
...
<gen_prepare_buffer>
{'src': {'same': False, 'congruent': 11, 'type': 'addresses_UC_ht'}, 'OP': 'REPM', 'dst': {'same': False, 'congruent': 10, 'type': 'addresses_D_ht'}}
...
{'src': {'NT': False, 'same': False, 'congruent': 5, 'type': 'addresses_UC_ht', 'AVXalign': True, 'size': 1}, 'OP': 'LOAD'}
