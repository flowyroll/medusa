...
push %rdi
push %rsi
lea addresses_D_ht+0x1a24e, %rsi
lea addresses_WC_ht+0x176d6, %rdi
xor $3942, %r12
mov $90, %rcx
rep movsb
nop
and $30440, %r13
lea addresses_D_ht+0x15d4e, %rcx
nop
sub %r14, %r14
...
nop
xor %r14, %r14
lea addresses_WT_ht+0x10aee, %r13
nop
nop
nop
nop
...
nop
dec %r12
lea addresses_UC_ht+0x18df1, %rdi
sub $49250, %r8
movb (%rdi), %r14b
nop
nop
and $19256, %r12
lea addresses_normal_ht+0x1494e, %r13
nop
nop
nop
and $29014, %r8
...
nop
sub $63096, %r13
lea addresses_WT_ht+0xdd66, %rcx
nop
nop
nop
sub %r14, %r14
