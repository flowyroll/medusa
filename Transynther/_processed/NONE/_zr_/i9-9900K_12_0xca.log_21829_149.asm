...
push %rdx
push %rsi
lea addresses_D_ht+0x73b3, %rsi
lea addresses_normal_ht+0x17fb3, %rdi
nop
nop
nop
nop
...
nop
add %r8, %r8
lea addresses_normal_ht+0x67b3, %rsi
lea addresses_WC_ht+0x9e33, %rdi
nop
nop
nop
nop
...
nop
sub $18778, %r8
lea addresses_UC_ht+0xc193, %rsi
lea addresses_WT_ht+0x96b3, %rdi
add %rbx, %rbx
mov $107, %rcx
rep movsb
nop
...
nop
dec %rcx
lea addresses_normal_ht+0xd273, %rdi
nop
nop
nop
nop
...
nop
dec %r8
lea addresses_WT_ht+0x5fb3, %rbx
nop
nop
cmp $50852, %rcx
movups (%rbx), %xmm5
...
nop
sub $37860, %rbx
lea addresses_WT_ht+0x112ab, %rsi
clflush (%rsi)
nop
nop
nop
...
nop
sub %rdi, %rdi
lea addresses_normal_ht+0x11ff3, %rcx
nop
nop
nop
sub %rdi, %rdi
...
nop
add $43915, %r13
lea addresses_WC_ht+0x85d3, %r13
cmp $964, %rdi
mov $0x6162636465666768, %rbx
movq %rbx, %xmm5
movups %xmm5, (%r13)
add %rbx, %rbx
lea addresses_UC_ht+0x1cef3, %r8
add $17362, %rsi
vmovups (%r8), %ymm5
...
nop
inc %rcx
lea addresses_A_ht+0x17023, %rcx
nop
nop
nop
nop
...
nop
xor %rcx, %rcx
lea addresses_D_ht+0x19fb3, %rbx
nop
nop
nop
nop
...
mov (%rbx), %ecx
add %r12, %r12
lea addresses_WC_ht+0x1afb3, %rcx
nop
nop
nop
nop
...
nop
and %rdi, %rdi
lea addresses_A_ht+0x1bf83, %rbx
nop
cmp $37069, %r8
...
nop
sub $49107, %r13
lea addresses_WT_ht+0x7d33, %rbx
clflush (%rbx)
nop
inc %rcx
movl $0x61626364, (%rbx)
...
lea addresses_normal_ht+0x4db3, %rdi
and $4151, %rdx
mov $3, %rcx
rep movsb
nop
...
// Store
lea addresses_normal+0x137b3, %rdi
nop
nop
nop
cmp %r11, %r11
...
{'OP': 'REPM', 'src': {'same': False, 'type': 'addresses_normal_ht', 'congruent': 10}, 'dst': {'same': False, 'type': 'addresses_WC_ht', 'congruent': 7}}
{'OP': 'REPM', 'src': {'same': False, 'type': 'addresses_UC_ht', 'congruent': 4}, 'dst': {'same': True, 'type': 'addresses_WT_ht', 'congruent': 8}}
...
{'OP': 'REPM', 'src': {'same': False, 'type': 'addresses_UC_ht', 'congruent': 4}, 'dst': {'same': False, 'type': 'addresses_normal_ht', 'congruent': 9}}
{'00': 21829}
