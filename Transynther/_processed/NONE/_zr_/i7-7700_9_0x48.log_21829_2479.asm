...
push %rbx
push %rdx
lea addresses_UC_ht+0x56c6, %rbp
nop
nop
xor $61796, %r9
mov (%rbp), %dx
...
{'OP': 'LOAD', 'src': {'type': 'addresses_D_ht', 'AVXalign': True, 'congruent': 6, 'size': 32, 'same': True, 'NT': False}}
