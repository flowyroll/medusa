...
nop
cmp $6024, %rcx
lea addresses_normal_ht+0x2100, %r13
nop
nop
and $45324, %r12
movb $0x61, (%r13)
xor %rdi, %rdi
lea addresses_A_ht+0x12d60, %rcx
nop
nop
nop
cmp $6341, %rdi
...
movups %xmm5, (%rcx)
cmp $41692, %r13
lea addresses_normal_ht+0xbb80, %rcx
nop
nop
nop
xor %rdi, %rdi
...
nop
sub %rdi, %rdi
lea addresses_WC_ht+0x4ea0, %r13
add $42526, %r12
mov (%r13), %r15w
add $27862, %r9
lea addresses_D_ht+0x1ed00, %rcx
nop
nop
nop
nop
...
movb (%rcx), %r13b
xor %rdi, %rdi
lea addresses_UC_ht+0x5100, %rsi
lea addresses_UC_ht+0x392, %rdi
nop
cmp %r9, %r9
mov $59, %rcx
rep movsw
...
nop
xor %rsi, %rsi
lea addresses_WC_ht+0x12080, %r9
nop
nop
cmp %rsi, %rsi
...
nop
lfence
lea addresses_normal_ht+0x1bef7, %rsi
lea addresses_A_ht+0x5d00, %rdi
nop
nop
nop
nop
...
nop
cmp %r15, %r15
lea addresses_normal_ht+0xa700, %r9
nop
sub $50361, %rdi
movl $0x61626364, (%r9)
nop
...
nop
inc %r12
lea addresses_UC_ht+0x10c80, %rsi
lea addresses_WT_ht+0x6640, %rdi
nop
nop
cmp %r9, %r9
mov $100, %rcx
...
{'OP': 'LOAD', 'src': {'size': 16, 'NT': False, 'type': 'addresses_P', 'same': False, 'AVXalign': True, 'congruent': 6}}
...
<gen_prepare_buffer>
{'OP': 'REPM', 'src': {'same': True, 'type': 'addresses_WC_ht', 'congruent': 8}, 'dst': {'same': False, 'type': 'addresses_A_ht', 'congruent': 10}}
...
{'OP': 'LOAD', 'src': {'size': 2, 'NT': False, 'type': 'addresses_normal_ht', 'same': True, 'AVXalign': True, 'congruent': 7}}
...
{'OP': 'REPM', 'src': {'same': False, 'type': 'addresses_UC_ht', 'congruent': 9}, 'dst': {'same': False, 'type': 'addresses_UC_ht', 'congruent': 1}}
{'OP': 'STOR', 'dst': {'size': 8, 'NT': False, 'type': 'addresses_WC_ht', 'same': False, 'AVXalign': False, 'congruent': 7}}
{'OP': 'REPM', 'src': {'same': True, 'type': 'addresses_normal_ht', 'congruent': 0}, 'dst': {'same': False, 'type': 'addresses_A_ht', 'congruent': 9}}
