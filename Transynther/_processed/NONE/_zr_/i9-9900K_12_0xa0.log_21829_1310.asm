...
push %rdi
push %rsi
lea addresses_WT_ht+0x18689, %r13
nop
nop
add $44290, %r8
movups (%r13), %xmm4
...
nop
sub %rsi, %rsi
lea addresses_WC_ht+0x9c89, %rbp
nop
sub %rbx, %rbx
mov (%rbp), %rsi
nop
add $14623, %rsi
lea addresses_WC_ht+0x1de89, %r12
nop
nop
nop
cmp %r10, %r10
...
nop
cmp $58146, %rsi
lea addresses_D_ht+0x1e829, %r12
nop
nop
nop
nop
...
nop
and %r12, %r12
lea addresses_WC_ht+0x3b49, %rsi
lea addresses_UC_ht+0xe9eb, %rdi
inc %rbx
mov $87, %rcx
rep movsw
nop
...
{'OP': 'STOR', 'dst': {'NT': False, 'same': True, 'congruent': 2, 'type': 'addresses_D_ht', 'AVXalign': False, 'size': 2}}
{'src': {'same': False, 'congruent': 5, 'type': 'addresses_WC_ht'}, 'OP': 'REPM', 'dst': {'same': False, 'congruent': 1, 'type': 'addresses_UC_ht'}}
{'00': 21829}
