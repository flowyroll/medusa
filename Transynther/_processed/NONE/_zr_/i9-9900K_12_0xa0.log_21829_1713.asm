...
nop
xor $54215, %r12
lea addresses_normal_ht+0x116ac, %r13
inc %rdi
movb $0x61, (%r13)
nop
nop
...
nop
add %rbp, %rbp
lea addresses_normal_ht+0x71c6, %rsi
lea addresses_D_ht+0x1ebe6, %rdi
clflush (%rsi)
nop
nop
cmp %r13, %r13
...
nop
add $63054, %r13
lea addresses_UC_ht+0xee4c, %rsi
lea addresses_WC_ht+0x19c8f, %rdi
nop
nop
nop
nop
...
{'OP': 'STOR', 'dst': {'NT': False, 'same': True, 'congruent': 5, 'type': 'addresses_normal_ht', 'AVXalign': False, 'size': 1}}
{'OP': 'STOR', 'dst': {'NT': False, 'same': False, 'congruent': 5, 'type': 'addresses_A_ht', 'AVXalign': True, 'size': 8}}
