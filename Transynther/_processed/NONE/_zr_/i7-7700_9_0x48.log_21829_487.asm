...
nop
sub %rax, %rax
lea addresses_WT_ht+0x8eb9, %r10
nop
cmp %r8, %r8
...
nop
and $39152, %r10
lea addresses_D_ht+0x1d9b9, %rsi
lea addresses_WT_ht+0x8709, %rdi
nop
nop
nop
nop
...
nop
xor $58077, %r8
lea addresses_normal_ht+0x1a6b9, %rsi
dec %rcx
movl $0x61626364, (%rsi)
nop
nop
...
nop
xor %rdi, %rdi
lea addresses_normal_ht+0x194b9, %rsi
lea addresses_UC_ht+0xde21, %rdi
clflush (%rsi)
xor %r15, %r15
mov $31, %rcx
rep movsq
...
nop
sub $45050, %r8
lea addresses_D_ht+0x18119, %r10
nop
nop
nop
xor $52642, %r15
...
{'OP': 'STOR', 'dst': {'type': 'addresses_WT_ht', 'AVXalign': False, 'congruent': 9, 'size': 8, 'same': False, 'NT': True}}
