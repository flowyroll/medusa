...
push %rbx
push %rsi
lea addresses_A_ht+0x13f1f, %r11
nop
nop
nop
nop
...
nop
inc %rbx
lea addresses_normal_ht+0x1397, %rbx
nop
nop
nop
sub %r9, %r9
...
nop
sub $12192, %rbx
lea addresses_normal_ht+0x12c1f, %rsi
nop
inc %rbp
movb (%rsi), %r9b
nop
dec %r9
lea addresses_normal_ht+0x14f1f, %r14
nop
sub %r10, %r10
movups (%r14), %xmm0
vpextrq $1, %xmm0, %rbx
...
nop
xor %r10, %r10
lea addresses_WC_ht+0x1111f, %r10
nop
nop
nop
nop
...
{'OP': 'STOR', 'dst': {'same': False, 'congruent': 6, 'NT': False, 'type': 'addresses_US', 'size': 1, 'AVXalign': False}}
[Faulty Load]
...
{'src': {'same': True, 'congruent': 7, 'NT': False, 'type': 'addresses_normal_ht', 'size': 1, 'AVXalign': False}, 'OP': 'LOAD'}
