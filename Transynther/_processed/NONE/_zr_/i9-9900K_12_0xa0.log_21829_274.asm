...
push %rdx
push %rsi
lea addresses_WT_ht+0x59cb, %rsi
lea addresses_WC_ht+0xc2eb, %rdi
clflush (%rsi)
nop
nop
nop
...
nop
add $20568, %r8
lea addresses_WT_ht+0xe1cb, %rbx
nop
nop
nop
and $15024, %rdi
...
nop
xor $3026, %rax
lea addresses_A_ht+0x13cb, %rsi
lea addresses_A_ht+0x11acb, %rdi
nop
nop
nop
nop
...
nop
xor %rdi, %rdi
lea addresses_WT_ht+0x127cb, %rsi
nop
nop
nop
dec %rcx
...
nop
xor %rax, %rax
lea addresses_A_ht+0x1a5cb, %rcx
nop
nop
nop
and $59732, %rdi
...
nop
sub %rcx, %rcx
lea addresses_WT_ht+0x14153, %rcx
and %r9, %r9
mov $0x6162636465666768, %rdi
movq %rdi, %xmm0
movups %xmm0, (%rcx)
cmp %r9, %r9
lea addresses_WC_ht+0x594b, %rsi
nop
sub $31469, %rax
mov (%rsi), %r9d
nop
nop
sub %r8, %r8
lea addresses_WC_ht+0x1446f, %rsi
lea addresses_UC_ht+0x151cb, %rdi
add %rdx, %rdx
mov $105, %rcx
rep movsb
nop
...
// Store
lea addresses_normal+0x39cb, %r13
nop
sub %rax, %rax
movb $0x51, (%r13)
nop
...
{'src': {'NT': False, 'same': False, 'congruent': 11, 'type': 'addresses_D', 'AVXalign': False, 'size': 4}, 'OP': 'LOAD'}
...
{'src': {'NT': False, 'same': True, 'congruent': 1, 'type': 'addresses_WT_ht', 'AVXalign': False, 'size': 2}, 'OP': 'LOAD'}
...
{'src': {'same': False, 'congruent': 1, 'type': 'addresses_WC_ht'}, 'OP': 'REPM', 'dst': {'same': False, 'congruent': 10, 'type': 'addresses_UC_ht'}}
{'00': 21829}
