...
push %rcx
push %rdi
lea addresses_D_ht+0x13fba, %rcx
nop
nop
inc %r8
...
nop
xor %r14, %r14
lea addresses_A_ht+0x1ce3a, %r11
nop
nop
nop
nop
...
nop
xor $27128, %r11
lea addresses_WC_ht+0x17bba, %rcx
clflush (%rcx)
nop
nop
nop
...
{'src': {'type': 'addresses_WT', 'congruent': 2, 'same': False}, 'OP': 'REPM', 'dst': {'type': 'addresses_P', 'congruent': 7, 'same': False}}
...
{'OP': 'STOR', 'dst': {'type': 'addresses_A_ht', 'AVXalign': True, 'size': 16, 'NT': False, 'same': False, 'congruent': 8}}
