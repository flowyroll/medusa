...
nop
sub $33783, %rbx
lea addresses_normal_ht+0x7f40, %r10
clflush (%r10)
nop
inc %r14
mov (%r10), %r11
...
nop
inc %r12
lea addresses_D_ht+0x1dc40, %r10
clflush (%r10)
nop
nop
nop
...
nop
and %rdi, %rdi
lea addresses_WC_ht+0x64c0, %rsi
lea addresses_WC_ht+0x13760, %rdi
clflush (%rdi)
nop
nop
nop
...
nop
cmp $39237, %rdi
lea addresses_normal_ht+0x1ece0, %r11
cmp %rcx, %rcx
mov (%r11), %ebx
nop
nop
...
{'OP': 'STOR', 'dst': {'type': 'addresses_WC', 'size': 2, 'AVXalign': True, 'NT': False, 'congruent': 2, 'same': False}}
[Faulty Load]
