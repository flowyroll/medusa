...
push %rdx
push %rsi
lea addresses_A_ht+0x147f1, %rsi
lea addresses_normal_ht+0xcb03, %rdi
cmp $47825, %r15
mov $49, %rcx
rep movsb
nop
...
nop
and $62578, %r9
lea addresses_normal_ht+0xd8f1, %r14
nop
nop
nop
xor $11084, %rbp
...
nop
inc %rsi
lea addresses_normal_ht+0x9ab1, %rdi
nop
nop
inc %r9
movb $0x61, (%rdi)
...
nop
inc %r14
lea addresses_WC_ht+0x1dc51, %r15
nop
nop
nop
cmp %rdi, %rdi
...
nop
add $6290, %rcx
lea addresses_UC_ht+0x110e5, %rbp
add $10629, %r14
movl $0x61626364, (%rbp)
nop
nop
...
nop
and %rcx, %rcx
lea addresses_UC_ht+0x72b1, %rcx
nop
nop
sub $55460, %rbp
...
nop
xor %r15, %r15
lea addresses_WC_ht+0x13eb1, %rcx
nop
add %r9, %r9
...
nop
sub $16783, %r9
lea addresses_WT_ht+0x7d85, %rcx
nop
nop
nop
and $6642, %rdi
...
nop
add $33029, %r14
lea addresses_A_ht+0x93c8, %rcx
nop
nop
sub %r15, %r15
movl $0x61626364, (%rcx)
add %rdi, %rdi
lea addresses_A_ht+0xa251, %rsi
nop
nop
nop
nop
...
nop
cmp $9730, %rbp
lea addresses_normal_ht+0x845f, %rsi
lea addresses_WT_ht+0x78b1, %rdi
nop
sub $14499, %r9
mov $3, %rcx
rep movsq
...
nop
sub %r9, %r9
lea addresses_normal_ht+0x1b751, %rsi
lea addresses_D_ht+0x57b1, %rdi
cmp %rdx, %rdx
mov $90, %rcx
rep movsl
nop
...
nop
xor %rbp, %rbp
lea addresses_WT_ht+0x17ab1, %rdi
add %r9, %r9
movb (%rdi), %dl
nop
and $40426, %rsi
...
{'OP': 'LOAD', 'src': {'size': 32, 'NT': False, 'type': 'addresses_P', 'same': False, 'AVXalign': False, 'congruent': 6}}
{'OP': 'STOR', 'dst': {'size': 1, 'NT': False, 'type': 'addresses_PSE', 'same': False, 'AVXalign': True, 'congruent': 8}}
[Faulty Load]
...
{'OP': 'REPM', 'src': {'same': False, 'type': 'addresses_normal_ht', 'congruent': 4}, 'dst': {'same': False, 'type': 'addresses_D_ht', 'congruent': 7}}
...
{'OP': 'LOAD', 'src': {'size': 1, 'NT': False, 'type': 'addresses_WT_ht', 'same': False, 'AVXalign': True, 'congruent': 8}}
{'00': 21829}
