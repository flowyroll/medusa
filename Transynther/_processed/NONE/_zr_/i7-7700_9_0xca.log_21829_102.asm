...
push %rdi
push %rsi
lea addresses_A_ht+0x17ec1, %rax
nop
nop
nop
nop
...
nop
xor %rbp, %rbp
lea addresses_WT_ht+0x5189, %rsi
lea addresses_UC_ht+0x1a75e, %rdi
add %rax, %rax
mov $21, %rcx
rep movsl
nop
inc %rdi
lea addresses_UC_ht+0x2281, %rax
nop
nop
nop
nop
...
movups %xmm4, (%rax)
cmp $48967, %rax
lea addresses_WC_ht+0x1ef81, %rdi
nop
nop
sub $38540, %r12
movb $0x61, (%rdi)
nop
cmp %rax, %rax
lea addresses_WC_ht+0x12881, %r12
nop
nop
sub $42291, %rdi
...
movups %xmm6, (%r12)
sub %rdi, %rdi
lea addresses_UC_ht+0x2c81, %r12
nop
nop
nop
sub %r14, %r14
...
// Load
lea addresses_normal+0x1cd01, %rdi
add $10958, %rcx
movb (%rdi), %r13b
add %rdi, %rdi

// Faulty Load
lea addresses_A+0x1dc81, %r13
nop
nop
nop
nop
