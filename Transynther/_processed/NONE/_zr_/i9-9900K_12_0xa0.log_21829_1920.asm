...
push %rdi
push %rsi
lea addresses_D_ht+0x1c6e2, %rcx
clflush (%rcx)
nop
nop
nop
...
nop
cmp %r15, %r15
lea addresses_D_ht+0x7562, %rsi
lea addresses_WT_ht+0x12162, %rdi
clflush (%rsi)
xor %r14, %r14
mov $115, %rcx
rep movsb
dec %rsi
lea addresses_UC_ht+0x10222, %rcx
nop
nop
nop
nop
...
movups %xmm3, (%rcx)
mfence
lea addresses_WT_ht+0xa962, %rdi
nop
and $50316, %r15
movups (%rdi), %xmm0
vpextrq $0, %xmm0, %rcx
...
nop
and $59876, %rcx
lea addresses_UC_ht+0x5162, %rsi
lea addresses_WC_ht+0xf962, %rdi
xor %rbx, %rbx
mov $86, %rcx
rep movsl
nop
...
nop
xor $1537, %rbp
lea addresses_normal_ht+0x142e0, %r15
nop
nop
nop
sub $27965, %rbx
...
nop
sub %rbx, %rbx
lea addresses_UC_ht+0x1ed62, %rbx
and %rax, %rax
movw $0x6162, (%rbx)
nop
nop
...
nop
cmp $27463, %rbp
lea addresses_D_ht+0x1be62, %rsi
lea addresses_A_ht+0x89d2, %rdi
nop
nop
nop
nop
...
nop
add %rbp, %rbp
lea addresses_WT_ht+0x11272, %rax
nop
sub $7809, %rbx
mov $0x6162636465666768, %rdi
movq %rdi, (%rax)
...
nop
xor $50451, %r15
lea addresses_D_ht+0x16262, %rsi
lea addresses_WC_ht+0x3534, %rdi
nop
and %r15, %r15
mov $97, %rcx
rep movsb
...
nop
add $41499, %rbx
lea addresses_WC_ht+0x12a62, %rdi
xor $48836, %rbx
...
{'src': {'same': False, 'congruent': 7, 'type': 'addresses_D_ht'}, 'OP': 'REPM', 'dst': {'same': True, 'congruent': 10, 'type': 'addresses_WT_ht'}}
...
{'src': {'same': False, 'congruent': 6, 'type': 'addresses_D_ht'}, 'OP': 'REPM', 'dst': {'same': True, 'congruent': 4, 'type': 'addresses_A_ht'}}
{'src': {'NT': False, 'same': False, 'congruent': 4, 'type': 'addresses_A_ht', 'AVXalign': True, 'size': 32}, 'OP': 'LOAD'}
...
{'src': {'NT': False, 'same': False, 'congruent': 5, 'type': 'addresses_WC_ht', 'AVXalign': True, 'size': 32}, 'OP': 'LOAD'}
{'00': 21829}
