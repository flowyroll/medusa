...
nop
and %rbp, %rbp
lea addresses_WT_ht+0x1a0ac, %r9
dec %r15
movb (%r9), %r12b
nop
nop
nop
and $3189, %r10
lea addresses_WC_ht+0x3004, %rbp
and $64941, %rbx
vmovups (%rbp), %ymm6
vextracti128 $0, %ymm6, %xmm6
vpextrq $1, %xmm6, %r10
xor %rbp, %rbp
lea addresses_normal_ht+0x1114c, %rbx
nop
nop
nop
nop
...
nop
sub $54920, %rbx
lea addresses_UC_ht+0x12a4c, %rsi
lea addresses_WT_ht+0x1a29c, %rdi
nop
nop
nop
nop
...
nop
sub %r10, %r10
lea addresses_UC_ht+0x13dc, %rbp
nop
nop
nop
nop
...
nop
sub $26767, %r12
lea addresses_WC_ht+0x1214c, %rbp
nop
nop
add $32101, %r10
mov (%rbp), %edi
...
{'src': {'congruent': 7, 'same': False, 'type': 'addresses_UC_ht'}, 'OP': 'REPM', 'dst': {'congruent': 4, 'same': False, 'type': 'addresses_WT_ht'}}
{'src': {'congruent': 4, 'AVXalign': False, 'same': False, 'size': 32, 'NT': False, 'type': 'addresses_UC_ht'}, 'OP': 'LOAD'}
{'src': {'congruent': 1, 'same': False, 'type': 'addresses_UC_ht'}, 'OP': 'REPM', 'dst': {'congruent': 9, 'same': True, 'type': 'addresses_D_ht'}}
