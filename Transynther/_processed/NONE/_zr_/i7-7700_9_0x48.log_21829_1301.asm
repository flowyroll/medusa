...
push %rdi
push %rsi
lea addresses_A_ht+0x10b46, %r14
nop
nop
nop
xor $30584, %rdi
...
nop
cmp $44486, %rbx
lea addresses_UC_ht+0x41ee, %rsi
lea addresses_WT_ht+0x1721e, %rdi
clflush (%rsi)
nop
and %rbx, %rbx
mov $69, %rcx
...
nop
add $20454, %rbx
lea addresses_WC_ht+0x5b8e, %rdi
add %r11, %r11
movw $0x6162, (%rdi)
nop
nop
...
nop
sub %r14, %r14
lea addresses_WC_ht+0x7c2e, %r14
nop
add %rcx, %rcx
movb $0x61, (%r14)
nop
