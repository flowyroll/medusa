...
nop
add %rbp, %rbp
lea addresses_WT_ht+0x17db0, %r9
nop
nop
nop
nop
...
movq %rdi, (%r9)
cmp $30596, %rdi
lea addresses_normal_ht+0x11400, %rdi
nop
nop
nop
dec %rbx
...
nop
xor %rdi, %rdi
lea addresses_A_ht+0x19db0, %rbx
clflush (%rbx)
nop
nop
nop
...
nop
and %rdi, %rdi
lea addresses_D_ht+0x5542, %rsi
lea addresses_UC_ht+0x7230, %rdi
and %rbp, %rbp
mov $91, %rcx
rep movsw
sub %rcx, %rcx
lea addresses_A_ht+0x19ca0, %rsi
lea addresses_WC_ht+0x1916c, %rdi
nop
nop
nop
nop
...
nop
and $2380, %rdi
lea addresses_normal_ht+0x1c8b0, %rsi
lea addresses_WC_ht+0xb4b0, %rdi
nop
cmp $6534, %rbx
mov $44, %rcx
rep movsw
...
{'OP': 'REPM', 'src': {'type': 'addresses_D_ht', 'congruent': 1, 'same': False}, 'dst': {'type': 'addresses_UC_ht', 'congruent': 7, 'same': True}}
