...
push %rdx
push %rsi
lea addresses_WT_ht+0xb31c, %rsi
lea addresses_WT_ht+0x299, %rdi
clflush (%rsi)
nop
nop
inc %rax
...
nop
dec %r8
lea addresses_normal_ht+0x509c, %r15
nop
nop
nop
nop
...
nop
sub $33499, %rsi
lea addresses_WT_ht+0x18b1c, %r15
nop
nop
nop
xor $58911, %rbx
...
movntdq %xmm7, (%r15)
add %rax, %rax
lea addresses_WT_ht+0x1e302, %rsi
lea addresses_WC_ht+0x391c, %rdi
nop
nop
nop
nop
...
nop
cmp $37106, %rsi
lea addresses_UC_ht+0x1eedc, %rsi
lea addresses_WT_ht+0x1291c, %rdi
nop
nop
cmp %r8, %r8
mov $15, %rcx
...
nop
inc %rdi
lea addresses_A_ht+0x4cc6, %rsi
lea addresses_UC_ht+0xde1c, %rdi
clflush (%rdi)
add %rax, %rax
mov $92, %rcx
rep movsl
...
{'OP': 'REPM', 'src': {'type': 'addresses_WT_ht', 'congruent': 1, 'same': False}, 'dst': {'type': 'addresses_WC_ht', 'congruent': 9, 'same': False}}
