...
push %rdx
push %rsi
lea addresses_WC_ht+0x6e43, %rdx
nop
nop
sub %rsi, %rsi
movb $0x61, (%rdx)
...
nop
sub $43241, %r8
lea addresses_WT_ht+0x18e83, %r12
clflush (%r12)
nop
nop
xor %r9, %r9
...
nop
and %r9, %r9
lea addresses_normal_ht+0xe4e1, %rsi
lea addresses_WT_ht+0x16e83, %rdi
clflush (%rsi)
nop
nop
xor $46176, %r13
...
nop
add $29104, %rdx
lea addresses_UC_ht+0x6d83, %rsi
nop
nop
nop
nop
...
movw $0x6162, (%r13)
add $20969, %rcx
lea addresses_normal_ht+0x843, %r8
nop
cmp $56903, %r12
movb $0x61, (%r8)
nop
and %r8, %r8
lea addresses_WC_ht+0x1d883, %rdx
nop
nop
nop
xor %r13, %r13
...
nop
inc %r9
lea addresses_normal_ht+0x7e03, %rsi
lea addresses_normal_ht+0x1da83, %rdi
nop
nop
nop
nop
...
nop
add $41495, %rdi
lea addresses_WC_ht+0xb083, %rdi
nop
nop
nop
nop
...
{'src': {'same': False, 'congruent': 0, 'type': 'addresses_normal_ht'}, 'OP': 'REPM', 'dst': {'same': False, 'congruent': 10, 'type': 'addresses_WT_ht'}}
...
{'OP': 'STOR', 'dst': {'NT': True, 'same': False, 'congruent': 5, 'type': 'addresses_normal_ht', 'AVXalign': False, 'size': 1}}
...
{'src': {'same': False, 'congruent': 7, 'type': 'addresses_normal_ht'}, 'OP': 'REPM', 'dst': {'same': True, 'congruent': 10, 'type': 'addresses_normal_ht'}}
