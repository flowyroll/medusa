...
lea addresses_WT_ht+0x1259c, %rdi
clflush (%rsi)
clflush (%rdi)
nop
nop
...
nop
xor %rdi, %rdi
lea addresses_A_ht+0x449c, %rsi
lea addresses_WC_ht+0x1429c, %rdi
add %r11, %r11
mov $97, %rcx
rep movsw
nop
nop
cmp $31960, %rsi
lea addresses_WC_ht+0x1c485, %rsi
lea addresses_UC_ht+0xac5c, %rdi
nop
sub %rdx, %rdx
mov $97, %rcx
rep movsw
...
nop
xor %r11, %r11
lea addresses_UC_ht+0x601c, %r15
nop
nop
add %rsi, %rsi
movl $0x61626364, (%r15)
...
nop
xor $36461, %r15
lea addresses_WC_ht+0x101e4, %r9
nop
nop
xor $41521, %rcx
mov (%r9), %si
...
nop
and %rsi, %rsi
lea addresses_WT_ht+0x1719c, %r8
nop
nop
nop
nop
...
vpextrq $1, %xmm2, %rdi
and $21908, %rdi
lea addresses_WT_ht+0x19c18, %rcx
nop
nop
add $48459, %rdx
movb $0x61, (%rcx)
nop
cmp %r15, %r15
lea addresses_D_ht+0x604c, %r11
dec %rsi
movups (%r11), %xmm0
vpextrq $1, %xmm0, %rdx
and %rsi, %rsi
lea addresses_D_ht+0x9578, %r9
nop
nop
dec %rdi
mov (%r9), %r11d
...
nop
add $54301, %r15
lea addresses_normal_ht+0x14e2e, %r9
nop
cmp %r11, %r11
movb (%r9), %r8b
nop
...
nop
mfence
lea addresses_D_ht+0x18b84, %rdx
nop
nop
nop
nop
