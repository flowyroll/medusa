...
nop
add %r12, %r12
lea addresses_UC_ht+0x312d, %r13
nop
nop
nop
and $24213, %r15
movw $0x6162, (%r13)
cmp %rbx, %rbx
lea addresses_UC_ht+0xd2d, %rsi
lea addresses_D_ht+0xdb35, %rdi
nop
nop
nop
nop
...
nop
xor $40867, %rdi
lea addresses_UC_ht+0x1592d, %r12
clflush (%r12)
nop
nop
nop
...
movq %rdi, (%r12)
and %rbx, %rbx
lea addresses_UC_ht+0x1ea4d, %rdi
nop
nop
add $58839, %r13
vmovups (%rdi), %ymm0
...
nop
add $17777, %r15
lea addresses_WC_ht+0x1766d, %rbx
nop
nop
nop
xor %rdi, %rdi
mov (%rbx), %r12w
cmp $41075, %rdi
lea addresses_WC_ht+0x11825, %rsi
lea addresses_WT_ht+0x142ed, %rdi
nop
nop
nop
nop
...
nop
xor $44873, %rbp
lea addresses_D_ht+0x1cc4d, %r14
nop
nop
sub %rbp, %rbp
movl $0x61626364, (%r14)
...
mov (%r15), %r14w
dec %r14
lea addresses_D_ht+0x14b2d, %rsi
lea addresses_A_ht+0xd92d, %rdi
sub $7615, %r14
mov $113, %rcx
rep movsw
nop
...
nop
inc %r15
lea addresses_WC_ht+0xcfad, %rcx
nop
nop
nop
nop
...
{'OP': 'REPM', 'src': {'type': 'addresses_UC_ht', 'congruent': 10, 'same': False}, 'dst': {'type': 'addresses_D_ht', 'congruent': 3, 'same': False}}
