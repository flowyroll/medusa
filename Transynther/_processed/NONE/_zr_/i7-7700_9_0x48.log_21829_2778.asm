...
nop
and %r12, %r12
lea addresses_UC_ht+0x16e4b, %r8
inc %r12
movl $0x61626364, (%r8)
nop
nop
sub %r8, %r8
lea addresses_A_ht+0xdabb, %rsi
lea addresses_WC_ht+0x1c0df, %rdi
nop
nop
nop
inc %rbp
...
nop
and $36031, %rdi
lea addresses_normal_ht+0xf2db, %rsi
lea addresses_normal_ht+0xd64b, %rdi
nop
nop
nop
nop
...
nop
and $51295, %rbp
lea addresses_normal_ht+0x66f3, %rsi
clflush (%rsi)
dec %r12
mov (%rsi), %rcx
nop
xor $15424, %rsi
lea addresses_normal_ht+0x1e64b, %rdi
and $22371, %r8
mov (%rdi), %r9
nop
cmp %rdx, %rdx
lea addresses_UC_ht+0xae4b, %rdx
nop
nop
nop
dec %r12
...
nop
cmp $43300, %rcx
lea addresses_WC_ht+0x1200b, %rsi
lea addresses_normal_ht+0x864b, %rdi
cmp %rdx, %rdx
mov $71, %rcx
rep movsb
nop
...
nop
inc %r8
lea addresses_WT_ht+0x1304b, %rdi
nop
dec %rbp
mov (%rdi), %r8
nop
...
nop
dec %r12
lea addresses_A_ht+0x13a4b, %rsi
...
nop
add %rbp, %rbp
lea addresses_A_ht+0x1640c, %rdx
nop
nop
dec %rsi
...
nop
sub $30585, %r9
lea addresses_WT_ht+0x10f7f, %rbp
nop
and $29399, %rdx
mov $0x6162636465666768, %rcx
movq %rcx, %xmm4
...
{'OP': 'STOR', 'dst': {'type': 'addresses_UC_ht', 'AVXalign': True, 'congruent': 8, 'size': 4, 'same': True, 'NT': False}}
{'OP': 'REPM', 'src': {'type': 'addresses_A_ht', 'congruent': 4, 'same': False}, 'dst': {'type': 'addresses_WC_ht', 'congruent': 2, 'same': True}}
...
{'OP': 'REPM', 'src': {'type': 'addresses_A_ht', 'congruent': 9, 'same': False}, 'dst': {'type': 'addresses_normal_ht', 'congruent': 9, 'same': False}}
{'OP': 'STOR', 'dst': {'type': 'addresses_A_ht', 'AVXalign': False, 'congruent': 0, 'size': 16, 'same': False, 'NT': False}}
{'OP': 'STOR', 'dst': {'type': 'addresses_WT_ht', 'AVXalign': True, 'congruent': 2, 'size': 32, 'same': False, 'NT': True}}
{'00': 21829}
