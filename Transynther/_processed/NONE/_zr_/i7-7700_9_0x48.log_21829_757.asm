...
push %rdx
push %rsi
lea addresses_UC_ht+0xfeb5, %rbp
nop
nop
nop
nop
...
nop
inc %rdi
lea addresses_UC_ht+0x16e7b, %r15
nop
nop
nop
inc %rdx
...
nop
and %rdx, %rdx
lea addresses_WT_ht+0x10d7b, %rsi
lea addresses_UC_ht+0xd47b, %rdi
nop
nop
and %r14, %r14
mov $78, %rcx
rep movsb
and %r12, %r12
lea addresses_UC_ht+0xcffb, %rdx
nop
nop
nop
nop
...
vmovups %ymm7, (%r14)
dec %r15
lea addresses_normal_ht+0x10cbb, %r15
nop
nop
nop
inc %rbp
...
nop
sub %rdx, %rdx
lea addresses_WC_ht+0x1e6fb, %rdi
nop
nop
sub $32380, %r14
mov (%rdi), %r15
...
nop
xor $22800, %rdx
lea addresses_D_ht+0x1a5af, %rsi
lea addresses_D_ht+0x107fb, %rdi
clflush (%rsi)
dec %r15
mov $50, %rcx
rep movsw
...
nop
add $17093, %r15
lea addresses_WC_ht+0x1820b, %rsi
lea addresses_UC_ht+0x12727, %rdi
nop
nop
nop
nop
...
{'OP': 'REPM', 'src': {'type': 'addresses_WT_ht', 'congruent': 7, 'same': False}, 'dst': {'type': 'addresses_UC_ht', 'congruent': 11, 'same': True}}
