...
nop
sub $24161, %rbp
lea addresses_WT_ht+0x19151, %rcx
nop
nop
add %rdi, %rdi
mov $0x6162636465666768, %r10
...
nop
and %r10, %r10
lea addresses_UC_ht+0x1e41d, %rsi
nop
nop
nop
nop
...
// Store
lea addresses_US+0x1e821, %r8
dec %r11
movb $0x51, (%r8)
sub $26279, %rsi

// Store
lea addresses_US+0x1bd61, %rbp
nop
nop
nop
add %r11, %r11
...
// Store
lea addresses_RW+0x9c21, %rbp
add $56535, %r11
movl $0x51525354, (%rbp)
xor $34790, %rbp

// Faulty Load
lea addresses_A+0x1e421, %r11
clflush (%r11)
nop
nop
nop
...
{'OP': 'STOR', 'dst': {'type': 'addresses_US', 'AVXalign': True, 'congruent': 6, 'size': 32, 'same': False, 'NT': True}}
...
<gen_prepare_buffer>
{'OP': 'REPM', 'src': {'type': 'addresses_D_ht', 'congruent': 8, 'same': False}, 'dst': {'type': 'addresses_A_ht', 'congruent': 9, 'same': True}}
