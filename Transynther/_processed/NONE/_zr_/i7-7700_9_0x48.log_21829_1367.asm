...
nop
add $35347, %rdi
lea addresses_D_ht+0x1ab8b, %r13
sub %r11, %r11
mov (%r13), %ebp
nop
nop
...
nop
xor %r15, %r15
lea addresses_normal_ht+0x13a3d, %r11
nop
and %rcx, %rcx
movb (%r11), %bl
cmp %r11, %r11
lea addresses_WT_ht+0x16715, %rsi
lea addresses_D_ht+0xc445, %rdi
nop
nop
nop
xor %rbx, %rbx
...
rep movsq
sub %rdi, %rdi
lea addresses_UC_ht+0x2d99, %r15
nop
nop
nop
dec %rcx
...
nop
dec %rdi
lea addresses_WC_ht+0x18a05, %r13
clflush (%r13)
nop
nop
nop
