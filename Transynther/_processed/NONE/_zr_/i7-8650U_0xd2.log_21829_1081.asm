...
vmovups %ymm6, (%rsi)
sub $57313, %r8
lea addresses_normal_ht+0x101ab, %r15
nop
nop
nop
nop
...
nop
cmp $27230, %r8
lea addresses_normal_ht+0x18e3b, %r11
clflush (%r11)
nop
nop
nop
...
nop
cmp $55680, %rsi
lea addresses_normal_ht+0x16bb7, %rsi
lea addresses_A_ht+0xc995, %rdi
nop
nop
xor $3176, %r15
mov $103, %rcx
...
nop
cmp %r11, %r11
lea addresses_WT_ht+0x17c85, %rsi
nop
nop
sub $35388, %r8
mov (%rsi), %r13d
...
nop
cmp $58939, %rdi
lea addresses_D_ht+0x1a0bb, %rsi
lea addresses_A_ht+0x197f, %rdi
add %rax, %rax
mov $106, %rcx
rep movsb
nop
...
nop
xor %rsi, %rsi
lea addresses_WT_ht+0x223b, %r11
nop
nop
nop
nop
...
{'OP': 'LOAD', 'src': {'type': 'addresses_WT_ht', 'size': 4, 'AVXalign': True, 'NT': False, 'congruent': 1, 'same': False}}
