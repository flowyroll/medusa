...
vpextrq $0, %xmm1, %r11
cmp %r13, %r13
lea addresses_WC_ht+0x17156, %rdi
nop
cmp %r13, %r13
mov (%rdi), %r15
nop
nop
add $57851, %r15
lea addresses_D_ht+0x17156, %r8
xor $18491, %r10
mov (%r8), %r13d
nop
dec %r11
lea addresses_UC_ht+0xc56, %r13
nop
nop
nop
nop
...
movb (%r13), %r15b
add $59095, %r11
lea addresses_WC_ht+0xc156, %rdi
nop
and %r15, %r15
mov (%rdi), %r10w
nop
...
nop
xor $13476, %r15
lea addresses_A_ht+0x8156, %rsi
lea addresses_normal_ht+0x2156, %rdi
nop
nop
nop
nop
...
nop
inc %rdi
lea addresses_A_ht+0x19d9a, %rsi
lea addresses_D_ht+0x115de, %rdi
clflush (%rsi)
nop
sub %r13, %r13
mov $114, %rcx
...
nop
and %r10, %r10
lea addresses_UC_ht+0x1d0d6, %r13
nop
nop
nop
nop
...
nop
add $32257, %r8
lea addresses_WT_ht+0x5cfb, %rsi
lea addresses_D_ht+0x856, %rdi
nop
nop
nop
xor $28468, %r15
...
nop
inc %r15
lea addresses_D_ht+0x1098e, %r10
nop
nop
nop
nop
...
{'OP': 'LOAD', 'src': {'type': 'addresses_WC', 'AVXalign': False, 'congruent': 11, 'size': 1, 'same': False, 'NT': False}}
...
{'OP': 'REPM', 'src': {'type': 'addresses_A_ht', 'congruent': 10, 'same': False}, 'dst': {'type': 'addresses_normal_ht', 'congruent': 10, 'same': False}}
