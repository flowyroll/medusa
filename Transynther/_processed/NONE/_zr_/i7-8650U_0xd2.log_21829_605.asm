...
lea addresses_D_ht+0x1568d, %rdi
nop
nop
nop
dec %rax
...
nop
cmp $40891, %rdx
lea addresses_A_ht+0x1634d, %r13
nop
nop
nop
add %r8, %r8
...
nop
inc %rsi
lea addresses_WT_ht+0xd98d, %rsi
nop
nop
inc %r8
...
nop
xor $2825, %rcx
lea addresses_A_ht+0x1078d, %rax
nop
nop
inc %rdi
...
vmovups %ymm3, (%rax)
xor $32609, %r13
lea addresses_normal_ht+0x1b38d, %rdx
nop
nop
nop
nop
...
mov (%rdx), %edi
cmp %r8, %r8
lea addresses_UC_ht+0x188d, %r13
nop
nop
nop
sub $51897, %rdi
