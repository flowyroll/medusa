...
push %rdi
push %rsi
lea addresses_A_ht+0x184ea, %rsi
...
nop
inc %rbp
lea addresses_A_ht+0x1e826, %rsi
lea addresses_D_ht+0x1088a, %rdi
nop
nop
cmp $63906, %r12
mov $21, %rcx
rep movsl
add %r12, %r12
lea addresses_UC_ht+0x658a, %rcx
nop
nop
add $15545, %r12
mov (%rcx), %r15d
and %rbp, %rbp
lea addresses_UC_ht+0x1988a, %r15
nop
nop
add %r8, %r8
movw $0x6162, (%r15)
...
lea addresses_UC_ht+0x148a, %rdi
and %r11, %r11
mov $109, %rcx
rep movsb
nop
...
nop
xor %r11, %r11
lea addresses_UC_ht+0x16f8a, %r8
clflush (%r8)
nop
nop
nop
...
nop
and $63504, %r15
lea addresses_WC_ht+0x488a, %rsi
lea addresses_D_ht+0x888a, %rdi
nop
nop
nop
nop
...
// Store
lea addresses_normal+0xe3bb, %rdx
nop
nop
nop
nop
...
<gen_faulty_load>
[REF]
{'OP': 'LOAD', 'src': {'type': 'addresses_UC', 'AVXalign': False, 'congruent': 0, 'size': 16, 'same': False, 'NT': True}}
...
{'OP': 'REPM', 'src': {'type': 'addresses_WC_ht', 'congruent': 11, 'same': True}, 'dst': {'type': 'addresses_D_ht', 'congruent': 11, 'same': False}}
{'00': 21829}
