...
push %rdi
push %rsi
lea addresses_normal_ht+0x51ec, %rsi
lea addresses_D_ht+0x4aec, %rdi
xor $11885, %r12
mov $120, %rcx
rep movsq
nop
...
nop
add $33467, %r12
lea addresses_UC_ht+0x193ec, %rbp
nop
nop
nop
nop
...
nop
cmp %rax, %rax
lea addresses_WT_ht+0xdec, %rdi
nop
nop
inc %rax
mov (%rdi), %bp
xor %rdi, %rdi
lea addresses_D_ht+0x1efac, %rsi
lea addresses_WC_ht+0x31ec, %rdi
clflush (%rsi)
dec %r14
mov $29, %rcx
rep movsl
...
{'src': {'congruent': 6, 'same': False, 'type': 'addresses_D_ht'}, 'OP': 'REPM', 'dst': {'congruent': 5, 'same': False, 'type': 'addresses_WC_ht'}}
{'00': 21829}
