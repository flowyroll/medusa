...
push %rdi
push %rsi
lea addresses_UC_ht+0x5c08, %rsi
lea addresses_A_ht+0x1a51c, %rdi
nop
nop
and %r9, %r9
mov $115, %rcx
...
movq %rcx, (%rbx)
inc %rcx
lea addresses_UC_ht+0x75e0, %rsi
lea addresses_A_ht+0x1cf08, %rdi
nop
nop
inc %r11
mov $119, %rcx
...
nop
xor %rsi, %rsi
lea addresses_A_ht+0x13708, %rbx
nop
nop
nop
nop
...
nop
and $23969, %r12
lea addresses_UC_ht+0x1c988, %r9
nop
xor %rdi, %rdi
movups (%r9), %xmm0
vpextrq $0, %xmm0, %rsi
...
mov (%r9), %rbp
xor %r12, %r12
lea addresses_WT_ht+0xfe08, %rdi
clflush (%rdi)
nop
nop
nop
...
nop
cmp $61335, %rsi
lea addresses_UC_ht+0xb708, %r11
nop
nop
nop
sub $4184, %rbp
...
nop
add $65023, %r11
lea addresses_WT_ht+0x15922, %rsi
lea addresses_D_ht+0x15f08, %rdi
nop
nop
nop
cmp %r12, %r12
