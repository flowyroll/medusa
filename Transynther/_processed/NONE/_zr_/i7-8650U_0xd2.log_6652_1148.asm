...
push %rdi
push %rsi
lea addresses_UC_ht+0x18a1b, %rsi
lea addresses_D_ht+0x17143, %rdi
nop
add %r13, %r13
mov $120, %rcx
rep movsq
...
nop
cmp %rsi, %rsi
lea addresses_UC_ht+0x5e1b, %rcx
sub $55236, %r13
vmovups (%rcx), %ymm5
...
nop
add %rdi, %rdi
lea addresses_A_ht+0x1ccf1, %rsi
lea addresses_WT_ht+0x1221b, %rdi
add %r8, %r8
mov $72, %rcx
rep movsb
cmp $51562, %rdi
lea addresses_normal_ht+0xc64b, %rsi
lea addresses_WC_ht+0x1e60b, %rdi
xor $24249, %r8
mov $117, %rcx
rep movsl
nop
...
nop
sub %rdi, %rdi
lea addresses_D_ht+0x1ea4b, %rcx
nop
nop
nop
nop
...
nop
and %rsi, %rsi
lea addresses_normal_ht+0x1ae1b, %rdi
nop
nop
nop
nop
...
nop
sub $28144, %rbx
lea addresses_normal_ht+0x1af1b, %rdi
nop
nop
nop
nop
...
nop
dec %r13
lea addresses_normal_ht+0xa7b, %rdi
nop
sub %rsi, %rsi
vmovups (%rdi), %ymm3
...
nop
inc %rbx
lea addresses_UC_ht+0x11a1b, %r8
nop
cmp %rbp, %rbp
...
nop
inc %rbp
lea addresses_WC_ht+0xd5a7, %r8
add %rbp, %rbp
vmovups (%r8), %ymm5
vextracti128 $1, %ymm5, %xmm5
vpextrq $1, %xmm5, %rbx
sub $37475, %r13
lea addresses_WC_ht+0x8b4b, %rdi
nop
nop
nop
cmp $21610, %rbx
...
nop
xor %rbx, %rbx
lea addresses_WT_ht+0x1701b, %rdi
and %r8, %r8
movw $0x6162, (%rdi)
nop
sub %rbx, %rbx
...
{'OP': 'STOR', 'dst': {'type': 'addresses_D', 'size': 16, 'AVXalign': False, 'NT': True, 'congruent': 7, 'same': False}}
[Faulty Load]
...
{'OP': 'REPM', 'src': {'type': 'addresses_A_ht', 'congruent': 0, 'same': False}, 'dst': {'type': 'addresses_WT_ht', 'congruent': 11, 'same': False}}
{'OP': 'REPM', 'src': {'type': 'addresses_normal_ht', 'congruent': 4, 'same': False}, 'dst': {'type': 'addresses_WC_ht', 'congruent': 2, 'same': False}}
{'OP': 'STOR', 'dst': {'type': 'addresses_D_ht', 'size': 8, 'AVXalign': False, 'NT': True, 'congruent': 4, 'same': False}}
...
{'OP': 'STOR', 'dst': {'type': 'addresses_WC_ht', 'size': 4, 'AVXalign': True, 'NT': False, 'congruent': 4, 'same': False}}
