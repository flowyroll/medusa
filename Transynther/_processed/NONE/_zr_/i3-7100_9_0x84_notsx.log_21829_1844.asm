...
lea addresses_normal_ht+0x19fbc, %rdi
nop
nop
nop
add %r15, %r15
...
nop
dec %r13
lea addresses_UC_ht+0x8a7c, %r13
nop
nop
nop
nop
...
nop
dec %r10
lea addresses_WC_ht+0x112fc, %rsi
lea addresses_A_ht+0x6e1c, %rdi
nop
nop
nop
sub $41302, %rbx
...
nop
xor %rsi, %rsi
lea addresses_normal_ht+0x88d4, %rsi
lea addresses_normal_ht+0x11122, %rdi
nop
nop
cmp $61202, %r10
mov $78, %rcx
...
lea addresses_normal_ht+0x99a2, %rdi
add $34840, %r15
mov $101, %rcx
rep movsb
nop
...
{'src': {'type': 'addresses_D_ht', 'congruent': 6, 'same': False}, 'dst': {'type': 'addresses_normal_ht', 'congruent': 5, 'same': False}, 'OP': 'REPM'}
{'dst': {'type': 'addresses_UC_ht', 'same': False, 'size': 1, 'congruent': 7, 'NT': False, 'AVXalign': True}, 'OP': 'STOR'}
{'src': {'type': 'addresses_WC_ht', 'congruent': 3, 'same': True}, 'dst': {'type': 'addresses_A_ht', 'congruent': 5, 'same': False}, 'OP': 'REPM'}
{'src': {'type': 'addresses_normal_ht', 'congruent': 2, 'same': False}, 'dst': {'type': 'addresses_normal_ht', 'congruent': 0, 'same': False}, 'OP': 'REPM'}
{'src': {'type': 'addresses_normal_ht', 'congruent': 5, 'same': False}, 'dst': {'type': 'addresses_normal_ht', 'congruent': 0, 'same': False}, 'OP': 'REPM'}
