...
push %rdi
push %rsi
lea addresses_UC_ht+0x6d74, %rsi
lea addresses_normal_ht+0xdf74, %rdi
nop
nop
cmp $27676, %r12
mov $58, %rcx
...
nop
add $53915, %r8
lea addresses_normal_ht+0xfcd4, %rax
nop
nop
nop
inc %r8
...
nop
cmp $11943, %r12
lea addresses_WT_ht+0x4074, %r8
nop
inc %rax
mov (%r8), %rdi
nop
xor $59626, %rsi
lea addresses_WC_ht+0x7394, %rax
nop
nop
nop
nop
...
nop
sub %r12, %r12
lea addresses_A_ht+0x10f74, %rsi
lea addresses_D_ht+0x1e974, %rdi
nop
nop
inc %r12
mov $42, %rcx
rep movsl
xor %r8, %r8
lea addresses_WC_ht+0xb05d, %r12
clflush (%r12)
nop
sub $8555, %rax
movl $0x61626364, (%r12)
...
nop
dec %rdi
lea addresses_normal_ht+0x17b74, %rsi
lea addresses_WT_ht+0x1ed74, %rdi
sub %r11, %r11
mov $77, %rcx
rep movsq
add %r8, %r8
lea addresses_D_ht+0x1b374, %rdi
nop
nop
nop
add %r12, %r12
...
nop
xor $2050, %rsi
lea addresses_WT_ht+0x149b6, %rax
nop
nop
xor $28233, %rsi
movb (%rax), %r12b
...
{'OP': 'REPM', 'src': {'type': 'addresses_A_ht', 'congruent': 11, 'same': False}, 'dst': {'type': 'addresses_D_ht', 'congruent': 9, 'same': False}}
