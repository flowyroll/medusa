...
push %rdi
push %rsi
lea addresses_WC_ht+0xf619, %rbx
and %r10, %r10
...
nop
inc %rbx
lea addresses_A_ht+0x19d49, %rsi
lea addresses_A_ht+0x4789, %rdi
clflush (%rdi)
add $18382, %rbp
mov $84, %rcx
rep movsb
...
nop
sub $34199, %rsi
lea addresses_A_ht+0x5899, %rdi
nop
nop
sub $17812, %r12
mov (%rdi), %si
sub %r10, %r10
lea addresses_D_ht+0xda19, %rsi
lea addresses_WC_ht+0x7d19, %rdi
nop
nop
nop
nop
...
nop
and %r12, %r12
lea addresses_UC_ht+0x1a159, %rdi
nop
cmp %rbx, %rbx
movw $0x6162, (%rdi)
inc %r12
lea addresses_D_ht+0x3919, %rbp
clflush (%rbp)
nop
add $27881, %rdi
...
lea addresses_WT_ht+0x17419, %rdi
nop
nop
nop
nop
...
nop
xor $44968, %r12
lea addresses_WT_ht+0xd239, %rsi
lea addresses_UC_ht+0x1a011, %rdi
clflush (%rdi)
nop
nop
nop
...
lea addresses_WT_ht+0xb3f9, %rdi
nop
nop
cmp %r12, %r12
mov $30, %rcx
...
nop
lfence
lea addresses_normal_ht+0x1719, %rsi
lea addresses_normal_ht+0x16a9, %rdi
nop
nop
nop
and %rbx, %rbx
...
nop
and %rdi, %rdi
lea addresses_UC_ht+0xa019, %r11
nop
nop
nop
nop
...
nop
and %rsi, %rsi
lea addresses_normal_ht+0xf719, %rbp
nop
mfence
mov (%rbp), %ebx
nop
...
<gen_prepare_buffer>
{'OP': 'LOAD', 'src': {'size': 32, 'NT': True, 'type': 'addresses_WC_ht', 'same': False, 'AVXalign': False, 'congruent': 6}}
...
{'OP': 'STOR', 'dst': {'size': 2, 'NT': False, 'type': 'addresses_UC_ht', 'same': False, 'AVXalign': True, 'congruent': 6}}
{'OP': 'STOR', 'dst': {'size': 32, 'NT': False, 'type': 'addresses_D_ht', 'same': False, 'AVXalign': False, 'congruent': 8}}
{'OP': 'REPM', 'src': {'same': False, 'type': 'addresses_WT_ht', 'congruent': 4}, 'dst': {'same': False, 'type': 'addresses_WT_ht', 'congruent': 7}}
{'OP': 'REPM', 'src': {'same': False, 'type': 'addresses_WT_ht', 'congruent': 5}, 'dst': {'same': False, 'type': 'addresses_UC_ht', 'congruent': 2}}
{'OP': 'REPM', 'src': {'same': False, 'type': 'addresses_A_ht', 'congruent': 9}, 'dst': {'same': False, 'type': 'addresses_WT_ht', 'congruent': 3}}
