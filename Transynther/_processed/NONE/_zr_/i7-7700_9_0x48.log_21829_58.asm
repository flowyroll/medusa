...
push %rdi
push %rsi
lea addresses_normal_ht+0x90d5, %rsi
lea addresses_A_ht+0x5cb5, %rdi
nop
nop
nop
nop
...
nop
and %r15, %r15
lea addresses_UC_ht+0xd655, %r15
nop
nop
nop
nop
...
nop
cmp $18554, %rsi
lea addresses_WC_ht+0x11955, %rbp
nop
nop
nop
nop
...
// REPMOV
mov $0x29eba700000008ad, %rsi
lea addresses_PSE+0x15149, %rdi
nop
nop
cmp $29222, %r9
mov $56, %rcx
...
{'OP': 'REPM', 'src': {'type': 'addresses_NC', 'congruent': 2, 'same': False}, 'dst': {'type': 'addresses_PSE', 'congruent': 0, 'same': False}}
[Faulty Load]
