...
push %rdi
push %rsi
lea addresses_normal_ht+0x62a1, %rsi
lea addresses_D_ht+0xbb7c, %rdi
xor $17063, %r11
mov $118, %rcx
rep movsb
nop
...
nop
dec %rdi
lea addresses_WC_ht+0x101bb, %r8
nop
inc %r13
movl $0x61626364, (%r8)
cmp %r11, %r11
lea addresses_normal_ht+0xc7d5, %r8
nop
nop
nop
nop
...
nop
and %rsi, %rsi
lea addresses_UC_ht+0x116d5, %rsi
lea addresses_A_ht+0x1a5d5, %rdi
nop
xor %r15, %r15
mov $109, %rcx
rep movsl
...
nop
and %rdi, %rdi
lea addresses_D_ht+0x18f95, %r10
nop
nop
nop
nop
...
nop
xor %r8, %r8
lea addresses_normal_ht+0xf4d5, %r8
nop
nop
and %r13, %r13
...
nop
xor %r13, %r13
lea addresses_normal_ht+0x1b3d5, %rcx
dec %r8
movups (%rcx), %xmm4
vpextrq $1, %xmm4, %r13
nop
...
{'OP': 'LOAD', 'src': {'type': 'addresses_D_ht', 'AVXalign': False, 'congruent': 1, 'size': 4, 'same': True, 'NT': False}}
