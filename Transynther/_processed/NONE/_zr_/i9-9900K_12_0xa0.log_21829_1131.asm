...
push %rdi
push %rsi
lea addresses_D_ht+0xb616, %rsi
lea addresses_UC_ht+0xb553, %rdi
clflush (%rsi)
nop
inc %rax
mov $89, %rcx
rep movsl
cmp $46809, %r10
lea addresses_WT_ht+0x472d, %r14
nop
cmp $26038, %rbx
...
nop
cmp $62684, %rcx
lea addresses_A_ht+0x143cb, %rcx
nop
nop
dec %r14
...
nop
dec %rdi
lea addresses_WC_ht+0x11e43, %rbx
nop
nop
dec %r10
...
nop
inc %rbx
lea addresses_WC_ht+0x17373, %rdi
nop
nop
nop
nop
...
nop
xor $46028, %rax
lea addresses_normal_ht+0x891b, %rbx
nop
nop
xor %rdi, %rdi
vmovups (%rbx), %ymm2
...
<gen_prepare_buffer>
{'src': {'same': False, 'congruent': 0, 'type': 'addresses_D_ht'}, 'OP': 'REPM', 'dst': {'same': False, 'congruent': 6, 'type': 'addresses_UC_ht'}}
{'OP': 'STOR', 'dst': {'NT': False, 'same': False, 'congruent': 0, 'type': 'addresses_WT_ht', 'AVXalign': False, 'size': 32}}
{'src': {'NT': False, 'same': False, 'congruent': 1, 'type': 'addresses_A_ht', 'AVXalign': True, 'size': 16}, 'OP': 'LOAD'}
