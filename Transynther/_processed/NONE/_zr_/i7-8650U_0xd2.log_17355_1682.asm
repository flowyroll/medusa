...
nop
and %r9, %r9
lea addresses_WT_ht+0x1b73, %r13
nop
nop
add $37934, %rdi
movw $0x6162, (%r13)
add $45609, %rdi
lea addresses_WT_ht+0x7773, %rsi
lea addresses_A_ht+0x10173, %rdi
nop
nop
nop
cmp %r10, %r10
...
nop
sub $43699, %rdi
lea addresses_A_ht+0x15553, %r13
clflush (%r13)
nop
nop
sub $41412, %r14
