...
lea addresses_WC_ht+0x6cd3, %rdi
nop
nop
nop
sub $64925, %rbx
...
nop
add %r8, %r8
lea addresses_WC_ht+0x54d3, %rsi
nop
nop
cmp $52590, %r12
mov (%rsi), %r10w
...
nop
inc %r8
lea addresses_WT_ht+0x14cd3, %rcx
nop
nop
nop
nop
...
nop
sub $24270, %rbx
lea addresses_normal_ht+0x64d3, %r12
cmp %rbx, %rbx
movw $0x6162, (%r12)
nop
nop
...
nop
inc %rsi
lea addresses_WT_ht+0xd9d3, %rsi
nop
inc %r10
movb (%rsi), %cl
nop
...
nop
and $35830, %r12
lea addresses_WT_ht+0x13cd3, %rsi
lea addresses_WT_ht+0x1a8d3, %rdi
clflush (%rsi)
nop
dec %r12
mov $110, %rcx
