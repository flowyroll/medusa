...
push %rdi
push %rsi
lea addresses_WT_ht+0x1b1f3, %r14
clflush (%r14)
nop
nop
dec %r10
...
nop
sub $19857, %rcx
lea addresses_WC_ht+0x106db, %r10
nop
nop
sub %r11, %r11
mov (%r10), %esi
...
nop
cmp $2893, %rcx
lea addresses_D_ht+0x113e7, %rdi
nop
nop
nop
nop
...
movb (%rdi), %cl
sub $19561, %r11
lea addresses_WT_ht+0x1ce77, %rdi
nop
nop
nop
nop
...
nop
xor %r11, %r11
lea addresses_WC_ht+0x1eb3b, %rdi
nop
nop
nop
nop
...
nop
cmp %r8, %r8
lea addresses_normal_ht+0x79e9, %rsi
nop
add %rdi, %rdi
movl $0x61626364, (%rsi)
add $45710, %r8
lea addresses_D_ht+0x65db, %rsi
lea addresses_UC_ht+0x1a0db, %rdi
nop
nop
nop
sub %rbp, %rbp
...
rep movsl
and $1484, %rsi
lea addresses_WC_ht+0xebdb, %rsi
lea addresses_UC_ht+0xd0db, %rdi
nop
cmp $47687, %r10
mov $125, %rcx
rep movsq
...
nop
xor %rdi, %rdi
lea addresses_UC_ht+0xefdb, %rsi
lea addresses_UC_ht+0x105fd, %rdi
and $47504, %r10
mov $49, %rcx
rep movsq
nop
nop
sub $7180, %r14
lea addresses_WT_ht+0x1e930, %rsi
sub $55633, %rcx
mov (%rsi), %r10d
nop
nop
...
nop
and %r14, %r14
lea addresses_WT_ht+0x21ab, %rbp
clflush (%rbp)
nop
nop
nop
...
nop
add $34552, %rsi
lea addresses_WT_ht+0x1ecdb, %r11
nop
cmp $29838, %r14
mov (%r11), %ecx
nop
