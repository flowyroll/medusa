...
push %rdx
push %rsi
lea addresses_WT_ht+0x4697, %rdx
nop
nop
nop
dec %rdi
...
nop
sub $15844, %rbx
lea addresses_WC_ht+0x4d9b, %rsi
lea addresses_A_ht+0x3717, %rdi
clflush (%rsi)
nop
and $58000, %rdx
mov $127, %rcx
rep movsq
and $35869, %rcx
lea addresses_A_ht+0x1a46d, %rbx
nop
nop
nop
nop
...
{'OP': 'REPM', 'src': {'type': 'addresses_WC_ht', 'congruent': 2, 'same': False}, 'dst': {'type': 'addresses_A_ht', 'congruent': 6, 'same': False}}
