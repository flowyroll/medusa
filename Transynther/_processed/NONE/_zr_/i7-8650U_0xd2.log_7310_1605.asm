...
nop
cmp %r8, %r8
lea addresses_UC_ht+0x1a21d, %r11
nop
nop
nop
nop
...
nop
inc %r11
lea addresses_normal_ht+0x139dd, %rcx
nop
and %rdx, %rdx
...
nop
sub $31984, %rsi
lea addresses_normal_ht+0x10b31, %rcx
nop
nop
nop
nop
...
nop
inc %r11
lea addresses_WT_ht+0x1b59d, %r15
nop
nop
nop
nop
...
{'OP': 'STOR', 'dst': {'type': 'addresses_US', 'size': 2, 'AVXalign': False, 'NT': False, 'congruent': 10, 'same': False}}
...
<gen_prepare_buffer>
{'OP': 'REPM', 'src': {'type': 'addresses_A_ht', 'congruent': 2, 'same': True}, 'dst': {'type': 'addresses_normal_ht', 'congruent': 9, 'same': False}}
