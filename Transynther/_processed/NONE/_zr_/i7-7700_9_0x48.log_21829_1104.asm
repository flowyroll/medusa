...
push %rdx
push %rsi
lea addresses_normal_ht+0x626c, %r10
nop
nop
nop
and $42221, %rdx
movl $0x61626364, (%r10)
inc %r11
lea addresses_UC_ht+0x1d501, %rsi
lea addresses_WC_ht+0x15981, %rdi
nop
nop
cmp $62877, %r9
mov $113, %rcx
...
// Load
lea addresses_normal+0xa554, %r15
cmp %rcx, %rcx
movups (%r15), %xmm4
vpextrq $0, %xmm4, %rbx
nop
