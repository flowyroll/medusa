...
push %rdi
push %rsi
lea addresses_normal_ht+0x2f8d, %rsi
lea addresses_UC_ht+0x601, %rdi
clflush (%rsi)
nop
nop
cmp %r13, %r13
...
rep movsb
sub %r14, %r14
lea addresses_normal_ht+0x13d8d, %rsi
clflush (%rsi)
nop
nop
nop
...
nop
cmp %rcx, %rcx
lea addresses_A_ht+0x15a2d, %r15
xor $29599, %rbx
...
nop
dec %r15
lea addresses_D_ht+0x1a58d, %rsi
...
{'OP': 'REPM', 'src': {'type': 'addresses_D_ht', 'congruent': 11, 'same': False}, 'dst': {'type': 'addresses_A_ht', 'congruent': 1, 'same': False}}
{'00': 21829}
