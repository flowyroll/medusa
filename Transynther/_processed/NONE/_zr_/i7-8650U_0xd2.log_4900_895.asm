...
push %rdi
push %rsi
lea addresses_normal_ht+0x8365, %r12
nop
nop
nop
nop
...
nop
xor %r12, %r12
lea addresses_WC_ht+0xfb08, %rsi
...
nop
and $54883, %rax
lea addresses_WT_ht+0x4f00, %rax
nop
inc %rsi
mov (%rax), %r12d
nop
add %rbp, %rbp
lea addresses_WT_ht+0x1e228, %rsi
lea addresses_WT_ht+0x6efc, %rdi
nop
sub %r12, %r12
mov $125, %rcx
rep movsq
...
// Store
lea addresses_normal+0xe668, %r12
nop
nop
nop
add %rbx, %rbx
...
{'OP': 'REPM', 'src': {'type': 'addresses_WC_ht', 'congruent': 1, 'same': True}, 'dst': {'type': 'addresses_normal_ht', 'congruent': 10, 'same': False}}
