...
movb (%rsi), %r13b
cmp $33302, %r12
lea addresses_WT_ht+0x209a, %r15
nop
nop
nop
nop
...
nop
cmp %r11, %r11
lea addresses_WC_ht+0xe13a, %rsi
lea addresses_WT_ht+0x9afa, %rdi
cmp %r11, %r11
mov $32, %rcx
rep movsl
nop
...
nop
and %rdi, %rdi
lea addresses_WT_ht+0x706c, %rsi
lea addresses_UC_ht+0x1c83a, %rdi
nop
nop
nop
xor $45956, %r14
...
rep movsl
xor $49785, %rcx
lea addresses_D_ht+0xcdba, %r15
nop
nop
inc %rcx
movb $0x61, (%r15)
add $49529, %rsi
lea addresses_UC_ht+0xc53a, %r13
nop
nop
nop
nop
...
nop
mfence
lea addresses_WT_ht+0x19e, %rsi
lea addresses_UC_ht+0x283a, %rdi
clflush (%rdi)
nop
add $61777, %r12
mov $46, %rcx
...
// Store
lea addresses_normal+0x14e7a, %rcx
nop
nop
nop
nop
...
// Store
lea addresses_US+0xd93a, %r10
and $61013, %rsi
movw $0x5152, (%r10)
cmp %r9, %r9

// Store
lea addresses_UC+0x1bc34, %r12
nop
and %r9, %r9
...
{'OP': 'STOR', 'dst': {'size': 8, 'NT': True, 'type': 'addresses_WT_ht', 'same': False, 'AVXalign': False, 'congruent': 5}}
{'OP': 'STOR', 'dst': {'size': 32, 'NT': True, 'type': 'addresses_A_ht', 'same': False, 'AVXalign': False, 'congruent': 8}}
{'OP': 'REPM', 'src': {'same': False, 'type': 'addresses_WC_ht', 'congruent': 11}, 'dst': {'same': False, 'type': 'addresses_WT_ht', 'congruent': 6}}
{'OP': 'REPM', 'src': {'same': True, 'type': 'addresses_WT_ht', 'congruent': 0}, 'dst': {'same': True, 'type': 'addresses_UC_ht', 'congruent': 8}}
