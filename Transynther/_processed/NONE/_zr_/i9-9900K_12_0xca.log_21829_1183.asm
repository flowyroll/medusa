...
push %rdi
push %rsi
lea addresses_D_ht+0x1c631, %r12
clflush (%r12)
nop
nop
nop
...
nop
add $9948, %rbx
lea addresses_WC_ht+0x470, %rsi
lea addresses_D_ht+0x9150, %rdi
xor %r10, %r10
mov $84, %rcx
rep movsw
nop
and %rdi, %rdi
lea addresses_WT_ht+0x1e7d0, %rdi
nop
nop
nop
lfence
...
nop
cmp %r10, %r10
lea addresses_A_ht+0x19f50, %rbp
inc %rsi
movb (%rbp), %r13b
nop
nop
xor $29461, %r12
lea addresses_WC_ht+0x199a4, %rsi
lea addresses_WT_ht+0xd750, %rdi
nop
nop
dec %r10
mov $48, %rcx
...
nop
dec %r13
lea addresses_UC_ht+0x10050, %rbx
nop
nop
xor %rcx, %rcx
movups (%rbx), %xmm0
...
nop
and $9673, %r13
lea addresses_A_ht+0x15ef0, %r10
xor $22506, %rbx
...
{'OP': 'STOR', 'dst': {'size': 1, 'NT': False, 'type': 'addresses_UC', 'same': False, 'AVXalign': True, 'congruent': 2}}
[Faulty Load]
...
{'OP': 'REPM', 'src': {'same': False, 'type': 'addresses_WC_ht', 'congruent': 0}, 'dst': {'same': False, 'type': 'addresses_WT_ht', 'congruent': 11}}
