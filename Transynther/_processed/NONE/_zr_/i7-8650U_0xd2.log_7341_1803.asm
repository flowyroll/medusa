...
push %rdi
push %rsi
lea addresses_WT_ht+0x1a1ec, %rsi
...
rep movsl
cmp $53753, %rsi
lea addresses_WC_ht+0x1e394, %rsi
lea addresses_A_ht+0xe994, %rdi
nop
add %r9, %r9
mov $117, %rcx
rep movsl
...
nop
cmp %r9, %r9
lea addresses_D_ht+0x1c594, %rsi
...
{'OP': 'STOR', 'dst': {'type': 'addresses_RW', 'size': 8, 'AVXalign': True, 'NT': False, 'congruent': 8, 'same': False}}
[Faulty Load]
