...
push %rdi
push %rsi
lea addresses_normal_ht+0x1547a, %r8
nop
nop
nop
xor %r11, %r11
...
nop
add %rbx, %rbx
lea addresses_WT_ht+0x1812, %rbp
nop
nop
nop
nop
...
nop
xor %r9, %r9
lea addresses_WT_ht+0x1be7a, %r14
and $20538, %r9
movb (%r14), %bl
nop
and $50017, %rbp
lea addresses_normal_ht+0x1c5d2, %r12
nop
add %r8, %r8
mov (%r12), %r11
sub $62160, %r12
lea addresses_WC_ht+0x8202, %r14
nop
nop
cmp %r9, %r9
mov (%r14), %ebp
nop
cmp $16774, %r8
lea addresses_WC_ht+0x14a7a, %rsi
lea addresses_WT_ht+0x147a, %rdi
nop
add %rbx, %rbx
mov $44, %rcx
rep movsq
...
{'src': {'same': False, 'congruent': 9, 'type': 'addresses_WC_ht'}, 'OP': 'REPM', 'dst': {'same': False, 'congruent': 11, 'type': 'addresses_WT_ht'}}
{'00': 21829}
