...
push %rdi
push %rsi
lea addresses_normal_ht+0x1e289, %rsi
lea addresses_WT_ht+0x1a7e9, %rdi
nop
nop
nop
nop
...
nop
add $5689, %r15
lea addresses_UC_ht+0x12e49, %rsi
lea addresses_WC_ht+0x449, %rdi
and $15940, %r10
mov $3, %rcx
rep movsw
dec %r10
...
// Store
lea addresses_UC+0x1c98c, %r11
and %rdi, %rdi
movw $0x5152, (%r11)
dec %rdx

// Store
lea addresses_D+0x2849, %r15
nop
nop
nop
nop
