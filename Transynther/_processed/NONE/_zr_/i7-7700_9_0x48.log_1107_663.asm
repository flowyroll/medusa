...
nop
sub $60960, %r13
lea addresses_A_ht+0x1db12, %r11
xor %rax, %rax
vmovups (%r11), %ymm0
...
nop
inc %rcx
lea addresses_D_ht+0x14012, %rax
add $26220, %r13
...
nop
cmp %r11, %r11
lea addresses_D_ht+0xe292, %rsi
lea addresses_A_ht+0xa212, %rdi
nop
nop
xor %r10, %r10
mov $3, %rcx
...
nop
add $55723, %r13
lea addresses_normal_ht+0x1142c, %rcx
nop
nop
nop
nop
...
nop
inc %r11
lea addresses_A_ht+0x1292, %rsi
lea addresses_UC_ht+0x1812, %rdi
nop
nop
nop
nop
...
rep movsb
xor %r9, %r9
lea addresses_UC_ht+0xa40c, %rsi
nop
nop
nop
nop
...
<gen_prepare_buffer>
{'OP': 'STOR', 'dst': {'type': 'addresses_WT_ht', 'AVXalign': True, 'congruent': 7, 'size': 16, 'same': False, 'NT': False}}
