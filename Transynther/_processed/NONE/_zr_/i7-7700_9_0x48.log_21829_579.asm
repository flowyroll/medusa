...
push %rdx
push %rsi
lea addresses_UC_ht+0x81f0, %rsi
lea addresses_normal_ht+0x6f50, %rdi
clflush (%rdi)
nop
nop
nop
...
nop
add $59541, %r12
lea addresses_UC_ht+0x1d310, %rax
nop
nop
nop
nop
...
nop
xor %rsi, %rsi
lea addresses_normal_ht+0x1ed78, %rsi
lea addresses_UC_ht+0x1d6c0, %rdi
and $30628, %rbp
mov $5, %rcx
rep movsw
nop
sub $49970, %r14
lea addresses_WT_ht+0x16950, %rcx
nop
nop
nop
nop
...
{'OP': 'STOR', 'dst': {'type': 'addresses_PSE', 'AVXalign': True, 'congruent': 11, 'size': 2, 'same': False, 'NT': False}}
