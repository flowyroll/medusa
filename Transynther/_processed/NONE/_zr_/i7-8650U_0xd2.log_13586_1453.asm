...
nop
cmp %rdi, %rdi
lea addresses_D_ht+0x11081, %rsi
nop
nop
nop
nop
...
nop
sub $19957, %r15
lea addresses_normal_ht+0x10581, %r14
nop
nop
nop
nop
...
nop
add $38271, %rcx
lea addresses_WT_ht+0xdf01, %r11
inc %r14
mov (%r11), %rax
nop
add $24917, %r11
lea addresses_UC_ht+0x15701, %r11
clflush (%r11)
nop
nop
cmp %rcx, %rcx
...
{'OP': 'STOR', 'dst': {'type': 'addresses_RW', 'size': 32, 'AVXalign': False, 'NT': True, 'congruent': 7, 'same': False}}
...
{'OP': 'LOAD', 'src': {'type': 'addresses_D_ht', 'size': 32, 'AVXalign': False, 'NT': True, 'congruent': 2, 'same': True}}
