...
nop
dec %r10
lea addresses_WC_ht+0x1ec9e, %rsi
nop
nop
nop
nop
...
{'OP': 'STOR', 'dst': {'NT': True, 'same': False, 'congruent': 6, 'type': 'addresses_WC', 'AVXalign': False, 'size': 4}}
...
{'OP': 'STOR', 'dst': {'NT': False, 'same': False, 'congruent': 10, 'type': 'addresses_WT_ht', 'AVXalign': True, 'size': 1}}
