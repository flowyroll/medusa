...
nop
cmp %r12, %r12
lea addresses_UC_ht+0x13424, %rsi
lea addresses_D_ht+0x17090, %rdi
clflush (%rdi)
nop
nop
nop
...
nop
sub $45339, %r14
lea addresses_WT_ht+0x9390, %rsi
lea addresses_D_ht+0xe390, %rdi
nop
cmp %r10, %r10
mov $58, %rcx
rep movsq
xor %rsi, %rsi
lea addresses_UC_ht+0x1b4f0, %rsi
lea addresses_A_ht+0x3560, %rdi
clflush (%rdi)
nop
nop
nop
...
nop
dec %r14
lea addresses_WT_ht+0x69f0, %rsi
lea addresses_normal_ht+0x5590, %rdi
nop
nop
and $63365, %r14
mov $101, %rcx
...
nop
sub $44581, %r15
lea addresses_WT_ht+0xceed, %r15
sub $38280, %r13
...
nop
inc %r13
lea addresses_WC_ht+0xca8, %rsi
lea addresses_normal_ht+0x1a890, %rdi
nop
nop
nop
nop
...
nop
sub $33372, %r12
lea addresses_A_ht+0x12f90, %rsi
lea addresses_WT_ht+0x18490, %rdi
and %r14, %r14
mov $51, %rcx
rep movsl
nop
...
nop
and %r15, %r15
lea addresses_normal_ht+0xd598, %rsi
clflush (%rsi)
cmp %rcx, %rcx
mov (%rsi), %r12
nop
...
nop
dec %r12
lea addresses_normal_ht+0x1df90, %r15
nop
sub $35071, %r14
movups (%r15), %xmm7
vpextrq $1, %xmm7, %rsi
