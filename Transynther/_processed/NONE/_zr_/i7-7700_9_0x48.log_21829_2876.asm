...
push %rdi
push %rsi
lea addresses_UC_ht+0x116ec, %r11
nop
add %r8, %r8
mov (%r11), %bp
nop
nop
add $3854, %r11
lea addresses_normal_ht+0xccac, %rsi
lea addresses_UC_ht+0x886c, %rdi
xor $50338, %rbp
mov $28, %rcx
rep movsl
cmp %rsi, %rsi
lea addresses_normal_ht+0x342c, %rbp
nop
nop
sub $7468, %r8
mov (%rbp), %edi
...
nop
sub $60470, %r10
lea addresses_WT_ht+0xce7c, %rsi
lea addresses_D_ht+0x1e38c, %rdi
clflush (%rdi)
nop
nop
nop
...
nop
add %r8, %r8
lea addresses_UC_ht+0x19aec, %rbp
nop
nop
nop
cmp $13013, %r8
...
nop
and $56732, %r12
lea addresses_A_ht+0x3274, %r8
inc %rsi
movb (%r8), %r11b
nop
dec %rbp
lea addresses_normal_ht+0xb57c, %rdi
nop
nop
add $27537, %r8
...
nop
dec %r8
lea addresses_WC_ht+0x15326, %r8
nop
nop
nop
nop
...
nop
and %rcx, %rcx
lea addresses_WT_ht+0x11374, %r12
nop
xor $33724, %rbp
...
nop
and %rbp, %rbp
lea addresses_UC_ht+0x1c16e, %r12
nop
sub %r11, %r11
mov (%r12), %r10w
nop
...
// Store
lea addresses_normal+0x1b2ec, %r10
nop
nop
nop
nop
...
{'OP': 'REPM', 'src': {'type': 'addresses_normal_ht', 'congruent': 4, 'same': False}, 'dst': {'type': 'addresses_UC_ht', 'congruent': 7, 'same': False}}
...
{'OP': 'STOR', 'dst': {'type': 'addresses_UC_ht', 'AVXalign': False, 'congruent': 10, 'size': 1, 'same': False, 'NT': True}}
...
{'OP': 'LOAD', 'src': {'type': 'addresses_D_ht', 'AVXalign': False, 'congruent': 6, 'size': 8, 'same': True, 'NT': False}}
