...
push %rdi
push %rsi
lea addresses_WC_ht+0x1b26, %rsi
lea addresses_A_ht+0x10ea6, %rdi
nop
nop
nop
nop
...
nop
xor $25085, %rdi
lea addresses_normal_ht+0x1cdb6, %r14
xor $6872, %r12
...
nop
add %r12, %r12
lea addresses_A_ht+0x161a, %rsi
lea addresses_normal_ht+0x7c95, %rdi
nop
nop
nop
and $9903, %r12
...
// Store
lea addresses_normal+0x4126, %rbp
xor $14468, %r11
...
{'OP': 'STOR', 'dst': {'congruent': 5, 'AVXalign': False, 'same': False, 'size': 2, 'NT': True, 'type': 'addresses_A'}}
...
{'OP': 'STOR', 'dst': {'congruent': 6, 'AVXalign': False, 'same': False, 'size': 32, 'NT': False, 'type': 'addresses_US'}}
