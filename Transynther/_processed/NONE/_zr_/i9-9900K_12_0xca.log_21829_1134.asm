...
nop
dec %rdi
lea addresses_WC_ht+0x9eef, %rax
nop
nop
nop
nop
...
movb (%rax), %r12b
inc %r8
lea addresses_UC_ht+0x10f0f, %rsi
lea addresses_D_ht+0xf9e9, %rdi
nop
dec %r12
mov $14, %rcx
rep movsl
...
nop
dec %r11
lea addresses_WC_ht+0x1b94f, %r12
add $2540, %r8
mov (%r12), %rax
nop
sub %r12, %r12
lea addresses_normal_ht+0x1543f, %rcx
nop
nop
and $22346, %r8
mov (%rcx), %si
...
nop
and $15162, %r8
lea addresses_normal_ht+0x70af, %rdi
add $19243, %r12
...
nop
xor $44859, %rax
lea addresses_UC_ht+0x15eef, %rsi
lea addresses_normal_ht+0x10cff, %rdi
nop
nop
nop
nop
...
nop
add %rax, %rax
lea addresses_UC_ht+0x162ef, %r8
nop
nop
sub $20341, %rdx
movb (%r8), %r11b
...
{'OP': 'REPM', 'src': {'same': False, 'type': 'addresses_UC_ht', 'congruent': 4}, 'dst': {'same': False, 'type': 'addresses_D_ht', 'congruent': 1}}
