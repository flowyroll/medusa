...
push %rdx
push %rsi
lea addresses_WT_ht+0x1e038, %rsi
lea addresses_A_ht+0x4a68, %rdi
nop
nop
nop
nop
...
nop
xor $22354, %r14
lea addresses_A_ht+0xca08, %rsi
lea addresses_WT_ht+0x18e68, %rdi
nop
nop
dec %rdx
mov $80, %rcx
...
nop
inc %rdx
lea addresses_D_ht+0x13068, %rdi
nop
and $34620, %rsi
mov $0x6162636465666768, %r14
movq %r14, (%rdi)
xor $61620, %rdx
lea addresses_WT_ht+0xcd68, %rsi
nop
nop
xor %rbx, %rbx
mov (%rsi), %cx
inc %rdi
lea addresses_normal_ht+0x3318, %rsi
lea addresses_WC_ht+0xbd06, %rdi
clflush (%rsi)
nop
cmp $13291, %rbx
mov $90, %rcx
rep movsq
cmp $49157, %rcx
lea addresses_WT_ht+0xbe5c, %r14
and %rcx, %rcx
movb (%r14), %r10b
nop
nop
nop
sub %rdi, %rdi
lea addresses_WT_ht+0x13a68, %rdi
nop
nop
nop
nop
...
nop
add %rdi, %rdi
lea addresses_A_ht+0xc488, %rsi
lea addresses_D_ht+0x19268, %rdi
nop
nop
nop
nop
...
nop
inc %rbx
lea addresses_UC_ht+0x14268, %rsi
lea addresses_normal_ht+0x1edb0, %rdi
nop
nop
sub $56247, %r10
mov $104, %rcx
...
{'src': {'congruent': 8, 'AVXalign': False, 'same': True, 'size': 2, 'NT': False, 'type': 'addresses_WT_ht'}, 'OP': 'LOAD'}
