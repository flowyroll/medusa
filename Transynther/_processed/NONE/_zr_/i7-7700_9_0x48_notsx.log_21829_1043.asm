...
nop
xor $5443, %rsi
lea addresses_UC_ht+0xfa32, %rsi
lea addresses_A_ht+0x15432, %rdi
nop
and %r15, %r15
mov $33, %rcx
rep movsl
...
nop
xor $43604, %rdi
lea addresses_WT_ht+0x126aa, %r14
nop
nop
nop
and $2733, %rbp
...
// Store
lea addresses_normal+0xf1fa, %r9
clflush (%r9)
nop
nop
add $20066, %rsi
...
// Store
lea addresses_normal+0xb232, %rsi
cmp %rbp, %rbp
...
// Faulty Load
lea addresses_normal+0xb232, %r13
nop
nop
nop
nop
...
{'OP': 'LOAD', 'src': {'same': False, 'NT': False, 'AVXalign': False, 'size': 32, 'type': 'addresses_P', 'congruent': 5}}
...
<gen_prepare_buffer>
{'dst': {'same': False, 'congruent': 10, 'type': 'addresses_WC_ht'}, 'OP': 'REPM', 'src': {'same': False, 'congruent': 9, 'type': 'addresses_WC_ht'}}
{'dst': {'same': False, 'NT': False, 'AVXalign': False, 'size': 4, 'type': 'addresses_WC_ht', 'congruent': 2}, 'OP': 'STOR'}
{'dst': {'same': False, 'congruent': 7, 'type': 'addresses_A_ht'}, 'OP': 'REPM', 'src': {'same': False, 'congruent': 11, 'type': 'addresses_UC_ht'}}
