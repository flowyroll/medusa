...
push %rdi
push %rsi
lea addresses_D_ht+0x13386, %rax
nop
nop
nop
nop
...
nop
add %r9, %r9
lea addresses_normal_ht+0xe0c3, %r8
nop
nop
and %r14, %r14
movw $0x6162, (%r8)
...
nop
add %r8, %r8
lea addresses_A_ht+0x1b893, %rsi
lea addresses_A_ht+0x1e803, %rdi
sub $24073, %rax
mov $52, %rcx
rep movsb
sub %rax, %rax
lea addresses_D_ht+0x1aa3, %rsi
lea addresses_UC_ht+0x9083, %rdi
nop
nop
nop
nop
...
nop
and $36239, %r14
lea addresses_UC_ht+0x1c863, %rsi
...
nop
mfence
lea addresses_WC_ht+0x1ae23, %rdi
nop
nop
and $61541, %r9
...
movq %r14, (%rdi)
and %rsi, %rsi
lea addresses_normal_ht+0x1ee77, %rsi
nop
nop
nop
nop
...
nop
and $24697, %r8
lea addresses_WT_ht+0x1a223, %rsi
lea addresses_WC_ht+0x19423, %rdi
inc %r9
mov $121, %rcx
rep movsq
nop
...
nop
xor %rsi, %rsi
lea addresses_WC_ht+0x3ecf, %rsi
lea addresses_WT_ht+0xe8d3, %rdi
nop
nop
nop
nop
...
nop
add %rcx, %rcx
lea addresses_normal_ht+0x223, %rsi
lea addresses_WC_ht+0x16223, %rdi
nop
nop
nop
nop
...
{'OP': 'REPM', 'src': {'type': 'addresses_WT_ht', 'congruent': 10, 'same': False}, 'dst': {'type': 'addresses_WC_ht', 'congruent': 9, 'same': False}}
