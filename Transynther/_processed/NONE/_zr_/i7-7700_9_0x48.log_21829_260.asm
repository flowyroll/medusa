...
push %rdi
push %rsi
lea addresses_normal_ht+0x1c4f0, %r8
nop
and %r10, %r10
mov (%r8), %r14
nop
...
nop
dec %rsi
lea addresses_A_ht+0x2d50, %rsi
lea addresses_UC_ht+0x1b950, %rdi
nop
nop
nop
add $6378, %r9
...
nop
and $47794, %r8
lea addresses_UC_ht+0xb8d0, %rsi
lea addresses_UC_ht+0xa3d0, %rdi
nop
nop
nop
nop
