...
push %rdi
push %rsi
lea addresses_WC_ht+0xe14a, %rdi
clflush (%rdi)
nop
nop
nop
...
nop
xor $53276, %r12
lea addresses_UC_ht+0xbc12, %rsi
lea addresses_WC_ht+0x15b0, %rdi
nop
nop
nop
nop
...
nop
add %rsi, %rsi
lea addresses_normal_ht+0xb04a, %rsi
