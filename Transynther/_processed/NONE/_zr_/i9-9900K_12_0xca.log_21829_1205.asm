...
lea addresses_UC_ht+0x162a5, %rdi
cmp %r8, %r8
mov $66, %rcx
rep movsq
nop
...
nop
inc %rcx
lea addresses_UC_ht+0x2915, %rbx
clflush (%rbx)
nop
add $31555, %r11
movups (%rbx), %xmm0
...
nop
inc %rsi
lea addresses_WC_ht+0x15be5, %rbx
nop
nop
cmp %r13, %r13
movb (%rbx), %r8b
...
nop
add %rsi, %rsi
lea addresses_WC_ht+0x118ff, %rsi
lea addresses_WC_ht+0xce45, %rdi
add $63281, %r9
mov $50, %rcx
rep movsb
inc %rcx
lea addresses_A_ht+0xabe5, %r8
nop
nop
nop
nop
...
nop
add $54214, %rdi
lea addresses_A_ht+0x4fe5, %rsi
lea addresses_UC_ht+0xaabd, %rdi
nop
add %r13, %r13
mov $95, %rcx
rep movsb
...
{'OP': 'REPM', 'src': {'same': False, 'type': 'addresses_WT_ht', 'congruent': 4}, 'dst': {'same': False, 'type': 'addresses_UC_ht', 'congruent': 6}}
...
{'OP': 'REPM', 'src': {'same': True, 'type': 'addresses_WC_ht', 'congruent': 0}, 'dst': {'same': False, 'type': 'addresses_WC_ht', 'congruent': 4}}
