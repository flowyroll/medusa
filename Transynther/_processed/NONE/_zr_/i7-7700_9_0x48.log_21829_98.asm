...
nop
cmp %rdx, %rdx
lea addresses_WT_ht+0x7610, %rsi
lea addresses_A_ht+0x1af10, %rdi
dec %r15
mov $64, %rcx
rep movsb
nop
...
nop
sub $27150, %rdi
lea addresses_D_ht+0xdd00, %rsi
lea addresses_WC_ht+0x6e16, %rdi
nop
nop
nop
nop
...
nop
and %r12, %r12
lea addresses_UC_ht+0x1efa0, %r12
nop
xor $7420, %r13
movl $0x61626364, (%r12)
nop
dec %r15
lea addresses_UC_ht+0xf010, %r8
nop
nop
nop
nop
...
nop
xor $47397, %r13
lea addresses_UC_ht+0x1abf8, %r13
clflush (%r13)
add %rcx, %rcx
vmovups (%r13), %ymm6
...
nop
dec %r15
lea addresses_normal_ht+0xa810, %rcx
nop
nop
and %r13, %r13
mov (%rcx), %r8d
...
{'OP': 'REPM', 'src': {'type': 'addresses_D_ht', 'congruent': 4, 'same': True}, 'dst': {'type': 'addresses_WC_ht', 'congruent': 1, 'same': True}}
