...
nop
dec %rsi
lea addresses_normal_ht+0x4992, %r9
nop
nop
nop
inc %rdx
...
nop
sub %rdx, %rdx
lea addresses_UC_ht+0x19772, %r8
cmp $24147, %rsi
...
nop
sub $9373, %rsi
lea addresses_D_ht+0x15192, %r10
nop
nop
nop
xor $51917, %rsi
...
{'OP': 'LOAD', 'src': {'size': 1, 'NT': False, 'type': 'addresses_A', 'same': False, 'AVXalign': True, 'congruent': 5}}
[Faulty Load]
...
{'OP': 'LOAD', 'src': {'size': 1, 'NT': False, 'type': 'addresses_normal_ht', 'same': False, 'AVXalign': True, 'congruent': 9}}
