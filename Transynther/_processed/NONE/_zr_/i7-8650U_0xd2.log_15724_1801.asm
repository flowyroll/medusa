...
movb (%r11), %r14b
sub $40646, %r8
lea addresses_WC_ht+0xaf5c, %rsi
lea addresses_D_ht+0x66de, %rdi
clflush (%rsi)
nop
nop
dec %r9
...
rep movsb
and $53360, %r9
lea addresses_UC_ht+0x11899, %rsi
dec %r8
movl $0x61626364, (%rsi)
nop
nop
...
nop
and $9978, %rcx
lea addresses_WT_ht+0x17066, %rsi
nop
nop
cmp %r14, %r14
mov (%rsi), %r11d
