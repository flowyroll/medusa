...
push %rdx
push %rsi
lea addresses_UC_ht+0x32ad, %r11
nop
inc %r14
movb $0x61, (%r11)
nop
dec %rbp
lea addresses_D_ht+0x197ad, %r13
nop
nop
cmp %rdx, %rdx
...
lea addresses_WT_ht+0x1eaad, %rdi
nop
nop
nop
sub %r14, %r14
...
nop
and %rdx, %rdx
lea addresses_WC_ht+0x34ad, %r11
clflush (%r11)
nop
cmp %r14, %r14
...
nop
and %rdi, %rdi
lea addresses_normal_ht+0x1c4f1, %r14
cmp %r12, %r12
movl $0x61626364, (%r14)
nop
nop
nop
add %rdx, %rdx
lea addresses_D_ht+0x1aeed, %r11
nop
nop
nop
nop
...
nop
cmp $33004, %rbx
lea addresses_WC_ht+0x392d, %rbp
nop
nop
sub $40406, %r13
mov (%rbp), %r12w
sub $14957, %r12
lea addresses_WC_ht+0x1d6ad, %rbp
nop
xor %r11, %r11
vmovups (%rbp), %ymm5
...
nop
dec %rbx
lea addresses_WC_ht+0x15aad, %rdi
nop
nop
and $4161, %r12
mov (%rdi), %dx
...
nop
dec %rsi
lea addresses_D_ht+0x1426d, %rsi
...
nop
and $33732, %rsi
lea addresses_WC_ht+0x19681, %r14
sub %r12, %r12
movb $0x61, (%r14)
nop
sub $15952, %r14
...
{'OP': 'REPM', 'src': {'same': False, 'type': 'addresses_normal_ht', 'congruent': 4}, 'dst': {'same': False, 'type': 'addresses_WT_ht', 'congruent': 9}}
...
{'OP': 'LOAD', 'src': {'size': 2, 'NT': False, 'type': 'addresses_WC_ht', 'same': False, 'AVXalign': True, 'congruent': 10}}
{'OP': 'LOAD', 'src': {'size': 4, 'NT': False, 'type': 'addresses_normal_ht', 'same': False, 'AVXalign': False, 'congruent': 8}}
{'OP': 'REPM', 'src': {'same': False, 'type': 'addresses_D_ht', 'congruent': 6}, 'dst': {'same': False, 'type': 'addresses_A_ht', 'congruent': 1}}
