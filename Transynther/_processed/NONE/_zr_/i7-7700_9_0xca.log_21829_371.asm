...
push %rdi
push %rsi
lea addresses_D_ht+0x170a5, %rsi
lea addresses_WT_ht+0x64a5, %rdi
nop
nop
and %r13, %r13
mov $49, %rcx
rep movsl
dec %r14
lea addresses_WT_ht+0x17b7f, %rsi
lea addresses_D_ht+0x19536, %rdi
nop
nop
nop
nop
...
rep movsl
and %r13, %r13
lea addresses_D_ht+0x118a5, %rax
nop
nop
nop
inc %rbp
...
nop
sub %r13, %r13
lea addresses_WT_ht+0x4ca5, %rsi
lea addresses_normal_ht+0x44a5, %rdi
sub %rax, %rax
mov $100, %rcx
rep movsb
nop
...
nop
add $51595, %r13
lea addresses_UC_ht+0x4075, %rbp
add %rcx, %rcx
mov $0x6162636465666768, %r13
movq %r13, %xmm2
movups %xmm2, (%rbp)
and %rax, %rax
lea addresses_D_ht+0x12e0d, %rsi
lea addresses_normal_ht+0x3b25, %rdi
clflush (%rdi)
nop
nop
nop
...
// Load
lea addresses_normal+0xe1a5, %r13
nop
nop
nop
sub $64905, %r11
...
// Store
lea addresses_normal+0x58a5, %rcx
nop
add %r9, %r9
...
{'src': {'congruent': 5, 'AVXalign': False, 'same': False, 'size': 2, 'NT': False, 'type': 'addresses_normal'}, 'OP': 'LOAD'}
...
{'src': {'congruent': 3, 'same': False, 'type': 'addresses_D_ht'}, 'OP': 'REPM', 'dst': {'congruent': 6, 'same': True, 'type': 'addresses_normal_ht'}}
{'00': 21829}
