...
push %rdi
push %rsi
lea addresses_WC_ht+0x1e086, %rsi
lea addresses_UC_ht+0x16946, %rdi
clflush (%rsi)
nop
nop
add $7014, %rbp
...
nop
xor $56456, %r9
lea addresses_normal_ht+0x6c6, %r10
nop
nop
nop
nop
...
nop
sub %rsi, %rsi
lea addresses_normal_ht+0x14e6, %rsi
lea addresses_A_ht+0x57a6, %rdi
nop
nop
and $10019, %r15
mov $54, %rcx
...
nop
and $37071, %r9
lea addresses_WT_ht+0xe8c6, %rcx
nop
nop
nop
nop
...
mov (%r15), %r10d
cmp %rcx, %rcx
lea addresses_A_ht+0x10134, %rdi
nop
add $4009, %r13
mov $0x6162636465666768, %r15
movq %r15, %xmm1
...
nop
sub $48552, %r15
lea addresses_A_ht+0x1b3ae, %rsi
lea addresses_normal_ht+0x108c6, %rdi
nop
and %r10, %r10
mov $82, %rcx
rep movsw
...
{'OP': 'LOAD', 'src': {'type': 'addresses_NC', 'AVXalign': False, 'congruent': 9, 'size': 16, 'same': False, 'NT': True}}
[Faulty Load]
