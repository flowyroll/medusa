...
push %rdi
push %rsi
lea addresses_WC_ht+0x10700, %rsi
...
nop
and %rdi, %rdi
lea addresses_A_ht+0x1e500, %rsi
lea addresses_normal_ht+0xc768, %rdi
and %r10, %r10
mov $66, %rcx
rep movsl
nop
...
nop
inc %r12
lea addresses_UC_ht+0xc300, %rsi
lea addresses_normal_ht+0x1da80, %rdi
nop
nop
nop
nop
...
nop
xor $41852, %rsi
lea addresses_WC_ht+0x11500, %r12
nop
nop
nop
nop
...
// Load
lea addresses_A+0xa780, %rax
inc %rcx
mov (%rax), %ebp
cmp $917, %r14

// Store
lea addresses_A+0x16760, %rax
nop
nop
nop
nop
...
{'src': {'type': 'addresses_A_ht', 'congruent': 8, 'same': False}, 'dst': {'type': 'addresses_normal_ht', 'congruent': 2, 'same': True}, 'OP': 'REPM'}
