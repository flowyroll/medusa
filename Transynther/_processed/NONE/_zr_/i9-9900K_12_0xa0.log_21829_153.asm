...
nop
xor %rsi, %rsi
lea addresses_WC_ht+0x11c8b, %rsi
nop
nop
nop
nop
...
nop
add $27143, %rdi
lea addresses_UC_ht+0x1d68b, %r12
nop
nop
xor $44271, %rdi
movw $0x6162, (%r12)
...
nop
inc %rsi
lea addresses_WC_ht+0xfaab, %rdx
nop
nop
add %rdi, %rdi
vmovups (%rdx), %ymm3
...
nop
cmp $7969, %rdx
lea addresses_WC_ht+0x1ca8b, %rsi
lea addresses_WT_ht+0x488b, %rdi
nop
nop
nop
nop
...
nop
xor %r12, %r12
lea addresses_UC_ht+0x7933, %r14
nop
sub $25869, %rdi
mov $0x6162636465666768, %rbp
movq %rbp, %xmm2
...
nop
inc %r14
lea addresses_A_ht+0x123fb, %r12
nop
nop
nop
inc %rsi
...
{'src': {'same': False, 'congruent': 9, 'type': 'addresses_WC_ht'}, 'OP': 'REPM', 'dst': {'same': True, 'congruent': 9, 'type': 'addresses_WT_ht'}}
{'OP': 'STOR', 'dst': {'NT': True, 'same': False, 'congruent': 2, 'type': 'addresses_UC_ht', 'AVXalign': True, 'size': 16}}
{'src': {'NT': False, 'same': True, 'congruent': 3, 'type': 'addresses_A_ht', 'AVXalign': False, 'size': 2}, 'OP': 'LOAD'}
