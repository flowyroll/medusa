...
nop
add $45701, %rdx
lea addresses_D_ht+0x2a3, %rsi
lea addresses_WC_ht+0x3673, %rdi
clflush (%rsi)
nop
nop
nop
...
nop
xor %r12, %r12
lea addresses_WT_ht+0x1e923, %rdi
nop
nop
nop
nop
...
nop
xor $32853, %rcx
lea addresses_UC_ht+0x1b7a3, %r9
nop
nop
nop
nop
...
nop
xor %rbp, %rbp
lea addresses_normal_ht+0xb9a3, %rsi
lea addresses_normal_ht+0xf477, %rdi
nop
nop
add $41457, %r11
mov $89, %rcx
...
nop
sub $35004, %rsi
lea addresses_UC_ht+0x124a3, %r9
nop
nop
nop
nop
...
nop
and $22065, %r12
lea addresses_A_ht+0x1cfa3, %rbp
nop
nop
xor $41940, %rdi
mov (%rbp), %r11d
add $53194, %rcx
lea addresses_WC_ht+0x1ac43, %rsi
lea addresses_D_ht+0x27ad, %rdi
clflush (%rsi)
nop
nop
nop
...
nop
cmp $43815, %rdx
lea addresses_UC_ht+0x174a3, %rsi
lea addresses_UC_ht+0x16cbb, %rdi
nop
nop
nop
nop
...
{'OP': 'LOAD', 'src': {'type': 'addresses_US', 'AVXalign': False, 'congruent': 8, 'size': 4, 'same': False, 'NT': False}}
[Faulty Load]
...
{'OP': 'REPM', 'src': {'type': 'addresses_D_ht', 'congruent': 7, 'same': False}, 'dst': {'type': 'addresses_WC_ht', 'congruent': 4, 'same': True}}
...
{'OP': 'REPM', 'src': {'type': 'addresses_normal_ht', 'congruent': 9, 'same': False}, 'dst': {'type': 'addresses_normal_ht', 'congruent': 0, 'same': True}}
