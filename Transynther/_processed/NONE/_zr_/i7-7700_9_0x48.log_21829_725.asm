...
nop
xor $50627, %rbp
lea addresses_WC_ht+0x19e95, %rsi
nop
inc %r14
movb $0x61, (%rsi)
nop
...
nop
add $20060, %rdx
lea addresses_WT_ht+0x6d2d, %rsi
lea addresses_WT_ht+0x1b383, %rdi
clflush (%rdi)
nop
nop
add %rbp, %rbp
...
nop
cmp %rcx, %rcx
lea addresses_D_ht+0xb495, %rcx
add $5979, %r8
movw $0x6162, (%rcx)
sub %rbp, %rbp
lea addresses_normal_ht+0x15261, %rdi
nop
sub $2567, %r14
...
nop
xor $27832, %rbp
lea addresses_A_ht+0x7035, %rsi
lea addresses_WC_ht+0xb88e, %rdi
cmp $57630, %r10
mov $127, %rcx
rep movsq
nop
nop
sub $37834, %rsi
lea addresses_WC_ht+0x10a32, %rsi
nop
nop
and %rdx, %rdx
mov (%rsi), %rdi
...
nop
cmp $22036, %rcx
lea addresses_WT_ht+0x16015, %rdi
nop
nop
sub %r14, %r14
vmovups (%rdi), %ymm2
...
nop
and $54316, %r8
lea addresses_A_ht+0x14295, %rsi
nop
nop
nop
sub $35014, %r8
...
// Store
lea addresses_normal+0xbd5d, %r13
nop
nop
cmp $16760, %r10
movl $0x51525354, (%r13)
...
{'OP': 'LOAD', 'src': {'type': 'addresses_normal_ht', 'AVXalign': False, 'congruent': 1, 'size': 16, 'same': True, 'NT': True}}
