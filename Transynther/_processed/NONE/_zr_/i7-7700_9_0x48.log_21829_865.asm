...
push %rbx
push %rdi
lea addresses_A_ht+0x105ce, %r11
nop
nop
nop
nop
...
nop
cmp $23718, %r14
lea addresses_normal_ht+0x1e78e, %rbx
xor %r12, %r12
movups (%rbx), %xmm2
vpextrq $1, %xmm2, %rbp
nop
...
nop
cmp %r10, %r10
lea addresses_UC_ht+0x1dbbe, %r12
sub $33254, %r14
movw $0x6162, (%r12)
xor %r10, %r10
pop %rdi
...
{'OP': 'REPM', 'src': {'type': 'addresses_P', 'congruent': 1, 'same': False}, 'dst': {'type': 'addresses_WT', 'congruent': 5, 'same': False}}
