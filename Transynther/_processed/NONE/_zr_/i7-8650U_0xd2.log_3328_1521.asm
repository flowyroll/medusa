...
push %rdx
push %rsi
lea addresses_UC_ht+0x1b54d, %rsi
lea addresses_UC_ht+0x8acd, %rdi
nop
nop
nop
add $53590, %r14
...
nop
add $20592, %rdx
lea addresses_A_ht+0xd98d, %rsi
lea addresses_D_ht+0x1004d, %rdi
nop
nop
nop
nop
...
{'OP': 'STOR', 'dst': {'type': 'addresses_WC', 'size': 16, 'AVXalign': False, 'NT': True, 'congruent': 0, 'same': False}}
