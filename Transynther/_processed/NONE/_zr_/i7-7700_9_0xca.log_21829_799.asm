...
push %r9
push %rsi
lea addresses_normal_ht+0x18c18, %r11
clflush (%r11)
nop
nop
cmp $33515, %r10
...
nop
inc %r10
lea addresses_WT_ht+0x1ef76, %r12
inc %rsi
...
nop
add %r12, %r12
lea addresses_UC_ht+0x3d18, %r14
nop
nop
nop
and %r9, %r9
...
// Load
lea addresses_normal+0x3318, %rax
nop
nop
nop
nop
...
{'src': {'congruent': 2, 'AVXalign': True, 'same': False, 'size': 1, 'NT': False, 'type': 'addresses_P'}, 'OP': 'LOAD'}
{'src': {'congruent': 11, 'AVXalign': False, 'same': False, 'size': 8, 'NT': False, 'type': 'addresses_A'}, 'OP': 'LOAD'}
{'OP': 'STOR', 'dst': {'congruent': 6, 'AVXalign': True, 'same': False, 'size': 1, 'NT': False, 'type': 'addresses_PSE'}}
