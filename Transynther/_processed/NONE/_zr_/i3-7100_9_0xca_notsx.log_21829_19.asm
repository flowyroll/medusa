...
push %rdi
push %rsi
lea addresses_normal_ht+0x4ff5, %rsi
lea addresses_WC_ht+0x28fd, %rdi
nop
nop
nop
nop
...
nop
dec %r14
lea addresses_D_ht+0x183dd, %r11
clflush (%r11)
nop
nop
cmp %rdi, %rdi
...
nop
xor $40846, %rcx
lea addresses_D_ht+0x11bdd, %rsi
lea addresses_WT_ht+0x6bdd, %rdi
clflush (%rsi)
sub %r8, %r8
mov $111, %rcx
rep movsl
...
nop
dec %r14
lea addresses_normal_ht+0xeedd, %rsi
lea addresses_WC_ht+0xabdd, %rdi
clflush (%rsi)
dec %r10
mov $84, %rcx
rep movsq
...
nop
sub %r8, %r8
lea addresses_UC_ht+0xc5b1, %rsi
lea addresses_WC_ht+0xa3dd, %rdi
clflush (%rdi)
nop
sub %r8, %r8
mov $110, %rcx
...
nop
add %r10, %r10
lea addresses_WC_ht+0x1e7dd, %rcx
nop
nop
nop
nop
...
nop
xor $40570, %rsi
lea addresses_WC_ht+0x1fdd, %r11
nop
nop
and %r10, %r10
mov (%r11), %ecx
...
<gen_prepare_buffer>
{'src': {'type': 'addresses_normal_ht', 'congruent': 3, 'same': False}, 'OP': 'REPM', 'dst': {'type': 'addresses_WC_ht', 'congruent': 5, 'same': True}}
{'OP': 'STOR', 'dst': {'same': False, 'congruent': 11, 'NT': False, 'type': 'addresses_D_ht', 'size': 32, 'AVXalign': False}}
{'src': {'type': 'addresses_D_ht', 'congruent': 11, 'same': False}, 'OP': 'REPM', 'dst': {'type': 'addresses_WT_ht', 'congruent': 9, 'same': True}}
