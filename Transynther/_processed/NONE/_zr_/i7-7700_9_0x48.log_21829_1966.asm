...
lea addresses_WT_ht+0x17dd5, %rdi
nop
sub %r13, %r13
mov $79, %rcx
rep movsq
...
nop
xor %r13, %r13
lea addresses_WC_ht+0x15c99, %rsi
lea addresses_WC_ht+0x125c9, %rdi
nop
nop
cmp %rbx, %rbx
mov $20, %rcx
rep movsb
xor %rbx, %rbx
lea addresses_D_ht+0x1a519, %rdx
nop
nop
xor %rbx, %rbx
movl $0x61626364, (%rdx)
...
lea addresses_A_ht+0x11d59, %rdi
clflush (%rdi)
nop
nop
nop
...
nop
sub %r13, %r13
lea addresses_normal_ht+0xaa99, %rcx
nop
nop
cmp $24391, %r8
movb (%rcx), %dl
...
nop
xor %rsi, %rsi
lea addresses_UC_ht+0x12899, %rcx
clflush (%rcx)
cmp %rsi, %rsi
...
nop
add %rdx, %rdx
lea addresses_D_ht+0x14681, %rsi
lea addresses_normal_ht+0x819, %rdi
nop
nop
nop
nop
...
rep movsb
dec %r9
lea addresses_UC_ht+0x16899, %rsi
...
nop
dec %rsi
lea addresses_normal_ht+0x2a9, %rcx
nop
nop
sub $44265, %r9
vmovups (%rcx), %ymm5
...
{'OP': 'STOR', 'dst': {'type': 'addresses_UC_ht', 'AVXalign': False, 'congruent': 1, 'size': 8, 'same': True, 'NT': True}}
