...
push %rdx
push %rsi
lea addresses_D_ht+0x32d8, %rsi
lea addresses_normal_ht+0x141d0, %rdi
nop
nop
nop
cmp %rdx, %rdx
...
nop
add $42892, %r8
lea addresses_UC_ht+0x7a30, %r11
dec %rbp
...
nop
cmp %r8, %r8
lea addresses_D_ht+0x19230, %rcx
nop
nop
nop
nop
...
nop
sub %rbp, %rbp
lea addresses_A_ht+0x11f30, %rsi
