...
push %rdi
push %rsi
lea addresses_UC_ht+0x1d5d0, %rcx
and %r10, %r10
...
nop
and $8723, %r10
lea addresses_WT_ht+0x4bd0, %rsi
lea addresses_A_ht+0xdbd0, %rdi
clflush (%rsi)
nop
nop
add %r12, %r12
...
nop
add $2185, %r11
lea addresses_WT_ht+0xd1d0, %rsi
...
lea addresses_WT_ht+0x1aad0, %rdi
and %r12, %r12
mov $81, %rcx
rep movsl
nop
...
// Store
lea addresses_normal+0x4004, %r8
dec %rdx
...
{'OP': 'STOR', 'dst': {'congruent': 0, 'AVXalign': True, 'same': False, 'size': 2, 'NT': True, 'type': 'addresses_NC'}}
[Faulty Load]
...
{'src': {'congruent': 9, 'same': False, 'type': 'addresses_WT_ht'}, 'OP': 'REPM', 'dst': {'congruent': 2, 'same': False, 'type': 'addresses_A_ht'}}
