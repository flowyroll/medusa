...
push %rdx
push %rsi
lea addresses_UC_ht+0x1ed65, %r9
nop
nop
nop
nop
...
mov (%r9), %r11w
and $1658, %rdi
lea addresses_WC_ht+0x177ac, %rdx
nop
nop
nop
nop
...
nop
mfence
lea addresses_UC_ht+0xa1ac, %rsi
lea addresses_normal_ht+0x1bdac, %rdi
nop
xor %rbx, %rbx
mov $109, %rcx
rep movsq
xor $37243, %rdi
lea addresses_WC_ht+0x1c20, %rsi
lea addresses_normal_ht+0x47b6, %rdi
nop
sub %rax, %rax
mov $119, %rcx
rep movsb
...
nop
add $20104, %r9
lea addresses_UC_ht+0x12dac, %rsi
lea addresses_WC_ht+0x1cce0, %rdi
nop
nop
nop
xor %rdx, %rdx
...
{'OP': 'STOR', 'dst': {'NT': False, 'same': False, 'congruent': 7, 'type': 'addresses_A', 'AVXalign': True, 'size': 16}}
...
{'src': {'same': False, 'congruent': 2, 'type': 'addresses_WC_ht'}, 'OP': 'REPM', 'dst': {'same': False, 'congruent': 1, 'type': 'addresses_normal_ht'}}
