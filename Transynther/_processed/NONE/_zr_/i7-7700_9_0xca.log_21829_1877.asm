...
push %rdi
push %rsi
lea addresses_WC_ht+0x144ea, %rbx
clflush (%rbx)
and %r11, %r11
mov (%rbx), %r15w
xor $23382, %rax
lea addresses_WC_ht+0x19e9d, %rax
nop
nop
nop
nop
...
nop
and %rbx, %rbx
lea addresses_UC_ht+0x151ea, %rsi
...
movq %rdi, (%rbx)
add $59234, %r11
lea addresses_A_ht+0x13080, %rsi
nop
nop
nop
nop
...
mov (%rsi), %di
xor $1809, %r15
lea addresses_normal_ht+0x11e6a, %rcx
nop
nop
nop
nop
...
nop
and %rbp, %rbp
lea addresses_D_ht+0x9512, %rsi
lea addresses_D_ht+0x159ea, %rdi
nop
cmp %rbp, %rbp
mov $22, %rcx
rep movsl
...
nop
sub $53997, %r11
lea addresses_UC_ht+0x443a, %rsi
lea addresses_WC_ht+0x9aea, %rdi
nop
cmp %rbp, %rbp
mov $120, %rcx
rep movsw
...
nop
inc %rdi
lea addresses_D_ht+0x1ea, %rsi
lea addresses_WT_ht+0x3ea, %rdi
nop
nop
nop
nop
...
lea addresses_WT_ht+0x8bea, %rdi
cmp $5138, %r11
mov $117, %rcx
rep movsw
nop
...
{'src': {'congruent': 3, 'same': False, 'type': 'addresses_D_ht'}, 'OP': 'REPM', 'dst': {'congruent': 11, 'same': False, 'type': 'addresses_D_ht'}}
...
{'src': {'congruent': 11, 'same': True, 'type': 'addresses_WC_ht'}, 'OP': 'REPM', 'dst': {'congruent': 9, 'same': False, 'type': 'addresses_WT_ht'}}
{'00': 21829}
