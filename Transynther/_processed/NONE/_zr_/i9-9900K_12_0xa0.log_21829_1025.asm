...
nop
cmp %r10, %r10
lea addresses_normal_ht+0xb543, %rsi
lea addresses_D_ht+0x10283, %rdi
nop
nop
nop
nop
...
lea addresses_normal_ht+0x1e973, %rdi
nop
nop
nop
and %r13, %r13
...
nop
xor $14434, %rsi
lea addresses_A_ht+0x8533, %rsi
nop
and %rcx, %rcx
movb $0x61, (%rsi)
nop
and $17758, %rsi
lea addresses_A_ht+0x1cd33, %rsi
lea addresses_WT_ht+0x1d33, %rdi
nop
nop
nop
nop
...
lea addresses_UC_ht+0x15c33, %rdi
nop
nop
nop
sub $28497, %r15
...
nop
and %r10, %r10
lea addresses_UC_ht+0x5b97, %rsi
lea addresses_WC_ht+0x7d33, %rdi
nop
nop
nop
nop
...
movw $0x6162, (%rdi)
and %r13, %r13
lea addresses_WC_ht+0x18bf3, %r10
nop
dec %r15
mov (%r10), %rdi
nop
...
<gen_prepare_buffer>
{'src': {'same': False, 'congruent': 10, 'type': 'addresses_WT_ht'}, 'OP': 'REPM', 'dst': {'same': False, 'congruent': 10, 'type': 'addresses_WC_ht'}}
{'src': {'same': True, 'congruent': 4, 'type': 'addresses_normal_ht'}, 'OP': 'REPM', 'dst': {'same': False, 'congruent': 3, 'type': 'addresses_D_ht'}}
...
{'src': {'same': True, 'congruent': 2, 'type': 'addresses_A_ht'}, 'OP': 'REPM', 'dst': {'same': False, 'congruent': 8, 'type': 'addresses_UC_ht'}}
{'src': {'same': False, 'congruent': 0, 'type': 'addresses_UC_ht'}, 'OP': 'REPM', 'dst': {'same': True, 'congruent': 9, 'type': 'addresses_WC_ht'}}
