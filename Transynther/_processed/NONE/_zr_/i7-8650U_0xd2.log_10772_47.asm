...
push %rdx
push %rsi
lea addresses_WC_ht+0x5c3d, %rax
nop
nop
nop
nop
...
nop
sub $11561, %rbx
lea addresses_D_ht+0x1915b, %rsi
nop
cmp $3670, %r14
movl $0x61626364, (%rsi)
nop
...
nop
sub %r14, %r14
lea addresses_UC_ht+0x12f43, %r15
nop
nop
xor %rbx, %rbx
mov (%r15), %rsi
...
nop
cmp $12797, %r14
lea addresses_D_ht+0x13113, %rsi
nop
nop
nop
and $48789, %r12
...
nop
xor %rdx, %rdx
lea addresses_WC_ht+0x1843b, %rsi
lea addresses_normal_ht+0x4fab, %rdi
nop
nop
nop
sub %rbx, %rbx
...
nop
sub %r12, %r12
lea addresses_D_ht+0x19f1b, %rdi
nop
nop
nop
nop
...
<gen_prepare_buffer>
{'OP': 'STOR', 'dst': {'type': 'addresses_WC_ht', 'size': 16, 'AVXalign': True, 'NT': False, 'congruent': 1, 'same': False}}
