...
push %rdi
push %rsi
lea addresses_WC_ht+0x68b2, %rsi
lea addresses_WC_ht+0x1d3f2, %rdi
nop
inc %rax
mov $7, %rcx
rep movsq
...
// Load
lea addresses_normal+0x1f0b2, %r14
nop
nop
nop
nop
...
{'OP': 'LOAD', 'src': {'type': 'addresses_normal', 'size': 8, 'AVXalign': False, 'NT': False, 'congruent': 9, 'same': False}}
