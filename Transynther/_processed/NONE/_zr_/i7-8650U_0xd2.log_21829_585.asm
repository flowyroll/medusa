...
nop
cmp %rbx, %rbx
lea addresses_A_ht+0x1adfa, %r10
clflush (%r10)
nop
nop
add $35608, %rbx
...
nop
xor %r12, %r12
lea addresses_normal_ht+0xc0ca, %rsi
...
nop
sub $9133, %rbx
lea addresses_WT_ht+0x25ca, %r10
nop
nop
nop
xor %rdi, %rdi
...
nop
dec %r11
lea addresses_UC_ht+0x1a3ca, %rsi
lea addresses_WT_ht+0xb4ca, %rdi
sub $33574, %rbx
mov $41, %rcx
rep movsw
nop
nop
inc %rdi
lea addresses_D_ht+0x18522, %r11
xor %rbx, %rbx
movb (%r11), %cl
and $44414, %rdi
lea addresses_UC_ht+0x1c1a, %rcx
nop
add %r13, %r13
mov (%rcx), %r10
add %r11, %r11
lea addresses_A_ht+0x1474a, %r11
nop
nop
nop
and $36696, %rbx
...
{'OP': 'REPM', 'src': {'type': 'addresses_UC_ht', 'congruent': 7, 'same': False}, 'dst': {'type': 'addresses_WT_ht', 'congruent': 10, 'same': False}}
