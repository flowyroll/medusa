...
push %rdx
push %rsi
lea addresses_normal_ht+0xf759, %r8
clflush (%r8)
xor %r14, %r14
vmovups (%r8), %ymm5
...
nop
sub %r13, %r13
lea addresses_A_ht+0x18e59, %r14
nop
nop
nop
nop
...
nop
sub $31277, %r13
lea addresses_WT_ht+0x4599, %rdx
cmp %r13, %r13
...
nop
cmp $4404, %rbx
lea addresses_WC_ht+0x104b9, %r14
nop
and $45812, %rdx
...
nop
sub $50748, %r12
lea addresses_A_ht+0x14977, %r14
cmp %rbx, %rbx
mov (%r14), %rdx
sub %r14, %r14
lea addresses_A_ht+0x19a59, %rdx
clflush (%rdx)
nop
nop
nop
...
nop
and %rsi, %rsi
lea addresses_WT_ht+0xdc2d, %rsi
lea addresses_WT_ht+0x1b7e9, %rdi
nop
dec %r8
mov $27, %rcx
rep movsl
...
nop
xor $32853, %r13
lea addresses_WT_ht+0x1c59, %rcx
nop
nop
nop
nop
...
nop
cmp $49262, %rdi
lea addresses_A_ht+0x1d919, %r12
nop
nop
nop
nop
...
nop
sub $45066, %r13
lea addresses_WT_ht+0x8b59, %rsi
lea addresses_WT_ht+0x16719, %rdi
nop
nop
nop
nop
...
nop
and $42575, %r14
lea addresses_UC_ht+0xb3d9, %r12
nop
nop
nop
nop
...
<gen_prepare_buffer>
{'OP': 'LOAD', 'src': {'size': 32, 'NT': False, 'type': 'addresses_normal_ht', 'same': True, 'AVXalign': False, 'congruent': 8}}
...
{'OP': 'STOR', 'dst': {'size': 2, 'NT': False, 'type': 'addresses_A_ht', 'same': False, 'AVXalign': True, 'congruent': 11}}
...
{'OP': 'REPM', 'src': {'same': False, 'type': 'addresses_WT_ht', 'congruent': 2}, 'dst': {'same': False, 'type': 'addresses_WT_ht', 'congruent': 4}}
{'OP': 'STOR', 'dst': {'size': 16, 'NT': False, 'type': 'addresses_WT_ht', 'same': True, 'AVXalign': False, 'congruent': 9}}
