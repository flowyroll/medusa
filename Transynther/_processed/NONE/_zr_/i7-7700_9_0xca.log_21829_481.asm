...
nop
dec %rbp
lea addresses_normal_ht+0x18165, %r15
nop
nop
nop
nop
...
nop
add $34413, %r15
lea addresses_WC_ht+0x67b5, %r11
nop
nop
nop
nop
...
{'OP': 'STOR', 'dst': {'congruent': 4, 'AVXalign': True, 'same': False, 'size': 32, 'NT': True, 'type': 'addresses_WC_ht'}}
