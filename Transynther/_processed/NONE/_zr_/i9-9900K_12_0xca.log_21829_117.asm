...
push %rdi
push %rsi
lea addresses_normal_ht+0x11d44, %rsi
lea addresses_UC_ht+0x173c8, %rdi
inc %r12
mov $43, %rcx
rep movsb
dec %r10
lea addresses_A_ht+0x15968, %r14
nop
nop
nop
nop
...
nop
lfence
lea addresses_WT_ht+0x13168, %r14
nop
add $48272, %r13
movups (%r14), %xmm0
vpextrq $1, %xmm0, %rdi
...
nop
and $15815, %rsi
lea addresses_D_ht+0x15f50, %r12
nop
nop
inc %rsi
movw $0x6162, (%r12)
