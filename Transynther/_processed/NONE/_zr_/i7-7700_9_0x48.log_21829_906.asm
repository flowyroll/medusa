...
push %rdx
push %rsi
lea addresses_D_ht+0x145f9, %rsi
lea addresses_WT_ht+0x1b6b0, %rdi
nop
xor $45341, %r14
mov $82, %rcx
rep movsl
...
nop
add %rcx, %rcx
lea addresses_A_ht+0x112f6, %rbx
nop
nop
cmp %rdx, %rdx
movw $0x6162, (%rbx)
nop
add %rbx, %rbx
lea addresses_UC_ht+0x1b876, %rsi
lea addresses_UC_ht+0x1576, %rdi
nop
nop
nop
and %rdx, %rdx
...
nop
sub %rbx, %rbx
lea addresses_A_ht+0xf80e, %rsi
lea addresses_WT_ht+0x1b656, %rdi
cmp %r15, %r15
mov $23, %rcx
rep movsw
nop
...
nop
and %r14, %r14
lea addresses_WC_ht+0x71c6, %rdi
nop
xor %r14, %r14
movb $0x61, (%rdi)
nop
...
nop
add $52301, %r11
lea addresses_A_ht+0x33d9, %rsi
lea addresses_normal_ht+0x1871a, %rdi
lfence
mov $54, %rcx
rep movsq
nop
...
lea addresses_UC_ht+0x1caf6, %rdi
clflush (%rdi)
add $26826, %r15
mov $118, %rcx
rep movsq
...
nop
and %r14, %r14
lea addresses_WT_ht+0xec96, %rsi
lea addresses_A_ht+0x160b6, %rdi
clflush (%rdi)
nop
nop
nop
...
rep movsl
sub %rbx, %rbx
lea addresses_A_ht+0x139ce, %rsi
lea addresses_UC_ht+0x1caf6, %rdi
nop
nop
sub $25135, %r15
...
<gen_faulty_load>
[REF]
{'OP': 'LOAD', 'src': {'type': 'addresses_WC', 'AVXalign': True, 'congruent': 0, 'size': 16, 'same': False, 'NT': True}}
...
{'OP': 'REPM', 'src': {'type': 'addresses_UC_ht', 'congruent': 5, 'same': True}, 'dst': {'type': 'addresses_UC_ht', 'congruent': 7, 'same': False}}
