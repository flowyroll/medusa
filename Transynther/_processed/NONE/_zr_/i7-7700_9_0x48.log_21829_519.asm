...
push %rdi
push %rsi
lea addresses_normal_ht+0x1328e, %r13
nop
nop
add $21062, %r15
vmovups (%r13), %ymm5
...
nop
sub %rcx, %rcx
lea addresses_WT_ht+0x151be, %rsi
nop
nop
nop
nop
...
nop
add %r15, %r15
lea addresses_WC_ht+0x1116e, %rsi
lea addresses_A_ht+0xd60e, %rdi
cmp %rax, %rax
mov $26, %rcx
rep movsl
nop
...
nop
inc %rbx
lea addresses_UC_ht+0x5a8e, %rsi
lea addresses_normal_ht+0x1258e, %rdi
nop
nop
cmp %rbp, %rbp
mov $28, %rcx
...
{'OP': 'STOR', 'dst': {'type': 'addresses_WT', 'AVXalign': False, 'congruent': 4, 'size': 4, 'same': False, 'NT': True}}
[Faulty Load]
...
{'OP': 'REPM', 'src': {'type': 'addresses_WC_ht', 'congruent': 4, 'same': True}, 'dst': {'type': 'addresses_A_ht', 'congruent': 7, 'same': False}}
