...
nop
sub $11616, %r10
lea addresses_UC_ht+0x96e0, %rcx
nop
nop
nop
nop
...
nop
xor $33129, %rbx
lea addresses_UC_ht+0xb4b8, %rsi
lea addresses_UC_ht+0x63d8, %rdi
nop
nop
nop
nop
...
nop
cmp $38132, %r12
lea addresses_UC_ht+0x1c730, %rsi
...
nop
and $30477, %r9
lea addresses_WC_ht+0x7c48, %rbx
nop
and %rcx, %rcx
...
nop
xor $32303, %rdi
lea addresses_normal_ht+0x2af8, %rbx
inc %rdi
...
nop
sub %r9, %r9
lea addresses_WT_ht+0x4f8, %rcx
nop
inc %r12
movups (%rcx), %xmm0
vpextrq $0, %xmm0, %rbx
cmp %r12, %r12
lea addresses_WC_ht+0x3af8, %r9
nop
nop
nop
cmp $56151, %r12
...
nop
and $38215, %rsi
lea addresses_normal_ht+0x14c68, %r12
and %rdx, %rdx
mov (%r12), %r9
nop
add $32049, %r12
...
{'src': {'same': False, 'congruent': 5, 'type': 'addresses_UC_ht'}, 'OP': 'REPM', 'dst': {'same': False, 'congruent': 3, 'type': 'addresses_UC_ht'}}
{'src': {'same': False, 'congruent': 0, 'type': 'addresses_UC_ht'}, 'OP': 'REPM', 'dst': {'same': False, 'congruent': 7, 'type': 'addresses_UC_ht'}}
