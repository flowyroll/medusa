...
push %rdi
push %rsi
lea addresses_WC_ht+0x1c292, %r10
clflush (%r10)
nop
nop
nop
...
nop
xor $5475, %rsi
lea addresses_A_ht+0x16092, %rsi
lea addresses_UC_ht+0x1ace2, %rdi
nop
cmp $187, %r14
mov $82, %rcx
rep movsl
...
nop
dec %rsi
lea addresses_normal_ht+0xba92, %rbp
nop
nop
nop
nop
...
vpextrq $0, %xmm5, %r10
inc %rsi
lea addresses_normal_ht+0x139c8, %r14
nop
nop
nop
nop
...
nop
xor %rdi, %rdi
lea addresses_D_ht+0x18e92, %rsi
lea addresses_UC_ht+0x1b312, %rdi
sub %r13, %r13
mov $122, %rcx
rep movsw
nop
add $22504, %r14
lea addresses_D_ht+0x1c632, %rbp
nop
nop
nop
nop
...
nop
cmp %rbp, %rbp
lea addresses_UC_ht+0x1b4f2, %r14
clflush (%r14)
nop
nop
nop
...
nop
cmp $43345, %rsi
lea addresses_normal_ht+0x15882, %r13
nop
nop
nop
xor $63756, %r15
...
nop
dec %r14
lea addresses_WT_ht+0x1ce92, %rsi
clflush (%rsi)
nop
nop
nop
