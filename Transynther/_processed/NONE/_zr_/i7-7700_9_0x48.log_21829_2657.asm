...
nop
cmp $12903, %r10
lea addresses_WT_ht+0x1fd7, %rbp
nop
sub $47586, %rax
movb (%rbp), %dl
nop
...
nop
xor $5417, %r10
lea addresses_normal_ht+0x9797, %r10
nop
nop
xor $62455, %rdi
...
nop
sub $57264, %r10
lea addresses_A_ht+0x14777, %rax
nop
nop
xor %rsi, %rsi
vmovups (%rax), %ymm0
...
nop
inc %rdi
lea addresses_A_ht+0x15b97, %rdx
nop
nop
nop
xor %rdi, %rdi
...
nop
xor %r10, %r10
lea addresses_A_ht+0xeb97, %rsi
lea addresses_A_ht+0x5397, %rdi
nop
nop
nop
nop
...
rep movsb
dec %rdi
lea addresses_A_ht+0xe057, %rsi
lea addresses_UC_ht+0x12a67, %rdi
nop
nop
inc %rax
mov $74, %rcx
...
nop
inc %rdi
lea addresses_WC_ht+0x16bc7, %rsi
lea addresses_WC_ht+0xf097, %rdi
nop
nop
nop
dec %r10
...
<gen_prepare_buffer>
{'OP': 'REPM', 'src': {'type': 'addresses_WC_ht', 'congruent': 0, 'same': True}, 'dst': {'type': 'addresses_WT_ht', 'congruent': 7, 'same': False}}
...
{'OP': 'REPM', 'src': {'type': 'addresses_A_ht', 'congruent': 10, 'same': True}, 'dst': {'type': 'addresses_A_ht', 'congruent': 7, 'same': False}}
