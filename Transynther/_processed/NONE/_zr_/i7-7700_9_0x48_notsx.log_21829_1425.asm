...
push %r9
push %rbp
lea addresses_WT_ht+0x1ef1b, %rbp
nop
nop
inc %r12
mov (%rbp), %r14w
...
// Store
lea addresses_normal+0x92ab, %r14
nop
nop
nop
xor $26346, %r15
...
// Store
lea addresses_normal+0x11d3b, %rsi
nop
nop
nop
and $37023, %r14
...
{'OP': 'LOAD', 'src': {'same': False, 'NT': False, 'AVXalign': True, 'size': 2, 'type': 'addresses_WC', 'congruent': 6}}
