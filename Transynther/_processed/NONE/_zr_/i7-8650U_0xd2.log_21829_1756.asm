...
push %rbx
push %rdx
lea addresses_WT_ht+0x37f8, %rbx
nop
nop
nop
add $25566, %rax
...
nop
sub %r8, %r8
lea addresses_normal_ht+0x1b15c, %rax
nop
nop
nop
nop
...
{'OP': 'STOR', 'dst': {'type': 'addresses_RW', 'size': 2, 'AVXalign': True, 'NT': False, 'congruent': 3, 'same': False}}
