...
push %rdi
push %rsi
lea addresses_UC_ht+0x6dae, %r15
nop
nop
nop
nop
...
nop
xor %rbx, %rbx
lea addresses_UC_ht+0x1345e, %rsi
lea addresses_UC_ht+0x1a9ae, %rdi
nop
nop
nop
nop
...
rep movsw
add $3700, %rcx
lea addresses_UC_ht+0x79ae, %rdi
nop
dec %r15
...
nop
and $13747, %rbp
lea addresses_WC_ht+0x30ae, %rsi
lea addresses_D_ht+0x962a, %rdi
nop
nop
nop
xor %r13, %r13
...
nop
xor %r10, %r10
lea addresses_A_ht+0x197ae, %r15
nop
nop
nop
cmp %rbp, %rbp
...
nop
cmp $15397, %r15
lea addresses_WC_ht+0x64a2, %rdi
sub %r13, %r13
mov (%rdi), %rbx
nop
nop
...
nop
add $45923, %r13
lea addresses_WC_ht+0x225e, %r13
nop
nop
nop
xor $40489, %rdi
...
nop
add $393, %r13
lea addresses_normal_ht+0x3b4e, %r10
add $32306, %r15
...
// Store
lea addresses_normal+0x1e1ae, %rsi
clflush (%rsi)
cmp %r14, %r14
movw $0x5152, (%rsi)
nop
...
{'OP': 'LOAD', 'src': {'type': 'addresses_WC', 'AVXalign': False, 'congruent': 3, 'size': 2, 'same': False, 'NT': False}}
...
{'OP': 'REPM', 'src': {'type': 'addresses_UC_ht', 'congruent': 4, 'same': False}, 'dst': {'type': 'addresses_UC_ht', 'congruent': 11, 'same': False}}
