...
push %rdx
push %rsi
lea addresses_D_ht+0x157a1, %r13
clflush (%r13)
nop
sub %rax, %rax
movb $0x61, (%r13)
...
nop
dec %rdi
lea addresses_WC_ht+0x158d1, %rdx
nop
dec %rbx
...
vpextrq $0, %xmm1, %rax
add $23421, %rax
lea addresses_D_ht+0xbd31, %rsi
lea addresses_UC_ht+0x1d8f5, %rdi
dec %rdx
mov $15, %rcx
rep movsl
nop
...
nop
sub $62608, %rdi
lea addresses_D_ht+0x1d551, %rsi
lea addresses_D_ht+0x127d1, %rdi
nop
nop
nop
nop
...
rep movsq
inc %rax
lea addresses_WT_ht+0x17ad, %rdx
nop
xor %r11, %r11
mov (%rdx), %rsi
nop
...
nop
xor %rbx, %rbx
lea addresses_A_ht+0x19031, %rbx
and $43430, %r11
movups (%rbx), %xmm7
vpextrq $0, %xmm7, %rsi
nop
...
{'src': {'congruent': 5, 'AVXalign': True, 'same': False, 'size': 32, 'NT': False, 'type': 'addresses_WC_ht'}, 'OP': 'LOAD'}
{'src': {'congruent': 9, 'same': False, 'type': 'addresses_D_ht'}, 'OP': 'REPM', 'dst': {'congruent': 0, 'same': False, 'type': 'addresses_UC_ht'}}
{'src': {'congruent': 4, 'same': False, 'type': 'addresses_D_ht'}, 'OP': 'REPM', 'dst': {'congruent': 1, 'same': False, 'type': 'addresses_D_ht'}}
