...
mov (%r10), %r15d
inc %r13
lea addresses_D_ht+0x1edf2, %rsi
lea addresses_WC_ht+0x12117, %rdi
clflush (%rdi)
nop
cmp $49156, %rbp
mov $109, %rcx
...
nop
add %rbp, %rbp
lea addresses_normal_ht+0x1d692, %rsi
lea addresses_WC_ht+0xa292, %rdi
nop
nop
xor $49289, %rdx
mov $5, %rcx
rep movsw
and %rdx, %rdx
lea addresses_normal_ht+0xb412, %rbp
clflush (%rbp)
xor $4181, %r10
mov (%rbp), %r13d
nop
...
lea addresses_A_ht+0x1c612, %rdi
nop
nop
and $34861, %rbp
mov $104, %rcx
...
{'OP': 'REPM', 'src': {'type': 'addresses_D_ht', 'congruent': 2, 'same': False}, 'dst': {'type': 'addresses_WC_ht', 'congruent': 0, 'same': True}}
