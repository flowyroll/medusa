...
push %rdx
push %rsi
lea addresses_WT_ht+0xaedb, %rdi
nop
nop
nop
nop
...
nop
sub %rdx, %rdx
lea addresses_A_ht+0xaddb, %rsi
lea addresses_A_ht+0x70db, %rdi
clflush (%rsi)
nop
nop
nop
...
nop
cmp %r14, %r14
lea addresses_UC_ht+0x1155b, %rsi
lea addresses_normal_ht+0x146db, %rdi
clflush (%rsi)
nop
nop
nop
...
nop
dec %rcx
lea addresses_WC_ht+0x19582, %rsi
nop
lfence
movb $0x61, (%rsi)
nop
...
nop
inc %rbx
lea addresses_A_ht+0x16edb, %rax
nop
nop
cmp %rcx, %rcx
mov (%rax), %ebx
nop
cmp $37956, %rbx
lea addresses_D_ht+0x189db, %rbx
nop
nop
nop
nop
...
nop
sub %rax, %rax
lea addresses_WT_ht+0x15fe0, %rdx
nop
nop
nop
nop
...
nop
sub $32426, %rax
lea addresses_UC_ht+0x10db, %r14
nop
sub %rsi, %rsi
movups (%r14), %xmm0
vpextrq $1, %xmm0, %rax
...
nop
cmp %rdx, %rdx
lea addresses_WC_ht+0x142db, %rbx
nop
nop
inc %rcx
...
// Store
lea addresses_RW+0x902b, %rdi
and %r12, %r12
movb $0x51, (%rdi)
xor %r9, %r9

// Store
lea addresses_US+0x1385b, %r10
and $7790, %r15
movl $0x51525354, (%r10)
nop
nop
...
<gen_prepare_buffer>
{'src': {'NT': False, 'same': False, 'congruent': 11, 'type': 'addresses_WT_ht', 'AVXalign': True, 'size': 1}, 'OP': 'LOAD'}
{'src': {'same': False, 'congruent': 8, 'type': 'addresses_A_ht'}, 'OP': 'REPM', 'dst': {'same': False, 'congruent': 7, 'type': 'addresses_A_ht'}}
...
{'src': {'same': False, 'congruent': 7, 'type': 'addresses_UC_ht'}, 'OP': 'REPM', 'dst': {'same': False, 'congruent': 11, 'type': 'addresses_normal_ht'}}
...
{'src': {'same': True, 'congruent': 4, 'type': 'addresses_A_ht'}, 'OP': 'REPM', 'dst': {'same': False, 'congruent': 10, 'type': 'addresses_UC_ht'}}
