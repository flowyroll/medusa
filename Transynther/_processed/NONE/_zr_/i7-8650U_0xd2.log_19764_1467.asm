...
nop
cmp %rbx, %rbx
lea addresses_normal_ht+0xd693, %rsi
lea addresses_D_ht+0x13893, %rdi
clflush (%rdi)
nop
nop
nop
...
rep movsb
and $3145, %r12
lea addresses_A_ht+0x1ae93, %rbx
nop
nop
nop
xor $2376, %r8
...
nop
add %r13, %r13
lea addresses_A_ht+0x12493, %rsi
...
rep movsl
add $61338, %r8
lea addresses_WT_ht+0x7913, %r14
nop
nop
add $53791, %rdi
movb (%r14), %r13b
...
nop
dec %rsi
lea addresses_D_ht+0x12e93, %r12
nop
and %rbx, %rbx
...
nop
add %r14, %r14
lea addresses_A_ht+0x106e7, %rdi
nop
nop
nop
add %rsi, %rsi
...
// Store
lea addresses_normal+0xcc93, %r15
nop
nop
xor $14940, %r14
movw $0x5152, (%r15)
...
{'OP': 'STOR', 'dst': {'type': 'addresses_normal', 'size': 2, 'AVXalign': True, 'NT': False, 'congruent': 8, 'same': False}}
...
{'OP': 'LOAD', 'src': {'type': 'addresses_A_ht', 'size': 4, 'AVXalign': True, 'NT': False, 'congruent': 0, 'same': False}}
