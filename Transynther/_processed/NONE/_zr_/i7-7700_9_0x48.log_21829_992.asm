...
push %rdi
push %rsi
lea addresses_WC_ht+0x1d649, %rsi
lea addresses_UC_ht+0x18f0c, %rdi
nop
nop
cmp $59789, %r13
mov $97, %rcx
...
nop
xor %rax, %rax
lea addresses_WT_ht+0x6e49, %rsi
lea addresses_normal_ht+0x49c9, %rdi
nop
sub %r15, %r15
mov $26, %rcx
rep movsb
...
nop
cmp $45708, %rax
lea addresses_D_ht+0x11309, %r15
nop
nop
nop
nop
...
nop
sub $60792, %r15
lea addresses_normal_ht+0xf89, %rdi
nop
nop
nop
nop
...
nop
add $34769, %r13
lea addresses_UC_ht+0x15d49, %rsi
lea addresses_WT_ht+0x1c149, %rdi
clflush (%rdi)
add $25707, %r12
mov $65, %rcx
rep movsw
...
nop
cmp %r9, %r9
lea addresses_WC_ht+0x29c9, %rsi
lea addresses_UC_ht+0xe0f9, %rdi
nop
inc %rax
mov $41, %rcx
rep movsl
...
nop
cmp $25131, %rcx
lea addresses_WT_ht+0x9249, %rdi
nop
nop
nop
nop
...
mov (%rdi), %si
add $34987, %rdi
lea addresses_UC_ht+0x19549, %r13
cmp $22447, %rsi
movups (%r13), %xmm1
vpextrq $1, %xmm1, %rdi
nop
dec %r9
lea addresses_normal_ht+0x4c9, %rcx
clflush (%rcx)
nop
nop
nop
...
nop
sub %rdi, %rdi
lea addresses_D_ht+0x1b949, %r13
nop
nop
nop
nop
...
<gen_prepare_buffer>
{'OP': 'REPM', 'src': {'type': 'addresses_WC_ht', 'congruent': 8, 'same': False}, 'dst': {'type': 'addresses_UC_ht', 'congruent': 0, 'same': False}}
