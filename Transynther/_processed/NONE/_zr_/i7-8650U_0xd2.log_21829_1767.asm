...
nop
xor $30057, %rdx
lea addresses_D_ht+0x10347, %rcx
nop
nop
nop
nop
...
lea addresses_WC_ht+0x96c7, %rdi
nop
nop
nop
nop
...
nop
cmp %rdi, %rdi
lea addresses_A_ht+0x182b7, %r10
nop
cmp $6260, %r14
mov (%r10), %rdi
nop
...
{'OP': 'REPM', 'src': {'type': 'addresses_PSE', 'congruent': 2, 'same': False}, 'dst': {'type': 'addresses_P', 'congruent': 1, 'same': False}}
