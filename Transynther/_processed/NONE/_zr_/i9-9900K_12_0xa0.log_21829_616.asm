...
push %rdx
push %rsi
lea addresses_A_ht+0xbf00, %rsi
lea addresses_WT_ht+0x6f14, %rdi
nop
nop
cmp $44488, %r9
mov $113, %rcx
...
nop
cmp $19088, %rdx
lea addresses_normal_ht+0x7900, %r13
cmp %r9, %r9
movw $0x6162, (%r13)
nop
sub %rdx, %rdx
lea addresses_normal_ht+0x9b00, %r13
nop
nop
nop
sub $21694, %r10
...
{'src': {'NT': True, 'same': False, 'congruent': 11, 'type': 'addresses_US', 'AVXalign': False, 'size': 4}, 'OP': 'LOAD'}
[Faulty Load]
