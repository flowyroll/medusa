...
push %r9
push %rbx
lea addresses_normal_ht+0xfbd8, %r10
nop
add %rbx, %rbx
...
nop
xor $21914, %rbx
lea addresses_D_ht+0x141d8, %r10
and $40558, %r14
mov $0x6162636465666768, %r11
movq %r11, %xmm5
...
nop
add %r10, %r10
lea addresses_D_ht+0x1da88, %r12
cmp $14546, %r15
mov (%r12), %r9
nop
xor $18220, %rbx
lea addresses_WC_ht+0x114d8, %rbx
lfence
mov (%rbx), %r9
nop
nop
sub %r12, %r12
lea addresses_UC_ht+0xca98, %r10
nop
nop
nop
add $50531, %rbx
...
{'dst': {'type': 'addresses_NC', 'same': False, 'size': 32, 'congruent': 0, 'NT': True, 'AVXalign': False}, 'OP': 'STOR'}
[Faulty Load]
...
{'dst': {'type': 'addresses_D_ht', 'same': False, 'size': 32, 'congruent': 6, 'NT': True, 'AVXalign': True}, 'OP': 'STOR'}
{'dst': {'type': 'addresses_A_ht', 'same': False, 'size': 32, 'congruent': 6, 'NT': False, 'AVXalign': False}, 'OP': 'STOR'}
{'src': {'type': 'addresses_D_ht', 'same': True, 'size': 8, 'congruent': 4, 'NT': False, 'AVXalign': True}, 'OP': 'LOAD'}
