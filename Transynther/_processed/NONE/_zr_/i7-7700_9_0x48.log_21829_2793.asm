...
nop
cmp $30487, %rdi
lea addresses_WC_ht+0x1d07b, %r8
nop
nop
nop
nop
...
nop
and $55319, %rdi
lea addresses_normal_ht+0x1987b, %rsi
lea addresses_A_ht+0x17bfb, %rdi
clflush (%rdi)
and %r15, %r15
mov $120, %rcx
rep movsb
nop
and %r9, %r9
lea addresses_normal_ht+0x1307b, %rsi
lea addresses_D_ht+0xbf3b, %rdi
nop
nop
nop
nop
...
nop
and $34296, %rdi
lea addresses_WT_ht+0x7c7b, %r9
nop
nop
sub $24115, %rcx
movw $0x6162, (%r9)
cmp $3321, %r9
lea addresses_WC_ht+0x783b, %r15
clflush (%r15)
nop
nop
nop
...
vpextrq $1, %xmm4, %rdi
sub $28396, %rcx
lea addresses_WC_ht+0x1287b, %r15
nop
nop
nop
nop
...
nop
sub %r8, %r8
lea addresses_WC_ht+0x1881b, %rdi
nop
cmp $26952, %r9
movb $0x61, (%rdi)
nop
...
nop
sub %rbp, %rbp
lea addresses_D_ht+0x13afb, %rsi
lea addresses_WT_ht+0x2c7b, %rdi
nop
nop
nop
nop
...
nop
cmp $35861, %r12
lea addresses_A_ht+0x8c7b, %rsi
lea addresses_UC_ht+0x151eb, %rdi
nop
nop
nop
nop
...
{'OP': 'REPM', 'src': {'type': 'addresses_A_ht', 'congruent': 10, 'same': True}, 'dst': {'type': 'addresses_UC_ht', 'congruent': 3, 'same': False}}
{'00': 21829}
