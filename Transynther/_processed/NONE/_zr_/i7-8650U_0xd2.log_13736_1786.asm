...
nop
add %rdx, %rdx
lea addresses_WT_ht+0x141bd, %rsi
lea addresses_A_ht+0x1259d, %rdi
nop
sub $24562, %r10
mov $103, %rcx
rep movsq
...
nop
sub %rdi, %rdi
lea addresses_D_ht+0x19b21, %r10
mfence
mov (%r10), %di
and $62628, %rcx
lea addresses_WC_ht+0x957d, %rsi
lea addresses_UC_ht+0x1023d, %rdi
clflush (%rdi)
nop
cmp %r11, %r11
mov $62, %rcx
...
nop
xor $10235, %rsi
lea addresses_A_ht+0x1db3d, %rsi
nop
nop
nop
nop
...
nop
sub %rcx, %rcx
lea addresses_UC_ht+0x9abd, %rcx
nop
cmp %rsi, %rsi
...
vmovaps %ymm5, (%rcx)
cmp %rcx, %rcx
lea addresses_WT_ht+0xca3b, %rsi
lea addresses_A_ht+0x1855d, %rdi
clflush (%rsi)
nop
nop
and $21272, %r14
...
nop
and $12582, %r13
lea addresses_normal_ht+0x7181, %rdx
nop
sub %rcx, %rcx
mov (%rdx), %r13d
nop
...
<gen_faulty_load>
[REF]
{'OP': 'LOAD', 'src': {'type': 'addresses_A', 'size': 16, 'AVXalign': True, 'NT': False, 'congruent': 0, 'same': False}}
{'OP': 'STOR', 'dst': {'type': 'addresses_US', 'size': 2, 'AVXalign': False, 'NT': True, 'congruent': 8, 'same': False}}
...
{'OP': 'LOAD', 'src': {'type': 'addresses_UC_ht', 'size': 16, 'AVXalign': True, 'NT': False, 'congruent': 7, 'same': False}}
