...
push %rdi
push %rsi
lea addresses_WC_ht+0x1a308, %rax
nop
nop
nop
nop
...
nop
inc %rbp
lea addresses_UC_ht+0x6308, %r15
nop
nop
nop
nop
...
movb $0x61, (%r15)
xor $15557, %rdi
lea addresses_WC_ht+0x5708, %rbx
nop
nop
nop
nop
...
nop
sub %rdi, %rdi
lea addresses_WT_ht+0x115b8, %rsi
lea addresses_D_ht+0x184ed, %rdi
nop
nop
nop
nop
...
rep movsw
add %rcx, %rcx
lea addresses_normal_ht+0x2a88, %rsi
nop
nop
nop
cmp $54970, %r15
...
nop
cmp %r8, %r8
lea addresses_normal_ht+0x19f08, %rax
nop
inc %rbp
...
nop
and %r15, %r15
lea addresses_WC_ht+0x746c, %rsi
lea addresses_WC_ht+0x199d4, %rdi
clflush (%rsi)
nop
xor %r15, %r15
mov $60, %rcx
...
{'OP': 'STOR', 'dst': {'congruent': 7, 'AVXalign': False, 'same': False, 'size': 32, 'NT': True, 'type': 'addresses_P'}}
[Faulty Load]
