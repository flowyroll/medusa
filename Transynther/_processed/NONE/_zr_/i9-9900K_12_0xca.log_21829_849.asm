...
push %rdx
push %rsi
lea addresses_A_ht+0x10735, %rdx
and $9866, %r15
movb $0x61, (%rdx)
nop
nop
...
nop
xor %r9, %r9
lea addresses_WC_ht+0xc735, %rsi
...
nop
xor %rbx, %rbx
lea addresses_normal_ht+0xa4b5, %r14
nop
xor $7081, %r15
movl $0x61626364, (%r14)
inc %rsi
lea addresses_WT_ht+0x135cd, %r15
nop
nop
nop
add %rcx, %rcx
...
nop
add $14018, %rbx
lea addresses_WT_ht+0x1a4ed, %rdx
dec %r14
mov $0x6162636465666768, %r9
movq %r9, (%rdx)
sub $16741, %rbx
lea addresses_A_ht+0x275, %rsi
dec %rbx
movl $0x61626364, (%rsi)
nop
nop
...
nop
and $1873, %rdx
lea addresses_D_ht+0xf835, %rsi
lea addresses_WC_ht+0x11de5, %rdi
nop
nop
nop
add %r15, %r15
...
nop
inc %r14
lea addresses_WC_ht+0x3ced, %rdi
nop
nop
nop
xor %r15, %r15
...
// REPMOV
lea addresses_normal+0x9329, %rsi
mov $0x4e5, %rdi
nop
nop
nop
...
{'OP': 'REPM', 'src': {'same': False, 'type': 'addresses_normal', 'congruent': 1}, 'dst': {'same': False, 'type': 'addresses_P', 'congruent': 1}}
...
{'OP': 'REPM', 'src': {'same': False, 'type': 'addresses_WC_ht', 'congruent': 8}, 'dst': {'same': True, 'type': 'addresses_UC_ht', 'congruent': 6}}
