...
push %rdx
push %rsi
lea addresses_WT_ht+0x89ec, %rbx
nop
add $20770, %r8
...
nop
xor $20055, %rbp
lea addresses_WC_ht+0x14e78, %rsi
lea addresses_normal_ht+0x1558c, %rdi
clflush (%rsi)
nop
nop
nop
...
nop
inc %rcx
lea addresses_WC_ht+0x1ee2c, %r8
clflush (%r8)
nop
nop
nop
...
nop
cmp $27475, %rbp
lea addresses_WT_ht+0x786c, %rax
nop
nop
nop
nop
...
nop
and $129, %rax
lea addresses_D_ht+0x1009c, %rsi
lea addresses_UC_ht+0x61b4, %rdi
clflush (%rsi)
nop
nop
nop
...
nop
lfence
lea addresses_D_ht+0xcec, %rsi
lea addresses_WC_ht+0x9ca2, %rdi
nop
nop
nop
nop
...
lea addresses_WC_ht+0x19fec, %rdi
add %rbx, %rbx
mov $80, %rcx
rep movsb
nop
nop
cmp $10944, %rbp
lea addresses_WC_ht+0x43cc, %rsi
lea addresses_normal_ht+0x17aec, %rdi
nop
sub %r8, %r8
mov $72, %rcx
rep movsb
...
nop
xor $5193, %rdx
lea addresses_WC_ht+0x1e4ec, %rbx
inc %rsi
movw $0x6162, (%rbx)
nop
nop
nop
add %rax, %rax
lea addresses_WC_ht+0x76b6, %rbx
nop
nop
mfence
...
nop
dec %rax
lea addresses_UC_ht+0x336c, %rax
nop
nop
dec %rdi
movups (%rax), %xmm4
...
{'OP': 'REPM', 'src': {'type': 'addresses_WC_ht', 'congruent': 4, 'same': True}, 'dst': {'type': 'addresses_normal_ht', 'congruent': 8, 'same': False}}
...
{'OP': 'LOAD', 'src': {'type': 'addresses_UC_ht', 'size': 16, 'AVXalign': False, 'NT': False, 'congruent': 6, 'same': True}}
{'00': 13568}
