...
push %rdx
push %rsi
lea addresses_normal_ht+0x1b89, %rdx
nop
nop
nop
nop
...
nop
cmp %rdi, %rdi
lea addresses_normal_ht+0x178c9, %rsi
lea addresses_WT_ht+0xb869, %rdi
nop
nop
nop
nop
...
nop
inc %rsi
lea addresses_UC_ht+0x12bc9, %r9
cmp $50250, %rbx
mov (%r9), %cx
nop
nop
...
nop
sub $21998, %rbx
lea addresses_A_ht+0x4341, %rsi
lea addresses_WT_ht+0x17d21, %rdi
sub %r12, %r12
mov $28, %rcx
rep movsb
dec %rdx
lea addresses_D_ht+0x14109, %rbx
nop
nop
sub %r9, %r9
...
nop
cmp $19493, %rbx
lea addresses_D_ht+0x1c609, %rbx
nop
nop
nop
nop
...
nop
inc %rbx
lea addresses_UC_ht+0x9009, %rcx
nop
nop
nop
nop
...
nop
inc %r9
lea addresses_A_ht+0x12109, %rsi
lea addresses_WT_ht+0xaa84, %rdi
nop
nop
dec %rdx
mov $50, %rcx
...
nop
xor $9170, %rcx
lea addresses_WT_ht+0xa989, %rbp
nop
add %rdx, %rdx
vmovups (%rbp), %ymm1
...
{'OP': 'REPM', 'src': {'type': 'addresses_normal_ht', 'congruent': 5, 'same': True}, 'dst': {'type': 'addresses_WT_ht', 'congruent': 3, 'same': False}}
