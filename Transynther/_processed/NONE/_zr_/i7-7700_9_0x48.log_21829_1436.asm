...
push %rdi
push %rsi
lea addresses_UC_ht+0xbb92, %r14
nop
sub %rsi, %rsi
movl $0x61626364, (%r14)
nop
nop
cmp $32474, %r10
lea addresses_UC_ht+0xbde2, %rcx
nop
and %rax, %rax
vmovups (%rcx), %ymm4
...
nop
add %rsi, %rsi
lea addresses_D_ht+0x15246, %r11
cmp %r15, %r15
movw $0x6162, (%r11)
dec %r11
lea addresses_D_ht+0x1e702, %r10
nop
nop
nop
nop
...
nop
add $33290, %r14
lea addresses_WC_ht+0x12262, %rsi
lea addresses_WT_ht+0x5b18, %rdi
nop
nop
nop
sub $31928, %r10
...
lea addresses_normal_ht+0x169e2, %rdi
nop
nop
nop
add %r10, %r10
