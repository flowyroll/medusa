...
push %rdi
push %rsi
lea addresses_D_ht+0x13190, %rsi
lea addresses_WC_ht+0x18e90, %rdi
nop
nop
nop
nop
...
nop
and %r12, %r12
lea addresses_WT_ht+0x12030, %r14
clflush (%r14)
nop
nop
nop
...
nop
add $20158, %rcx
lea addresses_A_ht+0x1a090, %rsi
lea addresses_D_ht+0x12540, %rdi
inc %r13
mov $57, %rcx
rep movsb
nop
sub %r12, %r12
lea addresses_normal_ht+0x19890, %rax
nop
inc %r12
movb $0x61, (%rax)
nop
inc %rsi
lea addresses_D_ht+0x14890, %rsi
...
nop
xor $22446, %rax
lea addresses_UC_ht+0x18c21, %rsi
nop
add $28931, %rcx
mov (%rsi), %di
nop
...
nop
add $55639, %r12
lea addresses_D_ht+0x14290, %rsi
lea addresses_D_ht+0x7490, %rdi
nop
nop
nop
nop
...
movups %xmm3, (%rax)
and $14629, %r13
lea addresses_WC_ht+0x19c90, %r12
nop
nop
nop
nop
...
// Store
lea addresses_US+0xb490, %rdx
dec %rax
movb $0x51, (%rdx)
and $56989, %rsi

// Faulty Load
lea addresses_WT+0x2090, %rax
nop
nop
nop
nop
