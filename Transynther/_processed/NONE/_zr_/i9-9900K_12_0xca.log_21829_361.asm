...
push %rdx
push %rsi
lea addresses_normal_ht+0x1728d, %r13
nop
xor %rdx, %rdx
mov (%r13), %ebx
nop
sub %r10, %r10
lea addresses_normal_ht+0x2f91, %r12
nop
nop
xor %rax, %rax
mov (%r12), %r15
nop
and %r10, %r10
lea addresses_A_ht+0x1edad, %rbx
nop
nop
sub %rdx, %rdx
movl $0x61626364, (%rbx)
...
vmovups %ymm1, (%r12)
and %r13, %r13
lea addresses_D_ht+0xe5b6, %rdx
nop
nop
dec %rax
mov (%rdx), %r10d
add $46956, %rbx
lea addresses_UC_ht+0x11f49, %r10
nop
nop
nop
cmp $55736, %rax
...
nop
sub %rbx, %rbx
lea addresses_WC_ht+0x408c, %rsi
lea addresses_A_ht+0x17de5, %rdi
clflush (%rdi)
dec %r15
mov $64, %rcx
rep movsl
xor %rdx, %rdx
lea addresses_WC_ht+0x160f1, %r10
nop
nop
nop
dec %r15
mov (%r10), %rcx
cmp %rdx, %rdx
lea addresses_UC_ht+0xdd95, %r12
sub $36617, %rbx
mov (%r12), %eax
nop
nop
nop
add %rcx, %rcx
lea addresses_UC_ht+0x13b91, %rdx
nop
nop
and %rsi, %rsi
mov (%rdx), %rcx
...
nop
dec %r10
lea addresses_UC_ht+0xc8d1, %rsi
...
{'OP': 'LOAD', 'src': {'size': 8, 'NT': False, 'type': 'addresses_NC', 'same': False, 'AVXalign': False, 'congruent': 10}}
[Faulty Load]
...
{'OP': 'REPM', 'src': {'same': False, 'type': 'addresses_WC_ht', 'congruent': 0}, 'dst': {'same': True, 'type': 'addresses_A_ht', 'congruent': 2}}
...
{'OP': 'REPM', 'src': {'same': False, 'type': 'addresses_UC_ht', 'congruent': 6}, 'dst': {'same': True, 'type': 'addresses_UC_ht', 'congruent': 2}}
{'00': 21829}
