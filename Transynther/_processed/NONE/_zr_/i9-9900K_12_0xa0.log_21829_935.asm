...
push %rdx
push %rsi
lea addresses_normal_ht+0x1b49f, %rsi
lea addresses_normal_ht+0x1e99f, %rdi
nop
nop
nop
and $21934, %rbp
...
nop
sub %r9, %r9
lea addresses_UC_ht+0xcb9f, %rdx
sub %r13, %r13
...
nop
add $28023, %rsi
lea addresses_UC_ht+0xb09f, %rsi
nop
nop
xor %rbp, %rbp
...
nop
xor $3553, %rsi
lea addresses_WT_ht+0x1ee5f, %rbp
nop
nop
nop
nop
...
nop
cmp %r13, %r13
lea addresses_D_ht+0x1ab9f, %rsi
lea addresses_UC_ht+0x10e91, %rdi
nop
nop
nop
nop
...
{'src': {'same': False, 'congruent': 8, 'type': 'addresses_D_ht'}, 'OP': 'REPM', 'dst': {'same': False, 'congruent': 1, 'type': 'addresses_UC_ht'}}
{'00': 21829}
