...
push %rdi
push %rsi
lea addresses_normal_ht+0x352f, %rsi
lea addresses_UC_ht+0x1c52f, %rdi
nop
nop
and $23938, %r15
mov $75, %rcx
...
nop
sub %rdi, %rdi
lea addresses_normal_ht+0x12b2a, %rsi
nop
nop
nop
add $45889, %r9
mov (%rsi), %r15
cmp %r15, %r15
lea addresses_WT_ht+0x17a6f, %r13
clflush (%r13)
nop
sub $44637, %r12
...
vpextrq $0, %xmm0, %rcx
add $54254, %r12
lea addresses_UC_ht+0x64ef, %r15
and $32004, %r13
...
nop
xor $7706, %r13
lea addresses_WC_ht+0x111ef, %r12
and %r15, %r15
mov (%r12), %r9
nop
nop
add $5014, %rsi
lea addresses_A_ht+0xd3d, %r9
nop
xor $7034, %rsi
movb $0x61, (%r9)
nop
...
nop
inc %r9
lea addresses_normal_ht+0x1c7ef, %rcx
clflush (%rcx)
nop
and $6213, %rdi
...
nop
sub %rcx, %rcx
lea addresses_WC_ht+0x14def, %r13
nop
cmp %rsi, %rsi
vmovups (%r13), %ymm4
...
// Load
lea addresses_normal+0x1def, %rcx
nop
nop
and $51302, %r8
mov (%rcx), %eax
...
{'OP': 'STOR', 'dst': {'type': 'addresses_D', 'AVXalign': True, 'congruent': 11, 'size': 1, 'same': False, 'NT': False}}
{'OP': 'STOR', 'dst': {'type': 'addresses_A', 'AVXalign': False, 'congruent': 7, 'size': 32, 'same': False, 'NT': False}}
{'OP': 'STOR', 'dst': {'type': 'addresses_WC', 'AVXalign': False, 'congruent': 10, 'size': 8, 'same': False, 'NT': True}}
[Faulty Load]
...
{'OP': 'LOAD', 'src': {'type': 'addresses_WT_ht', 'AVXalign': True, 'congruent': 6, 'size': 16, 'same': False, 'NT': False}}
