...
nop
sub %r15, %r15
lea addresses_WT_ht+0x14308, %rdx
and %r14, %r14
movb (%rdx), %r11b
nop
nop
...
nop
add %r11, %r11
lea addresses_UC_ht+0x4568, %r11
nop
nop
nop
nop
...
{'OP': 'STOR', 'dst': {'congruent': 0, 'AVXalign': False, 'same': True, 'size': 32, 'NT': True, 'type': 'addresses_WC'}}
[Faulty Load]
...
{'src': {'congruent': 4, 'AVXalign': False, 'same': False, 'size': 1, 'NT': True, 'type': 'addresses_WT_ht'}, 'OP': 'LOAD'}
