...
nop
lfence
lea addresses_WC_ht+0x1ee3c, %rsi
cmp %r11, %r11
mov (%rsi), %eax
sub $40130, %rax
lea addresses_UC_ht+0x1967c, %rsi
lea addresses_A_ht+0x1023c, %rdi
nop
nop
nop
nop
...
nop
inc %r11
lea addresses_WT_ht+0x15cfc, %r15
nop
nop
nop
nop
...
nop
and $49876, %rdi
lea addresses_WC_ht+0x16a2c, %rcx
nop
add $51772, %r10
...
nop
add %rdi, %rdi
lea addresses_WT_ht+0xa0bc, %rdi
nop
nop
nop
nop
...
nop
cmp $29063, %r11
lea addresses_D_ht+0x1608c, %r15
nop
nop
nop
nop
...
nop
cmp $59047, %r15
lea addresses_WT_ht+0x193ac, %rsi
lea addresses_WT_ht+0x22fc, %rdi
nop
nop
nop
nop
...
nop
dec %r14
lea addresses_normal_ht+0x1dd4c, %rsi
nop
nop
nop
nop
...
nop
lfence
lea addresses_normal_ht+0xe773, %rsi
lea addresses_A_ht+0x4efc, %rdi
and $15519, %rax
mov $57, %rcx
rep movsb
nop
...
nop
sub %r11, %r11
lea addresses_normal_ht+0x140fc, %rsi
lea addresses_normal_ht+0x109fc, %rdi
nop
nop
nop
cmp %r14, %r14
...
nop
cmp $41638, %rsi
lea addresses_A_ht+0x1cb7c, %rcx
cmp $39734, %rbp
vmovups (%rcx), %ymm4
