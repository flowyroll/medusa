...
push %rdi
push %rsi
lea addresses_UC_ht+0xca0a, %r15
nop
nop
nop
dec %r12
...
nop
cmp $49820, %r9
lea addresses_WT_ht+0x818a, %r13
nop
nop
cmp %r14, %r14
...
vmovups %ymm2, (%r13)
sub %r13, %r13
lea addresses_UC_ht+0xbe0a, %rsi
lea addresses_normal_ht+0x168b4, %rdi
clflush (%rsi)
nop
nop
nop
...
{'OP': 'STOR', 'dst': {'size': 4, 'NT': True, 'type': 'addresses_US', 'same': False, 'AVXalign': False, 'congruent': 3}}
{'OP': 'LOAD', 'src': {'size': 2, 'NT': False, 'type': 'addresses_A', 'same': False, 'AVXalign': False, 'congruent': 0}}
{'OP': 'LOAD', 'src': {'size': 2, 'NT': False, 'type': 'addresses_RW', 'same': False, 'AVXalign': False, 'congruent': 10}}
...
{'OP': 'REPM', 'src': {'same': False, 'type': 'addresses_UC_ht', 'congruent': 10}, 'dst': {'same': True, 'type': 'addresses_normal_ht', 'congruent': 1}}
{'00': 21829}
