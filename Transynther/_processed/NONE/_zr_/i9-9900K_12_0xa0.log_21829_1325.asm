...
push %rdx
push %rsi
lea addresses_WC_ht+0x12488, %rdx
cmp $64776, %rsi
mov (%rdx), %rax
nop
nop
nop
xor $18558, %r14
lea addresses_normal_ht+0x17dd0, %rsi
lea addresses_normal_ht+0x1e200, %rdi
clflush (%rdi)
nop
nop
nop
...
nop
cmp $54912, %rsi
lea addresses_WT_ht+0xe1d8, %rsi
clflush (%rsi)
nop
nop
nop
...
nop
cmp %rdx, %rdx
lea addresses_normal_ht+0x16ae0, %r12
add %rax, %rax
mov (%r12), %dx
nop
dec %rax
lea addresses_D_ht+0x90d0, %rax
clflush (%rax)
xor %rdi, %rdi
movups (%rax), %xmm0
vpextrq $0, %xmm0, %rcx
...
nop
lfence
lea addresses_D_ht+0x105d0, %r14
dec %rax
movb (%r14), %r12b
dec %r14
lea addresses_WC_ht+0x8a91, %r14
clflush (%r14)
nop
nop
and %rdx, %rdx
...
nop
xor $16292, %rdi
lea addresses_UC_ht+0xf7d0, %rsi
lea addresses_A_ht+0x1be28, %rdi
sub $26442, %r11
mov $11, %rcx
rep movsb
nop
sub %rsi, %rsi
lea addresses_D_ht+0x1ddd0, %rdx
nop
nop
nop
nop
...
{'OP': 'STOR', 'dst': {'NT': True, 'same': False, 'congruent': 2, 'type': 'addresses_WT', 'AVXalign': True, 'size': 32}}
[Faulty Load]
