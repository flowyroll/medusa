...
push %rdi
push %rsi
lea addresses_normal_ht+0x2a4f, %r9
nop
nop
nop
cmp $64755, %r13
...
nop
and %r8, %r8
lea addresses_D_ht+0x1054f, %rsi
lea addresses_D_ht+0xc7ef, %rdi
add %r13, %r13
mov $120, %rcx
rep movsb
nop
...
nop
xor %rdi, %rdi
lea addresses_D_ht+0x1a6ef, %r13
nop
nop
cmp $7756, %rdi
mov (%r13), %cx
sub $52576, %rsi
lea addresses_WT_ht+0x811f, %r13
nop
nop
nop
nop
...
// Store
lea addresses_normal+0x17bef, %rbp
nop
nop
nop
nop
...
{'OP': 'STOR', 'dst': {'type': 'addresses_US', 'AVXalign': True, 'congruent': 4, 'size': 2, 'same': False, 'NT': False}}
{'OP': 'STOR', 'dst': {'type': 'addresses_normal', 'AVXalign': True, 'congruent': 10, 'size': 1, 'same': False, 'NT': False}}
