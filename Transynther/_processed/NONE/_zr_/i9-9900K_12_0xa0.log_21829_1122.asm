...
nop
inc %rsi
lea addresses_A_ht+0x1163a, %r12
dec %r15
movups (%r12), %xmm1
vpextrq $1, %xmm1, %r10
nop
nop
sub $59705, %r15
lea addresses_WT_ht+0x1d4ca, %r8
dec %r15
...
nop
cmp %r15, %r15
lea addresses_A_ht+0x1b0ca, %r12
nop
nop
nop
nop
...
mov (%r12), %r8
add $45567, %r15
lea addresses_WC_ht+0x1f0c, %r12
nop
nop
nop
nop
...
nop
lfence
lea addresses_WT_ht+0xa7aa, %rsi
lea addresses_WC_ht+0xf2a, %rdi
inc %r12
mov $38, %rcx
rep movsl
nop
xor %r12, %r12
lea addresses_WT_ht+0x1b520, %rsi
lea addresses_D_ht+0x5ac2, %rdi
dec %r10
mov $73, %rcx
rep movsl
nop
nop
cmp $9188, %r8
lea addresses_normal_ht+0x13198, %rdi
nop
nop
inc %rcx
mov $0x6162636465666768, %r15
...
{'src': {'same': False, 'congruent': 1, 'type': 'addresses_WT_ht'}, 'OP': 'REPM', 'dst': {'same': False, 'congruent': 1, 'type': 'addresses_D_ht'}}
