...
push %rdx
push %rsi
lea addresses_normal_ht+0x16f67, %rsi
nop
nop
xor $31368, %r14
vmovups (%rsi), %ymm2
...
nop
and $19157, %r10
lea addresses_normal_ht+0x1d897, %r9
nop
dec %r11
movl $0x61626364, (%r9)
sub %rsi, %rsi
lea addresses_WT_ht+0x1d097, %rsi
lea addresses_D_ht+0xb147, %rdi
nop
nop
nop
nop
...
nop
add %rbx, %rbx
lea addresses_normal_ht+0xae4c, %r9
nop
sub %r14, %r14
movb $0x61, (%r9)
nop
nop
cmp %rcx, %rcx
lea addresses_UC_ht+0x18067, %r11
and $37107, %r14
movb (%r11), %r10b
nop
nop
cmp %r11, %r11
lea addresses_D_ht+0xdd97, %r9
clflush (%r9)
and $15494, %rdi
mov (%r9), %ecx
and $41377, %rbx
lea addresses_A_ht+0x1bb97, %r14
nop
add %rdi, %rdi
...
nop
inc %rcx
lea addresses_WC_ht+0x1cbf7, %rsi
lea addresses_UC_ht+0x1bb27, %rdi
clflush (%rdi)
nop
nop
nop
...
nop
and %r9, %r9
lea addresses_UC_ht+0x1c697, %rbx
and %r14, %r14
vmovups (%rbx), %ymm3
...
nop
sub %rdx, %rdx
lea addresses_A_ht+0x6baf, %rsi
lea addresses_UC_ht+0x16d4f, %rdi
nop
nop
nop
and $12103, %rbx
...
nop
sub $5054, %r10
lea addresses_WT_ht+0x7c07, %rsi
lea addresses_A_ht+0x7797, %rdi
clflush (%rsi)
nop
nop
mfence
...
nop
mfence
lea addresses_normal_ht+0x15f17, %r9
nop
nop
nop
nop
...
{'src': {'same': False, 'congruent': 5, 'type': 'addresses_WC_ht'}, 'OP': 'REPM', 'dst': {'same': False, 'congruent': 4, 'type': 'addresses_UC_ht'}}
...
{'src': {'NT': False, 'same': True, 'congruent': 4, 'type': 'addresses_normal_ht', 'AVXalign': False, 'size': 8}, 'OP': 'LOAD'}
{'00': 21829}
