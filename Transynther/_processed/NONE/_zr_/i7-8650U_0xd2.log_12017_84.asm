...
nop
dec %r15
lea addresses_A_ht+0x12acf, %rsi
lea addresses_WT_ht+0x109c4, %rdi
nop
nop
nop
nop
...
nop
and $60986, %r15
lea addresses_WC_ht+0x1ca8f, %rsi
nop
nop
nop
xor %rax, %rax
...
nop
inc %rsi
lea addresses_WC_ht+0x82cf, %rsi
lea addresses_WC_ht+0x288f, %rdi
nop
nop
nop
nop
...
nop
sub %r15, %r15
lea addresses_UC_ht+0x6c8f, %r15
clflush (%r15)
nop
nop
nop
...
nop
dec %rdi
lea addresses_UC_ht+0x178f, %rsi
lea addresses_UC_ht+0x1408f, %rdi
nop
nop
nop
cmp %rax, %rax
...
nop
and %rbp, %rbp
lea addresses_D_ht+0x6970, %rsi
lea addresses_A_ht+0x1708f, %rdi
dec %r13
mov $61, %rcx
rep movsq
nop
...
{'OP': 'STOR', 'dst': {'type': 'addresses_UC', 'size': 8, 'AVXalign': False, 'NT': False, 'congruent': 6, 'same': True}}
[Faulty Load]
