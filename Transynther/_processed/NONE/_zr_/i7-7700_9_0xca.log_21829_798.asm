...
push %rdx
push %rsi
lea addresses_WT_ht+0x1c81b, %r8
nop
nop
nop
nop
...
nop
and %rsi, %rsi
lea addresses_WC_ht+0x14a1b, %r10
nop
inc %r9
movb $0x61, (%r10)
inc %rdx
lea addresses_D_ht+0x7981, %rsi
lea addresses_normal_ht+0xff1d, %rdi
nop
nop
nop
and $7084, %r8
...
nop
inc %rbp
lea addresses_D_ht+0x129b, %rsi
lea addresses_D_ht+0xc81b, %rdi
nop
nop
nop
nop
...
nop
and %r10, %r10
lea addresses_WC_ht+0x343b, %rsi
lea addresses_WT_ht+0xbc1b, %rdi
nop
cmp $57066, %r8
mov $58, %rcx
rep movsl
...
nop
xor %r8, %r8
lea addresses_normal_ht+0x1a01b, %rsi
lea addresses_A_ht+0x622f, %rdi
clflush (%rsi)
nop
xor $52578, %r8
mov $65, %rcx
rep movsq
dec %rdx
lea addresses_WC_ht+0x1401b, %r8
nop
nop
nop
nop
...
{'src': {'congruent': 0, 'same': True, 'type': 'addresses_D_ht'}, 'OP': 'REPM', 'dst': {'congruent': 1, 'same': False, 'type': 'addresses_normal_ht'}}
...
{'src': {'congruent': 10, 'same': False, 'type': 'addresses_normal_ht'}, 'OP': 'REPM', 'dst': {'congruent': 1, 'same': False, 'type': 'addresses_A_ht'}}
