...
push %rdx
push %rsi
lea addresses_normal_ht+0x1e459, %r14
nop
nop
cmp %r9, %r9
...
vmovups %ymm3, (%r14)
and $18690, %rdx
lea addresses_WT_ht+0xcdd5, %r15
nop
nop
nop
add $58597, %r14
...
nop
add %rdx, %rdx
lea addresses_UC_ht+0xdd95, %r10
clflush (%r10)
nop
nop
nop
...
nop
xor %r15, %r15
lea addresses_WC_ht+0x103ed, %rsi
lea addresses_UC_ht+0x16d95, %rdi
inc %r15
mov $67, %rcx
rep movsw
cmp %r10, %r10
lea addresses_D_ht+0xa98d, %rsi
lea addresses_A_ht+0xac95, %rdi
nop
nop
nop
xor %r15, %r15
...
rep movsb
add $36450, %r12
lea addresses_D_ht+0x1bd95, %rsi
lea addresses_WT_ht+0x17405, %rdi
clflush (%rdi)
nop
xor %r9, %r9
mov $12, %rcx
...
{'OP': 'STOR', 'dst': {'type': 'addresses_RW', 'size': 2, 'AVXalign': False, 'NT': True, 'congruent': 4, 'same': False}}
...
{'OP': 'REPM', 'src': {'type': 'addresses_D_ht', 'congruent': 3, 'same': False}, 'dst': {'type': 'addresses_A_ht', 'congruent': 8, 'same': False}}
