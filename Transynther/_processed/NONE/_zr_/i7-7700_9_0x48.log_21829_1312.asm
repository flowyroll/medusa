...
nop
cmp $10731, %rbp
lea addresses_WT_ht+0x3809, %r10
nop
nop
add $7999, %r15
...
nop
dec %rbp
lea addresses_D_ht+0x11109, %rsi
nop
nop
xor $65100, %rcx
mov (%rsi), %r10
add $159, %r15
lea addresses_WC_ht+0x1374f, %rbp
sub %rsi, %rsi
movw $0x6162, (%rbp)
nop
nop
nop
sub %rbp, %rbp
lea addresses_normal_ht+0x639d, %rsi
lea addresses_A_ht+0x8f29, %rdi
clflush (%rsi)
nop
nop
cmp $691, %rbx
...
nop
sub %r15, %r15
lea addresses_WT_ht+0x1163, %rsi
nop
nop
nop
nop
...
nop
sub $15476, %r10
lea addresses_normal_ht+0xab6d, %rbx
nop
mfence
...
nop
cmp $41015, %r10
lea addresses_A_ht+0x1bb09, %rdi
nop
nop
nop
nop
...
vpextrq $0, %xmm2, %rbx
and $55662, %r10
lea addresses_normal_ht+0x9269, %rsi
lea addresses_normal_ht+0xc049, %rdi
nop
inc %r15
mov $14, %rcx
rep movsw
...
nop
dec %rdi
lea addresses_WC_ht+0x929, %rsi
lea addresses_normal_ht+0x14309, %rdi
nop
nop
nop
xor $9, %r10
...
// REPMOV
lea addresses_PSE+0x2415, %rsi
lea addresses_normal+0x17f09, %rdi
xor $52053, %r14
mov $117, %rcx
rep movsw
inc %r8
...
// Store
lea addresses_normal+0x7349, %rdi
nop
nop
nop
xor $8265, %r12
...
{'OP': 'REPM', 'src': {'type': 'addresses_PSE', 'congruent': 1, 'same': False}, 'dst': {'type': 'addresses_normal', 'congruent': 10, 'same': False}}
{'OP': 'STOR', 'dst': {'type': 'addresses_normal', 'AVXalign': False, 'congruent': 4, 'size': 32, 'same': False, 'NT': False}}
{'OP': 'LOAD', 'src': {'type': 'addresses_A', 'AVXalign': False, 'congruent': 8, 'size': 2, 'same': False, 'NT': True}}
...
{'OP': 'REPM', 'src': {'type': 'addresses_normal_ht', 'congruent': 5, 'same': False}, 'dst': {'type': 'addresses_normal_ht', 'congruent': 6, 'same': True}}
