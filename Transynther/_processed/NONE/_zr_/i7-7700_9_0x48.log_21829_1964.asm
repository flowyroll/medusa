...
nop
cmp $15375, %r10
lea addresses_normal_ht+0x18cc8, %rbp
nop
nop
nop
nop
...
nop
cmp %r12, %r12
lea addresses_WT_ht+0x155bc, %r12
nop
nop
nop
nop
...
nop
and $3486, %rsi
lea addresses_UC_ht+0x360c, %r12
nop
dec %rbx
mov $0x6162636465666768, %rsi
movq %rsi, %xmm2
...
nop
cmp %r10, %r10
lea addresses_WC_ht+0x13c0c, %rdi
nop
inc %rsi
movb (%rdi), %r12b
nop
...
nop
dec %r10
lea addresses_WC_ht+0xb20c, %r8
nop
xor %rdi, %rdi
movb (%r8), %r10b
nop
sub $22845, %rbp
lea addresses_UC_ht+0x189ec, %rbp
nop
nop
nop
nop
...
nop
cmp $65260, %r12
lea addresses_normal_ht+0x1b4cc, %rsi
lea addresses_A_ht+0x1760c, %rdi
nop
nop
add $5663, %r12
mov $23, %rcx
...
nop
cmp $8549, %rbp
lea addresses_normal_ht+0x1680c, %rbp
clflush (%rbp)
add $26407, %r10
mov (%rbp), %r12
nop
...
{'OP': 'LOAD', 'src': {'type': 'addresses_normal_ht', 'AVXalign': False, 'congruent': 2, 'size': 32, 'same': True, 'NT': False}}
