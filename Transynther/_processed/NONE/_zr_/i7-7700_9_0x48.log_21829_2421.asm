...
push %rdx
push %rsi
lea addresses_WT_ht+0xe89f, %r11
nop
nop
nop
inc %r12
...
nop
and %rdx, %rdx
lea addresses_D_ht+0xcd0f, %rsi
lea addresses_WC_ht+0x17c9f, %rdi
nop
nop
add %r14, %r14
mov $114, %rcx
...
nop
add $721, %rdx
lea addresses_UC_ht+0x16d03, %rdx
nop
nop
nop
nop
...
nop
add %rdi, %rdi
lea addresses_D_ht+0x1c761, %rsi
lea addresses_normal_ht+0x13333, %rdi
inc %rdx
mov $48, %rcx
rep movsq
add %rdx, %rdx
lea addresses_D_ht+0xac9f, %r12
nop
and $37203, %rcx
mov (%r12), %r14
nop
nop
and %r11, %r11
lea addresses_D_ht+0x67af, %rsi
lea addresses_D_ht+0x819f, %rdi
nop
and $64233, %rdx
mov $27, %rcx
rep movsw
...
nop
inc %r8
lea addresses_WC_ht+0x1bd5f, %r11
nop
nop
cmp %rdx, %rdx
mov (%r11), %cx
...
nop
cmp %r12, %r12
lea addresses_A_ht+0x1769f, %r12
nop
nop
nop
nop
...
nop
xor $39433, %r8
lea addresses_normal_ht+0x1ea13, %rdx
nop
nop
add %r11, %r11
mov $0x6162636465666768, %r8
...
nop
cmp $13559, %r8
lea addresses_UC_ht+0x1b91f, %rsi
lea addresses_WT_ht+0x8e9f, %rdi
nop
nop
nop
nop
...
rep movsl
xor $55719, %r11
lea addresses_normal_ht+0x1369f, %rdx
nop
nop
add $3023, %rdi
mov (%rdx), %r14d
xor %rdi, %rdi
lea addresses_normal_ht+0x1809f, %rcx
nop
nop
nop
add $21277, %r11
...
<gen_prepare_buffer>
{'OP': 'STOR', 'dst': {'type': 'addresses_WT_ht', 'AVXalign': True, 'congruent': 10, 'size': 32, 'same': False, 'NT': False}}
{'OP': 'REPM', 'src': {'type': 'addresses_D_ht', 'congruent': 4, 'same': False}, 'dst': {'type': 'addresses_WC_ht', 'congruent': 11, 'same': False}}
{'OP': 'STOR', 'dst': {'type': 'addresses_UC_ht', 'AVXalign': False, 'congruent': 5, 'size': 32, 'same': True, 'NT': False}}
