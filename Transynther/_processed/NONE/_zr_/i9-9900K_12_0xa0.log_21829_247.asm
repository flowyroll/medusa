...
push %rdx
push %rsi
lea addresses_normal_ht+0xf191, %rsi
lea addresses_normal_ht+0x10731, %rdi
nop
nop
xor %rax, %rax
mov $58, %rcx
...
nop
inc %rax
lea addresses_A_ht+0x7c11, %rsi
lea addresses_D_ht+0x1ad15, %rdi
nop
nop
nop
nop
...
nop
and %rdx, %rdx
lea addresses_WC_ht+0x8519, %rbp
nop
nop
nop
xor $31675, %r13
...
nop
cmp %rbp, %rbp
lea addresses_normal_ht+0x11211, %rbp
nop
nop
nop
nop
...
nop
and %rax, %rax
lea addresses_UC_ht+0x1d211, %rsi
lea addresses_WT_ht+0xe151, %rdi
nop
nop
add $11755, %r10
mov $119, %rcx
...
nop
inc %rdx
lea addresses_UC_ht+0x5811, %rdx
nop
nop
nop
nop
...
nop
add %r13, %r13
lea addresses_UC_ht+0xc211, %rcx
nop
add $22465, %rax
movw $0x6162, (%rcx)
nop
...
{'src': {'same': False, 'congruent': 9, 'type': 'addresses_A_ht'}, 'OP': 'REPM', 'dst': {'same': False, 'congruent': 2, 'type': 'addresses_D_ht'}}
...
{'OP': 'STOR', 'dst': {'NT': False, 'same': True, 'congruent': 8, 'type': 'addresses_WC_ht', 'AVXalign': False, 'size': 1}}
{'00': 21829}
