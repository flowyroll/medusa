...
push %rdi
push %rsi
lea addresses_normal_ht+0x2991, %rax
clflush (%rax)
nop
nop
xor %rbp, %rbp
...
rep movsq
dec %rax
lea addresses_WT_ht+0x1034f, %rax
clflush (%rax)
nop
nop
nop
...
nop
xor %rdi, %rdi
lea addresses_WC_ht+0x18787, %rsi
lea addresses_normal_ht+0x7e4f, %rdi
clflush (%rdi)
nop
nop
add $29053, %rbx
...
nop
add %rbx, %rbx
lea addresses_WC_ht+0xea7f, %rax
nop
nop
nop
dec %rbp
...
nop
and $46255, %rax
lea addresses_normal_ht+0x1e8f, %rsi
lea addresses_UC_ht+0x10f1f, %rdi
clflush (%rsi)
add %rax, %rax
mov $87, %rcx
rep movsl
...
<gen_prepare_buffer>
{'OP': 'LOAD', 'src': {'type': 'addresses_normal_ht', 'AVXalign': True, 'congruent': 1, 'size': 1, 'same': True, 'NT': False}}
