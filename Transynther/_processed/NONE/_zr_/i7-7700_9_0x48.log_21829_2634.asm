...
nop
dec %rdi
lea addresses_D_ht+0x1b96c, %rsi
nop
nop
nop
nop
...
nop
sub %r14, %r14
lea addresses_WC_ht+0x1a6ec, %rsi
nop
nop
nop
nop
...
nop
sub $42508, %rdi
lea addresses_normal_ht+0x1d9cb, %rsi
lea addresses_normal_ht+0x58fa, %rdi
nop
nop
nop
xor %r9, %r9
...
nop
cmp %r9, %r9
lea addresses_normal_ht+0x5afc, %r12
cmp %r14, %r14
mov (%r12), %di
nop
nop
...
{'OP': 'LOAD', 'src': {'type': 'addresses_A', 'AVXalign': False, 'congruent': 4, 'size': 8, 'same': False, 'NT': False}}
...
{'OP': 'LOAD', 'src': {'type': 'addresses_normal_ht', 'AVXalign': False, 'congruent': 0, 'size': 2, 'same': False, 'NT': True}}
{'00': 21829}
