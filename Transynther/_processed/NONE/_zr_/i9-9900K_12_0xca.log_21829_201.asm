...
push %rdi
push %rsi
lea addresses_A_ht+0x7990, %rsi
lea addresses_UC_ht+0x1bd94, %rdi
nop
nop
nop
nop
...
rep movsl
and %rbp, %rbp
lea addresses_normal_ht+0x120f0, %rsi
lea addresses_normal_ht+0x12390, %rdi
nop
nop
nop
dec %r12
...
nop
xor %rcx, %rcx
lea addresses_WT_ht+0xa4d0, %rbp
nop
inc %r12
movups (%rbp), %xmm1
vpextrq $1, %xmm1, %rdi
...
lea addresses_UC_ht+0x12258, %rdi
dec %r14
mov $121, %rcx
rep movsw
nop
...
nop
sub %rdi, %rdi
lea addresses_WT_ht+0x11f90, %r12
nop
nop
nop
and %rbp, %rbp
...
nop
cmp %rcx, %rcx
lea addresses_normal_ht+0x18826, %r12
sub %rdi, %rdi
movb $0x61, (%r12)
nop
nop
...
nop
cmp %rcx, %rcx
lea addresses_WT_ht+0x1e390, %r14
nop
nop
nop
nop
...
nop
add $2836, %rcx
lea addresses_normal_ht+0xf90, %r14
nop
xor $28868, %rbp
mov (%r14), %r12w
nop
...
<gen_prepare_buffer>
{'OP': 'REPM', 'src': {'same': True, 'type': 'addresses_A_ht', 'congruent': 8}, 'dst': {'same': False, 'type': 'addresses_UC_ht', 'congruent': 2}}
{'OP': 'REPM', 'src': {'same': False, 'type': 'addresses_normal_ht', 'congruent': 5}, 'dst': {'same': False, 'type': 'addresses_normal_ht', 'congruent': 10}}
{'OP': 'STOR', 'dst': {'size': 1, 'NT': False, 'type': 'addresses_UC_ht', 'same': False, 'AVXalign': False, 'congruent': 11}}
{'OP': 'LOAD', 'src': {'size': 16, 'NT': False, 'type': 'addresses_WT_ht', 'same': True, 'AVXalign': False, 'congruent': 6}}
