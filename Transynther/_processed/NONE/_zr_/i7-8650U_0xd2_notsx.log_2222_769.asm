...
push %rbp
push %rdi
lea addresses_UC_ht+0x12be4, %r12
nop
nop
nop
nop
...
nop
and $33297, %r15
lea addresses_WC_ht+0xe5e4, %r14
nop
nop
nop
and %r8, %r8
...
nop
dec %r12
lea addresses_UC_ht+0x16064, %rdi
nop
nop
nop
nop
...
nop
sub $61080, %r14
lea addresses_WC_ht+0x330f, %rbp
nop
nop
nop
nop
...
nop
xor %rbp, %rbp
lea addresses_A_ht+0xc3e4, %r8
dec %r13
movl $0x61626364, (%r8)
nop
nop
add %r15, %r15
lea addresses_WC_ht+0x12538, %r13
nop
nop
nop
nop
...
<gen_faulty_load>
[REF]
{'OP': 'LOAD', 'src': {'type': 'addresses_RW', 'size': 2, 'AVXalign': True, 'NT': True, 'congruent': 0, 'same': True}}
