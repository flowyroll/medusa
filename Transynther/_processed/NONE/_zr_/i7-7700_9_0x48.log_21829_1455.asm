...
push %rdx
push %rsi
lea addresses_WT_ht+0x1ae86, %rbp
nop
nop
nop
and $46508, %r14
...
nop
inc %rax
lea addresses_D_ht+0x4da6, %rdx
and %rax, %rax
mov $0x6162636465666768, %r12
movq %r12, (%rdx)
nop
cmp %rdx, %rdx
lea addresses_WT_ht+0xfa86, %r15
nop
nop
nop
nop
...
nop
add $34690, %rax
lea addresses_normal_ht+0x14886, %r12
clflush (%r12)
nop
nop
xor $15636, %rsi
...
vpextrq $1, %xmm6, %r14
and $6799, %rbp
lea addresses_WC_ht+0x8e86, %r12
nop
inc %rdx
mov (%r12), %r15w
nop
nop
add %rax, %rax
lea addresses_normal_ht+0x10d26, %rsi
lea addresses_D_ht+0x1bc36, %rdi
clflush (%rsi)
nop
nop
nop
...
{'OP': 'LOAD', 'src': {'type': 'addresses_WC_ht', 'AVXalign': True, 'congruent': 11, 'size': 2, 'same': False, 'NT': True}}
