...
push %rdi
push %rsi
lea addresses_A_ht+0x1493a, %rsi
lea addresses_UC_ht+0xe706, %rdi
nop
nop
nop
xor $50298, %r10
...
nop
add %rbx, %rbx
lea addresses_WC_ht+0x12086, %rsi
lea addresses_UC_ht+0x11386, %rdi
nop
nop
nop
nop
...
nop
xor $4821, %r10
lea addresses_WC_ht+0x17786, %rsi
lea addresses_UC_ht+0xc430, %rdi
nop
nop
nop
sub $42214, %r11
...
nop
cmp %rdi, %rdi
lea addresses_D_ht+0x16206, %rsi
lea addresses_UC_ht+0x2d86, %rdi
nop
nop
nop
nop
...
rep movsl
cmp $21034, %rsi
lea addresses_WT_ht+0x5076, %rdi
sub %r10, %r10
movb (%rdi), %al
nop
nop
dec %rsi
lea addresses_A_ht+0x17005, %rsi
lea addresses_A_ht+0x15216, %rdi
nop
cmp $716, %r11
mov $25, %rcx
rep movsq
nop
dec %rax
lea addresses_UC_ht+0x5f96, %rcx
nop
nop
nop
nop
...
nop
and %r10, %r10
lea addresses_WC_ht+0x182ca, %r11
add %rbx, %rbx
...
nop
dec %rbx
lea addresses_UC_ht+0x5e86, %rax
nop
nop
nop
nop
...
nop
dec %rbx
lea addresses_WT_ht+0x14ee6, %rsi
lea addresses_WC_ht+0x2786, %rdi
nop
sub %r12, %r12
mov $4, %rcx
rep movsw
...
nop
sub %rsi, %rsi
lea addresses_normal_ht+0x3776, %rbx
nop
nop
nop
nop
...
{'src': {'congruent': 8, 'same': True, 'type': 'addresses_WC_ht'}, 'OP': 'REPM', 'dst': {'congruent': 10, 'same': False, 'type': 'addresses_UC_ht'}}
{'src': {'congruent': 5, 'same': False, 'type': 'addresses_WC_ht'}, 'OP': 'REPM', 'dst': {'congruent': 1, 'same': False, 'type': 'addresses_UC_ht'}}
{'src': {'congruent': 3, 'same': False, 'type': 'addresses_D_ht'}, 'OP': 'REPM', 'dst': {'congruent': 8, 'same': False, 'type': 'addresses_UC_ht'}}
{'src': {'congruent': 4, 'AVXalign': False, 'same': False, 'size': 1, 'NT': False, 'type': 'addresses_WT_ht'}, 'OP': 'LOAD'}
{'src': {'congruent': 0, 'same': False, 'type': 'addresses_A_ht'}, 'OP': 'REPM', 'dst': {'congruent': 4, 'same': False, 'type': 'addresses_A_ht'}}
