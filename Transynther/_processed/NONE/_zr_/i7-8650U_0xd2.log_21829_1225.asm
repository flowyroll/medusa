...
nop
sub %rdi, %rdi
lea addresses_normal_ht+0x129db, %rsi
lea addresses_WT_ht+0x12913, %rdi
clflush (%rdi)
nop
nop
nop
...
rep movsw
sub %rax, %rax
lea addresses_WT_ht+0xadab, %rbp
nop
inc %r12
movl $0x61626364, (%rbp)
nop
...
nop
dec %rax
lea addresses_UC_ht+0xae73, %r12
nop
nop
inc %rsi
...
nop
cmp %rsi, %rsi
lea addresses_WT_ht+0xb713, %rsi
lea addresses_A_ht+0x7513, %rdi
xor $40034, %rax
mov $45, %rcx
rep movsb
nop
...
nop
sub $21423, %rsi
lea addresses_A_ht+0x13b53, %rsi
lea addresses_A_ht+0x13553, %rdi
nop
nop
nop
nop
...
nop
sub %rcx, %rcx
lea addresses_A_ht+0xe0b3, %rsi
lea addresses_D_ht+0x19830, %rdi
nop
nop
nop
nop
...
{'OP': 'LOAD', 'src': {'type': 'addresses_US', 'size': 16, 'AVXalign': False, 'NT': False, 'congruent': 4, 'same': False}}
...
<gen_prepare_buffer>
{'OP': 'REPM', 'src': {'type': 'addresses_normal_ht', 'congruent': 4, 'same': False}, 'dst': {'type': 'addresses_UC_ht', 'congruent': 9, 'same': False}}
...
{'OP': 'STOR', 'dst': {'type': 'addresses_UC_ht', 'size': 8, 'AVXalign': True, 'NT': False, 'congruent': 5, 'same': False}}
{'OP': 'REPM', 'src': {'type': 'addresses_WT_ht', 'congruent': 10, 'same': False}, 'dst': {'type': 'addresses_A_ht', 'congruent': 8, 'same': False}}
{'OP': 'REPM', 'src': {'type': 'addresses_A_ht', 'congruent': 5, 'same': False}, 'dst': {'type': 'addresses_A_ht', 'congruent': 4, 'same': False}}
