...
push %rdx
push %rsi
lea addresses_UC_ht+0x12ec3, %rdi
inc %rcx
mov (%rdi), %r9
nop
nop
nop
cmp $42798, %rcx
lea addresses_WC_ht+0x7033, %r14
and $37820, %rsi
...
nop
add %rcx, %rcx
lea addresses_UC_ht+0x1aca3, %rbp
cmp $58615, %rdx
mov (%rbp), %di
nop
dec %rsi
lea addresses_D_ht+0xea73, %rdx
nop
nop
and %rsi, %rsi
movups (%rdx), %xmm7
...
nop
and $2556, %r14
lea addresses_WC_ht+0x6793, %rbp
nop
nop
nop
nop
...
nop
add %rcx, %rcx
lea addresses_normal_ht+0x6033, %r14
clflush (%r14)
add %rcx, %rcx
movups (%r14), %xmm5
vpextrq $0, %xmm5, %rdx
nop
cmp %r14, %r14
lea addresses_WT_ht+0x510b, %rsi
lea addresses_UC_ht+0x14833, %rdi
nop
add $2396, %rax
mov $41, %rcx
rep movsl
and %rcx, %rcx
lea addresses_normal_ht+0x14833, %rax
nop
nop
nop
nop
...
nop
add %rcx, %rcx
lea addresses_A_ht+0xdc33, %rsi
lea addresses_normal_ht+0x15013, %rdi
nop
nop
nop
lfence
...
rep movsq
xor $25007, %rax
lea addresses_WC_ht+0xc637, %rsi
lea addresses_UC_ht+0x9433, %rdi
add %rdx, %rdx
mov $25, %rcx
rep movsw
inc %rdx
lea addresses_WT_ht+0x6d15, %rcx
nop
nop
nop
nop
...
nop
sub %rcx, %rcx
lea addresses_A_ht+0x10233, %rdx
nop
nop
sub $21968, %rcx
mov (%rdx), %di
...
{'OP': 'STOR', 'dst': {'size': 1, 'NT': False, 'type': 'addresses_D', 'same': False, 'AVXalign': False, 'congruent': 5}}
[Faulty Load]
...
{'OP': 'REPM', 'src': {'same': False, 'type': 'addresses_WT_ht', 'congruent': 3}, 'dst': {'same': False, 'type': 'addresses_UC_ht', 'congruent': 9}}
...
{'OP': 'REPM', 'src': {'same': False, 'type': 'addresses_WC_ht', 'congruent': 2}, 'dst': {'same': False, 'type': 'addresses_UC_ht', 'congruent': 8}}
