...
nop
add %r15, %r15
lea addresses_WC_ht+0x6ac2, %rsi
lea addresses_A_ht+0xd6c2, %rdi
nop
sub $13892, %rbx
mov $63, %rcx
rep movsw
...
nop
xor %r10, %r10
lea addresses_WT_ht+0x176c2, %r10
nop
nop
nop
nop
...
movl $0x61626364, (%r10)
cmp %rbx, %rbx
lea addresses_WC_ht+0xbd92, %rdi
clflush (%rdi)
nop
nop
inc %r15
...
{'OP': 'STOR', 'dst': {'size': 8, 'NT': True, 'type': 'addresses_WC', 'same': False, 'AVXalign': False, 'congruent': 3}}
{'OP': 'LOAD', 'src': {'size': 2, 'NT': False, 'type': 'addresses_US', 'same': False, 'AVXalign': False, 'congruent': 7}}
