...
push %rdx
push %rsi
lea addresses_WT_ht+0x15dd5, %r15
nop
nop
nop
inc %rcx
...
nop
xor $62986, %rdx
lea addresses_A_ht+0x1873d, %rsi
lea addresses_WT_ht+0x2da5, %rdi
clflush (%rsi)
nop
inc %rdx
mov $3, %rcx
...
nop
dec %rcx
lea addresses_UC_ht+0x18cf5, %rsi
lea addresses_A_ht+0x9a99, %rdi
nop
nop
nop
cmp %rax, %rax
...
rep movsq
xor %rdx, %rdx
lea addresses_normal_ht+0xdd3d, %rsi
lea addresses_normal_ht+0x140b5, %rdi
nop
nop
inc %rbp
mov $56, %rcx
...
nop
sub $11041, %rax
lea addresses_WT_ht+0x1d355, %rdi
cmp $3307, %r9
...
nop
cmp $31142, %rcx
lea addresses_WT_ht+0x1cdcd, %rsi
lea addresses_A_ht+0x1cc99, %rdi
cmp $42954, %r9
mov $23, %rcx
rep movsl
nop
and %r9, %r9
lea addresses_A_ht+0x248d, %rsi
lea addresses_UC_ht+0x1e5f5, %rdi
clflush (%rdi)
nop
nop
nop
...
// Store
lea addresses_normal+0x9df5, %r12
clflush (%r12)
sub %r13, %r13
movw $0x5152, (%r12)
nop
...
{'src': {'congruent': 3, 'same': False, 'type': 'addresses_A_ht'}, 'OP': 'REPM', 'dst': {'congruent': 4, 'same': False, 'type': 'addresses_WT_ht'}}
{'src': {'congruent': 6, 'same': False, 'type': 'addresses_UC_ht'}, 'OP': 'REPM', 'dst': {'congruent': 2, 'same': True, 'type': 'addresses_A_ht'}}
