...
lea addresses_WC_ht+0x14a59, %rdi
nop
nop
and %r14, %r14
mov $64, %rcx
...
nop
add %rax, %rax
lea addresses_normal_ht+0x156c9, %rsi
lea addresses_A_ht+0x140c9, %rdi
add %r11, %r11
mov $62, %rcx
rep movsb
nop
sub %rcx, %rcx
lea addresses_WC_ht+0x1c499, %rsi
lea addresses_A_ht+0x16859, %rdi
nop
nop
nop
nop
...
rep movsl
cmp $15525, %rax
lea addresses_normal_ht+0x1b4c9, %r15
dec %rdi
vmovups (%r15), %ymm6
...
nop
xor $14732, %r11
lea addresses_D_ht+0x17065, %rbp
cmp $38438, %rax
movb $0x61, (%rbp)
nop
nop
sub %r15, %r15
lea addresses_WT_ht+0x15f49, %rsi
lea addresses_A_ht+0x38e9, %rdi
nop
nop
add %rax, %rax
mov $71, %rcx
...
{'OP': 'REPM', 'src': {'type': 'addresses_normal_ht', 'congruent': 9, 'same': False}, 'dst': {'type': 'addresses_A_ht', 'congruent': 11, 'same': True}}
...
{'OP': 'REPM', 'src': {'type': 'addresses_WT_ht', 'congruent': 4, 'same': False}, 'dst': {'type': 'addresses_A_ht', 'congruent': 3, 'same': False}}
{'00': 15343}
