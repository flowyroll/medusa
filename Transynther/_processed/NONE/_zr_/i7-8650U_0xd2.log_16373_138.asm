...
push %rdi
push %rsi
lea addresses_WC_ht+0x2d46, %r15
nop
nop
nop
nop
...
nop
cmp %r9, %r9
lea addresses_A_ht+0x107fe, %r15
nop
nop
nop
nop
...
nop
inc %rax
lea addresses_UC_ht+0x4946, %rcx
nop
nop
nop
nop
...
nop
inc %rdi
lea addresses_A_ht+0x18146, %rsi
lea addresses_WC_ht+0x8846, %rdi
nop
nop
nop
dec %r11
...
nop
inc %rsi
lea addresses_A_ht+0x8946, %rsi
lea addresses_A_ht+0x1e53e, %rdi
xor %r11, %r11
mov $60, %rcx
rep movsw
nop
dec %rsi
lea addresses_normal_ht+0x1e346, %r9
nop
nop
nop
nop
...
nop
add %r15, %r15
lea addresses_normal_ht+0x14d46, %rax
nop
nop
nop
nop
...
<gen_prepare_buffer>
{'OP': 'LOAD', 'src': {'type': 'addresses_WC_ht', 'size': 4, 'AVXalign': False, 'NT': True, 'congruent': 9, 'same': True}}
