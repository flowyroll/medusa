...
push %rdx
push %rsi
lea addresses_WC_ht+0x13123, %rdx
clflush (%rdx)
nop
sub %r14, %r14
movw $0x6162, (%rdx)
...
nop
cmp %rdi, %rdi
lea addresses_WC_ht+0x11b53, %rsi
lea addresses_A_ht+0x1f13, %rdi
nop
nop
nop
nop
...
nop
dec %rdi
lea addresses_UC_ht+0x1a013, %rdi
nop
nop
nop
xor $2622, %r14
...
nop
xor $17552, %rcx
lea addresses_WT_ht+0x189d5, %rsi
nop
nop
nop
nop
...
nop
sub $62420, %r10
lea addresses_normal_ht+0x11c9a, %rdi
nop
nop
nop
add $53422, %rcx
...
// REPMOV
lea addresses_US+0x18793, %rsi
lea addresses_normal+0x1b213, %rdi
add %rbx, %rbx
mov $4, %rcx
rep movsl
sub %rbx, %rbx
...
{'OP': 'REPM', 'src': {'type': 'addresses_US', 'congruent': 4, 'same': False}, 'dst': {'type': 'addresses_normal', 'congruent': 10, 'same': False}}
[Faulty Load]
