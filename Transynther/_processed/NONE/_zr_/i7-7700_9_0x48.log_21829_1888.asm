...
nop
add $64085, %r13
lea addresses_normal_ht+0x10f37, %rsi
lea addresses_normal_ht+0x12117, %rdi
nop
nop
cmp %r11, %r11
mov $59, %rcx
...
nop
sub $43078, %r13
lea addresses_WT_ht+0x33b7, %rbp
nop
nop
nop
cmp $14208, %rbx
...
nop
xor $45539, %rdi
lea addresses_A_ht+0x10e37, %rsi
lea addresses_A_ht+0x9af7, %rdi
nop
nop
nop
cmp $35980, %r13
...
nop
xor $7380, %r11
lea addresses_WC_ht+0xcf17, %rbx
nop
nop
cmp $41008, %r13
...
movq %r15, (%rbx)
xor $3946, %rdi
lea addresses_UC_ht+0x1e02b, %r11
nop
nop
nop
nop
...
nop
inc %r11
lea addresses_normal_ht+0x18d8d, %r15
and %rdi, %rdi
...
nop
xor %r15, %r15
lea addresses_UC_ht+0xbe77, %rdi
nop
nop
nop
nop
...
nop
cmp $20080, %rbp
lea addresses_D_ht+0x191b7, %rbx
inc %rbp
movups (%rbx), %xmm0
vpextrq $1, %xmm0, %r13
nop
...
nop
sub $13023, %rcx
lea addresses_UC_ht+0x155b7, %rbp
nop
nop
dec %r15
mov (%rbp), %r13
...
nop
sub $4625, %r11
lea addresses_WT_ht+0x6737, %rsi
lea addresses_normal_ht+0x59b7, %rdi
nop
nop
nop
nop
...
{'OP': 'REPM', 'src': {'type': 'addresses_normal_ht', 'congruent': 7, 'same': False}, 'dst': {'type': 'addresses_normal_ht', 'congruent': 0, 'same': False}}
