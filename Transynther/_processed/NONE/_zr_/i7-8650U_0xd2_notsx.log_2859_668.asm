...
push %rdi
push %rsi
lea addresses_WT_ht+0x18ea2, %rsi
lea addresses_A_ht+0x2d42, %rdi
clflush (%rsi)
nop
nop
nop
...
nop
xor %r15, %r15
lea addresses_UC_ht+0x3f02, %rsi
lea addresses_WC_ht+0xf502, %rdi
nop
nop
nop
nop
...
rep movsw
sub %rcx, %rcx
lea addresses_WC_ht+0x13cc2, %rdi
nop
nop
xor %rbp, %rbp
movl $0x61626364, (%rdi)
nop
dec %rcx
lea addresses_WT_ht+0x18c02, %r15
xor $37591, %rdi
...
nop
cmp $8771, %rsi
lea addresses_normal_ht+0x1e00a, %rcx
clflush (%rcx)
nop
nop
nop
...
nop
dec %rbp
lea addresses_WC_ht+0x14502, %rsi
nop
nop
nop
xor $32744, %rbx
...
// Store
lea addresses_normal+0x12c82, %r12
nop
nop
xor $11515, %rdi
...
// Store
lea addresses_normal+0xa102, %r8
nop
mfence
movb $0x51, (%r8)
...
{'OP': 'STOR', 'dst': {'type': 'addresses_A', 'size': 8, 'AVXalign': False, 'NT': False, 'congruent': 4, 'same': True}}
...
{'OP': 'STOR', 'dst': {'type': 'addresses_D', 'size': 4, 'AVXalign': False, 'NT': True, 'congruent': 10, 'same': False}}
{'OP': 'STOR', 'dst': {'type': 'addresses_A', 'size': 4, 'AVXalign': True, 'NT': True, 'congruent': 0, 'same': False}}
[Faulty Load]
{'OP': 'LOAD', 'src': {'type': 'addresses_A', 'size': 4, 'AVXalign': False, 'NT': False, 'congruent': 0, 'same': True}}
<gen_prepare_buffer>
{'OP': 'REPM', 'src': {'type': 'addresses_WT_ht', 'congruent': 5, 'same': False}, 'dst': {'type': 'addresses_A_ht', 'congruent': 5, 'same': False}}
