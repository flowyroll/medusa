...
push %rdx
push %rsi
lea addresses_WC_ht+0x3070, %r9
cmp $51939, %rbx
mov (%r9), %r15d
nop
nop
xor $44216, %rdx
lea addresses_normal_ht+0xd45a, %r9
nop
nop
inc %r14
vmovups (%r9), %ymm6
...
vmovups %ymm0, (%rdi)
cmp %rdi, %rdi
lea addresses_WC_ht+0x1600a, %rsi
xor %rdx, %rdx
movups (%rsi), %xmm7
vpextrq $1, %xmm7, %rdi
nop
...
nop
xor $10428, %r14
lea addresses_A_ht+0x1bfcf, %rsi
lea addresses_normal_ht+0x1001a, %rdi
inc %r14
mov $87, %rcx
rep movsw
nop
...
nop
dec %rsi
lea addresses_WT_ht+0x10282, %r14
dec %r9
vmovups (%r14), %ymm5
...
{'OP': 'REPM', 'src': {'same': False, 'type': 'addresses_A_ht', 'congruent': 10}, 'dst': {'same': False, 'type': 'addresses_normal_ht', 'congruent': 9}}
...
{'OP': 'REPM', 'src': {'same': False, 'type': 'addresses_A_ht', 'congruent': 0}, 'dst': {'same': True, 'type': 'addresses_normal_ht', 'congruent': 9}}
