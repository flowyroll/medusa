...
nop
and %rcx, %rcx
lea addresses_WC_ht+0xc513, %rcx
cmp $34999, %rdx
mov (%rcx), %r14
inc %r14
lea addresses_WC_ht+0x194b3, %r10
nop
nop
and $38637, %r13
movb (%r10), %dl
nop
add %rsi, %rsi
lea addresses_WC_ht+0x15ce5, %rsi
lea addresses_UC_ht+0xc513, %rdi
nop
nop
nop
inc %rbx
...
nop
and %rdi, %rdi
lea addresses_UC_ht+0x6f67, %rsi
...
nop
xor $20598, %rdi
lea addresses_WC_ht+0x41e3, %rsi
lea addresses_D_ht+0x1bdd3, %rdi
nop
nop
nop
sub $47308, %r10
...
nop
sub %r10, %r10
lea addresses_WT_ht+0x6ed3, %rsi
nop
nop
nop
nop
...
nop
add %rbx, %rbx
lea addresses_normal_ht+0xe9f3, %rsi
lea addresses_UC_ht+0x17943, %rdi
clflush (%rsi)
nop
nop
dec %r13
...
nop
and %rsi, %rsi
lea addresses_WT_ht+0x11a13, %rsi
nop
nop
sub $64792, %rdx
movw $0x6162, (%rsi)
...
vmovaps %ymm4, (%r14)
sub %rdx, %rdx
lea addresses_WC_ht+0xa703, %rsi
lea addresses_D_ht+0xa13, %rdi
nop
cmp %r13, %r13
mov $115, %rcx
rep movsb
nop
add %rdx, %rdx
lea addresses_UC_ht+0xb613, %rcx
nop
nop
nop
dec %rbx
...
{'OP': 'LOAD', 'src': {'type': 'addresses_UC_ht', 'size': 4, 'AVXalign': True, 'NT': False, 'congruent': 8, 'same': False}}
{'00': 16652}
