...
push %rdi
push %rsi
lea addresses_normal_ht+0xea37, %rsi
lea addresses_normal_ht+0x1637, %rdi
nop
nop
nop
nop
...
nop
xor $6827, %rdi
lea addresses_WC_ht+0x88c7, %rsi
lea addresses_WT_ht+0x11237, %rdi
cmp %r10, %r10
mov $111, %rcx
rep movsq
cmp %rcx, %rcx
lea addresses_A_ht+0x18237, %rbp
nop
nop
cmp $60128, %rax
mov (%rbp), %r10d
sub %rbp, %rbp
lea addresses_WT_ht+0xba37, %r10
nop
nop
nop
and %rcx, %rcx
...
// Store
lea addresses_normal+0x12237, %r10
nop
nop
nop
cmp %rdi, %rdi
