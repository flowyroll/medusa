...
push %rdx
push %rsi
lea addresses_WC_ht+0x632b, %rbp
nop
nop
nop
xor %rdx, %rdx
...
nop
add $24164, %r8
lea addresses_WT_ht+0x13d2b, %r9
nop
nop
nop
inc %r11
...
nop
cmp $24942, %r9
lea addresses_UC_ht+0x1d8c3, %rsi
lea addresses_WT_ht+0x1b37f, %rdi
clflush (%rdi)
nop
nop
nop
...
nop
sub %rbp, %rbp
lea addresses_UC_ht+0x14e3b, %rsi
lea addresses_D_ht+0x19b97, %rdi
nop
nop
nop
cmp %r9, %r9
...
nop
inc %r8
lea addresses_normal_ht+0x11afb, %rsi
lea addresses_WC_ht+0x1f97, %rdi
nop
nop
cmp $60603, %r8
mov $43, %rcx
rep movsq
add %rbp, %rbp
lea addresses_normal_ht+0xa2eb, %rdi
nop
nop
nop
nop
...
mov (%rdi), %r14
sub $26176, %r14
lea addresses_D_ht+0x1bf5f, %rsi
lea addresses_UC_ht+0x1eb2b, %rdi
nop
nop
nop
nop
...
<gen_prepare_buffer>
{'OP': 'LOAD', 'src': {'type': 'addresses_WC_ht', 'AVXalign': False, 'congruent': 9, 'size': 8, 'same': False, 'NT': True}}
...
{'OP': 'REPM', 'src': {'type': 'addresses_UC_ht', 'congruent': 4, 'same': True}, 'dst': {'type': 'addresses_D_ht', 'congruent': 2, 'same': False}}
