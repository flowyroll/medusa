...
push %rdi
push %rsi
lea addresses_WC_ht+0x48fc, %rdi
clflush (%rdi)
nop
nop
nop
...
nop
inc %r12
lea addresses_A_ht+0x18a84, %rax
nop
and %rsi, %rsi
...
nop
and $11700, %rsi
lea addresses_normal_ht+0x3884, %rsi
lea addresses_D_ht+0x18364, %rdi
nop
nop
nop
nop
...
nop
inc %rax
lea addresses_A_ht+0x1eea4, %rsi
...
nop
sub $56769, %r12
lea addresses_WC_ht+0x1201, %rsi
lea addresses_A_ht+0x2544, %rdi
nop
nop
nop
nop
...
nop
add %r12, %r12
lea addresses_WT_ht+0xbbec, %rdi
nop
and $57752, %r9
movb (%rdi), %r8b
nop
...
// Load
lea addresses_normal+0x309c, %r10
nop
nop
nop
nop
...
{'OP': 'REPM', 'src': {'type': 'addresses_WC_ht', 'congruent': 0, 'same': False}, 'dst': {'type': 'addresses_A_ht', 'congruent': 8, 'same': True}}
