...
push %rdi
push %rsi
lea addresses_WT_ht+0xbdf8, %r11
dec %rcx
movl $0x61626364, (%r11)
xor $58154, %rbx
lea addresses_D_ht+0x9e9c, %rsi
lea addresses_normal_ht+0x126f8, %rdi
lfence
mov $3, %rcx
rep movsb
nop
...
nop
and %r9, %r9
lea addresses_UC_ht+0x5cb0, %rsi
lea addresses_UC_ht+0xf378, %rdi
clflush (%rsi)
nop
nop
nop
...
nop
dec %r9
lea addresses_WC_ht+0x79f8, %rdi
nop
nop
nop
nop
...
nop
and %r8, %r8
lea addresses_UC_ht+0xe598, %rsi
lea addresses_WT_ht+0x395d, %rdi
and %r11, %r11
mov $55, %rcx
rep movsb
nop
nop
cmp $9807, %rdi
lea addresses_UC_ht+0x69f8, %rbx
nop
xor $59051, %rsi
movl $0x61626364, (%rbx)
nop
...
nop
cmp $24080, %r9
lea addresses_WC_ht+0x143a1, %rsi
and %r11, %r11
mov (%rsi), %edi
xor $10516, %rsi
lea addresses_WC_ht+0x131f8, %r11
clflush (%r11)
nop
nop
nop
...
nop
xor %r8, %r8
lea addresses_A_ht+0xc7b8, %rsi
lea addresses_WT_ht+0x13ab8, %rdi
nop
nop
xor %r12, %r12
mov $53, %rcx
...
{'OP': 'REPM', 'src': {'type': 'addresses_UC_ht', 'congruent': 3, 'same': False}, 'dst': {'type': 'addresses_UC_ht', 'congruent': 7, 'same': True}}
