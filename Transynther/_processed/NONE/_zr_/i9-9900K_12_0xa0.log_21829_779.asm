...
push %rdi
push %rsi
lea addresses_WT_ht+0x17a8c, %rsi
lea addresses_UC_ht+0x1a48c, %rdi
nop
nop
nop
nop
...
{'OP': 'STOR', 'dst': {'NT': False, 'same': True, 'congruent': 6, 'type': 'addresses_WC', 'AVXalign': False, 'size': 1}}
...
{'src': {'NT': True, 'same': False, 'congruent': 2, 'type': 'addresses_NC', 'AVXalign': False, 'size': 4}, 'OP': 'LOAD'}
[Faulty Load]
