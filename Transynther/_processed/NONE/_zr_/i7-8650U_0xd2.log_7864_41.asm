...
mov (%rcx), %esi
and %r11, %r11
lea addresses_WT_ht+0xb5e8, %rsi
lea addresses_normal_ht+0x7e68, %rdi
nop
nop
nop
nop
...
nop
sub $15437, %rsi
lea addresses_A_ht+0x1b068, %rdi
nop
nop
xor $53941, %r12
mov (%rdi), %esi
...
nop
cmp $57679, %rcx
lea addresses_UC_ht+0x10d0, %rsi
lea addresses_WC_ht+0x16cc0, %rdi
clflush (%rdi)
nop
nop
nop
...
{'OP': 'LOAD', 'src': {'type': 'addresses_PSE', 'size': 1, 'AVXalign': False, 'NT': False, 'congruent': 2, 'same': False}}
{'OP': 'STOR', 'dst': {'type': 'addresses_WT', 'size': 4, 'AVXalign': True, 'NT': False, 'congruent': 11, 'same': False}}
...
<gen_prepare_buffer>
{'OP': 'LOAD', 'src': {'type': 'addresses_D_ht', 'size': 4, 'AVXalign': True, 'NT': True, 'congruent': 6, 'same': False}}
