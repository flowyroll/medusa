...
push %rdi
push %rsi
lea addresses_WC_ht+0xeb82, %r11
nop
nop
nop
nop
...
nop
xor %r8, %r8
lea addresses_UC_ht+0x2cab, %rdi
nop
nop
nop
nop
...
nop
dec %rcx
lea addresses_WC_ht+0x1e00b, %r8
and %r15, %r15
mov $0x6162636465666768, %r14
movq %r14, %xmm2
vmovups %ymm2, (%r8)
...
{'dst': {'same': True, 'NT': False, 'AVXalign': False, 'size': 32, 'type': 'addresses_WC_ht', 'congruent': 6}, 'OP': 'STOR'}
