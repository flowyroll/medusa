...
push %r9
push %rax
lea addresses_WC_ht+0x1e285, %r12
nop
nop
nop
xor $20530, %r11
...
{'OP': 'STOR', 'dst': {'type': 'addresses_WC', 'size': 8, 'AVXalign': False, 'NT': True, 'congruent': 3, 'same': False}}
[Faulty Load]
