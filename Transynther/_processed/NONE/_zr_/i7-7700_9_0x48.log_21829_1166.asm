...
push %rdi
push %rsi
lea addresses_UC_ht+0x5f18, %r10
nop
nop
nop
nop
...
nop
add %rdi, %rdi
lea addresses_UC_ht+0x7340, %rax
nop
nop
nop
nop
...
nop
sub %rax, %rax
lea addresses_D_ht+0x1ac70, %rbp
dec %r8
movl $0x61626364, (%rbp)
nop
dec %rbp
lea addresses_A_ht+0x1c238, %rax
clflush (%rax)
nop
nop
xor %r14, %r14
...
nop
add $16426, %r8
lea addresses_A_ht+0x1c723, %r10
nop
inc %rbp
movl $0x61626364, (%r10)
nop
nop
and %rax, %rax
lea addresses_UC_ht+0xd540, %rcx
nop
nop
inc %rdi
mov (%rcx), %r10w
nop
add $55994, %r10
lea addresses_WC_ht+0x3818, %rsi
lea addresses_A_ht+0x1e4e4, %rdi
nop
nop
nop
nop
...
nop
and %rdi, %rdi
lea addresses_UC_ht+0x15940, %rcx
nop
cmp %rdi, %rdi
...
nop
xor %rdi, %rdi
lea addresses_WC_ht+0x5db8, %rsi
lea addresses_A_ht+0xfb40, %rdi
nop
nop
nop
cmp $58421, %rbp
...
nop
and $64879, %rsi
lea addresses_WT_ht+0xbb40, %rsi
lea addresses_normal_ht+0x1ba40, %rdi
nop
cmp %r8, %r8
mov $15, %rcx
rep movsl
...
nop
inc %rsi
lea addresses_A_ht+0x14e2c, %rbp
nop
nop
nop
and %rsi, %rsi
...
nop
cmp $45042, %rsi
lea addresses_UC_ht+0xc340, %rsi
lea addresses_D_ht+0x1055c, %rdi
and $12816, %rbp
mov $31, %rcx
rep movsl
nop
...
{'OP': 'STOR', 'dst': {'type': 'addresses_D_ht', 'AVXalign': False, 'congruent': 4, 'size': 4, 'same': True, 'NT': False}}
