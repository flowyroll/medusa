...
nop
add %r8, %r8
lea addresses_D_ht+0x1e08, %rsi
lea addresses_WC_ht+0xc508, %rdi
clflush (%rsi)
nop
sub %r8, %r8
mov $94, %rcx
...
nop
add %rdx, %rdx
lea addresses_WT_ht+0x13e08, %r15
clflush (%r15)
nop
nop
nop
...
nop
add %rcx, %rcx
lea addresses_normal_ht+0x1608, %rsi
nop
nop
nop
nop
...
nop
add $64305, %rcx
lea addresses_WC_ht+0xd808, %rdx
xor $58444, %r15
mov (%rdx), %edi
nop
nop
...
// Store
lea addresses_normal+0x1baec, %r11
nop
nop
nop
add $1072, %r9
...
// Store
lea addresses_normal+0x13c08, %r8
nop
nop
and %r15, %r15
