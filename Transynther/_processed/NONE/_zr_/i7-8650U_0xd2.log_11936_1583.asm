...
push %rdx
push %rsi
lea addresses_D_ht+0x1b16c, %rdx
nop
nop
nop
nop
...
nop
and $42166, %r12
lea addresses_WT_ht+0x11eac, %rsi
lea addresses_UC_ht+0x109df, %rdi
xor $14643, %r15
mov $49, %rcx
rep movsl
nop
...
nop
sub $21947, %rcx
lea addresses_UC_ht+0x1742c, %r9
nop
nop
add %rdi, %rdi
movb $0x61, (%r9)
...
nop
inc %r15
lea addresses_normal_ht+0x19eac, %r15
add $14246, %r12
mov (%r15), %esi
nop
nop
...
nop
and $61326, %r9
lea addresses_UC_ht+0xaeac, %r12
nop
nop
dec %rsi
...
nop
cmp $39801, %rcx
lea addresses_UC_ht+0x1238c, %r15
add $7326, %rdx
mov (%r15), %cx
nop
nop
nop
xor $61133, %rdx
lea addresses_UC_ht+0xd462, %rsi
...
rep movsq
cmp $58028, %rdi
lea addresses_normal_ht+0x10546, %rdi
nop
nop
nop
and $43746, %r15
...
movntdq %xmm4, (%r9)
dec %r15
lea addresses_WT_ht+0x1422c, %rsi
lea addresses_normal_ht+0x9b68, %rdi
nop
xor %rdx, %rdx
mov $35, %rcx
rep movsb
...
nop
add %r12, %r12
lea addresses_A_ht+0x125ac, %rsi
...
nop
sub %r12, %r12
lea addresses_A_ht+0x13576, %r12
nop
nop
nop
sub %r9, %r9
