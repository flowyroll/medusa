...
nop
add $14883, %r14
lea addresses_normal_ht+0x175f1, %r9
nop
nop
xor $9512, %rbp
mov (%r9), %rsi
...
nop
and %rcx, %rcx
lea addresses_WT_ht+0x17349, %r9
nop
xor %rcx, %rcx
mov (%r9), %bp
nop
nop
xor $12896, %rsi
lea addresses_normal_ht+0x1b729, %r14
nop
nop
nop
nop
...
nop
cmp $17702, %rbp
lea addresses_UC_ht+0x18929, %rsi
lea addresses_normal_ht+0x1bd29, %rdi
nop
cmp $3676, %r9
mov $28, %rcx
rep movsq
...
{'OP': 'REPM', 'src': {'type': 'addresses_D_ht', 'congruent': 4, 'same': True}, 'dst': {'type': 'addresses_D_ht', 'congruent': 11, 'same': False}}
