...
push %rdx
push %rsi
lea addresses_A_ht+0x1bbae, %r10
nop
nop
sub $43684, %r14
...
nop
mfence
lea addresses_A_ht+0x500e, %rsi
lea addresses_UC_ht+0xd5ce, %rdi
nop
nop
nop
nop
...
rep movsl
add $36902, %r8
lea addresses_D_ht+0x1468e, %r8
inc %rdx
mov (%r8), %ecx
nop
xor $38025, %r14
lea addresses_normal_ht+0x1a30e, %rsi
lea addresses_D_ht+0x8a36, %rdi
nop
nop
nop
nop
...
rep movsl
and %r8, %r8
lea addresses_WT_ht+0x38fe, %rcx
nop
nop
nop
nop
...
nop
cmp %rdi, %rdi
lea addresses_D_ht+0xc50e, %rsi
lea addresses_UC_ht+0x7f0e, %rdi
nop
nop
inc %r8
mov $52, %rcx
...
nop
sub %r8, %r8
lea addresses_WT_ht+0x19eee, %rsi
xor $11511, %r10
movw $0x6162, (%rsi)
nop
add %rsi, %rsi
...
// Store
lea addresses_normal+0x1c78e, %rax
nop
nop
xor $39121, %r8
movl $0x51525354, (%rax)
...
{'OP': 'STOR', 'dst': {'type': 'addresses_D', 'AVXalign': False, 'congruent': 7, 'size': 8, 'same': False, 'NT': True}}
