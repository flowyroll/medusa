...
push %rdi
push %rsi
lea addresses_UC_ht+0xfcbb, %r11
nop
dec %r9
movw $0x6162, (%r11)
and $6888, %rdi
lea addresses_WT_ht+0x118bb, %rsi
lea addresses_D_ht+0x653b, %rdi
nop
nop
nop
nop
...
nop
xor $30622, %rdi
lea addresses_WC_ht+0x18528, %r9
xor %rsi, %rsi
mov $0x6162636465666768, %rax
movq %rax, (%r9)
cmp %rax, %rax
lea addresses_D_ht+0x3f47, %rcx
nop
nop
xor $53165, %r10
vmovups (%rcx), %ymm0
...
nop
cmp %rdi, %rdi
lea addresses_normal_ht+0x1997b, %rcx
and $52498, %rdi
...
nop
and %r9, %r9
lea addresses_WC_ht+0x106bb, %rdi
nop
nop
nop
nop
...
nop
and $6176, %r11
lea addresses_WC_ht+0x5c2b, %rdi
nop
nop
nop
cmp $15425, %r11
...
vmovups %ymm4, (%rdi)
xor $54294, %rsi
lea addresses_D_ht+0x15211, %rdi
nop
nop
nop
nop
...
nop
and %rcx, %rcx
lea addresses_normal_ht+0x977b, %r9
nop
nop
nop
nop
...
nop
inc %rax
lea addresses_WT_ht+0x693b, %rcx
nop
nop
nop
nop
...
{'OP': 'REPM', 'src': {'type': 'addresses_WT_ht', 'congruent': 10, 'same': True}, 'dst': {'type': 'addresses_D_ht', 'congruent': 5, 'same': False}}
...
{'OP': 'STOR', 'dst': {'type': 'addresses_normal_ht', 'size': 32, 'AVXalign': False, 'NT': False, 'congruent': 6, 'same': True}}
