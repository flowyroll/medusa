...
push %rdx
push %rsi
lea addresses_WT_ht+0x1280c, %rsi
lea addresses_normal_ht+0x1bc0c, %rdi
nop
nop
nop
nop
...
nop
add $26821, %rcx
lea addresses_WT_ht+0x1004, %rsi
lea addresses_WC_ht+0xa36c, %rdi
nop
cmp $14525, %rdx
mov $10, %rcx
rep movsl
...
nop
xor $35, %rdx
lea addresses_WT_ht+0x1a5b6, %rax
add $25297, %rsi
movb $0x61, (%rax)
nop
nop
...
nop
and %rax, %rax
lea addresses_D_ht+0xef0c, %rsi
lea addresses_normal_ht+0x1cc4c, %rdi
nop
nop
nop
nop
...
{'OP': 'STOR', 'dst': {'same': False, 'congruent': 3, 'NT': True, 'type': 'addresses_P', 'size': 4, 'AVXalign': True}}
[Faulty Load]
