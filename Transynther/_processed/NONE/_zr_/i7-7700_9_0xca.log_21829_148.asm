...
push %rdi
push %rsi
lea addresses_normal_ht+0x1281, %rsi
lea addresses_A_ht+0x7f93, %rdi
and %rbx, %rbx
mov $100, %rcx
rep movsb
nop
...
nop
and $60910, %rbx
lea addresses_WT_ht+0x136a1, %rbp
cmp $13661, %rax
mov (%rbp), %r15w
nop
nop
...
nop
add %rbx, %rbx
lea addresses_A_ht+0x15ce9, %r15
nop
nop
nop
nop
