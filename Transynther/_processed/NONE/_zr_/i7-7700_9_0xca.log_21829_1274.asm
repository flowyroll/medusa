...
push %rdi
push %rsi
lea addresses_normal_ht+0x1b2e1, %r12
nop
nop
nop
nop
...
nop
cmp %r9, %r9
lea addresses_UC_ht+0x9fde, %rcx
clflush (%rcx)
nop
nop
add %r10, %r10
...
vpextrq $1, %xmm7, %r11
dec %r10
lea addresses_WT_ht+0x1489e, %rsi
lea addresses_normal_ht+0x2c4e, %rdi
nop
add %r12, %r12
mov $117, %rcx
rep movsq
...
nop
inc %r12
lea addresses_D_ht+0x1c319, %rcx
nop
and $62358, %r10
mov (%rcx), %r12
nop
sub %r9, %r9
lea addresses_D_ht+0x1e8fd, %rdi
nop
nop
nop
dec %r9
...
{'src': {'congruent': 5, 'AVXalign': False, 'same': False, 'size': 32, 'NT': True, 'type': 'addresses_NC'}, 'OP': 'LOAD'}
[Faulty Load]
...
{'src': {'congruent': 4, 'same': False, 'type': 'addresses_WT_ht'}, 'OP': 'REPM', 'dst': {'congruent': 1, 'same': False, 'type': 'addresses_normal_ht'}}
