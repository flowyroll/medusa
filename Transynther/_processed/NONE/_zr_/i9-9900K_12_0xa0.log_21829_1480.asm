...
push %rdx
push %rsi
lea addresses_WT_ht+0x144a6, %rdx
nop
nop
nop
nop
...
nop
sub %r8, %r8
lea addresses_UC_ht+0x15986, %r10
nop
nop
nop
nop
...
nop
xor $8961, %r15
lea addresses_normal_ht+0x72e6, %rcx
nop
nop
nop
nop
...
nop
xor $61948, %r15
lea addresses_D_ht+0x19fe6, %r12
xor %r8, %r8
...
nop
sub $61235, %r10
lea addresses_normal_ht+0x1b8a6, %rsi
lea addresses_WC_ht+0x7fe6, %rdi
nop
nop
nop
nop
...
nop
and %r12, %r12
lea addresses_WT_ht+0x15a95, %rdx
nop
nop
xor $28391, %r10
...
nop
cmp %r15, %r15
lea addresses_UC_ht+0x33ec, %rsi
nop
nop
add $49402, %r15
movb $0x61, (%rsi)
...
{'OP': 'STOR', 'dst': {'NT': False, 'same': False, 'congruent': 10, 'type': 'addresses_P', 'AVXalign': False, 'size': 4}}
{'OP': 'STOR', 'dst': {'NT': True, 'same': False, 'congruent': 5, 'type': 'addresses_A', 'AVXalign': True, 'size': 1}}
[Faulty Load]
...
{'OP': 'STOR', 'dst': {'NT': True, 'same': False, 'congruent': 8, 'type': 'addresses_normal_ht', 'AVXalign': False, 'size': 4}}
