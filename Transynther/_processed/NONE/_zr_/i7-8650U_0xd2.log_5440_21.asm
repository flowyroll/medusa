...
push %rdx
push %rsi
lea addresses_normal_ht+0x4f23, %rcx
nop
nop
nop
nop
...
mov (%rcx), %r10
add $5738, %r8
lea addresses_normal_ht+0x1b507, %r12
nop
nop
inc %rbx
...
movups %xmm0, (%r12)
add $35333, %rdx
lea addresses_UC_ht+0x12143, %r10
nop
nop
nop
and %rdx, %rdx
...
mov (%r8), %rcx
add %rcx, %rcx
lea addresses_UC_ht+0x19f43, %rbx
nop
cmp %rdx, %rdx
mov (%rbx), %cx
nop
...
nop
and %rcx, %rcx
lea addresses_WT_ht+0x9367, %rsi
lea addresses_D_ht+0x15473, %rdi
xor %r10, %r10
mov $83, %rcx
rep movsq
xor %rbx, %rbx
lea addresses_normal_ht+0x16503, %rsi
lea addresses_A_ht+0x167be, %rdi
nop
sub $17745, %rdx
mov $62, %rcx
rep movsw
...
nop
add %r8, %r8
lea addresses_A_ht+0x19023, %rdx
nop
nop
nop
and %rbx, %rbx
...
nop
sub $10275, %rdx
lea addresses_normal_ht+0xa7b8, %rax
nop
nop
nop
nop
...
{'OP': 'STOR', 'dst': {'type': 'addresses_NC', 'size': 16, 'AVXalign': False, 'NT': True, 'congruent': 2, 'same': False}}
