...
movq %r11, (%r14)
sub $5122, %rsi
lea addresses_WC_ht+0x6f2f, %r14
nop
nop
xor %rdi, %rdi
vmovups (%r14), %ymm2
...
nop
sub $61379, %r11
lea addresses_UC_ht+0x770f, %rsi
lea addresses_WT_ht+0xdd0f, %rdi
nop
nop
nop
nop
...
nop
and $43888, %rsi
lea addresses_UC_ht+0x917f, %rcx
nop
xor $53832, %r15
mov (%rcx), %r13w
nop
...
nop
lfence
lea addresses_UC_ht+0x14b0f, %rsi
lea addresses_UC_ht+0xe677, %rdi
nop
nop
nop
nop
...
rep movsl
and $7957, %r11
lea addresses_WT_ht+0x1e70f, %rdi
nop
nop
nop
xor %r10, %r10
...
vpextrq $1, %xmm6, %r15
sub %rdi, %rdi
lea addresses_WT_ht+0x1760f, %r11
and $46394, %r10
...
nop
and %r10, %r10
lea addresses_UC_ht+0x4a4f, %r11
nop
nop
nop
nop
...
nop
xor $1239, %rdi
lea addresses_UC_ht+0x19d0f, %rcx
add %r10, %r10
movups (%rcx), %xmm1
vpextrq $1, %xmm1, %r15
nop
...
nop
and $55356, %r14
lea addresses_WT_ht+0x970f, %rsi
xor %r10, %r10
...
nop
dec %r10
lea addresses_WC_ht+0x7ecf, %rsi
add %rcx, %rcx
mov (%rsi), %r15w
sub $6546, %rdi
pop %rsi
...
{'OP': 'LOAD', 'src': {'type': 'addresses_WT_ht', 'AVXalign': False, 'congruent': 8, 'size': 32, 'same': True, 'NT': True}}
...
{'OP': 'STOR', 'dst': {'type': 'addresses_WT_ht', 'AVXalign': True, 'congruent': 11, 'size': 16, 'same': False, 'NT': True}}
