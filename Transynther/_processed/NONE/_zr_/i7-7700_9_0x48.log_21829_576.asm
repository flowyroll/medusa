...
push %rdi
push %rsi
lea addresses_D_ht+0x80de, %r9
dec %r15
movups (%r9), %xmm3
vpextrq $0, %xmm3, %rbx
nop
and %r11, %r11
lea addresses_A_ht+0x1a5e, %rbx
nop
nop
add %r12, %r12
...
nop
sub %r11, %r11
lea addresses_UC_ht+0x1afde, %rax
clflush (%rax)
nop
inc %rcx
movw $0x6162, (%rax)
...
nop
xor %r11, %r11
lea addresses_normal_ht+0xffae, %rsi
lea addresses_D_ht+0xddde, %rdi
nop
nop
sub $18058, %r12
mov $104, %rcx
...
movl $0x61626364, (%r9)
xor %r12, %r12
lea addresses_UC_ht+0xefde, %rax
nop
nop
nop
nop
...
movq %r9, (%rax)
xor $27475, %rsi
lea addresses_UC_ht+0x14ce, %r11
nop
nop
nop
nop
...
{'OP': 'STOR', 'dst': {'type': 'addresses_UC_ht', 'AVXalign': True, 'congruent': 7, 'size': 2, 'same': True, 'NT': False}}
