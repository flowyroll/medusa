...
push %rdx
push %rsi
lea addresses_normal_ht+0x43d0, %rsi
lea addresses_normal_ht+0x1ab2a, %rdi
nop
nop
add $18002, %rbp
mov $14, %rcx
...
nop
xor %r9, %r9
lea addresses_normal_ht+0x8c0a, %rcx
nop
nop
nop
and %rdx, %rdx
...
nop
xor $18383, %rbp
lea addresses_D_ht+0x1a9ca, %rcx
nop
add %rdx, %rdx
...
nop
and %rdx, %rdx
lea addresses_normal_ht+0x12b6a, %rdi
nop
nop
cmp %r9, %r9
movb $0x61, (%rdi)
add %rdi, %rdi
lea addresses_WT_ht+0xf36a, %rsi
lea addresses_UC_ht+0xc24, %rdi
nop
nop
nop
nop
...
nop
add $39620, %rdi
lea addresses_D_ht+0x69aa, %rsi
lea addresses_D_ht+0x8f76, %rdi
nop
and %rbp, %rbp
mov $78, %rcx
rep movsl
...
nop
dec %rbp
lea addresses_WC_ht+0x1b67a, %rbp
nop
nop
nop
nop
...
nop
sub $12583, %rdx
lea addresses_WC_ht+0x642a, %rsi
lea addresses_WT_ht+0x8566, %rdi
nop
and %rbp, %rbp
mov $43, %rcx
rep movsl
nop
cmp $46933, %r13
lea addresses_A_ht+0x1001e, %rcx
cmp $37372, %rdi
movb (%rcx), %r12b
nop
nop
nop
cmp $23823, %rbp
lea addresses_UC_ht+0x199ea, %rsi
lea addresses_normal_ht+0x1da0a, %rdi
clflush (%rdi)
nop
nop
nop
...
{'OP': 'LOAD', 'src': {'type': 'addresses_normal_ht', 'AVXalign': False, 'congruent': 4, 'size': 8, 'same': False, 'NT': True}}
...
{'OP': 'REPM', 'src': {'type': 'addresses_D_ht', 'congruent': 7, 'same': True}, 'dst': {'type': 'addresses_D_ht', 'congruent': 2, 'same': False}}
