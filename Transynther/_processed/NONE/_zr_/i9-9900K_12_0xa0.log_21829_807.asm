...
push %rdi
push %rsi
lea addresses_UC_ht+0x1045c, %rax
nop
nop
sub %rcx, %rcx
movb $0x61, (%rax)
...
nop
add %r11, %r11
lea addresses_WT_ht+0xcb3c, %r10
nop
nop
nop
nop
...
nop
and %rbx, %rbx
lea addresses_D_ht+0x18c06, %rsi
lea addresses_WT_ht+0x17692, %rdi
nop
nop
nop
nop
...
rep movsq
sub $40460, %r9
lea addresses_UC_ht+0x1df3c, %rax
nop
nop
nop
nop
...
nop
sub %rsi, %rsi
lea addresses_normal_ht+0x1af3c, %rsi
lea addresses_WC_ht+0x1bb2c, %rdi
cmp $41542, %r9
mov $14, %rcx
rep movsl
inc %rbx
lea addresses_UC_ht+0x81d3, %rcx
nop
nop
nop
add %r11, %r11
...
nop
cmp %rax, %rax
lea addresses_WC_ht+0x1073c, %r9
nop
nop
nop
and %rcx, %rcx
...
nop
xor %rcx, %rcx
lea addresses_UC_ht+0x1acbc, %r9
inc %rdi
mov (%r9), %ebx
nop
nop
...
nop
cmp $42951, %r9
lea addresses_WT_ht+0x1aeac, %r10
nop
nop
nop
nop
...
nop
add $48275, %r10
lea addresses_UC_ht+0x15f3c, %rax
nop
nop
nop
nop
...
lea addresses_UC_ht+0x1757c, %rdi
nop
nop
dec %r10
mov $76, %rcx
...
nop
cmp $24842, %r9
lea addresses_WT_ht+0x166f4, %r10
nop
nop
add $6393, %rcx
...
nop
add %rcx, %rcx
lea addresses_D_ht+0x1237c, %rsi
lea addresses_WT_ht+0x733c, %rdi
nop
nop
add $22050, %r10
mov $10, %rcx
...
{'src': {'same': False, 'congruent': 1, 'type': 'addresses_WT_ht'}, 'OP': 'REPM', 'dst': {'same': False, 'congruent': 4, 'type': 'addresses_UC_ht'}}
