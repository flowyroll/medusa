...
push %rdx
push %rsi
lea addresses_WT_ht+0x188cf, %r15
nop
nop
nop
dec %rbp
...
nop
sub $32225, %rsi
lea addresses_WT_ht+0x328f, %rcx
nop
nop
nop
nop
...
nop
cmp $39075, %r11
lea addresses_UC_ht+0x524f, %rsi
lea addresses_WT_ht+0xa07f, %rdi
clflush (%rsi)
nop
and %r10, %r10
mov $123, %rcx
...
nop
add %rdx, %rdx
lea addresses_D_ht+0x14b8f, %r10
nop
nop
nop
nop
...
{'OP': 'LOAD', 'src': {'type': 'addresses_normal', 'size': 2, 'AVXalign': False, 'NT': True, 'congruent': 7, 'same': False}}
