...
nop
inc %rcx
lea addresses_WT_ht+0x51be, %r15
nop
nop
nop
nop
...
nop
cmp $16100, %r15
lea addresses_WC_ht+0x323e, %r15
clflush (%r15)
nop
nop
nop
...
nop
xor %r13, %r13
lea addresses_UC_ht+0x17fe, %rsi
lea addresses_D_ht+0x643e, %rdi
nop
nop
nop
nop
...
nop
add %rsi, %rsi
lea addresses_D_ht+0x9f3e, %rsi
lea addresses_normal_ht+0x12fe, %rdi
nop
xor %rbx, %rbx
mov $119, %rcx
rep movsw
...
// Store
lea addresses_normal+0xc9e, %rdi
nop
nop
nop
nop
...
{'OP': 'STOR', 'dst': {'NT': False, 'same': False, 'congruent': 0, 'type': 'addresses_WT', 'AVXalign': True, 'size': 8}}
{'OP': 'STOR', 'dst': {'NT': False, 'same': False, 'congruent': 8, 'type': 'addresses_D', 'AVXalign': True, 'size': 16}}
[Faulty Load]
...
{'src': {'same': False, 'congruent': 5, 'type': 'addresses_A_ht'}, 'OP': 'REPM', 'dst': {'same': False, 'congruent': 4, 'type': 'addresses_WT_ht'}}
...
{'src': {'same': False, 'congruent': 7, 'type': 'addresses_D_ht'}, 'OP': 'REPM', 'dst': {'same': True, 'congruent': 5, 'type': 'addresses_normal_ht'}}
{'00': 21829}
