...
push %rdi
push %rsi
lea addresses_normal_ht+0xc928, %r13
sub $31367, %r9
movb $0x61, (%r13)
xor $54260, %r12
lea addresses_D_ht+0x5448, %rdi
nop
nop
nop
nop
...
nop
and $55680, %r12
lea addresses_WC_ht+0x1e948, %r14
nop
nop
nop
nop
...
nop
add $23288, %rdi
lea addresses_normal_ht+0x14d48, %rsi
lea addresses_A_ht+0x1da28, %rdi
and $18045, %r13
mov $51, %rcx
rep movsq
dec %rbx
lea addresses_WC_ht+0x19d88, %rsi
lea addresses_normal_ht+0x18148, %rdi
nop
nop
nop
xor %rbx, %rbx
...
nop
dec %r12
lea addresses_WT_ht+0x5a18, %r12
nop
nop
nop
sub %r14, %r14
...
nop
sub $56992, %rcx
lea addresses_WT_ht+0xca28, %rdi
nop
nop
sub %r9, %r9
movw $0x6162, (%rdi)
...
nop
sub %r14, %r14
lea addresses_D_ht+0x175c8, %r13
clflush (%r13)
nop
nop
nop
...
nop
cmp %rbx, %rbx
lea addresses_D_ht+0x18d55, %rdi
sub $41796, %rcx
movw $0x6162, (%rdi)
nop
and %r14, %r14
lea addresses_UC_ht+0x9000, %r12
nop
nop
lfence
movw $0x6162, (%r12)
...
nop
sub %rsi, %rsi
lea addresses_A_ht+0xb7c8, %rsi
lea addresses_A_ht+0x11f48, %rdi
nop
nop
add %r12, %r12
mov $82, %rcx
...
{'src': {'NT': False, 'same': True, 'congruent': 9, 'type': 'addresses_WC_ht', 'AVXalign': True, 'size': 16}, 'OP': 'LOAD'}
{'src': {'same': False, 'congruent': 10, 'type': 'addresses_normal_ht'}, 'OP': 'REPM', 'dst': {'same': False, 'congruent': 5, 'type': 'addresses_A_ht'}}
...
{'OP': 'STOR', 'dst': {'NT': False, 'same': False, 'congruent': 0, 'type': 'addresses_D_ht', 'AVXalign': True, 'size': 2}}
...
{'src': {'same': False, 'congruent': 7, 'type': 'addresses_A_ht'}, 'OP': 'REPM', 'dst': {'same': False, 'congruent': 9, 'type': 'addresses_A_ht'}}
