...
lea addresses_WC_ht+0xf0ae, %rdi
nop
and %r9, %r9
mov $116, %rcx
rep movsb
...
nop
add $24279, %r10
lea addresses_WT_ht+0x3ef0, %r12
nop
dec %rsi
mov $0x6162636465666768, %r13
movq %r13, (%r12)
nop
sub $51369, %r9
lea addresses_WT_ht+0x145f0, %rsi
nop
nop
nop
dec %r10
...
nop
sub %rdi, %rdi
lea addresses_WT_ht+0xd3fc, %rsi
lea addresses_A_ht+0x4430, %rdi
clflush (%rdi)
nop
nop
nop
...
nop
sub $54168, %r13
lea addresses_A_ht+0x97b0, %rsi
lea addresses_normal_ht+0x86a0, %rdi
nop
nop
nop
dec %r10
...
nop
inc %r9
lea addresses_WT_ht+0xe670, %rsi
lea addresses_D_ht+0x7430, %rdi
clflush (%rdi)
nop
nop
nop
...
{'OP': 'STOR', 'dst': {'congruent': 9, 'AVXalign': False, 'same': True, 'size': 32, 'NT': True, 'type': 'addresses_normal_ht'}}
