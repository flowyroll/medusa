...
push %rcx
push %rdx
lea addresses_WT_ht+0x18f94, %r12
nop
nop
nop
nop
...
nop
cmp %r12, %r12
lea addresses_D_ht+0x4b24, %rcx
and %rbx, %rbx
movl $0x61626364, (%rcx)
nop
nop
and $55018, %rbx
lea addresses_WT_ht+0x28e5, %rdx
and $12393, %r12
movl $0x61626364, (%rdx)
nop
cmp $39715, %r12
