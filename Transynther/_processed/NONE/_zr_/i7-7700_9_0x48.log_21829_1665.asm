...
push %rdi
push %rsi
lea addresses_D_ht+0x7119, %rsi
lea addresses_A_ht+0xc661, %rdi
nop
nop
nop
sub %r9, %r9
...
nop
and %rdi, %rdi
lea addresses_WC_ht+0x6999, %r15
sub $30247, %r14
mov (%r15), %r9w
nop
add $50173, %rbp
lea addresses_WT_ht+0x7859, %rdi
nop
dec %rcx
...
nop
sub $11962, %rcx
lea addresses_normal_ht+0x1bd99, %rsi
nop
nop
nop
nop
...
movb (%rsi), %r14b
and $44868, %r9
lea addresses_normal_ht+0xf599, %rdi
nop
nop
add $3401, %rcx
movups (%rdi), %xmm1
...
// Store
lea addresses_normal+0xc57c, %r8
cmp $62340, %rdi
movw $0x5152, (%r8)
nop
nop
...
// Store
lea addresses_normal+0x1b69f, %r15
nop
nop
nop
nop
...
<gen_prepare_buffer>
{'OP': 'REPM', 'src': {'type': 'addresses_D_ht', 'congruent': 7, 'same': False}, 'dst': {'type': 'addresses_A_ht', 'congruent': 3, 'same': True}}
...
{'OP': 'STOR', 'dst': {'type': 'addresses_A_ht', 'AVXalign': True, 'congruent': 5, 'size': 4, 'same': True, 'NT': True}}
