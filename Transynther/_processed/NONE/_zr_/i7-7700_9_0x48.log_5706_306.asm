...
push %rdi
push %rsi
lea addresses_WC_ht+0x7f0f, %rbp
nop
nop
dec %r11
movups (%rbp), %xmm0
...
nop
inc %rax
lea addresses_WT_ht+0xd42f, %rsi
nop
nop
nop
xor %rbp, %rbp
...
nop
and %rax, %rax
lea addresses_WC_ht+0x10c0f, %rbp
xor %r13, %r13
...
nop
xor %rax, %rax
lea addresses_normal_ht+0x707d, %r11
nop
nop
nop
nop
...
nop
cmp %rax, %rax
lea addresses_normal_ht+0x1cc0f, %r14
nop
nop
and $48208, %rbp
mov (%r14), %eax
and %rax, %rax
lea addresses_WT_ht+0xcc0f, %rsi
lea addresses_A_ht+0x13e0f, %rdi
nop
cmp %r13, %r13
mov $1, %rcx
rep movsq
...
nop
sub $19734, %rcx
lea addresses_UC_ht+0x27d7, %rax
nop
nop
nop
nop
...
nop
cmp %r13, %r13
lea addresses_WC_ht+0xcec8, %rsi
nop
nop
and %r13, %r13
movb $0x61, (%rsi)
...
nop
and %r13, %r13
lea addresses_normal_ht+0x9419, %rax
nop
and %r11, %r11
movups (%rax), %xmm1
vpextrq $0, %xmm1, %r13
...
nop
xor %r9, %r9
lea addresses_normal_ht+0x460f, %rsi
lea addresses_A_ht+0x940f, %rdi
nop
nop
nop
sub %rax, %rax
