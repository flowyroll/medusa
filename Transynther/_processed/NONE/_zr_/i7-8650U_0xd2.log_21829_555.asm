...
push %rdx
push %rsi
lea addresses_A_ht+0x1d3d2, %r12
xor %rcx, %rcx
movw $0x6162, (%r12)
nop
nop
...
nop
xor $53636, %rdi
lea addresses_UC_ht+0x1b5b2, %rsi
lea addresses_WT_ht+0x1c9d1, %rdi
nop
nop
and %rdx, %rdx
mov $38, %rcx
...
nop
sub %rsi, %rsi
lea addresses_WT_ht+0xfdd2, %rsi
lea addresses_WT_ht+0x172d2, %rdi
nop
nop
xor %r10, %r10
mov $82, %rcx
rep movsq
sub $28606, %rsi
lea addresses_UC_ht+0x7312, %r10
nop
nop
nop
nop
...
// Store
lea addresses_normal+0x55d2, %rsi
nop
nop
nop
lfence
...
<gen_prepare_buffer>
{'OP': 'STOR', 'dst': {'type': 'addresses_A_ht', 'size': 2, 'AVXalign': False, 'NT': False, 'congruent': 9, 'same': True}}
