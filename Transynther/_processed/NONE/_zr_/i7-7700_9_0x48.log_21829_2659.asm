...
nop
and $40671, %rdi
lea addresses_normal_ht+0xbd7c, %rsi
lea addresses_UC_ht+0x1b5b8, %rdi
nop
nop
and $20619, %r15
mov $12, %rcx
...
nop
xor %rcx, %rcx
lea addresses_WC_ht+0x1b6b8, %rsi
lea addresses_UC_ht+0x9be6, %rdi
nop
nop
nop
cmp %rbp, %rbp
...
nop
xor $35810, %r13
lea addresses_WC_ht+0xe2bf, %rcx
nop
nop
nop
nop
...
movb $0x61, (%rcx)
xor $30425, %rdi
lea addresses_WT_ht+0x1b790, %r14
clflush (%r14)
nop
nop
nop
...
nop
add $12800, %r14
lea addresses_normal_ht+0x1ebd0, %rsi
lea addresses_normal_ht+0x167d0, %rdi
nop
sub %r15, %r15
mov $53, %rcx
rep movsw
...
nop
cmp %r15, %r15
lea addresses_WT_ht+0x1a3a6, %r8
nop
nop
nop
nop
...
nop
add %r14, %r14
lea addresses_WC_ht+0x4b70, %rcx
sub %r15, %r15
...
nop
sub $25064, %rcx
lea addresses_D_ht+0x184d0, %rsi
lea addresses_A_ht+0x43d0, %rdi
nop
nop
inc %rbp
mov $45, %rcx
...
{'OP': 'REPM', 'src': {'type': 'addresses_D_ht', 'congruent': 7, 'same': False}, 'dst': {'type': 'addresses_A_ht', 'congruent': 10, 'same': False}}
{'00': 21829}
