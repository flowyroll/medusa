...
push %rdx
push %rsi
lea addresses_UC_ht+0x94e6, %rdx
sub %rax, %rax
movups (%rdx), %xmm7
vpextrq $0, %xmm7, %r12
nop
inc %rbx
lea addresses_normal_ht+0x3e76, %rsi
lea addresses_UC_ht+0x13ba6, %rdi
nop
nop
nop
nop
...
nop
sub %rdx, %rdx
lea addresses_WT_ht+0x67e6, %rbx
nop
nop
nop
nop
...
nop
xor %rbx, %rbx
lea addresses_normal_ht+0xc6c0, %rbx
nop
nop
nop
nop
...
nop
inc %rdx
lea addresses_UC_ht+0x1b11e, %rbx
nop
nop
nop
nop
...
nop
cmp $16194, %r11
lea addresses_WC_ht+0x1dfe6, %rsi
lea addresses_UC_ht+0xefe6, %rdi
clflush (%rsi)
nop
nop
nop
...
nop
cmp $31700, %rdx
lea addresses_A_ht+0x100da, %rsi
nop
nop
sub $46041, %rcx
mov (%rsi), %bx
...
nop
cmp $17230, %rsi
lea addresses_normal_ht+0x32b0, %rdi
nop
nop
nop
nop
...
nop
xor $37942, %rcx
lea addresses_normal_ht+0x1e3e6, %rcx
nop
nop
sub $62049, %rbx
movb $0x61, (%rcx)
nop
xor $34544, %rdi
lea addresses_WC_ht+0xd922, %rcx
nop
add $5083, %r11
movw $0x6162, (%rcx)
nop
...
{'dst': {'same': False, 'congruent': 6, 'type': 'addresses_UC_ht'}, 'OP': 'REPM', 'src': {'same': False, 'congruent': 4, 'type': 'addresses_normal_ht'}}
{'dst': {'same': False, 'NT': True, 'AVXalign': False, 'size': 8, 'type': 'addresses_WT_ht', 'congruent': 10}, 'OP': 'STOR'}
