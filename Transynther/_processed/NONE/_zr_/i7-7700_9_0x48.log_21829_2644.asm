...
push %rdi
push %rsi
lea addresses_UC_ht+0x1a373, %r14
nop
nop
sub %r8, %r8
...
nop
xor $48721, %r9
lea addresses_D_ht+0x14afb, %rsi
lea addresses_WT_ht+0x16793, %rdi
nop
cmp %r15, %r15
mov $96, %rcx
rep movsb
...
nop
add %rsi, %rsi
lea addresses_normal_ht+0x1dcfd, %r14
nop
nop
add %r9, %r9
movups (%r14), %xmm1
