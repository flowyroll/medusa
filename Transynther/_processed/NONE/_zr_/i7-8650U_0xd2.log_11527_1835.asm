...
push %rdi
push %rsi
lea addresses_WT_ht+0x6e57, %rsi
lea addresses_normal_ht+0x8ed7, %rdi
nop
nop
nop
nop
...
rep movsw
dec %rax
lea addresses_WC_ht+0x5d57, %rsi
lea addresses_normal_ht+0x6b57, %rdi
cmp $61867, %rbx
mov $59, %rcx
rep movsl
nop
nop
dec %rcx
lea addresses_A_ht+0x1316d, %rcx
nop
nop
nop
nop
...
nop
sub $46991, %rsi
lea addresses_WT_ht+0xe557, %rsi
...
nop
and %rbx, %rbx
lea addresses_UC_ht+0x10c77, %r13
nop
nop
nop
nop
...
mov (%r13), %eax
inc %rsi
lea addresses_A_ht+0x16b57, %rbp
sub %r11, %r11
...
nop
and $1628, %rax
lea addresses_normal_ht+0xcbd7, %rbp
nop
cmp %rbx, %rbx
...
nop
xor $31626, %rax
lea addresses_D_ht+0x1e787, %rsi
clflush (%rsi)
nop
inc %rax
mov (%rsi), %r13d
add %rbp, %rbp
lea addresses_WC_ht+0x13357, %rbp
nop
nop
sub %rdi, %rdi
...
nop
xor %rax, %rax
lea addresses_WT_ht+0x9057, %rbx
nop
nop
nop
nop
...
nop
lfence
lea addresses_WC_ht+0x161d7, %rsi
inc %rbx
movw $0x6162, (%rsi)
nop
nop
...
nop
inc %r11
lea addresses_WC_ht+0x17b57, %rsi
lea addresses_D_ht+0x18a77, %rdi
nop
nop
nop
nop
...
{'OP': 'STOR', 'dst': {'type': 'addresses_A_ht', 'size': 16, 'AVXalign': False, 'NT': True, 'congruent': 11, 'same': False}}
...
{'OP': 'LOAD', 'src': {'type': 'addresses_WT_ht', 'size': 16, 'AVXalign': False, 'NT': True, 'congruent': 7, 'same': False}}
