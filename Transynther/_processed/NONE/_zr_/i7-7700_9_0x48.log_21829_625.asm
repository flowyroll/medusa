...
nop
lfence
lea addresses_UC_ht+0x17c80, %r10
nop
nop
dec %rsi
...
nop
add %rsi, %rsi
lea addresses_normal_ht+0x16580, %rsi
lea addresses_A_ht+0x3e2c, %rdi
nop
add %r9, %r9
mov $52, %rcx
rep movsb
...
nop
sub %rsi, %rsi
lea addresses_WC_ht+0x19bd0, %rbx
add $20668, %rsi
movw $0x6162, (%rbx)
nop
nop
...
nop
xor $61594, %r10
lea addresses_A_ht+0x8340, %rsi
lea addresses_A_ht+0x17280, %rdi
nop
nop
nop
inc %r11
...
nop
cmp %r9, %r9
lea addresses_A_ht+0x174c8, %rsi
lea addresses_D_ht+0xb4f0, %rdi
nop
nop
cmp %rbx, %rbx
mov $69, %rcx
...
nop
add $49575, %r9
lea addresses_WT_ht+0x12320, %rsi
lea addresses_WC_ht+0x1c3b4, %rdi
nop
nop
nop
nop
...
nop
and $50269, %rdi
lea addresses_A_ht+0x1690, %rsi
lea addresses_UC_ht+0x18160, %rdi
nop
nop
nop
nop
...
nop
dec %r9
lea addresses_A_ht+0x11480, %rsi
lea addresses_normal_ht+0x7f80, %rdi
clflush (%rsi)
nop
nop
nop
