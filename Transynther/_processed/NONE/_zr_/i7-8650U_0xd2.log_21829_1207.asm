...
push %rdi
push %rsi
lea addresses_WT_ht+0x19627, %r11
clflush (%r11)
nop
nop
nop
...
lea addresses_A_ht+0x1195c, %rdi
clflush (%rsi)
nop
nop
nop
...
nop
xor $57443, %r11
lea addresses_UC_ht+0x16e81, %rdi
add $25807, %rbp
mov (%rdi), %rbx
nop
and %rsi, %rsi
lea addresses_UC_ht+0x10439, %rsi
lea addresses_WC_ht+0x10cb9, %rdi
nop
nop
add %r8, %r8
mov $6, %rcx
...
nop
and $24394, %r11
lea addresses_WC_ht+0x173e9, %rbp
nop
nop
dec %rsi
movb $0x61, (%rbp)
...
{'OP': 'STOR', 'dst': {'type': 'addresses_WT_ht', 'size': 8, 'AVXalign': False, 'NT': False, 'congruent': 7, 'same': True}}
