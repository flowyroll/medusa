...
lea addresses_WT_ht+0x494d, %rdi
clflush (%rsi)
nop
nop
nop
...
nop
sub %r12, %r12
lea addresses_UC_ht+0x2115, %rsi
lea addresses_WC_ht+0x5cdd, %rdi
nop
nop
nop
nop
...
nop
cmp %rax, %rax
lea addresses_WT_ht+0x19155, %rsi
lea addresses_UC_ht+0x1ed55, %rdi
nop
nop
nop
sub $27936, %r13
...
rep movsb
and %r15, %r15
lea addresses_WC_ht+0x170c1, %rsi
...
nop
inc %r14
lea addresses_normal_ht+0xd1c3, %rcx
nop
nop
nop
sub $13543, %r15
...
nop
xor %r13, %r13
lea addresses_D_ht+0x1df55, %rsi
lea addresses_A_ht+0x1d955, %rdi
xor $23273, %r12
mov $0, %rcx
rep movsl
nop
...
nop
and %rax, %rax
lea addresses_UC_ht+0xbf01, %r15
nop
nop
nop
cmp %rax, %rax
...
{'src': {'congruent': 3, 'same': False, 'type': 'addresses_UC_ht'}, 'OP': 'REPM', 'dst': {'congruent': 2, 'same': False, 'type': 'addresses_WC_ht'}}
