...
push %rdi
push %rsi
lea addresses_UC_ht+0x4072, %rbx
nop
and %r13, %r13
movw $0x6162, (%rbx)
nop
...
nop
and %rdi, %rdi
lea addresses_normal_ht+0x15c02, %r11
nop
nop
nop
cmp $33870, %r9
...
nop
cmp %rbx, %rbx
lea addresses_A_ht+0xb602, %rbx
nop
nop
add %r8, %r8
mov (%rbx), %di
sub %r15, %r15
lea addresses_WC_ht+0xcdc2, %r8
and %r9, %r9
movb (%r8), %r13b
nop
nop
nop
cmp %rbx, %rbx
lea addresses_D_ht+0x822, %rsi
lea addresses_WT_ht+0x11ce2, %rdi
nop
cmp $36080, %r9
mov $19, %rcx
rep movsw
...
{'OP': 'REPM', 'src': {'type': 'addresses_D_ht', 'congruent': 5, 'same': False}, 'dst': {'type': 'addresses_WT_ht', 'congruent': 4, 'same': False}}
{'00': 21829}
