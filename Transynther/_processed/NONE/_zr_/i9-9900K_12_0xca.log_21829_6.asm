...
push %rdi
push %rsi
lea addresses_normal_ht+0x1c6f9, %rsi
lea addresses_UC_ht+0x5bb9, %rdi
nop
nop
nop
nop
...
rep movsl
and $51226, %r10
lea addresses_WT_ht+0x1c80d, %rsi
nop
cmp $41602, %rbx
movl $0x61626364, (%rsi)
add $27976, %rcx
lea addresses_UC_ht+0x13ab9, %rsi
nop
nop
nop
nop
...
nop
and %r10, %r10
lea addresses_A_ht+0x15cc5, %rsi
nop
nop
cmp %r14, %r14
mov (%rsi), %rbx
...
nop
and $27156, %rcx
lea addresses_WT_ht+0xf84f, %rcx
nop
sub %rbx, %rbx
...
nop
inc %r14
lea addresses_WT_ht+0x18179, %rsi
lea addresses_UC_ht+0x17ef9, %rdi
xor $63206, %rbx
mov $32, %rcx
rep movsq
nop
...
nop
xor $59525, %r12
lea addresses_WC_ht+0x11e13, %r12
nop
nop
nop
nop
...
<gen_prepare_buffer>
{'OP': 'REPM', 'src': {'same': False, 'type': 'addresses_normal_ht', 'congruent': 10}, 'dst': {'same': False, 'type': 'addresses_UC_ht', 'congruent': 5}}
...
{'OP': 'LOAD', 'src': {'size': 16, 'NT': True, 'type': 'addresses_D_ht', 'same': False, 'AVXalign': False, 'congruent': 1}}
