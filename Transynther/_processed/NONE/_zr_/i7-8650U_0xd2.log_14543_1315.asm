...
push %rdx
push %rsi
lea addresses_WT_ht+0x9153, %rdi
clflush (%rdi)
nop
nop
nop
...
nop
inc %r10
lea addresses_UC_ht+0x13e1b, %rdx
nop
nop
nop
nop
...
nop
xor %r15, %r15
lea addresses_WT_ht+0x1a175, %rsi
lea addresses_D_ht+0x7cf5, %rdi
nop
nop
add $9557, %rdx
mov $82, %rcx
rep movsw
xor %rdx, %rdx
lea addresses_D_ht+0x10b85, %rcx
nop
add %rdx, %rdx
mov (%rcx), %rbx
nop
lfence
lea addresses_UC_ht+0x10141, %r15
and $32064, %rsi
movups (%r15), %xmm2
vpextrq $0, %xmm2, %r12
xor %r15, %r15
lea addresses_WC_ht+0x1b375, %rsi
lea addresses_A_ht+0x18f5, %rdi
nop
nop
nop
nop
...
rep movsw
dec %r15
lea addresses_WC_ht+0x18b23, %rbx
nop
nop
sub %r12, %r12
...
nop
inc %rsi
lea addresses_D_ht+0xb5, %rsi
lea addresses_WC_ht+0xd02a, %rdi
lfence
mov $15, %rcx
rep movsl
nop
...
nop
sub $42691, %rdi
lea addresses_A_ht+0x1bec5, %rbx
nop
nop
nop
nop
...
nop
add %r15, %r15
lea addresses_WC_ht+0x800d, %rbx
nop
nop
dec %r15
vmovups (%rbx), %ymm5
...
nop
cmp %rdx, %rdx
lea addresses_WC_ht+0x1d8f5, %r12
nop
sub $7150, %r15
movups (%r12), %xmm4
vpextrq $0, %xmm4, %rbx
cmp %rdx, %rdx
lea addresses_normal_ht+0x16295, %rsi
lea addresses_WT_ht+0x1b1f5, %rdi
nop
cmp %r15, %r15
mov $2, %rcx
rep movsl
...
nop
cmp %r10, %r10
lea addresses_D_ht+0x1ab75, %r15
xor %rdx, %rdx
mov (%r15), %esi
nop
nop
...
nop
and %rsi, %rsi
lea addresses_UC_ht+0x136ad, %rdi
nop
and $29597, %rdx
movb $0x61, (%rdi)
sub $4087, %rcx
...
{'OP': 'REPM', 'src': {'type': 'addresses_WC_ht', 'congruent': 7, 'same': False}, 'dst': {'type': 'addresses_A_ht', 'congruent': 9, 'same': False}}
...
{'OP': 'REPM', 'src': {'type': 'addresses_normal_ht', 'congruent': 5, 'same': False}, 'dst': {'type': 'addresses_WT_ht', 'congruent': 8, 'same': True}}
