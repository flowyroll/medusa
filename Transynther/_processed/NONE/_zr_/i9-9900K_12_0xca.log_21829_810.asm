...
push %rdx
push %rsi
lea addresses_UC_ht+0x24b5, %rdx
nop
nop
nop
nop
...
nop
inc %r8
lea addresses_normal_ht+0x181c5, %r14
nop
nop
xor $30998, %rdi
movb (%r14), %bl
nop
dec %rbx
lea addresses_WC_ht+0x56c5, %r14
clflush (%r14)
nop
nop
add $25388, %r9
...
nop
and %r8, %r8
lea addresses_A_ht+0x185, %rdi
inc %rdx
movb (%rdi), %r15b
nop
nop
xor $5620, %rbx
lea addresses_UC_ht+0x115c5, %r9
nop
inc %r15
mov (%r9), %r14w
nop
nop
dec %r14
lea addresses_normal_ht+0x17f95, %rdx
xor %r9, %r9
movb $0x61, (%rdx)
nop
nop
...
nop
sub $60929, %r15
lea addresses_WT_ht+0xd045, %rsi
...
nop
dec %rsi
lea addresses_WT_ht+0x1d82d, %rsi
nop
nop
nop
nop
...
movups %xmm7, (%rsi)
and %rdx, %rdx
lea addresses_WT_ht+0x171c5, %r8
nop
nop
nop
nop
...
// Load
lea addresses_A+0x11515, %rax
cmp %r14, %r14
mov (%rax), %r10
dec %r14

// Store
mov $0x553dd200000007a9, %r14
nop
nop
nop
nop
...
{'OP': 'LOAD', 'src': {'size': 8, 'NT': True, 'type': 'addresses_A', 'same': False, 'AVXalign': True, 'congruent': 4}}
...
{'OP': 'REPM', 'src': {'same': False, 'type': 'addresses_WT_ht', 'congruent': 6}, 'dst': {'same': False, 'type': 'addresses_WC_ht', 'congruent': 9}}
