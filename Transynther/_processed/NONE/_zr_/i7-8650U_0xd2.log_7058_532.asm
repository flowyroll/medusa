...
push %rdi
push %rsi
lea addresses_A_ht+0x40a7, %rsi
lea addresses_D_ht+0x12d77, %rdi
nop
nop
nop
nop
...
nop
dec %r10
lea addresses_WT_ht+0x2b27, %rsi
lea addresses_A_ht+0x11c73, %rdi
and %r10, %r10
mov $46, %rcx
rep movsl
nop
...
nop
sub $60338, %r10
lea addresses_D_ht+0x1c1e7, %r11
nop
nop
nop
nop
...
nop
sub $34755, %r11
lea addresses_A_ht+0x14947, %r11
nop
nop
nop
nop
...
{'OP': 'STOR', 'dst': {'type': 'addresses_D_ht', 'size': 16, 'AVXalign': True, 'NT': False, 'congruent': 9, 'same': False}}
