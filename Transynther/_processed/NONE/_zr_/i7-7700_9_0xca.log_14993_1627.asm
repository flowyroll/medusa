...
push %rdx
push %rsi
lea addresses_D_ht+0x1231e, %rsi
sub $36533, %rcx
vmovups (%rsi), %ymm1
...
nop
add $58516, %rcx
lea addresses_A_ht+0x71a4, %rsi
lea addresses_D_ht+0x1bea4, %rdi
sub $31684, %r15
mov $52, %rcx
rep movsw
inc %rcx
lea addresses_A_ht+0x161e4, %r9
nop
nop
nop
sub %r13, %r13
...
nop
and $23251, %r13
lea addresses_normal_ht+0x14e14, %r15
nop
nop
nop
nop
...
// Store
lea addresses_normal+0xc2a4, %rcx
nop
nop
nop
add %rbp, %rbp
...
{'OP': 'STOR', 'dst': {'congruent': 4, 'AVXalign': False, 'same': False, 'size': 4, 'NT': True, 'type': 'addresses_UC'}}
