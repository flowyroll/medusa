...
nop
sub %rax, %rax
lea addresses_UC_ht+0x626f, %r15
nop
xor %rdx, %rdx
...
nop
inc %r15
lea addresses_normal_ht+0xfeef, %r15
nop
sub $55358, %rcx
mov (%r15), %rbp
nop
add $50481, %r15
lea addresses_WT_ht+0xb78f, %r11
nop
nop
nop
nop
...
movups %xmm2, (%rax)
cmp %r15, %r15
lea addresses_A_ht+0x17def, %rbp
nop
nop
nop
xor $17342, %r15
...
{'OP': 'LOAD', 'src': {'type': 'addresses_RW', 'AVXalign': False, 'congruent': 7, 'size': 2, 'same': False, 'NT': False}}
...
{'OP': 'STOR', 'dst': {'type': 'addresses_WT_ht', 'AVXalign': False, 'congruent': 4, 'size': 16, 'same': True, 'NT': False}}
