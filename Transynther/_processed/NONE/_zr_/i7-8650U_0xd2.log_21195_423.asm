...
nop
xor $46652, %r10
lea addresses_normal_ht+0xf964, %r14
and $11850, %r10
...
nop
mfence
lea addresses_WT_ht+0x16514, %rsi
...
nop
and %rcx, %rcx
lea addresses_WT_ht+0x1b3c, %rsi
lea addresses_WC_ht+0xfebc, %rdi
clflush (%rdi)
nop
nop
nop
...
rep movsq
inc %rdi
lea addresses_WC_ht+0x101b4, %rsi
lea addresses_UC_ht+0x1573c, %rdi
nop
nop
nop
cmp %r10, %r10
...
// Store
lea addresses_normal+0x13f3c, %rcx
clflush (%rcx)
nop
dec %r12
