...
push %rdi
push %rsi
lea addresses_WT_ht+0x14a40, %rsi
nop
nop
nop
cmp $54557, %r10
...
nop
sub %rsi, %rsi
lea addresses_WT_ht+0x1208c, %rsi
lea addresses_D_ht+0xeea0, %rdi
nop
nop
nop
nop
...
{'OP': 'LOAD', 'src': {'type': 'addresses_UC', 'AVXalign': True, 'congruent': 7, 'size': 32, 'same': False, 'NT': False}}
{'OP': 'LOAD', 'src': {'type': 'addresses_P', 'AVXalign': False, 'congruent': 6, 'size': 2, 'same': False, 'NT': False}}
