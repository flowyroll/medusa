...
lea addresses_WC_ht+0x7a5a, %rdi
clflush (%rdi)
nop
nop
nop
...
rep movsl
xor $445, %rax
lea addresses_normal_ht+0x4b7a, %rcx
nop
xor %r12, %r12
movb (%rcx), %al
nop
nop
sub $30490, %rax
lea addresses_D_ht+0x1d41a, %rbp
nop
nop
and %r12, %r12
movl $0x61626364, (%rbp)
nop
cmp $41588, %rdi
lea addresses_D_ht+0x1c9ca, %r12
nop
nop
nop
nop
...
// Load
lea addresses_normal+0x646a, %r8
nop
nop
inc %rcx
mov (%r8), %bp
