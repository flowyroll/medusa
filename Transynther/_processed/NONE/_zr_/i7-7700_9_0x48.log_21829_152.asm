...
push %rdi
push %rsi
lea addresses_D_ht+0x1a202, %rsi
lea addresses_WC_ht+0x118c2, %rdi
nop
nop
nop
nop
...
nop
sub %rdi, %rdi
lea addresses_A_ht+0x12e32, %rsi
lea addresses_A_ht+0x15b12, %rdi
nop
nop
nop
nop
...
lea addresses_WC_ht+0x11402, %rdi
nop
nop
nop
dec %r10
...
nop
dec %r10
lea addresses_UC_ht+0x3226, %r10
nop
nop
nop
nop
...
nop
dec %rsi
lea addresses_WT_ht+0x6e32, %r12
nop
nop
nop
add $25527, %r8
...
{'OP': 'STOR', 'dst': {'type': 'addresses_WT_ht', 'AVXalign': False, 'congruent': 3, 'size': 32, 'same': True, 'NT': True}}
