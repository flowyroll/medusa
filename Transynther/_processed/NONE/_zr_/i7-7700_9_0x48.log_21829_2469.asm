...
push %rdi
push %rsi
lea addresses_normal_ht+0x887e, %rsi
nop
nop
nop
nop
...
nop
and $30764, %rax
lea addresses_WC_ht+0x14f3e, %r11
nop
and $37029, %r14
movups (%r11), %xmm7
vpextrq $0, %xmm7, %r8
...
nop
xor %r14, %r14
lea addresses_A_ht+0x1793e, %rsi
lea addresses_normal_ht+0x12fbe, %rdi
clflush (%rdi)
nop
nop
nop
...
lea addresses_WC_ht+0x64, %rdi
add $14328, %r11
mov $27, %rcx
rep movsb
cmp $7727, %rcx
lea addresses_WT_ht+0x1a19e, %r11
nop
nop
inc %rdi
movb (%r11), %r14b
...
{'OP': 'LOAD', 'src': {'type': 'addresses_WT_ht', 'AVXalign': False, 'congruent': 5, 'size': 1, 'same': True, 'NT': False}}
{'00': 21829}
