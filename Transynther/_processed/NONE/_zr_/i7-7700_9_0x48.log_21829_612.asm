...
push %rdi
push %rsi
lea addresses_normal_ht+0x5fc3, %rsi
lea addresses_D_ht+0x173fc, %rdi
nop
nop
nop
nop
...
rep movsw
add $57282, %rbp
lea addresses_normal_ht+0x1b6ca, %r8
and %rcx, %rcx
...
nop
inc %r8
lea addresses_UC_ht+0x115f8, %rsi
lea addresses_A_ht+0x1d59c, %rdi
nop
inc %r11
mov $95, %rcx
rep movsb
...
mov (%r9), %r11w
xor $50953, %r9
lea addresses_WC_ht+0x1f7c, %r11
nop
nop
nop
nop
...
vpextrq $0, %xmm4, %rbp
xor %rbp, %rbp
lea addresses_WT_ht+0x1073b, %rcx
nop
nop
nop
cmp $5606, %r8
...
nop
inc %rdi
lea addresses_WT_ht+0x16b56, %rsi
lea addresses_UC_ht+0x1efc, %rdi
clflush (%rdi)
nop
nop
nop
