...
nop
inc %r8
lea addresses_WT_ht+0xc598, %r13
nop
xor %r8, %r8
...
nop
and $56082, %r8
lea addresses_D_ht+0x10d18, %rcx
nop
nop
nop
nop
...
nop
sub $16815, %r12
lea addresses_WT_ht+0x1ee88, %rsi
lea addresses_normal_ht+0x196f8, %rdi
nop
nop
nop
dec %rbx
...
// REPMOV
lea addresses_normal+0x1cc, %rsi
lea addresses_A+0x12b18, %rdi
nop
nop
nop
sub %r11, %r11
...
{'OP': 'REPM', 'src': {'type': 'addresses_normal', 'congruent': 2, 'same': False}, 'dst': {'type': 'addresses_A', 'congruent': 9, 'same': False}}
[Faulty Load]
