...
push %rdx
push %rsi
lea addresses_D_ht+0x1784c, %r15
nop
nop
nop
nop
...
nop
dec %r9
lea addresses_normal_ht+0x1adb6, %rdx
nop
nop
nop
nop
...
nop
cmp $15854, %r15
lea addresses_WC_ht+0xd1cc, %rsi
lea addresses_A_ht+0x344c, %rdi
nop
nop
nop
nop
...
rep movsw
cmp %rax, %rax
lea addresses_D_ht+0x1c74c, %rsi
lea addresses_A_ht+0x9404, %rdi
nop
xor %rbp, %rbp
mov $1, %rcx
rep movsb
...
nop
and $4638, %rbp
lea addresses_WC_ht+0xdbcc, %rdx
inc %rax
mov (%rdx), %r9w
nop
nop
cmp $34811, %r9
lea addresses_D_ht+0x1542c, %rax
nop
dec %rdx
...
nop
and $23381, %rbp
lea addresses_normal_ht+0x11714, %rbp
nop
nop
nop
and $42728, %rdi
...
nop
xor $24165, %r15
lea addresses_UC_ht+0x4c4c, %rdi
nop
xor $32728, %rbp
movw $0x6162, (%rdi)
nop
...
nop
cmp %rax, %rax
lea addresses_UC_ht+0x182ec, %rdi
nop
nop
nop
nop
...
nop
add $100, %rbp
lea addresses_WC_ht+0x1650c, %rsi
lea addresses_D_ht+0x7c4c, %rdi
nop
add %rbp, %rbp
mov $121, %rcx
rep movsb
...
nop
sub $14404, %rbp
lea addresses_WC_ht+0x1624c, %rbp
nop
nop
nop
nop
...
<gen_faulty_load>
[REF]
{'src': {'congruent': 0, 'AVXalign': True, 'same': False, 'size': 2, 'NT': True, 'type': 'addresses_WT'}, 'OP': 'LOAD'}
[Faulty Load]
...
{'src': {'congruent': 5, 'same': False, 'type': 'addresses_WC_ht'}, 'OP': 'REPM', 'dst': {'congruent': 10, 'same': False, 'type': 'addresses_D_ht'}}
