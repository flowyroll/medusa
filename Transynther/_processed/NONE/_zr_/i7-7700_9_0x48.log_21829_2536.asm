...
push %rdi
push %rsi
lea addresses_normal_ht+0xf787, %r14
nop
nop
nop
nop
...
movl $0x61626364, (%r14)
dec %rax
lea addresses_A_ht+0x1a8f, %rsi
lea addresses_WC_ht+0x1ef97, %rdi
sub $9285, %r8
mov $66, %rcx
rep movsw
mfence
lea addresses_A_ht+0x19757, %rax
clflush (%rax)
nop
cmp $39811, %r9
movw $0x6162, (%rax)
...
nop
and %rsi, %rsi
lea addresses_D_ht+0x1bd57, %rsi
nop
nop
nop
xor $9879, %r8
movl $0x61626364, (%rsi)
and %r8, %r8
lea addresses_UC_ht+0xea17, %r14
nop
and %r9, %r9
movb $0x61, (%r14)
nop
...
nop
xor $9305, %r14
lea addresses_WT_ht+0x17e17, %r9
nop
nop
nop
nop
...
nop
add $413, %rax
lea addresses_normal_ht+0x9d17, %r14
nop
nop
nop
nop
...
movl $0x61626364, (%r14)
and $50916, %rsi
lea addresses_D_ht+0x16c17, %rsi
sub $15480, %rcx
movw $0x6162, (%rsi)
nop
nop
sub $58400, %rax
lea addresses_UC_ht+0x1330f, %r14
nop
nop
dec %rcx
movb (%r14), %r8b
...
{'OP': 'STOR', 'dst': {'type': 'addresses_D_ht', 'AVXalign': True, 'congruent': 7, 'size': 2, 'same': False, 'NT': False}}
