...
nop
xor $52828, %rsi
lea addresses_WT_ht+0x1438a, %rsi
lea addresses_normal_ht+0xfc1e, %rdi
add $40667, %r13
mov $55, %rcx
rep movsq
nop
nop
cmp $25554, %rdi
lea addresses_D_ht+0x1975e, %r10
nop
nop
nop
nop
...
nop
cmp $36986, %r13
lea addresses_normal_ht+0x426, %r10
clflush (%r10)
nop
nop
dec %rdi
...
<gen_prepare_buffer>
{'OP': 'STOR', 'dst': {'type': 'addresses_normal_ht', 'size': 8, 'AVXalign': False, 'NT': True, 'congruent': 11, 'same': False}}
