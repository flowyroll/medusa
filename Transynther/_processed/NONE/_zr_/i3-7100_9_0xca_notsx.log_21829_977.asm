...
nop
inc %r9
lea addresses_WT_ht+0x1792e, %rdi
nop
xor %rax, %rax
mov (%rdi), %rsi
nop
...
nop
xor $19767, %rax
lea addresses_D_ht+0x16aee, %r12
nop
nop
nop
nop
...
nop
cmp %rdi, %rdi
lea addresses_D_ht+0x12d2e, %rdi
nop
inc %r9
movups (%rdi), %xmm7
vpextrq $1, %xmm7, %rax
...
nop
add $7404, %rbp
lea addresses_D_ht+0x1dcee, %rbp
nop
nop
sub $19372, %rbx
movw $0x6162, (%rbp)
...
<gen_prepare_buffer>
{'src': {'same': True, 'congruent': 9, 'NT': False, 'type': 'addresses_D_ht', 'size': 16, 'AVXalign': False}, 'OP': 'LOAD'}
