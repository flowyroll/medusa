...
push %rdx
push %rsi
lea addresses_WC_ht+0x5c0c, %rdx
clflush (%rdx)
nop
nop
nop
...
nop
inc %rdi
lea addresses_normal_ht+0x6860, %rsi
lea addresses_WT_ht+0xe100, %rdi
clflush (%rsi)
nop
nop
sub $42101, %r15
...
nop
cmp %rdi, %rdi
lea addresses_WC_ht+0xcbe0, %r11
nop
nop
nop
nop
...
nop
sub $39919, %rdx
lea addresses_normal_ht+0x2ce8, %rcx
dec %r15
...
nop
inc %rax
lea addresses_UC_ht+0x19660, %rsi
lea addresses_WC_ht+0x2d60, %rdi
nop
nop
nop
and %r14, %r14
...
nop
and $40372, %r15
lea addresses_D_ht+0x1be80, %rcx
nop
and $54687, %rdi
vmovups (%rcx), %ymm3
...
nop
cmp %rcx, %rcx
lea addresses_A_ht+0x1aca0, %rax
nop
xor %r15, %r15
movl $0x61626364, (%rax)
nop
...
nop
cmp $1158, %r11
lea addresses_UC_ht+0xfb60, %r11
nop
nop
nop
nop
...
nop
add $61917, %r14
lea addresses_WC_ht+0x1de4c, %rsi
nop
nop
cmp $28895, %r11
movb $0x61, (%rsi)
