...
push %rdi
push %rsi
lea addresses_normal_ht+0x2131, %rsi
...
nop
and $30116, %r10
lea addresses_WC_ht+0x17d59, %r11
nop
and $7116, %rcx
mov (%r11), %r15w
nop
...
nop
xor %r15, %r15
lea addresses_WC_ht+0x15731, %rdi
nop
dec %r12
...
nop
and %r11, %r11
lea addresses_WT_ht+0xeab1, %rsi
lea addresses_D_ht+0xd301, %rdi
nop
nop
nop
nop
...
nop
add %rdi, %rdi
lea addresses_normal_ht+0x111b1, %r12
nop
nop
nop
and $3253, %rsi
...
{'OP': 'LOAD', 'src': {'type': 'addresses_WC_ht', 'AVXalign': True, 'congruent': 3, 'size': 2, 'same': False, 'NT': False}}
