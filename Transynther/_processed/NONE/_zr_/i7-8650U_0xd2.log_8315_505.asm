...
nop
and $62, %r10
lea addresses_normal_ht+0x126fe, %rbp
nop
nop
nop
nop
...
nop
cmp $41361, %r10
lea addresses_D_ht+0x49fe, %rsi
lea addresses_WT_ht+0xcefe, %rdi
nop
nop
nop
nop
...
nop
add $39689, %r10
lea addresses_WC_ht+0x1ead0, %r15
clflush (%r15)
nop
inc %rsi
mov (%r15), %r11d
...
nop
and %r11, %r11
lea addresses_WC_ht+0x4097, %rax
sub $20983, %rbp
mov (%rax), %rsi
nop
nop
and %rcx, %rcx
lea addresses_WC_ht+0x1ffe, %rsi
lea addresses_A_ht+0x106fe, %rdi
clflush (%rdi)
nop
nop
sub %r15, %r15
