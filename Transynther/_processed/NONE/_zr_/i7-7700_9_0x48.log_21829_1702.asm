...
push %rdi
push %rsi
lea addresses_WT_ht+0xe19d, %rsi
lea addresses_normal_ht+0xbcfd, %rdi
nop
nop
dec %r8
mov $9, %rcx
...
nop
xor %r9, %r9
lea addresses_WC_ht+0xe7dd, %rbp
nop
nop
add $26778, %rbx
movl $0x61626364, (%rbp)
nop
xor %rbp, %rbp
lea addresses_D_ht+0x1dfa9, %rdi
nop
nop
nop
nop
...
nop
inc %r9
lea addresses_WC_ht+0x39cd, %rsi
lfence
vmovups (%rsi), %ymm0
