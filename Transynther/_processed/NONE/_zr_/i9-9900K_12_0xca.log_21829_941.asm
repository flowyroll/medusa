...
nop
add %rdx, %rdx
lea addresses_normal_ht+0xaba5, %r12
nop
nop
nop
nop
...
movb (%r12), %cl
inc %rcx
lea addresses_UC_ht+0x1278d, %rcx
nop
nop
nop
nop
...
nop
cmp $48359, %r11
lea addresses_UC_ht+0x11a5, %rsi
and $61694, %r11
mov (%rsi), %ecx
nop
nop
...
nop
add %r11, %r11
lea addresses_WT_ht+0xf1a5, %rsi
lea addresses_A_ht+0x18dd4, %rdi
nop
nop
nop
sub $34606, %r8
...
{'OP': 'STOR', 'dst': {'size': 4, 'NT': True, 'type': 'addresses_PSE', 'same': False, 'AVXalign': True, 'congruent': 6}}
[Faulty Load]
...
{'OP': 'LOAD', 'src': {'size': 4, 'NT': False, 'type': 'addresses_UC_ht', 'same': True, 'AVXalign': False, 'congruent': 9}}
