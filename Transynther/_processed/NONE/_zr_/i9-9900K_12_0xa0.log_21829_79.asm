...
nop
cmp $36178, %rdi
lea addresses_WC_ht+0x1c365, %rcx
nop
nop
nop
sub %rdx, %rdx
...
nop
cmp %rsi, %rsi
lea addresses_WC_ht+0xd8e5, %rsi
nop
nop
nop
inc %r9
...
nop
and $56022, %rdx
lea addresses_WT_ht+0x1a61d, %rsi
lea addresses_WC_ht+0xa745, %rdi
nop
nop
nop
nop
