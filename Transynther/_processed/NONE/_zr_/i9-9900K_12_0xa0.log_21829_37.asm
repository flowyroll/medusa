...
push %rdi
push %rsi
lea addresses_WC_ht+0x16cfe, %r13
nop
add %rbx, %rbx
...
nop
and $62170, %r10
lea addresses_D_ht+0xa04a, %rsi
lea addresses_normal_ht+0x13b0a, %rdi
add %r11, %r11
mov $39, %rcx
rep movsw
nop
...
// REPMOV
lea addresses_D+0x10a4a, %rsi
lea addresses_PSE+0x39ea, %rdi
nop
add $48280, %r14
mov $21, %rcx
rep movsb
