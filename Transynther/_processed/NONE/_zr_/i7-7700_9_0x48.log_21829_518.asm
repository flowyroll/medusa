...
push %rdi
push %rsi
lea addresses_UC_ht+0x13c85, %rsi
lea addresses_normal_ht+0x11385, %rdi
xor $55969, %rax
mov $53, %rcx
rep movsl
nop
sub %r11, %r11
lea addresses_WC_ht+0x18485, %r14
nop
nop
and $14037, %r8
mov (%r14), %r11d
...
nop
and $5791, %rsi
lea addresses_D_ht+0x18e3d, %rsi
nop
cmp %rax, %rax
movb $0x61, (%rsi)
nop
nop
and %rax, %rax
lea addresses_WT_ht+0x13a09, %rsi
lea addresses_D_ht+0x1d485, %rdi
nop
nop
nop
cmp $33806, %r12
...
nop
sub $56487, %r8
lea addresses_normal_ht+0x13e25, %r8
nop
sub $11839, %r12
...
nop
sub $38437, %r8
lea addresses_D_ht+0x130a5, %rsi
cmp $64523, %r12
movl $0x61626364, (%rsi)
nop
nop
...
nop
add $28338, %r8
lea addresses_UC_ht+0x19105, %r12
nop
and %r14, %r14
...
nop
inc %rsi
lea addresses_A_ht+0x4a85, %rsi
lea addresses_normal_ht+0xb185, %rdi
nop
nop
nop
nop
...
rep movsb
xor %rsi, %rsi
lea addresses_normal_ht+0x9485, %rsi
lea addresses_A_ht+0x16185, %rdi
nop
sub %r8, %r8
mov $53, %rcx
rep movsq
add $2700, %rax
lea addresses_UC_ht+0x13dc5, %rax
dec %rdi
mov $0x6162636465666768, %rcx
movq %rcx, %xmm1
movups %xmm1, (%rax)
...
nop
cmp %rcx, %rcx
lea addresses_normal_ht+0xafc5, %r14
nop
nop
nop
nop
...
nop
add %rcx, %rcx
lea addresses_WC_ht+0x1345, %r12
nop
nop
nop
nop
...
{'OP': 'REPM', 'src': {'type': 'addresses_WT_ht', 'congruent': 1, 'same': False}, 'dst': {'type': 'addresses_D_ht', 'congruent': 8, 'same': False}}
...
{'OP': 'REPM', 'src': {'type': 'addresses_A_ht', 'congruent': 11, 'same': False}, 'dst': {'type': 'addresses_normal_ht', 'congruent': 6, 'same': False}}
