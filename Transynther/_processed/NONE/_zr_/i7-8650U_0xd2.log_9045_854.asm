...
push %rdx
push %rsi
lea addresses_UC_ht+0x83ce, %rbx
inc %r12
movw $0x6162, (%rbx)
nop
nop
sub $29741, %rbp
lea addresses_WT_ht+0x17ce, %rdi
nop
add %rbx, %rbx
...
movups %xmm4, (%rdi)
xor %rbp, %rbp
lea addresses_WC_ht+0x984c, %rcx
nop
nop
nop
nop
...
// Store
lea addresses_normal+0x195ce, %rdx
nop
sub $52588, %r12
movw $0x5152, (%rdx)
nop
...
{'OP': 'STOR', 'dst': {'type': 'addresses_UC', 'size': 16, 'AVXalign': True, 'NT': True, 'congruent': 6, 'same': False}}
