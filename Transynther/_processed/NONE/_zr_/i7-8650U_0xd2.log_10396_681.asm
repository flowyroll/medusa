...
push %rdx
push %rsi
lea addresses_UC_ht+0x9e05, %rsi
lea addresses_D_ht+0x1ef05, %rdi
sub %r13, %r13
mov $124, %rcx
rep movsq
nop
...
nop
sub $14595, %r12
lea addresses_D_ht+0x1b395, %rdx
clflush (%rdx)
nop
add $24717, %r15
mov (%rdx), %r12w
...
{'OP': 'STOR', 'dst': {'type': 'addresses_US', 'size': 32, 'AVXalign': True, 'NT': False, 'congruent': 9, 'same': False}}
