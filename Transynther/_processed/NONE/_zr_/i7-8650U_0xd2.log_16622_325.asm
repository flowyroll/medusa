...
push %rdi
push %rsi
lea addresses_normal_ht+0x18f2, %rsi
...
nop
xor $11172, %r11
lea addresses_WC_ht+0x1ee52, %rcx
add %r11, %r11
vmovups (%rcx), %ymm1
...
nop
add %rcx, %rcx
lea addresses_UC_ht+0x1e2f2, %rax
nop
nop
nop
nop
...
nop
sub %r8, %r8
lea addresses_D_ht+0x198f2, %rsi
...
nop
xor %r8, %r8
lea addresses_WC_ht+0xe726, %r8
nop
nop
add %rbx, %rbx
movb $0x61, (%r8)
cmp $58648, %r8
lea addresses_normal_ht+0xc9f2, %rdi
clflush (%rdi)
nop
nop
nop
...
mov (%rdi), %r11w
xor %rsi, %rsi
lea addresses_UC_ht+0x111e2, %rax
clflush (%rax)
nop
nop
nop
...
nop
sub %rcx, %rcx
lea addresses_UC_ht+0x569f, %rdi
nop
nop
nop
nop
...
nop
and %rsi, %rsi
lea addresses_UC_ht+0x1fd2, %rdi
nop
nop
nop
nop
