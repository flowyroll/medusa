...
push %rdx
push %rsi
lea addresses_WT_ht+0x11283, %rsi
sub $11227, %rbx
movl $0x61626364, (%rsi)
nop
nop
...
nop
add $45230, %r14
lea addresses_normal_ht+0xab83, %r10
sub $5341, %r13
movl $0x61626364, (%r10)
nop
nop
...
nop
add $29665, %rsi
lea addresses_WC_ht+0x2383, %rsi
lea addresses_normal_ht+0x19003, %rdi
nop
nop
nop
and %rbx, %rbx
...
nop
inc %rsi
lea addresses_normal_ht+0x14f83, %rcx
nop
nop
nop
nop
...
nop
xor $32655, %rdx
lea addresses_UC_ht+0x1193b, %r13
xor %r10, %r10
mov (%r13), %di
nop
add %r14, %r14
lea addresses_WT_ht+0x19a83, %r10
nop
nop
lfence
mov (%r10), %rdx
...
nop
dec %rsi
lea addresses_UC_ht+0x50a3, %r13
nop
nop
nop
sub %rdi, %rdi
...
nop
xor %rdi, %rdi
lea addresses_WT_ht+0x15983, %rdi
dec %rcx
movw $0x6162, (%rdi)
nop
nop
...
nop
add %rcx, %rcx
lea addresses_WC_ht+0xab37, %rbx
nop
nop
nop
nop
...
nop
sub %rcx, %rcx
lea addresses_D_ht+0x811b, %rsi
lea addresses_UC_ht+0x169ab, %rdi
sub $4149, %rdx
mov $110, %rcx
rep movsw
nop
...
// Load
lea addresses_normal+0x8a6f, %r9
nop
nop
nop
cmp %r14, %r14
...
{'src': {'congruent': 2, 'AVXalign': True, 'same': False, 'size': 8, 'NT': False, 'type': 'addresses_normal'}, 'OP': 'LOAD'}
[Faulty Load]
...
{'OP': 'STOR', 'dst': {'congruent': 9, 'AVXalign': True, 'same': False, 'size': 4, 'NT': False, 'type': 'addresses_normal_ht'}}
{'src': {'congruent': 9, 'same': False, 'type': 'addresses_WC_ht'}, 'OP': 'REPM', 'dst': {'congruent': 7, 'same': False, 'type': 'addresses_normal_ht'}}
