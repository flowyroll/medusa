...
push %rdi
push %rsi
lea addresses_normal_ht+0x6431, %rsi
lea addresses_WT_ht+0x47ff, %rdi
inc %r13
mov $23, %rcx
rep movsw
nop
...
nop
cmp %rsi, %rsi
lea addresses_A_ht+0x1d311, %rsi
lea addresses_D_ht+0xe161, %rdi
nop
nop
inc %r10
mov $9, %rcx
rep movsb
sub $10959, %rsi
lea addresses_D_ht+0x189d1, %rsi
...
nop
inc %r8
lea addresses_WC_ht+0x1d751, %r10
add $8839, %rbp
mov (%r10), %r15w
add $20488, %rbp
lea addresses_WC_ht+0x1aa05, %rsi
lea addresses_WT_ht+0x19f15, %rdi
nop
and $7828, %r13
mov $59, %rcx
rep movsw
nop
sub $31411, %rdi
lea addresses_A_ht+0xf151, %rsi
lea addresses_WT_ht+0xc7d1, %rdi
cmp %r10, %r10
mov $106, %rcx
rep movsl
nop
...
// Load
lea addresses_normal+0xa529, %rcx
nop
nop
nop
nop
...
{'OP': 'LOAD', 'src': {'type': 'addresses_D_ht', 'AVXalign': False, 'congruent': 11, 'size': 8, 'same': True, 'NT': True}}
