...
nop
dec %rbp
lea addresses_A_ht+0x13927, %r13
nop
nop
nop
nop
...
mov (%r13), %ecx
xor %rcx, %rcx
lea addresses_WT_ht+0x12df2, %r14
nop
nop
cmp %rsi, %rsi
movl $0x61626364, (%r14)
...
nop
cmp $60757, %rcx
lea addresses_UC_ht+0xa572, %r13
add %rbp, %rbp
mov (%r13), %cx
nop
nop
inc %r12
lea addresses_WC_ht+0x1d472, %rcx
nop
nop
cmp $20603, %rdi
...
nop
cmp %rbp, %rbp
lea addresses_normal_ht+0x10f72, %rsi
...
// Store
lea addresses_normal+0x18172, %rbp
nop
nop
nop
nop
...
{'src': {'same': False, 'congruent': 7, 'NT': False, 'type': 'addresses_P', 'size': 1, 'AVXalign': False}, 'OP': 'LOAD'}
...
{'src': {'type': 'addresses_normal_ht', 'congruent': 9, 'same': False}, 'OP': 'REPM', 'dst': {'type': 'addresses_normal_ht', 'congruent': 9, 'same': False}}
{'00': 2495}
