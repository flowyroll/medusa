...
nop
sub %r9, %r9
lea addresses_A_ht+0x624f, %rsi
lea addresses_A_ht+0x8cff, %rdi
nop
nop
nop
nop
...
lea addresses_WC_ht+0x6a6f, %rdi
nop
nop
and $23675, %r12
mov $64, %rcx
...
nop
sub %r8, %r8
lea addresses_WT_ht+0x61ef, %r13
nop
nop
xor $52187, %rdi
...
nop
cmp $2260, %r8
lea addresses_D_ht+0x3faf, %rsi
lea addresses_A_ht+0x1fef, %rdi
nop
nop
nop
inc %rbx
...
nop
cmp $36678, %rsi
lea addresses_WT_ht+0x7ac7, %rsi
nop
nop
add $26316, %rcx
mov (%rsi), %r12w
...
// Store
lea addresses_normal+0xd1ef, %rdi
nop
nop
nop
and %r12, %r12
...
<gen_prepare_buffer>
{'OP': 'REPM', 'src': {'type': 'addresses_WT_ht', 'congruent': 3, 'same': False}, 'dst': {'type': 'addresses_WC_ht', 'congruent': 6, 'same': True}}
