...
push %rdx
push %rsi
lea addresses_UC_ht+0x11908, %r10
nop
nop
nop
nop
...
mov (%r10), %esi
dec %rax
lea addresses_WC_ht+0x9d08, %rdx
nop
nop
nop
nop
...
nop
dec %rax
lea addresses_normal_ht+0xc3c3, %rcx
and $21471, %rdx
...
nop
xor $34064, %rsi
lea addresses_A_ht+0x1308, %rdx
cmp $21877, %r10
movups (%rdx), %xmm1
vpextrq $0, %xmm1, %rcx
xor %rdx, %rdx
lea addresses_WC_ht+0x308, %r10
nop
nop
nop
and $55145, %rsi
...
nop
dec %rsi
lea addresses_A_ht+0x1cc58, %rsi
lea addresses_WC_ht+0x1c2c8, %rdi
sub $55237, %rax
mov $39, %rcx
rep movsw
xor %rsi, %rsi
lea addresses_normal_ht+0x2988, %rax
nop
add %rsi, %rsi
movb $0x61, (%rax)
nop
...
nop
and %rdx, %rdx
lea addresses_normal_ht+0x10108, %rsi
lea addresses_UC_ht+0x1b508, %rdi
clflush (%rsi)
nop
nop
add %r8, %r8
...
rep movsb
sub %rdi, %rdi
lea addresses_UC_ht+0x1943c, %rdx
nop
nop
nop
sub $15380, %r8
...
{'OP': 'STOR', 'dst': {'type': 'addresses_WC_ht', 'size': 8, 'AVXalign': False, 'NT': False, 'congruent': 9, 'same': True}}
