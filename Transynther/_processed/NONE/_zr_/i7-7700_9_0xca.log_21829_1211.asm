...
nop
lfence
lea addresses_A_ht+0x3393, %rsi
lea addresses_WC_ht+0x11793, %rdi
nop
add $54615, %rax
mov $80, %rcx
rep movsw
...
nop
sub %rsi, %rsi
lea addresses_UC_ht+0x195f3, %rax
nop
nop
nop
nop
...
vpextrq $1, %xmm1, %rdi
inc %rsi
lea addresses_WC_ht+0x11393, %r12
nop
nop
nop
nop
...
nop
dec %rcx
lea addresses_UC_ht+0x57cf, %rsi
lea addresses_normal_ht+0x12f13, %rdi
cmp $21968, %rax
mov $4, %rcx
rep movsw
nop
...
nop
dec %r14
lea addresses_WC_ht+0xb0eb, %rsi
lea addresses_normal_ht+0x4393, %rdi
clflush (%rdi)
nop
nop
inc %r11
...
nop
sub $31305, %rdi
lea addresses_WC_ht+0x1b193, %rax
nop
nop
nop
cmp $35807, %r11
...
movq %rcx, (%rax)
and %rcx, %rcx
lea addresses_normal_ht+0x240b, %r12
nop
nop
nop
nop
...
nop
sub %rax, %rax
lea addresses_WC_ht+0xca37, %rsi
lea addresses_A_ht+0x1799f, %rdi
add %r12, %r12
mov $111, %rcx
rep movsq
sub $22837, %r11
...
{'OP': 'STOR', 'dst': {'congruent': 1, 'AVXalign': True, 'same': False, 'size': 2, 'NT': False, 'type': 'addresses_WT_ht'}}
{'src': {'congruent': 11, 'same': False, 'type': 'addresses_A_ht'}, 'OP': 'REPM', 'dst': {'congruent': 10, 'same': False, 'type': 'addresses_WC_ht'}}
...
{'src': {'congruent': 3, 'same': False, 'type': 'addresses_WC_ht'}, 'OP': 'REPM', 'dst': {'congruent': 11, 'same': True, 'type': 'addresses_normal_ht'}}
...
{'src': {'congruent': 0, 'same': False, 'type': 'addresses_WC_ht'}, 'OP': 'REPM', 'dst': {'congruent': 0, 'same': False, 'type': 'addresses_A_ht'}}
{'00': 21829}
