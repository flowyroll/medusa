...
push %rdi
push %rsi
lea addresses_A_ht+0x17fb4, %r15
nop
nop
nop
nop
...
nop
inc %rbp
lea addresses_WT_ht+0x16b34, %rax
nop
and $49364, %r12
movups (%rax), %xmm5
vpextrq $0, %xmm5, %rsi
...
nop
cmp %rsi, %rsi
lea addresses_UC_ht+0x1d9b4, %rsi
lea addresses_A_ht+0x98b4, %rdi
nop
nop
nop
nop
...
nop
cmp $60084, %r8
lea addresses_normal_ht+0xf021, %rsi
lea addresses_normal_ht+0x155b4, %rdi
nop
nop
nop
nop
...
nop
add %rsi, %rsi
lea addresses_UC_ht+0x1374, %rsi
lea addresses_WC_ht+0x53b4, %rdi
clflush (%rdi)
nop
nop
nop
...
nop
inc %r8
lea addresses_UC_ht+0x64fc, %rsi
...
nop
and $50997, %r11
lea addresses_WC_ht+0x13cb4, %rax
nop
nop
nop
nop
...
{'OP': 'STOR', 'dst': {'NT': False, 'same': False, 'congruent': 2, 'type': 'addresses_P', 'AVXalign': True, 'size': 4}}
...
<gen_prepare_buffer>
{'src': {'NT': True, 'same': False, 'congruent': 11, 'type': 'addresses_A_ht', 'AVXalign': False, 'size': 1}, 'OP': 'LOAD'}
{'src': {'NT': False, 'same': False, 'congruent': 5, 'type': 'addresses_WT_ht', 'AVXalign': False, 'size': 16}, 'OP': 'LOAD'}
{'src': {'same': False, 'congruent': 6, 'type': 'addresses_UC_ht'}, 'OP': 'REPM', 'dst': {'same': False, 'congruent': 8, 'type': 'addresses_A_ht'}}
...
{'src': {'same': False, 'congruent': 0, 'type': 'addresses_normal_ht'}, 'OP': 'REPM', 'dst': {'same': False, 'congruent': 8, 'type': 'addresses_normal_ht'}}
