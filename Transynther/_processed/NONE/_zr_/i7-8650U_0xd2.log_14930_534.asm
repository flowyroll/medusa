...
nop
and %r14, %r14
lea addresses_UC_ht+0x6661, %r14
xor %rcx, %rcx
...
lea addresses_D_ht+0x141a7, %rdi
nop
nop
add $42787, %r13
mov $35, %rcx
...
nop
dec %r14
lea addresses_A_ht+0x131a7, %r14
nop
nop
nop
nop
...
nop
inc %rsi
lea addresses_D_ht+0x19667, %rsi
lea addresses_normal_ht+0x13e2c, %rdi
sub %r14, %r14
mov $12, %rcx
rep movsq
nop
...
nop
sub %r14, %r14
lea addresses_normal_ht+0x6c67, %rsi
lea addresses_UC_ht+0x13117, %rdi
nop
nop
nop
nop
...
nop
dec %r13
lea addresses_WC_ht+0x17a87, %r14
nop
nop
nop
nop
...
nop
add $52072, %r14
lea addresses_UC_ht+0xc127, %rcx
nop
sub %r13, %r13
movb (%rcx), %r14b
xor $20975, %r14
lea addresses_WT_ht+0x34c7, %r9
cmp $63722, %rcx
...
nop
sub $63440, %r14
lea addresses_UC_ht+0x1a603, %rcx
and %r9, %r9
movups (%rcx), %xmm5
vpextrq $1, %xmm5, %rdi
xor $63453, %rcx
lea addresses_D_ht+0x141a7, %r14
nop
nop
nop
nop
