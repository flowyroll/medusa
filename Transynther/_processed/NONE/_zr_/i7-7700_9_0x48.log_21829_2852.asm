...
push %rdi
push %rsi
lea addresses_normal_ht+0xe875, %r11
nop
nop
nop
nop
...
movw $0x6162, (%r11)
add %r9, %r9
lea addresses_UC_ht+0xf5c5, %rsi
lea addresses_WC_ht+0x112ff, %rdi
and $21921, %r15
mov $45, %rcx
rep movsb
nop
sub $35787, %r15
lea addresses_WT_ht+0x127c5, %rsi
lea addresses_A_ht+0xafc5, %rdi
nop
nop
nop
nop
