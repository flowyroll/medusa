...
nop
add $64122, %r15
lea addresses_WT_ht+0x120c4, %r12
clflush (%r12)
nop
nop
nop
...
nop
cmp %r8, %r8
lea addresses_D_ht+0x1d134, %r13
nop
nop
nop
add %rcx, %rcx
...
// Store
lea addresses_normal+0x7104, %r11
cmp $59337, %r8
...
{'OP': 'LOAD', 'src': {'type': 'addresses_D', 'AVXalign': False, 'congruent': 11, 'size': 2, 'same': False, 'NT': True}}
{'OP': 'STOR', 'dst': {'type': 'addresses_normal', 'AVXalign': False, 'congruent': 5, 'size': 32, 'same': False, 'NT': False}}
{'OP': 'LOAD', 'src': {'type': 'addresses_D', 'AVXalign': False, 'congruent': 7, 'size': 16, 'same': False, 'NT': False}}
