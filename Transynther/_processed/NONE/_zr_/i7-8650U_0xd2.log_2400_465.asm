...
nop
xor $39219, %r12
lea addresses_A_ht+0x11a51, %rbx
nop
xor $47394, %r11
...
nop
inc %r14
lea addresses_WT_ht+0x11400, %rdi
nop
nop
xor $39844, %r11
mov (%rdi), %esi
