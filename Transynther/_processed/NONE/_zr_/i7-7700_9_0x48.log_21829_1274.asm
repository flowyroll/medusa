...
nop
dec %rbx
lea addresses_A_ht+0x3070, %rsi
lea addresses_normal_ht+0x44f0, %rdi
inc %r9
mov $85, %rcx
rep movsq
nop
...
nop
and %rsi, %rsi
lea addresses_A_ht+0xa4ca, %r8
nop
nop
inc %rsi
movl $0x61626364, (%r8)
and $10073, %r9
lea addresses_UC_ht+0x1cf0, %rcx
nop
nop
nop
lfence
...
nop
xor %r9, %r9
lea addresses_WC_ht+0x16070, %r10
nop
nop
nop
inc %rbx
...
vmovups %ymm5, (%r10)
inc %r11
lea addresses_normal_ht+0x90e4, %rsi
lea addresses_WT_ht+0x8f0, %rdi
nop
nop
nop
nop
...
nop
and %rbx, %rbx
lea addresses_UC_ht+0x1a620, %r9
nop
nop
nop
add $11218, %r11
...
nop
xor %r9, %r9
lea addresses_A_ht+0xe324, %rsi
lea addresses_A_ht+0x89d8, %rdi
nop
nop
add $53527, %r8
mov $6, %rcx
