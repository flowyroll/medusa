...
push %rbp
push %rcx
lea addresses_UC_ht+0x1040c, %r10
nop
nop
nop
dec %rbp
...
nop
dec %r14
lea addresses_normal_ht+0xb60c, %rcx
nop
and %r13, %r13
mov (%rcx), %r9
add %r10, %r10
lea addresses_WT_ht+0x161c, %r13
nop
nop
nop
nop
...
nop
cmp $15672, %rcx
lea addresses_WC_ht+0x930c, %rbp
nop
nop
xor $52909, %r12
mov (%rbp), %r14d
...
nop
add %r10, %r10
lea addresses_A_ht+0x19d7c, %r14
nop
nop
nop
nop
...
nop
and $51372, %r10
lea addresses_WT_ht+0x1045c, %rbp
nop
add $65412, %r12
movl $0x61626364, (%rbp)
nop
...
nop
inc %r14
lea addresses_normal_ht+0x3acc, %rcx
nop
sub %r13, %r13
vmovups (%rcx), %ymm3
