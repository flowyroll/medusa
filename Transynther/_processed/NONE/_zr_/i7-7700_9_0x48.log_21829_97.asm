...
nop
xor %r14, %r14
lea addresses_UC_ht+0x13328, %r13
clflush (%r13)
nop
nop
and %rax, %rax
...
nop
mfence
lea addresses_WT_ht+0xb428, %rbp
nop
xor $63314, %rax
...
nop
inc %rdx
lea addresses_normal_ht+0xbbe8, %rsi
lea addresses_UC_ht+0x1388, %rdi
nop
nop
nop
nop
