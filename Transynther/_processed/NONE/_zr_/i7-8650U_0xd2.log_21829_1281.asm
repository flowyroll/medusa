...
nop
add $28202, %r14
lea addresses_UC_ht+0x19358, %rsi
nop
dec %r13
mov (%rsi), %di
xor %r13, %r13
lea addresses_normal_ht+0x166f8, %r13
nop
nop
nop
cmp %rsi, %rsi
...
nop
add %r14, %r14
lea addresses_WC_ht+0xc238, %rsi
lea addresses_D_ht+0x11010, %rdi
inc %r13
mov $110, %rcx
rep movsl
nop
...
nop
add $35602, %r11
lea addresses_normal_ht+0xfc18, %r14
nop
inc %r9
...
vpextrq $1, %xmm2, %rdi
cmp $18786, %rcx
lea addresses_WT_ht+0x4638, %rdi
and $14169, %r9
movups (%rdi), %xmm2
vpextrq $0, %xmm2, %rcx
nop
