...
push %rdi
push %rsi
lea addresses_WT_ht+0x12c18, %rbp
nop
xor $41858, %rax
movb $0x61, (%rbp)
nop
...
nop
sub $7044, %rdi
lea addresses_UC_ht+0x118, %rsi
lea addresses_WC_ht+0x71b8, %rdi
nop
nop
nop
nop
...
nop
cmp $53172, %rsi
lea addresses_WC_ht+0x8498, %r14
nop
nop
sub $17532, %rax
...
vmovups %ymm4, (%r14)
cmp $41599, %rsi
lea addresses_UC_ht+0x5018, %rsi
clflush (%rsi)
xor $38513, %r13
movw $0x6162, (%rsi)
nop
