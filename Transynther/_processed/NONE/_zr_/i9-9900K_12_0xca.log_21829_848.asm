...
movb $0x61, (%r9)
xor %rcx, %rcx
lea addresses_UC_ht+0xd48c, %r13
sub $64256, %rsi
mov $0x6162636465666768, %r11
movq %r11, (%r13)
nop
xor $23744, %rsi
lea addresses_WT_ht+0x9356, %r9
nop
nop
xor %r12, %r12
mov (%r9), %r11d
...
nop
cmp $64857, %rbx
lea addresses_normal_ht+0x8656, %rsi
lea addresses_UC_ht+0x1544e, %rdi
nop
nop
nop
nop
...
nop
sub $50244, %r9
lea addresses_UC_ht+0x1595e, %rdi
dec %r9
mov (%rdi), %r12d
nop
nop
...
nop
cmp $11929, %r11
lea addresses_UC_ht+0x1656, %rcx
nop
nop
sub $27010, %r13
...
nop
cmp %r13, %r13
lea addresses_A_ht+0x196b6, %rsi
lea addresses_normal_ht+0x1a256, %rdi
clflush (%rdi)
nop
nop
nop
...
nop
sub %r12, %r12
lea addresses_normal_ht+0x1d656, %rsi
nop
nop
and %r9, %r9
...
nop
inc %rcx
lea addresses_normal_ht+0x4656, %r12
clflush (%r12)
nop
xor %r9, %r9
movups (%r12), %xmm1
...
// Store
lea addresses_normal+0xa256, %rax
nop
nop
nop
sub $61792, %r10
...
{'OP': 'STOR', 'dst': {'size': 1, 'NT': False, 'type': 'addresses_normal', 'same': False, 'AVXalign': False, 'congruent': 8}}
[Faulty Load]
...
{'OP': 'STOR', 'dst': {'size': 16, 'NT': True, 'type': 'addresses_UC_ht', 'same': False, 'AVXalign': False, 'congruent': 11}}
