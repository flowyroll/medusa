...
nop
dec %rsi
lea addresses_WC_ht+0x8eb9, %rbx
nop
nop
nop
nop
...
lea addresses_WC_ht+0x150b9, %rdi
clflush (%rdi)
nop
nop
nop
...
nop
and %r13, %r13
lea addresses_WC_ht+0xc19, %rbp
add %rbx, %rbx
movups (%rbp), %xmm6
vpextrq $0, %xmm6, %rdi
add $646, %r12
lea addresses_A_ht+0xde51, %rsi
lea addresses_D_ht+0x1df41, %rdi
nop
cmp %r13, %r13
mov $32, %rcx
rep movsq
...
nop
cmp $9077, %r12
lea addresses_WC_ht+0x4cb9, %r12
nop
nop
nop
nop
...
nop
sub %rsi, %rsi
lea addresses_WT_ht+0x70b9, %rsi
lea addresses_A_ht+0x82b9, %rdi
nop
nop
nop
nop
...
nop
sub $28528, %rsi
lea addresses_normal_ht+0x5cb9, %rsi
lea addresses_WC_ht+0x12439, %rdi
clflush (%rsi)
nop
nop
cmp %rbx, %rbx
...
nop
sub $27659, %rax
lea addresses_WT_ht+0x1e4b9, %rcx
nop
nop
nop
nop
...
nop
and %r13, %r13
lea addresses_UC_ht+0x1d0b9, %rsi
nop
nop
nop
and %r12, %r12
...
{'OP': 'STOR', 'dst': {'congruent': 7, 'AVXalign': False, 'same': False, 'size': 1, 'NT': True, 'type': 'addresses_WT_ht'}}
...
{'src': {'congruent': 10, 'same': False, 'type': 'addresses_normal_ht'}, 'OP': 'REPM', 'dst': {'congruent': 6, 'same': False, 'type': 'addresses_WC_ht'}}
