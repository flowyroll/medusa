...
push %rdi
push %rsi
lea addresses_WC_ht+0x3ef7, %rsi
lea addresses_normal_ht+0x6fd3, %rdi
and %rbx, %rbx
mov $106, %rcx
rep movsq
nop
...
nop
inc %r10
lea addresses_A_ht+0x170b7, %r13
nop
nop
nop
add $3344, %rdi
...
nop
xor %rsi, %rsi
lea addresses_UC_ht+0x19af7, %rcx
nop
nop
nop
nop
...
nop
lfence
lea addresses_normal_ht+0x6ef7, %rsi
lea addresses_WT_ht+0xcf1b, %rdi
nop
nop
nop
nop
...
nop
sub $6663, %rcx
lea addresses_A_ht+0x1c777, %rsi
lea addresses_D_ht+0x6c79, %rdi
nop
nop
nop
cmp $59759, %r13
...
<gen_prepare_buffer>
{'OP': 'REPM', 'src': {'type': 'addresses_WC_ht', 'congruent': 6, 'same': False}, 'dst': {'type': 'addresses_normal_ht', 'congruent': 2, 'same': True}}
