...
push %rdx
push %rsi
lea addresses_WT_ht+0xcb26, %rbx
nop
nop
nop
nop
...
nop
xor %r8, %r8
lea addresses_WC_ht+0xac42, %r10
sub $37805, %r12
movw $0x6162, (%r10)
inc %rdx
lea addresses_A_ht+0xca16, %rdx
nop
nop
xor $25559, %rbx
movb (%rdx), %r10b
...
nop
xor %r8, %r8
lea addresses_D_ht+0x19d86, %r12
nop
nop
nop
nop
...
nop
sub $7042, %r10
lea addresses_WC_ht+0x1c306, %r12
nop
nop
nop
sub $8533, %rdx
...
vpextrq $0, %xmm5, %r10
add $1853, %r12
lea addresses_normal_ht+0x11a0e, %rbx
nop
nop
cmp $12837, %r10
...
nop
cmp %r12, %r12
lea addresses_A_ht+0x1eac6, %r10
nop
nop
nop
add %r12, %r12
...
nop
and %r12, %r12
lea addresses_UC_ht+0xc06, %rsi
lea addresses_WC_ht+0x8366, %rdi
nop
nop
nop
xor $46355, %r8
...
nop
cmp $8721, %rbx
lea addresses_A_ht+0x1a606, %r10
sub %rdi, %rdi
mov (%r10), %ecx
nop
add %rbx, %rbx
...
<gen_prepare_buffer>
{'OP': 'STOR', 'dst': {'congruent': 5, 'AVXalign': False, 'same': False, 'size': 8, 'NT': True, 'type': 'addresses_WT_ht'}}
{'OP': 'STOR', 'dst': {'congruent': 1, 'AVXalign': False, 'same': True, 'size': 2, 'NT': False, 'type': 'addresses_WC_ht'}}
...
{'src': {'congruent': 6, 'same': False, 'type': 'addresses_UC_ht'}, 'OP': 'REPM', 'dst': {'congruent': 4, 'same': False, 'type': 'addresses_WC_ht'}}
