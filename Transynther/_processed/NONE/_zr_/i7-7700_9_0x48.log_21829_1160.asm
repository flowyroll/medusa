...
push %rdi
push %rsi
lea addresses_normal_ht+0xecdf, %rcx
nop
nop
nop
nop
...
nop
cmp %r14, %r14
lea addresses_D_ht+0x13caf, %rsi
lea addresses_WC_ht+0x20af, %rdi
clflush (%rdi)
nop
nop
nop
...
nop
add $44067, %r11
lea addresses_WT_ht+0x1a8af, %rsi
nop
nop
nop
nop
...
{'OP': 'STOR', 'dst': {'type': 'addresses_RW', 'AVXalign': True, 'congruent': 4, 'size': 32, 'same': False, 'NT': False}}
...
{'OP': 'STOR', 'dst': {'type': 'addresses_WT_ht', 'AVXalign': True, 'congruent': 11, 'size': 4, 'same': False, 'NT': False}}
{'00': 21829}
