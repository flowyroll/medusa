...
push %rdi
push %rsi
lea addresses_WC_ht+0x1e1d2, %r13
nop
cmp %rbp, %rbp
...
lea addresses_A_ht+0x121b2, %rdi
nop
nop
xor $719, %r8
mov $1, %rcx
...
nop
and %r13, %r13
lea addresses_D_ht+0x1ee52, %r8
nop
xor $16925, %r13
movb $0x61, (%r8)
and $21820, %r8
lea addresses_WC_ht+0x1b7d6, %rsi
lea addresses_WC_ht+0x1ee52, %rdi
clflush (%rdi)
nop
nop
nop
...
nop
xor %rbp, %rbp
lea addresses_WC_ht+0x18182, %r13
nop
nop
and $12600, %r8
movw $0x6162, (%r13)
...
nop
add $62770, %r13
lea addresses_D_ht+0x13fa6, %r13
nop
nop
nop
inc %rcx
...
nop
and $60238, %rcx
lea addresses_A_ht+0x17b52, %rsi
nop
nop
dec %r13
movb (%rsi), %r8b
...
nop
inc %rdi
lea addresses_WC_ht+0x1be52, %r15
nop
nop
nop
inc %r8
...
{'src': {'same': False, 'congruent': 2, 'type': 'addresses_WC_ht'}, 'OP': 'REPM', 'dst': {'same': False, 'congruent': 11, 'type': 'addresses_WC_ht'}}
{'OP': 'STOR', 'dst': {'NT': True, 'same': False, 'congruent': 3, 'type': 'addresses_WC_ht', 'AVXalign': False, 'size': 2}}
