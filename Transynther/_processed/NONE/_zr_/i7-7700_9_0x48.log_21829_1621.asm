...
push %rdi
push %rsi
lea addresses_D_ht+0x1ea09, %r12
nop
nop
cmp $33620, %r8
mov (%r12), %ebp
...
nop
xor $60444, %r13
lea addresses_UC_ht+0x7e63, %rsi
lea addresses_D_ht+0x8ed1, %rdi
nop
nop
cmp %r11, %r11
mov $74, %rcx
...
nop
inc %r8
lea addresses_UC_ht+0x1c7d1, %r12
xor $39918, %rcx
movl $0x61626364, (%r12)
nop
xor $47989, %r11
lea addresses_D_ht+0x17571, %rcx
nop
nop
nop
nop
...
nop
cmp $18236, %rcx
lea addresses_UC_ht+0x77e1, %rdi
nop
nop
nop
dec %r13
...
nop
add $45917, %rdi
lea addresses_D_ht+0x1dbd1, %rsi
nop
nop
nop
nop
...
nop
lfence
lea addresses_WT_ht+0xfde4, %rcx
nop
nop
xor %r8, %r8
...
nop
xor $2891, %r13
lea addresses_normal_ht+0x16bd1, %r13
nop
nop
cmp $33164, %r8
movw $0x6162, (%r13)
...
nop
and %rsi, %rsi
lea addresses_UC_ht+0xf3d1, %rsi
clflush (%rsi)
sub $21498, %r12
mov (%rsi), %rdi
nop
...
{'OP': 'STOR', 'dst': {'type': 'addresses_WT_ht', 'AVXalign': False, 'congruent': 0, 'size': 8, 'same': True, 'NT': False}}
