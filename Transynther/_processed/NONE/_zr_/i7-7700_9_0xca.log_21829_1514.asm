...
vpextrq $0, %xmm0, %rcx
sub %r11, %r11
lea addresses_WC_ht+0x32af, %rsi
nop
sub %rdx, %rdx
...
lea addresses_normal_ht+0x9487, %rdi
clflush (%rsi)
nop
nop
and $21724, %r11
...
rep movsl
add %rdi, %rdi
lea addresses_UC_ht+0x177f7, %rsi
lea addresses_normal_ht+0x18e47, %rdi
nop
nop
nop
nop
...
{'OP': 'STOR', 'dst': {'congruent': 3, 'AVXalign': False, 'same': False, 'size': 16, 'NT': True, 'type': 'addresses_P'}}
...
{'src': {'congruent': 3, 'AVXalign': False, 'same': True, 'size': 16, 'NT': True, 'type': 'addresses_WT_ht'}, 'OP': 'LOAD'}
...
{'src': {'congruent': 3, 'same': False, 'type': 'addresses_UC_ht'}, 'OP': 'REPM', 'dst': {'congruent': 6, 'same': False, 'type': 'addresses_normal_ht'}}
{'00': 21829}
