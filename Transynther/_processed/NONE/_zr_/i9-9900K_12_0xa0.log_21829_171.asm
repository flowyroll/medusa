...
push %rdx
push %rsi
lea addresses_normal_ht+0x422b, %rsi
lea addresses_WT_ht+0x1ae2b, %rdi
inc %r14
mov $32, %rcx
rep movsb
nop
...
nop
xor $44296, %rdi
lea addresses_A_ht+0x182c3, %rbp
nop
cmp %rdi, %rdi
movl $0x61626364, (%rbp)
nop
cmp %rdi, %rdi
lea addresses_UC_ht+0x16cbb, %r9
nop
nop
nop
nop
...
nop
xor $1902, %rdi
lea addresses_D_ht+0x1512b, %r14
nop
nop
nop
nop
...
movb $0x61, (%r14)
add %rax, %rax
lea addresses_D_ht+0x12c6b, %rax
nop
nop
nop
nop
...
nop
cmp $42939, %rsi
lea addresses_WT_ht+0x2277, %rdi
nop
nop
nop
nop
...
nop
xor %rax, %rax
lea addresses_normal_ht+0x1aa2b, %rsi
lea addresses_WT_ht+0xd9ff, %rdi
nop
nop
cmp $28434, %rdx
mov $73, %rcx
...
nop
and %rdi, %rdi
lea addresses_WT_ht+0x1b62b, %rsi
lea addresses_D_ht+0x18309, %rdi
clflush (%rdi)
nop
nop
nop
...
nop
sub %r9, %r9
lea addresses_WT_ht+0xf2ab, %rdx
nop
nop
nop
dec %rcx
...
nop
xor %r9, %r9
lea addresses_WC_ht+0x1822b, %rsi
...
<gen_prepare_buffer>
{'src': {'same': True, 'congruent': 9, 'type': 'addresses_normal_ht'}, 'OP': 'REPM', 'dst': {'same': True, 'congruent': 11, 'type': 'addresses_WT_ht'}}
...
{'OP': 'STOR', 'dst': {'NT': True, 'same': True, 'congruent': 7, 'type': 'addresses_D_ht', 'AVXalign': False, 'size': 1}}
...
{'src': {'same': False, 'congruent': 10, 'type': 'addresses_WT_ht'}, 'OP': 'REPM', 'dst': {'same': False, 'congruent': 1, 'type': 'addresses_D_ht'}}
...
{'src': {'same': False, 'congruent': 8, 'type': 'addresses_WC_ht'}, 'OP': 'REPM', 'dst': {'same': False, 'congruent': 2, 'type': 'addresses_WT_ht'}}
{'00': 21829}
