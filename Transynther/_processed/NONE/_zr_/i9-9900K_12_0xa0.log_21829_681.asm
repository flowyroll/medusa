...
push %rdi
push %rsi
lea addresses_WC_ht+0x1bd96, %r10
clflush (%r10)
add $56007, %r8
movw $0x6162, (%r10)
nop
...
nop
add $47240, %rax
lea addresses_WT_ht+0x137b6, %r15
clflush (%r15)
nop
nop
nop
...
nop
xor %r15, %r15
lea addresses_UC_ht+0x181f6, %rbx
nop
nop
nop
nop
...
nop
cmp %r8, %r8
lea addresses_A_ht+0xb7b6, %rsi
lea addresses_UC_ht+0x6596, %rdi
clflush (%rdi)
nop
nop
nop
...
nop
xor %rdi, %rdi
lea addresses_D_ht+0xb236, %rsi
lea addresses_WC_ht+0xdc76, %rdi
nop
nop
inc %r10
mov $82, %rcx
...
nop
cmp %rcx, %rcx
lea addresses_WC_ht+0x977e, %rcx
nop
nop
nop
sub %r15, %r15
...
// Store
lea addresses_US+0x19fb6, %r14
add $2351, %r8
movw $0x5152, (%r14)
sub %rbx, %rbx

// Store
lea addresses_WC+0x1ff76, %r14
nop
nop
nop
nop
...
{'src': {'same': False, 'congruent': 11, 'type': 'addresses_A_ht'}, 'OP': 'REPM', 'dst': {'same': False, 'congruent': 5, 'type': 'addresses_UC_ht'}}
{'src': {'same': False, 'congruent': 3, 'type': 'addresses_D_ht'}, 'OP': 'REPM', 'dst': {'same': False, 'congruent': 6, 'type': 'addresses_WC_ht'}}
