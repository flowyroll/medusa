...
push %rdi
push %rsi
lea addresses_WT_ht+0x1793c, %r10
nop
nop
nop
nop
...
nop
and %rcx, %rcx
lea addresses_WC_ht+0xb03c, %rbx
nop
nop
dec %r13
movb $0x61, (%rbx)
...
nop
sub $41416, %rbx
lea addresses_WT_ht+0xcb3c, %rsi
lea addresses_normal_ht+0xab3c, %rdi
nop
nop
nop
nop
...
nop
sub $1510, %rdi
lea addresses_WC_ht+0x51cc, %rsi
