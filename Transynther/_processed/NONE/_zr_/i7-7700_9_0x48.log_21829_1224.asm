...
push %rdi
push %rsi
lea addresses_A_ht+0xd3e5, %rsi
lea addresses_WC_ht+0x1bf4d, %rdi
nop
xor $22456, %rax
mov $46, %rcx
rep movsq
...
nop
cmp $19579, %rbp
lea addresses_normal_ht+0x1a06d, %rbx
clflush (%rbx)
nop
nop
nop
...
nop
cmp $55008, %rax
lea addresses_normal_ht+0x1b44d, %r10
xor %rax, %rax
movw $0x6162, (%r10)
xor $38488, %rdi
lea addresses_A_ht+0xda0d, %rcx
nop
nop
nop
nop
...
nop
sub $59702, %rax
lea addresses_normal_ht+0xf49d, %rsi
lea addresses_normal_ht+0x944d, %rdi
cmp $18767, %rbx
mov $77, %rcx
rep movsb
nop
...
nop
inc %rsi
lea addresses_UC_ht+0x86ad, %rsi
lea addresses_WT_ht+0x18799, %rdi
xor %rbx, %rbx
mov $53, %rcx
rep movsw
nop
nop
and %r10, %r10
lea addresses_WC_ht+0xc3ed, %rsi
nop
nop
nop
nop
...
nop
cmp $7960, %rax
lea addresses_WC_ht+0x17af8, %rsi
nop
nop
nop
nop
...
nop
inc %rsi
lea addresses_UC_ht+0x8e4d, %rcx
nop
nop
and $23788, %rbp
movb $0x61, (%rcx)
nop
cmp $58045, %rdi
lea addresses_UC_ht+0xa04d, %rcx
nop
nop
nop
sub %r10, %r10
