...
nop
xor $55610, %rsi
lea addresses_D_ht+0x13ee7, %rcx
nop
add $62103, %r8
...
nop
mfence
lea addresses_D_ht+0x168c7, %rbp
nop
nop
nop
nop
...
nop
cmp $5279, %rbp
lea addresses_D_ht+0x9447, %rsi
lea addresses_UC_ht+0x434, %rdi
xor %r13, %r13
mov $4, %rcx
rep movsl
nop
nop
sub %rsi, %rsi
lea addresses_WT_ht+0x175e7, %r9
nop
nop
nop
nop
...
// Store
lea addresses_normal+0x144c7, %rsi
nop
nop
nop
nop
...
{'OP': 'STOR', 'dst': {'size': 8, 'NT': False, 'type': 'addresses_WT_ht', 'same': False, 'AVXalign': True, 'congruent': 3}}
{'00': 21829}
