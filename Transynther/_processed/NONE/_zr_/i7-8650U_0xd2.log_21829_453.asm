...
push %rdi
push %rsi
lea addresses_D_ht+0x114a7, %rcx
clflush (%rcx)
nop
nop
nop
...
rep movsq
and $42662, %rdi
lea addresses_normal_ht+0x5967, %r14
nop
nop
nop
cmp %r8, %r8
...
nop
inc %rsi
lea addresses_WT_ht+0x14807, %r14
add %rcx, %rcx
movb (%r14), %r13b
nop
nop
...
<gen_prepare_buffer>
{'OP': 'STOR', 'dst': {'type': 'addresses_D_ht', 'size': 4, 'AVXalign': True, 'NT': True, 'congruent': 5, 'same': False}}
