...
nop
cmp $60076, %rsi
lea addresses_normal_ht+0x1b60e, %rsi
lea addresses_WT_ht+0x1c0e, %rdi
nop
nop
and $3397, %r13
mov $8, %rcx
...
nop
sub %rcx, %rcx
lea addresses_WT_ht+0x1b40e, %rsi
lea addresses_WT_ht+0x1b8ce, %rdi
nop
nop
and %r13, %r13
mov $77, %rcx
...
nop
add $53169, %rsi
lea addresses_A_ht+0x1721e, %rdi
clflush (%rdi)
and $37208, %r13
mov (%rdi), %si
nop
xor $49424, %rsi
lea addresses_normal_ht+0xdd4e, %rsi
sub $12879, %rbp
mov $0x6162636465666768, %rcx
movq %rcx, (%rsi)
and %r9, %r9
lea addresses_A_ht+0xf22e, %r9
nop
xor %rbp, %rbp
mov (%r9), %si
nop
...
{'OP': 'REPM', 'src': {'type': 'addresses_normal_ht', 'congruent': 9, 'same': False}, 'dst': {'type': 'addresses_WT_ht', 'congruent': 9, 'same': True}}
