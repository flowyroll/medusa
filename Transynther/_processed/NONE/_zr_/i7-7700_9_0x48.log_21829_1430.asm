...
nop
xor %r13, %r13
lea addresses_UC_ht+0xfcdb, %rdx
nop
nop
nop
nop
...
nop
and %r9, %r9
lea addresses_normal_ht+0xcf83, %rsi
lea addresses_WT_ht+0x18ddb, %rdi
nop
nop
nop
nop
...
nop
dec %rdi
lea addresses_WC_ht+0xb263, %rsi
nop
nop
nop
nop
...
vpextrq $1, %xmm4, %rdx
sub $2373, %rdi
lea addresses_normal_ht+0x4ffb, %rsi
lea addresses_A_ht+0xe9db, %rdi
clflush (%rdi)
nop
nop
nop
...
nop
cmp $41521, %r13
lea addresses_A_ht+0x134db, %rdx
nop
nop
sub %rsi, %rsi
movups (%rdx), %xmm0
...
nop
add %r8, %r8
lea addresses_WT_ht+0xfdb3, %r13
nop
nop
nop
nop
...
nop
and $52224, %rcx
lea addresses_normal_ht+0x1e73b, %rsi
lea addresses_normal_ht+0x6fa5, %rdi
xor %r9, %r9
mov $1, %rcx
rep movsw
xor $33224, %r8
lea addresses_WC_ht+0x17607, %rsi
nop
nop
inc %rcx
...
{'OP': 'REPM', 'src': {'type': 'addresses_normal_ht', 'congruent': 1, 'same': False}, 'dst': {'type': 'addresses_WT_ht', 'congruent': 8, 'same': True}}
{'OP': 'LOAD', 'src': {'type': 'addresses_WC_ht', 'AVXalign': False, 'congruent': 2, 'size': 32, 'same': False, 'NT': False}}
{'OP': 'REPM', 'src': {'type': 'addresses_normal_ht', 'congruent': 4, 'same': True}, 'dst': {'type': 'addresses_A_ht', 'congruent': 7, 'same': True}}
