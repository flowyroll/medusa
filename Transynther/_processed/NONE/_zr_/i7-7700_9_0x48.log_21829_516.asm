...
nop
add %r14, %r14
lea addresses_WT_ht+0x1340e, %r13
nop
inc %rdx
movb (%r13), %al
nop
...
nop
add %rdi, %rdi
lea addresses_UC_ht+0xf70e, %rsi
lea addresses_WC_ht+0xbd5e, %rdi
nop
nop
sub %r14, %r14
mov $39, %rcx
...
movb (%rcx), %al
sub $13691, %rax
lea addresses_WT_ht+0x1ae1e, %rsi
lea addresses_WC_ht+0xacde, %rdi
nop
nop
nop
nop
...
lea addresses_A_ht+0x1bc5e, %rdi
nop
nop
nop
cmp %r13, %r13
...
nop
and $56362, %r14
lea addresses_WT_ht+0x185e, %rdx
nop
nop
nop
sub %r13, %r13
...
nop
add %r14, %r14
lea addresses_normal_ht+0xd05e, %rsi
lea addresses_A_ht+0x198be, %rdi
nop
nop
nop
nop
...
nop
cmp %r14, %r14
lea addresses_normal_ht+0x1639e, %rdi
nop
nop
nop
and %rsi, %rsi
...
{'OP': 'STOR', 'dst': {'type': 'addresses_WT', 'AVXalign': False, 'congruent': 9, 'size': 2, 'same': False, 'NT': True}}
...
{'OP': 'REPM', 'src': {'type': 'addresses_D_ht', 'congruent': 1, 'same': False}, 'dst': {'type': 'addresses_A_ht', 'congruent': 7, 'same': True}}
