...
push %rdx
push %rsi
lea addresses_A_ht+0xf83b, %rsi
lea addresses_WT_ht+0x11857, %rdi
nop
nop
nop
and $9139, %r12
...
nop
cmp $62948, %r8
lea addresses_WC_ht+0x747d, %rdi
nop
nop
nop
and %r10, %r10
movb (%rdi), %r8b
add $51420, %rdi
lea addresses_WC_ht+0x4217, %rdi
and %rdx, %rdx
mov (%rdi), %r8
nop
nop
dec %rsi
lea addresses_UC_ht+0x19a8f, %r8
nop
nop
nop
nop
...
{'OP': 'STOR', 'dst': {'size': 4, 'NT': True, 'type': 'addresses_US', 'same': False, 'AVXalign': False, 'congruent': 8}}
...
{'OP': 'LOAD', 'src': {'size': 4, 'NT': False, 'type': 'addresses_D_ht', 'same': True, 'AVXalign': False, 'congruent': 3}}
