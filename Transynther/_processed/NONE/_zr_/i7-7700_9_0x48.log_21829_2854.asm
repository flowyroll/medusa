...
push %rdx
push %rsi
lea addresses_WC_ht+0x63d9, %r13
nop
and %r11, %r11
movups (%r13), %xmm6
vpextrq $1, %xmm6, %rdx
add $51353, %rdi
lea addresses_UC_ht+0x49fa, %rsi
lea addresses_WT_ht+0x17fd9, %rdi
nop
nop
nop
xor %r11, %r11
...
nop
sub %rcx, %rcx
lea addresses_WC_ht+0xbbe9, %rcx
nop
nop
xor $60031, %r13
mov (%rcx), %r11
...
nop
lfence
lea addresses_WC_ht+0xc3d9, %r11
nop
nop
nop
cmp $13409, %r14
...
nop
xor $8938, %rdx
lea addresses_WT_ht+0x2dd9, %rsi
...
nop
dec %rsi
lea addresses_D_ht+0x18839, %r11
nop
nop
nop
nop
...
nop
sub %r11, %r11
lea addresses_D_ht+0x7d5, %rsi
lea addresses_normal_ht+0x193d9, %rdi
nop
nop
xor $8431, %r13
mov $15, %rcx
...
nop
dec %r11
lea addresses_WT_ht+0x3bd9, %rdi
nop
sub $32435, %rcx
...
nop
cmp $46314, %r14
lea addresses_WT_ht+0xa37d, %rsi
lea addresses_A_ht+0x26b5, %rdi
nop
nop
xor $16325, %r11
mov $29, %rcx
...
nop
and $36323, %r11
lea addresses_UC_ht+0x17cd9, %rdi
nop
cmp %r13, %r13
movw $0x6162, (%rdi)
nop
...
{'OP': 'REPM', 'src': {'type': 'addresses_UC_ht', 'congruent': 0, 'same': False}, 'dst': {'type': 'addresses_WT_ht', 'congruent': 10, 'same': True}}
