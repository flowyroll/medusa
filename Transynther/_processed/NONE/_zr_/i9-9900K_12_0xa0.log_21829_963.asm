...
push %rdx
push %rsi
lea addresses_normal_ht+0x199da, %rsi
...
nop
and $8813, %rax
lea addresses_UC_ht+0x1b5c0, %rsi
lea addresses_UC_ht+0x1765a, %rdi
nop
nop
nop
add $8297, %rdx
...
nop
add $4145, %rax
lea addresses_UC_ht+0x1245a, %rbx
and $62573, %r14
movw $0x6162, (%rbx)
xor $24071, %rax
lea addresses_WT_ht+0x50f1, %r14
nop
nop
nop
nop
...
nop
and %rbx, %rbx
lea addresses_WC_ht+0x1d55a, %rdi
clflush (%rdi)
nop
nop
nop
...
nop
add $15245, %rsi
lea addresses_normal_ht+0x7c2, %rax
xor %rdi, %rdi
...
nop
add %r14, %r14
lea addresses_A_ht+0x1205a, %rdi
nop
nop
nop
cmp $21126, %rsi
...
nop
xor $1804, %rbx
lea addresses_WC_ht+0x345a, %rsi
lea addresses_WT_ht+0x82da, %rdi
nop
nop
nop
nop
...
<gen_prepare_buffer>
{'src': {'same': False, 'congruent': 6, 'type': 'addresses_normal_ht'}, 'OP': 'REPM', 'dst': {'same': False, 'congruent': 5, 'type': 'addresses_WC_ht'}}
...
{'OP': 'STOR', 'dst': {'NT': False, 'same': True, 'congruent': 3, 'type': 'addresses_normal_ht', 'AVXalign': False, 'size': 16}}
{'src': {'NT': False, 'same': False, 'congruent': 9, 'type': 'addresses_A_ht', 'AVXalign': False, 'size': 8}, 'OP': 'LOAD'}
{'src': {'same': False, 'congruent': 9, 'type': 'addresses_WC_ht'}, 'OP': 'REPM', 'dst': {'same': False, 'congruent': 5, 'type': 'addresses_WT_ht'}}
{'00': 21829}
