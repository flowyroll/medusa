...
push %rdx
push %rsi
lea addresses_normal_ht+0x169fa, %rdx
nop
nop
nop
and $9517, %r12
...
nop
sub $14956, %rbx
lea addresses_WT_ht+0x7e82, %rsi
nop
nop
nop
dec %rcx
...
nop
add %rdx, %rdx
lea addresses_WC_ht+0x1db02, %rsi
lea addresses_WC_ht+0x6a10, %rdi
nop
add %r8, %r8
mov $87, %rcx
rep movsb
...
nop
xor %r8, %r8
lea addresses_normal_ht+0xf402, %rsi
nop
nop
nop
add %r8, %r8
...
nop
cmp $39577, %r8
lea addresses_A_ht+0x1a982, %r13
clflush (%r13)
nop
nop
sub $62360, %rsi
...
// Store
lea addresses_normal+0x6282, %r15
nop
nop
nop
nop
...
{'src': {'congruent': 10, 'AVXalign': False, 'same': False, 'size': 2, 'NT': False, 'type': 'addresses_RW'}, 'OP': 'LOAD'}
[Faulty Load]
...
{'OP': 'STOR', 'dst': {'congruent': 7, 'AVXalign': False, 'same': True, 'size': 16, 'NT': True, 'type': 'addresses_normal_ht'}}
