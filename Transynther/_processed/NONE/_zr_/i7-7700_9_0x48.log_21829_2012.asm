...
nop
sub $39017, %r12
lea addresses_UC_ht+0x5f95, %rdx
nop
nop
add $33018, %r11
movb (%rdx), %r15b
...
nop
add %rdx, %rdx
lea addresses_A_ht+0x1eb95, %rdx
nop
add $42490, %rdi
...
nop
inc %rbp
lea addresses_A_ht+0x19595, %rsi
lea addresses_A_ht+0x1ec5, %rdi
nop
nop
nop
nop
...
mov (%rdi), %r12w
xor %r11, %r11
lea addresses_WT_ht+0xd089, %rdx
nop
add $43984, %r15
movb $0x61, (%rdx)
nop
...
nop
inc %rbp
lea addresses_normal_ht+0x4395, %rsi
lea addresses_WC_ht+0x14ae1, %rdi
nop
nop
nop
nop
...
rep movsw
xor %rcx, %rcx
lea addresses_UC_ht+0x16315, %rsi
lea addresses_WT_ht+0x1e465, %rdi
dec %r15
mov $124, %rcx
rep movsq
nop
...
{'OP': 'REPM', 'src': {'type': 'addresses_A_ht', 'congruent': 8, 'same': True}, 'dst': {'type': 'addresses_A_ht', 'congruent': 4, 'same': True}}
{'OP': 'LOAD', 'src': {'type': 'addresses_D_ht', 'AVXalign': False, 'congruent': 5, 'size': 2, 'same': False, 'NT': False}}
{'OP': 'STOR', 'dst': {'type': 'addresses_WT_ht', 'AVXalign': True, 'congruent': 1, 'size': 1, 'same': False, 'NT': False}}
