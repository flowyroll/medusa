...
movups %xmm5, (%r8)
and %rdx, %rdx
lea addresses_WT_ht+0xb0d9, %rsi
lea addresses_D_ht+0x8819, %rdi
nop
xor %r11, %r11
mov $29, %rcx
rep movsq
...
nop
cmp $61415, %rcx
lea addresses_UC_ht+0x1e899, %rdi
nop
nop
nop
nop
...
vpextrq $0, %xmm4, %rsi
xor %r8, %r8
lea addresses_UC_ht+0x1d9dd, %r10
nop
nop
nop
dec %rdx
...
nop
dec %r11
lea addresses_A_ht+0x7f51, %rsi
lea addresses_A_ht+0xce65, %rdi
clflush (%rsi)
nop
inc %r15
mov $38, %rcx
...
{'src': {'same': False, 'congruent': 6, 'type': 'addresses_WT_ht'}, 'OP': 'REPM', 'dst': {'same': True, 'congruent': 6, 'type': 'addresses_D_ht'}}
{'src': {'NT': False, 'same': False, 'congruent': 0, 'type': 'addresses_D_ht', 'AVXalign': False, 'size': 16}, 'OP': 'LOAD'}
{'src': {'NT': False, 'same': True, 'congruent': 10, 'type': 'addresses_UC_ht', 'AVXalign': False, 'size': 32}, 'OP': 'LOAD'}
{'OP': 'STOR', 'dst': {'NT': False, 'same': False, 'congruent': 1, 'type': 'addresses_UC_ht', 'AVXalign': False, 'size': 32}}
{'src': {'same': False, 'congruent': 3, 'type': 'addresses_A_ht'}, 'OP': 'REPM', 'dst': {'same': False, 'congruent': 0, 'type': 'addresses_A_ht'}}
{'00': 21829}
