...
push %rdi
push %rsi
lea addresses_WC_ht+0x160f0, %r11
nop
nop
nop
nop
...
nop
sub $4777, %rcx
lea addresses_UC_ht+0xa688, %rsi
lea addresses_D_ht+0xf388, %rdi
nop
nop
nop
dec %r14
...
nop
sub %rdi, %rdi
lea addresses_normal_ht+0xeff0, %r11
nop
cmp %r9, %r9
vmovups (%r11), %ymm3
...
vpextrq $0, %xmm3, %rdi
cmp %r14, %r14
lea addresses_normal_ht+0x2e88, %rsi
lea addresses_normal_ht+0x1e8e4, %rdi
clflush (%rdi)
nop
nop
lfence
...
nop
dec %r11
lea addresses_UC_ht+0x152e8, %r9
nop
nop
add $12351, %r15
mov (%r9), %cx
xor $12630, %r14
lea addresses_WC_ht+0x17841, %r11
clflush (%r11)
nop
nop
nop
...
nop
dec %r11
lea addresses_WT_ht+0x12388, %rsi
lea addresses_WT_ht+0x3662, %rdi
nop
nop
nop
nop
...
nop
add %rdi, %rdi
lea addresses_WT_ht+0x1cf8, %r15
nop
dec %rsi
mov (%r15), %r11
nop
...
nop
cmp $2267, %rdi
lea addresses_normal_ht+0x6734, %r14
nop
nop
nop
sub %rcx, %rcx
...
{'OP': 'REPM', 'src': {'type': 'addresses_UC_ht', 'congruent': 9, 'same': False}, 'dst': {'type': 'addresses_D_ht', 'congruent': 7, 'same': False}}
