...
push %rdi
push %rsi
lea addresses_A_ht+0xb79f, %rsi
lea addresses_A_ht+0xeda6, %rdi
nop
xor %rbp, %rbp
mov $103, %rcx
rep movsl
...
lea addresses_normal_ht+0x17366, %rdi
nop
nop
nop
nop
...
lea addresses_WT_ht+0xd000, %rdi
clflush (%rsi)
nop
add $26035, %r9
mov $78, %rcx
...
nop
and %r10, %r10
lea addresses_UC_ht+0x2e06, %rsi
nop
nop
and %rbp, %rbp
mov (%rsi), %r8d
...
nop
dec %rsi
lea addresses_A_ht+0x1b376, %rsi
lea addresses_D_ht+0x12a66, %rdi
nop
nop
sub %r13, %r13
mov $14, %rcx
...
nop
dec %rbp
lea addresses_WC_ht+0x15d66, %r8
nop
nop
nop
cmp %rsi, %rsi
...
{'OP': 'REPM', 'src': {'type': 'addresses_UC_ht', 'congruent': 6, 'same': False}, 'dst': {'type': 'addresses_WT_ht', 'congruent': 1, 'same': False}}
