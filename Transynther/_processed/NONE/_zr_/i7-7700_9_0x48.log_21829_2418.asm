...
nop
xor $15191, %r11
lea addresses_normal_ht+0x1434f, %rdx
nop
nop
sub $29463, %r11
...
vmovaps %ymm7, (%rdx)
and $2740, %r14
lea addresses_normal_ht+0x30cf, %rsi
nop
sub $11147, %rbp
movw $0x6162, (%rsi)
cmp %rsi, %rsi
lea addresses_normal_ht+0x1594f, %rsi
lea addresses_WT_ht+0x1a04f, %rdi
clflush (%rdi)
nop
nop
nop
...
rep movsw
xor $26352, %r15
lea addresses_UC_ht+0x1014f, %rsi
lea addresses_D_ht+0x11f8f, %rdi
nop
nop
nop
nop
...
nop
inc %rdi
lea addresses_WC_ht+0x1e02f, %rsi
lea addresses_UC_ht+0x5f6f, %rdi
nop
nop
add %r11, %r11
mov $107, %rcx
...
nop
dec %r11
lea addresses_A_ht+0xc34f, %rsi
lea addresses_WC_ht+0x1555f, %rdi
clflush (%rsi)
nop
nop
nop
...
{'OP': 'REPM', 'src': {'type': 'addresses_normal_ht', 'congruent': 11, 'same': True}, 'dst': {'type': 'addresses_WT_ht', 'congruent': 6, 'same': False}}
{'OP': 'REPM', 'src': {'type': 'addresses_UC_ht', 'congruent': 11, 'same': False}, 'dst': {'type': 'addresses_D_ht', 'congruent': 6, 'same': True}}
{'OP': 'REPM', 'src': {'type': 'addresses_WC_ht', 'congruent': 2, 'same': False}, 'dst': {'type': 'addresses_UC_ht', 'congruent': 5, 'same': False}}
{'OP': 'REPM', 'src': {'type': 'addresses_A_ht', 'congruent': 9, 'same': False}, 'dst': {'type': 'addresses_WC_ht', 'congruent': 4, 'same': False}}
{'00': 21829}
