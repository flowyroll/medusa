...
lea addresses_normal_ht+0xd879, %rdi
nop
xor $23657, %r9
mov $53, %rcx
rep movsb
...
nop
sub $32959, %r10
lea addresses_D_ht+0x89f9, %rsi
lea addresses_WT_ht+0xe439, %rdi
nop
nop
sub $1553, %r10
mov $68, %rcx
...
nop
inc %rcx
lea addresses_WT_ht+0x1da71, %r9
and %rdx, %rdx
...
<gen_prepare_buffer>
{'OP': 'REPM', 'src': {'same': False, 'type': 'addresses_UC_ht', 'congruent': 4}, 'dst': {'same': False, 'type': 'addresses_normal_ht', 'congruent': 6}}
{'OP': 'REPM', 'src': {'same': False, 'type': 'addresses_D_ht', 'congruent': 5}, 'dst': {'same': False, 'type': 'addresses_WT_ht', 'congruent': 6}}
