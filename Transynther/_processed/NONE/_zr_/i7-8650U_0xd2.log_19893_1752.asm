...
push %rdx
push %rsi
lea addresses_WT_ht+0x2261, %rcx
nop
nop
nop
nop
...
nop
cmp %rdx, %rdx
lea addresses_WC_ht+0xbce1, %r13
xor %r14, %r14
...
nop
add %r10, %r10
lea addresses_UC_ht+0xcce1, %r15
add $6227, %rdx
movb (%r15), %r10b
nop
nop
cmp %r15, %r15
lea addresses_UC_ht+0x11fe1, %rsi
lea addresses_normal_ht+0x1d701, %rdi
nop
nop
nop
nop
...
nop
add $48946, %rsi
lea addresses_A_ht+0x17469, %rsi
lea addresses_D_ht+0x3021, %rdi
nop
nop
nop
inc %rdx
...
nop
cmp $47456, %r10
lea addresses_A_ht+0x1ba81, %rbx
nop
nop
and %rdi, %rdi
mov (%rbx), %cx
...
nop
add $35559, %r13
lea addresses_normal_ht+0x16581, %rdi
nop
nop
and $23402, %rdx
movl $0x61626364, (%rdi)
...
nop
and %rbx, %rbx
lea addresses_WC_ht+0xdc67, %r13
xor $42207, %rsi
movw $0x6162, (%r13)
nop
nop
...
nop
sub %rcx, %rcx
lea addresses_WC_ht+0x1b8df, %rdx
xor %rbx, %rbx
movb (%rdx), %r14b
nop
nop
...
nop
and %r15, %r15
lea addresses_WC_ht+0x90e1, %rdi
nop
add $59536, %r10
movw $0x6162, (%rdi)
nop
cmp %rdi, %rdi
lea addresses_A_ht+0x1cb81, %rdi
nop
nop
xor %rdx, %rdx
movl $0x61626364, (%rdi)
...
nop
and %rcx, %rcx
lea addresses_normal_ht+0x1aba1, %r10
nop
nop
sub %r14, %r14
...
<gen_prepare_buffer>
{'OP': 'LOAD', 'src': {'type': 'addresses_WT_ht', 'size': 16, 'AVXalign': True, 'NT': False, 'congruent': 5, 'same': False}}
...
{'OP': 'STOR', 'dst': {'type': 'addresses_normal_ht', 'size': 4, 'AVXalign': False, 'NT': False, 'congruent': 5, 'same': True}}
