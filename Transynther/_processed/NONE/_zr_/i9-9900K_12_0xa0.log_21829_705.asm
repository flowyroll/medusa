...
push %rdi
push %rsi
lea addresses_WT_ht+0x12cfa, %r11
nop
nop
nop
cmp $63806, %rbp
...
nop
inc %r9
lea addresses_UC_ht+0x182fa, %rbx
nop
nop
nop
sub $19774, %r8
...
nop
xor %rbp, %rbp
lea addresses_normal_ht+0x141e, %rsi
lea addresses_A_ht+0x1712, %rdi
nop
nop
nop
nop
...
nop
xor %r13, %r13
lea addresses_UC_ht+0x17cc8, %r8
nop
nop
nop
nop
...
nop
dec %r13
lea addresses_UC_ht+0x1c9b2, %r13
nop
nop
nop
nop
...
nop
add $42666, %r13
lea addresses_WT_ht+0x1944a, %rsi
lea addresses_WC_ht+0xc642, %rdi
nop
nop
nop
xor %rbx, %rbx
...
rep movsq
add $47056, %rbp
lea addresses_WC_ht+0x14afa, %rsi
lea addresses_WT_ht+0x151fa, %rdi
nop
nop
nop
and %r9, %r9
...
{'src': {'same': False, 'congruent': 2, 'type': 'addresses_WT_ht'}, 'OP': 'REPM', 'dst': {'same': True, 'congruent': 2, 'type': 'addresses_WC_ht'}}
{'src': {'same': True, 'congruent': 10, 'type': 'addresses_WC_ht'}, 'OP': 'REPM', 'dst': {'same': False, 'congruent': 8, 'type': 'addresses_WT_ht'}}
{'00': 21829}
