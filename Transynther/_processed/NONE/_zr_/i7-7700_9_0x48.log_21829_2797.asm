...
lea addresses_WC_ht+0x18239, %rdi
clflush (%rsi)
nop
nop
nop
...
nop
sub $4967, %rbp
lea addresses_WT_ht+0x1c16a, %rsi
lea addresses_normal_ht+0xa90a, %rdi
nop
nop
nop
nop
...
nop
cmp $63865, %rax
lea addresses_UC_ht+0x16caa, %r9
nop
nop
nop
nop
...
nop
sub $14046, %rsi
lea addresses_WT_ht+0x8f2a, %r13
nop
nop
inc %r8
mov (%r13), %r9w
xor $50283, %r13
lea addresses_WT_ht+0x1c06a, %r9
clflush (%r9)
nop
xor $9786, %r13
mov (%r9), %cx
...
{'OP': 'REPM', 'src': {'type': 'addresses_normal_ht', 'congruent': 11, 'same': True}, 'dst': {'type': 'addresses_WC_ht', 'congruent': 0, 'same': True}}
