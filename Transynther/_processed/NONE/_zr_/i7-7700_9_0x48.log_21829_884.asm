...
nop
add $25199, %rcx
lea addresses_D_ht+0x111da, %r11
nop
nop
nop
xor %rcx, %rcx
...
nop
xor $33034, %r15
lea addresses_UC_ht+0x46da, %rsi
lea addresses_normal_ht+0x8a3a, %rdi
and $10149, %rbx
mov $97, %rcx
rep movsl
nop
xor %rcx, %rcx
lea addresses_WC_ht+0x160da, %rcx
nop
nop
nop
nop
...
nop
cmp %rcx, %rcx
lea addresses_A_ht+0x105da, %r11
nop
nop
and $38562, %r12
mov (%r11), %rcx
...
nop
and %r12, %r12
lea addresses_WT_ht+0x161da, %rsi
nop
nop
nop
xor %rbx, %rbx
...
nop
cmp $47893, %r15
lea addresses_normal_ht+0x40aa, %r11
nop
nop
nop
nop
...
nop
and $16172, %rcx
lea addresses_WT_ht+0x10da, %rsi
lea addresses_D_ht+0x15d6e, %rdi
nop
cmp %rax, %rax
mov $95, %rcx
rep movsw
...
nop
xor %rcx, %rcx
lea addresses_A_ht+0x79da, %rsi
lea addresses_A_ht+0xf0ba, %rdi
cmp $2478, %rax
mov $36, %rcx
rep movsq
nop
add $41930, %r12
lea addresses_D_ht+0x639a, %rax
and %rbx, %rbx
...
nop
dec %rcx
lea addresses_WC_ht+0xca5a, %r15
nop
nop
nop
nop
...
// Store
lea addresses_normal+0xe5da, %rsi
nop
nop
nop
nop
...
// Load
lea addresses_normal+0x1095a, %r9
nop
nop
nop
nop
...
{'OP': 'LOAD', 'src': {'type': 'addresses_normal', 'AVXalign': True, 'congruent': 7, 'size': 16, 'same': False, 'NT': False}}
{'OP': 'STOR', 'dst': {'type': 'addresses_D', 'AVXalign': False, 'congruent': 1, 'size': 32, 'same': True, 'NT': False}}
...
{'OP': 'REPM', 'src': {'type': 'addresses_UC_ht', 'congruent': 7, 'same': False}, 'dst': {'type': 'addresses_normal_ht', 'congruent': 5, 'same': True}}
