...
nop
and %rsi, %rsi
lea addresses_WC_ht+0x3ad3, %rcx
nop
inc %r8
movb $0x61, (%rcx)
nop
...
nop
sub %r10, %r10
lea addresses_WC_ht+0x1ad9, %rsi
lea addresses_WC_ht+0x1dad3, %rdi
add %r13, %r13
mov $8, %rcx
rep movsl
nop
...
nop
and %r8, %r8
lea addresses_WT_ht+0x1ed3, %r10
nop
nop
and %rcx, %rcx
mov (%r10), %r8d
nop
xor %r13, %r13
lea addresses_normal_ht+0xfbf8, %rsi
lea addresses_UC_ht+0x3b37, %rdi
nop
nop
nop
nop
...
nop
cmp $8076, %rdi
lea addresses_D_ht+0x1214b, %r12
nop
nop
nop
nop
...
nop
and %rcx, %rcx
lea addresses_D_ht+0x17ef3, %rsi
nop
nop
inc %r12
mov (%rsi), %rdi
nop
sub $10978, %r10
lea addresses_WC_ht+0x156d3, %r12
nop
nop
nop
nop
