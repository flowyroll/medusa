...
nop
xor %rbp, %rbp
lea addresses_WT_ht+0x11251, %r8
nop
nop
nop
nop
...
movw $0x6162, (%r8)
xor %r8, %r8
lea addresses_normal_ht+0x16231, %r15
nop
nop
nop
nop
...
{'OP': 'STOR', 'dst': {'type': 'addresses_A', 'AVXalign': True, 'congruent': 6, 'size': 8, 'same': False, 'NT': False}}
[Faulty Load]
