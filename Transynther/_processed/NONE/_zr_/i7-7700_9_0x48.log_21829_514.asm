...
push %rdi
push %rsi
lea addresses_D_ht+0x13a95, %rsi
lea addresses_normal_ht+0x4a95, %rdi
nop
nop
nop
nop
...
nop
xor $30547, %rsi
lea addresses_WC_ht+0x2795, %r11
nop
dec %r14
movb (%r11), %cl
cmp %r14, %r14
lea addresses_A_ht+0xf095, %rsi
...
nop
xor $7624, %rdi
lea addresses_D_ht+0x16bd5, %r14
inc %r13
movw $0x6162, (%r14)
nop
nop
dec %r13
lea addresses_normal_ht+0xa415, %rsi
lea addresses_normal_ht+0x1bb49, %rdi
clflush (%rdi)
nop
nop
nop
...
nop
and %rdi, %rdi
lea addresses_D_ht+0x1120, %rcx
nop
sub %rbp, %rbp
movb $0x61, (%rcx)
xor %r13, %r13
lea addresses_UC_ht+0x49f1, %rdi
nop
nop
nop
nop
...
nop
inc %rbp
lea addresses_normal_ht+0x15301, %rcx
nop
nop
nop
nop
