...
push %rdi
push %rsi
lea addresses_UC_ht+0x1d094, %rax
dec %rdi
mov (%rax), %r8w
nop
nop
nop
sub %r8, %r8
lea addresses_WC_ht+0x8f94, %r11
nop
nop
inc %r12
mov (%r11), %ebx
...
nop
xor %rdi, %rdi
lea addresses_UC_ht+0xa194, %r12
nop
nop
sub %rsi, %rsi
mov (%r12), %r11
mfence
lea addresses_D_ht+0x25f4, %rax
nop
sub %r12, %r12
movl $0x61626364, (%rax)
nop
...
nop
and %r12, %r12
lea addresses_WT_ht+0x16794, %rax
nop
nop
nop
nop
...
nop
add %rdi, %rdi
lea addresses_UC_ht+0xbdbc, %rsi
nop
nop
nop
nop
...
nop
add $45689, %r8
lea addresses_WC_ht+0x1486a, %rsi
lea addresses_WC_ht+0x13e94, %rdi
nop
nop
nop
nop
...
nop
cmp %rcx, %rcx
lea addresses_WT_ht+0xce94, %rsi
lea addresses_WT_ht+0x56d4, %rdi
nop
xor $50972, %r11
mov $35, %rcx
rep movsb
...
nop
inc %rdi
lea addresses_normal_ht+0x858, %rcx
nop
nop
mfence
movups (%rcx), %xmm4
