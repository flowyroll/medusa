...
push %rdi
push %rsi
lea addresses_UC_ht+0xbd97, %rsi
lea addresses_UC_ht+0x6d77, %rdi
lfence
mov $43, %rcx
rep movsw
nop
...
nop
cmp %rdi, %rdi
lea addresses_A_ht+0x1d853, %rsi
nop
sub $62380, %rbx
mov (%rsi), %r15w
nop
mfence
lea addresses_UC_ht+0x13597, %r15
nop
cmp $20945, %r13
vmovups (%r15), %ymm3
...
nop
add %rdi, %rdi
lea addresses_UC_ht+0x13597, %r12
nop
dec %r15
...
nop
and %rbx, %rbx
lea addresses_UC_ht+0x1dcd7, %r13
nop
nop
nop
add %r12, %r12
...
nop
dec %r13
lea addresses_D_ht+0x1b997, %r13
and $6170, %rsi
movw $0x6162, (%r13)
nop
sub $35444, %r15
...
{'src': {'NT': False, 'same': False, 'congruent': 3, 'type': 'addresses_D', 'AVXalign': False, 'size': 16}, 'OP': 'LOAD'}
[Faulty Load]
{'src': {'NT': False, 'same': True, 'congruent': 0, 'type': 'addresses_A', 'AVXalign': False, 'size': 16}, 'OP': 'LOAD'}
<gen_prepare_buffer>
{'src': {'same': False, 'congruent': 9, 'type': 'addresses_UC_ht'}, 'OP': 'REPM', 'dst': {'same': False, 'congruent': 5, 'type': 'addresses_UC_ht'}}
