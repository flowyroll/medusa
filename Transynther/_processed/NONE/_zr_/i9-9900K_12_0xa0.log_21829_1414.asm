...
nop
sub $51104, %rdx
lea addresses_D_ht+0x1c2f4, %rbx
nop
nop
sub %r8, %r8
mov (%rbx), %r10
...
<gen_prepare_buffer>
{'src': {'NT': False, 'same': True, 'congruent': 2, 'type': 'addresses_D_ht', 'AVXalign': False, 'size': 16}, 'OP': 'LOAD'}
{'OP': 'STOR', 'dst': {'NT': False, 'same': False, 'congruent': 10, 'type': 'addresses_UC_ht', 'AVXalign': True, 'size': 32}}
