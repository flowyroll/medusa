...
push %rdi
push %rsi
lea addresses_WC_ht+0xb620, %rbp
nop
nop
sub %r13, %r13
mov (%rbp), %edi
...
nop
dec %rbp
lea addresses_UC_ht+0x101f0, %r10
nop
nop
nop
nop
...
nop
inc %r9
lea addresses_WT_ht+0x11030, %rdi
nop
nop
xor %r10, %r10
mov (%rdi), %rbp
...
nop
inc %r9
lea addresses_UC_ht+0x1b940, %rdi
nop
nop
nop
nop
...
lea addresses_WC_ht+0xf920, %rdi
nop
nop
nop
xor %rbx, %rbx
...
{'src': {'congruent': 7, 'same': False, 'type': 'addresses_A_ht'}, 'OP': 'REPM', 'dst': {'congruent': 8, 'same': False, 'type': 'addresses_WC_ht'}}
{'00': 21829}
