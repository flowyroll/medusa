...
push %rdi
push %rsi
lea addresses_D_ht+0x1cb1b, %r13
nop
nop
add $25624, %r11
mov (%r13), %r15d
...
nop
and $58768, %r12
lea addresses_WC_ht+0x1b2cb, %rsi
lea addresses_A_ht+0x12f0b, %rdi
nop
nop
nop
and $38070, %r13
...
// Store
lea addresses_normal+0xb30b, %rbx
and $53552, %rdi
movw $0x5152, (%rbx)
nop
nop
...
// Load
lea addresses_normal+0x1208b, %r14
nop
nop
add %rbx, %rbx
vmovups (%r14), %ymm5
...
{'OP': 'LOAD', 'src': {'size': 1, 'NT': False, 'type': 'addresses_WC', 'same': False, 'AVXalign': False, 'congruent': 11}}
...
{'OP': 'STOR', 'dst': {'size': 1, 'NT': True, 'type': 'addresses_D_ht', 'same': True, 'AVXalign': False, 'congruent': 5}}
{'00': 21829}
