...
nop
xor $49960, %r8
lea addresses_UC_ht+0x1ea88, %rsi
nop
nop
nop
nop
...
nop
add %rdi, %rdi
lea addresses_normal_ht+0xae08, %rdi
nop
nop
nop
and $48514, %rcx
...
nop
cmp %rdi, %rdi
lea addresses_WC_ht+0x1e448, %r8
clflush (%r8)
nop
nop
nop
...
movw $0x6162, (%r8)
and $1968, %rcx
lea addresses_A_ht+0x1d398, %rax
cmp %rdi, %rdi
movups (%rax), %xmm7
vpextrq $0, %xmm7, %r9
nop
...
{'OP': 'STOR', 'dst': {'congruent': 9, 'AVXalign': False, 'same': True, 'size': 16, 'NT': False, 'type': 'addresses_A_ht'}}
