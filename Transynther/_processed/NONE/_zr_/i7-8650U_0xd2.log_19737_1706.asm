...
nop
cmp $43831, %rdi
lea addresses_A_ht+0x1ac14, %r12
sub $2384, %r8
movb (%r12), %dl
cmp $24530, %r8
lea addresses_D_ht+0x106d4, %rsi
lea addresses_WT_ht+0x8014, %rdi
nop
nop
nop
nop
...
nop
cmp %rcx, %rcx
lea addresses_UC_ht+0x17500, %rsi
lea addresses_normal_ht+0x1c14, %rdi
nop
nop
nop
nop
...
nop
lfence
lea addresses_UC_ht+0x1692c, %r13
nop
nop
nop
nop
...
nop
cmp %r12, %r12
lea addresses_UC_ht+0x1dd14, %r12
nop
nop
nop
nop
...
nop
dec %r9
lea addresses_UC_ht+0x11d54, %r13
nop
sub %rdi, %rdi
...
nop
and %rdx, %rdx
lea addresses_normal_ht+0x8c14, %rdi
nop
nop
nop
dec %r9
...
nop
sub $42876, %rcx
lea addresses_normal_ht+0x5904, %rsi
lea addresses_normal_ht+0x16d4, %rdi
nop
nop
nop
nop
...
{'OP': 'REPM', 'src': {'type': 'addresses_D_ht', 'congruent': 5, 'same': False}, 'dst': {'type': 'addresses_WT_ht', 'congruent': 11, 'same': False}}
{'OP': 'REPM', 'src': {'type': 'addresses_UC_ht', 'congruent': 2, 'same': True}, 'dst': {'type': 'addresses_normal_ht', 'congruent': 6, 'same': False}}
...
{'OP': 'REPM', 'src': {'type': 'addresses_normal_ht', 'congruent': 4, 'same': True}, 'dst': {'type': 'addresses_normal_ht', 'congruent': 6, 'same': False}}
