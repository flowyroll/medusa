...
push %rdx
push %rsi
lea addresses_WT_ht+0xc28f, %rdi
nop
nop
nop
nop
...
nop
sub $18857, %rdx
lea addresses_D_ht+0x1245f, %rcx
nop
nop
dec %rbp
...
nop
cmp $33803, %rdx
lea addresses_UC_ht+0xf0f, %rsi
lea addresses_WT_ht+0xed8f, %rdi
nop
nop
nop
xor $64972, %r13
...
nop
dec %rbp
lea addresses_A_ht+0x128f, %rsi
lea addresses_WT_ht+0x1718f, %rdi
nop
nop
nop
add $21523, %r13
...
nop
xor %r9, %r9
lea addresses_WT_ht+0x9f8f, %rsi
lea addresses_WT_ht+0x19f93, %rdi
nop
nop
nop
nop
...
{'src': {'congruent': 8, 'same': True, 'type': 'addresses_WT_ht'}, 'OP': 'REPM', 'dst': {'congruent': 1, 'same': False, 'type': 'addresses_WT_ht'}}
{'00': 21829}
