...
push %rdi
push %rsi
lea addresses_WT_ht+0x1018e, %rax
nop
nop
nop
nop
...
movw $0x6162, (%rax)
sub $41093, %rdi
lea addresses_D_ht+0xc90e, %rsi
lea addresses_WT_ht+0x1c363, %rdi
nop
nop
nop
nop
...
nop
and %rbp, %rbp
lea addresses_WT_ht+0xd446, %rbp
nop
nop
nop
cmp $5230, %rdi
...
nop
cmp $16475, %rsi
lea addresses_normal_ht+0x18d0e, %rax
nop
nop
nop
nop
...
nop
sub $46490, %rdi
lea addresses_D_ht+0x5a56, %rsi
lea addresses_WC_ht+0x17f4a, %rdi
add $40234, %r14
mov $12, %rcx
rep movsb
nop
...
{'src': {'same': False, 'congruent': 10, 'type': 'addresses_D_ht'}, 'OP': 'REPM', 'dst': {'same': False, 'congruent': 0, 'type': 'addresses_WT_ht'}}
...
{'src': {'same': False, 'congruent': 2, 'type': 'addresses_D_ht'}, 'OP': 'REPM', 'dst': {'same': False, 'congruent': 0, 'type': 'addresses_WC_ht'}}
{'00': 21829}
