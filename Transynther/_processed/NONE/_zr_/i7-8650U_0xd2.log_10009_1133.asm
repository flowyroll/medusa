...
push %rdi
push %rsi
lea addresses_WT_ht+0x57e4, %rbp
add $56486, %r10
...
nop
add $64477, %r10
lea addresses_A_ht+0xe324, %rcx
nop
sub %r10, %r10
mov (%rcx), %r14d
and %r8, %r8
lea addresses_D_ht+0x10124, %rsi
lea addresses_A_ht+0xdd44, %rdi
nop
nop
sub $45322, %r15
mov $34, %rcx
...
nop
sub %r10, %r10
lea addresses_D_ht+0x16a24, %rsi
lea addresses_WT_ht+0x3d84, %rdi
nop
nop
xor %rbp, %rbp
mov $110, %rcx
...
nop
xor %r15, %r15
lea addresses_UC_ht+0x1205c, %rcx
nop
nop
nop
nop
...
nop
sub $27416, %r8
lea addresses_normal_ht+0x10064, %rdi
nop
nop
nop
nop
...
nop
xor $30193, %rbp
lea addresses_normal_ht+0x1f78, %rbp
nop
inc %r10
mov (%rbp), %r14
nop
...
nop
xor $18361, %r8
lea addresses_UC_ht+0xa8f, %rsi
lea addresses_normal_ht+0xed24, %rdi
nop
nop
and $10696, %r15
mov $44, %rcx
...
nop
xor $39710, %rcx
lea addresses_D_ht+0x1b532, %rsi
lea addresses_normal_ht+0x10bd9, %rdi
nop
and %r10, %r10
mov $66, %rcx
rep movsq
...
nop
cmp %rsi, %rsi
lea addresses_D_ht+0x1c524, %r14
nop
nop
nop
nop
...
nop
sub %rdi, %rdi
lea addresses_normal_ht+0x17524, %rsi
lea addresses_WC_ht+0xf724, %rdi
nop
cmp %r8, %r8
mov $34, %rcx
rep movsq
inc %r10
lea addresses_normal_ht+0x154a4, %r14
nop
nop
nop
xor %rdi, %rdi
...
{'OP': 'LOAD', 'src': {'type': 'addresses_A_ht', 'size': 4, 'AVXalign': False, 'NT': False, 'congruent': 9, 'same': True}}
...
{'OP': 'REPM', 'src': {'type': 'addresses_D_ht', 'congruent': 1, 'same': False}, 'dst': {'type': 'addresses_normal_ht', 'congruent': 0, 'same': True}}
