...
push %r8
push %rbp
lea addresses_D_ht+0x1a6de, %r13
nop
nop
nop
add %r10, %r10
...
nop
sub $49446, %r15
lea addresses_normal_ht+0xd6de, %r11
nop
nop
nop
dec %rbp
...
nop
inc %r10
lea addresses_D_ht+0x13d3a, %rbp
nop
nop
nop
nop
...
movw $0x6162, (%rbp)
and %r14, %r14
lea addresses_UC_ht+0x1c3a6, %rbp
nop
nop
nop
dec %r14
...
{'OP': 'LOAD', 'src': {'size': 16, 'NT': False, 'type': 'addresses_US', 'same': False, 'AVXalign': False, 'congruent': 3}}
{'OP': 'STOR', 'dst': {'size': 1, 'NT': False, 'type': 'addresses_A', 'same': False, 'AVXalign': False, 'congruent': 11}}
{'OP': 'LOAD', 'src': {'size': 2, 'NT': True, 'type': 'addresses_P', 'same': False, 'AVXalign': False, 'congruent': 2}}
