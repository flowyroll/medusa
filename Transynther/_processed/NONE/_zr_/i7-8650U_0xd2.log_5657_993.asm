...
push %rdi
push %rsi
lea addresses_normal_ht+0xb3a8, %r11
nop
inc %r14
movb $0x61, (%r11)
nop
...
nop
add %r10, %r10
lea addresses_WT_ht+0x1d228, %r9
add $62430, %r12
...
nop
add $42756, %r11
lea addresses_WT_ht+0x1cf28, %rsi
lea addresses_WT_ht+0x3628, %rdi
nop
nop
nop
sub %r13, %r13
...
nop
add $41239, %r11
lea addresses_UC_ht+0x1cb68, %rax
nop
nop
nop
nop
...
nop
xor $64165, %r12
lea addresses_WT_ht+0x113a8, %rcx
nop
nop
nop
nop
...
nop
sub %r12, %r12
lea addresses_D_ht+0x1d28, %rsi
lea addresses_A_ht+0x1a8b2, %rdi
nop
nop
dec %r10
mov $64, %rcx
...
lea addresses_WT_ht+0x3b28, %rdi
and %r14, %r14
mov $59, %rcx
rep movsw
nop
and %rax, %rax
lea addresses_WT_ht+0x1a048, %rdi
nop
nop
inc %r10
movw $0x6162, (%rdi)
...
nop
cmp $16152, %r12
lea addresses_UC_ht+0xdf98, %r10
dec %rdi
mov (%r10), %rcx
nop
cmp %r9, %r9
lea addresses_normal_ht+0x7ca8, %rsi
lea addresses_UC_ht+0x1eb28, %rdi
nop
nop
nop
nop
...
nop
cmp $52792, %r13
lea addresses_D_ht+0x1ab28, %rsi
lea addresses_WC_ht+0x12b28, %rdi
clflush (%rsi)
add %r13, %r13
mov $47, %rcx
rep movsw
nop
sub %rsi, %rsi
lea addresses_D_ht+0x15228, %r14
nop
add $27144, %rdi
movb $0x61, (%r14)
nop
...
{'OP': 'LOAD', 'src': {'type': 'addresses_UC_ht', 'size': 8, 'AVXalign': True, 'NT': True, 'congruent': 0, 'same': False}}
