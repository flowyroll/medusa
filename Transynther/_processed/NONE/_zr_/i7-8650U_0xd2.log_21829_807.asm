...
push %rdx
push %rsi
lea addresses_normal_ht+0x1d1a6, %r15
nop
nop
add $24053, %rdx
...
nop
inc %rax
lea addresses_WC_ht+0x139a6, %rbx
nop
nop
nop
sub $9670, %r8
...
nop
xor %r9, %r9
lea addresses_normal_ht+0x101a6, %rbx
nop
nop
nop
sub %rsi, %rsi
...
nop
xor $12488, %rsi
lea addresses_normal_ht+0x16d2e, %rsi
lea addresses_D_ht+0xffa6, %rdi
nop
nop
and %r8, %r8
mov $33, %rcx
...
nop
add $10910, %r8
lea addresses_A_ht+0x1891a, %rsi
lea addresses_D_ht+0x12cc2, %rdi
nop
nop
and $52215, %rdx
mov $88, %rcx
...
nop
and $48396, %rsi
lea addresses_UC_ht+0x1dc66, %rsi
nop
nop
nop
xor $28161, %r8
...
<gen_prepare_buffer>
{'OP': 'STOR', 'dst': {'type': 'addresses_normal_ht', 'size': 8, 'AVXalign': False, 'NT': True, 'congruent': 11, 'same': True}}
{'OP': 'LOAD', 'src': {'type': 'addresses_WC_ht', 'size': 2, 'AVXalign': True, 'NT': False, 'congruent': 9, 'same': False}}
