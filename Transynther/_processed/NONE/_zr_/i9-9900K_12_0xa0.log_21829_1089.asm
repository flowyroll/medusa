...
lea addresses_UC_ht+0x6902, %rdi
sub $63950, %r10
mov $75, %rcx
rep movsb
cmp $16978, %rdi
lea addresses_WT_ht+0xca82, %rsi
lea addresses_WT_ht+0xbd82, %rdi
clflush (%rdi)
xor $4678, %rbx
mov $116, %rcx
rep movsl
...
nop
cmp $19958, %rbx
lea addresses_D_ht+0x186bc, %rdi
nop
xor $21465, %r10
movb $0x61, (%rdi)
nop
inc %rsi
lea addresses_A_ht+0x17c02, %rbx
nop
nop
nop
nop
...
nop
sub %r11, %r11
lea addresses_UC_ht+0x1c702, %r11
clflush (%r11)
nop
nop
nop
...
nop
sub $59659, %rbx
lea addresses_WC_ht+0x178c2, %rcx
nop
nop
nop
nop
...
{'src': {'same': False, 'congruent': 9, 'type': 'addresses_normal_ht'}, 'OP': 'REPM', 'dst': {'same': False, 'congruent': 9, 'type': 'addresses_UC_ht'}}
{'src': {'same': False, 'congruent': 4, 'type': 'addresses_WT_ht'}, 'OP': 'REPM', 'dst': {'same': False, 'congruent': 7, 'type': 'addresses_WT_ht'}}
...
{'src': {'NT': False, 'same': False, 'congruent': 5, 'type': 'addresses_WC_ht', 'AVXalign': True, 'size': 2}, 'OP': 'LOAD'}
