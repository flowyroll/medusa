...
push %rbx
push %rsi
lea addresses_WC_ht+0xd6d8, %rbx
nop
nop
nop
nop
...
mov (%rbx), %r12w
cmp $26226, %r9
lea addresses_WT_ht+0x17fd2, %r9
inc %rsi
mov (%r9), %r11
nop
nop
...
nop
add $56607, %rbx
lea addresses_normal_ht+0x18526, %r10
nop
nop
and %r9, %r9
mov (%r10), %rbx
...
nop
cmp $62463, %r12
lea addresses_A_ht+0x106d8, %rbx
nop
add $43233, %r15
mov (%rbx), %r9d
nop
...
// Load
lea addresses_normal+0x1308, %rbx
nop
nop
cmp $25504, %rsi
mov (%rbx), %bp
...
{'OP': 'LOAD', 'src': {'type': 'addresses_NC', 'AVXalign': False, 'congruent': 9, 'size': 8, 'same': False, 'NT': False}}
{'OP': 'LOAD', 'src': {'type': 'addresses_normal', 'AVXalign': True, 'congruent': 4, 'size': 2, 'same': False, 'NT': False}}
[Faulty Load]
