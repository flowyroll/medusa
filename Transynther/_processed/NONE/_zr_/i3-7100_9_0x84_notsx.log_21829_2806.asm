...
nop
sub %r10, %r10
lea addresses_WT_ht+0x15628, %rsi
lea addresses_normal_ht+0x1de28, %rdi
nop
nop
nop
xor $12582, %r8
...
nop
sub $18065, %r11
lea addresses_normal_ht+0x1c0bc, %rsi
lea addresses_UC_ht+0x1d5f4, %rdi
nop
nop
nop
dec %r10
...
nop
add %r11, %r11
lea addresses_UC_ht+0x2428, %rcx
nop
nop
nop
sub %r13, %r13
mov (%rcx), %r8d
dec %r13
lea addresses_UC_ht+0x130a8, %rsi
lea addresses_normal_ht+0x1b1a4, %rdi
clflush (%rsi)
nop
nop
cmp %r9, %r9
