...
push %rdi
push %rsi
lea addresses_A_ht+0x1ab63, %rsi
lea addresses_A_ht+0x1d8f7, %rdi
nop
nop
nop
nop
...
nop
and $55191, %rax
lea addresses_WC_ht+0x16f63, %r8
nop
nop
nop
nop
...
nop
cmp $11590, %r8
lea addresses_WC_ht+0x14e43, %rcx
nop
nop
nop
nop
...
nop
and $27162, %r13
lea addresses_normal_ht+0x1b82b, %rsi
lea addresses_A_ht+0x18863, %rdi
nop
nop
and $33938, %rax
mov $16, %rcx
...
nop
cmp %rcx, %rcx
lea addresses_D_ht+0x1b163, %rsi
lea addresses_WT_ht+0xbac7, %rdi
nop
cmp $36883, %rbp
mov $10, %rcx
rep movsq
...
{'OP': 'LOAD', 'src': {'type': 'addresses_WC_ht', 'size': 8, 'AVXalign': False, 'NT': False, 'congruent': 4, 'same': True}}
{'OP': 'LOAD', 'src': {'type': 'addresses_A_ht', 'size': 2, 'AVXalign': False, 'NT': False, 'congruent': 5, 'same': False}}
{'OP': 'REPM', 'src': {'type': 'addresses_normal_ht', 'congruent': 3, 'same': True}, 'dst': {'type': 'addresses_A_ht', 'congruent': 8, 'same': False}}
