...
push %rdi
push %rsi
lea addresses_A_ht+0x6afb, %rsi
lea addresses_normal_ht+0x18467, %rdi
nop
nop
nop
nop
...
nop
xor %rdi, %rdi
lea addresses_normal_ht+0xd467, %rsi
lea addresses_D_ht+0x3d66, %rdi
nop
nop
nop
nop
...
nop
cmp %r10, %r10
lea addresses_WT_ht+0x1e267, %rsi
nop
nop
nop
dec %r12
...
nop
sub %rdi, %rdi
lea addresses_UC_ht+0x13c67, %r9
nop
nop
nop
and $11353, %rcx
...
nop
sub %rdi, %rdi
lea addresses_WC_ht+0x6147, %r11
nop
nop
nop
and $20083, %r9
...
nop
and %r10, %r10
lea addresses_A_ht+0x1e858, %rsi
lea addresses_WT_ht+0xd427, %rdi
nop
nop
nop
xor %r14, %r14
...
nop
sub $51370, %rdi
lea addresses_A_ht+0x1a63f, %rcx
cmp $47633, %r9
movw $0x6162, (%rcx)
nop
nop
...
nop
cmp $37692, %rcx
lea addresses_WC_ht+0xa347, %rsi
lea addresses_D_ht+0x8667, %rdi
clflush (%rsi)
nop
nop
nop
...
nop
and $44653, %rdi
lea addresses_WT_ht+0x12c67, %rsi
lea addresses_WT_ht+0x17142, %rdi
add %r14, %r14
mov $29, %rcx
rep movsl
sub $13449, %r9
