...
push %rdi
push %rsi
lea addresses_WC_ht+0x18812, %rsi
lea addresses_D_ht+0x1dfd2, %rdi
nop
inc %r9
mov $107, %rcx
rep movsq
...
nop
sub $7147, %rbp
lea addresses_normal_ht+0x1210e, %r14
nop
cmp $65521, %r9
mov (%r14), %rsi
nop
nop
cmp $4862, %rsi
lea addresses_D_ht+0x19c12, %rbp
nop
xor %r14, %r14
mov (%rbp), %rsi
nop
sub %rcx, %rcx
lea addresses_D_ht+0x1e912, %rcx
nop
nop
nop
nop
...
nop
cmp %r9, %r9
lea addresses_WT_ht+0x80d2, %r14
and $41443, %rsi
movl $0x61626364, (%r14)
nop
nop
...
{'OP': 'LOAD', 'src': {'type': 'addresses_normal_ht', 'size': 8, 'AVXalign': True, 'NT': False, 'congruent': 2, 'same': False}}
