...
lea addresses_D_ht+0x16533, %rdi
nop
nop
nop
nop
...
nop
cmp %rcx, %rcx
lea addresses_WT_ht+0x1a4c1, %rsi
lea addresses_WT_ht+0x1dc5d, %rdi
nop
nop
nop
nop
...
nop
dec %rdi
lea addresses_A_ht+0x150c1, %rsi
lea addresses_A_ht+0xc9e1, %rdi
add $7012, %r8
mov $95, %rcx
rep movsb
nop
...
nop
sub $37478, %rbx
lea addresses_normal_ht+0x19f51, %rsi
lea addresses_normal_ht+0x1cc1, %rdi
sub $21134, %r13
mov $7, %rcx
rep movsb
xor %r8, %r8
...
// Store
lea addresses_D+0x14fc1, %rdx
add %rsi, %rsi
movl $0x51525354, (%rdx)
add $60371, %rsi

// Store
lea addresses_normal+0x106d9, %r13
cmp $48386, %rbp
...
{'OP': 'REPM', 'src': {'type': 'addresses_WT_ht', 'congruent': 8, 'same': False}, 'dst': {'type': 'addresses_WT_ht', 'congruent': 2, 'same': False}}
