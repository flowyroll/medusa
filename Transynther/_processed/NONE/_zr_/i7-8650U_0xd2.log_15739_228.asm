...
nop
xor %r13, %r13
lea addresses_UC_ht+0x120f9, %rcx
nop
nop
nop
nop
...
movw $0x6162, (%rcx)
cmp %r15, %r15
lea addresses_WT_ht+0x1bb79, %rsi
lea addresses_normal_ht+0x4519, %rdi
nop
nop
nop
nop
...
nop
cmp %rbp, %rbp
lea addresses_normal_ht+0x6379, %rdi
nop
nop
xor %rcx, %rcx
mov (%rdi), %rsi
...
nop
sub $31230, %rsi
lea addresses_UC_ht+0x10949, %rbp
nop
nop
sub $34911, %rsi
movb (%rbp), %cl
...
nop
xor $20509, %rcx
lea addresses_UC_ht+0x7979, %rsi
lea addresses_WT_ht+0x16e39, %rdi
nop
nop
nop
and %r11, %r11
...
nop
cmp $4631, %r13
lea addresses_WC_ht+0x6079, %rcx
xor %r11, %r11
movb (%rcx), %r13b
nop
and $6473, %r11
lea addresses_UC_ht+0x1de2c, %rcx
xor %r15, %r15
mov (%rcx), %r13w
cmp %rbp, %rbp
pop %rsi
