...
push %rdx
push %rsi
lea addresses_UC_ht+0x62d2, %rsi
lea addresses_UC_ht+0x9a2c, %rdi
clflush (%rsi)
nop
nop
nop
...
lea addresses_D_ht+0x66d2, %rdi
nop
sub %r10, %r10
mov $54, %rcx
rep movsq
dec %rdx
lea addresses_A_ht+0xdf2, %rsi
nop
and $55617, %r14
mov (%rsi), %r10d
nop
...
lea addresses_A_ht+0x1a6cc, %rdi
clflush (%rdi)
and $44169, %r11
mov $123, %rcx
rep movsb
...
{'OP': 'STOR', 'dst': {'type': 'addresses_P', 'size': 16, 'AVXalign': False, 'NT': True, 'congruent': 2, 'same': False}}
[Faulty Load]
...
{'OP': 'REPM', 'src': {'type': 'addresses_A_ht', 'congruent': 2, 'same': False}, 'dst': {'type': 'addresses_D_ht', 'congruent': 9, 'same': False}}
