...
push %rdi
push %rsi
lea addresses_A_ht+0x10dcc, %r11
nop
nop
inc %r14
...
nop
cmp %r8, %r8
lea addresses_UC_ht+0x1386c, %rax
add $62465, %r9
mov (%rax), %rbx
nop
nop
...
nop
and $59807, %r14
lea addresses_UC_ht+0xd7fc, %rsi
lea addresses_UC_ht+0x252c, %rdi
nop
nop
nop
nop
...
nop
xor $45759, %r14
lea addresses_D_ht+0x11f4e, %rsi
lea addresses_normal_ht+0x1af52, %rdi
nop
nop
nop
nop
...
rep movsw
add $53260, %r11
lea addresses_normal_ht+0x2bac, %rsi
lea addresses_WT_ht+0x69b4, %rdi
clflush (%rsi)
clflush (%rdi)
nop
nop
...
<gen_prepare_buffer>
{'OP': 'STOR', 'dst': {'type': 'addresses_A_ht', 'size': 16, 'AVXalign': False, 'NT': False, 'congruent': 3, 'same': True}}
