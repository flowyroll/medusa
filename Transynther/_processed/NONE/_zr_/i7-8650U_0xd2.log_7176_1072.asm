...
push %rdx
push %rsi
lea addresses_normal_ht+0x482d, %r13
nop
nop
nop
sub %r8, %r8
...
nop
and %rbx, %rbx
lea addresses_UC_ht+0xd640, %rdx
nop
nop
and $36584, %r15
mov (%rdx), %bx
...
nop
sub %r13, %r13
lea addresses_WT_ht+0xab40, %r15
nop
nop
nop
nop
...
nop
add $10694, %r15
lea addresses_D_ht+0x1ee82, %rsi
lea addresses_normal_ht+0x8f40, %rdi
nop
nop
nop
nop
...
nop
and %rdx, %rdx
lea addresses_D_ht+0x17e0, %rsi
lea addresses_normal_ht+0x1d540, %rdi
nop
nop
add $62876, %rdx
mov $61, %rcx
...
nop
and $59027, %r13
lea addresses_WT_ht+0xa040, %rbx
nop
nop
nop
nop
...
movl $0x61626364, (%r8)
cmp %rdi, %rdi
lea addresses_A_ht+0x18c40, %rdi
nop
dec %rdx
movw $0x6162, (%rdi)
nop
...
nop
xor %rbx, %rbx
lea addresses_WT_ht+0x14340, %rsi
lea addresses_WT_ht+0xeb40, %rdi
nop
cmp $61463, %r15
mov $28, %rcx
rep movsb
...
{'OP': 'STOR', 'dst': {'type': 'addresses_WT_ht', 'size': 2, 'AVXalign': True, 'NT': False, 'congruent': 6, 'same': False}}
{'OP': 'STOR', 'dst': {'type': 'addresses_UC_ht', 'size': 4, 'AVXalign': False, 'NT': False, 'congruent': 9, 'same': False}}
{'OP': 'STOR', 'dst': {'type': 'addresses_A_ht', 'size': 2, 'AVXalign': True, 'NT': True, 'congruent': 4, 'same': False}}
