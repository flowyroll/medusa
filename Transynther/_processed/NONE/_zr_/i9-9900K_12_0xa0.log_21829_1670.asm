...
push %rdi
push %rsi
lea addresses_normal_ht+0xfd36, %rdi
nop
nop
nop
nop
...
movb $0x61, (%rdi)
cmp %r15, %r15
lea addresses_WT_ht+0x1bf36, %rbp
clflush (%rbp)
nop
nop
nop
...
nop
add %rbp, %rbp
lea addresses_WC_ht+0x18e36, %rdi
sub $5941, %r14
movb (%rdi), %r15b
nop
nop
...
nop
cmp $47739, %r8
lea addresses_D_ht+0x172ca, %r15
nop
nop
sub %rbx, %rbx
vmovups (%r15), %ymm5
...
nop
cmp %r8, %r8
lea addresses_WC_ht+0x1ee36, %r14
nop
and $41226, %rdi
...
vmovups %ymm5, (%r14)
add %rbp, %rbp
lea addresses_UC_ht+0x8236, %rsi
...
{'src': {'NT': True, 'same': True, 'congruent': 10, 'type': 'addresses_WC_ht', 'AVXalign': False, 'size': 1}, 'OP': 'LOAD'}
...
{'src': {'same': False, 'congruent': 11, 'type': 'addresses_UC_ht'}, 'OP': 'REPM', 'dst': {'same': False, 'congruent': 3, 'type': 'addresses_normal_ht'}}
{'00': 21829}
