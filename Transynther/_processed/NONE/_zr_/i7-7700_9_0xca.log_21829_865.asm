...
push %rdx
push %rsi
lea addresses_WT_ht+0xaee4, %rdx
nop
nop
add %r9, %r9
...
nop
dec %rdi
lea addresses_WT_ht+0x18024, %rcx
nop
nop
cmp $10925, %rdi
...
nop
dec %rdi
lea addresses_WT_ht+0xc824, %rsi
lea addresses_A_ht+0x58b9, %rdi
nop
cmp %rax, %rax
mov $7, %rcx
rep movsq
...
nop
xor %rdi, %rdi
lea addresses_normal_ht+0xd424, %rsi
lea addresses_A_ht+0x10d24, %rdi
nop
sub $3322, %rax
mov $0, %rcx
rep movsq
...
nop
add $48634, %r14
lea addresses_D_ht+0x15664, %rdi
cmp %rsi, %rsi
mov (%rdi), %rcx
nop
nop
add %r14, %r14
lea addresses_D_ht+0x177b8, %r9
nop
nop
nop
nop
...
mov (%r9), %rax
xor %r14, %r14
lea addresses_normal_ht+0xc1e4, %rsi
lea addresses_UC_ht+0x19524, %rdi
dec %r10
mov $116, %rcx
rep movsb
nop
...
nop
sub $12140, %rcx
lea addresses_D_ht+0x13024, %rax
clflush (%rax)
nop
nop
nop
...
nop
inc %rcx
lea addresses_UC_ht+0xc24, %rsi
lea addresses_WC_ht+0x9a64, %rdi
nop
and %r9, %r9
mov $65, %rcx
rep movsw
cmp %r9, %r9
lea addresses_D_ht+0x9524, %r10
nop
nop
and %r9, %r9
mov (%r10), %edi
...
{'src': {'congruent': 10, 'same': False, 'type': 'addresses_WT_ht'}, 'OP': 'REPM', 'dst': {'congruent': 0, 'same': False, 'type': 'addresses_A_ht'}}
...
{'src': {'congruent': 11, 'same': False, 'type': 'addresses_UC_ht'}, 'OP': 'REPM', 'dst': {'congruent': 5, 'same': False, 'type': 'addresses_WC_ht'}}
