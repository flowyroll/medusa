...
push %rdi
push %rsi
lea addresses_normal_ht+0x14a3f, %rsi
lea addresses_WC_ht+0x19407, %rdi
nop
nop
nop
nop
...
lea addresses_D_ht+0x109c7, %rdi
nop
nop
nop
nop
...
nop
add $43114, %rbp
lea addresses_UC_ht+0x1b9c7, %rax
nop
nop
nop
nop
...
nop
xor $46241, %rbp
lea addresses_normal_ht+0x18207, %rsi
lea addresses_D_ht+0xec07, %rdi
nop
nop
nop
nop
...
nop
and $16468, %r13
lea addresses_WC_ht+0x15cc7, %rcx
nop
sub $23658, %r13
...
nop
cmp %r15, %r15
lea addresses_WT_ht+0x15f12, %rax
nop
sub %rcx, %rcx
mov $0x6162636465666768, %r15
movq %r15, (%rax)
