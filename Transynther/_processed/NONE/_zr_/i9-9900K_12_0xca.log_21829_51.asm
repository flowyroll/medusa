...
push %rdx
push %rsi
lea addresses_WC_ht+0x2e83, %r11
nop
sub %r9, %r9
mov (%r11), %rdx
nop
...
lea addresses_normal_ht+0x8be3, %rdi
sub $2072, %rax
mov $53, %rcx
rep movsb
nop
...
// Store
lea addresses_D+0x1ee23, %rdi
inc %rbx
movw $0x5152, (%rdi)
add %rdi, %rdi

// Store
lea addresses_WC+0x117db, %rcx
cmp $30427, %rsi
movw $0x5152, (%rcx)
nop
nop
...
{'OP': 'LOAD', 'src': {'size': 4, 'NT': False, 'type': 'addresses_A', 'same': False, 'AVXalign': False, 'congruent': 11}}
...
{'OP': 'LOAD', 'src': {'size': 16, 'NT': True, 'type': 'addresses_PSE', 'same': False, 'AVXalign': False, 'congruent': 8}}
...
{'OP': 'REPM', 'src': {'same': True, 'type': 'addresses_UC_ht', 'congruent': 11}, 'dst': {'same': False, 'type': 'addresses_normal_ht', 'congruent': 9}}
