...
push %rdx
push %rsi
lea addresses_D_ht+0x19d10, %r15
nop
nop
nop
nop
...
nop
sub %rbp, %rbp
lea addresses_normal_ht+0xb250, %rsi
lea addresses_A_ht+0x107d0, %rdi
nop
nop
nop
nop
...
rep movsq
add $54154, %rcx
lea addresses_normal_ht+0x3a10, %rsi
lea addresses_WT_ht+0x7750, %rdi
nop
nop
nop
nop
...
nop
cmp $28545, %rsi
lea addresses_UC_ht+0x13f50, %rsi
nop
nop
nop
and %rdi, %rdi
...
{'OP': 'LOAD', 'src': {'size': 16, 'NT': True, 'type': 'addresses_D', 'same': False, 'AVXalign': False, 'congruent': 11}}
[Faulty Load]
