...
push %rdi
push %rsi
lea addresses_A_ht+0x10ad4, %rcx
nop
nop
nop
nop
...
nop
and $27208, %r15
lea addresses_normal_ht+0x22b4, %r11
nop
nop
nop
and $5495, %r12
...
nop
add %rcx, %rcx
lea addresses_D_ht+0x10eae, %rbp
nop
nop
nop
dec %r12
...
nop
and $17965, %rcx
lea addresses_WT_ht+0x1882f, %rbp
nop
nop
nop
sub %rax, %rax
...
nop
and %rax, %rax
lea addresses_A_ht+0x11db4, %rsi
lea addresses_UC_ht+0xe64e, %rdi
nop
xor $44099, %r9
mov $64, %rcx
rep movsw
...
// Load
lea addresses_normal+0x19434, %r13
nop
nop
and $40797, %rax
mov (%r13), %r9
...
{'OP': 'LOAD', 'src': {'size': 8, 'NT': False, 'type': 'addresses_normal', 'same': False, 'AVXalign': False, 'congruent': 7}}
[Faulty Load]
...
{'OP': 'REPM', 'src': {'same': False, 'type': 'addresses_A_ht', 'congruent': 8}, 'dst': {'same': False, 'type': 'addresses_UC_ht', 'congruent': 1}}
{'00': 21829}
