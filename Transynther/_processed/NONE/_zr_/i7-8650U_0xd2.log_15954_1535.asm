...
nop
and $52869, %rbx
lea addresses_D_ht+0x14712, %r10
nop
nop
add %r11, %r11
...
nop
add %r11, %r11
lea addresses_WT_ht+0x11492, %rsi
lea addresses_A_ht+0xb2, %rdi
nop
and %r11, %r11
mov $3, %rcx
rep movsq
...
lea addresses_A_ht+0x17bea, %rdi
nop
nop
inc %r14
mov $37, %rcx
...
nop
add %r14, %r14
lea addresses_WT_ht+0x1cd92, %rsi
lea addresses_A_ht+0x16292, %rdi
nop
nop
sub %r10, %r10
mov $33, %rcx
...
nop
add $38188, %rdi
lea addresses_UC_ht+0x13992, %rsi
lea addresses_normal_ht+0xc112, %rdi
nop
nop
nop
cmp $8221, %r14
...
{'OP': 'STOR', 'dst': {'type': 'addresses_A', 'size': 16, 'AVXalign': False, 'NT': True, 'congruent': 10, 'same': False}}
...
{'OP': 'LOAD', 'src': {'type': 'addresses_NC', 'size': 8, 'AVXalign': False, 'NT': False, 'congruent': 7, 'same': False}}
[Faulty Load]
...
{'OP': 'REPM', 'src': {'type': 'addresses_WT_ht', 'congruent': 8, 'same': True}, 'dst': {'type': 'addresses_A_ht', 'congruent': 5, 'same': False}}
