...
push %rdi
push %rsi
lea addresses_A_ht+0x1ed66, %rsi
lea addresses_D_ht+0x1c5ae, %rdi
clflush (%rsi)
nop
and %r9, %r9
mov $74, %rcx
...
nop
and %rdi, %rdi
lea addresses_normal_ht+0x1ef96, %rbp
nop
nop
dec %rsi
...
vmovups %ymm6, (%rbp)
add $35093, %rsi
lea addresses_UC_ht+0xff96, %rbp
nop
nop
dec %r15
mov (%rbp), %r8w
sub $15980, %r9
lea addresses_UC_ht+0x1542a, %rsi
nop
sub $17188, %rbp
movb $0x61, (%rsi)
nop
