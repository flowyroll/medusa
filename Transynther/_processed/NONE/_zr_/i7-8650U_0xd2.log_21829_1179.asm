...
nop
add $56104, %r13
lea addresses_normal_ht+0x7a0b, %rsi
nop
nop
nop
nop
...
nop
mfence
lea addresses_D_ht+0x782c, %r13
nop
sub $44192, %r10
movb (%r13), %bl
nop
xor %r12, %r12
lea addresses_WC_ht+0x1145b, %r13
nop
nop
nop
nop
...
nop
cmp $59796, %r11
lea addresses_UC_ht+0x11c5b, %rsi
lea addresses_WC_ht+0xfc5b, %rdi
nop
cmp %rdx, %rdx
mov $24, %rcx
rep movsw
...
nop
sub $32704, %rdi
lea addresses_UC_ht+0xbc57, %rdx
nop
nop
nop
inc %rbx
mov (%rdx), %si
add %rcx, %rcx
lea addresses_normal_ht+0x17c7b, %r12
clflush (%r12)
nop
nop
inc %rdx
...
nop
sub $61883, %rbx
lea addresses_WC_ht+0x989b, %r12
clflush (%r12)
nop
nop
cmp %rsi, %rsi
...
nop
cmp $2414, %rdi
lea addresses_UC_ht+0x1131b, %rcx
nop
nop
nop
nop
...
// Load
lea addresses_normal+0x1105b, %r9
nop
nop
and $18924, %r8
mov (%r9), %r12
...
{'OP': 'LOAD', 'src': {'type': 'addresses_normal', 'size': 8, 'AVXalign': False, 'NT': True, 'congruent': 8, 'same': False}}
...
{'OP': 'LOAD', 'src': {'type': 'addresses_D_ht', 'size': 1, 'AVXalign': False, 'NT': True, 'congruent': 0, 'same': False}}
...
{'OP': 'STOR', 'dst': {'type': 'addresses_WC_ht', 'size': 2, 'AVXalign': False, 'NT': False, 'congruent': 6, 'same': True}}
