...
// Store
lea addresses_normal+0x1cedd, %rdx
nop
nop
sub %rax, %rax
mov $0x5152535455565758, %rbp
...
// Load
lea addresses_UC+0x1ab7d, %rdx
and %r11, %r11
mov (%rdx), %rcx
and %rbp, %rbp

// Load
lea addresses_PSE+0x13f5d, %r10
nop
nop
and $41369, %rdx
mov (%r10), %r11w
...
{'OP': 'LOAD', 'src': {'same': False, 'type': 'addresses_UC', 'NT': False, 'AVXalign': False, 'size': 8, 'congruent': 4}}
