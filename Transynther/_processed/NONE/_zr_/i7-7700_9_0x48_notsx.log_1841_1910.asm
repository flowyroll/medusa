...
push %rdi
push %rsi
lea addresses_normal_ht+0x16d8d, %r11
nop
nop
nop
nop
...
nop
and %r11, %r11
lea addresses_D_ht+0x16f8d, %rsi
lea addresses_WT_ht+0x798d, %rdi
nop
nop
nop
nop
...
lea addresses_UC_ht+0x14024, %rdi
nop
nop
nop
nop
...
{'OP': 'LOAD', 'src': {'same': False, 'NT': False, 'AVXalign': False, 'size': 1, 'type': 'addresses_US', 'congruent': 4}}
...
{'dst': {'same': False, 'NT': False, 'AVXalign': True, 'size': 2, 'type': 'addresses_PSE', 'congruent': 6}, 'OP': 'STOR'}
...
{'dst': {'same': False, 'congruent': 8, 'type': 'addresses_WT_ht'}, 'OP': 'REPM', 'src': {'same': False, 'congruent': 8, 'type': 'addresses_D_ht'}}
