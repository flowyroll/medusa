...
nop
add %rsi, %rsi
lea addresses_WT_ht+0x17aac, %r15
and $51884, %r9
movb (%r15), %al
nop
nop
...
nop
sub %r9, %r9
lea addresses_WC_ht+0xf85c, %r15
nop
nop
nop
nop
...
nop
cmp %r9, %r9
lea addresses_D_ht+0x5d4, %rsi
lea addresses_UC_ht+0x31c4, %rdi
nop
cmp $43845, %r12
mov $121, %rcx
rep movsw
...
// Load
lea addresses_normal+0x1976c, %rbx
nop
nop
nop
nop
...
// Store
lea addresses_normal+0x77dc, %r15
nop
nop
nop
nop
...
{'OP': 'LOAD', 'src': {'type': 'addresses_normal', 'size': 2, 'AVXalign': False, 'NT': False, 'congruent': 5, 'same': True}}
{'OP': 'STOR', 'dst': {'type': 'addresses_UC', 'size': 2, 'AVXalign': False, 'NT': True, 'congruent': 3, 'same': True}}
...
{'OP': 'REPM', 'src': {'type': 'addresses_US', 'congruent': 8, 'same': False}, 'dst': {'type': 'addresses_P', 'congruent': 7, 'same': False}}
