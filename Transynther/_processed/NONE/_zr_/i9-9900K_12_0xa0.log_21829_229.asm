...
nop
inc %r13
lea addresses_UC_ht+0x8780, %rsi
lea addresses_WC_ht+0xc530, %rdi
nop
nop
nop
nop
...
rep movsq
xor $13021, %r13
lea addresses_A_ht+0xfea0, %rdi
add $54762, %rax
movl $0x61626364, (%rdi)
nop
xor $5049, %r14
lea addresses_A_ht+0x3620, %r14
nop
nop
nop
add %rcx, %rcx
...
mov (%r14), %edi
xor $58966, %r9
lea addresses_A_ht+0x127d0, %r13
nop
nop
nop
nop
...
nop
inc %rsi
lea addresses_normal_ht+0x174a0, %r9
clflush (%r9)
nop
nop
nop
...
nop
sub %r14, %r14
lea addresses_A_ht+0x10340, %r14
nop
nop
nop
nop
...
nop
add %rcx, %rcx
lea addresses_WT_ht+0xdca0, %rdi
cmp %rax, %rax
movups (%rdi), %xmm6
vpextrq $0, %xmm6, %r13
nop
...
{'src': {'same': False, 'congruent': 5, 'type': 'addresses_UC_ht'}, 'OP': 'REPM', 'dst': {'same': False, 'congruent': 4, 'type': 'addresses_WC_ht'}}
