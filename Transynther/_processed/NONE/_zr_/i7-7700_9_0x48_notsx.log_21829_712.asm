...
push %rdi
push %rsi
lea addresses_D_ht+0x1ba64, %rax
clflush (%rax)
nop
nop
add $46005, %r11
...
nop
dec %rcx
lea addresses_D_ht+0x1da64, %r11
sub %r13, %r13
...
nop
inc %rax
lea addresses_UC_ht+0x18004, %rcx
nop
nop
add $5114, %r10
movw $0x6162, (%rcx)
...
nop
dec %r11
lea addresses_WC_ht+0x6264, %r11
nop
nop
nop
nop
...
nop
sub $18949, %rdi
lea addresses_UC_ht+0x15664, %rcx
nop
nop
add %rax, %rax
movb $0x61, (%rcx)
...
nop
inc %r11
lea addresses_UC_ht+0xf004, %r13
nop
nop
nop
nop
...
nop
cmp $28725, %rbp
lea addresses_A_ht+0x19264, %r11
nop
nop
nop
add %rax, %rax
mov (%r11), %rdi
and %rdi, %rdi
lea addresses_WT_ht+0xea64, %r11
cmp $50985, %r13
movw $0x6162, (%r11)
nop
nop
nop
and $43109, %r10
lea addresses_WT_ht+0x16a64, %r13
nop
nop
nop
nop
...
nop
and $20853, %rcx
lea addresses_WT_ht+0x17a04, %r11
nop
nop
nop
nop
...
{'dst': {'same': False, 'congruent': 2, 'type': 'addresses_US'}, 'OP': 'REPM', 'src': {'same': False, 'congruent': 8, 'type': 'addresses_P'}}
[Faulty Load]
...
{'OP': 'LOAD', 'src': {'same': False, 'NT': False, 'AVXalign': True, 'size': 8, 'type': 'addresses_WT_ht', 'congruent': 1}}
