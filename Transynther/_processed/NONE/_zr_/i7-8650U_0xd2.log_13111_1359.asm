...
push %rdi
push %rsi
lea addresses_WC_ht+0x1012e, %r11
nop
nop
xor %rsi, %rsi
movw $0x6162, (%r11)
...
lea addresses_normal_ht+0xf0ec, %rdi
nop
nop
nop
nop
...
nop
cmp %rax, %rax
lea addresses_normal_ht+0xe40c, %rsi
lea addresses_A_ht+0x163ab, %rdi
nop
nop
nop
nop
...
nop
add $30012, %r14
lea addresses_normal_ht+0x1e80c, %r10
sub %rcx, %rcx
...
nop
cmp $59598, %rcx
lea addresses_WC_ht+0x1148c, %rdi
nop
nop
sub %rcx, %rcx
movw $0x6162, (%rdi)
...
nop
cmp %rsi, %rsi
lea addresses_WT_ht+0xfcba, %rsi
nop
nop
and $3786, %rax
...
nop
and $48703, %r11
lea addresses_WT_ht+0x1ec0c, %rcx
and $13940, %rsi
movl $0x61626364, (%rcx)
nop
nop
sub $56140, %r14
lea addresses_UC_ht+0xbf0c, %rsi
lea addresses_WC_ht+0x620c, %rdi
clflush (%rsi)
nop
nop
nop
...
nop
inc %rbp
lea addresses_WC_ht+0x1070c, %rax
nop
nop
mfence
mov (%rax), %r10d
nop
and %rbp, %rbp
lea addresses_WC_ht+0x16c0c, %rsi
nop
nop
xor %rdi, %rdi
