...
push %rdx
push %rsi
lea addresses_WC_ht+0xa86f, %r12
nop
nop
add %rdx, %rdx
movb $0x61, (%r12)
...
nop
xor %rdi, %rdi
lea addresses_UC_ht+0x15eaf, %rsi
lea addresses_UC_ht+0x157af, %rdi
nop
nop
cmp %r9, %r9
mov $22, %rcx
...
nop
and $34187, %rdx
lea addresses_WT_ht+0x90b9, %rsi
lea addresses_WT_ht+0x6e4f, %rdi
nop
nop
nop
xor $23506, %r11
...
{'OP': 'LOAD', 'src': {'type': 'addresses_A', 'AVXalign': False, 'congruent': 10, 'size': 16, 'same': False, 'NT': False}}
[Faulty Load]
{'OP': 'LOAD', 'src': {'type': 'addresses_A', 'AVXalign': False, 'congruent': 0, 'size': 8, 'same': True, 'NT': False}}
<gen_prepare_buffer>
{'OP': 'STOR', 'dst': {'type': 'addresses_WC_ht', 'AVXalign': True, 'congruent': 6, 'size': 1, 'same': False, 'NT': False}}
