...
nop
inc %rdi
lea addresses_A_ht+0x13977, %rsi
lea addresses_A_ht+0x17297, %rdi
nop
nop
and $59415, %r10
mov $6, %rcx
rep movsw
sub %rsi, %rsi
lea addresses_D_ht+0x2eb7, %rsi
lea addresses_normal_ht+0xeb7, %rdi
nop
and $21299, %r12
mov $68, %rcx
rep movsb
...
nop
add %r10, %r10
lea addresses_WT_ht+0x177c7, %rdi
nop
nop
nop
nop
...
nop
inc %rax
lea addresses_WT_ht+0xccf7, %r12
nop
sub %r14, %r14
movw $0x6162, (%r12)
add $21125, %rsi
lea addresses_WC_ht+0x14bd7, %rsi
lea addresses_normal_ht+0x2e37, %rdi
nop
nop
cmp %rbx, %rbx
mov $114, %rcx
rep movsw
and $55781, %rsi
lea addresses_WT_ht+0x11cd7, %rsi
add $25034, %rcx
...
nop
and $8697, %r10
lea addresses_normal_ht+0xfeb7, %r12
and $48836, %rdi
mov (%r12), %rax
nop
nop
...
nop
inc %r10
lea addresses_WT_ht+0x1e513, %r12
inc %rdi
movups (%r12), %xmm6
vpextrq $1, %xmm6, %r10
nop
nop
xor %rbx, %rbx
lea addresses_WC_ht+0xdc3f, %rbx
nop
nop
xor %r12, %r12
mov (%rbx), %di
and %rcx, %rcx
lea addresses_WC_ht+0x3eb7, %rbx
nop
nop
xor $34154, %rax
movb $0x61, (%rbx)
...
nop
cmp %r12, %r12
lea addresses_D_ht+0x95e7, %rsi
lea addresses_D_ht+0x10013, %rdi
clflush (%rsi)
nop
nop
nop
...
{'OP': 'LOAD', 'src': {'type': 'addresses_WT', 'AVXalign': False, 'congruent': 10, 'size': 4, 'same': False, 'NT': False}}
...
<gen_prepare_buffer>
{'OP': 'REPM', 'src': {'type': 'addresses_D_ht', 'congruent': 7, 'same': False}, 'dst': {'type': 'addresses_WC_ht', 'congruent': 7, 'same': True}}
{'OP': 'REPM', 'src': {'type': 'addresses_A_ht', 'congruent': 4, 'same': False}, 'dst': {'type': 'addresses_A_ht', 'congruent': 5, 'same': False}}
