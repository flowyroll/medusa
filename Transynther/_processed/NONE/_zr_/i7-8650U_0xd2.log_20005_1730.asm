...
push %rdx
push %rsi
lea addresses_WC_ht+0x14a2a, %rdx
nop
and $2471, %r14
...
nop
add $61087, %r8
lea addresses_WC_ht+0x14e2a, %rbp
dec %r8
mov (%rbp), %r15
nop
nop
...
nop
dec %r15
lea addresses_UC_ht+0x715a, %r15
nop
nop
nop
nop
...
mov (%r15), %esi
add $35295, %rsi
lea addresses_WT_ht+0x172ba, %rdi
and %r8, %r8
movb (%rdi), %r14b
nop
nop
...
nop
add $64934, %rsi
lea addresses_WT_ht+0x1848a, %rbp
nop
nop
nop
nop
...
nop
xor %rsi, %rsi
lea addresses_WT_ht+0x15c2a, %rdi
nop
nop
dec %rbp
movups (%rdi), %xmm3
...
nop
cmp $47387, %rdx
lea addresses_WC_ht+0x4b68, %rsi
add $29114, %rbp
movb $0x61, (%rsi)
nop
nop
add $13237, %rbp
lea addresses_A_ht+0x262a, %rbp
nop
nop
nop
cmp $36594, %r15
...
nop
dec %r14
lea addresses_UC_ht+0xd338, %rdi
nop
cmp %r15, %r15
mov (%rdi), %r8d
nop
...
nop
add %r15, %r15
lea addresses_WC_ht+0x85aa, %rsi
nop
nop
nop
nop
...
{'OP': 'STOR', 'dst': {'type': 'addresses_WC_ht', 'size': 1, 'AVXalign': False, 'NT': False, 'congruent': 1, 'same': True}}
