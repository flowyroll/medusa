...
movw $0x6162, (%r9)
and $8215, %r9
lea addresses_WC_ht+0x18fd9, %rbx
nop
nop
nop
xor %rcx, %rcx
...
// Store
lea addresses_normal+0xe3d9, %r8
xor %r14, %r14
movb $0x51, (%r8)
nop
nop
