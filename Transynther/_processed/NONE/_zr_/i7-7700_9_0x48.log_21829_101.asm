...
nop
inc %r8
lea addresses_WC_ht+0x8af6, %rax
nop
nop
add %rdi, %rdi
movb (%rax), %r14b
...
nop
add %rcx, %rcx
lea addresses_WT_ht+0x13956, %rsi
lea addresses_WC_ht+0x130f6, %rdi
dec %r9
mov $56, %rcx
rep movsq
sub $35579, %rsi
lea addresses_D_ht+0x73f6, %rsi
lea addresses_D_ht+0x156f6, %rdi
nop
nop
nop
xor %r9, %r9
...
nop
inc %rdi
lea addresses_normal_ht+0x11b36, %rsi
lea addresses_A_ht+0x186f6, %rdi
nop
nop
nop
nop
...
nop
xor $50743, %r10
lea addresses_A_ht+0xb186, %rsi
lea addresses_A_ht+0x98f6, %rdi
clflush (%rsi)
nop
nop
nop
...
nop
inc %rdi
lea addresses_UC_ht+0xa1f6, %rdi
nop
nop
nop
nop
...
nop
cmp $5844, %r9
lea addresses_WC_ht+0x1ab96, %rsi
lea addresses_WC_ht+0x1ba86, %rdi
nop
dec %r10
mov $38, %rcx
rep movsq
...
{'OP': 'STOR', 'dst': {'type': 'addresses_NC', 'AVXalign': False, 'congruent': 0, 'size': 2, 'same': False, 'NT': False}}
...
{'OP': 'STOR', 'dst': {'type': 'addresses_A_ht', 'AVXalign': True, 'congruent': 1, 'size': 16, 'same': False, 'NT': True}}
...
{'OP': 'LOAD', 'src': {'type': 'addresses_A_ht', 'AVXalign': False, 'congruent': 11, 'size': 2, 'same': True, 'NT': False}}
{'OP': 'LOAD', 'src': {'type': 'addresses_UC_ht', 'AVXalign': False, 'congruent': 7, 'size': 1, 'same': False, 'NT': False}}
{'OP': 'REPM', 'src': {'type': 'addresses_WC_ht', 'congruent': 1, 'same': False}, 'dst': {'type': 'addresses_WC_ht', 'congruent': 3, 'same': True}}
{'00': 21829}
