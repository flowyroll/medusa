...
push %rdx
push %rsi
lea addresses_WT_ht+0x17eb1, %rbx
nop
nop
cmp $40296, %r15
mov (%rbx), %rdx
add %rcx, %rcx
lea addresses_UC_ht+0x8f95, %rsi
lea addresses_normal_ht+0x157e1, %rdi
add $25677, %rax
mov $71, %rcx
rep movsw
nop
...
nop
dec %rdi
lea addresses_WC_ht+0x63e1, %rsi
nop
nop
nop
dec %rdi
...
nop
add $36210, %r15
lea addresses_WC_ht+0x1dd01, %rsi
nop
nop
nop
xor %rax, %rax
...
// REPMOV
lea addresses_A+0x7e64, %rsi
lea addresses_UC+0x83e1, %rdi
clflush (%rdi)
xor %rbp, %rbp
mov $104, %rcx
rep movsw
...
{'OP': 'REPM', 'src': {'type': 'addresses_A', 'congruent': 0, 'same': False}, 'dst': {'type': 'addresses_UC', 'congruent': 11, 'same': False}}
...
{'OP': 'STOR', 'dst': {'type': 'addresses_NC', 'size': 32, 'AVXalign': False, 'NT': True, 'congruent': 7, 'same': False}}
[Faulty Load]
