...
push %rdi
push %rsi
lea addresses_UC_ht+0xc122, %rdi
nop
nop
and $28156, %r13
...
nop
cmp $46654, %rax
lea addresses_WC_ht+0x37c2, %rbp
nop
nop
xor %r8, %r8
...
nop
inc %r13
lea addresses_D_ht+0x11c82, %rsi
lea addresses_A_ht+0x7f82, %rdi
nop
nop
nop
nop
...
rep movsq
cmp $38378, %rbp
lea addresses_D_ht+0x12d62, %rbp
nop
nop
nop
nop
...
movups %xmm5, (%rbp)
and %r8, %r8
lea addresses_UC_ht+0xaa82, %rbp
nop
sub $62476, %rcx
...
nop
and $24971, %r10
lea addresses_UC_ht+0x2982, %rcx
clflush (%rcx)
nop
nop
nop
...
nop
lfence
lea addresses_WT_ht+0x16a82, %rsi
lea addresses_WC_ht+0x16f02, %rdi
dec %r9
mov $29, %rcx
rep movsl
nop
cmp $16995, %rdi
lea addresses_UC_ht+0x18152, %rbp
nop
nop
nop
nop
...
nop
add %rsi, %rsi
lea addresses_normal_ht+0x419a, %rsi
lea addresses_UC_ht+0x14d82, %rdi
nop
nop
nop
nop
...
{'OP': 'LOAD', 'src': {'type': 'addresses_A', 'AVXalign': False, 'congruent': 9, 'size': 1, 'same': False, 'NT': False}}
...
{'OP': 'LOAD', 'src': {'type': 'addresses_D_ht', 'AVXalign': True, 'congruent': 3, 'size': 16, 'same': False, 'NT': True}}
