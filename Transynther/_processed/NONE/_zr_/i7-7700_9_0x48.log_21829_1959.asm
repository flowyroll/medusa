...
nop
sub $12495, %rdx
lea addresses_UC_ht+0x973a, %rbx
nop
add $40982, %r9
movl $0x61626364, (%rbx)
nop
...
nop
add %r13, %r13
lea addresses_WT_ht+0x1721a, %rdx
clflush (%rdx)
nop
nop
xor %r11, %r11
mov (%rdx), %ebx
inc %r9
lea addresses_UC_ht+0x1685a, %r11
nop
nop
nop
add $40217, %r14
