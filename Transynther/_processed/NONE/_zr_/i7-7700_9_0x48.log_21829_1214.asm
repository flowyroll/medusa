...
nop
cmp %rsi, %rsi
lea addresses_A_ht+0x9385, %rsi
lea addresses_WC_ht+0x9385, %rdi
nop
nop
sub %r12, %r12
mov $29, %rcx
rep movsq
and $63069, %rcx
lea addresses_A_ht+0x10501, %rsi
lea addresses_A_ht+0xc025, %rdi
and %rbp, %rbp
mov $36, %rcx
rep movsb
nop
...
nop
sub $63914, %rbp
lea addresses_normal_ht+0x6b85, %rsi
lea addresses_WT_ht+0x111e5, %rdi
clflush (%rsi)
clflush (%rdi)
nop
add $13482, %r15
...
rep movsl
xor %rsi, %rsi
lea addresses_normal_ht+0x17785, %r12
nop
and $51929, %r8
...
nop
inc %r8
lea addresses_UC_ht+0x11385, %rsi
nop
nop
and %r12, %r12
movb $0x61, (%rsi)
...
nop
sub %r8, %r8
lea addresses_WC_ht+0x9871, %rsi
lea addresses_UC_ht+0x8005, %rdi
nop
nop
nop
nop
...
nop
cmp $21659, %rbx
lea addresses_WT_ht+0x128e4, %rbp
nop
nop
nop
nop
...
nop
and $39774, %rsi
lea addresses_D_ht+0x14b85, %rsi
lea addresses_A_ht+0xbda5, %rdi
nop
nop
nop
nop
...
rep movsb
inc %r8
lea addresses_normal_ht+0x4c05, %rcx
nop
nop
nop
nop
...
nop
add $32423, %r8
lea addresses_WT_ht+0x17821, %rsi
lea addresses_WC_ht+0x1e507, %rdi
nop
nop
nop
dec %r15
...
{'OP': 'LOAD', 'src': {'type': 'addresses_WC', 'AVXalign': False, 'congruent': 5, 'size': 2, 'same': False, 'NT': False}}
