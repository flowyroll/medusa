...
push %rdi
push %rsi
lea addresses_WC_ht+0xc1c6, %r15
nop
nop
nop
nop
...
nop
xor $34757, %r11
lea addresses_UC_ht+0x14436, %rsi
lea addresses_normal_ht+0xd3ee, %rdi
nop
nop
nop
nop
...
nop
sub %r9, %r9
lea addresses_normal_ht+0x12f0, %rsi
lea addresses_D_ht+0x19296, %rdi
nop
nop
nop
nop
...
nop
and %r15, %r15
lea addresses_normal_ht+0x2cce, %r13
nop
nop
add $29782, %rdi
...
nop
add %r13, %r13
lea addresses_WC_ht+0x180c6, %r9
nop
nop
nop
and $44771, %rsi
...
nop
add $44305, %rdi
lea addresses_UC_ht+0x1506, %rsi
lea addresses_A_ht+0x4de6, %rdi
cmp %r11, %r11
mov $28, %rcx
rep movsw
xor %rbx, %rbx
lea addresses_UC_ht+0x167e6, %rsi
lea addresses_WT_ht+0x6cc6, %rdi
clflush (%rdi)
nop
nop
nop
...
nop
add $15592, %r9
lea addresses_WC_ht+0x1c0c6, %rsi
nop
nop
nop
nop
...
nop
add %rcx, %rcx
lea addresses_WT_ht+0xf6c6, %rsi
nop
nop
nop
add $53865, %r13
...
nop
add %r13, %r13
lea addresses_WT_ht+0x113c6, %rsi
lea addresses_UC_ht+0x173c2, %rdi
nop
nop
cmp %r13, %r13
mov $27, %rcx
...
{'src': {'same': False, 'congruent': 5, 'type': 'addresses_UC_ht'}, 'OP': 'REPM', 'dst': {'same': True, 'congruent': 8, 'type': 'addresses_WT_ht'}}
