...
push %rdi
push %rsi
lea addresses_UC_ht+0x10218, %rax
nop
nop
nop
nop
...
nop
add $12225, %r8
lea addresses_D_ht+0x1a8d8, %rsi
lea addresses_normal_ht+0x14758, %rdi
nop
nop
nop
and %rax, %rax
...
nop
inc %r14
lea addresses_normal_ht+0x4b58, %rsi
nop
nop
nop
sub %rcx, %rcx
...
nop
xor %r11, %r11
lea addresses_D_ht+0x1df58, %rax
nop
nop
xor $63165, %r14
movb (%rax), %cl
...
nop
dec %r8
lea addresses_WC_ht+0xf5b4, %rsi
lea addresses_A_ht+0x1d314, %rdi
clflush (%rdi)
nop
xor %r8, %r8
mov $83, %rcx
...
nop
cmp $14028, %rdi
lea addresses_normal_ht+0x6038, %rsi
lea addresses_UC_ht+0x11cc8, %rdi
clflush (%rsi)
cmp $64902, %rbx
mov $42, %rcx
rep movsb
...
{'src': {'congruent': 5, 'same': False, 'type': 'addresses_D_ht'}, 'OP': 'REPM', 'dst': {'congruent': 11, 'same': False, 'type': 'addresses_normal_ht'}}
...
{'src': {'congruent': 1, 'same': False, 'type': 'addresses_WC_ht'}, 'OP': 'REPM', 'dst': {'congruent': 2, 'same': False, 'type': 'addresses_A_ht'}}
...
{'src': {'congruent': 5, 'same': False, 'type': 'addresses_normal_ht'}, 'OP': 'REPM', 'dst': {'congruent': 2, 'same': False, 'type': 'addresses_UC_ht'}}
{'00': 21829}
