...
lea addresses_A_ht+0x176e6, %rdi
nop
nop
and $60226, %r8
mov $38, %rcx
...
nop
cmp $23547, %rdx
lea addresses_WC_ht+0x10a36, %r10
nop
add $4405, %r12
...
nop
add $33423, %rdi
lea addresses_D_ht+0x87d6, %r12
nop
cmp $31007, %r8
movl $0x61626364, (%r12)
sub %r8, %r8
lea addresses_D_ht+0x11ed6, %r10
nop
nop
nop
nop
...
nop
and $8287, %r10
lea addresses_A_ht+0x15ab6, %r12
nop
nop
nop
nop
...
movb $0x61, (%r12)
xor $21351, %r8
lea addresses_WC_ht+0xefd6, %r8
add $10504, %rdx
movl $0x61626364, (%r8)
xor $20657, %rdx
lea addresses_UC_ht+0x73d6, %r10
sub %r8, %r8
movb $0x61, (%r10)
nop
nop
...
movb $0x61, (%r10)
sub %rdx, %rdx
lea addresses_normal_ht+0x24e6, %rdx
clflush (%rdx)
lfence
movups (%rdx), %xmm4
vpextrq $0, %xmm4, %r10
...
{'OP': 'STOR', 'dst': {'congruent': 11, 'AVXalign': False, 'same': False, 'size': 2, 'NT': True, 'type': 'addresses_D'}}
