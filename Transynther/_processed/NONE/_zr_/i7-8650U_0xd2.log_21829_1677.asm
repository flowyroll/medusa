...
push %rdx
push %rsi
lea addresses_UC_ht+0x1ab20, %rsi
lea addresses_UC_ht+0x5e20, %rdi
nop
nop
nop
nop
...
nop
cmp %r12, %r12
lea addresses_UC_ht+0x6120, %rbp
sub %rdx, %rdx
movups (%rbp), %xmm2
vpextrq $0, %xmm2, %r12
nop
sub $36239, %rbp
lea addresses_D_ht+0xe620, %rsi
nop
nop
nop
and $57480, %r12
...
vpextrq $1, %xmm7, %rdi
mfence
lea addresses_normal_ht+0x10da0, %rdx
nop
nop
nop
add $22194, %rdi
movb (%rdx), %bl
cmp %r12, %r12
lea addresses_UC_ht+0xa45c, %rcx
nop
cmp %rsi, %rsi
movups (%rcx), %xmm3
vpextrq $0, %xmm3, %rbx
