...
push %rdi
push %rsi
lea addresses_UC_ht+0x63f6, %r14
clflush (%r14)
nop
nop
dec %r15
...
nop
sub %r14, %r14
lea addresses_UC_ht+0xd5f6, %rsi
lea addresses_normal_ht+0x8840, %rdi
clflush (%rsi)
inc %r9
mov $28, %rcx
rep movsw
...
nop
xor $7980, %r8
lea addresses_normal_ht+0x10ff6, %rdi
nop
nop
sub $65345, %r14
mov (%rdi), %r15d
...
nop
cmp $24997, %r14
lea addresses_WC_ht+0xe3f6, %rsi
lea addresses_WC_ht+0xbab6, %rdi
nop
nop
nop
nop
...
{'OP': 'REPM', 'src': {'same': True, 'type': 'addresses_UC_ht', 'congruent': 6}, 'dst': {'same': False, 'type': 'addresses_normal_ht', 'congruent': 0}}
...
{'OP': 'REPM', 'src': {'same': False, 'type': 'addresses_WC_ht', 'congruent': 9}, 'dst': {'same': True, 'type': 'addresses_WC_ht', 'congruent': 6}}
