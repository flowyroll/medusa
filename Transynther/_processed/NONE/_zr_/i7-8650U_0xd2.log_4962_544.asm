...
push %rdi
push %rsi
lea addresses_WT_ht+0x169a8, %rsi
lea addresses_normal_ht+0x3638, %rdi
nop
nop
nop
nop
...
rep movsw
add $63668, %rbx
lea addresses_WC_ht+0x1b190, %rax
nop
nop
nop
nop
