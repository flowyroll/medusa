...
push %rdi
push %rsi
lea addresses_normal_ht+0x876b, %r14
nop
dec %r13
...
nop
xor $38126, %r15
lea addresses_normal_ht+0x956b, %r12
nop
nop
nop
nop
...
nop
add %rcx, %rcx
lea addresses_A_ht+0xf0de, %rsi
lea addresses_WT_ht+0x1558b, %rdi
clflush (%rdi)
nop
nop
nop
...
nop
sub %rcx, %rcx
lea addresses_WC_ht+0x169eb, %rsi
lea addresses_normal_ht+0x15d1b, %rdi
nop
xor $46398, %r12
mov $26, %rcx
rep movsw
...
nop
sub $16591, %rsi
lea addresses_UC_ht+0x156b, %rsi
cmp %r14, %r14
movl $0x61626364, (%rsi)
nop
nop
nop
and %rsi, %rsi
lea addresses_WC_ht+0x2d6b, %r10
nop
nop
nop
nop
...
movq %r10, (%rdi)
and %r15, %r15
lea addresses_normal_ht+0x16b96, %r14
nop
nop
nop
nop
...
mov (%r14), %r12
cmp %rcx, %rcx
lea addresses_normal_ht+0x1b27b, %r13
nop
dec %r10
movb $0x61, (%r13)
nop
nop
add %rcx, %rcx
lea addresses_WT_ht+0x1256b, %r10
nop
xor $35018, %rcx
...
nop
and %r13, %r13
lea addresses_A_ht+0x18a2b, %rsi
...
{'OP': 'REPM', 'src': {'type': 'addresses_WC_ht', 'congruent': 7, 'same': False}, 'dst': {'type': 'addresses_normal_ht', 'congruent': 3, 'same': False}}
{'OP': 'LOAD', 'src': {'type': 'addresses_A_ht', 'size': 16, 'AVXalign': False, 'NT': False, 'congruent': 3, 'same': False}}
{'OP': 'STOR', 'dst': {'type': 'addresses_UC_ht', 'size': 4, 'AVXalign': True, 'NT': False, 'congruent': 6, 'same': False}}
