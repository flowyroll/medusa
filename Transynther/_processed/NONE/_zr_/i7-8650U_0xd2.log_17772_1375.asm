...
nop
cmp %rcx, %rcx
lea addresses_A_ht+0x86cc, %rsi
lea addresses_D_ht+0xaecc, %rdi
nop
nop
cmp $35363, %rax
mov $84, %rcx
...
nop
and $46703, %r14
lea addresses_WC_ht+0x8dcc, %rsi
nop
add $20409, %rdi
...
nop
add %rcx, %rcx
lea addresses_normal_ht+0x7cc, %rbx
nop
nop
nop
nop
...
movb $0x61, (%rbx)
cmp %rsi, %rsi
lea addresses_WC_ht+0xc6cc, %rsi
lea addresses_WC_ht+0xcd84, %rdi
clflush (%rdi)
nop
cmp %rax, %rax
mov $25, %rcx
...
nop
sub $40013, %r15
lea addresses_normal_ht+0xd9e4, %r14
dec %rbx
movl $0x61626364, (%r14)
nop
xor %r14, %r14
lea addresses_WT_ht+0xc6cc, %rsi
lea addresses_D_ht+0xb84c, %rdi
nop
nop
nop
nop
...
nop
dec %rbx
lea addresses_UC_ht+0x14b2c, %r15
nop
nop
nop
nop
...
{'OP': 'REPM', 'src': {'type': 'addresses_A_ht', 'congruent': 8, 'same': False}, 'dst': {'type': 'addresses_D_ht', 'congruent': 11, 'same': False}}
