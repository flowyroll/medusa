...
push %rdx
push %rsi
lea addresses_WT_ht+0x1381b, %r12
nop
nop
sub $32138, %rbp
...
nop
add %rcx, %rcx
lea addresses_WC_ht+0x8707, %rsi
...
nop
inc %rcx
lea addresses_A_ht+0x1607f, %r13
nop
nop
add $46689, %rdi
...
movq %r12, (%r13)
cmp $18577, %r12
lea addresses_normal_ht+0x3a2c, %rsi
lea addresses_UC_ht+0x1729b, %rdi
clflush (%rsi)
clflush (%rdi)
nop
nop
...
nop
sub $49157, %rcx
lea addresses_normal_ht+0x1285b, %rsi
lea addresses_D_ht+0x1949b, %rdi
xor $8545, %rbp
mov $88, %rcx
rep movsl
nop
...
nop
sub %r13, %r13
lea addresses_WC_ht+0x15982, %r13
nop
nop
add $25075, %rdi
...
nop
inc %rbp
lea addresses_UC_ht+0x1549b, %r13
clflush (%r13)
nop
nop
nop
...
nop
dec %rbp
lea addresses_WT_ht+0x1169b, %rsi
inc %rdx
movb (%rsi), %r12b
nop
nop
