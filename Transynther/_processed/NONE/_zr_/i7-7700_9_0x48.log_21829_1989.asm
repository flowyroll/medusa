...
nop
add %r14, %r14
lea addresses_normal_ht+0x11b71, %rsi
lea addresses_A_ht+0x7301, %rdi
nop
nop
nop
nop
...
nop
sub $48758, %rbp
lea addresses_WC_ht+0x14071, %rsi
lea addresses_D_ht+0x3e8d, %rdi
clflush (%rdi)
inc %r13
mov $58, %rcx
rep movsq
...
nop
and $43477, %r10
lea addresses_D_ht+0x2a71, %rsi
lea addresses_A_ht+0xca71, %rdi
nop
and $11681, %r14
mov $7, %rcx
rep movsl
...
nop
and $13813, %r8
lea addresses_normal_ht+0x17f71, %rbp
nop
xor $29981, %rdi
mov (%rbp), %esi
inc %r13
lea addresses_A_ht+0xcf31, %rsi
sub $19373, %rdi
...
nop
xor %rdi, %rdi
lea addresses_WC_ht+0x2e71, %rdi
nop
nop
xor $6188, %r10
mov (%rdi), %rbp
...
nop
and $22185, %r13
lea addresses_WT_ht+0x1ecc1, %rdi
nop
nop
nop
nop
...
// Store
lea addresses_normal+0xfb69, %r14
cmp %r9, %r9
movb $0x51, (%r14)
nop
cmp %r13, %r13
...
{'OP': 'REPM', 'src': {'type': 'addresses_WC_ht', 'congruent': 8, 'same': False}, 'dst': {'type': 'addresses_D_ht', 'congruent': 2, 'same': True}}
