...
nop
add $57736, %rsi
lea addresses_WC_ht+0x1450b, %rsi
lea addresses_UC_ht+0xe70b, %rdi
nop
nop
nop
nop
...
nop
add %r10, %r10
lea addresses_WC_ht+0x1d10b, %rsi
lea addresses_normal_ht+0x1620b, %rdi
nop
nop
nop
and $24048, %rbx
...
nop
xor %rsi, %rsi
lea addresses_A_ht+0x83cb, %rbx
nop
xor %r8, %r8
movw $0x6162, (%rbx)
sub %r10, %r10
lea addresses_normal_ht+0x595b, %rbx
nop
nop
sub %rax, %rax
mov $0x6162636465666768, %r8
...
nop
lfence
lea addresses_WC_ht+0x1710b, %rdi
xor $30050, %rcx
movl $0x61626364, (%rdi)
nop
nop
...
nop
sub %rbx, %rbx
lea addresses_UC_ht+0x19f0b, %rsi
lea addresses_UC_ht+0x1da0b, %rdi
nop
nop
nop
and %r8, %r8
...
// Store
lea addresses_normal+0x310b, %rsi
nop
inc %rdi
movb $0x51, (%rsi)
nop
...
{'OP': 'LOAD', 'src': {'type': 'addresses_P', 'AVXalign': False, 'congruent': 9, 'size': 4, 'same': False, 'NT': True}}
...
{'OP': 'STOR', 'dst': {'type': 'addresses_UC', 'AVXalign': True, 'congruent': 1, 'size': 16, 'same': False, 'NT': False}}
[Faulty Load]
...
{'OP': 'REPM', 'src': {'type': 'addresses_WC_ht', 'congruent': 11, 'same': True}, 'dst': {'type': 'addresses_UC_ht', 'congruent': 5, 'same': False}}
{'OP': 'STOR', 'dst': {'type': 'addresses_normal_ht', 'AVXalign': False, 'congruent': 9, 'size': 8, 'same': True, 'NT': False}}
