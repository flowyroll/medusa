...
nop
cmp %r15, %r15
lea addresses_WT_ht+0x11c26, %r14
nop
inc %r9
movw $0x6162, (%r14)
nop
nop
cmp %r9, %r9
lea addresses_WC_ht+0x1834a, %rbp
nop
nop
nop
nop
...
nop
sub $64667, %r15
lea addresses_D_ht+0x126e8, %r11
nop
nop
nop
nop
...
nop
cmp %r11, %r11
lea addresses_D_ht+0xe9fa, %rsi
lea addresses_normal_ht+0x1ed4a, %rdi
nop
nop
nop
nop
...
nop
add %rsi, %rsi
lea addresses_WC_ht+0x1d486, %rsi
lea addresses_D_ht+0x1bf2a, %rdi
nop
nop
nop
xor %r10, %r10
...
nop
dec %r15
lea addresses_WC_ht+0x77e0, %r11
nop
xor $41239, %r10
mov (%r11), %si
nop
...
{'src': {'NT': True, 'AVXalign': False, 'size': 8, 'congruent': 7, 'same': False, 'type': 'addresses_PSE'}, 'OP': 'LOAD'}
...
{'src': {'congruent': 1, 'same': False, 'type': 'addresses_D_ht'}, 'dst': {'congruent': 9, 'same': False, 'type': 'addresses_normal_ht'}, 'OP': 'REPM'}
