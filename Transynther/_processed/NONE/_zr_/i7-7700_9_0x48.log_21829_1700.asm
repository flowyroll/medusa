...
nop
dec %r12
lea addresses_A_ht+0x8596, %rsi
lea addresses_A_ht+0x9e96, %rdi
nop
nop
nop
nop
...
nop
xor $29556, %r12
lea addresses_UC_ht+0x1ba36, %rdi
nop
nop
nop
nop
...
nop
xor $55642, %rcx
lea addresses_A_ht+0x171b6, %rbp
nop
nop
nop
add $49730, %r10
...
nop
cmp $22019, %r10
lea addresses_A_ht+0xa584, %rsi
lea addresses_WC_ht+0x1dbfe, %rdi
nop
nop
nop
nop
...
nop
dec %r12
lea addresses_normal_ht+0x15e2, %r10
nop
nop
xor $51997, %rbp
vmovups (%r10), %ymm5
...
vpextrq $0, %xmm5, %rsi
sub $60346, %r12
lea addresses_UC_ht+0x1bbb6, %rdi
nop
xor $64112, %rbp
movb $0x61, (%rdi)
nop
cmp %rdi, %rdi
lea addresses_normal_ht+0x1e8b6, %rax
nop
nop
nop
nop
...
mov (%rax), %r10d
xor $31914, %r10
lea addresses_A_ht+0x101b6, %rsi
lea addresses_normal_ht+0x28b6, %rdi
nop
nop
nop
nop
...
rep movsw
xor $11042, %r12
lea addresses_WT_ht+0x10cb6, %r9
cmp %r10, %r10
movb (%r9), %cl
nop
nop
...
nop
sub %r12, %r12
lea addresses_D_ht+0x19e96, %rsi
lea addresses_normal_ht+0x111d6, %rdi
nop
nop
nop
nop
...
nop
xor $33757, %rax
lea addresses_WC_ht+0x16cb6, %r9
nop
nop
nop
lfence
...
nop
add $1943, %r10
lea addresses_normal_ht+0x198b6, %rsi
lea addresses_normal_ht+0xfeb6, %rdi
nop
nop
nop
inc %r9
...
{'OP': 'STOR', 'dst': {'type': 'addresses_WC', 'AVXalign': False, 'congruent': 5, 'size': 8, 'same': False, 'NT': True}}
[Faulty Load]
...
{'OP': 'REPM', 'src': {'type': 'addresses_A_ht', 'congruent': 5, 'same': False}, 'dst': {'type': 'addresses_A_ht', 'congruent': 3, 'same': True}}
...
{'OP': 'REPM', 'src': {'type': 'addresses_A_ht', 'congruent': 0, 'same': False}, 'dst': {'type': 'addresses_WC_ht', 'congruent': 3, 'same': True}}
...
{'OP': 'REPM', 'src': {'type': 'addresses_A_ht', 'congruent': 8, 'same': False}, 'dst': {'type': 'addresses_normal_ht', 'congruent': 11, 'same': True}}
...
{'OP': 'LOAD', 'src': {'type': 'addresses_WC_ht', 'AVXalign': False, 'congruent': 8, 'size': 1, 'same': True, 'NT': False}}
