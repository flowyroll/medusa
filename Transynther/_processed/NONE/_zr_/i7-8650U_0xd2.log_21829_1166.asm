...
nop
dec %rdx
lea addresses_A_ht+0x5c6d, %r13
sub $9499, %r11
mov (%r13), %rbx
nop
nop
and $13742, %rbx
lea addresses_D_ht+0x33ad, %r14
nop
nop
nop
nop
...
movw $0x6162, (%r14)
sub $17149, %rbx
lea addresses_WC_ht+0x140d0, %rsi
clflush (%rsi)
and $21709, %rbx
...
nop
inc %rbx
lea addresses_normal_ht+0x346d, %r13
nop
dec %rbx
mov (%r13), %edx
cmp %r13, %r13
lea addresses_UC_ht+0xb6b1, %r14
nop
nop
dec %r13
movb (%r14), %bl
...
nop
dec %r13
lea addresses_normal_ht+0x6a6d, %r9
dec %r13
movw $0x6162, (%r9)
nop
inc %r13
lea addresses_D_ht+0x1e46d, %rsi
nop
and $12851, %rbx
mov (%rsi), %edx
dec %r11
lea addresses_D_ht+0x8b6d, %rsi
lea addresses_normal_ht+0x18ffd, %rdi
nop
nop
nop
add %r11, %r11
...
nop
sub $37020, %rsi
lea addresses_WC_ht+0xfced, %rsi
lea addresses_UC_ht+0x16c6d, %rdi
nop
cmp %r13, %r13
mov $18, %rcx
rep movsq
...
{'OP': 'STOR', 'dst': {'type': 'addresses_D_ht', 'size': 1, 'AVXalign': True, 'NT': False, 'congruent': 7, 'same': True}}
