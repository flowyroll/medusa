...
push %rdi
push %rsi
lea addresses_UC_ht+0x9034, %rsi
...
nop
add %r15, %r15
lea addresses_WT_ht+0xb2c4, %r14
nop
nop
nop
nop
...
nop
cmp $47792, %r12
lea addresses_normal_ht+0x13050, %rsi
lea addresses_normal_ht+0x18ed0, %rdi
nop
xor $8457, %r8
mov $1, %rcx
rep movsq
...
nop
inc %r10
lea addresses_WT_ht+0xf4d0, %r12
cmp %r8, %r8
movl $0x61626364, (%r12)
nop
nop
...
lea addresses_D_ht+0x138d0, %rdi
nop
nop
nop
nop
...
nop
and %r10, %r10
lea addresses_WT_ht+0x6530, %r8
nop
sub %r15, %r15
mov (%r8), %si
nop
cmp $47335, %r10
lea addresses_WC_ht+0x66a0, %r12
nop
and $7657, %r14
...
{'OP': 'REPM', 'src': {'type': 'addresses_normal_ht', 'congruent': 4, 'same': True}, 'dst': {'type': 'addresses_D_ht', 'congruent': 10, 'same': True}}
{'OP': 'STOR', 'dst': {'type': 'addresses_A_ht', 'size': 2, 'AVXalign': False, 'NT': True, 'congruent': 6, 'same': False}}
