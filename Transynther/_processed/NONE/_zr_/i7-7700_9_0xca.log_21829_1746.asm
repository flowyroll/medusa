...
push %rdx
push %rsi
lea addresses_WC_ht+0xdb9d, %rsi
...
nop
add %r9, %r9
lea addresses_UC_ht+0x86bd, %rdi
nop
and %rbx, %rbx
...
nop
dec %rcx
lea addresses_UC_ht+0x1229d, %rdi
and %rdx, %rdx
movups (%rdi), %xmm3
vpextrq $0, %xmm3, %r9
nop
...
nop
cmp %rbx, %rbx
lea addresses_WT_ht+0x7dfd, %rsi
nop
nop
cmp %rdx, %rdx
movw $0x6162, (%rsi)
...
nop
add $2276, %rdx
lea addresses_WC_ht+0x1cd91, %rdi
nop
nop
nop
sub $29559, %r8
...
nop
add %rcx, %rcx
lea addresses_UC_ht+0xaa9d, %rsi
lea addresses_WT_ht+0x177a5, %rdi
add $40428, %r10
mov $21, %rcx
rep movsq
nop
...
nop
and $54759, %r8
lea addresses_WT_ht+0x5ded, %rdx
nop
nop
nop
nop
...
<gen_prepare_buffer>
{'src': {'congruent': 6, 'same': False, 'type': 'addresses_WC_ht'}, 'OP': 'REPM', 'dst': {'congruent': 5, 'same': False, 'type': 'addresses_UC_ht'}}
...
{'src': {'congruent': 11, 'same': False, 'type': 'addresses_UC_ht'}, 'OP': 'REPM', 'dst': {'congruent': 1, 'same': False, 'type': 'addresses_WT_ht'}}
