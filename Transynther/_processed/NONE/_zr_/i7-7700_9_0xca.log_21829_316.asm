...
movups %xmm2, (%rdi)
add $39853, %rbx
lea addresses_UC_ht+0x1c79c, %rbp
xor %rax, %rax
movb (%rbp), %bl
nop
nop
and %rsi, %rsi
lea addresses_UC_ht+0x17d9c, %rdi
clflush (%rdi)
nop
nop
nop
...
movl $0x61626364, (%rdi)
and %rdi, %rdi
lea addresses_D_ht+0x1071c, %rbp
nop
nop
nop
add %rax, %rax
...
nop
xor %rsi, %rsi
lea addresses_WC_ht+0xdf1c, %rsi
lea addresses_A_ht+0x1889c, %rdi
nop
nop
nop
nop
...
nop
sub $9407, %rdi
lea addresses_WC_ht+0x241c, %rdi
inc %rax
...
// Store
lea addresses_normal+0xadbc, %r11
nop
nop
dec %rax
...
{'OP': 'STOR', 'dst': {'congruent': 5, 'AVXalign': False, 'same': False, 'size': 16, 'NT': False, 'type': 'addresses_normal'}}
[Faulty Load]
...
{'src': {'congruent': 8, 'same': True, 'type': 'addresses_WT_ht'}, 'OP': 'REPM', 'dst': {'congruent': 7, 'same': False, 'type': 'addresses_UC_ht'}}
