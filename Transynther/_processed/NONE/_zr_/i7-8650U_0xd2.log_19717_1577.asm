...
push %rdx
push %rsi
lea addresses_A_ht+0x12229, %rsi
...
nop
and %rdx, %rdx
lea addresses_WT_ht+0x72a9, %r14
nop
cmp $20855, %r11
movb (%r14), %cl
sub %rdi, %rdi
lea addresses_normal_ht+0x11a9, %rcx
nop
nop
nop
nop
...
nop
inc %rdi
lea addresses_WC_ht+0x1e6a9, %rdx
nop
nop
nop
nop
...
nop
add %rsi, %rsi
lea addresses_D_ht+0x19909, %rsi
nop
add $62396, %rcx
...
<gen_prepare_buffer>
{'OP': 'REPM', 'src': {'type': 'addresses_A_ht', 'congruent': 6, 'same': False}, 'dst': {'type': 'addresses_D_ht', 'congruent': 1, 'same': True}}
{'OP': 'LOAD', 'src': {'type': 'addresses_WT_ht', 'size': 1, 'AVXalign': False, 'NT': True, 'congruent': 9, 'same': False}}
...
{'OP': 'LOAD', 'src': {'type': 'addresses_D_ht', 'size': 16, 'AVXalign': False, 'NT': True, 'congruent': 0, 'same': False}}
{'00': 19717}
