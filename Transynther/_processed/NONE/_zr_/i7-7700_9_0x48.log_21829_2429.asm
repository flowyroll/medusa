...
push %rdi
push %rsi
lea addresses_D_ht+0x15c50, %rcx
nop
nop
nop
nop
...
nop
and $55152, %r10
lea addresses_WC_ht+0x1611c, %rcx
nop
xor %r12, %r12
mov (%rcx), %r14
mfence
lea addresses_WT_ht+0x1a6d0, %rsi
lea addresses_D_ht+0x3350, %rdi
nop
nop
nop
and %r11, %r11
...
nop
add %rcx, %rcx
lea addresses_A_ht+0x1cf50, %r14
nop
nop
nop
nop
...
mov (%r14), %cx
xor %r11, %r11
lea addresses_A_ht+0xec9e, %r10
sub $42068, %rsi
movb $0x61, (%r10)
cmp %r8, %r8
lea addresses_WT_ht+0x10150, %rdi
nop
nop
nop
nop
...
nop
dec %rcx
lea addresses_A_ht+0x19610, %r12
nop
nop
nop
and $44943, %r14
movb (%r12), %r11b
add $27850, %rdi
lea addresses_normal_ht+0x8a60, %r12
nop
nop
nop
dec %rdi
...
nop
add $44211, %r12
lea addresses_WC_ht+0xd7d0, %rcx
nop
nop
xor $53529, %rsi
mov (%rcx), %r14
...
{'OP': 'STOR', 'dst': {'type': 'addresses_WC', 'AVXalign': True, 'congruent': 2, 'size': 8, 'same': False, 'NT': True}}
[Faulty Load]
{'OP': 'LOAD', 'src': {'type': 'addresses_WC', 'AVXalign': False, 'congruent': 0, 'size': 1, 'same': True, 'NT': False}}
<gen_prepare_buffer>
{'OP': 'LOAD', 'src': {'type': 'addresses_D_ht', 'AVXalign': False, 'congruent': 7, 'size': 1, 'same': False, 'NT': True}}
...
{'OP': 'REPM', 'src': {'type': 'addresses_WT_ht', 'congruent': 5, 'same': False}, 'dst': {'type': 'addresses_D_ht', 'congruent': 11, 'same': False}}
