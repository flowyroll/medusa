...
push %rdx
push %rsi
lea addresses_UC_ht+0x12c08, %rdx
nop
nop
nop
sub $22991, %rsi
...
nop
cmp $29760, %r14
lea addresses_A_ht+0x3758, %rsi
lea addresses_UC_ht+0x17808, %rdi
clflush (%rsi)
nop
xor %r9, %r9
mov $68, %rcx
...
nop
sub $61347, %rsi
lea addresses_normal_ht+0xa1e8, %r10
clflush (%r10)
nop
nop
nop
...
nop
dec %r9
lea addresses_WC_ht+0x40c8, %r13
nop
sub $8365, %rsi
...
nop
sub %r9, %r9
lea addresses_WC_ht+0x17e08, %r10
nop
nop
nop
nop
...
nop
cmp %rcx, %rcx
lea addresses_WT_ht+0x4590, %rdx
nop
nop
nop
nop
...
nop
inc %r9
lea addresses_normal_ht+0x10908, %r9
nop
nop
nop
nop
...
nop
add $4870, %rdx
lea addresses_WC_ht+0x1d2a8, %r9
nop
nop
nop
nop
...
// Load
lea addresses_normal+0x98e2, %r13
nop
nop
xor $12944, %rbx
mov (%r13), %r11d
