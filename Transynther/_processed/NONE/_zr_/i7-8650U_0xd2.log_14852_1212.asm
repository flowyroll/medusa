...
push %rdi
push %rsi
lea addresses_WC_ht+0xe22a, %r13
nop
xor $11702, %r14
movups (%r13), %xmm3
vpextrq $1, %xmm3, %r9
...
nop
sub $26564, %rcx
lea addresses_WT_ht+0xeb72, %rsi
lea addresses_D_ht+0xa02, %rdi
clflush (%rdi)
nop
add $29315, %r12
mov $110, %rcx
...
nop
sub $15790, %r12
lea addresses_WT_ht+0x12c2a, %rsi
lea addresses_A_ht+0xfb6a, %rdi
nop
nop
nop
nop
...
rep movsw
cmp $22131, %rsi
lea addresses_D_ht+0xff16, %rsi
lea addresses_UC_ht+0x287e, %rdi
clflush (%rsi)
nop
nop
nop
...
rep movsw
xor $45389, %r13
lea addresses_WC_ht+0x60aa, %rsi
lea addresses_WC_ht+0x1ec2a, %rdi
clflush (%rdi)
nop
nop
sub $39483, %r13
...
nop
dec %rcx
lea addresses_normal_ht+0x1a7c6, %rsi
nop
nop
nop
nop
...
vpextrq $1, %xmm2, %r13
add $4174, %r14
lea addresses_WT_ht+0x1822a, %rdi
nop
nop
nop
nop
...
movb $0x61, (%rdi)
sub $6634, %rdi
lea addresses_D_ht+0x1652a, %rsi
lea addresses_WT_ht+0xc2a, %rdi
clflush (%rsi)
clflush (%rdi)
nop
xor $27148, %r9
...
nop
mfence
lea addresses_normal_ht+0x175c5, %rsi
...
nop
cmp %rcx, %rcx
lea addresses_WT_ht+0x1242a, %r14
nop
nop
add $42667, %rsi
movw $0x6162, (%r14)
...
nop
sub $11814, %r14
lea addresses_WC_ht+0x9b2a, %rdi
sub %r12, %r12
mov $0x6162636465666768, %rcx
movq %rcx, (%rdi)
add $50462, %rsi
lea addresses_A_ht+0x18ff7, %rsi
...
nop
sub %rbp, %rbp
lea addresses_D_ht+0x1e42a, %r12
clflush (%r12)
nop
nop
nop
...
{'OP': 'STOR', 'dst': {'type': 'addresses_WT', 'size': 4, 'AVXalign': True, 'NT': True, 'congruent': 5, 'same': False}}
[Faulty Load]
...
{'OP': 'REPM', 'src': {'type': 'addresses_A_ht', 'congruent': 0, 'same': False}, 'dst': {'type': 'addresses_UC_ht', 'congruent': 5, 'same': False}}
