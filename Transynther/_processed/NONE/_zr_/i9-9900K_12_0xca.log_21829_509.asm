...
push %rdx
push %rsi
lea addresses_A_ht+0x1549f, %rsi
lea addresses_D_ht+0xea1f, %rdi
nop
nop
nop
dec %rdx
...
nop
dec %r9
lea addresses_UC_ht+0x1911f, %rdx
nop
nop
nop
and %r9, %r9
...
nop
add $60790, %rdx
lea addresses_UC_ht+0x70bf, %rsi
lea addresses_WT_ht+0x1d19f, %rdi
nop
nop
nop
and $10572, %r10
...
// Store
lea addresses_normal+0x1b7df, %r11
clflush (%r11)
nop
nop
nop
...
<gen_prepare_buffer>
{'OP': 'REPM', 'src': {'same': False, 'type': 'addresses_A_ht', 'congruent': 5}, 'dst': {'same': False, 'type': 'addresses_D_ht', 'congruent': 10}}
