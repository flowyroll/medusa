...
nop
xor %rdx, %rdx
lea addresses_UC_ht+0x6873, %r15
nop
nop
nop
nop
...
nop
sub $17390, %rdi
lea addresses_WC_ht+0x1aff3, %rsi
lea addresses_WC_ht+0x10473, %rdi
cmp $5956, %rbp
mov $21, %rcx
rep movsw
nop
sub $43759, %r15
lea addresses_D_ht+0xb1f3, %rsi
lea addresses_D_ht+0xe7df, %rdi
nop
nop
and %r14, %r14
mov $104, %rcx
...
nop
and %rdx, %rdx
lea addresses_WC_ht+0x16a73, %rsi
...
nop
sub $26646, %rcx
lea addresses_normal_ht+0x18e73, %rsi
lea addresses_D_ht+0xa9f3, %rdi
clflush (%rsi)
nop
nop
nop
...
nop
inc %r14
lea addresses_WC_ht+0xc73, %rsi
lea addresses_UC_ht+0x476a, %rdi
nop
inc %rbp
mov $108, %rcx
rep movsq
...
nop
sub $64833, %r8
lea addresses_WT_ht+0x8021, %r14
nop
dec %rsi
movb $0x61, (%r14)
nop
...
{'src': {'same': False, 'congruent': 8, 'type': 'addresses_WC_ht'}, 'OP': 'REPM', 'dst': {'same': False, 'congruent': 8, 'type': 'addresses_A_ht'}}
{'src': {'same': False, 'congruent': 8, 'type': 'addresses_normal_ht'}, 'OP': 'REPM', 'dst': {'same': True, 'congruent': 4, 'type': 'addresses_D_ht'}}
