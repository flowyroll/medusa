...
nop
sub %rdi, %rdi
lea addresses_normal_ht+0xa2b, %r11
nop
nop
nop
add %r13, %r13
...
nop
sub %r9, %r9
lea addresses_WC_ht+0x12a42, %r14
clflush (%r14)
xor $40474, %r15
...
lea addresses_UC_ht+0x13ace, %rdi
nop
nop
nop
nop
...
nop
cmp %r13, %r13
lea addresses_WC_ht+0xc48e, %r13
nop
nop
inc %rsi
movb $0x61, (%r13)
