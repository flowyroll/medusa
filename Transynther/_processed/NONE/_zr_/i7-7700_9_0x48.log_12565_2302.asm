...
movw $0x6162, (%rsi)
inc %r9
lea addresses_WC_ht+0x25ca, %rsi
...
rep movsq
and %r8, %r8
lea addresses_normal_ht+0x1a77e, %rsi
lea addresses_WT_ht+0xb14f, %rdi
nop
nop
nop
nop
...
nop
and $2043, %r8
lea addresses_WC_ht+0x72ee, %r9
nop
xor %rsi, %rsi
movw $0x6162, (%r9)
nop
inc %rcx
lea addresses_normal_ht+0x7a0e, %r9
nop
nop
and $553, %r13
movb (%r9), %r10b
...
nop
dec %rcx
lea addresses_WT_ht+0x1f47, %rsi
lea addresses_A_ht+0x1a4ee, %rdi
nop
nop
nop
and $45280, %rdx
...
nop
sub $17674, %rcx
lea addresses_WT_ht+0x1734e, %rsi
nop
nop
nop
add %r13, %r13
...
{'OP': 'LOAD', 'src': {'type': 'addresses_D', 'AVXalign': True, 'congruent': 9, 'size': 4, 'same': False, 'NT': False}}
{'OP': 'LOAD', 'src': {'type': 'addresses_UC', 'AVXalign': False, 'congruent': 2, 'size': 4, 'same': False, 'NT': False}}
...
{'OP': 'REPM', 'src': {'type': 'addresses_WC_ht', 'congruent': 1, 'same': False}, 'dst': {'type': 'addresses_UC_ht', 'congruent': 9, 'same': False}}
...
{'OP': 'REPM', 'src': {'type': 'addresses_WT_ht', 'congruent': 0, 'same': True}, 'dst': {'type': 'addresses_A_ht', 'congruent': 5, 'same': False}}
