...
nop
cmp $1978, %r15
lea addresses_A_ht+0x15740, %rdx
nop
nop
cmp $18702, %r9
...
nop
cmp $62657, %rbp
lea addresses_WT_ht+0x7fb8, %r12
clflush (%r12)
nop
nop
inc %r15
...
nop
add %r15, %r15
lea addresses_WC_ht+0xd40, %rsi
lea addresses_normal_ht+0x92d0, %rdi
nop
nop
nop
nop
...
nop
add %rbp, %rbp
lea addresses_normal_ht+0x61e0, %r12
nop
nop
nop
nop
...
mov (%r12), %ebx
sub %rbp, %rbp
lea addresses_WC_ht+0x11d0, %rbp
nop
nop
nop
nop
...
// REPMOV
lea addresses_D+0x11540, %rsi
lea addresses_normal+0xde44, %rdi
nop
nop
add %r9, %r9
mov $76, %rcx
...
// Store
lea addresses_PSE+0xa494, %rcx
and %r11, %r11
movb $0x51, (%rcx)
add $52128, %rcx

// Store
lea addresses_A+0xa740, %rdi
dec %r10
movb $0x51, (%rdi)
nop
nop
...
{'dst': {'same': False, 'congruent': 2, 'type': 'addresses_normal'}, 'OP': 'REPM', 'src': {'same': False, 'congruent': 8, 'type': 'addresses_D'}}
...
{'OP': 'LOAD', 'src': {'same': False, 'NT': True, 'AVXalign': False, 'size': 16, 'type': 'addresses_A_ht', 'congruent': 8}}
{'dst': {'same': False, 'NT': False, 'AVXalign': False, 'size': 32, 'type': 'addresses_WT_ht', 'congruent': 1}, 'OP': 'STOR'}
{'dst': {'same': False, 'congruent': 3, 'type': 'addresses_normal_ht'}, 'OP': 'REPM', 'src': {'same': False, 'congruent': 9, 'type': 'addresses_WC_ht'}}
{'OP': 'LOAD', 'src': {'same': False, 'NT': False, 'AVXalign': True, 'size': 4, 'type': 'addresses_normal_ht', 'congruent': 5}}
