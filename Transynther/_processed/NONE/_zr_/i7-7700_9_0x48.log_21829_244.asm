...
nop
dec %r12
lea addresses_A_ht+0x1124, %rsi
lea addresses_UC_ht+0xe024, %rdi
clflush (%rdi)
and $18276, %r14
mov $105, %rcx
rep movsw
...
nop
inc %r14
lea addresses_WC_ht+0x1c924, %rsi
clflush (%rsi)
nop
nop
nop
...
nop
sub %rcx, %rcx
lea addresses_WC_ht+0xc164, %rdi
nop
nop
nop
nop
...
nop
cmp $57010, %rcx
lea addresses_WC_ht+0x4a28, %rsi
lea addresses_normal_ht+0x19c24, %rdi
clflush (%rdi)
nop
nop
nop
...
lea addresses_WC_ht+0x1e9a4, %rdi
cmp %rdx, %rdx
mov $101, %rcx
rep movsb
sub $41392, %r8
...
// Store
lea addresses_normal+0x1a7c4, %r13
nop
nop
nop
nop
