...
push %rdi
push %rsi
lea addresses_normal_ht+0x5a8f, %rbx
nop
nop
nop
nop
...
nop
inc %r9
lea addresses_UC_ht+0x89ff, %r12
nop
nop
nop
cmp %rdi, %rdi
...
vmovups %ymm3, (%r12)
xor %r11, %r11
lea addresses_D_ht+0x1bf7, %r14
cmp %rcx, %rcx
mov (%r14), %rbx
nop
nop
and $27672, %rdi
lea addresses_UC_ht+0x2ce7, %rsi
lea addresses_A_ht+0x497f, %rdi
nop
inc %r9
mov $100, %rcx
rep movsl
nop
inc %r11
lea addresses_UC_ht+0x13dff, %r14
nop
nop
nop
nop
...
nop
xor %r12, %r12
lea addresses_D_ht+0x6a23, %rsi
lea addresses_D_ht+0x156ff, %rdi
clflush (%rsi)
clflush (%rdi)
nop
nop
...
{'OP': 'REPM', 'src': {'same': True, 'type': 'addresses_D_ht', 'congruent': 2}, 'dst': {'same': False, 'type': 'addresses_D_ht', 'congruent': 3}}
{'00': 21829}
