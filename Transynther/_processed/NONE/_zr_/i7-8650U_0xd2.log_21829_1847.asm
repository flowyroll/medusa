...
nop
and %rsi, %rsi
lea addresses_UC_ht+0x12188, %r11
nop
nop
and %r8, %r8
mov (%r11), %r14d
...
nop
xor %r8, %r8
lea addresses_D_ht+0x5a49, %rsi
lea addresses_WC_ht+0x167b9, %rdi
clflush (%rsi)
nop
add $57188, %r14
mov $55, %rcx
...
nop
xor %rdi, %rdi
lea addresses_WT_ht+0x1bdf1, %rsi
lea addresses_A_ht+0x81f2, %rdi
clflush (%rdi)
nop
inc %rbp
mov $68, %rcx
...
nop
add %r14, %r14
lea addresses_UC_ht+0xa989, %r8
add $35863, %r11
mov $0x6162636465666768, %r14
movq %r14, (%r8)
nop
xor $64282, %rcx
lea addresses_D_ht+0xcaa9, %rdi
xor $48203, %r11
mov (%rdi), %rbp
nop
nop
...
nop
dec %rbp
lea addresses_normal_ht+0xe389, %rsi
lea addresses_D_ht+0x9b39, %rdi
clflush (%rsi)
nop
nop
and $33428, %rdx
...
nop
sub %r8, %r8
lea addresses_WT_ht+0x5c05, %r12
nop
nop
nop
nop
...
nop
dec %rdx
lea addresses_A_ht+0x17559, %rbp
sub %r11, %r11
mov $0x6162636465666768, %r14
movq %r14, (%rbp)
nop
...
nop
add $731, %r12
lea addresses_WT_ht+0x15fc9, %rsi
nop
nop
dec %rcx
vmovups (%rsi), %ymm4
...
{'OP': 'REPM', 'src': {'type': 'addresses_D_ht', 'congruent': 8, 'same': False}, 'dst': {'type': 'addresses_WC_ht', 'congruent': 4, 'same': False}}
