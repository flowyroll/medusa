...
nop
dec %r12
lea addresses_WT_ht+0x7e97, %r15
clflush (%r15)
nop
nop
and %rbp, %rbp
...
nop
sub %r15, %r15
lea addresses_WT_ht+0x15df7, %rsi
lea addresses_normal_ht+0xee9d, %rdi
nop
nop
add %r12, %r12
mov $59, %rcx
...
nop
xor $5384, %r13
lea addresses_normal_ht+0xb7d7, %r14
nop
nop
nop
nop
...
nop
and $3013, %rcx
lea addresses_UC_ht+0xc9ad, %r15
cmp %rbp, %rbp
movb (%r15), %r14b
nop
nop
...
nop
sub %rcx, %rcx
lea addresses_UC_ht+0x14757, %rbp
nop
sub $33782, %r15
mov (%rbp), %r12
nop
nop
and $27119, %r13
lea addresses_UC_ht+0x75e5, %rsi
lea addresses_UC_ht+0x1aab7, %rdi
nop
nop
nop
nop
...
nop
cmp %r14, %r14
lea addresses_UC_ht+0x16557, %r12
nop
nop
nop
inc %r9
...
lea addresses_A_ht+0x197d7, %rdi
nop
nop
xor $55849, %r14
mov $73, %rcx
...
nop
and %r13, %r13
lea addresses_UC_ht+0x14c6f, %r12
nop
nop
nop
nop
...
{'OP': 'LOAD', 'src': {'type': 'addresses_UC_ht', 'size': 8, 'AVXalign': True, 'NT': False, 'congruent': 7, 'same': False}}
...
{'OP': 'LOAD', 'src': {'type': 'addresses_UC_ht', 'size': 1, 'AVXalign': False, 'NT': True, 'congruent': 1, 'same': False}}
...
{'OP': 'REPM', 'src': {'type': 'addresses_normal_ht', 'congruent': 9, 'same': False}, 'dst': {'type': 'addresses_A_ht', 'congruent': 8, 'same': False}}
