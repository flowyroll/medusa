...
push %rdi
push %rsi
lea addresses_WC_ht+0x1722, %rsi
...
nop
xor %r12, %r12
lea addresses_UC_ht+0x1be92, %rsi
lea addresses_WT_ht+0x15c92, %rdi
nop
dec %rbp
mov $91, %rcx
rep movsw
cmp %rdi, %rdi
lea addresses_A_ht+0x11e2, %r15
nop
sub $64865, %rsi
vmovups (%r15), %ymm6
...
nop
cmp %rbp, %rbp
lea addresses_WT_ht+0xf112, %r10
nop
nop
dec %rcx
movups (%r10), %xmm1
...
nop
add $37027, %r9
lea addresses_A_ht+0x155d2, %rdi
nop
nop
nop
nop
...
nop
cmp %r10, %r10
lea addresses_WC_ht+0x1d525, %rcx
nop
nop
nop
nop
...
nop
and %r15, %r15
lea addresses_D_ht+0x1ea92, %r15
nop
nop
nop
nop
...
nop
cmp $63983, %r12
lea addresses_normal_ht+0xc92, %rsi
nop
nop
nop
nop
...
{'OP': 'REPM', 'src': {'type': 'addresses_UC_ht', 'congruent': 8, 'same': False}, 'dst': {'type': 'addresses_WT_ht', 'congruent': 9, 'same': True}}
