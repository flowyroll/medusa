...
nop
add %rcx, %rcx
lea addresses_UC_ht+0xeba9, %rsi
lea addresses_A_ht+0xcf81, %rdi
clflush (%rdi)
nop
nop
nop
...
rep movsl
and $7279, %r10
lea addresses_normal_ht+0x1dc01, %rsi
lea addresses_UC_ht+0x11301, %rdi
clflush (%rsi)
nop
nop
nop
...
nop
inc %r12
lea addresses_UC_ht+0x7a1, %rsi
lea addresses_UC_ht+0x11d01, %rdi
nop
nop
sub %r10, %r10
mov $112, %rcx
...
nop
and %rsi, %rsi
lea addresses_A_ht+0x16181, %rax
nop
and %r10, %r10
mov (%rax), %esi
nop
...
// Store
lea addresses_normal+0x1ec25, %r14
clflush (%r14)
nop
nop
nop
...
{'OP': 'REPM', 'src': {'type': 'addresses_UC_ht', 'congruent': 5, 'same': False}, 'dst': {'type': 'addresses_UC_ht', 'congruent': 8, 'same': False}}
