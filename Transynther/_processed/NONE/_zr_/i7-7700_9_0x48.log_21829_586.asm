...
push %rdi
push %rsi
lea addresses_WC_ht+0x500e, %r11
nop
nop
add $24752, %r10
movups (%r11), %xmm5
...
nop
xor %rbx, %rbx
lea addresses_WT_ht+0x2a96, %rdi
nop
nop
nop
nop
...
mov (%rdi), %r9d
xor $56056, %r11
lea addresses_UC_ht+0x55ae, %rsi
lea addresses_normal_ht+0x10a8e, %rdi
clflush (%rsi)
nop
nop
nop
...
rep movsw
cmp $5979, %r9
lea addresses_D_ht+0x1320e, %rdi
nop
nop
nop
nop
...
{'OP': 'REPM', 'src': {'type': 'addresses_UC_ht', 'congruent': 4, 'same': False}, 'dst': {'type': 'addresses_normal_ht', 'congruent': 5, 'same': False}}
