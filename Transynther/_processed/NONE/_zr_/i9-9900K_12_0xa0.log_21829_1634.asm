...
push %rdx
push %rsi
lea addresses_D_ht+0x11f51, %rbp
nop
nop
nop
nop
...
nop
dec %rbx
lea addresses_D_ht+0x1adc5, %rax
cmp %r14, %r14
movw $0x6162, (%rax)
nop
nop
...
nop
dec %r14
lea addresses_WT_ht+0x4251, %rax
nop
sub %r8, %r8
...
nop
and %rdx, %rdx
lea addresses_normal_ht+0x11095, %rbx
xor %rax, %rax
mov (%rbx), %r9w
nop
nop
...
nop
add $37442, %rax
lea addresses_WT_ht+0x16d51, %rsi
lea addresses_normal_ht+0x18871, %rdi
nop
nop
nop
nop
...
nop
cmp $21767, %rbp
lea addresses_UC_ht+0x13f51, %rdx
nop
nop
nop
nop
...
nop
inc %rcx
lea addresses_WT_ht+0x1c5d1, %r14
add $39531, %rsi
movb $0x61, (%r14)
nop
nop
...
nop
mfence
lea addresses_UC_ht+0x7c51, %rax
nop
nop
nop
nop
...
nop
sub %r14, %r14
lea addresses_A_ht+0x17ea1, %rbp
nop
nop
nop
nop
...
{'src': {'NT': False, 'same': False, 'congruent': 2, 'type': 'addresses_normal_ht', 'AVXalign': True, 'size': 2}, 'OP': 'LOAD'}
{'src': {'same': False, 'congruent': 9, 'type': 'addresses_WT_ht'}, 'OP': 'REPM', 'dst': {'same': False, 'congruent': 2, 'type': 'addresses_normal_ht'}}
{'src': {'same': True, 'congruent': 6, 'type': 'addresses_UC_ht'}, 'OP': 'REPM', 'dst': {'same': True, 'congruent': 9, 'type': 'addresses_A_ht'}}
