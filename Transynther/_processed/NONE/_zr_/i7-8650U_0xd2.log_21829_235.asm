...
push %rdi
push %rsi
lea addresses_D_ht+0x1ea8f, %rsi
lea addresses_normal_ht+0x9313, %rdi
nop
nop
nop
add $44413, %r9
...
nop
xor $28682, %rcx
lea addresses_normal_ht+0x8213, %r14
nop
nop
nop
nop
...
nop
add $26252, %r10
lea addresses_UC_ht+0x1e373, %r9
nop
nop
nop
cmp %r13, %r13
...
nop
xor $37385, %r9
lea addresses_WC_ht+0x9213, %rsi
lea addresses_normal_ht+0x1b613, %rdi
nop
nop
nop
nop
...
// Store
mov $0x1c16550000000313, %rbp
xor %r8, %r8
movw $0x5152, (%rbp)
xor $23923, %r11

// Faulty Load
lea addresses_WC+0xfa13, %r15
nop
sub $26905, %rbx
mov (%r15), %ebp
lea oracles, %rdi
