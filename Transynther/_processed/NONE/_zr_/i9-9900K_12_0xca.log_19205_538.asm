...
push %rdx
push %rsi
lea addresses_WT_ht+0x7a60, %rsi
lea addresses_normal_ht+0x1a648, %rdi
nop
nop
nop
xor %r14, %r14
...
nop
and %rdx, %rdx
lea addresses_D_ht+0xd278, %rsi
lea addresses_UC_ht+0x2674, %rdi
clflush (%rsi)
sub %r14, %r14
mov $31, %rcx
rep movsq
...
<gen_prepare_buffer>
{'OP': 'REPM', 'src': {'same': False, 'type': 'addresses_WT_ht', 'congruent': 1}, 'dst': {'same': False, 'type': 'addresses_normal_ht', 'congruent': 1}}
