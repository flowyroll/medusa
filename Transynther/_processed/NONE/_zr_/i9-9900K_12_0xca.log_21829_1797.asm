...
push %rbx
push %rcx
lea addresses_WT_ht+0xd0c8, %rax
add %r9, %r9
vmovups (%rax), %ymm7
...
nop
sub %r9, %r9
lea addresses_WC_ht+0x9708, %rcx
nop
add $27658, %rbx
vmovups (%rcx), %ymm2
...
nop
sub %r14, %r14
lea addresses_normal_ht+0x1e02a, %r10
nop
nop
inc %r14
movups (%r10), %xmm2
