...
push %rdi
push %rsi
lea addresses_UC_ht+0x6bfa, %rsi
lea addresses_WT_ht+0x110b8, %rdi
nop
nop
nop
nop
...
rep movsq
and %r10, %r10
lea addresses_normal_ht+0x1539a, %r11
nop
nop
and %rax, %rax
movups (%r11), %xmm0
...
nop
xor $7952, %rcx
lea addresses_normal_ht+0x63a, %rdi
nop
nop
nop
xor $12046, %r12
...
nop
sub $64418, %rdi
lea addresses_UC_ht+0x4cfa, %rdi
nop
nop
nop
sub $26520, %rax
...
nop
and $21530, %rcx
lea addresses_A_ht+0x16bfa, %r12
nop
sub $34912, %rcx
...
movaps %xmm0, (%r12)
dec %r10
lea addresses_WT_ht+0x1d7f2, %r11
nop
nop
nop
nop
...
nop
xor $44783, %r12
lea addresses_D_ht+0x17dfa, %r11
nop
nop
xor %rdi, %rdi
movups (%r11), %xmm1
...
<gen_prepare_buffer>
{'src': {'congruent': 9, 'same': False, 'type': 'addresses_UC_ht'}, 'OP': 'REPM', 'dst': {'congruent': 1, 'same': False, 'type': 'addresses_WT_ht'}}
...
{'src': {'congruent': 6, 'AVXalign': False, 'same': False, 'size': 2, 'NT': True, 'type': 'addresses_WC_ht'}, 'OP': 'LOAD'}
{'OP': 'STOR', 'dst': {'congruent': 10, 'AVXalign': True, 'same': False, 'size': 16, 'NT': True, 'type': 'addresses_A_ht'}}
