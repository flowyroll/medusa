...
nop
xor %r14, %r14
lea addresses_WT_ht+0x1dd89, %rsi
lea addresses_D_ht+0x13fe9, %rdi
nop
sub $17202, %rbp
mov $3, %rcx
rep movsq
...
nop
and $33602, %rbp
lea addresses_UC_ht+0x18989, %rbx
clflush (%rbx)
nop
nop
nop
...
nop
sub $30947, %r14
lea addresses_UC_ht+0x13189, %rdi
nop
nop
and $24512, %r14
movl $0x61626364, (%rdi)
...
// Store
lea addresses_normal+0x1d589, %r11
nop
inc %r8
movb $0x51, (%r11)
nop
...
{'OP': 'STOR', 'dst': {'NT': False, 'same': False, 'congruent': 4, 'type': 'addresses_A', 'AVXalign': True, 'size': 2}}
