...
push %rdx
push %rsi
lea addresses_D_ht+0x3cd2, %rsi
lea addresses_D_ht+0x2baa, %rdi
nop
nop
nop
add %r9, %r9
...
rep movsw
and %rbp, %rbp
lea addresses_A_ht+0x1ddd2, %rsi
lea addresses_UC_ht+0xfe52, %rdi
clflush (%rdi)
nop
nop
nop
...
nop
dec %r9
lea addresses_normal_ht+0x15b72, %rdx
nop
nop
nop
add %r15, %r15
...
nop
xor $60656, %rdi
lea addresses_UC_ht+0x1786a, %rdx
nop
and $45483, %rdi
...
nop
inc %rsi
lea addresses_WC_ht+0xcf4a, %rsi
lea addresses_UC_ht+0xc472, %rdi
clflush (%rdi)
nop
nop
nop
...
nop
sub %rdx, %rdx
lea addresses_normal_ht+0xb8b2, %rax
nop
nop
nop
cmp %rdx, %rdx
mov (%rax), %r15
cmp %rdx, %rdx
lea addresses_normal_ht+0x7612, %rsi
lea addresses_WC_ht+0x121d2, %rdi
clflush (%rsi)
nop
nop
nop
...
nop
xor $65525, %rdi
lea addresses_WC_ht+0x17f46, %rax
clflush (%rax)
nop
nop
and $29149, %rdi
...
<gen_prepare_buffer>
{'OP': 'REPM', 'src': {'type': 'addresses_D_ht', 'congruent': 7, 'same': False}, 'dst': {'type': 'addresses_D_ht', 'congruent': 3, 'same': False}}
{'OP': 'REPM', 'src': {'type': 'addresses_A_ht', 'congruent': 9, 'same': False}, 'dst': {'type': 'addresses_UC_ht', 'congruent': 4, 'same': False}}
