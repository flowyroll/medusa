...
nop
cmp %rbp, %rbp
lea addresses_WT_ht+0x1eac2, %rbx
nop
nop
nop
nop
...
movq %r11, (%rbx)
add $7514, %r13
lea addresses_D_ht+0xed12, %rsi
lea addresses_WC_ht+0x18fc2, %rdi
nop
add $37451, %rbp
mov $112, %rcx
rep movsl
...
{'OP': 'LOAD', 'src': {'type': 'addresses_A_ht', 'size': 32, 'AVXalign': False, 'NT': False, 'congruent': 5, 'same': True}}
