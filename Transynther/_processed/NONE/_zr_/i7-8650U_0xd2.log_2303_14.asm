...
push %rdi
push %rsi
lea addresses_WC_ht+0x3e31, %rax
nop
nop
nop
xor $51123, %r14
...
lea addresses_WT_ht+0x8131, %rdi
nop
and %rbx, %rbx
mov $53, %rcx
rep movsq
...
nop
dec %rsi
lea addresses_WC_ht+0x15d31, %rsi
lea addresses_WC_ht+0xe871, %rdi
nop
nop
nop
nop
...
{'OP': 'LOAD', 'src': {'type': 'addresses_WC', 'size': 8, 'AVXalign': True, 'NT': True, 'congruent': 0, 'same': False}}
[Faulty Load]
