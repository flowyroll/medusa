...
push %rdx
push %rsi
lea addresses_normal_ht+0x10154, %rbp
nop
nop
nop
add $19565, %r8
...
nop
cmp $26522, %r12
lea addresses_WC_ht+0x1da4, %rdx
nop
nop
sub %rbx, %rbx
movb $0x61, (%rdx)
nop
xor $51692, %r12
lea addresses_normal_ht+0x16834, %rsi
lea addresses_WC_ht+0x1dfd4, %rdi
nop
nop
nop
xor $9221, %r11
...
nop
sub %rdx, %rdx
lea addresses_normal_ht+0xf3d4, %rsi
lea addresses_normal_ht+0x2d4, %rdi
nop
dec %rdx
mov $75, %rcx
rep movsl
...
nop
and $54718, %rdx
lea addresses_WC_ht+0x187d4, %r13
nop
nop
xor $5480, %r11
...
// Store
lea addresses_normal+0x3e44, %rdx
nop
nop
nop
dec %r11
...
{'OP': 'REPM', 'src': {'type': 'addresses_normal_ht', 'congruent': 8, 'same': False}, 'dst': {'type': 'addresses_normal_ht', 'congruent': 8, 'same': False}}
