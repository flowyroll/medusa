...
push %rdi
push %rsi
lea addresses_A_ht+0x636a, %rsi
lea addresses_A_ht+0xdfe4, %rdi
nop
nop
nop
cmp %r10, %r10
...
nop
xor $48537, %rbx
lea addresses_WT_ht+0x41ac, %rsi
lea addresses_UC_ht+0x1beb4, %rdi
nop
nop
nop
sub %rbp, %rbp
...
nop
inc %rbp
lea addresses_WT_ht+0xe9ac, %rbp
nop
nop
nop
nop
...
nop
xor $20214, %rbp
lea addresses_UC_ht+0x176ca, %rsi
lea addresses_A_ht+0x29ac, %rdi
clflush (%rdi)
nop
nop
and %rbx, %rbx
...
nop
sub $36567, %rsi
lea addresses_A_ht+0x1a88e, %rsi
nop
nop
nop
nop
...
nop
inc %rbx
lea addresses_WC_ht+0x861b, %r12
nop
nop
nop
and %r10, %r10
...
nop
add $63050, %rsi
lea addresses_WC_ht+0x1b1ac, %rbx
sub $37020, %rbp
...
nop
and $36021, %rbp
lea addresses_normal_ht+0x143ac, %rbx
nop
nop
nop
nop
...
{'OP': 'STOR', 'dst': {'type': 'addresses_A', 'size': 1, 'AVXalign': False, 'NT': False, 'congruent': 6, 'same': True}}
