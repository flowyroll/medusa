...
nop
xor $43110, %r10
lea addresses_A_ht+0x105de, %r13
nop
nop
xor %rbp, %rbp
vmovups (%r13), %ymm0
...
nop
cmp $64065, %rbp
lea addresses_UC_ht+0x1baba, %rbp
nop
nop
nop
nop
...
nop
dec %rdi
lea addresses_UC_ht+0x18b8e, %rbp
nop
nop
nop
nop
...
nop
sub $37821, %r10
lea addresses_A_ht+0x1590e, %rdi
nop
nop
nop
add %rcx, %rcx
...
nop
sub %rdi, %rdi
lea addresses_normal_ht+0x1c80e, %rcx
nop
nop
nop
dec %r15
...
nop
cmp $53490, %r10
lea addresses_WT_ht+0x17d6e, %rsi
lea addresses_WC_ht+0x40e, %rdi
nop
nop
sub %r8, %r8
mov $98, %rcx
...
// Store
lea addresses_normal+0x145ee, %r10
nop
nop
nop
inc %rbx
...
{'OP': 'STOR', 'dst': {'type': 'addresses_UC_ht', 'AVXalign': False, 'congruent': 7, 'size': 1, 'same': True, 'NT': False}}
...
{'OP': 'LOAD', 'src': {'type': 'addresses_normal_ht', 'AVXalign': False, 'congruent': 10, 'size': 16, 'same': False, 'NT': True}}
