...
push %rdi
push %rsi
lea addresses_A_ht+0xc6f2, %rsi
lea addresses_WT_ht+0x4c22, %rdi
nop
add $48486, %r9
mov $49, %rcx
rep movsw
...
nop
and %r10, %r10
lea addresses_WT_ht+0xdf42, %rsi
lea addresses_normal_ht+0x27f2, %rdi
nop
cmp %r12, %r12
mov $103, %rcx
rep movsl
...
nop
dec %r9
lea addresses_D_ht+0x16df2, %rsi
nop
nop
nop
and %r13, %r13
...
nop
and $26889, %rdi
lea addresses_normal_ht+0xd442, %rsi
lea addresses_WT_ht+0x4ef2, %rdi
clflush (%rsi)
nop
nop
nop
...
nop
dec %r12
lea addresses_D_ht+0x125f2, %rdi
nop
and $26830, %r13
movb $0x61, (%rdi)
nop
...
nop
sub %rsi, %rsi
lea addresses_D_ht+0x173f2, %rsi
add %rdi, %rdi
mov (%rsi), %r10d
nop
nop
xor $45480, %rcx
lea addresses_A_ht+0xaff2, %r9
nop
nop
nop
nop
...
nop
cmp $32463, %r10
lea addresses_WT_ht+0x3372, %rcx
nop
nop
nop
inc %rsi
...
nop
dec %rsi
lea addresses_normal_ht+0x7382, %rsi
lea addresses_UC_ht+0x663a, %rdi
nop
nop
and %r10, %r10
mov $2, %rcx
...
// Load
lea addresses_normal+0x2b62, %rdx
nop
sub %r8, %r8
vmovups (%rdx), %ymm4
...
{'OP': 'LOAD', 'src': {'type': 'addresses_normal', 'size': 32, 'AVXalign': False, 'NT': False, 'congruent': 3, 'same': True}}
...
{'OP': 'REPM', 'src': {'type': 'addresses_WT_ht', 'congruent': 2, 'same': False}, 'dst': {'type': 'addresses_normal_ht', 'congruent': 9, 'same': False}}
{'OP': 'STOR', 'dst': {'type': 'addresses_D_ht', 'size': 8, 'AVXalign': True, 'NT': False, 'congruent': 7, 'same': False}}
{'OP': 'REPM', 'src': {'type': 'addresses_normal_ht', 'congruent': 2, 'same': True}, 'dst': {'type': 'addresses_WT_ht', 'congruent': 8, 'same': False}}
