...
push %rdx
push %rsi
lea addresses_UC_ht+0x1155b, %r13
nop
nop
nop
nop
...
movw $0x6162, (%r13)
and $54121, %r15
lea addresses_normal_ht+0xab5b, %r11
nop
cmp $51651, %rbx
movl $0x61626364, (%r11)
nop
nop
xor %rdi, %rdi
lea addresses_WT_ht+0x13afb, %r10
nop
cmp $8668, %r11
movl $0x61626364, (%r10)
and %r13, %r13
lea addresses_D_ht+0x176c3, %rsi
lea addresses_D_ht+0x1da35, %rdi
clflush (%rsi)
nop
nop
add %r10, %r10
...
rep movsq
add $7211, %rdi
lea addresses_A_ht+0xc89b, %rsi
lea addresses_normal_ht+0x22f, %rdi
dec %rdx
mov $116, %rcx
rep movsw
nop
...
{'OP': 'REPM', 'src': {'type': 'addresses_A_ht', 'congruent': 6, 'same': False}, 'dst': {'type': 'addresses_normal_ht', 'congruent': 2, 'same': True}}
{'00': 10998}
