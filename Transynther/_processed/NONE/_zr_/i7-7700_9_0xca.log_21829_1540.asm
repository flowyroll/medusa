...
nop
cmp %r10, %r10
lea addresses_WT_ht+0x9da3, %rsi
...
nop
dec %rax
lea addresses_WT_ht+0xbb84, %rax
clflush (%rax)
nop
nop
nop
...
nop
xor %rbp, %rbp
lea addresses_UC_ht+0x15cfe, %r11
nop
nop
nop
nop
...
{'OP': 'STOR', 'dst': {'congruent': 7, 'AVXalign': False, 'same': False, 'size': 32, 'NT': True, 'type': 'addresses_WT_ht'}}
{'src': {'congruent': 0, 'same': False, 'type': 'addresses_WT_ht'}, 'OP': 'REPM', 'dst': {'congruent': 5, 'same': True, 'type': 'addresses_UC_ht'}}
