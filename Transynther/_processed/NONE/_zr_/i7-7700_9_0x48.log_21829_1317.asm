...
push %rdi
push %rsi
lea addresses_normal_ht+0x1c8d, %rsi
lea addresses_UC_ht+0x124a7, %rdi
nop
nop
nop
nop
...
nop
sub %r11, %r11
lea addresses_WC_ht+0x11d8d, %rdi
nop
nop
add %r8, %r8
movl $0x61626364, (%rdi)
...
nop
dec %r8
lea addresses_D_ht+0x12afd, %r11
clflush (%r11)
nop
nop
nop
...
movl $0x61626364, (%r11)
inc %r14
lea addresses_UC_ht+0x2acd, %rcx
and %r13, %r13
movb $0x61, (%rcx)
nop
nop
...
{'OP': 'STOR', 'dst': {'type': 'addresses_UC_ht', 'AVXalign': False, 'congruent': 6, 'size': 1, 'same': False, 'NT': True}}
{'00': 21829}
