...
push %rdi
push %rsi
lea addresses_UC_ht+0x1a43b, %rdi
and $35606, %rax
movb $0x61, (%rdi)
nop
nop
...
nop
and %rdi, %rdi
lea addresses_D_ht+0x167f0, %rsi
lea addresses_WC_ht+0x13fcc, %rdi
nop
and %r15, %r15
mov $58, %rcx
rep movsq
...
nop
inc %rcx
lea addresses_WC_ht+0x10afc, %r14
nop
nop
nop
nop
...
rep movsw
sub $43585, %rsi
lea addresses_UC_ht+0x196cc, %rax
nop
sub %r11, %r11
mov (%rax), %r14
nop
...
{'src': {'same': False, 'congruent': 8, 'type': 'addresses_WT_ht'}, 'OP': 'REPM', 'dst': {'same': True, 'congruent': 2, 'type': 'addresses_D_ht'}}
