...
nop
cmp %rax, %rax
lea addresses_UC_ht+0x10367, %rsi
lea addresses_UC_ht+0x88a7, %rdi
nop
nop
nop
nop
...
{'OP': 'STOR', 'dst': {'type': 'addresses_WC', 'size': 32, 'AVXalign': False, 'NT': True, 'congruent': 8, 'same': False}}
