...
push %rdi
push %rsi
lea addresses_UC_ht+0x18b9f, %rsi
add $40738, %r11
mov (%rsi), %bx
nop
nop
nop
and %r9, %r9
lea addresses_WT_ht+0x1e9f, %r13
nop
nop
nop
nop
...
nop
sub $643, %r13
lea addresses_A_ht+0x1519f, %r11
clflush (%r11)
nop
nop
nop
...
nop
sub %rbx, %rbx
lea addresses_D_ht+0x14c4f, %rbp
nop
add %r13, %r13
movw $0x6162, (%rbp)
nop
...
movq %r13, (%r9)
cmp %r11, %r11
lea addresses_WT_ht+0xd527, %r10
nop
nop
dec %r9
mov (%r10), %rbx
...
nop
sub $55614, %r10
lea addresses_WC_ht+0x1cf1f, %rsi
inc %r13
movl $0x61626364, (%rsi)
nop
nop
...
nop
sub %rcx, %rcx
lea addresses_WC_ht+0x18d9f, %r11
nop
nop
inc %rcx
...
nop
cmp %r10, %r10
lea addresses_A_ht+0x1d1bf, %rsi
nop
nop
nop
and %rdi, %rdi
...
nop
and $22944, %rbx
lea addresses_UC_ht+0x1a0ff, %rbp
nop
nop
nop
nop
...
nop
cmp $8692, %r11
lea addresses_UC_ht+0x1699f, %rbp
nop
add %rcx, %rcx
mov (%rbp), %r9w
nop
nop
and $4327, %rsi
lea addresses_normal_ht+0x419f, %rbp
nop
nop
nop
add $37809, %r9
...
nop
mfence
lea addresses_UC_ht+0x8e1f, %rsi
lea addresses_WT_ht+0x1e19f, %rdi
nop
nop
nop
nop
...
{'src': {'congruent': 7, 'AVXalign': False, 'same': True, 'size': 4, 'NT': True, 'type': 'addresses_WT_ht'}, 'OP': 'LOAD'}
...
{'src': {'congruent': 3, 'AVXalign': False, 'same': False, 'size': 2, 'NT': True, 'type': 'addresses_UC_ht'}, 'OP': 'LOAD'}
