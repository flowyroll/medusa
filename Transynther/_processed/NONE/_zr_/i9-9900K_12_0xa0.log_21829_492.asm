...
push %rdx
push %rsi
lea addresses_normal_ht+0x1d70c, %r11
nop
nop
nop
xor $54480, %rdx
...
nop
cmp %r15, %r15
lea addresses_WC_ht+0x18aec, %r11
nop
add $3375, %rbp
mov (%r11), %cx
nop
cmp %rcx, %rcx
lea addresses_UC_ht+0xf0c, %rdx
nop
sub $36495, %r11
mov (%rdx), %rbp
nop
sub %r15, %r15
lea addresses_A_ht+0x1445e, %r11
nop
dec %r14
mov (%r11), %rdx
cmp %r15, %r15
lea addresses_WC_ht+0x12f8c, %rsi
lea addresses_WT_ht+0x164b4, %rdi
nop
nop
nop
cmp $58081, %rdx
...
{'src': {'same': False, 'congruent': 7, 'type': 'addresses_WC_ht'}, 'OP': 'REPM', 'dst': {'same': False, 'congruent': 2, 'type': 'addresses_WT_ht'}}
{'00': 21829}
