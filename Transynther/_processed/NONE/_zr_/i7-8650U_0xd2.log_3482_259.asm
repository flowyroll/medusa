...
push %rdx
push %rsi
lea addresses_WT_ht+0x105dd, %rdx
nop
nop
nop
nop
...
nop
cmp %rcx, %rcx
lea addresses_UC_ht+0x187dd, %r8
nop
nop
nop
nop
...
nop
inc %r15
lea addresses_normal_ht+0x1a741, %rsi
...
// Load
lea addresses_normal+0x1195d, %rdx
clflush (%rdx)
nop
add %r12, %r12
mov (%rdx), %bp
