...
nop
cmp $51419, %r8
lea addresses_WC_ht+0x1e729, %r12
nop
nop
nop
nop
...
nop
and %r15, %r15
lea addresses_WC_ht+0x594d, %rsi
lea addresses_UC_ht+0xb3a9, %rdi
clflush (%rdi)
and %r15, %r15
mov $2, %rcx
rep movsb
...
nop
inc %rdi
lea addresses_D_ht+0x1e669, %rsi
lea addresses_UC_ht+0x1c785, %rdi
nop
nop
nop
nop
...
nop
cmp $42535, %rcx
lea addresses_WT_ht+0x1cb29, %r15
xor $57508, %r14
movb $0x61, (%r15)
nop
nop
...
nop
sub $63325, %r9
lea addresses_UC_ht+0x18f29, %r11
cmp $20416, %rdi
...
nop
cmp %r9, %r9
lea addresses_WT_ht+0x6329, %r9
nop
nop
xor %r12, %r12
mov (%r9), %si
dec %r9
lea addresses_D_ht+0x3629, %rdi
nop
nop
nop
add %r14, %r14
...
{'OP': 'STOR', 'dst': {'NT': False, 'same': False, 'congruent': 1, 'type': 'addresses_WC', 'AVXalign': True, 'size': 4}}
...
{'src': {'same': False, 'congruent': 2, 'type': 'addresses_WC_ht'}, 'OP': 'REPM', 'dst': {'same': False, 'congruent': 7, 'type': 'addresses_UC_ht'}}
...
{'OP': 'STOR', 'dst': {'NT': False, 'same': True, 'congruent': 10, 'type': 'addresses_UC_ht', 'AVXalign': False, 'size': 8}}
