...
mov (%r14), %r13w
add $10279, %rdx
lea addresses_D_ht+0x18bd4, %r14
nop
nop
nop
nop
...
nop
sub $18081, %rbx
lea addresses_WT_ht+0x7f54, %rbx
nop
nop
and $2831, %rsi
movw $0x6162, (%rbx)
dec %rbx
lea addresses_D_ht+0x10fe4, %r11
and %rbx, %rbx
...
nop
add $20859, %r11
lea addresses_normal_ht+0x77dc, %rsi
lea addresses_normal_ht+0xf49c, %rdi
nop
nop
nop
nop
...
nop
sub %rdx, %rdx
lea addresses_normal_ht+0x71c, %rcx
nop
nop
nop
nop
...
nop
cmp %rcx, %rcx
lea addresses_D_ht+0xbe4, %rsi
lea addresses_WT_ht+0x601c, %rdi
nop
nop
nop
nop
...
nop
dec %r14
lea addresses_UC_ht+0xfe8c, %rdx
nop
nop
nop
nop
...
{'OP': 'REPM', 'src': {'type': 'addresses_normal_ht', 'congruent': 5, 'same': False}, 'dst': {'type': 'addresses_normal_ht', 'congruent': 11, 'same': True}}
