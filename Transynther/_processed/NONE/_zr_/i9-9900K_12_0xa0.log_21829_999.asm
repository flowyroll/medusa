...
nop
sub %r9, %r9
lea addresses_WC_ht+0x5713, %rsi
lea addresses_D_ht+0x16423, %rdi
nop
nop
nop
nop
...
nop
inc %rax
lea addresses_UC_ht+0xb20, %rsi
lea addresses_D_ht+0xd923, %rdi
nop
nop
nop
xor $56044, %rdx
...
rep movsw
cmp $34471, %rax
lea addresses_normal_ht+0x8023, %rsi
lea addresses_A_ht+0x7823, %rdi
nop
and %r14, %r14
mov $5, %rcx
rep movsq
...
nop
and $10219, %r14
lea addresses_normal_ht+0x3293, %r12
nop
nop
nop
nop
...
nop
dec %rcx
lea addresses_WC_ht+0x4823, %r12
nop
nop
nop
cmp %rsi, %rsi
...
nop
inc %rcx
lea addresses_UC_ht+0x1ac95, %r9
nop
nop
and $32235, %rax
movw $0x6162, (%r9)
...
nop
cmp $52429, %rcx
lea addresses_WC_ht+0x2733, %rsi
lea addresses_UC_ht+0x8217, %rdi
nop
nop
cmp $18368, %r12
mov $17, %rcx
rep movsl
inc %r9
lea addresses_WC_ht+0x141f, %rsi
lea addresses_UC_ht+0x1ee7b, %rdi
nop
nop
cmp $32276, %rdx
mov $55, %rcx
...
nop
inc %rdi
lea addresses_D_ht+0x1db23, %rsi
nop
nop
nop
nop
...
nop
inc %r9
lea addresses_WT_ht+0x1eed3, %r9
nop
sub %rcx, %rcx
...
{'src': {'same': False, 'congruent': 4, 'type': 'addresses_WC_ht'}, 'OP': 'REPM', 'dst': {'same': False, 'congruent': 8, 'type': 'addresses_D_ht'}}
{'src': {'same': False, 'congruent': 0, 'type': 'addresses_UC_ht'}, 'OP': 'REPM', 'dst': {'same': True, 'congruent': 8, 'type': 'addresses_D_ht'}}
{'src': {'same': False, 'congruent': 11, 'type': 'addresses_normal_ht'}, 'OP': 'REPM', 'dst': {'same': True, 'congruent': 11, 'type': 'addresses_A_ht'}}
{'OP': 'STOR', 'dst': {'NT': True, 'same': False, 'congruent': 10, 'type': 'addresses_A_ht', 'AVXalign': True, 'size': 2}}
