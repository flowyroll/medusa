...
push %rdi
push %rsi
lea addresses_D_ht+0x1bbec, %rsi
lea addresses_UC_ht+0x167a4, %rdi
clflush (%rsi)
nop
nop
nop
...
nop
and %rbx, %rbx
lea addresses_A_ht+0x17620, %r11
nop
add %rbp, %rbp
movl $0x61626364, (%r11)
nop
...
nop
and $44577, %rdi
lea addresses_normal_ht+0x9464, %rdi
nop
nop
nop
nop
...
vpextrq $1, %xmm0, %r11
add %rsi, %rsi
lea addresses_D_ht+0x1dc64, %rsi
lea addresses_normal_ht+0x5d2a, %rdi
nop
xor %r15, %r15
mov $78, %rcx
rep movsq
dec %r11
lea addresses_WT_ht+0x14c94, %rdi
sub $55285, %r14
...
{'src': {'congruent': 9, 'same': False, 'type': 'addresses_D_ht'}, 'OP': 'REPM', 'dst': {'congruent': 1, 'same': True, 'type': 'addresses_normal_ht'}}
