...
push %rdx
push %rsi
lea addresses_A_ht+0x125dc, %rsi
nop
nop
nop
nop
...
nop
inc %rdx
lea addresses_UC_ht+0x18c5c, %r9
nop
nop
nop
and %r15, %r15
...
nop
cmp %rdx, %rdx
lea addresses_UC_ht+0x119fc, %rsi
nop
nop
nop
nop
...
nop
cmp $17607, %r9
lea addresses_UC_ht+0x19aec, %r9
nop
nop
nop
nop
...
nop
sub $45636, %r15
lea addresses_UC_ht+0x2f1f, %r13
clflush (%r13)
sub %r15, %r15
mov (%r13), %edx
nop
nop
add $41284, %rdx
lea addresses_WC_ht+0x1b25c, %rsi
lea addresses_UC_ht+0xd65c, %rdi
clflush (%rdi)
nop
nop
cmp %r15, %r15
...
nop
dec %r9
lea addresses_A_ht+0x11c, %rsi
lea addresses_A_ht+0x1c93c, %rdi
and $19677, %r15
mov $73, %rcx
rep movsl
xor %rdi, %rdi
lea addresses_WC_ht+0x153ec, %r9
nop
nop
nop
nop
...
nop
sub %r15, %r15
lea addresses_WT_ht+0x365c, %r15
inc %r9
mov (%r15), %si
nop
nop
...
nop
xor $39946, %r9
lea addresses_WC_ht+0x154e4, %rsi
lea addresses_WC_ht+0xbddc, %rdi
nop
nop
inc %r14
mov $56, %rcx
...
{'src': {'NT': True, 'AVXalign': False, 'size': 16, 'congruent': 5, 'same': False, 'type': 'addresses_D_ht'}, 'OP': 'LOAD'}
...
{'src': {'congruent': 6, 'same': False, 'type': 'addresses_WC_ht'}, 'dst': {'congruent': 9, 'same': False, 'type': 'addresses_UC_ht'}, 'OP': 'REPM'}
{'src': {'congruent': 6, 'same': True, 'type': 'addresses_A_ht'}, 'dst': {'congruent': 5, 'same': False, 'type': 'addresses_A_ht'}, 'OP': 'REPM'}
...
{'dst': {'NT': True, 'AVXalign': True, 'size': 2, 'congruent': 1, 'same': False, 'type': 'addresses_D_ht'}, 'OP': 'STOR'}
{'00': 21829}
