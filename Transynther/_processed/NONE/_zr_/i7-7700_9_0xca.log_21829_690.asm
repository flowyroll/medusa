...
push %rdi
push %rsi
lea addresses_D_ht+0x1dfaa, %rax
clflush (%rax)
cmp %r9, %r9
...
nop
cmp $54846, %r13
lea addresses_WC_ht+0x36ca, %r12
nop
nop
add $60040, %rbx
vmovups (%r12), %ymm2
...
nop
inc %r9
lea addresses_WC_ht+0x39e, %rsi
lea addresses_UC_ht+0xe0ca, %rdi
nop
and $306, %r13
mov $12, %rcx
rep movsq
...
nop
add %rax, %rax
lea addresses_normal_ht+0xa4ba, %rdi
nop
nop
cmp $22155, %r11
movw $0x6162, (%rdi)
...
nop
add $61050, %rbx
lea addresses_WT_ht+0x18bab, %rcx
nop
and $39690, %r9
movb (%rcx), %r14b
nop
nop
inc %r9
lea addresses_A_ht+0x166ca, %r13
nop
nop
nop
nop
...
// Store
lea addresses_normal+0x373a, %rdi
inc %r14
movl $0x51525354, (%rdi)
nop
nop
...
{'OP': 'STOR', 'dst': {'congruent': 3, 'AVXalign': False, 'same': False, 'size': 4, 'NT': True, 'type': 'addresses_normal'}}
