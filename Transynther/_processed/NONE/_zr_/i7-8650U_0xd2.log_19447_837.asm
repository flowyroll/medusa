...
push %rdx
push %rsi
lea addresses_UC_ht+0x73d0, %r12
nop
nop
sub %r13, %r13
mov (%r12), %r9w
...
nop
cmp $28926, %rbx
lea addresses_WC_ht+0x17dd0, %rbx
nop
nop
dec %rdx
...
nop
sub $48499, %r9
lea addresses_WC_ht+0x5fd0, %rbx
and $10687, %rdi
mov (%rbx), %r15w
nop
nop
dec %rdx
lea addresses_UC_ht+0x1d918, %rbx
nop
sub $60490, %rdx
...
nop
sub %r15, %r15
lea addresses_normal_ht+0x4ad0, %r9
nop
nop
nop
nop
...
nop
inc %r13
lea addresses_WC_ht+0x18f50, %r9
nop
and $27377, %r13
movb $0x61, (%r9)
nop
xor %r13, %r13
lea addresses_WC_ht+0x2810, %rsi
...
rep movsb
and $60493, %rdi
lea addresses_WT_ht+0xed74, %rsi
lea addresses_D_ht+0x6ed2, %rdi
nop
nop
add $50562, %r12
mov $33, %rcx
...
nop
sub $3300, %r13
lea addresses_normal_ht+0x141f0, %rsi
lea addresses_WT_ht+0x183d0, %rdi
nop
nop
inc %r12
mov $57, %rcx
...
{'OP': 'LOAD', 'src': {'type': 'addresses_WC_ht', 'size': 2, 'AVXalign': False, 'NT': False, 'congruent': 7, 'same': True}}
