...
nop
cmp %rdx, %rdx
lea addresses_WT_ht+0x8568, %rdx
nop
nop
nop
nop
...
nop
cmp %rdi, %rdi
lea addresses_D_ht+0x19898, %rsi
nop
and $12089, %r9
mov (%rsi), %r12w
nop
add %r9, %r9
lea addresses_A_ht+0x56b8, %r11
nop
nop
dec %rdx
...
nop
xor $31434, %r12
lea addresses_UC_ht+0x6dd0, %rdi
nop
nop
nop
nop
...
nop
cmp $51751, %r9
lea addresses_A_ht+0x1c3f0, %r13
nop
nop
nop
nop
...
rep movsq
xor %r11, %r11
lea addresses_normal_ht+0xbc78, %rdx
nop
nop
add $14408, %rcx
movups (%rdx), %xmm5
...
nop
mfence
lea addresses_WC_ht+0x6278, %rsi
lea addresses_WC_ht+0x108f8, %rdi
nop
nop
nop
nop
...
rep movsl
cmp %rcx, %rcx
lea addresses_A_ht+0x7a78, %rdx
nop
sub $17694, %r11
movb (%rdx), %r12b
nop
add $34428, %r13
lea addresses_WC_ht+0x5237, %r9
nop
nop
xor %rsi, %rsi
mov (%r9), %r11
...
{'OP': 'LOAD', 'src': {'type': 'addresses_A', 'size': 2, 'AVXalign': True, 'NT': False, 'congruent': 1, 'same': False}}
