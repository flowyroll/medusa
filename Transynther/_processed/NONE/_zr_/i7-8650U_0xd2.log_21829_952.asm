...
vpextrq $0, %xmm2, %rsi
xor %r13, %r13
lea addresses_WT_ht+0x2169, %rsi
lea addresses_A_ht+0x13339, %rdi
xor %rbx, %rbx
mov $81, %rcx
rep movsl
nop
...
lea addresses_D_ht+0x1ade9, %rdi
nop
cmp $58373, %rax
mov $34, %rcx
rep movsb
...
nop
xor $7730, %rdi
lea addresses_A_ht+0x1d3c9, %r13
clflush (%r13)
nop
nop
nop
...
nop
cmp %rax, %rax
lea addresses_UC_ht+0x1dea9, %rsi
lea addresses_UC_ht+0x19749, %rdi
nop
nop
nop
add $18272, %r13
...
{'OP': 'REPM', 'src': {'type': 'addresses_UC_ht', 'congruent': 6, 'same': False}, 'dst': {'type': 'addresses_UC_ht', 'congruent': 5, 'same': True}}
{'00': 21829}
