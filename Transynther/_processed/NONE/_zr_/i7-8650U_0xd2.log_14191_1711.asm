...
nop
dec %rdx
lea addresses_A_ht+0xb44a, %rsi
lea addresses_WT_ht+0x16cfc, %rdi
nop
nop
inc %r10
mov $39, %rcx
...
nop
cmp $55085, %rdx
lea addresses_WT_ht+0x1a48a, %rsi
lea addresses_D_ht+0x17f76, %rdi
nop
nop
nop
nop
...
nop
cmp %rcx, %rcx
lea addresses_normal_ht+0x1eb0a, %rsi
nop
dec %rdx
movups (%rsi), %xmm0
vpextrq $1, %xmm0, %rcx
xor $55490, %rcx
lea addresses_WT_ht+0x1610a, %rsi
lea addresses_A_ht+0x1b269, %rdi
nop
nop
and %r8, %r8
mov $76, %rcx
...
nop
add $17353, %rcx
lea addresses_UC_ht+0x1d70a, %rsi
clflush (%rsi)
nop
nop
add $27512, %rcx
...
nop
xor %r10, %r10
lea addresses_A_ht+0x1c10a, %rsi
lea addresses_UC_ht+0x310a, %rdi
nop
nop
nop
nop
...
nop
dec %rdx
lea addresses_UC_ht+0xdb8a, %rsi
lea addresses_WT_ht+0x1d142, %rdi
nop
sub $18921, %r10
mov $90, %rcx
rep movsl
...
nop
add %r15, %r15
lea addresses_WT_ht+0x5504, %rcx
nop
nop
nop
nop
...
nop
xor $35091, %rcx
lea addresses_normal_ht+0xba22, %r14
nop
nop
nop
nop
...
{'OP': 'REPM', 'src': {'type': 'addresses_WT_ht', 'congruent': 5, 'same': False}, 'dst': {'type': 'addresses_D_ht', 'congruent': 2, 'same': True}}
{'OP': 'LOAD', 'src': {'type': 'addresses_normal_ht', 'size': 16, 'AVXalign': False, 'NT': False, 'congruent': 8, 'same': False}}
{'OP': 'REPM', 'src': {'type': 'addresses_WT_ht', 'congruent': 8, 'same': True}, 'dst': {'type': 'addresses_A_ht', 'congruent': 0, 'same': False}}
...
{'OP': 'REPM', 'src': {'type': 'addresses_UC_ht', 'congruent': 7, 'same': False}, 'dst': {'type': 'addresses_WT_ht', 'congruent': 1, 'same': True}}
{'OP': 'STOR', 'dst': {'type': 'addresses_WT_ht', 'size': 32, 'AVXalign': True, 'NT': False, 'congruent': 1, 'same': False}}
