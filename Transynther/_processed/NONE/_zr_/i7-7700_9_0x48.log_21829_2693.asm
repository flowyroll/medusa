...
nop
dec %r11
lea addresses_UC_ht+0x1f080, %rsi
lea addresses_D_ht+0x1e6e0, %rdi
nop
nop
nop
nop
...
nop
cmp $28752, %r11
lea addresses_WT_ht+0x15880, %rsi
lea addresses_WC_ht+0x1c240, %rdi
nop
nop
nop
nop
...
nop
sub %r10, %r10
lea addresses_WC_ht+0x181e0, %rcx
nop
inc %rsi
movl $0x61626364, (%rcx)
xor $36263, %rax
lea addresses_normal_ht+0x9400, %rdi
nop
nop
nop
nop
...
{'OP': 'REPM', 'src': {'type': 'addresses_UC_ht', 'congruent': 9, 'same': False}, 'dst': {'type': 'addresses_D_ht', 'congruent': 4, 'same': False}}
{'OP': 'REPM', 'src': {'type': 'addresses_WT_ht', 'congruent': 8, 'same': True}, 'dst': {'type': 'addresses_WC_ht', 'congruent': 6, 'same': False}}
