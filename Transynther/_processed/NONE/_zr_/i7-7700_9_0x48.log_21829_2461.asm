...
push %rdi
push %rsi
lea addresses_WC_ht+0x1d991, %rsi
lea addresses_WC_ht+0x17549, %rdi
nop
nop
nop
and $8478, %r9
...
nop
sub %rbp, %rbp
lea addresses_WT_ht+0x14633, %r12
nop
nop
sub $27530, %rdi
mov (%r12), %rbp
sub $34736, %rdi
lea addresses_UC_ht+0xf471, %rsi
lea addresses_WT_ht+0x6f9, %rdi
nop
nop
nop
add $58757, %r9
...
nop
and %rsi, %rsi
lea addresses_normal_ht+0x5811, %rax
sub $842, %rdi
movw $0x6162, (%rax)
nop
nop
...
nop
dec %rbp
lea addresses_A_ht+0x1d4fd, %rcx
nop
nop
nop
nop
...
nop
and $20009, %rax
lea addresses_WT_ht+0x13891, %r9
and $20820, %rdi
movw $0x6162, (%r9)
nop
nop
xor %rcx, %rcx
lea addresses_A_ht+0xe951, %rsi
lea addresses_UC_ht+0x1e991, %rdi
clflush (%rdi)
nop
nop
cmp $959, %r14
...
{'OP': 'LOAD', 'src': {'type': 'addresses_RW', 'AVXalign': False, 'congruent': 10, 'size': 32, 'same': False, 'NT': False}}
[Faulty Load]
