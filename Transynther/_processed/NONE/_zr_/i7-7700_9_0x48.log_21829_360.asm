...
push %rdi
push %rsi
lea addresses_WC_ht+0xbcef, %r12
cmp $5338, %rbx
movw $0x6162, (%r12)
nop
nop
nop
sub %r8, %r8
lea addresses_A_ht+0x19ea, %rax
sub $4343, %r9
mov $0x6162636465666768, %r14
movq %r14, %xmm0
movups %xmm0, (%rax)
and %r12, %r12
lea addresses_normal_ht+0x162ca, %rsi
lea addresses_WT_ht+0x1540a, %rdi
nop
nop
nop
add %rax, %rax
...
nop
cmp %rax, %rax
lea addresses_UC_ht+0x1e1ea, %rcx
nop
nop
nop
nop
...
nop
xor %rsi, %rsi
lea addresses_D_ht+0x17f0a, %rbx
nop
nop
cmp %rcx, %rcx
movb (%rbx), %r14b
nop
dec %rsi
lea addresses_UC_ht+0x1e8a, %rax
nop
nop
nop
nop
...
nop
and $8484, %rsi
lea addresses_UC_ht+0x1ab0a, %rdi
clflush (%rdi)
nop
nop
nop
...
nop
xor $31691, %r9
lea addresses_WT_ht+0x18c94, %rsi
lea addresses_WC_ht+0x19f0a, %rdi
nop
nop
nop
nop
...
nop
sub $10457, %rax
lea addresses_WT_ht+0x6d64, %rsi
lea addresses_A_ht+0x19e0a, %rdi
nop
nop
nop
nop
...
nop
dec %rcx
lea addresses_A_ht+0x1a39a, %rax
nop
nop
cmp %r12, %r12
...
nop
xor $61641, %r12
lea addresses_UC_ht+0x6ef2, %r12
nop
sub %rbx, %rbx
mov (%r12), %cx
nop
...
nop
sub %rax, %rax
lea addresses_WC_ht+0x19a9a, %r12
nop
and %r8, %r8
mov $0x6162636465666768, %r14
movq %r14, %xmm2
...
nop
and $49821, %rbx
lea addresses_WT_ht+0x1650a, %r12
clflush (%r12)
sub $45997, %r9
mov (%r12), %si
nop
...
<gen_prepare_buffer>
{'OP': 'STOR', 'dst': {'type': 'addresses_WC_ht', 'AVXalign': False, 'congruent': 0, 'size': 2, 'same': True, 'NT': False}}
{'OP': 'STOR', 'dst': {'type': 'addresses_A_ht', 'AVXalign': False, 'congruent': 5, 'size': 16, 'same': False, 'NT': False}}
{'OP': 'REPM', 'src': {'type': 'addresses_normal_ht', 'congruent': 3, 'same': False}, 'dst': {'type': 'addresses_WT_ht', 'congruent': 8, 'same': False}}
...
{'OP': 'REPM', 'src': {'type': 'addresses_WT_ht', 'congruent': 0, 'same': False}, 'dst': {'type': 'addresses_A_ht', 'congruent': 8, 'same': False}}
{'OP': 'LOAD', 'src': {'type': 'addresses_A_ht', 'AVXalign': False, 'congruent': 2, 'size': 32, 'same': False, 'NT': True}}
