...
nop
inc %r15
lea addresses_WT_ht+0x2f9c, %rsi
lea addresses_A_ht+0x734, %rdi
nop
nop
dec %r11
mov $30, %rcx
...
nop
dec %rdi
lea addresses_normal_ht+0xcf9c, %r14
nop
nop
nop
nop
...
nop
xor %r14, %r14
lea addresses_D_ht+0x79c, %rsi
lea addresses_A_ht+0x13cb0, %rdi
nop
nop
nop
cmp %rdx, %rdx
...
nop
xor %r14, %r14
lea addresses_normal_ht+0x16eef, %r11
xor %rcx, %rcx
movb (%r11), %r15b
nop
nop
...
nop
add $34584, %rdi
lea addresses_WT_ht+0x40d7, %rsi
lea addresses_A_ht+0x8e1c, %rdi
nop
nop
nop
nop
...
nop
cmp %rsi, %rsi
lea addresses_WT_ht+0x13b9c, %r11
clflush (%r11)
add $58997, %rdx
movups (%r11), %xmm7
vpextrq $1, %xmm7, %rcx
and $52392, %rdi
lea addresses_A_ht+0x1423c, %r11
nop
nop
nop
nop
...
{'OP': 'REPM', 'src': {'type': 'addresses_WT_ht', 'congruent': 11, 'same': False}, 'dst': {'type': 'addresses_A_ht', 'congruent': 3, 'same': False}}
{'OP': 'LOAD', 'src': {'type': 'addresses_D_ht', 'AVXalign': False, 'congruent': 10, 'size': 1, 'same': False, 'NT': False}}
{'OP': 'LOAD', 'src': {'type': 'addresses_normal_ht', 'AVXalign': True, 'congruent': 7, 'size': 2, 'same': False, 'NT': False}}
