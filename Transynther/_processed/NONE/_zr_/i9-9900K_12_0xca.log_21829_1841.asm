...
nop
add %r10, %r10
lea addresses_WC_ht+0x11bc1, %r9
nop
xor %r14, %r14
movb $0x61, (%r9)
nop
dec %r10
lea addresses_D_ht+0x2068, %r13
nop
nop
nop
nop
...
nop
cmp $43175, %r13
lea addresses_A_ht+0xc519, %r10
nop
dec %r12
movl $0x61626364, (%r10)
nop
sub %r10, %r10
lea addresses_UC_ht+0x1b119, %rsi
lea addresses_A_ht+0x7bf1, %rdi
nop
nop
add $51342, %r9
mov $31, %rcx
...
nop
sub $17462, %rbx
lea addresses_WC_ht+0xf519, %r14
nop
and %rcx, %rcx
...
{'OP': 'REPM', 'src': {'same': False, 'type': 'addresses_UC_ht', 'congruent': 7}, 'dst': {'same': False, 'type': 'addresses_A_ht', 'congruent': 3}}
{'OP': 'LOAD', 'src': {'size': 16, 'NT': True, 'type': 'addresses_WC_ht', 'same': True, 'AVXalign': False, 'congruent': 10}}
{'00': 21829}
