...
push %rdx
push %rsi
lea addresses_UC_ht+0x12f4a, %r8
nop
nop
nop
nop
...
vpextrq $0, %xmm7, %rdx
and %r14, %r14
lea addresses_WC_ht+0x472e, %r14
xor %r12, %r12
mov (%r14), %bp
nop
nop
...
nop
add %r12, %r12
lea addresses_A_ht+0x1837e, %rsi
...
nop
sub $4957, %rdx
lea addresses_D_ht+0x14eae, %rsi
lea addresses_WT_ht+0xc5ab, %rdi
nop
add $15107, %r12
mov $5, %rcx
rep movsl
...
nop
cmp %r12, %r12
lea addresses_WT_ht+0x1288d, %rsi
lea addresses_A_ht+0x13f9e, %rdi
clflush (%rdi)
nop
and $20168, %r12
mov $33, %rcx
...
nop
add $19786, %r12
lea addresses_WT_ht+0x9a52, %rsi
nop
nop
nop
nop
...
nop
dec %r14
lea addresses_WT_ht+0x6f6e, %r14
nop
nop
nop
nop
...
rep movsq
cmp %rbp, %rbp
lea addresses_UC_ht+0x10f1e, %r12
nop
nop
nop
nop
...
nop
cmp $4921, %r8
lea addresses_normal_ht+0x1911e, %r12
nop
nop
nop
nop
...
{'OP': 'STOR', 'dst': {'type': 'addresses_US', 'AVXalign': False, 'congruent': 7, 'size': 2, 'same': False, 'NT': False}}
...
<gen_prepare_buffer>
{'OP': 'LOAD', 'src': {'type': 'addresses_UC_ht', 'AVXalign': False, 'congruent': 2, 'size': 32, 'same': True, 'NT': True}}
{'OP': 'LOAD', 'src': {'type': 'addresses_WC_ht', 'AVXalign': False, 'congruent': 4, 'size': 2, 'same': False, 'NT': False}}
{'OP': 'REPM', 'src': {'type': 'addresses_A_ht', 'congruent': 5, 'same': False}, 'dst': {'type': 'addresses_A_ht', 'congruent': 6, 'same': False}}
