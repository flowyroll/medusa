...
lea addresses_normal_ht+0x1e7e1, %rdi
xor $52700, %r9
mov $91, %rcx
rep movsw
nop
...
nop
lfence
lea addresses_UC_ht+0x81c5, %rcx
nop
nop
nop
xor $24585, %rdi
...
movq %rcx, (%r9)
add $46644, %rsi
lea addresses_A_ht+0x1b05, %rsi
lea addresses_UC_ht+0x1828b, %rdi
nop
inc %r13
mov $75, %rcx
rep movsl
nop
inc %rsi
lea addresses_WC_ht+0x181c5, %rbx
nop
nop
nop
nop
...
{'src': {'congruent': 11, 'AVXalign': False, 'same': False, 'size': 32, 'NT': False, 'type': 'addresses_WC'}, 'OP': 'LOAD'}
...
{'src': {'congruent': 10, 'same': False, 'type': 'addresses_A_ht'}, 'OP': 'REPM', 'dst': {'congruent': 1, 'same': False, 'type': 'addresses_UC_ht'}}
