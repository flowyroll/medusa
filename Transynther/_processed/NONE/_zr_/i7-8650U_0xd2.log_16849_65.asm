...
nop
cmp $48881, %r15
lea addresses_WC_ht+0x11738, %rsi
lea addresses_WT_ht+0x1e458, %rdi
nop
nop
nop
sub %r13, %r13
...
nop
add $2957, %rdi
lea addresses_normal_ht+0x19058, %rsi
nop
nop
nop
nop
...
mov (%rsi), %ecx
xor $8331, %rdi
lea addresses_WT_ht+0xd458, %rbx
nop
nop
nop
nop
...
nop
mfence
lea addresses_WC_ht+0x1a58, %rsi
nop
nop
nop
nop
...
nop
and $42286, %rcx
lea addresses_D_ht+0x13658, %rcx
add %rbx, %rbx
movb $0x61, (%rcx)
nop
nop
...
nop
and $3830, %rbx
lea addresses_normal_ht+0x2e58, %rsi
lea addresses_A_ht+0xc9ce, %rdi
clflush (%rsi)
nop
nop
nop
...
nop
add %rbp, %rbp
lea addresses_normal_ht+0x7658, %rsi
lea addresses_WT_ht+0x17458, %rdi
nop
nop
cmp %r14, %r14
mov $49, %rcx
...
nop
add %rdi, %rdi
lea addresses_WC_ht+0x17098, %rsi
lea addresses_normal_ht+0x427e, %rdi
nop
nop
nop
nop
...
nop
dec %rdi
lea addresses_normal_ht+0x16dd8, %r15
nop
nop
nop
nop
...
{'OP': 'REPM', 'src': {'type': 'addresses_WC_ht', 'congruent': 5, 'same': False}, 'dst': {'type': 'addresses_WT_ht', 'congruent': 10, 'same': False}}
