...
push %rdx
push %rsi
lea addresses_normal_ht+0x148, %r11
nop
nop
nop
nop
...
nop
xor %r10, %r10
lea addresses_normal_ht+0x19888, %r10
nop
nop
and %rdx, %rdx
mov (%r10), %esi
sub $27481, %r11
lea addresses_UC_ht+0x6508, %r11
cmp $32212, %rcx
movl $0x61626364, (%r11)
nop
nop
...
nop
sub %rdx, %rdx
lea addresses_WT_ht+0x164f0, %rcx
nop
nop
nop
xor %r8, %r8
...
nop
dec %rsi
lea addresses_WT_ht+0x124c8, %rsi
lea addresses_UC_ht+0x6c88, %rdi
nop
add $37247, %r11
mov $0, %rcx
rep movsl
...
nop
add $4824, %r10
lea addresses_normal_ht+0x84ce, %rdx
nop
nop
nop
nop
...
nop
and %r11, %r11
lea addresses_normal_ht+0x18cee, %rsi
...
nop
xor %r11, %r11
lea addresses_D_ht+0x16c58, %rsi
nop
dec %r10
mov (%rsi), %rdi
nop
...
nop
and %rdi, %rdi
lea addresses_normal_ht+0x6a18, %r11
nop
nop
nop
cmp $1163, %r10
...
nop
and %rsi, %rsi
lea addresses_D_ht+0x116f8, %rsi
lea addresses_normal_ht+0xae68, %rdi
nop
cmp %r8, %r8
mov $103, %rcx
rep movsq
...
nop
cmp $45524, %r14
lea addresses_WT_ht+0xce88, %r11
sub $39219, %rsi
movb (%r11), %r14b
cmp %r8, %r8
pop %rsi
...
{'OP': 'REPM', 'src': {'type': 'addresses_WT_ht', 'congruent': 6, 'same': False}, 'dst': {'type': 'addresses_UC_ht', 'congruent': 7, 'same': False}}
