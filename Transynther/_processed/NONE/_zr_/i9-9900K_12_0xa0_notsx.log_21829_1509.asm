...
push %rdi
push %rsi
lea addresses_UC_ht+0xf3dd, %rsi
lea addresses_A_ht+0x239d, %rdi
nop
xor $19236, %r12
mov $46, %rcx
rep movsb
cmp %r9, %r9
lea addresses_WC_ht+0x4dfd, %rsi
lea addresses_D_ht+0xb4dd, %rdi
cmp %r13, %r13
mov $14, %rcx
rep movsb
nop
...
nop
cmp %r12, %r12
lea addresses_normal_ht+0x501b, %r9
xor %r8, %r8
mov $0x6162636465666768, %rsi
movq %rsi, %xmm2
vmovups %ymm2, (%r9)
and $20195, %r9
lea addresses_WC_ht+0x18b95, %rsi
lea addresses_WT_ht+0xfddd, %rdi
nop
nop
nop
nop
...
// Store
lea addresses_normal+0x1113d, %rdi
nop
nop
nop
and $39537, %r14
...
// Store
lea addresses_normal+0x15bf5, %rdi
nop
dec %r13
movw $0x5152, (%rdi)
nop
