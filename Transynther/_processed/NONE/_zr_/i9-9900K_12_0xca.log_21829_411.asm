...
nop
inc %rsi
lea addresses_normal_ht+0x1ed23, %rsi
...
lea addresses_WC_ht+0x378a, %rdi
clflush (%rdi)
nop
nop
nop
...
nop
dec %r14
lea addresses_D_ht+0x1ea1, %r13
nop
mfence
mov (%r13), %esi
cmp $9167, %r8
lea addresses_WT_ht+0xa823, %rsi
lea addresses_D_ht+0x9923, %rdi
xor $60765, %rdx
mov $9, %rcx
rep movsw
nop
...
movups %xmm0, (%rsi)
add $11815, %r8
lea addresses_UC_ht+0x13d63, %r8
nop
and $27914, %rcx
...
nop
xor %r14, %r14
lea addresses_normal_ht+0x1ea63, %rcx
nop
nop
nop
nop
...
{'OP': 'STOR', 'dst': {'size': 2, 'NT': False, 'type': 'addresses_A', 'same': False, 'AVXalign': True, 'congruent': 2}}
...
{'OP': 'REPM', 'src': {'same': True, 'type': 'addresses_normal_ht', 'congruent': 9}, 'dst': {'same': True, 'type': 'addresses_D_ht', 'congruent': 8}}
{'OP': 'REPM', 'src': {'same': False, 'type': 'addresses_normal_ht', 'congruent': 6}, 'dst': {'same': False, 'type': 'addresses_D_ht', 'congruent': 0}}
{'OP': 'REPM', 'src': {'same': False, 'type': 'addresses_A_ht', 'congruent': 1}, 'dst': {'same': False, 'type': 'addresses_WC_ht', 'congruent': 0}}
{'OP': 'LOAD', 'src': {'size': 4, 'NT': False, 'type': 'addresses_D_ht', 'same': False, 'AVXalign': False, 'congruent': 0}}
{'OP': 'REPM', 'src': {'same': False, 'type': 'addresses_WT_ht', 'congruent': 7}, 'dst': {'same': False, 'type': 'addresses_D_ht', 'congruent': 9}}
