...
push %rdx
push %rsi
lea addresses_normal_ht+0xdb4a, %rdi
cmp $47854, %rbp
movw $0x6162, (%rdi)
nop
nop
dec %r14
lea addresses_D_ht+0x18b4a, %rax
nop
dec %rbx
...
movl $0x61626364, (%rbx)
dec %r13
lea addresses_WT_ht+0x15faa, %rsi
lea addresses_UC_ht+0x4b8a, %rdi
clflush (%rsi)
nop
nop
xor %rbx, %rbx
