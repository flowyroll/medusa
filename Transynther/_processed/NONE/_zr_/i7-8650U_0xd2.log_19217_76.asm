...
push %rdi
push %rsi
lea addresses_WT_ht+0x1b476, %rsi
lea addresses_UC_ht+0x1b6d4, %rdi
nop
nop
add $60965, %r13
mov $59, %rcx
rep movsw
add $29853, %rdi
lea addresses_WC_ht+0x11af6, %r15
nop
nop
nop
nop
...
nop
cmp $43424, %r15
lea addresses_UC_ht+0x15ef6, %rcx
nop
nop
nop
nop
...
nop
cmp $17653, %rbx
lea addresses_D_ht+0x116, %rsi
lea addresses_WT_ht+0x1dbf6, %rdi
xor %rbp, %rbp
mov $107, %rcx
rep movsq
nop
nop
lfence
lea addresses_WC_ht+0x1276, %rcx
nop
nop
add $25222, %rsi
