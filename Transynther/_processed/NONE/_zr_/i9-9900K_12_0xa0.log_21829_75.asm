...
push %rdi
push %rsi
lea addresses_normal_ht+0xe307, %r15
nop
nop
nop
xor $7320, %rcx
...
nop
xor %rdi, %rdi
lea addresses_UC_ht+0xadd5, %rsi
lea addresses_A_ht+0x17635, %rdi
and $47671, %r10
mov $119, %rcx
rep movsq
nop
...
nop
cmp $2063, %rsi
lea addresses_UC_ht+0x3555, %rbx
cmp %rbp, %rbp
...
movntdq %xmm0, (%rbx)
cmp %rdi, %rdi
lea addresses_UC_ht+0x3dd5, %rcx
nop
nop
dec %r15
movb $0x61, (%rcx)
...
nop
and $7516, %r10
lea addresses_A_ht+0x14dd5, %r15
nop
add %rdi, %rdi
movups (%r15), %xmm2
vpextrq $1, %xmm2, %r10
...
nop
and $3436, %rbx
lea addresses_A_ht+0x1b55, %rsi
lea addresses_UC_ht+0x702d, %rdi
nop
nop
cmp %rax, %rax
mov $18, %rcx
...
lea addresses_UC_ht+0x6e35, %rdi
inc %r15
mov $92, %rcx
rep movsw
nop
...
nop
sub $35837, %r10
lea addresses_normal_ht+0xc8a5, %r15
cmp %rbx, %rbx
mov $0x6162636465666768, %rsi
movq %rsi, (%r15)
add $49998, %rbx
lea addresses_WT_ht+0x16f78, %rsi
lea addresses_WC_ht+0x1e9d5, %rdi
nop
nop
nop
and %rax, %rax
...
nop
add $11597, %rcx
lea addresses_WC_ht+0x15699, %r10
nop
inc %rcx
movb (%r10), %al
nop
...
nop
cmp %rbp, %rbp
lea addresses_WC_ht+0xe085, %rsi
lea addresses_A_ht+0x181d5, %rdi
nop
nop
nop
add $22401, %rax
...
nop
add $57070, %r15
lea addresses_WT_ht+0x16dd5, %rsi
lea addresses_normal_ht+0x19ac8, %rdi
cmp %r10, %r10
mov $2, %rcx
rep movsb
nop
...
{'src': {'same': False, 'congruent': 11, 'type': 'addresses_UC_ht'}, 'OP': 'REPM', 'dst': {'same': False, 'congruent': 4, 'type': 'addresses_A_ht'}}
{'OP': 'STOR', 'dst': {'NT': True, 'same': False, 'congruent': 6, 'type': 'addresses_UC_ht', 'AVXalign': False, 'size': 16}}
...
{'src': {'same': False, 'congruent': 5, 'type': 'addresses_D_ht'}, 'OP': 'REPM', 'dst': {'same': True, 'congruent': 4, 'type': 'addresses_UC_ht'}}
{'OP': 'STOR', 'dst': {'NT': False, 'same': False, 'congruent': 4, 'type': 'addresses_normal_ht', 'AVXalign': False, 'size': 8}}
{'src': {'same': False, 'congruent': 0, 'type': 'addresses_WT_ht'}, 'OP': 'REPM', 'dst': {'same': False, 'congruent': 9, 'type': 'addresses_WC_ht'}}
...
{'src': {'same': False, 'congruent': 3, 'type': 'addresses_WC_ht'}, 'OP': 'REPM', 'dst': {'same': False, 'congruent': 6, 'type': 'addresses_A_ht'}}
