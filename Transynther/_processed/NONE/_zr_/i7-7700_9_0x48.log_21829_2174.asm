...
push %rdi
push %rsi
lea addresses_D_ht+0xfdcc, %rsi
lea addresses_normal_ht+0x107ec, %rdi
clflush (%rsi)
nop
dec %rbx
mov $30, %rcx
...
nop
cmp $4770, %rbx
lea addresses_A_ht+0x1ac94, %rsi
lea addresses_UC_ht+0x10a4c, %rdi
nop
and $52577, %r12
mov $53, %rcx
rep movsl
...
nop
add $45673, %rcx
lea addresses_D_ht+0x139ec, %rsi
lea addresses_normal_ht+0xf598, %rdi
nop
and $20098, %r13
mov $37, %rcx
rep movsl
nop
sub %rcx, %rcx
lea addresses_UC_ht+0x1d2c4, %rsi
lea addresses_D_ht+0x61b4, %rdi
nop
nop
nop
sub $22855, %r10
...
rep movsq
inc %rcx
lea addresses_WC_ht+0x1d93c, %r10
nop
nop
nop
nop
...
vpextrq $1, %xmm5, %r13
and $43898, %rdi
lea addresses_WT_ht+0x4ecc, %r12
cmp $50968, %rdi
...
nop
and %rbx, %rbx
lea addresses_D_ht+0x19aac, %r13
cmp $39909, %r10
movl $0x61626364, (%r13)
nop
nop
...
nop
inc %r13
lea addresses_normal_ht+0x1ab2c, %r13
nop
nop
nop
nop
...
nop
inc %rdi
lea addresses_UC_ht+0x13bcc, %rdi
nop
nop
nop
cmp $35294, %rcx
...
nop
xor %r10, %r10
lea addresses_WT_ht+0xfdcc, %rsi
nop
nop
add $39083, %r12
mov (%rsi), %r10d
...
nop
cmp %r12, %r12
lea addresses_WC_ht+0x11fcc, %rsi
cmp $41360, %r10
vmovups (%rsi), %ymm1
...
nop
mfence
lea addresses_WT_ht+0x654c, %rsi
lea addresses_normal_ht+0xce4c, %rdi
clflush (%rdi)
nop
nop
xor $36431, %r12
...
rep movsw
add %r10, %r10
lea addresses_WC_ht+0x1efcc, %rbx
nop
nop
inc %rsi
mov (%rbx), %r12d
...
{'OP': 'REPM', 'src': {'type': 'addresses_A_ht', 'congruent': 1, 'same': False}, 'dst': {'type': 'addresses_UC_ht', 'congruent': 7, 'same': True}}
...
{'OP': 'LOAD', 'src': {'type': 'addresses_WC_ht', 'AVXalign': True, 'congruent': 11, 'size': 4, 'same': True, 'NT': False}}
{'00': 21829}
