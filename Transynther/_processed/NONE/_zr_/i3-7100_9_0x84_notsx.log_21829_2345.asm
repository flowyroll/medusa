...
push %rdx
push %rsi
lea addresses_WC_ht+0x1cd4c, %rsi
lea addresses_WT_ht+0x173ec, %rdi
clflush (%rdi)
nop
nop
nop
...
nop
sub $51520, %r15
lea addresses_A_ht+0x1b38c, %rsi
lea addresses_A_ht+0x1a38c, %rdi
clflush (%rdi)
nop
nop
and $61373, %rdx
...
nop
dec %rcx
lea addresses_A_ht+0xcb9f, %r14
sub %r13, %r13
movb (%r14), %dl
nop
cmp %r15, %r15
lea addresses_normal_ht+0x16e4c, %rsi
lea addresses_WT_ht+0x12d8c, %rdi
clflush (%rdi)
nop
nop
nop
...
nop
add $21772, %rdi
lea addresses_normal_ht+0x10788, %r13
nop
nop
nop
nop
...
nop
inc %rsi
lea addresses_normal_ht+0x1b8c, %rsi
lea addresses_WT_ht+0x578c, %rdi
nop
nop
and %r15, %r15
mov $79, %rcx
...
nop
and %r9, %r9
lea addresses_WT_ht+0x18d92, %r9
and $10220, %rdx
...
lea addresses_WT_ht+0x12b8c, %rdi
nop
nop
nop
nop
...
nop
sub %rcx, %rcx
lea addresses_UC_ht+0x29e4, %r13
clflush (%r13)
nop
nop
nop
...
{'src': {'type': 'addresses_A_ht', 'congruent': 11, 'same': True}, 'dst': {'type': 'addresses_A_ht', 'congruent': 10, 'same': False}, 'OP': 'REPM'}
...
{'src': {'type': 'addresses_normal_ht', 'congruent': 11, 'same': True}, 'dst': {'type': 'addresses_WT_ht', 'congruent': 9, 'same': False}, 'OP': 'REPM'}
