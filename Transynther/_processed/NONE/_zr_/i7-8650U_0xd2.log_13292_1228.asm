...
nop
add $9511, %rax
lea addresses_normal_ht+0x13679, %rax
nop
nop
nop
nop
...
nop
sub $31922, %rcx
lea addresses_WC_ht+0x1b921, %rcx
nop
nop
nop
nop
...
nop
add %r10, %r10
lea addresses_WT_ht+0x13039, %rsi
lea addresses_normal_ht+0x13699, %rdi
cmp %r12, %r12
mov $88, %rcx
rep movsl
nop
...
nop
xor $9075, %rsi
lea addresses_A_ht+0x1e599, %rax
nop
and %rcx, %rcx
mov (%rax), %r12w
nop
...
nop
cmp $45703, %rax
lea addresses_D_ht+0xa999, %rsi
lea addresses_A_ht+0x1d099, %rdi
nop
inc %r15
mov $95, %rcx
rep movsb
...
nop
cmp $18342, %r9
lea addresses_D_ht+0x12639, %rcx
nop
nop
nop
nop
...
nop
and %r12, %r12
lea addresses_WT_ht+0x1a119, %rdi
nop
and $1672, %r10
movl $0x61626364, (%rdi)
nop
...
nop
cmp %r15, %r15
lea addresses_WC_ht+0x17459, %r9
nop
inc %rsi
movb (%r9), %r15b
add %r9, %r9
lea addresses_D_ht+0x17399, %r12
nop
nop
nop
nop
...
nop
cmp $45729, %rax
lea addresses_WT_ht+0x140b1, %r10
clflush (%r10)
nop
nop
nop
...
vpextrq $0, %xmm5, %rsi
inc %rdi
lea addresses_UC_ht+0x15e01, %rsi
lea addresses_WC_ht+0x17b99, %rdi
nop
nop
and $11539, %r9
mov $66, %rcx
