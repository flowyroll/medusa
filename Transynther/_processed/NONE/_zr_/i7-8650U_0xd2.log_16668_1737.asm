...
nop
cmp %rbp, %rbp
lea addresses_UC_ht+0x1229d, %rsi
lea addresses_normal_ht+0x1eadd, %rdi
nop
nop
nop
sub $34265, %r8
...
lea addresses_WT_ht+0x19c9d, %rdi
nop
lfence
mov $31, %rcx
rep movsb
and $17344, %rsi
lea addresses_normal_ht+0x1c9d, %r13
nop
dec %r8
mov (%r13), %bp
nop
nop
xor $60080, %rsi
lea addresses_WC_ht+0x1a21d, %r8
nop
nop
cmp %r13, %r13
...
movups %xmm1, (%r8)
inc %r13
lea addresses_UC_ht+0x1481d, %rbp
nop
nop
nop
nop
...
nop
and $2918, %rbp
lea addresses_UC_ht+0x88ed, %rcx
nop
add $4248, %r15
...
nop
sub $38116, %rdi
lea addresses_D_ht+0x13a9d, %rdx
clflush (%rdx)
nop
nop
nop
...
<gen_prepare_buffer>
{'OP': 'LOAD', 'src': {'type': 'addresses_WC_ht', 'size': 2, 'AVXalign': True, 'NT': True, 'congruent': 3, 'same': False}}
{'OP': 'LOAD', 'src': {'type': 'addresses_UC_ht', 'size': 4, 'AVXalign': False, 'NT': False, 'congruent': 8, 'same': False}}
{'OP': 'REPM', 'src': {'type': 'addresses_UC_ht', 'congruent': 8, 'same': False}, 'dst': {'type': 'addresses_normal_ht', 'congruent': 0, 'same': False}}
