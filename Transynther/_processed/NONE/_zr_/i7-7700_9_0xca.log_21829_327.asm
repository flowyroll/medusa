...
push %rdi
push %rsi
lea addresses_A_ht+0x15ad, %rsi
lea addresses_A_ht+0x1621d, %rdi
nop
nop
nop
nop
...
nop
lfence
lea addresses_normal_ht+0xef5d, %r12
nop
nop
nop
cmp %r13, %r13
...
nop
add %rdi, %rdi
lea addresses_WT_ht+0x18d79, %r15
nop
nop
nop
cmp %r8, %r8
...
nop
add $3570, %rdi
lea addresses_A_ht+0x12a1d, %r12
nop
add %r8, %r8
...
{'OP': 'STOR', 'dst': {'congruent': 4, 'AVXalign': True, 'same': False, 'size': 4, 'NT': True, 'type': 'addresses_P'}}
...
<gen_prepare_buffer>
{'src': {'congruent': 2, 'same': False, 'type': 'addresses_A_ht'}, 'OP': 'REPM', 'dst': {'congruent': 10, 'same': False, 'type': 'addresses_A_ht'}}
...
{'src': {'congruent': 10, 'AVXalign': True, 'same': False, 'size': 32, 'NT': False, 'type': 'addresses_A_ht'}, 'OP': 'LOAD'}
{'00': 21829}
