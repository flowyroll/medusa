...
movl $0x61626364, (%r10)
xor %r8, %r8
lea addresses_UC_ht+0x1b00c, %rsi
lea addresses_normal_ht+0x17e38, %rdi
cmp $23163, %r8
mov $114, %rcx
rep movsw
nop
...
nop
cmp %rsi, %rsi
lea addresses_D_ht+0x1358c, %rsi
clflush (%rsi)
nop
and %r12, %r12
...
nop
add $38974, %rsi
lea addresses_WT_ht+0xf81c, %rsi
lea addresses_A_ht+0x6854, %rdi
clflush (%rdi)
nop
nop
cmp %r9, %r9
...
nop
add $41274, %rsi
lea addresses_WC_ht+0xe35c, %rdi
nop
sub %r12, %r12
movb (%rdi), %r10b
nop
nop
inc %rcx
lea addresses_normal_ht+0x11993, %r8
xor %rcx, %rcx
mov (%r8), %r10d
xor %rax, %rax
lea addresses_normal_ht+0x10a8c, %rax
nop
nop
nop
sub %r8, %r8
