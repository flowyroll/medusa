...
nop
xor %rcx, %rcx
lea addresses_WT_ht+0x689f, %rsi
lea addresses_UC_ht+0x8b9f, %rdi
nop
nop
nop
dec %rdx
...
nop
and $8291, %r15
lea addresses_A_ht+0x1dad1, %rsi
...
nop
add $41402, %r15
lea addresses_WT_ht+0x1a17b, %r15
sub %r8, %r8
...
nop
and $39684, %rsi
lea addresses_WT_ht+0xeae7, %rcx
nop
nop
nop
nop
