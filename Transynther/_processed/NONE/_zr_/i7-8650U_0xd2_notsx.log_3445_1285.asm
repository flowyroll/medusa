...
push %r9
push %rdi
lea addresses_normal_ht+0x1b518, %r15
nop
nop
inc %rdi
movb (%r15), %r9b
...
// REPMOV
lea addresses_WC+0x1f410, %rsi
lea addresses_WC+0x1f410, %rdi
nop
cmp %r11, %r11
mov $122, %rcx
rep movsl
...
{'OP': 'REPM', 'src': {'type': 'addresses_WC', 'congruent': 0, 'same': True}, 'dst': {'type': 'addresses_WC', 'congruent': 0, 'same': True}}
[Faulty Load]
