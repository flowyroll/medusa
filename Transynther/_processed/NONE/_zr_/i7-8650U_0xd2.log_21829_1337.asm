...
push %rdx
push %rsi
lea addresses_WT_ht+0x162ad, %rsi
lea addresses_WT_ht+0x192ad, %rdi
nop
and %rax, %rax
mov $42, %rcx
rep movsb
nop
sub %rbx, %rbx
lea addresses_normal_ht+0x4ead, %r12
nop
dec %rsi
mov (%r12), %ax
nop
...
nop
inc %r12
lea addresses_D_ht+0x1aaad, %rdi
nop
nop
nop
nop
...
nop
dec %rdi
lea addresses_A_ht+0x15a32, %rsi
lea addresses_UC_ht+0x14095, %rdi
nop
xor %r11, %r11
mov $97, %rcx
rep movsq
...
lea addresses_WC_ht+0x175ad, %rdi
nop
nop
nop
and %rdx, %rdx
...
rep movsw
cmp $21824, %r12
lea addresses_normal_ht+0xc3ad, %r11
nop
nop
nop
nop
...
nop
xor $64439, %r12
lea addresses_normal_ht+0x1eacd, %rsi
...
rep movsq
inc %rdi
lea addresses_D_ht+0x12b0d, %r11
nop
nop
xor $16966, %r12
mov (%r11), %di
...
nop
inc %rdi
lea addresses_D_ht+0x149bd, %rsi
lea addresses_normal_ht+0xf56d, %rdi
nop
cmp %rax, %rax
mov $65, %rcx
rep movsl
...
nop
cmp %rcx, %rcx
lea addresses_WT_ht+0xe1dd, %rsi
lea addresses_normal_ht+0x38bd, %rdi
xor $35202, %r12
mov $99, %rcx
rep movsw
sub $40884, %rax
lea addresses_UC_ht+0x1dc9b, %rsi
lea addresses_D_ht+0x3f0, %rdi
nop
nop
nop
nop
...
nop
xor %r11, %r11
lea addresses_WT_ht+0x5aad, %rsi
lea addresses_UC_ht+0xeef2, %rdi
nop
nop
nop
nop
...
nop
add $64259, %rdx
lea addresses_WT_ht+0x616d, %r11
xor $4259, %rdx
...
nop
inc %r12
lea addresses_normal_ht+0x1456d, %rsi
lea addresses_A_ht+0x52ad, %rdi
clflush (%rdi)
nop
nop
nop
...
{'OP': 'LOAD', 'src': {'type': 'addresses_normal_ht', 'size': 2, 'AVXalign': True, 'NT': False, 'congruent': 10, 'same': False}}
...
{'OP': 'REPM', 'src': {'type': 'addresses_UC_ht', 'congruent': 9, 'same': False}, 'dst': {'type': 'addresses_WC_ht', 'congruent': 8, 'same': False}}
...
{'OP': 'REPM', 'src': {'type': 'addresses_D_ht', 'congruent': 3, 'same': False}, 'dst': {'type': 'addresses_normal_ht', 'congruent': 6, 'same': False}}
