...
push %rdx
push %rsi
lea addresses_WT_ht+0x1001e, %rsi
lea addresses_UC_ht+0x14fa6, %rdi
clflush (%rsi)
cmp %r15, %r15
mov $20, %rcx
rep movsb
...
nop
xor %rbp, %rbp
lea addresses_A_ht+0xf85e, %rax
cmp %r9, %r9
mov (%rax), %esi
xor $674, %rsi
lea addresses_A_ht+0xfc1e, %rax
nop
and $23231, %r15
...
nop
cmp $24870, %rsi
lea addresses_UC_ht+0x821e, %rsi
...
rep movsw
xor $20435, %rbp
lea addresses_WC_ht+0x777e, %rcx
nop
nop
nop
mfence
...
<gen_prepare_buffer>
{'OP': 'REPM', 'src': {'type': 'addresses_WT_ht', 'congruent': 9, 'same': False}, 'dst': {'type': 'addresses_UC_ht', 'congruent': 3, 'same': True}}
