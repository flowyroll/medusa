...
push %rdi
push %rsi
lea addresses_A_ht+0x6a8e, %rsi
lea addresses_WT_ht+0xa50e, %rdi
nop
nop
nop
nop
...
nop
inc %rbp
lea addresses_UC_ht+0x4c8e, %rsi
lea addresses_WC_ht+0x7a8e, %rdi
sub $53811, %r8
mov $68, %rcx
rep movsq
nop
nop
sub %rcx, %rcx
lea addresses_normal_ht+0x1c68e, %rsi
lea addresses_UC_ht+0x7c8e, %rdi
nop
and %r14, %r14
mov $94, %rcx
rep movsw
...
nop
cmp %r14, %r14
lea addresses_normal_ht+0x1d026, %r11
nop
and %r8, %r8
...
nop
cmp %r11, %r11
lea addresses_WC_ht+0x43ce, %rsi
...
nop
xor %r11, %r11
lea addresses_WC_ht+0x1285e, %r9
nop
nop
nop
sub $40079, %r14
movl $0x61626364, (%r9)
sub %rbp, %rbp
lea addresses_normal_ht+0x15c8e, %r8
nop
nop
nop
cmp %rsi, %rsi
...
nop
and $8278, %r14
lea addresses_WT_ht+0xbc3e, %rsi
lea addresses_WT_ht+0x18c0e, %rdi
nop
dec %r11
mov $58, %rcx
rep movsq
...
nop
add %r11, %r11
lea addresses_D_ht+0x10c4e, %rdi
nop
nop
nop
nop
...
{'OP': 'REPM', 'src': {'type': 'addresses_WC_ht', 'congruent': 5, 'same': False}, 'dst': {'type': 'addresses_D_ht', 'congruent': 4, 'same': True}}
{'OP': 'LOAD', 'src': {'type': 'addresses_WC_ht', 'size': 1, 'AVXalign': True, 'NT': False, 'congruent': 10, 'same': True}}
