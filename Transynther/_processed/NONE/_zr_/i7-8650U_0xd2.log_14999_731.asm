...
push %rdi
push %rsi
lea addresses_WC_ht+0x1e416, %rdi
add %rbp, %rbp
movb $0x61, (%rdi)
nop
nop
...
nop
and %rdi, %rdi
lea addresses_WT_ht+0xd30e, %rsi
lea addresses_D_ht+0x1850e, %rdi
nop
nop
nop
and $32889, %r12
...
nop
add %rbp, %rbp
lea addresses_normal_ht+0x10ee, %rdi
sub %rsi, %rsi
movb (%rdi), %cl
nop
nop
xor %rcx, %rcx
lea addresses_D_ht+0x7adf, %rcx
clflush (%rcx)
nop
nop
nop
...
nop
add $55932, %r9
lea addresses_normal_ht+0x4d8e, %rsi
lea addresses_WC_ht+0x609e, %rdi
nop
dec %r15
mov $26, %rcx
rep movsb
...
nop
xor %r9, %r9
lea addresses_WT_ht+0x9f0e, %r12
nop
nop
nop
xor %rsi, %rsi
...
nop
sub $832, %rdi
lea addresses_WT_ht+0x1ebce, %rsi
clflush (%rsi)
sub %rdi, %rdi
vmovups (%rsi), %ymm7
...
nop
and %rdi, %rdi
lea addresses_normal_ht+0x7f5a, %rcx
cmp $17213, %r12
movl $0x61626364, (%rcx)
nop
add %rbp, %rbp
lea addresses_A_ht+0x13436, %rsi
lea addresses_normal_ht+0x1670e, %rdi
nop
nop
nop
nop
...
rep movsq
and %r15, %r15
lea addresses_normal_ht+0x1c772, %rsi
lea addresses_WT_ht+0x410e, %rdi
xor $45992, %rbp
mov $96, %rcx
rep movsb
xor $11649, %rsi
...
{'OP': 'LOAD', 'src': {'type': 'addresses_WT_ht', 'size': 32, 'AVXalign': False, 'NT': False, 'congruent': 6, 'same': True}}
