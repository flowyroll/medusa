...
push %rdi
push %rsi
lea addresses_WT_ht+0x1c63e, %r15
nop
nop
and %r8, %r8
movw $0x6162, (%r15)
nop
add %rcx, %rcx
lea addresses_normal_ht+0x164c6, %rsi
lea addresses_WC_ht+0x1eec6, %rdi
clflush (%rdi)
nop
xor $16909, %r15
mov $74, %rcx
...
nop
cmp %rdi, %rdi
lea addresses_UC_ht+0x138c6, %rsi
lea addresses_A_ht+0x118c6, %rdi
nop
nop
xor %r10, %r10
mov $92, %rcx
...
nop
and %rcx, %rcx
lea addresses_UC_ht+0x61c6, %r10
sub %r12, %r12
...
nop
and $59004, %r15
lea addresses_WT_ht+0x26c6, %r10
inc %rcx
...
nop
cmp %rcx, %rcx
lea addresses_WC_ht+0x1cc6, %r12
nop
nop
nop
cmp $8199, %r15
...
nop
add $32331, %r15
lea addresses_WC_ht+0x172d6, %r10
nop
nop
nop
nop
