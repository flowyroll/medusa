...
nop
and $40276, %r8
lea addresses_WT_ht+0x6750, %rsi
lea addresses_normal_ht+0x12db6, %rdi
nop
nop
add $59253, %r12
mov $123, %rcx
...
nop
xor %r12, %r12
lea addresses_D_ht+0x1212e, %r13
sub %rdi, %rdi
mov (%r13), %rcx
nop
nop
...
nop
inc %rsi
lea addresses_WC_ht+0x1c5b6, %rsi
lea addresses_A_ht+0xceb6, %rdi
clflush (%rsi)
nop
inc %rbx
mov $53, %rcx
...
// Store
lea addresses_PSE+0x121b6, %r11
add %r8, %r8
movb $0x51, (%r11)
and %r11, %r11

// Load
lea addresses_A+0x12db6, %rbx
nop
nop
nop
dec %r10
...
{'OP': 'REPM', 'src': {'type': 'addresses_WC_ht', 'congruent': 9, 'same': True}, 'dst': {'type': 'addresses_A_ht', 'congruent': 8, 'same': False}}
{'00': 21829}
