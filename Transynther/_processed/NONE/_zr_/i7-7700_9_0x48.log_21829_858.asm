...
push %rdi
push %rsi
lea addresses_WT_ht+0x934f, %r10
nop
nop
nop
nop
...
nop
xor $33012, %r11
lea addresses_A_ht+0x1e027, %r14
nop
nop
xor %r11, %r11
vmovups (%r14), %ymm2
...
nop
cmp $56664, %r10
lea addresses_WT_ht+0x19ba7, %rcx
add $60285, %rsi
mov (%rcx), %r14w
nop
nop
...
nop
add %r14, %r14
lea addresses_WT_ht+0x12167, %r10
nop
nop
nop
sub $53939, %r14
...
movw $0x6162, (%r14)
xor %r10, %r10
lea addresses_WC_ht+0x193a7, %rsi
lea addresses_A_ht+0x1582f, %rdi
sub %r11, %r11
mov $51, %rcx
rep movsb
nop
...
nop
sub %r14, %r14
lea addresses_A_ht+0x113a7, %r11
nop
nop
nop
nop
...
nop
sub %r8, %r8
lea addresses_D_ht+0x71a7, %rsi
lea addresses_WC_ht+0xd2e7, %rdi
cmp %r10, %r10
mov $45, %rcx
rep movsb
nop
...
nop
sub %r14, %r14
lea addresses_normal_ht+0x147a7, %rdi
nop
nop
nop
nop
...
// Store
lea addresses_normal+0xb627, %r12
inc %rbx
movl $0x51525354, (%r12)
cmp %r15, %r15

// Load
lea addresses_normal+0x18061, %rbx
and %r10, %r10
movb (%rbx), %r12b
nop
cmp $41196, %r12
...
{'OP': 'LOAD', 'src': {'type': 'addresses_A_ht', 'AVXalign': False, 'congruent': 4, 'size': 32, 'same': True, 'NT': False}}
...
{'OP': 'STOR', 'dst': {'type': 'addresses_A_ht', 'AVXalign': False, 'congruent': 3, 'size': 2, 'same': True, 'NT': False}}
{'OP': 'REPM', 'src': {'type': 'addresses_WC_ht', 'congruent': 10, 'same': False}, 'dst': {'type': 'addresses_A_ht', 'congruent': 3, 'same': False}}
{'OP': 'STOR', 'dst': {'type': 'addresses_D_ht', 'AVXalign': False, 'congruent': 7, 'size': 1, 'same': True, 'NT': False}}
{'OP': 'STOR', 'dst': {'type': 'addresses_A_ht', 'AVXalign': False, 'congruent': 11, 'size': 1, 'same': False, 'NT': False}}
{'OP': 'REPM', 'src': {'type': 'addresses_D_ht', 'congruent': 9, 'same': True}, 'dst': {'type': 'addresses_WC_ht', 'congruent': 5, 'same': False}}
