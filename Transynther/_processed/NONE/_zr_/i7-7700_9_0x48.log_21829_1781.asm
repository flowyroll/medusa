...
nop
dec %rdi
lea addresses_UC_ht+0x159e8, %rbp
nop
sub %r12, %r12
...
nop
sub %r11, %r11
lea addresses_A_ht+0x19668, %rsi
lea addresses_A_ht+0x7268, %rdi
clflush (%rsi)
add $115, %rbp
mov $49, %rcx
rep movsw
...
lea addresses_WT_ht+0x6448, %rdi
clflush (%rsi)
nop
dec %r12
mov $23, %rcx
...
nop
sub %r13, %r13
lea addresses_UC_ht+0x40c0, %r13
xor $49925, %rsi
mov (%r13), %r12
nop
nop
add $14743, %r13
lea addresses_WT_ht+0x9068, %r15
nop
sub %rsi, %rsi
...
nop
inc %rcx
lea addresses_normal_ht+0x16b68, %rcx
nop
nop
nop
nop
...
nop
cmp $56823, %rsi
lea addresses_WC_ht+0xa718, %r11
nop
nop
xor %r12, %r12
mov (%r11), %r13
cmp $23736, %rcx
lea addresses_WT_ht+0x11bc0, %rdi
nop
nop
nop
nop
...
// Store
lea addresses_normal+0xd0c0, %r11
nop
add $44493, %rbp
movl $0x51525354, (%r11)
inc %rdi
...
// Store
lea addresses_normal+0x74c8, %r13
clflush (%r13)
nop
nop
nop
...
<gen_prepare_buffer>
{'OP': 'STOR', 'dst': {'type': 'addresses_D_ht', 'AVXalign': False, 'congruent': 3, 'size': 4, 'same': True, 'NT': False}}
...
{'OP': 'REPM', 'src': {'type': 'addresses_D_ht', 'congruent': 7, 'same': True}, 'dst': {'type': 'addresses_WT_ht', 'congruent': 5, 'same': False}}
