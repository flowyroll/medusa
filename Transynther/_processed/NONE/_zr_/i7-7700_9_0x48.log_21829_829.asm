...
push %rdi
push %rsi
lea addresses_normal_ht+0x13d8f, %rbp
nop
nop
and $41141, %rcx
movb (%rbp), %bl
and %r8, %r8
lea addresses_WC_ht+0x19aaf, %rdi
nop
xor $297, %r14
mov (%rdi), %bp
and %r8, %r8
lea addresses_normal_ht+0x10e8f, %rsi
lea addresses_WC_ht+0xe92f, %rdi
nop
nop
nop
nop
...
nop
add $51188, %r14
lea addresses_WT_ht+0x7443, %rbx
nop
sub %rcx, %rcx
...
movups %xmm6, (%rbx)
inc %rbp
lea addresses_A_ht+0x1ca8f, %rsi
lea addresses_WT_ht+0x721b, %rdi
clflush (%rdi)
nop
nop
nop
...
nop
add $37636, %rcx
lea addresses_WC_ht+0x99af, %rbp
nop
cmp $44728, %r15
movups (%rbp), %xmm5
vpextrq $1, %xmm5, %rsi
...
vmovntdq %ymm5, (%rcx)
sub $50293, %rdi
lea addresses_WC_ht+0x1ba89, %r15
clflush (%r15)
nop
nop
dec %rbp
mov (%r15), %rbx
and %rdi, %rdi
lea addresses_WC_ht+0x1d1ef, %rsi
nop
nop
dec %r15
mov (%rsi), %bp
nop
cmp %r8, %r8
lea addresses_D_ht+0x1d528, %rcx
nop
dec %r8
movb $0x61, (%rcx)
nop
add $17965, %rcx
lea addresses_WC_ht+0x5459, %rbp
clflush (%rbp)
nop
nop
nop
...
nop
and %rcx, %rcx
lea addresses_A_ht+0x1292f, %rbp
nop
nop
nop
nop
...
nop
cmp $16977, %r8
lea addresses_D_ht+0x15697, %r14
nop
nop
nop
and $62383, %r15
...
<gen_prepare_buffer>
{'OP': 'LOAD', 'src': {'type': 'addresses_normal_ht', 'AVXalign': False, 'congruent': 5, 'size': 1, 'same': False, 'NT': True}}
...
{'OP': 'REPM', 'src': {'type': 'addresses_A_ht', 'congruent': 4, 'same': True}, 'dst': {'type': 'addresses_WT_ht', 'congruent': 2, 'same': False}}
{'OP': 'LOAD', 'src': {'type': 'addresses_WC_ht', 'AVXalign': False, 'congruent': 1, 'size': 16, 'same': False, 'NT': False}}
{'OP': 'STOR', 'dst': {'type': 'addresses_D_ht', 'AVXalign': False, 'congruent': 11, 'size': 32, 'same': False, 'NT': True}}
