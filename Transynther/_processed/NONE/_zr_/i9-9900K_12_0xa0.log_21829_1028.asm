...
// Store
lea addresses_normal+0xab7a, %rax
and %rdx, %rdx
movw $0x5152, (%rax)
sub %rbp, %rbp

// Store
lea addresses_UC+0xddba, %r9
nop
nop
nop
xor %rdx, %rdx
...
{'src': {'NT': False, 'same': False, 'congruent': 8, 'type': 'addresses_P', 'AVXalign': False, 'size': 8}, 'OP': 'LOAD'}
