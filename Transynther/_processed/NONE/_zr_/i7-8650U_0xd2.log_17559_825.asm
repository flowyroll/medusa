...
push %rdx
push %rsi
lea addresses_WT_ht+0x1a299, %rcx
nop
cmp $40301, %rsi
mov (%rcx), %dx
nop
nop
xor %rcx, %rcx
lea addresses_normal_ht+0x19e19, %rsi
lea addresses_WT_ht+0x14559, %rdi
clflush (%rsi)
nop
nop
nop
...
nop
xor $35201, %rdx
lea addresses_WT_ht+0x1d665, %rax
nop
nop
dec %rdi
mov (%rax), %r8d
sub $37616, %r8
lea addresses_normal_ht+0x3fb9, %rcx
nop
nop
xor %rsi, %rsi
mov (%rcx), %edi
...
nop
lfence
lea addresses_D_ht+0x1ccf9, %rdx
nop
nop
nop
xor $6609, %r11
...
nop
xor %rsi, %rsi
lea addresses_A_ht+0x8bd9, %rsi
lea addresses_WT_ht+0x5a91, %rdi
nop
nop
nop
nop
...
mov (%rdx), %eax
add %rsi, %rsi
lea addresses_UC_ht+0x18699, %rsi
lea addresses_UC_ht+0x8c99, %rdi
nop
nop
nop
nop
...
rep movsw
sub %rcx, %rcx
lea addresses_UC_ht+0x2e19, %rsi
lea addresses_WT_ht+0x10899, %rdi
nop
nop
nop
nop
...
nop
dec %rdx
lea addresses_D_ht+0x1930f, %rcx
nop
nop
nop
xor %r11, %r11
...
{'OP': 'STOR', 'dst': {'type': 'addresses_WT', 'size': 8, 'AVXalign': False, 'NT': True, 'congruent': 0, 'same': True}}
...
{'OP': 'LOAD', 'src': {'type': 'addresses_normal_ht', 'size': 4, 'AVXalign': False, 'NT': False, 'congruent': 1, 'same': True}}
{'OP': 'LOAD', 'src': {'type': 'addresses_D_ht', 'size': 8, 'AVXalign': False, 'NT': True, 'congruent': 4, 'same': False}}
...
{'OP': 'REPM', 'src': {'type': 'addresses_UC_ht', 'congruent': 11, 'same': True}, 'dst': {'type': 'addresses_UC_ht', 'congruent': 6, 'same': False}}
