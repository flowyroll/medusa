...
push %rdx
push %rsi
lea addresses_WC_ht+0xe9bb, %r11
nop
nop
nop
nop
...
nop
xor $1816, %r8
lea addresses_normal_ht+0x141c, %rax
nop
nop
nop
nop
...
nop
add $12469, %rbp
lea addresses_A_ht+0x155bb, %rax
clflush (%rax)
nop
nop
nop
...
nop
cmp $19313, %rcx
lea addresses_A_ht+0x1a5bb, %rsi
lea addresses_D_ht+0x8abb, %rdi
nop
nop
sub %r11, %r11
mov $41, %rcx
...
nop
cmp $46335, %rax
lea addresses_WT_ht+0x49bb, %rdi
nop
nop
add $47258, %rdx
mov (%rdi), %ecx
...
nop
cmp $23098, %rax
lea addresses_WC_ht+0x6ebb, %rdi
nop
nop
nop
nop
