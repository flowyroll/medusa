...
nop
cmp $64332, %rbx
lea addresses_UC_ht+0x2c8c, %r11
nop
nop
dec %rbx
movb (%r11), %r9b
...
nop
lfence
lea addresses_normal_ht+0x4f5c, %r11
nop
nop
and %r8, %r8
...
nop
dec %r11
lea addresses_D_ht+0xf772, %r11
nop
xor $27873, %rdx
mov (%r11), %r13
inc %r8
lea addresses_WT_ht+0x540c, %r8
nop
xor %r14, %r14
movb (%r8), %r11b
and $52851, %rdx
lea addresses_D_ht+0x13a8c, %rsi
lea addresses_WT_ht+0x1ba8c, %rdi
nop
nop
nop
nop
...
vmovups %ymm1, (%rsi)
and $20881, %r8
lea addresses_normal_ht+0x1300c, %rsi
lea addresses_WT_ht+0x8b8c, %rdi
clflush (%rdi)
nop
xor %rbx, %rbx
mov $74, %rcx
...
<gen_prepare_buffer>
{'OP': 'STOR', 'dst': {'size': 32, 'NT': False, 'type': 'addresses_D_ht', 'same': False, 'AVXalign': True, 'congruent': 3}}
{'OP': 'LOAD', 'src': {'size': 1, 'NT': False, 'type': 'addresses_UC_ht', 'same': True, 'AVXalign': True, 'congruent': 3}}
...
{'OP': 'LOAD', 'src': {'size': 1, 'NT': False, 'type': 'addresses_WT_ht', 'same': True, 'AVXalign': False, 'congruent': 7}}
