...
push %rdx
push %rsi
lea addresses_WC_ht+0x57cc, %rsi
nop
dec %r12
movw $0x6162, (%rsi)
nop
...
nop
mfence
lea addresses_UC_ht+0x4772, %r14
nop
nop
nop
nop
...
nop
cmp %rcx, %rcx
lea addresses_D_ht+0x1a64c, %rdx
nop
nop
nop
nop
...
nop
and $31325, %rdx
lea addresses_WT_ht+0x1e90c, %rcx
cmp $33522, %rdi
movb $0x61, (%rcx)
nop
nop
...
nop
sub $12663, %rdx
lea addresses_UC_ht+0x18fcc, %r12
nop
nop
nop
nop
...
nop
cmp %rdi, %rdi
lea addresses_WC_ht+0x10c0c, %rsi
nop
cmp %r14, %r14
mov (%rsi), %r15d
xor $4790, %r14
