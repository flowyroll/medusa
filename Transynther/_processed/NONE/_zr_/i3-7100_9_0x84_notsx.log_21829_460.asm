...
push %rdx
push %rsi
lea addresses_normal_ht+0x1c849, %r15
nop
nop
nop
xor %rax, %rax
movb $0x61, (%r15)
add $20131, %rdx
lea addresses_A_ht+0x15009, %rax
nop
nop
nop
nop
...
nop
add $10447, %rdx
lea addresses_WT_ht+0x15509, %r15
nop
nop
nop
inc %rsi
...
nop
sub %rbp, %rbp
lea addresses_WC_ht+0x9b58, %rsi
lea addresses_WT_ht+0x1ccdb, %rdi
sub $2995, %rbp
mov $84, %rcx
rep movsw
nop
...
nop
sub $14541, %rbp
lea addresses_normal_ht+0x110c9, %rax
nop
nop
nop
nop
...
nop
and %rax, %rax
lea addresses_normal_ht+0x49e9, %r15
nop
dec %r14
movb (%r15), %al
nop
...
nop
cmp $3745, %r14
lea addresses_WC_ht+0x3489, %rcx
and %rax, %rax
movb (%rcx), %dl
and $51957, %rcx
lea addresses_WC_ht+0x1e329, %rsi
lea addresses_A_ht+0x18a69, %rdi
add $3692, %r15
mov $23, %rcx
rep movsb
sub $9458, %rdi
lea addresses_WC_ht+0x10b09, %rsi
lea addresses_WC_ht+0x143a9, %rdi
clflush (%rdi)
nop
add $52827, %r14
mov $34, %rcx
...
nop
add $41604, %rdi
lea addresses_UC_ht+0x17c31, %rdi
nop
nop
add %rax, %rax
...
nop
add $27217, %rdi
lea addresses_WT_ht+0x1c049, %rdx
nop
nop
nop
nop
...
// Store
lea addresses_normal+0x1f729, %r8
nop
nop
sub %r11, %r11
movl $0x51525354, (%r8)
...
{'dst': {'type': 'addresses_NC', 'same': False, 'size': 32, 'congruent': 3, 'NT': False, 'AVXalign': True}, 'OP': 'STOR'}
...
{'src': {'type': 'addresses_WC_ht', 'congruent': 0, 'same': False}, 'dst': {'type': 'addresses_WT_ht', 'congruent': 1, 'same': True}, 'OP': 'REPM'}
...
{'src': {'type': 'addresses_WC_ht', 'congruent': 5, 'same': False}, 'dst': {'type': 'addresses_WC_ht', 'congruent': 5, 'same': False}, 'OP': 'REPM'}
