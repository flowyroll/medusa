...
nop
and $57615, %r9
lea addresses_UC_ht+0x15da4, %r9
nop
nop
dec %rsi
mov (%r9), %ax
nop
sub $6085, %rbp
lea addresses_UC_ht+0x16228, %rax
nop
sub %rbp, %rbp
movl $0x61626364, (%rax)
nop
...
nop
and %rsi, %rsi
lea addresses_A_ht+0xc264, %rsi
lea addresses_WC_ht+0x11bdc, %rdi
clflush (%rdi)
add $35524, %r11
mov $102, %rcx
rep movsl
...
{'OP': 'STOR', 'dst': {'NT': True, 'same': False, 'congruent': 6, 'type': 'addresses_RW', 'AVXalign': False, 'size': 8}}
[Faulty Load]
{'src': {'NT': False, 'same': True, 'congruent': 0, 'type': 'addresses_WT', 'AVXalign': False, 'size': 2}, 'OP': 'LOAD'}
<gen_prepare_buffer>
{'src': {'same': False, 'congruent': 6, 'type': 'addresses_A_ht'}, 'OP': 'REPM', 'dst': {'same': True, 'congruent': 4, 'type': 'addresses_A_ht'}}
...
{'src': {'same': False, 'congruent': 6, 'type': 'addresses_A_ht'}, 'OP': 'REPM', 'dst': {'same': False, 'congruent': 3, 'type': 'addresses_WC_ht'}}
{'00': 21829}
