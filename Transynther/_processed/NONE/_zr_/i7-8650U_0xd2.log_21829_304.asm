...
push %rdx
push %rsi
lea addresses_WT_ht+0x3bf1, %rsi
lea addresses_A_ht+0x10951, %rdi
clflush (%rdi)
nop
nop
nop
...
nop
cmp %r14, %r14
lea addresses_UC_ht+0x16911, %r15
add $60732, %rdx
mov (%r15), %r13w
nop
and %rdx, %rdx
lea addresses_normal_ht+0x2d11, %r14
nop
nop
nop
and %rcx, %rcx
...
nop
dec %r15
lea addresses_D_ht+0x16a11, %rsi
lea addresses_UC_ht+0x10d11, %rdi
nop
nop
nop
nop
...
nop
sub $53158, %rsi
lea addresses_UC_ht+0xfe39, %rdi
nop
nop
nop
add $3200, %rcx
...
nop
sub %r14, %r14
lea addresses_normal_ht+0x1b311, %rcx
nop
nop
nop
nop
...
vpextrq $1, %xmm4, %rsi
inc %rcx
lea addresses_WC_ht+0x38d1, %rsi
lea addresses_WC_ht+0x5991, %rdi
nop
nop
nop
add $12032, %rdx
...
nop
xor %r15, %r15
lea addresses_D_ht+0x16d11, %r15
nop
cmp %r13, %r13
mov (%r15), %r11w
nop
...
<gen_prepare_buffer>
{'OP': 'REPM', 'src': {'type': 'addresses_WT_ht', 'congruent': 5, 'same': True}, 'dst': {'type': 'addresses_A_ht', 'congruent': 6, 'same': True}}
