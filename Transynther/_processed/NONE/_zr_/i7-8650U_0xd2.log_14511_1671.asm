...
nop
sub %r14, %r14
lea addresses_D_ht+0xbf2d, %rsi
lea addresses_A_ht+0x1730d, %rdi
clflush (%rsi)
clflush (%rdi)
nop
and $31212, %r13
...
// Load
lea addresses_normal+0x115ad, %r9
nop
nop
nop
nop
