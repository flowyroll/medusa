...
nop
sub %rsi, %rsi
lea addresses_D_ht+0x18bc6, %rbp
nop
lfence
mov (%rbp), %di
nop
...
nop
sub %rsi, %rsi
lea addresses_D_ht+0x13516, %rsi
lea addresses_WT_ht+0x17716, %rdi
nop
sub %r14, %r14
mov $25, %rcx
rep movsw
...
<gen_prepare_buffer>
{'src': {'same': False, 'congruent': 10, 'type': 'addresses_WC_ht'}, 'OP': 'REPM', 'dst': {'same': False, 'congruent': 8, 'type': 'addresses_normal_ht'}}
{'OP': 'STOR', 'dst': {'NT': True, 'same': False, 'congruent': 6, 'type': 'addresses_D_ht', 'AVXalign': False, 'size': 32}}
{'src': {'NT': False, 'same': False, 'congruent': 3, 'type': 'addresses_D_ht', 'AVXalign': True, 'size': 2}, 'OP': 'LOAD'}
