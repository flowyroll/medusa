...
push %rdx
push %rsi
lea addresses_D_ht+0x1b9e4, %rcx
nop
nop
nop
nop
...
nop
cmp $23896, %rsi
lea addresses_A_ht+0x21e4, %rdi
nop
sub %rdx, %rdx
mov (%rdi), %cx
nop
xor %rcx, %rcx
lea addresses_WT_ht+0x1af14, %rcx
xor $15443, %r12
mov $0x6162636465666768, %r14
movq %r14, (%rcx)
dec %rsi
lea addresses_UC_ht+0x53bc, %r15
nop
nop
nop
inc %rdx
...
nop
cmp %r14, %r14
lea addresses_normal_ht+0x5fa4, %rsi
lea addresses_normal_ht+0x1b64, %rdi
nop
add $55790, %rax
mov $87, %rcx
rep movsb
...
nop
add $52552, %rax
lea addresses_WC_ht+0x51e4, %rsi
lea addresses_WC_ht+0x81e4, %rdi
nop
nop
nop
sub $34765, %rdx
...
nop
add %rdi, %rdi
lea addresses_WC_ht+0x59a4, %rsi
nop
nop
nop
nop
...
nop
dec %r12
lea addresses_WC_ht+0x1a3e4, %rsi
lea addresses_WT_ht+0xa9e4, %rdi
nop
nop
sub %rax, %rax
mov $73, %rcx
...
nop
and $30385, %rdi
lea addresses_A_ht+0x32e4, %rsi
lea addresses_WT_ht+0x109e4, %rdi
nop
dec %rax
mov $51, %rcx
rep movsb
...
{'OP': 'REPM', 'src': {'type': 'addresses_normal_ht', 'congruent': 6, 'same': False}, 'dst': {'type': 'addresses_normal_ht', 'congruent': 7, 'same': True}}
