...
lea addresses_UC_ht+0x132bc, %rdi
nop
add %rax, %rax
mov $121, %rcx
rep movsl
...
nop
cmp $56867, %rcx
lea addresses_WC_ht+0x893f, %rbp
clflush (%rbp)
nop
nop
nop
...
nop
dec %rcx
lea addresses_WT_ht+0x1b3b1, %rax
nop
nop
dec %rbp
mov (%rax), %si
...
nop
dec %r14
lea addresses_A_ht+0x19fc3, %rsi
lea addresses_WC_ht+0xe38f, %rdi
and $52370, %r11
mov $112, %rcx
rep movsq
nop
...
nop
xor %r9, %r9
lea addresses_A_ht+0x1badf, %rsi
lea addresses_UC_ht+0x34d5, %rdi
nop
nop
nop
nop
...
nop
and $45323, %r9
lea addresses_D_ht+0x120c7, %rsi
nop
nop
xor %rbp, %rbp
