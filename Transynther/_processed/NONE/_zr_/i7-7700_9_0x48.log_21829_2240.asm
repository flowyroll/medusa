...
nop
xor %rcx, %rcx
lea addresses_WC_ht+0xde3f, %rax
nop
nop
nop
nop
...
movb (%rax), %r10b
and %r10, %r10
lea addresses_A_ht+0x1829d, %r12
clflush (%r12)
nop
nop
nop
...
nop
and %rcx, %rcx
lea addresses_UC_ht+0xc8fd, %rcx
nop
nop
nop
nop
...
nop
cmp $3932, %r12
lea addresses_WT_ht+0x1231d, %rdi
nop
nop
nop
sub $55973, %r10
...
movups %xmm6, (%rdi)
and $26223, %rcx
lea addresses_UC_ht+0x1c49d, %rcx
nop
nop
nop
and $4787, %rbp
...
nop
and $56165, %rdi
lea addresses_WC_ht+0x13d9d, %r12
nop
inc %rcx
movl $0x61626364, (%r12)
nop
add $23684, %rax
lea addresses_normal_ht+0x7145, %rbp
nop
nop
inc %r12
mov (%rbp), %r10
...
// Store
lea addresses_normal+0x106cd, %rdx
nop
nop
nop
nop
...
{'OP': 'LOAD', 'src': {'type': 'addresses_RW', 'AVXalign': False, 'congruent': 1, 'size': 1, 'same': False, 'NT': False}}
[Faulty Load]
...
{'OP': 'LOAD', 'src': {'type': 'addresses_UC_ht', 'AVXalign': False, 'congruent': 8, 'size': 32, 'same': True, 'NT': False}}
