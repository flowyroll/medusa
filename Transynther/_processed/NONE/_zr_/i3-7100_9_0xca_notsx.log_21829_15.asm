...
rep movsw
add $24904, %rax
lea addresses_normal_ht+0x16c38, %rdi
nop
nop
add %rax, %rax
movb $0x61, (%rdi)
...
nop
and %r12, %r12
lea addresses_WC_ht+0x4af0, %rcx
clflush (%rcx)
add %r14, %r14
movb $0x61, (%rcx)
nop
...
vpextrq $0, %xmm5, %rdi
xor $4648, %r11
lea addresses_A_ht+0x4970, %rsi
lea addresses_normal_ht+0x1b630, %rdi
nop
cmp $11154, %rax
mov $95, %rcx
rep movsq
...
{'OP': 'STOR', 'dst': {'same': False, 'congruent': 3, 'NT': False, 'type': 'addresses_normal_ht', 'size': 1, 'AVXalign': True}}
