...
push %rdx
push %rsi
lea addresses_normal_ht+0xf272, %r8
dec %rsi
movw $0x6162, (%r8)
nop
nop
...
nop
xor %rdx, %rdx
lea addresses_WT_ht+0x172f2, %rsi
lea addresses_WT_ht+0x17b72, %rdi
nop
nop
nop
and $42647, %rdx
...
lea addresses_D_ht+0x1c172, %rdi
clflush (%rsi)
clflush (%rdi)
nop
nop
...
nop
xor $18663, %r11
lea addresses_UC_ht+0x195f2, %rsi
lea addresses_A_ht+0x17f72, %rdi
nop
nop
nop
nop
...
nop
sub $24739, %rdx
lea addresses_WT_ht+0x1c772, %rdi
nop
nop
nop
nop
...
nop
sub %rsi, %rsi
lea addresses_WC_ht+0x4f72, %r11
nop
nop
cmp $13342, %rsi
...
nop
add %r11, %r11
lea addresses_D_ht+0x1c542, %rsi
lea addresses_normal_ht+0x14772, %rdi
clflush (%rsi)
xor %rdx, %rdx
mov $22, %rcx
rep movsb
...
nop
xor %rbx, %rbx
lea addresses_normal_ht+0x15dd6, %r8
nop
nop
add %r11, %r11
...
nop
xor $3879, %rbx
lea addresses_WC_ht+0x5b72, %r12
nop
nop
nop
nop
...
nop
add %rdx, %rdx
lea addresses_UC_ht+0xf772, %rsi
lea addresses_UC_ht+0x12282, %rdi
nop
inc %r12
mov $41, %rcx
rep movsq
...
{'OP': 'LOAD', 'src': {'type': 'addresses_RW', 'size': 1, 'AVXalign': False, 'NT': False, 'congruent': 5, 'same': False}}
...
{'OP': 'REPM', 'src': {'type': 'addresses_WT_ht', 'congruent': 7, 'same': False}, 'dst': {'type': 'addresses_WT_ht', 'congruent': 8, 'same': False}}
...
{'OP': 'REPM', 'src': {'type': 'addresses_D_ht', 'congruent': 4, 'same': False}, 'dst': {'type': 'addresses_normal_ht', 'congruent': 11, 'same': False}}
{'OP': 'STOR', 'dst': {'type': 'addresses_normal_ht', 'size': 16, 'AVXalign': False, 'NT': False, 'congruent': 2, 'same': True}}
