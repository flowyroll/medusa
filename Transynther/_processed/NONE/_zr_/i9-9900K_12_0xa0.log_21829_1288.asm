...
push %rdi
push %rsi
lea addresses_normal_ht+0x18e96, %r15
nop
nop
nop
nop
...
vmovups %ymm0, (%rcx)
sub %r15, %r15
lea addresses_UC_ht+0xec96, %rsi
lea addresses_WT_ht+0x14296, %rdi
nop
xor $57917, %rax
mov $99, %rcx
rep movsb
...
nop
dec %r13
lea addresses_A_ht+0x2f26, %rsi
lea addresses_normal_ht+0x8f58, %rdi
nop
nop
inc %r9
mov $81, %rcx
...
{'src': {'NT': False, 'same': False, 'congruent': 5, 'type': 'addresses_RW', 'AVXalign': False, 'size': 8}, 'OP': 'LOAD'}
[Faulty Load]
...
{'src': {'same': False, 'congruent': 9, 'type': 'addresses_UC_ht'}, 'OP': 'REPM', 'dst': {'same': False, 'congruent': 10, 'type': 'addresses_WT_ht'}}
