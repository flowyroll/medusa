...
push %rdx
push %rsi
lea addresses_WC_ht+0x3f87, %rbx
cmp %rdi, %rdi
...
nop
xor %rdx, %rdx
lea addresses_D_ht+0xa087, %rsi
lea addresses_D_ht+0x8d01, %rdi
clflush (%rdi)
nop
nop
add $53293, %r10
...
nop
xor $60410, %rdi
lea addresses_D_ht+0x1c917, %r15
nop
nop
nop
nop
...
nop
dec %rsi
lea addresses_WC_ht+0x15187, %rdi
nop
nop
nop
nop
...
nop
xor $21698, %rsi
lea addresses_D_ht+0x12e91, %rsi
nop
nop
nop
nop
...
nop
xor %r15, %r15
lea addresses_WT_ht+0x6687, %rsi
lea addresses_D_ht+0xf587, %rdi
clflush (%rdi)
add %r11, %r11
mov $1, %rcx
rep movsb
...
{'OP': 'REPM', 'src': {'type': 'addresses_D_ht', 'congruent': 7, 'same': True}, 'dst': {'type': 'addresses_D_ht', 'congruent': 0, 'same': False}}
