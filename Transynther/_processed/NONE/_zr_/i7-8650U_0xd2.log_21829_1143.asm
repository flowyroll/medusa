...
nop
dec %rdx
lea addresses_normal_ht+0x1851, %r15
nop
nop
nop
nop
...
// Store
lea addresses_normal+0x1648d, %rcx
nop
nop
nop
nop
...
{'OP': 'LOAD', 'src': {'type': 'addresses_D', 'size': 8, 'AVXalign': False, 'NT': False, 'congruent': 4, 'same': True}}
