...
nop
add %r10, %r10
lea addresses_WC_ht+0x197e2, %rsi
lea addresses_normal_ht+0x16fa2, %rdi
xor %r10, %r10
mov $48, %rcx
rep movsb
nop
inc %rbx
lea addresses_A_ht+0x1d222, %rsi
lea addresses_WC_ht+0x2ae2, %rdi
clflush (%rdi)
nop
nop
nop
...
nop
xor %r13, %r13
lea addresses_WC_ht+0x9f16, %r13
and $60029, %r10
movups (%r13), %xmm0
vpextrq $0, %xmm0, %r9
nop
...
lea addresses_normal_ht+0x4522, %rdi
nop
nop
nop
nop
...
{'src': {'congruent': 6, 'same': False, 'type': 'addresses_WC_ht'}, 'OP': 'REPM', 'dst': {'congruent': 7, 'same': False, 'type': 'addresses_normal_ht'}}
{'src': {'congruent': 7, 'same': False, 'type': 'addresses_A_ht'}, 'OP': 'REPM', 'dst': {'congruent': 5, 'same': False, 'type': 'addresses_WC_ht'}}
{'src': {'congruent': 0, 'AVXalign': False, 'same': False, 'size': 16, 'NT': False, 'type': 'addresses_WC_ht'}, 'OP': 'LOAD'}
{'src': {'congruent': 8, 'same': False, 'type': 'addresses_WC_ht'}, 'OP': 'REPM', 'dst': {'congruent': 9, 'same': True, 'type': 'addresses_normal_ht'}}
{'00': 21829}
