...
nop
xor %r9, %r9
lea addresses_WC_ht+0x1e1ad, %rdx
clflush (%rdx)
nop
nop
cmp $47173, %rbp
...
lea addresses_UC_ht+0x156bd, %rdi
nop
nop
inc %r10
mov $79, %rcx
...
nop
xor %r13, %r13
lea addresses_WC_ht+0x17e4d, %rdx
nop
nop
nop
nop
...
{'OP': 'STOR', 'dst': {'congruent': 7, 'AVXalign': True, 'same': True, 'size': 8, 'NT': True, 'type': 'addresses_A_ht'}}
