...
push %rdx
push %rsi
lea addresses_UC_ht+0xbd95, %rdx
clflush (%rdx)
nop
sub %r14, %r14
...
lea addresses_UC_ht+0x5f48, %rdi
xor $32109, %r15
mov $4, %rcx
rep movsq
nop
...
nop
xor %rcx, %rcx
lea addresses_D_ht+0xcec8, %rsi
lea addresses_UC_ht+0x30c8, %rdi
nop
add $37421, %rax
mov $109, %rcx
rep movsw
...
lea addresses_normal_ht+0x7ac8, %rdi
nop
nop
inc %r11
mov $8, %rcx
...
nop
xor $21208, %rdx
lea addresses_D_ht+0x1bbe8, %rsi
lea addresses_normal_ht+0x148c8, %rdi
xor $53976, %r11
mov $44, %rcx
rep movsq
sub $16125, %rdi
lea addresses_WC_ht+0xc6c8, %r15
nop
nop
nop
add $53623, %rdi
...
nop
sub $50259, %r15
lea addresses_UC_ht+0x3348, %rdx
nop
cmp %r15, %r15
mov (%rdx), %ax
cmp $34873, %rax
lea addresses_D_ht+0x30c8, %rsi
lea addresses_A_ht+0x1bb68, %rdi
nop
sub %rax, %rax
mov $36, %rcx
rep movsw
nop
add %r14, %r14
lea addresses_WT_ht+0x1a0c8, %r14
nop
nop
nop
nop
...
{'OP': 'REPM', 'src': {'type': 'addresses_WT_ht', 'congruent': 0, 'same': False}, 'dst': {'type': 'addresses_normal_ht', 'congruent': 8, 'same': False}}
