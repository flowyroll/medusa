...
nop
add $62702, %r11
lea addresses_UC_ht+0x1ced6, %rsi
lea addresses_WT_ht+0x17cd6, %rdi
clflush (%rdi)
nop
and $21916, %r13
mov $61, %rcx
...
vpextrq $0, %xmm6, %r13
xor $10001, %rcx
lea addresses_UC_ht+0xe9a6, %rsi
lea addresses_D_ht+0x35ee, %rdi
nop
nop
nop
and %r13, %r13
...
nop
cmp $18378, %r11
lea addresses_normal_ht+0x2442, %rsi
lea addresses_A_ht+0xe8d6, %rdi
nop
nop
nop
nop
...
nop
add %rcx, %rcx
lea addresses_WT_ht+0x8ad6, %r13
nop
nop
xor %r10, %r10
...
{'OP': 'REPM', 'src': {'type': 'addresses_UC_ht', 'congruent': 5, 'same': True}, 'dst': {'type': 'addresses_WT_ht', 'congruent': 9, 'same': False}}
...
{'OP': 'LOAD', 'src': {'type': 'addresses_WT_ht', 'AVXalign': False, 'congruent': 9, 'size': 32, 'same': False, 'NT': True}}
{'00': 21829}
