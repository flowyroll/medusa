...
push %rdi
push %rsi
lea addresses_UC_ht+0xa670, %r11
clflush (%r11)
nop
nop
nop
...
nop
xor $5895, %rbx
lea addresses_UC_ht+0x65b0, %r12
xor $23177, %r15
movups (%r12), %xmm2
vpextrq $0, %xmm2, %rbx
nop
...
nop
and $7453, %r11
lea addresses_WC_ht+0x630, %rsi
lea addresses_D_ht+0xa204, %rdi
nop
nop
nop
xor %r12, %r12
...
nop
add $46857, %r11
lea addresses_WC_ht+0x19486, %r11
nop
nop
nop
nop
...
nop
sub $44380, %r12
lea addresses_UC_ht+0x1c580, %rsi
lea addresses_WC_ht+0x10e80, %rdi
nop
nop
sub $16592, %r11
mov $117, %rcx
...
{'src': {'same': False, 'congruent': 8, 'type': 'addresses_UC_ht'}, 'OP': 'REPM', 'dst': {'same': False, 'congruent': 7, 'type': 'addresses_WC_ht'}}
{'00': 21829}
