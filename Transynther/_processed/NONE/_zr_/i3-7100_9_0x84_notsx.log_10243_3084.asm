...
nop
sub $59036, %rdi
lea addresses_UC_ht+0x898d, %rax
nop
cmp %r15, %r15
...
nop
sub $20998, %rbp
lea addresses_WT_ht+0x1478d, %r15
nop
nop
nop
dec %r14
...
// REPMOV
lea addresses_normal+0x2dad, %rsi
mov $0x9ad, %rdi
clflush (%rdi)
nop
nop
...
{'src': {'type': 'addresses_normal', 'congruent': 4, 'same': False}, 'dst': {'type': 'addresses_P', 'congruent': 2, 'same': False}, 'OP': 'REPM'}
{'dst': {'type': 'addresses_WC', 'same': False, 'size': 4, 'congruent': 7, 'NT': False, 'AVXalign': True}, 'OP': 'STOR'}
[Faulty Load]
