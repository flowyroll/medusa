...
nop
xor $26286, %rbp
lea addresses_WT_ht+0x13409, %rbp
nop
nop
cmp $58393, %r12
movw $0x6162, (%rbp)
...
nop
cmp %r9, %r9
lea addresses_normal_ht+0x1cc89, %r15
nop
nop
dec %r9
movb $0x61, (%r15)
...
nop
inc %r9
lea addresses_WT_ht+0xa209, %r12
sub $24537, %r13
mov (%r12), %ax
inc %r9
lea addresses_normal_ht+0xf609, %rdi
sub $40367, %r12
movw $0x6162, (%rdi)
inc %r15
lea addresses_D_ht+0x5247, %r13
clflush (%r13)
nop
nop
dec %r15
...
nop
add %r13, %r13
lea addresses_A_ht+0x5609, %r9
nop
cmp $11033, %r15
movb $0x61, (%r9)
nop
cmp %rbp, %rbp
lea addresses_normal_ht+0xef09, %rsi
lea addresses_WC_ht+0xd609, %rdi
clflush (%rsi)
nop
add %r15, %r15
mov $25, %rcx
...
{'OP': 'LOAD', 'src': {'type': 'addresses_PSE', 'AVXalign': False, 'congruent': 9, 'size': 16, 'same': False, 'NT': True}}
{'OP': 'STOR', 'dst': {'type': 'addresses_PSE', 'AVXalign': True, 'congruent': 3, 'size': 4, 'same': False, 'NT': False}}
[Faulty Load]
