...
push %rdi
push %rsi
lea addresses_WC_ht+0x1cfbc, %rbp
nop
nop
nop
cmp $2492, %r15
...
movups %xmm7, (%rbp)
add %rbx, %rbx
lea addresses_UC_ht+0x17cbc, %rsi
lea addresses_A_ht+0x677c, %rdi
nop
nop
nop
nop
...
rep movsw
and %r11, %r11
lea addresses_A_ht+0x1dabc, %rsi
nop
nop
nop
nop
...
movw $0x6162, (%rsi)
dec %r15
lea addresses_WC_ht+0x176bc, %r15
nop
nop
nop
add %rbp, %rbp
...
nop
and %rdi, %rdi
lea addresses_WT_ht+0x1d94c, %rsi
lea addresses_UC_ht+0x1a5bc, %rdi
nop
xor %r13, %r13
mov $126, %rcx
rep movsw
...
nop
cmp $37614, %r13
lea addresses_A_ht+0x1e6bc, %rbx
nop
nop
nop
nop
...
{'src': {'same': True, 'congruent': 7, 'type': 'addresses_UC_ht'}, 'OP': 'REPM', 'dst': {'same': False, 'congruent': 4, 'type': 'addresses_A_ht'}}
