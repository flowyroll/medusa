...
push %rdi
push %rsi
lea addresses_D_ht+0x1c846, %rax
nop
nop
nop
sub $8150, %rcx
...
nop
add %r10, %r10
lea addresses_WC_ht+0x17ce6, %rsi
lea addresses_A_ht+0x824e, %rdi
nop
and $61000, %rax
mov $88, %rcx
rep movsw
nop
xor $6216, %rax
lea addresses_WT_ht+0x4ec6, %rsi
nop
nop
xor %r11, %r11
mov (%rsi), %eax
nop
sub %rax, %rax
lea addresses_D_ht+0x13902, %r10
clflush (%r10)
nop
nop
nop
...
nop
add $37752, %rsi
lea addresses_WC_ht+0x73c6, %rax
sub %r10, %r10
movb (%rax), %r15b
nop
nop
...
nop
sub $18667, %r15
lea addresses_UC_ht+0x192c6, %rdi
nop
nop
nop
sub $7390, %rcx
...
nop
inc %r11
lea addresses_UC_ht+0x1c2c6, %r11
nop
add $38067, %rcx
vmovups (%r11), %ymm0
vextracti128 $1, %ymm0, %xmm0
...
nop
mfence
lea addresses_WT_ht+0x142c6, %r11
nop
nop
nop
nop
...
nop
add %r10, %r10
lea addresses_WC_ht+0x12ec6, %rsi
lea addresses_A_ht+0xf6de, %rdi
nop
add $13586, %r9
mov $88, %rcx
rep movsw
...
nop
inc %rdi
lea addresses_UC_ht+0x170c6, %rsi
add %r15, %r15
vmovups (%rsi), %ymm1
...
nop
inc %rcx
lea addresses_UC_ht+0x96c6, %rdi
clflush (%rdi)
nop
nop
cmp %r11, %r11
...
nop
sub %r9, %r9
lea addresses_WC_ht+0x107c6, %rsi
lea addresses_UC_ht+0x1b917, %rdi
nop
nop
nop
nop
...
nop
xor $35822, %rsi
lea addresses_normal_ht+0x14d36, %r9
add %rdi, %rdi
mov $0x6162636465666768, %r11
movq %r11, %xmm0
vmovups %ymm0, (%r9)
inc %r9
lea addresses_A_ht+0xdbc6, %rsi
lea addresses_D_ht+0xe7ae, %rdi
nop
nop
nop
nop
...
<gen_prepare_buffer>
{'OP': 'STOR', 'dst': {'congruent': 5, 'AVXalign': False, 'same': True, 'size': 32, 'NT': False, 'type': 'addresses_D_ht'}}
{'src': {'congruent': 2, 'same': False, 'type': 'addresses_WC_ht'}, 'OP': 'REPM', 'dst': {'congruent': 2, 'same': False, 'type': 'addresses_A_ht'}}
{'src': {'congruent': 10, 'AVXalign': False, 'same': False, 'size': 4, 'NT': True, 'type': 'addresses_WT_ht'}, 'OP': 'LOAD'}
...
{'src': {'congruent': 8, 'same': False, 'type': 'addresses_WC_ht'}, 'OP': 'REPM', 'dst': {'congruent': 1, 'same': False, 'type': 'addresses_A_ht'}}
