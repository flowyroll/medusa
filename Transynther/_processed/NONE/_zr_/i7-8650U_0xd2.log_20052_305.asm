...
push %rdi
push %rsi
lea addresses_D_ht+0x1755a, %rsi
lea addresses_A_ht+0x661a, %rdi
inc %r10
mov $31, %rcx
rep movsw
nop
...
nop
and %r13, %r13
lea addresses_WC_ht+0x9d5a, %r12
add %rbx, %rbx
movb $0x61, (%r12)
sub %rdi, %rdi
lea addresses_normal_ht+0x12b1a, %r10
nop
nop
nop
nop
...
nop
inc %r12
lea addresses_WC_ht+0xe4ca, %r12
nop
nop
nop
nop
...
nop
add %r10, %r10
lea addresses_UC_ht+0xd71a, %rsi
...
nop
cmp %rdi, %rdi
lea addresses_WT_ht+0xdf1a, %rcx
nop
nop
dec %r12
movw $0x6162, (%rcx)
