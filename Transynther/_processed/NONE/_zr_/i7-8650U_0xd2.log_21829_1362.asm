...
nop
cmp $24694, %r8
lea addresses_normal_ht+0x1b4c6, %rsi
lea addresses_A_ht+0x93b3, %rdi
nop
xor %r9, %r9
mov $115, %rcx
rep movsl
...
nop
dec %rcx
lea addresses_WT_ht+0x14a7d, %rsi
lea addresses_UC_ht+0x15013, %rdi
nop
nop
nop
and $29935, %rbp
...
nop
and $42194, %rbx
lea addresses_normal_ht+0x1c033, %rsi
lea addresses_A_ht+0x17b1e, %rdi
clflush (%rsi)
nop
cmp $20923, %rbx
mov $75, %rcx
...
{'OP': 'REPM', 'src': {'type': 'addresses_normal_ht', 'congruent': 0, 'same': True}, 'dst': {'type': 'addresses_A_ht', 'congruent': 6, 'same': False}}
