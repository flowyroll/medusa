...
nop
sub %rbp, %rbp
lea addresses_D_ht+0x1bc14, %rdi
nop
nop
nop
nop
...
nop
add $17497, %r14
lea addresses_WC_ht+0x3614, %rsi
lea addresses_UC_ht+0x19e14, %rdi
cmp %r11, %r11
mov $26, %rcx
rep movsl
nop
...
nop
and %rbp, %rbp
lea addresses_UC_ht+0xec00, %rsi
lea addresses_WT_ht+0xf914, %rdi
nop
nop
add $52527, %r11
mov $37, %rcx
...
nop
dec %r11
lea addresses_D_ht+0x6dd4, %rsi
lea addresses_UC_ht+0x12c14, %rdi
nop
dec %r11
mov $11, %rcx
rep movsl
