...
push %rdi
push %rsi
lea addresses_normal_ht+0x1ebaa, %rsi
lea addresses_D_ht+0x18e86, %rdi
clflush (%rdi)
nop
nop
nop
...
// Load
lea addresses_normal+0x6d36, %r8
nop
dec %rax
movb (%r8), %r10b
nop
...
// Store
lea addresses_normal+0x5e12, %rbx
nop
nop
nop
nop
