...
push %rdi
push %rsi
lea addresses_WC_ht+0x13323, %rsi
lea addresses_A_ht+0x19067, %rdi
nop
nop
nop
nop
...
rep movsl
and $56065, %r10
lea addresses_WT_ht+0xb4fd, %rsi
lea addresses_WT_ht+0x15e67, %rdi
clflush (%rdi)
nop
nop
sub %r15, %r15
...
nop
cmp %rsi, %rsi
lea addresses_UC_ht+0x161a7, %r15
nop
nop
nop
and $44513, %r10
movb (%r15), %cl
sub $11936, %rsi
lea addresses_UC_ht+0xeac0, %rdi
nop
nop
and $3391, %r11
...
nop
xor %r11, %r11
lea addresses_A_ht+0x11467, %rsi
lea addresses_WC_ht+0x16067, %rdi
nop
nop
and %r11, %r11
mov $35, %rcx
...
nop
cmp %r15, %r15
lea addresses_UC_ht+0x12867, %rsi
clflush (%rsi)
dec %rdi
movups (%rsi), %xmm5
vpextrq $1, %xmm5, %r15
...
nop
sub $22523, %rcx
lea addresses_WT_ht+0x4caf, %r10
nop
nop
and $59838, %rcx
movups (%r10), %xmm5
...
{'OP': 'LOAD', 'src': {'type': 'addresses_A', 'size': 16, 'AVXalign': False, 'NT': False, 'congruent': 4, 'same': False}}
[Faulty Load]
...
{'OP': 'REPM', 'src': {'type': 'addresses_WT_ht', 'congruent': 1, 'same': True}, 'dst': {'type': 'addresses_WT_ht', 'congruent': 7, 'same': False}}
...
{'OP': 'REPM', 'src': {'type': 'addresses_A_ht', 'congruent': 9, 'same': False}, 'dst': {'type': 'addresses_WC_ht', 'congruent': 9, 'same': False}}
