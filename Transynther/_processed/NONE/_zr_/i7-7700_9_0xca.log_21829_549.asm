...
push %rdi
push %rsi
lea addresses_D_ht+0xf51e, %rsi
lea addresses_UC_ht+0x1d096, %rdi
nop
nop
nop
nop
...
nop
cmp $55014, %rbp
lea addresses_UC_ht+0x3896, %rsi
lea addresses_WT_ht+0xde6, %rdi
nop
nop
xor $21505, %rbx
mov $103, %rcx
...
lea addresses_D_ht+0x9c14, %rdi
nop
add $54240, %r8
mov $60, %rcx
rep movsb
cmp $517, %rsi
lea addresses_normal_ht+0xe56, %r13
nop
nop
nop
add %rdi, %rdi
...
nop
xor %r8, %r8
lea addresses_WC_ht+0xb286, %r13
nop
xor $37204, %r8
movups (%r13), %xmm5
vpextrq $1, %xmm5, %rcx
...
nop
cmp $54668, %rbx
lea addresses_A_ht+0x7756, %rsi
lea addresses_UC_ht+0x7e66, %rdi
nop
inc %rbp
mov $18, %rcx
rep movsl
nop
dec %r8
lea addresses_WT_ht+0x28e5, %rsi
...
{'src': {'congruent': 8, 'AVXalign': False, 'same': False, 'size': 2, 'NT': False, 'type': 'addresses_PSE'}, 'OP': 'LOAD'}
...
<gen_prepare_buffer>
{'src': {'congruent': 1, 'same': False, 'type': 'addresses_D_ht'}, 'OP': 'REPM', 'dst': {'congruent': 5, 'same': False, 'type': 'addresses_UC_ht'}}
{'src': {'congruent': 6, 'same': False, 'type': 'addresses_UC_ht'}, 'OP': 'REPM', 'dst': {'congruent': 4, 'same': False, 'type': 'addresses_WT_ht'}}
{'src': {'congruent': 0, 'same': False, 'type': 'addresses_WC_ht'}, 'OP': 'REPM', 'dst': {'congruent': 1, 'same': False, 'type': 'addresses_D_ht'}}
