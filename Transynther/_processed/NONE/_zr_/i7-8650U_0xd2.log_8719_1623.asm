...
nop
sub $21717, %rcx
lea addresses_UC_ht+0x9a4c, %rcx
nop
nop
nop
nop
...
nop
inc %rdi
lea addresses_D_ht+0xf3f0, %r9
xor %rdx, %rdx
movb $0x61, (%r9)
nop
and %r9, %r9
lea addresses_WT_ht+0x1767d, %rsi
lea addresses_UC_ht+0x1a890, %rdi
and %r9, %r9
mov $88, %rcx
rep movsw
nop
...
nop
inc %rcx
lea addresses_WT_ht+0x24d0, %rsi
lea addresses_UC_ht+0x17250, %rdi
clflush (%rsi)
clflush (%rdi)
nop
sub $58079, %rdx
...
nop
dec %r11
lea addresses_A_ht+0x8ad0, %rsi
lea addresses_WT_ht+0x14250, %rdi
nop
nop
nop
nop
...
rep movsw
sub $36279, %r11
lea addresses_normal_ht+0x14cb0, %r13
nop
nop
and $42463, %rcx
vmovups (%r13), %ymm5
...
// REPMOV
lea addresses_US+0x100d0, %rsi
lea addresses_normal+0x1d6d0, %rdi
nop
inc %rbx
mov $28, %rcx
rep movsb
...
// Faulty Load
lea addresses_normal+0x1d6d0, %rsi
nop
sub $55862, %r11
movb (%rsi), %bl
lea oracles, %rsi
...
{'OP': 'REPM', 'src': {'type': 'addresses_US', 'congruent': 9, 'same': False}, 'dst': {'type': 'addresses_normal', 'congruent': 0, 'same': True}}
[Faulty Load]
...
{'OP': 'STOR', 'dst': {'type': 'addresses_A_ht', 'size': 2, 'AVXalign': False, 'NT': True, 'congruent': 7, 'same': True}}
...
{'OP': 'REPM', 'src': {'type': 'addresses_WT_ht', 'congruent': 0, 'same': False}, 'dst': {'type': 'addresses_UC_ht', 'congruent': 6, 'same': True}}
{'OP': 'STOR', 'dst': {'type': 'addresses_D_ht', 'size': 8, 'AVXalign': False, 'NT': False, 'congruent': 6, 'same': False}}
{'OP': 'REPM', 'src': {'type': 'addresses_WT_ht', 'congruent': 6, 'same': True}, 'dst': {'type': 'addresses_UC_ht', 'congruent': 6, 'same': False}}
