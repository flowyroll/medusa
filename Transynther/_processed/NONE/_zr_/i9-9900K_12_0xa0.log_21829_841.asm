...
nop
cmp $42671, %r14
lea addresses_WC_ht+0x71e8, %r13
clflush (%r13)
nop
nop
nop
...
nop
add $28345, %r12
lea addresses_normal_ht+0x12fe0, %rsi
lea addresses_normal_ht+0x66f0, %rdi
nop
nop
and $17781, %rax
mov $105, %rcx
...
nop
add $60590, %rdi
lea addresses_A_ht+0x18c26, %r12
clflush (%r12)
nop
nop
nop
...
nop
and %rcx, %rcx
lea addresses_A_ht+0xf3e8, %rsi
lea addresses_normal_ht+0x1de8, %rdi
nop
nop
nop
nop
...
nop
dec %r13
lea addresses_UC_ht+0xc626, %rcx
nop
nop
nop
nop
...
nop
cmp $25292, %rax
lea addresses_D_ht+0x3bb8, %rax
nop
add %r8, %r8
movl $0x61626364, (%rax)
sub $12572, %rax
lea addresses_WC_ht+0xd150, %rax
nop
nop
nop
nop
...
nop
xor %rcx, %rcx
lea addresses_D_ht+0x87e8, %rsi
lea addresses_A_ht+0x1b7e8, %rdi
nop
nop
nop
nop
...
rep movsw
and $34083, %rdi
lea addresses_D_ht+0x13228, %r15
nop
nop
nop
nop
...
movaps %xmm7, (%r15)
cmp %rcx, %rcx
lea addresses_UC_ht+0x8de8, %rbx
and $48927, %r14
movl $0x61626364, (%rbx)
cmp %rsi, %rsi
pop %rsi
...
{'src': {'same': False, 'congruent': 2, 'type': 'addresses_normal_ht'}, 'OP': 'REPM', 'dst': {'same': False, 'congruent': 3, 'type': 'addresses_normal_ht'}}
...
{'OP': 'STOR', 'dst': {'NT': False, 'same': True, 'congruent': 4, 'type': 'addresses_D_ht', 'AVXalign': False, 'size': 4}}
...
{'OP': 'STOR', 'dst': {'NT': False, 'same': False, 'congruent': 4, 'type': 'addresses_D_ht', 'AVXalign': True, 'size': 16}}
