...
push %rdi
push %rsi
lea addresses_WT_ht+0x18eb9, %rsi
lea addresses_UC_ht+0xc199, %rdi
nop
nop
sub %rbp, %rbp
mov $5, %rcx
...
nop
and $32137, %r9
lea addresses_WC_ht+0x10bf9, %rsi
lea addresses_WC_ht+0x16d19, %rdi
inc %r15
mov $93, %rcx
rep movsb
nop
nop
cmp %r9, %r9
lea addresses_normal_ht+0xfd19, %r9
nop
nop
and %r11, %r11
...
nop
sub $58305, %r15
lea addresses_UC_ht+0x7c79, %rcx
clflush (%rcx)
nop
nop
nop
...
nop
add $23585, %r11
lea addresses_normal_ht+0x1e391, %rbp
nop
nop
nop
nop
...
mov (%rbp), %r9d
cmp $55081, %r11
lea addresses_UC_ht+0x15159, %rdi
nop
nop
nop
add %r15, %r15
...
vmovups %ymm6, (%rdi)
xor $40613, %rsi
lea addresses_A_ht+0x17f45, %rbp
add $3926, %rsi
vmovups (%rbp), %ymm7
...
nop
mfence
lea addresses_D_ht+0xbc89, %rsi
lea addresses_D_ht+0x1b9d9, %rdi
nop
nop
cmp $54140, %rbx
mov $13, %rcx
...
nop
xor $29788, %rsi
lea addresses_normal_ht+0xcd9, %rdi
nop
nop
nop
nop
...
nop
xor $14169, %r9
lea addresses_D_ht+0x10819, %rsi
lea addresses_WC_ht+0x3419, %rdi
nop
inc %r9
mov $58, %rcx
rep movsl
...
nop
and $41349, %rcx
lea addresses_WC_ht+0x17359, %rsi
lea addresses_UC_ht+0x13319, %rdi
clflush (%rsi)
nop
nop
nop
...
nop
xor $4905, %rdi
lea addresses_WT_ht+0x17519, %rsi
lea addresses_UC_ht+0x16d19, %rdi
clflush (%rsi)
nop
xor %r9, %r9
mov $120, %rcx
...
{'OP': 'REPM', 'src': {'type': 'addresses_WC_ht', 'congruent': 3, 'same': False}, 'dst': {'type': 'addresses_WC_ht', 'congruent': 8, 'same': False}}
...
{'OP': 'REPM', 'src': {'type': 'addresses_WT_ht', 'congruent': 11, 'same': False}, 'dst': {'type': 'addresses_UC_ht', 'congruent': 10, 'same': True}}
{'00': 21829}
