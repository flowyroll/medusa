...
push %rdi
push %rsi
lea addresses_WT_ht+0x1ac7e, %rsi
lea addresses_A_ht+0x13c56, %rdi
nop
nop
nop
nop
...
rep movsq
xor $38838, %r15
lea addresses_normal_ht+0x406e, %r8
xor %rdi, %rdi
movups (%r8), %xmm4
vpextrq $0, %xmm4, %rcx
nop
...
nop
xor $11442, %rcx
lea addresses_normal_ht+0x1b056, %rsi
and $2025, %r14
mov (%rsi), %edi
nop
nop
cmp %rsi, %rsi
lea addresses_WC_ht+0x4a16, %rsi
nop
nop
nop
xor $5375, %r15
...
nop
xor $7659, %r15
lea addresses_normal_ht+0x4303, %rax
nop
nop
nop
xor $45779, %rcx
...
lea addresses_normal_ht+0x15856, %rdi
nop
dec %rax
mov $95, %rcx
rep movsl
...
nop
dec %r14
lea addresses_UC_ht+0xd456, %rcx
nop
nop
nop
and %r8, %r8
...
{'OP': 'LOAD', 'src': {'type': 'addresses_normal_ht', 'AVXalign': False, 'congruent': 11, 'size': 4, 'same': True, 'NT': False}}
