...
push %rdx
push %rsi
lea addresses_D_ht+0x16665, %r12
nop
and %rcx, %rcx
mov (%r12), %r11d
nop
xor %rsi, %rsi
lea addresses_A_ht+0x13bb1, %rbx
clflush (%rbx)
nop
nop
nop
...
lea addresses_UC_ht+0x54bc, %rdi
clflush (%rsi)
nop
nop
nop
...
nop
and %rdx, %rdx
lea addresses_WC_ht+0x12bd5, %r12
nop
inc %r11
movups (%r12), %xmm6
vpextrq $1, %xmm6, %rsi
sub $63884, %rbp
lea addresses_WT_ht+0xd665, %rdx
nop
xor $19007, %rdi
movb (%rdx), %r11b
nop
...
nop
add %rdx, %rdx
lea addresses_D_ht+0x1b9c5, %rdx
nop
nop
inc %rbx
movups (%rdx), %xmm5
...
nop
xor $13576, %rdi
lea addresses_UC_ht+0x17e65, %rsi
lea addresses_WC_ht+0x1dd7d, %rdi
nop
and $25747, %rbx
mov $87, %rcx
rep movsq
...
nop
xor $7853, %r11
lea addresses_UC_ht+0x1e9d5, %rbp
nop
xor %r12, %r12
mov (%rbp), %rsi
nop
and $209, %rsi
lea addresses_D_ht+0xf919, %rbx
nop
nop
nop
inc %rdx
...
nop
and %r11, %r11
lea addresses_UC_ht+0x665, %rsi
lea addresses_UC_ht+0xe665, %rdi
nop
nop
nop
nop
...
nop
dec %rdi
lea addresses_WC_ht+0x1c3e9, %rsi
lea addresses_normal_ht+0x12590, %rdi
nop
nop
nop
cmp $39554, %rbp
...
{'src': {'NT': False, 'same': True, 'congruent': 5, 'type': 'addresses_D_ht', 'AVXalign': False, 'size': 16}, 'OP': 'LOAD'}
{'src': {'same': False, 'congruent': 11, 'type': 'addresses_UC_ht'}, 'OP': 'REPM', 'dst': {'same': True, 'congruent': 3, 'type': 'addresses_WC_ht'}}
