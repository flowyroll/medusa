...
push %rdi
push %rsi
lea addresses_A_ht+0xf71e, %rsi
lea addresses_WC_ht+0x1459e, %rdi
nop
nop
nop
nop
...
nop
xor %rax, %rax
lea addresses_A_ht+0x94ae, %rsi
lea addresses_D_ht+0x174e2, %rdi
nop
nop
and $4787, %r14
mov $40, %rcx
...
nop
add %rbx, %rbx
lea addresses_UC_ht+0xab9e, %rsi
lea addresses_D_ht+0xaa9e, %rdi
nop
nop
nop
nop
...
nop
and %rax, %rax
lea addresses_WC_ht+0x3d0e, %r15
nop
nop
nop
xor $38270, %rdi
...
nop
inc %rbx
lea addresses_WT_ht+0x116de, %rsi
lea addresses_normal_ht+0x1129e, %rdi
nop
nop
inc %r12
mov $28, %rcx
...
nop
and %r15, %r15
lea addresses_WC_ht+0x3c86, %rsi
xor $44424, %rcx
...
nop
add $15711, %rax
lea addresses_WT_ht+0x1029e, %rax
nop
nop
nop
nop
...
// Store
mov $0x4be499000000011e, %r10
sub %rax, %rax
movw $0x5152, (%r10)
xor %r12, %r12

// Faulty Load
lea addresses_WT+0x19a9e, %r13
nop
sub $40664, %r9
movups (%r13), %xmm5
vpextrq $0, %xmm5, %r10
...
<gen_prepare_buffer>
{'src': {'same': False, 'congruent': 6, 'type': 'addresses_A_ht'}, 'OP': 'REPM', 'dst': {'same': False, 'congruent': 8, 'type': 'addresses_WC_ht'}}
{'src': {'same': False, 'congruent': 4, 'type': 'addresses_A_ht'}, 'OP': 'REPM', 'dst': {'same': False, 'congruent': 1, 'type': 'addresses_D_ht'}}
{'src': {'same': False, 'congruent': 7, 'type': 'addresses_UC_ht'}, 'OP': 'REPM', 'dst': {'same': False, 'congruent': 10, 'type': 'addresses_D_ht'}}
...
{'OP': 'STOR', 'dst': {'NT': False, 'same': True, 'congruent': 11, 'type': 'addresses_D_ht', 'AVXalign': True, 'size': 1}}
