...
push %rdi
push %rsi
lea addresses_WC_ht+0xb3ea, %rsi
lea addresses_normal_ht+0x8e5e, %rdi
clflush (%rdi)
nop
xor %r15, %r15
mov $108, %rcx
...
nop
and %rbx, %rbx
lea addresses_D_ht+0x569e, %rsi
lea addresses_WT_ht+0x1a25e, %rdi
sub %r10, %r10
mov $37, %rcx
rep movsw
nop
...
// Load
lea addresses_normal+0x1cda3, %rax
nop
nop
and $9300, %rbp
vmovups (%rax), %ymm0
...
{'OP': 'REPM', 'src': {'type': 'addresses_D_ht', 'congruent': 4, 'same': False}, 'dst': {'type': 'addresses_WT_ht', 'congruent': 9, 'same': True}}
{'00': 4577}
