...
push %rdi
push %rsi
lea addresses_D_ht+0x3e71, %rsi
lea addresses_WC_ht+0x3011, %rdi
xor $36253, %rbx
mov $17, %rcx
rep movsl
cmp $52138, %rbx
lea addresses_normal_ht+0x1c5a9, %rdi
nop
nop
nop
nop
...
movl $0x61626364, (%rdi)
add %rdi, %rdi
lea addresses_WC_ht+0x1da11, %r10
nop
nop
nop
nop
...
mov (%r10), %di
dec %rsi
lea addresses_normal_ht+0x7420, %rsi
lea addresses_WT_ht+0xfa11, %rdi
nop
xor $35472, %rbp
mov $1, %rcx
rep movsl
nop
dec %rcx
lea addresses_D_ht+0x151a5, %rcx
nop
nop
nop
nop
...
nop
sub $6900, %r13
lea addresses_D_ht+0xcdd1, %rsi
lea addresses_WC_ht+0x8311, %rdi
nop
nop
nop
cmp %rbx, %rbx
...
nop
add %r10, %r10
lea addresses_normal_ht+0x7511, %rsi
lea addresses_WC_ht+0x1ccc9, %rdi
nop
nop
nop
nop
...
rep movsw
cmp $24728, %rcx
lea addresses_WT_ht+0x833f, %rsi
lea addresses_A_ht+0x1e711, %rdi
nop
nop
xor %rbx, %rbx
mov $77, %rcx
...
nop
and $7807, %r8
lea addresses_normal_ht+0xf611, %r13
nop
nop
nop
nop
...
nop
sub %rsi, %rsi
lea addresses_WC_ht+0x1ced1, %r8
nop
nop
nop
nop
...
nop
sub $30436, %rcx
lea addresses_UC_ht+0x6611, %r13
nop
mfence
movl $0x61626364, (%r13)
nop
...
nop
xor $61531, %r8
lea addresses_WT_ht+0x3811, %rsi
lea addresses_UC_ht+0xe611, %rdi
nop
nop
nop
add %r8, %r8
...
nop
lfence
lea addresses_normal_ht+0x1c7e5, %rbx
nop
dec %r13
mov (%rbx), %rbp
nop
...
{'OP': 'REPM', 'src': {'type': 'addresses_normal_ht', 'congruent': 8, 'same': True}, 'dst': {'type': 'addresses_WC_ht', 'congruent': 1, 'same': False}}
