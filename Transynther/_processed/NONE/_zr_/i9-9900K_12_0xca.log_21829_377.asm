...
push %rdi
push %rsi
lea addresses_D_ht+0x959d, %rsi
lea addresses_WC_ht+0xb9de, %rdi
clflush (%rsi)
nop
nop
nop
...
nop
sub $26830, %r12
lea addresses_D_ht+0x9716, %rcx
nop
cmp $5023, %r15
mov (%rcx), %rdi
nop
inc %r12
lea addresses_WC_ht+0x15c7e, %rsi
lea addresses_D_ht+0x1c2de, %rdi
clflush (%rsi)
nop
cmp $30152, %r11
mov $10, %rcx
rep movsb
inc %rcx
lea addresses_UC_ht+0x180de, %rdi
nop
nop
and %r12, %r12
vmovups (%rdi), %ymm0
...
vpextrq $1, %xmm0, %rsi
inc %rsi
lea addresses_normal_ht+0x115de, %rsi
lea addresses_D_ht+0x197fe, %rdi
nop
nop
nop
add %rbp, %rbp
...
rep movsl
sub %rbx, %rbx
lea addresses_WT_ht+0x17cde, %rsi
cmp $43368, %r15
mov (%rsi), %r11w
nop
nop
nop
and $22968, %rbp
lea addresses_normal_ht+0x279e, %r15
nop
nop
cmp $61539, %r12
mov (%r15), %r11d
...
lea addresses_UC_ht+0x129de, %rdi
nop
nop
sub %r11, %r11
mov $105, %rcx
...
nop
and $24233, %r15
lea addresses_A_ht+0x154de, %rbp
nop
nop
nop
nop
...
vpextrq $0, %xmm3, %r11
inc %r11
lea addresses_WC_ht+0xf7de, %rcx
nop
nop
dec %r15
mov (%rcx), %r12d
sub $49331, %rbx
lea addresses_UC_ht+0xbdde, %rcx
nop
nop
nop
dec %r12
...
nop
sub $17636, %r15
lea addresses_WT_ht+0x1ac34, %rsi
lea addresses_WT_ht+0xa8de, %rdi
nop
nop
xor %r11, %r11
mov $43, %rcx
...
// Store
lea addresses_normal+0x843e, %r11
xor %r14, %r14
...
<gen_prepare_buffer>
{'OP': 'REPM', 'src': {'same': False, 'type': 'addresses_D_ht', 'congruent': 0}, 'dst': {'same': False, 'type': 'addresses_WC_ht', 'congruent': 6}}
...
{'OP': 'REPM', 'src': {'same': False, 'type': 'addresses_normal_ht', 'congruent': 7}, 'dst': {'same': False, 'type': 'addresses_D_ht', 'congruent': 5}}
...
{'OP': 'REPM', 'src': {'same': False, 'type': 'addresses_normal_ht', 'congruent': 4}, 'dst': {'same': False, 'type': 'addresses_UC_ht', 'congruent': 7}}
