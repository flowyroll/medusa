...
nop
cmp $31766, %r14
lea addresses_WT_ht+0x1cbe0, %rsi
lea addresses_WT_ht+0x159e0, %rdi
nop
nop
lfence
mov $57, %rcx
rep movsq
sub $19071, %rsi
lea addresses_WT_ht+0x14470, %rsi
cmp $63767, %rdi
movb (%rsi), %cl
nop
nop
...
{'OP': 'LOAD', 'src': {'size': 16, 'NT': False, 'type': 'addresses_UC', 'same': False, 'AVXalign': False, 'congruent': 11}}
[Faulty Load]
{'OP': 'LOAD', 'src': {'size': 8, 'NT': False, 'type': 'addresses_WT', 'same': True, 'AVXalign': False, 'congruent': 0}}
<gen_prepare_buffer>
{'OP': 'STOR', 'dst': {'size': 16, 'NT': True, 'type': 'addresses_D_ht', 'same': True, 'AVXalign': True, 'congruent': 1}}
...
{'OP': 'STOR', 'dst': {'size': 16, 'NT': False, 'type': 'addresses_A_ht', 'same': True, 'AVXalign': False, 'congruent': 2}}
