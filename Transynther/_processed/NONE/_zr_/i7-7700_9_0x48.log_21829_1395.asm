...
nop
sub $30033, %r12
lea addresses_A_ht+0x11537, %rdx
add %rbx, %rbx
movb (%rdx), %al
nop
nop
...
nop
sub $641, %rbx
lea addresses_WT_ht+0x10a54, %rbx
nop
nop
nop
nop
...
nop
sub $52983, %rdx
lea addresses_WC_ht+0x1a00a, %r10
nop
nop
mfence
movb $0x61, (%r10)
mfence
lea addresses_WC_ht+0xd20a, %rdx
nop
nop
nop
cmp %rax, %rax
...
{'OP': 'LOAD', 'src': {'type': 'addresses_WT_ht', 'AVXalign': False, 'congruent': 1, 'size': 32, 'same': True, 'NT': False}}
