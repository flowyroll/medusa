...
push %rbp
push %rdi
lea addresses_WT_ht+0x19b8e, %rdi
nop
nop
and %r12, %r12
...
nop
sub %r15, %r15
lea addresses_WC_ht+0x43c6, %r10
nop
nop
xor $39203, %rbp
...
movups %xmm2, (%r10)
add %r15, %r15
lea addresses_normal_ht+0x19746, %r10
add %r13, %r13
mov (%r10), %r15d
nop
nop
nop
cmp $12469, %r13
lea addresses_D_ht+0x14256, %r11
nop
nop
nop
nop
