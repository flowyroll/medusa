...
push %rdi
push %rsi
lea addresses_WT_ht+0x172b6, %rsi
lea addresses_WC_ht+0xf4e6, %rdi
nop
nop
nop
nop
...
nop
sub $17979, %rcx
lea addresses_UC_ht+0x19d83, %r10
clflush (%r10)
nop
xor %rdi, %rdi
mov (%r10), %r13w
nop
cmp %rcx, %rcx
lea addresses_WC_ht+0x774e, %rsi
lea addresses_A_ht+0x1a5ae, %rdi
nop
nop
nop
nop
...
nop
sub %r10, %r10
lea addresses_WT_ht+0x64ce, %rsi
nop
nop
sub $5309, %rbp
...
nop
cmp %rsi, %rsi
lea addresses_D_ht+0x15d4e, %r12
nop
nop
nop
sub %rbp, %rbp
...
nop
dec %rsi
lea addresses_A_ht+0xb9da, %rsi
lea addresses_D_ht+0x11d0e, %rdi
nop
nop
nop
xor %rbx, %rbx
...
nop
add $30388, %r13
lea addresses_UC_ht+0x1ed2e, %rdi
nop
nop
add %rsi, %rsi
mov (%rdi), %bx
...
nop
xor %r13, %r13
lea addresses_normal_ht+0x12e, %rsi
lea addresses_D_ht+0x16d70, %rdi
clflush (%rsi)
nop
nop
inc %r13
...
nop
sub %r10, %r10
lea addresses_UC_ht+0x11d9e, %rbp
nop
nop
nop
inc %r12
...
<gen_prepare_buffer>
{'OP': 'REPM', 'src': {'same': False, 'type': 'addresses_WT_ht', 'congruent': 2}, 'dst': {'same': False, 'type': 'addresses_WC_ht', 'congruent': 3}}
...
{'OP': 'REPM', 'src': {'same': False, 'type': 'addresses_normal_ht', 'congruent': 9}, 'dst': {'same': True, 'type': 'addresses_D_ht', 'congruent': 1}}
