...
nop
sub %r15, %r15
lea addresses_D_ht+0x11c2f, %rsi
lea addresses_normal_ht+0x894f, %rdi
nop
add $28558, %r9
mov $116, %rcx
rep movsq
...
nop
xor $58300, %rcx
lea addresses_UC_ht+0xffaf, %r12
clflush (%r12)
add $13600, %rdi
movups (%r12), %xmm7
vpextrq $1, %xmm7, %r15
...
nop
sub %r9, %r9
lea addresses_WC_ht+0xa74f, %rax
nop
nop
nop
xor %rdi, %rdi
...
nop
add %rcx, %rcx
lea addresses_D_ht+0x16f4f, %rsi
lea addresses_WC_ht+0x36cf, %rdi
clflush (%rsi)
nop
sub $38672, %rax
mov $121, %rcx
...
nop
xor $65250, %rax
lea addresses_normal_ht+0x944f, %r15
and %r9, %r9
mov (%r15), %cx
nop
nop
nop
xor $11541, %rcx
lea addresses_A_ht+0x12f4f, %rcx
nop
nop
nop
add %rdi, %rdi
...
{'OP': 'REPM', 'src': {'type': 'addresses_D_ht', 'congruent': 2, 'same': False}, 'dst': {'type': 'addresses_normal_ht', 'congruent': 8, 'same': False}}
