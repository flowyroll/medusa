...
push %rdi
push %rsi
lea addresses_UC_ht+0xd1f5, %r11
nop
nop
nop
cmp %r10, %r10
...
nop
sub $62800, %r10
lea addresses_normal_ht+0x1b88d, %rsi
lea addresses_A_ht+0x571d, %rdi
nop
nop
and %r8, %r8
mov $102, %rcx
...
nop
lfence
lea addresses_normal_ht+0x199f5, %rsi
lea addresses_WT_ht+0x34fd, %rdi
nop
nop
nop
nop
...
nop
sub %r11, %r11
lea addresses_D_ht+0x174a3, %r11
nop
nop
nop
nop
...
nop
sub $39336, %r11
lea addresses_D_ht+0x16755, %r11
nop
and $62637, %rdi
movw $0x6162, (%r11)
nop
...
{'OP': 'STOR', 'dst': {'congruent': 4, 'AVXalign': False, 'same': False, 'size': 16, 'NT': True, 'type': 'addresses_P'}}
{'OP': 'STOR', 'dst': {'congruent': 5, 'AVXalign': False, 'same': False, 'size': 1, 'NT': False, 'type': 'addresses_D'}}
...
{'src': {'congruent': 11, 'same': False, 'type': 'addresses_normal_ht'}, 'OP': 'REPM', 'dst': {'congruent': 3, 'same': False, 'type': 'addresses_WT_ht'}}
{'OP': 'STOR', 'dst': {'congruent': 1, 'AVXalign': False, 'same': False, 'size': 2, 'NT': False, 'type': 'addresses_D_ht'}}
{'OP': 'STOR', 'dst': {'congruent': 5, 'AVXalign': True, 'same': False, 'size': 2, 'NT': False, 'type': 'addresses_D_ht'}}
{'00': 21829}
