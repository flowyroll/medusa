...
push %rdx
push %rsi
lea addresses_A_ht+0x1aeec, %rbp
nop
nop
nop
nop
...
nop
sub $48073, %rbx
lea addresses_WC_ht+0x1c6ec, %rdi
inc %rcx
movups (%rdi), %xmm4
vpextrq $1, %xmm4, %rsi
nop
...
nop
cmp $9395, %rbp
lea addresses_normal_ht+0x11ec, %rbp
dec %rdx
...
nop
inc %rdx
lea addresses_WT_ht+0x1eec, %rdx
clflush (%rdx)
nop
nop
nop
...
vpextrq $0, %xmm4, %r14
add $27354, %rsi
lea addresses_D_ht+0x11414, %rdx
clflush (%rdx)
cmp $32581, %rbp
movb (%rdx), %r14b
cmp %r14, %r14
lea addresses_WT_ht+0x182ec, %rsi
nop
xor %rbp, %rbp
vmovups (%rsi), %ymm5
...
vpextrq $0, %xmm5, %rbx
inc %rcx
lea addresses_UC_ht+0x146ec, %rsi
...
nop
sub $46043, %rdi
lea addresses_WT_ht+0x51a4, %rsi
lea addresses_D_ht+0xa8ec, %rdi
nop
nop
xor %rbx, %rbx
mov $112, %rcx
...
nop
sub $17515, %rdx
lea addresses_normal_ht+0x6e34, %r14
nop
nop
nop
nop
...
nop
sub %r14, %r14
lea addresses_WT_ht+0x117ec, %rdx
nop
nop
nop
nop
...
nop
and $65498, %rsi
lea addresses_WC_ht+0x10d84, %rcx
xor %rbp, %rbp
mov (%rcx), %si
nop
nop
sub %rdi, %rdi
lea addresses_D_ht+0xea67, %rdi
nop
nop
nop
nop
...
movq %r14, (%rdi)
sub %rbx, %rbx
lea addresses_D_ht+0x1b14c, %rbp
nop
nop
nop
cmp %r14, %r14
...
{'OP': 'REPM', 'src': {'type': 'addresses_WT_ht', 'congruent': 3, 'same': True}, 'dst': {'type': 'addresses_D_ht', 'congruent': 9, 'same': True}}
...
{'OP': 'STOR', 'dst': {'type': 'addresses_D_ht', 'AVXalign': True, 'congruent': 0, 'size': 8, 'same': False, 'NT': True}}
