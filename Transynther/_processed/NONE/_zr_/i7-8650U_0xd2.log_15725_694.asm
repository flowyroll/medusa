...
push %rdi
push %rsi
lea addresses_D_ht+0x12a48, %rsi
lea addresses_WT_ht+0x1ec8, %rdi
nop
nop
nop
nop
...
{'OP': 'STOR', 'dst': {'type': 'addresses_D', 'size': 16, 'AVXalign': True, 'NT': False, 'congruent': 2, 'same': False}}
