...
nop
dec %rdx
lea addresses_WC_ht+0x164e9, %r14
nop
nop
nop
add %rbx, %rbx
...
nop
and %rbx, %rbx
lea addresses_UC_ht+0x1ab83, %rsi
...
nop
sub $27540, %rcx
lea addresses_WC_ht+0x190e9, %rbx
clflush (%rbx)
nop
nop
sub %rsi, %rsi
...
nop
add %r14, %r14
lea addresses_UC_ht+0xcce9, %rsi
nop
nop
dec %rbx
mov (%rsi), %r14d
...
nop
dec %rsi
lea addresses_A_ht+0x16de9, %r13
clflush (%r13)
nop
nop
nop
...
nop
xor %rsi, %rsi
lea addresses_WC_ht+0xa6e9, %rsi
lea addresses_D_ht+0x116e9, %rdi
nop
nop
cmp $29619, %r8
mov $120, %rcx
...
movups %xmm0, (%rdi)
dec %rsi
lea addresses_UC_ht+0x1e6e9, %rdi
cmp $44640, %r13
mov (%rdi), %r8w
nop
nop
...
nop
add %r14, %r14
lea addresses_WT_ht+0x15509, %r8
nop
inc %r14
movups (%r8), %xmm6
vpextrq $0, %xmm6, %rdi
nop
xor %r13, %r13
lea addresses_normal_ht+0x14e9, %rsi
lea addresses_D_ht+0x1e3a9, %rdi
nop
nop
and %rdx, %rdx
mov $61, %rcx
...
nop
and %rcx, %rcx
lea addresses_D_ht+0x10869, %rcx
nop
inc %rdi
movb $0x61, (%rcx)
add %rdi, %rdi
lea addresses_A_ht+0x1bae9, %rdi
nop
nop
nop
nop
...
<gen_prepare_buffer>
{'src': {'same': False, 'congruent': 11, 'type': 'addresses_WC_ht'}, 'OP': 'REPM', 'dst': {'same': False, 'congruent': 5, 'type': 'addresses_WC_ht'}}
{'OP': 'STOR', 'dst': {'NT': False, 'same': False, 'congruent': 3, 'type': 'addresses_WC_ht', 'AVXalign': False, 'size': 2}}
{'src': {'same': False, 'congruent': 1, 'type': 'addresses_UC_ht'}, 'OP': 'REPM', 'dst': {'same': False, 'congruent': 4, 'type': 'addresses_normal_ht'}}
{'src': {'NT': False, 'same': True, 'congruent': 2, 'type': 'addresses_A_ht', 'AVXalign': False, 'size': 1}, 'OP': 'LOAD'}
{'OP': 'STOR', 'dst': {'NT': False, 'same': True, 'congruent': 7, 'type': 'addresses_WC_ht', 'AVXalign': False, 'size': 8}}
...
{'src': {'same': False, 'congruent': 10, 'type': 'addresses_WC_ht'}, 'OP': 'REPM', 'dst': {'same': False, 'congruent': 9, 'type': 'addresses_D_ht'}}
