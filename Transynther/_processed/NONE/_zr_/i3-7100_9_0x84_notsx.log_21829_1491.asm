...
push %rbp
push %rcx
lea addresses_WT_ht+0x120f0, %rcx
nop
nop
nop
nop
...
// Load
lea addresses_normal+0x10970, %rdi
nop
add %rsi, %rsi
mov (%rdi), %r13d
