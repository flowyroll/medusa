...
push %rdx
push %rsi
lea addresses_UC_ht+0x84cc, %r12
nop
nop
nop
dec %rdi
...
nop
and %r15, %r15
lea addresses_D_ht+0x561d, %r13
cmp $34418, %rsi
movups (%r13), %xmm7
vpextrq $1, %xmm7, %r9
add %r12, %r12
lea addresses_A_ht+0x9f95, %rsi
lea addresses_D_ht+0x1ca3d, %rdi
nop
nop
nop
sub %r9, %r9
...
nop
cmp %r9, %r9
lea addresses_WT_ht+0x835d, %r13
nop
nop
cmp $22674, %rdx
movb (%r13), %r9b
nop
xor $64079, %rsi
lea addresses_WC_ht+0x1b01d, %r9
sub $64334, %r12
mov $0x6162636465666768, %rdi
movq %rdi, (%r9)
add $59948, %r12
lea addresses_UC_ht+0x160dd, %r12
nop
nop
nop
xor %r15, %r15
...
nop
and %r12, %r12
lea addresses_WT_ht+0x11d45, %rsi
lea addresses_A_ht+0xf31d, %rdi
nop
nop
nop
add $62259, %r9
...
nop
sub $17100, %rdx
lea addresses_normal_ht+0x7ffd, %rdx
nop
nop
nop
nop
...
nop
and %r15, %r15
lea addresses_WC_ht+0xafdd, %rsi
nop
nop
nop
dec %r9
...
movups %xmm6, (%rsi)
and $29063, %r9
lea addresses_WC_ht+0x9ddd, %rdi
nop
nop
add $46232, %r9
movb $0x61, (%rdi)
...
{'OP': 'STOR', 'dst': {'type': 'addresses_WC_ht', 'AVXalign': True, 'congruent': 2, 'size': 8, 'same': True, 'NT': False}}
