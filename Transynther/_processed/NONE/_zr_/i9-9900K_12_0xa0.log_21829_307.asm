...
push %rdx
push %rsi
lea addresses_WT_ht+0x110e4, %rsi
...
nop
cmp $8261, %rbx
lea addresses_normal_ht+0x41e4, %rsi
lea addresses_WC_ht+0x17d24, %rdi
nop
nop
nop
nop
...
nop
cmp %r9, %r9
lea addresses_WC_ht+0x5ee4, %rsi
and %rdx, %rdx
movw $0x6162, (%rsi)
nop
nop
...
nop
cmp %rsi, %rsi
lea addresses_WC_ht+0x1b684, %rdi
nop
nop
nop
and %r9, %r9
...
lea addresses_UC_ht+0xddad, %rdi
nop
xor $39706, %r10
mov $18, %rcx
rep movsw
...
{'src': {'same': True, 'congruent': 11, 'type': 'addresses_WC_ht'}, 'OP': 'REPM', 'dst': {'same': False, 'congruent': 0, 'type': 'addresses_UC_ht'}}
{'00': 21829}
