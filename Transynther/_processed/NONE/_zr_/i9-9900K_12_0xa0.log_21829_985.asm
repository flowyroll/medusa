...
push %rdx
push %rsi
lea addresses_WT_ht+0x37b7, %r15
nop
sub $4028, %r10
...
vmovaps %ymm5, (%r15)
add $13662, %rdx
lea addresses_normal_ht+0x46b7, %r15
clflush (%r15)
nop
sub %rsi, %rsi
...
nop
xor %rbp, %rbp
lea addresses_WT_ht+0x7663, %rbp
lfence
movb $0x61, (%rbp)
nop
nop
...
nop
cmp %rbp, %rbp
lea addresses_UC_ht+0x81b7, %rsi
lea addresses_UC_ht+0x1377, %rdi
nop
nop
nop
xor %rdx, %rdx
...
<gen_prepare_buffer>
{'OP': 'STOR', 'dst': {'NT': False, 'same': False, 'congruent': 6, 'type': 'addresses_WT_ht', 'AVXalign': True, 'size': 32}}
