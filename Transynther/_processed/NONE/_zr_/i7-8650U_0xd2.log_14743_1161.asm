...
push %rdx
push %rsi
lea addresses_WT_ht+0x4bcb, %r15
clflush (%r15)
nop
nop
nop
...
nop
xor %r12, %r12
lea addresses_WC_ht+0xd733, %r14
nop
and $61771, %rcx
mov (%r14), %rdx
nop
...
nop
add %r15, %r15
lea addresses_WT_ht+0x2153, %rdx
nop
nop
nop
cmp %r15, %r15
...
nop
dec %r12
lea addresses_WT_ht+0x1188a, %rsi
lea addresses_D_ht+0x65b3, %rdi
and %r11, %r11
mov $97, %rcx
rep movsb
xor $6770, %r15
lea addresses_WT_ht+0x1ecd3, %rdi
clflush (%rdi)
nop
nop
nop
...
movl $0x61626364, (%rdi)
add %r14, %r14
lea addresses_A_ht+0x1ded3, %r11
clflush (%r11)
nop
nop
nop
...
nop
dec %r15
lea addresses_D_ht+0x208a, %rsi
lea addresses_UC_ht+0x4ed3, %rdi
clflush (%rsi)
nop
nop
nop
...
// Store
lea addresses_normal+0x1d546, %rbp
nop
nop
dec %rax
