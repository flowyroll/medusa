...
lea addresses_WT_ht+0x6f5c, %rdi
nop
add %rax, %rax
mov $19, %rcx
rep movsw
...
nop
dec %r9
lea addresses_UC_ht+0x14668, %rsi
lea addresses_D_ht+0x293c, %rdi
nop
nop
nop
nop
...
lea addresses_D_ht+0x142fc, %rdi
nop
nop
nop
cmp %rbp, %rbp
...
nop
xor $52186, %rbp
lea addresses_WC_ht+0x5488, %r11
nop
nop
cmp %rsi, %rsi
movups (%r11), %xmm6
vpextrq $0, %xmm6, %rbp
cmp %r11, %r11
lea addresses_normal_ht+0xe1dc, %rsi
nop
add $42344, %rbp
movw $0x6162, (%rsi)
nop
dec %rcx
lea addresses_WC_ht+0x758c, %rsi
clflush (%rsi)
nop
nop
nop
