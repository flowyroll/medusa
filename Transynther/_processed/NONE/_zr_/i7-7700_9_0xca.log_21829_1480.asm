...
push %rdx
push %rsi
lea addresses_WT_ht+0x7b09, %rsi
nop
nop
add $26867, %rbp
vmovups (%rsi), %ymm0
...
nop
sub $24815, %r13
lea addresses_D_ht+0x14b61, %rdx
nop
nop
nop
and %rdi, %rdi
...
nop
xor $18874, %rsi
lea addresses_normal_ht+0x3281, %rbp
nop
nop
and $50750, %rax
...
nop
and %rcx, %rcx
lea addresses_UC_ht+0xbbe1, %rcx
nop
inc %rdx
mov (%rcx), %rsi
nop
...
nop
xor %rdx, %rdx
lea addresses_UC_ht+0x8061, %rsi
nop
add $43978, %r10
mov (%rsi), %dx
nop
...
{'OP': 'STOR', 'dst': {'congruent': 6, 'AVXalign': False, 'same': False, 'size': 16, 'NT': True, 'type': 'addresses_WT'}}
