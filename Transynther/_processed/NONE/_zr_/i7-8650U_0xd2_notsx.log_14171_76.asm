...
nop
mfence
lea addresses_WT_ht+0x344c, %r11
clflush (%r11)
nop
nop
nop
...
mov (%r11), %rdi
and $50215, %rbx
lea addresses_WT_ht+0xda4c, %rax
cmp $62510, %r15
mov (%rax), %esi
nop
nop
...
nop
and %rbx, %rbx
lea addresses_normal_ht+0x734c, %rsi
lea addresses_A_ht+0xd04c, %rdi
nop
cmp $2101, %rax
mov $88, %rcx
rep movsq
...
nop
xor $32950, %rbx
lea addresses_WT_ht+0x1284c, %rsi
lea addresses_WC_ht+0x158ac, %rdi
nop
and $43979, %rbp
mov $112, %rcx
rep movsq
...
lea addresses_normal_ht+0x1e64c, %rdi
nop
xor $39723, %rbx
mov $75, %rcx
rep movsl
...
nop
and $37660, %rsi
lea addresses_normal_ht+0x14a4c, %r11
cmp $40963, %rcx
mov (%r11), %bp
nop
nop
...
// REPMOV
lea addresses_PSE+0x19e4c, %rsi
lea addresses_PSE+0x1498c, %rdi
nop
nop
nop
nop
...
{'OP': 'STOR', 'dst': {'type': 'addresses_WC', 'size': 4, 'AVXalign': False, 'NT': True, 'congruent': 3, 'same': False}}
{'OP': 'REPM', 'src': {'type': 'addresses_PSE', 'congruent': 0, 'same': True}, 'dst': {'type': 'addresses_PSE', 'congruent': 5, 'same': False}}
...
{'OP': 'STOR', 'dst': {'type': 'addresses_A_ht', 'size': 8, 'AVXalign': False, 'NT': True, 'congruent': 5, 'same': True}}
