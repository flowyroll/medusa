...
push %rdx
push %rsi
lea addresses_UC_ht+0x2cb9, %rbx
nop
nop
nop
nop
...
nop
cmp %rdx, %rdx
lea addresses_UC_ht+0x1e6f9, %r11
nop
nop
nop
nop
...
nop
inc %r8
lea addresses_UC_ht+0x16d01, %rsi
...
rep movsw
xor %rsi, %rsi
lea addresses_normal_ht+0x14f59, %rdi
nop
nop
and $15207, %rdx
movb (%rdi), %r11b
...
nop
sub %rdi, %rdi
lea addresses_normal_ht+0xf7b9, %rsi
lea addresses_WT_ht+0x120b9, %rdi
nop
nop
add %rbx, %rbx
mov $108, %rcx
...
nop
cmp %rsi, %rsi
lea addresses_D_ht+0x15db9, %rsi
nop
nop
cmp $7618, %rdi
movl $0x61626364, (%rsi)
...
nop
and %r8, %r8
lea addresses_WT_ht+0x1bab9, %rsi
lea addresses_normal_ht+0x91a1, %rdi
nop
nop
nop
add $44416, %rbx
...
rep movsq
add %rsi, %rsi
lea addresses_WC_ht+0x159b9, %rsi
lea addresses_UC_ht+0x1c921, %rdi
nop
nop
nop
nop
...
nop
and %rdx, %rdx
lea addresses_WC_ht+0x10eb9, %rax
nop
dec %r11
movw $0x6162, (%rax)
nop
...
{'OP': 'LOAD', 'src': {'type': 'addresses_WC', 'AVXalign': False, 'congruent': 3, 'size': 4, 'same': False, 'NT': False}}
...
{'OP': 'STOR', 'dst': {'type': 'addresses_UC_ht', 'AVXalign': False, 'congruent': 6, 'size': 4, 'same': True, 'NT': False}}
...
{'OP': 'STOR', 'dst': {'type': 'addresses_D_ht', 'AVXalign': False, 'congruent': 10, 'size': 4, 'same': True, 'NT': False}}
{'OP': 'REPM', 'src': {'type': 'addresses_WT_ht', 'congruent': 8, 'same': False}, 'dst': {'type': 'addresses_normal_ht', 'congruent': 3, 'same': False}}
{'OP': 'REPM', 'src': {'type': 'addresses_WC_ht', 'congruent': 10, 'same': False}, 'dst': {'type': 'addresses_UC_ht', 'congruent': 3, 'same': True}}
