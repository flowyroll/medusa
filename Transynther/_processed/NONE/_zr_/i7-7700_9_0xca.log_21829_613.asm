...
nop
sub $29229, %rax
lea addresses_A_ht+0x1b6d0, %rsi
lea addresses_normal_ht+0xcd8, %rdi
nop
xor %r10, %r10
mov $42, %rcx
rep movsw
...
nop
and $41028, %rdi
lea addresses_normal_ht+0x42a, %rsi
lea addresses_D_ht+0x106ea, %rdi
nop
nop
and $1305, %r13
mov $114, %rcx
...
nop
and $25577, %r13
lea addresses_WT_ht+0x56d8, %rax
nop
cmp $20692, %r13
...
nop
sub $21767, %r10
lea addresses_normal_ht+0x1e158, %rsi
nop
add $57671, %r14
movl $0x61626364, (%rsi)
nop
...
nop
sub %rdi, %rdi
lea addresses_A_ht+0x5ad8, %rsi
lea addresses_D_ht+0x13bd8, %rdi
nop
nop
nop
sub %r10, %r10
...
nop
xor %rdi, %rdi
lea addresses_normal_ht+0x1dd8, %rax
nop
and %r9, %r9
movw $0x6162, (%rax)
nop
...
nop
sub %r13, %r13
lea addresses_normal_ht+0x153d8, %r14
and $51857, %rsi
...
nop
inc %rsi
lea addresses_D_ht+0x12258, %rsi
lea addresses_WT_ht+0x15648, %rdi
nop
nop
inc %r10
mov $13, %rcx
rep movsq
xor $41860, %rcx
lea addresses_UC_ht+0xd898, %rsi
lea addresses_D_ht+0x1c4d8, %rdi
nop
nop
nop
nop
...
nop
and $9928, %r9
lea addresses_WC_ht+0x18bbf, %rdi
nop
nop
and $7260, %r10
movw $0x6162, (%rdi)
...
{'src': {'congruent': 2, 'same': False, 'type': 'addresses_A_ht'}, 'OP': 'REPM', 'dst': {'congruent': 10, 'same': False, 'type': 'addresses_normal_ht'}}
...
{'src': {'congruent': 8, 'same': False, 'type': 'addresses_A_ht'}, 'OP': 'REPM', 'dst': {'congruent': 7, 'same': False, 'type': 'addresses_D_ht'}}
