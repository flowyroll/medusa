...
nop
xor %r8, %r8
lea addresses_A_ht+0x1b537, %rsi
lea addresses_UC_ht+0xc137, %rdi
nop
and $28751, %r8
mov $84, %rcx
rep movsb
nop
cmp $45895, %r9
lea addresses_WT_ht+0x1d31d, %rax
nop
nop
nop
add %rsi, %rsi
...
{'OP': 'REPM', 'src': {'same': False, 'congruent': 6, 'type': 'addresses_RW'}, 'dst': {'same': False, 'congruent': 10, 'type': 'addresses_P'}}
...
{'OP': 'REPM', 'src': {'same': False, 'congruent': 8, 'type': 'addresses_A_ht'}, 'dst': {'same': False, 'congruent': 9, 'type': 'addresses_UC_ht'}}
