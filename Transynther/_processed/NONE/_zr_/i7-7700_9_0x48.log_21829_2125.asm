...
push %rdi
push %rsi
lea addresses_normal_ht+0x121f4, %r12
and $35839, %r10
movl $0x61626364, (%r12)
nop
cmp %r9, %r9
lea addresses_A_ht+0xa1b4, %rbp
nop
add %r11, %r11
...
nop
sub %r11, %r11
lea addresses_WT_ht+0x12c84, %rsi
...
nop
xor $63157, %r10
lea addresses_WC_ht+0xc574, %rsi
...
nop
sub %rcx, %rcx
lea addresses_UC_ht+0xcefc, %rsi
clflush (%rsi)
nop
nop
nop
...
nop
dec %r10
lea addresses_UC_ht+0x1e1f4, %r11
clflush (%r11)
and $250, %rdi
...
vpextrq $0, %xmm7, %r9
inc %r9
lea addresses_A_ht+0x1e6fc, %r10
nop
nop
sub %rbp, %rbp
movb (%r10), %r11b
...
{'OP': 'LOAD', 'src': {'type': 'addresses_A_ht', 'AVXalign': True, 'congruent': 6, 'size': 32, 'same': False, 'NT': False}}
