...
nop
sub %rdi, %rdi
lea addresses_WC_ht+0x108e8, %r15
nop
nop
nop
nop
...
{'OP': 'STOR', 'dst': {'type': 'addresses_D_ht', 'AVXalign': True, 'size': 32, 'NT': False, 'same': False, 'congruent': 2}}
