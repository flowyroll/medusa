...
nop
add $3930, %r13
lea addresses_D_ht+0x198a1, %rbx
nop
nop
nop
nop
...
movb $0x61, (%rbx)
xor %r10, %r10
lea addresses_D_ht+0xeeb6, %rsi
lea addresses_A_ht+0x12c24, %rdi
nop
nop
nop
nop
...
nop
add %r12, %r12
lea addresses_UC_ht+0x4a76, %rcx
clflush (%rcx)
nop
nop
nop
...
nop
sub $36423, %r10
lea addresses_WT_ht+0xf676, %rsi
...
nop
cmp %r12, %r12
lea addresses_WC_ht+0x1e7d6, %r13
clflush (%r13)
nop
nop
and $57981, %rsi
...
{'OP': 'STOR', 'dst': {'type': 'addresses_UC', 'size': 4, 'AVXalign': False, 'NT': True, 'congruent': 7, 'same': False}}
[Faulty Load]
...
{'OP': 'REPM', 'src': {'type': 'addresses_WT_ht', 'congruent': 8, 'same': True}, 'dst': {'type': 'addresses_D_ht', 'congruent': 10, 'same': False}}
