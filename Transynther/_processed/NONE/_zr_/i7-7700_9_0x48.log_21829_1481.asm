...
nop
dec %rcx
lea addresses_A_ht+0x1e471, %rsi
lea addresses_A_ht+0xbb8f, %rdi
nop
nop
nop
nop
...
rep movsl
xor $65071, %r12
lea addresses_WC_ht+0x4361, %r10
nop
add %rsi, %rsi
movl $0x61626364, (%r10)
nop
nop
and $28133, %r10
lea addresses_D_ht+0x1d049, %rsi
...
nop
sub %r15, %r15
lea addresses_WC_ht+0x60f9, %rcx
nop
nop
nop
nop
...
nop
inc %rcx
lea addresses_WT_ht+0x1ec49, %rdi
nop
sub %r9, %r9
mov (%rdi), %r10w
nop
...
lea addresses_normal_ht+0x16879, %rdi
nop
add %r15, %r15
mov $98, %rcx
rep movsb
...
nop
sub %rcx, %rcx
lea addresses_normal_ht+0x11c49, %rdi
nop
nop
xor %r15, %r15
...
nop
and $62556, %r12
lea addresses_WC_ht+0x1a849, %rdi
nop
nop
nop
nop
...
nop
xor $43456, %r12
lea addresses_D_ht+0x19849, %r12
nop
nop
nop
add %r9, %r9
mov (%r12), %edi
and $59338, %rsi
lea addresses_normal_ht+0xb049, %rsi
nop
nop
nop
nop
...
nop
dec %rdi
lea addresses_normal_ht+0xcc49, %rsi
lea addresses_normal_ht+0x139, %rdi
clflush (%rdi)
nop
nop
nop
...
rep movsq
and $18796, %rdi
lea addresses_A_ht+0x1049, %rsi
lea addresses_normal_ht+0x1de9d, %rdi
nop
nop
nop
nop
...
{'OP': 'REPM', 'src': {'type': 'addresses_D_ht', 'congruent': 11, 'same': False}, 'dst': {'type': 'addresses_A_ht', 'congruent': 4, 'same': True}}
{'OP': 'STOR', 'dst': {'type': 'addresses_WC_ht', 'AVXalign': True, 'congruent': 4, 'size': 4, 'same': False, 'NT': False}}
{'OP': 'LOAD', 'src': {'type': 'addresses_WT_ht', 'AVXalign': False, 'congruent': 10, 'size': 2, 'same': False, 'NT': False}}
{'OP': 'LOAD', 'src': {'type': 'addresses_D_ht', 'AVXalign': True, 'congruent': 5, 'size': 32, 'same': False, 'NT': True}}
