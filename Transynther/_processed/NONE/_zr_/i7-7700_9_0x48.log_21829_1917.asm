...
push %rdx
push %rsi
lea addresses_WC_ht+0xef69, %r11
nop
nop
nop
xor %rdi, %rdi
...
nop
and %rdx, %rdx
lea addresses_UC_ht+0x5088, %rcx
nop
add %rax, %rax
movb $0x61, (%rcx)
nop
add %r15, %r15
lea addresses_A_ht+0xe669, %rdi
nop
nop
nop
xor $33319, %rdx
...
nop
xor %rdx, %rdx
lea addresses_A_ht+0x18cad, %rax
nop
sub $45199, %rdi
mov (%rax), %ecx
nop
nop
inc %r15
lea addresses_A_ht+0x1b769, %rsi
lea addresses_WC_ht+0x3f01, %rdi
nop
nop
nop
nop
