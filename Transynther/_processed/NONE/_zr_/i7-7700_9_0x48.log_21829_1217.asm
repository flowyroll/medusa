...
push %rdi
push %rsi
lea addresses_UC_ht+0x16d70, %rbp
nop
nop
xor %rbx, %rbx
movups (%rbp), %xmm4
...
nop
and %rbp, %rbp
lea addresses_A_ht+0x1cab0, %rcx
nop
nop
nop
nop
...
lea addresses_WT_ht+0x2570, %rdi
nop
nop
inc %r14
mov $91, %rcx
rep movsl
add $50767, %r14
lea addresses_WT_ht+0x1d070, %r14
nop
nop
nop
nop
...
nop
and %rbp, %rbp
lea addresses_D_ht+0x13e10, %rsi
lea addresses_D_ht+0x1db70, %rdi
nop
nop
nop
nop
...
// Load
lea addresses_normal+0x11168, %r11
add %r13, %r13
movb (%r11), %cl
nop
inc %r8
...
{'OP': 'LOAD', 'src': {'type': 'addresses_normal', 'AVXalign': False, 'congruent': 2, 'size': 1, 'same': False, 'NT': False}}
