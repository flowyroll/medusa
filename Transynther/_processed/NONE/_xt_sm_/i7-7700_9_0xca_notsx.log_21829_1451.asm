...
push %rdi
push %rsi
lea addresses_A_ht+0x10243, %rsi
lea addresses_WC_ht+0x38f5, %rdi
nop
nop
nop
nop
...
// Store
lea addresses_WC+0xf7a3, %rax
mfence
movw $0x5152, (%rax)
sub %rax, %rax

// Store
lea addresses_PSE+0x145db, %r11
nop
nop
nop
nop
...
// REPMOV
lea addresses_WC+0xf83b, %rsi
lea addresses_PSE+0xb5af, %rdi
nop
nop
nop
nop
...
// Store
lea addresses_normal+0x17f12, %rdi
nop
nop
and $33119, %r15
...
{'src': {'congruent': 2, 'same': False, 'type': 'addresses_WC'}, 'dst': {'congruent': 2, 'same': False, 'type': 'addresses_PSE'}, 'OP': 'REPM'}
{'dst': {'NT': True, 'AVXalign': False, 'size': 1, 'congruent': 4, 'same': False, 'type': 'addresses_WT'}, 'OP': 'STOR'}
