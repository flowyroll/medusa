...
nop
sub $32356, %r13
lea addresses_WC_ht+0x15302, %rbp
nop
nop
nop
nop
...
nop
and %r13, %r13
lea addresses_WC_ht+0x50ce, %rbp
nop
nop
add $609, %r8
movups (%rbp), %xmm2
...
nop
sub %r9, %r9
lea addresses_WC_ht+0x19e3c, %rax
clflush (%rax)
nop
nop
nop
...
nop
add $51981, %r8
lea addresses_UC_ht+0x11e1e, %r8
nop
nop
nop
nop
