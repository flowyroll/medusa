...
nop
dec %r12
lea addresses_UC_ht+0x12c0a, %rcx
nop
nop
nop
nop
...
nop
mfence
lea addresses_normal_ht+0x106aa, %r8
nop
nop
nop
nop
...
nop
dec %rdi
lea addresses_normal_ht+0x184ea, %rax
nop
nop
nop
nop
...
nop
cmp $41717, %rcx
lea addresses_WT_ht+0x2326, %rsi
lea addresses_D_ht+0x194aa, %rdi
nop
nop
nop
nop
...
nop
add %rsi, %rsi
lea addresses_UC_ht+0x178ea, %r8
nop
nop
nop
add $40071, %r11
...
nop
add $28961, %rax
lea addresses_normal_ht+0x330a, %r12
dec %rcx
movb $0x61, (%r12)
nop
nop
...
{'src': {'type': 'addresses_A_ht', 'congruent': 9, 'same': True}, 'dst': {'type': 'addresses_UC_ht', 'congruent': 4, 'same': False}, 'OP': 'REPM'}
