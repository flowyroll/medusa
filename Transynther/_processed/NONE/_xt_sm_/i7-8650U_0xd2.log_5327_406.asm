...
push %rdi
push %rsi
lea addresses_normal_ht+0x1d405, %rsi
clflush (%rsi)
nop
and %r10, %r10
movb (%rsi), %r9b
...
nop
inc %rcx
lea addresses_UC_ht+0x130f5, %r9
nop
nop
nop
nop
...
nop
sub $51051, %rdi
lea addresses_WC_ht+0x1cd15, %r14
nop
nop
nop
nop
...
vpextrq $0, %xmm0, %rcx
cmp %r10, %r10
lea addresses_A_ht+0x153a9, %r12
nop
sub %r9, %r9
...
nop
and %rdi, %rdi
lea addresses_normal_ht+0x7aea, %rsi
nop
nop
nop
nop
...
nop
inc %r9
lea addresses_A_ht+0x1a415, %rsi
lea addresses_normal_ht+0x1da7d, %rdi
nop
nop
and %r11, %r11
mov $105, %rcx
...
nop
sub %r11, %r11
lea addresses_UC_ht+0x14535, %rsi
nop
dec %r11
movb $0x61, (%rsi)
nop
...
// Store
lea addresses_normal+0x11d15, %r8
nop
nop
inc %r12
...
{'OP': 'STOR', 'dst': {'type': 'addresses_A', 'size': 16, 'AVXalign': True, 'NT': False, 'congruent': 0, 'same': False}}
...
{'OP': 'LOAD', 'src': {'type': 'addresses_normal_ht', 'size': 2, 'AVXalign': True, 'NT': True, 'congruent': 0, 'same': False}}
{'OP': 'REPM', 'src': {'type': 'addresses_A_ht', 'congruent': 8, 'same': False}, 'dst': {'type': 'addresses_normal_ht', 'congruent': 3, 'same': True}}
