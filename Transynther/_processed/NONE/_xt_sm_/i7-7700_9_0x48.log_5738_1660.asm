...
push %rdx
push %rsi
lea addresses_D_ht+0x1860c, %r11
nop
and $21392, %rcx
vmovups (%r11), %ymm1
...
nop
and $21199, %rax
lea addresses_normal_ht+0xa70c, %rsi
lea addresses_D_ht+0x1517c, %rdi
and $4710, %rbx
mov $103, %rcx
rep movsw
nop
...
nop
sub %rdi, %rdi
lea addresses_normal_ht+0x1ed0c, %rcx
nop
nop
nop
xor %rbx, %rbx
mov (%rcx), %r12d
cmp %rax, %rax
lea addresses_UC_ht+0x508c, %rcx
nop
nop
nop
nop
...
nop
inc %rax
lea addresses_WC_ht+0x1b30c, %rsi
lea addresses_A_ht+0x516c, %rdi
nop
nop
nop
add $20137, %rdx
...
nop
cmp $46236, %r12
lea addresses_A_ht+0x14f0c, %rbx
and $18433, %r11
movb (%rbx), %dl
nop
nop
...
nop
sub $6087, %r12
lea addresses_D_ht+0x1a30c, %rsi
lea addresses_WC_ht+0x13b0c, %rdi
nop
nop
nop
nop
...
nop
xor %rax, %rax
lea addresses_WC_ht+0x1890c, %rsi
nop
nop
add $19608, %r12
movb (%rsi), %cl
...
nop
and $35138, %r12
lea addresses_A_ht+0x1870c, %r12
nop
nop
nop
nop
...
{'OP': 'REPM', 'src': {'type': 'addresses_WC_ht', 'congruent': 11, 'same': False}, 'dst': {'type': 'addresses_A_ht', 'congruent': 5, 'same': False}}
