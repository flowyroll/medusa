...
nop
dec %rcx
lea addresses_A_ht+0xaa3a, %rsi
lea addresses_normal_ht+0xc46a, %rdi
sub $55715, %r11
mov $103, %rcx
rep movsb
xor %r8, %r8
lea addresses_WT_ht+0x1b2ba, %rbp
xor $40481, %r8
movups (%rbp), %xmm3
vpextrq $1, %xmm3, %rsi
nop
...
nop
xor $42162, %rdi
lea addresses_D_ht+0x10fce, %r11
nop
nop
nop
nop
...
nop
add %rsi, %rsi
lea addresses_normal_ht+0x129ba, %rsi
and %r8, %r8
mov (%rsi), %rax
nop
nop
...
nop
cmp %r8, %r8
lea addresses_WC_ht+0x153a, %rax
nop
nop
add %r11, %r11
...
nop
sub %rdi, %rdi
lea addresses_WC_ht+0x14a9a, %rsi
nop
nop
nop
nop
...
nop
dec %r11
lea addresses_normal_ht+0x15238, %rsi
lea addresses_A_ht+0xc22f, %rdi
nop
nop
xor %r15, %r15
mov $75, %rcx
