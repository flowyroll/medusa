...
lea addresses_normal_ht+0x156af, %rdi
nop
nop
nop
cmp %rbp, %rbp
...
nop
cmp %rdi, %rdi
lea addresses_WT_ht+0x14023, %rsi
...
nop
sub $49140, %rsi
lea addresses_A_ht+0x1285f, %r12
nop
nop
nop
cmp $49109, %rdi
