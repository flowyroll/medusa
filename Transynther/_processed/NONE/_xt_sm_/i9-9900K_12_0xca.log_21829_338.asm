...
movq %rcx, (%rbp)
sub %rcx, %rcx
lea addresses_A_ht+0xa02c, %rsi
lea addresses_D_ht+0x3a0c, %rdi
nop
nop
nop
nop
...
nop
inc %rcx
lea addresses_UC_ht+0x4e2c, %rdx
nop
nop
nop
nop
...
nop
add $40514, %rbp
lea addresses_WT_ht+0x7c0c, %rcx
nop
nop
nop
cmp %rdx, %rdx
movl $0x61626364, (%rcx)
sub %rsi, %rsi
lea addresses_UC_ht+0xcb94, %r15
nop
nop
nop
nop
...
movw $0x6162, (%r15)
and $6436, %rdx
lea addresses_normal_ht+0x94a0, %rsi
lea addresses_normal_ht+0xfb4c, %rdi
nop
nop
nop
nop
...
rep movsw
sub $23675, %rbp
lea addresses_D_ht+0x10a0c, %rsi
lea addresses_A_ht+0x1b80c, %rdi
nop
cmp %r9, %r9
mov $7, %rcx
rep movsb
cmp %rsi, %rsi
lea addresses_A_ht+0x1040c, %r9
clflush (%r9)
nop
nop
nop
...
nop
sub $1933, %r8
lea addresses_normal_ht+0x1700c, %rdx
nop
nop
nop
nop
...
vpextrq $1, %xmm0, %r8
add $30232, %r15
lea addresses_UC_ht+0x1e80c, %rsi
lea addresses_D_ht+0x1ea2c, %rdi
nop
nop
and $18836, %r9
mov $103, %rcx
...
{'OP': 'REPM', 'src': {'same': False, 'type': 'addresses_normal_ht', 'congruent': 0}, 'dst': {'same': False, 'type': 'addresses_normal_ht', 'congruent': 5}}
{'OP': 'REPM', 'src': {'same': True, 'type': 'addresses_D_ht', 'congruent': 9}, 'dst': {'same': False, 'type': 'addresses_A_ht', 'congruent': 9}}
{'OP': 'LOAD', 'src': {'size': 8, 'NT': False, 'type': 'addresses_A_ht', 'same': False, 'AVXalign': True, 'congruent': 10}}
