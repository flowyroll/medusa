...
nop
add $12744, %rbp
lea addresses_normal_ht+0x79c, %rbx
nop
nop
nop
nop
...
nop
sub $11970, %rcx
lea addresses_UC_ht+0xd21c, %rsi
lea addresses_A_ht+0x1d04c, %rdi
nop
sub %r13, %r13
mov $127, %rcx
rep movsl
...
nop
cmp $32844, %r14
lea addresses_WC_ht+0x78bc, %r13
cmp %rsi, %rsi
...
nop
sub %rbx, %rbx
lea addresses_D_ht+0x1c96c, %rbx
nop
nop
nop
nop
...
nop
cmp %rax, %rax
lea addresses_WC_ht+0xf820, %rdi
nop
nop
nop
nop
...
{'src': {'type': 'addresses_UC_ht', 'congruent': 8, 'same': False}, 'OP': 'REPM', 'dst': {'type': 'addresses_A_ht', 'congruent': 3, 'same': False}}
