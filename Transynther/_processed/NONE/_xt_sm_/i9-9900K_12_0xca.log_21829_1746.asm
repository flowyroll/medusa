...
nop
dec %rdx
lea addresses_UC_ht+0xb3a0, %rsi
nop
nop
nop
sub %r8, %r8
...
nop
sub $2093, %rax
lea addresses_WC_ht+0x16343, %rbp
nop
nop
nop
sub %r12, %r12
...
nop
dec %rsi
lea addresses_normal_ht+0x1b9bf, %r8
nop
nop
nop
nop
...
nop
and $31854, %r13
lea addresses_WT_ht+0x19b01, %rbp
nop
nop
nop
add $29862, %r13
