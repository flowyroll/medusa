...
nop
add %r13, %r13
lea addresses_WC_ht+0xe216, %rsi
lea addresses_WC_ht+0x792a, %rdi
nop
nop
nop
xor %r13, %r13
...
nop
xor $42125, %rsi
lea addresses_D_ht+0xf1aa, %rbx
nop
nop
cmp %rbp, %rbp
movl $0x61626364, (%rbx)
and $16931, %r13
lea addresses_A_ht+0x232a, %rsi
lea addresses_D_ht+0x130aa, %rdi
clflush (%rdi)
nop
nop
cmp %r10, %r10
...
{'OP': 'LOAD', 'src': {'same': False, 'type': 'addresses_P', 'NT': False, 'AVXalign': False, 'size': 1, 'congruent': 6}}
...
{'OP': 'REPM', 'src': {'same': False, 'congruent': 2, 'type': 'addresses_WC_ht'}, 'dst': {'same': False, 'congruent': 10, 'type': 'addresses_WC_ht'}}
{'OP': 'STOR', 'dst': {'same': False, 'type': 'addresses_D_ht', 'NT': False, 'AVXalign': False, 'size': 4, 'congruent': 7}}
{'OP': 'REPM', 'src': {'same': False, 'congruent': 5, 'type': 'addresses_A_ht'}, 'dst': {'same': False, 'congruent': 0, 'type': 'addresses_D_ht'}}
{'52': 21829}
