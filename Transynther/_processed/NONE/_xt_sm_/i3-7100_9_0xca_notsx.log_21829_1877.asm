...
push %rdx
push %rsi
lea addresses_UC_ht+0x14ce4, %rsi
lea addresses_normal_ht+0x7d9c, %rdi
nop
nop
nop
nop
...
nop
cmp %r10, %r10
lea addresses_WC_ht+0x4cbc, %rsi
lea addresses_D_ht+0x1aa3c, %rdi
clflush (%rsi)
nop
nop
dec %r13
...
nop
cmp %rdi, %rdi
lea addresses_WT_ht+0x108bc, %rsi
lea addresses_WC_ht+0x3f45, %rdi
nop
nop
nop
add $63112, %r15
...
nop
add %r15, %r15
lea addresses_WT_ht+0x198bc, %rdx
add $64056, %rdi
mov (%rdx), %r13d
dec %rcx
pop %rsi
...
{'OP': 'STOR', 'dst': {'same': True, 'congruent': 0, 'NT': False, 'type': 'addresses_WC', 'size': 16, 'AVXalign': False}}
...
{'src': {'type': 'addresses_WC_ht', 'congruent': 10, 'same': False}, 'OP': 'REPM', 'dst': {'type': 'addresses_D_ht', 'congruent': 6, 'same': True}}
