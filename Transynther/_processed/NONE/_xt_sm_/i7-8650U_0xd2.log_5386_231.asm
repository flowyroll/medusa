...
push %rdi
push %rsi
lea addresses_WT_ht+0x3870, %rsi
lea addresses_WC_ht+0x8b30, %rdi
nop
nop
and $61798, %rbx
mov $32, %rcx
...
nop
sub $58148, %r10
lea addresses_A_ht+0x1cac0, %rsi
lea addresses_normal_ht+0xd370, %rdi
nop
nop
nop
nop
...
nop
dec %r10
lea addresses_WT_ht+0x11770, %rsi
lea addresses_normal_ht+0x19370, %rdi
nop
nop
nop
nop
...
rep movsw
xor $43068, %r13
lea addresses_A_ht+0x1a250, %rcx
cmp $62527, %rdi
mov $0x6162636465666768, %r13
movq %r13, (%rcx)
add %rbx, %rbx
lea addresses_WT_ht+0x53b2, %rsi
lea addresses_UC_ht+0x12970, %rdi
nop
nop
nop
nop
...
nop
and %r11, %r11
lea addresses_D_ht+0x1d8f0, %rcx
nop
nop
nop
add %r10, %r10
...
nop
cmp %r10, %r10
lea addresses_WC_ht+0xd070, %rcx
nop
nop
nop
cmp %rsi, %rsi
...
nop
cmp $35067, %r11
lea addresses_A_ht+0x1a710, %rsi
lea addresses_A_ht+0x160f0, %rdi
clflush (%rdi)
sub $20123, %r10
mov $66, %rcx
rep movsb
...
// Store
lea addresses_US+0x11860, %r8
sub %rax, %rax
movw $0x5152, (%r8)
inc %r8

// Store
lea addresses_WC+0xf070, %rsi
nop
nop
and $41283, %r15
...
{'OP': 'REPM', 'src': {'type': 'addresses_WT_ht', 'congruent': 1, 'same': False}, 'dst': {'type': 'addresses_UC_ht', 'congruent': 7, 'same': True}}
