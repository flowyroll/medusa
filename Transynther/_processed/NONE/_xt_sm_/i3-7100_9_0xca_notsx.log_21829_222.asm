...
push %rbx
push %rsi
lea addresses_WT_ht+0x1369, %r11
nop
nop
nop
nop
...
nop
and $6484, %r9
lea addresses_UC_ht+0x15229, %r14
sub %r10, %r10
mov (%r14), %ebx
nop
nop
...
nop
sub %r15, %r15
lea addresses_UC_ht+0x160e9, %r10
nop
nop
nop
nop
...
nop
add %rbx, %rbx
lea addresses_WC_ht+0x16769, %r15
nop
nop
nop
nop
...
// REPMOV
lea addresses_A+0x114b, %rsi
lea addresses_UC+0x7f49, %rdi
clflush (%rdi)
nop
nop
nop
...
{'src': {'type': 'addresses_A', 'congruent': 1, 'same': False}, 'OP': 'REPM', 'dst': {'type': 'addresses_UC', 'congruent': 5, 'same': False}}
[Faulty Load]
