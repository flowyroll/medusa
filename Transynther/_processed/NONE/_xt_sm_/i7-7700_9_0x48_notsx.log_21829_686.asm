...
// REPMOV
lea addresses_RW+0x1a80a, %rsi
lea addresses_D+0xa68a, %rdi
cmp $23468, %rax
mov $23, %rcx
rep movsl
nop
...
// Store
lea addresses_normal+0xfa0a, %rdi
nop
nop
nop
sub %r14, %r14
...
{'dst': {'same': False, 'NT': True, 'AVXalign': False, 'size': 2, 'type': 'addresses_A', 'congruent': 3}, 'OP': 'STOR'}
{'dst': {'same': False, 'NT': True, 'AVXalign': False, 'size': 8, 'type': 'addresses_A', 'congruent': 6}, 'OP': 'STOR'}
{'dst': {'same': True, 'congruent': 0, 'type': 'addresses_D'}, 'OP': 'REPM', 'src': {'same': False, 'congruent': 5, 'type': 'addresses_RW'}}
