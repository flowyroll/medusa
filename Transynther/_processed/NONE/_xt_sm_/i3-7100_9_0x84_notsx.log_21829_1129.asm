...
push %rdi
push %rsi
lea addresses_A_ht+0x1a1d4, %rsi
lea addresses_UC_ht+0xee54, %rdi
clflush (%rdi)
nop
nop
nop
...
nop
xor %rsi, %rsi
lea addresses_UC_ht+0x1c654, %rbx
nop
nop
nop
inc %r12
...
nop
dec %rsi
lea addresses_UC_ht+0x19154, %rsi
lea addresses_WT_ht+0x1a254, %rdi
nop
nop
nop
xor %r14, %r14
...
nop
xor $50779, %rdi
lea addresses_A_ht+0x1ec54, %rsi
lea addresses_normal_ht+0x44, %rdi
sub %r8, %r8
mov $70, %rcx
rep movsw
nop
...
nop
xor %rbx, %rbx
lea addresses_A_ht+0x18a54, %rbx
sub $32119, %r12
movups (%rbx), %xmm3
vpextrq $1, %xmm3, %r14
nop
...
<gen_prepare_buffer>
{'src': {'type': 'addresses_A_ht', 'congruent': 6, 'same': False}, 'dst': {'type': 'addresses_UC_ht', 'congruent': 10, 'same': False}, 'OP': 'REPM'}
{'src': {'type': 'addresses_A_ht', 'congruent': 9, 'same': False}, 'dst': {'type': 'addresses_A_ht', 'congruent': 0, 'same': False}, 'OP': 'REPM'}
{'src': {'type': 'addresses_UC_ht', 'same': False, 'size': 4, 'congruent': 8, 'NT': False, 'AVXalign': True}, 'OP': 'LOAD'}
