...
push %rdx
push %rsi
lea addresses_normal_ht+0x1bd27, %rsi
lea addresses_normal_ht+0x156bf, %rdi
nop
and %rdx, %rdx
mov $1, %rcx
rep movsw
...
nop
xor %r10, %r10
lea addresses_UC_ht+0x9b21, %r10
nop
inc %r8
movl $0x61626364, (%r10)
nop
xor %rdi, %rdi
lea addresses_D_ht+0x35b7, %r10
nop
nop
nop
nop
...
nop
dec %rdx
lea addresses_UC_ht+0x1daf7, %r15
clflush (%r15)
nop
and $1570, %rsi
movb (%r15), %r10b
...
nop
sub %r10, %r10
lea addresses_D_ht+0x1cd01, %rsi
lea addresses_normal_ht+0x1bcf7, %rdi
nop
nop
nop
nop
...
nop
and %rax, %rax
lea addresses_normal_ht+0x9ff7, %r10
nop
nop
nop
xor $30117, %rcx
...
nop
cmp %r10, %r10
lea addresses_WT_ht+0x1e2f7, %rsi
lea addresses_D_ht+0x10314, %rdi
sub $60018, %rax
mov $82, %rcx
rep movsl
nop
nop
add %r10, %r10
lea addresses_WC_ht+0x13e77, %rsi
lea addresses_UC_ht+0x160a7, %rdi
nop
sub $57933, %r8
mov $54, %rcx
rep movsl
...
{'dst': {'same': False, 'congruent': 9, 'type': 'addresses_normal_ht'}, 'OP': 'REPM', 'src': {'same': False, 'congruent': 1, 'type': 'addresses_D_ht'}}
{'dst': {'same': False, 'NT': False, 'AVXalign': False, 'size': 16, 'type': 'addresses_normal_ht', 'congruent': 8}, 'OP': 'STOR'}
{'dst': {'same': False, 'congruent': 0, 'type': 'addresses_D_ht'}, 'OP': 'REPM', 'src': {'same': False, 'congruent': 11, 'type': 'addresses_WT_ht'}}
