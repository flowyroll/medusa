...
push %rdx
push %rsi
lea addresses_D_ht+0x1e03c, %r14
nop
nop
nop
nop
...
nop
inc %rbp
lea addresses_WT_ht+0x3f3c, %rbx
nop
nop
nop
nop
...
nop
cmp $34017, %rbx
lea addresses_D_ht+0x18e3c, %rsi
nop
nop
nop
nop
...
nop
cmp $40093, %rcx
lea addresses_A_ht+0x1e4bc, %rcx
nop
nop
nop
nop
...
movb $0x61, (%rcx)
cmp $58539, %r14
lea addresses_D_ht+0x147bc, %rsi
...
nop
inc %rdi
lea addresses_D_ht+0x1c8ec, %rsi
lea addresses_WC_ht+0x566c, %rdi
nop
nop
xor $33325, %rbp
mov $65, %rcx
...
nop
xor %rbp, %rbp
lea addresses_D_ht+0x1a7bc, %rdi
clflush (%rdi)
nop
inc %rbp
movb $0x61, (%rdi)
xor %rbp, %rbp
lea addresses_D_ht+0x1503c, %rcx
nop
and %r8, %r8
movw $0x6162, (%rcx)
nop
...
// Store
lea addresses_normal+0x993c, %r12
and %r11, %r11
