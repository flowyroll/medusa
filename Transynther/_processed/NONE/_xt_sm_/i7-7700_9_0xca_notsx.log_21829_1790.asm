...
push %rdx
push %rsi
lea addresses_D_ht+0x1132f, %rsi
xor %rdx, %rdx
mov (%rsi), %r13
nop
nop
...
nop
sub $10541, %rbp
lea addresses_UC_ht+0xf97d, %rbx
clflush (%rbx)
add %rcx, %rcx
vmovups (%rbx), %ymm1
...
nop
sub $25808, %rbx
lea addresses_normal_ht+0x1c0b, %rsi
lea addresses_WC_ht+0x855, %rdi
clflush (%rsi)
nop
nop
nop
...
rep movsq
sub $38158, %rdi
lea addresses_normal_ht+0x45ad, %rsi
nop
nop
inc %rcx
mov (%rsi), %dx
...
nop
dec %rcx
lea addresses_D_ht+0x18ad, %rsi
lea addresses_UC_ht+0x1e05d, %rdi
nop
nop
nop
nop
...
nop
dec %rdi
lea addresses_D_ht+0x1145d, %r10
nop
and $55535, %rsi
mov (%r10), %r13d
nop
...
nop
cmp $14294, %rcx
lea addresses_A_ht+0x1185d, %rsi
lea addresses_WC_ht+0x1735d, %rdi
nop
nop
xor $13754, %rbx
mov $58, %rcx
...
nop
add $57915, %rdi
lea addresses_WT_ht+0xf87d, %rbp
clflush (%rbp)
nop
nop
cmp $49929, %r10
...
nop
sub %rdx, %rdx
lea addresses_A_ht+0x85d, %rsi
lea addresses_UC_ht+0xf18b, %rdi
nop
nop
nop
and $54095, %rbp
...
lea addresses_UC_ht+0x1577d, %rdi
nop
nop
nop
cmp %r10, %r10
...
nop
xor %rcx, %rcx
lea addresses_WC_ht+0x20cd, %rbx
nop
nop
nop
nop
...
<gen_prepare_buffer>
{'src': {'NT': False, 'AVXalign': False, 'size': 8, 'congruent': 0, 'same': True, 'type': 'addresses_D_ht'}, 'OP': 'LOAD'}
...
{'src': {'congruent': 4, 'same': False, 'type': 'addresses_D_ht'}, 'dst': {'congruent': 11, 'same': True, 'type': 'addresses_UC_ht'}, 'OP': 'REPM'}
...
{'src': {'congruent': 11, 'same': False, 'type': 'addresses_A_ht'}, 'dst': {'congruent': 1, 'same': False, 'type': 'addresses_UC_ht'}, 'OP': 'REPM'}
