...
push %rdx
push %rsi
lea addresses_WC_ht+0x4da8, %rsi
nop
nop
nop
nop
...
nop
sub %rdx, %rdx
lea addresses_normal_ht+0x1d0ec, %r15
nop
add $13858, %rdx
movl $0x61626364, (%r15)
cmp %rsi, %rsi
lea addresses_normal_ht+0x1a1a8, %rsi
...
{'src': {'type': 'addresses_normal_ht', 'congruent': 10, 'same': False}, 'dst': {'type': 'addresses_D_ht', 'congruent': 9, 'same': False}, 'OP': 'REPM'}
{'58': 21829}
