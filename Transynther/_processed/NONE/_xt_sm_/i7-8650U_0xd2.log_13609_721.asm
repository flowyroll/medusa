...
push %rdi
push %rsi
lea addresses_A_ht+0x1e324, %rsi
...
nop
and $25684, %rsi
lea addresses_WT_ht+0x4bec, %rsi
...
nop
add %r9, %r9
lea addresses_WT_ht+0x6c8c, %r13
nop
nop
dec %r8
movl $0x61626364, (%r13)
...
nop
and %r13, %r13
lea addresses_WT_ht+0x12fe0, %rsi
...
nop
and $48091, %r8
lea addresses_WC_ht+0x3064, %rdi
and %rcx, %rcx
movb $0x61, (%rdi)
nop
nop
...
// Store
lea addresses_normal+0x9b44, %rsi
nop
and %r14, %r14
movl $0x51525354, (%rsi)
nop
...
// Faulty Load
lea addresses_normal+0x9b44, %r12
nop
sub %rsi, %rsi
mov (%r12), %ebp
lea oracles, %r12
...
{'OP': 'REPM', 'src': {'type': 'addresses_WT_ht', 'congruent': 2, 'same': False}, 'dst': {'type': 'addresses_D_ht', 'congruent': 9, 'same': True}}
