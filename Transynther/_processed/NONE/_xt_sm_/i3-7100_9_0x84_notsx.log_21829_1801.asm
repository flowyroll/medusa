...
vpextrq $1, %xmm5, %r12
add $6279, %rcx
lea addresses_WT_ht+0x80b0, %rax
cmp %rdx, %rdx
movw $0x6162, (%rax)
nop
nop
nop
and $16501, %r15
lea addresses_A_ht+0x15b50, %rsi
lea addresses_WT_ht+0x1e4a8, %rdi
clflush (%rdi)
nop
nop
nop
...
nop
cmp %rax, %rax
lea addresses_UC_ht+0x4cb0, %rdx
nop
cmp %r12, %r12
movl $0x61626364, (%rdx)
nop
