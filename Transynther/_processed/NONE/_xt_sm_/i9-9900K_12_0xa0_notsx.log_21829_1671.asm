...
nop
xor $4605, %r13
lea addresses_UC_ht+0x148b9, %rsi
lea addresses_A_ht+0x3874, %rdi
clflush (%rsi)
nop
lfence
mov $91, %rcx
rep movsq
cmp $44841, %r9
lea addresses_D_ht+0x14bb9, %rsi
lea addresses_UC_ht+0x1a679, %rdi
nop
nop
and $60337, %r12
mov $36, %rcx
...
nop
xor $9682, %r15
lea addresses_WT_ht+0x129cf, %r9
nop
cmp $21827, %rdi
mov $0x6162636465666768, %r10
movq %r10, (%r9)
...
nop
xor %rcx, %rcx
lea addresses_UC_ht+0x1c479, %r12
nop
nop
sub $56926, %rcx
mov (%r12), %r15d
cmp $24148, %rdi
lea addresses_UC_ht+0x16079, %r10
and %rdi, %rdi
movw $0x6162, (%r10)
nop
and $25381, %r9
lea addresses_D_ht+0x1a581, %r12
nop
add $63006, %rsi
movups (%r12), %xmm2
vpextrq $1, %xmm2, %r10
...
nop
and %r15, %r15
lea addresses_WC_ht+0x18391, %rdi
clflush (%rdi)
nop
nop
add $3592, %rcx
