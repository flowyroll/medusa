...
push %rdx
push %rsi
lea addresses_normal_ht+0x23ac, %rsi
lea addresses_WC_ht+0x13196, %rdi
add $27430, %r15
mov $63, %rcx
rep movsq
nop
nop
sub %rsi, %rsi
lea addresses_UC_ht+0x1b1f4, %r15
nop
nop
xor $35610, %r13
movb $0x61, (%r15)
cmp $15740, %r13
lea addresses_normal_ht+0x6b84, %r15
nop
nop
add $50789, %rdx
movb (%r15), %cl
nop
inc %rcx
lea addresses_WT_ht+0x183b4, %r15
nop
nop
dec %rsi
...
vmovups %ymm3, (%r13)
and $31114, %rcx
lea addresses_WC_ht+0x51f4, %rsi
nop
nop
nop
mfence
...
nop
and $23911, %rdi
lea addresses_WC_ht+0x1346a, %rdx
nop
nop
cmp %rdi, %rdi
mov (%rdx), %eax
...
nop
sub $10522, %r15
lea addresses_WT_ht+0xb9ac, %rcx
nop
nop
nop
xor %rsi, %rsi
...
// Store
lea addresses_A+0x5df4, %rdi
xor %rbp, %rbp
movb $0x51, (%rdi)
cmp $60208, %rbp

// Store
lea addresses_A+0x161f4, %rdi
nop
dec %r15
...
{'OP': 'STOR', 'dst': {'congruent': 11, 'AVXalign': True, 'same': False, 'size': 1, 'NT': False, 'type': 'addresses_UC_ht'}}
...
{'OP': 'STOR', 'dst': {'congruent': 6, 'AVXalign': False, 'same': True, 'size': 32, 'NT': False, 'type': 'addresses_D_ht'}}
