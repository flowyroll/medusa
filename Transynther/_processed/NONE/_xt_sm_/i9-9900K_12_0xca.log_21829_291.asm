...
push %rdx
push %rsi
lea addresses_normal_ht+0x83d7, %r9
and $38920, %r15
movups (%r9), %xmm6
vpextrq $1, %xmm6, %rdx
nop
...
nop
dec %r14
lea addresses_A_ht+0x8bd7, %rsi
lea addresses_WT_ht+0xb5d7, %rdi
nop
and $13795, %r13
mov $120, %rcx
rep movsl
...
vpextrq $0, %xmm1, %r9
dec %r13
lea addresses_normal_ht+0x40af, %rsi
lea addresses_A_ht+0x12257, %rdi
nop
add %r15, %r15
mov $95, %rcx
rep movsl
...
nop
add %rcx, %rcx
lea addresses_normal_ht+0x14357, %rcx
nop
nop
cmp %rdx, %rdx
movl $0x61626364, (%rcx)
...
nop
sub $32166, %rdi
lea addresses_A_ht+0x1d3ae, %r14
nop
inc %rdi
...
nop
xor %r15, %r15
lea addresses_D_ht+0x11f37, %r15
nop
sub $1112, %rsi
mov (%r15), %ecx
sub $60611, %rsi
lea addresses_A_ht+0x119d7, %rdi
and %rsi, %rsi
...
{'OP': 'LOAD', 'src': {'size': 4, 'NT': False, 'type': 'addresses_D_ht', 'same': False, 'AVXalign': True, 'congruent': 8}}
