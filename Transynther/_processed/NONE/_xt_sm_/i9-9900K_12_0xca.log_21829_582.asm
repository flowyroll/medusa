...
push %rdx
push %rsi
lea addresses_WC_ht+0xb2c1, %rsi
lea addresses_D_ht+0x11741, %rdi
nop
nop
nop
nop
...
nop
inc %r8
lea addresses_A_ht+0x1bd61, %r12
nop
xor $56824, %rax
...
nop
xor $19184, %rax
lea addresses_normal_ht+0x96bd, %rdi
nop
nop
add $36506, %rsi
...
nop
inc %rax
lea addresses_UC_ht+0x14599, %rdx
clflush (%rdx)
nop
nop
nop
...
// Load
lea addresses_normal+0x1e2c1, %r15
nop
nop
nop
and %rax, %rax
...
{'OP': 'STOR', 'dst': {'size': 16, 'NT': False, 'type': 'addresses_D', 'same': False, 'AVXalign': True, 'congruent': 5}}
...
<gen_prepare_buffer>
{'OP': 'REPM', 'src': {'same': False, 'type': 'addresses_WC_ht', 'congruent': 9}, 'dst': {'same': True, 'type': 'addresses_D_ht', 'congruent': 4}}
{'OP': 'LOAD', 'src': {'size': 32, 'NT': True, 'type': 'addresses_A_ht', 'same': False, 'AVXalign': False, 'congruent': 5}}
{'OP': 'LOAD', 'src': {'size': 16, 'NT': False, 'type': 'addresses_normal_ht', 'same': False, 'AVXalign': True, 'congruent': 0}}
