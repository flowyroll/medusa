...
push %rdx
push %rsi
lea addresses_D_ht+0x1d36b, %rdx
nop
nop
nop
cmp %rcx, %rcx
...
{'dst': {'type': 'addresses_PSE', 'same': True, 'size': 8, 'congruent': 0, 'NT': False, 'AVXalign': True}, 'OP': 'STOR'}
