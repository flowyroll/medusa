...
nop
sub %r11, %r11
lea addresses_normal_ht+0x17866, %rcx
cmp $5003, %rdi
mov (%rcx), %r14w
nop
add %r14, %r14
lea addresses_UC_ht+0x1df92, %r14
nop
nop
and $26313, %rcx
movw $0x6162, (%r14)
...
nop
cmp $13683, %r14
lea addresses_UC_ht+0x5242, %rcx
cmp $6052, %r9
movl $0x61626364, (%rcx)
nop
nop
add %rcx, %rcx
lea addresses_normal_ht+0x10122, %r11
add %rcx, %rcx
movb (%r11), %r14b
nop
nop
...
{'OP': 'STOR', 'dst': {'same': False, 'type': 'addresses_US', 'NT': False, 'AVXalign': False, 'size': 4, 'congruent': 7}}
{'OP': 'STOR', 'dst': {'same': False, 'type': 'addresses_P', 'NT': True, 'AVXalign': False, 'size': 1, 'congruent': 3}}
[Faulty Load]
...
{'OP': 'LOAD', 'src': {'same': False, 'type': 'addresses_A_ht', 'NT': True, 'AVXalign': False, 'size': 2, 'congruent': 1}}
