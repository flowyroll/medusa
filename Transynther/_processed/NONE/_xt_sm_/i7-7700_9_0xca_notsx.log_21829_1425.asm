...
push %rdx
push %rsi
lea addresses_normal_ht+0x1735a, %rdx
nop
nop
add %r12, %r12
movl $0x61626364, (%rdx)
nop
cmp %r14, %r14
lea addresses_WC_ht+0x15156, %r8
nop
nop
inc %r15
vmovups (%r8), %ymm6
...
nop
add $773, %r8
lea addresses_normal_ht+0x67a6, %rbp
nop
nop
nop
nop
...
nop
sub %r12, %r12
lea addresses_normal_ht+0x9d5a, %rsi
lea addresses_normal_ht+0x991a, %rdi
nop
nop
dec %r8
mov $80, %rcx
...
nop
xor $61067, %r9
lea addresses_UC_ht+0x5b2a, %rsi
nop
cmp $60934, %r12
movb (%rsi), %cl
nop
...
nop
lfence
lea addresses_WC_ht+0x1d95a, %rsi
lea addresses_normal_ht+0x8042, %rdi
clflush (%rdi)
nop
nop
nop
...
{'src': {'NT': False, 'AVXalign': True, 'size': 1, 'congruent': 4, 'same': False, 'type': 'addresses_UC_ht'}, 'OP': 'LOAD'}
