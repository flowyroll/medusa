...
nop
cmp $59015, %rbp
lea addresses_A_ht+0x1b988, %r15
nop
nop
nop
add $33361, %r11
...
nop
sub $43574, %r9
lea addresses_WT_ht+0x15d48, %rdi
sub %r14, %r14
...
nop
sub %r15, %r15
lea addresses_WT_ht+0x1b088, %rsi
lea addresses_normal_ht+0x3d88, %rdi
dec %r11
mov $97, %rcx
rep movsl
lfence
...
// Store
lea addresses_normal+0x1b188, %r13
nop
nop
nop
dec %r12
...
// REPMOV
lea addresses_normal+0x1b188, %rsi
lea addresses_UC+0xf7fa, %rdi
nop
nop
nop
nop
...
{'src': {'type': 'addresses_normal', 'congruent': 0, 'same': True}, 'OP': 'REPM', 'dst': {'type': 'addresses_UC', 'congruent': 0, 'same': False}}
[Faulty Load]
...
{'src': {'type': 'addresses_WT_ht', 'congruent': 8, 'same': False}, 'OP': 'REPM', 'dst': {'type': 'addresses_normal_ht', 'congruent': 10, 'same': True}}
{'58': 21829}
