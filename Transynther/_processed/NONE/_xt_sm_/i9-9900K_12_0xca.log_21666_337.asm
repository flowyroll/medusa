...
push %rdx
push %rsi
lea addresses_normal_ht+0xfba1, %rdx
nop
nop
nop
nop
...
nop
add %r13, %r13
lea addresses_UC_ht+0xf321, %rsi
lea addresses_normal_ht+0x9391, %rdi
clflush (%rsi)
nop
nop
nop
...
{'OP': 'STOR', 'dst': {'size': 16, 'NT': False, 'type': 'addresses_PSE', 'same': False, 'AVXalign': True, 'congruent': 7}}
...
{'OP': 'REPM', 'src': {'same': True, 'type': 'addresses_UC_ht', 'congruent': 6}, 'dst': {'same': False, 'type': 'addresses_normal_ht', 'congruent': 4}}
