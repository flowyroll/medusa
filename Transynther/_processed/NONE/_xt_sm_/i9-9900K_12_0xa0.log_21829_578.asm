...
push %rdi
push %rsi
lea addresses_normal_ht+0x10887, %r8
nop
nop
cmp %rcx, %rcx
mov (%r8), %r13
...
nop
add %rdi, %rdi
lea addresses_normal_ht+0xdb87, %r10
nop
nop
nop
nop
...
nop
and %rsi, %rsi
lea addresses_normal_ht+0x12fa9, %rcx
nop
and %rsi, %rsi
movb (%rcx), %r8b
nop
...
nop
dec %r13
lea addresses_normal_ht+0x16c07, %rdi
nop
nop
nop
nop
...
nop
add $26891, %rdi
lea addresses_WT_ht+0x4307, %rsi
lea addresses_D_ht+0xeb87, %rdi
nop
nop
and $34132, %r11
mov $45, %rcx
rep movsw
add $8341, %r13
lea addresses_normal_ht+0x13fea, %rsi
...
rep movsl
add %r10, %r10
lea addresses_WC_ht+0x9787, %rsi
lea addresses_UC_ht+0xe787, %rdi
nop
nop
nop
cmp %rbx, %rbx
...
nop
xor $7015, %rbx
lea addresses_UC_ht+0x1b947, %rcx
nop
xor $64431, %r11
movb (%rcx), %r13b
nop
cmp %rsi, %rsi
lea addresses_WC_ht+0x1a167, %rbx
nop
cmp %r10, %r10
...
// Store
lea addresses_normal+0x3f87, %rsi
sub $17566, %r12
movw $0x5152, (%rsi)
nop
nop
...
// Faulty Load
lea addresses_normal+0x3f87, %r14
nop
nop
add $36779, %rsi
movb (%r14), %al
...
{'src': {'NT': True, 'same': True, 'congruent': 7, 'type': 'addresses_normal_ht', 'AVXalign': False, 'size': 2}, 'OP': 'LOAD'}
{'src': {'same': False, 'congruent': 6, 'type': 'addresses_WT_ht'}, 'OP': 'REPM', 'dst': {'same': False, 'congruent': 10, 'type': 'addresses_D_ht'}}
{'src': {'same': False, 'congruent': 0, 'type': 'addresses_normal_ht'}, 'OP': 'REPM', 'dst': {'same': False, 'congruent': 5, 'type': 'addresses_A_ht'}}
{'src': {'same': False, 'congruent': 11, 'type': 'addresses_WC_ht'}, 'OP': 'REPM', 'dst': {'same': False, 'congruent': 10, 'type': 'addresses_UC_ht'}}
