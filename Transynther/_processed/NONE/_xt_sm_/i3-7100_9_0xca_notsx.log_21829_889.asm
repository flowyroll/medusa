...
// REPMOV
lea addresses_WC+0x661e, %rsi
lea addresses_UC+0x541e, %rdi
nop
and %rdx, %rdx
mov $77, %rcx
rep movsw
...
// Load
lea addresses_normal+0x1089e, %rdi
nop
nop
xor $16596, %r10
movups (%rdi), %xmm1
...
{'src': {'type': 'addresses_WC', 'congruent': 9, 'same': False}, 'OP': 'REPM', 'dst': {'type': 'addresses_UC', 'congruent': 0, 'same': True}}
{'OP': 'STOR', 'dst': {'same': True, 'congruent': 0, 'NT': False, 'type': 'addresses_UC', 'size': 16, 'AVXalign': False}}
{'src': {'same': False, 'congruent': 5, 'NT': False, 'type': 'addresses_normal', 'size': 16, 'AVXalign': False}, 'OP': 'LOAD'}
[Faulty Load]
