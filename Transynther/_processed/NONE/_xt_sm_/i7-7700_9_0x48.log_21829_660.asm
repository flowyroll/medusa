...
push %rdx
push %rsi
lea addresses_WC_ht+0x32c6, %rsi
lea addresses_WC_ht+0x11b2e, %rdi
nop
nop
add $4906, %r13
mov $89, %rcx
...
nop
xor $33444, %rax
lea addresses_WT_ht+0x10f6, %r15
nop
nop
and %rdx, %rdx
movb (%r15), %r13b
lfence
lea addresses_normal_ht+0x1dfb6, %r13
nop
nop
nop
nop
...
nop
xor %rdx, %rdx
lea addresses_WT_ht+0x166b6, %rsi
lea addresses_normal_ht+0xc2c6, %rdi
nop
nop
nop
cmp %rax, %rax
...
nop
xor %r13, %r13
lea addresses_WT_ht+0x12ab6, %rsi
nop
nop
and %rax, %rax
movw $0x6162, (%rsi)
cmp $6832, %rsi
lea addresses_WT_ht+0x10446, %rsi
lea addresses_WT_ht+0xfab6, %rdi
nop
nop
nop
nop
...
rep movsq
and %rsi, %rsi
lea addresses_normal_ht+0xe7a8, %r13
and $39818, %rax
movb (%r13), %r15b
and %rsi, %rsi
lea addresses_normal_ht+0x11c0e, %rcx
nop
nop
nop
cmp $8769, %rdi
...
nop
and %rsi, %rsi
lea addresses_normal_ht+0x1e184, %r14
clflush (%r14)
nop
nop
nop
...
nop
cmp %r15, %r15
lea addresses_WT_ht+0xcbc6, %r14
nop
nop
add $42664, %r13
movups (%r14), %xmm3
...
nop
and %rax, %rax
lea addresses_normal_ht+0x126e6, %rsi
lea addresses_WT_ht+0x1c736, %rdi
nop
xor %r14, %r14
mov $51, %rcx
rep movsq
...
{'OP': 'LOAD', 'src': {'type': 'addresses_WC_ht', 'AVXalign': True, 'congruent': 3, 'size': 4, 'same': False, 'NT': False}}
{'OP': 'REPM', 'src': {'type': 'addresses_WT_ht', 'congruent': 9, 'same': False}, 'dst': {'type': 'addresses_normal_ht', 'congruent': 3, 'same': False}}
