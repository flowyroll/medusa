...
// Store
lea addresses_normal+0x17fd0, %r13
nop
nop
nop
add $420, %rsi
...
// Store
lea addresses_normal+0x445a, %rbx
clflush (%rbx)
nop
nop
nop
...
// Faulty Load
lea addresses_normal+0x17fd0, %r15
nop
inc %rbx
mov (%r15), %rsi
lea oracles, %r14
...
{'OP': 'STOR', 'dst': {'same': True, 'type': 'addresses_normal', 'NT': False, 'AVXalign': True, 'size': 1, 'congruent': 0}}
...
{'OP': 'STOR', 'dst': {'same': False, 'type': 'addresses_PSE', 'NT': False, 'AVXalign': False, 'size': 16, 'congruent': 1}}
