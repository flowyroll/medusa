...
push %rdx
push %rsi
lea addresses_WC_ht+0xfff2, %rbp
nop
nop
and $36629, %rdx
movb $0x61, (%rbp)
...
nop
sub %r11, %r11
lea addresses_UC_ht+0x16f82, %rsi
lea addresses_WT_ht+0xc1e2, %rdi
clflush (%rdi)
nop
nop
xor $52692, %r15
...
rep movsb
and $27307, %rcx
lea addresses_WC_ht+0x6b38, %rsi
lea addresses_normal_ht+0x8bf2, %rdi
inc %rdx
mov $23, %rcx
rep movsl
nop
...
nop
cmp $51941, %r11
lea addresses_WT_ht+0xebf2, %r13
clflush (%r13)
nop
nop
nop
...
// Store
lea addresses_D+0x1d3f2, %r10
cmp $58692, %rcx
movl $0x51525354, (%r10)
inc %rdx

// Store
lea addresses_A+0x1bbf2, %rax
nop
nop
xor %rsi, %rsi
movb $0x51, (%rax)
...
{'OP': 'STOR', 'dst': {'type': 'addresses_WT_ht', 'size': 8, 'AVXalign': False, 'NT': True, 'congruent': 10, 'same': True}}
{'51': 10734}
