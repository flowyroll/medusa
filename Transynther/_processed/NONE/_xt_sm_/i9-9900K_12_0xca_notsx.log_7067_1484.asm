...
nop
xor %r15, %r15
lea addresses_WT_ht+0xe27c, %r14
clflush (%r14)
nop
nop
nop
...
vmovntdq %ymm0, (%r14)
and $1478, %r12
lea addresses_A_ht+0x1c7bc, %rsi
lea addresses_D_ht+0xb02c, %rdi
nop
add %rbx, %rbx
mov $39, %rcx
rep movsl
...
nop
add $31769, %r12
lea addresses_D_ht+0x15a7a, %rsi
lea addresses_WT_ht+0x14e54, %rdi
cmp %r12, %r12
mov $55, %rcx
rep movsb
nop
nop
cmp %r10, %r10
lea addresses_WT_ht+0x1383c, %rbx
sub $45703, %r14
mov (%rbx), %esi
nop
nop
...
nop
and $28615, %rbx
lea addresses_A_ht+0xabbc, %rsi
lea addresses_normal_ht+0x1483c, %rdi
sub %r14, %r14
mov $19, %rcx
rep movsw
nop
...
nop
cmp $10499, %rcx
lea addresses_D_ht+0x803c, %rsi
lea addresses_D_ht+0x1e03c, %rdi
nop
nop
inc %r15
mov $39, %rcx
...
lea addresses_UC_ht+0x743c, %rdi
add %r15, %r15
mov $82, %rcx
rep movsl
nop
...
nop
add $29886, %rcx
lea addresses_UC_ht+0x65c, %r12
sub %rsi, %rsi
movl $0x61626364, (%r12)
nop
nop
xor $45366, %rdi
lea addresses_UC_ht+0xb53c, %r13
nop
xor $48515, %rdi
...
// Store
lea addresses_normal+0x1571c, %rdx
nop
nop
nop
nop
...
<gen_faulty_load>
[REF]
{'OP': 'LOAD', 'src': {'same': False, 'type': 'addresses_RW', 'NT': False, 'AVXalign': True, 'size': 2, 'congruent': 0}}
...
{'OP': 'STOR', 'dst': {'same': False, 'type': 'addresses_WT_ht', 'NT': True, 'AVXalign': False, 'size': 32, 'congruent': 5}}
...
{'OP': 'REPM', 'src': {'same': False, 'congruent': 7, 'type': 'addresses_A_ht'}, 'dst': {'same': False, 'congruent': 10, 'type': 'addresses_normal_ht'}}
{'OP': 'REPM', 'src': {'same': False, 'congruent': 11, 'type': 'addresses_D_ht'}, 'dst': {'same': False, 'congruent': 9, 'type': 'addresses_D_ht'}}
{'OP': 'LOAD', 'src': {'same': True, 'type': 'addresses_D_ht', 'NT': False, 'AVXalign': True, 'size': 32, 'congruent': 6}}
{'OP': 'REPM', 'src': {'same': False, 'congruent': 6, 'type': 'addresses_normal_ht'}, 'dst': {'same': False, 'congruent': 10, 'type': 'addresses_UC_ht'}}
