...
push %rdx
push %rsi
lea addresses_normal_ht+0x2f4d, %r10
xor $11126, %r14
movw $0x6162, (%r10)
nop
nop
add $25665, %rdx
lea addresses_normal_ht+0x334d, %rsi
lea addresses_WT_ht+0x1e8ed, %rdi
nop
nop
add %r8, %r8
mov $58, %rcx
...
nop
and %r8, %r8
lea addresses_D_ht+0x1b42d, %rsi
lea addresses_WC_ht+0x9f6d, %rdi
cmp $22183, %r11
mov $6, %rcx
rep movsl
nop
dec %r10
lea addresses_A_ht+0x1e621, %rsi
nop
nop
sub %rdi, %rdi
...
nop
inc %r11
lea addresses_UC_ht+0x1e04d, %rsi
lea addresses_UC_ht+0x1378d, %rdi
nop
xor $39705, %r10
mov $104, %rcx
rep movsb
...
nop
add %r10, %r10
lea addresses_normal_ht+0x724d, %r8
nop
nop
nop
nop
...
nop
sub $9184, %r10
lea addresses_D_ht+0x1a1fd, %r10
clflush (%r10)
nop
cmp $2381, %rdx
movb $0x61, (%r10)
...
{'src': {'type': 'addresses_UC_ht', 'congruent': 9, 'same': False}, 'OP': 'REPM', 'dst': {'type': 'addresses_UC_ht', 'congruent': 5, 'same': False}}
{'src': {'type': 'addresses_UC_ht', 'AVXalign': False, 'size': 1, 'NT': False, 'same': False, 'congruent': 1}, 'OP': 'LOAD'}
{'OP': 'STOR', 'dst': {'type': 'addresses_normal_ht', 'AVXalign': False, 'size': 4, 'NT': True, 'same': True, 'congruent': 11}}
