...
nop
cmp $13890, %r10
lea addresses_WT_ht+0x15a15, %rsi
...
nop
and $37288, %rdi
lea addresses_WC_ht+0x3835, %rdx
sub $9442, %rax
movups (%rdx), %xmm2
vpextrq $1, %xmm2, %r8
nop
...
nop
cmp %rcx, %rcx
lea addresses_WC_ht+0x18075, %rsi
lea addresses_A_ht+0x8e75, %rdi
nop
nop
nop
nop
...
rep movsb
sub %rdx, %rdx
lea addresses_D_ht+0x17875, %rsi
lea addresses_UC_ht+0x1f43, %rdi
nop
nop
nop
add $47994, %r14
...
{'src': {'same': False, 'congruent': 10, 'type': 'addresses_D_ht'}, 'OP': 'REPM', 'dst': {'same': False, 'congruent': 1, 'type': 'addresses_UC_ht'}}
{'58': 21829}
