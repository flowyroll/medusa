...
push %rdi
push %rsi
lea addresses_UC_ht+0x17df5, %rsi
lea addresses_normal_ht+0x1d565, %rdi
clflush (%rsi)
cmp $30011, %rbx
mov $12, %rcx
rep movsw
...
nop
add %r13, %r13
lea addresses_UC_ht+0x1357d, %r14
clflush (%r14)
nop
nop
cmp %r10, %r10
...
nop
xor %rbx, %rbx
lea addresses_D_ht+0xb87d, %rsi
lea addresses_D_ht+0x10965, %rdi
nop
add $105, %r11
mov $92, %rcx
rep movsw
...
nop
xor $3770, %rcx
lea addresses_WC_ht+0x1b65, %r14
nop
nop
nop
xor %r13, %r13
...
nop
sub $39538, %rcx
lea addresses_WC_ht+0x198b1, %r10
nop
nop
nop
nop
...
nop
and $1871, %r11
lea addresses_UC_ht+0x7965, %rsi
nop
nop
and %rdi, %rdi
movb $0x61, (%rsi)
...
nop
sub $3638, %r10
lea addresses_D_ht+0x1472b, %r11
nop
nop
nop
nop
...
nop
xor $51828, %r11
lea addresses_normal_ht+0xbf8d, %rbx
nop
nop
xor %r13, %r13
mov (%rbx), %r11d
...
nop
and $49073, %rcx
lea addresses_D_ht+0x17265, %rdi
nop
inc %rcx
movb (%rdi), %r11b
and $30122, %rsi
lea addresses_D_ht+0xa665, %rsi
lea addresses_normal_ht+0xe665, %rdi
nop
cmp %r11, %r11
mov $1, %rcx
rep movsb
...
{'dst': {'same': False, 'NT': True, 'AVXalign': True, 'size': 1, 'type': 'addresses_UC_ht', 'congruent': 11}, 'OP': 'STOR'}
