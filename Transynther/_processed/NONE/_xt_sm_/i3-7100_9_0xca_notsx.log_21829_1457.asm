...
nop
add %rcx, %rcx
lea addresses_normal_ht+0x5a67, %rdi
nop
nop
sub %rcx, %rcx
...
nop
cmp %r12, %r12
lea addresses_normal_ht+0x4e9b, %r9
nop
nop
nop
nop
...
nop
xor %rbp, %rbp
lea addresses_WT_ht+0x19f9b, %r9
nop
nop
nop
nop
...
nop
add %rcx, %rcx
lea addresses_normal_ht+0x14797, %rsi
lea addresses_WT_ht+0x325f, %rdi
clflush (%rdi)
cmp $37071, %r9
mov $80, %rcx
rep movsl
...
// Store
lea addresses_normal+0x127b7, %rdi
cmp $2531, %rbx
movb $0x51, (%rdi)
nop
nop
...
// Store
lea addresses_normal+0x6ebb, %rax
nop
nop
nop
nop
...
// REPMOV
lea addresses_PSE+0x59b, %rsi
lea addresses_WT+0xeeee, %rdi
nop
nop
nop
nop
...
{'src': {'type': 'addresses_PSE', 'congruent': 0, 'same': True}, 'OP': 'REPM', 'dst': {'type': 'addresses_WT', 'congruent': 0, 'same': False}}
[Faulty Load]
...
{'src': {'same': False, 'congruent': 8, 'NT': False, 'type': 'addresses_normal_ht', 'size': 2, 'AVXalign': True}, 'OP': 'LOAD'}
