...
push %rdi
push %rsi
lea addresses_A_ht+0x18ed1, %rbp
nop
and %rax, %rax
movups (%rbp), %xmm5
vpextrq $0, %xmm5, %r11
...
nop
xor %r11, %r11
lea addresses_A_ht+0xe651, %rsi
lea addresses_UC_ht+0x1af51, %rdi
clflush (%rsi)
nop
nop
nop
...
nop
xor %r14, %r14
lea addresses_WC_ht+0x12cd1, %rsi
nop
nop
nop
nop
...
nop
sub $19964, %rsi
lea addresses_UC_ht+0x1cdb1, %r11
nop
nop
nop
nop
...
movq %rbp, (%r11)
and %r14, %r14
lea addresses_WC_ht+0x1b4d1, %r11
nop
sub %r13, %r13
movl $0x61626364, (%r11)
nop
cmp %r14, %r14
lea addresses_normal_ht+0x9da9, %r11
nop
nop
nop
and $31008, %rbp
...
{'OP': 'STOR', 'dst': {'NT': True, 'same': False, 'congruent': 1, 'type': 'addresses_A', 'AVXalign': False, 'size': 2}}
{'OP': 'STOR', 'dst': {'NT': False, 'same': True, 'congruent': 0, 'type': 'addresses_D', 'AVXalign': False, 'size': 32}}
