...
nop
sub %rcx, %rcx
lea addresses_normal_ht+0xff94, %r15
nop
nop
nop
sub %rbp, %rbp
...
nop
and $48396, %rbp
lea addresses_UC_ht+0x9808, %rbx
nop
nop
nop
add $22269, %r12
...
nop
sub %r15, %r15
lea addresses_normal_ht+0xd020, %rsi
lea addresses_A_ht+0x19a08, %rdi
inc %r12
mov $69, %rcx
rep movsw
nop
cmp %rbp, %rbp
lea addresses_WC_ht+0xe08, %rsi
lea addresses_A_ht+0xdb08, %rdi
nop
nop
nop
nop
...
nop
cmp %rbx, %rbx
lea addresses_normal_ht+0x1b708, %r12
nop
nop
nop
nop
...
nop
add %r15, %r15
lea addresses_WT_ht+0x16528, %r12
nop
nop
nop
and %rsi, %rsi
...
nop
and $6349, %r12
lea addresses_normal_ht+0x41e8, %rcx
nop
nop
nop
nop
...
{'src': {'type': 'addresses_normal_ht', 'congruent': 3, 'same': False}, 'dst': {'type': 'addresses_A_ht', 'congruent': 7, 'same': False}, 'OP': 'REPM'}
