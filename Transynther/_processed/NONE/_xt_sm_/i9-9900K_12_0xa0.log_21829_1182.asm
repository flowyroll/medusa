...
nop
inc %r14
lea addresses_WC_ht+0x2284, %rsi
lea addresses_UC_ht+0x15730, %rdi
nop
dec %r10
mov $95, %rcx
rep movsb
cmp %rdi, %rdi
lea addresses_normal_ht+0x365c, %r11
nop
dec %r10
movb (%r11), %r9b
nop
...
nop
inc %rsi
lea addresses_A_ht+0x58c, %rsi
lea addresses_A_ht+0x103e8, %rdi
nop
sub %r11, %r11
mov $127, %rcx
rep movsl
nop
cmp %r11, %r11
lea addresses_WC_ht+0x2b7c, %r11
nop
nop
nop
xor %rsi, %rsi
...
lea addresses_WC_ht+0x58dc, %rdi
nop
and %rbx, %rbx
mov $53, %rcx
rep movsw
...
{'src': {'same': True, 'congruent': 0, 'type': 'addresses_D_ht'}, 'OP': 'REPM', 'dst': {'same': False, 'congruent': 5, 'type': 'addresses_WC_ht'}}
{'58': 21829}
