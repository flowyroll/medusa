...
push %rdi
push %rsi
lea addresses_D_ht+0x1a8bb, %rcx
nop
sub %r13, %r13
mov (%rcx), %r15
nop
sub $12032, %r8
lea addresses_A_ht+0x160b7, %rcx
nop
dec %r13
movups (%rcx), %xmm5
vpextrq $0, %xmm5, %r11
...
nop
dec %r11
lea addresses_normal_ht+0x173db, %rbp
sub %r14, %r14
mov (%rbp), %r13d
nop
nop
sub %r15, %r15
lea addresses_UC_ht+0xb41b, %r8
nop
sub %r14, %r14
...
nop
and $63622, %r15
lea addresses_normal_ht+0x1ebdb, %rbp
nop
nop
nop
nop
...
nop
dec %r11
lea addresses_normal_ht+0xb673, %rsi
lea addresses_WT_ht+0x1abdb, %rdi
nop
nop
nop
nop
...
nop
xor $61, %rdi
lea addresses_WC_ht+0xd54b, %r14
clflush (%r14)
nop
nop
nop
...
// Store
lea addresses_normal+0x129db, %r10
nop
nop
nop
nop
...
{'OP': 'LOAD', 'src': {'type': 'addresses_A_ht', 'size': 16, 'AVXalign': False, 'NT': False, 'congruent': 2, 'same': True}}
...
{'OP': 'LOAD', 'src': {'type': 'addresses_A_ht', 'size': 4, 'AVXalign': True, 'NT': False, 'congruent': 0, 'same': True}}
