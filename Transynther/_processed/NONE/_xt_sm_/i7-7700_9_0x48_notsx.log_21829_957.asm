...
// REPMOV
lea addresses_A+0xb48a, %rsi
lea addresses_WT+0xf5ca, %rdi
nop
xor $21948, %r14
mov $2, %rcx
rep movsw
...
{'dst': {'same': False, 'congruent': 7, 'type': 'addresses_WT'}, 'OP': 'REPM', 'src': {'same': False, 'congruent': 1, 'type': 'addresses_WC'}}
...
{'dst': {'same': False, 'congruent': 10, 'type': 'addresses_WT'}, 'OP': 'REPM', 'src': {'same': False, 'congruent': 6, 'type': 'addresses_A'}}
{'dst': {'same': True, 'NT': False, 'AVXalign': False, 'size': 16, 'type': 'addresses_PSE', 'congruent': 0}, 'OP': 'STOR'}
{'dst': {'same': False, 'NT': False, 'AVXalign': False, 'size': 32, 'type': 'addresses_WT', 'congruent': 11}, 'OP': 'STOR'}
[Faulty Load]
