...
push %rdx
push %rsi
lea addresses_WC_ht+0xaaf9, %rsi
...
nop
sub %r14, %r14
lea addresses_WT_ht+0x1c8bd, %rsi
and $47224, %r15
movups (%rsi), %xmm3
vpextrq $0, %xmm3, %rdx
nop
sub $15594, %rdx
lea addresses_WC_ht+0x16139, %rsi
lea addresses_A_ht+0x13ef9, %rdi
nop
dec %rdx
mov $64, %rcx
rep movsl
cmp $23975, %rdi
lea addresses_A_ht+0xcff9, %rdi
sub %rcx, %rcx
mov (%rdi), %dx
nop
nop
...
nop
add $56325, %r12
lea addresses_D_ht+0x10979, %r15
nop
nop
nop
nop
...
{'OP': 'STOR', 'dst': {'congruent': 7, 'AVXalign': False, 'same': False, 'size': 8, 'NT': True, 'type': 'addresses_RW'}}
{'src': {'congruent': 0, 'AVXalign': False, 'same': False, 'size': 2, 'NT': True, 'type': 'addresses_WC'}, 'OP': 'LOAD'}
...
<gen_prepare_buffer>
{'src': {'congruent': 7, 'same': True, 'type': 'addresses_WC_ht'}, 'OP': 'REPM', 'dst': {'congruent': 5, 'same': False, 'type': 'addresses_UC_ht'}}
{'src': {'congruent': 2, 'AVXalign': False, 'same': False, 'size': 16, 'NT': False, 'type': 'addresses_WT_ht'}, 'OP': 'LOAD'}
{'src': {'congruent': 6, 'same': False, 'type': 'addresses_WC_ht'}, 'OP': 'REPM', 'dst': {'congruent': 10, 'same': False, 'type': 'addresses_A_ht'}}
