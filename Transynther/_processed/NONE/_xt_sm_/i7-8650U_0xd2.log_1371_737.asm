...
nop
add $61301, %rdi
lea addresses_WC_ht+0x1ec58, %rbx
nop
nop
nop
xor %r10, %r10
...
nop
sub $8602, %rcx
lea addresses_D_ht+0x19094, %r15
nop
nop
xor $58959, %r8
movups (%r15), %xmm7
...
nop
add %rax, %rax
lea addresses_UC_ht+0x7c24, %r10
nop
nop
nop
nop
...
movups %xmm7, (%r10)
and %rsi, %rsi
lea addresses_UC_ht+0x19134, %r8
nop
add $17700, %r15
...
// Store
lea addresses_normal+0xb68c, %rsi
nop
nop
nop
nop
...
// Store
lea addresses_WC+0x3394, %r8
xor $59264, %r12
movl $0x51525354, (%r8)
cmp $23144, %rsi

// Load
lea addresses_WT+0x13128, %r8
nop
and $42141, %r13
mov (%r8), %rax
nop
...
{'OP': 'LOAD', 'src': {'type': 'addresses_WT', 'size': 8, 'AVXalign': True, 'NT': False, 'congruent': 1, 'same': False}}
{'OP': 'LOAD', 'src': {'type': 'addresses_UC', 'size': 32, 'AVXalign': False, 'NT': False, 'congruent': 11, 'same': False}}
[Faulty Load]
