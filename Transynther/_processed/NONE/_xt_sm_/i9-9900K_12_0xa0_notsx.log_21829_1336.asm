...
push %r9
push %rax
lea addresses_normal_ht+0xc9de, %r10
nop
add $503, %r8
movw $0x6162, (%r10)
nop
...
nop
sub %r11, %r11
lea addresses_WT_ht+0x15bac, %r8
nop
nop
nop
and %r9, %r9
...
nop
xor $47051, %r8
lea addresses_D_ht+0x1b3ac, %r10
nop
nop
cmp $32512, %r12
...
movq %r13, (%r10)
xor %r13, %r13
lea addresses_normal_ht+0x1872c, %r12
nop
nop
nop
nop
...
movw $0x6162, (%r12)
inc %r9
lea addresses_UC_ht+0x83ac, %r13
clflush (%r13)
nop
nop
nop
...
nop
sub $62631, %r8
lea addresses_WC_ht+0x120a8, %r12
dec %r9
...
nop
and %r9, %r9
lea addresses_normal_ht+0xa7d6, %r13
nop
nop
nop
nop
...
nop
add $49023, %r9
lea addresses_UC_ht+0x6db0, %r10
nop
nop
nop
nop
...
nop
cmp $33466, %r12
lea addresses_normal_ht+0x17c8c, %r11
nop
nop
nop
and %r12, %r12
...
{'OP': 'STOR', 'dst': {'type': 'addresses_D_ht', 'AVXalign': False, 'size': 8, 'NT': True, 'same': False, 'congruent': 10}}
...
{'OP': 'STOR', 'dst': {'type': 'addresses_WC_ht', 'AVXalign': False, 'size': 32, 'NT': False, 'same': True, 'congruent': 2}}
{'OP': 'STOR', 'dst': {'type': 'addresses_normal_ht', 'AVXalign': False, 'size': 2, 'NT': False, 'same': False, 'congruent': 1}}
{'src': {'type': 'addresses_UC_ht', 'AVXalign': False, 'size': 2, 'NT': True, 'same': False, 'congruent': 2}, 'OP': 'LOAD'}
