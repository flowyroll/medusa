...
push %rcx
push %rdx
lea addresses_WC_ht+0x1e123, %r13
nop
nop
nop
nop
...
nop
cmp $43192, %rcx
lea addresses_A_ht+0x190f7, %r12
nop
nop
nop
sub %rcx, %rcx
...
nop
and $39832, %r12
lea addresses_WC_ht+0x3af7, %rax
nop
sub %r10, %r10
mov (%rax), %r13
nop
...
nop
cmp $10716, %rax
lea addresses_WT_ht+0xb7ae, %r12
nop
nop
nop
nop
