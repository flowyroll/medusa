...
nop
add $47838, %rcx
lea addresses_normal_ht+0x7d2c, %r8
cmp $39819, %r11
vmovups (%r8), %ymm1
...
// Store
lea addresses_normal+0xb46c, %rax
clflush (%rax)
cmp $58360, %rsi
movb $0x51, (%rax)
nop
...
{'OP': 'STOR', 'dst': {'type': 'addresses_normal', 'size': 1, 'AVXalign': False, 'NT': True, 'congruent': 5, 'same': False}}
{'OP': 'STOR', 'dst': {'type': 'addresses_PSE', 'size': 32, 'AVXalign': False, 'NT': False, 'congruent': 0, 'same': True}}
{'OP': 'STOR', 'dst': {'type': 'addresses_NC', 'size': 4, 'AVXalign': True, 'NT': False, 'congruent': 10, 'same': False}}
[Faulty Load]
