...
nop
cmp $26060, %rbp
lea addresses_WT_ht+0x61f7, %r15
nop
nop
xor %r9, %r9
vmovups (%r15), %ymm4
...
nop
sub $32691, %r9
lea addresses_UC_ht+0xc117, %rsi
lea addresses_WC_ht+0x1d9d7, %rdi
clflush (%rdi)
nop
nop
nop
...
nop
cmp $56589, %rsi
lea addresses_WT_ht+0x16d17, %rbp
nop
add %r15, %r15
movw $0x6162, (%rbp)
nop
...
{'OP': 'REPM', 'src': {'type': 'addresses_UC_ht', 'congruent': 5, 'same': False}, 'dst': {'type': 'addresses_WT_ht', 'congruent': 1, 'same': False}}
