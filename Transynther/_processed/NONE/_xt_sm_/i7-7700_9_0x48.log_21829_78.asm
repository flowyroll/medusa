...
push %rdi
push %rsi
lea addresses_normal_ht+0xbdcf, %rsi
lea addresses_WC_ht+0x1de3b, %rdi
nop
nop
nop
sub %rbp, %rbp
...
nop
add $22871, %rbx
lea addresses_normal_ht+0x10203, %rsi
nop
nop
nop
sub %r8, %r8
...
nop
sub $35948, %rdi
lea addresses_WT_ht+0x1ee03, %rbx
nop
and %rdi, %rdi
mov (%rbx), %si
nop
...
nop
cmp $1980, %rbp
lea addresses_UC_ht+0x120f3, %rcx
nop
nop
nop
nop
...
// Store
lea addresses_normal+0x14203, %r8
clflush (%r8)
nop
nop
nop
...
// Faulty Load
lea addresses_normal+0x14203, %r14
nop
nop
nop
xor %rdx, %rdx
...
{'OP': 'STOR', 'dst': {'type': 'addresses_WT', 'AVXalign': True, 'congruent': 6, 'size': 8, 'same': False, 'NT': False}}
{'OP': 'STOR', 'dst': {'type': 'addresses_UC', 'AVXalign': False, 'congruent': 6, 'size': 4, 'same': False, 'NT': False}}
{'OP': 'LOAD', 'src': {'type': 'addresses_NC', 'AVXalign': True, 'congruent': 3, 'size': 8, 'same': False, 'NT': False}}
[Faulty Load]
{'OP': 'LOAD', 'src': {'type': 'addresses_normal', 'AVXalign': False, 'congruent': 0, 'size': 8, 'same': True, 'NT': False}}
<gen_prepare_buffer>
{'OP': 'REPM', 'src': {'type': 'addresses_normal_ht', 'congruent': 2, 'same': True}, 'dst': {'type': 'addresses_WC_ht', 'congruent': 1, 'same': False}}
