...
nop
sub %r12, %r12
lea addresses_normal_ht+0x11abf, %r14
nop
nop
nop
sub $55099, %rcx
...
nop
dec %r15
lea addresses_UC_ht+0xfbbf, %r15
nop
nop
nop
nop
...
nop
sub $8520, %rdx
lea addresses_normal_ht+0x11c9f, %r15
nop
nop
nop
nop
...
{'OP': 'STOR', 'dst': {'NT': False, 'same': True, 'congruent': 0, 'type': 'addresses_WC', 'AVXalign': True, 'size': 2}}
