...
push %rdi
push %rsi
lea addresses_WC_ht+0x12d06, %rsi
lea addresses_normal_ht+0x359a, %rdi
nop
and $6366, %r8
mov $117, %rcx
rep movsl
...
nop
xor %r13, %r13
lea addresses_UC_ht+0xf176, %rbx
nop
nop
nop
nop
...
mov (%rbx), %r13d
and $57795, %rdi
lea addresses_UC_ht+0x17c06, %r14
clflush (%r14)
nop
nop
add %rcx, %rcx
...
// REPMOV
lea addresses_A+0xf806, %rsi
lea addresses_PSE+0xf656, %rdi
nop
nop
nop
nop
...
{'OP': 'REPM', 'src': {'type': 'addresses_A', 'congruent': 7, 'same': False}, 'dst': {'type': 'addresses_PSE', 'congruent': 1, 'same': False}}
...
<gen_prepare_buffer>
{'OP': 'REPM', 'src': {'type': 'addresses_WC_ht', 'congruent': 8, 'same': True}, 'dst': {'type': 'addresses_normal_ht', 'congruent': 2, 'same': False}}
