...
push %rdx
push %rsi
lea addresses_normal_ht+0x9df0, %rsi
lea addresses_WC_ht+0x4af0, %rdi
add $16485, %r8
mov $70, %rcx
rep movsw
nop
and $31117, %r13
lea addresses_WT_ht+0x1270, %rcx
nop
nop
nop
nop
...
mov (%rcx), %rsi
cmp $5958, %r13
lea addresses_UC_ht+0x1abc2, %r8
nop
nop
and %rdx, %rdx
movb (%r8), %cl
...
nop
lfence
lea addresses_WT_ht+0x11f0c, %rsi
lea addresses_D_ht+0xb1f0, %rdi
clflush (%rdi)
nop
nop
nop
...
nop
sub %r15, %r15
lea addresses_A_ht+0x189c8, %rsi
...
nop
cmp $29629, %r8
lea addresses_UC_ht+0x1c2f0, %rsi
nop
nop
nop
cmp $36723, %rdi
...
// Store
lea addresses_normal+0x14e70, %r9
nop
nop
nop
nop
...
{'OP': 'LOAD', 'src': {'same': False, 'type': 'addresses_NC', 'NT': False, 'AVXalign': False, 'size': 8, 'congruent': 5}}
...
<gen_prepare_buffer>
{'OP': 'REPM', 'src': {'same': False, 'congruent': 9, 'type': 'addresses_normal_ht'}, 'dst': {'same': False, 'congruent': 8, 'type': 'addresses_WC_ht'}}
...
{'OP': 'REPM', 'src': {'same': False, 'congruent': 2, 'type': 'addresses_WT_ht'}, 'dst': {'same': False, 'congruent': 11, 'type': 'addresses_D_ht'}}
{'OP': 'REPM', 'src': {'same': False, 'congruent': 2, 'type': 'addresses_A_ht'}, 'dst': {'same': True, 'congruent': 11, 'type': 'addresses_normal_ht'}}
