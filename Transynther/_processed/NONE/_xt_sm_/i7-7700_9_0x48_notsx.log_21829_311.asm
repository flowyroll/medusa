...
push %rdx
push %rsi
lea addresses_A_ht+0x16ad7, %rdi
nop
nop
nop
dec %rdx
...
nop
inc %r14
lea addresses_UC_ht+0xd357, %rsi
lea addresses_WT_ht+0x186d7, %rdi
nop
nop
nop
nop
...
nop
sub $46967, %rdi
lea addresses_A_ht+0x1357f, %r14
nop
nop
nop
nop
...
nop
sub $57722, %rsi
lea addresses_WC_ht+0xb3d7, %rsi
lea addresses_WT_ht+0xe637, %rdi
nop
nop
dec %rdx
mov $113, %rcx
...
nop
dec %r14
lea addresses_D_ht+0x1a53, %rsi
lea addresses_UC_ht+0x16e7b, %rdi
nop
nop
dec %rdx
mov $110, %rcx
...
{'dst': {'same': False, 'congruent': 4, 'type': 'addresses_WT_ht'}, 'OP': 'REPM', 'src': {'same': False, 'congruent': 7, 'type': 'addresses_WC_ht'}}
