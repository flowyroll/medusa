...
push %rdx
push %rsi
lea addresses_D_ht+0x1e000, %rsi
lea addresses_UC_ht+0xb218, %rdi
clflush (%rdi)
nop
nop
nop
...
nop
sub $32317, %rdx
lea addresses_WT_ht+0x5bb8, %r11
clflush (%r11)
nop
nop
xor %r8, %r8
...
movq %rsi, (%r11)
xor $39751, %r10
lea addresses_A_ht+0x13d08, %r10
nop
inc %rdx
movw $0x6162, (%r10)
add %r11, %r11
lea addresses_normal_ht+0xd7b8, %rsi
nop
nop
nop
and %rcx, %rcx
...
nop
inc %rdx
lea addresses_normal_ht+0x1b0ea, %r8
nop
nop
and %r11, %r11
movb $0x61, (%r8)
...
<gen_prepare_buffer>
{'src': {'congruent': 3, 'same': False, 'type': 'addresses_D_ht'}, 'dst': {'congruent': 3, 'same': False, 'type': 'addresses_UC_ht'}, 'OP': 'REPM'}
