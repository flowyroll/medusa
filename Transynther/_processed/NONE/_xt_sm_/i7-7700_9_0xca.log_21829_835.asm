...
push %rdi
push %rsi
lea addresses_WC_ht+0x1e31b, %rsi
lea addresses_UC_ht+0xef0f, %rdi
nop
nop
nop
nop
...
nop
inc %r14
lea addresses_D_ht+0x1168b, %rdi
nop
nop
and %rcx, %rcx
movups (%rdi), %xmm2
...
nop
add %rsi, %rsi
lea addresses_normal_ht+0x16e67, %r10
nop
nop
nop
and %r15, %r15
...
// Store
lea addresses_normal+0x6267, %rdi
nop
nop
nop
nop
...
{'src': {'congruent': 8, 'AVXalign': False, 'same': False, 'size': 4, 'NT': False, 'type': 'addresses_P'}, 'OP': 'LOAD'}
