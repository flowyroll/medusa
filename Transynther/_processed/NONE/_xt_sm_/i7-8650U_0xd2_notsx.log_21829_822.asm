...
push %rdi
push %rsi
lea addresses_UC_ht+0x18551, %rsi
lea addresses_D_ht+0x15bd1, %rdi
nop
nop
nop
nop
...
nop
sub %rsi, %rsi
lea addresses_WT_ht+0x5631, %r14
clflush (%r14)
nop
nop
cmp $11510, %rcx
...
nop
cmp $30189, %rcx
lea addresses_normal_ht+0x1b951, %r14
nop
nop
xor $1903, %r11
mov (%r14), %di
...
// REPMOV
lea addresses_PSE+0x1b551, %rsi
lea addresses_D+0x11bd7, %rdi
nop
nop
nop
nop
...
{'OP': 'REPM', 'src': {'type': 'addresses_PSE', 'congruent': 11, 'same': False}, 'dst': {'type': 'addresses_D', 'congruent': 1, 'same': False}}
[Faulty Load]
{'OP': 'LOAD', 'src': {'type': 'addresses_D', 'size': 16, 'AVXalign': False, 'NT': False, 'congruent': 0, 'same': True}}
<gen_prepare_buffer>
{'OP': 'REPM', 'src': {'type': 'addresses_UC_ht', 'congruent': 10, 'same': True}, 'dst': {'type': 'addresses_D_ht', 'congruent': 7, 'same': False}}
