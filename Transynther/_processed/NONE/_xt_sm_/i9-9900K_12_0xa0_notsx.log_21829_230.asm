...
nop
cmp $54030, %rbp
lea addresses_WT_ht+0x28e5, %rbx
nop
cmp %r8, %r8
mov (%rbx), %r10d
nop
...
nop
and $34949, %r10
lea addresses_WC_ht+0x3bbd, %rsi
lea addresses_UC_ht+0xe5e5, %rdi
nop
nop
cmp $32133, %rdx
mov $13, %rcx
...
nop
add %rcx, %rcx
lea addresses_D_ht+0x14e65, %rcx
nop
nop
nop
nop
...
{'src': {'type': 'addresses_WC_ht', 'congruent': 2, 'same': False}, 'OP': 'REPM', 'dst': {'type': 'addresses_UC_ht', 'congruent': 6, 'same': False}}
