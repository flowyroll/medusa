...
push %rbp
push %rdx
lea addresses_normal_ht+0x8aba, %r13
nop
and %rdx, %rdx
movb $0x61, (%r13)
nop
...
nop
xor %rbp, %rbp
lea addresses_WT_ht+0xe2ba, %rdx
nop
nop
and $10811, %r8
movl $0x61626364, (%rdx)
...
// REPMOV
lea addresses_PSE+0xab7a, %rsi
lea addresses_UC+0xdeba, %rdi
nop
nop
nop
nop
...
{'src': {'type': 'addresses_PSE', 'congruent': 6, 'same': False}, 'dst': {'type': 'addresses_UC', 'congruent': 10, 'same': False}, 'OP': 'REPM'}
{'src': {'type': 'addresses_RW', 'same': True, 'size': 4, 'congruent': 0, 'NT': False, 'AVXalign': False}, 'OP': 'LOAD'}
{'dst': {'type': 'addresses_RW', 'same': True, 'size': 2, 'congruent': 0, 'NT': False, 'AVXalign': True}, 'OP': 'STOR'}
[Faulty Load]
