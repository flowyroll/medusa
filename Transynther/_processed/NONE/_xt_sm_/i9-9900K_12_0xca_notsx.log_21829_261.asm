...
push %rdi
push %rsi
lea addresses_normal_ht+0x6c91, %rsi
lea addresses_A_ht+0xd101, %rdi
nop
nop
nop
nop
...
nop
cmp $56756, %r12
lea addresses_D_ht+0xe691, %rsi
lea addresses_UC_ht+0x651, %rdi
nop
nop
nop
dec %r11
...
// Store
lea addresses_normal+0x1c091, %rbp
nop
cmp %rax, %rax
...
// Faulty Load
lea addresses_normal+0x1c091, %rax
add $50474, %rbp
mov (%rax), %edx
lea oracles, %rcx
and $0xff, %rdx
...
{'OP': 'REPM', 'src': {'same': False, 'congruent': 8, 'type': 'addresses_D_ht'}, 'dst': {'same': False, 'congruent': 6, 'type': 'addresses_UC_ht'}}
{'58': 21829}
