...
nop
sub %rcx, %rcx
lea addresses_normal_ht+0x98ff, %rdi
nop
nop
and %r8, %r8
...
movw $0x6162, (%rbx)
lfence
lea addresses_WT_ht+0x1627f, %rsi
lea addresses_WT_ht+0x98a1, %rdi
nop
sub $32757, %r13
mov $64, %rcx
rep movsb
...
nop
and %rcx, %rcx
lea addresses_normal_ht+0x15787, %rbx
nop
nop
nop
and %rbp, %rbp
...
nop
lfence
lea addresses_WT_ht+0x131d6, %rdi
nop
dec %r8
mov (%rdi), %rcx
nop
xor %rsi, %rsi
lea addresses_normal_ht+0x13aa7, %r11
sub $23628, %rsi
vmovups (%r11), %ymm1
...
nop
xor $26860, %r13
lea addresses_WC_ht+0x172a7, %rsi
lea addresses_WC_ht+0x8ba7, %rdi
add $60795, %r8
mov $42, %rcx
rep movsq
nop
...
nop
sub $11129, %r13
lea addresses_WT_ht+0x8527, %r11
nop
add %rbp, %rbp
movw $0x6162, (%r11)
nop
...
{'src': {'same': True, 'congruent': 0, 'NT': False, 'type': 'addresses_WT_ht', 'size': 8, 'AVXalign': True}, 'OP': 'LOAD'}
...
{'OP': 'STOR', 'dst': {'same': False, 'congruent': 7, 'NT': True, 'type': 'addresses_WT_ht', 'size': 2, 'AVXalign': False}}
{'58': 21829}
