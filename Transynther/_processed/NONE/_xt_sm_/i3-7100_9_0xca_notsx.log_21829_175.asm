...
push %rdx
push %rsi
lea addresses_WT_ht+0xa7f2, %rdi
nop
nop
dec %r8
...
nop
sub %rdi, %rdi
lea addresses_normal_ht+0xf13a, %rsi
lea addresses_UC_ht+0xb41a, %rdi
nop
nop
nop
nop
...
nop
inc %rsi
lea addresses_normal_ht+0x325a, %rdi
clflush (%rdi)
nop
nop
sub $11075, %r8
...
nop
sub $35093, %rdi
lea addresses_A_ht+0x150a3, %r13
nop
and %rdx, %rdx
movb $0x61, (%r13)
nop
add %r13, %r13
lea addresses_normal_ht+0x143a, %rsi
lea addresses_WT_ht+0x9706, %rdi
cmp %rax, %rax
mov $77, %rcx
rep movsb
nop
...
nop
sub $19568, %rax
lea addresses_D_ht+0x413a, %rsi
lea addresses_WT_ht+0x5b5a, %rdi
nop
and $41510, %r13
mov $89, %rcx
rep movsl
...
nop
inc %r13
lea addresses_WC_ht+0x793a, %rsi
lea addresses_A_ht+0x181e, %rdi
nop
nop
nop
and $19402, %r8
...
rep movsq
dec %rdx
lea addresses_A_ht+0x19d01, %rsi
lea addresses_WC_ht+0xe114, %rdi
nop
nop
nop
nop
...
rep movsl
cmp $59032, %r8
lea addresses_UC_ht+0x88aa, %rsi
lea addresses_WT_ht+0x1c93a, %rdi
add $298, %r8
mov $113, %rcx
rep movsb
nop
nop
xor %rax, %rax
lea addresses_normal_ht+0x1da8a, %rdx
nop
nop
nop
nop
...
nop
add $44775, %r8
lea addresses_UC_ht+0x1293a, %rsi
nop
nop
nop
nop
...
nop
and %rax, %rax
lea addresses_normal_ht+0x1e93a, %rcx
nop
nop
nop
nop
...
// REPMOV
lea addresses_normal+0xc13a, %rsi
lea addresses_D+0x11b3a, %rdi
nop
nop
nop
sub %r15, %r15
...
{'src': {'type': 'addresses_normal', 'congruent': 11, 'same': False}, 'OP': 'REPM', 'dst': {'type': 'addresses_D', 'congruent': 9, 'same': False}}
...
{'src': {'type': 'addresses_D_ht', 'congruent': 10, 'same': False}, 'OP': 'REPM', 'dst': {'type': 'addresses_WT_ht', 'congruent': 5, 'same': False}}
{'src': {'type': 'addresses_WC_ht', 'congruent': 11, 'same': False}, 'OP': 'REPM', 'dst': {'type': 'addresses_A_ht', 'congruent': 2, 'same': False}}
