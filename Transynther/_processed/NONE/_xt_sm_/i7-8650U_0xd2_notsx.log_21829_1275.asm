...
push %rdx
push %rsi
lea addresses_UC_ht+0xae64, %rsi
lea addresses_normal_ht+0x8d4c, %rdi
and $61609, %rbp
mov $45, %rcx
rep movsl
nop
nop
cmp %rbp, %rbp
lea addresses_WT_ht+0x300e, %rsi
lea addresses_WC_ht+0xa96c, %rdi
nop
nop
nop
xor %rdx, %rdx
...
nop
add %rdx, %rdx
lea addresses_WT_ht+0x1072c, %r15
nop
nop
nop
nop
...
nop
inc %r15
lea addresses_D_ht+0x3a2c, %rsi
lea addresses_UC_ht+0x9916, %rdi
clflush (%rdi)
nop
xor %r12, %r12
mov $66, %rcx
...
nop
cmp %rsi, %rsi
lea addresses_WT_ht+0x1cf2c, %r15
add %rbp, %rbp
movb $0x61, (%r15)
nop
nop
nop
cmp $7578, %rbp
lea addresses_A_ht+0xac2c, %rsi
add %rdx, %rdx
movups (%rsi), %xmm2
vpextrq $0, %xmm2, %rdi
and %rsi, %rsi
lea addresses_A_ht+0x628, %rdi
nop
nop
nop
inc %r12
...
nop
sub %rcx, %rcx
lea addresses_D_ht+0x272c, %rsi
lea addresses_UC_ht+0x130, %rdi
add $49365, %r14
mov $51, %rcx
rep movsw
xor $59789, %rdx
lea addresses_WT_ht+0xf239, %rsi
lea addresses_D_ht+0xee2c, %rdi
nop
nop
xor $55894, %rdx
mov $60, %rcx
...
nop
sub %rsi, %rsi
lea addresses_A_ht+0x19abc, %rsi
nop
nop
inc %r12
vmovups (%rsi), %ymm0
...
nop
and %rcx, %rcx
lea addresses_D_ht+0x153c, %rsi
lea addresses_WC_ht+0x1d92c, %rdi
nop
nop
sub $12638, %r12
mov $22, %rcx
...
nop
and $30760, %rbp
lea addresses_WC_ht+0x1e72c, %rsi
lea addresses_WC_ht+0x1f2c, %rdi
nop
sub %r12, %r12
mov $113, %rcx
rep movsl
...
// Store
lea addresses_PSE+0x1872c, %rdx
add $20087, %r11
movw $0x5152, (%rdx)
dec %r14

// Faulty Load
lea addresses_PSE+0x1872c, %r11
nop
nop
nop
xor %rdx, %rdx
...
<gen_prepare_buffer>
{'OP': 'REPM', 'src': {'type': 'addresses_UC_ht', 'congruent': 2, 'same': False}, 'dst': {'type': 'addresses_normal_ht', 'congruent': 5, 'same': False}}
...
{'OP': 'LOAD', 'src': {'type': 'addresses_A_ht', 'size': 16, 'AVXalign': False, 'NT': False, 'congruent': 6, 'same': True}}
...
{'OP': 'REPM', 'src': {'type': 'addresses_WT_ht', 'congruent': 0, 'same': False}, 'dst': {'type': 'addresses_D_ht', 'congruent': 7, 'same': False}}
...
{'OP': 'STOR', 'dst': {'type': 'addresses_A_ht', 'size': 16, 'AVXalign': False, 'NT': False, 'congruent': 9, 'same': True}}
