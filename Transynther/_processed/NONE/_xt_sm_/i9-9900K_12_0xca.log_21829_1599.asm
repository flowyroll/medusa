...
nop
and $57377, %r10
lea addresses_normal_ht+0xda5, %rsi
lea addresses_normal_ht+0x1e0a5, %rdi
clflush (%rsi)
nop
nop
nop
...
nop
inc %rdx
lea addresses_A_ht+0x140ea, %rsi
lea addresses_WC_ht+0xd9d, %rdi
clflush (%rdi)
nop
nop
dec %rdx
