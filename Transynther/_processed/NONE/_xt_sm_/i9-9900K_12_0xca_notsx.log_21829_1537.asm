...
nop
cmp $44082, %rax
lea addresses_UC_ht+0x95ea, %rsi
...
// REPMOV
lea addresses_WC+0x1dea, %rsi
lea addresses_WC+0x1042a, %rdi
nop
nop
nop
nop
...
// Load
lea addresses_normal+0x189aa, %r14
nop
nop
nop
and $44561, %rcx
...
{'OP': 'REPM', 'src': {'same': False, 'congruent': 10, 'type': 'addresses_WC'}, 'dst': {'same': True, 'congruent': 6, 'type': 'addresses_WC'}}
