...
push %rbx
push %rdx
lea addresses_WC_ht+0x1685d, %r12
nop
cmp %r11, %r11
...
nop
cmp %r12, %r12
lea addresses_WC_ht+0x1ae5d, %rbx
clflush (%rbx)
nop
nop
nop
...
nop
inc %rbx
lea addresses_A_ht+0x19c01, %r14
nop
nop
cmp %rdx, %rdx
movl $0x61626364, (%r14)
...
{'src': {'congruent': 5, 'AVXalign': False, 'same': False, 'size': 1, 'NT': False, 'type': 'addresses_US'}, 'OP': 'LOAD'}
