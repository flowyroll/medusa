...
push %rdx
push %rsi
lea addresses_WT_ht+0x1e956, %rsi
lea addresses_WT_ht+0x18e72, %rdi
nop
xor %r12, %r12
mov $25, %rcx
rep movsw
...
nop
dec %rdi
lea addresses_D_ht+0x15bb2, %r12
nop
nop
xor %r9, %r9
...
nop
sub $22012, %rbp
lea addresses_UC_ht+0x1c072, %r9
nop
nop
and %r12, %r12
movb (%r9), %cl
...
nop
cmp $47223, %r12
lea addresses_normal_ht+0xd872, %r9
nop
nop
nop
nop
...
nop
sub $14288, %r12
lea addresses_D_ht+0x1cea4, %r12
nop
nop
nop
nop
...
nop
and $43959, %r9
lea addresses_UC_ht+0x14b42, %r12
clflush (%r12)
nop
cmp %r9, %r9
mov (%r12), %si
...
nop
sub %rdi, %rdi
lea addresses_UC_ht+0x2472, %rcx
sub $57926, %rdx
movb $0x61, (%rcx)
nop
nop
xor %rdx, %rdx
lea addresses_A_ht+0x3372, %rsi
lea addresses_A_ht+0x17872, %rdi
nop
nop
nop
nop
...
nop
inc %rdi
lea addresses_WT_ht+0x17972, %rbp
nop
nop
nop
nop
...
{'dst': {'NT': False, 'AVXalign': False, 'size': 8, 'congruent': 1, 'same': False, 'type': 'addresses_P'}, 'OP': 'STOR'}
...
{'src': {'NT': False, 'AVXalign': False, 'size': 1, 'congruent': 10, 'same': True, 'type': 'addresses_UC_ht'}, 'OP': 'LOAD'}
{'dst': {'NT': False, 'AVXalign': True, 'size': 2, 'congruent': 11, 'same': False, 'type': 'addresses_normal_ht'}, 'OP': 'STOR'}
...
{'src': {'congruent': 8, 'same': False, 'type': 'addresses_A_ht'}, 'dst': {'congruent': 11, 'same': False, 'type': 'addresses_A_ht'}, 'OP': 'REPM'}
{'dst': {'NT': False, 'AVXalign': False, 'size': 32, 'congruent': 7, 'same': True, 'type': 'addresses_WT_ht'}, 'OP': 'STOR'}
