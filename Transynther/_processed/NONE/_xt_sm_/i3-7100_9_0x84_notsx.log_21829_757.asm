...
push %rdi
push %rsi
lea addresses_UC_ht+0xbd5d, %r11
and $60817, %rsi
movl $0x61626364, (%r11)
dec %r15
lea addresses_UC_ht+0x64fd, %rsi
lea addresses_A_ht+0x1e81d, %rdi
nop
nop
nop
inc %r13
...
nop
cmp %rsi, %rsi
lea addresses_A_ht+0x1c05d, %rsi
lea addresses_normal_ht+0x1475, %rdi
clflush (%rdi)
nop
add $51353, %r8
mov $77, %rcx
...
nop
sub $30518, %r8
lea addresses_A_ht+0xde5d, %rsi
lea addresses_A_ht+0x86e6, %rdi
nop
nop
nop
nop
...
nop
xor $9703, %r11
lea addresses_normal_ht+0x1b211, %r11
nop
nop
sub %r8, %r8
mov (%r11), %di
...
// Store
lea addresses_normal+0xf45d, %rcx
nop
add %r9, %r9
movl $0x51525354, (%rcx)
nop
...
{'dst': {'type': 'addresses_normal', 'same': False, 'size': 4, 'congruent': 10, 'NT': False, 'AVXalign': True}, 'OP': 'STOR'}
{'dst': {'type': 'addresses_D', 'same': True, 'size': 4, 'congruent': 0, 'NT': False, 'AVXalign': False}, 'OP': 'STOR'}
{'src': {'type': 'addresses_UC', 'same': False, 'size': 1, 'congruent': 9, 'NT': False, 'AVXalign': False}, 'OP': 'LOAD'}
...
{'src': {'type': 'addresses_A_ht', 'congruent': 11, 'same': False}, 'dst': {'type': 'addresses_normal_ht', 'congruent': 2, 'same': False}, 'OP': 'REPM'}
{'src': {'type': 'addresses_A_ht', 'congruent': 7, 'same': True}, 'dst': {'type': 'addresses_A_ht', 'congruent': 0, 'same': False}, 'OP': 'REPM'}
