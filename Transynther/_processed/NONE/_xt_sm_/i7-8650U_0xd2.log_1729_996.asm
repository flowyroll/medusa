...
push %rdi
push %rsi
lea addresses_D_ht+0x19b5f, %rsi
lea addresses_WT_ht+0x1b4d6, %rdi
nop
nop
nop
sub %rbp, %rbp
...
nop
and $36922, %rsi
lea addresses_normal_ht+0x754e, %r14
nop
nop
cmp %rcx, %rcx
mov (%r14), %di
nop
add $1918, %rdi
lea addresses_WT_ht+0x170ce, %r15
nop
nop
nop
nop
...
nop
cmp %rsi, %rsi
lea addresses_D_ht+0xe64e, %rsi
lea addresses_normal_ht+0x6ace, %rdi
nop
nop
nop
xor $26435, %r12
...
nop
sub %rdi, %rdi
lea addresses_UC_ht+0x1ca4e, %rdi
nop
nop
nop
nop
...
nop
add %rdi, %rdi
lea addresses_WC_ht+0x2d04, %r14
nop
nop
nop
nop
...
nop
add %r14, %r14
lea addresses_normal_ht+0x1d8ae, %rsi
nop
nop
xor %r15, %r15
movb $0x61, (%rsi)
cmp %rbp, %rbp
lea addresses_WT_ht+0x10d0e, %r12
nop
nop
nop
and $48999, %r14
...
nop
cmp %rdi, %rdi
lea addresses_WT_ht+0x1144e, %r12
nop
nop
inc %rcx
movl $0x61626364, (%r12)
...
nop
cmp $53289, %r12
lea addresses_A_ht+0x15d69, %r15
nop
nop
nop
nop
...
nop
add %r12, %r12
lea addresses_WC_ht+0x12c4e, %rsi
lea addresses_A_ht+0x496e, %rdi
sub %r8, %r8
mov $118, %rcx
rep movsb
nop
...
{'OP': 'STOR', 'dst': {'type': 'addresses_UC', 'size': 2, 'AVXalign': False, 'NT': True, 'congruent': 1, 'same': False}}
