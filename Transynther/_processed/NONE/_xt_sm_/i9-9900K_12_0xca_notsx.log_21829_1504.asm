...
push %rdx
push %rsi
lea addresses_D_ht+0x10e53, %r15
sub $42150, %rbx
movw $0x6162, (%r15)
nop
nop
xor $60580, %r9
lea addresses_WC_ht+0x291b, %r13
nop
nop
nop
nop
...
nop
inc %r13
lea addresses_WT_ht+0x14a97, %rsi
lea addresses_UC_ht+0x1e823, %rdi
clflush (%rsi)
nop
nop
dec %r15
...
rep movsl
and $26077, %rsi
lea addresses_WC_ht+0xc317, %r15
nop
nop
nop
nop
...
nop
sub %rcx, %rcx
lea addresses_A_ht+0x18163, %rsi
nop
dec %rdx
movw $0x6162, (%rsi)
nop
...
{'OP': 'STOR', 'dst': {'same': False, 'type': 'addresses_D', 'NT': False, 'AVXalign': False, 'size': 8, 'congruent': 3}}
[Faulty Load]
...
{'OP': 'REPM', 'src': {'same': False, 'congruent': 1, 'type': 'addresses_WT_ht'}, 'dst': {'same': False, 'congruent': 6, 'type': 'addresses_UC_ht'}}
{'OP': 'STOR', 'dst': {'same': False, 'type': 'addresses_WC_ht', 'NT': False, 'AVXalign': False, 'size': 16, 'congruent': 1}}
{'OP': 'STOR', 'dst': {'same': False, 'type': 'addresses_A_ht', 'NT': True, 'AVXalign': False, 'size': 2, 'congruent': 9}}
{'58': 21829}
