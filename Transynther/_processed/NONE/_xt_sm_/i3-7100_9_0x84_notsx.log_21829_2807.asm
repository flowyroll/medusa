...
push %rdi
push %rsi
lea addresses_A_ht+0xb3f9, %rsi
lea addresses_WT_ht+0x2b09, %rdi
nop
nop
nop
cmp $42747, %r12
...
nop
add $12331, %rsi
lea addresses_D_ht+0x2689, %rsi
lea addresses_D_ht+0x19e9, %rdi
clflush (%rsi)
nop
nop
nop
...
nop
xor $59854, %r12
lea addresses_WT_ht+0x9ff1, %rdi
nop
nop
nop
add %rsi, %rsi
...
// Store
lea addresses_normal+0x17c89, %rsi
nop
nop
nop
nop
...
<gen_prepare_buffer>
{'src': {'type': 'addresses_A_ht', 'congruent': 3, 'same': False}, 'dst': {'type': 'addresses_WT_ht', 'congruent': 7, 'same': True}, 'OP': 'REPM'}
