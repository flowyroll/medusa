...
push %rdi
push %rsi
lea addresses_WC_ht+0x1e4d4, %rsi
lea addresses_WT_ht+0x18d34, %rdi
clflush (%rdi)
nop
nop
cmp $42176, %r10
...
nop
cmp %rax, %rax
lea addresses_A_ht+0x1c014, %rbx
nop
nop
nop
inc %r15
...
nop
and %r15, %r15
lea addresses_WC_ht+0x4034, %rsi
...
nop
sub %r15, %r15
lea addresses_WT_ht+0x11d34, %rcx
nop
nop
nop
nop
...
nop
cmp %r11, %r11
lea addresses_WT_ht+0x2eb4, %rsi
lea addresses_UC_ht+0x9134, %rdi
nop
nop
nop
nop
...
nop
sub %rax, %rax
lea addresses_normal_ht+0x15934, %rbx
sub $28253, %rdi
mov (%rbx), %r11d
inc %rbx
lea addresses_D_ht+0x7f34, %rcx
nop
nop
nop
nop
...
nop
inc %rcx
lea addresses_WT_ht+0x1d674, %rsi
nop
add %r11, %r11
vmovups (%rsi), %ymm2
...
{'src': {'congruent': 1, 'same': False, 'type': 'addresses_WC_ht'}, 'dst': {'congruent': 8, 'same': False, 'type': 'addresses_A_ht'}, 'OP': 'REPM'}
{'dst': {'NT': False, 'AVXalign': False, 'size': 2, 'congruent': 10, 'same': False, 'type': 'addresses_WT_ht'}, 'OP': 'STOR'}
{'src': {'congruent': 6, 'same': False, 'type': 'addresses_WT_ht'}, 'dst': {'congruent': 11, 'same': False, 'type': 'addresses_UC_ht'}, 'OP': 'REPM'}
