...
push %rdi
push %rdx
lea addresses_UC_ht+0x15f83, %r10
nop
nop
nop
and %rdi, %rdi
...
nop
and $1600, %rdx
lea addresses_normal_ht+0x14d33, %r11
nop
nop
nop
and %rbx, %rbx
...
{'OP': 'STOR', 'dst': {'type': 'addresses_WC', 'AVXalign': False, 'congruent': 8, 'size': 32, 'same': False, 'NT': True}}
...
{'OP': 'STOR', 'dst': {'type': 'addresses_A_ht', 'AVXalign': False, 'congruent': 11, 'size': 32, 'same': False, 'NT': True}}
{'58': 21829}
