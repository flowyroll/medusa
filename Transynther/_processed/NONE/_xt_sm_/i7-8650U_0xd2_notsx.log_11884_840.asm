...
movups %xmm4, (%r8)
and %rbp, %rbp
lea addresses_UC_ht+0x15290, %rsi
lea addresses_D_ht+0xf189, %rdi
nop
cmp $38785, %r9
mov $49, %rcx
rep movsb
...
nop
cmp $32616, %r9
lea addresses_D_ht+0x11eb0, %rdi
xor $29596, %rcx
mov $0x6162636465666768, %rbp
movq %rbp, %xmm6
movups %xmm6, (%rdi)
...
movq %rcx, (%rsi)
sub %rsi, %rsi
lea addresses_normal_ht+0x8d80, %rcx
nop
sub %r8, %r8
vmovups (%rcx), %ymm1
...
// REPMOV
lea addresses_WC+0x1ce90, %rsi
lea addresses_WT+0x7410, %rdi
nop
nop
nop
nop
...
// REPMOV
lea addresses_RW+0xbb0, %rsi
lea addresses_normal+0x1e753, %rdi
nop
nop
nop
nop
...
{'OP': 'REPM', 'src': {'type': 'addresses_WC', 'congruent': 11, 'same': False}, 'dst': {'type': 'addresses_WT', 'congruent': 6, 'same': False}}
{'OP': 'STOR', 'dst': {'type': 'addresses_D', 'size': 8, 'AVXalign': False, 'NT': False, 'congruent': 0, 'same': True}}
{'OP': 'REPM', 'src': {'type': 'addresses_RW', 'congruent': 5, 'same': False}, 'dst': {'type': 'addresses_normal', 'congruent': 0, 'same': False}}
