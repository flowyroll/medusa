...
push %rdi
push %rsi
lea addresses_WT_ht+0x1e1f5, %r12
nop
nop
nop
nop
...
nop
xor $58411, %rbx
lea addresses_normal_ht+0x1dc4d, %rsi
lea addresses_UC_ht+0x137f5, %rdi
nop
nop
nop
nop
...
rep movsb
and %rcx, %rcx
lea addresses_A_ht+0xb9f5, %rbx
nop
inc %rdi
movb $0x61, (%rbx)
nop
sub %r15, %r15
lea addresses_UC_ht+0x5775, %rsi
lea addresses_A_ht+0x1c8ff, %rdi
clflush (%rdi)
nop
nop
nop
...
// REPMOV
lea addresses_A+0x16635, %rsi
lea addresses_UC+0x3af5, %rdi
nop
nop
nop
nop
...
// REPMOV
lea addresses_D+0xfbe4, %rsi
lea addresses_A+0x1b5f5, %rdi
clflush (%rsi)
clflush (%rdi)
nop
nop
...
{'dst': {'NT': False, 'AVXalign': False, 'size': 4, 'congruent': 0, 'same': True, 'type': 'addresses_WC'}, 'OP': 'STOR'}
{'dst': {'NT': False, 'AVXalign': False, 'size': 1, 'congruent': 11, 'same': False, 'type': 'addresses_D'}, 'OP': 'STOR'}
{'src': {'congruent': 6, 'same': False, 'type': 'addresses_A'}, 'dst': {'congruent': 8, 'same': False, 'type': 'addresses_UC'}, 'OP': 'REPM'}
{'src': {'congruent': 0, 'same': False, 'type': 'addresses_D'}, 'dst': {'congruent': 9, 'same': False, 'type': 'addresses_A'}, 'OP': 'REPM'}
[Faulty Load]
