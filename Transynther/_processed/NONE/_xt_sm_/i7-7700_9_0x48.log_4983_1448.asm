...
push %rdi
push %rsi
lea addresses_A_ht+0x1bccb, %rbp
xor $32765, %r10
mov (%rbp), %r14d
cmp %r10, %r10
lea addresses_D_ht+0xbafb, %rsi
lea addresses_A_ht+0x1bf57, %rdi
nop
nop
sub %r9, %r9
mov $72, %rcx
...
nop
cmp %r10, %r10
lea addresses_D_ht+0x148bb, %r14
nop
nop
nop
nop
...
{'OP': 'REPM', 'src': {'type': 'addresses_D_ht', 'congruent': 3, 'same': False}, 'dst': {'type': 'addresses_A_ht', 'congruent': 0, 'same': False}}
