...
push %rdi
push %rsi
lea addresses_UC_ht+0x1815e, %rcx
nop
inc %rdi
mov (%rcx), %r15w
and %rsi, %rsi
lea addresses_WC_ht+0x12091, %rsi
lea addresses_normal_ht+0xb49, %rdi
sub $55136, %r13
mov $18, %rcx
rep movsq
nop
...
nop
inc %rcx
lea addresses_WT_ht+0x1b9df, %rcx
nop
add $2358, %rbp
movb (%rcx), %r13b
nop
...
{'src': {'type': 'addresses_WC_ht', 'congruent': 3, 'same': False}, 'dst': {'type': 'addresses_normal_ht', 'congruent': 10, 'same': False}, 'OP': 'REPM'}
