...
// REPMOV
lea addresses_WT+0xf507, %rsi
lea addresses_A+0x9503, %rdi
add $28602, %rdx
mov $26, %rcx
rep movsl
nop
...
// Store
lea addresses_normal+0xe187, %rdi
nop
cmp $14091, %rsi
movl $0x51525354, (%rdi)
nop
...
// Load
lea addresses_normal+0x1a707, %rbp
nop
nop
nop
add %rcx, %rcx
...
// Store
lea addresses_normal+0x9c1b, %rax
nop
dec %r8
mov $0x5152535455565758, %rbp
movq %rbp, %xmm0
...
{'src': {'NT': False, 'AVXalign': False, 'size': 4, 'congruent': 4, 'same': False, 'type': 'addresses_RW'}, 'OP': 'LOAD'}
...
{'src': {'congruent': 0, 'same': True, 'type': 'addresses_WT'}, 'dst': {'congruent': 1, 'same': False, 'type': 'addresses_A'}, 'OP': 'REPM'}
