...
// Store
lea addresses_normal+0x129fe, %r15
nop
nop
nop
xor %rbp, %rbp
...
// REPMOV
lea addresses_normal+0x39fe, %rsi
lea addresses_A+0x1debe, %rdi
clflush (%rsi)
nop
nop
nop
...
// Faulty Load
lea addresses_normal+0x129fe, %r11
and %rcx, %rcx
movb (%r11), %r15b
lea oracles, %rdi
and $0xff, %r15
...
{'dst': {'type': 'addresses_normal', 'same': True, 'size': 8, 'congruent': 0, 'NT': True, 'AVXalign': True}, 'OP': 'STOR'}
...
<gen_prepare_buffer>
{'src': {'type': 'addresses_A_ht', 'congruent': 0, 'same': False}, 'dst': {'type': 'addresses_A_ht', 'congruent': 1, 'same': False}, 'OP': 'REPM'}
{'58': 21829}
