...
push %rdi
push %rsi
lea addresses_UC_ht+0x1eb25, %rsi
lea addresses_D_ht+0x1cf85, %rdi
nop
nop
cmp %r8, %r8
mov $120, %rcx
...
nop
sub $57048, %rdi
lea addresses_A_ht+0x1612d, %rsi
lea addresses_A_ht+0xcbc3, %rdi
nop
cmp $12906, %rax
mov $9, %rcx
rep movsq
nop
cmp $13299, %r8
lea addresses_A_ht+0x16725, %rsi
nop
nop
nop
nop
...
// Store
lea addresses_normal+0x1125, %r14
nop
nop
nop
nop
...
<gen_prepare_buffer>
{'dst': {'same': False, 'congruent': 5, 'type': 'addresses_D_ht'}, 'OP': 'REPM', 'src': {'same': False, 'congruent': 11, 'type': 'addresses_UC_ht'}}
{'dst': {'same': False, 'congruent': 0, 'type': 'addresses_A_ht'}, 'OP': 'REPM', 'src': {'same': False, 'congruent': 3, 'type': 'addresses_A_ht'}}
