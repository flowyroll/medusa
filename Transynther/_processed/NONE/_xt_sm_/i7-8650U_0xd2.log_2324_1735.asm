...
lea addresses_WT_ht+0x1612b, %rdi
nop
and $337, %r10
mov $50, %rcx
rep movsw
...
nop
dec %rbp
lea addresses_UC_ht+0x1dd15, %r10
nop
xor %rax, %rax
...
nop
cmp $63492, %r11
lea addresses_UC_ht+0x19210, %r10
sub $22730, %rdi
movw $0x6162, (%r10)
nop
nop
nop
xor $9563, %rax
lea addresses_WT_ht+0x1db15, %rax
nop
nop
nop
and $11680, %rbp
...
nop
xor $32750, %rdi
lea addresses_WC_ht+0x12cad, %rax
nop
nop
sub $32494, %rbp
movb $0x61, (%rax)
...
nop
cmp %rcx, %rcx
lea addresses_normal_ht+0x1a125, %rcx
nop
nop
nop
cmp $22157, %r11
...
nop
add %r11, %r11
lea addresses_WT_ht+0x14915, %rsi
lea addresses_normal_ht+0x8315, %rdi
nop
add $18233, %r11
mov $101, %rcx
rep movsw
