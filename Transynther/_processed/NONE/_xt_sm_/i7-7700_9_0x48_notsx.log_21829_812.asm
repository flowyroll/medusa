...
push %rdx
push %rsi
lea addresses_A_ht+0x191fd, %r15
clflush (%r15)
sub $22403, %rcx
...
nop
sub %r9, %r9
lea addresses_D_ht+0x11a1d, %rdx
nop
nop
nop
nop
...
nop
add $57493, %rcx
lea addresses_D_ht+0x1e39d, %r15
nop
nop
nop
xor $12725, %r13
...
nop
xor %r13, %r13
lea addresses_normal_ht+0x41bd, %rsi
