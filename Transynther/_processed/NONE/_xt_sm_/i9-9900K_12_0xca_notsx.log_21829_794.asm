...
rep movsl
sub %rcx, %rcx
lea addresses_WT_ht+0x2c8c, %rcx
nop
nop
cmp $19049, %rsi
movl $0x61626364, (%rcx)
...
nop
sub %rdx, %rdx
lea addresses_WC_ht+0x14c8c, %rdx
nop
inc %r13
...
// Store
lea addresses_normal+0x1f54, %r13
nop
nop
nop
nop
...
{'OP': 'REPM', 'src': {'same': False, 'congruent': 10, 'type': 'addresses_UC_ht'}, 'dst': {'same': False, 'congruent': 4, 'type': 'addresses_UC_ht'}}
