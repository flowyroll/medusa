...
push %rdi
push %rsi
lea addresses_WC_ht+0x5c37, %rsi
lea addresses_UC_ht+0x1421f, %rdi
nop
nop
nop
nop
...
nop
xor $60196, %rcx
lea addresses_normal_ht+0x195a7, %r10
nop
nop
nop
nop
...
{'src': {'type': 'addresses_NC', 'same': False, 'size': 4, 'congruent': 11, 'NT': False, 'AVXalign': True}, 'OP': 'LOAD'}
[Faulty Load]
