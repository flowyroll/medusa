...
rep movsq
add $36772, %r13
lea addresses_WT_ht+0x12198, %r9
sub $13642, %rsi
mov (%r9), %cx
nop
nop
nop
add $18353, %r13
lea addresses_WT_ht+0x16b30, %rcx
nop
cmp $27928, %r14
movw $0x6162, (%rcx)
nop
nop
and $31815, %r9
lea addresses_A_ht+0x1030, %rsi
lea addresses_D_ht+0x16ab9, %rdi
nop
nop
nop
nop
...
rep movsw
inc %r15
lea addresses_WT_ht+0x1a82d, %rsi
lea addresses_WT_ht+0x2bf4, %rdi
nop
nop
nop
nop
...
nop
cmp %r13, %r13
lea addresses_A_ht+0x10e94, %rsi
...
nop
and %r12, %r12
lea addresses_WC_ht+0x18eb0, %r15
sub %rdi, %rdi
movb $0x61, (%r15)
nop
nop
...
nop
dec %rdi
lea addresses_normal_ht+0xa774, %rcx
and $5939, %r14
mov (%rcx), %r9w
nop
nop
...
<gen_prepare_buffer>
{'src': {'congruent': 0, 'same': False, 'type': 'addresses_UC_ht'}, 'OP': 'REPM', 'dst': {'congruent': 5, 'same': False, 'type': 'addresses_UC_ht'}}
...
{'src': {'congruent': 11, 'same': False, 'type': 'addresses_A_ht'}, 'OP': 'REPM', 'dst': {'congruent': 0, 'same': False, 'type': 'addresses_D_ht'}}
{'src': {'congruent': 0, 'same': False, 'type': 'addresses_WT_ht'}, 'OP': 'REPM', 'dst': {'congruent': 1, 'same': False, 'type': 'addresses_WT_ht'}}
