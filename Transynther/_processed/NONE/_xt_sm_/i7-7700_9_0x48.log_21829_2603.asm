...
lea addresses_UC_ht+0x190d4, %rdi
nop
xor $35190, %r10
mov $9, %rcx
rep movsb
...
lea addresses_UC_ht+0x1b28, %rdi
clflush (%rdi)
nop
nop
nop
...
rep movsl
sub $41607, %rax
lea addresses_D_ht+0x1528, %rsi
lea addresses_WC_ht+0x14528, %rdi
nop
nop
nop
nop
...
// Store
lea addresses_normal+0x5528, %r13
sub $12302, %rsi
...
// Faulty Load
lea addresses_normal+0x5528, %rdi
nop
xor $17649, %rbx
mov (%rdi), %si
lea oracles, %rax
...
<gen_prepare_buffer>
{'OP': 'REPM', 'src': {'type': 'addresses_A_ht', 'congruent': 11, 'same': False}, 'dst': {'type': 'addresses_UC_ht', 'congruent': 0, 'same': False}}
