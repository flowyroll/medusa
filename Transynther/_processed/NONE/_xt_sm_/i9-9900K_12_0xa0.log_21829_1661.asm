...
push %rdx
push %rsi
lea addresses_UC_ht+0x19ebf, %r12
nop
nop
xor $993, %rax
mov (%r12), %r15d
add %r11, %r11
lea addresses_normal_ht+0x19a1f, %rsi
lea addresses_normal_ht+0x1601f, %rdi
nop
nop
nop
inc %rdx
...
{'OP': 'STOR', 'dst': {'NT': False, 'same': False, 'congruent': 0, 'type': 'addresses_UC', 'AVXalign': False, 'size': 2}}
[Faulty Load]
