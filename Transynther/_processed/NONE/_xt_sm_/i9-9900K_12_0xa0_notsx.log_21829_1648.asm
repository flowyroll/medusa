...
nop
cmp $53176, %rsi
lea addresses_A_ht+0x19341, %rsi
nop
nop
dec %r11
vmovups (%rsi), %ymm2
...
nop
inc %r10
lea addresses_WT_ht+0x10a41, %rsi
...
// REPMOV
lea addresses_WC+0x3901, %rsi
lea addresses_UC+0x1a4b2, %rdi
nop
nop
sub $21395, %rbp
mov $105, %rcx
...
{'src': {'type': 'addresses_WC', 'congruent': 5, 'same': False}, 'OP': 'REPM', 'dst': {'type': 'addresses_UC', 'congruent': 0, 'same': False}}
{'OP': 'STOR', 'dst': {'type': 'addresses_A', 'AVXalign': False, 'size': 1, 'NT': False, 'same': False, 'congruent': 9}}
{'OP': 'STOR', 'dst': {'type': 'addresses_NC', 'AVXalign': True, 'size': 2, 'NT': False, 'same': False, 'congruent': 1}}
