...
push %rdi
push %rsi
lea addresses_D_ht+0x10c27, %r12
nop
nop
nop
nop
...
nop
dec %rax
lea addresses_WC_ht+0x80c7, %rbp
nop
nop
and %r10, %r10
movb (%rbp), %bl
...
nop
sub $35116, %rsi
lea addresses_UC_ht+0x1ac61, %rsi
lea addresses_WC_ht+0x17227, %rdi
add %r12, %r12
mov $37, %rcx
rep movsw
nop
