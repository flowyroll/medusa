...
push %rdi
push %rsi
lea addresses_D_ht+0x1b788, %rbx
xor %rdi, %rdi
...
nop
sub %r10, %r10
lea addresses_WC_ht+0xf448, %rsi
lea addresses_D_ht+0x5098, %rdi
nop
nop
nop
nop
...
nop
sub %r10, %r10
lea addresses_WC_ht+0x16588, %rsi
lea addresses_UC_ht+0x1c048, %rdi
nop
cmp $37859, %r15
mov $61, %rcx
rep movsl
...
nop
dec %rcx
lea addresses_normal_ht+0x13568, %rsi
lea addresses_WT_ht+0x7048, %rdi
cmp %r10, %r10
mov $16, %rcx
rep movsl
nop
inc %r15
lea addresses_normal_ht+0x163c0, %rdi
nop
sub $40928, %rcx
mov (%rdi), %si
xor $37837, %rbx
lea addresses_D_ht+0x1ce00, %r9
nop
nop
nop
lfence
...
nop
and $1527, %rcx
lea addresses_WT_ht+0x17b78, %rbx
nop
nop
nop
add $63657, %rsi
...
{'src': {'type': 'addresses_WC_ht', 'congruent': 10, 'same': False}, 'dst': {'type': 'addresses_D_ht', 'congruent': 4, 'same': False}, 'OP': 'REPM'}
{'src': {'type': 'addresses_WC_ht', 'congruent': 6, 'same': True}, 'dst': {'type': 'addresses_UC_ht', 'congruent': 11, 'same': False}, 'OP': 'REPM'}
{'src': {'type': 'addresses_normal_ht', 'congruent': 5, 'same': False}, 'dst': {'type': 'addresses_WT_ht', 'congruent': 6, 'same': False}, 'OP': 'REPM'}
