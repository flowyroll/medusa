...
push %rdi
push %rsi
lea addresses_WC_ht+0x1de05, %r15
clflush (%r15)
nop
cmp $7654, %r10
movups (%r15), %xmm6
...
nop
inc %rbx
lea addresses_UC_ht+0x16645, %rcx
nop
nop
add $54412, %r12
mov (%rcx), %r14
...
nop
cmp $38375, %r12
lea addresses_WT_ht+0x197d5, %r9
and %r10, %r10
mov (%r9), %rcx
nop
nop
nop
sub $15670, %r10
lea addresses_WT_ht+0x1d905, %rsi
lea addresses_D_ht+0x17905, %rdi
nop
nop
nop
nop
...
nop
and $50568, %rbx
lea addresses_normal_ht+0x14a9c, %rsi
lea addresses_WC_ht+0xb165, %rdi
nop
nop
nop
nop
...
rep movsb
xor %r14, %r14
lea addresses_WC_ht+0x1c85f, %r9
nop
nop
add %r15, %r15
mov (%r9), %r12w
...
nop
add %r15, %r15
lea addresses_UC_ht+0xf105, %rsi
nop
nop
nop
cmp $12396, %r15
movw $0x6162, (%rsi)
cmp %r12, %r12
lea addresses_WT_ht+0x1c105, %rsi
...
nop
and $43106, %r9
lea addresses_normal_ht+0x129bd, %rsi
xor $25264, %r15
mov $0x6162636465666768, %rdi
movq %rdi, %xmm4
vmovups %ymm4, (%rsi)
xor %rdi, %rdi
lea addresses_UC_ht+0xd05, %rsi
lea addresses_D_ht+0x1e205, %rdi
nop
nop
cmp $36890, %r10
mov $30, %rcx
...
{'src': {'type': 'addresses_WT_ht', 'congruent': 10, 'same': True}, 'dst': {'type': 'addresses_D_ht', 'congruent': 11, 'same': False}, 'OP': 'REPM'}
...
{'src': {'type': 'addresses_WT_ht', 'congruent': 9, 'same': False}, 'dst': {'type': 'addresses_normal_ht', 'congruent': 8, 'same': False}, 'OP': 'REPM'}
{'dst': {'type': 'addresses_normal_ht', 'same': False, 'size': 32, 'congruent': 2, 'NT': False, 'AVXalign': False}, 'OP': 'STOR'}
{'src': {'type': 'addresses_UC_ht', 'congruent': 10, 'same': False}, 'dst': {'type': 'addresses_D_ht', 'congruent': 8, 'same': True}, 'OP': 'REPM'}
{'58': 21829}
