...
nop
xor $38444, %r15
lea addresses_UC_ht+0x2c07, %rbx
nop
nop
and %r8, %r8
...
nop
add $41012, %r9
lea addresses_normal_ht+0x126e5, %r8
nop
nop
xor $6821, %r12
mov (%r8), %r15
...
nop
dec %rbp
lea addresses_D_ht+0x1a6cb, %rsi
lea addresses_normal_ht+0x9c07, %rdi
nop
nop
nop
nop
...
nop
xor %rdi, %rdi
lea addresses_WC_ht+0x18a87, %r12
add %r13, %r13
movw $0x6162, (%r12)
nop
nop
...
nop
xor %r8, %r8
lea addresses_UC_ht+0x13966, %rbp
nop
xor %r8, %r8
movb (%rbp), %r9b
nop
nop
and %r9, %r9
lea addresses_normal_ht+0x2607, %rbx
nop
nop
nop
sub $7504, %r9
...
{'src': {'NT': False, 'same': False, 'congruent': 5, 'type': 'addresses_PSE', 'AVXalign': False, 'size': 2}, 'OP': 'LOAD'}
