...
nop
xor $28233, %rbp
lea addresses_UC_ht+0x1cc38, %rsi
lea addresses_WT_ht+0x1b878, %rdi
clflush (%rdi)
nop
nop
dec %r11
...
nop
add %rsi, %rsi
lea addresses_WT_ht+0x17478, %r13
add %rdi, %rdi
...
nop
xor $25346, %rbp
lea addresses_WC_ht+0x111a, %r11
nop
nop
nop
nop
...
// REPMOV
lea addresses_WT+0x6be8, %rsi
lea addresses_UC+0x44f8, %rdi
nop
nop
and $1119, %r14
mov $70, %rcx
...
{'OP': 'LOAD', 'src': {'same': False, 'NT': False, 'AVXalign': False, 'size': 2, 'type': 'addresses_WC', 'congruent': 1}}
{'dst': {'same': True, 'NT': False, 'AVXalign': False, 'size': 2, 'type': 'addresses_WC', 'congruent': 0}, 'OP': 'STOR'}
{'dst': {'same': False, 'congruent': 6, 'type': 'addresses_UC'}, 'OP': 'REPM', 'src': {'same': False, 'congruent': 3, 'type': 'addresses_WT'}}
...
{'dst': {'same': False, 'congruent': 3, 'type': 'addresses_D_ht'}, 'OP': 'REPM', 'src': {'same': False, 'congruent': 8, 'type': 'addresses_WC_ht'}}
