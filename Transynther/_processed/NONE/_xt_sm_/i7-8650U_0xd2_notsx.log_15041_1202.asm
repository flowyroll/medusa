...
nop
cmp %rsi, %rsi
lea addresses_D_ht+0x7eb6, %rsi
lea addresses_normal_ht+0xcb36, %rdi
nop
nop
nop
add $42902, %r11
...
rep movsq
add $32197, %r11
lea addresses_WC_ht+0x1c8ae, %rsi
lea addresses_A_ht+0x192b6, %rdi
clflush (%rsi)
nop
nop
add $53274, %r15
