...
nop
add %rbx, %rbx
lea addresses_normal_ht+0x17317, %r11
sub %r8, %r8
mov (%r11), %rsi
nop
nop
...
nop
sub %rbx, %rbx
lea addresses_normal_ht+0x11017, %rsi
lea addresses_normal_ht+0x19157, %rdi
nop
nop
nop
nop
...
lea addresses_WC_ht+0x7f47, %rdi
dec %rbx
mov $42, %rcx
rep movsq
nop
inc %rdi
lea addresses_WC_ht+0x16787, %rbx
nop
nop
nop
nop
...
nop
cmp %r11, %r11
lea addresses_normal_ht+0x1de3f, %rcx
nop
nop
nop
nop
...
nop
add %r8, %r8
lea addresses_WT_ht+0x57bb, %rsi
lea addresses_D_ht+0x180b7, %rdi
nop
add $599, %r11
mov $25, %rcx
rep movsq
...
{'OP': 'LOAD', 'src': {'type': 'addresses_WT_ht', 'AVXalign': False, 'congruent': 9, 'size': 1, 'same': True, 'NT': False}}
