...
movw $0x6162, (%r9)
add $34508, %r14
lea addresses_normal_ht+0x7562, %r9
nop
nop
nop
nop
...
nop
xor $43837, %rbp
lea addresses_normal_ht+0x1b152, %rdx
add %r15, %r15
...
movntdq %xmm2, (%rdx)
inc %r15
lea addresses_WT_ht+0x1b523, %r9
nop
sub $18657, %rdi
movb (%r9), %r12b
nop
