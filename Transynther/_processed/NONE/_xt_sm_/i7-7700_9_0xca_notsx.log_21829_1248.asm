...
nop
add %rsi, %rsi
lea addresses_normal_ht+0x18365, %r15
nop
nop
nop
sub $3171, %rdi
...
// Store
lea addresses_normal+0x1e505, %rcx
nop
nop
nop
nop
...
// REPMOV
lea addresses_PSE+0x1851b, %rsi
lea addresses_A+0x17e65, %rdi
nop
nop
nop
nop
...
{'src': {'congruent': 0, 'same': False, 'type': 'addresses_PSE'}, 'dst': {'congruent': 3, 'same': False, 'type': 'addresses_A'}, 'OP': 'REPM'}
[Faulty Load]
{'src': {'NT': False, 'AVXalign': False, 'size': 4, 'congruent': 0, 'same': True, 'type': 'addresses_A'}, 'OP': 'LOAD'}
<gen_prepare_buffer>
{'src': {'NT': False, 'AVXalign': True, 'size': 1, 'congruent': 11, 'same': True, 'type': 'addresses_A_ht'}, 'OP': 'LOAD'}
