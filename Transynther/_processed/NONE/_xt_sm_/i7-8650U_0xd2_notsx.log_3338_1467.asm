...
push %rdi
push %rsi
lea addresses_WC_ht+0x8274, %rax
nop
nop
nop
nop
...
nop
xor %rbx, %rbx
lea addresses_WT_ht+0x13df4, %rdi
nop
cmp %rsi, %rsi
mov (%rdi), %r8w
nop
nop
inc %r12
lea addresses_WT_ht+0x5174, %rsi
nop
nop
lfence
mov $0x6162636465666768, %r14
...
nop
and $31094, %rsi
lea addresses_normal_ht+0x18c94, %rbx
nop
nop
nop
nop
...
nop
sub $45402, %rax
lea addresses_WT_ht+0xc274, %rsi
lea addresses_WC_ht+0x49b4, %rdi
nop
nop
nop
nop
...
nop
and %r8, %r8
lea addresses_WC_ht+0xebe4, %rdi
nop
and $37355, %r12
vmovups (%rdi), %ymm4
...
nop
add %rdi, %rdi
lea addresses_normal_ht+0xa070, %r8
nop
nop
nop
nop
...
// Store
lea addresses_normal+0x149f4, %rax
nop
nop
nop
xor %rbx, %rbx
