...
push %rdx
push %rsi
lea addresses_WC_ht+0x1d05e, %r15
clflush (%r15)
nop
nop
cmp $62182, %r10
...
nop
add $18422, %r15
lea addresses_UC_ht+0x18366, %rdi
clflush (%rdi)
nop
inc %r15
vmovups (%rdi), %ymm3
...
vpextrq $1, %xmm3, %rax
cmp %rdx, %rdx
lea addresses_WT_ht+0x5a1e, %rsi
lea addresses_D_ht+0x92c2, %rdi
nop
nop
and %r12, %r12
mov $80, %rcx
...
nop
sub %rdx, %rdx
lea addresses_WC_ht+0x86b2, %rdx
cmp $29501, %rcx
movw $0x6162, (%rdx)
nop
nop
...
nop
cmp %rax, %rax
lea addresses_WC_ht+0x1721e, %rdx
sub $61205, %rcx
mov (%rdx), %r12
nop
nop
