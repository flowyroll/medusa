...
lea addresses_A_ht+0x16cfb, %rdi
nop
nop
nop
nop
...
nop
cmp $61711, %rcx
lea addresses_A_ht+0x1923b, %rdi
cmp %rsi, %rsi
mov (%rdi), %r13
and %rbp, %rbp
lea addresses_normal_ht+0xdd7b, %rsi
lea addresses_WT_ht+0x867b, %rdi
nop
nop
nop
nop
...
nop
cmp %rbx, %rbx
lea addresses_normal_ht+0x57eb, %rdi
clflush (%rdi)
inc %r14
mov $0x6162636465666768, %rcx
movq %rcx, (%rdi)
inc %rbp
lea addresses_normal_ht+0x95be, %rsi
clflush (%rsi)
nop
add $40836, %rbp
movl $0x61626364, (%rsi)
...
nop
sub $5966, %r15
lea addresses_WT_ht+0xe94b, %r13
xor $8953, %rcx
mov (%r13), %r14d
add $37344, %rsi
lea addresses_WC_ht+0x14f7b, %rsi
nop
nop
nop
sub $30437, %r13
...
{'OP': 'STOR', 'dst': {'type': 'addresses_normal_ht', 'AVXalign': True, 'size': 4, 'NT': False, 'same': False, 'congruent': 0}}
