...
push %rdi
push %rsi
lea addresses_D_ht+0xaa9f, %rsi
lea addresses_D_ht+0x1bbbf, %rdi
nop
nop
nop
nop
...
nop
cmp $13845, %r12
lea addresses_normal_ht+0xabbf, %r8
nop
nop
nop
nop
