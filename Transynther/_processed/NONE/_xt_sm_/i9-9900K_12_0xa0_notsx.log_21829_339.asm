...
push %rbx
push %rsi
lea addresses_UC_ht+0x1db6a, %rax
nop
and %r8, %r8
...
nop
cmp $40044, %r9
lea addresses_normal_ht+0x1c86a, %r14
nop
nop
nop
nop
...
// REPMOV
lea addresses_A+0x5845, %rsi
lea addresses_normal+0x1376a, %rdi
nop
nop
nop
nop
...
// Load
lea addresses_normal+0x1a5da, %rax
nop
nop
nop
nop
...
// Store
lea addresses_normal+0x1376a, %rax
nop
nop
nop
and %rdi, %rdi
...
// Faulty Load
lea addresses_normal+0x1376a, %r14
nop
nop
nop
cmp $36663, %r13
...
{'src': {'type': 'addresses_A', 'congruent': 0, 'same': False}, 'OP': 'REPM', 'dst': {'type': 'addresses_normal', 'congruent': 0, 'same': True}}
...
{'src': {'type': 'addresses_RW', 'AVXalign': True, 'size': 32, 'NT': False, 'same': False, 'congruent': 1}, 'OP': 'LOAD'}
...
{'src': {'type': 'addresses_normal_ht', 'AVXalign': False, 'size': 32, 'NT': False, 'same': True, 'congruent': 7}, 'OP': 'LOAD'}
{'52': 21829}
