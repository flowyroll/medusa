...
movb $0x61, (%rdi)
cmp $53528, %rax
lea addresses_UC_ht+0x126a1, %rsi
...
nop
and %rsi, %rsi
lea addresses_WT_ht+0x10e21, %rcx
nop
sub %rbp, %rbp
movw $0x6162, (%rcx)
nop
...
{'src': {'same': False, 'congruent': 8, 'NT': True, 'type': 'addresses_UC', 'size': 2, 'AVXalign': False}, 'OP': 'LOAD'}
