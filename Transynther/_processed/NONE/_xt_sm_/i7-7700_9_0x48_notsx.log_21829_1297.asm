...
push %rcx
push %rdi
lea addresses_A_ht+0x1bc72, %rcx
nop
nop
inc %rdi
mov (%rcx), %r12
...
nop
add %r14, %r14
lea addresses_WC_ht+0x14798, %r8
nop
nop
nop
nop
...
nop
add $37016, %r14
lea addresses_normal_ht+0x1ba92, %r8
nop
nop
nop
add $55461, %rdi
...
// Store
lea addresses_normal+0x10c52, %r10
nop
nop
nop
inc %r8
...
<gen_prepare_buffer>
{'OP': 'LOAD', 'src': {'same': False, 'NT': True, 'AVXalign': False, 'size': 8, 'type': 'addresses_A_ht', 'congruent': 4}}
{'OP': 'LOAD', 'src': {'same': True, 'NT': False, 'AVXalign': False, 'size': 16, 'type': 'addresses_WC_ht', 'congruent': 0}}
{'dst': {'same': False, 'NT': True, 'AVXalign': False, 'size': 2, 'type': 'addresses_normal_ht', 'congruent': 9}, 'OP': 'STOR'}
{'52': 21829}
