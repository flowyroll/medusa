...
lea addresses_A_ht+0x1cb23, %rdi
xor %rdx, %rdx
mov $52, %rcx
rep movsl
nop
...
// Store
lea addresses_normal+0x18d23, %r15
nop
nop
nop
cmp $4562, %rax
...
{'OP': 'STOR', 'dst': {'same': False, 'type': 'addresses_D', 'NT': False, 'AVXalign': True, 'size': 4, 'congruent': 8}}
