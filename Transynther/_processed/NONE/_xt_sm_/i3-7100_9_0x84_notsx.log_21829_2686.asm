...
nop
cmp $54018, %rbx
lea addresses_A_ht+0x1cdee, %rsi
lea addresses_D_ht+0x17ab1, %rdi
nop
nop
nop
nop
...
nop
xor %rcx, %rcx
lea addresses_D_ht+0x1072e, %rsi
lea addresses_D_ht+0x4181, %rdi
nop
nop
nop
nop
...
// Store
lea addresses_normal+0x8ee, %r10
nop
nop
xor %rdi, %rdi
movw $0x5152, (%r10)
...
// Faulty Load
lea addresses_normal+0x8ee, %rdi
nop
nop
cmp $26714, %rdx
mov (%rdi), %r12d
...
{'src': {'type': 'addresses_A_ht', 'congruent': 7, 'same': False}, 'dst': {'type': 'addresses_D_ht', 'congruent': 0, 'same': False}, 'OP': 'REPM'}
