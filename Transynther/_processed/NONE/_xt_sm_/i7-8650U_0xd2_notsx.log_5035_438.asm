...
push %rdi
push %rsi
lea addresses_UC_ht+0x3640, %r10
clflush (%r10)
nop
inc %r11
movups (%r10), %xmm0
...
nop
cmp %r14, %r14
lea addresses_normal_ht+0x2e80, %rsi
lea addresses_A_ht+0xc680, %rdi
nop
nop
nop
xor %r11, %r11
