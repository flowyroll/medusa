...
push %rdi
push %rsi
lea addresses_UC_ht+0xdb6, %rsi
lea addresses_WT_ht+0x1dde8, %rdi
nop
nop
add $46440, %rbx
mov $107, %rcx
...
nop
xor $33946, %rcx
lea addresses_D_ht+0x10cb6, %r11
nop
nop
nop
nop
...
nop
add %rsi, %rsi
lea addresses_WT_ht+0x169dc, %r11
nop
nop
nop
nop
...
nop
and %rcx, %rcx
lea addresses_UC_ht+0xe910, %r10
add %r11, %r11
mov (%r10), %r14
nop
nop
xor %rcx, %rcx
lea addresses_UC_ht+0x4180, %rsi
clflush (%rsi)
nop
nop
nop
...
nop
cmp %rbx, %rbx
lea addresses_UC_ht+0xb9b6, %r10
and $49662, %rdi
movups (%r10), %xmm7
vpextrq $1, %xmm7, %rcx
nop
...
nop
add %rsi, %rsi
lea addresses_A_ht+0xb476, %rsi
lea addresses_normal_ht+0xc076, %rdi
clflush (%rdi)
nop
nop
dec %r9
...
{'OP': 'STOR', 'dst': {'type': 'addresses_WC', 'size': 1, 'AVXalign': True, 'NT': False, 'congruent': 0, 'same': True}}
...
{'OP': 'STOR', 'dst': {'type': 'addresses_D_ht', 'size': 8, 'AVXalign': True, 'NT': False, 'congruent': 9, 'same': False}}
