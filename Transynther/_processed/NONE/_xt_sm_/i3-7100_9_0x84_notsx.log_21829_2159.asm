...
push %rdx
push %rsi
lea addresses_UC_ht+0x19cfe, %r10
nop
nop
nop
nop
...
nop
and $25033, %r12
lea addresses_WT_ht+0x1b99e, %r10
nop
nop
sub $53286, %r15
...
nop
add $6781, %rdi
lea addresses_D_ht+0x150be, %rcx
nop
nop
nop
cmp %rdx, %rdx
...
nop
dec %rdx
lea addresses_WT_ht+0x1b99e, %rdi
nop
nop
nop
nop
...
nop
and %rdx, %rdx
lea addresses_UC_ht+0x1599e, %r10
nop
nop
nop
xor %rax, %rax
...
nop
add $40856, %rcx
lea addresses_WC_ht+0x142ac, %rsi
...
nop
and $55103, %rdi
lea addresses_UC_ht+0x81de, %rsi
lea addresses_A_ht+0x5e9e, %rdi
nop
sub $22679, %r12
mov $127, %rcx
rep movsb
...
nop
cmp %r12, %r12
lea addresses_D_ht+0x1119e, %rax
nop
nop
nop
sub %rcx, %rcx
...
// REPMOV
lea addresses_PSE+0x19e30, %rsi
lea addresses_normal+0x1899e, %rdi
clflush (%rdi)
nop
xor %rdx, %rdx
mov $79, %rcx
...
// Store
lea addresses_PSE+0x1d99e, %r12
cmp %r14, %r14
movl $0x51525354, (%r12)
cmp $34679, %rdx

// Store
lea addresses_normal+0x1899e, %r14
cmp $43842, %r12
mov $0x5152535455565758, %rdx
movq %rdx, (%r14)
nop
...
// Faulty Load
lea addresses_normal+0x1899e, %rsi
nop
nop
nop
nop
...
{'src': {'type': 'addresses_PSE', 'congruent': 1, 'same': False}, 'dst': {'type': 'addresses_normal', 'congruent': 0, 'same': True}, 'OP': 'REPM'}
...
{'src': {'type': 'addresses_UC_ht', 'congruent': 4, 'same': False}, 'dst': {'type': 'addresses_A_ht', 'congruent': 8, 'same': False}, 'OP': 'REPM'}
