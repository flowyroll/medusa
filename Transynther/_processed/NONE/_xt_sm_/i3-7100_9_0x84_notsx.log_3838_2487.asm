...
push %rdi
push %rsi
lea addresses_WT_ht+0x15eb, %rsi
lea addresses_WC_ht+0x31bf, %rdi
clflush (%rsi)
nop
and $65091, %r10
mov $47, %rcx
...
nop
sub $37365, %r14
lea addresses_normal_ht+0xd5eb, %rax
nop
nop
xor %rbx, %rbx
...
nop
dec %r14
lea addresses_A_ht+0x16feb, %rcx
nop
nop
nop
nop
...
nop
cmp $57474, %rcx
lea addresses_normal_ht+0xb5eb, %r14
nop
nop
add %r10, %r10
movw $0x6162, (%r14)
...
nop
inc %r10
lea addresses_UC_ht+0x1bf09, %rbx
clflush (%rbx)
nop
nop
nop
...
nop
sub $21104, %rax
lea addresses_D_ht+0x1058f, %rax
nop
and $555, %rdi
movw $0x6162, (%rax)
nop
...
nop
add %rcx, %rcx
lea addresses_UC_ht+0xb9ab, %rsi
nop
nop
nop
nop
...
{'dst': {'type': 'addresses_UC', 'same': False, 'size': 8, 'congruent': 9, 'NT': True, 'AVXalign': False}, 'OP': 'STOR'}
