...
nop
cmp %rdx, %rdx
lea addresses_D_ht+0x1b77c, %r12
nop
nop
nop
nop
...
nop
sub %r9, %r9
lea addresses_normal_ht+0x129ca, %rsi
lea addresses_UC_ht+0x19661, %rdi
nop
nop
nop
nop
...
nop
and $32883, %r13
lea addresses_WT_ht+0x1bca5, %rsi
nop
cmp %r12, %r12
mov (%rsi), %ecx
nop
inc %r13
lea addresses_normal_ht+0x16bca, %rdx
nop
nop
nop
nop
...
{'OP': 'STOR', 'dst': {'NT': False, 'same': True, 'congruent': 0, 'type': 'addresses_D', 'AVXalign': True, 'size': 32}}
...
<gen_prepare_buffer>
{'src': {'NT': False, 'same': True, 'congruent': 9, 'type': 'addresses_D_ht', 'AVXalign': False, 'size': 16}, 'OP': 'LOAD'}
