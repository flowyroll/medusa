...
push %rdi
push %rsi
lea addresses_normal_ht+0xf41, %rdi
nop
xor $44573, %r10
movb (%rdi), %r14b
nop
dec %r13
lea addresses_A_ht+0x3167, %r9
nop
nop
nop
nop
...
nop
dec %r13
lea addresses_normal_ht+0xdaaf, %rsi
lea addresses_normal_ht+0x13992, %rdi
nop
sub $23718, %rbx
mov $126, %rcx
rep movsq
...
nop
xor %rbx, %rbx
lea addresses_normal_ht+0xe9af, %rsi
lea addresses_normal_ht+0x110af, %rdi
nop
inc %r10
mov $40, %rcx
rep movsq
nop
xor %r10, %r10
lea addresses_WC_ht+0x660f, %rbp
nop
nop
nop
nop
...
{'src': {'type': 'addresses_normal_ht', 'congruent': 7, 'same': False}, 'dst': {'type': 'addresses_normal_ht', 'congruent': 9, 'same': False}, 'OP': 'REPM'}
