...
lea addresses_UC_ht+0x1536c, %rdi
nop
sub %rbx, %rbx
mov $112, %rcx
rep movsb
...
nop
xor $13925, %rcx
lea addresses_WC_ht+0x7ec, %rsi
lea addresses_UC_ht+0x1522c, %rdi
nop
nop
nop
and %r13, %r13
...
nop
and %rdi, %rdi
lea addresses_normal_ht+0x1941c, %r14
nop
nop
nop
nop
...
movq %rsi, (%r14)
sub $36313, %rbx
lea addresses_D_ht+0x106c8, %rsi
lea addresses_A_ht+0x1a446, %rdi
clflush (%rsi)
nop
add $45358, %r13
mov $83, %rcx
rep movsq
dec %r8
lea addresses_UC_ht+0x1abec, %r13
nop
nop
nop
cmp $1356, %r8
movw $0x6162, (%r13)
dec %rbx
lea addresses_WT_ht+0x1594c, %rdi
nop
nop
xor $35846, %r13
mov (%rdi), %r8d
...
{'OP': 'STOR', 'dst': {'type': 'addresses_UC', 'AVXalign': False, 'congruent': 6, 'size': 16, 'same': False, 'NT': True}}
[Faulty Load]
...
{'OP': 'REPM', 'src': {'type': 'addresses_WC_ht', 'congruent': 10, 'same': False}, 'dst': {'type': 'addresses_UC_ht', 'congruent': 6, 'same': False}}
