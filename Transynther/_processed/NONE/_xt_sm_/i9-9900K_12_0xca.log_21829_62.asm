...
push %rbp
push %rsi
lea addresses_WC_ht+0x18d12, %rsi
nop
nop
nop
xor %r12, %r12
...
nop
cmp $22871, %rax
lea addresses_WC_ht+0x1b812, %rbp
nop
xor $13788, %r9
movb (%rbp), %al
nop
