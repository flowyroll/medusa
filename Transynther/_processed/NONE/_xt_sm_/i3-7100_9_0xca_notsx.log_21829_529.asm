...
push %rax
push %rdi
lea addresses_UC_ht+0x1bfef, %rax
nop
nop
nop
nop
...
// Store
lea addresses_normal+0xddef, %r13
dec %r8
...
// Store
lea addresses_normal+0x189ef, %r13
nop
nop
nop
nop
...
// Store
lea addresses_normal+0x1a78f, %r11
nop
and %r8, %r8
mov $0x5152535455565758, %r14
movq %r14, %xmm0
...
// Load
lea addresses_WT+0xb66f, %r13
cmp $37743, %rdi
mov (%r13), %r14
dec %r13

// Store
lea addresses_UC+0xd8d3, %r8
nop
nop
nop
nop
...
// Faulty Load
lea addresses_normal+0x189ef, %r15
nop
xor $24173, %r8
mov (%r15), %r11d
lea oracles, %r13
...
{'OP': 'STOR', 'dst': {'same': False, 'congruent': 11, 'NT': False, 'type': 'addresses_A', 'size': 1, 'AVXalign': False}}
...
{'src': {'same': False, 'congruent': 6, 'NT': False, 'type': 'addresses_NC', 'size': 2, 'AVXalign': False}, 'OP': 'LOAD'}
{'OP': 'STOR', 'dst': {'same': False, 'congruent': 5, 'NT': False, 'type': 'addresses_D', 'size': 32, 'AVXalign': False}}
{'OP': 'STOR', 'dst': {'same': False, 'congruent': 1, 'NT': False, 'type': 'addresses_NC', 'size': 1, 'AVXalign': True}}
