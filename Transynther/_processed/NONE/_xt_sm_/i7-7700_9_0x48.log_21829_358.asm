...
push %rdi
push %rsi
lea addresses_WC_ht+0x440a, %rcx
nop
nop
nop
nop
...
vpextrq $0, %xmm3, %r11
sub $22483, %rdi
lea addresses_normal_ht+0x12dea, %r13
nop
nop
nop
inc %r14
...
nop
and $30130, %rcx
lea addresses_UC_ht+0x10ea, %rsi
lea addresses_normal_ht+0xd44, %rdi
nop
nop
nop
sub $40424, %r12
...
nop
cmp $25472, %r14
lea addresses_WT_ht+0x1cfea, %r14
nop
nop
nop
and %rsi, %rsi
...
nop
and %r13, %r13
lea addresses_A_ht+0x1c9a, %rsi
lea addresses_A_ht+0x1e40e, %rdi
nop
nop
mfence
mov $8, %rcx
...
nop
add %rsi, %rsi
lea addresses_WC_ht+0x1371a, %r8
dec %r13
mov (%r8), %rsi
nop
nop
sub $44390, %r8
lea addresses_WT_ht+0xdd4a, %r8
nop
sub %r11, %r11
mov (%r8), %esi
nop
...
{'OP': 'REPM', 'src': {'type': 'addresses_UC_ht', 'congruent': 6, 'same': False}, 'dst': {'type': 'addresses_normal_ht', 'congruent': 0, 'same': True}}
...
{'OP': 'LOAD', 'src': {'type': 'addresses_WC_ht', 'AVXalign': True, 'congruent': 3, 'size': 8, 'same': False, 'NT': False}}
