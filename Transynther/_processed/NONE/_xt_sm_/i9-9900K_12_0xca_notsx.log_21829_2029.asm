...
lea addresses_UC_ht+0xe334, %rdi
nop
nop
nop
nop
...
rep movsq
add %r11, %r11
lea addresses_normal_ht+0xc834, %rbp
nop
nop
nop
nop
...
// Load
lea addresses_normal+0xfbb4, %r12
inc %r8
vmovups (%r12), %ymm7
...
// Store
lea addresses_normal+0xd734, %r9
nop
nop
nop
mfence
...
{'OP': 'LOAD', 'src': {'same': False, 'type': 'addresses_WT', 'NT': False, 'AVXalign': False, 'size': 4, 'congruent': 6}}
[Faulty Load]
{'OP': 'LOAD', 'src': {'same': True, 'type': 'addresses_WT', 'NT': False, 'AVXalign': False, 'size': 4, 'congruent': 0}}
<gen_prepare_buffer>
{'OP': 'REPM', 'src': {'same': False, 'congruent': 0, 'type': 'addresses_WC_ht'}, 'dst': {'same': False, 'congruent': 11, 'type': 'addresses_UC_ht'}}
