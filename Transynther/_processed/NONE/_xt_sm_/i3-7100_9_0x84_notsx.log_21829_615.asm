...
push %rdi
push %rsi
lea addresses_UC_ht+0x13809, %rcx
nop
nop
nop
and %r10, %r10
...
nop
and $18013, %r15
lea addresses_D_ht+0x5fe9, %rsi
lea addresses_normal_ht+0x14e09, %rdi
nop
nop
and %r10, %r10
mov $81, %rcx
...
nop
inc %rcx
lea addresses_UC_ht+0x3045, %r15
nop
nop
nop
nop
...
lea addresses_normal_ht+0x1d7d, %rdi
nop
nop
nop
xor $2168, %r10
...
nop
sub $28000, %r10
lea addresses_D_ht+0x13681, %rcx
inc %rax
movb $0x61, (%rcx)
nop
nop
...
nop
and %rbp, %rbp
lea addresses_WC_ht+0x97f3, %rdi
clflush (%rdi)
nop
nop
nop
...
nop
cmp %rdi, %rdi
lea addresses_A_ht+0xb899, %rsi
lea addresses_A_ht+0x16106, %rdi
nop
nop
add %r14, %r14
mov $125, %rcx
...
{'src': {'type': 'addresses_D_ht', 'congruent': 5, 'same': False}, 'dst': {'type': 'addresses_normal_ht', 'congruent': 11, 'same': False}, 'OP': 'REPM'}
...
{'dst': {'type': 'addresses_WC_ht', 'same': True, 'size': 8, 'congruent': 0, 'NT': False, 'AVXalign': True}, 'OP': 'STOR'}
