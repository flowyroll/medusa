...
push %rcx
push %rdi
lea addresses_normal_ht+0xc04f, %r9
clflush (%r9)
nop
nop
nop
...
nop
xor %r8, %r8
lea addresses_WT_ht+0x4b8f, %rbx
clflush (%rbx)
nop
nop
nop
...
movb (%rbx), %al
sub $17512, %rcx
lea addresses_normal_ht+0x1db7f, %r8
nop
nop
nop
cmp $19249, %rax
...
nop
and %rcx, %rcx
lea addresses_UC_ht+0x1924f, %r12
cmp %rax, %rax
movl $0x61626364, (%r12)
nop
nop
