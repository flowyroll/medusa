...
push %r9
push %rbx
lea addresses_WC_ht+0x15518, %r9
nop
nop
nop
nop
...
// REPMOV
lea addresses_normal+0x1a660, %rsi
lea addresses_WT+0x7818, %rdi
nop
nop
nop
sub %rbx, %rbx
...
{'OP': 'REPM', 'src': {'type': 'addresses_normal', 'congruent': 3, 'same': False}, 'dst': {'type': 'addresses_WT', 'congruent': 10, 'same': False}}
