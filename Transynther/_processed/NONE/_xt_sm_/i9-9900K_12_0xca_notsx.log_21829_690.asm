...
push %rdi
push %rsi
lea addresses_normal_ht+0x132e4, %r10
nop
nop
nop
dec %r8
...
nop
dec %r15
lea addresses_WT_ht+0x14b9c, %r15
clflush (%r15)
nop
nop
add %rdi, %rdi
...
nop
add %r12, %r12
lea addresses_D_ht+0x5a2e, %rsi
lea addresses_D_ht+0x1e22e, %rdi
nop
nop
nop
nop
...
nop
inc %r12
lea addresses_UC_ht+0x1da06, %rcx
add $45608, %r15
mov (%rcx), %r10w
nop
nop
...
nop
inc %rcx
lea addresses_normal_ht+0x11eee, %rsi
lea addresses_D_ht+0x892e, %rdi
clflush (%rdi)
nop
nop
nop
...
// Store
lea addresses_normal+0x662e, %r10
dec %rdi
movl $0x51525354, (%r10)
cmp $29233, %r9

// Store
lea addresses_RW+0x1e72e, %r10
cmp %r14, %r14
movb $0x51, (%r10)
nop
nop
...
// Faulty Load
lea addresses_normal+0x662e, %r14
nop
sub $57706, %rdi
movb (%r14), %bl
lea oracles, %r9
...
{'OP': 'STOR', 'dst': {'same': True, 'type': 'addresses_normal', 'NT': True, 'AVXalign': False, 'size': 4, 'congruent': 0}}
...
{'OP': 'STOR', 'dst': {'same': True, 'type': 'addresses_WT_ht', 'NT': False, 'AVXalign': False, 'size': 32, 'congruent': 1}}
