...
nop
add $30995, %r9
lea addresses_UC_ht+0x374d, %rcx
sub %r8, %r8
movups (%rcx), %xmm6
vpextrq $0, %xmm6, %r10
nop
...
nop
inc %r8
lea addresses_WC_ht+0x1204d, %r13
and $28460, %r10
...
nop
and $60755, %rdi
lea addresses_UC_ht+0x1004d, %r9
dec %r10
...
lea addresses_WT_ht+0x3dc5, %rdi
nop
nop
nop
nop
...
nop
add $20942, %rcx
lea addresses_A_ht+0xdb4d, %rdi
add $21043, %r13
movw $0x6162, (%rdi)
nop
nop
cmp $56223, %r8
lea addresses_normal_ht+0x16e25, %rsi
lea addresses_UC_ht+0x12c0d, %rdi
xor %r13, %r13
mov $68, %rcx
rep movsq
nop
...
{'OP': 'LOAD', 'src': {'type': 'addresses_RW', 'AVXalign': False, 'congruent': 6, 'size': 4, 'same': False, 'NT': False}}
[Faulty Load]
