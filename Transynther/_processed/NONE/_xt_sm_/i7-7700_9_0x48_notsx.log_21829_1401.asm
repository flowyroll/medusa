...
push %rdx
push %rsi
lea addresses_normal_ht+0x12207, %rsi
lea addresses_normal_ht+0x5c73, %rdi
nop
nop
sub %r12, %r12
mov $105, %rcx
rep movsb
add $62907, %r9
lea addresses_UC_ht+0x7907, %rdx
clflush (%rdx)
nop
nop
nop
...
nop
sub %rdi, %rdi
lea addresses_UC_ht+0x18765, %rdx
clflush (%rdx)
and %rcx, %rcx
movl $0x61626364, (%rdx)
nop
...
nop
xor $40000, %rdi
lea addresses_WC_ht+0x13233, %rsi
clflush (%rsi)
nop
nop
nop
...
nop
xor %rdx, %rdx
lea addresses_D_ht+0x1bd2f, %r12
nop
nop
nop
nop
