...
nop
sub %r9, %r9
lea addresses_WC_ht+0x12d6a, %rax
nop
nop
inc %rbx
...
nop
sub %rcx, %rcx
lea addresses_normal_ht+0x1b042, %rsi
lea addresses_D_ht+0x12282, %rdi
nop
nop
sub $48001, %rbp
mov $119, %rcx
...
nop
add %r9, %r9
lea addresses_D_ht+0x12322, %rcx
nop
sub %rax, %rax
mov (%rcx), %r14d
xor %rsi, %rsi
lea addresses_UC_ht+0x466a, %rsi
...
nop
sub %rcx, %rcx
lea addresses_normal_ht+0x2582, %r14
nop
nop
xor %rcx, %rcx
...
<gen_prepare_buffer>
{'src': {'same': False, 'congruent': 5, 'type': 'addresses_A_ht'}, 'OP': 'REPM', 'dst': {'same': False, 'congruent': 5, 'type': 'addresses_D_ht'}}
{'OP': 'STOR', 'dst': {'NT': False, 'same': False, 'congruent': 3, 'type': 'addresses_WC_ht', 'AVXalign': False, 'size': 16}}
{'src': {'same': True, 'congruent': 6, 'type': 'addresses_normal_ht'}, 'OP': 'REPM', 'dst': {'same': False, 'congruent': 8, 'type': 'addresses_D_ht'}}
