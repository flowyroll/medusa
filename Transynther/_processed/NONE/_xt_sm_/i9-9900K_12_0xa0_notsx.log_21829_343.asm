...
push %rdi
push %rsi
lea addresses_normal_ht+0x152e3, %rcx
nop
nop
xor %r15, %r15
movl $0x61626364, (%rcx)
...
lea addresses_normal_ht+0xd44e, %rdi
nop
nop
sub %r14, %r14
mov $21, %rcx
...
lea addresses_D_ht+0x107b2, %rdi
clflush (%rsi)
nop
nop
xor $24114, %r10
...
rep movsq
cmp %r15, %r15
lea addresses_normal_ht+0xe108, %rsi
lea addresses_UC_ht+0xbc8, %rdi
nop
nop
cmp %r13, %r13
mov $10, %rcx
...
nop
and $29168, %r13
lea addresses_UC_ht+0x1b908, %rcx
nop
nop
sub %rdi, %rdi
...
movq %r8, (%rcx)
add %r15, %r15
lea addresses_WT_ht+0xc3c8, %r13
sub %r8, %r8
movb $0x61, (%r13)
nop
nop
...
// Store
lea addresses_normal+0xafc8, %r15
nop
nop
nop
add $25231, %rcx
...
// REPMOV
lea addresses_D+0xbc6, %rsi
lea addresses_WC+0x16e0, %rdi
clflush (%rdi)
nop
sub $2833, %rax
mov $24, %rcx
...
{'src': {'type': 'addresses_D', 'congruent': 1, 'same': False}, 'OP': 'REPM', 'dst': {'type': 'addresses_WC', 'congruent': 3, 'same': False}}
[Faulty Load]
