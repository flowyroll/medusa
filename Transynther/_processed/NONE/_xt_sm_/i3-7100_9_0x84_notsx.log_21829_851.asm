...
nop
cmp $56615, %rdi
lea addresses_WT_ht+0x1a0ba, %rcx
nop
nop
add %r12, %r12
...
nop
cmp $44014, %rcx
lea addresses_UC_ht+0x2b7a, %r15
inc %rdi
...
nop
inc %r13
lea addresses_WT_ht+0xfae, %rsi
lea addresses_D_ht+0x1c6fa, %rdi
clflush (%rdi)
nop
nop
nop
...
{'src': {'type': 'addresses_WT_ht', 'congruent': 2, 'same': False}, 'dst': {'type': 'addresses_D_ht', 'congruent': 10, 'same': False}, 'OP': 'REPM'}
{'58': 21829}
