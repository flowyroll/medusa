...
push %rdi
push %rsi
lea addresses_D_ht+0x1cbf9, %rcx
clflush (%rcx)
nop
nop
sub %r10, %r10
...
nop
sub %rcx, %rcx
lea addresses_UC_ht+0x14439, %rsi
lea addresses_normal_ht+0x11239, %rdi
dec %r13
mov $70, %rcx
rep movsw
nop
...
nop
cmp %rcx, %rcx
lea addresses_WT_ht+0x181d1, %r10
clflush (%r10)
cmp %r11, %r11
movw $0x6162, (%r10)
sub %r11, %r11
...
{'src': {'congruent': 6, 'same': False, 'type': 'addresses_WT_ht'}, 'dst': {'congruent': 3, 'same': False, 'type': 'addresses_A_ht'}, 'OP': 'REPM'}
{'dst': {'NT': False, 'AVXalign': False, 'size': 4, 'congruent': 1, 'same': False, 'type': 'addresses_A_ht'}, 'OP': 'STOR'}
{'src': {'congruent': 5, 'same': True, 'type': 'addresses_UC_ht'}, 'dst': {'congruent': 6, 'same': False, 'type': 'addresses_normal_ht'}, 'OP': 'REPM'}
