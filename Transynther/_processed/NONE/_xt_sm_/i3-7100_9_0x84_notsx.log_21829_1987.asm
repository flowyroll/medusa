...
push %rdi
push %rsi
lea addresses_WT_ht+0x10b56, %r10
nop
nop
nop
nop
...
lea addresses_A_ht+0x1ea96, %rdi
nop
nop
nop
nop
...
nop
add $53651, %r10
lea addresses_normal_ht+0xf0b6, %rsi
lea addresses_WC_ht+0x14696, %rdi
nop
nop
nop
nop
...
nop
and $15591, %rcx
lea addresses_D_ht+0x14396, %r15
clflush (%r15)
nop
nop
nop
...
nop
cmp %rcx, %rcx
lea addresses_WT_ht+0x807a, %rsi
lea addresses_D_ht+0xd08a, %rdi
nop
nop
nop
xor $11581, %r15
...
nop
cmp $901, %r15
lea addresses_WC_ht+0xc296, %r11
nop
sub %r12, %r12
movb $0x61, (%r11)
nop
...
lea addresses_WC_ht+0xf08e, %rdi
nop
nop
nop
nop
...
nop
and $44097, %r12
lea addresses_WT_ht+0x19216, %rsi
nop
nop
sub %rcx, %rcx
movb $0x61, (%rsi)
nop
sub %rdi, %rdi
lea addresses_UC_ht+0x3116, %r11
clflush (%r11)
xor %r15, %r15
movb (%r11), %r10b
cmp $22115, %r11
lea addresses_A_ht+0x1a0f6, %r15
nop
nop
xor %r10, %r10
mov (%r15), %cx
nop
inc %r10
lea addresses_WT_ht+0x16b9e, %rsi
lea addresses_normal_ht+0xc116, %rdi
clflush (%rdi)
xor %r10, %r10
mov $111, %rcx
rep movsw
...
nop
dec %r10
lea addresses_WC_ht+0xf296, %rsi
nop
xor $9891, %r15
movl $0x61626364, (%rsi)
nop
...
// Store
lea addresses_normal+0xca96, %rax
nop
nop
and %rsi, %rsi
movb $0x51, (%rax)
...
// Faulty Load
lea addresses_normal+0xca96, %r11
nop
nop
dec %rax
mov (%r11), %di
...
<gen_prepare_buffer>
{'src': {'type': 'addresses_WT_ht', 'same': False, 'size': 32, 'congruent': 6, 'NT': True, 'AVXalign': False}, 'OP': 'LOAD'}
...
{'src': {'type': 'addresses_normal_ht', 'congruent': 2, 'same': False}, 'dst': {'type': 'addresses_WC_ht', 'congruent': 10, 'same': True}, 'OP': 'REPM'}
