...
push %rdx
push %rsi
lea addresses_WC_ht+0x109f1, %rdx
nop
nop
nop
add %rdi, %rdi
...
nop
xor %rsi, %rsi
lea addresses_WC_ht+0x17c29, %rbp
nop
nop
nop
cmp %rdi, %rdi
movw $0x6162, (%rbp)
dec %rdx
lea addresses_UC_ht+0x1d3c9, %rbp
nop
nop
nop
nop
...
nop
and $30969, %r8
lea addresses_WT_ht+0x15f69, %rbp
nop
nop
nop
nop
...
nop
add %rdx, %rdx
lea addresses_D_ht+0x17809, %r14
nop
cmp %rbx, %rbx
movw $0x6162, (%r14)
nop
...
{'OP': 'STOR', 'dst': {'congruent': 0, 'AVXalign': True, 'same': True, 'size': 4, 'NT': False, 'type': 'addresses_RW'}}
...
{'OP': 'STOR', 'dst': {'congruent': 0, 'AVXalign': False, 'same': True, 'size': 32, 'NT': False, 'type': 'addresses_RW'}}
[Faulty Load]
...
{'OP': 'STOR', 'dst': {'congruent': 6, 'AVXalign': False, 'same': False, 'size': 2, 'NT': True, 'type': 'addresses_WC_ht'}}
