...
// REPMOV
lea addresses_A+0x189d8, %rsi
lea addresses_D+0x3488, %rdi
nop
nop
and $4113, %rbp
mov $35, %rcx
...
// Store
lea addresses_normal+0x169d8, %rbx
nop
and $57667, %r13
...
// Store
lea addresses_normal+0xf5e6, %r13
inc %rdi
movl $0x51525354, (%r13)
nop
nop
...
{'OP': 'REPM', 'src': {'type': 'addresses_A', 'congruent': 6, 'same': False}, 'dst': {'type': 'addresses_D', 'congruent': 3, 'same': False}}
