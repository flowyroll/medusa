...
movups %xmm4, (%r9)
xor $47542, %r12
lea addresses_UC_ht+0x12d8c, %rsi
lea addresses_D_ht+0x3138, %rdi
xor $15581, %rbp
mov $61, %rcx
rep movsw
nop
nop
and %rbp, %rbp
lea addresses_normal_ht+0x216c, %r9
sub %r13, %r13
mov (%r9), %bp
nop
nop
...
nop
cmp %r12, %r12
lea addresses_normal_ht+0x17188, %r12
nop
nop
cmp $7267, %rdi
mov (%r12), %r9d
...
nop
cmp $4219, %rdi
lea addresses_A_ht+0x1b6bc, %rsi
nop
nop
nop
nop
...
nop
add %rdi, %rdi
lea addresses_D_ht+0x1342c, %rsi
lea addresses_D_ht+0x1d17c, %rdi
nop
nop
cmp %r11, %r11
mov $91, %rcx
