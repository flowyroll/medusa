...
nop
sub %r11, %r11
lea addresses_WT_ht+0x1a696, %rsi
lea addresses_UC_ht+0x1d316, %rdi
cmp %r8, %r8
mov $10, %rcx
rep movsl
nop
...
nop
xor %rsi, %rsi
lea addresses_normal_ht+0x4516, %r11
nop
cmp $47109, %rsi
mov (%r11), %r14
nop
nop
dec %r14
lea addresses_WC_ht+0x1cb96, %rax
nop
nop
nop
and $60030, %rsi
...
nop
xor $55158, %rcx
lea addresses_UC_ht+0x11b90, %rax
nop
nop
nop
and %r8, %r8
...
vpextrq $0, %xmm4, %rcx
add %rdi, %rdi
lea addresses_WT_ht+0xb8ce, %rsi
lea addresses_WT_ht+0x12996, %rdi
clflush (%rsi)
nop
nop
cmp $49262, %rbx
...
rep movsl
add %rcx, %rcx
lea addresses_UC_ht+0x1cde6, %rsi
nop
nop
xor %r11, %r11
movl $0x61626364, (%rsi)
...
{'OP': 'STOR', 'dst': {'type': 'addresses_D', 'AVXalign': False, 'congruent': 3, 'size': 1, 'same': False, 'NT': True}}
...
<gen_prepare_buffer>
{'OP': 'STOR', 'dst': {'type': 'addresses_A_ht', 'AVXalign': True, 'congruent': 2, 'size': 32, 'same': False, 'NT': True}}
