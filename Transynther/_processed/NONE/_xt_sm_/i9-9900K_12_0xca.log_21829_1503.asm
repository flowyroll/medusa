...
nop
xor $23594, %r9
lea addresses_normal_ht+0x3f9f, %rsi
lea addresses_UC_ht+0x1b3ff, %rdi
and %r11, %r11
mov $71, %rcx
rep movsb
nop
...
nop
mfence
lea addresses_WC_ht+0x15e9f, %rsi
lea addresses_WC_ht+0x1a284, %rdi
xor $54646, %r14
mov $5, %rcx
rep movsb
nop
...
nop
sub $17404, %r14
lea addresses_UC_ht+0x1cf1f, %r14
nop
add $31194, %r9
mov (%r14), %esi
nop
...
nop
xor $47808, %rdi
lea addresses_WT_ht+0x1c835, %rsi
lea addresses_UC_ht+0x14715, %rdi
nop
nop
nop
add $7730, %r10
...
nop
and $45129, %rdi
lea addresses_WT_ht+0x19f1f, %rcx
nop
nop
nop
nop
...
nop
xor $63788, %r9
lea addresses_A_ht+0x19e1f, %rsi
nop
nop
sub %r10, %r10
movb (%rsi), %r14b
dec %r14
lea addresses_WT_ht+0x19f1f, %rsi
nop
nop
nop
nop
...
{'OP': 'REPM', 'src': {'same': False, 'type': 'addresses_normal_ht', 'congruent': 6}, 'dst': {'same': True, 'type': 'addresses_UC_ht', 'congruent': 1}}
{'OP': 'REPM', 'src': {'same': False, 'type': 'addresses_WC_ht', 'congruent': 3}, 'dst': {'same': False, 'type': 'addresses_WC_ht', 'congruent': 0}}
...
{'OP': 'STOR', 'dst': {'size': 2, 'NT': True, 'type': 'addresses_WT_ht', 'same': False, 'AVXalign': False, 'congruent': 8}}
