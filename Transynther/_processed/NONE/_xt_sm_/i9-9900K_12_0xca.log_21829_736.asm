...
push %rdi
push %rsi
lea addresses_WT_ht+0x1e40, %r15
nop
add $3261, %rsi
mov (%r15), %bp
nop
...
nop
add $53372, %rax
lea addresses_normal_ht+0x1d810, %rsi
lea addresses_A_ht+0x32c, %rdi
clflush (%rsi)
clflush (%rdi)
nop
nop
...
// Store
lea addresses_normal+0x12500, %rsi
nop
nop
nop
inc %rax
...
// Load
lea addresses_WC+0x4700, %rdx
dec %r9
mov (%rdx), %ecx
add $28095, %rdx

// Store
lea addresses_normal+0x1a500, %r9
nop
nop
nop
nop
...
// Store
lea addresses_normal+0xf100, %r12
nop
nop
nop
nop
...
// Store
lea addresses_normal+0x900, %rsi
nop
nop
nop
nop
...
{'OP': 'STOR', 'dst': {'size': 4, 'NT': False, 'type': 'addresses_normal', 'same': True, 'AVXalign': False, 'congruent': 0}}
...
{'OP': 'LOAD', 'src': {'size': 4, 'NT': False, 'type': 'addresses_WC', 'same': False, 'AVXalign': False, 'congruent': 5}}
...
<gen_prepare_buffer>
{'OP': 'LOAD', 'src': {'size': 2, 'NT': False, 'type': 'addresses_WT_ht', 'same': False, 'AVXalign': True, 'congruent': 6}}
{'OP': 'REPM', 'src': {'same': True, 'type': 'addresses_normal_ht', 'congruent': 3}, 'dst': {'same': False, 'type': 'addresses_A_ht', 'congruent': 0}}
{'58': 21829}
