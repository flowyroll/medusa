...
push %rdi
push %rsi
lea addresses_WC_ht+0x4efe, %rsi
...
nop
add %rbx, %rbx
lea addresses_normal_ht+0x7aec, %rsi
lea addresses_D_ht+0x1a21e, %rdi
nop
nop
cmp $58147, %r9
mov $13, %rcx
rep movsw
xor %rbx, %rbx
lea addresses_UC_ht+0x19c1e, %r11
nop
nop
sub %rcx, %rcx
movb (%r11), %r9b
...
{'dst': {'NT': False, 'AVXalign': False, 'size': 8, 'congruent': 0, 'same': True, 'type': 'addresses_UC'}, 'OP': 'STOR'}
