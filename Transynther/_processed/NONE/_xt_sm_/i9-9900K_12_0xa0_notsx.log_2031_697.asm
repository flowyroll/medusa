...
nop
and %rcx, %rcx
lea addresses_normal_ht+0x1bbac, %rdx
clflush (%rdx)
nop
nop
cmp %rbx, %rbx
...
nop
dec %rbx
lea addresses_WC_ht+0x107fc, %rax
nop
nop
nop
nop
...
{'OP': 'STOR', 'dst': {'type': 'addresses_RW', 'AVXalign': False, 'size': 8, 'NT': True, 'same': True, 'congruent': 0}}
{'OP': 'STOR', 'dst': {'type': 'addresses_D', 'AVXalign': False, 'size': 8, 'NT': True, 'same': False, 'congruent': 4}}
...
{'src': {'type': 'addresses_normal_ht', 'AVXalign': False, 'size': 16, 'NT': True, 'same': False, 'congruent': 11}, 'OP': 'LOAD'}
