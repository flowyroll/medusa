...
push %rdi
push %rsi
lea addresses_normal_ht+0x18cf6, %r12
nop
nop
nop
xor $254, %rbp
...
movups %xmm6, (%r12)
xor %r14, %r14
lea addresses_D_ht+0x76a6, %rsi
lea addresses_WC_ht+0xe106, %rdi
nop
add $63888, %r13
mov $11, %rcx
rep movsb
...
nop
and %r10, %r10
lea addresses_WT_ht+0x6816, %rsi
lea addresses_A_ht+0x13186, %rdi
nop
cmp $13418, %rbp
mov $77, %rcx
rep movsw
...
nop
sub %rsi, %rsi
lea addresses_WC_ht+0x8306, %rsi
lea addresses_normal_ht+0x18606, %rdi
clflush (%rsi)
nop
nop
nop
...
nop
sub $13171, %rcx
lea addresses_D_ht+0x17106, %rdi
nop
nop
nop
nop
...
vpextrq $1, %xmm1, %r10
xor $64412, %r10
lea addresses_WT_ht+0x24d7, %rdi
nop
nop
nop
nop
...
{'OP': 'STOR', 'dst': {'type': 'addresses_WT_ht', 'AVXalign': False, 'size': 8, 'NT': False, 'same': True, 'congruent': 0}}
{'58': 21829}
