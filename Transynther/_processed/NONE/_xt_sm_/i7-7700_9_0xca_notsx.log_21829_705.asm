...
push %rdi
push %rsi
lea addresses_UC_ht+0x42dc, %rbp
nop
nop
inc %r9
...
nop
sub $8654, %r12
lea addresses_WT_ht+0x196dc, %rsi
lea addresses_normal_ht+0x186dc, %rdi
clflush (%rsi)
clflush (%rdi)
nop
nop
...
nop
add $21740, %rbp
lea addresses_A_ht+0x1ccdc, %rdi
nop
nop
nop
nop
...
{'src': {'NT': True, 'AVXalign': False, 'size': 4, 'congruent': 8, 'same': False, 'type': 'addresses_WT'}, 'OP': 'LOAD'}
