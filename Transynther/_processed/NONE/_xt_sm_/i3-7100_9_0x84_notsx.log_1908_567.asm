...
nop
cmp $49527, %r14
lea addresses_WC_ht+0x17b14, %rsi
clflush (%rsi)
and %rdx, %rdx
...
nop
sub %r11, %r11
lea addresses_normal_ht+0x1b3ae, %rdx
clflush (%rdx)
nop
xor $62895, %r10
movl $0x61626364, (%rdx)
dec %r10
lea addresses_UC_ht+0x10314, %r11
nop
nop
nop
nop
...
{'src': {'type': 'addresses_WC', 'same': False, 'size': 4, 'congruent': 9, 'NT': True, 'AVXalign': False}, 'OP': 'LOAD'}
[Faulty Load]
