...
push %rdx
push %rsi
lea addresses_A_ht+0x1a990, %rbx
nop
add $10905, %r10
mov (%rbx), %dx
nop
nop
add %rbp, %rbp
lea addresses_WT_ht+0xccb0, %rsi
lea addresses_D_ht+0x57b0, %rdi
clflush (%rdi)
nop
nop
nop
...
nop
and $26922, %rdi
lea addresses_D_ht+0x7bb0, %rsi
lea addresses_normal_ht+0x9db0, %rdi
nop
add %r11, %r11
mov $101, %rcx
rep movsl
...
nop
xor $14763, %r10
lea addresses_A_ht+0x1cfb0, %rbx
sub $26896, %r11
...
nop
dec %rdi
lea addresses_A_ht+0x1d0b0, %r10
nop
nop
nop
nop
...
nop
xor %rdx, %rdx
lea addresses_WC_ht+0x7fb0, %rsi
lea addresses_A_ht+0x12880, %rdi
add %r11, %r11
mov $104, %rcx
rep movsl
nop
...
// Store
lea addresses_normal+0x29b0, %r9
nop
nop
sub %r8, %r8
...
// Store
lea addresses_normal+0x1ebb0, %rax
xor %rdi, %rdi
...
// Faulty Load
lea addresses_normal+0x1ebb0, %rdi
nop
and $23083, %rsi
movb (%rdi), %r14b
lea oracles, %r9
...
{'OP': 'STOR', 'dst': {'type': 'addresses_normal', 'size': 32, 'AVXalign': True, 'NT': True, 'congruent': 7, 'same': False}}
