...
// Store
lea addresses_normal+0x1394, %r10
nop
nop
nop
nop
...
// Store
lea addresses_normal+0x13034, %r11
nop
nop
nop
nop
...
// Faulty Load
lea addresses_normal+0x1394, %r14
nop
sub $44503, %r10
mov (%r14), %r11
lea oracles, %rax
...
{'OP': 'STOR', 'dst': {'same': False, 'congruent': 11, 'NT': False, 'type': 'addresses_US', 'size': 32, 'AVXalign': True}}
...
{'OP': 'STOR', 'dst': {'same': False, 'congruent': 4, 'NT': False, 'type': 'addresses_normal', 'size': 16, 'AVXalign': True}}
{'OP': 'STOR', 'dst': {'same': False, 'congruent': 5, 'NT': True, 'type': 'addresses_US', 'size': 1, 'AVXalign': False}}
[Faulty Load]
