...
push %rbp
push %rdi
lea addresses_WC_ht+0x10aac, %rbp
clflush (%rbp)
xor $46577, %rdi
mov (%rbp), %r9w
nop
...
// Load
lea addresses_normal+0x15aa4, %rdi
sub $16182, %r11
mov (%rdi), %rcx
nop
and %rcx, %rcx
...
{'OP': 'STOR', 'dst': {'type': 'addresses_D', 'size': 32, 'AVXalign': True, 'NT': False, 'congruent': 0, 'same': True}}
{'OP': 'STOR', 'dst': {'type': 'addresses_NC', 'size': 1, 'AVXalign': False, 'NT': False, 'congruent': 4, 'same': False}}
{'OP': 'LOAD', 'src': {'type': 'addresses_normal', 'size': 8, 'AVXalign': False, 'NT': False, 'congruent': 2, 'same': False}}
[Faulty Load]
