...
push %rdx
push %rsi
lea addresses_WT_ht+0x6927, %rsi
lea addresses_normal_ht+0xe1c7, %rdi
nop
nop
nop
nop
...
nop
xor %r8, %r8
lea addresses_normal_ht+0x7a7, %r9
sub %rbp, %rbp
...
nop
sub $41777, %rdi
lea addresses_UC_ht+0x70a3, %rsi
xor $35849, %rdx
mov (%rsi), %r9
cmp %r8, %r8
lea addresses_UC_ht+0x3527, %rsi
nop
nop
nop
nop
...
nop
sub %rdx, %rdx
lea addresses_normal_ht+0x1b4e7, %rcx
nop
xor $27264, %r8
movw $0x6162, (%rcx)
nop
...
nop
add %rdi, %rdi
lea addresses_normal_ht+0x5727, %r9
clflush (%r9)
nop
nop
nop
...
{'OP': 'STOR', 'dst': {'congruent': 1, 'AVXalign': False, 'same': False, 'size': 16, 'NT': False, 'type': 'addresses_NC'}}
{'src': {'congruent': 11, 'AVXalign': False, 'same': False, 'size': 4, 'NT': True, 'type': 'addresses_D'}, 'OP': 'LOAD'}
...
{'OP': 'STOR', 'dst': {'congruent': 2, 'AVXalign': False, 'same': False, 'size': 1, 'NT': True, 'type': 'addresses_WC'}}
[Faulty Load]
...
{'src': {'congruent': 7, 'AVXalign': True, 'same': False, 'size': 16, 'NT': False, 'type': 'addresses_normal_ht'}, 'OP': 'LOAD'}
