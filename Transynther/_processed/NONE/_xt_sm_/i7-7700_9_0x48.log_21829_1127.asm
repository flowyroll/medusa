...
push %rdx
push %rsi
lea addresses_UC_ht+0x9156, %r13
nop
nop
nop
nop
...
nop
add %rsi, %rsi
lea addresses_normal_ht+0xb9f, %rdx
cmp %r14, %r14
...
nop
dec %r11
lea addresses_WT_ht+0xd3b6, %r13
nop
nop
nop
nop
...
nop
add $16545, %r9
lea addresses_normal_ht+0x156d6, %rsi
lea addresses_normal_ht+0x14ffa, %rdi
nop
nop
nop
and %r14, %r14
...
nop
xor $37009, %rsi
lea addresses_WT_ht+0x11256, %r13
nop
nop
nop
nop
...
// Store
lea addresses_normal+0x18056, %r9
nop
xor %rsi, %rsi
...
// Faulty Load
lea addresses_normal+0x18056, %rsi
sub %rbx, %rbx
movups (%rsi), %xmm4
vpextrq $0, %xmm4, %r13
lea oracles, %rbx
...
{'OP': 'LOAD', 'src': {'type': 'addresses_normal_ht', 'AVXalign': False, 'congruent': 0, 'size': 16, 'same': False, 'NT': True}}
