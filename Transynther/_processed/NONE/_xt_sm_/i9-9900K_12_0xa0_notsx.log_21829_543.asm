...
push %rdi
push %rsi
lea addresses_normal_ht+0x568a, %rcx
nop
nop
nop
cmp %r14, %r14
...
nop
and %rbx, %rbx
lea addresses_normal_ht+0xc4ea, %rsi
lea addresses_normal_ht+0x27aa, %rdi
nop
cmp $2347, %r11
mov $99, %rcx
rep movsb
...
nop
xor %rbx, %rbx
lea addresses_A_ht+0x11ede, %rsi
lea addresses_normal_ht+0xc49c, %rdi
add %rax, %rax
mov $103, %rcx
rep movsl
nop
add $7083, %rdi
lea addresses_WT_ht+0x3f8a, %rsi
and %r11, %r11
mov (%rsi), %ebx
xor $46085, %rcx
lea addresses_WT_ht+0x1238a, %rbp
nop
nop
nop
nop
...
nop
cmp %r14, %r14
lea addresses_normal_ht+0xd502, %r11
nop
nop
inc %rcx
...
nop
sub %rbp, %rbp
lea addresses_A_ht+0x1c49a, %rsi
lea addresses_UC_ht+0x7b8a, %rdi
nop
nop
nop
nop
...
// Store
lea addresses_normal+0x738a, %rdx
nop
nop
cmp $33554, %r12
movb $0x51, (%rdx)
...
// Faulty Load
lea addresses_normal+0x738a, %rsi
nop
nop
nop
inc %rax
...
{'src': {'type': 'addresses_UC', 'AVXalign': False, 'size': 32, 'NT': False, 'same': False, 'congruent': 6}, 'OP': 'LOAD'}
