...
push %rcx
push %rsi
lea addresses_normal_ht+0x1605c, %r12
nop
sub %rcx, %rcx
mov (%r12), %rsi
add $38029, %r10
lea addresses_UC_ht+0x9f5c, %rax
nop
nop
nop
add %r8, %r8
...
nop
cmp %rcx, %rcx
lea addresses_normal_ht+0x15eac, %rsi
nop
nop
and $39940, %r8
mov (%rsi), %r12d
...
nop
dec %rsi
lea addresses_WT_ht+0xc5c0, %rcx
nop
nop
nop
nop
...
// REPMOV
lea addresses_PSE+0x35c, %rsi
lea addresses_normal+0x1635c, %rdi
nop
nop
inc %r15
mov $88, %rcx
...
{'OP': 'REPM', 'src': {'same': False, 'type': 'addresses_PSE', 'congruent': 11}, 'dst': {'same': False, 'type': 'addresses_normal', 'congruent': 7}}
{'OP': 'STOR', 'dst': {'size': 4, 'NT': True, 'type': 'addresses_P', 'same': False, 'AVXalign': False, 'congruent': 0}}
{'OP': 'STOR', 'dst': {'size': 4, 'NT': False, 'type': 'addresses_WC', 'same': True, 'AVXalign': True, 'congruent': 0}}
[Faulty Load]
