...
push %rdi
push %rsi
lea addresses_D_ht+0x1382d, %rsi
...
nop
sub $2431, %rcx
lea addresses_WC_ht+0x1b6ad, %r10
nop
nop
nop
nop
...
{'OP': 'STOR', 'dst': {'NT': True, 'same': False, 'congruent': 4, 'type': 'addresses_WT', 'AVXalign': False, 'size': 1}}
...
<gen_prepare_buffer>
{'src': {'same': False, 'congruent': 4, 'type': 'addresses_D_ht'}, 'OP': 'REPM', 'dst': {'same': True, 'congruent': 7, 'type': 'addresses_normal_ht'}}
