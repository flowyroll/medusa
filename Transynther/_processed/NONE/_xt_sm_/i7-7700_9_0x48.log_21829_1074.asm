...
nop
add %r15, %r15
lea addresses_D_ht+0x1b7a3, %rsi
lea addresses_normal_ht+0x86b, %rdi
nop
nop
nop
dec %r14
...
rep movsw
sub $5060, %rax
lea addresses_UC_ht+0x286b, %r15
nop
and $32254, %r14
mov (%r15), %r8d
sub $16471, %rdi
lea addresses_WC_ht+0xab0b, %rsi
lea addresses_normal_ht+0x1cf66, %rdi
nop
nop
nop
nop
...
lea addresses_WT_ht+0x1dd19, %rdi
nop
nop
nop
sub $23969, %r8
...
nop
sub %rax, %rax
lea addresses_WT_ht+0x5b6b, %rax
nop
nop
dec %rdi
mov (%rax), %r14
nop
dec %r14
lea addresses_normal_ht+0x806b, %rsi
sub $1167, %rax
movb $0x61, (%rsi)
nop
nop
