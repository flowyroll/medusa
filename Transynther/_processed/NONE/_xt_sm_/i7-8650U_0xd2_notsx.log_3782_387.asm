...
push %rdi
push %rsi
lea addresses_D_ht+0x19309, %rsi
lea addresses_normal_ht+0xf409, %rdi
clflush (%rsi)
nop
nop
nop
...
nop
dec %r9
lea addresses_D_ht+0x7309, %rsi
lea addresses_A_ht+0x1df09, %rdi
nop
nop
inc %r12
mov $54, %rcx
...
nop
cmp %rdi, %rdi
lea addresses_WT_ht+0x1e92b, %r12
nop
nop
nop
and %rax, %rax
...
{'OP': 'LOAD', 'src': {'type': 'addresses_D', 'size': 1, 'AVXalign': False, 'NT': True, 'congruent': 3, 'same': False}}
