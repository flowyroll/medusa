...
mov (%rcx), %si
and $32340, %rbx
lea addresses_A_ht+0x11ccd, %rsi
lea addresses_WT_ht+0x13b53, %rdi
clflush (%rsi)
and %r9, %r9
mov $83, %rcx
rep movsw
add %rsi, %rsi
lea addresses_A_ht+0x15019, %rcx
nop
nop
nop
sub $3786, %r15
...
nop
inc %rcx
lea addresses_WT_ht+0x14219, %rsi
lea addresses_UC_ht+0x18c19, %rdi
nop
nop
nop
cmp %r11, %r11
...
nop
cmp %r9, %r9
lea addresses_WT_ht+0x1a019, %rbx
nop
xor $30367, %rcx
mov (%rbx), %si
nop
...
nop
add %r15, %r15
lea addresses_normal_ht+0x14819, %r15
nop
cmp $18916, %rbx
movw $0x6162, (%r15)
inc %r11
lea addresses_WT_ht+0x10db9, %rdi
nop
nop
sub %r11, %r11
mov (%rdi), %si
...
// Load
lea addresses_normal+0x17bc5, %r10
nop
inc %rax
mov (%r10), %r9w
nop
...
{'src': {'type': 'addresses_RW', 'same': False, 'size': 1, 'congruent': 1, 'NT': False, 'AVXalign': False}, 'OP': 'LOAD'}
...
<gen_prepare_buffer>
{'src': {'type': 'addresses_UC_ht', 'congruent': 0, 'same': False}, 'dst': {'type': 'addresses_UC_ht', 'congruent': 2, 'same': False}, 'OP': 'REPM'}
...
{'dst': {'type': 'addresses_normal_ht', 'same': False, 'size': 2, 'congruent': 11, 'NT': True, 'AVXalign': False}, 'OP': 'STOR'}
