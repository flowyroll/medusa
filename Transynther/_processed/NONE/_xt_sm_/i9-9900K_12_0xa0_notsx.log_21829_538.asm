...
push %rdx
push %rsi
lea addresses_UC_ht+0x12c49, %rsi
lea addresses_normal_ht+0xc864, %rdi
nop
nop
nop
and $59252, %r15
...
rep movsb
xor %rdi, %rdi
lea addresses_UC_ht+0x11258, %rdx
nop
nop
nop
nop
...
nop
and $44498, %r11
lea addresses_A_ht+0xf65c, %rsi
lea addresses_WC_ht+0x65c, %rdi
nop
nop
nop
xor $8967, %rax
...
nop
sub $63816, %rdi
lea addresses_UC_ht+0xd65c, %r11
sub $2921, %rdx
mov (%r11), %ecx
inc %rdi
lea addresses_WC_ht+0xba3c, %rsi
clflush (%rsi)
nop
add %rdx, %rdx
...
nop
inc %r14
lea addresses_WT_ht+0x1465c, %rdx
nop
nop
nop
and %r15, %r15
...
nop
add %rdx, %rdx
lea addresses_WC_ht+0x1a55c, %rsi
lea addresses_normal_ht+0x1a202, %rdi
nop
nop
nop
nop
...
nop
add %rcx, %rcx
lea addresses_UC_ht+0xcc54, %rdi
nop
nop
nop
sub %rsi, %rsi
...
nop
xor %r11, %r11
lea addresses_D_ht+0x19d5c, %rcx
nop
dec %rax
...
nop
xor $64452, %rax
lea addresses_WC_ht+0x1c1f9, %rsi
lea addresses_normal_ht+0x14e8e, %rdi
xor $46363, %r14
mov $106, %rcx
rep movsb
nop
...
// Store
lea addresses_normal+0x1364, %rbx
nop
inc %rdx
movb $0x51, (%rbx)
nop
...
// Store
lea addresses_normal+0x1b59c, %r13
nop
nop
nop
nop
...
{'OP': 'STOR', 'dst': {'type': 'addresses_D', 'AVXalign': False, 'size': 16, 'NT': False, 'same': False, 'congruent': 11}}
...
{'OP': 'STOR', 'dst': {'type': 'addresses_WC_ht', 'AVXalign': False, 'size': 16, 'NT': True, 'same': False, 'congruent': 5}}
{'OP': 'STOR', 'dst': {'type': 'addresses_WT_ht', 'AVXalign': False, 'size': 32, 'NT': False, 'same': True, 'congruent': 7}}
{'src': {'type': 'addresses_WC_ht', 'congruent': 8, 'same': False}, 'OP': 'REPM', 'dst': {'type': 'addresses_normal_ht', 'congruent': 1, 'same': False}}
