...
push %rdi
push %rsi
lea addresses_D_ht+0x51f5, %rdi
cmp %r14, %r14
movw $0x6162, (%rdi)
nop
sub %r13, %r13
lea addresses_UC_ht+0xb35, %r11
nop
nop
nop
and %rcx, %rcx
...
nop
dec %r10
lea addresses_UC_ht+0xdd59, %r13
clflush (%r13)
nop
cmp $32083, %rax
mov (%r13), %cx
...
nop
sub %r14, %r14
lea addresses_A_ht+0x1a69d, %r14
clflush (%r14)
nop
nop
nop
...
movaps %xmm3, (%r14)
add $49344, %r13
lea addresses_UC_ht+0x8a79, %r13
nop
nop
nop
nop
...
nop
add $63587, %rdi
lea addresses_normal_ht+0x2b35, %r10
nop
sub $4071, %rax
movl $0x61626364, (%r10)
sub $53184, %r11
lea addresses_UC_ht+0x6e35, %rcx
nop
nop
nop
nop
...
nop
and %r14, %r14
lea addresses_UC_ht+0x6335, %rsi
lea addresses_WT_ht+0x81c2, %rdi
nop
nop
nop
sub $10184, %r14
...
// Store
lea addresses_normal+0x1ed35, %r13
clflush (%r13)
nop
dec %r8
mov $0x5152535455565758, %rbx
...
// Faulty Load
lea addresses_normal+0x1ed35, %rdi
nop
nop
add $53171, %r8
mov (%rdi), %edx
...
<gen_prepare_buffer>
{'OP': 'STOR', 'dst': {'type': 'addresses_D_ht', 'AVXalign': True, 'congruent': 5, 'size': 2, 'same': False, 'NT': False}}
