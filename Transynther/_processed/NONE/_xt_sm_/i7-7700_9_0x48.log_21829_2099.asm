...
push %rdi
push %rsi
lea addresses_normal_ht+0x2f2, %r15
nop
and %rbp, %rbp
movb $0x61, (%r15)
nop
...
nop
xor $61782, %rdi
lea addresses_WT_ht+0x110f2, %rsi
nop
nop
inc %r13
...
vpextrq $1, %xmm3, %rbp
and $47855, %rdi
lea addresses_WT_ht+0x1c8f2, %r11
nop
nop
add %rdi, %rdi
...
nop
and %rdi, %rdi
lea addresses_D_ht+0xa942, %rsi
lea addresses_A_ht+0x1de6, %rdi
clflush (%rdi)
nop
nop
and %r13, %r13
...
nop
sub $3818, %rcx
lea addresses_UC_ht+0x1c6f2, %r15
clflush (%r15)
nop
xor %r12, %r12
mov (%r15), %si
...
nop
sub $23524, %r13
lea addresses_D_ht+0x1db2e, %rsi
lea addresses_UC_ht+0x1d4f2, %rdi
nop
nop
nop
nop
...
rep movsw
and $33109, %r12
lea addresses_normal_ht+0x1ad32, %r15
nop
nop
nop
nop
...
nop
inc %rbp
lea addresses_UC_ht+0x1cef2, %r12
add %r11, %r11
movl $0x61626364, (%r12)
nop
sub $65195, %r15
