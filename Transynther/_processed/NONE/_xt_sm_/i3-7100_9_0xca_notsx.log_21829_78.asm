...
push %rdi
push %rsi
lea addresses_D_ht+0x127b1, %rsi
lea addresses_WC_ht+0x20b1, %rdi
clflush (%rsi)
dec %rbp
mov $31, %rcx
rep movsb
...
nop
cmp %rbx, %rbx
lea addresses_normal_ht+0x83b9, %rsi
nop
nop
mfence
mov (%rsi), %ecx
...
nop
sub %rbx, %rbx
lea addresses_WC_ht+0x5cb1, %rsi
lea addresses_normal_ht+0x2b1, %rdi
clflush (%rsi)
nop
nop
nop
...
// Store
lea addresses_normal+0xa0b1, %rbx
nop
nop
nop
nop
...
// Faulty Load
lea addresses_normal+0xa0b1, %rcx
cmp $58765, %r8
movups (%rcx), %xmm0
vpextrq $0, %xmm0, %rax
lea oracles, %rbx
