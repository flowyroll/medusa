...
push %rdi
push %rsi
lea addresses_UC_ht+0x7e9f, %r15
inc %rax
mov (%r15), %r8
nop
cmp %r9, %r9
lea addresses_D_ht+0xcc3f, %rsi
lea addresses_A_ht+0x46ff, %rdi
nop
cmp $51451, %r10
mov $60, %rcx
rep movsb
cmp %r10, %r10
lea addresses_WC_ht+0xb43f, %r8
nop
nop
nop
nop
...
nop
cmp $34940, %rdi
lea addresses_D_ht+0x16a25, %rsi
nop
nop
nop
nop
...
nop
dec %rsi
lea addresses_normal_ht+0x125f7, %rdi
nop
add $6600, %r8
movb (%rdi), %r9b
dec %rdi
lea addresses_normal_ht+0x1843f, %rax
nop
nop
nop
nop
...
{'OP': 'REPM', 'src': {'same': True, 'congruent': 7, 'type': 'addresses_D_ht'}, 'dst': {'same': False, 'congruent': 3, 'type': 'addresses_A_ht'}}
{'OP': 'STOR', 'dst': {'same': False, 'type': 'addresses_WC_ht', 'NT': False, 'AVXalign': False, 'size': 32, 'congruent': 9}}
{'OP': 'STOR', 'dst': {'same': False, 'type': 'addresses_D_ht', 'NT': True, 'AVXalign': True, 'size': 8, 'congruent': 1}}
