...
nop
and %rbp, %rbp
lea addresses_A_ht+0x17390, %rsi
lea addresses_D_ht+0x13510, %rdi
nop
nop
inc %rbp
mov $124, %rcx
...
nop
add $23209, %rbp
lea addresses_UC_ht+0x11910, %r15
nop
nop
nop
sub %rdx, %rdx
...
nop
cmp $53315, %r9
lea addresses_WC_ht+0xbd10, %rsi
lea addresses_normal_ht+0x3d28, %rdi
nop
nop
nop
nop
...
// Store
lea addresses_PSE+0x12910, %rbp
add %rbx, %rbx
movl $0x51525354, (%rbp)
xor %rbx, %rbx

// Faulty Load
lea addresses_PSE+0x12910, %rcx
clflush (%rcx)
add $59412, %rax
mov (%rcx), %rdx
lea oracles, %r10
...
<gen_prepare_buffer>
{'src': {'type': 'addresses_WT_ht', 'AVXalign': False, 'size': 4, 'NT': True, 'same': False, 'congruent': 6}, 'OP': 'LOAD'}
