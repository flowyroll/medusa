...
push %rdi
push %rdx
lea addresses_WT_ht+0xb84a, %rbp
nop
nop
nop
dec %rdi
...
{'dst': {'type': 'addresses_WC', 'same': False, 'size': 2, 'congruent': 0, 'NT': False, 'AVXalign': True}, 'OP': 'STOR'}
[Faulty Load]
