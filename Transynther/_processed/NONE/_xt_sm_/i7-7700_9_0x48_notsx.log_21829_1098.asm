...
nop
inc %rbp
lea addresses_WC_ht+0x4c5d, %rsi
lea addresses_A_ht+0x1675d, %rdi
sub %r12, %r12
mov $14, %rcx
rep movsw
add $53741, %rbp
lea addresses_normal_ht+0x1635d, %rsi
lea addresses_WT_ht+0x13fbe, %rdi
nop
nop
xor $39449, %r8
mov $21, %rcx
...
nop
inc %r12
lea addresses_UC_ht+0x18fb1, %rcx
nop
nop
add %rdx, %rdx
vmovups (%rcx), %ymm5
...
nop
add %r8, %r8
lea addresses_normal_ht+0x15425, %rcx
nop
nop
sub $60025, %r8
...
nop
add %rsi, %rsi
lea addresses_D_ht+0x11e69, %rsi
...
nop
dec %r12
lea addresses_UC_ht+0xa85d, %rsi
...
nop
dec %r12
lea addresses_WC_ht+0x1c5dd, %r11
nop
nop
and $64306, %rdi
...
nop
and $17476, %rdx
lea addresses_WC_ht+0xb85d, %rcx
nop
nop
nop
nop
...
lea addresses_normal_ht+0x1645d, %rdi
nop
nop
nop
xor %rdx, %rdx
...
<gen_prepare_buffer>
{'OP': 'LOAD', 'src': {'same': False, 'NT': False, 'AVXalign': True, 'size': 16, 'type': 'addresses_A_ht', 'congruent': 9}}
{'dst': {'same': False, 'congruent': 8, 'type': 'addresses_A_ht'}, 'OP': 'REPM', 'src': {'same': False, 'congruent': 7, 'type': 'addresses_WC_ht'}}
...
{'dst': {'same': True, 'congruent': 5, 'type': 'addresses_UC_ht'}, 'OP': 'REPM', 'src': {'same': False, 'congruent': 2, 'type': 'addresses_D_ht'}}
{'dst': {'same': False, 'congruent': 7, 'type': 'addresses_normal_ht'}, 'OP': 'REPM', 'src': {'same': False, 'congruent': 10, 'type': 'addresses_UC_ht'}}
...
{'dst': {'same': False, 'congruent': 9, 'type': 'addresses_normal_ht'}, 'OP': 'REPM', 'src': {'same': False, 'congruent': 3, 'type': 'addresses_normal_ht'}}
{'58': 21829}
