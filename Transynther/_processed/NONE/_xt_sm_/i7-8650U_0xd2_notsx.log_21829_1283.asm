...
nop
add %rcx, %rcx
lea addresses_UC_ht+0x5547, %r13
nop
and %r12, %r12
movl $0x61626364, (%r13)
nop
cmp %r12, %r12
lea addresses_WC_ht+0x1e7f7, %rsi
lea addresses_D_ht+0xb6c7, %rdi
clflush (%rsi)
nop
nop
nop
...
// Store
lea addresses_normal+0x11c47, %r15
nop
nop
nop
nop
...
<gen_prepare_buffer>
{'OP': 'REPM', 'src': {'type': 'addresses_A_ht', 'congruent': 2, 'same': False}, 'dst': {'type': 'addresses_D_ht', 'congruent': 6, 'same': False}}
