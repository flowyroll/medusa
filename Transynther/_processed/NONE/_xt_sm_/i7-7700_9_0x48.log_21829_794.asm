...
push %rdi
push %rsi
lea addresses_A_ht+0xc4a5, %rsi
lea addresses_WC_ht+0x12217, %rdi
nop
xor $62932, %rax
mov $48, %rcx
rep movsq
nop
xor %r15, %r15
lea addresses_UC_ht+0x16a5, %r14
nop
nop
nop
nop
