...
push %rdi
push %rsi
lea addresses_A_ht+0x16b31, %rcx
nop
nop
nop
nop
...
nop
and $47446, %rsi
lea addresses_WT_ht+0x10236, %r8
nop
nop
nop
nop
...
movb $0x61, (%r8)
and $32118, %rsi
lea addresses_UC_ht+0x14f51, %r10
nop
nop
nop
nop
...
nop
xor %r11, %r11
lea addresses_WT_ht+0x16b51, %rdi
nop
cmp $15840, %r13
mov $0x6162636465666768, %r10
movq %r10, (%rdi)
cmp $2466, %r8
lea addresses_normal_ht+0x12ac1, %rcx
clflush (%rcx)
nop
nop
add %r10, %r10
...
nop
inc %r10
lea addresses_D_ht+0x9c51, %rsi
lea addresses_D_ht+0x13f51, %rdi
clflush (%rsi)
nop
nop
cmp $39062, %r12
...
nop
xor %r11, %r11
lea addresses_WC_ht+0x11f51, %rdi
nop
sub $31225, %r12
movl $0x61626364, (%rdi)
nop
...
{'OP': 'STOR', 'dst': {'type': 'addresses_WT_ht', 'AVXalign': False, 'size': 1, 'NT': True, 'same': False, 'congruent': 0}}
...
{'OP': 'STOR', 'dst': {'type': 'addresses_A_ht', 'AVXalign': False, 'size': 8, 'NT': False, 'same': True, 'congruent': 1}}
{'58': 21829}
