...
push %rdx
push %rsi
lea addresses_WT_ht+0x18209, %r8
clflush (%r8)
nop
nop
nop
...
nop
xor $17448, %rax
lea addresses_A_ht+0x19789, %rax
nop
nop
nop
nop
...
nop
cmp %r8, %r8
lea addresses_D_ht+0x6e09, %rax
sub %r15, %r15
mov (%rax), %r12w
sub $16936, %r13
lea addresses_WC_ht+0xfa09, %r8
nop
nop
nop
nop
...
nop
xor $8800, %rdi
lea addresses_WT_ht+0xbbd9, %r15
nop
nop
nop
nop
...
nop
xor %r12, %r12
lea addresses_WC_ht+0xfe79, %rax
nop
nop
nop
xor $29949, %rdi
...
nop
xor %rax, %rax
lea addresses_normal_ht+0x19b55, %rax
nop
nop
and $25797, %r15
mov (%rax), %r8d
...
lea addresses_WT_ht+0x5809, %rdi
clflush (%rdi)
nop
xor %rax, %rax
mov $9, %rcx
...
nop
xor %rcx, %rcx
lea addresses_normal_ht+0x329, %rax
sub $22953, %r8
movw $0x6162, (%rax)
nop
cmp %rdx, %rdx
lea addresses_WT_ht+0xa419, %r8
nop
nop
nop
nop
...
{'OP': 'LOAD', 'src': {'type': 'addresses_A_ht', 'size': 16, 'AVXalign': True, 'NT': False, 'congruent': 7, 'same': False}}
{'OP': 'LOAD', 'src': {'type': 'addresses_D_ht', 'size': 2, 'AVXalign': True, 'NT': False, 'congruent': 9, 'same': False}}
