...
nop
and %rsi, %rsi
lea addresses_WT_ht+0xb2ab, %r13
nop
nop
xor %rdi, %rdi
movl $0x61626364, (%r13)
...
// REPMOV
lea addresses_normal+0x3aab, %rsi
lea addresses_A+0x13aab, %rdi
nop
nop
nop
nop
...
// REPMOV
lea addresses_WC+0x160ab, %rsi
lea addresses_A+0x170a0, %rdi
nop
nop
nop
nop
...
{'OP': 'REPM', 'src': {'same': False, 'congruent': 9, 'type': 'addresses_normal'}, 'dst': {'same': True, 'congruent': 0, 'type': 'addresses_A'}}
...
{'OP': 'REPM', 'src': {'same': False, 'congruent': 9, 'type': 'addresses_WC'}, 'dst': {'same': False, 'congruent': 0, 'type': 'addresses_A'}}
[Faulty Load]
...
{'OP': 'REPM', 'src': {'same': False, 'congruent': 10, 'type': 'addresses_UC_ht'}, 'dst': {'same': False, 'congruent': 3, 'type': 'addresses_normal_ht'}}
