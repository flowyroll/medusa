...
push %rdi
push %rsi
lea addresses_WT_ht+0x17d98, %rsi
lea addresses_A_ht+0x1eb8, %rdi
nop
sub %r13, %r13
mov $64, %rcx
rep movsl
...
// Store
lea addresses_normal+0x10638, %rdx
nop
nop
nop
nop
