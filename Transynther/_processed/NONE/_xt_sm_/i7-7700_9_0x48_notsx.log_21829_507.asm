...
push %rdi
push %rsi
lea addresses_WT_ht+0x1121e, %r14
nop
nop
and %r8, %r8
mov (%r14), %r15d
xor %rbp, %rbp
lea addresses_normal_ht+0x17bde, %rdi
clflush (%rdi)
nop
nop
nop
...
nop
and $59202, %r14
lea addresses_A_ht+0x1811e, %r10
nop
cmp $38860, %rbp
movb (%r10), %r15b
and $19128, %rdi
lea addresses_WT_ht+0x1661e, %r14
nop
cmp %rdi, %rdi
movb $0x61, (%r14)
nop
xor $50165, %rbp
lea addresses_WT_ht+0x15d1e, %rsi
lea addresses_WC_ht+0x1bde, %rdi
nop
nop
xor $38505, %r10
mov $108, %rcx
...
nop
dec %r10
lea addresses_normal_ht+0x7a1e, %r10
nop
nop
cmp $12167, %rdi
movw $0x6162, (%r10)
xor %r10, %r10
lea addresses_A_ht+0x2b7e, %rcx
clflush (%rcx)
and $306, %r8
mov (%rcx), %rbp
nop
nop
and $19980, %r10
lea addresses_A_ht+0x18a1e, %r10
nop
nop
nop
dec %r8
...
nop
inc %r10
lea addresses_UC_ht+0x1daf2, %r14
nop
nop
nop
nop
...
{'dst': {'same': False, 'congruent': 6, 'type': 'addresses_WC_ht'}, 'OP': 'REPM', 'src': {'same': False, 'congruent': 8, 'type': 'addresses_WT_ht'}}
