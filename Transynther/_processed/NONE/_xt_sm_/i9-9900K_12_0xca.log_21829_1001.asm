...
push %rdx
push %rsi
lea addresses_WT_ht+0x1194a, %rsi
lea addresses_normal_ht+0x1be66, %rdi
nop
nop
add $49861, %rbp
mov $115, %rcx
rep movsq
cmp $23549, %rcx
lea addresses_UC_ht+0xe91a, %rsi
lea addresses_D_ht+0x3ce6, %rdi
nop
cmp %rdx, %rdx
mov $72, %rcx
rep movsw
...
nop
inc %rcx
lea addresses_UC_ht+0x10da6, %r15
nop
sub %rdx, %rdx
mov (%r15), %di
nop
inc %rdi
lea addresses_UC_ht+0x111f4, %r15
nop
nop
inc %rax
...
nop
sub %rdx, %rdx
lea addresses_WT_ht+0xe0e6, %rcx
nop
nop
sub %rdi, %rdi
...
nop
add %rbp, %rbp
lea addresses_WC_ht+0x12ee6, %rax
nop
nop
nop
nop
...
nop
xor $23853, %rbp
lea addresses_normal_ht+0x122e6, %rsi
lea addresses_A_ht+0x11de6, %rdi
clflush (%rsi)
nop
nop
nop
...
// Store
lea addresses_normal+0x28e6, %r10
clflush (%r10)
nop
nop
nop
...
// Faulty Load
lea addresses_normal+0x28e6, %rdi
add $56728, %r8
mov (%rdi), %r12d
lea oracles, %r10
and $0xff, %r12
...
<gen_prepare_buffer>
{'OP': 'REPM', 'src': {'same': False, 'type': 'addresses_WT_ht', 'congruent': 2}, 'dst': {'same': False, 'type': 'addresses_normal_ht', 'congruent': 4}}
...
{'OP': 'STOR', 'dst': {'size': 16, 'NT': False, 'type': 'addresses_WT_ht', 'same': True, 'AVXalign': False, 'congruent': 10}}
{'OP': 'STOR', 'dst': {'size': 4, 'NT': False, 'type': 'addresses_WC_ht', 'same': False, 'AVXalign': False, 'congruent': 9}}
{'OP': 'REPM', 'src': {'same': False, 'type': 'addresses_normal_ht', 'congruent': 9}, 'dst': {'same': False, 'type': 'addresses_A_ht', 'congruent': 8}}
{'58': 21829}
