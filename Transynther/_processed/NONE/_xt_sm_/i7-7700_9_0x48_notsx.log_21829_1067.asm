...
nop
and %r13, %r13
lea addresses_normal_ht+0x52d5, %rsi
lea addresses_D_ht+0x16749, %rdi
nop
nop
nop
nop
...
nop
cmp %r15, %r15
lea addresses_WC_ht+0x12a05, %rsi
lea addresses_D_ht+0x9305, %rdi
nop
nop
add %r11, %r11
mov $35, %rcx
...
nop
and %rbp, %rbp
lea addresses_WC_ht+0x8305, %r15
nop
nop
nop
nop
...
nop
xor %rdi, %rdi
lea addresses_UC_ht+0x1af5d, %r13
nop
nop
nop
nop
...
nop
xor $54167, %r13
lea addresses_A_ht+0x1967d, %r11
nop
nop
nop
nop
...
{'dst': {'same': False, 'NT': True, 'AVXalign': False, 'size': 16, 'type': 'addresses_UC', 'congruent': 8}, 'OP': 'STOR'}
...
{'dst': {'same': False, 'congruent': 2, 'type': 'addresses_D_ht'}, 'OP': 'REPM', 'src': {'same': False, 'congruent': 3, 'type': 'addresses_normal_ht'}}
{'dst': {'same': False, 'congruent': 9, 'type': 'addresses_D_ht'}, 'OP': 'REPM', 'src': {'same': False, 'congruent': 8, 'type': 'addresses_WC_ht'}}
