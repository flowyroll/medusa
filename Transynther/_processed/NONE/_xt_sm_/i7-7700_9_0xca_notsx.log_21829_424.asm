...
push %rdi
push %rsi
lea addresses_WT_ht+0x1e8a9, %r15
nop
cmp $49137, %r11
movl $0x61626364, (%r15)
nop
nop
inc %r15
lea addresses_WC_ht+0x11ea9, %rsi
nop
nop
lfence
...
nop
inc %rsi
lea addresses_UC_ht+0xf269, %r15
clflush (%r15)
nop
nop
nop
...
movq %rbx, (%r15)
and $53281, %rax
lea addresses_D_ht+0x11709, %rbx
clflush (%rbx)
nop
nop
add $50836, %rax
...
nop
mfence
lea addresses_normal_ht+0x124a9, %rbx
nop
dec %rax
movl $0x61626364, (%rbx)
sub %rbx, %rbx
lea addresses_WT_ht+0x13ca9, %rsi
lea addresses_UC_ht+0x9181, %rdi
clflush (%rsi)
inc %rax
mov $126, %rcx
rep movsb
dec %rcx
lea addresses_UC_ht+0x5aa9, %rsi
lea addresses_D_ht+0x11529, %rdi
nop
nop
sub %r11, %r11
mov $72, %rcx
...
nop
xor %rax, %rax
lea addresses_UC_ht+0x10629, %rbx
nop
nop
nop
cmp %rcx, %rcx
...
nop
cmp $33758, %r11
lea addresses_UC_ht+0xda19, %rcx
nop
nop
dec %rax
mov (%rcx), %di
sub $48745, %r11
lea addresses_A_ht+0x810d, %rsi
lea addresses_WT_ht+0x1229, %rdi
nop
nop
nop
xor %r11, %r11
...
nop
and %rbp, %rbp
lea addresses_normal_ht+0x4ca9, %rsi
...
nop
dec %r11
lea addresses_WT_ht+0x489, %rsi
lea addresses_WT_ht+0x18ca9, %rdi
nop
nop
nop
add $9741, %rbp
...
rep movsq
cmp $12959, %rcx
lea addresses_WC_ht+0x1ed0f, %rsi
lea addresses_WT_ht+0xfe89, %rdi
clflush (%rdi)
nop
nop
nop
...
{'src': {'congruent': 2, 'same': False, 'type': 'addresses_A_ht'}, 'dst': {'congruent': 7, 'same': False, 'type': 'addresses_WT_ht'}, 'OP': 'REPM'}
{'src': {'congruent': 10, 'same': False, 'type': 'addresses_normal_ht'}, 'dst': {'congruent': 5, 'same': False, 'type': 'addresses_normal_ht'}, 'OP': 'REPM'}
{'src': {'congruent': 2, 'same': False, 'type': 'addresses_WT_ht'}, 'dst': {'congruent': 3, 'same': False, 'type': 'addresses_WT_ht'}, 'OP': 'REPM'}
