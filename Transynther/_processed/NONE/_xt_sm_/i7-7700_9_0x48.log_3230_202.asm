...
push %rdi
push %rsi
lea addresses_normal_ht+0x80c0, %rsi
lea addresses_D_ht+0x106c0, %rdi
nop
nop
nop
and $58647, %r10
...
nop
sub $29514, %rax
lea addresses_WT_ht+0x10bc0, %r13
sub $11531, %r11
movb (%r13), %al
add $63367, %rsi
lea addresses_normal_ht+0x12d68, %rax
nop
cmp $34372, %rcx
movups (%rax), %xmm7
vpextrq $1, %xmm7, %r10
