...
push %rdi
push %rsi
lea addresses_WC_ht+0xae22, %rcx
nop
nop
and $25535, %r15
...
nop
and %rcx, %rcx
lea addresses_normal_ht+0x66b0, %r15
nop
nop
nop
nop
...
nop
dec %rcx
lea addresses_normal_ht+0x10f52, %rsi
lea addresses_WC_ht+0x1e176, %rdi
clflush (%rsi)
nop
nop
nop
...
nop
xor $33589, %rbp
lea addresses_normal_ht+0x3052, %rsi
nop
nop
nop
nop
...
nop
and $62289, %r11
lea addresses_UC_ht+0x4bfe, %rsi
lea addresses_WT_ht+0x695e, %rdi
nop
dec %rbp
mov $72, %rcx
rep movsl
...
// REPMOV
lea addresses_WC+0xad8c, %rsi
lea addresses_WT+0xa0ae, %rdi
nop
nop
nop
sub $39176, %rbp
...
{'OP': 'REPM', 'src': {'same': False, 'congruent': 0, 'type': 'addresses_WC'}, 'dst': {'same': False, 'congruent': 3, 'type': 'addresses_WT'}}
...
<gen_prepare_buffer>
{'OP': 'STOR', 'dst': {'same': False, 'type': 'addresses_WC_ht', 'NT': True, 'AVXalign': True, 'size': 16, 'congruent': 1}}
{'OP': 'LOAD', 'src': {'same': True, 'type': 'addresses_A_ht', 'NT': False, 'AVXalign': False, 'size': 4, 'congruent': 2}}
