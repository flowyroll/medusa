...
push %rdi
push %rsi
lea addresses_normal_ht+0xd901, %rsi
lea addresses_WT_ht+0x9b13, %rdi
nop
nop
nop
nop
...
nop
cmp %r11, %r11
lea addresses_D_ht+0xa161, %r10
clflush (%r10)
add $62868, %r9
mov $0x6162636465666768, %rcx
movq %rcx, (%r10)
xor $59343, %r11
lea addresses_normal_ht+0x17f41, %r11
clflush (%r11)
sub $64664, %r9
mov (%r11), %ecx
nop
