...
movb $0x61, (%r9)
add %rsi, %rsi
lea addresses_A_ht+0x1b597, %rbp
nop
nop
cmp %rcx, %rcx
...
// REPMOV
lea addresses_RW+0x17f57, %rsi
lea addresses_UC+0x1ea57, %rdi
nop
nop
nop
nop
...
// Store
lea addresses_normal+0xc0a3, %rax
nop
nop
xor %r11, %r11
movl $0x51525354, (%rax)
...
{'src': {'type': 'addresses_RW', 'congruent': 7, 'same': False}, 'OP': 'REPM', 'dst': {'type': 'addresses_UC', 'congruent': 7, 'same': False}}
