...
push %rdi
push %rsi
lea addresses_WC_ht+0x7d1b, %r15
nop
nop
and $11679, %r13
movups (%r15), %xmm7
...
nop
cmp $7891, %r14
lea addresses_D_ht+0x1be1b, %rcx
nop
xor $41267, %r12
mov (%rcx), %r15w
nop
...
nop
inc %r12
lea addresses_normal_ht+0x486b, %rsi
...
nop
xor $28825, %r14
lea addresses_normal_ht+0x1a41b, %rsi
lea addresses_A_ht+0x1261b, %rdi
clflush (%rdi)
nop
nop
nop
...
nop
and %r15, %r15
lea addresses_WC_ht+0x1521b, %rcx
nop
cmp %r14, %r14
...
vmovups %ymm7, (%rcx)
and $31187, %rdi
lea addresses_UC_ht+0xba1b, %r13
nop
nop
add $26080, %rax
mov (%r13), %di
cmp $64778, %rsi
lea addresses_normal_ht+0x635b, %rdi
nop
nop
and %r13, %r13
movl $0x61626364, (%rdi)
...
nop
and %r12, %r12
lea addresses_normal_ht+0x5cdb, %rcx
nop
and $38891, %rdi
mov (%rcx), %ax
nop
...
nop
sub %r13, %r13
lea addresses_WT_ht+0x1e7ab, %rax
nop
nop
nop
nop
