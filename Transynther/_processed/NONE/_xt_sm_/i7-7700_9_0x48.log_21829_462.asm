...
push %rdx
push %rsi
lea addresses_normal_ht+0x344e, %r9
nop
nop
nop
xor %rdx, %rdx
...
nop
sub $3146, %rbx
lea addresses_WC_ht+0x12dd5, %rcx
nop
nop
nop
nop
...
nop
add %rcx, %rcx
lea addresses_normal_ht+0x1d5e5, %rsi
lea addresses_WC_ht+0x1b5a5, %rdi
nop
sub %rbx, %rbx
mov $16, %rcx
rep movsq
nop
sub $6028, %rsi
lea addresses_WC_ht+0x7525, %rdx
nop
nop
nop
nop
...
nop
sub %rdx, %rdx
lea addresses_WT_ht+0x9fa5, %rsi
lea addresses_WC_ht+0x17b7d, %rdi
nop
nop
nop
nop
...
nop
cmp %rcx, %rcx
lea addresses_WT_ht+0x16b25, %rsi
nop
nop
nop
nop
...
nop
inc %r14
lea addresses_A_ht+0x2c85, %rsi
lea addresses_UC_ht+0x1dd25, %rdi
nop
xor %r14, %r14
mov $77, %rcx
rep movsl
nop
add $7281, %rcx
lea addresses_normal_ht+0x11726, %rsi
lea addresses_WT_ht+0x9ba5, %rdi
clflush (%rsi)
nop
nop
nop
...
nop
and %r9, %r9
lea addresses_WT_ht+0x14561, %rsi
lea addresses_D_ht+0xbaa5, %rdi
nop
nop
and %r14, %r14
mov $6, %rcx
...
// Store
lea addresses_PSE+0x1e1a5, %r13
sub $46211, %r9
movb $0x51, (%r13)
sub %r8, %r8

// Load
lea addresses_WC+0x15ca5, %r14
nop
nop
nop
xor $1191, %r8
...
{'OP': 'STOR', 'dst': {'type': 'addresses_PSE', 'AVXalign': True, 'congruent': 0, 'size': 1, 'same': True, 'NT': False}}
...
{'OP': 'REPM', 'src': {'type': 'addresses_WT_ht', 'congruent': 9, 'same': False}, 'dst': {'type': 'addresses_WC_ht', 'congruent': 3, 'same': True}}
