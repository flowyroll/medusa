...
push %rdx
push %rsi
lea addresses_normal_ht+0x1acf0, %rdx
nop
nop
nop
nop
...
nop
cmp $38948, %r8
lea addresses_WC_ht+0x178a0, %rax
nop
nop
nop
nop
...
nop
dec %r15
lea addresses_normal_ht+0x1d560, %rdi
nop
nop
nop
dec %rax
...
nop
add %r8, %r8
lea addresses_WT_ht+0x4350, %rbx
nop
nop
nop
nop
...
nop
dec %r8
lea addresses_WT_ht+0x1e6b8, %rsi
lea addresses_WT_ht+0x197a0, %rdi
nop
nop
nop
sub $28079, %rbx
...
nop
add %r15, %r15
lea addresses_UC_ht+0x133a0, %rcx
xor %rax, %rax
movb $0x61, (%rcx)
dec %r15
lea addresses_A_ht+0xdba0, %rsi
lea addresses_normal_ht+0x1327e, %rdi
sub $45573, %r15
mov $77, %rcx
rep movsl
nop
...
nop
xor %rcx, %rcx
lea addresses_normal_ht+0x19120, %rcx
clflush (%rcx)
nop
nop
nop
...
nop
add $55653, %rdi
lea addresses_WC_ht+0x1b7a0, %rax
clflush (%rax)
nop
nop
add $4930, %rdx
...
nop
cmp $54731, %rcx
lea addresses_WT_ht+0x1b784, %rsi
...
{'OP': 'REPM', 'src': {'type': 'addresses_WT_ht', 'congruent': 2, 'same': False}, 'dst': {'type': 'addresses_WT_ht', 'congruent': 10, 'same': False}}
{'OP': 'STOR', 'dst': {'type': 'addresses_UC_ht', 'size': 1, 'AVXalign': False, 'NT': False, 'congruent': 6, 'same': False}}
{'OP': 'REPM', 'src': {'type': 'addresses_A_ht', 'congruent': 8, 'same': False}, 'dst': {'type': 'addresses_normal_ht', 'congruent': 0, 'same': False}}
{'OP': 'STOR', 'dst': {'type': 'addresses_normal_ht', 'size': 2, 'AVXalign': False, 'NT': False, 'congruent': 6, 'same': True}}
