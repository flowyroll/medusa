...
push %rdi
push %rsi
lea addresses_A_ht+0x16612, %rsi
nop
nop
and %r9, %r9
vmovups (%rsi), %ymm5
...
nop
and %r12, %r12
lea addresses_normal_ht+0x1ca12, %rsi
lea addresses_UC_ht+0x18912, %rdi
nop
nop
cmp $29260, %rax
mov $24, %rcx
...
nop
sub $14812, %rax
lea addresses_normal_ht+0xfb12, %rdi
nop
nop
nop
nop
...
movq %r9, (%rdi)
add $33521, %rsi
lea addresses_UC_ht+0x13612, %r9
clflush (%r9)
nop
dec %rcx
movb $0x61, (%r9)
...
nop
add $37364, %rax
lea addresses_WC_ht+0x5382, %rsi
lea addresses_normal_ht+0x18722, %rdi
nop
cmp %rbx, %rbx
mov $54, %rcx
rep movsb
...
nop
cmp %rdi, %rdi
lea addresses_D_ht+0x1c6aa, %rsi
nop
nop
nop
cmp %r9, %r9
...
nop
sub $38472, %r9
lea addresses_WC_ht+0x7112, %rsi
lea addresses_D_ht+0x16592, %rdi
nop
nop
nop
nop
...
{'OP': 'STOR', 'dst': {'type': 'addresses_UC', 'AVXalign': False, 'size': 8, 'NT': False, 'same': True, 'congruent': 0}}
[Faulty Load]
