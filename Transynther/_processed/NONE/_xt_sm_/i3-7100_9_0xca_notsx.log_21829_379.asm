...
nop
add $33904, %rdi
lea addresses_normal_ht+0x9322, %rbp
nop
nop
nop
nop
...
nop
and %rcx, %rcx
lea addresses_A_ht+0x1251e, %rsi
lea addresses_UC_ht+0x1a502, %rdi
nop
nop
nop
and %rdx, %rdx
...
nop
sub $62196, %r12
lea addresses_UC_ht+0x1a382, %rcx
nop
nop
nop
add %rdx, %rdx
...
nop
dec %rcx
lea addresses_normal_ht+0x1d5f2, %rsi
lea addresses_UC_ht+0x60d2, %rdi
inc %rbx
mov $120, %rcx
rep movsb
nop
...
nop
mfence
lea addresses_normal_ht+0x9232, %rsi
lea addresses_WC_ht+0x18e92, %rdi
nop
nop
nop
nop
...
nop
inc %rdx
lea addresses_WT_ht+0x12d2, %rsi
lea addresses_UC_ht+0x141b0, %rdi
nop
nop
nop
add $63375, %rbp
...
// Store
lea addresses_normal+0x7cd2, %rsi
nop
nop
nop
nop
...
// Store
lea addresses_normal+0x8052, %r9
nop
nop
nop
cmp $11048, %rsi
...
{'src': {'type': 'addresses_WT_ht', 'congruent': 8, 'same': False}, 'OP': 'REPM', 'dst': {'type': 'addresses_UC_ht', 'congruent': 1, 'same': False}}
{'58': 21829}
