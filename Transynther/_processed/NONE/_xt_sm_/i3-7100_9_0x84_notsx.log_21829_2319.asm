...
push %rdi
push %rsi
lea addresses_WC_ht+0x186b4, %r14
nop
nop
nop
xor %r15, %r15
...
lea addresses_UC_ht+0x16107, %rdi
nop
nop
cmp $42202, %rbp
mov $37, %rcx
...
nop
mfence
lea addresses_WC_ht+0x1a8e4, %rsi
lea addresses_normal_ht+0x127e4, %rdi
sub $26503, %rbx
mov $91, %rcx
rep movsb
nop
sub %rbx, %rbx
lea addresses_UC_ht+0x14464, %rbp
nop
nop
nop
nop
...
nop
cmp $60592, %rcx
lea addresses_UC_ht+0x87d4, %rbp
xor $23414, %r15
mov (%rbp), %ecx
nop
nop
...
nop
cmp %rcx, %rcx
lea addresses_WT_ht+0x107f8, %rsi
lea addresses_A_ht+0xc1d4, %rdi
nop
nop
nop
nop
...
rep movsl
dec %rsi
lea addresses_normal_ht+0x46d4, %rsi
lea addresses_UC_ht+0x102d4, %rdi
nop
nop
nop
add %rbx, %rbx
...
nop
and %rbx, %rbx
lea addresses_WC_ht+0x17ef4, %rsi
lea addresses_A_ht+0x1dad4, %rdi
nop
nop
nop
nop
...
{'src': {'type': 'addresses_WC_ht', 'congruent': 4, 'same': True}, 'dst': {'type': 'addresses_normal_ht', 'congruent': 2, 'same': False}, 'OP': 'REPM'}
...
{'src': {'type': 'addresses_WT_ht', 'congruent': 0, 'same': False}, 'dst': {'type': 'addresses_A_ht', 'congruent': 8, 'same': False}, 'OP': 'REPM'}
{'src': {'type': 'addresses_normal_ht', 'congruent': 10, 'same': False}, 'dst': {'type': 'addresses_UC_ht', 'congruent': 5, 'same': False}, 'OP': 'REPM'}
{'src': {'type': 'addresses_normal_ht', 'congruent': 4, 'same': False}, 'dst': {'type': 'addresses_WT_ht', 'congruent': 2, 'same': False}, 'OP': 'REPM'}
