...
push %rdi
push %rsi
lea addresses_normal_ht+0xaee1, %r8
nop
nop
add %rbx, %rbx
movl $0x61626364, (%r8)
...
nop
cmp $60617, %r11
lea addresses_A_ht+0x10e1f, %r12
nop
nop
nop
nop
...
lea addresses_D_ht+0x10e21, %rdi
nop
nop
inc %rax
mov $120, %rcx
...
nop
cmp $29512, %rcx
lea addresses_WC_ht+0x1efc5, %r11
dec %r12
mov (%r11), %r8w
nop
cmp %rdi, %rdi
lea addresses_WC_ht+0x57b9, %r11
add $5300, %rdi
movw $0x6162, (%r11)
nop
nop
...
nop
sub %rdi, %rdi
lea addresses_UC_ht+0x58e1, %rbx
nop
xor $55887, %r12
...
nop
dec %rbx
lea addresses_WT_ht+0x11ee1, %rsi
lea addresses_WT_ht+0x7565, %rdi
nop
sub %r12, %r12
mov $76, %rcx
rep movsl
...
nop
sub %rdi, %rdi
lea addresses_A_ht+0x15999, %rsi
nop
nop
nop
dec %r8
...
nop
xor %rbx, %rbx
lea addresses_normal_ht+0xf4e1, %rsi
nop
nop
xor %rdi, %rdi
movb $0x61, (%rsi)
...
nop
cmp %rsi, %rsi
lea addresses_A_ht+0x17961, %rsi
lea addresses_WT_ht+0x14be1, %rdi
nop
and $48480, %rax
mov $24, %rcx
rep movsb
...
nop
add $61567, %rsi
lea addresses_UC_ht+0x12e1, %r12
nop
dec %rbx
mov (%r12), %di
nop
...
{'src': {'type': 'addresses_A_ht', 'congruent': 7, 'same': False}, 'OP': 'REPM', 'dst': {'type': 'addresses_WT_ht', 'congruent': 7, 'same': True}}
