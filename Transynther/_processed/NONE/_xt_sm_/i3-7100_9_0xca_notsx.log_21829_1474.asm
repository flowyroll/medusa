...
push %rdi
push %rsi
lea addresses_WT_ht+0x46af, %r9
add %r8, %r8
mov $0x6162636465666768, %rcx
movq %rcx, %xmm1
vmovups %ymm1, (%r9)
inc %rbp
lea addresses_D_ht+0xcca7, %rsi
lea addresses_normal_ht+0x17e3f, %rdi
clflush (%rsi)
clflush (%rdi)
nop
nop
...
nop
inc %rsi
lea addresses_WC_ht+0xbc81, %rsi
lea addresses_WT_ht+0x132ef, %rdi
nop
nop
nop
nop
...
nop
add %rbp, %rbp
lea addresses_UC_ht+0x11c73, %rsi
nop
and $12579, %r15
vmovups (%rsi), %ymm0
...
nop
xor $59208, %r9
lea addresses_WC_ht+0x180a9, %rbp
nop
nop
nop
add $60862, %rdi
...
nop
xor $29448, %rcx
lea addresses_A_ht+0xbeef, %rsi
lea addresses_D_ht+0xc16f, %rdi
clflush (%rsi)
nop
nop
nop
...
nop
cmp %rax, %rax
lea addresses_normal_ht+0x94ef, %rbp
xor %r9, %r9
movw $0x6162, (%rbp)
nop
nop
...
// Store
lea addresses_normal+0x7f2f, %rbp
nop
nop
nop
nop
...
{'src': {'type': 'addresses_WC_ht', 'congruent': 1, 'same': False}, 'OP': 'REPM', 'dst': {'type': 'addresses_WT_ht', 'congruent': 11, 'same': False}}
