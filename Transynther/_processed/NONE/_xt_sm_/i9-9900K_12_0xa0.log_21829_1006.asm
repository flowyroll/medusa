...
push %rdi
push %rsi
lea addresses_WT_ht+0x117b0, %r9
nop
nop
inc %rcx
movups (%r9), %xmm4
...
nop
dec %r14
lea addresses_normal_ht+0x1b3e0, %rbp
nop
nop
nop
nop
...
nop
add $12270, %r9
lea addresses_normal_ht+0x9b40, %rbp
nop
cmp $62012, %rdi
...
nop
inc %r11
lea addresses_D_ht+0x13238, %rsi
lea addresses_normal_ht+0x87e0, %rdi
clflush (%rsi)
nop
nop
nop
...
nop
add %rsi, %rsi
lea addresses_WC_ht+0x1344c, %rsi
lea addresses_normal_ht+0x3fe0, %rdi
nop
nop
nop
add %r9, %r9
...
{'src': {'NT': False, 'same': False, 'congruent': 4, 'type': 'addresses_normal_ht', 'AVXalign': True, 'size': 16}, 'OP': 'LOAD'}
{'src': {'same': False, 'congruent': 2, 'type': 'addresses_D_ht'}, 'OP': 'REPM', 'dst': {'same': False, 'congruent': 8, 'type': 'addresses_normal_ht'}}
