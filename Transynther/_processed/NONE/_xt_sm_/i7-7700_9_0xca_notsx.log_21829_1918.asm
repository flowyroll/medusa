...
push %rdi
push %rsi
lea addresses_WC_ht+0x72e3, %r12
nop
nop
nop
dec %rax
...
nop
and %rbx, %rbx
lea addresses_UC_ht+0x9be1, %r8
sub %r15, %r15
movl $0x61626364, (%r8)
add $64243, %r13
lea addresses_WC_ht+0x16c8e, %rsi
nop
nop
nop
nop
...
nop
sub $36825, %rbx
lea addresses_normal_ht+0xc703, %rsi
lea addresses_WC_ht+0xe603, %rdi
clflush (%rdi)
nop
nop
inc %rax
...
rep movsw
sub $2238, %r13
lea addresses_WC_ht+0x17443, %rbx
nop
nop
nop
nop
...
nop
add %rsi, %rsi
lea addresses_D_ht+0x1319b, %r15
nop
nop
nop
xor $44772, %rdi
...
nop
xor %r13, %r13
lea addresses_D_ht+0x16003, %rsi
lea addresses_D_ht+0x36b9, %rdi
xor %rax, %rax
mov $97, %rcx
rep movsb
nop
...
nop
sub %rsi, %rsi
lea addresses_normal_ht+0x2903, %r8
nop
nop
nop
nop
...
nop
cmp $56688, %r13
lea addresses_WC_ht+0x19e03, %r13
nop
nop
nop
add %r8, %r8
...
nop
xor %r12, %r12
lea addresses_UC_ht+0x19deb, %rdi
nop
nop
nop
nop
...
<gen_prepare_buffer>
{'src': {'NT': False, 'AVXalign': True, 'size': 16, 'congruent': 5, 'same': False, 'type': 'addresses_WC_ht'}, 'OP': 'LOAD'}
...
{'src': {'congruent': 6, 'same': False, 'type': 'addresses_normal_ht'}, 'dst': {'congruent': 10, 'same': False, 'type': 'addresses_WC_ht'}, 'OP': 'REPM'}
