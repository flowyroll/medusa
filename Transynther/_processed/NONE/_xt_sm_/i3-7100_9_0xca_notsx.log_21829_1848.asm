...
nop
cmp %r10, %r10
lea addresses_D_ht+0x18120, %r10
nop
nop
dec %r12
mov (%r10), %r13w
...
// REPMOV
lea addresses_D+0x1a5d0, %rsi
lea addresses_D+0x16024, %rdi
clflush (%rdi)
nop
add $15569, %rdx
mov $97, %rcx
...
// REPMOV
lea addresses_WC+0x1ebf0, %rsi
lea addresses_UC+0xdec8, %rdi
nop
sub %r12, %r12
mov $38, %rcx
rep movsb
...
{'src': {'type': 'addresses_D', 'congruent': 5, 'same': False}, 'OP': 'REPM', 'dst': {'type': 'addresses_D', 'congruent': 2, 'same': False}}
{'src': {'type': 'addresses_WC', 'congruent': 0, 'same': True}, 'OP': 'REPM', 'dst': {'type': 'addresses_UC', 'congruent': 3, 'same': False}}
[Faulty Load]
