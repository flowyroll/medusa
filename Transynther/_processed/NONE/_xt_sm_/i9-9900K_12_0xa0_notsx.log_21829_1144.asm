...
movaps %xmm4, (%r9)
dec %r9
lea addresses_UC_ht+0x14380, %rsi
nop
nop
nop
nop
...
nop
and %rcx, %rcx
lea addresses_WC_ht+0x6b3a, %rsi
lea addresses_WT_ht+0x72ba, %rdi
clflush (%rdi)
add %r13, %r13
mov $32, %rcx
rep movsw
...
nop
cmp $64562, %rbx
lea addresses_normal_ht+0x18cba, %rcx
nop
and $65497, %rdi
mov (%rcx), %edx
sub %rsi, %rsi
lea addresses_UC_ht+0xa6da, %rdx
nop
nop
nop
nop
...
nop
inc %rdx
lea addresses_D_ht+0x16aba, %rbp
inc %rcx
movb $0x61, (%rbp)
nop
nop
...
nop
and $28352, %r13
lea addresses_WT_ht+0x1e916, %r13
clflush (%r13)
nop
nop
nop
...
// Store
lea addresses_normal+0xa2ba, %r9
clflush (%r9)
nop
add $14800, %rcx
...
{'OP': 'STOR', 'dst': {'type': 'addresses_A_ht', 'AVXalign': True, 'size': 16, 'NT': False, 'same': False, 'congruent': 9}}
