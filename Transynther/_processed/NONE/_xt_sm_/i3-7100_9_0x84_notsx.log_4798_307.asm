...
nop
sub %r10, %r10
lea addresses_A_ht+0x10d7e, %r13
nop
nop
nop
add $20296, %rdx
...
nop
add %rdx, %rdx
lea addresses_D_ht+0x44be, %rsi
lea addresses_D_ht+0x1a8fe, %rdi
add %rdx, %rdx
mov $2, %rcx
rep movsl
nop
...
{'src': {'type': 'addresses_D_ht', 'congruent': 6, 'same': False}, 'dst': {'type': 'addresses_D_ht', 'congruent': 7, 'same': False}, 'OP': 'REPM'}
{'58': 4798}
