...
nop
add $5092, %r12
lea addresses_normal_ht+0x72e4, %rdx
add %r11, %r11
movb $0x61, (%rdx)
nop
nop
...
nop
dec %r11
lea addresses_WC_ht+0x1e56c, %rdx
nop
nop
nop
nop
...
nop
dec %r11
lea addresses_WT_ht+0x1de4, %r13
and $51572, %r12
mov (%r13), %rdx
nop
nop
...
nop
inc %r12
lea addresses_WC_ht+0x41c4, %rsi
lea addresses_D_ht+0x1790, %rdi
clflush (%rsi)
clflush (%rdi)
nop
nop
...
nop
and $63003, %rdx
lea addresses_D_ht+0x18372, %r11
and $27721, %rbp
movb $0x61, (%r11)
add %r11, %r11
lea addresses_WC_ht+0xfee4, %rbp
nop
nop
nop
nop
...
nop
dec %rsi
lea addresses_WC_ht+0xd264, %rbp
nop
nop
nop
nop
...
nop
lfence
lea addresses_normal_ht+0xa88, %rsi
lea addresses_UC_ht+0xd9e4, %rdi
clflush (%rdi)
nop
nop
cmp %r12, %r12
...
nop
and %rsi, %rsi
lea addresses_A_ht+0x1d9bc, %r11
nop
nop
and $50746, %r8
movw $0x6162, (%r11)
sub %rbp, %rbp
lea addresses_A_ht+0x16de4, %r13
clflush (%r13)
nop
nop
nop
...
nop
dec %rbp
lea addresses_WC_ht+0x17664, %rsi
lea addresses_normal_ht+0x13804, %rdi
nop
nop
nop
xor $37525, %r11
...
{'OP': 'REPM', 'src': {'type': 'addresses_WC_ht', 'congruent': 5, 'same': False}, 'dst': {'type': 'addresses_D_ht', 'congruent': 2, 'same': False}}
{'OP': 'STOR', 'dst': {'type': 'addresses_D_ht', 'AVXalign': False, 'congruent': 1, 'size': 1, 'same': False, 'NT': False}}
{'OP': 'STOR', 'dst': {'type': 'addresses_WC_ht', 'AVXalign': False, 'congruent': 8, 'size': 8, 'same': True, 'NT': False}}
