...
nop
inc %rdx
lea addresses_WC_ht+0x550e, %r13
add $33331, %rbx
...
nop
xor %rdx, %rdx
lea addresses_normal_ht+0xe70e, %rcx
clflush (%rcx)
nop
nop
nop
...
movb $0x61, (%rcx)
dec %rcx
lea addresses_UC_ht+0x700e, %rsi
lea addresses_WC_ht+0x1778e, %rdi
nop
nop
nop
nop
...
nop
and $33309, %r9
lea addresses_A_ht+0xb50e, %rsi
lea addresses_D_ht+0x19116, %rdi
clflush (%rdi)
nop
nop
dec %r13
...
nop
xor $18048, %rcx
lea addresses_D_ht+0xfa0e, %rsi
lea addresses_WT_ht+0xa90e, %rdi
nop
nop
nop
nop
...
nop
cmp $28695, %r9
lea addresses_WC_ht+0x360e, %rdx
nop
nop
add $7804, %r9
...
nop
sub $5803, %r12
lea addresses_A_ht+0xe7cc, %r13
and $23375, %rdx
mov (%r13), %r9w
cmp $6967, %rbx
lea addresses_UC_ht+0x4e7e, %rsi
lea addresses_UC_ht+0x5e3a, %rdi
clflush (%rsi)
nop
nop
nop
...
rep movsw
sub $54715, %rbx
lea addresses_WT_ht+0x554e, %rsi
lea addresses_UC_ht+0x190be, %rdi
nop
nop
nop
and %r9, %r9
...
nop
sub $20683, %rdi
lea addresses_WT_ht+0x850e, %r13
nop
nop
cmp %rsi, %rsi
movups (%r13), %xmm2
...
{'OP': 'REPM', 'src': {'type': 'addresses_A_ht', 'congruent': 7, 'same': True}, 'dst': {'type': 'addresses_D_ht', 'congruent': 3, 'same': False}}
{'OP': 'REPM', 'src': {'type': 'addresses_D_ht', 'congruent': 11, 'same': False}, 'dst': {'type': 'addresses_WT_ht', 'congruent': 8, 'same': False}}
{'OP': 'STOR', 'dst': {'type': 'addresses_WC_ht', 'size': 8, 'AVXalign': False, 'NT': True, 'congruent': 10, 'same': False}}
{'OP': 'LOAD', 'src': {'type': 'addresses_A_ht', 'size': 2, 'AVXalign': False, 'NT': False, 'congruent': 1, 'same': False}}
{'OP': 'REPM', 'src': {'type': 'addresses_UC_ht', 'congruent': 3, 'same': False}, 'dst': {'type': 'addresses_UC_ht', 'congruent': 2, 'same': True}}
