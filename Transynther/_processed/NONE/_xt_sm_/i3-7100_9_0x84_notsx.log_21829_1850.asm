...
push %rdi
push %rsi
lea addresses_UC_ht+0x14780, %rsi
lea addresses_UC_ht+0x4f80, %rdi
add %r9, %r9
mov $116, %rcx
rep movsq
nop
...
nop
inc %rax
lea addresses_UC_ht+0x1df80, %r14
nop
nop
nop
nop
...
nop
xor $63624, %rsi
lea addresses_normal_ht+0x1cb80, %rdi
nop
nop
sub %r14, %r14
...
nop
add $18981, %r9
lea addresses_WC_ht+0xba3a, %rdi
nop
nop
nop
xor $26868, %r14
...
nop
add %r9, %r9
lea addresses_D_ht+0x1d780, %rsi
nop
nop
nop
nop
...
nop
sub %r9, %r9
lea addresses_UC_ht+0x4a80, %r9
dec %rbx
mov (%r9), %ax
xor %rdi, %rdi
lea addresses_UC_ht+0x190b8, %rbx
clflush (%rbx)
nop
nop
nop
...
nop
add $49438, %r14
lea addresses_normal_ht+0x9160, %rcx
nop
nop
nop
nop
...
<gen_prepare_buffer>
{'src': {'type': 'addresses_UC_ht', 'congruent': 9, 'same': True}, 'dst': {'type': 'addresses_UC_ht', 'congruent': 9, 'same': False}, 'OP': 'REPM'}
...
{'dst': {'type': 'addresses_WT_ht', 'same': False, 'size': 2, 'congruent': 10, 'NT': True, 'AVXalign': False}, 'OP': 'STOR'}
