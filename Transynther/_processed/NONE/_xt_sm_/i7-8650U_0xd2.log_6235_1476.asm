...
nop
add %r9, %r9
lea addresses_WC_ht+0x7c3c, %r10
nop
nop
xor $35915, %rdx
movb (%r10), %bl
...
nop
cmp $65153, %rdi
lea addresses_normal_ht+0x19d02, %r9
inc %rdx
movb (%r9), %bl
nop
cmp %r9, %r9
lea addresses_normal_ht+0xb922, %rcx
nop
nop
nop
nop
...
nop
cmp %rbx, %rbx
lea addresses_A_ht+0x1154a, %rsi
lea addresses_UC_ht+0xada2, %rdi
nop
nop
nop
nop
...
{'OP': 'LOAD', 'src': {'type': 'addresses_normal_ht', 'size': 1, 'AVXalign': False, 'NT': True, 'congruent': 6, 'same': True}}
