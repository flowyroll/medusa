...
push %rdx
push %rsi
lea addresses_D_ht+0x624e, %rsi
lea addresses_normal_ht+0x852e, %rdi
clflush (%rsi)
nop
nop
nop
...
nop
add %rbx, %rbx
lea addresses_normal_ht+0x10a5e, %rsi
lea addresses_WT_ht+0x1cb4e, %rdi
add $59095, %r12
mov $37, %rcx
rep movsb
nop
...
nop
add %rcx, %rcx
lea addresses_A_ht+0x1bfee, %rax
clflush (%rax)
nop
xor %rdx, %rdx
...
nop
sub %rbx, %rbx
lea addresses_WC_ht+0x7f4e, %rsi
nop
nop
nop
nop
...
nop
add %r12, %r12
lea addresses_UC_ht+0x197fe, %rdi
clflush (%rdi)
sub %rcx, %rcx
...
lea addresses_A_ht+0x1900e, %rdi
nop
nop
nop
nop
...
nop
inc %r12
lea addresses_WC_ht+0xfce, %rsi
lea addresses_WC_ht+0x15d4e, %rdi
clflush (%rsi)
nop
nop
nop
...
nop
sub %rdx, %rdx
lea addresses_normal_ht+0x1119e, %rsi
lea addresses_A_ht+0x15938, %rdi
nop
mfence
mov $109, %rcx
rep movsb
...
{'OP': 'STOR', 'dst': {'type': 'addresses_A', 'AVXalign': True, 'size': 4, 'NT': False, 'same': True, 'congruent': 0}}
[Faulty Load]
{'src': {'type': 'addresses_A', 'AVXalign': False, 'size': 8, 'NT': False, 'same': True, 'congruent': 0}, 'OP': 'LOAD'}
<gen_prepare_buffer>
{'src': {'type': 'addresses_D_ht', 'congruent': 5, 'same': True}, 'OP': 'REPM', 'dst': {'type': 'addresses_normal_ht', 'congruent': 4, 'same': False}}
{'src': {'type': 'addresses_normal_ht', 'congruent': 3, 'same': True}, 'OP': 'REPM', 'dst': {'type': 'addresses_WT_ht', 'congruent': 8, 'same': False}}
{'OP': 'STOR', 'dst': {'type': 'addresses_A_ht', 'AVXalign': False, 'size': 16, 'NT': False, 'same': True, 'congruent': 4}}
