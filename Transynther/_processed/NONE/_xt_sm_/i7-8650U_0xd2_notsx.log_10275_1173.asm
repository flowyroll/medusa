...
push %rax
push %rsi
lea addresses_WT_ht+0x10bca, %r10
nop
nop
nop
nop
...
nop
add %rsi, %rsi
lea addresses_WT_ht+0xf5d2, %rax
nop
nop
nop
nop
...
// Store
lea addresses_normal+0xf7ca, %r14
nop
nop
and %r15, %r15
movw $0x5152, (%r14)
...
// Faulty Load
lea addresses_normal+0xf7ca, %rsi
nop
nop
nop
nop
...
{'OP': 'STOR', 'dst': {'type': 'addresses_PSE', 'size': 4, 'AVXalign': True, 'NT': False, 'congruent': 8, 'same': False}}
