...
push %r15
push %rbx
lea addresses_UC_ht+0x16778, %r12
nop
nop
nop
xor $11566, %r15
...
// Store
lea addresses_WT+0xb278, %r10
add $20257, %r9
movb $0x51, (%r10)
xor $61927, %rdx

// Store
lea addresses_A+0x1a378, %r10
nop
nop
dec %r13
movl $0x51525354, (%r10)
