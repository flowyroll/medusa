...
// REPMOV
lea addresses_RW+0xa29d, %rsi
lea addresses_normal+0x13ebd, %rdi
nop
nop
nop
nop
...
// Store
lea addresses_A+0xf27d, %r8
dec %rdx
movb $0x51, (%r8)
cmp %r8, %r8

// Store
lea addresses_A+0xf27d, %rsi
sub $19877, %rdi
movw $0x5152, (%rsi)
add $51437, %rsi

// Store
lea addresses_D+0xde7d, %r13
xor $16199, %r15
...
{'src': {'type': 'addresses_RW', 'congruent': 5, 'same': False}, 'dst': {'type': 'addresses_normal', 'congruent': 6, 'same': False}, 'OP': 'REPM'}
...
<gen_prepare_buffer>
{'src': {'type': 'addresses_WT_ht', 'congruent': 9, 'same': False}, 'dst': {'type': 'addresses_D_ht', 'congruent': 1, 'same': False}, 'OP': 'REPM'}
