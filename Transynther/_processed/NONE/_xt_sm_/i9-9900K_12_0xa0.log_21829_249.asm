...
push %rdi
push %rsi
lea addresses_UC_ht+0xf7b8, %r13
dec %rax
mov (%r13), %r12w
sub $47889, %r8
lea addresses_normal_ht+0x68f8, %rsi
and %r12, %r12
movb $0x61, (%rsi)
cmp %r8, %r8
lea addresses_D_ht+0x1d3f8, %rsi
lea addresses_UC_ht+0x14a38, %rdi
clflush (%rdi)
nop
nop
xor $9972, %r12
...
nop
cmp %rax, %rax
lea addresses_WT_ht+0x1163c, %rsi
lea addresses_normal_ht+0xc2f9, %rdi
cmp $57564, %rbp
mov $71, %rcx
rep movsq
nop
...
nop
and $42496, %rax
lea addresses_UC_ht+0x15f8, %rsi
lea addresses_D_ht+0x45f8, %rdi
xor %rax, %rax
mov $118, %rcx
rep movsb
nop
sub $61247, %rcx
lea addresses_WT_ht+0x1ef8, %rsi
lea addresses_A_ht+0xa418, %rdi
xor %r13, %r13
mov $82, %rcx
rep movsw
nop
...
nop
xor $36480, %rsi
lea addresses_UC_ht+0x1d1e8, %r12
nop
nop
cmp $52581, %rsi
...
nop
inc %rdi
lea addresses_UC_ht+0x14134, %r12
nop
nop
and %rsi, %rsi
mov (%r12), %rax
...
{'OP': 'STOR', 'dst': {'NT': False, 'same': False, 'congruent': 11, 'type': 'addresses_NC', 'AVXalign': True, 'size': 8}}
{'OP': 'STOR', 'dst': {'NT': False, 'same': True, 'congruent': 0, 'type': 'addresses_D', 'AVXalign': False, 'size': 8}}
[Faulty Load]
...
{'src': {'same': False, 'congruent': 9, 'type': 'addresses_D_ht'}, 'OP': 'REPM', 'dst': {'same': False, 'congruent': 5, 'type': 'addresses_UC_ht'}}
{'src': {'same': True, 'congruent': 2, 'type': 'addresses_WT_ht'}, 'OP': 'REPM', 'dst': {'same': True, 'congruent': 0, 'type': 'addresses_normal_ht'}}
...
{'src': {'same': False, 'congruent': 9, 'type': 'addresses_UC_ht'}, 'OP': 'REPM', 'dst': {'same': False, 'congruent': 9, 'type': 'addresses_D_ht'}}
