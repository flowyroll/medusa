...
vpextrq $1, %xmm1, %rax
cmp %rax, %rax
lea addresses_WC_ht+0x1dcba, %rcx
nop
nop
nop
nop
...
nop
add %rbp, %rbp
lea addresses_normal_ht+0x114ba, %rcx
clflush (%rcx)
nop
nop
cmp $33682, %r9
...
nop
and $58911, %rbp
lea addresses_D_ht+0x1cbba, %rcx
nop
nop
nop
add %r9, %r9
...
nop
add %rbp, %rbp
lea addresses_normal_ht+0x333a, %rsi
lea addresses_WC_ht+0x1c2ea, %rdi
clflush (%rdi)
nop
sub %rbp, %rbp
mov $47, %rcx
...
nop
cmp $18530, %rdi
lea addresses_A_ht+0x199ba, %rsi
lea addresses_WT_ht+0x11f4c, %rdi
nop
sub $17743, %rbx
mov $43, %rcx
rep movsl
...
nop
inc %rbp
lea addresses_UC_ht+0xc0ba, %rsi
lea addresses_normal_ht+0xc3ba, %rdi
clflush (%rdi)
add %rbx, %rbx
mov $78, %rcx
rep movsl
...
// Store
lea addresses_normal+0x1f8ba, %rbp
nop
nop
cmp $16284, %rsi
...
// Faulty Load
lea addresses_normal+0x1f8ba, %r8
nop
nop
nop
nop
