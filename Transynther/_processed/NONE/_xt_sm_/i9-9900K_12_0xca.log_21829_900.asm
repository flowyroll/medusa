...
vmovups %ymm5, (%r9)
sub $14694, %rdx
lea addresses_WC_ht+0x1cb88, %r9
nop
nop
add %r15, %r15
movl $0x61626364, (%r9)
inc %r15
lea addresses_WC_ht+0x1ae80, %r15
sub %rcx, %rcx
...
// Store
lea addresses_normal+0x1c000, %r15
nop
xor %rbx, %rbx
movb $0x51, (%r15)
nop
...
{'OP': 'LOAD', 'src': {'size': 32, 'NT': False, 'type': 'addresses_US', 'same': False, 'AVXalign': False, 'congruent': 6}}
{'OP': 'STOR', 'dst': {'size': 16, 'NT': False, 'type': 'addresses_WT', 'same': True, 'AVXalign': False, 'congruent': 8}}
