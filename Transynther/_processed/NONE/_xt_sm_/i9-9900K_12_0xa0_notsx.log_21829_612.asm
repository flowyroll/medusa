...
push %rdi
push %rsi
lea addresses_UC_ht+0xf005, %r12
nop
nop
add $8192, %rbx
...
nop
add %rsi, %rsi
lea addresses_WC_ht+0x25c5, %rsi
lea addresses_D_ht+0x137f1, %rdi
nop
nop
add %r11, %r11
mov $75, %rcx
...
nop
add %rdi, %rdi
lea addresses_D_ht+0x15c95, %rdi
nop
nop
nop
inc %rcx
...
nop
inc %rdi
lea addresses_D_ht+0x17dc5, %rsi
nop
cmp $42516, %rcx
movb $0x61, (%rsi)
nop
...
nop
xor $57995, %rcx
lea addresses_WT_ht+0x13405, %rsi
nop
nop
sub $17890, %rbx
mov (%rsi), %r11d
nop
and %rdi, %rdi
lea addresses_WC_ht+0x157c5, %rcx
nop
nop
nop
and $48498, %r12
...
nop
cmp $18179, %rbx
lea addresses_A_ht+0x15dc5, %r11
nop
nop
dec %rdi
mov (%r11), %r12
...
// Store
lea addresses_normal+0xc365, %rbp
nop
cmp %r8, %r8
movl $0x51525354, (%rbp)
nop
...
{'OP': 'STOR', 'dst': {'type': 'addresses_US', 'AVXalign': False, 'size': 2, 'NT': False, 'same': False, 'congruent': 10}}
...
{'src': {'type': 'addresses_WC_ht', 'congruent': 11, 'same': False}, 'OP': 'REPM', 'dst': {'type': 'addresses_D_ht', 'congruent': 2, 'same': False}}
{'OP': 'STOR', 'dst': {'type': 'addresses_D_ht', 'AVXalign': False, 'size': 8, 'NT': False, 'same': True, 'congruent': 3}}
...
{'src': {'type': 'addresses_WC_ht', 'AVXalign': False, 'size': 16, 'NT': False, 'same': True, 'congruent': 8}, 'OP': 'LOAD'}
