...
push %rdx
push %rsi
lea addresses_WT_ht+0x17bba, %rsi
lea addresses_A_ht+0x267a, %rdi
nop
nop
nop
nop
...
nop
dec %rax
lea addresses_normal_ht+0x9aba, %r12
clflush (%r12)
nop
xor $27589, %rdx
...
movq %rsi, (%r12)
sub %rax, %rax
lea addresses_normal_ht+0xd97a, %rsi
...
nop
mfence
lea addresses_WC_ht+0xe2ba, %rdx
cmp $7, %rdi
movb $0x61, (%rdx)
nop
cmp %r12, %r12
lea addresses_UC_ht+0x9f92, %rdx
nop
nop
lfence
movb (%rdx), %cl
nop
xor $17076, %rdx
lea addresses_normal_ht+0x1283a, %rsi
...
rep movsb
add %rcx, %rcx
lea addresses_normal_ht+0x1d7ba, %rsi
lea addresses_UC_ht+0x115ba, %rdi
clflush (%rdi)
nop
nop
nop
...
nop
add %rax, %rax
lea addresses_WT_ht+0xa6ba, %rbp
nop
nop
nop
nop
...
// Store
lea addresses_normal+0xe7ba, %r9
nop
nop
nop
and %rdi, %rdi
...
// Faulty Load
lea addresses_normal+0xe7ba, %rbp
nop
xor %r15, %r15
movb (%rbp), %r9b
lea oracles, %rax
...
{'dst': {'NT': False, 'AVXalign': False, 'size': 32, 'congruent': 1, 'same': False, 'type': 'addresses_PSE'}, 'OP': 'STOR'}
...
{'src': {'congruent': 4, 'same': False, 'type': 'addresses_normal_ht'}, 'dst': {'congruent': 1, 'same': False, 'type': 'addresses_normal_ht'}, 'OP': 'REPM'}
{'src': {'congruent': 10, 'same': False, 'type': 'addresses_normal_ht'}, 'dst': {'congruent': 8, 'same': False, 'type': 'addresses_UC_ht'}, 'OP': 'REPM'}
