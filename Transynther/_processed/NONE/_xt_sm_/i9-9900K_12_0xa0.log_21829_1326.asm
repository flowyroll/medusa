...
push %rdx
push %rsi
lea addresses_WC_ht+0x583b, %rsi
lea addresses_WC_ht+0x2bfb, %rdi
nop
nop
inc %r13
mov $124, %rcx
...
nop
sub %rdx, %rdx
lea addresses_WT_ht+0x127b, %rsi
lea addresses_normal_ht+0x1d2ab, %rdi
nop
nop
nop
nop
...
nop
add %rsi, %rsi
lea addresses_WT_ht+0x1183b, %rsi
nop
nop
nop
nop
...
nop
inc %rsi
lea addresses_D_ht+0x19f1b, %rsi
lea addresses_D_ht+0x4d3b, %rdi
nop
nop
nop
nop
...
// Store
lea addresses_normal+0xc42f, %r12
nop
dec %rdi
...
{'OP': 'STOR', 'dst': {'NT': False, 'same': False, 'congruent': 2, 'type': 'addresses_normal', 'AVXalign': False, 'size': 8}}
...
{'src': {'same': False, 'congruent': 5, 'type': 'addresses_D_ht'}, 'OP': 'REPM', 'dst': {'same': False, 'congruent': 7, 'type': 'addresses_D_ht'}}
{'51': 21829}
