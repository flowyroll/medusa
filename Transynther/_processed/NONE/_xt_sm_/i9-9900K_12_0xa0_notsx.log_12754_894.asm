...
push %rdi
push %rsi
lea addresses_WC_ht+0x4161, %rsi
lea addresses_normal_ht+0x19b73, %rdi
cmp $6462, %rbx
mov $25, %rcx
rep movsb
nop
...
nop
add %rdi, %rdi
lea addresses_A_ht+0x14f99, %r13
sub $20279, %r9
...
// Store
lea addresses_normal+0x2dd1, %rbp
nop
sub $54303, %rax
