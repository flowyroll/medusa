...
push %rdx
push %rsi
lea addresses_D_ht+0x414e, %rsi
lea addresses_A_ht+0x12ece, %rdi
clflush (%rdi)
nop
nop
nop
...
nop
cmp $60386, %r8
lea addresses_WC_ht+0xdace, %r11
nop
add $46064, %rdi
...
// Store
lea addresses_normal+0x116ce, %r13
clflush (%r13)
nop
nop
nop
...
// Faulty Load
lea addresses_normal+0x116ce, %r11
nop
nop
nop
nop
...
{'src': {'NT': False, 'same': False, 'congruent': 8, 'type': 'addresses_UC', 'AVXalign': False, 'size': 8}, 'OP': 'LOAD'}
