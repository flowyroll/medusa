...
vpextrq $0, %xmm1, %rbx
and %r9, %r9
lea addresses_normal_ht+0x190e1, %r9
nop
and $17138, %r13
movups (%r9), %xmm1
vpextrq $1, %xmm1, %r10
...
nop
xor $13936, %r9
lea addresses_WT_ht+0x112f9, %rsi
lea addresses_A_ht+0x1746d, %rdi
clflush (%rsi)
clflush (%rdi)
nop
xor %r13, %r13
...
{'OP': 'STOR', 'dst': {'NT': False, 'same': True, 'congruent': 0, 'type': 'addresses_RW', 'AVXalign': False, 'size': 1}}
