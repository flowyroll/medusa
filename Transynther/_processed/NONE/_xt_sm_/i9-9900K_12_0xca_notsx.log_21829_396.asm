...
nop
and $4355, %rbp
lea addresses_WC_ht+0x990c, %rax
nop
nop
nop
nop
...
mov (%rax), %rcx
inc %r12
lea addresses_D_ht+0x7750, %rsi
lea addresses_A_ht+0x10a98, %rdi
nop
nop
nop
nop
...
// Store
lea addresses_normal+0x1fe98, %r12
dec %r9
movw $0x5152, (%r12)
nop
nop
...
// Faulty Load
lea addresses_normal+0x1fe98, %rdx
clflush (%rdx)
nop
nop
nop
