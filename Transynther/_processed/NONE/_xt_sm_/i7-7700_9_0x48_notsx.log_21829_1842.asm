...
push %rdx
push %rsi
lea addresses_D_ht+0x1a929, %rsi
nop
dec %rdi
movb $0x61, (%rsi)
nop
add $50304, %r12
lea addresses_A_ht+0x1e9, %r12
clflush (%r12)
nop
nop
nop
...
nop
lfence
lea addresses_D_ht+0xb1a9, %rsi
lea addresses_WC_ht+0x1a12f, %rdi
nop
nop
nop
nop
...
nop
sub $18672, %rdi
lea addresses_WT_ht+0x1c2a9, %rdi
nop
nop
cmp $25328, %rsi
movb $0x61, (%rdi)
...
movb $0x61, (%r10)
cmp %rsi, %rsi
lea addresses_WT_ht+0x8779, %rsi
nop
nop
nop
nop
...
nop
sub $15281, %rcx
lea addresses_A_ht+0x28a9, %rsi
lea addresses_D_ht+0x1e735, %rdi
nop
cmp %rax, %rax
mov $81, %rcx
rep movsq
...
// Store
lea addresses_normal+0x16641, %r13
nop
nop
nop
nop
...
{'dst': {'same': False, 'NT': True, 'AVXalign': False, 'size': 2, 'type': 'addresses_P', 'congruent': 0}, 'OP': 'STOR'}
...
<gen_prepare_buffer>
{'dst': {'same': True, 'NT': False, 'AVXalign': False, 'size': 1, 'type': 'addresses_D_ht', 'congruent': 9}, 'OP': 'STOR'}
...
{'dst': {'same': False, 'NT': True, 'AVXalign': False, 'size': 1, 'type': 'addresses_WT_ht', 'congruent': 6}, 'OP': 'STOR'}
...
{'dst': {'same': False, 'congruent': 2, 'type': 'addresses_D_ht'}, 'OP': 'REPM', 'src': {'same': True, 'congruent': 6, 'type': 'addresses_A_ht'}}
{'58': 21829}
