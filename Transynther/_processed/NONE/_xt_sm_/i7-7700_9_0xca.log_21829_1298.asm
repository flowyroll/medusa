...
push %rdx
push %rsi
lea addresses_D_ht+0x1c57e, %rdi
nop
nop
add $45229, %rbx
...
nop
add %r11, %r11
lea addresses_normal_ht+0xf982, %r10
nop
nop
nop
nop
...
nop
dec %rcx
lea addresses_UC_ht+0x187c2, %rsi
lea addresses_D_ht+0x137a2, %rdi
clflush (%rsi)
nop
inc %r11
mov $57, %rcx
...
nop
add %rbp, %rbp
lea addresses_WC_ht+0x7332, %rsi
lea addresses_WT_ht+0x16212, %rdi
clflush (%rsi)
nop
nop
nop
...
{'src': {'congruent': 4, 'same': True, 'type': 'addresses_WC_ht'}, 'OP': 'REPM', 'dst': {'congruent': 4, 'same': True, 'type': 'addresses_WT_ht'}}
{'58': 21829}
