...
nop
add %r12, %r12
lea addresses_UC_ht+0x1d882, %rsi
lea addresses_A_ht+0xf1b2, %rdi
cmp %rbp, %rbp
mov $50, %rcx
rep movsl
nop
...
nop
and $34077, %rdi
lea addresses_WC_ht+0xcdbb, %rsi
lea addresses_A_ht+0x11082, %rdi
cmp %rbp, %rbp
mov $74, %rcx
rep movsq
dec %r12
lea addresses_A_ht+0xaa64, %rsi
nop
nop
nop
nop
...
// REPMOV
lea addresses_US+0x10402, %rsi
lea addresses_WC+0x1607a, %rdi
nop
nop
nop
sub $30483, %rbx
...
{'OP': 'REPM', 'src': {'same': False, 'congruent': 7, 'type': 'addresses_US'}, 'dst': {'same': False, 'congruent': 3, 'type': 'addresses_WC'}}
{'OP': 'STOR', 'dst': {'same': True, 'type': 'addresses_D', 'NT': True, 'AVXalign': False, 'size': 2, 'congruent': 0}}
...
{'OP': 'REPM', 'src': {'same': False, 'congruent': 10, 'type': 'addresses_UC_ht'}, 'dst': {'same': False, 'congruent': 4, 'type': 'addresses_A_ht'}}
{'OP': 'REPM', 'src': {'same': False, 'congruent': 0, 'type': 'addresses_WC_ht'}, 'dst': {'same': False, 'congruent': 11, 'type': 'addresses_A_ht'}}
