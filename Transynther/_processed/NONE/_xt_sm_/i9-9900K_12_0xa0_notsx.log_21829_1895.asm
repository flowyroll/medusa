...
push %rdi
push %rsi
lea addresses_WT_ht+0x196e7, %rsi
lea addresses_A_ht+0x1d447, %rdi
clflush (%rsi)
nop
nop
nop
...
rep movsq
inc %r11
lea addresses_A_ht+0xf547, %r14
nop
nop
sub %rax, %rax
mov (%r14), %edi
xor $64143, %r14
lea addresses_WT_ht+0x19d7, %r14
nop
nop
and $12577, %r13
mov (%r14), %esi
...
nop
add %r13, %r13
lea addresses_D_ht+0x1d9f8, %rsi
...
nop
dec %r14
lea addresses_D_ht+0xf747, %rsi
lea addresses_normal_ht+0x10c47, %rdi
clflush (%rsi)
clflush (%rdi)
nop
nop
...
nop
cmp %r13, %r13
lea addresses_UC_ht+0x12a47, %rsi
lea addresses_A_ht+0xec7c, %rdi
nop
nop
nop
nop
...
rep movsl
add $42613, %r13
lea addresses_WC_ht+0xae47, %rbp
nop
nop
xor %rcx, %rcx
movb (%rbp), %r11b
...
// Store
lea addresses_normal+0xe0c7, %r9
nop
nop
nop
add $46026, %rdx
...
{'OP': 'STOR', 'dst': {'type': 'addresses_US', 'AVXalign': False, 'size': 1, 'NT': False, 'same': False, 'congruent': 4}}
[Faulty Load]
{'src': {'type': 'addresses_PSE', 'AVXalign': False, 'size': 4, 'NT': False, 'same': True, 'congruent': 0}, 'OP': 'LOAD'}
<gen_prepare_buffer>
{'src': {'type': 'addresses_WT_ht', 'congruent': 5, 'same': False}, 'OP': 'REPM', 'dst': {'type': 'addresses_A_ht', 'congruent': 8, 'same': False}}
...
{'src': {'type': 'addresses_D_ht', 'congruent': 0, 'same': False}, 'OP': 'REPM', 'dst': {'type': 'addresses_WT_ht', 'congruent': 9, 'same': False}}
