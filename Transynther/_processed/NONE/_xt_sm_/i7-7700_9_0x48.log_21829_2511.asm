...
push %rdi
push %rsi
lea addresses_normal_ht+0xe0e, %rsi
lea addresses_UC_ht+0xaa0e, %rdi
and %r13, %r13
mov $73, %rcx
rep movsb
nop
...
nop
add $50053, %r10
lea addresses_normal_ht+0xcd3e, %r10
inc %rbp
...
nop
and $60396, %rdi
lea addresses_normal_ht+0xdd7e, %r10
nop
xor %r9, %r9
...
nop
mfence
lea addresses_WT_ht+0x376e, %rsi
...
lea addresses_A_ht+0x1236e, %rdi
nop
nop
xor %r10, %r10
mov $42, %rcx
...
nop
inc %rsi
lea addresses_normal_ht+0x7e0e, %r9
nop
nop
nop
nop
...
<gen_prepare_buffer>
{'OP': 'REPM', 'src': {'type': 'addresses_normal_ht', 'congruent': 11, 'same': False}, 'dst': {'type': 'addresses_UC_ht', 'congruent': 10, 'same': True}}
{'OP': 'STOR', 'dst': {'type': 'addresses_normal_ht', 'AVXalign': False, 'congruent': 4, 'size': 32, 'same': True, 'NT': False}}
