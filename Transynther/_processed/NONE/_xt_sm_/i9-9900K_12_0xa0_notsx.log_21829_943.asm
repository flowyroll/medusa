...
push %rdi
push %rsi
lea addresses_WT_ht+0x1db3a, %r14
clflush (%r14)
nop
nop
nop
...
nop
cmp $63255, %r13
lea addresses_A_ht+0x173c, %rsi
lea addresses_D_ht+0x1dbc, %rdi
nop
and $47712, %r11
mov $51, %rcx
rep movsw
nop
dec %r13
lea addresses_WC_ht+0x1d394, %rsi
lea addresses_WT_ht+0x1a2bf, %rdi
clflush (%rsi)
nop
nop
nop
...
nop
add %rcx, %rcx
lea addresses_WC_ht+0xacc, %rsi
lea addresses_UC_ht+0x16d5c, %rdi
nop
nop
nop
and %r11, %r11
...
<gen_prepare_buffer>
{'OP': 'STOR', 'dst': {'type': 'addresses_WT_ht', 'AVXalign': False, 'size': 4, 'NT': True, 'same': False, 'congruent': 0}}
