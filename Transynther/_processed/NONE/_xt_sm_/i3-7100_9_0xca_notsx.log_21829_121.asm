...
nop
xor $16062, %r15
lea addresses_UC_ht+0x11803, %rbx
nop
nop
nop
nop
...
nop
sub %r8, %r8
lea addresses_normal_ht+0xe17d, %rsi
lea addresses_WC_ht+0x16369, %rdi
nop
nop
nop
and $8444, %rdx
