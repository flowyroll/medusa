...
// Store
lea addresses_normal+0x199a4, %r8
nop
nop
nop
and $11842, %r11
...
// REPMOV
lea addresses_D+0x3d44, %rsi
lea addresses_D+0x18718, %rdi
clflush (%rsi)
nop
nop
and %r8, %r8
...
// Faulty Load
lea addresses_normal+0x199a4, %rsi
nop
add $46368, %r11
mov (%rsi), %rbp
lea oracles, %r12
...
{'OP': 'REPM', 'src': {'same': False, 'congruent': 5, 'type': 'addresses_D'}, 'dst': {'same': False, 'congruent': 2, 'type': 'addresses_D'}}
...
{'OP': 'LOAD', 'src': {'same': False, 'type': 'addresses_D', 'NT': False, 'AVXalign': True, 'size': 2, 'congruent': 4}}
[Faulty Load]
