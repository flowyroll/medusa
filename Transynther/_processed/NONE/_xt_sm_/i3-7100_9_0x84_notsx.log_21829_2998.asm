...
push %rdi
push %rsi
lea addresses_WT_ht+0x36d4, %rcx
nop
nop
nop
xor $16707, %rax
...
nop
xor %rbp, %rbp
lea addresses_WC_ht+0x1e1d4, %rsi
lea addresses_normal_ht+0x91d4, %rdi
nop
nop
dec %r14
mov $32, %rcx
...
nop
xor $11793, %rsi
lea addresses_WC_ht+0x16b54, %r10
nop
nop
nop
nop
...
// Store
lea addresses_normal+0xa9d4, %r10
xor %r14, %r14
...
// Faulty Load
lea addresses_normal+0xa9d4, %rsi
nop
nop
nop
nop
...
{'src': {'type': 'addresses_WC_ht', 'congruent': 11, 'same': True}, 'dst': {'type': 'addresses_normal_ht', 'congruent': 11, 'same': False}, 'OP': 'REPM'}
