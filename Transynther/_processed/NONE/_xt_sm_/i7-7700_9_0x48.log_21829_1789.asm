...
nop
xor $50831, %rsi
lea addresses_WT_ht+0xef43, %r10
dec %r14
movb $0x61, (%r10)
nop
cmp %r10, %r10
lea addresses_WT_ht+0xf303, %rsi
lea addresses_WC_ht+0xda41, %rdi
nop
nop
cmp %rdx, %rdx
mov $9, %rcx
rep movsl
add %rcx, %rcx
lea addresses_normal_ht+0x5e03, %rsi
nop
nop
nop
nop
...
{'OP': 'STOR', 'dst': {'type': 'addresses_WT_ht', 'AVXalign': True, 'congruent': 6, 'size': 1, 'same': True, 'NT': False}}
{'OP': 'REPM', 'src': {'type': 'addresses_WT_ht', 'congruent': 10, 'same': False}, 'dst': {'type': 'addresses_WC_ht', 'congruent': 1, 'same': False}}
