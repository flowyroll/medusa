...
nop
and %rax, %rax
lea addresses_WT_ht+0x34a0, %rdx
nop
nop
nop
add %r9, %r9
...
nop
and %r9, %r9
lea addresses_WT_ht+0x6820, %r13
and %rdx, %rdx
movl $0x61626364, (%r13)
add %r10, %r10
lea addresses_A_ht+0x18e55, %rsi
lea addresses_WT_ht+0x8ea0, %rdi
clflush (%rdi)
nop
nop
nop
...
nop
and %r10, %r10
lea addresses_WC_ht+0x1fa0, %rsi
...
nop
xor $27399, %rcx
lea addresses_A_ht+0x113f8, %rdi
nop
xor %rdx, %rdx
mov (%rdi), %cx
nop
...
// Store
lea addresses_normal+0x16760, %r9
nop
inc %r12
movb $0x51, (%r9)
nop
...
// Store
lea addresses_normal+0x1aa0, %rbp
nop
nop
nop
nop
...
{'OP': 'STOR', 'dst': {'congruent': 0, 'AVXalign': True, 'same': True, 'size': 32, 'NT': False, 'type': 'addresses_RW'}}
{'OP': 'STOR', 'dst': {'congruent': 4, 'AVXalign': False, 'same': False, 'size': 4, 'NT': False, 'type': 'addresses_A'}}
{'OP': 'STOR', 'dst': {'congruent': 5, 'AVXalign': False, 'same': False, 'size': 1, 'NT': True, 'type': 'addresses_normal'}}
...
{'src': {'congruent': 8, 'same': False, 'type': 'addresses_WC_ht'}, 'OP': 'REPM', 'dst': {'congruent': 8, 'same': False, 'type': 'addresses_normal_ht'}}
{'src': {'congruent': 2, 'AVXalign': False, 'same': False, 'size': 2, 'NT': True, 'type': 'addresses_A_ht'}, 'OP': 'LOAD'}
{'58': 21829}
