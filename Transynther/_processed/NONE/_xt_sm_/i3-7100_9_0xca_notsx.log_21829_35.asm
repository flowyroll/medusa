...
nop
and %r14, %r14
lea addresses_A_ht+0x17ef8, %rsi
lea addresses_UC_ht+0x11420, %rdi
nop
cmp %r8, %r8
mov $41, %rcx
rep movsb
and $36208, %rdi
lea addresses_WC_ht+0x16178, %rdi
nop
sub $60175, %r14
...
nop
sub $24656, %r14
lea addresses_WC_ht+0x1d742, %r12
nop
nop
nop
nop
...
vmovups %ymm1, (%r12)
and %r12, %r12
lea addresses_UC_ht+0x18b78, %r13
nop
and $9077, %r14
mov (%r13), %r8
nop
...
nop
cmp $884, %r8
lea addresses_normal_ht+0x1df78, %rsi
lea addresses_WC_ht+0x58f8, %rdi
nop
nop
add %rbp, %rbp
mov $75, %rcx
...
nop
and %rsi, %rsi
lea addresses_WT_ht+0x11178, %rsi
lea addresses_A_ht+0xc2d8, %rdi
nop
nop
nop
nop
...
{'src': {'type': 'addresses_WT_ht', 'congruent': 10, 'same': True}, 'OP': 'REPM', 'dst': {'type': 'addresses_A_ht', 'congruent': 5, 'same': False}}
{'58': 21829}
