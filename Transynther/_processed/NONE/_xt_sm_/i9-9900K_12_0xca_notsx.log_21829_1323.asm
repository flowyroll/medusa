...
push %rdx
push %rsi
lea addresses_D_ht+0x17455, %rdx
nop
nop
nop
nop
...
lea addresses_WT_ht+0x1455, %rdi
nop
nop
nop
inc %rax
...
nop
add %rax, %rax
lea addresses_WC_ht+0x17575, %rax
nop
nop
nop
nop
...
lea addresses_WT_ht+0xa695, %rdi
nop
nop
nop
nop
...
rep movsl
add %rdi, %rdi
lea addresses_UC_ht+0x19c95, %r8
nop
nop
nop
and %rbp, %rbp
...
nop
add %rax, %rax
lea addresses_WT_ht+0x15495, %r8
nop
cmp %rsi, %rsi
movb (%r8), %dl
nop
...
{'OP': 'REPM', 'src': {'same': False, 'congruent': 6, 'type': 'addresses_UC_ht'}, 'dst': {'same': False, 'congruent': 7, 'type': 'addresses_WT_ht'}}
