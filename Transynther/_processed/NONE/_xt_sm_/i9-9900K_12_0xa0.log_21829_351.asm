...
push %rdi
push %rsi
lea addresses_A_ht+0xf62a, %rsi
lea addresses_D_ht+0x10a62, %rdi
nop
nop
nop
cmp %r14, %r14
...
nop
cmp %rdi, %rdi
lea addresses_WT_ht+0x16882, %rsi
nop
nop
nop
cmp %rbp, %rbp
...
nop
dec %rcx
lea addresses_UC_ht+0x16a82, %rsi
lea addresses_UC_ht+0x1cf1f, %rdi
nop
cmp %r13, %r13
mov $1, %rcx
rep movsb
...
nop
add $21053, %rcx
lea addresses_WC_ht+0x1ccd2, %rbp
nop
nop
nop
nop
...
nop
sub %rdi, %rdi
lea addresses_WC_ht+0xa082, %r14
nop
nop
nop
nop
...
nop
and $33569, %r10
lea addresses_UC_ht+0x79e2, %rbp
nop
nop
nop
nop
...
nop
xor %r13, %r13
lea addresses_normal_ht+0x13882, %rsi
nop
nop
nop
nop
...
{'src': {'NT': False, 'same': False, 'congruent': 3, 'type': 'addresses_WT', 'AVXalign': False, 'size': 8}, 'OP': 'LOAD'}
...
<gen_prepare_buffer>
{'src': {'same': True, 'congruent': 3, 'type': 'addresses_A_ht'}, 'OP': 'REPM', 'dst': {'same': False, 'congruent': 4, 'type': 'addresses_D_ht'}}
