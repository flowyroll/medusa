...
nop
add $39740, %rdi
lea addresses_WC_ht+0xfa48, %rsi
lea addresses_UC_ht+0x4608, %rdi
nop
inc %r9
mov $42, %rcx
rep movsq
...
movb (%r9), %r14b
add %rcx, %rcx
lea addresses_WC_ht+0x7ba0, %rax
nop
nop
nop
and %rcx, %rcx
...
nop
xor %rcx, %rcx
lea addresses_WT_ht+0x9688, %rcx
add $41095, %rbp
movups (%rcx), %xmm5
vpextrq $0, %xmm5, %rsi
nop
...
nop
and %rdi, %rdi
lea addresses_normal_ht+0x5228, %r9
and %rsi, %rsi
...
nop
dec %r9
lea addresses_normal_ht+0x14c08, %rsi
lea addresses_WC_ht+0x3808, %rdi
nop
nop
nop
nop
...
nop
and $33351, %r14
lea addresses_D_ht+0x3868, %rsi
lea addresses_WC_ht+0x1b848, %rdi
nop
nop
nop
nop
...
nop
cmp $14696, %r9
lea addresses_normal_ht+0x78c4, %r11
nop
nop
nop
xor $49933, %r9
...
nop
xor $54647, %rdi
lea addresses_WC_ht+0xfc08, %rdi
nop
nop
nop
nop
...
mov (%rdi), %esi
and $35411, %rbp
lea addresses_UC_ht+0x17c08, %rsi
lea addresses_normal_ht+0x16010, %rdi
nop
nop
nop
sub %r9, %r9
...
// Store
lea addresses_normal+0x1cad8, %rbx
nop
nop
and $38386, %rdi
movw $0x5152, (%rbx)
...
{'src': {'type': 'addresses_WC_ht', 'congruent': 4, 'same': False}, 'OP': 'REPM', 'dst': {'type': 'addresses_UC_ht', 'congruent': 9, 'same': False}}
...
{'src': {'type': 'addresses_D_ht', 'congruent': 3, 'same': False}, 'OP': 'REPM', 'dst': {'type': 'addresses_WC_ht', 'congruent': 4, 'same': False}}
