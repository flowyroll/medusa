...
push %rdi
push %rsi
lea addresses_UC_ht+0x19581, %rdi
nop
nop
nop
and %rsi, %rsi
...
nop
inc %rdi
lea addresses_normal_ht+0x14cc1, %r13
nop
nop
dec %r11
movb (%r13), %cl
...
{'OP': 'STOR', 'dst': {'NT': True, 'same': False, 'congruent': 8, 'type': 'addresses_D', 'AVXalign': False, 'size': 4}}
...
{'src': {'NT': True, 'same': False, 'congruent': 2, 'type': 'addresses_WT', 'AVXalign': False, 'size': 2}, 'OP': 'LOAD'}
[Faulty Load]
