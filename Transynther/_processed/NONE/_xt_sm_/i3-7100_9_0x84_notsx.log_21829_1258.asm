...
push %rdi
push %rsi
lea addresses_A_ht+0x150b1, %r10
nop
dec %r12
mov (%r10), %r11d
add $6782, %rcx
lea addresses_normal_ht+0x4eb1, %rcx
nop
nop
nop
nop
...
nop
sub $55882, %r10
lea addresses_UC_ht+0x3e35, %rax
nop
nop
add $14953, %r14
mov (%rax), %r11w
...
nop
cmp %r10, %r10
lea addresses_WT_ht+0x8cb1, %rax
nop
nop
nop
xor %r10, %r10
...
nop
xor $9054, %rax
lea addresses_UC_ht+0xe4b1, %r11
sub %rax, %rax
...
nop
and %rcx, %rcx
lea addresses_normal_ht+0xa55, %r10
nop
nop
nop
nop
...
nop
xor $589, %r11
lea addresses_WC_ht+0x1a2b1, %rsi
lea addresses_normal_ht+0x19d05, %rdi
nop
nop
nop
and $43491, %rbp
...
nop
cmp $53161, %r11
lea addresses_WT_ht+0x148b1, %r10
nop
nop
nop
nop
...
lea addresses_WC_ht+0x1df99, %rdi
nop
nop
nop
add %rbp, %rbp
...
// Store
lea addresses_WC+0x11ab1, %rbp
and $52715, %r10
movl $0x51525354, (%rbp)
sub $22967, %rbp

// Store
lea addresses_A+0x158b1, %rbp
nop
nop
nop
nop
