...
push %rdi
push %rsi
lea addresses_A_ht+0x1d1f0, %rbx
inc %r10
movl $0x61626364, (%rbx)
nop
nop
dec %rbx
lea addresses_WT_ht+0xbcbc, %rsi
lea addresses_D_ht+0x124bc, %rdi
clflush (%rsi)
nop
nop
nop
...
rep movsl
inc %rsi
lea addresses_normal_ht+0x2efc, %r10
nop
nop
nop
nop
...
nop
xor $50622, %rdi
lea addresses_WC_ht+0xcabc, %rcx
nop
nop
nop
nop
...
nop
add $19851, %r8
lea addresses_UC_ht+0xc6bc, %rsi
nop
sub %rcx, %rcx
mov (%rsi), %edi
add $3485, %rcx
lea addresses_normal_ht+0xee1c, %rax
nop
nop
nop
nop
...
nop
add $40385, %rdi
lea addresses_WT_ht+0x1ebc, %rsi
clflush (%rsi)
nop
nop
nop
...
nop
cmp %r8, %r8
lea addresses_WT_ht+0xebc, %rsi
lea addresses_WT_ht+0x18d9c, %rdi
and $60195, %r8
mov $110, %rcx
rep movsl
nop
add $4492, %r8
lea addresses_UC_ht+0xeac, %rbx
nop
nop
nop
nop
...
nop
sub %r8, %r8
lea addresses_normal_ht+0x2ebc, %rdi
nop
nop
nop
dec %rbx
...
nop
and $59866, %rax
lea addresses_normal_ht+0x629c, %rcx
add $8692, %rsi
vmovups (%rcx), %ymm2
...
// Store
lea addresses_A+0x1d8bc, %rbx
add %r12, %r12
movl $0x51525354, (%rbx)
add $45901, %r12

// Faulty Load
lea addresses_WT+0x1debc, %rdx
nop
nop
xor $22905, %r13
mov (%rdx), %r15d
...
{'OP': 'LOAD', 'src': {'type': 'addresses_normal_ht', 'AVXalign': False, 'congruent': 4, 'size': 2, 'same': False, 'NT': False}}
