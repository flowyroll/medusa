...
push %rdi
push %rsi
lea addresses_WC_ht+0x19913, %rsi
lea addresses_UC_ht+0x2a1a, %rdi
nop
nop
inc %r12
mov $30, %rcx
...
nop
xor %r15, %r15
lea addresses_D_ht+0x17139, %r10
nop
nop
sub %r8, %r8
movb (%r10), %cl
...
nop
sub $2193, %r8
lea addresses_normal_ht+0x4839, %rsi
lea addresses_A_ht+0x166bb, %rdi
nop
nop
nop
nop
...
nop
sub $16380, %rsi
lea addresses_WT_ht+0x10485, %rsi
cmp $18526, %r15
movb $0x61, (%rsi)
nop
sub $36119, %r12
lea addresses_A_ht+0x13ed9, %r8
nop
nop
nop
and %rcx, %rcx
...
nop
add %r10, %r10
lea addresses_WC_ht+0x35a9, %rsi
lea addresses_WT_ht+0x918d, %rdi
nop
xor $27667, %r13
mov $78, %rcx
rep movsb
...
nop
cmp %rsi, %rsi
lea addresses_WC_ht+0x16679, %r15
nop
nop
sub %r10, %r10
movb $0x61, (%r15)
nop
and $30347, %r10
lea addresses_WC_ht+0xd0e9, %rsi
nop
and $23011, %r15
movl $0x61626364, (%rsi)
nop
...
// Store
lea addresses_normal+0xe55c, %r14
nop
nop
cmp $64039, %r9
...
{'OP': 'STOR', 'dst': {'type': 'addresses_WT', 'AVXalign': False, 'congruent': 0, 'size': 16, 'same': True, 'NT': False}}
...
{'OP': 'REPM', 'src': {'type': 'addresses_normal_ht', 'congruent': 9, 'same': False}, 'dst': {'type': 'addresses_A_ht', 'congruent': 1, 'same': True}}
