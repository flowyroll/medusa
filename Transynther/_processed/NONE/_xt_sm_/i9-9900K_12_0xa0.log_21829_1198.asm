...
push %rdx
push %rsi
lea addresses_normal_ht+0x56f8, %r13
and %r15, %r15
movw $0x6162, (%r13)
nop
nop
sub $63015, %rsi
lea addresses_WC_ht+0x1d81, %rsi
lea addresses_D_ht+0xa72, %rdi
nop
cmp $42476, %rdx
mov $58, %rcx
rep movsb
...
{'src': {'same': True, 'congruent': 0, 'type': 'addresses_WC_ht'}, 'OP': 'REPM', 'dst': {'same': True, 'congruent': 0, 'type': 'addresses_D_ht'}}
{'58': 21829}
