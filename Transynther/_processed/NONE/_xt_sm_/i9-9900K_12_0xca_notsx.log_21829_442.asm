...
push %rdi
push %rsi
lea addresses_WT_ht+0xebaf, %rsi
nop
nop
nop
nop
...
nop
add %rcx, %rcx
lea addresses_A_ht+0x13fa7, %rdi
clflush (%rdi)
nop
nop
nop
...
nop
sub $64124, %rdi
lea addresses_A_ht+0xcfb9, %rsi
lea addresses_WT_ht+0x1caa7, %rdi
inc %r10
mov $88, %rcx
rep movsl
nop
and $32014, %r10
lea addresses_WT_ht+0x807, %rdi
nop
nop
nop
nop
...
nop
sub %rbx, %rbx
lea addresses_normal_ht+0x1e7f4, %r10
xor %r15, %r15
movups (%r10), %xmm5
vpextrq $0, %xmm5, %rsi
nop
...
nop
inc %rcx
lea addresses_normal_ht+0x1b2a7, %rdi
nop
xor %rbx, %rbx
movb (%rdi), %r10b
nop
...
// Store
lea addresses_normal+0x1f2a7, %rdx
nop
nop
nop
nop
...
// Store
lea addresses_normal+0x1f2a7, %rdi
nop
nop
nop
nop
...
// REPMOV
lea addresses_UC+0x9aa7, %rsi
lea addresses_WT+0x10d0f, %rdi
clflush (%rsi)
nop
cmp $14325, %r12
mov $34, %rcx
...
// Faulty Load
lea addresses_normal+0x1f2a7, %r8
nop
nop
xor $44659, %rdx
mov (%r8), %rbp
...
{'OP': 'REPM', 'src': {'same': False, 'congruent': 11, 'type': 'addresses_UC'}, 'dst': {'same': False, 'congruent': 3, 'type': 'addresses_WT'}}
[Faulty Load]
...
{'OP': 'REPM', 'src': {'same': False, 'congruent': 0, 'type': 'addresses_A_ht'}, 'dst': {'same': True, 'congruent': 11, 'type': 'addresses_WT_ht'}}
...
{'OP': 'REPM', 'src': {'same': True, 'congruent': 9, 'type': 'addresses_D_ht'}, 'dst': {'same': False, 'congruent': 5, 'type': 'addresses_WT_ht'}}
