...
nop
cmp %r13, %r13
lea addresses_A_ht+0x1e906, %rax
clflush (%rax)
nop
xor $33561, %rdi
vmovups (%rax), %ymm4
...
nop
sub %rsi, %rsi
lea addresses_A_ht+0x1d2c6, %rdi
nop
xor %r13, %r13
mov (%rdi), %rsi
nop
...
nop
and %rdi, %rdi
lea addresses_WC_ht+0x5906, %rsi
nop
nop
dec %r8
movw $0x6162, (%rsi)
...
nop
cmp %r13, %r13
lea addresses_UC_ht+0x1a5c6, %rsi
lea addresses_WT_ht+0xf97e, %rdi
clflush (%rdi)
nop
nop
nop
...
{'OP': 'STOR', 'dst': {'type': 'addresses_A', 'AVXalign': True, 'congruent': 0, 'size': 4, 'same': True, 'NT': False}}
[Faulty Load]
...
{'OP': 'STOR', 'dst': {'type': 'addresses_WC_ht', 'AVXalign': False, 'congruent': 1, 'size': 32, 'same': True, 'NT': False}}
