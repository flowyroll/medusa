...
push %rdi
push %rsi
lea addresses_D_ht+0x12749, %r13
nop
nop
nop
nop
...
nop
and $62543, %rax
lea addresses_WC_ht+0x128cd, %rax
nop
nop
nop
nop
...
nop
add %r14, %r14
lea addresses_normal_ht+0x3919, %rsi
nop
nop
nop
nop
...
nop
cmp $1197, %rbp
lea addresses_D_ht+0x1e853, %rax
clflush (%rax)
nop
sub %r13, %r13
movw $0x6162, (%rax)
...
{'src': {'same': False, 'congruent': 4, 'NT': False, 'type': 'addresses_A', 'size': 16, 'AVXalign': False}, 'OP': 'LOAD'}
