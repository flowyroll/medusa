...
push %rdi
push %rsi
lea addresses_A_ht+0x18290, %r12
nop
nop
nop
nop
...
nop
xor %r9, %r9
lea addresses_WC_ht+0x13896, %rsi
lea addresses_WT_ht+0x7d30, %rdi
nop
and %r8, %r8
mov $88, %rcx
rep movsl
...
nop
xor %r8, %r8
lea addresses_WC_ht+0x17790, %r9
clflush (%r9)
nop
nop
nop
...
nop
and $28602, %rdi
lea addresses_UC_ht+0x7900, %r12
xor $7932, %rbp
movw $0x6162, (%r12)
add %rcx, %rcx
lea addresses_normal_ht+0x176f0, %r9
nop
nop
dec %r8
...
nop
cmp %r12, %r12
lea addresses_normal_ht+0x15e90, %rcx
clflush (%rcx)
nop
nop
nop
...
{'src': {'type': 'addresses_WC_ht', 'congruent': 1, 'same': False}, 'OP': 'REPM', 'dst': {'type': 'addresses_WT_ht', 'congruent': 4, 'same': True}}
{'OP': 'STOR', 'dst': {'same': False, 'congruent': 8, 'NT': False, 'type': 'addresses_WC_ht', 'size': 4, 'AVXalign': True}}
