...
push %rdi
push %rsi
lea addresses_WT_ht+0xada5, %rbx
nop
and %rsi, %rsi
...
nop
add $64720, %r14
lea addresses_D_ht+0x17105, %r15
nop
nop
mfence
movups (%r15), %xmm4
vpextrq $0, %xmm4, %r12
xor %rbx, %rbx
lea addresses_UC_ht+0xcfa5, %r15
add %rsi, %rsi
mov (%r15), %r13d
nop
nop
...
{'OP': 'STOR', 'dst': {'size': 1, 'NT': False, 'type': 'addresses_WT', 'same': True, 'AVXalign': True, 'congruent': 0}}
[Faulty Load]
