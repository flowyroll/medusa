...
nop
xor $35263, %rdx
lea addresses_WC_ht+0x166d9, %rbp
nop
nop
nop
nop
...
nop
add $63033, %rbp
lea addresses_WT_ht+0x108b, %rsi
lea addresses_normal_ht+0xfaf9, %rdi
clflush (%rsi)
nop
nop
nop
...
rep movsq
xor $31925, %rcx
lea addresses_WT_ht+0xece9, %r13
nop
cmp $44776, %rbp
movups (%r13), %xmm2
vpextrq $1, %xmm2, %rdx
...
nop
xor %rax, %rax
lea addresses_UC_ht+0xd325, %r13
nop
nop
nop
nop
...
nop
cmp $41087, %rax
lea addresses_D_ht+0x1e6d9, %rsi
lea addresses_D_ht+0x32d9, %rdi
and %rdx, %rdx
mov $32, %rcx
rep movsl
cmp $26336, %rdi
lea addresses_UC_ht+0x1be1f, %rbp
nop
nop
nop
nop
...
nop
sub $59748, %r13
lea addresses_UC_ht+0x3599, %r13
nop
add $51129, %r10
...
vmovups %ymm3, (%r13)
add %rsi, %rsi
lea addresses_WT_ht+0x1c839, %r10
nop
nop
nop
sub %rsi, %rsi
movw $0x6162, (%r10)
sub %r13, %r13
lea addresses_WT_ht+0x1aaf1, %rcx
clflush (%rcx)
nop
nop
sub $41343, %rsi
...
nop
xor %r10, %r10
lea addresses_WT_ht+0x16581, %rdi
sub $57611, %rdx
movb $0x61, (%rdi)
nop
nop
add $60368, %r13
lea addresses_normal_ht+0xf439, %rsi
nop
nop
nop
nop
...
{'OP': 'STOR', 'dst': {'type': 'addresses_A', 'AVXalign': False, 'congruent': 3, 'size': 8, 'same': True, 'NT': False}}
{'OP': 'STOR', 'dst': {'type': 'addresses_UC', 'AVXalign': True, 'congruent': 0, 'size': 2, 'same': True, 'NT': False}}
{'OP': 'STOR', 'dst': {'type': 'addresses_D', 'AVXalign': True, 'congruent': 8, 'size': 8, 'same': False, 'NT': False}}
{'OP': 'STOR', 'dst': {'type': 'addresses_D', 'AVXalign': False, 'congruent': 6, 'size': 32, 'same': False, 'NT': False}}
{'OP': 'LOAD', 'src': {'type': 'addresses_RW', 'AVXalign': False, 'congruent': 7, 'size': 4, 'same': False, 'NT': False}}
[Faulty Load]
...
{'OP': 'LOAD', 'src': {'type': 'addresses_normal_ht', 'AVXalign': True, 'congruent': 1, 'size': 32, 'same': False, 'NT': True}}
{'52': 21829}
