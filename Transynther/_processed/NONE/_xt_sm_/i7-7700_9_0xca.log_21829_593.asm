...
nop
dec %rbp
lea addresses_UC_ht+0x176dd, %rsi
lea addresses_normal_ht+0x172f5, %rdi
nop
nop
dec %r15
mov $57, %rcx
rep movsb
add %rdi, %rdi
lea addresses_WC_ht+0x16a35, %rsi
lea addresses_A_ht+0x198f5, %rdi
nop
nop
nop
add $28067, %r9
...
nop
xor %r12, %r12
lea addresses_A_ht+0x15aeb, %rcx
nop
nop
nop
nop
...
nop
and %r12, %r12
lea addresses_A_ht+0x18e75, %rsi
lea addresses_WC_ht+0xda24, %rdi
clflush (%rdi)
nop
nop
nop
...
nop
add %rbp, %rbp
lea addresses_D_ht+0x17075, %rsi
nop
nop
nop
nop
...
nop
sub $38553, %rcx
lea addresses_WT_ht+0x1daf5, %r15
nop
dec %rsi
movb (%r15), %r12b
nop
xor %r15, %r15
lea addresses_normal_ht+0x152f5, %rsi
lea addresses_WC_ht+0x1ce01, %rdi
nop
nop
nop
nop
...
rep movsl
add $48958, %rcx
lea addresses_A_ht+0x140f5, %rbp
cmp %rdi, %rdi
mov (%rbp), %r15w
nop
nop
...
// Store
lea addresses_normal+0x12ef5, %rsi
nop
nop
nop
cmp $33481, %r8
...
// Faulty Load
lea addresses_normal+0x12ef5, %r14
nop
nop
nop
nop
...
{'src': {'congruent': 2, 'same': True, 'type': 'addresses_UC_ht'}, 'OP': 'REPM', 'dst': {'congruent': 10, 'same': False, 'type': 'addresses_normal_ht'}}
...
{'OP': 'STOR', 'dst': {'congruent': 7, 'AVXalign': False, 'same': True, 'size': 1, 'NT': False, 'type': 'addresses_D_ht'}}
{'src': {'congruent': 8, 'AVXalign': False, 'same': False, 'size': 1, 'NT': False, 'type': 'addresses_WT_ht'}, 'OP': 'LOAD'}
{'src': {'congruent': 9, 'same': False, 'type': 'addresses_normal_ht'}, 'OP': 'REPM', 'dst': {'congruent': 2, 'same': False, 'type': 'addresses_WC_ht'}}
{'src': {'congruent': 8, 'AVXalign': False, 'same': False, 'size': 2, 'NT': True, 'type': 'addresses_A_ht'}, 'OP': 'LOAD'}
{'52': 21829}
