...
push %rdi
push %rsi
lea addresses_A_ht+0x1b720, %r10
nop
nop
nop
add $11629, %r14
...
nop
add $28366, %rbp
lea addresses_UC_ht+0x5c98, %rsi
lea addresses_A_ht+0x16d20, %rdi
nop
xor %r9, %r9
mov $123, %rcx
rep movsl
...
nop
inc %rcx
lea addresses_UC_ht+0x15d88, %rsi
lea addresses_WT_ht+0xa420, %rdi
nop
add %rax, %rax
mov $4, %rcx
rep movsw
...
nop
cmp $62116, %r10
lea addresses_WT_ht+0x19320, %r9
nop
nop
nop
nop
...
nop
dec %r9
lea addresses_WT_ht+0xa720, %rax
nop
nop
nop
nop
...
nop
dec %r9
lea addresses_A_ht+0xa660, %r14
clflush (%r14)
cmp $51726, %r10
movw $0x6162, (%r14)
nop
sub $45998, %r9
lea addresses_UC_ht+0xb5c0, %rbp
nop
nop
nop
cmp $29438, %r9
...
nop
xor $23233, %rdi
lea addresses_normal_ht+0x1af20, %rsi
lea addresses_WC_ht+0xb8c6, %rdi
sub %r10, %r10
mov $56, %rcx
rep movsb
nop
...
nop
and %r14, %r14
lea addresses_normal_ht+0x54dc, %r10
nop
nop
nop
nop
