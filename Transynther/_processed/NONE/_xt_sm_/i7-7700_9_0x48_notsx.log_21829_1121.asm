...
push %rdi
push %rsi
lea addresses_WT_ht+0xfd7c, %rsi
lea addresses_WC_ht+0x1364c, %rdi
nop
nop
nop
xor $59696, %rax
...
lea addresses_D_ht+0x1310c, %rdi
nop
inc %rbx
mov $16, %rcx
rep movsq
sub %rsi, %rsi
lea addresses_WT_ht+0x96c, %rdi
nop
nop
dec %r8
mov (%rdi), %ebx
...
{'dst': {'same': True, 'NT': False, 'AVXalign': True, 'size': 4, 'type': 'addresses_UC', 'congruent': 0}, 'OP': 'STOR'}
[Faulty Load]
{'OP': 'LOAD', 'src': {'same': True, 'NT': False, 'AVXalign': False, 'size': 1, 'type': 'addresses_UC', 'congruent': 0}}
<gen_prepare_buffer>
{'dst': {'same': False, 'congruent': 5, 'type': 'addresses_WC_ht'}, 'OP': 'REPM', 'src': {'same': False, 'congruent': 0, 'type': 'addresses_WT_ht'}}
