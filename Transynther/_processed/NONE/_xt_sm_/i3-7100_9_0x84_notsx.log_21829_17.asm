...
push %rdx
push %rsi
lea addresses_A_ht+0x19466, %rax
sub %rsi, %rsi
movups (%rax), %xmm4
vpextrq $1, %xmm4, %rdx
nop
...
nop
xor $40375, %rsi
lea addresses_D_ht+0x1c2b3, %rdx
and $48235, %rbp
mov (%rdx), %r11d
nop
nop
...
nop
sub $50960, %rax
lea addresses_A_ht+0x43e7, %rsi
lea addresses_D_ht+0xee07, %rdi
nop
nop
nop
nop
...
nop
and $43312, %r11
lea addresses_WC_ht+0x3112, %rdi
nop
sub %rsi, %rsi
movups (%rdi), %xmm6
vpextrq $1, %xmm6, %r10
...
// Store
lea addresses_normal+0xa007, %r14
nop
mfence
...
// Store
lea addresses_normal+0xa007, %rsi
xor %r14, %r14
mov $0x5152535455565758, %r11
movq %r11, %xmm2
vmovups %ymm2, (%rsi)
...
// Faulty Load
lea addresses_normal+0xa007, %rbx
nop
nop
nop
dec %r15
