...
push %rax
push %rbp
lea addresses_normal_ht+0x554d, %r9
nop
nop
dec %r11
movl $0x61626364, (%r9)
...
{'OP': 'STOR', 'dst': {'same': False, 'congruent': 9, 'NT': True, 'type': 'addresses_D', 'size': 1, 'AVXalign': False}}
{'src': {'same': False, 'congruent': 8, 'NT': False, 'type': 'addresses_UC', 'size': 4, 'AVXalign': False}, 'OP': 'LOAD'}
[Faulty Load]
