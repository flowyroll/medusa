...
nop
xor %rbx, %rbx
lea addresses_WT_ht+0x1d1eb, %rsi
lea addresses_A_ht+0xb43b, %rdi
nop
nop
nop
nop
...
nop
add %r13, %r13
lea addresses_WT_ht+0x557b, %r13
nop
inc %r14
mov (%r13), %di
and $22366, %r14
lea addresses_UC_ht+0x16b3a, %rsi
lea addresses_D_ht+0x19bbb, %rdi
nop
nop
dec %r9
mov $0, %rcx
...
nop
sub $43227, %rcx
lea addresses_normal_ht+0x7361, %rdi
nop
nop
nop
nop
...
{'OP': 'REPM', 'src': {'same': True, 'congruent': 4, 'type': 'addresses_WT_ht'}, 'dst': {'same': False, 'congruent': 8, 'type': 'addresses_A_ht'}}
{'OP': 'LOAD', 'src': {'same': False, 'type': 'addresses_WT_ht', 'NT': False, 'AVXalign': False, 'size': 2, 'congruent': 6}}
{'OP': 'REPM', 'src': {'same': True, 'congruent': 0, 'type': 'addresses_UC_ht'}, 'dst': {'same': False, 'congruent': 6, 'type': 'addresses_D_ht'}}
