...
push %rdi
push %rsi
lea addresses_D_ht+0x1cb55, %r11
nop
nop
nop
nop
...
nop
xor %rcx, %rcx
lea addresses_UC_ht+0x1bad1, %r11
nop
nop
nop
nop
...
nop
xor %rbx, %rbx
lea addresses_D_ht+0x1b6d1, %rsi
lea addresses_normal_ht+0x6d41, %rdi
add $57816, %r9
mov $44, %rcx
rep movsq
nop
...
nop
cmp $56703, %rbx
lea addresses_D_ht+0x1acb1, %rsi
lea addresses_WT_ht+0x7ffd, %rdi
cmp $33171, %r15
mov $72, %rcx
rep movsl
nop
sub %r13, %r13
lea addresses_WC_ht+0x14ed1, %rsi
lea addresses_A_ht+0x9fd1, %rdi
dec %rbx
mov $62, %rcx
rep movsw
nop
...
// REPMOV
lea addresses_UC+0x20d1, %rsi
lea addresses_A+0x16ad1, %rdi
nop
nop
nop
sub $2016, %r9
...
{'src': {'type': 'addresses_UC', 'congruent': 9, 'same': False}, 'dst': {'type': 'addresses_A', 'congruent': 10, 'same': False}, 'OP': 'REPM'}
[Faulty Load]
