...
push %rdi
push %rsi
lea addresses_WC_ht+0x1b45, %r15
nop
nop
nop
xor $22977, %r14
...
nop
add %r15, %r15
lea addresses_normal_ht+0x6045, %rdi
clflush (%rdi)
xor %rbx, %rbx
movb $0x61, (%rdi)
nop
dec %r9
lea addresses_UC_ht+0x191c5, %rsi
lea addresses_D_ht+0x2aab, %rdi
clflush (%rsi)
clflush (%rdi)
nop
nop
...
nop
sub $9828, %rcx
lea addresses_normal_ht+0x5d39, %rsi
lea addresses_WT_ht+0x11845, %rdi
and %rbp, %rbp
mov $19, %rcx
rep movsl
nop
nop
add %rcx, %rcx
lea addresses_A_ht+0x405, %rsi
lea addresses_A_ht+0x1a445, %rdi
nop
nop
nop
nop
...
rep movsw
sub %r14, %r14
lea addresses_WT_ht+0x1a5dd, %rsi
lea addresses_WT_ht+0x8445, %rdi
clflush (%rsi)
nop
nop
nop
...
{'OP': 'REPM', 'src': {'type': 'addresses_normal_ht', 'congruent': 2, 'same': False}, 'dst': {'type': 'addresses_WT_ht', 'congruent': 9, 'same': True}}
{'OP': 'REPM', 'src': {'type': 'addresses_A_ht', 'congruent': 3, 'same': True}, 'dst': {'type': 'addresses_A_ht', 'congruent': 8, 'same': False}}
