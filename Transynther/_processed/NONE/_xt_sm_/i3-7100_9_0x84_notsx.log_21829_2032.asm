...
nop
and $21734, %rdi
lea addresses_WC_ht+0xc373, %rsi
lea addresses_WT_ht+0x1143, %rdi
nop
nop
nop
xor %rbp, %rbp
...
nop
xor %rdi, %rdi
lea addresses_normal_ht+0x52c3, %rcx
nop
nop
nop
nop
...
// Load
lea addresses_RW+0x2143, %r10
add %rbp, %rbp
mov (%r10), %rdx
add $42321, %r10

// Store
lea addresses_D+0x1f143, %rdx
nop
add %rcx, %rcx
movb $0x51, (%rdx)
nop
...
{'src': {'type': 'addresses_D_ht', 'same': True, 'size': 32, 'congruent': 11, 'NT': True, 'AVXalign': False}, 'OP': 'LOAD'}
