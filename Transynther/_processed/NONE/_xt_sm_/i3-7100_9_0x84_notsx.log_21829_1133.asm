...
vpextrq $0, %xmm6, %rax
inc %r15
lea addresses_D_ht+0x1e5d2, %rsi
lea addresses_WT_ht+0xbc92, %rdi
nop
nop
nop
nop
...
nop
cmp $27721, %r8
lea addresses_WT_ht+0x1d92, %rsi
lea addresses_UC_ht+0x903e, %rdi
nop
nop
xor $1388, %r11
mov $121, %rcx
...
nop
add %rax, %rax
lea addresses_WT_ht+0x16bfe, %rsi
lea addresses_normal_ht+0x12d92, %rdi
sub $12385, %r13
mov $51, %rcx
rep movsw
nop
...
// REPMOV
lea addresses_D+0xc592, %rsi
lea addresses_UC+0x4292, %rdi
clflush (%rsi)
xor $31205, %rax
mov $9, %rcx
rep movsw
...
{'src': {'type': 'addresses_D', 'congruent': 0, 'same': True}, 'dst': {'type': 'addresses_UC', 'congruent': 7, 'same': False}, 'OP': 'REPM'}
[Faulty Load]
...
{'src': {'type': 'addresses_D_ht', 'congruent': 5, 'same': False}, 'dst': {'type': 'addresses_WT_ht', 'congruent': 7, 'same': False}, 'OP': 'REPM'}
