...
nop
xor $21584, %rdi
lea addresses_normal_ht+0x133b5, %rsi
lea addresses_D_ht+0xa9d1, %rdi
clflush (%rsi)
xor %r11, %r11
mov $55, %rcx
rep movsw
xor $41921, %rdi
lea addresses_normal_ht+0xe7b9, %rdx
nop
nop
nop
nop
...
movb $0x61, (%rdx)
dec %rcx
lea addresses_A_ht+0x10871, %rsi
nop
nop
nop
nop
...
nop
cmp %r15, %r15
lea addresses_WT_ht+0xdf15, %rsi
lea addresses_normal_ht+0x7f91, %rdi
nop
nop
nop
nop
...
nop
cmp $40373, %rcx
lea addresses_WC_ht+0x1a3f9, %rsi
lea addresses_A_ht+0xcaa1, %rdi
clflush (%rdi)
nop
nop
nop
...
{'src': {'type': 'addresses_P', 'same': False, 'size': 32, 'congruent': 2, 'NT': False, 'AVXalign': False}, 'OP': 'LOAD'}
...
{'src': {'type': 'addresses_normal_ht', 'congruent': 0, 'same': False}, 'dst': {'type': 'addresses_D_ht', 'congruent': 6, 'same': False}, 'OP': 'REPM'}
...
{'src': {'type': 'addresses_WC_ht', 'congruent': 3, 'same': False}, 'dst': {'type': 'addresses_A_ht', 'congruent': 3, 'same': False}, 'OP': 'REPM'}
