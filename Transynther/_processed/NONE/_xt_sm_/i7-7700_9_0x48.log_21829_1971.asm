...
push %rdi
push %rsi
lea addresses_WC_ht+0x4a4e, %rbx
nop
nop
nop
nop
...
nop
add $33406, %rbx
lea addresses_WC_ht+0xff4e, %rsi
lea addresses_WT_ht+0x1554e, %rdi
nop
add %r8, %r8
mov $60, %rcx
rep movsb
...
nop
inc %r8
lea addresses_A_ht+0x3546, %rsi
lea addresses_normal_ht+0x904e, %rdi
add %r12, %r12
mov $127, %rcx
rep movsw
nop
dec %rbx
lea addresses_UC_ht+0x123ce, %rsi
lea addresses_UC_ht+0xea4e, %rdi
nop
nop
cmp %r10, %r10
mov $77, %rcx
...
nop
and %rdi, %rdi
lea addresses_D_ht+0xd96e, %r12
inc %rbx
mov (%r12), %r10d
nop
inc %rbx
lea addresses_WT_ht+0x344e, %rsi
nop
nop
xor %rcx, %rcx
...
nop
and $58596, %r10
lea addresses_normal_ht+0x244e, %rsi
...
{'OP': 'REPM', 'src': {'type': 'addresses_WC_ht', 'congruent': 5, 'same': True}, 'dst': {'type': 'addresses_WT_ht', 'congruent': 7, 'same': False}}
{'OP': 'REPM', 'src': {'type': 'addresses_A_ht', 'congruent': 3, 'same': False}, 'dst': {'type': 'addresses_normal_ht', 'congruent': 6, 'same': False}}
{'OP': 'REPM', 'src': {'type': 'addresses_UC_ht', 'congruent': 7, 'same': False}, 'dst': {'type': 'addresses_UC_ht', 'congruent': 9, 'same': False}}
{'OP': 'LOAD', 'src': {'type': 'addresses_D_ht', 'AVXalign': True, 'congruent': 4, 'size': 4, 'same': False, 'NT': False}}
