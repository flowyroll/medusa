...
push %rdi
push %rsi
lea addresses_WC_ht+0x9447, %r15
nop
nop
cmp $32977, %r13
...
nop
cmp %r10, %r10
lea addresses_UC_ht+0x19ceb, %r8
nop
nop
nop
nop
...
nop
xor $28015, %r10
lea addresses_WC_ht+0x5a83, %r11
nop
nop
nop
nop
...
nop
inc %r15
lea addresses_D_ht+0x1c4c3, %rsi
lea addresses_normal_ht+0xbf63, %rdi
nop
nop
nop
nop
...
{'dst': {'same': False, 'congruent': 4, 'type': 'addresses_normal_ht'}, 'OP': 'REPM', 'src': {'same': False, 'congruent': 5, 'type': 'addresses_D_ht'}}
{'58': 21829}
