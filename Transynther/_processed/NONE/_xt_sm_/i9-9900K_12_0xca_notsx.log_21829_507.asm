...
push %rdi
push %rsi
lea addresses_normal_ht+0x86c0, %r8
nop
nop
nop
sub $43946, %rax
...
nop
xor $14312, %rsi
lea addresses_WC_ht+0xd8a0, %rax
nop
nop
nop
nop
...
nop
cmp $35568, %rcx
lea addresses_WT_ht+0xa540, %rsi
lea addresses_WC_ht+0x182ec, %rdi
add $40281, %rbp
mov $112, %rcx
rep movsw
nop
...
{'OP': 'LOAD', 'src': {'same': False, 'type': 'addresses_PSE', 'NT': False, 'AVXalign': False, 'size': 2, 'congruent': 10}}
{'OP': 'STOR', 'dst': {'same': False, 'type': 'addresses_PSE', 'NT': False, 'AVXalign': True, 'size': 32, 'congruent': 6}}
{'OP': 'STOR', 'dst': {'same': True, 'type': 'addresses_D', 'NT': False, 'AVXalign': False, 'size': 8, 'congruent': 0}}
{'OP': 'STOR', 'dst': {'same': False, 'type': 'addresses_P', 'NT': False, 'AVXalign': True, 'size': 2, 'congruent': 5}}
[Faulty Load]
...
{'OP': 'REPM', 'src': {'same': False, 'congruent': 0, 'type': 'addresses_A_ht'}, 'dst': {'same': False, 'congruent': 2, 'type': 'addresses_A_ht'}}
