...
lea addresses_D_ht+0x12aaf, %rdi
clflush (%rdi)
nop
nop
add $58110, %rbx
...
rep movsl
add $61703, %rsi
lea addresses_WT_ht+0x1262f, %r15
nop
nop
nop
nop
...
// Store
lea addresses_normal+0x19aaf, %r8
nop
nop
nop
nop
...
{'OP': 'STOR', 'dst': {'type': 'addresses_RW', 'AVXalign': True, 'congruent': 0, 'size': 4, 'same': True, 'NT': True}}
[Faulty Load]
