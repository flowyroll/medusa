...
push %rdi
push %rsi
lea addresses_UC_ht+0xb73d, %r13
nop
nop
and $3283, %rdi
vmovups (%r13), %ymm2
...
nop
add %r9, %r9
lea addresses_WC_ht+0x15559, %r13
nop
nop
cmp %rbx, %rbx
...
nop
and %rbp, %rbp
lea addresses_WT_ht+0x13abd, %rbp
nop
add %r12, %r12
...
nop
sub $65513, %rbp
lea addresses_WC_ht+0x1483d, %r12
cmp %rbp, %rbp
vmovups (%r12), %ymm2
vextracti128 $1, %ymm2, %xmm2
vpextrq $1, %xmm2, %r13
sub %r9, %r9
lea addresses_normal_ht+0xd15a, %rsi
lea addresses_A_ht+0xd5a5, %rdi
nop
nop
nop
nop
...
nop
add %rcx, %rcx
lea addresses_A_ht+0x1563d, %r12
sub $57348, %rbx
movl $0x61626364, (%r12)
nop
nop
...
nop
xor %r9, %r9
lea addresses_WC_ht+0x19071, %r9
add $30132, %rdi
movb (%r9), %bl
nop
nop
...
{'OP': 'LOAD', 'src': {'size': 2, 'NT': False, 'type': 'addresses_P', 'same': False, 'AVXalign': False, 'congruent': 2}}
{'OP': 'STOR', 'dst': {'size': 1, 'NT': False, 'type': 'addresses_RW', 'same': False, 'AVXalign': True, 'congruent': 7}}
...
{'OP': 'REPM', 'src': {'same': False, 'type': 'addresses_normal_ht', 'congruent': 0}, 'dst': {'same': False, 'type': 'addresses_A_ht', 'congruent': 3}}
