...
push %rdx
push %rsi
lea addresses_A_ht+0xe8c6, %rsi
lea addresses_UC_ht+0x1b9c6, %rdi
sub %r13, %r13
mov $126, %rcx
rep movsl
inc %rbx
lea addresses_normal_ht+0x184ae, %rsi
lea addresses_D_ht+0x23e6, %rdi
nop
nop
nop
nop
...
nop
sub $52337, %r13
lea addresses_WT_ht+0x145c6, %rax
nop
nop
nop
nop
...
nop
add %rdi, %rdi
lea addresses_WT_ht+0x1b9c6, %rsi
...
nop
and $42334, %rcx
lea addresses_normal_ht+0x1e1c6, %rdx
nop
nop
nop
nop
...
nop
dec %rdi
lea addresses_WT_ht+0x277c, %rsi
lea addresses_normal_ht+0x1c3c6, %rdi
nop
cmp %rax, %rax
mov $12, %rcx
rep movsq
nop
dec %rdx
lea addresses_D_ht+0x14006, %rsi
lea addresses_WC_ht+0x6fd6, %rdi
nop
nop
sub %rdx, %rdx
mov $61, %rcx
...
lea addresses_WC_ht+0xf9c6, %rdi
nop
nop
nop
nop
...
nop
cmp %r10, %r10
lea addresses_WC_ht+0x101c6, %rdi
nop
nop
nop
nop
...
nop
and %rsi, %rsi
lea addresses_A_ht+0x13b86, %rbx
nop
nop
add %rdi, %rdi
movb (%rbx), %cl
...
// Store
lea addresses_normal+0x169c6, %r10
nop
xor %r9, %r9
movl $0x51525354, (%r10)
nop
...
// Faulty Load
lea addresses_normal+0x169c6, %rax
nop
nop
cmp $61070, %r9
mov (%rax), %r14d
...
{'src': {'congruent': 9, 'same': False, 'type': 'addresses_WT_ht'}, 'OP': 'REPM', 'dst': {'congruent': 0, 'same': False, 'type': 'addresses_A_ht'}}
{'src': {'congruent': 9, 'AVXalign': False, 'same': True, 'size': 8, 'NT': False, 'type': 'addresses_normal_ht'}, 'OP': 'LOAD'}
{'src': {'congruent': 1, 'same': False, 'type': 'addresses_WT_ht'}, 'OP': 'REPM', 'dst': {'congruent': 9, 'same': False, 'type': 'addresses_normal_ht'}}
{'src': {'congruent': 5, 'same': False, 'type': 'addresses_D_ht'}, 'OP': 'REPM', 'dst': {'congruent': 3, 'same': False, 'type': 'addresses_WC_ht'}}
{'src': {'congruent': 1, 'same': False, 'type': 'addresses_normal_ht'}, 'OP': 'REPM', 'dst': {'congruent': 10, 'same': False, 'type': 'addresses_WC_ht'}}
...
{'src': {'congruent': 5, 'AVXalign': True, 'same': False, 'size': 1, 'NT': False, 'type': 'addresses_A_ht'}, 'OP': 'LOAD'}
