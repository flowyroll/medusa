...
push %rdx
push %rsi
lea addresses_UC_ht+0xa0fe, %rsi
...
nop
add $22430, %r13
lea addresses_WC_ht+0x82be, %rsi
lea addresses_WC_ht+0x4dfe, %rdi
cmp $30709, %rdx
mov $46, %rcx
rep movsb
nop
...
nop
cmp %r13, %r13
lea addresses_D_ht+0xffa6, %r11
nop
xor $42967, %r9
mov (%r11), %edi
sub $64817, %r13
lea addresses_normal_ht+0xf247, %rdi
nop
nop
nop
xor %r11, %r11
...
nop
inc %rsi
lea addresses_D_ht+0xc0ae, %rsi
lea addresses_A_ht+0x397e, %rdi
clflush (%rdi)
nop
nop
add $3474, %r13
...
nop
sub %rcx, %rcx
lea addresses_WC_ht+0x87fe, %rdi
and $23049, %rcx
movups (%rdi), %xmm0
vpextrq $0, %xmm0, %r13
nop
add %rsi, %rsi
lea addresses_D_ht+0x387e, %r11
clflush (%r11)
cmp %r13, %r13
mov (%r11), %edi
nop
and $35376, %rdi
lea addresses_D_ht+0xd2fe, %r11
nop
nop
nop
nop
...
nop
dec %rdx
lea addresses_WT_ht+0xecbe, %rsi
nop
nop
nop
nop
...
movq %rcx, (%rsi)
add $23861, %r9
lea addresses_WC_ht+0xbd7e, %rsi
nop
nop
nop
and $19914, %r9
...
nop
xor $1708, %r11
lea addresses_A_ht+0x103fe, %rsi
lea addresses_D_ht+0x15766, %rdi
nop
nop
nop
add %rbx, %rbx
...
nop
add %r11, %r11
lea addresses_normal_ht+0x135fe, %r11
nop
nop
nop
nop
...
{'OP': 'STOR', 'dst': {'type': 'addresses_D', 'size': 4, 'AVXalign': False, 'NT': True, 'congruent': 11, 'same': False}}
{'OP': 'STOR', 'dst': {'type': 'addresses_WT', 'size': 4, 'AVXalign': False, 'NT': False, 'congruent': 7, 'same': False}}
{'OP': 'LOAD', 'src': {'type': 'addresses_RW', 'size': 8, 'AVXalign': False, 'NT': False, 'congruent': 1, 'same': False}}
...
{'OP': 'REPM', 'src': {'type': 'addresses_WC_ht', 'congruent': 5, 'same': False}, 'dst': {'type': 'addresses_WC_ht', 'congruent': 7, 'same': False}}
...
{'OP': 'REPM', 'src': {'type': 'addresses_D_ht', 'congruent': 3, 'same': False}, 'dst': {'type': 'addresses_A_ht', 'congruent': 7, 'same': False}}
