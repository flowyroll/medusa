...
push %rdi
push %rsi
lea addresses_A_ht+0x18c95, %r15
nop
nop
nop
nop
...
mov (%r15), %rcx
xor $63432, %r14
lea addresses_WC_ht+0xb495, %rsi
lea addresses_WT_ht+0x77ef, %rdi
nop
xor %r11, %r11
mov $93, %rcx
rep movsw
...
nop
cmp %r15, %r15
lea addresses_normal_ht+0x1e07d, %r15
nop
nop
nop
nop
...
nop
and $49477, %r15
lea addresses_UC_ht+0x3e85, %r14
nop
nop
nop
sub $29898, %r11
...
nop
dec %r11
lea addresses_WC_ht+0x18cd5, %rdi
and $43220, %r14
movl $0x61626364, (%rdi)
nop
inc %r9
lea addresses_D_ht+0x8495, %rsi
lea addresses_UC_ht+0x87d5, %rdi
clflush (%rsi)
clflush (%rdi)
nop
nop
...
nop
add %rdi, %rdi
lea addresses_normal_ht+0x1b695, %rsi
lea addresses_WC_ht+0x1b495, %rdi
nop
nop
cmp %r13, %r13
mov $55, %rcx
...
nop
and $49790, %rsi
lea addresses_WT_ht+0x1b795, %rdi
nop
nop
nop
nop
...
{'OP': 'LOAD', 'src': {'size': 1, 'NT': False, 'type': 'addresses_normal_ht', 'same': True, 'AVXalign': False, 'congruent': 3}}
...
{'OP': 'REPM', 'src': {'same': False, 'type': 'addresses_D_ht', 'congruent': 5}, 'dst': {'same': False, 'type': 'addresses_UC_ht', 'congruent': 6}}
