...
push %rdi
push %rsi
lea addresses_UC_ht+0xa7ca, %rcx
dec %rbp
...
nop
mfence
lea addresses_A_ht+0x93ca, %rsi
lea addresses_normal_ht+0x1efca, %rdi
clflush (%rdi)
add $32091, %r14
mov $19, %rcx
rep movsw
nop
cmp %rsi, %rsi
lea addresses_UC_ht+0xb7ca, %rdi
nop
nop
nop
inc %rax
...
// REPMOV
lea addresses_D+0xd7ca, %rsi
lea addresses_D+0xd7ca, %rdi
nop
sub %r15, %r15
mov $31, %rcx
rep movsl
