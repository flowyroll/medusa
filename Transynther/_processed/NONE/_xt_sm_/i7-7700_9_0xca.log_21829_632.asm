...
push %rdi
push %rsi
lea addresses_WT_ht+0x23ed, %rdi
nop
nop
nop
nop
...
nop
add %rcx, %rcx
lea addresses_UC_ht+0x1a42d, %r8
nop
nop
sub $53856, %r14
mov (%r8), %rdi
nop
add %rcx, %rcx
lea addresses_D_ht+0x1c58d, %rsi
clflush (%rsi)
cmp $39433, %rdi
...
nop
cmp %rdi, %rdi
lea addresses_UC_ht+0x1575, %rsi
lea addresses_UC_ht+0x1d2d, %rdi
nop
nop
nop
cmp %r13, %r13
...
nop
add %rsi, %rsi
lea addresses_UC_ht+0x722d, %rdi
clflush (%rdi)
nop
nop
nop
...
<gen_prepare_buffer>
{'OP': 'STOR', 'dst': {'congruent': 6, 'AVXalign': False, 'same': True, 'size': 16, 'NT': True, 'type': 'addresses_WT_ht'}}
{'src': {'congruent': 10, 'same': False, 'type': 'addresses_UC_ht'}, 'OP': 'REPM', 'dst': {'congruent': 2, 'same': False, 'type': 'addresses_A_ht'}}
{'src': {'congruent': 8, 'AVXalign': True, 'same': False, 'size': 8, 'NT': True, 'type': 'addresses_UC_ht'}, 'OP': 'LOAD'}
