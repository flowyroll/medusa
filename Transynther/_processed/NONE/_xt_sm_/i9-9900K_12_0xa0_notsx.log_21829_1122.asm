...
push %rdx
push %rsi
lea addresses_WT_ht+0x1a1be, %rdx
nop
nop
and $18622, %rsi
mov (%rdx), %r13w
...
nop
inc %rcx
lea addresses_A_ht+0x1efbe, %r13
nop
xor %r8, %r8
movl $0x61626364, (%r13)
nop
nop
dec %r13
lea addresses_normal_ht+0x171be, %r13
nop
nop
nop
nop
...
// REPMOV
lea addresses_normal+0x16fbe, %rsi
lea addresses_WC+0x1a620, %rdi
nop
nop
add $59139, %r9
mov $98, %rcx
...
{'src': {'type': 'addresses_normal', 'congruent': 7, 'same': False}, 'OP': 'REPM', 'dst': {'type': 'addresses_WC', 'congruent': 1, 'same': False}}
...
{'OP': 'STOR', 'dst': {'type': 'addresses_A_ht', 'AVXalign': False, 'size': 4, 'NT': False, 'same': True, 'congruent': 7}}
