...
push %rdi
push %rsi
lea addresses_WC_ht+0x1643b, %rcx
nop
nop
sub %r15, %r15
mov (%rcx), %r10w
...
nop
add %rbp, %rbp
lea addresses_WC_ht+0x19a3b, %r14
nop
nop
nop
xor %rax, %rax
...
nop
cmp %r10, %r10
lea addresses_WC_ht+0x643b, %r15
nop
nop
nop
nop
...
nop
sub $28849, %r15
lea addresses_normal_ht+0x9ed3, %rax
nop
xor $20043, %rbp
movb (%rax), %cl
nop
nop
dec %rax
lea addresses_UC_ht+0x199bc, %r10
xor %r13, %r13
mov $0x6162636465666768, %r14
movq %r14, (%r10)
dec %r15
lea addresses_WC_ht+0x128ba, %r13
add $61602, %r15
vmovups (%r13), %ymm7
...
movups %xmm5, (%r13)
xor %rcx, %rcx
lea addresses_A_ht+0xb0fb, %rsi
lea addresses_WT_ht+0x1ac37, %rdi
nop
nop
nop
nop
...
nop
inc %r10
lea addresses_WT_ht+0x1b870, %r10
nop
nop
nop
inc %rdi
...
// Load
lea addresses_normal+0x1cfb, %r11
nop
add $11869, %rbp
mov (%r11), %si
nop
...
{'OP': 'LOAD', 'src': {'type': 'addresses_normal', 'AVXalign': False, 'congruent': 6, 'size': 2, 'same': False, 'NT': False}}
[Faulty Load]
...
{'OP': 'REPM', 'src': {'type': 'addresses_A_ht', 'congruent': 6, 'same': True}, 'dst': {'type': 'addresses_WT_ht', 'congruent': 2, 'same': False}}
