...
push %rdx
push %rsi
lea addresses_normal_ht+0x6c37, %rbx
nop
nop
cmp $45744, %rax
movups (%rbx), %xmm3
vpextrq $1, %xmm3, %rdx
cmp %rbp, %rbp
lea addresses_D_ht+0x46d4, %rsi
lea addresses_UC_ht+0x790d, %rdi
nop
cmp $35868, %r9
mov $56, %rcx
rep movsb
nop
add %rcx, %rcx
lea addresses_UC_ht+0xd04f, %rsi
nop
cmp $7846, %rbp
movb (%rsi), %r9b
nop
nop
inc %rcx
lea addresses_UC_ht+0x1986d, %rcx
nop
cmp $2411, %rbx
...
nop
and %rbp, %rbp
lea addresses_D_ht+0x1510d, %rbp
sub %rbx, %rbx
movw $0x6162, (%rbp)
nop
nop
