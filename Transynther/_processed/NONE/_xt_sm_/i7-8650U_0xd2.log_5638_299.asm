...
push %rdi
push %rsi
lea addresses_WT_ht+0x1ab4b, %r13
cmp $47350, %rsi
mov (%r13), %r11w
nop
sub $1613, %rdi
lea addresses_normal_ht+0x8ab7, %rsi
lea addresses_D_ht+0x18f4b, %rdi
nop
cmp $28132, %rbx
mov $7, %rcx
rep movsb
add %rbx, %rbx
lea addresses_WT_ht+0x779b, %r11
nop
nop
and %rcx, %rcx
mov (%r11), %rbx
nop
and %rbx, %rbx
lea addresses_normal_ht+0x5833, %rsi
lea addresses_UC_ht+0xb4b, %rdi
sub %r10, %r10
mov $118, %rcx
rep movsl
xor $25684, %rdi
lea addresses_UC_ht+0x58d, %rsi
lea addresses_normal_ht+0x165ab, %rdi
nop
nop
inc %r11
mov $80, %rcx
...
nop
dec %r10
lea addresses_UC_ht+0x1294b, %rsi
clflush (%rsi)
nop
nop
and $2235, %rbx
mov (%rsi), %cx
and %r13, %r13
lea addresses_WC_ht+0x1bc8b, %rsi
...
nop
cmp %rcx, %rcx
lea addresses_UC_ht+0x1764b, %rdi
cmp $10498, %r13
movb $0x61, (%rdi)
nop
nop
nop
and %rsi, %rsi
lea addresses_WC_ht+0x1061, %rcx
nop
lfence
...
nop
add %rdi, %rdi
lea addresses_D_ht+0x1a5db, %rsi
nop
and %r11, %r11
...
nop
sub $46811, %rdi
lea addresses_normal_ht+0x1074b, %rsi
lea addresses_D_ht+0x1cb4b, %rdi
clflush (%rsi)
nop
nop
nop
...
{'OP': 'REPM', 'src': {'type': 'addresses_normal_ht', 'congruent': 0, 'same': True}, 'dst': {'type': 'addresses_D_ht', 'congruent': 9, 'same': False}}
