...
push %rdi
push %rsi
lea addresses_UC_ht+0x1218b, %rsi
lea addresses_A_ht+0x178b, %rdi
nop
nop
nop
and %r14, %r14
...
// Store
lea addresses_normal+0xa38b, %rbx
nop
nop
sub $49515, %rbp
movw $0x5152, (%rbx)
...
// Store
lea addresses_normal+0x1ab, %rbp
nop
nop
nop
nop
...
<gen_prepare_buffer>
{'src': {'congruent': 9, 'same': True, 'type': 'addresses_UC_ht'}, 'dst': {'congruent': 10, 'same': False, 'type': 'addresses_A_ht'}, 'OP': 'REPM'}
{'52': 4331}
