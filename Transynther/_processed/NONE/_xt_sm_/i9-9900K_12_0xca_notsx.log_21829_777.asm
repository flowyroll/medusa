...
push %rdi
push %rsi
lea addresses_D_ht+0x16a00, %r10
clflush (%r10)
nop
nop
nop
...
nop
dec %rcx
lea addresses_UC_ht+0xb600, %r13
nop
inc %rdi
...
lea addresses_WC_ht+0xb260, %rdi
nop
nop
add $30029, %r12
mov $1, %rcx
...
nop
xor $6544, %rcx
lea addresses_WT_ht+0xa570, %rsi
lea addresses_normal_ht+0xc200, %rdi
nop
nop
nop
nop
...
nop
cmp %r12, %r12
lea addresses_UC_ht+0x1000, %r13
nop
nop
xor %rcx, %rcx
mov (%r13), %rdi
...
nop
sub $19513, %rcx
lea addresses_UC_ht+0x12760, %rsi
lea addresses_UC_ht+0xa900, %rdi
inc %r12
mov $14, %rcx
rep movsl
add %rcx, %rcx
...
nop
and %r11, %r11
lea addresses_A_ht+0x38d0, %rsi
lea addresses_WC_ht+0xef55, %rdi
inc %r15
mov $113, %rcx
rep movsl
nop
...
{'OP': 'STOR', 'dst': {'same': True, 'type': 'addresses_UC', 'NT': False, 'AVXalign': True, 'size': 4, 'congruent': 0}}
[Faulty Load]
...
{'OP': 'REPM', 'src': {'same': False, 'congruent': 10, 'type': 'addresses_WC_ht'}, 'dst': {'same': False, 'congruent': 5, 'type': 'addresses_WC_ht'}}
{'OP': 'REPM', 'src': {'same': False, 'congruent': 4, 'type': 'addresses_WT_ht'}, 'dst': {'same': True, 'congruent': 11, 'type': 'addresses_normal_ht'}}
