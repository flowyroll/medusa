...
push %rdi
push %rsi
lea addresses_normal_ht+0xf882, %rsi
lea addresses_UC_ht+0x6aed, %rdi
sub $5364, %rbx
mov $116, %rcx
rep movsq
cmp $59947, %r10
lea addresses_WT_ht+0x29ea, %r12
nop
nop
nop
and %r14, %r14
...
nop
cmp %r10, %r10
lea addresses_normal_ht+0x1ceea, %r12
nop
nop
nop
nop
...
nop
cmp %rcx, %rcx
lea addresses_WT_ht+0x12a3a, %r14
nop
nop
nop
sub $55529, %r12
...
{'src': {'NT': False, 'same': False, 'congruent': 7, 'type': 'addresses_normal_ht', 'AVXalign': True, 'size': 4}, 'OP': 'LOAD'}
