...
push %rdi
push %rsi
lea addresses_A_ht+0x196d0, %r10
clflush (%r10)
nop
and $45317, %rdi
movb (%r10), %r15b
...
nop
sub %r14, %r14
lea addresses_D_ht+0x174d0, %rsi
nop
nop
nop
dec %r13
...
nop
cmp $49754, %r13
lea addresses_WT_ht+0x127d0, %rsi
lea addresses_WC_ht+0x10d30, %rdi
nop
sub %r8, %r8
mov $47, %rcx
rep movsw
sub $28460, %rsi
lea addresses_normal_ht+0x6250, %rsi
lea addresses_WC_ht+0x1d618, %rdi
clflush (%rdi)
xor %r13, %r13
mov $93, %rcx
rep movsq
...
nop
sub $31929, %r15
lea addresses_WC_ht+0xeed0, %r10
nop
nop
nop
nop
...
nop
cmp %r15, %r15
lea addresses_WT_ht+0x1b6d0, %r8
nop
nop
add $16863, %r10
...
nop
cmp %rcx, %rcx
lea addresses_normal_ht+0x12eda, %r8
nop
nop
nop
cmp $36989, %rsi
...
nop
cmp %rcx, %rcx
lea addresses_D_ht+0xb650, %rsi
lea addresses_normal_ht+0x47f0, %rdi
nop
nop
nop
nop
...
nop
and $17700, %rdi
lea addresses_normal_ht+0x3f0, %rsi
lea addresses_normal_ht+0x19319, %rdi
nop
nop
nop
nop
...
// Store
lea addresses_normal+0x176d0, %rax
add %r11, %r11
...
// Faulty Load
lea addresses_normal+0x176d0, %r11
nop
and %rax, %rax
movups (%r11), %xmm7
vpextrq $0, %xmm7, %r8
...
{'dst': {'same': True, 'NT': False, 'AVXalign': True, 'size': 16, 'type': 'addresses_normal', 'congruent': 0}, 'OP': 'STOR'}
...
{'dst': {'same': False, 'NT': False, 'AVXalign': True, 'size': 4, 'type': 'addresses_D_ht', 'congruent': 9}, 'OP': 'STOR'}
{'dst': {'same': False, 'congruent': 5, 'type': 'addresses_WC_ht'}, 'OP': 'REPM', 'src': {'same': False, 'congruent': 8, 'type': 'addresses_WT_ht'}}
...
{'dst': {'same': False, 'congruent': 0, 'type': 'addresses_normal_ht'}, 'OP': 'REPM', 'src': {'same': False, 'congruent': 5, 'type': 'addresses_normal_ht'}}
