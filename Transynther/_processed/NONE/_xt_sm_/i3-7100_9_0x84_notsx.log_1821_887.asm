...
push %rcx
push %rsi
lea addresses_A_ht+0x14b2f, %r12
nop
nop
xor %rsi, %rsi
movb $0x61, (%r12)
nop
cmp %rax, %rax
lea addresses_WT_ht+0xeea8, %r13
nop
nop
nop
and %r15, %r15
...
movq %rbx, (%r13)
and %rbx, %rbx
lea addresses_WC_ht+0x104ef, %rsi
nop
cmp %r13, %r13
mov (%rsi), %r12
nop
...
// Store
lea addresses_normal+0x3e2f, %rbp
clflush (%rbp)
nop
nop
nop
...
// Load
lea addresses_normal+0x6fff, %r8
nop
nop
inc %rdi
vmovups (%r8), %ymm0
...
// Store
lea addresses_normal+0x3e2f, %r11
nop
nop
nop
nop
...
// Store
lea addresses_normal+0x3e2f, %rdi
nop
nop
nop
add $48684, %r8
...
// Faulty Load
lea addresses_normal+0x3e2f, %r12
nop
nop
inc %rdi
movb (%r12), %r8b
...
{'src': {'type': 'addresses_D', 'same': False, 'size': 4, 'congruent': 7, 'NT': False, 'AVXalign': False}, 'OP': 'LOAD'}
