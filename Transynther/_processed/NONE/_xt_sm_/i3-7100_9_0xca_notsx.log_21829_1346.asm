...
push %rdx
push %rsi
lea addresses_normal_ht+0x1724b, %rbp
nop
nop
cmp %r10, %r10
...
nop
inc %rbx
lea addresses_WC_ht+0x1594b, %rsi
lea addresses_D_ht+0x84b, %rdi
clflush (%rdi)
nop
nop
nop
...
nop
cmp $655, %rbx
lea addresses_normal_ht+0x1e70b, %rsi
lea addresses_UC_ht+0xad4b, %rdi
clflush (%rdi)
nop
nop
nop
...
nop
sub %r10, %r10
lea addresses_UC_ht+0x8eab, %rdx
xor $59401, %rcx
movw $0x6162, (%rdx)
nop
nop
...
// Store
lea addresses_normal+0x11e95, %rbp
cmp %r13, %r13
