...
// Store
lea addresses_normal+0xf67a, %r13
clflush (%r13)
add $5145, %r8
movl $0x51525354, (%r13)
nop
...
// Store
lea addresses_normal+0x1097a, %rsi
nop
nop
nop
nop
...
// REPMOV
lea addresses_normal+0x10d7a, %rsi
lea addresses_WC+0x109da, %rdi
nop
nop
nop
nop
...
// Store
lea addresses_normal+0x1117a, %rbp
nop
and $3183, %r11
movb $0x51, (%rbp)
inc %rbx
...
// Faulty Load
lea addresses_normal+0x1097a, %rbp
nop
nop
nop
nop
...
{'src': {'type': 'addresses_normal', 'congruent': 9, 'same': False}, 'dst': {'type': 'addresses_WC', 'congruent': 4, 'same': False}, 'OP': 'REPM'}
