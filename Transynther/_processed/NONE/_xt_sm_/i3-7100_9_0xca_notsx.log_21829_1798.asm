...
nop
add %r11, %r11
lea addresses_WC_ht+0x1cf10, %r14
clflush (%r14)
nop
nop
nop
...
nop
inc %r14
lea addresses_A_ht+0x18290, %rbx
nop
nop
nop
nop
...
nop
add %r14, %r14
lea addresses_normal_ht+0xb710, %rbx
nop
nop
dec %r10
...
nop
and $15585, %r11
lea addresses_WT_ht+0x1dd10, %rsi
lea addresses_UC_ht+0x12410, %rdi
nop
nop
nop
nop
...
nop
cmp %rbx, %rbx
lea addresses_WT_ht+0x1d730, %rsi
lea addresses_A_ht+0x15cf8, %rdi
nop
nop
cmp %rax, %rax
mov $27, %rcx
...
nop
inc %r14
lea addresses_WT_ht+0xccb0, %rax
nop
nop
nop
cmp $27609, %rbx
...
{'OP': 'STOR', 'dst': {'same': False, 'congruent': 1, 'NT': True, 'type': 'addresses_UC', 'size': 2, 'AVXalign': False}}
[Faulty Load]
{'src': {'same': True, 'congruent': 0, 'NT': False, 'type': 'addresses_WC', 'size': 4, 'AVXalign': False}, 'OP': 'LOAD'}
<gen_prepare_buffer>
{'src': {'same': False, 'congruent': 11, 'NT': False, 'type': 'addresses_UC_ht', 'size': 4, 'AVXalign': True}, 'OP': 'LOAD'}
...
{'src': {'type': 'addresses_WT_ht', 'congruent': 3, 'same': False}, 'OP': 'REPM', 'dst': {'type': 'addresses_A_ht', 'congruent': 2, 'same': False}}
