...
push %rdx
push %rsi
lea addresses_D_ht+0x15564, %rcx
clflush (%rcx)
nop
xor %r14, %r14
...
nop
dec %r15
lea addresses_D_ht+0x11904, %rax
nop
nop
nop
nop
...
nop
sub %r12, %r12
lea addresses_UC_ht+0x2e94, %rsi
lea addresses_UC_ht+0xa364, %rdi
clflush (%rdi)
nop
nop
nop
...
nop
xor $59983, %r12
lea addresses_UC_ht+0xb970, %rax
nop
nop
add %rdx, %rdx
movl $0x61626364, (%rax)
cmp $39341, %r14
lea addresses_UC_ht+0x1bb64, %rax
nop
xor $64382, %r14
...
// Store
lea addresses_normal+0x129ec, %rbp
nop
nop
xor $12825, %r13
