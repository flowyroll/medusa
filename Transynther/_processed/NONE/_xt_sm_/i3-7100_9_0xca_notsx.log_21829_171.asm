...
push %rdi
push %rsi
lea addresses_WC_ht+0x171b6, %rdi
nop
nop
nop
nop
...
nop
cmp %rax, %rax
lea addresses_normal_ht+0x292e, %rcx
sub $2004, %r13
mov $0x6162636465666768, %r15
movq %r15, %xmm0
vmovups %ymm0, (%rcx)
inc %rdi
lea addresses_D_ht+0xaa5a, %rsi
lea addresses_WT_ht+0x1a2fa, %rdi
nop
nop
nop
nop
...
{'OP': 'STOR', 'dst': {'same': False, 'congruent': 11, 'NT': False, 'type': 'addresses_A', 'size': 8, 'AVXalign': True}}
