...
push %rdi
push %rsi
lea addresses_D_ht+0x129c4, %rsi
...
nop
cmp %r12, %r12
lea addresses_UC_ht+0x10c24, %r10
clflush (%r10)
xor $20722, %rbp
mov (%r10), %r11w
nop
nop
and $57148, %rdi
lea addresses_WC_ht+0xf824, %rsi
nop
nop
nop
nop
...
nop
and $10401, %rbp
lea addresses_A_ht+0x14f84, %rdi
and %r11, %r11
movb (%rdi), %cl
nop
nop
...
nop
xor %rbp, %rbp
lea addresses_D_ht+0x19224, %r11
nop
xor $36405, %rbp
movl $0x61626364, (%r11)
nop
...
nop
xor $42284, %rsi
lea addresses_A_ht+0x16a54, %rsi
lea addresses_normal_ht+0x7ba8, %rdi
nop
nop
nop
nop
...
{'OP': 'STOR', 'dst': {'same': False, 'congruent': 10, 'NT': False, 'type': 'addresses_P', 'size': 1, 'AVXalign': True}}
...
{'src': {'same': False, 'congruent': 11, 'NT': True, 'type': 'addresses_PSE', 'size': 4, 'AVXalign': True}, 'OP': 'LOAD'}
...
{'src': {'same': True, 'congruent': 3, 'NT': False, 'type': 'addresses_A_ht', 'size': 1, 'AVXalign': False}, 'OP': 'LOAD'}
{'OP': 'STOR', 'dst': {'same': False, 'congruent': 9, 'NT': False, 'type': 'addresses_D_ht', 'size': 4, 'AVXalign': True}}
