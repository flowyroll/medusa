...
push %rdx
push %rsi
lea addresses_normal_ht+0xc7d4, %r13
nop
nop
nop
nop
...
nop
sub %rdx, %rdx
lea addresses_WT_ht+0x16614, %r8
clflush (%r8)
nop
nop
nop
...
nop
and $19975, %r11
lea addresses_WT_ht+0x1ba96, %rsi
...
nop
and $40608, %r13
lea addresses_WT_ht+0x1c3b4, %rdi
nop
nop
nop
nop
...
nop
add %r8, %r8
lea addresses_UC_ht+0x7d88, %r11
nop
nop
nop
nop
...
nop
sub %rdx, %rdx
lea addresses_WT_ht+0xe3f2, %rsi
lea addresses_A_ht+0x127b4, %rdi
nop
nop
nop
and $33031, %rdx
...
nop
cmp %rdi, %rdi
lea addresses_A_ht+0x157b4, %r11
add %r14, %r14
mov (%r11), %bp
nop
add %rcx, %rcx
lea addresses_D_ht+0x11bb4, %r13
nop
nop
nop
sub %rcx, %rcx
...
nop
cmp $27202, %rsi
lea addresses_D_ht+0x1b834, %r14
nop
nop
nop
nop
...
nop
and $1541, %r11
lea addresses_normal_ht+0x10fb, %rcx
nop
nop
add %rdx, %rdx
...
movq %r11, (%rcx)
xor %rcx, %rcx
lea addresses_UC_ht+0xfcee, %rsi
nop
nop
nop
nop
...
nop
xor %rcx, %rcx
lea addresses_normal_ht+0xeaac, %rsi
lea addresses_normal_ht+0x83b4, %rdi
nop
nop
nop
nop
