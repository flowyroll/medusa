...
push %rcx
push %rdx
lea addresses_WT_ht+0x7e51, %r10
cmp $18765, %rdx
mov $0x6162636465666768, %r9
movq %r9, (%r10)
nop
cmp $50628, %rcx
lea addresses_WT_ht+0x105d1, %rcx
clflush (%rcx)
nop
nop
nop
...
nop
sub $18509, %rcx
lea addresses_UC_ht+0x1a5d1, %r9
inc %r12
...
nop
add $972, %r10
lea addresses_A_ht+0x162e8, %r12
clflush (%r12)
nop
nop
nop
...
nop
inc %r10
lea addresses_WT_ht+0x1db61, %r12
nop
nop
nop
nop
...
nop
sub $2800, %rdx
lea addresses_UC_ht+0x19d51, %rbp
nop
nop
nop
nop
...
nop
sub %r9, %r9
lea addresses_UC_ht+0x2f75, %rbp
inc %r10
movl $0x61626364, (%rbp)
inc %rcx
pop %rdx
...
{'OP': 'STOR', 'dst': {'same': True, 'congruent': 0, 'NT': True, 'type': 'addresses_WT', 'size': 8, 'AVXalign': False}}
[Faulty Load]
