...
// REPMOV
lea addresses_PSE+0x10b07, %rsi
lea addresses_PSE+0x10b07, %rdi
nop
nop
nop
cmp %r10, %r10
...
{'dst': {'same': True, 'congruent': 0, 'type': 'addresses_PSE'}, 'OP': 'REPM', 'src': {'same': True, 'congruent': 0, 'type': 'addresses_PSE'}}
...
<gen_prepare_buffer>
{'dst': {'same': True, 'NT': True, 'AVXalign': False, 'size': 1, 'type': 'addresses_WC_ht', 'congruent': 8}, 'OP': 'STOR'}
