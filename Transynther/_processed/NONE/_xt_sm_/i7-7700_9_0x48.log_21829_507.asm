...
nop
xor $57054, %r8
lea addresses_WC_ht+0xf97, %rsi
lea addresses_D_ht+0x1697, %rdi
nop
dec %r13
mov $71, %rcx
rep movsq
...
nop
dec %r11
lea addresses_WC_ht+0x17c97, %rcx
add $16720, %rdi
movw $0x6162, (%rcx)
nop
nop
...
nop
cmp %r13, %r13
lea addresses_WT_ht+0x4079, %rsi
lea addresses_WC_ht+0x1cd17, %rdi
nop
nop
nop
nop
...
nop
inc %r9
lea addresses_WC_ht+0xd697, %r13
nop
nop
nop
nop
...
movb $0x61, (%r13)
add %rcx, %rcx
lea addresses_WT_ht+0x1a897, %rsi
lea addresses_WC_ht+0xa697, %rdi
nop
nop
nop
cmp $38871, %r12
...
rep movsq
and $61623, %r8
lea addresses_WT_ht+0x12c97, %r13
nop
and $44256, %rcx
movl $0x61626364, (%r13)
nop
...
nop
cmp %rcx, %rcx
lea addresses_WT_ht+0x6697, %r11
nop
nop
nop
nop
...
nop
add %rcx, %rcx
lea addresses_normal_ht+0x8053, %rsi
nop
nop
xor %rdi, %rdi
mov (%rsi), %r8w
...
// Store
lea addresses_normal+0x5697, %r15
nop
nop
nop
nop
...
// Store
lea addresses_normal+0x14797, %r10
inc %r11
movw $0x5152, (%r10)
nop
nop
