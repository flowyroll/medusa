...
push %rdi
push %rsi
lea addresses_normal_ht+0x1a764, %rsi
...
nop
sub %r14, %r14
lea addresses_D_ht+0x4767, %rsi
lea addresses_normal_ht+0xc3af, %rdi
nop
nop
sub %rax, %rax
mov $11, %rcx
...
nop
sub %rsi, %rsi
lea addresses_normal_ht+0x383, %rdi
nop
nop
nop
xor $21443, %r10
...
nop
and %rdi, %rdi
lea addresses_UC_ht+0x148bd, %r10
xor %rax, %rax
mov (%r10), %esi
nop
nop
and %rcx, %rcx
lea addresses_normal_ht+0x9f83, %rbx
nop
nop
nop
nop
...
nop
add %r10, %r10
lea addresses_UC_ht+0x6983, %r10
nop
xor %rbx, %rbx
movups (%r10), %xmm2
vpextrq $1, %xmm2, %rax
nop
add %rsi, %rsi
lea addresses_normal_ht+0xabe3, %r14
clflush (%r14)
nop
sub %rax, %rax
movl $0x61626364, (%r14)
...
{'OP': 'STOR', 'dst': {'type': 'addresses_normal_ht', 'AVXalign': True, 'size': 4, 'NT': False, 'same': True, 'congruent': 5}}
