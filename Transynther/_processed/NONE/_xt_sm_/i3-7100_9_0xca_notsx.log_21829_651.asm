...
push %rdx
push %rsi
lea addresses_D_ht+0x1a968, %rax
nop
nop
xor %r12, %r12
movb $0x61, (%rax)
...
nop
sub %rax, %rax
lea addresses_normal_ht+0x1d2d0, %rdx
nop
and %r12, %r12
movb $0x61, (%rdx)
and $22671, %rdx
...
nop
sub $47660, %rdi
lea addresses_A_ht+0x1cd50, %rsi
lea addresses_normal_ht+0x8550, %rdi
nop
and $5880, %r15
mov $46, %rcx
rep movsl
...
nop
xor $58963, %r15
lea addresses_WC_ht+0xe6d0, %r12
nop
nop
nop
sub %r15, %r15
...
// Store
lea addresses_normal+0xa150, %r9
nop
nop
add $38561, %rbx
...
// Faulty Load
lea addresses_normal+0xa150, %rcx
nop
nop
nop
nop
...
{'src': {'same': False, 'congruent': 7, 'NT': True, 'type': 'addresses_A_ht', 'size': 8, 'AVXalign': False}, 'OP': 'LOAD'}
...
{'OP': 'STOR', 'dst': {'same': False, 'congruent': 0, 'NT': False, 'type': 'addresses_A_ht', 'size': 4, 'AVXalign': True}}
