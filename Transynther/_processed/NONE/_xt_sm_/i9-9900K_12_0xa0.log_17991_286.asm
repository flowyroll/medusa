...
push %rdi
push %rsi
lea addresses_normal_ht+0x350, %rax
clflush (%rax)
nop
nop
xor %rsi, %rsi
...
nop
xor $22726, %r10
lea addresses_WT_ht+0x22cd, %r11
clflush (%r11)
nop
nop
nop
...
movq %r8, (%r11)
add %r10, %r10
lea addresses_normal_ht+0x11973, %rsi
lea addresses_WC_ht+0x120cb, %rdi
nop
dec %rax
mov $28, %rcx
rep movsq
...
nop
dec %r8
lea addresses_D_ht+0xc28b, %rsi
lea addresses_A_ht+0xd44b, %rdi
nop
nop
cmp $50802, %r11
mov $5, %rcx
...
{'OP': 'STOR', 'dst': {'NT': False, 'same': True, 'congruent': 0, 'type': 'addresses_PSE', 'AVXalign': True, 'size': 2}}
...
{'src': {'same': False, 'congruent': 1, 'type': 'addresses_normal_ht'}, 'OP': 'REPM', 'dst': {'same': True, 'congruent': 2, 'type': 'addresses_WC_ht'}}
