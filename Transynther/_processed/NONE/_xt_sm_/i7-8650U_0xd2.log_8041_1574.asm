...
nop
and $20229, %r10
lea addresses_WT_ht+0x97f9, %rdi
clflush (%rdi)
nop
nop
lfence
...
nop
xor $30687, %r11
lea addresses_WT_ht+0x8ab1, %rdx
nop
nop
nop
nop
...
nop
sub %rdi, %rdi
lea addresses_UC_ht+0x70f9, %r14
add %r11, %r11
movups (%r14), %xmm2
vpextrq $1, %xmm2, %r10
and %rdx, %rdx
lea addresses_normal_ht+0x18ff9, %r10
nop
nop
nop
nop
...
mov (%r10), %edi
and $28622, %r10
lea addresses_D_ht+0x1e4f9, %r15
nop
nop
nop
sub $37031, %r11
...
nop
sub $11743, %rdi
lea addresses_A_ht+0x15dd9, %r10
nop
nop
nop
nop
...
nop
cmp $37830, %r14
lea addresses_WT_ht+0x1db19, %r15
nop
nop
nop
nop
...
movq %rdi, (%r15)
inc %r9
lea addresses_UC_ht+0x3879, %rsi
lea addresses_WC_ht+0x1bac5, %rdi
nop
nop
nop
nop
...
nop
cmp $47335, %r11
lea addresses_WT_ht+0x173e7, %r9
nop
nop
nop
add $27092, %rdi
...
nop
cmp $52717, %r15
lea addresses_normal_ht+0x19ef9, %r11
nop
nop
nop
cmp %rcx, %rcx
...
nop
and %rcx, %rcx
lea addresses_A_ht+0x11431, %rsi
lea addresses_WT_ht+0x68f9, %rdi
clflush (%rsi)
nop
add $21288, %r11
mov $7, %rcx
...
nop
sub $633, %rdi
lea addresses_normal_ht+0x1e9, %r11
sub $54763, %rdi
...
nop
inc %rdx
lea addresses_WC_ht+0x188f9, %rcx
nop
and $3502, %r15
mov (%rcx), %rdx
nop
