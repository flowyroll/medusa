...
nop
xor %rdi, %rdi
lea addresses_normal_ht+0x1af45, %rsi
lea addresses_A_ht+0x1db85, %rdi
nop
nop
nop
nop
...
nop
xor %r14, %r14
lea addresses_WC_ht+0x55c5, %rsi
lea addresses_normal_ht+0x26c5, %rdi
clflush (%rsi)
cmp %r14, %r14
mov $94, %rcx
rep movsb
...
nop
add %r14, %r14
lea addresses_UC_ht+0x15e75, %r14
nop
xor %rbx, %rbx
mov (%r14), %rdx
sub %r14, %r14
lea addresses_normal_ht+0x4205, %rsi
lea addresses_WC_ht+0x14abc, %rdi
xor $62901, %rdx
mov $57, %rcx
rep movsw
add $10309, %rbp
lea addresses_normal_ht+0xce6d, %rbx
nop
nop
nop
and $37096, %r14
...
// Store
lea addresses_normal+0xe995, %r10
nop
nop
nop
nop
