...
movq %rcx, (%r12)
xor %r10, %r10
lea addresses_D_ht+0x1c509, %rsi
lea addresses_UC_ht+0x6437, %rdi
clflush (%rdi)
nop
nop
xor %r10, %r10
...
nop
sub $36301, %r10
lea addresses_WT_ht+0x9361, %r10
nop
xor $43386, %rax
...
nop
and %rsi, %rsi
lea addresses_D_ht+0x14e69, %rdi
nop
nop
nop
add %r11, %r11
...
{'OP': 'REPM', 'src': {'same': False, 'congruent': 3, 'type': 'addresses_D_ht'}, 'dst': {'same': False, 'congruent': 1, 'type': 'addresses_UC_ht'}}
