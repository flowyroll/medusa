...
push %rdx
push %rsi
lea addresses_D_ht+0xb74c, %rsi
lea addresses_normal_ht+0x1d04c, %rdi
nop
nop
nop
nop
...
nop
xor %rdx, %rdx
lea addresses_WT_ht+0x1674c, %r11
nop
nop
nop
and %r9, %r9
...
nop
cmp $56004, %rax
lea addresses_WC_ht+0x14198, %rsi
lea addresses_WT_ht+0x103d4, %rdi
nop
nop
nop
nop
...
nop
cmp $8973, %r10
lea addresses_UC_ht+0x8f8e, %rcx
nop
nop
add %rdi, %rdi
...
nop
sub $53099, %rsi
lea addresses_WC_ht+0xdf4c, %rdi
nop
add %rax, %rax
mov (%rdi), %r10w
nop
inc %r10
lea addresses_A_ht+0x1ab4c, %rax
clflush (%rax)
nop
nop
add $111, %rdi
...
nop
cmp %rdx, %rdx
lea addresses_WC_ht+0x890c, %r10
clflush (%r10)
nop
dec %rdx
...
vpextrq $0, %xmm5, %rdi
add $62510, %r11
lea addresses_A_ht+0x1dccc, %r11
nop
nop
cmp %rax, %rax
...
nop
add $15196, %rdx
lea addresses_UC_ht+0x124fc, %rdi
nop
nop
and %rax, %rax
...
// Store
lea addresses_normal+0x614c, %r11
nop
xor %rcx, %rcx
movw $0x5152, (%r11)
and $23149, %r9
...
{'src': {'type': 'addresses_WC_ht', 'congruent': 2, 'same': False}, 'dst': {'type': 'addresses_WT_ht', 'congruent': 3, 'same': True}, 'OP': 'REPM'}
