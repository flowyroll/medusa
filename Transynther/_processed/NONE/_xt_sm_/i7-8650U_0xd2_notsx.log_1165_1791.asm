...
push %rdi
push %rsi
lea addresses_WT_ht+0x1ae4, %rdi
nop
nop
nop
cmp %rax, %rax
...
movq %r13, (%rdi)
sub $65283, %r15
lea addresses_UC_ht+0x139e6, %rsi
...
rep movsb
dec %r13
lea addresses_D_ht+0x18bba, %rsi
lea addresses_WT_ht+0x1517a, %rdi
nop
cmp %r10, %r10
mov $55, %rcx
rep movsl
...
nop
and %rax, %rax
lea addresses_D_ht+0x1dcfa, %rsi
lea addresses_WC_ht+0xd34a, %rdi
clflush (%rdi)
nop
nop
cmp %rbp, %rbp
...
nop
and %rbp, %rbp
lea addresses_normal_ht+0x11e5a, %r13
nop
nop
nop
nop
...
movq %r15, (%r13)
xor %r10, %r10
lea addresses_UC_ht+0x8fba, %r13
nop
nop
nop
sub %r10, %r10
...
// REPMOV
lea addresses_A+0xd87e, %rsi
lea addresses_D+0x1652a, %rdi
nop
nop
xor $33267, %r9
mov $40, %rcx
...
// REPMOV
lea addresses_normal+0x116ba, %rsi
lea addresses_UC+0x1eefa, %rdi
nop
nop
nop
and %r12, %r12
...
{'OP': 'REPM', 'src': {'type': 'addresses_A', 'congruent': 1, 'same': False}, 'dst': {'type': 'addresses_D', 'congruent': 4, 'same': False}}
{'OP': 'STOR', 'dst': {'type': 'addresses_UC', 'size': 8, 'AVXalign': False, 'NT': False, 'congruent': 0, 'same': True}}
{'OP': 'REPM', 'src': {'type': 'addresses_normal', 'congruent': 8, 'same': False}, 'dst': {'type': 'addresses_UC', 'congruent': 6, 'same': False}}
