...
nop
sub %rbx, %rbx
lea addresses_WT_ht+0x1954a, %rsi
nop
nop
inc %rax
vmovups (%rsi), %ymm6
...
vpextrq $1, %xmm6, %r14
sub %rbx, %rbx
lea addresses_D_ht+0x1539b, %rsi
lea addresses_WT_ht+0xb913, %rdi
sub %rax, %rax
mov $61, %rcx
rep movsw
nop
...
nop
and %r8, %r8
lea addresses_UC_ht+0x10513, %r9
and %rax, %rax
movb $0x61, (%r9)
nop
nop
nop
and $57159, %r12
lea addresses_WC_ht+0xd76c, %rsi
nop
inc %r14
mov (%rsi), %r12d
nop
...
nop
xor $28914, %rdi
lea addresses_D_ht+0x18b63, %rsi
lea addresses_WT_ht+0x13313, %rdi
nop
xor %r8, %r8
mov $7, %rcx
rep movsw
...
nop
sub %r14, %r14
lea addresses_WT_ht+0x12e13, %rbx
nop
nop
nop
cmp %r14, %r14
...
nop
add %rax, %rax
lea addresses_WT_ht+0x1de13, %rsi
lea addresses_WC_ht+0x6d03, %rdi
nop
nop
nop
nop
...
nop
xor %r14, %r14
lea addresses_D_ht+0xf1e, %rsi
lea addresses_WC_ht+0xf613, %rdi
nop
nop
nop
nop
...
nop
and %r12, %r12
lea addresses_WC_ht+0x153d1, %rsi
nop
nop
add %rbx, %rbx
mov (%rsi), %cx
