...
push %rdx
push %rsi
lea addresses_UC_ht+0x1492d, %rcx
nop
nop
cmp %rax, %rax
...
nop
xor %rdx, %rdx
lea addresses_WC_ht+0xed2d, %rsi
nop
nop
nop
nop
...
nop
cmp $6177, %rax
lea addresses_normal_ht+0x16b2d, %rcx
clflush (%rcx)
nop
nop
nop
...
nop
and %r11, %r11
lea addresses_D_ht+0x107ad, %rsi
nop
nop
nop
nop
...
// Store
lea addresses_normal+0xeaad, %rsi
and $18499, %rbx
