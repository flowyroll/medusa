...
push %rdi
push %rsi
lea addresses_UC_ht+0x16265, %rsi
...
// Store
lea addresses_normal+0x1b565, %r13
clflush (%r13)
and %rsi, %rsi
movw $0x5152, (%r13)
nop
...
// REPMOV
lea addresses_normal+0x8e65, %rsi
lea addresses_A+0xc165, %rdi
nop
nop
add %rbp, %rbp
mov $22, %rcx
...
// Store
lea addresses_normal+0x8e65, %r12
nop
nop
nop
and $15872, %rcx
...
// Load
lea addresses_normal+0xac65, %r9
clflush (%r9)
nop
add $19922, %r13
vmovups (%r9), %ymm2
...
// Faulty Load
lea addresses_normal+0x8e65, %r9
nop
nop
nop
nop
...
{'OP': 'STOR', 'dst': {'type': 'addresses_normal', 'AVXalign': True, 'size': 2, 'NT': False, 'same': False, 'congruent': 4}}
{'src': {'type': 'addresses_normal', 'congruent': 0, 'same': True}, 'OP': 'REPM', 'dst': {'type': 'addresses_A', 'congruent': 8, 'same': False}}
{'src': {'type': 'addresses_P', 'AVXalign': False, 'size': 4, 'NT': False, 'same': False, 'congruent': 4}, 'OP': 'LOAD'}
