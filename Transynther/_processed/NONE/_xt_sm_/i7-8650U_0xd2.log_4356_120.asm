...
push %rdi
push %rsi
lea addresses_WC_ht+0x82ef, %rdi
nop
nop
nop
nop
...
nop
and $49693, %r10
lea addresses_A_ht+0x172cf, %rsi
lea addresses_normal_ht+0x1eacf, %rdi
nop
nop
inc %rax
mov $68, %rcx
...
nop
sub $60944, %rdi
lea addresses_WT_ht+0x1d2cf, %rdi
dec %rsi
mov (%rdi), %ecx
nop
nop
...
nop
cmp %r14, %r14
lea addresses_A_ht+0x11acf, %r14
nop
nop
nop
xor %r8, %r8
...
nop
inc %r8
lea addresses_D_ht+0xd2cf, %rsi
lea addresses_A_ht+0xe97f, %rdi
nop
nop
xor %r12, %r12
mov $0, %rcx
...
nop
inc %rax
lea addresses_WC_ht+0x52cf, %r14
nop
nop
nop
nop
...
nop
xor $8326, %rcx
lea addresses_UC_ht+0x1d0f, %rsi
lea addresses_A_ht+0x19eef, %rdi
clflush (%rdi)
nop
nop
nop
...
nop
sub %rax, %rax
lea addresses_A_ht+0x1e60f, %rax
nop
nop
nop
nop
...
nop
inc %rcx
lea addresses_UC_ht+0x1a4cf, %rsi
lea addresses_WC_ht+0xcacf, %rdi
nop
cmp %r8, %r8
mov $103, %rcx
rep movsl
...
nop
xor $55438, %r10
lea addresses_WC_ht+0xb913, %rsi
lea addresses_A_ht+0xf94f, %rdi
nop
nop
nop
nop
...
rep movsb
dec %rcx
lea addresses_A_ht+0x18077, %rdi
nop
xor $20578, %r8
mov $0x6162636465666768, %r10
movq %r10, (%rdi)
...
nop
cmp $48908, %r10
lea addresses_WT_ht+0x4fd1, %rax
nop
nop
nop
nop
...
{'OP': 'REPM', 'src': {'type': 'addresses_A_ht', 'congruent': 10, 'same': True}, 'dst': {'type': 'addresses_normal_ht', 'congruent': 9, 'same': True}}
...
{'OP': 'REPM', 'src': {'type': 'addresses_D_ht', 'congruent': 10, 'same': False}, 'dst': {'type': 'addresses_A_ht', 'congruent': 3, 'same': True}}
...
{'OP': 'LOAD', 'src': {'type': 'addresses_A_ht', 'size': 1, 'AVXalign': True, 'NT': False, 'congruent': 6, 'same': False}}
...
{'OP': 'REPM', 'src': {'type': 'addresses_WC_ht', 'congruent': 2, 'same': False}, 'dst': {'type': 'addresses_A_ht', 'congruent': 7, 'same': False}}
