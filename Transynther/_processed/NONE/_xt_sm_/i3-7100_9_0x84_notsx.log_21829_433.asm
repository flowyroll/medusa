...
push %rdi
push %rsi
lea addresses_normal_ht+0x42a8, %rsi
nop
dec %rcx
...
nop
xor $20803, %rcx
lea addresses_UC_ht+0x65b4, %r14
clflush (%r14)
nop
nop
add %r13, %r13
...
nop
xor %rsi, %rsi
lea addresses_UC_ht+0x1d9a4, %r14
add %r9, %r9
mov (%r14), %rsi
nop
nop
...
nop
and $3504, %r9
lea addresses_normal_ht+0x8ca, %rsi
lea addresses_D_ht+0x13ee7, %rdi
nop
nop
cmp $32503, %rbp
mov $60, %rcx
rep movsb
sub %rcx, %rcx
lea addresses_normal_ht+0x15964, %r9
clflush (%r9)
nop
xor $32947, %rbp
mov (%r9), %r13d
nop
and $61939, %r12
lea addresses_WC_ht+0x1bda4, %r12
nop
nop
and $16827, %rcx
mov $0x6162636465666768, %r14
...
nop
add %r9, %r9
lea addresses_normal_ht+0x4a4, %rsi
nop
inc %r9
movb (%rsi), %r13b
nop
...
// REPMOV
lea addresses_D+0x16624, %rsi
lea addresses_PSE+0x424, %rdi
nop
nop
nop
nop
...
{'src': {'type': 'addresses_D', 'congruent': 3, 'same': False}, 'dst': {'type': 'addresses_PSE', 'congruent': 7, 'same': False}, 'OP': 'REPM'}
...
{'dst': {'type': 'addresses_US', 'same': False, 'size': 2, 'congruent': 9, 'NT': True, 'AVXalign': True}, 'OP': 'STOR'}
...
{'src': {'type': 'addresses_UC_ht', 'congruent': 8, 'same': False}, 'dst': {'type': 'addresses_A_ht', 'congruent': 4, 'same': False}, 'OP': 'REPM'}
{'src': {'type': 'addresses_UC_ht', 'same': False, 'size': 8, 'congruent': 3, 'NT': False, 'AVXalign': False}, 'OP': 'LOAD'}
{'src': {'type': 'addresses_UC_ht', 'same': False, 'size': 8, 'congruent': 9, 'NT': True, 'AVXalign': False}, 'OP': 'LOAD'}
