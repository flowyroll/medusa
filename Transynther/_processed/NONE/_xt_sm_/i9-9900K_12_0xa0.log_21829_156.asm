...
push %rdi
push %rsi
lea addresses_D_ht+0x6be9, %r15
nop
and $50346, %r10
mov (%r15), %r13d
mfence
lea addresses_UC_ht+0x1afe9, %rsi
lea addresses_UC_ht+0xb871, %rdi
nop
nop
nop
nop
...
nop
add $53415, %r9
lea addresses_WC_ht+0x195e9, %rsi
lea addresses_A_ht+0x15e89, %rdi
nop
inc %r10
mov $81, %rcx
rep movsb
...
// Store
lea addresses_A+0x10be9, %rdi
cmp %r14, %r14
movw $0x5152, (%rdi)
cmp $38955, %r15

// Store
lea addresses_US+0xbbe3, %r14
clflush (%r14)
and %rdi, %rdi
