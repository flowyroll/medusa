...
push %rbp
push %rsi
lea addresses_WC_ht+0x17f9a, %r10
nop
nop
dec %r8
...
nop
cmp %rbp, %rbp
lea addresses_WC_ht+0x17252, %r15
nop
nop
nop
nop
...
nop
add %rbp, %rbp
lea addresses_WC_ht+0x1ad9a, %rax
nop
nop
nop
xor %rsi, %rsi
