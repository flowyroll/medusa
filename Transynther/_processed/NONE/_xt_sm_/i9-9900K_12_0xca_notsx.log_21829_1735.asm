...
lea addresses_WC_ht+0x1c3cb, %rdi
nop
nop
nop
xor $54902, %r14
...
rep movsl
sub %rdx, %rdx
lea addresses_UC_ht+0xbf6b, %rax
xor $48519, %r14
movb (%rax), %dl
sub $24488, %rcx
lea addresses_WT_ht+0xb68f, %rcx
clflush (%rcx)
nop
nop
nop
...
nop
dec %rsi
lea addresses_UC_ht+0xacae, %rax
nop
and %rsi, %rsi
...
nop
and %rsi, %rsi
lea addresses_D_ht+0x6a6b, %rsi
lea addresses_WC_ht+0x1676b, %rdi
nop
nop
nop
inc %r15
...
// Store
lea addresses_normal+0xd5f, %r15
nop
nop
xor %rbp, %rbp
...
{'OP': 'LOAD', 'src': {'same': True, 'type': 'addresses_UC_ht', 'NT': False, 'AVXalign': False, 'size': 1, 'congruent': 11}}
