...
push %rcx
push %rdx
lea addresses_UC_ht+0xcf3d, %r12
nop
nop
nop
nop
...
nop
add %rcx, %rcx
lea addresses_UC_ht+0x5d59, %rdx
nop
dec %r15
...
nop
xor %r10, %r10
lea addresses_normal_ht+0xc59, %r9
xor $43760, %r11
mov (%r9), %rdx
nop
nop
...
// Store
lea addresses_normal+0x1bf59, %r11
nop
nop
nop
nop
