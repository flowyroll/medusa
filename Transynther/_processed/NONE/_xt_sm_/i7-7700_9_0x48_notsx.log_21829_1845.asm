...
push %rdi
push %rsi
lea addresses_WC_ht+0x1e68e, %rdi
cmp $30371, %r13
...
nop
add $56269, %rbx
lea addresses_normal_ht+0x80c2, %rax
nop
nop
xor $11753, %rsi
...
vmovups %ymm1, (%rax)
sub $23706, %rdi
lea addresses_D_ht+0x1a6a2, %rdi
clflush (%rdi)
nop
nop
xor %rax, %rax
...
vpextrq $0, %xmm4, %r10
add %rax, %rax
lea addresses_D_ht+0x1d385, %rsi
nop
cmp $58068, %rbx
movb (%rsi), %r13b
nop
...
lea addresses_normal_ht+0x1ee22, %rdi
nop
nop
nop
nop
...
nop
and %rdi, %rdi
lea addresses_normal_ht+0x5622, %r10
nop
nop
nop
nop
...
nop
sub $55677, %rbx
lea addresses_UC_ht+0x1b822, %r14
nop
nop
nop
mfence
...
nop
add $2998, %rsi
lea addresses_UC_ht+0x9fe2, %rsi
lea addresses_normal_ht+0xd822, %rdi
nop
nop
nop
sub $51070, %r13
...
{'dst': {'same': True, 'NT': True, 'AVXalign': False, 'size': 2, 'type': 'addresses_A', 'congruent': 0}, 'OP': 'STOR'}
...
{'OP': 'LOAD', 'src': {'same': True, 'NT': False, 'AVXalign': True, 'size': 1, 'type': 'addresses_D_ht', 'congruent': 0}}
{'dst': {'same': True, 'congruent': 9, 'type': 'addresses_normal_ht'}, 'OP': 'REPM', 'src': {'same': False, 'congruent': 6, 'type': 'addresses_A_ht'}}
...
{'dst': {'same': False, 'congruent': 10, 'type': 'addresses_normal_ht'}, 'OP': 'REPM', 'src': {'same': False, 'congruent': 6, 'type': 'addresses_UC_ht'}}
{'52': 21829}
