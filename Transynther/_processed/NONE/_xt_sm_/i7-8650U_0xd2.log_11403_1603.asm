...
push %rdx
push %rsi
lea addresses_WT_ht+0x1476b, %rdx
nop
nop
add $8310, %rbp
movl $0x61626364, (%rdx)
...
nop
sub $2178, %r15
lea addresses_normal_ht+0x1acfb, %rsi
lea addresses_D_ht+0x96fb, %rdi
nop
nop
nop
inc %rbx
...
rep movsb
cmp $1307, %rdi
lea addresses_UC_ht+0x1e9fb, %rbx
and $14803, %r15
...
nop
cmp %r15, %r15
lea addresses_normal_ht+0xa133, %rsi
nop
nop
nop
inc %rdi
...
nop
sub $55207, %rbp
lea addresses_WC_ht+0xe17b, %r15
nop
nop
nop
nop
...
nop
add %rdx, %rdx
lea addresses_WC_ht+0x1d7bb, %r15
nop
add %rbp, %rbp
mov (%r15), %di
nop
inc %rbp
lea addresses_WT_ht+0x1ad7b, %rsi
nop
nop
nop
nop
...
nop
sub $45183, %rsi
lea addresses_WC_ht+0x174fb, %rsi
lea addresses_A_ht+0x11d23, %rdi
clflush (%rdi)
nop
sub $39212, %rbp
mov $32, %rcx
...
nop
add $39962, %rbp
lea addresses_WC_ht+0x3cfb, %rdi
nop
nop
sub %rbx, %rbx
...
lea addresses_normal_ht+0x100fb, %rdi
nop
cmp %rbp, %rbp
mov $8, %rcx
rep movsq
...
nop
add %rsi, %rsi
lea addresses_normal_ht+0x1e85b, %rsi
lea addresses_WT_ht+0xfafb, %rdi
nop
nop
nop
xor $46230, %rbp
...
rep movsb
dec %rbx
lea addresses_normal_ht+0x1cefb, %rcx
nop
nop
dec %rbp
movl $0x61626364, (%rcx)
...
{'OP': 'REPM', 'src': {'type': 'addresses_WC_ht', 'congruent': 7, 'same': False}, 'dst': {'type': 'addresses_A_ht', 'congruent': 3, 'same': True}}
...
{'OP': 'REPM', 'src': {'type': 'addresses_normal_ht', 'congruent': 5, 'same': False}, 'dst': {'type': 'addresses_WT_ht', 'congruent': 10, 'same': False}}
