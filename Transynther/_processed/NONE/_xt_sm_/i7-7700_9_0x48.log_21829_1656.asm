...
lea addresses_A_ht+0x1360a, %rdi
clflush (%rsi)
nop
nop
nop
...
rep movsw
cmp $6942, %r11
lea addresses_WC_ht+0x450a, %r10
clflush (%r10)
sub $22457, %rdi
mov (%r10), %r12d
nop
nop
sub %rcx, %rcx
lea addresses_normal_ht+0x1717a, %rsi
...
nop
cmp $48056, %r12
lea addresses_D_ht+0x1b68a, %r11
nop
nop
nop
dec %rsi
...
nop
cmp %rsi, %rsi
lea addresses_UC_ht+0x1adea, %r10
nop
nop
cmp %rdx, %rdx
movb (%r10), %cl
sub $442, %rsi
lea addresses_D_ht+0x17806, %r10
nop
nop
nop
nop
...
nop
and %rdi, %rdi
lea addresses_WT_ht+0xb75a, %rdi
xor %r12, %r12
movw $0x6162, (%rdi)
dec %rdi
lea addresses_WC_ht+0x178ce, %rcx
nop
nop
nop
xor $19697, %r10
...
{'OP': 'LOAD', 'src': {'type': 'addresses_UC', 'AVXalign': False, 'congruent': 5, 'size': 8, 'same': False, 'NT': False}}
[Faulty Load]
...
{'OP': 'LOAD', 'src': {'type': 'addresses_UC_ht', 'AVXalign': False, 'congruent': 5, 'size': 1, 'same': False, 'NT': True}}
