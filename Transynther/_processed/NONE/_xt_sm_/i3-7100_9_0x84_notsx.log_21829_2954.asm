...
push %rdi
push %rsi
lea addresses_UC_ht+0x995, %rbx
cmp $36446, %rcx
mov (%rbx), %r11
nop
xor $9902, %rax
lea addresses_normal_ht+0xfb35, %rsi
lea addresses_normal_ht+0x16307, %rdi
nop
nop
nop
nop
...
nop
add $22164, %rax
lea addresses_UC_ht+0xd995, %r13
nop
cmp $4474, %rax
movl $0x61626364, (%r13)
nop
nop
sub $12161, %rsi
lea addresses_UC_ht+0x1cb69, %rsi
...
movups %xmm4, (%rcx)
cmp %rsi, %rsi
lea addresses_D_ht+0x1c595, %r13
nop
nop
nop
nop
...
nop
inc %rbx
lea addresses_normal_ht+0x5035, %r11
nop
nop
sub $57775, %rsi
movl $0x61626364, (%r11)
sub $29755, %rcx
lea addresses_WC_ht+0x11415, %rbx
nop
nop
nop
nop
...
nop
add %r13, %r13
lea addresses_A_ht+0x5735, %rsi
lea addresses_WC_ht+0x1e55, %rdi
dec %rbx
mov $12, %rcx
rep movsb
nop
...
nop
sub %r13, %r13
lea addresses_WC_ht+0x379d, %rsi
xor $30771, %r13
mov (%rsi), %rbx
sub %r13, %r13
lea addresses_UC_ht+0xde15, %rax
add $5531, %rbp
movl $0x61626364, (%rax)
nop
nop
...
// Store
lea addresses_normal+0xb01, %r14
clflush (%r14)
nop
nop
nop
...
{'src': {'type': 'addresses_normal_ht', 'congruent': 5, 'same': True}, 'dst': {'type': 'addresses_normal_ht', 'congruent': 1, 'same': False}, 'OP': 'REPM'}
{'dst': {'type': 'addresses_UC_ht', 'same': False, 'size': 4, 'congruent': 6, 'NT': False, 'AVXalign': True}, 'OP': 'STOR'}
{'src': {'type': 'addresses_UC_ht', 'congruent': 0, 'same': False}, 'dst': {'type': 'addresses_A_ht', 'congruent': 6, 'same': False}, 'OP': 'REPM'}
...
{'dst': {'type': 'addresses_D_ht', 'same': False, 'size': 2, 'congruent': 9, 'NT': True, 'AVXalign': False}, 'OP': 'STOR'}
...
{'src': {'type': 'addresses_A_ht', 'congruent': 5, 'same': False}, 'dst': {'type': 'addresses_WC_ht', 'congruent': 3, 'same': False}, 'OP': 'REPM'}
