...
push %rdx
push %rsi
lea addresses_normal_ht+0x12d28, %r14
nop
nop
nop
nop
...
vmovups %ymm3, (%r14)
xor $33812, %rdx
lea addresses_A_ht+0x1a664, %rbx
nop
nop
nop
nop
...
vmovups %ymm3, (%rbx)
add $14442, %rdi
lea addresses_UC_ht+0x4f5c, %rbx
nop
nop
nop
xor %r9, %r9
...
// Store
lea addresses_normal+0x1e88, %rdi
nop
sub %rbx, %rbx
movw $0x5152, (%rdi)
nop
...
{'OP': 'STOR', 'dst': {'type': 'addresses_WT', 'AVXalign': False, 'congruent': 0, 'size': 16, 'same': True, 'NT': False}}
{'OP': 'STOR', 'dst': {'type': 'addresses_WC', 'AVXalign': False, 'congruent': 0, 'size': 1, 'same': False, 'NT': True}}
[Faulty Load]
