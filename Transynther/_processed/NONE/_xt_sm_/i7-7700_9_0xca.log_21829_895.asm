...
push %rdx
push %rsi
lea addresses_WC_ht+0x1e843, %rsi
lea addresses_WC_ht+0xbbb3, %rdi
add %rbp, %rbp
mov $127, %rcx
rep movsb
nop
...
nop
and $50147, %r8
lea addresses_UC_ht+0x8043, %rbp
nop
cmp $35401, %rdi
movb $0x61, (%rbp)
sub %rdi, %rdi
lea addresses_UC_ht+0xf083, %r8
nop
nop
nop
nop
...
vpextrq $1, %xmm0, %rcx
add $38840, %rdx
lea addresses_WC_ht+0x79c3, %rdx
nop
sub $38239, %rcx
...
nop
dec %r14
lea addresses_D_ht+0x1a043, %r14
clflush (%r14)
sub %rsi, %rsi
movb (%r14), %cl
nop
nop
add %rdx, %rdx
lea addresses_UC_ht+0x43, %rsi
lea addresses_normal_ht+0x178c3, %rdi
nop
nop
nop
nop
...
rep movsq
cmp $16274, %rdi
lea addresses_WC_ht+0x12443, %r14
nop
nop
nop
xor %r8, %r8
...
nop
sub $5487, %rbp
lea addresses_UC_ht+0x7643, %rsi
lea addresses_WC_ht+0x1efc3, %rdi
nop
xor %rbx, %rbx
mov $113, %rcx
rep movsq
...
nop
sub %rbp, %rbp
lea addresses_WC_ht+0x1d193, %r14
nop
nop
nop
nop
...
{'src': {'congruent': 9, 'same': False, 'type': 'addresses_UC_ht'}, 'OP': 'REPM', 'dst': {'congruent': 3, 'same': False, 'type': 'addresses_WC_ht'}}
