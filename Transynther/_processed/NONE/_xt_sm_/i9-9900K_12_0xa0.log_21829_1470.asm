...
nop
and %r14, %r14
lea addresses_UC_ht+0x15457, %r15
nop
nop
nop
nop
...
nop
dec %r15
lea addresses_WC_ht+0x8927, %rcx
and %r15, %r15
movups (%rcx), %xmm6
vpextrq $1, %xmm6, %rdi
nop
and $2028, %rdi
lea addresses_A_ht+0x10dd7, %rsi
lea addresses_UC_ht+0x16817, %rdi
clflush (%rdi)
nop
xor %r14, %r14
mov $91, %rcx
...
// Store
lea addresses_normal+0x1368f, %rdi
nop
nop
nop
nop
...
{'OP': 'STOR', 'dst': {'NT': False, 'same': True, 'congruent': 0, 'type': 'addresses_A', 'AVXalign': True, 'size': 16}}
{'OP': 'STOR', 'dst': {'NT': True, 'same': False, 'congruent': 1, 'type': 'addresses_normal', 'AVXalign': False, 'size': 2}}
{'OP': 'STOR', 'dst': {'NT': False, 'same': False, 'congruent': 9, 'type': 'addresses_NC', 'AVXalign': False, 'size': 8}}
{'OP': 'STOR', 'dst': {'NT': False, 'same': False, 'congruent': 6, 'type': 'addresses_NC', 'AVXalign': False, 'size': 8}}
