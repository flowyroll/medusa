...
push %rcx
push %rdx
lea addresses_WT_ht+0x13859, %r15
clflush (%r15)
nop
nop
nop
...
nop
and $63806, %r10
lea addresses_WC_ht+0xb459, %rcx
nop
nop
nop
nop
...
nop
cmp %r11, %r11
lea addresses_UC_ht+0x2f07, %rax
nop
nop
add %r11, %r11
...
{'OP': 'REPM', 'src': {'same': False, 'congruent': 6, 'type': 'addresses_US'}, 'dst': {'same': False, 'congruent': 4, 'type': 'addresses_P'}}
{'OP': 'STOR', 'dst': {'same': False, 'type': 'addresses_A', 'NT': False, 'AVXalign': True, 'size': 1, 'congruent': 8}}
