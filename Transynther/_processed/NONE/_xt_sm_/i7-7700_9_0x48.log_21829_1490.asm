...
push %rdi
push %rsi
lea addresses_WC_ht+0x8615, %rdi
nop
xor $31951, %r12
mov (%rdi), %ebp
nop
...
nop
add %rbp, %rbp
lea addresses_UC_ht+0x1da15, %rbx
nop
nop
nop
and %r10, %r10
...
nop
lfence
lea addresses_D_ht+0xa815, %rsi
lea addresses_D_ht+0x191d5, %rdi
nop
add $29254, %rax
mov $28, %rcx
rep movsl
...
nop
sub %rcx, %rcx
lea addresses_WT_ht+0x19215, %r12
nop
and %rbp, %rbp
movb $0x61, (%r12)
cmp $29754, %rdi
lea addresses_A_ht+0x1915, %r12
clflush (%r12)
xor %rcx, %rcx
mov (%r12), %rsi
nop
...
nop
xor %rsi, %rsi
lea addresses_WT_ht+0x1855, %rsi
clflush (%rsi)
nop
xor %r12, %r12
mov (%rsi), %rax
...
nop
and $4908, %rax
lea addresses_normal_ht+0xee15, %r9
clflush (%r9)
and $27752, %rsi
movw $0x6162, (%r9)
nop
