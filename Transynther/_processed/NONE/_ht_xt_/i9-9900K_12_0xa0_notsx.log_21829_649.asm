...
nop
xor %r12, %r12
lea addresses_A_ht+0x1677c, %rbx
nop
nop
and $61243, %r15
...
movq %r12, (%rbx)
sub $38435, %r15
lea addresses_WT_ht+0x15878, %rsi
...
nop
xor %r14, %r14
lea addresses_D_ht+0x11a3c, %rsi
lea addresses_normal_ht+0x19d1c, %rdi
and $29105, %r12
mov $72, %rcx
rep movsl
nop
xor %rsi, %rsi
lea addresses_WT_ht+0x245b, %rsi
lea addresses_WC_ht+0x1b41c, %rdi
nop
nop
nop
and $910, %r11
...
nop
and %r11, %r11
lea addresses_D_ht+0x1061c, %r15
nop
nop
nop
nop
...
{'src': {'type': 'addresses_RW', 'AVXalign': True, 'size': 4, 'NT': False, 'same': False, 'congruent': 5}, 'OP': 'LOAD'}
[Faulty Load]
...
{'OP': 'STOR', 'dst': {'type': 'addresses_D_ht', 'AVXalign': False, 'size': 1, 'NT': True, 'same': False, 'congruent': 9}}
{'35': 21828, '46': 1}
