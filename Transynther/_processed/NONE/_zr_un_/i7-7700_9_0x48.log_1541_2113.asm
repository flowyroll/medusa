...
push %rdi
push %rsi
lea addresses_UC_ht+0xef7f, %rsi
lea addresses_normal_ht+0x10d6f, %rdi
nop
nop
nop
add %r9, %r9
...
nop
add %rcx, %rcx
lea addresses_WT_ht+0x1d07b, %rsi
nop
add $36399, %rax
...
nop
xor %rbx, %rbx
lea addresses_UC_ht+0x1879f, %rcx
nop
cmp %r8, %r8
movb $0x61, (%rcx)
nop
...
nop
xor %rcx, %rcx
lea addresses_WT_ht+0x3f7f, %rbx
and $55820, %r9
movb (%rbx), %cl
nop
nop
...
// Store
lea addresses_normal+0x19787, %r9
nop
nop
nop
dec %r14
...
// REPMOV
lea addresses_A+0x11247, %rsi
lea addresses_WT+0x18f7f, %rdi
nop
nop
nop
nop
...
{'OP': 'REPM', 'src': {'type': 'addresses_A', 'congruent': 2, 'same': False}, 'dst': {'type': 'addresses_WT', 'congruent': 9, 'same': False}}
[Faulty Load]
