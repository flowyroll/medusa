...
movb (%rbx), %r15b
and $39535, %r15
lea addresses_A_ht+0x1e276, %rsi
lea addresses_normal_ht+0xe370, %rdi
nop
nop
nop
inc %r13
...
nop
dec %rcx
lea addresses_WT_ht+0xe9b4, %rdx
nop
dec %rsi
movb $0x61, (%rdx)
xor $19348, %r13
lea addresses_WT_ht+0x970, %rsi
nop
nop
nop
and $4133, %rdi
...
nop
and %rbp, %rbp
lea addresses_WT_ht+0xbc10, %rsi
nop
nop
sub %r13, %r13
movb $0x61, (%rsi)
...
// REPMOV
lea addresses_D+0x4343, %rsi
lea addresses_UC+0x1eb70, %rdi
nop
nop
nop
nop
...
{'src': {'congruent': 0, 'same': False, 'type': 'addresses_D'}, 'dst': {'congruent': 0, 'same': True, 'type': 'addresses_UC'}, 'OP': 'REPM'}
[Faulty Load]
...
{'src': {'congruent': 1, 'same': False, 'type': 'addresses_A_ht'}, 'dst': {'congruent': 11, 'same': True, 'type': 'addresses_normal_ht'}, 'OP': 'REPM'}
