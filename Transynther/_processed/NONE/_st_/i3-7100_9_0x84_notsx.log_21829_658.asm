...
push %rdi
push %rsi
lea addresses_UC_ht+0x17f75, %r14
nop
nop
dec %rbp
mov (%r14), %r13w
...
nop
cmp %r12, %r12
lea addresses_UC_ht+0x519, %rsi
lea addresses_normal_ht+0x109e1, %rdi
nop
cmp %r8, %r8
mov $78, %rcx
rep movsq
...
nop
and $31871, %rbp
lea addresses_normal_ht+0x5e99, %rcx
nop
nop
nop
nop
...
nop
add %rdi, %rdi
lea addresses_WT_ht+0x3399, %r13
nop
nop
add $62316, %r14
movups (%r13), %xmm5
...
nop
add %rsi, %rsi
lea addresses_normal_ht+0x81af, %rdi
nop
cmp %r12, %r12
movb $0x61, (%rdi)
nop
nop
sub $13363, %r8
lea addresses_WT_ht+0xb6ca, %rsi
lea addresses_WT_ht+0x1c699, %rdi
nop
nop
nop
nop
...
nop
dec %r13
lea addresses_normal_ht+0x155f9, %rdi
clflush (%rdi)
nop
nop
nop
...
nop
and $30924, %rsi
lea addresses_UC_ht+0x16299, %rcx
nop
nop
add %r12, %r12
...
nop
xor %rsi, %rsi
lea addresses_WT_ht+0x1199, %rcx
nop
nop
nop
inc %r12
...
{'src': {'type': 'addresses_WT_ht', 'congruent': 0, 'same': True}, 'dst': {'type': 'addresses_WT_ht', 'congruent': 10, 'same': False}, 'OP': 'REPM'}
...
{'src': {'type': 'addresses_WT_ht', 'same': True, 'size': 32, 'congruent': 6, 'NT': True, 'AVXalign': False}, 'OP': 'LOAD'}
{'58': 21829}
