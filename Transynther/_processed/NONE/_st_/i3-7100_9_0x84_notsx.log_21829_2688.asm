...
push %rdi
push %rsi
lea addresses_WT_ht+0x7f56, %rsi
...
{'src': {'type': 'addresses_WC', 'congruent': 0, 'same': False}, 'dst': {'type': 'addresses_A', 'congruent': 0, 'same': True}, 'OP': 'REPM'}
