...
push %rdi
push %rsi
lea addresses_normal_ht+0x96ae, %rax
nop
nop
nop
dec %rdi
...
nop
add %rax, %rax
lea addresses_WT_ht+0x12d6e, %rsi
lea addresses_normal_ht+0x77ae, %rdi
clflush (%rdi)
add %r12, %r12
mov $126, %rcx
rep movsq
...
vpextrq $0, %xmm6, %rcx
dec %rdi
lea addresses_D_ht+0x16eae, %r12
nop
nop
nop
inc %r13
...
nop
dec %r8
lea addresses_A_ht+0x1b45f, %r12
nop
and $44358, %rdi
mov (%r12), %r13w
nop
...
{'OP': 'STOR', 'dst': {'type': 'addresses_A', 'AVXalign': True, 'congruent': 2, 'size': 8, 'same': False, 'NT': True}}
