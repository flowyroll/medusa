...
push %rdx
push %rsi
lea addresses_normal_ht+0xf4f3, %r12
nop
nop
nop
nop
...
nop
and %rbx, %rbx
lea addresses_A_ht+0x13b33, %r12
nop
nop
nop
xor $36766, %r15
...
nop
cmp %r13, %r13
lea addresses_A_ht+0x15ab3, %rdx
clflush (%rdx)
nop
nop
sub %r11, %r11
...
nop
add $59168, %rdx
lea addresses_WC_ht+0x1deb3, %rsi
lea addresses_WC_ht+0x11f93, %rdi
nop
nop
and $33332, %r15
mov $122, %rcx
...
nop
sub %rdx, %rdx
lea addresses_A_ht+0x1913, %rsi
lea addresses_WT_ht+0x18eb3, %rdi
nop
add $21711, %rdx
mov $12, %rcx
rep movsw
...
nop
add $54700, %rcx
lea addresses_UC_ht+0x53b3, %rsi
lea addresses_normal_ht+0x6ab3, %rdi
nop
nop
nop
cmp %rbx, %rbx
...
rep movsb
mfence
lea addresses_D_ht+0x132b3, %rsi
nop
dec %r13
movb (%rsi), %r15b
nop
nop
and $36372, %rsi
lea addresses_normal_ht+0xacb3, %rsi
nop
nop
nop
nop
...
nop
inc %rdx
lea addresses_WC_ht+0xbe73, %rsi
lea addresses_WC_ht+0x1dab3, %rdi
clflush (%rdi)
nop
nop
nop
...
rep movsq
add $61143, %rcx
lea addresses_WC_ht+0x15eb3, %r15
nop
nop
nop
xor %r11, %r11
...
nop
dec %rcx
lea addresses_A_ht+0x1ad2e, %r13
nop
nop
nop
nop
...
nop
dec %rdx
lea addresses_normal_ht+0xc5e8, %rbx
nop
nop
and %r12, %r12
...
<gen_prepare_buffer>
{'OP': 'STOR', 'dst': {'size': 16, 'NT': True, 'type': 'addresses_normal_ht', 'same': False, 'AVXalign': False, 'congruent': 6}}
...
{'OP': 'REPM', 'src': {'same': True, 'type': 'addresses_WC_ht', 'congruent': 10}, 'dst': {'same': False, 'type': 'addresses_WC_ht', 'congruent': 5}}
{'OP': 'REPM', 'src': {'same': False, 'type': 'addresses_A_ht', 'congruent': 1}, 'dst': {'same': False, 'type': 'addresses_WT_ht', 'congruent': 9}}
{'OP': 'REPM', 'src': {'same': False, 'type': 'addresses_UC_ht', 'congruent': 8}, 'dst': {'same': False, 'type': 'addresses_normal_ht', 'congruent': 10}}
