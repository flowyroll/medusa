...
nop
dec %r11
lea addresses_A_ht+0x1a44e, %rsi
lea addresses_WC_ht+0x9c4e, %rdi
nop
nop
sub %r14, %r14
mov $68, %rcx
...
nop
sub %r13, %r13
lea addresses_D_ht+0x1db26, %rsi
lea addresses_WT_ht+0x1ba4e, %rdi
nop
nop
nop
add $39534, %r14
...
nop
add $34122, %rsi
lea addresses_WT_ht+0x1edce, %rsi
lea addresses_UC_ht+0x115b2, %rdi
add %r14, %r14
mov $22, %rcx
rep movsl
nop
...
{'OP': 'REPM', 'src': {'type': 'addresses_WT_ht', 'congruent': 7, 'same': False}, 'dst': {'type': 'addresses_UC_ht', 'congruent': 2, 'same': True}}
{'58': 21829}
