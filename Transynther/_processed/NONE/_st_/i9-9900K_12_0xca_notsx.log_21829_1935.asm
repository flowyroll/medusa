...
push %rbx
push %rcx
lea addresses_UC_ht+0xc242, %rcx
add %r11, %r11
vmovups (%rcx), %ymm5
...
// Store
lea addresses_normal+0x6a1a, %rdi
nop
nop
nop
nop
...
{'OP': 'STOR', 'dst': {'same': False, 'type': 'addresses_PSE', 'NT': False, 'AVXalign': True, 'size': 16, 'congruent': 7}}
