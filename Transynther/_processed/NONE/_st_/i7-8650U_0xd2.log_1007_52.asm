...
push %rdi
push %rsi
lea addresses_D_ht+0x1802d, %r15
nop
nop
nop
and $11594, %rbx
...
nop
sub %r11, %r11
lea addresses_WC_ht+0xab34, %r10
clflush (%r10)
nop
nop
nop
...
nop
sub $50184, %r15
lea addresses_normal_ht+0xb5b4, %r14
nop
dec %r10
movw $0x6162, (%r14)
nop
...
nop
add %r11, %r11
lea addresses_A_ht+0x13bb4, %rbx
nop
nop
nop
nop
...
movl $0x61626364, (%rbx)
add %rbx, %rbx
lea addresses_normal_ht+0x19ef4, %rsi
lea addresses_WT_ht+0x6cb4, %rdi
clflush (%rsi)
sub $41219, %rbx
mov $91, %rcx
rep movsw
...
{'OP': 'REPM', 'src': {'type': 'addresses_normal_ht', 'congruent': 2, 'same': True}, 'dst': {'type': 'addresses_WT_ht', 'congruent': 7, 'same': False}}
{'58': 1007}
