...
push %rdi
push %rsi
lea addresses_WT_ht+0x800a, %rsi
lea addresses_WT_ht+0xd1ba, %rdi
nop
nop
nop
nop
...
nop
cmp %r8, %r8
lea addresses_WT_ht+0x196da, %r12
cmp $49609, %rbx
movl $0x61626364, (%r12)
nop
nop
cmp $40239, %rdi
lea addresses_A_ht+0x954c, %r12
nop
nop
xor %rdi, %rdi
movw $0x6162, (%r12)
...
nop
and %rbx, %rbx
lea addresses_WC_ht+0x131ef, %rsi
lea addresses_normal_ht+0x1415a, %rdi
nop
nop
add $36920, %r12
mov $1, %rcx
rep movsq
xor %r8, %r8
lea addresses_WC_ht+0x11da, %rbx
nop
and %rsi, %rsi
mov (%rbx), %r8
dec %r12
lea addresses_A_ht+0x10c5a, %rsi
lea addresses_normal_ht+0x1195a, %rdi
nop
nop
and $24525, %r13
mov $27, %rcx
...
nop
xor $48532, %rsi
lea addresses_A_ht+0x6a5a, %rsi
lea addresses_normal_ht+0xc0c8, %rdi
nop
nop
nop
xor $57143, %r13
...
nop
xor $21108, %rsi
lea addresses_WC_ht+0xe488, %r13
nop
nop
inc %rbx
movl $0x61626364, (%r13)
...
{'OP': 'STOR', 'dst': {'type': 'addresses_WC', 'size': 8, 'AVXalign': False, 'NT': True, 'congruent': 4, 'same': False}}
[Faulty Load]
...
{'OP': 'REPM', 'src': {'type': 'addresses_A_ht', 'congruent': 11, 'same': True}, 'dst': {'type': 'addresses_normal_ht', 'congruent': 8, 'same': False}}
