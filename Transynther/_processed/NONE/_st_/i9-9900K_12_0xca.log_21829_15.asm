...
push %rdi
push %rsi
lea addresses_UC_ht+0x167b3, %rsi
lea addresses_WC_ht+0x182ac, %rdi
nop
nop
nop
nop
...
nop
and %r10, %r10
lea addresses_WT_ht+0x16f4b, %rcx
sub %r15, %r15
movb $0x61, (%rcx)
nop
nop
