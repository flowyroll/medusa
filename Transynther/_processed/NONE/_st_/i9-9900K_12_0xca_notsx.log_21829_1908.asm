...
push %rdi
push %rsi
lea addresses_normal_ht+0x1a0ef, %r12
nop
nop
nop
and %rsi, %rsi
...
nop
cmp $26184, %r14
lea addresses_WT_ht+0x3dc5, %r14
nop
nop
nop
nop
...
nop
xor %r14, %r14
lea addresses_D_ht+0x18a7f, %r9
dec %rbx
mov $0x6162636465666768, %r14
movq %r14, (%r9)
dec %r14
lea addresses_D_ht+0x847f, %rbx
nop
nop
add %r9, %r9
movw $0x6162, (%rbx)
...
nop
dec %rbx
lea addresses_WT_ht+0x1367f, %rcx
nop
nop
add %rbx, %rbx
movb $0x61, (%rcx)
...
nop
sub $9302, %r14
lea addresses_UC_ht+0x1b3f, %rdi
nop
nop
nop
sub %rsi, %rsi
...
// REPMOV
lea addresses_WC+0x1547f, %rsi
lea addresses_PSE+0x8c7f, %rdi
clflush (%rdi)
nop
nop
sub $26404, %rax
...
{'OP': 'REPM', 'src': {'same': False, 'congruent': 11, 'type': 'addresses_WC'}, 'dst': {'same': True, 'congruent': 0, 'type': 'addresses_PSE'}}
...
{'OP': 'REPM', 'src': {'same': False, 'congruent': 7, 'type': 'addresses_A_ht'}, 'dst': {'same': False, 'congruent': 1, 'type': 'addresses_WC_ht'}}
{'OP': 'STOR', 'dst': {'same': False, 'type': 'addresses_WT_ht', 'NT': False, 'AVXalign': False, 'size': 1, 'congruent': 9}}
{'OP': 'STOR', 'dst': {'same': True, 'type': 'addresses_UC_ht', 'NT': False, 'AVXalign': False, 'size': 1, 'congruent': 6}}
{'38': 21829}
