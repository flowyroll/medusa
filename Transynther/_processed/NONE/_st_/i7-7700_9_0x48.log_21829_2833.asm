...
push %rdx
push %rsi
lea addresses_WT_ht+0x15489, %r13
sub %rbx, %rbx
movb $0x61, (%r13)
and %rax, %rax
lea addresses_A_ht+0x1ed89, %rbp
clflush (%rbp)
nop
nop
inc %r9
...
lea addresses_WC_ht+0xd089, %rdi
nop
nop
xor %rbp, %rbp
mov $118, %rcx
...
nop
sub $54127, %r13
lea addresses_normal_ht+0x1c747, %rax
nop
nop
nop
nop
...
movw $0x6162, (%rbp)
mfence
lea addresses_WT_ht+0x1ea85, %r9
nop
nop
nop
nop
...
nop
and %rcx, %rcx
lea addresses_normal_ht+0x6c89, %rcx
clflush (%rcx)
nop
nop
nop
...
// Store
lea addresses_normal+0xe49, %r11
nop
nop
nop
nop
...
{'OP': 'STOR', 'dst': {'type': 'addresses_A_ht', 'AVXalign': False, 'congruent': 8, 'size': 32, 'same': False, 'NT': True}}
...
{'OP': 'STOR', 'dst': {'type': 'addresses_A_ht', 'AVXalign': True, 'congruent': 6, 'size': 2, 'same': False, 'NT': False}}
...
{'OP': 'STOR', 'dst': {'type': 'addresses_D_ht', 'AVXalign': False, 'congruent': 8, 'size': 8, 'same': True, 'NT': False}}
{'51': 21829}
