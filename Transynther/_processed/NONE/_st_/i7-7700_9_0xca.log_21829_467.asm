...
push %rdx
push %rsi
lea addresses_A_ht+0x146ab, %rsi
lea addresses_normal_ht+0x163db, %rdi
nop
nop
xor $33448, %r9
mov $42, %rcx
...
nop
sub %r11, %r11
lea addresses_WC_ht+0x18b3f, %r9
nop
nop
nop
mfence
...
nop
sub $58077, %r11
lea addresses_WC_ht+0xdd93, %rbx
nop
nop
nop
nop
...
nop
and $40734, %rsi
lea addresses_WT_ht+0x16bbf, %rsi
lea addresses_WC_ht+0x1a2e1, %rdi
nop
nop
nop
nop
...
lea addresses_WC_ht+0x86a7, %rdi
nop
nop
nop
cmp $3270, %rdx
...
{'src': {'congruent': 6, 'AVXalign': True, 'same': False, 'size': 8, 'NT': False, 'type': 'addresses_NC'}, 'OP': 'LOAD'}
...
{'src': {'congruent': 7, 'same': False, 'type': 'addresses_WT_ht'}, 'OP': 'REPM', 'dst': {'congruent': 0, 'same': False, 'type': 'addresses_WC_ht'}}
