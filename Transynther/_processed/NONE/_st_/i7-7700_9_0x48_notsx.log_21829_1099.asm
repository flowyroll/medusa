...
push %rdi
push %rsi
lea addresses_D_ht+0x190d, %rsi
lea addresses_A_ht+0x1e9fd, %rdi
nop
nop
nop
nop
...
// REPMOV
lea addresses_WT+0x1ef5d, %rsi
lea addresses_A+0xc5fd, %rdi
clflush (%rsi)
nop
nop
sub $15476, %r10
...
// REPMOV
lea addresses_WC+0x129b9, %rsi
lea addresses_WT+0x161fd, %rdi
nop
nop
nop
nop
...
{'dst': {'same': False, 'congruent': 8, 'type': 'addresses_A'}, 'OP': 'REPM', 'src': {'same': False, 'congruent': 5, 'type': 'addresses_WT'}}
{'dst': {'same': True, 'congruent': 0, 'type': 'addresses_WT'}, 'OP': 'REPM', 'src': {'same': False, 'congruent': 1, 'type': 'addresses_WC'}}
...
{'OP': 'LOAD', 'src': {'same': False, 'NT': False, 'AVXalign': True, 'size': 32, 'type': 'addresses_WT', 'congruent': 7}}
