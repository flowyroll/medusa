...
push %rdx
push %rsi
lea addresses_normal_ht+0x2198, %rbx
clflush (%rbx)
nop
nop
nop
...
nop
sub %rax, %rax
lea addresses_UC_ht+0x1a98, %r11
nop
nop
nop
and %rsi, %rsi
...
nop
xor $25214, %rdx
lea addresses_D_ht+0x125e8, %rsi
nop
nop
nop
nop
...
nop
cmp %r11, %r11
lea addresses_A_ht+0x12298, %rsi
lea addresses_UC_ht+0x18328, %rdi
nop
inc %rbp
mov $127, %rcx
rep movsq
...
nop
and %rbx, %rbx
lea addresses_WT_ht+0x11098, %r11
nop
nop
nop
nop
...
nop
inc %rdx
lea addresses_UC_ht+0x19e98, %rsi
lea addresses_WT_ht+0x17ad8, %rdi
inc %r11
mov $78, %rcx
rep movsl
nop
...
// REPMOV
lea addresses_D+0x8698, %rsi
lea addresses_PSE+0x17698, %rdi
nop
nop
nop
nop
...
{'src': {'type': 'addresses_D', 'congruent': 10, 'same': False}, 'OP': 'REPM', 'dst': {'type': 'addresses_PSE', 'congruent': 0, 'same': True}}
{'OP': 'STOR', 'dst': {'same': False, 'congruent': 8, 'NT': False, 'type': 'addresses_UC', 'size': 16, 'AVXalign': True}}
[Faulty Load]
