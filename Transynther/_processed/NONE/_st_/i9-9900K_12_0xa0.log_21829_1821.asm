...
push %rdi
push %rsi
lea addresses_WC_ht+0xbe34, %rsi
nop
nop
nop
nop
...
nop
add $35340, %r10
lea addresses_WT_ht+0x1a574, %rbx
inc %rsi
movups (%rbx), %xmm3
vpextrq $0, %xmm3, %rbp
nop
cmp $60804, %r13
lea addresses_A_ht+0xc2fe, %rsi
lea addresses_D_ht+0xa374, %rdi
nop
nop
and %r15, %r15
mov $50, %rcx
...
nop
cmp %rdi, %rdi
lea addresses_A_ht+0x1356c, %rbp
nop
add %r15, %r15
movb $0x61, (%rbp)
nop
...
nop
cmp %rcx, %rcx
lea addresses_UC_ht+0x32f4, %r10
nop
nop
nop
nop
...
nop
cmp %rdi, %rdi
lea addresses_WC_ht+0x1e034, %rbx
xor %rsi, %rsi
movb (%rbx), %r15b
nop
nop
...
// Store
lea addresses_normal+0xbcf4, %rax
nop
cmp $56600, %rbx
movw $0x5152, (%rax)
nop
...
// Faulty Load
lea addresses_normal+0xbcf4, %rsi
nop
cmp %rbp, %rbp
mov (%rsi), %r10d
lea oracles, %r9
...
{'src': {'same': False, 'congruent': 0, 'type': 'addresses_A_ht'}, 'OP': 'REPM', 'dst': {'same': False, 'congruent': 5, 'type': 'addresses_D_ht'}}
{'OP': 'STOR', 'dst': {'NT': False, 'same': False, 'congruent': 2, 'type': 'addresses_A_ht', 'AVXalign': False, 'size': 1}}
{'OP': 'STOR', 'dst': {'NT': True, 'same': False, 'congruent': 8, 'type': 'addresses_UC_ht', 'AVXalign': False, 'size': 4}}
