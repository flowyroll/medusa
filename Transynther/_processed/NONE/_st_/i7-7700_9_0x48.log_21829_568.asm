...
push %rax
push %rdx
lea addresses_UC_ht+0x1c613, %r14
nop
nop
nop
nop
...
// Store
lea addresses_normal+0x154db, %rsi
nop
nop
nop
and %r10, %r10
...
{'OP': 'STOR', 'dst': {'type': 'addresses_P', 'AVXalign': False, 'congruent': 8, 'size': 2, 'same': False, 'NT': True}}
...
{'OP': 'STOR', 'dst': {'type': 'addresses_UC', 'AVXalign': True, 'congruent': 2, 'size': 8, 'same': False, 'NT': False}}
