...
movw $0x6162, (%r8)
add $27133, %r11
lea addresses_normal_ht+0x625d, %r8
nop
nop
nop
nop
...
nop
dec %r11
lea addresses_D_ht+0xb9b5, %rsi
lea addresses_WT_ht+0xe5e5, %rdi
xor $51212, %r8
mov $127, %rcx
rep movsb
nop
and $55611, %r11
lea addresses_UC_ht+0x11725, %r12
nop
nop
sub $41229, %rsi
mov (%r12), %r10
...
nop
inc %rsi
lea addresses_D_ht+0x7e3b, %rsi
lea addresses_normal_ht+0x18625, %rdi
add %r8, %r8
mov $22, %rcx
rep movsb
nop
...
nop
and %r10, %r10
lea addresses_WC_ht+0xd725, %rdi
add $41012, %r10
mov (%rdi), %r13
nop
nop
nop
xor $20950, %rdx
lea addresses_WT_ht+0x4f25, %r12
nop
nop
nop
nop
...
nop
cmp $62214, %r13
lea addresses_WT_ht+0x1a725, %r8
nop
nop
nop
nop
...
movw $0x6162, (%r8)
xor $25616, %r13
lea addresses_WC_ht+0x6325, %r11
nop
nop
nop
nop
...
// REPMOV
lea addresses_A+0x112e5, %rsi
lea addresses_normal+0x19f25, %rdi
nop
nop
nop
sub %r11, %r11
...
// Faulty Load
lea addresses_normal+0x19f25, %r15
nop
xor $11438, %rax
mov (%r15), %r11w
lea oracles, %rdi
...
{'src': {'type': 'addresses_A', 'congruent': 5, 'same': False}, 'dst': {'type': 'addresses_normal', 'congruent': 0, 'same': True}, 'OP': 'REPM'}
[Faulty Load]
...
{'src': {'type': 'addresses_D_ht', 'congruent': 1, 'same': False}, 'dst': {'type': 'addresses_normal_ht', 'congruent': 7, 'same': True}, 'OP': 'REPM'}
