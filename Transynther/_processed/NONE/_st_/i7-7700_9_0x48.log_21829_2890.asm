...
push %rdi
push %rsi
lea addresses_normal_ht+0x9e36, %rsi
lea addresses_WT_ht+0x1053c, %rdi
clflush (%rsi)
clflush (%rdi)
and $3020, %rbx
mov $21, %rcx
...
nop
xor %r10, %r10
lea addresses_WT_ht+0x141de, %r9
nop
nop
nop
cmp %r14, %r14
...
nop
add $5151, %r10
lea addresses_D_ht+0x1b6fe, %rdi
nop
sub %r10, %r10
movl $0x61626364, (%rdi)
nop
...
nop
inc %r14
lea addresses_WT_ht+0xa702, %rbx
nop
nop
inc %r10
...
nop
sub %r9, %r9
lea addresses_D_ht+0x1a742, %r14
nop
nop
nop
nop
...
<gen_prepare_buffer>
{'OP': 'REPM', 'src': {'type': 'addresses_normal_ht', 'congruent': 2, 'same': True}, 'dst': {'type': 'addresses_WT_ht', 'congruent': 1, 'same': False}}
