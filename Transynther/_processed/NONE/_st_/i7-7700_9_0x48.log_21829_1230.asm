...
push %rdx
push %rsi
lea addresses_WT_ht+0x118a8, %rsi
nop
nop
nop
nop
...
nop
inc %r10
lea addresses_normal_ht+0x154a8, %rsi
lea addresses_WC_ht+0x188a8, %rdi
xor $23712, %r10
mov $62, %rcx
rep movsw
nop
nop
inc %rcx
lea addresses_WT_ht+0x1d928, %rsi
lea addresses_WC_ht+0x194e0, %rdi
nop
nop
xor %rdx, %rdx
mov $109, %rcx
...
nop
sub $45824, %rsi
lea addresses_WT_ht+0xe2a8, %rsi
clflush (%rsi)
nop
nop
nop
...
nop
inc %rsi
lea addresses_normal_ht+0x80a8, %r10
nop
nop
nop
nop
...
nop
xor %r10, %r10
lea addresses_WT_ht+0xf28, %rax
and $31644, %rdx
movw $0x6162, (%rax)
nop
inc %rcx
lea addresses_D_ht+0x12991, %rdi
nop
nop
xor %rdx, %rdx
movups (%rdi), %xmm1
...
nop
inc %r8
lea addresses_UC_ht+0x1e1a8, %r10
nop
inc %rdx
mov $0x6162636465666768, %rax
movq %rax, (%r10)
...
nop
and %rsi, %rsi
lea addresses_WC_ht+0x128a8, %rsi
lea addresses_normal_ht+0x138a8, %rdi
clflush (%rsi)
nop
nop
nop
...
nop
cmp %rdx, %rdx
lea addresses_D_ht+0x1276c, %r10
xor $28318, %rdi
...
// REPMOV
lea addresses_D+0x3ea8, %rsi
lea addresses_PSE+0x70a8, %rdi
nop
nop
nop
nop
...
{'OP': 'REPM', 'src': {'type': 'addresses_D', 'congruent': 7, 'same': False}, 'dst': {'type': 'addresses_PSE', 'congruent': 0, 'same': True}}
[Faulty Load]
