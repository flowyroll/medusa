...
push %rdx
push %rsi
lea addresses_normal_ht+0x6e93, %rbx
nop
nop
nop
xor %r9, %r9
...
nop
cmp %rdx, %rdx
lea addresses_WT_ht+0x8dc3, %rcx
nop
and %r10, %r10
mov (%rcx), %r15w
nop
...
nop
add $1647, %rbx
lea addresses_WC_ht+0x16343, %rdx
nop
nop
nop
add %r15, %r15
...
nop
cmp %r10, %r10
lea addresses_WC_ht+0x13c03, %rbx
clflush (%rbx)
nop
nop
cmp $6704, %rdx
...
nop
xor $49133, %rcx
lea addresses_UC_ht+0x12343, %rsi
lea addresses_UC_ht+0x1cd23, %rdi
nop
inc %rbx
mov $77, %rcx
rep movsl
add $44349, %rdi
lea addresses_WT_ht+0x4b43, %rbx
cmp %r10, %r10
...
// Store
lea addresses_normal+0x1ef43, %rcx
nop
and %rdx, %rdx
movl $0x51525354, (%rcx)
nop
...
// Store
lea addresses_normal+0x18ec3, %r8
nop
nop
nop
nop
...
{'OP': 'STOR', 'dst': {'type': 'addresses_WT', 'size': 1, 'AVXalign': False, 'NT': True, 'congruent': 6, 'same': False}}
