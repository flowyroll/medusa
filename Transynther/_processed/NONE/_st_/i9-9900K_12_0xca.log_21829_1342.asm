...
push %rdi
push %rsi
lea addresses_WT_ht+0x1b575, %r8
nop
sub %r15, %r15
...
nop
xor %r9, %r9
lea addresses_D_ht+0x1b175, %rax
nop
nop
nop
xor $59347, %r11
...
nop
inc %rcx
lea addresses_WC_ht+0xe6fa, %r15
nop
nop
nop
nop
...
nop
cmp $26588, %r11
lea addresses_UC_ht+0xdef5, %rsi
lea addresses_A_ht+0x1bca2, %rdi
and %r11, %r11
mov $120, %rcx
rep movsq
nop
...
nop
sub %r9, %r9
lea addresses_WT_ht+0x160b5, %rsi
lea addresses_WC_ht+0xd315, %rdi
nop
nop
add $53482, %r9
mov $120, %rcx
...
nop
sub $18385, %rax
lea addresses_normal_ht+0x4475, %rsi
lea addresses_normal_ht+0xc975, %rdi
clflush (%rdi)
xor %r8, %r8
mov $4, %rcx
rep movsw
...
nop
xor %r9, %r9
lea addresses_normal_ht+0x17a0a, %rsi
...
// Load
lea addresses_normal+0xa775, %r11
nop
nop
nop
nop
...
{'OP': 'STOR', 'dst': {'size': 4, 'NT': True, 'type': 'addresses_UC', 'same': False, 'AVXalign': False, 'congruent': 11}}
{'OP': 'LOAD', 'src': {'size': 16, 'NT': False, 'type': 'addresses_normal', 'same': False, 'AVXalign': False, 'congruent': 8}}
[Faulty Load]
...
{'OP': 'REPM', 'src': {'same': False, 'type': 'addresses_UC_ht', 'congruent': 7}, 'dst': {'same': False, 'type': 'addresses_A_ht', 'congruent': 0}}
...
{'OP': 'REPM', 'src': {'same': False, 'type': 'addresses_normal_ht', 'congruent': 7}, 'dst': {'same': False, 'type': 'addresses_normal_ht', 'congruent': 11}}
