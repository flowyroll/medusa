...
nop
add $19115, %rsi
lea addresses_D_ht+0x16139, %rdi
nop
sub $26896, %r12
movb $0x61, (%rdi)
add %rcx, %rcx
lea addresses_A_ht+0x19439, %r8
nop
add %rbx, %rbx
vmovups (%r8), %ymm7
...
nop
dec %rbx
lea addresses_WC_ht+0xc8e9, %rcx
nop
nop
nop
add %rdi, %rdi
...
// REPMOV
lea addresses_RW+0x7039, %rsi
lea addresses_A+0x17c39, %rdi
nop
inc %r10
mov $1, %rcx
rep movsl
...
// REPMOV
lea addresses_RW+0x1c939, %rsi
lea addresses_WC+0x8139, %rdi
nop
dec %r15
mov $6, %rcx
rep movsb
...
// REPMOV
lea addresses_WT+0x6339, %rsi
lea addresses_A+0x1e607, %rdi
nop
nop
nop
nop
...
{'src': {'type': 'addresses_RW', 'congruent': 9, 'same': False}, 'OP': 'REPM', 'dst': {'type': 'addresses_A', 'congruent': 0, 'same': True}}
...
{'src': {'type': 'addresses_RW', 'congruent': 8, 'same': False}, 'OP': 'REPM', 'dst': {'type': 'addresses_WC', 'congruent': 7, 'same': False}}
{'src': {'type': 'addresses_WT', 'congruent': 7, 'same': False}, 'OP': 'REPM', 'dst': {'type': 'addresses_A', 'congruent': 1, 'same': False}}
...
<gen_prepare_buffer>
{'src': {'same': True, 'congruent': 9, 'NT': False, 'type': 'addresses_A_ht', 'size': 1, 'AVXalign': False}, 'OP': 'LOAD'}
