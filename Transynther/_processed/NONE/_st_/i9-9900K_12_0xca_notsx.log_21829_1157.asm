...
push %rdx
push %rsi
lea addresses_normal_ht+0xb373, %r11
nop
nop
dec %r15
movb $0x61, (%r11)
...
nop
dec %r8
lea addresses_normal_ht+0x8221, %rsi
lea addresses_normal_ht+0x114ef, %rdi
nop
nop
nop
nop
...
nop
and %r8, %r8
lea addresses_WT_ht+0x1e583, %rdx
nop
nop
nop
nop
...
nop
and $60934, %r9
lea addresses_WC_ht+0x3623, %rsi
lea addresses_WT_ht+0x52a3, %rdi
nop
nop
nop
nop
...
nop
cmp %rcx, %rcx
lea addresses_WT_ht+0x1c6a3, %rsi
clflush (%rsi)
nop
nop
nop
...
vmovntdq %ymm1, (%rsi)
cmp $62081, %rcx
lea addresses_WC_ht+0xd4a3, %rsi
lea addresses_D_ht+0x8713, %rdi
nop
nop
nop
inc %r8
...
nop
add $56727, %r15
lea addresses_A_ht+0xd223, %rsi
lea addresses_A_ht+0xff23, %rdi
nop
and %rdx, %rdx
mov $119, %rcx
rep movsb
and $34562, %r11
lea addresses_normal_ht+0x1a2a3, %rdi
nop
nop
nop
cmp %r9, %r9
...
nop
add $2067, %r9
lea addresses_WT_ht+0x4237, %rsi
lea addresses_D_ht+0x4e83, %rdi
nop
nop
nop
inc %rdx
...
nop
and %r9, %r9
lea addresses_WC_ht+0x134a3, %rsi
...
<gen_prepare_buffer>
{'OP': 'STOR', 'dst': {'same': False, 'type': 'addresses_normal_ht', 'NT': True, 'AVXalign': True, 'size': 1, 'congruent': 4}}
...
{'OP': 'REPM', 'src': {'same': False, 'congruent': 9, 'type': 'addresses_WC_ht'}, 'dst': {'same': False, 'congruent': 1, 'type': 'addresses_D_ht'}}
