...
lea addresses_WT_ht+0x13051, %rdi
nop
nop
nop
nop
...
nop
cmp %r10, %r10
lea addresses_A_ht+0xf961, %rsi
lea addresses_A_ht+0xd399, %rdi
inc %rbp
mov $19, %rcx
rep movsq
nop
nop
add %rcx, %rcx
lea addresses_WT_ht+0x654d, %rcx
clflush (%rcx)
nop
nop
nop
...
nop
cmp %r9, %r9
lea addresses_UC_ht+0x1116d, %rsi
nop
nop
add $1465, %r9
mov (%rsi), %r10w
nop
add $24894, %rsi
lea addresses_A_ht+0x714d, %rsi
lea addresses_A_ht+0x1994d, %rdi
nop
nop
nop
xor $1614, %rbp
...
nop
xor $17185, %rcx
lea addresses_UC_ht+0xc94d, %rcx
nop
nop
nop
inc %r10
...
// Store
lea addresses_normal+0x1b94d, %rbp
nop
nop
nop
nop
...
{'OP': 'LOAD', 'src': {'type': 'addresses_A', 'AVXalign': False, 'congruent': 9, 'size': 2, 'same': False, 'NT': False}}
{'OP': 'STOR', 'dst': {'type': 'addresses_NC', 'AVXalign': True, 'congruent': 8, 'size': 1, 'same': False, 'NT': False}}
{'OP': 'STOR', 'dst': {'type': 'addresses_WT', 'AVXalign': False, 'congruent': 7, 'size': 8, 'same': False, 'NT': False}}
{'OP': 'STOR', 'dst': {'type': 'addresses_normal', 'AVXalign': True, 'congruent': 10, 'size': 16, 'same': False, 'NT': True}}
[Faulty Load]
