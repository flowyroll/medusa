...
nop
add %rsi, %rsi
lea addresses_UC_ht+0x11cff, %rsi
lea addresses_normal_ht+0x4607, %rdi
nop
nop
nop
and %rdx, %rdx
...
nop
cmp $7158, %rdi
lea addresses_UC_ht+0xee07, %rsi
dec %r15
...
nop
and $6194, %rcx
lea addresses_WC_ht+0x2527, %rcx
nop
sub $57258, %r13
movups (%rcx), %xmm1
vpextrq $0, %xmm1, %rsi
...
nop
and %rcx, %rcx
lea addresses_WC_ht+0x17f87, %rdx
clflush (%rdx)
nop
nop
sub %rsi, %rsi
...
nop
xor %rdx, %rdx
lea addresses_WC_ht+0x2b17, %rsi
lea addresses_WC_ht+0x9287, %rdi
nop
nop
nop
nop
...
nop
and %rdi, %rdi
lea addresses_UC_ht+0x9687, %rdi
nop
nop
nop
xor %rdx, %rdx
...
vmovups %ymm3, (%rdi)
sub $43269, %r13
lea addresses_D_ht+0x1bb07, %rsi
lea addresses_D_ht+0x8a43, %rdi
clflush (%rdi)
nop
nop
nop
...
nop
xor $2813, %rdx
lea addresses_WT_ht+0x148d9, %rdi
nop
nop
nop
inc %r13
movl $0x61626364, (%rdi)
sub $8062, %rcx
lea addresses_UC_ht+0xcb07, %r13
nop
nop
nop
nop
...
<gen_prepare_buffer>
{'src': {'congruent': 6, 'AVXalign': False, 'same': False, 'size': 16, 'NT': True, 'type': 'addresses_normal_ht'}, 'OP': 'LOAD'}
{'src': {'congruent': 1, 'same': False, 'type': 'addresses_UC_ht'}, 'OP': 'REPM', 'dst': {'congruent': 7, 'same': False, 'type': 'addresses_normal_ht'}}
...
{'OP': 'STOR', 'dst': {'congruent': 10, 'AVXalign': False, 'same': True, 'size': 32, 'NT': False, 'type': 'addresses_UC_ht'}}
{'src': {'congruent': 0, 'same': True, 'type': 'addresses_D_ht'}, 'OP': 'REPM', 'dst': {'congruent': 2, 'same': False, 'type': 'addresses_D_ht'}}
