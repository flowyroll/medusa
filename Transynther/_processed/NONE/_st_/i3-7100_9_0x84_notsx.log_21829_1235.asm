...
nop
lfence
lea addresses_D_ht+0x16c76, %rsi
lea addresses_normal_ht+0x9196, %rdi
clflush (%rsi)
nop
nop
xor $59765, %r8
...
nop
inc %r9
lea addresses_UC_ht+0xb554, %rsi
lea addresses_D_ht+0x1d136, %rdi
clflush (%rsi)
nop
sub %rbp, %rbp
mov $97, %rcx
...
nop
and $27253, %r8
lea addresses_A_ht+0x61b6, %rsi
lea addresses_UC_ht+0x12c3c, %rdi
clflush (%rsi)
cmp $25846, %r15
mov $71, %rcx
rep movsq
...
nop
cmp %r14, %r14
lea addresses_normal_ht+0x3210, %r14
nop
nop
and %rsi, %rsi
...
movups %xmm3, (%r14)
inc %r14
lea addresses_UC_ht+0x18536, %rdi
nop
nop
xor %r8, %r8
movb (%rdi), %r9b
...
nop
add %rbp, %rbp
lea addresses_UC_ht+0x13ef6, %rcx
nop
add $11145, %rdi
mov (%rcx), %r15d
sub $44092, %r15
lea addresses_D_ht+0xafb6, %r15
clflush (%r15)
nop
nop
nop
...
nop
cmp %r8, %r8
lea addresses_WT_ht+0x13ca4, %r8
cmp $49417, %r15
vmovups (%r8), %ymm3
...
<gen_faulty_load>
[REF]
{'src': {'type': 'addresses_PSE', 'same': False, 'size': 1, 'congruent': 0, 'NT': True, 'AVXalign': True}, 'OP': 'LOAD'}
...
<gen_prepare_buffer>
{'dst': {'type': 'addresses_WT_ht', 'same': False, 'size': 4, 'congruent': 8, 'NT': True, 'AVXalign': False}, 'OP': 'STOR'}
{'dst': {'type': 'addresses_WC_ht', 'same': True, 'size': 1, 'congruent': 7, 'NT': False, 'AVXalign': False}, 'OP': 'STOR'}
{'src': {'type': 'addresses_D_ht', 'congruent': 4, 'same': False}, 'dst': {'type': 'addresses_normal_ht', 'congruent': 4, 'same': False}, 'OP': 'REPM'}
