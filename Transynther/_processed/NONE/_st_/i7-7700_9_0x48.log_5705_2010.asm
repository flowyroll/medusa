...
nop
dec %r8
lea addresses_normal_ht+0x16ebb, %rdx
nop
cmp $7577, %r10
...
nop
add $35952, %rsi
lea addresses_D_ht+0x11fbb, %r11
nop
nop
nop
add %rbx, %rbx
...
nop
add %r10, %r10
lea addresses_normal_ht+0x507f, %rsi
lea addresses_normal_ht+0xdec1, %rdi
nop
nop
xor $7541, %rdx
mov $125, %rcx
...
nop
and $64615, %r10
lea addresses_D_ht+0x1c56e, %rdi
nop
nop
nop
cmp %rcx, %rcx
...
nop
add $32949, %rdx
lea addresses_UC_ht+0x12cbb, %rsi
lea addresses_WT_ht+0x8e3b, %rdi
nop
nop
nop
nop
...
rep movsw
and $54316, %r8
lea addresses_normal_ht+0x16e3b, %rbx
clflush (%rbx)
nop
nop
and %rdi, %rdi
...
{'OP': 'LOAD', 'src': {'type': 'addresses_US', 'AVXalign': False, 'congruent': 2, 'size': 2, 'same': False, 'NT': False}}
...
{'OP': 'LOAD', 'src': {'type': 'addresses_RW', 'AVXalign': True, 'congruent': 2, 'size': 2, 'same': False, 'NT': False}}
[Faulty Load]
...
{'OP': 'STOR', 'dst': {'type': 'addresses_D_ht', 'AVXalign': True, 'congruent': 0, 'size': 8, 'same': False, 'NT': False}}
