...
nop
sub $52436, %rdx
lea addresses_UC_ht+0x10ffd, %r10
and %r8, %r8
movb (%r10), %r13b
nop
nop
...
nop
and %r8, %r8
lea addresses_WT_ht+0x179a9, %rdx
add %rdi, %rdi
mov (%rdx), %r13w
add $25080, %rcx
lea addresses_A_ht+0xb5f9, %r10
nop
nop
nop
sub %rdx, %rdx
...
<gen_prepare_buffer>
{'OP': 'REPM', 'src': {'type': 'addresses_UC_ht', 'congruent': 0, 'same': False}, 'dst': {'type': 'addresses_WT_ht', 'congruent': 3, 'same': True}}
