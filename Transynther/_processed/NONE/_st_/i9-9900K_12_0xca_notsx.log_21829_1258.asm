...
movl $0x61626364, (%rax)
dec %rax
lea addresses_normal_ht+0x49f2, %r12
nop
nop
nop
nop
...
// Store
lea addresses_normal+0xfda8, %r9
clflush (%r9)
nop
nop
inc %rbp
...
// REPMOV
lea addresses_PSE+0x15398, %rsi
lea addresses_D+0x115a8, %rdi
nop
nop
nop
inc %r8
...
{'OP': 'REPM', 'src': {'same': False, 'congruent': 4, 'type': 'addresses_PSE'}, 'dst': {'same': True, 'congruent': 0, 'type': 'addresses_D'}}
