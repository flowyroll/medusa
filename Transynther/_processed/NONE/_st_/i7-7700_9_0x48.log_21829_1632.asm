...
lea addresses_WC_ht+0x1d2a3, %rdi
dec %r12
mov $75, %rcx
rep movsl
nop
dec %rdi
lea addresses_WC_ht+0x1efa3, %rsi
clflush (%rsi)
sub $39247, %rdx
mov (%rsi), %di
nop
...
nop
sub $53545, %r12
lea addresses_WC_ht+0x162a3, %rdx
xor %rdi, %rdi
mov (%rdx), %ecx
nop
nop
...
// Store
lea addresses_normal+0x13343, %r13
nop
nop
nop
add %r15, %r15
