...
push %rdi
push %rsi
lea addresses_A_ht+0x18011, %r14
nop
nop
nop
nop
...
nop
cmp $39324, %r9
lea addresses_A_ht+0x12611, %rdi
nop
nop
xor %r8, %r8
movw $0x6162, (%rdi)
...
nop
inc %rdi
lea addresses_WC_ht+0x4e11, %r14
nop
nop
nop
nop
...
nop
and $34595, %rsi
lea addresses_UC_ht+0x4611, %rsi
clflush (%rsi)
nop
sub $16116, %rcx
...
nop
dec %r14
lea addresses_normal_ht+0x1ce11, %r15
and %rcx, %rcx
vmovups (%r15), %ymm5
...
// REPMOV
lea addresses_D+0x15011, %rsi
lea addresses_PSE+0x14e11, %rdi
nop
nop
nop
and $25494, %r10
...
{'dst': {'same': True, 'congruent': 0, 'type': 'addresses_PSE'}, 'OP': 'REPM', 'src': {'same': False, 'congruent': 9, 'type': 'addresses_D'}}
[Faulty Load]
