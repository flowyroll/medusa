...
push %rdx
push %rsi
lea addresses_UC_ht+0x1bfb5, %rdi
sub $2564, %rbp
movups (%rdi), %xmm1
vpextrq $0, %xmm1, %r8
nop
...
nop
add %rdx, %rdx
lea addresses_D_ht+0x4075, %rsi
lea addresses_normal_ht+0x1c575, %rdi
nop
nop
nop
add %rbp, %rbp
...
// Store
lea addresses_normal+0xf475, %r14
nop
nop
cmp %rax, %rax
movl $0x51525354, (%r14)
...
// REPMOV
lea addresses_WT+0x7875, %rsi
lea addresses_D+0x11175, %rdi
nop
nop
nop
and %rax, %rax
