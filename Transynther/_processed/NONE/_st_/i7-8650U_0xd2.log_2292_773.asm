...
nop
dec %r10
lea addresses_A_ht+0x1ade3, %rcx
nop
nop
nop
nop
...
// Load
lea addresses_normal+0x1d5a3, %rdi
nop
add %rcx, %rcx
movups (%rdi), %xmm3
vpextrq $1, %xmm3, %rbx
...
{'OP': 'LOAD', 'src': {'type': 'addresses_P', 'size': 4, 'AVXalign': False, 'NT': False, 'congruent': 1, 'same': False}}
{'OP': 'LOAD', 'src': {'type': 'addresses_WT', 'size': 8, 'AVXalign': False, 'NT': False, 'congruent': 3, 'same': False}}
...
<gen_prepare_buffer>
{'OP': 'REPM', 'src': {'type': 'addresses_normal_ht', 'congruent': 4, 'same': True}, 'dst': {'type': 'addresses_UC_ht', 'congruent': 8, 'same': False}}
