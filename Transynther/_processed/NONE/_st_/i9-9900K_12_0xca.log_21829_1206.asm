...
push %rcx
push %rdi
lea addresses_normal_ht+0x1c447, %rcx
clflush (%rcx)
nop
nop
nop
...
nop
xor $35805, %r9
lea addresses_WT_ht+0x4c77, %r15
clflush (%r15)
nop
nop
nop
...
{'OP': 'LOAD', 'src': {'size': 16, 'NT': False, 'type': 'addresses_NC', 'same': False, 'AVXalign': False, 'congruent': 2}}
[Faulty Load]
