...
push %rdx
push %rsi
lea addresses_D_ht+0x1e73d, %rdx
nop
inc %rsi
movups (%rdx), %xmm1
vpextrq $1, %xmm1, %rcx
...
nop
cmp %r13, %r13
lea addresses_WC_ht+0xf113, %rbx
nop
nop
nop
nop
...
nop
sub $36105, %rcx
lea addresses_UC_ht+0x11c61, %rdx
nop
nop
nop
nop
...
// REPMOV
lea addresses_WC+0xf521, %rsi
lea addresses_PSE+0xdc61, %rdi
clflush (%rdi)
nop
nop
cmp $50665, %r9
...
{'OP': 'REPM', 'src': {'same': False, 'congruent': 6, 'type': 'addresses_WC'}, 'dst': {'same': True, 'congruent': 0, 'type': 'addresses_PSE'}}
{'OP': 'STOR', 'dst': {'same': False, 'type': 'addresses_P', 'NT': False, 'AVXalign': False, 'size': 1, 'congruent': 3}}
{'OP': 'LOAD', 'src': {'same': False, 'type': 'addresses_WT', 'NT': False, 'AVXalign': False, 'size': 1, 'congruent': 5}}
