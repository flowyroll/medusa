...
push %rdx
push %rsi
lea addresses_WT_ht+0x421d, %r12
clflush (%r12)
nop
nop
sub %r11, %r11
...
nop
sub %r11, %r11
lea addresses_normal_ht+0x104b9, %rsi
lea addresses_A_ht+0x3099, %rdi
nop
nop
nop
dec %r11
...
rep movsb
dec %rcx
lea addresses_normal_ht+0x171f5, %rdi
nop
nop
nop
nop
...
mov (%rdi), %r9w
and $28377, %r14
lea addresses_D_ht+0x1d4b9, %rcx
sub %r11, %r11
...
nop
inc %r11
lea addresses_WT_ht+0x102b9, %r9
nop
nop
nop
nop
...
nop
add %r11, %r11
lea addresses_D_ht+0xa0f9, %rsi
lea addresses_UC_ht+0x6c5b, %rdi
nop
nop
nop
nop
...
rep movsl
add $22774, %rcx
lea addresses_normal_ht+0x12205, %rsi
nop
add %r9, %r9
mov (%rsi), %r11d
and %r11, %r11
lea addresses_normal_ht+0x1c7d9, %rsi
sub %r14, %r14
vmovups (%rsi), %ymm5
...
nop
and $10641, %rdi
lea addresses_WC_ht+0x15eb9, %r9
nop
add %rdx, %rdx
movups (%r9), %xmm6
vpextrq $1, %xmm6, %rsi
...
nop
add %rdx, %rdx
lea addresses_WC_ht+0x17035, %rsi
...
rep movsl
xor %r12, %r12
lea addresses_UC_ht+0x1c5d3, %rsi
lea addresses_normal_ht+0x38b9, %rdi
nop
nop
nop
nop
...
nop
cmp $45454, %rdx
lea addresses_UC_ht+0x168b9, %rsi
nop
nop
and %r14, %r14
movl $0x61626364, (%rsi)
