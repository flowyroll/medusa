...
nop
cmp $29141, %rdx
lea addresses_WT_ht+0xabb3, %rsi
lea addresses_UC_ht+0xde71, %rdi
nop
nop
nop
sub $45725, %rbp
...
nop
sub %rbp, %rbp
lea addresses_D_ht+0x1e661, %rbp
nop
nop
nop
nop
...
nop
add %rcx, %rcx
lea addresses_WC_ht+0xeed5, %rdx
nop
nop
nop
nop
...
{'OP': 'STOR', 'dst': {'NT': False, 'same': False, 'congruent': 8, 'type': 'addresses_WT', 'AVXalign': True, 'size': 16}}
