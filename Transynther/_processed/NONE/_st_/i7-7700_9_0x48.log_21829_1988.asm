...
push %rdi
push %rsi
lea addresses_UC_ht+0x833c, %rdi
clflush (%rdi)
and $13499, %rcx
movl $0x61626364, (%rdi)
nop
nop
sub %r10, %r10
lea addresses_WC_ht+0x15ed9, %rsi
lea addresses_normal_ht+0xf99c, %rdi
nop
nop
nop
nop
...
nop
sub $13944, %rbx
lea addresses_A_ht+0x12ea4, %r10
add $35882, %r14
movb (%r10), %bl
and $11331, %rdi
lea addresses_A_ht+0x13dfc, %rcx
and $23447, %rbx
movb $0x61, (%rcx)
nop
nop
...
nop
dec %rdi
lea addresses_WT_ht+0xff9c, %rbx
nop
nop
nop
and $37967, %r15
...
vmovups %ymm3, (%rbx)
and %rbx, %rbx
lea addresses_A_ht+0x1c29c, %r10
cmp %r14, %r14
mov (%r10), %ebx
nop
nop
nop
xor %r15, %r15
lea addresses_normal_ht+0x97dc, %rbx
clflush (%rbx)
cmp $14572, %rcx
vmovups (%rbx), %ymm7
...
{'OP': 'REPM', 'src': {'type': 'addresses_WC_ht', 'congruent': 0, 'same': False}, 'dst': {'type': 'addresses_normal_ht', 'congruent': 7, 'same': True}}
