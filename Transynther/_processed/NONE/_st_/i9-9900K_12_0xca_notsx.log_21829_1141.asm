...
lea addresses_D_ht+0x11448, %rdi
nop
nop
nop
nop
...
nop
add %rax, %rax
lea addresses_UC_ht+0xb969, %rax
nop
nop
nop
nop
...
mov (%rax), %ecx
xor $35394, %rax
lea addresses_D_ht+0x18f69, %rsi
lea addresses_WT_ht+0x13b69, %rdi
and $102, %r13
mov $43, %rcx
rep movsw
nop
...
nop
sub %r13, %r13
lea addresses_WT_ht+0x28f9, %rsi
nop
nop
nop
nop
...
movw $0x6162, (%rsi)
sub $64972, %rdi
lea addresses_D_ht+0x14969, %rsi
lea addresses_A_ht+0xc1e9, %rdi
nop
nop
nop
cmp %rbp, %rbp
...
nop
xor %rsi, %rsi
lea addresses_normal_ht+0x7879, %r12
clflush (%r12)
xor %r11, %r11
movb (%r12), %al
nop
...
nop
and $20102, %rsi
lea addresses_normal_ht+0x15cc9, %rbp
nop
nop
sub $37828, %rcx
mov (%rbp), %r12w
...
nop
cmp $19325, %rcx
lea addresses_normal_ht+0x14564, %rsi
nop
nop
nop
nop
...
// Store
lea addresses_normal+0x1c669, %r12
nop
nop
nop
nop
...
// Load
lea addresses_normal+0x16969, %r15
nop
nop
nop
nop
...
// REPMOV
lea addresses_D+0x11d69, %rsi
lea addresses_normal+0x16969, %rdi
nop
nop
nop
and $51588, %r10
...
{'OP': 'REPM', 'src': {'same': False, 'congruent': 10, 'type': 'addresses_D'}, 'dst': {'same': True, 'congruent': 0, 'type': 'addresses_normal'}}
...
{'OP': 'REPM', 'src': {'same': False, 'congruent': 9, 'type': 'addresses_D_ht'}, 'dst': {'same': True, 'congruent': 9, 'type': 'addresses_WT_ht'}}
{'OP': 'STOR', 'dst': {'same': False, 'type': 'addresses_WT_ht', 'NT': False, 'AVXalign': False, 'size': 2, 'congruent': 4}}
{'OP': 'REPM', 'src': {'same': False, 'congruent': 11, 'type': 'addresses_D_ht'}, 'dst': {'same': False, 'congruent': 7, 'type': 'addresses_A_ht'}}
