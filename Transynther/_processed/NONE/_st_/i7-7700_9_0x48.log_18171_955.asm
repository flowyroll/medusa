...
push %rdi
push %rsi
lea addresses_normal_ht+0x1b86e, %rsi
lea addresses_normal_ht+0x3a4a, %rdi
clflush (%rsi)
nop
nop
nop
...
nop
dec %rbx
lea addresses_A_ht+0x1729a, %rsi
lea addresses_UC_ht+0x473a, %rdi
nop
nop
nop
nop
...
nop
and %rbx, %rbx
lea addresses_WT_ht+0xa1da, %rdi
nop
inc %r9
movw $0x6162, (%rdi)
nop
...
// Store
lea addresses_normal+0x1bbda, %r12
nop
nop
nop
nop
...
// Load
lea addresses_normal+0xa95a, %rbp
nop
nop
nop
nop
...
{'OP': 'LOAD', 'src': {'type': 'addresses_normal', 'AVXalign': False, 'congruent': 6, 'size': 4, 'same': False, 'NT': False}}
[Faulty Load]
{'OP': 'LOAD', 'src': {'type': 'addresses_UC', 'AVXalign': False, 'congruent': 0, 'size': 4, 'same': True, 'NT': False}}
<gen_prepare_buffer>
{'OP': 'REPM', 'src': {'type': 'addresses_normal_ht', 'congruent': 2, 'same': False}, 'dst': {'type': 'addresses_normal_ht', 'congruent': 0, 'same': True}}
{'OP': 'REPM', 'src': {'type': 'addresses_A_ht', 'congruent': 6, 'same': True}, 'dst': {'type': 'addresses_UC_ht', 'congruent': 5, 'same': False}}
