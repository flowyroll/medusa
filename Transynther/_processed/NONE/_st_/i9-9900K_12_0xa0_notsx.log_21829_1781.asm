...
nop
sub %r15, %r15
lea addresses_normal_ht+0x17715, %rsi
lea addresses_A_ht+0x389f, %rdi
nop
add %rbp, %rbp
mov $54, %rcx
rep movsq
...
nop
inc %rcx
lea addresses_WT_ht+0x54e6, %rsi
lea addresses_A_ht+0x10913, %rdi
clflush (%rdi)
nop
add $60233, %rax
mov $30, %rcx
...
nop
and %rbp, %rbp
lea addresses_D_ht+0x1a51f, %r15
clflush (%r15)
nop
nop
cmp $25646, %rax
...
nop
sub $64571, %rcx
lea addresses_WT_ht+0x451f, %rdi
nop
nop
nop
sub $32582, %rsi
...
nop
cmp %r11, %r11
lea addresses_WT_ht+0x103df, %rcx
nop
nop
nop
sub %r15, %r15
...
nop
cmp $60255, %r11
lea addresses_A_ht+0x116cf, %rbx
dec %rbp
...
nop
and $23031, %rcx
lea addresses_WT_ht+0x1ac9f, %rbx
nop
nop
nop
xor $45556, %rsi
...
nop
cmp %rcx, %rcx
lea addresses_WT_ht+0x14a7, %r11
nop
nop
dec %rdi
mov (%r11), %r15w
...
// REPMOV
lea addresses_normal+0xebf, %rsi
lea addresses_D+0x12d1f, %rdi
nop
nop
nop
nop
...
{'src': {'type': 'addresses_normal', 'congruent': 4, 'same': False}, 'OP': 'REPM', 'dst': {'type': 'addresses_D', 'congruent': 0, 'same': True}}
[Faulty Load]
...
{'src': {'type': 'addresses_normal_ht', 'congruent': 1, 'same': True}, 'OP': 'REPM', 'dst': {'type': 'addresses_A_ht', 'congruent': 6, 'same': False}}
