...
push %rdi
push %rsi
lea addresses_WC_ht+0x7051, %rsi
lea addresses_D_ht+0x12521, %rdi
add %rbx, %rbx
mov $85, %rcx
rep movsw
nop
nop
add %rcx, %rcx
lea addresses_normal_ht+0x148d1, %r15
nop
nop
nop
dec %r10
...
nop
add $787, %r10
lea addresses_WC_ht+0xa49, %rsi
lea addresses_WC_ht+0x15851, %rdi
nop
nop
and $39278, %r9
mov $45, %rcx
...
mov (%r9), %rcx
sub %rcx, %rcx
lea addresses_WC_ht+0x8309, %rsi
sub %rbx, %rbx
...
nop
cmp $55781, %rcx
lea addresses_UC_ht+0x1a451, %rcx
xor $58296, %r10
mov (%rcx), %r9
nop
add $62150, %rbx
lea addresses_WT_ht+0x2351, %rsi
lea addresses_WC_ht+0x14a49, %rdi
dec %r11
mov $2, %rcx
rep movsq
nop
...
nop
and %r15, %r15
lea addresses_A_ht+0x157f9, %rsi
clflush (%rsi)
nop
nop
nop
...
nop
cmp %r15, %r15
lea addresses_UC_ht+0x110e9, %r15
nop
nop
nop
nop
...
nop
add %rdi, %rdi
lea addresses_normal_ht+0x5b71, %rbx
nop
nop
nop
sub $55981, %r9
...
{'OP': 'REPM', 'src': {'same': False, 'type': 'addresses_WC_ht', 'congruent': 3}, 'dst': {'same': False, 'type': 'addresses_WC_ht', 'congruent': 8}}
...
{'OP': 'STOR', 'dst': {'size': 16, 'NT': False, 'type': 'addresses_D_ht', 'same': True, 'AVXalign': False, 'congruent': 5}}
...
{'OP': 'REPM', 'src': {'same': False, 'type': 'addresses_WT_ht', 'congruent': 8}, 'dst': {'same': False, 'type': 'addresses_WC_ht', 'congruent': 3}}
{'OP': 'STOR', 'dst': {'size': 1, 'NT': True, 'type': 'addresses_A_ht', 'same': False, 'AVXalign': False, 'congruent': 2}}
