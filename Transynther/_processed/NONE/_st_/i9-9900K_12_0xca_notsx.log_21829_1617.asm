...
// Store
lea addresses_normal+0x13c78, %r11
clflush (%r11)
nop
cmp %r13, %r13
...
// Store
lea addresses_normal+0x1e38, %rsi
nop
nop
nop
sub %r15, %r15
...
{'OP': 'STOR', 'dst': {'same': False, 'type': 'addresses_P', 'NT': True, 'AVXalign': False, 'size': 32, 'congruent': 3}}
