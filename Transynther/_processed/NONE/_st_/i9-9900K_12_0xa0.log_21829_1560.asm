...
push %rdx
push %rsi
lea addresses_normal_ht+0x1e242, %rsi
nop
nop
nop
nop
...
movups %xmm2, (%rsi)
xor %r8, %r8
lea addresses_UC_ht+0xfa42, %r10
nop
nop
nop
nop
...
nop
cmp %r8, %r8
lea addresses_normal_ht+0xcf3c, %rbp
clflush (%rbp)
nop
sub %r11, %r11
movb (%rbp), %dl
add $441, %r8
lea addresses_normal_ht+0xf9e, %rsi
lea addresses_WT_ht+0x18382, %rdi
nop
xor $26260, %r10
mov $61, %rcx
rep movsl
...
nop
and $45706, %rbp
lea addresses_A_ht+0x1af72, %r13
nop
cmp %rdi, %rdi
movb $0x61, (%r13)
nop
xor $54000, %r13
lea addresses_D_ht+0x1a242, %r8
nop
nop
nop
nop
...
nop
cmp $45224, %rsi
lea addresses_WC_ht+0xbe4e, %r13
nop
nop
nop
xor %rbp, %rbp
...
nop
sub $20897, %rdx
lea addresses_UC_ht+0x16a42, %rsi
lea addresses_normal_ht+0x1634a, %rdi
nop
nop
sub $257, %rbp
mov $94, %rcx
...
lea addresses_normal_ht+0xec42, %rdi
clflush (%rsi)
nop
nop
nop
...
nop
cmp $5901, %r13
lea addresses_UC_ht+0x1a42, %r10
nop
nop
cmp $29669, %r8
movb $0x61, (%r10)
nop
inc %rcx
lea addresses_WC_ht+0x6142, %rcx
clflush (%rcx)
nop
nop
sub %r13, %r13
...
nop
and %r13, %r13
lea addresses_D_ht+0x10a42, %rsi
lea addresses_A_ht+0xc8c2, %rdi
clflush (%rdi)
nop
nop
nop
...
// Load
lea addresses_normal+0x59fe, %r13
inc %r9
mov (%r13), %r11
nop
dec %r8
...
{'src': {'NT': False, 'same': False, 'congruent': 1, 'type': 'addresses_normal', 'AVXalign': True, 'size': 8}, 'OP': 'LOAD'}
{'OP': 'STOR', 'dst': {'NT': False, 'same': False, 'congruent': 10, 'type': 'addresses_UC', 'AVXalign': False, 'size': 16}}
[Faulty Load]
...
{'src': {'same': False, 'congruent': 10, 'type': 'addresses_UC_ht'}, 'OP': 'REPM', 'dst': {'same': False, 'congruent': 2, 'type': 'addresses_normal_ht'}}
{'src': {'NT': False, 'same': False, 'congruent': 4, 'type': 'addresses_A_ht', 'AVXalign': False, 'size': 16}, 'OP': 'LOAD'}
{'src': {'same': False, 'congruent': 5, 'type': 'addresses_A_ht'}, 'OP': 'REPM', 'dst': {'same': False, 'congruent': 9, 'type': 'addresses_normal_ht'}}
