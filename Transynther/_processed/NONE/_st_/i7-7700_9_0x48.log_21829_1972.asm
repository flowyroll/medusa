...
lea addresses_UC_ht+0x1ae67, %rdi
nop
nop
xor $10887, %r14
mov $27, %rcx
...
nop
mfence
lea addresses_normal_ht+0x4ffd, %rdi
dec %r14
movb (%rdi), %r11b
nop
nop
...
nop
dec %r14
lea addresses_A_ht+0x3fef, %rsi
lea addresses_normal_ht+0x128e7, %rdi
cmp $8685, %r9
mov $79, %rcx
rep movsl
nop
...
nop
cmp $24347, %r13
lea addresses_normal_ht+0x10f0f, %rsi
lea addresses_A_ht+0x1290f, %rdi
nop
nop
nop
nop
...
lea addresses_normal_ht+0x1a0f, %rdi
nop
nop
nop
inc %r12
...
nop
sub $23917, %r13
lea addresses_normal_ht+0xd20f, %r9
nop
nop
cmp $27706, %rsi
...
nop
add $6590, %r13
lea addresses_A_ht+0x10897, %r13
nop
nop
nop
nop
...
nop
and $55, %r13
lea addresses_D_ht+0xcfcf, %r12
cmp $46956, %r9
movw $0x6162, (%r12)
nop
lfence
lea addresses_D_ht+0xb00f, %rdi
inc %r12
...
nop
xor %r11, %r11
lea addresses_WC_ht+0x92cf, %rcx
nop
nop
nop
and $31837, %r9
...
{'OP': 'LOAD', 'src': {'type': 'addresses_normal_ht', 'AVXalign': True, 'congruent': 0, 'size': 1, 'same': False, 'NT': False}}
...
{'OP': 'REPM', 'src': {'type': 'addresses_normal_ht', 'congruent': 8, 'same': False}, 'dst': {'type': 'addresses_A_ht', 'congruent': 7, 'same': True}}
...
{'OP': 'LOAD', 'src': {'type': 'addresses_A_ht', 'AVXalign': False, 'congruent': 2, 'size': 4, 'same': True, 'NT': False}}
...
{'OP': 'LOAD', 'src': {'type': 'addresses_WC_ht', 'AVXalign': False, 'congruent': 6, 'size': 2, 'same': True, 'NT': False}}
{'58': 21829}
