...
push %rbp
push %rbx
lea addresses_D_ht+0x183a3, %r12
nop
nop
nop
and $18080, %r15
...
nop
add %rbp, %rbp
lea addresses_D_ht+0x13ac3, %r11
nop
nop
nop
add $44292, %r12
...
nop
inc %r12
lea addresses_normal_ht+0x116c7, %rbp
nop
nop
nop
and %r12, %r12
...
vmovups %ymm4, (%rbp)
and $41961, %rbp
lea addresses_normal_ht+0x6ac7, %r11
nop
nop
and %r13, %r13
mov (%r11), %eax
...
nop
xor %rax, %rax
lea addresses_A_ht+0x1c6c7, %r13
nop
nop
nop
nop
...
nop
and $49087, %rax
lea addresses_UC_ht+0x184c7, %r12
nop
nop
nop
add %rax, %rax
...
{'OP': 'STOR', 'dst': {'type': 'addresses_WC', 'AVXalign': False, 'congruent': 3, 'size': 32, 'same': False, 'NT': True}}
{'OP': 'STOR', 'dst': {'type': 'addresses_WC', 'AVXalign': True, 'congruent': 10, 'size': 2, 'same': False, 'NT': False}}
[Faulty Load]
{'OP': 'LOAD', 'src': {'type': 'addresses_UC', 'AVXalign': False, 'congruent': 0, 'size': 8, 'same': True, 'NT': False}}
<gen_prepare_buffer>
{'OP': 'LOAD', 'src': {'type': 'addresses_D_ht', 'AVXalign': True, 'congruent': 2, 'size': 8, 'same': False, 'NT': False}}
