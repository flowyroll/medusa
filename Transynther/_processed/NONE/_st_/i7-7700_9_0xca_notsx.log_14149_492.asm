...
push %rdi
push %rsi
lea addresses_WT_ht+0x8774, %rsi
lea addresses_A_ht+0x1bbf4, %rdi
nop
nop
nop
add %rbp, %rbp
...
nop
xor %r8, %r8
lea addresses_WT_ht+0x1bcf4, %r10
clflush (%r10)
nop
nop
nop
...
mov (%r10), %r8
and $46472, %rdi
lea addresses_A_ht+0x12ef4, %rcx
dec %rbp
movb $0x61, (%rcx)
nop
nop
