...
nop
add %r13, %r13
lea addresses_D_ht+0x1363b, %rbp
nop
nop
add %r14, %r14
...
nop
and $45170, %rax
lea addresses_D_ht+0x1405b, %r13
nop
nop
nop
nop
...
nop
sub $23479, %rsi
lea addresses_UC_ht+0x344b, %r13
nop
dec %rbp
...
movups %xmm0, (%r13)
sub $21901, %r13
lea addresses_WC_ht+0x19ce7, %rax
nop
nop
nop
nop
...
nop
add %r14, %r14
lea addresses_normal_ht+0x1af73, %rsi
lea addresses_A_ht+0xcb9b, %rdi
nop
add %r13, %r13
mov $45, %rcx
rep movsb
...
// Load
lea addresses_normal+0x1e05b, %r12
clflush (%r12)
and %rax, %rax
mov (%r12), %r11d
nop
...
// REPMOV
lea addresses_PSE+0x18cf3, %rsi
lea addresses_normal+0x1005b, %rdi
clflush (%rsi)
nop
nop
inc %r11
...
{'OP': 'LOAD', 'src': {'same': False, 'NT': False, 'AVXalign': False, 'size': 4, 'type': 'addresses_normal', 'congruent': 11}}
{'dst': {'same': False, 'NT': False, 'AVXalign': False, 'size': 2, 'type': 'addresses_PSE', 'congruent': 4}, 'OP': 'STOR'}
{'dst': {'same': True, 'congruent': 0, 'type': 'addresses_normal'}, 'OP': 'REPM', 'src': {'same': False, 'congruent': 3, 'type': 'addresses_PSE'}}
[Faulty Load]
...
{'OP': 'LOAD', 'src': {'same': True, 'NT': False, 'AVXalign': True, 'size': 16, 'type': 'addresses_D_ht', 'congruent': 3}}
