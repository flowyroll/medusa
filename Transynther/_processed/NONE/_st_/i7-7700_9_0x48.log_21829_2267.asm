...
push %rdi
push %rsi
lea addresses_UC_ht+0x2c49, %rsi
...
lea addresses_WC_ht+0x1e569, %rdi
clflush (%rsi)
nop
cmp $18196, %rax
mov $38, %rcx
...
lea addresses_WC_ht+0x18249, %rdi
nop
nop
sub $4458, %r10
mov $122, %rcx
rep movsl
and %rax, %rax
lea addresses_WC_ht+0x10089, %r10
nop
nop
nop
nop
...
vpextrq $1, %xmm5, %rsi
xor %rsi, %rsi
lea addresses_normal_ht+0x5c49, %r14
nop
nop
nop
nop
...
nop
and $26839, %rcx
lea addresses_WC_ht+0x1b149, %r14
nop
dec %r10
mov (%r14), %rsi
nop
...
{'OP': 'REPM', 'src': {'type': 'addresses_WC_ht', 'congruent': 7, 'same': False}, 'dst': {'type': 'addresses_WC_ht', 'congruent': 5, 'same': False}}
