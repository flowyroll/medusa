...
nop
inc %rdi
lea addresses_UC_ht+0x20ce, %rdi
nop
xor %rax, %rax
movl $0x61626364, (%rdi)
nop
...
nop
dec %rcx
lea addresses_D_ht+0x1583a, %rdi
nop
nop
nop
nop
