...
// REPMOV
lea addresses_UC+0x18dbf, %rsi
lea addresses_D+0x17dbf, %rdi
clflush (%rdi)
nop
add $54953, %r8
mov $34, %rcx
...
// Store
lea addresses_normal+0x6c28, %rcx
nop
nop
nop
nop
...
// Store
lea addresses_normal+0x1bd9f, %r8
nop
nop
nop
and %rax, %rax
...
// Store
lea addresses_normal+0x23bf, %r8
nop
nop
nop
nop
...
{'OP': 'REPM', 'src': {'same': False, 'congruent': 10, 'type': 'addresses_UC'}, 'dst': {'same': True, 'congruent': 0, 'type': 'addresses_D'}}
{'OP': 'STOR', 'dst': {'same': False, 'type': 'addresses_WC', 'NT': False, 'AVXalign': False, 'size': 16, 'congruent': 4}}
{'OP': 'LOAD', 'src': {'same': False, 'type': 'addresses_PSE', 'NT': False, 'AVXalign': False, 'size': 2, 'congruent': 6}}
