...
nop
xor $24262, %r9
lea addresses_UC_ht+0xee36, %rsi
lea addresses_A_ht+0xbcf6, %rdi
nop
add %r10, %r10
mov $20, %rcx
rep movsq
...
nop
and %r9, %r9
lea addresses_WT_ht+0x15636, %rcx
nop
nop
nop
nop
...
nop
cmp %rdi, %rdi
lea addresses_A_ht+0x188b6, %rsi
lea addresses_WC_ht+0xb5fc, %rdi
nop
nop
nop
nop
...
// REPMOV
lea addresses_WC+0xffad, %rsi
lea addresses_D+0xb636, %rdi
nop
nop
nop
nop
...
// REPMOV
lea addresses_WC+0x107f8, %rsi
lea addresses_D+0x38f6, %rdi
clflush (%rdi)
nop
nop
nop
...
{'src': {'type': 'addresses_WC', 'congruent': 0, 'same': False}, 'OP': 'REPM', 'dst': {'type': 'addresses_D', 'congruent': 0, 'same': True}}
...
{'src': {'type': 'addresses_normal_ht', 'congruent': 2, 'same': True}, 'OP': 'REPM', 'dst': {'type': 'addresses_A_ht', 'congruent': 4, 'same': False}}
