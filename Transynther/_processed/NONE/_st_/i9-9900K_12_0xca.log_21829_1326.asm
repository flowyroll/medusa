...
push %rdi
push %rsi
lea addresses_WC_ht+0x12f8, %r12
nop
nop
nop
nop
...
nop
cmp $23429, %rax
lea addresses_D_ht+0x13978, %r10
and %r15, %r15
mov (%r10), %r12w
nop
nop
nop
sub %rax, %rax
lea addresses_normal_ht+0x7ca3, %rsi
lea addresses_normal_ht+0x1cca0, %rdi
clflush (%rdi)
nop
nop
sub $20810, %r10
...
nop
xor %r12, %r12
lea addresses_WT_ht+0xdf78, %rcx
nop
nop
xor $46300, %rdi
movups (%rcx), %xmm3
...
nop
dec %rdi
lea addresses_normal_ht+0x15b8, %rbx
nop
nop
nop
nop
