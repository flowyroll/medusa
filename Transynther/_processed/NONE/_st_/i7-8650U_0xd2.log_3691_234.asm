...
nop
and %r9, %r9
lea addresses_normal_ht+0x3baa, %r15
nop
nop
nop
xor $20583, %r14
...
nop
dec %rsi
lea addresses_WC_ht+0x99f2, %r11
nop
nop
nop
add %r9, %r9
...
nop
add %r14, %r14
lea addresses_WC_ht+0xd48a, %rsi
add $5205, %rdx
mov (%rsi), %r9
nop
nop
and $32320, %r9
lea addresses_D_ht+0x15cd0, %r14
nop
nop
nop
sub %rdx, %rdx
...
nop
and $5784, %r8
lea addresses_WT_ht+0x2d4a, %rsi
lea addresses_WC_ht+0x1122, %rdi
nop
nop
cmp $38689, %r15
mov $81, %rcx
...
nop
xor $33142, %r9
lea addresses_WC_ht+0x1be8a, %rsi
...
lea addresses_WT_ht+0x1c3ea, %rdi
clflush (%rdi)
nop
nop
add $32493, %r15
...
nop
and $25586, %r14
lea addresses_UC_ht+0x1b5b4, %rsi
nop
nop
nop
nop
...
nop
sub %r14, %r14
lea addresses_WT_ht+0x1398a, %rsi
...
{'OP': 'REPM', 'src': {'type': 'addresses_normal_ht', 'congruent': 5, 'same': False}, 'dst': {'type': 'addresses_WT_ht', 'congruent': 4, 'same': False}}
