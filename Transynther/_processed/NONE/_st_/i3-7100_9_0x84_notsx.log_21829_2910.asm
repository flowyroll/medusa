...
vpextrq $1, %xmm0, %rax
and %rbp, %rbp
lea addresses_WC_ht+0x135e0, %r9
nop
nop
nop
nop
...
// REPMOV
lea addresses_RW+0xdde4, %rsi
lea addresses_normal+0xee90, %rdi
clflush (%rsi)
nop
nop
nop
...
// Faulty Load
lea addresses_normal+0xee90, %rsi
nop
nop
add %rcx, %rcx
vmovups (%rsi), %ymm4
...
{'src': {'type': 'addresses_RW', 'congruent': 1, 'same': False}, 'dst': {'type': 'addresses_normal', 'congruent': 0, 'same': True}, 'OP': 'REPM'}
{'src': {'type': 'addresses_P', 'same': False, 'size': 16, 'congruent': 6, 'NT': False, 'AVXalign': False}, 'OP': 'LOAD'}
...
{'src': {'type': 'addresses_A_ht', 'same': True, 'size': 16, 'congruent': 2, 'NT': False, 'AVXalign': False}, 'OP': 'LOAD'}
