...
push %rdi
push %rsi
lea addresses_UC_ht+0x322b, %r15
nop
nop
nop
nop
...
movntdq %xmm3, (%r15)
xor %rbp, %rbp
lea addresses_normal_ht+0x1ef2b, %r10
nop
nop
add $37068, %rbx
movups (%r10), %xmm0
...
rep movsw
add %r10, %r10
lea addresses_WC_ht+0x1352b, %rdi
nop
nop
nop
nop
...
nop
sub %rbp, %rbp
lea addresses_WC_ht+0x422b, %rbp
nop
nop
nop
and $19754, %rcx
...
nop
cmp $41619, %rbp
lea addresses_WT_ht+0xb9eb, %rsi
lea addresses_WT_ht+0x1672b, %rdi
nop
nop
add %r10, %r10
mov $61, %rcx
...
nop
and $27536, %r8
lea addresses_WT_ht+0xe22b, %rsi
lea addresses_D_ht+0xa06b, %rdi
and %r8, %r8
mov $85, %rcx
rep movsb
nop
...
nop
dec %rbp
lea addresses_normal_ht+0x969b, %rsi
lea addresses_normal_ht+0x1e67b, %rdi
clflush (%rsi)
xor $23023, %rbp
mov $14, %rcx
rep movsw
...
nop
sub %r10, %r10
lea addresses_D_ht+0x15df3, %rsi
lea addresses_WT_ht+0x16de6, %rdi
clflush (%rdi)
nop
xor %r8, %r8
mov $61, %rcx
...
nop
cmp %rcx, %rcx
lea addresses_normal_ht+0x13a2b, %rcx
nop
nop
nop
nop
...
nop
and $15422, %rbp
lea addresses_WT_ht+0x1a5cf, %r10
nop
add $7076, %rcx
movw $0x6162, (%r10)
nop
xor $43271, %rbp
lea addresses_normal_ht+0x532b, %rsi
lea addresses_normal_ht+0xca2b, %rdi
nop
nop
nop
sub $44167, %rbp
...
<gen_prepare_buffer>
{'OP': 'STOR', 'dst': {'type': 'addresses_UC_ht', 'AVXalign': False, 'congruent': 11, 'size': 16, 'same': False, 'NT': True}}
...
{'OP': 'REPM', 'src': {'type': 'addresses_WT_ht', 'congruent': 11, 'same': False}, 'dst': {'type': 'addresses_D_ht', 'congruent': 5, 'same': False}}
...
{'OP': 'REPM', 'src': {'type': 'addresses_D_ht', 'congruent': 1, 'same': False}, 'dst': {'type': 'addresses_WT_ht', 'congruent': 0, 'same': False}}
...
{'OP': 'REPM', 'src': {'type': 'addresses_normal_ht', 'congruent': 6, 'same': False}, 'dst': {'type': 'addresses_normal_ht', 'congruent': 11, 'same': False}}
{'52': 21829}
