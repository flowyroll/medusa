...
nop
xor %r12, %r12
lea addresses_D_ht+0x1bc6c, %rsi
lea addresses_D_ht+0x1b060, %rdi
clflush (%rsi)
xor $4116, %r14
mov $89, %rcx
rep movsb
...
nop
dec %rsi
lea addresses_WT_ht+0x178cc, %r12
nop
nop
nop
nop
...
{'src': {'congruent': 10, 'AVXalign': False, 'same': False, 'size': 1, 'NT': True, 'type': 'addresses_NC'}, 'OP': 'LOAD'}
