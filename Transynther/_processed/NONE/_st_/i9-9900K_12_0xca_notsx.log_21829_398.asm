...
push %rdi
push %rsi
lea addresses_UC_ht+0x185b2, %rax
nop
nop
add $21062, %r12
movb $0x61, (%rax)
cmp $39170, %rcx
lea addresses_UC_ht+0x9e30, %rsi
lea addresses_WT_ht+0x199d4, %rdi
nop
nop
nop
nop
...
rep movsb
xor %r12, %r12
lea addresses_A_ht+0x1cc40, %rax
nop
nop
and %rbx, %rbx
mov (%rax), %r11d
cmp $33755, %rcx
lea addresses_normal_ht+0x14200, %r12
nop
nop
cmp %rsi, %rsi
movw $0x6162, (%r12)
...
// REPMOV
lea addresses_RW+0x1c59c, %rsi
lea addresses_A+0x1fe00, %rdi
nop
nop
nop
nop
...
{'OP': 'REPM', 'src': {'same': False, 'congruent': 2, 'type': 'addresses_RW'}, 'dst': {'same': True, 'congruent': 0, 'type': 'addresses_A'}}
...
{'OP': 'STOR', 'dst': {'same': False, 'type': 'addresses_normal_ht', 'NT': True, 'AVXalign': False, 'size': 2, 'congruent': 8}}
{'32': 21829}
