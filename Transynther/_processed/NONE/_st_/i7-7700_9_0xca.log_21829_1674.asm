...
push %rdi
push %rsi
lea addresses_A_ht+0x1455f, %r12
clflush (%r12)
nop
xor $58997, %r11
mov (%r12), %r10
...
nop
sub $64592, %r8
lea addresses_UC_ht+0xb53f, %rsi
lea addresses_A_ht+0x685f, %rdi
clflush (%rsi)
nop
nop
nop
...
nop
inc %rbx
lea addresses_WC_ht+0x7b5f, %r11
nop
nop
xor %rsi, %rsi
movups (%r11), %xmm7
...
nop
cmp %r10, %r10
lea addresses_normal_ht+0x180df, %r11
nop
nop
nop
nop
...
nop
sub %r11, %r11
lea addresses_normal_ht+0xd899, %r11
xor $47114, %r10
movb (%r11), %r12b
nop
nop
...
{'src': {'congruent': 5, 'same': False, 'type': 'addresses_UC_ht'}, 'OP': 'REPM', 'dst': {'congruent': 4, 'same': False, 'type': 'addresses_A_ht'}}
