...
push %rdx
push %rsi
lea addresses_normal_ht+0xacaf, %rbx
nop
nop
sub $32294, %r13
movb (%rbx), %dl
cmp %rsi, %rsi
lea addresses_UC_ht+0x1c797, %rdi
nop
nop
nop
nop
...
nop
and %rdi, %rdi
lea addresses_normal_ht+0x12fb7, %r8
nop
nop
nop
nop
...
// REPMOV
lea addresses_PSE+0x5817, %rsi
lea addresses_UC+0x1c797, %rdi
nop
nop
nop
nop
...
// Store
lea addresses_normal+0x107ad, %r12
clflush (%r12)
nop
dec %r15
mov $0x5152535455565758, %rax
...
{'src': {'type': 'addresses_PSE', 'congruent': 7, 'same': False}, 'dst': {'type': 'addresses_UC', 'congruent': 0, 'same': True}, 'OP': 'REPM'}
