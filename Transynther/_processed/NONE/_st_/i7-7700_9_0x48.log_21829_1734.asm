...
nop
xor %rcx, %rcx
lea addresses_normal_ht+0xf40e, %rsi
lea addresses_A_ht+0x118cd, %rdi
nop
and %r10, %r10
mov $2, %rcx
rep movsw
...
{'OP': 'STOR', 'dst': {'type': 'addresses_PSE', 'AVXalign': False, 'congruent': 8, 'size': 8, 'same': False, 'NT': True}}
...
<gen_prepare_buffer>
{'OP': 'REPM', 'src': {'type': 'addresses_D_ht', 'congruent': 0, 'same': False}, 'dst': {'type': 'addresses_WC_ht', 'congruent': 5, 'same': False}}
