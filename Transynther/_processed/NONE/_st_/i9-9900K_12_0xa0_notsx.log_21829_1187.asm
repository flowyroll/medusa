...
// REPMOV
lea addresses_A+0x1c8f3, %rsi
lea addresses_D+0xacb, %rdi
nop
nop
nop
nop
...
{'src': {'type': 'addresses_A', 'congruent': 3, 'same': False}, 'OP': 'REPM', 'dst': {'type': 'addresses_D', 'congruent': 0, 'same': True}}
