...
push %rdx
push %rsi
lea addresses_normal_ht+0x1a3d3, %rsi
lea addresses_WT_ht+0xf764, %rdi
nop
nop
nop
nop
...
nop
and %rdx, %rdx
lea addresses_UC_ht+0x58c7, %r13
and $47438, %rdi
...
vmovntdq %ymm4, (%r13)
sub $29353, %rsi
lea addresses_UC_ht+0x154ca, %r10
nop
nop
nop
xor %rsi, %rsi
...
nop
add $41432, %rsi
lea addresses_D_ht+0x158c3, %rdi
nop
nop
nop
xor $38517, %r8
movw $0x6162, (%rdi)
cmp $56814, %r8
lea addresses_WT_ht+0xbb43, %rdi
nop
nop
cmp %rdx, %rdx
mov (%rdi), %ecx
...
nop
dec %r10
lea addresses_WT_ht+0x3f53, %rsi
lea addresses_WC_ht+0x1eb43, %rdi
cmp %r11, %r11
mov $106, %rcx
rep movsq
nop
...
nop
add %r8, %r8
lea addresses_D_ht+0xa943, %rsi
lea addresses_UC_ht+0x5a2b, %rdi
clflush (%rdi)
nop
nop
nop
...
nop
cmp %r13, %r13
lea addresses_WC_ht+0x9baf, %rsi
lea addresses_UC_ht+0x12738, %rdi
clflush (%rsi)
add $57978, %r11
mov $12, %rcx
rep movsb
...
movl $0x61626364, (%r13)
and %rcx, %rcx
lea addresses_D_ht+0x14b43, %rdi
cmp $456, %r10
mov (%rdi), %r11d
nop
nop
...
{'OP': 'STOR', 'dst': {'congruent': 5, 'AVXalign': False, 'same': False, 'size': 32, 'NT': False, 'type': 'addresses_NC'}}
...
{'OP': 'STOR', 'dst': {'congruent': 2, 'AVXalign': False, 'same': True, 'size': 32, 'NT': True, 'type': 'addresses_UC_ht'}}
...
{'src': {'congruent': 4, 'same': False, 'type': 'addresses_WT_ht'}, 'OP': 'REPM', 'dst': {'congruent': 11, 'same': True, 'type': 'addresses_WC_ht'}}
{'src': {'congruent': 7, 'same': False, 'type': 'addresses_D_ht'}, 'OP': 'REPM', 'dst': {'congruent': 3, 'same': False, 'type': 'addresses_UC_ht'}}
{'src': {'congruent': 1, 'same': False, 'type': 'addresses_WC_ht'}, 'OP': 'REPM', 'dst': {'congruent': 0, 'same': False, 'type': 'addresses_UC_ht'}}
