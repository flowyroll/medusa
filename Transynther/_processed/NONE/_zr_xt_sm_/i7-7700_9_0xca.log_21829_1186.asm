...
push %rdi
push %rsi
lea addresses_normal_ht+0x14dcd, %rsi
lea addresses_normal_ht+0x1ae2d, %rdi
and %r11, %r11
mov $58, %rcx
rep movsl
nop
...
nop
and $49868, %r13
lea addresses_UC_ht+0x2e37, %r11
clflush (%r11)
nop
nop
nop
...
nop
inc %r13
lea addresses_D_ht+0x12dcd, %rcx
cmp $55290, %r13
movups (%rcx), %xmm4
vpextrq $0, %xmm4, %r11
add %r11, %r11
lea addresses_A_ht+0x3ad, %rcx
clflush (%rcx)
nop
nop
nop
...
mov (%rcx), %r13
xor $25736, %rdi
lea addresses_D_ht+0x1b04d, %rcx
nop
cmp %rdi, %rdi
...
nop
cmp $55900, %rdi
lea addresses_normal_ht+0xf3cd, %rsi
lea addresses_normal_ht+0x1dd8d, %rdi
nop
and %r13, %r13
mov $57, %rcx
rep movsw
...
nop
dec %r10
lea addresses_WC_ht+0x8b4d, %r10
nop
nop
nop
nop
...
{'src': {'congruent': 9, 'same': False, 'type': 'addresses_P'}, 'OP': 'REPM', 'dst': {'congruent': 11, 'same': False, 'type': 'addresses_P'}}
...
{'OP': 'STOR', 'dst': {'congruent': 0, 'AVXalign': True, 'same': False, 'size': 32, 'NT': False, 'type': 'addresses_UC_ht'}}
...
{'src': {'congruent': 10, 'same': False, 'type': 'addresses_normal_ht'}, 'OP': 'REPM', 'dst': {'congruent': 6, 'same': True, 'type': 'addresses_normal_ht'}}
