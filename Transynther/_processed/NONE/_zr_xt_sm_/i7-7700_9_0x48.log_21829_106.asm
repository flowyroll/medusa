...
push %rdx
push %rsi
lea addresses_normal_ht+0x151cc, %r10
nop
nop
nop
dec %r13
...
nop
cmp %rdx, %rdx
lea addresses_D_ht+0x9520, %rsi
lea addresses_WT_ht+0x1510c, %rdi
clflush (%rsi)
inc %r14
mov $107, %rcx
rep movsw
...
nop
xor %r14, %r14
lea addresses_D_ht+0x19c0c, %rdx
nop
nop
and %rdi, %rdi
mov (%rdx), %r10
and %rax, %rax
lea addresses_UC_ht+0xf80c, %rsi
lea addresses_normal_ht+0x19d9f, %rdi
nop
nop
nop
nop
...
rep movsb
xor $58042, %rdi
lea addresses_WC_ht+0x176cc, %r14
clflush (%r14)
nop
xor %r10, %r10
...
nop
xor %rax, %rax
lea addresses_WC_ht+0x182fc, %rcx
clflush (%rcx)
nop
nop
add %rdx, %rdx
