...
nop
add $27212, %r11
lea addresses_A_ht+0x2aa3, %rbx
add %rcx, %rcx
mov (%rbx), %r13w
nop
and %rdx, %rdx
lea addresses_WC_ht+0x1679f, %rsi
lea addresses_UC_ht+0x15acb, %rdi
nop
and %rdx, %rdx
mov $19, %rcx
rep movsl
...
nop
sub $8958, %rsi
lea addresses_UC_ht+0xd413, %rcx
nop
nop
add %r13, %r13
movb $0x61, (%rcx)
