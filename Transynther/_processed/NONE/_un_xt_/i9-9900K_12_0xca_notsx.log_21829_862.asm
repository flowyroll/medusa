...
movq %rdx, (%rdi)
add $6028, %rbp
lea addresses_normal_ht+0xb5b1, %rdx
nop
nop
add %rdi, %rdi
movb (%rdx), %r13b
inc %r11
lea addresses_A_ht+0xfc1, %rsi
lea addresses_normal_ht+0x19289, %rdi
clflush (%rsi)
nop
nop
nop
...
nop
and %rbp, %rbp
lea addresses_WT_ht+0x5241, %rsi
lea addresses_WC_ht+0x14299, %rdi
nop
nop
nop
nop
...
nop
cmp $13426, %rdx
lea addresses_WT_ht+0x1e7c1, %rsi
lea addresses_WC_ht+0x1bfc1, %rdi
nop
nop
and $49649, %r8
mov $71, %rcx
...
{'OP': 'REPM', 'src': {'same': False, 'congruent': 5, 'type': 'addresses_A_ht'}, 'dst': {'same': False, 'congruent': 3, 'type': 'addresses_normal_ht'}}
{'OP': 'REPM', 'src': {'same': True, 'congruent': 7, 'type': 'addresses_WT_ht'}, 'dst': {'same': False, 'congruent': 1, 'type': 'addresses_WC_ht'}}
