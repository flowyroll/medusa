...
push %rdi
push %rsi
lea addresses_D_ht+0x17a36, %r8
dec %rbp
movb $0x61, (%r8)
nop
nop
sub $13431, %r11
lea addresses_WT_ht+0x16786, %rcx
nop
and $54857, %r8
vmovups (%rcx), %ymm3
...
nop
cmp %r8, %r8
lea addresses_A_ht+0x11158, %rsi
...
rep movsw
inc %rbp
lea addresses_normal_ht+0x1e236, %rsi
nop
nop
nop
xor $37215, %r11
...
nop
sub $35322, %rbp
lea addresses_WC_ht+0x1d70a, %r15
xor %r12, %r12
vmovups (%r15), %ymm1
...
nop
add $43547, %rsi
lea addresses_A_ht+0x11d72, %rbp
xor $43642, %rsi
movb (%rbp), %r11b
nop
nop
nop
cmp %rcx, %rcx
lea addresses_normal_ht+0x14a36, %r8
nop
nop
nop
dec %r11
...
nop
xor %r12, %r12
lea addresses_WT_ht+0x40fe, %r12
nop
nop
nop
and $4239, %r11
...
nop
add $60180, %rdi
lea addresses_A_ht+0x19836, %rsi
lea addresses_A_ht+0xd836, %rdi
nop
nop
nop
nop
...
// Load
lea addresses_normal+0xfc76, %rbx
nop
nop
cmp $57359, %r15
mov (%rbx), %r9d
...
// Store
lea addresses_normal+0x19d36, %rbx
clflush (%rbx)
nop
nop
nop
...
// Faulty Load
lea addresses_normal+0x1ab36, %r9
nop
nop
nop
nop
...
{'OP': 'LOAD', 'src': {'same': False, 'NT': True, 'AVXalign': False, 'size': 4, 'type': 'addresses_normal', 'congruent': 5}}
...
<gen_prepare_buffer>
{'dst': {'same': False, 'NT': False, 'AVXalign': True, 'size': 1, 'type': 'addresses_D_ht', 'congruent': 6}, 'OP': 'STOR'}
{'OP': 'LOAD', 'src': {'same': False, 'NT': False, 'AVXalign': False, 'size': 32, 'type': 'addresses_WT_ht', 'congruent': 4}}
{'dst': {'same': True, 'congruent': 6, 'type': 'addresses_WC_ht'}, 'OP': 'REPM', 'src': {'same': False, 'congruent': 1, 'type': 'addresses_A_ht'}}
{'dst': {'same': False, 'NT': False, 'AVXalign': False, 'size': 1, 'type': 'addresses_normal_ht', 'congruent': 8}, 'OP': 'STOR'}
{'dst': {'same': True, 'NT': False, 'AVXalign': False, 'size': 2, 'type': 'addresses_A_ht', 'congruent': 0}, 'OP': 'STOR'}
...
{'dst': {'same': False, 'NT': False, 'AVXalign': True, 'size': 2, 'type': 'addresses_WT_ht', 'congruent': 3}, 'OP': 'STOR'}
