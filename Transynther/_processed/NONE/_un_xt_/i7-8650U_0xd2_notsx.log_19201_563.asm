...
nop
add %rsi, %rsi
lea addresses_normal_ht+0xe1cf, %rdi
add %r10, %r10
movw $0x6162, (%rdi)
nop
cmp $45972, %rax
lea addresses_UC_ht+0xd93b, %r8
nop
nop
nop
nop
...
nop
xor $51626, %rax
lea addresses_WC_ht+0xb3cf, %rsi
lea addresses_D_ht+0xa4f, %rdi
clflush (%rsi)
nop
xor %r10, %r10
mov $45, %rcx
rep movsw
dec %rcx
lea addresses_WC_ht+0x12ddb, %rsi
nop
nop
dec %rbx
movw $0x6162, (%rsi)
...
nop
dec %rbx
lea addresses_WT_ht+0xcfcf, %rcx
nop
nop
nop
nop
...
nop
and $20265, %r8
lea addresses_D_ht+0xc7cf, %rsi
lea addresses_WT_ht+0x4bcf, %rdi
nop
nop
nop
xor %rbx, %rbx
...
nop
sub $23061, %r15
lea addresses_normal_ht+0xd6cb, %r15
clflush (%r15)
nop
nop
nop
...
nop
sub %rdi, %rdi
lea addresses_WT_ht+0xadcf, %rax
clflush (%rax)
nop
nop
xor $20968, %r8
...
nop
add %r10, %r10
lea addresses_WC_ht+0x118bb, %rsi
lea addresses_D_ht+0x153ff, %rdi
sub %r8, %r8
mov $53, %rcx
rep movsb
and $45861, %r15
...
{'OP': 'STOR', 'dst': {'type': 'addresses_normal_ht', 'size': 2, 'AVXalign': True, 'NT': False, 'congruent': 11, 'same': False}}
...
{'OP': 'LOAD', 'src': {'type': 'addresses_WT_ht', 'size': 8, 'AVXalign': False, 'NT': False, 'congruent': 9, 'same': True}}
...
{'OP': 'REPM', 'src': {'type': 'addresses_WC_ht', 'congruent': 1, 'same': True}, 'dst': {'type': 'addresses_D_ht', 'congruent': 4, 'same': False}}
{'32': 19200, 'ff': 1}
