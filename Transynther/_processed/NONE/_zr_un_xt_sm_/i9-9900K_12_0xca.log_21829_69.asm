...
push %rdi
push %rsi
lea addresses_A_ht+0x17433, %rsi
lea addresses_WC_ht+0xf15d, %rdi
nop
nop
inc %r14
mov $32, %rcx
rep movsb
sub %rbp, %rbp
lea addresses_WT_ht+0x12f98, %r13
nop
nop
nop
nop
...
mov (%r13), %si
add $17684, %r14
lea addresses_normal_ht+0x81ab, %r14
nop
nop
nop
add $1286, %r13
...
movq %rbp, (%r14)
add $13438, %r13
lea addresses_WT_ht+0xe893, %rsi
clflush (%rsi)
nop
nop
nop
...
nop
and %r14, %r14
lea addresses_normal_ht+0xac1, %rsi
nop
nop
nop
nop
...
{'OP': 'LOAD', 'src': {'size': 2, 'NT': False, 'type': 'addresses_WT_ht', 'same': False, 'AVXalign': True, 'congruent': 0}}
