...
nop
xor $22510, %r11
lea addresses_UC_ht+0x17a8b, %rsi
lea addresses_normal_ht+0x400b, %rdi
clflush (%rdi)
nop
nop
nop
...
nop
lfence
lea addresses_UC_ht+0x1ad0b, %rsi
lea addresses_WT_ht+0x1e67b, %rdi
nop
nop
nop
cmp $10131, %r13
...
nop
xor $15518, %r13
lea addresses_WT_ht+0xe50b, %rsi
lea addresses_WC_ht+0x1150b, %rdi
clflush (%rdi)
nop
dec %r10
mov $24, %rcx
...
nop
sub %r13, %r13
lea addresses_WC_ht+0x674b, %r13
nop
nop
nop
nop
...
mov (%r13), %rcx
dec %r14
lea addresses_WT_ht+0xf2a4, %rcx
nop
dec %r13
movl $0x61626364, (%rcx)
xor %rdi, %rdi
lea addresses_normal_ht+0x1224b, %rsi
lea addresses_D_ht+0x1690b, %rdi
dec %r13
mov $95, %rcx
rep movsl
nop
...
{'OP': 'REPM', 'src': {'same': False, 'type': 'addresses_UC_ht', 'congruent': 5}, 'dst': {'same': False, 'type': 'addresses_normal_ht', 'congruent': 8}}
{'OP': 'REPM', 'src': {'same': False, 'type': 'addresses_UC_ht', 'congruent': 11}, 'dst': {'same': True, 'type': 'addresses_WT_ht', 'congruent': 3}}
{'OP': 'REPM', 'src': {'same': False, 'type': 'addresses_WT_ht', 'congruent': 11}, 'dst': {'same': False, 'type': 'addresses_WC_ht', 'congruent': 11}}
{'OP': 'LOAD', 'src': {'size': 8, 'NT': False, 'type': 'addresses_WC_ht', 'same': True, 'AVXalign': False, 'congruent': 5}}
{'OP': 'STOR', 'dst': {'size': 4, 'NT': False, 'type': 'addresses_WT_ht', 'same': False, 'AVXalign': False, 'congruent': 0}}
{'OP': 'REPM', 'src': {'same': False, 'type': 'addresses_normal_ht', 'congruent': 5}, 'dst': {'same': False, 'type': 'addresses_D_ht', 'congruent': 9}}
{'44': 21767, '49': 56, '00': 6}
