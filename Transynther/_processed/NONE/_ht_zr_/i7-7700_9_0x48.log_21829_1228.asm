...
push %rdi
push %rsi
lea addresses_UC_ht+0x5b99, %rsi
lea addresses_WC_ht+0xffad, %rdi
nop
nop
nop
nop
...
rep movsq
add %rbx, %rbx
lea addresses_A_ht+0x17b59, %rbp
and $64881, %r12
mov (%rbp), %di
nop
nop
inc %rcx
lea addresses_D_ht+0x74d9, %rbp
nop
nop
and $23657, %rdi
...
nop
xor %rdi, %rdi
lea addresses_WC_ht+0x12f19, %rsi
...
nop
sub $57689, %rbx
lea addresses_WC_ht+0x2a81, %rsi
lea addresses_A_ht+0x22ae, %rdi
nop
inc %r8
mov $124, %rcx
rep movsb
...
nop
add %rdi, %rdi
lea addresses_WT_ht+0x8711, %rbx
nop
nop
inc %r8
movb $0x61, (%rbx)
...
nop
add $63460, %rsi
lea addresses_normal_ht+0xaa19, %r8
nop
sub %rcx, %rcx
mov (%r8), %rax
nop
nop
xor $9123, %rbx
lea addresses_normal_ht+0x12c99, %r8
nop
nop
and %r12, %r12
movb (%r8), %bl
...
nop
dec %r8
lea addresses_normal_ht+0x1785d, %r12
add %rdi, %rdi
movb $0x61, (%r12)
nop
nop
...
{'OP': 'LOAD', 'src': {'type': 'addresses_A_ht', 'AVXalign': True, 'congruent': 11, 'size': 2, 'same': False, 'NT': True}}
{'OP': 'STOR', 'dst': {'type': 'addresses_D_ht', 'AVXalign': False, 'congruent': 7, 'size': 16, 'same': False, 'NT': False}}
{'OP': 'REPM', 'src': {'type': 'addresses_WC_ht', 'congruent': 6, 'same': False}, 'dst': {'type': 'addresses_D_ht', 'congruent': 3, 'same': False}}
