...
push %rdx
push %rsi
lea addresses_normal_ht+0xd242, %rdx
nop
nop
nop
nop
...
nop
xor $30198, %r8
lea addresses_normal_ht+0x3ada, %r15
nop
xor $38076, %r9
...
vmovups %ymm6, (%r15)
xor $17722, %rbx
lea addresses_A_ht+0xd552, %rsi
lea addresses_normal_ht+0xc4bd, %rdi
nop
nop
nop
nop
...
nop
dec %rbx
lea addresses_A_ht+0x1376d, %rsi
lea addresses_UC_ht+0xc4f2, %rdi
nop
nop
nop
and $18134, %r8
...
nop
inc %rdi
lea addresses_WC_ht+0xe8f2, %rsi
nop
nop
nop
nop
...
nop
and $37174, %rdi
lea addresses_WC_ht+0xef72, %rdi
nop
nop
nop
nop
...
movups %xmm2, (%rdi)
inc %rdx
lea addresses_UC_ht+0x169f2, %rdx
nop
nop
nop
add $43124, %rbx
...
nop
and %r15, %r15
lea addresses_D_ht+0xb4f2, %rsi
lea addresses_WT_ht+0x79d0, %rdi
clflush (%rdi)
cmp %r8, %r8
mov $100, %rcx
rep movsw
and %r8, %r8
lea addresses_WC_ht+0x177f2, %rdi
nop
nop
nop
nop
...
nop
sub $51360, %rsi
lea addresses_WC_ht+0xdcf2, %rdi
nop
nop
nop
nop
...
nop
and $58058, %rsi
lea addresses_WC_ht+0x12ef2, %rsi
lea addresses_UC_ht+0x15032, %rdi
and $24248, %rdx
mov $118, %rcx
rep movsl
nop
...
nop
dec %rdi
lea addresses_normal_ht+0x19572, %rsi
lea addresses_UC_ht+0xf7aa, %rdi
nop
xor %r15, %r15
mov $51, %rcx
rep movsl
nop
and %rbx, %rbx
lea addresses_WT_ht+0x9b82, %rsi
lea addresses_A_ht+0x12df2, %rdi
dec %r9
mov $114, %rcx
rep movsb
add $35979, %rbx
lea addresses_UC_ht+0x12772, %rdi
nop
nop
nop
and %r9, %r9
...
{'OP': 'REPM', 'src': {'type': 'addresses_D_ht', 'congruent': 11, 'same': False}, 'dst': {'type': 'addresses_WT_ht', 'congruent': 1, 'same': False}}
