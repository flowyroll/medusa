...
push %rdx
push %rsi
lea addresses_WT_ht+0x12c5e, %rsi
...
nop
xor %r10, %r10
lea addresses_WT_ht+0x53ac, %r12
nop
nop
nop
nop
...
nop
add $45584, %rbx
lea addresses_normal_ht+0x181ac, %rdx
nop
add %rsi, %rsi
movw $0x6162, (%rdx)
nop
