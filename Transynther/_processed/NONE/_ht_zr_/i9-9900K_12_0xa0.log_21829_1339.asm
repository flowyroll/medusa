...
push %rdx
push %rsi
lea addresses_WT_ht+0x6676, %rdx
cmp $32976, %r15
mov (%rdx), %rsi
nop
nop
cmp $63713, %r12
lea addresses_WT_ht+0x1774e, %r10
nop
nop
nop
nop
...
nop
dec %rdx
lea addresses_A_ht+0x1904e, %rsi
lea addresses_normal_ht+0x1240e, %rdi
nop
nop
nop
cmp $38880, %r12
...
nop
and $13119, %r12
lea addresses_A_ht+0x1ed59, %r10
nop
nop
nop
dec %r12
...
nop
xor $55658, %r15
lea addresses_A_ht+0x14e5e, %rcx
nop
nop
inc %r10
mov (%rcx), %edx
cmp %r12, %r12
lea addresses_normal_ht+0xb58e, %rdi
nop
xor $19669, %rsi
...
nop
and %r15, %r15
lea addresses_D_ht+0x1dfce, %rsi
nop
nop
nop
nop
...
nop
and %r15, %r15
lea addresses_normal_ht+0x2e26, %rsi
clflush (%rsi)
nop
nop
add %r10, %r10
...
nop
add $56692, %rsi
lea addresses_D_ht+0x1b518, %rsi
lea addresses_WT_ht+0x204e, %rdi
nop
nop
nop
nop
...
nop
sub %r15, %r15
lea addresses_normal_ht+0x3b4e, %r15
nop
nop
nop
cmp $48899, %r11
...
nop
and $5315, %r11
lea addresses_WC_ht+0x1b4e, %rsi
lea addresses_normal_ht+0x7f4e, %rdi
clflush (%rsi)
nop
nop
and $33848, %rdx
...
nop
xor $37616, %rdi
lea addresses_WT_ht+0x894e, %rsi
lea addresses_normal_ht+0x304e, %rdi
nop
nop
nop
nop
...
{'OP': 'STOR', 'dst': {'NT': True, 'same': False, 'congruent': 9, 'type': 'addresses_NC', 'AVXalign': False, 'size': 16}}
[Faulty Load]
...
{'src': {'same': False, 'congruent': 8, 'type': 'addresses_A_ht'}, 'OP': 'REPM', 'dst': {'same': False, 'congruent': 4, 'type': 'addresses_normal_ht'}}
...
{'src': {'same': False, 'congruent': 1, 'type': 'addresses_D_ht'}, 'OP': 'REPM', 'dst': {'same': False, 'congruent': 7, 'type': 'addresses_WT_ht'}}
{'src': {'NT': False, 'same': False, 'congruent': 10, 'type': 'addresses_normal_ht', 'AVXalign': False, 'size': 4}, 'OP': 'LOAD'}
{'src': {'same': False, 'congruent': 10, 'type': 'addresses_WC_ht'}, 'OP': 'REPM', 'dst': {'same': False, 'congruent': 11, 'type': 'addresses_normal_ht'}}
{'src': {'same': False, 'congruent': 6, 'type': 'addresses_WT_ht'}, 'OP': 'REPM', 'dst': {'same': False, 'congruent': 2, 'type': 'addresses_normal_ht'}}
{'46': 21828, '00': 1}
