...
push %rdi
push %rsi
lea addresses_UC_ht+0x14e13, %rbp
nop
nop
dec %rbx
...
nop
sub $18376, %r12
lea addresses_normal_ht+0xf979, %rbp
sub %rcx, %rcx
movups (%rbp), %xmm0
vpextrq $1, %xmm0, %rax
and $25131, %rax
lea addresses_UC_ht+0x1a579, %rsi
...
lea addresses_A_ht+0x10979, %rdi
clflush (%rsi)
nop
nop
cmp %r9, %r9
...
<gen_faulty_load>
[REF]
{'OP': 'LOAD', 'src': {'type': 'addresses_A', 'AVXalign': True, 'congruent': 0, 'size': 16, 'same': False, 'NT': True}}
