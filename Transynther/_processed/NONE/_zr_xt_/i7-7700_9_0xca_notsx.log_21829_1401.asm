...
vpextrq $0, %xmm0, %r15
add %rsi, %rsi
lea addresses_D_ht+0x1e6d6, %rsi
lea addresses_WT_ht+0x4052, %rdi
nop
nop
add %r13, %r13
mov $123, %rcx
...
nop
dec %r15
lea addresses_WC_ht+0x32b6, %rcx
nop
nop
xor %rbp, %rbp
movups (%rcx), %xmm3
...
nop
cmp %r8, %r8
lea addresses_UC_ht+0x3826, %r15
nop
nop
nop
cmp $10049, %rcx
...
nop
cmp %rcx, %rcx
lea addresses_WC_ht+0x1e42e, %rsi
...
nop
sub $49821, %rdi
lea addresses_WC_ht+0xbd46, %rsi
nop
nop
nop
nop
...
{'src': {'congruent': 9, 'same': False, 'type': 'addresses_D_ht'}, 'dst': {'congruent': 2, 'same': False, 'type': 'addresses_WT_ht'}, 'OP': 'REPM'}
