...
push %rdi
push %rsi
lea addresses_WC_ht+0xbf44, %rsi
lea addresses_normal_ht+0x3a44, %rdi
clflush (%rsi)
nop
cmp %r8, %r8
mov $67, %rcx
...
nop
and %r9, %r9
lea addresses_UC_ht+0x136a8, %rsi
lea addresses_WC_ht+0x1dfc8, %rdi
nop
nop
nop
nop
...
nop
and $61506, %rsi
lea addresses_WT_ht+0x2112, %rbx
nop
nop
sub $45438, %r14
movb (%rbx), %r8b
...
nop
and %rcx, %rcx
lea addresses_normal_ht+0x5f90, %rsi
lea addresses_normal_ht+0x14f8, %rdi
nop
nop
nop
nop
...
nop
xor %rdi, %rdi
lea addresses_normal_ht+0x195e8, %r14
nop
nop
nop
sub %rbp, %rbp
...
nop
and %rbx, %rbx
lea addresses_normal_ht+0x7e8, %rbp
clflush (%rbp)
nop
nop
nop
...
// Load
lea addresses_normal+0x1eee8, %r10
nop
nop
nop
nop
...
{'src': {'type': 'addresses_normal_ht', 'congruent': 2, 'same': False}, 'dst': {'type': 'addresses_normal_ht', 'congruent': 4, 'same': False}, 'OP': 'REPM'}
...
{'src': {'type': 'addresses_normal_ht', 'same': True, 'size': 8, 'congruent': 6, 'NT': True, 'AVXalign': False}, 'OP': 'LOAD'}
{'00': 1, '35': 21828}
