...
nop
inc %r12
lea addresses_WT_ht+0xb880, %rdi
clflush (%rdi)
nop
sub %rbx, %rbx
...
nop
cmp %rcx, %rcx
lea addresses_UC_ht+0x116d1, %r15
clflush (%r15)
nop
nop
xor $19729, %rcx
movb $0x61, (%r15)
sub %rcx, %rcx
lea addresses_normal_ht+0xb245, %r13
clflush (%r13)
dec %rbx
movl $0x61626364, (%r13)
nop
...
nop
and $45225, %rbx
lea addresses_UC_ht+0x2191, %rsi
nop
nop
nop
inc %r10
...
nop
sub $23029, %r15
lea addresses_UC_ht+0x4511, %rsi
lea addresses_normal_ht+0x1cd51, %rdi
nop
nop
xor $29222, %r13
mov $44, %rcx
...
<gen_prepare_buffer>
{'src': {'type': 'addresses_A_ht', 'AVXalign': True, 'size': 1, 'NT': True, 'same': False, 'congruent': 9}, 'OP': 'LOAD'}
