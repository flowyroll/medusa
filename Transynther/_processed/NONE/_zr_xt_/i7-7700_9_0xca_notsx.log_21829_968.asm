...
nop
inc %r10
lea addresses_normal_ht+0x72b2, %r12
nop
cmp %rbx, %rbx
mov (%r12), %rcx
nop
...
nop
cmp $47703, %rdi
lea addresses_normal_ht+0x74e2, %r12
nop
nop
nop
nop
...
mov (%r12), %r13d
cmp %r13, %r13
lea addresses_UC_ht+0x17ee2, %rdi
nop
add $63215, %r12
movb (%rdi), %r10b
xor $24756, %r13
lea addresses_normal_ht+0xce9d, %r12
nop
nop
nop
nop
...
// Store
lea addresses_normal+0x13ce2, %rbx
nop
inc %r11
...
<gen_prepare_buffer>
{'src': {'congruent': 8, 'same': False, 'type': 'addresses_WC_ht'}, 'dst': {'congruent': 0, 'same': True, 'type': 'addresses_WT_ht'}, 'OP': 'REPM'}
...
{'src': {'NT': False, 'AVXalign': False, 'size': 1, 'congruent': 9, 'same': True, 'type': 'addresses_UC_ht'}, 'OP': 'LOAD'}
