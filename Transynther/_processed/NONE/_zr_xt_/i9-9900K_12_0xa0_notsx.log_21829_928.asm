...
lea addresses_WC_ht+0xff13, %rdi
nop
nop
nop
nop
...
nop
cmp $53869, %rsi
lea addresses_A_ht+0x14513, %r15
nop
nop
nop
nop
...
lea addresses_normal_ht+0x9cde, %rdi
nop
sub $19116, %rbx
mov $31, %rcx
rep movsb
...
nop
inc %r13
lea addresses_UC_ht+0x16872, %rcx
clflush (%rcx)
nop
nop
nop
...
nop
sub %rbx, %rbx
lea addresses_WC_ht+0xad13, %rsi
lea addresses_WC_ht+0x3313, %rdi
nop
nop
cmp $22782, %rbx
mov $60, %rcx
...
nop
add $38724, %rdi
lea addresses_normal_ht+0x2ec3, %rdi
nop
nop
nop
nop
...
nop
dec %r12
lea addresses_A_ht+0x145d5, %rsi
lea addresses_D_ht+0xab3, %rdi
nop
add $29309, %r15
mov $51, %rcx
rep movsl
inc %rsi
lea addresses_WT_ht+0x1db13, %rsi
lea addresses_normal_ht+0x1414b, %rdi
and $30745, %r15
mov $59, %rcx
rep movsq
sub $48771, %r12
...
{'src': {'type': 'addresses_UC_ht', 'AVXalign': False, 'size': 4, 'NT': False, 'same': True, 'congruent': 0}, 'OP': 'LOAD'}
...
{'src': {'type': 'addresses_A_ht', 'congruent': 1, 'same': False}, 'OP': 'REPM', 'dst': {'type': 'addresses_D_ht', 'congruent': 3, 'same': False}}
{'src': {'type': 'addresses_WT_ht', 'congruent': 6, 'same': False}, 'OP': 'REPM', 'dst': {'type': 'addresses_normal_ht', 'congruent': 2, 'same': True}}
{'35': 21828, '00': 1}
