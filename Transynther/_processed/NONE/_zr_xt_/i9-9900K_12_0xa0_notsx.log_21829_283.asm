...
lea addresses_A_ht+0x1afc0, %rdi
nop
nop
nop
nop
...
nop
and $2192, %r13
lea addresses_A_ht+0x87a0, %rsi
lea addresses_WC_ht+0x14b80, %rdi
clflush (%rsi)
nop
nop
nop
...
nop
xor %rcx, %rcx
lea addresses_UC_ht+0x11fc0, %rsi
lea addresses_UC_ht+0x1a300, %rdi
nop
nop
nop
nop
...
{'OP': 'STOR', 'dst': {'type': 'addresses_normal_ht', 'AVXalign': False, 'size': 16, 'NT': True, 'same': False, 'congruent': 11}}
{'35': 21828, '00': 1}
