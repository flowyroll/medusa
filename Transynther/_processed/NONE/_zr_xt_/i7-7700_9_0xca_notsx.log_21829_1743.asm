...
nop
cmp $36539, %rsi
lea addresses_A_ht+0x698e, %rsi
lea addresses_UC_ht+0x11f66, %rdi
nop
cmp %r10, %r10
mov $3, %rcx
rep movsw
...
nop
xor $28097, %rax
lea addresses_UC_ht+0x17166, %rax
xor %r11, %r11
vmovups (%rax), %ymm6
...
nop
add $28663, %rdi
lea addresses_normal_ht+0x14f66, %rsi
nop
nop
mfence
mov (%rsi), %r12w
...
nop
add %rax, %rax
lea addresses_UC_ht+0x4e46, %rcx
nop
nop
nop
and %rdi, %rdi
...
nop
dec %rcx
lea addresses_UC_ht+0xf976, %rsi
lea addresses_WT_ht+0x14b66, %rdi
clflush (%rdi)
nop
and %r12, %r12
mov $66, %rcx
...
nop
sub $47104, %rcx
lea addresses_D_ht+0x19ed8, %rsi
lea addresses_normal_ht+0x5366, %rdi
nop
cmp %r9, %r9
mov $28, %rcx
rep movsw
...
nop
and %rax, %rax
lea addresses_WC_ht+0x15206, %r10
nop
nop
nop
nop
...
movb $0x61, (%r9)
dec %r9
lea addresses_normal_ht+0x1391e, %rcx
nop
xor %r11, %r11
movw $0x6162, (%rcx)
nop
...
{'src': {'congruent': 4, 'same': True, 'type': 'addresses_UC_ht'}, 'dst': {'congruent': 9, 'same': False, 'type': 'addresses_WT_ht'}, 'OP': 'REPM'}
