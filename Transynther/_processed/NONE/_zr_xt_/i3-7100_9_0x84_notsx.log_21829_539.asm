...
lea addresses_UC_ht+0x178da, %rdi
nop
nop
nop
nop
...
nop
and %rbp, %rbp
lea addresses_A_ht+0x1e53c, %r13
add %rdi, %rdi
...
nop
xor $12482, %r13
lea addresses_WT_ht+0x1d43c, %rax
nop
xor %rdi, %rdi
movw $0x6162, (%rax)
nop
...
// Store
lea addresses_WT+0x118dc, %r13
add %rax, %rax
movb $0x51, (%r13)
and $42827, %r10

// Faulty Load
lea addresses_A+0xdc, %r10
nop
nop
nop
nop
