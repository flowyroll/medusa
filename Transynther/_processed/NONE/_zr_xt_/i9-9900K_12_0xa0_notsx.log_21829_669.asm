...
lea addresses_D_ht+0x18047, %rdi
nop
nop
nop
and $4469, %r12
...
nop
cmp %r9, %r9
lea addresses_WT_ht+0x48c7, %rsi
lea addresses_D_ht+0x155c7, %rdi
clflush (%rsi)
nop
sub %r9, %r9
mov $100, %rcx
...
vmovups %ymm6, (%r12)
and $25922, %rdi
lea addresses_WC_ht+0xd347, %rsi
nop
xor %rdi, %rdi
mov (%rsi), %r9w
nop
...
nop
and %r12, %r12
lea addresses_WC_ht+0x17235, %rsi
lea addresses_normal_ht+0xfa7, %rdi
clflush (%rdi)
xor $13870, %rdx
mov $123, %rcx
rep movsb
...
nop
cmp %rbx, %rbx
lea addresses_D_ht+0x16513, %rsi
lea addresses_normal_ht+0x178c7, %rdi
nop
nop
sub $52788, %r9
mov $94, %rcx
rep movsw
add %rdi, %rdi
lea addresses_A_ht+0x9e97, %rsi
lea addresses_UC_ht+0x5947, %rdi
nop
nop
nop
nop
...
nop
add %r9, %r9
lea addresses_normal_ht+0x15847, %rdi
nop
nop
add %rbp, %rbp
movups (%rdi), %xmm4
...
nop
cmp $53347, %rdx
lea addresses_WT_ht+0x14e47, %rsi
nop
nop
nop
nop
...
nop
and %rcx, %rcx
lea addresses_normal_ht+0x341b, %rsi
nop
nop
nop
nop
...
nop
cmp $39263, %rcx
lea addresses_WT_ht+0x198c7, %rdx
nop
nop
nop
nop
...
nop
sub %rbp, %rbp
lea addresses_UC_ht+0x3903, %rcx
nop
nop
dec %rbx
...
{'src': {'type': 'addresses_A_ht', 'congruent': 4, 'same': False}, 'OP': 'REPM', 'dst': {'type': 'addresses_UC_ht', 'congruent': 8, 'same': True}}
...
{'OP': 'STOR', 'dst': {'type': 'addresses_UC_ht', 'AVXalign': False, 'size': 32, 'NT': False, 'same': True, 'congruent': 2}}
{'35': 21828, '00': 1}
