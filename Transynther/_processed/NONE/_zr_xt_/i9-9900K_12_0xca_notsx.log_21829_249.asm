...
push %rdi
push %rsi
lea addresses_normal_ht+0x17810, %r12
nop
nop
nop
nop
...
nop
xor %rax, %rax
lea addresses_UC_ht+0x1d410, %r15
nop
xor $3274, %r11
...
nop
dec %r11
lea addresses_UC_ht+0xe1c0, %r8
nop
add $28564, %rcx
movb $0x61, (%r8)
nop
xor $21573, %r15
lea addresses_WT_ht+0x16d00, %rsi
lea addresses_A_ht+0x1eb90, %rdi
clflush (%rsi)
nop
nop
nop
...
rep movsw
sub $24686, %rdi
lea addresses_WT_ht+0x2430, %rsi
nop
nop
sub %r8, %r8
movl $0x61626364, (%rsi)
...
nop
cmp $17612, %r12
lea addresses_WT_ht+0x15b4c, %rax
nop
nop
dec %r8
...
nop
dec %rsi
lea addresses_WT_ht+0x9e10, %rdi
nop
nop
xor $24567, %rax
movb (%rdi), %r12b
...
nop
cmp %rax, %rax
lea addresses_normal_ht+0x2428, %r11
nop
and %r12, %r12
movups (%r11), %xmm2
vpextrq $0, %xmm2, %r15
...
nop
xor %rsi, %rsi
lea addresses_A_ht+0xe010, %rsi
nop
xor $5198, %rdi
movb $0x61, (%rsi)
cmp $23581, %rdi
lea addresses_D_ht+0x1967a, %r12
nop
nop
nop
sub $9806, %rsi
...
{'OP': 'REPM', 'src': {'same': False, 'congruent': 4, 'type': 'addresses_WT_ht'}, 'dst': {'same': False, 'congruent': 7, 'type': 'addresses_A_ht'}}
