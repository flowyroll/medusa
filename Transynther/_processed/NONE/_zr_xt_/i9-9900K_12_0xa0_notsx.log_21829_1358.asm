...
nop
and $28503, %r10
lea addresses_normal_ht+0x14074, %rcx
nop
nop
dec %r10
mov (%rcx), %rbx
...
nop
inc %r8
lea addresses_A_ht+0x1ead4, %rsi
lea addresses_WC_ht+0x14bc0, %rdi
nop
xor %r14, %r14
mov $106, %rcx
rep movsl
...
nop
xor $55603, %rbx
lea addresses_UC_ht+0xa974, %rsi
lea addresses_normal_ht+0x1b674, %rdi
and $51108, %r8
mov $123, %rcx
rep movsl
nop
...
<gen_prepare_buffer>
{'src': {'type': 'addresses_WT_ht', 'congruent': 10, 'same': False}, 'OP': 'REPM', 'dst': {'type': 'addresses_WC_ht', 'congruent': 7, 'same': False}}
