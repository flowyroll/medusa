...
push %rdx
push %rsi
lea addresses_A_ht+0x183f9, %rsi
lea addresses_normal_ht+0xc625, %rdi
nop
nop
nop
and %r12, %r12
...
nop
xor $28307, %r10
lea addresses_A_ht+0x11f5f, %rsi
lea addresses_UC_ht+0xc025, %rdi
nop
nop
xor %r12, %r12
mov $110, %rcx
...
nop
add $20251, %r14
lea addresses_UC_ht+0x13125, %rdi
nop
nop
nop
nop
...
nop
xor %rsi, %rsi
lea addresses_D_ht+0x197d5, %rdi
nop
add $46052, %rcx
mov (%rdi), %edx
nop
...
nop
and %r10, %r10
lea addresses_WC_ht+0xc625, %r12
nop
nop
nop
add $23163, %rdi
...
nop
xor $48644, %rdi
lea addresses_WT_ht+0x10225, %rsi
add $19260, %r12
mov (%rsi), %edx
nop
nop
cmp $7423, %r12
lea addresses_A_ht+0x897e, %r10
nop
add %r14, %r14
movups (%r10), %xmm0
vpextrq $0, %xmm0, %rdi
...
{'OP': 'REPM', 'src': {'type': 'addresses_A_ht', 'congruent': 0, 'same': False}, 'dst': {'type': 'addresses_UC_ht', 'congruent': 8, 'same': True}}
