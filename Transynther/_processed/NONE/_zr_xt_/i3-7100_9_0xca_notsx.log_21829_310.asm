...
push %rbx
push %rdx
lea addresses_WT_ht+0x15686, %rdx
nop
nop
nop
nop
...
// REPMOV
lea addresses_PSE+0x1cae6, %rsi
lea addresses_WC+0x1ee86, %rdi
nop
nop
nop
nop
...
{'src': {'type': 'addresses_PSE', 'congruent': 4, 'same': False}, 'OP': 'REPM', 'dst': {'type': 'addresses_WC', 'congruent': 11, 'same': False}}
