...
push %rdi
push %rsi
lea addresses_normal_ht+0xc972, %rax
nop
cmp $591, %rbp
...
nop
sub %r12, %r12
lea addresses_UC_ht+0x57a, %rsi
lea addresses_D_ht+0xade4, %rdi
clflush (%rdi)
nop
xor %r13, %r13
mov $67, %rcx
...
nop
add $16955, %r8
lea addresses_normal_ht+0x16c3a, %r14
sub %r13, %r13
movl $0x61626364, (%r14)
add %r13, %r13
lea addresses_UC_ht+0x1e7ea, %r14
nop
nop
nop
nop
...
nop
and %r13, %r13
lea addresses_normal_ht+0x441a, %rcx
nop
nop
xor $41869, %r12
mov (%rcx), %si
add %rcx, %rcx
lea addresses_UC_ht+0x1dc1a, %rcx
clflush (%rcx)
nop
nop
nop
...
{'OP': 'STOR', 'dst': {'type': 'addresses_A', 'AVXalign': False, 'congruent': 1, 'size': 32, 'same': False, 'NT': True}}
[Faulty Load]
