...
nop
cmp $21899, %rbp
lea addresses_WT_ht+0xa780, %rsi
...
rep movsl
xor %rdi, %rdi
lea addresses_D_ht+0xc0fc, %rbp
cmp $21328, %rax
movb (%rbp), %cl
cmp $20703, %r14
lea addresses_WC_ht+0x14cc, %r14
clflush (%r14)
nop
nop
nop
...
nop
dec %r13
lea addresses_UC_ht+0x150fc, %rsi
lea addresses_UC_ht+0xdebc, %rdi
sub %r12, %r12
mov $109, %rcx
rep movsw
nop
xor $28332, %rdi
lea addresses_UC_ht+0x8fc, %r14
dec %r13
mov (%r14), %r12d
nop
nop
...
nop
xor $56315, %rcx
lea addresses_A_ht+0x139fc, %rsi
and %rdi, %rdi
mov (%rsi), %r14w
nop
nop
...
nop
inc %rbp
lea addresses_normal_ht+0x496c, %rsi
lea addresses_normal_ht+0x1e27c, %rdi
nop
nop
and %r13, %r13
mov $44, %rcx
...
nop
and $23736, %rdi
lea addresses_WT_ht+0x1a56c, %rcx
clflush (%rcx)
nop
nop
nop
...
nop
and $49676, %rax
lea addresses_A_ht+0x104dc, %rdi
nop
mfence
mov (%rdi), %cx
nop
...
<gen_faulty_load>
[REF]
{'src': {'congruent': 0, 'AVXalign': False, 'same': False, 'size': 16, 'NT': True, 'type': 'addresses_WT'}, 'OP': 'LOAD'}
[Faulty Load]
{'src': {'congruent': 0, 'AVXalign': False, 'same': True, 'size': 1, 'NT': False, 'type': 'addresses_WT'}, 'OP': 'LOAD'}
<gen_prepare_buffer>
{'src': {'congruent': 5, 'same': True, 'type': 'addresses_A_ht'}, 'OP': 'REPM', 'dst': {'congruent': 7, 'same': False, 'type': 'addresses_D_ht'}}
{'src': {'congruent': 0, 'same': False, 'type': 'addresses_WT_ht'}, 'OP': 'REPM', 'dst': {'congruent': 6, 'same': False, 'type': 'addresses_normal_ht'}}
...
{'src': {'congruent': 4, 'AVXalign': True, 'same': False, 'size': 32, 'NT': False, 'type': 'addresses_WT_ht'}, 'OP': 'LOAD'}
