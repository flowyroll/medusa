...
push %rdi
push %rsi
lea addresses_normal_ht+0xd497, %rsi
lea addresses_D_ht+0x14d37, %rdi
nop
nop
nop
nop
...
nop
xor $33926, %rsi
lea addresses_UC_ht+0x13ec7, %rdi
nop
nop
nop
nop
...
nop
lfence
lea addresses_D_ht+0x1be92, %rsi
lea addresses_A_ht+0xecdb, %rdi
clflush (%rsi)
nop
nop
sub $64449, %rax
...
nop
cmp %rax, %rax
lea addresses_UC_ht+0x8097, %rsi
lea addresses_WC_ht+0x5103, %rdi
nop
nop
nop
nop
...
nop
and %r14, %r14
lea addresses_normal_ht+0x1d027, %r14
nop
nop
and $49593, %r11
movb $0x61, (%r14)
...
nop
add $61432, %rcx
lea addresses_normal_ht+0x1d497, %r10
xor %r14, %r14
movups (%r10), %xmm6
vpextrq $0, %xmm6, %rbp
and $36126, %rsi
lea addresses_D_ht+0x697, %rsi
lea addresses_WT_ht+0xfc97, %rdi
nop
nop
nop
nop
...
nop
sub $38956, %r11
lea addresses_WT_ht+0x17a97, %rbp
nop
nop
cmp $53911, %rax
mov (%rbp), %rcx
...
{'src': {'type': 'addresses_D_ht', 'congruent': 9, 'same': False}, 'OP': 'REPM', 'dst': {'type': 'addresses_WT_ht', 'congruent': 9, 'same': True}}
