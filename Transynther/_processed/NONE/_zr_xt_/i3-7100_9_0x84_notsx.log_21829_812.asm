...
push %rdi
push %rsi
lea addresses_WC_ht+0x1eeeb, %rbp
nop
nop
sub %r15, %r15
...
nop
sub %rbx, %rbx
lea addresses_UC_ht+0x1bdff, %rsi
lea addresses_WT_ht+0x1a9bf, %rdi
dec %r9
mov $55, %rcx
rep movsw
nop
...
nop
cmp $57924, %rsi
lea addresses_UC_ht+0x1d8eb, %r9
nop
and $63347, %rcx
mov (%r9), %ebx
cmp $53964, %rsi
lea addresses_WT_ht+0x1abeb, %r15
nop
nop
add $5749, %r9
mov (%r15), %cx
...
{'src': {'type': 'addresses_UC_ht', 'congruent': 1, 'same': True}, 'dst': {'type': 'addresses_WT_ht', 'congruent': 0, 'same': False}, 'OP': 'REPM'}
...
{'src': {'type': 'addresses_WT_ht', 'same': False, 'size': 2, 'congruent': 8, 'NT': False, 'AVXalign': True}, 'OP': 'LOAD'}
