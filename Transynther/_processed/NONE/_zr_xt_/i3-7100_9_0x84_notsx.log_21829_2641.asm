...
push %rdx
push %rsi
lea addresses_WC_ht+0x1c080, %rdx
cmp %rdi, %rdi
...
nop
add $47434, %r9
lea addresses_UC_ht+0x1f00, %r15
nop
nop
nop
sub %r12, %r12
...
nop
and %r12, %r12
lea addresses_WT_ht+0xf330, %rsi
...
nop
cmp $22906, %r15
lea addresses_normal_ht+0x23d0, %rbp
nop
nop
nop
cmp %r15, %r15
...
nop
and %rbp, %rbp
lea addresses_WC_ht+0x1900, %rcx
nop
nop
nop
xor $30059, %r15
...
nop
add $21917, %r12
lea addresses_normal_ht+0x16500, %rdx
nop
nop
cmp $6104, %rbp
movb $0x61, (%rdx)
...
nop
inc %r9
lea addresses_normal_ht+0x9100, %rsi
nop
nop
add $57833, %r12
movw $0x6162, (%rsi)
...
nop
sub $33566, %rsi
lea addresses_WT_ht+0x11d68, %r15
nop
nop
dec %rbp
movb (%r15), %r12b
...
nop
xor %rdi, %rdi
lea addresses_A_ht+0x1cf00, %r12
nop
xor $29853, %rdi
...
nop
cmp %rbp, %rbp
lea addresses_D_ht+0x64de, %r13
nop
nop
cmp $45959, %rcx
movb $0x61, (%r13)
sub %rcx, %rcx
lea addresses_WC_ht+0x8300, %rsi
lea addresses_WC_ht+0xe145, %rdi
nop
and $60697, %r13
mov $73, %rcx
rep movsl
...
nop
sub $37986, %rdi
lea addresses_WT_ht+0x1a300, %rsi
lea addresses_D_ht+0x10f00, %rdi
nop
nop
nop
nop
...
{'src': {'type': 'addresses_D_ht', 'same': True, 'size': 8, 'congruent': 8, 'NT': False, 'AVXalign': True}, 'OP': 'LOAD'}
...
{'src': {'type': 'addresses_WT_ht', 'same': True, 'size': 1, 'congruent': 3, 'NT': False, 'AVXalign': False}, 'OP': 'LOAD'}
