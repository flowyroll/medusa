...
push %rdx
push %rsi
lea addresses_WC_ht+0x1660, %rsi
lea addresses_D_ht+0x1528d, %rdi
clflush (%rsi)
nop
dec %rbp
mov $105, %rcx
...
// Store
lea addresses_normal+0x65e0, %r14
nop
nop
nop
nop
...
{'OP': 'LOAD', 'src': {'same': False, 'NT': False, 'AVXalign': False, 'size': 32, 'type': 'addresses_D', 'congruent': 6}}
{'dst': {'same': False, 'NT': False, 'AVXalign': False, 'size': 32, 'type': 'addresses_PSE', 'congruent': 9}, 'OP': 'STOR'}
{'dst': {'same': False, 'NT': False, 'AVXalign': True, 'size': 32, 'type': 'addresses_normal', 'congruent': 11}, 'OP': 'STOR'}
[Faulty Load]
