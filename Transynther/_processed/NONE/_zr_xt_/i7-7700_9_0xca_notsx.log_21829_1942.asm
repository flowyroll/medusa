...
nop
and %r10, %r10
lea addresses_WT_ht+0x13705, %r14
nop
nop
nop
nop
...
nop
add %rdi, %rdi
lea addresses_normal_ht+0x1a12f, %r12
nop
nop
and %rsi, %rsi
movl $0x61626364, (%r12)
...
nop
sub $37626, %r9
lea addresses_D_ht+0x1a3c5, %rsi
lea addresses_WT_ht+0x97e6, %rdi
inc %r8
mov $30, %rcx
rep movsb
nop
...
nop
and $48532, %rsi
lea addresses_normal_ht+0x18c85, %rsi
lea addresses_WT_ht+0x151c5, %rdi
clflush (%rdi)
nop
nop
nop
...
nop
sub %r12, %r12
lea addresses_WT_ht+0x1fa5, %rcx
nop
nop
nop
nop
...
nop
sub $1871, %r12
lea addresses_WT_ht+0x6ec5, %rcx
nop
nop
nop
nop
...
nop
add %r12, %r12
lea addresses_D_ht+0x1551d, %r14
nop
nop
nop
nop
...
nop
inc %r8
lea addresses_UC_ht+0x159c5, %rsi
lea addresses_D_ht+0x1cfc5, %rdi
nop
nop
nop
nop
...
{'src': {'congruent': 10, 'same': False, 'type': 'addresses_D_ht'}, 'dst': {'congruent': 0, 'same': False, 'type': 'addresses_WT_ht'}, 'OP': 'REPM'}
{'src': {'congruent': 6, 'same': True, 'type': 'addresses_normal_ht'}, 'dst': {'congruent': 8, 'same': False, 'type': 'addresses_WT_ht'}, 'OP': 'REPM'}
...
{'dst': {'NT': False, 'AVXalign': True, 'size': 2, 'congruent': 8, 'same': False, 'type': 'addresses_A_ht'}, 'OP': 'STOR'}
