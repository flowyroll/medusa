...
nop
xor %r8, %r8
lea addresses_WT_ht+0x1cb15, %rcx
nop
nop
nop
nop
...
mov (%rcx), %eax
xor $47247, %rbp
lea addresses_UC_ht+0x1eb95, %rcx
sub %r15, %r15
movb (%rcx), %r10b
nop
sub %rbp, %rbp
lea addresses_WT_ht+0x5b55, %rsi
lea addresses_UC_ht+0x1db15, %rdi
nop
cmp %r14, %r14
mov $73, %rcx
rep movsl
...
nop
dec %r14
lea addresses_D_ht+0x16a15, %rax
add %rcx, %rcx
mov (%rax), %di
nop
nop
...
nop
xor $19465, %r8
lea addresses_normal_ht+0x9b15, %r8
nop
nop
nop
nop
...
nop
sub %rcx, %rcx
lea addresses_WC_ht+0x4f4d, %rsi
lea addresses_WT_ht+0x6415, %rdi
clflush (%rsi)
nop
nop
nop
...
rep movsl
add $28669, %r14
lea addresses_WT_ht+0xf215, %rdi
nop
nop
nop
nop
...
mov (%rdi), %r14d
xor %r8, %r8
lea addresses_UC_ht+0x6715, %rsi
...
nop
lfence
lea addresses_UC_ht+0xe695, %rsi
clflush (%rsi)
nop
nop
nop
...
nop
sub $33196, %r14
lea addresses_UC_ht+0x2715, %r15
clflush (%r15)
nop
nop
nop
...
movl $0x61626364, (%r15)
sub %rsi, %rsi
lea addresses_UC_ht+0x9155, %rsi
lea addresses_D_ht+0x7c15, %rdi
nop
nop
nop
nop
...
{'OP': 'REPM', 'src': {'type': 'addresses_WT_ht', 'congruent': 5, 'same': False}, 'dst': {'type': 'addresses_UC_ht', 'congruent': 9, 'same': False}}
...
{'OP': 'REPM', 'src': {'type': 'addresses_UC_ht', 'congruent': 5, 'same': False}, 'dst': {'type': 'addresses_D_ht', 'congruent': 7, 'same': False}}
{'39': 154, '00': 21675}
