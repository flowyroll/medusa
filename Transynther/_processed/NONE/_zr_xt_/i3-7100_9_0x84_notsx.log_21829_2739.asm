...
nop
xor $34271, %rsi
lea addresses_WC_ht+0x47c8, %rsi
lea addresses_UC_ht+0xb29, %rdi
nop
nop
nop
nop
...
nop
and %rbx, %rbx
lea addresses_WT_ht+0x10768, %r12
clflush (%r12)
nop
nop
nop
...
nop
dec %rbx
lea addresses_normal_ht+0x10b48, %rsi
nop
nop
nop
nop
...
nop
dec %rdi
lea addresses_WC_ht+0x15548, %rcx
nop
nop
nop
nop
...
vmovups %ymm3, (%rcx)
cmp %r10, %r10
lea addresses_WT_ht+0x11ef3, %rsi
...
nop
inc %r14
lea addresses_normal_ht+0x18f48, %r14
and $56271, %r10
movups (%r14), %xmm2
vpextrq $1, %xmm2, %rsi
nop
lfence
lea addresses_A_ht+0xc988, %r12
cmp $64026, %r14
mov (%r12), %bx
nop
add $61969, %r12
lea addresses_WC_ht+0x9828, %rsi
lea addresses_D_ht+0x1d748, %rdi
nop
nop
nop
nop
...
nop
sub %r10, %r10
lea addresses_D_ht+0x1bfec, %r10
nop
nop
cmp $5304, %rbx
mov $0x6162636465666768, %rdi
...
movups %xmm1, (%r10)
cmp $49067, %rdi
lea addresses_D_ht+0x1ad21, %rbx
nop
nop
nop
sub %rsi, %rsi
...
nop
cmp $45639, %r14
lea addresses_WT_ht+0x6950, %r14
nop
nop
nop
nop
...
<gen_prepare_buffer>
{'src': {'type': 'addresses_WC_ht', 'congruent': 11, 'same': True}, 'dst': {'type': 'addresses_normal_ht', 'congruent': 7, 'same': False}, 'OP': 'REPM'}
{'dst': {'type': 'addresses_A_ht', 'same': False, 'size': 1, 'congruent': 9, 'NT': False, 'AVXalign': False}, 'OP': 'STOR'}
{'src': {'type': 'addresses_WC_ht', 'congruent': 6, 'same': False}, 'dst': {'type': 'addresses_UC_ht', 'congruent': 0, 'same': False}, 'OP': 'REPM'}
