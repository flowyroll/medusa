...
push %rdi
push %rsi
lea addresses_normal_ht+0x15f08, %rsi
nop
nop
nop
nop
...
nop
xor $59298, %rsi
lea addresses_WC_ht+0x1bf40, %rsi
lea addresses_UC_ht+0x39e0, %rdi
nop
nop
nop
nop
...
mov (%rcx), %esi
inc %r8
lea addresses_A_ht+0x1b4c0, %rsi
lea addresses_A_ht+0x12bc0, %rdi
nop
nop
cmp $30308, %r9
mov $110, %rcx
...
nop
inc %rdi
lea addresses_UC_ht+0x1dcc0, %r9
nop
nop
nop
nop
...
nop
and $16946, %rbx
lea addresses_UC_ht+0x11cc0, %r8
clflush (%r8)
cmp $52989, %rdi
vmovups (%r8), %ymm7
...
lea addresses_WC_ht+0x1c200, %rdi
clflush (%rsi)
nop
nop
nop
...
nop
cmp $28740, %rax
lea addresses_UC_ht+0xd9a0, %rsi
lea addresses_normal_ht+0x18130, %rdi
nop
nop
nop
dec %r8
...
nop
add $43665, %rcx
lea addresses_WT_ht+0x1a4c8, %rsi
clflush (%rsi)
nop
sub %rdi, %rdi
...
// REPMOV
lea addresses_A+0x1b920, %rsi
lea addresses_A+0x178c0, %rdi
nop
cmp $2630, %r15
mov $32, %rcx
rep movsb
...
{'OP': 'REPM', 'src': {'type': 'addresses_A', 'congruent': 5, 'same': False}, 'dst': {'type': 'addresses_A', 'congruent': 10, 'same': False}}
[Faulty Load]
...
{'OP': 'REPM', 'src': {'type': 'addresses_UC_ht', 'congruent': 5, 'same': False}, 'dst': {'type': 'addresses_normal_ht', 'congruent': 4, 'same': False}}
