...
nop
sub %r15, %r15
lea addresses_WC_ht+0x11e3d, %r8
nop
nop
nop
nop
...
nop
add %rax, %rax
lea addresses_normal_ht+0x2f1d, %rsi
lea addresses_UC_ht+0x1459d, %rdi
xor %rdx, %rdx
mov $8, %rcx
rep movsw
nop
...
<gen_prepare_buffer>
{'src': {'congruent': 4, 'same': False, 'type': 'addresses_normal_ht'}, 'dst': {'congruent': 0, 'same': False, 'type': 'addresses_WC_ht'}, 'OP': 'REPM'}
{'dst': {'NT': False, 'AVXalign': False, 'size': 32, 'congruent': 4, 'same': False, 'type': 'addresses_WC_ht'}, 'OP': 'STOR'}
{'src': {'congruent': 10, 'same': False, 'type': 'addresses_normal_ht'}, 'dst': {'congruent': 7, 'same': False, 'type': 'addresses_UC_ht'}, 'OP': 'REPM'}
{'00': 1, '35': 21828}
