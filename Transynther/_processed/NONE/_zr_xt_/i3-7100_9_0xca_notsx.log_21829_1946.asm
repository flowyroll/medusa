...
push %rdi
push %rsi
lea addresses_UC_ht+0x17f68, %rsi
...
nop
add %r9, %r9
lea addresses_WT_ht+0x6468, %r10
and $43374, %r14
...
nop
and $57333, %rsi
lea addresses_normal_ht+0xcdca, %rsi
nop
and %r8, %r8
mov (%rsi), %r14d
cmp %r14, %r14
lea addresses_WT_ht+0x1b560, %rsi
lea addresses_WT_ht+0x1b368, %rdi
nop
nop
nop
nop
...
nop
xor %r9, %r9
lea addresses_WC_ht+0x1c888, %r14
nop
nop
nop
add $36634, %rdi
...
nop
xor %rcx, %rcx
lea addresses_normal_ht+0x85e8, %rsi
lea addresses_normal_ht+0x19ce8, %rdi
nop
nop
nop
nop
...
{'src': {'type': 'addresses_normal_ht', 'congruent': 7, 'same': False}, 'OP': 'REPM', 'dst': {'type': 'addresses_normal_ht', 'congruent': 5, 'same': False}}
{'35': 21828, '00': 1}
