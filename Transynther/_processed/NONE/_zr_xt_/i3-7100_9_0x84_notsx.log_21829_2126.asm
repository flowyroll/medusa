...
push %rdi
push %rsi
lea addresses_WT_ht+0x1df65, %r10
nop
xor $51541, %rcx
vmovups (%r10), %ymm1
...
nop
add %rbp, %rbp
lea addresses_WC_ht+0x1eeed, %rbp
nop
nop
nop
cmp $58077, %r11
mov (%rbp), %ecx
add $2267, %r9
lea addresses_normal_ht+0x1d905, %rsi
nop
nop
sub $15880, %r13
movups (%rsi), %xmm4
...
nop
and %r11, %r11
lea addresses_UC_ht+0x15dc5, %r10
inc %r13
mov (%r10), %bp
nop
nop
...
nop
sub $60121, %r10
lea addresses_normal_ht+0x8085, %rsi
lea addresses_D_ht+0x3185, %rdi
nop
nop
nop
nop
...
nop
dec %rbp
lea addresses_WC_ht+0x14a05, %rsi
lea addresses_WC_ht+0x3c45, %rdi
nop
nop
nop
nop
...
nop
cmp %rcx, %rcx
lea addresses_UC_ht+0x16305, %r11
nop
cmp %rdi, %rdi
mov (%r11), %r13d
nop
...
movntdq %xmm6, (%r10)
xor %rsi, %rsi
lea addresses_WC_ht+0xc3c5, %r10
sub %rcx, %rcx
movups (%r10), %xmm6
vpextrq $1, %xmm6, %rbp
cmp %r9, %r9
lea addresses_D_ht+0x1a7a5, %r11
nop
xor %rdi, %rdi
mov (%r11), %r13
and %rdi, %rdi
lea addresses_A_ht+0xb7bf, %rbp
nop
nop
nop
nop
...
mov (%rbp), %esi
xor %r10, %r10
lea addresses_normal_ht+0x14303, %rsi
lea addresses_UC_ht+0x127c5, %rdi
nop
nop
dec %r11
mov $126, %rcx
rep movsl
sub $42079, %r10
lea addresses_D_ht+0x14d05, %rbp
nop
nop
nop
dec %rsi
...
{'src': {'type': 'addresses_WC_ht', 'congruent': 8, 'same': False}, 'dst': {'type': 'addresses_WC_ht', 'congruent': 4, 'same': True}, 'OP': 'REPM'}
