...
push %rdx
push %rsi
lea addresses_UC_ht+0xa11a, %rsi
lea addresses_WT_ht+0xbef1, %rdi
nop
nop
sub $3536, %rdx
mov $13, %rcx
...
nop
and $32221, %rbp
lea addresses_A_ht+0x7b1a, %rsi
lea addresses_D_ht+0x1a51a, %rdi
nop
nop
nop
nop
...
nop
xor $11212, %rsi
lea addresses_D_ht+0x1029a, %rbx
inc %rbp
movl $0x61626364, (%rbx)
nop
nop
...
// Store
lea addresses_normal+0x1ba3a, %r10
nop
nop
nop
nop
