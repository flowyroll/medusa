...
push %rbp
push %rsi
lea addresses_UC_ht+0xa8e2, %r14
nop
nop
nop
nop
...
movups %xmm1, (%r14)
and %rbp, %rbp
lea addresses_WT_ht+0x18c52, %r13
nop
nop
dec %rax
...
nop
cmp $24436, %r8
lea addresses_D_ht+0x9c52, %r13
nop
dec %rsi
movl $0x61626364, (%r13)
nop
cmp $3611, %rsi
lea addresses_WT_ht+0x6052, %r8
nop
add %r11, %r11
