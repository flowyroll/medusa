...
nop
xor $49036, %rdi
lea addresses_UC_ht+0x131fc, %rbx
nop
nop
sub %r13, %r13
mov (%rbx), %rdi
...
nop
add %rsi, %rsi
lea addresses_WC_ht+0x9838, %rsi
lea addresses_UC_ht+0x1c5fc, %rdi
nop
nop
nop
nop
...
nop
cmp %rcx, %rcx
lea addresses_WC_ht+0x25fc, %rsi
lea addresses_A_ht+0xfdfc, %rdi
sub %r11, %r11
mov $63, %rcx
rep movsq
nop
...
{'OP': 'REPM', 'src': {'same': False, 'congruent': 10, 'type': 'addresses_WC_ht'}, 'dst': {'same': False, 'congruent': 7, 'type': 'addresses_A_ht'}}
{'00': 1, '35': 21828}
