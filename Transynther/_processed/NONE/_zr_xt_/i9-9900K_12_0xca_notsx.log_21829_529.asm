...
push %rdx
push %rsi
lea addresses_UC_ht+0x1411f, %rsi
lea addresses_WT_ht+0x8383, %rdi
nop
nop
nop
nop
...
rep movsb
sub %r14, %r14
lea addresses_normal_ht+0xb052, %r15
nop
nop
nop
inc %r12
...
nop
inc %rdi
lea addresses_WC_ht+0x2de7, %r15
clflush (%r15)
nop
nop
nop
...
movq %rsi, (%r15)
dec %r13
lea addresses_WC_ht+0x1c15f, %rsi
lea addresses_WC_ht+0xbbd, %rdi
nop
nop
nop
cmp $61227, %rdx
...
nop
sub %r12, %r12
lea addresses_normal_ht+0x1161f, %rdx
nop
nop
add $19797, %r12
mov (%rdx), %r14
...
nop
xor %r12, %r12
lea addresses_D_ht+0x1b7d2, %r12
add %rcx, %rcx
mov $0x6162636465666768, %rsi
movq %rsi, %xmm1
...
<gen_prepare_buffer>
{'OP': 'REPM', 'src': {'same': False, 'congruent': 8, 'type': 'addresses_UC_ht'}, 'dst': {'same': True, 'congruent': 1, 'type': 'addresses_WT_ht'}}
