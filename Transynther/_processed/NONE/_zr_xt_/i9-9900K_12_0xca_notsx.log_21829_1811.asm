...
lea addresses_normal_ht+0xb50, %rdi
nop
sub %r11, %r11
mov $32, %rcx
rep movsq
...
nop
cmp $12742, %rsi
lea addresses_WT_ht+0x13610, %rsi
lea addresses_D_ht+0x1df40, %rdi
nop
inc %rax
mov $115, %rcx
rep movsl
...
nop
add $31813, %rsi
lea addresses_A_ht+0x1d0c0, %rcx
nop
dec %r14
movups (%rcx), %xmm1
vpextrq $1, %xmm1, %rax
...
nop
and %r11, %r11
lea addresses_D_ht+0x4c0, %rsi
lea addresses_WT_ht+0x21c0, %rdi
nop
nop
nop
nop
...
nop
xor $58289, %r11
lea addresses_UC_ht+0x7640, %rsi
nop
and %r8, %r8
movups (%rsi), %xmm6
vpextrq $0, %xmm6, %rdx
...
nop
cmp $17463, %r11
lea addresses_normal_ht+0x145c0, %rdi
cmp %rsi, %rsi
...
nop
sub $29063, %rax
lea addresses_UC_ht+0x5074, %rdi
nop
sub %r8, %r8
movb (%rdi), %dl
nop
...
{'OP': 'REPM', 'src': {'same': False, 'congruent': 3, 'type': 'addresses_WT_ht'}, 'dst': {'same': False, 'congruent': 3, 'type': 'addresses_normal_ht'}}
{'OP': 'REPM', 'src': {'same': True, 'congruent': 2, 'type': 'addresses_WT_ht'}, 'dst': {'same': False, 'congruent': 5, 'type': 'addresses_D_ht'}}
