...
push %rdx
push %rsi
lea addresses_UC_ht+0x10e3c, %rdx
nop
dec %rdi
...
movw $0x6162, (%r13)
xor $2240, %rdx
lea addresses_WC_ht+0x11b00, %rsi
lea addresses_UC_ht+0xfd64, %rdi
nop
nop
nop
nop
...
lea addresses_UC_ht+0x17232, %rdi
nop
cmp %r9, %r9
mov $88, %rcx
rep movsq
and $6821, %rax
lea addresses_WC_ht+0x1ec4c, %rsi
lea addresses_A_ht+0x165f4, %rdi
sub $5535, %rdx
mov $78, %rcx
rep movsw
sub %rax, %rax
...
nop
add $27473, %rsi
lea addresses_normal_ht+0x12a3c, %rsi
lea addresses_D_ht+0x13a3c, %rdi
nop
nop
sub %rax, %rax
mov $48, %rcx
...
nop
cmp %r15, %r15
lea addresses_A_ht+0xb63c, %rcx
sub %r15, %r15
mov $0x6162636465666768, %rdi
movq %rdi, (%rcx)
add %rdi, %rdi
lea addresses_UC_ht+0xe85f, %rdx
nop
xor $25955, %rdi
movb $0x61, (%rdx)
nop
cmp $6933, %r13
lea addresses_normal_ht+0x13afc, %rsi
lea addresses_UC_ht+0x118e8, %rdi
add %r13, %r13
mov $27, %rcx
rep movsb
nop
...
nop
sub %rax, %rax
lea addresses_A_ht+0x1e8fc, %rdx
nop
nop
nop
sub %r15, %r15
...
{'src': {'type': 'addresses_normal_ht', 'congruent': 10, 'same': False}, 'dst': {'type': 'addresses_D_ht', 'congruent': 9, 'same': True}, 'OP': 'REPM'}
...
{'src': {'type': 'addresses_normal_ht', 'congruent': 6, 'same': False}, 'dst': {'type': 'addresses_UC_ht', 'congruent': 1, 'same': False}, 'OP': 'REPM'}
{'dst': {'type': 'addresses_A_ht', 'same': False, 'size': 4, 'congruent': 6, 'NT': False, 'AVXalign': True}, 'OP': 'STOR'}
{'00': 1, '35': 21828}
