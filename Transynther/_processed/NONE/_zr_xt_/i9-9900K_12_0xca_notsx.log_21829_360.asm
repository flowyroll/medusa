...
push %rdx
push %rsi
lea addresses_normal_ht+0x574e, %rcx
nop
cmp $19531, %rdx
...
nop
sub %rcx, %rcx
lea addresses_D_ht+0x177ae, %rsi
lea addresses_A_ht+0x197ee, %rdi
nop
xor %rbp, %rbp
mov $35, %rcx
rep movsw
nop
sub %rdi, %rdi
lea addresses_UC_ht+0x1a0e3, %rdi
nop
nop
nop
nop
...
nop
sub %rsi, %rsi
lea addresses_WT_ht+0x63ee, %rdx
nop
nop
add $125, %r14
...
movq %rbp, (%rdx)
add $55565, %rsi
lea addresses_WC_ht+0x109d0, %rdx
nop
nop
and %rsi, %rsi
movb $0x61, (%rdx)
dec %rdx
lea addresses_normal_ht+0x10ee, %r14
nop
nop
and $20549, %rbp
movb (%r14), %r10b
...
nop
add %rsi, %rsi
lea addresses_normal_ht+0x177ae, %r14
nop
nop
nop
nop
...
movb $0x61, (%r14)
xor %rbp, %rbp
lea addresses_A_ht+0x1a0ee, %rcx
nop
sub %r14, %r14
movw $0x6162, (%rcx)
nop
...
// Load
lea addresses_normal+0x1756e, %r9
nop
nop
nop
xor %r15, %r15
...
// REPMOV
lea addresses_PSE+0x142ee, %rsi
lea addresses_WC+0x1c6a6, %rdi
nop
nop
nop
nop
...
{'OP': 'REPM', 'src': {'same': False, 'congruent': 7, 'type': 'addresses_PSE'}, 'dst': {'same': False, 'congruent': 2, 'type': 'addresses_WC'}}
[Faulty Load]
...
{'OP': 'STOR', 'dst': {'same': False, 'type': 'addresses_normal_ht', 'NT': False, 'AVXalign': True, 'size': 1, 'congruent': 6}}
