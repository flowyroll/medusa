...
push %rdi
push %rsi
lea addresses_D_ht+0x1c106, %rcx
dec %r11
movl $0x61626364, (%rcx)
nop
inc %rcx
lea addresses_UC_ht+0x8d42, %r8
nop
nop
nop
xor %r11, %r11
...
nop
inc %rcx
lea addresses_UC_ht+0x1dd42, %rax
nop
sub $1260, %rcx
vmovups (%rax), %ymm7
...
nop
cmp %rcx, %rcx
lea addresses_WC_ht+0xc402, %rsi
lea addresses_normal_ht+0xcd22, %rdi
nop
nop
nop
and $60060, %r12
...
{'dst': {'type': 'addresses_D', 'same': False, 'size': 4, 'congruent': 6, 'NT': True, 'AVXalign': False}, 'OP': 'STOR'}
