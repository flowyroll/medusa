...
push %rdi
push %rsi
lea addresses_D_ht+0x1057b, %rbp
nop
nop
nop
nop
...
nop
sub $17854, %rdi
lea addresses_normal_ht+0x11b43, %r10
xor $40189, %r13
movb $0x61, (%r10)
nop
nop
...
nop
lfence
lea addresses_WC_ht+0x815b, %r10
nop
cmp %r14, %r14
...
nop
cmp $19352, %r13
lea addresses_UC_ht+0x3c59, %rbp
nop
nop
nop
nop
...
nop
xor %r15, %r15
lea addresses_WC_ht+0xe0db, %r10
nop
nop
nop
nop
...
nop
add %r11, %r11
lea addresses_UC_ht+0x11e5b, %rsi
lea addresses_D_ht+0x1255b, %rdi
and $19491, %r13
mov $28, %rcx
rep movsl
nop
