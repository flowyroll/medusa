...
push %rdi
push %rsi
lea addresses_D_ht+0x3ace, %rcx
nop
xor %rax, %rax
mov (%rcx), %r15
cmp %r10, %r10
lea addresses_A_ht+0x13fda, %rsi
lea addresses_A_ht+0x17d1a, %rdi
clflush (%rsi)
nop
nop
nop
...
nop
add $60332, %rdi
lea addresses_D_ht+0x1d65a, %rsi
lea addresses_WT_ht+0x5a5a, %rdi
nop
nop
mfence
mov $0, %rcx
...
nop
add $37658, %rdi
lea addresses_UC_ht+0x5e5a, %r15
and $23026, %r10
movl $0x61626364, (%r15)
nop
add %rsi, %rsi
lea addresses_D_ht+0x778, %rsi
nop
nop
cmp $41371, %r15
...
// REPMOV
lea addresses_normal+0xa55a, %rsi
lea addresses_A+0x1147a, %rdi
nop
and %r15, %r15
mov $4, %rcx
rep movsq
...
{'src': {'type': 'addresses_normal', 'congruent': 10, 'same': False}, 'OP': 'REPM', 'dst': {'type': 'addresses_A', 'congruent': 4, 'same': False}}
[Faulty Load]
