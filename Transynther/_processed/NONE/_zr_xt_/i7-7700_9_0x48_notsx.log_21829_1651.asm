...
push %rdi
push %rsi
lea addresses_normal_ht+0x1a9f8, %r15
nop
nop
nop
cmp %r13, %r13
...
nop
xor $56146, %rdi
lea addresses_normal_ht+0x1e878, %r9
nop
cmp $60291, %r14
mov (%r9), %r15d
nop
nop
sub $48276, %r14
lea addresses_WC_ht+0x68ca, %rsi
lea addresses_WT_ht+0x19a68, %rdi
nop
add $24787, %r11
mov $122, %rcx
rep movsb
...
nop
sub %r14, %r14
lea addresses_A_ht+0x10958, %r15
nop
nop
cmp %rcx, %rcx
mov (%r15), %r14d
sub $20403, %rsi
lea addresses_A_ht+0x2cb8, %rsi
lea addresses_D_ht+0x100b8, %rdi
nop
nop
nop
nop
...
rep movsw
cmp $2311, %r15
lea addresses_UC_ht+0x3f00, %rsi
lea addresses_A_ht+0x70b8, %rdi
clflush (%rsi)
clflush (%rdi)
add $36878, %r15
mov $8, %rcx
...
nop
and %rdi, %rdi
lea addresses_D_ht+0x1e6e4, %r13
nop
nop
inc %r11
...
nop
and %rcx, %rcx
lea addresses_WC_ht+0x19ab8, %r11
nop
nop
nop
nop
...
nop
cmp $46466, %rdi
lea addresses_WC_ht+0x16cb8, %rsi
lea addresses_D_ht+0x16c78, %rdi
nop
nop
nop
inc %r13
...
{'dst': {'same': False, 'congruent': 10, 'type': 'addresses_D_ht'}, 'OP': 'REPM', 'src': {'same': False, 'congruent': 11, 'type': 'addresses_A_ht'}}
...
{'dst': {'same': False, 'congruent': 6, 'type': 'addresses_D_ht'}, 'OP': 'REPM', 'src': {'same': False, 'congruent': 11, 'type': 'addresses_WC_ht'}}
{'35': 21828, '00': 1}
