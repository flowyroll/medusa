...
push %rdx
push %rsi
lea addresses_WT_ht+0x14386, %rdi
nop
nop
nop
nop
...
nop
sub $34280, %r13
lea addresses_D_ht+0x174e6, %rsi
lea addresses_WC_ht+0x2826, %rdi
clflush (%rsi)
nop
nop
add %rdx, %rdx
...
nop
inc %r10
lea addresses_A_ht+0xecf2, %rsi
lea addresses_WC_ht+0xb85b, %rdi
nop
nop
nop
and %r11, %r11
...
nop
and $42946, %rdi
lea addresses_D_ht+0x67e6, %rsi
lea addresses_D_ht+0x11d66, %rdi
nop
sub %r10, %r10
mov $28, %rcx
rep movsl
nop
dec %r10
lea addresses_UC_ht+0xe466, %r11
nop
nop
nop
add $33318, %r10
...
nop
cmp $54793, %r13
lea addresses_UC_ht+0x195e6, %rsi
lea addresses_WC_ht+0x1ecaa, %rdi
nop
nop
nop
and $49587, %rax
...
nop
xor $36650, %rax
lea addresses_WC_ht+0x13ce6, %rcx
nop
nop
nop
nop
...
vpextrq $1, %xmm7, %rdi
cmp $59321, %rax
lea addresses_WC_ht+0x1d0e6, %rdi
nop
nop
nop
nop
...
nop
inc %r10
lea addresses_WT_ht+0x29e6, %rdx
dec %r13
mov (%rdx), %rdi
nop
nop
...
<gen_prepare_buffer>
{'OP': 'STOR', 'dst': {'type': 'addresses_WT_ht', 'AVXalign': True, 'size': 4, 'NT': True, 'same': False, 'congruent': 4}}
{'src': {'type': 'addresses_D_ht', 'congruent': 10, 'same': False}, 'OP': 'REPM', 'dst': {'type': 'addresses_WC_ht', 'congruent': 5, 'same': False}}
{'src': {'type': 'addresses_A_ht', 'congruent': 1, 'same': False}, 'OP': 'REPM', 'dst': {'type': 'addresses_WC_ht', 'congruent': 0, 'same': False}}
{'src': {'type': 'addresses_D_ht', 'congruent': 8, 'same': False}, 'OP': 'REPM', 'dst': {'type': 'addresses_D_ht', 'congruent': 7, 'same': False}}
