...
nop
add %r10, %r10
lea addresses_normal_ht+0x1b2a2, %rsi
lea addresses_UC_ht+0x2066, %rdi
nop
nop
add $39247, %r11
mov $76, %rcx
...
nop
add $52856, %rdi
lea addresses_UC_ht+0xaf74, %r14
nop
nop
nop
nop
...
nop
cmp $30293, %rsi
lea addresses_D_ht+0x1e4c6, %r10
nop
nop
nop
nop
...
nop
xor %r8, %r8
lea addresses_WT_ht+0xae1e, %r11
and $11865, %rsi
...
nop
sub $62380, %rdi
lea addresses_normal_ht+0x18866, %r11
sub %r10, %r10
...
nop
sub %rcx, %rcx
lea addresses_normal_ht+0xd66, %rsi
nop
nop
nop
nop
...
nop
sub %rsi, %rsi
lea addresses_WT_ht+0x1d672, %r8
nop
nop
nop
nop
...
nop
inc %r10
lea addresses_WT_ht+0x502e, %rcx
clflush (%rcx)
nop
nop
nop
...
{'src': {'type': 'addresses_normal_ht', 'congruent': 2, 'same': False}, 'OP': 'REPM', 'dst': {'type': 'addresses_UC_ht', 'congruent': 10, 'same': False}}
{'OP': 'STOR', 'dst': {'type': 'addresses_UC_ht', 'AVXalign': False, 'size': 32, 'NT': True, 'same': False, 'congruent': 1}}
