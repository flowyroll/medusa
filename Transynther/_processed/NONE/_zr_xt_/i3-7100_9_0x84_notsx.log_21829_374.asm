...
push %rbp
push %rsi
lea addresses_D_ht+0x14516, %rsi
nop
nop
nop
nop
...
nop
mfence
lea addresses_UC_ht+0x8b0e, %r12
nop
sub $54925, %rax
movb (%r12), %r10b
nop
...
nop
and $34503, %rsi
lea addresses_WC_ht+0x16916, %r13
nop
nop
nop
nop
...
nop
inc %rsi
lea addresses_normal_ht+0x14696, %rbp
xor %r9, %r9
movw $0x6162, (%rbp)
nop
nop
nop
sub %r12, %r12
lea addresses_D_ht+0x152c6, %rax
nop
nop
nop
inc %r13
