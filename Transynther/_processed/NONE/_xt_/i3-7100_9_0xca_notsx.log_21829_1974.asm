...
push %rdi
push %rdx
lea addresses_normal_ht+0x1a9ce, %r13
nop
nop
nop
nop
...
nop
and $20074, %rdx
lea addresses_WT_ht+0x15ce, %r11
clflush (%r11)
nop
nop
nop
