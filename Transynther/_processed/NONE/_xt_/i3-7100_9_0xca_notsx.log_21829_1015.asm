...
nop
and %r12, %r12
lea addresses_A_ht+0xea3b, %rsi
lea addresses_normal_ht+0xf1fb, %rdi
nop
sub %r15, %r15
mov $40, %rcx
rep movsl
...
nop
dec %r12
lea addresses_WC_ht+0xad27, %rdi
nop
nop
nop
sub %rcx, %rcx
...
nop
sub %r12, %r12
lea addresses_D_ht+0xaafb, %rsi
lea addresses_normal_ht+0x1b2fb, %rdi
clflush (%rsi)
and $40253, %r9
mov $111, %rcx
rep movsb
...
nop
xor $20620, %r11
lea addresses_UC_ht+0x3efb, %rcx
sub %rbp, %rbp
...
nop
cmp $15205, %r9
lea addresses_normal_ht+0xbd7b, %rdi
xor $16864, %r11
mov (%rdi), %rbp
nop
nop
...
<gen_prepare_buffer>
{'OP': 'STOR', 'dst': {'same': False, 'congruent': 1, 'NT': True, 'type': 'addresses_UC_ht', 'size': 8, 'AVXalign': False}}
...
{'src': {'same': False, 'congruent': 10, 'NT': False, 'type': 'addresses_UC_ht', 'size': 32, 'AVXalign': True}, 'OP': 'LOAD'}
