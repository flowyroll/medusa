...
push %rdi
push %rsi
lea addresses_A_ht+0x16969, %rcx
xor $50279, %r10
mov (%rcx), %r9d
nop
add %r14, %r14
lea addresses_normal_ht+0x4c36, %rsi
lea addresses_UC_ht+0x568a, %rdi
clflush (%rsi)
nop
nop
nop
...
lea addresses_UC_ht+0x10376, %rdi
nop
nop
nop
nop
...
nop
add $25929, %rcx
lea addresses_WC_ht+0xcf76, %r10
nop
nop
and %r9, %r9
mov (%r10), %rbx
...
nop
add %r10, %r10
lea addresses_normal_ht+0x10b32, %rsi
lea addresses_A_ht+0x152f6, %rdi
nop
cmp $18581, %r11
mov $65, %rcx
rep movsw
...
lea addresses_UC_ht+0xf702, %rdi
nop
cmp %r9, %r9
mov $54, %rcx
rep movsq
...
nop
sub $42473, %rdi
lea addresses_WT_ht+0x187e, %rdi
nop
nop
xor $38694, %r11
mov (%rdi), %bx
...
// Store
lea addresses_normal+0x16c76, %r10
nop
nop
add $2497, %r11
...
{'OP': 'REPM', 'src': {'type': 'addresses_normal_ht', 'congruent': 2, 'same': False}, 'dst': {'type': 'addresses_A_ht', 'congruent': 7, 'same': False}}
{'OP': 'REPM', 'src': {'type': 'addresses_WT_ht', 'congruent': 10, 'same': True}, 'dst': {'type': 'addresses_UC_ht', 'congruent': 1, 'same': False}}
