...
nop
dec %r8
lea addresses_normal_ht+0xec71, %rsi
lea addresses_UC_ht+0x18791, %rdi
nop
nop
nop
nop
...
nop
inc %r9
lea addresses_WC_ht+0x1ca91, %rcx
nop
nop
nop
cmp %rbx, %rbx
...
nop
dec %rax
lea addresses_normal_ht+0x17591, %rsi
nop
nop
dec %rdi
movb (%rsi), %al
...
nop
add $18821, %rsi
lea addresses_UC_ht+0x19b31, %rsi
lea addresses_A_ht+0x1d79d, %rdi
nop
nop
nop
and $26243, %r12
...
rep movsw
and $34021, %rbx
lea addresses_WC_ht+0x9011, %rsi
lea addresses_A_ht+0x194a1, %rdi
nop
nop
nop
xor $592, %rbx
...
nop
xor $2160, %rbx
lea addresses_WC_ht+0x2d11, %rsi
lea addresses_UC_ht+0x1dd51, %rdi
inc %rax
mov $93, %rcx
rep movsq
nop
...
nop
cmp %rcx, %rcx
lea addresses_D_ht+0x17911, %rsi
lea addresses_UC_ht+0x19691, %rdi
nop
nop
nop
nop
...
nop
dec %rdi
lea addresses_UC_ht+0x1bafb, %rbx
nop
nop
nop
nop
...
vpextrq $1, %xmm6, %rax
cmp $47587, %rdi
lea addresses_A_ht+0xdd1, %rbx
add $18639, %r8
mov (%rbx), %esi
nop
sub %r9, %r9
lea addresses_D_ht+0xb491, %rsi
lea addresses_A_ht+0x10991, %rdi
nop
and $2200, %r12
mov $37, %rcx
rep movsq
...
nop
dec %rax
lea addresses_WT_ht+0x14591, %rsi
lea addresses_normal_ht+0x87e1, %rdi
clflush (%rdi)
nop
nop
nop
...
rep movsw
dec %rcx
lea addresses_WT_ht+0x6141, %rax
add %rsi, %rsi
mov (%rax), %ecx
inc %r12
pop %rsi
...
// Store
lea addresses_normal+0x1aa71, %rsi
nop
nop
nop
nop
...
{'OP': 'REPM', 'src': {'type': 'addresses_normal_ht', 'congruent': 3, 'same': False}, 'dst': {'type': 'addresses_UC_ht', 'congruent': 8, 'same': True}}
...
{'OP': 'REPM', 'src': {'type': 'addresses_D_ht', 'congruent': 9, 'same': False}, 'dst': {'type': 'addresses_A_ht', 'congruent': 5, 'same': False}}
