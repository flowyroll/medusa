...
push %rdx
push %rsi
lea addresses_WT_ht+0x3d3a, %rbx
nop
nop
nop
nop
...
mov (%rbx), %r15d
cmp %rbx, %rbx
lea addresses_A_ht+0x1d4ba, %rdx
xor $60926, %rcx
movw $0x6162, (%rdx)
xor $29811, %r8
lea addresses_normal_ht+0x743a, %r15
nop
and $13188, %r12
movw $0x6162, (%r15)
nop
sub %rdx, %rdx
lea addresses_A_ht+0x1eea0, %rsi
lea addresses_WC_ht+0xbbde, %rdi
mfence
mov $17, %rcx
rep movsw
nop
...
nop
xor %r8, %r8
lea addresses_WT_ht+0x9d7a, %rbx
nop
nop
nop
sub $32443, %r15
...
movq %rdi, (%rbx)
cmp %rcx, %rcx
lea addresses_D_ht+0x1817a, %rsi
nop
nop
cmp %r15, %r15
vmovups (%rsi), %ymm2
...
nop
xor %r8, %r8
lea addresses_normal_ht+0x35ba, %rdi
nop
nop
nop
sub %r15, %r15
...
nop
add %rdx, %rdx
lea addresses_normal_ht+0x1623a, %r12
nop
nop
nop
add $50218, %rdx
...
nop
and %rsi, %rsi
lea addresses_A_ht+0x11437, %rsi
lea addresses_D_ht+0x1183a, %rdi
nop
nop
nop
nop
...
nop
and $27886, %r8
lea addresses_WC_ht+0x558a, %rdx
nop
nop
nop
sub %rcx, %rcx
mov (%rdx), %ebx
sub %rdi, %rdi
lea addresses_A_ht+0x16872, %rbx
nop
nop
nop
nop
...
movaps %xmm1, (%rbx)
inc %rdi
lea addresses_D_ht+0x1273a, %rsi
lea addresses_normal_ht+0xb03a, %rdi
clflush (%rsi)
nop
nop
nop
...
nop
and %rbx, %rbx
lea addresses_WT_ht+0xd263, %rsi
lea addresses_A_ht+0x170a, %rdi
clflush (%rsi)
nop
nop
nop
...
// Store
lea addresses_normal+0x175da, %rdx
nop
nop
nop
and $38303, %r12
...
{'OP': 'REPM', 'src': {'same': False, 'congruent': 1, 'type': 'addresses_A_ht'}, 'dst': {'same': False, 'congruent': 0, 'type': 'addresses_WC_ht'}}
...
{'OP': 'REPM', 'src': {'same': False, 'congruent': 0, 'type': 'addresses_A_ht'}, 'dst': {'same': False, 'congruent': 10, 'type': 'addresses_D_ht'}}
{'OP': 'LOAD', 'src': {'same': False, 'type': 'addresses_WC_ht', 'NT': False, 'AVXalign': False, 'size': 4, 'congruent': 4}}
{'OP': 'STOR', 'dst': {'same': False, 'type': 'addresses_A_ht', 'NT': False, 'AVXalign': True, 'size': 16, 'congruent': 3}}
