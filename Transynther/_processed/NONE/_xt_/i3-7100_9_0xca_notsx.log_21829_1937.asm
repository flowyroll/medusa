...
push %rdi
push %rsi
lea addresses_UC_ht+0x17560, %r8
dec %r13
movl $0x61626364, (%r8)
nop
nop
...
nop
and $61333, %r15
lea addresses_WC_ht+0x11960, %r15
nop
and $27212, %r9
movb (%r15), %r12b
nop
...
nop
dec %r13
lea addresses_normal_ht+0xf370, %r9
cmp %rdi, %rdi
mov (%r9), %r15
nop
nop
and $65490, %r12
lea addresses_D_ht+0x2c38, %r12
nop
nop
cmp $42331, %r13
movb (%r12), %r15b
...
nop
add %rdi, %rdi
lea addresses_WT_ht+0x18c62, %rdi
nop
nop
nop
xor $42171, %r14
...
vpextrq $0, %xmm5, %r13
xor $31285, %r15
lea addresses_D_ht+0x1ee60, %rsi
lea addresses_A_ht+0x8fd0, %rdi
nop
nop
and $18658, %r12
mov $59, %rcx
...
nop
sub $48387, %r8
lea addresses_A_ht+0x7560, %rsi
lea addresses_WC_ht+0xce4c, %rdi
nop
nop
and %r8, %r8
mov $53, %rcx
...
nop
xor $33889, %r12
lea addresses_WC_ht+0x11320, %r14
nop
cmp $57631, %r13
mov (%r14), %cx
nop
...
nop
xor $14568, %r9
lea addresses_UC_ht+0x1a0ce, %rdi
nop
nop
nop
nop
...
nop
dec %r13
lea addresses_D_ht+0x13d60, %rsi
lea addresses_WC_ht+0x1d560, %rdi
nop
nop
nop
nop
...
{'src': {'same': True, 'congruent': 6, 'NT': False, 'type': 'addresses_WC_ht', 'size': 2, 'AVXalign': False}, 'OP': 'LOAD'}
{'src': {'same': False, 'congruent': 1, 'NT': False, 'type': 'addresses_UC_ht', 'size': 2, 'AVXalign': False}, 'OP': 'LOAD'}
{'src': {'type': 'addresses_D_ht', 'congruent': 10, 'same': True}, 'OP': 'REPM', 'dst': {'type': 'addresses_WC_ht', 'congruent': 11, 'same': False}}
{'37': 21829}
