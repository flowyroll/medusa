...
push %rdi
push %rsi
lea addresses_WT_ht+0x2e08, %r11
nop
nop
nop
nop
...
nop
sub %r12, %r12
lea addresses_D_ht+0x15388, %rcx
nop
cmp $61436, %r12
movl $0x61626364, (%rcx)
nop
...
nop
add $25205, %r12
lea addresses_normal_ht+0x9088, %rsi
lea addresses_WC_ht+0x1e088, %rdi
sub %r13, %r13
mov $94, %rcx
rep movsb
and %rsi, %rsi
...
{'src': {'type': 'addresses_normal_ht', 'congruent': 9, 'same': False}, 'OP': 'REPM', 'dst': {'type': 'addresses_WC_ht', 'congruent': 9, 'same': False}}
{'39': 21829}
