...
push %rdi
push %rsi
lea addresses_A_ht+0x1baff, %r12
nop
nop
and %rax, %rax
movw $0x6162, (%r12)
...
nop
inc %rdi
lea addresses_normal_ht+0x1c3ab, %rax
nop
nop
nop
nop
...
nop
and %rsi, %rsi
lea addresses_D_ht+0x1c7ff, %rdi
nop
dec %r13
movups (%rdi), %xmm5
vpextrq $0, %xmm5, %rbp
...
nop
cmp %rax, %rax
lea addresses_D_ht+0x14cff, %rsi
nop
and %rdi, %rdi
...
nop
cmp $14443, %rdi
lea addresses_WT_ht+0x1c723, %r14
nop
nop
nop
and $55557, %rbp
mov (%r14), %r12
add %rbp, %rbp
lea addresses_UC_ht+0x7d4b, %r13
nop
nop
sub %r12, %r12
movups (%r13), %xmm6
...
nop
xor $9834, %rax
lea addresses_A_ht+0x102ff, %rsi
lea addresses_WT_ht+0x3e03, %rdi
cmp $18845, %r13
mov $53, %rcx
rep movsq
nop
