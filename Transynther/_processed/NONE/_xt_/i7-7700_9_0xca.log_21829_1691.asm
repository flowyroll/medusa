...
push %rdx
push %rsi
lea addresses_normal_ht+0xf0ad, %rax
nop
and %r12, %r12
movw $0x6162, (%rax)
sub %r9, %r9
lea addresses_normal_ht+0xd3cd, %rdx
clflush (%rdx)
nop
sub $64584, %rcx
...
nop
add %rdi, %rdi
lea addresses_UC_ht+0x1eced, %rsi
lea addresses_UC_ht+0x17c4d, %rdi
xor %r14, %r14
mov $98, %rcx
rep movsq
nop
