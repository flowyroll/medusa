...
nop
and $34212, %r14
lea addresses_D_ht+0x1d306, %rsi
lea addresses_WC_ht+0x165b3, %rdi
clflush (%rdi)
nop
nop
nop
...
nop
sub %rdi, %rdi
lea addresses_D_ht+0x155cb, %r14
nop
sub $12168, %rsi
movups (%r14), %xmm2
vpextrq $1, %xmm2, %r15
...
nop
cmp %rcx, %rcx
lea addresses_UC_ht+0x19d3, %rsi
lea addresses_normal_ht+0x3947, %rdi
nop
nop
nop
nop
...
nop
inc %rdi
lea addresses_UC_ht+0xe853, %r15
dec %rax
vmovups (%r15), %ymm7
...
nop
sub %r14, %r14
lea addresses_UC_ht+0x1ea1f, %rsi
lea addresses_D_ht+0xcc8b, %rdi
xor %r14, %r14
mov $79, %rcx
rep movsq
nop
...
nop
xor $204, %rdi
lea addresses_normal_ht+0x13a57, %r15
nop
nop
nop
add %r14, %r14
...
nop
inc %rdi
lea addresses_UC_ht+0xb453, %rsi
nop
nop
cmp %rdi, %rdi
mov (%rsi), %ecx
nop
inc %r14
lea addresses_WT_ht+0x1d55, %rsi
nop
nop
cmp %rax, %rax
movb (%rsi), %cl
...
nop
inc %r13
lea addresses_WC_ht+0x139b3, %rsi
lea addresses_A_ht+0x134eb, %rdi
nop
nop
nop
nop
...
nop
xor %rax, %rax
lea addresses_D_ht+0x9053, %rax
nop
sub $51421, %rcx
movw $0x6162, (%rax)
xor $20043, %rdi
lea addresses_D_ht+0x16bd3, %rdi
nop
nop
nop
nop
...
nop
sub %rax, %rax
lea addresses_WC_ht+0xe2f3, %r13
nop
nop
nop
nop
...
vpextrq $0, %xmm2, %rsi
dec %r14
lea addresses_A_ht+0x1bc53, %rsi
lea addresses_WT_ht+0x1e32c, %rdi
nop
nop
nop
dec %r14
...
nop
and $20859, %r15
lea addresses_normal_ht+0x2d13, %rcx
nop
nop
nop
nop
...
// Faulty Load
lea addresses_normal+0xb053, %rdi
clflush (%rdi)
nop
nop
nop
...
{'OP': 'REPM', 'src': {'type': 'addresses_D_ht', 'congruent': 0, 'same': False}, 'dst': {'type': 'addresses_WC_ht', 'congruent': 4, 'same': False}}
...
{'OP': 'REPM', 'src': {'type': 'addresses_WC_ht', 'congruent': 5, 'same': False}, 'dst': {'type': 'addresses_A_ht', 'congruent': 2, 'same': False}}
