...
push %rdi
push %rsi
lea addresses_D_ht+0xf86a, %r10
add %r8, %r8
mov (%r10), %r13d
and $36889, %rdi
lea addresses_A_ht+0x1416a, %r10
cmp $11535, %rax
...
nop
and %r8, %r8
lea addresses_WT_ht+0x28ca, %r14
clflush (%r14)
nop
nop
sub $35243, %rcx
...
nop
xor %rax, %rax
lea addresses_UC_ht+0x1446a, %rsi
lea addresses_normal_ht+0x87ea, %rdi
nop
cmp $6467, %rax
mov $107, %rcx
rep movsq
...
nop
cmp $39753, %r10
lea addresses_WT_ht+0xd86a, %rax
nop
nop
nop
nop
...
// Load
lea addresses_normal+0x9d2a, %r8
nop
nop
nop
nop
...
{'src': {'type': 'addresses_normal', 'same': False, 'size': 8, 'congruent': 6, 'NT': False, 'AVXalign': True}, 'OP': 'LOAD'}
[Faulty Load]
