...
nop
cmp %r11, %r11
lea addresses_A_ht+0x199be, %rbp
and $28099, %rbx
movups (%rbp), %xmm4
vpextrq $0, %xmm4, %rax
nop
...
nop
sub %rbp, %rbp
lea addresses_normal_ht+0x1912, %r12
nop
nop
dec %rdi
mov (%r12), %ebx
...
rep movsb
and $1767, %rbp
lea addresses_UC_ht+0x16d12, %rdi
nop
nop
and $28538, %r12
