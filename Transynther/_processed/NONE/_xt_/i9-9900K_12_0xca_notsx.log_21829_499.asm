...
nop
xor %r14, %r14
lea addresses_A_ht+0x11652, %r13
nop
nop
nop
nop
...
nop
xor $13198, %r10
lea addresses_WT_ht+0x1311a, %r13
nop
nop
nop
nop
...
nop
sub $4107, %rcx
lea addresses_WC_ht+0xf85a, %rsi
lea addresses_D_ht+0x3b1a, %rdi
and %rbx, %rbx
mov $11, %rcx
rep movsb
nop
...
nop
sub %rsi, %rsi
lea addresses_A_ht+0xfb1a, %rsi
lea addresses_normal_ht+0x1851a, %rdi
nop
nop
nop
nop
...
{'OP': 'STOR', 'dst': {'same': True, 'type': 'addresses_WT_ht', 'NT': False, 'AVXalign': False, 'size': 1, 'congruent': 6}}
{'OP': 'REPM', 'src': {'same': True, 'congruent': 2, 'type': 'addresses_WC_ht'}, 'dst': {'same': False, 'congruent': 10, 'type': 'addresses_D_ht'}}
