...
push %rdx
push %rsi
lea addresses_A_ht+0x177ac, %r15
nop
and %rsi, %rsi
vmovups (%r15), %ymm5
...
nop
sub %r15, %r15
lea addresses_WC_ht+0x612c, %rdx
nop
cmp $27734, %rax
...
nop
inc %rdx
lea addresses_WC_ht+0xbd7c, %r14
nop
add $1398, %r13
mov (%r14), %eax
nop
nop
add $18246, %rcx
lea addresses_normal_ht+0x1ef2c, %rdx
nop
nop
nop
nop
