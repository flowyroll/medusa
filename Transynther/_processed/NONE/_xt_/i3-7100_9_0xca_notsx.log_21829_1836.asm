...
push %rdx
push %rsi
lea addresses_UC_ht+0x14380, %rdx
nop
xor %r14, %r14
mov (%rdx), %cx
nop
nop
sub %r9, %r9
lea addresses_WC_ht+0xeee8, %rsi
nop
sub $53205, %rbp
mov (%rsi), %rax
nop
...
nop
and %rax, %rax
lea addresses_UC_ht+0x158a8, %rbp
nop
xor $11908, %rdx
...
nop
xor $41971, %rcx
lea addresses_UC_ht+0x1da58, %rax
xor $36768, %r9
movb (%rax), %cl
nop
nop
nop
sub %rsi, %rsi
lea addresses_D_ht+0xc56c, %rsi
lea addresses_A_ht+0x17ef0, %rdi
xor $59211, %rax
mov $34, %rcx
rep movsw
mfence
lea addresses_WC_ht+0x1bee8, %rdi
nop
nop
nop
nop
...
nop
add %rcx, %rcx
lea addresses_WC_ht+0x1d754, %rax
nop
nop
dec %r9
movb (%rax), %dl
nop
inc %rbp
lea addresses_WT_ht+0x92e8, %rsi
lea addresses_WC_ht+0x6e54, %rdi
nop
sub $9080, %r14
mov $90, %rcx
rep movsw
...
nop
cmp %rbp, %rbp
lea addresses_WT_ht+0x1a822, %rsi
lea addresses_normal_ht+0x1b6e8, %rdi
clflush (%rdi)
nop
nop
nop
...
nop
cmp %rcx, %rcx
lea addresses_D_ht+0x18be8, %rax
nop
nop
dec %r9
...
nop
add $29055, %r14
lea addresses_WT_ht+0x89e8, %r14
xor $64577, %rbp
vmovups (%r14), %ymm1
...
{'src': {'type': 'addresses_D_ht', 'congruent': 0, 'same': False}, 'OP': 'REPM', 'dst': {'type': 'addresses_A_ht', 'congruent': 3, 'same': False}}
{'OP': 'STOR', 'dst': {'same': False, 'congruent': 9, 'NT': False, 'type': 'addresses_WC_ht', 'size': 16, 'AVXalign': False}}
{'src': {'same': True, 'congruent': 1, 'NT': True, 'type': 'addresses_WC_ht', 'size': 1, 'AVXalign': False}, 'OP': 'LOAD'}
{'src': {'type': 'addresses_WT_ht', 'congruent': 10, 'same': False}, 'OP': 'REPM', 'dst': {'type': 'addresses_WC_ht', 'congruent': 1, 'same': False}}
{'src': {'type': 'addresses_WT_ht', 'congruent': 0, 'same': False}, 'OP': 'REPM', 'dst': {'type': 'addresses_normal_ht', 'congruent': 8, 'same': False}}
