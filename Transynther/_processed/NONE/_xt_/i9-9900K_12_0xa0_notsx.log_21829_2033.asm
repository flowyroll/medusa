...
nop
inc %rsi
lea addresses_D_ht+0x4f09, %rsi
lea addresses_UC_ht+0x113d9, %rdi
nop
cmp $54532, %r8
mov $81, %rcx
rep movsl
...
nop
xor %r14, %r14
lea addresses_WT_ht+0xf3e5, %rbx
nop
nop
nop
nop
...
nop
cmp $20812, %rdi
lea addresses_normal_ht+0x17359, %rsi
nop
nop
add $65467, %r15
movb (%rsi), %cl
...
nop
cmp %rsi, %rsi
lea addresses_normal_ht+0xa0d9, %rdi
clflush (%rdi)
dec %rsi
movb (%rdi), %r8b
sub %rcx, %rcx
lea addresses_WC_ht+0x17719, %r15
nop
nop
nop
nop
...
nop
xor %r8, %r8
lea addresses_A_ht+0x37d9, %rsi
lea addresses_WT_ht+0xbffd, %rdi
clflush (%rsi)
nop
nop
nop
...
nop
add $39898, %rsi
lea addresses_normal_ht+0x14cd9, %rsi
nop
nop
add %rcx, %rcx
movb (%rsi), %r12b
...
nop
xor $1083, %r14
lea addresses_UC_ht+0x40d9, %rsi
nop
nop
nop
nop
...
nop
cmp $55938, %rbx
lea addresses_D_ht+0x1d69, %rsi
lea addresses_UC_ht+0xd9, %rdi
clflush (%rsi)
nop
nop
nop
...
nop
dec %r14
lea addresses_UC_ht+0x1d1d9, %rsi
nop
nop
nop
dec %r14
...
vmovups %ymm7, (%r15)
cmp %r8, %r8
lea addresses_A_ht+0x1d2d9, %r12
nop
nop
nop
mfence
movb $0x61, (%r12)
sub %r15, %r15
lea addresses_WC_ht+0x5ad9, %rbx
nop
xor $65379, %rsi
movb (%rbx), %r12b
nop
...
{'src': {'type': 'addresses_WC_ht', 'congruent': 4, 'same': True}, 'OP': 'REPM', 'dst': {'type': 'addresses_WC_ht', 'congruent': 4, 'same': False}}
{'src': {'type': 'addresses_D_ht', 'congruent': 4, 'same': False}, 'OP': 'REPM', 'dst': {'type': 'addresses_UC_ht', 'congruent': 5, 'same': True}}
{'src': {'type': 'addresses_WT_ht', 'AVXalign': False, 'size': 8, 'NT': False, 'same': False, 'congruent': 1}, 'OP': 'LOAD'}
{'src': {'type': 'addresses_normal_ht', 'AVXalign': False, 'size': 1, 'NT': True, 'same': False, 'congruent': 6}, 'OP': 'LOAD'}
