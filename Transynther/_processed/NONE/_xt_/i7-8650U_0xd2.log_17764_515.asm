...
push %rdi
push %rsi
lea addresses_normal_ht+0x10b91, %r11
nop
nop
nop
sub %rbx, %rbx
...
nop
inc %rbx
lea addresses_UC_ht+0x16fc9, %r13
nop
nop
nop
nop
...
nop
and $65248, %r10
lea addresses_WC_ht+0x1e721, %r10
nop
nop
nop
nop
...
nop
cmp %rbx, %rbx
lea addresses_WC_ht+0x8fd9, %rsi
lea addresses_WT_ht+0x4ce1, %rdi
nop
nop
nop
nop
...
nop
sub $37845, %rbx
lea addresses_UC_ht+0x74f1, %rdi
xor %r13, %r13
...
nop
dec %rcx
lea addresses_A_ht+0x88d1, %rsi
lea addresses_WC_ht+0x1d8d5, %rdi
nop
add %r11, %r11
mov $93, %rcx
rep movsl
nop
add %rsi, %rsi
lea addresses_WT_ht+0x2ed1, %rsi
lea addresses_normal_ht+0x16a11, %rdi
nop
nop
nop
nop
...
nop
add %rbx, %rbx
lea addresses_UC_ht+0x16571, %rsi
lea addresses_WT_ht+0x5551, %rdi
nop
sub $47381, %r9
mov $80, %rcx
rep movsq
nop
sub %r13, %r13
lea addresses_D_ht+0x11351, %r11
dec %r9
movb (%r11), %r14b
and %rdi, %rdi
lea addresses_WC_ht+0x128a1, %r11
nop
inc %r14
mov (%r11), %edi
add $61331, %r10
lea addresses_WC_ht+0x18b51, %r10
nop
nop
add $18467, %r11
...
// Faulty Load
lea addresses_normal+0x1551, %r15
nop
nop
nop
sub %r11, %r11
...
{'OP': 'STOR', 'dst': {'type': 'addresses_NC', 'size': 16, 'AVXalign': False, 'NT': True, 'congruent': 10, 'same': False}}
[Faulty Load]
...
{'OP': 'REPM', 'src': {'type': 'addresses_WC_ht', 'congruent': 3, 'same': False}, 'dst': {'type': 'addresses_WT_ht', 'congruent': 4, 'same': False}}
{'OP': 'STOR', 'dst': {'type': 'addresses_UC_ht', 'size': 32, 'AVXalign': False, 'NT': False, 'congruent': 4, 'same': False}}
{'OP': 'REPM', 'src': {'type': 'addresses_A_ht', 'congruent': 6, 'same': True}, 'dst': {'type': 'addresses_WC_ht', 'congruent': 1, 'same': False}}
{'OP': 'REPM', 'src': {'type': 'addresses_WT_ht', 'congruent': 7, 'same': False}, 'dst': {'type': 'addresses_normal_ht', 'congruent': 6, 'same': True}}
