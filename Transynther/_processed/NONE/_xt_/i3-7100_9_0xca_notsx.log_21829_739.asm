...
push %rbx
push %rdi
lea addresses_UC_ht+0x16da5, %r15
nop
nop
nop
nop
...
nop
cmp $36518, %r15
lea addresses_UC_ht+0x1c165, %rbx
nop
nop
nop
nop
...
// Store
lea addresses_normal+0x2da, %r14
xor $54765, %r8
movb $0x51, (%r14)
nop
nop
...
// REPMOV
lea addresses_UC+0x1d445, %rsi
lea addresses_WT+0x5765, %rdi
clflush (%rdi)
nop
nop
nop
...
// REPMOV
lea addresses_D+0x12965, %rsi
lea addresses_normal+0x19d25, %rdi
nop
nop
nop
nop
...
{'OP': 'STOR', 'dst': {'same': False, 'congruent': 0, 'NT': True, 'type': 'addresses_normal', 'size': 1, 'AVXalign': True}}
{'src': {'type': 'addresses_UC', 'congruent': 4, 'same': False}, 'OP': 'REPM', 'dst': {'type': 'addresses_WT', 'congruent': 2, 'same': False}}
...
{'src': {'same': False, 'congruent': 3, 'NT': False, 'type': 'addresses_PSE', 'size': 4, 'AVXalign': False}, 'OP': 'LOAD'}
[Faulty Load]
