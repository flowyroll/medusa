...
push %rdi
push %rsi
lea addresses_WT_ht+0x1b35d, %r13
nop
xor %r9, %r9
...
vpextrq $1, %xmm2, %rbx
add %r15, %r15
lea addresses_WC_ht+0x2dbd, %r10
nop
nop
nop
nop
...
nop
inc %r13
lea addresses_UC_ht+0x58cd, %rbx
clflush (%rbx)
nop
nop
nop
...
nop
inc %r12
lea addresses_UC_ht+0xdf68, %rsi
...
// Store
lea addresses_normal+0x33bd, %rcx
nop
nop
nop
nop
...
{'dst': {'same': False, 'NT': False, 'AVXalign': False, 'size': 2, 'type': 'addresses_UC', 'congruent': 1}, 'OP': 'STOR'}
