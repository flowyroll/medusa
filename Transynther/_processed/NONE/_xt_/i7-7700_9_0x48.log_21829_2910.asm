...
push %rdi
push %rsi
lea addresses_normal_ht+0x106, %rsi
lea addresses_A_ht+0x1ac16, %rdi
nop
nop
nop
add $15762, %r15
...
nop
add $25305, %rcx
lea addresses_UC_ht+0x6b3c, %rcx
nop
nop
nop
nop
...
nop
xor $16478, %r15
lea addresses_A_ht+0x149ce, %rsi
lea addresses_A_ht+0x3ece, %rdi
clflush (%rsi)
add $13070, %r11
mov $71, %rcx
rep movsq
...
nop
dec %r13
lea addresses_D_ht+0x14ce8, %rdi
nop
nop
nop
lfence
...
nop
add $17437, %rdi
lea addresses_WC_ht+0x1cece, %r13
nop
nop
sub $43805, %rsi
mov (%r13), %r15
...
// Faulty Load
lea addresses_normal+0x5ece, %r13
sub $64621, %rcx
vmovups (%r13), %ymm4
