...
push %rdi
push %rsi
lea addresses_normal_ht+0x1055a, %rsi
lea addresses_D_ht+0x163c6, %rdi
nop
nop
nop
nop
...
nop
add %rcx, %rcx
lea addresses_D_ht+0x1557a, %rdi
nop
nop
nop
nop
...
vmovups %ymm1, (%rdi)
add $60440, %rax
lea addresses_WT_ht+0xbccf, %rsi
nop
nop
nop
and $20260, %r11
...
nop
sub %rcx, %rcx
lea addresses_UC_ht+0x107da, %rsi
lea addresses_A_ht+0x135da, %rdi
nop
nop
nop
nop
...
rep movsw
and $10033, %rcx
lea addresses_normal_ht+0xda8a, %rbp
nop
and %r14, %r14
mov (%rbp), %rcx
nop
...
nop
xor %rdi, %rdi
lea addresses_WC_ht+0x14a62, %rax
nop
nop
add $9632, %rcx
vmovups (%rax), %ymm6
...
{'OP': 'STOR', 'dst': {'type': 'addresses_D', 'AVXalign': False, 'size': 4, 'NT': False, 'same': False, 'congruent': 5}}
...
{'src': {'type': 'addresses_WC_ht', 'AVXalign': False, 'size': 32, 'NT': False, 'same': True, 'congruent': 0}, 'OP': 'LOAD'}
{'32': 21829}
