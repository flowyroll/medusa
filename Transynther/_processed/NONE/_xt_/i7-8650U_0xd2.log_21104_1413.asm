...
push %rdx
push %rsi
lea addresses_WC_ht+0x1c2b0, %r11
clflush (%r11)
nop
xor %r9, %r9
movb $0x61, (%r11)
...
nop
cmp $55925, %r8
lea addresses_WC_ht+0x1ca28, %r15
add %r8, %r8
movups (%r15), %xmm5
vpextrq $1, %xmm5, %rcx
nop
...
nop
xor %r8, %r8
lea addresses_WT_ht+0x5490, %rsi
lea addresses_A_ht+0x1c0b0, %rdi
nop
nop
and %r8, %r8
mov $31, %rcx
rep movsb
cmp %r8, %r8
lea addresses_normal_ht+0x83e4, %rsi
lea addresses_D_ht+0x6b0, %rdi
nop
sub $48347, %rdx
mov $107, %rcx
rep movsw
add $31961, %rsi
lea addresses_D_ht+0x36b0, %rcx
clflush (%rcx)
nop
inc %r8
movl $0x61626364, (%rcx)
