...
push %rdx
push %rsi
lea addresses_D_ht+0x18b64, %rsi
lea addresses_D_ht+0x1471c, %rdi
clflush (%rdi)
nop
nop
nop
...
nop
xor $39276, %r15
lea addresses_WC_ht+0x7f1c, %rsi
lea addresses_A_ht+0xe291, %rdi
nop
nop
nop
xor $60332, %r9
...
lea addresses_normal_ht+0x1bddc, %rdi
add %r11, %r11
mov $3, %rcx
rep movsw
nop
...
{'src': {'type': 'addresses_A', 'same': False, 'size': 8, 'congruent': 3, 'NT': False, 'AVXalign': True}, 'OP': 'LOAD'}
