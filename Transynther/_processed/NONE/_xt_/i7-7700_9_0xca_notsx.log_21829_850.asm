...
rep movsq
cmp $29456, %r14
lea addresses_UC_ht+0x1b995, %r12
cmp %r9, %r9
...
nop
sub %r9, %r9
lea addresses_D_ht+0x1b0f, %rsi
lea addresses_normal_ht+0x84ea, %rdi
xor $54263, %r10
mov $70, %rcx
rep movsb
nop
...
nop
add $12578, %r8
lea addresses_normal_ht+0xd88d, %r8
nop
nop
nop
nop
...
nop
add %r14, %r14
lea addresses_WT_ht+0xe43d, %rsi
lea addresses_WC_ht+0xa9fd, %rdi
nop
nop
cmp %r14, %r14
mov $91, %rcx
...
nop
inc %rdi
lea addresses_D_ht+0x138f5, %r14
nop
nop
nop
and $38705, %r8
...
{'src': {'congruent': 0, 'same': False, 'type': 'addresses_UC_ht'}, 'dst': {'congruent': 2, 'same': True, 'type': 'addresses_A_ht'}, 'OP': 'REPM'}
