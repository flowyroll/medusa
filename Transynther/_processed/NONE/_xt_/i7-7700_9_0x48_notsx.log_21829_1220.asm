...
nop
add %r8, %r8
lea addresses_WT_ht+0x1a732, %rsi
nop
nop
nop
nop
...
nop
cmp $23460, %rsi
lea addresses_UC_ht+0x1e8dc, %rbp
clflush (%rbp)
nop
nop
nop
...
nop
cmp $23498, %r15
lea addresses_WC_ht+0x5e4c, %rsi
lea addresses_A_ht+0xc2dc, %rdi
nop
nop
nop
nop
...
rep movsb
and %r8, %r8
lea addresses_normal_ht+0x4e5c, %rdi
nop
cmp $14475, %r15
movb $0x61, (%rdi)
nop
...
{'dst': {'same': False, 'NT': True, 'AVXalign': True, 'size': 16, 'type': 'addresses_UC_ht', 'congruent': 9}, 'OP': 'STOR'}
{'dst': {'same': False, 'congruent': 8, 'type': 'addresses_A_ht'}, 'OP': 'REPM', 'src': {'same': False, 'congruent': 4, 'type': 'addresses_WC_ht'}}
