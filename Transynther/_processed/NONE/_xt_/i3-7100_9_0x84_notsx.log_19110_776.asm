...
push %rdi
push %rsi
lea addresses_UC_ht+0x1af63, %rdi
and $12330, %r11
mov (%rdi), %si
nop
nop
and %rdi, %rdi
lea addresses_A_ht+0x2563, %rsi
lea addresses_WT_ht+0x2e63, %rdi
nop
nop
nop
sub %r11, %r11
...
rep movsb
xor %rdi, %rdi
lea addresses_D_ht+0x1bd63, %rsi
lea addresses_UC_ht+0x12ce3, %rdi
cmp $65370, %r14
mov $89, %rcx
rep movsb
nop
...
nop
mfence
lea addresses_normal_ht+0x16bd, %rsi
lea addresses_WC_ht+0x6763, %rdi
nop
nop
nop
nop
...
rep movsl
cmp $36852, %rdi
lea addresses_A_ht+0x1ec63, %rax
nop
nop
and $16360, %r10
...
nop
add %rsi, %rsi
lea addresses_WC_ht+0x9f43, %rdi
nop
nop
nop
lfence
...
nop
xor %rsi, %rsi
lea addresses_WC_ht+0x8b63, %rdi
nop
nop
nop
and %r10, %r10
...
nop
and %r11, %r11
lea addresses_WC_ht+0xa943, %rsi
lea addresses_D_ht+0x1970f, %rdi
sub %r13, %r13
mov $17, %rcx
rep movsb
nop
...
// Store
lea addresses_WT+0x11b63, %r12
xor %rax, %rax
movw $0x5152, (%r12)
cmp $55570, %rsi

// Store
lea addresses_A+0x22dd, %rbp
dec %rsi
...
{'src': {'type': 'addresses_A_ht', 'congruent': 8, 'same': False}, 'dst': {'type': 'addresses_WT_ht', 'congruent': 9, 'same': False}, 'OP': 'REPM'}
{'src': {'type': 'addresses_D_ht', 'congruent': 7, 'same': False}, 'dst': {'type': 'addresses_UC_ht', 'congruent': 5, 'same': False}, 'OP': 'REPM'}
