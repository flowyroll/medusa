...
nop
xor $60506, %rcx
lea addresses_D_ht+0x11263, %rsi
dec %rbx
mov (%rsi), %di
xor %rsi, %rsi
lea addresses_normal_ht+0x89c3, %r11
nop
nop
nop
nop
...
nop
inc %rbx
lea addresses_WT_ht+0x7763, %r12
nop
nop
nop
xor $53913, %rcx
...
nop
cmp %rdx, %rdx
lea addresses_UC_ht+0x1c763, %rdi
nop
nop
nop
nop
...
<gen_prepare_buffer>
{'src': {'congruent': 2, 'same': False, 'type': 'addresses_UC_ht'}, 'OP': 'REPM', 'dst': {'congruent': 10, 'same': False, 'type': 'addresses_normal_ht'}}
