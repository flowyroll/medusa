...
push %rdx
push %rsi
lea addresses_UC_ht+0x18107, %rdx
nop
nop
xor %rbp, %rbp
...
vpextrq $0, %xmm6, %r12
and %rbp, %rbp
lea addresses_WC_ht+0x2ee7, %r10
clflush (%r10)
nop
nop
xor $51487, %rsi
...
lea addresses_UC_ht+0x1e4ef, %rdi
nop
nop
nop
nop
...
nop
dec %rdi
lea addresses_A_ht+0x1648f, %r12
nop
dec %rsi
movw $0x6162, (%r12)
sub %rdx, %rdx
