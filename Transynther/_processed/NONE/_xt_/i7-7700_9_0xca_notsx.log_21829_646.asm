...
nop
xor $10726, %r10
lea addresses_WT_ht+0x1c254, %rsi
lea addresses_WT_ht+0x1c0dc, %rdi
clflush (%rsi)
clflush (%rdi)
nop
nop
...
nop
cmp $49896, %rsi
lea addresses_D_ht+0x156f4, %r10
dec %rsi
movw $0x6162, (%r10)
nop
nop
xor %rdi, %rdi
lea addresses_WC_ht+0x104c6, %rdi
sub $39267, %rcx
mov (%rdi), %rbp
nop
nop
nop
and $42542, %r15
lea addresses_WC_ht+0x1da24, %r12
dec %rdi
mov $0x6162636465666768, %r15
movq %r15, %xmm7
movups %xmm7, (%r12)
xor %rsi, %rsi
lea addresses_WT_ht+0x171d4, %r9
nop
nop
nop
dec %r10
mov (%r9), %r12
sub $54889, %rdi
lea addresses_UC_ht+0x21d4, %r15
nop
cmp $5988, %rcx
mov (%r15), %r12d
add $58544, %rcx
lea addresses_D_ht+0x53e4, %r10
nop
add %rdi, %rdi
mov (%r10), %r9d
nop
...
nop
and $44180, %rbp
lea addresses_UC_ht+0x7d78, %rsi
lea addresses_WT_ht+0xda02, %rdi
add $13863, %r9
mov $37, %rcx
rep movsl
nop
...
nop
sub %r15, %r15
lea addresses_WC_ht+0x1edac, %r10
nop
nop
nop
nop
...
nop
cmp %r9, %r9
lea addresses_WT_ht+0x11bd4, %r15
clflush (%r15)
nop
nop
nop
...
movq %rdi, (%r15)
and %r15, %r15
lea addresses_normal_ht+0x1dfd4, %r9
nop
nop
and %rbp, %rbp
mov (%r9), %r12d
...
// REPMOV
lea addresses_UC+0x13484, %rsi
lea addresses_WT+0xde14, %rdi
nop
nop
nop
nop
...
{'src': {'congruent': 2, 'same': False, 'type': 'addresses_UC_ht'}, 'dst': {'congruent': 1, 'same': False, 'type': 'addresses_WT_ht'}, 'OP': 'REPM'}
