...
push %rdi
push %rsi
lea addresses_WT_ht+0x49bf, %rdi
dec %r11
mov (%rdi), %r14
nop
nop
add $19950, %r13
lea addresses_normal_ht+0xe450, %r15
nop
cmp $1916, %r8
mov (%r15), %rcx
nop
...
nop
sub $30588, %rcx
lea addresses_D_ht+0x15040, %r13
clflush (%r13)
nop
dec %rdi
mov (%r13), %r11d
add $34535, %r11
lea addresses_A_ht+0x5e20, %r14
nop
nop
nop
nop
...
nop
cmp $60065, %r14
lea addresses_WC_ht+0x10240, %r11
xor $20182, %r8
mov (%r11), %r14d
nop
nop
nop
cmp %rcx, %rcx
lea addresses_UC_ht+0x11540, %rcx
nop
nop
nop
sub %r8, %r8
...
movq %r14, (%rcx)
cmp %r11, %r11
lea addresses_normal_ht+0x7d20, %rsi
...
nop
inc %r11
lea addresses_UC_ht+0x4d40, %rsi
lea addresses_A_ht+0x1ca40, %rdi
and $55617, %r8
mov $78, %rcx
rep movsw
and $28126, %r8
lea addresses_UC_ht+0xf440, %r8
nop
nop
nop
nop
...
nop
sub $63743, %rsi
lea addresses_WT_ht+0x1e38a, %rdi
clflush (%rdi)
nop
nop
nop
...
nop
and $57892, %rdi
lea addresses_normal_ht+0x12aa4, %r13
nop
dec %rsi
movups (%r13), %xmm7
vpextrq $0, %xmm7, %rdi
...
nop
and $50120, %rcx
lea addresses_WC_ht+0xb040, %rcx
xor $45328, %r8
...
{'src': {'congruent': 4, 'same': False, 'type': 'addresses_normal_ht'}, 'dst': {'congruent': 0, 'same': True, 'type': 'addresses_D_ht'}, 'OP': 'REPM'}
{'src': {'congruent': 8, 'same': True, 'type': 'addresses_UC_ht'}, 'dst': {'congruent': 8, 'same': False, 'type': 'addresses_A_ht'}, 'OP': 'REPM'}
