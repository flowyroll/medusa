...
nop
add %r14, %r14
lea addresses_WC_ht+0x157bb, %rsi
lea addresses_WT_ht+0x15c1b, %rdi
clflush (%rdi)
nop
nop
nop
...
// Store
lea addresses_normal+0xa597, %r11
nop
nop
cmp $22125, %rcx
