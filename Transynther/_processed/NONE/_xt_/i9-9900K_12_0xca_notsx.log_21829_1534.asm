...
nop
and %r10, %r10
lea addresses_normal_ht+0xadb2, %r10
nop
nop
and %r15, %r15
movl $0x61626364, (%r10)
nop
add $63688, %r13
lea addresses_D_ht+0x1d812, %rax
nop
nop
and %r15, %r15
movups (%rax), %xmm3
vpextrq $1, %xmm3, %rdx
dec %r15
lea addresses_WC_ht+0x9d8b, %r13
nop
nop
nop
nop
...
nop
cmp $58596, %rax
lea addresses_WT_ht+0x15bf2, %rsi
lea addresses_A_ht+0x11b2, %rdi
nop
nop
nop
nop
...
nop
and %rdi, %rdi
lea addresses_D_ht+0x195b2, %rsi
lea addresses_WC_ht+0x195b2, %rdi
nop
sub $29169, %rax
mov $3, %rcx
rep movsq
...
nop
cmp %rdi, %rdi
lea addresses_normal_ht+0x31b2, %rsi
lea addresses_D_ht+0x16d2, %rdi
nop
sub %rax, %rax
mov $107, %rcx
rep movsl
...
// Load
lea addresses_normal+0x99b2, %r11
nop
nop
nop
nop
...
// Faulty Load
lea addresses_normal+0x99b2, %rbx
clflush (%rbx)
nop
nop
nop
...
{'OP': 'REPM', 'src': {'same': False, 'congruent': 10, 'type': 'addresses_D_ht'}, 'dst': {'same': False, 'congruent': 9, 'type': 'addresses_WC_ht'}}
{'OP': 'REPM', 'src': {'same': False, 'congruent': 10, 'type': 'addresses_normal_ht'}, 'dst': {'same': False, 'congruent': 4, 'type': 'addresses_D_ht'}}
{'34': 21829}
