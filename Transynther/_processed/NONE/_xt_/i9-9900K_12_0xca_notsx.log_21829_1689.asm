...
nop
xor $43603, %r13
lea addresses_normal_ht+0x3e04, %rax
nop
nop
nop
inc %r15
...
// Load
lea addresses_normal+0x8072, %rdx
nop
and $52891, %rcx
movb (%rdx), %r15b
nop
...
// Load
lea addresses_normal+0x1c704, %rcx
nop
add %r8, %r8
movups (%rcx), %xmm5
vpextrq $1, %xmm5, %r12
...
{'OP': 'LOAD', 'src': {'same': False, 'type': 'addresses_normal', 'NT': False, 'AVXalign': False, 'size': 16, 'congruent': 8}}
