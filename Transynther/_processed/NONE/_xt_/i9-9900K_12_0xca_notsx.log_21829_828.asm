...
push %rdi
push %rsi
lea addresses_WC_ht+0x8efa, %rcx
nop
xor %r10, %r10
mov (%rcx), %r14
nop
...
nop
add $29294, %r14
lea addresses_D_ht+0x11ce7, %rsi
lea addresses_UC_ht+0x199fa, %rdi
clflush (%rdi)
nop
nop
inc %r9
...
nop
sub $48801, %r9
lea addresses_D_ht+0x149aa, %rdi
nop
nop
nop
xor %rbx, %rbx
