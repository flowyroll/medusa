...
movq %r11, (%rsi)
cmp $33134, %r11
lea addresses_D_ht+0x11fe6, %rdi
nop
nop
nop
add %r12, %r12
...
nop
cmp %rsi, %rsi
lea addresses_A_ht+0xdfea, %rsi
lea addresses_D_ht+0x2a8e, %rdi
nop
nop
nop
nop
...
nop
add $24055, %rsi
lea addresses_normal_ht+0xfd4c, %r15
nop
nop
nop
sub $24714, %rcx
...
nop
add %r12, %r12
lea addresses_UC_ht+0x119c6, %r15
nop
xor $30459, %r13
...
nop
sub %rsi, %rsi
lea addresses_WT_ht+0x5c66, %rsi
lea addresses_WT_ht+0x148e6, %rdi
sub %r13, %r13
mov $113, %rcx
rep movsb
nop
and %r11, %r11
lea addresses_normal_ht+0x82c6, %rsi
lea addresses_WT_ht+0x15866, %rdi
nop
nop
nop
nop
...
{'src': {'type': 'addresses_D_ht', 'AVXalign': False, 'size': 2, 'NT': True, 'same': False, 'congruent': 2}, 'OP': 'LOAD'}
{'src': {'type': 'addresses_A_ht', 'congruent': 0, 'same': False}, 'OP': 'REPM', 'dst': {'type': 'addresses_D_ht', 'congruent': 2, 'same': False}}
{'OP': 'STOR', 'dst': {'type': 'addresses_normal_ht', 'AVXalign': True, 'size': 1, 'NT': False, 'same': False, 'congruent': 11}}
{'src': {'type': 'addresses_normal_ht', 'AVXalign': False, 'size': 4, 'NT': True, 'same': False, 'congruent': 1}, 'OP': 'LOAD'}
{'OP': 'STOR', 'dst': {'type': 'addresses_UC_ht', 'AVXalign': False, 'size': 32, 'NT': False, 'same': False, 'congruent': 3}}
{'src': {'type': 'addresses_WT_ht', 'congruent': 6, 'same': False}, 'OP': 'REPM', 'dst': {'type': 'addresses_WT_ht', 'congruent': 4, 'same': False}}
{'src': {'type': 'addresses_normal_ht', 'congruent': 5, 'same': False}, 'OP': 'REPM', 'dst': {'type': 'addresses_WT_ht', 'congruent': 5, 'same': True}}
{'36': 21829}
