...
push %rdi
push %rsi
lea addresses_WC_ht+0x91af, %rsi
nop
nop
nop
and $22596, %rcx
...
nop
cmp %r10, %r10
lea addresses_A_ht+0x1b0af, %r15
nop
nop
add $10145, %rsi
movl $0x61626364, (%r15)
...
nop
and %r10, %r10
lea addresses_WT_ht+0x99d9, %rsi
lea addresses_A_ht+0x1b17f, %rdi
clflush (%rsi)
nop
xor %r14, %r14
mov $124, %rcx
...
nop
sub $15288, %rcx
lea addresses_UC_ht+0x2caf, %r14
xor $3997, %r15
...
<gen_prepare_buffer>
{'OP': 'LOAD', 'src': {'type': 'addresses_WC_ht', 'size': 4, 'AVXalign': False, 'NT': True, 'congruent': 5, 'same': False}}
