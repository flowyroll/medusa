...
push %rdi
push %rsi
lea addresses_WT_ht+0xfb71, %rax
nop
add $36593, %r8
mov (%rax), %r9
cmp $15008, %r15
lea addresses_WT_ht+0x1c111, %rsi
lea addresses_A_ht+0x2341, %rdi
nop
sub $42295, %r9
mov $98, %rcx
rep movsq
...
nop
and %r9, %r9
lea addresses_WC_ht+0x1ab71, %rsi
nop
sub %r8, %r8
...
vmovups %ymm0, (%rsi)
and %rdi, %rdi
lea addresses_UC_ht+0x1402f, %r8
clflush (%r8)
nop
nop
nop
...
vpextrq $0, %xmm1, %rdi
inc %rsi
lea addresses_normal_ht+0x137f1, %rax
nop
nop
sub %rdi, %rdi
vmovups (%rax), %ymm7
...
mov (%r9), %rsi
and %r8, %r8
lea addresses_WC_ht+0x1509a, %rdi
nop
nop
nop
xor %rax, %rax
...
nop
cmp %rsi, %rsi
lea addresses_WC_ht+0x1e4dd, %rdi
nop
nop
nop
sub %r15, %r15
...
movb $0x61, (%rsi)
dec %rsi
lea addresses_normal_ht+0x3171, %r8
nop
and %rcx, %rcx
mov $0x6162636465666768, %r9
movq %r9, (%r8)
...
nop
dec %rcx
lea addresses_A_ht+0x12e71, %rsi
lea addresses_A_ht+0x1c511, %rdi
nop
sub %rbx, %rbx
mov $116, %rcx
rep movsl
...
{'src': {'type': 'addresses_WC_ht', 'AVXalign': False, 'size': 32, 'NT': True, 'same': False, 'congruent': 0}, 'OP': 'LOAD'}
...
{'src': {'type': 'addresses_A_ht', 'congruent': 8, 'same': True}, 'OP': 'REPM', 'dst': {'type': 'addresses_A_ht', 'congruent': 3, 'same': False}}
