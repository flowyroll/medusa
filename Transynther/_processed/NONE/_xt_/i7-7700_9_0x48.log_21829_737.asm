...
push %rdx
push %rsi
lea addresses_UC_ht+0x40af, %rsi
lea addresses_WT_ht+0x1635b, %rdi
clflush (%rdi)
nop
and %rdx, %rdx
mov $73, %rcx
...
nop
and %r13, %r13
lea addresses_D_ht+0xc39b, %rcx
cmp %r11, %r11
movb (%rcx), %r8b
nop
inc %rsi
lea addresses_A_ht+0x1e4db, %rdi
nop
nop
nop
nop
...
nop
add $27411, %rcx
lea addresses_UC_ht+0x14f83, %rsi
lea addresses_D_ht+0x6d5b, %rdi
clflush (%rsi)
nop
nop
nop
...
nop
and $31367, %r8
lea addresses_WT_ht+0x143db, %r13
nop
nop
nop
nop
...
nop
add $37628, %rcx
lea addresses_UC_ht+0x1ec5b, %rsi
lea addresses_D_ht+0xcf7, %rdi
nop
nop
nop
xor %r8, %r8
...
rep movsq
cmp %rdi, %rdi
lea addresses_UC_ht+0x965b, %rsi
lea addresses_UC_ht+0x12bb, %rdi
clflush (%rsi)
nop
nop
nop
...
rep movsb
and $27130, %r9
lea addresses_WC_ht+0xf35b, %rsi
lea addresses_WC_ht+0xa15b, %rdi
nop
add %r8, %r8
mov $69, %rcx
rep movsw
...
<gen_prepare_buffer>
{'OP': 'REPM', 'src': {'type': 'addresses_UC_ht', 'congruent': 1, 'same': False}, 'dst': {'type': 'addresses_WT_ht', 'congruent': 11, 'same': True}}
{'OP': 'LOAD', 'src': {'type': 'addresses_D_ht', 'AVXalign': True, 'congruent': 4, 'size': 1, 'same': True, 'NT': False}}
{'OP': 'LOAD', 'src': {'type': 'addresses_A_ht', 'AVXalign': True, 'congruent': 7, 'size': 32, 'same': False, 'NT': True}}
