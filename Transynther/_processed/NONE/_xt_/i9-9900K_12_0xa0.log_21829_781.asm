...
push %rdx
push %rsi
lea addresses_WC_ht+0x9690, %rsi
lea addresses_WT_ht+0x4684, %rdi
nop
nop
sub %rdx, %rdx
mov $33, %rcx
...
nop
inc %rbx
lea addresses_WT_ht+0x1afa0, %r11
nop
nop
nop
and %r8, %r8
...
nop
cmp $8874, %rdi
lea addresses_normal_ht+0xb5a0, %rsi
lea addresses_D_ht+0x12220, %rdi
clflush (%rsi)
nop
nop
nop
...
nop
xor %r11, %r11
lea addresses_WC_ht+0xd9a0, %rsi
lea addresses_UC_ht+0x18650, %rdi
clflush (%rdi)
xor $17102, %rdx
mov $76, %rcx
rep movsb
...
nop
sub $46791, %r8
lea addresses_WT_ht+0x5fd0, %rdi
nop
nop
nop
add %rcx, %rcx
movb $0x61, (%rdi)
and $6088, %rsi
lea addresses_WC_ht+0x193a0, %rsi
nop
nop
nop
nop
...
nop
cmp $39829, %rsi
lea addresses_D_ht+0x14c60, %rsi
...
{'src': {'same': False, 'congruent': 10, 'type': 'addresses_normal_ht'}, 'OP': 'REPM', 'dst': {'same': True, 'congruent': 6, 'type': 'addresses_D_ht'}}
...
{'src': {'same': False, 'congruent': 6, 'type': 'addresses_D_ht'}, 'OP': 'REPM', 'dst': {'same': False, 'congruent': 7, 'type': 'addresses_UC_ht'}}
{'33': 21829}
