...
push %rdi
push %rsi
lea addresses_UC_ht+0x1a1d2, %r14
nop
nop
nop
add %r9, %r9
...
nop
xor $6335, %rcx
lea addresses_normal_ht+0x56ba, %r8
nop
nop
cmp $33904, %rbp
movb $0x61, (%r8)
cmp %r15, %r15
lea addresses_normal_ht+0x8eb4, %r8
nop
nop
dec %r15
mov (%r8), %ecx
...
nop
inc %r8
lea addresses_WC_ht+0xc9d2, %rbp
nop
sub %r9, %r9
...
nop
sub %rbp, %rbp
lea addresses_UC_ht+0x129d2, %rsi
lea addresses_WC_ht+0x117d2, %rdi
nop
nop
nop
and %rbp, %rbp
...
nop
sub $37286, %r10
lea addresses_WC_ht+0x1e7d2, %rsi
lea addresses_WT_ht+0x1c1d2, %rdi
clflush (%rdi)
nop
nop
nop
...
nop
and %rdi, %rdi
lea addresses_normal_ht+0x56d2, %r9
nop
nop
xor $14709, %r14
movb (%r9), %cl
...
nop
xor %r8, %r8
lea addresses_normal_ht+0x13002, %rsi
lea addresses_normal_ht+0x181d2, %rdi
nop
nop
nop
inc %r14
...
nop
dec %r8
lea addresses_WT_ht+0x188d2, %rcx
nop
nop
nop
add %r15, %r15
...
nop
dec %r10
lea addresses_WC_ht+0x71d2, %rsi
lea addresses_A_ht+0x87d2, %rdi
nop
add %r8, %r8
mov $80, %rcx
rep movsl
...
{'src': {'type': 'addresses_UC_ht', 'congruent': 11, 'same': False}, 'dst': {'type': 'addresses_WC_ht', 'congruent': 8, 'same': False}, 'OP': 'REPM'}
...
{'src': {'type': 'addresses_WC_ht', 'congruent': 9, 'same': False}, 'dst': {'type': 'addresses_WT_ht', 'congruent': 10, 'same': False}, 'OP': 'REPM'}
{'src': {'type': 'addresses_normal_ht', 'same': False, 'size': 1, 'congruent': 8, 'NT': False, 'AVXalign': False}, 'OP': 'LOAD'}
{'src': {'type': 'addresses_normal_ht', 'congruent': 3, 'same': False}, 'dst': {'type': 'addresses_normal_ht', 'congruent': 10, 'same': False}, 'OP': 'REPM'}
{'dst': {'type': 'addresses_A_ht', 'same': False, 'size': 1, 'congruent': 4, 'NT': False, 'AVXalign': False}, 'OP': 'STOR'}
{'dst': {'type': 'addresses_WT_ht', 'same': True, 'size': 1, 'congruent': 5, 'NT': False, 'AVXalign': False}, 'OP': 'STOR'}
