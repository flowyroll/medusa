...
push %rdi
push %rsi
lea addresses_normal_ht+0xe36c, %r11
nop
xor $49954, %r12
movb $0x61, (%r11)
nop
...
nop
and $35747, %rbx
lea addresses_WC_ht+0x120ec, %rsi
lea addresses_A_ht+0x17aec, %rdi
nop
nop
nop
nop
...
nop
sub %rsi, %rsi
lea addresses_normal_ht+0x2028, %rsi
lea addresses_UC_ht+0x6aec, %rdi
nop
cmp $57512, %r10
mov $10, %rcx
rep movsw
...
nop
sub %r10, %r10
lea addresses_normal_ht+0xf0ec, %rcx
add %r12, %r12
mov (%rcx), %edi
nop
nop
...
nop
dec %rcx
lea addresses_A_ht+0x158ec, %rcx
nop
inc %r11
movw $0x6162, (%rcx)
nop
...
nop
dec %rbx
lea addresses_WT_ht+0x390c, %rdi
clflush (%rdi)
nop
nop
nop
...
nop
inc %rcx
lea addresses_WC_ht+0x2aec, %r12
nop
nop
nop
add %rsi, %rsi
...
vpextrq $1, %xmm2, %r11
sub $16930, %rcx
lea addresses_normal_ht+0xff84, %rsi
nop
nop
nop
nop
...
nop
dec %rbx
lea addresses_WT_ht+0x1e2ec, %rdi
nop
nop
nop
cmp %rbx, %rbx
...
nop
cmp %rcx, %rcx
lea addresses_WC_ht+0xecec, %rcx
nop
add %rsi, %rsi
movb (%rcx), %r10b
sub %rcx, %rcx
lea addresses_WC_ht+0x28ac, %rdi
sub %r11, %r11
mov (%rdi), %esi
nop
nop
inc %r11
lea addresses_WT_ht+0x14dac, %rsi
nop
sub %r12, %r12
mov (%rsi), %ebx
nop
...
{'OP': 'LOAD', 'src': {'type': 'addresses_normal_ht', 'size': 1, 'AVXalign': True, 'NT': True, 'congruent': 3, 'same': False}}
