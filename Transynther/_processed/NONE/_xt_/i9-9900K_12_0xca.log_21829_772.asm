...
push %rdi
push %rsi
lea addresses_normal_ht+0x19c5d, %r13
nop
nop
nop
add %r11, %r11
...
nop
cmp $45832, %r11
lea addresses_normal_ht+0x11cd8, %r12
nop
nop
nop
add %r14, %r14
...
nop
and $61747, %rsi
lea addresses_UC_ht+0x1bed8, %r9
nop
nop
cmp %r12, %r12
movb (%r9), %r13b
nop
inc %r15
lea addresses_WC_ht+0xe128, %rsi
nop
nop
add %r12, %r12
mov $0x6162636465666768, %r13
...
nop
and $42901, %r14
lea addresses_normal_ht+0x56d8, %rsi
lea addresses_WT_ht+0x5aa8, %rdi
nop
nop
nop
nop
...
// Store
lea addresses_normal+0x19838, %r12
nop
nop
nop
add $18617, %r8
...
{'OP': 'STOR', 'dst': {'size': 8, 'NT': True, 'type': 'addresses_WC_ht', 'same': True, 'AVXalign': False, 'congruent': 7}}
