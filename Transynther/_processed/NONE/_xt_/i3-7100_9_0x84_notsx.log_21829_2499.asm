...
push %rdi
push %rsi
lea addresses_A_ht+0x1d870, %rsi
lea addresses_A_ht+0x186cc, %rdi
and $25871, %rax
mov $5, %rcx
rep movsq
nop
nop
sub $9480, %rsi
lea addresses_normal_ht+0xfab0, %rbx
nop
nop
sub $41675, %r14
mov (%rbx), %r13d
...
nop
and %rax, %rax
lea addresses_WC_ht+0xc070, %rcx
nop
nop
nop
inc %rdi
...
nop
cmp $42698, %rsi
lea addresses_D_ht+0x11cba, %rsi
lea addresses_normal_ht+0x73b8, %rdi
nop
cmp $55635, %r12
mov $102, %rcx
rep movsb
...
// Store
lea addresses_normal+0x41b0, %r12
clflush (%r12)
nop
nop
nop
...
{'src': {'type': 'addresses_WC', 'same': False, 'size': 16, 'congruent': 11, 'NT': False, 'AVXalign': True}, 'OP': 'LOAD'}
...
<gen_prepare_buffer>
{'src': {'type': 'addresses_A_ht', 'congruent': 6, 'same': False}, 'dst': {'type': 'addresses_A_ht', 'congruent': 2, 'same': False}, 'OP': 'REPM'}
