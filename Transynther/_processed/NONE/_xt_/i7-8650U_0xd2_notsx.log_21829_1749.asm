...
push %rdi
push %rsi
lea addresses_WT_ht+0x7d12, %rcx
nop
dec %r15
movb (%rcx), %r12b
sub $38091, %r13
lea addresses_UC_ht+0xcae2, %rbp
nop
nop
sub %rbx, %rbx
...
movaps %xmm2, (%rbp)
xor %r13, %r13
lea addresses_WC_ht+0x14258, %rsi
lea addresses_A_ht+0x812, %rdi
nop
nop
nop
nop
...
nop
cmp %rbx, %rbx
lea addresses_normal_ht+0x2c12, %rsi
lea addresses_D_ht+0x156d2, %rdi
nop
nop
xor $26947, %r12
mov $61, %rcx
...
nop
sub $27679, %r12
lea addresses_D_ht+0x13592, %rbp
nop
dec %rdi
mov (%rbp), %r15
nop
...
{'OP': 'REPM', 'src': {'type': 'addresses_WC_ht', 'congruent': 1, 'same': False}, 'dst': {'type': 'addresses_A_ht', 'congruent': 11, 'same': False}}
