...
nop
xor $18880, %r14
lea addresses_normal_ht+0xd17d, %rsi
lea addresses_normal_ht+0x102b1, %rdi
nop
nop
and %rax, %rax
mov $56, %rcx
...
nop
cmp %r14, %r14
lea addresses_D_ht+0x103b1, %r12
and $16742, %rax
mov $0x6162636465666768, %rsi
movq %rsi, %xmm4
vmovups %ymm4, (%r12)
sub %r11, %r11
lea addresses_D_ht+0x2a59, %rsi
lea addresses_UC_ht+0x6ab1, %rdi
nop
nop
nop
nop
...
nop
add %rsi, %rsi
lea addresses_normal_ht+0xbc85, %r12
nop
nop
nop
nop
...
nop
cmp %r14, %r14
lea addresses_WC_ht+0x138b5, %rax
nop
nop
nop
nop
...
nop
inc %r11
lea addresses_WT_ht+0x15a31, %r14
nop
nop
nop
add $25033, %rax
...
nop
cmp %rdx, %rdx
lea addresses_D_ht+0x1586a, %rsi
nop
nop
cmp %rcx, %rcx
vmovups (%rsi), %ymm4
...
nop
and $61033, %r11
lea addresses_normal_ht+0x32b1, %rcx
nop
nop
nop
nop
...
nop
and %r11, %r11
lea addresses_UC_ht+0x17a11, %rsi
lea addresses_D_ht+0x491, %rdi
nop
nop
nop
nop
...
nop
xor %r11, %r11
lea addresses_normal_ht+0x19a31, %r11
nop
nop
nop
dec %rdi
...
nop
cmp $34434, %rax
lea addresses_WT_ht+0x12ab1, %rcx
nop
nop
nop
cmp %rax, %rax
...
nop
sub $56025, %rdx
lea addresses_WC_ht+0x80b1, %rcx
nop
nop
cmp $14183, %rax
movups (%rcx), %xmm2
...
{'OP': 'STOR', 'dst': {'same': False, 'type': 'addresses_WT', 'NT': True, 'AVXalign': False, 'size': 4, 'congruent': 0}}
...
{'OP': 'REPM', 'src': {'same': False, 'congruent': 2, 'type': 'addresses_normal_ht'}, 'dst': {'same': False, 'congruent': 10, 'type': 'addresses_normal_ht'}}
...
{'OP': 'STOR', 'dst': {'same': False, 'type': 'addresses_normal_ht', 'NT': False, 'AVXalign': True, 'size': 8, 'congruent': 2}}
{'OP': 'STOR', 'dst': {'same': False, 'type': 'addresses_WC_ht', 'NT': False, 'AVXalign': True, 'size': 1, 'congruent': 1}}
