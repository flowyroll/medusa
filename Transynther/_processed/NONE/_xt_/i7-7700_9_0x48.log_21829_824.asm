...
push %rdx
push %rsi
lea addresses_UC_ht+0x73f8, %rdx
nop
nop
nop
cmp $12092, %r9
...
nop
and %rax, %rax
lea addresses_WC_ht+0x50ca, %rsi
lea addresses_WT_ht+0x11b0c, %rdi
nop
nop
nop
nop
...
rep movsw
xor %rsi, %rsi
lea addresses_normal_ht+0xf11a, %rsi
lea addresses_UC_ht+0x180e1, %rdi
clflush (%rdi)
nop
nop
add $1105, %rdx
...
nop
cmp %rdx, %rdx
lea addresses_UC_ht+0x13ae, %rdx
cmp $41320, %rdi
movb $0x61, (%rdx)
xor %rdi, %rdi
lea addresses_A_ht+0x1871a, %rcx
nop
nop
dec %r8
movb (%rcx), %r11b
and $55361, %r11
lea addresses_WT_ht+0x18dba, %r9
add $20894, %r8
...
nop
cmp %rax, %rax
lea addresses_UC_ht+0x1ef4e, %rcx
nop
nop
nop
add $40087, %r8
...
nop
and %r11, %r11
lea addresses_UC_ht+0x821a, %r11
nop
nop
sub %rcx, %rcx
movw $0x6162, (%r11)
xor %rdi, %rdi
lea addresses_WC_ht+0x100f0, %rsi
lea addresses_WT_ht+0x1c41a, %rdi
and $11492, %r9
mov $21, %rcx
rep movsw
nop
...
nop
inc %rsi
lea addresses_WT_ht+0x570e, %rax
nop
nop
nop
cmp $37159, %rdi
...
nop
cmp %rdi, %rdi
lea addresses_WC_ht+0xd21a, %rdx
nop
nop
nop
add %rsi, %rsi
...
// Faulty Load
lea addresses_normal+0xca1a, %r14
and %r8, %r8
movb (%r14), %dl
lea oracles, %rsi
and $0xff, %rdx
...
{'OP': 'STOR', 'dst': {'type': 'addresses_WT_ht', 'AVXalign': False, 'congruent': 5, 'size': 16, 'same': False, 'NT': True}}
...
{'OP': 'REPM', 'src': {'type': 'addresses_WC_ht', 'congruent': 1, 'same': True}, 'dst': {'type': 'addresses_WT_ht', 'congruent': 9, 'same': True}}
