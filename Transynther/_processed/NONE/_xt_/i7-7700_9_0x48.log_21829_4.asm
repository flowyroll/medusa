...
push %rdi
push %rsi
lea addresses_UC_ht+0x1996a, %r10
inc %rcx
mov (%r10), %r9
nop
nop
...
nop
mfence
lea addresses_A_ht+0x184aa, %rcx
nop
nop
nop
nop
...
nop
add $13396, %r10
lea addresses_normal_ht+0x76aa, %r15
nop
nop
and %r10, %r10
vmovups (%r15), %ymm6
...
nop
sub %r10, %r10
lea addresses_A_ht+0x1c3f0, %rcx
nop
add $51891, %r9
...
nop
sub $46094, %r10
lea addresses_D_ht+0x1885a, %r15
nop
nop
nop
nop
...
nop
and %r15, %r15
lea addresses_D_ht+0x1174a, %r10
nop
nop
nop
and %rax, %rax
...
nop
inc %rbx
lea addresses_normal_ht+0x7aaa, %rbx
nop
nop
nop
nop
...
nop
cmp %rcx, %rcx
lea addresses_A_ht+0x1c72a, %rsi
lea addresses_WT_ht+0x1f2a, %rdi
clflush (%rdi)
nop
nop
add %r10, %r10
...
// Faulty Load
lea addresses_normal+0xeaa, %rbp
add $28420, %rdx
vmovups (%rbp), %ymm0
