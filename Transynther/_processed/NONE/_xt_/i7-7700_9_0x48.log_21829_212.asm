...
push %rdi
push %rsi
lea addresses_UC_ht+0x6a64, %rsi
lea addresses_UC_ht+0xbbb4, %rdi
clflush (%rsi)
nop
nop
xor $20577, %r11
...
rep movsq
xor %r9, %r9
lea addresses_WC_ht+0xa874, %rsi
lea addresses_D_ht+0x16014, %rdi
inc %r12
mov $5, %rcx
rep movsb
nop
...
nop
cmp %rdi, %rdi
lea addresses_UC_ht+0x57b4, %rsi
lea addresses_A_ht+0xf54, %rdi
nop
nop
nop
nop
...
nop
add %rsi, %rsi
lea addresses_normal_ht+0x5b64, %rcx
nop
nop
add $10871, %r12
movb (%rcx), %r9b
xor %rdi, %rdi
lea addresses_D_ht+0x6d32, %r8
nop
nop
nop
inc %r9
...
nop
cmp $31494, %rsi
lea addresses_normal_ht+0x1b8aa, %r8
nop
nop
nop
nop
...
nop
sub $59010, %rcx
lea addresses_WT_ht+0x183e4, %r8
inc %rcx
mov (%r8), %rdi
nop
sub $48611, %r12
...
// Faulty Load
lea addresses_normal+0x123b4, %r9
nop
nop
cmp $26073, %rbx
mov (%r9), %esi
