...
push %rdi
push %rsi
lea addresses_D_ht+0xef1, %rsi
lea addresses_WC_ht+0xcbd8, %rdi
nop
nop
nop
nop
...
nop
dec %rsi
lea addresses_WT_ht+0x1918, %rsi
nop
and $32162, %rcx
movw $0x6162, (%rsi)
nop
nop
cmp $36606, %rbp
lea addresses_WT_ht+0x9718, %rsi
nop
cmp $54991, %rdi
movb $0x61, (%rsi)
nop
nop
xor %rbp, %rbp
lea addresses_normal_ht+0x1c718, %rbp
nop
nop
nop
cmp %r9, %r9
...
nop
dec %rcx
lea addresses_D_ht+0xb698, %rsi
lea addresses_normal_ht+0x1c0cf, %rdi
nop
nop
nop
nop
...
{'dst': {'NT': True, 'AVXalign': False, 'size': 2, 'congruent': 0, 'same': False, 'type': 'addresses_A'}, 'OP': 'STOR'}
...
<gen_prepare_buffer>
{'src': {'congruent': 0, 'same': False, 'type': 'addresses_D_ht'}, 'dst': {'congruent': 6, 'same': True, 'type': 'addresses_WC_ht'}, 'OP': 'REPM'}
...
{'src': {'congruent': 4, 'same': False, 'type': 'addresses_D_ht'}, 'dst': {'congruent': 0, 'same': False, 'type': 'addresses_normal_ht'}, 'OP': 'REPM'}
{'33': 20447}
