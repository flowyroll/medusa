...
push %rdi
push %rsi
lea addresses_A_ht+0x6b09, %rsi
lea addresses_UC_ht+0x9ea9, %rdi
sub $7335, %r8
mov $114, %rcx
rep movsl
nop
...
nop
dec %rax
lea addresses_UC_ht+0x12869, %rcx
nop
nop
xor %rdi, %rdi
...
nop
and %r15, %r15
lea addresses_normal_ht+0x16581, %rcx
clflush (%rcx)
nop
nop
nop
...
nop
and $40564, %rsi
lea addresses_UC_ht+0x6597, %rdi
nop
nop
nop
xor %r15, %r15
...
nop
cmp %r11, %r11
lea addresses_A_ht+0x185e9, %rsi
lea addresses_WC_ht+0xc8a9, %rdi
nop
nop
nop
xor %r14, %r14
...
rep movsl
add $34811, %rcx
lea addresses_WT_ht+0x164e9, %rax
clflush (%rax)
add %r11, %r11
movb $0x61, (%rax)
nop
...
nop
xor $33188, %r15
lea addresses_normal_ht+0x12e9, %rsi
lea addresses_UC_ht+0x13ee9, %rdi
nop
nop
nop
nop
...
nop
cmp %r11, %r11
lea addresses_A_ht+0x14727, %r15
nop
nop
nop
sub %r8, %r8
...
{'OP': 'LOAD', 'src': {'type': 'addresses_normal_ht', 'AVXalign': False, 'congruent': 3, 'size': 16, 'same': True, 'NT': False}}
{'OP': 'LOAD', 'src': {'type': 'addresses_UC_ht', 'AVXalign': False, 'congruent': 0, 'size': 1, 'same': True, 'NT': False}}
