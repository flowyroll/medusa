...
push %rdi
push %rsi
lea addresses_WC_ht+0xdfbe, %rsi
lea addresses_D_ht+0x1bcbe, %rdi
nop
nop
add $63799, %r15
mov $73, %rcx
...
nop
inc %rdi
lea addresses_normal_ht+0x28be, %rdi
nop
dec %rcx
movb $0x61, (%rdi)
dec %r15
lea addresses_normal_ht+0x576, %rsi
lea addresses_UC_ht+0x1a23e, %rdi
cmp %r12, %r12
mov $47, %rcx
rep movsw
nop
...
// Store
lea addresses_normal+0x16f7e, %r12
clflush (%r12)
nop
nop
and $13665, %r14
...
{'dst': {'same': True, 'NT': False, 'AVXalign': False, 'size': 1, 'type': 'addresses_WC', 'congruent': 11}, 'OP': 'STOR'}
