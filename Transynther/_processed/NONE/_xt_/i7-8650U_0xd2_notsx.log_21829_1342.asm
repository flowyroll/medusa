...
push %rdi
push %rsi
lea addresses_A_ht+0x9ac8, %rsi
lea addresses_normal_ht+0x915a, %rdi
clflush (%rdi)
nop
nop
nop
...
nop
and %r15, %r15
lea addresses_A_ht+0x1726c, %rsi
lea addresses_D_ht+0x5d5a, %rdi
nop
sub $55171, %r15
mov $61, %rcx
rep movsl
xor $44999, %rsi
lea addresses_UC_ht+0x75da, %rsi
lea addresses_D_ht+0x1535a, %rdi
nop
nop
nop
and $54286, %r10
...
rep movsb
dec %r15
lea addresses_A_ht+0x1b4da, %rsi
lea addresses_WC_ht+0x114da, %rdi
nop
nop
dec %r8
mov $37, %rcx
...
nop
xor %rbx, %rbx
lea addresses_D_ht+0x19d4a, %r10
nop
nop
nop
sub $64610, %rsi
...
nop
and %r15, %r15
lea addresses_WT_ht+0x1ef5a, %rsi
nop
nop
nop
nop
...
{'OP': 'STOR', 'dst': {'type': 'addresses_A_ht', 'size': 8, 'AVXalign': False, 'NT': True, 'congruent': 11, 'same': False}}
{'OP': 'REPM', 'src': {'type': 'addresses_A_ht', 'congruent': 0, 'same': False}, 'dst': {'type': 'addresses_D_ht', 'congruent': 7, 'same': True}}
