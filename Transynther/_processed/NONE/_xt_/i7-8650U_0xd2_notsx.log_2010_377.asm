...
push %rdi
push %rsi
lea addresses_normal_ht+0x14f30, %rsi
lea addresses_A_ht+0x24b0, %rdi
nop
nop
nop
nop
...
nop
xor $43869, %r8
lea addresses_UC_ht+0x4380, %rbx
lfence
...
nop
lfence
lea addresses_WT_ht+0x178d0, %rsi
...
nop
sub $39577, %r8
lea addresses_normal_ht+0xa058, %rsi
lea addresses_WC_ht+0xeb0, %rdi
nop
nop
nop
nop
...
nop
xor %r15, %r15
lea addresses_WT_ht+0x64b0, %rsi
lea addresses_D_ht+0x3cb0, %rdi
nop
nop
nop
add %rbx, %rbx
...
rep movsq
and %r14, %r14
lea addresses_normal_ht+0x19e10, %rsi
lea addresses_normal_ht+0x14d70, %rdi
sub %r15, %r15
mov $90, %rcx
rep movsw
nop
add %rdi, %rdi
lea addresses_normal_ht+0x1ccb0, %rsi
lea addresses_A_ht+0x24e0, %rdi
nop
and $7332, %r15
mov $49, %rcx
rep movsw
dec %r15
lea addresses_WC_ht+0x1afb0, %r14
nop
nop
nop
nop
...
mov (%r14), %r9
sub %r8, %r8
lea addresses_WT_ht+0x1a4b0, %r15
nop
xor $4786, %rcx
mov (%r15), %r8d
xor %rsi, %rsi
lea addresses_D_ht+0x44b0, %rsi
lea addresses_UC_ht+0x14cb0, %rdi
nop
nop
xor %r15, %r15
mov $107, %rcx
...
nop
dec %r9
lea addresses_UC_ht+0x38b0, %rbx
nop
nop
nop
add %rdi, %rdi
mov (%rbx), %r14w
and %r14, %r14
lea addresses_normal_ht+0x184b0, %rdi
clflush (%rdi)
nop
nop
nop
...
<gen_faulty_load>
[REF]
{'OP': 'LOAD', 'src': {'type': 'addresses_UC', 'size': 1, 'AVXalign': False, 'NT': True, 'congruent': 0, 'same': False}}
...
{'OP': 'REPM', 'src': {'type': 'addresses_normal_ht', 'congruent': 1, 'same': False}, 'dst': {'type': 'addresses_normal_ht', 'congruent': 5, 'same': False}}
