...
nop
cmp %r13, %r13
lea addresses_WC_ht+0x169ff, %r11
nop
nop
nop
nop
...
nop
sub $18269, %r12
lea addresses_UC_ht+0xb0af, %rsi
lea addresses_WT_ht+0x9aff, %rdi
nop
cmp $40509, %r12
mov $93, %rcx
rep movsl
...
nop
and %r8, %r8
lea addresses_A_ht+0x142b7, %r13
nop
nop
nop
nop
...
nop
inc %r12
lea addresses_UC_ht+0x7ad7, %rsi
nop
nop
inc %r13
vmovups (%rsi), %ymm5
...
// Faulty Load
lea addresses_normal+0x187ff, %rsi
nop
cmp %r12, %r12
movb (%rsi), %cl
lea oracles, %r10
...
<gen_prepare_buffer>
{'OP': 'STOR', 'dst': {'same': True, 'type': 'addresses_WC_ht', 'NT': False, 'AVXalign': False, 'size': 16, 'congruent': 10}}
