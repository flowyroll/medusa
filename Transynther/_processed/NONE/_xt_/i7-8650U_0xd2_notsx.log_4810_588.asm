...
push %rdx
push %rsi
lea addresses_WC_ht+0x141ca, %rbp
nop
inc %r8
movb $0x61, (%rbp)
nop
...
nop
sub %r9, %r9
lea addresses_UC_ht+0x11634, %rbp
nop
nop
dec %r8
...
nop
dec %rbp
lea addresses_normal_ht+0x9c74, %rsi
lea addresses_UC_ht+0x1c5c, %rdi
nop
nop
nop
and $39121, %rbp
...
nop
xor $32667, %rcx
lea addresses_normal_ht+0x6874, %rdi
clflush (%rdi)
nop
nop
nop
...
mov (%rdi), %ecx
cmp $27814, %r9
lea addresses_D_ht+0x1df74, %r8
sub $45280, %r9
mov $0x6162636465666768, %r10
movq %r10, (%r8)
dec %rdi
lea addresses_WC_ht+0x14cac, %rdx
nop
nop
nop
nop
...
nop
xor %rsi, %rsi
lea addresses_WC_ht+0xb3ec, %rsi
nop
nop
and $9747, %rdi
movw $0x6162, (%rsi)
...
nop
sub %r8, %r8
lea addresses_normal_ht+0x127cc, %rbp
nop
nop
nop
nop
...
nop
cmp $33776, %rdi
lea addresses_normal_ht+0xec94, %rcx
nop
cmp %rdi, %rdi
...
nop
xor %rdi, %rdi
lea addresses_normal_ht+0x14af4, %rcx
nop
nop
nop
nop
...
nop
inc %rbp
lea addresses_UC_ht+0x13e74, %rcx
inc %rdx
mov $0x6162636465666768, %r10
movq %r10, %xmm7
movups %xmm7, (%rcx)
