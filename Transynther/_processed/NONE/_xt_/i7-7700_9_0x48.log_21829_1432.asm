...
push %rdi
push %rsi
lea addresses_UC_ht+0x16b4d, %rcx
xor $55910, %rax
...
nop
cmp $37001, %r8
lea addresses_A_ht+0x5d24, %rsi
lea addresses_A_ht+0xc267, %rdi
nop
nop
nop
nop
...
// Load
lea addresses_normal+0x10925, %rbp
nop
nop
nop
nop
...
{'OP': 'STOR', 'dst': {'type': 'addresses_UC', 'AVXalign': False, 'congruent': 8, 'size': 32, 'same': False, 'NT': True}}
{'OP': 'LOAD', 'src': {'type': 'addresses_normal', 'AVXalign': True, 'congruent': 10, 'size': 8, 'same': False, 'NT': False}}
