...
nop
and %r13, %r13
lea addresses_A_ht+0x18a29, %rax
add $14732, %r9
mov (%rax), %esi
xor %rsi, %rsi
lea addresses_D_ht+0x9229, %rsi
lea addresses_normal_ht+0x1b629, %rdi
nop
nop
nop
and %r11, %r11
...
nop
inc %rbx
lea addresses_WT_ht+0x11169, %rsi
nop
sub $46687, %r11
mov (%rsi), %r9d
cmp %rdi, %rdi
...
{'src': {'type': 'addresses_D_ht', 'congruent': 8, 'same': False}, 'dst': {'type': 'addresses_normal_ht', 'congruent': 9, 'same': False}, 'OP': 'REPM'}
