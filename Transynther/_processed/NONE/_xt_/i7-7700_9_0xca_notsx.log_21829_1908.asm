...
push %rdi
push %rsi
lea addresses_WT_ht+0x19ba5, %r9
clflush (%r9)
nop
nop
cmp %rax, %rax
...
nop
and $12929, %r9
lea addresses_D_ht+0x86f, %rdi
nop
nop
cmp %rbx, %rbx
movl $0x61626364, (%rdi)
xor $36801, %r9
lea addresses_A_ht+0xaf9, %r15
nop
nop
nop
cmp $2839, %r8
movw $0x6162, (%r15)
add $43792, %r9
lea addresses_D_ht+0x1c0a5, %rbx
nop
nop
nop
add $27432, %r9
...
nop
cmp %r15, %r15
lea addresses_WC_ht+0x13d65, %rdi
inc %rbp
movw $0x6162, (%rdi)
nop
nop
...
nop
and $35375, %rdi
lea addresses_WT_ht+0x1cbfd, %rsi
lea addresses_WC_ht+0x4fc7, %rdi
nop
nop
inc %r8
mov $70, %rcx
...
nop
xor $61992, %rdi
lea addresses_normal_ht+0x67d5, %rbp
and $12427, %r9
movw $0x6162, (%rbp)
nop
nop
...
{'src': {'congruent': 3, 'same': False, 'type': 'addresses_WT_ht'}, 'dst': {'congruent': 1, 'same': False, 'type': 'addresses_WC_ht'}, 'OP': 'REPM'}
