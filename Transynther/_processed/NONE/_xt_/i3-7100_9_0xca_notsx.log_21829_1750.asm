...
mov (%r8), %ebx
cmp $28065, %rbp
lea addresses_WT_ht+0x756d, %rax
nop
nop
add $58512, %rbp
...
vmovups %ymm4, (%r8)
cmp $28198, %r11
lea addresses_WT_ht+0x1484d, %r8
nop
nop
nop
nop
...
nop
sub %r11, %r11
lea addresses_WC_ht+0x1eb79, %rbx
nop
add %rcx, %rcx
mov $0x6162636465666768, %rax
movq %rax, (%rbx)
and $60837, %rax
lea addresses_WC_ht+0x13801, %rbx
nop
sub %r8, %r8
movb (%rbx), %r9b
nop
