...
push %rdx
push %rsi
lea addresses_WC_ht+0x112cb, %rsi
lea addresses_normal_ht+0x7fcf, %rdi
nop
nop
nop
nop
...
nop
inc %rbp
lea addresses_D_ht+0x1cfe2, %rsi
lea addresses_D_ht+0x17165, %rdi
nop
nop
nop
nop
...
rep movsb
sub $55852, %rdx
lea addresses_normal_ht+0x70b, %rcx
nop
nop
nop
nop
...
nop
sub $56577, %rcx
lea addresses_WT_ht+0x1308b, %rdi
sub %rsi, %rsi
...
// Faulty Load
lea addresses_normal+0x1588b, %rdi
nop
nop
cmp %r9, %r9
movups (%rdi), %xmm0
...
<gen_prepare_buffer>
{'OP': 'REPM', 'src': {'type': 'addresses_WC_ht', 'congruent': 6, 'same': False}, 'dst': {'type': 'addresses_normal_ht', 'congruent': 1, 'same': True}}
