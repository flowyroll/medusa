...
push %rdx
push %rsi
lea addresses_normal_ht+0x134bf, %rbp
nop
nop
nop
nop
...
nop
and $30595, %r9
lea addresses_UC_ht+0x3711, %rsi
lea addresses_A_ht+0x11419, %rdi
nop
nop
nop
nop
...
nop
xor $58377, %rdx
lea addresses_A_ht+0x4891, %r9
sub %r11, %r11
movb (%r9), %cl
sub %rdi, %rdi
lea addresses_normal_ht+0xb291, %rdi
sub $49043, %r11
mov (%rdi), %rcx
nop
nop
...
{'OP': 'REPM', 'src': {'type': 'addresses_UC_ht', 'congruent': 7, 'same': True}, 'dst': {'type': 'addresses_A_ht', 'congruent': 1, 'same': False}}
