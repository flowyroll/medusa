...
push %rdx
push %rsi
lea addresses_WC_ht+0x90a1, %rsi
lea addresses_UC_ht+0x15eb9, %rdi
nop
nop
nop
nop
...
rep movsl
and %rdx, %rdx
lea addresses_A_ht+0xcea1, %rsi
lea addresses_normal_ht+0x16ea1, %rdi
nop
sub %rax, %rax
mov $27, %rcx
rep movsq
...
nop
sub %rdi, %rdi
lea addresses_WT_ht+0x1c261, %rdx
nop
nop
cmp %rcx, %rcx
mov (%rdx), %rax
nop
sub %rax, %rax
lea addresses_D_ht+0x1e29, %rdi
nop
add $44951, %r13
mov $0x6162636465666768, %rsi
movq %rsi, (%rdi)
sub %rdx, %rdx
lea addresses_D_ht+0x16a1, %r13
nop
nop
nop
nop
...
<gen_prepare_buffer>
{'src': {'type': 'addresses_WC_ht', 'congruent': 7, 'same': False}, 'dst': {'type': 'addresses_UC_ht', 'congruent': 3, 'same': True}, 'OP': 'REPM'}
{'src': {'type': 'addresses_A_ht', 'congruent': 11, 'same': False}, 'dst': {'type': 'addresses_normal_ht', 'congruent': 11, 'same': False}, 'OP': 'REPM'}
