...
push %rdi
push %rsi
lea addresses_WC_ht+0xba65, %rsi
lea addresses_WT_ht+0x18f25, %rdi
clflush (%rdi)
nop
add $8589, %rbx
mov $89, %rcx
...
nop
xor $23644, %r8
lea addresses_normal_ht+0x3c61, %rbp
nop
nop
nop
cmp %r10, %r10
...
nop
inc %r8
lea addresses_WC_ht+0x2225, %rsi
lea addresses_normal_ht+0x1769d, %rdi
dec %r9
mov $124, %rcx
rep movsl
nop
...
nop
add $42158, %rbx
lea addresses_normal_ht+0x2925, %rsi
lea addresses_UC_ht+0x8c95, %rdi
nop
nop
nop
nop
...
nop
add $62288, %rsi
lea addresses_D_ht+0xcb85, %rsi
lea addresses_WC_ht+0xeca5, %rdi
nop
nop
nop
nop
...
nop
and %rbx, %rbx
lea addresses_normal_ht+0x1e1f1, %rsi
nop
add $26255, %r9
movups (%rsi), %xmm3
vpextrq $1, %xmm3, %r10
...
nop
cmp $61128, %r8
lea addresses_WT_ht+0xa4e5, %r10
inc %rdi
...
nop
and %rcx, %rcx
lea addresses_D_ht+0xe6e4, %rsi
lea addresses_normal_ht+0x54d1, %rdi
nop
nop
nop
cmp %rbx, %rbx
...
nop
inc %rdi
lea addresses_D_ht+0x17e25, %rbx
nop
inc %r8
mov (%rbx), %r9d
nop
...
nop
add $18969, %r9
lea addresses_UC_ht+0x1ba25, %rsi
...
nop
inc %r10
lea addresses_WC_ht+0x19c3d, %rsi
lea addresses_D_ht+0x85c5, %rdi
clflush (%rsi)
nop
nop
nop
...
nop
sub $34812, %rsi
lea addresses_UC_ht+0x1b625, %rcx
nop
sub $59566, %r10
...
nop
sub $32324, %rbp
lea addresses_UC_ht+0x4ac5, %rdi
and %rsi, %rsi
movl $0x61626364, (%rdi)
cmp $29116, %rcx
pop %rsi
...
{'OP': 'LOAD', 'src': {'type': 'addresses_D_ht', 'size': 4, 'AVXalign': False, 'NT': False, 'congruent': 11, 'same': True}}
{'OP': 'REPM', 'src': {'type': 'addresses_UC_ht', 'congruent': 5, 'same': False}, 'dst': {'type': 'addresses_normal_ht', 'congruent': 9, 'same': True}}
