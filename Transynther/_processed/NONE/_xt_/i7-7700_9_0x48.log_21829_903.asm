...
nop
and $62021, %r14
lea addresses_normal_ht+0x6363, %rsi
lea addresses_WC_ht+0xb5fb, %rdi
nop
nop
nop
nop
...
lea addresses_WT_ht+0x1104b, %rdi
dec %rbx
mov $72, %rcx
rep movsl
nop
...
nop
xor $4502, %rbx
lea addresses_WT_ht+0xd863, %rsi
lea addresses_D_ht+0xf763, %rdi
clflush (%rsi)
nop
nop
nop
...
nop
cmp %rcx, %rcx
lea addresses_UC_ht+0x9f3, %rsi
lea addresses_normal_ht+0xd763, %rdi
nop
nop
nop
nop
...
rep movsw
add $23129, %rsi
lea addresses_normal_ht+0x9e63, %rsi
lea addresses_A_ht+0x1d033, %rdi
nop
nop
and $21624, %r10
mov $30, %rcx
...
nop
and $43981, %rdi
lea addresses_WT_ht+0x101ed, %rsi
nop
nop
nop
sub $25900, %r14
...
nop
and %r14, %r14
lea addresses_WT_ht+0x9f63, %rsi
lea addresses_D_ht+0x963, %rdi
nop
dec %r8
mov $108, %rcx
rep movsl
nop
xor %rsi, %rsi
lea addresses_normal_ht+0x7563, %rsi
nop
sub %rbx, %rbx
...
{'OP': 'REPM', 'src': {'type': 'addresses_UC_ht', 'congruent': 4, 'same': True}, 'dst': {'type': 'addresses_normal_ht', 'congruent': 7, 'same': False}}
{'OP': 'REPM', 'src': {'type': 'addresses_normal_ht', 'congruent': 2, 'same': False}, 'dst': {'type': 'addresses_A_ht', 'congruent': 2, 'same': True}}
