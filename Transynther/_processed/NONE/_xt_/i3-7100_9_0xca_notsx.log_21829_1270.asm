...
lea addresses_WT_ht+0x4b4d, %rdi
nop
dec %rbx
mov $118, %rcx
rep movsl
...
nop
xor %r10, %r10
lea addresses_WC_ht+0x12b4d, %rsi
lea addresses_D_ht+0x1954d, %rdi
clflush (%rdi)
nop
nop
and %rdx, %rdx
...
nop
sub $2645, %rsi
lea addresses_normal_ht+0x214d, %rcx
nop
nop
nop
add $26200, %r8
