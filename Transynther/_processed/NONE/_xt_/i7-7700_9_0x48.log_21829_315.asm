...
push %rdi
push %rsi
lea addresses_D_ht+0x1b68e, %r13
nop
nop
nop
nop
...
nop
xor %r15, %r15
lea addresses_UC_ht+0x1d5fe, %rbx
cmp %rsi, %rsi
mov (%rbx), %r8w
nop
cmp $29028, %r8
lea addresses_WT_ht+0x15f8e, %r15
nop
nop
nop
nop
...
nop
inc %rax
lea addresses_WT_ht+0x148e, %rsi
lea addresses_A_ht+0x968e, %rdi
nop
nop
xor %rbx, %rbx
mov $124, %rcx
...
nop
add %r11, %r11
lea addresses_WC_ht+0x1a29e, %rdi
nop
xor $20678, %rbx
movups (%rdi), %xmm3
vpextrq $1, %xmm3, %r15
nop
add %r11, %r11
lea addresses_A_ht+0x1530e, %rsi
nop
nop
dec %rax
vmovups (%rsi), %ymm0
...
nop
sub %rax, %rax
lea addresses_A_ht+0x968e, %r8
nop
sub %rax, %rax
mov (%r8), %rdi
cmp $19893, %rbx
lea addresses_WC_ht+0x8a4e, %rbx
nop
nop
nop
nop
...
nop
inc %rsi
lea addresses_A_ht+0x450e, %r15
nop
and %r11, %r11
mov $0x6162636465666768, %rcx
movq %rcx, (%r15)
cmp $61780, %r11
lea addresses_D_ht+0x7e8e, %rcx
nop
nop
nop
nop
...
// Faulty Load
lea addresses_normal+0x1ce8e, %rbp
and $22573, %rsi
vmovups (%rbp), %ymm7
...
{'OP': 'STOR', 'dst': {'type': 'addresses_WT_ht', 'AVXalign': False, 'congruent': 8, 'size': 16, 'same': True, 'NT': True}}
...
{'OP': 'REPM', 'src': {'type': 'addresses_WT_ht', 'congruent': 6, 'same': False}, 'dst': {'type': 'addresses_A_ht', 'congruent': 9, 'same': False}}
