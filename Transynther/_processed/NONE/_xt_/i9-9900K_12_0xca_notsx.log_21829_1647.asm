...
nop
dec %rbp
lea addresses_normal_ht+0xdebc, %r14
nop
sub %rdx, %rdx
mov $0x6162636465666768, %rsi
movq %rsi, %xmm0
...
nop
sub $47700, %rdx
lea addresses_normal_ht+0x1df3c, %rsi
inc %rbp
...
nop
inc %rcx
lea addresses_A_ht+0x19b34, %r14
nop
nop
sub $14333, %rdi
movl $0x61626364, (%r14)
nop
xor %rdx, %rdx
lea addresses_WC_ht+0x1bdbc, %rdx
nop
nop
nop
nop
...
nop
xor %rdx, %rdx
lea addresses_WT_ht+0x9dbc, %r14
xor %r12, %r12
mov $0x6162636465666768, %rdx
movq %rdx, %xmm0
vmovups %ymm0, (%r14)
...
{'OP': 'STOR', 'dst': {'same': True, 'type': 'addresses_D_ht', 'NT': False, 'AVXalign': True, 'size': 16, 'congruent': 7}}
{'OP': 'STOR', 'dst': {'same': True, 'type': 'addresses_normal_ht', 'NT': False, 'AVXalign': True, 'size': 16, 'congruent': 8}}
