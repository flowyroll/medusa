...
push %rdx
push %rsi
lea addresses_UC_ht+0x1776c, %rsi
lea addresses_WT_ht+0x1a248, %rdi
nop
xor %r13, %r13
mov $39, %rcx
rep movsl
...
nop
inc %rax
lea addresses_WC_ht+0xf78c, %rsi
nop
nop
nop
nop
...
vmovups %ymm2, (%rsi)
xor %rdi, %rdi
lea addresses_normal_ht+0x276c, %r13
nop
nop
nop
nop
...
nop
xor %r13, %r13
lea addresses_A_ht+0x1caec, %rax
nop
nop
nop
cmp $8482, %rdx
...
nop
inc %rcx
lea addresses_A_ht+0x1552c, %rdx
nop
nop
nop
nop
...
nop
cmp $26104, %rdx
lea addresses_A_ht+0x105ec, %rdi
nop
nop
inc %rax
mov (%rdi), %r13
...
nop
xor %rcx, %rcx
lea addresses_WC_ht+0x4aec, %rsi
nop
nop
nop
nop
...
nop
add %rdi, %rdi
lea addresses_WT_ht+0x11891, %rsi
lea addresses_normal_ht+0xeafc, %rdi
nop
nop
nop
and %r14, %r14
...
vpextrq $1, %xmm2, %rcx
xor %r12, %r12
lea addresses_WC_ht+0x165ec, %rdx
nop
nop
inc %rax
mov (%rdx), %r12w
sub %rdx, %rdx
lea addresses_UC_ht+0x13fec, %rsi
lea addresses_UC_ht+0xf1c, %rdi
nop
nop
and $62221, %r12
mov $98, %rcx
...
lea addresses_WT_ht+0x182ec, %rdi
nop
nop
xor $24344, %r14
mov $17, %rcx
...
<gen_prepare_buffer>
{'dst': {'same': False, 'congruent': 0, 'type': 'addresses_WT_ht'}, 'OP': 'REPM', 'src': {'same': False, 'congruent': 7, 'type': 'addresses_UC_ht'}}
...
{'OP': 'LOAD', 'src': {'same': False, 'NT': True, 'AVXalign': True, 'size': 8, 'type': 'addresses_A_ht', 'congruent': 4}}
{'OP': 'LOAD', 'src': {'same': False, 'NT': False, 'AVXalign': True, 'size': 8, 'type': 'addresses_A_ht', 'congruent': 11}}
{'OP': 'LOAD', 'src': {'same': False, 'NT': False, 'AVXalign': False, 'size': 32, 'type': 'addresses_WC_ht', 'congruent': 10}}
{'dst': {'same': True, 'congruent': 3, 'type': 'addresses_normal_ht'}, 'OP': 'REPM', 'src': {'same': True, 'congruent': 0, 'type': 'addresses_WT_ht'}}
...
{'dst': {'same': False, 'congruent': 3, 'type': 'addresses_UC_ht'}, 'OP': 'REPM', 'src': {'same': False, 'congruent': 8, 'type': 'addresses_UC_ht'}}
