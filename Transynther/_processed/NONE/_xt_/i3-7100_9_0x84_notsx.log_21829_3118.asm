...
push %rdx
push %rsi
lea addresses_A_ht+0x18d1a, %r13
clflush (%r13)
nop
nop
nop
...
nop
xor $9566, %r10
lea addresses_WT_ht+0x1d01a, %rsi
lea addresses_WT_ht+0x4e9a, %rdi
nop
nop
sub $34645, %r14
mov $96, %rcx
...
nop
and $48547, %rdi
lea addresses_WC_ht+0x14dba, %r13
nop
nop
nop
nop
...
nop
and %rdx, %rdx
lea addresses_normal_ht+0xde85, %rcx
nop
and $50019, %r8
mov (%rcx), %edx
nop
inc %r13
lea addresses_WT_ht+0x1d29a, %rcx
nop
nop
nop
nop
...
{'src': {'type': 'addresses_normal_ht', 'same': True, 'size': 4, 'congruent': 0, 'NT': True, 'AVXalign': False}, 'OP': 'LOAD'}
