...
push %rdi
push %rsi
lea addresses_normal_ht+0x26b3, %rsi
lea addresses_WT_ht+0xa38f, %rdi
clflush (%rsi)
clflush (%rdi)
nop
nop
...
nop
xor %rbp, %rbp
lea addresses_UC_ht+0x1144f, %rsi
nop
nop
nop
nop
...
movups %xmm7, (%rsi)
add $52089, %rax
lea addresses_WT_ht+0x1a037, %rbx
nop
nop
nop
cmp %rax, %rax
...
nop
cmp %rbp, %rbp
lea addresses_normal_ht+0x1838f, %rbp
clflush (%rbp)
nop
nop
sub %r13, %r13
...
nop
cmp $14780, %rax
lea addresses_normal_ht+0x15b4f, %rsi
nop
nop
xor %rbp, %rbp
...
vmovups %ymm2, (%rsi)
xor %rdi, %rdi
lea addresses_WC_ht+0x17851, %rdi
nop
nop
nop
xor $1597, %rsi
...
nop
xor %rcx, %rcx
lea addresses_normal_ht+0x1855b, %rdi
nop
nop
nop
and $12708, %rbx
...
nop
inc %rdi
lea addresses_normal_ht+0x1074f, %rdi
nop
nop
nop
nop
...
nop
cmp $15047, %rcx
lea addresses_WT_ht+0x2e0f, %rdi
add %rbp, %rbp
movb $0x61, (%rdi)
cmp $22913, %rdi
lea addresses_D_ht+0x13179, %r13
nop
nop
nop
nop
...
{'src': {'type': 'addresses_WC', 'AVXalign': False, 'size': 32, 'NT': False, 'same': False, 'congruent': 6}, 'OP': 'LOAD'}
