...
push %rdx
push %rsi
lea addresses_A_ht+0x151ec, %rbp
nop
nop
nop
nop
...
nop
add $63573, %r12
lea addresses_UC_ht+0x77c2, %r12
nop
nop
nop
nop
...
nop
and $20934, %rbp
lea addresses_A_ht+0x18b3c, %rsi
nop
mfence
movw $0x6162, (%rsi)
sub %r13, %r13
lea addresses_D_ht+0x72cc, %r8
nop
xor $8715, %rdx
...
nop
dec %rdx
lea addresses_WT_ht+0x40f4, %rsi
lea addresses_normal_ht+0xc4d8, %rdi
xor %r8, %r8
mov $78, %rcx
rep movsw
nop
...
nop
mfence
lea addresses_UC_ht+0x373c, %rsi
nop
nop
nop
nop
...
nop
cmp %r13, %r13
lea addresses_A_ht+0x1373c, %rsi
lea addresses_WC_ht+0x18be4, %rdi
clflush (%rdi)
nop
nop
nop
...
nop
dec %r13
lea addresses_UC_ht+0x6a3c, %rbp
nop
add %rdi, %rdi
mov (%rbp), %r13
nop
...
nop
add $53790, %r8
lea addresses_WC_ht+0xc9bc, %rdi
nop
nop
and $16474, %r14
movl $0x61626364, (%rdi)
...
nop
dec %rdx
lea addresses_normal_ht+0x1193c, %rsi
nop
sub $64428, %rdx
mov $0x6162636465666768, %rdi
movq %rdi, %xmm6
...
// Store
lea addresses_normal+0x3b3c, %r12
nop
nop
nop
add $46030, %r9
...
<gen_prepare_buffer>
{'OP': 'STOR', 'dst': {'type': 'addresses_A_ht', 'size': 4, 'AVXalign': True, 'NT': False, 'congruent': 3, 'same': False}}
...
{'OP': 'REPM', 'src': {'type': 'addresses_WT_ht', 'congruent': 3, 'same': False}, 'dst': {'type': 'addresses_normal_ht', 'congruent': 1, 'same': False}}
