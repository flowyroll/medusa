...
push %rdi
push %rsi
lea addresses_WT_ht+0xcec2, %rsi
lea addresses_WC_ht+0x1aa82, %rdi
nop
nop
nop
nop
...
rep movsq
xor %r11, %r11
lea addresses_D_ht+0x11cc2, %rbp
nop
nop
nop
add %rcx, %rcx
...
nop
sub %rdi, %rdi
lea addresses_normal_ht+0x1595a, %rdi
nop
nop
dec %r14
...
nop
inc %r14
lea addresses_WT_ht+0x111a2, %rsi
clflush (%rsi)
cmp $22534, %r11
...
{'OP': 'STOR', 'dst': {'congruent': 2, 'AVXalign': False, 'same': False, 'size': 16, 'NT': True, 'type': 'addresses_UC'}}
{'src': {'congruent': 3, 'AVXalign': False, 'same': False, 'size': 1, 'NT': False, 'type': 'addresses_RW'}, 'OP': 'LOAD'}
