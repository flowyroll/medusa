...
push %rdx
push %rsi
lea addresses_normal_ht+0x1a335, %rsi
lea addresses_UC_ht+0xa9b5, %rdi
nop
cmp $4449, %r14
mov $51, %rcx
rep movsl
...
nop
and $2283, %r13
lea addresses_A_ht+0x15e0d, %rax
nop
nop
nop
nop
...
nop
dec %rsi
lea addresses_normal_ht+0x15dc5, %rax
nop
nop
nop
sub %r14, %r14
...
nop
sub %r14, %r14
lea addresses_A_ht+0x191b5, %r14
cmp %r15, %r15
...
vpextrq $1, %xmm0, %rsi
cmp %rdi, %rdi
lea addresses_A_ht+0x15c35, %rsi
lea addresses_UC_ht+0x1ab25, %rdi
nop
nop
nop
nop
...
nop
inc %rdi
lea addresses_WC_ht+0x1ce35, %rcx
nop
nop
nop
and %rax, %rax
...
nop
and $62085, %rdi
lea addresses_normal_ht+0x9c75, %rsi
lea addresses_A_ht+0x1bf5f, %rdi
nop
add %r14, %r14
mov $44, %rcx
rep movsq
...
nop
and $38692, %rsi
lea addresses_A_ht+0x12435, %rsi
lea addresses_WT_ht+0x13835, %rdi
nop
nop
nop
dec %r13
...
rep movsl
and %rax, %rax
lea addresses_WT_ht+0x17235, %r14
nop
nop
nop
nop
...
nop
dec %rdx
lea addresses_normal_ht+0x1b475, %r15
nop
nop
nop
nop
...
nop
add $20163, %r13
lea addresses_D_ht+0x1a435, %r15
nop
dec %rcx
mov (%r15), %r13
nop
nop
add %rdi, %rdi
lea addresses_A_ht+0x13c35, %rsi
lea addresses_UC_ht+0x1e435, %rdi
clflush (%rdi)
cmp $58202, %rdx
mov $27, %rcx
rep movsl
...
nop
and %r13, %r13
lea addresses_WT_ht+0x1af35, %r14
nop
cmp %rax, %rax
mov (%r14), %r15d
nop
cmp $63378, %rcx
lea addresses_A_ht+0x18d4d, %rsi
lea addresses_WC_ht+0x1a835, %rdi
and $52455, %r14
mov $19, %rcx
rep movsw
nop
