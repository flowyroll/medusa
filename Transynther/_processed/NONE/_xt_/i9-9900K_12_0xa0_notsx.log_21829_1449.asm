...
push %rdi
push %rsi
lea addresses_WC_ht+0x1e297, %r11
nop
sub $2362, %rbp
mov (%r11), %r9d
nop
xor $58454, %rsi
lea addresses_D_ht+0x10bd3, %rsi
lea addresses_WT_ht+0x1820b, %rdi
clflush (%rdi)
nop
nop
nop
...
nop
sub $2193, %rbp
lea addresses_A_ht+0x5317, %rsi
lea addresses_WC_ht+0x14697, %rdi
dec %r15
mov $1, %rcx
rep movsq
nop
...
lea addresses_UC_ht+0x1de17, %rdi
nop
nop
nop
nop
...
nop
and $1132, %r9
lea addresses_D_ht+0xb6bf, %rsi
lea addresses_WC_ht+0x4697, %rdi
nop
nop
nop
sub $43404, %r15
...
nop
cmp $57251, %rdi
lea addresses_A_ht+0x16897, %r14
nop
nop
nop
nop
