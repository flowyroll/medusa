...
push %rdx
push %rsi
lea addresses_WC_ht+0x1c203, %rbx
nop
nop
nop
nop
...
nop
add $2085, %rbx
lea addresses_WT_ht+0x4bab, %rsi
lea addresses_D_ht+0x1c86b, %rdi
dec %rdx
mov $41, %rcx
rep movsb
nop
...
nop
inc %rbx
lea addresses_A_ht+0x1e70b, %r13
nop
sub %rdi, %rdi
movb $0x61, (%r13)
nop
...
nop
dec %rcx
lea addresses_WC_ht+0x1a3cb, %r13
nop
cmp $63303, %rcx
movb $0x61, (%r13)
cmp $60477, %r13
lea addresses_UC_ht+0xd85b, %rbx
nop
nop
nop
add %r13, %r13
...
nop
and $18507, %r9
lea addresses_UC_ht+0x199ab, %r9
nop
dec %rcx
movl $0x61626364, (%r9)
xor $1929, %r8
lea addresses_normal_ht+0x1e063, %r13
clflush (%r13)
nop
nop
and %r8, %r8
...
vpextrq $0, %xmm5, %r9
and $49727, %r9
lea addresses_WC_ht+0x110ab, %rbx
nop
cmp $33827, %rcx
movl $0x61626364, (%rbx)
nop
...
nop
add %r13, %r13
lea addresses_WC_ht+0x1b3c2, %rdx
nop
nop
sub $63111, %r8
...
{'dst': {'type': 'addresses_WC_ht', 'same': False, 'size': 4, 'congruent': 9, 'NT': True, 'AVXalign': False}, 'OP': 'STOR'}
{'dst': {'type': 'addresses_WC_ht', 'same': False, 'size': 8, 'congruent': 0, 'NT': False, 'AVXalign': True}, 'OP': 'STOR'}
{'32': 21829}
