...
nop
add %rdi, %rdi
lea addresses_A_ht+0x19664, %rcx
nop
nop
nop
nop
...
movups %xmm5, (%rcx)
sub $54001, %r10
lea addresses_UC_ht+0xcbac, %r12
nop
nop
nop
nop
...
nop
and %rdi, %rdi
lea addresses_A_ht+0x1e174, %r10
nop
nop
nop
nop
...
nop
xor $54822, %r12
lea addresses_A_ht+0xec74, %rsi
lea addresses_A_ht+0xce34, %rdi
nop
nop
nop
nop
...
nop
inc %r10
lea addresses_UC_ht+0x6174, %rsi
lea addresses_UC_ht+0xc954, %rdi
nop
nop
nop
xor %rdx, %rdx
...
{'dst': {'NT': False, 'AVXalign': True, 'size': 8, 'congruent': 11, 'same': False, 'type': 'addresses_A_ht'}, 'OP': 'STOR'}
