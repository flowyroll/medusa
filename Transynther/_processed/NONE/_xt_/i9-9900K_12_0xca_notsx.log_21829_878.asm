...
nop
add %r9, %r9
lea addresses_D_ht+0x118ed, %rsi
lea addresses_UC_ht+0xbc1d, %rdi
nop
nop
nop
sub %r11, %r11
...
nop
cmp %r13, %r13
lea addresses_normal_ht+0x1835d, %rcx
clflush (%rcx)
nop
nop
and $24540, %rdi
...
nop
dec %rdi
lea addresses_WC_ht+0x14f5d, %r13
nop
sub %r8, %r8
mov (%r13), %r11
nop
cmp %rcx, %rcx
lea addresses_D_ht+0xef5d, %r11
nop
add $33410, %r13
movb $0x61, (%r11)
nop
cmp $41570, %r8
lea addresses_WT_ht+0x1975d, %rsi
lea addresses_A_ht+0x193d, %rdi
clflush (%rsi)
add %r11, %r11
mov $71, %rcx
rep movsl
...
nop
sub %r15, %r15
lea addresses_WT_ht+0x1075d, %r15
nop
inc %rdi
...
nop
cmp %r15, %r15
lea addresses_A_ht+0x16919, %rsi
lea addresses_D_ht+0x1f8d, %rdi
add $40317, %r8
mov $96, %rcx
rep movsw
nop
...
movw $0x6162, (%rsi)
cmp %r11, %r11
lea addresses_WT_ht+0x1b75d, %rdi
nop
nop
nop
nop
...
lea addresses_normal_ht+0x7f9d, %rdi
nop
add $50735, %r8
mov $62, %rcx
rep movsb
and $51381, %r9
lea addresses_WT_ht+0x1035d, %r13
nop
nop
xor %r11, %r11
movb (%r13), %r9b
...
{'OP': 'REPM', 'src': {'same': False, 'congruent': 4, 'type': 'addresses_D_ht'}, 'dst': {'same': False, 'congruent': 5, 'type': 'addresses_UC_ht'}}
...
{'OP': 'REPM', 'src': {'same': False, 'congruent': 0, 'type': 'addresses_WC_ht'}, 'dst': {'same': False, 'congruent': 6, 'type': 'addresses_normal_ht'}}
