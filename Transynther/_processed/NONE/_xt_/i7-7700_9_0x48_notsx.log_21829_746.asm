...
push %rdx
push %rsi
lea addresses_UC_ht+0x1d949, %rsi
lea addresses_A_ht+0x17af, %rdi
nop
inc %r9
mov $102, %rcx
rep movsq
...
nop
xor %r14, %r14
lea addresses_A_ht+0x15449, %rdx
nop
nop
nop
dec %r14
...
nop
sub %rdi, %rdi
lea addresses_WT_ht+0x7d81, %rdx
clflush (%rdx)
nop
nop
nop
...
nop
cmp %rdx, %rdx
lea addresses_normal_ht+0x191c9, %r9
nop
nop
inc %rdx
...
nop
add %rsi, %rsi
lea addresses_A_ht+0x174c1, %rsi
nop
nop
nop
dec %r14
...
nop
and $34988, %rcx
lea addresses_WT_ht+0x19ed9, %rsi
lea addresses_normal_ht+0x1aa09, %rdi
nop
nop
xor $35200, %r10
mov $97, %rcx
...
nop
cmp %rax, %rax
lea addresses_UC_ht+0x1c49, %rsi
lea addresses_normal_ht+0x2729, %rdi
nop
nop
cmp %r14, %r14
mov $76, %rcx
...
<gen_prepare_buffer>
{'dst': {'same': True, 'congruent': 1, 'type': 'addresses_A_ht'}, 'OP': 'REPM', 'src': {'same': False, 'congruent': 8, 'type': 'addresses_UC_ht'}}
...
{'dst': {'same': False, 'congruent': 3, 'type': 'addresses_normal_ht'}, 'OP': 'REPM', 'src': {'same': False, 'congruent': 11, 'type': 'addresses_UC_ht'}}
{'33': 21829}
