...
movw $0x6162, (%rcx)
add %rcx, %rcx
lea addresses_WC_ht+0x18066, %rax
inc %rcx
vmovups (%rax), %ymm0
...
nop
xor %rdx, %rdx
lea addresses_WT_ht+0x10706, %r9
nop
nop
nop
nop
...
nop
add %r10, %r10
lea addresses_WT_ht+0x1ec0c, %rbp
cmp $31432, %r15
movb $0x61, (%rbp)
nop
nop
...
{'OP': 'STOR', 'dst': {'congruent': 3, 'AVXalign': True, 'same': False, 'size': 2, 'NT': False, 'type': 'addresses_A_ht'}}
