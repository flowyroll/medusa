...
nop
add $26813, %rdi
lea addresses_normal_ht+0xa514, %rsi
lea addresses_UC_ht+0x13d14, %rdi
nop
nop
nop
xor %r11, %r11
...
lea addresses_D_ht+0x1e7d4, %rdi
nop
nop
nop
nop
...
// Load
lea addresses_normal+0x17e14, %rbp
nop
cmp %r14, %r14
mov (%rbp), %rdx
inc %rdx
...
// Store
lea addresses_normal+0xe214, %rax
nop
nop
cmp %r13, %r13
...
{'OP': 'REPM', 'src': {'type': 'addresses_normal_ht', 'congruent': 8, 'same': True}, 'dst': {'type': 'addresses_UC_ht', 'congruent': 8, 'same': False}}
{'OP': 'REPM', 'src': {'type': 'addresses_UC_ht', 'congruent': 4, 'same': False}, 'dst': {'type': 'addresses_D_ht', 'congruent': 5, 'same': False}}
