...
nop
add $29031, %rcx
lea addresses_D_ht+0xe82, %rsi
lea addresses_WC_ht+0x4a02, %rdi
nop
nop
nop
xor $63687, %r12
...
nop
add %rax, %rax
lea addresses_UC_ht+0x1db52, %rsi
lea addresses_D_ht+0x3382, %rdi
nop
nop
dec %rax
mov $70, %rcx
...
nop
inc %r11
lea addresses_D_ht+0x10e32, %rsi
lea addresses_WC_ht+0x8532, %rdi
clflush (%rsi)
nop
nop
nop
...
nop
and %rdx, %rdx
lea addresses_WT_ht+0xf242, %r13
nop
nop
nop
xor $49786, %rdi
...
// Faulty Load
lea addresses_normal+0x1e782, %rcx
nop
nop
nop
nop
...
<gen_prepare_buffer>
{'src': {'type': 'addresses_D_ht', 'congruent': 10, 'same': False}, 'dst': {'type': 'addresses_D_ht', 'congruent': 2, 'same': False}, 'OP': 'REPM'}
