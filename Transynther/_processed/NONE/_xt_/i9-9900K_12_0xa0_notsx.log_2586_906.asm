...
nop
and %r10, %r10
lea addresses_normal_ht+0x11c41, %r14
inc %rdi
movb (%r14), %bl
add %rdi, %rdi
lea addresses_A_ht+0x117d1, %r9
sub %rdx, %rdx
movups (%r9), %xmm1
vpextrq $0, %xmm1, %rbx
nop
...
nop
inc %r9
lea addresses_WC_ht+0x6041, %rsi
lea addresses_normal_ht+0xe741, %rdi
nop
dec %rbx
mov $86, %rcx
rep movsq
...
nop
xor $26697, %rcx
lea addresses_WC_ht+0x18341, %rsi
lea addresses_WT_ht+0x15370, %rdi
clflush (%rsi)
nop
nop
cmp $63984, %r9
...
nop
and $41708, %rcx
lea addresses_D_ht+0x10041, %rsi
lea addresses_D_ht+0x9839, %rdi
nop
nop
nop
nop
...
nop
dec %r10
lea addresses_WT_ht+0x7719, %rbx
nop
nop
nop
nop
...
nop
and %r9, %r9
lea addresses_WT_ht+0x9751, %rsi
lea addresses_D_ht+0xc661, %rdi
nop
nop
nop
xor %rdx, %rdx
...
rep movsq
sub %r9, %r9
lea addresses_A_ht+0x1a441, %rcx
nop
nop
nop
xor %r14, %r14
...
nop
inc %rbx
lea addresses_WT_ht+0x6a81, %rsi
...
nop
add $57352, %r10
lea addresses_UC_ht+0x1e35b, %rsi
lea addresses_WC_ht+0x6401, %rdi
clflush (%rsi)
nop
nop
nop
...
rep movsw
add %rdi, %rdi
lea addresses_UC_ht+0x4572, %rdx
clflush (%rdx)
nop
nop
nop
...
nop
cmp %rsi, %rsi
lea addresses_UC_ht+0x1ee41, %r9
nop
nop
nop
xor $17765, %rbx
...
nop
cmp %rbx, %rbx
lea addresses_WC_ht+0x10441, %rsi
nop
nop
nop
nop
...
{'src': {'type': 'addresses_WC_ht', 'congruent': 8, 'same': False}, 'OP': 'REPM', 'dst': {'type': 'addresses_WT_ht', 'congruent': 0, 'same': False}}
{'src': {'type': 'addresses_D_ht', 'congruent': 6, 'same': False}, 'OP': 'REPM', 'dst': {'type': 'addresses_D_ht', 'congruent': 0, 'same': True}}
...
{'src': {'type': 'addresses_WT_ht', 'congruent': 6, 'same': True}, 'OP': 'REPM', 'dst': {'type': 'addresses_WC_ht', 'congruent': 9, 'same': True}}
{'src': {'type': 'addresses_UC_ht', 'congruent': 0, 'same': False}, 'OP': 'REPM', 'dst': {'type': 'addresses_WC_ht', 'congruent': 6, 'same': False}}
