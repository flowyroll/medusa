...
nop
dec %r13
lea addresses_WC_ht+0x146be, %r13
nop
nop
nop
nop
...
lea addresses_WT_ht+0x15768, %rdi
nop
nop
dec %r11
mov $63, %rcx
...
nop
xor %r14, %r14
lea addresses_UC_ht+0x4666, %r13
clflush (%r13)
nop
nop
sub $21873, %r15
...
nop
sub %r10, %r10
lea addresses_WT_ht+0x5ea6, %r15
nop
nop
nop
nop
...
nop
dec %rsi
lea addresses_UC_ht+0x3d16, %r15
add $64665, %rcx
...
// Faulty Load
lea addresses_normal+0x5666, %r11
and %rsi, %rsi
mov (%r11), %di
lea oracles, %rsi
and $0xff, %rdi
...
{'OP': 'REPM', 'src': {'type': 'addresses_A_ht', 'congruent': 10, 'same': True}, 'dst': {'type': 'addresses_WT_ht', 'congruent': 1, 'same': False}}
