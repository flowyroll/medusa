...
push %rdx
push %rsi
lea addresses_A_ht+0x1813b, %r14
add $4463, %rdx
mov (%r14), %r8
nop
nop
...
nop
sub $41177, %rax
lea addresses_WT_ht+0xe5f4, %rsi
lea addresses_WT_ht+0x19460, %rdi
nop
nop
add %r13, %r13
mov $46, %rcx
...
nop
cmp %r14, %r14
lea addresses_WC_ht+0xd6c8, %rax
nop
nop
nop
nop
...
{'OP': 'LOAD', 'src': {'type': 'addresses_D_ht', 'size': 16, 'AVXalign': False, 'NT': True, 'congruent': 4, 'same': False}}
{'37': 14096}
