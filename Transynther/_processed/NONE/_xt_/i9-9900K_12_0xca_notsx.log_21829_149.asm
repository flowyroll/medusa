...
push %rdi
push %rsi
lea addresses_WC_ht+0x31a7, %r11
nop
nop
nop
nop
...
nop
xor $26986, %r12
lea addresses_UC_ht+0xed27, %r10
nop
and $61075, %r14
mov (%r10), %di
nop
...
nop
sub $6796, %rbx
lea addresses_UC_ht+0x4107, %r10
nop
nop
nop
nop
...
nop
add $55571, %rbx
lea addresses_normal_ht+0x158a7, %rsi
