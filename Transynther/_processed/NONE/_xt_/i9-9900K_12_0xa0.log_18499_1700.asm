...
push %rdi
push %rsi
lea addresses_D_ht+0x11d88, %rdi
nop
nop
nop
nop
...
nop
inc %r14
lea addresses_UC_ht+0x7180, %rsi
lea addresses_normal_ht+0x11980, %rdi
nop
sub $20111, %r9
mov $94, %rcx
rep movsl
...
nop
sub %rdi, %rdi
lea addresses_WC_ht+0x18370, %rsi
lea addresses_WT_ht+0x1e7e0, %rdi
nop
nop
nop
nop
...
{'src': {'same': False, 'congruent': 4, 'type': 'addresses_WC_ht'}, 'OP': 'REPM', 'dst': {'same': True, 'congruent': 7, 'type': 'addresses_WT_ht'}}
{'32': 18499}
