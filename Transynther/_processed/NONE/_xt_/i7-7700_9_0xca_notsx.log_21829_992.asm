...
nop
and $37992, %r13
lea addresses_D_ht+0xb0e7, %rsi
lea addresses_UC_ht+0x1a5a7, %rdi
clflush (%rdi)
nop
nop
nop
...
nop
dec %r14
lea addresses_D_ht+0x11933, %rsi
...
nop
xor %r13, %r13
lea addresses_normal_ht+0x5efb, %rdi
nop
nop
nop
nop
...
lea addresses_UC_ht+0xb967, %rdi
clflush (%rsi)
nop
dec %r9
mov $37, %rcx
...
nop
add $58673, %r14
lea addresses_D_ht+0xabb3, %rsi
lea addresses_WT_ht+0x1b9a7, %rdi
sub %r13, %r13
mov $23, %rcx
rep movsq
nop
...
nop
inc %rbp
lea addresses_UC_ht+0x332b, %rcx
nop
nop
nop
nop
...
mov (%rcx), %r13w
sub $17289, %rsi
lea addresses_WC_ht+0x1df9c, %r13
clflush (%r13)
nop
nop
nop
...
// Faulty Load
lea addresses_normal+0xf1a7, %r15
xor $58863, %r13
movups (%r15), %xmm5
vpextrq $1, %xmm5, %rbx
lea oracles, %r12
...
{'src': {'congruent': 5, 'same': False, 'type': 'addresses_D_ht'}, 'dst': {'congruent': 7, 'same': False, 'type': 'addresses_UC_ht'}, 'OP': 'REPM'}
{'src': {'congruent': 1, 'same': False, 'type': 'addresses_D_ht'}, 'dst': {'congruent': 6, 'same': False, 'type': 'addresses_UC_ht'}, 'OP': 'REPM'}
{'src': {'NT': False, 'AVXalign': False, 'size': 32, 'congruent': 9, 'same': False, 'type': 'addresses_A_ht'}, 'OP': 'LOAD'}
{'dst': {'NT': True, 'AVXalign': False, 'size': 16, 'congruent': 2, 'same': True, 'type': 'addresses_UC_ht'}, 'OP': 'STOR'}
