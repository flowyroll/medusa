...
nop
add $7618, %r13
lea addresses_normal_ht+0xd59d, %r9
xor %r15, %r15
movl $0x61626364, (%r9)
nop
nop
nop
dec %rsi
lea addresses_WC_ht+0x1791e, %rsi
lea addresses_normal_ht+0x630e, %rdi
nop
xor %r13, %r13
mov $67, %rcx
rep movsb
...
nop
cmp %r11, %r11
lea addresses_WC_ht+0x10c2e, %r13
clflush (%r13)
nop
and $37162, %r15
movw $0x6162, (%r13)
sub %r8, %r8
lea addresses_normal_ht+0x1402e, %rsi
lea addresses_UC_ht+0xec2e, %rdi
clflush (%rsi)
nop
dec %r9
mov $66, %rcx
...
nop
sub %r13, %r13
lea addresses_WT_ht+0x18a2e, %rbp
sub $20305, %r8
movb (%rbp), %r15b
nop
xor %rcx, %rcx
lea addresses_normal_ht+0x1b0ce, %r9
and %r13, %r13
mov (%r9), %r15d
nop
xor $57361, %r11
lea addresses_WT_ht+0x1362e, %r15
nop
nop
sub %rdi, %rdi
movw $0x6162, (%r15)
...
nop
xor %rdi, %rdi
lea addresses_A_ht+0x1502e, %rsi
lea addresses_D_ht+0x1b9fc, %rdi
nop
nop
nop
nop
...
nop
and $35848, %r9
lea addresses_WT_ht+0x1c992, %r8
nop
nop
cmp $51598, %r11
movl $0x61626364, (%r8)
...
nop
add %rsi, %rsi
lea addresses_WC_ht+0xcdae, %rsi
nop
nop
nop
dec %r15
...
// Faulty Load
lea addresses_normal+0x1502e, %r8
nop
nop
nop
nop
...
{'OP': 'REPM', 'src': {'type': 'addresses_normal_ht', 'congruent': 10, 'same': True}, 'dst': {'type': 'addresses_UC_ht', 'congruent': 9, 'same': False}}
...
{'OP': 'STOR', 'dst': {'type': 'addresses_WT_ht', 'AVXalign': True, 'congruent': 2, 'size': 2, 'same': False, 'NT': True}}
