...
push %rdi
push %rsi
lea addresses_A_ht+0x16096, %r14
nop
nop
nop
nop
...
nop
xor %rsi, %rsi
lea addresses_UC_ht+0x18316, %rsi
lea addresses_UC_ht+0x1af16, %rdi
nop
cmp %rbp, %rbp
mov $98, %rcx
rep movsq
...
nop
add %rsi, %rsi
lea addresses_WC_ht+0x11716, %rsi
lea addresses_normal_ht+0x197c6, %rdi
clflush (%rsi)
xor $44981, %rbx
mov $101, %rcx
rep movsl
...
nop
and %rax, %rax
lea addresses_WT_ht+0x1e426, %rbx
nop
nop
add $14866, %r9
vmovups (%rbx), %ymm1
...
nop
cmp $44327, %rsi
lea addresses_UC_ht+0x1ec96, %rsi
nop
nop
nop
nop
...
nop
xor %rsi, %rsi
lea addresses_normal_ht+0x15116, %r9
nop
nop
cmp $40122, %rdi
movl $0x61626364, (%r9)
...
<gen_faulty_load>
[REF]
{'OP': 'LOAD', 'src': {'type': 'addresses_D', 'AVXalign': True, 'congruent': 0, 'size': 1, 'same': False, 'NT': False}}
