...
lea addresses_normal_ht+0xc2f8, %rdi
clflush (%rsi)
nop
nop
nop
...
lea addresses_WT_ht+0x5d78, %rdi
nop
nop
nop
cmp $278, %rax
...
lea addresses_A_ht+0x1cb68, %rdi
clflush (%rsi)
clflush (%rdi)
nop
nop
...
nop
cmp %rax, %rax
lea addresses_A_ht+0x1c28, %rsi
lea addresses_D_ht+0xfaad, %rdi
nop
add %r15, %r15
mov $90, %rcx
rep movsq
...
nop
sub %r15, %r15
lea addresses_normal_ht+0x142f8, %rsi
nop
nop
cmp %rdi, %rdi
...
movq %rdx, (%rsi)
sub %rax, %rax
lea addresses_UC_ht+0x14b38, %rsi
lea addresses_A_ht+0x16690, %rdi
nop
nop
dec %r15
mov $33, %rcx
rep movsq
and %rdi, %rdi
lea addresses_WT_ht+0x1eaf8, %rdx
nop
nop
nop
nop
...
nop
add %r14, %r14
lea addresses_WC_ht+0x19af8, %rsi
lea addresses_D_ht+0x1c4f8, %rdi
clflush (%rsi)
cmp $40412, %rax
mov $97, %rcx
rep movsb
...
nop
add $9871, %r15
lea addresses_UC_ht+0xd7f9, %r14
add %rdi, %rdi
movw $0x6162, (%r14)
nop
nop
