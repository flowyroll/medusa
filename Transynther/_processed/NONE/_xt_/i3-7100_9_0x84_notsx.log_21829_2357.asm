...
nop
and %r11, %r11
lea addresses_D_ht+0x8830, %rsi
lea addresses_WT_ht+0x241b, %rdi
clflush (%rsi)
nop
nop
nop
...
nop
sub %rcx, %rcx
lea addresses_D_ht+0xaeab, %rsi
lea addresses_A_ht+0x17bdb, %rdi
clflush (%rdi)
nop
nop
nop
...
nop
dec %r15
lea addresses_WC_ht+0xacdb, %rdi
nop
nop
nop
nop
...
nop
sub $63112, %rdx
lea addresses_A_ht+0x1e10b, %rsi
...
nop
xor %r11, %r11
lea addresses_UC_ht+0x13ef, %r15
nop
nop
nop
nop
...
nop
dec %rcx
lea addresses_WC_ht+0x1ef5b, %rdi
nop
nop
nop
nop
...
nop
cmp $60053, %rdx
lea addresses_D_ht+0x109db, %rbp
xor %r14, %r14
...
// Store
lea addresses_normal+0x13713, %r15
add %r11, %r11
movl $0x51525354, (%r15)
nop
nop
...
{'src': {'type': 'addresses_D_ht', 'congruent': 4, 'same': True}, 'dst': {'type': 'addresses_A_ht', 'congruent': 9, 'same': True}, 'OP': 'REPM'}
{'src': {'type': 'addresses_WC_ht', 'same': False, 'size': 1, 'congruent': 5, 'NT': False, 'AVXalign': True}, 'OP': 'LOAD'}
{'src': {'type': 'addresses_A_ht', 'congruent': 4, 'same': False}, 'dst': {'type': 'addresses_normal_ht', 'congruent': 0, 'same': True}, 'OP': 'REPM'}
{'src': {'type': 'addresses_UC_ht', 'same': False, 'size': 16, 'congruent': 2, 'NT': False, 'AVXalign': True}, 'OP': 'LOAD'}
