...
push %rdx
push %rsi
lea addresses_normal_ht+0x1a395, %r11
clflush (%r11)
nop
nop
nop
...
movw $0x6162, (%r11)
sub $24044, %r9
lea addresses_D_ht+0x17885, %rsi
lea addresses_WT_ht+0x1285, %rdi
nop
sub $15628, %rbp
mov $26, %rcx
rep movsl
...
nop
add %r15, %r15
lea addresses_WT_ht+0xb2c5, %rdi
nop
nop
nop
and %r9, %r9
mov (%rdi), %rbp
xor $36358, %r11
lea addresses_WC_ht+0x6d84, %rdi
nop
nop
nop
sub $21160, %r9
...
// Faulty Load
lea addresses_normal+0xea85, %rdi
sub $60067, %rcx
mov (%rdi), %rbp
lea oracles, %rcx
and $0xff, %rbp
