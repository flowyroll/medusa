...
nop
add $33740, %rdi
lea addresses_A_ht+0x16df1, %rdi
nop
nop
and %rsi, %rsi
movw $0x6162, (%rdi)
...
nop
dec %r15
lea addresses_UC_ht+0x9d19, %rdx
nop
nop
nop
xor %r12, %r12
...
nop
and $31977, %rdx
lea addresses_UC_ht+0x11399, %r14
nop
nop
nop
nop
...
nop
add $51293, %rsi
lea addresses_WC_ht+0x110fb, %rsi
lea addresses_D_ht+0x6619, %rdi
clflush (%rdi)
nop
nop
nop
...
nop
xor $20562, %rbp
lea addresses_A_ht+0x17119, %r15
nop
add %rdi, %rdi
movb (%r15), %r14b
nop
...
{'OP': 'STOR', 'dst': {'congruent': 8, 'AVXalign': False, 'same': False, 'size': 8, 'NT': False, 'type': 'addresses_PSE'}}
{'src': {'congruent': 8, 'AVXalign': False, 'same': False, 'size': 4, 'NT': False, 'type': 'addresses_UC'}, 'OP': 'LOAD'}
[Faulty Load]
{'src': {'congruent': 0, 'AVXalign': False, 'same': True, 'size': 2, 'NT': False, 'type': 'addresses_RW'}, 'OP': 'LOAD'}
<gen_prepare_buffer>
{'src': {'congruent': 6, 'same': False, 'type': 'addresses_WC_ht'}, 'OP': 'REPM', 'dst': {'congruent': 0, 'same': False, 'type': 'addresses_WC_ht'}}
...
{'src': {'congruent': 1, 'same': False, 'type': 'addresses_WC_ht'}, 'OP': 'REPM', 'dst': {'congruent': 8, 'same': False, 'type': 'addresses_D_ht'}}
