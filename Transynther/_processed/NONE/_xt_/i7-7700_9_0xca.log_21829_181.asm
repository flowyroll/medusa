...
nop
add %rdi, %rdi
lea addresses_UC_ht+0x1426c, %rdi
nop
nop
and $30970, %rax
movb (%rdi), %r8b
...
lea addresses_WC_ht+0xbc6c, %rdi
nop
inc %r9
mov $10, %rcx
rep movsl
...
nop
sub %r9, %r9
lea addresses_normal_ht+0x1b36c, %r9
nop
sub %rsi, %rsi
...
nop
and $43993, %r8
lea addresses_UC_ht+0xc07d, %rdi
sub %r15, %r15
movl $0x61626364, (%rdi)
nop
and $32736, %rcx
lea addresses_UC_ht+0x24bc, %rdi
dec %r14
vmovups (%rdi), %ymm3
...
nop
sub $23105, %rax
lea addresses_WT_ht+0x4814, %rdi
nop
nop
nop
nop
...
nop
inc %r15
lea addresses_WC_ht+0x1ef6c, %rax
cmp %r14, %r14
movb (%rax), %r15b
nop
nop
...
{'src': {'congruent': 3, 'same': False, 'type': 'addresses_D_ht'}, 'OP': 'REPM', 'dst': {'congruent': 10, 'same': False, 'type': 'addresses_WC_ht'}}
{'OP': 'STOR', 'dst': {'congruent': 5, 'AVXalign': False, 'same': False, 'size': 16, 'NT': False, 'type': 'addresses_normal_ht'}}
{'OP': 'STOR', 'dst': {'congruent': 0, 'AVXalign': True, 'same': False, 'size': 4, 'NT': True, 'type': 'addresses_UC_ht'}}
...
{'src': {'congruent': 5, 'AVXalign': False, 'same': True, 'size': 1, 'NT': False, 'type': 'addresses_WC_ht'}, 'OP': 'LOAD'}
{'36': 21829}
