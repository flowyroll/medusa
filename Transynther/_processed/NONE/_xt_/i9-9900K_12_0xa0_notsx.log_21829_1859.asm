...
push %rdi
push %rsi
lea addresses_WT_ht+0x19b99, %rbp
nop
nop
nop
nop
...
movw $0x6162, (%rbp)
add $10679, %rcx
lea addresses_WT_ht+0xc205, %r12
nop
cmp %r13, %r13
movb $0x61, (%r12)
nop
inc %r9
lea addresses_WC_ht+0x1cc31, %r9
and %r8, %r8
movb (%r9), %cl
nop
nop
...
nop
inc %r13
lea addresses_WC_ht+0x15ab9, %rsi
lea addresses_A_ht+0x1a839, %rdi
nop
sub $8188, %rbp
mov $80, %rcx
rep movsl
...
// Load
lea addresses_normal+0xf6c0, %r15
nop
nop
nop
nop
...
// REPMOV
lea addresses_WC+0x13c17, %rsi
lea addresses_PSE+0x4eb9, %rdi
clflush (%rdi)
nop
nop
nop
...
// Store
lea addresses_normal+0x64b9, %r11
nop
nop
nop
nop
...
// REPMOV
lea addresses_UC+0x166b9, %rsi
lea addresses_D+0xe734, %rdi
nop
add %rax, %rax
mov $98, %rcx
rep movsb
...
{'src': {'type': 'addresses_UC', 'congruent': 0, 'same': True}, 'OP': 'REPM', 'dst': {'type': 'addresses_D', 'congruent': 0, 'same': False}}
[Faulty Load]
{'src': {'type': 'addresses_UC', 'AVXalign': False, 'size': 16, 'NT': False, 'same': True, 'congruent': 0}, 'OP': 'LOAD'}
<gen_prepare_buffer>
{'OP': 'STOR', 'dst': {'type': 'addresses_WT_ht', 'AVXalign': False, 'size': 2, 'NT': True, 'same': False, 'congruent': 4}}
