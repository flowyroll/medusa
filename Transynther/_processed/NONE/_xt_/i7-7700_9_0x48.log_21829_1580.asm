...
nop
cmp $53132, %r13
lea addresses_WC_ht+0xd3a8, %rsi
lea addresses_UC_ht+0xd669, %rdi
nop
nop
nop
nop
...
nop
mfence
lea addresses_WT_ht+0x1df28, %r13
nop
nop
nop
nop
...
rep movsb
cmp %rsi, %rsi
lea addresses_WC_ht+0x10728, %rdi
nop
nop
nop
cmp $35204, %rbp
...
nop
inc %rdx
lea addresses_D_ht+0xf728, %rsi
lea addresses_normal_ht+0x108e0, %rdi
clflush (%rsi)
cmp %r9, %r9
mov $12, %rcx
rep movsl
...
{'OP': 'STOR', 'dst': {'type': 'addresses_A', 'AVXalign': False, 'congruent': 4, 'size': 4, 'same': False, 'NT': True}}
[Faulty Load]
