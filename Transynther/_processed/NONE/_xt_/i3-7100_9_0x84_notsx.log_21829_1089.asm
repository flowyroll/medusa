...
push %rdx
push %rsi
lea addresses_normal_ht+0x9f17, %rax
nop
nop
nop
sub %r8, %r8
mov (%rax), %di
dec %r11
lea addresses_WT_ht+0x12f17, %r8
clflush (%r8)
nop
nop
nop
...
nop
inc %r8
lea addresses_WC_ht+0x1356e, %rdi
nop
dec %r15
mov $0x6162636465666768, %rdx
movq %rdx, %xmm3
...
nop
dec %r8
lea addresses_UC_ht+0x15a17, %rsi
lea addresses_UC_ht+0x8e17, %rdi
nop
nop
nop
nop
...
nop
cmp $15575, %r12
lea addresses_normal_ht+0xd2f, %rsi
nop
nop
add $59732, %r15
mov (%rsi), %rdi
...
// Faulty Load
lea addresses_normal+0x1ee17, %rax
xor $58626, %rcx
mov (%rax), %r14
lea oracles, %r8
and $0xff, %r14
...
{'src': {'type': 'addresses_UC_ht', 'congruent': 10, 'same': False}, 'dst': {'type': 'addresses_UC_ht', 'congruent': 11, 'same': True}, 'OP': 'REPM'}
