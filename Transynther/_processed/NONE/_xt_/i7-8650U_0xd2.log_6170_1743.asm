...
nop
xor $61582, %rcx
lea addresses_D_ht+0x15bb, %rsi
lea addresses_WC_ht+0x727f, %rdi
clflush (%rdi)
nop
nop
xor %r14, %r14
...
nop
dec %rbp
lea addresses_UC_ht+0x16b3, %rdi
nop
nop
xor %r14, %r14
movb (%rdi), %r11b
...
nop
dec %rcx
lea addresses_WT_ht+0x17aff, %r12
nop
nop
nop
and %rcx, %rcx
mov (%r12), %si
cmp $7995, %rcx
lea addresses_WC_ht+0x11cff, %rcx
nop
sub $33906, %r14
movw $0x6162, (%rcx)
nop
...
nop
cmp $47046, %rbp
lea addresses_UC_ht+0x1cc0b, %r13
nop
xor %r11, %r11
...
// Faulty Load
lea addresses_normal+0x15cff, %r10
nop
nop
nop
nop
