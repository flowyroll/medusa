...
nop
dec %rdi
lea addresses_normal_ht+0x63ed, %rsi
lea addresses_A_ht+0x1c083, %rdi
nop
nop
nop
nop
...
rep movsq
sub $10105, %rdi
lea addresses_UC_ht+0x96c3, %rdi
nop
nop
and $14509, %r8
vmovups (%rdi), %ymm3
...
{'OP': 'STOR', 'dst': {'same': False, 'type': 'addresses_WT', 'NT': True, 'AVXalign': False, 'size': 2, 'congruent': 9}}
[Faulty Load]
