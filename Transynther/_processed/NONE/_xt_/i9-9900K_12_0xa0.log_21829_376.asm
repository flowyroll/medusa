...
push %rdx
push %rsi
lea addresses_WT_ht+0x10517, %rsi
lea addresses_normal_ht+0xf75f, %rdi
nop
nop
nop
nop
...
nop
dec %r12
lea addresses_WC_ht+0x1d4a7, %r13
nop
xor $62337, %rbp
movb $0x61, (%r13)
nop
...
nop
sub $23960, %rdi
lea addresses_WC_ht+0x1775f, %rsi
nop
nop
nop
nop
...
nop
xor $53401, %rsi
lea addresses_D_ht+0x14637, %rsi
lea addresses_D_ht+0x7f5f, %rdi
nop
nop
nop
nop
...
{'OP': 'STOR', 'dst': {'NT': False, 'same': False, 'congruent': 10, 'type': 'addresses_WT', 'AVXalign': True, 'size': 32}}
...
{'src': {'same': False, 'congruent': 3, 'type': 'addresses_D_ht'}, 'OP': 'REPM', 'dst': {'same': False, 'congruent': 10, 'type': 'addresses_D_ht'}}
{'32': 21829}
