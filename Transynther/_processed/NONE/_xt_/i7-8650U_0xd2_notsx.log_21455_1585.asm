...
nop
and $37833, %r12
lea addresses_A_ht+0x18156, %rsi
lea addresses_WT_ht+0xd460, %rdi
clflush (%rdi)
nop
nop
nop
...
nop
inc %r14
lea addresses_UC_ht+0x18560, %rdi
nop
nop
nop
nop
...
movl $0x61626364, (%rdi)
sub %r14, %r14
lea addresses_WC_ht+0x1c4a0, %rsi
lea addresses_WC_ht+0xf560, %rdi
clflush (%rsi)
add $55756, %rdx
mov $86, %rcx
rep movsl
...
movb $0x61, (%r12)
and %rsi, %rsi
lea addresses_A_ht+0x14d60, %rcx
nop
nop
cmp $52204, %r12
movb (%rcx), %r8b
nop
inc %r14
lea addresses_WC_ht+0xd7d0, %rsi
lea addresses_D_ht+0x159a0, %rdi
nop
nop
nop
add $34822, %r14
...
// Faulty Load
lea addresses_normal+0xfd60, %r9
nop
xor %r14, %r14
mov (%r9), %rdx
lea oracles, %r14
...
{'OP': 'STOR', 'dst': {'type': 'addresses_UC_ht', 'size': 4, 'AVXalign': True, 'NT': False, 'congruent': 11, 'same': False}}
...
{'OP': 'REPM', 'src': {'type': 'addresses_WC_ht', 'congruent': 3, 'same': True}, 'dst': {'type': 'addresses_D_ht', 'congruent': 6, 'same': False}}
{'34': 21455}
