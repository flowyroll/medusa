...
nop
sub %rax, %rax
lea addresses_WC_ht+0x3d73, %rbp
nop
nop
nop
nop
...
nop
add %rdi, %rdi
lea addresses_D_ht+0x1b493, %rax
nop
nop
nop
nop
...
nop
cmp %rsi, %rsi
lea addresses_D_ht+0x1b7d7, %rdx
nop
nop
nop
xor $58284, %rcx
...
nop
add %r15, %r15
lea addresses_D_ht+0x1b183, %rdx
nop
nop
nop
nop
...
nop
add %rbp, %rbp
lea addresses_WC_ht+0x1c66, %rdi
nop
nop
nop
xor $11025, %rcx
...
nop
and $60052, %rsi
lea addresses_normal_ht+0x1ece5, %rsi
clflush (%rsi)
nop
nop
cmp %rdi, %rdi
...
nop
dec %rsi
lea addresses_WT_ht+0x187fb, %rsi
lea addresses_normal_ht+0x172a0, %rdi
clflush (%rsi)
nop
nop
nop
...
{'src': {'NT': True, 'AVXalign': False, 'size': 32, 'congruent': 11, 'same': False, 'type': 'addresses_WC_ht'}, 'OP': 'LOAD'}
...
{'dst': {'NT': False, 'AVXalign': False, 'size': 4, 'congruent': 0, 'same': True, 'type': 'addresses_normal_ht'}, 'OP': 'STOR'}
{'src': {'congruent': 3, 'same': False, 'type': 'addresses_WT_ht'}, 'dst': {'congruent': 0, 'same': False, 'type': 'addresses_normal_ht'}, 'OP': 'REPM'}
{'36': 21829}
