...
push %rdx
push %rsi
lea addresses_WC_ht+0x1e9e8, %rdi
nop
add %r8, %r8
mov (%rdi), %r13
nop
...
nop
and %r12, %r12
lea addresses_normal_ht+0x3b48, %rdx
nop
nop
nop
nop
...
<gen_prepare_buffer>
{'src': {'congruent': 10, 'AVXalign': False, 'same': True, 'size': 8, 'NT': False, 'type': 'addresses_WC_ht'}, 'OP': 'LOAD'}
