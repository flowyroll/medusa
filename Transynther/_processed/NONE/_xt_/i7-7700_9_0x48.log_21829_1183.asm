...
push %rdx
push %rsi
lea addresses_D_ht+0xe618, %rsi
lea addresses_WC_ht+0xf960, %rdi
nop
nop
sub %rdx, %rdx
mov $63, %rcx
rep movsl
add $8966, %r9
lea addresses_WT_ht+0xdd58, %rbp
clflush (%rbp)
add $511, %r13
mov (%rbp), %edi
nop
nop
xor %r9, %r9
lea addresses_WT_ht+0x1d248, %rcx
clflush (%rcx)
nop
nop
nop
...
nop
add %r13, %r13
lea addresses_normal_ht+0x6224, %rdx
nop
nop
dec %r9
mov (%rdx), %r13d
...
nop
xor %rbp, %rbp
lea addresses_WT_ht+0x24d8, %rsi
lea addresses_normal_ht+0x16f58, %rdi
xor $13225, %r8
mov $52, %rcx
rep movsq
dec %r8
lea addresses_normal_ht+0x99f4, %rdx
nop
nop
nop
nop
...
// Store
lea addresses_A+0x1d958, %r10
and $46130, %rdx
movw $0x5152, (%r10)
cmp $20477, %r10

// Faulty Load
lea addresses_normal+0x12758, %r15
nop
nop
nop
add $49008, %rsi
