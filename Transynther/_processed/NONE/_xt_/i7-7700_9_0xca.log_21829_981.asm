...
nop
add $13246, %rbx
lea addresses_D_ht+0x16005, %rbx
nop
nop
nop
nop
...
nop
dec %rbp
lea addresses_WC_ht+0x4015, %rsi
lea addresses_D_ht+0x10dd5, %rdi
nop
nop
cmp $48379, %r9
mov $19, %rcx
...
nop
xor $25914, %r11
lea addresses_UC_ht+0x159d5, %rsi
lea addresses_D_ht+0x67d5, %rdi
nop
nop
nop
nop
...
nop
inc %rbp
lea addresses_WC_ht+0xc055, %r11
clflush (%r11)
nop
nop
add %rbx, %rbx
...
nop
add %rsi, %rsi
lea addresses_UC_ht+0x5c25, %rbp
nop
nop
and %r14, %r14
mov (%rbp), %r9
...
// Faulty Load
lea addresses_normal+0x1bfd5, %r14
nop
nop
nop
nop
...
{'src': {'congruent': 5, 'AVXalign': False, 'same': False, 'size': 1, 'NT': True, 'type': 'addresses_US'}, 'OP': 'LOAD'}
...
{'src': {'congruent': 9, 'same': False, 'type': 'addresses_UC_ht'}, 'OP': 'REPM', 'dst': {'congruent': 11, 'same': False, 'type': 'addresses_D_ht'}}
{'src': {'congruent': 4, 'AVXalign': True, 'same': False, 'size': 2, 'NT': False, 'type': 'addresses_WC_ht'}, 'OP': 'LOAD'}
