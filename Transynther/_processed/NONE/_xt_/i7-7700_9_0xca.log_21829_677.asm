...
nop
inc %rdi
lea addresses_WT_ht+0xd417, %rsi
nop
nop
cmp %r10, %r10
movups (%rsi), %xmm1
...
nop
and $40424, %r13
lea addresses_A_ht+0x6f97, %rsi
lea addresses_UC_ht+0x9937, %rdi
nop
nop
nop
nop
...
rep movsl
dec %rdi
lea addresses_UC_ht+0x2293, %r13
add %r8, %r8
mov $0x6162636465666768, %r10
movq %r10, %xmm2
movups %xmm2, (%r13)
add %rcx, %rcx
lea addresses_WT_ht+0x3c17, %rsi
lea addresses_normal_ht+0x17da4, %rdi
nop
nop
nop
nop
...
nop
and %rbp, %rbp
lea addresses_normal_ht+0x15d4c, %r10
cmp $37040, %rdi
movw $0x6162, (%r10)
xor $691, %r13
pop %rsi
