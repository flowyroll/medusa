...
push %rdi
push %rsi
lea addresses_WT_ht+0xb987, %rsi
lea addresses_A_ht+0x1987, %rdi
clflush (%rsi)
add $63436, %rax
mov $64, %rcx
rep movsq
xor %r9, %r9
lea addresses_WT_ht+0x10f57, %rbx
nop
nop
and $4613, %r10
...
nop
add %rax, %rax
lea addresses_normal_ht+0x1f87, %rdi
nop
nop
nop
cmp %rcx, %rcx
...
nop
add $16730, %rcx
lea addresses_D_ht+0xd1db, %rsi
lea addresses_WC_ht+0x1df07, %rdi
nop
nop
sub $44979, %r12
mov $60, %rcx
...
nop
add %r10, %r10
lea addresses_UC_ht+0x1644b, %rsi
lea addresses_A_ht+0xa307, %rdi
nop
nop
nop
add $2970, %r10
...
{'OP': 'REPM', 'src': {'type': 'addresses_UC_ht', 'congruent': 2, 'same': False}, 'dst': {'type': 'addresses_A_ht', 'congruent': 7, 'same': True}}
{'32': 21829}
