...
push %rdi
push %rsi
lea addresses_WC_ht+0x1105f, %rsi
lea addresses_WC_ht+0x1e1ef, %rdi
clflush (%rdi)
xor %rbx, %rbx
mov $1, %rcx
rep movsq
...
nop
cmp %r10, %r10
lea addresses_normal_ht+0xd80e, %rsi
lea addresses_UC_ht+0x1e1df, %rdi
nop
nop
nop
nop
