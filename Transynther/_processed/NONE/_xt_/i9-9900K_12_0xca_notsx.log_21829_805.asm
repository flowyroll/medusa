...
push %rdx
push %rsi
lea addresses_normal_ht+0x9980, %r13
nop
nop
nop
nop
...
movq %r15, (%r13)
dec %r14
lea addresses_UC_ht+0x1de86, %rbx
nop
nop
nop
nop
...
nop
and %r15, %r15
lea addresses_D_ht+0x1978a, %r14
nop
nop
nop
cmp $46681, %rdx
...
nop
dec %r15
lea addresses_normal_ht+0x6492, %rsi
...
nop
sub $53597, %r15
lea addresses_normal_ht+0x19b86, %rsi
lea addresses_A_ht+0x1c586, %rdi
sub %rbp, %rbp
mov $53, %rcx
rep movsw
nop
...
nop
and $35310, %r14
lea addresses_WT_ht+0xd8c6, %rsi
lea addresses_A_ht+0x16446, %rdi
add $25250, %rbx
mov $77, %rcx
rep movsw
nop
...
nop
xor %rdi, %rdi
lea addresses_normal_ht+0x16f86, %rdi
nop
and $18534, %rsi
movl $0x61626364, (%rdi)
nop
nop
add %rbx, %rbx
lea addresses_A_ht+0x10786, %r13
nop
nop
nop
nop
