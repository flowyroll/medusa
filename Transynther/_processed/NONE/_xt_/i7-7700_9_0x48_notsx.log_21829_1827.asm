...
nop
inc %rdi
lea addresses_A_ht+0x426f, %rsi
lea addresses_A_ht+0x386f, %rdi
cmp $4620, %r8
mov $2, %rcx
rep movsq
nop
...
{'dst': {'same': False, 'NT': True, 'AVXalign': False, 'size': 1, 'type': 'addresses_RW', 'congruent': 7}, 'OP': 'STOR'}
{'OP': 'LOAD', 'src': {'same': False, 'NT': False, 'AVXalign': False, 'size': 2, 'type': 'addresses_UC', 'congruent': 4}}
[Faulty Load]
