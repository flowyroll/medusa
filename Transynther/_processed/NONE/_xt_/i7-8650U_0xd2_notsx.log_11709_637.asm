...
nop
add $20060, %r8
lea addresses_WT_ht+0x17afd, %rsi
and %r13, %r13
...
{'OP': 'STOR', 'dst': {'type': 'addresses_UC_ht', 'size': 1, 'AVXalign': False, 'NT': True, 'congruent': 1, 'same': True}}
{'35': 11709}
