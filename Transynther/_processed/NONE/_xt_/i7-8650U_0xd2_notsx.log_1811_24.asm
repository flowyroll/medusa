...
nop
cmp %rcx, %rcx
lea addresses_UC_ht+0x7de4, %rax
nop
nop
nop
nop
...
nop
xor %r15, %r15
lea addresses_UC_ht+0xd904, %rsi
lea addresses_normal_ht+0x8d04, %rdi
nop
nop
nop
add %r14, %r14
...
nop
sub $2245, %rsi
lea addresses_WC_ht+0x1b784, %rsi
lea addresses_normal_ht+0x13f04, %rdi
nop
nop
and $55642, %rax
mov $48, %rcx
...
nop
sub %r15, %r15
lea addresses_normal_ht+0x1d904, %r10
nop
nop
xor $7577, %rdi
...
nop
add $60916, %r15
lea addresses_UC_ht+0xc504, %rsi
lea addresses_D_ht+0x19f04, %rdi
nop
nop
nop
cmp %r15, %r15
...
nop
inc %rsi
lea addresses_normal_ht+0x1a504, %rsi
lea addresses_normal_ht+0x11284, %rdi
clflush (%rsi)
nop
nop
sub $62922, %r10
...
// Store
lea addresses_normal+0x13eb4, %r14
nop
nop
cmp $30513, %rcx
movl $0x51525354, (%r14)
...
// Faulty Load
lea addresses_normal+0x1e904, %r10
nop
and %rcx, %rcx
movups (%r10), %xmm3
vpextrq $0, %xmm3, %rbp
...
{'OP': 'LOAD', 'src': {'type': 'addresses_A_ht', 'size': 1, 'AVXalign': False, 'NT': True, 'congruent': 9, 'same': False}}
{'OP': 'REPM', 'src': {'type': 'addresses_UC_ht', 'congruent': 11, 'same': False}, 'dst': {'type': 'addresses_normal_ht', 'congruent': 10, 'same': False}}
...
{'OP': 'REPM', 'src': {'type': 'addresses_UC_ht', 'congruent': 7, 'same': False}, 'dst': {'type': 'addresses_D_ht', 'congruent': 9, 'same': False}}
