...
nop
cmp %r12, %r12
lea addresses_UC_ht+0x115b0, %rsi
lea addresses_normal_ht+0x1c230, %rdi
clflush (%rdi)
nop
add $7023, %rdx
mov $16, %rcx
...
nop
sub $22006, %r10
lea addresses_WC_ht+0xc49c, %rdi
nop
nop
add %rdx, %rdx
mov (%rdi), %r12d
...
nop
and %rbp, %rbp
lea addresses_A_ht+0x1c310, %rsi
nop
nop
nop
sub %rdx, %rdx
...
// Store
lea addresses_A+0x1c3b4, %r11
and %r10, %r10
movl $0x51525354, (%r11)
dec %r13

// Faulty Load
lea addresses_RW+0x14bb0, %r15
nop
nop
nop
nop
