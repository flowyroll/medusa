...
push %rdx
push %rsi
lea addresses_A_ht+0x16004, %rsi
lea addresses_A_ht+0x15104, %rdi
clflush (%rsi)
nop
nop
nop
...
nop
cmp %r9, %r9
lea addresses_WT_ht+0x8f04, %r11
nop
nop
xor $34200, %rdx
...
nop
xor %r11, %r11
lea addresses_WT_ht+0x19104, %rbp
nop
sub %r11, %r11
movups (%rbp), %xmm2
vpextrq $0, %xmm2, %r9
nop
cmp $25117, %rbp
lea addresses_WT_ht+0x50a7, %r11
sub %rsi, %rsi
...
<gen_prepare_buffer>
{'src': {'type': 'addresses_A_ht', 'congruent': 3, 'same': False}, 'dst': {'type': 'addresses_A_ht', 'congruent': 11, 'same': False}, 'OP': 'REPM'}
{'src': {'type': 'addresses_A_ht', 'same': False, 'size': 1, 'congruent': 3, 'NT': False, 'AVXalign': False}, 'OP': 'LOAD'}
{'src': {'type': 'addresses_UC_ht', 'congruent': 11, 'same': True}, 'dst': {'type': 'addresses_A_ht', 'congruent': 3, 'same': False}, 'OP': 'REPM'}
...
{'dst': {'type': 'addresses_UC_ht', 'same': True, 'size': 16, 'congruent': 10, 'NT': True, 'AVXalign': False}, 'OP': 'STOR'}
