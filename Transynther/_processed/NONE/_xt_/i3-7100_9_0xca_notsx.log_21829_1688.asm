...
push %rdx
push %rsi
lea addresses_A_ht+0xe51a, %r15
sub %r9, %r9
mov (%r15), %rdx
nop
sub $44701, %r14
lea addresses_WT_ht+0x1bd02, %rsi
lea addresses_WT_ht+0x1d0a3, %rdi
nop
xor %r15, %r15
mov $121, %rcx
rep movsq
dec %rcx
lea addresses_A_ht+0x10d02, %rsi
lea addresses_D_ht+0x134d2, %rdi
nop
and $47175, %r12
mov $38, %rcx
rep movsw
...
nop
cmp %rdx, %rdx
lea addresses_UC_ht+0x13402, %r9
nop
nop
nop
add %rsi, %rsi
...
nop
cmp %rdi, %rdi
lea addresses_WT_ht+0x1b02, %r15
nop
nop
and %rdi, %rdi
mov (%r15), %r12w
