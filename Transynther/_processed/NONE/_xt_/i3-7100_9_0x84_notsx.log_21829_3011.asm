...
push %rdi
push %rsi
lea addresses_WC_ht+0x8ced, %rbx
nop
and %rbp, %rbp
mov (%rbx), %r8w
cmp $30869, %rsi
lea addresses_UC_ht+0x1c11b, %rsi
lea addresses_normal_ht+0x15ced, %rdi
nop
sub %r14, %r14
mov $36, %rcx
rep movsw
...
nop
and $3244, %r8
lea addresses_UC_ht+0xcc04, %rdi
nop
nop
xor %rbp, %rbp
movb $0x61, (%rdi)
