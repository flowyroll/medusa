...
push %rdx
push %rsi
lea addresses_A_ht+0xfd5a, %rsi
lea addresses_WT_ht+0x1b68a, %rdi
clflush (%rdi)
cmp %rdx, %rdx
mov $11, %rcx
rep movsl
...
nop
xor $41443, %rcx
lea addresses_WC_ht+0xe7ea, %rsi
lea addresses_WC_ht+0x9caa, %rdi
nop
nop
nop
nop
...
nop
xor %rdx, %rdx
lea addresses_WT_ht+0x11aa, %rsi
lea addresses_normal_ht+0xb1aa, %rdi
nop
nop
nop
nop
...
nop
xor $6458, %r15
lea addresses_A_ht+0xc670, %rsi
lea addresses_WC_ht+0x1d5ea, %rdi
xor %r14, %r14
mov $107, %rcx
rep movsw
nop
...
nop
cmp %r13, %r13
lea addresses_WT_ht+0xfee3, %rdi
clflush (%rdi)
nop
nop
nop
...
nop
and $36912, %r13
lea addresses_normal_ht+0x119aa, %rdx
nop
nop
nop
add %rcx, %rcx
...
vpextrq $0, %xmm4, %r14
xor %rsi, %rsi
lea addresses_UC_ht+0x1a85a, %r15
nop
nop
nop
nop
...
nop
add %rcx, %rcx
lea addresses_WT_ht+0x15daa, %rsi
lea addresses_WC_ht+0x16eea, %rdi
nop
nop
sub $3295, %r11
mov $2, %rcx
...
nop
inc %r13
lea addresses_WT_ht+0x173aa, %r11
nop
sub $27692, %rdx
mov (%r11), %rdi
add $18406, %r13
...
<gen_prepare_buffer>
{'dst': {'same': False, 'congruent': 4, 'type': 'addresses_WT_ht'}, 'OP': 'REPM', 'src': {'same': True, 'congruent': 4, 'type': 'addresses_A_ht'}}
...
{'OP': 'LOAD', 'src': {'same': True, 'NT': False, 'AVXalign': False, 'size': 8, 'type': 'addresses_WT_ht', 'congruent': 9}}
{'38': 21829}
