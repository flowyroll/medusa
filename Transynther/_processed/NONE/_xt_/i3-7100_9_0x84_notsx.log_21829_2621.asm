...
push %rdi
push %rsi
lea addresses_D_ht+0x16c51, %rsi
lea addresses_D_ht+0x18071, %rdi
nop
nop
nop
nop
...
nop
xor %r10, %r10
lea addresses_A_ht+0x1b271, %r15
clflush (%r15)
mfence
movl $0x61626364, (%r15)
xor $44084, %r10
lea addresses_normal_ht+0x611, %r10
nop
nop
nop
nop
...
movb $0x61, (%r10)
cmp %rdi, %rdi
lea addresses_A_ht+0x12bd1, %rsi
nop
nop
nop
nop
...
nop
dec %r10
lea addresses_UC_ht+0xd0f1, %r12
nop
xor %rcx, %rcx
movb $0x61, (%r12)
nop
...
nop
and $23835, %r10
lea addresses_WC_ht+0x11071, %rsi
lea addresses_UC_ht+0x1182d, %rdi
clflush (%rsi)
nop
sub $40592, %r13
mov $26, %rcx
...
nop
add %rdi, %rdi
lea addresses_WT_ht+0x2071, %r10
nop
nop
nop
nop
...
<gen_prepare_buffer>
{'src': {'type': 'addresses_D_ht', 'congruent': 5, 'same': False}, 'dst': {'type': 'addresses_D_ht', 'congruent': 8, 'same': False}, 'OP': 'REPM'}
...
{'src': {'type': 'addresses_WC_ht', 'congruent': 11, 'same': False}, 'dst': {'type': 'addresses_UC_ht', 'congruent': 2, 'same': False}, 'OP': 'REPM'}
