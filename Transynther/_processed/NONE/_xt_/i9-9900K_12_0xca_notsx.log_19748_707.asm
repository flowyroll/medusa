...
push %rdx
push %rsi
lea addresses_A_ht+0x140cb, %rdi
nop
and $9352, %r9
...
nop
sub %rdx, %rdx
lea addresses_A_ht+0xf75b, %rsi
lea addresses_D_ht+0xfee8, %rdi
nop
nop
nop
nop
...
nop
xor $12622, %rbp
lea addresses_normal_ht+0x66cb, %r9
nop
nop
nop
nop
...
nop
add $35416, %r9
lea addresses_WT_ht+0x10fb3, %rcx
inc %rdx
vmovups (%rcx), %ymm2
...
{'OP': 'REPM', 'src': {'same': False, 'congruent': 1, 'type': 'addresses_P'}, 'dst': {'same': False, 'congruent': 6, 'type': 'addresses_US'}}
{'OP': 'LOAD', 'src': {'same': False, 'type': 'addresses_RW', 'NT': False, 'AVXalign': True, 'size': 32, 'congruent': 6}}
...
<gen_prepare_buffer>
{'OP': 'STOR', 'dst': {'same': False, 'type': 'addresses_A_ht', 'NT': True, 'AVXalign': False, 'size': 8, 'congruent': 9}}
