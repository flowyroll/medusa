...
push %rdx
push %rsi
lea addresses_UC_ht+0x1d70c, %rsi
lea addresses_WT_ht+0x14749, %rdi
nop
nop
nop
nop
...
nop
cmp $58223, %rdx
lea addresses_D_ht+0xe489, %r15
nop
nop
mfence
movw $0x6162, (%r15)
add $27650, %rcx
lea addresses_WC_ht+0x5669, %rdi
nop
xor $53684, %rdx
mov (%rdi), %rsi
nop
...
nop
add %r9, %r9
lea addresses_WC_ht+0x1d2d1, %rsi
lea addresses_D_ht+0x19489, %rdi
nop
nop
nop
nop
...
lea addresses_normal_ht+0x125e9, %rdi
nop
nop
nop
nop
...
nop
cmp %rcx, %rcx
lea addresses_WC_ht+0x4dc9, %r11
sub $63986, %rcx
mov (%r11), %rdx
nop
nop
sub %rsi, %rsi
lea addresses_UC_ht+0x15f01, %r15
clflush (%r15)
cmp $19265, %r9
movb (%r15), %dl
dec %rdi
lea addresses_A_ht+0xf889, %rcx
nop
nop
nop
nop
...
nop
sub $54066, %r9
lea addresses_UC_ht+0x19889, %rsi
...
nop
dec %r9
lea addresses_WT_ht+0x1305b, %r11
nop
cmp $20485, %rdx
movw $0x6162, (%r11)
nop
...
nop
sub $6395, %rdx
lea addresses_UC_ht+0x9c69, %rsi
nop
nop
nop
cmp $6897, %rbp
...
nop
add %r11, %r11
lea addresses_normal_ht+0xc489, %rsi
lea addresses_UC_ht+0x1a689, %rdi
nop
nop
nop
add %r9, %r9
...
nop
dec %r9
lea addresses_normal_ht+0x1ca29, %rbp
nop
nop
xor $36626, %rsi
movl $0x61626364, (%rbp)
...
<gen_prepare_buffer>
{'src': {'type': 'addresses_UC_ht', 'congruent': 0, 'same': True}, 'OP': 'REPM', 'dst': {'type': 'addresses_WT_ht', 'congruent': 2, 'same': False}}
...
{'src': {'type': 'addresses_WC_ht', 'congruent': 3, 'same': False}, 'OP': 'REPM', 'dst': {'type': 'addresses_D_ht', 'congruent': 9, 'same': False}}
{'src': {'type': 'addresses_WT_ht', 'congruent': 4, 'same': False}, 'OP': 'REPM', 'dst': {'type': 'addresses_normal_ht', 'congruent': 3, 'same': False}}
{'src': {'type': 'addresses_WC_ht', 'AVXalign': False, 'size': 8, 'NT': False, 'same': True, 'congruent': 6}, 'OP': 'LOAD'}
...
{'src': {'type': 'addresses_UC_ht', 'congruent': 11, 'same': False}, 'OP': 'REPM', 'dst': {'type': 'addresses_normal_ht', 'congruent': 5, 'same': False}}
{'src': {'type': 'addresses_D_ht', 'AVXalign': False, 'size': 2, 'NT': True, 'same': True, 'congruent': 3}, 'OP': 'LOAD'}
