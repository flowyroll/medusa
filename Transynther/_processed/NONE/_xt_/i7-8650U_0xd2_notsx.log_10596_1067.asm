...
nop
xor $29765, %r10
lea addresses_A_ht+0x16979, %rcx
nop
nop
nop
sub $9114, %r11
...
lea addresses_UC_ht+0x3979, %rdi
nop
nop
nop
cmp %rdx, %rdx
...
nop
xor %rdi, %rdi
lea addresses_WT_ht+0x19979, %rsi
nop
nop
xor $3632, %rdx
movb (%rsi), %r12b
...
nop
xor $51665, %r13
lea addresses_normal_ht+0x17159, %rdi
sub %r10, %r10
...
nop
add $43779, %rsi
lea addresses_WT_ht+0xd2f9, %rsi
lea addresses_WC_ht+0x539f, %rdi
clflush (%rdi)
nop
nop
nop
...
nop
and $25110, %rdi
lea addresses_WC_ht+0x4db9, %r12
nop
nop
nop
nop
...
nop
and %r13, %r13
lea addresses_D_ht+0x1205e, %rdx
nop
nop
nop
nop
...
nop
add $60067, %r12
lea addresses_D_ht+0x1df79, %r10
nop
nop
and %rcx, %rcx
movb $0x61, (%r10)
...
nop
and %r11, %r11
lea addresses_WC_ht+0x734f, %r11
nop
add %rdx, %rdx
mov $0x6162636465666768, %r12
movq %r12, %xmm6
...
nop
sub %r11, %r11
lea addresses_WT_ht+0xb4f9, %rsi
nop
nop
nop
nop
...
{'OP': 'LOAD', 'src': {'type': 'addresses_WT_ht', 'size': 1, 'AVXalign': True, 'NT': False, 'congruent': 11, 'same': False}}
