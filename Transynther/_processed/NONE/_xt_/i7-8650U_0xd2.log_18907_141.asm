...
nop
and %r8, %r8
lea addresses_UC_ht+0x670d, %rbx
nop
nop
nop
add $44541, %r14
...
nop
and $46015, %r15
lea addresses_WT_ht+0xd80f, %r11
nop
nop
nop
nop
...
mov (%r11), %r14
add %rbx, %rbx
lea addresses_UC_ht+0x12e3d, %rsi
lea addresses_A_ht+0x1b50d, %rdi
nop
nop
nop
xor $54423, %rbx
...
movl $0x61626364, (%rbx)
sub $50169, %rax
lea addresses_normal_ht+0xb50d, %rsi
lea addresses_normal_ht+0x779d, %rdi
nop
nop
nop
nop
...
{'OP': 'STOR', 'dst': {'type': 'addresses_PSE', 'size': 32, 'AVXalign': True, 'NT': False, 'congruent': 2, 'same': False}}
...
{'OP': 'LOAD', 'src': {'type': 'addresses_UC_ht', 'size': 16, 'AVXalign': True, 'NT': False, 'congruent': 10, 'same': False}}
