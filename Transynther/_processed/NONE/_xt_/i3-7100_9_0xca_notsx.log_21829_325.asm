...
push %rdi
push %rsi
lea addresses_D_ht+0x17328, %r14
clflush (%r14)
nop
nop
nop
...
nop
xor %rcx, %rcx
lea addresses_normal_ht+0x78, %r11
nop
xor $37684, %rcx
mov (%r11), %r14d
nop
...
nop
inc %rbx
lea addresses_normal_ht+0x10f28, %rdi
nop
nop
and $59587, %rcx
movl $0x61626364, (%rdi)
...
nop
sub $39274, %rcx
lea addresses_A_ht+0x5a28, %rsi
lea addresses_D_ht+0x11828, %rdi
nop
nop
nop
nop
...
nop
add $34599, %r13
lea addresses_normal_ht+0xd6e8, %rbx
clflush (%rbx)
sub %rcx, %rcx
mov (%rbx), %di
nop
nop
cmp $46202, %rsi
lea addresses_normal_ht+0x1ed95, %rsi
lea addresses_D_ht+0x77a8, %rdi
nop
nop
nop
add %r8, %r8
...
{'src': {'type': 'addresses_A_ht', 'congruent': 7, 'same': False}, 'OP': 'REPM', 'dst': {'type': 'addresses_D_ht', 'congruent': 5, 'same': True}}
