...
push %rcx
push %rdi
lea addresses_UC_ht+0x5c78, %r13
nop
nop
nop
nop
...
nop
and %rcx, %rcx
lea addresses_normal_ht+0x8dcc, %rbx
nop
nop
nop
nop
...
nop
sub $57313, %rbp
lea addresses_WT_ht+0x1b760, %r13
nop
and %r14, %r14
...
nop
and %r14, %r14
lea addresses_normal_ht+0xca0, %rdi
nop
nop
nop
nop
...
nop
xor $30317, %rbp
lea addresses_D_ht+0x18e5a, %r14
inc %rdi
mov $0x6162636465666768, %rbp
movq %rbp, %xmm1
movups %xmm1, (%r14)
...
{'src': {'type': 'addresses_D', 'same': False, 'size': 1, 'congruent': 11, 'NT': False, 'AVXalign': True}, 'OP': 'LOAD'}
