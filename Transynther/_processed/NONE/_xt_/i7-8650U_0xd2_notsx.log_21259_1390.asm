...
push %rdi
push %rsi
lea addresses_normal_ht+0x9242, %r10
nop
nop
inc %r15
...
vmovups %ymm5, (%r10)
xor $18198, %rcx
lea addresses_normal_ht+0x17442, %rsi
lea addresses_UC_ht+0xce42, %rdi
nop
nop
nop
nop
...
nop
sub %rcx, %rcx
lea addresses_D_ht+0x1353e, %rdi
nop
and $55122, %rsi
mov (%rdi), %rcx
nop
...
nop
inc %rbp
lea addresses_normal_ht+0x5342, %rsi
lea addresses_normal_ht+0x1102e, %rdi
nop
nop
nop
nop
...
nop
xor $12762, %r15
lea addresses_D_ht+0x10742, %r10
nop
nop
cmp $4323, %rbp
movb $0x61, (%r10)
and $1620, %r8
lea addresses_A_ht+0x9c1b, %rax
nop
nop
nop
nop
...
nop
inc %r15
lea addresses_A_ht+0x1cd76, %r15
nop
dec %rax
movups (%r15), %xmm7
vpextrq $1, %xmm7, %r10
...
nop
and $25557, %rcx
lea addresses_WT_ht+0xf442, %rcx
nop
dec %rbp
movb (%rcx), %al
nop
...
lea addresses_D_ht+0x155aa, %rdi
clflush (%rdi)
nop
nop
nop
...
nop
xor $17110, %rax
lea addresses_WC_ht+0x5342, %rsi
lea addresses_WC_ht+0x15ab2, %rdi
nop
nop
dec %r15
mov $111, %rcx
...
nop
sub %r8, %r8
lea addresses_UC_ht+0x4fb2, %rsi
lea addresses_normal_ht+0x1a842, %rdi
nop
nop
nop
nop
...
nop
inc %rax
lea addresses_WT_ht+0xb90e, %rbp
nop
nop
nop
nop
