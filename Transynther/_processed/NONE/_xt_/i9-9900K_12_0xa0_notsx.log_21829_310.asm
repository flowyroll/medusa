...
push %rdi
push %rsi
lea addresses_UC_ht+0x52f7, %rdi
xor %r13, %r13
mov (%rdi), %cx
nop
nop
nop
cmp %r14, %r14
lea addresses_normal_ht+0x11543, %rsi
lea addresses_WT_ht+0x10e9f, %rdi
nop
nop
nop
cmp %r11, %r11
...
rep movsq
sub $3932, %rsi
lea addresses_WT_ht+0x16ba3, %rcx
nop
add $61935, %rdi
mov (%rcx), %r11d
nop
nop
add $51578, %rdi
lea addresses_A_ht+0x19a37, %rsi
lea addresses_UC_ht+0x12fb7, %rdi
clflush (%rsi)
and %r12, %r12
mov $33, %rcx
rep movsb
nop
cmp %r14, %r14
lea addresses_A_ht+0x16637, %rsi
lea addresses_D_ht+0x10f07, %rdi
nop
nop
nop
nop
...
nop
add %rax, %rax
lea addresses_normal_ht+0x13905, %rax
nop
nop
nop
add %rcx, %rcx
...
nop
add $30947, %r12
lea addresses_WT_ht+0xba37, %rcx
nop
nop
xor $37401, %rax
...
movq %r14, (%rcx)
dec %r12
lea addresses_UC_ht+0xce37, %rsi
nop
and $20548, %r13
movups (%rsi), %xmm4
vpextrq $1, %xmm4, %r11
...
nop
cmp %r13, %r13
lea addresses_UC_ht+0x283f, %rsi
lea addresses_WT_ht+0x1a637, %rdi
clflush (%rsi)
clflush (%rdi)
nop
sub %r13, %r13
...
rep movsq
inc %r14
lea addresses_normal_ht+0x18cb, %rax
nop
nop
nop
and $47787, %r13
...
<gen_prepare_buffer>
{'src': {'type': 'addresses_UC_ht', 'AVXalign': False, 'size': 2, 'NT': True, 'same': False, 'congruent': 5}, 'OP': 'LOAD'}
{'src': {'type': 'addresses_normal_ht', 'congruent': 2, 'same': False}, 'OP': 'REPM', 'dst': {'type': 'addresses_WT_ht', 'congruent': 2, 'same': True}}
{'src': {'type': 'addresses_WT_ht', 'AVXalign': False, 'size': 4, 'NT': False, 'same': False, 'congruent': 2}, 'OP': 'LOAD'}
{'src': {'type': 'addresses_A_ht', 'congruent': 10, 'same': False}, 'OP': 'REPM', 'dst': {'type': 'addresses_UC_ht', 'congruent': 7, 'same': False}}
...
{'src': {'type': 'addresses_UC_ht', 'congruent': 3, 'same': False}, 'OP': 'REPM', 'dst': {'type': 'addresses_WT_ht', 'congruent': 10, 'same': False}}
