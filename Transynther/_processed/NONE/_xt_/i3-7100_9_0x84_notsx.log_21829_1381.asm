...
movb $0x61, (%r14)
cmp %rbx, %rbx
lea addresses_WT_ht+0x82c9, %rsi
lea addresses_D_ht+0x5bf9, %rdi
nop
and %rbp, %rbp
mov $83, %rcx
rep movsw
...
nop
xor %rsi, %rsi
lea addresses_normal_ht+0x2bf9, %rsi
cmp %r10, %r10
movups (%rsi), %xmm6
vpextrq $0, %xmm6, %rdi
nop
nop
add $37457, %rsi
lea addresses_UC_ht+0x8db1, %rsi
clflush (%rsi)
nop
nop
nop
...
nop
cmp $62985, %r10
lea addresses_normal_ht+0xbbf9, %rsi
lea addresses_UC_ht+0x10955, %rdi
clflush (%rsi)
nop
nop
nop
...
nop
and %rsi, %rsi
lea addresses_WT_ht+0x1d9f9, %rsi
lea addresses_D_ht+0xc059, %rdi
clflush (%rsi)
clflush (%rdi)
nop
nop
...
nop
and $939, %r14
lea addresses_UC_ht+0xf5f9, %r14
clflush (%r14)
nop
nop
and %rcx, %rcx
...
nop
and $35572, %rbp
lea addresses_WT_ht+0x123f9, %r10
nop
inc %rbx
mov $0x6162636465666768, %rcx
movq %rcx, (%r10)
...
nop
inc %rsi
lea addresses_WT_ht+0xcf5f, %rsi
lea addresses_WT_ht+0xa7f9, %rdi
clflush (%rsi)
nop
nop
nop
...
{'src': {'type': 'addresses_WT_ht', 'congruent': 4, 'same': False}, 'dst': {'type': 'addresses_D_ht', 'congruent': 11, 'same': True}, 'OP': 'REPM'}
...
{'dst': {'type': 'addresses_WT_ht', 'same': False, 'size': 8, 'congruent': 11, 'NT': True, 'AVXalign': True}, 'OP': 'STOR'}
{'src': {'type': 'addresses_WT_ht', 'congruent': 1, 'same': False}, 'dst': {'type': 'addresses_WT_ht', 'congruent': 6, 'same': True}, 'OP': 'REPM'}
{'35': 21829}
