...
nop
dec %r8
lea addresses_A_ht+0x1b8f, %rsi
lea addresses_D_ht+0x1482f, %rdi
nop
nop
xor %r10, %r10
mov $6, %rcx
rep movsq
sub %r10, %r10
lea addresses_normal_ht+0xbe62, %r10
nop
nop
and %rcx, %rcx
movw $0x6162, (%r10)
...
nop
cmp %r10, %r10
lea addresses_normal_ht+0x1b7cf, %rdx
nop
nop
nop
nop
...
{'OP': 'STOR', 'dst': {'same': False, 'type': 'addresses_PSE', 'NT': False, 'AVXalign': True, 'size': 2, 'congruent': 2}}
{'OP': 'STOR', 'dst': {'same': False, 'type': 'addresses_PSE', 'NT': False, 'AVXalign': True, 'size': 8, 'congruent': 7}}
...
{'OP': 'STOR', 'dst': {'same': True, 'type': 'addresses_normal_ht', 'NT': True, 'AVXalign': False, 'size': 2, 'congruent': 0}}
