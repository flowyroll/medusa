...
nop
add %r9, %r9
lea addresses_A_ht+0x1dd62, %r13
nop
nop
and $44732, %rdx
movw $0x6162, (%r13)
sub $23852, %r9
lea addresses_WT_ht+0x5878, %r11
nop
nop
nop
nop
...
movb (%r11), %bl
xor %rdx, %rdx
lea addresses_UC_ht+0x13478, %r11
nop
xor %r12, %r12
movb (%r11), %r10b
nop
add $8211, %r12
lea addresses_UC_ht+0x8878, %rsi
lea addresses_D_ht+0x11a7b, %rdi
nop
nop
sub %rbx, %rbx
mov $25, %rcx
...
nop
inc %rbx
lea addresses_WC_ht+0x4478, %rsi
lea addresses_normal_ht+0x6d78, %rdi
xor %r12, %r12
mov $59, %rcx
rep movsb
sub %rdx, %rdx
lea addresses_normal_ht+0x1a278, %r11
nop
nop
nop
add %r10, %r10
...
// Store
lea addresses_normal+0x138b6, %rbx
nop
nop
nop
nop
...
{'OP': 'STOR', 'dst': {'size': 2, 'NT': True, 'type': 'addresses_normal', 'same': False, 'AVXalign': False, 'congruent': 0}}
[Faulty Load]
{'OP': 'LOAD', 'src': {'size': 32, 'NT': False, 'type': 'addresses_RW', 'same': True, 'AVXalign': False, 'congruent': 0}}
<gen_prepare_buffer>
{'OP': 'LOAD', 'src': {'size': 2, 'NT': False, 'type': 'addresses_normal_ht', 'same': True, 'AVXalign': True, 'congruent': 1}}
...
{'OP': 'REPM', 'src': {'same': False, 'type': 'addresses_WC_ht', 'congruent': 8}, 'dst': {'same': False, 'type': 'addresses_normal_ht', 'congruent': 7}}
