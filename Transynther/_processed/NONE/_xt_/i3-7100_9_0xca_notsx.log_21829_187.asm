...
rep movsb
xor $46814, %rdx
lea addresses_UC_ht+0xf9e8, %rdx
nop
nop
and %rsi, %rsi
vmovups (%rdx), %ymm4
...
vpextrq $1, %xmm4, %rcx
and $51866, %rdx
lea addresses_WC_ht+0x1e9e8, %r15
nop
add %rax, %rax
...
nop
add $32482, %rdx
lea addresses_D_ht+0x14b68, %r10
nop
nop
add $63921, %rsi
...
nop
inc %rax
lea addresses_UC_ht+0x16b78, %rsi
lea addresses_normal_ht+0xd9e8, %rdi
nop
nop
nop
nop
...
rep movsb
sub $14593, %rax
lea addresses_normal_ht+0x1ede8, %rsi
lea addresses_A_ht+0xf028, %rdi
nop
nop
nop
nop
...
nop
xor $49035, %rdx
lea addresses_WC_ht+0x176e8, %rax
xor %rdx, %rdx
mov (%rax), %bx
nop
nop
...
{'src': {'type': 'addresses_WC_ht', 'congruent': 11, 'same': False}, 'OP': 'REPM', 'dst': {'type': 'addresses_WC_ht', 'congruent': 10, 'same': False}}
