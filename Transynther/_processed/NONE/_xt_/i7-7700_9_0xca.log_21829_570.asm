...
nop
dec %rcx
lea addresses_A_ht+0xa010, %rsi
lea addresses_D_ht+0x199b0, %rdi
nop
dec %rbx
mov $55, %rcx
rep movsw
...
nop
xor $11645, %rdi
lea addresses_normal_ht+0x115b0, %r15
nop
nop
nop
sub %rax, %rax
...
nop
sub $9039, %rdi
lea addresses_UC_ht+0x2e47, %r15
nop
nop
nop
xor %rcx, %rcx
...
// Store
lea addresses_normal+0x49b0, %rsi
nop
nop
and %r14, %r14
movl $0x51525354, (%rsi)
