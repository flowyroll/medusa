...
nop
cmp $26255, %rdi
lea addresses_D_ht+0xde4b, %rsi
lea addresses_A_ht+0x546b, %rdi
sub %rbx, %rbx
mov $20, %rcx
rep movsw
nop
...
nop
and %rsi, %rsi
lea addresses_D_ht+0x10b09, %rcx
nop
nop
nop
xor %rdi, %rdi
...
nop
add $51020, %rbx
lea addresses_normal_ht+0x10d1d, %rcx
nop
nop
nop
nop
...
nop
cmp %rsi, %rsi
lea addresses_WT_ht+0x15cb, %r13
nop
nop
nop
nop
...
// Faulty Load
lea addresses_normal+0x1470b, %r9
nop
xor $25762, %rbx
mov (%r9), %rax
lea oracles, %rbx
...
{'OP': 'LOAD', 'src': {'type': 'addresses_NC', 'AVXalign': False, 'congruent': 7, 'size': 1, 'same': False, 'NT': False}}
[Faulty Load]
...
{'OP': 'STOR', 'dst': {'type': 'addresses_A_ht', 'AVXalign': False, 'congruent': 1, 'size': 1, 'same': False, 'NT': True}}
{'34': 21829}
