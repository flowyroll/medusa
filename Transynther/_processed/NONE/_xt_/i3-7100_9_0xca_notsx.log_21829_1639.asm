...
push %rdx
push %rsi
lea addresses_WT_ht+0x12314, %r15
nop
nop
nop
add $5767, %r12
...
nop
add $57200, %rbp
lea addresses_D_ht+0x14e64, %rbx
nop
sub $48154, %r15
movups (%rbx), %xmm6
vpextrq $0, %xmm6, %r12
...
nop
dec %rbp
lea addresses_normal_ht+0x1ed24, %rsi
lea addresses_normal_ht+0x153e4, %rdi
sub %rbp, %rbp
mov $16, %rcx
rep movsw
add $30596, %r14
lea addresses_WT_ht+0x15f54, %rdi
nop
and %rcx, %rcx
