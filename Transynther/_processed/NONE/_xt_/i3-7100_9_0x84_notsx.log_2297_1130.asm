...
push %rdi
push %rsi
lea addresses_normal_ht+0x1593, %rbp
inc %rdi
movw $0x6162, (%rbp)
nop
nop
cmp $13773, %r12
lea addresses_A_ht+0x1cffb, %rsi
lea addresses_WT_ht+0x645b, %rdi
clflush (%rsi)
nop
nop
nop
...
nop
cmp %rdi, %rdi
lea addresses_UC_ht+0x12e4b, %rbp
nop
add $38663, %rsi
movb (%rbp), %r11b
inc %rbp
lea addresses_UC_ht+0x173e3, %rbp
clflush (%rbp)
and $53275, %r12
vmovups (%rbp), %ymm7
