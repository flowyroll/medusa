...
push %rdi
push %rsi
lea addresses_WT_ht+0x353c, %rsi
lea addresses_WT_ht+0x1c03c, %rdi
nop
nop
nop
nop
...
nop
lfence
lea addresses_A_ht+0x213c, %r8
clflush (%r8)
xor %rbp, %rbp
mov (%r8), %rcx
nop
xor %r13, %r13
lea addresses_UC_ht+0x1e13c, %rcx
clflush (%rcx)
nop
nop
nop
...
nop
xor $14192, %rdi
lea addresses_D_ht+0x1b43c, %rbx
nop
nop
and $1760, %rbp
movb (%rbx), %r13b
...
nop
xor $32788, %rsi
lea addresses_normal_ht+0xed3c, %rsi
nop
nop
nop
nop
...
movups %xmm6, (%rsi)
cmp $3906, %rdi
lea addresses_WC_ht+0x55b2, %rsi
lea addresses_WT_ht+0x10f4c, %rdi
nop
nop
nop
sub %r12, %r12
...
rep movsw
xor $58137, %r13
lea addresses_WC_ht+0x950c, %rsi
nop
dec %rdi
mov $0x6162636465666768, %rcx
movq %rcx, (%rsi)
...
// Faulty Load
lea addresses_normal+0x18d3c, %r11
sub %rax, %rax
vmovups (%r11), %ymm6
