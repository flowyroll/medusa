...
push %rdx
push %rsi
lea addresses_normal_ht+0xe63d, %r14
nop
nop
nop
nop
...
nop
dec %r13
lea addresses_normal_ht+0x18835, %rsi
nop
sub $13601, %r10
vmovups (%rsi), %ymm5
...
nop
cmp $34495, %rax
lea addresses_A_ht+0x1cb5d, %r10
nop
nop
nop
nop
...
nop
cmp $17915, %r13
lea addresses_normal_ht+0x1675d, %r13
nop
nop
nop
cmp $22530, %rcx
...
nop
xor $7103, %rsi
lea addresses_UC_ht+0x1435d, %rsi
nop
nop
nop
nop
...
nop
add %rdx, %rdx
lea addresses_normal_ht+0x1afd, %r13
nop
inc %r10
vmovups (%r13), %ymm7
...
nop
and %r13, %r13
lea addresses_WC_ht+0x17edd, %rax
cmp %r13, %r13
...
nop
cmp $32112, %r10
lea addresses_D_ht+0x17b5d, %r14
xor $3057, %rdx
mov $0x6162636465666768, %rax
movq %rax, %xmm7
vmovups %ymm7, (%r14)
dec %r13
lea addresses_WC_ht+0x1c75d, %rax
clflush (%rax)
nop
nop
add %r10, %r10
...
nop
cmp %r10, %r10
lea addresses_WC_ht+0x120dd, %rax
nop
nop
cmp %r10, %r10
vmovups (%rax), %ymm0
...
nop
xor $57792, %r13
lea addresses_normal_ht+0x85d, %rax
nop
add %rdx, %rdx
movups (%rax), %xmm5
vpextrq $0, %xmm5, %r13
add $50622, %r10
lea addresses_normal_ht+0x668d, %rsi
lea addresses_normal_ht+0xc21d, %rdi
nop
nop
nop
nop
...
{'src': {'same': False, 'congruent': 4, 'type': 'addresses_normal_ht'}, 'OP': 'REPM', 'dst': {'same': True, 'congruent': 6, 'type': 'addresses_normal_ht'}}
{'33': 21829}
