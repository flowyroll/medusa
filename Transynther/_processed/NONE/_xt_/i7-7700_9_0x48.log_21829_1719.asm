...
push %rdx
push %rsi
lea addresses_normal_ht+0x11062, %r13
nop
add %rax, %rax
...
movups %xmm4, (%r13)
and $23607, %rcx
lea addresses_WC_ht+0x46d2, %rsi
lea addresses_WT_ht+0x65d2, %rdi
clflush (%rsi)
nop
nop
nop
...
nop
dec %rbp
lea addresses_normal_ht+0x53d2, %rsi
lea addresses_A_ht+0xcd0, %rdi
nop
nop
nop
nop
...
nop
sub $8782, %r13
lea addresses_WT_ht+0x10452, %rdx
nop
and %r14, %r14
mov $0x6162636465666768, %rax
movq %rax, (%rdx)
dec %rax
lea addresses_WT_ht+0x1e1a6, %r13
nop
nop
nop
nop
...
nop
mfence
lea addresses_A_ht+0x1c0d2, %rsi
lea addresses_normal_ht+0x157d2, %rdi
nop
nop
nop
add $35772, %rdx
...
nop
cmp $42643, %r13
lea addresses_WC_ht+0x9ad2, %r14
nop
cmp %rax, %rax
movl $0x61626364, (%r14)
nop
...
nop
xor $11587, %r14
lea addresses_D_ht+0x1e4d2, %rsi
cmp %r14, %r14
mov (%rsi), %bp
add $11976, %rdi
lea addresses_WT_ht+0x13aa6, %r13
nop
nop
nop
nop
...
{'OP': 'STOR', 'dst': {'type': 'addresses_UC', 'AVXalign': False, 'congruent': 3, 'size': 16, 'same': False, 'NT': True}}
[Faulty Load]
...
{'OP': 'REPM', 'src': {'type': 'addresses_WC_ht', 'congruent': 10, 'same': False}, 'dst': {'type': 'addresses_WT_ht', 'congruent': 1, 'same': True}}
{'OP': 'LOAD', 'src': {'type': 'addresses_D_ht', 'AVXalign': True, 'congruent': 7, 'size': 1, 'same': False, 'NT': False}}
{'OP': 'REPM', 'src': {'type': 'addresses_normal_ht', 'congruent': 6, 'same': False}, 'dst': {'type': 'addresses_A_ht', 'congruent': 1, 'same': False}}
