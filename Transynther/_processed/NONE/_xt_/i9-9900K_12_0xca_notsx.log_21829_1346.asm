...
push %rdx
push %rsi
lea addresses_WC_ht+0x7818, %rsi
lea addresses_WT_ht+0x5558, %rdi
xor $18877, %r10
mov $118, %rcx
rep movsw
nop
...
nop
xor $11123, %r8
lea addresses_A_ht+0x6090, %rsi
lea addresses_UC_ht+0x9654, %rdi
clflush (%rsi)
nop
nop
nop
...
nop
dec %rsi
lea addresses_WT_ht+0x3898, %r11
xor $42632, %rdx
mov $0x6162636465666768, %rdi
movq %rdi, (%r11)
nop
add %rcx, %rcx
lea addresses_WC_ht+0x868, %rdx
nop
nop
and $2792, %r11
mov (%rdx), %rdi
...
nop
cmp $12362, %rdi
lea addresses_WC_ht+0xffa0, %rdi
nop
nop
nop
nop
...
<gen_prepare_buffer>
{'OP': 'REPM', 'src': {'same': False, 'congruent': 6, 'type': 'addresses_WC_ht'}, 'dst': {'same': True, 'congruent': 5, 'type': 'addresses_WT_ht'}}
{'OP': 'REPM', 'src': {'same': True, 'congruent': 2, 'type': 'addresses_A_ht'}, 'dst': {'same': False, 'congruent': 2, 'type': 'addresses_UC_ht'}}
{'OP': 'STOR', 'dst': {'same': False, 'type': 'addresses_WT_ht', 'NT': True, 'AVXalign': False, 'size': 8, 'congruent': 5}}
