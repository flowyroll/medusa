...
push %rdi
push %rsi
lea addresses_UC_ht+0x206c, %rsi
lea addresses_WT_ht+0xee5c, %rdi
nop
and $26129, %r9
mov $16, %rcx
rep movsq
...
nop
mfence
lea addresses_UC_ht+0x6e6c, %rsi
lea addresses_WT_ht+0x30ac, %rdi
cmp %r11, %r11
mov $112, %rcx
rep movsl
nop
...
{'dst': {'same': False, 'congruent': 3, 'type': 'addresses_WT'}, 'OP': 'REPM', 'src': {'same': False, 'congruent': 6, 'type': 'addresses_P'}}
[Faulty Load]
...
{'dst': {'same': False, 'congruent': 4, 'type': 'addresses_WT_ht'}, 'OP': 'REPM', 'src': {'same': False, 'congruent': 4, 'type': 'addresses_UC_ht'}}
{'36': 12100}
