...
nop
inc %r14
lea addresses_WT_ht+0x44bc, %rsi
nop
nop
dec %rbp
vmovups (%rsi), %ymm7
...
vpextrq $0, %xmm7, %r14
and $13546, %rbp
lea addresses_WT_ht+0x240c, %rsi
lea addresses_WT_ht+0xf6ec, %rdi
nop
and %r10, %r10
mov $81, %rcx
rep movsq
...
nop
sub $40028, %rdx
lea addresses_D_ht+0x498c, %rsi
lea addresses_WT_ht+0x200c, %rdi
nop
nop
nop
nop
...
{'OP': 'LOAD', 'src': {'same': False, 'type': 'addresses_WC', 'NT': False, 'AVXalign': False, 'size': 1, 'congruent': 2}}
{'OP': 'STOR', 'dst': {'same': False, 'type': 'addresses_D', 'NT': False, 'AVXalign': False, 'size': 32, 'congruent': 6}}
{'OP': 'LOAD', 'src': {'same': False, 'type': 'addresses_WT', 'NT': False, 'AVXalign': False, 'size': 4, 'congruent': 1}}
[Faulty Load]
