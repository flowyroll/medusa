...
push %rdi
push %rsi
lea addresses_normal_ht+0x1ddd6, %rsi
nop
nop
mfence
movb (%rsi), %r15b
...
nop
and %r13, %r13
lea addresses_WC_ht+0x1c0de, %rcx
nop
nop
nop
inc %r10
...
nop
cmp $62926, %rcx
lea addresses_normal_ht+0xd5f6, %r13
nop
nop
nop
nop
...
nop
cmp $62333, %r13
lea addresses_normal_ht+0x2fbe, %rsi
lea addresses_D_ht+0xd1f6, %rdi
cmp $7323, %rbx
mov $122, %rcx
rep movsb
nop
...
vmovups %ymm2, (%rcx)
xor %rbx, %rbx
lea addresses_WC_ht+0x1e1f6, %rsi
lea addresses_normal_ht+0xb884, %rdi
nop
nop
nop
nop
...
nop
mfence
lea addresses_A_ht+0x1df6, %rsi
lea addresses_WC_ht+0x2686, %rdi
sub %r14, %r14
mov $61, %rcx
rep movsl
nop
...
<gen_prepare_buffer>
{'OP': 'LOAD', 'src': {'type': 'addresses_normal_ht', 'AVXalign': False, 'congruent': 4, 'size': 1, 'same': True, 'NT': True}}
...
{'OP': 'REPM', 'src': {'type': 'addresses_WC_ht', 'congruent': 11, 'same': False}, 'dst': {'type': 'addresses_normal_ht', 'congruent': 1, 'same': False}}
