...
push %rdi
push %rsi
lea addresses_UC_ht+0x1e661, %r14
nop
nop
nop
sub %r8, %r8
...
nop
inc %r11
lea addresses_UC_ht+0xdc61, %rcx
nop
nop
xor %r12, %r12
...
nop
cmp %r11, %r11
lea addresses_A_ht+0x1a161, %r11
nop
nop
xor $38194, %r8
movups (%r11), %xmm4
vpextrq $1, %xmm4, %rcx
cmp $14344, %r11
lea addresses_UC_ht+0x130e1, %r8
nop
nop
cmp $38850, %r12
...
nop
add %r11, %r11
lea addresses_normal_ht+0x14551, %r14
nop
nop
nop
nop
...
nop
and $54999, %rsi
lea addresses_UC_ht+0x14079, %r8
nop
nop
nop
nop
...
movb $0x61, (%r8)
inc %rdi
lea addresses_UC_ht+0x9657, %r11
nop
lfence
...
movb $0x61, (%rdi)
inc %r11
lea addresses_A_ht+0x1ac21, %rsi
lea addresses_UC_ht+0x1b1e1, %rdi
nop
nop
nop
sub %rax, %rax
...
nop
add $35505, %r8
lea addresses_A_ht+0x16061, %r11
nop
nop
dec %rcx
movups (%r11), %xmm0
...
{'dst': {'NT': False, 'AVXalign': False, 'size': 8, 'congruent': 11, 'same': True, 'type': 'addresses_UC_ht'}, 'OP': 'STOR'}
...
{'src': {'congruent': 4, 'same': False, 'type': 'addresses_A_ht'}, 'dst': {'congruent': 7, 'same': False, 'type': 'addresses_UC_ht'}, 'OP': 'REPM'}
