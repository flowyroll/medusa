...
nop
and %rdi, %rdi
lea addresses_WT_ht+0x8ddb, %rdi
sub %r14, %r14
...
nop
xor $2078, %rcx
lea addresses_WT_ht+0x511b, %r14
nop
xor %rsi, %rsi
movb $0x61, (%r14)
nop
...
<gen_prepare_buffer>
{'src': {'same': False, 'congruent': 7, 'type': 'addresses_D_ht'}, 'OP': 'REPM', 'dst': {'same': False, 'congruent': 8, 'type': 'addresses_normal_ht'}}
