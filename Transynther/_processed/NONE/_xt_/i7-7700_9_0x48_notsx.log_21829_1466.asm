...
push %rdi
push %rsi
lea addresses_WC_ht+0xf1c5, %rsi
clflush (%rsi)
nop
inc %r8
mov (%rsi), %r11d
...
nop
add $7914, %r8
lea addresses_WT_ht+0x17e95, %r12
and $17771, %rcx
mov (%r12), %ebx
nop
nop
...
nop
xor %r11, %r11
lea addresses_D_ht+0x19a59, %rbx
nop
nop
nop
nop
...
nop
sub %rcx, %rcx
lea addresses_A_ht+0x18bf1, %rcx
clflush (%rcx)
nop
sub %r10, %r10
movl $0x61626364, (%rcx)
nop
add $8810, %rbx
lea addresses_WC_ht+0x17f85, %r8
nop
nop
nop
nop
...
nop
add %r12, %r12
lea addresses_WC_ht+0x19dc9, %r11
nop
nop
nop
nop
...
nop
sub $6273, %r8
lea addresses_WT_ht+0xb485, %rsi
lea addresses_WT_ht+0xc385, %rdi
and $4811, %r12
mov $123, %rcx
rep movsw
inc %rcx
