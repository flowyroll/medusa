...
push %rcx
push %rsi
lea addresses_UC_ht+0x14ff5, %r9
nop
nop
nop
inc %r12
...
nop
inc %rsi
lea addresses_UC_ht+0x9735, %r15
nop
cmp %r14, %r14
movb $0x61, (%r15)
nop
...
nop
cmp %r15, %r15
lea addresses_normal_ht+0x15035, %r15
clflush (%r15)
nop
nop
add $50863, %r10
...
nop
inc %r9
lea addresses_WC_ht+0x175b, %r14
nop
xor %rsi, %rsi
movb (%r14), %r12b
nop
...
<gen_prepare_buffer>
{'dst': {'type': 'addresses_UC_ht', 'same': True, 'size': 1, 'congruent': 6, 'NT': False, 'AVXalign': False}, 'OP': 'STOR'}
