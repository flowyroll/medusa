...
push %rdi
push %rsi
lea addresses_WT_ht+0x1e191, %r14
clflush (%r14)
nop
nop
nop
...
nop
add $3279, %r12
lea addresses_A_ht+0x10d8d, %r14
nop
nop
nop
sub %r8, %r8
...
nop
sub %r8, %r8
lea addresses_WC_ht+0x5c3d, %rsi
lea addresses_WC_ht+0x8e3, %rdi
nop
nop
nop
inc %rax
...
nop
cmp $12663, %rax
lea addresses_normal_ht+0x567d, %rsi
nop
nop
nop
add %r8, %r8
...
// Faulty Load
lea addresses_normal+0x15d3d, %rsi
nop
nop
nop
and $53177, %rbp
