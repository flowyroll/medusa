...
push %rdx
push %rsi
lea addresses_A_ht+0x1848a, %r11
nop
nop
and %rdx, %rdx
movups (%r11), %xmm7
...
nop
inc %r11
lea addresses_WC_ht+0xd0da, %rsi
lea addresses_WT_ht+0xd31a, %rdi
nop
xor $10719, %r13
mov $77, %rcx
rep movsl
xor $14686, %rdx
lea addresses_D_ht+0x6eba, %rdx
nop
nop
nop
nop
...
nop
xor $51559, %r13
lea addresses_UC_ht+0x11d9a, %r13
cmp $35853, %rdx
movl $0x61626364, (%r13)
nop
and $62302, %rsi
lea addresses_UC_ht+0x691a, %rdx
clflush (%rdx)
nop
nop
nop
...
nop
xor %rdx, %rdx
lea addresses_WT_ht+0x1cc9a, %rcx
dec %rsi
