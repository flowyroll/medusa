...
push %rdx
push %rsi
lea addresses_UC_ht+0xaa46, %rsi
inc %r11
...
nop
and $62057, %r13
lea addresses_D_ht+0x102ae, %r11
nop
nop
nop
nop
...
nop
and %r10, %r10
lea addresses_WC_ht+0xf30e, %r15
nop
nop
nop
nop
...
nop
add $12348, %r15
lea addresses_normal_ht+0xa19e, %r15
clflush (%r15)
xor $1579, %r11
mov (%r15), %si
add $63215, %r10
lea addresses_WT_ht+0x38ae, %rsi
lea addresses_A_ht+0xea9a, %rdi
nop
add $53311, %r11
mov $76, %rcx
rep movsl
...
// Store
lea addresses_UC+0x189ae, %rbp
and %r12, %r12
movw $0x5152, (%rbp)
sub $158, %rbp

// Faulty Load
lea addresses_PSE+0x70ae, %r14
nop
dec %rbx
mov (%r14), %r12d
lea oracles, %rbp
