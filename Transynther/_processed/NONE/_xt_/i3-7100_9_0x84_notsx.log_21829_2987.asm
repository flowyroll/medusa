...
push %rdi
push %rsi
lea addresses_normal_ht+0x31be, %r8
nop
nop
cmp %rsi, %rsi
...
nop
inc %r13
lea addresses_UC_ht+0xd9be, %r15
nop
inc %rax
mov $0x6162636465666768, %rsi
movq %rsi, (%r15)
xor %rsi, %rsi
lea addresses_A_ht+0x49be, %r15
nop
nop
nop
cmp $41572, %r11
...
nop
and %r15, %r15
lea addresses_UC_ht+0x33be, %rax
nop
nop
nop
nop
...
nop
sub %r12, %r12
lea addresses_WC_ht+0xfa3e, %rsi
lea addresses_A_ht+0x169be, %rdi
clflush (%rsi)
nop
add $60051, %r12
mov $29, %rcx
rep movsq
and %r15, %r15
lea addresses_WC_ht+0xdc58, %rcx
nop
nop
nop
nop
