...
lea addresses_normal_ht+0xf239, %rdi
nop
nop
nop
and %rbp, %rbp
...
nop
cmp $59147, %rbp
lea addresses_UC_ht+0x135c9, %r9
nop
nop
nop
nop
...
nop
and $38730, %rcx
lea addresses_WT_ht+0x1d85f, %rdi
nop
xor %rbp, %rbp
mov (%rdi), %eax
nop
nop
sub $33343, %r9
lea addresses_normal_ht+0xe9e9, %r9
nop
nop
nop
add %rax, %rax
...
vpextrq $0, %xmm4, %rsi
dec %rcx
lea addresses_WT_ht+0xaa91, %rsi
lea addresses_D_ht+0x19209, %rdi
clflush (%rsi)
nop
cmp %r13, %r13
mov $18, %rcx
...
nop
xor $34233, %rsi
lea addresses_WC_ht+0xe22b, %rax
nop
nop
nop
nop
...
nop
and %rsi, %rsi
lea addresses_A_ht+0x17869, %rsi
lea addresses_UC_ht+0x12c09, %rdi
nop
nop
nop
nop
...
nop
sub %rax, %rax
lea addresses_normal_ht+0x8649, %rsi
lea addresses_WT_ht+0x15bd, %rdi
nop
nop
nop
nop
...
rep movsb
inc %r13
lea addresses_A_ht+0x19545, %rdx
and $39746, %rax
vmovups (%rdx), %ymm5
vextracti128 $1, %ymm5, %xmm5
vpextrq $1, %xmm5, %rsi
add $65084, %rax
lea addresses_D_ht+0xf809, %rsi
lea addresses_WT_ht+0x16409, %rdi
nop
nop
sub %rax, %rax
mov $126, %rcx
...
nop
add %rdx, %rdx
lea addresses_UC_ht+0x4ea9, %rsi
clflush (%rsi)
nop
nop
sub $32689, %r13
...
{'OP': 'REPM', 'src': {'type': 'addresses_WT_ht', 'congruent': 2, 'same': True}, 'dst': {'type': 'addresses_D_ht', 'congruent': 11, 'same': False}}
