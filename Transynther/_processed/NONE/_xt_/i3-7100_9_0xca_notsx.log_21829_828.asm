...
push %rdi
push %rsi
lea addresses_normal_ht+0x162ef, %rsi
lea addresses_UC_ht+0xb4c6, %rdi
clflush (%rsi)
nop
nop
nop
...
nop
add %r13, %r13
lea addresses_WT_ht+0xc881, %rsi
lea addresses_UC_ht+0xfb0b, %rdi
clflush (%rsi)
clflush (%rdi)
nop
nop
...
rep movsl
xor $21681, %rdi
lea addresses_WT_ht+0x1801b, %rsi
lea addresses_WT_ht+0x1998f, %rdi
nop
nop
nop
nop
...
nop
cmp %rsi, %rsi
lea addresses_D_ht+0x16b0f, %rsi
lea addresses_D_ht+0x16ce7, %rdi
nop
nop
nop
nop
...
nop
inc %rax
lea addresses_normal_ht+0x738f, %rsi
nop
nop
nop
nop
...
nop
sub $32797, %r13
lea addresses_normal_ht+0x658d, %rdi
nop
nop
nop
nop
...
mov (%rdi), %cx
xor %rdi, %rdi
lea addresses_UC_ht+0x1210f, %rsi
nop
xor $30696, %r13
movl $0x61626364, (%rsi)
nop
nop
and $4703, %r8
lea addresses_WC_ht+0x1470f, %rax
nop
nop
nop
nop
...
// Faulty Load
lea addresses_normal+0x1840f, %rbp
nop
cmp $23914, %r14
mov (%rbp), %r11d
lea oracles, %rbp
...
<gen_prepare_buffer>
{'src': {'type': 'addresses_normal_ht', 'congruent': 4, 'same': False}, 'OP': 'REPM', 'dst': {'type': 'addresses_UC_ht', 'congruent': 0, 'same': False}}
