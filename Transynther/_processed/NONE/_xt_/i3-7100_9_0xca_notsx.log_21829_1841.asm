...
push %rdx
push %rsi
lea addresses_D_ht+0x13f0b, %r15
nop
nop
nop
add $9892, %rdx
...
nop
sub $18306, %rdx
lea addresses_UC_ht+0x18b0b, %r12
nop
nop
nop
nop
...
nop
and $24774, %rsi
lea addresses_UC_ht+0x5f4d, %rsi
lea addresses_D_ht+0x270b, %rdi
nop
nop
xor $15484, %r8
mov $13, %rcx
...
nop
sub %rdi, %rdi
lea addresses_normal_ht+0xe18b, %rsi
...
nop
dec %r12
lea addresses_WT_ht+0xa3f5, %rdx
nop
nop
nop
nop
...
nop
xor $48771, %rcx
lea addresses_UC_ht+0xab0b, %r15
nop
inc %rbx
...
nop
xor $61859, %rbx
lea addresses_WC_ht+0x13f0b, %rsi
...
nop
xor %r12, %r12
lea addresses_normal_ht+0x1538b, %rdx
nop
inc %rcx
...
movntdq %xmm6, (%rdx)
add $5897, %rbx
lea addresses_WC_ht+0x1cbcb, %rsi
nop
and $22987, %r8
mov (%rsi), %ecx
nop
...
lea addresses_UC_ht+0xdfab, %rdi
nop
nop
nop
nop
...
// Store
lea addresses_normal+0x16f8b, %rsi
inc %r13
...
{'OP': 'STOR', 'dst': {'same': False, 'congruent': 5, 'NT': False, 'type': 'addresses_normal', 'size': 8, 'AVXalign': False}}
[Faulty Load]
...
{'src': {'type': 'addresses_UC_ht', 'congruent': 1, 'same': False}, 'OP': 'REPM', 'dst': {'type': 'addresses_D_ht', 'congruent': 11, 'same': False}}
{'src': {'type': 'addresses_normal_ht', 'congruent': 7, 'same': False}, 'OP': 'REPM', 'dst': {'type': 'addresses_UC_ht', 'congruent': 5, 'same': False}}
{'OP': 'STOR', 'dst': {'same': False, 'congruent': 1, 'NT': True, 'type': 'addresses_WT_ht', 'size': 1, 'AVXalign': False}}
{'src': {'same': False, 'congruent': 8, 'NT': False, 'type': 'addresses_A_ht', 'size': 2, 'AVXalign': False}, 'OP': 'LOAD'}
{'OP': 'STOR', 'dst': {'same': False, 'congruent': 5, 'NT': False, 'type': 'addresses_UC_ht', 'size': 32, 'AVXalign': False}}
...
{'src': {'type': 'addresses_WC_ht', 'congruent': 6, 'same': False}, 'OP': 'REPM', 'dst': {'type': 'addresses_UC_ht', 'congruent': 2, 'same': False}}
{'32': 21829}
