...
push %rdx
push %rsi
lea addresses_D_ht+0x187f1, %r14
nop
sub $35394, %rsi
...
movups %xmm7, (%r14)
inc %rcx
lea addresses_A_ht+0x1af93, %rdx
nop
nop
nop
nop
...
nop
xor $36559, %rcx
lea addresses_A_ht+0x1a1d3, %rdx
nop
nop
nop
nop
...
vpextrq $1, %xmm3, %rcx
cmp %r15, %r15
lea addresses_UC_ht+0x61c1, %r15
nop
nop
inc %r14
movb (%r15), %cl
nop
add $54342, %rdx
lea addresses_D_ht+0x14f4b, %rdi
and $31970, %r14
mov $0x6162636465666768, %r15
movq %r15, %xmm6
movups %xmm6, (%rdi)
...
{'OP': 'STOR', 'dst': {'same': False, 'type': 'addresses_WT', 'NT': True, 'AVXalign': True, 'size': 2, 'congruent': 9}}
{'OP': 'STOR', 'dst': {'same': False, 'type': 'addresses_PSE', 'NT': False, 'AVXalign': False, 'size': 8, 'congruent': 4}}
{'OP': 'STOR', 'dst': {'same': False, 'type': 'addresses_RW', 'NT': True, 'AVXalign': False, 'size': 2, 'congruent': 1}}
...
{'OP': 'LOAD', 'src': {'same': True, 'type': 'addresses_A_ht', 'NT': True, 'AVXalign': False, 'size': 16, 'congruent': 6}}
