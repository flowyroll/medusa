...
push %rdi
push %rsi
lea addresses_WC_ht+0x258e, %rax
nop
nop
nop
cmp $41820, %r8
...
nop
dec %r13
lea addresses_normal_ht+0x18b0e, %r12
nop
nop
mfence
...
movups %xmm0, (%r12)
cmp $34741, %rax
lea addresses_WT_ht+0x1810e, %rsi
...
nop
add %rsi, %rsi
lea addresses_WT_ht+0x1a0de, %rsi
nop
nop
nop
nop
...
nop
inc %r13
lea addresses_normal_ht+0x460e, %r13
clflush (%r13)
nop
nop
nop
...
nop
xor $5425, %rax
lea addresses_normal_ht+0x14f0e, %r8
nop
nop
nop
nop
...
nop
sub %rsi, %rsi
lea addresses_normal_ht+0x96f6, %r12
dec %r8
mov $0x6162636465666768, %rdi
movq %rdi, %xmm5
movups %xmm5, (%r12)
add $25736, %rax
lea addresses_D_ht+0x11c2e, %r8
nop
nop
nop
nop
...
movw $0x6162, (%r8)
and %rsi, %rsi
lea addresses_WC_ht+0x10d0e, %rsi
nop
nop
and %r8, %r8
movl $0x61626364, (%rsi)
...
nop
and $40643, %rax
lea addresses_WC_ht+0x42ce, %r12
nop
nop
sub $20064, %rsi
vmovups (%r12), %ymm7
...
nop
and $59869, %rdi
lea addresses_WT_ht+0x19bbe, %r13
nop
nop
add $26413, %rcx
movl $0x61626364, (%r13)
nop
sub $18021, %r12
lea addresses_D_ht+0x1e90e, %rsi
lea addresses_D_ht+0x19cae, %rdi
nop
nop
nop
sub $51156, %r8
...
nop
xor %rbp, %rbp
lea addresses_WC_ht+0x64ce, %rsi
nop
nop
add %r8, %r8
movl $0x61626364, (%rsi)
