...
push %rdi
push %rsi
lea addresses_normal_ht+0xf96c, %r9
nop
nop
add $51717, %rcx
movb $0x61, (%r9)
...
nop
dec %r15
lea addresses_normal_ht+0x1756c, %rsi
lea addresses_WT_ht+0x155ac, %rdi
nop
nop
cmp %rbx, %rbx
mov $23, %rcx
...
nop
dec %rbp
lea addresses_UC_ht+0x6a58, %r15
nop
cmp $1458, %r9
...
nop
cmp %rbp, %rbp
lea addresses_WC_ht+0x1ee6c, %rbx
nop
add $6408, %rdi
movb $0x61, (%rbx)
nop
...
nop
and %rcx, %rcx
lea addresses_WC_ht+0x4364, %rcx
sub %rbp, %rbp
movups (%rcx), %xmm5
vpextrq $1, %xmm5, %r9
nop
...
movb $0x61, (%rsi)
dec %r10
lea addresses_D_ht+0x107ec, %rsi
...
nop
dec %rbx
lea addresses_WT_ht+0x9748, %rsi
lea addresses_normal_ht+0x16204, %rdi
nop
nop
nop
xor $12478, %r10
...
nop
xor %rcx, %rcx
lea addresses_WC_ht+0x107c4, %rcx
add %rsi, %rsi
mov $0x6162636465666768, %r15
movq %r15, %xmm5
movups %xmm5, (%rcx)
...
{'src': {'type': 'addresses_normal_ht', 'congruent': 8, 'same': False}, 'OP': 'REPM', 'dst': {'type': 'addresses_WT_ht', 'congruent': 4, 'same': False}}
{'OP': 'STOR', 'dst': {'type': 'addresses_UC_ht', 'AVXalign': False, 'size': 32, 'NT': False, 'same': True, 'congruent': 1}}
{'OP': 'STOR', 'dst': {'type': 'addresses_WC_ht', 'AVXalign': False, 'size': 1, 'NT': True, 'same': False, 'congruent': 9}}
...
{'src': {'type': 'addresses_WT_ht', 'congruent': 1, 'same': False}, 'OP': 'REPM', 'dst': {'type': 'addresses_normal_ht', 'congruent': 3, 'same': True}}
