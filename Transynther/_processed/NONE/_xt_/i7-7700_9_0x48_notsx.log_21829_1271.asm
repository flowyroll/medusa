...
push %rdi
push %rsi
lea addresses_normal_ht+0x11c0f, %r14
nop
nop
cmp %rsi, %rsi
movw $0x6162, (%r14)
nop
and %rax, %rax
lea addresses_UC_ht+0x14e0f, %rsi
lea addresses_WC_ht+0x6e0f, %rdi
clflush (%rsi)
nop
nop
nop
...
rep movsq
xor %r14, %r14
lea addresses_normal_ht+0x9c0f, %rdi
dec %r12
movups (%rdi), %xmm7
vpextrq $0, %xmm7, %rsi
nop
...
nop
xor %r14, %r14
lea addresses_normal_ht+0x18b21, %rcx
nop
nop
nop
nop
...
nop
and %rsi, %rsi
lea addresses_WC_ht+0x165cf, %rsi
nop
nop
nop
nop
...
vpextrq $1, %xmm5, %r14
add $48375, %r14
lea addresses_normal_ht+0x13b4f, %r12
nop
nop
nop
and %r14, %r14
...
nop
sub %rdi, %rdi
lea addresses_WT_ht+0x14bcf, %rdi
nop
nop
nop
nop
...
nop
dec %r14
lea addresses_WT_ht+0x1a00f, %rax
dec %rsi
...
nop
cmp %rax, %rax
lea addresses_WT_ht+0x1a80f, %rdi
nop
nop
nop
inc %rsi
...
nop
add %r10, %r10
lea addresses_WT_ht+0x1a40f, %rsi
lea addresses_WC_ht+0xb40f, %rdi
nop
nop
nop
nop
...
nop
cmp $38798, %r14
lea addresses_A_ht+0x16adb, %rdi
nop
nop
nop
add %r12, %r12
...
<gen_prepare_buffer>
{'dst': {'same': False, 'NT': True, 'AVXalign': True, 'size': 2, 'type': 'addresses_normal_ht', 'congruent': 11}, 'OP': 'STOR'}
{'dst': {'same': False, 'congruent': 9, 'type': 'addresses_WC_ht'}, 'OP': 'REPM', 'src': {'same': False, 'congruent': 9, 'type': 'addresses_UC_ht'}}
...
{'dst': {'same': True, 'congruent': 9, 'type': 'addresses_WC_ht'}, 'OP': 'REPM', 'src': {'same': False, 'congruent': 11, 'type': 'addresses_WT_ht'}}
