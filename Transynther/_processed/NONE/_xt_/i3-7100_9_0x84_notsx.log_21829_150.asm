...
push %rdx
push %rsi
lea addresses_A_ht+0x13d89, %r11
nop
nop
nop
cmp %rcx, %rcx
...
nop
sub %r12, %r12
lea addresses_A_ht+0xda99, %rsi
lea addresses_D_ht+0xfd89, %rdi
clflush (%rsi)
add $30676, %r12
mov $92, %rcx
rep movsw
xor %r11, %r11
lea addresses_A_ht+0xfd79, %r11
clflush (%r11)
nop
nop
nop
...
nop
add %r11, %r11
lea addresses_normal_ht+0x6821, %rsi
and $41727, %r11
mov (%rsi), %edi
nop
inc %r12
lea addresses_A_ht+0x1b729, %rsi
clflush (%rsi)
add $45864, %r14
movb (%rsi), %cl
nop
nop
add %rdi, %rdi
lea addresses_D_ht+0x3b09, %rsi
lea addresses_A_ht+0x12be9, %rdi
nop
nop
nop
nop
...
nop
cmp $51026, %r10
lea addresses_WT_ht+0x139d5, %rsi
lea addresses_normal_ht+0xb889, %rdi
nop
nop
nop
nop
...
{'src': {'type': 'addresses_D_ht', 'congruent': 7, 'same': True}, 'dst': {'type': 'addresses_A_ht', 'congruent': 5, 'same': False}, 'OP': 'REPM'}
