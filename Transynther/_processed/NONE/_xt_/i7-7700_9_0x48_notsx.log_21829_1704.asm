...
push %rdi
push %rsi
lea addresses_A_ht+0xfc00, %r9
clflush (%r9)
nop
and $16961, %r15
movb $0x61, (%r9)
xor $12324, %r15
lea addresses_D_ht+0xc000, %rsi
lea addresses_WC_ht+0x1d164, %rdi
nop
nop
nop
nop
...
nop
xor %r15, %r15
lea addresses_D_ht+0x13000, %r11
nop
nop
inc %r14
mov (%r11), %si
...
{'dst': {'same': False, 'congruent': 2, 'type': 'addresses_WC_ht'}, 'OP': 'REPM', 'src': {'same': False, 'congruent': 10, 'type': 'addresses_D_ht'}}
{'OP': 'LOAD', 'src': {'same': True, 'NT': True, 'AVXalign': False, 'size': 2, 'type': 'addresses_D_ht', 'congruent': 11}}
{'33': 21829}
