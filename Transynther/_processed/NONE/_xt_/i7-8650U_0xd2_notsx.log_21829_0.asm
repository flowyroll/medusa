...
push %rdi
push %rsi
lea addresses_A_ht+0x19222, %r12
nop
nop
nop
nop
...
nop
add $63281, %r10
lea addresses_D_ht+0x15c46, %rsi
lea addresses_D_ht+0xa7c2, %rdi
nop
nop
nop
sub %r12, %r12
...
nop
and $23782, %rdi
lea addresses_WT_ht+0xac62, %r12
nop
nop
nop
nop
...
movl $0x61626364, (%r12)
sub $20376, %rbp
lea addresses_WT_ht+0x1de22, %rsi
lea addresses_UC_ht+0x7922, %rdi
nop
nop
cmp %rbx, %rbx
mov $27, %rcx
...
nop
sub %rbx, %rbx
lea addresses_D_ht+0x18b22, %rsi
nop
nop
nop
and $48219, %rbx
