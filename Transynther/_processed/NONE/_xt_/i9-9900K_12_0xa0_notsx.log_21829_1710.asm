...
push %rdx
push %rsi
lea addresses_WC_ht+0x15061, %rdx
nop
sub $16980, %r11
movw $0x6162, (%rdx)
nop
...
nop
inc %rbp
lea addresses_UC_ht+0x7e7b, %rsi
lea addresses_D_ht+0x6afb, %rdi
nop
nop
cmp %r8, %r8
mov $87, %rcx
...
nop
and $24621, %r14
lea addresses_normal_ht+0x103f7, %rsi
lea addresses_A_ht+0x63ab, %rdi
cmp $25499, %rbp
mov $94, %rcx
rep movsq
nop
...
nop
add $23949, %r8
lea addresses_WT_ht+0x78fb, %rsi
lea addresses_WC_ht+0x1266b, %rdi
nop
sub %r11, %r11
mov $33, %rcx
rep movsl
...
nop
sub %rbp, %rbp
lea addresses_WT_ht+0x1e97b, %rbp
nop
nop
cmp %rcx, %rcx
mov (%rbp), %r14w
...
nop
add $50880, %rcx
lea addresses_WC_ht+0x1b57b, %rsi
lea addresses_WT_ht+0x1acbb, %rdi
nop
cmp $51631, %r14
mov $51, %rcx
rep movsw
...
{'OP': 'STOR', 'dst': {'type': 'addresses_A_ht', 'AVXalign': False, 'size': 4, 'NT': True, 'same': False, 'congruent': 0}}
