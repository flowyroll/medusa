...
push %rdi
push %rsi
lea addresses_WT_ht+0xc9a7, %r10
nop
add %rbx, %rbx
movb $0x61, (%r10)
and %rax, %rax
lea addresses_UC_ht+0x11fa7, %rsi
lea addresses_WC_ht+0x147cf, %rdi
nop
nop
nop
nop
...
nop
cmp $23220, %rsi
lea addresses_normal_ht+0x17ca5, %r10
nop
nop
xor %rdi, %rdi
mov (%r10), %esi
...
nop
sub $51545, %rbx
lea addresses_WT_ht+0x1e9a7, %rsi
lea addresses_WC_ht+0x11067, %rdi
cmp %rbp, %rbp
mov $17, %rcx
rep movsw
nop
...
nop
add %r9, %r9
lea addresses_D_ht+0x16da7, %rsi
lea addresses_D_ht+0xf807, %rdi
nop
nop
nop
nop
...
nop
add %rsi, %rsi
lea addresses_WC_ht+0x4d07, %rcx
clflush (%rcx)
nop
nop
xor $50876, %rdi
...
nop
inc %rcx
lea addresses_WT_ht+0xd3a7, %rdi
nop
add %rcx, %rcx
movb (%rdi), %r10b
nop
...
nop
xor $21463, %r9
lea addresses_normal_ht+0xae27, %rsi
lea addresses_normal_ht+0x17bd7, %rdi
nop
nop
nop
nop
...
rep movsq
xor %rax, %rax
lea addresses_A_ht+0x7667, %rsi
lea addresses_D_ht+0x161a7, %rdi
nop
nop
nop
add %rbx, %rbx
...
movb (%r9), %cl
xor %rcx, %rcx
lea addresses_WT_ht+0x17ea7, %rdi
nop
sub $16907, %rcx
movb (%rdi), %r9b
nop
...
nop
and $13096, %rbx
lea addresses_A_ht+0xb9bb, %rsi
lea addresses_normal_ht+0x9207, %rdi
nop
nop
nop
nop
...
{'OP': 'REPM', 'src': {'type': 'addresses_UC_ht', 'congruent': 6, 'same': False}, 'dst': {'type': 'addresses_WC_ht', 'congruent': 2, 'same': False}}
...
{'OP': 'STOR', 'dst': {'type': 'addresses_WC_ht', 'AVXalign': False, 'congruent': 4, 'size': 8, 'same': True, 'NT': True}}
