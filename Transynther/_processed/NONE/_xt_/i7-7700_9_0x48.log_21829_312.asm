...
nop
xor %rax, %rax
lea addresses_WC_ht+0xbd54, %rax
nop
nop
nop
and %r8, %r8
...
nop
xor %rax, %rax
lea addresses_WC_ht+0xd124, %rdx
nop
nop
nop
sub %r15, %r15
...
nop
cmp %r15, %r15
lea addresses_D_ht+0x117c9, %r14
nop
nop
nop
nop
...
nop
and %r8, %r8
lea addresses_WT_ht+0x11723, %r11
nop
nop
nop
dec %r14
...
nop
inc %rdx
lea addresses_A_ht+0x13154, %rsi
lea addresses_UC_ht+0xa094, %rdi
nop
dec %r11
mov $124, %rcx
rep movsq
...
nop
sub $6553, %r15
lea addresses_normal_ht+0x1d620, %r8
nop
add %rsi, %rsi
...
{'OP': 'STOR', 'dst': {'type': 'addresses_WC_ht', 'AVXalign': True, 'congruent': 10, 'size': 2, 'same': False, 'NT': False}}
