...
push %rdx
push %rsi
lea addresses_normal_ht+0x6f53, %r15
clflush (%r15)
nop
nop
and $34978, %rdx
...
nop
dec %r13
lea addresses_D_ht+0xb0bb, %rsi
lea addresses_UC_ht+0x1e7f3, %rdi
nop
nop
nop
nop
...
nop
and %rdi, %rdi
lea addresses_normal_ht+0x1b6f3, %rsi
lea addresses_WT_ht+0x10b05, %rdi
nop
inc %rdx
mov $74, %rcx
rep movsl
...
nop
and %rcx, %rcx
lea addresses_normal_ht+0x1d973, %rsi
lea addresses_D_ht+0x18ef3, %rdi
nop
xor %r9, %r9
mov $71, %rcx
rep movsq
...
nop
inc %rsi
lea addresses_WC_ht+0x1b6f3, %rdi
nop
and $26538, %rdx
...
nop
sub $42499, %r15
lea addresses_WC_ht+0x1a211, %rcx
nop
cmp $6736, %r9
movb (%rcx), %r15b
xor $5117, %r13
...
{'src': {'type': 'addresses_normal_ht', 'congruent': 7, 'same': True}, 'OP': 'REPM', 'dst': {'type': 'addresses_D_ht', 'congruent': 10, 'same': False}}
