...
push %rdi
push %rsi
lea addresses_D_ht+0x139f0, %r13
nop
nop
nop
nop
...
nop
sub %rbp, %rbp
lea addresses_WC_ht+0x18870, %r12
nop
nop
nop
nop
...
nop
inc %r12
lea addresses_A_ht+0x1de98, %r14
dec %rsi
movb $0x61, (%r14)
dec %r12
lea addresses_WC_ht+0x570, %rsi
lea addresses_WC_ht+0xb0, %rdi
sub $48168, %r12
mov $127, %rcx
rep movsq
nop
...
nop
and $65156, %rcx
lea addresses_A_ht+0x18370, %rbp
nop
xor $12247, %r10
movw $0x6162, (%rbp)
nop
nop
and %r8, %r8
lea addresses_WC_ht+0x5f70, %rsi
lea addresses_A_ht+0x167f0, %rdi
nop
nop
nop
nop
...
nop
xor $9131, %r8
lea addresses_WT_ht+0x17d70, %rdi
nop
nop
nop
nop
...
{'OP': 'STOR', 'dst': {'same': False, 'type': 'addresses_WT_ht', 'NT': False, 'AVXalign': True, 'size': 1, 'congruent': 9}}
{'39': 21829}
