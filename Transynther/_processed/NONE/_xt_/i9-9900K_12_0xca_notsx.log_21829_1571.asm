...
push %rdi
push %rsi
lea addresses_UC_ht+0x21de, %r12
nop
nop
and %r11, %r11
movb (%r12), %r15b
...
nop
and %r13, %r13
lea addresses_WC_ht+0x1517a, %r11
clflush (%r11)
xor $6899, %r13
...
nop
add $49386, %rsi
lea addresses_A_ht+0x1072a, %rbx
nop
nop
nop
nop
...
movups %xmm5, (%rbx)
xor $14087, %r13
lea addresses_normal_ht+0x119b1, %r15
nop
nop
nop
nop
...
nop
sub $47201, %rbx
lea addresses_A_ht+0xb0ba, %rsi
lea addresses_WC_ht+0x17d2e, %rdi
and $23639, %r11
mov $123, %rcx
rep movsl
cmp $55757, %r13
lea addresses_WT_ht+0x1b92e, %r12
dec %rdi
movl $0x61626364, (%r12)
nop
nop
...
nop
and %r15, %r15
lea addresses_UC_ht+0x832e, %rcx
and $17777, %r11
movb $0x61, (%rcx)
nop
nop
...
nop
and %rdi, %rdi
lea addresses_WT_ht+0x162ae, %rsi
lea addresses_A_ht+0x1093e, %rdi
nop
nop
nop
nop
...
nop
sub $9412, %r12
lea addresses_UC_ht+0x8e1a, %rsi
lea addresses_A_ht+0x1612e, %rdi
nop
nop
nop
nop
...
{'OP': 'REPM', 'src': {'same': False, 'congruent': 6, 'type': 'addresses_WT_ht'}, 'dst': {'same': False, 'congruent': 4, 'type': 'addresses_A_ht'}}
