...
push %rdi
push %rsi
lea addresses_normal_ht+0x26ee, %r12
dec %rbp
...
nop
inc %rsi
lea addresses_WT_ht+0x143ee, %rax
nop
nop
nop
nop
...
nop
xor $23336, %r14
lea addresses_UC_ht+0x198ee, %rsi
...
nop
dec %r14
lea addresses_D_ht+0x88ee, %rsi
lea addresses_WT_ht+0x1e2ae, %rdi
nop
nop
nop
nop
...
nop
xor $21566, %rbp
lea addresses_WC_ht+0xa246, %r14
nop
nop
nop
sub %r15, %r15
...
nop
and $24721, %rcx
lea addresses_WC_ht+0x192b6, %r12
sub $2777, %r15
movb $0x61, (%r12)
cmp $22148, %r15
pop %rsi
...
{'OP': 'REPM', 'src': {'same': False, 'congruent': 9, 'type': 'addresses_UC_ht'}, 'dst': {'same': True, 'congruent': 10, 'type': 'addresses_A_ht'}}
{'OP': 'STOR', 'dst': {'same': False, 'type': 'addresses_A_ht', 'NT': False, 'AVXalign': False, 'size': 8, 'congruent': 6}}
{'OP': 'REPM', 'src': {'same': False, 'congruent': 9, 'type': 'addresses_D_ht'}, 'dst': {'same': False, 'congruent': 6, 'type': 'addresses_WT_ht'}}
