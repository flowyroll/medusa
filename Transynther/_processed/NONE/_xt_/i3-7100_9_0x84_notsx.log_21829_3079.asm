...
push %rdx
push %rsi
lea addresses_normal_ht+0x1569, %rsi
lea addresses_A_ht+0x11a29, %rdi
clflush (%rsi)
nop
nop
nop
...
rep movsl
mfence
lea addresses_UC_ht+0x3c49, %r15
add $11237, %r13
movups (%r15), %xmm2
vpextrq $0, %xmm2, %rdx
nop
nop
sub %rsi, %rsi
lea addresses_WT_ht+0xfa89, %rsi
lea addresses_D_ht+0x13ae9, %rdi
clflush (%rdi)
nop
nop
nop
...
nop
add %rsi, %rsi
lea addresses_A_ht+0x19f69, %rcx
nop
nop
sub %r8, %r8
...
nop
inc %rdx
lea addresses_UC_ht+0x7f69, %rsi
lea addresses_WC_ht+0x3769, %rdi
clflush (%rdi)
nop
nop
nop
...
nop
dec %r13
lea addresses_normal_ht+0x162e9, %r8
nop
cmp %rsi, %rsi
mov (%r8), %r15
dec %r13
lea addresses_WT_ht+0xcc99, %rdx
nop
nop
nop
nop
...
rep movsb
add %rdx, %rdx
lea addresses_A_ht+0x14769, %rsi
lea addresses_A_ht+0xc4eb, %rdi
nop
nop
add %r13, %r13
mov $17, %rcx
...
nop
xor $58853, %r15
lea addresses_normal_ht+0x76d1, %rdx
nop
nop
nop
nop
...
nop
add %r15, %r15
lea addresses_D_ht+0x5769, %rsi
lea addresses_normal_ht+0xacbf, %rdi
nop
cmp $34782, %rdx
mov $120, %rcx
rep movsl
add %r13, %r13
lea addresses_D_ht+0xf89d, %r8
sub %rdx, %rdx
...
// Store
lea addresses_normal+0x878b, %rax
nop
nop
nop
nop
...
{'dst': {'type': 'addresses_A_ht', 'same': True, 'size': 8, 'congruent': 7, 'NT': False, 'AVXalign': False}, 'OP': 'STOR'}
...
{'src': {'type': 'addresses_A_ht', 'congruent': 10, 'same': False}, 'dst': {'type': 'addresses_A_ht', 'congruent': 1, 'same': False}, 'OP': 'REPM'}
