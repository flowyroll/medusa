...
// Load
lea addresses_normal+0xf6f7, %rdi
nop
nop
sub $56046, %rdx
mov (%rdi), %rax
...
// Faulty Load
lea addresses_normal+0x12270, %rdx
nop
nop
nop
dec %r11
...
{'OP': 'STOR', 'dst': {'same': False, 'congruent': 0, 'NT': False, 'type': 'addresses_UC', 'size': 2, 'AVXalign': True}}
...
{'OP': 'STOR', 'dst': {'same': False, 'congruent': 2, 'NT': True, 'type': 'addresses_NC', 'size': 4, 'AVXalign': False}}
{'OP': 'STOR', 'dst': {'same': False, 'congruent': 3, 'NT': False, 'type': 'addresses_P', 'size': 1, 'AVXalign': True}}
[Faulty Load]
