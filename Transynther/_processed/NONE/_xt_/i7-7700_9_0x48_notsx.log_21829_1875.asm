...
push %rdi
push %rsi
lea addresses_WC_ht+0x149cf, %rsi
lea addresses_A_ht+0x10ccf, %rdi
cmp $28058, %r12
mov $123, %rcx
rep movsw
inc %r9
lea addresses_UC_ht+0x1b9cf, %rsi
lea addresses_WC_ht+0x13c8b, %rdi
nop
add %rbp, %rbp
mov $17, %rcx
rep movsb
...
nop
sub %rbp, %rbp
lea addresses_A_ht+0x1a253, %rbp
xor %rbx, %rbx
mov (%rbp), %rdi
nop
nop
nop
add %r9, %r9
lea addresses_A_ht+0x1210f, %rcx
add $19742, %rbx
...
// Store
lea addresses_normal+0x57db, %r13
nop
and %r8, %r8
movw $0x5152, (%r13)
nop
...
<gen_prepare_buffer>
{'dst': {'same': False, 'congruent': 7, 'type': 'addresses_A_ht'}, 'OP': 'REPM', 'src': {'same': False, 'congruent': 11, 'type': 'addresses_WC_ht'}}
{'dst': {'same': False, 'congruent': 2, 'type': 'addresses_WC_ht'}, 'OP': 'REPM', 'src': {'same': True, 'congruent': 10, 'type': 'addresses_UC_ht'}}
