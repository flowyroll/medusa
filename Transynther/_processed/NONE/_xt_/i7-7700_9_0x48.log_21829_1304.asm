...
nop
xor %rbx, %rbx
lea addresses_WT_ht+0x13704, %r9
clflush (%r9)
nop
and %rdx, %rdx
...
nop
sub $54983, %r13
lea addresses_WT_ht+0x50d4, %rdx
nop
nop
nop
nop
...
nop
inc %rdx
lea addresses_UC_ht+0xe404, %rdx
sub %rdi, %rdi
movups (%rdx), %xmm1
vpextrq $0, %xmm1, %r13
nop
...
nop
sub $30032, %rbx
lea addresses_UC_ht+0x8e5c, %rsi
lea addresses_WT_ht+0x4b84, %rdi
nop
nop
nop
nop
...
nop
inc %rdx
lea addresses_A_ht+0x10004, %rsi
lea addresses_normal_ht+0xc746, %rdi
nop
nop
nop
nop
...
nop
sub %rbx, %rbx
lea addresses_UC_ht+0xd804, %rbp
nop
nop
sub %r13, %r13
mov (%rbp), %r11d
...
nop
cmp %rsi, %rsi
lea addresses_normal_ht+0x11ea4, %rsi
lea addresses_WC_ht+0xb71e, %rdi
nop
nop
nop
nop
...
{'OP': 'STOR', 'dst': {'type': 'addresses_WT_ht', 'AVXalign': False, 'congruent': 4, 'size': 32, 'same': False, 'NT': True}}
...
{'OP': 'STOR', 'dst': {'type': 'addresses_UC_ht', 'AVXalign': False, 'congruent': 5, 'size': 16, 'same': False, 'NT': True}}
{'OP': 'REPM', 'src': {'type': 'addresses_UC_ht', 'congruent': 2, 'same': False}, 'dst': {'type': 'addresses_WT_ht', 'congruent': 7, 'same': False}}
{'OP': 'REPM', 'src': {'type': 'addresses_A_ht', 'congruent': 10, 'same': False}, 'dst': {'type': 'addresses_normal_ht', 'congruent': 1, 'same': True}}
