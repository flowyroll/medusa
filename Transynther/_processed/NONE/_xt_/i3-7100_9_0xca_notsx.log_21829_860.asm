...
push %rdx
push %rsi
lea addresses_normal_ht+0x5c36, %rdx
nop
nop
nop
nop
...
nop
inc %rbx
lea addresses_WT_ht+0x14612, %rbp
nop
cmp %r11, %r11
...
nop
add %r11, %r11
lea addresses_normal_ht+0x5812, %rbx
nop
nop
nop
nop
...
nop
add $47430, %rdi
lea addresses_WC_ht+0x6c12, %rdx
nop
nop
nop
nop
...
movb (%rdx), %r11b
xor $57662, %r15
lea addresses_A_ht+0x1c712, %rsi
lea addresses_UC_ht+0xa9e2, %rdi
nop
nop
nop
nop
...
nop
cmp %r11, %r11
lea addresses_normal_ht+0x14012, %rcx
nop
nop
nop
nop
...
nop
sub $27714, %rbx
lea addresses_normal_ht+0x1b212, %rsi
lea addresses_UC_ht+0xc1b2, %rdi
nop
inc %rbp
mov $106, %rcx
rep movsb
...
nop
add $30360, %r11
lea addresses_UC_ht+0x3e6a, %rcx
nop
nop
and %rdx, %rdx
mov $0x6162636465666768, %r15
...
nop
cmp %rsi, %rsi
lea addresses_A_ht+0x198f2, %rdi
nop
nop
nop
nop
...
lea addresses_A_ht+0x1187a, %rdi
nop
nop
cmp %rdx, %rdx
mov $1, %rcx
...
// Store
lea addresses_normal+0x11012, %r12
nop
nop
nop
xor %rcx, %rcx
...
// Store
lea addresses_UC+0x1ebba, %rcx
cmp %r12, %r12
movl $0x51525354, (%rcx)
cmp $35464, %r8

// Load
lea addresses_WT+0xf45a, %r12
nop
nop
sub $32530, %rbx
mov (%r12), %r8d
...
{'OP': 'STOR', 'dst': {'same': False, 'congruent': 2, 'NT': False, 'type': 'addresses_WT_ht', 'size': 4, 'AVXalign': True}}
...
{'src': {'type': 'addresses_normal_ht', 'congruent': 6, 'same': False}, 'OP': 'REPM', 'dst': {'type': 'addresses_A_ht', 'congruent': 3, 'same': False}}
{'33': 21829}
