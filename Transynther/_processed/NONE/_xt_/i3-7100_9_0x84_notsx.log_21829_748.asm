...
push %rdi
push %rsi
lea addresses_UC_ht+0x8a3a, %rsi
lea addresses_WT_ht+0xa26a, %rdi
nop
nop
nop
nop
...
nop
sub $21500, %rax
lea addresses_D_ht+0x1549c, %rsi
lea addresses_normal_ht+0x7dfa, %rdi
nop
nop
nop
nop
...
nop
sub %rsi, %rsi
lea addresses_WT_ht+0xac3a, %rdi
nop
nop
nop
nop
...
nop
cmp $20702, %rdi
lea addresses_normal_ht+0xde3a, %rsi
nop
nop
sub $104, %rdi
movl $0x61626364, (%rsi)
...
nop
cmp $60408, %r13
lea addresses_A_ht+0x1123a, %rcx
nop
cmp $6418, %rdi
...
{'src': {'type': 'addresses_D_ht', 'congruent': 1, 'same': False}, 'dst': {'type': 'addresses_normal_ht', 'congruent': 6, 'same': False}, 'OP': 'REPM'}
{'dst': {'type': 'addresses_WT_ht', 'same': False, 'size': 2, 'congruent': 9, 'NT': False, 'AVXalign': False}, 'OP': 'STOR'}
{'dst': {'type': 'addresses_normal_ht', 'same': False, 'size': 4, 'congruent': 10, 'NT': True, 'AVXalign': True}, 'OP': 'STOR'}
