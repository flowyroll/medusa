...
push %rdx
push %rsi
lea addresses_WC_ht+0x92dd, %r11
and %r9, %r9
movl $0x61626364, (%r11)
nop
nop
...
nop
inc %rbp
lea addresses_WT_ht+0x1ae6d, %r10
and $35661, %r11
mov (%r10), %r15d
nop
nop
...
nop
xor %r10, %r10
lea addresses_WT_ht+0xe7d5, %rsi
lea addresses_D_ht+0x14bed, %rdi
nop
nop
nop
cmp $13832, %r11
...
nop
and %rdx, %rdx
lea addresses_WT_ht+0x814d, %rcx
dec %r11
vmovups (%rcx), %ymm5
...
nop
xor %rdx, %rdx
lea addresses_normal_ht+0x1c3ad, %rbp
nop
nop
add %rdx, %rdx
movw $0x6162, (%rbp)
...
nop
sub %r9, %r9
lea addresses_WT_ht+0x11399, %rdi
nop
nop
inc %r11
movb (%rdi), %r9b
...
nop
cmp %r15, %r15
lea addresses_normal_ht+0xd94d, %rdi
nop
nop
and $19567, %rcx
movups (%rdi), %xmm1
vpextrq $0, %xmm1, %r11
add $41071, %r10
lea addresses_WC_ht+0x110cd, %rsi
clflush (%rsi)
xor %r15, %r15
...
nop
xor %rdi, %rdi
lea addresses_A_ht+0x6d4d, %rsi
and $52352, %r11
mov (%rsi), %cx
dec %r10
lea addresses_D_ht+0x125ad, %rsi
lea addresses_UC_ht+0xc94d, %rdi
nop
nop
nop
nop
...
nop
cmp $39125, %r15
lea addresses_D_ht+0x1554d, %rsi
lea addresses_WC_ht+0x4b3d, %rdi
nop
nop
nop
nop
...
nop
and $32051, %r11
lea addresses_normal_ht+0x16305, %r15
nop
nop
nop
nop
...
nop
and %r11, %r11
lea addresses_WT_ht+0x234d, %rcx
nop
nop
nop
nop
...
nop
sub %rcx, %rcx
lea addresses_UC_ht+0x1894d, %rsi
...
<gen_faulty_load>
[REF]
{'OP': 'LOAD', 'src': {'type': 'addresses_UC', 'size': 2, 'AVXalign': True, 'NT': True, 'congruent': 0, 'same': False}}
...
{'OP': 'LOAD', 'src': {'type': 'addresses_WT_ht', 'size': 1, 'AVXalign': False, 'NT': False, 'congruent': 0, 'same': True}}
...
{'OP': 'REPM', 'src': {'type': 'addresses_D_ht', 'congruent': 5, 'same': False}, 'dst': {'type': 'addresses_UC_ht', 'congruent': 8, 'same': False}}
