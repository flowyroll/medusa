...
push %rdx
push %rsi
lea addresses_WT_ht+0xb4d4, %r15
xor $33475, %r11
...
nop
xor %rbp, %rbp
lea addresses_WC_ht+0x113f6, %rsi
lea addresses_A_ht+0x95f6, %rdi
nop
nop
xor %r15, %r15
mov $124, %rcx
