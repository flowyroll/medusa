...
nop
xor %rdi, %rdi
lea addresses_A_ht+0x10180, %rsi
lea addresses_WC_ht+0x1ee87, %rdi
nop
nop
nop
nop
...
rep movsl
sub %r12, %r12
lea addresses_normal_ht+0x19c87, %rdi
clflush (%rdi)
and %r12, %r12
mov (%rdi), %ebx
nop
...
nop
sub $16161, %rdi
lea addresses_UC_ht+0x3b79, %r12
clflush (%r12)
nop
nop
nop
...
nop
lfence
lea addresses_WC_ht+0xe687, %rsi
nop
nop
nop
and %rcx, %rcx
...
nop
dec %rcx
lea addresses_WT_ht+0x1cbc7, %r12
and %r8, %r8
movb (%r12), %cl
nop
xor %rdi, %rdi
lea addresses_WT_ht+0x129c7, %rsi
lea addresses_WC_ht+0x1e261, %rdi
nop
nop
nop
cmp $23392, %r9
...
// Faulty Load
lea addresses_normal+0x1f687, %rax
nop
nop
sub $22819, %r9
movb (%rax), %r10b
...
{'OP': 'STOR', 'dst': {'type': 'addresses_D_ht', 'size': 8, 'AVXalign': False, 'NT': False, 'congruent': 4, 'same': True}}
{'34': 10550}
