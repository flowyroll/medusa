...
push %rdx
push %rsi
lea addresses_normal_ht+0x13c42, %rcx
nop
nop
nop
nop
...
nop
cmp %r11, %r11
lea addresses_WC_ht+0x2de9, %r11
nop
cmp %r8, %r8
mov (%r11), %rdx
nop
cmp $42164, %rbp
lea addresses_D_ht+0x11102, %r12
nop
nop
add %rdx, %rdx
movl $0x61626364, (%r12)
...
nop
xor $4315, %rdx
lea addresses_D_ht+0x1ab4e, %rsi
lea addresses_D_ht+0x7ece, %rdi
nop
sub %rdx, %rdx
mov $22, %rcx
rep movsw
...
nop
and %r12, %r12
lea addresses_normal_ht+0x1c8e6, %rdi
nop
nop
nop
nop
...
nop
add %r11, %r11
lea addresses_UC_ht+0x1c74e, %rsi
nop
nop
nop
sub $19916, %r8
