...
push %rdx
push %rsi
lea addresses_D_ht+0x1d947, %rsi
lea addresses_A_ht+0x9f8f, %rdi
nop
nop
xor $23898, %rdx
mov $99, %rcx
...
nop
inc %rax
lea addresses_WC_ht+0x1140f, %rdx
nop
nop
nop
nop
...
nop
sub $47923, %rcx
lea addresses_normal_ht+0xc20f, %rsi
lea addresses_D_ht+0x8a0f, %rdi
nop
nop
nop
and $54167, %r13
...
nop
inc %rcx
lea addresses_normal_ht+0xc8e7, %rsi
lea addresses_A_ht+0x848f, %rdi
nop
dec %r13
mov $50, %rcx
rep movsq
nop
and %r9, %r9
lea addresses_WT_ht+0xba0f, %r9
xor %rcx, %rcx
movb $0x61, (%r9)
nop
nop
add $47893, %rdi
lea addresses_WC_ht+0x94ff, %rsi
lea addresses_A_ht+0x1584b, %rdi
and $31217, %rax
mov $36, %rcx
rep movsl
nop
dec %r15
lea addresses_A_ht+0x9b8f, %r15
nop
nop
nop
dec %rcx
...
nop
and %r15, %r15
lea addresses_D_ht+0xad0f, %rsi
lea addresses_UC_ht+0x840f, %rdi
nop
nop
add %r13, %r13
mov $46, %rcx
...
nop
cmp %r15, %r15
lea addresses_D_ht+0x1a60f, %rdx
nop
nop
add %r15, %r15
mov (%rdx), %ecx
nop
cmp $22252, %r9
lea addresses_D_ht+0x1d38f, %r13
nop
nop
mfence
...
nop
sub %r13, %r13
lea addresses_D_ht+0x148f, %r13
nop
add $17457, %rdi
movb (%r13), %al
nop
xor %r13, %r13
lea addresses_UC_ht+0x12a0f, %r15
nop
xor $46602, %rcx
mov (%r15), %r9
nop
...
{'OP': 'LOAD', 'src': {'size': 32, 'NT': False, 'type': 'addresses_D', 'same': False, 'AVXalign': False, 'congruent': 1}}
...
<gen_prepare_buffer>
{'OP': 'REPM', 'src': {'same': False, 'type': 'addresses_D_ht', 'congruent': 3}, 'dst': {'same': False, 'type': 'addresses_A_ht', 'congruent': 7}}
...
{'OP': 'REPM', 'src': {'same': False, 'type': 'addresses_normal_ht', 'congruent': 11}, 'dst': {'same': False, 'type': 'addresses_D_ht', 'congruent': 10}}
{'OP': 'REPM', 'src': {'same': False, 'type': 'addresses_normal_ht', 'congruent': 3}, 'dst': {'same': False, 'type': 'addresses_A_ht', 'congruent': 7}}
{'OP': 'STOR', 'dst': {'size': 1, 'NT': False, 'type': 'addresses_WT_ht', 'same': False, 'AVXalign': True, 'congruent': 11}}
