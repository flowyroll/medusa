...
push %rdx
push %rsi
lea addresses_A_ht+0x13bc5, %rbx
clflush (%rbx)
nop
nop
and %r13, %r13
...
nop
xor %r8, %r8
lea addresses_WT_ht+0x1a738, %rdi
nop
nop
and %r13, %r13
...
nop
xor $8683, %rdi
lea addresses_A_ht+0x11f38, %rsi
lea addresses_WT_ht+0x19bc, %rdi
nop
nop
nop
nop
...
rep movsw
sub %r13, %r13
lea addresses_normal_ht+0x1788, %r12
nop
nop
nop
sub %rsi, %rsi
...
nop
add %r8, %r8
lea addresses_D_ht+0x38, %rsi
lea addresses_normal_ht+0x7c20, %rdi
nop
nop
add $22876, %rbx
mov $13, %rcx
...
nop
sub $7333, %rcx
lea addresses_WC_ht+0x1be78, %rsi
nop
nop
nop
cmp $46321, %rdi
...
// Load
lea addresses_normal+0x4838, %r10
inc %r11
movups (%r10), %xmm3
vpextrq $1, %xmm3, %rbx
nop
...
{'OP': 'STOR', 'dst': {'type': 'addresses_UC', 'AVXalign': True, 'congruent': 10, 'size': 4, 'same': False, 'NT': False}}
