...
nop
and $18502, %rdx
lea addresses_WC_ht+0x1598f, %rsi
lea addresses_UC_ht+0x18847, %rdi
clflush (%rsi)
nop
nop
inc %rdx
...
lea addresses_normal_ht+0xaf07, %rdi
clflush (%rsi)
nop
nop
nop
...
nop
add $14207, %rdx
lea addresses_normal_ht+0x16e3d, %rsi
lea addresses_UC_ht+0xb78b, %rdi
nop
nop
nop
xor %r14, %r14
...
nop
dec %rdi
lea addresses_UC_ht+0x10907, %rsi
lea addresses_UC_ht+0x5507, %rdi
nop
dec %r9
mov $127, %rcx
rep movsl
nop
xor $23342, %rcx
lea addresses_WC_ht+0x9a07, %rbx
xor %r14, %r14
mov (%rbx), %rsi
nop
nop
...
nop
sub $26995, %r14
lea addresses_normal_ht+0xb507, %rdx
nop
nop
nop
nop
...
nop
add $53963, %r10
lea addresses_WT_ht+0x8e35, %rsi
nop
nop
nop
nop
...
nop
xor $13295, %rdx
lea addresses_WC_ht+0x4d07, %rsi
lea addresses_normal_ht+0xcb7, %rdi
nop
nop
nop
nop
...
nop
xor %rsi, %rsi
lea addresses_WT_ht+0x9fd1, %rsi
lea addresses_D_ht+0x11667, %rdi
nop
nop
cmp %r9, %r9
mov $85, %rcx
...
{'src': {'type': 'addresses_normal_ht', 'congruent': 0, 'same': True}, 'dst': {'type': 'addresses_UC_ht', 'congruent': 1, 'same': False}, 'OP': 'REPM'}
...
{'src': {'type': 'addresses_WT_ht', 'congruent': 1, 'same': False}, 'dst': {'type': 'addresses_D_ht', 'congruent': 3, 'same': False}, 'OP': 'REPM'}
{'32': 21829}
