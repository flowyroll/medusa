...
nop
dec %rcx
lea addresses_WT_ht+0x18ea5, %r11
clflush (%r11)
nop
dec %r12
mov (%r11), %r10w
nop
dec %rdi
lea addresses_WC_ht+0x8cc9, %r11
sub %r8, %r8
mov (%r11), %r12
nop
nop
...
nop
add %r11, %r11
lea addresses_WC_ht+0x17775, %rsi
lea addresses_UC_ht+0x1a07d, %rdi
nop
nop
nop
nop
...
nop
and %r12, %r12
lea addresses_WT_ht+0x7ba5, %rdi
and $17806, %r10
...
nop
sub $37886, %r13
lea addresses_normal_ht+0x5ba5, %rsi
nop
nop
nop
inc %r13
...
nop
cmp $13865, %r10
lea addresses_D_ht+0x117a5, %rcx
dec %r11
...
nop
add %r8, %r8
lea addresses_A_ht+0x15ced, %rsi
nop
nop
nop
nop
...
mov (%rsi), %r13d
sub $13064, %r10
lea addresses_UC_ht+0x123a5, %r11
nop
and $31923, %r12
mov (%r11), %r10w
nop
nop
and %r13, %r13
lea addresses_WC_ht+0x1a0d5, %rsi
lea addresses_D_ht+0x11ec9, %rdi
nop
and %r13, %r13
mov $69, %rcx
rep movsq
...
nop
xor $59384, %rdi
lea addresses_A_ht+0x133a5, %r13
nop
nop
nop
add $29949, %r12
...
nop
inc %rcx
lea addresses_WT_ht+0x133a5, %r8
clflush (%r8)
add %r13, %r13
movw $0x6162, (%r8)
nop
...
nop
dec %r11
lea addresses_UC_ht+0x187a5, %r8
nop
nop
nop
nop
...
{'OP': 'LOAD', 'src': {'same': False, 'type': 'addresses_UC_ht', 'NT': False, 'AVXalign': True, 'size': 4, 'congruent': 7}}
