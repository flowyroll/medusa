...
push %rdx
push %rsi
lea addresses_A_ht+0x1b24f, %rdx
nop
xor %rcx, %rcx
movl $0x61626364, (%rdx)
nop
...
nop
cmp %rcx, %rcx
lea addresses_WT_ht+0x9a8f, %rsi
lea addresses_WT_ht+0x18f4f, %rdi
and %rax, %rax
mov $57, %rcx
rep movsq
nop
nop
and $11888, %rdx
lea addresses_WT_ht+0x1062f, %rsi
and $271, %r12
movl $0x61626364, (%rsi)
nop
sub $8258, %r10
lea addresses_normal_ht+0x1bd8f, %rdi
nop
nop
nop
and $47983, %rcx
...
nop
inc %r12
lea addresses_WT_ht+0xa24f, %rsi
lea addresses_normal_ht+0x19ae3, %rdi
sub %rbx, %rbx
mov $56, %rcx
rep movsq
nop
...
nop
xor %rcx, %rcx
lea addresses_normal_ht+0x13b3f, %rsi
lea addresses_WT_ht+0x1de4f, %rdi
and $63607, %r10
mov $63, %rcx
rep movsq
nop
nop
sub %rsi, %rsi
lea addresses_A_ht+0x7a4f, %rsi
lea addresses_normal_ht+0x4a7f, %rdi
nop
nop
nop
nop
...
{'OP': 'REPM', 'src': {'type': 'addresses_A_ht', 'congruent': 11, 'same': False}, 'dst': {'type': 'addresses_normal_ht', 'congruent': 4, 'same': False}}
{'32': 1070}
