...
nop
add %rbx, %rbx
lea addresses_normal_ht+0x1c6ac, %r11
nop
cmp %r15, %r15
mov (%r11), %bp
nop
...
nop
xor %r12, %r12
lea addresses_UC_ht+0x78ac, %r14
nop
nop
nop
cmp %rbp, %rbp
...
nop
add %r14, %r14
lea addresses_WT_ht+0xc1fc, %rsi
lea addresses_normal_ht+0x190ac, %rdi
clflush (%rdi)
nop
nop
nop
...
nop
add $55102, %rbp
lea addresses_WT_ht+0x146c, %rsi
...
nop
dec %rdi
lea addresses_normal_ht+0x1202c, %r12
nop
nop
nop
nop
...
// Load
lea addresses_normal+0x1d3ac, %rdi
and $59608, %rsi
movb (%rdi), %dl
nop
xor %r9, %r9
...
{'OP': 'LOAD', 'src': {'same': False, 'type': 'addresses_normal', 'NT': False, 'AVXalign': False, 'size': 1, 'congruent': 8}}
[Faulty Load]
...
{'OP': 'STOR', 'dst': {'same': True, 'type': 'addresses_normal_ht', 'NT': False, 'AVXalign': False, 'size': 4, 'congruent': 7}}
{'37': 21829}
