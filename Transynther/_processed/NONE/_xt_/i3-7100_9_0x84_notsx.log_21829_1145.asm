...
// REPMOV
lea addresses_WC+0x1a1c9, %rsi
lea addresses_WT+0x64e9, %rdi
nop
nop
nop
inc %r12
...
{'src': {'type': 'addresses_WC', 'congruent': 0, 'same': True}, 'dst': {'type': 'addresses_WT', 'congruent': 0, 'same': False}, 'OP': 'REPM'}
