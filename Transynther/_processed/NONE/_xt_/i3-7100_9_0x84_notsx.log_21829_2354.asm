...
push %rdi
push %rsi
lea addresses_WC_ht+0x7eb3, %rbx
nop
xor $12407, %rax
...
nop
add %r14, %r14
lea addresses_A_ht+0xb133, %rsi
lea addresses_D_ht+0x18e37, %rdi
nop
add %r9, %r9
mov $112, %rcx
rep movsb
...
nop
add $57172, %rbp
lea addresses_WC_ht+0x149ab, %rdi
clflush (%rdi)
nop
nop
nop
...
mov (%rdi), %esi
dec %rsi
lea addresses_UC_ht+0x19eb0, %rax
nop
nop
nop
nop
...
nop
cmp %rdi, %rdi
lea addresses_WC_ht+0xe93, %r9
clflush (%r9)
and $11879, %rax
movw $0x6162, (%r9)
nop
sub %r9, %r9
lea addresses_UC_ht+0x19033, %rbx
clflush (%rbx)
nop
and %rcx, %rcx
movb $0x61, (%rbx)
...
nop
add %r9, %r9
lea addresses_UC_ht+0x1cef3, %rbp
and $25962, %rcx
...
nop
cmp %rcx, %rcx
lea addresses_WC_ht+0xd643, %rsi
lea addresses_D_ht+0x95d3, %rdi
nop
nop
nop
nop
...
{'src': {'type': 'addresses_D_ht', 'same': False, 'size': 2, 'congruent': 4, 'NT': False, 'AVXalign': True}, 'OP': 'LOAD'}
...
{'dst': {'type': 'addresses_UC_ht', 'same': False, 'size': 32, 'congruent': 6, 'NT': True, 'AVXalign': True}, 'OP': 'STOR'}
