...
push %rdi
push %rsi
lea addresses_WT_ht+0xa4d3, %rbp
nop
nop
and $52973, %r12
mov (%rbp), %r15
...
lea addresses_WC_ht+0x9713, %rdi
and %r10, %r10
mov $47, %rcx
rep movsq
nop
...
nop
inc %rcx
lea addresses_D_ht+0x12b13, %r15
nop
and %r13, %r13
...
mov (%r15), %bp
and %r12, %r12
lea addresses_normal_ht+0x5433, %rsi
xor $64020, %r12
...
nop
inc %rbp
lea addresses_A_ht+0x18413, %rsi
lea addresses_D_ht+0x11893, %rdi
clflush (%rdi)
nop
nop
nop
