...
push %rdi
push %rsi
lea addresses_normal_ht+0x3c5, %r14
nop
nop
xor %r13, %r13
...
nop
mfence
lea addresses_WC_ht+0x714f, %rcx
nop
nop
nop
lfence
...
nop
add $16610, %r8
lea addresses_UC_ht+0x33c5, %r12
nop
nop
nop
inc %r14
...
nop
dec %r14
lea addresses_WT_ht+0xeaa5, %r11
clflush (%r11)
nop
and $46258, %r13
mov (%r11), %r14w
add %r8, %r8
lea addresses_WT_ht+0xdf85, %r11
dec %r8
vmovups (%r11), %ymm5
vextracti128 $1, %ymm5, %xmm5
vpextrq $0, %xmm5, %r12
cmp %r11, %r11
lea addresses_normal_ht+0x1d84d, %rsi
lea addresses_D_ht+0x12bc5, %rdi
nop
nop
nop
nop
...
nop
add %r8, %r8
lea addresses_normal_ht+0xaee3, %rsi
nop
nop
nop
nop
...
nop
xor $7712, %r13
lea addresses_normal_ht+0x1e585, %r12
nop
nop
sub %r11, %r11
movb $0x61, (%r12)
...
mov (%rdi), %r11d
cmp %r8, %r8
lea addresses_normal_ht+0xd525, %rdi
nop
nop
cmp %r12, %r12
vmovups (%rdi), %ymm4
