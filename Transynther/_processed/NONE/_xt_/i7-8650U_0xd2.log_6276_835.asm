...
push %rdx
push %rsi
lea addresses_UC_ht+0x16b43, %r10
cmp %rdx, %rdx
movups (%r10), %xmm0
vpextrq $1, %xmm0, %rax
add %rdi, %rdi
lea addresses_WT_ht+0x1b6bb, %r12
nop
nop
sub %rax, %rax
mov (%r12), %rbx
cmp %rdx, %rdx
lea addresses_WC_ht+0x97fb, %rdi
clflush (%rdi)
nop
nop
nop
...
nop
xor %rax, %rax
lea addresses_D_ht+0xb9bb, %rsi
lea addresses_normal_ht+0x545b, %rdi
nop
nop
nop
nop
...
nop
cmp $49387, %rdx
lea addresses_normal_ht+0x11e3b, %r12
nop
nop
nop
nop
...
vpextrq $1, %xmm0, %r10
and $33171, %r10
lea addresses_normal_ht+0x140e6, %rsi
lea addresses_UC_ht+0x1bed3, %rdi
nop
nop
nop
add $53768, %rax
...
nop
sub %r10, %r10
lea addresses_WC_ht+0x1343b, %rdx
nop
nop
nop
nop
...
movl $0x61626364, (%rdx)
xor %rsi, %rsi
lea addresses_D_ht+0x1b83b, %r10
nop
nop
nop
nop
...
vpextrq $1, %xmm2, %rdx
add %r10, %r10
lea addresses_UC_ht+0xa671, %rsi
lea addresses_normal_ht+0xd30b, %rdi
nop
nop
xor %rax, %rax
mov $21, %rcx
...
{'OP': 'REPM', 'src': {'type': 'addresses_normal_ht', 'congruent': 0, 'same': True}, 'dst': {'type': 'addresses_UC_ht', 'congruent': 3, 'same': False}}
{'OP': 'STOR', 'dst': {'type': 'addresses_WC_ht', 'size': 4, 'AVXalign': False, 'NT': True, 'congruent': 10, 'same': False}}
