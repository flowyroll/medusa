...
push %rdx
push %rsi
lea addresses_normal_ht+0x2217, %rdx
xor $63218, %rcx
mov (%rdx), %r15d
cmp $33991, %r12
lea addresses_A_ht+0x1cb41, %r9
nop
inc %rdx
movb (%r9), %r10b
nop
inc %rdx
lea addresses_D_ht+0x5cd1, %rsi
lea addresses_A_ht+0x1efe, %rdi
nop
nop
cmp %r9, %r9
mov $24, %rcx
...
// Store
lea addresses_normal+0x1bf89, %r13
nop
nop
nop
inc %r12
