...
push %rdx
push %rsi
lea addresses_WT_ht+0xcb12, %r8
nop
add $38995, %rbp
mov (%r8), %rcx
nop
cmp %rdx, %rdx
lea addresses_WC_ht+0x1029c, %r15
nop
nop
nop
nop
...
nop
dec %r11
lea addresses_normal_ht+0x1201c, %rcx
nop
nop
nop
and %rdx, %rdx
...
nop
xor %rbp, %rbp
lea addresses_A_ht+0x1991c, %r11
sub $39177, %rdi
mov (%r11), %r8d
nop
nop
...
nop
and $29032, %rcx
lea addresses_normal_ht+0x64a4, %rdi
sub $48194, %rdx
...
nop
and $14736, %r15
lea addresses_normal_ht+0x3ffc, %rsi
lea addresses_WC_ht+0x58ec, %rdi
nop
nop
nop
nop
...
nop
add $35569, %r11
lea addresses_UC_ht+0x178ec, %r15
nop
nop
nop
nop
...
nop
cmp %rsi, %rsi
lea addresses_WT_ht+0x1701c, %rsi
lea addresses_A_ht+0x470c, %rdi
nop
nop
nop
nop
...
nop
and %rbp, %rbp
lea addresses_WC_ht+0xc11c, %rsi
lea addresses_WT_ht+0x1d55b, %rdi
clflush (%rdi)
nop
nop
nop
...
nop
dec %rcx
lea addresses_UC_ht+0x1e51c, %rbp
nop
inc %r15
movb (%rbp), %r8b
nop
...
{'OP': 'REPM', 'src': {'same': False, 'congruent': 5, 'type': 'addresses_normal_ht'}, 'dst': {'same': False, 'congruent': 4, 'type': 'addresses_WC_ht'}}
...
{'OP': 'REPM', 'src': {'same': False, 'congruent': 8, 'type': 'addresses_WC_ht'}, 'dst': {'same': False, 'congruent': 0, 'type': 'addresses_WT_ht'}}
