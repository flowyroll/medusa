...
push %rdx
push %rsi
lea addresses_WC_ht+0x131e6, %rsi
lea addresses_WC_ht+0x11be6, %rdi
clflush (%rdi)
nop
xor %rax, %rax
mov $90, %rcx
rep movsw
sub $51138, %rdx
lea addresses_normal_ht+0x4fe6, %r12
nop
nop
nop
cmp $16701, %r10
...
nop
dec %rdx
lea addresses_WT_ht+0x11f66, %rcx
sub $48976, %rax
movb (%rcx), %dl
nop
cmp %r10, %r10
lea addresses_WC_ht+0x167e6, %rsi
lea addresses_WC_ht+0x3f36, %rdi
nop
nop
nop
dec %rbp
...
rep movsw
xor $6855, %rax
lea addresses_UC_ht+0x484a, %r10
cmp $3174, %r12
...
nop
add $48118, %r12
lea addresses_UC_ht+0x16adc, %rax
dec %r10
vmovups (%rax), %ymm6
...
nop
cmp $13861, %r12
lea addresses_normal_ht+0x1e91e, %rdx
nop
nop
nop
nop
...
nop
xor $635, %rcx
lea addresses_D_ht+0x59e6, %r10
add %rax, %rax
mov $0x6162636465666768, %rsi
movq %rsi, (%r10)
nop
xor %rax, %rax
lea addresses_normal_ht+0x15e6, %rsi
...
<gen_prepare_buffer>
{'OP': 'REPM', 'src': {'same': False, 'congruent': 8, 'type': 'addresses_WC_ht'}, 'dst': {'same': False, 'congruent': 10, 'type': 'addresses_WC_ht'}}
...
{'OP': 'REPM', 'src': {'same': False, 'congruent': 8, 'type': 'addresses_normal_ht'}, 'dst': {'same': False, 'congruent': 7, 'type': 'addresses_WT_ht'}}
{'35': 21829}
