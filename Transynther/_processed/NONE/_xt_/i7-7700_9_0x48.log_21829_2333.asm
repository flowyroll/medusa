...
push %rdx
push %rsi
lea addresses_normal_ht+0x11786, %rsi
...
nop
cmp $8809, %rdx
lea addresses_normal_ht+0x1cc02, %r8
nop
nop
xor %rcx, %rcx
movl $0x61626364, (%r8)
...
nop
xor $40335, %r8
lea addresses_UC_ht+0x12986, %rdi
nop
nop
nop
nop
...
nop
xor $55168, %rdx
lea addresses_WT_ht+0x1586, %rdx
nop
and $17666, %r11
movups (%rdx), %xmm5
vpextrq $1, %xmm5, %r9
...
nop
add $7354, %rdi
lea addresses_normal_ht+0x2786, %rsi
lea addresses_A_ht+0x437e, %rdi
nop
nop
nop
nop
...
rep movsq
cmp %r8, %r8
lea addresses_WT_ht+0xc936, %rsi
...
nop
and $6091, %r11
lea addresses_WT_ht+0x686, %rsi
lea addresses_UC_ht+0xf586, %rdi
nop
cmp $29513, %r11
mov $70, %rcx
rep movsq
nop
xor $9855, %r11
lea addresses_A_ht+0x11c06, %rcx
nop
nop
nop
nop
...
nop
inc %r9
lea addresses_A_ht+0x179d6, %rsi
lea addresses_A_ht+0x16086, %rdi
clflush (%rdi)
xor %r13, %r13
mov $115, %rcx
rep movsq
nop
mfence
lea addresses_WT_ht+0x15786, %rcx
nop
inc %r13
movl $0x61626364, (%rcx)
sub $15884, %rsi
...
<gen_prepare_buffer>
{'OP': 'REPM', 'src': {'type': 'addresses_normal_ht', 'congruent': 10, 'same': False}, 'dst': {'type': 'addresses_D_ht', 'congruent': 0, 'same': True}}
...
{'OP': 'REPM', 'src': {'type': 'addresses_WT_ht', 'congruent': 4, 'same': False}, 'dst': {'type': 'addresses_A_ht', 'congruent': 2, 'same': False}}
