...
push %rdi
push %rsi
lea addresses_D_ht+0x16f60, %r12
nop
nop
nop
nop
...
nop
and %r9, %r9
lea addresses_WT_ht+0xd0e0, %rsi
lea addresses_WC_ht+0xc2e0, %rdi
nop
nop
nop
nop
...
nop
inc %r8
lea addresses_UC_ht+0x188e0, %rcx
nop
nop
nop
nop
...
nop
dec %r8
lea addresses_WT_ht+0x11bc8, %r9
xor %r12, %r12
movl $0x61626364, (%r9)
nop
nop
add %r8, %r8
lea addresses_UC_ht+0xa6e0, %rsi
...
nop
and %r12, %r12
lea addresses_normal_ht+0xc5d2, %rsi
nop
xor %r9, %r9
mov $0x6162636465666768, %rax
movq %rax, (%rsi)
...
nop
dec %rdi
lea addresses_A_ht+0x116e0, %rsi
lea addresses_A_ht+0x172e0, %rdi
nop
xor %r15, %r15
mov $52, %rcx
rep movsl
...
nop
cmp %r12, %r12
lea addresses_D_ht+0x17ee0, %rsi
lea addresses_D_ht+0x1c200, %rdi
cmp %rax, %rax
mov $105, %rcx
rep movsl
add %r9, %r9
lea addresses_A_ht+0x60c, %rsi
nop
nop
nop
nop
...
// Load
lea addresses_normal+0x3620, %rax
clflush (%rax)
nop
nop
nop
...
// Store
lea addresses_normal+0xe9e0, %rbp
clflush (%rbp)
nop
nop
nop
...
{'dst': {'type': 'addresses_normal', 'same': False, 'size': 2, 'congruent': 8, 'NT': True, 'AVXalign': False}, 'OP': 'STOR'}
[Faulty Load]
...
{'src': {'type': 'addresses_UC_ht', 'congruent': 9, 'same': True}, 'dst': {'type': 'addresses_D_ht', 'congruent': 5, 'same': False}, 'OP': 'REPM'}
{'dst': {'type': 'addresses_normal_ht', 'same': True, 'size': 8, 'congruent': 1, 'NT': False, 'AVXalign': False}, 'OP': 'STOR'}
{'src': {'type': 'addresses_A_ht', 'congruent': 10, 'same': True}, 'dst': {'type': 'addresses_A_ht', 'congruent': 9, 'same': False}, 'OP': 'REPM'}
