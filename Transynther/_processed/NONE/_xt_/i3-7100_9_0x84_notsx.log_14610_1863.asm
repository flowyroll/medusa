...
push %rdi
push %rsi
lea addresses_UC_ht+0x1bfca, %rsi
lea addresses_A_ht+0x17614, %rdi
clflush (%rdi)
nop
nop
inc %r14
...
nop
and $59937, %r13
lea addresses_UC_ht+0x7aca, %rsi
lea addresses_normal_ht+0x17dca, %rdi
nop
dec %rbp
mov $40, %rcx
rep movsl
...
nop
cmp %rsi, %rsi
lea addresses_WT_ht+0x1cb48, %rsi
lea addresses_UC_ht+0x208a, %rdi
and %r15, %r15
mov $66, %rcx
rep movsl
nop
...
nop
sub $49491, %r14
lea addresses_WT_ht+0x8d6c, %r13
nop
nop
nop
inc %rbp
...
lea addresses_normal_ht+0x160ca, %rdi
nop
nop
nop
sub $63569, %r15
...
nop
dec %rbp
lea addresses_UC_ht+0x160ca, %r13
nop
nop
nop
nop
...
nop
inc %r13
lea addresses_WC_ht+0x21ca, %rcx
nop
nop
nop
nop
...
// Load
lea addresses_normal+0x1c1b2, %r10
nop
nop
nop
nop
...
{'src': {'type': 'addresses_UC_ht', 'congruent': 10, 'same': False}, 'dst': {'type': 'addresses_normal_ht', 'congruent': 8, 'same': False}, 'OP': 'REPM'}
{'src': {'type': 'addresses_WT_ht', 'congruent': 1, 'same': False}, 'dst': {'type': 'addresses_UC_ht', 'congruent': 6, 'same': False}, 'OP': 'REPM'}
...
{'src': {'type': 'addresses_A_ht', 'same': True, 'size': 16, 'congruent': 6, 'NT': False, 'AVXalign': True}, 'OP': 'LOAD'}
