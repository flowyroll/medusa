...
lea addresses_WC_ht+0xc39e, %rdi
clflush (%rdi)
nop
xor $59427, %r10
mov $74, %rcx
...
<gen_prepare_buffer>
{'OP': 'REPM', 'src': {'type': 'addresses_D_ht', 'congruent': 0, 'same': False}, 'dst': {'type': 'addresses_WC_ht', 'congruent': 11, 'same': True}}
{'33': 2986}
