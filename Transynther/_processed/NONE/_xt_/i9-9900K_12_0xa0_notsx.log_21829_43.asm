...
push %rdx
push %rsi
lea addresses_UC_ht+0xcf53, %rcx
nop
nop
and %r14, %r14
...
nop
dec %r14
lea addresses_A_ht+0x1e153, %r10
and $26177, %rdx
mov (%r10), %bx
nop
nop
...
nop
sub $31589, %rcx
lea addresses_UC_ht+0x16f9f, %rbx
nop
nop
nop
sub %r11, %r11
...
nop
and %r10, %r10
lea addresses_normal_ht+0xbd53, %rsi
lea addresses_A_ht+0xd54a, %rdi
nop
nop
and $41499, %r11
mov $117, %rcx
...
nop
add $52142, %rdx
lea addresses_WC_ht+0x1d5b3, %rsi
lea addresses_UC_ht+0x3b53, %rdi
nop
nop
and %rdx, %rdx
mov $93, %rcx
rep movsl
sub %r14, %r14
lea addresses_WT_ht+0xff53, %r11
nop
sub $26146, %r10
...
nop
add %rdi, %rdi
lea addresses_UC_ht+0x10b53, %rdx
sub $27198, %r10
movb $0x61, (%rdx)
nop
nop
...
lea addresses_D_ht+0x19a53, %rdi
add %r14, %r14
mov $118, %rcx
rep movsw
nop
...
nop
xor %r11, %r11
lea addresses_normal_ht+0x6af3, %rcx
nop
nop
nop
add $4933, %r14
...
movq %rbx, (%rcx)
add $22215, %rsi
lea addresses_A_ht+0x1e753, %rsi
lea addresses_A_ht+0xacbf, %rdi
nop
inc %r10
mov $74, %rcx
rep movsw
...
nop
xor %rdx, %rdx
lea addresses_D_ht+0xab53, %rsi
lea addresses_WT_ht+0x4313, %rdi
xor %r14, %r14
mov $27, %rcx
rep movsq
nop
...
{'src': {'type': 'addresses_PSE', 'AVXalign': True, 'size': 1, 'NT': False, 'same': False, 'congruent': 10}, 'OP': 'LOAD'}
[Faulty Load]
...
{'src': {'type': 'addresses_A_ht', 'congruent': 9, 'same': False}, 'OP': 'REPM', 'dst': {'type': 'addresses_A_ht', 'congruent': 0, 'same': False}}
{'src': {'type': 'addresses_D_ht', 'congruent': 10, 'same': False}, 'OP': 'REPM', 'dst': {'type': 'addresses_WT_ht', 'congruent': 6, 'same': False}}
{'33': 21829}
