...
push %rdi
push %rsi
lea addresses_WC_ht+0x1592, %r14
nop
add $61257, %rbp
mov (%r14), %si
dec %rax
lea addresses_D_ht+0x16342, %r12
nop
nop
nop
nop
...
nop
sub %r15, %r15
lea addresses_WC_ht+0x14f82, %r15
nop
nop
and $62143, %rbp
movb (%r15), %al
...
nop
inc %r15
lea addresses_UC_ht+0x12c02, %r12
nop
nop
nop
xor %rsi, %rsi
...
nop
and %rsi, %rsi
lea addresses_UC_ht+0x19682, %r8
nop
nop
nop
nop
...
movb (%r8), %r14b
sub $47299, %r8
lea addresses_A_ht+0xde02, %rsi
lea addresses_WT_ht+0x15c02, %rdi
nop
nop
nop
add $17321, %r14
