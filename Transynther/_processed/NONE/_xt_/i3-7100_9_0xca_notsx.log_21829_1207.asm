...
push %rdi
push %rsi
lea addresses_D_ht+0x1b1a1, %rsi
lea addresses_WC_ht+0xb5e1, %rdi
nop
nop
sub $54099, %r13
mov $68, %rcx
rep movsl
add $19741, %r8
lea addresses_A_ht+0x1a569, %rsi
lea addresses_A_ht+0x1362b, %rdi
nop
nop
nop
inc %r10
...
rep movsl
sub $17999, %rdi
lea addresses_D_ht+0x12da1, %rdi
cmp %rbx, %rbx
movups (%rdi), %xmm1
vpextrq $1, %xmm1, %r8
nop
...
nop
sub $15221, %rcx
lea addresses_UC_ht+0x19219, %rsi
lea addresses_A_ht+0x12285, %rdi
clflush (%rdi)
nop
xor $14613, %r8
mov $25, %rcx
...
nop
and $61504, %r10
lea addresses_WC_ht+0x3a0b, %rbx
nop
nop
nop
xor %rsi, %rsi
...
nop
xor $37642, %r8
lea addresses_A_ht+0x1c087, %rsi
...
nop
sub $33675, %rcx
lea addresses_UC_ht+0xb761, %rsi
...
nop
and %r8, %r8
lea addresses_WC_ht+0x179a1, %rsi
lea addresses_UC_ht+0xdd27, %rdi
clflush (%rdi)
nop
add $43335, %r10
mov $78, %rcx
...
nop
and $44761, %r13
lea addresses_UC_ht+0x11b60, %r8
nop
nop
sub $37287, %r10
...
nop
cmp $12948, %r13
lea addresses_WC_ht+0x34a1, %rcx
nop
nop
nop
inc %rsi
...
nop
sub $33670, %r9
lea addresses_A_ht+0x14201, %rsi
nop
nop
nop
nop
...
<gen_prepare_buffer>
{'src': {'type': 'addresses_D_ht', 'congruent': 6, 'same': False}, 'OP': 'REPM', 'dst': {'type': 'addresses_WC_ht', 'congruent': 6, 'same': True}}
...
{'OP': 'STOR', 'dst': {'same': False, 'congruent': 0, 'NT': False, 'type': 'addresses_WC_ht', 'size': 8, 'AVXalign': True}}
