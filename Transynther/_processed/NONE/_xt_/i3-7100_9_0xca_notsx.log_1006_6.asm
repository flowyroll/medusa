...
nop
and %r11, %r11
lea addresses_WC_ht+0x16815, %rbp
nop
nop
nop
add $26129, %rax
...
nop
add %r11, %r11
lea addresses_normal_ht+0xa8a1, %rbp
xor %r10, %r10
movw $0x6162, (%rbp)
nop
nop
lfence
lea addresses_normal_ht+0xa7a1, %rsi
lea addresses_WT_ht+0x4a1, %rdi
clflush (%rdi)
nop
nop
xor %rax, %rax
...
nop
add $33908, %r11
lea addresses_WT_ht+0x11bac, %rsi
lea addresses_normal_ht+0x15ca1, %rdi
clflush (%rsi)
nop
nop
nop
...
rep movsl
inc %r8
lea addresses_D_ht+0x8ba5, %rsi
lea addresses_D_ht+0x4c11, %rdi
nop
nop
nop
nop
...
{'OP': 'STOR', 'dst': {'same': False, 'congruent': 6, 'NT': True, 'type': 'addresses_NC', 'size': 4, 'AVXalign': False}}
[Faulty Load]
