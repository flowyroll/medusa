...
nop
and %r14, %r14
lea addresses_WT_ht+0x1a51e, %rsi
nop
nop
nop
nop
...
nop
sub $24608, %rdx
lea addresses_WT_ht+0x1aa3e, %rsi
lea addresses_A_ht+0xfa3e, %rdi
nop
nop
nop
nop
...
nop
and %rdi, %rdi
lea addresses_A_ht+0x10d89, %rbx
nop
and $8327, %r14
movups (%rbx), %xmm0
vpextrq $0, %xmm0, %rcx
...
nop
sub %rdi, %rdi
lea addresses_WC_ht+0x1eb3e, %rsi
lea addresses_normal_ht+0x33e, %rdi
sub %rdx, %rdx
mov $125, %rcx
rep movsw
nop
...
{'src': {'type': 'addresses_WC_ht', 'congruent': 4, 'same': False}, 'dst': {'type': 'addresses_normal_ht', 'congruent': 8, 'same': False}, 'OP': 'REPM'}
{'39': 21829}
