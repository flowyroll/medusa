...
push %rdi
push %rsi
lea addresses_D_ht+0x1cd39, %rsi
lea addresses_UC_ht+0x16a89, %rdi
clflush (%rdi)
nop
sub $14039, %r14
mov $127, %rcx
...
nop
and %r8, %r8
lea addresses_UC_ht+0x1de6b, %r9
clflush (%r9)
xor %rcx, %rcx
...
nop
sub $39492, %rsi
lea addresses_normal_ht+0x10b09, %r8
nop
nop
nop
nop
...
nop
add $53778, %r8
lea addresses_D_ht+0x18009, %rsi
lea addresses_A_ht+0x18c09, %rdi
add %r14, %r14
mov $3, %rcx
rep movsq
dec %rcx
lea addresses_UC_ht+0x17871, %rsi
...
<gen_prepare_buffer>
{'src': {'type': 'addresses_D_ht', 'congruent': 4, 'same': False}, 'OP': 'REPM', 'dst': {'type': 'addresses_UC_ht', 'congruent': 7, 'same': False}}
