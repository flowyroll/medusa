...
push %rdx
push %rsi
lea addresses_WT_ht+0x18b9, %rsi
lea addresses_WT_ht+0x9779, %rdi
nop
nop
nop
nop
...
nop
xor $56944, %rbp
lea addresses_UC_ht+0x10579, %rsi
lea addresses_UC_ht+0xbf01, %rdi
and %r12, %r12
mov $21, %rcx
rep movsw
nop
...
nop
xor %rdx, %rdx
lea addresses_UC_ht+0x5779, %r12
nop
nop
nop
nop
...
nop
dec %rsi
lea addresses_WC_ht+0x107b9, %rcx
nop
nop
nop
nop
...
nop
sub %rdi, %rdi
lea addresses_normal_ht+0x150f9, %rcx
nop
nop
and $62127, %r13
...
nop
and $23305, %r12
lea addresses_WC_ht+0x6179, %rbp
nop
add $24126, %r12
movb (%rbp), %r13b
and %r13, %r13
lea addresses_WC_ht+0xc2d3, %rsi
lea addresses_A_ht+0x1dd39, %rdi
add %r9, %r9
mov $2, %rcx
rep movsl
nop
...
nop
and %rdx, %rdx
lea addresses_WC_ht+0x4ad9, %rsi
nop
nop
nop
nop
...
nop
sub $10985, %rsi
lea addresses_WT_ht+0x15299, %rsi
lea addresses_WC_ht+0x16b79, %rdi
nop
nop
nop
and %rdx, %rdx
...
<gen_prepare_buffer>
{'OP': 'REPM', 'src': {'type': 'addresses_WT_ht', 'congruent': 5, 'same': False}, 'dst': {'type': 'addresses_WT_ht', 'congruent': 10, 'same': False}}
...
{'OP': 'REPM', 'src': {'type': 'addresses_WC_ht', 'congruent': 1, 'same': True}, 'dst': {'type': 'addresses_A_ht', 'congruent': 6, 'same': False}}
