...
push %rdi
push %rsi
lea addresses_WT_ht+0x6d9, %rsi
lea addresses_WT_ht+0x16ad, %rdi
clflush (%rsi)
nop
sub %r13, %r13
mov $32, %rcx
...
nop
cmp $56074, %rbx
lea addresses_WC_ht+0x1d6ed, %rsi
lea addresses_UC_ht+0x106ed, %rdi
nop
nop
nop
nop
...
nop
cmp %rbp, %rbp
lea addresses_normal_ht+0x64af, %rbx
nop
nop
nop
nop
...
mov (%rbx), %esi
xor $25882, %r11
lea addresses_UC_ht+0x1deed, %rsi
lea addresses_A_ht+0xca6d, %rdi
clflush (%rsi)
add $51745, %r15
mov $18, %rcx
rep movsq
...
<gen_prepare_buffer>
{'dst': {'same': False, 'congruent': 6, 'type': 'addresses_WT_ht'}, 'OP': 'REPM', 'src': {'same': True, 'congruent': 2, 'type': 'addresses_WT_ht'}}
...
{'dst': {'same': False, 'congruent': 5, 'type': 'addresses_A_ht'}, 'OP': 'REPM', 'src': {'same': False, 'congruent': 8, 'type': 'addresses_UC_ht'}}
{'33': 21829}
