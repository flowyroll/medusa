...
push %rdx
push %rsi
lea addresses_WC_ht+0x14c13, %rsi
...
nop
and %rdx, %rdx
lea addresses_WC_ht+0x10fab, %rsi
lea addresses_WC_ht+0x16db, %rdi
and %rdx, %rdx
mov $29, %rcx
rep movsl
nop
...
nop
and %rdi, %rdi
lea addresses_A_ht+0xa4ab, %rsi
lea addresses_WT_ht+0x15cab, %rdi
nop
nop
nop
sub $3091, %r13
...
rep movsb
sub %r11, %r11
lea addresses_UC_ht+0xf6ab, %rsi
lea addresses_WT_ht+0x2b3f, %rdi
sub %rdx, %rdx
mov $78, %rcx
rep movsw
nop
nop
xor %r13, %r13
lea addresses_WC_ht+0x1d4ab, %rsi
...
nop
cmp %rax, %rax
lea addresses_WC_ht+0x2eab, %r13
nop
cmp %rcx, %rcx
movw $0x6162, (%r13)
nop
nop
and $33673, %rdx
lea addresses_UC_ht+0xe44b, %rax
nop
nop
nop
nop
...
nop
sub %r11, %r11
lea addresses_A_ht+0xe8ab, %rsi
lea addresses_WT_ht+0x18591, %rdi
nop
nop
nop
nop
...
nop
add $24370, %rcx
lea addresses_A_ht+0x6b, %rsi
lea addresses_WT_ht+0x184ab, %rdi
nop
nop
sub %r10, %r10
mov $53, %rcx
...
nop
add %rsi, %rsi
lea addresses_WC_ht+0xdcab, %r11
clflush (%r11)
nop
nop
nop
...
movw $0x6162, (%r11)
cmp $27919, %rsi
lea addresses_UC_ht+0x10d2b, %rsi
lea addresses_WC_ht+0x12eb3, %rdi
nop
nop
nop
nop
...
nop
add %r13, %r13
lea addresses_WT_ht+0x11aab, %rsi
lea addresses_A_ht+0x152b, %rdi
nop
nop
nop
cmp %r11, %r11
...
rep movsb
cmp %rsi, %rsi
lea addresses_normal_ht+0x161bb, %r11
xor $60163, %rcx
movb (%r11), %dl
inc %rdi
pop %rsi
...
{'src': {'type': 'addresses_WT_ht', 'congruent': 7, 'same': False}, 'OP': 'REPM', 'dst': {'type': 'addresses_A_ht', 'congruent': 6, 'same': False}}
