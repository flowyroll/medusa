...
movl $0x61626364, (%r8)
sub $39409, %r10
lea addresses_normal_ht+0x79b0, %rcx
nop
nop
nop
nop
...
nop
add %rbx, %rbx
lea addresses_D_ht+0x1dc30, %rsi
...
nop
add $1326, %rsi
lea addresses_UC_ht+0x10fb0, %rsi
lea addresses_D_ht+0xdb30, %rdi
nop
nop
add $23222, %r8
mov $77, %rcx
...
// REPMOV
lea addresses_WC+0x3cb8, %rsi
lea addresses_WT+0x1cbf8, %rdi
nop
nop
nop
nop
...
{'OP': 'REPM', 'src': {'type': 'addresses_WC', 'congruent': 3, 'same': False}, 'dst': {'type': 'addresses_WT', 'congruent': 2, 'same': True}}
