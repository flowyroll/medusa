...
push %rdx
push %rsi
lea addresses_D_ht+0x16bdc, %rsi
lea addresses_WC_ht+0x14eee, %rdi
nop
nop
nop
cmp $32518, %rbx
...
rep movsl
and $14306, %r15
lea addresses_A_ht+0x1e7fe, %rdx
nop
nop
nop
add $58657, %rbp
...
nop
cmp $53802, %rbx
lea addresses_UC_ht+0x55fa, %rcx
nop
add %rbx, %rbx
vmovups (%rcx), %ymm3
...
nop
and %rcx, %rcx
lea addresses_normal_ht+0x7c7e, %rdx
clflush (%rdx)
nop
nop
nop
...
nop
xor %rsi, %rsi
lea addresses_A_ht+0x1380e, %rbx
nop
nop
xor %rbp, %rbp
...
lea addresses_WT_ht+0x10e7a, %rdi
nop
nop
sub %rdx, %rdx
mov $23, %rcx
...
nop
inc %rbx
lea addresses_UC_ht+0x1247e, %rsi
