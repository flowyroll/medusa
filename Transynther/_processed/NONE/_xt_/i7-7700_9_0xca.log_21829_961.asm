...
nop
cmp $14718, %r8
lea addresses_A_ht+0x29f3, %rsi
lea addresses_normal_ht+0x100c3, %rdi
nop
nop
inc %r11
mov $99, %rcx
...
nop
cmp %rbp, %rbp
lea addresses_normal_ht+0xa413, %r11
nop
nop
nop
and $35267, %rax
...
nop
sub $21278, %r8
lea addresses_D_ht+0x13693, %rax
add %rcx, %rcx
mov (%rax), %edi
nop
nop
cmp %rsi, %rsi
lea addresses_normal_ht+0x12eb3, %rsi
lea addresses_WC_ht+0x16fe3, %rdi
nop
cmp $34470, %r15
mov $7, %rcx
rep movsq
...
// Store
lea addresses_US+0x1483, %r9
dec %r13
movw $0x5152, (%r9)
add %rbp, %rbp

// Store
lea addresses_PSE+0x8b93, %r9
clflush (%r9)
nop
nop
nop
...
{'OP': 'STOR', 'dst': {'congruent': 3, 'AVXalign': True, 'same': False, 'size': 2, 'NT': False, 'type': 'addresses_US'}}
...
{'src': {'congruent': 5, 'same': False, 'type': 'addresses_normal_ht'}, 'OP': 'REPM', 'dst': {'congruent': 1, 'same': False, 'type': 'addresses_WC_ht'}}
{'36': 21829}
