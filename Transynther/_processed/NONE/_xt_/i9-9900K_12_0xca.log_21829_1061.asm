...
lea addresses_UC_ht+0x1705c, %rdi
clflush (%rdi)
nop
nop
nop
...
nop
cmp $15267, %rsi
lea addresses_D_ht+0x199f8, %rsi
nop
nop
sub $6368, %r15
movw $0x6162, (%rsi)
...
nop
xor %rcx, %rcx
lea addresses_WC_ht+0xb84, %rsi
inc %rdi
mov (%rsi), %ecx
and %rdi, %rdi
lea addresses_WC_ht+0x1dfe8, %rcx
clflush (%rcx)
nop
nop
nop
...
nop
inc %r8
lea addresses_normal_ht+0xdee0, %rsi
lea addresses_UC_ht+0x1c698, %rdi
nop
nop
nop
nop
...
nop
add $57892, %rsi
lea addresses_UC_ht+0x1e63a, %rbp
nop
mfence
mov (%rbp), %r15w
xor $54193, %r15
...
// Faulty Load
lea addresses_normal+0xa7f8, %rsi
nop
nop
nop
nop
...
{'OP': 'REPM', 'src': {'same': False, 'type': 'addresses_WT_ht', 'congruent': 10}, 'dst': {'same': False, 'type': 'addresses_UC_ht', 'congruent': 1}}
