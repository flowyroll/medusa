...
push %rdi
push %rsi
lea addresses_UC_ht+0x1a027, %rsi
...
nop
mfence
lea addresses_normal_ht+0xf507, %r15
and $53558, %rbp
movb $0x61, (%r15)
nop
nop
...
nop
and $24376, %rbp
lea addresses_normal_ht+0x19e87, %rsi
...
nop
sub %r8, %r8
lea addresses_D_ht+0x97, %rsi
lea addresses_WC_ht+0xe492, %rdi
nop
nop
cmp %rbp, %rbp
mov $65, %rcx
...
// Faulty Load
lea addresses_normal+0x7687, %rcx
nop
nop
and $43947, %r10
movups (%rcx), %xmm2
...
{'OP': 'STOR', 'dst': {'type': 'addresses_WT', 'AVXalign': True, 'size': 1, 'NT': False, 'same': False, 'congruent': 11}}
