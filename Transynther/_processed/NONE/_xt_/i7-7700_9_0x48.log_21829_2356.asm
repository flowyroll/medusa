...
push %rdx
push %rsi
lea addresses_WC_ht+0xca2d, %rsi
lea addresses_normal_ht+0x161ad, %rdi
nop
nop
nop
nop
...
nop
inc %rax
lea addresses_normal_ht+0x19c3d, %r15
nop
nop
nop
nop
...
nop
and $35277, %r15
lea addresses_D_ht+0x1c32d, %rsi
nop
nop
nop
nop
...
nop
xor $4558, %rsi
lea addresses_normal_ht+0x177d8, %rax
sub %rcx, %rcx
vmovups (%rax), %ymm3
...
nop
sub %rdx, %rdx
lea addresses_WT_ht+0x70b5, %rdi
nop
nop
nop
sub %rcx, %rcx
...
nop
add %rsi, %rsi
lea addresses_normal_ht+0x2de9, %rdi
nop
and %r15, %r15
vmovups (%rdi), %ymm0
...
vpextrq $1, %xmm0, %rcx
xor %r15, %r15
lea addresses_WT_ht+0xddad, %rsi
lea addresses_normal_ht+0x16f54, %rdi
add $50557, %r9
mov $116, %rcx
rep movsq
dec %r9
lea addresses_WC_ht+0x1b22d, %rsi
dec %rdi
mov (%rsi), %r15w
xor %r9, %r9
lea addresses_A_ht+0x297d, %rdx
nop
xor $16343, %rcx
movups (%rdx), %xmm6
vpextrq $1, %xmm6, %rdi
...
{'OP': 'STOR', 'dst': {'type': 'addresses_normal_ht', 'AVXalign': True, 'congruent': 4, 'size': 16, 'same': False, 'NT': False}}
