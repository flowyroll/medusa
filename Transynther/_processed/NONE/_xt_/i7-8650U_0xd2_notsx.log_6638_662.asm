...
nop
xor %r12, %r12
lea addresses_WT_ht+0x1c268, %r13
nop
add %rcx, %rcx
movl $0x61626364, (%r13)
nop
xor $42023, %r8
lea addresses_WT_ht+0x13414, %r10
nop
nop
nop
nop
...
nop
dec %rax
lea addresses_D_ht+0x1ef98, %rax
nop
nop
inc %r13
movb (%rax), %r10b
...
nop
add $49315, %rdx
lea addresses_normal_ht+0x11e24, %rsi
lea addresses_WC_ht+0x10818, %rdi
clflush (%rsi)
dec %rdx
mov $61, %rcx
rep movsl
...
nop
add %r8, %r8
lea addresses_WC_ht+0x3018, %rsi
...
// Store
lea addresses_normal+0xd018, %rdx
xor $35612, %r8
movl $0x51525354, (%rdx)
nop
nop
