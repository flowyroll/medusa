...
push %rdi
push %rsi
lea addresses_WC_ht+0x12e77, %rsi
lea addresses_D_ht+0x1eefb, %rdi
nop
nop
nop
nop
...
nop
dec %rbp
lea addresses_WC_ht+0x172c3, %rcx
and $53714, %rbp
movl $0x61626364, (%rcx)
nop
xor $64359, %rsi
lea addresses_UC_ht+0x1ecbb, %r13
nop
nop
nop
sub %rsi, %rsi
...
nop
dec %rdi
lea addresses_WT_ht+0x6fb, %rsi
lea addresses_A_ht+0x1da0b, %rdi
nop
add $39833, %r8
mov $64, %rcx
rep movsb
...
nop
xor $18723, %r15
lea addresses_normal_ht+0xbcfb, %rcx
nop
cmp %rbx, %rbx
mov (%rcx), %r8w
cmp %r8, %r8
