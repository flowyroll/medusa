...
nop
cmp $60905, %r12
lea addresses_WT_ht+0xa576, %rsi
nop
nop
nop
nop
...
nop
cmp $57997, %r11
lea addresses_D_ht+0x12d76, %rax
nop
nop
nop
nop
...
nop
xor %r9, %r9
lea addresses_D_ht+0x13176, %rsi
lea addresses_D_ht+0xd576, %rdi
nop
nop
nop
nop
...
nop
cmp %r8, %r8
lea addresses_D_ht+0x15076, %r11
nop
nop
dec %rcx
...
nop
and $56655, %r9
lea addresses_WT_ht+0x1c2, %rcx
sub $14857, %rax
mov (%rcx), %esi
nop
nop
sub $56333, %rdi
lea addresses_WC_ht+0xc2, %rsi
lea addresses_WT_ht+0x107d0, %rdi
nop
nop
and $17938, %r12
mov $34, %rcx
...
nop
cmp $30281, %rsi
lea addresses_UC_ht+0x5a76, %rax
nop
nop
nop
nop
...
nop
dec %rcx
lea addresses_normal_ht+0xba5e, %r8
nop
nop
nop
nop
...
nop
add $15087, %rcx
lea addresses_WC_ht+0x19836, %r13
nop
nop
nop
add %rdi, %rdi
...
nop
xor %rdi, %rdi
lea addresses_WT_ht+0x3976, %rsi
lea addresses_D_ht+0x4546, %rdi
clflush (%rsi)
nop
nop
and $54701, %rax
...
{'OP': 'STOR', 'dst': {'same': False, 'congruent': 10, 'NT': True, 'type': 'addresses_D_ht', 'size': 1, 'AVXalign': True}}
{'src': {'type': 'addresses_D_ht', 'congruent': 9, 'same': False}, 'OP': 'REPM', 'dst': {'type': 'addresses_D_ht', 'congruent': 10, 'same': True}}
...
{'src': {'type': 'addresses_WC_ht', 'congruent': 2, 'same': False}, 'OP': 'REPM', 'dst': {'type': 'addresses_WT_ht', 'congruent': 1, 'same': True}}
