...
push %rdi
push %rsi
lea addresses_A_ht+0x1dbdd, %rsi
lea addresses_normal_ht+0x22dd, %rdi
xor $59949, %rbp
mov $37, %rcx
rep movsl
nop
nop
xor $32834, %rbx
lea addresses_normal_ht+0x1d7dd, %r14
nop
nop
nop
nop
...
nop
and $8462, %r10
lea addresses_WC_ht+0x9fdd, %rsi
lea addresses_D_ht+0x45d, %rdi
and %r15, %r15
mov $59, %rcx
rep movsq
nop
