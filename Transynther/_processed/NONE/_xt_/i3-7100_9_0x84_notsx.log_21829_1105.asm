...
nop
and $48651, %rsi
lea addresses_WT_ht+0x1dc61, %rbp
nop
nop
dec %r8
movups (%rbp), %xmm4
...
nop
and %r15, %r15
lea addresses_D_ht+0x1d4e2, %r15
nop
nop
sub %rsi, %rsi
movups (%r15), %xmm4
...
nop
and $7220, %rcx
lea addresses_A_ht+0x157ab, %rsi
lea addresses_A_ht+0x1213b, %rdi
nop
nop
nop
nop
...
nop
and %rsi, %rsi
lea addresses_D_ht+0x182bb, %rcx
nop
nop
nop
nop
...
nop
and $60467, %r14
lea addresses_UC_ht+0xe27b, %rcx
nop
nop
nop
sub %r11, %r11
...
// REPMOV
lea addresses_A+0x13b, %rsi
lea addresses_WT+0x160a5, %rdi
clflush (%rsi)
inc %r11
mov $68, %rcx
rep movsb
...
{'src': {'type': 'addresses_A', 'same': False, 'size': 4, 'congruent': 8, 'NT': False, 'AVXalign': False}, 'OP': 'LOAD'}
{'src': {'type': 'addresses_A', 'congruent': 0, 'same': True}, 'dst': {'type': 'addresses_WT', 'congruent': 0, 'same': False}, 'OP': 'REPM'}
[Faulty Load]
...
{'src': {'type': 'addresses_A_ht', 'congruent': 4, 'same': False}, 'dst': {'type': 'addresses_A_ht', 'congruent': 11, 'same': False}, 'OP': 'REPM'}
