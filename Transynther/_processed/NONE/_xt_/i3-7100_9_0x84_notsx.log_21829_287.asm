...
push %rdi
push %rsi
lea addresses_A_ht+0x1640f, %rsi
lea addresses_normal_ht+0x14eef, %rdi
clflush (%rsi)
nop
nop
xor $41434, %rax
...
nop
cmp %rbx, %rbx
lea addresses_D_ht+0x72af, %rsi
lea addresses_D_ht+0x103e4, %rdi
clflush (%rdi)
nop
inc %r8
mov $59, %rcx
...
nop
add $4870, %rax
lea addresses_UC_ht+0x19d2f, %rsi
lea addresses_UC_ht+0xf92f, %rdi
nop
sub %r13, %r13
mov $103, %rcx
rep movsq
...
nop
cmp %r8, %r8
lea addresses_WC_ht+0x1cd7f, %rsi
xor %rcx, %rcx
mov (%rsi), %eax
nop
nop
...
nop
sub $16102, %rdi
lea addresses_normal_ht+0x16a3f, %rax
clflush (%rax)
inc %r13
movl $0x61626364, (%rax)
nop
...
{'src': {'type': 'addresses_D_ht', 'congruent': 5, 'same': False}, 'dst': {'type': 'addresses_D_ht', 'congruent': 0, 'same': False}, 'OP': 'REPM'}
{'src': {'type': 'addresses_UC_ht', 'congruent': 9, 'same': False}, 'dst': {'type': 'addresses_UC_ht', 'congruent': 10, 'same': False}, 'OP': 'REPM'}
