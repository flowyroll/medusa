...
push %rdx
push %rsi
lea addresses_WT_ht+0x188e3, %rcx
nop
nop
nop
nop
...
nop
xor %rdx, %rdx
lea addresses_WC_ht+0x11b19, %r13
nop
nop
xor $27274, %rcx
movb $0x61, (%r13)
nop
and $46499, %rsi
lea addresses_normal_ht+0x19519, %rdx
xor $45638, %r9
vmovups (%rdx), %ymm5
...
nop
mfence
lea addresses_WC_ht+0x14319, %rdx
clflush (%rdx)
nop
nop
nop
...
movb $0x61, (%rdx)
inc %rcx
lea addresses_WT_ht+0x11f19, %rsi
lea addresses_D_ht+0x6f19, %rdi
nop
nop
sub $4075, %r12
mov $88, %rcx
...
nop
xor $62189, %r13
lea addresses_normal_ht+0x19319, %rdx
nop
xor $29585, %rdi
mov (%rdx), %cx
nop
...
nop
add %r13, %r13
lea addresses_normal_ht+0x15319, %rcx
nop
xor $2285, %r12
...
nop
cmp $37607, %rcx
lea addresses_normal_ht+0xb119, %r13
nop
and %rcx, %rcx
movb $0x61, (%r13)
nop
...
nop
cmp %r15, %r15
lea addresses_WT_ht+0x17ad9, %r12
nop
nop
nop
nop
...
{'OP': 'STOR', 'dst': {'same': False, 'type': 'addresses_normal_ht', 'NT': False, 'AVXalign': True, 'size': 16, 'congruent': 11}}
