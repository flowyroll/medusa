...
push %rdx
push %rsi
lea addresses_A_ht+0x56fc, %rsi
lea addresses_WC_ht+0xf7ac, %rdi
nop
inc %rbp
mov $105, %rcx
rep movsb
and %r10, %r10
lea addresses_WT_ht+0x76fc, %rdx
inc %rbx
mov (%rdx), %rsi
add $49877, %rcx
lea addresses_WC_ht+0x152fc, %r10
nop
nop
and $47742, %rcx
mov (%r10), %rbp
...
{'OP': 'LOAD', 'src': {'type': 'addresses_PSE', 'AVXalign': False, 'congruent': 8, 'size': 8, 'same': False, 'NT': False}}
