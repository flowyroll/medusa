...
nop
sub $38781, %rbx
lea addresses_UC_ht+0xb262, %rsi
...
nop
dec %rsi
lea addresses_normal_ht+0x11095, %rsi
lea addresses_WT_ht+0x96c5, %rdi
nop
nop
nop
nop
...
nop
cmp $41252, %rsi
lea addresses_A_ht+0x8ac5, %rsi
lea addresses_WC_ht+0x17319, %rdi
nop
nop
nop
nop
...
nop
sub %r13, %r13
lea addresses_WC_ht+0x2c65, %rcx
nop
nop
nop
nop
...
nop
sub %r10, %r10
lea addresses_WC_ht+0x9345, %rsi
lea addresses_UC_ht+0xfe25, %rdi
nop
nop
nop
nop
...
// Load
mov $0x58cad60000000d95, %r10
sub %rdx, %rdx
movb (%r10), %r9b
add %rax, %rax

// Faulty Load
lea addresses_normal+0x156c5, %rdx
nop
nop
nop
nop
