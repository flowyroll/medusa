...
nop
cmp %r14, %r14
lea addresses_normal_ht+0x12877, %r8
clflush (%r8)
nop
xor %rax, %rax
...
nop
cmp %rdx, %rdx
lea addresses_normal_ht+0x1922f, %rsi
lea addresses_A_ht+0xdaf7, %rdi
nop
nop
add $19695, %rdx
mov $18, %rcx
...
nop
cmp $24258, %rdi
lea addresses_A_ht+0x109f7, %rsi
lea addresses_WT_ht+0x1c117, %rdi
sub %r14, %r14
mov $89, %rcx
rep movsl
and %r9, %r9
...
{'OP': 'STOR', 'dst': {'type': 'addresses_WC', 'AVXalign': False, 'size': 8, 'NT': True, 'same': False, 'congruent': 9}}
[Faulty Load]
