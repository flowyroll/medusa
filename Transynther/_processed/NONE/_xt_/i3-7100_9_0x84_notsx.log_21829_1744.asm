...
push %rdx
push %rsi
lea addresses_WC_ht+0x1077d, %rbp
inc %rsi
...
nop
and %r9, %r9
lea addresses_WC_ht+0x18cd, %rdx
dec %rbp
...
nop
and $33907, %r14
lea addresses_UC_ht+0x1decd, %rbp
nop
nop
nop
nop
...
movq %rdx, (%rbp)
xor %r9, %r9
lea addresses_WC_ht+0x164cd, %r9
nop
and %rsi, %rsi
mov $0x6162636465666768, %r14
movq %r14, %xmm4
...
// Store
lea addresses_normal+0x1a0cd, %rbx
nop
nop
nop
and $15196, %rsi
