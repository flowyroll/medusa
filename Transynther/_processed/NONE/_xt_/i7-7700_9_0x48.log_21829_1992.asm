...
push %rdi
push %rsi
lea addresses_normal_ht+0x1dae3, %rsi
lea addresses_WC_ht+0x185e4, %rdi
nop
nop
nop
nop
...
lea addresses_WC_ht+0x2ba3, %rdi
nop
nop
nop
sub $17082, %r10
...
nop
inc %rsi
lea addresses_WT_ht+0x1c6e3, %rsi
nop
nop
nop
sub $36823, %r14
mov (%rsi), %eax
xor %rdi, %rdi
lea addresses_normal_ht+0xcee3, %rsi
lea addresses_UC_ht+0xeeb7, %rdi
clflush (%rdi)
nop
nop
nop
...
nop
cmp $60316, %rsi
lea addresses_WT_ht+0x6de3, %rsi
lea addresses_WT_ht+0x1a903, %rdi
nop
nop
nop
nop
...
lea addresses_WT_ht+0x3fe3, %rdi
nop
add $12018, %r11
mov $23, %rcx
rep movsl
nop
add %r14, %r14
lea addresses_A_ht+0x12343, %rsi
lea addresses_WT_ht+0xda3, %rdi
nop
nop
nop
nop
...
nop
sub $13601, %r10
lea addresses_D_ht+0x15fe3, %r14
cmp %r10, %r10
mov (%r14), %r11
nop
nop
...
nop
and %r14, %r14
lea addresses_UC_ht+0xb063, %r11
add %rsi, %rsi
...
nop
and $41788, %r10
lea addresses_normal_ht+0xa6e3, %r11
nop
nop
nop
xor %rdi, %rdi
...
nop
dec %rdi
lea addresses_A_ht+0x11f63, %rsi
nop
xor $18996, %r10
mov $0x6162636465666768, %r11
movq %r11, (%rsi)
dec %r9
lea addresses_WC_ht+0x1304b, %rsi
lea addresses_D_ht+0x1e4e3, %rdi
nop
nop
nop
nop
...
nop
sub %rcx, %rcx
lea addresses_UC_ht+0x5c97, %rsi
lea addresses_UC_ht+0xa87f, %rdi
clflush (%rsi)
nop
nop
nop
...
{'OP': 'REPM', 'src': {'type': 'addresses_A_ht', 'congruent': 7, 'same': True}, 'dst': {'type': 'addresses_WC_ht', 'congruent': 4, 'same': False}}
...
{'OP': 'LOAD', 'src': {'type': 'addresses_D_ht', 'AVXalign': True, 'congruent': 7, 'size': 8, 'same': False, 'NT': True}}
{'OP': 'LOAD', 'src': {'type': 'addresses_UC_ht', 'AVXalign': False, 'congruent': 6, 'size': 16, 'same': True, 'NT': True}}
