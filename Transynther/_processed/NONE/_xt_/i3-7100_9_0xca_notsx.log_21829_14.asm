...
push %rdi
push %rsi
lea addresses_UC_ht+0x1af5c, %r13
nop
nop
nop
nop
...
nop
and %r14, %r14
lea addresses_UC_ht+0x1ec4c, %r12
cmp $8700, %r13
movw $0x6162, (%r12)
cmp $49684, %r13
lea addresses_WT_ht+0x1af8d, %r12
nop
nop
nop
nop
...
mov (%r12), %r8d
and %r13, %r13
lea addresses_WC_ht+0x1b51e, %rsi
nop
nop
xor %r14, %r14
...
movq %r8, (%rsi)
and %r14, %r14
lea addresses_D_ht+0xb85e, %rsi
lea addresses_normal_ht+0x3596, %rdi
nop
nop
nop
nop
...
nop
and $34890, %r9
lea addresses_normal_ht+0x1486, %rsi
lea addresses_UC_ht+0x1933c, %rdi
nop
nop
nop
nop
...
nop
and %rcx, %rcx
lea addresses_D_ht+0x10de5, %rcx
nop
nop
nop
nop
...
mov (%rcx), %r14w
inc %rcx
lea addresses_WC_ht+0x712, %rsi
lea addresses_UC_ht+0xa79c, %rdi
nop
nop
nop
nop
...
// Store
lea addresses_normal+0x18a26, %r14
nop
nop
nop
xor %r10, %r10
...
// Faulty Load
lea addresses_normal+0x1b596, %r14
nop
add $2546, %r15
vmovups (%r14), %ymm4
...
{'OP': 'STOR', 'dst': {'same': False, 'congruent': 3, 'NT': False, 'type': 'addresses_WC_ht', 'size': 8, 'AVXalign': True}}
...
{'src': {'same': False, 'congruent': 0, 'NT': False, 'type': 'addresses_D_ht', 'size': 2, 'AVXalign': True}, 'OP': 'LOAD'}
