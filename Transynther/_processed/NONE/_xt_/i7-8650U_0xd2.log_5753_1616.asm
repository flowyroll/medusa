...
nop
and $26277, %rcx
lea addresses_WT_ht+0x1c625, %rsi
...
nop
sub %r15, %r15
lea addresses_A_ht+0xcf2e, %rcx
add $51010, %rdi
movb $0x61, (%rcx)
nop
and $21343, %r11
lea addresses_D_ht+0xb7c5, %rsi
lea addresses_UC_ht+0xebc5, %rdi
nop
nop
add $4539, %r14
mov $99, %rcx
...
nop
inc %r12
lea addresses_A_ht+0xdcc5, %rsi
lea addresses_D_ht+0x675, %rdi
nop
nop
nop
xor %r14, %r14
...
nop
dec %r12
lea addresses_WT_ht+0x18237, %r14
nop
nop
inc %rdi
mov (%r14), %cx
add %r11, %r11
lea addresses_normal_ht+0x98c5, %rdi
nop
nop
nop
xor $60682, %r14
...
// Load
lea addresses_normal+0x134c5, %r12
clflush (%r12)
nop
nop
nop
...
// Faulty Load
lea addresses_normal+0x134c5, %rcx
nop
and $19440, %r9
mov (%rcx), %r8w
lea oracles, %rcx
...
{'OP': 'STOR', 'dst': {'type': 'addresses_RW', 'size': 8, 'AVXalign': False, 'NT': True, 'congruent': 5, 'same': False}}
...
{'OP': 'LOAD', 'src': {'type': 'addresses_US', 'size': 1, 'AVXalign': False, 'NT': False, 'congruent': 11, 'same': False}}
[Faulty Load]
...
{'OP': 'REPM', 'src': {'type': 'addresses_WT_ht', 'congruent': 0, 'same': True}, 'dst': {'type': 'addresses_UC_ht', 'congruent': 9, 'same': False}}
