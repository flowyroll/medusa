...
push %rdx
push %rsi
lea addresses_D_ht+0x11af4, %rdx
nop
nop
xor $38595, %rdi
movups (%rdx), %xmm1
...
nop
and %r8, %r8
lea addresses_WT_ht+0x4db4, %rdx
nop
sub $14083, %r12
...
nop
lfence
lea addresses_WT_ht+0xae50, %rsi
lea addresses_WT_ht+0x1cf4, %rdi
nop
nop
nop
nop
...
movups %xmm4, (%rdi)
cmp $30014, %r13
lea addresses_A_ht+0x1adb4, %r12
nop
nop
nop
nop
...
nop
add $915, %rdx
lea addresses_WT_ht+0x17df4, %rsi
lea addresses_UC_ht+0xee50, %rdi
xor %r15, %r15
mov $26, %rcx
rep movsw
nop
...
nop
sub %r12, %r12
lea addresses_UC_ht+0x106f4, %rsi
lea addresses_WT_ht+0x2af4, %rdi
nop
nop
nop
nop
...
// REPMOV
lea addresses_A+0x2764, %rsi
lea addresses_D+0x56f4, %rdi
and $17322, %r11
mov $9, %rcx
rep movsb
nop
...
{'OP': 'REPM', 'src': {'type': 'addresses_A', 'congruent': 3, 'same': False}, 'dst': {'type': 'addresses_D', 'congruent': 7, 'same': False}}
[Faulty Load]
