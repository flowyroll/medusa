...
nop
mfence
lea addresses_A_ht+0xcde9, %rsi
lea addresses_UC_ht+0x1d9e9, %rdi
nop
nop
nop
nop
...
nop
add $30688, %r13
lea addresses_normal_ht+0x1ca49, %rcx
nop
sub $55343, %rdx
...
// Faulty Load
lea addresses_normal+0xa9e9, %r15
nop
add %r12, %r12
movb (%r15), %r14b
lea oracles, %r12
...
{'OP': 'LOAD', 'src': {'type': 'addresses_NC', 'size': 32, 'AVXalign': False, 'NT': False, 'congruent': 7, 'same': False}}
...
<gen_prepare_buffer>
{'OP': 'REPM', 'src': {'type': 'addresses_WC_ht', 'congruent': 2, 'same': True}, 'dst': {'type': 'addresses_normal_ht', 'congruent': 11, 'same': False}}
{'OP': 'REPM', 'src': {'type': 'addresses_A_ht', 'congruent': 9, 'same': True}, 'dst': {'type': 'addresses_UC_ht', 'congruent': 10, 'same': False}}
