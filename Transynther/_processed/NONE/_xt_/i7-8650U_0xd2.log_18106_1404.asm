...
push %rdx
push %rsi
lea addresses_WT_ht+0x15063, %rsi
lea addresses_A_ht+0x5963, %rdi
clflush (%rdi)
nop
nop
nop
...
mov (%r8), %ax
add %rsi, %rsi
lea addresses_normal_ht+0xe4b3, %rdx
nop
nop
nop
inc %r10
...
nop
and %rdx, %rdx
lea addresses_UC_ht+0x1954c, %rsi
lea addresses_WC_ht+0x17913, %rdi
nop
nop
xor %r8, %r8
mov $109, %rcx
...
// Faulty Load
lea addresses_normal+0xeae3, %r11
nop
sub $6394, %rcx
mov (%r11), %r10
lea oracles, %r11
