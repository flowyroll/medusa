...
push %rdx
push %rsi
lea addresses_UC_ht+0x9c18, %rdx
nop
nop
nop
nop
...
nop
inc %rcx
lea addresses_UC_ht+0x14b60, %r11
nop
nop
and %r15, %r15
movb (%r11), %al
and %r8, %r8
lea addresses_D_ht+0x194c0, %r11
nop
nop
cmp $31162, %r15
...
vmovaps %ymm1, (%r11)
sub %r9, %r9
lea addresses_D_ht+0x15f40, %r11
clflush (%r11)
nop
nop
nop
...
nop
add %rax, %rax
lea addresses_normal_ht+0x18640, %rdx
nop
cmp %rcx, %rcx
mov (%rdx), %ax
nop
...
movw $0x6162, (%r15)
add $45410, %rax
lea addresses_WC_ht+0xc4a0, %rsi
lea addresses_D_ht+0x73c0, %rdi
clflush (%rsi)
nop
nop
nop
...
nop
cmp $1382, %r8
lea addresses_normal_ht+0x15cf8, %r15
nop
nop
nop
nop
...
{'OP': 'STOR', 'dst': {'type': 'addresses_D_ht', 'AVXalign': True, 'congruent': 11, 'size': 32, 'same': False, 'NT': False}}
