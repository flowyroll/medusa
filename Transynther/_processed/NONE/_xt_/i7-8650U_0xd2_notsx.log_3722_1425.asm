...
push %rdi
push %rsi
lea addresses_UC_ht+0x1e4b8, %rsi
lea addresses_UC_ht+0xecf9, %rdi
xor $4310, %r10
mov $33, %rcx
rep movsw
nop
...
nop
add %rsi, %rsi
lea addresses_WC_ht+0x18379, %rbp
nop
cmp $7503, %r8
mov (%rbp), %r14d
and %r10, %r10
lea addresses_D_ht+0x19939, %rdi
nop
sub $50947, %r10
...
nop
dec %r8
lea addresses_UC_ht+0x26b9, %r10
clflush (%r10)
nop
nop
nop
...
nop
add %r10, %r10
lea addresses_A_ht+0x176b9, %rsi
lea addresses_A_ht+0x5511, %rdi
inc %r10
mov $71, %rcx
rep movsl
nop
and %rbp, %rbp
lea addresses_D_ht+0x124b9, %rdi
nop
nop
nop
sub %r10, %r10
...
nop
add $31750, %r8
lea addresses_WC_ht+0x16bd9, %rsi
lea addresses_WT_ht+0xeeb9, %rdi
cmp %r10, %r10
mov $83, %rcx
rep movsl
nop
add $8740, %rdi
lea addresses_normal_ht+0x1ef9, %rdi
nop
sub $29585, %r14
vmovups (%rdi), %ymm2
...
nop
dec %rdi
lea addresses_UC_ht+0xb6b9, %r14
nop
nop
nop
cmp $21248, %rsi
...
nop
and $53956, %rbp
lea addresses_A_ht+0xcab9, %rsi
lea addresses_normal_ht+0x10d99, %rdi
nop
nop
nop
add %rbx, %rbx
...
rep movsw
sub %rbp, %rbp
lea addresses_D_ht+0x136b9, %rsi
cmp $8456, %rdi
mov $0x6162636465666768, %rbp
movq %rbp, %xmm3
movups %xmm3, (%rsi)
...
nop
and %r14, %r14
lea addresses_normal_ht+0x6ab9, %rbp
nop
nop
nop
nop
...
nop
add %r14, %r14
lea addresses_normal_ht+0x11eb9, %rsi
lea addresses_WC_ht+0x4a62, %rdi
nop
xor $42968, %rbp
mov $30, %rcx
rep movsw
...
<gen_prepare_buffer>
{'OP': 'REPM', 'src': {'type': 'addresses_UC_ht', 'congruent': 0, 'same': False}, 'dst': {'type': 'addresses_UC_ht', 'congruent': 2, 'same': False}}
...
{'OP': 'REPM', 'src': {'type': 'addresses_A_ht', 'congruent': 6, 'same': True}, 'dst': {'type': 'addresses_normal_ht', 'congruent': 5, 'same': False}}
