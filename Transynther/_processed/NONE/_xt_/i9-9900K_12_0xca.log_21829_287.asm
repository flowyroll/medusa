...
push %rdi
push %rsi
lea addresses_WC_ht+0xa653, %rsi
lea addresses_UC_ht+0x106d3, %rdi
nop
nop
nop
sub %rbx, %rbx
...
nop
inc %rdi
lea addresses_normal_ht+0x1e943, %rsi
lea addresses_WT_ht+0x12583, %rdi
nop
nop
nop
nop
...
rep movsw
xor %r15, %r15
lea addresses_D_ht+0x113ab, %rsi
lea addresses_normal_ht+0xcc43, %rdi
nop
nop
nop
xor %r12, %r12
...
lea addresses_normal_ht+0x9c43, %rdi
nop
nop
and $14206, %rbx
mov $57, %rcx
...
{'OP': 'REPM', 'src': {'same': True, 'type': 'addresses_normal_ht', 'congruent': 7}, 'dst': {'same': False, 'type': 'addresses_WT_ht', 'congruent': 3}}
