...
push %rdi
push %rsi
lea addresses_normal_ht+0x13d5b, %r11
cmp %rdi, %rdi
movb $0x61, (%r11)
nop
nop
nop
and $39590, %rbp
lea addresses_D_ht+0x15ae3, %rsi
clflush (%rsi)
nop
nop
nop
...
movb $0x61, (%rsi)
and %r8, %r8
lea addresses_normal_ht+0x98e3, %rsi
nop
nop
and %r13, %r13
...
nop
xor %r13, %r13
lea addresses_UC_ht+0x58e3, %rsi
nop
nop
nop
nop
...
nop
add $51639, %rbp
lea addresses_WT_ht+0x3673, %r11
nop
inc %rdi
movl $0x61626364, (%r11)
nop
...
nop
sub $58088, %rbp
lea addresses_UC_ht+0xc7a3, %rbx
nop
nop
nop
add $34172, %r13
...
nop
xor %r8, %r8
lea addresses_WT_ht+0xe4e3, %rbp
clflush (%rbp)
nop
nop
nop
...
vpextrq $1, %xmm3, %r13
inc %rbx
lea addresses_A_ht+0x166e3, %rsi
lea addresses_D_ht+0xd063, %rdi
nop
nop
nop
nop
...
rep movsw
dec %rsi
lea addresses_normal_ht+0x7003, %rsi
lea addresses_UC_ht+0x17ce3, %rdi
clflush (%rdi)
nop
xor %r11, %r11
mov $16, %rcx
...
nop
xor %rsi, %rsi
lea addresses_WT_ht+0xa263, %rdi
nop
nop
nop
nop
...
{'OP': 'REPM', 'src': {'type': 'addresses_A_ht', 'congruent': 11, 'same': True}, 'dst': {'type': 'addresses_D_ht', 'congruent': 7, 'same': False}}
{'OP': 'REPM', 'src': {'type': 'addresses_normal_ht', 'congruent': 5, 'same': False}, 'dst': {'type': 'addresses_UC_ht', 'congruent': 8, 'same': False}}
{'OP': 'STOR', 'dst': {'type': 'addresses_WT_ht', 'size': 1, 'AVXalign': False, 'NT': False, 'congruent': 4, 'same': True}}
{'32': 1541}
