...
push %rdi
push %rsi
lea addresses_D_ht+0x13536, %rbp
nop
nop
nop
nop
...
nop
inc %r10
lea addresses_WC_ht+0x9946, %r10
nop
nop
nop
nop
...
movq %rcx, (%r10)
dec %rsi
lea addresses_WT_ht+0x195b6, %rsi
...
nop
xor $20015, %rcx
lea addresses_WT_ht+0x140c6, %r10
and %r8, %r8
movb $0x61, (%r10)
nop
sub $41585, %rdi
lea addresses_A_ht+0x143c0, %rax
nop
nop
nop
nop
...
nop
sub %rax, %rax
lea addresses_UC_ht+0x1d4c6, %rbp
nop
nop
nop
inc %rdi
...
lea addresses_WC_ht+0x12986, %rdi
nop
sub %r14, %r14
mov $43, %rcx
rep movsq
...
{'OP': 'STOR', 'dst': {'same': False, 'congruent': 8, 'NT': False, 'type': 'addresses_WC_ht', 'size': 8, 'AVXalign': True}}
...
{'OP': 'STOR', 'dst': {'same': True, 'congruent': 1, 'NT': False, 'type': 'addresses_A_ht', 'size': 1, 'AVXalign': False}}
{'OP': 'STOR', 'dst': {'same': False, 'congruent': 6, 'NT': True, 'type': 'addresses_UC_ht', 'size': 1, 'AVXalign': False}}
