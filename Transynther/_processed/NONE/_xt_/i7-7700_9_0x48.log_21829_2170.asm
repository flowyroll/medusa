...
push %rdx
push %rsi
lea addresses_WT_ht+0x17627, %r12
nop
nop
nop
dec %r14
...
nop
xor $65386, %rbx
lea addresses_D_ht+0x11587, %r12
xor %r10, %r10
movw $0x6162, (%r12)
nop
nop
and $52129, %rbx
lea addresses_WT_ht+0x1c47f, %rbx
nop
nop
nop
cmp %rdx, %rdx
...
vpextrq $0, %xmm7, %r14
add $22390, %rbx
lea addresses_UC_ht+0x6527, %rdx
nop
nop
nop
nop
...
nop
xor $25519, %rsi
lea addresses_WT_ht+0x1468c, %rsi
lea addresses_A_ht+0x1b3a7, %rdi
nop
nop
nop
nop
...
nop
sub %r14, %r14
lea addresses_normal_ht+0x1049f, %rsi
lea addresses_WT_ht+0xe3e7, %rdi
clflush (%rsi)
nop
nop
nop
...
nop
xor %r12, %r12
lea addresses_D_ht+0x1a527, %rdx
nop
nop
nop
nop
...
vpextrq $0, %xmm7, %r8
cmp %rdx, %rdx
lea addresses_UC_ht+0x13827, %rsi
lea addresses_WC_ht+0x17b27, %rdi
nop
nop
nop
xor %rdx, %rdx
...
nop
and %r10, %r10
lea addresses_WC_ht+0x1c827, %r14
nop
nop
nop
nop
...
nop
xor %rcx, %rcx
lea addresses_normal_ht+0x527, %r14
nop
nop
nop
nop
...
nop
add $59494, %rbx
lea addresses_A_ht+0x1d027, %rsi
lea addresses_normal_ht+0x1c27, %rdi
nop
nop
add $16456, %r14
mov $40, %rcx
...
{'OP': 'REPM', 'src': {'type': 'addresses_WT_ht', 'congruent': 0, 'same': False}, 'dst': {'type': 'addresses_A_ht', 'congruent': 6, 'same': False}}
