...
push %rdx
push %rsi
lea addresses_WT_ht+0x6c19, %rdx
nop
inc %r12
mov (%rdx), %si
xor %r8, %r8
lea addresses_WT_ht+0x6c19, %rsi
lea addresses_WT_ht+0x2a19, %rdi
nop
cmp %r8, %r8
mov $92, %rcx
rep movsq
...
nop
sub $37970, %r9
lea addresses_normal_ht+0x1d75d, %rdx
clflush (%rdx)
nop
nop
nop
...
nop
inc %r12
lea addresses_WT_ht+0x10019, %r9
nop
nop
add $5394, %rcx
movl $0x61626364, (%r9)
cmp $14879, %r9
lea addresses_UC_ht+0x10219, %rdx
nop
nop
nop
nop
