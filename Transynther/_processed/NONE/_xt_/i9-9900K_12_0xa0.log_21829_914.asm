...
lea addresses_normal_ht+0xedd, %rdi
nop
nop
cmp %rbp, %rbp
mov $52, %rcx
rep movsl
inc %r8
lea addresses_WT_ht+0x19095, %rsi
lea addresses_A_ht+0xe8bd, %rdi
nop
nop
and $61350, %r15
mov $100, %rcx
...
nop
and %rbp, %rbp
lea addresses_normal_ht+0x12fdd, %rsi
nop
nop
add %r15, %r15
movups (%rsi), %xmm0
...
nop
and $19959, %rcx
lea addresses_UC_ht+0x1a71d, %rbp
clflush (%rbp)
nop
nop
nop
...
{'src': {'same': False, 'congruent': 2, 'type': 'addresses_WT_ht'}, 'OP': 'REPM', 'dst': {'same': True, 'congruent': 3, 'type': 'addresses_A_ht'}}
