...
push %rdi
push %rsi
lea addresses_A_ht+0xef5c, %rsi
lea addresses_D_ht+0xb8fc, %rdi
nop
nop
add %r11, %r11
mov $84, %rcx
...
nop
xor $24903, %r11
lea addresses_normal_ht+0x13f99, %r9
dec %rax
movw $0x6162, (%r9)
nop
nop
...
nop
add %r13, %r13
lea addresses_normal_ht+0x14454, %rcx
nop
nop
nop
xor $51368, %r9
...
nop
and %rdi, %rdi
lea addresses_UC_ht+0x3ffc, %r11
nop
nop
sub %rax, %rax
...
nop
xor $30504, %rcx
lea addresses_A_ht+0x12093, %rsi
lea addresses_WT_ht+0xafc, %rdi
clflush (%rdi)
nop
and %rbx, %rbx
mov $66, %rcx
...
nop
cmp $30220, %r11
lea addresses_A_ht+0x13a4a, %rsi
lea addresses_WC_ht+0x1af14, %rdi
nop
nop
nop
nop
...
nop
and %r9, %r9
lea addresses_WC_ht+0xd9fd, %rbx
nop
cmp %rsi, %rsi
vmovups (%rbx), %ymm6
...
nop
cmp $46642, %rdi
lea addresses_WC_ht+0x1c59c, %rbx
clflush (%rbx)
and %rcx, %rcx
movb (%rbx), %r11b
cmp $28519, %rcx
lea addresses_WC_ht+0x1eefc, %r13
nop
sub $15864, %rdi
movb (%r13), %r9b
nop
...
nop
inc %rdi
lea addresses_A_ht+0x12190, %r13
nop
nop
nop
nop
...
nop
cmp $44987, %rax
lea addresses_D_ht+0x1bfd4, %r13
nop
dec %rax
movb (%r13), %r9b
nop
...
nop
cmp $33719, %rcx
lea addresses_D_ht+0x18ac4, %rsi
lea addresses_A_ht+0x7b84, %rdi
clflush (%rdi)
nop
add %rax, %rax
mov $59, %rcx
...
// Faulty Load
lea addresses_normal+0x42fc, %r13
nop
nop
nop
add %r9, %r9
...
<gen_faulty_load>
[REF]
{'src': {'type': 'addresses_normal', 'same': False, 'size': 2, 'congruent': 0, 'NT': True, 'AVXalign': True}, 'OP': 'LOAD'}
[Faulty Load]
