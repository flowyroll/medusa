...
nop
sub %r9, %r9
lea addresses_WC_ht+0x1c577, %r13
add %r8, %r8
movw $0x6162, (%r13)
nop
nop
...
nop
add $20716, %rdi
lea addresses_D_ht+0x1a68f, %rsi
lea addresses_WT_ht+0x336f, %rdi
clflush (%rdi)
nop
nop
nop
...
nop
cmp $15231, %r14
lea addresses_A_ht+0x1d887, %rsi
inc %r8
mov $0x6162636465666768, %r14
movq %r14, (%rsi)
xor %r8, %r8
lea addresses_A_ht+0x6aaf, %rsi
lea addresses_WT_ht+0x9b5e, %rdi
cmp %r11, %r11
mov $88, %rcx
rep movsq
nop
...
nop
cmp $8036, %rsi
lea addresses_normal_ht+0xa1f, %r11
nop
nop
add %r14, %r14
mov (%r11), %di
xor %rcx, %rcx
lea addresses_D_ht+0xfe2f, %r9
inc %r11
mov (%r9), %rdi
add %rcx, %rcx
lea addresses_WT_ht+0x2fef, %rbx
nop
xor %r9, %r9
...
nop
and $62469, %rsi
lea addresses_WT_ht+0x3c6f, %rbx
nop
nop
nop
nop
...
nop
and %rsi, %rsi
lea addresses_A_ht+0x1ddc1, %r13
nop
nop
nop
nop
...
nop
sub %r14, %r14
lea addresses_D_ht+0x1e6ef, %rsi
...
nop
cmp $30672, %r13
lea addresses_WC_ht+0x16c6f, %r8
nop
nop
dec %r13
movups (%r8), %xmm6
...
nop
and %r9, %r9
lea addresses_normal_ht+0x18c5f, %rdi
nop
nop
nop
nop
...
{'OP': 'STOR', 'dst': {'type': 'addresses_WC_ht', 'size': 2, 'AVXalign': True, 'NT': False, 'congruent': 3, 'same': False}}
{'OP': 'REPM', 'src': {'type': 'addresses_D_ht', 'congruent': 5, 'same': False}, 'dst': {'type': 'addresses_WT_ht', 'congruent': 7, 'same': False}}
{'OP': 'STOR', 'dst': {'type': 'addresses_A_ht', 'size': 8, 'AVXalign': False, 'NT': False, 'congruent': 1, 'same': False}}
{'OP': 'REPM', 'src': {'type': 'addresses_A_ht', 'congruent': 5, 'same': False}, 'dst': {'type': 'addresses_WT_ht', 'congruent': 0, 'same': True}}
