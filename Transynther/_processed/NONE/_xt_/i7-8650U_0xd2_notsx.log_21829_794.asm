...
push %rdx
push %rsi
lea addresses_D_ht+0x1a09d, %r15
nop
nop
nop
add $54237, %r8
...
nop
and $60214, %r12
lea addresses_A_ht+0x1ebfd, %rsi
lea addresses_D_ht+0x1ce3d, %rdi
nop
cmp %r10, %r10
mov $93, %rcx
rep movsb
add %r8, %r8
lea addresses_WC_ht+0xddfd, %r10
clflush (%r10)
nop
nop
cmp $16873, %r8
...
nop
cmp %rsi, %rsi
lea addresses_UC_ht+0x47fd, %rsi
lea addresses_UC_ht+0x19bfd, %rdi
clflush (%rsi)
nop
nop
inc %rdx
...
nop
sub %r15, %r15
lea addresses_normal_ht+0x1767d, %r15
clflush (%r15)
nop
nop
nop
...
// Faulty Load
lea addresses_normal+0x1cbfd, %rdi
nop
nop
sub $1039, %r15
mov (%rdi), %r10w
...
{'OP': 'REPM', 'src': {'type': 'addresses_UC_ht', 'congruent': 5, 'same': True}, 'dst': {'type': 'addresses_UC_ht', 'congruent': 10, 'same': True}}
