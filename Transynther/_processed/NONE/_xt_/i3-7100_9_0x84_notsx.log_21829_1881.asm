...
push %rdi
push %rsi
lea addresses_WT_ht+0xb75d, %rsi
lea addresses_WC_ht+0x99ad, %rdi
sub %r10, %r10
mov $120, %rcx
rep movsb
nop
...
nop
and %r8, %r8
lea addresses_UC_ht+0xe89d, %rsi
lea addresses_A_ht+0x1595d, %rdi
clflush (%rsi)
sub %rbx, %rbx
mov $0, %rcx
rep movsq
nop
sub $20663, %rcx
lea addresses_normal_ht+0x94cd, %rcx
nop
nop
cmp $41505, %r12
mov (%rcx), %r8w
nop
dec %r10
lea addresses_WT_ht+0x1175d, %r8
nop
nop
nop
nop
...
nop
sub %r8, %r8
lea addresses_normal_ht+0x13cfd, %rbx
nop
nop
nop
nop
...
movq %rbx, (%r8)
mfence
lea addresses_A_ht+0x1b55d, %rcx
nop
add %r10, %r10
movb $0x61, (%rcx)
xor %rdi, %rdi
lea addresses_UC_ht+0x3cad, %rsi
lea addresses_UC_ht+0xb95d, %rdi
nop
inc %r9
mov $13, %rcx
rep movsl
...
// Store
lea addresses_normal+0x1c53d, %r12
xor %r9, %r9
movb $0x51, (%r12)
nop
cmp $47094, %r8
...
{'src': {'type': 'addresses_normal_ht', 'same': False, 'size': 2, 'congruent': 4, 'NT': False, 'AVXalign': True}, 'OP': 'LOAD'}
{'dst': {'type': 'addresses_WT_ht', 'same': True, 'size': 4, 'congruent': 9, 'NT': True, 'AVXalign': False}, 'OP': 'STOR'}
