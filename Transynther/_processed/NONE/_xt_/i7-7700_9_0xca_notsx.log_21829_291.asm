...
push %rdi
push %rsi
lea addresses_normal_ht+0x1e7ef, %rcx
nop
nop
and $34275, %r13
mov (%rcx), %rbp
...
nop
xor $20280, %rdi
lea addresses_UC_ht+0x1ebef, %rax
nop
nop
nop
cmp %r11, %r11
...
vpextrq $1, %xmm2, %rcx
dec %rax
lea addresses_WC_ht+0x396f, %rax
nop
nop
nop
nop
...
movl $0x61626364, (%rax)
sub $18361, %rcx
lea addresses_normal_ht+0x999d, %r14
nop
nop
nop
and %r11, %r11
...
nop
sub $586, %rbp
lea addresses_normal_ht+0xcefb, %r13
nop
nop
nop
xor $121, %r14
...
nop
dec %rcx
lea addresses_D_ht+0x1dfef, %rsi
lea addresses_normal_ht+0x1625, %rdi
clflush (%rsi)
nop
nop
nop
...
// Store
lea addresses_normal+0x992f, %r8
nop
nop
cmp %rax, %rax
...
{'dst': {'NT': False, 'AVXalign': True, 'size': 8, 'congruent': 10, 'same': False, 'type': 'addresses_UC'}, 'OP': 'STOR'}
...
{'dst': {'NT': False, 'AVXalign': False, 'size': 2, 'congruent': 5, 'same': False, 'type': 'addresses_PSE'}, 'OP': 'STOR'}
[Faulty Load]
...
{'src': {'NT': False, 'AVXalign': True, 'size': 32, 'congruent': 4, 'same': False, 'type': 'addresses_A_ht'}, 'OP': 'LOAD'}
{'src': {'NT': False, 'AVXalign': False, 'size': 4, 'congruent': 6, 'same': False, 'type': 'addresses_D_ht'}, 'OP': 'LOAD'}
{'src': {'congruent': 10, 'same': False, 'type': 'addresses_D_ht'}, 'dst': {'congruent': 1, 'same': False, 'type': 'addresses_normal_ht'}, 'OP': 'REPM'}
{'39': 21829}
