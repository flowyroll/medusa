...
nop
sub %r14, %r14
lea addresses_WT_ht+0x19428, %r10
nop
nop
inc %rdi
movb $0x61, (%r10)
nop
add %r9, %r9
lea addresses_UC_ht+0x157a4, %rdi
nop
nop
nop
nop
...
nop
dec %r9
lea addresses_normal_ht+0xf0e0, %rcx
nop
sub $47380, %r9
...
{'OP': 'LOAD', 'src': {'type': 'addresses_D', 'size': 32, 'AVXalign': False, 'NT': False, 'congruent': 5, 'same': False}}
[Faulty Load]
