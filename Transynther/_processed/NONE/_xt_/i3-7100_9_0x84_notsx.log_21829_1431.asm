...
nop
and %r11, %r11
lea addresses_WT_ht+0x1d9ff, %rbx
clflush (%rbx)
nop
nop
nop
...
movups %xmm1, (%rbx)
mfence
lea addresses_UC_ht+0x1abff, %rdi
nop
nop
nop
nop
...
nop
add %rdx, %rdx
lea addresses_D_ht+0x159ff, %r15
nop
and $60600, %rdi
movb $0x61, (%r15)
nop
...
nop
sub $46012, %r12
lea addresses_WT_ht+0x548f, %rsi
lea addresses_normal_ht+0xb1ff, %rdi
nop
nop
nop
nop
...
{'src': {'type': 'addresses_WT_ht', 'congruent': 4, 'same': True}, 'dst': {'type': 'addresses_normal_ht', 'congruent': 11, 'same': False}, 'OP': 'REPM'}
{'32': 21829}
