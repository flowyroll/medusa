...
nop
xor $36445, %r9
lea addresses_WT_ht+0xdcdb, %rbp
nop
nop
nop
nop
...
nop
dec %rbp
lea addresses_normal_ht+0x16c7b, %rsi
lea addresses_D_ht+0x1e54b, %rdi
nop
nop
nop
nop
...
nop
sub $22121, %rcx
lea addresses_WC_ht+0xc3db, %r15
nop
nop
nop
sub %rdi, %rdi
