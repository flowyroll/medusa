...
push %rdi
push %rsi
lea addresses_D_ht+0x1e9c5, %rsi
lea addresses_normal_ht+0x16c7d, %rdi
clflush (%rsi)
nop
nop
nop
...
nop
and $25554, %rbp
lea addresses_D_ht+0x1e373, %rsi
...
nop
and $34389, %rcx
lea addresses_WC_ht+0x8ddd, %rsi
lea addresses_normal_ht+0x2089, %rdi
cmp $33967, %r15
mov $111, %rcx
rep movsq
nop
...
nop
add %r15, %r15
lea addresses_normal_ht+0x81dd, %r10
nop
cmp $62156, %r15
mov (%r10), %r8
nop
...
nop
dec %r8
lea addresses_WC_ht+0x92c5, %rsi
nop
sub %r10, %r10
movups (%rsi), %xmm4
vpextrq $1, %xmm4, %rbp
nop
inc %rcx
lea addresses_normal_ht+0xb9dd, %rsi
lea addresses_A_ht+0xf61c, %rdi
clflush (%rdi)
nop
nop
nop
...
nop
and %r8, %r8
lea addresses_WT_ht+0x90c9, %rsi
lea addresses_UC_ht+0x9dd, %rdi
mfence
mov $46, %rcx
rep movsq
nop
and %rdi, %rdi
lea addresses_D_ht+0x2de9, %r15
nop
nop
nop
nop
...
{'dst': {'same': False, 'congruent': 3, 'type': 'addresses_UC_ht'}, 'OP': 'REPM', 'src': {'same': False, 'congruent': 0, 'type': 'addresses_D_ht'}}
