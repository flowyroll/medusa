...
push %rdx
push %rsi
lea addresses_WC_ht+0x6a30, %r12
nop
cmp %r13, %r13
mov (%r12), %dx
nop
...
nop
and %r13, %r13
lea addresses_A_ht+0x16e58, %rsi
lea addresses_WT_ht+0xb470, %rdi
clflush (%rsi)
nop
nop
nop
...
nop
dec %r13
lea addresses_A_ht+0x106a0, %rdx
clflush (%rdx)
nop
xor $6565, %r9
vmovups (%rdx), %ymm5
...
lea addresses_WC_ht+0x7108, %rdi
nop
xor $20194, %r12
mov $20, %rcx
rep movsb
...
nop
cmp %r12, %r12
lea addresses_A_ht+0x16f34, %rsi
lea addresses_A_ht+0xda78, %rdi
nop
add $35157, %rbx
mov $54, %rcx
rep movsb
...
lea addresses_WT_ht+0x15b08, %rdi
xor $56498, %r13
mov $32, %rcx
rep movsq
nop
...
nop
and %rbx, %rbx
lea addresses_WT_ht+0x8588, %rsi
lea addresses_D_ht+0x1a908, %rdi
nop
nop
nop
nop
...
nop
dec %r9
lea addresses_D_ht+0xbf08, %rsi
lea addresses_normal_ht+0x4cc8, %rdi
clflush (%rdi)
nop
nop
nop
