...
push %rdi
push %rsi
lea addresses_WT_ht+0x75c4, %r14
clflush (%r14)
nop
nop
nop
...
nop
sub %rcx, %rcx
lea addresses_A_ht+0x533c, %rsi
lea addresses_D_ht+0x49c4, %rdi
clflush (%rsi)
nop
nop
nop
...
nop
and $60165, %rsi
lea addresses_WC_ht+0x9dc4, %rdi
nop
add %r12, %r12
movw $0x6162, (%rdi)
nop
...
nop
add %rax, %rax
lea addresses_UC_ht+0x43c4, %rsi
nop
nop
sub %rax, %rax
...
nop
cmp $11994, %rdi
lea addresses_D_ht+0x901c, %rsi
lea addresses_WT_ht+0xf444, %rdi
nop
nop
sub %r10, %r10
mov $10, %rcx
rep movsb
cmp $54355, %r14
lea addresses_D_ht+0x15ffa, %r13
nop
nop
inc %r14
...
nop
and %rax, %rax
lea addresses_normal_ht+0x4358, %rcx
nop
cmp %r14, %r14
mov $0x6162636465666768, %r10
movq %r10, %xmm1
...
nop
cmp %rsi, %rsi
lea addresses_WT_ht+0x7922, %rsi
lea addresses_UC_ht+0x10614, %rdi
cmp %r14, %r14
mov $74, %rcx
rep movsw
nop
nop
dec %rsi
lea addresses_UC_ht+0x19bc4, %r13
nop
nop
add %rdi, %rdi
mov (%r13), %esi
nop
dec %rax
lea addresses_WT_ht+0x15dc4, %rax
sub $52276, %rdi
mov (%rax), %r14w
nop
nop
...
{'OP': 'LOAD', 'src': {'type': 'addresses_P', 'AVXalign': True, 'congruent': 4, 'size': 2, 'same': False, 'NT': False}}
[Faulty Load]
...
{'OP': 'STOR', 'dst': {'type': 'addresses_normal_ht', 'AVXalign': False, 'congruent': 0, 'size': 16, 'same': False, 'NT': True}}
{'OP': 'REPM', 'src': {'type': 'addresses_WT_ht', 'congruent': 0, 'same': False}, 'dst': {'type': 'addresses_UC_ht', 'congruent': 4, 'same': False}}
{'OP': 'LOAD', 'src': {'type': 'addresses_UC_ht', 'AVXalign': True, 'congruent': 11, 'size': 4, 'same': False, 'NT': False}}
