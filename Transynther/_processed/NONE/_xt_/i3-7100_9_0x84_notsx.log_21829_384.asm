...
lea addresses_UC_ht+0x146df, %rdi
clflush (%rsi)
sub %r12, %r12
mov $82, %rcx
rep movsq
inc %rsi
lea addresses_normal_ht+0x2b3d, %r12
clflush (%r12)
nop
dec %r11
movw $0x6162, (%r12)
nop
xor %rcx, %rcx
lea addresses_WT_ht+0xaa84, %rsi
nop
nop
nop
lfence
...
nop
cmp $57821, %rcx
lea addresses_normal_ht+0x1d81d, %rsi
nop
nop
inc %r11
vmovups (%rsi), %ymm0
...
nop
sub $2727, %rcx
lea addresses_UC_ht+0x543d, %rsi
...
{'src': {'type': 'addresses_UC_ht', 'congruent': 2, 'same': True}, 'dst': {'type': 'addresses_UC_ht', 'congruent': 0, 'same': False}, 'OP': 'REPM'}
