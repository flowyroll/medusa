...
push %rdi
push %rsi
lea addresses_D_ht+0x11047, %rsi
lea addresses_WC_ht+0x472f, %rdi
dec %rax
mov $45, %rcx
rep movsb
cmp $5963, %r11
lea addresses_UC_ht+0x3549, %r9
nop
nop
nop
dec %r8
...
nop
cmp $39274, %rax
lea addresses_A_ht+0x1442f, %rcx
nop
and $60124, %rsi
...
nop
add $15353, %rax
lea addresses_WT_ht+0x1782f, %r8
nop
nop
nop
and $43727, %rcx
...
nop
xor %r8, %r8
lea addresses_WT_ht+0x202f, %rsi
lea addresses_normal_ht+0x73cf, %rdi
nop
nop
nop
and $10631, %r10
...
nop
and $46319, %rax
lea addresses_normal_ht+0xf8ef, %r9
xor %rax, %rax
...
nop
sub $24533, %r9
lea addresses_WC_ht+0xffc7, %rax
nop
nop
nop
nop
...
// Faulty Load
lea addresses_normal+0xec2f, %r10
nop
nop
nop
cmp $10258, %r13
...
{'OP': 'STOR', 'dst': {'type': 'addresses_A_ht', 'AVXalign': True, 'size': 16, 'NT': False, 'same': False, 'congruent': 11}}
...
{'src': {'type': 'addresses_WT_ht', 'congruent': 10, 'same': False}, 'OP': 'REPM', 'dst': {'type': 'addresses_normal_ht', 'congruent': 5, 'same': False}}
