...
push %rdi
push %rsi
lea addresses_WC_ht+0x111f6, %rsi
lea addresses_A_ht+0xef26, %rdi
nop
nop
nop
nop
...
nop
xor $12324, %r10
lea addresses_WT_ht+0x1676e, %rbp
nop
xor %r8, %r8
...
nop
dec %r12
lea addresses_A_ht+0x1eb76, %rcx
nop
nop
nop
nop
...
nop
sub $19728, %r12
lea addresses_normal_ht+0x19ef6, %rsi
nop
nop
nop
and %r12, %r12
...
nop
dec %rcx
lea addresses_UC_ht+0xb776, %rsi
nop
nop
nop
add %r12, %r12
...
nop
add %r12, %r12
lea addresses_WC_ht+0x174f7, %rdi
nop
add $769, %rcx
movb $0x61, (%rdi)
nop
nop
dec %r10
lea addresses_WC_ht+0x10336, %rcx
nop
nop
nop
nop
