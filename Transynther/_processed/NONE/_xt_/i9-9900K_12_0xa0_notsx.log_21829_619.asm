...
nop
add $10058, %r11
lea addresses_UC_ht+0xfefc, %rcx
nop
nop
sub $32308, %rbp
mov (%rcx), %r10
...
nop
add $32116, %r10
lea addresses_WT_ht+0x1db3c, %rax
nop
nop
nop
nop
...
mov (%rax), %r11
sub %rbp, %rbp
lea addresses_WC_ht+0x33fc, %r11
nop
and $30149, %r8
movb $0x61, (%r11)
add %rcx, %rcx
