...
push %rdi
push %rsi
lea addresses_A_ht+0x145a8, %r15
nop
nop
nop
nop
...
nop
inc %r13
lea addresses_WT_ht+0xc7c8, %rsi
lea addresses_WC_ht+0x17188, %rdi
nop
nop
nop
nop
...
lea addresses_UC_ht+0x1bfc8, %rdi
clflush (%rsi)
nop
nop
nop
...
nop
lfence
lea addresses_A_ht+0x1d5d8, %r11
and $57488, %r13
...
nop
inc %rsi
lea addresses_normal_ht+0x32f8, %rsi
nop
nop
nop
nop
...
nop
add %rsi, %rsi
lea addresses_D_ht+0x19028, %r15
nop
nop
xor %r13, %r13
mov (%r15), %di
...
{'src': {'type': 'addresses_WT_ht', 'congruent': 3, 'same': True}, 'OP': 'REPM', 'dst': {'type': 'addresses_WC_ht', 'congruent': 7, 'same': False}}
