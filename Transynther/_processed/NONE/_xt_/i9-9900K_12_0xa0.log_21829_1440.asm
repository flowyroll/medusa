...
push %rdi
push %rsi
lea addresses_WC_ht+0x3c92, %r12
nop
nop
nop
xor %r11, %r11
movl $0x61626364, (%r12)
dec %r12
lea addresses_WC_ht+0x15e12, %rsi
lea addresses_WT_ht+0x13a92, %rdi
nop
nop
nop
nop
...
nop
xor $64599, %r10
lea addresses_normal_ht+0x15a92, %rdi
nop
and %r9, %r9
vmovups (%rdi), %ymm7
...
nop
and %rsi, %rsi
lea addresses_UC_ht+0xba92, %rsi
clflush (%rsi)
cmp $53932, %rcx
mov (%rsi), %r11w
sub $8409, %rdi
lea addresses_A_ht+0xa12, %rdi
and $45831, %r12
mov (%rdi), %r10
nop
nop
...
lea addresses_normal_ht+0x1e292, %rdi
add %rbx, %rbx
mov $97, %rcx
rep movsl
nop
...
nop
sub $12853, %rsi
lea addresses_normal_ht+0xd7b6, %rbx
nop
nop
and %r11, %r11
...
movups %xmm6, (%rbx)
cmp $50293, %r11
lea addresses_WT_ht+0x16292, %rsi
lea addresses_normal_ht+0xe3d2, %rdi
nop
xor $12600, %rbx
mov $127, %rcx
rep movsw
...
{'src': {'same': False, 'congruent': 11, 'type': 'addresses_WT_ht'}, 'OP': 'REPM', 'dst': {'same': False, 'congruent': 6, 'type': 'addresses_normal_ht'}}
{'33': 21829}
