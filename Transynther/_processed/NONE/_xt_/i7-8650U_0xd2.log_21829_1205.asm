...
push %rdi
push %rsi
lea addresses_UC_ht+0x60f1, %rsi
lea addresses_WT_ht+0x127b1, %rdi
clflush (%rsi)
and $46168, %r11
mov $69, %rcx
rep movsl
nop
and %rbp, %rbp
lea addresses_WC_ht+0xb0f1, %r12
nop
cmp %r14, %r14
...
nop
inc %r11
lea addresses_WT_ht+0x7d01, %rbp
nop
nop
nop
nop
...
nop
dec %r12
lea addresses_WC_ht+0x13831, %r12
nop
sub $32023, %rdi
mov (%r12), %ecx
nop
xor $62426, %rcx
lea addresses_normal_ht+0x14bf1, %rsi
lea addresses_WT_ht+0xd30d, %rdi
nop
nop
nop
nop
...
// Faulty Load
lea addresses_normal+0x8af1, %rsi
nop
nop
xor %r11, %r11
movups (%rsi), %xmm6
...
{'OP': 'LOAD', 'src': {'type': 'addresses_D', 'size': 16, 'AVXalign': False, 'NT': False, 'congruent': 10, 'same': False}}
{'OP': 'REPM', 'src': {'type': 'addresses_D', 'congruent': 2, 'same': False}, 'dst': {'type': 'addresses_P', 'congruent': 6, 'same': False}}
[Faulty Load]
