...
lea addresses_UC_ht+0x1d9d1, %rdi
clflush (%rdi)
nop
add %r14, %r14
mov $125, %rcx
...
nop
and $24980, %r14
lea addresses_A_ht+0x4911, %r14
dec %rdi
movb $0x61, (%r14)
nop
nop
dec %r8
lea addresses_UC_ht+0x9993, %r8
clflush (%r8)
nop
nop
nop
...
vpextrq $0, %xmm5, %rsi
cmp %r11, %r11
lea addresses_UC_ht+0x11451, %r14
nop
nop
inc %r11
mov (%r14), %r8w
...
nop
add %rdi, %rdi
lea addresses_UC_ht+0x2499, %r14
nop
nop
nop
nop
...
nop
sub $26146, %rdi
lea addresses_D_ht+0x12811, %rsi
clflush (%rsi)
sub $249, %rcx
movb $0x61, (%rsi)
nop
...
nop
and %r14, %r14
lea addresses_WT_ht+0x18411, %rcx
nop
nop
nop
nop
...
nop
xor $19241, %r9
lea addresses_A_ht+0x17501, %rdi
add %r11, %r11
movw $0x6162, (%rdi)
nop
nop
...
<gen_prepare_buffer>
{'OP': 'REPM', 'src': {'type': 'addresses_WC_ht', 'congruent': 9, 'same': False}, 'dst': {'type': 'addresses_UC_ht', 'congruent': 5, 'same': True}}
