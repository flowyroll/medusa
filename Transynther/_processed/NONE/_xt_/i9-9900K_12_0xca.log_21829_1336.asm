...
push %rdx
push %rsi
lea addresses_WC_ht+0xa35e, %rax
nop
nop
cmp %rdx, %rdx
movw $0x6162, (%rax)
add $46807, %r11
lea addresses_normal_ht+0x85be, %rax
nop
nop
nop
nop
...
nop
sub $2475, %rcx
lea addresses_normal_ht+0x3900, %rcx
clflush (%rcx)
nop
nop
sub $63260, %rdi
...
vmovups %ymm5, (%rcx)
dec %rbp
lea addresses_WC_ht+0x6c8, %rsi
lea addresses_A_ht+0xbbe, %rdi
clflush (%rsi)
nop
nop
cmp %r11, %r11
...
nop
xor %rsi, %rsi
lea addresses_normal_ht+0x168be, %rdi
nop
nop
nop
nop
...
nop
xor %rdx, %rdx
lea addresses_A_ht+0x30be, %r14
sub $54798, %rbp
mov $0x6162636465666768, %rdi
movq %rdi, %xmm7
movups %xmm7, (%r14)
add %r14, %r14
lea addresses_normal_ht+0x1ebba, %rsi
nop
nop
nop
nop
...
{'OP': 'REPM', 'src': {'same': False, 'type': 'addresses_WC_ht', 'congruent': 1}, 'dst': {'same': False, 'type': 'addresses_A_ht', 'congruent': 5}}
