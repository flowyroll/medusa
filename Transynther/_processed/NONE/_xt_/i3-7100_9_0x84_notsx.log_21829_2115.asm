...
push %rbp
push %rcx
lea addresses_normal_ht+0xea0d, %r11
clflush (%r11)
nop
cmp $19423, %rcx
...
nop
cmp $12712, %r8
lea addresses_UC_ht+0x1670d, %r8
nop
nop
nop
nop
...
// Load
lea addresses_normal+0x878d, %r9
nop
nop
nop
nop
...
// Store
lea addresses_normal+0xf0d, %rsi
clflush (%rsi)
nop
add %rbp, %rbp
movl $0x51525354, (%rsi)
