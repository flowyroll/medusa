...
push %rdi
push %rsi
lea addresses_A_ht+0x18b0a, %rsi
lea addresses_A_ht+0x722a, %rdi
and $40347, %r12
mov $90, %rcx
rep movsw
nop
nop
sub %r13, %r13
lea addresses_WC_ht+0x140d2, %rsi
lea addresses_WT_ht+0x15fea, %rdi
nop
nop
xor %rbx, %rbx
mov $64, %rcx
...
// Store
lea addresses_normal+0x1f20a, %rbp
nop
nop
nop
nop
...
// REPMOV
lea addresses_normal+0xbeca, %rsi
lea addresses_WC+0x16929, %rdi
dec %r10
mov $95, %rcx
rep movsl
...
{'src': {'congruent': 6, 'same': False, 'type': 'addresses_normal'}, 'dst': {'congruent': 0, 'same': False, 'type': 'addresses_WC'}, 'OP': 'REPM'}
...
{'src': {'congruent': 3, 'same': False, 'type': 'addresses_WC_ht'}, 'dst': {'congruent': 3, 'same': False, 'type': 'addresses_WT_ht'}, 'OP': 'REPM'}
{'33': 21829}
