...
push %rdi
push %rsi
lea addresses_UC_ht+0x15945, %rsi
lea addresses_WT_ht+0x8b95, %rdi
nop
nop
nop
nop
...
nop
xor %r8, %r8
lea addresses_normal_ht+0x125a5, %rsi
lea addresses_WT_ht+0x1b555, %rdi
clflush (%rdi)
nop
nop
inc %r10
...
nop
cmp %r14, %r14
lea addresses_WC_ht+0x12591, %rsi
nop
nop
nop
nop
...
nop
dec %rdi
lea addresses_normal_ht+0x17151, %rsi
...
nop
add $8895, %rdi
lea addresses_D_ht+0x143d5, %rsi
nop
and %rcx, %rcx
movups (%rsi), %xmm4
vpextrq $0, %xmm4, %r10
...
nop
dec %r14
lea addresses_UC_ht+0x64a5, %r11
nop
nop
add $46956, %rdi
movb (%r11), %r14b
nop
xor %r8, %r8
lea addresses_D_ht+0x15f15, %rdi
nop
nop
nop
nop
...
nop
and $26080, %rdi
lea addresses_normal_ht+0x4395, %rcx
xor %r14, %r14
...
nop
and $51119, %rcx
lea addresses_normal_ht+0xcb95, %rsi
lea addresses_A_ht+0x3715, %rdi
nop
nop
nop
add %r15, %r15
...
rep movsb
and %r10, %r10
lea addresses_normal_ht+0x2b95, %rsi
lea addresses_WC_ht+0x1d395, %rdi
nop
nop
nop
cmp $20043, %r10
...
{'dst': {'type': 'addresses_UC', 'same': False, 'size': 4, 'congruent': 1, 'NT': False, 'AVXalign': True}, 'OP': 'STOR'}
...
{'src': {'type': 'addresses_normal_ht', 'congruent': 11, 'same': False}, 'dst': {'type': 'addresses_A_ht', 'congruent': 5, 'same': False}, 'OP': 'REPM'}
