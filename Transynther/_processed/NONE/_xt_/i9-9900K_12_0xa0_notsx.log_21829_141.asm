...
push %rdi
push %rsi
lea addresses_D_ht+0x17cb8, %r13
nop
add $49132, %r9
...
nop
add $3056, %r13
lea addresses_D_ht+0x155f4, %rsi
lea addresses_WT_ht+0x12d34, %rdi
clflush (%rdi)
nop
nop
nop
...
nop
sub %rbp, %rbp
lea addresses_UC_ht+0xff38, %rsi
inc %rbp
mov $0x6162636465666768, %r15
movq %r15, %xmm7
...
nop
add $52340, %r13
lea addresses_UC_ht+0x116d4, %rdi
nop
sub %rsi, %rsi
movw $0x6162, (%rdi)
and %rsi, %rsi
lea addresses_normal_ht+0xe4f4, %r9
nop
cmp %rsi, %rsi
mov (%r9), %ecx
nop
...
nop
mfence
lea addresses_UC_ht+0x1d5f4, %r15
sub %rbp, %rbp
...
movw $0x6162, (%r9)
cmp %rsi, %rsi
lea addresses_normal_ht+0x6b08, %rsi
lea addresses_normal_ht+0x65f4, %rdi
nop
xor %rbp, %rbp
mov $70, %rcx
rep movsb
...
nop
cmp $41773, %rsi
lea addresses_WC_ht+0x104f4, %rsi
lea addresses_A_ht+0x2f24, %rdi
nop
nop
nop
nop
...
nop
add %rdi, %rdi
lea addresses_WT_ht+0x152fb, %r15
nop
nop
nop
nop
...
nop
add %rbp, %rbp
lea addresses_UC_ht+0x95f4, %r15
nop
nop
nop
nop
...
// Faulty Load
lea addresses_normal+0x7df4, %r9
nop
nop
nop
nop
...
{'OP': 'STOR', 'dst': {'type': 'addresses_UC_ht', 'AVXalign': False, 'size': 16, 'NT': True, 'same': False, 'congruent': 0}}
...
{'src': {'type': 'addresses_normal_ht', 'congruent': 0, 'same': False}, 'OP': 'REPM', 'dst': {'type': 'addresses_normal_ht', 'congruent': 5, 'same': False}}
