...
rep movsb
sub %rdi, %rdi
lea addresses_UC_ht+0xa7d7, %r12
dec %rbx
vmovups (%r12), %ymm2
...
nop
and %r12, %r12
lea addresses_UC_ht+0x1eed7, %r13
nop
nop
nop
nop
...
vmovups %ymm3, (%r13)
and $40618, %r13
lea addresses_WT_ht+0xd2c3, %rsi
nop
nop
nop
nop
...
// REPMOV
lea addresses_WT+0x13a83, %rsi
lea addresses_WT+0x13a83, %rdi
nop
nop
nop
sub %r9, %r9
...
// Store
lea addresses_normal+0x1fa83, %r12
add $11721, %r13
...
{'OP': 'REPM', 'src': {'same': True, 'congruent': 0, 'type': 'addresses_WT'}, 'dst': {'same': True, 'congruent': 0, 'type': 'addresses_WT'}}
...
<gen_prepare_buffer>
{'OP': 'REPM', 'src': {'same': False, 'congruent': 6, 'type': 'addresses_A_ht'}, 'dst': {'same': False, 'congruent': 3, 'type': 'addresses_D_ht'}}
