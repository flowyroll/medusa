...
push %rdi
push %rsi
lea addresses_UC_ht+0x143e5, %r13
nop
nop
nop
nop
...
nop
xor $37725, %rax
lea addresses_normal_ht+0x95a5, %rbp
nop
nop
nop
nop
...
vmovups %ymm7, (%rbp)
cmp $45131, %r9
lea addresses_normal_ht+0x65, %r9
clflush (%r9)
sub %rdi, %rdi
movl $0x61626364, (%r9)
sub %r13, %r13
lea addresses_normal_ht+0x41a5, %rsi
lea addresses_A_ht+0x1e1a5, %rdi
nop
nop
nop
sub %rax, %rax
...
{'src': {'congruent': 11, 'same': True, 'type': 'addresses_normal_ht'}, 'dst': {'congruent': 9, 'same': False, 'type': 'addresses_A_ht'}, 'OP': 'REPM'}
{'37': 21829}
