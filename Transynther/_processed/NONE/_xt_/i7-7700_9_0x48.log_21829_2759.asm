...
push %rdx
push %rsi
lea addresses_WC_ht+0xe790, %rbx
nop
nop
nop
nop
...
nop
and %rbp, %rbp
lea addresses_WC_ht+0x18d52, %r10
xor $30982, %r15
movb $0x61, (%r10)
nop
nop
xor %rbx, %rbx
lea addresses_normal_ht+0x8b42, %rbx
nop
nop
nop
nop
...
nop
inc %rdx
lea addresses_D_ht+0x4742, %r10
and %r15, %r15
mov (%r10), %rbp
xor %rbx, %rbx
lea addresses_D_ht+0x11641, %rsi
lea addresses_UC_ht+0x1442, %rdi
nop
nop
nop
nop
...
nop
cmp %rdi, %rdi
lea addresses_WT_ht+0xd772, %r15
nop
nop
nop
nop
...
nop
inc %r12
lea addresses_WC_ht+0x56a2, %r15
xor %r12, %r12
...
// Faulty Load
lea addresses_normal+0x16342, %r11
nop
nop
nop
nop
...
{'OP': 'LOAD', 'src': {'type': 'addresses_WC_ht', 'AVXalign': False, 'congruent': 4, 'size': 2, 'same': False, 'NT': True}}
