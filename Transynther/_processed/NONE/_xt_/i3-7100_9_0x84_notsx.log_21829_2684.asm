...
push %rdx
push %rsi
lea addresses_UC_ht+0x1c1b0, %rdi
sub $32218, %r11
movb $0x61, (%rdi)
add $56100, %r13
lea addresses_normal_ht+0x1b608, %rax
nop
nop
nop
and $6412, %r14
...
nop
add %rdx, %rdx
lea addresses_WC_ht+0x15624, %rdx
nop
nop
nop
nop
...
nop
inc %r14
lea addresses_WC_ht+0xb324, %rsi
lea addresses_normal_ht+0x1327c, %rdi
nop
nop
nop
nop
...
// Faulty Load
lea addresses_normal+0x7124, %r9
nop
nop
nop
nop
