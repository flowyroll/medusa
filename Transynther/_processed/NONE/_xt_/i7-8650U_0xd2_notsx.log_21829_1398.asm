...
push %rdi
push %rsi
lea addresses_A_ht+0x37f6, %rsi
lea addresses_A_ht+0x1d476, %rdi
sub %rbx, %rbx
mov $119, %rcx
rep movsq
nop
...
nop
xor $47146, %r10
lea addresses_WT_ht+0x83f6, %rsi
...
nop
add $15804, %rcx
lea addresses_UC_ht+0x1de36, %rsi
lea addresses_WC_ht+0x13a76, %rdi
nop
xor %rbx, %rbx
mov $35, %rcx
rep movsq
...
nop
cmp %rsi, %rsi
lea addresses_WT_ht+0x5038, %r10
nop
nop
nop
nop
