...
push %rdx
push %rsi
lea addresses_UC_ht+0x1354b, %r13
nop
nop
nop
xor $2909, %r14
...
nop
add %rdx, %rdx
lea addresses_WC_ht+0x307c, %rsi
lea addresses_WC_ht+0x12600, %rdi
nop
nop
xor $7887, %rbx
mov $78, %rcx
...
nop
sub $29034, %rbx
lea addresses_normal_ht+0x2d60, %rsi
nop
nop
nop
xor $45221, %rdx
mov (%rsi), %rcx
cmp %r14, %r14
lea addresses_D_ht+0x1927c, %rdx
clflush (%rdx)
nop
and $37306, %rbx
movb (%rdx), %r14b
inc %rbx
lea addresses_D_ht+0x1c05c, %rsi
nop
nop
nop
nop
...
nop
xor %rdi, %rdi
lea addresses_UC_ht+0xf57c, %r14
nop
nop
nop
cmp $16382, %rsi
...
nop
dec %rdi
lea addresses_D_ht+0x1b2a4, %r14
sub %r13, %r13
mov $0x6162636465666768, %rdx
movq %rdx, %xmm4
movups %xmm4, (%r14)
...
nop
sub $6946, %rcx
lea addresses_normal_ht+0x1547c, %rcx
nop
nop
cmp $35456, %rsi
mov (%rcx), %r14
...
nop
add %rsi, %rsi
lea addresses_WC_ht+0x169fc, %rsi
lea addresses_D_ht+0x1c07c, %rdi
nop
nop
nop
cmp %rax, %rax
...
nop
cmp %rcx, %rcx
lea addresses_D_ht+0x1e5fc, %r13
nop
nop
nop
xor %r14, %r14
mov (%r13), %rbx
cmp %rsi, %rsi
lea addresses_UC_ht+0xeabc, %rcx
nop
nop
nop
nop
...
// Faulty Load
lea addresses_normal+0x1527c, %r10
nop
nop
nop
sub %rbp, %rbp
...
{'src': {'congruent': 7, 'same': False, 'type': 'addresses_WC_ht'}, 'dst': {'congruent': 2, 'same': False, 'type': 'addresses_WC_ht'}, 'OP': 'REPM'}
...
{'src': {'NT': True, 'AVXalign': False, 'size': 8, 'congruent': 7, 'same': False, 'type': 'addresses_D_ht'}, 'OP': 'LOAD'}
