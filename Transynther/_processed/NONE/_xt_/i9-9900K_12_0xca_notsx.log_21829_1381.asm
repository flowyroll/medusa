...
nop
and %r12, %r12
lea addresses_WT_ht+0xbcad, %r12
clflush (%r12)
add $26365, %rax
...
vmovaps %ymm4, (%r12)
dec %rbx
lea addresses_D_ht+0x140ad, %rax
clflush (%rax)
nop
nop
nop
...
nop
cmp %r14, %r14
lea addresses_normal_ht+0x23ad, %rsi
nop
nop
inc %r9
...
{'OP': 'REPM', 'src': {'same': False, 'congruent': 1, 'type': 'addresses_D'}, 'dst': {'same': False, 'congruent': 7, 'type': 'addresses_UC'}}
[Faulty Load]
...
{'OP': 'STOR', 'dst': {'same': False, 'type': 'addresses_WT_ht', 'NT': False, 'AVXalign': True, 'size': 32, 'congruent': 11}}
