...
vpextrq $1, %xmm2, %r9
xor $56408, %r9
lea addresses_WT_ht+0x6a25, %rsi
lea addresses_D_ht+0x4c25, %rdi
nop
nop
nop
dec %r15
...
nop
lfence
lea addresses_normal_ht+0x4ba9, %rdx
nop
cmp $14198, %rsi
movb $0x61, (%rdx)
nop
...
lea addresses_WC_ht+0x16365, %rdi
nop
sub $12418, %r13
mov $45, %rcx
rep movsl
dec %r15
lea addresses_WC_ht+0xc785, %rsi
lea addresses_WT_ht+0xd7e5, %rdi
nop
nop
nop
and $47551, %r13
...
{'dst': {'same': False, 'congruent': 4, 'type': 'addresses_WT_ht'}, 'OP': 'REPM', 'src': {'same': False, 'congruent': 5, 'type': 'addresses_WC_ht'}}
{'37': 21829}
