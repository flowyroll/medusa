...
nop
dec %rcx
lea addresses_WC_ht+0x1536e, %rsi
clflush (%rsi)
nop
nop
nop
...
movb (%rsi), %cl
inc %rcx
lea addresses_normal_ht+0xa36e, %r10
nop
nop
add %r9, %r9
movl $0x61626364, (%r10)
xor %rsi, %rsi
lea addresses_UC_ht+0x14b6e, %r14
clflush (%r14)
nop
nop
nop
...
vpextrq $1, %xmm1, %rcx
sub %rdi, %rdi
lea addresses_WT_ht+0xf9ee, %rsi
lea addresses_WT_ht+0x5d2e, %rdi
nop
nop
nop
add %r11, %r11
...
rep movsq
inc %r10
lea addresses_WT_ht+0x1396e, %r9
nop
nop
nop
dec %r11
