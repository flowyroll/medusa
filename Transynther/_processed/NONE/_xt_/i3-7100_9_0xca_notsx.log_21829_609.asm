...
nop
add %rbx, %rbx
lea addresses_A_ht+0x1c9b0, %r14
nop
nop
nop
nop
...
movw $0x6162, (%r14)
cmp $43517, %rbx
lea addresses_UC_ht+0x1b4b0, %r14
nop
nop
nop
nop
...
nop
cmp %rax, %rax
lea addresses_WT_ht+0x1aa74, %r13
nop
nop
nop
xor %r11, %r11
...
movntdq %xmm0, (%r13)
cmp %rsi, %rsi
lea addresses_D_ht+0x1c8de, %rbx
nop
dec %rax
mov (%rbx), %ecx
nop
nop
sub %rcx, %rcx
lea addresses_D_ht+0x127c8, %rsi
...
nop
xor %r14, %r14
lea addresses_WT_ht+0xf4b0, %r14
nop
nop
nop
and %rbx, %rbx
