...
push %rdi
push %rsi
lea addresses_normal_ht+0x352f, %r14
nop
nop
nop
nop
...
nop
xor $44692, %r14
lea addresses_UC_ht+0x903b, %r13
nop
nop
nop
nop
...
nop
xor $44947, %r13
lea addresses_WC_ht+0x16faf, %rsi
lea addresses_normal_ht+0x49c1, %rdi
and $43678, %rbx
mov $53, %rcx
rep movsb
nop
...
nop
add %rbp, %rbp
lea addresses_WC_ht+0x1c12f, %rsi
lea addresses_A_ht+0x1b0af, %rdi
nop
nop
cmp %rax, %rax
mov $83, %rcx
...
nop
cmp $42125, %rdi
lea addresses_UC_ht+0x164f, %rbp
cmp %rdi, %rdi
mov $0x6162636465666768, %rbx
movq %rbx, (%rbp)
nop
mfence
lea addresses_A_ht+0x112fb, %r9
nop
dec %r14
vmovups (%r9), %ymm1
...
vpextrq $1, %xmm3, %r14
and $32041, %r13
lea addresses_WT_ht+0x15d57, %r9
nop
nop
nop
nop
...
nop
sub %r9, %r9
lea addresses_A_ht+0x1b52f, %rsi
lea addresses_WC_ht+0x8347, %rdi
nop
sub $4199, %r9
mov $65, %rcx
rep movsl
...
{'src': {'type': 'addresses_WC_ht', 'congruent': 7, 'same': False}, 'dst': {'type': 'addresses_normal_ht', 'congruent': 1, 'same': False}, 'OP': 'REPM'}
{'src': {'type': 'addresses_WC_ht', 'congruent': 7, 'same': False}, 'dst': {'type': 'addresses_A_ht', 'congruent': 6, 'same': False}, 'OP': 'REPM'}
{'dst': {'type': 'addresses_UC_ht', 'same': True, 'size': 8, 'congruent': 5, 'NT': False, 'AVXalign': False}, 'OP': 'STOR'}
