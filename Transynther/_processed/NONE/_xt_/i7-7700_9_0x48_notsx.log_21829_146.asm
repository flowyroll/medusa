...
push %rdi
push %rsi
lea addresses_normal_ht+0x17be4, %rsi
lea addresses_WC_ht+0x19aac, %rdi
clflush (%rdi)
nop
nop
nop
...
nop
sub %r9, %r9
lea addresses_WC_ht+0xaddc, %rax
xor %r15, %r15
mov $0x6162636465666768, %r10
movq %r10, %xmm4
vmovups %ymm4, (%rax)
xor $18728, %rax
lea addresses_D_ht+0x12254, %rax
cmp $236, %rcx
mov $0x6162636465666768, %r10
movq %r10, %xmm0
movups %xmm0, (%rax)
...
nop
xor %rcx, %rcx
lea addresses_normal_ht+0xe25c, %rsi
lea addresses_D_ht+0x1d65c, %rdi
clflush (%rsi)
nop
add $23327, %r14
mov $75, %rcx
...
nop
inc %r10
lea addresses_D_ht+0x1d45c, %rsi
lea addresses_normal_ht+0x1dfc, %rdi
nop
nop
nop
cmp %r14, %r14
...
nop
cmp %rsi, %rsi
lea addresses_D_ht+0x11814, %rsi
lea addresses_WC_ht+0x1bccc, %rdi
nop
nop
cmp $65070, %r9
mov $71, %rcx
...
nop
dec %r15
lea addresses_WT_ht+0x26dc, %rsi
lea addresses_normal_ht+0x4d44, %rdi
nop
nop
and %r15, %r15
mov $70, %rcx
...
nop
xor $9870, %rcx
lea addresses_WT_ht+0x6608, %rcx
nop
inc %r10
movw $0x6162, (%rcx)
nop
...
lea addresses_WT_ht+0x1c0c0, %rdi
nop
nop
nop
nop
...
nop
and %r9, %r9
lea addresses_normal_ht+0x1cadc, %rsi
...
rep movsw
and %rcx, %rcx
lea addresses_WC_ht+0x3e5c, %rsi
lea addresses_WC_ht+0xbe5c, %rdi
nop
nop
nop
nop
...
{'dst': {'same': False, 'congruent': 1, 'type': 'addresses_normal_ht'}, 'OP': 'REPM', 'src': {'same': False, 'congruent': 6, 'type': 'addresses_WT_ht'}}
{'dst': {'same': False, 'NT': False, 'AVXalign': True, 'size': 2, 'type': 'addresses_WT_ht', 'congruent': 2}, 'OP': 'STOR'}
{'dst': {'same': False, 'congruent': 1, 'type': 'addresses_WT_ht'}, 'OP': 'REPM', 'src': {'same': False, 'congruent': 3, 'type': 'addresses_UC_ht'}}
{'dst': {'same': False, 'congruent': 5, 'type': 'addresses_WC_ht'}, 'OP': 'REPM', 'src': {'same': False, 'congruent': 7, 'type': 'addresses_normal_ht'}}
