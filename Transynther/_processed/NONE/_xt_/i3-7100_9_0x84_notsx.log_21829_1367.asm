...
nop
cmp $40566, %rcx
lea addresses_WT_ht+0xc38b, %rdi
add $29802, %r12
mov (%rdi), %r13d
nop
nop
nop
add %rsi, %rsi
lea addresses_A_ht+0x1478b, %rbp
nop
nop
nop
nop
...
nop
add $65529, %r11
lea addresses_WT_ht+0x1ef04, %rsi
lea addresses_UC_ht+0x15aab, %rdi
clflush (%rsi)
nop
and %r12, %r12
mov $8, %rcx
...
nop
add $59918, %rbp
lea addresses_WT_ht+0x130eb, %rsi
clflush (%rsi)
nop
nop
nop
...
nop
and $28606, %rbp
lea addresses_WT_ht+0x17d4b, %rcx
nop
nop
nop
add $34417, %r13
...
nop
dec %r13
lea addresses_UC_ht+0x5b8b, %rsi
nop
nop
add %rcx, %rcx
movb $0x61, (%rsi)
...
nop
xor $43727, %rcx
lea addresses_D_ht+0x1358b, %rsi
nop
nop
nop
sub $33587, %rdi
...
nop
and $65524, %r12
lea addresses_UC_ht+0x1e0f9, %rdi
nop
nop
nop
and $18804, %r12
...
nop
add $21414, %rbp
lea addresses_A_ht+0x18d5f, %rcx
nop
nop
nop
dec %rbp
...
<gen_prepare_buffer>
{'src': {'type': 'addresses_A_ht', 'congruent': 9, 'same': False}, 'dst': {'type': 'addresses_WC_ht', 'congruent': 5, 'same': True}, 'OP': 'REPM'}
...
{'dst': {'type': 'addresses_WT_ht', 'same': True, 'size': 8, 'congruent': 6, 'NT': False, 'AVXalign': True}, 'OP': 'STOR'}
