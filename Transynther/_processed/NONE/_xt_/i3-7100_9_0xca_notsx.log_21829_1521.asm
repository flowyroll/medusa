...
push %rdi
push %rsi
lea addresses_WT_ht+0xb7ba, %rbp
clflush (%rbp)
sub %rcx, %rcx
mov (%rbp), %r9d
nop
...
nop
dec %r9
lea addresses_WC_ht+0xd2ec, %rdi
nop
nop
add $53743, %rbp
movb (%rdi), %r10b
and %rcx, %rcx
lea addresses_A_ht+0xfaec, %rdi
and $1731, %r8
vmovups (%rdi), %ymm3
vextracti128 $1, %ymm3, %xmm3
vpextrq $0, %xmm3, %rbp
sub %r8, %r8
lea addresses_UC_ht+0x19664, %rcx
nop
nop
nop
add $19841, %rbx
...
nop
inc %rbx
lea addresses_D_ht+0x1a6ec, %rbx
nop
nop
nop
xor %r10, %r10
...
movups %xmm5, (%rbx)
cmp %rdi, %rdi
lea addresses_normal_ht+0x4cec, %rsi
lea addresses_UC_ht+0x6ebc, %rdi
add %r9, %r9
mov $99, %rcx
rep movsb
nop
...
// Faulty Load
lea addresses_normal+0x24ec, %rsi
nop
nop
xor $5426, %r11
vmovups (%rsi), %ymm5
...
{'src': {'same': False, 'congruent': 5, 'NT': False, 'type': 'addresses_US', 'size': 16, 'AVXalign': False}, 'OP': 'LOAD'}
...
{'src': {'type': 'addresses_normal_ht', 'congruent': 11, 'same': True}, 'OP': 'REPM', 'dst': {'type': 'addresses_UC_ht', 'congruent': 4, 'same': False}}
{'34': 21829}
