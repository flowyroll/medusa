...
push %rdx
push %rsi
lea addresses_D_ht+0x11b2e, %rbx
nop
nop
sub %rdx, %rdx
mov (%rbx), %r14w
...
nop
lfence
lea addresses_A_ht+0x1672e, %r11
clflush (%r11)
nop
nop
nop
...
nop
add %rbp, %rbp
lea addresses_A_ht+0x14916, %r14
nop
nop
and %rdi, %rdi
movups (%r14), %xmm6
...
nop
xor %rbx, %rbx
lea addresses_normal_ht+0x1db4e, %rsi
lea addresses_D_ht+0x1c72e, %rdi
nop
nop
nop
nop
...
nop
mfence
lea addresses_UC_ht+0xec01, %rcx
sub %r10, %r10
movb (%rcx), %r14b
nop
sub %rcx, %rcx
lea addresses_WT_ht+0xb98e, %r10
nop
add $28158, %r14
...
movups %xmm5, (%r10)
sub %rbx, %rbx
lea addresses_WT_ht+0x1237a, %rsi
lea addresses_WC_ht+0x1d396, %rdi
clflush (%rdi)
nop
nop
add %rbx, %rbx
...
nop
sub $4477, %r10
lea addresses_normal_ht+0x1211e, %rsi
lea addresses_normal_ht+0x16d2e, %rdi
nop
sub %rbx, %rbx
mov $59, %rcx
rep movsw
...
{'dst': {'same': False, 'congruent': 10, 'type': 'addresses_D_ht'}, 'OP': 'REPM', 'src': {'same': True, 'congruent': 5, 'type': 'addresses_normal_ht'}}
...
{'dst': {'same': True, 'congruent': 9, 'type': 'addresses_normal_ht'}, 'OP': 'REPM', 'src': {'same': False, 'congruent': 2, 'type': 'addresses_normal_ht'}}
{'39': 21829}
