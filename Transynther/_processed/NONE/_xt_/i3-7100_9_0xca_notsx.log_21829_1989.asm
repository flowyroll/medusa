...
push %rdi
push %rsi
lea addresses_WC_ht+0x35ab, %rax
nop
nop
nop
dec %r14
...
vmovaps %ymm2, (%rax)
sub $64854, %r8
lea addresses_WT_ht+0xe78f, %r10
nop
nop
inc %rcx
movl $0x61626364, (%r10)
...
nop
cmp %r8, %r8
lea addresses_WC_ht+0x598f, %rsi
lea addresses_UC_ht+0x34df, %rdi
clflush (%rdi)
nop
nop
nop
...
nop
and $35462, %r10
lea addresses_UC_ht+0x24c2, %rsi
lea addresses_normal_ht+0x2f5f, %rdi
nop
nop
add $6701, %rbx
mov $96, %rcx
...
nop
add %rax, %rax
lea addresses_D_ht+0xe14f, %rsi
lea addresses_WT_ht+0x1740f, %rdi
clflush (%rsi)
nop
nop
dec %r10
...
{'OP': 'STOR', 'dst': {'same': False, 'congruent': 0, 'NT': False, 'type': 'addresses_WT', 'size': 32, 'AVXalign': True}}
[Faulty Load]
