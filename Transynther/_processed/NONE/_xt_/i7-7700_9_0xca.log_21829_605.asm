...
push %rdi
push %rsi
lea addresses_A_ht+0x886f, %rsi
lea addresses_D_ht+0x11337, %rdi
cmp %r13, %r13
mov $63, %rcx
rep movsl
nop
nop
xor %r14, %r14
lea addresses_normal_ht+0x17737, %rax
nop
nop
nop
nop
...
nop
sub %rsi, %rsi
lea addresses_UC_ht+0xcf17, %rcx
clflush (%rcx)
nop
nop
cmp %r10, %r10
...
nop
add $6787, %r13
lea addresses_normal_ht+0x1d337, %rdi
clflush (%rdi)
nop
xor $28370, %rcx
movl $0x61626364, (%rdi)
...
nop
cmp %rdi, %rdi
lea addresses_D_ht+0x1257, %rsi
lea addresses_A_ht+0xef37, %rdi
nop
nop
dec %r8
mov $58, %rcx
rep movsl
xor $51802, %rsi
lea addresses_WT_ht+0x7037, %rsi
lea addresses_WT_ht+0x9f37, %rdi
nop
nop
nop
nop
...
// Store
lea addresses_normal+0x9b37, %r9
clflush (%r9)
nop
nop
cmp %rax, %rax
...
// Faulty Load
lea addresses_normal+0x5337, %r9
nop
and $5345, %r11
vmovups (%r9), %ymm6
...
<gen_prepare_buffer>
{'src': {'congruent': 2, 'same': False, 'type': 'addresses_A_ht'}, 'OP': 'REPM', 'dst': {'congruent': 6, 'same': True, 'type': 'addresses_D_ht'}}
