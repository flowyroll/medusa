...
push %rdx
push %rsi
lea addresses_UC_ht+0x199b6, %rsi
lea addresses_WT_ht+0x1a236, %rdi
nop
xor $59952, %r12
mov $45, %rcx
rep movsl
...
nop
xor $15117, %rdi
lea addresses_UC_ht+0x129b6, %r11
nop
nop
nop
nop
...
nop
inc %rsi
lea addresses_UC_ht+0x142b6, %rdi
nop
nop
add $65078, %r9
mov (%rdi), %ecx
...
nop
inc %r9
lea addresses_normal_ht+0x6c86, %rsi
lea addresses_A_ht+0x99b6, %rdi
nop
nop
nop
add %r11, %r11
...
mov (%rsi), %edi
dec %r9
lea addresses_normal_ht+0x41b6, %rcx
nop
nop
cmp %r12, %r12
movw $0x6162, (%rcx)
nop
xor %r12, %r12
lea addresses_normal_ht+0x1c1b6, %rbp
nop
nop
nop
nop
...
nop
add %rsi, %rsi
lea addresses_UC_ht+0x14c7a, %rsi
lea addresses_normal_ht+0x1190c, %rdi
nop
nop
nop
dec %rdx
...
{'dst': {'type': 'addresses_RW', 'same': False, 'size': 1, 'congruent': 7, 'NT': False, 'AVXalign': True}, 'OP': 'STOR'}
[Faulty Load]
...
{'src': {'type': 'addresses_UC_ht', 'congruent': 1, 'same': False}, 'dst': {'type': 'addresses_normal_ht', 'congruent': 1, 'same': False}, 'OP': 'REPM'}
{'32': 21829}
