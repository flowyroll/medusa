...
push %rdx
push %rsi
lea addresses_UC_ht+0x138c2, %rdi
nop
nop
nop
nop
...
mov (%rdi), %r9d
sub $9459, %rdi
lea addresses_WT_ht+0x6a0c, %r12
clflush (%r12)
inc %r14
...
nop
sub $49344, %rdx
lea addresses_WC_ht+0x6db4, %r14
nop
cmp $54973, %r13
vmovups (%r14), %ymm2
...
nop
add %r13, %r13
lea addresses_normal_ht+0x3104, %rsi
lea addresses_WT_ht+0x744c, %rdi
nop
nop
nop
nop
...
rep movsw
and $59242, %rdi
lea addresses_normal_ht+0x322c, %r13
nop
nop
and %r12, %r12
...
nop
cmp %rdi, %rdi
lea addresses_WT_ht+0x15f0c, %r9
nop
nop
nop
nop
...
nop
xor $11345, %rdx
lea addresses_WC_ht+0x8904, %rsi
nop
nop
nop
nop
...
movq %r13, (%rsi)
and %rdx, %rdx
lea addresses_normal_ht+0x13d8c, %r9
inc %r13
mov (%r9), %rdx
nop
nop
cmp $17530, %r13
lea addresses_WC_ht+0x418c, %rdi
nop
add $45184, %rsi
movw $0x6162, (%rdi)
nop
...
nop
lfence
lea addresses_A_ht+0x1800c, %rsi
lea addresses_normal_ht+0x10964, %rdi
nop
nop
nop
inc %rdx
...
<gen_faulty_load>
[REF]
{'src': {'same': False, 'congruent': 0, 'NT': True, 'type': 'addresses_RW', 'size': 32, 'AVXalign': False}, 'OP': 'LOAD'}
[Faulty Load]
...
{'OP': 'STOR', 'dst': {'same': False, 'congruent': 8, 'NT': False, 'type': 'addresses_WT_ht', 'size': 32, 'AVXalign': True}}
...
{'src': {'type': 'addresses_A_ht', 'congruent': 7, 'same': False}, 'OP': 'REPM', 'dst': {'type': 'addresses_normal_ht', 'congruent': 3, 'same': True}}
{'32': 21829}
