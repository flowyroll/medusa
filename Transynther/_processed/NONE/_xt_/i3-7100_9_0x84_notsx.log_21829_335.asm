...
push %rdx
push %rsi
lea addresses_WT_ht+0xf79a, %rdx
nop
nop
nop
nop
...
movb $0x61, (%rdx)
sub %rcx, %rcx
lea addresses_normal_ht+0x15cdc, %rsi
lea addresses_UC_ht+0x13f9a, %rdi
nop
nop
nop
and %r10, %r10
...
nop
and $552, %rdi
lea addresses_WC_ht+0x11eae, %rsi
lea addresses_WT_ht+0xe42, %rdi
nop
nop
nop
and %r10, %r10
...
nop
cmp %rdi, %rdi
lea addresses_WT_ht+0x4530, %rsi
lea addresses_normal_ht+0x2a9a, %rdi
nop
nop
nop
and $49726, %r11
...
{'src': {'type': 'addresses_WC_ht', 'congruent': 2, 'same': False}, 'dst': {'type': 'addresses_WT_ht', 'congruent': 1, 'same': False}, 'OP': 'REPM'}
