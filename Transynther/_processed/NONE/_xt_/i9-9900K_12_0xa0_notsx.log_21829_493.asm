...
push %rdx
push %rsi
lea addresses_A_ht+0x19731, %rax
nop
nop
and %r10, %r10
mov (%rax), %r9d
...
nop
dec %rsi
lea addresses_WT_ht+0xefe5, %rbx
nop
nop
nop
nop
...
nop
sub %r12, %r12
lea addresses_WT_ht+0x149e5, %r9
nop
nop
nop
nop
...
nop
dec %r12
lea addresses_D_ht+0x12a25, %rsi
lea addresses_D_ht+0x1228d, %rdi
nop
nop
nop
nop
...
nop
sub $38844, %r12
lea addresses_WC_ht+0x9e59, %rdx
nop
nop
nop
nop
...
nop
sub %rdx, %rdx
lea addresses_WC_ht+0xf7e5, %rsi
lea addresses_WC_ht+0x6681, %rdi
nop
nop
and %r10, %r10
mov $30, %rcx
...
<gen_prepare_buffer>
{'src': {'type': 'addresses_A_ht', 'AVXalign': True, 'size': 4, 'NT': True, 'same': False, 'congruent': 2}, 'OP': 'LOAD'}
...
{'src': {'type': 'addresses_WC_ht', 'congruent': 10, 'same': True}, 'OP': 'REPM', 'dst': {'type': 'addresses_WC_ht', 'congruent': 1, 'same': False}}
{'35': 21829}
