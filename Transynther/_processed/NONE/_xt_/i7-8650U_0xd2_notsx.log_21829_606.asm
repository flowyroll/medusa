...
push %rdx
push %rsi
lea addresses_WC_ht+0x98d6, %rsi
lea addresses_WT_ht+0x9df6, %rdi
nop
nop
and $28189, %r14
mov $114, %rcx
rep movsq
sub %r12, %r12
lea addresses_WC_ht+0x19176, %rdx
nop
nop
nop
and %r11, %r11
...
nop
sub $28730, %r12
lea addresses_UC_ht+0x6df6, %r11
clflush (%r11)
nop
nop
xor %rdi, %rdi
mov (%r11), %r14d
inc %r11
lea addresses_normal_ht+0x98d3, %rsi
lea addresses_D_ht+0x111b6, %rdi
nop
nop
nop
nop
...
rep movsb
xor $43153, %r14
lea addresses_WC_ht+0x1a26, %rsi
lea addresses_WT_ht+0x1c032, %rdi
nop
nop
add $36041, %r11
mov $52, %rcx
...
nop
sub $42799, %rdi
lea addresses_normal_ht+0x16deb, %r11
nop
inc %rdi
movw $0x6162, (%r11)
nop
cmp $3619, %rdx
lea addresses_WC_ht+0x6436, %rbp
nop
nop
nop
nop
...
lea addresses_WC_ht+0x16df6, %rdi
nop
dec %r11
mov $119, %rcx
rep movsb
...
nop
cmp $30041, %r14
lea addresses_WT_ht+0xbdf6, %r12
nop
nop
nop
nop
...
nop
sub %rdx, %rdx
lea addresses_UC_ht+0xe3f6, %r11
nop
nop
add %rsi, %rsi
mov (%r11), %rbp
...
nop
cmp $32301, %rcx
lea addresses_UC_ht+0x37b6, %rbp
and $45213, %r12
and $0xffffffffffffffc0, %rbp
movntdqa (%rbp), %xmm2
vpextrq $1, %xmm2, %rsi
nop
sub $33229, %r14
lea addresses_normal_ht+0x155f6, %r14
nop
nop
nop
sub $19128, %rdi
...
nop
inc %rdx
lea addresses_WT_ht+0x14992, %rdi
nop
nop
nop
nop
...
// Load
lea addresses_normal+0xdb56, %r13
nop
nop
nop
and $22933, %rdi
...
// Faulty Load
lea addresses_normal+0x1cdf6, %r12
nop
sub $63702, %rsi
mov (%r12), %rdx
lea oracles, %rbx
...
{'OP': 'STOR', 'dst': {'type': 'addresses_normal_ht', 'size': 2, 'AVXalign': False, 'NT': False, 'congruent': 0, 'same': True}}
