...
nop
and %r11, %r11
lea addresses_UC_ht+0x1d3e3, %rsi
lea addresses_WT_ht+0x1c67, %rdi
nop
nop
nop
nop
...
nop
add $7035, %rsi
lea addresses_WC_ht+0x867, %rsi
lea addresses_UC_ht+0x11467, %rdi
nop
nop
cmp %rdx, %rdx
mov $0, %rcx
...
nop
and $41204, %rdi
lea addresses_normal_ht+0x2867, %rsi
lea addresses_normal_ht+0x6be7, %rdi
clflush (%rdi)
nop
nop
add %r13, %r13
...
nop
sub $29211, %r11
lea addresses_A_ht+0x1a933, %rdi
nop
and %rbx, %rbx
movb (%rdi), %r13b
nop
...
nop
dec %r13
lea addresses_A_ht+0x16067, %rdi
nop
sub %rbx, %rbx
movl $0x61626364, (%rdi)
nop
...
nop
cmp %r10, %r10
lea addresses_WC_ht+0x11b67, %rdx
nop
nop
nop
and %rcx, %rcx
...
nop
add %rcx, %rcx
lea addresses_normal_ht+0xf567, %r13
nop
sub $58355, %rcx
...
// Faulty Load
lea addresses_normal+0x8867, %r12
nop
nop
add $50634, %rdi
movups (%r12), %xmm5
...
{'OP': 'LOAD', 'src': {'type': 'addresses_WT_ht', 'size': 32, 'AVXalign': False, 'NT': True, 'congruent': 2, 'same': False}}
{'OP': 'REPM', 'src': {'type': 'addresses_UC_ht', 'congruent': 2, 'same': False}, 'dst': {'type': 'addresses_WT_ht', 'congruent': 10, 'same': False}}
{'OP': 'REPM', 'src': {'type': 'addresses_WC_ht', 'congruent': 8, 'same': False}, 'dst': {'type': 'addresses_UC_ht', 'congruent': 9, 'same': False}}
...
{'OP': 'LOAD', 'src': {'type': 'addresses_A_ht', 'size': 1, 'AVXalign': False, 'NT': False, 'congruent': 1, 'same': True}}
