...
push %rdx
push %rsi
lea addresses_WC_ht+0x90ba, %rcx
clflush (%rcx)
add %rdx, %rdx
...
nop
xor $65266, %rsi
lea addresses_WT_ht+0x16e7a, %rsi
lea addresses_D_ht+0x8dae, %rdi
nop
nop
nop
nop
...
nop
sub $54153, %rdi
lea addresses_normal_ht+0x1bcfa, %r13
nop
add $9917, %r11
vmovups (%r13), %ymm2
...
nop
inc %r9
lea addresses_UC_ht+0x188fa, %r9
nop
nop
nop
add $43973, %r13
...
nop
xor %r11, %r11
lea addresses_UC_ht+0x126fa, %r11
nop
sub $32366, %rdi
