...
push %rdi
push %rsi
lea addresses_A_ht+0x11b08, %rsi
nop
nop
nop
sub %rcx, %rcx
...
nop
xor %rdi, %rdi
lea addresses_UC_ht+0xcc30, %rsi
lea addresses_A_ht+0x4ae4, %rdi
nop
nop
nop
nop
...
rep movsq
and $64517, %rcx
lea addresses_D_ht+0x18928, %rcx
nop
nop
nop
add %r8, %r8
...
nop
and $43609, %rbx
lea addresses_normal_ht+0x5c30, %r10
nop
nop
sub %rcx, %rcx
mov (%r10), %di
xor %rbx, %rbx
lea addresses_UC_ht+0x5e60, %rdi
nop
nop
nop
sub $22883, %rcx
...
nop
mfence
lea addresses_normal_ht+0x8e60, %r10
nop
nop
nop
nop
...
{'src': {'type': 'addresses_UC_ht', 'congruent': 10, 'same': False}, 'OP': 'REPM', 'dst': {'type': 'addresses_A_ht', 'congruent': 2, 'same': False}}
