...
nop
xor $43560, %rdx
lea addresses_WC_ht+0x12ea1, %rsi
lea addresses_D_ht+0x10dd1, %rdi
add %r11, %r11
mov $93, %rcx
rep movsb
nop
...
nop
and %rsi, %rsi
lea addresses_D_ht+0x153d1, %rbp
clflush (%rbp)
nop
nop
nop
...
nop
and $34514, %rdx
lea addresses_UC_ht+0xbdd1, %rcx
nop
nop
nop
nop
...
lea addresses_WC_ht+0x70b9, %rdi
nop
and %rbp, %rbp
mov $17, %rcx
rep movsq
...
// Store
lea addresses_normal+0x1a351, %r14
nop
cmp $4884, %r15
movb $0x51, (%r14)
nop
...
{'OP': 'LOAD', 'src': {'type': 'addresses_NC', 'AVXalign': False, 'congruent': 7, 'size': 8, 'same': False, 'NT': False}}
[Faulty Load]
...
{'OP': 'LOAD', 'src': {'type': 'addresses_UC_ht', 'AVXalign': False, 'congruent': 10, 'size': 2, 'same': True, 'NT': False}}
