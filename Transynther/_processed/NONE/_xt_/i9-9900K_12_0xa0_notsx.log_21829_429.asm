...
mov (%rdi), %cx
add $42153, %r13
lea addresses_UC_ht+0x3d03, %rsi
lea addresses_WC_ht+0x1d0c3, %rdi
nop
nop
xor %r10, %r10
mov $66, %rcx
...
nop
add $4581, %r12
lea addresses_UC_ht+0x16703, %r8
nop
nop
nop
nop
...
nop
and %r12, %r12
lea addresses_WT_ht+0x10093, %r10
nop
nop
sub %r12, %r12
movb $0x61, (%r10)
...
lea addresses_WT_ht+0x3983, %rdi
nop
nop
sub %r13, %r13
mov $76, %rcx
...
nop
dec %r13
lea addresses_normal_ht+0x19583, %rsi
lea addresses_normal_ht+0x9e03, %rdi
nop
nop
and %rax, %rax
mov $62, %rcx
...
nop
and %r12, %r12
lea addresses_normal_ht+0xcc83, %rsi
nop
cmp $10351, %r12
movb $0x61, (%rsi)
nop
...
vpextrq $1, %xmm6, %rsi
sub %rsi, %rsi
lea addresses_WT_ht+0x7b7, %r10
cmp $65526, %r8
movb $0x61, (%r10)
nop
inc %rax
lea addresses_normal_ht+0x10d03, %r10
nop
nop
nop
nop
...
nop
cmp $1889, %r12
lea addresses_D_ht+0x12303, %r13
nop
nop
nop
xor %r8, %r8
...
{'src': {'type': 'addresses_normal_ht', 'congruent': 7, 'same': False}, 'OP': 'REPM', 'dst': {'type': 'addresses_normal_ht', 'congruent': 7, 'same': False}}
