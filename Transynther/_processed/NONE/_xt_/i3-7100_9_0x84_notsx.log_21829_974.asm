...
push %rdi
push %rsi
lea addresses_WT_ht+0x18c0f, %r15
nop
nop
and $32212, %rcx
...
nop
cmp %r12, %r12
lea addresses_WC_ht+0x640f, %r14
clflush (%r14)
nop
nop
nop
...
movups %xmm2, (%r14)
sub %r14, %r14
lea addresses_WT_ht+0x164df, %r15
nop
nop
nop
nop
...
// Store
lea addresses_normal+0xe06, %r13
nop
nop
and %rcx, %rcx
movl $0x51525354, (%r13)
...
{'dst': {'type': 'addresses_normal', 'same': False, 'size': 4, 'congruent': 0, 'NT': True, 'AVXalign': False}, 'OP': 'STOR'}
