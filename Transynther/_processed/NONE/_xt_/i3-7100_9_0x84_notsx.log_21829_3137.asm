...
push %rdi
push %rdx
lea addresses_A_ht+0x13296, %r10
nop
nop
nop
inc %r11
...
nop
inc %r12
lea addresses_UC_ht+0x132f6, %r13
nop
nop
nop
nop
...
mov (%r13), %r12w
cmp %rdx, %rdx
lea addresses_WT_ht+0x168e6, %r12
nop
add %rdi, %rdi
...
nop
sub %rdx, %rdx
lea addresses_normal_ht+0x588, %r15
clflush (%r15)
nop
nop
add %r10, %r10
...
nop
sub %r10, %r10
lea addresses_WC_ht+0xfb96, %r13
clflush (%r13)
nop
nop
nop
...
nop
xor %r12, %r12
lea addresses_D_ht+0x18416, %r13
nop
nop
nop
nop
...
nop
inc %r11
lea addresses_UC_ht+0x18d96, %r13
nop
nop
nop
nop
...
// Faulty Load
lea addresses_normal+0x5f96, %rbp
nop
nop
nop
sub %r9, %r9
