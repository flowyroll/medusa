...
push %rdi
push %rsi
lea addresses_WT_ht+0x8714, %rsi
lea addresses_WT_ht+0x14f5f, %rdi
nop
cmp $39070, %r13
mov $109, %rcx
rep movsw
nop
dec %rcx
lea addresses_normal_ht+0x130ae, %rsi
lea addresses_WC_ht+0x599f, %rdi
nop
xor $19524, %rax
mov $60, %rcx
rep movsl
cmp $31809, %rcx
lea addresses_normal_ht+0xc55f, %rsi
lea addresses_UC_ht+0x1c65b, %rdi
nop
cmp $45883, %r9
mov $50, %rcx
rep movsw
...
nop
dec %rsi
lea addresses_UC_ht+0x1205f, %r11
nop
dec %rcx
movb (%r11), %r9b
nop
...
nop
cmp $41063, %rsi
lea addresses_normal_ht+0x1c013, %r9
nop
nop
nop
nop
...
nop
add %r11, %r11
lea addresses_normal_ht+0x1a5f, %rsi
nop
nop
add $36365, %r13
movl $0x61626364, (%rsi)
...
{'src': {'type': 'addresses_normal_ht', 'congruent': 0, 'same': True}, 'OP': 'REPM', 'dst': {'type': 'addresses_WC_ht', 'congruent': 6, 'same': False}}
