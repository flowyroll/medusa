...
push %rdx
push %rsi
lea addresses_WC_ht+0x19443, %rsi
lea addresses_WC_ht+0x5a83, %rdi
nop
nop
nop
nop
...
nop
inc %rdi
lea addresses_A_ht+0x12d23, %rsi
lea addresses_A_ht+0xf443, %rdi
nop
nop
nop
nop
...
nop
dec %r12
lea addresses_UC_ht+0x16d43, %r13
nop
nop
nop
sub $62048, %r12
...
nop
cmp %rdi, %rdi
lea addresses_WT_ht+0x19aef, %rsi
lea addresses_UC_ht+0x10443, %rdi
clflush (%rdi)
nop
nop
sub %r9, %r9
...
nop
cmp %rdi, %rdi
lea addresses_WT_ht+0x165c3, %r13
nop
nop
nop
nop
...
nop
sub %rdx, %rdx
lea addresses_normal_ht+0x1885b, %rsi
lea addresses_D_ht+0x19f97, %rdi
nop
xor %r12, %r12
mov $74, %rcx
rep movsq
...
{'src': {'type': 'addresses_A_ht', 'congruent': 3, 'same': False}, 'OP': 'REPM', 'dst': {'type': 'addresses_A_ht', 'congruent': 10, 'same': False}}
{'OP': 'STOR', 'dst': {'type': 'addresses_UC_ht', 'AVXalign': True, 'size': 1, 'NT': True, 'same': False, 'congruent': 8}}
...
{'src': {'type': 'addresses_normal_ht', 'congruent': 0, 'same': False}, 'OP': 'REPM', 'dst': {'type': 'addresses_D_ht', 'congruent': 1, 'same': False}}
