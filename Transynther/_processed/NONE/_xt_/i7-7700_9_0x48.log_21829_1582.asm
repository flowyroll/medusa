...
push %rdx
push %rsi
lea addresses_WT_ht+0x1aaa7, %r15
nop
nop
sub %r14, %r14
...
vpextrq $1, %xmm5, %r12
add %rdx, %rdx
lea addresses_WC_ht+0x1fe7, %rsi
...
rep movsb
cmp %r12, %r12
lea addresses_A_ht+0x1a7a7, %rsi
lea addresses_D_ht+0x3db7, %rdi
xor $11135, %rax
mov $93, %rcx
rep movsl
nop
xor %rdx, %rdx
lea addresses_D_ht+0x702f, %rsi
lea addresses_WC_ht+0x167b7, %rdi
and %r14, %r14
mov $100, %rcx
rep movsb
cmp $52157, %rcx
lea addresses_UC_ht+0x1afa7, %rsi
lea addresses_WC_ht+0xc1a7, %rdi
nop
nop
nop
nop
