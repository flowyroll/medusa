...
push %rdx
push %rsi
lea addresses_WT_ht+0x1a48a, %r12
nop
nop
nop
nop
...
nop
dec %r12
lea addresses_WC_ht+0x5f87, %r14
cmp %rdx, %rdx
mov $0x6162636465666768, %r11
movq %r11, %xmm4
vmovups %ymm4, (%r14)
xor $32734, %rdx
lea addresses_WC_ht+0xb327, %r13
nop
nop
nop
nop
...
nop
inc %r13
lea addresses_WC_ht+0x1327, %r12
xor %r14, %r14
movb (%r12), %dl
nop
nop
nop
dec %r14
lea addresses_normal_ht+0x1cbef, %rsi
lea addresses_normal_ht+0xa533, %rdi
nop
nop
nop
nop
...
nop
sub %r13, %r13
lea addresses_UC_ht+0xfb27, %rcx
nop
nop
cmp $33524, %r12
mov (%rcx), %di
...
// Store
lea addresses_normal+0x11327, %r8
add %rdi, %rdi
movl $0x51525354, (%r8)
nop
nop
