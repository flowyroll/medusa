...
push %rdx
push %rsi
lea addresses_WT_ht+0x1215e, %rsi
nop
nop
inc %r15
...
nop
add %rsi, %rsi
lea addresses_WT_ht+0x114f2, %r13
nop
nop
xor $35126, %rcx
movw $0x6162, (%r13)
...
nop
cmp $65364, %r13
lea addresses_D_ht+0x7fa, %rsi
lea addresses_A_ht+0x999a, %rdi
clflush (%rdi)
nop
nop
nop
...
// REPMOV
lea addresses_WC+0x102fa, %rsi
lea addresses_UC+0x13792, %rdi
nop
inc %rbx
mov $13, %rcx
rep movsl
...
{'src': {'type': 'addresses_WC', 'congruent': 8, 'same': False}, 'dst': {'type': 'addresses_UC', 'congruent': 2, 'same': False}, 'OP': 'REPM'}
[Faulty Load]
