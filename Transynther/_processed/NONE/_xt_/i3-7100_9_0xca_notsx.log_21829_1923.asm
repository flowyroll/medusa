...
push %rdi
push %rsi
lea addresses_normal_ht+0x132a7, %r14
nop
add %r9, %r9
...
lea addresses_UC_ht+0x4627, %rdi
nop
sub $60731, %r14
mov $103, %rcx
rep movsl
xor %rcx, %rcx
lea addresses_WT_ht+0x146b7, %r9
clflush (%r9)
nop
nop
inc %rsi
...
nop
and %rdi, %rdi
lea addresses_WT_ht+0x1250f, %rsi
lea addresses_D_ht+0x6e27, %rdi
nop
nop
and %rbx, %rbx
mov $73, %rcx
...
nop
add $48251, %r14
lea addresses_WT_ht+0xb1a7, %rcx
nop
nop
nop
nop
...
nop
sub $64430, %rbx
lea addresses_normal_ht+0x13a27, %rsi
lea addresses_UC_ht+0x11127, %rdi
nop
nop
nop
nop
...
nop
cmp $26124, %r14
lea addresses_UC_ht+0x17727, %rsi
lea addresses_WT_ht+0x8527, %rdi
clflush (%rsi)
nop
nop
nop
...
nop
dec %rsi
lea addresses_normal_ht+0x17de7, %r9
nop
and $37631, %rdi
vmovups (%r9), %ymm4
...
nop
cmp $30904, %rsi
lea addresses_UC_ht+0x1ce27, %r14
nop
nop
nop
nop
...
nop
and $37599, %rbx
lea addresses_WC_ht+0x16227, %rsi
lea addresses_WC_ht+0x17467, %rdi
dec %rax
mov $121, %rcx
rep movsb
nop
nop
cmp %rbx, %rbx
lea addresses_WC_ht+0xe7a7, %r10
nop
nop
nop
xor $39709, %rcx
movb (%r10), %r9b
add $27772, %rcx
lea addresses_WC_ht+0xac27, %rcx
nop
nop
nop
nop
...
{'src': {'type': 'addresses_WT_ht', 'congruent': 3, 'same': False}, 'OP': 'REPM', 'dst': {'type': 'addresses_UC_ht', 'congruent': 9, 'same': False}}
{'OP': 'STOR', 'dst': {'same': False, 'congruent': 2, 'NT': False, 'type': 'addresses_WT_ht', 'size': 1, 'AVXalign': True}}
{'src': {'type': 'addresses_WT_ht', 'congruent': 2, 'same': False}, 'OP': 'REPM', 'dst': {'type': 'addresses_D_ht', 'congruent': 9, 'same': True}}
...
{'OP': 'STOR', 'dst': {'same': True, 'congruent': 6, 'NT': False, 'type': 'addresses_UC_ht', 'size': 8, 'AVXalign': False}}
