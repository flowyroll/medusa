...
push %rdi
push %rsi
lea addresses_WT_ht+0x1aa87, %r9
nop
inc %rdi
movups (%r9), %xmm4
vpextrq $1, %xmm4, %r12
nop
sub %r11, %r11
lea addresses_UC_ht+0xe133, %rsi
lea addresses_A_ht+0x6533, %rdi
nop
nop
nop
inc %rbp
...
nop
sub $3703, %r9
lea addresses_D_ht+0x1d333, %rsi
lea addresses_WC_ht+0x1cd13, %rdi
nop
nop
nop
nop
...
nop
xor %r11, %r11
lea addresses_UC_ht+0x7433, %rdi
nop
nop
sub $50049, %rbp
...
nop
add %r12, %r12
lea addresses_A_ht+0x1274b, %rbp
nop
nop
nop
add $21654, %r9
...
nop
cmp $64253, %rbp
lea addresses_WC_ht+0xa52f, %rdi
clflush (%rdi)
nop
cmp %r12, %r12
movl $0x61626364, (%rdi)
...
nop
cmp $34299, %rcx
lea addresses_normal_ht+0x1d133, %rdi
nop
nop
nop
nop
...
nop
cmp %r15, %r15
lea addresses_normal_ht+0x12fa3, %r11
nop
nop
cmp %rbp, %rbp
...
nop
and $62434, %r9
lea addresses_WT_ht+0x3e52, %r15
nop
nop
nop
add %rbp, %rbp
...
{'src': {'type': 'addresses_D_ht', 'congruent': 6, 'same': False}, 'OP': 'REPM', 'dst': {'type': 'addresses_D_ht', 'congruent': 10, 'same': True}}
{'OP': 'STOR', 'dst': {'type': 'addresses_UC_ht', 'AVXalign': False, 'size': 8, 'NT': True, 'same': False, 'congruent': 5}}
...
{'OP': 'STOR', 'dst': {'type': 'addresses_normal_ht', 'AVXalign': False, 'size': 8, 'NT': False, 'same': True, 'congruent': 10}}
