...
push %rdx
push %rsi
lea addresses_normal_ht+0x743b, %rsi
inc %rdx
vmovups (%rsi), %ymm7
vextracti128 $1, %ymm7, %xmm7
vpextrq $1, %xmm7, %r10
inc %r9
lea addresses_WT_ht+0x1dd9b, %rdx
sub $17999, %r8
mov (%rdx), %edi
nop
nop
...
nop
and $50346, %r8
lea addresses_UC_ht+0xe728, %rdi
nop
nop
nop
nop
...
nop
inc %rdx
lea addresses_D_ht+0x1d6b3, %rsi
lea addresses_WT_ht+0x1172b, %rdi
clflush (%rsi)
nop
xor $36440, %r13
mov $28, %rcx
...
nop
inc %rsi
lea addresses_D_ht+0x15b1b, %rdi
nop
cmp %rdx, %rdx
movl $0x61626364, (%rdi)
xor %r9, %r9
lea addresses_WT_ht+0x1e11b, %rsi
lea addresses_UC_ht+0xf11b, %rdi
nop
nop
add %rdx, %rdx
mov $115, %rcx
...
nop
and $54356, %rdi
lea addresses_normal_ht+0x1491b, %rdx
nop
nop
nop
nop
...
{'src': {'type': 'addresses_D_ht', 'congruent': 3, 'same': False}, 'dst': {'type': 'addresses_WT_ht', 'congruent': 2, 'same': True}, 'OP': 'REPM'}
