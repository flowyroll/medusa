...
push %rdi
push %rsi
lea addresses_WC_ht+0x10ab9, %rsi
lea addresses_WT_ht+0x18819, %rdi
sub %r8, %r8
mov $69, %rcx
rep movsl
xor $1982, %r8
lea addresses_WT_ht+0xf6b9, %rsi
lea addresses_D_ht+0xcb7d, %rdi
nop
nop
nop
nop
...
nop
and $154, %r9
lea addresses_normal_ht+0x1199, %rsi
lea addresses_WC_ht+0xe4e9, %rdi
nop
add %r11, %r11
mov $127, %rcx
rep movsw
nop
cmp $53702, %rdi
lea addresses_normal_ht+0x7f19, %r11
inc %rax
vmovups (%r11), %ymm0
...
nop
cmp $10874, %r11
lea addresses_normal_ht+0x15053, %rsi
clflush (%rsi)
nop
nop
nop
...
nop
sub %rdi, %rdi
lea addresses_normal_ht+0x148b9, %rax
nop
nop
cmp %rdi, %rdi
mov (%rax), %esi
...
nop
xor %rax, %rax
lea addresses_normal_ht+0xbf91, %r8
nop
nop
nop
inc %rcx
