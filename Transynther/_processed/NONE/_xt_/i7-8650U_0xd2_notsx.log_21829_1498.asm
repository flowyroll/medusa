...
nop
sub $41592, %rdi
lea addresses_UC_ht+0x11979, %rsi
...
nop
add %r11, %r11
lea addresses_D_ht+0x12468, %rcx
cmp %r11, %r11
mov $0x6162636465666768, %rdi
movq %rdi, (%rcx)
nop
sub $58801, %rsi
lea addresses_WC_ht+0x124b4, %rsi
lea addresses_WC_ht+0x728, %rdi
nop
nop
nop
xor $45377, %r15
...
nop
and $57080, %r10
lea addresses_D_ht+0x146b8, %rsi
lea addresses_normal_ht+0x1c128, %rdi
clflush (%rsi)
nop
nop
dec %r8
...
nop
dec %r9
lea addresses_A_ht+0x15d58, %rsi
lea addresses_WT_ht+0x2928, %rdi
nop
nop
nop
sub %r8, %r8
...
nop
sub %r15, %r15
lea addresses_normal_ht+0x1d774, %rsi
lea addresses_A_ht+0x1c5a8, %rdi
nop
nop
nop
nop
...
// Faulty Load
lea addresses_normal+0x12828, %rbp
clflush (%rbp)
nop
nop
nop
...
{'OP': 'LOAD', 'src': {'type': 'addresses_D', 'size': 1, 'AVXalign': False, 'NT': False, 'congruent': 9, 'same': False}}
[Faulty Load]
...
{'OP': 'REPM', 'src': {'type': 'addresses_UC_ht', 'congruent': 0, 'same': False}, 'dst': {'type': 'addresses_normal_ht', 'congruent': 5, 'same': True}}
...
{'OP': 'REPM', 'src': {'type': 'addresses_normal_ht', 'congruent': 1, 'same': False}, 'dst': {'type': 'addresses_A_ht', 'congruent': 7, 'same': True}}
{'34': 21829}
