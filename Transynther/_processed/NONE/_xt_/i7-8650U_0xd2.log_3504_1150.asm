...
push %rdx
push %rsi
lea addresses_WC_ht+0x15d9d, %r15
nop
cmp $26406, %rbx
...
nop
inc %r10
lea addresses_UC_ht+0x5084, %rdx
nop
nop
nop
nop
...
nop
dec %r10
lea addresses_D_ht+0x17a1d, %rbx
nop
nop
nop
and %r10, %r10
...
nop
cmp $22925, %rdx
lea addresses_A_ht+0x1a39d, %rsi
lea addresses_normal_ht+0xd06a, %rdi
nop
nop
nop
inc %r11
...
nop
cmp $27012, %r10
lea addresses_WT_ht+0x1839d, %rsi
lea addresses_normal_ht+0x1d99d, %rdi
nop
xor %r15, %r15
mov $50, %rcx
rep movsl
...
nop
xor %rdi, %rdi
lea addresses_UC_ht+0xf055, %rbx
nop
add $54274, %r9
movb $0x61, (%rbx)
nop
...
nop
and $15452, %r10
lea addresses_WT_ht+0x1959d, %rdx
clflush (%rdx)
nop
nop
nop
...
nop
cmp %rdx, %rdx
lea addresses_D_ht+0xa83d, %rsi
lea addresses_D_ht+0x1579d, %rdi
nop
nop
nop
add $509, %rbx
...
rep movsl
dec %r9
lea addresses_WC_ht+0x19cb8, %r11
nop
nop
nop
nop
...
{'OP': 'REPM', 'src': {'type': 'addresses_WT_ht', 'congruent': 11, 'same': True}, 'dst': {'type': 'addresses_normal_ht', 'congruent': 8, 'same': False}}
...
{'OP': 'REPM', 'src': {'type': 'addresses_D_ht', 'congruent': 3, 'same': True}, 'dst': {'type': 'addresses_D_ht', 'congruent': 10, 'same': False}}
