...
nop
sub $40962, %r11
lea addresses_WC_ht+0x19305, %rcx
nop
xor %rdi, %rdi
movl $0x61626364, (%rcx)
nop
...
nop
xor $58531, %r10
lea addresses_WC_ht+0xf5b9, %r10
nop
nop
nop
cmp %rcx, %rcx
...
vpextrq $0, %xmm5, %rdi
sub $38565, %rsi
lea addresses_D_ht+0xc239, %r11
xor $27716, %rsi
movl $0x61626364, (%r11)
nop
cmp %r10, %r10
lea addresses_A_ht+0x170b9, %rsi
lea addresses_WC_ht+0x106e9, %rdi
add %r11, %r11
mov $8, %rcx
rep movsq
nop
...
<gen_prepare_buffer>
{'dst': {'same': False, 'congruent': 8, 'type': 'addresses_UC_ht'}, 'OP': 'REPM', 'src': {'same': False, 'congruent': 9, 'type': 'addresses_D_ht'}}
{'OP': 'LOAD', 'src': {'same': False, 'NT': True, 'AVXalign': False, 'size': 32, 'type': 'addresses_WC_ht', 'congruent': 7}}
