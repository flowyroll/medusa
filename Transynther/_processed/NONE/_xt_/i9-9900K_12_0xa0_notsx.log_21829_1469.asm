...
nop
xor %rdi, %rdi
lea addresses_UC_ht+0x1dc29, %rbp
nop
nop
nop
nop
...
nop
add %rax, %rax
lea addresses_WT_ht+0xbd29, %rsi
lea addresses_normal_ht+0x71e9, %rdi
nop
nop
nop
nop
...
nop
inc %rax
lea addresses_normal_ht+0x17429, %rsi
nop
nop
nop
inc %r11
...
nop
xor %rax, %rax
lea addresses_UC_ht+0xe7f5, %rdi
nop
nop
nop
nop
...
nop
xor $31075, %rcx
lea addresses_D_ht+0x18189, %rax
nop
nop
inc %rcx
movw $0x6162, (%rax)
...
// Store
mov $0x60040a00000007a9, %r9
xor %rdx, %rdx
movw $0x5152, (%r9)
cmp %rdx, %rdx

// Faulty Load
lea addresses_D+0x10a29, %r14
nop
sub %r9, %r9
mov (%r14), %r10
lea oracles, %r14
...
{'src': {'type': 'addresses_P', 'AVXalign': False, 'size': 1, 'NT': False, 'same': False, 'congruent': 10}, 'OP': 'LOAD'}
...
<gen_prepare_buffer>
{'OP': 'STOR', 'dst': {'type': 'addresses_A_ht', 'AVXalign': True, 'size': 8, 'NT': False, 'same': False, 'congruent': 4}}
{'OP': 'STOR', 'dst': {'type': 'addresses_UC_ht', 'AVXalign': False, 'size': 16, 'NT': False, 'same': False, 'congruent': 8}}
{'src': {'type': 'addresses_WT_ht', 'congruent': 8, 'same': True}, 'OP': 'REPM', 'dst': {'type': 'addresses_normal_ht', 'congruent': 4, 'same': False}}
