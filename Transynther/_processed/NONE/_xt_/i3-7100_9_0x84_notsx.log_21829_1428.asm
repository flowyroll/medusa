...
nop
and %rcx, %rcx
lea addresses_normal_ht+0x1d060, %rsi
lea addresses_normal_ht+0x2b0e, %rdi
nop
nop
nop
nop
...
nop
inc %r11
lea addresses_D_ht+0xb060, %rsi
lea addresses_WC_ht+0x4e60, %rdi
nop
cmp $36640, %rbx
mov $117, %rcx
rep movsq
...
nop
xor %rdi, %rdi
lea addresses_UC_ht+0x260, %rsi
lea addresses_A_ht+0x11fe0, %rdi
nop
nop
nop
xor $9871, %rbx
...
nop
cmp $46717, %rbx
lea addresses_WT_ht+0x1260, %rsi
lea addresses_A_ht+0x454e, %rdi
nop
nop
nop
sub $51420, %rax
...
nop
xor $29097, %rcx
lea addresses_WC_ht+0x15a60, %rsi
nop
nop
nop
nop
...
nop
xor $25615, %rdi
lea addresses_WC_ht+0x4260, %rcx
nop
nop
nop
xor $47706, %rbx
...
{'src': {'type': 'addresses_P', 'congruent': 3, 'same': False}, 'dst': {'type': 'addresses_D', 'congruent': 4, 'same': False}, 'OP': 'REPM'}
[Faulty Load]
...
{'src': {'type': 'addresses_D_ht', 'congruent': 9, 'same': False}, 'dst': {'type': 'addresses_WC_ht', 'congruent': 10, 'same': False}, 'OP': 'REPM'}
{'src': {'type': 'addresses_UC_ht', 'congruent': 11, 'same': False}, 'dst': {'type': 'addresses_A_ht', 'congruent': 6, 'same': False}, 'OP': 'REPM'}
{'src': {'type': 'addresses_WT_ht', 'congruent': 7, 'same': False}, 'dst': {'type': 'addresses_A_ht', 'congruent': 1, 'same': False}, 'OP': 'REPM'}
