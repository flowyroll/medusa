...
vpextrq $1, %xmm5, %r10
cmp %rsi, %rsi
lea addresses_WC_ht+0x16a7a, %rsi
lea addresses_UC_ht+0x42aa, %rdi
nop
nop
nop
nop
...
nop
and $21500, %r15
lea addresses_A_ht+0x98fa, %rsi
lea addresses_D_ht+0xc6fa, %rdi
nop
and $14417, %rbx
mov $92, %rcx
rep movsl
dec %rsi
lea addresses_normal_ht+0x1c1fa, %rsi
lea addresses_UC_ht+0x6a5a, %rdi
nop
nop
nop
nop
...
<gen_prepare_buffer>
{'src': {'type': 'addresses_A_ht', 'congruent': 3, 'same': False}, 'dst': {'type': 'addresses_normal_ht', 'congruent': 1, 'same': False}, 'OP': 'REPM'}
{'src': {'type': 'addresses_WC_ht', 'same': True, 'size': 16, 'congruent': 3, 'NT': True, 'AVXalign': False}, 'OP': 'LOAD'}
