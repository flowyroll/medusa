...
lea addresses_WT_ht+0x1c656, %rdi
nop
cmp %rax, %rax
mov $117, %rcx
rep movsw
...
nop
and $2841, %rsi
lea addresses_D_ht+0xe5ec, %rsi
lea addresses_UC_ht+0xcf66, %rdi
add $60946, %r8
mov $36, %rcx
rep movsw
nop
...
// Store
lea addresses_normal+0x7a52, %rbx
clflush (%rbx)
nop
and $30837, %r12
...
{'OP': 'STOR', 'dst': {'same': False, 'congruent': 2, 'NT': False, 'type': 'addresses_normal', 'size': 32, 'AVXalign': True}}
[Faulty Load]
...
{'src': {'type': 'addresses_A_ht', 'congruent': 9, 'same': False}, 'OP': 'REPM', 'dst': {'type': 'addresses_UC_ht', 'congruent': 11, 'same': False}}
{'src': {'type': 'addresses_A_ht', 'congruent': 10, 'same': False}, 'OP': 'REPM', 'dst': {'type': 'addresses_WT_ht', 'congruent': 10, 'same': False}}
