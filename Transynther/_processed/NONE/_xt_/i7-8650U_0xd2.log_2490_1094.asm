...
push %rdi
push %rsi
lea addresses_UC_ht+0xa35a, %rbp
nop
add %r13, %r13
movb $0x61, (%rbp)
nop
nop
xor %rcx, %rcx
lea addresses_WT_ht+0x14c5, %r12
nop
add $10427, %r10
mov (%r12), %r8
nop
...
nop
inc %rbp
lea addresses_D_ht+0x11165, %rsi
lea addresses_normal_ht+0x1c443, %rdi
nop
add %r10, %r10
mov $116, %rcx
rep movsw
sub $17781, %r8
lea addresses_D_ht+0xe65, %rsi
lea addresses_WT_ht+0x14e65, %rdi
nop
nop
nop
nop
...
nop
and $1379, %r8
lea addresses_A_ht+0xf0e5, %rsi
lea addresses_WT_ht+0x1ef65, %rdi
nop
nop
nop
cmp %r13, %r13
...
{'OP': 'REPM', 'src': {'type': 'addresses_D_ht', 'congruent': 6, 'same': True}, 'dst': {'type': 'addresses_normal_ht', 'congruent': 1, 'same': False}}
{'OP': 'REPM', 'src': {'type': 'addresses_D_ht', 'congruent': 11, 'same': False}, 'dst': {'type': 'addresses_WT_ht', 'congruent': 9, 'same': False}}
