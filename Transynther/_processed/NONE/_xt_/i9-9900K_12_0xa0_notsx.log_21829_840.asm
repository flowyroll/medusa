...
push %rdx
push %rsi
lea addresses_normal_ht+0x173c4, %r8
nop
nop
nop
nop
...
nop
and %rdx, %rdx
lea addresses_normal_ht+0x8904, %rdi
nop
nop
nop
nop
...
nop
sub %rbx, %rbx
lea addresses_normal_ht+0xc764, %rdi
nop
nop
nop
nop
...
nop
xor %r11, %r11
lea addresses_WC_ht+0x163c0, %rbx
nop
nop
nop
dec %rdi
...
nop
xor %rdx, %rdx
lea addresses_normal_ht+0x7c6e, %r14
nop
cmp %r11, %r11
movb (%r14), %r8b
nop
and $21968, %r8
lea addresses_UC_ht+0xe584, %r14
nop
nop
nop
nop
...
nop
cmp $28308, %rbx
lea addresses_UC_ht+0x1aa04, %rsi
lea addresses_WT_ht+0x1c804, %rdi
nop
add %r14, %r14
mov $55, %rcx
rep movsl
...
{'OP': 'STOR', 'dst': {'type': 'addresses_normal_ht', 'AVXalign': True, 'size': 16, 'NT': False, 'same': False, 'congruent': 3}}
...
{'src': {'type': 'addresses_UC_ht', 'congruent': 9, 'same': False}, 'OP': 'REPM', 'dst': {'type': 'addresses_WT_ht', 'congruent': 10, 'same': False}}
