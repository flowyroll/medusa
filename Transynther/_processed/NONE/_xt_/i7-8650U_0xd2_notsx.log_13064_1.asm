...
push %rdi
push %rsi
lea addresses_WC_ht+0x14870, %rsi
lea addresses_A_ht+0x748a, %rdi
nop
nop
nop
nop
...
nop
xor $54321, %rcx
lea addresses_UC_ht+0x10fea, %rsi
...
nop
and $29457, %r15
lea addresses_A_ht+0x1d65a, %r10
nop
nop
xor %r15, %r15
movb (%r10), %cl
...
nop
and %rsi, %rsi
lea addresses_normal_ht+0x12e0a, %r15
nop
nop
nop
nop
...
{'OP': 'LOAD', 'src': {'type': 'addresses_A_ht', 'size': 1, 'AVXalign': False, 'NT': True, 'congruent': 3, 'same': False}}
