...
push %rdi
push %rsi
lea addresses_D_ht+0x1a40a, %rsi
...
nop
sub $41946, %r10
lea addresses_WC_ht+0x1a62a, %rax
nop
nop
nop
nop
...
nop
and $8407, %r15
lea addresses_WT_ht+0x1c6aa, %rsi
nop
nop
dec %r10
vmovups (%rsi), %ymm3
...
nop
sub %rax, %rax
lea addresses_A_ht+0x1cc0a, %rax
and %r15, %r15
mov (%rax), %rcx
nop
nop
...
nop
xor %rsi, %rsi
lea addresses_D_ht+0x132fa, %rsi
...
nop
sub %rax, %rax
lea addresses_UC_ht+0xec0a, %rbx
nop
nop
sub $41188, %rax
...
{'OP': 'STOR', 'dst': {'same': True, 'type': 'addresses_UC_ht', 'NT': False, 'AVXalign': False, 'size': 8, 'congruent': 11}}
{'38': 21829}
