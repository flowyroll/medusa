...
push %rdi
push %rsi
lea addresses_normal_ht+0x835e, %rbp
nop
xor $40087, %r8
movb $0x61, (%rbp)
cmp $43651, %r12
lea addresses_normal_ht+0xce9e, %rsi
lea addresses_WC_ht+0xaafe, %rdi
nop
add %r8, %r8
mov $125, %rcx
rep movsb
nop
add %r12, %r12
lea addresses_D_ht+0x181fe, %rsi
nop
nop
nop
nop
...
nop
sub $40939, %r8
lea addresses_WT_ht+0x1ab1e, %rsi
lea addresses_UC_ht+0x1452e, %rdi
nop
and %r13, %r13
mov $24, %rcx
rep movsq
...
nop
inc %r8
lea addresses_A_ht+0x18afe, %rsi
lea addresses_UC_ht+0x1e21a, %rdi
inc %r12
mov $63, %rcx
rep movsq
nop
nop
add %r8, %r8
lea addresses_A_ht+0x13bbe, %rdi
inc %r13
movl $0x61626364, (%rdi)
nop
nop
dec %rbp
lea addresses_D_ht+0x82ce, %r12
nop
nop
xor %rsi, %rsi
mov (%r12), %ebp
...
nop
lfence
lea addresses_A_ht+0x122fe, %rsi
lea addresses_WC_ht+0x413e, %rdi
nop
nop
nop
nop
...
nop
sub $25031, %rsi
lea addresses_UC_ht+0x159e, %rcx
xor $29171, %r13
mov (%rcx), %bp
nop
nop
...
lea addresses_WC_ht+0x14e9c, %rdi
nop
nop
xor $51050, %r13
mov $51, %rcx
...
nop
xor %r12, %r12
lea addresses_normal_ht+0x2fee, %rsi
lea addresses_A_ht+0xd2fe, %rdi
clflush (%rdi)
nop
nop
nop
...
nop
sub %rbp, %rbp
lea addresses_D_ht+0x10afe, %rbp
nop
and %r12, %r12
mov (%rbp), %rdi
cmp $38564, %r8
lea addresses_normal_ht+0x5cfe, %rdi
nop
nop
and $59840, %r8
vmovups (%rdi), %ymm3
...
// Faulty Load
lea addresses_normal+0x72fe, %rdx
nop
nop
nop
nop
...
{'OP': 'REPM', 'src': {'type': 'addresses_WT_ht', 'congruent': 5, 'same': False}, 'dst': {'type': 'addresses_UC_ht', 'congruent': 2, 'same': False}}
