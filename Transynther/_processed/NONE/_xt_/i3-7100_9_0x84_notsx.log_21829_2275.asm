...
push %rdi
push %rsi
lea addresses_UC_ht+0xb3ee, %rsi
...
nop
add %rdi, %rdi
lea addresses_normal_ht+0xee, %rsi
lea addresses_D_ht+0x862e, %rdi
clflush (%rsi)
nop
nop
nop
...
nop
inc %rcx
lea addresses_WC_ht+0x1d2ee, %r8
nop
nop
nop
nop
...
nop
and %r8, %r8
lea addresses_WT_ht+0x2ee, %rcx
clflush (%rcx)
sub $33008, %rax
mov (%rcx), %r12w
and $32660, %rsi
lea addresses_A_ht+0x16ece, %rsi
...
nop
cmp $654, %r13
lea addresses_WC_ht+0x13dc2, %r8
nop
nop
nop
xor %r12, %r12
movb $0x61, (%r8)
inc %r8
lea addresses_normal_ht+0x181ee, %rax
nop
nop
nop
nop
...
nop
sub %rdi, %rdi
lea addresses_A_ht+0x13f4a, %rcx
inc %r8
movb (%rcx), %al
nop
dec %r8
lea addresses_WT_ht+0x1118e, %rsi
lea addresses_A_ht+0x179ca, %rdi
nop
and $42321, %r12
mov $57, %rcx
rep movsl
...
nop
inc %r8
lea addresses_WC_ht+0x312e, %r13
nop
nop
nop
nop
...
{'src': {'type': 'addresses_normal_ht', 'congruent': 8, 'same': False}, 'dst': {'type': 'addresses_D_ht', 'congruent': 6, 'same': False}, 'OP': 'REPM'}
{'dst': {'type': 'addresses_WC_ht', 'same': False, 'size': 4, 'congruent': 6, 'NT': False, 'AVXalign': False}, 'OP': 'STOR'}
{'src': {'type': 'addresses_WT_ht', 'same': False, 'size': 2, 'congruent': 8, 'NT': True, 'AVXalign': False}, 'OP': 'LOAD'}
