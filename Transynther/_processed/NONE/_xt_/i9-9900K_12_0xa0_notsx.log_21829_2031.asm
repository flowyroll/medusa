...
push %rdi
push %rsi
lea addresses_normal_ht+0x15cae, %r15
nop
nop
sub $8656, %rdi
movb (%r15), %bl
...
nop
add $35445, %r12
lea addresses_normal_ht+0x1d3ae, %r15
nop
nop
cmp %r13, %r13
mov (%r15), %edi
sub $37179, %r15
lea addresses_WC_ht+0x79e, %rsi
lea addresses_WT_ht+0xe8e, %rdi
nop
xor $6902, %r12
mov $105, %rcx
rep movsl
nop
cmp %rsi, %rsi
lea addresses_WC_ht+0xb0ee, %rbx
nop
nop
nop
nop
...
nop
cmp $46136, %r15
lea addresses_A_ht+0x46ae, %rsi
lea addresses_WT_ht+0x1566e, %rdi
nop
nop
add %r14, %r14
mov $98, %rcx
...
nop
sub $4028, %r13
lea addresses_WT_ht+0x887c, %rsi
lea addresses_normal_ht+0x294, %rdi
nop
sub %rbx, %rbx
mov $45, %rcx
rep movsq
...
nop
and %rdi, %rdi
lea addresses_A_ht+0xc902, %rsi
lea addresses_A_ht+0x802e, %rdi
sub $36729, %r12
mov $71, %rcx
rep movsq
cmp %rsi, %rsi
lea addresses_A_ht+0x1052e, %rbx
nop
nop
nop
xor $54144, %r15
...
{'src': {'type': 'addresses_WT_ht', 'congruent': 0, 'same': False}, 'OP': 'REPM', 'dst': {'type': 'addresses_normal_ht', 'congruent': 1, 'same': False}}
