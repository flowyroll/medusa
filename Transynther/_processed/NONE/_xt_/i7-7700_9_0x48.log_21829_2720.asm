...
push %rdi
push %rsi
lea addresses_WT_ht+0x10169, %rdi
clflush (%rdi)
nop
add $14096, %r13
...
movups %xmm1, (%rdi)
and $35762, %rax
lea addresses_normal_ht+0xbbfd, %r14
nop
nop
nop
inc %r9
...
nop
add $30236, %rbx
lea addresses_D_ht+0x164d1, %r13
cmp %rdi, %rdi
mov (%r13), %r14w
nop
nop
nop
sub $44380, %r11
lea addresses_UC_ht+0x156d1, %rsi
lea addresses_UC_ht+0x10afe, %rdi
nop
add $49108, %r13
mov $40, %rcx
rep movsl
...
nop
xor %rcx, %rcx
lea addresses_WC_ht+0x180d1, %rsi
...
{'OP': 'LOAD', 'src': {'type': 'addresses_D_ht', 'AVXalign': False, 'congruent': 7, 'size': 2, 'same': False, 'NT': True}}
