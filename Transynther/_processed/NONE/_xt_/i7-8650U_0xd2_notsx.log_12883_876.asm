...
push %rdx
push %rsi
lea addresses_WC_ht+0x4389, %rsi
lea addresses_WC_ht+0x43dd, %rdi
nop
and %rdx, %rdx
mov $75, %rcx
rep movsq
...
nop
cmp $38230, %r13
lea addresses_UC_ht+0x75dd, %rcx
xor $28903, %r13
mov (%rcx), %di
nop
nop
nop
sub $4135, %rcx
lea addresses_A_ht+0x6ddd, %rsi
lea addresses_WT_ht+0x1d55d, %rdi
nop
nop
nop
nop
...
rep movsb
cmp %rsi, %rsi
lea addresses_WC_ht+0xd5d, %rcx
nop
and $58783, %r12
movl $0x61626364, (%rcx)
nop
sub $2880, %r12
lea addresses_A_ht+0x1b395, %rsi
lea addresses_normal_ht+0x107ad, %rdi
nop
nop
nop
inc %rbp
...
nop
add $47123, %rbx
lea addresses_UC_ht+0xeddd, %rsi
nop
nop
nop
nop
...
nop
cmp $23009, %rbx
lea addresses_WC_ht+0xbadd, %rbp
cmp $59002, %rcx
movb $0x61, (%rbp)
nop
nop
...
nop
and %rsi, %rsi
lea addresses_normal_ht+0x13e85, %rbx
nop
nop
nop
nop
...
nop
cmp %rbx, %rbx
lea addresses_A_ht+0x1625d, %rsi
...
// Store
lea addresses_normal+0x27dc, %r12
nop
dec %rdi
