...
rep movsw
cmp $60929, %rsi
lea addresses_UC_ht+0x141f0, %rsi
lea addresses_D_ht+0x12eb0, %rdi
clflush (%rdi)
nop
nop
cmp %rbx, %rbx
...
// Load
lea addresses_normal+0x17370, %rdx
clflush (%rdx)
nop
nop
nop
...
{'OP': 'LOAD', 'src': {'same': True, 'type': 'addresses_normal', 'NT': True, 'AVXalign': True, 'size': 1, 'congruent': 6}}
[Faulty Load]
...
{'OP': 'REPM', 'src': {'same': False, 'congruent': 9, 'type': 'addresses_UC_ht'}, 'dst': {'same': False, 'congruent': 5, 'type': 'addresses_D_ht'}}
{'33': 21829}
