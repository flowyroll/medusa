...
lea addresses_normal_ht+0x76fa, %rdi
nop
inc %r13
mov $126, %rcx
rep movsw
...
nop
add %rcx, %rcx
lea addresses_WT_ht+0x28fa, %rdi
add %rsi, %rsi
movw $0x6162, (%rdi)
nop
nop
...
nop
dec %r9
lea addresses_normal_ht+0x1ea8a, %rsi
nop
nop
nop
nop
...
nop
and $43209, %rcx
lea addresses_WC_ht+0x1903a, %rsi
clflush (%rsi)
nop
nop
nop
...
nop
xor %rcx, %rcx
lea addresses_UC_ht+0xf31a, %rsi
lea addresses_D_ht+0x10afa, %rdi
clflush (%rdi)
nop
nop
nop
...
nop
sub %r12, %r12
lea addresses_WC_ht+0x5bb, %rsi
lea addresses_normal_ht+0x1701a, %rdi
nop
nop
nop
nop
...
nop
add %r12, %r12
lea addresses_UC_ht+0xa74, %r13
cmp $19847, %rsi
movb $0x61, (%r13)
nop
xor %rsi, %rsi
lea addresses_WT_ht+0xfc6a, %rsi
...
// Store
lea addresses_normal+0x2f7a, %r15
clflush (%r15)
nop
nop
sub %rdx, %rdx
...
<gen_prepare_buffer>
{'src': {'congruent': 0, 'same': False, 'type': 'addresses_WC_ht'}, 'OP': 'REPM', 'dst': {'congruent': 2, 'same': False, 'type': 'addresses_UC_ht'}}
{'src': {'congruent': 4, 'same': False, 'type': 'addresses_UC_ht'}, 'OP': 'REPM', 'dst': {'congruent': 9, 'same': True, 'type': 'addresses_normal_ht'}}
...
{'src': {'congruent': 4, 'same': True, 'type': 'addresses_UC_ht'}, 'OP': 'REPM', 'dst': {'congruent': 8, 'same': False, 'type': 'addresses_D_ht'}}
