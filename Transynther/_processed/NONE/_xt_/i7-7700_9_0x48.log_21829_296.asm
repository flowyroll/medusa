...
push %rdx
push %rsi
lea addresses_WC_ht+0xc675, %rsi
lea addresses_A_ht+0x7ae9, %rdi
nop
nop
nop
nop
...
nop
dec %r14
lea addresses_D_ht+0x19769, %rdx
clflush (%rdx)
nop
nop
nop
...
nop
inc %rdx
lea addresses_WT_ht+0x3531, %rdi
and %r14, %r14
movb (%rdi), %dl
nop
nop
inc %rdx
lea addresses_WT_ht+0x4dc9, %rsi
lea addresses_WT_ht+0xc69, %rdi
nop
nop
nop
and %rbp, %rbp
...
nop
xor %rdx, %rdx
lea addresses_WC_ht+0x1c769, %rdx
nop
nop
nop
nop
...
nop
add $31897, %rsi
lea addresses_UC_ht+0x1d4e9, %rsi
lea addresses_normal_ht+0x15691, %rdi
xor %rbp, %rbp
mov $107, %rcx
rep movsq
nop
...
{'OP': 'LOAD', 'src': {'type': 'addresses_WT_ht', 'AVXalign': False, 'congruent': 1, 'size': 1, 'same': True, 'NT': False}}
...
{'OP': 'REPM', 'src': {'type': 'addresses_D_ht', 'congruent': 2, 'same': True}, 'dst': {'type': 'addresses_UC_ht', 'congruent': 10, 'same': False}}
