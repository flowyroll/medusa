...
push %rcx
push %rdx
lea addresses_WT_ht+0x1cb82, %r9
xor $805, %r11
movw $0x6162, (%r9)
nop
nop
add %rax, %rax
lea addresses_normal_ht+0x2562, %r11
clflush (%r11)
nop
nop
nop
...
nop
add $37066, %r12
lea addresses_normal_ht+0xf562, %r9
nop
nop
nop
nop
...
{'OP': 'STOR', 'dst': {'same': False, 'congruent': 7, 'NT': False, 'type': 'addresses_normal_ht', 'size': 8, 'AVXalign': True}}
{'33': 21829}
