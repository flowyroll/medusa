...
push %rdx
push %rsi
lea addresses_WT_ht+0xb7bc, %rsi
lea addresses_UC_ht+0x37bc, %rdi
nop
and %r11, %r11
mov $33, %rcx
rep movsw
and %rdx, %rdx
lea addresses_normal_ht+0x17bc, %rbp
nop
nop
nop
nop
...
nop
xor $45054, %rsi
lea addresses_normal_ht+0x90c3, %rsi
lea addresses_D_ht+0x453c, %rdi
clflush (%rsi)
nop
add %rbx, %rbx
mov $89, %rcx
...
nop
add %rdx, %rdx
lea addresses_normal_ht+0x67bc, %rsi
lea addresses_D_ht+0xe76c, %rdi
clflush (%rdi)
nop
nop
nop
...
lea addresses_UC_ht+0xffbc, %rdi
nop
nop
nop
nop
...
nop
and %rbx, %rbx
lea addresses_UC_ht+0x10c7c, %rbx
nop
nop
nop
nop
...
nop
cmp $9713, %rdi
lea addresses_WC_ht+0x10eeb, %rbx
add $25297, %r11
movups (%rbx), %xmm5
vpextrq $0, %xmm5, %rax
nop
add %rcx, %rcx
lea addresses_UC_ht+0x1303c, %rdx
nop
nop
xor %r11, %r11
...
// Faulty Load
lea addresses_normal+0x7fbc, %r15
nop
nop
nop
dec %rax
...
{'OP': 'REPM', 'src': {'type': 'addresses_normal_ht', 'congruent': 0, 'same': True}, 'dst': {'type': 'addresses_D_ht', 'congruent': 6, 'same': False}}
{'OP': 'REPM', 'src': {'type': 'addresses_normal_ht', 'congruent': 11, 'same': False}, 'dst': {'type': 'addresses_D_ht', 'congruent': 4, 'same': True}}
