...
push %rdi
push %rsi
lea addresses_D_ht+0x1c972, %rsi
lea addresses_A_ht+0xadb2, %rdi
nop
nop
nop
nop
...
nop
add %rbp, %rbp
lea addresses_WT_ht+0xc372, %r14
sub %r11, %r11
vmovups (%r14), %ymm7
...
nop
inc %rcx
lea addresses_normal_ht+0xbb72, %rbp
nop
inc %rdi
movb (%rbp), %r14b
nop
sub %r13, %r13
lea addresses_A_ht+0x9bb2, %rsi
lea addresses_D_ht+0x2d9e, %rdi
nop
nop
lfence
mov $91, %rcx
...
// REPMOV
lea addresses_UC+0x1f972, %rsi
lea addresses_normal+0x19f72, %rdi
nop
nop
nop
nop
...
// Store
lea addresses_normal+0x6aca, %rsi
sub $55370, %r10
...
{'dst': {'type': 'addresses_UC', 'same': False, 'size': 4, 'congruent': 8, 'NT': True, 'AVXalign': False}, 'OP': 'STOR'}
{'src': {'type': 'addresses_UC', 'congruent': 9, 'same': False}, 'dst': {'type': 'addresses_normal', 'congruent': 10, 'same': False}, 'OP': 'REPM'}
...
<gen_prepare_buffer>
{'src': {'type': 'addresses_D_ht', 'congruent': 7, 'same': False}, 'dst': {'type': 'addresses_A_ht', 'congruent': 5, 'same': False}, 'OP': 'REPM'}
...
{'src': {'type': 'addresses_A_ht', 'congruent': 3, 'same': False}, 'dst': {'type': 'addresses_D_ht', 'congruent': 1, 'same': True}, 'OP': 'REPM'}
{'33': 21829}
