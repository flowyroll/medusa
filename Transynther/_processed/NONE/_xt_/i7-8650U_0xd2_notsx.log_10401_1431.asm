...
push %rdi
push %rsi
lea addresses_WT_ht+0x1e64f, %rbp
nop
nop
cmp %rax, %rax
...
nop
sub %r12, %r12
lea addresses_A_ht+0x1acc9, %r14
nop
mfence
movups (%r14), %xmm7
vpextrq $0, %xmm7, %r11
nop
and %r14, %r14
lea addresses_WC_ht+0x1c22c, %r11
nop
nop
add $50528, %rcx
mov (%r11), %bp
...
nop
dec %r14
lea addresses_D_ht+0x167e3, %rbp
nop
nop
dec %r12
and $0xffffffffffffffc0, %rbp
...
nop
cmp $2906, %r12
lea addresses_UC_ht+0x67ff, %rcx
nop
nop
nop
add %r13, %r13
...
nop
inc %rbp
lea addresses_D_ht+0x111bf, %r14
nop
inc %rbp
mov (%r14), %eax
nop
...
nop
cmp $8639, %r11
lea addresses_normal_ht+0x148cf, %rsi
lea addresses_A_ht+0x155cf, %rdi
nop
nop
add $28391, %r14
mov $68, %rcx
...
nop
dec %r14
lea addresses_UC_ht+0xb1cf, %rsi
lea addresses_UC_ht+0x16dcf, %rdi
nop
nop
inc %rbp
mov $103, %rcx
rep movsw
add %rdi, %rdi
lea addresses_normal_ht+0x14acf, %rax
nop
nop
nop
nop
...
nop
xor %r12, %r12
lea addresses_UC_ht+0x1252f, %rdi
nop
nop
nop
nop
...
lea addresses_normal_ht+0x169ff, %rdi
clflush (%rsi)
nop
nop
nop
