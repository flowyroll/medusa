...
nop
xor $62571, %rdi
lea addresses_normal_ht+0x1140e, %r9
clflush (%r9)
nop
nop
nop
...
nop
sub $42476, %rdi
lea addresses_D_ht+0x13fce, %rbp
nop
cmp %r9, %r9
movb $0x61, (%rbp)
cmp $43068, %rsi
lea addresses_WT_ht+0x60ac, %r11
nop
nop
nop
nop
...
nop
and %rsi, %rsi
lea addresses_WC_ht+0x18794, %r9
nop
and $54966, %rsi
mov (%r9), %r11
nop
...
nop
sub $59846, %rsi
lea addresses_A_ht+0xe7ce, %rsi
lea addresses_normal_ht+0x4e4e, %rdi
clflush (%rdi)
nop
nop
nop
...
{'src': {'congruent': 8, 'same': False, 'type': 'addresses_A_ht'}, 'dst': {'congruent': 5, 'same': False, 'type': 'addresses_normal_ht'}, 'OP': 'REPM'}
{'33': 21829}
