...
movw $0x6162, (%r8)
add $43809, %r8
lea addresses_WT_ht+0x2000, %rsi
nop
nop
nop
nop
...
nop
cmp $27757, %rcx
lea addresses_A_ht+0x16a08, %rsi
lea addresses_D_ht+0xf024, %rdi
nop
nop
xor $64070, %r15
mov $112, %rcx
...
nop
xor %r15, %r15
lea addresses_WT_ht+0x1eda4, %rsi
lea addresses_WC_ht+0x9cb8, %rdi
nop
nop
nop
nop
...
nop
sub $39890, %r9
lea addresses_UC_ht+0x52f8, %rbx
inc %r15
...
<gen_prepare_buffer>
{'OP': 'REPM', 'src': {'same': False, 'congruent': 9, 'type': 'addresses_WT_ht'}, 'dst': {'same': False, 'congruent': 4, 'type': 'addresses_D_ht'}}
...
{'OP': 'REPM', 'src': {'same': False, 'congruent': 4, 'type': 'addresses_A_ht'}, 'dst': {'same': False, 'congruent': 1, 'type': 'addresses_D_ht'}}
