...
push %rdi
push %rsi
lea addresses_WC_ht+0x17dd2, %rbx
add $54373, %r10
movw $0x6162, (%rbx)
xor %rax, %rax
lea addresses_UC_ht+0x13b12, %rsi
lea addresses_WT_ht+0x16432, %rdi
nop
nop
cmp %r8, %r8
mov $43, %rcx
...
nop
add $33769, %rbx
lea addresses_WC_ht+0x134e0, %r8
nop
nop
and $23951, %rcx
mov (%r8), %ax
cmp %r8, %r8
lea addresses_normal_ht+0x193d2, %rsi
lea addresses_D_ht+0x1ad2, %rdi
nop
nop
dec %rbx
mov $29, %rcx
...
{'dst': {'same': False, 'congruent': 5, 'type': 'addresses_WT_ht'}, 'OP': 'REPM', 'src': {'same': False, 'congruent': 6, 'type': 'addresses_UC_ht'}}
