...
push %rdx
push %rsi
lea addresses_WT_ht+0x185c3, %r8
nop
nop
nop
dec %r13
mov (%r8), %rbx
and %rsi, %rsi
lea addresses_normal_ht+0x17b43, %rsi
lea addresses_A_ht+0x101e7, %rdi
clflush (%rdi)
nop
nop
nop
...
nop
xor $44720, %rbx
lea addresses_WC_ht+0x2b35, %r13
nop
nop
cmp %rdi, %rdi
...
nop
sub %r13, %r13
lea addresses_WC_ht+0xbcd3, %rsi
...
nop
and %r13, %r13
lea addresses_normal_ht+0x9093, %rsi
lea addresses_UC_ht+0x18063, %rdi
nop
nop
nop
nop
...
nop
add %rbx, %rbx
lea addresses_normal_ht+0x5249, %rbx
clflush (%rbx)
nop
nop
nop
...
nop
lfence
lea addresses_UC_ht+0x18f43, %rsi
lea addresses_D_ht+0xd343, %rdi
inc %rdx
mov $14, %rcx
rep movsq
nop
...
{'src': {'type': 'addresses_UC_ht', 'congruent': 10, 'same': False}, 'dst': {'type': 'addresses_D_ht', 'congruent': 9, 'same': True}, 'OP': 'REPM'}
{'38': 21829}
