...
nop
and $14958, %rbx
lea addresses_normal_ht+0x454b, %rsi
lea addresses_A_ht+0x1337b, %rdi
nop
nop
nop
cmp $29833, %r10
...
nop
dec %rcx
lea addresses_normal_ht+0xfb3b, %rcx
nop
inc %r14
mov (%rcx), %r8
nop
...
nop
add %r14, %r14
lea addresses_WT_ht+0x10ffb, %r15
nop
nop
xor $2462, %rbx
...
nop
sub $3258, %r8
lea addresses_WT_ht+0xf473, %rsi
nop
nop
nop
nop
...
nop
cmp $4281, %r8
lea addresses_WC_ht+0x9433, %r15
nop
nop
nop
nop
...
nop
sub %rsi, %rsi
lea addresses_UC_ht+0xf53b, %rsi
...
nop
sub $29052, %rcx
lea addresses_WT_ht+0xc0db, %rdi
nop
nop
nop
nop
...
{'OP': 'LOAD', 'src': {'type': 'addresses_WC_ht', 'AVXalign': True, 'congruent': 3, 'size': 32, 'same': False, 'NT': False}}
{'OP': 'REPM', 'src': {'type': 'addresses_UC_ht', 'congruent': 4, 'same': False}, 'dst': {'type': 'addresses_D_ht', 'congruent': 2, 'same': False}}
