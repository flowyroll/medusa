...
nop
and $46429, %rbx
lea addresses_UC_ht+0x1c887, %rbp
nop
sub %r8, %r8
movl $0x61626364, (%rbp)
nop
nop
sub $54732, %r8
lea addresses_D_ht+0x114c7, %r11
nop
nop
nop
nop
...
vpextrq $1, %xmm4, %rbx
sub $50433, %rbx
lea addresses_normal_ht+0x18747, %rcx
clflush (%rcx)
nop
nop
nop
...
// Faulty Load
lea addresses_normal+0xbe87, %rbp
clflush (%rbp)
nop
add $60577, %r15
mov (%rbp), %rax
...
{'OP': 'STOR', 'dst': {'congruent': 9, 'AVXalign': False, 'same': False, 'size': 2, 'NT': False, 'type': 'addresses_NC'}}
