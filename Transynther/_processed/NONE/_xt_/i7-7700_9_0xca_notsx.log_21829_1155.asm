...
push %rdx
push %rsi
lea addresses_D_ht+0x180ba, %r11
nop
nop
nop
nop
...
nop
cmp %r11, %r11
lea addresses_WT_ht+0xd67a, %rbx
nop
nop
nop
nop
...
nop
cmp $45171, %r12
lea addresses_WT_ht+0xa8ba, %r14
clflush (%r14)
nop
nop
nop
...
nop
cmp %r11, %r11
lea addresses_D_ht+0x17cba, %rsi
lea addresses_WC_ht+0x152ba, %rdi
nop
nop
nop
nop
...
nop
sub %rsi, %rsi
lea addresses_WT_ht+0x170ba, %r13
nop
nop
nop
sub %r12, %r12
...
{'src': {'congruent': 9, 'same': False, 'type': 'addresses_D_ht'}, 'dst': {'congruent': 7, 'same': False, 'type': 'addresses_WC_ht'}, 'OP': 'REPM'}
