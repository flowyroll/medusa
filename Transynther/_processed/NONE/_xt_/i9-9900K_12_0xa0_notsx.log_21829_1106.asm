...
push %rdi
push %rsi
lea addresses_UC_ht+0x1cdea, %rcx
nop
nop
nop
inc %r15
...
nop
add $20400, %rax
lea addresses_D_ht+0x195de, %rsi
sub $56493, %rax
movb (%rsi), %bl
nop
inc %rsi
lea addresses_WC_ht+0x146da, %rsi
nop
nop
nop
nop
...
nop
xor %r15, %r15
lea addresses_D_ht+0xa2da, %rsi
lea addresses_D_ht+0x7bba, %rdi
clflush (%rdi)
nop
nop
nop
...
{'OP': 'STOR', 'dst': {'type': 'addresses_WT', 'AVXalign': False, 'size': 4, 'NT': True, 'same': False, 'congruent': 4}}
[Faulty Load]
