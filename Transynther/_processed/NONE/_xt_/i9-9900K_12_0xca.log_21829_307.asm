...
push %rdi
push %rsi
lea addresses_UC_ht+0x7b82, %rdi
nop
nop
nop
nop
...
nop
and %rbx, %rbx
lea addresses_UC_ht+0x1e582, %r15
nop
nop
nop
nop
...
// Store
lea addresses_normal+0x1448e, %rdi
nop
nop
nop
nop
...
{'OP': 'LOAD', 'src': {'size': 8, 'NT': False, 'type': 'addresses_WT', 'same': False, 'AVXalign': False, 'congruent': 1}}
...
<gen_prepare_buffer>
{'OP': 'LOAD', 'src': {'size': 4, 'NT': False, 'type': 'addresses_UC_ht', 'same': False, 'AVXalign': True, 'congruent': 9}}
