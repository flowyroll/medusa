...
nop
sub $39828, %rsi
lea addresses_UC_ht+0x15b45, %r9
nop
nop
nop
nop
...
nop
xor %r13, %r13
lea addresses_WT_ht+0x1bf69, %rsi
nop
nop
and %r8, %r8
mov (%rsi), %ecx
...
nop
sub $19180, %rdi
lea addresses_WT_ht+0x1a325, %r14
xor $37898, %rsi
...
nop
xor $11387, %r14
lea addresses_UC_ht+0x13725, %rcx
clflush (%rcx)
nop
nop
sub %rdi, %rdi
...
nop
cmp $50607, %rcx
lea addresses_A_ht+0x1d6ad, %r14
clflush (%r14)
nop
nop
nop
...
// Load
lea addresses_normal+0x1525, %rsi
nop
nop
nop
add %r8, %r8
...
{'src': {'NT': False, 'same': False, 'congruent': 4, 'type': 'addresses_normal', 'AVXalign': True, 'size': 4}, 'OP': 'LOAD'}
...
{'src': {'same': True, 'congruent': 11, 'type': 'addresses_UC_ht'}, 'OP': 'REPM', 'dst': {'same': False, 'congruent': 3, 'type': 'addresses_A_ht'}}
{'src': {'NT': True, 'same': False, 'congruent': 5, 'type': 'addresses_UC_ht', 'AVXalign': False, 'size': 2}, 'OP': 'LOAD'}
...
{'src': {'same': False, 'congruent': 11, 'type': 'addresses_UC_ht'}, 'OP': 'REPM', 'dst': {'same': False, 'congruent': 5, 'type': 'addresses_UC_ht'}}
{'OP': 'STOR', 'dst': {'NT': True, 'same': False, 'congruent': 9, 'type': 'addresses_UC_ht', 'AVXalign': False, 'size': 8}}
