...
push %rdi
push %rsi
lea addresses_A_ht+0xb2a4, %rsi
lea addresses_UC_ht+0x132a4, %rdi
nop
nop
nop
nop
...
lea addresses_UC_ht+0x82a4, %rdi
sub %rbp, %rbp
mov $55, %rcx
rep movsw
nop
...
nop
sub %rdi, %rdi
lea addresses_WT_ht+0x141a4, %rbx
xor $63843, %rdi
...
nop
cmp %rsi, %rsi
lea addresses_WC_ht+0x1dea4, %rcx
clflush (%rcx)
cmp %rdi, %rdi
movw $0x6162, (%rcx)
xor $20299, %rdi
lea addresses_D_ht+0x7f24, %rsi
nop
nop
nop
xor %r13, %r13
...
nop
sub $6682, %rsi
lea addresses_normal_ht+0x142a4, %rcx
nop
nop
add $40710, %r13
mov (%rcx), %r10w
...
nop
inc %rbp
lea addresses_WT_ht+0xd126, %rsi
...
nop
sub $43637, %rcx
lea addresses_WT_ht+0xcca4, %rcx
cmp %r10, %r10
mov (%rcx), %rdi
nop
nop
nop
and %rdi, %rdi
lea addresses_UC_ht+0xdaa4, %r11
and $43145, %rcx
movb $0x61, (%r11)
nop
and $46892, %rbp
...
<gen_prepare_buffer>
{'OP': 'REPM', 'src': {'type': 'addresses_A_ht', 'congruent': 8, 'same': True}, 'dst': {'type': 'addresses_UC_ht', 'congruent': 11, 'same': False}}
