...
push %rdi
push %rsi
lea addresses_D_ht+0x11b5e, %rbx
nop
nop
nop
nop
...
movl $0x61626364, (%rbx)
inc %r14
lea addresses_WT_ht+0x8b7e, %rsi
lea addresses_WT_ht+0x1c5be, %rdi
nop
nop
xor %rax, %rax
mov $71, %rcx
...
nop
xor $56524, %rcx
lea addresses_normal_ht+0x1d20a, %rdi
sub %rbx, %rbx
movb $0x61, (%rdi)
nop
nop
and $5023, %rax
lea addresses_A_ht+0x310e, %rsi
...
nop
add %rdi, %rdi
lea addresses_A_ht+0x1a922, %rcx
nop
nop
sub %rbx, %rbx
mov (%rcx), %r8
nop
add $61476, %rax
lea addresses_normal_ht+0x3dbe, %rsi
lea addresses_UC_ht+0xbcbe, %rdi
nop
sub $13890, %r14
mov $125, %rcx
rep movsb
...
nop
xor %r8, %r8
lea addresses_WT_ht+0x2cbe, %r13
nop
nop
nop
and $12887, %rdi
...
nop
dec %rsi
lea addresses_D_ht+0x6dbe, %rsi
lea addresses_WT_ht+0xe5be, %rdi
nop
nop
nop
dec %r14
...
rep movsq
and %r14, %r14
lea addresses_UC_ht+0x1db85, %rsi
...
nop
and %r13, %r13
lea addresses_A_ht+0x1c1be, %rsi
lea addresses_UC_ht+0xa9be, %rdi
nop
add $36202, %rbx
mov $110, %rcx
rep movsb
...
// REPMOV
lea addresses_US+0xb5c6, %rsi
lea addresses_PSE+0x1aabe, %rdi
cmp $3529, %rax
mov $2, %rcx
rep movsb
nop
...
{'OP': 'REPM', 'src': {'type': 'addresses_US', 'congruent': 0, 'same': False}, 'dst': {'type': 'addresses_PSE', 'congruent': 8, 'same': False}}
[Faulty Load]
...
{'OP': 'REPM', 'src': {'type': 'addresses_D_ht', 'congruent': 8, 'same': False}, 'dst': {'type': 'addresses_WT_ht', 'congruent': 11, 'same': True}}
