...
nop
add %r11, %r11
lea addresses_D_ht+0x18ff2, %rdi
nop
nop
sub $23097, %r9
vmovups (%rdi), %ymm4
...
nop
add %r11, %r11
lea addresses_A_ht+0x19fd2, %rax
clflush (%rax)
xor %rsi, %rsi
