...
push %rdi
push %rsi
lea addresses_D_ht+0x1d7db, %rsi
nop
nop
dec %r14
movl $0x61626364, (%rsi)
nop
and $30613, %r8
lea addresses_WT_ht+0xb3db, %rsi
lea addresses_WC_ht+0x12483, %rdi
nop
nop
nop
and %r10, %r10
...
nop
and $4516, %r14
lea addresses_WT_ht+0x1cdb, %r10
nop
nop
nop
nop
...
nop
cmp %rdi, %rdi
lea addresses_D_ht+0x10afb, %rcx
clflush (%rcx)
nop
nop
nop
...
vpextrq $1, %xmm4, %rbx
sub $37695, %rdi
lea addresses_UC_ht+0x8c73, %rsi
lea addresses_normal_ht+0xfdb, %rdi
nop
nop
nop
add $38575, %r11
...
nop
and %r8, %r8
lea addresses_WT_ht+0x19201, %r10
nop
nop
nop
nop
...
nop
add %rbx, %rbx
lea addresses_A_ht+0x16a29, %rsi
lea addresses_UC_ht+0x1a1db, %rdi
inc %r11
mov $53, %rcx
rep movsb
nop
...
nop
cmp %r14, %r14
lea addresses_WC_ht+0xa75b, %rdi
nop
nop
nop
sub %rsi, %rsi
...
nop
sub $57814, %r8
lea addresses_WT_ht+0x6a5b, %rcx
nop
nop
nop
nop
...
nop
add $31384, %rsi
lea addresses_D_ht+0x225b, %rsi
lea addresses_D_ht+0x18dd7, %rdi
nop
nop
nop
and $28779, %rbx
...
nop
xor %r8, %r8
lea addresses_UC_ht+0x177db, %rsi
lea addresses_WC_ht+0x4bdb, %rdi
nop
nop
add $12981, %r8
mov $0, %rcx
...
nop
cmp $49777, %rsi
lea addresses_normal_ht+0x53db, %rsi
lea addresses_D_ht+0xf8db, %rdi
add $47502, %r14
mov $93, %rcx
rep movsq
xor %r10, %r10
lea addresses_WC_ht+0xbfdb, %rdi
nop
nop
nop
nop
...
{'OP': 'REPM', 'src': {'type': 'addresses_D_ht', 'congruent': 6, 'same': False}, 'dst': {'type': 'addresses_D_ht', 'congruent': 1, 'same': False}}
{'OP': 'REPM', 'src': {'type': 'addresses_UC_ht', 'congruent': 11, 'same': False}, 'dst': {'type': 'addresses_WC_ht', 'congruent': 9, 'same': True}}
{'OP': 'REPM', 'src': {'type': 'addresses_normal_ht', 'congruent': 6, 'same': True}, 'dst': {'type': 'addresses_D_ht', 'congruent': 6, 'same': False}}
