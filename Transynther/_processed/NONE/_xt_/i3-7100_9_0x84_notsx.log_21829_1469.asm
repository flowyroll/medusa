...
push %rdi
push %rsi
lea addresses_UC_ht+0xfe7f, %r12
nop
nop
nop
nop
...
nop
xor %rdi, %rdi
lea addresses_A_ht+0x117ae, %rsi
nop
nop
nop
nop
...
nop
dec %rbp
lea addresses_WC_ht+0x521e, %r10
nop
nop
nop
xor %rdi, %rdi
...
nop
xor %rdi, %rdi
lea addresses_normal_ht+0x3a7a, %r8
clflush (%r8)
nop
nop
nop
...
nop
sub %rbp, %rbp
lea addresses_normal_ht+0x1196f, %r15
nop
nop
xor $42086, %r8
movw $0x6162, (%r15)
