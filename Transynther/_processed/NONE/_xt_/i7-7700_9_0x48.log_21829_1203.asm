...
push %rdi
push %rsi
lea addresses_WT_ht+0x1d322, %rsi
lea addresses_normal_ht+0xc63e, %rdi
nop
add %r12, %r12
mov $115, %rcx
rep movsb
...
nop
add %r8, %r8
lea addresses_D_ht+0x16746, %rsi
lea addresses_A_ht+0x48be, %rdi
clflush (%rsi)
nop
nop
nop
...
nop
xor $41720, %rax
lea addresses_WC_ht+0x173e, %rsi
lea addresses_D_ht+0xf8b2, %rdi
nop
nop
and %r12, %r12
mov $35, %rcx
...
nop
cmp $20638, %rcx
lea addresses_normal_ht+0xec7e, %r12
nop
add %r9, %r9
movb (%r12), %r8b
cmp $55649, %rcx
lea addresses_A_ht+0x1d3be, %rdi
nop
nop
nop
nop
...
nop
xor %rax, %rax
lea addresses_WC_ht+0xed3e, %rax
nop
nop
sub $43469, %rdi
mov (%rax), %rsi
...
nop
cmp $51008, %rcx
lea addresses_WT_ht+0x627e, %r12
nop
cmp %rax, %rax
vmovups (%r12), %ymm7
...
nop
xor $32187, %r8
lea addresses_WT_ht+0x5f3e, %rsi
lea addresses_WT_ht+0xbeee, %rdi
nop
nop
xor $60139, %r15
mov $53, %rcx
...
nop
xor %r9, %r9
lea addresses_WT_ht+0x16e5e, %rax
nop
nop
sub %r9, %r9
mov (%rax), %r12w
...
nop
inc %r15
lea addresses_WT_ht+0xad3e, %rsi
lea addresses_UC_ht+0x17ffe, %rdi
xor %rax, %rax
mov $27, %rcx
rep movsq
nop
...
{'OP': 'REPM', 'src': {'type': 'addresses_WT_ht', 'congruent': 9, 'same': False}, 'dst': {'type': 'addresses_WT_ht', 'congruent': 3, 'same': True}}
{'OP': 'LOAD', 'src': {'type': 'addresses_WT_ht', 'AVXalign': True, 'congruent': 5, 'size': 2, 'same': True, 'NT': True}}
