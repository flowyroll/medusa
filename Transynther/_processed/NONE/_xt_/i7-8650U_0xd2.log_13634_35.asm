...
push %rdi
push %rsi
lea addresses_A_ht+0x11bc2, %rsi
...
nop
dec %rbp
lea addresses_UC_ht+0x259a, %rsi
lea addresses_WT_ht+0xc742, %rdi
nop
nop
nop
nop
...
nop
xor %rdi, %rdi
lea addresses_UC_ht+0x13242, %r11
sub %r14, %r14
movw $0x6162, (%r11)
nop
nop
...
// Load
lea addresses_normal+0x159d3, %r13
inc %r15
movups (%r13), %xmm0
vpextrq $1, %xmm0, %rdx
nop
...
<gen_prepare_buffer>
{'OP': 'REPM', 'src': {'type': 'addresses_A_ht', 'congruent': 7, 'same': False}, 'dst': {'type': 'addresses_A_ht', 'congruent': 1, 'same': True}}
{'OP': 'REPM', 'src': {'type': 'addresses_UC_ht', 'congruent': 1, 'same': True}, 'dst': {'type': 'addresses_WT_ht', 'congruent': 8, 'same': False}}
