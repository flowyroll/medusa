...
nop
sub $41574, %rdi
lea addresses_UC_ht+0x182e7, %r9
nop
cmp %rdi, %rdi
movw $0x6162, (%r9)
nop
...
nop
add $10951, %rax
lea addresses_A_ht+0x1ee00, %rsi
...
nop
xor $11297, %rdi
lea addresses_WC_ht+0x863c, %rax
nop
nop
nop
nop
...
nop
and $4330, %rax
lea addresses_UC_ht+0x1bd7, %rsi
...
// Store
lea addresses_normal+0x1c4d7, %rcx
nop
and %rsi, %rsi
...
{'dst': {'NT': True, 'AVXalign': False, 'size': 4, 'congruent': 7, 'same': False, 'type': 'addresses_UC'}, 'OP': 'STOR'}
{'dst': {'NT': False, 'AVXalign': True, 'size': 8, 'congruent': 6, 'same': False, 'type': 'addresses_NC'}, 'OP': 'STOR'}
...
{'src': {'NT': False, 'AVXalign': True, 'size': 16, 'congruent': 2, 'same': False, 'type': 'addresses_D'}, 'OP': 'LOAD'}
[Faulty Load]
