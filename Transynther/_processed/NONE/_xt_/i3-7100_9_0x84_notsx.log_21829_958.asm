...
nop
cmp %rdi, %rdi
lea addresses_normal_ht+0x543d, %rdi
nop
nop
nop
nop
...
nop
add %r12, %r12
lea addresses_WC_ht+0x190c9, %r9
nop
nop
and $47992, %rcx
mov (%r9), %r8d
nop
and $52394, %rdi
lea addresses_A_ht+0xc6bd, %r9
and %r12, %r12
mov (%r9), %di
nop
sub %r11, %r11
lea addresses_normal_ht+0x172bd, %r11
nop
nop
nop
nop
...
nop
add $34117, %r9
lea addresses_WC_ht+0x92bd, %r11
nop
nop
nop
nop
...
nop
add $32747, %rcx
lea addresses_normal_ht+0x942d, %rsi
lea addresses_A_ht+0xbd, %rdi
nop
and %r12, %r12
mov $38, %rcx
rep movsl
