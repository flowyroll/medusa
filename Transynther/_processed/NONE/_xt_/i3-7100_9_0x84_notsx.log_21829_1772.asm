...
push %rdx
push %rsi
lea addresses_D_ht+0x1c61b, %rsi
lea addresses_WT_ht+0x177f7, %rdi
nop
nop
nop
nop
...
nop
cmp $38366, %r12
lea addresses_WC_ht+0x86d7, %rbp
nop
cmp %r9, %r9
movw $0x6162, (%rbp)
nop
add $8221, %rdi
lea addresses_WC_ht+0x1e66c, %rsi
lea addresses_D_ht+0x15a4b, %rdi
nop
dec %r15
mov $88, %rcx
rep movsb
...
nop
dec %rbp
lea addresses_normal_ht+0x850b, %r12
nop
nop
nop
nop
...
nop
and $47477, %r15
lea addresses_WT_ht+0x1b82b, %rsi
lea addresses_WT_ht+0x12e8b, %rdi
nop
nop
inc %rdx
mov $112, %rcx
...
nop
and %rdx, %rdx
lea addresses_normal_ht+0x12b33, %rbp
nop
nop
nop
sub %rsi, %rsi
...
nop
dec %r12
lea addresses_normal_ht+0x1060b, %rsi
lea addresses_D_ht+0xad0b, %rdi
nop
nop
add $28377, %rbp
mov $52, %rcx
...
// REPMOV
lea addresses_US+0x1958b, %rsi
mov $0x505bd8000000098b, %rdi
nop
nop
inc %r11
mov $127, %rcx
...
{'src': {'type': 'addresses_US', 'congruent': 3, 'same': False}, 'dst': {'type': 'addresses_NC', 'congruent': 6, 'same': False}, 'OP': 'REPM'}
[Faulty Load]
...
{'src': {'type': 'addresses_WT_ht', 'congruent': 5, 'same': True}, 'dst': {'type': 'addresses_WT_ht', 'congruent': 7, 'same': False}, 'OP': 'REPM'}
