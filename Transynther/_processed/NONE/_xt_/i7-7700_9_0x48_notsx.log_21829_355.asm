...
push %rdi
push %rsi
lea addresses_UC_ht+0x5be0, %rsi
...
rep movsb
xor $50366, %r13
lea addresses_normal_ht+0x179a4, %r15
nop
nop
nop
dec %r12
...
nop
inc %r12
lea addresses_WC_ht+0x84d3, %r15
nop
nop
nop
dec %rdi
...
nop
xor $16915, %rsi
lea addresses_UC_ht+0x18ea4, %rsi
lea addresses_normal_ht+0x1baca, %rdi
nop
xor $1156, %r10
mov $96, %rcx
rep movsq
nop
cmp %rcx, %rcx
lea addresses_UC_ht+0xa6a4, %rcx
and $20058, %r10
mov (%rcx), %rsi
and $41392, %rbx
pop %rsi
