...
nop
cmp $56163, %rcx
lea addresses_D_ht+0x164e1, %r13
nop
nop
nop
nop
...
nop
xor %r8, %r8
lea addresses_normal_ht+0x11691, %rsi
lea addresses_normal_ht+0x1b1a5, %rdi
nop
nop
nop
nop
...
nop
xor %r10, %r10
lea addresses_D_ht+0x1e391, %rsi
...
<gen_prepare_buffer>
{'src': {'NT': True, 'AVXalign': False, 'size': 1, 'congruent': 11, 'same': False, 'type': 'addresses_D_ht'}, 'OP': 'LOAD'}
...
{'src': {'congruent': 8, 'same': False, 'type': 'addresses_D_ht'}, 'dst': {'congruent': 3, 'same': False, 'type': 'addresses_D_ht'}, 'OP': 'REPM'}
{'38': 21829}
