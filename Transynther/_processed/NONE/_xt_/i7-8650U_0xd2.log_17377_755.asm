...
push %rdi
push %rsi
lea addresses_UC_ht+0x19fb4, %rsi
lea addresses_WT_ht+0x1e2e8, %rdi
nop
xor $53355, %rax
mov $39, %rcx
rep movsl
xor $62026, %rax
lea addresses_WC_ht+0x1ede8, %r15
nop
cmp $47243, %rcx
vmovups (%r15), %ymm3
...
nop
dec %r15
lea addresses_WT_ht+0x16de8, %rcx
nop
sub %r13, %r13
movb (%rcx), %r15b
nop
...
nop
cmp $18629, %r15
lea addresses_WC_ht+0x1a8e8, %r13
nop
nop
nop
nop
...
nop
cmp %rax, %rax
lea addresses_D_ht+0x1a8e8, %rsi
nop
nop
sub $21238, %rdi
movups (%rsi), %xmm1
...
nop
cmp %rcx, %rcx
lea addresses_WT_ht+0x188d8, %rsi
lea addresses_A_ht+0x10948, %rdi
clflush (%rsi)
and $29280, %r8
mov $96, %rcx
rep movsl
...
nop
xor $27575, %r15
lea addresses_UC_ht+0xa8e0, %r15
nop
nop
nop
nop
...
<gen_faulty_load>
[REF]
{'OP': 'LOAD', 'src': {'type': 'addresses_RW', 'size': 1, 'AVXalign': True, 'NT': True, 'congruent': 0, 'same': False}}
[Faulty Load]
