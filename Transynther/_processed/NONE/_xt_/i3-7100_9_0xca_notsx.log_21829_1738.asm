...
nop
dec %r15
lea addresses_normal_ht+0xdee, %rcx
nop
nop
sub $12519, %r8
mov (%rcx), %rax
...
nop
xor $49324, %rax
lea addresses_A_ht+0x1a0f7, %rsi
lea addresses_A_ht+0x876e, %rdi
nop
nop
add %r8, %r8
mov $93, %rcx
...
nop
inc %rdi
lea addresses_UC_ht+0x1e2e6, %rsi
lea addresses_D_ht+0x1ed0e, %rdi
nop
nop
nop
sub $9348, %rax
...
nop
xor %r15, %r15
lea addresses_UC_ht+0x104ce, %rsi
lea addresses_A_ht+0x1cfee, %rdi
nop
cmp %r14, %r14
mov $85, %rcx
rep movsl
...
nop
add %r11, %r11
lea addresses_WC_ht+0x17e7e, %rsi
add $24257, %r14
movl $0x61626364, (%rsi)
nop
cmp $611, %rsi
lea addresses_WC_ht+0x1b06e, %rdi
nop
nop
nop
inc %rax
...
// REPMOV
lea addresses_A+0x15a26, %rsi
lea addresses_PSE+0x1bd9a, %rdi
nop
nop
nop
add %r12, %r12
...
{'src': {'type': 'addresses_A', 'congruent': 2, 'same': False}, 'OP': 'REPM', 'dst': {'type': 'addresses_PSE', 'congruent': 1, 'same': False}}
...
{'src': {'type': 'addresses_A_ht', 'congruent': 0, 'same': True}, 'OP': 'REPM', 'dst': {'type': 'addresses_A_ht', 'congruent': 7, 'same': False}}
{'src': {'type': 'addresses_UC_ht', 'congruent': 1, 'same': False}, 'OP': 'REPM', 'dst': {'type': 'addresses_D_ht', 'congruent': 4, 'same': True}}
{'src': {'type': 'addresses_UC_ht', 'congruent': 3, 'same': False}, 'OP': 'REPM', 'dst': {'type': 'addresses_A_ht', 'congruent': 9, 'same': False}}
