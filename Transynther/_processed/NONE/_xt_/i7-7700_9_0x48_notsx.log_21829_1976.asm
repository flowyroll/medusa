...
nop
inc %r9
lea addresses_normal_ht+0x1ee3b, %rcx
nop
cmp %rdi, %rdi
mov (%rcx), %r11w
nop
...
nop
xor $23553, %rdi
lea addresses_normal_ht+0x11a53, %rcx
nop
nop
sub $49647, %r13
vmovups (%rcx), %ymm1
...
nop
sub $4204, %rax
lea addresses_UC_ht+0x135bb, %rdi
cmp %rcx, %rcx
movl $0x61626364, (%rdi)
nop
nop
mfence
lea addresses_A_ht+0x16485, %rsi
lea addresses_WT_ht+0xc47b, %rdi
clflush (%rsi)
nop
nop
nop
...
nop
inc %rsi
lea addresses_UC_ht+0x1387b, %rsi
lea addresses_D_ht+0x154ad, %rdi
nop
nop
nop
nop
...
nop
and $44475, %r13
lea addresses_WT_ht+0xf87b, %rdx
clflush (%rdx)
nop
nop
nop
...
// Store
lea addresses_UC+0x747b, %r9
inc %rsi
movw $0x5152, (%r9)
add $20418, %r9

// Faulty Load
lea addresses_D+0x1447b, %r9
sub %r10, %r10
mov (%r9), %r13d
lea oracles, %rsi
and $0xff, %r13
...
{'OP': 'LOAD', 'src': {'same': True, 'NT': False, 'AVXalign': False, 'size': 2, 'type': 'addresses_normal_ht', 'congruent': 4}}
...
{'dst': {'same': False, 'congruent': 11, 'type': 'addresses_WT_ht'}, 'OP': 'REPM', 'src': {'same': False, 'congruent': 1, 'type': 'addresses_A_ht'}}
