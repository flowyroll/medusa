...
nop
sub %rdi, %rdi
lea addresses_A_ht+0x19e74, %rbx
nop
nop
dec %rdi
movb $0x61, (%rbx)
nop
xor %rdi, %rdi
lea addresses_WC_ht+0x6078, %rsi
lea addresses_normal_ht+0xc478, %rdi
nop
nop
nop
nop
...
nop
cmp %rbx, %rbx
lea addresses_UC_ht+0x2340, %rbx
nop
nop
and $29717, %rdx
movb $0x61, (%rbx)
...
nop
cmp $44876, %rsi
lea addresses_WC_ht+0x14f8, %rsi
lea addresses_UC_ht+0x1154d, %rdi
nop
nop
nop
nop
...
nop
add %rdi, %rdi
lea addresses_WC_ht+0x12878, %r8
nop
nop
inc %r10
movb (%r8), %cl
nop
inc %rcx
lea addresses_WC_ht+0x19cd8, %rsi
lea addresses_normal_ht+0x10580, %rdi
nop
nop
nop
and $4325, %rbx
...
{'src': {'type': 'addresses_WC_ht', 'congruent': 8, 'same': False}, 'dst': {'type': 'addresses_normal_ht', 'congruent': 10, 'same': True}, 'OP': 'REPM'}
...
{'src': {'type': 'addresses_WC_ht', 'congruent': 2, 'same': False}, 'dst': {'type': 'addresses_normal_ht', 'congruent': 3, 'same': False}, 'OP': 'REPM'}
{'36': 21829}
