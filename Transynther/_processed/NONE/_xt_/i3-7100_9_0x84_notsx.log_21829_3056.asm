...
push %rdx
push %rsi
lea addresses_normal_ht+0x4060, %rdx
nop
cmp $12999, %r12
movb $0x61, (%rdx)
nop
nop
xor $21034, %r9
lea addresses_WT_ht+0x13960, %rsi
...
nop
and %r9, %r9
lea addresses_UC_ht+0x14560, %rsi
nop
nop
nop
nop
...
{'src': {'type': 'addresses_WT_ht', 'congruent': 11, 'same': False}, 'dst': {'type': 'addresses_D_ht', 'congruent': 7, 'same': False}, 'OP': 'REPM'}
