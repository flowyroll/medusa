...
push %rdx
push %rsi
lea addresses_A_ht+0x11c62, %rbp
nop
nop
nop
and %rsi, %rsi
...
nop
dec %rdi
lea addresses_normal_ht+0x1250a, %rsi
lea addresses_WC_ht+0x105c2, %rdi
clflush (%rdi)
nop
cmp %rbx, %rbx
mov $84, %rcx
...
nop
add $16225, %rcx
lea addresses_WC_ht+0x134c2, %rdi
nop
sub %rcx, %rcx
...
lea addresses_UC_ht+0x1e7c2, %rdi
nop
nop
xor $27046, %r9
mov $23, %rcx
rep movsq
sub $40748, %r9
lea addresses_A_ht+0xd9c2, %rsi
lea addresses_A_ht+0x1623a, %rdi
nop
nop
nop
sub $22747, %rdx
...
nop
add $29588, %r12
lea addresses_normal_ht+0x41a2, %rsi
lea addresses_WT_ht+0x1d8c2, %rdi
and $41078, %rbx
mov $127, %rcx
rep movsw
nop
...
nop
cmp %rsi, %rsi
lea addresses_WC_ht+0x48c2, %rsi
lea addresses_normal_ht+0x19cc2, %rdi
add %rbp, %rbp
mov $82, %rcx
rep movsb
nop
...
lea addresses_WT_ht+0x103aa, %rdi
nop
nop
nop
nop
...
{'src': {'type': 'addresses_A_ht', 'congruent': 7, 'same': False}, 'dst': {'type': 'addresses_A_ht', 'congruent': 3, 'same': False}, 'OP': 'REPM'}
...
{'src': {'type': 'addresses_WC_ht', 'congruent': 4, 'same': False}, 'dst': {'type': 'addresses_WT_ht', 'congruent': 3, 'same': False}, 'OP': 'REPM'}
{'36': 21829}
