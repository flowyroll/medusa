...
push %rdi
push %rsi
lea addresses_UC_ht+0x14235, %r11
nop
nop
nop
nop
...
nop
and $28794, %rbp
lea addresses_UC_ht+0x18955, %rsi
lea addresses_UC_ht+0x1d101, %rdi
nop
nop
add %r11, %r11
mov $4, %rcx
...
nop
sub %rsi, %rsi
lea addresses_A_ht+0xe4b5, %rsi
lea addresses_WC_ht+0xc6c5, %rdi
nop
nop
nop
cmp $1611, %r12
...
nop
xor %rsi, %rsi
lea addresses_normal_ht+0x12f35, %rbp
nop
and %r11, %r11
mov (%rbp), %r12w
nop
nop
dec %r12
lea addresses_normal_ht+0x1235, %r9
nop
nop
nop
cmp %rbp, %rbp
mov (%r9), %r8d
and $11657, %rcx
lea addresses_WT_ht+0x1abf5, %r8
clflush (%r8)
nop
nop
and %r9, %r9
...
nop
and $49785, %rbp
lea addresses_normal_ht+0x3635, %r9
nop
nop
nop
nop
...
nop
add %rsi, %rsi
lea addresses_UC_ht+0xc6d5, %rsi
lea addresses_A_ht+0x12b35, %rdi
nop
nop
add %rbp, %rbp
mov $82, %rcx
...
nop
sub %rdi, %rdi
lea addresses_WC_ht+0x18935, %rsi
lea addresses_WT_ht+0x18ad5, %rdi
nop
sub $42751, %rbp
mov $49, %rcx
rep movsb
...
nop
sub $62442, %rdi
lea addresses_UC_ht+0xd8b5, %rsi
nop
nop
nop
cmp $1176, %rbp
...
nop
inc %r12
lea addresses_A_ht+0xebb5, %rsi
lea addresses_WT_ht+0x835, %rdi
clflush (%rdi)
nop
nop
nop
...
nop
cmp %rsi, %rsi
lea addresses_UC_ht+0x4535, %rsi
lea addresses_WC_ht+0x1eb35, %rdi
cmp $2498, %r11
mov $113, %rcx
rep movsb
nop
...
nop
xor $5453, %r12
lea addresses_normal_ht+0x1e335, %rsi
lea addresses_WC_ht+0x15535, %rdi
nop
nop
sub %rbp, %rbp
mov $85, %rcx
...
{'src': {'type': 'addresses_WC_ht', 'congruent': 7, 'same': False}, 'OP': 'REPM', 'dst': {'type': 'addresses_WT_ht', 'congruent': 4, 'same': False}}
{'src': {'same': False, 'congruent': 6, 'NT': False, 'type': 'addresses_UC_ht', 'size': 16, 'AVXalign': False}, 'OP': 'LOAD'}
{'src': {'type': 'addresses_A_ht', 'congruent': 7, 'same': False}, 'OP': 'REPM', 'dst': {'type': 'addresses_WT_ht', 'congruent': 8, 'same': False}}
{'src': {'type': 'addresses_UC_ht', 'congruent': 9, 'same': False}, 'OP': 'REPM', 'dst': {'type': 'addresses_WC_ht', 'congruent': 11, 'same': False}}
{'src': {'type': 'addresses_normal_ht', 'congruent': 9, 'same': False}, 'OP': 'REPM', 'dst': {'type': 'addresses_WC_ht', 'congruent': 3, 'same': False}}
{'33': 21829}
