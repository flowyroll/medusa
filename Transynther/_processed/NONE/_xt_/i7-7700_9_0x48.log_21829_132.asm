...
nop
sub %r15, %r15
lea addresses_WC_ht+0x532d, %r15
nop
and $21562, %rbx
movl $0x61626364, (%r15)
nop
...
nop
dec %rbx
lea addresses_D_ht+0x1442d, %rcx
nop
nop
sub %rsi, %rsi
...
nop
cmp %rcx, %rcx
lea addresses_WT_ht+0xee52, %rsi
lea addresses_WT_ht+0x1342d, %rdi
and $40137, %r9
mov $28, %rcx
rep movsb
nop
add %rdi, %rdi
lea addresses_WC_ht+0xfd2d, %rbp
nop
nop
nop
sub %r8, %r8
...
lea addresses_A_ht+0x11b45, %rdi
nop
nop
nop
nop
...
nop
sub $56997, %rbx
lea addresses_WT_ht+0x17d95, %rbp
cmp %r8, %r8
...
nop
xor %rcx, %rcx
lea addresses_WT_ht+0x1608d, %r8
nop
nop
nop
nop
...
nop
cmp %rcx, %rcx
lea addresses_UC_ht+0x14f2d, %rsi
lea addresses_WC_ht+0x1042d, %rdi
clflush (%rdi)
nop
nop
add $57345, %r8
...
{'OP': 'LOAD', 'src': {'type': 'addresses_WC_ht', 'AVXalign': False, 'congruent': 9, 'size': 2, 'same': False, 'NT': True}}
...
{'OP': 'LOAD', 'src': {'type': 'addresses_UC_ht', 'AVXalign': False, 'congruent': 7, 'size': 32, 'same': True, 'NT': False}}
