...
push %rdx
push %rsi
lea addresses_WT_ht+0xfec1, %rsi
lea addresses_normal_ht+0x19d44, %rdi
nop
nop
nop
nop
...
nop
cmp %r10, %r10
lea addresses_WT_ht+0x1ef28, %r12
nop
and $10035, %rsi
movb $0x61, (%r12)
nop
lfence
lea addresses_normal_ht+0xf8c8, %rsi
lea addresses_UC_ht+0x1a4f6, %rdi
nop
nop
nop
nop
...
nop
cmp $4459, %r12
lea addresses_UC_ht+0x1d9f4, %rsi
lea addresses_A_ht+0xf248, %rdi
nop
xor $63638, %r8
mov $49, %rcx
rep movsb
...
lea addresses_WT_ht+0x189b8, %rdi
nop
nop
nop
inc %rdx
...
nop
sub $31309, %rsi
lea addresses_normal_ht+0x1cbfc, %rdx
add %r12, %r12
...
nop
and %rcx, %rcx
lea addresses_A_ht+0x1e2f4, %r12
nop
nop
nop
add $23125, %rsi
...
nop
xor %rsi, %rsi
lea addresses_UC_ht+0x2b88, %rsi
lea addresses_D_ht+0x2cf1, %rdi
nop
nop
nop
nop
...
<gen_prepare_buffer>
{'src': {'type': 'addresses_WT_ht', 'congruent': 0, 'same': False}, 'dst': {'type': 'addresses_normal_ht', 'congruent': 1, 'same': False}, 'OP': 'REPM'}
