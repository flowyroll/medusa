...
push %rdx
push %rsi
lea addresses_WT_ht+0x8029, %rdx
nop
nop
nop
xor $32180, %r14
...
nop
cmp $47717, %r10
lea addresses_WT_ht+0x10ba9, %rsi
lea addresses_WT_ht+0x16a19, %rdi
nop
nop
nop
nop
...
nop
and %r12, %r12
lea addresses_normal_ht+0x15de9, %rsi
lea addresses_A_ht+0x2117, %rdi
clflush (%rdi)
nop
nop
and %rdx, %rdx
...
nop
sub $19363, %rsi
lea addresses_normal_ht+0xdcd1, %rsi
lea addresses_normal_ht+0x36a9, %rdi
clflush (%rdi)
xor %r10, %r10
mov $41, %rcx
rep movsw
...
nop
sub %rdx, %rdx
lea addresses_WT_ht+0x17ca9, %rcx
nop
nop
nop
add $24929, %rsi
...
nop
dec %r10
lea addresses_D_ht+0x155b9, %rsi
lea addresses_WT_ht+0xd841, %rdi
nop
nop
nop
nop
...
nop
and %rdx, %rdx
lea addresses_WT_ht+0x2aa9, %r12
xor %rdi, %rdi
