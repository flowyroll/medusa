...
nop
sub $36683, %rbx
lea addresses_WT_ht+0x1da2f, %r8
mfence
...
nop
add %rax, %rax
lea addresses_normal_ht+0x3dc7, %rax
clflush (%rax)
nop
add $3869, %r15
mov $0x6162636465666768, %r10
...
nop
lfence
lea addresses_UC_ht+0x19f3b, %r13
nop
nop
nop
nop
...
nop
and %r15, %r15
lea addresses_UC_ht+0x1de4b, %r8
nop
nop
cmp $5157, %r13
...
nop
cmp $3776, %r10
lea addresses_WT_ht+0x110c0, %rax
nop
nop
sub $49366, %r12
movl $0x61626364, (%rax)
...
{'OP': 'STOR', 'dst': {'same': False, 'congruent': 0, 'NT': False, 'type': 'addresses_WT_ht', 'size': 4, 'AVXalign': True}}
