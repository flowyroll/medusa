...
push %rdi
push %rsi
lea addresses_D_ht+0x1bde6, %rbx
xor $4958, %r13
movw $0x6162, (%rbx)
nop
nop
cmp $61922, %rbx
lea addresses_WT_ht+0x14c86, %rcx
nop
nop
nop
nop
...
nop
xor %r15, %r15
lea addresses_A_ht+0x137e6, %rsi
lea addresses_UC_ht+0x1c28e, %rdi
nop
nop
nop
nop
...
nop
and $15018, %r10
lea addresses_D_ht+0x17566, %r10
xor %r15, %r15
movups (%r10), %xmm2
vpextrq $1, %xmm2, %rsi
nop
