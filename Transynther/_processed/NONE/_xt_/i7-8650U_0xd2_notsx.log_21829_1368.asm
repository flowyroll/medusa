...
push %rdi
push %rsi
lea addresses_WT_ht+0xf822, %r12
nop
dec %r15
movups (%r12), %xmm5
vpextrq $0, %xmm5, %rdi
...
nop
dec %r13
lea addresses_WC_ht+0x1c222, %rsi
lea addresses_A_ht+0xe1e2, %rdi
clflush (%rsi)
inc %rax
mov $97, %rcx
rep movsq
...
nop
xor %r12, %r12
lea addresses_WC_ht+0x16c42, %rsi
nop
nop
nop
add $4008, %rax
...
nop
cmp $582, %rdi
lea addresses_D_ht+0x13a22, %rsi
lea addresses_UC_ht+0x1ce22, %rdi
add %r9, %r9
mov $53, %rcx
rep movsl
nop
nop
and %rcx, %rcx
lea addresses_WT_ht+0x90db, %rcx
nop
nop
nop
nop
...
// REPMOV
lea addresses_PSE+0x1f162, %rsi
lea addresses_normal+0x1fe22, %rdi
nop
nop
nop
add %r11, %r11
...
{'OP': 'REPM', 'src': {'type': 'addresses_PSE', 'congruent': 0, 'same': False}, 'dst': {'type': 'addresses_normal', 'congruent': 11, 'same': False}}
[Faulty Load]
