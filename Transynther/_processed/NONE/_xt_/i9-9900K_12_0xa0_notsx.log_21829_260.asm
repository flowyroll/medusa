...
nop
dec %r9
lea addresses_A_ht+0x9f3e, %rsi
lea addresses_WC_ht+0x1bcd2, %rdi
nop
nop
nop
add %r12, %r12
...
nop
cmp %r15, %r15
lea addresses_WT_ht+0x2ac2, %rsi
lea addresses_WT_ht+0xc60f, %rdi
nop
nop
inc %r13
mov $18, %rcx
...
<gen_prepare_buffer>
{'OP': 'STOR', 'dst': {'type': 'addresses_D_ht', 'AVXalign': False, 'size': 16, 'NT': True, 'same': False, 'congruent': 9}}
