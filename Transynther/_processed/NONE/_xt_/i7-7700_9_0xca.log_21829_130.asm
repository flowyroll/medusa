...
push %rdi
push %rsi
lea addresses_D_ht+0x1929f, %r13
nop
nop
nop
nop
...
nop
dec %rbx
lea addresses_D_ht+0x9873, %rsi
lea addresses_A_ht+0x3bff, %rdi
clflush (%rdi)
nop
add %r11, %r11
mov $8, %rcx
rep movsq
and %r13, %r13
lea addresses_UC_ht+0x9fff, %r11
nop
nop
nop
inc %r15
...
nop
and %r8, %r8
lea addresses_WT_ht+0xcead, %r11
nop
nop
nop
nop
...
nop
add $62604, %rbx
lea addresses_A_ht+0x1536f, %rsi
nop
nop
nop
nop
...
// Faulty Load
lea addresses_normal+0x1a3ff, %r15
nop
sub $4348, %rax
mov (%r15), %rbx
lea oracles, %r10
...
<gen_prepare_buffer>
{'src': {'congruent': 4, 'AVXalign': False, 'same': True, 'size': 8, 'NT': False, 'type': 'addresses_D_ht'}, 'OP': 'LOAD'}
