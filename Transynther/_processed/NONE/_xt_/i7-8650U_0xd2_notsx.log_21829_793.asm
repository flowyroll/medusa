...
nop
cmp $20225, %r15
lea addresses_WC_ht+0x159c9, %rdx
nop
cmp $15534, %r15
movb $0x61, (%rdx)
nop
...
movb (%rdx), %al
sub %rax, %rax
lea addresses_WT_ht+0x1e1b9, %rax
nop
nop
nop
nop
...
movups %xmm3, (%rax)
xor %rax, %rax
lea addresses_WT_ht+0x4f9, %rsi
lea addresses_A_ht+0x7bd9, %rdi
clflush (%rsi)
sub $47497, %r15
mov $97, %rcx
rep movsw
xor $21013, %r12
lea addresses_D_ht+0xaf9, %rcx
nop
nop
nop
nop
...
nop
and %r12, %r12
lea addresses_UC_ht+0xb6e3, %rsi
lea addresses_WC_ht+0x15881, %rdi
nop
nop
cmp %r8, %r8
mov $24, %rcx
...
nop
mfence
lea addresses_A_ht+0x1c001, %rax
nop
nop
dec %rdi
...
{'OP': 'REPM', 'src': {'type': 'addresses_WT_ht', 'congruent': 5, 'same': True}, 'dst': {'type': 'addresses_A_ht', 'congruent': 6, 'same': False}}
{'OP': 'LOAD', 'src': {'type': 'addresses_D_ht', 'size': 2, 'AVXalign': True, 'NT': False, 'congruent': 3, 'same': False}}
