...
// REPMOV
lea addresses_WC+0x6862, %rsi
lea addresses_UC+0x4062, %rdi
clflush (%rsi)
nop
add %r10, %r10
mov $52, %rcx
...
// Faulty Load
lea addresses_normal+0xaf62, %rbx
clflush (%rbx)
xor %rdi, %rdi
movb (%rbx), %r10b
lea oracles, %rdi
...
{'dst': {'NT': True, 'AVXalign': False, 'size': 1, 'congruent': 1, 'same': False, 'type': 'addresses_A'}, 'OP': 'STOR'}
{'src': {'congruent': 4, 'same': False, 'type': 'addresses_WC'}, 'dst': {'congruent': 0, 'same': False, 'type': 'addresses_UC'}, 'OP': 'REPM'}
