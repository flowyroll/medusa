...
push %rdi
push %rsi
lea addresses_UC_ht+0x120c9, %rsi
lea addresses_WC_ht+0xe989, %rdi
nop
nop
inc %r9
mov $32, %rcx
...
nop
sub $49431, %r8
lea addresses_WC_ht+0x1a409, %rdi
nop
nop
xor %r10, %r10
movb $0x61, (%rdi)
...
nop
add $49653, %r8
lea addresses_WC_ht+0x1b609, %r10
nop
nop
sub $15412, %rax
...
nop
sub $39825, %rax
lea addresses_A_ht+0x8e09, %rsi
lea addresses_A_ht+0xd909, %rdi
nop
nop
sub $10308, %rbx
mov $120, %rcx
...
nop
xor $47000, %rcx
lea addresses_WT_ht+0xd949, %rsi
lea addresses_UC_ht+0x1e381, %rdi
nop
inc %r8
mov $22, %rcx
rep movsl
sub $26582, %r8
lea addresses_D_ht+0x29b9, %r10
and $31679, %rax
...
nop
sub %rcx, %rcx
lea addresses_WC_ht+0xe46f, %rsi
nop
nop
nop
nop
...
nop
and %rax, %rax
lea addresses_normal_ht+0xe0f9, %rbx
nop
nop
inc %r9
movw $0x6162, (%rbx)
...
// Store
lea addresses_normal+0x1c0a9, %r9
clflush (%r9)
dec %rbx
movb $0x51, (%r9)
nop
...
// Faulty Load
lea addresses_normal+0x1609, %r8
nop
nop
nop
cmp $15110, %rbx
...
{'OP': 'LOAD', 'src': {'type': 'addresses_WT', 'AVXalign': False, 'congruent': 7, 'size': 4, 'same': False, 'NT': False}}
...
{'OP': 'STOR', 'dst': {'type': 'addresses_normal', 'AVXalign': False, 'congruent': 5, 'size': 1, 'same': False, 'NT': True}}
{'OP': 'STOR', 'dst': {'type': 'addresses_WC', 'AVXalign': False, 'congruent': 7, 'size': 2, 'same': False, 'NT': True}}
[Faulty Load]
