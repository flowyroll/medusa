...
push %rdx
push %rsi
lea addresses_WT_ht+0xc87c, %rsi
lea addresses_normal_ht+0x10e94, %rdi
nop
nop
inc %rbx
mov $78, %rcx
rep movsb
sub %rdi, %rdi
lea addresses_D_ht+0x12412, %rsi
...
nop
and $56248, %rbx
lea addresses_WC_ht+0xbd04, %r12
nop
nop
nop
nop
...
nop
add %rdi, %rdi
lea addresses_normal_ht+0x16a94, %rbx
nop
nop
nop
nop
...
nop
add $57877, %rdx
lea addresses_normal_ht+0x1be94, %r12
nop
cmp $28317, %rbx
...
nop
add $3880, %rbx
lea addresses_WT_ht+0x14e94, %r12
cmp $43313, %rcx
mov $0x6162636465666768, %r15
movq %r15, (%r12)
add %rbx, %rbx
lea addresses_normal_ht+0x1c94, %rsi
lea addresses_D_ht+0x5f04, %rdi
nop
nop
cmp %r11, %r11
mov $107, %rcx
...
// Faulty Load
lea addresses_normal+0xce94, %r14
clflush (%r14)
nop
nop
cmp %r15, %r15
...
{'OP': 'REPM', 'src': {'type': 'addresses_normal_ht', 'congruent': 3, 'same': False}, 'dst': {'type': 'addresses_D_ht', 'congruent': 4, 'same': False}}
{'34': 3730}
