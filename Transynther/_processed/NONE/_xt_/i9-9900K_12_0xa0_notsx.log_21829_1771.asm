...
push %rdi
push %rsi
lea addresses_normal_ht+0x2e5c, %rsi
lea addresses_WT_ht+0xec9c, %rdi
inc %r12
mov $97, %rcx
rep movsw
nop
...
nop
cmp $13366, %r11
lea addresses_normal_ht+0x1e1dc, %r10
xor $55744, %r13
movw $0x6162, (%r10)
nop
nop
...
nop
xor $39528, %r13
lea addresses_D_ht+0x6d5c, %rsi
lea addresses_UC_ht+0xfccc, %rdi
clflush (%rsi)
nop
sub %rax, %rax
mov $12, %rcx
...
nop
and $23784, %r10
lea addresses_normal_ht+0x426d, %r12
clflush (%r12)
nop
nop
nop
...
nop
sub %rdi, %rdi
lea addresses_WC_ht+0x149dc, %rsi
lea addresses_normal_ht+0xa50d, %rdi
clflush (%rdi)
add $52540, %r11
mov $124, %rcx
rep movsb
...
nop
inc %r11
lea addresses_UC_ht+0xcbdc, %r11
sub $8838, %rdi
...
nop
inc %r13
lea addresses_normal_ht+0x96dc, %rcx
nop
nop
nop
cmp $40645, %r12
...
nop
add $25732, %rdi
lea addresses_A_ht+0x5b9c, %rsi
lea addresses_WT_ht+0x12bdc, %rdi
clflush (%rdi)
nop
nop
nop
...
nop
dec %rdi
lea addresses_UC_ht+0x14d44, %r10
nop
nop
nop
nop
...
{'src': {'type': 'addresses_D_ht', 'congruent': 6, 'same': True}, 'OP': 'REPM', 'dst': {'type': 'addresses_UC_ht', 'congruent': 3, 'same': False}}
...
{'src': {'type': 'addresses_A_ht', 'congruent': 6, 'same': False}, 'OP': 'REPM', 'dst': {'type': 'addresses_WT_ht', 'congruent': 9, 'same': True}}
