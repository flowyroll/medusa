...
push %rdi
push %rsi
lea addresses_UC_ht+0x99fb, %rcx
nop
add %rbp, %rbp
...
nop
dec %rsi
lea addresses_D_ht+0xc06f, %rsi
lea addresses_normal_ht+0x1e67f, %rdi
clflush (%rdi)
nop
nop
add $60133, %rbx
...
// Store
lea addresses_normal+0x104ef, %rdi
nop
dec %r11
movl $0x51525354, (%rdi)
nop
...
// REPMOV
lea addresses_D+0x14d1f, %rsi
lea addresses_PSE+0x48ef, %rdi
nop
nop
nop
nop
...
// Faulty Load
lea addresses_normal+0x46f, %rsi
sub $65098, %rdi
mov (%rsi), %r15
lea oracles, %rsi
and $0xff, %r15
...
{'dst': {'type': 'addresses_normal', 'same': False, 'size': 4, 'congruent': 4, 'NT': True, 'AVXalign': False}, 'OP': 'STOR'}
