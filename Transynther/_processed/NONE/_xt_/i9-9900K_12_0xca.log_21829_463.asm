...
push %rdi
push %rdx
lea addresses_UC_ht+0x6880, %rbp
nop
and %r15, %r15
...
nop
add %r8, %r8
lea addresses_WC_ht+0x10a80, %rcx
nop
sub %r12, %r12
movups (%rcx), %xmm2
vpextrq $1, %xmm2, %rdi
...
nop
dec %r12
lea addresses_WT_ht+0x12c80, %rcx
nop
nop
nop
xor $21091, %rbp
...
nop
sub %rbp, %rbp
lea addresses_A_ht+0x1ead4, %rcx
nop
nop
and $57715, %r15
mov (%rcx), %r8w
...
// Faulty Load
lea addresses_normal+0x15c80, %rax
nop
nop
nop
nop
...
<gen_prepare_buffer>
{'OP': 'LOAD', 'src': {'size': 32, 'NT': True, 'type': 'addresses_UC_ht', 'same': False, 'AVXalign': True, 'congruent': 9}}
