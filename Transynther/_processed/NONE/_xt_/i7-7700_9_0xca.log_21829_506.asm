...
nop
add %rdi, %rdi
lea addresses_UC_ht+0x70f0, %rcx
nop
nop
nop
nop
...
movntdq %xmm7, (%rcx)
cmp %rcx, %rcx
lea addresses_WC_ht+0x16cb8, %r10
nop
nop
add $32623, %rbx
movb (%r10), %r14b
...
// Faulty Load
lea addresses_normal+0x1a0b8, %rsi
nop
nop
nop
and $3904, %rbx
...
<gen_prepare_buffer>
{'src': {'congruent': 4, 'same': False, 'type': 'addresses_UC_ht'}, 'OP': 'REPM', 'dst': {'congruent': 5, 'same': False, 'type': 'addresses_normal_ht'}}
