...
push %rdx
push %rsi
lea addresses_UC_ht+0x8a72, %rsi
nop
nop
nop
nop
...
nop
cmp %r13, %r13
lea addresses_WC_ht+0x1b272, %r12
nop
nop
nop
dec %rdi
...
nop
cmp $50647, %rdx
lea addresses_WC_ht+0x1388a, %r12
nop
nop
nop
nop
...
nop
sub $42271, %r12
lea addresses_UC_ht+0x1162, %rsi
lea addresses_UC_ht+0xa382, %rdi
nop
nop
nop
nop
...
lea addresses_WT_ht+0x6162, %rdi
and $27430, %r13
mov $7, %rcx
rep movsl
sub %r12, %r12
...
{'OP': 'STOR', 'dst': {'type': 'addresses_WC_ht', 'size': 16, 'AVXalign': False, 'NT': True, 'congruent': 4, 'same': True}}
{'OP': 'REPM', 'src': {'type': 'addresses_A_ht', 'congruent': 7, 'same': False}, 'dst': {'type': 'addresses_WT_ht', 'congruent': 3, 'same': False}}
{'36': 3597}
