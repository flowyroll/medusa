...
push %rdx
push %rsi
lea addresses_D_ht+0x1a400, %rbp
add %r12, %r12
movb $0x61, (%rbp)
nop
nop
...
nop
xor %rdx, %rdx
lea addresses_normal_ht+0x4a80, %r15
nop
nop
and %rsi, %rsi
movw $0x6162, (%r15)
...
nop
sub $9489, %rdx
lea addresses_normal_ht+0x67a0, %rsi
lea addresses_UC_ht+0x13980, %rdi
nop
nop
sub %r15, %r15
mov $7, %rcx
...
nop
add %rcx, %rcx
lea addresses_D_ht+0x11d24, %r13
nop
nop
and $53041, %rsi
mov (%r13), %r14w
