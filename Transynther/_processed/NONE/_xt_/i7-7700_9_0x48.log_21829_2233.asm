...
push %rdi
push %rsi
lea addresses_WT_ht+0x2f7c, %rsi
lea addresses_WC_ht+0xd164, %rdi
nop
nop
nop
dec %r11
...
nop
add %r14, %r14
lea addresses_UC_ht+0x12364, %rsi
lea addresses_UC_ht+0x1ebc8, %rdi
nop
nop
cmp $24959, %r9
mov $22, %rcx
...
nop
add %rsi, %rsi
lea addresses_WT_ht+0x15a0c, %r9
nop
nop
nop
nop
...
nop
and %r9, %r9
lea addresses_A_ht+0x13cc4, %rsi
lea addresses_UC_ht+0x380, %rdi
nop
nop
nop
inc %r8
...
nop
cmp %r14, %r14
lea addresses_WC_ht+0x6be4, %rcx
cmp $13937, %r14
movw $0x6162, (%rcx)
nop
nop
...
// Faulty Load
lea addresses_normal+0x19164, %rsi
nop
nop
nop
nop
...
{'OP': 'STOR', 'dst': {'type': 'addresses_P', 'AVXalign': False, 'congruent': 2, 'size': 2, 'same': False, 'NT': False}}
...
<gen_prepare_buffer>
{'OP': 'REPM', 'src': {'type': 'addresses_WT_ht', 'congruent': 3, 'same': False}, 'dst': {'type': 'addresses_WC_ht', 'congruent': 11, 'same': False}}
