...
push %rdi
push %rsi
lea addresses_A_ht+0x117d9, %r10
nop
nop
inc %r13
mov (%r10), %rax
...
nop
sub %r12, %r12
lea addresses_WT_ht+0xa519, %r11
clflush (%r11)
nop
nop
nop
...
nop
inc %r13
lea addresses_WT_ht+0x10919, %r13
nop
nop
add $33973, %r15
movb (%r13), %al
...
nop
dec %r13
lea addresses_D_ht+0x15519, %rax
nop
nop
nop
sub %r11, %r11
...
nop
sub $40028, %r10
lea addresses_UC_ht+0x15419, %rsi
lea addresses_D_ht+0x9aee, %rdi
nop
nop
nop
sub %rax, %rax
...
nop
inc %r13
lea addresses_D_ht+0xb019, %rsi
lea addresses_WT_ht+0x12a59, %rdi
nop
nop
nop
nop
...
nop
cmp $48168, %r10
lea addresses_WT_ht+0xb519, %r15
nop
nop
nop
and $46499, %rbp
...
nop
xor %r10, %r10
lea addresses_normal_ht+0x6e99, %r11
clflush (%r11)
nop
nop
xor %rcx, %rcx
...
nop
dec %r10
lea addresses_UC_ht+0x1ec19, %rsi
lea addresses_normal_ht+0x14dd1, %rdi
nop
nop
nop
nop
...
nop
sub $25575, %r11
lea addresses_normal_ht+0xbe1, %rbp
nop
nop
nop
nop
...
{'OP': 'LOAD', 'src': {'type': 'addresses_D_ht', 'size': 4, 'AVXalign': False, 'NT': False, 'congruent': 8, 'same': True}}
{'OP': 'REPM', 'src': {'type': 'addresses_UC_ht', 'congruent': 10, 'same': True}, 'dst': {'type': 'addresses_D_ht', 'congruent': 0, 'same': False}}
