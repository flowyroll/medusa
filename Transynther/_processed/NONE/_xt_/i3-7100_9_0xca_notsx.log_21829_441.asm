...
nop
cmp %rsi, %rsi
lea addresses_A_ht+0x1e81b, %rcx
nop
nop
nop
nop
...
nop
inc %rcx
lea addresses_WT_ht+0x3aaf, %rsi
lea addresses_UC_ht+0x1bcaf, %rdi
nop
nop
nop
nop
...
rep movsb
cmp $13469, %r8
lea addresses_WC_ht+0x106e2, %rdx
nop
nop
nop
nop
...
movb (%rdx), %cl
cmp $32591, %r13
lea addresses_WT_ht+0x15f7f, %r9
xor %rdi, %rdi
mov (%r9), %ax
nop
nop
sub %r9, %r9
lea addresses_WC_ht+0x167af, %rsi
lea addresses_WC_ht+0x1c4af, %rdi
clflush (%rdi)
nop
xor $55732, %r8
mov $36, %rcx
...
nop
xor $46350, %rsi
lea addresses_D_ht+0xdaf, %rdi
add $50866, %rcx
vmovups (%rdi), %ymm6
vextracti128 $0, %ymm6, %xmm6
vpextrq $0, %xmm6, %r9
cmp %rcx, %rcx
lea addresses_A_ht+0x29af, %rsi
lea addresses_WC_ht+0xf9af, %rdi
nop
nop
nop
sub %rdx, %rdx
...
nop
mfence
lea addresses_WC_ht+0x16bbb, %rsi
nop
cmp $978, %r9
mov (%rsi), %edx
sub $13595, %rax
lea addresses_WC_ht+0x1bb6f, %rdi
nop
nop
nop
inc %r8
...
nop
inc %rdi
lea addresses_WC_ht+0x10af, %rsi
nop
nop
nop
nop
...
{'src': {'type': 'addresses_WC_ht', 'congruent': 11, 'same': True}, 'OP': 'REPM', 'dst': {'type': 'addresses_WC_ht', 'congruent': 4, 'same': False}}
{'src': {'same': False, 'congruent': 9, 'NT': False, 'type': 'addresses_D_ht', 'size': 32, 'AVXalign': False}, 'OP': 'LOAD'}
{'src': {'type': 'addresses_A_ht', 'congruent': 7, 'same': False}, 'OP': 'REPM', 'dst': {'type': 'addresses_WC_ht', 'congruent': 5, 'same': True}}
