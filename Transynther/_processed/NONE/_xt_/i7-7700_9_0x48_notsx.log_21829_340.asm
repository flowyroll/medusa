...
nop
cmp $60728, %r8
lea addresses_UC_ht+0x15584, %r11
nop
and $26157, %rcx
movl $0x61626364, (%r11)
nop
...
nop
sub %r8, %r8
lea addresses_A_ht+0x14bf8, %r13
nop
nop
cmp %r14, %r14
movb $0x61, (%r13)
nop
xor $50584, %r10
lea addresses_normal_ht+0xe4b8, %rax
nop
nop
cmp %r11, %r11
mov (%rax), %r8d
...
{'dst': {'same': False, 'NT': False, 'AVXalign': False, 'size': 32, 'type': 'addresses_D', 'congruent': 10}, 'OP': 'STOR'}
[Faulty Load]
...
{'dst': {'same': True, 'NT': False, 'AVXalign': False, 'size': 4, 'type': 'addresses_UC_ht', 'congruent': 2}, 'OP': 'STOR'}
