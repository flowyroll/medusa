...
push %rdi
push %rsi
lea addresses_WT_ht+0x56a7, %rax
nop
nop
nop
xor %r15, %r15
...
movb (%r15), %al
cmp $63865, %r14
lea addresses_WC_ht+0x1be27, %rsi
xor $51586, %r14
...
nop
xor $11943, %r14
lea addresses_normal_ht+0x1898f, %rsi
nop
nop
nop
nop
...
nop
inc %r14
lea addresses_WT_ht+0x1bea7, %r10
and $22927, %r14
vmovups (%r10), %ymm5
vextracti128 $1, %ymm5, %xmm5
vpextrq $0, %xmm5, %rsi
dec %r14
lea addresses_UC_ht+0xdea7, %rsi
lea addresses_D_ht+0x1d7a7, %rdi
nop
nop
xor $14848, %r8
mov $70, %rcx
...
// Faulty Load
lea addresses_normal+0x96a7, %rcx
nop
nop
nop
nop
...
{'OP': 'STOR', 'dst': {'congruent': 1, 'AVXalign': False, 'same': False, 'size': 32, 'NT': False, 'type': 'addresses_D'}}
...
{'src': {'congruent': 0, 'AVXalign': True, 'same': False, 'size': 1, 'NT': False, 'type': 'addresses_D_ht'}, 'OP': 'LOAD'}
...
{'src': {'congruent': 11, 'AVXalign': False, 'same': True, 'size': 32, 'NT': False, 'type': 'addresses_WT_ht'}, 'OP': 'LOAD'}
{'src': {'congruent': 10, 'same': True, 'type': 'addresses_UC_ht'}, 'OP': 'REPM', 'dst': {'congruent': 8, 'same': False, 'type': 'addresses_D_ht'}}
