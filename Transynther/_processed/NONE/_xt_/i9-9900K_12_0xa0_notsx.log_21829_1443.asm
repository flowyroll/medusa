...
push %rdi
push %rsi
lea addresses_normal_ht+0x15ac6, %rsi
lea addresses_WC_ht+0xbf36, %rdi
nop
sub $56076, %r14
mov $44, %rcx
rep movsb
...
nop
sub %r11, %r11
lea addresses_WT_ht+0x19ec6, %r12
nop
xor $58439, %rax
vmovups (%r12), %ymm5
...
nop
cmp $23478, %rax
lea addresses_A_ht+0x8ec6, %rsi
lea addresses_UC_ht+0x1146b, %rdi
nop
nop
xor $59690, %rbx
mov $96, %rcx
...
nop
sub $1642, %rsi
lea addresses_WT_ht+0x165ac, %r11
nop
nop
nop
xor $33011, %rsi
...
{'src': {'type': 'addresses_A_ht', 'AVXalign': False, 'size': 4, 'NT': True, 'same': False, 'congruent': 3}, 'OP': 'LOAD'}
{'33': 21829}
