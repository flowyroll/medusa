...
nop
inc %rdi
lea addresses_normal_ht+0x1eb19, %r14
nop
nop
nop
cmp %r10, %r10
...
nop
inc %r11
lea addresses_D_ht+0x10b19, %r14
clflush (%r14)
nop
nop
nop
...
nop
sub %r10, %r10
lea addresses_D_ht+0x14019, %r11
clflush (%r11)
nop
nop
nop
...
nop
dec %r14
lea addresses_WT_ht+0x13b19, %r10
nop
nop
nop
nop
...
nop
inc %r14
lea addresses_WT_ht+0x13319, %r10
and %rcx, %rcx
movl $0x61626364, (%r10)
sub %rdi, %rdi
lea addresses_A_ht+0x19f19, %rsi
lea addresses_UC_ht+0x3b19, %rdi
clflush (%rdi)
nop
nop
nop
...
nop
xor %r9, %r9
lea addresses_A_ht+0x13919, %rdi
add %r11, %r11
movups (%rdi), %xmm5
vpextrq $0, %xmm5, %r14
nop
...
nop
xor %r10, %r10
lea addresses_A_ht+0x1d0d9, %rsi
lea addresses_D_ht+0xc919, %rdi
nop
inc %r11
mov $58, %rcx
rep movsw
...
nop
cmp %r11, %r11
lea addresses_WC_ht+0x6719, %rdi
nop
nop
nop
nop
...
nop
dec %r10
lea addresses_A_ht+0x1dcf9, %rsi
...
nop
sub $24928, %rsi
lea addresses_D_ht+0x1ac12, %rsi
lea addresses_UC_ht+0x9019, %rdi
cmp $30746, %r9
mov $44, %rcx
rep movsb
nop
...
// REPMOV
lea addresses_UC+0x1cb19, %rsi
lea addresses_WT+0x1b0b9, %rdi
nop
nop
nop
nop
...
{'src': {'type': 'addresses_UC', 'congruent': 11, 'same': False}, 'OP': 'REPM', 'dst': {'type': 'addresses_WT', 'congruent': 0, 'same': False}}
[Faulty Load]
{'src': {'type': 'addresses_UC', 'AVXalign': False, 'size': 32, 'NT': False, 'same': True, 'congruent': 0}, 'OP': 'LOAD'}
<gen_prepare_buffer>
{'src': {'type': 'addresses_A_ht', 'congruent': 11, 'same': True}, 'OP': 'REPM', 'dst': {'type': 'addresses_WT_ht', 'congruent': 9, 'same': False}}
...
{'src': {'type': 'addresses_A_ht', 'congruent': 5, 'same': False}, 'OP': 'REPM', 'dst': {'type': 'addresses_D_ht', 'congruent': 8, 'same': False}}
{'OP': 'STOR', 'dst': {'type': 'addresses_WC_ht', 'AVXalign': False, 'size': 32, 'NT': False, 'same': True, 'congruent': 10}}
{'src': {'type': 'addresses_A_ht', 'congruent': 5, 'same': False}, 'OP': 'REPM', 'dst': {'type': 'addresses_A_ht', 'congruent': 5, 'same': False}}
{'src': {'type': 'addresses_D_ht', 'congruent': 0, 'same': False}, 'OP': 'REPM', 'dst': {'type': 'addresses_UC_ht', 'congruent': 8, 'same': False}}
{'37': 21829}
