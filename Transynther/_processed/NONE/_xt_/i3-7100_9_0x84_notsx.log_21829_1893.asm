...
nop
inc %r13
lea addresses_UC_ht+0x186b5, %r11
nop
add $32472, %r8
...
nop
and $1068, %r9
lea addresses_UC_ht+0x1eb5, %rbx
nop
cmp $17151, %rcx
mov (%rbx), %rbp
nop
nop
xor %r11, %r11
lea addresses_normal_ht+0x159b5, %rcx
nop
sub $27767, %r9
movb $0x61, (%rcx)
nop
...
nop
sub $65360, %rbp
lea addresses_normal_ht+0x4305, %rsi
lea addresses_WT_ht+0x4eb5, %rdi
nop
nop
nop
inc %r9
...
nop
sub %r13, %r13
lea addresses_UC_ht+0xfcb5, %rsi
nop
nop
nop
dec %r9
...
nop
sub $64499, %rbp
lea addresses_normal_ht+0x116b5, %r9
nop
add $4008, %r8
movw $0x6162, (%r9)
nop
...
nop
add $11854, %r8
lea addresses_D_ht+0x10369, %r11
nop
and $18381, %rcx
vmovups (%r11), %ymm2
...
nop
dec %rbx
lea addresses_UC_ht+0x152f5, %rsi
lea addresses_normal_ht+0x3b5, %rdi
nop
nop
nop
nop
...
{'src': {'type': 'addresses_D_ht', 'same': True, 'size': 32, 'congruent': 0, 'NT': False, 'AVXalign': False}, 'OP': 'LOAD'}
