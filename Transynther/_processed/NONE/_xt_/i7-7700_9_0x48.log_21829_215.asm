...
nop
xor %rdi, %rdi
lea addresses_UC_ht+0x11550, %rcx
nop
xor %rdi, %rdi
...
lea addresses_WC_ht+0xd750, %rdi
clflush (%rsi)
nop
nop
nop
...
nop
sub %r13, %r13
lea addresses_UC_ht+0x19150, %rsi
lea addresses_normal_ht+0xe2d0, %rdi
nop
nop
nop
sub %rbp, %rbp
...
nop
and %r13, %r13
lea addresses_WT_ht+0xa850, %rbx
nop
nop
nop
nop
...
nop
add $4376, %rdi
lea addresses_WT_ht+0x192d0, %rsi
nop
nop
nop
nop
...
mov (%rsi), %r15d
sub %r15, %r15
lea addresses_A_ht+0x810, %rsi
lea addresses_D_ht+0x980, %rdi
nop
nop
cmp $11503, %r13
mov $23, %rcx
...
nop
add %r12, %r12
lea addresses_normal_ht+0x1bc0, %rsi
lea addresses_A_ht+0x7120, %rdi
add %rbp, %rbp
mov $50, %rcx
rep movsw
nop
...
nop
cmp %rcx, %rcx
lea addresses_normal_ht+0x1dd7e, %rdi
nop
xor %r12, %r12
movb $0x61, (%rdi)
nop
...
nop
inc %rdi
lea addresses_normal_ht+0x19750, %r12
nop
nop
nop
nop
...
nop
dec %rcx
lea addresses_WC_ht+0x12250, %rsi
nop
nop
dec %rbp
...
{'OP': 'REPM', 'src': {'type': 'addresses_D_ht', 'congruent': 11, 'same': False}, 'dst': {'type': 'addresses_WT_ht', 'congruent': 3, 'same': False}}
{'OP': 'STOR', 'dst': {'type': 'addresses_UC_ht', 'AVXalign': False, 'congruent': 10, 'size': 32, 'same': False, 'NT': False}}
{'OP': 'REPM', 'src': {'type': 'addresses_D_ht', 'congruent': 5, 'same': True}, 'dst': {'type': 'addresses_WC_ht', 'congruent': 9, 'same': False}}
...
{'OP': 'STOR', 'dst': {'type': 'addresses_WC_ht', 'AVXalign': False, 'congruent': 8, 'size': 32, 'same': True, 'NT': False}}
{'32': 21829}
