...
push %rdi
push %rsi
lea addresses_UC_ht+0x1ee44, %rsi
lea addresses_A_ht+0xb644, %rdi
add %r15, %r15
mov $61, %rcx
rep movsl
nop
...
nop
xor %r8, %r8
lea addresses_WT_ht+0xb344, %rsi
lea addresses_normal_ht+0x9a44, %rdi
nop
nop
nop
nop
...
nop
sub %rsi, %rsi
lea addresses_WT_ht+0x1c80c, %rsi
inc %r10
mov (%rsi), %rcx
nop
nop
...
// Store
lea addresses_normal+0xee44, %r11
clflush (%r11)
nop
and %rbx, %rbx
mov $0x5152535455565758, %r10
...
// Faulty Load
lea addresses_normal+0x16a44, %r12
dec %rbp
movups (%r12), %xmm1
vpextrq $0, %xmm1, %rax
lea oracles, %r11
