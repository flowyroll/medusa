...
nop
sub %r14, %r14
lea addresses_WT_ht+0x7553, %rsi
lea addresses_WT_ht+0xfb33, %rdi
nop
and %rbx, %rbx
mov $81, %rcx
rep movsw
...
nop
cmp %rbx, %rbx
lea addresses_UC_ht+0x5833, %rsi
lea addresses_WC_ht+0x1943b, %rdi
nop
nop
nop
xor $54212, %rdx
...
nop
add %rdx, %rdx
lea addresses_WT_ht+0x1ccd3, %r14
nop
nop
nop
add %rdx, %rdx
...
nop
sub $62674, %rcx
lea addresses_WC_ht+0x16ec3, %rdi
cmp $64927, %rcx
mov (%rdi), %r14
cmp %rbx, %rbx
lea addresses_D_ht+0x1314b, %rax
nop
dec %r14
mov (%rax), %r8w
nop
...
nop
sub $18462, %rsi
lea addresses_D_ht+0x18c33, %rcx
nop
nop
nop
nop
...
nop
and %rdx, %rdx
lea addresses_normal_ht+0x117b3, %rsi
nop
and $24584, %rdi
vmovups (%rsi), %ymm4
...
nop
inc %r8
lea addresses_A_ht+0x14e73, %rsi
lea addresses_D_ht+0x3333, %rdi
nop
lfence
mov $63, %rcx
rep movsl
...
// Faulty Load
lea addresses_normal+0x1eb33, %rdi
nop
nop
nop
nop
