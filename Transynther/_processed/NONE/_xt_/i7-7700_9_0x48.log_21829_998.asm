...
push %rdi
push %rsi
lea addresses_A_ht+0x1d86d, %rsi
lea addresses_UC_ht+0x174ed, %rdi
clflush (%rdi)
nop
nop
add $63968, %r9
...
nop
dec %r9
lea addresses_normal_ht+0x1da6d, %rax
nop
nop
nop
and %r12, %r12
...
nop
add %r9, %r9
lea addresses_WC_ht+0x5f5d, %rcx
xor %rbx, %rbx
movw $0x6162, (%rcx)
nop
nop
...
nop
cmp %rax, %rax
lea addresses_normal_ht+0x18ad, %rdi
nop
xor $15847, %rsi
movb (%rdi), %al
nop
nop
cmp $63973, %rbx
lea addresses_UC_ht+0x1d06d, %rsi
lea addresses_A_ht+0x8a6d, %rdi
and %r15, %r15
mov $102, %rcx
rep movsl
nop
nop
xor %r12, %r12
lea addresses_WC_ht+0x11c6d, %r9
nop
xor %r15, %r15
mov (%r9), %rdi
nop
