...
push %rdx
push %rsi
lea addresses_WC_ht+0x151fb, %r15
nop
nop
xor %rdx, %rdx
mov (%r15), %di
...
nop
dec %rbx
lea addresses_normal_ht+0x1c613, %rcx
nop
nop
sub $52280, %r11
movw $0x6162, (%rcx)
...
nop
cmp $18716, %r15
lea addresses_D_ht+0x13c9b, %rsi
lea addresses_WT_ht+0xf7b9, %rdi
nop
nop
nop
nop
...
nop
sub %rax, %rax
lea addresses_normal_ht+0x1b9fb, %rsi
lea addresses_D_ht+0xf31b, %rdi
nop
nop
nop
nop
...
nop
sub $3597, %rdi
lea addresses_WC_ht+0x163cb, %r11
nop
nop
nop
add %rax, %rax
...
// Load
lea addresses_normal+0x753b, %rsi
nop
cmp $20931, %r14
mov (%rsi), %r12
add $52242, %rsi
...
{'src': {'type': 'addresses_normal', 'AVXalign': True, 'size': 8, 'NT': False, 'same': False, 'congruent': 4}, 'OP': 'LOAD'}
