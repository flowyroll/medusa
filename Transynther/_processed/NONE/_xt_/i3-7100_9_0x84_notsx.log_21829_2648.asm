...
push %rdi
push %rsi
lea addresses_normal_ht+0x9e96, %rsi
lea addresses_A_ht+0x13e96, %rdi
nop
and $9911, %r11
mov $98, %rcx
rep movsw
add %r12, %r12
lea addresses_A_ht+0x11559, %r9
nop
nop
dec %r14
...
nop
add $42071, %r11
lea addresses_WC_ht+0x52b6, %r11
nop
cmp $48030, %rdi
...
nop
dec %r12
lea addresses_WC_ht+0x11016, %rsi
lea addresses_WC_ht+0x12916, %rdi
nop
nop
nop
nop
...
rep movsw
cmp %rdi, %rdi
lea addresses_WC_ht+0x11696, %r9
nop
nop
nop
nop
...
mov (%r9), %r12
sub %r11, %r11
lea addresses_WC_ht+0x13066, %r11
nop
nop
nop
nop
...
nop
xor %r10, %r10
lea addresses_normal_ht+0x1c696, %r10
nop
nop
nop
nop
...
nop
inc %r14
lea addresses_normal_ht+0xc96, %r9
nop
nop
nop
dec %r14
...
nop
add %r12, %r12
lea addresses_WC_ht+0x3076, %rsi
...
nop
cmp %rcx, %rcx
lea addresses_UC_ht+0x1a416, %rsi
lea addresses_D_ht+0x5396, %rdi
clflush (%rsi)
nop
nop
nop
...
rep movsb
xor $12896, %r9
lea addresses_D_ht+0x18796, %rdi
clflush (%rdi)
nop
nop
nop
...
{'src': {'type': 'addresses_WC_ht', 'congruent': 6, 'same': False}, 'dst': {'type': 'addresses_WC_ht', 'congruent': 7, 'same': False}, 'OP': 'REPM'}
...
{'src': {'type': 'addresses_UC_ht', 'congruent': 5, 'same': False}, 'dst': {'type': 'addresses_D_ht', 'congruent': 5, 'same': True}, 'OP': 'REPM'}
