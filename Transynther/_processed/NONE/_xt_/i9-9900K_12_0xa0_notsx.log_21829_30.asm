...
push %rdx
push %rsi
lea addresses_normal_ht+0x4a41, %r8
nop
nop
nop
nop
...
nop
dec %r8
lea addresses_normal_ht+0x1d441, %r15
nop
nop
nop
nop
...
nop
and $22822, %r10
lea addresses_normal_ht+0x35c1, %rsi
lea addresses_A_ht+0x2441, %rdi
clflush (%rsi)
nop
nop
nop
...
nop
add $7093, %rdx
lea addresses_WC_ht+0x7e61, %rbx
nop
nop
nop
cmp $46035, %rdx
...
nop
add %rdx, %rdx
lea addresses_WT_ht+0x2e31, %rsi
and $1766, %rdx
vmovups (%rsi), %ymm6
...
lea addresses_A_ht+0x7a61, %rdi
and $19446, %rdx
mov $49, %rcx
rep movsl
nop
and $41152, %r8
lea addresses_UC_ht+0x6841, %r8
and %rbx, %rbx
movw $0x6162, (%r8)
nop
and $46754, %rdx
lea addresses_WC_ht+0x7651, %rsi
xor %rcx, %rcx
movw $0x6162, (%rsi)
nop
nop
nop
cmp $2970, %r10
lea addresses_WC_ht+0xea41, %rdx
clflush (%rdx)
nop
nop
nop
...
nop
sub $4992, %rcx
lea addresses_normal_ht+0xe0c1, %rbx
nop
nop
and $62958, %rdx
...
nop
and $52235, %rbx
lea addresses_WT_ht+0x1e041, %rsi
add $58128, %r10
movb (%rsi), %bl
nop
nop
xor %r8, %r8
lea addresses_WC_ht+0xe141, %rsi
nop
nop
nop
sub $26676, %r10
...
nop
add %r15, %r15
lea addresses_UC_ht+0x112a1, %rsi
nop
xor $53248, %r15
...
<gen_prepare_buffer>
{'src': {'type': 'addresses_normal_ht', 'AVXalign': True, 'size': 2, 'NT': True, 'same': False, 'congruent': 9}, 'OP': 'LOAD'}
...
{'src': {'type': 'addresses_A_ht', 'congruent': 2, 'same': False}, 'OP': 'REPM', 'dst': {'type': 'addresses_D_ht', 'congruent': 0, 'same': True}}
...
{'src': {'type': 'addresses_WC_ht', 'AVXalign': True, 'size': 8, 'NT': False, 'same': False, 'congruent': 6}, 'OP': 'LOAD'}
