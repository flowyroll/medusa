...
push %rcx
push %rdi
lea addresses_WT_ht+0x14718, %r15
nop
nop
nop
nop
...
vpextrq $1, %xmm0, %r13
sub $14933, %r13
lea addresses_normal_ht+0x798, %rax
nop
nop
nop
nop
...
nop
and %r11, %r11
lea addresses_D_ht+0x1da7c, %r11
nop
cmp $63766, %r10
movw $0x6162, (%r11)
sub $46876, %r13
lea addresses_D_ht+0x9956, %r13
nop
nop
dec %rax
...
{'src': {'NT': False, 'same': True, 'congruent': 0, 'type': 'addresses_A_ht', 'AVXalign': True, 'size': 2}, 'OP': 'LOAD'}
