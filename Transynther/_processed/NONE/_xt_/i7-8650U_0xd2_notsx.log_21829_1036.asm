...
movups %xmm5, (%r9)
and %rbp, %rbp
lea addresses_normal_ht+0xc817, %rbp
nop
dec %r9
mov (%rbp), %esi
nop
...
// Faulty Load
lea addresses_normal+0x1f617, %r10
nop
nop
add $31595, %rcx
movb (%r10), %r14b
