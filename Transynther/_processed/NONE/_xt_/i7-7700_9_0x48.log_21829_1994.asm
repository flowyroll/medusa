...
push %rdi
push %rsi
lea addresses_normal_ht+0xa6fa, %rsi
nop
nop
nop
add $38953, %r13
...
nop
and $11755, %rbx
lea addresses_D_ht+0x1777a, %rsi
nop
nop
nop
nop
...
nop
sub %rdi, %rdi
lea addresses_A_ht+0x18cfa, %r13
nop
nop
nop
nop
...
nop
sub %rsi, %rsi
lea addresses_UC_ht+0x59d3, %rbx
nop
nop
nop
nop
...
nop
and %r9, %r9
lea addresses_normal_ht+0x13d9a, %rbx
nop
nop
nop
nop
...
nop
and $7284, %rsi
lea addresses_normal_ht+0xd18a, %rdi
nop
nop
nop
nop
...
nop
cmp %rsi, %rsi
lea addresses_UC_ht+0x1a7fa, %r9
nop
cmp $43190, %rbx
movb $0x61, (%r9)
inc %r9
lea addresses_A_ht+0x116fa, %rdi
nop
nop
xor %r13, %r13
movw $0x6162, (%rdi)
nop
xor $6328, %r9
lea addresses_UC_ht+0xf9da, %rdi
clflush (%rdi)
nop
nop
nop
...
vpextrq $0, %xmm6, %r12
xor $46543, %rsi
lea addresses_WT_ht+0x18e02, %r13
nop
and $1349, %r9
mov (%r13), %si
sub %rdi, %rdi
lea addresses_A_ht+0x110fa, %rsi
lea addresses_A_ht+0x1d38a, %rdi
nop
nop
nop
and %rbx, %rbx
...
nop
cmp %r15, %r15
lea addresses_normal_ht+0xd7ce, %rsi
lea addresses_WC_ht+0x158fa, %rdi
xor $61402, %r13
mov $52, %rcx
rep movsq
nop
...
nop
dec %r15
lea addresses_D_ht+0x130fa, %rsi
lea addresses_UC_ht+0x14cfa, %rdi
nop
nop
nop
nop
...
nop
cmp %r15, %r15
lea addresses_UC_ht+0x14b26, %r13
nop
nop
nop
and $53205, %r15
...
// Faulty Load
lea addresses_normal+0x8efa, %rax
nop
nop
add %rdi, %rdi
movups (%rax), %xmm6
...
{'OP': 'LOAD', 'src': {'type': 'addresses_D_ht', 'AVXalign': False, 'congruent': 1, 'size': 8, 'same': True, 'NT': False}}
{'OP': 'LOAD', 'src': {'type': 'addresses_UC_ht', 'AVXalign': False, 'congruent': 0, 'size': 2, 'same': False, 'NT': False}}
{'OP': 'LOAD', 'src': {'type': 'addresses_normal_ht', 'AVXalign': False, 'congruent': 5, 'size': 8, 'same': True, 'NT': False}}
...
{'OP': 'REPM', 'src': {'type': 'addresses_normal_ht', 'congruent': 2, 'same': False}, 'dst': {'type': 'addresses_WC_ht', 'congruent': 9, 'same': False}}
{'OP': 'REPM', 'src': {'type': 'addresses_D_ht', 'congruent': 7, 'same': True}, 'dst': {'type': 'addresses_UC_ht', 'congruent': 8, 'same': False}}
