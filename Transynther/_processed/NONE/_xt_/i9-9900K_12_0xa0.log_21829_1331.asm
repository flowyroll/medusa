...
push %rdi
push %rsi
lea addresses_A_ht+0x99c2, %rsi
lea addresses_WC_ht+0x19c02, %rdi
nop
nop
and %r10, %r10
mov $111, %rcx
rep movsl
xor %rbx, %rbx
lea addresses_normal_ht+0x11612, %rsi
lea addresses_WC_ht+0x15b42, %rdi
xor %rbp, %rbp
mov $70, %rcx
rep movsl
nop
...
nop
cmp %r10, %r10
lea addresses_normal_ht+0x993a, %rsi
nop
nop
add %r11, %r11
movl $0x61626364, (%rsi)
...
nop
xor %rbp, %rbp
lea addresses_A_ht+0x9daf, %rcx
and %rsi, %rsi
movb (%rcx), %r10b
nop
nop
xor $24649, %rcx
lea addresses_normal_ht+0x6742, %rbp
nop
nop
nop
add $63351, %rsi
...
// Faulty Load
lea addresses_normal+0x1d342, %rdx
nop
sub %rbp, %rbp
mov (%rdx), %r12d
lea oracles, %rbp
