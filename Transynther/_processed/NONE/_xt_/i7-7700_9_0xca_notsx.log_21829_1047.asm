...
nop
add %rax, %rax
lea addresses_UC_ht+0x11a18, %r14
cmp %rbp, %rbp
...
nop
cmp $33263, %r13
lea addresses_WT_ht+0x2d18, %rbp
nop
nop
nop
nop
...
nop
cmp %rbp, %rbp
lea addresses_UC_ht+0xe898, %r10
add %rax, %rax
movups (%r10), %xmm3
vpextrq $0, %xmm3, %r13
nop
...
nop
dec %r10
lea addresses_normal_ht+0x16858, %rax
nop
nop
nop
nop
...
nop
xor $36181, %r10
lea addresses_D_ht+0x7fec, %rsi
nop
xor %r13, %r13
mov (%rsi), %r10d
nop
dec %rsi
lea addresses_D_ht+0x170bc, %rsi
nop
nop
nop
and %r14, %r14
...
nop
sub %r13, %r13
lea addresses_WT_ht+0x15d18, %r14
nop
sub %rax, %rax
movb (%r14), %r10b
xor %r12, %r12
lea addresses_WT_ht+0xffb8, %rsi
...
nop
xor $35791, %rdi
lea addresses_D_ht+0x10798, %r13
nop
nop
nop
sub $13959, %rdi
...
nop
inc %rcx
lea addresses_WC_ht+0x16918, %r14
clflush (%r14)
nop
nop
nop
...
{'src': {'NT': False, 'AVXalign': True, 'size': 8, 'congruent': 6, 'same': False, 'type': 'addresses_normal_ht'}, 'OP': 'LOAD'}
...
{'src': {'congruent': 5, 'same': True, 'type': 'addresses_WT_ht'}, 'dst': {'congruent': 6, 'same': False, 'type': 'addresses_A_ht'}, 'OP': 'REPM'}
{'src': {'NT': False, 'AVXalign': False, 'size': 8, 'congruent': 5, 'same': False, 'type': 'addresses_D_ht'}, 'OP': 'LOAD'}
{'src': {'NT': False, 'AVXalign': False, 'size': 8, 'congruent': 8, 'same': True, 'type': 'addresses_WC_ht'}, 'OP': 'LOAD'}
{'39': 21829}
