...
push %rdx
push %rsi
lea addresses_WC_ht+0xf2df, %r12
nop
nop
nop
nop
...
nop
and %r12, %r12
lea addresses_D_ht+0x1ee0f, %rsi
...
nop
cmp %r8, %r8
lea addresses_UC_ht+0x1cd8f, %r8
clflush (%r8)
nop
xor %rsi, %rsi
vmovups (%r8), %ymm6
...
{'src': {'type': 'addresses_D_ht', 'congruent': 5, 'same': False}, 'OP': 'REPM', 'dst': {'type': 'addresses_D_ht', 'congruent': 5, 'same': True}}
{'src': {'type': 'addresses_UC_ht', 'AVXalign': False, 'size': 32, 'NT': False, 'same': True, 'congruent': 10}, 'OP': 'LOAD'}
