...
push %rbx
push %rcx
lea addresses_normal_ht+0x15476, %r11
add $64788, %rax
mov (%r11), %r10w
nop
nop
nop
inc %r11
lea addresses_UC_ht+0x1d076, %rbp
nop
nop
nop
nop
...
mov (%rbp), %rax
xor %rcx, %rcx
lea addresses_normal_ht+0x11ff6, %r9
nop
dec %rbx
...
nop
xor %r10, %r10
lea addresses_UC_ht+0x1e839, %rcx
nop
nop
nop
nop
...
{'src': {'NT': True, 'AVXalign': False, 'size': 2, 'congruent': 0, 'same': False, 'type': 'addresses_UC_ht'}, 'OP': 'LOAD'}
{'39': 21829}
