...
push %rdx
push %rsi
lea addresses_A_ht+0x1c7b5, %rdx
nop
nop
nop
nop
...
movl $0x61626364, (%rdx)
add $16076, %rax
lea addresses_WT_ht+0x8c25, %rsi
lea addresses_A_ht+0xf305, %rdi
nop
nop
dec %r14
mov $2, %rcx
...
nop
cmp $32839, %rdx
lea addresses_WT_ht+0xe185, %rdx
nop
add %r14, %r14
movw $0x6162, (%rdx)
nop
nop
xor %r14, %r14
lea addresses_WC_ht+0x1e325, %r11
clflush (%r11)
nop
sub %rsi, %rsi
movb (%r11), %dl
...
nop
xor %rax, %rax
lea addresses_D_ht+0x1bb85, %rsi
nop
nop
nop
add %r13, %r13
movl $0x61626364, (%rsi)
sub $9128, %rcx
lea addresses_WT_ht+0x9885, %rcx
nop
nop
nop
nop
...
nop
and $35223, %r11
lea addresses_WT_ht+0x19b85, %rcx
nop
nop
nop
nop
...
nop
add $8210, %rcx
lea addresses_A_ht+0x7585, %rsi
lea addresses_UC_ht+0x2385, %rdi
nop
nop
nop
nop
...
rep movsw
add $7744, %r11
lea addresses_UC_ht+0xf0c5, %rsi
add $541, %rdi
mov (%rsi), %r11d
add %r11, %r11
lea addresses_normal_ht+0x17ae5, %rdx
nop
and %rax, %rax
movups (%rdx), %xmm7
vpextrq $1, %xmm7, %rcx
...
nop
cmp %r13, %r13
lea addresses_A_ht+0xf385, %rsi
lea addresses_normal_ht+0x6f85, %rdi
sub $2363, %r13
mov $122, %rcx
rep movsw
cmp $30542, %r14
lea addresses_UC_ht+0x15a45, %r11
nop
nop
nop
nop
...
vmovups %ymm5, (%r11)
add %rcx, %rcx
lea addresses_UC_ht+0xe985, %rsi
lea addresses_normal_ht+0x17385, %rdi
nop
nop
nop
nop
...
{'src': {'congruent': 5, 'same': False, 'type': 'addresses_WT_ht'}, 'OP': 'REPM', 'dst': {'congruent': 7, 'same': False, 'type': 'addresses_A_ht'}}
{'OP': 'STOR', 'dst': {'congruent': 9, 'AVXalign': True, 'same': False, 'size': 2, 'NT': False, 'type': 'addresses_WT_ht'}}
...
{'OP': 'STOR', 'dst': {'congruent': 11, 'AVXalign': True, 'same': False, 'size': 4, 'NT': True, 'type': 'addresses_WT_ht'}}
...
{'src': {'congruent': 9, 'same': False, 'type': 'addresses_UC_ht'}, 'OP': 'REPM', 'dst': {'congruent': 9, 'same': False, 'type': 'addresses_normal_ht'}}
{'32': 21829}
