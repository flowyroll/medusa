...
nop
add %rdi, %rdi
lea addresses_WT_ht+0x140ff, %rbx
cmp $4811, %rbp
mov (%rbx), %r11w
nop
sub %r10, %r10
lea addresses_UC_ht+0x19297, %rcx
nop
and %r11, %r11
movups (%rcx), %xmm4
vpextrq $1, %xmm4, %rdi
...
nop
cmp $32873, %r11
lea addresses_A_ht+0x149af, %r10
and $62878, %rsi
...
vpextrq $0, %xmm0, %rdi
add $64365, %rsi
lea addresses_normal_ht+0x9daf, %rsi
lea addresses_A_ht+0x164cf, %rdi
inc %rbp
mov $23, %rcx
rep movsb
nop
...
// REPMOV
lea addresses_PSE+0x10daf, %rsi
lea addresses_normal+0x192af, %rdi
nop
nop
nop
sub %r9, %r9
...
{'OP': 'REPM', 'src': {'type': 'addresses_PSE', 'congruent': 0, 'same': True}, 'dst': {'type': 'addresses_normal', 'congruent': 7, 'same': False}}
[Faulty Load]
{'OP': 'LOAD', 'src': {'type': 'addresses_PSE', 'size': 1, 'AVXalign': False, 'NT': False, 'congruent': 0, 'same': True}}
<gen_prepare_buffer>
{'OP': 'REPM', 'src': {'type': 'addresses_UC_ht', 'congruent': 8, 'same': False}, 'dst': {'type': 'addresses_UC_ht', 'congruent': 7, 'same': True}}
...
{'OP': 'LOAD', 'src': {'type': 'addresses_A_ht', 'size': 32, 'AVXalign': True, 'NT': False, 'congruent': 9, 'same': False}}
