...
push %rdx
push %rsi
lea addresses_normal_ht+0xb86a, %rsi
lea addresses_A_ht+0x91c4, %rdi
nop
nop
nop
nop
...
nop
add %r10, %r10
lea addresses_A_ht+0x14b32, %r14
nop
add %rbx, %rbx
...
nop
sub %r14, %r14
lea addresses_WC_ht+0xaf72, %rbx
nop
xor $19560, %rdi
vmovups (%rbx), %ymm6
...
nop
xor %rdi, %rdi
lea addresses_WT_ht+0x1811c, %rcx
clflush (%rcx)
nop
nop
nop
