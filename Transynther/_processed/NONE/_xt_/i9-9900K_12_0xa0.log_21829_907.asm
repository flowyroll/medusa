...
rep movsb
sub %rax, %rax
lea addresses_UC_ht+0x18dee, %rsi
lea addresses_UC_ht+0xaace, %rdi
nop
nop
nop
and %rbp, %rbp
...
nop
xor %rdi, %rdi
lea addresses_normal_ht+0x1213e, %rsi
lea addresses_A_ht+0x1410e, %rdi
xor %r8, %r8
mov $39, %rcx
rep movsw
cmp %rdi, %rdi
lea addresses_WC_ht+0x420e, %r15
nop
add %rcx, %rcx
...
nop
dec %rdi
lea addresses_UC_ht+0x1a706, %rax
nop
nop
mfence
mov $0x6162636465666768, %r9
...
nop
cmp %r8, %r8
lea addresses_normal_ht+0x19e, %r9
nop
nop
nop
cmp $25979, %r15
...
nop
dec %rcx
lea addresses_D_ht+0x14b0e, %rsi
lea addresses_UC_ht+0x1470e, %rdi
nop
nop
xor %rbp, %rbp
mov $48, %rcx
rep movsw
dec %r15
lea addresses_WT_ht+0x1b9ce, %r15
nop
nop
cmp $4015, %rcx
movl $0x61626364, (%r15)
...
// Faulty Load
lea addresses_normal+0x2b0e, %r13
xor $43638, %r12
mov (%r13), %r8d
lea oracles, %r13
and $0xff, %r8
...
{'OP': 'STOR', 'dst': {'NT': True, 'same': True, 'congruent': 5, 'type': 'addresses_WC_ht', 'AVXalign': False, 'size': 32}}
