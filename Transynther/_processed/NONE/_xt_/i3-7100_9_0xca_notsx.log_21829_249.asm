...
// REPMOV
lea addresses_D+0x71a6, %rsi
lea addresses_UC+0x11ab6, %rdi
clflush (%rdi)
add $21470, %r8
mov $102, %rcx
rep movsb
...
// Store
mov $0x44a4690000000ee6, %r8
add $2603, %rcx
movl $0x51525354, (%r8)
xor $37032, %rcx

// Load
lea addresses_PSE+0x1c9c4, %rcx
nop
add %rbx, %rbx
mov (%rcx), %edi
add %rsi, %rsi
