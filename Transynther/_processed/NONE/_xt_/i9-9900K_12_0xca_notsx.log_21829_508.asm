...
push %rdi
push %rsi
lea addresses_UC_ht+0xb137, %rsi
...
rep movsb
cmp $57882, %r8
lea addresses_UC_ht+0x17b7, %rsi
lea addresses_A_ht+0x7937, %rdi
nop
nop
and $38837, %r8
mov $1, %rcx
...
nop
and %rcx, %rcx
lea addresses_UC_ht+0xd937, %rbp
nop
nop
nop
inc %r10
...
nop
add $3080, %r9
lea addresses_D_ht+0xb337, %rsi
lea addresses_UC_ht+0x13b7, %rdi
sub %r12, %r12
mov $56, %rcx
rep movsq
nop
...
nop
and $6834, %rbp
lea addresses_UC_ht+0xc307, %rdi
nop
nop
nop
nop
...
nop
and %rdi, %rdi
lea addresses_WT_ht+0x6137, %rsi
nop
nop
nop
inc %r10
...
vpextrq $0, %xmm3, %r12
add %rdi, %rdi
lea addresses_UC_ht+0x16df7, %r8
nop
nop
nop
nop
...
nop
sub $61323, %r8
lea addresses_WT_ht+0x14137, %r12
nop
nop
nop
nop
...
// Store
lea addresses_normal+0x1ab37, %r10
nop
nop
sub $7295, %rdx
...
<gen_prepare_buffer>
{'OP': 'REPM', 'src': {'same': False, 'congruent': 11, 'type': 'addresses_UC_ht'}, 'dst': {'same': False, 'congruent': 3, 'type': 'addresses_D_ht'}}
{'OP': 'REPM', 'src': {'same': False, 'congruent': 7, 'type': 'addresses_UC_ht'}, 'dst': {'same': False, 'congruent': 10, 'type': 'addresses_A_ht'}}
...
{'OP': 'STOR', 'dst': {'same': True, 'type': 'addresses_UC_ht', 'NT': False, 'AVXalign': False, 'size': 4, 'congruent': 4}}
{'OP': 'STOR', 'dst': {'same': False, 'type': 'addresses_D_ht', 'NT': True, 'AVXalign': False, 'size': 32, 'congruent': 9}}
