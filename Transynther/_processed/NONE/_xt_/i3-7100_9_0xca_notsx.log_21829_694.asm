...
push %rdi
push %rsi
lea addresses_normal_ht+0xf64a, %r9
nop
nop
add %rbp, %rbp
movw $0x6162, (%r9)
and $51257, %r9
lea addresses_WT_ht+0x13a4a, %rbp
clflush (%rbp)
nop
nop
xor %r13, %r13
...
nop
dec %rsi
lea addresses_UC_ht+0x171e2, %rbp
nop
nop
inc %r15
...
nop
and $3418, %r13
lea addresses_normal_ht+0xe64a, %rbp
nop
nop
nop
cmp %r12, %r12
...
movups %xmm4, (%rbp)
and %r12, %r12
lea addresses_normal_ht+0x1de4a, %rsi
lea addresses_WT_ht+0x1bc4a, %rdi
nop
nop
nop
inc %rbp
...
nop
add %r9, %r9
lea addresses_UC_ht+0x424a, %rbx
clflush (%rbx)
nop
nop
cmp %rsi, %rsi
...
nop
sub $36809, %rbp
lea addresses_WT_ht+0xebaa, %rbp
nop
sub $64820, %r15
movb (%rbp), %r12b
nop
...
{'OP': 'STOR', 'dst': {'same': False, 'congruent': 2, 'NT': True, 'type': 'addresses_UC_ht', 'size': 32, 'AVXalign': False}}
