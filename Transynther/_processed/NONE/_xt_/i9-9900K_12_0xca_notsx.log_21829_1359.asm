...
push %rdx
push %rsi
lea addresses_UC_ht+0x11400, %r10
clflush (%r10)
nop
and %rdx, %rdx
mov (%r10), %rdi
...
nop
and $43970, %rbp
lea addresses_A_ht+0x1dc00, %rbp
clflush (%rbp)
nop
nop
nop
...
nop
sub $22451, %rdx
lea addresses_WT_ht+0x10420, %rbp
nop
nop
xor $3308, %rcx
movl $0x61626364, (%rbp)
...
nop
inc %rdi
lea addresses_UC_ht+0x14cc0, %r10
nop
nop
cmp %rsi, %rsi
mov (%r10), %rdi
...
nop
sub $21594, %rdi
lea addresses_A_ht+0x1a144, %rsi
lea addresses_normal_ht+0xc91a, %rdi
nop
nop
and %r11, %r11
mov $102, %rcx
...
nop
and $18359, %rdx
lea addresses_normal_ht+0x408c, %rcx
sub %r10, %r10
vmovups (%rcx), %ymm0
...
nop
and %rdx, %rdx
lea addresses_normal_ht+0x4180, %rsi
lea addresses_normal_ht+0x13200, %rdi
nop
inc %r13
mov $25, %rcx
rep movsq
...
nop
dec %rdx
lea addresses_WT_ht+0x1003a, %r13
clflush (%r13)
nop
nop
nop
...
nop
cmp $2580, %r11
lea addresses_normal_ht+0x7b1, %rdx
nop
nop
sub %rbp, %rbp
...
nop
sub %rdx, %rdx
lea addresses_WT_ht+0x17280, %rcx
nop
and %r13, %r13
movups (%rcx), %xmm7
vpextrq $1, %xmm7, %rbp
...
nop
and $3236, %r11
lea addresses_normal_ht+0x11c00, %rsi
lea addresses_UC_ht+0x1d600, %rdi
nop
nop
nop
add $30380, %r10
...
{'OP': 'REPM', 'src': {'same': False, 'congruent': 2, 'type': 'addresses_A_ht'}, 'dst': {'same': False, 'congruent': 1, 'type': 'addresses_normal_ht'}}
