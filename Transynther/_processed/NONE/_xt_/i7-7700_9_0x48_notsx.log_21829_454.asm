...
lea addresses_normal_ht+0x7c5c, %rdi
sub %rdx, %rdx
mov $93, %rcx
rep movsq
nop
...
nop
add $39526, %rbp
lea addresses_WC_ht+0x1bdd4, %rsi
nop
nop
nop
nop
...
nop
sub %rsi, %rsi
lea addresses_D_ht+0x12354, %rsi
lea addresses_normal_ht+0x13d4, %rdi
nop
nop
nop
nop
...
rep movsq
xor $53071, %rdx
lea addresses_UC_ht+0xd254, %rsi
lea addresses_normal_ht+0x15bd4, %rdi
clflush (%rdi)
nop
nop
sub $13685, %r10
...
nop
and %rdx, %rdx
lea addresses_A_ht+0x13ad4, %rbp
nop
nop
nop
nop
...
nop
add $43217, %r15
lea addresses_UC_ht+0xa6d4, %r15
nop
nop
nop
nop
...
nop
add %r10, %r10
lea addresses_WC_ht+0x14254, %rsi
lea addresses_WC_ht+0x32d4, %rdi
nop
nop
nop
nop
...
{'dst': {'same': False, 'NT': False, 'AVXalign': True, 'size': 1, 'type': 'addresses_A', 'congruent': 6}, 'OP': 'STOR'}
...
{'dst': {'same': True, 'congruent': 1, 'type': 'addresses_normal_ht'}, 'OP': 'REPM', 'src': {'same': False, 'congruent': 8, 'type': 'addresses_UC_ht'}}
{'dst': {'same': False, 'NT': False, 'AVXalign': False, 'size': 16, 'type': 'addresses_WC_ht', 'congruent': 8}, 'OP': 'STOR'}
{'dst': {'same': False, 'congruent': 4, 'type': 'addresses_normal_ht'}, 'OP': 'REPM', 'src': {'same': False, 'congruent': 7, 'type': 'addresses_D_ht'}}
{'dst': {'same': False, 'congruent': 8, 'type': 'addresses_normal_ht'}, 'OP': 'REPM', 'src': {'same': False, 'congruent': 4, 'type': 'addresses_UC_ht'}}
