...
push %rdi
push %rsi
lea addresses_D_ht+0x18f1d, %r12
nop
nop
nop
nop
...
nop
add %r11, %r11
lea addresses_D_ht+0x2edd, %rsi
lea addresses_WT_ht+0xdb1d, %rdi
nop
nop
nop
nop
...
nop
cmp %r12, %r12
lea addresses_WT_ht+0xbe7d, %r12
nop
nop
add %r14, %r14
movw $0x6162, (%r12)
...
nop
sub $54434, %rax
lea addresses_D_ht+0xb91d, %rsi
lea addresses_A_ht+0x609, %rdi
nop
nop
nop
and $39070, %r13
...
nop
xor %r12, %r12
lea addresses_WT_ht+0x1b949, %rsi
lea addresses_WT_ht+0x345d, %rdi
nop
nop
nop
nop
...
nop
add $17958, %r14
lea addresses_D_ht+0xe19d, %rcx
add $37827, %rsi
mov (%rcx), %r11d
xor %rcx, %rcx
lea addresses_D_ht+0x791d, %rcx
nop
cmp %r11, %r11
...
vpextrq $0, %xmm2, %r12
sub $7407, %r11
lea addresses_WC_ht+0x291d, %rsi
lea addresses_D_ht+0x9da9, %rdi
nop
nop
nop
and %r13, %r13
...
nop
inc %rdi
lea addresses_A_ht+0x16415, %rdi
dec %rax
...
nop
dec %rax
lea addresses_D_ht+0x551d, %rsi
lea addresses_WT_ht+0x1057d, %rdi
and %r12, %r12
mov $82, %rcx
rep movsl
nop
nop
add %r11, %r11
lea addresses_A_ht+0x1af1d, %r11
clflush (%r11)
nop
nop
nop
...
{'src': {'type': 'addresses_D_ht', 'congruent': 0, 'same': False}, 'dst': {'type': 'addresses_WT_ht', 'congruent': 8, 'same': False}, 'OP': 'REPM'}
...
{'src': {'type': 'addresses_WC_ht', 'congruent': 10, 'same': False}, 'dst': {'type': 'addresses_D_ht', 'congruent': 2, 'same': True}, 'OP': 'REPM'}
...
{'src': {'type': 'addresses_D_ht', 'congruent': 8, 'same': False}, 'dst': {'type': 'addresses_WT_ht', 'congruent': 4, 'same': False}, 'OP': 'REPM'}
