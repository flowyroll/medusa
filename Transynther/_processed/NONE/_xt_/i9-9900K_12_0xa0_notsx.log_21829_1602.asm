...
push %rdi
push %rsi
lea addresses_UC_ht+0xfa33, %rsi
lea addresses_WC_ht+0x178c2, %rdi
nop
nop
nop
nop
...
nop
xor %r15, %r15
lea addresses_WT_ht+0x2052, %rbp
nop
nop
nop
and $33545, %r13
...
nop
and $15208, %r15
lea addresses_D_ht+0x1d5d2, %r15
xor %rsi, %rsi
mov (%r15), %rcx
nop
xor %rcx, %rcx
lea addresses_WC_ht+0x11942, %rsi
clflush (%rsi)
and $44225, %r11
movups (%rsi), %xmm3
vpextrq $0, %xmm3, %r15
...
nop
add %r13, %r13
lea addresses_UC_ht+0x1ecbe, %rsi
lea addresses_UC_ht+0x11332, %rdi
nop
nop
nop
nop
...
nop
sub $57111, %rdi
lea addresses_WT_ht+0xab62, %rdi
nop
nop
nop
nop
...
nop
dec %r11
lea addresses_normal_ht+0x1c796, %rsi
lea addresses_normal_ht+0x1210, %rdi
nop
nop
nop
nop
...
nop
and %rsi, %rsi
lea addresses_WT_ht+0xc412, %r12
nop
nop
add $29147, %r15
mov (%r12), %r11d
cmp $26202, %rdi
lea addresses_normal_ht+0x11942, %r15
cmp $57682, %r13
movb (%r15), %r11b
nop
cmp %r11, %r11
lea addresses_WC_ht+0xd842, %rsi
lea addresses_A_ht+0x89ca, %rdi
nop
and $19711, %r13
mov $108, %rcx
rep movsw
...
nop
inc %rcx
lea addresses_WC_ht+0x1d142, %rsi
lea addresses_WT_ht+0x891e, %rdi
nop
nop
nop
dec %r12
...
lea addresses_normal_ht+0x11202, %rdi
add %r15, %r15
mov $23, %rcx
rep movsq
nop
...
nop
xor $7963, %r13
lea addresses_A_ht+0x114a2, %r12
nop
inc %rsi
mov (%r12), %ecx
nop
...
nop
xor %rcx, %rcx
lea addresses_D_ht+0x19fa2, %r11
clflush (%r11)
nop
nop
nop
...
nop
and $39059, %rbp
lea addresses_A_ht+0x1cd42, %rdi
clflush (%rdi)
nop
nop
nop
...
{'src': {'type': 'addresses_D_ht', 'AVXalign': False, 'size': 8, 'NT': False, 'same': True, 'congruent': 4}, 'OP': 'LOAD'}
...
{'src': {'type': 'addresses_D_ht', 'congruent': 5, 'same': True}, 'OP': 'REPM', 'dst': {'type': 'addresses_normal_ht', 'congruent': 3, 'same': False}}
