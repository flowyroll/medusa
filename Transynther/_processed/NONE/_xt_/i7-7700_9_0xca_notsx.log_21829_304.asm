...
push %rdx
push %rsi
lea addresses_normal_ht+0x621, %rcx
sub %rbx, %rbx
mov (%rcx), %esi
nop
nop
...
nop
xor $22613, %rcx
lea addresses_normal_ht+0x13921, %rsi
lea addresses_D_ht+0x1ada1, %rdi
nop
nop
nop
nop
...
nop
and $43568, %rdx
lea addresses_UC_ht+0x1ebdd, %r14
nop
nop
nop
nop
...
nop
and %rsi, %rsi
lea addresses_WT_ht+0xf2a9, %r14
nop
add %rdi, %rdi
...
nop
xor $36333, %rsi
lea addresses_WT_ht+0xb7e9, %rdx
clflush (%rdx)
nop
nop
sub %rcx, %rcx
