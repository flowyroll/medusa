...
nop
sub $13329, %r12
lea addresses_UC_ht+0x11893, %r10
nop
and $13925, %r14
movw $0x6162, (%r10)
nop
...
nop
xor %rsi, %rsi
lea addresses_WT_ht+0x101f7, %r8
nop
nop
add $5422, %rdi
mov (%r8), %si
...
nop
sub %rdi, %rdi
lea addresses_WC_ht+0xa093, %rsi
lea addresses_D_ht+0x5c93, %rdi
nop
nop
nop
sub %r10, %r10
...
rep movsw
cmp %rdi, %rdi
lea addresses_normal_ht+0x117b3, %r8
clflush (%r8)
nop
nop
nop
...
// Faulty Load
lea addresses_normal+0xb893, %r13
sub $51245, %rsi
movups (%r13), %xmm2
vpextrq $1, %xmm2, %r15
lea oracles, %r9
...
{'OP': 'STOR', 'dst': {'type': 'addresses_PSE', 'size': 8, 'AVXalign': True, 'NT': True, 'congruent': 0, 'same': False}}
[Faulty Load]
{'OP': 'LOAD', 'src': {'type': 'addresses_normal', 'size': 16, 'AVXalign': False, 'NT': False, 'congruent': 0, 'same': True}}
<gen_prepare_buffer>
{'OP': 'LOAD', 'src': {'type': 'addresses_UC_ht', 'size': 8, 'AVXalign': False, 'NT': False, 'congruent': 2, 'same': True}}
