...
push %rdi
push %rsi
lea addresses_WC_ht+0x12d23, %rsi
lea addresses_UC_ht+0x11723, %rdi
nop
nop
nop
sub %r10, %r10
...
rep movsw
xor $7437, %r8
lea addresses_WC_ht+0x1e23, %rbp
sub %rsi, %rsi
movb (%rbp), %r8b
nop
nop
...
nop
mfence
lea addresses_normal_ht+0x1d6a3, %rdi
nop
nop
nop
nop
...
movw $0x6162, (%rdi)
sub %rdi, %rdi
lea addresses_D_ht+0x1ec03, %rsi
lea addresses_WC_ht+0xa023, %rdi
nop
nop
nop
nop
...
rep movsw
sub %r11, %r11
lea addresses_WT_ht+0x9223, %rsi
nop
nop
nop
nop
...
nop
xor %rcx, %rcx
lea addresses_UC_ht+0xcb95, %rsi
nop
nop
nop
nop
...
// Faulty Load
lea addresses_normal+0x5523, %rbp
nop
nop
nop
nop
...
{'dst': {'NT': True, 'AVXalign': False, 'size': 2, 'congruent': 6, 'same': True, 'type': 'addresses_normal_ht'}, 'OP': 'STOR'}
