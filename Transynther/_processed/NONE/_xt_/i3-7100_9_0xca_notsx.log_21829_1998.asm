...
push %rdi
push %rsi
lea addresses_D_ht+0x1d0e9, %rsi
lea addresses_UC_ht+0x10815, %rdi
nop
nop
and %r9, %r9
mov $125, %rcx
...
nop
inc %r13
lea addresses_WT_ht+0x192e9, %rsi
...
nop
xor $15180, %rax
lea addresses_normal_ht+0xa1df, %r13
nop
nop
nop
dec %rbp
...
lea addresses_WC_ht+0x4269, %rdi
nop
nop
nop
cmp %rax, %rax
...
{'src': {'type': 'addresses_WT_ht', 'congruent': 9, 'same': True}, 'OP': 'REPM', 'dst': {'type': 'addresses_D_ht', 'congruent': 0, 'same': False}}
