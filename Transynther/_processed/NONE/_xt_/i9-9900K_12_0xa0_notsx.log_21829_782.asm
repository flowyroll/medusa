...
nop
xor %r11, %r11
lea addresses_WC_ht+0x1104, %rdi
nop
cmp %rdx, %rdx
mov (%rdi), %rsi
add %rdi, %rdi
lea addresses_WT_ht+0x182c2, %rdx
nop
nop
sub %r15, %r15
mov (%rdx), %ax
nop
and %rcx, %rcx
lea addresses_WC_ht+0x601c, %r11
nop
nop
nop
sub %rax, %rax
...
nop
inc %rcx
lea addresses_normal_ht+0x17104, %rsi
clflush (%rsi)
nop
cmp %r11, %r11
...
nop
sub %rdx, %rdx
lea addresses_normal_ht+0x19504, %rax
nop
nop
nop
inc %rcx
...
nop
add $59256, %r15
lea addresses_A_ht+0x17104, %rax
nop
xor %r15, %r15
movl $0x61626364, (%rax)
add %rdi, %rdi
...
<gen_prepare_buffer>
{'src': {'type': 'addresses_A_ht', 'congruent': 2, 'same': False}, 'OP': 'REPM', 'dst': {'type': 'addresses_WC_ht', 'congruent': 7, 'same': True}}
...
{'src': {'type': 'addresses_WT_ht', 'AVXalign': False, 'size': 2, 'NT': True, 'same': False, 'congruent': 1}, 'OP': 'LOAD'}
{'src': {'type': 'addresses_WC_ht', 'AVXalign': False, 'size': 4, 'NT': True, 'same': False, 'congruent': 1}, 'OP': 'LOAD'}
