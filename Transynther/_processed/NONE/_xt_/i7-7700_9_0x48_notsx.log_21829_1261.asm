...
nop
and %rbx, %rbx
lea addresses_D_ht+0x14fca, %rbp
nop
dec %r10
...
nop
inc %rbx
lea addresses_D_ht+0x1efca, %rax
nop
nop
cmp %rbp, %rbp
movw $0x6162, (%rax)
...
// REPMOV
lea addresses_A+0x1a3ca, %rsi
lea addresses_WC+0x7914, %rdi
clflush (%rdi)
nop
nop
nop
...
{'dst': {'same': False, 'congruent': 1, 'type': 'addresses_WC'}, 'OP': 'REPM', 'src': {'same': False, 'congruent': 7, 'type': 'addresses_A'}}
{'OP': 'LOAD', 'src': {'same': False, 'NT': False, 'AVXalign': False, 'size': 4, 'type': 'addresses_UC', 'congruent': 2}}
