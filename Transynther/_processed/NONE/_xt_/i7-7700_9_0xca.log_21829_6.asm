...
push %rdi
push %rsi
lea addresses_normal_ht+0x186c5, %rsi
...
nop
add %rcx, %rcx
lea addresses_WC_ht+0x1e5d5, %rcx
nop
nop
nop
nop
...
nop
sub $26861, %rdi
lea addresses_WC_ht+0xa345, %rsi
lea addresses_normal_ht+0x13a45, %rdi
nop
nop
nop
nop
...
nop
sub $50781, %r13
lea addresses_WC_ht+0x5351, %r15
nop
nop
nop
nop
...
nop
and %r13, %r13
lea addresses_D_ht+0x11445, %r15
nop
nop
nop
nop
...
vpextrq $0, %xmm3, %r13
dec %r8
lea addresses_UC_ht+0xfa45, %rsi
nop
xor $47387, %r8
...
nop
cmp %rsi, %rsi
lea addresses_normal_ht+0x26f5, %rdi
nop
nop
nop
and $36425, %r15
...
nop
inc %r8
lea addresses_WC_ht+0x3103, %r13
xor %rdi, %rdi
movl $0x61626364, (%r13)
nop
nop
nop
and $5913, %rcx
lea addresses_WC_ht+0x7845, %rsi
lea addresses_WT_ht+0x5835, %rdi
sub $21438, %r13
mov $77, %rcx
rep movsb
cmp $60760, %rbx
lea addresses_A_ht+0x1bffd, %r15
nop
nop
nop
cmp %r13, %r13
...
nop
sub $15153, %r13
lea addresses_WC_ht+0x159f5, %r15
nop
nop
lfence
mov (%r15), %r13
xor %r15, %r15
lea addresses_normal_ht+0xd445, %r15
nop
nop
nop
nop
...
{'src': {'congruent': 8, 'same': False, 'type': 'addresses_WC_ht'}, 'OP': 'REPM', 'dst': {'congruent': 11, 'same': False, 'type': 'addresses_normal_ht'}}
{'OP': 'STOR', 'dst': {'congruent': 2, 'AVXalign': False, 'same': False, 'size': 4, 'NT': False, 'type': 'addresses_WC_ht'}}
{'src': {'congruent': 8, 'AVXalign': False, 'same': True, 'size': 16, 'NT': False, 'type': 'addresses_D_ht'}, 'OP': 'LOAD'}
...
{'src': {'congruent': 8, 'same': False, 'type': 'addresses_WC_ht'}, 'OP': 'REPM', 'dst': {'congruent': 3, 'same': False, 'type': 'addresses_WT_ht'}}
