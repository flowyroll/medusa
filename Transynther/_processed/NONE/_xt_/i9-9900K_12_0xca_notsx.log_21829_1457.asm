...
push %rdx
push %rsi
lea addresses_UC_ht+0x19db3, %rsi
lea addresses_A_ht+0x50f7, %rdi
lfence
mov $58, %rcx
rep movsb
nop
...
nop
xor $57746, %rbx
lea addresses_UC_ht+0x6cd7, %rdi
nop
nop
nop
nop
...
nop
cmp %r11, %r11
lea addresses_A_ht+0x10f99, %rsi
lea addresses_normal_ht+0xf837, %rdi
clflush (%rsi)
nop
cmp $52675, %rbp
mov $108, %rcx
...
nop
add $24968, %r15
lea addresses_normal_ht+0x1edb7, %rbx
nop
nop
nop
cmp $23840, %r11
...
nop
xor %rdx, %rdx
lea addresses_WC_ht+0x179bf, %rsi
lea addresses_WT_ht+0x3fb7, %rdi
nop
nop
nop
nop
...
// Store
lea addresses_normal+0xed37, %rdx
nop
add $46082, %r9
...
<gen_prepare_buffer>
{'OP': 'REPM', 'src': {'same': False, 'congruent': 2, 'type': 'addresses_UC_ht'}, 'dst': {'same': False, 'congruent': 5, 'type': 'addresses_A_ht'}}
