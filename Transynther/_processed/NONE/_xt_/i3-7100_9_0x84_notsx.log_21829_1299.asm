...
// Load
lea addresses_normal+0x14dbd, %rax
nop
nop
nop
cmp $42931, %rsi
...
// Load
lea addresses_normal+0x1c1c4, %r8
add $58628, %r13
mov (%r8), %rax
nop
nop
...
// Store
lea addresses_normal+0x13a2c, %r8
nop
nop
and %rcx, %rcx
