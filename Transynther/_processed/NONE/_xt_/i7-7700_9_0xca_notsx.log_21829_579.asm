...
nop
xor $60513, %r13
lea addresses_WC_ht+0x178c6, %rdx
nop
nop
sub $39629, %r9
movups (%rdx), %xmm0
...
nop
and %r9, %r9
lea addresses_D_ht+0x809c, %rsi
lea addresses_WT_ht+0x19a8c, %rdi
clflush (%rdi)
nop
nop
nop
...
nop
sub %rbx, %rbx
lea addresses_WT_ht+0x47ee, %rsi
lea addresses_normal_ht+0xdb8c, %rdi
nop
nop
nop
inc %rdx
...
{'src': {'congruent': 1, 'same': True, 'type': 'addresses_WT_ht'}, 'dst': {'congruent': 10, 'same': True, 'type': 'addresses_normal_ht'}, 'OP': 'REPM'}
