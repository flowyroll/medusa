...
push %rdi
push %rsi
lea addresses_UC_ht+0x1a02, %rsi
lea addresses_UC_ht+0x163d6, %rdi
nop
nop
nop
nop
...
nop
and $1346, %rcx
lea addresses_WC_ht+0x1db76, %rsi
nop
nop
nop
cmp %rbx, %rbx
...
nop
xor %rcx, %rcx
lea addresses_WC_ht+0xc016, %rsi
nop
add $7237, %rax
mov (%rsi), %ebx
nop
...
lea addresses_A_ht+0x1ccf6, %rdi
nop
nop
nop
nop
...
nop
sub %rcx, %rcx
lea addresses_UC_ht+0x101d6, %rbx
nop
cmp $51051, %rdi
...
nop
mfence
lea addresses_WC_ht+0x1b986, %rbx
nop
nop
nop
nop
...
nop
inc %r13
lea addresses_normal_ht+0x656, %rsi
nop
nop
nop
nop
...
nop
sub %rcx, %rcx
lea addresses_normal_ht+0x1c0d6, %rbx
nop
nop
nop
nop
...
// Faulty Load
lea addresses_normal+0x1efd6, %r12
nop
nop
nop
nop
...
{'OP': 'REPM', 'src': {'same': False, 'type': 'addresses_D_ht', 'congruent': 7}, 'dst': {'same': False, 'type': 'addresses_A_ht', 'congruent': 4}}
...
{'OP': 'LOAD', 'src': {'size': 16, 'NT': False, 'type': 'addresses_WC_ht', 'same': False, 'AVXalign': True, 'congruent': 3}}
