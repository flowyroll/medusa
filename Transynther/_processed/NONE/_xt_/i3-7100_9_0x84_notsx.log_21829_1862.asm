...
push %rdi
push %rsi
lea addresses_WC_ht+0x1023c, %r9
nop
sub $7805, %r8
...
nop
add $3054, %r10
lea addresses_UC_ht+0xfd94, %rsi
lea addresses_D_ht+0x1bc7c, %rdi
nop
dec %r12
mov $59, %rcx
rep movsw
...
nop
sub $9995, %r10
lea addresses_A_ht+0x1e63c, %rdi
add $53029, %r9
mov (%rdi), %cx
nop
nop
...
nop
cmp %rdi, %rdi
lea addresses_WC_ht+0xf13c, %r10
nop
nop
nop
nop
...
nop
add %r9, %r9
lea addresses_WT_ht+0x1883c, %rsi
lea addresses_A_ht+0xd63c, %rdi
nop
nop
xor %r15, %r15
mov $60, %rcx
...
nop
add $22467, %r10
lea addresses_A_ht+0x1e23c, %r15
nop
nop
nop
dec %rcx
...
nop
cmp %r15, %r15
lea addresses_WT_ht+0x1e1fc, %rsi
nop
nop
nop
nop
...
nop
xor %rcx, %rcx
lea addresses_WC_ht+0x61ec, %rdi
xor %rsi, %rsi
mov (%rdi), %r8
nop
nop
nop
cmp %r12, %r12
lea addresses_UC_ht+0x9a5c, %r10
nop
nop
nop
nop
...
nop
dec %r12
lea addresses_UC_ht+0x12bc0, %r9
inc %rsi
movb $0x61, (%r9)
nop
nop
