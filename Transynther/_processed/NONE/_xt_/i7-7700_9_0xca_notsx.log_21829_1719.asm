...
nop
cmp %rdx, %rdx
lea addresses_WT_ht+0x4777, %rbp
nop
add $49436, %r12
mov (%rbp), %r13
nop
...
nop
and %r14, %r14
lea addresses_WC_ht+0x13af7, %r10
cmp $61467, %r14
mov $0x6162636465666768, %r13
movq %r13, %xmm2
movups %xmm2, (%r10)
and $63880, %r13
lea addresses_normal_ht+0x84a9, %rbp
nop
nop
nop
nop
...
nop
dec %r12
lea addresses_WC_ht+0xd577, %r10
xor $10178, %r11
movb (%r10), %dl
nop
and $40833, %r14
lea addresses_WC_ht+0xc777, %rsi
lea addresses_UC_ht+0x19c8a, %rdi
add $23858, %rdx
mov $65, %rcx
rep movsb
nop
...
{'src': {'congruent': 10, 'same': False, 'type': 'addresses_WC_ht'}, 'dst': {'congruent': 0, 'same': True, 'type': 'addresses_UC_ht'}, 'OP': 'REPM'}
{'35': 21829}
