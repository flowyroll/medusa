...
push %rdi
push %rdx
lea addresses_WC_ht+0xc56e, %rbp
nop
nop
nop
nop
...
nop
inc %r12
lea addresses_normal_ht+0x1b80e, %rdx
nop
nop
nop
nop
...
nop
add %r8, %r8
lea addresses_WC_ht+0xa88e, %rbp
clflush (%rbp)
nop
nop
nop
