...
nop
dec %r9
lea addresses_UC_ht+0x71a0, %r11
nop
and %r13, %r13
...
nop
and %r11, %r11
lea addresses_normal_ht+0x2650, %r9
nop
nop
nop
inc %r10
...
<gen_prepare_buffer>
{'OP': 'STOR', 'dst': {'same': True, 'congruent': 2, 'NT': False, 'type': 'addresses_D_ht', 'size': 2, 'AVXalign': False}}
