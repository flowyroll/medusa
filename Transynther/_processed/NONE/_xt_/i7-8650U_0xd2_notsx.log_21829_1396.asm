...
nop
sub $25739, %rax
lea addresses_normal_ht+0xa199, %r12
nop
nop
inc %rdi
...
vmovups %ymm7, (%r12)
and $20032, %rdi
lea addresses_A_ht+0x174d8, %rsi
lea addresses_WT_ht+0x1d1c8, %rdi
nop
xor $49213, %rbx
mov $81, %rcx
rep movsb
...
nop
xor %rax, %rax
lea addresses_A_ht+0x14814, %r12
nop
nop
nop
cmp %rdi, %rdi
...
nop
xor %rcx, %rcx
lea addresses_WC_ht+0xd618, %r12
nop
nop
nop
nop
...
movl $0x61626364, (%r12)
xor %rax, %rax
lea addresses_D_ht+0x1444c, %rsi
nop
nop
nop
nop
...
nop
inc %rcx
lea addresses_UC_ht+0xc118, %rdx
nop
nop
nop
xor %rbx, %rbx
