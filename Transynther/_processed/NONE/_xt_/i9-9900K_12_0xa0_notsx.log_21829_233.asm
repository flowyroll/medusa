...
push %rdi
push %rsi
lea addresses_WT_ht+0x13124, %rbx
nop
nop
sub $33505, %r13
movups (%rbx), %xmm0
...
nop
cmp %rdi, %rdi
lea addresses_UC_ht+0x14d24, %r12
nop
nop
and %rsi, %rsi
...
nop
sub %rsi, %rsi
lea addresses_A_ht+0x1ce74, %rax
nop
nop
nop
add %r13, %r13
...
nop
cmp $60005, %rsi
lea addresses_normal_ht+0x12a24, %rsi
lea addresses_WT_ht+0x4f24, %rdi
add $37979, %rax
mov $64, %rcx
rep movsl
nop
...
nop
sub $15219, %rax
lea addresses_UC_ht+0x17b24, %rcx
nop
nop
nop
and $62527, %rdi
