...
push %rdi
push %rsi
lea addresses_normal_ht+0x2523, %rbp
nop
nop
inc %rdi
movups (%rbp), %xmm1
...
nop
xor %rbp, %rbp
lea addresses_normal_ht+0x694b, %rsi
...
rep movsw
cmp %r9, %r9
lea addresses_WT_ht+0x1e37b, %rsi
lea addresses_WC_ht+0x1d37b, %rdi
cmp $8379, %r11
mov $12, %rcx
rep movsw
nop
...
nop
dec %rax
lea addresses_normal_ht+0x1fbb, %rsi
sub %rdi, %rdi
...
nop
dec %r9
lea addresses_A_ht+0x1997b, %rsi
lea addresses_normal_ht+0x9f33, %rdi
nop
nop
nop
nop
...
nop
sub %rcx, %rcx
lea addresses_WT_ht+0x1997b, %rax
nop
nop
nop
nop
...
// Faulty Load
lea addresses_normal+0x14b7b, %rcx
cmp $12419, %r9
movb (%rcx), %r11b
lea oracles, %r8
and $0xff, %r11
...
{'dst': {'same': False, 'congruent': 10, 'type': 'addresses_WC_ht'}, 'OP': 'REPM', 'src': {'same': False, 'congruent': 11, 'type': 'addresses_WT_ht'}}
