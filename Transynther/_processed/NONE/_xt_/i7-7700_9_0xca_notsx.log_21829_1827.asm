...
push %rdx
push %rsi
lea addresses_UC_ht+0x36ff, %r13
nop
nop
dec %r12
...
nop
and %r13, %r13
lea addresses_A_ht+0x19a6f, %rax
nop
nop
sub $47371, %rdx
movl $0x61626364, (%rax)
nop
xor $56741, %r12
lea addresses_WT_ht+0x68d7, %r13
cmp $12207, %r12
vmovups (%r13), %ymm0
...
nop
cmp $49754, %r13
lea addresses_D_ht+0x104bf, %rsi
lea addresses_A_ht+0xb457, %rdi
nop
and $42949, %r12
mov $32, %rcx
rep movsb
...
// Load
lea addresses_normal+0xa3bf, %r14
clflush (%r14)
nop
nop
nop
...
// Store
lea addresses_normal+0x845f, %r10
nop
nop
inc %r8
...
// Faulty Load
lea addresses_normal+0x15cbf, %r14
nop
nop
nop
nop
...
{'src': {'NT': False, 'AVXalign': False, 'size': 4, 'congruent': 6, 'same': False, 'type': 'addresses_normal'}, 'OP': 'LOAD'}
{'dst': {'NT': False, 'AVXalign': False, 'size': 8, 'congruent': 5, 'same': False, 'type': 'addresses_normal'}, 'OP': 'STOR'}
{'dst': {'NT': False, 'AVXalign': False, 'size': 4, 'congruent': 7, 'same': False, 'type': 'addresses_RW'}, 'OP': 'STOR'}
