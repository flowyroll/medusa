...
push %rdi
push %rsi
lea addresses_WC_ht+0xd2f0, %rsi
lea addresses_A_ht+0x7f0, %rdi
nop
add $39051, %r15
mov $58, %rcx
rep movsw
...
nop
inc %r11
lea addresses_UC_ht+0x1168, %r15
nop
nop
nop
nop
...
nop
cmp %rcx, %rcx
lea addresses_WT_ht+0x48f0, %rax
nop
nop
nop
cmp $15111, %rcx
...
nop
and %rcx, %rcx
lea addresses_D_ht+0x113f0, %rax
nop
nop
nop
nop
...
<gen_prepare_buffer>
{'OP': 'REPM', 'src': {'type': 'addresses_WC_ht', 'congruent': 9, 'same': False}, 'dst': {'type': 'addresses_A_ht', 'congruent': 8, 'same': False}}
