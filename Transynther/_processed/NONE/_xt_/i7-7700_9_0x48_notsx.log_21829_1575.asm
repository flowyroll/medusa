...
push %rdi
push %rsi
lea addresses_WC_ht+0x17953, %r12
nop
nop
nop
nop
...
nop
and %r15, %r15
lea addresses_WT_ht+0x80c7, %rsi
lea addresses_WT_ht+0xb45f, %rdi
nop
nop
nop
nop
...
nop
dec %rdi
lea addresses_normal_ht+0x5eb3, %r12
nop
nop
nop
add $55224, %rdi
...
nop
add %r14, %r14
lea addresses_UC_ht+0x109bc, %rcx
nop
nop
inc %r12
...
nop
xor $49624, %rsi
lea addresses_WT_ht+0x75b3, %r12
nop
nop
nop
nop
