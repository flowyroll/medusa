...
mov (%r10), %rdx
cmp $16854, %r14
lea addresses_WT_ht+0x2437, %r11
nop
nop
nop
nop
...
nop
xor %rbx, %rbx
lea addresses_normal_ht+0x1e2f7, %rdx
clflush (%rdx)
cmp $12570, %rbx
mov $0x6162636465666768, %r10
movq %r10, (%rdx)
add %rdx, %rdx
lea addresses_UC_ht+0x2be7, %rbx
xor $55965, %r11
movups (%rbx), %xmm1
vpextrq $1, %xmm1, %r10
sub %r10, %r10
lea addresses_WT_ht+0x19837, %rbx
nop
nop
nop
dec %r10
...
nop
sub %r11, %r11
lea addresses_WT_ht+0x4937, %rsi
lea addresses_A_ht+0xb837, %rdi
nop
nop
nop
cmp $46694, %r10
...
rep movsl
xor $33866, %rdi
lea addresses_UC_ht+0xe6d7, %rcx
nop
nop
nop
nop
...
nop
and %rdi, %rdi
lea addresses_UC_ht+0x3767, %rbx
nop
xor $42307, %r13
movb (%rbx), %dl
nop
...
nop
sub %rdi, %rdi
lea addresses_D_ht+0x1e227, %rcx
nop
nop
nop
dec %r14
...
nop
sub $31090, %r14
lea addresses_WT_ht+0x3737, %r13
nop
nop
nop
xor $32791, %rsi
...
nop
and $62367, %rdx
lea addresses_WC_ht+0x1d437, %rsi
lea addresses_A_ht+0xec37, %rdi
nop
nop
cmp %rdx, %rdx
mov $64, %rcx
...
nop
dec %rdx
lea addresses_UC_ht+0x1bc37, %r14
nop
nop
nop
nop
...
// Faulty Load
lea addresses_normal+0xd837, %rbx
nop
nop
nop
add $3559, %rcx
...
{'src': {'same': False, 'congruent': 9, 'NT': True, 'type': 'addresses_WC', 'size': 16, 'AVXalign': False}, 'OP': 'LOAD'}
{'OP': 'STOR', 'dst': {'same': False, 'congruent': 0, 'NT': False, 'type': 'addresses_RW', 'size': 1, 'AVXalign': False}}
{'OP': 'STOR', 'dst': {'same': False, 'congruent': 1, 'NT': True, 'type': 'addresses_D', 'size': 8, 'AVXalign': False}}
...
{'OP': 'STOR', 'dst': {'same': True, 'congruent': 9, 'NT': False, 'type': 'addresses_WT_ht', 'size': 16, 'AVXalign': False}}
...
{'src': {'type': 'addresses_WT_ht', 'congruent': 7, 'same': True}, 'OP': 'REPM', 'dst': {'type': 'addresses_A_ht', 'congruent': 11, 'same': False}}
