...
push %rdi
push %rsi
lea addresses_D_ht+0x13418, %rbx
nop
nop
nop
add %r9, %r9
...
nop
and $33100, %r9
lea addresses_WC_ht+0x17fb4, %rbp
clflush (%rbp)
nop
sub %r15, %r15
vmovups (%rbp), %ymm3
...
nop
cmp $63764, %r15
lea addresses_WT_ht+0x1bc18, %r9
nop
nop
nop
nop
...
nop
xor $8346, %r9
lea addresses_UC_ht+0x16418, %rsi
...
nop
cmp $9, %rsi
lea addresses_WT_ht+0xac18, %rsi
lea addresses_UC_ht+0x1c1f0, %rdi
clflush (%rdi)
nop
nop
nop
...
nop
inc %rbp
lea addresses_UC_ht+0xb994, %r15
nop
nop
inc %rdi
...
nop
sub %rdi, %rdi
lea addresses_A_ht+0x16518, %rsi
lea addresses_D_ht+0x5c18, %rdi
xor $48781, %r9
mov $105, %rcx
rep movsq
nop
xor $20030, %r13
lea addresses_WT_ht+0x10d58, %r15
nop
nop
nop
nop
...
mov (%r15), %r9w
xor %r12, %r12
lea addresses_WT_ht+0x1a958, %rsi
nop
nop
nop
dec %r13
...
nop
inc %rbx
lea addresses_D_ht+0x12870, %rsi
lea addresses_WC_ht+0x1c758, %rdi
nop
nop
nop
nop
...
{'src': {'type': 'addresses_UC_ht', 'congruent': 11, 'same': False}, 'dst': {'type': 'addresses_WT_ht', 'congruent': 5, 'same': True}, 'OP': 'REPM'}
...
{'src': {'type': 'addresses_A_ht', 'congruent': 8, 'same': True}, 'dst': {'type': 'addresses_D_ht', 'congruent': 10, 'same': False}, 'OP': 'REPM'}
...
{'src': {'type': 'addresses_D_ht', 'congruent': 3, 'same': False}, 'dst': {'type': 'addresses_WC_ht', 'congruent': 0, 'same': True}, 'OP': 'REPM'}
{'38': 21829}
