...
push %rdx
push %rsi
lea addresses_A_ht+0x14f7e, %r13
nop
nop
nop
nop
...
nop
inc %rdx
lea addresses_D_ht+0xe9fe, %rcx
add $41988, %rdx
movw $0x6162, (%rcx)
xor $28642, %r9
lea addresses_A_ht+0x467e, %r14
nop
nop
nop
nop
...
nop
dec %r13
lea addresses_WT_ht+0x1597e, %r14
xor $44042, %rbp
...
nop
dec %r14
lea addresses_UC_ht+0x73fe, %rcx
nop
nop
nop
nop
...
nop
add $17333, %rcx
lea addresses_WC_ht+0x267e, %rsi
lea addresses_normal_ht+0x1bc7e, %rdi
clflush (%rdi)
nop
nop
nop
...
nop
and $12908, %r13
lea addresses_WC_ht+0xaf7e, %rcx
nop
nop
nop
xor %r13, %r13
...
nop
add %rcx, %rcx
lea addresses_WC_ht+0x1607e, %rdi
nop
nop
cmp %r13, %r13
vmovups (%rdi), %ymm7
...
nop
add %r10, %r10
lea addresses_UC_ht+0xe47e, %rdi
nop
nop
nop
cmp $37720, %r14
...
vpextrq $0, %xmm7, %r9
and $15723, %r9
lea addresses_UC_ht+0xfafa, %rsi
lea addresses_A_ht+0x15c7e, %rdi
clflush (%rdi)
nop
nop
inc %r10
...
nop
inc %rdx
lea addresses_A_ht+0x1917e, %rsi
lea addresses_D_ht+0x1d074, %rdi
nop
nop
nop
add %rdx, %rdx
...
// Faulty Load
lea addresses_normal+0x407e, %r8
nop
cmp %r11, %r11
movb (%r8), %bl
lea oracles, %r11
...
{'src': {'same': False, 'congruent': 8, 'type': 'addresses_WC_ht'}, 'OP': 'REPM', 'dst': {'same': False, 'congruent': 10, 'type': 'addresses_normal_ht'}}
