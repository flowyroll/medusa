...
push %rdi
push %rsi
lea addresses_WT_ht+0x102d6, %r12
nop
inc %rsi
movl $0x61626364, (%r12)
nop
...
nop
sub $32207, %r13
lea addresses_D_ht+0x1d943, %rsi
lea addresses_UC_ht+0xdf43, %rdi
nop
nop
sub %r13, %r13
mov $9, %rcx
...
nop
cmp $63004, %rdi
lea addresses_UC_ht+0x5d43, %rdi
nop
sub $43067, %r12
...
nop
dec %r12
lea addresses_A_ht+0x1a543, %rsi
lea addresses_UC_ht+0x14733, %rdi
nop
and $57425, %r8
mov $25, %rcx
rep movsw
...
nop
sub $47701, %rsi
lea addresses_UC_ht+0x1cc43, %r13
clflush (%r13)
sub %r12, %r12
...
nop
and %r8, %r8
lea addresses_normal_ht+0x1b743, %rcx
nop
nop
nop
nop
...
vpextrq $0, %xmm5, %rsi
and %rcx, %rcx
lea addresses_A_ht+0x1375b, %rsi
lea addresses_A_ht+0x30b3, %rdi
nop
and %rax, %rax
mov $59, %rcx
rep movsb
...
{'src': {'type': 'addresses_A_ht', 'congruent': 7, 'same': True}, 'OP': 'REPM', 'dst': {'type': 'addresses_UC_ht', 'congruent': 3, 'same': False}}
{'OP': 'STOR', 'dst': {'same': True, 'congruent': 8, 'NT': False, 'type': 'addresses_UC_ht', 'size': 16, 'AVXalign': False}}
