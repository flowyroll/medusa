...
push %rdx
push %rsi
lea addresses_UC_ht+0x1784, %rsi
nop
nop
add $23152, %rax
movb $0x61, (%rsi)
...
nop
sub %r8, %r8
lea addresses_UC_ht+0xf544, %rsi
lea addresses_A_ht+0xd504, %rdi
nop
nop
dec %rbp
mov $48, %rcx
rep movsw
dec %rbp
lea addresses_WC_ht+0xf7c4, %rsi
and $2442, %rax
mov (%rsi), %r14d
nop
nop
nop
add $53861, %rcx
lea addresses_D_ht+0x123c4, %rsi
lea addresses_D_ht+0x1bbc4, %rdi
clflush (%rdi)
nop
nop
nop
...
lea addresses_normal_ht+0x103c4, %rdi
nop
nop
nop
cmp $39262, %r14
...
nop
cmp $658, %rbp
lea addresses_A_ht+0x1c584, %r14
nop
xor %rbp, %rbp
...
nop
sub %rdx, %rdx
lea addresses_A_ht+0x10b24, %rdi
nop
nop
nop
xor $14096, %rax
...
vpextrq $0, %xmm7, %rdx
sub %r8, %r8
lea addresses_normal_ht+0xfa06, %r14
nop
nop
nop
nop
...
nop
inc %r8
lea addresses_UC_ht+0x141c4, %r14
sub %rbp, %rbp
...
// Faulty Load
lea addresses_normal+0x19fc4, %rcx
nop
nop
cmp %rdi, %rdi
mov (%rcx), %r13
...
{'OP': 'STOR', 'dst': {'type': 'addresses_D_ht', 'AVXalign': False, 'congruent': 8, 'size': 4, 'same': True, 'NT': False}}
...
{'OP': 'REPM', 'src': {'type': 'addresses_D_ht', 'congruent': 6, 'same': False}, 'dst': {'type': 'addresses_D_ht', 'congruent': 10, 'same': False}}
