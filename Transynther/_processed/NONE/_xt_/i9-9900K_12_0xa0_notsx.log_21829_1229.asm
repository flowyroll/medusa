...
push %rdx
push %rsi
lea addresses_WC_ht+0xf472, %rsi
lea addresses_normal_ht+0x1ca72, %rdi
nop
nop
and %r11, %r11
mov $126, %rcx
...
nop
and %rax, %rax
lea addresses_D_ht+0xfa72, %rsi
lea addresses_WT_ht+0xc560, %rdi
and %rdx, %rdx
mov $3, %rcx
rep movsw
nop
...
nop
cmp $21966, %rcx
lea addresses_UC_ht+0x1b4d1, %rax
nop
nop
nop
nop
...
nop
xor $44614, %rsi
lea addresses_normal_ht+0x1d272, %rdx
nop
nop
nop
add %rdi, %rdi
...
<gen_prepare_buffer>
{'src': {'type': 'addresses_WC_ht', 'congruent': 8, 'same': True}, 'OP': 'REPM', 'dst': {'type': 'addresses_normal_ht', 'congruent': 10, 'same': True}}
