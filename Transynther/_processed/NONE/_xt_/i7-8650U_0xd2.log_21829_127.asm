...
nop
cmp $48539, %rax
lea addresses_A_ht+0x17b70, %rdi
nop
nop
add $47998, %rax
movl $0x61626364, (%rdi)
xor $11401, %rcx
lea addresses_WC_ht+0x5170, %r11
nop
xor %rsi, %rsi
movb $0x61, (%r11)
add $17123, %r11
