...
push %rdx
push %rsi
lea addresses_UC_ht+0x3c7b, %rbx
nop
nop
nop
nop
...
nop
sub %rbx, %rbx
lea addresses_WC_ht+0x187b, %rdi
nop
xor $4523, %r11
movb (%rdi), %r15b
inc %r11
lea addresses_A_ht+0x1d87b, %rsi
lea addresses_D_ht+0x643b, %rdi
nop
nop
nop
cmp $32423, %rbx
...
nop
add $56981, %rdi
lea addresses_WC_ht+0x5c7b, %rbx
nop
nop
nop
nop
...
nop
sub $33249, %r15
lea addresses_UC_ht+0x277b, %rdx
nop
and %r15, %r15
...
nop
cmp %rdi, %rdi
lea addresses_WT_ht+0x15847, %r12
nop
nop
xor $38043, %rsi
vmovups (%r12), %ymm1
...
nop
xor %rbx, %rbx
lea addresses_UC_ht+0x2b2f, %rsi
lea addresses_WT_ht+0xf313, %rdi
nop
nop
nop
cmp $50564, %rbx
...
nop
and $63946, %r15
lea addresses_UC_ht+0x2c7b, %rsi
nop
nop
nop
nop
...
nop
and %rsi, %rsi
lea addresses_WC_ht+0x16391, %rsi
lea addresses_WC_ht+0xdf3b, %rdi
nop
nop
nop
nop
...
nop
xor %rdi, %rdi
lea addresses_normal_ht+0x10d7b, %r11
add %r15, %r15
mov $0x6162636465666768, %rcx
movq %rcx, %xmm1
movups %xmm1, (%r11)
xor %rbx, %rbx
lea addresses_WC_ht+0x1b27b, %rsi
lea addresses_UC_ht+0x1af7b, %rdi
nop
nop
nop
sub $25946, %r11
...
nop
inc %rsi
lea addresses_normal_ht+0xea7b, %r11
nop
nop
nop
nop
...
// Faulty Load
lea addresses_normal+0x14c7b, %r13
nop
dec %r12
mov (%r13), %cx
lea oracles, %rax
...
{'src': {'NT': False, 'AVXalign': False, 'size': 8, 'congruent': 1, 'same': False, 'type': 'addresses_P'}, 'OP': 'LOAD'}
...
{'src': {'NT': False, 'AVXalign': False, 'size': 8, 'congruent': 11, 'same': True, 'type': 'addresses_UC_ht'}, 'OP': 'LOAD'}
{'src': {'congruent': 1, 'same': False, 'type': 'addresses_WC_ht'}, 'dst': {'congruent': 5, 'same': False, 'type': 'addresses_WC_ht'}, 'OP': 'REPM'}
{'dst': {'NT': False, 'AVXalign': False, 'size': 16, 'congruent': 7, 'same': False, 'type': 'addresses_normal_ht'}, 'OP': 'STOR'}
{'src': {'congruent': 9, 'same': False, 'type': 'addresses_WC_ht'}, 'dst': {'congruent': 7, 'same': False, 'type': 'addresses_UC_ht'}, 'OP': 'REPM'}
