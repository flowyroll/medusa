...
push %rdi
push %rsi
lea addresses_UC_ht+0x1bddf, %rsi
lea addresses_UC_ht+0x15ddf, %rdi
sub %r9, %r9
mov $99, %rcx
rep movsb
nop
...
nop
sub %rdi, %rdi
lea addresses_WT_ht+0x1a92f, %r14
nop
nop
nop
nop
...
vpextrq $0, %xmm5, %rcx
add $23863, %r14
lea addresses_UC_ht+0x1b5df, %rbp
nop
cmp %r13, %r13
movw $0x6162, (%rbp)
nop
...
nop
cmp %rbp, %rbp
lea addresses_A_ht+0x19cdf, %rbp
nop
nop
nop
nop
...
nop
lfence
lea addresses_UC_ht+0x131f, %rsi
lea addresses_normal_ht+0x13217, %rdi
nop
nop
nop
sub %rax, %rax
...
nop
xor %r14, %r14
lea addresses_UC_ht+0x53df, %r13
nop
nop
nop
nop
...
// Faulty Load
lea addresses_normal+0x89df, %r15
nop
and %r14, %r14
movb (%r15), %r9b
lea oracles, %rcx
...
{'OP': 'STOR', 'dst': {'same': True, 'type': 'addresses_A_ht', 'NT': False, 'AVXalign': False, 'size': 4, 'congruent': 6}}
