...
lea addresses_WT_ht+0x1cdaa, %rdi
sub $41782, %rbp
mov $71, %rcx
rep movsw
nop
...
lea addresses_WT_ht+0x1b03a, %rdi
nop
nop
nop
nop
...
nop
xor %rsi, %rsi
lea addresses_D_ht+0x120ea, %rax
nop
add $44748, %rcx
...
nop
sub $53564, %rbp
lea addresses_WC_ht+0x490a, %rdi
nop
nop
nop
nop
...
vmovups %ymm2, (%rdi)
cmp %r13, %r13
lea addresses_WC_ht+0x162ea, %rsi
lea addresses_D_ht+0x1c7ea, %rdi
clflush (%rdi)
nop
nop
nop
...
nop
inc %r14
lea addresses_D_ht+0x133ea, %rcx
nop
nop
nop
nop
...
nop
add $14635, %rcx
lea addresses_UC_ht+0x709a, %rsi
lea addresses_WC_ht+0x1a45a, %rdi
nop
nop
nop
nop
...
nop
xor $50806, %rdi
lea addresses_normal_ht+0x1e0ea, %rsi
nop
nop
nop
xor $34493, %rbp
...
{'src': {'type': 'addresses_UC_ht', 'congruent': 4, 'same': False}, 'dst': {'type': 'addresses_WC_ht', 'congruent': 4, 'same': False}, 'OP': 'REPM'}
