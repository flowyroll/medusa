...
push %rcx
push %rdx
lea addresses_WT_ht+0x7d31, %r11
nop
nop
nop
nop
...
nop
add %r13, %r13
lea addresses_WC_ht+0xbfd9, %r12
nop
and %r15, %r15
movups (%r12), %xmm4
vpextrq $0, %xmm4, %rdx
...
nop
cmp %r15, %r15
lea addresses_normal_ht+0x159d9, %rax
nop
nop
cmp $51317, %r13
...
movups %xmm2, (%rax)
and %r13, %r13
lea addresses_WC_ht+0xd9d9, %rax
and %rcx, %rcx
movb (%rax), %r12b
nop
nop
...
nop
lfence
lea addresses_normal_ht+0x10319, %rdx
nop
nop
nop
nop
...
nop
sub %rcx, %rcx
lea addresses_WT_ht+0xe6d9, %r15
nop
nop
cmp %r12, %r12
movb (%r15), %r11b
...
{'OP': 'STOR', 'dst': {'type': 'addresses_D_ht', 'size': 2, 'AVXalign': False, 'NT': False, 'congruent': 1, 'same': True}}
...
{'OP': 'LOAD', 'src': {'type': 'addresses_WT_ht', 'size': 1, 'AVXalign': True, 'NT': True, 'congruent': 6, 'same': False}}
{'36': 21829}
