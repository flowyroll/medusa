...
push %rdi
push %rsi
lea addresses_normal_ht+0x120e2, %rsi
lea addresses_normal_ht+0xe9ba, %rdi
nop
nop
nop
nop
...
nop
cmp $60120, %rsi
lea addresses_normal_ht+0x1b38f, %r15
nop
nop
nop
nop
...
nop
add %rcx, %rcx
lea addresses_WT_ht+0x14ac2, %rbp
nop
nop
nop
cmp %r8, %r8
...
nop
add $60342, %r8
lea addresses_A_ht+0x1bae2, %rsi
nop
nop
and %r8, %r8
mov (%rsi), %r12
dec %rsi
lea addresses_WT_ht+0xe47a, %rdi
nop
add $16443, %r15
movups (%rdi), %xmm6
vpextrq $1, %xmm6, %r12
...
nop
inc %rcx
lea addresses_WT_ht+0x68e2, %rsi
nop
nop
nop
xor %rbp, %rbp
...
nop
sub $29246, %rcx
lea addresses_WC_ht+0x32b6, %rsi
lea addresses_D_ht+0x16082, %rdi
clflush (%rdi)
xor $41664, %r14
mov $39, %rcx
rep movsb
...
nop
cmp %r14, %r14
lea addresses_D_ht+0xe102, %r12
clflush (%r12)
sub $22352, %r15
mov (%r12), %rbp
nop
add $24106, %rdi
lea addresses_WT_ht+0x58e2, %rbp
nop
xor $49108, %r12
movb $0x61, (%rbp)
nop
nop
inc %r15
lea addresses_D_ht+0x1e6e2, %rsi
lea addresses_normal_ht+0x16dd, %rdi
nop
nop
nop
nop
...
nop
add $46111, %rbp
lea addresses_WT_ht+0x190e2, %rsi
lea addresses_UC_ht+0xba36, %rdi
nop
nop
nop
nop
...
// Load
lea addresses_normal+0x138e2, %r15
nop
nop
nop
nop
...
// Faulty Load
lea addresses_normal+0x138e2, %r12
nop
nop
nop
nop
...
{'OP': 'LOAD', 'src': {'same': True, 'type': 'addresses_WT_ht', 'NT': False, 'AVXalign': False, 'size': 16, 'congruent': 3}}
...
{'OP': 'REPM', 'src': {'same': False, 'congruent': 8, 'type': 'addresses_WT_ht'}, 'dst': {'same': False, 'congruent': 1, 'type': 'addresses_UC_ht'}}
