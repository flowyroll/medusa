...
push %rdi
push %rsi
lea addresses_WT_ht+0x19780, %rbp
clflush (%rbp)
nop
nop
nop
...
nop
add $10115, %rax
lea addresses_normal_ht+0x3c94, %r13
nop
nop
nop
mfence
...
nop
cmp %rax, %rax
lea addresses_normal_ht+0x10f8c, %r13
nop
nop
nop
nop
...
nop
cmp $14914, %r13
lea addresses_WC_ht+0xed80, %r11
mfence
vmovups (%r11), %ymm2
...
vpextrq $1, %xmm0, %r14
xor %r14, %r14
lea addresses_A_ht+0x13580, %rsi
nop
nop
nop
and %r11, %r11
...
nop
and $65119, %rsi
lea addresses_normal_ht+0x112dc, %r13
nop
nop
nop
nop
...
nop
lfence
lea addresses_D_ht+0x1dc80, %r11
nop
nop
nop
add %rdi, %rdi
...
nop
mfence
lea addresses_UC_ht+0x11124, %rsi
nop
nop
xor $33397, %r14
movw $0x6162, (%rsi)
...
// Faulty Load
lea addresses_normal+0xb180, %rdx
nop
nop
cmp $37951, %rax
mov (%rdx), %r11w
...
{'OP': 'STOR', 'dst': {'type': 'addresses_US', 'size': 1, 'AVXalign': False, 'NT': True, 'congruent': 7, 'same': False}}
[Faulty Load]
