...
nop
inc %rbx
lea addresses_WC_ht+0x1a2a2, %rcx
nop
nop
xor $29638, %rbx
movl $0x61626364, (%rcx)
...
nop
and %rcx, %rcx
lea addresses_normal_ht+0xbb12, %rbx
nop
nop
nop
nop
...
nop
sub %r13, %r13
lea addresses_normal_ht+0x19aa2, %rdi
nop
nop
cmp %r9, %r9
movw $0x6162, (%rdi)
...
nop
xor %rdi, %rdi
lea addresses_WT_ht+0x12d12, %rcx
nop
nop
nop
inc %r12
...
nop
xor %rdi, %rdi
lea addresses_normal_ht+0x66d2, %rsi
lea addresses_WC_ht+0x3a92, %rdi
inc %r13
mov $105, %rcx
rep movsb
nop
...
nop
sub %rsi, %rsi
lea addresses_D_ht+0x34c9, %rsi
lea addresses_WC_ht+0x1292, %rdi
nop
nop
cmp %r14, %r14
mov $63, %rcx
...
nop
cmp %r9, %r9
lea addresses_D_ht+0x1c37d, %r12
nop
nop
nop
nop
...
nop
add $7125, %r12
lea addresses_UC_ht+0x3f9a, %rdi
sub %rbx, %rbx
...
{'OP': 'STOR', 'dst': {'congruent': 4, 'AVXalign': True, 'same': False, 'size': 4, 'NT': True, 'type': 'addresses_WC_ht'}}
...
{'src': {'congruent': 5, 'AVXalign': False, 'same': True, 'size': 16, 'NT': False, 'type': 'addresses_A_ht'}, 'OP': 'LOAD'}
