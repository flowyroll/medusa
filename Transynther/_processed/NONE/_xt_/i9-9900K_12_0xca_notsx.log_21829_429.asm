...
push %rdi
push %rsi
lea addresses_WC_ht+0xea78, %rsi
lea addresses_WC_ht+0x8bb0, %rdi
clflush (%rsi)
inc %rbp
mov $109, %rcx
rep movsb
...
nop
and %r8, %r8
lea addresses_normal_ht+0xffb0, %r9
nop
nop
nop
nop
...
movb (%r9), %r8b
add $16444, %rbp
lea addresses_normal_ht+0x163b0, %rdi
and $12935, %r14
...
nop
sub %rcx, %rcx
lea addresses_WC_ht+0x17ad0, %r9
nop
nop
nop
nop
...
movb (%rcx), %r8b
add %r14, %r14
lea addresses_WC_ht+0x4eb8, %rsi
nop
nop
nop
nop
...
<gen_prepare_buffer>
{'OP': 'REPM', 'src': {'same': False, 'congruent': 3, 'type': 'addresses_WC_ht'}, 'dst': {'same': False, 'congruent': 11, 'type': 'addresses_WC_ht'}}
...
{'OP': 'REPM', 'src': {'same': False, 'congruent': 5, 'type': 'addresses_UC_ht'}, 'dst': {'same': False, 'congruent': 2, 'type': 'addresses_D_ht'}}
{'33': 21829}
