...
push %rdi
push %rsi
lea addresses_A_ht+0x18fa6, %rsi
lea addresses_normal_ht+0x144e6, %rdi
clflush (%rsi)
dec %r8
mov $69, %rcx
rep movsl
...
nop
cmp %r10, %r10
lea addresses_normal_ht+0xb426, %rsi
...
rep movsl
add %rcx, %rcx
lea addresses_UC_ht+0x16526, %rdi
clflush (%rdi)
nop
nop
nop
...
nop
sub %rsi, %rsi
lea addresses_A_ht+0x11c08, %r15
nop
nop
nop
and $19710, %r13
...
nop
add %r8, %r8
lea addresses_D_ht+0x18182, %rsi
nop
inc %r10
vmovups (%rsi), %ymm3
...
nop
dec %rsi
lea addresses_UC_ht+0x13ae6, %r13
nop
nop
nop
sub %rdi, %rdi
...
nop
xor %r8, %r8
lea addresses_D_ht+0x10c2e, %r15
nop
nop
and %rdi, %rdi
...
<gen_prepare_buffer>
{'OP': 'REPM', 'src': {'type': 'addresses_A_ht', 'congruent': 10, 'same': False}, 'dst': {'type': 'addresses_normal_ht', 'congruent': 6, 'same': False}}
