...
nop
and $57243, %r10
lea addresses_WT_ht+0x1ee5d, %rsi
nop
nop
nop
add %rbx, %rbx
...
nop
and $62579, %rbx
lea addresses_UC_ht+0x1c29, %r15
nop
nop
nop
sub $8812, %r8
...
nop
and %rdx, %rdx
lea addresses_WC_ht+0x197ec, %rbx
nop
nop
nop
nop
...
nop
add %rbx, %rbx
lea addresses_A_ht+0x1d1b1, %rsi
lea addresses_WC_ht+0x7875, %rdi
clflush (%rsi)
nop
cmp $24136, %rbx
mov $8, %rcx
...
// Faulty Load
lea addresses_normal+0x15d31, %r9
nop
nop
nop
nop
