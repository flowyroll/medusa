...
push %rdi
push %rsi
lea addresses_WC_ht+0x9de1, %r14
nop
nop
add %r13, %r13
mov (%r14), %r10
...
vpextrq $1, %xmm2, %r9
xor $30377, %r9
lea addresses_WT_ht+0xdfa9, %rsi
lea addresses_WT_ht+0x14ae9, %rdi
nop
xor $43008, %r14
mov $11, %rcx
rep movsq
...
// REPMOV
lea addresses_RW+0x16da9, %rsi
lea addresses_A+0x60f3, %rdi
nop
nop
nop
nop
...
{'dst': {'same': False, 'congruent': 0, 'type': 'addresses_A'}, 'OP': 'REPM', 'src': {'same': False, 'congruent': 7, 'type': 'addresses_RW'}}
...
{'dst': {'same': True, 'congruent': 4, 'type': 'addresses_WT_ht'}, 'OP': 'REPM', 'src': {'same': False, 'congruent': 9, 'type': 'addresses_WT_ht'}}
{'39': 21829}
