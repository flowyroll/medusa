...
push %rdi
push %rsi
lea addresses_WT_ht+0x6c34, %rbx
clflush (%rbx)
nop
xor $51838, %rbp
...
lea addresses_normal_ht+0xa20c, %rdi
clflush (%rdi)
nop
nop
dec %r15
...
nop
and %rax, %rax
lea addresses_WT_ht+0xdf44, %r15
nop
inc %rsi
movups (%r15), %xmm7
vpextrq $0, %xmm7, %rdi
...
{'dst': {'NT': True, 'AVXalign': False, 'size': 8, 'congruent': 7, 'same': False, 'type': 'addresses_PSE'}, 'OP': 'STOR'}
[Faulty Load]
