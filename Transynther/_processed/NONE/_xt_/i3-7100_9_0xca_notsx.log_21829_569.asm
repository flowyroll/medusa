...
nop
xor $20146, %rax
lea addresses_D_ht+0x1009, %rsi
lea addresses_WC_ht+0xa469, %rdi
nop
nop
nop
inc %rax
...
nop
add $62758, %rbp
lea addresses_UC_ht+0xbcd9, %rsi
nop
nop
cmp $50489, %rax
mov (%rsi), %r9d
...
nop
cmp %rbp, %rbp
lea addresses_D_ht+0x195e9, %r13
nop
nop
nop
xor $34763, %rax
...
nop
and %r13, %r13
lea addresses_UC_ht+0x2fb1, %r13
nop
nop
nop
nop
...
nop
cmp $47851, %rcx
lea addresses_WC_ht+0x1efe9, %rax
sub $18814, %rdi
mov (%rax), %ebp
nop
nop
...
nop
cmp %rbp, %rbp
lea addresses_WC_ht+0x11afd, %rcx
clflush (%rcx)
nop
nop
nop
...
{'src': {'same': True, 'congruent': 4, 'NT': False, 'type': 'addresses_UC_ht', 'size': 4, 'AVXalign': True}, 'OP': 'LOAD'}
