...
push %rdx
push %rsi
lea addresses_UC_ht+0x12855, %r14
nop
nop
nop
inc %rdx
...
lea addresses_UC_ht+0x184d5, %rdi
nop
inc %r11
mov $67, %rcx
rep movsq
...
nop
add $8304, %rsi
lea addresses_WT_ht+0x10321, %rdi
and %rdx, %rdx
movb (%rdi), %cl
nop
nop
...
nop
sub $50615, %r11
lea addresses_WT_ht+0xa3d5, %rdi
clflush (%rdi)
nop
add $31846, %rdx
movups (%rdi), %xmm3
...
{'OP': 'STOR', 'dst': {'same': False, 'type': 'addresses_D', 'NT': True, 'AVXalign': False, 'size': 8, 'congruent': 7}}
{'OP': 'LOAD', 'src': {'same': False, 'type': 'addresses_A', 'NT': False, 'AVXalign': False, 'size': 8, 'congruent': 6}}
{'OP': 'LOAD', 'src': {'same': False, 'type': 'addresses_A', 'NT': False, 'AVXalign': False, 'size': 2, 'congruent': 7}}
{'OP': 'STOR', 'dst': {'same': False, 'type': 'addresses_A', 'NT': False, 'AVXalign': False, 'size': 2, 'congruent': 5}}
{'OP': 'STOR', 'dst': {'same': False, 'type': 'addresses_WT', 'NT': False, 'AVXalign': True, 'size': 2, 'congruent': 1}}
...
{'OP': 'LOAD', 'src': {'same': False, 'type': 'addresses_WT_ht', 'NT': False, 'AVXalign': True, 'size': 1, 'congruent': 1}}
