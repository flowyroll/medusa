...
nop
and $18063, %r13
lea addresses_A_ht+0xe3cd, %rsi
lea addresses_D_ht+0xa48d, %rdi
and $52131, %r14
mov $49, %rcx
rep movsb
nop
...
nop
xor %rcx, %rcx
lea addresses_WT_ht+0xea8d, %r11
sub %rdi, %rdi
mov $0x6162636465666768, %r10
movq %r10, %xmm0
movups %xmm0, (%r11)
...
nop
and %r10, %r10
lea addresses_D_ht+0x14a8d, %r11
nop
nop
add $63772, %rcx
movups (%r11), %xmm1
...
nop
xor %r13, %r13
lea addresses_D_ht+0x13e8d, %rdi
clflush (%rdi)
nop
nop
nop
...
nop
sub $32206, %r11
lea addresses_A_ht+0x1818d, %rdi
dec %rcx
movb (%rdi), %r10b
nop
nop
...
nop
xor %rsi, %rsi
lea addresses_WT_ht+0x17a8d, %rsi
clflush (%rsi)
nop
nop
dec %r14
...
nop
xor $11598, %r10
lea addresses_normal_ht+0x1318d, %rsi
lea addresses_A_ht+0x175c5, %rdi
nop
cmp $38540, %r9
mov $48, %rcx
rep movsq
nop
and %r11, %r11
lea addresses_D_ht+0x22a8, %r13
lfence
movb (%r13), %r14b
nop
nop
mfence
lea addresses_normal_ht+0xee75, %rsi
lea addresses_WC_ht+0x4a06, %rdi
nop
cmp %r9, %r9
mov $62, %rcx
rep movsb
...
nop
cmp %r10, %r10
lea addresses_D_ht+0x18f65, %rcx
clflush (%rcx)
nop
nop
mfence
movb $0x61, (%rcx)
cmp $32739, %r11
lea addresses_WT_ht+0x3bd3, %r13
nop
nop
nop
dec %r9
...
{'dst': {'type': 'addresses_A', 'same': False, 'size': 8, 'congruent': 5, 'NT': False, 'AVXalign': True}, 'OP': 'STOR'}
{'dst': {'type': 'addresses_A', 'same': False, 'size': 4, 'congruent': 1, 'NT': True, 'AVXalign': False}, 'OP': 'STOR'}
[Faulty Load]
{'src': {'type': 'addresses_PSE', 'same': True, 'size': 1, 'congruent': 0, 'NT': False, 'AVXalign': False}, 'OP': 'LOAD'}
<gen_prepare_buffer>
{'dst': {'type': 'addresses_A_ht', 'same': True, 'size': 32, 'congruent': 3, 'NT': False, 'AVXalign': False}, 'OP': 'STOR'}
{'src': {'type': 'addresses_A_ht', 'congruent': 3, 'same': False}, 'dst': {'type': 'addresses_D_ht', 'congruent': 5, 'same': False}, 'OP': 'REPM'}
...
{'dst': {'type': 'addresses_WT_ht', 'same': True, 'size': 1, 'congruent': 1, 'NT': False, 'AVXalign': False}, 'OP': 'STOR'}
{'33': 21829}
