...
nop
sub $19262, %rsi
lea addresses_UC_ht+0x16b1e, %rsi
lea addresses_normal_ht+0xec5e, %rdi
nop
nop
nop
nop
...
// Faulty Load
lea addresses_normal+0x5b1e, %r13
nop
nop
xor $40134, %rsi
movb (%r13), %r9b
