...
push %rdx
push %rsi
lea addresses_WC_ht+0xddd3, %rsi
lea addresses_UC_ht+0x1a827, %rdi
nop
nop
nop
nop
...
rep movsq
and $39519, %rcx
lea addresses_D_ht+0x15a53, %rdx
nop
nop
nop
nop
...
nop
cmp $51733, %r11
lea addresses_WC_ht+0x3223, %rsi
lea addresses_WT_ht+0x77e3, %rdi
nop
nop
nop
sub %rbp, %rbp
...
nop
cmp %rdi, %rdi
lea addresses_WT_ht+0x10431, %rsi
lea addresses_A_ht+0x179ab, %rdi
nop
nop
nop
and %rbp, %rbp
...
nop
and $18607, %r11
lea addresses_D_ht+0x17bd3, %rsi
lea addresses_UC_ht+0x8373, %rdi
nop
add %r13, %r13
mov $112, %rcx
rep movsl
...
nop
xor %rdi, %rdi
lea addresses_UC_ht+0x193d3, %rsi
lea addresses_WT_ht+0x864b, %rdi
clflush (%rdi)
nop
cmp %r11, %r11
mov $89, %rcx
...
nop
dec %rsi
lea addresses_normal_ht+0x13bd3, %rsi
lea addresses_WT_ht+0xbd3, %rdi
dec %r14
mov $43, %rcx
rep movsl
nop
nop
and %rcx, %rcx
lea addresses_UC_ht+0x9bd3, %r13
nop
nop
nop
nop
...
nop
add $10558, %rbp
lea addresses_UC_ht+0x83a2, %rsi
nop
nop
nop
nop
...
<gen_prepare_buffer>
{'src': {'congruent': 9, 'same': True, 'type': 'addresses_WC_ht'}, 'dst': {'congruent': 0, 'same': True, 'type': 'addresses_UC_ht'}, 'OP': 'REPM'}
...
{'src': {'congruent': 7, 'same': False, 'type': 'addresses_D_ht'}, 'dst': {'congruent': 5, 'same': False, 'type': 'addresses_UC_ht'}, 'OP': 'REPM'}
