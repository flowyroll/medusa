...
push %rdx
push %rsi
lea addresses_WC_ht+0x2fb1, %rdx
xor $39758, %rbx
movb (%rdx), %cl
nop
nop
and $7328, %r10
lea addresses_A_ht+0xe5b1, %r9
nop
inc %r15
movb $0x61, (%r9)
nop
...
nop
add %rdx, %rdx
lea addresses_WC_ht+0x8d31, %rdx
sub $5583, %r10
movups (%rdx), %xmm1
vpextrq $0, %xmm1, %r15
nop
...
nop
inc %rcx
lea addresses_normal_ht+0x17401, %r9
nop
nop
and %rsi, %rsi
vmovups (%r9), %ymm4
...
nop
dec %rdx
lea addresses_normal_ht+0x12ab1, %rdx
cmp $11671, %r10
...
nop
cmp $27795, %rdx
lea addresses_UC_ht+0x1c9b1, %r9
nop
nop
nop
cmp %rsi, %rsi
...
movups %xmm3, (%r9)
mfence
lea addresses_WT_ht+0x1adb1, %rbx
nop
nop
nop
dec %rcx
...
// Faulty Load
lea addresses_normal+0x19fb1, %r10
cmp %rbp, %rbp
mov (%r10), %ax
lea oracles, %r10
and $0xff, %rax
...
{'OP': 'STOR', 'dst': {'NT': False, 'same': True, 'congruent': 4, 'type': 'addresses_A_ht', 'AVXalign': False, 'size': 2}}
