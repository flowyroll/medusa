...
movq %r10, (%rbp)
sub $45022, %rdx
lea addresses_WC_ht+0x12daa, %rsi
...
nop
cmp %r9, %r9
lea addresses_A_ht+0xbc22, %rsi
lea addresses_WC_ht+0x18cea, %rdi
xor $16143, %r12
mov $19, %rcx
rep movsw
and %rcx, %rcx
...
// Faulty Load
lea addresses_normal+0x48ea, %r11
nop
nop
nop
nop
