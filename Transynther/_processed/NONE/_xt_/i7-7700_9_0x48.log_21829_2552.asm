...
push %rdx
push %rsi
lea addresses_UC_ht+0x1e811, %r8
and %r14, %r14
movl $0x61626364, (%r8)
nop
nop
sub $24789, %r13
lea addresses_D_ht+0x1583b, %r8
sub $54746, %rax
...
nop
sub %r8, %r8
lea addresses_D_ht+0x11f0b, %r14
nop
nop
and $45563, %r13
vmovups (%r14), %ymm3
...
nop
xor %r13, %r13
lea addresses_normal_ht+0x11fcb, %r14
nop
nop
nop
and %rax, %rax
...
nop
add %rax, %rax
lea addresses_normal_ht+0x8ebb, %rsi
lea addresses_D_ht+0x1400b, %rdi
clflush (%rsi)
nop
nop
and %rbp, %rbp
...
nop
inc %rdi
lea addresses_normal_ht+0x13dab, %r8
nop
nop
xor $2279, %rcx
mov (%r8), %si
...
nop
dec %r13
lea addresses_normal_ht+0x950b, %rbp
nop
nop
nop
cmp %rsi, %rsi
...
nop
and $9393, %rdx
lea addresses_normal_ht+0x7c37, %rsi
lea addresses_D_ht+0x18093, %rdi
nop
nop
nop
nop
...
nop
add $58135, %r8
lea addresses_UC_ht+0x1410b, %r13
nop
sub $33974, %rdi
mov $0x6162636465666768, %rdx
movq %rdx, %xmm0
...
movntdq %xmm0, (%r13)
sub $35626, %r14
lea addresses_normal_ht+0x1970b, %r13
nop
and %r14, %r14
movl $0x61626364, (%r13)
nop
nop
xor %rdi, %rdi
lea addresses_WT_ht+0x449b, %rdi
nop
nop
sub %rbp, %rbp
...
nop
and %rsi, %rsi
lea addresses_UC_ht+0x10f2b, %rsi
nop
sub $63546, %rbp
mov (%rsi), %rcx
xor %r14, %r14
lea addresses_D_ht+0x1990b, %rcx
nop
nop
nop
nop
...
{'OP': 'STOR', 'dst': {'type': 'addresses_PSE', 'AVXalign': True, 'congruent': 11, 'size': 8, 'same': False, 'NT': False}}
...
{'OP': 'LOAD', 'src': {'type': 'addresses_D_ht', 'AVXalign': True, 'congruent': 0, 'size': 16, 'same': True, 'NT': False}}
...
{'OP': 'REPM', 'src': {'type': 'addresses_normal_ht', 'congruent': 3, 'same': True}, 'dst': {'type': 'addresses_D_ht', 'congruent': 7, 'same': False}}
...
{'OP': 'STOR', 'dst': {'type': 'addresses_normal_ht', 'AVXalign': True, 'congruent': 9, 'size': 4, 'same': False, 'NT': True}}
