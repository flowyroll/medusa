...
push %rdx
push %rsi
lea addresses_UC_ht+0x19f9, %rsi
lea addresses_normal_ht+0x1541, %rdi
nop
nop
nop
nop
...
nop
cmp %rcx, %rcx
lea addresses_A_ht+0x1bcf9, %rsi
lea addresses_A_ht+0x16339, %rdi
xor $26458, %r14
mov $120, %rcx
rep movsb
nop
...
nop
add $54571, %rcx
lea addresses_WT_ht+0x195f9, %rbp
clflush (%rbp)
nop
nop
nop
...
nop
sub $45259, %r14
lea addresses_WT_ht+0x8a79, %rsi
lea addresses_D_ht+0xec79, %rdi
nop
nop
nop
nop
...
nop
add $55214, %r9
lea addresses_UC_ht+0x1a6f9, %rdi
nop
nop
nop
and %r11, %r11
...
movaps %xmm7, (%rdi)
cmp %r9, %r9
lea addresses_UC_ht+0xa759, %rsi
lea addresses_A_ht+0x124f9, %rdi
nop
nop
nop
xor %rdx, %rdx
...
nop
inc %rdx
lea addresses_UC_ht+0x184f9, %rsi
cmp %r14, %r14
movw $0x6162, (%rsi)
xor %r14, %r14
pop %rsi
...
// Faulty Load
lea addresses_normal+0x40f9, %r13
nop
nop
xor %rbx, %rbx
mov (%r13), %r15
...
{'OP': 'STOR', 'dst': {'type': 'addresses_UC_ht', 'size': 16, 'AVXalign': True, 'NT': True, 'congruent': 9, 'same': True}}
{'OP': 'REPM', 'src': {'type': 'addresses_UC_ht', 'congruent': 4, 'same': False}, 'dst': {'type': 'addresses_A_ht', 'congruent': 9, 'same': False}}
