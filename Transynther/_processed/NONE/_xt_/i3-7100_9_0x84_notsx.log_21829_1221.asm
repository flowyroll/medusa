...
nop
cmp %rcx, %rcx
lea addresses_D_ht+0xd70b, %rsi
lea addresses_normal_ht+0x1c3ed, %rdi
nop
nop
nop
nop
...
nop
cmp $39491, %rsi
lea addresses_UC_ht+0x4691, %r10
nop
nop
cmp $37131, %r14
...
nop
cmp %r14, %r14
lea addresses_normal_ht+0x849b, %rsi
lea addresses_normal_ht+0x1447b, %rdi
clflush (%rsi)
nop
nop
inc %r14
...
rep movsq
add $2395, %rsi
lea addresses_D_ht+0x84e3, %rsi
lea addresses_normal_ht+0x14995, %rdi
clflush (%rdi)
nop
nop
nop
...
rep movsb
xor $64620, %rcx
lea addresses_WT_ht+0x7f9, %rsi
lea addresses_normal_ht+0xa127, %rdi
nop
nop
nop
nop
...
nop
inc %r11
lea addresses_UC_ht+0x12b75, %rsi
lea addresses_WT_ht+0x16a96, %rdi
clflush (%rsi)
nop
nop
nop
...
nop
add $47076, %rsi
lea addresses_WT_ht+0xb19b, %r14
nop
xor %rdi, %rdi
mov $0x6162636465666768, %rsi
movq %rsi, %xmm7
...
{'src': {'type': 'addresses_D_ht', 'congruent': 3, 'same': False}, 'dst': {'type': 'addresses_normal_ht', 'congruent': 0, 'same': False}, 'OP': 'REPM'}
{'src': {'type': 'addresses_WT_ht', 'congruent': 0, 'same': False}, 'dst': {'type': 'addresses_normal_ht', 'congruent': 2, 'same': False}, 'OP': 'REPM'}
{'src': {'type': 'addresses_UC_ht', 'congruent': 1, 'same': False}, 'dst': {'type': 'addresses_WT_ht', 'congruent': 0, 'same': False}, 'OP': 'REPM'}
