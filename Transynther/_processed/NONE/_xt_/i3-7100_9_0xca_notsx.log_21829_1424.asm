...
push %rdi
push %rsi
lea addresses_UC_ht+0x9908, %r13
nop
nop
nop
nop
...
nop
sub $18287, %r9
lea addresses_A_ht+0x1da6e, %r13
nop
sub %r15, %r15
...
nop
xor $3575, %r9
lea addresses_UC_ht+0x116c8, %rcx
nop
nop
nop
add %r15, %r15
...
movq %rbp, (%rcx)
and %r9, %r9
lea addresses_D_ht+0x19428, %rdi
nop
nop
sub %rax, %rax
movb (%rdi), %r13b
nop
xor $3541, %rax
lea addresses_WC_ht+0x1e050, %rbp
nop
dec %rcx
movw $0x6162, (%rbp)
xor $3170, %rax
lea addresses_UC_ht+0xc0c8, %rsi
lea addresses_A_ht+0x168f0, %rdi
nop
nop
and %rbp, %rbp
mov $1, %rcx
...
nop
add %rcx, %rcx
lea addresses_WC_ht+0x1d378, %rsi
lea addresses_D_ht+0x1ef88, %rdi
nop
nop
nop
nop
...
nop
xor %r13, %r13
lea addresses_WC_ht+0xc988, %rax
inc %rdi
...
nop
xor %r13, %r13
lea addresses_normal_ht+0xcf88, %rsi
lea addresses_normal_ht+0x12232, %rdi
cmp %rbp, %rbp
mov $115, %rcx
rep movsq
nop
...
{'src': {'type': 'addresses_UC_ht', 'congruent': 4, 'same': False}, 'OP': 'REPM', 'dst': {'type': 'addresses_A_ht', 'congruent': 3, 'same': False}}
{'src': {'type': 'addresses_WC_ht', 'congruent': 3, 'same': False}, 'OP': 'REPM', 'dst': {'type': 'addresses_D_ht', 'congruent': 10, 'same': False}}
{'src': {'same': False, 'congruent': 7, 'NT': False, 'type': 'addresses_WC_ht', 'size': 32, 'AVXalign': True}, 'OP': 'LOAD'}
