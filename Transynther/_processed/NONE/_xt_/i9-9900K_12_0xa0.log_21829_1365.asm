...
push %rdx
push %rsi
lea addresses_WT_ht+0x1c9b9, %rbp
nop
nop
nop
nop
...
movaps %xmm4, (%rbp)
add %rax, %rax
lea addresses_UC_ht+0x17a5c, %rdx
nop
nop
dec %rsi
...
nop
cmp %rbp, %rbp
lea addresses_D_ht+0x4a23, %rsi
lea addresses_WT_ht+0x19783, %rdi
nop
nop
nop
nop
...
nop
add %rdx, %rdx
lea addresses_normal_ht+0x18f83, %rbp
clflush (%rbp)
nop
nop
nop
...
nop
sub %rbp, %rbp
lea addresses_D_ht+0x1334f, %rdx
nop
nop
nop
nop
...
movb $0x61, (%rdx)
inc %rdx
lea addresses_normal_ht+0x1e543, %rcx
nop
nop
nop
nop
...
nop
sub $13331, %rcx
lea addresses_UC_ht+0x5383, %rax
nop
nop
nop
nop
