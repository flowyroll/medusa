...
nop
xor $26519, %rcx
lea addresses_UC_ht+0x191e7, %rcx
nop
nop
nop
nop
...
nop
inc %rsi
lea addresses_WT_ht+0x1481f, %r12
nop
nop
xor $27302, %rdx
...
nop
inc %rdx
lea addresses_A_ht+0x1c2a7, %rax
nop
xor %r12, %r12
...
nop
add $24579, %rsi
lea addresses_WC_ht+0x49e7, %rsi
lea addresses_normal_ht+0x1354f, %rdi
xor %r8, %r8
mov $85, %rcx
rep movsl
nop
...
nop
cmp %rdx, %rdx
lea addresses_D_ht+0x172e7, %rdi
nop
nop
and $59413, %rax
movb $0x61, (%rdi)
add $47173, %rsi
lea addresses_normal_ht+0x18e2, %rax
nop
nop
nop
inc %r12
...
// Faulty Load
lea addresses_normal+0x1a9e7, %r13
nop
nop
xor %r12, %r12
mov (%r13), %si
...
{'OP': 'LOAD', 'src': {'size': 4, 'NT': False, 'type': 'addresses_UC_ht', 'same': False, 'AVXalign': True, 'congruent': 11}}
{'OP': 'STOR', 'dst': {'size': 32, 'NT': False, 'type': 'addresses_WT_ht', 'same': False, 'AVXalign': False, 'congruent': 0}}
{'OP': 'LOAD', 'src': {'size': 16, 'NT': False, 'type': 'addresses_A_ht', 'same': False, 'AVXalign': True, 'congruent': 6}}
{'OP': 'REPM', 'src': {'same': False, 'type': 'addresses_WC_ht', 'congruent': 10}, 'dst': {'same': False, 'type': 'addresses_normal_ht', 'congruent': 3}}
