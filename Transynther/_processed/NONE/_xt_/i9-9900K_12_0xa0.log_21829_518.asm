...
nop
cmp $63285, %r13
lea addresses_normal_ht+0x6f1f, %r15
nop
nop
nop
nop
...
nop
cmp %r15, %r15
lea addresses_D_ht+0x13b1f, %rsi
lea addresses_WT_ht+0x25f, %rdi
nop
nop
nop
nop
...
// Store
lea addresses_normal+0x1069f, %r9
clflush (%r9)
nop
nop
nop
...
{'src': {'NT': False, 'same': False, 'congruent': 9, 'type': 'addresses_A', 'AVXalign': False, 'size': 2}, 'OP': 'LOAD'}
