...
push %rdx
push %rsi
lea addresses_normal_ht+0x157f9, %rdx
nop
nop
nop
nop
...
movb (%r15), %al
add $13823, %rsi
lea addresses_WC_ht+0xf7b0, %rsi
...
rep movsq
sub $38695, %rcx
lea addresses_normal_ht+0x12810, %rsi
lea addresses_WC_ht+0x124d0, %rdi
nop
nop
nop
nop
...
nop
dec %rcx
lea addresses_UC_ht+0x24f0, %rcx
clflush (%rcx)
nop
nop
nop
...
movntdq %xmm2, (%rcx)
sub %rsi, %rsi
lea addresses_WT_ht+0xd3b0, %rbp
nop
nop
nop
nop
...
nop
cmp %rbx, %rbx
lea addresses_A_ht+0x19d30, %rdi
add $59311, %rdx
movl $0x61626364, (%rdi)
nop
nop
sub $6645, %rax
lea addresses_normal_ht+0x5b30, %rsi
lea addresses_UC_ht+0x5230, %rdi
nop
nop
nop
nop
...
nop
sub $3943, %rsi
lea addresses_D_ht+0xf120, %rsi
lea addresses_WC_ht+0xc168, %rdi
clflush (%rdi)
nop
and $30312, %r15
mov $19, %rcx
...
nop
sub $5912, %rdx
lea addresses_A_ht+0x13b0, %rsi
lea addresses_UC_ht+0x52b0, %rdi
nop
nop
nop
nop
...
nop
add %r15, %r15
lea addresses_WT_ht+0xffb0, %rsi
...
nop
xor %rcx, %rcx
lea addresses_UC_ht+0x19be0, %rcx
nop
inc %rdi
movl $0x61626364, (%rcx)
nop
and $16743, %rdi
lea addresses_A_ht+0x66f0, %rbp
add %rsi, %rsi
mov $0x6162636465666768, %r15
movq %r15, %xmm1
movups %xmm1, (%rbp)
...
{'dst': {'same': True, 'congruent': 5, 'type': 'addresses_normal_ht'}, 'OP': 'REPM', 'src': {'same': False, 'congruent': 11, 'type': 'addresses_WC_ht'}}
{'dst': {'same': False, 'congruent': 4, 'type': 'addresses_WC_ht'}, 'OP': 'REPM', 'src': {'same': False, 'congruent': 5, 'type': 'addresses_normal_ht'}}
{'dst': {'same': False, 'NT': True, 'AVXalign': False, 'size': 16, 'type': 'addresses_UC_ht', 'congruent': 6}, 'OP': 'STOR'}
...
{'dst': {'same': False, 'congruent': 2, 'type': 'addresses_WC_ht'}, 'OP': 'REPM', 'src': {'same': False, 'congruent': 4, 'type': 'addresses_D_ht'}}
{'dst': {'same': True, 'congruent': 8, 'type': 'addresses_UC_ht'}, 'OP': 'REPM', 'src': {'same': False, 'congruent': 8, 'type': 'addresses_A_ht'}}
