...
push %rdi
push %rsi
lea addresses_WC_ht+0xf839, %rbx
nop
nop
nop
nop
...
nop
xor $30322, %r15
lea addresses_WC_ht+0xa2d9, %r10
nop
nop
dec %r14
movw $0x6162, (%r10)
...
nop
xor %r15, %r15
lea addresses_normal_ht+0xa39, %rbp
cmp %rbx, %rbx
movl $0x61626364, (%rbp)
nop
and %r15, %r15
lea addresses_WC_ht+0x19639, %r12
nop
xor %r15, %r15
mov (%r12), %ax
nop
dec %rax
lea addresses_UC_ht+0x18039, %rsi
lea addresses_UC_ht+0x10839, %rdi
nop
cmp $62167, %r12
mov $96, %rcx
rep movsb
...
{'OP': 'REPM', 'src': {'type': 'addresses_UC_ht', 'congruent': 8, 'same': True}, 'dst': {'type': 'addresses_UC_ht', 'congruent': 9, 'same': False}}
{'33': 21829}
