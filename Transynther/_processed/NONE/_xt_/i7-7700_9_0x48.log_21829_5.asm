...
nop
dec %rdx
lea addresses_normal_ht+0x14f87, %rcx
sub $57663, %r10
movl $0x61626364, (%rcx)
and %r8, %r8
lea addresses_UC_ht+0x3023, %rsi
lea addresses_normal_ht+0xa23, %rdi
sub %r15, %r15
mov $22, %rcx
rep movsw
nop
...
nop
add %r15, %r15
lea addresses_WT_ht+0xacbb, %r14
clflush (%r14)
nop
nop
xor %r8, %r8
...
nop
add $35379, %r15
lea addresses_D_ht+0x1ac23, %rsi
...
nop
and %rdx, %rdx
lea addresses_UC_ht+0x144e3, %r10
nop
nop
add $2179, %rcx
mov (%r10), %r14d
...
nop
cmp $50582, %r14
lea addresses_normal_ht+0x9160, %rsi
sub %r14, %r14
movl $0x61626364, (%rsi)
nop
sub $7430, %rdx
lea addresses_normal_ht+0x12d23, %rdi
nop
nop
nop
nop
...
nop
sub %r8, %r8
lea addresses_WT_ht+0xd9c3, %rsi
lea addresses_normal_ht+0x17ac3, %rdi
nop
nop
nop
nop
...
nop
and %r15, %r15
lea addresses_WT_ht+0xd7e3, %r15
nop
nop
nop
nop
...
{'OP': 'LOAD', 'src': {'type': 'addresses_US', 'AVXalign': False, 'congruent': 1, 'size': 1, 'same': False, 'NT': False}}
[Faulty Load]
