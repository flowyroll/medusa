...
movups %xmm4, (%r11)
sub %r13, %r13
lea addresses_UC_ht+0x15132, %rsi
lea addresses_D_ht+0xbcc0, %rdi
clflush (%rsi)
nop
nop
cmp $64575, %r9
...
nop
and %r12, %r12
lea addresses_WT_ht+0x182b2, %r11
nop
nop
nop
xor $49445, %r15
...
nop
add $33066, %r11
lea addresses_WC_ht+0x1e532, %r9
nop
nop
nop
add %r13, %r13
...
nop
cmp %r11, %r11
lea addresses_UC_ht+0x3802, %rdi
nop
nop
nop
nop
...
nop
inc %rcx
lea addresses_UC_ht+0x16732, %rdi
nop
nop
sub %r11, %r11
movb $0x61, (%rdi)
...
nop
inc %rdi
lea addresses_A_ht+0x148b2, %rsi
...
{'src': {'type': 'addresses_UC_ht', 'congruent': 3, 'same': False}, 'dst': {'type': 'addresses_D_ht', 'congruent': 1, 'same': False}, 'OP': 'REPM'}
