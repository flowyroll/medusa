...
push %rdx
push %rsi
lea addresses_UC_ht+0x17c2a, %rsi
lea addresses_D_ht+0xb5ca, %rdi
clflush (%rsi)
clflush (%rdi)
nop
nop
...
nop
xor $23516, %rbx
lea addresses_WT_ht+0x140ca, %rdi
and %r14, %r14
vmovups (%rdi), %ymm7
...
// REPMOV
lea addresses_WT+0x4c72, %rsi
lea addresses_WC+0x5dca, %rdi
nop
nop
nop
nop
...
{'src': {'type': 'addresses_WT', 'congruent': 2, 'same': False}, 'dst': {'type': 'addresses_WC', 'congruent': 10, 'same': False}, 'OP': 'REPM'}
...
<gen_prepare_buffer>
{'src': {'type': 'addresses_UC_ht', 'congruent': 4, 'same': False}, 'dst': {'type': 'addresses_D_ht', 'congruent': 11, 'same': False}, 'OP': 'REPM'}
...
{'src': {'type': 'addresses_WC_ht', 'congruent': 1, 'same': False}, 'dst': {'type': 'addresses_A_ht', 'congruent': 9, 'same': False}, 'OP': 'REPM'}
{'33': 21829}
