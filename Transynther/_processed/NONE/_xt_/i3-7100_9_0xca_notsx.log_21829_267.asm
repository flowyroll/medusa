...
push %r9
push %rdx
lea addresses_normal_ht+0x3942, %r8
nop
nop
nop
nop
...
nop
sub %rdx, %rdx
lea addresses_WC_ht+0xef52, %r13
nop
nop
inc %r9
movb $0x61, (%r13)
...
nop
and $52062, %rdx
lea addresses_normal_ht+0x15c42, %r12
nop
nop
nop
add $8220, %r8
...
{'src': {'same': False, 'congruent': 3, 'NT': False, 'type': 'addresses_US', 'size': 32, 'AVXalign': False}, 'OP': 'LOAD'}
[Faulty Load]
