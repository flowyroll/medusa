...
push %rdx
push %rsi
lea addresses_WT_ht+0x1c2aa, %rbp
nop
xor %rsi, %rsi
movb (%rbp), %r12b
nop
...
nop
dec %r12
lea addresses_WT_ht+0x17a1a, %r12
nop
nop
nop
nop
...
nop
and %r11, %r11
lea addresses_normal_ht+0xc846, %rbp
nop
nop
nop
nop
