...
nop
and $18494, %rbp
lea addresses_normal_ht+0x2d61, %rcx
nop
nop
nop
nop
...
nop
and %rsi, %rsi
lea addresses_WC_ht+0x36e9, %r12
xor %r15, %r15
movw $0x6162, (%r12)
nop
cmp %rcx, %rcx
lea addresses_normal_ht+0xb2e9, %rbp
nop
nop
sub $52877, %r11
...
nop
inc %r12
lea addresses_D_ht+0x154e9, %r12
nop
nop
nop
nop
...
nop
cmp %rsi, %rsi
lea addresses_UC_ht+0x168e9, %rcx
nop
nop
nop
nop
...
nop
add %r15, %r15
lea addresses_UC_ht+0x1c09d, %rsi
...
nop
sub %r10, %r10
lea addresses_normal_ht+0x103b9, %r15
clflush (%r15)
nop
sub $22171, %rdi
mov (%r15), %r11w
...
{'src': {'type': 'addresses_D_ht', 'same': False, 'size': 32, 'congruent': 2, 'NT': True, 'AVXalign': False}, 'OP': 'LOAD'}
...
{'src': {'type': 'addresses_UC_ht', 'congruent': 2, 'same': True}, 'dst': {'type': 'addresses_WC_ht', 'congruent': 10, 'same': False}, 'OP': 'REPM'}
