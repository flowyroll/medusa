...
push %rdi
push %rsi
lea addresses_A_ht+0x1b0dd, %rsi
...
nop
cmp $24501, %rcx
lea addresses_normal_ht+0x1a0dd, %rcx
nop
xor %r10, %r10
mov (%rcx), %rsi
nop
...
nop
add %rdi, %rdi
lea addresses_D_ht+0x1805d, %rsi
lea addresses_A_ht+0xe7d4, %rdi
clflush (%rdi)
nop
nop
cmp $19854, %r14
...
nop
cmp %r14, %r14
lea addresses_D_ht+0x1b7dd, %rdi
inc %rbp
mov (%rdi), %r14
nop
nop
...
{'OP': 'REPM', 'src': {'same': False, 'type': 'addresses_D_ht', 'congruent': 6}, 'dst': {'same': False, 'type': 'addresses_A_ht', 'congruent': 0}}
{'OP': 'LOAD', 'src': {'size': 8, 'NT': True, 'type': 'addresses_D_ht', 'same': False, 'AVXalign': False, 'congruent': 8}}
{'32': 21829}
