...
push %rdx
push %rsi
lea addresses_normal_ht+0x18b2b, %rax
nop
add $14569, %rdx
...
movaps %xmm6, (%rax)
add %r10, %r10
lea addresses_WC_ht+0x72db, %rsi
lea addresses_normal_ht+0x12d26, %rdi
clflush (%rdi)
nop
and %r11, %r11
mov $40, %rcx
rep movsw
sub %r12, %r12
lea addresses_A_ht+0x13f83, %rsi
nop
nop
nop
nop
...
nop
and $1417, %rax
lea addresses_WT_ht+0x1c0c3, %rsi
lea addresses_UC_ht+0x31a3, %rdi
nop
nop
nop
nop
...
{'OP': 'STOR', 'dst': {'type': 'addresses_A_ht', 'size': 16, 'AVXalign': True, 'NT': True, 'congruent': 11, 'same': False}}
