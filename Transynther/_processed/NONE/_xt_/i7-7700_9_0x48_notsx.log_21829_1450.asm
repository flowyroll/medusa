...
push %rdi
push %rsi
lea addresses_WT_ht+0x1d10, %rax
add $40316, %r12
...
nop
add $36988, %rbx
lea addresses_D_ht+0x1ed10, %rcx
cmp $3798, %r15
mov (%rcx), %bx
nop
add $64276, %r11
lea addresses_D_ht+0x8107, %r9
nop
nop
nop
nop
...
mov (%r9), %rcx
cmp $6575, %r11
lea addresses_D_ht+0x8550, %r12
sub $41002, %r15
mov (%r12), %rcx
nop
nop
xor %rbx, %rbx
lea addresses_A_ht+0x17510, %r15
nop
nop
cmp %r12, %r12
mov $0x6162636465666768, %r9
...
nop
add $21000, %r15
lea addresses_normal_ht+0x10be0, %rsi
lea addresses_D_ht+0x1bd10, %rdi
clflush (%rsi)
nop
nop
nop
