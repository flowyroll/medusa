...
vmovups %ymm6, (%r14)
xor %rdi, %rdi
lea addresses_WT_ht+0x1cc07, %r10
clflush (%r10)
nop
nop
nop
...
nop
sub %r14, %r14
lea addresses_D_ht+0x367, %rsi
lea addresses_WC_ht+0x4ca7, %rdi
nop
nop
nop
nop
