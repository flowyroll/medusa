...
push %rdi
push %rsi
lea addresses_A_ht+0x14938, %rsi
lea addresses_WT_ht+0xcb5c, %rdi
nop
sub $15203, %rbp
mov $51, %rcx
rep movsw
...
nop
xor %rdi, %rdi
lea addresses_WT_ht+0x12ede, %r8
nop
nop
nop
nop
...
// REPMOV
lea addresses_D+0x1a6b8, %rsi
lea addresses_A+0x19d4a, %rdi
xor $61233, %r9
mov $4, %rcx
rep movsb
nop
...
// REPMOV
lea addresses_D+0x1cb30, %rsi
lea addresses_RW+0xf1c6, %rdi
nop
nop
nop
nop
...
// Store
lea addresses_normal+0x8938, %r11
nop
xor %rsi, %rsi
...
// Faulty Load
lea addresses_normal+0x13138, %rcx
and %rax, %rax
movups (%rcx), %xmm7
vpextrq $1, %xmm7, %rdi
lea oracles, %r11
...
{'src': {'congruent': 7, 'same': False, 'type': 'addresses_D'}, 'dst': {'congruent': 1, 'same': False, 'type': 'addresses_A'}, 'OP': 'REPM'}
{'src': {'congruent': 3, 'same': False, 'type': 'addresses_D'}, 'dst': {'congruent': 1, 'same': False, 'type': 'addresses_RW'}, 'OP': 'REPM'}
