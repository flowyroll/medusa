...
nop
add $36028, %r10
lea addresses_UC_ht+0x1bd51, %rbp
clflush (%rbp)
add $2850, %r15
mov (%rbp), %cx
nop
nop
xor $269, %rbp
lea addresses_WC_ht+0xdd51, %r10
nop
sub $18850, %rdx
movl $0x61626364, (%r10)
nop
cmp %rax, %rax
lea addresses_WC_ht+0x19a51, %rsi
lea addresses_A_ht+0x6661, %rdi
and %rbp, %rbp
mov $102, %rcx
rep movsl
nop
...
vpextrq $0, %xmm6, %r15
and %rcx, %rcx
lea addresses_normal_ht+0x12251, %rdi
nop
nop
nop
cmp $3138, %rcx
...
nop
xor %rsi, %rsi
lea addresses_D_ht+0x17a11, %r10
and $17349, %rsi
mov (%r10), %rax
nop
nop
xor $5799, %r8
lea addresses_WC_ht+0xabd1, %rbp
dec %rdx
...
{'OP': 'STOR', 'dst': {'type': 'addresses_WC_ht', 'AVXalign': False, 'size': 32, 'NT': False, 'same': True, 'congruent': 7}}
{'32': 21829}
