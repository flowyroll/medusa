...
push %rbx
push %rdi
lea addresses_normal_ht+0x17cd0, %r8
nop
nop
nop
nop
...
nop
dec %rax
lea addresses_WC_ht+0x9ac0, %rbp
nop
nop
nop
nop
...
vpextrq $1, %xmm3, %rbx
sub $22996, %rbx
lea addresses_normal_ht+0x44e0, %r8
nop
nop
nop
nop
...
nop
cmp %rax, %rax
lea addresses_normal_ht+0x12f80, %r15
add %rdi, %rdi
movb $0x61, (%r15)
cmp %rbx, %rbx
lea addresses_WC_ht+0x1a1c0, %rax
sub $13823, %r14
...
nop
dec %rbx
lea addresses_D_ht+0x1a640, %rbx
nop
nop
nop
nop
...
nop
and %rbp, %rbp
lea addresses_WT_ht+0xc240, %rax
add $40694, %r8
mov (%rax), %bx
nop
nop
...
<gen_prepare_buffer>
{'OP': 'STOR', 'dst': {'congruent': 3, 'AVXalign': False, 'same': False, 'size': 16, 'NT': True, 'type': 'addresses_normal_ht'}}
