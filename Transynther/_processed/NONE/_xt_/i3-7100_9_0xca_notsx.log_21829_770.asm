...
push %rcx
push %rdx
lea addresses_WC_ht+0x1c6b6, %r13
nop
nop
nop
nop
...
nop
and %rbx, %rbx
lea addresses_WT_ht+0x18a55, %rcx
nop
nop
and %r8, %r8
movb (%rcx), %al
...
nop
add $35598, %rcx
lea addresses_A_ht+0x18ef4, %rbx
nop
nop
nop
and $50352, %rdx
...
// Faulty Load
lea addresses_normal+0x18ef4, %r14
clflush (%r14)
nop
add $51566, %rbx
mov (%r14), %si
...
{'OP': 'STOR', 'dst': {'same': False, 'congruent': 6, 'NT': False, 'type': 'addresses_UC', 'size': 2, 'AVXalign': False}}
