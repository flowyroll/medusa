...
push %rdi
push %rsi
lea addresses_UC_ht+0x6e46, %rsi
lea addresses_WT_ht+0x18226, %rdi
nop
nop
xor %rbx, %rbx
mov $63, %rcx
...
nop
add %rsi, %rsi
lea addresses_WC_ht+0x169a6, %rsi
lea addresses_D_ht+0x2726, %rdi
nop
nop
and $18684, %rbx
mov $51, %rcx
...
lea addresses_UC_ht+0x12760, %rdi
clflush (%rsi)
nop
and $35840, %r8
mov $34, %rcx
...
nop
add %r11, %r11
lea addresses_A_ht+0x1ab26, %rsi
add %rbx, %rbx
movb (%rsi), %r10b
nop
nop
...
{'dst': {'type': 'addresses_A_ht', 'same': False, 'size': 1, 'congruent': 11, 'NT': False, 'AVXalign': True}, 'OP': 'STOR'}
{'src': {'type': 'addresses_normal_ht', 'same': True, 'size': 4, 'congruent': 8, 'NT': False, 'AVXalign': False}, 'OP': 'LOAD'}
{'src': {'type': 'addresses_D_ht', 'congruent': 3, 'same': True}, 'dst': {'type': 'addresses_UC_ht', 'congruent': 1, 'same': False}, 'OP': 'REPM'}
