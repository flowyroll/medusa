...
push %rdi
push %rsi
lea addresses_WT_ht+0x1ef67, %rsi
lea addresses_normal_ht+0x3d67, %rdi
clflush (%rdi)
nop
nop
nop
...
nop
inc %r10
lea addresses_UC_ht+0x1ac75, %rsi
lea addresses_A_ht+0xcd67, %rdi
nop
nop
nop
nop
...
nop
and $61958, %rax
lea addresses_A_ht+0xc3e7, %rsi
lea addresses_UC_ht+0xf67, %rdi
clflush (%rsi)
nop
nop
xor $45926, %r10
...
nop
xor %rsi, %rsi
lea addresses_WC_ht+0x91e5, %r10
nop
add $56255, %r9
mov (%r10), %r13d
nop
...
// Store
lea addresses_normal+0x12627, %r14
nop
nop
nop
nop
...
// REPMOV
lea addresses_WT+0x1fae7, %rsi
lea addresses_WC+0x11d27, %rdi
add %r14, %r14
mov $97, %rcx
rep movsb
nop
...
{'src': {'type': 'addresses_WT', 'congruent': 6, 'same': False}, 'dst': {'type': 'addresses_WC', 'congruent': 3, 'same': False}, 'OP': 'REPM'}
...
<gen_prepare_buffer>
{'src': {'type': 'addresses_WT_ht', 'congruent': 10, 'same': True}, 'dst': {'type': 'addresses_normal_ht', 'congruent': 9, 'same': False}, 'OP': 'REPM'}
...
{'src': {'type': 'addresses_A_ht', 'congruent': 3, 'same': False}, 'dst': {'type': 'addresses_UC_ht', 'congruent': 9, 'same': False}, 'OP': 'REPM'}
