...
lea addresses_D_ht+0x15810, %rdi
clflush (%rdi)
nop
nop
cmp %rbx, %rbx
...
nop
and %r8, %r8
lea addresses_WT_ht+0x1c790, %rbx
nop
nop
nop
nop
...
{'OP': 'STOR', 'dst': {'type': 'addresses_A_ht', 'size': 16, 'AVXalign': False, 'NT': True, 'congruent': 4, 'same': False}}
{'36': 21829}
