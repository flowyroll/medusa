...
push %rdx
push %rsi
lea addresses_UC_ht+0xc03f, %r13
nop
sub %rsi, %rsi
movw $0x6162, (%r13)
nop
...
nop
dec %r9
lea addresses_normal_ht+0x1512f, %rsi
lea addresses_WC_ht+0x7ebf, %rdi
clflush (%rsi)
clflush (%rdi)
nop
inc %r14
...
nop
dec %r14
lea addresses_WC_ht+0x14c7f, %rcx
nop
nop
nop
add %rax, %rax
...
nop
and %rdx, %rdx
lea addresses_UC_ht+0x1bfff, %rsi
lea addresses_WC_ht+0xc43f, %rdi
clflush (%rdi)
nop
nop
nop
