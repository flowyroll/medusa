...
push %rdi
push %rsi
lea addresses_WT_ht+0x1c89, %rsi
...
nop
dec %rbp
lea addresses_WT_ht+0xcb89, %rsi
lea addresses_A_ht+0x11aa1, %rdi
nop
nop
and %r11, %r11
mov $109, %rcx
...
nop
xor $47375, %r11
lea addresses_A_ht+0x126e9, %rbp
nop
nop
cmp $15695, %r15
mov (%rbp), %ecx
...
nop
add $4072, %rbp
lea addresses_normal_ht+0x2299, %rcx
nop
nop
nop
sub %rbx, %rbx
...
nop
xor $32617, %rsi
lea addresses_D_ht+0x19f89, %rsi
lea addresses_WT_ht+0x15789, %rdi
nop
nop
nop
nop
...
nop
sub $17462, %rbp
lea addresses_WT_ht+0x1e589, %rsi
add %rbp, %rbp
...
nop
cmp $23149, %r15
lea addresses_D_ht+0x3f89, %rsi
lea addresses_WT_ht+0x13789, %rdi
clflush (%rsi)
nop
xor $44101, %r11
mov $5, %rcx
...
nop
dec %r11
lea addresses_WT_ht+0x4f89, %rdi
nop
nop
sub %rcx, %rcx
movb $0x61, (%rdi)
nop
cmp %rbp, %rbp
lea addresses_WC_ht+0xcb09, %rbx
nop
nop
nop
nop
...
nop
sub $6001, %rsi
lea addresses_UC_ht+0x11659, %rbp
nop
nop
nop
nop
...
nop
xor %r15, %r15
lea addresses_UC_ht+0xfa29, %rsi
lea addresses_D_ht+0xe09, %rdi
nop
nop
nop
xor $7970, %r12
...
// Faulty Load
lea addresses_normal+0x12789, %r15
sub $48452, %rcx
movups (%r15), %xmm6
vpextrq $0, %xmm6, %rdx
lea oracles, %rcx
