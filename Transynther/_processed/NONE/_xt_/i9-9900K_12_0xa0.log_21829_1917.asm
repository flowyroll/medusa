...
push %rdx
push %rsi
lea addresses_normal_ht+0xaf62, %r13
nop
nop
add %rcx, %rcx
vmovups (%r13), %ymm6
...
nop
sub $34737, %rdx
lea addresses_A_ht+0x10562, %r10
clflush (%r10)
nop
nop
nop
...
nop
sub $33819, %r10
lea addresses_UC_ht+0x1dc22, %r10
nop
nop
nop
inc %rax
mov (%r10), %r12d
add $63173, %r13
lea addresses_WC_ht+0x5412, %r13
nop
nop
nop
nop
...
nop
and $55770, %r11
lea addresses_WC_ht+0x1c422, %rsi
lea addresses_UC_ht+0x1279e, %rdi
clflush (%rdi)
nop
nop
nop
...
nop
sub $53616, %rdi
lea addresses_UC_ht+0x13c22, %rsi
lea addresses_WT_ht+0x11c22, %rdi
nop
nop
nop
cmp %r12, %r12
...
nop
sub $41859, %r11
lea addresses_UC_ht+0x18c22, %rdi
nop
nop
nop
add %rdx, %rdx
movl $0x61626364, (%rdi)
and $31393, %r11
lea addresses_UC_ht+0x4cea, %rcx
nop
nop
nop
nop
...
nop
xor %r11, %r11
lea addresses_WT_ht+0x108c2, %rcx
nop
nop
xor $4318, %r13
mov (%rcx), %r10d
...
// Store
lea addresses_normal+0x11622, %r12
nop
nop
nop
nop
...
// Store
lea addresses_normal+0xc422, %r15
nop
nop
cmp $63843, %rax
movw $0x5152, (%r15)
...
{'src': {'same': False, 'congruent': 11, 'type': 'addresses_WC_ht'}, 'OP': 'REPM', 'dst': {'same': True, 'congruent': 1, 'type': 'addresses_UC_ht'}}
{'src': {'same': True, 'congruent': 11, 'type': 'addresses_UC_ht'}, 'OP': 'REPM', 'dst': {'same': False, 'congruent': 8, 'type': 'addresses_WT_ht'}}
{'OP': 'STOR', 'dst': {'NT': True, 'same': False, 'congruent': 11, 'type': 'addresses_UC_ht', 'AVXalign': False, 'size': 4}}
