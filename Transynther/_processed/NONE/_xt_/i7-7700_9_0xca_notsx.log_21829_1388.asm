...
nop
xor $40571, %r9
lea addresses_normal_ht+0xf726, %rsi
...
lea addresses_WT_ht+0x5378, %rdi
nop
nop
nop
nop
...
nop
dec %r13
lea addresses_D_ht+0x14e66, %rcx
nop
nop
nop
add $23453, %r9
...
nop
xor $45523, %rdi
lea addresses_A_ht+0x13d31, %rdi
clflush (%rdi)
nop
nop
nop
...
{'src': {'congruent': 4, 'same': False, 'type': 'addresses_normal_ht'}, 'dst': {'congruent': 10, 'same': False, 'type': 'addresses_D_ht'}, 'OP': 'REPM'}
...
{'dst': {'NT': True, 'AVXalign': False, 'size': 4, 'congruent': 4, 'same': True, 'type': 'addresses_D_ht'}, 'OP': 'STOR'}
