...
push %rdx
push %rsi
lea addresses_normal_ht+0x14a61, %r12
inc %rbx
...
nop
sub %rcx, %rcx
lea addresses_WC_ht+0x3ce1, %r15
nop
nop
nop
nop
...
nop
xor %rdx, %rdx
lea addresses_normal_ht+0x5fe1, %rsi
lea addresses_UC_ht+0x19529, %rdi
nop
xor $54061, %r13
mov $87, %rcx
rep movsw
...
nop
sub %rdx, %rdx
lea addresses_WT_ht+0x13221, %rdx
nop
and %r12, %r12
mov $0x6162636465666768, %rcx
movq %rcx, (%rdx)
cmp $32439, %rcx
lea addresses_WT_ht+0xcbd1, %rsi
clflush (%rsi)
nop
add $37620, %r8
...
nop
add %rcx, %rcx
lea addresses_WT_ht+0x1b7e1, %rsi
nop
nop
nop
nop
...
nop
add %r13, %r13
lea addresses_WT_ht+0x14e11, %r15
nop
nop
nop
nop
...
nop
xor $12836, %rdi
lea addresses_A_ht+0x189c1, %rdx
nop
nop
nop
xor %rsi, %rsi
...
// Store
lea addresses_normal+0x102e1, %rdi
sub %r13, %r13
movw $0x5152, (%rdi)
dec %rdi

// Store
lea addresses_US+0x189bd, %r13
clflush (%r13)
nop
nop
xor $2220, %rsi
...
{'OP': 'REPM', 'src': {'same': False, 'type': 'addresses_normal_ht', 'congruent': 10}, 'dst': {'same': True, 'type': 'addresses_UC_ht', 'congruent': 3}}
...
{'OP': 'STOR', 'dst': {'size': 8, 'NT': True, 'type': 'addresses_A_ht', 'same': False, 'AVXalign': False, 'congruent': 8}}
...
{'OP': 'STOR', 'dst': {'size': 4, 'NT': False, 'type': 'addresses_A_ht', 'same': False, 'AVXalign': True, 'congruent': 4}}
{'33': 21829}
