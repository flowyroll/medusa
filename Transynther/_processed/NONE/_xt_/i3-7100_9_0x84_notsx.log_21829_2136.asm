...
nop
xor $35305, %rcx
lea addresses_D_ht+0x15b2b, %r15
add $52015, %r13
mov (%r15), %dx
sub $65358, %r15
lea addresses_D_ht+0x172eb, %r13
nop
nop
xor %rax, %rax
movb $0x61, (%r13)
nop
sub $9415, %rax
lea addresses_A_ht+0x144cf, %r13
nop
cmp %rax, %rax
...
mov (%rax), %r15
and %rcx, %rcx
lea addresses_D_ht+0x1691b, %rsi
lea addresses_D_ht+0x1daeb, %rdi
nop
nop
nop
nop
...
rep movsw
sub %r13, %r13
lea addresses_normal_ht+0x1c485, %r13
nop
nop
nop
sub $55296, %rdx
...
nop
xor %r13, %r13
lea addresses_normal_ht+0xc073, %rcx
nop
nop
inc %r9
movb $0x61, (%rcx)
...
{'src': {'type': 'addresses_D_ht', 'congruent': 4, 'same': False}, 'dst': {'type': 'addresses_D_ht', 'congruent': 11, 'same': False}, 'OP': 'REPM'}
