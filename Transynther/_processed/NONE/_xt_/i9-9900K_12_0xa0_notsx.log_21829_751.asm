...
nop
xor $4792, %r9
lea addresses_WC_ht+0xc812, %r10
nop
nop
xor %r14, %r14
mov (%r10), %rdx
...
nop
add %rdx, %rdx
lea addresses_A_ht+0x88f2, %r9
nop
xor %r14, %r14
movw $0x6162, (%r9)
nop
add %r8, %r8
lea addresses_normal_ht+0x186b2, %r8
nop
nop
and $40493, %r14
movups (%r8), %xmm4
...
nop
cmp %r10, %r10
lea addresses_normal_ht+0xce12, %rsi
lea addresses_WT_ht+0xe5d2, %rdi
nop
nop
and $22399, %r8
mov $0, %rcx
...
nop
cmp $34018, %r9
lea addresses_UC_ht+0x19278, %rsi
lea addresses_UC_ht+0xfdb2, %rdi
and %r8, %r8
mov $41, %rcx
rep movsl
nop
...
// Faulty Load
lea addresses_normal+0x1ae12, %rbp
cmp $38865, %r15
movups (%rbp), %xmm1
vpextrq $1, %xmm1, %r12
lea oracles, %rbp
...
{'src': {'type': 'addresses_normal_ht', 'congruent': 11, 'same': False}, 'OP': 'REPM', 'dst': {'type': 'addresses_WT_ht', 'congruent': 2, 'same': False}}
{'OP': 'STOR', 'dst': {'type': 'addresses_D_ht', 'AVXalign': True, 'size': 32, 'NT': False, 'same': False, 'congruent': 6}}
{'src': {'type': 'addresses_UC_ht', 'congruent': 1, 'same': False}, 'OP': 'REPM', 'dst': {'type': 'addresses_UC_ht', 'congruent': 5, 'same': False}}
{'34': 21829}
