...
push %rdi
push %rsi
lea addresses_A_ht+0xa12c, %rsi
lea addresses_normal_ht+0x1134, %rdi
nop
dec %r10
mov $64, %rcx
rep movsl
add %r14, %r14
lea addresses_WT_ht+0xe50a, %r9
nop
nop
nop
nop
...
nop
add %r15, %r15
lea addresses_normal_ht+0x19b8c, %rcx
nop
nop
nop
nop
...
nop
and %rdi, %rdi
lea addresses_UC_ht+0x15544, %r10
nop
nop
nop
nop
...
nop
cmp $6049, %rcx
lea addresses_A_ht+0x16044, %rsi
lea addresses_WT_ht+0x8db4, %rdi
nop
xor $47140, %r13
mov $43, %rcx
rep movsl
...
nop
cmp %r14, %r14
lea addresses_D_ht+0x3a18, %rsi
lea addresses_WT_ht+0xa844, %rdi
nop
nop
nop
cmp $50945, %r10
...
nop
sub %r13, %r13
lea addresses_UC_ht+0x16544, %r9
nop
nop
nop
and %rsi, %rsi
