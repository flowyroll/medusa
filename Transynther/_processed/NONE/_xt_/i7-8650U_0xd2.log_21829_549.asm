...
push %rdx
push %rsi
lea addresses_normal_ht+0x11fd3, %rax
nop
nop
cmp $2635, %rdi
movb $0x61, (%rax)
...
nop
sub %rax, %rax
lea addresses_UC_ht+0x1eeeb, %rsi
lea addresses_A_ht+0xb1d3, %rdi
add $49044, %r14
mov $86, %rcx
rep movsl
nop
add %rcx, %rcx
lea addresses_WC_ht+0x12c53, %rdi
clflush (%rdi)
nop
nop
nop
...
lea addresses_D_ht+0x1ed4d, %rdi
nop
nop
nop
dec %r13
...
lea addresses_UC_ht+0xe24f, %rdi
nop
nop
xor $25021, %r13
mov $90, %rcx
...
lea addresses_WC_ht+0x8d93, %rdi
nop
nop
nop
nop
...
{'OP': 'REPM', 'src': {'type': 'addresses_WC_ht', 'congruent': 8, 'same': False}, 'dst': {'type': 'addresses_WC_ht', 'congruent': 6, 'same': True}}
