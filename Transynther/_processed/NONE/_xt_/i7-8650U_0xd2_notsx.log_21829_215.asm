...
push %rcx
push %rdx
lea addresses_WC_ht+0x1daa7, %r9
cmp %r13, %r13
movups (%r9), %xmm3
vpextrq $0, %xmm3, %r14
nop
...
nop
add %rbp, %rbp
lea addresses_normal_ht+0x63d9, %rax
nop
nop
and $52819, %rdx
movl $0x61626364, (%rax)
add %rbp, %rbp
lea addresses_UC_ht+0xa7a7, %r13
nop
nop
nop
and %r9, %r9
movw $0x6162, (%r13)
sub %r14, %r14
lea addresses_WC_ht+0x6bfb, %r13
nop
cmp %rdx, %rdx
...
{'OP': 'STOR', 'dst': {'type': 'addresses_A', 'size': 8, 'AVXalign': False, 'NT': True, 'congruent': 10, 'same': False}}
