...
push %rdi
push %rsi
lea addresses_UC_ht+0x18cc6, %rsi
lea addresses_A_ht+0x11661, %rdi
nop
sub %r11, %r11
mov $12, %rcx
rep movsw
...
// Store
lea addresses_normal+0x804c, %r13
sub %r10, %r10
movw $0x5152, (%r13)
add $38, %rsi

// Store
lea addresses_RW+0x5a16, %r10
nop
inc %r14
movl $0x51525354, (%r10)
nop
...
// Store
lea addresses_normal+0x1ae76, %r11
nop
nop
xor %r9, %r9
movl $0x51525354, (%r11)
