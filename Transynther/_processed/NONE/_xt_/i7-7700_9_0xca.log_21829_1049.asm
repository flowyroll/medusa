...
push %rdi
push %rsi
lea addresses_A_ht+0x679f, %rsi
lea addresses_UC_ht+0x9c67, %rdi
nop
nop
nop
and $9619, %r12
...
nop
xor %r13, %r13
lea addresses_WC_ht+0x149d9, %r10
nop
nop
nop
nop
...
nop
cmp $8122, %r10
lea addresses_UC_ht+0x17905, %rdi
nop
nop
xor $49678, %r15
...
nop
and %rsi, %rsi
lea addresses_normal_ht+0xa7d9, %rcx
nop
nop
nop
nop
...
nop
cmp $64324, %r13
lea addresses_WT_ht+0xd237, %r13
nop
nop
nop
nop
...
movw $0x6162, (%r13)
xor $15752, %r13
lea addresses_UC_ht+0x105ef, %rsi
lea addresses_UC_ht+0x1bc37, %rdi
nop
dec %r14
mov $43, %rcx
rep movsl
...
nop
cmp $14562, %r13
lea addresses_normal_ht+0xdb77, %r10
nop
nop
and %rcx, %rcx
movb $0x61, (%r10)
sub %rcx, %rcx
lea addresses_A_ht+0xdcb7, %rsi
lea addresses_D_ht+0xfeb7, %rdi
nop
nop
xor $44615, %r12
mov $29, %rcx
...
{'OP': 'STOR', 'dst': {'congruent': 1, 'AVXalign': False, 'same': False, 'size': 32, 'NT': True, 'type': 'addresses_UC_ht'}}
...
{'src': {'congruent': 3, 'same': False, 'type': 'addresses_UC_ht'}, 'OP': 'REPM', 'dst': {'congruent': 8, 'same': False, 'type': 'addresses_UC_ht'}}
{'OP': 'STOR', 'dst': {'congruent': 6, 'AVXalign': False, 'same': False, 'size': 1, 'NT': False, 'type': 'addresses_normal_ht'}}
{'src': {'congruent': 7, 'same': False, 'type': 'addresses_A_ht'}, 'OP': 'REPM', 'dst': {'congruent': 7, 'same': False, 'type': 'addresses_D_ht'}}
