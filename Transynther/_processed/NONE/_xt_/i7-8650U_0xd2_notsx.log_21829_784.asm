...
push %rdi
push %rsi
lea addresses_normal_ht+0x1e959, %r10
and %rdi, %rdi
...
nop
add $34494, %rsi
lea addresses_UC_ht+0x16c38, %rsi
lea addresses_UC_ht+0xe288, %rdi
inc %rax
mov $33, %rcx
rep movsw
add $41607, %rcx
lea addresses_WT_ht+0xd618, %rsi
lea addresses_normal_ht+0x70d8, %rdi
nop
nop
nop
nop
...
rep movsb
add $55492, %r10
lea addresses_UC_ht+0x19a08, %r11
nop
xor %rbp, %rbp
movl $0x61626364, (%r11)
nop
nop
add $41006, %r10
lea addresses_WC_ht+0x18d88, %r10
cmp $12707, %r11
...
nop
xor %r10, %r10
lea addresses_WT_ht+0xae88, %rsi
cmp $3210, %rbp
movups (%rsi), %xmm1
vpextrq $1, %xmm1, %r10
nop
nop
inc %r11
lea addresses_WT_ht+0x6088, %r11
nop
inc %rsi
movl $0x61626364, (%r11)
nop
nop
cmp %rcx, %rcx
lea addresses_normal_ht+0x17d6a, %rsi
lea addresses_WC_ht+0x11588, %rdi
clflush (%rdi)
nop
and $39875, %r15
mov $37, %rcx
...
nop
cmp $59046, %r15
lea addresses_WC_ht+0xad88, %r11
nop
nop
nop
nop
...
nop
cmp $5807, %rbp
lea addresses_UC_ht+0x17bd0, %rdi
clflush (%rdi)
nop
nop
nop
...
movl $0x61626364, (%rdi)
cmp $20872, %rsi
lea addresses_WT_ht+0x18938, %rcx
nop
nop
nop
nop
...
nop
add $10397, %rcx
lea addresses_WC_ht+0xe008, %rsi
lea addresses_WC_ht+0x1846a, %rdi
clflush (%rdi)
nop
nop
nop
...
nop
inc %rcx
lea addresses_WC_ht+0x1ee48, %rsi
...
// Faulty Load
lea addresses_normal+0xd88, %rsi
nop
nop
and %rdx, %rdx
vmovups (%rsi), %ymm0
...
{'OP': 'REPM', 'src': {'type': 'addresses_WT_ht', 'congruent': 4, 'same': False}, 'dst': {'type': 'addresses_normal_ht', 'congruent': 4, 'same': True}}
...
{'OP': 'REPM', 'src': {'type': 'addresses_normal_ht', 'congruent': 0, 'same': False}, 'dst': {'type': 'addresses_WC_ht', 'congruent': 9, 'same': False}}
