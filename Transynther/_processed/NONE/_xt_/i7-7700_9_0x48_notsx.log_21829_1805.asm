...
nop
and %rdx, %rdx
lea addresses_WC_ht+0xb753, %rdi
nop
nop
inc %r10
...
nop
add %rcx, %rcx
lea addresses_WC_ht+0x3bef, %r10
nop
nop
nop
nop
...
nop
add %rdx, %rdx
lea addresses_WT_ht+0x159af, %rsi
lea addresses_normal_ht+0xc5ef, %rdi
clflush (%rsi)
clflush (%rdi)
nop
nop
...
lea addresses_normal_ht+0x746f, %rdi
nop
nop
nop
nop
...
nop
add $52701, %r10
lea addresses_normal_ht+0x11aef, %rsi
lea addresses_A_ht+0xe5ef, %rdi
nop
nop
nop
dec %r12
...
nop
inc %rdi
lea addresses_normal_ht+0x924f, %rdx
nop
nop
nop
nop
...
{'dst': {'same': True, 'NT': False, 'AVXalign': False, 'size': 8, 'type': 'addresses_WC_ht', 'congruent': 9}, 'OP': 'STOR'}
{'dst': {'same': False, 'congruent': 10, 'type': 'addresses_normal_ht'}, 'OP': 'REPM', 'src': {'same': False, 'congruent': 6, 'type': 'addresses_WT_ht'}}
{'dst': {'same': False, 'congruent': 7, 'type': 'addresses_normal_ht'}, 'OP': 'REPM', 'src': {'same': False, 'congruent': 3, 'type': 'addresses_WT_ht'}}
{'dst': {'same': False, 'congruent': 11, 'type': 'addresses_A_ht'}, 'OP': 'REPM', 'src': {'same': False, 'congruent': 8, 'type': 'addresses_normal_ht'}}
{'dst': {'same': False, 'NT': True, 'AVXalign': False, 'size': 16, 'type': 'addresses_normal_ht', 'congruent': 5}, 'OP': 'STOR'}
{'33': 21829}
