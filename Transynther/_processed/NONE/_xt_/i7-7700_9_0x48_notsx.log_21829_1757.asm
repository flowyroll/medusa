...
push %rdx
push %rsi
lea addresses_UC_ht+0xf891, %rsi
lea addresses_normal_ht+0x6827, %rdi
clflush (%rdi)
nop
nop
nop
...
nop
xor %rdi, %rdi
lea addresses_WC_ht+0x8b7f, %r13
inc %r8
movb (%r13), %r10b
nop
nop
...
nop
add %rdx, %rdx
lea addresses_D_ht+0x1cd27, %rsi
nop
nop
nop
nop
...
movl $0x61626364, (%rsi)
dec %rsi
lea addresses_WC_ht+0x1e647, %r10
clflush (%r10)
nop
nop
sub %r8, %r8
...
vmovups %ymm6, (%r10)
add $48289, %r8
lea addresses_UC_ht+0x17ec7, %rsi
nop
nop
nop
and $18500, %rdi
mov (%rsi), %r13d
and %r8, %r8
lea addresses_WT_ht+0x1ca47, %rdi
nop
xor $57688, %rcx
...
nop
add $36092, %rdi
lea addresses_D_ht+0x121af, %rdx
nop
nop
nop
nop
...
// Faulty Load
lea addresses_normal+0x5447, %rdx
nop
nop
add $46334, %r15
mov (%rdx), %r11d
...
<gen_prepare_buffer>
{'dst': {'same': False, 'congruent': 5, 'type': 'addresses_normal_ht'}, 'OP': 'REPM', 'src': {'same': False, 'congruent': 0, 'type': 'addresses_UC_ht'}}
