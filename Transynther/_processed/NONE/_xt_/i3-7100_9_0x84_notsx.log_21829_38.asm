...
push %rdi
push %rsi
lea addresses_WC_ht+0x52f9, %rsi
lea addresses_normal_ht+0x15f9, %rdi
nop
nop
nop
cmp $55250, %r14
...
nop
xor $3155, %r9
lea addresses_WC_ht+0x2d79, %rsi
lea addresses_normal_ht+0x18e3d, %rdi
xor %r13, %r13
mov $95, %rcx
rep movsl
dec %rdi
lea addresses_normal_ht+0xd3f9, %rsi
cmp %rax, %rax
mov (%rsi), %r13d
nop
nop
and $1417, %r13
lea addresses_D_ht+0x6bf9, %rsi
dec %rdi
movw $0x6162, (%rsi)
nop
nop
...
nop
dec %rax
lea addresses_D_ht+0x1a9d9, %rsi
lea addresses_D_ht+0xa7f9, %rdi
nop
nop
nop
nop
...
rep movsb
cmp %rdi, %rdi
lea addresses_D_ht+0x17991, %rsi
lea addresses_normal_ht+0x15ff9, %rdi
nop
nop
nop
nop
...
// Faulty Load
lea addresses_normal+0xd3f9, %rbp
nop
nop
nop
and %r15, %r15
...
{'src': {'type': 'addresses_D_ht', 'congruent': 2, 'same': False}, 'dst': {'type': 'addresses_normal_ht', 'congruent': 7, 'same': False}, 'OP': 'REPM'}
