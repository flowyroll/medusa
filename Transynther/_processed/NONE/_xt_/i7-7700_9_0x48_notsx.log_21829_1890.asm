...
push %rdx
push %rsi
lea addresses_WC_ht+0xf450, %r10
and $3339, %r15
vmovups (%r10), %ymm1
...
nop
inc %r15
lea addresses_D_ht+0x7daa, %rsi
lea addresses_normal_ht+0x5af2, %rdi
nop
nop
nop
nop
...
nop
and %rdx, %rdx
lea addresses_normal_ht+0x1badf, %r10
nop
nop
and %rcx, %rcx
mov (%r10), %rdx
...
nop
add %rsi, %rsi
lea addresses_normal_ht+0x13df2, %r15
nop
nop
nop
nop
...
movw $0x6162, (%rdi)
cmp $12976, %rcx
lea addresses_WC_ht+0x8bf2, %rsi
lea addresses_A_ht+0x167f2, %rdi
nop
nop
nop
nop
...
rep movsl
add $34781, %r15
lea addresses_UC_ht+0x1eff2, %rcx
nop
nop
nop
nop
...
{'dst': {'same': False, 'congruent': 1, 'type': 'addresses_NC'}, 'OP': 'REPM', 'src': {'same': False, 'congruent': 6, 'type': 'addresses_P'}}
[Faulty Load]
...
{'dst': {'same': False, 'congruent': 11, 'type': 'addresses_A_ht'}, 'OP': 'REPM', 'src': {'same': False, 'congruent': 9, 'type': 'addresses_WC_ht'}}
