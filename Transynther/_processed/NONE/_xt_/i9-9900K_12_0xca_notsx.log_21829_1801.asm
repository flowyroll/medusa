...
push %rdi
push %rsi
lea addresses_WC_ht+0x180dc, %rsi
lea addresses_WT_ht+0x4e7c, %rdi
xor $53438, %r8
mov $4, %rcx
rep movsw
nop
sub $25866, %rbx
lea addresses_WT_ht+0x317c, %r10
sub %rbp, %rbp
...
nop
dec %rdi
lea addresses_WT_ht+0xc4fc, %rsi
nop
nop
nop
and %rbp, %rbp
...
nop
inc %rbp
lea addresses_D_ht+0x11abc, %r10
cmp $41131, %rsi
movl $0x61626364, (%r10)
nop
nop
