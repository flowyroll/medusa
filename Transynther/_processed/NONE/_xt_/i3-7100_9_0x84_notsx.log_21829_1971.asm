...
nop
inc %r8
lea addresses_A_ht+0x234c, %rsi
lea addresses_WT_ht+0x8b34, %rdi
sub $15877, %r12
mov $25, %rcx
rep movsb
nop
cmp %rbx, %rbx
lea addresses_normal_ht+0x50b0, %rsi
lea addresses_WT_ht+0x304c, %rdi
nop
nop
nop
nop
...
nop
sub $35032, %r8
lea addresses_WT_ht+0x234c, %rbx
xor $62850, %rdi
movl $0x61626364, (%rbx)
inc %r8
lea addresses_WT_ht+0x15b4c, %r11
nop
nop
sub $44969, %rbx
...
nop
and %r12, %r12
lea addresses_WT_ht+0x120cc, %rsi
lea addresses_WT_ht+0xa64c, %rdi
nop
nop
sub %rbx, %rbx
mov $52, %rcx
...
nop
and $23035, %rdi
lea addresses_UC_ht+0x426c, %rbx
sub %r8, %r8
movl $0x61626364, (%rbx)
nop
nop
...
{'src': {'type': 'addresses_A_ht', 'congruent': 7, 'same': True}, 'dst': {'type': 'addresses_WT_ht', 'congruent': 3, 'same': True}, 'OP': 'REPM'}
