...
push %rdi
push %rsi
lea addresses_D_ht+0x1a3e6, %r12
clflush (%r12)
nop
nop
and $61441, %rbp
...
nop
cmp $35083, %r10
lea addresses_A_ht+0xac1e, %rsi
lea addresses_normal_ht+0x170cf, %rdi
cmp $9655, %rbx
mov $62, %rcx
rep movsl
nop
...
nop
add $17319, %rcx
lea addresses_WC_ht+0x137a6, %rbx
clflush (%rbx)
nop
nop
inc %r14
...
nop
sub %r14, %r14
lea addresses_WC_ht+0xb242, %r12
nop
nop
inc %rcx
movb (%r12), %bl
...
nop
and $44568, %rbp
lea addresses_A_ht+0x188e6, %rsi
add $53502, %r10
movb $0x61, (%rsi)
cmp %rcx, %rcx
lea addresses_D_ht+0xa316, %r12
nop
nop
nop
nop
...
nop
sub $24565, %r14
lea addresses_A_ht+0x14347, %r12
nop
nop
nop
nop
...
nop
and %rcx, %rcx
lea addresses_UC_ht+0x1cca6, %rbp
clflush (%rbp)
nop
cmp $35100, %r14
vmovups (%rbp), %ymm4
...
nop
and %rdi, %rdi
lea addresses_normal_ht+0x15a6, %rbp
clflush (%rbp)
sub $12131, %rbx
mov $0x6162636465666768, %r14
movq %r14, %xmm5
...
nop
xor $4703, %rcx
lea addresses_A_ht+0x17196, %r10
nop
nop
nop
nop
...
nop
sub $32079, %rbx
lea addresses_UC_ht+0x1a182, %rbp
nop
nop
nop
nop
...
movb (%rbp), %cl
and $4942, %rdi
lea addresses_A_ht+0x8ba6, %rsi
lea addresses_WC_ht+0x3fde, %rdi
nop
nop
nop
nop
...
nop
and $7780, %r12
lea addresses_A_ht+0x48e6, %rsi
lea addresses_WT_ht+0x2c76, %rdi
nop
and $4321, %r12
mov $109, %rcx
rep movsw
...
// Load
lea addresses_normal+0x17526, %rcx
nop
nop
nop
nop
...
{'src': {'type': 'addresses_D_ht', 'same': False, 'size': 32, 'congruent': 4, 'NT': True, 'AVXalign': True}, 'OP': 'LOAD'}
{'src': {'type': 'addresses_A_ht', 'same': False, 'size': 32, 'congruent': 0, 'NT': True, 'AVXalign': False}, 'OP': 'LOAD'}
...
{'src': {'type': 'addresses_A_ht', 'congruent': 5, 'same': True}, 'dst': {'type': 'addresses_WC_ht', 'congruent': 2, 'same': False}, 'OP': 'REPM'}
