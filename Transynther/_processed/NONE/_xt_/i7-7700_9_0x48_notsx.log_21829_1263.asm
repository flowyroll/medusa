...
lea addresses_normal_ht+0x57dc, %rdi
nop
nop
nop
nop
...
nop
lfence
lea addresses_A_ht+0x622e, %rsi
lea addresses_D_ht+0x84dc, %rdi
nop
sub $35406, %rdx
mov $123, %rcx
rep movsb
...
{'OP': 'LOAD', 'src': {'same': False, 'NT': False, 'AVXalign': False, 'size': 2, 'type': 'addresses_RW', 'congruent': 10}}
[Faulty Load]
...
{'dst': {'same': False, 'congruent': 9, 'type': 'addresses_D_ht'}, 'OP': 'REPM', 'src': {'same': False, 'congruent': 0, 'type': 'addresses_A_ht'}}
{'39': 21829}
