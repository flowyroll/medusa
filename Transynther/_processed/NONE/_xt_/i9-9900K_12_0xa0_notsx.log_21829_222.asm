...
push %rdi
push %rsi
lea addresses_WC_ht+0xe926, %r12
nop
nop
nop
nop
...
nop
and $28757, %rax
lea addresses_normal_ht+0x511a, %rax
nop
nop
nop
sub %rsi, %rsi
...
nop
sub $62103, %r12
lea addresses_UC_ht+0xae26, %r10
nop
sub %r8, %r8
movb (%r10), %al
nop
...
nop
xor $62929, %r12
lea addresses_UC_ht+0x16d1c, %rsi
lea addresses_WC_ht+0xd02e, %rdi
nop
nop
nop
nop
...
nop
sub %r12, %r12
lea addresses_WT_ht+0xb426, %rcx
nop
cmp $47305, %rsi
movl $0x61626364, (%rcx)
nop
...
{'src': {'type': 'addresses_normal_ht', 'AVXalign': False, 'size': 1, 'NT': True, 'same': False, 'congruent': 1}, 'OP': 'LOAD'}
...
{'src': {'type': 'addresses_UC_ht', 'congruent': 1, 'same': False}, 'OP': 'REPM', 'dst': {'type': 'addresses_WC_ht', 'congruent': 3, 'same': False}}
