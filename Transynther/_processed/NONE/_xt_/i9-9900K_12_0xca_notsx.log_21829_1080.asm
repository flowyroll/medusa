...
push %r9
push %rax
lea addresses_normal_ht+0x71eb, %r15
nop
nop
cmp %r12, %r12
mov (%r15), %r9
...
nop
xor $19062, %r8
lea addresses_A_ht+0x10e4b, %rax
clflush (%rax)
nop
nop
xor $55981, %r8
...
nop
sub %rax, %rax
lea addresses_normal_ht+0x37ab, %r12
nop
nop
nop
nop
...
nop
xor $26915, %r8
lea addresses_WC_ht+0x4e4b, %r9
clflush (%r9)
inc %r8
movw $0x6162, (%r9)
dec %r11
lea addresses_normal_ht+0x16a4b, %r9
nop
xor $18509, %r15
movb $0x61, (%r9)
nop
...
nop
sub $36632, %r14
lea addresses_UC_ht+0x123ab, %r11
nop
nop
inc %r12
movb $0x61, (%r11)
...
{'OP': 'STOR', 'dst': {'same': False, 'type': 'addresses_WC_ht', 'NT': False, 'AVXalign': True, 'size': 2, 'congruent': 10}}
{'OP': 'STOR', 'dst': {'same': True, 'type': 'addresses_normal_ht', 'NT': False, 'AVXalign': False, 'size': 1, 'congruent': 11}}
