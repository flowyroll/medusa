...
push %rdx
push %rsi
lea addresses_UC_ht+0x1cf2d, %rsi
lea addresses_WC_ht+0x156ad, %rdi
nop
nop
nop
nop
...
nop
inc %rcx
lea addresses_UC_ht+0x9885, %rax
nop
nop
nop
nop
...
nop
xor $16553, %rdx
lea addresses_UC_ht+0xb78d, %rdx
nop
xor $13544, %rax
movl $0x61626364, (%rdx)
nop
...
nop
dec %r10
lea addresses_normal_ht+0x33d7, %rsi
lea addresses_D_ht+0x130ad, %rdi
nop
nop
nop
dec %r9
...
lea addresses_WT_ht+0x140ad, %rdi
nop
nop
nop
inc %r9
...
nop
cmp $57980, %r9
lea addresses_WT_ht+0x1d24b, %rsi
lea addresses_D_ht+0xd30a, %rdi
nop
nop
sub $29849, %r10
mov $59, %rcx
...
nop
inc %rcx
lea addresses_normal_ht+0x194ad, %rax
nop
nop
dec %r10
mov (%rax), %cx
...
lea addresses_normal_ht+0x1e745, %rdi
nop
nop
nop
cmp %rdx, %rdx
...
nop
cmp %rax, %rax
lea addresses_A_ht+0x10ced, %rcx
nop
nop
inc %r9
...
// Faulty Load
lea addresses_normal+0x78ad, %r13
nop
nop
nop
add %rbx, %rbx
...
<gen_prepare_buffer>
{'src': {'congruent': 7, 'same': False, 'type': 'addresses_UC_ht'}, 'dst': {'congruent': 8, 'same': False, 'type': 'addresses_WC_ht'}, 'OP': 'REPM'}
...
{'src': {'congruent': 5, 'same': True, 'type': 'addresses_D_ht'}, 'dst': {'congruent': 9, 'same': False, 'type': 'addresses_WT_ht'}, 'OP': 'REPM'}
...
{'src': {'congruent': 2, 'same': False, 'type': 'addresses_D_ht'}, 'dst': {'congruent': 3, 'same': False, 'type': 'addresses_normal_ht'}, 'OP': 'REPM'}
{'dst': {'NT': True, 'AVXalign': True, 'size': 16, 'congruent': 5, 'same': False, 'type': 'addresses_A_ht'}, 'OP': 'STOR'}
