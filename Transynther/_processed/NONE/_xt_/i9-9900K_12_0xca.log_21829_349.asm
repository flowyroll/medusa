...
lea addresses_WC_ht+0x11d3a, %rdi
clflush (%rsi)
nop
nop
nop
...
nop
xor %r12, %r12
lea addresses_normal_ht+0x83d2, %rsi
lea addresses_WC_ht+0xb2fa, %rdi
nop
nop
sub %r13, %r13
mov $105, %rcx
...
nop
sub %rsi, %rsi
lea addresses_UC_ht+0xea7a, %rbx
nop
sub %rdx, %rdx
...
nop
sub $29485, %rsi
lea addresses_normal_ht+0x46ea, %r12
and $17594, %rsi
mov (%r12), %r13d
nop
nop
...
nop
and %rbx, %rbx
lea addresses_normal_ht+0xa8fa, %r12
nop
dec %rbx
movups (%r12), %xmm7
vpextrq $1, %xmm7, %rdi
...
nop
cmp $43156, %rsi
lea addresses_A_ht+0x1c93a, %rdx
nop
nop
nop
nop
...
// Faulty Load
lea addresses_normal+0x16cfa, %r10
nop
sub %rdi, %rdi
movb (%r10), %r9b
lea oracles, %rdi
...
<gen_faulty_load>
[REF]
{'OP': 'LOAD', 'src': {'size': 1, 'NT': True, 'type': 'addresses_normal', 'same': False, 'AVXalign': False, 'congruent': 0}}
...
{'OP': 'REPM', 'src': {'same': False, 'type': 'addresses_WC_ht', 'congruent': 10}, 'dst': {'same': False, 'type': 'addresses_WC_ht', 'congruent': 6}}
