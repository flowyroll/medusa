...
push %rdi
push %rsi
lea addresses_D_ht+0x57cf, %r13
xor $63037, %rbx
mov (%r13), %eax
nop
mfence
lea addresses_D_ht+0xd24f, %rsi
lea addresses_WC_ht+0x13bcf, %rdi
clflush (%rsi)
nop
nop
nop
...
rep movsw
cmp $19781, %rax
lea addresses_WC_ht+0xf0af, %rcx
nop
nop
dec %rax
mov (%rcx), %di
...
nop
and %r12, %r12
lea addresses_normal_ht+0xc987, %r12
inc %r13
...
nop
dec %r13
lea addresses_D_ht+0x7fcf, %rsi
lea addresses_UC_ht+0x528d, %rdi
nop
nop
nop
nop
...
nop
and $57172, %rsi
lea addresses_WT_ht+0x100cf, %rcx
nop
nop
nop
xor $20476, %rsi
...
nop
inc %rcx
lea addresses_WC_ht+0xbd33, %rcx
clflush (%rcx)
nop
nop
dec %rsi
...
nop
cmp $51633, %r12
lea addresses_WC_ht+0x1dbcf, %rsi
lea addresses_normal_ht+0xabcf, %rdi
nop
nop
nop
sub %r14, %r14
...
{'src': {'type': 'addresses_D_ht', 'congruent': 7, 'same': True}, 'OP': 'REPM', 'dst': {'type': 'addresses_WC_ht', 'congruent': 10, 'same': False}}
...
{'OP': 'STOR', 'dst': {'same': True, 'congruent': 10, 'NT': False, 'type': 'addresses_D_ht', 'size': 8, 'AVXalign': False}}
{'OP': 'STOR', 'dst': {'same': False, 'congruent': 2, 'NT': False, 'type': 'addresses_WC_ht', 'size': 32, 'AVXalign': False}}
{'src': {'type': 'addresses_WC_ht', 'congruent': 9, 'same': False}, 'OP': 'REPM', 'dst': {'type': 'addresses_normal_ht', 'congruent': 10, 'same': True}}
{'38': 21829}
