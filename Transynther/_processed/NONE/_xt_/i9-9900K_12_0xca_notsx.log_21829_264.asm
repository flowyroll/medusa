...
nop
dec %r11
lea addresses_WT_ht+0x1a142, %rdx
inc %r13
mov (%rdx), %r15
nop
nop
...
lea addresses_normal_ht+0x112dc, %rdi
nop
nop
nop
nop
...
rep movsq
cmp %r13, %r13
lea addresses_D_ht+0x1c75c, %rcx
nop
nop
cmp %r11, %r11
vmovups (%rcx), %ymm7
...
vpextrq $1, %xmm7, %r15
add $17163, %rdi
lea addresses_WT_ht+0x1b15c, %rsi
lea addresses_WT_ht+0x85ec, %rdi
nop
nop
xor $59629, %r15
mov $59, %rcx
