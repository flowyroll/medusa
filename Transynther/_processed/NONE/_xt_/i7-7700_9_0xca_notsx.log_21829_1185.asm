...
push %rdi
push %rsi
lea addresses_normal_ht+0x1527e, %rsi
lea addresses_WT_ht+0x7b6d, %rdi
nop
nop
nop
nop
...
nop
inc %r12
lea addresses_WT_ht+0xafd6, %r10
nop
nop
xor %rdi, %rdi
movw $0x6162, (%r10)
nop
sub %rcx, %rcx
lea addresses_A_ht+0x171b6, %rcx
inc %r15
...
nop
xor %r15, %r15
lea addresses_WC_ht+0xa22e, %r10
nop
nop
nop
nop
...
nop
xor $26396, %r12
lea addresses_WC_ht+0x15cd6, %r12
nop
nop
nop
nop
...
vpextrq $0, %xmm3, %rsi
add $44230, %r10
lea addresses_normal_ht+0xc0b6, %rcx
nop
nop
dec %rax
movw $0x6162, (%rcx)
...
nop
add %rdi, %rdi
lea addresses_WC_ht+0x879e, %rdi
nop
nop
nop
nop
...
nop
sub $6859, %rsi
lea addresses_normal_ht+0xa3d6, %r12
cmp %r15, %r15
