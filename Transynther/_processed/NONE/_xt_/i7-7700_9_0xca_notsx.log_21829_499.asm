...
lea addresses_WT_ht+0xa324, %rdi
nop
nop
inc %r15
mov $109, %rcx
rep movsw
add %rbx, %rbx
lea addresses_D_ht+0x11a90, %rsi
lea addresses_A_ht+0x15314, %rdi
nop
nop
nop
inc %rbp
...
nop
add $49853, %rbp
lea addresses_WT_ht+0x15da4, %rbx
nop
nop
and $64943, %rcx
...
nop
sub $30231, %rcx
lea addresses_WT_ht+0x176d4, %rsi
lea addresses_D_ht+0x64, %rdi
clflush (%rsi)
nop
nop
inc %rax
...
nop
sub $54346, %r11
lea addresses_UC_ht+0x82a4, %rsi
...
rep movsq
dec %rbx
lea addresses_normal_ht+0x1524, %rcx
nop
nop
nop
nop
...
nop
add $37422, %r15
lea addresses_WT_ht+0x14012, %r15
sub $59766, %rcx
mov $0x6162636465666768, %r11
movq %r11, (%r15)
nop
add $15187, %rax
lea addresses_WC_ht+0x2a4, %r15
nop
nop
sub $65285, %rdi
movb (%r15), %cl
dec %rbx
lea addresses_WT_ht+0x1da4, %rax
nop
nop
nop
nop
...
// Faulty Load
lea addresses_normal+0x1d6a4, %rdx
cmp $5280, %r15
mov (%rdx), %ebp
lea oracles, %r12
and $0xff, %rbp
...
{'src': {'congruent': 1, 'same': True, 'type': 'addresses_WC_ht'}, 'dst': {'congruent': 7, 'same': False, 'type': 'addresses_WT_ht'}, 'OP': 'REPM'}
...
{'src': {'congruent': 2, 'same': True, 'type': 'addresses_WT_ht'}, 'dst': {'congruent': 5, 'same': False, 'type': 'addresses_D_ht'}, 'OP': 'REPM'}
