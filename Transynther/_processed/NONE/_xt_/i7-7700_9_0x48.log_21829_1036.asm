...
push %rdi
push %rsi
lea addresses_D_ht+0x1840a, %rsi
lea addresses_D_ht+0xc3ae, %rdi
nop
nop
nop
and $43748, %r15
...
nop
sub %rsi, %rsi
lea addresses_normal_ht+0x5aec, %rsi
lea addresses_WC_ht+0xdb2c, %rdi
xor $5921, %r14
mov $97, %rcx
rep movsb
nop
sub $57969, %r15
lea addresses_normal_ht+0x1ef6c, %r9
nop
nop
xor $22627, %r13
...
// Faulty Load
lea addresses_normal+0x9ec, %rcx
sub $47909, %r9
movb (%rcx), %al
lea oracles, %r13
and $0xff, %rax
...
<gen_prepare_buffer>
{'OP': 'REPM', 'src': {'type': 'addresses_D_ht', 'congruent': 0, 'same': False}, 'dst': {'type': 'addresses_D_ht', 'congruent': 0, 'same': True}}
