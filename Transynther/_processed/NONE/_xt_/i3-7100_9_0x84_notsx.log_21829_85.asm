...
push %rdi
push %rsi
lea addresses_UC_ht+0x370d, %rsi
nop
nop
xor %r11, %r11
movw $0x6162, (%rsi)
nop
cmp %r12, %r12
lea addresses_WC_ht+0x1be0d, %r12
clflush (%r12)
nop
nop
nop
...
nop
and $15747, %rbp
lea addresses_A_ht+0x1448d, %rsi
lea addresses_A_ht+0xd10d, %rdi
nop
sub %r8, %r8
mov $7, %rcx
rep movsb
...
nop
and %rsi, %rsi
lea addresses_WT_ht+0x250d, %rcx
nop
nop
and %rdi, %rdi
movb $0x61, (%rcx)
...
lea addresses_D_ht+0x1720d, %rdi
nop
nop
nop
nop
...
// REPMOV
lea addresses_A+0x56e5, %rsi
lea addresses_UC+0x191cd, %rdi
nop
nop
cmp %rbx, %rbx
mov $111, %rcx
...
{'src': {'type': 'addresses_A_ht', 'congruent': 6, 'same': False}, 'dst': {'type': 'addresses_A_ht', 'congruent': 8, 'same': False}, 'OP': 'REPM'}
