...
push %rdx
push %rsi
lea addresses_WC_ht+0x13b0c, %r8
clflush (%r8)
nop
nop
cmp %r13, %r13
...
lea addresses_WT_ht+0x1650c, %rdi
nop
nop
nop
nop
...
nop
xor $10255, %rsi
lea addresses_WC_ht+0x1c80c, %r8
add $45250, %rdi
movl $0x61626364, (%r8)
nop
cmp $7037, %rcx
lea addresses_WC_ht+0x1b634, %r8
nop
nop
dec %rdi
vmovups (%r8), %ymm4
...
nop
add %rcx, %rcx
lea addresses_normal_ht+0xd28, %r8
nop
nop
inc %rdx
...
nop
and %rdx, %rdx
lea addresses_A_ht+0x1054, %rsi
add %r9, %r9
mov $0x6162636465666768, %rcx
movq %rcx, %xmm5
vmovups %ymm5, (%rsi)
and $4407, %r9
lea addresses_UC_ht+0x6f8e, %rcx
nop
nop
nop
nop
...
nop
add $33055, %r9
lea addresses_UC_ht+0x1db0c, %rcx
nop
nop
nop
nop
...
nop
sub %r13, %r13
lea addresses_WC_ht+0x1950c, %r8
nop
nop
nop
nop
...
// Store
lea addresses_normal+0x1ab0c, %r10
and %r9, %r9
movl $0x51525354, (%r10)
nop
nop
...
{'OP': 'STOR', 'dst': {'type': 'addresses_normal', 'AVXalign': False, 'size': 4, 'NT': True, 'same': False, 'congruent': 11}}
[Faulty Load]
...
{'src': {'type': 'addresses_A_ht', 'AVXalign': False, 'size': 1, 'NT': False, 'same': True, 'congruent': 5}, 'OP': 'LOAD'}
