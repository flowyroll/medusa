...
push %rdi
push %rsi
lea addresses_UC_ht+0x4d1b, %rsi
lea addresses_A_ht+0xce99, %rdi
nop
nop
nop
nop
...
nop
inc %rdi
lea addresses_WC_ht+0x15093, %r12
nop
nop
nop
nop
...
nop
and $5176, %rdi
lea addresses_A_ht+0x1a093, %rsi
lea addresses_WC_ht+0x15553, %rdi
nop
nop
nop
nop
...
nop
sub %r12, %r12
lea addresses_WT_ht+0x7c93, %r11
nop
nop
xor $42150, %r9
mov (%r11), %edi
nop
inc %rdi
lea addresses_WT_ht+0x4c93, %rbx
clflush (%rbx)
nop
sub %rcx, %rcx
...
nop
sub $268, %rcx
lea addresses_UC_ht+0xcfd3, %rsi
...
nop
sub %r12, %r12
lea addresses_UC_ht+0x1e8d3, %rsi
lea addresses_D_ht+0x1156f, %rdi
nop
and %rbx, %rbx
mov $10, %rcx
rep movsb
...
vmovups %ymm4, (%rdi)
dec %rcx
lea addresses_WC_ht+0x19c93, %rsi
lea addresses_A_ht+0x6d13, %rdi
nop
sub %r11, %r11
mov $126, %rcx
rep movsl
...
// Faulty Load
lea addresses_normal+0x17493, %r15
add %rbp, %rbp
movb (%r15), %dl
lea oracles, %rcx
and $0xff, %rdx
...
<gen_prepare_buffer>
{'OP': 'REPM', 'src': {'type': 'addresses_UC_ht', 'congruent': 3, 'same': False}, 'dst': {'type': 'addresses_A_ht', 'congruent': 1, 'same': True}}
