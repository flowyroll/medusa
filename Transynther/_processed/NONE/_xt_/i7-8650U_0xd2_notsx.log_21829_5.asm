...
push %rdi
push %rsi
lea addresses_D_ht+0xa60, %rsi
lea addresses_WC_ht+0x16538, %rdi
nop
nop
inc %r15
mov $99, %rcx
...
nop
inc %r15
lea addresses_normal_ht+0x1b100, %rbx
nop
nop
nop
nop
...
nop
cmp $1811, %rsi
lea addresses_WT_ht+0x15380, %r15
clflush (%r15)
nop
nop
sub %rcx, %rcx
