...
push %rdi
push %rsi
lea addresses_A_ht+0x1d5fb, %rsi
nop
nop
nop
add $12008, %r13
...
nop
sub %rcx, %rcx
lea addresses_WC_ht+0xe97b, %rbx
nop
add %r12, %r12
...
nop
xor $40008, %rdi
lea addresses_D_ht+0xd9eb, %rsi
lea addresses_WC_ht+0x8d3, %rdi
nop
nop
nop
sub $23733, %rbp
...
nop
xor %rbp, %rbp
lea addresses_D_ht+0x1265c, %r13
nop
nop
nop
nop
...
// Load
lea addresses_normal+0xe9db, %r13
nop
nop
and %r12, %r12
mov (%r13), %cx
...
// Faulty Load
lea addresses_normal+0x3dfb, %r12
nop
nop
nop
add $26642, %rax
...
<gen_prepare_buffer>
{'OP': 'STOR', 'dst': {'NT': True, 'same': False, 'congruent': 11, 'type': 'addresses_A_ht', 'AVXalign': False, 'size': 8}}
...
{'src': {'same': False, 'congruent': 1, 'type': 'addresses_D_ht'}, 'OP': 'REPM', 'dst': {'same': True, 'congruent': 3, 'type': 'addresses_WC_ht'}}
{'OP': 'STOR', 'dst': {'NT': True, 'same': False, 'congruent': 7, 'type': 'addresses_A_ht', 'AVXalign': False, 'size': 2}}
{'OP': 'STOR', 'dst': {'NT': False, 'same': True, 'congruent': 0, 'type': 'addresses_D_ht', 'AVXalign': False, 'size': 1}}
{'34': 21829}
