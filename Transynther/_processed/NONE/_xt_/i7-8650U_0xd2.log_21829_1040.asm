...
nop
and %r8, %r8
lea addresses_WC_ht+0x327a, %r15
nop
nop
sub $23820, %rdx
movups (%r15), %xmm2
...
nop
lfence
lea addresses_normal_ht+0x1e27a, %rbp
nop
nop
nop
inc %rbx
...
nop
add $63243, %rbx
lea addresses_WT_ht+0xf7da, %rsi
nop
nop
nop
nop
...
vpextrq $1, %xmm7, %rsi
and %rsi, %rsi
lea addresses_WC_ht+0x11cb1, %rsi
lea addresses_A_ht+0x138fa, %rdi
nop
nop
nop
nop
...
{'OP': 'LOAD', 'src': {'type': 'addresses_normal_ht', 'size': 1, 'AVXalign': True, 'NT': False, 'congruent': 5, 'same': True}}
