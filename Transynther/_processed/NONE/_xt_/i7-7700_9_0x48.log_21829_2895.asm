...
push %rdi
push %rsi
lea addresses_D_ht+0x15646, %rsi
lea addresses_A_ht+0x8652, %rdi
nop
sub $9071, %r8
mov $63, %rcx
rep movsw
nop
add $11848, %r9
lea addresses_normal_ht+0x18306, %r12
nop
nop
nop
sub %r13, %r13
...
nop
xor %r9, %r9
lea addresses_normal_ht+0x8446, %rsi
...
nop
sub $440, %r9
lea addresses_D_ht+0x1aa18, %r10
nop
dec %rdi
movw $0x6162, (%r10)
nop
xor %r9, %r9
lea addresses_A_ht+0x1d0b6, %rsi
lea addresses_UC_ht+0x1ee46, %rdi
clflush (%rsi)
nop
nop
nop
...
nop
cmp %r9, %r9
lea addresses_D_ht+0x1d9ac, %rsi
lea addresses_D_ht+0x8cb6, %rdi
clflush (%rdi)
nop
nop
cmp %r10, %r10
...
nop
sub $56254, %rcx
lea addresses_UC_ht+0x1afc6, %r12
nop
cmp %r10, %r10
mov (%r12), %cx
nop
...
{'OP': 'STOR', 'dst': {'type': 'addresses_normal_ht', 'AVXalign': False, 'congruent': 5, 'size': 2, 'same': True, 'NT': False}}
