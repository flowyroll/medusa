...
push %rdi
push %rsi
lea addresses_WC_ht+0xf985, %r14
nop
and %r8, %r8
...
nop
xor $26375, %rsi
lea addresses_D_ht+0x16865, %rsi
lea addresses_D_ht+0x3e8a, %rdi
clflush (%rsi)
clflush (%rdi)
cmp $29817, %rax
mov $115, %rcx
...
nop
add $25059, %rcx
lea addresses_normal_ht+0x6d85, %rcx
clflush (%rcx)
nop
nop
nop
...
nop
sub $49857, %rdi
lea addresses_normal_ht+0xbe45, %rsi
nop
nop
nop
nop
...
nop
and $8607, %rdi
lea addresses_WC_ht+0x13515, %rdi
add %rsi, %rsi
...
nop
sub %rdi, %rdi
lea addresses_WC_ht+0x4665, %rcx
nop
nop
nop
nop
...
{'OP': 'LOAD', 'src': {'size': 32, 'NT': True, 'type': 'addresses_WT_ht', 'same': False, 'AVXalign': False, 'congruent': 1}}
{'OP': 'STOR', 'dst': {'size': 8, 'NT': False, 'type': 'addresses_normal_ht', 'same': False, 'AVXalign': False, 'congruent': 4}}
{'OP': 'STOR', 'dst': {'size': 32, 'NT': True, 'type': 'addresses_WC_ht', 'same': False, 'AVXalign': False, 'congruent': 4}}
{'OP': 'STOR', 'dst': {'size': 4, 'NT': False, 'type': 'addresses_WC_ht', 'same': True, 'AVXalign': False, 'congruent': 5}}
{'33': 21829}
