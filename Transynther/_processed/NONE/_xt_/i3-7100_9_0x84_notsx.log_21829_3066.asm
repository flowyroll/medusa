...
push %rdx
push %rsi
lea addresses_normal_ht+0x35c7, %rsi
lea addresses_D_ht+0x1d91b, %rdi
nop
nop
nop
nop
...
nop
and %r8, %r8
lea addresses_A_ht+0x15ed7, %r14
nop
nop
nop
nop
...
nop
add $27922, %r14
lea addresses_WT_ht+0xff9b, %rsi
lea addresses_A_ht+0x1391b, %rdi
nop
nop
sub %rdx, %rdx
mov $29, %rcx
...
nop
cmp $65379, %rdx
lea addresses_UC_ht+0xa145, %rsi
lea addresses_WT_ht+0xc395, %rdi
clflush (%rdi)
nop
nop
inc %r13
...
nop
and $34848, %r14
lea addresses_WT_ht+0x54cb, %r14
nop
nop
nop
nop
...
vpextrq $1, %xmm1, %rsi
cmp $7987, %rdx
lea addresses_UC_ht+0x1c19b, %rdi
nop
nop
nop
nop
...
nop
inc %r11
lea addresses_WC_ht+0x1075b, %rsi
lea addresses_UC_ht+0x71c3, %rdi
clflush (%rsi)
nop
nop
nop
...
nop
sub %rdx, %rdx
lea addresses_normal_ht+0x1be1b, %rsi
nop
nop
nop
nop
...
movb $0x61, (%rsi)
add %r13, %r13
lea addresses_WC_ht+0x23fb, %rsi
lea addresses_D_ht+0x1ab62, %rdi
nop
nop
nop
add %r11, %r11
