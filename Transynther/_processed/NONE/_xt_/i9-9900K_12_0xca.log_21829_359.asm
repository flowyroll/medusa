...
push %rdi
push %rsi
lea addresses_A_ht+0x11c95, %rsi
lea addresses_D_ht+0xe769, %rdi
nop
nop
nop
nop
...
nop
and $56208, %rsi
lea addresses_normal_ht+0x3059, %rsi
lea addresses_D_ht+0xb869, %rdi
nop
nop
nop
nop
...
nop
inc %rcx
lea addresses_WT_ht+0xb4e9, %rsi
lea addresses_normal_ht+0xc869, %rdi
nop
nop
nop
nop
...
rep movsb
dec %rsi
lea addresses_WC_ht+0x1712d, %rsi
lea addresses_WC_ht+0x11b09, %rdi
and $26125, %r12
mov $44, %rcx
rep movsl
nop
xor $64569, %rsi
lea addresses_D_ht+0x69e9, %rdi
nop
nop
nop
and $10189, %r9
...
nop
and $61265, %rbp
lea addresses_WT_ht+0x12ae9, %rsi
lea addresses_D_ht+0x19081, %rdi
nop
nop
cmp %r14, %r14
mov $63, %rcx
...
// Store
lea addresses_normal+0xefb9, %rcx
nop
nop
and %r14, %r14
...
// Faulty Load
lea addresses_normal+0x10769, %rax
nop
nop
nop
cmp $59623, %r10
...
{'OP': 'STOR', 'dst': {'size': 16, 'NT': False, 'type': 'addresses_WC', 'same': False, 'AVXalign': False, 'congruent': 7}}
...
<gen_prepare_buffer>
{'OP': 'REPM', 'src': {'same': True, 'type': 'addresses_A_ht', 'congruent': 1}, 'dst': {'same': False, 'type': 'addresses_D_ht', 'congruent': 9}}
{'OP': 'REPM', 'src': {'same': False, 'type': 'addresses_normal_ht', 'congruent': 4}, 'dst': {'same': False, 'type': 'addresses_D_ht', 'congruent': 8}}
{'OP': 'REPM', 'src': {'same': False, 'type': 'addresses_WT_ht', 'congruent': 7}, 'dst': {'same': False, 'type': 'addresses_normal_ht', 'congruent': 6}}
{'OP': 'REPM', 'src': {'same': False, 'type': 'addresses_WC_ht', 'congruent': 1}, 'dst': {'same': False, 'type': 'addresses_WC_ht', 'congruent': 1}}
