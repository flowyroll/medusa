...
push %rdx
push %rsi
lea addresses_WC_ht+0x1e1d6, %r12
nop
nop
nop
sub %r14, %r14
...
lea addresses_normal_ht+0x1a356, %rdi
nop
add $13174, %r10
mov $11, %rcx
rep movsq
nop
dec %r12
lea addresses_D_ht+0x196d6, %r14
nop
xor $15940, %rdi
movw $0x6162, (%r14)
nop
and $22927, %rdi
lea addresses_UC_ht+0x136d6, %rsi
...
nop
sub $57677, %r15
lea addresses_normal_ht+0xa6f6, %rsi
lea addresses_A_ht+0x169d6, %rdi
cmp $14690, %r14
mov $17, %rcx
rep movsl
nop
...
vpextrq $0, %xmm4, %r15
sub %rsi, %rsi
lea addresses_WT_ht+0x182d6, %rsi
...
nop
cmp %r12, %r12
lea addresses_UC_ht+0x1bc16, %r15
nop
nop
dec %rdi
mov (%r15), %r10d
