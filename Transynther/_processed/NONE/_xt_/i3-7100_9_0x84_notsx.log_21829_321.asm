...
nop
sub %r12, %r12
lea addresses_WT_ht+0x1508, %rax
nop
nop
sub $48352, %rbp
movw $0x6162, (%rax)
...
nop
inc %rbp
lea addresses_normal_ht+0xf734, %rbx
nop
nop
nop
nop
...
nop
inc %rdi
lea addresses_A_ht+0x1d378, %rcx
nop
nop
and $53039, %r9
movups (%rcx), %xmm4
...
nop
add %rcx, %rcx
lea addresses_normal_ht+0x7678, %rcx
nop
cmp $12079, %rbx
movl $0x61626364, (%rcx)
add %rcx, %rcx
lea addresses_A_ht+0xa500, %rsi
lea addresses_UC_ht+0x8b78, %rdi
nop
nop
cmp %rbx, %rbx
mov $100, %rcx
...
lea addresses_UC_ht+0xc378, %rdi
nop
nop
nop
nop
...
nop
add $34149, %rax
lea addresses_UC_ht+0xd578, %rsi
clflush (%rsi)
nop
nop
nop
...
nop
xor %rax, %rax
lea addresses_WC_ht+0xcb78, %rsi
lea addresses_A_ht+0x7c78, %rdi
nop
nop
nop
xor $12362, %rbx
...
<gen_prepare_buffer>
{'src': {'type': 'addresses_A_ht', 'same': True, 'size': 8, 'congruent': 10, 'NT': False, 'AVXalign': True}, 'OP': 'LOAD'}
...
{'src': {'type': 'addresses_A_ht', 'congruent': 1, 'same': False}, 'dst': {'type': 'addresses_UC_ht', 'congruent': 10, 'same': False}, 'OP': 'REPM'}
{'src': {'type': 'addresses_normal_ht', 'congruent': 6, 'same': False}, 'dst': {'type': 'addresses_UC_ht', 'congruent': 11, 'same': False}, 'OP': 'REPM'}
...
{'src': {'type': 'addresses_WC_ht', 'congruent': 8, 'same': True}, 'dst': {'type': 'addresses_A_ht', 'congruent': 8, 'same': False}, 'OP': 'REPM'}
{'38': 21829}
