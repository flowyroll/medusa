...
nop
inc %rdx
lea addresses_WC_ht+0x1d7e8, %rsi
lea addresses_D_ht+0x6be8, %rdi
nop
nop
nop
add %r15, %r15
...
nop
add $10351, %rcx
lea addresses_WC_ht+0x1d51c, %rcx
nop
nop
mfence
movb (%rcx), %dl
...
nop
xor $63745, %rdi
lea addresses_WC_ht+0xe5e8, %rsi
lea addresses_UC_ht+0x1dd78, %rdi
clflush (%rsi)
nop
nop
nop
...
nop
dec %r15
lea addresses_normal_ht+0x95e8, %rsi
lea addresses_WT_ht+0x5084, %rdi
nop
nop
and $48295, %r13
mov $58, %rcx
...
nop
sub %rbx, %rbx
lea addresses_normal_ht+0x8ca0, %rbx
nop
nop
nop
inc %r13
...
// Faulty Load
lea addresses_normal+0x187e8, %rbp
clflush (%rbp)
nop
nop
and $35848, %r10
