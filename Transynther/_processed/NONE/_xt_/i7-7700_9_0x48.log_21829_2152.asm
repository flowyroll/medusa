...
push %rdx
push %rsi
lea addresses_A_ht+0x162d5, %r13
and %rdi, %rdi
movb $0x61, (%r13)
add $44304, %rax
lea addresses_WT_ht+0x13615, %r12
nop
nop
nop
nop
...
nop
sub %rdi, %rdi
lea addresses_WT_ht+0x1bbd5, %rdi
nop
nop
cmp %r13, %r13
movw $0x6162, (%rdi)
xor %rax, %rax
lea addresses_D_ht+0xde61, %rdi
nop
nop
sub %rcx, %rcx
...
nop
sub %rcx, %rcx
lea addresses_UC_ht+0x1ebd5, %r12
nop
nop
add %rcx, %rcx
movw $0x6162, (%r12)
...
{'OP': 'LOAD', 'src': {'type': 'addresses_WT_ht', 'AVXalign': True, 'congruent': 5, 'size': 16, 'same': False, 'NT': False}}
