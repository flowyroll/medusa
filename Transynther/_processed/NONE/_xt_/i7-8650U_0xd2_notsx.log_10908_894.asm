...
push %rdx
push %rsi
lea addresses_UC_ht+0x24bd, %rdx
nop
nop
nop
nop
...
nop
and $20479, %r13
lea addresses_WT_ht+0x135bd, %r8
dec %r12
...
nop
sub %r8, %r8
lea addresses_D_ht+0x1023d, %r10
nop
nop
nop
xor $64284, %rsi
...
nop
sub $34644, %r12
lea addresses_WC_ht+0x102ed, %r9
nop
nop
nop
nop
...
mov (%r9), %r12d
mfence
lea addresses_WT_ht+0x96bd, %rsi
nop
nop
nop
nop
...
nop
xor $4000, %rdx
lea addresses_D_ht+0x990d, %rsi
lea addresses_normal_ht+0x1eedd, %rdi
nop
sub $56686, %r9
mov $115, %rcx
rep movsl
...
nop
mfence
lea addresses_normal_ht+0x17ddd, %rsi
lea addresses_normal_ht+0xc5bd, %rdi
add $16128, %r8
mov $5, %rcx
rep movsl
nop
...
nop
sub %r8, %r8
lea addresses_WC_ht+0x41fd, %rsi
lea addresses_WC_ht+0x724d, %rdi
nop
nop
nop
nop
...
nop
inc %r9
lea addresses_D_ht+0x17adc, %r10
nop
nop
nop
nop
...
{'OP': 'LOAD', 'src': {'type': 'addresses_WC_ht', 'size': 4, 'AVXalign': True, 'NT': False, 'congruent': 4, 'same': False}}
...
{'OP': 'REPM', 'src': {'type': 'addresses_WC_ht', 'congruent': 2, 'same': False}, 'dst': {'type': 'addresses_WC_ht', 'congruent': 4, 'same': False}}
