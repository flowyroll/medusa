...
push %rdx
push %rsi
lea addresses_normal_ht+0x4bed, %r11
nop
nop
nop
nop
...
nop
add %rdx, %rdx
lea addresses_UC_ht+0x11dad, %r15
nop
nop
nop
nop
...
movw $0x6162, (%r15)
dec %r11
lea addresses_UC_ht+0x12e05, %r11
cmp $29132, %r10
...
nop
xor $25832, %r15
lea addresses_WC_ht+0x9128, %r15
nop
nop
nop
nop
...
nop
xor %r8, %r8
lea addresses_UC_ht+0x2f5d, %rsi
lea addresses_UC_ht+0x1205d, %rdi
nop
nop
cmp %r8, %r8
mov $118, %rcx
rep movsw
xor %rsi, %rsi
lea addresses_normal_ht+0x17b5d, %rax
nop
nop
and %rsi, %rsi
mov (%rax), %ecx
