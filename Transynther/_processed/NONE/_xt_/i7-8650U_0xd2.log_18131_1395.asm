...
nop
inc %rax
lea addresses_WC_ht+0x1542e, %r13
nop
nop
sub $33375, %r14
movl $0x61626364, (%r13)
xor %rcx, %rcx
lea addresses_normal_ht+0x4d6a, %rcx
nop
nop
dec %r10
movb (%rcx), %al
...
nop
xor $52492, %r10
lea addresses_WC_ht+0x1520e, %rsi
lea addresses_A_ht+0x1d41c, %rdi
xor %rax, %rax
mov $126, %rcx
rep movsl
nop
...
nop
xor $20020, %rsi
lea addresses_UC_ht+0x1532e, %rcx
nop
nop
and $57637, %rax
mov (%rcx), %r14
