...
nop
and %rsi, %rsi
lea addresses_UC_ht+0x79e, %rsi
lea addresses_WT_ht+0x819a, %rdi
nop
xor $18098, %r12
mov $72, %rcx
rep movsl
xor $48941, %rcx
lea addresses_WC_ht+0x717a, %rsi
lea addresses_A_ht+0x1af9a, %rdi
clflush (%rsi)
nop
nop
nop
...
nop
and $12154, %r12
lea addresses_WC_ht+0xe5fa, %rsi
lea addresses_normal_ht+0x231a, %rdi
nop
nop
nop
nop
...
nop
and $36612, %r14
lea addresses_WT_ht+0x3be4, %r12
nop
nop
nop
nop
...
nop
add $62451, %r12
lea addresses_UC_ht+0x12766, %r12
inc %r14
mov (%r12), %eax
nop
nop
...
nop
cmp $4921, %r12
lea addresses_normal_ht+0x1a8a, %rax
nop
nop
nop
nop
...
nop
add $287, %rdi
lea addresses_UC_ht+0x1917a, %rsi
lea addresses_UC_ht+0x172fa, %rdi
nop
nop
nop
nop
...
nop
inc %rcx
lea addresses_D_ht+0x1cf7a, %rdi
nop
nop
and %r13, %r13
...
movq %r12, (%rdi)
inc %rdi
lea addresses_WT_ht+0xa97a, %rcx
nop
nop
and %rsi, %rsi
movl $0x61626364, (%rcx)
...
nop
add %r14, %r14
lea addresses_normal_ht+0xf59a, %rdx
sub %rdi, %rdi
mov (%rdx), %r13w
nop
nop
...
{'src': {'congruent': 0, 'same': True, 'type': 'addresses_D_ht'}, 'dst': {'congruent': 3, 'same': False, 'type': 'addresses_D_ht'}, 'OP': 'REPM'}
{'src': {'congruent': 1, 'same': False, 'type': 'addresses_UC_ht'}, 'dst': {'congruent': 5, 'same': False, 'type': 'addresses_WT_ht'}, 'OP': 'REPM'}
{'src': {'congruent': 7, 'same': False, 'type': 'addresses_WC_ht'}, 'dst': {'congruent': 4, 'same': False, 'type': 'addresses_A_ht'}, 'OP': 'REPM'}
...
{'src': {'congruent': 10, 'same': False, 'type': 'addresses_UC_ht'}, 'dst': {'congruent': 4, 'same': False, 'type': 'addresses_UC_ht'}, 'OP': 'REPM'}
