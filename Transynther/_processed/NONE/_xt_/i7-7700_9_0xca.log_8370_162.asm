...
push %rdx
push %rsi
lea addresses_WT_ht+0xf65c, %r13
nop
nop
inc %rax
movl $0x61626364, (%r13)
inc %rax
lea addresses_D_ht+0x1848c, %rsi
nop
nop
nop
nop
...
nop
xor %r13, %r13
lea addresses_UC_ht+0xe88e, %rax
nop
nop
nop
nop
...
nop
add %rdx, %rdx
lea addresses_D_ht+0x1620c, %rsi
lea addresses_A_ht+0x1a50c, %rdi
and %r15, %r15
mov $125, %rcx
rep movsb
nop
nop
and %r9, %r9
lea addresses_D_ht+0x860c, %rsi
lea addresses_WC_ht+0x13de8, %rdi
mfence
mov $123, %rcx
rep movsb
nop
xor %rax, %rax
lea addresses_normal_ht+0x1538c, %r9
nop
nop
sub %r15, %r15
...
nop
xor $26242, %r9
lea addresses_D_ht+0x1a4a2, %rsi
lea addresses_A_ht+0x1870c, %rdi
nop
nop
nop
add $30875, %rax
...
nop
and $16242, %r9
lea addresses_normal_ht+0xa77c, %r15
nop
nop
nop
nop
...
nop
inc %rsi
lea addresses_WC_ht+0x120c, %rsi
lea addresses_D_ht+0xc19c, %rdi
nop
nop
sub %rax, %rax
mov $9, %rcx
...
nop
add $43840, %r13
lea addresses_WC_ht+0x8f0c, %rsi
lea addresses_UC_ht+0x16e60, %rdi
add %rax, %rax
mov $66, %rcx
rep movsl
nop
...
nop
add $21809, %rdi
lea addresses_D_ht+0x3f7c, %rsi
lea addresses_UC_ht+0x1960c, %rdi
nop
and %r9, %r9
mov $20, %rcx
rep movsb
...
// REPMOV
lea addresses_PSE+0x1860a, %rsi
lea addresses_WC+0x1b24c, %rdi
nop
cmp %rbx, %rbx
mov $1, %rcx
rep movsq
...
// Faulty Load
lea addresses_normal+0x1ae0c, %rbx
cmp $10669, %r14
mov (%rbx), %ecx
lea oracles, %rdi
and $0xff, %rcx
...
{'src': {'congruent': 0, 'same': False, 'type': 'addresses_PSE'}, 'OP': 'REPM', 'dst': {'congruent': 6, 'same': False, 'type': 'addresses_WC'}}
[Faulty Load]
...
{'src': {'congruent': 10, 'same': True, 'type': 'addresses_D_ht'}, 'OP': 'REPM', 'dst': {'congruent': 7, 'same': True, 'type': 'addresses_A_ht'}}
{'src': {'congruent': 11, 'same': False, 'type': 'addresses_D_ht'}, 'OP': 'REPM', 'dst': {'congruent': 1, 'same': False, 'type': 'addresses_WC_ht'}}
