...
push %rdi
push %rsi
lea addresses_UC_ht+0x1ca4, %rsi
lea addresses_WC_ht+0x1d34, %rdi
clflush (%rsi)
clflush (%rdi)
nop
nop
...
nop
xor $24638, %rbx
lea addresses_D_ht+0x2ad0, %rsi
lea addresses_normal_ht+0x7a20, %rdi
nop
add $18174, %rax
mov $54, %rcx
rep movsq
...
vpextrq $0, %xmm6, %r8
xor %rcx, %rcx
lea addresses_WT_ht+0x634, %rsi
sub %rdi, %rdi
movl $0x61626364, (%rsi)
nop
and $36340, %rbx
lea addresses_WC_ht+0xaa44, %rsi
lea addresses_normal_ht+0xb8ae, %rdi
nop
nop
sub $56138, %rbp
mov $88, %rcx
...
lea addresses_A_ht+0x17944, %rdi
nop
nop
nop
and $56988, %rax
...
nop
inc %rcx
lea addresses_normal_ht+0x8944, %rcx
nop
nop
nop
add $55341, %r8
...
nop
inc %rcx
lea addresses_WT_ht+0x14644, %r12
nop
nop
cmp %rax, %rax
mov (%r12), %bp
...
{'OP': 'STOR', 'dst': {'type': 'addresses_RW', 'AVXalign': False, 'congruent': 5, 'size': 32, 'same': False, 'NT': True}}
...
{'OP': 'REPM', 'src': {'type': 'addresses_D_ht', 'congruent': 2, 'same': False}, 'dst': {'type': 'addresses_normal_ht', 'congruent': 1, 'same': True}}
...
{'OP': 'REPM', 'src': {'type': 'addresses_WC_ht', 'congruent': 8, 'same': True}, 'dst': {'type': 'addresses_normal_ht', 'congruent': 1, 'same': True}}
{'OP': 'REPM', 'src': {'type': 'addresses_normal_ht', 'congruent': 6, 'same': False}, 'dst': {'type': 'addresses_A_ht', 'congruent': 11, 'same': False}}
{'OP': 'STOR', 'dst': {'type': 'addresses_normal_ht', 'AVXalign': True, 'congruent': 11, 'size': 4, 'same': False, 'NT': False}}
