...
push %rdi
push %rsi
lea addresses_WT_ht+0x1351a, %rsi
lea addresses_UC_ht+0x11e5a, %rdi
clflush (%rsi)
nop
nop
dec %r12
...
nop
and $41075, %r15
lea addresses_D_ht+0x15c9a, %rsi
lea addresses_normal_ht+0x551a, %rdi
nop
nop
nop
add %r14, %r14
...
nop
and %r15, %r15
lea addresses_normal_ht+0xe822, %r15
nop
xor %rbx, %rbx
...
nop
dec %r12
lea addresses_A_ht+0x18d1a, %rcx
nop
nop
nop
nop
...
nop
sub %rbx, %rbx
lea addresses_WT_ht+0x1155a, %r15
nop
nop
nop
nop
...
nop
add %rbx, %rbx
lea addresses_WC_ht+0x1751a, %rsi
lea addresses_WC_ht+0x1579a, %rdi
nop
nop
nop
cmp %r8, %r8
...
nop
sub %r8, %r8
lea addresses_UC_ht+0x1e91a, %r8
nop
nop
nop
add $37530, %rdi
...
nop
add $37908, %rcx
lea addresses_WT_ht+0x811a, %rbx
nop
sub $25271, %r15
movw $0x6162, (%rbx)
nop
...
{'OP': 'REPM', 'src': {'same': False, 'congruent': 6, 'type': 'addresses_D_ht'}, 'dst': {'same': False, 'congruent': 10, 'type': 'addresses_normal_ht'}}
...
{'OP': 'REPM', 'src': {'same': True, 'congruent': 9, 'type': 'addresses_WC_ht'}, 'dst': {'same': False, 'congruent': 7, 'type': 'addresses_WC_ht'}}
