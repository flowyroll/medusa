...
push %rdi
push %rsi
lea addresses_normal_ht+0x148ba, %r11
xor $25818, %rbx
movb (%r11), %cl
nop
nop
...
nop
inc %r11
lea addresses_normal_ht+0xccba, %rsi
lea addresses_A_ht+0x124ba, %rdi
add $24069, %rbx
mov $10, %rcx
rep movsl
xor %rsi, %rsi
lea addresses_normal_ht+0x80ba, %rsi
lea addresses_D_ht+0xb80a, %rdi
nop
nop
nop
nop
...
nop
add %rcx, %rcx
lea addresses_WT_ht+0x19bba, %r12
clflush (%r12)
nop
mfence
mov (%r12), %esi
...
{'dst': {'same': False, 'congruent': 3, 'type': 'addresses_D_ht'}, 'OP': 'REPM', 'src': {'same': False, 'congruent': 11, 'type': 'addresses_normal_ht'}}
