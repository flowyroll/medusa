...
push %rdi
push %rsi
lea addresses_UC_ht+0x305b, %rbx
nop
nop
add $45085, %r8
...
nop
sub $61832, %rax
lea addresses_WT_ht+0x1a1be, %rcx
sub $11608, %rbx
mov (%rcx), %r11
nop
xor %rax, %rax
lea addresses_WC_ht+0xd9ef, %rsi
lea addresses_UC_ht+0x71bb, %rdi
nop
nop
nop
nop
...
rep movsw
sub $56725, %rsi
lea addresses_UC_ht+0x1efcb, %rsi
nop
nop
inc %rcx
mov (%rsi), %ebx
...
<gen_prepare_buffer>
{'dst': {'NT': False, 'AVXalign': True, 'size': 32, 'congruent': 3, 'same': False, 'type': 'addresses_UC_ht'}, 'OP': 'STOR'}
{'src': {'NT': False, 'AVXalign': False, 'size': 8, 'congruent': 0, 'same': False, 'type': 'addresses_WT_ht'}, 'OP': 'LOAD'}
{'src': {'congruent': 0, 'same': False, 'type': 'addresses_WC_ht'}, 'dst': {'congruent': 8, 'same': True, 'type': 'addresses_UC_ht'}, 'OP': 'REPM'}
