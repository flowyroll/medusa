...
push %rdi
push %rsi
lea addresses_WT_ht+0x1b60e, %rsi
lea addresses_normal_ht+0x1040e, %rdi
clflush (%rsi)
nop
nop
nop
...
nop
and %r13, %r13
lea addresses_WT_ht+0x1ccba, %rcx
add $34797, %rax
movl $0x61626364, (%rcx)
nop
nop
...
// Faulty Load
lea addresses_normal+0x380e, %r8
nop
nop
nop
xor %rcx, %rcx
...
<gen_prepare_buffer>
{'OP': 'REPM', 'src': {'type': 'addresses_WT_ht', 'congruent': 6, 'same': True}, 'dst': {'type': 'addresses_normal_ht', 'congruent': 9, 'same': False}}
{'OP': 'LOAD', 'src': {'type': 'addresses_A_ht', 'size': 4, 'AVXalign': False, 'NT': False, 'congruent': 5, 'same': True}}
