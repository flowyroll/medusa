...
nop
cmp $21917, %rbx
lea addresses_normal_ht+0x8834, %rsi
lea addresses_normal_ht+0x92b4, %rdi
nop
and $2189, %r11
mov $32, %rcx
rep movsb
...
nop
add %r11, %r11
lea addresses_UC_ht+0x15cbc, %rsi
nop
nop
nop
nop
...
nop
dec %r15
lea addresses_WT_ht+0x1eeb4, %rcx
nop
nop
nop
nop
...
nop
inc %r11
lea addresses_A_ht+0x1cac4, %rcx
xor %r13, %r13
mov (%rcx), %r11d
nop
nop
...
nop
and $61150, %r15
lea addresses_normal_ht+0x167d4, %rdi
clflush (%rdi)
nop
nop
nop
...
mov (%rdi), %r15d
and %rsi, %rsi
lea addresses_normal_ht+0x7294, %rdi
nop
nop
nop
nop
...
nop
cmp %r15, %r15
lea addresses_normal_ht+0x3674, %r11
nop
nop
xor $2080, %rdi
mov (%r11), %r15d
...
{'OP': 'LOAD', 'src': {'type': 'addresses_A_ht', 'size': 4, 'AVXalign': True, 'NT': True, 'congruent': 2, 'same': False}}
