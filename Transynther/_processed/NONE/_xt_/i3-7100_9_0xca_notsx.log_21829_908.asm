...
push %rdi
push %rsi
lea addresses_A_ht+0x18340, %r10
xor %rsi, %rsi
mov (%r10), %di
nop
nop
...
nop
sub %r15, %r15
lea addresses_UC_ht+0x1afc0, %rsi
lea addresses_UC_ht+0xe600, %rdi
nop
nop
nop
nop
...
nop
xor %rdi, %rdi
lea addresses_WC_ht+0x10b40, %rsi
lea addresses_normal_ht+0x7c80, %rdi
nop
nop
nop
nop
...
lea addresses_WC_ht+0x151f0, %rdi
nop
nop
add %r12, %r12
mov $6, %rcx
...
nop
add %rdi, %rdi
lea addresses_UC_ht+0xba40, %rcx
add $56646, %rsi
movw $0x6162, (%rcx)
nop
nop
xor $28496, %r15
lea addresses_D_ht+0x1e1d0, %rsi
lea addresses_WC_ht+0x2140, %rdi
nop
nop
nop
cmp $57420, %r15
...
vpextrq $1, %xmm6, %r12
xor %r11, %r11
lea addresses_WT_ht+0x16440, %rcx
nop
sub $57656, %r12
mov (%rcx), %r11d
nop
dec %rdi
lea addresses_UC_ht+0x1a2e2, %r12
nop
nop
xor $49531, %r15
...
nop
xor %rbx, %rbx
lea addresses_normal_ht+0x40c0, %rsi
lea addresses_normal_ht+0x1b940, %rdi
and %rbx, %rbx
mov $98, %rcx
rep movsb
nop
add $56918, %rcx
lea addresses_D_ht+0x177c0, %rsi
lea addresses_UC_ht+0x37dc, %rdi
nop
nop
nop
add $15929, %r10
...
nop
sub %r11, %r11
lea addresses_UC_ht+0xf9c0, %r11
nop
nop
cmp $57159, %rdi
movb (%r11), %bl
xor %rcx, %rcx
lea addresses_A_ht+0x4a12, %rdi
nop
nop
nop
nop
...
nop
sub $39886, %rdi
lea addresses_A_ht+0x18a28, %rdi
nop
nop
nop
sub %rcx, %rcx
...
nop
sub $44973, %r15
lea addresses_WC_ht+0x1740, %rsi
lea addresses_WT_ht+0x1af40, %rdi
nop
nop
nop
nop
...
<gen_faulty_load>
[REF]
{'src': {'same': False, 'congruent': 0, 'NT': False, 'type': 'addresses_WC', 'size': 32, 'AVXalign': True}, 'OP': 'LOAD'}
[Faulty Load]
