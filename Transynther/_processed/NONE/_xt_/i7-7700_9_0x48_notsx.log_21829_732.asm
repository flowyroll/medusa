...
push %rdx
push %rsi
lea addresses_UC_ht+0x9344, %rsi
lea addresses_UC_ht+0xb444, %rdi
nop
nop
nop
nop
...
nop
xor %rbp, %rbp
lea addresses_UC_ht+0x1b872, %rsi
...
nop
and %rbp, %rbp
lea addresses_A_ht+0x19834, %rdi
nop
nop
cmp %r15, %r15
movw $0x6162, (%rdi)
...
nop
cmp $49535, %rcx
lea addresses_UC_ht+0x11224, %rbp
nop
nop
nop
nop
...
nop
cmp $13885, %rbp
lea addresses_WT_ht+0xd344, %rdx
add $28406, %rbp
