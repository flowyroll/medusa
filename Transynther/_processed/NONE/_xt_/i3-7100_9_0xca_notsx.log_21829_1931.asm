...
nop
and %rbx, %rbx
lea addresses_normal_ht+0x19706, %r9
nop
nop
nop
nop
...
movups %xmm2, (%r9)
and $28698, %r13
lea addresses_A_ht+0x1d79a, %rsi
nop
nop
nop
nop
...
// REPMOV
lea addresses_D+0x6306, %rsi
lea addresses_WC+0x4f06, %rdi
nop
nop
xor $3147, %rax
mov $112, %rcx
...
// REPMOV
lea addresses_A+0x88fe, %rsi
lea addresses_RW+0x484e, %rdi
xor %r12, %r12
mov $30, %rcx
rep movsb
nop
...
{'src': {'type': 'addresses_D', 'congruent': 7, 'same': False}, 'OP': 'REPM', 'dst': {'type': 'addresses_WC', 'congruent': 8, 'same': False}}
{'src': {'type': 'addresses_A', 'congruent': 2, 'same': False}, 'OP': 'REPM', 'dst': {'type': 'addresses_RW', 'congruent': 3, 'same': False}}
[Faulty Load]
