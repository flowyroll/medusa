...
nop
sub $21692, %r11
lea addresses_WT_ht+0xd5b8, %rsi
nop
nop
add $49293, %r14
...
nop
xor $57258, %r15
lea addresses_WT_ht+0x1bb38, %r9
clflush (%r9)
dec %r10
vmovups (%r9), %ymm1
...
nop
cmp $23493, %r15
lea addresses_UC_ht+0x6058, %rsi
lea addresses_normal_ht+0x9a8, %rdi
and $63431, %r10
mov $112, %rcx
rep movsq
nop
...
nop
add $13441, %r9
lea addresses_normal_ht+0x6ed8, %r12
nop
nop
nop
xor %rsi, %rsi
movb $0x61, (%r12)
add $7011, %r11
lea addresses_normal_ht+0x10a40, %rcx
nop
nop
nop
mfence
...
nop
sub %r15, %r15
lea addresses_normal_ht+0x84b8, %rsi
lea addresses_UC_ht+0x5cd8, %rdi
nop
nop
cmp %r15, %r15
mov $36, %rcx
rep movsq
cmp %rsi, %rsi
lea addresses_WT_ht+0xfdec, %r12
nop
and %r15, %r15
movl $0x61626364, (%r12)
nop
...
nop
add $31182, %r10
lea addresses_A_ht+0x1c910, %rdi
nop
inc %r10
movb (%rdi), %r11b
nop
nop
cmp $7838, %r15
lea addresses_A_ht+0x198b8, %r10
nop
and $54153, %r12
movups (%r10), %xmm6
vpextrq $1, %xmm6, %r9
...
nop
cmp $27536, %rsi
lea addresses_A_ht+0x1c0d8, %r10
nop
inc %r11
movb (%r10), %cl
nop
...
nop
inc %rcx
lea addresses_UC_ht+0x9ad2, %rsi
lea addresses_A_ht+0x152b8, %rdi
nop
nop
sub $13623, %r15
mov $38, %rcx
...
nop
add %r14, %r14
lea addresses_A_ht+0x112b8, %r12
dec %r14
movb (%r12), %r9b
nop
nop
...
nop
and $29064, %rdi
lea addresses_WT_ht+0xba74, %rsi
lea addresses_normal_ht+0x161d8, %rdi
xor %r9, %r9
mov $80, %rcx
rep movsl
nop
...
lea addresses_WC_ht+0x152b8, %rdi
clflush (%rsi)
clflush (%rdi)
nop
dec %r10
...
{'OP': 'STOR', 'dst': {'type': 'addresses_normal_ht', 'size': 8, 'AVXalign': False, 'NT': True, 'congruent': 3, 'same': False}}
{'OP': 'REPM', 'src': {'type': 'addresses_normal_ht', 'congruent': 7, 'same': False}, 'dst': {'type': 'addresses_UC_ht', 'congruent': 5, 'same': True}}
...
{'OP': 'REPM', 'src': {'type': 'addresses_normal_ht', 'congruent': 5, 'same': True}, 'dst': {'type': 'addresses_WC_ht', 'congruent': 11, 'same': False}}
{'33': 10280}
