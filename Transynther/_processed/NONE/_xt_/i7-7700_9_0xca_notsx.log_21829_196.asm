...
nop
xor $23226, %rbx
lea addresses_WC_ht+0x1236f, %r14
nop
sub %r13, %r13
movw $0x6162, (%r14)
nop
...
nop
and $43877, %rbx
lea addresses_WT_ht+0x16a6f, %r9
nop
nop
nop
cmp %r15, %r15
...
vmovups %ymm6, (%r9)
cmp $23184, %r9
lea addresses_A_ht+0x1056f, %r13
nop
nop
nop
nop
