...
push %rdi
push %rsi
lea addresses_WT_ht+0x1a386, %rsi
lea addresses_A_ht+0xc7b9, %rdi
clflush (%rsi)
nop
nop
nop
...
nop
sub $2564, %rbp
lea addresses_UC_ht+0x687f, %rsi
lea addresses_WT_ht+0x2a86, %rdi
nop
nop
cmp $34006, %r12
mov $70, %rcx
...
nop
sub $45098, %r9
lea addresses_normal_ht+0x462, %rsi
lea addresses_UC_ht+0x12dc6, %rdi
nop
inc %r8
mov $84, %rcx
rep movsw
...
nop
cmp %r11, %r11
lea addresses_UC_ht+0xf1de, %rcx
nop
nop
nop
nop
...
nop
dec %r9
lea addresses_WT_ht+0x1e444, %r11
nop
cmp %rbp, %rbp
movl $0x61626364, (%r11)
nop
...
// Load
lea addresses_normal+0x17386, %r14
nop
nop
sub %r8, %r8
mov (%r14), %ecx
...
// Store
lea addresses_normal+0x1e60e, %r8
nop
nop
dec %rdx
...
// Faulty Load
lea addresses_normal+0x17386, %rcx
nop
nop
xor $33099, %rbx
mov (%rcx), %r8w
...
{'dst': {'type': 'addresses_normal', 'same': False, 'size': 16, 'congruent': 3, 'NT': True, 'AVXalign': False}, 'OP': 'STOR'}
[Faulty Load]
...
{'src': {'type': 'addresses_normal_ht', 'congruent': 1, 'same': False}, 'dst': {'type': 'addresses_UC_ht', 'congruent': 6, 'same': False}, 'OP': 'REPM'}
