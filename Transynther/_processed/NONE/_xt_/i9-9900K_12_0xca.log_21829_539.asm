...
nop
and $36949, %rdx
lea addresses_WT_ht+0xa63b, %r15
nop
nop
nop
nop
...
nop
xor %r9, %r9
lea addresses_WT_ht+0x114d9, %rax
nop
nop
nop
nop
...
nop
sub $43428, %rdx
lea addresses_UC_ht+0x4969, %rsi
lea addresses_A_ht+0xe6c9, %rdi
nop
nop
nop
nop
...
nop
and $25530, %rdi
lea addresses_WT_ht+0x9d69, %r13
nop
mfence
...
nop
add %rsi, %rsi
lea addresses_WC_ht+0x18e9, %rbp
nop
nop
nop
cmp %rdi, %rdi
...
nop
cmp $58921, %rbp
lea addresses_WC_ht+0x6ae9, %rsi
dec %rcx
movw $0x6162, (%rsi)
nop
xor %rdi, %rdi
lea addresses_WC_ht+0x1c91d, %rbp
nop
nop
nop
nop
...
nop
inc %rax
lea addresses_A_ht+0x108e9, %rbp
nop
nop
nop
xor $28484, %rsi
...
nop
xor %rdi, %rdi
lea addresses_WC_ht+0xa991, %rsi
lea addresses_A_ht+0x18949, %rdi
nop
nop
nop
nop
...
nop
cmp %rax, %rax
lea addresses_normal_ht+0x125e9, %rsi
...
rep movsw
add %r15, %r15
lea addresses_WC_ht+0x11de9, %rcx
clflush (%rcx)
nop
and $15556, %rdi
mov $0x6162636465666768, %r9
...
{'OP': 'STOR', 'dst': {'size': 8, 'NT': False, 'type': 'addresses_D_ht', 'same': False, 'AVXalign': True, 'congruent': 7}}
...
{'OP': 'REPM', 'src': {'same': False, 'type': 'addresses_WC_ht', 'congruent': 3}, 'dst': {'same': False, 'type': 'addresses_A_ht', 'congruent': 5}}
{'OP': 'STOR', 'dst': {'size': 8, 'NT': True, 'type': 'addresses_A_ht', 'same': False, 'AVXalign': False, 'congruent': 5}}
{'OP': 'REPM', 'src': {'same': False, 'type': 'addresses_normal_ht', 'congruent': 11}, 'dst': {'same': False, 'type': 'addresses_A_ht', 'congruent': 1}}
