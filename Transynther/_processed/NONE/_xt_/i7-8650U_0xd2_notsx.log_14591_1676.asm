...
movb (%rax), %r10b
add $63513, %r9
lea addresses_WC_ht+0xabdf, %rdi
nop
sub %rcx, %rcx
movw $0x6162, (%rdi)
nop
...
{'OP': 'STOR', 'dst': {'type': 'addresses_WC', 'size': 1, 'AVXalign': False, 'NT': True, 'congruent': 6, 'same': False}}
...
{'OP': 'LOAD', 'src': {'type': 'addresses_normal_ht', 'size': 1, 'AVXalign': False, 'NT': False, 'congruent': 10, 'same': True}}
