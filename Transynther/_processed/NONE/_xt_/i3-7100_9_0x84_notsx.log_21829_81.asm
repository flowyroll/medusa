...
lea addresses_normal_ht+0x14af4, %rdi
nop
nop
cmp $49329, %r12
mov $2, %rcx
...
nop
add %rdi, %rdi
lea addresses_UC_ht+0x1d308, %r13
nop
nop
nop
xor %r9, %r9
...
nop
xor $31662, %r12
lea addresses_D_ht+0x1ecd0, %r12
nop
nop
nop
nop
...
mov (%r12), %ecx
xor %r13, %r13
lea addresses_UC_ht+0xde22, %r13
clflush (%r13)
nop
nop
nop
...
nop
add %rdi, %rdi
lea addresses_D_ht+0x10708, %rcx
nop
nop
nop
nop
...
nop
xor %r14, %r14
lea addresses_WC_ht+0x10788, %rsi
lea addresses_WC_ht+0xdb08, %rdi
nop
add %r9, %r9
mov $78, %rcx
rep movsq
inc %r12
lea addresses_UC_ht+0x91a8, %rdi
nop
xor $36605, %r12
mov (%rdi), %r14
nop
...
lea addresses_WC_ht+0x18ee8, %rdi
nop
inc %r12
mov $9, %rcx
rep movsq
...
nop
lfence
lea addresses_A_ht+0xa9c0, %rsi
lea addresses_WT_ht+0x1b310, %rdi
clflush (%rsi)
dec %rdx
mov $11, %rcx
rep movsq
cmp $38779, %r12
lea addresses_D_ht+0x6ae8, %r9
nop
nop
nop
xor %rdx, %rdx
...
{'src': {'type': 'addresses_WC_ht', 'congruent': 7, 'same': False}, 'dst': {'type': 'addresses_WC_ht', 'congruent': 11, 'same': False}, 'OP': 'REPM'}
...
{'src': {'type': 'addresses_A_ht', 'congruent': 3, 'same': False}, 'dst': {'type': 'addresses_WT_ht', 'congruent': 3, 'same': False}, 'OP': 'REPM'}
