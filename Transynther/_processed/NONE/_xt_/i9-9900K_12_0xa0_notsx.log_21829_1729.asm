...
push %rdi
push %rsi
lea addresses_D_ht+0x1e50d, %rax
xor $3952, %rcx
...
nop
sub $11409, %rsi
lea addresses_WC_ht+0x1f65, %rsi
nop
cmp $23255, %r11
mov (%rsi), %r9d
nop
...
nop
add $15634, %r8
lea addresses_WT_ht+0xc83d, %r9
and %r11, %r11
movw $0x6162, (%r9)
nop
cmp $28167, %rbp
lea addresses_WC_ht+0x7625, %r9
nop
nop
nop
nop
...
vpextrq $0, %xmm2, %rbp
and %r11, %r11
lea addresses_A_ht+0x1137d, %rbp
nop
nop
nop
nop
...
nop
and $22462, %r11
lea addresses_normal_ht+0x1bb0d, %rsi
lea addresses_D_ht+0xdf10, %rdi
nop
nop
nop
nop
...
nop
xor $30189, %rdi
lea addresses_UC_ht+0x5a8d, %rsi
nop
nop
nop
add $12696, %rax
movw $0x6162, (%rsi)
sub $31334, %rcx
lea addresses_normal_ht+0x640d, %rdi
nop
sub %r8, %r8
vmovups (%rdi), %ymm3
