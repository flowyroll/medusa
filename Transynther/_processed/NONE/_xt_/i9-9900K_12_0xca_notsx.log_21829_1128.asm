...
push %rdi
push %rsi
lea addresses_UC_ht+0x766d, %rsi
lea addresses_normal_ht+0x17c4d, %rdi
nop
mfence
mov $59, %rcx
rep movsb
...
nop
xor $57078, %r14
lea addresses_UC_ht+0xaf4d, %rsi
lea addresses_WT_ht+0x6975, %rdi
nop
cmp %r11, %r11
mov $76, %rcx
rep movsq
nop
xor %rdi, %rdi
lea addresses_WC_ht+0x74ad, %rsi
clflush (%rsi)
nop
nop
nop
...
nop
cmp %rdi, %rdi
lea addresses_A_ht+0xacad, %rax
nop
nop
and %rcx, %rcx
movb (%rax), %r14b
and %rdi, %rdi
lea addresses_WC_ht+0xbcad, %rax
cmp $62366, %rsi
movb $0x61, (%rax)
nop
nop
...
<gen_prepare_buffer>
{'OP': 'REPM', 'src': {'same': False, 'congruent': 4, 'type': 'addresses_UC_ht'}, 'dst': {'same': False, 'congruent': 4, 'type': 'addresses_normal_ht'}}
{'OP': 'REPM', 'src': {'same': False, 'congruent': 4, 'type': 'addresses_UC_ht'}, 'dst': {'same': False, 'congruent': 1, 'type': 'addresses_WT_ht'}}
{'OP': 'LOAD', 'src': {'same': False, 'type': 'addresses_WC_ht', 'NT': False, 'AVXalign': False, 'size': 2, 'congruent': 10}}
{'OP': 'LOAD', 'src': {'same': True, 'type': 'addresses_WC_ht', 'NT': False, 'AVXalign': False, 'size': 32, 'congruent': 1}}
