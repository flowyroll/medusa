...
nop
sub $46511, %rsi
lea addresses_D_ht+0x1d0ed, %rbx
clflush (%rbx)
nop
xor $53550, %rsi
vmovups (%rbx), %ymm2
...
// Faulty Load
lea addresses_normal+0x35ed, %rbx
nop
nop
nop
nop
...
{'src': {'type': 'addresses_UC_ht', 'congruent': 2, 'same': False}, 'dst': {'type': 'addresses_WC_ht', 'congruent': 2, 'same': True}, 'OP': 'REPM'}
