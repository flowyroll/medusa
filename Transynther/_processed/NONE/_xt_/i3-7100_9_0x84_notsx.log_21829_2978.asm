...
push %rdx
push %rsi
lea addresses_UC_ht+0x3780, %rsi
lea addresses_UC_ht+0x4cd0, %rdi
nop
nop
nop
nop
...
rep movsl
xor %r13, %r13
lea addresses_UC_ht+0xd880, %rdx
nop
nop
sub $43734, %r13
mov (%rdx), %rcx
nop
inc %rcx
lea addresses_D_ht+0x16480, %rsi
and %r14, %r14
movw $0x6162, (%rsi)
nop
xor $49009, %rcx
lea addresses_A_ht+0x185f8, %rdi
clflush (%rdi)
nop
nop
nop
...
nop
dec %r13
lea addresses_normal_ht+0x2500, %r13
clflush (%r13)
nop
nop
dec %rcx
...
nop
add $28597, %rbx
lea addresses_WT_ht+0xff80, %rdi
nop
nop
nop
nop
...
// Faulty Load
lea addresses_normal+0xfd80, %r15
cmp %rcx, %rcx
vmovups (%r15), %ymm4
...
<gen_prepare_buffer>
{'src': {'type': 'addresses_UC_ht', 'congruent': 9, 'same': False}, 'dst': {'type': 'addresses_UC_ht', 'congruent': 3, 'same': True}, 'OP': 'REPM'}
{'src': {'type': 'addresses_UC_ht', 'same': True, 'size': 8, 'congruent': 7, 'NT': False, 'AVXalign': False}, 'OP': 'LOAD'}
{'dst': {'type': 'addresses_D_ht', 'same': True, 'size': 2, 'congruent': 8, 'NT': False, 'AVXalign': False}, 'OP': 'STOR'}
