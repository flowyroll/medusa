...
push %rdi
push %rsi
lea addresses_A_ht+0x13d4b, %r15
nop
nop
mfence
movups (%r15), %xmm2
...
nop
inc %rax
lea addresses_WT_ht+0x1af7b, %rsi
lea addresses_UC_ht+0xb9bb, %rdi
nop
add $23466, %r11
mov $87, %rcx
rep movsw
...
nop
lfence
lea addresses_WT_ht+0x1d54b, %r11
nop
nop
nop
and %rdi, %rdi
...
nop
mfence
lea addresses_WT_ht+0x1c94b, %rsi
nop
nop
inc %r13
...
nop
add $41885, %r15
lea addresses_normal_ht+0x1cb, %rsi
...
nop
inc %r10
lea addresses_normal_ht+0x1cdab, %rax
clflush (%rax)
nop
add %r15, %r15
movw $0x6162, (%rax)
nop
add %r13, %r13
lea addresses_normal_ht+0xc4b, %rdi
nop
nop
nop
nop
...
movl $0x61626364, (%rdi)
cmp $45864, %r13
lea addresses_UC_ht+0x5bab, %rcx
nop
nop
nop
sub %rax, %rax
mov (%rcx), %r13
xor $17945, %rdi
lea addresses_normal_ht+0x162bb, %rax
nop
nop
nop
cmp $13703, %r13
movw $0x6162, (%rax)
add %r15, %r15
lea addresses_UC_ht+0x18cb, %r15
dec %rsi
mov (%r15), %di
nop
nop
