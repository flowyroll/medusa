...
push %rdi
push %rsi
lea addresses_D_ht+0x1d600, %rcx
nop
add %r8, %r8
movl $0x61626364, (%rcx)
xor $50298, %r13
lea addresses_WT_ht+0x12ac9, %r13
nop
nop
xor %r8, %r8
...
nop
dec %r8
lea addresses_normal_ht+0xd38c, %rsi
lea addresses_WT_ht+0xbd91, %rdi
nop
nop
sub %r13, %r13
mov $82, %rcx
...
lea addresses_UC_ht+0x1c1a9, %rdi
nop
nop
nop
sub $38052, %rbx
...
nop
sub $13280, %r8
lea addresses_UC_ht+0xd529, %rbx
nop
nop
nop
nop
...
nop
xor $36867, %rsi
lea addresses_normal_ht+0x4809, %r13
nop
sub %rsi, %rsi
movb $0x61, (%r13)
nop
...
nop
xor $52911, %rsi
lea addresses_UC_ht+0xe201, %rsi
lea addresses_WC_ht+0x1cee9, %rdi
nop
nop
and $19136, %r8
mov $112, %rcx
...
{'dst': {'type': 'addresses_WT', 'same': False, 'size': 4, 'congruent': 1, 'NT': True, 'AVXalign': False}, 'OP': 'STOR'}
[Faulty Load]
...
{'src': {'type': 'addresses_normal_ht', 'congruent': 0, 'same': False}, 'dst': {'type': 'addresses_WT_ht', 'congruent': 2, 'same': True}, 'OP': 'REPM'}
{'src': {'type': 'addresses_D_ht', 'congruent': 0, 'same': False}, 'dst': {'type': 'addresses_UC_ht', 'congruent': 4, 'same': False}, 'OP': 'REPM'}
{'src': {'type': 'addresses_UC_ht', 'same': False, 'size': 8, 'congruent': 5, 'NT': True, 'AVXalign': True}, 'OP': 'LOAD'}
