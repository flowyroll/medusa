...
push %rdx
push %rsi
lea addresses_UC_ht+0xd5ef, %rsi
nop
nop
nop
inc %r10
...
nop
dec %r11
lea addresses_D_ht+0x17f9d, %r11
nop
xor $27040, %rdx
vmovups (%r11), %ymm4
...
nop
xor $63270, %rsi
lea addresses_WT_ht+0x12f9f, %r11
nop
nop
nop
cmp $8311, %rcx
...
nop
dec %rax
lea addresses_D_ht+0x1d242, %rsi
lea addresses_A_ht+0xb4f5, %rdi
nop
nop
nop
sub $48139, %r10
...
// Store
lea addresses_normal+0x1859f, %r11
nop
nop
nop
nop
...
{'OP': 'LOAD', 'src': {'same': False, 'type': 'addresses_WC', 'NT': True, 'AVXalign': False, 'size': 1, 'congruent': 11}}
...
{'OP': 'STOR', 'dst': {'same': True, 'type': 'addresses_WT_ht', 'NT': False, 'AVXalign': False, 'size': 32, 'congruent': 8}}
{'OP': 'REPM', 'src': {'same': True, 'congruent': 0, 'type': 'addresses_D_ht'}, 'dst': {'same': False, 'congruent': 0, 'type': 'addresses_A_ht'}}
{'32': 21829}
