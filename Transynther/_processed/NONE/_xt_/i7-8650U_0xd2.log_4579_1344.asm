...
lea addresses_normal_ht+0x15040, %rdi
nop
nop
cmp $31473, %rbx
mov $93, %rcx
...
nop
xor $54050, %rax
lea addresses_normal_ht+0xf00, %rax
nop
nop
nop
nop
...
nop
sub %rax, %rax
lea addresses_WC_ht+0x1e880, %rcx
nop
nop
nop
nop
...
vmovups %ymm4, (%rcx)
xor %rdi, %rdi
lea addresses_normal_ht+0x3680, %rsi
...
nop
sub %rcx, %rcx
lea addresses_D_ht+0x7480, %rsi
lea addresses_normal_ht+0x101b4, %rdi
nop
cmp $15781, %rbx
mov $11, %rcx
rep movsb
...
lea addresses_WT_ht+0x1ce80, %rdi
nop
nop
cmp $38498, %rax
mov $68, %rcx
...
nop
add %r12, %r12
lea addresses_A_ht+0x1db70, %rdi
nop
cmp $30027, %rcx
movb (%rdi), %al
nop
...
nop
sub %r12, %r12
lea addresses_normal_ht+0x7880, %rdi
nop
nop
nop
nop
...
xor $52632, %rdi
lea addresses_normal_ht+0x3680, %rsi
lea addresses_UC_ht+0x6bf8, %rdi
nop
nop
nop
nop
...
nop
xor $62155, %rbx
lea addresses_WC_ht+0x2c80, %rax
nop
nop
nop
nop
...
nop
sub %r12, %r12
lea addresses_A_ht+0x10e38, %rbx
clflush (%rbx)
nop
sub %r15, %r15
mov (%rbx), %di
...
nop
sub %r15, %r15
lea addresses_D_ht+0x15a80, %rsi
nop
xor %rdi, %rdi
mov $0x6162636465666768, %r12
movq %r12, %xmm7
...
lea addresses_WT_ht+0xf380, %rdi
clflush (%rdi)
nop
nop
cmp %rax, %rax
...
{'OP': 'REPM', 'src': {'type': 'addresses_A_ht', 'congruent': 10, 'same': True}, 'dst': {'type': 'addresses_normal_ht', 'congruent': 6, 'same': False}}
...
{'OP': 'REPM', 'src': {'type': 'addresses_normal_ht', 'congruent': 9, 'same': False}, 'dst': {'type': 'addresses_WT_ht', 'congruent': 0, 'same': False}}
