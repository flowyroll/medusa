...
push %rdi
push %rsi
lea addresses_WC_ht+0x17f7e, %rdi
nop
nop
nop
nop
...
mov (%rdi), %ebx
xor $6071, %rbx
lea addresses_normal_ht+0x12afe, %r12
nop
nop
xor %rsi, %rsi
movw $0x6162, (%r12)
...
nop
and %r9, %r9
lea addresses_A_ht+0x198ee, %rsi
lea addresses_D_ht+0x1a74e, %rdi
clflush (%rsi)
clflush (%rdi)
nop
nop
...
nop
cmp %rcx, %rcx
lea addresses_A_ht+0x144ae, %rsi
lea addresses_WT_ht+0x4d6e, %rdi
nop
xor %r11, %r11
mov $4, %rcx
rep movsb
...
nop
and $17077, %rdi
lea addresses_normal_ht+0xf20e, %rsi
lea addresses_WC_ht+0x1ceae, %rdi
nop
nop
nop
nop
...
nop
cmp $19359, %rbp
lea addresses_WC_ht+0x172ae, %r11
nop
dec %r9
...
{'src': {'type': 'addresses_A_ht', 'congruent': 7, 'same': False}, 'dst': {'type': 'addresses_D_ht', 'congruent': 5, 'same': True}, 'OP': 'REPM'}
{'src': {'type': 'addresses_A_ht', 'congruent': 6, 'same': False}, 'dst': {'type': 'addresses_WT_ht', 'congruent': 11, 'same': False}, 'OP': 'REPM'}
{'src': {'type': 'addresses_normal_ht', 'congruent': 4, 'same': False}, 'dst': {'type': 'addresses_WC_ht', 'congruent': 3, 'same': False}, 'OP': 'REPM'}
