...
nop
xor %rax, %rax
lea addresses_WT_ht+0x1a5ec, %rsi
lea addresses_WC_ht+0x145ec, %rdi
nop
dec %rbp
mov $54, %rcx
rep movsl
...
nop
cmp %rax, %rax
lea addresses_WC_ht+0x124b4, %r14
nop
nop
xor %rcx, %rcx
vmovups (%r14), %ymm2
...
nop
dec %r10
lea addresses_normal_ht+0x745c, %rsi
lea addresses_D_ht+0xc690, %rdi
clflush (%rsi)
nop
add $23466, %rdx
mov $68, %rcx
...
nop
xor $9041, %r14
lea addresses_WT_ht+0x1ebec, %rdx
clflush (%rdx)
nop
nop
nop
...
lea addresses_normal_ht+0x22b4, %rdi
nop
nop
nop
sub %r14, %r14
...
nop
cmp $10181, %rdx
lea addresses_A_ht+0x171ec, %rbp
nop
nop
nop
nop
...
nop
and %rdx, %rdx
lea addresses_UC_ht+0x150ec, %rsi
lea addresses_normal_ht+0x1d1ec, %rdi
nop
nop
nop
xor %r10, %r10
...
movq %r10, (%rsi)
xor $8267, %rdi
lea addresses_WC_ht+0xf76c, %rsi
lea addresses_normal_ht+0x2a0c, %rdi
clflush (%rdi)
nop
nop
nop
...
nop
inc %rdx
lea addresses_UC_ht+0x155ac, %rax
nop
add $43275, %rdi
mov (%rax), %rsi
nop
inc %r10
lea addresses_WT_ht+0x153ec, %r10
add $33748, %rdx
movb $0x61, (%r10)
nop
add $51984, %r10
lea addresses_WC_ht+0x4536, %rax
nop
xor $58403, %rcx
movups (%rax), %xmm2
vpextrq $0, %xmm2, %rsi
cmp $54584, %r14
lea addresses_UC_ht+0x1d285, %rsi
lea addresses_normal_ht+0x4a20, %rdi
nop
nop
nop
cmp $12848, %r14
...
{'src': {'type': 'addresses_UC_ht', 'congruent': 11, 'same': False}, 'dst': {'type': 'addresses_normal_ht', 'congruent': 3, 'same': False}, 'OP': 'REPM'}
