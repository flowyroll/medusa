...
push %rdx
push %rsi
lea addresses_normal_ht+0x14fab, %r13
xor %rdx, %rdx
...
nop
add %rbx, %rbx
lea addresses_D_ht+0x12082, %rsi
lea addresses_WC_ht+0x1bdba, %rdi
clflush (%rsi)
nop
nop
nop
...
lea addresses_WT_ht+0x439a, %rdi
nop
nop
dec %r13
mov $23, %rcx
...
nop
dec %rcx
lea addresses_D_ht+0x1399a, %rsi
nop
nop
cmp $6538, %rdx
mov (%rsi), %rdi
nop
lfence
lea addresses_D_ht+0x1dbf8, %r10
clflush (%r10)
nop
sub $4636, %r13
mov (%r10), %di
...
nop
cmp $65439, %r10
lea addresses_normal_ht+0xc3ba, %r12
nop
nop
nop
nop
...
nop
add %rbx, %rbx
lea addresses_UC_ht+0x37ba, %rsi
lea addresses_WC_ht+0x7bba, %rdi
nop
nop
nop
xor %r13, %r13
...
<gen_prepare_buffer>
{'dst': {'NT': True, 'AVXalign': False, 'size': 8, 'congruent': 0, 'same': False, 'type': 'addresses_normal_ht'}, 'OP': 'STOR'}
{'src': {'congruent': 2, 'same': False, 'type': 'addresses_D_ht'}, 'dst': {'congruent': 11, 'same': False, 'type': 'addresses_WC_ht'}, 'OP': 'REPM'}
...
{'src': {'NT': True, 'AVXalign': False, 'size': 8, 'congruent': 5, 'same': False, 'type': 'addresses_D_ht'}, 'OP': 'LOAD'}
