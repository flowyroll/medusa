...
push %rdi
push %rsi
lea addresses_normal_ht+0x1b694, %rcx
nop
nop
sub $25409, %r14
movw $0x6162, (%rcx)
...
nop
cmp $27902, %r14
lea addresses_UC_ht+0x3df4, %rdi
nop
dec %r12
...
nop
xor $51077, %r12
lea addresses_D_ht+0x17194, %rax
nop
nop
nop
nop
...
nop
cmp $54860, %r12
lea addresses_A_ht+0x11094, %rsi
lea addresses_A_ht+0x12894, %rdi
nop
and %r14, %r14
mov $56, %rcx
rep movsl
...
nop
dec %rsi
lea addresses_D_ht+0x1d094, %rsi
...
nop
cmp %rdi, %rdi
lea addresses_WT_ht+0x950c, %rsi
lea addresses_UC_ht+0x18094, %rdi
nop
nop
inc %r9
mov $93, %rcx
...
nop
sub %rsi, %rsi
lea addresses_WT_ht+0x15d94, %rsi
lea addresses_UC_ht+0xfd4c, %rdi
clflush (%rdi)
nop
nop
and %r12, %r12
...
nop
sub $1291, %r14
lea addresses_WT_ht+0x3774, %rdi
nop
nop
cmp $24224, %rsi
mov $0x6162636465666768, %rbp
