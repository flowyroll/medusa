...
push %rdi
push %rsi
lea addresses_A_ht+0xcc4e, %rsi
lea addresses_A_ht+0xd446, %rdi
nop
nop
and %rax, %rax
mov $127, %rcx
...
nop
xor %r8, %r8
lea addresses_UC_ht+0x5407, %r12
clflush (%r12)
nop
nop
nop
...
vpextrq $1, %xmm1, %rax
dec %r12
lea addresses_UC_ht+0x15556, %rdi
cmp %r12, %r12
...
nop
add $30676, %rcx
lea addresses_WT_ht+0xb4f6, %r13
nop
nop
nop
nop
...
nop
sub %rcx, %rcx
lea addresses_WT_ht+0x12a0e, %r13
nop
nop
nop
nop
