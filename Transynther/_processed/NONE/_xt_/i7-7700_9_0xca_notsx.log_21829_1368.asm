...
push %rcx
push %rsi
lea addresses_WC_ht+0x18ee7, %r8
clflush (%r8)
nop
nop
nop
...
nop
add $17507, %rsi
lea addresses_normal_ht+0x1bf87, %r15
nop
nop
nop
nop
...
// REPMOV
lea addresses_UC+0x5ce7, %rsi
lea addresses_D+0x1ff37, %rdi
nop
add %r12, %r12
mov $103, %rcx
rep movsq
...
// Faulty Load
lea addresses_normal+0x1bce7, %rdi
nop
nop
nop
add $17017, %rcx
...
{'src': {'congruent': 11, 'same': False, 'type': 'addresses_UC'}, 'dst': {'congruent': 3, 'same': False, 'type': 'addresses_D'}, 'OP': 'REPM'}
