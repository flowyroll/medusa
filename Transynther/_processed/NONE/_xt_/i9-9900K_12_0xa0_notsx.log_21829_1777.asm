...
push %rdx
push %rsi
lea addresses_WC_ht+0x15257, %rbx
nop
nop
add $10314, %r12
mov (%rbx), %dx
...
nop
xor $39913, %r12
lea addresses_normal_ht+0x175eb, %rdx
nop
nop
and %r8, %r8
mov (%rdx), %rbx
...
<gen_prepare_buffer>
{'src': {'type': 'addresses_WC_ht', 'AVXalign': False, 'size': 2, 'NT': True, 'same': False, 'congruent': 4}, 'OP': 'LOAD'}
