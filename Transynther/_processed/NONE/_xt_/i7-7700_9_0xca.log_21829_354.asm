...
push %rdi
push %rsi
lea addresses_D_ht+0x15123, %rsi
...
nop
and %rsi, %rsi
lea addresses_WT_ht+0xa017, %r13
nop
nop
dec %rcx
mov (%r13), %r8
...
nop
xor $38304, %r8
lea addresses_WT_ht+0xd797, %rbp
dec %r14
mov (%rbp), %ecx
nop
nop
...
{'src': {'congruent': 7, 'AVXalign': False, 'same': True, 'size': 8, 'NT': False, 'type': 'addresses_WT_ht'}, 'OP': 'LOAD'}
