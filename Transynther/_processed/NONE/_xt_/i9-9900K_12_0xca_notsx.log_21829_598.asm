...
nop
dec %r9
lea addresses_WC_ht+0x1a2ee, %rsi
lea addresses_UC_ht+0xa2b6, %rdi
cmp $35838, %r9
mov $76, %rcx
rep movsb
and $56071, %rdi
lea addresses_A_ht+0x152ee, %rcx
nop
nop
nop
nop
...
nop
dec %r9
lea addresses_WT_ht+0x19bee, %rcx
nop
nop
nop
nop
...
nop
xor %rcx, %rcx
lea addresses_WC_ht+0x68d6, %rcx
clflush (%rcx)
and %r11, %r11
mov (%rcx), %edi
nop
sub %r9, %r9
lea addresses_WC_ht+0x1a8ee, %r11
nop
nop
nop
nop
...
<gen_prepare_buffer>
{'OP': 'REPM', 'src': {'same': False, 'congruent': 6, 'type': 'addresses_UC_ht'}, 'dst': {'same': False, 'congruent': 8, 'type': 'addresses_WC_ht'}}
{'OP': 'REPM', 'src': {'same': False, 'congruent': 10, 'type': 'addresses_D_ht'}, 'dst': {'same': False, 'congruent': 9, 'type': 'addresses_WT_ht'}}
{'OP': 'REPM', 'src': {'same': False, 'congruent': 11, 'type': 'addresses_WC_ht'}, 'dst': {'same': False, 'congruent': 3, 'type': 'addresses_UC_ht'}}
{'OP': 'LOAD', 'src': {'same': False, 'type': 'addresses_A_ht', 'NT': True, 'AVXalign': False, 'size': 1, 'congruent': 11}}
