...
push %rdi
push %rsi
lea addresses_UC_ht+0x1b502, %rbp
add %rax, %rax
...
nop
and %r12, %r12
lea addresses_WC_ht+0xa7c2, %rsi
lea addresses_WC_ht+0x11c72, %rdi
nop
xor %r10, %r10
mov $21, %rcx
rep movsq
...
nop
mfence
lea addresses_WT_ht+0x8242, %r10
nop
nop
nop
xor $45944, %r12
...
nop
cmp $54735, %rax
lea addresses_normal_ht+0x6002, %r10
nop
nop
nop
xor $38674, %r8
mov (%r10), %r12w
dec %rbp
lea addresses_D_ht+0x18702, %rsi
lea addresses_A_ht+0x14018, %rdi
nop
add %rbp, %rbp
mov $57, %rcx
rep movsb
...
{'OP': 'REPM', 'src': {'type': 'addresses_WC_ht', 'congruent': 5, 'same': False}, 'dst': {'type': 'addresses_WC_ht', 'congruent': 4, 'same': True}}
