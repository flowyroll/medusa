...
push %rdi
push %rsi
lea addresses_A_ht+0x12149, %rcx
nop
nop
add %rax, %rax
...
nop
and %r10, %r10
lea addresses_A_ht+0xad49, %r9
clflush (%r9)
dec %r8
mov $0x6162636465666768, %rsi
movq %rsi, (%r9)
xor %r8, %r8
lea addresses_normal_ht+0x7235, %rcx
nop
dec %rax
movw $0x6162, (%rcx)
nop
nop
xor $55721, %r8
lea addresses_normal_ht+0x18e76, %rsi
lea addresses_UC_ht+0xa421, %rdi
nop
nop
xor $14178, %r10
mov $108, %rcx
...
nop
add $12163, %r14
lea addresses_normal_ht+0x7ec9, %rsi
lea addresses_normal_ht+0xf629, %rdi
nop
dec %r8
mov $40, %rcx
rep movsl
...
nop
cmp $3695, %r14
lea addresses_UC_ht+0xc518, %rcx
nop
sub %rsi, %rsi
movb (%rcx), %r9b
cmp %r8, %r8
lea addresses_A_ht+0x1c849, %r8
nop
nop
nop
nop
...
// Faulty Load
lea addresses_normal+0x2d49, %rdi
nop
nop
nop
nop
...
{'OP': 'STOR', 'dst': {'congruent': 9, 'AVXalign': False, 'same': True, 'size': 8, 'NT': False, 'type': 'addresses_A_ht'}}
...
{'src': {'congruent': 7, 'same': False, 'type': 'addresses_normal_ht'}, 'OP': 'REPM', 'dst': {'congruent': 4, 'same': False, 'type': 'addresses_normal_ht'}}
