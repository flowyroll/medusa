...
push %rdx
push %rsi
lea addresses_normal_ht+0x663, %rcx
and %rbp, %rbp
mov (%rcx), %r12d
nop
nop
...
nop
sub $29875, %r14
lea addresses_UC_ht+0xc41f, %rcx
nop
and $34061, %r9
movb (%rcx), %r14b
nop
...
nop
cmp %r12, %r12
lea addresses_WT_ht+0x133bf, %r10
sub %r12, %r12
movl $0x61626364, (%r10)
nop
nop
nop
sub $10797, %r10
lea addresses_WC_ht+0x1c47f, %r9
nop
xor $50993, %r12
mov (%r9), %bp
nop
inc %r12
lea addresses_normal_ht+0x233f, %rbp
nop
nop
nop
nop
...
nop
sub $36463, %rdx
lea addresses_A_ht+0xfabf, %r12
inc %r10
mov (%r12), %rdx
nop
nop
dec %r10
lea addresses_WC_ht+0x112d1, %rcx
and %rbp, %rbp
...
nop
dec %r14
lea addresses_normal_ht+0x1266b, %rsi
lea addresses_UC_ht+0x809f, %rdi
nop
nop
and %r9, %r9
mov $31, %rcx
...
nop
cmp $64712, %rdi
lea addresses_UC_ht+0x1613f, %r9
nop
sub %rcx, %rcx
mov (%r9), %dx
inc %r14
lea addresses_WT_ht+0xf23f, %rsi
lea addresses_normal_ht+0x4bbf, %rdi
nop
nop
and %r10, %r10
mov $86, %rcx
...
vpextrq $1, %xmm2, %rcx
and $34308, %rdx
lea addresses_WT_ht+0x37bf, %rsi
lea addresses_A_ht+0x6aff, %rdi
nop
and $30445, %rdx
mov $47, %rcx
rep movsl
...
// REPMOV
lea addresses_A+0x86bf, %rsi
lea addresses_UC+0x4c59, %rdi
nop
nop
nop
nop
...
{'src': {'type': 'addresses_A', 'congruent': 5, 'same': False}, 'OP': 'REPM', 'dst': {'type': 'addresses_UC', 'congruent': 1, 'same': False}}
...
{'OP': 'STOR', 'dst': {'same': True, 'congruent': 7, 'NT': False, 'type': 'addresses_normal_ht', 'size': 1, 'AVXalign': False}}
...
{'src': {'type': 'addresses_normal_ht', 'congruent': 2, 'same': True}, 'OP': 'REPM', 'dst': {'type': 'addresses_UC_ht', 'congruent': 5, 'same': False}}
...
{'src': {'type': 'addresses_WT_ht', 'congruent': 8, 'same': False}, 'OP': 'REPM', 'dst': {'type': 'addresses_A_ht', 'congruent': 6, 'same': False}}
{'38': 21829}
