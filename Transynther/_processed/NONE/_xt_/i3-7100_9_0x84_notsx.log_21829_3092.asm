...
nop
and $63024, %rcx
lea addresses_normal_ht+0x5d71, %rsi
lea addresses_WC_ht+0x13c71, %rdi
clflush (%rsi)
nop
nop
nop
...
nop
lfence
lea addresses_UC_ht+0x5271, %rdx
nop
nop
cmp $40377, %r13
...
nop
cmp $20541, %rsi
lea addresses_UC_ht+0x14771, %rdi
and $18837, %rdx
mov (%rdi), %r12w
nop
inc %r15
lea addresses_D_ht+0x70b1, %rdi
clflush (%rdi)
nop
nop
nop
...
movb $0x61, (%rdi)
cmp %r12, %r12
lea addresses_WT_ht+0x1b671, %rdx
nop
dec %r12
vmovups (%rdx), %ymm6
...
nop
sub %rax, %rax
lea addresses_UC_ht+0x1a271, %rdx
nop
nop
nop
nop
...
mov (%rdx), %r12w
xor $54217, %r15
lea addresses_D_ht+0x1a5f1, %rsi
lea addresses_WC_ht+0xf771, %rdi
nop
cmp %r13, %r13
mov $96, %rcx
rep movsl
...
nop
xor %rsi, %rsi
lea addresses_D_ht+0x1a901, %rsi
lea addresses_WC_ht+0x50a1, %rdi
clflush (%rsi)
nop
nop
nop
...
rep movsl
and $10016, %rcx
lea addresses_WC_ht+0x10f71, %rax
cmp %r12, %r12
