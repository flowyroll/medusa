...
nop
cmp $15229, %r9
lea addresses_A_ht+0x1c490, %r12
clflush (%r12)
nop
nop
sub $56393, %r8
...
nop
dec %rdi
lea addresses_WT_ht+0xfcfb, %r12
nop
nop
nop
nop
...
nop
sub %rdi, %rdi
lea addresses_A_ht+0x12f10, %rsi
lea addresses_D_ht+0x7be0, %rdi
nop
nop
nop
nop
...
nop
and $46671, %rcx
lea addresses_A_ht+0x8410, %rsi
lea addresses_UC_ht+0xb698, %rdi
clflush (%rsi)
nop
nop
nop
...
{'src': {'type': 'addresses_A_ht', 'congruent': 3, 'same': False}, 'OP': 'REPM', 'dst': {'type': 'addresses_D_ht', 'congruent': 4, 'same': False}}
