...
nop
cmp $55666, %rsi
lea addresses_D_ht+0x12e27, %rsi
nop
nop
nop
sub $13775, %rcx
...
nop
cmp $29044, %r15
lea addresses_normal_ht+0xd9ef, %rsi
lea addresses_WT_ht+0x1588f, %rdi
nop
nop
add $62309, %r13
mov $76, %rcx
...
nop
cmp %r12, %r12
lea addresses_D_ht+0x15727, %r12
nop
nop
xor %rsi, %rsi
mov (%r12), %r11d
...
nop
cmp %rdi, %rdi
lea addresses_normal_ht+0x1e127, %rsi
lea addresses_A_ht+0x10cd3, %rdi
nop
nop
nop
cmp $47640, %r11
...
rep movsb
xor %r13, %r13
lea addresses_UC_ht+0x3207, %r12
nop
nop
nop
dec %r15
...
nop
xor %rsi, %rsi
lea addresses_WT_ht+0xcb27, %r13
nop
nop
nop
add %r10, %r10
...
nop
dec %rsi
lea addresses_UC_ht+0x192a7, %r13
nop
nop
dec %r11
movl $0x61626364, (%r13)
...
nop
xor $62092, %rcx
lea addresses_UC_ht+0x555b, %rsi
clflush (%rsi)
nop
nop
nop
...
// REPMOV
mov $0x327, %rsi
lea addresses_normal+0x17f27, %rdi
nop
nop
nop
cmp %rax, %rax
...
{'OP': 'REPM', 'src': {'type': 'addresses_P', 'congruent': 9, 'same': False}, 'dst': {'type': 'addresses_normal', 'congruent': 10, 'same': False}}
...
{'OP': 'LOAD', 'src': {'type': 'addresses_D_ht', 'size': 4, 'AVXalign': False, 'NT': True, 'congruent': 10, 'same': False}}
