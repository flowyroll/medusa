...
push %rdi
push %rsi
lea addresses_WC_ht+0x1e69c, %rsi
...
nop
add $14106, %rdi
lea addresses_WT_ht+0x11b9c, %rsi
lea addresses_UC_ht+0x4c84, %rdi
cmp $35158, %r13
mov $33, %rcx
rep movsb
nop
nop
sub $23977, %rdi
lea addresses_WC_ht+0x1c4dc, %rax
nop
nop
add $29015, %rbp
mov (%rax), %esi
and %rdi, %rdi
lea addresses_A_ht+0x1458f, %rcx
clflush (%rcx)
nop
add $7362, %rbp
mov (%rcx), %rdi
mfence
lea addresses_WT_ht+0xc09c, %rsi
nop
add $31511, %r9
mov (%rsi), %r13d
nop
...
nop
sub $58378, %rax
lea addresses_D_ht+0x1abdc, %rsi
...
<gen_prepare_buffer>
{'src': {'congruent': 11, 'same': False, 'type': 'addresses_WC_ht'}, 'dst': {'congruent': 5, 'same': False, 'type': 'addresses_D_ht'}, 'OP': 'REPM'}
