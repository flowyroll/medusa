...
nop
dec %r13
lea addresses_WC_ht+0xc172, %r11
nop
dec %r8
movb (%r11), %al
nop
nop
xor %r11, %r11
lea addresses_normal_ht+0x19772, %r15
and %rcx, %rcx
mov (%r15), %r11w
nop
nop
xor %r15, %r15
lea addresses_UC_ht+0xed9a, %r8
nop
nop
nop
nop
...
mov (%r8), %r11
cmp $18907, %r8
lea addresses_normal_ht+0x11072, %r8
nop
add %r13, %r13
...
nop
and %r13, %r13
lea addresses_UC_ht+0x8d79, %rsi
lea addresses_WC_ht+0x188b2, %rdi
nop
nop
nop
nop
...
nop
xor $28738, %r15
lea addresses_WT_ht+0x5572, %rsi
lea addresses_WT_ht+0x43e6, %rdi
nop
nop
xor %r14, %r14
mov $33, %rcx
...
// Store
lea addresses_normal+0xeb72, %r14
nop
cmp %rbx, %rbx
movl $0x51525354, (%r14)
nop
...
<gen_prepare_buffer>
{'OP': 'LOAD', 'src': {'same': True, 'NT': False, 'AVXalign': True, 'size': 32, 'type': 'addresses_A_ht', 'congruent': 9}}
...
{'dst': {'same': False, 'congruent': 6, 'type': 'addresses_WC_ht'}, 'OP': 'REPM', 'src': {'same': False, 'congruent': 0, 'type': 'addresses_UC_ht'}}
