...
rep movsq
cmp $2837, %rbp
lea addresses_D_ht+0xacd3, %rsi
lea addresses_UC_ht+0xb173, %rdi
nop
nop
nop
and %r12, %r12
...
nop
cmp %rcx, %rcx
lea addresses_UC_ht+0x1bbfb, %rbp
nop
nop
and $18905, %r9
movups (%rbp), %xmm3
...
nop
dec %r12
lea addresses_UC_ht+0x57eb, %rcx
nop
nop
nop
nop
...
vpextrq $0, %xmm0, %r9
sub %r13, %r13
lea addresses_normal_ht+0x166db, %rsi
lea addresses_A_ht+0x138fb, %rdi
xor $24827, %r10
mov $66, %rcx
rep movsb
nop
