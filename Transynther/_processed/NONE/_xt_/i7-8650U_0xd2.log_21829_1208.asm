...
lea addresses_UC_ht+0x1411, %rdi
nop
nop
nop
nop
...
nop
and %rdi, %rdi
lea addresses_normal_ht+0x18f11, %rsi
lea addresses_A_ht+0x9181, %rdi
nop
nop
and $60731, %r13
mov $21, %rcx
rep movsl
cmp $6074, %rsi
lea addresses_UC_ht+0x911, %rsi
lea addresses_D_ht+0xfd11, %rdi
nop
cmp %r12, %r12
mov $102, %rcx
rep movsq
...
nop
cmp $25200, %r12
lea addresses_normal_ht+0xe6b7, %rcx
nop
nop
nop
nop
...
nop
sub $61814, %rdx
lea addresses_WT_ht+0x6771, %rbp
nop
inc %r12
...
nop
and %rdx, %rdx
lea addresses_UC_ht+0x1cfe1, %rdi
nop
nop
add $21685, %r13
movw $0x6162, (%rdi)
cmp $48622, %r12
lea addresses_UC_ht+0x1ef91, %rsi
nop
nop
nop
sub $38486, %r12
