...
push %rdi
push %rsi
lea addresses_WC_ht+0x1c299, %rbx
nop
sub %r12, %r12
...
nop
xor $27651, %r12
lea addresses_A_ht+0x1d199, %r13
nop
nop
nop
xor %r9, %r9
...
nop
xor %rcx, %rcx
lea addresses_UC_ht+0x19f19, %rsi
lea addresses_WT_ht+0x1d841, %rdi
nop
add %r12, %r12
mov $103, %rcx
rep movsw
cmp %rcx, %rcx
lea addresses_D_ht+0xba99, %r8
nop
nop
nop
nop
...
nop
and $62552, %rsi
lea addresses_normal_ht+0x9d49, %r15
nop
nop
sub $37391, %r9
movb (%r15), %r8b
...
nop
xor %rbx, %rbx
lea addresses_normal_ht+0xd319, %rsi
lea addresses_WT_ht+0xca99, %rdi
nop
nop
inc %rbx
mov $16, %rcx
...
nop
xor %r8, %r8
lea addresses_WT_ht+0x194ad, %r12
nop
nop
nop
xor %r13, %r13
...
nop
cmp %rbx, %rbx
lea addresses_WC_ht+0xec99, %rcx
nop
nop
and %r9, %r9
movb (%rcx), %bl
xor %r9, %r9
lea addresses_UC_ht+0x24f5, %rbx
nop
inc %r13
movb (%rbx), %r9b
nop
...
// Faulty Load
lea addresses_normal+0x1b999, %r12
nop
nop
nop
sub $6599, %r9
...
<gen_prepare_buffer>
{'OP': 'STOR', 'dst': {'same': False, 'congruent': 6, 'NT': False, 'type': 'addresses_WC_ht', 'size': 16, 'AVXalign': True}}
...
{'src': {'type': 'addresses_UC_ht', 'congruent': 7, 'same': False}, 'OP': 'REPM', 'dst': {'type': 'addresses_WT_ht', 'congruent': 3, 'same': False}}
