...
push %rdx
push %rsi
lea addresses_normal_ht+0x19d7, %rsi
lea addresses_WC_ht+0x1d6a3, %rdi
nop
and %r13, %r13
mov $37, %rcx
rep movsb
nop
sub $51840, %r14
lea addresses_WC_ht+0x1c5c3, %rsi
nop
nop
inc %rdx
movl $0x61626364, (%rsi)
...
nop
add $29511, %r14
lea addresses_UC_ht+0xdf1f, %rsi
lea addresses_WT_ht+0xbf37, %rdi
clflush (%rsi)
clflush (%rdi)
sub $64583, %rbp
mov $73, %rcx
...
nop
dec %rbp
lea addresses_A_ht+0x1e3d7, %rdx
nop
nop
and $28171, %r13
vmovups (%rdx), %ymm4
...
nop
add %r13, %r13
lea addresses_A_ht+0xfed7, %rsi
lea addresses_WT_ht+0x151d7, %rdi
clflush (%rdi)
and $24554, %r15
mov $20, %rcx
rep movsb
add %r13, %r13
lea addresses_A_ht+0x194af, %rcx
nop
nop
nop
nop
...
nop
cmp %r13, %r13
lea addresses_A_ht+0x83d7, %rdx
cmp $27814, %rsi
mov (%rdx), %rbp
nop
and $51642, %rsi
lea addresses_normal_ht+0x3017, %r14
nop
nop
nop
nop
...
{'OP': 'REPM', 'src': {'type': 'addresses_A_ht', 'congruent': 4, 'same': True}, 'dst': {'type': 'addresses_WT_ht', 'congruent': 8, 'same': True}}
