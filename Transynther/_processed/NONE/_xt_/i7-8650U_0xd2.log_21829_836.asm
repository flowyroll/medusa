...
nop
and %rdx, %rdx
lea addresses_D_ht+0xe10c, %rsi
lea addresses_WT_ht+0x3d0c, %rdi
nop
nop
nop
nop
...
nop
inc %r8
lea addresses_normal_ht+0x1eac, %rsi
lea addresses_A_ht+0x5f0c, %rdi
nop
add $36461, %rdx
mov $106, %rcx
rep movsl
...
nop
sub $26277, %rax
lea addresses_D_ht+0x1a3fc, %rsi
lea addresses_D_ht+0x1ed54, %rdi
nop
nop
nop
nop
...
nop
add %r8, %r8
lea addresses_WC_ht+0xe9bc, %rsi
lea addresses_WT_ht+0xaf0c, %rdi
cmp $15307, %r8
mov $3, %rcx
rep movsb
nop
