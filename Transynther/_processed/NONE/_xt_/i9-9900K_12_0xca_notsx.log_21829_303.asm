...
push %rdx
push %rsi
lea addresses_UC_ht+0x124e8, %r10
nop
nop
nop
nop
...
movups %xmm0, (%r10)
add %rdi, %rdi
lea addresses_normal_ht+0x9c68, %rsi
lea addresses_UC_ht+0x2168, %rdi
nop
nop
xor %r9, %r9
mov $79, %rcx
...
nop
add %r9, %r9
lea addresses_A_ht+0x11b28, %rcx
nop
nop
inc %r10
mov (%rcx), %r9d
nop
add %r9, %r9
lea addresses_WT_ht+0x159e8, %rdi
nop
nop
inc %rdx
movups (%rdi), %xmm0
...
nop
cmp %r14, %r14
lea addresses_normal_ht+0x8468, %r14
nop
nop
xor %r10, %r10
mov $0x6162636465666768, %rcx
...
nop
inc %rdi
lea addresses_UC_ht+0xb768, %rsi
lea addresses_D_ht+0x14c68, %rdi
nop
nop
nop
sub $27131, %r15
...
nop
sub %rsi, %rsi
lea addresses_WC_ht+0x1ec28, %r15
inc %rdx
movups (%r15), %xmm5
vpextrq $1, %xmm5, %r9
xor $12964, %rdi
lea addresses_WT_ht+0x8868, %rsi
lea addresses_D_ht+0x9268, %rdi
clflush (%rdi)
nop
dec %r9
mov $3, %rcx
...
{'OP': 'REPM', 'src': {'same': False, 'congruent': 10, 'type': 'addresses_normal_ht'}, 'dst': {'same': False, 'congruent': 6, 'type': 'addresses_UC_ht'}}
