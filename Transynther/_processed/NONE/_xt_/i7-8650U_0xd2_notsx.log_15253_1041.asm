...
nop
sub $42626, %r12
lea addresses_D_ht+0x15c15, %rsi
lea addresses_UC_ht+0xd147, %rdi
nop
nop
nop
nop
...
nop
and $37463, %rdi
lea addresses_D_ht+0x184bf, %rsi
dec %rbp
movl $0x61626364, (%rsi)
nop
xor %rdi, %rdi
...
nop
sub %r8, %r8
lea addresses_WC_ht+0x161ef, %rax
cmp %rsi, %rsi
...
<gen_prepare_buffer>
{'OP': 'STOR', 'dst': {'type': 'addresses_UC_ht', 'size': 8, 'AVXalign': False, 'NT': False, 'congruent': 3, 'same': True}}
