...
push %rdi
push %rsi
lea addresses_WC_ht+0x5fc6, %rbp
nop
and %r14, %r14
movb (%rbp), %al
nop
...
nop
sub $54013, %rdi
lea addresses_WT_ht+0x18faa, %r8
nop
nop
nop
cmp %rax, %rax
movl $0x61626364, (%r8)
dec %r10
lea addresses_UC_ht+0x793a, %rsi
lea addresses_normal_ht+0x1eb3a, %rdi
nop
nop
nop
nop
...
nop
sub $20736, %rcx
lea addresses_UC_ht+0x173ba, %rsi
lea addresses_WT_ht+0x1092a, %rdi
nop
nop
nop
nop
...
nop
add $57660, %r14
lea addresses_UC_ht+0x1517a, %rcx
nop
nop
nop
nop
...
{'src': {'congruent': 8, 'same': False, 'type': 'addresses_UC_ht'}, 'dst': {'congruent': 8, 'same': False, 'type': 'addresses_normal_ht'}, 'OP': 'REPM'}
{'src': {'congruent': 6, 'same': False, 'type': 'addresses_UC_ht'}, 'dst': {'congruent': 4, 'same': False, 'type': 'addresses_WT_ht'}, 'OP': 'REPM'}
