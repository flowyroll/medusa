...
push %rdx
push %rsi
lea addresses_A_ht+0x1a5c, %r12
sub %rdx, %rdx
movups (%r12), %xmm1
vpextrq $0, %xmm1, %r10
nop
cmp $57330, %rsi
lea addresses_normal_ht+0x9bf0, %rax
clflush (%rax)
nop
nop
nop
...
nop
sub $55334, %rdx
lea addresses_A_ht+0x1d604, %rax
nop
nop
xor %r12, %r12
movb (%rax), %r11b
...
nop
sub %r10, %r10
lea addresses_UC_ht+0xd15c, %rsi
lea addresses_D_ht+0x18654, %rdi
nop
nop
nop
cmp $32383, %rax
...
nop
inc %rax
lea addresses_WT_ht+0x12acc, %r12
nop
sub $3514, %rdx
movb (%r12), %al
nop
cmp $488, %rcx
lea addresses_WC_ht+0x83bc, %rdx
nop
and $19521, %rsi
movb $0x61, (%rdx)
inc %rsi
lea addresses_normal_ht+0x1a654, %r10
clflush (%r10)
nop
nop
xor %rsi, %rsi
...
// Store
lea addresses_normal+0x1e0cc, %r8
nop
nop
nop
nop
...
<gen_prepare_buffer>
{'OP': 'LOAD', 'src': {'same': True, 'type': 'addresses_A_ht', 'NT': False, 'AVXalign': False, 'size': 16, 'congruent': 3}}
...
{'OP': 'REPM', 'src': {'same': False, 'congruent': 3, 'type': 'addresses_UC_ht'}, 'dst': {'same': False, 'congruent': 4, 'type': 'addresses_D_ht'}}
{'OP': 'LOAD', 'src': {'same': True, 'type': 'addresses_WT_ht', 'NT': False, 'AVXalign': False, 'size': 1, 'congruent': 3}}
{'OP': 'STOR', 'dst': {'same': True, 'type': 'addresses_WC_ht', 'NT': True, 'AVXalign': False, 'size': 1, 'congruent': 3}}
