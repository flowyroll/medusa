...
nop
cmp %r11, %r11
lea addresses_UC_ht+0xc9d9, %r13
nop
nop
nop
nop
...
movb (%r13), %r10b
add $23319, %r13
lea addresses_UC_ht+0x28d9, %rsi
lea addresses_D_ht+0xeffd, %rdi
nop
nop
nop
nop
...
rep movsb
inc %r15
lea addresses_WC_ht+0xe235, %r11
nop
cmp %rdi, %rdi
movb $0x61, (%r11)
nop
nop
cmp $8267, %rsi
lea addresses_WC_ht+0xbdd5, %r13
nop
add %r11, %r11
movl $0x61626364, (%r13)
sub %r8, %r8
lea addresses_UC_ht+0x18c83, %rsi
nop
sub $36531, %rbx
...
nop
dec %rdi
lea addresses_D_ht+0x1b859, %rsi
lea addresses_WT_ht+0x16bd9, %rdi
clflush (%rdi)
nop
nop
nop
...
nop
add $13338, %r10
lea addresses_WC_ht+0x10d15, %r11
nop
nop
nop
nop
...
nop
dec %r11
lea addresses_UC_ht+0xf161, %r15
nop
nop
nop
nop
...
{'OP': 'REPM', 'src': {'same': False, 'congruent': 7, 'type': 'addresses_UC_ht'}, 'dst': {'same': True, 'congruent': 2, 'type': 'addresses_D_ht'}}
...
{'OP': 'REPM', 'src': {'same': False, 'congruent': 4, 'type': 'addresses_D_ht'}, 'dst': {'same': False, 'congruent': 9, 'type': 'addresses_WT_ht'}}
{'OP': 'LOAD', 'src': {'same': False, 'type': 'addresses_WC_ht', 'NT': False, 'AVXalign': False, 'size': 1, 'congruent': 1}}
{'OP': 'LOAD', 'src': {'same': False, 'type': 'addresses_UC_ht', 'NT': False, 'AVXalign': True, 'size': 8, 'congruent': 2}}
