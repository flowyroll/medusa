...
push %rdi
push %rsi
lea addresses_WC_ht+0xe703, %rsi
lea addresses_D_ht+0x82c0, %rdi
nop
nop
nop
sub %r13, %r13
...
nop
xor $9745, %rdi
lea addresses_WT_ht+0x17f80, %rbx
clflush (%rbx)
nop
nop
nop
...
nop
sub %r13, %r13
lea addresses_WT_ht+0x6ac0, %rcx
nop
nop
nop
nop
...
nop
add $18688, %r13
lea addresses_UC_ht+0x9120, %r13
nop
and $9827, %r10
mov (%r13), %r15w
nop
...
nop
and %rsi, %rsi
lea addresses_WC_ht+0x1e2c0, %r10
nop
nop
nop
xor $36290, %rbx
...
// Faulty Load
lea addresses_normal+0x12ec0, %rbp
nop
nop
add $49390, %rsi
mov (%rbp), %ebx
