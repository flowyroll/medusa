...
push %rdx
push %rsi
lea addresses_A_ht+0x1c249, %rcx
nop
nop
nop
nop
...
nop
and %rdx, %rdx
lea addresses_normal_ht+0x6749, %rbx
xor $20630, %r9
mov (%rbx), %r12w
nop
nop
...
nop
cmp %rbx, %rbx
lea addresses_WC_ht+0x18f49, %r11
nop
nop
nop
add $21954, %r12
...
nop
xor $20004, %r12
lea addresses_A_ht+0x16589, %r12
nop
nop
nop
xor $8444, %rdi
...
nop
xor %r11, %r11
lea addresses_normal_ht+0x1949, %rsi
lea addresses_D_ht+0x19949, %rdi
inc %rbx
mov $89, %rcx
rep movsw
nop
...
nop
cmp $55324, %rdi
lea addresses_UC_ht+0xa889, %rsi
lea addresses_WC_ht+0x9549, %rdi
nop
nop
nop
nop
...
mov (%rbx), %r12d
inc %rdi
lea addresses_normal_ht+0x15d49, %rdi
nop
nop
nop
nop
...
lea addresses_normal_ht+0x7855, %rdi
nop
cmp %r12, %r12
mov $3, %rcx
rep movsl
...
{'src': {'type': 'addresses_normal_ht', 'AVXalign': True, 'size': 2, 'NT': False, 'same': True, 'congruent': 9}, 'OP': 'LOAD'}
