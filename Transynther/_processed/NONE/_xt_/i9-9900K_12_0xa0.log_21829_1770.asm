...
push %rax
push %rbx
lea addresses_UC_ht+0x17aa8, %r10
nop
nop
nop
nop
...
nop
cmp $10570, %rax
lea addresses_WC_ht+0xa738, %r15
clflush (%r15)
sub %rbx, %rbx
mov (%r15), %r11
nop
...
nop
inc %r10
lea addresses_D_ht+0xc228, %r10
add %r8, %r8
movw $0x6162, (%r10)
nop
cmp %r15, %r15
lea addresses_WT_ht+0x4868, %rbx
nop
nop
nop
nop
...
nop
sub $47245, %r15
lea addresses_WC_ht+0x12e28, %r8
dec %rbx
...
// Faulty Load
lea addresses_normal+0xb828, %r13
nop
xor %r9, %r9
mov (%r13), %bx
lea oracles, %r13
