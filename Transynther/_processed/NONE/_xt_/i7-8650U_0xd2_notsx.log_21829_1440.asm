...
push %rdx
push %rsi
lea addresses_UC_ht+0xafaf, %rdx
nop
nop
nop
and $57090, %rdi
movb (%rdx), %r11b
sub $40500, %r14
lea addresses_normal_ht+0x27af, %rcx
nop
nop
nop
nop
...
nop
cmp %r13, %r13
lea addresses_WC_ht+0x417f, %rsi
lea addresses_D_ht+0x1514f, %rdi
nop
nop
nop
cmp $9799, %rdx
...
nop
and $33148, %r12
lea addresses_A_ht+0x1dfaf, %r14
nop
nop
and $10464, %r12
...
nop
cmp %r13, %r13
lea addresses_A_ht+0x1a1af, %r13
nop
nop
dec %r14
movw $0x6162, (%r13)
...
nop
dec %r11
lea addresses_UC_ht+0x1d97b, %r14
nop
nop
add %rsi, %rsi
movl $0x61626364, (%r14)
...
nop
xor $48071, %rdx
lea addresses_UC_ht+0x1682f, %rsi
lea addresses_D_ht+0x9af, %rdi
nop
nop
nop
nop
...
nop
xor $52460, %rdx
lea addresses_WT_ht+0x43af, %rsi
lea addresses_WC_ht+0x4d91, %rdi
nop
nop
xor %r13, %r13
mov $19, %rcx
...
nop
sub %rsi, %rsi
lea addresses_WT_ht+0xdeaf, %rcx
inc %r12
movups (%rcx), %xmm4
vpextrq $0, %xmm4, %r11
xor %rcx, %rcx
lea addresses_A_ht+0x1d0da, %rsi
lea addresses_UC_ht+0xafaf, %rdi
nop
nop
xor $61508, %rdx
mov $70, %rcx
...
// REPMOV
lea addresses_WC+0x485f, %rsi
lea addresses_D+0x163, %rdi
nop
nop
xor %r11, %r11
mov $67, %rcx
...
// Faulty Load
lea addresses_normal+0x1d7af, %rsi
and %rcx, %rcx
movb (%rsi), %al
lea oracles, %rdi
and $0xff, %rax
...
{'OP': 'REPM', 'src': {'type': 'addresses_WC', 'congruent': 4, 'same': False}, 'dst': {'type': 'addresses_D', 'congruent': 2, 'same': False}}
{'OP': 'STOR', 'dst': {'type': 'addresses_UC', 'size': 2, 'AVXalign': False, 'NT': True, 'congruent': 5, 'same': False}}
...
{'OP': 'LOAD', 'src': {'type': 'addresses_A_ht', 'size': 4, 'AVXalign': False, 'NT': True, 'congruent': 6, 'same': False}}
{'OP': 'REPM', 'src': {'type': 'addresses_normal_ht', 'congruent': 6, 'same': True}, 'dst': {'type': 'addresses_normal_ht', 'congruent': 8, 'same': True}}
...
{'OP': 'REPM', 'src': {'type': 'addresses_UC_ht', 'congruent': 7, 'same': True}, 'dst': {'type': 'addresses_D_ht', 'congruent': 9, 'same': False}}
