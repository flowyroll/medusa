...
push %rdi
push %rsi
lea addresses_normal_ht+0x1a5a6, %rax
nop
cmp $6248, %rsi
movw $0x6162, (%rax)
nop
...
nop
xor %rbp, %rbp
lea addresses_WT_ht+0x618e, %r12
nop
nop
nop
add $16326, %rsi
...
nop
dec %r12
lea addresses_normal_ht+0xf166, %rsi
lea addresses_UC_ht+0xc1a6, %rdi
nop
nop
nop
dec %r9
...
nop
dec %rbx
lea addresses_WC_ht+0x296e, %rsi
lea addresses_WT_ht+0x4466, %rdi
and $57243, %rbx
mov $49, %rcx
rep movsb
nop
...
{'OP': 'REPM', 'src': {'type': 'addresses_WC_ht', 'congruent': 2, 'same': True}, 'dst': {'type': 'addresses_WT_ht', 'congruent': 6, 'same': False}}
{'39': 5882}
