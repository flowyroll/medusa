...
push %rdx
push %rsi
lea addresses_WC_ht+0x4e31, %r14
add %r11, %r11
movups (%r14), %xmm0
vpextrq $0, %xmm0, %rdx
nop
xor %r11, %r11
lea addresses_UC_ht+0x1ce14, %rsi
lea addresses_normal_ht+0x8ba4, %rdi
nop
nop
nop
nop
...
nop
dec %r11
lea addresses_UC_ht+0x139a4, %rsi
...
nop
and $56318, %r11
lea addresses_A_ht+0x1dda4, %rsi
and $62476, %r11
mov $0x6162636465666768, %rcx
movq %rcx, (%rsi)
nop
dec %rcx
lea addresses_D_ht+0x40a4, %rsi
lea addresses_UC_ht+0x2ea4, %rdi
nop
nop
nop
nop
...
nop
sub %rdi, %rdi
lea addresses_normal_ht+0x17fa4, %rbx
nop
cmp %r14, %r14
mov (%rbx), %edi
dec %rdi
lea addresses_A_ht+0xdba4, %r14
nop
nop
sub $56116, %rdi
movl $0x61626364, (%r14)
...
nop
add $65121, %r11
lea addresses_D_ht+0x13a9c, %rcx
xor $7162, %rdx
mov (%rcx), %r14w
nop
nop
inc %rdx
lea addresses_normal_ht+0xe6d8, %rcx
nop
cmp %rbx, %rbx
...
nop
cmp $65115, %rsi
lea addresses_normal_ht+0x3fa4, %rbx
nop
and %rdx, %rdx
mov (%rbx), %r14
nop
add $15411, %rdx
lea addresses_D_ht+0x124ac, %rsi
lea addresses_A_ht+0x105c4, %rdi
nop
nop
sub %r11, %r11
mov $49, %rcx
...
{'src': {'congruent': 3, 'same': True, 'type': 'addresses_UC_ht'}, 'dst': {'congruent': 7, 'same': False, 'type': 'addresses_normal_ht'}, 'OP': 'REPM'}
...
{'src': {'congruent': 8, 'same': False, 'type': 'addresses_D_ht'}, 'dst': {'congruent': 7, 'same': False, 'type': 'addresses_UC_ht'}, 'OP': 'REPM'}
...
{'src': {'congruent': 1, 'same': True, 'type': 'addresses_D_ht'}, 'dst': {'congruent': 4, 'same': False, 'type': 'addresses_A_ht'}, 'OP': 'REPM'}
{'36': 21829}
