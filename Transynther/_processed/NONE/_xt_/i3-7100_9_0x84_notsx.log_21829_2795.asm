...
push %rdx
push %rsi
lea addresses_WC_ht+0x15759, %r9
nop
nop
nop
nop
...
nop
dec %rbp
lea addresses_D_ht+0x8df1, %rsi
xor $53298, %r12
movb $0x61, (%rsi)
and $18086, %r12
lea addresses_normal_ht+0xa4f1, %rsi
lea addresses_UC_ht+0x99b1, %rdi
nop
dec %r14
mov $95, %rcx
rep movsb
...
nop
xor %r14, %r14
lea addresses_WT_ht+0x1c831, %rsi
lea addresses_WT_ht+0x10055, %rdi
clflush (%rsi)
nop
nop
nop
...
nop
xor $2209, %r12
lea addresses_UC_ht+0x23b1, %rdi
nop
nop
nop
nop
...
nop
and $13559, %rdx
lea addresses_normal_ht+0x17d71, %rsi
nop
nop
nop
xor %r9, %r9
...
lea addresses_UC_ht+0x13821, %rdi
and %r12, %r12
mov $66, %rcx
rep movsw
nop
nop
add %r14, %r14
lea addresses_UC_ht+0x1b463, %rsi
lea addresses_UC_ht+0x11b71, %rdi
nop
nop
xor %r9, %r9
mov $102, %rcx
...
{'dst': {'type': 'addresses_RW', 'same': False, 'size': 2, 'congruent': 8, 'NT': False, 'AVXalign': True}, 'OP': 'STOR'}
...
{'src': {'type': 'addresses_WT_ht', 'congruent': 6, 'same': False}, 'dst': {'type': 'addresses_WT_ht', 'congruent': 1, 'same': False}, 'OP': 'REPM'}
...
{'src': {'type': 'addresses_WC_ht', 'congruent': 1, 'same': False}, 'dst': {'type': 'addresses_UC_ht', 'congruent': 4, 'same': False}, 'OP': 'REPM'}
