...
push %rdi
push %rsi
lea addresses_normal_ht+0x16c8e, %rsi
nop
nop
nop
nop
...
nop
inc %rdi
lea addresses_WC_ht+0x100f6, %r10
nop
nop
nop
inc %r15
...
mov (%rdi), %eax
and $44194, %rax
lea addresses_WT_ht+0x1253e, %r10
nop
sub %rdi, %rdi
movw $0x6162, (%r10)
nop
...
nop
xor $12279, %r11
lea addresses_normal_ht+0xa38e, %r15
nop
nop
nop
nop
...
nop
xor %rdi, %rdi
lea addresses_UC_ht+0x16b8e, %rsi
...
nop
sub $44745, %rax
lea addresses_UC_ht+0x9e8e, %r12
and %r15, %r15
...
nop
dec %r15
lea addresses_WT_ht+0x915e, %rcx
xor $35616, %r12
movups (%rcx), %xmm1
vpextrq $1, %xmm1, %r10
nop
...
{'src': {'type': 'addresses_A_ht', 'AVXalign': True, 'size': 4, 'NT': False, 'same': False, 'congruent': 6}, 'OP': 'LOAD'}
