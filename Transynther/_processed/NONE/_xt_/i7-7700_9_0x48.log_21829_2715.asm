...
push %rdi
push %rsi
lea addresses_WT_ht+0x173be, %r12
nop
nop
nop
sub %r13, %r13
...
nop
add $34680, %r10
lea addresses_A_ht+0x17750, %r12
sub %rbp, %rbp
mov (%r12), %ebx
nop
nop
xor %rbp, %rbp
lea addresses_D_ht+0x1eb3e, %rsi
lea addresses_WC_ht+0x51fe, %rdi
nop
nop
nop
nop
...
nop
add %r10, %r10
lea addresses_UC_ht+0x50a6, %rsi
lea addresses_WT_ht+0xbd0e, %rdi
clflush (%rsi)
nop
nop
nop
...
nop
dec %r13
lea addresses_normal_ht+0x11f8e, %rsi
lea addresses_A_ht+0x55f0, %rdi
nop
xor %rax, %rax
mov $60, %rcx
rep movsl
nop
sub $39746, %rsi
lea addresses_D_ht+0x14bf6, %rbx
nop
sub %rax, %rax
mov (%rbx), %ecx
nop
cmp $2628, %rbx
lea addresses_WT_ht+0x1902a, %rbp
clflush (%rbp)
nop
and %rbx, %rbx
mov (%rbp), %r13
nop
and %rcx, %rcx
lea addresses_D_ht+0x1bbee, %rsi
lea addresses_D_ht+0x1b3be, %rdi
nop
nop
add $20717, %r12
mov $96, %rcx
...
nop
and $34515, %rcx
lea addresses_normal_ht+0x105ec, %rax
nop
nop
nop
nop
...
nop
xor %r10, %r10
lea addresses_normal_ht+0x16d06, %rbp
nop
nop
nop
nop
...
nop
add $45210, %rbx
lea addresses_normal_ht+0x1e63d, %rbx
xor $30144, %r10
mov (%rbx), %cx
nop
nop
...
{'OP': 'REPM', 'src': {'type': 'addresses_D_ht', 'congruent': 7, 'same': False}, 'dst': {'type': 'addresses_WC_ht', 'congruent': 6, 'same': True}}
...
{'OP': 'LOAD', 'src': {'type': 'addresses_normal_ht', 'AVXalign': False, 'congruent': 2, 'size': 2, 'same': True, 'NT': False}}
