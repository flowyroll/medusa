...
push %rdi
push %rsi
lea addresses_UC_ht+0x89d9, %rax
nop
nop
nop
inc %rbp
...
nop
xor %r11, %r11
lea addresses_UC_ht+0x7ed9, %r13
nop
nop
add %r9, %r9
mov (%r13), %rsi
nop
dec %rax
lea addresses_UC_ht+0x5f25, %r11
nop
xor %rcx, %rcx
movb $0x61, (%r11)
dec %r11
lea addresses_normal_ht+0x11a59, %rbp
xor %r13, %r13
mov (%rbp), %esi
nop
nop
...
nop
add $21608, %rcx
lea addresses_UC_ht+0x1a661, %r9
clflush (%r9)
nop
nop
nop
...
nop
add %r13, %r13
lea addresses_WC_ht+0x116d9, %rsi
lea addresses_normal_ht+0x5579, %rdi
nop
nop
nop
nop
...
nop
inc %rsi
lea addresses_A_ht+0x14859, %r13
nop
nop
nop
add $42493, %rbp
...
{'OP': 'LOAD', 'src': {'same': False, 'type': 'addresses_RW', 'NT': False, 'AVXalign': True, 'size': 1, 'congruent': 6}}
...
{'OP': 'REPM', 'src': {'same': False, 'congruent': 7, 'type': 'addresses_WC_ht'}, 'dst': {'same': False, 'congruent': 3, 'type': 'addresses_normal_ht'}}
