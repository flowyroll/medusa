...
lea addresses_WT_ht+0x1665d, %rdi
inc %r10
mov $47, %rcx
rep movsl
xor %r14, %r14
lea addresses_D_ht+0x187bd, %rsi
lea addresses_D_ht+0x77dd, %rdi
nop
nop
nop
nop
...
nop
and $18674, %rdx
lea addresses_WT_ht+0x7f83, %rsi
lea addresses_UC_ht+0x1c7dd, %rdi
nop
nop
nop
nop
...
nop
cmp $29146, %rsi
lea addresses_A_ht+0x18f0d, %rsi
...
nop
sub %rdx, %rdx
lea addresses_normal_ht+0x14fdd, %rsi
lea addresses_WC_ht+0x1cb8d, %rdi
clflush (%rdi)
nop
nop
nop
...
rep movsb
xor %r8, %r8
lea addresses_normal_ht+0x177dd, %rsi
lea addresses_D_ht+0x10fdd, %rdi
nop
nop
nop
nop
...
rep movsq
xor %rcx, %rcx
lea addresses_WT_ht+0x105dd, %r14
xor %rsi, %rsi
...
nop
dec %rdx
lea addresses_A_ht+0x1377d, %rsi
...
nop
sub %rcx, %rcx
lea addresses_WC_ht+0x17d3d, %rsi
lea addresses_normal_ht+0x177dd, %rdi
nop
xor %r8, %r8
mov $93, %rcx
rep movsb
...
{'src': {'type': 'addresses_D_ht', 'congruent': 3, 'same': False}, 'OP': 'REPM', 'dst': {'type': 'addresses_D_ht', 'congruent': 11, 'same': True}}
...
{'src': {'type': 'addresses_normal_ht', 'congruent': 11, 'same': False}, 'OP': 'REPM', 'dst': {'type': 'addresses_WC_ht', 'congruent': 2, 'same': False}}
...
{'src': {'type': 'addresses_A_ht', 'congruent': 5, 'same': True}, 'OP': 'REPM', 'dst': {'type': 'addresses_WT_ht', 'congruent': 3, 'same': False}}
