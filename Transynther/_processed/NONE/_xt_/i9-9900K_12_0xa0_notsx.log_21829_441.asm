...
push %rdi
push %rsi
lea addresses_D_ht+0x18841, %rsi
lea addresses_WC_ht+0x9a9, %rdi
clflush (%rdi)
nop
nop
inc %rbp
...
nop
xor %rax, %rax
lea addresses_D_ht+0x1dc89, %r13
nop
nop
nop
and %rsi, %rsi
...
// REPMOV
lea addresses_D+0x2851, %rsi
lea addresses_WC+0x11341, %rdi
nop
nop
nop
add $23622, %r9
...
// Faulty Load
lea addresses_normal+0x1be41, %rcx
nop
nop
nop
nop
...
{'src': {'type': 'addresses_D', 'congruent': 4, 'same': False}, 'OP': 'REPM', 'dst': {'type': 'addresses_WC', 'congruent': 5, 'same': False}}
[Faulty Load]
{'src': {'type': 'addresses_normal', 'AVXalign': False, 'size': 8, 'NT': False, 'same': True, 'congruent': 0}, 'OP': 'LOAD'}
<gen_prepare_buffer>
