...
push %rdx
push %rsi
lea addresses_WC_ht+0x19926, %rdx
clflush (%rdx)
nop
cmp $5055, %rdi
movb (%rdx), %bl
...
nop
and %r13, %r13
lea addresses_A_ht+0x1e00e, %rsi
clflush (%rsi)
nop
nop
nop
...
nop
cmp %rdi, %rdi
lea addresses_normal_ht+0x1d63e, %rsi
lea addresses_normal_ht+0x1cbf, %rdi
nop
nop
nop
and %r13, %r13
...
nop
xor $34946, %rsi
lea addresses_A_ht+0x1adc, %rsi
lea addresses_UC_ht+0xf21e, %rdi
nop
nop
nop
nop
...
nop
xor $20295, %rsi
lea addresses_A_ht+0x4a3e, %rsi
lea addresses_WC_ht+0x88de, %rdi
nop
nop
nop
nop
...
rep movsq
xor $16933, %rbx
lea addresses_A_ht+0x16d3e, %rdx
add $18266, %rbx
mov (%rdx), %r11w
nop
nop
...
nop
and $40981, %rdi
lea addresses_A_ht+0x14dfe, %rdi
nop
nop
nop
cmp %rsi, %rsi
...
nop
add $41989, %rsi
lea addresses_normal_ht+0x1719e, %r13
nop
nop
nop
nop
...
nop
and $5594, %r13
lea addresses_D_ht+0x16f3e, %rdi
xor %rbx, %rbx
mov (%rdi), %dx
nop
cmp %rsi, %rsi
lea addresses_WT_ht+0x1a278, %rcx
nop
nop
nop
sub $39989, %rbp
movb (%rcx), %r13b
and %rsi, %rsi
lea addresses_D_ht+0x1db3e, %rcx
cmp $57621, %rbx
mov (%rcx), %r13w
add $23679, %rbp
pop %rsi
...
// Load
lea addresses_normal+0x873e, %r8
nop
add $45547, %r13
movups (%r8), %xmm6
vpextrq $0, %xmm6, %r15
...
// Faulty Load
lea addresses_normal+0x873e, %r12
cmp %r14, %r14
vmovups (%r12), %ymm6
...
{'src': {'same': False, 'congruent': 1, 'type': 'addresses_A_ht'}, 'OP': 'REPM', 'dst': {'same': False, 'congruent': 4, 'type': 'addresses_UC_ht'}}
{'src': {'same': True, 'congruent': 8, 'type': 'addresses_A_ht'}, 'OP': 'REPM', 'dst': {'same': False, 'congruent': 5, 'type': 'addresses_WC_ht'}}
...
{'src': {'NT': False, 'same': True, 'congruent': 10, 'type': 'addresses_D_ht', 'AVXalign': True, 'size': 2}, 'OP': 'LOAD'}
