...
// Store
lea addresses_normal+0x15fb2, %r9
nop
nop
mfence
...
// Load
lea addresses_WC+0x1e4c0, %rbx
dec %r15
mov (%rbx), %di
cmp $51957, %rbx

// Store
lea addresses_A+0xa368, %r10
nop
nop
nop
nop
...
{'src': {'same': False, 'congruent': 2, 'NT': False, 'type': 'addresses_WC', 'size': 2, 'AVXalign': False}, 'OP': 'LOAD'}
{'OP': 'STOR', 'dst': {'same': False, 'congruent': 3, 'NT': False, 'type': 'addresses_A', 'size': 8, 'AVXalign': True}}
