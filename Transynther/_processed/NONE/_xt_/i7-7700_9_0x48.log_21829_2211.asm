...
nop
xor $16406, %r10
lea addresses_normal_ht+0x1a72d, %rsi
lea addresses_D_ht+0x1c72d, %rdi
nop
nop
nop
nop
...
nop
sub $52650, %r14
lea addresses_WT_ht+0xc72d, %rcx
nop
nop
nop
cmp $59494, %r15
...
movaps %xmm5, (%rcx)
add %rax, %rax
lea addresses_A_ht+0x1301d, %rsi
lea addresses_WC_ht+0x90f9, %rdi
nop
nop
xor %r10, %r10
mov $14, %rcx
...
nop
mfence
lea addresses_D_ht+0x1b83d, %rax
nop
nop
nop
nop
...
nop
and %rax, %rax
lea addresses_A_ht+0x1ab2d, %rsi
lea addresses_normal_ht+0xf4db, %rdi
nop
nop
nop
nop
...
nop
sub %rcx, %rcx
lea addresses_normal_ht+0xfad, %r10
nop
nop
nop
nop
...
nop
xor %r14, %r14
lea addresses_WT_ht+0xaa2d, %r10
nop
nop
nop
nop
...
movl $0x61626364, (%r10)
dec %r14
lea addresses_WC_ht+0x16811, %rax
nop
nop
add $8280, %rsi
mov (%rax), %r14
...
nop
sub $14996, %r15
lea addresses_D_ht+0xcf3d, %rsi
lea addresses_WC_ht+0x1732d, %rdi
nop
nop
nop
nop
