...
push %rdx
push %rsi
lea addresses_normal_ht+0x30e9, %r12
nop
nop
nop
nop
...
nop
cmp $57843, %r12
lea addresses_WC_ht+0x16b69, %rax
nop
nop
cmp $19703, %rbp
movb (%rax), %r12b
nop
and $3132, %rax
lea addresses_UC_ht+0xb2a1, %r13
nop
nop
nop
nop
...
nop
cmp $48069, %rdx
lea addresses_D_ht+0x1b5e9, %rsi
lea addresses_D_ht+0xfce9, %rdi
cmp %rdx, %rdx
mov $89, %rcx
rep movsb
nop
...
nop
add %rdi, %rdi
lea addresses_normal_ht+0x2469, %rsi
...
nop
xor %rdi, %rdi
lea addresses_D_ht+0x11e55, %rsi
lea addresses_D_ht+0xf669, %rdi
nop
and %r14, %r14
mov $74, %rcx
rep movsb
xor $54888, %r14
lea addresses_normal_ht+0x16689, %rax
nop
nop
nop
inc %rsi
...
{'src': {'NT': True, 'AVXalign': False, 'size': 4, 'congruent': 0, 'same': False, 'type': 'addresses_D_ht'}, 'OP': 'LOAD'}
...
{'src': {'congruent': 2, 'same': False, 'type': 'addresses_D_ht'}, 'dst': {'congruent': 6, 'same': False, 'type': 'addresses_D_ht'}, 'OP': 'REPM'}
