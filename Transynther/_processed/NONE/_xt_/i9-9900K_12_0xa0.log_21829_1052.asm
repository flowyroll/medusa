...
push %rbx
push %rdx
lea addresses_normal_ht+0x1517c, %rbx
clflush (%rbx)
add $13675, %r11
mov (%rbx), %r15w
nop
...
nop
xor %r10, %r10
lea addresses_UC_ht+0x1a52c, %r12
nop
nop
nop
nop
...
movq %rbx, (%r11)
add %rbx, %rbx
lea addresses_UC_ht+0xe0bc, %r15
nop
nop
nop
nop
...
nop
xor %r13, %r13
lea addresses_WC_ht+0xbc6a, %r10
nop
nop
nop
cmp $8429, %r11
...
{'OP': 'STOR', 'dst': {'NT': True, 'same': True, 'congruent': 4, 'type': 'addresses_UC_ht', 'AVXalign': False, 'size': 32}}
