...
nop
inc %r14
lea addresses_D_ht+0xca76, %rsi
lea addresses_UC_ht+0xc39a, %rdi
nop
nop
nop
add %r13, %r13
...
nop
dec %r14
lea addresses_UC_ht+0x176a2, %rsi
clflush (%rsi)
inc %r14
movups (%rsi), %xmm4
vpextrq $1, %xmm4, %r13
...
nop
xor $15235, %r15
lea addresses_normal_ht+0x5b2, %r9
nop
nop
add %r13, %r13
...
nop
and $61626, %r9
lea addresses_normal_ht+0x1319a, %rcx
nop
nop
nop
nop
...
nop
cmp %r15, %r15
lea addresses_A_ht+0x9562, %rsi
lea addresses_normal_ht+0x102a2, %rdi
nop
nop
nop
nop
...
nop
add %rsi, %rsi
lea addresses_normal_ht+0x109a2, %rsi
xor %r13, %r13
mov $0x6162636465666768, %r14
movq %r14, %xmm2
movups %xmm2, (%rsi)
...
nop
and $10868, %rsi
lea addresses_D_ht+0x112a2, %r11
nop
nop
nop
add %rcx, %rcx
...
nop
xor %r11, %r11
lea addresses_A_ht+0x1c8a2, %rdi
nop
add $53662, %r14
...
vmovups %ymm2, (%rdi)
add $42381, %rbx
lea addresses_normal_ht+0x598e, %r14
nop
nop
xor %r13, %r13
mov (%r14), %rbx
...
// Store
lea addresses_normal+0x8ea2, %rbx
nop
nop
nop
sub $10131, %r9
...
{'dst': {'same': False, 'NT': True, 'AVXalign': False, 'size': 2, 'type': 'addresses_WC_ht', 'congruent': 2}, 'OP': 'STOR'}
{'dst': {'same': False, 'congruent': 3, 'type': 'addresses_UC_ht'}, 'OP': 'REPM', 'src': {'same': False, 'congruent': 1, 'type': 'addresses_D_ht'}}
...
{'dst': {'same': False, 'congruent': 8, 'type': 'addresses_normal_ht'}, 'OP': 'REPM', 'src': {'same': False, 'congruent': 4, 'type': 'addresses_A_ht'}}
{'OP': 'LOAD', 'src': {'same': True, 'NT': False, 'AVXalign': True, 'size': 1, 'type': 'addresses_D_ht', 'congruent': 1}}
