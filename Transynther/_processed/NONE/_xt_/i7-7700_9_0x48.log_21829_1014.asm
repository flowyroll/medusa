...
push %rdi
push %rsi
lea addresses_A_ht+0x145f, %rsi
lea addresses_WT_ht+0x2f1f, %rdi
nop
nop
nop
nop
...
nop
add %r11, %r11
lea addresses_WT_ht+0x2da1, %r14
nop
nop
nop
cmp %r8, %r8
...
nop
cmp $47408, %rdi
lea addresses_D_ht+0xad7f, %rsi
lea addresses_WT_ht+0x6f9f, %rdi
nop
nop
nop
nop
...
nop
sub %r14, %r14
lea addresses_WT_ht+0xe35b, %r11
nop
nop
nop
nop
...
nop
and %r11, %r11
lea addresses_normal_ht+0xc91f, %rsi
lea addresses_A_ht+0xdf1f, %rdi
nop
nop
nop
sub $2202, %r13
...
rep movsw
and $60159, %r13
lea addresses_WT_ht+0x1296f, %r9
nop
and %r14, %r14
movl $0x61626364, (%r9)
nop
xor %rcx, %rcx
lea addresses_UC_ht+0x1b31f, %rsi
lea addresses_WC_ht+0x991f, %rdi
nop
inc %r11
mov $119, %rcx
rep movsw
nop
add %r13, %r13
lea addresses_WC_ht+0x741f, %rsi
lea addresses_WT_ht+0x143df, %rdi
nop
nop
nop
sub %r8, %r8
...
// Load
lea addresses_normal+0x1e25, %rdi
nop
nop
nop
nop
...
// Faulty Load
lea addresses_normal+0x6f1f, %rax
nop
nop
cmp %rdx, %rdx
movb (%rax), %r9b
...
{'OP': 'LOAD', 'src': {'type': 'addresses_normal', 'AVXalign': False, 'congruent': 1, 'size': 32, 'same': False, 'NT': False}}
[Faulty Load]
...
{'OP': 'REPM', 'src': {'type': 'addresses_normal_ht', 'congruent': 7, 'same': False}, 'dst': {'type': 'addresses_A_ht', 'congruent': 9, 'same': True}}
