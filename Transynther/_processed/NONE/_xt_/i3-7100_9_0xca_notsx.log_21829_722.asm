...
push %rdx
push %rsi
lea addresses_A_ht+0x125e4, %rdx
nop
nop
cmp %rcx, %rcx
mov (%rdx), %r14w
...
nop
sub $58858, %r15
lea addresses_WT_ht+0x3f2c, %rsi
...
nop
add $22144, %rdx
lea addresses_UC_ht+0x1a4a4, %r13
nop
nop
nop
add %rsi, %rsi
...
nop
add %rcx, %rcx
lea addresses_UC_ht+0x117e4, %rsi
nop
nop
add $49090, %r13
movw $0x6162, (%rsi)
...
{'src': {'type': 'addresses_WT_ht', 'congruent': 3, 'same': False}, 'OP': 'REPM', 'dst': {'type': 'addresses_normal_ht', 'congruent': 3, 'same': False}}
