...
nop
and $44662, %r10
lea addresses_D_ht+0x106ab, %rsi
nop
nop
nop
add %r8, %r8
...
nop
xor %rcx, %rcx
lea addresses_A_ht+0x108a3, %rbx
nop
nop
inc %r13
movw $0x6162, (%rbx)
...
lea addresses_UC_ht+0x1738b, %rdi
nop
and %r9, %r9
mov $67, %rcx
rep movsw
...
nop
and %rdi, %rdi
lea addresses_WC_ht+0xd30b, %rsi
nop
nop
cmp $58787, %r10
vmovups (%rsi), %ymm1
...
nop
sub %r8, %r8
lea addresses_normal_ht+0x2ea3, %rdi
nop
nop
nop
add %r8, %r8
...
nop
xor %r8, %r8
lea addresses_normal_ht+0xcaa3, %rsi
lea addresses_WT_ht+0x4732, %rdi
nop
nop
nop
nop
...
nop
cmp %r10, %r10
lea addresses_A_ht+0x1eae7, %rbx
nop
nop
nop
cmp %rsi, %rsi
...
nop
dec %rdi
lea addresses_A_ht+0x1a9a3, %rsi
nop
nop
dec %r13
movl $0x61626364, (%rsi)
...
<gen_faulty_load>
[REF]
{'OP': 'LOAD', 'src': {'size': 1, 'NT': False, 'type': 'addresses_PSE', 'same': False, 'AVXalign': True, 'congruent': 0}}
...
{'OP': 'REPM', 'src': {'same': False, 'type': 'addresses_D_ht', 'congruent': 7}, 'dst': {'same': False, 'type': 'addresses_UC_ht', 'congruent': 2}}
...
{'OP': 'REPM', 'src': {'same': False, 'type': 'addresses_normal_ht', 'congruent': 11}, 'dst': {'same': False, 'type': 'addresses_WT_ht', 'congruent': 0}}
