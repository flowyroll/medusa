...
rep movsl
add %rdi, %rdi
lea addresses_normal_ht+0xbcbc, %rsi
lea addresses_WC_ht+0x13400, %rdi
nop
dec %rbp
mov $108, %rcx
rep movsq
...
nop
and %r14, %r14
lea addresses_D_ht+0x19134, %rsi
lea addresses_normal_ht+0x99c1, %rdi
nop
nop
nop
nop
...
nop
xor $45129, %r11
lea addresses_UC_ht+0x19cbc, %rsi
nop
nop
nop
nop
...
nop
dec %rdi
lea addresses_D_ht+0x1c79c, %r8
clflush (%r8)
add %r12, %r12
movups (%r8), %xmm0
vpextrq $0, %xmm0, %rbp
add %r14, %r14
lea addresses_WT_ht+0x178bc, %rsi
xor $31209, %r14
mov (%rsi), %edi
and %rcx, %rcx
pop %rsi
...
// REPMOV
lea addresses_A+0xdabc, %rsi
lea addresses_RW+0x1225c, %rdi
nop
nop
and %r13, %r13
mov $21, %rcx
...
{'dst': {'NT': True, 'AVXalign': False, 'size': 1, 'congruent': 4, 'same': False, 'type': 'addresses_UC'}, 'OP': 'STOR'}
{'dst': {'NT': False, 'AVXalign': False, 'size': 32, 'congruent': 6, 'same': False, 'type': 'addresses_WC'}, 'OP': 'STOR'}
{'src': {'congruent': 9, 'same': False, 'type': 'addresses_A'}, 'dst': {'congruent': 5, 'same': False, 'type': 'addresses_RW'}, 'OP': 'REPM'}
[Faulty Load]
...
{'src': {'congruent': 6, 'same': False, 'type': 'addresses_WT_ht'}, 'dst': {'congruent': 11, 'same': False, 'type': 'addresses_D_ht'}, 'OP': 'REPM'}
{'src': {'congruent': 9, 'same': True, 'type': 'addresses_normal_ht'}, 'dst': {'congruent': 2, 'same': False, 'type': 'addresses_WC_ht'}, 'OP': 'REPM'}
