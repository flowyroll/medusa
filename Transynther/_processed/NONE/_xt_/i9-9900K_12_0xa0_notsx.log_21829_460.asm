...
movb (%r14), %r10b
add %rsi, %rsi
lea addresses_normal_ht+0xcaec, %rsi
lea addresses_D_ht+0x116dc, %rdi
clflush (%rdi)
nop
nop
nop
...
nop
xor %r10, %r10
lea addresses_WC_ht+0x1b343, %r8
clflush (%r8)
nop
nop
xor $21384, %r10
...
nop
cmp %r8, %r8
lea addresses_UC_ht+0xffec, %r10
nop
nop
nop
xor $15067, %rdi
...
nop
and %rax, %rax
lea addresses_UC_ht+0x1dc2c, %rcx
nop
nop
nop
nop
...
lea addresses_D_ht+0x13a2c, %rdi
nop
nop
sub $11512, %rax
mov $40, %rcx
...
nop
cmp %rcx, %rcx
lea addresses_WC_ht+0x1b52c, %rsi
nop
nop
nop
xor %rcx, %rcx
...
lea addresses_UC_ht+0x2cfc, %rdi
nop
nop
nop
cmp $1095, %rax
...
rep movsb
and $24222, %rsi
lea addresses_A_ht+0x15a2c, %r14
nop
nop
nop
nop
...
nop
sub %rdi, %rdi
lea addresses_normal_ht+0x148cc, %rsi
lea addresses_WT_ht+0x1ccec, %rdi
and $62599, %r12
mov $92, %rcx
rep movsq
nop
...
{'src': {'type': 'addresses_normal_ht', 'congruent': 6, 'same': True}, 'OP': 'REPM', 'dst': {'type': 'addresses_D_ht', 'congruent': 2, 'same': True}}
...
{'src': {'type': 'addresses_A_ht', 'AVXalign': False, 'size': 16, 'NT': False, 'same': True, 'congruent': 10}, 'OP': 'LOAD'}
{'src': {'type': 'addresses_UC_ht', 'AVXalign': False, 'size': 4, 'NT': False, 'same': False, 'congruent': 9}, 'OP': 'LOAD'}
{'src': {'type': 'addresses_WT_ht', 'congruent': 8, 'same': False}, 'OP': 'REPM', 'dst': {'type': 'addresses_D_ht', 'congruent': 10, 'same': True}}
{'OP': 'STOR', 'dst': {'type': 'addresses_WC_ht', 'AVXalign': False, 'size': 1, 'NT': False, 'same': False, 'congruent': 8}}
{'src': {'type': 'addresses_A_ht', 'congruent': 4, 'same': False}, 'OP': 'REPM', 'dst': {'type': 'addresses_UC_ht', 'congruent': 4, 'same': False}}
