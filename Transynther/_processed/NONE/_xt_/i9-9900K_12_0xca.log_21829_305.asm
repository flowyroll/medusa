...
nop
cmp $13352, %r10
lea addresses_WT_ht+0xb38d, %r15
nop
dec %rbx
movb $0x61, (%r15)
nop
nop
and $51501, %r14
lea addresses_UC_ht+0xbba9, %rdi
nop
cmp %rsi, %rsi
mov (%rdi), %r10d
nop
...
nop
cmp %r10, %r10
lea addresses_WT_ht+0x2ea9, %rdi
nop
nop
nop
add $12051, %r10
...
nop
cmp $3626, %rcx
lea addresses_D_ht+0x53a9, %r14
nop
and %r15, %r15
movl $0x61626364, (%r14)
nop
add $9218, %rdi
lea addresses_UC_ht+0xcd89, %rsi
lea addresses_A_ht+0xe3a9, %rdi
nop
nop
nop
and %rdx, %rdx
...
nop
cmp $43368, %rsi
lea addresses_WC_ht+0xa3a9, %rsi
lea addresses_WC_ht+0x1dba9, %rdi
nop
nop
nop
nop
...
nop
dec %r14
lea addresses_WC_ht+0x29a9, %rsi
lea addresses_D_ht+0x123a9, %rdi
nop
nop
sub %rdx, %rdx
mov $96, %rcx
...
// Store
lea addresses_normal+0x143a9, %r8
nop
nop
nop
cmp %rdi, %rdi
...
{'OP': 'STOR', 'dst': {'size': 32, 'NT': False, 'type': 'addresses_A_ht', 'same': False, 'AVXalign': True, 'congruent': 1}}
{'32': 21829}
