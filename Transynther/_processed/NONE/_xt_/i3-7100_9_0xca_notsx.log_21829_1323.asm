...
push %rdx
push %rsi
lea addresses_D_ht+0x1ac63, %rcx
nop
nop
nop
sub %r14, %r14
...
nop
dec %r9
lea addresses_UC_ht+0x3c63, %rbp
clflush (%rbp)
nop
nop
nop
...
nop
xor $41415, %rcx
lea addresses_UC_ht+0xf8bb, %rbp
nop
nop
cmp $33969, %rcx
movb $0x61, (%rbp)
nop
sub $57853, %r9
lea addresses_normal_ht+0x1bc63, %r14
nop
nop
cmp %r12, %r12
...
lea addresses_normal_ht+0x46af, %rdi
xor %rdx, %rdx
mov $85, %rcx
rep movsb
nop
...
nop
xor %rdi, %rdi
lea addresses_A_ht+0x10047, %rbp
clflush (%rbp)
nop
nop
and $59958, %rdx
movw $0x6162, (%rbp)
add $32025, %r12
lea addresses_WT_ht+0x58ab, %rsi
lea addresses_normal_ht+0xd953, %rdi
nop
nop
nop
cmp %rdx, %rdx
...
nop
cmp %r12, %r12
lea addresses_D_ht+0x1a863, %r15
nop
nop
nop
nop
...
nop
xor $13318, %rsi
lea addresses_D_ht+0x9063, %rsi
lea addresses_D_ht+0x12083, %rdi
clflush (%rsi)
nop
nop
nop
...
// REPMOV
lea addresses_A+0x6c63, %rsi
lea addresses_WT+0x11163, %rdi
clflush (%rsi)
xor %r9, %r9
mov $118, %rcx
rep movsb
...
{'src': {'type': 'addresses_A', 'congruent': 0, 'same': True}, 'OP': 'REPM', 'dst': {'type': 'addresses_WT', 'congruent': 7, 'same': False}}
...
{'OP': 'STOR', 'dst': {'same': False, 'congruent': 11, 'NT': True, 'type': 'addresses_D_ht', 'size': 8, 'AVXalign': False}}
{'src': {'type': 'addresses_D_ht', 'congruent': 8, 'same': False}, 'OP': 'REPM', 'dst': {'type': 'addresses_D_ht', 'congruent': 4, 'same': False}}
{'35': 21829}
