...
push %rdi
push %rsi
lea addresses_UC_ht+0x19d72, %r12
nop
and $9070, %r15
vmovups (%r12), %ymm7
...
nop
inc %rbx
lea addresses_A_ht+0x11f76, %rsi
lea addresses_UC_ht+0x1c882, %rdi
nop
nop
nop
nop
...
nop
xor $24279, %r15
lea addresses_A_ht+0xc346, %rsi
lea addresses_normal_ht+0x1c146, %rdi
inc %rbx
mov $126, %rcx
rep movsl
nop
...
nop
cmp %r13, %r13
lea addresses_A_ht+0xd20a, %rsi
lea addresses_A_ht+0x7a66, %rdi
nop
nop
nop
nop
...
nop
dec %rsi
lea addresses_UC_ht+0x11d86, %r12
nop
cmp %rcx, %rcx
movw $0x6162, (%r12)
xor %r15, %r15
lea addresses_normal_ht+0x18b76, %rsi
nop
nop
add %rdi, %rdi
...
nop
xor $60451, %r15
lea addresses_UC_ht+0x1db46, %rsi
lea addresses_UC_ht+0x18f46, %rdi
clflush (%rdi)
nop
nop
nop
...
nop
inc %r13
lea addresses_WT_ht+0x6346, %rbx
cmp $60793, %r15
mov (%rbx), %rdi
nop
nop
...
nop
sub %rbx, %rbx
lea addresses_D_ht+0x6d06, %r12
nop
xor $8877, %rsi
mov (%r12), %edi
and $11278, %rbx
lea addresses_D_ht+0x12abe, %rsi
nop
nop
nop
add %r13, %r13
...
{'OP': 'REPM', 'src': {'same': False, 'congruent': 11, 'type': 'addresses_A_ht'}, 'dst': {'same': False, 'congruent': 9, 'type': 'addresses_normal_ht'}}
{'OP': 'LOAD', 'src': {'same': False, 'type': 'addresses_A_ht', 'NT': False, 'AVXalign': False, 'size': 1, 'congruent': 0}}
{'OP': 'REPM', 'src': {'same': True, 'congruent': 2, 'type': 'addresses_A_ht'}, 'dst': {'same': True, 'congruent': 4, 'type': 'addresses_A_ht'}}
...
{'OP': 'REPM', 'src': {'same': False, 'congruent': 7, 'type': 'addresses_UC_ht'}, 'dst': {'same': False, 'congruent': 9, 'type': 'addresses_UC_ht'}}
