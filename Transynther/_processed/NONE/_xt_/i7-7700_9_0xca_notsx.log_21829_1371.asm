...
push %rdx
push %rsi
lea addresses_WC_ht+0x19200, %r13
nop
dec %r9
...
lea addresses_normal_ht+0xad82, %rdi
nop
nop
xor %r12, %r12
mov $29, %rcx
...
vpextrq $0, %xmm7, %rdx
sub $49312, %r9
lea addresses_normal_ht+0x43e2, %rsi
lea addresses_normal_ht+0x100d2, %rdi
clflush (%rdi)
nop
nop
nop
...
nop
sub $20251, %r15
lea addresses_UC_ht+0x1bdf2, %r12
nop
nop
nop
nop
...
nop
sub %rdi, %rdi
lea addresses_A_ht+0x2ff2, %rsi
lea addresses_normal_ht+0x9572, %rdi
nop
nop
nop
dec %r12
...
nop
cmp $9887, %r13
lea addresses_D_ht+0x10b3a, %r13
clflush (%r13)
nop
nop
nop
...
vmovups %ymm2, (%r9)
cmp $50745, %rdx
lea addresses_UC_ht+0x114f2, %rsi
nop
nop
cmp %rcx, %rcx
...
nop
cmp %rdx, %rdx
lea addresses_D_ht+0x1d735, %rsi
lea addresses_WT_ht+0x1c472, %rdi
nop
nop
nop
add %r15, %r15
...
// Store
lea addresses_normal+0x1079a, %rax
nop
sub $13730, %r15
...
{'dst': {'NT': False, 'AVXalign': False, 'size': 32, 'congruent': 8, 'same': True, 'type': 'addresses_A'}, 'OP': 'STOR'}
...
<gen_prepare_buffer>
{'src': {'NT': True, 'AVXalign': False, 'size': 16, 'congruent': 1, 'same': True, 'type': 'addresses_WC_ht'}, 'OP': 'LOAD'}
...
{'src': {'congruent': 7, 'same': False, 'type': 'addresses_A_ht'}, 'dst': {'congruent': 7, 'same': False, 'type': 'addresses_normal_ht'}, 'OP': 'REPM'}
