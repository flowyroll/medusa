...
nop
xor $59911, %rcx
lea addresses_WT_ht+0xd938, %rsi
lea addresses_WT_ht+0x3298, %rdi
nop
and %rbp, %rbp
mov $92, %rcx
rep movsl
...
nop
sub %rbp, %rbp
lea addresses_normal_ht+0x102f8, %rsi
nop
nop
nop
nop
...
nop
xor $4107, %r11
lea addresses_D_ht+0x19e3c, %rbp
clflush (%rbp)
nop
add %rdi, %rdi
mov (%rbp), %cx
nop
inc %rsi
lea addresses_A_ht+0x11b28, %rsi
lea addresses_D_ht+0x150f8, %rdi
nop
nop
nop
and %r10, %r10
...
nop
and %r9, %r9
lea addresses_WC_ht+0x1a5f8, %rsi
lea addresses_WC_ht+0x1d528, %rdi
nop
nop
nop
nop
...
nop
sub $47554, %rsi
lea addresses_UC_ht+0x2cc0, %r13
nop
nop
nop
add %rbp, %rbp
...
// REPMOV
lea addresses_normal+0x169f8, %rsi
mov $0xb2, %rdi
nop
nop
nop
...
// Faulty Load
lea addresses_normal+0x86f8, %r13
nop
xor $50834, %r8
mov (%r13), %rbx
lea oracles, %rdi
...
{'OP': 'REPM', 'src': {'same': False, 'congruent': 7, 'type': 'addresses_normal'}, 'dst': {'same': False, 'congruent': 0, 'type': 'addresses_P'}}
[Faulty Load]
