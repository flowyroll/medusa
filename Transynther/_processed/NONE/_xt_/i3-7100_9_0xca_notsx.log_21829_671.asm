...
push %rdi
push %rsi
lea addresses_A_ht+0x1b5bc, %rsi
lea addresses_D_ht+0x313c, %rdi
nop
nop
nop
nop
...
nop
sub $58130, %r13
lea addresses_UC_ht+0x120bb, %rsi
lea addresses_D_ht+0xebfc, %rdi
nop
nop
cmp $29079, %rbx
mov $77, %rcx
...
nop
sub %r13, %r13
lea addresses_A_ht+0x175f8, %r13
xor $47557, %r9
movb $0x61, (%r13)
nop
nop
...
nop
dec %rcx
lea addresses_normal_ht+0x91fc, %r13
nop
nop
nop
nop
...
nop
and %r9, %r9
lea addresses_D_ht+0x1b5fc, %r13
nop
cmp $62324, %r12
...
nop
add %r9, %r9
lea addresses_UC_ht+0xb5fc, %r12
cmp $24257, %r9
...
nop
and $15816, %rdi
lea addresses_UC_ht+0x4fac, %rsi
lea addresses_WT_ht+0x59fc, %rdi
nop
nop
nop
nop
...
nop
dec %rsi
lea addresses_D_ht+0x1eada, %rsi
lea addresses_normal_ht+0xd3fc, %rdi
nop
nop
nop
nop
...
nop
xor %rdi, %rdi
lea addresses_UC_ht+0x1fc, %rsi
lea addresses_A_ht+0x5fbc, %rdi
nop
nop
nop
nop
...
nop
and $41561, %rsi
lea addresses_WC_ht+0x77fc, %rsi
lea addresses_normal_ht+0x1440c, %rdi
nop
nop
sub $32430, %r13
mov $77, %rcx
...
nop
add $33889, %rsi
lea addresses_WC_ht+0xd494, %r9
nop
nop
cmp $19539, %r14
mov (%r9), %r12d
add $24584, %rsi
lea addresses_WC_ht+0x142bc, %rsi
...
nop
and $4531, %rcx
lea addresses_WT_ht+0x110fc, %rsi
clflush (%rsi)
nop
nop
nop
...
{'src': {'type': 'addresses_UC_ht', 'congruent': 3, 'same': True}, 'OP': 'REPM', 'dst': {'type': 'addresses_WT_ht', 'congruent': 9, 'same': False}}
{'src': {'type': 'addresses_D_ht', 'congruent': 0, 'same': False}, 'OP': 'REPM', 'dst': {'type': 'addresses_normal_ht', 'congruent': 9, 'same': False}}
{'src': {'type': 'addresses_UC_ht', 'congruent': 10, 'same': False}, 'OP': 'REPM', 'dst': {'type': 'addresses_A_ht', 'congruent': 3, 'same': False}}
