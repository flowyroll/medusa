...
nop
and $36000, %rbx
lea addresses_D_ht+0x4555, %rax
sub %rbx, %rbx
movb (%rax), %cl
nop
cmp %rax, %rax
lea addresses_normal_ht+0x19c55, %rsi
...
nop
cmp $60414, %rsi
lea addresses_WT_ht+0xc355, %rsi
nop
nop
nop
and $2919, %r15
...
vmovups %ymm0, (%rsi)
add %rbx, %rbx
lea addresses_D_ht+0x19d15, %rsi
lea addresses_WT_ht+0xb955, %rdi
clflush (%rsi)
nop
nop
inc %r10
...
rep movsq
inc %rax
lea addresses_WC_ht+0x1c955, %rax
nop
nop
cmp $49207, %rcx
vmovups (%rax), %ymm0
...
nop
sub $60829, %rax
lea addresses_WT_ht+0xa815, %rsi
lea addresses_normal_ht+0xab95, %rdi
nop
sub $51584, %rbx
mov $68, %rcx
rep movsl
...
nop
sub $17198, %r10
lea addresses_WC_ht+0x1d098, %rcx
xor $51687, %rbx
mov (%rcx), %edx
nop
nop
...
nop
add %r15, %r15
lea addresses_WT_ht+0x3955, %rsi
lea addresses_WT_ht+0x1c355, %rdi
clflush (%rdi)
nop
nop
nop
...
rep movsw
add %rcx, %rcx
lea addresses_WT_ht+0x3515, %r15
clflush (%r15)
nop
nop
add $45950, %rbx
...
nop
cmp $5727, %rdi
lea addresses_A_ht+0x1ed35, %rsi
lea addresses_D_ht+0x847d, %rdi
nop
nop
sub %rdx, %rdx
mov $97, %rcx
...
nop
add %rsi, %rsi
lea addresses_WC_ht+0x13c55, %rdi
nop
xor %rdx, %rdx
...
// Faulty Load
lea addresses_normal+0x4155, %r10
nop
and %r11, %r11
vmovups (%r10), %ymm3
...
{'OP': 'LOAD', 'src': {'type': 'addresses_D_ht', 'AVXalign': False, 'congruent': 10, 'size': 1, 'same': True, 'NT': False}}
...
{'OP': 'LOAD', 'src': {'type': 'addresses_WC_ht', 'AVXalign': False, 'congruent': 0, 'size': 4, 'same': True, 'NT': False}}
