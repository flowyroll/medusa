...
push %rdx
push %rsi
lea addresses_UC_ht+0x17bf3, %r12
nop
nop
nop
nop
...
nop
mfence
lea addresses_D_ht+0xcd2b, %rsi
lea addresses_A_ht+0x1c5f3, %rdi
nop
nop
nop
nop
...
nop
dec %rdi
lea addresses_D_ht+0x1e5f3, %rsi
lea addresses_UC_ht+0x181f3, %rdi
sub %r13, %r13
mov $104, %rcx
rep movsl
nop
inc %r10
lea addresses_UC_ht+0xfaa3, %rsi
lea addresses_UC_ht+0x17df3, %rdi
nop
nop
nop
nop
...
nop
add $9767, %rdi
lea addresses_WT_ht+0x187f3, %r10
nop
add %rsi, %rsi
movb $0x61, (%r10)
nop
...
nop
and $360, %r13
lea addresses_normal_ht+0x3db, %rdx
nop
nop
nop
xor %rsi, %rsi
...
nop
xor $54180, %rdx
lea addresses_WT_ht+0xa773, %rsi
lea addresses_normal_ht+0x35f3, %rdi
clflush (%rsi)
nop
nop
nop
...
nop
and $61614, %rdx
lea addresses_UC_ht+0x17df3, %rsi
lea addresses_D_ht+0x149f3, %rdi
clflush (%rsi)
nop
nop
nop
...
nop
and %rdx, %rdx
lea addresses_WT_ht+0x3a73, %r13
nop
xor $15700, %rdi
...
nop
cmp $10977, %r10
lea addresses_WT_ht+0x1e3f3, %r12
nop
nop
nop
nop
...
nop
and $31259, %rdx
lea addresses_UC_ht+0x8c33, %r13
nop
nop
nop
nop
...
{'OP': 'REPM', 'src': {'type': 'addresses_D_ht', 'congruent': 11, 'same': False}, 'dst': {'type': 'addresses_UC_ht', 'congruent': 8, 'same': True}}
...
{'OP': 'LOAD', 'src': {'type': 'addresses_A_ht', 'size': 8, 'AVXalign': False, 'NT': False, 'congruent': 1, 'same': True}}
