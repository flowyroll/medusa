...
push %rdx
push %rsi
lea addresses_WT_ht+0x4346, %r11
nop
nop
nop
cmp %rdx, %rdx
movb $0x61, (%r11)
add $13375, %rdi
lea addresses_UC_ht+0xffe7, %rsi
lea addresses_normal_ht+0x1d94f, %rdi
sub $14017, %r8
mov $77, %rcx
rep movsb
nop
...
nop
add %r8, %r8
lea addresses_WT_ht+0x1aeef, %r13
nop
nop
xor $34511, %rdx
mov (%r13), %ecx
...
nop
cmp $56489, %rcx
lea addresses_A_ht+0x504f, %rsi
lea addresses_WC_ht+0x1b00f, %rdi
sub $43098, %r12
mov $48, %rcx
rep movsl
nop
...
nop
sub %rdi, %rdi
lea addresses_normal_ht+0xc2af, %r8
nop
nop
nop
nop
...
nop
xor $45624, %r8
lea addresses_WC_ht+0x197af, %r8
dec %rcx
mov $0x6162636465666768, %r12
movq %r12, (%r8)
nop
sub %r13, %r13
lea addresses_WC_ht+0x7cef, %r8
nop
nop
and $10523, %r13
mov $0x6162636465666768, %r12
...
{'src': {'type': 'addresses_UC_ht', 'congruent': 1, 'same': False}, 'OP': 'REPM', 'dst': {'type': 'addresses_normal_ht', 'congruent': 1, 'same': False}}
