...
nop
add $2940, %r15
lea addresses_UC_ht+0x99e6, %r10
nop
nop
nop
nop
...
nop
xor %rdx, %rdx
lea addresses_A_ht+0xfef, %rsi
lea addresses_A_ht+0x14faf, %rdi
nop
nop
nop
sub %r8, %r8
...
mov (%rcx), %edx
mfence
lea addresses_WC_ht+0x85af, %r15
nop
add %rdi, %rdi
mov (%r15), %r8
inc %rcx
lea addresses_normal_ht+0x19f99, %rsi
nop
dec %r15
movl $0x61626364, (%rsi)
nop
...
nop
sub $63785, %r13
lea addresses_WC_ht+0xedaf, %rdx
nop
nop
nop
sub %rsi, %rsi
...
nop
add $58117, %r14
lea addresses_A_ht+0x1bfaf, %r14
clflush (%r14)
nop
nop
nop
...
nop
add %rdx, %rdx
lea addresses_WC_ht+0x187af, %rdx
inc %rsi
movw $0x6162, (%rdx)
nop
nop
nop
xor %rsi, %rsi
lea addresses_WT_ht+0x1990f, %r15
add %r8, %r8
...
nop
cmp %r10, %r10
lea addresses_A_ht+0x1b3a5, %r10
nop
nop
inc %rdi
movups (%r10), %xmm6
...
nop
cmp $46359, %r13
lea addresses_D_ht+0x5faf, %rsi
lea addresses_UC_ht+0x1a2af, %rdi
nop
nop
nop
cmp $16391, %r8
...
nop
cmp $41837, %r12
lea addresses_WT_ht+0x67af, %rsi
lea addresses_WT_ht+0x175ff, %rdi
clflush (%rsi)
nop
xor %r13, %r13
mov $119, %rcx
...
{'src': {'congruent': 6, 'same': True, 'type': 'addresses_A_ht'}, 'dst': {'congruent': 10, 'same': False, 'type': 'addresses_A_ht'}, 'OP': 'REPM'}
{'src': {'NT': False, 'AVXalign': False, 'size': 4, 'congruent': 7, 'same': True, 'type': 'addresses_D_ht'}, 'OP': 'LOAD'}
...
{'src': {'congruent': 11, 'same': False, 'type': 'addresses_D_ht'}, 'dst': {'congruent': 6, 'same': True, 'type': 'addresses_UC_ht'}, 'OP': 'REPM'}
{'src': {'congruent': 11, 'same': False, 'type': 'addresses_WT_ht'}, 'dst': {'congruent': 4, 'same': False, 'type': 'addresses_WT_ht'}, 'OP': 'REPM'}
{'37': 21829}
