...
push %rbx
push %rdx
lea addresses_D_ht+0x138f7, %r11
nop
nop
nop
nop
...
nop
cmp %rbp, %rbp
lea addresses_WC_ht+0x940d, %r10
nop
nop
sub %rdx, %rdx
movw $0x6162, (%r10)
...
// REPMOV
lea addresses_normal+0xc8f7, %rsi
lea addresses_WT+0xdf7e, %rdi
nop
sub %rbx, %rbx
mov $79, %rcx
rep movsl
...
{'src': {'type': 'addresses_normal', 'congruent': 9, 'same': False}, 'OP': 'REPM', 'dst': {'type': 'addresses_WT', 'congruent': 0, 'same': False}}
[Faulty Load]
