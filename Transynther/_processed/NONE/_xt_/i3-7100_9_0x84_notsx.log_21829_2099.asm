...
push %rdi
push %rsi
lea addresses_WT_ht+0xdc0f, %r11
cmp $12663, %r12
mov (%r11), %r13d
nop
nop
nop
cmp %r13, %r13
lea addresses_WC_ht+0xa50b, %rsi
lea addresses_D_ht+0x530f, %rdi
xor %r9, %r9
mov $123, %rcx
rep movsb
nop
...
nop
xor $9681, %rdi
lea addresses_UC_ht+0xfb79, %rsi
lea addresses_WC_ht+0x4aef, %rdi
nop
nop
nop
nop
