...
push %rdi
push %rsi
lea addresses_WT_ht+0x1acc8, %rbx
nop
and $6821, %rbp
...
nop
cmp $28351, %rcx
lea addresses_UC_ht+0xd704, %rsi
lea addresses_UC_ht+0xe84, %rdi
and $28563, %r14
mov $44, %rcx
rep movsq
nop
nop
and %rsi, %rsi
lea addresses_UC_ht+0x9b04, %rax
xor $44376, %r14
mov $0x6162636465666768, %rbx
movq %rbx, (%rax)
nop
xor %rcx, %rcx
lea addresses_D_ht+0x1bfc8, %rsi
nop
nop
nop
nop
...
nop
cmp %rcx, %rcx
lea addresses_normal_ht+0x14904, %rax
nop
nop
nop
nop
...
nop
add %rdi, %rdi
lea addresses_WC_ht+0xc0c4, %rsi
lea addresses_WC_ht+0x14b04, %rdi
nop
nop
nop
cmp $16091, %r8
...
rep movsb
and $8330, %rbp
lea addresses_normal_ht+0x19480, %rbp
add $11703, %rdi
movw $0x6162, (%rbp)
nop
nop
...
nop
lfence
lea addresses_WT_ht+0xf3a4, %rdi
and %rcx, %rcx
movl $0x61626364, (%rdi)
nop
nop
...
nop
inc %rsi
lea addresses_normal_ht+0x117d4, %rdi
nop
nop
nop
nop
...
nop
cmp $8278, %rsi
lea addresses_normal_ht+0x9344, %rsi
nop
nop
sub $12885, %r8
movb $0x61, (%rsi)
...
{'src': {'congruent': 8, 'same': False, 'type': 'addresses_UC_ht'}, 'OP': 'REPM', 'dst': {'congruent': 7, 'same': False, 'type': 'addresses_UC_ht'}}
...
{'src': {'congruent': 5, 'same': False, 'type': 'addresses_WC_ht'}, 'OP': 'REPM', 'dst': {'congruent': 9, 'same': False, 'type': 'addresses_WC_ht'}}
{'OP': 'STOR', 'dst': {'congruent': 1, 'AVXalign': True, 'same': True, 'size': 2, 'NT': False, 'type': 'addresses_normal_ht'}}
