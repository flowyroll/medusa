...
push %rdi
push %rsi
lea addresses_normal_ht+0x46e8, %rbx
nop
nop
nop
nop
...
nop
dec %r12
lea addresses_WT_ht+0x11aa8, %rsi
lea addresses_D_ht+0x1c28, %rdi
nop
nop
nop
nop
...
nop
and $38181, %r9
lea addresses_A_ht+0x13d28, %rsi
lea addresses_A_ht+0x1a528, %rdi
nop
sub $37697, %r10
mov $120, %rcx
rep movsl
...
nop
cmp %rdi, %rdi
lea addresses_WC_ht+0x1b990, %rsi
lea addresses_A_ht+0x17a8, %rdi
nop
nop
nop
nop
...
nop
xor $28685, %r13
lea addresses_WC_ht+0x1e688, %r9
nop
nop
nop
nop
...
nop
cmp $34406, %rsi
lea addresses_UC_ht+0x164e8, %r13
nop
nop
nop
nop
...
movb (%r13), %bl
and %r10, %r10
lea addresses_A_ht+0x82f2, %rsi
nop
xor %r12, %r12
movl $0x61626364, (%rsi)
nop
cmp %rsi, %rsi
lea addresses_D_ht+0x8328, %rcx
nop
nop
and %r10, %r10
vmovups (%rcx), %ymm4
...
vpextrq $1, %xmm4, %rbx
and %r10, %r10
lea addresses_normal_ht+0x8ef0, %rsi
nop
and %r13, %r13
...
vpextrq $1, %xmm3, %rbx
and $59168, %rdi
lea addresses_UC_ht+0x1aca8, %rbx
nop
nop
nop
nop
...
// Faulty Load
lea addresses_normal+0xcd28, %r9
nop
nop
nop
nop
...
{'src': {'type': 'addresses_D_ht', 'AVXalign': True, 'size': 2, 'NT': False, 'same': False, 'congruent': 1}, 'OP': 'LOAD'}
{'34': 21829}
