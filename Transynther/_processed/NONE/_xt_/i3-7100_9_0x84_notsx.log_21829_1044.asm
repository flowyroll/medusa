...
nop
and %r10, %r10
lea addresses_UC_ht+0x40f4, %rsi
xor $41171, %r11
mov (%rsi), %cx
nop
nop
nop
cmp $39300, %r8
lea addresses_A_ht+0x16a94, %r11
nop
nop
nop
cmp %r8, %r8
...
nop
cmp %r13, %r13
lea addresses_WC_ht+0x1c1f4, %rsi
lea addresses_WT_ht+0x8530, %rdi
nop
nop
cmp %r9, %r9
mov $52, %rcx
...
nop
xor $54966, %r9
lea addresses_UC_ht+0x88bc, %rsi
lea addresses_WT_ht+0x1e0cc, %rdi
nop
nop
nop
nop
...
{'src': {'type': 'addresses_UC_ht', 'congruent': 3, 'same': False}, 'dst': {'type': 'addresses_WT_ht', 'congruent': 2, 'same': False}, 'OP': 'REPM'}
