...
push %rdi
push %rsi
lea addresses_normal_ht+0x1846c, %rsi
lea addresses_A_ht+0xac41, %rdi
nop
nop
nop
nop
...
nop
cmp $2973, %rsi
lea addresses_normal_ht+0x13cc1, %rdi
cmp %r14, %r14
movw $0x6162, (%rdi)
nop
nop
...
nop
xor $19022, %r14
lea addresses_UC_ht+0x17718, %rsi
lea addresses_UC_ht+0x1b061, %rdi
nop
nop
inc %rbx
mov $48, %rcx
...
nop
xor $65486, %rdi
lea addresses_normal_ht+0x9741, %rcx
clflush (%rcx)
nop
nop
xor %rax, %rax
...
<gen_prepare_buffer>
{'OP': 'REPM', 'src': {'type': 'addresses_normal_ht', 'congruent': 0, 'same': False}, 'dst': {'type': 'addresses_A_ht', 'congruent': 10, 'same': True}}
