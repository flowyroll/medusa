...
push %rdi
push %rsi
lea addresses_D_ht+0x165, %rsi
lea addresses_WC_ht+0x1b665, %rdi
nop
nop
nop
nop
...
nop
xor $8610, %r15
lea addresses_WC_ht+0x184a3, %rsi
lea addresses_normal_ht+0x17be5, %rdi
clflush (%rdi)
nop
nop
nop
