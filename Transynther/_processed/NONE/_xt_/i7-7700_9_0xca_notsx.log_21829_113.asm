...
nop
add $15603, %rcx
lea addresses_WC_ht+0x1784f, %rsi
lea addresses_D_ht+0x14df8, %rdi
nop
nop
nop
nop
...
nop
dec %rax
lea addresses_normal_ht+0x838f, %r14
nop
and %rdi, %rdi
mov (%r14), %eax
nop
...
nop
xor %rdx, %rdx
lea addresses_WT_ht+0x1364f, %rcx
nop
nop
sub $281, %rdx
mov (%rcx), %r10w
...
// Faulty Load
lea addresses_normal+0xee4f, %r15
nop
nop
nop
nop
...
<gen_prepare_buffer>
{'dst': {'NT': False, 'AVXalign': True, 'size': 1, 'congruent': 2, 'same': False, 'type': 'addresses_D_ht'}, 'OP': 'STOR'}
{'src': {'congruent': 8, 'same': True, 'type': 'addresses_WC_ht'}, 'dst': {'congruent': 0, 'same': False, 'type': 'addresses_D_ht'}, 'OP': 'REPM'}
