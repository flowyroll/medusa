...
push %rdi
push %rsi
lea addresses_UC_ht+0x11c3, %rdi
nop
nop
nop
and $11355, %r12
...
nop
sub $60496, %rbx
lea addresses_D_ht+0x3c23, %r8
nop
and $34472, %r15
mov (%r8), %r14d
add $247, %rdi
lea addresses_normal_ht+0x176e3, %rsi
lea addresses_normal_ht+0x10c23, %rdi
clflush (%rsi)
nop
sub $36716, %rbp
mov $9, %rcx
rep movsl
and $61378, %rbx
lea addresses_WC_ht+0x10623, %rbp
nop
nop
nop
nop
...
nop
add %rbp, %rbp
lea addresses_WT_ht+0x6623, %rcx
nop
nop
nop
nop
...
nop
cmp %r8, %r8
lea addresses_A_ht+0x187e3, %r14
nop
nop
nop
nop
...
nop
inc %rbp
lea addresses_WC_ht+0xe8a3, %rbx
nop
nop
nop
nop
...
nop
sub $37934, %rbx
lea addresses_WC_ht+0x1b023, %r8
inc %rbp
movb (%r8), %r14b
nop
nop
inc %rdi
lea addresses_A_ht+0xcb1b, %rsi
lea addresses_UC_ht+0xca23, %rdi
nop
nop
sub $9753, %r12
mov $84, %rcx
...
nop
inc %rsi
lea addresses_WC_ht+0x11823, %rsi
lea addresses_WT_ht+0x1ae23, %rdi
nop
sub %rbx, %rbx
mov $118, %rcx
rep movsq
...
nop
dec %r8
lea addresses_D_ht+0x1ea3, %rbx
nop
nop
add %r14, %r14
movb $0x61, (%rbx)
xor $41599, %rbx
lea addresses_UC_ht+0x1cd84, %rsi
lea addresses_D_ht+0x139e3, %rdi
nop
nop
nop
nop
...
nop
xor %rbx, %rbx
lea addresses_normal_ht+0x108bd, %rsi
lea addresses_WC_ht+0x5023, %rdi
nop
nop
nop
add $32963, %rbp
...
{'OP': 'REPM', 'src': {'type': 'addresses_normal_ht', 'congruent': 5, 'same': False}, 'dst': {'type': 'addresses_normal_ht', 'congruent': 11, 'same': False}}
