...
push %rdi
push %rsi
lea addresses_WT_ht+0x149be, %rsi
lea addresses_A_ht+0x1ab3e, %rdi
nop
nop
nop
add $15599, %rbx
...
nop
and %rbx, %rbx
lea addresses_WC_ht+0x25be, %rcx
nop
sub %rbp, %rbp
mov (%rcx), %r10w
nop
...
nop
sub $57382, %rcx
lea addresses_WT_ht+0x1a33e, %rcx
nop
nop
nop
nop
...
nop
cmp %r15, %r15
lea addresses_A_ht+0x9b3e, %rsi
lea addresses_WC_ht+0x533e, %rdi
cmp $12042, %rbx
mov $98, %rcx
rep movsw
nop
...
// REPMOV
lea addresses_D+0xde5e, %rsi
lea addresses_D+0x1058a, %rdi
nop
nop
nop
dec %r12
...
{'src': {'type': 'addresses_D', 'congruent': 5, 'same': False}, 'dst': {'type': 'addresses_D', 'congruent': 0, 'same': False}, 'OP': 'REPM'}
[Faulty Load]
...
{'src': {'type': 'addresses_A_ht', 'congruent': 11, 'same': False}, 'dst': {'type': 'addresses_WC_ht', 'congruent': 10, 'same': True}, 'OP': 'REPM'}
