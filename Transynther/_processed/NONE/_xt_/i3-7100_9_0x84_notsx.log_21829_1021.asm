...
movups %xmm7, (%rsi)
inc %r8
lea addresses_normal_ht+0xbaf7, %rcx
nop
nop
nop
nop
...
nop
add %r8, %r8
lea addresses_A_ht+0x11757, %rsi
nop
nop
nop
nop
...
nop
xor %r8, %r8
lea addresses_WT_ht+0x13577, %rsi
nop
and %rdx, %rdx
movw $0x6162, (%rsi)
nop
nop
xor %r8, %r8
lea addresses_normal_ht+0xd57, %rcx
and $38919, %r8
mov (%rcx), %bp
nop
nop
...
nop
and $5242, %rdx
lea addresses_UC_ht+0x1089d, %rcx
clflush (%rcx)
and $19794, %r8
movups (%rcx), %xmm5
vpextrq $1, %xmm5, %rsi
...
nop
add %rbp, %rbp
lea addresses_WT_ht+0xa5cf, %rcx
nop
nop
nop
sub %r8, %r8
...
vpextrq $1, %xmm0, %rdx
xor $27820, %rdx
lea addresses_normal_ht+0x6dcb, %r14
nop
nop
nop
xor %rbx, %rbx
