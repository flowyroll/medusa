...
push %rdi
push %rsi
lea addresses_WT_ht+0x3382, %r11
nop
nop
mfence
mov (%r11), %r14d
sub %rdi, %rdi
lea addresses_WT_ht+0x15b4a, %r10
nop
nop
nop
add %r15, %r15
...
nop
and $65041, %r10
lea addresses_A_ht+0x1ab82, %r10
nop
nop
xor %r8, %r8
...
nop
add $41131, %r10
lea addresses_normal_ht+0x18402, %r12
nop
nop
nop
nop
...
mov (%r12), %r10d
mfence
lea addresses_UC_ht+0x2782, %rsi
...
nop
xor %r10, %r10
lea addresses_D_ht+0x1b82, %rsi
lea addresses_WT_ht+0x6382, %rdi
clflush (%rdi)
add %r11, %r11
mov $57, %rcx
rep movsw
...
nop
xor %rsi, %rsi
lea addresses_UC_ht+0x7342, %r10
nop
nop
nop
nop
...
nop
xor $60547, %r8
lea addresses_WT_ht+0x14fc2, %r12
nop
nop
nop
and $26243, %rcx
...
{'OP': 'STOR', 'dst': {'same': False, 'congruent': 8, 'NT': False, 'type': 'addresses_A_ht', 'size': 16, 'AVXalign': True}}
...
{'src': {'type': 'addresses_D_ht', 'congruent': 9, 'same': False}, 'OP': 'REPM', 'dst': {'type': 'addresses_WT_ht', 'congruent': 9, 'same': False}}
