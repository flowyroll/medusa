...
push %rdx
push %rsi
lea addresses_UC_ht+0x18773, %rsi
lea addresses_D_ht+0x1c653, %rdi
clflush (%rdi)
nop
nop
nop
...
nop
sub %r12, %r12
lea addresses_WC_ht+0x1d473, %rsi
cmp %r13, %r13
...
nop
and $19990, %rbp
lea addresses_WC_ht+0x62b7, %rsi
lea addresses_WT_ht+0x53, %rdi
clflush (%rsi)
nop
nop
nop
...
nop
cmp %rdi, %rdi
lea addresses_normal_ht+0x17673, %rsi
lea addresses_WT_ht+0x15ff3, %rdi
clflush (%rsi)
nop
nop
nop
...
nop
sub %rbx, %rbx
lea addresses_UC_ht+0x19873, %rsi
lea addresses_UC_ht+0xccf3, %rdi
nop
nop
nop
sub $35313, %rbp
...
nop
cmp %rdx, %rdx
lea addresses_D_ht+0x18673, %rsi
lea addresses_UC_ht+0xa73, %rdi
nop
nop
cmp $18667, %rbp
mov $33, %rcx
...
nop
and $685, %rdi
lea addresses_WT_ht+0xe66e, %rdi
nop
nop
nop
nop
...
nop
inc %rbp
lea addresses_UC_ht+0x12d83, %rdi
nop
nop
nop
add $62516, %rdx
...
nop
cmp %r13, %r13
lea addresses_normal_ht+0xb473, %rsi
lea addresses_WC_ht+0x40b3, %rdi
nop
nop
nop
nop
...
rep movsl
and $92, %rsi
lea addresses_WC_ht+0x19463, %r13
nop
nop
xor $63697, %rdi
movb (%r13), %cl
...
nop
sub %rdi, %rdi
lea addresses_UC_ht+0x1d873, %rsi
and $44835, %rdi
movb (%rsi), %bl
nop
cmp $39807, %rbx
...
// Store
lea addresses_normal+0x11338, %rcx
nop
nop
nop
nop
...
{'OP': 'STOR', 'dst': {'type': 'addresses_WT_ht', 'AVXalign': False, 'congruent': 0, 'size': 16, 'same': False, 'NT': True}}
{'OP': 'STOR', 'dst': {'type': 'addresses_UC_ht', 'AVXalign': False, 'congruent': 2, 'size': 16, 'same': False, 'NT': False}}
{'OP': 'REPM', 'src': {'type': 'addresses_normal_ht', 'congruent': 10, 'same': False}, 'dst': {'type': 'addresses_WC_ht', 'congruent': 0, 'same': False}}
{'OP': 'LOAD', 'src': {'type': 'addresses_WC_ht', 'AVXalign': False, 'congruent': 1, 'size': 1, 'same': False, 'NT': True}}
