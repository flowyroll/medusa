...
push %rdi
push %rsi
lea addresses_WC_ht+0xfc8b, %rcx
nop
nop
nop
and $1596, %rbp
...
nop
and $51012, %r12
lea addresses_UC_ht+0x27df, %r12
nop
nop
nop
nop
...
nop
xor $56075, %r8
lea addresses_D_ht+0x706b, %rsi
lea addresses_UC_ht+0xf2ab, %rdi
nop
nop
nop
nop
...
nop
xor %rbx, %rbx
lea addresses_UC_ht+0x1beab, %rsi
lea addresses_D_ht+0x15cfb, %rdi
nop
cmp $25367, %rbp
mov $105, %rcx
rep movsb
and %r12, %r12
lea addresses_WC_ht+0x1395, %rbp
nop
nop
nop
nop
...
nop
xor %rbx, %rbx
lea addresses_WT_ht+0x1ec2b, %rsi
nop
nop
nop
nop
...
mov (%rsi), %ebx
add %rdi, %rdi
lea addresses_A_ht+0xcc13, %rsi
lea addresses_WC_ht+0x1774b, %rdi
nop
nop
nop
nop
...
nop
and %r14, %r14
lea addresses_WT_ht+0xd99b, %rbp
nop
nop
nop
nop
...
// Load
lea addresses_normal+0xb92b, %r8
cmp %rdx, %rdx
mov (%r8), %r15w
nop
nop
...
{'OP': 'STOR', 'dst': {'type': 'addresses_US', 'AVXalign': True, 'congruent': 7, 'size': 32, 'same': False, 'NT': False}}
[Faulty Load]
...
{'OP': 'LOAD', 'src': {'type': 'addresses_UC_ht', 'AVXalign': True, 'congruent': 2, 'size': 2, 'same': False, 'NT': False}}
{'OP': 'STOR', 'dst': {'type': 'addresses_WC_ht', 'AVXalign': False, 'congruent': 8, 'size': 2, 'same': False, 'NT': False}}
{'OP': 'STOR', 'dst': {'type': 'addresses_D_ht', 'AVXalign': True, 'congruent': 5, 'size': 32, 'same': False, 'NT': False}}
