...
nop
add %r10, %r10
lea addresses_UC_ht+0xeeb7, %rsi
lea addresses_D_ht+0x1abf8, %rdi
nop
nop
nop
nop
...
nop
and %rdi, %rdi
lea addresses_D_ht+0x102e7, %r15
nop
nop
nop
nop
...
nop
add %r15, %r15
lea addresses_normal_ht+0x18767, %rdx
nop
nop
nop
nop
...
nop
dec %r15
lea addresses_WT_ht+0x16ae7, %r8
xor %r10, %r10
...
// Faulty Load
lea addresses_normal+0x14ae7, %r8
nop
nop
nop
cmp $59415, %rsi
...
{'OP': 'STOR', 'dst': {'type': 'addresses_RW', 'AVXalign': False, 'size': 2, 'NT': False, 'same': False, 'congruent': 3}}
[Faulty Load]
