...
push %rdi
push %rsi
lea addresses_WT_ht+0x14315, %rax
nop
nop
nop
and $27499, %rdi
...
nop
inc %rax
lea addresses_WT_ht+0x1ead5, %rax
add $57504, %r11
mov (%rax), %ebx
nop
add $19181, %rax
lea addresses_D_ht+0xd6d5, %r12
nop
nop
nop
add $1807, %rdi
...
nop
inc %r11
lea addresses_UC_ht+0x12fd5, %rsi
lea addresses_UC_ht+0x1c1d5, %rdi
nop
nop
nop
nop
...
nop
xor %r15, %r15
lea addresses_normal_ht+0x1873d, %rsi
lea addresses_D_ht+0x10d55, %rdi
sub $14018, %rax
mov $62, %rcx
rep movsq
nop
...
nop
add $4539, %rsi
lea addresses_UC_ht+0x59d5, %r12
nop
inc %rbx
...
nop
sub $22547, %rbx
lea addresses_UC_ht+0x1bf1b, %rcx
nop
and $2642, %r15
movw $0x6162, (%rcx)
nop
...
// REPMOV
lea addresses_UC+0x9ad5, %rsi
lea addresses_UC+0xb9d5, %rdi
nop
nop
nop
nop
...
{'dst': {'same': False, 'congruent': 11, 'type': 'addresses_UC'}, 'OP': 'REPM', 'src': {'same': False, 'congruent': 7, 'type': 'addresses_UC'}}
...
{'dst': {'same': False, 'congruent': 11, 'type': 'addresses_UC_ht'}, 'OP': 'REPM', 'src': {'same': False, 'congruent': 9, 'type': 'addresses_UC_ht'}}
{'dst': {'same': False, 'congruent': 7, 'type': 'addresses_D_ht'}, 'OP': 'REPM', 'src': {'same': False, 'congruent': 0, 'type': 'addresses_normal_ht'}}
