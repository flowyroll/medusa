...
push %rdi
push %rsi
lea addresses_WT_ht+0x912d, %rax
nop
add %r11, %r11
movw $0x6162, (%rax)
nop
...
nop
xor $31876, %r13
lea addresses_WC_ht+0x6f2d, %r14
nop
add %rcx, %rcx
mov (%r14), %ax
add $50321, %r11
lea addresses_WT_ht+0xc32d, %rsi
lea addresses_WC_ht+0x191ad, %rdi
nop
nop
nop
nop
...
nop
cmp %rdi, %rdi
lea addresses_WT_ht+0xedfd, %rax
nop
nop
nop
xor $41227, %r13
...
nop
dec %rsi
lea addresses_UC_ht+0x18e2d, %rsi
lea addresses_A_ht+0x16b6d, %rdi
nop
xor $32413, %r11
mov $108, %rcx
rep movsw
...
nop
and $12051, %r14
lea addresses_WC_ht+0x1252d, %r14
nop
nop
nop
nop
...
nop
sub %rsi, %rsi
lea addresses_WC_ht+0x332d, %rcx
nop
nop
add %r11, %r11
vmovups (%rcx), %ymm3
...
vpextrq $0, %xmm3, %rax
and %rax, %rax
lea addresses_WT_ht+0x552d, %rsi
lea addresses_WT_ht+0x1172d, %rdi
add $45668, %r12
mov $89, %rcx
rep movsw
nop
...
{'OP': 'REPM', 'src': {'same': True, 'congruent': 9, 'type': 'addresses_WT_ht'}, 'dst': {'same': True, 'congruent': 6, 'type': 'addresses_WC_ht'}}
{'OP': 'LOAD', 'src': {'same': False, 'type': 'addresses_WT_ht', 'NT': False, 'AVXalign': False, 'size': 32, 'congruent': 4}}
{'OP': 'REPM', 'src': {'same': False, 'congruent': 8, 'type': 'addresses_UC_ht'}, 'dst': {'same': False, 'congruent': 4, 'type': 'addresses_A_ht'}}
