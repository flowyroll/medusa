...
push %rdx
push %rsi
lea addresses_WC_ht+0x171d5, %r9
nop
nop
nop
sub $4912, %r15
...
movups %xmm4, (%r9)
add %rbp, %rbp
lea addresses_WT_ht+0x9255, %rdx
dec %r15
movl $0x61626364, (%rdx)
nop
nop
...
// Load
lea addresses_normal+0x13255, %r8
nop
nop
nop
nop
...
// Faulty Load
lea addresses_normal+0x13255, %rsi
nop
nop
nop
add $30249, %r9
...
{'OP': 'STOR', 'dst': {'type': 'addresses_D', 'size': 32, 'AVXalign': True, 'NT': False, 'congruent': 9, 'same': False}}
