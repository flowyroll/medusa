...
push %rdx
push %rsi
lea addresses_normal_ht+0x18367, %r10
nop
nop
nop
add $30574, %rcx
...
nop
add %r13, %r13
lea addresses_WC_ht+0x1bcbe, %rdi
dec %rsi
movl $0x61626364, (%rdi)
nop
nop
...
nop
inc %rdx
lea addresses_normal_ht+0x1524f, %rsi
clflush (%rsi)
nop
nop
nop
...
nop
add %rdx, %rdx
lea addresses_A_ht+0xa87, %r14
clflush (%r14)
nop
add %r13, %r13
mov (%r14), %si
cmp %r13, %r13
lea addresses_WT_ht+0x1ee47, %rcx
nop
inc %r10
...
nop
dec %rcx
lea addresses_WC_ht+0x2177, %rsi
lea addresses_D_ht+0x10f67, %rdi
nop
nop
nop
nop
...
nop
and $20538, %rsi
lea addresses_WC_ht+0x15747, %rsi
lea addresses_WT_ht+0x6667, %rdi
nop
nop
nop
nop
...
nop
sub %rdx, %rdx
lea addresses_normal_ht+0xc98b, %rsi
nop
nop
nop
nop
...
lea addresses_normal_ht+0x4667, %rdi
nop
nop
sub %rdx, %rdx
mov $100, %rcx
...
<gen_prepare_buffer>
{'dst': {'type': 'addresses_normal_ht', 'same': False, 'size': 4, 'congruent': 10, 'NT': False, 'AVXalign': True}, 'OP': 'STOR'}
...
{'src': {'type': 'addresses_WC_ht', 'congruent': 4, 'same': False}, 'dst': {'type': 'addresses_WT_ht', 'congruent': 8, 'same': False}, 'OP': 'REPM'}
