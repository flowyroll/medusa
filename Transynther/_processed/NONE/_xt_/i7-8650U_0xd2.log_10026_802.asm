...
push %rdx
push %rsi
lea addresses_WC_ht+0xb434, %r11
nop
nop
nop
cmp $15252, %r10
...
nop
cmp $36885, %rsi
lea addresses_normal_ht+0x4954, %rsi
cmp $62412, %r13
...
nop
sub %r13, %r13
lea addresses_WC_ht+0x8634, %rdx
nop
nop
xor $63453, %rbp
movw $0x6162, (%rdx)
...
nop
cmp $28722, %rdi
lea addresses_WC_ht+0x6e34, %rdx
nop
nop
nop
nop
...
movw $0x6162, (%rdx)
cmp %rsi, %rsi
lea addresses_WT_ht+0x4b7e, %r10
nop
nop
nop
nop
...
nop
sub %rbp, %rbp
lea addresses_A_ht+0x1a1bc, %rsi
lea addresses_WC_ht+0x9424, %rdi
cmp $39538, %r11
mov $46, %rcx
rep movsw
nop
...
nop
sub %r13, %r13
lea addresses_D_ht+0x10834, %r11
nop
sub $62169, %rdi
vmovups (%r11), %ymm2
...
mov (%r11), %rbp
xor $56059, %rdi
lea addresses_normal_ht+0xb834, %r13
nop
nop
nop
nop
...
nop
cmp %rdx, %rdx
lea addresses_normal_ht+0x1b434, %r11
nop
nop
nop
cmp %rbp, %rbp
...
nop
add %rsi, %rsi
lea addresses_WT_ht+0x1d5b4, %rdi
nop
nop
nop
nop
...
nop
add $26532, %r13
lea addresses_WC_ht+0x1ec34, %rdx
nop
sub %rsi, %rsi
mov (%rdx), %r11d
nop
...
nop
sub %r13, %r13
lea addresses_WT_ht+0x11db4, %rbp
nop
nop
nop
xor %r11, %r11
...
// Faulty Load
lea addresses_normal+0x1c834, %rbp
nop
nop
xor $8124, %r10
mov (%rbp), %r11w
