...
rep movsl
inc %rdi
lea addresses_WT_ht+0x18ecb, %rsi
lea addresses_normal_ht+0x194b, %rdi
nop
nop
nop
add %r15, %r15
...
nop
cmp %rdi, %rdi
lea addresses_WT_ht+0x1154b, %r15
nop
nop
nop
nop
...
nop
inc %rdx
lea addresses_normal_ht+0x1b24b, %rsi
nop
nop
nop
nop
...
nop
add %rbp, %rbp
lea addresses_WC_ht+0x6d6c, %rdi
nop
nop
xor %rdx, %rdx
...
nop
and %rdi, %rdi
lea addresses_normal_ht+0x6abf, %r15
nop
nop
nop
nop
...
movl $0x61626364, (%r15)
dec %r10
lea addresses_WT_ht+0x189f3, %r10
nop
nop
add $59310, %rdx
movb (%r10), %cl
...
nop
and $49050, %r10
lea addresses_WC_ht+0x1580b, %rsi
clflush (%rsi)
nop
nop
nop
...
nop
inc %rdi
lea addresses_UC_ht+0xe54b, %rsi
lea addresses_D_ht+0x1548b, %rdi
nop
nop
nop
nop
...
nop
inc %rdi
lea addresses_WT_ht+0x153cb, %rbp
nop
nop
nop
nop
...
nop
and %rsi, %rsi
lea addresses_normal_ht+0x1b14b, %rax
dec %rcx
...
nop
cmp %rdx, %rdx
lea addresses_D_ht+0x1a09b, %rsi
...
{'src': {'type': 'addresses_WT_ht', 'congruent': 6, 'same': True}, 'dst': {'type': 'addresses_normal_ht', 'congruent': 10, 'same': True}, 'OP': 'REPM'}
...
{'src': {'type': 'addresses_WT_ht', 'same': False, 'size': 1, 'congruent': 3, 'NT': True, 'AVXalign': False}, 'OP': 'LOAD'}
