...
push %rdx
push %rsi
lea addresses_UC_ht+0xdffc, %r10
nop
nop
nop
cmp %rdx, %rdx
...
nop
sub %rbx, %rbx
lea addresses_D_ht+0x12794, %r14
nop
nop
nop
nop
...
nop
sub %rbx, %rbx
lea addresses_WC_ht+0x1d9fc, %rsi
lea addresses_A_ht+0x149fc, %rdi
nop
nop
cmp $26220, %r10
mov $11, %rcx
rep movsq
add %r10, %r10
lea addresses_WC_ht+0x3bb4, %r14
nop
nop
nop
xor %rcx, %rcx
...
nop
and %rbx, %rbx
lea addresses_WT_ht+0xd07c, %rsi
clflush (%rsi)
nop
xor $8982, %rdi
mov $0x6162636465666768, %r12
...
nop
sub $1567, %rbp
lea addresses_UC_ht+0xd1fc, %rbp
nop
nop
nop
cmp $21602, %rbx
...
nop
sub %rcx, %rcx
lea addresses_WC_ht+0x1866b, %rdx
clflush (%rdx)
cmp %rbp, %rbp
movb (%rdx), %r14b
nop
and $28312, %r12
lea addresses_WT_ht+0x15dfc, %r12
nop
dec %rsi
movb (%r12), %cl
nop
dec %rbx
lea addresses_WT_ht+0xe1fc, %rsi
lea addresses_normal_ht+0xc5d8, %rdi
nop
nop
nop
nop
...
nop
and $9901, %r10
lea addresses_WC_ht+0x1651c, %rsi
lea addresses_D_ht+0x1db1c, %rdi
nop
nop
add $1374, %rbx
mov $12, %rcx
...
nop
sub $29798, %r14
lea addresses_D_ht+0x14a34, %rsi
lea addresses_WC_ht+0x17fc, %rdi
nop
nop
sub %rdx, %rdx
mov $10, %rcx
rep movsb
add $19526, %r14
lea addresses_WT_ht+0x1a2fc, %rdx
nop
nop
add %r10, %r10
...
nop
and $22249, %rbx
lea addresses_WC_ht+0x21fc, %rsi
lea addresses_WT_ht+0x4c88, %rdi
nop
nop
add $50652, %rbx
mov $96, %rcx
...
nop
and %rsi, %rsi
lea addresses_normal_ht+0x9061, %rsi
...
// Faulty Load
lea addresses_normal+0x169fc, %rsi
nop
nop
nop
nop
...
<gen_prepare_buffer>
{'OP': 'STOR', 'dst': {'type': 'addresses_UC_ht', 'size': 32, 'AVXalign': True, 'NT': True, 'congruent': 7, 'same': False}}
...
{'OP': 'REPM', 'src': {'type': 'addresses_D_ht', 'congruent': 2, 'same': False}, 'dst': {'type': 'addresses_WC_ht', 'congruent': 8, 'same': False}}
{'OP': 'STOR', 'dst': {'type': 'addresses_WT_ht', 'size': 32, 'AVXalign': True, 'NT': True, 'congruent': 6, 'same': False}}
