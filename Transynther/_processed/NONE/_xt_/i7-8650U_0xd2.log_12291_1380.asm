...
push %rdi
push %rsi
lea addresses_UC_ht+0x1ceb3, %rsi
lea addresses_normal_ht+0x18fe0, %rdi
nop
nop
nop
nop
...
nop
add %r15, %r15
lea addresses_UC_ht+0xa5f0, %rbp
nop
sub $33036, %r11
...
nop
xor $63371, %rbp
lea addresses_A_ht+0x192d0, %r11
nop
xor %rcx, %rcx
movw $0x6162, (%r11)
nop
nop
add $1943, %rcx
lea addresses_WT_ht+0x8533, %rsi
dec %rcx
mov (%rsi), %bp
nop
nop
...
nop
sub $950, %r8
lea addresses_WC_ht+0x1b5d0, %r15
nop
add $55291, %r11
movb (%r15), %cl
nop
nop
add $9411, %r8
lea addresses_WC_ht+0x5230, %rsi
lea addresses_A_ht+0x11dd0, %rdi
nop
nop
nop
nop
...
nop
xor $11840, %r8
lea addresses_WC_ht+0xcc50, %rsi
nop
nop
nop
sub $60864, %r15
...
nop
sub %r8, %r8
lea addresses_A_ht+0x18eb0, %rbp
nop
nop
nop
nop
...
nop
xor $16881, %r15
lea addresses_WT_ht+0x13600, %r8
nop
nop
nop
dec %r14
...
// Store
lea addresses_normal+0x1e090, %rcx
nop
inc %rdx
...
// Faulty Load
lea addresses_normal+0x11dd0, %r9
nop
nop
nop
xor %r14, %r14
...
{'OP': 'STOR', 'dst': {'type': 'addresses_WT', 'size': 16, 'AVXalign': True, 'NT': False, 'congruent': 8, 'same': False}}
[Faulty Load]
...
{'OP': 'STOR', 'dst': {'type': 'addresses_D_ht', 'size': 1, 'AVXalign': False, 'NT': True, 'congruent': 7, 'same': False}}
...
{'OP': 'LOAD', 'src': {'type': 'addresses_WC_ht', 'size': 1, 'AVXalign': True, 'NT': False, 'congruent': 11, 'same': False}}
