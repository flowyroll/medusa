...
push %rdx
push %rsi
lea addresses_normal_ht+0x2689, %rdx
nop
nop
nop
nop
...
nop
add %rsi, %rsi
lea addresses_WT_ht+0x19709, %rsi
lea addresses_UC_ht+0xe689, %rdi
nop
and $6141, %rdx
mov $27, %rcx
rep movsl
nop
and $20304, %rdi
lea addresses_normal_ht+0x18d89, %r8
cmp %r11, %r11
...
nop
and %rcx, %rcx
lea addresses_WT_ht+0x125c6, %rdi
nop
nop
cmp %rsi, %rsi
movb (%rdi), %dl
...
nop
inc %r11
lea addresses_UC_ht+0x1086a, %rsi
lea addresses_WC_ht+0xce09, %rdi
nop
nop
nop
xor %r8, %r8
...
nop
add %r8, %r8
lea addresses_WC_ht+0x1b509, %rsi
lea addresses_A_ht+0x16189, %rdi
nop
nop
sub %r8, %r8
mov $13, %rcx
...
nop
cmp %rdx, %rdx
lea addresses_UC_ht+0x756d, %r14
sub %rsi, %rsi
...
nop
dec %r11
lea addresses_normal_ht+0x6989, %rsi
lea addresses_A_ht+0xc189, %rdi
clflush (%rdi)
nop
sub %rax, %rax
mov $69, %rcx
rep movsq
and $17698, %rsi
lea addresses_normal_ht+0x6089, %rsi
xor %rax, %rax
mov $0x6162636465666768, %rcx
movq %rcx, (%rsi)
nop
...
nop
xor $14380, %rdi
lea addresses_UC_ht+0x4809, %rdx
nop
inc %r14
movl $0x61626364, (%rdx)
nop
sub $61188, %r14
lea addresses_WT_ht+0x4115, %rsi
lea addresses_WC_ht+0x11f89, %rdi
clflush (%rdi)
nop
nop
nop
...
nop
cmp $41096, %rcx
lea addresses_D_ht+0x15759, %rdx
nop
nop
lfence
movb (%rdx), %cl
...
// REPMOV
lea addresses_RW+0x4189, %rsi
lea addresses_normal+0x19ae9, %rdi
nop
nop
nop
nop
...
{'src': {'type': 'addresses_RW', 'congruent': 0, 'same': True}, 'dst': {'type': 'addresses_normal', 'congruent': 4, 'same': False}, 'OP': 'REPM'}
...
{'src': {'type': 'addresses_WT_ht', 'same': True, 'size': 1, 'congruent': 0, 'NT': False, 'AVXalign': True}, 'OP': 'LOAD'}
