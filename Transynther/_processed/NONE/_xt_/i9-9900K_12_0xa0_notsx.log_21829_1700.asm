...
nop
and %rax, %rax
lea addresses_D_ht+0xe947, %rsi
lea addresses_WT_ht+0x5e47, %rdi
nop
xor $33796, %r14
mov $82, %rcx
rep movsw
...
nop
cmp $14185, %rbx
lea addresses_UC_ht+0xf26a, %r14
nop
nop
nop
nop
...
nop
sub %r14, %r14
lea addresses_WT_ht+0x4eef, %rdx
nop
nop
xor %r14, %r14
mov (%rdx), %r10w
nop
cmp $53394, %rsi
lea addresses_D_ht+0x1de47, %rdx
nop
nop
nop
nop
...
nop
add $2916, %rbx
lea addresses_UC_ht+0x8a27, %rcx
nop
nop
nop
nop
...
nop
sub $62812, %rdx
lea addresses_UC_ht+0x147eb, %r10
nop
inc %rbx
...
vmovups %ymm7, (%r10)
add %r14, %r14
lea addresses_WC_ht+0x3947, %rdx
sub %rdi, %rdi
...
{'src': {'type': 'addresses_D_ht', 'congruent': 7, 'same': True}, 'OP': 'REPM', 'dst': {'type': 'addresses_WT_ht', 'congruent': 10, 'same': False}}
...
{'src': {'type': 'addresses_WC_ht', 'AVXalign': True, 'size': 32, 'NT': True, 'same': False, 'congruent': 8}, 'OP': 'LOAD'}
{'38': 21829}
