...
nop
dec %rcx
lea addresses_normal_ht+0x1241e, %rdx
nop
nop
sub $18730, %rbp
...
nop
add %rcx, %rcx
lea addresses_A_ht+0x127de, %rbx
nop
nop
nop
nop
...
nop
and %r10, %r10
lea addresses_WC_ht+0x9b1e, %rbx
nop
sub %rdx, %rdx
mov (%rbx), %r10w
nop
nop
and $13476, %rcx
lea addresses_WT_ht+0x1571e, %r10
and $5099, %rdx
mov $0x6162636465666768, %r12
movq %r12, %xmm0
movups %xmm0, (%r10)
...
nop
xor $14718, %r10
lea addresses_UC_ht+0x1a1d6, %rdx
nop
nop
add $42880, %rbx
mov (%rdx), %r11d
...
nop
add %rcx, %rcx
lea addresses_WT_ht+0x5b1e, %rsi
lea addresses_WT_ht+0x538e, %rdi
nop
nop
nop
inc %rbx
...
nop
and $61198, %r11
lea addresses_UC_ht+0xa562, %r11
nop
nop
nop
nop
...
nop
lfence
lea addresses_WT_ht+0xa884, %rdx
add $21529, %rdi
mov (%rdx), %si
xor $11861, %r11
lea addresses_A_ht+0x833e, %rdi
nop
nop
nop
nop
...
nop
xor %rbp, %rbp
lea addresses_UC_ht+0x19f1e, %rsi
lea addresses_A_ht+0x931e, %rdi
nop
xor $55994, %rdx
mov $74, %rcx
rep movsl
...
nop
inc %rsi
lea addresses_WC_ht+0x136b6, %rcx
nop
nop
sub $57105, %rsi
mov $0x6162636465666768, %r12
...
{'src': {'same': False, 'congruent': 2, 'NT': True, 'type': 'addresses_UC_ht', 'size': 4, 'AVXalign': False}, 'OP': 'LOAD'}
{'src': {'type': 'addresses_WT_ht', 'congruent': 11, 'same': False}, 'OP': 'REPM', 'dst': {'type': 'addresses_WT_ht', 'congruent': 4, 'same': True}}
