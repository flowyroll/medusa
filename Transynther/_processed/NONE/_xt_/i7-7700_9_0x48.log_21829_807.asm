...
nop
cmp $9717, %rbx
lea addresses_normal_ht+0xef2b, %r10
nop
nop
nop
add %rcx, %rcx
...
vpextrq $1, %xmm3, %rbx
add %r10, %r10
lea addresses_normal_ht+0x363f, %rsi
...
vpextrq $0, %xmm3, %r10
xor %rdx, %rdx
lea addresses_D_ht+0x1df27, %r10
nop
nop
nop
nop
...
// Faulty Load
lea addresses_normal+0xbdff, %rax
nop
sub $54719, %rcx
vmovups (%rax), %ymm2
