...
nop
cmp %rbp, %rbp
lea addresses_WC_ht+0xd4ca, %r10
cmp %rdx, %rdx
movups (%r10), %xmm4
vpextrq $1, %xmm4, %rbx
nop
add %rdx, %rdx
lea addresses_normal_ht+0x1398a, %rsi
lea addresses_WC_ht+0x103ca, %rdi
clflush (%rdi)
nop
nop
dec %r14
...
nop
add %r10, %r10
lea addresses_normal_ht+0xa4b6, %r10
cmp $8390, %rdx
...
nop
inc %r10
lea addresses_WT_ht+0x13262, %r9
nop
cmp $27179, %rdi
mov $0x6162636465666768, %rbp
movq %rbp, (%r9)
...
{'dst': {'same': False, 'congruent': 8, 'type': 'addresses_WC_ht'}, 'OP': 'REPM', 'src': {'same': True, 'congruent': 5, 'type': 'addresses_normal_ht'}}
