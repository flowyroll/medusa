...
nop
and $44717, %rdi
lea addresses_WC_ht+0x3e26, %rbp
nop
nop
nop
nop
...
mov (%rbp), %si
xor %r10, %r10
lea addresses_WT_ht+0x828a, %rsi
lea addresses_UC_ht+0x18a5a, %rdi
nop
nop
cmp %r9, %r9
mov $77, %rcx
...
nop
sub $9608, %r15
lea addresses_WT_ht+0x13b4, %rcx
clflush (%rcx)
nop
nop
nop
...
mov (%rsi), %cx
and %rbp, %rbp
lea addresses_normal_ht+0x1376, %rsi
clflush (%rsi)
xor %r10, %r10
mov (%rsi), %edi
nop
...
nop
dec %rdi
lea addresses_WC_ht+0x1863e, %r15
nop
nop
xor %rsi, %rsi
movl $0x61626364, (%r15)
sub %r15, %r15
lea addresses_WT_ht+0x38be, %r15
nop
cmp $23081, %rdi
mov (%r15), %esi
nop
nop
cmp %r10, %r10
lea addresses_WC_ht+0x1106e, %rdi
and $51200, %r9
...
nop
add %rdi, %rdi
lea addresses_normal_ht+0x431e, %rsi
clflush (%rsi)
nop
add %r10, %r10
movb $0x61, (%rsi)
dec %r15
lea addresses_normal_ht+0x54f6, %r10
nop
nop
xor %rsi, %rsi
movl $0x61626364, (%r10)
...
// Store
lea addresses_normal+0x16abe, %r8
nop
nop
nop
cmp $15562, %r10
...
// Faulty Load
lea addresses_normal+0x16abe, %rcx
nop
nop
nop
nop
...
{'OP': 'STOR', 'dst': {'type': 'addresses_UC_ht', 'AVXalign': False, 'congruent': 3, 'size': 16, 'same': False, 'NT': True}}
