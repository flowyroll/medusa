...
nop
xor $65050, %r10
lea addresses_WC_ht+0x1ccad, %r11
nop
nop
add %rdi, %rdi
...
nop
sub %rsi, %rsi
lea addresses_D_ht+0x1a2cd, %rdi
nop
nop
nop
nop
...
nop
cmp %r11, %r11
lea addresses_WT_ht+0x180cc, %rsi
lea addresses_normal_ht+0x179d5, %rdi
nop
nop
nop
sub $60180, %r10
...
nop
cmp $21452, %rsi
lea addresses_A_ht+0x11fd5, %rsi
lea addresses_D_ht+0x1ac15, %rdi
clflush (%rsi)
nop
nop
cmp %rax, %rax
...
// Load
lea addresses_normal+0x33d5, %r14
clflush (%r14)
nop
nop
nop
...
// Store
lea addresses_normal+0x1fd5, %r12
nop
nop
nop
nop
...
{'src': {'type': 'addresses_WT', 'same': False, 'size': 32, 'congruent': 0, 'NT': True, 'AVXalign': True}, 'OP': 'LOAD'}
