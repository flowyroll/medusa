...
push %rdi
push %rsi
lea addresses_D_ht+0x9451, %rsi
lea addresses_normal_ht+0x104ab, %rdi
nop
cmp %r14, %r14
mov $94, %rcx
rep movsq
...
nop
sub $13852, %rbp
lea addresses_D_ht+0x16151, %rsi
lea addresses_normal_ht+0x7bde, %rdi
nop
nop
nop
nop
...
rep movsb
and $34004, %r11
lea addresses_WT_ht+0x7551, %rcx
nop
nop
nop
nop
...
nop
and %r14, %r14
lea addresses_UC_ht+0x1c911, %rbp
nop
nop
nop
xor $58837, %r9
...
nop
cmp %rbp, %rbp
lea addresses_WC_ht+0xf731, %rcx
mfence
mov $0x6162636465666768, %r11
movq %r11, %xmm3
movups %xmm3, (%rcx)
...
nop
dec %rdi
lea addresses_UC_ht+0x3531, %rsi
inc %rdi
movw $0x6162, (%rsi)
nop
nop
nop
sub %r14, %r14
lea addresses_D_ht+0x3671, %rsi
lea addresses_A_ht+0x1a131, %rdi
inc %r13
mov $113, %rcx
rep movsq
nop
xor %rcx, %rcx
lea addresses_WC_ht+0x7a31, %rsi
lea addresses_WC_ht+0xbab9, %rdi
clflush (%rsi)
nop
and $11956, %r11
mov $115, %rcx
...
nop
and $758, %rbp
lea addresses_WC_ht+0xc789, %rsi
lea addresses_WC_ht+0x3b31, %rdi
nop
sub %r13, %r13
mov $108, %rcx
rep movsl
...
nop
dec %rsi
lea addresses_D_ht+0x12dd1, %rbp
xor %r13, %r13
movl $0x61626364, (%rbp)
nop
nop
nop
and %rbp, %rbp
lea addresses_WT_ht+0xd331, %rsi
lea addresses_D_ht+0x101f1, %rdi
clflush (%rsi)
and $16827, %r14
mov $35, %rcx
rep movsw
...
nop
add %r9, %r9
lea addresses_WT_ht+0x13971, %rdi
nop
sub %rbp, %rbp
mov (%rdi), %rcx
nop
