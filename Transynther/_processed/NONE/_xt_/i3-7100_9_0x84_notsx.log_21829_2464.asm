...
push %rdx
push %rsi
lea addresses_D_ht+0x4b17, %rsi
lea addresses_A_ht+0xc1f, %rdi
clflush (%rsi)
dec %rdx
mov $22, %rcx
rep movsl
...
nop
cmp $24350, %r15
lea addresses_WT_ht+0x2147, %rax
cmp %rcx, %rcx
mov (%rax), %rdx
nop
nop
...
nop
xor %rdx, %rdx
lea addresses_WT_ht+0x6279, %rdx
mfence
...
nop
cmp %rbx, %rbx
lea addresses_WT_ht+0xe967, %rdx
sub $13875, %rsi
movb (%rdx), %bl
nop
dec %rsi
lea addresses_WC_ht+0x1cfef, %rsi
lea addresses_WT_ht+0xcb67, %rdi
clflush (%rdi)
inc %rbx
mov $97, %rcx
rep movsw
...
nop
cmp %rsi, %rsi
lea addresses_A_ht+0x13be7, %rsi
...
nop
and $30072, %rax
lea addresses_D_ht+0x20d7, %rsi
lea addresses_D_ht+0x8be7, %rdi
clflush (%rdi)
nop
and $49455, %r13
mov $106, %rcx
...
nop
add %rcx, %rcx
lea addresses_D_ht+0x4cbf, %rsi
lea addresses_WT_ht+0x15867, %rdi
nop
nop
cmp %rbx, %rbx
mov $106, %rcx
...
nop
dec %rax
lea addresses_UC_ht+0x1d3e7, %r15
nop
nop
nop
nop
...
nop
inc %rax
lea addresses_WC_ht+0x51bf, %rcx
nop
nop
nop
cmp $31260, %r15
...
nop
add $32970, %rcx
lea addresses_WT_ht+0xfe27, %r13
nop
add $45621, %r15
mov (%r13), %ax
nop
...
nop
and $54856, %r13
lea addresses_normal_ht+0x17f67, %rdi
nop
nop
cmp $65123, %rax
movl $0x61626364, (%rdi)
...
lea addresses_WT_ht+0xbe27, %rdi
nop
add %r15, %r15
mov $99, %rcx
rep movsl
...
{'src': {'type': 'addresses_D_ht', 'congruent': 3, 'same': True}, 'dst': {'type': 'addresses_D_ht', 'congruent': 11, 'same': False}, 'OP': 'REPM'}
{'src': {'type': 'addresses_D_ht', 'congruent': 3, 'same': False}, 'dst': {'type': 'addresses_WT_ht', 'congruent': 4, 'same': False}, 'OP': 'REPM'}
