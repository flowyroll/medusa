...
nop
add %r11, %r11
lea addresses_UC_ht+0x13585, %r9
nop
nop
nop
nop
...
// Store
lea addresses_normal+0x134d5, %rsi
nop
nop
nop
nop
...
<gen_prepare_buffer>
{'dst': {'NT': True, 'AVXalign': False, 'size': 2, 'congruent': 5, 'same': False, 'type': 'addresses_D_ht'}, 'OP': 'STOR'}
{'src': {'NT': False, 'AVXalign': False, 'size': 4, 'congruent': 4, 'same': False, 'type': 'addresses_normal_ht'}, 'OP': 'LOAD'}
{'src': {'NT': True, 'AVXalign': False, 'size': 1, 'congruent': 4, 'same': True, 'type': 'addresses_UC_ht'}, 'OP': 'LOAD'}
