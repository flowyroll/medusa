...
push %rdi
push %rsi
lea addresses_UC_ht+0x58cf, %rax
nop
nop
nop
nop
...
nop
dec %r8
lea addresses_A_ht+0x11173, %rsi
nop
nop
nop
nop
...
movb (%rsi), %r12b
dec %r12
lea addresses_UC_ht+0x17923, %rax
clflush (%rax)
nop
nop
nop
...
nop
cmp $52463, %rsi
lea addresses_A_ht+0x806b, %rbp
nop
add %rdi, %rdi
mov (%rbp), %r12d
nop
sub $10846, %r9
lea addresses_A_ht+0xa473, %rbp
nop
nop
sub %rax, %rax
mov (%rbp), %di
