...
push %rdx
push %rsi
lea addresses_WC_ht+0x45f5, %rsi
...
nop
xor $2258, %r12
lea addresses_WC_ht+0xb8c9, %rdx
nop
nop
nop
sub $50787, %r14
...
nop
cmp %rdx, %rdx
lea addresses_normal_ht+0x111dd, %rsi
lea addresses_D_ht+0x5509, %rdi
nop
sub %rbp, %rbp
mov $102, %rcx
rep movsb
...
// Load
lea addresses_normal+0x12689, %r14
nop
nop
add %rsi, %rsi
vmovups (%r14), %ymm7
