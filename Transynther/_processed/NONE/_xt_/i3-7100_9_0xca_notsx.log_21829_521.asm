...
nop
dec %r14
lea addresses_normal_ht+0x1d0e8, %r13
nop
nop
nop
nop
...
nop
sub $25888, %r11
lea addresses_WT_ht+0x121d0, %rbx
clflush (%rbx)
and $40848, %r13
mov (%rbx), %rcx
nop
...
mov (%r13), %rsi
add $32790, %rbx
lea addresses_D_ht+0x12c68, %rsi
lea addresses_A_ht+0x306, %rdi
nop
add $56655, %r13
mov $24, %rcx
rep movsw
