...
mov (%r10), %r8
add $58351, %rbp
lea addresses_normal_ht+0x157ab, %r12
clflush (%r12)
nop
nop
cmp $46209, %r11
...
// REPMOV
lea addresses_PSE+0x1977b, %rsi
lea addresses_WC+0x7b7b, %rdi
nop
nop
and $5764, %r9
mov $13, %rcx
...
// REPMOV
lea addresses_WC+0x1d77b, %rsi
lea addresses_WC+0x1351b, %rdi
cmp $63189, %rdx
mov $19, %rcx
rep movsl
nop
...
{'src': {'type': 'addresses_PSE', 'congruent': 0, 'same': True}, 'OP': 'REPM', 'dst': {'type': 'addresses_WC', 'congruent': 10, 'same': False}}
{'OP': 'STOR', 'dst': {'type': 'addresses_PSE', 'AVXalign': False, 'size': 2, 'NT': False, 'same': False, 'congruent': 5}}
{'src': {'type': 'addresses_WC', 'congruent': 11, 'same': False}, 'OP': 'REPM', 'dst': {'type': 'addresses_WC', 'congruent': 4, 'same': False}}
[Faulty Load]
