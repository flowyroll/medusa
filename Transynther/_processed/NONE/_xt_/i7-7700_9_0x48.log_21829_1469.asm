...
lea addresses_D_ht+0x1b56c, %rdi
nop
nop
nop
nop
...
nop
cmp $30011, %rbx
lea addresses_D_ht+0x1068c, %rsi
lea addresses_D_ht+0x12ec, %rdi
nop
nop
nop
and %r14, %r14
...
nop
sub %rcx, %rcx
lea addresses_WT_ht+0x141ec, %rsi
lea addresses_A_ht+0x456c, %rdi
nop
nop
cmp $29719, %rbp
mov $123, %rcx
...
nop
cmp $7945, %rsi
lea addresses_UC_ht+0x1896c, %r14
nop
nop
sub %rbp, %rbp
movw $0x6162, (%r14)
sub $34583, %rcx
lea addresses_WT_ht+0x10f6c, %rsi
lea addresses_A_ht+0x7a64, %rdi
nop
nop
nop
inc %r12
...
{'OP': 'REPM', 'src': {'type': 'addresses_D_ht', 'congruent': 5, 'same': True}, 'dst': {'type': 'addresses_D_ht', 'congruent': 7, 'same': False}}
