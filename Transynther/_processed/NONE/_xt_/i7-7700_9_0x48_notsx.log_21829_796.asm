...
push %rdx
push %rsi
lea addresses_D_ht+0x16351, %r11
nop
nop
nop
inc %r15
...
nop
add $49243, %r13
lea addresses_normal_ht+0x4a51, %r12
nop
nop
nop
nop
...
nop
dec %r11
lea addresses_WT_ht+0x18a51, %rbp
sub $56917, %rsi
movups (%rbp), %xmm3
vpextrq $0, %xmm3, %r11
nop
...
nop
inc %r15
lea addresses_normal_ht+0xb94b, %rsi
lea addresses_D_ht+0x1c651, %rdi
nop
nop
nop
nop
...
nop
and %rsi, %rsi
lea addresses_D_ht+0x1a651, %rsi
...
nop
inc %r15
lea addresses_UC_ht+0x1ba51, %r13
nop
and %rcx, %rcx
...
{'dst': {'same': False, 'congruent': 10, 'type': 'addresses_D_ht'}, 'OP': 'REPM', 'src': {'same': True, 'congruent': 1, 'type': 'addresses_normal_ht'}}
