...
push %rdi
push %rsi
lea addresses_WT_ht+0x17822, %rsi
lea addresses_D_ht+0x4422, %rdi
clflush (%rdi)
nop
nop
xor %r13, %r13
...
nop
cmp $19180, %r14
lea addresses_WT_ht+0x13402, %rsi
...
nop
sub $53030, %rsi
lea addresses_normal_ht+0x1cc32, %r15
nop
nop
nop
xor %rsi, %rsi
...
nop
xor $58268, %r13
lea addresses_A_ht+0xc42a, %rsi
lea addresses_A_ht+0xf7de, %rdi
nop
nop
nop
nop
...
nop
sub %rcx, %rcx
lea addresses_WC_ht+0xc890, %rdi
nop
nop
nop
nop
...
<gen_prepare_buffer>
{'src': {'type': 'addresses_WT_ht', 'congruent': 9, 'same': False}, 'dst': {'type': 'addresses_D_ht', 'congruent': 10, 'same': False}, 'OP': 'REPM'}
{'src': {'type': 'addresses_WT_ht', 'congruent': 4, 'same': False}, 'dst': {'type': 'addresses_A_ht', 'congruent': 0, 'same': False}, 'OP': 'REPM'}
