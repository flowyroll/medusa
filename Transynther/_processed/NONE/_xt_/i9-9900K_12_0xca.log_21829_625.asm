...
nop
xor %r10, %r10
lea addresses_A_ht+0x175e2, %r13
nop
nop
and %rsi, %rsi
movw $0x6162, (%r13)
cmp $37234, %r13
lea addresses_normal_ht+0xb2e2, %rsi
lea addresses_UC_ht+0x11ce2, %rdi
nop
sub %r15, %r15
mov $2, %rcx
rep movsl
...
nop
dec %rcx
lea addresses_normal_ht+0x19452, %r12
nop
nop
cmp $13552, %r8
movw $0x6162, (%r12)
...
<gen_prepare_buffer>
{'OP': 'LOAD', 'src': {'size': 4, 'NT': True, 'type': 'addresses_A_ht', 'same': False, 'AVXalign': True, 'congruent': 11}}
