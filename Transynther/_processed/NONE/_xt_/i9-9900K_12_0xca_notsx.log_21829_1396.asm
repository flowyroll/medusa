...
nop
sub $28456, %r10
lea addresses_WT_ht+0x5c41, %r11
nop
nop
nop
inc %rcx
...
nop
xor $55384, %rsi
lea addresses_normal_ht+0x2a7f, %r11
nop
nop
nop
nop
...
nop
and $26200, %rdi
lea addresses_WC_ht+0xd041, %rsi
lea addresses_normal_ht+0x6441, %rdi
clflush (%rdi)
nop
add $33296, %rbx
mov $0, %rcx
...
nop
inc %r11
lea addresses_UC_ht+0x4c41, %rsi
lea addresses_A_ht+0x93e3, %rdi
nop
nop
nop
add $35561, %r12
...
nop
xor $62836, %r12
lea addresses_WC_ht+0x14841, %rbx
nop
nop
nop
nop
...
nop
add %r12, %r12
lea addresses_WC_ht+0x1e341, %r12
nop
and %rbx, %rbx
mov (%r12), %cx
nop
...
nop
sub $42199, %rcx
lea addresses_WC_ht+0x3541, %r14
nop
sub %rbx, %rbx
vmovups (%r14), %ymm3
...
vpextrq $0, %xmm3, %rsi
add %r10, %r10
lea addresses_WT_ht+0x5d16, %rsi
lea addresses_WT_ht+0x5c41, %rdi
clflush (%rsi)
nop
nop
nop
...
nop
add %rbx, %rbx
lea addresses_WT_ht+0x18861, %rbx
nop
nop
nop
nop
...
nop
sub $29597, %r11
lea addresses_UC_ht+0xbbc1, %r10
clflush (%r10)
nop
xor $9159, %rbx
movb (%r10), %cl
...
{'OP': 'LOAD', 'src': {'same': False, 'type': 'addresses_WC_ht', 'NT': False, 'AVXalign': True, 'size': 8, 'congruent': 10}}
...
{'OP': 'REPM', 'src': {'same': False, 'congruent': 0, 'type': 'addresses_WT_ht'}, 'dst': {'same': False, 'congruent': 10, 'type': 'addresses_WT_ht'}}
