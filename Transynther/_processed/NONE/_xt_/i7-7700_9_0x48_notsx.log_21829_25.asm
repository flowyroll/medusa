...
push %rdx
push %rsi
lea addresses_WC_ht+0x54eb, %rdi
nop
nop
nop
nop
...
nop
dec %rsi
lea addresses_WT_ht+0x1049d, %r10
nop
add %r15, %r15
...
nop
xor $2057, %rdi
lea addresses_UC_ht+0x128eb, %r10
nop
nop
nop
nop
...
// Faulty Load
lea addresses_normal+0x176eb, %rdi
clflush (%rdi)
nop
nop
inc %r9
...
<gen_prepare_buffer>
{'dst': {'same': False, 'NT': True, 'AVXalign': True, 'size': 32, 'type': 'addresses_WC_ht', 'congruent': 6}, 'OP': 'STOR'}
{'OP': 'LOAD', 'src': {'same': True, 'NT': True, 'AVXalign': False, 'size': 32, 'type': 'addresses_WT_ht', 'congruent': 0}}
