...
push %rdx
push %rsi
lea addresses_normal_ht+0x1ddec, %r9
nop
nop
nop
cmp %rax, %rax
...
nop
add $63748, %r14
lea addresses_UC_ht+0x1462d, %rdi
nop
nop
nop
and %r13, %r13
...
nop
sub $38166, %r13
lea addresses_WC_ht+0xf4eb, %rax
nop
nop
sub $1251, %rdx
movw $0x6162, (%rax)
and $58143, %rdx
lea addresses_A_ht+0xd41d, %rsi
lea addresses_D_ht+0x276d, %rdi
clflush (%rdi)
sub %r13, %r13
mov $15, %rcx
rep movsw
nop
xor %rax, %rax
lea addresses_UC_ht+0x212d, %rax
nop
nop
nop
and $65455, %r9
...
nop
sub %r13, %r13
lea addresses_normal_ht+0xcaed, %r13
nop
nop
nop
xor %rcx, %rcx
...
nop
sub %rdx, %rdx
lea addresses_D_ht+0x175cd, %rbp
nop
nop
nop
nop
...
// Faulty Load
lea addresses_normal+0xef6d, %r10
nop
nop
nop
nop
