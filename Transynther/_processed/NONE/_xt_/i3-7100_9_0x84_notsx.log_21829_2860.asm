...
nop
sub $51387, %rbx
lea addresses_normal_ht+0x8995, %r9
xor %rsi, %rsi
mov $0x6162636465666768, %rdx
movq %rdx, (%r9)
xor $2990, %r9
lea addresses_WT_ht+0x30cd, %rsi
lea addresses_WT_ht+0x110a9, %rdi
clflush (%rdi)
xor $24570, %rbx
mov $8, %rcx
rep movsw
xor $25975, %r10
lea addresses_WC_ht+0x11629, %rdx
clflush (%rdx)
sub %rcx, %rcx
movups (%rdx), %xmm3
vpextrq $0, %xmm3, %rdi
xor $8216, %rbx
lea addresses_D_ht+0x15e9, %rdi
clflush (%rdi)
nop
nop
nop
...
nop
sub %rcx, %rcx
lea addresses_UC_ht+0x19b7f, %rsi
lea addresses_normal_ht+0x6fa9, %rdi
nop
nop
nop
and %r10, %r10
...
nop
cmp %r12, %r12
lea addresses_normal_ht+0x181a9, %rsi
nop
nop
nop
nop
...
nop
inc %r9
lea addresses_normal_ht+0x1eea9, %rdi
and %rsi, %rsi
mov $0x6162636465666768, %rdx
movq %rdx, (%rdi)
nop
