...
nop
inc %r11
lea addresses_A_ht+0x92a6, %rsi
lea addresses_WT_ht+0x117ce, %rdi
clflush (%rdi)
nop
nop
nop
...
// Faulty Load
lea addresses_normal+0x19fce, %r11
clflush (%r11)
add %r8, %r8
mov (%r11), %bx
lea oracles, %r14
...
{'OP': 'STOR', 'dst': {'type': 'addresses_normal_ht', 'size': 4, 'AVXalign': False, 'NT': True, 'congruent': 3, 'same': False}}
