...
push %rdi
push %rsi
lea addresses_UC_ht+0x8fb6, %r11
nop
nop
add %r12, %r12
movb $0x61, (%r11)
...
nop
xor $45575, %r8
lea addresses_WT_ht+0x18016, %rbp
nop
nop
add $62364, %r8
movb $0x61, (%rbp)
...
nop
inc %r12
lea addresses_A_ht+0x1d9f6, %rsi
lea addresses_WC_ht+0xfaf6, %rdi
add %rbp, %rbp
mov $80, %rcx
rep movsq
nop
dec %r12
lea addresses_UC_ht+0x14e36, %r11
nop
nop
nop
nop
...
nop
and $7935, %r11
lea addresses_WC_ht+0x147f6, %rbp
nop
inc %r12
...
nop
xor %rbp, %rbp
lea addresses_WC_ht+0xc316, %rsi
nop
nop
nop
nop
...
movw $0x6162, (%rsi)
xor $31985, %r8
lea addresses_D_ht+0x19ff6, %rsi
lea addresses_WC_ht+0xa656, %rdi
nop
nop
nop
nop
