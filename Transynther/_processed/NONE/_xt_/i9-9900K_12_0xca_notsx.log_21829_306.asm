...
push %rdi
push %rsi
lea addresses_WC_ht+0xcb4, %rsi
lea addresses_A_ht+0x8b5a, %rdi
xor %rax, %rax
mov $8, %rcx
rep movsw
nop
...
nop
lfence
lea addresses_WC_ht+0x8a14, %r10
nop
dec %r11
...
nop
dec %rax
lea addresses_UC_ht+0x4d5a, %r10
nop
dec %rcx
movups (%r10), %xmm0
vpextrq $1, %xmm0, %rsi
...
lea addresses_D_ht+0x16d5a, %rdi
xor $23531, %r15
mov $66, %rcx
rep movsl
sub %r11, %r11
lea addresses_WC_ht+0x1379a, %rsi
lea addresses_A_ht+0x4e9a, %rdi
clflush (%rdi)
nop
nop
nop
...
<gen_prepare_buffer>
{'OP': 'REPM', 'src': {'same': False, 'congruent': 1, 'type': 'addresses_WC_ht'}, 'dst': {'same': False, 'congruent': 10, 'type': 'addresses_A_ht'}}
...
{'OP': 'REPM', 'src': {'same': False, 'congruent': 5, 'type': 'addresses_WC_ht'}, 'dst': {'same': False, 'congruent': 4, 'type': 'addresses_A_ht'}}
{'37': 21829}
