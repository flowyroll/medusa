...
push %rdx
push %rsi
lea addresses_A_ht+0x11837, %rsi
lea addresses_D_ht+0x19ff1, %rdi
nop
add $59367, %r11
mov $3, %rcx
rep movsw
...
nop
xor %r9, %r9
lea addresses_UC_ht+0x1e537, %r12
nop
nop
inc %rbp
...
nop
xor $35101, %rcx
lea addresses_D_ht+0x194b7, %rsi
lea addresses_UC_ht+0x19037, %rdi
clflush (%rdi)
nop
nop
nop
...
nop
xor %r11, %r11
lea addresses_UC_ht+0xc7b7, %rsi
nop
nop
nop
add %r12, %r12
...
nop
xor $42829, %rbp
lea addresses_UC_ht+0x2837, %r11
sub $17815, %rdx
movw $0x6162, (%r11)
nop
xor $49508, %rdx
lea addresses_D_ht+0x2f7, %rdx
nop
nop
add $18711, %rdi
mov (%rdx), %si
...
lea addresses_UC_ht+0xe377, %rdi
nop
nop
sub %rdx, %rdx
mov $100, %rcx
...
{'OP': 'STOR', 'dst': {'congruent': 11, 'AVXalign': True, 'same': False, 'size': 2, 'NT': False, 'type': 'addresses_UC_ht'}}
{'src': {'congruent': 4, 'AVXalign': True, 'same': False, 'size': 2, 'NT': False, 'type': 'addresses_D_ht'}, 'OP': 'LOAD'}
{'src': {'congruent': 10, 'same': False, 'type': 'addresses_UC_ht'}, 'OP': 'REPM', 'dst': {'congruent': 4, 'same': False, 'type': 'addresses_UC_ht'}}
