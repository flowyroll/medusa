...
push %rdx
push %rsi
lea addresses_WC_ht+0x6c25, %r10
nop
nop
nop
nop
...
nop
sub %r13, %r13
lea addresses_WT_ht+0x18695, %r8
nop
xor %rdi, %rdi
vmovups (%r8), %ymm1
...
nop
cmp %r13, %r13
lea addresses_normal_ht+0x1ca95, %rsi
lea addresses_WT_ht+0x8b65, %rdi
nop
nop
nop
cmp $33870, %r9
...
nop
sub $64399, %rbx
lea addresses_A_ht+0x15e23, %rsi
lea addresses_WC_ht+0x1ba95, %rdi
add %r13, %r13
mov $32, %rcx
rep movsq
nop
...
lea addresses_D_ht+0x14f95, %rdi
nop
nop
nop
nop
...
// Faulty Load
lea addresses_normal+0x11c95, %rcx
clflush (%rcx)
nop
nop
nop
