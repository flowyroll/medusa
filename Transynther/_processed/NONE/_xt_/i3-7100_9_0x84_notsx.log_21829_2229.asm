...
nop
inc %rbx
lea addresses_D_ht+0x18fee, %rbp
and $10620, %rcx
...
nop
xor %r10, %r10
lea addresses_normal_ht+0xe5de, %rsi
sub $36384, %rbp
mov $0x6162636465666768, %r8
movq %r8, %xmm4
vmovups %ymm4, (%rsi)
xor %r8, %r8
lea addresses_WC_ht+0x1e6ce, %rbx
nop
nop
nop
nop
...
movq %r8, (%rbx)
and $47477, %rcx
lea addresses_A_ht+0x183ae, %r10
nop
nop
nop
add %rcx, %rcx
...
nop
xor %r8, %r8
lea addresses_normal_ht+0x120a4, %rcx
nop
nop
nop
inc %rbx
...
nop
and $29527, %rsi
lea addresses_A_ht+0x1dbee, %rsi
lea addresses_A_ht+0x6fce, %rdi
clflush (%rdi)
nop
nop
nop
...
nop
xor %rbx, %rbx
lea addresses_UC_ht+0xc86, %rbx
clflush (%rbx)
sub %r8, %r8
mov (%rbx), %di
nop
xor %rbx, %rbx
lea addresses_normal_ht+0x1a6bc, %r10
cmp %rcx, %rcx
movw $0x6162, (%r10)
nop
sub $37606, %rcx
lea addresses_D_ht+0xd2ce, %r8
clflush (%r8)
xor $5889, %rcx
mov (%r8), %rbx
xor $50629, %rcx
...
{'src': {'type': 'addresses_A_ht', 'congruent': 10, 'same': False}, 'dst': {'type': 'addresses_A_ht', 'congruent': 5, 'same': False}, 'OP': 'REPM'}
