...
nop
cmp %r15, %r15
lea addresses_WT_ht+0x1db1a, %rsi
lea addresses_WC_ht+0x133b6, %rdi
clflush (%rsi)
nop
sub $2858, %r8
mov $97, %rcx
...
nop
cmp $43180, %rcx
lea addresses_UC_ht+0x7ada, %rsi
lea addresses_A_ht+0x19146, %rdi
clflush (%rsi)
nop
sub $16905, %r10
mov $107, %rcx
rep movsq
sub %r15, %r15
lea addresses_UC_ht+0x1367d, %r10
nop
sub $58788, %rsi
mov $0x6162636465666768, %r15
movq %r15, (%r10)
...
nop
add %r10, %r10
lea addresses_D_ht+0x48f0, %rsi
lea addresses_WT_ht+0x1774a, %rdi
clflush (%rsi)
clflush (%rdi)
nop
nop
...
nop
add $49777, %rcx
lea addresses_D_ht+0x1674a, %rdi
nop
nop
nop
nop
...
{'OP': 'REPM', 'src': {'same': False, 'type': 'addresses_UC_ht', 'congruent': 4}, 'dst': {'same': False, 'type': 'addresses_A_ht', 'congruent': 2}}
...
{'OP': 'REPM', 'src': {'same': False, 'type': 'addresses_D_ht', 'congruent': 1}, 'dst': {'same': False, 'type': 'addresses_WT_ht', 'congruent': 11}}
