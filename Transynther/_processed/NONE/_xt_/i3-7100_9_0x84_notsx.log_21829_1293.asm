...
push %rdi
push %rsi
lea addresses_WC_ht+0xf5dc, %rsi
lea addresses_A_ht+0x156fc, %rdi
nop
nop
nop
nop
...
nop
cmp %rsi, %rsi
lea addresses_WT_ht+0xb43c, %rbx
nop
xor %r12, %r12
...
lea addresses_UC_ht+0xde3c, %rdi
nop
nop
nop
nop
...
nop
add $19207, %rcx
lea addresses_WC_ht+0x683c, %r12
nop
nop
nop
add %rsi, %rsi
...
nop
and %r15, %r15
lea addresses_D_ht+0x1d73c, %rsi
nop
nop
nop
dec %r12
...
nop
and $57014, %rbx
lea addresses_UC_ht+0x1743c, %rdi
nop
nop
nop
nop
...
nop
xor %rsi, %rsi
lea addresses_UC_ht+0x1b83c, %rsi
nop
nop
cmp $10505, %rcx
movw $0x6162, (%rsi)
and $25813, %rcx
lea addresses_D_ht+0x1103c, %r12
and %rcx, %rcx
mov (%r12), %esi
nop
nop
...
// Store
lea addresses_PSE+0x1883c, %rax
xor $10187, %r9
movb $0x51, (%rax)
xor %r12, %r12

// Faulty Load
lea addresses_RW+0x1e03c, %r12
nop
and %r15, %r15
mov (%r12), %r10d
lea oracles, %rax
...
{'src': {'type': 'addresses_D_ht', 'congruent': 0, 'same': False}, 'dst': {'type': 'addresses_UC_ht', 'congruent': 7, 'same': False}, 'OP': 'REPM'}
