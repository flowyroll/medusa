...
push %rdi
push %rsi
lea addresses_WC_ht+0x18c92, %rsi
lea addresses_WC_ht+0x15712, %rdi
nop
cmp $64276, %r10
mov $41, %rcx
rep movsb
...
nop
add $22223, %rsi
lea addresses_WC_ht+0x145b2, %rsi
nop
nop
inc %r9
movw $0x6162, (%rsi)
...
nop
cmp %r8, %r8
lea addresses_UC_ht+0x4d8e, %rsi
nop
nop
nop
nop
