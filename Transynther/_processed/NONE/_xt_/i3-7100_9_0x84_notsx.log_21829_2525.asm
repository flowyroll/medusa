...
nop
add %rdi, %rdi
lea addresses_normal_ht+0x1988f, %rsi
lea addresses_WT_ht+0x1774f, %rdi
nop
nop
and $48006, %rbx
mov $10, %rcx
...
nop
xor %r14, %r14
lea addresses_WT_ht+0xefef, %rcx
nop
nop
dec %rdi
mov (%rcx), %r14
nop
sub %r13, %r13
lea addresses_normal_ht+0x1b917, %r13
nop
nop
nop
nop
...
nop
inc %r13
lea addresses_WT_ht+0x145df, %rsi
lea addresses_UC_ht+0x1ba0f, %rdi
nop
nop
nop
and %r9, %r9
...
nop
inc %rbp
lea addresses_WC_ht+0x12c4f, %r14
nop
nop
nop
dec %rbx
movl $0x61626364, (%r14)
add %rsi, %rsi
lea addresses_WT_ht+0x5e4f, %rsi
lea addresses_UC_ht+0x1a54f, %rdi
nop
nop
nop
nop
