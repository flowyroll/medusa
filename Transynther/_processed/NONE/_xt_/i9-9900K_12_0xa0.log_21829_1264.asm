...
nop
and %rsi, %rsi
lea addresses_WC_ht+0x11654, %r9
nop
nop
nop
nop
...
nop
sub %rcx, %rcx
lea addresses_UC_ht+0x1e472, %r13
nop
nop
nop
inc %r8
movl $0x61626364, (%r13)
and %r8, %r8
lea addresses_WT_ht+0x199d8, %r13
nop
nop
sub %r15, %r15
