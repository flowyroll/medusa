...
push %rdx
push %rsi
lea addresses_WT_ht+0x90a8, %rdx
clflush (%rdx)
nop
nop
nop
...
nop
inc %rax
lea addresses_UC_ht+0x18da8, %rsi
lea addresses_UC_ht+0x1b8a8, %rdi
clflush (%rdi)
nop
add $9798, %r10
mov $109, %rcx
...
nop
xor %rdi, %rdi
lea addresses_UC_ht+0x18bb8, %rdi
nop
nop
cmp %rdx, %rdx
mov (%rdi), %si
add $8029, %rcx
lea addresses_normal_ht+0x1ebee, %rax
nop
dec %r15
...
nop
sub %rcx, %rcx
lea addresses_UC_ht+0xe7c6, %rsi
lea addresses_D_ht+0x141a8, %rdi
nop
nop
add $10741, %r8
mov $13, %rcx
...
nop
add %r15, %r15
lea addresses_UC_ht+0x6f2e, %rsi
lea addresses_A_ht+0x10da8, %rdi
nop
nop
nop
nop
...
nop
xor $23084, %rsi
lea addresses_normal_ht+0x18028, %rdx
nop
add %rcx, %rcx
mov (%rdx), %r15w
cmp $49345, %rcx
lea addresses_normal_ht+0x17608, %rsi
lea addresses_A_ht+0x1ad88, %rdi
nop
nop
nop
nop
...
{'OP': 'REPM', 'src': {'type': 'addresses_UC_ht', 'congruent': 1, 'same': True}, 'dst': {'type': 'addresses_A_ht', 'congruent': 11, 'same': False}}
