...
push %rdi
push %rsi
lea addresses_UC_ht+0xee94, %rsi
lea addresses_WC_ht+0x154, %rdi
nop
nop
nop
inc %r15
...
nop
dec %r13
lea addresses_WC_ht+0x17fa6, %rax
nop
nop
nop
add $36136, %rbp
...
nop
dec %rdi
lea addresses_WC_ht+0xdb48, %rsi
lea addresses_normal_ht+0x53d4, %rdi
nop
xor $12507, %rbp
mov $16, %rcx
rep movsb
...
nop
cmp %rsi, %rsi
lea addresses_UC_ht+0x13e04, %rax
nop
nop
nop
nop
...
// REPMOV
lea addresses_RW+0x1d294, %rsi
lea addresses_D+0x4654, %rdi
clflush (%rdi)
nop
nop
nop
...
{'OP': 'REPM', 'src': {'type': 'addresses_RW', 'congruent': 0, 'same': True}, 'dst': {'type': 'addresses_D', 'congruent': 6, 'same': False}}
[Faulty Load]
