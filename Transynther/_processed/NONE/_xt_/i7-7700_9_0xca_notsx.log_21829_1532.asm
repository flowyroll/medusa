...
push %rdx
push %rsi
lea addresses_WC_ht+0x1efd6, %rsi
...
nop
add %r9, %r9
lea addresses_A_ht+0x1ddd6, %r15
nop
nop
nop
nop
...
nop
add $2203, %rdx
lea addresses_WC_ht+0x11f4f, %rsi
lea addresses_WC_ht+0x110d6, %rdi
nop
nop
nop
sub $46128, %rdx
...
nop
inc %rdx
lea addresses_normal_ht+0x1e9d6, %rsi
nop
nop
nop
nop
...
nop
and %r15, %r15
lea addresses_normal_ht+0x1cdc4, %rsi
nop
nop
nop
nop
...
nop
xor $29172, %r11
lea addresses_normal_ht+0xa9d6, %rsi
...
<gen_prepare_buffer>
{'src': {'congruent': 9, 'same': False, 'type': 'addresses_WC_ht'}, 'dst': {'congruent': 3, 'same': True, 'type': 'addresses_normal_ht'}, 'OP': 'REPM'}
{'dst': {'NT': True, 'AVXalign': False, 'size': 4, 'congruent': 8, 'same': False, 'type': 'addresses_A_ht'}, 'OP': 'STOR'}
{'src': {'congruent': 0, 'same': False, 'type': 'addresses_WC_ht'}, 'dst': {'congruent': 8, 'same': False, 'type': 'addresses_WC_ht'}, 'OP': 'REPM'}
