...
push %rdx
push %rsi
lea addresses_UC_ht+0x11b1c, %rsi
lea addresses_D_ht+0xb884, %rdi
sub $12117, %r15
mov $54, %rcx
rep movsw
nop
...
nop
sub %r14, %r14
lea addresses_WT_ht+0x16b84, %rsi
lea addresses_WC_ht+0x1950c, %rdi
clflush (%rdi)
nop
nop
nop
...
nop
cmp $4805, %rcx
lea addresses_UC_ht+0xb5e4, %r15
nop
nop
nop
dec %rbp
...
nop
inc %r15
lea addresses_A_ht+0x1ad64, %rcx
nop
nop
nop
xor %r9, %r9
...
nop
xor %r15, %r15
lea addresses_WT_ht+0x5e84, %rsi
lea addresses_WC_ht+0x5284, %rdi
nop
nop
nop
nop
...
// Faulty Load
lea addresses_normal+0x4a84, %rbp
nop
dec %r13
mov (%rbp), %dx
lea oracles, %r13
...
<gen_prepare_buffer>
{'dst': {'same': False, 'congruent': 1, 'type': 'addresses_D_ht'}, 'OP': 'REPM', 'src': {'same': False, 'congruent': 3, 'type': 'addresses_UC_ht'}}
{'dst': {'same': False, 'congruent': 3, 'type': 'addresses_WC_ht'}, 'OP': 'REPM', 'src': {'same': False, 'congruent': 5, 'type': 'addresses_WT_ht'}}
