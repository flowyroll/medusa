...
// Store
lea addresses_RW+0x161ac, %rbp
sub $32241, %r11
movw $0x5152, (%rbp)
sub %r12, %r12

// Store
lea addresses_US+0x35b8, %rdx
nop
nop
add %rsi, %rsi
movb $0x51, (%rdx)
...
{'OP': 'STOR', 'dst': {'same': False, 'type': 'addresses_US', 'NT': True, 'AVXalign': False, 'size': 1, 'congruent': 10}}
{'OP': 'STOR', 'dst': {'same': False, 'type': 'addresses_US', 'NT': False, 'AVXalign': False, 'size': 2, 'congruent': 10}}
[Faulty Load]
