...
push %rbp
push %rdi
lea addresses_normal_ht+0x16fee, %rdi
nop
nop
nop
nop
...
nop
sub $41391, %rax
lea addresses_UC_ht+0xb62e, %rbp
nop
nop
inc %r12
movb (%rbp), %r10b
...
nop
inc %rax
lea addresses_normal_ht+0x19b2e, %rbp
xor $191, %r10
mov (%rbp), %r12
add $2968, %rdi
lea addresses_normal_ht+0x11c1e, %r10
nop
nop
xor %rbp, %rbp
mov (%r10), %r8d
...
nop
sub %r12, %r12
lea addresses_WT_ht+0xf1ee, %rbp
nop
add $37880, %r14
movw $0x6162, (%rbp)
nop
...
nop
xor $15443, %r12
lea addresses_D_ht+0x1a25e, %rbp
nop
nop
nop
nop
...
{'src': {'same': True, 'congruent': 4, 'NT': False, 'type': 'addresses_normal_ht', 'size': 4, 'AVXalign': False}, 'OP': 'LOAD'}
