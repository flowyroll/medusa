...
push %rdi
push %rsi
lea addresses_UC_ht+0x14ebf, %rbp
cmp %r11, %r11
movl $0x61626364, (%rbp)
nop
nop
...
nop
cmp %r15, %r15
lea addresses_WC_ht+0xd6fb, %r12
add %rdi, %rdi
mov (%r12), %r8w
nop
nop
...
nop
dec %r12
lea addresses_UC_ht+0xc01b, %rsi
...
movups %xmm6, (%rdi)
sub %rsi, %rsi
lea addresses_normal_ht+0x2559, %rsi
lea addresses_WT_ht+0x1eae2, %rdi
clflush (%rsi)
nop
inc %rbp
mov $63, %rcx
...
nop
lfence
lea addresses_normal_ht+0x93e9, %rbp
nop
nop
nop
nop
...
nop
inc %rdi
lea addresses_D_ht+0x174ff, %rdi
nop
nop
nop
nop
...
// Faulty Load
lea addresses_normal+0x144bf, %rdi
nop
nop
nop
nop
...
{'OP': 'REPM', 'src': {'same': True, 'congruent': 2, 'type': 'addresses_UC_ht'}, 'dst': {'same': True, 'congruent': 1, 'type': 'addresses_D_ht'}}
{'OP': 'STOR', 'dst': {'same': False, 'type': 'addresses_D_ht', 'NT': False, 'AVXalign': False, 'size': 16, 'congruent': 5}}
{'OP': 'REPM', 'src': {'same': True, 'congruent': 0, 'type': 'addresses_normal_ht'}, 'dst': {'same': False, 'congruent': 0, 'type': 'addresses_WT_ht'}}
