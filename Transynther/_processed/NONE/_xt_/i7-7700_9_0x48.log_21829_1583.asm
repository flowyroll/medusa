...
push %rdx
push %rsi
lea addresses_UC_ht+0xa450, %rsi
lea addresses_A_ht+0x7d12, %rdi
clflush (%rdi)
nop
nop
nop
...
nop
add %rdx, %rdx
lea addresses_WC_ht+0x15930, %r15
dec %rbp
...
nop
and %rbp, %rbp
lea addresses_WC_ht+0x1b430, %rcx
nop
nop
nop
nop
...
nop
inc %rdi
lea addresses_D_ht+0x13830, %rdi
nop
nop
nop
nop
...
movb $0x61, (%rdi)
sub %rdi, %rdi
lea addresses_D_ht+0x9a38, %rsi
lea addresses_WC_ht+0x93d2, %rdi
nop
xor %rdx, %rdx
mov $69, %rcx
rep movsb
nop
add %rdx, %rdx
lea addresses_WC_ht+0xdb30, %rsi
nop
nop
sub %r15, %r15
movups (%rsi), %xmm3
...
// Load
lea addresses_normal+0xa388, %rbp
nop
nop
nop
nop
...
{'OP': 'LOAD', 'src': {'type': 'addresses_P', 'AVXalign': False, 'congruent': 4, 'size': 8, 'same': False, 'NT': False}}
{'OP': 'LOAD', 'src': {'type': 'addresses_normal', 'AVXalign': False, 'congruent': 2, 'size': 32, 'same': False, 'NT': True}}
[Faulty Load]
