...
rep movsl
inc %rdi
lea addresses_UC_ht+0x17df4, %rsi
lea addresses_WT_ht+0x91c4, %rdi
nop
sub $26595, %r13
mov $34, %rcx
rep movsb
...
nop
add %rdi, %rdi
lea addresses_UC_ht+0x9dc4, %rsi
lea addresses_normal_ht+0xf684, %rdi
nop
nop
xor $44566, %rax
mov $24, %rcx
...
nop
cmp $10805, %r13
lea addresses_WT_ht+0xee24, %rdx
nop
nop
nop
nop
...
nop
and $49031, %r13
lea addresses_UC_ht+0x1b304, %rsi
lea addresses_WT_ht+0x67c4, %rdi
clflush (%rsi)
clflush (%rdi)
nop
nop
...
// REPMOV
lea addresses_normal+0x4dc4, %rsi
lea addresses_WT+0x159c4, %rdi
clflush (%rsi)
nop
nop
nop
...
{'src': {'type': 'addresses_normal', 'congruent': 10, 'same': False}, 'OP': 'REPM', 'dst': {'type': 'addresses_WT', 'congruent': 1, 'same': False}}
[Faulty Load]
{'src': {'type': 'addresses_PSE', 'AVXalign': False, 'size': 32, 'NT': False, 'same': True, 'congruent': 0}, 'OP': 'LOAD'}
<gen_prepare_buffer>
{'src': {'type': 'addresses_WT_ht', 'congruent': 4, 'same': False}, 'OP': 'REPM', 'dst': {'type': 'addresses_WC_ht', 'congruent': 9, 'same': False}}
