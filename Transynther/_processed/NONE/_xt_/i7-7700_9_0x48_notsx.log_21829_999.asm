...
push %rdi
push %rsi
lea addresses_WC_ht+0x1e6bc, %rsi
lea addresses_normal_ht+0x1083c, %rdi
nop
nop
xor %rax, %rax
mov $11, %rcx
...
nop
and $55364, %r14
lea addresses_normal_ht+0x1b6bc, %r15
nop
nop
nop
sub %r14, %r14
...
nop
and $32209, %rdi
lea addresses_D_ht+0x175dc, %r14
nop
nop
nop
nop
...
nop
inc %rsi
lea addresses_D_ht+0x1dab4, %rsi
lea addresses_WC_ht+0xabc, %rdi
nop
nop
xor %r13, %r13
mov $105, %rcx
...
lea addresses_UC_ht+0x6714, %rdi
nop
nop
nop
nop
...
// Store
lea addresses_PSE+0x187bc, %rax
xor $54956, %r14
movw $0x5152, (%rax)
add %r14, %r14

// Faulty Load
lea addresses_UC+0xf2bc, %r8
nop
nop
nop
nop
...
<gen_prepare_buffer>
{'dst': {'same': True, 'congruent': 5, 'type': 'addresses_normal_ht'}, 'OP': 'REPM', 'src': {'same': False, 'congruent': 10, 'type': 'addresses_WC_ht'}}
{'OP': 'LOAD', 'src': {'same': False, 'NT': True, 'AVXalign': False, 'size': 2, 'type': 'addresses_normal_ht', 'congruent': 7}}
...
{'dst': {'same': False, 'congruent': 11, 'type': 'addresses_WC_ht'}, 'OP': 'REPM', 'src': {'same': False, 'congruent': 3, 'type': 'addresses_D_ht'}}
