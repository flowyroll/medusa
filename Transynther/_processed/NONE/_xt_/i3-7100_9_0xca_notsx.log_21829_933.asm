...
nop
sub %rcx, %rcx
lea addresses_UC_ht+0x68ee, %rsi
nop
nop
sub %r13, %r13
movups (%rsi), %xmm5
...
nop
cmp $34736, %rdx
lea addresses_WT_ht+0x246e, %rsi
lea addresses_A_ht+0x10e6e, %rdi
inc %rdx
mov $7, %rcx
rep movsq
nop
nop
add $41514, %rdi
lea addresses_A_ht+0x1b7ee, %rdi
clflush (%rdi)
nop
nop
nop
...
nop
sub %rcx, %rcx
lea addresses_UC_ht+0xdef6, %rsi
nop
nop
nop
nop
...
nop
sub $58326, %r14
lea addresses_normal_ht+0x83ee, %r14
nop
xor %rdi, %rdi
mov (%r14), %r13
sub %r14, %r14
lea addresses_D_ht+0x11b6e, %rcx
nop
nop
nop
nop
...
nop
cmp $16798, %rdi
lea addresses_normal_ht+0x66ee, %r13
nop
nop
nop
nop
...
vpextrq $1, %xmm6, %rcx
cmp %rax, %rax
lea addresses_normal_ht+0xebc, %rsi
lea addresses_A_ht+0xc16e, %rdi
clflush (%rsi)
nop
sub %r8, %r8
mov $51, %rcx
...
{'src': {'type': 'addresses_WC_ht', 'congruent': 3, 'same': False}, 'OP': 'REPM', 'dst': {'type': 'addresses_UC_ht', 'congruent': 11, 'same': False}}
{'src': {'same': False, 'congruent': 4, 'NT': False, 'type': 'addresses_UC_ht', 'size': 16, 'AVXalign': False}, 'OP': 'LOAD'}
{'src': {'type': 'addresses_WT_ht', 'congruent': 7, 'same': False}, 'OP': 'REPM', 'dst': {'type': 'addresses_A_ht', 'congruent': 7, 'same': False}}
