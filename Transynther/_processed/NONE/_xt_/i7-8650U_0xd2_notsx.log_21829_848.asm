...
nop
cmp %rdi, %rdi
lea addresses_WC_ht+0x12b78, %rsi
nop
nop
and $35905, %rdx
movb (%rsi), %r15b
nop
xor $58601, %rbp
lea addresses_WT_ht+0xc378, %rsi
nop
nop
dec %r15
mov (%rsi), %r10w
...
nop
add $19730, %rbp
lea addresses_UC_ht+0x1ed06, %rdx
sub %rbp, %rbp
...
nop
add %rcx, %rcx
lea addresses_UC_ht+0x9778, %rbp
cmp %rsi, %rsi
movb (%rbp), %r10b
nop
nop
add %r10, %r10
lea addresses_normal_ht+0x19ca8, %rcx
nop
nop
nop
nop
...
nop
add $63394, %r10
lea addresses_normal_ht+0x18b78, %rbp
sub $46139, %rsi
...
nop
xor $7687, %rdx
lea addresses_A_ht+0x176b8, %rdx
nop
nop
and $54053, %r15
mov (%rdx), %di
