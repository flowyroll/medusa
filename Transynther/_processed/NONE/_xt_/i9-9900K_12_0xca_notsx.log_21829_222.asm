...
push %rdi
push %rsi
lea addresses_normal_ht+0xf857, %r9
nop
nop
nop
nop
...
lea addresses_A_ht+0x1d643, %rdi
nop
nop
nop
and %r14, %r14
...
nop
inc %rsi
lea addresses_WC_ht+0x1c893, %rax
nop
nop
sub $23034, %rcx
movups (%rax), %xmm3
...
nop
add $28699, %rsi
lea addresses_D_ht+0x10d8b, %r14
nop
nop
nop
nop
...
nop
xor %rax, %rax
lea addresses_normal_ht+0x1e30b, %rsi
lea addresses_WT_ht+0x17867, %rdi
nop
nop
add $19373, %rax
mov $15, %rcx
...
nop
cmp $20161, %rax
lea addresses_UC_ht+0x9447, %rsi
nop
nop
add %rbp, %rbp
movups (%rsi), %xmm2
...
nop
cmp %rcx, %rcx
lea addresses_normal_ht+0x1e24b, %r14
nop
nop
nop
dec %rbp
...
nop
sub $50432, %rbp
lea addresses_D_ht+0x1e44b, %rsi
lea addresses_D_ht+0x14c4b, %rdi
nop
nop
nop
xor $52392, %r15
...
nop
inc %rax
lea addresses_normal_ht+0x2beb, %rsi
lea addresses_D_ht+0x157db, %rdi
clflush (%rsi)
nop
nop
nop
...
nop
sub %rsi, %rsi
lea addresses_UC_ht+0x644b, %rsi
clflush (%rsi)
nop
sub $21404, %r14
mov (%rsi), %di
nop
add %rbp, %rbp
lea addresses_UC_ht+0x2bbf, %rsi
lea addresses_normal_ht+0x984b, %rdi
nop
nop
add %rax, %rax
mov $65, %rcx
...
nop
add %rdi, %rdi
lea addresses_normal_ht+0x17d7b, %r9
nop
nop
nop
nop
...
nop
cmp %r14, %r14
lea addresses_UC_ht+0x5e4b, %rdi
nop
nop
nop
add %rcx, %rcx
...
{'OP': 'REPM', 'src': {'same': False, 'congruent': 6, 'type': 'addresses_normal_ht'}, 'dst': {'same': False, 'congruent': 2, 'type': 'addresses_WT_ht'}}
