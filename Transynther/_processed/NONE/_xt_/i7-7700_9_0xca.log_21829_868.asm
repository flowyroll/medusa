...
lea addresses_WC_ht+0x11082, %rdi
xor $61743, %r15
mov $55, %rcx
rep movsq
xor $34202, %rcx
lea addresses_UC_ht+0x1a08a, %rsi
clflush (%rsi)
nop
nop
nop
...
nop
dec %rcx
lea addresses_UC_ht+0x15b82, %r12
nop
nop
nop
lfence
...
nop
add %r8, %r8
lea addresses_WT_ht+0x1c85e, %r12
nop
nop
nop
nop
...
movl $0x61626364, (%r14)
and $2861, %rdi
lea addresses_D_ht+0x171ee, %rsi
lea addresses_WC_ht+0xf482, %rdi
nop
nop
nop
nop
...
<gen_prepare_buffer>
{'src': {'congruent': 7, 'same': False, 'type': 'addresses_UC_ht'}, 'OP': 'REPM', 'dst': {'congruent': 9, 'same': False, 'type': 'addresses_normal_ht'}}
{'src': {'congruent': 7, 'same': True, 'type': 'addresses_normal_ht'}, 'OP': 'REPM', 'dst': {'congruent': 8, 'same': False, 'type': 'addresses_WC_ht'}}
...
{'src': {'congruent': 0, 'AVXalign': True, 'same': False, 'size': 16, 'NT': False, 'type': 'addresses_WT_ht'}, 'OP': 'LOAD'}
