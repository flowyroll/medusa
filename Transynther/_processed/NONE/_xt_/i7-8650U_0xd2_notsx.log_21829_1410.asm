...
push %rdi
push %rsi
lea addresses_D_ht+0x164f4, %r10
nop
nop
add %rsi, %rsi
...
lea addresses_WC_ht+0x61e8, %rdi
nop
nop
nop
nop
...
nop
xor $36341, %rbx
lea addresses_normal_ht+0x1ccf4, %rbx
nop
nop
sub $65284, %rdi
mov (%rbx), %r11d
add %r11, %r11
lea addresses_WC_ht+0x9362, %rsi
lea addresses_UC_ht+0x1d0f4, %rdi
nop
nop
inc %r10
mov $49, %rcx
...
nop
add $58448, %r10
lea addresses_WT_ht+0x1068c, %rdi
clflush (%rdi)
nop
nop
and %rbx, %rbx
...
// REPMOV
lea addresses_PSE+0x174f4, %rsi
lea addresses_PSE+0x177f4, %rdi
nop
nop
nop
nop
...
{'OP': 'REPM', 'src': {'type': 'addresses_PSE', 'congruent': 9, 'same': False}, 'dst': {'type': 'addresses_PSE', 'congruent': 7, 'same': False}}
[Faulty Load]
...
{'OP': 'REPM', 'src': {'type': 'addresses_WC_ht', 'congruent': 1, 'same': True}, 'dst': {'type': 'addresses_UC_ht', 'congruent': 8, 'same': False}}
