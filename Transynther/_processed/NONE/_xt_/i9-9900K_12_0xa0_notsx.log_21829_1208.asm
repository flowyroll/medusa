...
nop
and %rax, %rax
lea addresses_WC_ht+0x13cf3, %r9
nop
nop
nop
add %r15, %r15
...
nop
and $14700, %rdx
lea addresses_A_ht+0xd4f3, %rsi
lea addresses_A_ht+0x1b1f1, %rdi
nop
nop
nop
add $34969, %r13
...
nop
sub $54332, %r13
lea addresses_D_ht+0x17d93, %rcx
and %r9, %r9
mov $0x6162636465666768, %r11
movq %r11, %xmm1
movups %xmm1, (%rcx)
...
{'OP': 'STOR', 'dst': {'type': 'addresses_PSE', 'AVXalign': True, 'size': 4, 'NT': True, 'same': False, 'congruent': 2}}
[Faulty Load]
