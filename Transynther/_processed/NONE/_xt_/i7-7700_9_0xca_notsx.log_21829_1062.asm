...
push %rbp
push %rsi
lea addresses_UC_ht+0xfdd9, %r11
nop
add $33019, %r9
mov (%r11), %bp
nop
nop
add $60202, %r10
lea addresses_A_ht+0x13ac9, %rbp
clflush (%rbp)
nop
nop
nop
...
nop
cmp %r9, %r9
lea addresses_WT_ht+0x10649, %rsi
nop
and $36382, %r13
mov (%rsi), %r11
nop
