...
nop
cmp %r10, %r10
lea addresses_normal_ht+0xa330, %rax
nop
nop
nop
nop
...
nop
add $53714, %rax
lea addresses_WT_ht+0x1d836, %rsi
lea addresses_D_ht+0x1476c, %rdi
nop
nop
nop
nop
...
nop
sub $23338, %rdi
lea addresses_normal_ht+0x1619c, %rdx
cmp $41444, %rbp
movw $0x6162, (%rdx)
nop
nop
add $45428, %rdi
lea addresses_WT_ht+0x1c11b, %rsi
lea addresses_normal_ht+0x1cc6c, %rdi
nop
nop
nop
nop
...
nop
cmp $57171, %r15
lea addresses_D_ht+0x1c29e, %r15
clflush (%r15)
nop
nop
nop
...
lea addresses_WT_ht+0x13dac, %rdi
clflush (%rsi)
nop
nop
and %r10, %r10
...
{'OP': 'REPM', 'src': {'same': True, 'type': 'addresses_WT_ht', 'congruent': 1}, 'dst': {'same': False, 'type': 'addresses_D_ht', 'congruent': 7}}
...
{'OP': 'REPM', 'src': {'same': False, 'type': 'addresses_D_ht', 'congruent': 3}, 'dst': {'same': True, 'type': 'addresses_WT_ht', 'congruent': 6}}
{'36': 21829}
