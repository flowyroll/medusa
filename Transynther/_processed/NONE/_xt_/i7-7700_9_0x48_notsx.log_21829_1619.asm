...
nop
and $21869, %rsi
lea addresses_WT_ht+0x168d5, %rsi
nop
nop
nop
and %r8, %r8
...
nop
and %rdi, %rdi
lea addresses_UC_ht+0x7955, %rsi
lea addresses_D_ht+0xf155, %rdi
clflush (%rdi)
nop
nop
nop
...
nop
and %r11, %r11
lea addresses_WC_ht+0x1df0b, %rsi
nop
add $56520, %r14
movw $0x6162, (%rsi)
dec %rdi
lea addresses_WT_ht+0x29cd, %r11
nop
nop
nop
nop
...
mov (%r11), %edi
add $38598, %r14
lea addresses_D_ht+0x14155, %r11
nop
nop
sub $12035, %r8
mov (%r11), %ecx
nop
cmp %r14, %r14
lea addresses_UC_ht+0xc955, %rsi
lea addresses_WT_ht+0xe355, %rdi
nop
nop
and $62591, %r9
mov $93, %rcx
...
nop
sub %r11, %r11
lea addresses_WT_ht+0x11955, %rdi
nop
nop
add $4816, %r11
...
nop
and $5088, %r8
lea addresses_WT_ht+0x2d55, %r11
and %r8, %r8
movl $0x61626364, (%r11)
nop
nop
...
nop
and $20091, %r10
lea addresses_UC_ht+0x9255, %rdi
nop
nop
nop
nop
...
{'dst': {'same': False, 'congruent': 11, 'type': 'addresses_D_ht'}, 'OP': 'REPM', 'src': {'same': False, 'congruent': 11, 'type': 'addresses_UC_ht'}}
...
{'dst': {'same': True, 'congruent': 7, 'type': 'addresses_WT_ht'}, 'OP': 'REPM', 'src': {'same': True, 'congruent': 9, 'type': 'addresses_UC_ht'}}
...
{'OP': 'LOAD', 'src': {'same': False, 'NT': True, 'AVXalign': False, 'size': 32, 'type': 'addresses_A_ht', 'congruent': 8}}
{'35': 21829}
