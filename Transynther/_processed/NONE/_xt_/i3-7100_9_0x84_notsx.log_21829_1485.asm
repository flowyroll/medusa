...
push %rdi
push %rsi
lea addresses_UC_ht+0xa514, %rbp
nop
add $44947, %r11
movb $0x61, (%rbp)
nop
add $23475, %rax
lea addresses_D_ht+0x7624, %r9
nop
sub $17370, %r15
vmovups (%r9), %ymm4
...
nop
inc %r10
lea addresses_WC_ht+0x1917c, %rsi
...
nop
dec %rdi
lea addresses_UC_ht+0x123d4, %rcx
nop
nop
nop
nop
...
nop
cmp %rax, %rax
lea addresses_UC_ht+0xbe04, %r11
nop
nop
nop
nop
...
nop
xor %r15, %r15
lea addresses_WT_ht+0x55c8, %rcx
nop
nop
nop
nop
...
nop
dec %r15
lea addresses_WC_ht+0x1424, %rsi
lea addresses_normal_ht+0x150b4, %rdi
clflush (%rdi)
nop
nop
nop
...
nop
sub %r9, %r9
lea addresses_normal_ht+0x1604, %rsi
nop
cmp %rax, %rax
movb $0x61, (%rsi)
nop
and $32329, %rcx
lea addresses_normal_ht+0x10e24, %r10
nop
nop
cmp %r13, %r13
vmovups (%r10), %ymm4
...
nop
add %rcx, %rcx
lea addresses_WC_ht+0x16fa4, %rbp
add %r13, %r13
...
{'src': {'type': 'addresses_WC_ht', 'congruent': 11, 'same': False}, 'dst': {'type': 'addresses_normal_ht', 'congruent': 4, 'same': True}, 'OP': 'REPM'}
