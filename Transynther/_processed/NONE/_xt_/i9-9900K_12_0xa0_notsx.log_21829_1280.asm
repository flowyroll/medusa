...
push %rdi
push %rsi
lea addresses_normal_ht+0xfbe0, %rsi
lea addresses_D_ht+0x97a8, %rdi
inc %rbp
mov $96, %rcx
rep movsb
nop
and %r8, %r8
lea addresses_WC_ht+0x1c8b8, %r13
nop
nop
nop
and $58990, %r11
...
nop
xor %r13, %r13
lea addresses_UC_ht+0x164de, %r8
nop
nop
nop
sub $55361, %r11
...
nop
inc %rbp
lea addresses_UC_ht+0x15cac, %rcx
nop
add %rdi, %rdi
movb $0x61, (%rcx)
and %rdi, %rdi
lea addresses_normal_ht+0x9db8, %rsi
lea addresses_normal_ht+0xe9b8, %rdi
nop
nop
and $31987, %r12
mov $38, %rcx
...
nop
cmp %rbp, %rbp
lea addresses_WC_ht+0x151b8, %rbp
nop
xor $36175, %rcx
...
nop
xor $50441, %rcx
lea addresses_A_ht+0x199b8, %rsi
lea addresses_normal_ht+0x19d98, %rdi
nop
nop
nop
nop
...
// Faulty Load
lea addresses_normal+0xd5b8, %rdi
nop
nop
xor $64097, %rcx
mov (%rdi), %edx
...
{'src': {'type': 'addresses_A_ht', 'congruent': 10, 'same': False}, 'OP': 'REPM', 'dst': {'type': 'addresses_normal_ht', 'congruent': 5, 'same': False}}
{'34': 21829}
