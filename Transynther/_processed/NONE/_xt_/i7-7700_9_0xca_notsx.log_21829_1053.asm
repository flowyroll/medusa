...
nop
and $17014, %r14
lea addresses_UC_ht+0x1ce37, %rsi
lea addresses_normal_ht+0xf237, %rdi
nop
nop
nop
nop
...
rep movsw
add $16742, %rsi
lea addresses_D_ht+0x1af37, %rsi
lea addresses_normal_ht+0x13637, %rdi
nop
nop
add %rdx, %rdx
mov $105, %rcx
...
nop
cmp %r14, %r14
lea addresses_WT_ht+0xf017, %r11
nop
nop
nop
and $12897, %r14
...
nop
cmp $49815, %rsi
lea addresses_WT_ht+0xa637, %rsi
nop
nop
nop
nop
...
nop
xor %r12, %r12
lea addresses_UC_ht+0x1ca2f, %r11
nop
nop
nop
nop
...
nop
add $29403, %rdi
lea addresses_D_ht+0x1b2f7, %r12
nop
nop
nop
cmp $57837, %r14
...
nop
xor %rcx, %rcx
lea addresses_WT_ht+0x6537, %rdx
nop
nop
nop
nop
