...
push %rdi
push %rsi
lea addresses_A_ht+0x1b077, %rsi
lea addresses_UC_ht+0xf3d7, %rdi
clflush (%rsi)
nop
nop
and $44205, %r15
...
nop
dec %rcx
lea addresses_UC_ht+0x1e477, %rsi
...
nop
add %r15, %r15
lea addresses_UC_ht+0x13b4d, %rdi
nop
nop
dec %r11
movups (%rdi), %xmm7
...
movb $0x61, (%r9)
and $270, %r14
lea addresses_UC_ht+0xa0b7, %rsi
nop
nop
nop
xor $17823, %r14
...
nop
sub %rsi, %rsi
lea addresses_A_ht+0x1b8b7, %rsi
lea addresses_WT_ht+0x117c7, %rdi
add %r9, %r9
mov $69, %rcx
rep movsl
nop
...
// Store
lea addresses_normal+0xe907, %rbp
nop
nop
sub %rsi, %rsi
movl $0x51525354, (%rbp)
...
<gen_prepare_buffer>
{'OP': 'REPM', 'src': {'same': False, 'congruent': 8, 'type': 'addresses_A_ht'}, 'dst': {'same': False, 'congruent': 4, 'type': 'addresses_UC_ht'}}
{'OP': 'STOR', 'dst': {'same': False, 'type': 'addresses_D_ht', 'NT': False, 'AVXalign': False, 'size': 32, 'congruent': 11}}
{'OP': 'REPM', 'src': {'same': False, 'congruent': 8, 'type': 'addresses_UC_ht'}, 'dst': {'same': False, 'congruent': 5, 'type': 'addresses_WT_ht'}}
