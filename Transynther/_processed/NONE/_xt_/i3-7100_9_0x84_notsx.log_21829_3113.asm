...
nop
xor %rbp, %rbp
lea addresses_A_ht+0x1e899, %r10
nop
nop
cmp %r11, %r11
...
nop
cmp %r11, %r11
lea addresses_UC_ht+0xf1a9, %rsi
lea addresses_WT_ht+0x72e9, %rdi
clflush (%rdi)
nop
nop
sub $20073, %r12
...
nop
add $63974, %r12
lea addresses_WC_ht+0x71d1, %rsi
nop
nop
nop
nop
...
nop
inc %rbp
lea addresses_A_ht+0x15055, %rsi
lea addresses_A_ht+0x1e8e9, %rdi
clflush (%rdi)
nop
nop
nop
...
// REPMOV
lea addresses_WT+0xe8a9, %rsi
lea addresses_PSE+0xb22f, %rdi
clflush (%rdi)
add %r14, %r14
mov $30, %rcx
rep movsw
...
{'src': {'type': 'addresses_WT', 'congruent': 8, 'same': False}, 'dst': {'type': 'addresses_PSE', 'congruent': 1, 'same': False}, 'OP': 'REPM'}
...
{'src': {'type': 'addresses_A_ht', 'congruent': 1, 'same': False}, 'dst': {'type': 'addresses_A_ht', 'congruent': 6, 'same': False}, 'OP': 'REPM'}
{'36': 21829}
