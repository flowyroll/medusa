...
push %rdx
push %rsi
lea addresses_UC_ht+0x11acc, %rsi
lea addresses_UC_ht+0x153b8, %rdi
nop
nop
nop
xor %rbp, %rbp
...
rep movsw
add %r11, %r11
lea addresses_WT_ht+0x1c078, %rsi
lea addresses_WT_ht+0x12414, %rdi
nop
nop
sub $2323, %r14
mov $114, %rcx
...
nop
inc %rdi
lea addresses_A_ht+0x15c14, %r14
nop
nop
nop
and %rax, %rax
...
nop
dec %r11
lea addresses_D_ht+0x8f3c, %rsi
lea addresses_normal_ht+0x7d20, %rdi
and %rdx, %rdx
mov $29, %rcx
rep movsb
nop
...
nop
xor %rcx, %rcx
lea addresses_normal_ht+0x5a14, %r11
nop
add %rcx, %rcx
movb $0x61, (%r11)
nop
...
<gen_prepare_buffer>
{'src': {'type': 'addresses_UC_ht', 'congruent': 0, 'same': True}, 'OP': 'REPM', 'dst': {'type': 'addresses_UC_ht', 'congruent': 0, 'same': False}}
{'src': {'type': 'addresses_WT_ht', 'congruent': 2, 'same': False}, 'OP': 'REPM', 'dst': {'type': 'addresses_WT_ht', 'congruent': 11, 'same': False}}
