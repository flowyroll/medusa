...
nop
dec %r11
lea addresses_UC_ht+0x1212b, %rsi
lea addresses_normal_ht+0x1092b, %rdi
nop
nop
nop
nop
...
nop
sub %rsi, %rsi
lea addresses_WC_ht+0xa92b, %rax
clflush (%rax)
nop
nop
nop
...
nop
cmp $35917, %rdx
lea addresses_normal_ht+0x6beb, %rdx
nop
nop
nop
add %r12, %r12
...
nop
cmp $44397, %r14
lea addresses_normal_ht+0x1436b, %r14
clflush (%r14)
sub $13061, %r12
movb (%r14), %al
nop
...
{'OP': 'REPM', 'src': {'same': False, 'congruent': 11, 'type': 'addresses_UC_ht'}, 'dst': {'same': False, 'congruent': 10, 'type': 'addresses_normal_ht'}}
