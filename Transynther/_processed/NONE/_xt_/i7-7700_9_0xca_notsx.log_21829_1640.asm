...
nop
xor %r8, %r8
lea addresses_D_ht+0x1a706, %rdi
and $28996, %r13
...
nop
and %r8, %r8
lea addresses_WT_ht+0xc3dd, %r13
sub %r12, %r12
movw $0x6162, (%r13)
nop
nop
...
nop
and %rax, %rax
lea addresses_A_ht+0x12f85, %rbp
nop
nop
sub %r13, %r13
vmovups (%rbp), %ymm3
...
nop
mfence
lea addresses_A_ht+0x12e05, %rsi
lea addresses_A_ht+0xfe05, %rdi
nop
nop
nop
nop
...
{'src': {'congruent': 9, 'same': False, 'type': 'addresses_A_ht'}, 'dst': {'congruent': 11, 'same': False, 'type': 'addresses_A_ht'}, 'OP': 'REPM'}
{'32': 21829}
