...
push %rdx
push %rsi
lea addresses_UC_ht+0x112ad, %rsi
nop
nop
nop
nop
...
// Store
lea addresses_normal+0xb405, %rdx
nop
nop
nop
sub %rsi, %rsi
...
// Store
lea addresses_normal+0x15d2d, %r13
nop
inc %rsi
...
// Faulty Load
lea addresses_normal+0xadad, %r13
nop
and $25773, %rdx
movb (%r13), %r10b
lea oracles, %r13
