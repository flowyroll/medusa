...
lea addresses_normal_ht+0x1702a, %rdi
nop
lfence
mov $54, %rcx
rep movsb
nop
add $31356, %r10
lea addresses_WC_ht+0x35a2, %r10
nop
inc %rbp
movb (%r10), %cl
nop
...
nop
and %rdi, %rdi
lea addresses_WC_ht+0x15a82, %rsi
lea addresses_UC_ht+0x101ca, %rdi
nop
nop
inc %r15
mov $115, %rcx
...
nop
sub $60326, %rcx
lea addresses_WC_ht+0x1a122, %rcx
dec %rsi
