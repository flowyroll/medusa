...
push %rdi
push %rsi
lea addresses_WT_ht+0xd363, %rax
nop
nop
add %r9, %r9
...
nop
add %r13, %r13
lea addresses_A_ht+0x1cadf, %rsi
lea addresses_A_ht+0x14763, %rdi
nop
nop
nop
nop
...
nop
sub $40651, %rcx
lea addresses_WT_ht+0xadc6, %rax
inc %r9
movb $0x61, (%rax)
and $849, %rax
lea addresses_WT_ht+0x1cfbb, %rsi
lea addresses_WC_ht+0x18b63, %rdi
nop
nop
and %rax, %rax
mov $33, %rcx
rep movsb
dec %rsi
lea addresses_normal_ht+0x1c295, %rsi
lea addresses_WC_ht+0x164cb, %rdi
clflush (%rdi)
nop
nop
nop
...
nop
add $26212, %rax
lea addresses_UC_ht+0x1df63, %rsi
lea addresses_WC_ht+0x2023, %rdi
nop
nop
nop
nop
...
nop
xor $28983, %r11
lea addresses_WT_ht+0x12763, %rax
nop
nop
nop
add %rcx, %rcx
...
{'src': {'NT': False, 'same': False, 'congruent': 6, 'type': 'addresses_WC', 'AVXalign': False, 'size': 16}, 'OP': 'LOAD'}
...
{'src': {'NT': False, 'same': False, 'congruent': 11, 'type': 'addresses_RW', 'AVXalign': False, 'size': 8}, 'OP': 'LOAD'}
[Faulty Load]
...
{'src': {'same': False, 'congruent': 0, 'type': 'addresses_normal_ht'}, 'OP': 'REPM', 'dst': {'same': False, 'congruent': 2, 'type': 'addresses_WC_ht'}}
{'src': {'same': False, 'congruent': 10, 'type': 'addresses_UC_ht'}, 'OP': 'REPM', 'dst': {'same': False, 'congruent': 6, 'type': 'addresses_WC_ht'}}
