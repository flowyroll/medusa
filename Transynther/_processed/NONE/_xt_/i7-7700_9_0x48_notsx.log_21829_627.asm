...
nop
xor $21377, %rsi
lea addresses_normal_ht+0x14dad, %rdi
nop
nop
nop
nop
...
nop
xor %rdx, %rdx
lea addresses_WC_ht+0x16af0, %r14
nop
nop
nop
sub $13361, %r8
...
nop
and %rdi, %rdi
lea addresses_WC_ht+0x3594, %rdx
nop
nop
and %r13, %r13
mov (%rdx), %r8d
sub $7238, %r14
lea addresses_normal_ht+0x18df7, %rsi
lea addresses_normal_ht+0x62c7, %rdi
nop
nop
nop
nop
...
nop
xor %r8, %r8
lea addresses_WC_ht+0x199f7, %rsi
lea addresses_WC_ht+0x2b3d, %rdi
clflush (%rdi)
dec %r9
mov $87, %rcx
rep movsw
...
{'OP': 'LOAD', 'src': {'same': False, 'NT': False, 'AVXalign': True, 'size': 1, 'type': 'addresses_WC_ht', 'congruent': 0}}
{'OP': 'LOAD', 'src': {'same': False, 'NT': False, 'AVXalign': False, 'size': 4, 'type': 'addresses_WC_ht', 'congruent': 0}}
{'dst': {'same': False, 'congruent': 4, 'type': 'addresses_normal_ht'}, 'OP': 'REPM', 'src': {'same': False, 'congruent': 10, 'type': 'addresses_normal_ht'}}
...
{'dst': {'same': False, 'congruent': 1, 'type': 'addresses_WC_ht'}, 'OP': 'REPM', 'src': {'same': False, 'congruent': 11, 'type': 'addresses_WC_ht'}}
{'39': 21829}
