...
push %rdx
push %rsi
lea addresses_normal_ht+0x1e2e6, %rsi
lea addresses_D_ht+0xb68e, %rdi
nop
nop
nop
nop
...
nop
sub %r8, %r8
lea addresses_A_ht+0x3626, %rsi
lea addresses_D_ht+0x1a196, %rdi
and %rdx, %rdx
mov $109, %rcx
rep movsl
nop
nop
cmp %rdi, %rdi
lea addresses_UC_ht+0x61e6, %rdx
nop
nop
and $49765, %r12
movw $0x6162, (%rdx)
...
nop
sub $44112, %rcx
lea addresses_normal_ht+0x7346, %rdx
nop
nop
cmp $27855, %rcx
movl $0x61626364, (%rdx)
nop
and %rdi, %rdi
lea addresses_WT_ht+0x1eee6, %rcx
xor $56471, %r12
mov $0x6162636465666768, %r8
movq %r8, %xmm4
movups %xmm4, (%rcx)
inc %r8
lea addresses_D_ht+0x1a524, %r12
nop
sub %rcx, %rcx
mov (%r12), %dx
nop
...
nop
sub %r13, %r13
lea addresses_WT_ht+0x1bde6, %rsi
nop
inc %r13
...
nop
cmp $64716, %rdi
lea addresses_UC_ht+0x9e4d, %rsi
lea addresses_WC_ht+0x18dd6, %rdi
nop
nop
lfence
mov $43, %rcx
...
{'src': {'congruent': 6, 'same': False, 'type': 'addresses_A_ht'}, 'dst': {'congruent': 0, 'same': False, 'type': 'addresses_D_ht'}, 'OP': 'REPM'}
...
{'dst': {'NT': False, 'AVXalign': False, 'size': 8, 'congruent': 11, 'same': True, 'type': 'addresses_WT_ht'}, 'OP': 'STOR'}
