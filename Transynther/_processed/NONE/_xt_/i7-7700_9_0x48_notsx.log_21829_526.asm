...
push %rdi
push %rsi
lea addresses_WC_ht+0x136de, %r13
nop
nop
nop
nop
...
vmovups %ymm0, (%r13)
and %r13, %r13
lea addresses_normal_ht+0xa85e, %rsi
lea addresses_UC_ht+0x169bc, %rdi
nop
nop
nop
and %r9, %r9
...
nop
and %rcx, %rcx
lea addresses_D_ht+0x1423e, %r13
nop
nop
nop
nop
...
nop
xor %rdi, %rdi
lea addresses_WC_ht+0xdc85, %rcx
add $45094, %rdi
mov (%rcx), %rsi
nop
nop
xor $14102, %r9
lea addresses_normal_ht+0x1d43e, %rsi
lea addresses_WC_ht+0x6a1e, %rdi
clflush (%rsi)
xor %r12, %r12
mov $60, %rcx
rep movsq
...
nop
inc %rcx
lea addresses_WT_ht+0x1203e, %r9
nop
and $22490, %rsi
mov (%r9), %r13d
nop
nop
sub %rcx, %rcx
lea addresses_WT_ht+0x15c3e, %rsi
lea addresses_UC_ht+0x45be, %rdi
nop
nop
nop
nop
...
nop
cmp $30341, %rsi
lea addresses_A_ht+0x1183e, %rbp
nop
nop
nop
nop
...
{'dst': {'same': False, 'congruent': 5, 'type': 'addresses_WC_ht'}, 'OP': 'REPM', 'src': {'same': False, 'congruent': 10, 'type': 'addresses_normal_ht'}}
{'OP': 'LOAD', 'src': {'same': False, 'NT': False, 'AVXalign': False, 'size': 4, 'type': 'addresses_WT_ht', 'congruent': 10}}
{'dst': {'same': False, 'congruent': 7, 'type': 'addresses_UC_ht'}, 'OP': 'REPM', 'src': {'same': False, 'congruent': 9, 'type': 'addresses_WT_ht'}}
