...
push %rdi
push %rsi
lea addresses_normal_ht+0x1ee1e, %rsi
lea addresses_WC_ht+0x1861e, %rdi
nop
nop
nop
nop
...
nop
cmp %rsi, %rsi
lea addresses_UC_ht+0xc9e0, %rsi
nop
nop
nop
nop
...
nop
inc %r12
lea addresses_D_ht+0x431e, %rsi
lea addresses_D_ht+0x36de, %rdi
and $16401, %rbp
mov $13, %rcx
rep movsl
nop
...
nop
and %rbx, %rbx
lea addresses_UC_ht+0x1370e, %rdi
nop
nop
nop
nop
...
nop
dec %r10
lea addresses_UC_ht+0xb31e, %r14
nop
nop
nop
nop
...
<gen_prepare_buffer>
{'dst': {'same': False, 'congruent': 8, 'type': 'addresses_WC_ht'}, 'OP': 'REPM', 'src': {'same': True, 'congruent': 8, 'type': 'addresses_normal_ht'}}
...
{'dst': {'same': False, 'congruent': 5, 'type': 'addresses_D_ht'}, 'OP': 'REPM', 'src': {'same': True, 'congruent': 11, 'type': 'addresses_D_ht'}}
