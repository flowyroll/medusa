...
push %rdx
push %rsi
lea addresses_WT_ht+0x1c991, %r14
nop
add $7415, %rcx
...
nop
cmp %rax, %rax
lea addresses_WT_ht+0x1d39d, %rsi
lea addresses_UC_ht+0x1131d, %rdi
nop
nop
sub %r11, %r11
mov $121, %rcx
rep movsw
xor $39727, %rdi
lea addresses_WC_ht+0x411d, %r10
nop
nop
nop
dec %rdi
...
nop
add %rdi, %rdi
lea addresses_WC_ht+0x1051d, %rsi
lea addresses_WC_ht+0x995d, %rdi
nop
nop
nop
nop
...
nop
xor %rax, %rax
lea addresses_A_ht+0x1db1d, %rsi
lea addresses_WC_ht+0x3e1d, %rdi
nop
nop
nop
xor $35726, %r14
...
nop
dec %rax
lea addresses_D_ht+0x1651d, %r14
nop
and %r11, %r11
movw $0x6162, (%r14)
nop
...
nop
xor %rax, %rax
lea addresses_UC_ht+0x10a1d, %rsi
lea addresses_D_ht+0xd99d, %rdi
clflush (%rdi)
nop
nop
nop
...
nop
inc %rcx
lea addresses_WC_ht+0x176d, %rsi
lea addresses_normal_ht+0x15d05, %rdi
nop
nop
nop
nop
