...
push %rdx
push %rsi
lea addresses_WT_ht+0xb76e, %rdx
nop
nop
nop
nop
...
nop
sub $45282, %r8
lea addresses_normal_ht+0x1bbb2, %r13
nop
nop
nop
dec %r11
...
nop
xor %rdx, %rdx
lea addresses_normal_ht+0x10aba, %rsi
lea addresses_A_ht+0x1b526, %rdi
nop
nop
sub %rdx, %rdx
mov $102, %rcx
...
nop
sub $17239, %r11
lea addresses_normal_ht+0xd326, %rsi
lea addresses_UC_ht+0xc0a6, %rdi
and %r9, %r9
mov $66, %rcx
rep movsw
nop
xor $45276, %r14
lea addresses_A_ht+0x11f26, %rdi
clflush (%rdi)
nop
nop
nop
...
nop
cmp $61110, %r14
lea addresses_WT_ht+0xd1e6, %rdi
nop
nop
nop
nop
...
// REPMOV
lea addresses_normal+0x1cde6, %rsi
lea addresses_WC+0x1d376, %rdi
add $30252, %r11
mov $71, %rcx
rep movsw
nop
...
// Store
lea addresses_normal+0x10726, %rcx
nop
nop
nop
nop
...
{'OP': 'REPM', 'src': {'same': False, 'congruent': 5, 'type': 'addresses_normal'}, 'dst': {'same': False, 'congruent': 4, 'type': 'addresses_WC'}}
{'OP': 'STOR', 'dst': {'same': False, 'type': 'addresses_normal', 'NT': False, 'AVXalign': True, 'size': 8, 'congruent': 9}}
{'OP': 'LOAD', 'src': {'same': False, 'type': 'addresses_WC', 'NT': False, 'AVXalign': False, 'size': 8, 'congruent': 6}}
[Faulty Load]
