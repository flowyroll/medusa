...
nop
cmp $38996, %r9
lea addresses_A_ht+0x2d8b, %rsi
lea addresses_WT_ht+0x136c9, %rdi
nop
nop
nop
nop
...
// Store
lea addresses_normal+0x1435b, %r15
nop
nop
nop
cmp %r12, %r12
...
{'OP': 'STOR', 'dst': {'type': 'addresses_normal', 'size': 8, 'AVXalign': False, 'NT': True, 'congruent': 3, 'same': False}}
[Faulty Load]
