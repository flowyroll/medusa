...
nop
sub %r9, %r9
lea addresses_WT_ht+0x12cfd, %rax
nop
nop
cmp %r11, %r11
movb (%rax), %r15b
...
nop
sub $61556, %r15
lea addresses_D_ht+0x1039d, %r15
mfence
movb $0x61, (%r15)
nop
nop
inc %rax
lea addresses_A_ht+0x70fd, %rbx
nop
nop
sub %rcx, %rcx
mov (%rbx), %r9d
...
nop
add %rsi, %rsi
lea addresses_normal_ht+0xe7fd, %rbx
nop
add $63336, %rcx
...
nop
and %rbx, %rbx
lea addresses_normal_ht+0x1c303, %rcx
nop
lfence
movb $0x61, (%rcx)
nop
...
nop
sub %rbx, %rbx
lea addresses_WT_ht+0x15bad, %rsi
lea addresses_A_ht+0x6dbd, %rdi
clflush (%rsi)
nop
nop
nop
...
nop
xor %r15, %r15
lea addresses_UC_ht+0x194bd, %rbx
nop
nop
nop
cmp %r15, %r15
...
nop
add $24801, %r15
lea addresses_WT_ht+0x6977, %r11
nop
nop
add %rsi, %rsi
mov (%r11), %r15
...
// REPMOV
lea addresses_RW+0x56bd, %rsi
lea addresses_normal+0x76bd, %rdi
dec %r13
mov $6, %rcx
rep movsw
nop
...
{'src': {'same': True, 'congruent': 0, 'type': 'addresses_RW'}, 'OP': 'REPM', 'dst': {'same': False, 'congruent': 9, 'type': 'addresses_normal'}}
...
{'OP': 'STOR', 'dst': {'NT': False, 'same': True, 'congruent': 1, 'type': 'addresses_normal_ht', 'AVXalign': False, 'size': 1}}
{'src': {'NT': False, 'same': False, 'congruent': 1, 'type': 'addresses_A_ht', 'AVXalign': False, 'size': 8}, 'OP': 'LOAD'}
{'src': {'same': True, 'congruent': 1, 'type': 'addresses_WT_ht'}, 'OP': 'REPM', 'dst': {'same': False, 'congruent': 5, 'type': 'addresses_A_ht'}}
