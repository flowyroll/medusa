...
push %rdi
push %rsi
lea addresses_normal_ht+0xfe65, %r9
nop
nop
nop
sub %rsi, %rsi
...
nop
add $16186, %r8
lea addresses_WT_ht+0xbce5, %rsi
inc %rax
mov (%rsi), %rcx
nop
nop
xor $7927, %rsi
lea addresses_normal_ht+0x13ae5, %rsi
nop
nop
and $59448, %r10
...
nop
and %rsi, %rsi
lea addresses_UC_ht+0x3015, %rsi
clflush (%rsi)
nop
cmp %r8, %r8
movl $0x61626364, (%rsi)
...
nop
cmp %r10, %r10
lea addresses_WC_ht+0xe65, %rsi
lea addresses_D_ht+0x17c65, %rdi
nop
nop
nop
add %r13, %r13
...
rep movsq
and $14249, %r13
lea addresses_WC_ht+0x1cc25, %rcx
nop
nop
nop
nop
