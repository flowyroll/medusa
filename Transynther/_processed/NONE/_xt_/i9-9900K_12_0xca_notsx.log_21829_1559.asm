...
push %rdi
push %rsi
lea addresses_WC_ht+0x1bc13, %r10
nop
nop
xor $52843, %r15
...
nop
add %r15, %r15
lea addresses_A_ht+0xc913, %rsi
lea addresses_D_ht+0x10713, %rdi
nop
nop
nop
nop
...
nop
cmp $46518, %rsi
lea addresses_normal_ht+0xc13, %r13
nop
nop
nop
cmp %rdi, %rdi
...
nop
inc %rcx
lea addresses_A_ht+0x73f5, %rsi
lea addresses_WT_ht+0xc013, %rdi
nop
and $53774, %r13
mov $35, %rcx
rep movsw
...
// REPMOV
lea addresses_RW+0x74a1, %rsi
lea addresses_WT+0xe43b, %rdi
nop
nop
nop
add $27718, %r8
...
{'OP': 'REPM', 'src': {'same': False, 'congruent': 1, 'type': 'addresses_A_ht'}, 'dst': {'same': False, 'congruent': 10, 'type': 'addresses_WT_ht'}}
{'36': 21829}
