...
nop
xor $54282, %rbx
lea addresses_WT_ht+0x17a3a, %rbp
nop
nop
nop
nop
...
nop
inc %rbx
lea addresses_A_ht+0xadba, %r12
xor $60932, %rdx
movb $0x61, (%r12)
nop
inc %rdi
lea addresses_WT_ht+0xf88e, %rsi
lea addresses_UC_ht+0x101a, %rdi
nop
cmp $3555, %r13
mov $0, %rcx
rep movsq
...
nop
xor $65514, %r8
lea addresses_WT_ht+0x18f3a, %rsi
lea addresses_UC_ht+0x11f9a, %rdi
nop
nop
nop
and $63157, %rbp
...
rep movsb
and %r12, %r12
lea addresses_UC_ht+0x15432, %rsi
nop
nop
nop
cmp $46628, %r8
...
nop
and $437, %rbx
lea addresses_WT_ht+0x1223a, %rcx
nop
inc %rdi
mov (%rcx), %ebp
nop
...
nop
sub %rcx, %rcx
lea addresses_WT_ht+0xb6a6, %rbx
nop
nop
nop
nop
...
nop
mfence
lea addresses_WC_ht+0x8f62, %rdi
nop
nop
cmp %rsi, %rsi
mov (%rdi), %r13
...
nop
xor %rbp, %rbp
lea addresses_A_ht+0x167fa, %rsi
lea addresses_UC_ht+0x14f7a, %rdi
nop
nop
nop
inc %rbp
...
nop
sub $58435, %rcx
lea addresses_normal_ht+0x1d7ba, %rcx
nop
nop
nop
nop
...
nop
dec %r12
lea addresses_normal_ht+0x7dba, %rsi
lea addresses_A_ht+0x6e2a, %rdi
nop
nop
nop
nop
...
{'src': {'same': True, 'congruent': 8, 'NT': False, 'type': 'addresses_WT_ht', 'size': 4, 'AVXalign': False}, 'OP': 'LOAD'}
{'OP': 'STOR', 'dst': {'same': False, 'congruent': 6, 'NT': False, 'type': 'addresses_A_ht', 'size': 1, 'AVXalign': False}}
{'src': {'type': 'addresses_WT_ht', 'congruent': 2, 'same': False}, 'OP': 'REPM', 'dst': {'type': 'addresses_UC_ht', 'congruent': 5, 'same': False}}
...
{'src': {'same': False, 'congruent': 1, 'NT': True, 'type': 'addresses_WT_ht', 'size': 32, 'AVXalign': False}, 'OP': 'LOAD'}
