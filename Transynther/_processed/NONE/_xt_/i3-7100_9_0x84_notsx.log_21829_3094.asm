...
push %rdi
push %rsi
lea addresses_WT_ht+0x1c4df, %r13
nop
nop
nop
nop
...
nop
xor %rax, %rax
lea addresses_A_ht+0x13137, %rsi
lea addresses_A_ht+0xffb7, %rdi
nop
nop
nop
sub %r12, %r12
...
lea addresses_normal_ht+0x8837, %rdi
nop
nop
xor %rbx, %rbx
mov $120, %rcx
...
nop
add %rax, %rax
lea addresses_D_ht+0xbab7, %rsi
lea addresses_A_ht+0x26e7, %rdi
nop
nop
nop
nop
...
rep movsb
sub %rsi, %rsi
lea addresses_UC_ht+0x15537, %rsi
lea addresses_UC_ht+0x18737, %rdi
nop
nop
nop
nop
...
nop
add %rsi, %rsi
lea addresses_WC_ht+0x14c37, %rcx
nop
add %r12, %r12
...
nop
add %r12, %r12
lea addresses_WC_ht+0x10577, %r13
xor $11382, %rbx
mov (%r13), %esi
nop
nop
nop
dec %rax
lea addresses_D_ht+0x5335, %rcx
clflush (%rcx)
sub $1959, %rsi
movb $0x61, (%rcx)
nop
inc %r13
lea addresses_D_ht+0x16537, %rbx
nop
add $26010, %r13
movw $0x6162, (%rbx)
nop
...
{'src': {'type': 'addresses_D_ht', 'congruent': 7, 'same': False}, 'dst': {'type': 'addresses_A_ht', 'congruent': 4, 'same': False}, 'OP': 'REPM'}
...
{'src': {'type': 'addresses_WC_ht', 'same': False, 'size': 4, 'congruent': 5, 'NT': True, 'AVXalign': False}, 'OP': 'LOAD'}
