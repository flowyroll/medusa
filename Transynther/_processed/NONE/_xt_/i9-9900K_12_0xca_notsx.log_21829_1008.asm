...
push %rdi
push %rsi
lea addresses_D_ht+0x18f69, %r10
nop
nop
nop
sub $23551, %rax
...
nop
and $11766, %r11
lea addresses_UC_ht+0x2f29, %rsi
lea addresses_WC_ht+0xe569, %rdi
nop
nop
nop
nop
...
nop
add %r11, %r11
lea addresses_WT_ht+0x12929, %rax
nop
nop
nop
nop
...
nop
add %rax, %rax
lea addresses_D_ht+0x19569, %rsi
lea addresses_D_ht+0x1d141, %rdi
nop
nop
nop
nop
...
vpextrq $0, %xmm0, %rax
add %rsi, %rsi
lea addresses_D_ht+0x10bf9, %rsi
lea addresses_A_ht+0x3a12, %rdi
nop
nop
nop
nop
...
rep movsq
and $8991, %r11
lea addresses_WC_ht+0x188e9, %rdi
nop
nop
nop
xor $8552, %rsi
...
movups %xmm7, (%rdi)
xor $11799, %r9
lea addresses_UC_ht+0xf0b1, %rsi
lea addresses_A_ht+0x5249, %rdi
nop
nop
nop
xor $39969, %rax
...
// Store
lea addresses_normal+0xb89, %r11
nop
nop
nop
nop
...
// Faulty Load
lea addresses_normal+0x14169, %rsi
nop
nop
nop
nop
...
<gen_prepare_buffer>
{'OP': 'STOR', 'dst': {'same': True, 'type': 'addresses_D_ht', 'NT': False, 'AVXalign': False, 'size': 16, 'congruent': 8}}
...
{'OP': 'REPM', 'src': {'same': False, 'congruent': 3, 'type': 'addresses_D_ht'}, 'dst': {'same': False, 'congruent': 0, 'type': 'addresses_A_ht'}}
