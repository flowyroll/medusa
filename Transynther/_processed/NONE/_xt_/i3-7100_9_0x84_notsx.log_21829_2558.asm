...
push %rdi
push %rsi
lea addresses_UC_ht+0x161f4, %rsi
lea addresses_UC_ht+0x15282, %rdi
nop
sub $2547, %r14
mov $108, %rcx
rep movsw
nop
xor %r8, %r8
lea addresses_D_ht+0x10e00, %r12
nop
nop
nop
cmp %r14, %r14
...
nop
cmp $431, %r14
lea addresses_D_ht+0x1f80, %rsi
lea addresses_WT_ht+0x17a68, %rdi
nop
nop
sub $38627, %rbp
mov $44, %rcx
...
nop
and $21055, %rbp
lea addresses_D_ht+0x1ab80, %rbp
nop
nop
nop
nop
...
mov (%rbp), %r12
sub $1314, %rdi
lea addresses_UC_ht+0x19aa0, %rsi
nop
cmp %r8, %r8
movb $0x61, (%rsi)
nop
...
nop
cmp %r14, %r14
lea addresses_WC_ht+0x16b88, %rsi
...
nop
sub $36166, %r12
lea addresses_D_ht+0x5d30, %rsi
lea addresses_UC_ht+0x16180, %rdi
nop
nop
sub $4449, %rbx
mov $41, %rcx
...
nop
and $20175, %rdi
lea addresses_WC_ht+0xb880, %r14
nop
nop
nop
xor $38451, %rbp
...
// Faulty Load
lea addresses_normal+0xd980, %r15
nop
nop
nop
and %rdi, %rdi
...
{'src': {'type': 'addresses_A', 'same': False, 'size': 1, 'congruent': 9, 'NT': False, 'AVXalign': False}, 'OP': 'LOAD'}
[Faulty Load]
