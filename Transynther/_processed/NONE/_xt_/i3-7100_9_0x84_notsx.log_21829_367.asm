...
lea addresses_D_ht+0x1127a, %rdi
nop
nop
nop
nop
...
nop
xor %r9, %r9
lea addresses_WC_ht+0xc07a, %rcx
nop
nop
nop
nop
...
nop
cmp %r14, %r14
lea addresses_A_ht+0x1467a, %rdi
add $11415, %rbp
movb (%rdi), %r14b
nop
nop
sub $11910, %rbp
lea addresses_WC_ht+0x1ef7a, %rbx
nop
nop
nop
add $39559, %r14
...
lea addresses_WT_ht+0x12e6a, %rdi
nop
nop
nop
cmp $24211, %rax
...
nop
add $28717, %rcx
lea addresses_WC_ht+0xc27a, %rcx
nop
dec %r9
...
nop
sub %rbx, %rbx
lea addresses_D_ht+0x1367a, %rsi
lea addresses_A_ht+0xa07a, %rdi
nop
nop
nop
xor %r14, %r14
...
<gen_prepare_buffer>
{'src': {'type': 'addresses_WT_ht', 'congruent': 2, 'same': False}, 'dst': {'type': 'addresses_D_ht', 'congruent': 10, 'same': True}, 'OP': 'REPM'}
