...
push %rdi
push %rsi
lea addresses_WT_ht+0x10ecc, %rsi
nop
nop
nop
nop
...
nop
sub %rbx, %rbx
lea addresses_normal_ht+0x10c4c, %rcx
nop
nop
nop
nop
...
nop
add $18625, %r10
lea addresses_WT_ht+0x6c4c, %r12
nop
nop
nop
cmp %r8, %r8
...
nop
cmp $9233, %r10
lea addresses_WT_ht+0x3b4c, %rsi
nop
nop
add %r8, %r8
movups (%rsi), %xmm1
...
nop
sub $61872, %rbx
lea addresses_normal_ht+0xa44c, %rcx
inc %rsi
mov $0x6162636465666768, %rbx
movq %rbx, %xmm5
vmovups %ymm5, (%rcx)
dec %r12
lea addresses_WC_ht+0xb32c, %rsi
lea addresses_WT_ht+0x6c27, %rdi
nop
nop
dec %r10
mov $80, %rcx
...
nop
xor $63324, %rbx
lea addresses_A_ht+0xfcb6, %rsi
lea addresses_A_ht+0x14c4c, %rdi
nop
nop
nop
nop
...
{'OP': 'STOR', 'dst': {'type': 'addresses_normal_ht', 'AVXalign': False, 'size': 32, 'NT': False, 'same': False, 'congruent': 8}}
{'src': {'type': 'addresses_WC_ht', 'congruent': 5, 'same': False}, 'OP': 'REPM', 'dst': {'type': 'addresses_WT_ht', 'congruent': 0, 'same': True}}
