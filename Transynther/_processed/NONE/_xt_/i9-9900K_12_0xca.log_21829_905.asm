...
push %rdi
push %rsi
lea addresses_WT_ht+0x2ddd, %rsi
inc %r8
movups (%rsi), %xmm1
vpextrq $1, %xmm1, %r13
cmp $62773, %rcx
lea addresses_D_ht+0x9403, %rbx
clflush (%rbx)
nop
nop
sub %r14, %r14
...
nop
xor %rsi, %rsi
lea addresses_normal_ht+0xe855, %rsi
lea addresses_WT_ht+0xe18d, %rdi
clflush (%rdi)
nop
nop
nop
...
rep movsl
mfence
lea addresses_A_ht+0x106dd, %r13
nop
nop
add $59355, %rcx
...
vmovups %ymm4, (%r13)
add %rsi, %rsi
lea addresses_WC_ht+0x8899, %rsi
lea addresses_D_ht+0x8fdd, %rdi
nop
add $43023, %r13
mov $89, %rcx
rep movsb
...
nop
add $6780, %r10
lea addresses_WC_ht+0x3c4d, %rsi
lea addresses_A_ht+0x106dd, %rdi
nop
nop
nop
sub %r14, %r14
...
nop
sub %rcx, %rcx
lea addresses_A_ht+0x115dd, %r13
dec %rdi
mov (%r13), %rbx
nop
nop
nop
and $38959, %rsi
lea addresses_WT_ht+0x1bddd, %r13
nop
nop
nop
nop
...
nop
and %rcx, %rcx
lea addresses_A_ht+0x135f5, %rsi
lea addresses_D_ht+0x1cfdd, %rdi
nop
nop
nop
nop
...
nop
inc %r13
lea addresses_WT_ht+0x19c5d, %r14
nop
nop
nop
nop
...
{'OP': 'LOAD', 'src': {'size': 2, 'NT': False, 'type': 'addresses_D_ht', 'same': False, 'AVXalign': True, 'congruent': 1}}
{'OP': 'REPM', 'src': {'same': False, 'type': 'addresses_normal_ht', 'congruent': 0}, 'dst': {'same': False, 'type': 'addresses_WT_ht', 'congruent': 4}}
{'OP': 'STOR', 'dst': {'size': 32, 'NT': False, 'type': 'addresses_A_ht', 'same': False, 'AVXalign': False, 'congruent': 6}}
{'OP': 'REPM', 'src': {'same': False, 'type': 'addresses_WC_ht', 'congruent': 2}, 'dst': {'same': False, 'type': 'addresses_D_ht', 'congruent': 9}}
