...
nop
sub %rdx, %rdx
lea addresses_WC_ht+0x6898, %rdi
nop
nop
nop
and $42587, %rbp
...
nop
cmp %r12, %r12
lea addresses_WT_ht+0x9e08, %rsi
...
rep movsb
and $3528, %r9
lea addresses_A_ht+0x1431c, %rsi
lea addresses_D_ht+0x18a08, %rdi
nop
and %rbp, %rbp
mov $49, %rcx
rep movsq
xor $50695, %rcx
lea addresses_WT_ht+0xfa08, %rdx
clflush (%rdx)
nop
nop
nop
...
movw $0x6162, (%rbp)
mfence
lea addresses_WC_ht+0x22a2, %rbp
add %rbx, %rbx
mov $0x6162636465666768, %rdi
movq %rdi, %xmm4
vmovups %ymm4, (%rbp)
sub $51036, %rsi
lea addresses_D_ht+0x1da08, %rbx
nop
nop
nop
nop
...
movb (%rbx), %r9b
dec %rsi
lea addresses_normal_ht+0x176a1, %rsi
lea addresses_normal_ht+0x10e88, %rdi
nop
inc %rdx
mov $75, %rcx
rep movsq
and %rcx, %rcx
lea addresses_A_ht+0x7052, %rdi
nop
nop
add $15444, %rsi
movw $0x6162, (%rdi)
...
nop
inc %r9
lea addresses_UC_ht+0x11e08, %rdi
add %rsi, %rsi
movl $0x61626364, (%rdi)
cmp $14264, %r9
pop %rsi
...
{'src': {'type': 'addresses_P', 'congruent': 7, 'same': False}, 'dst': {'type': 'addresses_UC', 'congruent': 4, 'same': False}, 'OP': 'REPM'}
[Faulty Load]
...
{'src': {'type': 'addresses_A_ht', 'congruent': 1, 'same': True}, 'dst': {'type': 'addresses_D_ht', 'congruent': 9, 'same': False}, 'OP': 'REPM'}
