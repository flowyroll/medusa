...
nop
dec %r12
lea addresses_UC_ht+0xabcc, %rax
nop
nop
nop
nop
...
nop
and $23538, %rdi
lea addresses_WC_ht+0x191ea, %rax
clflush (%rax)
inc %rsi
mov (%rax), %rbx
add $60051, %rax
lea addresses_WT_ht+0xe5d8, %rsi
nop
sub %rbp, %rbp
movb $0x61, (%rsi)
nop
...
nop
add $46230, %rcx
lea addresses_D_ht+0x139f8, %r12
nop
sub %rsi, %rsi
movb (%r12), %cl
and $27869, %rcx
lea addresses_D_ht+0x1e5f4, %rdi
add $22407, %rbp
...
nop
cmp $25927, %rdi
lea addresses_A_ht+0x11eb8, %rsi
nop
nop
xor %r12, %r12
movups (%rsi), %xmm5
...
nop
and $52235, %rdi
lea addresses_A_ht+0x13df8, %rsi
nop
nop
nop
inc %rdi
...
nop
and %rbx, %rbx
lea addresses_WC_ht+0x8288, %rdi
nop
nop
nop
nop
...
{'OP': 'STOR', 'dst': {'type': 'addresses_D_ht', 'AVXalign': False, 'congruent': 0, 'size': 16, 'same': True, 'NT': True}}
...
{'OP': 'LOAD', 'src': {'type': 'addresses_normal_ht', 'AVXalign': False, 'congruent': 1, 'size': 8, 'same': False, 'NT': True}}
