...
lea addresses_WC_ht+0x2576, %rdi
clflush (%rdi)
nop
nop
nop
...
rep movsl
add %r12, %r12
lea addresses_normal_ht+0xd6b6, %rsi
nop
nop
nop
nop
...
nop
add $45326, %rcx
lea addresses_UC_ht+0x5176, %rdi
nop
nop
nop
nop
...
nop
cmp %rdi, %rdi
lea addresses_UC_ht+0x5b76, %rcx
nop
nop
nop
xor $7259, %r11
...
nop
xor $54675, %rdi
lea addresses_WT_ht+0x7776, %rdi
nop
nop
nop
nop
...
nop
and %rsi, %rsi
lea addresses_normal_ht+0x155b0, %rbp
xor %rcx, %rcx
movb (%rbp), %r12b
add $58010, %r12
lea addresses_A_ht+0x15176, %rdi
nop
nop
cmp $31942, %rsi
movb $0x61, (%rdi)
nop
xor %rcx, %rcx
lea addresses_UC_ht+0xeb76, %r15
nop
nop
nop
nop
...
nop
add %r11, %r11
lea addresses_A_ht+0x15576, %r15
sub %rax, %rax
movups (%r15), %xmm4
vpextrq $0, %xmm4, %r11
cmp $18216, %rdi
lea addresses_D_ht+0x1b76, %rbp
nop
nop
xor $64438, %r11
movb $0x61, (%rbp)
...
nop
sub $40704, %r11
lea addresses_WT_ht+0xef76, %rsi
lea addresses_D_ht+0xf576, %rdi
nop
nop
nop
nop
...
<gen_prepare_buffer>
{'OP': 'STOR', 'dst': {'type': 'addresses_WT_ht', 'size': 32, 'AVXalign': False, 'NT': False, 'congruent': 0, 'same': True}}
...
{'OP': 'LOAD', 'src': {'type': 'addresses_normal_ht', 'size': 1, 'AVXalign': False, 'NT': False, 'congruent': 1, 'same': True}}
