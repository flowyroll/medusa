...
nop
lfence
lea addresses_UC_ht+0x3ec2, %rbp
nop
nop
cmp $33792, %r11
movups (%rbp), %xmm6
...
nop
lfence
lea addresses_normal_ht+0x7402, %rsi
lea addresses_UC_ht+0x8f5a, %rdi
clflush (%rsi)
nop
nop
nop
...
nop
inc %r9
lea addresses_D_ht+0x163c2, %rsi
lea addresses_UC_ht+0x2722, %rdi
nop
nop
nop
nop
...
nop
dec %rsi
lea addresses_D_ht+0x1b42, %rsi
lea addresses_UC_ht+0x1cd82, %rdi
nop
nop
nop
nop
...
nop
sub $28679, %rbp
lea addresses_WT_ht+0x10242, %rsi
lea addresses_D_ht+0x98f7, %rdi
nop
nop
nop
nop
...
nop
and %r9, %r9
lea addresses_UC_ht+0x140a2, %rcx
nop
nop
nop
add %r14, %r14
...
nop
xor $61051, %rdi
lea addresses_D_ht+0x1db02, %r10
nop
dec %r11
movl $0x61626364, (%r10)
nop
...
{'OP': 'LOAD', 'src': {'type': 'addresses_UC_ht', 'AVXalign': False, 'congruent': 7, 'size': 16, 'same': True, 'NT': False}}
...
{'OP': 'STOR', 'dst': {'type': 'addresses_UC_ht', 'AVXalign': False, 'congruent': 5, 'size': 16, 'same': True, 'NT': False}}
{'OP': 'STOR', 'dst': {'type': 'addresses_D_ht', 'AVXalign': False, 'congruent': 6, 'size': 4, 'same': True, 'NT': True}}
{'32': 21829}
