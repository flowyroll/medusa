...
push %rdi
push %rsi
lea addresses_WC_ht+0x6e4f, %rsi
lea addresses_D_ht+0xc2ef, %rdi
nop
nop
nop
nop
...
nop
inc %r12
lea addresses_UC_ht+0x19ef, %r13
nop
nop
nop
nop
...
nop
and %r13, %r13
lea addresses_UC_ht+0x1309, %rsi
nop
nop
nop
nop
...
nop
sub $51847, %r15
lea addresses_normal_ht+0x1321f, %r15
nop
nop
nop
nop
...
nop
xor $27797, %rsi
lea addresses_normal_ht+0x176f, %rcx
nop
nop
cmp $9224, %r13
movw $0x6162, (%rcx)
nop
lfence
lea addresses_WC_ht+0x1a19f, %rsi
lea addresses_WT_ht+0xf68f, %rdi
nop
nop
nop
nop
...
nop
add $655, %r15
lea addresses_normal_ht+0x1aadb, %r15
clflush (%r15)
nop
nop
nop
...
nop
dec %r12
lea addresses_UC_ht+0x13bef, %rcx
nop
nop
nop
nop
...
nop
inc %rsi
lea addresses_UC_ht+0x1e7bf, %r15
and $10018, %rcx
movl $0x61626364, (%r15)
nop
nop
xor %r15, %r15
lea addresses_WC_ht+0x9095, %r13
dec %rbp
mov (%r13), %r9w
nop
dec %r9
lea addresses_WT_ht+0x9e4f, %rcx
nop
nop
nop
add %r13, %r13
...
nop
cmp %rbp, %rbp
lea addresses_WT_ht+0x1d2f, %rbp
nop
nop
nop
nop
