...
push %rdi
push %rsi
lea addresses_A_ht+0x1b9f2, %rcx
nop
xor %r14, %r14
movw $0x6162, (%rcx)
inc %r14
lea addresses_D_ht+0xcd42, %rbx
clflush (%rbx)
nop
nop
xor $42214, %rcx
...
nop
sub %r14, %r14
lea addresses_WC_ht+0x3e54, %rsi
nop
nop
nop
cmp %r14, %r14
...
nop
cmp %rsi, %rsi
lea addresses_normal_ht+0x4862, %rsi
nop
nop
nop
sub $38924, %r8
...
// Faulty Load
lea addresses_normal+0x1ec62, %rbx
nop
nop
sub $41861, %rbp
movb (%rbx), %r15b
