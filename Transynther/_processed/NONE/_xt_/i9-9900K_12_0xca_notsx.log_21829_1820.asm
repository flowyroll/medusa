...
push %rdx
push %rsi
lea addresses_normal_ht+0x164e1, %r13
nop
nop
xor %rdx, %rdx
movl $0x61626364, (%r13)
...
nop
add $45179, %r12
lea addresses_WC_ht+0x16ee1, %rax
clflush (%rax)
sub $63519, %rbx
movb $0x61, (%rax)
nop
sub %rax, %rax
lea addresses_D_ht+0x59e1, %r13
add $37418, %rsi
movb $0x61, (%r13)
nop
nop
...
nop
add %rdx, %rdx
lea addresses_WT_ht+0xfce1, %rbx
nop
nop
nop
nop
...
nop
add %rbx, %rbx
lea addresses_normal_ht+0x197bc, %rbx
nop
nop
nop
nop
...
<gen_prepare_buffer>
{'OP': 'STOR', 'dst': {'same': False, 'type': 'addresses_normal_ht', 'NT': True, 'AVXalign': False, 'size': 4, 'congruent': 9}}
