...
push %rdi
push %rsi
lea addresses_UC_ht+0x1c118, %rbp
nop
sub %r9, %r9
movw $0x6162, (%rbp)
nop
...
nop
dec %r13
lea addresses_A_ht+0x8f18, %rsi
lea addresses_D_ht+0x2f18, %rdi
clflush (%rsi)
nop
nop
dec %r15
...
nop
cmp %rsi, %rsi
lea addresses_normal_ht+0x9118, %r13
nop
nop
nop
nop
...
mov (%r13), %ecx
sub %r14, %r14
lea addresses_normal_ht+0x4f94, %rsi
lea addresses_WC_ht+0x1d6a8, %rdi
nop
nop
xor %r15, %r15
mov $23, %rcx
rep movsb
cmp $22874, %r13
lea addresses_WT_ht+0x1a318, %rcx
nop
dec %r9
...
nop
sub $19630, %r14
lea addresses_A_ht+0x1d5e8, %r13
nop
sub %rdi, %rdi
...
nop
and $31768, %r14
lea addresses_WT_ht+0xc051, %rbp
nop
nop
nop
nop
...
vmovups %ymm4, (%r14)
sub $3773, %rdi
lea addresses_WC_ht+0x1e6b0, %rsi
lea addresses_normal_ht+0x2518, %rdi
nop
nop
nop
nop
...
nop
sub $31023, %r9
lea addresses_normal_ht+0x13718, %rcx
nop
add $26834, %r15
movups (%rcx), %xmm2
vpextrq $0, %xmm2, %r14
...
// Faulty Load
lea addresses_normal+0x10f18, %r10
nop
nop
nop
nop
...
{'src': {'same': False, 'congruent': 9, 'type': 'addresses_A_ht'}, 'OP': 'REPM', 'dst': {'same': True, 'congruent': 11, 'type': 'addresses_D_ht'}}
...
{'OP': 'STOR', 'dst': {'NT': False, 'same': True, 'congruent': 2, 'type': 'addresses_A_ht', 'AVXalign': False, 'size': 32}}
...
{'OP': 'STOR', 'dst': {'NT': True, 'same': False, 'congruent': 2, 'type': 'addresses_A_ht', 'AVXalign': False, 'size': 32}}
