...
nop
and %rsi, %rsi
lea addresses_A_ht+0x16761, %r13
cmp %r12, %r12
...
lea addresses_WC_ht+0x10f8c, %rdi
nop
xor %r14, %r14
mov $89, %rcx
rep movsb
...
nop
xor $19907, %r14
lea addresses_normal_ht+0xa12d, %r11
nop
nop
nop
and $60651, %r12
...
nop
dec %rcx
lea addresses_WT_ht+0x19d21, %rsi
lea addresses_WC_ht+0x3121, %rdi
nop
nop
sub $37921, %r9
mov $49, %rcx
...
nop
and %rdi, %rdi
lea addresses_UC_ht+0x9d21, %rcx
nop
nop
nop
xor $41241, %rsi
...
{'src': {'same': False, 'congruent': 5, 'type': 'addresses_A_ht'}, 'OP': 'REPM', 'dst': {'same': False, 'congruent': 0, 'type': 'addresses_WC_ht'}}
{'OP': 'STOR', 'dst': {'NT': False, 'same': False, 'congruent': 2, 'type': 'addresses_normal_ht', 'AVXalign': False, 'size': 2}}
{'src': {'same': False, 'congruent': 9, 'type': 'addresses_WT_ht'}, 'OP': 'REPM', 'dst': {'same': False, 'congruent': 10, 'type': 'addresses_WC_ht'}}
