...
nop
dec %rdi
lea addresses_normal_ht+0x827, %r11
nop
inc %r9
movb $0x61, (%r11)
sub $52390, %rcx
lea addresses_UC_ht+0x1e883, %r11
nop
nop
nop
nop
...
nop
and %r9, %r9
lea addresses_normal_ht+0x16adf, %r12
nop
nop
nop
nop
...
<gen_prepare_buffer>
{'src': {'congruent': 7, 'same': False, 'type': 'addresses_WT_ht'}, 'dst': {'congruent': 10, 'same': False, 'type': 'addresses_UC_ht'}, 'OP': 'REPM'}
{'src': {'NT': False, 'AVXalign': False, 'size': 8, 'congruent': 10, 'same': False, 'type': 'addresses_WC_ht'}, 'OP': 'LOAD'}
{'src': {'congruent': 6, 'same': False, 'type': 'addresses_WC_ht'}, 'dst': {'congruent': 10, 'same': False, 'type': 'addresses_UC_ht'}, 'OP': 'REPM'}
