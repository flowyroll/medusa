...
push %rdx
push %rsi
lea addresses_UC_ht+0x12a46, %rsi
lea addresses_UC_ht+0xaa46, %rdi
xor %rdx, %rdx
mov $56, %rcx
rep movsw
nop
...
nop
dec %r13
lea addresses_WT_ht+0x14066, %r8
nop
nop
nop
nop
...
movq %rdi, (%r8)
inc %rdx
lea addresses_UC_ht+0x1e2ba, %rsi
lea addresses_WC_ht+0xa9c6, %rdi
clflush (%rsi)
nop
nop
nop
...
nop
sub $60646, %rcx
lea addresses_UC_ht+0x1cc46, %rsi
lea addresses_normal_ht+0x1ac06, %rdi
and %rdx, %rdx
mov $85, %rcx
rep movsl
nop
...
nop
xor %r8, %r8
lea addresses_WC_ht+0x7f06, %rdx
nop
nop
sub %rdi, %rdi
mov (%rdx), %ebp
...
nop
xor %rsi, %rsi
lea addresses_normal_ht+0x1aa46, %r9
clflush (%r9)
nop
inc %rdx
mov (%r9), %si
...
nop
cmp $9701, %rsi
lea addresses_A_ht+0x11a46, %rcx
cmp %rsi, %rsi
mov (%rcx), %bp
nop
nop
nop
cmp %rdi, %rdi
lea addresses_normal_ht+0xf246, %rsi
lea addresses_UC_ht+0xb5c6, %rdi
nop
sub %r8, %r8
mov $106, %rcx
rep movsw
...
nop
and $52600, %rsi
lea addresses_A_ht+0x12106, %rsi
lea addresses_UC_ht+0x17ff6, %rdi
nop
add %rbp, %rbp
mov $42, %rcx
rep movsb
nop
inc %rdx
lea addresses_WT_ht+0x78d8, %rsi
lea addresses_WC_ht+0x110a9, %rdi
sub $60677, %rdx
mov $19, %rcx
rep movsb
nop
...
// Faulty Load
lea addresses_normal+0x12246, %rcx
nop
nop
nop
nop
...
{'OP': 'REPM', 'src': {'type': 'addresses_A_ht', 'congruent': 5, 'same': False}, 'dst': {'type': 'addresses_UC_ht', 'congruent': 3, 'same': True}}
