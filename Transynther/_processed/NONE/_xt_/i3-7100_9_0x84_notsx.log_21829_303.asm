...
push %rdi
push %rsi
lea addresses_UC_ht+0x8364, %rax
nop
nop
sub $47600, %rdi
movups (%rax), %xmm3
...
nop
add $52555, %r13
lea addresses_normal_ht+0x1d464, %rdi
nop
nop
nop
and $41400, %rcx
...
lea addresses_normal_ht+0x16ae4, %rdi
nop
nop
nop
nop
...
nop
and $53363, %rdi
lea addresses_UC_ht+0x193fc, %r13
add %r15, %r15
mov (%r13), %cx
nop
nop
and %rcx, %rcx
lea addresses_WC_ht+0xc09c, %r8
nop
nop
nop
dec %rax
...
nop
and %rdi, %rdi
lea addresses_D_ht+0x16064, %rdi
nop
nop
xor %rbp, %rbp
...
lea addresses_WT_ht+0x4a64, %rdi
nop
nop
nop
inc %r13
...
nop
and %r13, %r13
lea addresses_WT_ht+0x1ee64, %rsi
...
// Faulty Load
lea addresses_normal+0x14264, %r8
nop
nop
and $33975, %r13
vmovups (%r8), %ymm0
...
{'src': {'type': 'addresses_UC_ht', 'same': False, 'size': 2, 'congruent': 1, 'NT': True, 'AVXalign': True}, 'OP': 'LOAD'}
...
{'src': {'type': 'addresses_normal_ht', 'congruent': 6, 'same': False}, 'dst': {'type': 'addresses_WT_ht', 'congruent': 11, 'same': True}, 'OP': 'REPM'}
{'src': {'type': 'addresses_WT_ht', 'congruent': 7, 'same': False}, 'dst': {'type': 'addresses_UC_ht', 'congruent': 2, 'same': False}, 'OP': 'REPM'}
{'34': 21829}
