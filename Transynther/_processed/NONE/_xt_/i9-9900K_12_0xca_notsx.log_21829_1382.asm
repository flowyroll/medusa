...
push %rdx
push %rsi
lea addresses_A_ht+0x11957, %r14
nop
nop
inc %rcx
...
nop
sub $40880, %r14
lea addresses_UC_ht+0x1b54b, %rsi
lea addresses_WC_ht+0x1a117, %rdi
nop
nop
sub $46948, %rbp
mov $3, %rcx
...
nop
xor $23659, %r14
lea addresses_WT_ht+0xfb57, %rsi
lea addresses_WC_ht+0xc157, %rdi
nop
nop
nop
nop
...
nop
inc %r13
lea addresses_normal_ht+0x3b37, %rcx
nop
nop
cmp $30096, %rdx
...
nop
cmp %r14, %r14
lea addresses_WT_ht+0x5427, %r13
nop
nop
nop
nop
...
<gen_faulty_load>
[REF]
{'OP': 'LOAD', 'src': {'same': False, 'type': 'addresses_UC', 'NT': False, 'AVXalign': True, 'size': 2, 'congruent': 0}}
[Faulty Load]
