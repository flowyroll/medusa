...
push %rdx
push %rsi
lea addresses_A_ht+0x19c44, %r10
clflush (%r10)
nop
nop
nop
...
nop
and %r10, %r10
lea addresses_normal_ht+0x5964, %rsi
lea addresses_A_ht+0x16464, %rdi
clflush (%rdi)
nop
nop
nop
...
nop
mfence
lea addresses_WC_ht+0x5344, %rcx
nop
nop
nop
nop
...
nop
inc %rbx
lea addresses_normal_ht+0xee44, %rsi
nop
nop
nop
inc %r8
...
movups %xmm4, (%rsi)
and %rbx, %rbx
lea addresses_A_ht+0x12ac4, %rsi
lea addresses_WT_ht+0x1a544, %rdi
sub $64958, %rdx
mov $64, %rcx
rep movsl
nop
...
mov (%r9), %rbx
sub %rcx, %rcx
lea addresses_WT_ht+0x19f60, %rsi
nop
nop
nop
cmp $7537, %rdx
...
nop
xor %r8, %r8
lea addresses_D_ht+0x1c604, %rsi
lea addresses_A_ht+0xc844, %rdi
nop
sub $21490, %rdx
mov $88, %rcx
rep movsw
nop
and %rcx, %rcx
lea addresses_UC_ht+0x16804, %rbx
nop
nop
nop
nop
...
{'src': {'type': 'addresses_A_ht', 'congruent': 5, 'same': False}, 'OP': 'REPM', 'dst': {'type': 'addresses_WT_ht', 'congruent': 8, 'same': True}}
