...
nop
inc %r9
lea addresses_WT_ht+0x166e6, %rbp
clflush (%rbp)
inc %r12
movw $0x6162, (%rbp)
nop
dec %rbp
lea addresses_UC_ht+0x1c222, %rsi
lea addresses_UC_ht+0xfa22, %rdi
inc %r12
mov $37, %rcx
rep movsb
nop
...
nop
sub $45527, %r9
lea addresses_D_ht+0x6f62, %rsi
xor $3468, %rdi
movb $0x61, (%rsi)
nop
nop
cmp $50271, %rdi
lea addresses_normal_ht+0x93e2, %rsi
lea addresses_WC_ht+0x986, %rdi
nop
nop
nop
add %r11, %r11
...
nop
cmp $62096, %rdi
lea addresses_WT_ht+0x14a22, %r12
clflush (%r12)
nop
nop
nop
...
nop
sub $58544, %rcx
lea addresses_WC_ht+0x13ea, %r11
nop
nop
nop
nop
...
nop
and $52867, %rdx
lea addresses_normal_ht+0x4a22, %rsi
lea addresses_D_ht+0x127dd, %rdi
sub $61750, %rbp
mov $43, %rcx
rep movsl
nop
...
nop
sub $24593, %r15
lea addresses_WC_ht+0x10222, %rdi
nop
nop
nop
nop
...
nop
sub %rdx, %rdx
lea addresses_UC_ht+0x1e722, %rsi
lea addresses_UC_ht+0x1db4e, %rdi
clflush (%rsi)
nop
nop
nop
...
rep movsb
sub %r11, %r11
lea addresses_normal_ht+0x1b962, %rcx
nop
nop
inc %r12
movb (%rcx), %r15b
...
nop
and %r11, %r11
lea addresses_WT_ht+0x14c6d, %rdx
nop
mfence
movl $0x61626364, (%rdx)
nop
...
nop
and $32177, %rcx
lea addresses_normal_ht+0xad72, %rdi
nop
nop
nop
nop
...
nop
dec %rdi
lea addresses_UC_ht+0x17842, %rsi
lea addresses_UC_ht+0x14b22, %rdi
and $47134, %r15
mov $38, %rcx
rep movsw
nop
...
// Faulty Load
lea addresses_normal+0xca22, %r12
nop
nop
add %rdi, %rdi
mov (%r12), %si
...
{'OP': 'STOR', 'dst': {'same': False, 'congruent': 2, 'NT': True, 'type': 'addresses_D_ht', 'size': 1, 'AVXalign': True}}
{'src': {'type': 'addresses_normal_ht', 'congruent': 6, 'same': False}, 'OP': 'REPM', 'dst': {'type': 'addresses_WC_ht', 'congruent': 2, 'same': True}}
...
{'src': {'type': 'addresses_UC_ht', 'congruent': 6, 'same': False}, 'OP': 'REPM', 'dst': {'type': 'addresses_UC_ht', 'congruent': 1, 'same': False}}
