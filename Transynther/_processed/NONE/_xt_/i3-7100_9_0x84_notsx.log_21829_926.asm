...
nop
add %r12, %r12
lea addresses_WT_ht+0x15d37, %rsi
nop
nop
nop
nop
...
movups %xmm6, (%rsi)
cmp %rsi, %rsi
lea addresses_UC_ht+0x13437, %rbp
nop
nop
nop
nop
...
nop
and %rcx, %rcx
lea addresses_WC_ht+0x179eb, %rdi
nop
nop
nop
nop
...
nop
dec %rsi
lea addresses_normal_ht+0x92e7, %rsi
lea addresses_WC_ht+0xc7, %rdi
nop
nop
nop
nop
...
nop
dec %r10
lea addresses_D_ht+0x18337, %rbp
nop
nop
nop
add $17239, %rdi
