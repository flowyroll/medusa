...
push %rdi
push %rsi
lea addresses_D_ht+0x90fa, %rsi
lea addresses_D_ht+0x19bfe, %rdi
nop
xor %r14, %r14
mov $16, %rcx
rep movsl
nop
add $53535, %r10
lea addresses_D_ht+0x1c7fe, %rsi
lea addresses_normal_ht+0x11cfa, %rdi
nop
nop
nop
nop
...
nop
dec %rdi
lea addresses_D_ht+0x1dbfe, %rsi
...
rep movsb
dec %r11
lea addresses_UC_ht+0x113be, %r10
nop
inc %rsi
movw $0x6162, (%r10)
nop
...
movw $0x6162, (%r10)
sub $32337, %rdi
lea addresses_A_ht+0x1e70e, %rax
nop
nop
cmp %r11, %r11
movb $0x61, (%rax)
...
nop
cmp %r14, %r14
lea addresses_UC_ht+0x13efe, %rsi
lea addresses_normal_ht+0x173fe, %rdi
clflush (%rdi)
add $15400, %r13
mov $91, %rcx
rep movsw
nop
xor %r13, %r13
lea addresses_UC_ht+0xa21e, %r11
nop
nop
nop
nop
...
nop
xor %r10, %r10
lea addresses_D_ht+0x1b3fe, %r10
nop
nop
dec %rcx
mov (%r10), %r13w
...
nop
sub $42021, %r13
lea addresses_WT_ht+0x112ee, %rax
nop
nop
nop
cmp $49793, %rcx
...
nop
sub %rdi, %rdi
lea addresses_WC_ht+0xa08a, %rsi
lea addresses_A_ht+0xf5ee, %rdi
nop
nop
nop
nop
...
nop
dec %rax
lea addresses_UC_ht+0xb92a, %rax
nop
nop
sub $49769, %rdi
mov (%rax), %cx
...
<gen_prepare_buffer>
{'src': {'same': False, 'congruent': 1, 'type': 'addresses_D_ht'}, 'OP': 'REPM', 'dst': {'same': False, 'congruent': 11, 'type': 'addresses_D_ht'}}
{'src': {'same': False, 'congruent': 10, 'type': 'addresses_D_ht'}, 'OP': 'REPM', 'dst': {'same': True, 'congruent': 1, 'type': 'addresses_normal_ht'}}
...
{'src': {'same': False, 'congruent': 8, 'type': 'addresses_UC_ht'}, 'OP': 'REPM', 'dst': {'same': False, 'congruent': 11, 'type': 'addresses_normal_ht'}}
...
{'src': {'NT': False, 'same': True, 'congruent': 1, 'type': 'addresses_UC_ht', 'AVXalign': False, 'size': 2}, 'OP': 'LOAD'}
{'32': 21829}
