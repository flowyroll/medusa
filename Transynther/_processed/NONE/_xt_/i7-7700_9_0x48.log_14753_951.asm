...
push %rdi
push %rsi
lea addresses_D_ht+0x1e041, %rdi
clflush (%rdi)
nop
nop
nop
...
nop
add $64284, %rbp
lea addresses_WC_ht+0x17001, %r8
cmp %rcx, %rcx
mov $0x6162636465666768, %r9
movq %r9, %xmm6
vmovups %ymm6, (%r8)
add %r9, %r9
lea addresses_A_ht+0x81, %r11
inc %rcx
...
nop
add %r9, %r9
lea addresses_A_ht+0xce81, %rsi
lea addresses_D_ht+0x4bc1, %rdi
nop
nop
nop
nop
...
nop
cmp $44709, %r9
lea addresses_WT_ht+0x32f1, %rsi
lea addresses_D_ht+0x19599, %rdi
nop
add %rbp, %rbp
mov $114, %rcx
rep movsb
...
nop
cmp %rbp, %rbp
lea addresses_normal_ht+0x12e81, %rcx
nop
nop
cmp $22320, %r12
movw $0x6162, (%rcx)
...
{'OP': 'STOR', 'dst': {'type': 'addresses_NC', 'AVXalign': False, 'congruent': 1, 'size': 16, 'same': False, 'NT': True}}
...
{'OP': 'STOR', 'dst': {'type': 'addresses_PSE', 'AVXalign': True, 'congruent': 6, 'size': 32, 'same': False, 'NT': False}}
{'OP': 'STOR', 'dst': {'type': 'addresses_WT', 'AVXalign': True, 'congruent': 10, 'size': 16, 'same': False, 'NT': False}}
{'OP': 'LOAD', 'src': {'type': 'addresses_D', 'AVXalign': False, 'congruent': 2, 'size': 4, 'same': False, 'NT': False}}
[Faulty Load]
...
{'OP': 'STOR', 'dst': {'type': 'addresses_A_ht', 'AVXalign': True, 'congruent': 10, 'size': 32, 'same': False, 'NT': False}}
