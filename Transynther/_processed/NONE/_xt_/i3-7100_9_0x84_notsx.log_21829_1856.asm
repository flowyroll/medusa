...
nop
inc %r15
lea addresses_D_ht+0xd0af, %rsi
add $57880, %r9
movl $0x61626364, (%rsi)
nop
nop
sub %r15, %r15
lea addresses_normal_ht+0x4db3, %r8
nop
nop
xor %rbp, %rbp
...
nop
and $29223, %rsi
lea addresses_WC_ht+0x17db3, %rbp
nop
nop
cmp $11218, %r15
...
nop
sub %r9, %r9
lea addresses_WT_ht+0x16673, %rdx
clflush (%rdx)
nop
nop
nop
...
mov (%rdx), %bp
xor %rbp, %rbp
lea addresses_UC_ht+0x141b3, %rdx
nop
nop
nop
add $14224, %r14
...
movups %xmm7, (%rdx)
xor $13900, %r8
lea addresses_WT_ht+0x61b3, %rdx
and $30739, %r14
mov (%rdx), %r9d
nop
nop
add %rdx, %rdx
lea addresses_UC_ht+0x64b3, %r8
nop
and %r9, %r9
movb $0x61, (%r8)
nop
...
nop
cmp $20646, %r14
lea addresses_D_ht+0x15e4f, %rdx
nop
nop
nop
nop
...
{'dst': {'type': 'addresses_P', 'same': False, 'size': 8, 'congruent': 0, 'NT': False, 'AVXalign': False}, 'OP': 'STOR'}
{'src': {'type': 'addresses_NC', 'same': False, 'size': 8, 'congruent': 3, 'NT': False, 'AVXalign': False}, 'OP': 'LOAD'}
[Faulty Load]
