...
lea addresses_WT_ht+0xb5aa, %rdi
clflush (%rdi)
nop
nop
nop
...
nop
and $21046, %r13
lea addresses_UC_ht+0x16696, %rdi
nop
nop
nop
inc %r15
...
nop
xor $809, %rsi
lea addresses_WC_ht+0x12fa2, %rsi
lea addresses_A_ht+0x1b2aa, %rdi
nop
nop
nop
nop
...
nop
sub $19592, %rbx
lea addresses_A_ht+0x170ff, %r15
nop
nop
nop
inc %r9
...
// Faulty Load
lea addresses_normal+0x7aaa, %rbp
nop
nop
nop
cmp $52031, %rdi
