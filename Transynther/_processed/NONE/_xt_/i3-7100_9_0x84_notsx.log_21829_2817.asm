...
push %rdx
push %rsi
lea addresses_normal_ht+0x1ab46, %rdx
nop
nop
nop
nop
...
nop
add %r12, %r12
lea addresses_D_ht+0x18be0, %rsi
lea addresses_normal_ht+0x17a06, %rdi
nop
nop
nop
nop
...
nop
xor %rbp, %rbp
lea addresses_normal_ht+0x7fb9, %rsi
lea addresses_normal_ht+0x1646, %rdi
clflush (%rsi)
nop
nop
nop
...
nop
sub $38029, %rsi
lea addresses_UC_ht+0x5246, %rsi
lea addresses_A_ht+0x14e46, %rdi
nop
nop
nop
nop
...
nop
sub $39591, %rcx
lea addresses_WT_ht+0x13c46, %rdx
nop
nop
sub $10926, %r9
movb $0x61, (%rdx)
...
// Faulty Load
lea addresses_normal+0xc46, %rdi
clflush (%rdi)
nop
nop
xor $16446, %rsi
...
{'src': {'type': 'addresses_D_ht', 'congruent': 0, 'same': False}, 'dst': {'type': 'addresses_normal_ht', 'congruent': 6, 'same': False}, 'OP': 'REPM'}
...
{'dst': {'type': 'addresses_D_ht', 'same': True, 'size': 1, 'congruent': 7, 'NT': False, 'AVXalign': True}, 'OP': 'STOR'}
{'src': {'type': 'addresses_UC_ht', 'congruent': 6, 'same': False}, 'dst': {'type': 'addresses_A_ht', 'congruent': 6, 'same': False}, 'OP': 'REPM'}
{'dst': {'type': 'addresses_D_ht', 'same': False, 'size': 8, 'congruent': 2, 'NT': True, 'AVXalign': True}, 'OP': 'STOR'}
