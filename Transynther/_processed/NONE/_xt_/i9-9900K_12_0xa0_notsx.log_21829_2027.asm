...
push %rdi
push %rsi
lea addresses_D_ht+0x150ab, %rsi
lea addresses_WT_ht+0xe4eb, %rdi
and %r10, %r10
mov $25, %rcx
rep movsq
nop
...
nop
xor %r9, %r9
lea addresses_WC_ht+0x1e4ab, %rbp
add %r11, %r11
movb (%rbp), %r9b
nop
nop
...
nop
xor %rsi, %rsi
lea addresses_A_ht+0x15f2b, %rsi
and %rcx, %rcx
movb $0x61, (%rsi)
nop
nop
...
nop
and $2661, %rbp
lea addresses_D_ht+0x7bab, %rbp
xor $13594, %rsi
movups (%rbp), %xmm2
vpextrq $0, %xmm2, %r9
add %rbp, %rbp
lea addresses_UC_ht+0x1236b, %rcx
nop
nop
lfence
movb (%rcx), %r9b
...
{'src': {'type': 'addresses_UC', 'AVXalign': False, 'size': 4, 'NT': True, 'same': False, 'congruent': 1}, 'OP': 'LOAD'}
[Faulty Load]
...
{'src': {'type': 'addresses_A_ht', 'AVXalign': False, 'size': 32, 'NT': False, 'same': True, 'congruent': 7}, 'OP': 'LOAD'}
{'37': 21829}
