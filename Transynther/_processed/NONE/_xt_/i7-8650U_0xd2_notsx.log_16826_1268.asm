...
push %rdi
push %rsi
lea addresses_UC_ht+0x85d5, %r14
clflush (%r14)
nop
nop
nop
...
nop
inc %r13
lea addresses_WT_ht+0x1ab65, %rsi
lea addresses_WC_ht+0x125d5, %rdi
nop
nop
nop
nop
...
nop
cmp %r13, %r13
lea addresses_UC_ht+0x12fd5, %r11
nop
nop
nop
nop
...
// REPMOV
lea addresses_D+0xc7d5, %rsi
lea addresses_WT+0x1b9d5, %rdi
nop
sub $10902, %rbp
mov $111, %rcx
rep movsb
...
{'OP': 'REPM', 'src': {'type': 'addresses_D', 'congruent': 9, 'same': False}, 'dst': {'type': 'addresses_WT', 'congruent': 9, 'same': False}}
