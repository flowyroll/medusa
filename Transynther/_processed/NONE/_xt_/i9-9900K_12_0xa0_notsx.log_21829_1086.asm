...
push %rdi
push %rsi
lea addresses_A_ht+0x17641, %rsi
...
nop
sub $5212, %r13
lea addresses_normal_ht+0x49e9, %r13
nop
nop
nop
nop
...
// REPMOV
lea addresses_normal+0x182b9, %rsi
lea addresses_A+0xd0e9, %rdi
cmp %r10, %r10
mov $6, %rcx
rep movsq
nop
...
{'src': {'type': 'addresses_normal', 'congruent': 0, 'same': False}, 'OP': 'REPM', 'dst': {'type': 'addresses_A', 'congruent': 10, 'same': False}}
{'src': {'type': 'addresses_US', 'AVXalign': False, 'size': 2, 'NT': False, 'same': False, 'congruent': 11}, 'OP': 'LOAD'}
