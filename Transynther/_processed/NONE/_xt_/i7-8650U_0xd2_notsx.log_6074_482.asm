...
nop
xor %r11, %r11
lea addresses_A_ht+0x14ddf, %r15
and $29928, %r9
mov $0x6162636465666768, %rsi
movq %rsi, (%r15)
sub $7238, %r12
lea addresses_A_ht+0x18adf, %rsi
lea addresses_WT_ht+0x11fdf, %rdi
nop
nop
and $60839, %r11
mov $106, %rcx
rep movsl
add %rdi, %rdi
lea addresses_WC_ht+0x1eadf, %rcx
nop
dec %r15
mov (%rcx), %si
nop
nop
and $29970, %rcx
lea addresses_normal_ht+0xeedf, %rcx
nop
nop
nop
add $56929, %rdi
...
nop
cmp $20413, %r9
lea addresses_WT_ht+0x847e, %rsi
lea addresses_WT_ht+0x10d48, %rdi
nop
and $50248, %r15
mov $17, %rcx
rep movsq
...
nop
xor $26994, %r11
lea addresses_UC_ht+0x1e934, %rsi
lea addresses_A_ht+0x7fdf, %rdi
nop
nop
nop
add $39015, %r9
...
nop
add $59540, %r12
lea addresses_WT_ht+0x2a47, %r12
nop
add $10085, %rcx
movups (%r12), %xmm5
vpextrq $1, %xmm5, %r15
nop
and %rsi, %rsi
lea addresses_UC_ht+0x195df, %r15
nop
nop
nop
nop
...
nop
cmp %rcx, %rcx
lea addresses_normal_ht+0x8d31, %rdi
nop
nop
nop
nop
...
{'OP': 'STOR', 'dst': {'type': 'addresses_normal_ht', 'size': 2, 'AVXalign': False, 'NT': False, 'congruent': 1, 'same': True}}
{'35': 6074}
