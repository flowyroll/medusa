...
push %rdi
push %rsi
lea addresses_WT_ht+0x14668, %rax
nop
nop
nop
nop
...
vpextrq $0, %xmm0, %r11
xor %r9, %r9
lea addresses_D_ht+0x3062, %rdi
nop
nop
sub %rbp, %rbp
mov (%rdi), %r10
mfence
lea addresses_D_ht+0x4362, %r9
nop
nop
nop
nop
...
mov (%r9), %rdi
inc %rsi
lea addresses_WC_ht+0x16562, %r10
nop
inc %r11
...
nop
mfence
lea addresses_D_ht+0x11762, %rsi
lea addresses_A_ht+0x5d62, %rdi
nop
nop
sub $39416, %rbp
mov $126, %rcx
...
nop
and $50221, %rdi
lea addresses_normal_ht+0x7362, %rdi
cmp $52318, %r11
mov (%rdi), %cx
nop
nop
nop
dec %rdi
lea addresses_WC_ht+0xdd82, %rcx
nop
and $20173, %rax
movl $0x61626364, (%rcx)
nop
...
nop
xor $728, %rsi
lea addresses_A_ht+0x12362, %rdi
nop
nop
nop
xor $58390, %r11
...
// Faulty Load
lea addresses_normal+0xef62, %rdi
nop
add %r8, %r8
mov (%rdi), %dx
lea oracles, %rax
...
<gen_prepare_buffer>
{'dst': {'type': 'addresses_WT_ht', 'same': False, 'size': 32, 'congruent': 1, 'NT': False, 'AVXalign': True}, 'OP': 'STOR'}
