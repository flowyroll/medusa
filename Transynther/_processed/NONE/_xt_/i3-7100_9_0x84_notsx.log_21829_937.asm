...
nop
dec %r11
lea addresses_WC_ht+0xf5a0, %rsi
lea addresses_D_ht+0x10ee0, %rdi
nop
cmp %rbp, %rbp
mov $88, %rcx
rep movsb
add %rcx, %rcx
lea addresses_WT_ht+0x17e60, %rsi
...
rep movsl
xor $13861, %rcx
lea addresses_normal_ht+0x1b21c, %rcx
nop
nop
nop
nop
...
nop
sub $38161, %rsi
lea addresses_UC_ht+0x8733, %rsi
lea addresses_normal_ht+0x1a508, %rdi
nop
nop
nop
nop
...
nop
and %rsi, %rsi
lea addresses_normal_ht+0x1b510, %r11
nop
nop
nop
nop
...
nop
xor $55265, %rax
lea addresses_WC_ht+0xf460, %r12
nop
nop
nop
nop
...
{'src': {'type': 'addresses_WT_ht', 'congruent': 7, 'same': False}, 'dst': {'type': 'addresses_D_ht', 'congruent': 2, 'same': False}, 'OP': 'REPM'}
{'dst': {'type': 'addresses_normal_ht', 'same': False, 'size': 32, 'congruent': 1, 'NT': False, 'AVXalign': False}, 'OP': 'STOR'}
{'src': {'type': 'addresses_UC_ht', 'congruent': 0, 'same': False}, 'dst': {'type': 'addresses_normal_ht', 'congruent': 1, 'same': False}, 'OP': 'REPM'}
