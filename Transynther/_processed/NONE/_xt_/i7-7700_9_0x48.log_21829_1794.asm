...
nop
xor %rcx, %rcx
lea addresses_WC_ht+0x1373c, %r14
lfence
vmovups (%r14), %ymm3
...
nop
add $38595, %rax
lea addresses_normal_ht+0x1153c, %rax
nop
nop
nop
nop
...
nop
add $56336, %rdx
lea addresses_normal_ht+0x131dc, %rsi
lea addresses_UC_ht+0x13a0c, %rdi
nop
nop
nop
nop
...
{'OP': 'LOAD', 'src': {'type': 'addresses_A_ht', 'AVXalign': True, 'congruent': 3, 'size': 2, 'same': False, 'NT': False}}
