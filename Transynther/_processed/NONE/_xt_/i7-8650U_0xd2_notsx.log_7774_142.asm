...
nop
and $15781, %r12
lea addresses_D_ht+0x1c770, %rdx
nop
nop
nop
and $47311, %r11
...
nop
sub $29662, %r15
lea addresses_UC_ht+0x1b770, %rsi
nop
nop
nop
nop
...
nop
add %r11, %r11
lea addresses_A_ht+0x1ef30, %rsi
lea addresses_WC_ht+0x1bb78, %rdi
clflush (%rdi)
nop
nop
sub %r8, %r8
...
nop
xor %r11, %r11
lea addresses_D_ht+0x13168, %r15
nop
nop
nop
nop
...
movq %r11, (%r15)
cmp %rsi, %rsi
lea addresses_D_ht+0x16770, %rsi
lea addresses_normal_ht+0x430, %rdi
nop
nop
dec %r8
mov $3, %rcx
...
nop
cmp %r15, %r15
lea addresses_WC_ht+0xbc70, %rdx
clflush (%rdx)
nop
and $17436, %r11
mov (%rdx), %edi
...
nop
cmp %r11, %r11
lea addresses_UC_ht+0xd570, %rsi
lea addresses_WT_ht+0x6000, %rdi
nop
nop
nop
nop
...
nop
cmp %rdx, %rdx
lea addresses_D_ht+0x9208, %rsi
lea addresses_UC_ht+0x19330, %rdi
sub $14553, %r15
mov $93, %rcx
rep movsq
xor $24401, %rcx
lea addresses_WC_ht+0x3370, %r8
nop
nop
nop
nop
...
nop
add $62944, %rsi
lea addresses_UC_ht+0x6822, %rdx
nop
nop
nop
nop
...
// Faulty Load
lea addresses_normal+0x7f70, %r13
nop
sub %r11, %r11
movups (%r13), %xmm0
vpextrq $0, %xmm0, %rdi
...
{'OP': 'STOR', 'dst': {'type': 'addresses_D_ht', 'size': 8, 'AVXalign': True, 'NT': False, 'congruent': 3, 'same': False}}
{'OP': 'REPM', 'src': {'type': 'addresses_D_ht', 'congruent': 10, 'same': False}, 'dst': {'type': 'addresses_normal_ht', 'congruent': 5, 'same': False}}
...
{'OP': 'LOAD', 'src': {'type': 'addresses_WC_ht', 'size': 2, 'AVXalign': True, 'NT': False, 'congruent': 10, 'same': False}}
