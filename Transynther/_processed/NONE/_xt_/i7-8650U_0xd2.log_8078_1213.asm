...
movq %rdi, (%r12)
cmp %rbp, %rbp
lea addresses_normal_ht+0x1e257, %rsi
lea addresses_WC_ht+0x8257, %rdi
nop
nop
nop
xor $30357, %rbp
...
nop
sub $60468, %rcx
lea addresses_normal_ht+0x6457, %rbp
add $1139, %rdi
mov (%rbp), %rbx
nop
xor $43319, %rsi
lea addresses_normal_ht+0x3c57, %rcx
nop
nop
nop
nop
...
movw $0x6162, (%rcx)
dec %rbx
lea addresses_D_ht+0x5e57, %rsi
lea addresses_WC_ht+0x16957, %rdi
clflush (%rsi)
add %rdx, %rdx
mov $41, %rcx
rep movsb
...
nop
cmp $18583, %r10
lea addresses_UC_ht+0x1b357, %rdx
nop
add %rdi, %rdi
movw $0x6162, (%rdx)
nop
...
{'OP': 'LOAD', 'src': {'type': 'addresses_normal_ht', 'size': 8, 'AVXalign': False, 'NT': True, 'congruent': 9, 'same': False}}
