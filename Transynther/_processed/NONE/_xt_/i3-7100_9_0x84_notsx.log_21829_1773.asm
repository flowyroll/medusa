...
push %rdi
push %rsi
lea addresses_D_ht+0x192cd, %rsi
lea addresses_WC_ht+0x11dc1, %rdi
nop
cmp $36492, %r11
mov $70, %rcx
rep movsb
...
lea addresses_normal_ht+0x13a4d, %rdi
nop
nop
nop
cmp %rbp, %rbp
...
rep movsl
sub $6587, %r11
lea addresses_A_ht+0x19d4d, %r14
nop
nop
nop
nop
