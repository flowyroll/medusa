...
nop
add $698, %rdi
lea addresses_normal_ht+0x15d8d, %rsi
nop
nop
cmp %rbp, %rbp
...
nop
cmp $14938, %r14
lea addresses_WC_ht+0xe46d, %r15
sub $40054, %r9
mov (%r15), %bp
nop
nop
nop
sub $52362, %rbp
lea addresses_normal_ht+0x4f4d, %rsi
lea addresses_normal_ht+0x9e8d, %rdi
nop
nop
nop
nop
...
// REPMOV
lea addresses_WC+0xc48d, %rsi
lea addresses_normal+0x8c8d, %rdi
clflush (%rdi)
nop
nop
nop
...
// Faulty Load
lea addresses_normal+0x528d, %rsi
nop
nop
lfence
mov (%rsi), %ax
...
{'OP': 'REPM', 'src': {'type': 'addresses_WC', 'congruent': 7, 'same': False}, 'dst': {'type': 'addresses_normal', 'congruent': 9, 'same': False}}
[Faulty Load]
...
{'OP': 'REPM', 'src': {'type': 'addresses_normal_ht', 'congruent': 4, 'same': True}, 'dst': {'type': 'addresses_normal_ht', 'congruent': 9, 'same': True}}
