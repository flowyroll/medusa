...
push %rdi
push %rsi
lea addresses_UC_ht+0x1ebea, %r11
nop
nop
nop
nop
...
nop
and %r8, %r8
lea addresses_normal_ht+0x915a, %rax
nop
nop
nop
nop
...
nop
add %r11, %r11
lea addresses_A_ht+0x10c5a, %rbx
cmp %rdi, %rdi
...
nop
and %r8, %r8
lea addresses_WC_ht+0x16a82, %rsi
lea addresses_A_ht+0x781a, %rdi
dec %r8
mov $14, %rcx
rep movsb
add %rax, %rax
lea addresses_WC_ht+0x455a, %rsi
...
nop
dec %r8
lea addresses_D_ht+0x16aa2, %r14
nop
nop
nop
nop
...
nop
add %r14, %r14
lea addresses_UC_ht+0xa5ba, %rsi
lea addresses_D_ht+0x1695a, %rdi
dec %rax
mov $103, %rcx
rep movsl
nop
...
nop
xor %rax, %rax
lea addresses_WT_ht+0xd55a, %rcx
nop
cmp $2124, %rdi
mov (%rcx), %r13d
nop
...
{'dst': {'NT': False, 'AVXalign': True, 'size': 2, 'congruent': 6, 'same': False, 'type': 'addresses_P'}, 'OP': 'STOR'}
...
{'src': {'NT': False, 'AVXalign': True, 'size': 32, 'congruent': 3, 'same': False, 'type': 'addresses_A_ht'}, 'OP': 'LOAD'}
{'src': {'congruent': 3, 'same': False, 'type': 'addresses_WC_ht'}, 'dst': {'congruent': 2, 'same': False, 'type': 'addresses_A_ht'}, 'OP': 'REPM'}
{'src': {'congruent': 11, 'same': False, 'type': 'addresses_WC_ht'}, 'dst': {'congruent': 1, 'same': True, 'type': 'addresses_normal_ht'}, 'OP': 'REPM'}
...
{'src': {'NT': False, 'AVXalign': True, 'size': 1, 'congruent': 8, 'same': False, 'type': 'addresses_A_ht'}, 'OP': 'LOAD'}
