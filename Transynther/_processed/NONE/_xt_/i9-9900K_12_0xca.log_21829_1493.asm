...
lea addresses_normal_ht+0x1b41e, %rdi
nop
sub %rbp, %rbp
mov $56, %rcx
rep movsb
...
nop
inc %rcx
lea addresses_WC_ht+0x1c7c6, %r8
nop
nop
nop
nop
...
movaps %xmm3, (%r8)
dec %rsi
lea addresses_UC_ht+0x14076, %rbp
nop
and %rsi, %rsi
movups (%rbp), %xmm3
vpextrq $1, %xmm3, %r8
...
nop
and %r14, %r14
lea addresses_UC_ht+0x544e, %rsi
...
nop
xor %rbx, %rbx
lea addresses_WC_ht+0x1e5c6, %rdi
nop
nop
nop
sub $30072, %rbx
...
movups %xmm1, (%rdi)
add $28218, %rdi
lea addresses_WC_ht+0xed0e, %rsi
clflush (%rsi)
nop
nop
nop
...
// Faulty Load
lea addresses_normal+0x1e7c6, %r15
clflush (%r15)
nop
xor $51242, %rcx
mov (%r15), %r11d
...
{'OP': 'STOR', 'dst': {'size': 2, 'NT': True, 'type': 'addresses_WC', 'same': False, 'AVXalign': False, 'congruent': 4}}
...
{'OP': 'REPM', 'src': {'same': False, 'type': 'addresses_WT_ht', 'congruent': 11}, 'dst': {'same': True, 'type': 'addresses_normal_ht', 'congruent': 3}}
...
{'OP': 'REPM', 'src': {'same': False, 'type': 'addresses_UC_ht', 'congruent': 3}, 'dst': {'same': False, 'type': 'addresses_WC_ht', 'congruent': 7}}
