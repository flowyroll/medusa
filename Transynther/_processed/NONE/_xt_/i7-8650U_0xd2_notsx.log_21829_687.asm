...
nop
and $31997, %r10
lea addresses_D_ht+0xb50b, %rsi
lea addresses_D_ht+0x5f0b, %rdi
nop
nop
nop
add %rdx, %rdx
...
nop
xor %r8, %r8
lea addresses_WT_ht+0xb4bf, %rsi
lea addresses_UC_ht+0x1030b, %rdi
inc %rdx
mov $37, %rcx
rep movsq
nop
...
nop
and $47882, %r15
lea addresses_WC_ht+0x10aa1, %rsi
lea addresses_WT_ht+0x17777, %rdi
clflush (%rsi)
nop
nop
nop
...
rep movsw
dec %rdi
lea addresses_WC_ht+0x928b, %r10
sub $26114, %r11
movb $0x61, (%r10)
nop
nop
...
{'OP': 'REPM', 'src': {'type': 'addresses_D_ht', 'congruent': 8, 'same': False}, 'dst': {'type': 'addresses_D_ht', 'congruent': 9, 'same': True}}
