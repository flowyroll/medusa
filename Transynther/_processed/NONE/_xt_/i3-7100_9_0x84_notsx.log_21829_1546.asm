...
push %rdi
push %rsi
lea addresses_WC_ht+0x16ef6, %rsi
lea addresses_A_ht+0x6376, %rdi
clflush (%rdi)
add %r10, %r10
mov $125, %rcx
rep movsq
...
nop
and %r8, %r8
lea addresses_normal_ht+0xcc6, %r14
nop
nop
add $11524, %r13
...
nop
and %r14, %r14
lea addresses_A_ht+0x19ef6, %rsi
lea addresses_WC_ht+0x124f6, %rdi
nop
nop
sub %r8, %r8
mov $113, %rcx
...
nop
add %r14, %r14
lea addresses_normal_ht+0x1908d, %rsi
lea addresses_WC_ht+0x18f6, %rdi
nop
nop
nop
nop
...
nop
xor $38587, %rcx
lea addresses_WC_ht+0x1bcf6, %r15
nop
nop
nop
sub %r8, %r8
...
nop
sub %r15, %r15
lea addresses_A_ht+0xf40a, %rsi
lea addresses_D_ht+0x1d4f6, %rdi
nop
nop
nop
nop
...
nop
dec %r10
lea addresses_WT_ht+0xa9b6, %rcx
clflush (%rcx)
nop
and $33688, %rsi
mov (%rcx), %r14
cmp %r8, %r8
lea addresses_A_ht+0xf256, %rsi
lea addresses_D_ht+0xa1f6, %rdi
nop
sub %r15, %r15
mov $92, %rcx
rep movsw
cmp %r14, %r14
lea addresses_normal_ht+0x54c6, %rsi
lea addresses_UC_ht+0x1e4f6, %rdi
nop
nop
nop
nop
...
nop
dec %r8
lea addresses_UC_ht+0x1b0f6, %r13
nop
nop
nop
nop
...
{'dst': {'type': 'addresses_PSE', 'same': False, 'size': 8, 'congruent': 3, 'NT': True, 'AVXalign': False}, 'OP': 'STOR'}
...
<gen_prepare_buffer>
{'src': {'type': 'addresses_WC_ht', 'congruent': 8, 'same': True}, 'dst': {'type': 'addresses_A_ht', 'congruent': 7, 'same': False}, 'OP': 'REPM'}
{'dst': {'type': 'addresses_normal_ht', 'same': False, 'size': 16, 'congruent': 4, 'NT': False, 'AVXalign': False}, 'OP': 'STOR'}
{'src': {'type': 'addresses_A_ht', 'congruent': 8, 'same': False}, 'dst': {'type': 'addresses_WC_ht', 'congruent': 9, 'same': False}, 'OP': 'REPM'}
...
{'src': {'type': 'addresses_A_ht', 'congruent': 3, 'same': False}, 'dst': {'type': 'addresses_A_ht', 'congruent': 4, 'same': False}, 'OP': 'REPM'}
