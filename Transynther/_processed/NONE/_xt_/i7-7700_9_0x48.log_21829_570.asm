...
nop
sub %rbp, %rbp
lea addresses_D_ht+0x1e492, %rdi
nop
nop
nop
lfence
...
nop
cmp $15533, %rbx
lea addresses_WT_ht+0x2912, %rsi
lea addresses_normal_ht+0x5e42, %rdi
nop
nop
nop
add %rax, %rax
...
nop
cmp %r11, %r11
lea addresses_A_ht+0x14092, %rdi
nop
nop
nop
nop
...
vpextrq $0, %xmm1, %rsi
add $21989, %rsi
lea addresses_D_ht+0xe912, %rdx
sub %rbp, %rbp
movl $0x61626364, (%rdx)
cmp %r11, %r11
lea addresses_A_ht+0x102fc, %rsi
lea addresses_WC_ht+0x2c92, %rdi
and $8233, %r11
mov $35, %rcx
rep movsq
nop
and $12405, %rsi
lea addresses_WT_ht+0x1da72, %rsi
lea addresses_normal_ht+0x196f4, %rdi
nop
nop
nop
nop
...
{'OP': 'REPM', 'src': {'type': 'addresses_WT_ht', 'congruent': 6, 'same': False}, 'dst': {'type': 'addresses_normal_ht', 'congruent': 3, 'same': False}}
...
{'OP': 'STOR', 'dst': {'type': 'addresses_D_ht', 'AVXalign': False, 'congruent': 5, 'size': 4, 'same': False, 'NT': True}}
