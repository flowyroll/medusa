...
push %rdi
push %rsi
lea addresses_D_ht+0xc169, %rsi
lea addresses_UC_ht+0x8f59, %rdi
cmp %rax, %rax
mov $125, %rcx
rep movsq
nop
...
nop
xor $7639, %rsi
lea addresses_D_ht+0x1bd59, %r13
inc %rdi
...
nop
inc %rdi
lea addresses_normal_ht+0x6859, %rdi
and $52490, %r8
vmovups (%rdi), %ymm3
...
nop
add $47671, %rsi
lea addresses_A_ht+0x4e57, %rsi
lea addresses_A_ht+0x4df5, %rdi
nop
nop
nop
add %rax, %rax
...
nop
and $4602, %rdi
lea addresses_WT_ht+0x8357, %rax
nop
nop
nop
nop
...
nop
cmp %r8, %r8
lea addresses_UC_ht+0x7059, %rcx
nop
dec %rbp
...
nop
and $3049, %rsi
lea addresses_WT_ht+0xa059, %rcx
nop
nop
nop
nop
...
nop
sub %rcx, %rcx
lea addresses_D_ht+0x1a979, %rax
add %rsi, %rsi
mov (%rax), %rcx
nop
nop
...
nop
cmp %r8, %r8
lea addresses_WC_ht+0x16dd9, %rdi
nop
nop
nop
nop
...
// Faulty Load
lea addresses_normal+0x1b859, %rdx
and %r11, %r11
movups (%rdx), %xmm7
vpextrq $0, %xmm7, %r9
lea oracles, %r12
...
<gen_prepare_buffer>
{'OP': 'REPM', 'src': {'same': False, 'congruent': 4, 'type': 'addresses_D_ht'}, 'dst': {'same': False, 'congruent': 7, 'type': 'addresses_UC_ht'}}
...
{'OP': 'LOAD', 'src': {'same': True, 'type': 'addresses_D_ht', 'NT': False, 'AVXalign': False, 'size': 8, 'congruent': 4}}
