...
push %rdi
push %rsi
lea addresses_WT_ht+0x18c2, %rsi
lea addresses_WT_ht+0x1e222, %rdi
nop
nop
nop
nop
...
rep movsb
inc %r9
lea addresses_normal_ht+0x10a42, %r14
nop
nop
nop
nop
...
nop
add %rdi, %rdi
lea addresses_A_ht+0x16ff2, %rsi
nop
nop
nop
nop
...
nop
dec %r12
lea addresses_normal_ht+0xcc22, %rax
nop
nop
nop
xor $59804, %rsi
...
nop
add %rcx, %rcx
lea addresses_WT_ht+0xa922, %rsi
lea addresses_WC_ht+0x8b92, %rdi
clflush (%rsi)
nop
nop
nop
...
nop
cmp %r11, %r11
lea addresses_normal_ht+0xdc42, %rsi
and %r11, %r11
movw $0x6162, (%rsi)
nop
nop
nop
inc %r11
lea addresses_WC_ht+0x18522, %rdi
clflush (%rdi)
nop
nop
nop
...
<gen_prepare_buffer>
{'src': {'congruent': 5, 'same': False, 'type': 'addresses_WT_ht'}, 'OP': 'REPM', 'dst': {'congruent': 8, 'same': False, 'type': 'addresses_WT_ht'}}
{'src': {'congruent': 5, 'AVXalign': True, 'same': False, 'size': 1, 'NT': False, 'type': 'addresses_normal_ht'}, 'OP': 'LOAD'}
