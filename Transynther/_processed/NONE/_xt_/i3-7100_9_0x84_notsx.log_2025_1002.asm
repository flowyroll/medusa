...
nop
add $30832, %r13
lea addresses_WC_ht+0x13e03, %rsi
lea addresses_normal_ht+0x18f0f, %rdi
clflush (%rdi)
nop
nop
nop
...
nop
cmp $59415, %rbp
lea addresses_normal_ht+0x18603, %rsi
lea addresses_WT_ht+0xfa03, %rdi
nop
nop
and $34426, %r11
mov $67, %rcx
...
nop
and %r11, %r11
lea addresses_A_ht+0x165e3, %rsi
nop
dec %r9
...
lea addresses_D_ht+0x17603, %rdi
nop
sub $3959, %rbx
mov $81, %rcx
rep movsq
xor $42062, %rcx
lea addresses_A_ht+0xc603, %rsi
nop
add $29481, %rbp
mov $0x6162636465666768, %rcx
movq %rcx, %xmm7
...
{'src': {'type': 'addresses_normal_ht', 'congruent': 10, 'same': False}, 'dst': {'type': 'addresses_WT_ht', 'congruent': 10, 'same': False}, 'OP': 'REPM'}
{'dst': {'type': 'addresses_A_ht', 'same': True, 'size': 32, 'congruent': 5, 'NT': False, 'AVXalign': False}, 'OP': 'STOR'}
{'src': {'type': 'addresses_UC_ht', 'congruent': 11, 'same': False}, 'dst': {'type': 'addresses_D_ht', 'congruent': 11, 'same': False}, 'OP': 'REPM'}
