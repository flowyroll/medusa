...
push %rdi
push %rsi
lea addresses_WT_ht+0x10ec7, %rsi
lea addresses_WC_ht+0x2c7, %rdi
nop
nop
sub %r12, %r12
mov $93, %rcx
rep movsb
dec %r8
lea addresses_D_ht+0x146c7, %rsi
lea addresses_A_ht+0xcec7, %rdi
nop
inc %r13
mov $75, %rcx
rep movsw
...
{'OP': 'STOR', 'dst': {'size': 32, 'NT': False, 'type': 'addresses_P', 'same': False, 'AVXalign': False, 'congruent': 8}}
...
<gen_prepare_buffer>
{'OP': 'REPM', 'src': {'same': True, 'type': 'addresses_WT_ht', 'congruent': 9}, 'dst': {'same': False, 'type': 'addresses_WC_ht', 'congruent': 11}}
