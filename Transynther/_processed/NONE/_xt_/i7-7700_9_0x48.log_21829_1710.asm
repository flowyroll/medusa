...
lea addresses_normal_ht+0x186f9, %rdi
clflush (%rdi)
cmp %r9, %r9
mov $90, %rcx
rep movsb
cmp $31301, %rbx
lea addresses_normal_ht+0x19511, %r9
and $27912, %r8
movw $0x6162, (%r9)
nop
nop
...
{'OP': 'REPM', 'src': {'type': 'addresses_normal_ht', 'congruent': 8, 'same': False}, 'dst': {'type': 'addresses_normal_ht', 'congruent': 9, 'same': True}}
