...
push %rdi
push %rsi
lea addresses_A_ht+0x1c61c, %rdi
clflush (%rdi)
nop
nop
cmp %r12, %r12
...
vpextrq $1, %xmm0, %r10
inc %r11
lea addresses_normal_ht+0xd37a, %r10
nop
nop
nop
xor $15609, %rsi
...
vmovups %ymm4, (%r10)
xor %r12, %r12
lea addresses_UC_ht+0xeb3c, %rbx
nop
nop
sub %rax, %rax
vmovups (%rbx), %ymm3
...
nop
sub $6448, %rax
lea addresses_WC_ht+0x103e2, %r12
cmp $36189, %rdi
movups (%r12), %xmm5
vpextrq $0, %xmm5, %r11
nop
nop
inc %r12
lea addresses_WT_ht+0x1754c, %rbx
clflush (%rbx)
nop
nop
and %r11, %r11
...
nop
xor $13540, %rax
lea addresses_normal_ht+0x13f3c, %rsi
lea addresses_D_ht+0x14fcc, %rdi
nop
nop
and %r10, %r10
mov $60, %rcx
...
lea addresses_A_ht+0x1d80e, %rdi
nop
nop
sub $23386, %r10
mov $81, %rcx
...
nop
cmp %rax, %rax
lea addresses_normal_ht+0x1b4c, %rsi
xor %rbx, %rbx
mov $0x6162636465666768, %r10
movq %r10, %xmm2
vmovups %ymm2, (%rsi)
and %r12, %r12
lea addresses_A_ht+0x1c74c, %rax
clflush (%rax)
nop
nop
nop
...
nop
add $46505, %rdi
lea addresses_UC_ht+0xf90c, %r10
add $23794, %rdi
mov (%r10), %ebx
nop
nop
...
// Faulty Load
lea addresses_normal+0x1cb4c, %r8
nop
nop
nop
xor $46853, %r10
...
{'src': {'same': False, 'congruent': 8, 'NT': False, 'type': 'addresses_D', 'size': 32, 'AVXalign': False}, 'OP': 'LOAD'}
[Faulty Load]
...
{'src': {'type': 'addresses_normal_ht', 'congruent': 4, 'same': False}, 'OP': 'REPM', 'dst': {'type': 'addresses_D_ht', 'congruent': 7, 'same': True}}
{'src': {'type': 'addresses_normal_ht', 'congruent': 0, 'same': True}, 'OP': 'REPM', 'dst': {'type': 'addresses_A_ht', 'congruent': 1, 'same': False}}
