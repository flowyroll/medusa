...
push %rdi
push %rsi
lea addresses_D_ht+0x12382, %rax
nop
nop
cmp %r15, %r15
...
vpextrq $1, %xmm1, %rsi
inc %rsi
lea addresses_WC_ht+0x2782, %r11
nop
nop
nop
cmp $49418, %r14
...
nop
sub %rsi, %rsi
lea addresses_D_ht+0x16da2, %rsi
lea addresses_D_ht+0x47f2, %rdi
nop
nop
nop
sub $27279, %r14
...
nop
xor %rdi, %rdi
lea addresses_WC_ht+0x1140e, %rsi
lea addresses_normal_ht+0x1402a, %rdi
cmp $27145, %r13
mov $115, %rcx
rep movsq
sub %rsi, %rsi
lea addresses_UC_ht+0xbd42, %r13
nop
cmp %rsi, %rsi
mov (%r13), %r11w
nop
...
nop
and $35497, %rdi
lea addresses_WC_ht+0x208c, %r15
nop
nop
nop
add %r11, %r11
...
nop
sub $57984, %rdi
lea addresses_WT_ht+0x30a2, %rsi
lea addresses_normal_ht+0x96a2, %rdi
nop
nop
nop
nop
...
nop
sub %rax, %rax
lea addresses_WC_ht+0x1b7a2, %rsi
lea addresses_WT_ht+0xcba2, %rdi
clflush (%rsi)
nop
and $10051, %r15
mov $114, %rcx
rep movsl
sub %r14, %r14
lea addresses_normal_ht+0xa222, %r14
nop
nop
sub $50619, %r11
movl $0x61626364, (%r14)
and %rcx, %rcx
lea addresses_WT_ht+0x1d5a2, %rdi
nop
nop
nop
dec %r11
...
nop
xor %r14, %r14
lea addresses_WT_ht+0x135e2, %rdi
nop
dec %rcx
movw $0x6162, (%rdi)
nop
nop
and %r14, %r14
lea addresses_WT_ht+0xd3a2, %rdi
nop
nop
nop
nop
...
{'dst': {'same': False, 'congruent': 2, 'type': 'addresses_normal_ht'}, 'OP': 'REPM', 'src': {'same': False, 'congruent': 2, 'type': 'addresses_WC_ht'}}
{'OP': 'LOAD', 'src': {'same': True, 'NT': False, 'AVXalign': False, 'size': 2, 'type': 'addresses_UC_ht', 'congruent': 4}}
{'dst': {'same': False, 'NT': False, 'AVXalign': False, 'size': 8, 'type': 'addresses_WC_ht', 'congruent': 1}, 'OP': 'STOR'}
{'dst': {'same': False, 'congruent': 5, 'type': 'addresses_normal_ht'}, 'OP': 'REPM', 'src': {'same': False, 'congruent': 8, 'type': 'addresses_WT_ht'}}
...
{'OP': 'LOAD', 'src': {'same': True, 'NT': False, 'AVXalign': False, 'size': 32, 'type': 'addresses_WT_ht', 'congruent': 9}}
