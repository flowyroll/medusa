...
lea addresses_WT_ht+0x1100c, %rdi
nop
nop
nop
and %r12, %r12
...
nop
xor %r14, %r14
lea addresses_WT_ht+0x14bb3, %rsi
lea addresses_normal_ht+0x9d73, %rdi
clflush (%rsi)
nop
and $25912, %r11
mov $70, %rcx
...
nop
and $29471, %rcx
lea addresses_UC_ht+0x8ab3, %rsi
lea addresses_D_ht+0xd73, %rdi
nop
nop
sub %r15, %r15
mov $80, %rcx
...
nop
sub $2201, %r12
lea addresses_WC_ht+0x6ead, %rsi
lea addresses_D_ht+0x8f53, %rdi
nop
nop
sub $3701, %r10
mov $39, %rcx
...
nop
sub $34386, %rcx
lea addresses_normal_ht+0x48d3, %rcx
nop
nop
nop
nop
...
nop
xor $44722, %r10
lea addresses_UC_ht+0x10c1b, %rsi
nop
cmp %r12, %r12
mov (%rsi), %r15d
nop
...
nop
dec %rsi
lea addresses_UC_ht+0xb2b3, %r15
nop
nop
sub %r11, %r11
movl $0x61626364, (%r15)
...
nop
cmp %rdi, %rdi
lea addresses_WC_ht+0x19edb, %rcx
nop
nop
nop
nop
...
{'OP': 'REPM', 'src': {'type': 'addresses_normal_ht', 'congruent': 0, 'same': False}, 'dst': {'type': 'addresses_WT_ht', 'congruent': 0, 'same': False}}
...
{'OP': 'REPM', 'src': {'type': 'addresses_WC_ht', 'congruent': 0, 'same': False}, 'dst': {'type': 'addresses_D_ht', 'congruent': 5, 'same': False}}
{'OP': 'LOAD', 'src': {'type': 'addresses_normal_ht', 'size': 1, 'AVXalign': False, 'NT': False, 'congruent': 5, 'same': True}}
