...
push %rdi
push %rsi
lea addresses_A_ht+0x13b51, %rsi
lea addresses_WT_ht+0xa90d, %rdi
and $8734, %rax
mov $74, %rcx
rep movsb
sub $8679, %r12
lea addresses_WC_ht+0x1312d, %r12
nop
nop
nop
and %r11, %r11
...
nop
add $18639, %rax
lea addresses_D_ht+0x1addd, %r12
nop
nop
cmp %rbx, %rbx
mov (%r12), %r11d
...
nop
lfence
lea addresses_normal_ht+0x1dd, %rsi
nop
nop
nop
nop
...
vpextrq $1, %xmm7, %rdi
sub %rcx, %rcx
lea addresses_D_ht+0xe5dd, %rax
and %rdi, %rdi
mov (%rax), %r11w
nop
cmp %rcx, %rcx
lea addresses_D_ht+0x17187, %rsi
...
nop
cmp %r12, %r12
lea addresses_A_ht+0x138dd, %rsi
lea addresses_UC_ht+0xf4dd, %rdi
clflush (%rdi)
cmp $39145, %r11
mov $121, %rcx
rep movsl
...
nop
add $33899, %rsi
lea addresses_WC_ht+0xd1b9, %rsi
lea addresses_UC_ht+0x129dd, %rdi
clflush (%rdi)
xor %r11, %r11
mov $70, %rcx
rep movsw
...
nop
add $30543, %rdi
lea addresses_WT_ht+0x104dd, %r12
nop
xor $42715, %rsi
mov (%r12), %ecx
nop
...
nop
and $26240, %rdi
lea addresses_WC_ht+0x9dd, %rsi
lea addresses_WC_ht+0x37dd, %rdi
nop
nop
nop
nop
...
nop
inc %rax
lea addresses_A_ht+0x1db83, %rsi
lea addresses_D_ht+0x179dd, %rdi
nop
xor $41562, %r11
mov $76, %rcx
rep movsl
...
{'src': {'NT': False, 'AVXalign': True, 'size': 16, 'congruent': 10, 'same': False, 'type': 'addresses_normal_ht'}, 'OP': 'LOAD'}
...
{'src': {'congruent': 1, 'same': False, 'type': 'addresses_WC_ht'}, 'dst': {'congruent': 10, 'same': False, 'type': 'addresses_UC_ht'}, 'OP': 'REPM'}
{'src': {'NT': False, 'AVXalign': False, 'size': 4, 'congruent': 8, 'same': False, 'type': 'addresses_WT_ht'}, 'OP': 'LOAD'}
{'src': {'congruent': 10, 'same': False, 'type': 'addresses_WC_ht'}, 'dst': {'congruent': 8, 'same': False, 'type': 'addresses_WC_ht'}, 'OP': 'REPM'}
