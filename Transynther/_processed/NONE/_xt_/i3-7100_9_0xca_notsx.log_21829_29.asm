...
push %rdi
push %rsi
lea addresses_UC_ht+0x9955, %r10
nop
nop
nop
nop
...
nop
sub $10841, %r12
lea addresses_normal_ht+0x17105, %r11
nop
nop
nop
nop
...
nop
inc %rdi
lea addresses_WT_ht+0x8c59, %rdi
nop
nop
nop
nop
...
nop
sub %r8, %r8
lea addresses_D_ht+0x4b9, %rsi
lea addresses_A_ht+0x175e9, %rdi
clflush (%rdi)
nop
nop
xor %r14, %r14
...
nop
and $44038, %r13
lea addresses_UC_ht+0x9959, %rsi
lea addresses_A_ht+0x14699, %rdi
nop
nop
nop
nop
...
nop
and $21175, %r10
lea addresses_D_ht+0x19a59, %r12
nop
and $55195, %rcx
movb $0x61, (%r12)
nop
...
// Load
lea addresses_normal+0xb459, %rdi
nop
nop
nop
nop
...
// Load
lea addresses_normal+0x19521, %rax
nop
nop
cmp $9930, %r11
mov (%rax), %r12d
...
{'src': {'same': False, 'congruent': 2, 'NT': False, 'type': 'addresses_normal', 'size': 4, 'AVXalign': False}, 'OP': 'LOAD'}
...
{'src': {'same': False, 'congruent': 11, 'NT': False, 'type': 'addresses_WT_ht', 'size': 1, 'AVXalign': True}, 'OP': 'LOAD'}
...
{'src': {'type': 'addresses_UC_ht', 'congruent': 7, 'same': False}, 'OP': 'REPM', 'dst': {'type': 'addresses_A_ht', 'congruent': 5, 'same': False}}
