...
push %rdi
push %rsi
lea addresses_WT_ht+0x129b1, %r15
nop
nop
nop
nop
...
nop
cmp $53438, %rsi
lea addresses_D_ht+0x1621a, %r13
nop
nop
inc %rsi
vmovups (%r13), %ymm6
...
nop
cmp %r15, %r15
lea addresses_normal_ht+0x41b9, %r9
nop
nop
nop
and %rsi, %rsi
...
nop
cmp %rbp, %rbp
lea addresses_WT_ht+0x1c5d9, %rsi
lea addresses_normal_ht+0x9a39, %rdi
nop
nop
cmp $51085, %rbp
mov $100, %rcx
...
{'OP': 'LOAD', 'src': {'type': 'addresses_normal_ht', 'size': 1, 'AVXalign': False, 'NT': False, 'congruent': 3, 'same': True}}
