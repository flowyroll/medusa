...
push %rdi
push %rsi
lea addresses_normal_ht+0x395d, %rsi
lea addresses_WT_ht+0x7f1d, %rdi
nop
nop
nop
nop
...
nop
sub $53728, %rsi
lea addresses_A_ht+0x301d, %rsi
lea addresses_A_ht+0x17afd, %rdi
nop
nop
inc %rbx
mov $97, %rcx
...
nop
sub $44054, %rcx
lea addresses_A_ht+0xeec5, %r15
nop
and $3236, %rcx
movb $0x61, (%r15)
dec %rcx
lea addresses_D_ht+0x18f1d, %rsi
inc %r12
movb $0x61, (%rsi)
nop
nop
and %rsi, %rsi
lea addresses_normal_ht+0x1449d, %r12
clflush (%r12)
nop
nop
cmp %rcx, %rcx
...
nop
sub %r12, %r12
lea addresses_WT_ht+0xd1d, %rsi
lea addresses_WC_ht+0xc235, %rdi
sub $32263, %r14
mov $122, %rcx
rep movsw
nop
...
nop
and %r14, %r14
lea addresses_normal_ht+0xe9bd, %r15
clflush (%r15)
nop
nop
sub %rbx, %rbx
...
nop
and $27429, %r12
lea addresses_normal_ht+0xfb8e, %rcx
nop
nop
nop
nop
...
nop
add %r14, %r14
lea addresses_UC_ht+0x13a7d, %r15
nop
nop
nop
nop
...
mov (%r15), %cx
add %rcx, %rcx
lea addresses_UC_ht+0x1d71d, %rsi
lea addresses_UC_ht+0x1068d, %rdi
nop
nop
nop
nop
...
rep movsb
cmp %r12, %r12
lea addresses_WC_ht+0x1b613, %rbx
nop
nop
nop
nop
...
nop
add %rcx, %rcx
lea addresses_UC_ht+0x1c49d, %rsi
clflush (%rsi)
nop
nop
nop
...
nop
cmp %r15, %r15
lea addresses_normal_ht+0x5e85, %r15
nop
nop
nop
nop
...
{'src': {'type': 'addresses_A_ht', 'congruent': 5, 'same': False}, 'dst': {'type': 'addresses_A_ht', 'congruent': 4, 'same': False}, 'OP': 'REPM'}
...
{'src': {'type': 'addresses_UC_ht', 'same': False, 'size': 2, 'congruent': 5, 'NT': False, 'AVXalign': True}, 'OP': 'LOAD'}
{'src': {'type': 'addresses_UC_ht', 'congruent': 10, 'same': False}, 'dst': {'type': 'addresses_UC_ht', 'congruent': 3, 'same': True}, 'OP': 'REPM'}
