...
movaps %xmm2, (%r10)
lfence
lea addresses_D_ht+0x12fb2, %rdi
clflush (%rdi)
nop
nop
and %r9, %r9
...
nop
and $2296, %r8
lea addresses_WC_ht+0x1614, %rsi
lea addresses_A_ht+0xafd4, %rdi
clflush (%rdi)
nop
and %r10, %r10
mov $63, %rcx
...
nop
add %rbp, %rbp
lea addresses_UC_ht+0x9d44, %rdi
nop
nop
nop
cmp %r10, %r10
movb (%rdi), %bl
xor %rsi, %rsi
lea addresses_WC_ht+0x11cd4, %rsi
clflush (%rsi)
nop
nop
xor $32801, %rbx
...
nop
cmp %rdi, %rdi
lea addresses_A_ht+0x15314, %rsi
lea addresses_A_ht+0x5528, %rdi
clflush (%rdi)
nop
nop
nop
...
nop
xor %rbp, %rbp
lea addresses_normal_ht+0x124b0, %rsi
lea addresses_WT_ht+0x9a56, %rdi
nop
xor %r8, %r8
mov $25, %rcx
rep movsq
...
nop
inc %rdi
lea addresses_UC_ht+0x10654, %rsi
lea addresses_WT_ht+0xd194, %rdi
nop
nop
nop
nop
...
{'src': {'type': 'addresses_normal_ht', 'congruent': 0, 'same': True}, 'OP': 'REPM', 'dst': {'type': 'addresses_WT_ht', 'congruent': 1, 'same': False}}
{'src': {'type': 'addresses_UC_ht', 'congruent': 6, 'same': False}, 'OP': 'REPM', 'dst': {'type': 'addresses_WT_ht', 'congruent': 7, 'same': True}}
{'32': 21829}
