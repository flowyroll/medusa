...
nop
and %rsi, %rsi
lea addresses_WC_ht+0x141c1, %rsi
nop
sub %r11, %r11
...
nop
inc %rcx
lea addresses_normal_ht+0x168b7, %rsi
nop
nop
nop
nop
...
nop
cmp $51623, %r12
lea addresses_WC_ht+0x77c1, %rdi
nop
nop
nop
nop
...
nop
xor %rdi, %rdi
lea addresses_WC_ht+0x156b1, %rdi
nop
sub %r14, %r14
mov $0x6162636465666768, %rcx
movq %rcx, %xmm0
...
nop
and $8333, %r11
lea addresses_D_ht+0x1cfc1, %rdi
clflush (%rdi)
nop
nop
nop
...
// Load
lea addresses_normal+0xa6fb, %rbp
nop
nop
nop
and $13362, %r11
...
<gen_faulty_load>
[REF]
{'src': {'congruent': 0, 'AVXalign': False, 'same': False, 'size': 8, 'NT': True, 'type': 'addresses_D'}, 'OP': 'LOAD'}
{'src': {'congruent': 1, 'AVXalign': False, 'same': False, 'size': 1, 'NT': False, 'type': 'addresses_normal'}, 'OP': 'LOAD'}
...
{'src': {'congruent': 9, 'AVXalign': False, 'same': False, 'size': 16, 'NT': True, 'type': 'addresses_WC_ht'}, 'OP': 'LOAD'}
...
{'OP': 'STOR', 'dst': {'congruent': 10, 'AVXalign': False, 'same': False, 'size': 16, 'NT': True, 'type': 'addresses_D_ht'}}
{'OP': 'STOR', 'dst': {'congruent': 6, 'AVXalign': True, 'same': False, 'size': 2, 'NT': False, 'type': 'addresses_A_ht'}}
{'36': 21829}
