...
push %rdi
push %rsi
lea addresses_A_ht+0xf7d8, %rsi
lea addresses_D_ht+0xd3c0, %rdi
nop
nop
nop
add %rax, %rax
...
nop
inc %rbp
lea addresses_WT_ht+0x1ad98, %r10
nop
and $49916, %r9
mov (%r10), %edi
nop
...
nop
sub %rbp, %rbp
lea addresses_D_ht+0x1abd8, %rdi
and $8667, %rax
mov (%rdi), %bp
xor $39225, %rbp
lea addresses_normal_ht+0x4858, %rax
nop
xor $4684, %r10
mov (%rax), %cx
nop
...
nop
dec %r10
lea addresses_D_ht+0x10400, %rsi
lea addresses_normal_ht+0x23f8, %rdi
nop
nop
nop
nop
...
nop
dec %rsi
lea addresses_normal_ht+0x10618, %rcx
nop
nop
nop
nop
...
movb (%rcx), %r12b
add %rax, %rax
lea addresses_D_ht+0x17458, %rsi
lea addresses_D_ht+0xcb58, %rdi
nop
nop
sub $62169, %rax
mov $70, %rcx
...
nop
add %rsi, %rsi
lea addresses_normal_ht+0x107f1, %rax
clflush (%rax)
dec %r10
...
nop
add $55046, %rdi
lea addresses_WC_ht+0x3624, %r10
nop
nop
nop
nop
...
// Faulty Load
lea addresses_normal+0x153d8, %rcx
nop
nop
nop
cmp %rax, %rax
...
<gen_prepare_buffer>
{'dst': {'same': False, 'congruent': 3, 'type': 'addresses_D_ht'}, 'OP': 'REPM', 'src': {'same': False, 'congruent': 9, 'type': 'addresses_A_ht'}}
