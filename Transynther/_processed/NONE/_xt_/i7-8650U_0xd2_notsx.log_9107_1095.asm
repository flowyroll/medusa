...
push %rdi
push %rdx
lea addresses_A_ht+0x14ca9, %r15
nop
add $3, %rax
...
nop
add %rdx, %rdx
lea addresses_normal_ht+0x9559, %r11
clflush (%r11)
nop
nop
nop
...
// REPMOV
lea addresses_D+0x16b59, %rsi
lea addresses_PSE+0xfea9, %rdi
clflush (%rsi)
nop
nop
add $42322, %r13
...
// Faulty Load
lea addresses_normal+0x7959, %rdx
nop
nop
nop
nop
...
{'OP': 'REPM', 'src': {'type': 'addresses_D', 'congruent': 4, 'same': False}, 'dst': {'type': 'addresses_PSE', 'congruent': 3, 'same': False}}
[Faulty Load]
