...
push %rdx
push %rsi
lea addresses_WC_ht+0x14638, %rsi
lea addresses_UC_ht+0x14678, %rdi
nop
nop
cmp $3048, %rbx
mov $63, %rcx
...
nop
add $12048, %rdx
lea addresses_normal_ht+0x11c08, %r11
nop
nop
dec %r9
mov (%r11), %rbx
...
nop
add %rsi, %rsi
lea addresses_normal_ht+0x1a018, %rbx
nop
nop
nop
add %rdi, %rdi
mov (%rbx), %si
xor $62593, %rsi
lea addresses_normal_ht+0x9228, %rcx
nop
nop
dec %rdx
movw $0x6162, (%rcx)
...
nop
add %r9, %r9
lea addresses_D_ht+0x3818, %rsi
lea addresses_UC_ht+0x15e90, %rdi
nop
nop
nop
sub $63433, %r8
...
rep movsb
sub $38255, %rsi
lea addresses_D_ht+0x1c398, %r9
nop
nop
add $23238, %rbx
movw $0x6162, (%r9)
cmp %r8, %r8
lea addresses_WT_ht+0x1efb8, %r11
nop
nop
inc %r8
movl $0x61626364, (%r11)
...
nop
cmp %rsi, %rsi
lea addresses_A_ht+0x14ab8, %rdx
nop
nop
dec %r9
...
movups %xmm1, (%rdx)
xor $55288, %r11
lea addresses_A_ht+0x1c78, %rsi
nop
nop
inc %rbx
mov (%rsi), %r11
xor $56946, %rbx
lea addresses_D_ht+0x81ae, %rdi
nop
nop
nop
nop
...
{'OP': 'STOR', 'dst': {'type': 'addresses_NC', 'AVXalign': True, 'congruent': 1, 'size': 4, 'same': False, 'NT': False}}
[Faulty Load]
...
{'OP': 'REPM', 'src': {'type': 'addresses_D_ht', 'congruent': 4, 'same': True}, 'dst': {'type': 'addresses_UC_ht', 'congruent': 3, 'same': False}}
...
{'OP': 'LOAD', 'src': {'type': 'addresses_A_ht', 'AVXalign': True, 'congruent': 9, 'size': 8, 'same': False, 'NT': False}}
