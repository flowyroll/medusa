...
push %rdi
push %rsi
lea addresses_UC_ht+0x1a5ee, %r13
nop
nop
sub $35640, %r10
...
nop
xor $28166, %rsi
lea addresses_WC_ht+0x1350a, %r11
clflush (%r11)
nop
nop
nop
...
nop
cmp %rbp, %rbp
lea addresses_normal_ht+0x6546, %rsi
lea addresses_WC_ht+0x1e2fc, %rdi
add %r14, %r14
mov $105, %rcx
rep movsb
nop
