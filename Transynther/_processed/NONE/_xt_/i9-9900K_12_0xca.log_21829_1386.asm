...
push %rdi
push %rsi
lea addresses_UC_ht+0x1a2e3, %r14
nop
nop
nop
sub %rbp, %rbp
...
lea addresses_D_ht+0x15c61, %rdi
nop
nop
inc %r9
mov $19, %rcx
...
movw $0x6162, (%rsi)
cmp $16281, %rdi
lea addresses_WC_ht+0xf8e1, %rsi
nop
xor %r12, %r12
mov (%rsi), %r9w
nop
...
nop
dec %r14
lea addresses_WT_ht+0xe4f9, %rbp
nop
nop
nop
add $19701, %rdi
...
nop
dec %rbp
lea addresses_WT_ht+0x16b31, %r14
nop
nop
nop
nop
...
nop
sub %rcx, %rcx
lea addresses_WT_ht+0x9c61, %rsi
lea addresses_WT_ht+0x3489, %rdi
nop
nop
nop
cmp %r12, %r12
...
// Store
lea addresses_normal+0x17ee1, %rdi
nop
nop
nop
nop
...
// Faulty Load
lea addresses_normal+0x17ee1, %rbp
nop
nop
nop
nop
...
{'OP': 'REPM', 'src': {'same': False, 'type': 'addresses_WC_ht', 'congruent': 7}, 'dst': {'same': False, 'type': 'addresses_D_ht', 'congruent': 7}}
...
{'OP': 'LOAD', 'src': {'size': 8, 'NT': False, 'type': 'addresses_WT_ht', 'same': True, 'AVXalign': False, 'congruent': 3}}
{'OP': 'REPM', 'src': {'same': False, 'type': 'addresses_WT_ht', 'congruent': 6}, 'dst': {'same': False, 'type': 'addresses_WT_ht', 'congruent': 1}}
{'34': 21829}
