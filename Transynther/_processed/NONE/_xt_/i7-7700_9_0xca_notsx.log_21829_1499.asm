...
push %rdx
push %rsi
lea addresses_D_ht+0x5ad4, %rsi
lea addresses_WT_ht+0x968c, %rdi
nop
nop
nop
nop
...
rep movsb
cmp %rbp, %rbp
lea addresses_UC_ht+0x1010c, %rsi
lea addresses_WT_ht+0xdd0c, %rdi
nop
cmp %r8, %r8
mov $21, %rcx
rep movsq
and %rsi, %rsi
lea addresses_WC_ht+0x46cc, %r8
nop
nop
nop
nop
...
movw $0x6162, (%r8)
sub %rsi, %rsi
lea addresses_UC_ht+0x1c978, %rsi
lea addresses_A_ht+0x192cc, %rdi
nop
sub %rdx, %rdx
mov $13, %rcx
rep movsw
...
nop
dec %r13
lea addresses_UC_ht+0x1eecc, %rsi
lea addresses_D_ht+0x623c, %rdi
clflush (%rdi)
nop
nop
add %r8, %r8
...
nop
add %r12, %r12
lea addresses_normal_ht+0x27f2, %r12
nop
nop
nop
nop
...
nop
add $22317, %rsi
lea addresses_A_ht+0x1490c, %rsi
lea addresses_normal_ht+0x12ecc, %rdi
add %r13, %r13
mov $5, %rcx
rep movsw
nop
nop
and %rdx, %rdx
lea addresses_normal_ht+0x166cc, %r8
nop
nop
nop
nop
...
nop
sub %rdi, %rdi
lea addresses_D_ht+0x1410c, %r13
nop
nop
nop
and $63985, %rbp
...
// Store
lea addresses_normal+0x74cc, %r11
nop
and $52599, %rdi
...
{'src': {'congruent': 1, 'same': False, 'type': 'addresses_UC_ht'}, 'dst': {'congruent': 10, 'same': False, 'type': 'addresses_A_ht'}, 'OP': 'REPM'}
{'src': {'congruent': 11, 'same': False, 'type': 'addresses_UC_ht'}, 'dst': {'congruent': 4, 'same': False, 'type': 'addresses_D_ht'}, 'OP': 'REPM'}
...
{'src': {'congruent': 4, 'same': False, 'type': 'addresses_A_ht'}, 'dst': {'congruent': 9, 'same': False, 'type': 'addresses_normal_ht'}, 'OP': 'REPM'}
