...
push %rdx
push %rsi
lea addresses_A_ht+0x1ae2a, %rbp
nop
xor $2944, %rax
mov (%rbp), %r12d
nop
...
movw $0x6162, (%rdi)
cmp $13635, %rdx
lea addresses_WT_ht+0x56e6, %rbp
clflush (%rbp)
nop
nop
cmp $54750, %r9
...
nop
cmp %r9, %r9
lea addresses_WC_ht+0x10ef8, %rax
nop
nop
nop
xor $13226, %rdi
...
nop
xor %rdx, %rdx
lea addresses_UC_ht+0x1ddaa, %r9
nop
nop
nop
nop
...
nop
sub $33431, %rdx
lea addresses_UC_ht+0xee4a, %rdx
clflush (%rdx)
cmp $37374, %r9
vmovups (%rdx), %ymm2
...
nop
add $56445, %rsi
lea addresses_UC_ht+0x19e6a, %rdx
clflush (%rdx)
nop
sub $6627, %rsi
...
<gen_prepare_buffer>
{'src': {'type': 'addresses_A_ht', 'same': False, 'size': 4, 'congruent': 4, 'NT': False, 'AVXalign': True}, 'OP': 'LOAD'}
