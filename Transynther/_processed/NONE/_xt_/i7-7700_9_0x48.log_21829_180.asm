...
push %rdi
push %rsi
lea addresses_normal_ht+0x140c5, %rsi
lea addresses_UC_ht+0x19c6d, %rdi
nop
nop
nop
nop
...
rep movsq
xor %r13, %r13
lea addresses_WT_ht+0x14af, %rsi
lea addresses_normal_ht+0x1de1d, %rdi
nop
nop
nop
nop
