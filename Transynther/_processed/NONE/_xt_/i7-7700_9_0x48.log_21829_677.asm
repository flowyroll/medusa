...
vpextrq $0, %xmm5, %rsi
cmp $6031, %rdx
lea addresses_UC_ht+0x85e9, %rsi
lea addresses_WT_ht+0x9879, %rdi
nop
cmp %rax, %rax
mov $34, %rcx
rep movsl
...
nop
xor $47598, %rbp
lea addresses_WC_ht+0x181f1, %rsi
lea addresses_A_ht+0x84f9, %rdi
nop
nop
nop
nop
...
{'OP': 'REPM', 'src': {'type': 'addresses_WC_ht', 'congruent': 3, 'same': False}, 'dst': {'type': 'addresses_A_ht', 'congruent': 6, 'same': False}}
{'36': 21829}
