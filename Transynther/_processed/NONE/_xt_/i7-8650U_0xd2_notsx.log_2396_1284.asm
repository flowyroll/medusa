...
push %rdi
push %rsi
lea addresses_WC_ht+0x1a03b, %rsi
lea addresses_UC_ht+0x11529, %rdi
nop
nop
nop
nop
...
nop
cmp $44475, %r9
lea addresses_WT_ht+0x1ef29, %r10
dec %r13
...
nop
dec %rbx
lea addresses_A_ht+0x1d6dd, %r13
nop
nop
nop
nop
...
nop
and %rdi, %rdi
lea addresses_UC_ht+0x4bdd, %rdi
nop
nop
cmp $18456, %r10
mov (%rdi), %bx
