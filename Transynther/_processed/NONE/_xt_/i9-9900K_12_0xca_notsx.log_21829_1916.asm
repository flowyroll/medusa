...
push %rdx
push %rsi
lea addresses_A_ht+0x15115, %r12
nop
nop
nop
nop
...
nop
dec %rsi
lea addresses_WC_ht+0xe715, %r10
nop
nop
nop
xor %rdx, %rdx
...
nop
add $47130, %rbp
lea addresses_D_ht+0xc4f5, %rsi
lea addresses_WT_ht+0x19915, %rdi
nop
nop
xor %rdx, %rdx
mov $92, %rcx
...
movups %xmm5, (%r10)
mfence
lea addresses_normal_ht+0x18515, %rsi
lea addresses_WC_ht+0xcd15, %rdi
nop
nop
nop
sub $30053, %rbp
...
nop
xor $59797, %rsi
lea addresses_A_ht+0x1a3a6, %rsi
lea addresses_UC_ht+0x9fd5, %rdi
xor $1076, %r9
mov $86, %rcx
rep movsw
nop
...
<gen_prepare_buffer>
{'OP': 'STOR', 'dst': {'same': True, 'type': 'addresses_A_ht', 'NT': False, 'AVXalign': False, 'size': 4, 'congruent': 9}}
...
{'OP': 'REPM', 'src': {'same': True, 'congruent': 11, 'type': 'addresses_normal_ht'}, 'dst': {'same': False, 'congruent': 9, 'type': 'addresses_WC_ht'}}
