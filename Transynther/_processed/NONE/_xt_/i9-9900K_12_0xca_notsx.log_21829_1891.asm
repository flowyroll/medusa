...
push %rdi
push %rsi
lea addresses_WT_ht+0x1bb95, %r13
nop
nop
nop
nop
...
nop
xor %r9, %r9
lea addresses_A_ht+0x185c1, %rax
clflush (%rax)
nop
add $41379, %rcx
movw $0x6162, (%rax)
...
nop
sub $21156, %r9
lea addresses_WT_ht+0x1ee81, %rsi
lea addresses_A_ht+0x3c79, %rdi
nop
nop
xor %r11, %r11
mov $103, %rcx
...
nop
sub $10578, %rcx
lea addresses_UC_ht+0x8d15, %r13
nop
nop
nop
nop
...
nop
and $10032, %rcx
lea addresses_WT_ht+0x16ee1, %r13
nop
nop
nop
nop
...
nop
sub %r11, %r11
lea addresses_normal_ht+0x149b3, %rdi
nop
nop
nop
add %r9, %r9
...
nop
add %r12, %r12
lea addresses_normal_ht+0x1aba3, %rdi
cmp $28894, %r12
mov (%rdi), %r9
nop
nop
...
nop
add $59892, %rdi
lea addresses_D_ht+0x54f1, %r13
clflush (%r13)
nop
sub $63005, %rdi
movw $0x6162, (%r13)
sub %r11, %r11
lea addresses_D_ht+0x16581, %rcx
nop
nop
nop
add $41757, %rdi
mov (%rcx), %ax
xor $13747, %rcx
lea addresses_WC_ht+0x114a1, %rsi
lea addresses_D_ht+0x80e9, %rdi
nop
nop
nop
nop
...
{'OP': 'REPM', 'src': {'same': False, 'congruent': 5, 'type': 'addresses_WT_ht'}, 'dst': {'same': False, 'congruent': 3, 'type': 'addresses_A_ht'}}
...
{'OP': 'STOR', 'dst': {'same': True, 'type': 'addresses_D_ht', 'NT': False, 'AVXalign': False, 'size': 8, 'congruent': 5}}
...
{'OP': 'REPM', 'src': {'same': False, 'congruent': 5, 'type': 'addresses_WC_ht'}, 'dst': {'same': False, 'congruent': 3, 'type': 'addresses_D_ht'}}
{'33': 21829}
