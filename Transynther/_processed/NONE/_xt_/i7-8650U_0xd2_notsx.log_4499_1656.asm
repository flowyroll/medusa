...
push %rdi
push %rsi
lea addresses_normal_ht+0xf2bb, %r10
nop
nop
nop
nop
...
movw $0x6162, (%r10)
sub %rdi, %rdi
lea addresses_A_ht+0x16f63, %rsi
...
nop
add %r8, %r8
lea addresses_WC_ht+0x1a5bb, %rcx
clflush (%rcx)
add $39730, %rbp
...
vpextrq $0, %xmm7, %rsi
add $43102, %r10
lea addresses_normal_ht+0xb9b, %r10
nop
nop
nop
nop
...
nop
xor $45882, %r10
lea addresses_normal_ht+0x110bb, %rsi
lea addresses_UC_ht+0x8abb, %rdi
and %r8, %r8
mov $11, %rcx
rep movsl
nop
...
{'OP': 'REPM', 'src': {'type': 'addresses_A_ht', 'congruent': 0, 'same': True}, 'dst': {'type': 'addresses_normal_ht', 'congruent': 5, 'same': False}}
{'OP': 'LOAD', 'src': {'type': 'addresses_WC_ht', 'size': 32, 'AVXalign': False, 'NT': True, 'congruent': 8, 'same': False}}
