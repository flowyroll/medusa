...
nop
sub $10425, %r9
lea addresses_A_ht+0x133fe, %rdi
sub %r15, %r15
movb $0x61, (%rdi)
nop
inc %rdx
lea addresses_WT_ht+0x5bc4, %r15
nop
nop
nop
nop
...
nop
and $61552, %rdi
lea addresses_normal_ht+0xf3fe, %rsi
lea addresses_WC_ht+0x14afe, %rdi
nop
add %rbx, %rbx
mov $40, %rcx
rep movsq
...
nop
dec %rbx
lea addresses_A_ht+0x97fe, %rsi
lea addresses_normal_ht+0x1667e, %rdi
clflush (%rsi)
nop
nop
nop
...
<gen_prepare_buffer>
{'src': {'type': 'addresses_normal_ht', 'congruent': 10, 'same': False}, 'OP': 'REPM', 'dst': {'type': 'addresses_WC_ht', 'congruent': 7, 'same': True}}
{'OP': 'STOR', 'dst': {'same': False, 'congruent': 8, 'NT': False, 'type': 'addresses_UC_ht', 'size': 1, 'AVXalign': False}}
{'OP': 'STOR', 'dst': {'same': False, 'congruent': 10, 'NT': False, 'type': 'addresses_A_ht', 'size': 1, 'AVXalign': True}}
{'OP': 'STOR', 'dst': {'same': False, 'congruent': 0, 'NT': False, 'type': 'addresses_WT_ht', 'size': 16, 'AVXalign': False}}
{'src': {'type': 'addresses_normal_ht', 'congruent': 8, 'same': True}, 'OP': 'REPM', 'dst': {'type': 'addresses_WC_ht', 'congruent': 0, 'same': False}}
