...
push %rdx
push %rsi
lea addresses_D_ht+0x1a24f, %r12
nop
sub $25317, %rdx
movl $0x61626364, (%r12)
nop
dec %rsi
lea addresses_normal_ht+0x171b, %r15
nop
nop
sub %rdx, %rdx
mov (%r15), %rbp
...
nop
cmp %r15, %r15
lea addresses_WC_ht+0xa31b, %r13
and $30246, %r9
mov (%r13), %ebp
add %r12, %r12
lea addresses_WT_ht+0x7d7b, %rbp
nop
nop
nop
nop
...
nop
and $54398, %rsi
lea addresses_normal_ht+0x13f9b, %r13
nop
nop
add $47535, %rbp
...
{'OP': 'STOR', 'dst': {'type': 'addresses_A', 'size': 1, 'AVXalign': False, 'NT': True, 'congruent': 11, 'same': False}}
[Faulty Load]
