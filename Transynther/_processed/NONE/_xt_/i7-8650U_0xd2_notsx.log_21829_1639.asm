...
nop
add %r9, %r9
lea addresses_WT_ht+0x1e583, %rsi
lea addresses_normal_ht+0xcb98, %rdi
nop
nop
nop
nop
...
nop
xor %r12, %r12
lea addresses_UC_ht+0x1a203, %rbx
nop
nop
sub %r8, %r8
movw $0x6162, (%rbx)
xor $33236, %rdi
lea addresses_UC_ht+0x3603, %rsi
lea addresses_WT_ht+0x6283, %rdi
nop
nop
nop
nop
...
nop
and %rcx, %rcx
lea addresses_A_ht+0x55ef, %rdx
dec %r8
movw $0x6162, (%rdx)
nop
nop
xor $49610, %r12
lea addresses_WC_ht+0xbde7, %r8
nop
nop
add %rdx, %rdx
movb $0x61, (%r8)
