...
push %rdi
push %rsi
lea addresses_UC_ht+0xe6f, %rsi
lea addresses_D_ht+0x90c7, %rdi
nop
nop
nop
nop
...
nop
xor $58452, %rsi
lea addresses_UC_ht+0x70f7, %rsi
lea addresses_A_ht+0x16c67, %rdi
nop
nop
nop
nop
...
rep movsq
add %rsi, %rsi
lea addresses_WT_ht+0x17667, %rdi
clflush (%rdi)
nop
nop
nop
...
nop
dec %r11
lea addresses_normal_ht+0xf727, %rbp
nop
nop
nop
nop
...
nop
add %rbp, %rbp
lea addresses_WT_ht+0xa0c7, %rsi
lea addresses_WC_ht+0x1e667, %rdi
nop
nop
cmp $9477, %r14
mov $24, %rcx
...
nop
inc %rcx
lea addresses_WT_ht+0x1b367, %rsi
lea addresses_normal_ht+0x7467, %rdi
nop
nop
cmp $46719, %r14
mov $10, %rcx
...
// Store
lea addresses_normal+0x1a267, %rcx
add %r15, %r15
...
{'src': {'congruent': 4, 'same': False, 'type': 'addresses_UC_ht'}, 'OP': 'REPM', 'dst': {'congruent': 8, 'same': False, 'type': 'addresses_A_ht'}}
...
{'src': {'congruent': 2, 'same': False, 'type': 'addresses_WT_ht'}, 'OP': 'REPM', 'dst': {'congruent': 9, 'same': False, 'type': 'addresses_WC_ht'}}
