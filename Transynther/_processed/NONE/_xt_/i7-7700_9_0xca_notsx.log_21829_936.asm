...
push %rdx
push %rsi
lea addresses_WT_ht+0x178df, %rsi
lea addresses_D_ht+0xfd3b, %rdi
nop
nop
nop
nop
...
rep movsl
and %r10, %r10
lea addresses_WT_ht+0xcc2f, %rcx
add $55216, %rdx
mov (%rcx), %r12
dec %rcx
lea addresses_WT_ht+0x355f, %r10
nop
nop
nop
nop
...
movb (%r10), %dl
inc %rdx
lea addresses_normal_ht+0x157dd, %rbp
nop
nop
nop
nop
...
nop
and $59085, %rdi
lea addresses_UC_ht+0x1ea6a, %rsi
xor %rdx, %rdx
movb $0x61, (%rsi)
nop
nop
...
nop
sub %rbp, %rbp
lea addresses_WC_ht+0x75f, %rcx
nop
nop
cmp $5234, %rbp
mov (%rcx), %si
xor %r10, %r10
lea addresses_normal_ht+0xdb2f, %rcx
inc %rdx
mov $0x6162636465666768, %rbp
movq %rbp, %xmm4
vmovups %ymm4, (%rcx)
dec %rdi
lea addresses_UC_ht+0x5dab, %r12
clflush (%r12)
nop
nop
nop
...
nop
xor %rbp, %rbp
lea addresses_WC_ht+0xc55f, %rcx
nop
nop
nop
nop
...
nop
cmp %rdx, %rdx
lea addresses_WC_ht+0x926f, %r12
nop
nop
nop
nop
...
nop
cmp %r12, %r12
lea addresses_WT_ht+0x2463, %rcx
nop
nop
xor $30957, %rsi
mov $0x6162636465666768, %rbp
...
<gen_prepare_buffer>
{'src': {'congruent': 6, 'same': False, 'type': 'addresses_WT_ht'}, 'dst': {'congruent': 0, 'same': False, 'type': 'addresses_D_ht'}, 'OP': 'REPM'}
...
{'src': {'NT': False, 'AVXalign': False, 'size': 2, 'congruent': 9, 'same': True, 'type': 'addresses_WC_ht'}, 'OP': 'LOAD'}
