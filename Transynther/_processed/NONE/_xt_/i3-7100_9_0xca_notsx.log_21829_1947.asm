...
push %rdx
push %rsi
lea addresses_WC_ht+0x1e6cc, %rax
nop
nop
nop
nop
...
nop
dec %rbx
lea addresses_WC_ht+0xb84c, %rsi
lea addresses_UC_ht+0xd860, %rdi
nop
nop
nop
dec %r9
...
nop
add %r10, %r10
lea addresses_WT_ht+0x50cc, %rcx
nop
nop
nop
nop
...
movq %rbx, (%rcx)
and %rbx, %rbx
lea addresses_D_ht+0x1114c, %rsi
lea addresses_UC_ht+0x12f4c, %rdi
nop
and %r9, %r9
mov $88, %rcx
rep movsq
...
nop
cmp $6865, %rax
lea addresses_normal_ht+0x13518, %rsi
lea addresses_UC_ht+0x3d56, %rdi
nop
add $36053, %r9
mov $101, %rcx
rep movsw
...
nop
xor %r9, %r9
lea addresses_D_ht+0x1deec, %rdx
xor $50976, %rsi
mov (%rdx), %rbx
nop
nop
...
nop
cmp %rdx, %rdx
lea addresses_WC_ht+0xaf1c, %rsi
lea addresses_D_ht+0x14b6c, %rdi
clflush (%rsi)
nop
nop
nop
...
rep movsq
cmp %rbx, %rbx
lea addresses_A_ht+0x93c4, %rsi
lea addresses_WC_ht+0x1e4ec, %rdi
nop
nop
nop
sub %rdx, %rdx
...
nop
cmp $1336, %rdi
lea addresses_A_ht+0x1320c, %rsi
lea addresses_D_ht+0x1e778, %rdi
nop
sub $43218, %r10
mov $7, %rcx
rep movsb
...
nop
mfence
lea addresses_A_ht+0x1b9ac, %r10
sub $63826, %rcx
movb (%r10), %dl
xor $13144, %rdx
lea addresses_normal_ht+0x1854c, %rdx
sub $37688, %rsi
mov (%rdx), %r9d
nop
nop
...
nop
add $57070, %rdx
lea addresses_WT_ht+0x1b14c, %rdx
cmp $11185, %rax
movw $0x6162, (%rdx)
and $32029, %rax
...
{'src': {'type': 'addresses_D_ht', 'congruent': 10, 'same': True}, 'OP': 'REPM', 'dst': {'type': 'addresses_UC_ht', 'congruent': 9, 'same': False}}
...
{'src': {'type': 'addresses_A_ht', 'congruent': 6, 'same': False}, 'OP': 'REPM', 'dst': {'type': 'addresses_D_ht', 'congruent': 2, 'same': False}}
