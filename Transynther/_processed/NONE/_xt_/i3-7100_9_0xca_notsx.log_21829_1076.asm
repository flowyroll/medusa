...
lea addresses_D_ht+0x1d0cc, %rdi
nop
nop
xor $55172, %r9
mov $46, %rcx
...
nop
xor %r15, %r15
lea addresses_normal_ht+0x19424, %r13
dec %rcx
movb $0x61, (%r13)
nop
nop
...
nop
dec %r13
lea addresses_D_ht+0x17fcc, %rdi
nop
nop
nop
dec %r15
...
nop
inc %r13
lea addresses_normal_ht+0x12c, %rsi
nop
nop
nop
nop
...
nop
xor %rdx, %rdx
lea addresses_WT_ht+0x16d44, %rdx
nop
nop
dec %rdi
mov (%rdx), %esi
and %rsi, %rsi
lea addresses_D_ht+0x109cc, %r9
nop
nop
nop
nop
...
nop
and %rsi, %rsi
lea addresses_WT_ht+0x196cc, %rcx
nop
nop
nop
xor $61569, %r15
movb $0x61, (%rcx)
xor $36017, %r15
lea addresses_A_ht+0x1214c, %rdi
nop
add %r15, %r15
...
nop
sub %r9, %r9
lea addresses_WC_ht+0xd54c, %rsi
lea addresses_D_ht+0x1d58, %rdi
clflush (%rsi)
clflush (%rdi)
nop
nop
...
nop
and $6415, %r15
lea addresses_A_ht+0x1af68, %rcx
nop
nop
nop
and $48013, %r15
...
nop
xor $42449, %rsi
lea addresses_A_ht+0x954c, %rsi
lea addresses_A_ht+0x1ce84, %rdi
sub %rbp, %rbp
mov $86, %rcx
rep movsq
nop
...
{'OP': 'STOR', 'dst': {'same': False, 'congruent': 10, 'NT': False, 'type': 'addresses_A_ht', 'size': 32, 'AVXalign': True}}
