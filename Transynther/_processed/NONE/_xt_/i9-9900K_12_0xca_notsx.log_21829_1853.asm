...
push %rdi
push %rsi
lea addresses_WC_ht+0xe0c0, %rbx
nop
sub $61128, %rax
mov (%rbx), %r11
nop
nop
and %rcx, %rcx
lea addresses_WT_ht+0xba7c, %rsi
...
nop
xor $2933, %rax
lea addresses_UC_ht+0x1467c, %rax
nop
nop
nop
nop
...
nop
lfence
lea addresses_WC_ht+0x4464, %rbx
nop
sub %rdi, %rdi
movb (%rbx), %cl
nop
...
movups %xmm6, (%r11)
cmp %rsi, %rsi
lea addresses_D_ht+0x12b00, %rcx
nop
nop
nop
nop
...
nop
sub %rax, %rax
lea addresses_WC_ht+0x16344, %rdi
nop
nop
nop
sub $16517, %rax
...
nop
sub $34341, %r11
lea addresses_UC_ht+0x65dc, %rdi
nop
nop
nop
nop
