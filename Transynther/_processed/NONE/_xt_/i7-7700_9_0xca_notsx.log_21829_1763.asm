...
nop
and $49044, %rdx
lea addresses_WC_ht+0xac2d, %rdi
clflush (%rdi)
nop
nop
nop
...
nop
inc %rsi
lea addresses_UC_ht+0xf42d, %rdx
clflush (%rdx)
nop
nop
nop
...
nop
cmp $64416, %r9
lea addresses_UC_ht+0x191b1, %rsi
lea addresses_A_ht+0x17fcd, %rdi
clflush (%rsi)
nop
add %r10, %r10
mov $62, %rcx
...
nop
inc %rcx
lea addresses_normal_ht+0x84c5, %rsi
lea addresses_normal_ht+0x8b2d, %rdi
nop
nop
xor $54382, %rdx
mov $3, %rcx
...
nop
add %r13, %r13
lea addresses_normal_ht+0x741d, %rcx
sub %r9, %r9
movb (%rcx), %r13b
xor %r13, %r13
lea addresses_WC_ht+0x1ebed, %rcx
nop
nop
nop
sub %rsi, %rsi
...
nop
and $31213, %r13
lea addresses_A_ht+0x1d82d, %rsi
nop
nop
nop
add $22302, %r9
...
nop
xor %rsi, %rsi
lea addresses_A_ht+0x1902d, %rsi
lea addresses_A_ht+0xbbad, %rdi
clflush (%rdi)
nop
xor $14937, %r10
mov $109, %rcx
rep movsl
and %r9, %r9
lea addresses_UC_ht+0xf02d, %rsi
lea addresses_A_ht+0x1942d, %rdi
and $28908, %rdx
mov $69, %rcx
rep movsl
nop
dec %r9
lea addresses_WT_ht+0x842d, %rsi
and $23178, %rcx
mov (%rsi), %rdi
nop
nop
...
nop
and $3676, %rsi
lea addresses_D_ht+0x15e58, %r13
clflush (%r13)
nop
nop
nop
...
// Faulty Load
lea addresses_normal+0x1bc2d, %r9
nop
nop
nop
inc %r14
...
{'src': {'NT': False, 'AVXalign': False, 'size': 8, 'congruent': 9, 'same': True, 'type': 'addresses_WT_ht'}, 'OP': 'LOAD'}
