...
nop
xor $25503, %rax
lea addresses_UC_ht+0x13b63, %r8
nop
nop
nop
nop
...
nop
and %r12, %r12
lea addresses_UC_ht+0x15955, %r9
xor %r15, %r15
mov (%r9), %eax
nop
nop
...
nop
add %r15, %r15
lea addresses_normal_ht+0x7eaf, %rsi
lea addresses_D_ht+0x75cf, %rdi
nop
inc %rbx
mov $47, %rcx
rep movsw
xor %rbx, %rbx
lea addresses_normal_ht+0x10e1b, %rdi
nop
xor $3276, %rsi
movl $0x61626364, (%rdi)
nop
nop
cmp $10562, %rax
lea addresses_UC_ht+0x1442d, %rax
nop
add %rcx, %rcx
...
nop
add %r9, %r9
lea addresses_WC_ht+0xe5af, %rax
nop
nop
nop
nop
...
nop
sub %r15, %r15
lea addresses_WC_ht+0xfeaf, %rsi
lea addresses_WC_ht+0x7027, %rdi
dec %rbx
mov $77, %rcx
rep movsq
nop
...
{'dst': {'type': 'addresses_UC', 'same': False, 'size': 8, 'congruent': 0, 'NT': False, 'AVXalign': True}, 'OP': 'STOR'}
[Faulty Load]
...
{'src': {'type': 'addresses_normal_ht', 'congruent': 11, 'same': False}, 'dst': {'type': 'addresses_D_ht', 'congruent': 4, 'same': False}, 'OP': 'REPM'}
