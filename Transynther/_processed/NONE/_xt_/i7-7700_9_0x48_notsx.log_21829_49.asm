...
push %rdx
push %rsi
lea addresses_A_ht+0xd06f, %rsi
lea addresses_D_ht+0x1915f, %rdi
nop
nop
nop
nop
...
nop
inc %rsi
lea addresses_WC_ht+0xed4f, %rcx
nop
nop
cmp $26904, %rsi
movw $0x6162, (%rcx)
...
nop
and $51724, %rdi
lea addresses_UC_ht+0x19a4f, %rsi
lea addresses_WC_ht+0x12f2d, %rdi
clflush (%rsi)
nop
nop
nop
...
nop
and $42469, %rcx
lea addresses_WC_ht+0x1b0cf, %rdx
nop
sub $7599, %rdi
movb $0x61, (%rdx)
nop
...
nop
and $13214, %r13
lea addresses_normal_ht+0x6856, %r13
nop
nop
nop
sub %rdi, %rdi
...
{'OP': 'LOAD', 'src': {'same': False, 'NT': True, 'AVXalign': False, 'size': 1, 'type': 'addresses_WC_ht', 'congruent': 7}}
...
{'dst': {'same': False, 'congruent': 1, 'type': 'addresses_WC_ht'}, 'OP': 'REPM', 'src': {'same': True, 'congruent': 6, 'type': 'addresses_UC_ht'}}
