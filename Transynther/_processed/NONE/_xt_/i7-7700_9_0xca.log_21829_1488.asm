...
push %rdx
push %rsi
lea addresses_UC_ht+0x925b, %rsi
lea addresses_WC_ht+0x4ff3, %rdi
nop
xor $4346, %rax
mov $27, %rcx
rep movsw
nop
and %rsi, %rsi
lea addresses_WT_ht+0x1c4eb, %r12
clflush (%r12)
nop
nop
nop
...
nop
and %rsi, %rsi
lea addresses_WC_ht+0x8e5b, %rsi
lea addresses_WC_ht+0xe1ef, %rdi
nop
nop
nop
nop
...
// Faulty Load
lea addresses_normal+0x1865b, %r8
clflush (%r8)
nop
nop
nop
