...
push %rdi
push %rsi
lea addresses_WC_ht+0x184da, %rdi
nop
nop
nop
nop
...
nop
and $31351, %rbx
lea addresses_normal_ht+0x3fda, %rcx
nop
nop
nop
nop
...
nop
and %rbx, %rbx
lea addresses_normal_ht+0xb4da, %rsi
lea addresses_WT_ht+0x40da, %rdi
clflush (%rdi)
nop
nop
cmp $39199, %r15
...
nop
and $32072, %r13
lea addresses_normal_ht+0x30da, %rsi
nop
nop
nop
nop
...
nop
xor %rbx, %rbx
lea addresses_normal_ht+0x1e6bc, %rdi
nop
nop
xor %rbp, %rbp
mov (%rdi), %r15w
nop
add $32159, %rsi
lea addresses_WT_ht+0x1d17a, %rsi
nop
nop
nop
nop
...
// Faulty Load
lea addresses_normal+0x34da, %rbp
nop
nop
xor %r8, %r8
mov (%rbp), %rax
