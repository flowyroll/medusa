...
nop
add $49845, %r8
lea addresses_normal_ht+0x154a3, %rsi
lea addresses_D_ht+0xc7f4, %rdi
nop
nop
nop
nop
...
nop
dec %r9
lea addresses_WT_ht+0x2222, %rcx
nop
nop
nop
xor $30683, %r15
...
nop
and %r8, %r8
lea addresses_WC_ht+0x3a04, %rax
nop
nop
nop
nop
...
nop
add $38452, %r9
lea addresses_A_ht+0xfbb4, %rsi
lea addresses_UC_ht+0x8324, %rdi
inc %rbp
mov $120, %rcx
rep movsb
nop
...
nop
xor %rcx, %rcx
lea addresses_D_ht+0x6704, %rsi
lea addresses_normal_ht+0x48ae, %rdi
nop
nop
lfence
mov $41, %rcx
...
{'dst': {'same': False, 'congruent': 5, 'type': 'addresses_UC_ht'}, 'OP': 'REPM', 'src': {'same': False, 'congruent': 3, 'type': 'addresses_A_ht'}}
{'dst': {'same': True, 'congruent': 0, 'type': 'addresses_normal_ht'}, 'OP': 'REPM', 'src': {'same': False, 'congruent': 11, 'type': 'addresses_D_ht'}}
{'33': 21829}
