...
push %rdx
push %rsi
lea addresses_normal_ht+0xf5da, %rax
clflush (%rax)
nop
xor $8928, %r14
movups (%rax), %xmm6
...
nop
and %r13, %r13
lea addresses_WC_ht+0x15caa, %rsi
nop
nop
nop
xor $41675, %r14
mov (%rsi), %edx
sub $12370, %rdx
lea addresses_normal_ht+0x17caa, %rsi
nop
nop
nop
and $46192, %rdx
movb $0x61, (%rsi)
sub $13717, %r14
lea addresses_D_ht+0x15682, %rsi
nop
nop
cmp %r10, %r10
mov (%rsi), %r13w
...
nop
cmp $41035, %rax
lea addresses_WT_ht+0xb6aa, %rsi
lea addresses_A_ht+0x5e56, %rdi
nop
cmp $50013, %r13
mov $116, %rcx
rep movsw
...
nop
inc %rdi
lea addresses_D_ht+0x1d2aa, %rsi
clflush (%rsi)
nop
nop
cmp $40219, %rax
...
nop
and $7666, %rdx
lea addresses_D_ht+0x4daa, %rsi
lea addresses_D_ht+0x156da, %rdi
nop
nop
nop
nop
