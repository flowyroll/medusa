...
lea addresses_WT_ht+0x10194, %rdi
clflush (%rdi)
nop
nop
nop
...
rep movsb
and %rdx, %rdx
lea addresses_D_ht+0xc958, %rsi
lea addresses_normal_ht+0x5278, %rdi
nop
cmp $9216, %rbx
mov $56, %rcx
rep movsb
...
nop
cmp %rsi, %rsi
lea addresses_normal_ht+0x7978, %r13
nop
nop
inc %r9
mov (%r13), %si
nop
xor $3176, %r13
lea addresses_UC_ht+0x1158, %rsi
lea addresses_A_ht+0x18b98, %rdi
nop
nop
nop
nop
...
nop
inc %rsi
lea addresses_WT_ht+0xd22c, %r10
nop
nop
and $64442, %r13
movups (%r10), %xmm4
...
nop
add %rbx, %rbx
lea addresses_WC_ht+0xd870, %rcx
clflush (%rcx)
nop
xor %r10, %r10
mov (%rcx), %r9w
...
nop
cmp %rdi, %rdi
lea addresses_A_ht+0x46ba, %rsi
lea addresses_UC_ht+0xa8d8, %rdi
nop
sub %r13, %r13
mov $99, %rcx
rep movsw
nop
add %rdi, %rdi
lea addresses_A_ht+0x1abe0, %rdi
nop
nop
xor %r13, %r13
...
{'OP': 'STOR', 'dst': {'type': 'addresses_PSE', 'AVXalign': True, 'congruent': 7, 'size': 16, 'same': False, 'NT': False}}
[Faulty Load]
{'OP': 'LOAD', 'src': {'type': 'addresses_PSE', 'AVXalign': False, 'congruent': 0, 'size': 32, 'same': True, 'NT': False}}
<gen_prepare_buffer>
...
{'OP': 'STOR', 'dst': {'type': 'addresses_D_ht', 'AVXalign': True, 'congruent': 8, 'size': 1, 'same': False, 'NT': False}}
