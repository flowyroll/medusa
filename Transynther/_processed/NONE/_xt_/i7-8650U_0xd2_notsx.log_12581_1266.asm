...
push %rdi
push %rsi
lea addresses_WT_ht+0xf59e, %rsi
...
nop
xor %rbx, %rbx
lea addresses_D_ht+0xdecd, %rsi
lea addresses_WC_ht+0x6d0d, %rdi
nop
xor $60792, %rbx
mov $16, %rcx
rep movsq
...
nop
sub $11476, %rbp
lea addresses_normal_ht+0xe62d, %r11
nop
nop
nop
cmp $32626, %rcx
...
nop
sub %rsi, %rsi
lea addresses_D_ht+0xa20d, %rsi
lea addresses_normal_ht+0x1cae5, %rdi
xor $9224, %r14
mov $51, %rcx
rep movsq
nop
...
nop
sub $39156, %rbx
lea addresses_WC_ht+0x148d, %rsi
lea addresses_A_ht+0x10e0d, %rdi
clflush (%rdi)
nop
nop
nop
...
rep movsl
xor $46379, %rbp
lea addresses_WC_ht+0x18235, %rcx
nop
nop
nop
nop
...
{'OP': 'REPM', 'src': {'type': 'addresses_D_ht', 'congruent': 6, 'same': False}, 'dst': {'type': 'addresses_WC_ht', 'congruent': 7, 'same': False}}
{'OP': 'STOR', 'dst': {'type': 'addresses_normal_ht', 'size': 8, 'AVXalign': True, 'NT': True, 'congruent': 0, 'same': False}}
...
{'OP': 'STOR', 'dst': {'type': 'addresses_WC_ht', 'size': 16, 'AVXalign': True, 'NT': False, 'congruent': 8, 'same': False}}
