...
push %rdx
push %rsi
lea addresses_WT_ht+0x4cb3, %rsi
...
nop
and $53142, %r10
lea addresses_UC_ht+0xd5bb, %r11
nop
nop
add %rdx, %rdx
movb (%r11), %cl
nop
cmp %r11, %r11
lea addresses_WC_ht+0x11333, %r10
clflush (%r10)
xor %r15, %r15
...
nop
cmp %rcx, %rcx
lea addresses_WC_ht+0x1dd3f, %r11
nop
nop
nop
sub $59477, %rdi
mov (%r11), %ecx
dec %rsi
lea addresses_A_ht+0x74e3, %rsi
lea addresses_WT_ht+0x1773, %rdi
nop
xor %rbp, %rbp
mov $12, %rcx
rep movsl
...
nop
add $15832, %rcx
lea addresses_WT_ht+0x3173, %rdx
nop
and $31549, %rcx
vmovups (%rdx), %ymm5
...
nop
cmp %r11, %r11
lea addresses_WT_ht+0x7d6f, %rsi
nop
nop
nop
sub %r11, %r11
movb $0x61, (%rsi)
inc %rdi
lea addresses_WT_ht+0x1aee3, %rdi
nop
nop
nop
nop
...
<gen_prepare_buffer>
{'OP': 'REPM', 'src': {'same': False, 'congruent': 10, 'type': 'addresses_WT_ht'}, 'dst': {'same': False, 'congruent': 4, 'type': 'addresses_normal_ht'}}
...
{'OP': 'REPM', 'src': {'same': False, 'congruent': 3, 'type': 'addresses_A_ht'}, 'dst': {'same': False, 'congruent': 6, 'type': 'addresses_WT_ht'}}
