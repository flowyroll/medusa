...
push %rdi
push %rsi
lea addresses_D_ht+0x165c0, %r13
add %r12, %r12
...
nop
add %r13, %r13
lea addresses_WC_ht+0x13a94, %rsi
lea addresses_A_ht+0x10d3f, %rdi
nop
nop
lfence
mov $18, %rcx
...
nop
dec %r13
lea addresses_UC_ht+0xd790, %rsi
lea addresses_A_ht+0x1e150, %rdi
nop
nop
nop
nop
...
nop
and %rdi, %rdi
lea addresses_WT_ht+0x2fd0, %rsi
...
nop
and $13234, %rdi
lea addresses_WC_ht+0x17950, %rsi
sub $64370, %r9
vmovups (%rsi), %ymm0
...
{'src': {'type': 'addresses_UC_ht', 'congruent': 4, 'same': False}, 'OP': 'REPM', 'dst': {'type': 'addresses_A_ht', 'congruent': 11, 'same': False}}
{'src': {'type': 'addresses_WT_ht', 'congruent': 7, 'same': False}, 'OP': 'REPM', 'dst': {'type': 'addresses_A_ht', 'congruent': 2, 'same': False}}
{'src': {'type': 'addresses_WC_ht', 'AVXalign': False, 'size': 32, 'NT': False, 'same': True, 'congruent': 11}, 'OP': 'LOAD'}
{'39': 21829}
