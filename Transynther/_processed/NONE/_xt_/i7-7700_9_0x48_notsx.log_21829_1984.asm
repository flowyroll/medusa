...
nop
cmp $536, %rbx
lea addresses_UC_ht+0x5ee4, %rbp
nop
nop
nop
xor $12954, %r11
...
nop
and $57397, %r11
lea addresses_normal_ht+0x3ee4, %r11
nop
nop
inc %r10
mov (%r11), %r9d
and $44629, %r15
lea addresses_UC_ht+0x5908, %r11
nop
nop
sub %r15, %r15
vmovups (%r11), %ymm0
...
nop
cmp $37357, %rbx
lea addresses_normal_ht+0xf148, %rsi
lea addresses_normal_ht+0x40e4, %rdi
nop
nop
inc %r9
mov $10, %rcx
...
nop
sub %rsi, %rsi
lea addresses_UC_ht+0xe08c, %rsi
lea addresses_normal_ht+0x1cdd8, %rdi
nop
nop
nop
nop
...
rep movsw
dec %rax
lea addresses_UC_ht+0xa0ae, %r11
nop
nop
nop
nop
...
mov (%r11), %ecx
cmp %r11, %r11
lea addresses_WT_ht+0x6e94, %rax
clflush (%rax)
nop
nop
nop
...
{'dst': {'same': False, 'congruent': 2, 'type': 'addresses_normal_ht'}, 'OP': 'REPM', 'src': {'same': False, 'congruent': 3, 'type': 'addresses_UC_ht'}}
