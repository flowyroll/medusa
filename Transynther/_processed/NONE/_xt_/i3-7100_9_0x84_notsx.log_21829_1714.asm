...
nop
cmp $25936, %r13
lea addresses_WT_ht+0x8c77, %rsi
lea addresses_D_ht+0x19e6f, %rdi
clflush (%rsi)
nop
nop
nop
...
rep movsq
xor $42120, %rbx
lea addresses_D_ht+0xd26f, %r15
nop
cmp %r11, %r11
mov $0x6162636465666768, %r8
movq %r8, (%r15)
xor $47080, %rbx
lea addresses_WT_ht+0x6c6f, %r13
nop
nop
dec %rbx
...
nop
xor $10817, %r11
lea addresses_normal_ht+0x656f, %r8
nop
nop
nop
cmp %r11, %r11
...
// REPMOV
lea addresses_D+0x14f2f, %rsi
lea addresses_normal+0x1306f, %rdi
nop
and %r15, %r15
mov $110, %rcx
rep movsb
...
// Faulty Load
lea addresses_normal+0x1ae6f, %r8
sub $11285, %r15
mov (%r8), %cx
lea oracles, %r12
and $0xff, %rcx
...
{'src': {'type': 'addresses_D', 'congruent': 6, 'same': False}, 'dst': {'type': 'addresses_normal', 'congruent': 8, 'same': False}, 'OP': 'REPM'}
[Faulty Load]
