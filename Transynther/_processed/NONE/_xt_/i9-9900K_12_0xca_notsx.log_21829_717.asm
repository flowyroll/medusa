...
nop
add $34976, %rcx
lea addresses_normal_ht+0x116e2, %rsi
lea addresses_WT_ht+0x275e, %rdi
clflush (%rdi)
nop
nop
xor $21843, %rbp
...
nop
xor %rbx, %rbx
lea addresses_UC_ht+0xf64e, %r14
nop
nop
nop
inc %r8
...
<gen_prepare_buffer>
{'OP': 'REPM', 'src': {'same': False, 'congruent': 3, 'type': 'addresses_UC_ht'}, 'dst': {'same': False, 'congruent': 3, 'type': 'addresses_WC_ht'}}
{'OP': 'STOR', 'dst': {'same': True, 'type': 'addresses_WT_ht', 'NT': False, 'AVXalign': False, 'size': 32, 'congruent': 9}}
{'OP': 'REPM', 'src': {'same': False, 'congruent': 1, 'type': 'addresses_normal_ht'}, 'dst': {'same': False, 'congruent': 3, 'type': 'addresses_WT_ht'}}
