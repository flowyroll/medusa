...
nop
and %rdx, %rdx
lea addresses_A_ht+0x16462, %rsi
lea addresses_UC_ht+0x32e2, %rdi
nop
xor $43152, %rdx
mov $59, %rcx
rep movsl
...
<gen_prepare_buffer>
{'OP': 'STOR', 'dst': {'type': 'addresses_A_ht', 'AVXalign': True, 'size': 4, 'NT': False, 'same': False, 'congruent': 7}}
...
{'src': {'type': 'addresses_A_ht', 'AVXalign': True, 'size': 2, 'NT': False, 'same': True, 'congruent': 5}, 'OP': 'LOAD'}
{'35': 21829}
