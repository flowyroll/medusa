...
push %rdx
push %rsi
lea addresses_WC_ht+0x1510c, %rdx
nop
nop
nop
cmp %r9, %r9
movw $0x6162, (%rdx)
add %r13, %r13
lea addresses_A_ht+0x1c10c, %rsi
lea addresses_UC_ht+0x9008, %rdi
nop
nop
add $13530, %rdx
mov $114, %rcx
...
nop
cmp %r9, %r9
lea addresses_normal_ht+0x10c, %rcx
nop
nop
nop
nop
...
nop
xor $29439, %r10
lea addresses_UC_ht+0x490c, %rsi
lea addresses_WT_ht+0x16c0, %rdi
mfence
mov $36, %rcx
rep movsl
and $1677, %rax
lea addresses_D_ht+0x1b30c, %rsi
lea addresses_normal_ht+0xde3c, %rdi
nop
nop
nop
nop
...
nop
add %r10, %r10
lea addresses_D_ht+0x1e9cc, %rax
and %rdx, %rdx
mov (%rax), %esi
xor %rcx, %rcx
lea addresses_WC_ht+0x12aac, %rsi
lea addresses_UC_ht+0x98ae, %rdi
clflush (%rsi)
nop
nop
nop
...
nop
xor %r13, %r13
lea addresses_normal_ht+0x1510c, %r10
nop
nop
nop
dec %rdi
...
lea addresses_A_ht+0x1a10c, %rdi
nop
nop
nop
nop
...
nop
dec %rcx
lea addresses_WT_ht+0x8d0c, %rsi
clflush (%rsi)
nop
nop
xor %r13, %r13
...
{'OP': 'REPM', 'src': {'type': 'addresses_UC_ht', 'congruent': 11, 'same': False}, 'dst': {'type': 'addresses_WT_ht', 'congruent': 2, 'same': False}}
{'OP': 'REPM', 'src': {'type': 'addresses_D_ht', 'congruent': 9, 'same': False}, 'dst': {'type': 'addresses_normal_ht', 'congruent': 4, 'same': False}}
...
{'OP': 'STOR', 'dst': {'type': 'addresses_D_ht', 'size': 16, 'AVXalign': True, 'NT': True, 'congruent': 9, 'same': False}}
