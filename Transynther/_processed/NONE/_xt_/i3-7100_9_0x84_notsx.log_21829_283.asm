...
push %rdi
push %rsi
lea addresses_UC_ht+0x1957, %rdi
cmp $17723, %r15
vmovups (%rdi), %ymm3
...
nop
xor %r14, %r14
lea addresses_D_ht+0x123e7, %rsi
lea addresses_A_ht+0x4c13, %rdi
nop
nop
cmp $61263, %r13
mov $84, %rcx
...
nop
inc %rsi
lea addresses_normal_ht+0xf757, %r15
nop
nop
nop
add $20691, %r11
...
nop
cmp $4129, %rsi
lea addresses_UC_ht+0x1c3d7, %r14
nop
nop
and $39051, %rcx
...
nop
add $54302, %r13
lea addresses_A_ht+0x9de1, %rsi
lea addresses_D_ht+0x16d29, %rdi
nop
nop
nop
nop
...
nop
and $25076, %r14
lea addresses_D_ht+0x15757, %rdi
nop
nop
nop
nop
...
nop
xor %r13, %r13
lea addresses_A_ht+0x1a957, %rsi
...
nop
xor $41840, %rsi
lea addresses_WC_ht+0x3757, %rdi
xor %r14, %r14
vmovups (%rdi), %ymm1
...
nop
dec %rcx
lea addresses_normal_ht+0x14757, %r10
nop
nop
nop
nop
...
nop
cmp $18543, %r14
lea addresses_normal_ht+0xf2d7, %rsi
lea addresses_UC_ht+0x17357, %rdi
nop
cmp %r10, %r10
mov $92, %rcx
rep movsl
...
nop
cmp $41788, %r13
lea addresses_normal_ht+0x15557, %r14
dec %rsi
mov $0x6162636465666768, %r10
movq %r10, %xmm1
movups %xmm1, (%r14)
mfence
lea addresses_UC_ht+0x18757, %r13
clflush (%r13)
nop
nop
nop
...
{'src': {'type': 'addresses_D_ht', 'congruent': 4, 'same': False}, 'dst': {'type': 'addresses_A_ht', 'congruent': 0, 'same': False}, 'OP': 'REPM'}
...
{'src': {'type': 'addresses_D_ht', 'same': True, 'size': 16, 'congruent': 10, 'NT': False, 'AVXalign': False}, 'OP': 'LOAD'}
...
{'src': {'type': 'addresses_normal_ht', 'congruent': 7, 'same': False}, 'dst': {'type': 'addresses_UC_ht', 'congruent': 9, 'same': False}, 'OP': 'REPM'}
