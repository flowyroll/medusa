...
push %rdi
push %rsi
lea addresses_WC_ht+0xaf69, %rsi
lea addresses_WT_ht+0xdc79, %rdi
nop
nop
nop
nop
...
nop
and %rbp, %rbp
lea addresses_WC_ht+0x4d79, %rdi
nop
nop
nop
dec %r11
mov (%rdi), %rsi
and %rax, %rax
lea addresses_WC_ht+0xcc39, %rdi
nop
nop
nop
nop
...
nop
add %rbp, %rbp
lea addresses_A_ht+0x10c79, %rax
sub $28568, %rsi
movl $0x61626364, (%rax)
nop
nop
nop
sub %r14, %r14
lea addresses_WC_ht+0x1ab9, %rsi
lea addresses_WC_ht+0x5bd9, %rdi
nop
nop
sub $59645, %rax
mov $3, %rcx
...
// Store
lea addresses_normal+0x1bc79, %rdx
cmp %r12, %r12
movl $0x51525354, (%rdx)
sub %r14, %r14

// Faulty Load
lea addresses_WT+0xac79, %r11
nop
nop
nop
nop
