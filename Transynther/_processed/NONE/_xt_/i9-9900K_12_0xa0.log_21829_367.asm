...
push %rdx
push %rsi
lea addresses_A_ht+0x9e6, %rbx
clflush (%rbx)
add %rdi, %rdi
mov (%rbx), %dx
add $31607, %rbx
lea addresses_D_ht+0xee6, %r12
nop
nop
sub $23335, %rbp
...
nop
xor %r11, %r11
lea addresses_WT_ht+0x1eb46, %rdi
nop
nop
nop
nop
...
nop
and %r11, %r11
lea addresses_WT_ht+0xbec6, %rbp
nop
nop
nop
nop
...
nop
xor $46596, %r11
lea addresses_UC_ht+0x10c46, %rsi
...
rep movsb
and $4897, %rcx
lea addresses_D_ht+0x1b046, %rbp
nop
nop
nop
inc %rcx
...
<gen_prepare_buffer>
{'src': {'NT': False, 'same': True, 'congruent': 5, 'type': 'addresses_A_ht', 'AVXalign': False, 'size': 2}, 'OP': 'LOAD'}
...
{'src': {'same': False, 'congruent': 9, 'type': 'addresses_UC_ht'}, 'OP': 'REPM', 'dst': {'same': False, 'congruent': 2, 'type': 'addresses_UC_ht'}}
{'src': {'NT': False, 'same': False, 'congruent': 3, 'type': 'addresses_D_ht', 'AVXalign': False, 'size': 1}, 'OP': 'LOAD'}
{'src': {'same': False, 'congruent': 10, 'type': 'addresses_normal_ht'}, 'OP': 'REPM', 'dst': {'same': False, 'congruent': 4, 'type': 'addresses_A_ht'}}
