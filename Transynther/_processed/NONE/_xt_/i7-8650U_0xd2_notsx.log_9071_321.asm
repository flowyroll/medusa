...
lea addresses_UC_ht+0x1bf0d, %rdi
nop
and %r11, %r11
mov $93, %rcx
rep movsl
...
movl $0x61626364, (%r10)
dec %r10
lea addresses_WT_ht+0x17bb9, %rsi
lea addresses_D_ht+0x1d355, %rdi
cmp %r8, %r8
mov $59, %rcx
rep movsb
nop
...
nop
xor $13355, %rcx
lea addresses_WT_ht+0x2f55, %rsi
lea addresses_WC_ht+0x17bd5, %rdi
clflush (%rdi)
sub $2403, %r10
mov $53, %rcx
rep movsl
