...
push %rdi
push %rsi
lea addresses_UC_ht+0x15c35, %r10
nop
nop
nop
nop
...
nop
add %r10, %r10
lea addresses_A_ht+0x1e9b5, %rdi
clflush (%rdi)
nop
nop
and $18341, %r10
...
nop
dec %r9
lea addresses_WC_ht+0x159b5, %rdi
nop
nop
cmp $28694, %rcx
...
movq %r13, (%rdi)
cmp $38055, %r9
lea addresses_D_ht+0x18d35, %rcx
nop
nop
nop
nop
...
nop
add $26683, %r9
lea addresses_UC_ht+0xbf35, %r13
nop
sub %r14, %r14
movb $0x61, (%r13)
nop
add %r13, %r13
lea addresses_WT_ht+0xeea3, %rdi
nop
nop
nop
nop
...
mov (%r14), %r9w
cmp $23055, %r14
lea addresses_D_ht+0x1c755, %rsi
lea addresses_A_ht+0xaa04, %rdi
nop
nop
sub %r14, %r14
mov $14, %rcx
...
nop
and %rdi, %rdi
lea addresses_normal_ht+0x1e9b5, %rsi
...
nop
xor %r14, %r14
lea addresses_A_ht+0x16785, %rdi
add $24896, %r9
mov (%rdi), %ax
nop
nop
xor %rdi, %rdi
lea addresses_A_ht+0x85a1, %r13
clflush (%r13)
nop
nop
nop
...
nop
cmp %r13, %r13
lea addresses_normal_ht+0x6ca5, %r10
nop
and $55244, %r9
...
// REPMOV
lea addresses_RW+0x1c975, %rsi
lea addresses_RW+0xaab5, %rdi
nop
nop
nop
nop
...
// Store
lea addresses_normal+0xeae5, %rbx
nop
nop
nop
nop
...
{'OP': 'REPM', 'src': {'same': False, 'congruent': 5, 'type': 'addresses_RW'}, 'dst': {'same': True, 'congruent': 0, 'type': 'addresses_RW'}}
{'OP': 'STOR', 'dst': {'same': False, 'type': 'addresses_normal', 'NT': False, 'AVXalign': False, 'size': 1, 'congruent': 3}}
{'OP': 'LOAD', 'src': {'same': False, 'type': 'addresses_WT', 'NT': True, 'AVXalign': False, 'size': 32, 'congruent': 5}}
...
{'OP': 'STOR', 'dst': {'same': True, 'type': 'addresses_WC_ht', 'NT': False, 'AVXalign': False, 'size': 8, 'congruent': 8}}
...
{'OP': 'REPM', 'src': {'same': False, 'congruent': 8, 'type': 'addresses_normal_ht'}, 'dst': {'same': False, 'congruent': 4, 'type': 'addresses_normal_ht'}}
{'OP': 'LOAD', 'src': {'same': True, 'type': 'addresses_A_ht', 'NT': False, 'AVXalign': False, 'size': 2, 'congruent': 4}}
