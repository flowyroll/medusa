...
push %rdi
push %rsi
lea addresses_WT_ht+0x9dec, %rsi
lea addresses_D_ht+0x1b1b4, %rdi
nop
nop
nop
nop
...
lea addresses_normal_ht+0x1e5f4, %rdi
nop
nop
nop
nop
...
nop
inc %rbx
lea addresses_WC_ht+0x181f4, %rsi
lea addresses_WC_ht+0xe544, %rdi
nop
nop
nop
nop
...
rep movsw
mfence
lea addresses_UC_ht+0x11bd4, %rdi
nop
nop
nop
xor $22623, %rsi
...
<gen_prepare_buffer>
{'dst': {'same': True, 'congruent': 3, 'type': 'addresses_D_ht'}, 'OP': 'REPM', 'src': {'same': False, 'congruent': 3, 'type': 'addresses_WT_ht'}}
