...
push %rdx
push %rsi
lea addresses_normal_ht+0x1bb28, %rdx
nop
nop
nop
nop
...
nop
cmp $3158, %rsi
lea addresses_WC_ht+0xa2c8, %rsi
nop
nop
nop
add %rdi, %rdi
...
nop
sub $26845, %rsi
lea addresses_UC_ht+0x1aa4c, %rbp
sub $17032, %rdx
...
nop
inc %r12
lea addresses_normal_ht+0xe48, %rdx
nop
nop
nop
nop
...
mov (%rdx), %r12d
dec %rsi
lea addresses_normal_ht+0x7c48, %r10
nop
nop
nop
nop
...
nop
cmp %rdx, %rdx
lea addresses_WT_ht+0x15160, %rsi
lea addresses_WT_ht+0xc288, %rdi
nop
nop
nop
and $43470, %r12
...
// Store
lea addresses_normal+0x15f98, %rbx
nop
nop
inc %r15
movl $0x51525354, (%rbx)
...
{'OP': 'STOR', 'dst': {'same': False, 'congruent': 10, 'NT': False, 'type': 'addresses_WC', 'size': 16, 'AVXalign': True}}
[Faulty Load]
...
{'OP': 'STOR', 'dst': {'same': True, 'congruent': 9, 'NT': False, 'type': 'addresses_A_ht', 'size': 4, 'AVXalign': False}}
...
{'src': {'type': 'addresses_WT_ht', 'congruent': 3, 'same': False}, 'OP': 'REPM', 'dst': {'type': 'addresses_WT_ht', 'congruent': 6, 'same': True}}
{'39': 21829}
