...
push %rdi
push %rsi
lea addresses_WT_ht+0xc486, %r12
nop
nop
nop
nop
...
nop
and $22359, %rax
lea addresses_normal_ht+0xce46, %rdi
nop
nop
mfence
movb $0x61, (%rdi)
...
nop
cmp $46987, %r11
lea addresses_WC_ht+0x1e494, %rdi
nop
nop
nop
nop
...
nop
dec %r12
lea addresses_normal_ht+0xf6d6, %rdi
nop
nop
nop
nop
...
movb (%rdi), %r12b
and $14427, %r14
lea addresses_A_ht+0x198b6, %rsi
lea addresses_WT_ht+0x3ac6, %rdi
nop
nop
nop
nop
...
nop
and %r14, %r14
lea addresses_D_ht+0x18086, %rax
nop
add $30277, %r14
movb $0x61, (%rax)
nop
...
nop
cmp $20320, %rax
lea addresses_normal_ht+0x119ae, %rsi
lea addresses_WC_ht+0x15ac6, %rdi
clflush (%rdi)
inc %r12
mov $10, %rcx
rep movsl
...
nop
sub %rsi, %rsi
lea addresses_WT_ht+0x1413a, %r12
nop
nop
nop
nop
...
{'dst': {'type': 'addresses_A', 'same': True, 'size': 16, 'congruent': 7, 'NT': False, 'AVXalign': False}, 'OP': 'STOR'}
[Faulty Load]
...
{'src': {'type': 'addresses_normal_ht', 'congruent': 1, 'same': False}, 'dst': {'type': 'addresses_WC_ht', 'congruent': 11, 'same': False}, 'OP': 'REPM'}
