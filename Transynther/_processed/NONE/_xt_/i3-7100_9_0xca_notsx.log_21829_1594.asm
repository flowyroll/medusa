...
nop
sub $20750, %r14
lea addresses_D_ht+0x1332b, %rsi
lea addresses_D_ht+0x7543, %rdi
nop
nop
nop
nop
...
nop
xor %r11, %r11
lea addresses_UC_ht+0xa89b, %rsi
lea addresses_UC_ht+0x11ce3, %rdi
clflush (%rdi)
nop
nop
nop
...
nop
xor %rsi, %rsi
lea addresses_A_ht+0x151e3, %r14
nop
nop
nop
nop
...
nop
sub %r8, %r8
lea addresses_WC_ht+0x1c45b, %r14
nop
nop
add $22720, %r15
and $0xffffffffffffffc0, %r14
