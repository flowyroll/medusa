...
nop
sub $62195, %rsi
lea addresses_UC_ht+0x17930, %r12
xor %rdi, %rdi
...
nop
cmp %r10, %r10
lea addresses_WC_ht+0x15c32, %r10
cmp $17285, %rbx
movl $0x61626364, (%r10)
nop
nop
...
nop
add $22036, %rbx
lea addresses_normal_ht+0xcb52, %rsi
...
nop
add %r10, %r10
lea addresses_WC_ht+0x1abf2, %r10
nop
nop
inc %r12
mov (%r10), %rdi
...
nop
cmp $13697, %r12
lea addresses_A_ht+0x9432, %rsi
lea addresses_D_ht+0x1e42, %rdi
nop
nop
sub $3345, %rbx
mov $118, %rcx
...
nop
add %r12, %r12
lea addresses_normal_ht+0xb4c2, %rsi
lea addresses_normal_ht+0x24d2, %rdi
nop
nop
nop
nop
...
nop
sub $5554, %rbx
lea addresses_normal_ht+0xec12, %rsi
lea addresses_normal_ht+0x110d2, %rdi
nop
nop
add $32661, %rbx
mov $86, %rcx
...
{'src': {'type': 'addresses_WC_ht', 'congruent': 0, 'same': False}, 'dst': {'type': 'addresses_A_ht', 'congruent': 9, 'same': False}, 'OP': 'REPM'}
