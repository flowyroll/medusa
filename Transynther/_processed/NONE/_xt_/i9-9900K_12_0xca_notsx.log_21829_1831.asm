...
nop
dec %rax
lea addresses_WC_ht+0xf24e, %rsi
lea addresses_UC_ht+0x1eb8e, %rdi
nop
nop
nop
nop
...
nop
cmp %r13, %r13
lea addresses_WC_ht+0x1a33e, %r13
and $42205, %rsi
mov (%r13), %rax
nop
nop
...
nop
cmp %r13, %r13
lea addresses_UC_ht+0x286, %rsi
lea addresses_A_ht+0x58c7, %rdi
nop
nop
add $53652, %rax
mov $1, %rcx
...
nop
and $33322, %rbx
lea addresses_normal_ht+0xfb4e, %rsi
and %rcx, %rcx
mov (%rsi), %r10d
nop
cmp %rdi, %rdi
lea addresses_WC_ht+0x1a27e, %rbx
nop
nop
nop
and $59951, %r13
...
nop
inc %rcx
lea addresses_A_ht+0x1c1ce, %rsi
nop
nop
and $18548, %rdi
mov (%rsi), %ax
...
{'OP': 'STOR', 'dst': {'same': True, 'type': 'addresses_D_ht', 'NT': False, 'AVXalign': False, 'size': 4, 'congruent': 8}}
