...
push %rdi
push %rsi
lea addresses_UC_ht+0x1ed41, %rsi
...
nop
add %rsi, %rsi
lea addresses_UC_ht+0x1c541, %r14
clflush (%r14)
cmp $60932, %rbp
mov (%r14), %r8d
nop
...
nop
sub $55305, %r8
lea addresses_normal_ht+0x14981, %rsi
nop
nop
nop
nop
...
nop
and %rsi, %rsi
lea addresses_normal_ht+0x1ed81, %rsi
lea addresses_D_ht+0x14f41, %rdi
nop
nop
nop
nop
...
rep movsw
sub $42586, %r15
lea addresses_WT_ht+0xcaf1, %r14
nop
nop
xor $55553, %rbp
movb $0x61, (%r14)
...
nop
cmp %rdi, %rdi
lea addresses_A_ht+0x1b674, %rsi
lea addresses_WT_ht+0x12d1, %rdi
nop
and %rbp, %rbp
mov $117, %rcx
rep movsq
...
nop
cmp $15810, %rcx
lea addresses_D_ht+0x1eac7, %rcx
nop
nop
sub $37568, %r14
movb $0x61, (%rcx)
...
// Faulty Load
lea addresses_normal+0x19d41, %r15
clflush (%r15)
nop
cmp $45553, %rdi
mov (%r15), %r11d
...
{'OP': 'LOAD', 'src': {'type': 'addresses_D_ht', 'AVXalign': False, 'congruent': 10, 'size': 16, 'same': False, 'NT': True}}
