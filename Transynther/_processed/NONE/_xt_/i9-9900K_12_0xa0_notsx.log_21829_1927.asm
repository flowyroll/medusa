...
nop
cmp $18605, %rcx
lea addresses_WT_ht+0x2a15, %rdi
nop
nop
nop
cmp $25804, %r13
movl $0x61626364, (%rdi)
and $48296, %rcx
lea addresses_WT_ht+0xda75, %r11
nop
nop
nop
cmp $14272, %r13
...
movq %rdi, (%r11)
and $8367, %r15
lea addresses_WT_ht+0x14275, %rdi
nop
add $49644, %rsi
mov (%rdi), %rcx
nop
...
nop
sub %rsi, %rsi
lea addresses_WT_ht+0x4d35, %r15
nop
nop
nop
xor %r11, %r11
...
nop
xor %r11, %r11
lea addresses_normal_ht+0x18475, %rsi
lea addresses_WT_ht+0x1775, %rdi
clflush (%rsi)
nop
sub %r13, %r13
mov $114, %rcx
...
{'OP': 'STOR', 'dst': {'type': 'addresses_UC_ht', 'AVXalign': True, 'size': 1, 'NT': False, 'same': False, 'congruent': 7}}
...
{'src': {'type': 'addresses_normal_ht', 'congruent': 9, 'same': True}, 'OP': 'REPM', 'dst': {'type': 'addresses_WT_ht', 'congruent': 8, 'same': False}}
{'37': 21829}
