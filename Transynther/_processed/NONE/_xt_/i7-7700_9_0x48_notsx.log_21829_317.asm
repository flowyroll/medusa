...
push %rdi
push %rsi
lea addresses_WT_ht+0x1c6f5, %r8
xor $63410, %r11
...
nop
add $47552, %rsi
lea addresses_UC_ht+0x459d, %rsi
lea addresses_A_ht+0x8af5, %rdi
nop
cmp $24283, %r13
mov $29, %rcx
rep movsw
...
nop
dec %rcx
lea addresses_WT_ht+0x1d9d3, %rsi
nop
nop
nop
cmp %r12, %r12
...
nop
inc %rsi
lea addresses_D_ht+0x165b5, %r11
nop
nop
nop
nop
...
nop
xor %r11, %r11
lea addresses_UC_ht+0x34f5, %rsi
lea addresses_normal_ht+0xd6f5, %rdi
nop
nop
nop
nop
...
nop
and %r13, %r13
lea addresses_D_ht+0x350d, %rsi
lea addresses_A_ht+0x1d39, %rdi
xor $64112, %r13
mov $103, %rcx
rep movsb
nop
...
// Store
lea addresses_normal+0x1a96d, %r10
nop
nop
cmp %r15, %r15
movl $0x51525354, (%r10)
...
{'dst': {'same': False, 'congruent': 11, 'type': 'addresses_A_ht'}, 'OP': 'REPM', 'src': {'same': False, 'congruent': 3, 'type': 'addresses_UC_ht'}}
...
{'dst': {'same': False, 'congruent': 2, 'type': 'addresses_A_ht'}, 'OP': 'REPM', 'src': {'same': False, 'congruent': 0, 'type': 'addresses_D_ht'}}
