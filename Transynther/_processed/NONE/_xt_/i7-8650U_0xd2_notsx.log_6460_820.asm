...
lea addresses_WT_ht+0x15487, %rdi
xor $20463, %r9
mov $4, %rcx
rep movsq
nop
...
nop
cmp %r12, %r12
lea addresses_normal_ht+0x150e7, %rax
nop
nop
add $17033, %r14
vmovups (%rax), %ymm1
...
nop
and $29209, %r9
lea addresses_UC_ht+0x14603, %rsi
nop
nop
nop
nop
...
nop
xor %rcx, %rcx
lea addresses_UC_ht+0x151a1, %rsi
lea addresses_normal_ht+0x5d43, %rdi
sub $45684, %r12
mov $28, %rcx
rep movsb
nop
cmp %rcx, %rcx
lea addresses_WT_ht+0x173c3, %rcx
nop
nop
nop
dec %r9
...
nop
and %rcx, %rcx
lea addresses_A_ht+0x1c843, %rsi
lea addresses_WC_ht+0x7e03, %rdi
nop
xor %rdx, %rdx
mov $16, %rcx
rep movsl
and %rdi, %rdi
lea addresses_normal_ht+0x1243, %rdi
clflush (%rdi)
nop
nop
sub %rax, %rax
...
nop
cmp $11618, %r9
lea addresses_WC_ht+0x132d3, %rcx
nop
nop
and $60567, %r14
movw $0x6162, (%rcx)
...
nop
xor %rdx, %rdx
lea addresses_A_ht+0x16b13, %rsi
lea addresses_WC_ht+0x11e43, %rdi
add %r14, %r14
mov $102, %rcx
rep movsw
nop
...
nop
xor $57480, %r12
lea addresses_WC_ht+0x131d1, %rsi
lea addresses_UC_ht+0xe43, %rdi
nop
nop
nop
nop
...
nop
xor %rsi, %rsi
lea addresses_WC_ht+0xf843, %rdx
nop
nop
nop
nop
...
// REPMOV
lea addresses_D+0x7bc3, %rsi
lea addresses_D+0x14443, %rdi
nop
nop
nop
and %r10, %r10
...
// Faulty Load
lea addresses_normal+0x10643, %rdi
add %rsi, %rsi
mov (%rdi), %r9w
lea oracles, %rcx
and $0xff, %r9
...
{'OP': 'REPM', 'src': {'type': 'addresses_D', 'congruent': 6, 'same': False}, 'dst': {'type': 'addresses_D', 'congruent': 6, 'same': False}}
[Faulty Load]
{'OP': 'LOAD', 'src': {'type': 'addresses_normal', 'size': 2, 'AVXalign': False, 'NT': False, 'congruent': 0, 'same': True}}
<gen_prepare_buffer>
{'OP': 'REPM', 'src': {'type': 'addresses_A_ht', 'congruent': 5, 'same': False}, 'dst': {'type': 'addresses_WT_ht', 'congruent': 1, 'same': False}}
...
{'OP': 'LOAD', 'src': {'type': 'addresses_WT_ht', 'size': 1, 'AVXalign': True, 'NT': True, 'congruent': 7, 'same': False}}
...
{'OP': 'REPM', 'src': {'type': 'addresses_A_ht', 'congruent': 3, 'same': False}, 'dst': {'type': 'addresses_WC_ht', 'congruent': 7, 'same': False}}
