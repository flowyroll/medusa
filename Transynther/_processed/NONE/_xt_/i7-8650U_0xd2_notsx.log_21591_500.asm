...
push %rdi
push %rsi
lea addresses_WC_ht+0xdd32, %rsi
lea addresses_WC_ht+0x70d0, %rdi
nop
nop
nop
xor %r12, %r12
...
rep movsq
xor $30240, %r12
lea addresses_normal_ht+0x1bd52, %rsi
clflush (%rsi)
nop
xor $17607, %rax
...
movb $0x61, (%rbp)
dec %r12
lea addresses_WC_ht+0x1c352, %rax
inc %rsi
mov (%rax), %rbp
nop
nop
...
nop
xor $35095, %rax
lea addresses_WT_ht+0xf952, %rbp
nop
nop
nop
nop
...
movw $0x6162, (%rbp)
and %rsi, %rsi
lea addresses_UC_ht+0x178f2, %rbp
nop
nop
nop
dec %rcx
...
<gen_prepare_buffer>
{'OP': 'REPM', 'src': {'type': 'addresses_WC_ht', 'congruent': 3, 'same': True}, 'dst': {'type': 'addresses_WC_ht', 'congruent': 0, 'same': False}}
