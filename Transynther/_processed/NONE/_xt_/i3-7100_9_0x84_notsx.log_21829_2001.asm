...
push %rdi
push %rsi
lea addresses_WT_ht+0x140e, %r11
nop
nop
nop
nop
...
nop
add $5725, %r13
lea addresses_WT_ht+0xb424, %r13
nop
nop
nop
nop
...
lea addresses_WT_ht+0xf7b4, %rdi
add %r15, %r15
mov $68, %rcx
rep movsq
cmp %r10, %r10
lea addresses_WC_ht+0xd90c, %rsi
lea addresses_WC_ht+0x9224, %rdi
clflush (%rsi)
nop
xor $33229, %r13
mov $26, %rcx
...
nop
add $46916, %rdi
lea addresses_WT_ht+0x1dad4, %rsi
lea addresses_A_ht+0x1d724, %rdi
nop
nop
nop
cmp %r12, %r12
...
nop
dec %r15
lea addresses_UC_ht+0xbcae, %r15
clflush (%r15)
nop
nop
nop
...
// Load
lea addresses_normal+0xaf34, %rax
nop
and $17057, %rdi
vmovups (%rax), %ymm3
...
// REPMOV
lea addresses_A+0x16af0, %rsi
lea addresses_WT+0x11a24, %rdi
clflush (%rdi)
nop
nop
mfence
...
// REPMOV
lea addresses_PSE+0x14224, %rsi
lea addresses_normal+0xca4, %rdi
nop
nop
nop
sub %rbp, %rbp
...
{'dst': {'type': 'addresses_WT', 'same': False, 'size': 1, 'congruent': 2, 'NT': True, 'AVXalign': False}, 'OP': 'STOR'}
...
{'src': {'type': 'addresses_A', 'congruent': 2, 'same': False}, 'dst': {'type': 'addresses_WT', 'congruent': 10, 'same': False}, 'OP': 'REPM'}
{'src': {'type': 'addresses_PSE', 'congruent': 9, 'same': False}, 'dst': {'type': 'addresses_normal', 'congruent': 7, 'same': False}, 'OP': 'REPM'}
...
{'src': {'type': 'addresses_WC_ht', 'congruent': 1, 'same': True}, 'dst': {'type': 'addresses_WC_ht', 'congruent': 11, 'same': True}, 'OP': 'REPM'}
