...
push %rdi
push %rsi
lea addresses_UC_ht+0xe16a, %rax
nop
nop
xor $51912, %r13
movl $0x61626364, (%rax)
...
nop
sub $4788, %r13
lea addresses_normal_ht+0xcb8c, %r13
nop
nop
nop
add $37582, %r10
...
nop
dec %r8
lea addresses_WC_ht+0x15dea, %r8
clflush (%r8)
nop
nop
nop
...
nop
and %rdi, %rdi
lea addresses_D_ht+0x1b36a, %rsi
lea addresses_WC_ht+0x1d76a, %rdi
nop
nop
nop
nop
...
nop
xor $17832, %r8
lea addresses_A_ht+0x1166a, %r13
nop
nop
sub $19150, %rax
mov (%r13), %r9d
...
nop
cmp %rsi, %rsi
lea addresses_A_ht+0x6f86, %rsi
lea addresses_normal_ht+0x876a, %rdi
and %r8, %r8
mov $100, %rcx
rep movsb
nop
...
nop
sub $10824, %rdi
lea addresses_A_ht+0x1746a, %r13
nop
nop
nop
nop
...
nop
and $16685, %rcx
lea addresses_WC_ht+0xd86a, %r10
xor %r8, %r8
movb (%r10), %r9b
nop
nop
nop
and %rax, %rax
lea addresses_normal_ht+0x182ea, %rsi
sub %r10, %r10
vmovups (%rsi), %ymm3
...
nop
and $61762, %rdi
lea addresses_UC_ht+0x100c2, %rdi
nop
nop
nop
inc %r9
...
// Load
lea addresses_D+0x1a36a, %rdx
cmp $29283, %rcx
mov (%rdx), %r11d
dec %r12

// Faulty Load
lea addresses_D+0x1a36a, %rcx
nop
nop
nop
and $20537, %r10
...
<gen_prepare_buffer>
{'OP': 'STOR', 'dst': {'same': False, 'congruent': 7, 'NT': False, 'type': 'addresses_UC_ht', 'size': 4, 'AVXalign': True}}
