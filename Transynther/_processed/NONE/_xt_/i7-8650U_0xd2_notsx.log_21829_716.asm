...
push %rdi
push %rdx
lea addresses_WC_ht+0x9739, %rax
nop
nop
nop
nop
...
nop
sub %rbx, %rbx
lea addresses_WT_ht+0x11739, %r9
nop
nop
inc %r15
...
nop
sub $39218, %rbx
lea addresses_UC_ht+0x1a39, %r14
nop
nop
xor %rdi, %rdi
mov $0x6162636465666768, %rax
...
nop
add $35289, %r14
lea addresses_WC_ht+0x13b01, %r15
nop
nop
nop
nop
...
nop
sub %rdi, %rdi
lea addresses_normal_ht+0x1dd79, %r9
nop
nop
dec %r14
...
nop
xor %rdi, %rdi
lea addresses_normal_ht+0x2f39, %rdx
and $56339, %r9
mov (%rdx), %rdi
nop
nop
...
nop
add $53365, %rbx
lea addresses_WC_ht+0xf0b9, %rax
nop
inc %r14
movb (%rax), %dl
nop
nop
inc %rdi
lea addresses_normal_ht+0x1af39, %rax
nop
nop
cmp $58393, %rdx
movups (%rax), %xmm2
