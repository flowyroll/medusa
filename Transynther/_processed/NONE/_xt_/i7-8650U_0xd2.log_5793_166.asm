...
push %rdi
push %rsi
lea addresses_WT_ht+0x122fb, %rbp
clflush (%rbp)
nop
nop
nop
...
nop
sub %r9, %r9
lea addresses_normal_ht+0x18e67, %r13
nop
add %r8, %r8
vmovups (%r13), %ymm3
...
nop
xor $26971, %r8
lea addresses_WC_ht+0xb62f, %rbx
nop
nop
nop
nop
...
nop
sub $4250, %r8
lea addresses_D_ht+0xb3f7, %rsi
lea addresses_normal_ht+0x6677, %rdi
nop
nop
nop
nop
...
nop
xor $10334, %r9
lea addresses_normal_ht+0x1e22f, %rsi
lea addresses_D_ht+0xb7ef, %rdi
nop
nop
add $19254, %rbp
mov $68, %rcx
...
nop
dec %rcx
lea addresses_WT_ht+0xafb9, %rsi
lea addresses_UC_ht+0xb1c3, %rdi
nop
nop
add $10718, %r9
mov $84, %rcx
...
nop
and $65297, %rdi
lea addresses_UC_ht+0xd42f, %rsi
lea addresses_WT_ht+0x1112f, %rdi
nop
nop
xor $25132, %r8
mov $26, %rcx
...
nop
add %rdi, %rdi
lea addresses_UC_ht+0x103f7, %rsi
lea addresses_WT_ht+0x1e65f, %rdi
clflush (%rsi)
clflush (%rdi)
nop
dec %r9
...
nop
sub $41016, %rsi
lea addresses_D_ht+0x1a07f, %rsi
lea addresses_D_ht+0xb0af, %rdi
clflush (%rdi)
nop
add $13503, %r9
mov $121, %rcx
...
nop
cmp $12871, %r9
lea addresses_WC_ht+0xc18a, %rsi
lea addresses_UC_ht+0x7cb3, %rdi
nop
nop
nop
nop
...
nop
sub %rbx, %rbx
lea addresses_A_ht+0xb795, %rsi
lea addresses_normal_ht+0xd92f, %rdi
nop
xor $47863, %rbp
mov $125, %rcx
rep movsw
...
// Load
lea addresses_normal+0x19c2f, %r10
nop
nop
nop
nop
...
// Faulty Load
lea addresses_normal+0x19c2f, %rcx
nop
nop
nop
nop
...
{'OP': 'REPM', 'src': {'type': 'addresses_WT_ht', 'congruent': 0, 'same': True}, 'dst': {'type': 'addresses_UC_ht', 'congruent': 1, 'same': False}}
{'OP': 'REPM', 'src': {'type': 'addresses_UC_ht', 'congruent': 10, 'same': False}, 'dst': {'type': 'addresses_WT_ht', 'congruent': 7, 'same': False}}
...
{'OP': 'REPM', 'src': {'type': 'addresses_WC_ht', 'congruent': 0, 'same': False}, 'dst': {'type': 'addresses_UC_ht', 'congruent': 2, 'same': False}}
