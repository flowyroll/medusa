...
push %rdx
push %rsi
lea addresses_WT_ht+0xcfdf, %rsi
lea addresses_WT_ht+0x1517, %rdi
nop
sub %rdx, %rdx
mov $90, %rcx
rep movsq
nop
xor %rdi, %rdi
lea addresses_D_ht+0xb3, %r13
cmp %rdi, %rdi
mov (%r13), %r8w
nop
cmp %rdi, %rdi
lea addresses_normal_ht+0x79d7, %rsi
lea addresses_WC_ht+0x25af, %rdi
nop
nop
nop
nop
...
// Faulty Load
lea addresses_normal+0xc517, %r14
clflush (%r14)
nop
nop
nop
