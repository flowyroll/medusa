...
lea addresses_normal_ht+0x1501c, %rdi
nop
nop
nop
nop
...
nop
and $11895, %rcx
lea addresses_WC_ht+0x813c, %r11
nop
nop
nop
cmp $39027, %r10
...
vpextrq $0, %xmm4, %rdi
and %rcx, %rcx
lea addresses_UC_ht+0x401c, %rsi
lea addresses_normal_ht+0xb61c, %rdi
nop
nop
nop
and %rbx, %rbx
...
nop
inc %r12
lea addresses_WC_ht+0x611c, %rcx
nop
nop
nop
and $45615, %r10
...
nop
sub %rdi, %rdi
lea addresses_WC_ht+0xf81c, %rbx
clflush (%rbx)
cmp %r12, %r12
mov (%rbx), %r10w
nop
...
nop
and $35686, %r11
lea addresses_D_ht+0xf01c, %r11
add $63918, %r12
movb (%r11), %cl
nop
add $49810, %r10
lea addresses_A_ht+0x1041c, %r11
nop
nop
nop
xor %r12, %r12
...
nop
cmp $53410, %rsi
lea addresses_WT_ht+0x47f9, %rsi
...
rep movsq
cmp $25897, %r10
lea addresses_WC_ht+0x1dcdc, %r10
clflush (%r10)
nop
nop
nop
...
nop
and %rcx, %rcx
lea addresses_WC_ht+0x1d61c, %rcx
add %r12, %r12
movb (%rcx), %bl
nop
nop
nop
sub $5289, %r12
lea addresses_WC_ht+0x881c, %rdi
nop
nop
nop
nop
