...
nop
xor $55808, %rbp
lea addresses_WC_ht+0x174a3, %r10
nop
nop
cmp $15914, %r12
movl $0x61626364, (%r10)
...
nop
xor $26855, %rdi
lea addresses_UC_ht+0x155fb, %rbx
nop
nop
nop
nop
...
mov (%rbx), %r12w
and $44292, %r15
lea addresses_UC_ht+0x63c3, %rsi
...
nop
add %rcx, %rcx
lea addresses_normal_ht+0x71c3, %rbx
nop
nop
nop
dec %rdi
...
{'src': {'type': 'addresses_UC_ht', 'congruent': 9, 'same': False}, 'OP': 'REPM', 'dst': {'type': 'addresses_D_ht', 'congruent': 3, 'same': False}}
