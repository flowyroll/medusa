...
movw $0x6162, (%r9)
cmp %rbx, %rbx
lea addresses_A_ht+0x1dae4, %rdx
nop
nop
nop
and $62195, %r8
...
nop
xor $40682, %r8
lea addresses_WC_ht+0x9384, %rdx
nop
nop
nop
sub %rdi, %rdi
...
lea addresses_normal_ht+0xcce4, %rdi
nop
nop
sub %rdx, %rdx
mov $69, %rcx
...
nop
cmp %r15, %r15
lea addresses_WC_ht+0x17bb2, %r9
nop
nop
inc %rbx
mov (%r9), %r11d
...
nop
dec %rdi
lea addresses_D_ht+0x16ca4, %rdx
nop
nop
nop
add $17255, %rcx
...
nop
cmp %rsi, %rsi
lea addresses_WT_ht+0xbbe4, %rsi
...
<gen_prepare_buffer>
{'src': {'congruent': 4, 'AVXalign': False, 'same': True, 'size': 16, 'NT': False, 'type': 'addresses_D_ht'}, 'OP': 'LOAD'}
...
{'src': {'congruent': 5, 'AVXalign': False, 'same': True, 'size': 8, 'NT': False, 'type': 'addresses_WC_ht'}, 'OP': 'LOAD'}
{'src': {'congruent': 1, 'same': False, 'type': 'addresses_A_ht'}, 'OP': 'REPM', 'dst': {'congruent': 9, 'same': True, 'type': 'addresses_normal_ht'}}
...
{'src': {'congruent': 8, 'same': False, 'type': 'addresses_WT_ht'}, 'OP': 'REPM', 'dst': {'congruent': 2, 'same': True, 'type': 'addresses_A_ht'}}
{'33': 21829}
