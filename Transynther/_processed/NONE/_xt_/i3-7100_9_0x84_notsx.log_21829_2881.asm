...
push %rdi
push %rsi
lea addresses_UC_ht+0xaa6d, %rbx
nop
nop
nop
nop
...
nop
and $60094, %r10
lea addresses_D_ht+0x1124d, %r10
nop
nop
cmp $45563, %r13
movb (%r10), %bl
...
nop
cmp $8589, %rdi
lea addresses_normal_ht+0x1b16d, %rsi
lea addresses_normal_ht+0x250d, %rdi
clflush (%rsi)
nop
nop
nop
...
nop
add $47393, %rbx
lea addresses_A_ht+0x48d, %rsi
lea addresses_normal_ht+0xfa3d, %rdi
nop
nop
nop
nop
...
nop
cmp $58334, %rcx
lea addresses_UC_ht+0x17fad, %rsi
lea addresses_WC_ht+0x18d, %rdi
nop
nop
cmp $53381, %r12
mov $15, %rcx
...
nop
add %rax, %rax
lea addresses_A_ht+0x1da8d, %rcx
nop
nop
nop
nop
...
{'src': {'type': 'addresses_UC_ht', 'congruent': 5, 'same': False}, 'dst': {'type': 'addresses_WC_ht', 'congruent': 7, 'same': True}, 'OP': 'REPM'}
{'src': {'type': 'addresses_normal_ht', 'congruent': 10, 'same': False}, 'dst': {'type': 'addresses_D_ht', 'congruent': 10, 'same': False}, 'OP': 'REPM'}
