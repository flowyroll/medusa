...
nop
add %r15, %r15
lea addresses_UC_ht+0xecae, %rsi
...
nop
dec %r9
lea addresses_normal_ht+0x1da2e, %rsi
lea addresses_A_ht+0x3c6e, %rdi
clflush (%rsi)
nop
nop
cmp %r8, %r8
...
nop
cmp %rsi, %rsi
lea addresses_WT_ht+0xc236, %rax
nop
nop
and $48155, %rcx
movb $0x61, (%rax)
...
nop
add %rcx, %rcx
lea addresses_A_ht+0xe7ae, %rsi
lea addresses_UC_ht+0x7dae, %rdi
nop
nop
nop
and %r15, %r15
...
nop
add %rax, %rax
lea addresses_D_ht+0x121ae, %rdx
nop
nop
nop
nop
...
nop
xor %rdx, %rdx
lea addresses_WC_ht+0xbfae, %r15
nop
nop
sub %rsi, %rsi
movups (%r15), %xmm6
...
nop
and %r8, %r8
lea addresses_WC_ht+0x12806, %rax
nop
xor %rcx, %rcx
mov (%rax), %dx
inc %rcx
...
{'OP': 'REPM', 'src': {'type': 'addresses_normal_ht', 'congruent': 7, 'same': False}, 'dst': {'type': 'addresses_A_ht', 'congruent': 0, 'same': False}}
{'OP': 'STOR', 'dst': {'type': 'addresses_WT_ht', 'size': 1, 'AVXalign': True, 'NT': False, 'congruent': 2, 'same': False}}
{'OP': 'REPM', 'src': {'type': 'addresses_A_ht', 'congruent': 7, 'same': False}, 'dst': {'type': 'addresses_UC_ht', 'congruent': 9, 'same': False}}
