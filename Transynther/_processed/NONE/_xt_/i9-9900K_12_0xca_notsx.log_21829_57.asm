...
push %rdi
push %rsi
lea addresses_WC_ht+0x623f, %r15
nop
nop
nop
nop
...
nop
sub $64098, %rbp
lea addresses_A_ht+0x18083, %r11
cmp %r10, %r10
...
nop
add $59827, %r10
lea addresses_WT_ht+0x3cc3, %rsi
lea addresses_UC_ht+0x1a2c9, %rdi
clflush (%rdi)
nop
add $19267, %rbp
mov $126, %rcx
...
nop
cmp %rdi, %rdi
lea addresses_WC_ht+0xd7e3, %rsi
lea addresses_D_ht+0x16d83, %rdi
clflush (%rdi)
sub %r15, %r15
mov $40, %rcx
rep movsq
...
nop
and $15498, %r10
lea addresses_UC_ht+0x4ce3, %r15
nop
nop
cmp $52085, %r13
...
{'OP': 'REPM', 'src': {'same': True, 'congruent': 5, 'type': 'addresses_WT_ht'}, 'dst': {'same': False, 'congruent': 1, 'type': 'addresses_UC_ht'}}
