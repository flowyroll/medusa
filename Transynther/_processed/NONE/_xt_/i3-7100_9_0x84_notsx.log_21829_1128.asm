...
push %rdi
push %rsi
lea addresses_UC_ht+0x583b, %rsi
lea addresses_A_ht+0x78f9, %rdi
nop
nop
and $62363, %r11
mov $125, %rcx
rep movsq
xor %r12, %r12
lea addresses_normal_ht+0x3a79, %rsi
lea addresses_UC_ht+0x4579, %rdi
clflush (%rsi)
nop
nop
add %rbx, %rbx
...
rep movsb
inc %rsi
lea addresses_WT_ht+0x15af9, %rsi
lea addresses_WT_ht+0x2699, %rdi
clflush (%rsi)
nop
nop
nop
...
<gen_prepare_buffer>
{'src': {'type': 'addresses_UC_ht', 'congruent': 0, 'same': True}, 'dst': {'type': 'addresses_A_ht', 'congruent': 7, 'same': False}, 'OP': 'REPM'}
