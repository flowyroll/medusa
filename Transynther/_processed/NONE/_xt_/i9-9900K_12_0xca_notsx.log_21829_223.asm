...
push %rdi
push %rsi
lea addresses_WC_ht+0xdd7b, %r13
nop
nop
nop
nop
...
nop
xor %r8, %r8
lea addresses_normal_ht+0x1b97b, %rsi
lea addresses_WT_ht+0x51db, %rdi
nop
nop
cmp %rbx, %rbx
mov $46, %rcx
...
nop
and %r8, %r8
lea addresses_WC_ht+0x8d0d, %rbx
inc %rdi
...
{'OP': 'STOR', 'dst': {'same': False, 'type': 'addresses_WC', 'NT': True, 'AVXalign': True, 'size': 8, 'congruent': 4}}
...
<gen_prepare_buffer>
{'OP': 'STOR', 'dst': {'same': False, 'type': 'addresses_WC_ht', 'NT': False, 'AVXalign': True, 'size': 32, 'congruent': 4}}
