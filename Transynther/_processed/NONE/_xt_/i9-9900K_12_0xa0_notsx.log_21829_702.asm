...
nop
and $15006, %rdi
lea addresses_A_ht+0x199f7, %rbx
nop
nop
nop
nop
...
nop
dec %rbp
lea addresses_normal_ht+0x1b8d4, %rsi
lea addresses_D_ht+0x82a0, %rdi
nop
add $31344, %r15
mov $27, %rcx
rep movsw
nop
and %rcx, %rcx
lea addresses_normal_ht+0x81e8, %rsi
lea addresses_normal_ht+0x14780, %rdi
nop
and %rdx, %rdx
mov $84, %rcx
rep movsw
nop
and $62490, %r15
lea addresses_D_ht+0x112a0, %rsi
lea addresses_normal_ht+0xe2a0, %rdi
nop
nop
nop
nop
...
nop
cmp %rbp, %rbp
lea addresses_WT_ht+0xb2f8, %rsi
lea addresses_D_ht+0x17aa0, %rdi
nop
nop
nop
nop
...
// Store
lea addresses_normal+0xee3d, %rdi
nop
nop
nop
xor %r11, %r11
...
// Store
lea addresses_UC+0x1a700, %rdi
inc %rbx
movl $0x51525354, (%rdi)
sub $23436, %rdi

// Store
lea addresses_D+0x9aa0, %rbx
nop
dec %rdi
mov $0x5152535455565758, %r9
movq %r9, %xmm6
...
<gen_prepare_buffer>
{'src': {'type': 'addresses_WT_ht', 'congruent': 1, 'same': False}, 'OP': 'REPM', 'dst': {'type': 'addresses_D_ht', 'congruent': 0, 'same': False}}
