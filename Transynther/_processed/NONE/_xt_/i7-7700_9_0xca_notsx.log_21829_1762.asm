...
nop
and $28868, %r11
lea addresses_WT_ht+0x1d485, %r14
nop
nop
nop
and %r10, %r10
...
nop
and $41491, %r15
lea addresses_UC_ht+0xc57b, %r11
nop
nop
and $18440, %rdx
mov (%r11), %di
...
nop
xor $41971, %r14
lea addresses_WC_ht+0x3845, %r14
sub $41066, %r11
...
nop
sub %r13, %r13
lea addresses_UC_ht+0x523a, %rsi
lea addresses_normal_ht+0x13d85, %rdi
nop
nop
nop
nop
...
<gen_prepare_buffer>
{'dst': {'NT': False, 'AVXalign': False, 'size': 16, 'congruent': 6, 'same': True, 'type': 'addresses_A_ht'}, 'OP': 'STOR'}
...
{'src': {'NT': False, 'AVXalign': True, 'size': 32, 'congruent': 6, 'same': False, 'type': 'addresses_WC_ht'}, 'OP': 'LOAD'}
