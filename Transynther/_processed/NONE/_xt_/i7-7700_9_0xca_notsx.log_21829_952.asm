...
push %rdi
push %rsi
lea addresses_UC_ht+0x7053, %rsi
lea addresses_normal_ht+0x17313, %rdi
nop
nop
and %rax, %rax
mov $40, %rcx
...
nop
xor $20205, %r15
lea addresses_UC_ht+0x7c73, %r10
nop
nop
xor $36767, %r13
vmovups (%r10), %ymm4
...
nop
cmp $62789, %r10
lea addresses_A_ht+0x1e603, %rdi
nop
and %r13, %r13
...
nop
dec %rsi
lea addresses_normal_ht+0x10993, %r15
nop
nop
and $11112, %rdi
...
nop
cmp $6276, %r13
lea addresses_A_ht+0x1d813, %rdi
nop
nop
nop
add $21172, %rcx
