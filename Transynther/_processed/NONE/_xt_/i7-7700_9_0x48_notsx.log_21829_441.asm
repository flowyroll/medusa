...
push %rdx
push %rsi
lea addresses_WC_ht+0x15945, %r10
nop
add %rdx, %rdx
movb (%r10), %r14b
nop
...
nop
inc %rbp
lea addresses_normal_ht+0xda45, %rsi
dec %r12
movb $0x61, (%rsi)
nop
sub $25757, %r12
lea addresses_UC_ht+0x2fb1, %r14
clflush (%r14)
nop
nop
nop
...
nop
inc %rbp
lea addresses_UC_ht+0x1ec45, %rbp
nop
nop
nop
and %rbx, %rbx
...
{'dst': {'same': False, 'NT': True, 'AVXalign': False, 'size': 8, 'type': 'addresses_UC_ht', 'congruent': 8}, 'OP': 'STOR'}
{'36': 21829}
