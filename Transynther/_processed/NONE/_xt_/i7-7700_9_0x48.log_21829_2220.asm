...
push %rdx
push %rsi
lea addresses_WT_ht+0x120a0, %rsi
lea addresses_D_ht+0x130a0, %rdi
cmp $27938, %rbp
mov $123, %rcx
rep movsq
nop
nop
inc %rdi
lea addresses_normal_ht+0xd0a0, %r14
nop
nop
sub %r9, %r9
...
nop
add %rdi, %rdi
lea addresses_WT_ht+0x1d620, %rsi
lea addresses_WT_ht+0x7a20, %rdi
nop
nop
cmp %rdx, %rdx
mov $1, %rcx
