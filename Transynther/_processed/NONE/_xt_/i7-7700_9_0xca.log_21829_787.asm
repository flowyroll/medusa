...
nop
xor $43977, %r13
lea addresses_WT_ht+0x11db6, %rcx
nop
cmp %r9, %r9
movl $0x61626364, (%rcx)
nop
...
nop
add %r9, %r9
lea addresses_WT_ht+0x1c86e, %r9
nop
nop
nop
nop
...
movups %xmm3, (%r9)
sub $11148, %r15
lea addresses_WT_ht+0x17e6e, %r13
sub $61208, %rcx
movb $0x61, (%r13)
nop
nop
cmp %r15, %r15
lea addresses_WC_ht+0x24ae, %rsi
lea addresses_A_ht+0x174ce, %rdi
nop
nop
nop
and $57682, %rbp
...
// Faulty Load
lea addresses_normal+0x1346e, %rcx
add %rbp, %rbp
mov (%rcx), %r10w
lea oracles, %rbp
and $0xff, %r10
...
{'src': {'congruent': 4, 'same': False, 'type': 'addresses_WC_ht'}, 'OP': 'REPM', 'dst': {'congruent': 5, 'same': True, 'type': 'addresses_A_ht'}}
{'34': 21829}
