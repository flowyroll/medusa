...
push %rdx
push %rsi
lea addresses_WT_ht+0x9f30, %rbp
nop
nop
nop
nop
...
nop
inc %r15
lea addresses_UC_ht+0x11338, %r10
inc %rbp
movups (%r10), %xmm6
vpextrq $0, %xmm6, %rdx
nop
...
nop
add %r15, %r15
lea addresses_normal_ht+0x8bdd, %r11
nop
nop
inc %rbx
movb $0x61, (%r11)
sub %rbx, %rbx
lea addresses_D_ht+0x17730, %rdx
nop
nop
nop
nop
...
nop
inc %rbx
lea addresses_WC_ht+0x171b0, %rsi
lea addresses_WC_ht+0x19330, %rdi
nop
and $53543, %r10
mov $42, %rcx
rep movsw
...
// Store
lea addresses_normal+0xd530, %r9
xor $35586, %r11
...
{'OP': 'STOR', 'dst': {'type': 'addresses_D_ht', 'AVXalign': True, 'congruent': 9, 'size': 32, 'same': True, 'NT': True}}
