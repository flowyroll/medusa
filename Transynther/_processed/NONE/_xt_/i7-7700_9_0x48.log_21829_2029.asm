...
nop
add $113, %rdx
lea addresses_WT_ht+0xc892, %rdi
nop
nop
nop
add %r10, %r10
...
nop
lfence
lea addresses_A_ht+0x1ebf6, %rdi
nop
nop
nop
nop
...
nop
cmp %r10, %r10
lea addresses_D_ht+0x1b6b6, %rsi
lea addresses_UC_ht+0x11c26, %rdi
nop
nop
nop
nop
