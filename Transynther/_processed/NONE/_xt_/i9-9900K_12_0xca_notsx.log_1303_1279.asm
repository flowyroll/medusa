...
push %rdi
push %rsi
lea addresses_D_ht+0x147f1, %r15
nop
nop
nop
xor $60407, %r13
...
nop
xor $22833, %rcx
lea addresses_UC_ht+0x2121, %r11
nop
nop
nop
nop
...
nop
cmp %rsi, %rsi
lea addresses_A_ht+0x177f1, %rsi
nop
nop
nop
and $1402, %rdi
movw $0x6162, (%rsi)
and %rdi, %rdi
lea addresses_WT_ht+0x1e124, %rsi
...
nop
add %rbx, %rbx
lea addresses_UC_ht+0x918f, %rsi
lea addresses_normal_ht+0x43f1, %rdi
nop
nop
nop
nop
...
// Load
lea addresses_normal+0x8f31, %r10
nop
nop
nop
xor %rbx, %rbx
...
{'OP': 'REPM', 'src': {'same': False, 'congruent': 0, 'type': 'addresses_WT_ht'}, 'dst': {'same': False, 'congruent': 3, 'type': 'addresses_UC_ht'}}
