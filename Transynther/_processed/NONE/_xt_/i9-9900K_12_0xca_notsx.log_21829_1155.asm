...
push %rdi
push %rdx
lea addresses_WC_ht+0x10414, %rbx
and %r13, %r13
mov (%rbx), %r8
nop
nop
...
nop
dec %rdx
lea addresses_WC_ht+0x14944, %r8
sub %r14, %r14
vmovups (%r8), %ymm6
...
nop
cmp $22663, %r13
lea addresses_normal_ht+0x16bf6, %rdi
and %r10, %r10
vmovups (%rdi), %ymm4
...
nop
inc %rdx
lea addresses_WT_ht+0x10084, %r10
inc %rdi
...
nop
dec %r8
lea addresses_normal_ht+0x5414, %r8
clflush (%r8)
nop
nop
xor $48566, %r10
