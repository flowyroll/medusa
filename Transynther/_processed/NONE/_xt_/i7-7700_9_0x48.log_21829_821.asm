...
nop
add $2056, %r15
lea addresses_WT_ht+0x119e8, %rax
nop
nop
nop
nop
...
nop
and $4833, %rax
lea addresses_normal_ht+0x9a8, %rdx
nop
nop
nop
nop
...
nop
and $15502, %rbp
lea addresses_WT_ht+0x1d14c, %rsi
nop
nop
nop
nop
...
movb (%r15), %al
add %r12, %r12
lea addresses_normal_ht+0x109a8, %rsi
lea addresses_D_ht+0x6408, %rdi
clflush (%rdi)
nop
and %rdx, %rdx
mov $20, %rcx
...
nop
cmp $20514, %r12
lea addresses_WT_ht+0xd5e8, %rsi
lea addresses_D_ht+0x14e28, %rdi
and $54073, %r12
mov $88, %rcx
rep movsq
nop
...
nop
xor $39858, %rsi
lea addresses_WC_ht+0xd268, %rax
nop
nop
cmp $49205, %r12
movb (%rax), %r15b
...
nop
and %r15, %r15
lea addresses_WC_ht+0x21a8, %rsi
lea addresses_WC_ht+0x13528, %rdi
nop
nop
nop
nop
...
{'OP': 'STOR', 'dst': {'type': 'addresses_WT', 'AVXalign': True, 'congruent': 4, 'size': 8, 'same': False, 'NT': False}}
[Faulty Load]
...
{'OP': 'LOAD', 'src': {'type': 'addresses_WC_ht', 'AVXalign': False, 'congruent': 3, 'size': 1, 'same': True, 'NT': False}}
