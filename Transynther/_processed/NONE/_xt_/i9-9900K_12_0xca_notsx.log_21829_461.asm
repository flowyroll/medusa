...
push %rbx
push %rsi
lea addresses_WC_ht+0x4baf, %r11
nop
nop
nop
nop
...
nop
add %rbx, %rbx
lea addresses_UC_ht+0x1c807, %r11
nop
nop
nop
nop
...
// Store
lea addresses_normal+0x1ce87, %r9
nop
nop
xor $35750, %rcx
movl $0x51525354, (%r9)
...
{'OP': 'STOR', 'dst': {'same': True, 'type': 'addresses_normal', 'NT': False, 'AVXalign': False, 'size': 4, 'congruent': 4}}
