...
push %rdx
push %rsi
lea addresses_WT_ht+0x15dff, %rax
clflush (%rax)
nop
nop
nop
...
nop
and $63071, %rdx
lea addresses_WT_ht+0x2105, %rdx
nop
add %r9, %r9
movw $0x6162, (%rdx)
nop
...
nop
and %r8, %r8
lea addresses_WT_ht+0x183ed, %rsi
lea addresses_UC_ht+0x1b757, %rdi
nop
nop
and $23974, %r9
mov $41, %rcx
...
nop
dec %r9
lea addresses_D_ht+0x19385, %rcx
nop
nop
nop
nop
...
lea addresses_D_ht+0x15ca5, %rdi
nop
xor $28528, %rdx
mov $106, %rcx
rep movsl
xor $59207, %rdx
lea addresses_A_ht+0x18c15, %rsi
lea addresses_A_ht+0xb570, %rdi
nop
add $36973, %rax
mov $45, %rcx
rep movsb
...
nop
dec %rsi
lea addresses_normal_ht+0xa9bd, %rsi
lea addresses_normal_ht+0x7385, %rdi
nop
sub $63848, %rax
mov $41, %rcx
rep movsl
...
nop
sub %rax, %rax
lea addresses_normal_ht+0x1eb85, %r12
nop
nop
nop
inc %rcx
...
vpextrq $1, %xmm4, %rdx
dec %rbx
lea addresses_D_ht+0x13b52, %rsi
lea addresses_normal_ht+0x1c785, %rdi
dec %rax
mov $119, %rcx
rep movsq
nop
...
nop
xor %rcx, %rcx
lea addresses_A_ht+0x1bee5, %rsi
lea addresses_WT_ht+0x102c5, %rdi
clflush (%rsi)
nop
nop
nop
...
{'src': {'type': 'addresses_WT_ht', 'congruent': 0, 'same': True}, 'OP': 'REPM', 'dst': {'type': 'addresses_UC_ht', 'congruent': 1, 'same': True}}
...
{'src': {'type': 'addresses_A_ht', 'congruent': 1, 'same': False}, 'OP': 'REPM', 'dst': {'type': 'addresses_A_ht', 'congruent': 0, 'same': True}}
...
{'src': {'type': 'addresses_A_ht', 'congruent': 5, 'same': False}, 'OP': 'REPM', 'dst': {'type': 'addresses_WT_ht', 'congruent': 6, 'same': False}}
{'38': 21829}
