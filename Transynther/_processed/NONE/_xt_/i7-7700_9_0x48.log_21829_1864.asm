...
push %rdi
push %rsi
lea addresses_normal_ht+0x3625, %rsi
clflush (%rsi)
nop
nop
nop
...
nop
cmp $10221, %rbx
lea addresses_WC_ht+0xb7d5, %r14
nop
nop
nop
nop
...
vmovups %ymm0, (%r14)
and %r13, %r13
lea addresses_A_ht+0x3add, %rsi
lea addresses_WC_ht+0x2de5, %rdi
and %rbx, %rbx
mov $113, %rcx
rep movsw
nop
nop
xor %rdi, %rdi
lea addresses_WT_ht+0x177d5, %r13
cmp %rbx, %rbx
movb $0x61, (%r13)
nop
and $58010, %r14
lea addresses_D_ht+0x1d8e5, %rcx
nop
nop
xor %rbp, %rbp
mov (%rcx), %r14w
...
nop
cmp %rbx, %rbx
lea addresses_A_ht+0x1721b, %rdi
nop
nop
nop
nop
...
nop
sub %rbx, %rbx
lea addresses_A_ht+0x79d, %rsi
lea addresses_UC_ht+0xa5ba, %rdi
clflush (%rdi)
nop
sub $53242, %rbx
mov $33, %rcx
...
nop
xor %r12, %r12
lea addresses_normal_ht+0x8311, %rdi
nop
nop
nop
nop
...
nop
add $42527, %r14
lea addresses_normal_ht+0x1a035, %r12
nop
nop
and $37525, %r14
mov (%r12), %rbp
...
nop
dec %rcx
lea addresses_A_ht+0xc8d1, %rsi
lea addresses_WC_ht+0x1ebd5, %rdi
clflush (%rsi)
xor $46045, %r13
mov $107, %rcx
rep movsq
...
nop
inc %r13
lea addresses_normal_ht+0x1421, %rbx
nop
nop
nop
add %r14, %r14
...
nop
add %r14, %r14
lea addresses_UC_ht+0x1b3d5, %r13
clflush (%r13)
nop
add %r14, %r14
mov (%r13), %di
...
nop
sub %r13, %r13
lea addresses_normal_ht+0x8ee5, %r13
nop
cmp $54659, %rcx
vmovups (%r13), %ymm3
...
{'OP': 'LOAD', 'src': {'type': 'addresses_A_ht', 'AVXalign': False, 'congruent': 3, 'size': 1, 'same': True, 'NT': False}}
...
{'OP': 'REPM', 'src': {'type': 'addresses_A_ht', 'congruent': 3, 'same': False}, 'dst': {'type': 'addresses_UC_ht', 'congruent': 0, 'same': False}}
{'OP': 'LOAD', 'src': {'type': 'addresses_normal_ht', 'AVXalign': False, 'congruent': 0, 'size': 2, 'same': True, 'NT': False}}
{'OP': 'LOAD', 'src': {'type': 'addresses_normal_ht', 'AVXalign': False, 'congruent': 4, 'size': 8, 'same': False, 'NT': False}}
{'OP': 'REPM', 'src': {'type': 'addresses_A_ht', 'congruent': 1, 'same': False}, 'dst': {'type': 'addresses_WC_ht', 'congruent': 11, 'same': False}}
