...
push %rdi
push %rsi
lea addresses_normal_ht+0x9813, %rsi
lea addresses_UC_ht+0x19113, %rdi
and $10670, %r11
mov $61, %rcx
rep movsl
nop
...
{'src': {'NT': False, 'same': False, 'congruent': 10, 'type': 'addresses_WT', 'AVXalign': False, 'size': 8}, 'OP': 'LOAD'}
