...
push %rdx
push %rsi
lea addresses_WT_ht+0x1cdfd, %rsi
lea addresses_UC_ht+0x13bfd, %rdi
clflush (%rsi)
nop
and $24720, %r10
mov $121, %rcx
...
nop
and $5111, %rdi
lea addresses_UC_ht+0x1ecfd, %rsi
lea addresses_D_ht+0x1a4fd, %rdi
nop
nop
nop
add $64014, %r10
...
nop
dec %rdx
lea addresses_UC_ht+0xb915, %rsi
lea addresses_UC_ht+0x129fd, %rdi
nop
nop
xor $14159, %r12
mov $98, %rcx
...
lea addresses_WC_ht+0x104bd, %rdi
clflush (%rdi)
nop
nop
xor $24925, %r12
...
nop
xor %rdx, %rdx
lea addresses_WT_ht+0x1285d, %rsi
lea addresses_UC_ht+0xc9fd, %rdi
nop
nop
nop
xor %r14, %r14
...
// Load
lea addresses_normal+0x9fd, %r10
nop
nop
add %r15, %r15
mov (%r10), %bx
...
{'OP': 'REPM', 'src': {'type': 'addresses_UC_ht', 'congruent': 1, 'same': False}, 'dst': {'type': 'addresses_UC_ht', 'congruent': 11, 'same': False}}
