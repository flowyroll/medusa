...
push %rdi
push %rsi
lea addresses_D_ht+0x125f8, %rsi
lea addresses_WT_ht+0x149f0, %rdi
sub $33974, %r12
mov $121, %rcx
rep movsl
nop
...
nop
and %r9, %r9
lea addresses_WT_ht+0x1e10, %rsi
lea addresses_normal_ht+0xc83a, %rdi
nop
nop
nop
nop
...
movw $0x6162, (%r9)
cmp $37100, %rsi
lea addresses_UC_ht+0x11f47, %r9
nop
nop
nop
nop
...
nop
and %r13, %r13
lea addresses_normal_ht+0xb7b0, %rsi
lea addresses_A_ht+0x7f60, %rdi
xor $56395, %rbx
mov $99, %rcx
rep movsq
nop
inc %rdi
lea addresses_WT_ht+0x17f30, %rsi
nop
nop
nop
nop
...
nop
lfence
lea addresses_WT_ht+0x17930, %rsi
lea addresses_UC_ht+0x100b0, %rdi
clflush (%rdi)
nop
nop
nop
...
nop
cmp $39036, %rbx
lea addresses_UC_ht+0x4ee0, %rsi
lea addresses_normal_ht+0x70f8, %rdi
clflush (%rdi)
nop
nop
add $47742, %r15
...
{'src': {'type': 'addresses_normal_ht', 'congruent': 6, 'same': False}, 'dst': {'type': 'addresses_A_ht', 'congruent': 4, 'same': False}, 'OP': 'REPM'}
{'src': {'type': 'addresses_WT_ht', 'same': False, 'size': 1, 'congruent': 11, 'NT': False, 'AVXalign': False}, 'OP': 'LOAD'}
{'src': {'type': 'addresses_WT_ht', 'congruent': 7, 'same': False}, 'dst': {'type': 'addresses_UC_ht', 'congruent': 7, 'same': False}, 'OP': 'REPM'}
