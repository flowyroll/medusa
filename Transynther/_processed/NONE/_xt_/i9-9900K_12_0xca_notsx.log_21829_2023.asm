...
nop
and $17195, %rbx
lea addresses_normal_ht+0xad51, %rbp
nop
nop
add %rcx, %rcx
mov (%rbp), %edi
nop
sub $5533, %rbx
lea addresses_UC_ht+0xd021, %rbx
nop
nop
nop
nop
...
nop
xor %r13, %r13
lea addresses_WC_ht+0x15511, %rbx
clflush (%rbx)
nop
nop
nop
...
lea addresses_WC_ht+0xf6d8, %rdi
nop
and $54389, %rbx
mov $7, %rcx
rep movsw
...
nop
cmp $26894, %r13
lea addresses_D_ht+0x1c979, %rsi
lea addresses_WC_ht+0xfef1, %rdi
nop
nop
nop
sub %r8, %r8
...
nop
lfence
lea addresses_normal_ht+0x1b91, %r10
nop
nop
nop
and $64302, %rsi
...
{'OP': 'REPM', 'src': {'same': False, 'congruent': 3, 'type': 'addresses_D_ht'}, 'dst': {'same': False, 'congruent': 5, 'type': 'addresses_WC_ht'}}
