...
push %rdi
push %rsi
lea addresses_A_ht+0x74d3, %rsi
lea addresses_A_ht+0x14884, %rdi
nop
nop
nop
nop
...
nop
xor %r15, %r15
lea addresses_A_ht+0x8423, %rsi
lea addresses_UC_ht+0x1af03, %rdi
nop
nop
sub $63581, %r11
mov $43, %rcx
...
nop
and $23006, %rdi
lea addresses_normal_ht+0x1ed23, %rcx
nop
dec %r13
...
nop
and %rcx, %rcx
lea addresses_WC_ht+0x1bee3, %rsi
nop
nop
nop
nop
...
nop
dec %r8
lea addresses_A_ht+0x139c3, %r13
nop
nop
nop
inc %rsi
...
movl $0x61626364, (%rsi)
inc %r15
lea addresses_A_ht+0x15223, %r13
nop
nop
nop
nop
