...
movb $0x61, (%rsi)
dec %rcx
lea addresses_normal_ht+0x563d, %rsi
lea addresses_WT_ht+0x1c44b, %rdi
cmp $11800, %rbp
mov $10, %rcx
rep movsl
nop
...
// Load
lea addresses_normal+0x1a5cd, %r10
and %r8, %r8
movb (%r10), %r13b
nop
add $58805, %r13
...
{'OP': 'LOAD', 'src': {'same': False, 'NT': False, 'AVXalign': True, 'size': 1, 'type': 'addresses_normal', 'congruent': 3}}
[Faulty Load]
{'OP': 'LOAD', 'src': {'same': True, 'NT': False, 'AVXalign': False, 'size': 4, 'type': 'addresses_UC', 'congruent': 0}}
<gen_prepare_buffer>
{'dst': {'same': True, 'NT': False, 'AVXalign': False, 'size': 1, 'type': 'addresses_normal_ht', 'congruent': 4}, 'OP': 'STOR'}
