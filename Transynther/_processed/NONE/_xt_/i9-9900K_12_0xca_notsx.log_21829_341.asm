...
push %rdx
push %rsi
lea addresses_WT_ht+0x190c2, %r8
nop
nop
nop
nop
...
nop
cmp %rbp, %rbp
lea addresses_normal_ht+0x91c2, %rsi
lea addresses_normal_ht+0x96c2, %rdi
nop
nop
nop
nop
...
nop
sub $25693, %rdx
lea addresses_normal_ht+0x10ec2, %rsi
lea addresses_D_ht+0x17fc2, %rdi
nop
nop
nop
inc %rdx
...
nop
add %r10, %r10
lea addresses_WT_ht+0x1e042, %rsi
lea addresses_A_ht+0x1cc22, %rdi
nop
nop
nop
nop
...
nop
sub %rcx, %rcx
lea addresses_normal_ht+0x205a, %rcx
nop
cmp $25902, %rsi
movb $0x61, (%rcx)
nop
cmp $7002, %rdi
lea addresses_A_ht+0x4cc2, %rbp
add %rdi, %rdi
movl $0x61626364, (%rbp)
sub %rdi, %rdi
pop %rsi
...
{'OP': 'REPM', 'src': {'same': False, 'congruent': 10, 'type': 'addresses_normal_ht'}, 'dst': {'same': False, 'congruent': 5, 'type': 'addresses_D_ht'}}
{'OP': 'REPM', 'src': {'same': False, 'congruent': 7, 'type': 'addresses_WT_ht'}, 'dst': {'same': True, 'congruent': 4, 'type': 'addresses_A_ht'}}
{'OP': 'LOAD', 'src': {'same': False, 'type': 'addresses_normal_ht', 'NT': False, 'AVXalign': False, 'size': 32, 'congruent': 4}}
{'OP': 'STOR', 'dst': {'same': False, 'type': 'addresses_normal_ht', 'NT': True, 'AVXalign': False, 'size': 1, 'congruent': 3}}
