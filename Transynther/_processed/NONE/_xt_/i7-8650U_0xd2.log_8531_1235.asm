...
push %rcx
push %rdi
lea addresses_WC_ht+0xfb59, %r12
nop
nop
nop
cmp %rcx, %rcx
...
nop
cmp %r14, %r14
lea addresses_WC_ht+0x1a759, %r8
nop
nop
add $30122, %rbx
mov (%r8), %di
nop
cmp $54282, %r8
lea addresses_WT_ht+0x1e759, %rbp
nop
nop
cmp $18958, %r8
movl $0x61626364, (%rbp)
...
nop
and %r12, %r12
lea addresses_WC_ht+0x8019, %rdi
nop
nop
nop
xor %rbx, %rbx
...
nop
xor %rbx, %rbx
lea addresses_WC_ht+0x61b1, %r14
nop
nop
nop
sub $15365, %rdi
...
// REPMOV
lea addresses_RW+0x1f7d9, %rsi
lea addresses_A+0x3759, %rdi
nop
nop
nop
nop
...
// Faulty Load
lea addresses_normal+0xf59, %r15
nop
nop
nop
cmp %rcx, %rcx
...
{'OP': 'REPM', 'src': {'type': 'addresses_RW', 'congruent': 6, 'same': False}, 'dst': {'type': 'addresses_A', 'congruent': 10, 'same': False}}
[Faulty Load]
