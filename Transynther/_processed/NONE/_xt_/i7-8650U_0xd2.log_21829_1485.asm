...
push %rdi
push %rsi
lea addresses_WT_ht+0x123aa, %rsi
lea addresses_WT_ht+0x672a, %rdi
nop
and $44679, %r13
mov $125, %rcx
rep movsb
...
nop
xor %r13, %r13
lea addresses_WT_ht+0xb1ca, %rdi
nop
add $15761, %rsi
...
// Faulty Load
lea addresses_normal+0x14aaa, %rbp
nop
nop
nop
nop
