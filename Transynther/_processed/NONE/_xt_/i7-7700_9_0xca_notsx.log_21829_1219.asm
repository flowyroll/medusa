...
push %rdx
push %rsi
lea addresses_WT_ht+0x10a8d, %rbp
nop
nop
sub %rcx, %rcx
vmovups (%rbp), %ymm2
...
nop
xor %rdx, %rdx
lea addresses_D_ht+0xf723, %rax
nop
nop
cmp $12110, %rbx
movl $0x61626364, (%rax)
xor %rdx, %rdx
lea addresses_WC_ht+0x1828d, %rsi
lea addresses_normal_ht+0x5ded, %rdi
nop
nop
dec %rdx
mov $20, %rcx
...
nop
inc %rdx
lea addresses_WT_ht+0x18a8d, %rsi
lea addresses_WT_ht+0xf08d, %rdi
clflush (%rsi)
nop
nop
xor %rdx, %rdx
...
lea addresses_WT_ht+0x3b2d, %rdi
nop
nop
nop
sub $14595, %rbp
...
{'src': {'congruent': 11, 'same': False, 'type': 'addresses_WC_ht'}, 'dst': {'congruent': 4, 'same': False, 'type': 'addresses_normal_ht'}, 'OP': 'REPM'}
