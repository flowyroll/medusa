...
nop
xor %r11, %r11
lea addresses_WT_ht+0x1bfa9, %rdi
inc %r8
mov $0x6162636465666768, %r12
movq %r12, %xmm3
vmovups %ymm3, (%rdi)
inc %rdi
lea addresses_WC_ht+0x124a9, %r15
nop
nop
nop
nop
...
nop
and %rcx, %rcx
lea addresses_normal_ht+0x4de9, %rdi
nop
and $31249, %r8
mov (%rdi), %r15
nop
...
nop
inc %rdi
lea addresses_WC_ht+0x5a3b, %r11
nop
nop
nop
nop
...
nop
dec %rdi
lea addresses_UC_ht+0xed, %rsi
lea addresses_WT_ht+0x7129, %rdi
cmp $27740, %rdx
mov $122, %rcx
rep movsq
sub $11860, %r11
lea addresses_D_ht+0xb351, %rsi
lea addresses_UC_ht+0x17901, %rdi
nop
nop
nop
nop
...
nop
dec %r15
lea addresses_normal_ht+0x170a9, %rsi
lea addresses_WT_ht+0x19b2d, %rdi
nop
cmp $2918, %r12
mov $16, %rcx
rep movsb
...
nop
xor %r12, %r12
lea addresses_WT_ht+0xc2f9, %rsi
lea addresses_UC_ht+0x11ae9, %rdi
clflush (%rsi)
nop
nop
cmp %r8, %r8
...
nop
xor %r11, %r11
lea addresses_D_ht+0x18c47, %rsi
lea addresses_normal_ht+0x11ee9, %rdi
nop
nop
nop
nop
...
{'src': {'type': 'addresses_normal_ht', 'congruent': 10, 'same': False}, 'OP': 'REPM', 'dst': {'type': 'addresses_WT_ht', 'congruent': 1, 'same': False}}
{'src': {'type': 'addresses_WT_ht', 'congruent': 4, 'same': False}, 'OP': 'REPM', 'dst': {'type': 'addresses_UC_ht', 'congruent': 4, 'same': False}}
{'src': {'type': 'addresses_D_ht', 'congruent': 1, 'same': False}, 'OP': 'REPM', 'dst': {'type': 'addresses_normal_ht', 'congruent': 5, 'same': True}}
{'36': 21829}
