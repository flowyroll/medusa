...
push %rdx
push %rsi
lea addresses_A_ht+0x116b1, %rsi
lea addresses_WT_ht+0x196b1, %rdi
clflush (%rsi)
nop
nop
nop
...
nop
xor %rsi, %rsi
lea addresses_normal_ht+0x12731, %rsi
lea addresses_A_ht+0x6ab1, %rdi
nop
nop
nop
inc %rdx
...
rep movsq
dec %rsi
lea addresses_A_ht+0x132e1, %rdi
nop
nop
and %r12, %r12
movl $0x61626364, (%rdi)
...
nop
and $41759, %rdx
lea addresses_WC_ht+0x1591, %rsi
nop
nop
nop
nop
...
nop
add %rdi, %rdi
lea addresses_WC_ht+0x15c3b, %rbx
and %r12, %r12
vmovups (%rbx), %ymm5
vextracti128 $0, %ymm5, %xmm5
vpextrq $1, %xmm5, %rdx
cmp $62975, %r12
lea addresses_WT_ht+0x14b8f, %r9
nop
nop
and $49403, %r12
...
lea addresses_WT_ht+0x3eb1, %rdi
nop
nop
nop
xor %rdx, %rdx
...
nop
and $27535, %rsi
lea addresses_WT_ht+0x7e31, %rcx
nop
nop
inc %rsi
vmovups (%rcx), %ymm6
...
nop
add %rdi, %rdi
lea addresses_WT_ht+0xdcb1, %r12
nop
nop
nop
xor $33932, %rsi
...
{'OP': 'STOR', 'dst': {'same': False, 'type': 'addresses_WC', 'NT': False, 'AVXalign': True, 'size': 4, 'congruent': 4}}
[Faulty Load]
{'OP': 'LOAD', 'src': {'same': True, 'type': 'addresses_RW', 'NT': False, 'AVXalign': False, 'size': 16, 'congruent': 0}}
<gen_prepare_buffer>
{'OP': 'REPM', 'src': {'same': False, 'congruent': 8, 'type': 'addresses_A_ht'}, 'dst': {'same': False, 'congruent': 11, 'type': 'addresses_WT_ht'}}
{'OP': 'REPM', 'src': {'same': False, 'congruent': 7, 'type': 'addresses_normal_ht'}, 'dst': {'same': False, 'congruent': 10, 'type': 'addresses_A_ht'}}
