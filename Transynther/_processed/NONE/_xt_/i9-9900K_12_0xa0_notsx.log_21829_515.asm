...
push %rdi
push %rsi
lea addresses_UC_ht+0xe36a, %r14
dec %r15
...
nop
and %rbx, %rbx
lea addresses_normal_ht+0xa72a, %rsi
lea addresses_UC_ht+0x71aa, %rdi
dec %rbx
mov $39, %rcx
rep movsq
nop
...
nop
add %r15, %r15
lea addresses_WT_ht+0x1356a, %r15
nop
nop
nop
inc %r9
...
nop
mfence
lea addresses_A_ht+0x11a4a, %rdi
nop
nop
nop
xor %r14, %r14
...
nop
sub $22342, %rcx
lea addresses_UC_ht+0x1376a, %rcx
cmp $23529, %r15
mov $0x6162636465666768, %rsi
movq %rsi, (%rcx)
nop
...
// Faulty Load
lea addresses_normal+0x1076a, %r9
nop
nop
nop
and $2052, %r8
