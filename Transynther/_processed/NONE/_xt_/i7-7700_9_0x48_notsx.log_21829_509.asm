...
push %rdi
push %rsi
lea addresses_normal_ht+0x2398, %rbp
nop
nop
nop
nop
...
nop
and %rcx, %rcx
lea addresses_WT_ht+0x92c8, %rsi
lea addresses_normal_ht+0x3598, %rdi
nop
nop
nop
nop
...
nop
and %rbp, %rbp
lea addresses_WT_ht+0x2318, %rax
nop
nop
nop
nop
...
nop
and $38368, %rax
lea addresses_normal_ht+0x2aa4, %rax
and %r11, %r11
movw $0x6162, (%rax)
nop
add $17349, %rsi
lea addresses_normal_ht+0x3c98, %rbp
clflush (%rbp)
nop
nop
and %rdi, %rdi
...
// Store
lea addresses_normal+0x5598, %rsi
clflush (%rsi)
nop
nop
xor %rbp, %rbp
...
{'dst': {'same': False, 'NT': False, 'AVXalign': True, 'size': 4, 'type': 'addresses_normal', 'congruent': 11}, 'OP': 'STOR'}
...
{'dst': {'same': False, 'NT': False, 'AVXalign': True, 'size': 8, 'type': 'addresses_P', 'congruent': 5}, 'OP': 'STOR'}
...
{'dst': {'same': False, 'congruent': 11, 'type': 'addresses_normal_ht'}, 'OP': 'REPM', 'src': {'same': False, 'congruent': 3, 'type': 'addresses_WT_ht'}}
