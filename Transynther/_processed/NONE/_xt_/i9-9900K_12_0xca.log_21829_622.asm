...
nop
and $49154, %rcx
lea addresses_WT_ht+0x1ecbb, %rdx
nop
nop
nop
nop
...
nop
cmp %rdx, %rdx
lea addresses_WT_ht+0xc23b, %r15
nop
nop
nop
nop
...
{'OP': 'LOAD', 'src': {'size': 4, 'NT': False, 'type': 'addresses_P', 'same': False, 'AVXalign': False, 'congruent': 5}}
[Faulty Load]
...
{'OP': 'STOR', 'dst': {'size': 1, 'NT': True, 'type': 'addresses_A_ht', 'same': False, 'AVXalign': True, 'congruent': 7}}
