...
push %rdi
push %rsi
lea addresses_normal_ht+0xcfda, %rbx
nop
nop
nop
nop
...
nop
and $39568, %r11
lea addresses_WC_ht+0x104e2, %rsi
lea addresses_WT_ht+0x1c7c8, %rdi
nop
nop
nop
xor %rax, %rax
...
nop
cmp $24452, %r9
lea addresses_WC_ht+0x12432, %r11
clflush (%r11)
and %rcx, %rcx
...
// Store
lea addresses_normal+0xeada, %r11
nop
nop
add $47208, %rdx
movb $0x51, (%r11)
...
{'OP': 'REPM', 'src': {'same': False, 'congruent': 3, 'type': 'addresses_WC_ht'}, 'dst': {'same': False, 'congruent': 0, 'type': 'addresses_WT_ht'}}
