...
rep movsq
cmp %r11, %r11
lea addresses_UC_ht+0x9c7c, %rsi
lea addresses_WT_ht+0x18fcc, %rdi
nop
nop
sub $20964, %rdx
mov $3, %rcx
...
nop
inc %rsi
lea addresses_WC_ht+0x103b2, %rsi
lea addresses_normal_ht+0x178cc, %rdi
nop
nop
nop
nop
...
nop
add $17365, %rdx
lea addresses_A_ht+0x826c, %rsi
lea addresses_A_ht+0x3cc, %rdi
sub %rdx, %rdx
mov $2, %rcx
rep movsl
nop
...
nop
add $61536, %rdx
lea addresses_WC_ht+0x1946c, %rbp
nop
nop
nop
nop
...
nop
xor %r9, %r9
lea addresses_D_ht+0x1bb8c, %rcx
xor %r11, %r11
mov (%rcx), %bp
nop
nop
...
nop
dec %rdx
lea addresses_UC_ht+0xe88c, %rsi
clflush (%rsi)
nop
xor %rdx, %rdx
...
nop
add $34812, %r9
lea addresses_UC_ht+0x6d4c, %rcx
nop
nop
nop
nop
...
{'OP': 'REPM', 'src': {'type': 'addresses_UC_ht', 'congruent': 4, 'same': False}, 'dst': {'type': 'addresses_WT_ht', 'congruent': 11, 'same': False}}
