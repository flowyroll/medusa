...
push %rdi
push %rsi
lea addresses_A_ht+0x15345, %r14
nop
nop
sub %rdi, %rdi
...
lea addresses_UC_ht+0x6ea5, %rdi
nop
nop
nop
cmp $62642, %r8
...
{'src': {'congruent': 10, 'same': False, 'type': 'addresses_WC_ht'}, 'dst': {'congruent': 1, 'same': False, 'type': 'addresses_UC_ht'}, 'OP': 'REPM'}
