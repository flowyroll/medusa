...
nop
cmp %rdi, %rdi
lea addresses_normal_ht+0x5c62, %rdi
nop
xor $21589, %r10
...
nop
and %rsi, %rsi
lea addresses_WC_ht+0x18862, %rsi
xor %r10, %r10
...
// REPMOV
lea addresses_UC+0x58c2, %rsi
lea addresses_A+0x87a6, %rdi
nop
cmp %r10, %r10
mov $69, %rcx
rep movsw
...
{'OP': 'REPM', 'src': {'type': 'addresses_UC', 'congruent': 4, 'same': False}, 'dst': {'type': 'addresses_A', 'congruent': 2, 'same': False}}
