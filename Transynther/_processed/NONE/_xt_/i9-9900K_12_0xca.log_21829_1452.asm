...
nop
dec %rdx
lea addresses_normal_ht+0x104fb, %rax
clflush (%rax)
nop
nop
nop
...
nop
sub $42614, %r12
lea addresses_WT_ht+0x1d356, %rdx
nop
nop
nop
nop
...
mov (%rdx), %r14w
and $12589, %r12
lea addresses_WC_ht+0x10453, %r8
nop
nop
nop
inc %rcx
...
nop
cmp $24906, %r8
lea addresses_WC_ht+0x32b3, %rsi
lea addresses_WC_ht+0x9d0b, %rdi
cmp %r12, %r12
mov $79, %rcx
rep movsq
nop
...
nop
sub %rdi, %rdi
lea addresses_UC_ht+0x7d53, %rsi
lea addresses_UC_ht+0xb80b, %rdi
nop
nop
nop
nop
...
nop
add $1437, %rax
lea addresses_WT_ht+0x1460b, %rax
nop
sub $42770, %rdi
mov (%rax), %rsi
nop
...
{'OP': 'STOR', 'dst': {'size': 8, 'NT': False, 'type': 'addresses_D', 'same': False, 'AVXalign': True, 'congruent': 9}}
{'OP': 'STOR', 'dst': {'size': 16, 'NT': False, 'type': 'addresses_WT', 'same': False, 'AVXalign': False, 'congruent': 9}}
{'OP': 'STOR', 'dst': {'size': 4, 'NT': False, 'type': 'addresses_D', 'same': False, 'AVXalign': True, 'congruent': 8}}
[Faulty Load]
...
{'OP': 'REPM', 'src': {'same': False, 'type': 'addresses_UC_ht', 'congruent': 3}, 'dst': {'same': True, 'type': 'addresses_UC_ht', 'congruent': 11}}
