...
nop
sub %r10, %r10
lea addresses_WT_ht+0x174f1, %rcx
nop
xor $60095, %r11
...
nop
cmp %r15, %r15
lea addresses_WT_ht+0x11b21, %r9
nop
nop
nop
nop
...
nop
sub %r11, %r11
lea addresses_D_ht+0x190ae, %rdi
nop
nop
nop
nop
...
nop
dec %r15
lea addresses_D_ht+0x18eed, %rsi
lea addresses_A_ht+0xfcf1, %rdi
nop
sub $46178, %r9
mov $46, %rcx
rep movsl
...
nop
xor %r10, %r10
lea addresses_WC_ht+0x1b0f1, %rsi
lea addresses_WC_ht+0x16bc1, %rdi
sub $59720, %r15
mov $28, %rcx
rep movsq
nop
nop
cmp %rdi, %rdi
lea addresses_WC_ht+0x1c2f1, %r9
nop
nop
nop
nop
...
nop
and %r10, %r10
lea addresses_D_ht+0x15471, %rsi
lea addresses_A_ht+0x1a3c9, %rdi
nop
nop
nop
inc %r14
...
nop
cmp %r15, %r15
lea addresses_A_ht+0x1c4f1, %rsi
lea addresses_normal_ht+0x1bd9, %rdi
nop
nop
nop
cmp $14641, %r10
...
nop
sub %r11, %r11
lea addresses_D_ht+0x191e1, %rcx
and $18926, %r14
movl $0x61626364, (%rcx)
nop
nop
...
{'dst': {'same': False, 'congruent': 11, 'type': 'addresses_A_ht'}, 'OP': 'REPM', 'src': {'same': False, 'congruent': 1, 'type': 'addresses_D_ht'}}
{'dst': {'same': False, 'congruent': 4, 'type': 'addresses_WC_ht'}, 'OP': 'REPM', 'src': {'same': False, 'congruent': 8, 'type': 'addresses_WC_ht'}}
...
{'dst': {'same': False, 'congruent': 3, 'type': 'addresses_normal_ht'}, 'OP': 'REPM', 'src': {'same': False, 'congruent': 11, 'type': 'addresses_A_ht'}}
{'dst': {'same': False, 'NT': False, 'AVXalign': True, 'size': 4, 'type': 'addresses_D_ht', 'congruent': 3}, 'OP': 'STOR'}
{'32': 21829}
