...
push %rdx
push %rsi
lea addresses_WT_ht+0xad62, %rsi
lea addresses_A_ht+0x117b2, %rdi
xor $54602, %rdx
mov $25, %rcx
rep movsw
nop
...
nop
and %rdx, %rdx
lea addresses_UC_ht+0x18eca, %r8
nop
nop
nop
nop
...
nop
add $9845, %rcx
lea addresses_UC_ht+0x1972, %rax
nop
nop
nop
nop
...
nop
add %rsi, %rsi
lea addresses_D_ht+0x138ea, %rdx
add %rcx, %rcx
mov $0x6162636465666768, %rax
movq %rax, %xmm1
vmovups %ymm1, (%rdx)
...
nop
cmp %rbx, %rbx
lea addresses_UC_ht+0xa1b2, %rax
nop
nop
nop
nop
...
nop
and %r8, %r8
lea addresses_UC_ht+0x43b2, %rdi
nop
cmp %r8, %r8
movl $0x61626364, (%rdi)
nop
...
nop
and $682, %rdx
lea addresses_D_ht+0x84b2, %rsi
lea addresses_WC_ht+0xd696, %rdi
nop
nop
nop
nop
...
nop
xor $22847, %rsi
lea addresses_D_ht+0x176b2, %rsi
lea addresses_WT_ht+0x616d, %rdi
nop
cmp $42766, %rax
mov $26, %rcx
rep movsb
...
nop
xor $9369, %rbp
lea addresses_A_ht+0x17d52, %rbx
nop
inc %rdi
...
nop
add %r8, %r8
lea addresses_normal_ht+0x15bb2, %rax
clflush (%rax)
nop
nop
nop
...
{'OP': 'STOR', 'dst': {'type': 'addresses_UC_ht', 'AVXalign': False, 'size': 32, 'NT': True, 'same': False, 'congruent': 0}}
...
{'src': {'type': 'addresses_D_ht', 'congruent': 4, 'same': False}, 'OP': 'REPM', 'dst': {'type': 'addresses_WC_ht', 'congruent': 0, 'same': False}}
{'src': {'type': 'addresses_D_ht', 'congruent': 8, 'same': False}, 'OP': 'REPM', 'dst': {'type': 'addresses_WT_ht', 'congruent': 0, 'same': False}}
{'OP': 'STOR', 'dst': {'type': 'addresses_A_ht', 'AVXalign': True, 'size': 32, 'NT': True, 'same': True, 'congruent': 3}}
