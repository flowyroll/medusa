...
push %rdi
push %rsi
lea addresses_WT_ht+0x5046, %r15
dec %r12
...
nop
xor $33834, %r8
lea addresses_UC_ht+0x1b02f, %rsi
lea addresses_UC_ht+0xa3f3, %rdi
nop
nop
nop
xor %r9, %r9
...
rep movsw
inc %r9
lea addresses_A_ht+0x11e26, %rsi
lea addresses_normal_ht+0x8746, %rdi
clflush (%rsi)
nop
nop
nop
...
// Load
lea addresses_normal+0x745b, %rdi
nop
nop
nop
nop
...
// Faulty Load
lea addresses_normal+0xa3c6, %r12
nop
nop
nop
nop
