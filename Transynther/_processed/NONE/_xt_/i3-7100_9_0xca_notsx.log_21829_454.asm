...
push %rdi
push %rsi
lea addresses_D_ht+0x1003a, %r14
nop
nop
nop
nop
...
nop
add %rsi, %rsi
lea addresses_normal_ht+0x16a5a, %rsi
lea addresses_WT_ht+0x201a, %rdi
nop
nop
nop
add $52499, %r15
...
{'src': {'same': False, 'congruent': 7, 'NT': False, 'type': 'addresses_WT', 'size': 32, 'AVXalign': False}, 'OP': 'LOAD'}
