...
push %rdi
push %rsi
lea addresses_WT_ht+0xb2b8, %rsi
lea addresses_WT_ht+0x1df40, %rdi
nop
inc %r9
mov $75, %rcx
rep movsb
cmp %rax, %rax
lea addresses_D_ht+0x48f0, %r11
and $59386, %r13
...
nop
inc %rax
lea addresses_WT_ht+0x1e8dd, %rsi
lea addresses_WC_ht+0x19e80, %rdi
nop
nop
nop
dec %rbx
...
nop
dec %rax
lea addresses_D_ht+0x18690, %rdi
sub $13091, %r13
...
nop
cmp %rbx, %rbx
lea addresses_WC_ht+0x366, %r11
sub %rcx, %rcx
movb (%r11), %al
nop
nop
inc %rax
lea addresses_D_ht+0x4680, %r11
clflush (%r11)
dec %rax
movl $0x61626364, (%r11)
sub $57962, %r9
lea addresses_WT_ht+0x17147, %rsi
lea addresses_D_ht+0x9a10, %rdi
clflush (%rdi)
nop
nop
xor %r11, %r11
...
nop
sub %r9, %r9
lea addresses_normal_ht+0x18d88, %rcx
nop
nop
nop
add %r9, %r9
...
nop
and %rcx, %rcx
lea addresses_WT_ht+0x51e0, %rsi
lea addresses_WC_ht+0xf740, %rdi
sub $39530, %r9
mov $53, %rcx
rep movsw
nop
...
nop
dec %rsi
lea addresses_normal_ht+0x1eb40, %rsi
lea addresses_UC_ht+0x9280, %rdi
nop
nop
nop
sub $3393, %rbx
...
nop
inc %rax
lea addresses_WT_ht+0x1be80, %rsi
lea addresses_UC_ht+0x14180, %rdi
nop
and %r13, %r13
mov $119, %rcx
rep movsw
...
nop
and %rax, %rax
lea addresses_D_ht+0xb480, %rsi
lea addresses_D_ht+0x6cc0, %rdi
add $39632, %r9
mov $15, %rcx
rep movsw
nop
...
nop
add $7409, %rax
lea addresses_UC_ht+0x1e680, %rax
nop
add $47092, %r13
movups (%rax), %xmm2
vpextrq $0, %xmm2, %r9
...
// Store
lea addresses_US+0x1b924, %r13
dec %rbp
movl $0x51525354, (%r13)
and %rbp, %rbp

// Faulty Load
lea addresses_WT+0xc680, %rbp
nop
nop
nop
nop
...
{'OP': 'STOR', 'dst': {'type': 'addresses_P', 'AVXalign': True, 'size': 2, 'NT': False, 'same': False, 'congruent': 1}}
...
{'src': {'type': 'addresses_WT_ht', 'congruent': 4, 'same': False}, 'OP': 'REPM', 'dst': {'type': 'addresses_WC_ht', 'congruent': 4, 'same': False}}
{'src': {'type': 'addresses_normal_ht', 'congruent': 6, 'same': False}, 'OP': 'REPM', 'dst': {'type': 'addresses_UC_ht', 'congruent': 7, 'same': False}}
{'src': {'type': 'addresses_WT_ht', 'congruent': 10, 'same': False}, 'OP': 'REPM', 'dst': {'type': 'addresses_UC_ht', 'congruent': 8, 'same': False}}
