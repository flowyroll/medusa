...
push %rdx
push %rsi
lea addresses_WT_ht+0x8980, %rsi
...
nop
sub $32396, %r12
lea addresses_normal_ht+0x6d00, %rsi
lea addresses_WT_ht+0x3780, %rdi
clflush (%rsi)
nop
nop
nop
...
nop
sub %r12, %r12
lea addresses_WT_ht+0xf825, %rsi
lea addresses_WC_ht+0x8380, %rdi
nop
nop
nop
sub %rdx, %rdx
...
// Faulty Load
lea addresses_normal+0x5780, %r8
nop
nop
nop
nop
...
{'OP': 'REPM', 'src': {'type': 'addresses_normal_ht', 'congruent': 3, 'same': False}, 'dst': {'type': 'addresses_WT_ht', 'congruent': 10, 'same': False}}
