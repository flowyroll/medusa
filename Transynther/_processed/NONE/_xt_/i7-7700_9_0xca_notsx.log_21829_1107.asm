...
push %rdi
push %rsi
lea addresses_normal_ht+0x1e22f, %rcx
nop
nop
nop
nop
...
nop
and $32111, %r8
lea addresses_UC_ht+0x8bcf, %r10
clflush (%r10)
nop
nop
nop
...
nop
sub $50085, %rbp
lea addresses_D_ht+0x13dcf, %rsi
nop
nop
nop
add $22897, %rcx
movw $0x6162, (%rsi)
xor $42075, %r10
lea addresses_UC_ht+0x5fcf, %rcx
and $6505, %r15
vmovups (%rcx), %ymm6
...
nop
sub %r10, %r10
lea addresses_normal_ht+0x1000f, %r14
nop
cmp $41203, %r10
movb (%r14), %r15b
nop
...
// REPMOV
lea addresses_PSE+0x9cf, %rsi
lea addresses_WT+0xec5f, %rdi
nop
nop
nop
dec %r15
...
{'src': {'congruent': 7, 'same': False, 'type': 'addresses_PSE'}, 'dst': {'congruent': 4, 'same': False, 'type': 'addresses_WT'}, 'OP': 'REPM'}
[Faulty Load]
...
{'src': {'congruent': 4, 'same': True, 'type': 'addresses_WC_ht'}, 'dst': {'congruent': 10, 'same': False, 'type': 'addresses_WC_ht'}, 'OP': 'REPM'}
