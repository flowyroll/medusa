...
push %rdi
push %rsi
lea addresses_WC_ht+0x12fe2, %r10
cmp $57152, %r9
...
lea addresses_normal_ht+0x176e2, %rdi
and %r9, %r9
mov $30, %rcx
rep movsb
nop
...
nop
xor %rax, %rax
lea addresses_UC_ht+0xdbe2, %r10
nop
nop
nop
nop
...
nop
and $13483, %rdi
lea addresses_D_ht+0x14052, %rsi
lea addresses_WT_ht+0xcee2, %rdi
clflush (%rdi)
nop
nop
nop
...
nop
and $49339, %r10
lea addresses_WT_ht+0x1b2e2, %rsi
nop
nop
nop
xor %rax, %rax
...
nop
and %r10, %r10
lea addresses_D_ht+0x17a02, %rsi
nop
nop
nop
nop
...
nop
cmp $31377, %rsi
lea addresses_UC_ht+0x168e2, %r8
nop
nop
nop
sub $58279, %r9
...
nop
cmp $45946, %r8
lea addresses_UC_ht+0xc386, %rcx
nop
xor $62169, %rbp
movl $0x61626364, (%rcx)
nop
...
// Faulty Load
lea addresses_normal+0x10ae2, %rcx
nop
nop
nop
nop
...
{'dst': {'same': False, 'congruent': 4, 'type': 'addresses_WT_ht'}, 'OP': 'REPM', 'src': {'same': False, 'congruent': 3, 'type': 'addresses_D_ht'}}
{'dst': {'same': False, 'NT': False, 'AVXalign': False, 'size': 2, 'type': 'addresses_UC_ht', 'congruent': 4}, 'OP': 'STOR'}
{'dst': {'same': False, 'congruent': 7, 'type': 'addresses_WT_ht'}, 'OP': 'REPM', 'src': {'same': False, 'congruent': 4, 'type': 'addresses_D_ht'}}
...
{'dst': {'same': False, 'NT': True, 'AVXalign': False, 'size': 8, 'type': 'addresses_UC_ht', 'congruent': 9}, 'OP': 'STOR'}
