...
push %rdi
push %rsi
lea addresses_UC_ht+0x1223d, %r9
nop
inc %rbx
mov (%r9), %rsi
and $26117, %r9
lea addresses_WT_ht+0x1bb45, %rsi
lea addresses_D_ht+0x1873d, %rdi
nop
nop
nop
nop
...
nop
dec %rcx
lea addresses_UC_ht+0x19074, %rdi
nop
nop
nop
nop
...
nop
inc %rcx
lea addresses_normal_ht+0x1cff3, %rsi
nop
xor %rcx, %rcx
mov (%rsi), %ebp
nop
sub %r9, %r9
lea addresses_UC_ht+0x143d, %rbp
sub $11686, %rbx
mov (%rbp), %di
nop
cmp %rbp, %rbp
lea addresses_WC_ht+0x473d, %rsi
lea addresses_normal_ht+0x1413d, %rdi
nop
nop
nop
nop
...
nop
cmp $17384, %rbx
lea addresses_UC_ht+0x1083d, %r15
nop
nop
xor $46339, %r9
movb $0x61, (%r15)
xor $47873, %rcx
lea addresses_normal_ht+0x133d, %rcx
nop
nop
nop
nop
...
nop
xor $36719, %rdi
lea addresses_WC_ht+0x120fd, %rsi
lea addresses_A_ht+0x118dd, %rdi
clflush (%rdi)
and $41124, %rbp
mov $114, %rcx
rep movsw
...
nop
add $3707, %rsi
lea addresses_WT_ht+0xd9c0, %rcx
cmp $32510, %rbx
mov (%rcx), %r15
nop
nop
...
{'OP': 'STOR', 'dst': {'type': 'addresses_RW', 'AVXalign': False, 'congruent': 2, 'size': 32, 'same': False, 'NT': True}}
[Faulty Load]
...
{'OP': 'REPM', 'src': {'type': 'addresses_WC_ht', 'congruent': 4, 'same': False}, 'dst': {'type': 'addresses_normal_ht', 'congruent': 8, 'same': False}}
