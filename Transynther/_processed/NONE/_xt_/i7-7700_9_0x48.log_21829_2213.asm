...
push %rdi
push %rsi
lea addresses_WT_ht+0x15c4a, %rax
nop
nop
sub %r13, %r13
...
nop
cmp $48631, %r14
lea addresses_WC_ht+0x161de, %rsi
lea addresses_normal_ht+0x1367e, %rdi
nop
nop
nop
sub %r13, %r13
...
lea addresses_A_ht+0x13ffe, %rdi
sub %rbp, %rbp
mov $68, %rcx
rep movsw
nop
add %r9, %r9
lea addresses_WC_ht+0x114fe, %rsi
lea addresses_normal_ht+0x10fe, %rdi
cmp $16857, %r11
mov $100, %rcx
rep movsb
nop
nop
and %r9, %r9
lea addresses_WT_ht+0x13981, %r13
nop
nop
sub $18187, %rcx
mov (%r13), %di
...
nop
cmp %r8, %r8
lea addresses_normal_ht+0xbd17, %r14
nop
nop
nop
nop
...
nop
sub $45327, %rcx
lea addresses_normal_ht+0x72a4, %r14
nop
nop
nop
nop
...
nop
dec %rcx
lea addresses_WT_ht+0x1ed3e, %r14
nop
nop
and %rdi, %rdi
mov (%r14), %bp
...
nop
and %rax, %rax
lea addresses_WT_ht+0x188fe, %rcx
inc %rdi
...
{'OP': 'REPM', 'src': {'type': 'addresses_WC_ht', 'congruent': 8, 'same': False}, 'dst': {'type': 'addresses_A_ht', 'congruent': 7, 'same': False}}
{'OP': 'REPM', 'src': {'type': 'addresses_WC_ht', 'congruent': 6, 'same': True}, 'dst': {'type': 'addresses_normal_ht', 'congruent': 10, 'same': False}}
