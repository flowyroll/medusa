...
nop
sub $47412, %r9
lea addresses_D_ht+0x138b5, %rcx
sub %rdx, %rdx
...
nop
inc %rcx
lea addresses_UC_ht+0x148e3, %rcx
nop
add $65145, %r8
movups (%rcx), %xmm7
vpextrq $1, %xmm7, %r9
...
nop
cmp %rax, %rax
lea addresses_normal_ht+0x146b5, %r8
nop
nop
nop
nop
...
nop
add %r8, %r8
lea addresses_D_ht+0x26b5, %rsi
lea addresses_D_ht+0x11eb5, %rdi
clflush (%rsi)
add $36636, %r9
mov $89, %rcx
rep movsq
...
nop
cmp $14776, %rsi
lea addresses_normal_ht+0x12f9b, %r14
nop
add $26274, %r8
movups (%r14), %xmm0
vpextrq $0, %xmm0, %rax
dec %rax
lea addresses_WC_ht+0x1be0a, %rax
nop
nop
nop
nop
...
nop
inc %r14
lea addresses_UC_ht+0x157b5, %rsi
inc %r8
movups (%rsi), %xmm0
vpextrq $0, %xmm0, %r9
and $28407, %r9
lea addresses_normal_ht+0x1248d, %rsi
lea addresses_D_ht+0x1ea35, %rdi
nop
nop
cmp %r15, %r15
mov $17, %rcx
...
{'src': {'type': 'addresses_UC_ht', 'AVXalign': False, 'size': 16, 'NT': False, 'same': True, 'congruent': 1}, 'OP': 'LOAD'}
