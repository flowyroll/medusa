...
nop
sub %rdi, %rdi
lea addresses_A_ht+0x162bf, %r15
nop
cmp $34830, %rcx
vmovups (%r15), %ymm2
...
nop
and $39358, %rdi
lea addresses_WT_ht+0x124bf, %rbx
nop
nop
nop
nop
...
nop
sub %rdi, %rdi
lea addresses_UC_ht+0x163af, %r8
nop
nop
nop
and %rcx, %rcx
...
nop
cmp %rdi, %rdi
lea addresses_A_ht+0x1d3bf, %rsi
lea addresses_WC_ht+0xc31f, %rdi
nop
nop
nop
nop
...
rep movsw
cmp %rbx, %rbx
lea addresses_UC_ht+0xc3d5, %r13
nop
cmp %r15, %r15
mov (%r13), %esi
nop
...
nop
add %r10, %r10
lea addresses_UC_ht+0x1c96, %r10
and $21689, %rcx
movb (%r10), %r15b
nop
sub %rbx, %rbx
lea addresses_WT_ht+0x5abf, %rdi
nop
nop
and $43042, %r15
...
{'src': {'congruent': 9, 'AVXalign': True, 'same': False, 'size': 1, 'NT': True, 'type': 'addresses_WT_ht'}, 'OP': 'LOAD'}
{'src': {'congruent': 3, 'AVXalign': False, 'same': False, 'size': 16, 'NT': False, 'type': 'addresses_UC_ht'}, 'OP': 'LOAD'}
{'src': {'congruent': 7, 'same': True, 'type': 'addresses_A_ht'}, 'OP': 'REPM', 'dst': {'congruent': 4, 'same': False, 'type': 'addresses_WC_ht'}}
