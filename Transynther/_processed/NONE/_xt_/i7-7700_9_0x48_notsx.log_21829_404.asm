...
push %rdi
push %rsi
lea addresses_WT_ht+0x973f, %rsi
lea addresses_WT_ht+0x19a3f, %rdi
nop
nop
nop
nop
...
nop
dec %rbp
lea addresses_WT_ht+0xad3f, %rsi
lea addresses_A_ht+0x7cbf, %rdi
nop
nop
nop
nop
...
nop
xor $40962, %rcx
lea addresses_D_ht+0x195ff, %rcx
nop
nop
sub %r13, %r13
...
nop
add $64531, %rcx
lea addresses_WC_ht+0xceff, %rbp
nop
nop
add %rsi, %rsi
movl $0x61626364, (%rbp)
...
// Faulty Load
lea addresses_normal+0x12e3f, %r8
nop
nop
inc %rcx
mov (%r8), %r9d
