...
nop
sub %rsi, %rsi
lea addresses_UC_ht+0x19d0, %r14
nop
nop
and %rdx, %rdx
mov (%r14), %r11
cmp %rsi, %rsi
lea addresses_WT_ht+0xdfd8, %rdi
nop
cmp %rcx, %rcx
...
nop
inc %r8
lea addresses_WC_ht+0x19d7, %rdx
nop
and $64886, %r14
movb $0x61, (%rdx)
nop
add %rdi, %rdi
lea addresses_WT_ht+0x1990, %rsi
lea addresses_A_ht+0x1a990, %rdi
nop
nop
nop
xor $26133, %rbp
...
nop
and $65157, %rcx
lea addresses_D_ht+0x15ed0, %r8
nop
nop
and $44823, %r14
movw $0x6162, (%r8)
cmp $20856, %rbp
lea addresses_normal_ht+0x9430, %rbp
nop
nop
nop
and %r8, %r8
...
nop
add $19573, %r11
lea addresses_WT_ht+0x4328, %rbp
sub %r14, %r14
movw $0x6162, (%rbp)
nop
nop
...
// REPMOV
lea addresses_RW+0x106b0, %rsi
lea addresses_D+0x1dee0, %rdi
dec %r9
mov $54, %rcx
rep movsb
nop
...
{'src': {'type': 'addresses_RW', 'congruent': 5, 'same': False}, 'dst': {'type': 'addresses_D', 'congruent': 4, 'same': False}, 'OP': 'REPM'}
{'src': {'type': 'addresses_P', 'same': False, 'size': 4, 'congruent': 10, 'NT': False, 'AVXalign': True}, 'OP': 'LOAD'}
[Faulty Load]
...
{'src': {'type': 'addresses_WT_ht', 'congruent': 11, 'same': False}, 'dst': {'type': 'addresses_A_ht', 'congruent': 11, 'same': False}, 'OP': 'REPM'}
...
{'src': {'type': 'addresses_WT_ht', 'congruent': 9, 'same': False}, 'dst': {'type': 'addresses_D_ht', 'congruent': 9, 'same': False}, 'OP': 'REPM'}
{'dst': {'type': 'addresses_D_ht', 'same': False, 'size': 2, 'congruent': 2, 'NT': False, 'AVXalign': True}, 'OP': 'STOR'}
