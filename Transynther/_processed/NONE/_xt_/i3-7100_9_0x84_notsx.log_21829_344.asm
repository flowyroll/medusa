...
push %rdi
push %rsi
lea addresses_WT_ht+0x188f4, %rax
nop
nop
nop
nop
...
nop
add $42071, %rsi
lea addresses_WT_ht+0x918c, %rdi
nop
nop
nop
nop
...
movb (%rdi), %r14b
add $17714, %r14
lea addresses_WC_ht+0x2ee4, %rsi
nop
nop
nop
xor %rdi, %rdi
...
nop
and $23523, %r15
lea addresses_WT_ht+0x149f4, %rsi
lea addresses_WT_ht+0x1e9f0, %rdi
nop
xor $39636, %r13
mov $81, %rcx
rep movsl
...
nop
cmp $61678, %rdi
lea addresses_A_ht+0x1e174, %rdi
cmp %r15, %r15
mov (%rdi), %r13
nop
nop
dec %r8
lea addresses_UC_ht+0x163f4, %rsi
lea addresses_UC_ht+0x45a4, %rdi
nop
nop
nop
nop
...
nop
sub $19867, %rax
lea addresses_normal_ht+0x11f94, %rax
nop
nop
nop
dec %rcx
...
nop
xor %r8, %r8
lea addresses_WC_ht+0x15ef4, %rsi
lea addresses_A_ht+0x16682, %rdi
nop
nop
nop
nop
...
rep movsw
add %r14, %r14
lea addresses_WT_ht+0x1b6f4, %rsi
lea addresses_WC_ht+0x19f24, %rdi
nop
nop
sub %r8, %r8
mov $70, %rcx
...
nop
and $37175, %rax
lea addresses_WT_ht+0x1b682, %r15
nop
nop
nop
and %rax, %rax
...
// Store
lea addresses_normal+0xca54, %r11
nop
nop
nop
nop
...
{'src': {'type': 'addresses_WT_ht', 'congruent': 8, 'same': False}, 'dst': {'type': 'addresses_WT_ht', 'congruent': 2, 'same': True}, 'OP': 'REPM'}
{'src': {'type': 'addresses_A_ht', 'same': False, 'size': 8, 'congruent': 7, 'NT': False, 'AVXalign': False}, 'OP': 'LOAD'}
{'src': {'type': 'addresses_UC_ht', 'congruent': 8, 'same': False}, 'dst': {'type': 'addresses_UC_ht', 'congruent': 4, 'same': False}, 'OP': 'REPM'}
...
{'src': {'type': 'addresses_WT_ht', 'congruent': 8, 'same': True}, 'dst': {'type': 'addresses_WC_ht', 'congruent': 4, 'same': False}, 'OP': 'REPM'}
