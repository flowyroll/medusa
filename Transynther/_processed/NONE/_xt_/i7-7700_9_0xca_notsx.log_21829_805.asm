...
nop
sub $5543, %r13
lea addresses_WC_ht+0x1aaff, %r15
clflush (%r15)
nop
nop
nop
...
movl $0x61626364, (%r15)
dec %rdx
lea addresses_WT_ht+0x147f3, %r15
cmp %r8, %r8
...
nop
cmp %rdi, %rdi
lea addresses_A_ht+0xe8c3, %rsi
lea addresses_WT_ht+0xf47f, %rdi
nop
nop
xor $13850, %r12
mov $113, %rcx
...
{'dst': {'NT': True, 'AVXalign': False, 'size': 32, 'congruent': 5, 'same': False, 'type': 'addresses_A_ht'}, 'OP': 'STOR'}
