...
push %rdi
push %rsi
lea addresses_WC_ht+0xd1c5, %r13
nop
nop
nop
xor %r15, %r15
...
lea addresses_A_ht+0x18f05, %rdi
nop
cmp $8081, %r9
mov $83, %rcx
rep movsq
nop
cmp %r13, %r13
lea addresses_D_ht+0xa519, %rsi
lea addresses_UC_ht+0x131d5, %rdi
clflush (%rdi)
nop
xor $63868, %r8
mov $90, %rcx
...
nop
and $49143, %r13
lea addresses_WT_ht+0x273d, %rsi
nop
xor %r8, %r8
...
nop
and %r13, %r13
lea addresses_WC_ht+0x1642d, %r8
nop
nop
cmp %r12, %r12
movb $0x61, (%r8)
...
{'OP': 'LOAD', 'src': {'same': False, 'type': 'addresses_D_ht', 'NT': True, 'AVXalign': False, 'size': 1, 'congruent': 5}}
