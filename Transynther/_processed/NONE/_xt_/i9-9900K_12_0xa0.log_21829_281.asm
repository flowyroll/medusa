...
nop
dec %r13
lea addresses_normal_ht+0x1e9d3, %rsi
lea addresses_D_ht+0x1e693, %rdi
clflush (%rsi)
nop
nop
nop
...
rep movsq
add $8845, %rsi
lea addresses_D_ht+0x14ab3, %rsi
nop
nop
nop
nop
...
nop
and $47485, %rcx
lea addresses_D_ht+0x19b93, %rdi
clflush (%rdi)
nop
nop
nop
...
nop
sub %rdi, %rdi
lea addresses_WC_ht+0x7293, %rsi
lea addresses_A_ht+0x1c6f3, %rdi
clflush (%rsi)
clflush (%rdi)
nop
and $40897, %r10
...
nop
xor %rsi, %rsi
lea addresses_UC_ht+0x1e93, %rsi
lea addresses_A_ht+0x10ab3, %rdi
clflush (%rsi)
nop
nop
nop
...
nop
cmp $35519, %r12
lea addresses_UC_ht+0x187e5, %r10
nop
nop
add %rcx, %rcx
movl $0x61626364, (%r10)
add $59050, %r13
lea addresses_D_ht+0x1b493, %rsi
nop
sub $23096, %r10
mov (%rsi), %rdi
nop
...
nop
xor %r13, %r13
lea addresses_WT_ht+0x12c93, %rsi
lea addresses_D_ht+0x1c293, %rdi
nop
nop
nop
and $35477, %r14
...
{'src': {'NT': False, 'same': False, 'congruent': 5, 'type': 'addresses_RW', 'AVXalign': True, 'size': 1}, 'OP': 'LOAD'}
...
{'src': {'same': False, 'congruent': 5, 'type': 'addresses_normal_ht'}, 'OP': 'REPM', 'dst': {'same': False, 'congruent': 9, 'type': 'addresses_D_ht'}}
...
{'src': {'same': False, 'congruent': 10, 'type': 'addresses_UC_ht'}, 'OP': 'REPM', 'dst': {'same': False, 'congruent': 0, 'type': 'addresses_A_ht'}}
