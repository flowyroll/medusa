...
push %rdi
push %rsi
lea addresses_normal_ht+0x1adc, %r14
add $32442, %rsi
vmovups (%r14), %ymm2
...
nop
dec %rax
lea addresses_normal_ht+0x320c, %rsi
lea addresses_WC_ht+0x96dc, %rdi
xor $2232, %rax
mov $20, %rcx
rep movsb
add %rsi, %rsi
lea addresses_UC_ht+0x15dc, %rcx
nop
and %rax, %rax
movups (%rcx), %xmm7
vpextrq $1, %xmm7, %r14
nop
inc %rcx
lea addresses_WT_ht+0x1cedc, %rsi
nop
nop
nop
nop
...
nop
sub $57845, %rax
lea addresses_WT_ht+0x42dc, %rbp
nop
nop
nop
inc %rsi
...
nop
sub %rdi, %rdi
lea addresses_D_ht+0x112a7, %r14
clflush (%r14)
nop
nop
sub $65034, %rbp
movb $0x61, (%r14)
and %r11, %r11
lea addresses_A_ht+0x11ddc, %rax
dec %rdi
mov (%rax), %r11d
nop
and $2086, %rax
lea addresses_D_ht+0x1eddc, %rcx
nop
nop
and %r11, %r11
...
nop
sub %r14, %r14
lea addresses_A_ht+0x1efdc, %rax
nop
cmp %rcx, %rcx
mov (%rax), %r14w
nop
...
nop
cmp $33833, %r14
lea addresses_WT_ht+0x1a1dc, %rdi
inc %rax
mov (%rdi), %bp
nop
nop
...
nop
add %rcx, %rcx
lea addresses_A_ht+0x15be8, %rax
nop
nop
nop
sub $10251, %rdi
...
// Load
lea addresses_normal+0x1eb90, %r13
nop
nop
nop
nop
...
{'OP': 'LOAD', 'src': {'same': False, 'NT': False, 'AVXalign': False, 'size': 2, 'type': 'addresses_normal', 'congruent': 1}}
[Faulty Load]
