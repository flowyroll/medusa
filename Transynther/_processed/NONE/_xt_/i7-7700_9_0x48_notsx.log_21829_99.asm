...
push %rdx
push %rsi
lea addresses_WC_ht+0x18e0c, %rsi
lea addresses_normal_ht+0x1edcc, %rdi
nop
nop
nop
nop
...
rep movsb
sub $31214, %r10
lea addresses_A_ht+0x19c54, %rdx
clflush (%rdx)
nop
nop
nop
...
movl $0x61626364, (%rdx)
dec %r12
lea addresses_WT_ht+0x960c, %r12
nop
nop
dec %r10
movw $0x6162, (%r12)
...
nop
dec %rdx
lea addresses_WC_ht+0xec8c, %r12
nop
nop
add %r10, %r10
mov (%r12), %r11w
inc %rdi
lea addresses_A_ht+0x9e0c, %rdi
nop
nop
nop
nop
...
mov (%rdi), %r11
add $38222, %rsi
lea addresses_A_ht+0x1ab18, %rsi
lea addresses_WC_ht+0x760c, %rdi
dec %r13
mov $107, %rcx
rep movsq
nop
...
nop
sub $59750, %rdx
lea addresses_WC_ht+0x1318c, %r11
nop
xor $11912, %r10
movb $0x61, (%r11)
nop
...
nop
add $53772, %rdi
lea addresses_D_ht+0x1b40c, %rdx
clflush (%rdx)
nop
nop
nop
...
<gen_prepare_buffer>
{'dst': {'same': True, 'congruent': 6, 'type': 'addresses_normal_ht'}, 'OP': 'REPM', 'src': {'same': False, 'congruent': 11, 'type': 'addresses_WC_ht'}}
{'dst': {'same': True, 'NT': False, 'AVXalign': True, 'size': 4, 'type': 'addresses_A_ht', 'congruent': 2}, 'OP': 'STOR'}
{'dst': {'same': False, 'NT': False, 'AVXalign': True, 'size': 2, 'type': 'addresses_WT_ht', 'congruent': 9}, 'OP': 'STOR'}
