...
nop
cmp $39537, %r10
lea addresses_WT_ht+0x1717a, %rsi
lea addresses_WT_ht+0x1ef2a, %rdi
nop
nop
nop
nop
...
nop
xor %rdx, %rdx
lea addresses_WT_ht+0x1e05e, %rcx
and %rbp, %rbp
movb (%rcx), %r10b
nop
nop
...
nop
add %rbp, %rbp
lea addresses_UC_ht+0xb50a, %r10
nop
dec %rcx
movups (%r10), %xmm0
vpextrq $0, %xmm0, %r13
...
nop
and $25825, %rbp
lea addresses_UC_ht+0x1e22a, %rsi
lea addresses_normal_ht+0x1d3aa, %rdi
nop
nop
nop
nop
...
nop
and %r8, %r8
lea addresses_WC_ht+0x7fa2, %rsi
lea addresses_UC_ht+0x592a, %rdi
clflush (%rdi)
nop
inc %r8
mov $76, %rcx
...
nop
and $63735, %rdi
lea addresses_normal_ht+0x1adaa, %rsi
...
{'src': {'type': 'addresses_WT_ht', 'congruent': 4, 'same': False}, 'OP': 'REPM', 'dst': {'type': 'addresses_WT_ht', 'congruent': 9, 'same': False}}
{'src': {'same': True, 'congruent': 1, 'NT': True, 'type': 'addresses_WT_ht', 'size': 1, 'AVXalign': False}, 'OP': 'LOAD'}
