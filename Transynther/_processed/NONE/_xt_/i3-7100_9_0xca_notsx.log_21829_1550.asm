...
push %rdx
push %rsi
lea addresses_D_ht+0x1246c, %rsi
lea addresses_normal_ht+0x13b18, %rdi
nop
nop
nop
and %r10, %r10
...
mov (%rbx), %r10d
add $56354, %r10
lea addresses_WC_ht+0x1c014, %rsi
nop
nop
nop
nop
...
nop
and $36904, %r10
lea addresses_A_ht+0x16d60, %rsi
...
nop
cmp $15211, %r10
lea addresses_normal_ht+0xfebc, %rdx
clflush (%rdx)
nop
nop
nop
...
// Faulty Load
lea addresses_normal+0x1cb6c, %r8
nop
nop
nop
nop
...
<gen_prepare_buffer>
{'src': {'type': 'addresses_D_ht', 'congruent': 6, 'same': False}, 'OP': 'REPM', 'dst': {'type': 'addresses_normal_ht', 'congruent': 1, 'same': True}}
