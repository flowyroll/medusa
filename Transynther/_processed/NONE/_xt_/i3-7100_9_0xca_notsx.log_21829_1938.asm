...
push %rdx
push %rsi
lea addresses_WC_ht+0xeca6, %rsi
lea addresses_A_ht+0x158a6, %rdi
nop
nop
nop
nop
...
nop
cmp $22003, %r15
lea addresses_normal_ht+0x60a6, %rdi
nop
nop
nop
nop
...
nop
and %r15, %r15
lea addresses_UC_ht+0x1e286, %rsi
...
nop
sub %rdx, %rdx
lea addresses_WC_ht+0xee9e, %rdi
nop
sub $32677, %r8
mov (%rdi), %rbx
nop
...
nop
and %rsi, %rsi
lea addresses_WC_ht+0xffa6, %rsi
lea addresses_WC_ht+0x54a6, %rdi
nop
sub $34368, %r13
mov $111, %rcx
rep movsq
nop
sub %r15, %r15
lea addresses_D_ht+0x118e6, %rcx
nop
xor $703, %rbx
...
{'src': {'same': True, 'congruent': 0, 'NT': False, 'type': 'addresses_UC', 'size': 32, 'AVXalign': False}, 'OP': 'LOAD'}
<gen_prepare_buffer>
{'src': {'type': 'addresses_WC_ht', 'congruent': 11, 'same': True}, 'OP': 'REPM', 'dst': {'type': 'addresses_A_ht', 'congruent': 10, 'same': False}}
{'src': {'same': True, 'congruent': 9, 'NT': False, 'type': 'addresses_normal_ht', 'size': 2, 'AVXalign': False}, 'OP': 'LOAD'}
{'src': {'type': 'addresses_UC_ht', 'congruent': 1, 'same': False}, 'OP': 'REPM', 'dst': {'type': 'addresses_normal_ht', 'congruent': 2, 'same': False}}
