...
// REPMOV
lea addresses_A+0x1b81d, %rsi
lea addresses_normal+0xc6dd, %rdi
nop
nop
nop
nop
...
// Store
lea addresses_normal+0x83dd, %rbp
nop
nop
add %rdi, %rdi
movw $0x5152, (%rbp)
...
{'OP': 'LOAD', 'src': {'same': False, 'type': 'addresses_RW', 'NT': False, 'AVXalign': False, 'size': 8, 'congruent': 8}}
{'OP': 'REPM', 'src': {'same': False, 'congruent': 3, 'type': 'addresses_A'}, 'dst': {'same': False, 'congruent': 8, 'type': 'addresses_normal'}}
...
{'OP': 'REPM', 'src': {'same': False, 'congruent': 5, 'type': 'addresses_WC_ht'}, 'dst': {'same': False, 'congruent': 2, 'type': 'addresses_UC_ht'}}
{'39': 21829}
