...
push %rdx
push %rsi
lea addresses_WT_ht+0x3697, %rdx
nop
nop
nop
nop
...
nop
inc %r9
lea addresses_WC_ht+0x5153, %r12
nop
nop
nop
nop
...
mov (%r9), %r14
mfence
lea addresses_WT_ht+0x6bcf, %rsi
lea addresses_A_ht+0x10ebb, %rdi
nop
nop
nop
nop
...
nop
cmp %rsi, %rsi
lea addresses_A_ht+0x9cd3, %rsi
lea addresses_normal_ht+0x1b5d3, %rdi
nop
cmp $56177, %rdx
mov $23, %rcx
rep movsb
nop
add $10705, %r10
lea addresses_D_ht+0x1e053, %rsi
lea addresses_normal_ht+0x1d053, %rdi
clflush (%rsi)
nop
nop
nop
...
nop
sub %rdx, %rdx
lea addresses_WT_ht+0xe1d3, %rcx
inc %r13
movl $0x61626364, (%rcx)
nop
nop
...
{'src': {'type': 'addresses_RW', 'same': False, 'size': 8, 'congruent': 5, 'NT': False, 'AVXalign': False}, 'OP': 'LOAD'}
[Faulty Load]
{'src': {'type': 'addresses_PSE', 'same': True, 'size': 16, 'congruent': 0, 'NT': False, 'AVXalign': False}, 'OP': 'LOAD'}
<gen_prepare_buffer>
...
{'src': {'type': 'addresses_D_ht', 'congruent': 6, 'same': False}, 'dst': {'type': 'addresses_normal_ht', 'congruent': 6, 'same': False}, 'OP': 'REPM'}
{'dst': {'type': 'addresses_WT_ht', 'same': False, 'size': 4, 'congruent': 8, 'NT': False, 'AVXalign': True}, 'OP': 'STOR'}
{'33': 21829}
