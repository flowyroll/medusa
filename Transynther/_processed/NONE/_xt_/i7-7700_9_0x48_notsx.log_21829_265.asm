...
push %rdi
push %rsi
lea addresses_normal_ht+0x1b4a3, %rsi
lea addresses_WC_ht+0x1edb3, %rdi
clflush (%rdi)
nop
nop
nop
...
nop
cmp $31218, %rbx
lea addresses_WT_ht+0x8123, %r14
nop
nop
cmp %rsi, %rsi
mov (%r14), %ebx
nop
and %rsi, %rsi
lea addresses_normal_ht+0x15cd3, %r12
nop
nop
nop
add %r10, %r10
...
// Load
lea addresses_normal+0x11d23, %r12
nop
nop
nop
and $13432, %r10
...
// Faulty Load
lea addresses_normal+0x11d23, %rax
nop
add %r11, %r11
mov (%rax), %r10w
lea oracles, %r15
