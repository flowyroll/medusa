...
nop
and %rbp, %rbp
lea addresses_normal_ht+0xfa96, %rsi
lea addresses_WC_ht+0xb8ce, %rdi
nop
and $36402, %r15
mov $66, %rcx
rep movsw
...
movq %rbp, (%r15)
cmp %rbp, %rbp
lea addresses_A_ht+0xaac6, %rsi
lea addresses_D_ht+0x7c78, %rdi
nop
nop
nop
add $60508, %r8
...
rep movsw
add %rcx, %rcx
lea addresses_WC_ht+0x15e5e, %rsi
clflush (%rsi)
nop
cmp $8399, %rax
movups (%rsi), %xmm6
...
nop
cmp $31563, %rbp
lea addresses_normal_ht+0xdc5e, %rbp
nop
nop
nop
cmp %rdi, %rdi
