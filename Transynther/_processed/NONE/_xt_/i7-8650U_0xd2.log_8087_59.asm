...
nop
cmp $38525, %rax
lea addresses_normal_ht+0x17251, %rbp
nop
xor %r11, %r11
...
nop
sub $37206, %r11
lea addresses_normal_ht+0xf2f5, %rsi
lea addresses_UC_ht+0xefd1, %rdi
nop
nop
nop
nop
...
rep movsq
inc %rsi
lea addresses_UC_ht+0x19fec, %rsi
lea addresses_WT_ht+0x6551, %rdi
nop
nop
sub %rbp, %rbp
mov $90, %rcx
...
nop
dec %rdx
lea addresses_WT_ht+0x1b551, %r13
nop
dec %r14
mov (%r13), %edi
nop
and $32242, %r13
lea addresses_D_ht+0x1df51, %r11
clflush (%r11)
xor %r14, %r14
movw $0x6162, (%r11)
nop
nop
xor $15959, %rcx
lea addresses_WT_ht+0x1451, %rsi
nop
xor $26300, %rcx
movb (%rsi), %r14b
nop
...
nop
dec %rax
lea addresses_UC_ht+0xa082, %r13
nop
nop
nop
nop
...
{'OP': 'STOR', 'dst': {'type': 'addresses_D_ht', 'size': 2, 'AVXalign': True, 'NT': False, 'congruent': 9, 'same': True}}
