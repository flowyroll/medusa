...
lea addresses_normal_ht+0x1488a, %rdi
clflush (%rsi)
nop
nop
nop
...
nop
mfence
lea addresses_WT_ht+0x98b6, %r10
nop
xor $40769, %rsi
movb $0x61, (%r10)
nop
...
nop
and $52953, %rbp
lea addresses_A_ht+0x4bb6, %rsi
lea addresses_WC_ht+0x1e336, %rdi
clflush (%rsi)
nop
nop
nop
...
nop
add $45923, %r10
lea addresses_normal_ht+0xcf36, %r10
nop
inc %r11
mov (%r10), %r15w
nop
...
nop
add %r14, %r14
lea addresses_WT_ht+0x15736, %rbp
nop
add %r15, %r15
movups (%rbp), %xmm4
vpextrq $1, %xmm4, %r11
nop
cmp %rbp, %rbp
lea addresses_UC_ht+0x4c36, %rsi
lea addresses_A_ht+0xf36, %rdi
nop
nop
nop
and $36793, %rbp
...
nop
and %r10, %r10
lea addresses_UC_ht+0x14436, %rdi
nop
nop
nop
cmp %rbp, %rbp
