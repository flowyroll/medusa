...
push %rdi
push %rsi
lea addresses_D_ht+0x1adbc, %rsi
lea addresses_WC_ht+0xa9b8, %rdi
clflush (%rsi)
clflush (%rdi)
nop
nop
...
nop
inc %r8
lea addresses_D_ht+0x128c6, %rsi
lea addresses_normal_ht+0x1ebc, %rdi
nop
nop
nop
add %rbp, %rbp
...
nop
cmp %rcx, %rcx
lea addresses_D_ht+0xb21c, %rsi
lea addresses_WT_ht+0x6f79, %rdi
xor %r8, %r8
mov $87, %rcx
rep movsw
nop
...
nop
sub %rsi, %rsi
lea addresses_A_ht+0xd5fc, %rsi
lea addresses_WT_ht+0x195bc, %rdi
nop
nop
nop
nop
