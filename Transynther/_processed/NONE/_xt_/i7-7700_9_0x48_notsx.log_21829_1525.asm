...
movw $0x6162, (%rbp)
and %r15, %r15
lea addresses_WC_ht+0x1b51, %rsi
lea addresses_A_ht+0xbb2b, %rdi
nop
nop
and %r13, %r13
mov $108, %rcx
...
nop
add %rdx, %rdx
lea addresses_normal_ht+0x1ed51, %r13
nop
nop
nop
inc %rdi
...
nop
cmp %rdi, %rdi
lea addresses_A_ht+0x1e151, %rcx
nop
nop
nop
nop
...
nop
cmp %r15, %r15
lea addresses_WC_ht+0x7abb, %rsi
lea addresses_normal_ht+0x11ed1, %rdi
nop
nop
inc %rbp
mov $57, %rcx
...
nop
sub $64842, %rax
lea addresses_WT_ht+0x18691, %rcx
nop
nop
nop
nop
...
nop
cmp %rcx, %rcx
lea addresses_normal_ht+0xb7a1, %rsi
lea addresses_UC_ht+0x12a51, %rdi
clflush (%rdi)
nop
nop
nop
...
rep movsl
add $52851, %rdx
lea addresses_UC_ht+0xe551, %r15
nop
nop
and $1774, %rdi
mov $0x6162636465666768, %rax
...
nop
inc %rax
lea addresses_normal_ht+0x2151, %rax
clflush (%rax)
nop
nop
nop
...
// Store
lea addresses_normal+0x14c51, %rbp
nop
nop
nop
nop
...
// Store
lea addresses_normal+0x1d011, %rsi
clflush (%rsi)
nop
inc %rdx
...
{'dst': {'same': False, 'congruent': 7, 'type': 'addresses_normal_ht'}, 'OP': 'REPM', 'src': {'same': False, 'congruent': 0, 'type': 'addresses_WC_ht'}}
...
{'dst': {'same': False, 'congruent': 8, 'type': 'addresses_UC_ht'}, 'OP': 'REPM', 'src': {'same': False, 'congruent': 1, 'type': 'addresses_normal_ht'}}
