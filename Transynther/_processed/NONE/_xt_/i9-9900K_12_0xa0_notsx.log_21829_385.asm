...
push %rdi
push %rsi
lea addresses_A_ht+0x13a9c, %rsi
lea addresses_normal_ht+0x1ed3c, %rdi
clflush (%rdi)
cmp %r10, %r10
mov $55, %rcx
rep movsw
sub $60661, %rdi
lea addresses_A_ht+0x12764, %rax
nop
nop
nop
add $7567, %rcx
...
nop
inc %rcx
lea addresses_A_ht+0x109e2, %rax
nop
nop
nop
nop
...
nop
inc %r8
lea addresses_D_ht+0x123bc, %rsi
lea addresses_UC_ht+0x15e3c, %rdi
cmp %r9, %r9
mov $83, %rcx
rep movsw
and $14658, %r8
lea addresses_UC_ht+0xcd3c, %rsi
lea addresses_normal_ht+0x6ebc, %rdi
nop
nop
nop
nop
...
nop
sub $11089, %rsi
lea addresses_WC_ht+0x1513c, %r10
xor %rcx, %rcx
...
nop
sub $50949, %rsi
lea addresses_WC_ht+0xc522, %r11
nop
nop
nop
nop
...
nop
xor %r8, %r8
lea addresses_WC_ht+0xcd3c, %rsi
lea addresses_WT_ht+0xdb3c, %rdi
sub %r11, %r11
mov $81, %rcx
rep movsb
nop
...
mov (%rsi), %r8d
dec %r8
lea addresses_normal_ht+0x92a1, %rsi
...
nop
inc %rcx
lea addresses_WT_ht+0xb1c, %rsi
lea addresses_D_ht+0x113bc, %rdi
nop
nop
sub %r11, %r11
mov $58, %rcx
...
nop
add $49777, %rsi
lea addresses_A_ht+0x1073c, %rsi
lea addresses_WT_ht+0x18c7c, %rdi
nop
nop
nop
nop
...
nop
and %r11, %r11
lea addresses_A_ht+0x1769c, %rcx
nop
nop
nop
nop
...
// Store
lea addresses_A+0x1509c, %r14
xor %rdi, %rdi
movw $0x5152, (%r14)
and $7701, %rdx

// Load
lea addresses_RW+0x1123c, %rdx
nop
nop
nop
xor $52390, %r10
...
{'src': {'type': 'addresses_D_ht', 'congruent': 7, 'same': False}, 'OP': 'REPM', 'dst': {'type': 'addresses_UC_ht', 'congruent': 8, 'same': False}}
{'src': {'type': 'addresses_UC_ht', 'congruent': 9, 'same': False}, 'OP': 'REPM', 'dst': {'type': 'addresses_normal_ht', 'congruent': 4, 'same': False}}
...
{'src': {'type': 'addresses_normal_ht', 'congruent': 0, 'same': False}, 'OP': 'REPM', 'dst': {'type': 'addresses_WC_ht', 'congruent': 0, 'same': False}}
