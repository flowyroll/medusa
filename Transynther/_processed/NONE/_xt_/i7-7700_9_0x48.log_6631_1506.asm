...
nop
inc %rsi
lea addresses_WT_ht+0x1d061, %r12
nop
nop
xor $32032, %r14
movups (%r12), %xmm6
...
nop
sub $34729, %rsi
lea addresses_normal_ht+0x1caa1, %rsi
nop
inc %rcx
movw $0x6162, (%rsi)
nop
...
// Store
lea addresses_normal+0x6ba1, %r11
nop
nop
add $10850, %r14
movw $0x5152, (%r11)
...
// Store
lea addresses_normal+0x4301, %rdx
nop
nop
nop
nop
...
{'OP': 'REPM', 'src': {'type': 'addresses_D_ht', 'congruent': 0, 'same': False}, 'dst': {'type': 'addresses_A_ht', 'congruent': 5, 'same': False}}
