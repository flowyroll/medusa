...
push %rdx
push %rsi
lea addresses_normal_ht+0x85e3, %rdx
nop
nop
nop
nop
...
nop
sub $44822, %rcx
lea addresses_normal_ht+0xc803, %rsi
lea addresses_UC_ht+0x1c383, %rdi
add %r13, %r13
mov $43, %rcx
rep movsq
nop
cmp $63406, %rsi
lea addresses_normal_ht+0x1a503, %rsi
nop
nop
nop
nop
...
// REPMOV
lea addresses_A+0x1b0e3, %rsi
lea addresses_A+0x1d2a0, %rdi
nop
nop
nop
nop
...
// REPMOV
lea addresses_WC+0x11303, %rsi
lea addresses_WC+0x11303, %rdi
nop
nop
nop
sub $28833, %rbx
...
{'src': {'type': 'addresses_A', 'congruent': 2, 'same': False}, 'OP': 'REPM', 'dst': {'type': 'addresses_A', 'congruent': 0, 'same': False}}
