...
push %rdx
push %rsi
lea addresses_UC_ht+0x41d5, %rbp
nop
nop
nop
and %r13, %r13
movw $0x6162, (%rbp)
xor %rdx, %rdx
lea addresses_WC_ht+0x108e3, %rsi
lea addresses_UC_ht+0x19ae5, %rdi
nop
nop
xor %r8, %r8
mov $27, %rcx
...
nop
xor %rax, %rax
lea addresses_D_ht+0xbebb, %rsi
lea addresses_WC_ht+0x1e73, %rdi
nop
nop
nop
nop
...
rep movsq
cmp $43680, %rax
lea addresses_D_ht+0x1de65, %rdx
nop
nop
lfence
movw $0x6162, (%rdx)
...
// Faulty Load
lea addresses_normal+0xed65, %r13
xor %rsi, %rsi
mov (%r13), %r8
lea oracles, %r15
and $0xff, %r8
