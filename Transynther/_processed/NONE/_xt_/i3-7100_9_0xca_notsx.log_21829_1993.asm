...
push %rdx
push %rsi
lea addresses_WT_ht+0x16d3c, %rsi
lea addresses_normal_ht+0x1093c, %rdi
nop
sub $32100, %r10
mov $95, %rcx
rep movsl
nop
xor %rdx, %rdx
lea addresses_normal_ht+0x573c, %r13
nop
nop
inc %rbp
movb (%r13), %dl
...
{'src': {'same': False, 'congruent': 6, 'NT': False, 'type': 'addresses_UC', 'size': 4, 'AVXalign': False}, 'OP': 'LOAD'}
