...
nop
xor %r10, %r10
lea addresses_WC_ht+0x2587, %rsi
lea addresses_UC_ht+0x1569f, %rdi
clflush (%rsi)
nop
nop
nop
...
// REPMOV
lea addresses_D+0x1459f, %rsi
lea addresses_WC+0x3c9f, %rdi
nop
nop
sub %r11, %r11
mov $126, %rcx
...
// Store
lea addresses_normal+0xb79f, %rbp
nop
nop
nop
nop
...
{'src': {'type': 'addresses_D', 'congruent': 0, 'same': True}, 'dst': {'type': 'addresses_WC', 'congruent': 4, 'same': False}, 'OP': 'REPM'}
