...
push %rdx
push %rsi
lea addresses_WC_ht+0xd07a, %r11
inc %rdx
...
nop
cmp $48156, %rbx
lea addresses_WT_ht+0xaf30, %rsi
lea addresses_WC_ht+0x82e0, %rdi
nop
add $58408, %rdx
mov $86, %rcx
rep movsb
...
nop
cmp $29729, %rbx
lea addresses_WT_ht+0x5db0, %r11
clflush (%r11)
nop
nop
nop
...
nop
cmp %rsi, %rsi
lea addresses_UC_ht+0x13780, %rsi
lea addresses_WC_ht+0x122b0, %rdi
nop
mfence
mov $83, %rcx
rep movsq
