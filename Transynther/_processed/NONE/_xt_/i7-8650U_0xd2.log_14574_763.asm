...
nop
and $46488, %r13
lea addresses_UC_ht+0x1244c, %rdi
cmp %r14, %r14
mov (%rdi), %r13d
nop
and %r14, %r14
lea addresses_D_ht+0x1481, %r15
nop
add $33677, %r13
mov (%r15), %edi
nop
nop
add $47574, %r13
lea addresses_WC_ht+0x15b01, %r13
nop
nop
nop
nop
...
nop
xor $30174, %r13
lea addresses_WT_ht+0x13bc1, %r14
nop
nop
nop
nop
...
nop
inc %rdi
lea addresses_A_ht+0xe9b1, %rsi
lea addresses_WT_ht+0x46a1, %rdi
clflush (%rdi)
nop
nop
nop
...
nop
and %r15, %r15
lea addresses_WT_ht+0x2e81, %rdi
nop
nop
nop
nop
...
nop
xor %rcx, %rcx
lea addresses_WC_ht+0x2381, %rax
nop
and $47851, %r13
mov (%rax), %r15d
nop
...
nop
add %r13, %r13
lea addresses_D_ht+0x9661, %rsi
lea addresses_WT_ht+0x7281, %rdi
nop
xor $45593, %rax
mov $3, %rcx
rep movsb
dec %rbx
lea addresses_WC_ht+0x1dd81, %r13
nop
nop
nop
cmp $26512, %rcx
...
nop
xor $7913, %rsi
lea addresses_UC_ht+0x193c1, %r13
nop
nop
nop
nop
...
{'OP': 'STOR', 'dst': {'type': 'addresses_P', 'size': 2, 'AVXalign': True, 'NT': False, 'congruent': 2, 'same': False}}
...
{'OP': 'LOAD', 'src': {'type': 'addresses_D_ht', 'size': 4, 'AVXalign': True, 'NT': False, 'congruent': 9, 'same': False}}
...
{'OP': 'STOR', 'dst': {'type': 'addresses_WT_ht', 'size': 2, 'AVXalign': False, 'NT': False, 'congruent': 11, 'same': True}}
{'OP': 'LOAD', 'src': {'type': 'addresses_WC_ht', 'size': 4, 'AVXalign': False, 'NT': True, 'congruent': 8, 'same': False}}
