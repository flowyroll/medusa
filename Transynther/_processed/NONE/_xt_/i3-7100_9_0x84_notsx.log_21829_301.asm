...
push %rdx
push %rsi
lea addresses_WC_ht+0x7886, %rdx
nop
nop
add $32928, %r15
movl $0x61626364, (%rdx)
...
nop
dec %r15
lea addresses_UC_ht+0x1a176, %r8
nop
nop
add $26669, %r13
mov (%r8), %r12d
...
lea addresses_normal_ht+0x14a86, %rdi
nop
nop
nop
nop
