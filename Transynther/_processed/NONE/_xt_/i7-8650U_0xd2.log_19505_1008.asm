...
vmovntdq %ymm0, (%r13)
sub %r10, %r10
lea addresses_UC_ht+0x9123, %rsi
lea addresses_D_ht+0x5f23, %rdi
nop
nop
nop
nop
...
rep movsw
xor %rsi, %rsi
lea addresses_D_ht+0x1746, %rsi
lea addresses_UC_ht+0x113a3, %rdi
nop
nop
nop
nop
...
nop
dec %rbx
lea addresses_A_ht+0x123, %rsi
lea addresses_A_ht+0x151e3, %rdi
clflush (%rsi)
nop
nop
nop
...
nop
add %r14, %r14
lea addresses_normal_ht+0x1b723, %r10
xor $24397, %r8
movups (%r10), %xmm7
vpextrq $0, %xmm7, %r12
nop
...
nop
cmp $61756, %rbx
lea addresses_D_ht+0xac6b, %r14
nop
xor $55551, %rsi
movb $0x61, (%r14)
inc %rdi
lea addresses_WC_ht+0x12053, %rsi
nop
nop
nop
nop
...
nop
dec %rdi
lea addresses_A_ht+0x1a223, %r12
nop
nop
nop
nop
...
{'OP': 'LOAD', 'src': {'type': 'addresses_WT', 'size': 32, 'AVXalign': False, 'NT': False, 'congruent': 6, 'same': False}}
[Faulty Load]
...
{'OP': 'STOR', 'dst': {'type': 'addresses_normal_ht', 'size': 32, 'AVXalign': False, 'NT': True, 'congruent': 10, 'same': True}}
...
{'OP': 'STOR', 'dst': {'type': 'addresses_WC_ht', 'size': 8, 'AVXalign': True, 'NT': False, 'congruent': 0, 'same': False}}
