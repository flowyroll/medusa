...
push %rdx
push %rsi
lea addresses_WT_ht+0x1dd78, %r13
nop
nop
nop
nop
...
nop
inc %rcx
lea addresses_WT_ht+0x1b89a, %r11
nop
nop
dec %rdx
vmovups (%r11), %ymm3
...
nop
xor %r13, %r13
lea addresses_UC_ht+0x16cf2, %rsi
lea addresses_UC_ht+0x1c39b, %rdi
clflush (%rsi)
clflush (%rdi)
nop
nop
...
nop
sub $35992, %r13
lea addresses_D_ht+0x3afa, %r11
nop
sub %rcx, %rcx
movw $0x6162, (%r11)
nop
xor $3508, %rdx
lea addresses_UC_ht+0xc27a, %r11
nop
nop
add $15772, %r14
mov (%r11), %cx
...
nop
add $25479, %r12
lea addresses_WT_ht+0x1cb34, %r12
clflush (%r12)
xor $26390, %rdi
mov (%r12), %r11
nop
xor $43334, %r13
lea addresses_D_ht+0xed7a, %rcx
nop
nop
sub $26302, %rdi
mov (%rcx), %r8d
