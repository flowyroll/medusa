...
lea addresses_UC_ht+0x76c6, %rdi
nop
nop
xor %rax, %rax
mov $54, %rcx
...
nop
sub %rcx, %rcx
lea addresses_WC_ht+0x1a846, %rsi
lea addresses_WC_ht+0x9656, %rdi
dec %rbx
mov $124, %rcx
rep movsw
sub %rdi, %rdi
lea addresses_WT_ht+0x1a746, %rcx
nop
nop
nop
nop
...
nop
xor $62768, %rsi
lea addresses_D_ht+0x19746, %rsi
lea addresses_WT_ht+0x1ddac, %rdi
nop
nop
nop
xor %r13, %r13
...
nop
add %r10, %r10
lea addresses_WT_ht+0x3ee0, %rbx
nop
add %r13, %r13
movb $0x61, (%rbx)
nop
sub $4149, %r13
lea addresses_normal_ht+0x13f46, %rsi
nop
nop
nop
nop
...
nop
inc %r10
lea addresses_WC_ht+0x158e6, %r13
sub $12263, %r10
movb $0x61, (%r13)
nop
nop
dec %r13
lea addresses_A_ht+0xae36, %rsi
nop
nop
and $23165, %r10
...
nop
and $4571, %rcx
lea addresses_A_ht+0x1a086, %rsi
...
nop
and $6632, %rbx
lea addresses_UC_ht+0xd6c6, %rdi
nop
nop
cmp %r13, %r13
mov (%rdi), %r10
...
nop
inc %rdi
lea addresses_UC_ht+0xaa4a, %rbx
nop
add $11906, %rcx
movups (%rbx), %xmm4
vpextrq $0, %xmm4, %rax
...
// Faulty Load
lea addresses_normal+0x17f46, %rax
nop
nop
nop
nop
...
<gen_prepare_buffer>
{'src': {'same': False, 'congruent': 7, 'type': 'addresses_A_ht'}, 'OP': 'REPM', 'dst': {'same': False, 'congruent': 8, 'type': 'addresses_A_ht'}}
{'src': {'same': False, 'congruent': 5, 'type': 'addresses_WC_ht'}, 'OP': 'REPM', 'dst': {'same': False, 'congruent': 7, 'type': 'addresses_UC_ht'}}
{'src': {'same': False, 'congruent': 6, 'type': 'addresses_WC_ht'}, 'OP': 'REPM', 'dst': {'same': False, 'congruent': 2, 'type': 'addresses_WC_ht'}}
...
{'src': {'NT': True, 'same': False, 'congruent': 5, 'type': 'addresses_UC_ht', 'AVXalign': False, 'size': 8}, 'OP': 'LOAD'}
