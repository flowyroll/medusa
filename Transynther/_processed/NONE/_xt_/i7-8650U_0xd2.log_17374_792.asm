...
nop
sub %rcx, %rcx
lea addresses_D_ht+0x10e31, %rsi
lea addresses_D_ht+0x1a3c1, %rdi
nop
nop
inc %rax
mov $95, %rcx
...
nop
dec %r12
lea addresses_WT_ht+0x6401, %rdx
nop
nop
and %r13, %r13
...
nop
inc %r9
lea addresses_A_ht+0x55c1, %rsi
lea addresses_D_ht+0x14e1, %rdi
nop
nop
nop
nop
...
nop
inc %rax
lea addresses_WC_ht+0x188f1, %rcx
clflush (%rcx)
xor %rdi, %rdi
...
nop
inc %r13
lea addresses_UC_ht+0x11d31, %rax
nop
nop
nop
xor $2113, %rsi
...
nop
xor $1144, %rdi
lea addresses_D_ht+0x6421, %rsi
lea addresses_A_ht+0x8ae2, %rdi
nop
nop
nop
nop
...
// Faulty Load
lea addresses_normal+0x137c1, %rbx
nop
nop
nop
nop
...
{'OP': 'STOR', 'dst': {'type': 'addresses_WC', 'size': 32, 'AVXalign': True, 'NT': False, 'congruent': 9, 'same': False}}
[Faulty Load]
...
{'OP': 'REPM', 'src': {'type': 'addresses_A_ht', 'congruent': 9, 'same': False}, 'dst': {'type': 'addresses_D_ht', 'congruent': 5, 'same': False}}
...
{'OP': 'REPM', 'src': {'type': 'addresses_D_ht', 'congruent': 5, 'same': False}, 'dst': {'type': 'addresses_A_ht', 'congruent': 0, 'same': False}}
{'34': 17374}
