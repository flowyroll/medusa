...
push %rdx
push %rsi
lea addresses_normal_ht+0x1cb9, %rbx
nop
nop
nop
nop
...
nop
sub %rdx, %rdx
lea addresses_WC_ht+0x1af39, %rsi
lea addresses_WT_ht+0x1ebb9, %rdi
nop
nop
sub %rbp, %rbp
mov $15, %rcx
...
nop
dec %rbp
lea addresses_WC_ht+0xf8b9, %rbx
clflush (%rbx)
nop
nop
nop
...
nop
and $24867, %r13
lea addresses_UC_ht+0x164b9, %rbp
nop
and %rcx, %rcx
...
nop
cmp $1051, %rbx
lea addresses_normal_ht+0x1c8b3, %rsi
lea addresses_UC_ht+0x13449, %rdi
nop
cmp $42121, %r11
mov $102, %rcx
rep movsw
...
nop
sub %r11, %r11
lea addresses_A_ht+0x19d19, %rdx
nop
nop
xor %r11, %r11
...
rep movsb
add $37000, %r11
lea addresses_A_ht+0x100b9, %rsi
lea addresses_normal_ht+0x106b9, %rdi
clflush (%rsi)
nop
nop
add %rbp, %rbp
...
rep movsw
xor $50647, %r11
lea addresses_normal_ht+0x14d01, %rcx
cmp $53012, %rbx
movb $0x61, (%rcx)
nop
nop
nop
cmp $3640, %rcx
lea addresses_WT_ht+0x58b9, %rbp
nop
nop
nop
and %rcx, %rcx
...
{'OP': 'STOR', 'dst': {'type': 'addresses_WC_ht', 'AVXalign': False, 'congruent': 11, 'size': 4, 'same': True, 'NT': False}}
{'OP': 'STOR', 'dst': {'type': 'addresses_UC_ht', 'AVXalign': False, 'congruent': 10, 'size': 32, 'same': True, 'NT': False}}
