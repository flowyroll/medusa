...
nop
sub $2454, %r11
lea addresses_D_ht+0x1844e, %rsi
lea addresses_D_ht+0x4c19, %rdi
clflush (%rsi)
and $7484, %r11
mov $67, %rcx
rep movsw
...
nop
xor $1168, %r8
lea addresses_UC_ht+0x12699, %rax
clflush (%rax)
nop
nop
and $42626, %rsi
...
// Store
lea addresses_normal+0xad49, %r15
nop
nop
nop
and %rbp, %rbp
...
// Faulty Load
lea addresses_normal+0x9419, %r11
clflush (%r11)
nop
nop
nop
