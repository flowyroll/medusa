...
nop
and $20627, %rbp
lea addresses_normal_ht+0x3d43, %rbx
clflush (%rbx)
nop
nop
nop
...
nop
sub $10302, %r9
lea addresses_D_ht+0x1463b, %rsi
lea addresses_A_ht+0x163bb, %rdi
nop
and $34503, %rdx
mov $32, %rcx
rep movsq
...
nop
add $46631, %rdx
lea addresses_WT_ht+0x19ad5, %r9
nop
xor %rsi, %rsi
movw $0x6162, (%r9)
xor $39316, %rbp
lea addresses_normal_ht+0x133fb, %rsi
lea addresses_A_ht+0x3b1b, %rdi
nop
nop
nop
nop
...
nop
inc %rdx
lea addresses_WT_ht+0x1193b, %rsi
lea addresses_WC_ht+0x124cc, %rdi
mfence
mov $17, %rcx
rep movsl
nop
...
// Store
lea addresses_normal+0x14dbb, %rbx
nop
nop
cmp %rbp, %rbp
movb $0x51, (%rbx)
...
{'OP': 'STOR', 'dst': {'type': 'addresses_D', 'AVXalign': False, 'size': 1, 'NT': True, 'same': False, 'congruent': 0}}
...
{'OP': 'STOR', 'dst': {'type': 'addresses_A_ht', 'AVXalign': True, 'size': 32, 'NT': False, 'same': True, 'congruent': 1}}
...
{'src': {'type': 'addresses_normal_ht', 'congruent': 4, 'same': False}, 'OP': 'REPM', 'dst': {'type': 'addresses_A_ht', 'congruent': 5, 'same': False}}
