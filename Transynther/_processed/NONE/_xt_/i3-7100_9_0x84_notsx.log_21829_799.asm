...
push %rdi
push %rsi
lea addresses_WT_ht+0x908, %rsi
lea addresses_WT_ht+0x14c34, %rdi
nop
nop
nop
nop
...
mov (%rsi), %ebx
and %r11, %r11
lea addresses_WT_ht+0x12908, %rdi
nop
nop
nop
nop
...
nop
and $46731, %rsi
lea addresses_A_ht+0x1ca00, %r12
nop
nop
xor $3699, %rdi
movb (%r12), %bl
...
nop
and %rax, %rax
lea addresses_WT_ht+0x7508, %rax
nop
xor $24947, %rcx
movb $0x61, (%rax)
nop
...
nop
xor %rdi, %rdi
lea addresses_D_ht+0xd608, %rax
nop
xor %rbx, %rbx
movw $0x6162, (%rax)
nop
cmp $43803, %rdi
lea addresses_D_ht+0x2128, %rdi
clflush (%rdi)
add %r11, %r11
vmovups (%rdi), %ymm0
...
vpextrq $0, %xmm0, %r12
and $30142, %r11
lea addresses_D_ht+0x16108, %r11
nop
inc %r12
mov (%r11), %rsi
nop
...
nop
xor $27867, %r12
lea addresses_normal_ht+0x1e908, %rbx
nop
nop
nop
nop
...
nop
cmp %rax, %rax
lea addresses_D_ht+0x18f08, %rbx
nop
nop
nop
nop
...
// Load
lea addresses_normal+0x1a5c4, %r9
nop
nop
nop
nop
...
<gen_prepare_buffer>
{'src': {'type': 'addresses_WT_ht', 'congruent': 9, 'same': False}, 'dst': {'type': 'addresses_WT_ht', 'congruent': 2, 'same': True}, 'OP': 'REPM'}
...
{'dst': {'type': 'addresses_WT_ht', 'same': False, 'size': 1, 'congruent': 8, 'NT': True, 'AVXalign': False}, 'OP': 'STOR'}
