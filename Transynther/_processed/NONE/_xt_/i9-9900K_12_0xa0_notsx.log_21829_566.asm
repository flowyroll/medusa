...
push %rdx
push %rsi
lea addresses_A_ht+0x13e3b, %rsi
lea addresses_WC_ht+0x15ddb, %rdi
nop
nop
nop
nop
...
nop
dec %r13
lea addresses_WC_ht+0x11cbb, %r12
nop
nop
sub $23102, %rdx
...
nop
dec %r13
lea addresses_WC_ht+0x194bb, %rcx
nop
nop
and %r12, %r12
mov $0x6162636465666768, %r11
...
nop
sub $1839, %rdi
lea addresses_UC_ht+0x7109, %rsi
lea addresses_normal_ht+0x1e75f, %rdi
cmp %r8, %r8
mov $70, %rcx
rep movsl
nop
...
nop
and %r11, %r11
lea addresses_UC_ht+0x11603, %rsi
lea addresses_UC_ht+0x9a3, %rdi
sub $61203, %r13
mov $71, %rcx
rep movsw
nop
nop
cmp %rsi, %rsi
lea addresses_D_ht+0x1c14b, %r12
nop
nop
nop
sub $23666, %r13
...
nop
add %r8, %r8
lea addresses_WC_ht+0xd5bb, %rdx
nop
nop
nop
nop
...
nop
sub %r12, %r12
lea addresses_WT_ht+0x20eb, %rsi
lea addresses_UC_ht+0x18cbb, %rdi
nop
nop
nop
cmp $12475, %r12
...
{'src': {'type': 'addresses_RW', 'AVXalign': False, 'size': 2, 'NT': False, 'same': False, 'congruent': 11}, 'OP': 'LOAD'}
...
{'src': {'type': 'addresses_UC_ht', 'congruent': 3, 'same': False}, 'OP': 'REPM', 'dst': {'type': 'addresses_UC_ht', 'congruent': 3, 'same': False}}
{'src': {'type': 'addresses_D_ht', 'AVXalign': False, 'size': 2, 'NT': False, 'same': False, 'congruent': 4}, 'OP': 'LOAD'}
{'OP': 'STOR', 'dst': {'type': 'addresses_normal_ht', 'AVXalign': False, 'size': 4, 'NT': True, 'same': False, 'congruent': 10}}
