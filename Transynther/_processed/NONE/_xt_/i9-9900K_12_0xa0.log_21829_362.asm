...
push %rdx
push %rsi
lea addresses_A_ht+0x1dffb, %rsi
lea addresses_D_ht+0x1aa2f, %rdi
nop
nop
inc %r13
mov $100, %rcx
...
nop
cmp %r9, %r9
lea addresses_D_ht+0x1ef37, %r10
nop
add %rdx, %rdx
movb (%r10), %cl
nop
...
nop
and $50041, %r10
lea addresses_A_ht+0x1bc7b, %rsi
lea addresses_normal_ht+0xc1fb, %rdi
and $11656, %r15
mov $7, %rcx
rep movsb
nop
...
nop
and $56198, %r9
lea addresses_WC_ht+0x1c3fb, %rdi
clflush (%rdi)
nop
nop
nop
...
nop
and %rcx, %rcx
lea addresses_WT_ht+0x50fb, %rsi
lea addresses_normal_ht+0x1e1fb, %rdi
clflush (%rsi)
nop
nop
cmp %rdx, %rdx
...
{'OP': 'STOR', 'dst': {'NT': False, 'same': True, 'congruent': 5, 'type': 'addresses_D', 'AVXalign': False, 'size': 8}}
