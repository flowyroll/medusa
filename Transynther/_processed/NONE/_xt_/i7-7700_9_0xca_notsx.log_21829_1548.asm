...
push %rdi
push %rsi
lea addresses_A_ht+0x1de39, %rsi
lea addresses_WC_ht+0x147f9, %rdi
nop
nop
nop
nop
...
vpextrq $1, %xmm0, %rsi
inc %rsi
lea addresses_WT_ht+0x197ad, %rcx
nop
nop
cmp $7207, %rbx
...
nop
sub $64725, %rbx
lea addresses_normal_ht+0xb3cb, %rdi
cmp %rbx, %rbx
mov (%rdi), %r14w
sub $6782, %rsi
lea addresses_WT_ht+0x18739, %r12
nop
nop
nop
add $60915, %rcx
...
<gen_prepare_buffer>
{'src': {'congruent': 7, 'same': False, 'type': 'addresses_A_ht'}, 'dst': {'congruent': 1, 'same': True, 'type': 'addresses_WC_ht'}, 'OP': 'REPM'}
{'src': {'NT': True, 'AVXalign': False, 'size': 32, 'congruent': 3, 'same': False, 'type': 'addresses_D_ht'}, 'OP': 'LOAD'}
