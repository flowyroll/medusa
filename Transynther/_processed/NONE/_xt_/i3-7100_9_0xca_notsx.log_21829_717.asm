...
nop
and %r8, %r8
lea addresses_A_ht+0x1dd4d, %rsi
lea addresses_WC_ht+0x1490d, %rdi
inc %r14
mov $124, %rcx
rep movsq
xor $32305, %r14
...
// REPMOV
lea addresses_D+0xe9dd, %rsi
lea addresses_WC+0x11d9d, %rdi
nop
sub %r14, %r14
mov $67, %rcx
rep movsq
...
{'src': {'type': 'addresses_D', 'congruent': 3, 'same': False}, 'OP': 'REPM', 'dst': {'type': 'addresses_WC', 'congruent': 2, 'same': False}}
[Faulty Load]
