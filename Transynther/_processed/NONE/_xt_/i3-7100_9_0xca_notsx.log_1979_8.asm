...
push %rdi
push %rsi
lea addresses_UC_ht+0xb1c0, %rsi
lea addresses_normal_ht+0x1d340, %rdi
clflush (%rdi)
nop
nop
nop
...
nop
xor $52712, %r13
lea addresses_D_ht+0x192ae, %rdi
nop
nop
nop
dec %r14
...
nop
add $53171, %r14
lea addresses_D_ht+0x1a1f0, %rdi
nop
nop
nop
sub $49619, %r15
...
nop
and $55940, %r14
lea addresses_UC_ht+0xb480, %r13
nop
nop
nop
nop
...
lea addresses_A_ht+0x184c0, %rdi
lfence
mov $75, %rcx
rep movsl
nop
...
<gen_prepare_buffer>
{'src': {'type': 'addresses_UC_ht', 'congruent': 6, 'same': True}, 'OP': 'REPM', 'dst': {'type': 'addresses_normal_ht', 'congruent': 2, 'same': False}}
...
{'src': {'type': 'addresses_A_ht', 'congruent': 2, 'same': False}, 'OP': 'REPM', 'dst': {'type': 'addresses_A_ht', 'congruent': 11, 'same': False}}
{'32': 1979}
