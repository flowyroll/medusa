...
nop
inc %rbx
lea addresses_WC_ht+0xfe1b, %rsi
lea addresses_normal_ht+0x5b5f, %rdi
nop
nop
nop
nop
...
rep movsw
cmp %r11, %r11
lea addresses_WT_ht+0x195df, %rbx
clflush (%rbx)
nop
add $56562, %r11
mov (%rbx), %cx
...
nop
xor %r10, %r10
lea addresses_UC_ht+0x1a95f, %rsi
lea addresses_UC_ht+0x5983, %rdi
nop
nop
nop
nop
...
nop
inc %r11
lea addresses_A_ht+0x1d75f, %rbp
nop
add %r8, %r8
movw $0x6162, (%rbp)
add $56438, %r8
lea addresses_A_ht+0x1951f, %rsi
nop
nop
add $50320, %rbx
movb $0x61, (%rsi)
...
nop
inc %r14
lea addresses_A_ht+0x1cd5f, %rcx
nop
nop
xor %r11, %r11
mov (%rcx), %rbp
...
nop
cmp %rsi, %rsi
lea addresses_UC_ht+0x1cddf, %rbp
nop
nop
nop
nop
...
nop
add %rcx, %rcx
lea addresses_UC_ht+0x1b8df, %r10
sub $63866, %rdi
vmovups (%r10), %ymm7
...
nop
inc %r10
lea addresses_A_ht+0x1bddf, %rsi
lea addresses_normal_ht+0x575f, %rdi
nop
nop
nop
nop
...
// Faulty Load
lea addresses_normal+0x95df, %rbp
clflush (%rbp)
and $26409, %r11
mov (%rbp), %r13
lea oracles, %rcx
...
{'OP': 'LOAD', 'src': {'type': 'addresses_D', 'AVXalign': False, 'congruent': 6, 'size': 16, 'same': False, 'NT': False}}
[Faulty Load]
...
{'OP': 'REPM', 'src': {'type': 'addresses_UC_ht', 'congruent': 6, 'same': False}, 'dst': {'type': 'addresses_UC_ht', 'congruent': 1, 'same': True}}
...
{'OP': 'REPM', 'src': {'type': 'addresses_A_ht', 'congruent': 11, 'same': True}, 'dst': {'type': 'addresses_normal_ht', 'congruent': 7, 'same': False}}
{'34': 21829}
