...
push %rdi
push %rsi
lea addresses_D_ht+0x204a, %rsi
lea addresses_normal_ht+0xf7da, %rdi
clflush (%rdi)
xor $10461, %r11
mov $27, %rcx
rep movsb
...
nop
and $1786, %rdi
lea addresses_D_ht+0x1df46, %rcx
nop
nop
nop
and %rbx, %rbx
...
nop
sub $57724, %rsi
lea addresses_normal_ht+0x1e76a, %r13
nop
nop
nop
nop
...
{'OP': 'STOR', 'dst': {'same': True, 'congruent': 2, 'NT': False, 'type': 'addresses_D_ht', 'size': 16, 'AVXalign': True}}
