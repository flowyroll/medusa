...
push %rdi
push %rsi
lea addresses_normal_ht+0xaf74, %r15
add %rbp, %rbp
...
nop
xor %rdi, %rdi
lea addresses_normal_ht+0x1bd5b, %r15
xor $21979, %r8
...
nop
xor %r15, %r15
lea addresses_UC_ht+0x1bf74, %rsi
lea addresses_normal_ht+0x95dc, %rdi
nop
nop
nop
nop
...
nop
xor $12706, %rax
lea addresses_UC_ht+0x17574, %rsi
lea addresses_A_ht+0x1cab0, %rdi
nop
nop
and $23626, %r15
mov $117, %rcx
...
nop
cmp $52523, %rbp
lea addresses_UC_ht+0x107f6, %rsi
lea addresses_A_ht+0x5774, %rdi
nop
inc %rax
mov $103, %rcx
rep movsq
...
nop
add $35199, %rax
lea addresses_WC_ht+0x13f42, %rbp
nop
nop
xor %r15, %r15
mov (%rbp), %r8d
...
nop
sub $36348, %rcx
lea addresses_UC_ht+0x12974, %rsi
lea addresses_WC_ht+0x12976, %rdi
nop
and %r15, %r15
mov $9, %rcx
rep movsq
nop
cmp %rax, %rax
lea addresses_UC_ht+0x1ee89, %rbp
nop
nop
nop
sub %rcx, %rcx
...
nop
add %rdi, %rdi
lea addresses_WT_ht+0x144ac, %rbp
nop
nop
nop
and $29527, %rax
...
// REPMOV
lea addresses_RW+0x1ed74, %rsi
lea addresses_D+0x1f849, %rdi
nop
nop
nop
nop
...
{'OP': 'REPM', 'src': {'same': False, 'congruent': 11, 'type': 'addresses_RW'}, 'dst': {'same': False, 'congruent': 0, 'type': 'addresses_D'}}
[Faulty Load]
...
{'OP': 'REPM', 'src': {'same': False, 'congruent': 6, 'type': 'addresses_UC_ht'}, 'dst': {'same': False, 'congruent': 1, 'type': 'addresses_A_ht'}}
{'OP': 'REPM', 'src': {'same': True, 'congruent': 1, 'type': 'addresses_UC_ht'}, 'dst': {'same': False, 'congruent': 9, 'type': 'addresses_A_ht'}}
