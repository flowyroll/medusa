...
push %rdi
push %rsi
lea addresses_UC_ht+0x6e2c, %rsi
lea addresses_D_ht+0x16b12, %rdi
nop
nop
nop
add %r14, %r14
...
nop
sub %rcx, %rcx
lea addresses_A_ht+0x1214c, %rbx
nop
nop
nop
nop
...
mov (%rbx), %r12d
dec %r12
lea addresses_WT_ht+0x1de2c, %rbx
xor %rsi, %rsi
mov (%rbx), %r12d
nop
nop
sub %rbx, %rbx
lea addresses_WC_ht+0xa54a, %rsi
lea addresses_WT_ht+0x17a2c, %rdi
nop
nop
nop
dec %r15
...
{'dst': {'type': 'addresses_WT', 'same': False, 'size': 1, 'congruent': 7, 'NT': True, 'AVXalign': False}, 'OP': 'STOR'}
...
{'dst': {'type': 'addresses_D', 'same': False, 'size': 32, 'congruent': 5, 'NT': True, 'AVXalign': False}, 'OP': 'STOR'}
...
{'src': {'type': 'addresses_WC_ht', 'congruent': 1, 'same': False}, 'dst': {'type': 'addresses_WT_ht', 'congruent': 7, 'same': False}, 'OP': 'REPM'}
{'33': 21829}
