...
push %rcx
push %rdx
lea addresses_normal_ht+0x54e0, %rdx
and %rbx, %rbx
mov (%rdx), %rcx
nop
nop
...
{'OP': 'STOR', 'dst': {'type': 'addresses_NC', 'AVXalign': False, 'size': 4, 'NT': False, 'same': False, 'congruent': 1}}
{'OP': 'STOR', 'dst': {'type': 'addresses_WT', 'AVXalign': True, 'size': 16, 'NT': False, 'same': False, 'congruent': 6}}
