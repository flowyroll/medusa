...
push %rdx
push %rsi
lea addresses_A_ht+0x1bfc3, %rdx
dec %r12
movb (%rdx), %cl
nop
nop
...
nop
sub %rdx, %rdx
lea addresses_WT_ht+0x143c3, %rsi
lea addresses_D_ht+0x1d40d, %rdi
clflush (%rdi)
nop
nop
nop
...
nop
add $51410, %rsi
lea addresses_A_ht+0x1ccc3, %rsi
lea addresses_UC_ht+0x10103, %rdi
sub $51076, %r11
mov $22, %rcx
rep movsb
nop
...
nop
xor %r15, %r15
lea addresses_D_ht+0x120c3, %r11
nop
nop
nop
inc %rcx
...
nop
sub $38189, %r12
lea addresses_WC_ht+0xb983, %rsi
nop
add $32035, %rdx
mov (%rsi), %r15d
nop
...
nop
sub $14585, %rdx
lea addresses_A_ht+0x97d3, %rsi
lea addresses_WT_ht+0xa81f, %rdi
nop
nop
nop
dec %rax
...
rep movsl
dec %r15
lea addresses_normal_ht+0x1ec33, %r12
nop
nop
nop
and $39698, %r15
...
{'src': {'type': 'addresses_WT_ht', 'congruent': 8, 'same': False}, 'OP': 'REPM', 'dst': {'type': 'addresses_D_ht', 'congruent': 1, 'same': False}}
{'src': {'type': 'addresses_A_ht', 'congruent': 10, 'same': False}, 'OP': 'REPM', 'dst': {'type': 'addresses_UC_ht', 'congruent': 5, 'same': False}}
...
{'src': {'type': 'addresses_A_ht', 'congruent': 1, 'same': False}, 'OP': 'REPM', 'dst': {'type': 'addresses_WT_ht', 'congruent': 1, 'same': False}}
