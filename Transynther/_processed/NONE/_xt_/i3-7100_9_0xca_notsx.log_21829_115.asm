...
push %rdi
push %rsi
lea addresses_UC_ht+0x10970, %rdi
nop
nop
nop
and %r8, %r8
...
lea addresses_normal_ht+0x1cba8, %rdi
dec %r14
mov $34, %rcx
rep movsq
nop
nop
dec %rsi
lea addresses_A_ht+0x1da68, %rcx
nop
nop
nop
nop
...
movl $0x61626364, (%rcx)
sub $58756, %rcx
lea addresses_normal_ht+0x7d50, %rsi
inc %rax
vmovups (%rsi), %ymm1
...
nop
cmp %r11, %r11
lea addresses_D_ht+0x1af90, %r14
nop
nop
nop
nop
...
movb (%r14), %r15b
xor %rax, %rax
lea addresses_WC_ht+0x1b76e, %r11
nop
cmp $29520, %rsi
movl $0x61626364, (%r11)
and %r8, %r8
lea addresses_UC_ht+0x759c, %rax
nop
nop
cmp %rdi, %rdi
movl $0x61626364, (%rax)
...
nop
sub %r14, %r14
lea addresses_WT_ht+0x3dbc, %rsi
lea addresses_UC_ht+0xad38, %rdi
clflush (%rsi)
nop
nop
add %r11, %r11
...
rep movsb
xor $35520, %rax
lea addresses_D_ht+0x18d9c, %rsi
lea addresses_normal_ht+0x1a81a, %rdi
nop
nop
nop
nop
...
nop
add %r15, %r15
lea addresses_normal_ht+0xda7c, %r11
nop
inc %rax
movw $0x6162, (%r11)
xor $57429, %r8
lea addresses_A_ht+0x22cc, %r8
cmp $23547, %r15
...
{'src': {'same': True, 'congruent': 11, 'NT': False, 'type': 'addresses_D_ht', 'size': 16, 'AVXalign': False}, 'OP': 'LOAD'}
