...
nop
and %r12, %r12
lea addresses_UC_ht+0x13b57, %r13
nop
nop
nop
sub %r9, %r9
...
nop
cmp %r13, %r13
lea addresses_WT_ht+0x10db7, %rsi
lea addresses_A_ht+0x11897, %rdi
clflush (%rdi)
nop
nop
nop
...
nop
xor $3429, %r12
lea addresses_normal_ht+0x7583, %rsi
lea addresses_D_ht+0x1ac37, %rdi
nop
xor %r10, %r10
mov $13, %rcx
rep movsq
...
nop
inc %rdi
lea addresses_WT_ht+0x1df, %rbp
nop
xor %rdi, %rdi
mov (%rbp), %r9w
nop
cmp %r12, %r12
lea addresses_WT_ht+0xc897, %r10
nop
nop
nop
sub %rsi, %rsi
...
// REPMOV
lea addresses_A+0xe80f, %rsi
lea addresses_WC+0x13ebf, %rdi
sub %rdx, %rdx
mov $73, %rcx
rep movsw
nop
