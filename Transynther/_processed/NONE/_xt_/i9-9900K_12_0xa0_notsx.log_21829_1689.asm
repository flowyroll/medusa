...
push %rdi
push %rsi
lea addresses_WT_ht+0x661f, %rsi
lea addresses_UC_ht+0xd2a0, %rdi
nop
nop
add %r10, %r10
mov $45, %rcx
...
nop
add $31166, %rbx
lea addresses_UC_ht+0x14d07, %r14
nop
cmp $62687, %r10
mov (%r14), %ecx
nop
...
nop
sub %rsi, %rsi
lea addresses_UC_ht+0x1b0f, %rbx
nop
nop
nop
cmp %r11, %r11
...
nop
sub %rsi, %rsi
lea addresses_A_ht+0x1c40f, %r10
nop
nop
nop
nop
...
nop
and %rdi, %rdi
lea addresses_normal_ht+0x840f, %rcx
nop
nop
sub %rdi, %rdi
...
vmovups %ymm5, (%rcx)
add $23794, %rcx
lea addresses_normal_ht+0x152ef, %rsi
lea addresses_D_ht+0x1d00f, %rdi
nop
nop
nop
dec %r10
...
{'src': {'type': 'addresses_normal_ht', 'congruent': 4, 'same': False}, 'OP': 'REPM', 'dst': {'type': 'addresses_D_ht', 'congruent': 10, 'same': False}}
{'37': 21829}
