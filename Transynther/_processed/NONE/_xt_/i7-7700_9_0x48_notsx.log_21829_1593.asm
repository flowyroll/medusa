...
push %rdx
push %rsi
lea addresses_WT_ht+0x18f3e, %r12
nop
nop
nop
dec %rcx
...
nop
add $62930, %r15
lea addresses_WT_ht+0x71b6, %rbp
nop
xor %rbx, %rbx
movb $0x61, (%rbp)
nop
nop
mfence
lea addresses_normal_ht+0x153e, %r8
cmp %rdx, %rdx
movl $0x61626364, (%r8)
and %rbp, %rbp
lea addresses_WC_ht+0x108be, %rcx
clflush (%rcx)
nop
nop
xor $27261, %rbp
...
nop
xor %r8, %r8
lea addresses_D_ht+0x1d45e, %rsi
...
rep movsq
inc %rdx
lea addresses_normal_ht+0x9cde, %rsi
lea addresses_normal_ht+0x1ce3e, %rdi
nop
sub %r15, %r15
mov $11, %rcx
rep movsq
...
nop
sub $13342, %r12
lea addresses_WT_ht+0xdb3e, %rsi
nop
xor %r15, %r15
mov (%rsi), %edi
nop
...
nop
dec %r8
lea addresses_D_ht+0x178b6, %rsi
nop
nop
dec %r15
mov (%rsi), %r12d
