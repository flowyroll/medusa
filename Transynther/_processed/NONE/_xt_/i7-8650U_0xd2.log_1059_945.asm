...
push %rdi
push %rsi
lea addresses_UC_ht+0x175be, %r13
nop
nop
xor %r12, %r12
movups (%r13), %xmm0
...
nop
cmp %rsi, %rsi
lea addresses_WC_ht+0xb636, %rax
nop
add $63090, %rbp
vmovups (%rax), %ymm6
...
nop
xor %rsi, %rsi
lea addresses_WT_ht+0x23e6, %rsi
lea addresses_WT_ht+0x17016, %rdi
add $30343, %rbx
mov $2, %rcx
rep movsb
nop
nop
inc %r13
lea addresses_normal_ht+0x7ad6, %rsi
lea addresses_A_ht+0xa116, %rdi
and $39454, %r13
mov $63, %rcx
rep movsb
nop
inc %rsi
lea addresses_UC_ht+0x18b1e, %rax
nop
nop
nop
nop
...
movq %rbx, (%rax)
dec %rbp
lea addresses_normal_ht+0x1466e, %rbx
nop
nop
nop
cmp %r12, %r12
...
nop
add $34668, %rcx
lea addresses_WC_ht+0x1eb16, %rsi
lea addresses_D_ht+0x2236, %rdi
nop
nop
inc %r12
mov $73, %rcx
...
lea addresses_WC_ht+0xe996, %rdi
nop
nop
nop
add $44055, %rbx
...
nop
dec %rax
lea addresses_normal_ht+0x202e, %rsi
...
{'OP': 'REPM', 'src': {'type': 'addresses_WT_ht', 'congruent': 3, 'same': True}, 'dst': {'type': 'addresses_WT_ht', 'congruent': 5, 'same': True}}
