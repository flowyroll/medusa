...
push %rdx
push %rsi
lea addresses_A_ht+0x15634, %rdi
xor %rsi, %rsi
...
nop
add $37246, %r15
lea addresses_A_ht+0x1d1f0, %rdx
nop
nop
nop
nop
...
nop
sub %r11, %r11
lea addresses_UC_ht+0xfa66, %rax
nop
add %r12, %r12
mov (%rax), %r15d
nop
...
nop
cmp %r15, %r15
lea addresses_WT_ht+0x7c4a, %rax
nop
nop
add %rdi, %rdi
mov $0x6162636465666768, %r11
...
nop
xor %rax, %rax
lea addresses_UC_ht+0xc47e, %rsi
nop
nop
nop
nop
...
nop
and $44798, %r12
lea addresses_WC_ht+0x10ffa, %rsi
lea addresses_D_ht+0x1598, %rdi
nop
nop
inc %r12
mov $83, %rcx
...
nop
cmp %rdi, %rdi
lea addresses_WC_ht+0x11aaa, %rcx
clflush (%rcx)
nop
nop
nop
...
nop
and $44022, %rdi
lea addresses_WT_ht+0x115aa, %rcx
nop
nop
nop
cmp %rdi, %rdi
...
nop
add %rdx, %rdx
lea addresses_WC_ht+0x1d18a, %rsi
lea addresses_D_ht+0xb5aa, %rdi
nop
nop
nop
sub $17929, %r11
...
nop
cmp $261, %rax
lea addresses_D_ht+0x1eaca, %r12
nop
nop
nop
nop
...
nop
and %rax, %rax
lea addresses_WT_ht+0xc32a, %rax
sub %rsi, %rsi
movb (%rax), %cl
nop
nop
add $60560, %rdx
lea addresses_WC_ht+0x8ca, %rsi
lea addresses_WT_ht+0x135aa, %rdi
clflush (%rsi)
clflush (%rdi)
nop
nop
...
nop
xor %r12, %r12
lea addresses_WT_ht+0x1006a, %rsi
nop
nop
nop
nop
...
nop
and %rcx, %rcx
lea addresses_normal_ht+0x2279, %rdi
add %r15, %r15
mov (%rdi), %r12d
xor $63377, %rdi
pop %rsi
