...
push %rax
push %rbx
lea addresses_WT_ht+0x3f87, %rax
nop
nop
nop
nop
...
nop
and $55974, %r12
lea addresses_normal_ht+0x13b1e, %r13
nop
nop
cmp $45538, %r8
movl $0x61626364, (%r13)
...
nop
inc %r8
lea addresses_normal_ht+0x83c6, %r14
nop
nop
nop
nop
...
nop
add %r14, %r14
lea addresses_WC_ht+0x18abe, %r13
and %r10, %r10
mov (%r13), %r8d
nop
nop
...
{'OP': 'LOAD', 'src': {'type': 'addresses_RW', 'AVXalign': False, 'congruent': 8, 'size': 4, 'same': False, 'NT': False}}
[Faulty Load]
...
{'OP': 'LOAD', 'src': {'type': 'addresses_WC_ht', 'AVXalign': True, 'congruent': 5, 'size': 4, 'same': False, 'NT': False}}
{'33': 21829}
