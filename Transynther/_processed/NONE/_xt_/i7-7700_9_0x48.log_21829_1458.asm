...
push %rdi
push %rsi
lea addresses_WC_ht+0x6e16, %r13
nop
nop
nop
nop
...
nop
add %rdi, %rdi
lea addresses_D_ht+0x1e91d, %rsi
lea addresses_normal_ht+0x2f85, %rdi
nop
nop
nop
sub %rax, %rax
...
nop
xor %rsi, %rsi
lea addresses_WT_ht+0x939d, %rsi
nop
nop
nop
nop
...
nop
xor $34142, %r13
lea addresses_WC_ht+0x4f1d, %rdi
nop
nop
dec %r13
movb (%rdi), %cl
sub %rbp, %rbp
lea addresses_normal_ht+0xdd6d, %r13
clflush (%r13)
nop
nop
inc %rbp
...
nop
xor $13960, %rbx
lea addresses_normal_ht+0x1c75d, %rsi
lea addresses_UC_ht+0x13371, %rdi
nop
nop
nop
inc %r8
...
nop
xor %rax, %rax
lea addresses_D_ht+0x17acd, %rsi
nop
nop
nop
nop
...
// Faulty Load
lea addresses_normal+0x1751d, %r12
nop
and $34733, %rsi
movb (%r12), %r9b
lea oracles, %rsi
