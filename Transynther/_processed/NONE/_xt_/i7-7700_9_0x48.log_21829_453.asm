...
push %rdx
push %rsi
lea addresses_A_ht+0x1c0d1, %r11
nop
nop
nop
nop
...
nop
xor $17703, %r9
lea addresses_D_ht+0x19479, %r11
nop
xor %rbx, %rbx
...
nop
add %r11, %r11
lea addresses_WC_ht+0x2679, %rsi
lea addresses_A_ht+0x3e37, %rdi
nop
nop
nop
nop
...
nop
inc %r11
lea addresses_normal_ht+0x1c279, %rbp
nop
nop
nop
inc %rcx
...
nop
cmp $4853, %rcx
lea addresses_A_ht+0xba79, %rsi
lea addresses_D_ht+0x1d011, %rdi
nop
nop
nop
nop
...
nop
xor %rdi, %rdi
lea addresses_WC_ht+0x192a9, %rsi
lea addresses_WC_ht+0x18c39, %rdi
clflush (%rsi)
nop
nop
xor $22221, %rbp
...
nop
xor %r11, %r11
lea addresses_D_ht+0x1d279, %rsi
lea addresses_normal_ht+0x3c03, %rdi
clflush (%rsi)
nop
add %r11, %r11
mov $72, %rcx
...
nop
and $50686, %rdi
lea addresses_WT_ht+0x12c79, %rdx
nop
nop
nop
nop
...
{'OP': 'REPM', 'src': {'type': 'addresses_D_ht', 'congruent': 8, 'same': False}, 'dst': {'type': 'addresses_normal_ht', 'congruent': 1, 'same': True}}
