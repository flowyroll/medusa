...
nop
and $51922, %r8
lea addresses_WT_ht+0x1025a, %rbx
nop
nop
nop
nop
...
nop
sub %rdx, %rdx
lea addresses_WT_ht+0x1403a, %r10
nop
nop
inc %rbx
mov (%r10), %r9w
...
nop
sub %r10, %r10
lea addresses_WT_ht+0xab9a, %rsi
lea addresses_normal_ht+0x1d9a, %rdi
sub %rbx, %rbx
mov $20, %rcx
rep movsw
nop
...
nop
xor %rdi, %rdi
lea addresses_UC_ht+0xb01a, %rbx
clflush (%rbx)
xor %rdi, %rdi
movl $0x61626364, (%rbx)
nop
...
nop
xor $1985, %rdi
lea addresses_A_ht+0x13106, %rdi
clflush (%rdi)
inc %rcx
mov (%rdi), %r9d
nop
...
{'src': {'NT': True, 'AVXalign': True, 'size': 2, 'congruent': 4, 'same': False, 'type': 'addresses_WT_ht'}, 'OP': 'LOAD'}
