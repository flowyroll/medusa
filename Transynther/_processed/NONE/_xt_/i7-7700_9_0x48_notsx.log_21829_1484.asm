...
nop
inc %rcx
lea addresses_WT_ht+0x8e91, %rsi
...
nop
and $10947, %rsi
lea addresses_WC_ht+0x16901, %r12
nop
nop
nop
nop
...
// REPMOV
lea addresses_WT+0xe091, %rsi
lea addresses_WT+0x1f355, %rdi
nop
add $57372, %r13
mov $35, %rcx
rep movsb
...
{'dst': {'same': False, 'congruent': 2, 'type': 'addresses_WT'}, 'OP': 'REPM', 'src': {'same': False, 'congruent': 9, 'type': 'addresses_WT'}}
...
{'dst': {'same': False, 'congruent': 3, 'type': 'addresses_WT_ht'}, 'OP': 'REPM', 'src': {'same': False, 'congruent': 10, 'type': 'addresses_WT_ht'}}
