...
nop
inc %rdx
lea addresses_A_ht+0x1efae, %rsi
nop
nop
nop
and %r13, %r13
...
nop
cmp $9045, %rdi
lea addresses_D_ht+0x133ae, %r9
dec %rdi
mov $0x6162636465666768, %rsi
movq %rsi, %xmm0
movups %xmm0, (%r9)
xor %rdx, %rdx
lea addresses_normal_ht+0x1e57e, %rsi
nop
nop
nop
sub $47607, %rdi
...
nop
sub %rdi, %rdi
lea addresses_WC_ht+0x1dfae, %r11
nop
nop
nop
add %r9, %r9
...
nop
add %rdi, %rdi
lea addresses_A_ht+0x1172e, %rsi
sub %r9, %r9
movw $0x6162, (%rsi)
nop
nop
...
nop
xor %rdx, %rdx
lea addresses_normal_ht+0x192ae, %rsi
nop
nop
nop
nop
...
nop
xor %r11, %r11
lea addresses_A_ht+0x1bf1a, %r13
nop
and $42992, %rdi
movups (%r13), %xmm1
vpextrq $1, %xmm1, %rdx
...
// Faulty Load
lea addresses_normal+0x177ae, %rdi
lfence
mov (%rdi), %r11
lea oracles, %rdx
and $0xff, %r11
...
{'src': {'type': 'addresses_A_ht', 'congruent': 7, 'same': False}, 'OP': 'REPM', 'dst': {'type': 'addresses_A_ht', 'congruent': 4, 'same': True}}
...
{'OP': 'STOR', 'dst': {'same': False, 'congruent': 3, 'NT': True, 'type': 'addresses_normal_ht', 'size': 4, 'AVXalign': False}}
...
{'OP': 'STOR', 'dst': {'same': True, 'congruent': 7, 'NT': False, 'type': 'addresses_normal_ht', 'size': 8, 'AVXalign': False}}
