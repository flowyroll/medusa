...
push %rdi
push %rsi
lea addresses_WT_ht+0x11808, %rsi
lea addresses_WT_ht+0x1bf40, %rdi
clflush (%rsi)
nop
nop
nop
...
nop
and %rax, %rax
lea addresses_WC_ht+0x1de40, %rsi
lea addresses_D_ht+0x23c0, %rdi
nop
nop
nop
sub %rbp, %rbp
...
nop
xor %rdi, %rdi
lea addresses_WC_ht+0xfe40, %rdi
dec %r15
...
nop
inc %rcx
lea addresses_WT_ht+0x1c640, %rsi
lea addresses_normal_ht+0x8680, %rdi
nop
nop
nop
dec %r14
...
rep movsb
dec %rsi
lea addresses_A_ht+0x14680, %rbp
xor %rdi, %rdi
mov (%rbp), %r12w
nop
nop
cmp $55283, %rcx
lea addresses_normal_ht+0x14e40, %rsi
lea addresses_WT_ht+0xc760, %rdi
nop
nop
xor $12436, %rax
mov $51, %rcx
...
nop
cmp $38058, %rax
lea addresses_A_ht+0x15b40, %rax
clflush (%rax)
nop
nop
nop
...
nop
cmp $9063, %rbp
lea addresses_WC_ht+0x74fc, %r14
nop
nop
nop
dec %rax
...
nop
and %rcx, %rcx
lea addresses_D_ht+0x13e40, %rsi
lea addresses_WC_ht+0x2240, %rdi
nop
inc %r12
mov $98, %rcx
rep movsl
...
// Store
lea addresses_normal+0x1ba00, %r10
nop
nop
cmp %r13, %r13
movb $0x51, (%r10)
...
{'OP': 'REPM', 'src': {'type': 'addresses_normal_ht', 'congruent': 11, 'same': False}, 'dst': {'type': 'addresses_WT_ht', 'congruent': 5, 'same': True}}
...
{'OP': 'REPM', 'src': {'type': 'addresses_D_ht', 'congruent': 11, 'same': False}, 'dst': {'type': 'addresses_WC_ht', 'congruent': 10, 'same': False}}
