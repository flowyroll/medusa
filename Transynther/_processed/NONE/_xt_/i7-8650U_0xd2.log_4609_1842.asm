...
push %rdi
push %rsi
lea addresses_WT_ht+0x16195, %r10
nop
nop
nop
nop
...
nop
and $57394, %rsi
lea addresses_WC_ht+0x3ff5, %rbp
nop
nop
nop
xor %rax, %rax
...
nop
cmp $21134, %rbp
lea addresses_UC_ht+0x1f59, %rsi
nop
nop
nop
nop
...
nop
inc %rdi
lea addresses_D_ht+0x4415, %rsi
lea addresses_normal_ht+0x17c15, %rdi
nop
nop
nop
nop
...
nop
add $5208, %r10
lea addresses_normal_ht+0x647d, %r10
nop
nop
nop
nop
...
nop
sub %rsi, %rsi
lea addresses_WT_ht+0x10b15, %rdi
nop
nop
nop
nop
...
nop
sub $54021, %rsi
lea addresses_WT_ht+0xe595, %rsi
lea addresses_WC_ht+0x5615, %rdi
sub %rbp, %rbp
mov $18, %rcx
rep movsb
nop
...
nop
sub %rdi, %rdi
lea addresses_A_ht+0x1d15, %rsi
lea addresses_D_ht+0x16695, %rdi
clflush (%rdi)
nop
nop
nop
...
rep movsw
dec %rsi
lea addresses_WT_ht+0xd615, %rdi
nop
nop
inc %r10
mov (%rdi), %r13w
...
// Store
lea addresses_WT+0x9ec5, %rbp
xor %rdx, %rdx
movl $0x51525354, (%rbp)
cmp $11441, %r9

// Faulty Load
lea addresses_RW+0xd615, %rcx
nop
sub %rdx, %rdx
movb (%rcx), %r9b
lea oracles, %rcx
...
{'OP': 'LOAD', 'src': {'type': 'addresses_UC_ht', 'size': 4, 'AVXalign': False, 'NT': False, 'congruent': 1, 'same': True}}
{'OP': 'REPM', 'src': {'type': 'addresses_D_ht', 'congruent': 2, 'same': False}, 'dst': {'type': 'addresses_normal_ht', 'congruent': 9, 'same': False}}
