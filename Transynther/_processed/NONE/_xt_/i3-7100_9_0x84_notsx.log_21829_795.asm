...
push %rdi
push %rsi
lea addresses_UC_ht+0x1c8e5, %r8
clflush (%r8)
nop
nop
add %r15, %r15
...
nop
sub %r13, %r13
lea addresses_WC_ht+0x137e5, %rsi
lea addresses_WT_ht+0xdbe5, %rdi
clflush (%rsi)
nop
nop
and %r14, %r14
...
nop
xor $1221, %rcx
lea addresses_A_ht+0x1bf65, %rsi
...
nop
xor $5895, %r9
lea addresses_WC_ht+0x10ccd, %rsi
lea addresses_WC_ht+0x34e5, %rdi
nop
xor %r15, %r15
mov $87, %rcx
rep movsl
nop
sub %rsi, %rsi
lea addresses_UC_ht+0x1d0e5, %r8
nop
nop
add $25787, %r12
mov (%r8), %rsi
...
nop
xor $22344, %rdi
lea addresses_A_ht+0x1b87d, %rsi
nop
nop
nop
nop
...
nop
sub %r13, %r13
lea addresses_normal_ht+0x53d5, %rsi
lea addresses_normal_ht+0x1971, %rdi
nop
nop
nop
nop
...
nop
xor %r9, %r9
lea addresses_WT_ht+0xff65, %rsi
lea addresses_A_ht+0x1e8e5, %rdi
clflush (%rsi)
nop
cmp %r9, %r9
mov $117, %rcx
...
nop
cmp %rsi, %rsi
lea addresses_WC_ht+0x188e5, %r15
nop
nop
sub $62950, %r8
movb (%r15), %r9b
...
nop
xor $16489, %r13
lea addresses_WT_ht+0x80e5, %r9
sub %r8, %r8
mov (%r9), %rsi
nop
and %r12, %r12
lea addresses_UC_ht+0xd85, %r8
nop
cmp %rcx, %rcx
movb (%r8), %r14b
nop
...
{'src': {'type': 'addresses_WC_ht', 'congruent': 7, 'same': False}, 'dst': {'type': 'addresses_WT_ht', 'congruent': 8, 'same': True}, 'OP': 'REPM'}
...
{'src': {'type': 'addresses_UC_ht', 'same': False, 'size': 8, 'congruent': 11, 'NT': False, 'AVXalign': True}, 'OP': 'LOAD'}
