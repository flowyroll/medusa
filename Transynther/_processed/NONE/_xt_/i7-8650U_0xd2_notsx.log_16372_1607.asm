...
nop
cmp %rcx, %rcx
lea addresses_normal_ht+0x1791f, %rsi
lea addresses_WT_ht+0x174c7, %rdi
xor $15715, %rdx
mov $13, %rcx
rep movsl
nop
nop
sub %rcx, %rcx
lea addresses_WT_ht+0xb6c7, %r11
nop
nop
nop
nop
...
vpextrq $0, %xmm5, %rdi
sub $21570, %r10
lea addresses_A_ht+0x1ac7, %rsi
lea addresses_UC_ht+0xe8c7, %rdi
nop
nop
sub %r12, %r12
mov $76, %rcx
...
nop
xor $32265, %r12
lea addresses_UC_ht+0x2147, %rsi
lea addresses_A_ht+0x112c7, %rdi
nop
nop
nop
nop
...
nop
sub $14633, %rsi
lea addresses_WC_ht+0x19dc7, %rdx
nop
nop
nop
nop
...
mov (%rdx), %r11d
inc %rcx
lea addresses_normal_ht+0x179f, %rsi
lea addresses_D_ht+0xa2c7, %rdi
nop
nop
nop
nop
...
nop
cmp $33393, %r11
lea addresses_WT_ht+0xacc7, %rsi
lea addresses_UC_ht+0x17894, %rdi
nop
nop
inc %r11
mov $79, %rcx
...
nop
and %rdi, %rdi
lea addresses_normal_ht+0x1eadd, %r11
xor $62569, %rdi
movb (%r11), %cl
xor $29973, %r8
lea addresses_WC_ht+0x1e547, %r10
nop
nop
nop
nop
