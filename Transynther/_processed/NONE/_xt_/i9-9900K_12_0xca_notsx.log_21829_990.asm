...
nop
cmp $22662, %rbp
lea addresses_WC_ht+0xaedb, %r12
nop
add $45672, %r13
...
nop
sub %r8, %r8
lea addresses_normal_ht+0x1df3b, %rsi
lea addresses_A_ht+0x43b, %rdi
clflush (%rdi)
sub %r11, %r11
mov $111, %rcx
rep movsw
nop
add $22802, %r15
lea addresses_normal_ht+0x518e, %r12
nop
nop
nop
sub %rdi, %rdi
...
nop
cmp %rbp, %rbp
lea addresses_WT_ht+0x13bbb, %r13
nop
nop
nop
dec %rbx
...
nop
xor $30574, %rbx
lea addresses_WT_ht+0xab3b, %rsi
lea addresses_WT_ht+0x1b13b, %rdi
nop
nop
nop
cmp %rbp, %rbp
...
vpextrq $0, %xmm3, %rbp
inc %rbx
lea addresses_normal_ht+0x6c3b, %rbp
nop
nop
nop
nop
...
<gen_prepare_buffer>
{'OP': 'LOAD', 'src': {'same': True, 'type': 'addresses_WC_ht', 'NT': False, 'AVXalign': False, 'size': 8, 'congruent': 1}}
...
{'OP': 'STOR', 'dst': {'same': False, 'type': 'addresses_normal_ht', 'NT': True, 'AVXalign': False, 'size': 2, 'congruent': 0}}
{'OP': 'LOAD', 'src': {'same': True, 'type': 'addresses_WT_ht', 'NT': False, 'AVXalign': False, 'size': 2, 'congruent': 6}}
{'OP': 'REPM', 'src': {'same': False, 'congruent': 9, 'type': 'addresses_WT_ht'}, 'dst': {'same': False, 'congruent': 8, 'type': 'addresses_WT_ht'}}
{'OP': 'LOAD', 'src': {'same': False, 'type': 'addresses_D_ht', 'NT': True, 'AVXalign': False, 'size': 32, 'congruent': 1}}
