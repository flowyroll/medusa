...
push %rdi
push %rsi
lea addresses_WT_ht+0x1e2cf, %rsi
clflush (%rsi)
nop
nop
nop
...
nop
sub %r10, %r10
lea addresses_UC_ht+0x6f88, %rsi
lea addresses_normal_ht+0xb481, %rdi
sub %r12, %r12
mov $10, %rcx
rep movsb
nop
...
nop
dec %r13
lea addresses_A_ht+0x12ccf, %rdi
dec %rbx
mov (%rdi), %r12
nop
nop
...
nop
xor $22525, %rsi
lea addresses_WC_ht+0x14bdb, %r10
clflush (%r10)
nop
nop
nop
...
nop
inc %rdi
lea addresses_WT_ht+0x3a87, %rsi
lea addresses_normal_ht+0x190bf, %rdi
nop
nop
nop
nop
...
// Faulty Load
lea addresses_normal+0x2ecf, %rbp
and $29680, %r10
mov (%rbp), %r8
lea oracles, %rdx
and $0xff, %r8
...
{'OP': 'REPM', 'src': {'type': 'addresses_UC_ht', 'congruent': 0, 'same': False}, 'dst': {'type': 'addresses_normal_ht', 'congruent': 1, 'same': False}}
