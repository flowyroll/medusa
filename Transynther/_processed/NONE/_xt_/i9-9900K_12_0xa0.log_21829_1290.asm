...
movb (%r15), %bl
inc %r15
lea addresses_A_ht+0x102ea, %rcx
and %r10, %r10
mov (%rcx), %r15d
nop
nop
sub $35389, %rcx
lea addresses_WT_ht+0x1a0ea, %r10
nop
nop
nop
nop
...
nop
add $29663, %rdi
lea addresses_WT_ht+0x28ea, %rsi
lea addresses_WC_ht+0x170ea, %rdi
clflush (%rdi)
cmp %r15, %r15
mov $33, %rcx
rep movsb
add $8060, %rbx
lea addresses_A_ht+0x178ea, %rbx
nop
nop
nop
nop
...
// Faulty Load
lea addresses_normal+0xd8ea, %r10
nop
nop
inc %rbx
mov (%r10), %r12
...
{'src': {'NT': False, 'same': False, 'congruent': 6, 'type': 'addresses_UC', 'AVXalign': False, 'size': 1}, 'OP': 'LOAD'}
[Faulty Load]
...
{'src': {'NT': True, 'same': True, 'congruent': 9, 'type': 'addresses_A_ht', 'AVXalign': False, 'size': 4}, 'OP': 'LOAD'}
...
{'src': {'same': False, 'congruent': 9, 'type': 'addresses_WT_ht'}, 'OP': 'REPM', 'dst': {'same': False, 'congruent': 11, 'type': 'addresses_WC_ht'}}
