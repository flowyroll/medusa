...
push %rdx
push %rsi
lea addresses_normal_ht+0x14936, %rsi
lea addresses_WC_ht+0x13234, %rdi
nop
nop
nop
nop
...
nop
dec %rdx
lea addresses_A_ht+0x50b4, %rsi
lea addresses_WT_ht+0x1c9b4, %rdi
nop
nop
nop
nop
...
nop
and $55727, %rdx
lea addresses_D_ht+0x72ae, %rsi
lea addresses_D_ht+0xc734, %rdi
nop
nop
nop
nop
