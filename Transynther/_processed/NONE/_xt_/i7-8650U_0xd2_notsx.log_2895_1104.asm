...
push %rdi
push %rsi
lea addresses_A_ht+0x1adaa, %rbx
nop
nop
nop
inc %rcx
...
nop
and $6888, %r14
lea addresses_UC_ht+0x1d91a, %r15
nop
nop
nop
inc %rdi
...
nop
xor %r9, %r9
lea addresses_normal_ht+0x3dda, %rsi
lea addresses_normal_ht+0x10883, %rdi
and $57011, %r15
mov $105, %rcx
rep movsq
nop
...
nop
and $59756, %r15
lea addresses_UC_ht+0x1685a, %rsi
nop
nop
nop
nop
...
nop
and %r14, %r14
lea addresses_UC_ht+0x6a5a, %rsi
lea addresses_D_ht+0x1c5b2, %rdi
nop
nop
nop
and $8072, %rbp
...
// Load
lea addresses_normal+0x51da, %r8
nop
nop
sub %rsi, %rsi
vmovups (%r8), %ymm5
...
// Store
lea addresses_normal+0x110ca, %r15
sub %r12, %r12
movb $0x51, (%r15)
nop
sub $24884, %rsi
...
{'OP': 'LOAD', 'src': {'type': 'addresses_normal', 'size': 32, 'AVXalign': False, 'NT': False, 'congruent': 7, 'same': False}}
...
{'OP': 'STOR', 'dst': {'type': 'addresses_WT', 'size': 8, 'AVXalign': True, 'NT': False, 'congruent': 1, 'same': False}}
...
{'OP': 'STOR', 'dst': {'type': 'addresses_UC_ht', 'size': 1, 'AVXalign': False, 'NT': False, 'congruent': 6, 'same': True}}
