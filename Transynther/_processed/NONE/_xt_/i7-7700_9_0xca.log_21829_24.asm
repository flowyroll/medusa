...
mov (%r8), %r14w
sub %rsi, %rsi
lea addresses_WC_ht+0x9c0a, %rsi
lea addresses_UC_ht+0x15b1a, %rdi
nop
nop
nop
nop
...
nop
xor $23627, %r8
lea addresses_normal_ht+0x731a, %rdi
clflush (%rdi)
nop
nop
sub %r14, %r14
...
nop
and $18273, %r14
lea addresses_UC_ht+0x1019a, %rsi
lea addresses_A_ht+0x371a, %rdi
clflush (%rdi)
and %r9, %r9
mov $40, %rcx
rep movsl
...
nop
sub %rdi, %rdi
lea addresses_normal_ht+0x6b1a, %rdi
nop
nop
nop
nop
...
vmovups %ymm4, (%rdi)
dec %rbp
lea addresses_normal_ht+0x18c5a, %rsi
nop
nop
xor %r14, %r14
movb (%rsi), %r8b
...
nop
xor $57186, %rdi
lea addresses_normal_ht+0xa1a, %rsi
lea addresses_D_ht+0x1887a, %rdi
nop
nop
nop
dec %r11
...
rep movsq
and %r9, %r9
lea addresses_normal_ht+0x1b946, %r9
clflush (%r9)
nop
nop
nop
...
nop
sub $38923, %r8
lea addresses_WT_ht+0x1199a, %r8
nop
nop
nop
nop
...
lea addresses_UC_ht+0xc542, %rdi
nop
nop
dec %r9
mov $16, %rcx
...
{'src': {'congruent': 7, 'same': False, 'type': 'addresses_UC_ht'}, 'OP': 'REPM', 'dst': {'congruent': 10, 'same': True, 'type': 'addresses_A_ht'}}
...
{'src': {'congruent': 8, 'same': False, 'type': 'addresses_normal_ht'}, 'OP': 'REPM', 'dst': {'congruent': 5, 'same': False, 'type': 'addresses_D_ht'}}
