...
push %rdx
push %rsi
lea addresses_WC_ht+0x7ca3, %rsi
lea addresses_D_ht+0x15093, %rdi
clflush (%rsi)
add $15596, %rax
mov $71, %rcx
rep movsw
...
nop
and %r11, %r11
lea addresses_A_ht+0x17f73, %r11
nop
nop
sub %rdi, %rdi
movw $0x6162, (%r11)
...
nop
and %rsi, %rsi
lea addresses_WT_ht+0x11793, %rbp
nop
nop
sub %r9, %r9
...
movq %rdi, (%rbp)
add $10130, %r9
lea addresses_A_ht+0x1d1f3, %rsi
nop
nop
nop
nop
...
movups %xmm7, (%rsi)
sub %r11, %r11
lea addresses_UC_ht+0xc1f3, %rsi
lea addresses_WT_ht+0xb153, %rdi
nop
nop
nop
nop
...
nop
xor $30898, %rbp
lea addresses_UC_ht+0x7cb3, %rdx
inc %rbp
movups (%rdx), %xmm0
vpextrq $0, %xmm0, %rdi
xor $50374, %r9
...
// Faulty Load
lea addresses_normal+0x2df3, %r12
nop
nop
nop
add %rsi, %rsi
...
<gen_prepare_buffer>
{'src': {'type': 'addresses_WC_ht', 'congruent': 2, 'same': False}, 'OP': 'REPM', 'dst': {'type': 'addresses_D_ht', 'congruent': 4, 'same': True}}
