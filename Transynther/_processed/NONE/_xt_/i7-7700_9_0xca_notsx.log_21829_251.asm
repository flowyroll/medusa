...
push %rdi
push %rsi
lea addresses_A_ht+0x10865, %rsi
lea addresses_A_ht+0xf245, %rdi
sub %r8, %r8
mov $76, %rcx
rep movsq
nop
nop
cmp $13187, %r12
lea addresses_WT_ht+0x107b5, %rsi
...
nop
cmp %rsi, %rsi
lea addresses_WT_ht+0x8645, %rsi
lea addresses_WT_ht+0x90f1, %rdi
xor %r11, %r11
mov $4, %rcx
rep movsq
sub $32920, %r12
lea addresses_A_ht+0x99d5, %r12
nop
mfence
mov (%r12), %r15d
nop
...
{'src': {'congruent': 4, 'same': False, 'type': 'addresses_WT_ht'}, 'dst': {'congruent': 0, 'same': False, 'type': 'addresses_WC_ht'}, 'OP': 'REPM'}
