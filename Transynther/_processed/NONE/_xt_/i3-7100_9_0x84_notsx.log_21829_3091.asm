...
push %rdi
push %rsi
lea addresses_D_ht+0x19c1, %rsi
lea addresses_A_ht+0x12e41, %rdi
dec %r13
mov $41, %rcx
rep movsq
nop
...
movq %rcx, (%rbx)
xor $5622, %r10
lea addresses_UC_ht+0xa6c1, %rsi
lea addresses_A_ht+0xbd41, %rdi
clflush (%rsi)
nop
nop
dec %r12
...
nop
cmp %r13, %r13
lea addresses_WC_ht+0x2c41, %r10
nop
cmp $30245, %rcx
mov (%r10), %r12w
nop
...
nop
sub $37365, %r10
lea addresses_UC_ht+0x2481, %rcx
nop
nop
nop
nop
...
nop
dec %rcx
lea addresses_UC_ht+0xc9b1, %rsi
nop
nop
nop
nop
...
nop
lfence
lea addresses_A_ht+0xe821, %rsi
lea addresses_UC_ht+0x16241, %rdi
clflush (%rdi)
nop
cmp %r8, %r8
mov $91, %rcx
...
nop
xor %rdi, %rdi
lea addresses_UC_ht+0x13119, %r13
nop
nop
nop
nop
...
// Load
lea addresses_normal+0x3a41, %rdx
nop
nop
nop
xor %r11, %r11
...
<gen_prepare_buffer>
{'src': {'type': 'addresses_D_ht', 'congruent': 6, 'same': True}, 'dst': {'type': 'addresses_A_ht', 'congruent': 9, 'same': False}, 'OP': 'REPM'}
...
{'src': {'type': 'addresses_A_ht', 'congruent': 1, 'same': False}, 'dst': {'type': 'addresses_UC_ht', 'congruent': 10, 'same': True}, 'OP': 'REPM'}
{'src': {'type': 'addresses_UC_ht', 'same': False, 'size': 32, 'congruent': 2, 'NT': True, 'AVXalign': False}, 'OP': 'LOAD'}
{'33': 21829}
