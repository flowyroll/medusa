...
movq %r14, (%rbx)
add $12354, %r8
lea addresses_WT_ht+0xf765, %r14
cmp $25759, %r8
vmovups (%r14), %ymm5
...
nop
add $52065, %r14
lea addresses_WT_ht+0xe10f, %r14
nop
nop
nop
add %r9, %r9
...
nop
sub $44061, %rbx
lea addresses_WC_ht+0x12ae1, %rsi
lea addresses_normal_ht+0x96e1, %rdi
nop
nop
nop
nop
...
rep movsq
add %r12, %r12
lea addresses_normal_ht+0x7751, %rcx
clflush (%rcx)
nop
nop
nop
...
nop
xor %r9, %r9
lea addresses_UC_ht+0x1109b, %rbx
clflush (%rbx)
mfence
movl $0x61626364, (%rbx)
nop
nop
and %rsi, %rsi
lea addresses_WT_ht+0x1427d, %rdi
nop
nop
nop
xor %r14, %r14
