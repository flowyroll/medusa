...
push %rdi
push %rsi
lea addresses_normal_ht+0x1ca5a, %r8
nop
nop
nop
nop
...
nop
cmp $26101, %rdi
lea addresses_UC_ht+0x1aa5a, %rdi
xor %r14, %r14
movb $0x61, (%rdi)
xor %rdi, %rdi
lea addresses_D_ht+0x14a5a, %rsi
lea addresses_WT_ht+0x986, %rdi
nop
nop
inc %r9
mov $67, %rcx
rep movsb
and %r8, %r8
lea addresses_D_ht+0x1abd4, %rsi
lea addresses_WC_ht+0x2a9a, %rdi
cmp %r12, %r12
mov $0, %rcx
rep movsq
nop
nop
xor %r14, %r14
lea addresses_UC_ht+0xe25a, %r14
nop
nop
nop
nop
...
nop
xor %rax, %rax
lea addresses_D_ht+0x1835a, %r14
lfence
...
nop
dec %r14
lea addresses_UC_ht+0x147eb, %rcx
nop
nop
nop
nop
...
{'src': {'type': 'addresses_D_ht', 'congruent': 1, 'same': True}, 'OP': 'REPM', 'dst': {'type': 'addresses_WC_ht', 'congruent': 4, 'same': False}}
