...
nop
inc %r11
lea addresses_WC_ht+0x5789, %rsi
lea addresses_WC_ht+0x14a81, %rdi
nop
nop
nop
nop
...
rep movsb
and $46216, %r12
lea addresses_WC_ht+0x1a259, %r10
nop
nop
cmp $9066, %rsi
movups (%r10), %xmm3
...
nop
dec %rsi
lea addresses_WT_ht+0x16909, %r11
nop
xor %r8, %r8
movw $0x6162, (%r11)
cmp %r12, %r12
lea addresses_A_ht+0xf509, %rsi
lea addresses_A_ht+0x14a79, %rdi
clflush (%rsi)
clflush (%rdi)
nop
nop
...
<gen_prepare_buffer>
{'src': {'same': False, 'congruent': 6, 'type': 'addresses_normal_ht'}, 'OP': 'REPM', 'dst': {'same': True, 'congruent': 11, 'type': 'addresses_D_ht'}}
{'OP': 'STOR', 'dst': {'NT': True, 'same': False, 'congruent': 4, 'type': 'addresses_WC_ht', 'AVXalign': False, 'size': 16}}
{'src': {'same': True, 'congruent': 5, 'type': 'addresses_WC_ht'}, 'OP': 'REPM', 'dst': {'same': False, 'congruent': 2, 'type': 'addresses_WC_ht'}}
...
{'src': {'same': True, 'congruent': 10, 'type': 'addresses_A_ht'}, 'OP': 'REPM', 'dst': {'same': False, 'congruent': 3, 'type': 'addresses_A_ht'}}
{'36': 21829}
