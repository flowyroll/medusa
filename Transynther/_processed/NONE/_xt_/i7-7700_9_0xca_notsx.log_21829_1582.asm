...
push %rdx
push %rsi
lea addresses_WT_ht+0x15796, %r13
clflush (%r13)
nop
nop
nop
...
nop
xor $55512, %r11
lea addresses_WT_ht+0xdd0a, %rdx
sub %r8, %r8
movups (%rdx), %xmm3
vpextrq $0, %xmm3, %rax
nop
...
nop
sub %rax, %rax
lea addresses_UC_ht+0x1450a, %rax
nop
nop
nop
nop
...
nop
xor $35634, %r11
lea addresses_WT_ht+0x1bd0a, %rdx
nop
nop
dec %r8
...
nop
dec %r13
lea addresses_WC_ht+0x11bea, %rsi
lea addresses_WC_ht+0x18b0a, %rdi
nop
nop
and %rax, %rax
mov $48, %rcx
...
nop
dec %rax
lea addresses_UC_ht+0xe0fa, %r11
nop
nop
nop
and $35649, %r9
...
nop
add $33714, %r8
lea addresses_UC_ht+0x1c032, %rcx
nop
sub $37166, %r14
...
nop
cmp $31386, %rdi
lea addresses_normal_ht+0x1b90a, %rdi
nop
nop
inc %rax
...
{'src': {'NT': False, 'AVXalign': False, 'size': 1, 'congruent': 2, 'same': True, 'type': 'addresses_A_ht'}, 'OP': 'LOAD'}
