...
push %rdi
push %rsi
lea addresses_normal_ht+0x1d78b, %rax
nop
nop
xor %r14, %r14
movl $0x61626364, (%rax)
...
nop
and $48493, %r9
lea addresses_WT_ht+0x7b4b, %rsi
lea addresses_WC_ht+0xc573, %rdi
clflush (%rsi)
nop
nop
xor %r14, %r14
...
rep movsb
dec %rcx
lea addresses_normal_ht+0xdf3b, %rsi
lea addresses_WC_ht+0x1e14f, %rdi
nop
nop
and $22899, %r11
mov $20, %rcx
...
nop
sub $4483, %rax
lea addresses_D_ht+0x1de6b, %rsi
lea addresses_normal_ht+0xe0b, %rdi
nop
nop
nop
nop
...
nop
and %rdi, %rdi
lea addresses_WC_ht+0x16d55, %rsi
lea addresses_UC_ht+0x338b, %rdi
nop
add $22424, %r9
mov $104, %rcx
rep movsq
...
nop
sub $39089, %r8
lea addresses_normal_ht+0x1118b, %r14
nop
nop
nop
nop
...
mov (%r14), %esi
xor $50987, %rax
lea addresses_D_ht+0xb14b, %rsi
lea addresses_D_ht+0x17055, %rdi
xor $28251, %rax
mov $72, %rcx
rep movsb
nop
...
nop
mfence
lea addresses_WT_ht+0x101f1, %rdi
clflush (%rdi)
nop
xor %rax, %rax
...
nop
and %rcx, %rcx
lea addresses_WC_ht+0x490b, %r11
cmp $29784, %r8
movb (%r11), %cl
nop
nop
...
{'src': {'type': 'addresses_WT_ht', 'congruent': 5, 'same': False}, 'dst': {'type': 'addresses_WC_ht', 'congruent': 3, 'same': False}, 'OP': 'REPM'}
...
{'src': {'type': 'addresses_D_ht', 'congruent': 6, 'same': False}, 'dst': {'type': 'addresses_D_ht', 'congruent': 0, 'same': False}, 'OP': 'REPM'}
