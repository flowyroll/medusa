...
nop
sub %r10, %r10
lea addresses_UC_ht+0xd256, %rsi
lea addresses_normal_ht+0x17d6, %rdi
clflush (%rdi)
nop
inc %r11
mov $50, %rcx
...
nop
add $5771, %r11
lea addresses_normal_ht+0x117d6, %r11
nop
nop
nop
nop
...
nop
cmp $27096, %rcx
lea addresses_A_ht+0x53d6, %rsi
lea addresses_WT_ht+0x123be, %rdi
nop
nop
nop
nop
...
nop
cmp $46587, %r11
lea addresses_WT_ht+0x133d6, %rsi
lea addresses_UC_ht+0xe8d6, %rdi
nop
nop
nop
nop
...
// Faulty Load
lea addresses_normal+0xfd6, %rbp
nop
nop
nop
nop
...
{'OP': 'REPM', 'src': {'type': 'addresses_A_ht', 'congruent': 7, 'same': True}, 'dst': {'type': 'addresses_WT_ht', 'congruent': 3, 'same': True}}
