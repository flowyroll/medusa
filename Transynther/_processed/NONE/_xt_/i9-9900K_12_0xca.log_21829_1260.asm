...
nop
add %rsi, %rsi
lea addresses_WT_ht+0x166e7, %r13
inc %rdx
...
nop
xor $32045, %r8
lea addresses_A_ht+0x5cf, %rsi
lea addresses_A_ht+0x1aa02, %rdi
nop
nop
nop
nop
...
nop
sub %rcx, %rcx
lea addresses_WC_ht+0x288f, %r11
nop
nop
dec %r8
and $0xffffffffffffffc0, %r11
...
nop
dec %rcx
lea addresses_UC_ht+0x1078f, %rsi
nop
nop
nop
sub %r8, %r8
...
nop
add %r9, %r9
lea addresses_WC_ht+0x1b72e, %rsi
lea addresses_normal_ht+0xffcf, %rdi
xor %r11, %r11
mov $60, %rcx
rep movsl
nop
...
nop
xor $16534, %rdi
lea addresses_normal_ht+0x85cf, %rsi
lea addresses_normal_ht+0x1aacf, %rdi
nop
nop
nop
cmp $2340, %r11
...
nop
dec %rdx
lea addresses_UC_ht+0x7fcf, %rsi
clflush (%rsi)
nop
nop
inc %r13
...
nop
and $37609, %r13
lea addresses_WC_ht+0x81cf, %rsi
nop
nop
xor %rdi, %rdi
mov (%rsi), %r11
nop
xor $3994, %rdx
lea addresses_A_ht+0x6aef, %rsi
lea addresses_normal_ht+0x1edcf, %rdi
nop
nop
nop
nop
...
nop
dec %rdx
lea addresses_WC_ht+0xdbcf, %rdi
clflush (%rdi)
nop
nop
nop
...
{'OP': 'REPM', 'src': {'same': False, 'type': 'addresses_A_ht', 'congruent': 11}, 'dst': {'same': False, 'type': 'addresses_A_ht', 'congruent': 0}}
...
{'OP': 'REPM', 'src': {'same': False, 'type': 'addresses_WC_ht', 'congruent': 0}, 'dst': {'same': False, 'type': 'addresses_normal_ht', 'congruent': 7}}
...
{'OP': 'LOAD', 'src': {'size': 8, 'NT': False, 'type': 'addresses_WC_ht', 'same': False, 'AVXalign': True, 'congruent': 10}}
{'OP': 'REPM', 'src': {'same': False, 'type': 'addresses_A_ht', 'congruent': 0}, 'dst': {'same': False, 'type': 'addresses_normal_ht', 'congruent': 11}}
