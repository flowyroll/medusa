...
push %rdi
push %rsi
lea addresses_WT_ht+0x1b5d4, %rbx
xor %r13, %r13
...
nop
xor %r8, %r8
lea addresses_UC_ht+0x161d4, %r9
nop
sub $49999, %r10
movb (%r9), %r15b
nop
add %r10, %r10
lea addresses_normal_ht+0x59d4, %rsi
...
nop
xor $27890, %r15
lea addresses_WT_ht+0x1cb94, %rsi
lea addresses_A_ht+0x14bd0, %rdi
nop
nop
nop
nop
...
nop
and $14191, %r15
lea addresses_D_ht+0xdad4, %rsi
lea addresses_WC_ht+0x8bf4, %rdi
nop
add %r8, %r8
mov $127, %rcx
rep movsl
...
nop
dec %rbp
lea addresses_D_ht+0x1cc54, %rbp
xor $64613, %rdi
movl $0x61626364, (%rbp)
nop
nop
...
{'OP': 'STOR', 'dst': {'congruent': 6, 'AVXalign': True, 'same': False, 'size': 2, 'NT': False, 'type': 'addresses_NC'}}
{'OP': 'STOR', 'dst': {'congruent': 10, 'AVXalign': True, 'same': False, 'size': 8, 'NT': False, 'type': 'addresses_P'}}
[Faulty Load]
...
{'src': {'congruent': 7, 'same': False, 'type': 'addresses_A_ht'}, 'OP': 'REPM', 'dst': {'congruent': 5, 'same': False, 'type': 'addresses_WT_ht'}}
