...
push %rdi
push %rsi
lea addresses_WT_ht+0x1b8ed, %r10
nop
nop
add %r8, %r8
mov (%r10), %cx
...
nop
dec %r15
lea addresses_normal_ht+0xd8ed, %rax
clflush (%rax)
nop
nop
nop
...
nop
inc %r10
lea addresses_WT_ht+0xa0a1, %r10
nop
nop
nop
nop
...
nop
and %r10, %r10
lea addresses_UC_ht+0xd2ed, %rsi
lea addresses_UC_ht+0x1c6ed, %rdi
dec %r15
mov $29, %rcx
rep movsl
nop
xor $17617, %r15
lea addresses_A_ht+0xe8ed, %rdi
nop
nop
nop
and $15850, %rsi
...
// REPMOV
lea addresses_RW+0x32ed, %rsi
lea addresses_A+0x1082d, %rdi
clflush (%rdi)
inc %rbp
mov $36, %rcx
rep movsw
...
{'src': {'type': 'addresses_RW', 'congruent': 7, 'same': False}, 'OP': 'REPM', 'dst': {'type': 'addresses_A', 'congruent': 6, 'same': False}}
[Faulty Load]
...
{'src': {'type': 'addresses_UC_ht', 'congruent': 8, 'same': False}, 'OP': 'REPM', 'dst': {'type': 'addresses_UC_ht', 'congruent': 8, 'same': True}}
