...
push %rdx
push %rsi
lea addresses_UC_ht+0xbed2, %rsi
lea addresses_normal_ht+0x19ed2, %rdi
and $30077, %r12
mov $50, %rcx
rep movsw
nop
...
nop
sub $52326, %rbp
lea addresses_UC_ht+0x15622, %r10
nop
and $63490, %r14
movb $0x61, (%r10)
nop
...
nop
cmp %rcx, %rcx
lea addresses_A_ht+0x1dad2, %rdi
clflush (%rdi)
nop
nop
and %r12, %r12
...
nop
cmp $41843, %rsi
lea addresses_WT_ht+0x5cd2, %r10
nop
nop
nop
nop
...
nop
and %rdi, %rdi
lea addresses_WT_ht+0x1ddd2, %rsi
lea addresses_A_ht+0x17b4e, %rdi
clflush (%rsi)
nop
nop
nop
...
nop
xor $41643, %rcx
lea addresses_D_ht+0xa8d2, %rsi
lea addresses_D_ht+0x1022, %rdi
nop
nop
cmp %rdx, %rdx
mov $35, %rcx
...
nop
inc %rcx
lea addresses_D_ht+0x22a2, %r10
nop
cmp $18702, %rcx
mov (%r10), %bp
inc %rdx
lea addresses_normal_ht+0xded2, %rdi
nop
dec %r14
movw $0x6162, (%rdi)
nop
...
nop
cmp %r12, %r12
lea addresses_normal_ht+0x1d43a, %rsi
nop
nop
nop
dec %rdi
...
// REPMOV
lea addresses_WC+0x129ce, %rsi
lea addresses_A+0xf942, %rdi
nop
nop
nop
nop
...
{'OP': 'STOR', 'dst': {'type': 'addresses_PSE', 'size': 8, 'AVXalign': False, 'NT': True, 'congruent': 8, 'same': False}}
{'OP': 'LOAD', 'src': {'type': 'addresses_D', 'size': 1, 'AVXalign': False, 'NT': False, 'congruent': 1, 'same': False}}
{'OP': 'REPM', 'src': {'type': 'addresses_WC', 'congruent': 1, 'same': False}, 'dst': {'type': 'addresses_A', 'congruent': 4, 'same': False}}
...
{'OP': 'LOAD', 'src': {'type': 'addresses_normal_ht', 'size': 2, 'AVXalign': False, 'NT': True, 'congruent': 0, 'same': False}}
{'36': 20417}
