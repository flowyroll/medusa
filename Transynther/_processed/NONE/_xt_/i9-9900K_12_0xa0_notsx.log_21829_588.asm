...
nop
and $10190, %r11
lea addresses_WT_ht+0x11ebf, %r10
nop
cmp $20644, %rbp
movb $0x61, (%r10)
nop
...
nop
add $55593, %r10
lea addresses_D_ht+0x3fff, %rsi
lea addresses_D_ht+0xf207, %rdi
xor $47161, %rbp
mov $29, %rcx
rep movsw
nop
...
nop
and $404, %r12
lea addresses_WC_ht+0x116ff, %rsi
...
nop
sub $16206, %r15
lea addresses_D_ht+0x1a4cb, %rsi
lea addresses_WT_ht+0xeff, %rdi
nop
nop
nop
nop
...
nop
dec %rdx
lea addresses_WT_ht+0x7bff, %rbp
nop
nop
nop
dec %rdx
...
nop
and %r11, %r11
lea addresses_normal_ht+0xabbf, %r13
nop
nop
nop
nop
...
// REPMOV
mov $0xb7f, %rsi
lea addresses_normal+0xd8ff, %rdi
nop
nop
sub $37640, %rdx
mov $72, %rcx
...
// Store
lea addresses_normal+0x1914b, %rsi
nop
nop
nop
nop
...
{'src': {'type': 'addresses_P', 'congruent': 7, 'same': False}, 'OP': 'REPM', 'dst': {'type': 'addresses_normal', 'congruent': 7, 'same': False}}
...
{'OP': 'STOR', 'dst': {'type': 'addresses_normal_ht', 'AVXalign': False, 'size': 32, 'NT': False, 'same': True, 'congruent': 2}}
