...
push %rdx
push %rsi
lea addresses_UC_ht+0xc327, %rsi
lea addresses_A_ht+0x4b27, %rdi
nop
nop
nop
nop
...
nop
xor %rcx, %rcx
lea addresses_WT_ht+0x16f67, %rax
nop
inc %r10
...
nop
and %rax, %rax
lea addresses_D_ht+0x10ee7, %r11
nop
nop
xor %r12, %r12
movw $0x6162, (%r11)
...
nop
xor %rdi, %rdi
lea addresses_WT_ht+0xc6d7, %rsi
lea addresses_normal_ht+0x18aa7, %rdi
nop
nop
nop
sub $7189, %r11
...
nop
and $45426, %rcx
lea addresses_UC_ht+0x15359, %r11
nop
nop
nop
nop
...
nop
dec %r11
lea addresses_UC_ht+0x16ce7, %rsi
lea addresses_D_ht+0x15a8f, %rdi
nop
nop
nop
nop
...
// Faulty Load
lea addresses_normal+0xe6e7, %rbp
nop
sub $36040, %r9
movups (%rbp), %xmm2
vpextrq $1, %xmm2, %r15
...
{'src': {'type': 'addresses_UC', 'same': False, 'size': 4, 'congruent': 8, 'NT': False, 'AVXalign': True}, 'OP': 'LOAD'}
[Faulty Load]
...
{'src': {'type': 'addresses_WT_ht', 'congruent': 3, 'same': False}, 'dst': {'type': 'addresses_normal_ht', 'congruent': 6, 'same': False}, 'OP': 'REPM'}
{'dst': {'type': 'addresses_UC_ht', 'same': False, 'size': 16, 'congruent': 1, 'NT': False, 'AVXalign': False}, 'OP': 'STOR'}
{'src': {'type': 'addresses_UC_ht', 'congruent': 8, 'same': False}, 'dst': {'type': 'addresses_D_ht', 'congruent': 3, 'same': False}, 'OP': 'REPM'}
{'34': 21829}
