...
nop
xor $21254, %r13
lea addresses_A_ht+0x13bc6, %rcx
nop
nop
nop
dec %r10
...
nop
and $25872, %r11
lea addresses_A_ht+0x163a6, %r11
nop
nop
nop
sub %rdi, %rdi
...
nop
dec %r10
lea addresses_D_ht+0x18aa0, %rdi
nop
nop
nop
cmp %r11, %r11
...
{'OP': 'LOAD', 'src': {'type': 'addresses_A_ht', 'size': 32, 'AVXalign': False, 'NT': True, 'congruent': 7, 'same': False}}
...
{'OP': 'LOAD', 'src': {'type': 'addresses_D_ht', 'size': 4, 'AVXalign': True, 'NT': False, 'congruent': 0, 'same': True}}
{'36': 3664}
