...
push %rdx
push %rsi
lea addresses_normal_ht+0x7010, %r11
add $57629, %r10
...
nop
and $39789, %r15
lea addresses_WT_ht+0x1a688, %rdx
nop
sub $15303, %rax
movl $0x61626364, (%rdx)
nop
...
nop
dec %rax
lea addresses_normal_ht+0x16248, %rsi
nop
nop
nop
nop
...
nop
and $63062, %r11
lea addresses_normal_ht+0x17808, %rdi
nop
inc %r10
movw $0x6162, (%rdi)
nop
...
nop
sub $38949, %r10
lea addresses_UC_ht+0x9a08, %rsi
lea addresses_UC_ht+0x8700, %rdi
clflush (%rdi)
nop
nop
nop
...
rep movsl
xor %rdi, %rdi
lea addresses_normal_ht+0x19608, %r10
inc %rax
movb $0x61, (%r10)
add $15727, %r11
lea addresses_UC_ht+0x14be0, %r10
nop
and $2739, %rcx
...
// Faulty Load
lea addresses_normal+0x12608, %r9
nop
nop
nop
nop
