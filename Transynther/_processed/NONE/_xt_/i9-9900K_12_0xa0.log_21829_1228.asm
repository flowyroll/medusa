...
push %rdx
push %rsi
lea addresses_WC_ht+0xb0fd, %r11
nop
sub $36040, %rdx
movw $0x6162, (%r11)
nop
...
nop
add $13449, %r13
lea addresses_D_ht+0xcd8d, %rsi
lea addresses_normal_ht+0x714d, %rdi
nop
xor %r15, %r15
mov $91, %rcx
rep movsb
...
nop
dec %r15
lea addresses_A_ht+0x1009d, %rcx
sub $28328, %rdi
...
nop
add %rcx, %rcx
lea addresses_D_ht+0xf7ad, %rsi
lea addresses_A_ht+0x11f8d, %rdi
nop
nop
inc %rdx
mov $46, %rcx
...
// Faulty Load
lea addresses_normal+0xc94d, %r13
nop
and $40466, %rax
mov (%r13), %r12d
lea oracles, %r13
...
<gen_faulty_load>
[REF]
{'src': {'NT': True, 'same': False, 'congruent': 0, 'type': 'addresses_normal', 'AVXalign': False, 'size': 8}, 'OP': 'LOAD'}
...
{'src': {'same': False, 'congruent': 5, 'type': 'addresses_D_ht'}, 'OP': 'REPM', 'dst': {'same': False, 'congruent': 6, 'type': 'addresses_A_ht'}}
{'34': 21829}
