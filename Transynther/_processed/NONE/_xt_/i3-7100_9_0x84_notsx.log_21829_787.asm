...
push %rdi
push %rsi
lea addresses_WC_ht+0xee23, %rsi
lea addresses_WC_ht+0x17623, %rdi
clflush (%rdi)
sub %r11, %r11
mov $17, %rcx
rep movsq
...
nop
and $34351, %rdi
lea addresses_normal_ht+0x96d3, %rbx
nop
sub $3571, %rsi
movw $0x6162, (%rbx)
add $30650, %rbp
...
// Store
lea addresses_normal+0x17bc7, %r14
nop
nop
and %rbx, %rbx
movw $0x5152, (%r14)
...
// Store
lea addresses_normal+0x196b3, %r12
cmp $29952, %rbx
movw $0x5152, (%r12)
nop
and $9743, %rax
...
// REPMOV
lea addresses_PSE+0x11063, %rsi
lea addresses_D+0x9683, %rdi
nop
dec %rax
mov $8, %rcx
rep movsq
...
// REPMOV
lea addresses_D+0x1bb23, %rsi
lea addresses_RW+0x111e3, %rdi
nop
nop
dec %rbx
mov $61, %rcx
...
// Store
lea addresses_A+0xf223, %rcx
add %rax, %rax
movl $0x51525354, (%rcx)
xor %rax, %rax

// Faulty Load
lea addresses_normal+0x1be23, %rsi
nop
xor %rbx, %rbx
vmovups (%rsi), %ymm7
...
{'src': {'type': 'addresses_D', 'same': False, 'size': 1, 'congruent': 7, 'NT': True, 'AVXalign': False}, 'OP': 'LOAD'}
{'dst': {'type': 'addresses_normal', 'same': False, 'size': 2, 'congruent': 4, 'NT': False, 'AVXalign': False}, 'OP': 'STOR'}
{'src': {'type': 'addresses_PSE', 'congruent': 2, 'same': False}, 'dst': {'type': 'addresses_D', 'congruent': 5, 'same': False}, 'OP': 'REPM'}
{'src': {'type': 'addresses_D', 'congruent': 8, 'same': False}, 'dst': {'type': 'addresses_RW', 'congruent': 4, 'same': False}, 'OP': 'REPM'}
