...
nop
xor %r11, %r11
lea addresses_WC_ht+0x15525, %rsi
lea addresses_A_ht+0x1a329, %rdi
nop
nop
inc %rbp
mov $116, %rcx
...
nop
sub $20045, %rsi
lea addresses_normal_ht+0x1d669, %rsi
nop
nop
nop
sub $30143, %r15
...
nop
dec %rbp
lea addresses_WC_ht+0x4849, %rcx
nop
nop
xor %r11, %r11
...
{'dst': {'type': 'addresses_WC_ht', 'same': False, 'size': 16, 'congruent': 5, 'NT': True, 'AVXalign': False}, 'OP': 'STOR'}
{'39': 21829}
