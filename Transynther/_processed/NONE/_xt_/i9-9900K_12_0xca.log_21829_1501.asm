...
push %rdx
push %rsi
lea addresses_normal_ht+0x10357, %rbx
inc %r10
...
nop
cmp $5781, %r15
lea addresses_WT_ht+0x1dfd7, %rbx
nop
cmp %rdi, %rdi
movl $0x61626364, (%rbx)
xor %r15, %r15
lea addresses_UC_ht+0x1a22f, %r10
nop
nop
nop
nop
...
nop
xor $8449, %rbx
lea addresses_normal_ht+0xd8c7, %rbx
nop
xor %r10, %r10
movw $0x6162, (%rbx)
xor %rdx, %rdx
lea addresses_A_ht+0x1f07, %rsi
lea addresses_WC_ht+0x18157, %rdi
nop
nop
dec %r15
mov $0, %rcx
...
nop
xor $57538, %rsi
lea addresses_WC_ht+0x40df, %rdi
nop
nop
nop
nop
...
nop
add $40067, %r10
lea addresses_UC_ht+0x1cb0f, %rbp
nop
inc %rdx
movw $0x6162, (%rbp)
nop
...
nop
sub $51167, %rcx
lea addresses_normal_ht+0x272b, %rsi
lea addresses_WC_ht+0x19d7, %rdi
nop
and $6381, %r15
mov $0, %rcx
rep movsb
...
nop
xor $40990, %rbx
lea addresses_WT_ht+0xb48f, %rsi
lea addresses_UC_ht+0x1c9d7, %rdi
clflush (%rdi)
nop
nop
xor $58370, %rbp
...
// Faulty Load
lea addresses_normal+0x29d7, %r9
xor $49226, %r14
vmovups (%r9), %ymm4
...
{'OP': 'LOAD', 'src': {'size': 4, 'NT': False, 'type': 'addresses_NC', 'same': False, 'AVXalign': False, 'congruent': 10}}
{'OP': 'STOR', 'dst': {'size': 16, 'NT': False, 'type': 'addresses_WT', 'same': False, 'AVXalign': False, 'congruent': 2}}
{'OP': 'LOAD', 'src': {'size': 8, 'NT': False, 'type': 'addresses_P', 'same': False, 'AVXalign': True, 'congruent': 0}}
{'OP': 'LOAD', 'src': {'size': 8, 'NT': False, 'type': 'addresses_P', 'same': False, 'AVXalign': False, 'congruent': 2}}
[Faulty Load]
...
{'OP': 'REPM', 'src': {'same': False, 'type': 'addresses_WT_ht', 'congruent': 3}, 'dst': {'same': False, 'type': 'addresses_UC_ht', 'congruent': 11}}
{'34': 21829}
