...
push %rdi
push %rsi
lea addresses_WC_ht+0x6317, %rdi
nop
nop
nop
nop
...
nop
xor $10855, %r9
lea addresses_UC_ht+0x627f, %rdi
nop
nop
nop
nop
...
nop
and $29192, %r12
lea addresses_WT_ht+0x1517, %r10
nop
and $39160, %rax
movb $0x61, (%r10)
nop
cmp $58728, %r9
lea addresses_UC_ht+0x7717, %r10
nop
nop
nop
nop
...
vmovups %ymm7, (%r10)
add $17630, %rdi
lea addresses_WT_ht+0x1edfb, %rsi
lea addresses_A_ht+0x5fb5, %rdi
nop
dec %r14
mov $7, %rcx
rep movsl
...
nop
inc %r10
lea addresses_WC_ht+0x1205, %rdi
nop
nop
nop
nop
...
nop
xor %r14, %r14
lea addresses_UC_ht+0x7857, %rsi
lea addresses_D_ht+0x1df17, %rdi
nop
nop
nop
nop
...
nop
dec %rdi
lea addresses_WT_ht+0xd917, %rax
nop
nop
nop
nop
...
nop
xor $34083, %r14
lea addresses_normal_ht+0xf17, %r12
nop
nop
nop
add %rcx, %rcx
...
// Faulty Load
lea addresses_normal+0x8717, %r15
nop
nop
nop
nop
...
{'OP': 'STOR', 'dst': {'same': False, 'congruent': 5, 'NT': True, 'type': 'addresses_WC', 'size': 8, 'AVXalign': False}}
{'src': {'type': 'addresses_P', 'congruent': 9, 'same': False}, 'OP': 'REPM', 'dst': {'type': 'addresses_WT', 'congruent': 10, 'same': False}}
[Faulty Load]
...
{'OP': 'STOR', 'dst': {'same': False, 'congruent': 7, 'NT': False, 'type': 'addresses_WT_ht', 'size': 1, 'AVXalign': True}}
{'OP': 'STOR', 'dst': {'same': False, 'congruent': 11, 'NT': False, 'type': 'addresses_UC_ht', 'size': 32, 'AVXalign': False}}
{'src': {'type': 'addresses_WT_ht', 'congruent': 1, 'same': False}, 'OP': 'REPM', 'dst': {'type': 'addresses_A_ht', 'congruent': 1, 'same': True}}
...
{'OP': 'STOR', 'dst': {'same': True, 'congruent': 11, 'NT': True, 'type': 'addresses_normal_ht', 'size': 2, 'AVXalign': False}}
{'34': 21829}
