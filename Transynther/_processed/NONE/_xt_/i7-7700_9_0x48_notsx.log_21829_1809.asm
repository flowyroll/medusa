...
lea addresses_UC_ht+0x18c52, %rdi
nop
nop
nop
nop
...
// Store
lea addresses_normal+0x1b4d4, %rdx
and $245, %r11
mov $0x5152535455565758, %rsi
movq %rsi, (%rdx)
nop
...
// Faulty Load
lea addresses_normal+0x12c52, %rdi
nop
nop
nop
xor $38658, %rsi
