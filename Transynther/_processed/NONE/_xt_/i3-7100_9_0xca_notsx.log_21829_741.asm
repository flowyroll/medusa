...
push %rdi
push %rsi
lea addresses_WT_ht+0x7451, %rsi
lea addresses_normal_ht+0x6f1, %rdi
nop
nop
sub %r13, %r13
mov $55, %rcx
...
nop
cmp $49976, %r9
lea addresses_WT_ht+0x1cfb1, %rsi
lea addresses_UC_ht+0x1cb1, %rdi
nop
nop
inc %r9
mov $108, %rcx
...
nop
sub $43612, %rdi
lea addresses_WC_ht+0x18ff1, %rax
nop
nop
inc %rdi
mov (%rax), %r9d
...
nop
add $61625, %rdi
lea addresses_WC_ht+0x93f1, %rdi
nop
sub %r12, %r12
mov (%rdi), %esi
xor $53214, %rax
lea addresses_normal_ht+0x3e71, %r9
nop
nop
nop
nop
...
nop
dec %rsi
lea addresses_D_ht+0x16f31, %r12
cmp $42474, %rax
...
nop
cmp $23771, %rdi
lea addresses_A_ht+0x1c3f1, %rax
clflush (%rax)
nop
nop
nop
...
nop
sub %r9, %r9
lea addresses_UC_ht+0x93f1, %r12
nop
nop
nop
add %r13, %r13
...
// REPMOV
lea addresses_A+0x1b7d5, %rsi
lea addresses_WT+0x1208f, %rdi
clflush (%rsi)
nop
nop
nop
...
{'src': {'type': 'addresses_A', 'congruent': 2, 'same': False}, 'OP': 'REPM', 'dst': {'type': 'addresses_WT', 'congruent': 1, 'same': False}}
[Faulty Load]
...
{'src': {'same': True, 'congruent': 10, 'NT': False, 'type': 'addresses_WC_ht', 'size': 4, 'AVXalign': False}, 'OP': 'LOAD'}
{'src': {'same': True, 'congruent': 9, 'NT': False, 'type': 'addresses_WC_ht', 'size': 4, 'AVXalign': False}, 'OP': 'LOAD'}
{'OP': 'STOR', 'dst': {'same': True, 'congruent': 7, 'NT': False, 'type': 'addresses_normal_ht', 'size': 4, 'AVXalign': True}}
