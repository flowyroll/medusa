...
push %rdi
push %rsi
lea addresses_WC_ht+0x7a7e, %rsi
lea addresses_D_ht+0x115f8, %rdi
nop
nop
nop
nop
...
nop
add $10044, %rbp
lea addresses_UC_ht+0x1207e, %r10
nop
nop
nop
nop
...
nop
inc %rbp
lea addresses_WT_ht+0xd2e8, %rcx
clflush (%rcx)
nop
nop
nop
...
nop
dec %r12
lea addresses_A_ht+0x1056, %rsi
lea addresses_normal_ht+0x807e, %rdi
clflush (%rsi)
nop
xor %r14, %r14
mov $90, %rcx
...
nop
xor %rbp, %rbp
lea addresses_WC_ht+0x1441e, %rsi
xor %r12, %r12
movb (%rsi), %r14b
nop
and $17599, %rdi
...
nop
xor %rdi, %rdi
lea addresses_UC_ht+0x36c6, %rcx
cmp $14097, %rbp
movb (%rcx), %r14b
nop
nop
nop
dec %r9
lea addresses_D_ht+0x147c6, %rcx
nop
nop
and %r12, %r12
movb $0x61, (%rcx)
...
nop
add %r14, %r14
lea addresses_D_ht+0x1714e, %rsi
lea addresses_D_ht+0x13dbe, %rdi
nop
xor %r14, %r14
mov $26, %rcx
rep movsl
