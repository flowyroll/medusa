...
push %rcx
push %rdx
lea addresses_D_ht+0x14ccd, %rcx
nop
nop
nop
nop
...
nop
add %rbp, %rbp
lea addresses_WT_ht+0x110cd, %rcx
and %rdx, %rdx
movb (%rcx), %bl
nop
sub $25903, %rcx
lea addresses_A_ht+0x198cd, %rcx
nop
nop
nop
nop
...
nop
xor $2156, %r11
lea addresses_normal_ht+0x6fcd, %r11
cmp %rdx, %rdx
movb $0x61, (%r11)
sub $56330, %r11
pop %rdx
...
// Load
lea addresses_normal+0x3ccd, %rsi
nop
nop
xor %r12, %r12
movb (%rsi), %cl
...
// Faulty Load
lea addresses_normal+0x3ccd, %r14
add %rbx, %rbx
movups (%r14), %xmm4
vpextrq $0, %xmm4, %r9
lea oracles, %r12
