...
nop
dec %r8
lea addresses_WC_ht+0x191f5, %rsi
nop
nop
nop
inc %rdi
...
nop
add %rcx, %rcx
lea addresses_normal_ht+0x18c45, %rsi
lea addresses_WC_ht+0x89c7, %rdi
nop
nop
nop
sub $10681, %r13
...
nop
and %r13, %r13
lea addresses_normal_ht+0x13755, %rsi
...
nop
cmp $60945, %rsi
lea addresses_WT_ht+0x15145, %r13
add $16050, %rdi
...
{'OP': 'STOR', 'dst': {'type': 'addresses_UC_ht', 'AVXalign': True, 'congruent': 11, 'size': 1, 'same': False, 'NT': False}}
