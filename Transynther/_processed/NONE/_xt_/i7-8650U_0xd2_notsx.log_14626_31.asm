...
push %rdi
push %rsi
lea addresses_WT_ht+0x8ea3, %rsi
lea addresses_WC_ht+0x5051, %rdi
nop
nop
nop
nop
...
nop
cmp $25449, %r9
lea addresses_A_ht+0x11485, %rsi
lea addresses_normal_ht+0x1490b, %rdi
nop
nop
nop
nop
...
nop
sub $10368, %r12
lea addresses_normal_ht+0x1ac23, %rsi
lea addresses_normal_ht+0xc20b, %rdi
clflush (%rdi)
cmp $35895, %r9
mov $90, %rcx
rep movsw
...
// REPMOV
lea addresses_PSE+0x7623, %rsi
lea addresses_A+0x15c63, %rdi
clflush (%rdi)
and %rdx, %rdx
mov $36, %rcx
rep movsb
...
{'OP': 'REPM', 'src': {'type': 'addresses_PSE', 'congruent': 0, 'same': True}, 'dst': {'type': 'addresses_A', 'congruent': 6, 'same': False}}
[Faulty Load]
