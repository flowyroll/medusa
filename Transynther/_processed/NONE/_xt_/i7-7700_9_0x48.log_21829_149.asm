...
nop
cmp %rcx, %rcx
lea addresses_WC_ht+0x120af, %rsi
lea addresses_UC_ht+0x171e7, %rdi
nop
nop
nop
nop
...
nop
sub %r9, %r9
lea addresses_WC_ht+0x67ff, %rsi
lea addresses_A_ht+0x61af, %rdi
nop
nop
cmp $65126, %rdx
mov $21, %rcx
...
nop
cmp %r15, %r15
lea addresses_A_ht+0x107af, %rdi
nop
nop
nop
nop
...
nop
inc %rdi
lea addresses_WT_ht+0x1d5af, %rdx
nop
sub $4497, %rdi
movb $0x61, (%rdx)
nop
...
nop
xor %r15, %r15
lea addresses_WT_ht+0xa693, %rdi
nop
add $48587, %rsi
movw $0x6162, (%rdi)
nop
dec %r9
lea addresses_normal_ht+0x1d42f, %rsi
lea addresses_normal_ht+0x1762f, %rdi
nop
xor $32914, %r11
mov $7, %rcx
rep movsb
...
nop
cmp %rdx, %rdx
lea addresses_UC_ht+0x1ca27, %rsi
lea addresses_normal_ht+0x6eef, %rdi
clflush (%rsi)
nop
nop
cmp $33894, %r11
...
rep movsq
inc %rcx
lea addresses_WC_ht+0x156d9, %rdi
nop
nop
nop
nop
...
movw $0x6162, (%rdi)
xor %rcx, %rcx
lea addresses_normal_ht+0xd6af, %rbx
nop
nop
nop
nop
...
nop
dec %rbx
lea addresses_normal_ht+0x14141, %rsi
lea addresses_WC_ht+0x1606f, %rdi
clflush (%rdi)
nop
xor %r15, %r15
mov $36, %rcx
...
nop
xor %r15, %r15
lea addresses_WT_ht+0x6f93, %rsi
lea addresses_WC_ht+0x3777, %rdi
nop
nop
nop
sub %rdx, %rdx
...
{'OP': 'REPM', 'src': {'type': 'addresses_WC_ht', 'congruent': 8, 'same': False}, 'dst': {'type': 'addresses_UC_ht', 'congruent': 3, 'same': False}}
{'OP': 'REPM', 'src': {'type': 'addresses_WC_ht', 'congruent': 3, 'same': False}, 'dst': {'type': 'addresses_A_ht', 'congruent': 4, 'same': True}}
