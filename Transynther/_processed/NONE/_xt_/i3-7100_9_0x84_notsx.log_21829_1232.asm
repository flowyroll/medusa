...
push %rdi
push %rsi
lea addresses_WT_ht+0xc00d, %rsi
lea addresses_normal_ht+0x1e7e5, %rdi
nop
sub $22718, %r8
mov $50, %rcx
rep movsb
add %r14, %r14
lea addresses_WC_ht+0xa8c1, %r13
nop
nop
nop
nop
...
{'dst': {'type': 'addresses_WC', 'same': False, 'size': 4, 'congruent': 2, 'NT': True, 'AVXalign': False}, 'OP': 'STOR'}
[Faulty Load]
...
{'dst': {'type': 'addresses_WT_ht', 'same': False, 'size': 8, 'congruent': 7, 'NT': True, 'AVXalign': False}, 'OP': 'STOR'}
