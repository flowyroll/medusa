...
push %rdi
push %rsi
lea addresses_WT_ht+0x2b1e, %rsi
lea addresses_UC_ht+0x1da1e, %rdi
nop
nop
nop
nop
...
nop
and %rax, %rax
lea addresses_WT_ht+0x8a1e, %rsi
lea addresses_D_ht+0xf21e, %rdi
clflush (%rsi)
nop
nop
nop
...
nop
dec %rbp
lea addresses_WT_ht+0x1a31e, %rsi
nop
nop
nop
mfence
...
nop
and %r13, %r13
lea addresses_WT_ht+0x421e, %rsi
lea addresses_WT_ht+0x609e, %rdi
nop
nop
nop
sub $29763, %r12
...
{'src': {'type': 'addresses_WT_ht', 'congruent': 11, 'same': False}, 'OP': 'REPM', 'dst': {'type': 'addresses_WT_ht', 'congruent': 7, 'same': False}}
{'38': 21829}
