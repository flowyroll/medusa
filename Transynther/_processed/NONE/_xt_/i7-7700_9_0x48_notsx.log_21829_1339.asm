...
nop
sub %r14, %r14
lea addresses_WT_ht+0x1503f, %r14
nop
nop
nop
nop
...
nop
and %r15, %r15
lea addresses_A_ht+0x15e81, %rsi
lea addresses_UC_ht+0x1e941, %rdi
clflush (%rsi)
add %rdx, %rdx
mov $93, %rcx
rep movsw
nop
xor %rbp, %rbp
lea addresses_WT_ht+0xdc01, %rsi
lea addresses_WT_ht+0x11801, %rdi
nop
nop
sub %rbp, %rbp
mov $56, %rcx
...
nop
and $50351, %rdi
lea addresses_WC_ht+0x11f01, %r15
and $19012, %rsi
movl $0x61626364, (%r15)
nop
nop
nop
add $47912, %r15
lea addresses_WT_ht+0x19fe1, %rdi
nop
inc %rcx
movups (%rdi), %xmm5
vpextrq $1, %xmm5, %r14
dec %rdi
lea addresses_normal_ht+0x4c01, %rsi
clflush (%rsi)
nop
nop
cmp $46848, %r15
...
nop
cmp $10992, %rdi
lea addresses_WC_ht+0xc401, %r11
nop
nop
nop
nop
...
movw $0x6162, (%r11)
add %rdi, %rdi
lea addresses_WT_ht+0x18081, %r14
nop
nop
nop
add $1980, %rcx
...
nop
xor $24858, %rcx
lea addresses_WT_ht+0x6d55, %rsi
lea addresses_WT_ht+0x5dad, %rdi
nop
nop
sub $23238, %rdx
mov $72, %rcx
...
// Faulty Load
lea addresses_normal+0x9401, %r14
nop
nop
nop
nop
...
{'dst': {'same': True, 'congruent': 10, 'type': 'addresses_WT_ht'}, 'OP': 'REPM', 'src': {'same': False, 'congruent': 10, 'type': 'addresses_WT_ht'}}
...
{'OP': 'LOAD', 'src': {'same': False, 'NT': True, 'AVXalign': False, 'size': 32, 'type': 'addresses_WT_ht', 'congruent': 6}}
{'dst': {'same': False, 'congruent': 1, 'type': 'addresses_WT_ht'}, 'OP': 'REPM', 'src': {'same': False, 'congruent': 2, 'type': 'addresses_WT_ht'}}
{'34': 21829}
