...
nop
inc %rdi
lea addresses_A_ht+0x15c19, %rdx
nop
xor $33689, %rdi
movb $0x61, (%rdx)
nop
add %r13, %r13
lea addresses_A_ht+0xf969, %rsi
lea addresses_WC_ht+0xa2e5, %rdi
nop
nop
nop
nop
