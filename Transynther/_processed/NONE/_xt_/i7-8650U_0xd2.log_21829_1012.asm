...
push %rdx
push %rsi
lea addresses_WC_ht+0x1b8bf, %r8
sub $46024, %rbx
...
nop
sub %r15, %r15
lea addresses_normal_ht+0xe11b, %rdx
nop
nop
nop
nop
...
vpextrq $0, %xmm2, %r10
sub %r10, %r10
lea addresses_WC_ht+0x17edf, %rdx
nop
nop
nop
nop
...
nop
and %r14, %r14
lea addresses_A_ht+0x141c5, %rsi
lea addresses_normal_ht+0x12e5f, %rdi
nop
and $22836, %r10
mov $109, %rcx
rep movsw
...
nop
cmp $13706, %rbx
lea addresses_normal_ht+0xb25f, %rsi
nop
nop
nop
nop
...
nop
xor $61585, %r14
lea addresses_A_ht+0x1a65f, %r14
nop
nop
nop
nop
...
// Faulty Load
lea addresses_normal+0x625f, %r9
nop
and $6545, %rdx
movups (%r9), %xmm0
vpextrq $1, %xmm0, %r15
...
{'OP': 'REPM', 'src': {'type': 'addresses_A_ht', 'congruent': 0, 'same': True}, 'dst': {'type': 'addresses_normal_ht', 'congruent': 7, 'same': False}}
