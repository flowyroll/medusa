...
push %rdx
push %rsi
lea addresses_WC_ht+0x175f0, %r14
nop
nop
nop
nop
...
nop
cmp $64533, %rdi
lea addresses_WT_ht+0x56f0, %rsi
...
nop
cmp $37540, %r11
lea addresses_A_ht+0xc2b4, %rsi
lea addresses_A_ht+0x13e30, %rdi
nop
nop
xor %rax, %rax
mov $117, %rcx
rep movsl
xor %r11, %r11
lea addresses_D_ht+0x8780, %rsi
lea addresses_WC_ht+0x1c7a4, %rdi
nop
nop
nop
nop
...
nop
and %rax, %rax
lea addresses_normal_ht+0x16e30, %rsi
lea addresses_normal_ht+0x40be, %rdi
nop
nop
dec %r11
mov $118, %rcx
...
// Store
lea addresses_normal+0x10074, %rbp
nop
nop
nop
nop
...
// Faulty Load
lea addresses_normal+0x16df0, %rsi
nop
nop
xor %r12, %r12
mov (%rsi), %r15
...
{'src': {'type': 'addresses_A_ht', 'congruent': 0, 'same': False}, 'dst': {'type': 'addresses_A_ht', 'congruent': 6, 'same': True}, 'OP': 'REPM'}
