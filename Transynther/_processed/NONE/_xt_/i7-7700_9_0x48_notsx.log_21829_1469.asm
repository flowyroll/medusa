...
push %rdi
push %rsi
lea addresses_WC_ht+0x1086a, %r11
nop
nop
nop
add %rbp, %rbp
...
nop
and %r12, %r12
lea addresses_normal_ht+0x5bea, %rsi
nop
nop
nop
cmp %rcx, %rcx
...
nop
and %r12, %r12
lea addresses_D_ht+0x18e9f, %rsi
lea addresses_WC_ht+0x125ea, %rdi
nop
nop
nop
nop
...
lea addresses_WT_ht+0x1e8aa, %rdi
nop
nop
nop
add $11571, %r10
...
nop
sub $29741, %rdi
lea addresses_WT_ht+0xbbba, %rsi
lea addresses_WT_ht+0x140ea, %rdi
nop
nop
xor $56274, %rbp
mov $84, %rcx
...
nop
xor %r12, %r12
lea addresses_A_ht+0x1943a, %rbp
clflush (%rbp)
nop
nop
nop
...
nop
add %r12, %r12
lea addresses_UC_ht+0xe5ea, %r12
nop
xor %rcx, %rcx
...
nop
and $4617, %r11
lea addresses_WT_ht+0x18e9a, %rsi
lea addresses_WC_ht+0x6fe0, %rdi
nop
nop
nop
nop
...
nop
and $27315, %r10
lea addresses_WC_ht+0x122c4, %r12
nop
nop
nop
nop
...
{'dst': {'same': False, 'congruent': 8, 'type': 'addresses_WC_ht'}, 'OP': 'REPM', 'src': {'same': False, 'congruent': 0, 'type': 'addresses_D_ht'}}
...
{'dst': {'same': False, 'congruent': 1, 'type': 'addresses_WC_ht'}, 'OP': 'REPM', 'src': {'same': False, 'congruent': 3, 'type': 'addresses_WT_ht'}}
{'OP': 'LOAD', 'src': {'same': False, 'NT': False, 'AVXalign': False, 'size': 4, 'type': 'addresses_WC_ht', 'congruent': 1}}
{'dst': {'same': True, 'NT': True, 'AVXalign': False, 'size': 16, 'type': 'addresses_WC_ht', 'congruent': 1}, 'OP': 'STOR'}
{'39': 21829}
