...
push %rdi
push %rsi
lea addresses_WC_ht+0x15e6f, %rbx
nop
nop
nop
xor $11657, %r13
...
nop
xor %r11, %r11
lea addresses_A_ht+0x1253f, %rsi
lea addresses_normal_ht+0x1ee9f, %rdi
cmp $36317, %r14
mov $88, %rcx
rep movsq
and $9612, %rcx
lea addresses_D_ht+0x11c4f, %rsi
lea addresses_normal_ht+0x178ef, %rdi
nop
and $17596, %r10
mov $3, %rcx
rep movsl
...
nop
cmp %r14, %r14
lea addresses_WC_ht+0x513f, %rsi
lea addresses_D_ht+0x1993f, %rdi
nop
nop
add %r11, %r11
mov $17, %rcx
...
// REPMOV
lea addresses_D+0x1e53f, %rsi
lea addresses_UC+0xf80f, %rdi
nop
nop
nop
nop
...
{'src': {'type': 'addresses_D', 'congruent': 4, 'same': False}, 'dst': {'type': 'addresses_UC', 'congruent': 4, 'same': False}, 'OP': 'REPM'}
