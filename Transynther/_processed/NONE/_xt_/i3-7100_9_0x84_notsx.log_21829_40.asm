...
nop
xor %rax, %rax
lea addresses_A_ht+0x16028, %r11
nop
nop
nop
nop
...
// REPMOV
lea addresses_normal+0x8428, %rsi
lea addresses_UC+0xdb28, %rdi
nop
nop
nop
nop
...
// Faulty Load
lea addresses_normal+0xe828, %rdi
nop
nop
nop
nop
...
{'src': {'type': 'addresses_normal', 'congruent': 8, 'same': False}, 'dst': {'type': 'addresses_UC', 'congruent': 8, 'same': True}, 'OP': 'REPM'}
