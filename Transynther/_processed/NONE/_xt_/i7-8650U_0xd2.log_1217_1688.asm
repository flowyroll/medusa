...
push %rdx
push %rsi
lea addresses_A_ht+0x146ff, %rsi
lea addresses_WT_ht+0xe3cf, %rdi
nop
add %rdx, %rdx
mov $57, %rcx
rep movsl
xor %r15, %r15
lea addresses_WT_ht+0x1b1e7, %rsi
lea addresses_D_ht+0x51b7, %rdi
clflush (%rsi)
nop
nop
nop
...
rep movsb
cmp $23602, %rdi
lea addresses_normal_ht+0xacc7, %rsi
lea addresses_WT_ht+0x2547, %rdi
nop
nop
nop
nop
...
nop
add $57169, %rsi
lea addresses_WC_ht+0x1070d, %r10
sub %r11, %r11
mov (%r10), %rdx
nop
nop
...
nop
dec %rsi
lea addresses_D_ht+0x1d7e7, %rsi
lea addresses_D_ht+0x12097, %rdi
nop
nop
nop
nop
...
nop
and $13102, %r10
lea addresses_WT_ht+0x1029f, %rcx
clflush (%rcx)
nop
nop
nop
...
nop
xor $15884, %rcx
lea addresses_A_ht+0x1b3e7, %r15
nop
add $63304, %r11
mov (%r15), %cx
nop
