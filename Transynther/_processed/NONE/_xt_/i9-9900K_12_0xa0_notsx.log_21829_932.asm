...
nop
sub %r14, %r14
lea addresses_normal_ht+0x2b60, %rdx
clflush (%rdx)
add %rbx, %rbx
vmovups (%rdx), %ymm2
...
// Load
lea addresses_normal+0x7cf4, %rbx
nop
nop
nop
cmp %rsi, %rsi
...
// Faulty Load
lea addresses_normal+0x7cf4, %rsi
nop
nop
and %rcx, %rcx
vmovups (%rsi), %ymm2
...
{'src': {'type': 'addresses_D', 'AVXalign': False, 'size': 4, 'NT': False, 'same': False, 'congruent': 4}, 'OP': 'LOAD'}
[Faulty Load]
