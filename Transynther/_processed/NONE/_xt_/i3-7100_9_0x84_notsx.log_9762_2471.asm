...
push %rdx
push %rsi
lea addresses_WC_ht+0x5ccd, %r11
nop
add $32171, %r8
movl $0x61626364, (%r11)
nop
...
nop
and %r12, %r12
lea addresses_A_ht+0x1b04d, %r14
nop
inc %rax
movups (%r14), %xmm4
vpextrq $1, %xmm4, %r8
...
nop
dec %r14
lea addresses_normal_ht+0x2bcd, %r14
nop
nop
inc %rsi
...
nop
and %r11, %r11
lea addresses_normal_ht+0x9bcd, %rax
nop
nop
nop
sub %r12, %r12
...
nop
and %r12, %r12
lea addresses_normal_ht+0x6fd5, %rsi
clflush (%rsi)
nop
nop
nop
