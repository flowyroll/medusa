...
push %rdx
push %rsi
lea addresses_D_ht+0x3e44, %rsi
lea addresses_UC_ht+0x1ebe4, %rdi
nop
add %rdx, %rdx
mov $121, %rcx
rep movsb
...
nop
and $44003, %r15
lea addresses_D_ht+0x62e4, %rsi
lea addresses_WT_ht+0x1dc78, %rdi
nop
nop
nop
and %r12, %r12
...
nop
xor %rcx, %rcx
lea addresses_WC_ht+0x123a2, %r15
nop
nop
nop
nop
...
nop
add %rdi, %rdi
lea addresses_D_ht+0x1dbe4, %r15
nop
cmp $37537, %r12
mov (%r15), %edi
inc %rdi
...
{'OP': 'LOAD', 'src': {'type': 'addresses_WT', 'AVXalign': False, 'congruent': 5, 'size': 8, 'same': False, 'NT': True}}
[Faulty Load]
{'OP': 'LOAD', 'src': {'type': 'addresses_D', 'AVXalign': False, 'congruent': 0, 'size': 16, 'same': True, 'NT': False}}
<gen_prepare_buffer>
{'OP': 'REPM', 'src': {'type': 'addresses_D_ht', 'congruent': 3, 'same': False}, 'dst': {'type': 'addresses_UC_ht', 'congruent': 7, 'same': False}}
