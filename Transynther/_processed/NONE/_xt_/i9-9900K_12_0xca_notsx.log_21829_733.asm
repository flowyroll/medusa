...
push %rbp
push %rdi
lea addresses_D_ht+0x12a94, %r14
nop
nop
nop
nop
...
// Store
lea addresses_WT+0x5a39, %rsi
cmp %rax, %rax
movl $0x51525354, (%rsi)
inc %r8

// Store
lea addresses_D+0x5c23, %rax
clflush (%rax)
nop
nop
nop
...
{'OP': 'STOR', 'dst': {'same': False, 'type': 'addresses_D', 'NT': False, 'AVXalign': True, 'size': 4, 'congruent': 3}}
...
{'OP': 'LOAD', 'src': {'same': True, 'type': 'addresses_PSE', 'NT': False, 'AVXalign': False, 'size': 16, 'congruent': 0}}
<gen_prepare_buffer>
{'OP': 'STOR', 'dst': {'same': False, 'type': 'addresses_D_ht', 'NT': False, 'AVXalign': True, 'size': 4, 'congruent': 0}}
{'33': 21829}
