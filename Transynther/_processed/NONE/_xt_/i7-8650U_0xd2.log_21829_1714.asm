...
push %rdi
push %rsi
lea addresses_A_ht+0x13679, %rbp
nop
nop
nop
nop
...
nop
and $42450, %r15
lea addresses_UC_ht+0x193b9, %rsi
lea addresses_UC_ht+0xf7b9, %rdi
clflush (%rdi)
nop
nop
nop
...
nop
and $42212, %r15
lea addresses_WT_ht+0x66b9, %rsi
lea addresses_UC_ht+0xe3a1, %rdi
nop
nop
nop
nop
...
nop
add $63876, %rdi
lea addresses_UC_ht+0x54b9, %rsi
...
rep movsw
sub %rsi, %rsi
lea addresses_D_ht+0x3559, %rsi
lea addresses_WT_ht+0x1161, %rdi
nop
nop
nop
and %rax, %rax
...
nop
add %rdi, %rdi
lea addresses_normal_ht+0x187b9, %rcx
nop
nop
nop
cmp %rdi, %rdi
movb $0x61, (%rcx)
cmp %rdi, %rdi
lea addresses_A_ht+0x11cb9, %r13
clflush (%r13)
nop
nop
xor $60537, %rcx
...
nop
add $20943, %rbp
lea addresses_D_ht+0x12b68, %rax
nop
nop
xor $58321, %rbp
movups (%rax), %xmm4
...
{'OP': 'STOR', 'dst': {'type': 'addresses_RW', 'size': 1, 'AVXalign': True, 'NT': False, 'congruent': 9, 'same': False}}
...
{'OP': 'REPM', 'src': {'type': 'addresses_D_ht', 'congruent': 5, 'same': True}, 'dst': {'type': 'addresses_WT_ht', 'congruent': 3, 'same': False}}
