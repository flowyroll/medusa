...
push %rdx
push %rsi
lea addresses_D_ht+0x9b12, %rcx
inc %r13
mov (%rcx), %rsi
nop
add $2164, %rdx
lea addresses_D_ht+0x1e0de, %rsi
nop
nop
nop
xor %rdx, %rdx
...
nop
sub $12216, %rdx
lea addresses_D_ht+0x114b2, %r14
nop
nop
nop
nop
...
nop
cmp %rax, %rax
lea addresses_WT_ht+0x13362, %rdx
nop
nop
cmp $55960, %rsi
mov (%rdx), %r11w
...
// Faulty Load
lea addresses_normal+0x15712, %rsi
nop
nop
nop
sub %rbx, %rbx
...
{'OP': 'LOAD', 'src': {'type': 'addresses_PSE', 'size': 2, 'AVXalign': False, 'NT': True, 'congruent': 2, 'same': False}}
{'OP': 'LOAD', 'src': {'type': 'addresses_D', 'size': 16, 'AVXalign': False, 'NT': False, 'congruent': 2, 'same': False}}
[Faulty Load]
