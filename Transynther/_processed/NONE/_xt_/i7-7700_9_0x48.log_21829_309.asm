...
nop
add %r14, %r14
lea addresses_WT_ht+0x1ae13, %r10
nop
nop
nop
nop
...
nop
cmp $41249, %rax
lea addresses_A_ht+0x2713, %rsi
lea addresses_normal_ht+0x1b713, %rdi
dec %r14
mov $95, %rcx
rep movsb
nop
...
nop
add %r14, %r14
lea addresses_normal_ht+0x7f1f, %rsi
...
rep movsb
add $53842, %r9
lea addresses_UC_ht+0x2d13, %r12
nop
nop
nop
nop
...
mov (%r12), %rsi
sub %r9, %r9
lea addresses_WC_ht+0xd893, %rsi
lea addresses_WC_ht+0x18113, %rdi
clflush (%rdi)
add $2708, %r9
mov $36, %rcx
rep movsw
...
nop
add $52958, %r12
lea addresses_normal_ht+0x125cf, %rcx
cmp $43512, %r9
movups (%rcx), %xmm5
vpextrq $1, %xmm5, %rax
nop
...
nop
add %r9, %r9
lea addresses_WC_ht+0x1e113, %r9
nop
nop
xor %rsi, %rsi
...
{'OP': 'STOR', 'dst': {'type': 'addresses_RW', 'AVXalign': True, 'congruent': 5, 'size': 1, 'same': False, 'NT': False}}
