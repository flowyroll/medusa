...
nop
and $49895, %r10
lea addresses_UC_ht+0x1b0a7, %r12
clflush (%r12)
nop
nop
nop
...
nop
sub $11537, %r15
lea addresses_D_ht+0x16887, %rbp
nop
nop
nop
inc %r13
movw $0x6162, (%rbp)
inc %r8
lea addresses_A_ht+0x1c027, %rsi
lea addresses_D_ht+0x1a0e7, %rdi
nop
nop
nop
nop
...
rep movsl
sub $44327, %r13
lea addresses_normal_ht+0x1b295, %rdx
nop
nop
inc %r15
movl $0x61626364, (%rdx)
...
// Store
lea addresses_normal+0xe504, %rdx
nop
nop
nop
xor %rcx, %rcx
...
{'src': {'type': 'addresses_A_ht', 'congruent': 11, 'same': False}, 'dst': {'type': 'addresses_D_ht', 'congruent': 5, 'same': True}, 'OP': 'REPM'}
