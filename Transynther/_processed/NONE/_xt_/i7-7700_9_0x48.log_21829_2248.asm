...
push %rdi
push %rsi
lea addresses_WT_ht+0x118d9, %rsi
nop
xor $63165, %r9
movw $0x6162, (%rsi)
nop
dec %rsi
lea addresses_WT_ht+0xfa9, %r14
nop
nop
and %r10, %r10
movb $0x61, (%r14)
...
nop
dec %r9
lea addresses_WT_ht+0x1e729, %rsi
lea addresses_D_ht+0x7b15, %rdi
sub $63487, %r12
mov $51, %rcx
rep movsw
nop
cmp %r10, %r10
lea addresses_UC_ht+0x1b2a9, %r13
nop
nop
nop
nop
...
nop
dec %rsi
lea addresses_WC_ht+0x9b89, %r9
and $49383, %r10
movw $0x6162, (%r9)
nop
nop
sub %rcx, %rcx
lea addresses_normal_ht+0x139e9, %r9
nop
nop
nop
nop
...
nop
sub %r9, %r9
lea addresses_normal_ht+0x18b61, %rcx
nop
nop
nop
nop
...
nop
xor %r10, %r10
lea addresses_D_ht+0x10c89, %r14
nop
nop
nop
nop
...
vpextrq $0, %xmm2, %r12
add %rsi, %rsi
lea addresses_A_ht+0xb009, %rsi
lea addresses_D_ht+0xd969, %rdi
nop
nop
nop
nop
...
nop
and %r13, %r13
lea addresses_normal_ht+0xb4e9, %rsi
lea addresses_A_ht+0x3929, %rdi
clflush (%rsi)
nop
nop
add $30847, %r9
...
{'OP': 'STOR', 'dst': {'type': 'addresses_normal_ht', 'AVXalign': False, 'congruent': 3, 'size': 1, 'same': False, 'NT': True}}
