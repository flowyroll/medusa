...
nop
xor %rax, %rax
lea addresses_WC_ht+0x149dd, %rsi
lea addresses_UC_ht+0x17629, %rdi
nop
nop
and $40510, %r11
mov $114, %rcx
...
nop
and %rax, %rax
lea addresses_normal_ht+0x159dd, %rdi
nop
nop
nop
add %r12, %r12
...
nop
and %r13, %r13
lea addresses_normal_ht+0xf959, %r11
nop
nop
nop
nop
...
{'OP': 'REPM', 'src': {'same': False, 'congruent': 10, 'type': 'addresses_WC_ht'}, 'dst': {'same': False, 'congruent': 1, 'type': 'addresses_UC_ht'}}
