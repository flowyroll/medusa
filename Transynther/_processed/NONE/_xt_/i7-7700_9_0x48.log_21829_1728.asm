...
nop
cmp %r8, %r8
lea addresses_WC_ht+0x1287f, %rdx
nop
nop
nop
nop
...
nop
and %rdx, %rdx
lea addresses_WT_ht+0x2775, %rsi
dec %rdi
movb (%rsi), %r14b
nop
xor $50773, %rsi
lea addresses_normal_ht+0x1c10d, %rcx
nop
add $37285, %r8
movups (%rcx), %xmm1
vpextrq $0, %xmm1, %rdi
...
nop
and %rdi, %rdi
lea addresses_normal_ht+0x878c, %rbp
nop
nop
and %rcx, %rcx
movl $0x61626364, (%rbp)
add %rsi, %rsi
lea addresses_D_ht+0x1d065, %rsi
lea addresses_D_ht+0xc7d5, %rdi
add $4445, %rbx
mov $15, %rcx
rep movsw
nop
...
nop
inc %rdi
lea addresses_WT_ht+0x4bb1, %rcx
nop
nop
add %rdx, %rdx
mov (%rcx), %r8w
...
mov (%rsi), %dx
cmp $44765, %r14
lea addresses_normal_ht+0x13bd5, %r8
nop
nop
sub $62246, %rdi
mov (%r8), %rbx
...
lea addresses_D_ht+0x156f3, %rdi
nop
sub $42852, %r8
mov $98, %rcx
rep movsw
...
nop
and %r8, %r8
lea addresses_WT_ht+0x12d95, %rsi
nop
nop
nop
nop
...
nop
xor %r8, %r8
lea addresses_D_ht+0x7395, %rsi
lea addresses_normal_ht+0xdd95, %rdi
nop
nop
nop
nop
...
// Store
lea addresses_WT+0x1dfd5, %r12
xor %r8, %r8
movb $0x51, (%r12)
cmp $40396, %r8

// Faulty Load
lea addresses_PSE+0x147d5, %r14
nop
and %rsi, %rsi
vmovups (%r14), %ymm1
...
{'OP': 'REPM', 'src': {'type': 'addresses_D_ht', 'congruent': 6, 'same': False}, 'dst': {'type': 'addresses_normal_ht', 'congruent': 5, 'same': False}}
{'33': 21829}
