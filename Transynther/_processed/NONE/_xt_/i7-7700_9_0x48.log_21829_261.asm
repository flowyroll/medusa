...
push %rcx
push %rdi
lea addresses_UC_ht+0x148cd, %r15
clflush (%r15)
nop
and $36830, %r11
movups (%r15), %xmm7
...
nop
sub $29864, %rbp
lea addresses_normal_ht+0x34cd, %rdi
nop
nop
sub $51190, %r15
...
nop
add %rdi, %rdi
lea addresses_WT_ht+0x1b2c7, %rbx
nop
xor %rcx, %rcx
movw $0x6162, (%rbx)
nop
...
nop
and %rdi, %rdi
lea addresses_WC_ht+0xb69d, %r11
sub %r10, %r10
movl $0x61626364, (%r11)
xor %rbp, %rbp
lea addresses_WT_ht+0x1254d, %rbx
sub %r11, %r11
vmovups (%rbx), %ymm0
...
{'OP': 'STOR', 'dst': {'type': 'addresses_PSE', 'AVXalign': True, 'congruent': 7, 'size': 16, 'same': False, 'NT': True}}
