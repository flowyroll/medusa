...
nop
add %rsi, %rsi
lea addresses_WC_ht+0x52fb, %rcx
nop
nop
nop
nop
...
// Store
lea addresses_normal+0x1971b, %r15
nop
nop
nop
sub %r14, %r14
...
{'dst': {'same': False, 'congruent': 7, 'type': 'addresses_US'}, 'OP': 'REPM', 'src': {'same': False, 'congruent': 6, 'type': 'addresses_P'}}
