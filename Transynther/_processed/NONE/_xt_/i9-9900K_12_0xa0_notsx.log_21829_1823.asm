...
nop
cmp $26117, %r15
lea addresses_D_ht+0x5f79, %rsi
lea addresses_WC_ht+0x2d79, %rdi
nop
nop
nop
nop
...
nop
and $35101, %rcx
lea addresses_normal_ht+0x8459, %rdi
nop
nop
cmp %rsi, %rsi
...
{'src': {'type': 'addresses_WT_ht', 'congruent': 6, 'same': False}, 'OP': 'REPM', 'dst': {'type': 'addresses_A_ht', 'congruent': 0, 'same': True}}
