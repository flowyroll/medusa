...
nop
and %r8, %r8
lea addresses_A_ht+0x9999, %rsi
lea addresses_D_ht+0x4139, %rdi
nop
cmp %r15, %r15
mov $112, %rcx
rep movsw
nop
inc %r15
lea addresses_A_ht+0xfd31, %rsi
lea addresses_A_ht+0x1db99, %rdi
nop
nop
nop
nop
...
nop
inc %r8
lea addresses_UC_ht+0xba19, %rcx
nop
and %rbx, %rbx
movl $0x61626364, (%rcx)
nop
...
nop
and $56538, %r8
lea addresses_A_ht+0x13f99, %rbx
clflush (%rbx)
sub $62994, %rcx
vmovups (%rbx), %ymm1
...
vpextrq $1, %xmm1, %r12
inc %rdi
lea addresses_A_ht+0x12c99, %r15
nop
nop
nop
nop
...
movl $0x61626364, (%r15)
xor %r12, %r12
lea addresses_A_ht+0x8399, %rsi
lea addresses_A_ht+0x6a91, %rdi
nop
nop
and $48029, %r15
mov $80, %rcx
rep movsb
xor %r15, %r15
lea addresses_UC_ht+0x2bb5, %r12
nop
inc %r8
movl $0x61626364, (%r12)
nop
nop
sub %rdi, %rdi
lea addresses_D_ht+0x1a619, %rcx
nop
nop
nop
and $9308, %r15
...
nop
xor %rcx, %rcx
lea addresses_WT_ht+0x5a19, %r8
nop
cmp $18770, %rsi
mov (%r8), %ebx
nop
sub %r8, %r8
lea addresses_WC_ht+0x19a19, %r12
nop
inc %rsi
movb (%r12), %cl
nop
...
{'OP': 'REPM', 'src': {'same': True, 'congruent': 5, 'type': 'addresses_A_ht'}, 'dst': {'same': False, 'congruent': 5, 'type': 'addresses_D_ht'}}
{'OP': 'REPM', 'src': {'same': False, 'congruent': 2, 'type': 'addresses_A_ht'}, 'dst': {'same': False, 'congruent': 7, 'type': 'addresses_A_ht'}}
...
{'OP': 'REPM', 'src': {'same': False, 'congruent': 4, 'type': 'addresses_A_ht'}, 'dst': {'same': False, 'congruent': 0, 'type': 'addresses_A_ht'}}
