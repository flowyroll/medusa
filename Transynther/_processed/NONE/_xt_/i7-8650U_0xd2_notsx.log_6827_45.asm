...
push %rdi
push %rsi
lea addresses_A_ht+0xaf0c, %r13
nop
cmp $47146, %rdi
movb $0x61, (%r13)
nop
inc %r15
lea addresses_D_ht+0x9c1c, %rsi
lea addresses_WT_ht+0xaf8c, %rdi
nop
nop
nop
nop
...
nop
cmp %rsi, %rsi
lea addresses_normal_ht+0x1518c, %r14
nop
nop
nop
nop
...
nop
cmp %rsi, %rsi
lea addresses_D_ht+0xb90c, %rsi
lea addresses_WT_ht+0x1e50c, %rdi
nop
nop
and %r11, %r11
mov $123, %rcx
rep movsw
sub %r11, %r11
lea addresses_normal_ht+0xf70c, %rsi
nop
nop
nop
and %r15, %r15
...
nop
and $44, %rsi
lea addresses_A_ht+0x86c, %rsi
lea addresses_D_ht+0x308c, %rdi
nop
nop
nop
nop
...
nop
xor %r13, %r13
lea addresses_A_ht+0x11fcc, %rcx
nop
nop
nop
nop
...
nop
xor %rsi, %rsi
lea addresses_WT_ht+0xd88c, %r11
clflush (%r11)
xor $20169, %r9
movb $0x61, (%r11)
nop
...
nop
cmp %r9, %r9
lea addresses_UC_ht+0x6cc, %rsi
lea addresses_A_ht+0xe54c, %rdi
nop
nop
nop
nop
...
rep movsq
add %rsi, %rsi
lea addresses_UC_ht+0x175b0, %rsi
lea addresses_WT_ht+0x3f0c, %rdi
sub $53042, %r15
mov $127, %rcx
rep movsq
nop
...
nop
xor $52785, %r15
lea addresses_normal_ht+0xed0c, %rsi
lea addresses_UC_ht+0xbd0c, %rdi
clflush (%rsi)
dec %r9
mov $70, %rcx
rep movsb
...
nop
dec %r14
lea addresses_WC_ht+0x1ca8c, %r9
nop
sub $29261, %rcx
...
nop
sub %r15, %r15
lea addresses_WC_ht+0xf40c, %r15
nop
nop
nop
dec %rsi
...
nop
xor %rdi, %rdi
lea addresses_D_ht+0x1250c, %r11
nop
nop
nop
cmp %r14, %r14
...
{'OP': 'REPM', 'src': {'type': 'addresses_D_ht', 'congruent': 9, 'same': True}, 'dst': {'type': 'addresses_WT_ht', 'congruent': 10, 'same': False}}
