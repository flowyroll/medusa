...
push %rdi
push %rsi
lea addresses_normal_ht+0x17246, %rcx
nop
nop
nop
nop
...
nop
and %r9, %r9
lea addresses_UC_ht+0x1746e, %rsi
lea addresses_normal_ht+0x9395, %rdi
and %r10, %r10
mov $33, %rcx
rep movsw
nop
nop
and $967, %rsi
lea addresses_WT_ht+0x2236, %rbp
nop
nop
nop
nop
...
nop
inc %r9
lea addresses_WC_ht+0x11a54, %rcx
nop
nop
nop
nop
...
nop
xor $13151, %rdi
lea addresses_WC_ht+0x127ee, %rcx
nop
nop
nop
add %r9, %r9
...
nop
dec %rbx
lea addresses_WT_ht+0xcfc6, %rcx
nop
nop
nop
nop
...
{'OP': 'REPM', 'src': {'same': False, 'congruent': 3, 'type': 'addresses_UC_ht'}, 'dst': {'same': False, 'congruent': 0, 'type': 'addresses_normal_ht'}}
