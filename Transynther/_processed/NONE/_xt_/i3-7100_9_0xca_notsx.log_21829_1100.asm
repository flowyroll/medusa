...
push %rdx
push %rsi
lea addresses_normal_ht+0x1e203, %r9
clflush (%r9)
nop
nop
nop
...
nop
and $32132, %rax
lea addresses_WT_ht+0x11c73, %rbp
nop
nop
nop
and %r13, %r13
...
nop
add %r13, %r13
lea addresses_WC_ht+0x16d67, %rbp
nop
nop
sub $3957, %r8
movw $0x6162, (%rbp)
...
nop
cmp $43426, %rbp
lea addresses_WC_ht+0x157b3, %rsi
lea addresses_D_ht+0x12953, %rdi
nop
nop
and %r9, %r9
mov $82, %rcx
rep movsb
cmp $34890, %r13
lea addresses_normal_ht+0x113e5, %rax
nop
nop
nop
nop
...
nop
sub $61607, %rax
lea addresses_normal_ht+0x10473, %rsi
lea addresses_D_ht+0x6ab3, %rdi
cmp %r8, %r8
mov $52, %rcx
rep movsw
nop
...
nop
sub %r9, %r9
lea addresses_WT_ht+0x2263, %rsi
lea addresses_A_ht+0x19b33, %rdi
nop
nop
nop
nop
...
// REPMOV
lea addresses_D+0x78e7, %rsi
lea addresses_normal+0xe610, %rdi
and $53808, %r8
mov $79, %rcx
rep movsq
sub %rsi, %rsi
...
// Faulty Load
lea addresses_normal+0x17fb3, %rsi
nop
sub $57191, %rcx
mov (%rsi), %edi
lea oracles, %r11
...
{'src': {'type': 'addresses_D', 'congruent': 0, 'same': False}, 'OP': 'REPM', 'dst': {'type': 'addresses_normal', 'congruent': 0, 'same': False}}
{'OP': 'STOR', 'dst': {'same': False, 'congruent': 9, 'NT': True, 'type': 'addresses_A', 'size': 8, 'AVXalign': True}}
...
{'src': {'type': 'addresses_normal_ht', 'congruent': 4, 'same': True}, 'OP': 'REPM', 'dst': {'type': 'addresses_D_ht', 'congruent': 8, 'same': False}}
