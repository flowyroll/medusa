...
push %rdi
push %rsi
lea addresses_normal_ht+0x9a31, %r15
nop
nop
dec %rcx
mov (%r15), %r13w
dec %r8
lea addresses_normal_ht+0x19671, %r13
nop
nop
nop
nop
...
nop
and $39048, %r15
lea addresses_WT_ht+0xe0f1, %r15
nop
and $51559, %rsi
...
mov (%r9), %r8w
add $15857, %rcx
lea addresses_normal_ht+0xcc71, %rdi
nop
nop
and $31640, %r9
mov (%rdi), %r8w
...
lea addresses_UC_ht+0xc1e5, %rdi
nop
dec %r9
mov $41, %rcx
rep movsl
...
nop
xor %rcx, %rcx
lea addresses_D_ht+0x19441, %rdi
nop
nop
cmp $27033, %r13
movw $0x6162, (%rdi)
...
nop
cmp %rcx, %rcx
lea addresses_WC_ht+0x37f1, %rsi
lea addresses_D_ht+0x15549, %rdi
nop
cmp $32851, %r13
mov $88, %rcx
rep movsl
...
nop
and %r9, %r9
lea addresses_UC_ht+0x1ace5, %r8
nop
inc %r13
mov (%r8), %r9
nop
...
{'src': {'type': 'addresses_A_ht', 'congruent': 0, 'same': True}, 'dst': {'type': 'addresses_UC_ht', 'congruent': 2, 'same': False}, 'OP': 'REPM'}
{'dst': {'type': 'addresses_D_ht', 'same': False, 'size': 2, 'congruent': 3, 'NT': False, 'AVXalign': False}, 'OP': 'STOR'}
{'src': {'type': 'addresses_WC_ht', 'congruent': 7, 'same': False}, 'dst': {'type': 'addresses_D_ht', 'congruent': 2, 'same': False}, 'OP': 'REPM'}
