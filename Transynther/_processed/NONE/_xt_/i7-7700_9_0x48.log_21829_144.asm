...
push %rdi
push %rsi
lea addresses_D_ht+0x1c60b, %rbp
nop
nop
nop
and %rax, %rax
...
nop
xor $2324, %r13
lea addresses_WT_ht+0x14d7, %rdi
nop
nop
nop
sub $8666, %rsi
...
nop
cmp %rax, %rax
lea addresses_normal_ht+0xfcd7, %rbp
nop
and $31054, %r13
vmovups (%rbp), %ymm0
...
nop
cmp $30062, %r10
lea addresses_D_ht+0x66af, %rsi
lea addresses_D_ht+0xe97, %rdi
clflush (%rsi)
nop
nop
nop
...
nop
cmp $59959, %r13
lea addresses_UC_ht+0x119f, %rsi
...
nop
xor $41136, %r13
lea addresses_WC_ht+0x19437, %rax
xor %rdi, %rdi
movw $0x6162, (%rax)
and %rbp, %rbp
lea addresses_UC_ht+0xdbd7, %rax
nop
nop
and %rbp, %rbp
...
nop
sub $40360, %rcx
lea addresses_normal_ht+0x17c57, %rsi
lea addresses_WT_ht+0x1e497, %rdi
nop
nop
nop
nop
...
nop
and $1019, %r13
lea addresses_normal_ht+0x18a09, %rsi
lea addresses_WT_ht+0x1af, %rdi
nop
nop
nop
xor %r14, %r14
...
nop
inc %rbp
lea addresses_WC_ht+0x38d7, %r10
nop
nop
nop
nop
...
// Faulty Load
lea addresses_normal+0x19cd7, %rax
nop
sub %r11, %r11
mov (%rax), %ecx
lea oracles, %r10
...
{'OP': 'REPM', 'src': {'type': 'addresses_UC_ht', 'congruent': 3, 'same': False}, 'dst': {'type': 'addresses_WT_ht', 'congruent': 5, 'same': True}}
...
{'OP': 'REPM', 'src': {'type': 'addresses_UC_ht', 'congruent': 2, 'same': False}, 'dst': {'type': 'addresses_D_ht', 'congruent': 2, 'same': False}}
