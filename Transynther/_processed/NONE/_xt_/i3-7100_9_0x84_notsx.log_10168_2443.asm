...
push %rdx
push %rsi
lea addresses_WC_ht+0x1e688, %rsi
lea addresses_D_ht+0xeb92, %rdi
nop
sub %r11, %r11
mov $52, %rcx
rep movsw
cmp %rdx, %rdx
lea addresses_WT_ht+0x13b88, %rdx
nop
nop
add $59464, %r14
movups (%rdx), %xmm1
vpextrq $1, %xmm1, %rdi
inc %rdi
lea addresses_D_ht+0x52c0, %r11
nop
nop
and %rsi, %rsi
movb (%r11), %dl
sub $51884, %rcx
lea addresses_D_ht+0x1d068, %rsi
lea addresses_WC_ht+0x4b88, %rdi
xor $8838, %rbp
mov $83, %rcx
rep movsq
nop
...
// REPMOV
lea addresses_WT+0xb388, %rsi
lea addresses_UC+0x18788, %rdi
nop
inc %rbp
mov $7, %rcx
rep movsw
...
{'src': {'type': 'addresses_WT', 'congruent': 0, 'same': True}, 'dst': {'type': 'addresses_UC', 'congruent': 10, 'same': False}, 'OP': 'REPM'}
...
{'src': {'type': 'addresses_D_ht', 'congruent': 5, 'same': False}, 'dst': {'type': 'addresses_WC_ht', 'congruent': 11, 'same': False}, 'OP': 'REPM'}
{'src': {'type': 'addresses_A_ht', 'same': False, 'size': 16, 'congruent': 9, 'NT': False, 'AVXalign': True}, 'OP': 'LOAD'}
{'39': 10168}
