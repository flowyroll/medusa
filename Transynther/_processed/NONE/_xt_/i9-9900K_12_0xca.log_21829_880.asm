...
push %rdi
push %rsi
lea addresses_WC_ht+0x1b4c2, %r15
nop
nop
nop
nop
...
nop
and $55387, %r15
lea addresses_WT_ht+0x168c2, %rax
nop
nop
nop
nop
...
movaps %xmm2, (%rax)
add %r11, %r11
lea addresses_WT_ht+0x50c2, %rdi
dec %rbp
movups (%rdi), %xmm4
vpextrq $0, %xmm4, %rax
nop
...
nop
xor $61363, %rbp
lea addresses_WT_ht+0x16cc2, %r11
nop
nop
nop
nop
...
nop
add $27842, %rbp
lea addresses_D_ht+0x100c2, %rax
nop
sub %rcx, %rcx
movw $0x6162, (%rax)
add $61712, %rcx
lea addresses_UC_ht+0x60c2, %rdi
nop
nop
nop
add $12102, %rbp
...
// Faulty Load
lea addresses_normal+0x68c2, %rdi
nop
nop
nop
nop
...
{'OP': 'STOR', 'dst': {'size': 16, 'NT': False, 'type': 'addresses_WT_ht', 'same': False, 'AVXalign': True, 'congruent': 10}}
