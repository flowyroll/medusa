...
push %rdi
push %rsi
lea addresses_WC_ht+0xb994, %rax
nop
nop
nop
nop
...
nop
xor %rdi, %rdi
lea addresses_UC_ht+0x1d394, %r15
nop
cmp $53307, %r8
movw $0x6162, (%r15)
nop
...
nop
add $1114, %rax
lea addresses_normal_ht+0xa4, %r15
sub %rdi, %rdi
mov (%r15), %r10d
nop
nop
sub %rax, %rax
lea addresses_WT_ht+0x14a, %rsi
lea addresses_WT_ht+0x11d94, %rdi
cmp $15054, %rax
mov $4, %rcx
rep movsw
nop
...
nop
xor $61683, %r15
lea addresses_A_ht+0x19f9a, %rsi
lea addresses_UC_ht+0xd466, %rdi
nop
nop
dec %r15
mov $25, %rcx
rep movsw
xor $37609, %rsi
lea addresses_normal_ht+0x7e74, %rsi
nop
nop
nop
nop
...
nop
cmp %rdi, %rdi
lea addresses_UC_ht+0x1b294, %rdi
xor %rcx, %rcx
mov (%rdi), %r12d
nop
cmp %rsi, %rsi
lea addresses_normal_ht+0x13594, %r10
xor $48100, %r8
movb (%r10), %cl
cmp $34669, %rcx
lea addresses_WT_ht+0x726c, %r8
clflush (%r8)
nop
nop
nop
...
nop
sub %r15, %r15
lea addresses_WT_ht+0x105e4, %rax
nop
nop
nop
sub %r10, %r10
...
nop
sub %rax, %rax
lea addresses_A_ht+0x1a954, %rsi
lea addresses_WT_ht+0xb194, %rdi
nop
nop
nop
nop
...
rep movsq
xor %rcx, %rcx
lea addresses_UC_ht+0x9914, %rdi
nop
nop
nop
nop
...
{'src': {'type': 'addresses_A_ht', 'congruent': 1, 'same': False}, 'dst': {'type': 'addresses_UC_ht', 'congruent': 1, 'same': False}, 'OP': 'REPM'}
...
{'src': {'type': 'addresses_WT_ht', 'same': False, 'size': 2, 'congruent': 3, 'NT': False, 'AVXalign': True}, 'OP': 'LOAD'}
{'src': {'type': 'addresses_WT_ht', 'same': False, 'size': 32, 'congruent': 3, 'NT': False, 'AVXalign': False}, 'OP': 'LOAD'}
{'src': {'type': 'addresses_A_ht', 'congruent': 6, 'same': False}, 'dst': {'type': 'addresses_WT_ht', 'congruent': 10, 'same': False}, 'OP': 'REPM'}
