...
push %rdx
push %rsi
lea addresses_UC_ht+0x10c4a, %rax
nop
nop
nop
cmp $41797, %rcx
...
nop
cmp %r15, %r15
lea addresses_normal_ht+0xabfa, %r8
nop
inc %rbp
vmovups (%r8), %ymm2
...
nop
cmp %rdx, %rdx
lea addresses_UC_ht+0x19a4a, %rbp
nop
nop
xor $61389, %rax
mov (%rbp), %r8d
...
nop
xor $41196, %rdx
lea addresses_UC_ht+0x1404a, %rsi
lea addresses_normal_ht+0x1404a, %rdi
nop
nop
xor %r15, %r15
mov $37, %rcx
...
// Faulty Load
lea addresses_normal+0x1c84a, %rsi
clflush (%rsi)
sub %rbx, %rbx
movb (%rsi), %al
lea oracles, %rbx
