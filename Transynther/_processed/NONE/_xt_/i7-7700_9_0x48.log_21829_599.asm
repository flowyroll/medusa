...
push %rdi
push %rsi
lea addresses_WC_ht+0x14009, %rsi
lea addresses_normal_ht+0x1f29, %rdi
dec %r8
mov $38, %rcx
rep movsq
nop
nop
cmp $55463, %r13
lea addresses_WT_ht+0xae69, %rsi
nop
nop
add $53175, %r9
...
nop
and %r9, %r9
lea addresses_WT_ht+0xaf3d, %rcx
nop
nop
nop
cmp %r10, %r10
...
movups %xmm4, (%rcx)
dec %r9
lea addresses_WT_ht+0x1abe9, %r10
nop
nop
nop
nop
...
nop
and %r13, %r13
lea addresses_UC_ht+0x1efd9, %r8
nop
cmp $21529, %r10
movb $0x61, (%r8)
nop
...
// Faulty Load
lea addresses_normal+0xfbe9, %r11
nop
nop
nop
nop
