...
lea addresses_WC_ht+0x98e4, %rdi
inc %r9
mov $10, %rcx
rep movsb
nop
...
nop
inc %r9
lea addresses_WC_ht+0x15842, %r8
nop
and $46579, %rsi
movups (%r8), %xmm1
vpextrq $0, %xmm1, %rdx
...
nop
sub %r8, %r8
lea addresses_UC_ht+0x15182, %r10
clflush (%r10)
nop
nop
nop
...
movl $0x61626364, (%r10)
xor %r15, %r15
lea addresses_normal_ht+0x1e832, %rsi
lea addresses_normal_ht+0xb972, %rdi
clflush (%rdi)
nop
nop
nop
...
// Store
lea addresses_normal+0x172fe, %r10
nop
sub $37712, %rdi
movl $0x51525354, (%r10)
nop
...
{'OP': 'STOR', 'dst': {'type': 'addresses_normal', 'AVXalign': False, 'size': 4, 'NT': True, 'same': False, 'congruent': 2}}
...
{'src': {'type': 'addresses_normal_ht', 'congruent': 2, 'same': False}, 'OP': 'REPM', 'dst': {'type': 'addresses_normal_ht', 'congruent': 0, 'same': True}}
{'39': 21829}
