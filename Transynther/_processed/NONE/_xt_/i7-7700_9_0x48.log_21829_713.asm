...
push %rdx
push %rsi
lea addresses_WC_ht+0x1560a, %rsi
lea addresses_normal_ht+0xf80a, %rdi
inc %rdx
mov $10, %rcx
rep movsb
nop
cmp $20773, %rax
lea addresses_normal_ht+0x1b70a, %rdx
clflush (%rdx)
nop
nop
cmp $25963, %r13
...
nop
xor %rdi, %rdi
lea addresses_WC_ht+0x1b14a, %rcx
nop
nop
dec %rbx
movl $0x61626364, (%rcx)
nop
add $25105, %rax
lea addresses_WT_ht+0x840a, %rsi
lea addresses_D_ht+0x1af4a, %rdi
nop
nop
xor %r12, %r12
mov $118, %rcx
...
nop
and $19322, %r13
lea addresses_WC_ht+0xaaca, %r12
nop
dec %rax
movl $0x61626364, (%r12)
nop
...
// Faulty Load
lea addresses_normal+0xe60a, %r15
nop
sub $43816, %rbp
mov (%r15), %di
lea oracles, %r8
...
{'OP': 'STOR', 'dst': {'type': 'addresses_UC', 'AVXalign': True, 'congruent': 1, 'size': 2, 'same': False, 'NT': False}}
