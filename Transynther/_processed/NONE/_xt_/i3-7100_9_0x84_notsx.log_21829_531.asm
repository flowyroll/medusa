...
nop
cmp %r13, %r13
lea addresses_WC_ht+0x1d964, %rsi
lea addresses_D_ht+0x1d570, %rdi
nop
inc %r10
mov $49, %rcx
rep movsb
...
nop
and %rcx, %rcx
lea addresses_UC_ht+0x1ba0, %rdi
nop
nop
add $7861, %r13
movups (%rdi), %xmm5
...
nop
sub %rax, %rax
lea addresses_UC_ht+0x1b34c, %rcx
nop
nop
nop
nop
...
nop
cmp $18997, %rsi
lea addresses_normal_ht+0xd8a0, %rbp
cmp $28484, %r10
movups (%rbp), %xmm1
vpextrq $1, %xmm1, %rsi
nop
...
nop
and $62565, %rbp
lea addresses_A_ht+0x1cdac, %rdi
clflush (%rdi)
nop
nop
nop
...
movb $0x61, (%rdi)
xor %r11, %r11
lea addresses_A_ht+0x130a0, %r10
nop
dec %rax
movw $0x6162, (%r10)
nop
add %rbp, %rbp
lea addresses_D_ht+0xd832, %rsi
lea addresses_UC_ht+0xf37a, %rdi
nop
nop
dec %rax
mov $82, %rcx
...
nop
inc %r11
lea addresses_D_ht+0x11e00, %r13
nop
nop
nop
nop
...
// Load
lea addresses_normal+0x17e0, %r12
nop
inc %rbx
mov (%r12), %eax
add $61627, %rax
...
// Load
lea addresses_normal+0x1b15c, %r12
cmp %rax, %rax
mov (%r12), %r11w
nop
nop
...
// Faulty Load
lea addresses_normal+0x17e0, %r9
nop
nop
nop
nop
...
{'src': {'type': 'addresses_UC_ht', 'same': True, 'size': 8, 'congruent': 3, 'NT': False, 'AVXalign': False}, 'OP': 'LOAD'}
{'src': {'type': 'addresses_WC_ht', 'congruent': 2, 'same': False}, 'dst': {'type': 'addresses_D_ht', 'congruent': 4, 'same': False}, 'OP': 'REPM'}
...
{'src': {'type': 'addresses_D_ht', 'congruent': 1, 'same': True}, 'dst': {'type': 'addresses_UC_ht', 'congruent': 0, 'same': False}, 'OP': 'REPM'}
