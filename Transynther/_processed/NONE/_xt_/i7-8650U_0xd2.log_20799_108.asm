...
movw $0x6162, (%r8)
cmp $38265, %rbx
lea addresses_WT_ht+0x155a9, %rsi
lea addresses_normal_ht+0x1369, %rdi
clflush (%rdi)
nop
nop
nop
...
lea addresses_WC_ht+0x7da9, %rdi
cmp $17925, %rax
mov $37, %rcx
rep movsl
nop
...
nop
inc %rbp
lea addresses_WC_ht+0x188a9, %r8
nop
nop
nop
nop
...
nop
cmp $43370, %r8
lea addresses_UC_ht+0xf314, %rbp
nop
cmp $25020, %rcx
...
// Faulty Load
lea addresses_normal+0x169a9, %rdx
nop
nop
inc %rdi
mov (%rdx), %esi
