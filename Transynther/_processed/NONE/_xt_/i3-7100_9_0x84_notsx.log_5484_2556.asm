...
push %rdi
push %rsi
lea addresses_WC_ht+0x1b535, %rsi
lea addresses_normal_ht+0x147b5, %rdi
nop
nop
nop
add $32643, %rbp
...
nop
sub $10175, %rdi
lea addresses_normal_ht+0x19631, %rbp
nop
nop
nop
nop
...
// Faulty Load
lea addresses_normal+0x16d35, %r12
nop
nop
nop
xor $64634, %r9
...
<gen_faulty_load>
[REF]
{'src': {'type': 'addresses_normal', 'same': False, 'size': 1, 'congruent': 0, 'NT': True, 'AVXalign': True}, 'OP': 'LOAD'}
...
{'dst': {'type': 'addresses_US', 'same': False, 'size': 16, 'congruent': 10, 'NT': True, 'AVXalign': False}, 'OP': 'STOR'}
...
{'dst': {'type': 'addresses_UC_ht', 'same': False, 'size': 4, 'congruent': 6, 'NT': True, 'AVXalign': False}, 'OP': 'STOR'}
