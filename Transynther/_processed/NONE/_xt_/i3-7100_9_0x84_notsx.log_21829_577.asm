...
lea addresses_WT_ht+0xbb47, %rdi
nop
nop
nop
and $16334, %r8
...
movw $0x6162, (%r8)
dec %r8
lea addresses_D_ht+0x17cb7, %rsi
lea addresses_normal_ht+0x2053, %rdi
nop
nop
add %r15, %r15
mov $81, %rcx
...
nop
add $65367, %rdi
lea addresses_D_ht+0x179c7, %rcx
inc %r15
vmovups (%rcx), %ymm5
...
nop
cmp %rsi, %rsi
lea addresses_UC_ht+0x8e47, %rsi
nop
nop
nop
nop
