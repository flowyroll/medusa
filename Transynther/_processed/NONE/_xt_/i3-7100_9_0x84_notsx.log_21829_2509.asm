...
push %rdi
push %rsi
lea addresses_normal_ht+0xc72, %rsi
lea addresses_WC_ht+0x18a72, %rdi
nop
nop
nop
cmp %rbx, %rbx
...
rep movsb
add %rbx, %rbx
lea addresses_WC_ht+0x159f2, %rcx
nop
xor $46422, %rax
...
nop
add %rsi, %rsi
lea addresses_WC_ht+0x1ed42, %rsi
lea addresses_WT_ht+0x9bca, %rdi
nop
nop
nop
nop
...
rep movsl
sub %r9, %r9
lea addresses_A_ht+0xb6f2, %rsi
nop
sub $18807, %rdi
mov (%rsi), %r9
add %rdi, %rdi
lea addresses_WT_ht+0xbf72, %rdi
nop
dec %r12
...
nop
cmp $33925, %r9
lea addresses_D_ht+0x5272, %rsi
lea addresses_D_ht+0x1dc53, %rdi
dec %rax
mov $51, %rcx
rep movsw
nop
nop
inc %rax
lea addresses_A_ht+0x1b138, %rsi
...
{'src': {'type': 'addresses_WC_ht', 'congruent': 4, 'same': False}, 'dst': {'type': 'addresses_WT_ht', 'congruent': 0, 'same': False}, 'OP': 'REPM'}
...
{'src': {'type': 'addresses_A_ht', 'congruent': 0, 'same': False}, 'dst': {'type': 'addresses_D_ht', 'congruent': 6, 'same': True}, 'OP': 'REPM'}
{'33': 21829}
