...
push %rdx
push %rsi
lea addresses_WC_ht+0x1a576, %rdx
nop
nop
nop
nop
...
nop
add %r10, %r10
lea addresses_WT_ht+0x1ed46, %rax
nop
nop
nop
nop
...
nop
cmp %rax, %rax
lea addresses_WC_ht+0x1bf56, %rsi
lea addresses_WC_ht+0x12c76, %rdi
nop
nop
nop
nop
...
// REPMOV
lea addresses_D+0x173f6, %rsi
lea addresses_normal+0x1aa16, %rdi
nop
nop
nop
add $54849, %r14
...
{'OP': 'REPM', 'src': {'type': 'addresses_D', 'congruent': 7, 'same': False}, 'dst': {'type': 'addresses_normal', 'congruent': 5, 'same': False}}
[Faulty Load]
