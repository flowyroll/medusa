...
push %rdx
push %rsi
lea addresses_WT_ht+0x1a110, %rdx
nop
nop
nop
nop
...
mov (%rdx), %r8w
xor %r14, %r14
lea addresses_normal_ht+0xf90d, %rdx
nop
nop
nop
and %r14, %r14
...
nop
cmp %rdx, %rdx
lea addresses_A_ht+0x17195, %r12
nop
nop
nop
and %r8, %r8
...
vmovups %ymm1, (%r12)
xor $50491, %rdx
lea addresses_WC_ht+0x1a44d, %r12
nop
nop
and %r14, %r14
mov (%r12), %dx
...
nop
add $30574, %r8
lea addresses_D_ht+0x150d3, %rsi
lea addresses_D_ht+0xff8d, %rdi
nop
nop
sub %r14, %r14
mov $72, %rcx
...
nop
xor $9685, %rdx
lea addresses_D_ht+0x1660d, %rsi
lea addresses_A_ht+0xafe5, %rdi
clflush (%rsi)
nop
nop
nop
...
rep movsb
and $60453, %r8
lea addresses_WC_ht+0xf625, %rax
clflush (%rax)
nop
nop
nop
...
movaps %xmm0, (%rax)
add $51929, %rcx
lea addresses_D_ht+0xef8d, %rsi
lea addresses_D_ht+0x1094d, %rdi
nop
dec %rax
mov $51, %rcx
rep movsl
...
nop
add $47075, %r12
lea addresses_WT_ht+0x1f8d, %r14
nop
inc %rcx
movb $0x61, (%r14)
and $12267, %rax
...
<gen_prepare_buffer>
{'src': {'type': 'addresses_WT_ht', 'AVXalign': False, 'size': 2, 'NT': True, 'same': False, 'congruent': 0}, 'OP': 'LOAD'}
...
{'src': {'type': 'addresses_WC_ht', 'AVXalign': False, 'size': 2, 'NT': True, 'same': False, 'congruent': 6}, 'OP': 'LOAD'}
{'src': {'type': 'addresses_D_ht', 'congruent': 1, 'same': True}, 'OP': 'REPM', 'dst': {'type': 'addresses_D_ht', 'congruent': 9, 'same': False}}
{'src': {'type': 'addresses_D_ht', 'congruent': 4, 'same': False}, 'OP': 'REPM', 'dst': {'type': 'addresses_A_ht', 'congruent': 2, 'same': True}}
