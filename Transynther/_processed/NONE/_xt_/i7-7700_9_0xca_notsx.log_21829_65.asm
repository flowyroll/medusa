...
push %rdi
push %rsi
lea addresses_normal_ht+0x189ad, %rax
nop
nop
nop
add %r10, %r10
...
nop
dec %rdi
lea addresses_UC_ht+0x135c5, %rsi
lea addresses_WC_ht+0x3e25, %rdi
nop
nop
nop
nop
...
nop
dec %rsi
lea addresses_A_ht+0xe9ad, %rsi
lea addresses_WC_ht+0x12ff3, %rdi
nop
nop
nop
dec %r12
...
nop
dec %r13
lea addresses_normal_ht+0x95ad, %rsi
lea addresses_UC_ht+0x12ac1, %rdi
nop
cmp %rbx, %rbx
mov $54, %rcx
rep movsw
xor $47484, %rbx
lea addresses_WT_ht+0x13509, %rdi
nop
nop
nop
nop
...
nop
add $35856, %rbx
lea addresses_WT_ht+0x1ed0d, %rsi
lea addresses_D_ht+0x6d9, %rdi
nop
nop
nop
nop
...
{'src': {'congruent': 3, 'same': False, 'type': 'addresses_UC_ht'}, 'dst': {'congruent': 3, 'same': False, 'type': 'addresses_WC_ht'}, 'OP': 'REPM'}
{'src': {'congruent': 11, 'same': False, 'type': 'addresses_A_ht'}, 'dst': {'congruent': 0, 'same': False, 'type': 'addresses_WC_ht'}, 'OP': 'REPM'}
{'src': {'congruent': 9, 'same': True, 'type': 'addresses_normal_ht'}, 'dst': {'congruent': 1, 'same': False, 'type': 'addresses_UC_ht'}, 'OP': 'REPM'}
{'src': {'NT': False, 'AVXalign': True, 'size': 16, 'congruent': 2, 'same': False, 'type': 'addresses_WT_ht'}, 'OP': 'LOAD'}
{'src': {'congruent': 4, 'same': False, 'type': 'addresses_WT_ht'}, 'dst': {'congruent': 2, 'same': False, 'type': 'addresses_D_ht'}, 'OP': 'REPM'}
{'33': 21829}
