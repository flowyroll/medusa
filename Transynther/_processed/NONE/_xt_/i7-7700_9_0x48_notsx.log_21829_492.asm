...
push %rdx
push %rsi
lea addresses_A_ht+0xcbaf, %rcx
nop
cmp %rax, %rax
mov (%rcx), %r10d
xor $8165, %r11
lea addresses_A_ht+0x199f, %rdx
clflush (%rdx)
nop
nop
sub %rsi, %rsi
...
nop
add $19970, %rcx
lea addresses_A_ht+0x1e881, %rdx
nop
cmp %r10, %r10
movups (%rdx), %xmm5
vpextrq $0, %xmm5, %rsi
...
nop
xor $54921, %r10
lea addresses_normal_ht+0x1c521, %rsi
lea addresses_normal_ht+0xc941, %rdi
sub %rdx, %rdx
mov $6, %rcx
rep movsw
nop
...
nop
dec %rdi
lea addresses_normal_ht+0x11581, %r11
nop
nop
nop
sub $63424, %rax
movb $0x61, (%r11)
xor $22248, %rax
lea addresses_normal_ht+0x17221, %rsi
...
nop
inc %r10
lea addresses_normal_ht+0x4d5e, %rcx
nop
nop
xor %rdx, %rdx
mov (%rcx), %si
...
lea addresses_normal_ht+0x14f81, %rdi
nop
and $2815, %rdx
mov $27, %rcx
rep movsq
...
nop
and $50758, %rsi
lea addresses_A_ht+0x13681, %rsi
lea addresses_WC_ht+0x6ecd, %rdi
clflush (%rdi)
nop
and $36974, %rax
mov $87, %rcx
...
{'dst': {'same': False, 'congruent': 5, 'type': 'addresses_normal_ht'}, 'OP': 'REPM', 'src': {'same': False, 'congruent': 4, 'type': 'addresses_normal_ht'}}
{'dst': {'same': False, 'NT': False, 'AVXalign': False, 'size': 1, 'type': 'addresses_normal_ht', 'congruent': 5}, 'OP': 'STOR'}
{'dst': {'same': False, 'congruent': 9, 'type': 'addresses_D_ht'}, 'OP': 'REPM', 'src': {'same': False, 'congruent': 5, 'type': 'addresses_normal_ht'}}
{'OP': 'LOAD', 'src': {'same': False, 'NT': False, 'AVXalign': False, 'size': 2, 'type': 'addresses_normal_ht', 'congruent': 0}}
{'dst': {'same': False, 'congruent': 9, 'type': 'addresses_normal_ht'}, 'OP': 'REPM', 'src': {'same': False, 'congruent': 10, 'type': 'addresses_UC_ht'}}
...
{'dst': {'same': False, 'congruent': 2, 'type': 'addresses_WC_ht'}, 'OP': 'REPM', 'src': {'same': False, 'congruent': 6, 'type': 'addresses_A_ht'}}
{'36': 21829}
