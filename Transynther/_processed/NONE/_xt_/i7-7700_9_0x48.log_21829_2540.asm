...
push %rdx
push %rsi
lea addresses_UC_ht+0x648b, %rdi
add %rdx, %rdx
movl $0x61626364, (%rdi)
nop
nop
...
nop
and $62734, %r9
lea addresses_WC_ht+0xc577, %rbp
nop
nop
nop
sub %r8, %r8
...
vmovups %ymm5, (%r8)
cmp %rdi, %rdi
lea addresses_WT_ht+0x748b, %rsi
lea addresses_WC_ht+0x9c8b, %rdi
clflush (%rsi)
nop
cmp %rax, %rax
mov $84, %rcx
rep movsl
sub %rax, %rax
lea addresses_WC_ht+0xbdd3, %rcx
clflush (%rcx)
nop
nop
nop
...
nop
sub $37107, %r15
lea addresses_UC_ht+0x1048b, %rcx
nop
nop
nop
nop
...
{'OP': 'REPM', 'src': {'type': 'addresses_WT_ht', 'congruent': 11, 'same': False}, 'dst': {'type': 'addresses_WC_ht', 'congruent': 11, 'same': False}}
