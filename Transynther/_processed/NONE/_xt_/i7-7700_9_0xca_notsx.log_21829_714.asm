...
push %rdi
push %rsi
lea addresses_A_ht+0x64de, %r13
add $40170, %rax
mov (%r13), %r10d
nop
nop
cmp %r15, %r15
lea addresses_D_ht+0x86de, %rsi
lea addresses_WC_ht+0x19a3e, %rdi
clflush (%rsi)
nop
nop
sub $41174, %r9
...
nop
cmp $24636, %rsi
lea addresses_UC_ht+0xb3de, %r13
nop
nop
nop
nop
...
nop
cmp $60369, %r15
lea addresses_WC_ht+0x92ae, %rsi
lea addresses_WC_ht+0x1c8de, %rdi
nop
nop
nop
inc %rax
...
nop
and %rdi, %rdi
lea addresses_UC_ht+0xf1de, %rsi
lea addresses_WC_ht+0x16dde, %rdi
clflush (%rdi)
nop
nop
add $16355, %r15
...
nop
sub %rsi, %rsi
lea addresses_normal_ht+0x1dcde, %r15
nop
nop
nop
nop
...
nop
sub $45570, %r10
lea addresses_WT_ht+0x1b7de, %r9
and %rsi, %rsi
movb $0x61, (%r9)
nop
nop
...
// Faulty Load
lea addresses_normal+0x7dde, %rsi
nop
nop
nop
nop
...
{'src': {'congruent': 1, 'same': False, 'type': 'addresses_D_ht'}, 'dst': {'congruent': 5, 'same': False, 'type': 'addresses_WC_ht'}, 'OP': 'REPM'}
