...
nop
lfence
lea addresses_A_ht+0x192b9, %rsi
nop
nop
inc %rbp
mov (%rsi), %r14d
...
// REPMOV
lea addresses_WC+0x1d049, %rsi
lea addresses_UC+0x1c419, %rdi
nop
nop
xor %r10, %r10
mov $125, %rcx
...
{'src': {'congruent': 4, 'same': False, 'type': 'addresses_WC'}, 'dst': {'congruent': 5, 'same': False, 'type': 'addresses_UC'}, 'OP': 'REPM'}
...
<gen_prepare_buffer>
{'src': {'NT': True, 'AVXalign': False, 'size': 4, 'congruent': 2, 'same': False, 'type': 'addresses_WT_ht'}, 'OP': 'LOAD'}
