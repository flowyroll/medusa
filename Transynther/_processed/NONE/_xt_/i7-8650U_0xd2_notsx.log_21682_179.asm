...
nop
sub $51814, %r11
lea addresses_WC_ht+0x11e0e, %r13
nop
nop
nop
nop
...
nop
add $58808, %rbx
lea addresses_A_ht+0x19286, %rsi
lea addresses_A_ht+0x12086, %rdi
nop
nop
nop
nop
...
nop
cmp %rbx, %rbx
lea addresses_WC_ht+0x2b46, %r11
nop
nop
nop
xor $17257, %rbx
...
nop
xor %rsi, %rsi
lea addresses_A_ht+0x18fc6, %rsi
lea addresses_normal_ht+0xda86, %rdi
nop
nop
nop
nop
...
nop
sub %r11, %r11
lea addresses_UC_ht+0xcd68, %rbx
nop
xor %r13, %r13
...
nop
cmp %r13, %r13
lea addresses_normal_ht+0x5fc6, %rsi
lea addresses_normal_ht+0x1246, %rdi
nop
add $64505, %rbx
mov $104, %rcx
rep movsl
...
nop
dec %r11
lea addresses_WT_ht+0xee06, %rsi
lea addresses_WC_ht+0x1dc86, %rdi
xor %rax, %rax
mov $12, %rcx
rep movsb
nop
...
nop
cmp %r13, %r13
lea addresses_UC_ht+0x7c86, %rcx
clflush (%rcx)
sub %rsi, %rsi
mov (%rcx), %ax
nop
...
nop
and %rax, %rax
lea addresses_WT_ht+0x11286, %rdi
nop
nop
nop
sub %rbx, %rbx
...
<gen_prepare_buffer>
{'OP': 'LOAD', 'src': {'type': 'addresses_UC_ht', 'size': 32, 'AVXalign': True, 'NT': False, 'congruent': 2, 'same': False}}
...
{'OP': 'STOR', 'dst': {'type': 'addresses_WC_ht', 'size': 8, 'AVXalign': True, 'NT': False, 'congruent': 6, 'same': False}}
{'OP': 'REPM', 'src': {'type': 'addresses_A_ht', 'congruent': 5, 'same': False}, 'dst': {'type': 'addresses_normal_ht', 'congruent': 11, 'same': False}}
{'OP': 'STOR', 'dst': {'type': 'addresses_UC_ht', 'size': 16, 'AVXalign': True, 'NT': False, 'congruent': 1, 'same': False}}
