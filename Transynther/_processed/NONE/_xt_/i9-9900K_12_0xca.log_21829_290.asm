...
nop
and %rdx, %rdx
lea addresses_D_ht+0x11917, %rsi
lea addresses_WT_ht+0x1a117, %rdi
nop
nop
lfence
mov $17, %rcx
...
mov (%rax), %r13d
add %rbx, %rbx
lea addresses_WT_ht+0xb5c7, %r13
sub $27305, %rdx
movl $0x61626364, (%r13)
nop
nop
...
nop
xor %r13, %r13
lea addresses_WT_ht+0x8117, %rdi
nop
xor $9831, %rsi
movw $0x6162, (%rdi)
nop
inc %r13
lea addresses_WC_ht+0x751b, %rbx
and $52101, %rax
mov (%rbx), %ecx
sub %rax, %rax
lea addresses_WC_ht+0x14429, %r13
clflush (%r13)
nop
nop
nop
...
nop
cmp $11351, %rcx
lea addresses_A_ht+0x16c27, %rsi
lea addresses_normal_ht+0x5117, %rdi
nop
nop
nop
nop
...
// Store
lea addresses_normal+0x1119f, %rdx
nop
nop
nop
nop
...
// Store
lea addresses_normal+0xecd7, %r15
nop
nop
xor %rax, %rax
...
{'OP': 'STOR', 'dst': {'size': 8, 'NT': True, 'type': 'addresses_normal', 'same': False, 'AVXalign': False, 'congruent': 6}}
[Faulty Load]
...
{'OP': 'REPM', 'src': {'same': False, 'type': 'addresses_A_ht', 'congruent': 5}, 'dst': {'same': False, 'type': 'addresses_WC_ht', 'congruent': 1}}
{'OP': 'REPM', 'src': {'same': True, 'type': 'addresses_D_ht', 'congruent': 11}, 'dst': {'same': False, 'type': 'addresses_WT_ht', 'congruent': 11}}
...
{'OP': 'REPM', 'src': {'same': False, 'type': 'addresses_A_ht', 'congruent': 4}, 'dst': {'same': False, 'type': 'addresses_normal_ht', 'congruent': 10}}
{'33': 21829}
