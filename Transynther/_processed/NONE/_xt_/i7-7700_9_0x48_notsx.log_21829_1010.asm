...
nop
cmp $26399, %rbp
lea addresses_WC_ht+0xec3d, %rsi
lea addresses_WT_ht+0x13785, %rdi
clflush (%rdi)
sub $11216, %r12
mov $120, %rcx
rep movsb
...
nop
add $31548, %r14
lea addresses_UC_ht+0x5e3d, %rdi
nop
sub %rsi, %rsi
movw $0x6162, (%rdi)
nop
...
nop
cmp %rbp, %rbp
lea addresses_WC_ht+0x1143d, %rsi
lea addresses_WC_ht+0x783d, %rdi
nop
nop
nop
nop
...
nop
add %rbp, %rbp
lea addresses_WC_ht+0xd03d, %rbx
nop
nop
nop
nop
...
{'dst': {'same': False, 'congruent': 3, 'type': 'addresses_WT_ht'}, 'OP': 'REPM', 'src': {'same': False, 'congruent': 11, 'type': 'addresses_WC_ht'}}
