...
push %rdi
push %rsi
lea addresses_A_ht+0x1207f, %rsi
lea addresses_A_ht+0x1b9e4, %rdi
nop
sub $20274, %r10
mov $113, %rcx
rep movsl
...
nop
sub %rdi, %rdi
lea addresses_A_ht+0xd264, %rsi
lea addresses_D_ht+0x1080c, %rdi
clflush (%rdi)
xor $47248, %rax
mov $23, %rcx
rep movsw
...
nop
sub %rax, %rax
lea addresses_WT_ht+0x1b444, %rsi
nop
nop
dec %r10
vmovups (%rsi), %ymm6
...
vpextrq $1, %xmm6, %rdi
cmp $28609, %rbx
lea addresses_normal_ht+0x1a064, %rax
nop
nop
nop
nop
...
nop
add %r8, %r8
lea addresses_D_ht+0x5524, %rsi
lea addresses_WC_ht+0x6a64, %rdi
nop
add $33662, %r10
mov $102, %rcx
rep movsl
...
nop
add %rsi, %rsi
lea addresses_WT_ht+0x1af94, %rcx
nop
nop
xor $371, %rsi
...
vmovups %ymm1, (%rcx)
sub %rax, %rax
lea addresses_WC_ht+0x7344, %rsi
lea addresses_D_ht+0x104b1, %rdi
sub %r13, %r13
mov $86, %rcx
rep movsw
xor $19355, %r8
...
<gen_prepare_buffer>
{'OP': 'REPM', 'src': {'same': False, 'congruent': 0, 'type': 'addresses_A_ht'}, 'dst': {'same': False, 'congruent': 6, 'type': 'addresses_A_ht'}}
