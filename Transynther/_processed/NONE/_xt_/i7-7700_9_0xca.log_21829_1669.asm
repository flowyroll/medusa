...
push %rbp
push %rsi
lea addresses_WC_ht+0x1e8c8, %r15
nop
nop
xor %rbp, %rbp
...
nop
dec %r14
lea addresses_normal_ht+0x71e0, %r15
nop
nop
nop
nop
...
nop
sub $19277, %rbp
lea addresses_D_ht+0x16f68, %rsi
clflush (%rsi)
nop
nop
nop
...
movl $0x61626364, (%rsi)
and $38785, %r14
lea addresses_D_ht+0x1a03f, %r15
nop
nop
nop
add $49312, %rbp
...
nop
and $32491, %rbp
lea addresses_WT_ht+0xc948, %rsi
nop
nop
nop
nop
...
nop
add %r14, %r14
lea addresses_WC_ht+0x1ad58, %r15
nop
nop
nop
xor $48495, %r14
...
nop
dec %r15
lea addresses_normal_ht+0x1e048, %rax
nop
nop
dec %rbp
vmovups (%rax), %ymm5
...
nop
xor %rax, %rax
lea addresses_normal_ht+0x1e9e8, %r11
nop
nop
and %rax, %rax
mov (%r11), %r10d
...
nop
inc %r15
lea addresses_WT_ht+0x195c8, %r11
xor $14054, %rsi
mov (%r11), %r14
sub %rax, %rax
lea addresses_D_ht+0xa648, %r10
clflush (%r10)
sub $5982, %r14
movb (%r10), %al
nop
nop
sub %r11, %r11
lea addresses_A_ht+0x1a948, %rax
nop
nop
add %r14, %r14
movw $0x6162, (%rax)
cmp $34238, %r14
lea addresses_WC_ht+0x1c2c8, %r14
nop
nop
nop
cmp $20256, %r11
...
{'OP': 'STOR', 'dst': {'congruent': 5, 'AVXalign': False, 'same': False, 'size': 4, 'NT': True, 'type': 'addresses_D_ht'}}
