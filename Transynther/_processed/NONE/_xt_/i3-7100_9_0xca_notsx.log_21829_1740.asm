...
push %rdi
push %rsi
lea addresses_WT_ht+0x13d52, %rsi
lea addresses_normal_ht+0x162c8, %rdi
nop
nop
nop
nop
...
nop
add %r10, %r10
lea addresses_WC_ht+0x17302, %rsi
...
nop
cmp $47790, %r15
lea addresses_D_ht+0x19152, %rsi
nop
cmp $35817, %r13
movups (%rsi), %xmm5
vpextrq $0, %xmm5, %r15
...
// Store
lea addresses_normal+0x10152, %r15
nop
nop
cmp $26965, %rdi
movl $0x51525354, (%r15)
...
// Store
lea addresses_A+0xe1a2, %rdx
add %r15, %r15
movl $0x51525354, (%rdx)
xor $10539, %rsi

// Faulty Load
lea addresses_WT+0x16152, %r14
nop
nop
nop
nop
