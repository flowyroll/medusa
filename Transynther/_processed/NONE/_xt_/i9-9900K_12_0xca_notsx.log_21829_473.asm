...
push %rdx
push %rsi
lea addresses_D_ht+0x3d55, %rsi
lea addresses_WC_ht+0x3675, %rdi
dec %rdx
mov $41, %rcx
rep movsb
nop
...
nop
sub %rax, %rax
lea addresses_WC_ht+0x5dd5, %rsi
...
nop
cmp %r11, %r11
lea addresses_normal_ht+0xd53, %rsi
sub $14614, %r8
mov (%rsi), %edx
add $36227, %rcx
lea addresses_A_ht+0xab05, %r11
nop
nop
nop
add %rdi, %rdi
...
nop
and %rdi, %rdi
lea addresses_WC_ht+0x19355, %rsi
nop
nop
nop
cmp $31945, %rdx
...
nop
cmp %rcx, %rcx
lea addresses_WT_ht+0xcca5, %rsi
nop
nop
nop
nop
...
nop
dec %rdi
lea addresses_A_ht+0x1c2b5, %rax
nop
nop
cmp $2565, %rdx
...
nop
inc %rdi
lea addresses_WT_ht+0x17ef1, %rdx
nop
dec %rdi
mov (%rdx), %r8
nop
nop
dec %rcx
lea addresses_D_ht+0x3b55, %rsi
lea addresses_A_ht+0xf5fd, %rdi
cmp %rbx, %rbx
mov $71, %rcx
rep movsw
nop
add %rax, %rax
lea addresses_D_ht+0x11f55, %rdx
nop
nop
xor $59179, %rcx
movb (%rdx), %r8b
...
nop
sub %r11, %r11
lea addresses_WC_ht+0x1b23f, %r8
nop
nop
nop
nop
...
nop
add $4800, %r11
lea addresses_UC_ht+0x90ff, %rsi
lea addresses_normal_ht+0x1bb55, %rdi
nop
cmp $24706, %r8
mov $13, %rcx
rep movsb
nop
sub $24740, %rdi
lea addresses_WT_ht+0xd755, %rsi
lea addresses_normal_ht+0x1e975, %rdi
nop
nop
nop
nop
...
nop
mfence
lea addresses_normal_ht+0xbb55, %rsi
lea addresses_D_ht+0x1ba5d, %rdi
clflush (%rdi)
xor %r11, %r11
mov $25, %rcx
rep movsl
...
nop
cmp %rax, %rax
lea addresses_WT_ht+0x1da05, %rdi
nop
nop
nop
cmp $65019, %rsi
...
// Store
lea addresses_normal+0x527c, %rbx
clflush (%rbx)
nop
nop
nop
...
<gen_prepare_buffer>
{'OP': 'REPM', 'src': {'same': False, 'congruent': 8, 'type': 'addresses_D_ht'}, 'dst': {'same': False, 'congruent': 5, 'type': 'addresses_WC_ht'}}
{'OP': 'REPM', 'src': {'same': False, 'congruent': 4, 'type': 'addresses_WC_ht'}, 'dst': {'same': False, 'congruent': 5, 'type': 'addresses_UC_ht'}}
...
{'OP': 'REPM', 'src': {'same': False, 'congruent': 0, 'type': 'addresses_UC_ht'}, 'dst': {'same': False, 'congruent': 9, 'type': 'addresses_normal_ht'}}
{'OP': 'REPM', 'src': {'same': False, 'congruent': 10, 'type': 'addresses_WT_ht'}, 'dst': {'same': True, 'congruent': 2, 'type': 'addresses_normal_ht'}}
