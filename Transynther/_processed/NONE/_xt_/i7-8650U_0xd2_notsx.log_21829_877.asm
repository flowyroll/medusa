...
push %rdx
push %rsi
lea addresses_UC_ht+0x7cda, %rsi
nop
nop
nop
sub %rcx, %rcx
...
nop
cmp %r14, %r14
lea addresses_A_ht+0x1b980, %rsi
lea addresses_UC_ht+0x1345a, %rdi
nop
nop
add %r9, %r9
mov $100, %rcx
rep movsb
cmp $24615, %r14
lea addresses_A_ht+0x1c414, %rcx
nop
nop
and %rdi, %rdi
mov (%rcx), %edx
...
nop
xor $42267, %rcx
lea addresses_WC_ht+0x1acda, %rsi
nop
nop
nop
sub $17036, %rbp
...
nop
and %r14, %r14
lea addresses_D_ht+0x160da, %rsi
lea addresses_normal_ht+0xe9a, %rdi
nop
nop
nop
nop
...
nop
and $17732, %r14
lea addresses_D_ht+0x1685a, %rdx
and %r14, %r14
vmovups (%rdx), %ymm7
vextracti128 $0, %ymm7, %xmm7
vpextrq $0, %xmm7, %rcx
cmp $63525, %rbp
lea addresses_WT_ht+0x51b0, %rcx
add %r14, %r14
movb (%rcx), %dl
nop
sub $36203, %r9
lea addresses_WT_ht+0x11bbe, %rcx
nop
nop
nop
cmp %rbp, %rbp
...
movq %rdi, (%rcx)
cmp $23808, %rdx
lea addresses_WT_ht+0x16bf2, %rbp
xor %rdx, %rdx
mov (%rbp), %cx
nop
nop
and $64302, %rdi
lea addresses_WT_ht+0x144ba, %rsi
lea addresses_D_ht+0x1e8fe, %rdi
clflush (%rsi)
nop
nop
nop
...
nop
cmp %r9, %r9
lea addresses_D_ht+0x12af1, %rcx
nop
sub %r9, %r9
mov $0x6162636465666768, %rdi
movq %rdi, %xmm2
...
movntdq %xmm2, (%rcx)
and %rdx, %rdx
lea addresses_WC_ht+0x5cda, %rsi
lea addresses_D_ht+0x2cda, %rdi
nop
nop
nop
sub $59597, %r9
...
// Store
lea addresses_normal+0x1f1da, %rax
nop
nop
nop
nop
...
{'OP': 'STOR', 'dst': {'type': 'addresses_D_ht', 'size': 16, 'AVXalign': False, 'NT': True, 'congruent': 0, 'same': False}}
