...
push %rdx
push %rsi
lea addresses_UC_ht+0x1267b, %r14
nop
nop
nop
nop
...
nop
and $56240, %r9
lea addresses_D_ht+0x1187b, %rdx
nop
nop
nop
nop
...
nop
sub $7095, %r14
lea addresses_WC_ht+0x13a7b, %rax
nop
nop
nop
nop
...
nop
cmp %r12, %r12
lea addresses_A_ht+0x1913b, %rsi
lea addresses_D_ht+0x367b, %rdi
nop
nop
sub $14184, %r9
mov $96, %rcx
...
nop
dec %r14
lea addresses_WT_ht+0x4392, %rdx
dec %r14
mov (%rdx), %r8
nop
nop
...
nop
and $30024, %r8
lea addresses_WT_ht+0xc611, %rsi
lea addresses_UC_ht+0x896b, %rdi
nop
nop
nop
nop
...
nop
dec %r8
lea addresses_WT_ht+0x83fb, %rcx
nop
nop
sub %r12, %r12
mov (%rcx), %rdx
...
{'src': {'type': 'addresses_WT_ht', 'same': True, 'size': 8, 'congruent': 3, 'NT': True, 'AVXalign': False}, 'OP': 'LOAD'}
{'39': 21829}
