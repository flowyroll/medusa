...
nop
dec %rsi
lea addresses_UC_ht+0x9fa9, %r10
nop
cmp %r13, %r13
mov (%r10), %ax
nop
nop
and %r11, %r11
lea addresses_WC_ht+0x13a53, %r13
nop
nop
nop
nop
...
nop
dec %r13
lea addresses_A_ht+0x2ba9, %rsi
lea addresses_UC_ht+0x11429, %rdi
xor %r10, %r10
mov $62, %rcx
rep movsq
nop
...
nop
sub $45729, %rdi
lea addresses_normal_ht+0x3c99, %rsi
lea addresses_A_ht+0x1dd29, %rdi
nop
nop
nop
inc %r13
...
nop
cmp $21501, %rcx
lea addresses_WT_ht+0xc500, %r13
nop
nop
nop
nop
...
nop
sub %rdi, %rdi
lea addresses_WC_ht+0x16529, %rsi
lea addresses_D_ht+0x10d51, %rdi
nop
nop
nop
lfence
...
movb $0x61, (%rax)
dec %r12
lea addresses_normal_ht+0xa529, %rdi
clflush (%rdi)
nop
nop
nop
...
nop
add %r10, %r10
lea addresses_UC_ht+0xc010, %rcx
nop
nop
nop
nop
...
nop
cmp %rsi, %rsi
lea addresses_WC_ht+0xf129, %r11
nop
nop
nop
nop
...
// REPMOV
lea addresses_normal+0xd0e9, %rsi
lea addresses_UC+0x2f29, %rdi
cmp %r13, %r13
mov $40, %rcx
rep movsb
nop
...
// Faulty Load
lea addresses_normal+0x13529, %rcx
nop
nop
xor %rbx, %rbx
mov (%rcx), %r13d
...
{'src': {'congruent': 4, 'same': False, 'type': 'addresses_normal'}, 'OP': 'REPM', 'dst': {'congruent': 9, 'same': False, 'type': 'addresses_UC'}}
[Faulty Load]
