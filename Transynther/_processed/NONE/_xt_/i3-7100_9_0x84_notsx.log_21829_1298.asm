...
push %rdi
push %rsi
lea addresses_WT_ht+0x1033e, %r12
sub $51681, %rbx
...
nop
dec %rbx
lea addresses_normal_ht+0x1556e, %rcx
nop
nop
nop
nop
...
movups %xmm0, (%rcx)
xor %rcx, %rcx
lea addresses_WT_ht+0x1d0dc, %r15
nop
nop
dec %r12
mov (%r15), %ebp
...
nop
and $24889, %r12
lea addresses_UC_ht+0xef06, %rbx
nop
nop
and %rbp, %rbp
movups (%rbx), %xmm2
...
nop
add $6038, %rbx
lea addresses_normal_ht+0x15606, %r15
nop
nop
nop
nop
...
nop
cmp $7889, %r12
lea addresses_WC_ht+0x5846, %rbx
and $58275, %rbp
vmovups (%rbx), %ymm3
...
nop
and $28919, %r12
lea addresses_UC_ht+0x586, %rsi
lea addresses_D_ht+0x118f2, %rdi
nop
nop
nop
sub $33294, %rbx
...
nop
cmp $18083, %rbp
lea addresses_UC_ht+0x43eb, %rsi
lea addresses_UC_ht+0x1c8e0, %rdi
nop
nop
add %r9, %r9
mov $46, %rcx
...
nop
dec %rbp
lea addresses_WT_ht+0x1a54e, %r15
clflush (%r15)
nop
nop
nop
...
nop
xor $3848, %rbx
lea addresses_WC_ht+0x1c986, %r9
clflush (%r9)
nop
nop
nop
...
nop
inc %r8
lea addresses_A_ht+0x18686, %rbp
and %rbx, %rbx
movb $0x61, (%rbp)
nop
nop
and $18567, %r15
lea addresses_D_ht+0x1732e, %r9
xor $39662, %rbp
movw $0x6162, (%r9)
nop
nop
