...
push %rdx
push %rsi
lea addresses_normal_ht+0xcbb0, %rsi
lea addresses_D_ht+0x1cea6, %rdi
nop
nop
nop
xor $9338, %rax
...
nop
sub %rdx, %rdx
lea addresses_WT_ht+0x16a14, %rdx
nop
nop
cmp %r10, %r10
...
nop
dec %r10
lea addresses_UC_ht+0x1ef54, %rsi
lea addresses_D_ht+0xb170, %rdi
clflush (%rdi)
nop
nop
nop
...
rep movsw
cmp $24146, %rcx
lea addresses_WC_ht+0x2fb0, %rax
clflush (%rax)
nop
nop
xor $7967, %r8
...
nop
inc %rsi
lea addresses_UC_ht+0x1000, %rsi
lea addresses_A_ht+0x127b0, %rdi
nop
nop
nop
and $42082, %r9
...
nop
add $43070, %rax
lea addresses_WC_ht+0x1d6d9, %rsi
lea addresses_UC_ht+0x2db0, %rdi
and %rdx, %rdx
mov $84, %rcx
rep movsl
nop
...
nop
add %rcx, %rcx
lea addresses_normal_ht+0x3b0, %rdi
nop
nop
nop
nop
...
// Store
lea addresses_normal+0x1e5c, %rax
nop
nop
nop
nop
...
// Store
lea addresses_normal+0x1a230, %rbx
nop
nop
nop
nop
...
{'OP': 'STOR', 'dst': {'type': 'addresses_WT', 'AVXalign': True, 'congruent': 1, 'size': 4, 'same': False, 'NT': False}}
...
{'OP': 'STOR', 'dst': {'type': 'addresses_US', 'AVXalign': True, 'congruent': 1, 'size': 1, 'same': False, 'NT': False}}
[Faulty Load]
...
{'OP': 'STOR', 'dst': {'type': 'addresses_WT_ht', 'AVXalign': False, 'congruent': 2, 'size': 32, 'same': True, 'NT': False}}
