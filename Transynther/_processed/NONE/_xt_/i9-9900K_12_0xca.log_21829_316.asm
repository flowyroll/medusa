...
lea addresses_normal_ht+0xd2b2, %rdi
sub %r10, %r10
mov $72, %rcx
rep movsb
nop
nop
cmp $15300, %rdi
lea addresses_D_ht+0xa2b2, %rsi
lea addresses_UC_ht+0x10ab2, %rdi
nop
nop
nop
nop
...
lea addresses_normal_ht+0x1b752, %rdi
cmp %r14, %r14
mov $125, %rcx
rep movsl
nop
...
nop
dec %rbx
lea addresses_UC_ht+0x15fb2, %rsi
lea addresses_A_ht+0xf03c, %rdi
nop
nop
nop
nop
...
nop
xor $4194, %r14
lea addresses_UC_ht+0xf4b2, %r9
nop
dec %rdi
mov (%r9), %cx
nop
xor $46154, %rcx
lea addresses_normal_ht+0x6b2, %rax
inc %r10
movl $0x61626364, (%rax)
nop
nop
nop
cmp %r14, %r14
lea addresses_WC_ht+0xcdb2, %r11
add $4028, %rsi
movb $0x61, (%r11)
nop
nop
...
{'OP': 'REPM', 'src': {'same': False, 'type': 'addresses_UC_ht', 'congruent': 9}, 'dst': {'same': False, 'type': 'addresses_normal_ht', 'congruent': 9}}
{'OP': 'REPM', 'src': {'same': False, 'type': 'addresses_D_ht', 'congruent': 9}, 'dst': {'same': True, 'type': 'addresses_UC_ht', 'congruent': 8}}
{'OP': 'REPM', 'src': {'same': False, 'type': 'addresses_WT_ht', 'congruent': 1}, 'dst': {'same': False, 'type': 'addresses_normal_ht', 'congruent': 5}}
{'OP': 'REPM', 'src': {'same': False, 'type': 'addresses_UC_ht', 'congruent': 8}, 'dst': {'same': False, 'type': 'addresses_A_ht', 'congruent': 1}}
