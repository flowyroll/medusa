...
nop
cmp %r9, %r9
lea addresses_UC_ht+0x28bd, %r12
nop
nop
nop
nop
...
mov (%r12), %ax
add %r11, %r11
lea addresses_WC_ht+0x37fd, %rsi
...
nop
inc %rax
lea addresses_normal_ht+0xfd7d, %r9
clflush (%r9)
nop
nop
nop
...
nop
and %rsi, %rsi
lea addresses_UC_ht+0xf9fd, %r11
add %rbx, %rbx
...
nop
and %rbx, %rbx
lea addresses_A_ht+0x1b3ad, %rbx
clflush (%rbx)
nop
nop
nop
...
movb (%rbx), %cl
cmp $61315, %rsi
lea addresses_WC_ht+0x1d585, %rbx
nop
and $8728, %rdi
vmovups (%rbx), %ymm7
