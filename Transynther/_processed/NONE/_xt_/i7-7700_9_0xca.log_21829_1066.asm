...
push %rbx
push %rdi
lea addresses_D_ht+0x17fa2, %rbx
nop
nop
sub %r12, %r12
...
movaps %xmm6, (%rdi)
and $2061, %rdi
lea addresses_normal_ht+0x24ee, %r12
nop
nop
nop
cmp $23873, %r11
...
nop
and $41174, %rdi
lea addresses_A_ht+0x1186e, %r11
nop
and %r9, %r9
mov (%r11), %r8d
nop
...
nop
xor $6239, %rbp
lea addresses_UC_ht+0x1b3b6, %r8
nop
nop
nop
nop
...
vpextrq $0, %xmm0, %r12
and $56335, %r9
lea addresses_UC_ht+0x9b5c, %rbx
nop
nop
nop
nop
...
// Faulty Load
lea addresses_normal+0xa4ee, %r8
dec %rdx
mov (%r8), %ebp
lea oracles, %rdx
and $0xff, %rbp
...
{'OP': 'STOR', 'dst': {'congruent': 5, 'AVXalign': True, 'same': False, 'size': 16, 'NT': False, 'type': 'addresses_UC_ht'}}
