...
push %rdx
push %rsi
lea addresses_WC_ht+0xc54a, %r13
nop
nop
inc %r10
...
nop
inc %rdx
lea addresses_UC_ht+0x10ccb, %r9
nop
nop
nop
nop
...
nop
sub $4318, %r10
lea addresses_D_ht+0x18eb, %rsi
lea addresses_WC_ht+0x18247, %rdi
nop
nop
xor $38663, %rbx
mov $19, %rcx
...
// Store
lea addresses_normal+0xcc8b, %r11
nop
nop
add %rbp, %rbp
movw $0x5152, (%r11)
...
// Faulty Load
lea addresses_normal+0x1bccb, %r8
nop
nop
nop
inc %rdx
...
{'src': {'congruent': 3, 'same': False, 'type': 'addresses_D_ht'}, 'OP': 'REPM', 'dst': {'congruent': 0, 'same': False, 'type': 'addresses_WC_ht'}}
{'34': 21829}
