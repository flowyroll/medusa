...
push %rdx
push %rsi
lea addresses_UC_ht+0x1df80, %rsi
lea addresses_UC_ht+0xdd80, %rdi
sub $58096, %r13
mov $34, %rcx
rep movsl
nop
nop
xor $25479, %rdx
lea addresses_UC_ht+0x393a, %rsi
lea addresses_D_ht+0x1edf0, %rdi
nop
and %rbp, %rbp
mov $125, %rcx
rep movsq
xor %rbp, %rbp
lea addresses_D_ht+0x1e00, %r13
nop
sub $49059, %rcx
mov (%r13), %rdi
sub $48275, %r13
lea addresses_WC_ht+0x175a0, %rdx
nop
nop
add $24903, %r10
movups (%rdx), %xmm4
...
nop
sub %rcx, %rcx
lea addresses_normal_ht+0xb980, %rsi
lea addresses_WT_ht+0xe00, %rdi
clflush (%rsi)
nop
sub $47177, %r13
mov $50, %rcx
...
nop
cmp $29653, %r10
lea addresses_D_ht+0x1ed00, %rsi
lea addresses_WT_ht+0x1c100, %rdi
clflush (%rdi)
nop
nop
nop
...
rep movsl
cmp $37750, %rbp
lea addresses_WT_ht+0x13f00, %rsi
lea addresses_UC_ht+0x18080, %rdi
nop
inc %rax
mov $30, %rcx
rep movsw
xor %rax, %rax
lea addresses_WT_ht+0x7150, %rax
nop
dec %rcx
mov (%rax), %ebp
nop
...
nop
cmp %rdx, %rdx
lea addresses_WT_ht+0x63c0, %rsi
lea addresses_WT_ht+0xc900, %rdi
sub %rbp, %rbp
mov $58, %rcx
rep movsq
nop
...
nop
add %rax, %rax
lea addresses_UC_ht+0x14800, %r13
nop
nop
nop
nop
...
nop
xor $39221, %rdx
lea addresses_normal_ht+0x172c0, %rsi
lea addresses_A_ht+0x1cb78, %rdi
nop
nop
nop
sub %r10, %r10
...
nop
xor %r13, %r13
lea addresses_D_ht+0xf464, %rsi
lea addresses_A_ht+0x1040, %rdi
nop
xor $51092, %rbp
mov $6, %rcx
rep movsq
...
nop
sub $6142, %rdx
lea addresses_normal_ht+0x9700, %r10
nop
nop
inc %r13
mov (%r10), %bp
...
{'OP': 'REPM', 'src': {'type': 'addresses_normal_ht', 'congruent': 3, 'same': False}, 'dst': {'type': 'addresses_A_ht', 'congruent': 2, 'same': True}}
{'OP': 'STOR', 'dst': {'type': 'addresses_D_ht', 'AVXalign': False, 'congruent': 4, 'size': 16, 'same': False, 'NT': False}}
{'OP': 'STOR', 'dst': {'type': 'addresses_D_ht', 'AVXalign': False, 'congruent': 4, 'size': 1, 'same': True, 'NT': False}}
{'OP': 'REPM', 'src': {'type': 'addresses_D_ht', 'congruent': 1, 'same': True}, 'dst': {'type': 'addresses_A_ht', 'congruent': 5, 'same': False}}
