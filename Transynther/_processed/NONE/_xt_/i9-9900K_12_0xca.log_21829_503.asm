...
{'OP': 'STOR', 'dst': {'size': 2, 'NT': True, 'type': 'addresses_NC', 'same': False, 'AVXalign': True, 'congruent': 1}}
[Faulty Load]
{'OP': 'LOAD', 'src': {'size': 2, 'NT': False, 'type': 'addresses_D', 'same': True, 'AVXalign': False, 'congruent': 0}}
<gen_prepare_buffer>
{'36': 21829}
