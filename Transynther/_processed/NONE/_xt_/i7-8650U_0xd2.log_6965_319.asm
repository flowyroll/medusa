...
push %rdi
push %rsi
lea addresses_WT_ht+0x132ab, %rsi
lea addresses_normal_ht+0x1cd0b, %rdi
nop
nop
and %r13, %r13
mov $14, %rcx
...
nop
inc %r10
lea addresses_D_ht+0x17207, %r15
nop
nop
nop
sub %rsi, %rsi
movw $0x6162, (%r15)
and %rsi, %rsi
lea addresses_D_ht+0x183b7, %rsi
lea addresses_UC_ht+0x7fcf, %rdi
nop
nop
nop
nop
...
nop
dec %r10
lea addresses_UC_ht+0x1d59, %rsi
lea addresses_WT_ht+0xa4f, %rdi
nop
nop
nop
add $10281, %rbp
...
nop
dec %r10
lea addresses_WC_ht+0x1294f, %rsi
lea addresses_D_ht+0x3c5f, %rdi
xor %rbp, %rbp
mov $31, %rcx
rep movsw
nop
...
nop
and $10362, %r13
lea addresses_WC_ht+0x1713f, %rsi
...
// Store
lea addresses_normal+0x1f94f, %r9
sub $32080, %r10
mov $0x5152535455565758, %r12
movq %r12, (%r9)
nop
...
<gen_prepare_buffer>
{'OP': 'REPM', 'src': {'type': 'addresses_WT_ht', 'congruent': 2, 'same': False}, 'dst': {'type': 'addresses_normal_ht', 'congruent': 2, 'same': False}}
{'OP': 'STOR', 'dst': {'type': 'addresses_D_ht', 'size': 2, 'AVXalign': True, 'NT': False, 'congruent': 3, 'same': False}}
