...
push %rdi
push %rsi
lea addresses_UC_ht+0x3077, %rax
nop
nop
nop
nop
...
nop
cmp %r8, %r8
lea addresses_UC_ht+0x1e1dc, %rax
sub %r9, %r9
movb $0x61, (%rax)
nop
nop
...
nop
inc %rsi
lea addresses_UC_ht+0x904b, %rsi
nop
nop
nop
inc %r12
...
nop
inc %r9
lea addresses_WC_ht+0x7143, %rdi
nop
add $11005, %rax
movw $0x6162, (%rdi)
nop
...
// Store
lea addresses_normal+0x6a37, %r14
nop
nop
nop
nop
...
{'src': {'type': 'addresses_A_ht', 'congruent': 4, 'same': False}, 'OP': 'REPM', 'dst': {'type': 'addresses_UC_ht', 'congruent': 9, 'same': False}}
...
{'OP': 'STOR', 'dst': {'type': 'addresses_WC_ht', 'AVXalign': True, 'size': 2, 'NT': False, 'same': False, 'congruent': 1}}
{'39': 21829}
