...
push %rdx
push %rsi
lea addresses_A_ht+0xe964, %rax
nop
add $34047, %rdi
movw $0x6162, (%rax)
nop
and %rdx, %rdx
lea addresses_UC_ht+0x4689, %r14
nop
inc %rax
...
nop
sub %r14, %r14
lea addresses_WT_ht+0x1104b, %rbx
dec %r11
...
nop
dec %rdi
lea addresses_WC_ht+0x7e31, %rsi
lea addresses_UC_ht+0x1d98d, %rdi
nop
nop
and %rax, %rax
mov $1, %rcx
...
nop
add $14673, %rdi
lea addresses_WC_ht+0xf8e9, %rsi
lea addresses_D_ht+0x142e9, %rdi
xor %rbx, %rbx
mov $104, %rcx
rep movsq
nop
