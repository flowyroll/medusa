...
push %rdi
push %rsi
lea addresses_WT_ht+0x3f3a, %r14
nop
nop
nop
add %rax, %rax
...
nop
sub $27460, %r13
lea addresses_D_ht+0x1eb2e, %rsi
lea addresses_A_ht+0x14a3a, %rdi
and $23034, %r10
mov $17, %rcx
rep movsw
nop
...
nop
add $64488, %rcx
lea addresses_normal_ht+0x1cabc, %rsi
lea addresses_WC_ht+0xf43a, %rdi
nop
nop
nop
nop
...
rep movsb
add %rbx, %rbx
lea addresses_A_ht+0x943a, %rdi
inc %rax
mov (%rdi), %r10d
nop
inc %r14
lea addresses_WT_ht+0x1cb3a, %rsi
...
nop
and $32042, %rsi
lea addresses_UC_ht+0x1907a, %rax
nop
nop
nop
nop
...
nop
sub %r13, %r13
lea addresses_A_ht+0x1297b, %rax
xor %r14, %r14
mov (%rax), %rcx
add $22135, %r13
lea addresses_normal_ht+0x1db62, %r14
nop
nop
add %rbx, %rbx
mov (%r14), %r10
add $62672, %rax
lea addresses_normal_ht+0x1a2b0, %r10
nop
nop
nop
nop
...
nop
sub %r14, %r14
lea addresses_D_ht+0x1d33a, %rsi
lea addresses_UC_ht+0x1512a, %rdi
nop
and %rbx, %rbx
mov $33, %rcx
rep movsq
...
nop
add $57600, %rsi
lea addresses_WT_ht+0x113a, %rsi
nop
nop
and %r14, %r14
movups (%rsi), %xmm3
...
{'dst': {'same': True, 'congruent': 7, 'type': 'addresses_normal_ht'}, 'OP': 'REPM', 'src': {'same': False, 'congruent': 10, 'type': 'addresses_WT_ht'}}
{'OP': 'LOAD', 'src': {'same': False, 'NT': False, 'AVXalign': True, 'size': 4, 'type': 'addresses_UC_ht', 'congruent': 6}}
...
{'dst': {'same': True, 'NT': True, 'AVXalign': True, 'size': 8, 'type': 'addresses_normal_ht', 'congruent': 0}, 'OP': 'STOR'}
