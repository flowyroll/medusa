...
rep movsq
dec %r14
lea addresses_WC_ht+0xf487, %r14
nop
nop
nop
nop
...
nop
dec %rbp
lea addresses_normal_ht+0x14cdf, %rcx
nop
nop
nop
nop
...
nop
inc %rsi
lea addresses_D_ht+0x1161f, %rsi
lea addresses_WC_ht+0x194df, %rdi
sub %r12, %r12
mov $0, %rcx
rep movsb
nop
...
{'OP': 'STOR', 'dst': {'type': 'addresses_WT', 'size': 32, 'AVXalign': True, 'NT': False, 'congruent': 0, 'same': False}}
[Faulty Load]
