...
vpextrq $0, %xmm5, %r13
and $63689, %r10
lea addresses_WT_ht+0x19545, %rsi
lea addresses_normal_ht+0xbde5, %rdi
nop
nop
nop
nop
...
lea addresses_D_ht+0x10dc5, %rdi
inc %r13
mov $118, %rcx
rep movsl
dec %r9
...
{'OP': 'LOAD', 'src': {'same': False, 'type': 'addresses_D', 'NT': True, 'AVXalign': False, 'size': 4, 'congruent': 8}}
[Faulty Load]
