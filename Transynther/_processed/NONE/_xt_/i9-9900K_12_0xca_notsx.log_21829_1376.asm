...
push %rdi
push %rsi
lea addresses_WC_ht+0x47db, %rdi
clflush (%rdi)
add %r14, %r14
mov (%rdi), %r11
add %r9, %r9
lea addresses_WT_ht+0x1c75b, %rax
nop
nop
nop
nop
...
nop
xor %r14, %r14
lea addresses_WC_ht+0x479b, %rsi
lea addresses_UC_ht+0x14c5b, %rdi
nop
and $15192, %r9
mov $108, %rcx
rep movsb
