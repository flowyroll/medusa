...
push %rdx
push %rsi
lea addresses_normal_ht+0x1257a, %rsi
lea addresses_WT_ht+0x513a, %rdi
nop
nop
and %r11, %r11
mov $91, %rcx
...
nop
and %r14, %r14
lea addresses_D_ht+0x1037a, %rcx
xor %rdx, %rdx
mov $0x6162636465666768, %r11
movq %r11, %xmm7
vmovups %ymm7, (%rcx)
and $46150, %r14
lea addresses_WC_ht+0x257a, %rdi
nop
add %rcx, %rcx
mov (%rdi), %r14w
nop
...
nop
add $40985, %rdx
lea addresses_normal_ht+0x161da, %rsi
lea addresses_WT_ht+0x18d7a, %rdi
nop
nop
nop
nop
...
nop
sub $60218, %rdx
lea addresses_normal_ht+0xc9b4, %rcx
clflush (%rcx)
nop
nop
nop
...
nop
inc %rsi
lea addresses_WC_ht+0x1947a, %rsi
lea addresses_WC_ht+0x1973a, %rdi
cmp %rdx, %rdx
mov $92, %rcx
rep movsw
nop
...
nop
cmp $41455, %rdi
lea addresses_A_ht+0xba, %rsi
lea addresses_D_ht+0xb5fa, %rdi
nop
nop
sub $34541, %r14
mov $81, %rcx
rep movsw
inc %rdx
lea addresses_UC_ht+0x102ba, %r10
nop
nop
nop
nop
...
nop
and %rdi, %rdi
lea addresses_WC_ht+0x19d7a, %r11
nop
nop
nop
add $7495, %rdx
...
// Faulty Load
lea addresses_normal+0x1497a, %r13
nop
nop
sub $12730, %rdi
mov (%r13), %ebp
...
{'src': {'type': 'addresses_normal_ht', 'congruent': 5, 'same': True}, 'OP': 'REPM', 'dst': {'type': 'addresses_WT_ht', 'congruent': 9, 'same': False}}
...
{'src': {'type': 'addresses_A_ht', 'congruent': 6, 'same': False}, 'OP': 'REPM', 'dst': {'type': 'addresses_D_ht', 'congruent': 7, 'same': False}}
{'OP': 'STOR', 'dst': {'same': False, 'congruent': 6, 'NT': False, 'type': 'addresses_UC_ht', 'size': 2, 'AVXalign': True}}
