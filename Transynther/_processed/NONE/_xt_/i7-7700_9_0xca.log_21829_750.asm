...
push %rdi
push %rsi
lea addresses_UC_ht+0xbf6b, %r14
nop
nop
nop
xor %rax, %rax
...
nop
inc %rdi
lea addresses_WC_ht+0x1806b, %rcx
sub %rax, %rax
mov (%rcx), %r10d
nop
nop
...
nop
dec %rdi
lea addresses_WT_ht+0x1cbab, %rax
nop
nop
nop
cmp %r11, %r11
...
nop
cmp %rcx, %rcx
lea addresses_WT_ht+0x186b, %rsi
lea addresses_WT_ht+0x216b, %rdi
nop
nop
nop
nop
...
nop
cmp %rdi, %rdi
lea addresses_normal_ht+0x8e0b, %r11
and $32767, %rax
mov $0x6162636465666768, %r10
movq %r10, (%r11)
nop
and $9370, %r10
lea addresses_normal_ht+0xbc0b, %r10
and %r11, %r11
movb $0x61, (%r10)
nop
inc %rax
lea addresses_UC_ht+0x15b8b, %rdi
nop
dec %rax
...
lea addresses_WT_ht+0x17eb, %rdi
nop
nop
nop
nop
...
nop
dec %r9
lea addresses_normal_ht+0x15e6b, %rdi
nop
cmp %r11, %r11
movw $0x6162, (%rdi)
nop
and $55362, %r14
lea addresses_D_ht+0x15e4b, %rsi
lea addresses_normal_ht+0x1446b, %rdi
nop
nop
nop
dec %r14
...
nop
xor %rsi, %rsi
lea addresses_WT_ht+0xae57, %r14
nop
nop
and %r10, %r10
mov (%r14), %esi
...
{'OP': 'STOR', 'dst': {'congruent': 11, 'AVXalign': False, 'same': False, 'size': 32, 'NT': True, 'type': 'addresses_D_ht'}}
...
{'src': {'congruent': 9, 'same': True, 'type': 'addresses_A_ht'}, 'OP': 'REPM', 'dst': {'congruent': 5, 'same': True, 'type': 'addresses_WT_ht'}}
{'OP': 'STOR', 'dst': {'congruent': 9, 'AVXalign': False, 'same': False, 'size': 2, 'NT': False, 'type': 'addresses_normal_ht'}}
{'src': {'congruent': 3, 'same': False, 'type': 'addresses_D_ht'}, 'OP': 'REPM', 'dst': {'congruent': 9, 'same': False, 'type': 'addresses_normal_ht'}}
