...
push %rdi
push %rsi
lea addresses_D_ht+0x1786b, %rsi
...
nop
xor $39088, %rsi
lea addresses_D_ht+0x19e1d, %r15
and $42299, %r12
movw $0x6162, (%r15)
nop
inc %rsi
lea addresses_A_ht+0x1084b, %rsi
lea addresses_A_ht+0x17d4b, %rdi
nop
nop
nop
nop
...
nop
cmp %rsi, %rsi
lea addresses_WT_ht+0x123cb, %r9
nop
nop
nop
nop
...
mov (%r9), %r15d
cmp %rcx, %rcx
lea addresses_WC_ht+0x134ef, %rcx
nop
nop
nop
xor $62097, %r9
...
// Store
lea addresses_normal+0xc54b, %rbx
nop
nop
nop
inc %rbp
...
// Faulty Load
lea addresses_normal+0x14d4b, %r13
nop
nop
nop
nop
...
{'OP': 'STOR', 'dst': {'type': 'addresses_D', 'AVXalign': False, 'congruent': 8, 'size': 16, 'same': False, 'NT': True}}
{'OP': 'STOR', 'dst': {'type': 'addresses_NC', 'AVXalign': True, 'congruent': 4, 'size': 4, 'same': False, 'NT': False}}
[Faulty Load]
