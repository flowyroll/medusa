...
push %rdi
push %rsi
lea addresses_UC_ht+0xcec9, %rbp
sub $18284, %r12
mov (%rbp), %di
nop
nop
add $20686, %r11
lea addresses_WT_ht+0xc2d2, %rsi
...
nop
sub $967, %r12
lea addresses_D_ht+0x18d89, %r12
nop
nop
inc %rbp
movb (%r12), %r11b
...
nop
and %rdi, %rdi
lea addresses_normal_ht+0x1e195, %rsi
lea addresses_A_ht+0x1c959, %rdi
nop
nop
nop
sub %r10, %r10
...
rep movsw
cmp $28976, %r11
lea addresses_UC_ht+0x12689, %rdi
nop
nop
nop
sub %rcx, %rcx
...
{'src': {'type': 'addresses_WT_ht', 'congruent': 0, 'same': False}, 'OP': 'REPM', 'dst': {'type': 'addresses_WT_ht', 'congruent': 10, 'same': False}}
{'src': {'type': 'addresses_D_ht', 'AVXalign': False, 'size': 1, 'NT': False, 'same': True, 'congruent': 9}, 'OP': 'LOAD'}
{'src': {'type': 'addresses_normal_ht', 'congruent': 2, 'same': False}, 'OP': 'REPM', 'dst': {'type': 'addresses_A_ht', 'congruent': 4, 'same': False}}
