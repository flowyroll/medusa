...
nop
xor %r14, %r14
lea addresses_WT_ht+0x139c0, %rsi
lea addresses_WT_ht+0x13690, %rdi
nop
nop
nop
nop
...
nop
sub $46916, %r14
lea addresses_A_ht+0x1b890, %rsi
nop
xor %rcx, %rcx
...
nop
dec %rax
lea addresses_WC_ht+0x158d0, %r10
clflush (%r10)
nop
nop
nop
...
mov (%r10), %di
and %rsi, %rsi
lea addresses_normal_ht+0xb9a4, %rsi
nop
nop
nop
dec %rdi
...
// Store
lea addresses_normal+0xd210, %rdx
nop
nop
nop
and %rdi, %rdi
...
// Faulty Load
lea addresses_normal+0xf390, %r10
nop
nop
xor %rbp, %rbp
mov (%r10), %ebx
...
{'OP': 'STOR', 'dst': {'same': False, 'congruent': 2, 'NT': True, 'type': 'addresses_normal_ht', 'size': 2, 'AVXalign': False}}
{'34': 21829}
