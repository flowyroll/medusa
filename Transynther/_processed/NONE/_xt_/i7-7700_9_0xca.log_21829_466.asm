...
nop
sub %r15, %r15
lea addresses_UC_ht+0xc5b4, %rcx
and %r12, %r12
mov (%rcx), %r11
nop
nop
nop
cmp %rcx, %rcx
lea addresses_UC_ht+0x8884, %rsi
lea addresses_WT_ht+0x1c7b4, %rdi
inc %r11
mov $119, %rcx
rep movsq
nop
...
nop
cmp $32685, %rsi
lea addresses_WC_ht+0x1b1f4, %rcx
lfence
...
nop
dec %r11
lea addresses_normal_ht+0xd7b4, %rdi
nop
inc %r15
movups (%rdi), %xmm5
vpextrq $0, %xmm5, %r10
...
// Faulty Load
lea addresses_normal+0x1c3b4, %r12
nop
nop
nop
nop
...
{'src': {'congruent': 3, 'same': False, 'type': 'addresses_UC_ht'}, 'OP': 'REPM', 'dst': {'congruent': 10, 'same': False, 'type': 'addresses_WT_ht'}}
