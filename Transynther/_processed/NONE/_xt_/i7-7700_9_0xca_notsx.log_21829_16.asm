...
push %rdx
push %rsi
lea addresses_A_ht+0xa443, %rsi
lea addresses_UC_ht+0x45a3, %rdi
nop
nop
nop
add $43189, %r13
...
nop
cmp $51253, %rcx
lea addresses_D_ht+0xfacb, %rbx
nop
and %rdi, %rdi
mov (%rbx), %edx
sub $34230, %rdi
lea addresses_WC_ht+0xf943, %rsi
nop
nop
nop
nop
...
nop
cmp $19400, %r13
lea addresses_D_ht+0x15743, %rcx
nop
nop
dec %r13
movb (%rcx), %bl
...
nop
and $55281, %rsi
lea addresses_WT_ht+0x1c569, %rsi
lea addresses_WC_ht+0x4b43, %rdi
nop
nop
cmp %r12, %r12
mov $32, %rcx
...
// Faulty Load
lea addresses_normal+0x1ef43, %r8
nop
nop
nop
nop
...
{'dst': {'NT': False, 'AVXalign': True, 'size': 4, 'congruent': 8, 'same': False, 'type': 'addresses_A'}, 'OP': 'STOR'}
...
{'dst': {'NT': True, 'AVXalign': False, 'size': 16, 'congruent': 8, 'same': False, 'type': 'addresses_WC_ht'}, 'OP': 'STOR'}
