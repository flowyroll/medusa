...
nop
sub $2661, %r9
lea addresses_normal_ht+0x1c0f, %rax
nop
nop
nop
mfence
...
nop
add %rdi, %rdi
lea addresses_UC_ht+0x1917f, %r10
nop
inc %rcx
...
nop
xor $32586, %rdi
lea addresses_WT_ht+0x1a185, %rsi
clflush (%rsi)
nop
nop
nop
...
nop
and $38348, %r14
lea addresses_WT_ht+0xd2bf, %rax
nop
nop
nop
cmp %r10, %r10
...
nop
and %r9, %r9
lea addresses_UC_ht+0x1c2bf, %rcx
nop
nop
inc %rdx
movb $0x61, (%rcx)
...
nop
and $50437, %r9
lea addresses_WC_ht+0x7c7f, %rdi
and $17571, %rsi
movl $0x61626364, (%rdi)
nop
inc %r14
lea addresses_WC_ht+0x1d367, %rcx
nop
nop
nop
and $24290, %rsi
...
{'OP': 'STOR', 'dst': {'same': True, 'congruent': 11, 'NT': True, 'type': 'addresses_UC_ht', 'size': 32, 'AVXalign': True}}
{'OP': 'STOR', 'dst': {'same': False, 'congruent': 0, 'NT': False, 'type': 'addresses_WT_ht', 'size': 2, 'AVXalign': True}}
...
{'OP': 'STOR', 'dst': {'same': False, 'congruent': 7, 'NT': False, 'type': 'addresses_WC_ht', 'size': 4, 'AVXalign': True}}
{'src': {'same': False, 'congruent': 3, 'NT': True, 'type': 'addresses_WC_ht', 'size': 16, 'AVXalign': False}, 'OP': 'LOAD'}
{'38': 21829}
