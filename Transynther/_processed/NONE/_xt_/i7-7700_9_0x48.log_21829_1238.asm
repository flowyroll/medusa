...
push %rdi
push %rsi
lea addresses_WC_ht+0x3610, %rbp
nop
nop
cmp $53643, %rcx
...
nop
dec %rdi
lea addresses_WC_ht+0x9010, %rbp
nop
nop
nop
cmp %r10, %r10
...
nop
sub $35372, %rcx
lea addresses_UC_ht+0x1be10, %rsi
...
nop
cmp $42103, %r13
lea addresses_normal_ht+0x7110, %rsi
lea addresses_UC_ht+0x14998, %rdi
nop
nop
nop
nop
...
rep movsl
inc %r13
lea addresses_normal_ht+0x15fe0, %r10
nop
sub $12489, %rdi
mov $0x6162636465666768, %rbp
movq %rbp, (%r10)
add $24663, %rcx
lea addresses_D_ht+0x1d510, %r10
nop
nop
nop
dec %r9
...
{'OP': 'STOR', 'dst': {'type': 'addresses_A', 'AVXalign': True, 'congruent': 5, 'size': 1, 'same': False, 'NT': False}}
...
{'OP': 'REPM', 'src': {'type': 'addresses_normal_ht', 'congruent': 8, 'same': False}, 'dst': {'type': 'addresses_UC_ht', 'congruent': 3, 'same': False}}
