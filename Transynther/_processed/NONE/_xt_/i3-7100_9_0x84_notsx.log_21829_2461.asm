...
push %rdi
push %rdx
lea addresses_WT_ht+0x13ba8, %r13
nop
nop
nop
sub %rdi, %rdi
...
nop
add %r13, %r13
lea addresses_normal_ht+0x2d98, %r15
clflush (%r15)
nop
nop
nop
...
nop
sub $15647, %rbx
lea addresses_UC_ht+0x7984, %rdx
nop
nop
sub %r8, %r8
mov (%rdx), %r9
nop
xor %r15, %r15
lea addresses_normal_ht+0x489c, %r13
clflush (%r13)
nop
nop
nop
...
nop
add %rbx, %rbx
lea addresses_D_ht+0x1ec9c, %r15
clflush (%r15)
nop
add $26543, %rbx
movb $0x61, (%r15)
...
nop
cmp %rbx, %rbx
lea addresses_D_ht+0x2e04, %r15
nop
add %rdx, %rdx
mov (%r15), %di
nop
dec %rbx
lea addresses_A_ht+0x2c9c, %r13
nop
nop
nop
nop
...
nop
sub $55625, %r9
lea addresses_WC_ht+0x13465, %r13
nop
nop
nop
nop
...
nop
sub %r9, %r9
lea addresses_WT_ht+0x709c, %r13
xor %rdi, %rdi
mov (%r13), %r8w
nop
nop
...
nop
xor %rdx, %rdx
lea addresses_WC_ht+0x1b89c, %r13
dec %r8
movups (%r13), %xmm0
vpextrq $1, %xmm0, %rdi
nop
