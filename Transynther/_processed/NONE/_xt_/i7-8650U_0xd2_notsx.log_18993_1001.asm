...
nop
inc %rbx
lea addresses_WC_ht+0xa67f, %rsi
nop
nop
nop
nop
...
mov (%rsi), %r8d
dec %rdi
lea addresses_normal_ht+0x1b69f, %rdi
nop
nop
nop
nop
...
mov (%rdi), %r8d
cmp %rdi, %rdi
lea addresses_normal_ht+0x1af5f, %r12
nop
nop
nop
nop
...
nop
inc %rbx
lea addresses_normal_ht+0xb3f, %r12
clflush (%r12)
nop
nop
nop
...
movw $0x6162, (%r12)
sub $44032, %r13
lea addresses_normal_ht+0x7b5f, %r13
cmp $31053, %rbx
mov (%r13), %rdi
nop
nop
