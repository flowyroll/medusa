...
nop
xor %r15, %r15
lea addresses_UC_ht+0x10818, %r14
nop
nop
nop
xor $40663, %rbx
...
nop
xor $21939, %rbx
lea addresses_D_ht+0x17c18, %rsi
lea addresses_WC_ht+0x19c18, %rdi
add %rbp, %rbp
mov $40, %rcx
rep movsb
nop
...
// Store
lea addresses_normal+0xdc18, %r14
inc %rcx
movw $0x5152, (%r14)
nop
nop
...
// Faulty Load
lea addresses_normal+0xd418, %rbp
nop
nop
nop
nop
...
{'OP': 'REPM', 'src': {'type': 'addresses_D_ht', 'congruent': 11, 'same': False}, 'dst': {'type': 'addresses_WC_ht', 'congruent': 11, 'same': False}}
