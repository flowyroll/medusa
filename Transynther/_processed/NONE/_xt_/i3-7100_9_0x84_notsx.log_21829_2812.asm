...
push %rdi
push %rsi
lea addresses_WT_ht+0x169ad, %r12
nop
nop
nop
nop
...
nop
cmp %rdi, %rdi
lea addresses_WC_ht+0x16c25, %r13
nop
nop
nop
nop
...
nop
cmp %r13, %r13
lea addresses_UC_ht+0x124d1, %rsi
lea addresses_WT_ht+0x56d1, %rdi
nop
nop
nop
nop
...
nop
sub %r11, %r11
lea addresses_A_ht+0xbe51, %rsi
lea addresses_UC_ht+0x68b1, %rdi
nop
nop
nop
nop
...
nop
cmp $20918, %r8
lea addresses_UC_ht+0x7dbf, %rcx
nop
nop
nop
nop
...
nop
sub %r12, %r12
lea addresses_D_ht+0x1b751, %rsi
lea addresses_WC_ht+0x7ed1, %rdi
nop
nop
nop
nop
...
rep movsl
dec %r14
lea addresses_WT_ht+0x1e851, %rsi
nop
cmp $13411, %rdi
movl $0x61626364, (%rsi)
nop
...
// Faulty Load
lea addresses_normal+0x162d1, %r10
nop
nop
nop
nop
