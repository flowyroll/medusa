...
push %rdx
push %rsi
lea addresses_normal_ht+0x56d4, %rcx
nop
nop
add %rdx, %rdx
...
nop
cmp %rsi, %rsi
lea addresses_UC_ht+0x41bc, %rbp
nop
nop
nop
add %rbx, %rbx
...
nop
sub %r13, %r13
lea addresses_WT_ht+0x121bc, %r13
nop
nop
and $14201, %rcx
mov $0x6162636465666768, %rsi
...
nop
and %rsi, %rsi
lea addresses_UC_ht+0x1e13c, %rdx
add %rcx, %rcx
movups (%rdx), %xmm3
vpextrq $0, %xmm3, %rbp
nop
...
nop
xor $473, %rbx
lea addresses_UC_ht+0x19116, %rsi
lea addresses_normal_ht+0x106bc, %rdi
cmp %rbp, %rbp
mov $114, %rcx
rep movsl
nop
nop
and %rsi, %rsi
lea addresses_WT_ht+0x5cf4, %rsi
lea addresses_WC_ht+0x296c, %rdi
nop
nop
cmp $17991, %rbx
mov $76, %rcx
...
nop
sub %rcx, %rcx
lea addresses_WC_ht+0x1df3c, %rdx
nop
xor %rcx, %rcx
mov (%rdx), %di
nop
...
nop
lfence
lea addresses_D_ht+0x159bc, %rsi
lea addresses_normal_ht+0x25bc, %rdi
nop
nop
nop
nop
...
nop
sub $33447, %rdx
lea addresses_normal_ht+0x14b3c, %rdi
nop
xor %rsi, %rsi
mov (%rdi), %dx
nop
...
nop
add $31175, %rbp
lea addresses_UC_ht+0xc7bc, %rdi
nop
nop
nop
nop
...
nop
add %rdi, %rdi
lea addresses_WT_ht+0xb1bc, %rsi
lea addresses_D_ht+0x33bc, %rdi
xor $34336, %rdx
mov $126, %rcx
rep movsq
sub %rsi, %rsi
lea addresses_UC_ht+0xa9bc, %rbx
nop
add $7316, %rbp
mov (%rbx), %edx
nop
...
nop
xor $3819, %rdi
lea addresses_normal_ht+0xd9bc, %rdi
nop
cmp $42717, %rbx
...
// Faulty Load
lea addresses_normal+0x51bc, %rbx
nop
nop
nop
nop
...
{'dst': {'same': False, 'NT': False, 'AVXalign': True, 'size': 32, 'type': 'addresses_WT_ht', 'congruent': 11}, 'OP': 'STOR'}
