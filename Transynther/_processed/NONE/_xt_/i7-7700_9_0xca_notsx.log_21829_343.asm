...
push %rdi
push %rsi
lea addresses_normal_ht+0xe51, %rsi
lea addresses_WC_ht+0xfd41, %rdi
clflush (%rsi)
add $42283, %rbp
mov $3, %rcx
rep movsw
sub %rdi, %rdi
lea addresses_WC_ht+0xf055, %r15
clflush (%r15)
nop
nop
sub $32735, %rcx
...
nop
cmp %r15, %r15
lea addresses_WC_ht+0x39d1, %r15
nop
nop
nop
nop
...
nop
cmp $39571, %rdi
lea addresses_UC_ht+0xe201, %rdi
nop
nop
nop
sub %rbx, %rbx
...
nop
cmp %rbp, %rbp
lea addresses_WT_ht+0x1ac01, %rbx
nop
nop
nop
add $54370, %r11
...
nop
cmp %r15, %r15
lea addresses_WT_ht+0xaf81, %r15
nop
nop
nop
xor %rbx, %rbx
...
movups %xmm4, (%rbx)
inc %rbp
lea addresses_WT_ht+0x15081, %rdi
nop
nop
nop
add $24052, %rbp
...
nop
xor %rbx, %rbx
lea addresses_A_ht+0x18ccb, %r11
nop
nop
and $21763, %rcx
mov $0x6162636465666768, %rsi
...
nop
xor %rdi, %rdi
lea addresses_WC_ht+0x13c79, %rsi
lea addresses_UC_ht+0x6101, %rdi
sub %rbx, %rbx
mov $17, %rcx
rep movsl
nop
...
nop
and $53137, %rbx
lea addresses_A_ht+0x1d681, %rcx
clflush (%rcx)
nop
nop
cmp %rdi, %rdi
...
nop
xor $27164, %rsi
lea addresses_UC_ht+0x1cb81, %rsi
lea addresses_D_ht+0x16881, %rdi
nop
nop
nop
add %r13, %r13
...
{'src': {'congruent': 2, 'same': False, 'type': 'addresses_WC_ht'}, 'dst': {'congruent': 7, 'same': False, 'type': 'addresses_UC_ht'}, 'OP': 'REPM'}
