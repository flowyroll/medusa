...
push %rdx
push %rsi
lea addresses_normal_ht+0xeb5d, %rsi
lea addresses_WT_ht+0x10ee5, %rdi
nop
nop
nop
and $35679, %rbx
...
nop
sub $45113, %rdi
lea addresses_D_ht+0x196cd, %rbp
clflush (%rbp)
nop
nop
nop
...
nop
cmp %rcx, %rcx
lea addresses_UC_ht+0x4e97, %rsi
lea addresses_A_ht+0x1715d, %rdi
nop
nop
and %rbx, %rbx
mov $2, %rcx
...
nop
sub $35640, %r8
lea addresses_WT_ht+0xe55d, %rdi
nop
nop
dec %rdx
...
nop
add $19819, %rcx
lea addresses_WT_ht+0x1ef5d, %r8
nop
nop
nop
and %rsi, %rsi
...
nop
sub $59933, %rbx
lea addresses_UC_ht+0x53c5, %rbx
nop
xor %rcx, %rcx
movw $0x6162, (%rbx)
inc %rbp
lea addresses_WC_ht+0x13ed, %rbx
nop
nop
nop
nop
...
nop
sub $45032, %rdx
lea addresses_normal_ht+0x1505d, %rsi
lea addresses_UC_ht+0x1532d, %rdi
nop
and %r10, %r10
mov $92, %rcx
rep movsq
xor %rbp, %rbp
lea addresses_WT_ht+0xa1ad, %r10
nop
nop
nop
nop
...
nop
and $7588, %r10
lea addresses_normal_ht+0x9f5d, %r10
clflush (%r10)
nop
nop
nop
...
nop
sub %rdx, %rdx
lea addresses_A_ht+0x18a75, %r10
nop
nop
inc %r8
mov $0x6162636465666768, %rdi
...
nop
inc %rdi
lea addresses_D_ht+0x1764f, %rdi
nop
nop
nop
nop
...
{'src': {'NT': False, 'AVXalign': False, 'size': 1, 'congruent': 7, 'same': False, 'type': 'addresses_UC'}, 'OP': 'LOAD'}
[Faulty Load]
...
{'src': {'congruent': 8, 'same': False, 'type': 'addresses_normal_ht'}, 'dst': {'congruent': 4, 'same': False, 'type': 'addresses_UC_ht'}, 'OP': 'REPM'}
{'dst': {'NT': True, 'AVXalign': False, 'size': 4, 'congruent': 3, 'same': True, 'type': 'addresses_WT_ht'}, 'OP': 'STOR'}
