...
nop
add %r14, %r14
lea addresses_normal_ht+0x103aa, %r11
nop
nop
sub $59489, %rbp
movups (%r11), %xmm6
...
nop
inc %rcx
lea addresses_D_ht+0x14530, %rsi
...
nop
and $58826, %r14
lea addresses_UC_ht+0x1bc96, %r10
nop
nop
nop
and $58326, %rcx
...
nop
dec %rsi
lea addresses_WT_ht+0x7eaa, %rsi
lea addresses_A_ht+0x6bfe, %rdi
nop
nop
nop
nop
...
rep movsb
dec %r14
lea addresses_WT_ht+0x8faa, %rcx
nop
nop
nop
cmp %rdx, %rdx
...
nop
xor $30873, %rdi
lea addresses_D_ht+0x175aa, %rdi
nop
nop
sub $13774, %r11
mov (%rdi), %rcx
...
nop
and %rbp, %rbp
lea addresses_normal_ht+0x1a2bc, %rdx
inc %rdi
movb (%rdx), %r11b
nop
nop
...
nop
dec %rbp
lea addresses_A_ht+0x1ca6a, %rbp
sub %r10, %r10
...
nop
sub %rdx, %rdx
lea addresses_A_ht+0x138ea, %rcx
nop
nop
nop
xor $18363, %r11
...
nop
mfence
lea addresses_WC_ht+0x5aaa, %rsi
lea addresses_WC_ht+0x3ea, %rdi
nop
nop
nop
nop
...
// Faulty Load
lea addresses_normal+0x1f1aa, %rax
nop
nop
xor %rbp, %rbp
movups (%rax), %xmm0
