...
push %rdi
push %rsi
lea addresses_UC_ht+0x97ed, %rsi
lea addresses_D_ht+0x24ed, %rdi
nop
nop
nop
xor %rbx, %rbx
...
nop
cmp $5273, %r14
lea addresses_WT_ht+0x1aeed, %r10
clflush (%r10)
nop
nop
sub %r12, %r12
...
nop
inc %r10
lea addresses_D_ht+0x167d, %rsi
lea addresses_WT_ht+0xa39d, %rdi
nop
and $25482, %rbp
mov $35, %rcx
rep movsw
...
nop
xor %rdi, %rdi
lea addresses_normal_ht+0x1e3c4, %rdi
inc %rcx
mov (%rdi), %rbp
nop
nop
...
nop
and %r14, %r14
lea addresses_A_ht+0x16aed, %rsi
nop
nop
nop
cmp %rbp, %rbp
