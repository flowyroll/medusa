...
push %rdi
push %rsi
lea addresses_WT_ht+0xc705, %rsi
lea addresses_D_ht+0x2305, %rdi
clflush (%rsi)
clflush (%rdi)
nop
sub $53187, %rbx
...
rep movsw
cmp $63389, %r9
lea addresses_normal_ht+0x8d05, %rsi
lea addresses_WT_ht+0x2305, %rdi
nop
nop
cmp %r9, %r9
mov $48, %rcx
...
nop
sub %rbx, %rbx
lea addresses_UC_ht+0x146c5, %rbx
inc %r12
movups (%rbx), %xmm3
vpextrq $0, %xmm3, %rcx
nop
xor %rcx, %rcx
lea addresses_D_ht+0x2f85, %rsi
lea addresses_WC_ht+0xeb05, %rdi
nop
inc %rax
mov $114, %rcx
rep movsb
add $48353, %rcx
lea addresses_UC_ht+0xf5c5, %rdi
nop
cmp $4060, %r12
mov (%rdi), %rbx
inc %r9
lea addresses_normal_ht+0x1548f, %rax
nop
nop
nop
nop
...
mov (%rax), %di
xor $40226, %r12
lea addresses_WC_ht+0xda45, %rdi
nop
nop
nop
nop
...
// REPMOV
lea addresses_UC+0x19637, %rsi
lea addresses_A+0xb4dd, %rdi
xor %r8, %r8
mov $9, %rcx
rep movsl
nop
...
// Faulty Load
lea addresses_normal+0x1b05, %r12
nop
nop
nop
nop
...
{'dst': {'NT': False, 'AVXalign': False, 'size': 4, 'congruent': 0, 'same': False, 'type': 'addresses_RW'}, 'OP': 'STOR'}
{'src': {'congruent': 1, 'same': False, 'type': 'addresses_UC'}, 'dst': {'congruent': 3, 'same': False, 'type': 'addresses_A'}, 'OP': 'REPM'}
[Faulty Load]
...
{'src': {'congruent': 9, 'same': False, 'type': 'addresses_normal_ht'}, 'dst': {'congruent': 11, 'same': False, 'type': 'addresses_WT_ht'}, 'OP': 'REPM'}
