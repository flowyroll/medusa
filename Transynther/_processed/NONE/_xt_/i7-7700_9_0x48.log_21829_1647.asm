...
push %rdi
push %rsi
lea addresses_WT_ht+0x1342f, %r15
nop
add $16518, %rcx
vmovups (%r15), %ymm4
...
vpextrq $0, %xmm4, %rsi
cmp %r9, %r9
lea addresses_UC_ht+0xc9af, %r11
nop
dec %r13
movups (%r11), %xmm2
vpextrq $0, %xmm2, %rdi
...
nop
xor $64670, %r9
lea addresses_A_ht+0x1eb3f, %rdi
nop
nop
nop
nop
...
nop
sub $14400, %rdi
lea addresses_UC_ht+0x1ddaf, %r11
clflush (%r11)
nop
add %rsi, %rsi
vmovups (%r11), %ymm2
...
nop
sub %rcx, %rcx
lea addresses_D_ht+0x651b, %rsi
lea addresses_WT_ht+0x1a9af, %rdi
clflush (%rdi)
sub %r10, %r10
mov $78, %rcx
rep movsw
...
nop
sub $8662, %r11
lea addresses_normal_ht+0x6c0f, %rcx
and %r10, %r10
mov (%rcx), %r15w
nop
nop
nop
dec %r15
lea addresses_D_ht+0x18b45, %rdi
nop
xor %r9, %r9
...
nop
sub %r11, %r11
lea addresses_UC_ht+0x125af, %rsi
lea addresses_UC_ht+0xab15, %rdi
clflush (%rdi)
nop
xor $47570, %r10
mov $51, %rcx
...
nop
xor $51253, %r9
lea addresses_UC_ht+0xd807, %rsi
lea addresses_A_ht+0x852f, %rdi
nop
nop
nop
nop
...
nop
add %r13, %r13
lea addresses_A_ht+0x1a5af, %r11
clflush (%r11)
nop
nop
nop
...
nop
add %rdi, %rdi
lea addresses_UC_ht+0x141af, %rsi
xor %r9, %r9
mov (%rsi), %r10w
lfence
pop %rsi
...
{'OP': 'STOR', 'dst': {'type': 'addresses_US', 'AVXalign': False, 'congruent': 7, 'size': 1, 'same': False, 'NT': True}}
[Faulty Load]
...
{'OP': 'REPM', 'src': {'type': 'addresses_UC_ht', 'congruent': 3, 'same': False}, 'dst': {'type': 'addresses_A_ht', 'congruent': 5, 'same': False}}
