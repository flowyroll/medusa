...
push %rdi
push %rsi
lea addresses_D_ht+0x10ad1, %r12
nop
sub $6113, %r13
movw $0x6162, (%r12)
nop
...
nop
and $16942, %r14
lea addresses_UC_ht+0xc17d, %r11
nop
cmp $20449, %r15
mov (%r11), %ecx
nop
nop
xor $33885, %r15
lea addresses_WC_ht+0x12afd, %rsi
...
rep movsb
sub %rdi, %rdi
lea addresses_UC_ht+0x1c7fd, %rdi
nop
nop
nop
nop
...
nop
and $28017, %r10
lea addresses_WT_ht+0x1ba7d, %r15
nop
nop
nop
nop
...
// Store
lea addresses_normal+0x1431d, %r12
nop
nop
inc %r11
movl $0x51525354, (%r12)
...
{'src': {'congruent': 4, 'same': False, 'type': 'addresses_WC_ht'}, 'OP': 'REPM', 'dst': {'congruent': 3, 'same': False, 'type': 'addresses_WT_ht'}}
