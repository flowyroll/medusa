...
push %rdi
push %rsi
lea addresses_normal_ht+0xe40d, %rsi
...
nop
cmp %rdi, %rdi
lea addresses_normal_ht+0x1ad96, %rsi
lea addresses_A_ht+0x1616, %rdi
nop
nop
nop
nop
...
nop
cmp %rbp, %rbp
lea addresses_UC_ht+0x39fe, %rcx
nop
sub $43224, %r10
movl $0x61626364, (%rcx)
nop
...
nop
dec %rbp
lea addresses_D_ht+0x180f6, %rsi
lea addresses_UC_ht+0x3196, %rdi
nop
add $14104, %rbp
mov $23, %rcx
rep movsw
...
// Load
lea addresses_normal+0xd196, %rdx
nop
nop
and $23298, %r11
mov (%rdx), %r10
...
// Faulty Load
lea addresses_normal+0x19996, %rsi
nop
nop
add $25409, %r11
mov (%rsi), %r8w
...
{'OP': 'STOR', 'dst': {'type': 'addresses_P', 'AVXalign': True, 'congruent': 3, 'size': 4, 'same': False, 'NT': False}}
