...
nop
sub $32842, %r15
lea addresses_UC_ht+0x1c1ed, %rax
nop
nop
nop
nop
...
// REPMOV
lea addresses_A+0x1a73d, %rsi
lea addresses_UC+0x203d, %rdi
sub $5992, %rbp
mov $29, %rcx
rep movsq
nop
...
// Faulty Load
lea addresses_normal+0xa33d, %rsi
nop
nop
nop
nop
...
{'OP': 'REPM', 'src': {'type': 'addresses_A', 'congruent': 7, 'same': False}, 'dst': {'type': 'addresses_UC', 'congruent': 7, 'same': False}}
...
{'OP': 'STOR', 'dst': {'type': 'addresses_A_ht', 'size': 8, 'AVXalign': False, 'NT': False, 'congruent': 5, 'same': True}}
