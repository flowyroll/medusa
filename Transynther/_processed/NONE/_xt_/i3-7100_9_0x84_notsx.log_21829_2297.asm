...
push %rdi
push %rsi
lea addresses_WT_ht+0x857b, %r12
nop
nop
nop
nop
...
nop
sub $4255, %rcx
lea addresses_WT_ht+0x881b, %rax
cmp %r10, %r10
movl $0x61626364, (%rax)
nop
nop
...
nop
add $46479, %r12
lea addresses_A_ht+0x1711b, %r11
nop
nop
xor $6091, %rbx
...
nop
inc %r11
lea addresses_WC_ht+0x9f3b, %rsi
lea addresses_D_ht+0x1011b, %rdi
clflush (%rdi)
nop
nop
nop
...
nop
sub $41353, %rcx
lea addresses_WC_ht+0x1628f, %rsi
lea addresses_WT_ht+0x703b, %rdi
clflush (%rdi)
sub $14640, %r10
mov $31, %rcx
rep movsl
...
nop
sub $26402, %r12
lea addresses_normal_ht+0x821b, %r10
inc %r12
...
{'src': {'type': 'addresses_WC_ht', 'congruent': 3, 'same': False}, 'dst': {'type': 'addresses_D_ht', 'congruent': 6, 'same': False}, 'OP': 'REPM'}
