...
nop
xor $32559, %rbp
lea addresses_WT_ht+0x2907, %rsi
...
rep movsl
inc %rbp
lea addresses_WT_ht+0x13d67, %rsi
nop
nop
nop
nop
...
nop
sub $34279, %r11
lea addresses_normal_ht+0xec87, %rsi
lea addresses_WT_ht+0x1e654, %rdi
nop
nop
cmp %rbp, %rbp
mov $48, %rcx
...
nop
xor %rdi, %rdi
lea addresses_WT_ht+0x2007, %rsi
...
nop
and $10879, %r11
lea addresses_normal_ht+0xbdbf, %rcx
add %r11, %r11
movb (%rcx), %r12b
nop
nop
cmp %rbp, %rbp
lea addresses_WC_ht+0x2439, %rcx
dec %rdi
movb (%rcx), %r10b
nop
add %r12, %r12
...
// Faulty Load
lea addresses_normal+0x1b807, %r10
clflush (%r10)
nop
nop
inc %r8
...
<gen_prepare_buffer>
{'src': {'congruent': 10, 'same': False, 'type': 'addresses_D_ht'}, 'dst': {'congruent': 8, 'same': True, 'type': 'addresses_normal_ht'}, 'OP': 'REPM'}
...
{'src': {'congruent': 11, 'same': False, 'type': 'addresses_WT_ht'}, 'dst': {'congruent': 10, 'same': False, 'type': 'addresses_WC_ht'}, 'OP': 'REPM'}
