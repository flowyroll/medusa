...
push %rdx
push %rsi
lea addresses_D_ht+0x12dc1, %r14
xor %rcx, %rcx
mov (%r14), %rbp
nop
nop
...
nop
add %r10, %r10
lea addresses_A_ht+0x17221, %rcx
nop
nop
sub %rbp, %rbp
mov (%rcx), %r15
...
nop
sub $13765, %r14
lea addresses_normal_ht+0x19421, %rsi
...
nop
xor $60044, %rdx
lea addresses_D_ht+0x1d7d9, %r15
nop
nop
nop
and $40352, %rdx
...
nop
cmp %rsi, %rsi
lea addresses_WC_ht+0xd021, %rsi
...
nop
cmp $24799, %rbp
lea addresses_WT_ht+0x71a1, %rdi
nop
nop
nop
cmp %r10, %r10
movl $0x61626364, (%rdi)
and %rbp, %rbp
lea addresses_normal_ht+0x1a221, %rsi
nop
nop
nop
nop
...
nop
and %rbp, %rbp
lea addresses_D_ht+0x8811, %rsi
lea addresses_D_ht+0x2ba1, %rdi
cmp $51402, %rbp
mov $52, %rcx
rep movsl
nop
nop
add $47713, %r10
lea addresses_WC_ht+0x17d21, %r14
nop
nop
nop
nop
...
nop
add $15389, %rdi
lea addresses_WT_ht+0x187e9, %r15
nop
nop
nop
nop
...
mov (%r15), %rbp
cmp %rdx, %rdx
lea addresses_WT_ht+0x2a21, %r15
nop
nop
nop
and %rsi, %rsi
...
nop
cmp %r15, %r15
lea addresses_WC_ht+0x10221, %rsi
clflush (%rsi)
nop
nop
nop
...
nop
sub $12252, %r15
lea addresses_A_ht+0x77a1, %rsi
lea addresses_A_ht+0x1de21, %rdi
nop
nop
nop
nop
...
{'OP': 'REPM', 'src': {'same': False, 'type': 'addresses_normal_ht', 'congruent': 9}, 'dst': {'same': False, 'type': 'addresses_WC_ht', 'congruent': 4}}
...
{'OP': 'STOR', 'dst': {'size': 1, 'NT': False, 'type': 'addresses_normal_ht', 'same': True, 'AVXalign': False, 'congruent': 9}}
...
{'OP': 'REPM', 'src': {'same': False, 'type': 'addresses_A_ht', 'congruent': 7}, 'dst': {'same': False, 'type': 'addresses_A_ht', 'congruent': 4}}
{'36': 21829}
