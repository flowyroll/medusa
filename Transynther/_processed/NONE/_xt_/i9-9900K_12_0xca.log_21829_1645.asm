...
push %rdi
push %rsi
lea addresses_WT_ht+0x4e15, %rsi
lea addresses_A_ht+0xaa65, %rdi
nop
nop
nop
dec %r13
...
nop
and $54362, %r8
lea addresses_WT_ht+0x1b8cd, %rbp
nop
nop
nop
nop
...
nop
sub $6882, %r13
lea addresses_WC_ht+0x9d95, %rcx
add $7704, %r12
movb $0x61, (%rcx)
nop
nop
nop
and $17982, %r13
lea addresses_WC_ht+0x14665, %rdi
sub %r13, %r13
movups (%rdi), %xmm1
vpextrq $1, %xmm1, %r8
sub $9507, %rcx
lea addresses_A_ht+0x68e5, %rbp
nop
nop
cmp %r8, %r8
mov (%rbp), %r13
...
{'OP': 'LOAD', 'src': {'size': 4, 'NT': False, 'type': 'addresses_PSE', 'same': False, 'AVXalign': True, 'congruent': 4}}
{'OP': 'STOR', 'dst': {'size': 8, 'NT': False, 'type': 'addresses_WT', 'same': False, 'AVXalign': False, 'congruent': 5}}
{'OP': 'STOR', 'dst': {'size': 8, 'NT': False, 'type': 'addresses_RW', 'same': False, 'AVXalign': True, 'congruent': 11}}
