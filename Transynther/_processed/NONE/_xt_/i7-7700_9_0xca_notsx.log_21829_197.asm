...
push %rdx
push %rsi
lea addresses_normal_ht+0xb406, %r12
nop
nop
nop
xor $36035, %r11
...
nop
cmp $63261, %r10
lea addresses_WC_ht+0x13406, %r15
nop
nop
nop
nop
...
movw $0x6162, (%r15)
add %rsi, %rsi
lea addresses_WT_ht+0x3806, %rsi
lea addresses_WC_ht+0xc006, %rdi
nop
nop
nop
cmp %r15, %r15
...
nop
add %rdx, %rdx
lea addresses_normal_ht+0x5d46, %r11
nop
nop
cmp $28680, %r15
...
nop
inc %rcx
lea addresses_UC_ht+0x11de1, %rsi
lea addresses_D_ht+0x1dc06, %rdi
clflush (%rdi)
nop
nop
nop
...
rep movsq
and %rdi, %rdi
lea addresses_WT_ht+0xc406, %rsi
...
rep movsw
inc %r15
lea addresses_normal_ht+0x19c06, %rsi
lea addresses_UC_ht+0xd026, %rdi
dec %r15
mov $90, %rcx
rep movsb
nop
...
{'src': {'congruent': 0, 'same': False, 'type': 'addresses_UC_ht'}, 'dst': {'congruent': 10, 'same': False, 'type': 'addresses_D_ht'}, 'OP': 'REPM'}
{'src': {'congruent': 11, 'same': False, 'type': 'addresses_WT_ht'}, 'dst': {'congruent': 10, 'same': False, 'type': 'addresses_normal_ht'}, 'OP': 'REPM'}
