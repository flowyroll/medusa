...
nop
dec %rdi
lea addresses_A_ht+0x1e628, %rsi
lea addresses_normal_ht+0xc908, %rdi
nop
xor $16969, %r9
mov $106, %rcx
rep movsl
...
nop
dec %rsi
lea addresses_normal_ht+0x17a28, %r14
nop
cmp $3166, %rax
...
nop
cmp %rax, %rax
lea addresses_D_ht+0x105e8, %r9
cmp %rdi, %rdi
movb $0x61, (%r9)
xor $17152, %rdi
lea addresses_WC_ht+0x4328, %rsi
lea addresses_D_ht+0x1b628, %rdi
clflush (%rsi)
nop
nop
nop
...
nop
sub %rdi, %rdi
lea addresses_UC_ht+0x1a208, %rbp
nop
nop
sub %rdi, %rdi
vmovups (%rbp), %ymm1
...
vpextrq $1, %xmm1, %rax
sub %r9, %r9
lea addresses_normal_ht+0x11e12, %rcx
nop
nop
nop
nop
...
nop
sub %rax, %rax
lea addresses_WC_ht+0x169e8, %rdi
dec %rbp
mov (%rdi), %rax
nop
nop
...
{'OP': 'REPM', 'src': {'same': False, 'congruent': 3, 'type': 'addresses_UC'}, 'dst': {'same': False, 'congruent': 0, 'type': 'addresses_WT'}}
[Faulty Load]
