...
push %rdx
push %rsi
lea addresses_normal_ht+0xaa13, %r8
nop
and %r12, %r12
movb $0x61, (%r8)
nop
...
nop
xor $36064, %rdi
lea addresses_D_ht+0xbad3, %rsi
lea addresses_WC_ht+0xaa13, %rdi
nop
nop
add %rdx, %rdx
mov $37, %rcx
...
nop
add %r12, %r12
lea addresses_WC_ht+0x1693, %rcx
nop
cmp %r8, %r8
mov (%rcx), %rdx
nop
...
nop
cmp $43027, %r12
lea addresses_WT_ht+0xa613, %rsi
nop
nop
nop
and $55171, %rax
movw $0x6162, (%rsi)
cmp %rcx, %rcx
lea addresses_WC_ht+0x9943, %rsi
lea addresses_D_ht+0x7213, %rdi
nop
add $45841, %rbx
mov $119, %rcx
rep movsl
...
nop
xor $12886, %rsi
lea addresses_normal_ht+0x6e13, %rsi
lea addresses_WC_ht+0x17213, %rdi
nop
inc %rax
mov $25, %rcx
rep movsb
...
nop
and $20021, %rcx
lea addresses_normal_ht+0x14193, %r8
nop
nop
cmp %rax, %rax
...
nop
cmp $40418, %r8
lea addresses_normal_ht+0x16213, %rdi
cmp %rcx, %rcx
mov (%rdi), %rsi
nop
nop
...
{'src': {'type': 'addresses_D_ht', 'congruent': 1, 'same': False}, 'OP': 'REPM', 'dst': {'type': 'addresses_WC_ht', 'congruent': 11, 'same': False}}
...
{'src': {'type': 'addresses_WC_ht', 'congruent': 3, 'same': False}, 'OP': 'REPM', 'dst': {'type': 'addresses_D_ht', 'congruent': 9, 'same': True}}
{'src': {'type': 'addresses_normal_ht', 'congruent': 5, 'same': False}, 'OP': 'REPM', 'dst': {'type': 'addresses_WC_ht', 'congruent': 11, 'same': False}}
