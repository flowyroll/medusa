...
push %rax
push %rcx
lea addresses_normal_ht+0x13dc5, %r11
nop
nop
nop
nop
...
movw $0x6162, (%r11)
and $6327, %r10
lea addresses_D_ht+0x6bf0, %r15
add %r12, %r12
mov (%r15), %ecx
nop
xor %r10, %r10
lea addresses_WC_ht+0xa851, %r14
clflush (%r14)
nop
nop
nop
...
nop
and $26613, %rax
lea addresses_normal_ht+0xfb99, %r14
clflush (%r14)
nop
nop
nop
...
nop
cmp %r12, %r12
lea addresses_UC_ht+0xc6c9, %r11
nop
nop
nop
nop
...
mov (%r11), %r10
mfence
lea addresses_A_ht+0x182c9, %r10
nop
nop
nop
nop
...
// Faulty Load
lea addresses_normal+0x152c9, %rsi
nop
nop
nop
nop
