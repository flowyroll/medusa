...
push %rdx
push %rsi
lea addresses_WC_ht+0x55d2, %rbx
xor %r8, %r8
...
nop
and %rsi, %rsi
lea addresses_D_ht+0x724e, %rsi
lea addresses_UC_ht+0xca12, %rdi
nop
nop
nop
nop
...
nop
add $25063, %rcx
lea addresses_UC_ht+0x1e352, %rsi
nop
nop
nop
sub $18035, %rcx
...
nop
sub %r8, %r8
lea addresses_WC_ht+0x9a7c, %rbx
dec %r12
mov $0x6162636465666768, %r8
movq %r8, %xmm4
vmovups %ymm4, (%rbx)
xor %r8, %r8
lea addresses_WT_ht+0x11434, %r8
nop
nop
add $15426, %rcx
movl $0x61626364, (%r8)
...
nop
add $33668, %rdi
lea addresses_D_ht+0x14483, %rdi
nop
nop
nop
sub $4761, %r8
...
nop
xor %rbx, %rbx
lea addresses_A_ht+0x139a2, %rsi
lea addresses_WC_ht+0xb5d2, %rdi
nop
nop
nop
nop
...
// Store
lea addresses_normal+0xcea, %r15
nop
nop
nop
cmp %r14, %r14
...
// REPMOV
lea addresses_RW+0xebd2, %rsi
lea addresses_US+0x1c40a, %rdi
nop
nop
nop
nop
...
// Faulty Load
lea addresses_normal+0x175d2, %rax
nop
nop
nop
nop
...
{'OP': 'STOR', 'dst': {'congruent': 3, 'AVXalign': False, 'same': False, 'size': 16, 'NT': False, 'type': 'addresses_D'}}
{'OP': 'STOR', 'dst': {'congruent': 3, 'AVXalign': False, 'same': False, 'size': 32, 'NT': False, 'type': 'addresses_normal'}}
{'src': {'congruent': 8, 'same': False, 'type': 'addresses_RW'}, 'OP': 'REPM', 'dst': {'congruent': 3, 'same': False, 'type': 'addresses_US'}}
[Faulty Load]
...
{'src': {'congruent': 4, 'same': False, 'type': 'addresses_A_ht'}, 'OP': 'REPM', 'dst': {'congruent': 9, 'same': False, 'type': 'addresses_WC_ht'}}
{'34': 21829}
