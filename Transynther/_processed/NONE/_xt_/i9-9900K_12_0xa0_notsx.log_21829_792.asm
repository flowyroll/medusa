...
push %rdi
push %rsi
lea addresses_WC_ht+0x107b0, %r10
clflush (%r10)
nop
sub %r13, %r13
mov (%r10), %di
...
nop
add $50869, %r8
lea addresses_WT_ht+0xdd3c, %rsi
lea addresses_normal_ht+0xf650, %rdi
nop
and $34968, %r10
mov $37, %rcx
rep movsw
...
nop
and $23413, %r10
lea addresses_UC_ht+0xd0a0, %r14
clflush (%r14)
nop
nop
xor $30224, %r11
...
nop
sub $28836, %r10
lea addresses_normal_ht+0xca50, %rsi
nop
nop
nop
nop
...
nop
and $64518, %r10
lea addresses_normal_ht+0xba50, %rsi
lea addresses_WT_ht+0x7650, %rdi
clflush (%rdi)
nop
nop
nop
...
nop
and %r8, %r8
lea addresses_WT_ht+0x1850, %r11
nop
and %rsi, %rsi
movl $0x61626364, (%r11)
nop
sub $56827, %r13
lea addresses_UC_ht+0x8118, %rcx
nop
nop
nop
add $51514, %r14
...
nop
dec %r10
lea addresses_UC_ht+0x4f50, %r11
dec %rcx
mov (%r11), %rsi
nop
nop
dec %r10
lea addresses_normal_ht+0x68b0, %rsi
lea addresses_WC_ht+0x1c0f0, %rdi
nop
nop
nop
nop
...
nop
sub $49110, %r8
lea addresses_WT_ht+0x1650, %rdi
nop
nop
nop
nop
...
// Faulty Load
lea addresses_normal+0x13e50, %rbp
nop
xor %r8, %r8
mov (%rbp), %rbx
lea oracles, %rbp
...
{'src': {'type': 'addresses_normal_ht', 'congruent': 4, 'same': False}, 'OP': 'REPM', 'dst': {'type': 'addresses_WC_ht', 'congruent': 3, 'same': False}}
