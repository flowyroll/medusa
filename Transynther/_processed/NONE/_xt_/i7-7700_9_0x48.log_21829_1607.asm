...
movups %xmm0, (%r8)
xor $25662, %rbp
lea addresses_A_ht+0x1e838, %rsi
nop
nop
nop
nop
...
mov (%rsi), %r10d
inc %rbp
lea addresses_UC_ht+0xf600, %rax
nop
nop
and %r12, %r12
movw $0x6162, (%rax)
...
nop
dec %rbp
lea addresses_WC_ht+0xa880, %rsi
lea addresses_WT_ht+0xf300, %rdi
add $5318, %r12
mov $31, %rcx
rep movsb
nop
inc %rcx
lea addresses_A_ht+0x1cb20, %rsi
lea addresses_A_ht+0x11500, %rdi
cmp $48888, %r12
mov $81, %rcx
rep movsq
nop
...
nop
add $1079, %rdx
lea addresses_WT_ht+0x19e00, %rdi
nop
dec %rax
movl $0x61626364, (%rdi)
dec %rdx
lea addresses_WT_ht+0x169dc, %rsi
lea addresses_WT_ht+0x16600, %rdi
clflush (%rdi)
nop
nop
nop
...
nop
xor %rcx, %rcx
lea addresses_A_ht+0x18800, %rsi
nop
nop
sub $47002, %rdi
vmovups (%rsi), %ymm3
...
{'OP': 'LOAD', 'src': {'type': 'addresses_WC', 'AVXalign': False, 'congruent': 2, 'size': 4, 'same': False, 'NT': False}}
...
{'OP': 'STOR', 'dst': {'type': 'addresses_A_ht', 'AVXalign': False, 'congruent': 0, 'size': 2, 'same': False, 'NT': True}}
{'OP': 'REPM', 'src': {'type': 'addresses_WC_ht', 'congruent': 7, 'same': False}, 'dst': {'type': 'addresses_WT_ht', 'congruent': 8, 'same': False}}
{'OP': 'REPM', 'src': {'type': 'addresses_A_ht', 'congruent': 4, 'same': False}, 'dst': {'type': 'addresses_A_ht', 'congruent': 8, 'same': False}}
...
{'OP': 'LOAD', 'src': {'type': 'addresses_WC_ht', 'AVXalign': False, 'congruent': 8, 'size': 8, 'same': True, 'NT': False}}
{'33': 21829}
