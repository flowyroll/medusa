...
push %rdi
push %rsi
lea addresses_UC_ht+0x18d4d, %rsi
lea addresses_UC_ht+0xd22f, %rdi
clflush (%rdi)
nop
nop
nop
...
nop
sub %rcx, %rcx
lea addresses_normal_ht+0xd62f, %rax
nop
sub $63123, %r13
mov (%rax), %rcx
cmp $15696, %rax
lea addresses_WC_ht+0xad2f, %r13
clflush (%r13)
nop
nop
nop
...
nop
cmp %r9, %r9
lea addresses_A_ht+0xc17, %rsi
lea addresses_WT_ht+0x7669, %rdi
add $6847, %r12
mov $56, %rcx
rep movsw
xor $46049, %rdi
lea addresses_A_ht+0x109ef, %r13
clflush (%r13)
nop
nop
nop
...
nop
sub $61615, %r13
lea addresses_D_ht+0x11e2f, %rax
nop
nop
nop
nop
...
nop
and %r13, %r13
lea addresses_UC_ht+0x1836d, %r12
nop
nop
nop
nop
...
nop
dec %rsi
lea addresses_A_ht+0x7807, %rsi
lea addresses_D_ht+0x1627, %rdi
nop
add %r9, %r9
mov $100, %rcx
rep movsl
...
nop
cmp $61909, %r9
lea addresses_WT_ht+0xe478, %rdi
nop
nop
nop
xor $23171, %rbx
...
nop
xor $63011, %rdi
lea addresses_WC_ht+0x73af, %rsi
lea addresses_WC_ht+0x5a2f, %rdi
nop
nop
nop
nop
...
// Load
lea addresses_normal+0x1822f, %r15
nop
nop
nop
cmp $29913, %rax
...
// Faulty Load
lea addresses_normal+0x1822f, %rbp
nop
nop
nop
nop
...
{'src': {'same': False, 'congruent': 1, 'type': 'addresses_A_ht'}, 'OP': 'REPM', 'dst': {'same': True, 'congruent': 1, 'type': 'addresses_WT_ht'}}
...
{'OP': 'STOR', 'dst': {'NT': True, 'same': False, 'congruent': 1, 'type': 'addresses_UC_ht', 'AVXalign': False, 'size': 4}}
