...
push %rdx
push %rsi
lea addresses_normal_ht+0x1cedb, %r10
nop
nop
nop
nop
...
nop
and $4003, %r14
lea addresses_WC_ht+0x1ac0b, %r13
nop
and $64620, %r10
movl $0x61626364, (%r13)
nop
nop
add $60958, %rbp
lea addresses_WT_ht+0x1b6db, %r13
nop
nop
nop
nop
...
nop
sub $27116, %r14
lea addresses_normal_ht+0x1a8db, %rsi
lea addresses_WT_ht+0x10edb, %rdi
nop
add %r14, %r14
mov $4, %rcx
rep movsw
nop
add %rcx, %rcx
lea addresses_WC_ht+0xd2db, %rcx
clflush (%rcx)
nop
nop
nop
...
nop
dec %rdi
lea addresses_WT_ht+0x1331f, %rsi
lea addresses_WC_ht+0xadb, %rdi
nop
nop
nop
nop
...
// Load
lea addresses_normal+0x10adb, %r10
nop
nop
nop
nop
...
// Faulty Load
lea addresses_normal+0x10adb, %r8
nop
nop
nop
nop
...
{'OP': 'LOAD', 'src': {'type': 'addresses_normal', 'size': 32, 'AVXalign': True, 'NT': True, 'congruent': 0, 'same': True}}
[Faulty Load]
{'OP': 'LOAD', 'src': {'type': 'addresses_normal', 'size': 8, 'AVXalign': False, 'NT': False, 'congruent': 0, 'same': True}}
<gen_prepare_buffer>
{'OP': 'LOAD', 'src': {'type': 'addresses_normal_ht', 'size': 8, 'AVXalign': True, 'NT': False, 'congruent': 9, 'same': False}}
