...
nop
dec %r13
lea addresses_UC_ht+0x1456d, %r11
nop
nop
nop
nop
...
nop
and $22426, %r13
lea addresses_D_ht+0x5daa, %rsi
lea addresses_WC_ht+0x4fab, %rdi
clflush (%rdi)
dec %r9
mov $108, %rcx
rep movsl
...
nop
add %rcx, %rcx
lea addresses_UC_ht+0x1a96d, %rsi
lea addresses_UC_ht+0x743d, %rdi
nop
nop
nop
and $31901, %r13
...
rep movsq
inc %rdi
lea addresses_A_ht+0xa879, %rsi
inc %r13
movw $0x6162, (%rsi)
nop
xor %r13, %r13
lea addresses_D_ht+0x19d6d, %rsi
...
nop
cmp %r10, %r10
lea addresses_normal_ht+0x8d6d, %r9
nop
nop
nop
add %r10, %r10
...
nop
and $49220, %rcx
lea addresses_WT_ht+0xeab4, %rdi
nop
nop
nop
nop
...
nop
xor %r9, %r9
lea addresses_WC_ht+0x18cb5, %r14
and $9081, %r11
movb $0x61, (%r14)
nop
nop
add $39522, %r11
lea addresses_normal_ht+0x13d6d, %rcx
nop
nop
nop
nop
...
nop
add $53509, %r11
lea addresses_UC_ht+0xcacd, %rsi
lea addresses_WC_ht+0x1e56d, %rdi
nop
nop
nop
sub $14682, %r9
...
{'OP': 'REPM', 'src': {'type': 'addresses_D_ht', 'congruent': 0, 'same': False}, 'dst': {'type': 'addresses_WC_ht', 'congruent': 1, 'same': False}}
...
{'OP': 'REPM', 'src': {'type': 'addresses_D_ht', 'congruent': 9, 'same': True}, 'dst': {'type': 'addresses_D_ht', 'congruent': 9, 'same': False}}
{'OP': 'LOAD', 'src': {'type': 'addresses_normal_ht', 'AVXalign': True, 'congruent': 11, 'size': 4, 'same': False, 'NT': False}}
