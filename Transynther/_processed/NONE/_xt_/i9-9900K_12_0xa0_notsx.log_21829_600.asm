...
push %rdx
push %rsi
lea addresses_UC_ht+0x18d0a, %rdi
nop
cmp $11497, %rbp
movl $0x61626364, (%rdi)
nop
...
nop
xor $4094, %r13
lea addresses_A_ht+0x15dd7, %rax
nop
nop
nop
xor %rdi, %rdi
...
{'OP': 'STOR', 'dst': {'type': 'addresses_WT', 'AVXalign': True, 'size': 1, 'NT': False, 'same': False, 'congruent': 0}}
