...
nop
xor $5732, %r13
lea addresses_A_ht+0x1407f, %r11
nop
add $35303, %r9
movw $0x6162, (%r11)
nop
...
nop
cmp $55695, %r13
lea addresses_UC_ht+0xbd7f, %rsi
lea addresses_WT_ht+0x13b7f, %rdi
nop
nop
nop
nop
...
nop
dec %r9
lea addresses_A_ht+0x11575, %rsi
...
nop
sub %rbp, %rbp
lea addresses_UC_ht+0x1a191, %rsi
lea addresses_A_ht+0x997f, %rdi
nop
nop
and %r11, %r11
mov $60, %rcx
...
nop
inc %rdi
lea addresses_UC_ht+0xa606, %rsi
lea addresses_normal_ht+0x4f17, %rdi
nop
sub %r11, %r11
mov $5, %rcx
rep movsl
...
nop
add $57514, %rbp
lea addresses_A_ht+0x1e37f, %rdx
nop
nop
nop
nop
...
movq %r15, (%rdx)
cmp $61448, %r9
lea addresses_UC_ht+0x5b7f, %r15
nop
xor $14129, %r13
...
nop
add %rbp, %rbp
lea addresses_UC_ht+0x1377f, %r15
nop
nop
nop
cmp $51946, %rsi
...
nop
add $28801, %rdx
lea addresses_WC_ht+0xcadf, %rcx
nop
nop
nop
nop
...
mov (%rcx), %r15d
inc %rsi
lea addresses_UC_ht+0x1dba3, %r13
clflush (%r13)
add %rdx, %rdx
mov (%r13), %r11
nop
...
<gen_prepare_buffer>
{'src': {'type': 'addresses_D_ht', 'same': True, 'size': 16, 'congruent': 8, 'NT': False, 'AVXalign': False}, 'OP': 'LOAD'}
...
{'src': {'type': 'addresses_A_ht', 'congruent': 1, 'same': False}, 'dst': {'type': 'addresses_WC_ht', 'congruent': 5, 'same': False}, 'OP': 'REPM'}
{'src': {'type': 'addresses_UC_ht', 'congruent': 1, 'same': False}, 'dst': {'type': 'addresses_A_ht', 'congruent': 6, 'same': False}, 'OP': 'REPM'}
