...
push %rdx
push %rsi
lea addresses_normal_ht+0xb9df, %rsi
lea addresses_D_ht+0x109df, %rdi
clflush (%rsi)
nop
nop
nop
...
nop
sub $34610, %rsi
lea addresses_D_ht+0x3167, %rdx
nop
nop
sub $38200, %rcx
mov (%rdx), %di
cmp $53628, %rdi
lea addresses_UC_ht+0xc69f, %rsi
...
nop
and $47881, %rcx
lea addresses_WC_ht+0x1147f, %rsi
lea addresses_UC_ht+0x1619f, %rdi
sub $5712, %r11
mov $43, %rcx
rep movsw
nop
...
nop
cmp %rdx, %rdx
lea addresses_WT_ht+0x1449f, %r9
nop
nop
nop
nop
...
nop
cmp %rsi, %rsi
lea addresses_UC_ht+0x59f, %rsi
lea addresses_WC_ht+0x1c49f, %rdi
nop
nop
nop
and %rax, %rax
...
nop
add $45941, %rcx
lea addresses_UC_ht+0x128df, %rdx
nop
nop
nop
nop
...
nop
add %rsi, %rsi
lea addresses_D_ht+0x1129f, %rsi
lea addresses_normal_ht+0x12faf, %rdi
cmp %rdx, %rdx
mov $53, %rcx
rep movsq
nop
...
<gen_prepare_buffer>
{'src': {'type': 'addresses_normal_ht', 'congruent': 3, 'same': False}, 'dst': {'type': 'addresses_D_ht', 'congruent': 4, 'same': False}, 'OP': 'REPM'}
{'src': {'type': 'addresses_D_ht', 'same': False, 'size': 2, 'congruent': 3, 'NT': False, 'AVXalign': False}, 'OP': 'LOAD'}
{'src': {'type': 'addresses_UC_ht', 'congruent': 9, 'same': False}, 'dst': {'type': 'addresses_WT_ht', 'congruent': 2, 'same': False}, 'OP': 'REPM'}
