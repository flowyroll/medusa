...
push %rdi
push %rsi
lea addresses_WC_ht+0x1b5c0, %r15
nop
nop
xor $29142, %r12
mov (%r15), %r13d
...
nop
and %r15, %r15
lea addresses_WC_ht+0x9f40, %rsi
lea addresses_A_ht+0x1c5c0, %rdi
sub $64725, %r14
mov $78, %rcx
rep movsw
nop
and $28830, %r13
lea addresses_D_ht+0xdf30, %rsi
lea addresses_D_ht+0x13c0, %rdi
nop
and %r14, %r14
mov $115, %rcx
rep movsq
...
nop
sub %rsi, %rsi
lea addresses_normal_ht+0x79c0, %r10
dec %r12
vmovups (%r10), %ymm6
...
nop
and %rcx, %rcx
lea addresses_normal_ht+0x35c0, %rsi
lea addresses_WT_ht+0x147e0, %rdi
clflush (%rdi)
nop
nop
nop
...
{'OP': 'STOR', 'dst': {'type': 'addresses_UC_ht', 'size': 2, 'AVXalign': False, 'NT': True, 'congruent': 11, 'same': False}}
...
{'OP': 'REPM', 'src': {'type': 'addresses_normal_ht', 'congruent': 8, 'same': True}, 'dst': {'type': 'addresses_WT_ht', 'congruent': 5, 'same': False}}
