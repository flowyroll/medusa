...
push %rdi
push %rsi
lea addresses_D_ht+0x43b8, %rsi
lea addresses_normal_ht+0x12d68, %rdi
nop
nop
nop
add %rbx, %rbx
...
rep movsl
cmp $38119, %r14
lea addresses_D_ht+0x183b8, %rbp
nop
nop
sub $33885, %r12
movb (%rbp), %cl
and %rsi, %rsi
lea addresses_normal_ht+0xc7b8, %rbx
nop
add $35591, %rbp
movl $0x61626364, (%rbx)
inc %rbp
lea addresses_WT_ht+0x14d90, %r12
nop
nop
dec %r14
mov (%r12), %esi
...
nop
and %rbp, %rbp
lea addresses_D_ht+0x1d3b8, %rdi
nop
and %rcx, %rcx
movb $0x61, (%rdi)
nop
...
nop
and %rdi, %rdi
lea addresses_WC_ht+0x12eb8, %r12
nop
nop
nop
nop
...
nop
and %rbp, %rbp
lea addresses_normal_ht+0x19fb8, %r14
clflush (%r14)
nop
nop
nop
...
nop
sub %rbp, %rbp
lea addresses_normal_ht+0x33b8, %rbx
nop
nop
nop
nop
...
// Faulty Load
lea addresses_normal+0x193b8, %rsi
nop
inc %rdx
mov (%rsi), %ax
lea oracles, %rsi
