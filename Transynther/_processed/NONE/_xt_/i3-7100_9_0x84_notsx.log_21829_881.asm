...
push %rdi
push %rsi
lea addresses_WT_ht+0x1a57f, %r10
nop
cmp %rax, %rax
mov (%r10), %bx
nop
...
nop
sub %rsi, %rsi
lea addresses_UC_ht+0x1297f, %rsi
lea addresses_normal_ht+0x1b30f, %rdi
nop
nop
xor %r13, %r13
mov $87, %rcx
...
nop
sub $6037, %rcx
lea addresses_normal_ht+0x1430f, %rsi
lea addresses_A_ht+0x157c7, %rdi
nop
nop
nop
nop
...
nop
add %rsi, %rsi
lea addresses_WT_ht+0x1dbff, %rax
cmp %r8, %r8
...
mov (%r8), %edi
sub $55802, %r8
lea addresses_WC_ht+0x617f, %rdi
clflush (%rdi)
nop
sub %r8, %r8
