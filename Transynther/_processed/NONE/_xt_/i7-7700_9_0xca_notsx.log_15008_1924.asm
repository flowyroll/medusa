...
nop
add $57904, %rsi
lea addresses_WT_ht+0x49a1, %rdx
clflush (%rdx)
nop
dec %rbx
mov (%rdx), %rcx
...
nop
add %rbx, %rbx
lea addresses_normal_ht+0x19696, %rsi
lea addresses_WC_ht+0x4396, %rdi
nop
nop
inc %r15
mov $52, %rcx
...
nop
xor %rcx, %rcx
lea addresses_normal_ht+0x5f96, %rdx
nop
nop
nop
nop
...
nop
and %rdi, %rdi
lea addresses_WT_ht+0x1ab56, %r9
add $54962, %rsi
...
nop
inc %rdx
lea addresses_normal_ht+0x13216, %rsi
nop
inc %rcx
...
// Faulty Load
lea addresses_normal+0xab96, %r8
nop
nop
cmp $1492, %r12
movb (%r8), %r11b
...
{'src': {'NT': False, 'AVXalign': True, 'size': 4, 'congruent': 3, 'same': False, 'type': 'addresses_NC'}, 'OP': 'LOAD'}
[Faulty Load]
...
{'src': {'congruent': 5, 'same': False, 'type': 'addresses_normal_ht'}, 'dst': {'congruent': 10, 'same': False, 'type': 'addresses_WC_ht'}, 'OP': 'REPM'}
...
{'src': {'NT': False, 'AVXalign': True, 'size': 8, 'congruent': 6, 'same': False, 'type': 'addresses_D_ht'}, 'OP': 'LOAD'}
