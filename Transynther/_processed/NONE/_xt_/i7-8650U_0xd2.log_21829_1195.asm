...
push %rdx
push %rsi
lea addresses_WT_ht+0x17c70, %rcx
nop
nop
nop
sub $40546, %rbp
movl $0x61626364, (%rcx)
cmp %rbp, %rbp
lea addresses_WC_ht+0x15a50, %rsi
lea addresses_D_ht+0x5b70, %rdi
clflush (%rdi)
nop
nop
nop
...
nop
cmp $52420, %rsi
lea addresses_UC_ht+0x17c70, %rbp
nop
nop
nop
nop
...
movw $0x6162, (%rbp)
add $40503, %rbp
lea addresses_WC_ht+0x92e4, %rsi
lea addresses_D_ht+0x17e70, %rdi
clflush (%rsi)
nop
inc %rbp
mov $74, %rcx
