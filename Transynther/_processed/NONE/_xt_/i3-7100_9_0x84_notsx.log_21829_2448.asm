...
push %rdi
push %rsi
lea addresses_UC_ht+0x3c94, %rsi
lea addresses_D_ht+0x3268, %rdi
nop
nop
dec %r10
mov $99, %rcx
...
mov (%rcx), %rax
add %rdi, %rdi
lea addresses_normal_ht+0x1586c, %rcx
nop
nop
nop
nop
...
vmovups %ymm6, (%rcx)
and $63220, %rsi
lea addresses_WT_ht+0x8a70, %rbx
nop
nop
nop
nop
...
nop
xor $43456, %rdi
lea addresses_WC_ht+0x18968, %r10
nop
nop
sub $59470, %rax
mov $0x6162636465666768, %rdi
...
nop
add %rbx, %rbx
lea addresses_WT_ht+0x10840, %r10
clflush (%r10)
nop
nop
nop
...
nop
xor $39439, %rcx
lea addresses_D_ht+0x13168, %rbx
nop
nop
nop
nop
...
nop
add %r9, %r9
lea addresses_UC_ht+0xbc68, %rcx
nop
cmp %r10, %r10
mov $0x6162636465666768, %rdi
movq %rdi, %xmm6
...
nop
sub $34986, %rax
lea addresses_normal_ht+0x1e368, %rdi
dec %r9
movw $0x6162, (%rdi)
nop
nop
nop
xor $21202, %rax
lea addresses_normal_ht+0x16670, %rsi
nop
sub %rbx, %rbx
mov (%rsi), %cx
nop
...
{'src': {'type': 'addresses_P', 'same': False, 'size': 16, 'congruent': 9, 'NT': False, 'AVXalign': False}, 'OP': 'LOAD'}
[Faulty Load]
{'src': {'type': 'addresses_PSE', 'same': True, 'size': 32, 'congruent': 0, 'NT': False, 'AVXalign': False}, 'OP': 'LOAD'}
<gen_prepare_buffer>
{'src': {'type': 'addresses_UC_ht', 'congruent': 1, 'same': False}, 'dst': {'type': 'addresses_D_ht', 'congruent': 8, 'same': True}, 'OP': 'REPM'}
