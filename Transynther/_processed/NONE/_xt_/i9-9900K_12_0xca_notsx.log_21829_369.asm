...
mov (%r13), %di
xor $41569, %rsi
lea addresses_UC_ht+0x5204, %r13
nop
nop
nop
nop
...
nop
sub $28800, %rdx
lea addresses_D_ht+0x1a3c4, %rdi
mfence
...
nop
and %rdi, %rdi
lea addresses_WC_ht+0x9497, %rsi
lea addresses_UC_ht+0x2f4e, %rdi
nop
dec %r14
mov $14, %rcx
rep movsb
...
nop
and $19204, %rcx
lea addresses_D_ht+0x113c4, %rsi
lea addresses_WT_ht+0x1412d, %rdi
nop
nop
nop
add $51770, %rdx
...
nop
inc %r15
lea addresses_UC_ht+0x8fc4, %rsi
nop
nop
and $35327, %rdi
movb (%rsi), %cl
nop
dec %rcx
lea addresses_A_ht+0x17f2a, %rax
clflush (%rax)
xor $46518, %r13
movb $0x61, (%rax)
sub %rax, %rax
lea addresses_A_ht+0x1367c, %rsi
...
nop
xor $26919, %r14
lea addresses_normal_ht+0x11ac, %r14
xor %rcx, %rcx
...
nop
xor $19810, %r13
lea addresses_D_ht+0x1b0ec, %rsi
lea addresses_UC_ht+0x60c4, %rdi
and %r15, %r15
mov $46, %rcx
rep movsb
nop
...
<gen_prepare_buffer>
{'OP': 'REPM', 'src': {'same': False, 'congruent': 4, 'type': 'addresses_WT_ht'}, 'dst': {'same': False, 'congruent': 4, 'type': 'addresses_WT_ht'}}
...
{'OP': 'REPM', 'src': {'same': False, 'congruent': 3, 'type': 'addresses_D_ht'}, 'dst': {'same': True, 'congruent': 7, 'type': 'addresses_UC_ht'}}
{'32': 21829}
