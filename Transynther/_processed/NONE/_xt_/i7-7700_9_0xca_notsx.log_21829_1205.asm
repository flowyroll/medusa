...
nop
cmp %rdi, %rdi
lea addresses_normal_ht+0x1a872, %rcx
nop
nop
nop
xor %r14, %r14
...
nop
inc %rax
lea addresses_WT_ht+0x1d2e, %r14
clflush (%r14)
nop
nop
nop
...
nop
add $39257, %r14
lea addresses_WT_ht+0x10fdc, %rax
nop
nop
nop
inc %rdi
...
// Store
lea addresses_normal+0x1fef2, %r9
nop
nop
nop
nop
...
// Faulty Load
lea addresses_normal+0xdcf2, %r9
nop
nop
nop
nop
...
{'src': {'congruent': 9, 'same': True, 'type': 'addresses_D_ht'}, 'dst': {'congruent': 5, 'same': False, 'type': 'addresses_D_ht'}, 'OP': 'REPM'}
