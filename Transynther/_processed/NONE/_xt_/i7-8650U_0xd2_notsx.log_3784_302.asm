...
nop
xor $24773, %r12
lea addresses_WC_ht+0x1519d, %r9
nop
nop
nop
cmp $22003, %rbx
...
nop
and $3160, %rsi
lea addresses_normal_ht+0x1ce9d, %rsi
nop
nop
nop
nop
...
nop
add $11766, %rsi
lea addresses_UC_ht+0xe221, %r10
and %rbx, %rbx
mov (%r10), %r12d
nop
nop
...
nop
xor $45185, %r9
lea addresses_normal_ht+0x16c1d, %rsi
lea addresses_WC_ht+0x150a8, %rdi
clflush (%rsi)
nop
nop
nop
...
nop
xor %rcx, %rcx
lea addresses_D_ht+0x1519d, %rsi
...
nop
cmp %r9, %r9
lea addresses_WC_ht+0x16d9d, %r10
clflush (%r10)
nop
nop
add $30535, %r12
movb (%r10), %bl
sub %rbp, %rbp
lea addresses_D_ht+0x1ca5a, %r10
nop
nop
cmp $55542, %rbp
...
nop
xor $24714, %r9
lea addresses_WC_ht+0x105f5, %rbp
nop
nop
nop
nop
...
nop
and $44286, %rsi
lea addresses_UC_ht+0x11e97, %rcx
nop
nop
nop
nop
...
nop
cmp %rbx, %rbx
lea addresses_normal_ht+0x13a9d, %r12
nop
nop
nop
nop
...
nop
sub %rcx, %rcx
lea addresses_WT_ht+0x18e0d, %r9
nop
add $26175, %rcx
movl $0x61626364, (%r9)
nop
...
nop
cmp $14299, %r12
lea addresses_D_ht+0x11cfd, %r10
nop
add %rcx, %rcx
vmovups (%r10), %ymm7
...
{'OP': 'STOR', 'dst': {'type': 'addresses_D_ht', 'size': 8, 'AVXalign': True, 'NT': True, 'congruent': 0, 'same': False}}
...
{'OP': 'STOR', 'dst': {'type': 'addresses_normal_ht', 'size': 2, 'AVXalign': True, 'NT': True, 'congruent': 8, 'same': False}}
