...
nop
sub %rbx, %rbx
lea addresses_A_ht+0x11691, %r14
nop
nop
nop
nop
...
vpextrq $0, %xmm0, %r13
inc %rdx
lea addresses_A_ht+0x113f9, %r14
cmp $3411, %rdx
...
nop
xor %rbp, %rbp
lea addresses_normal_ht+0x5bb9, %rsi
...
lea addresses_A_ht+0x1ddb9, %rdi
nop
nop
sub $20196, %rdx
mov $36, %rcx
rep movsq
and $22766, %rdi
lea addresses_normal_ht+0x27d9, %r13
cmp %r14, %r14
...
{'dst': {'same': True, 'congruent': 6, 'type': 'addresses_normal_ht'}, 'OP': 'REPM', 'src': {'same': False, 'congruent': 11, 'type': 'addresses_normal_ht'}}
