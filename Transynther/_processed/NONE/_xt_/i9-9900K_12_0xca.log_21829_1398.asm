...
nop
and $51772, %rbp
lea addresses_UC_ht+0x7ed0, %rsi
lea addresses_WC_ht+0x1b0d0, %rdi
nop
add $12604, %rbp
mov $34, %rcx
rep movsq
...
// Store
lea addresses_normal+0x56e8, %rbx
clflush (%rbx)
nop
nop
nop
...
{'OP': 'STOR', 'dst': {'size': 16, 'NT': False, 'type': 'addresses_normal', 'same': False, 'AVXalign': True, 'congruent': 3}}
