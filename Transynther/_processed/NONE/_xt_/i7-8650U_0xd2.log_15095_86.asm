...
push %rcx
push %rdx
lea addresses_WC_ht+0xfacd, %rcx
nop
nop
nop
sub $36426, %r11
...
{'OP': 'STOR', 'dst': {'type': 'addresses_PSE', 'size': 1, 'AVXalign': False, 'NT': True, 'congruent': 1, 'same': False}}
[Faulty Load]
