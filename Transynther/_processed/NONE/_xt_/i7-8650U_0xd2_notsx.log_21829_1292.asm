...
push %rdi
push %rsi
lea addresses_WC_ht+0x1c60d, %rsi
lea addresses_WC_ht+0xe059, %rdi
clflush (%rsi)
clflush (%rdi)
nop
nop
...
nop
add %rsi, %rsi
lea addresses_WT_ht+0x16c59, %r13
clflush (%r13)
nop
nop
nop
...
// REPMOV
lea addresses_D+0x12e59, %rsi
lea addresses_normal+0x5459, %rdi
clflush (%rdi)
nop
nop
nop
...
// Store
lea addresses_normal+0x1cc19, %r15
nop
nop
nop
nop
...
{'OP': 'REPM', 'src': {'type': 'addresses_D', 'congruent': 9, 'same': False}, 'dst': {'type': 'addresses_normal', 'congruent': 9, 'same': False}}
...
{'OP': 'STOR', 'dst': {'type': 'addresses_normal', 'size': 4, 'AVXalign': False, 'NT': True, 'congruent': 5, 'same': False}}
