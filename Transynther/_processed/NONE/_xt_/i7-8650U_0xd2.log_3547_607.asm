...
push %rdx
push %rsi
lea addresses_D_ht+0x19341, %r14
nop
nop
xor $30734, %rdx
...
nop
inc %rbx
lea addresses_WT_ht+0x16b41, %rsi
...
nop
inc %rdx
lea addresses_WT_ht+0x37c1, %r10
nop
nop
nop
nop
...
nop
mfence
lea addresses_UC_ht+0x16241, %r10
nop
sub $17842, %r14
mov (%r10), %ecx
nop
...
nop
add %rdi, %rdi
lea addresses_D_ht+0x1e091, %rcx
nop
nop
nop
nop
