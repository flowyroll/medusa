...
nop
add %r10, %r10
lea addresses_normal_ht+0x19760, %r14
nop
cmp %rbp, %rbp
vmovups (%r14), %ymm4
...
lea addresses_D_ht+0x14f69, %rdi
nop
nop
nop
nop
...
nop
sub %rbp, %rbp
lea addresses_D_ht+0x1df5e, %rsi
lea addresses_A_ht+0x9ac0, %rdi
clflush (%rdi)
nop
nop
nop
...
nop
sub %rax, %rax
lea addresses_UC_ht+0x564c, %rsi
lea addresses_D_ht+0x116a8, %rdi
nop
nop
nop
mfence
...
nop
and %rdi, %rdi
lea addresses_normal_ht+0x1cd70, %rsi
...
nop
xor %rsi, %rsi
lea addresses_A_ht+0x1d4f0, %rdi
clflush (%rdi)
nop
nop
nop
...
nop
cmp $49721, %rdi
lea addresses_A_ht+0x16cc0, %rax
nop
cmp %r15, %r15
...
nop
cmp $22341, %rax
lea addresses_A_ht+0x8140, %r14
nop
cmp %rax, %rax
movups (%r14), %xmm2
vpextrq $0, %xmm2, %rbp
and %r10, %r10
lea addresses_WT_ht+0x150c0, %r14
nop
nop
nop
nop
...
// Faulty Load
lea addresses_normal+0x164c0, %r14
clflush (%r14)
and %rdx, %rdx
vmovups (%r14), %ymm2
...
<gen_prepare_buffer>
{'OP': 'REPM', 'src': {'type': 'addresses_WT_ht', 'congruent': 4, 'same': False}, 'dst': {'type': 'addresses_WT_ht', 'congruent': 9, 'same': False}}
{'OP': 'LOAD', 'src': {'type': 'addresses_A_ht', 'AVXalign': True, 'congruent': 9, 'size': 32, 'same': False, 'NT': False}}
...
{'OP': 'REPM', 'src': {'type': 'addresses_normal_ht', 'congruent': 2, 'same': True}, 'dst': {'type': 'addresses_D_ht', 'congruent': 0, 'same': False}}
{'OP': 'REPM', 'src': {'type': 'addresses_D_ht', 'congruent': 1, 'same': False}, 'dst': {'type': 'addresses_A_ht', 'congruent': 6, 'same': False}}
{'OP': 'REPM', 'src': {'type': 'addresses_UC_ht', 'congruent': 0, 'same': False}, 'dst': {'type': 'addresses_D_ht', 'congruent': 3, 'same': False}}
{'OP': 'REPM', 'src': {'type': 'addresses_normal_ht', 'congruent': 3, 'same': False}, 'dst': {'type': 'addresses_WC_ht', 'congruent': 11, 'same': False}}
{'OP': 'LOAD', 'src': {'type': 'addresses_A_ht', 'AVXalign': True, 'congruent': 1, 'size': 4, 'same': False, 'NT': False}}
