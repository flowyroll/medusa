...
nop
dec %rdx
lea addresses_A_ht+0x182fc, %rsi
lea addresses_D_ht+0x771d, %rdi
and %rdx, %rdx
mov $16, %rcx
rep movsl
nop
...
nop
inc %rdi
lea addresses_WC_ht+0x1449e, %rcx
nop
add %rsi, %rsi
movl $0x61626364, (%rcx)
nop
...
nop
inc %rbx
lea addresses_WT_ht+0xa17c, %rsi
lea addresses_WT_ht+0x16b35, %rdi
clflush (%rsi)
clflush (%rdi)
nop
xor %r11, %r11
...
nop
cmp %r11, %r11
lea addresses_WC_ht+0x66fc, %rsi
lea addresses_normal_ht+0x1b60c, %rdi
clflush (%rdi)
cmp %rax, %rax
mov $120, %rcx
rep movsl
...
{'dst': {'type': 'addresses_PSE', 'same': False, 'size': 4, 'congruent': 8, 'NT': False, 'AVXalign': True}, 'OP': 'STOR'}
[Faulty Load]
...
{'src': {'type': 'addresses_WT_ht', 'congruent': 7, 'same': False}, 'dst': {'type': 'addresses_WT_ht', 'congruent': 0, 'same': False}, 'OP': 'REPM'}
