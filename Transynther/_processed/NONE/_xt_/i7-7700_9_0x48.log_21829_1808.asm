...
push %rdx
push %rsi
lea addresses_WT_ht+0x1bcb0, %r14
nop
nop
nop
nop
...
nop
cmp $8599, %r9
lea addresses_UC_ht+0x9fb4, %rbx
nop
nop
nop
nop
...
mov (%rbx), %dx
cmp $54046, %r9
lea addresses_WT_ht+0x1bf7a, %rsi
lea addresses_WT_ht+0x1ecb4, %rdi
nop
nop
cmp $24614, %rbx
mov $46, %rcx
rep movsb
cmp %r9, %r9
lea addresses_WT_ht+0x13bb4, %rdi
nop
nop
nop
add %r12, %r12
movl $0x61626364, (%rdi)
add $53918, %rax
lea addresses_WC_ht+0x15eb4, %rdx
inc %r9
movl $0x61626364, (%rdx)
add $23065, %rcx
lea addresses_A_ht+0x1e034, %rsi
clflush (%rsi)
nop
nop
nop
...
nop
sub $38400, %rsi
lea addresses_WC_ht+0x8cf4, %rsi
lea addresses_normal_ht+0x171b4, %rdi
nop
nop
sub %r12, %r12
mov $101, %rcx
...
nop
dec %r14
lea addresses_WC_ht+0xe24c, %rsi
lea addresses_UC_ht+0x9ab4, %rdi
xor %rbx, %rbx
mov $49, %rcx
rep movsq
xor %rsi, %rsi
lea addresses_normal_ht+0x54b4, %rdx
nop
nop
cmp $33361, %rbx
movl $0x61626364, (%rdx)
...
nop
xor %r14, %r14
lea addresses_normal_ht+0x1ebc4, %rax
nop
nop
nop
nop
...
nop
and $56236, %r12
lea addresses_WC_ht+0xe2b4, %rdx
nop
nop
xor %rdi, %rdi
vmovups (%rdx), %ymm1
...
{'OP': 'STOR', 'dst': {'type': 'addresses_normal_ht', 'AVXalign': True, 'congruent': 9, 'size': 4, 'same': True, 'NT': False}}
