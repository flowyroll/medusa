...
push %rdi
push %rsi
lea addresses_A_ht+0x1c628, %r13
nop
nop
nop
nop
...
nop
add $34170, %rsi
lea addresses_UC_ht+0x102a8, %rsi
lea addresses_WT_ht+0x296c, %rdi
clflush (%rsi)
nop
nop
sub %r10, %r10
...
nop
cmp $37974, %rdi
lea addresses_WC_ht+0x1dca8, %rsi
lea addresses_normal_ht+0xb98c, %rdi
nop
add $47969, %r8
mov $61, %rcx
rep movsl
add %r13, %r13
lea addresses_D_ht+0xfd58, %rdi
nop
nop
dec %r8
movw $0x6162, (%rdi)
sub %r10, %r10
lea addresses_WC_ht+0x2a6a, %rcx
nop
and $50012, %r8
...
// REPMOV
lea addresses_normal+0xaca8, %rsi
lea addresses_PSE+0xc5a8, %rdi
nop
xor %r13, %r13
mov $117, %rcx
rep movsq
...
// Store
lea addresses_normal+0x163ac, %rsi
nop
xor $65318, %r8
...
{'src': {'type': 'addresses_normal', 'congruent': 11, 'same': False}, 'dst': {'type': 'addresses_PSE', 'congruent': 7, 'same': False}, 'OP': 'REPM'}
...
{'src': {'type': 'addresses_UC_ht', 'congruent': 8, 'same': False}, 'dst': {'type': 'addresses_WT_ht', 'congruent': 2, 'same': False}, 'OP': 'REPM'}
