...
push %rdi
push %rsi
lea addresses_A_ht+0x6a1b, %rsi
lea addresses_A_ht+0x63db, %rdi
clflush (%rsi)
nop
nop
nop
...
nop
and $62557, %r13
lea addresses_WC_ht+0x465b, %rax
nop
nop
nop
nop
...
nop
sub %rbp, %rbp
lea addresses_A_ht+0x1d627, %r13
nop
nop
cmp $62647, %rdi
...
// Faulty Load
lea addresses_normal+0x1525b, %rbx
nop
nop
nop
xor %r8, %r8
