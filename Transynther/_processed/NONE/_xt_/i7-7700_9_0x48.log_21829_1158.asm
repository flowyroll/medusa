...
lea addresses_normal_ht+0x4681, %rdi
nop
nop
nop
nop
...
nop
xor $21366, %rsi
lea addresses_WC_ht+0xc3b6, %r13
nop
cmp $52482, %r15
movb (%r13), %r10b
nop
add %r12, %r12
lea addresses_WT_ht+0x153de, %r12
nop
nop
nop
sub $15232, %rcx
...
nop
and %r12, %r12
lea addresses_A_ht+0x1ddb6, %rbp
add %rsi, %rsi
movups (%rbp), %xmm2
vpextrq $0, %xmm2, %rcx
nop
