...
lea addresses_WC_ht+0xf87a, %rdi
nop
inc %r9
mov $32, %rcx
rep movsw
...
// Load
lea addresses_normal+0x8b08, %rdi
nop
nop
nop
nop
...
// Store
lea addresses_normal+0x690, %r14
nop
nop
and $64773, %rdi
...
{'OP': 'STOR', 'dst': {'same': False, 'congruent': 11, 'NT': True, 'type': 'addresses_PSE', 'size': 8, 'AVXalign': False}}
{'OP': 'STOR', 'dst': {'same': False, 'congruent': 10, 'NT': False, 'type': 'addresses_A', 'size': 8, 'AVXalign': False}}
{'OP': 'STOR', 'dst': {'same': True, 'congruent': 1, 'NT': False, 'type': 'addresses_A', 'size': 16, 'AVXalign': False}}
{'src': {'same': False, 'congruent': 7, 'NT': False, 'type': 'addresses_normal', 'size': 2, 'AVXalign': False}, 'OP': 'LOAD'}
