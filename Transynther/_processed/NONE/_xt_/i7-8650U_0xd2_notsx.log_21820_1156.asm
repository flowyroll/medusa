...
push %rdx
push %rsi
lea addresses_D_ht+0x113f4, %rsi
...
nop
add %rdx, %rdx
lea addresses_UC_ht+0xacb4, %rsi
lea addresses_D_ht+0x11bf4, %rdi
nop
nop
nop
and $58385, %r10
...
nop
lfence
lea addresses_WT_ht+0x175f4, %rdx
nop
nop
dec %rbx
movw $0x6162, (%rdx)
...
nop
cmp %r12, %r12
lea addresses_WT_ht+0x2ff4, %rcx
xor $37894, %rsi
...
nop
sub $3863, %r10
lea addresses_WC_ht+0x1d048, %rcx
clflush (%rcx)
add $43612, %r10
...
nop
xor $20629, %r12
lea addresses_normal_ht+0x17f74, %rsi
lea addresses_WC_ht+0x16bf4, %rdi
nop
nop
nop
nop
...
nop
dec %r12
lea addresses_A_ht+0x113f4, %r10
nop
nop
nop
nop
...
nop
add $37784, %r14
lea addresses_WT_ht+0xcff4, %rsi
lea addresses_WC_ht+0x12d44, %rdi
nop
nop
cmp %r10, %r10
mov $58, %rcx
rep movsq
lfence
lea addresses_UC_ht+0x198f4, %rcx
nop
nop
nop
xor %rdx, %rdx
...
nop
add %rsi, %rsi
lea addresses_normal_ht+0x15ff4, %rbx
nop
nop
nop
nop
...
// REPMOV
lea addresses_UC+0x1c69c, %rsi
lea addresses_A+0xf5fe, %rdi
add $37970, %r14
mov $44, %rcx
rep movsb
nop
...
// Store
lea addresses_normal+0x1d854, %rbx
clflush (%rbx)
nop
nop
nop
...
{'OP': 'REPM', 'src': {'type': 'addresses_UC', 'congruent': 2, 'same': False}, 'dst': {'type': 'addresses_A', 'congruent': 1, 'same': False}}
...
{'OP': 'STOR', 'dst': {'type': 'addresses_A_ht', 'size': 8, 'AVXalign': False, 'NT': True, 'congruent': 11, 'same': True}}
