...
push %rdx
push %rsi
lea addresses_normal_ht+0x4d72, %r12
nop
nop
nop
nop
...
nop
sub $55223, %rbp
lea addresses_WC_ht+0x36fc, %rdx
clflush (%rdx)
nop
nop
nop
...
nop
inc %rsi
lea addresses_D_ht+0x1b52, %rsi
lea addresses_WC_ht+0x7772, %rdi
clflush (%rdi)
and $54377, %r13
mov $93, %rcx
rep movsq
...
nop
and $33498, %rcx
lea addresses_normal_ht+0x16832, %rdi
nop
nop
nop
nop
...
nop
sub %rdi, %rdi
lea addresses_WT_ht+0x24b8, %rsi
nop
nop
nop
nop
...
nop
xor %rsi, %rsi
lea addresses_WT_ht+0x1e572, %rsi
lea addresses_D_ht+0x8b72, %rdi
clflush (%rdi)
nop
nop
add %rbp, %rbp
...
nop
sub $2760, %rcx
lea addresses_WC_ht+0x173dc, %rcx
nop
nop
nop
cmp %rdi, %rdi
...
nop
xor $36480, %rbp
lea addresses_A_ht+0x160d2, %rsi
nop
cmp $12077, %rbp
...
{'src': {'type': 'addresses_D_ht', 'congruent': 5, 'same': False}, 'dst': {'type': 'addresses_WC_ht', 'congruent': 9, 'same': False}, 'OP': 'REPM'}
...
{'src': {'type': 'addresses_WT_ht', 'congruent': 11, 'same': True}, 'dst': {'type': 'addresses_D_ht', 'congruent': 6, 'same': False}, 'OP': 'REPM'}
