...
push %rdx
push %rsi
lea addresses_normal_ht+0x16ee4, %rdx
cmp $34498, %rcx
...
nop
and $48822, %rcx
lea addresses_WC_ht+0x193e4, %r11
nop
nop
nop
sub $18002, %r10
...
vpextrq $1, %xmm2, %rcx
cmp $21623, %r13
lea addresses_UC_ht+0x1b9e4, %rsi
nop
dec %r13
...
// Load
lea addresses_normal+0x7dc4, %r14
nop
nop
nop
add $30460, %rax
...
// Store
lea addresses_normal+0x97e3, %r10
nop
nop
nop
nop
