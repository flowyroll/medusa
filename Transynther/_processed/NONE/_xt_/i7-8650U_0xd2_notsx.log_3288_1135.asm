...
push %rbp
push %rdx
lea addresses_WT_ht+0xd5d9, %rdx
nop
nop
nop
cmp %r8, %r8
...
nop
xor $36727, %r14
lea addresses_WC_ht+0x1ecd9, %r14
nop
nop
nop
nop
...
nop
dec %r10
lea addresses_UC_ht+0xb82d, %rdx
add $56171, %r14
movb $0x61, (%rdx)
nop
and %r9, %r9
...
// Store
lea addresses_normal+0x12fa1, %r8
nop
nop
nop
nop
...
// Load
lea addresses_WC+0x105d9, %r10
add $31527, %rbx
mov (%r10), %r8w
and $18633, %rbx

// Faulty Load
lea addresses_WC+0x105d9, %r13
nop
nop
nop
nop
