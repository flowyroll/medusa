...
push %rdx
push %rsi
lea addresses_WC_ht+0x1c64b, %r12
nop
nop
cmp $44593, %r11
mov (%r12), %rdx
nop
xor $19532, %r14
lea addresses_UC_ht+0x574b, %rsi
lea addresses_A_ht+0x1ed3b, %rdi
nop
nop
nop
sub %rax, %rax
...
nop
cmp %rsi, %rsi
lea addresses_UC_ht+0x9c4b, %rsi
lea addresses_normal_ht+0x16c4c, %rdi
nop
nop
nop
sub %r12, %r12
...
rep movsb
xor $54351, %rdx
lea addresses_normal_ht+0x1eceb, %rsi
...
nop
xor $51930, %rdi
lea addresses_UC_ht+0x1334b, %rax
nop
nop
nop
nop
...
// Faulty Load
lea addresses_normal+0x4f4b, %r15
nop
nop
add %rdi, %rdi
movups (%r15), %xmm0
...
{'OP': 'REPM', 'src': {'same': False, 'congruent': 11, 'type': 'addresses_UC_ht'}, 'dst': {'same': False, 'congruent': 4, 'type': 'addresses_A_ht'}}
{'OP': 'REPM', 'src': {'same': False, 'congruent': 6, 'type': 'addresses_UC_ht'}, 'dst': {'same': False, 'congruent': 0, 'type': 'addresses_normal_ht'}}
{'OP': 'REPM', 'src': {'same': False, 'congruent': 1, 'type': 'addresses_normal_ht'}, 'dst': {'same': False, 'congruent': 4, 'type': 'addresses_UC_ht'}}
{'OP': 'STOR', 'dst': {'same': False, 'type': 'addresses_A_ht', 'NT': True, 'AVXalign': False, 'size': 2, 'congruent': 0}}
