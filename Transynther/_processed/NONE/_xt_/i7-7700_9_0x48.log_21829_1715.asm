...
nop
sub $30413, %rcx
lea addresses_UC_ht+0x92c8, %rbp
clflush (%rbp)
nop
nop
add $45564, %rsi
...
nop
xor $15798, %rdi
lea addresses_WT_ht+0x13a9e, %r10
clflush (%r10)
nop
xor %rdi, %rdi
mov (%r10), %cx
...
nop
inc %rbp
lea addresses_WT_ht+0x11d48, %rdi
nop
nop
sub $23856, %r8
...
nop
dec %rdi
lea addresses_A_ht+0x2448, %r10
and $10282, %rsi
mov $0x6162636465666768, %rcx
movq %rcx, (%r10)
nop
inc %r15
lea addresses_A_ht+0x1e788, %rsi
nop
nop
add $29524, %rdi
movw $0x6162, (%rsi)
nop
cmp $3179, %rdi
lea addresses_WC_ht+0xf248, %rsi
nop
nop
nop
nop
...
{'OP': 'LOAD', 'src': {'type': 'addresses_A', 'AVXalign': False, 'congruent': 11, 'size': 4, 'same': False, 'NT': True}}
[Faulty Load]
...
{'OP': 'LOAD', 'src': {'type': 'addresses_WT_ht', 'AVXalign': True, 'congruent': 10, 'size': 2, 'same': True, 'NT': False}}
...
{'OP': 'STOR', 'dst': {'type': 'addresses_A_ht', 'AVXalign': False, 'congruent': 3, 'size': 2, 'same': False, 'NT': True}}
