...
push %rdi
push %rsi
lea addresses_D_ht+0x1bb87, %r15
nop
nop
nop
nop
...
nop
sub $2274, %r12
lea addresses_UC_ht+0x394b, %rsi
lea addresses_UC_ht+0x5787, %rdi
nop
nop
dec %r15
mov $42, %rcx
...
nop
add %r12, %r12
lea addresses_D_ht+0x17f87, %rsi
...
nop
add %rsi, %rsi
lea addresses_WC_ht+0x4687, %r13
nop
nop
nop
nop
...
nop
xor $61478, %r10
lea addresses_normal_ht+0xf1cb, %rsi
lea addresses_WT_ht+0x1e647, %rdi
nop
nop
nop
nop
...
nop
dec %rsi
lea addresses_WC_ht+0xdf87, %rdi
nop
nop
xor %rsi, %rsi
movl $0x61626364, (%rdi)
...
nop
sub $57076, %r10
lea addresses_UC_ht+0x8887, %r10
nop
xor $9448, %rcx
mov (%r10), %rdi
nop
...
nop
sub %rcx, %rcx
lea addresses_normal_ht+0x17f91, %rsi
lea addresses_A_ht+0xa107, %rdi
sub %r12, %r12
mov $11, %rcx
rep movsw
cmp $49161, %rdi
lea addresses_normal_ht+0x17287, %rsi
clflush (%rsi)
nop
nop
nop
...
<gen_prepare_buffer>
{'src': {'NT': False, 'AVXalign': False, 'size': 8, 'congruent': 8, 'same': True, 'type': 'addresses_D_ht'}, 'OP': 'LOAD'}
{'src': {'congruent': 2, 'same': False, 'type': 'addresses_UC_ht'}, 'dst': {'congruent': 10, 'same': False, 'type': 'addresses_UC_ht'}, 'OP': 'REPM'}
...
{'src': {'congruent': 2, 'same': False, 'type': 'addresses_normal_ht'}, 'dst': {'congruent': 5, 'same': False, 'type': 'addresses_WT_ht'}, 'OP': 'REPM'}
