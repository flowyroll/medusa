...
push %rdx
push %rsi
lea addresses_WT_ht+0xea09, %rsi
lea addresses_A_ht+0x8275, %rdi
cmp $37842, %r15
mov $103, %rcx
rep movsl
nop
...
nop
cmp %r10, %r10
lea addresses_D_ht+0x18f2d, %r10
nop
nop
cmp %rax, %rax
...
nop
xor $38067, %r15
lea addresses_WT_ht+0x1e6c9, %rax
nop
nop
nop
nop
...
lea addresses_WT_ht+0xd6a9, %rdi
nop
nop
and $37813, %rdx
mov $118, %rcx
...
nop
add %rdx, %rdx
lea addresses_UC_ht+0x6c75, %rdx
dec %rax
...
nop
add %r15, %r15
lea addresses_normal_ht+0x22e9, %rsi
lea addresses_WC_ht+0xc649, %rdi
clflush (%rdi)
nop
and $15653, %r10
mov $74, %rcx
...
rep movsw
xor $46811, %r8
lea addresses_normal_ht+0x10a01, %rdi
nop
sub $4836, %rcx
mov (%rdi), %si
nop
nop
add $50625, %r15
lea addresses_WC_ht+0x12209, %r8
nop
nop
nop
nop
...
nop
add $41884, %rcx
lea addresses_UC_ht+0x19069, %rsi
lea addresses_D_ht+0x14e19, %rdi
nop
nop
nop
nop
...
<gen_prepare_buffer>
{'OP': 'REPM', 'src': {'type': 'addresses_WT_ht', 'congruent': 4, 'same': True}, 'dst': {'type': 'addresses_A_ht', 'congruent': 2, 'same': False}}
...
{'OP': 'LOAD', 'src': {'type': 'addresses_normal_ht', 'size': 2, 'AVXalign': False, 'NT': False, 'congruent': 3, 'same': True}}
