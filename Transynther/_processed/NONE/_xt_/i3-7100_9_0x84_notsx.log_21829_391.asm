...
push %rdx
push %rsi
lea addresses_normal_ht+0x334b, %rsi
lea addresses_UC_ht+0x149cb, %rdi
nop
nop
nop
sub %r12, %r12
...
nop
xor $23679, %r13
lea addresses_WC_ht+0x514b, %rdx
clflush (%rdx)
nop
nop
dec %rbp
...
nop
cmp $54175, %rdi
lea addresses_UC_ht+0x864b, %rbp
cmp $64699, %rdi
...
nop
add $30705, %rdi
lea addresses_A_ht+0x131cb, %rcx
and %r12, %r12
movb (%rcx), %r13b
nop
nop
inc %rsi
lea addresses_A_ht+0x1c8cb, %rsi
add $40893, %rbp
