...
push %rdi
push %rsi
lea addresses_UC_ht+0x1543d, %rsi
lea addresses_normal_ht+0x8d7d, %rdi
nop
nop
add $17451, %r10
mov $84, %rcx
...
nop
inc %rcx
lea addresses_normal_ht+0xef7d, %r14
nop
nop
sub %rsi, %rsi
vmovups (%r14), %ymm7
...
nop
and $42687, %r14
lea addresses_WT_ht+0x987d, %rdi
nop
nop
nop
add $55904, %r13
...
nop
xor $1214, %r14
lea addresses_D_ht+0x15a09, %rsi
lea addresses_D_ht+0xf57e, %rdi
clflush (%rdi)
dec %r8
mov $7, %rcx
rep movsw
...
nop
and $37512, %rcx
lea addresses_normal_ht+0xa0d, %rsi
lea addresses_A_ht+0x683b, %rdi
clflush (%rsi)
add $10445, %r8
mov $2, %rcx
rep movsb
...
nop
add $26077, %r13
lea addresses_WT_ht+0x1d1fd, %r10
nop
sub %rcx, %rcx
movups (%r10), %xmm5
vpextrq $1, %xmm5, %r8
...
nop
sub %r13, %r13
lea addresses_D_ht+0x1a1fd, %rcx
nop
nop
xor $7175, %r14
mov (%rcx), %r8
nop
cmp %r11, %r11
lea addresses_D_ht+0x18c50, %rdi
nop
nop
nop
nop
...
nop
add $8304, %r14
lea addresses_WC_ht+0x7cdd, %r11
add %r8, %r8
movw $0x6162, (%r11)
nop
nop
