...
push %rdx
push %rsi
lea addresses_WT_ht+0x9f6f, %r11
nop
xor %r15, %r15
movb (%r11), %dl
nop
...
nop
xor $31975, %r13
lea addresses_normal_ht+0x119a4, %rax
nop
nop
and %r9, %r9
movups (%rax), %xmm4
...
nop
cmp %r14, %r14
lea addresses_UC_ht+0x36c4, %r15
clflush (%r15)
nop
and $59749, %r14
movw $0x6162, (%r15)
nop
sub %r15, %r15
lea addresses_normal_ht+0x1ac4, %r11
nop
nop
cmp $36234, %rdx
...
nop
sub $54341, %r11
lea addresses_WC_ht+0x192fc, %rax
nop
nop
nop
nop
...
nop
xor $10075, %rdx
lea addresses_normal_ht+0x1ba44, %rsi
lea addresses_WC_ht+0x13026, %rdi
nop
sub $11963, %rdx
mov $1, %rcx
rep movsw
nop
cmp %rcx, %rcx
lea addresses_UC_ht+0x9a44, %rsi
lea addresses_WC_ht+0xeec4, %rdi
cmp $39458, %rdx
mov $87, %rcx
rep movsw
nop
cmp $17750, %r9
lea addresses_normal_ht+0xa0c4, %rax
nop
nop
sub %r11, %r11
movl $0x61626364, (%rax)
...
nop
cmp %rax, %rax
lea addresses_WC_ht+0x1050, %rax
clflush (%rax)
nop
nop
nop
...
{'src': {'type': 'addresses_UC_ht', 'congruent': 3, 'same': False}, 'OP': 'REPM', 'dst': {'type': 'addresses_WC_ht', 'congruent': 8, 'same': True}}
{'OP': 'STOR', 'dst': {'same': False, 'congruent': 8, 'NT': True, 'type': 'addresses_normal_ht', 'size': 4, 'AVXalign': True}}
