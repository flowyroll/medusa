...
push %rdi
push %rsi
lea addresses_WT_ht+0x98b2, %rbp
nop
inc %r10
movb $0x61, (%rbp)
nop
...
nop
and $9659, %rax
lea addresses_UC_ht+0x1e172, %r9
nop
nop
nop
sub $28324, %r14
movw $0x6162, (%r9)
sub %r8, %r8
lea addresses_WC_ht+0x188b2, %r14
nop
nop
inc %rcx
mov (%r14), %r8
...
nop
and $21362, %r8
lea addresses_D_ht+0x11cb2, %rsi
lea addresses_A_ht+0x11632, %rdi
xor %r10, %r10
mov $50, %rcx
rep movsb
nop
dec %rax
lea addresses_WC_ht+0xab02, %rsi
...
nop
sub %rcx, %rcx
lea addresses_normal_ht+0x98b2, %r8
nop
nop
nop
sub %rax, %rax
...
{'src': {'congruent': 9, 'same': False, 'type': 'addresses_D_ht'}, 'dst': {'congruent': 3, 'same': False, 'type': 'addresses_A_ht'}, 'OP': 'REPM'}
{'src': {'congruent': 4, 'same': False, 'type': 'addresses_WC_ht'}, 'dst': {'congruent': 7, 'same': False, 'type': 'addresses_normal_ht'}, 'OP': 'REPM'}
