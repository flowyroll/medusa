...
nop
and $34024, %rdi
lea addresses_D_ht+0x108a0, %rsi
...
nop
and $62760, %rdi
lea addresses_WC_ht+0x160a0, %r10
nop
nop
nop
cmp $3001, %rbp
...
nop
add $53190, %rcx
lea addresses_WT_ht+0x1e120, %rsi
lea addresses_WT_ht+0x34f0, %rdi
clflush (%rdi)
nop
nop
and $27333, %r15
...
nop
xor %r8, %r8
lea addresses_WC_ht+0x1d5bb, %rdi
nop
nop
nop
nop
...
nop
and %rsi, %rsi
lea addresses_D_ht+0x4bd0, %rsi
lea addresses_WC_ht+0xcea, %rdi
nop
and %r15, %r15
mov $8, %rcx
rep movsl
...
nop
sub %r15, %r15
lea addresses_normal_ht+0x467e, %rsi
lea addresses_WC_ht+0x1aaa0, %rdi
nop
nop
nop
nop
...
nop
xor $52539, %rbx
lea addresses_D_ht+0x15340, %rbx
nop
nop
nop
xor $53047, %r8
...
nop
xor $43196, %rsi
lea addresses_WT_ht+0x11c10, %rsi
lea addresses_normal_ht+0x139c0, %rdi
clflush (%rsi)
nop
nop
nop
...
nop
dec %rcx
lea addresses_D_ht+0x136e0, %rbp
and $12925, %rsi
movups (%rbp), %xmm0
vpextrq $1, %xmm0, %r8
nop
...
nop
cmp %rbp, %rbp
lea addresses_WC_ht+0xc130, %r15
nop
nop
nop
cmp $10312, %r10
...
{'src': {'type': 'addresses_D_ht', 'congruent': 8, 'same': False}, 'OP': 'REPM', 'dst': {'type': 'addresses_A_ht', 'congruent': 10, 'same': False}}
...
{'src': {'type': 'addresses_WT_ht', 'congruent': 7, 'same': False}, 'OP': 'REPM', 'dst': {'type': 'addresses_WT_ht', 'congruent': 4, 'same': False}}
...
{'src': {'type': 'addresses_WT_ht', 'congruent': 4, 'same': False}, 'OP': 'REPM', 'dst': {'type': 'addresses_normal_ht', 'congruent': 3, 'same': True}}
...
{'src': {'type': 'addresses_WC_ht', 'AVXalign': False, 'size': 16, 'NT': False, 'same': True, 'congruent': 1}, 'OP': 'LOAD'}
{'33': 21829}
