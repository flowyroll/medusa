...
push %rdi
push %rsi
lea addresses_WT_ht+0x3d09, %rsi
lea addresses_UC_ht+0x5915, %rdi
xor %r11, %r11
mov $25, %rcx
rep movsq
nop
...
nop
inc %rcx
lea addresses_UC_ht+0x1117d, %r9
nop
sub $64999, %r10
vmovups (%r9), %ymm5
...
nop
and $56317, %rcx
lea addresses_normal_ht+0x1915f, %r9
cmp %rdi, %rdi
...
nop
xor $61185, %r11
lea addresses_WT_ht+0xda09, %rsi
...
nop
cmp %rsi, %rsi
lea addresses_A_ht+0x105f1, %rsi
...
nop
cmp $52884, %rcx
lea addresses_UC_ht+0x1609, %rsi
lea addresses_A_ht+0x1e309, %rdi
dec %r11
mov $9, %rcx
rep movsw
nop
...
nop
and %r15, %r15
lea addresses_A_ht+0x17aaf, %r10
nop
sub $35708, %rdi
movb $0x61, (%r10)
nop
...
nop
cmp %r12, %r12
lea addresses_WC_ht+0xb209, %rsi
nop
nop
nop
add $60103, %rdi
...
<gen_prepare_buffer>
{'OP': 'REPM', 'src': {'same': False, 'congruent': 10, 'type': 'addresses_WT_ht'}, 'dst': {'same': False, 'congruent': 2, 'type': 'addresses_UC_ht'}}
...
{'OP': 'REPM', 'src': {'same': False, 'congruent': 3, 'type': 'addresses_A_ht'}, 'dst': {'same': False, 'congruent': 4, 'type': 'addresses_WC_ht'}}
