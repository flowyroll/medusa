...
nop
add $37723, %r8
lea addresses_WT_ht+0x11937, %rcx
nop
nop
nop
and $45519, %rbx
...
nop
xor $30594, %rcx
lea addresses_WC_ht+0xfb00, %rsi
lea addresses_WC_ht+0xef9, %rdi
nop
nop
nop
add %r14, %r14
...
nop
xor %rdi, %rdi
lea addresses_UC_ht+0x5fd9, %r14
nop
nop
inc %r8
mov (%r14), %r9d
nop
add %rdi, %rdi
lea addresses_WT_ht+0x12fa5, %r14
nop
cmp $64816, %rcx
movl $0x61626364, (%r14)
nop
...
// Faulty Load
lea addresses_normal+0x48f9, %rsi
nop
add $12867, %r9
mov (%rsi), %r8
lea oracles, %r14
...
{'OP': 'STOR', 'dst': {'same': False, 'type': 'addresses_US', 'NT': False, 'AVXalign': False, 'size': 8, 'congruent': 0}}
{'OP': 'STOR', 'dst': {'same': False, 'type': 'addresses_RW', 'NT': False, 'AVXalign': False, 'size': 8, 'congruent': 2}}
{'OP': 'STOR', 'dst': {'same': False, 'type': 'addresses_UC', 'NT': False, 'AVXalign': False, 'size': 4, 'congruent': 1}}
...
<gen_prepare_buffer>
{'OP': 'REPM', 'src': {'same': False, 'congruent': 8, 'type': 'addresses_A_ht'}, 'dst': {'same': False, 'congruent': 8, 'type': 'addresses_WT_ht'}}
{'OP': 'LOAD', 'src': {'same': False, 'type': 'addresses_WT_ht', 'NT': False, 'AVXalign': False, 'size': 8, 'congruent': 9}}
{'OP': 'LOAD', 'src': {'same': False, 'type': 'addresses_WT_ht', 'NT': True, 'AVXalign': False, 'size': 4, 'congruent': 1}}
{'OP': 'STOR', 'dst': {'same': False, 'type': 'addresses_A_ht', 'NT': False, 'AVXalign': False, 'size': 8, 'congruent': 11}}
{'OP': 'REPM', 'src': {'same': False, 'congruent': 0, 'type': 'addresses_WC_ht'}, 'dst': {'same': False, 'congruent': 8, 'type': 'addresses_WC_ht'}}
