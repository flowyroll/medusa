...
nop
add %r8, %r8
lea addresses_UC_ht+0x18ae5, %rsi
lea addresses_A_ht+0x13395, %rdi
nop
nop
nop
nop
...
// Load
lea addresses_normal+0x6e17, %rdx
nop
nop
nop
nop
...
{'src': {'NT': True, 'AVXalign': False, 'size': 8, 'congruent': 1, 'same': False, 'type': 'addresses_normal'}, 'OP': 'LOAD'}
[Faulty Load]
...
{'src': {'congruent': 10, 'same': True, 'type': 'addresses_UC_ht'}, 'dst': {'congruent': 3, 'same': False, 'type': 'addresses_A_ht'}, 'OP': 'REPM'}
