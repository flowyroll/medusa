...
nop
add $36251, %rcx
lea addresses_WC_ht+0x16f5c, %r11
nop
nop
nop
nop
...
mov (%r11), %r9d
sub $56522, %r9
lea addresses_WC_ht+0x5b42, %rsi
lea addresses_D_ht+0x11ed4, %rdi
and %r15, %r15
mov $28, %rcx
rep movsb
nop
...
nop
sub %r13, %r13
lea addresses_normal_ht+0x1cd94, %r15
nop
nop
sub %r8, %r8
...
nop
dec %r9
lea addresses_A_ht+0x18753, %rcx
nop
nop
nop
and %rsi, %rsi
...
nop
add %r11, %r11
lea addresses_UC_ht+0x44d4, %rsi
lea addresses_D_ht+0x136d4, %rdi
clflush (%rsi)
nop
and $44169, %r13
mov $87, %rcx
...
<gen_prepare_buffer>
{'src': {'type': 'addresses_WT_ht', 'same': True, 'size': 4, 'congruent': 11, 'NT': False, 'AVXalign': False}, 'OP': 'LOAD'}
