...
push %rdi
push %rsi
lea addresses_WC_ht+0x6252, %rsi
lea addresses_normal_ht+0x1bb52, %rdi
clflush (%rdi)
nop
nop
xor %r9, %r9
...
nop
dec %rcx
lea addresses_WT_ht+0x123b2, %rsi
lea addresses_WT_ht+0xd641, %rdi
nop
nop
inc %r8
mov $65, %rcx
...
nop
cmp $7196, %rsi
lea addresses_WT_ht+0x181f2, %r10
clflush (%r10)
nop
nop
nop
...
nop
and $22489, %rsi
lea addresses_WT_ht+0x920a, %rsi
cmp %rcx, %rcx
mov (%rsi), %rdi
nop
nop
