...
push %rdi
push %rsi
lea addresses_WT_ht+0xb3bc, %rsi
nop
nop
lfence
movb $0x61, (%rsi)
...
lea addresses_WC_ht+0x7cf4, %rdi
cmp $7913, %rax
mov $3, %rcx
rep movsq
nop
...
lea addresses_WT_ht+0x74ac, %rdi
nop
nop
nop
nop
...
nop
sub $47626, %rsi
lea addresses_D_ht+0x1cfac, %rsi
lea addresses_normal_ht+0x19ca4, %rdi
nop
and $49085, %r15
mov $37, %rcx
rep movsb
nop
add %rdi, %rdi
lea addresses_A_ht+0x1a02c, %r11
cmp %rax, %rax
movups (%r11), %xmm5
vpextrq $0, %xmm5, %rcx
and $10083, %rsi
lea addresses_D_ht+0xfaac, %r8
nop
nop
nop
xor $8187, %r11
...
<gen_prepare_buffer>
{'OP': 'STOR', 'dst': {'same': False, 'congruent': 3, 'NT': True, 'type': 'addresses_WT_ht', 'size': 1, 'AVXalign': False}}
