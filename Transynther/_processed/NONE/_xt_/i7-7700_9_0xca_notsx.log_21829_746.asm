...
push %rdi
push %rsi
lea addresses_WT_ht+0x1785f, %rsi
lea addresses_WC_ht+0xc04f, %rdi
nop
nop
inc %r11
mov $82, %rcx
...
nop
and $22737, %r10
lea addresses_D_ht+0x1244f, %rsi
lea addresses_normal_ht+0x1c9b7, %rdi
dec %rbp
mov $19, %rcx
rep movsl
dec %r11
lea addresses_normal_ht+0xbb3f, %rsi
lea addresses_D_ht+0xb04f, %rdi
clflush (%rsi)
nop
nop
nop
...
nop
cmp %rbp, %rbp
lea addresses_WT_ht+0xc113, %rdi
nop
sub %r14, %r14
movl $0x61626364, (%rdi)
nop
...
nop
and %r10, %r10
lea addresses_D_ht+0x39af, %r10
nop
nop
add $53479, %rbp
mov (%r10), %rdi
sub %r11, %r11
lea addresses_D_ht+0xd41d, %rdi
cmp $2038, %r11
mov $0x6162636465666768, %rcx
movq %rcx, %xmm6
movups %xmm6, (%rdi)
sub %r14, %r14
lea addresses_WC_ht+0xcfdf, %rcx
add $29052, %rbp
vmovups (%rcx), %ymm5
...
{'src': {'congruent': 9, 'same': False, 'type': 'addresses_D_ht'}, 'dst': {'congruent': 3, 'same': False, 'type': 'addresses_normal_ht'}, 'OP': 'REPM'}
{'src': {'congruent': 2, 'same': False, 'type': 'addresses_normal_ht'}, 'dst': {'congruent': 11, 'same': False, 'type': 'addresses_D_ht'}, 'OP': 'REPM'}
{'dst': {'NT': False, 'AVXalign': False, 'size': 4, 'congruent': 0, 'same': False, 'type': 'addresses_WT_ht'}, 'OP': 'STOR'}
{'src': {'NT': False, 'AVXalign': True, 'size': 8, 'congruent': 5, 'same': False, 'type': 'addresses_D_ht'}, 'OP': 'LOAD'}
