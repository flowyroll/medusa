...
movb $0x61, (%r9)
lfence
lea addresses_WC_ht+0x89c6, %rsi
lea addresses_normal_ht+0x16e4e, %rdi
nop
nop
nop
cmp %r13, %r13
...
nop
cmp %rcx, %rcx
lea addresses_WT_ht+0x9b6a, %r15
nop
and %rcx, %rcx
movl $0x61626364, (%r15)
nop
inc %r13
lea addresses_WT_ht+0xf69e, %r13
clflush (%r13)
nop
nop
sub %rsi, %rsi
...
nop
add %r13, %r13
lea addresses_WC_ht+0x16a4e, %r10
nop
cmp $29966, %r13
vmovups (%r10), %ymm4
...
nop
dec %r13
lea addresses_WC_ht+0x15c4e, %r15
nop
nop
nop
sub $3176, %rcx
...
nop
sub %rdi, %rdi
lea addresses_WT_ht+0xb24e, %r13
and $51815, %rcx
movups (%r13), %xmm0
vpextrq $0, %xmm0, %r10
nop
...
nop
xor $6760, %r13
lea addresses_WT_ht+0x1ca4e, %r13
nop
nop
nop
cmp %r15, %r15
...
// Load
lea addresses_normal+0xe24e, %rdi
cmp $19744, %r9
vmovups (%rdi), %ymm2
...
// Faulty Load
lea addresses_normal+0xe24e, %rdx
clflush (%rdx)
nop
add $33261, %r13
movb (%rdx), %al
