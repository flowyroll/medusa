...
lea addresses_UC_ht+0xc0e0, %rdi
nop
cmp $64733, %r14
mov $118, %rcx
rep movsq
add $10218, %r14
lea addresses_A_ht+0xae6e, %rdx
clflush (%rdx)
nop
nop
nop
...
nop
sub %rcx, %rcx
lea addresses_WC_ht+0x466e, %r14
nop
and %rbp, %rbp
mov (%r14), %esi
nop
nop
add %rdx, %rdx
lea addresses_WT_ht+0x1b46e, %rcx
nop
nop
xor %r10, %r10
vmovups (%rcx), %ymm4
...
nop
cmp %rdx, %rdx
lea addresses_UC_ht+0x136f6, %rbp
add %rcx, %rcx
mov (%rbp), %rdx
nop
nop
nop
cmp %r14, %r14
lea addresses_A_ht+0x1dfae, %r14
nop
nop
add %rbp, %rbp
...
nop
add $10599, %rdx
lea addresses_A_ht+0x1c84e, %rsi
lea addresses_WT_ht+0x174fe, %rdi
nop
nop
nop
inc %r8
...
nop
add %rbp, %rbp
lea addresses_A_ht+0x1166e, %rsi
lea addresses_normal_ht+0x13dfa, %rdi
cmp %r8, %r8
mov $94, %rcx
rep movsw
nop
...
{'dst': {'type': 'addresses_D', 'same': False, 'size': 4, 'congruent': 1, 'NT': False, 'AVXalign': True}, 'OP': 'STOR'}
...
{'src': {'type': 'addresses_UC', 'same': False, 'size': 8, 'congruent': 2, 'NT': False, 'AVXalign': False}, 'OP': 'LOAD'}
[Faulty Load]
{'src': {'type': 'addresses_WT', 'same': True, 'size': 8, 'congruent': 0, 'NT': False, 'AVXalign': False}, 'OP': 'LOAD'}
<gen_prepare_buffer>
{'src': {'type': 'addresses_normal_ht', 'congruent': 6, 'same': False}, 'dst': {'type': 'addresses_UC_ht', 'congruent': 0, 'same': False}, 'OP': 'REPM'}
...
{'dst': {'type': 'addresses_UC_ht', 'same': False, 'size': 8, 'congruent': 0, 'NT': False, 'AVXalign': True}, 'OP': 'STOR'}
...
{'src': {'type': 'addresses_A_ht', 'congruent': 9, 'same': False}, 'dst': {'type': 'addresses_normal_ht', 'congruent': 2, 'same': False}, 'OP': 'REPM'}
{'39': 21829}
