...
nop
sub $60120, %rdi
lea addresses_WC_ht+0x12f66, %rsi
lea addresses_WT_ht+0x10056, %rdi
clflush (%rsi)
nop
add %r8, %r8
mov $67, %rcx
...
nop
sub $42766, %r8
lea addresses_WC_ht+0x1e75e, %rdi
sub %rbp, %rbp
movb (%rdi), %cl
cmp $62877, %r8
lea addresses_normal_ht+0x14096, %rsi
nop
nop
cmp %rbp, %rbp
vmovups (%rsi), %ymm4
...
nop
cmp %r9, %r9
lea addresses_UC_ht+0x15b96, %r9
nop
nop
nop
nop
...
nop
sub $26716, %rsi
lea addresses_WT_ht+0x10f16, %rsi
lea addresses_normal_ht+0x15356, %rdi
nop
nop
nop
nop
...
nop
add $65335, %rsi
lea addresses_WC_ht+0x17b96, %r10
nop
nop
cmp %r13, %r13
movl $0x61626364, (%r10)
...
{'OP': 'REPM', 'src': {'type': 'addresses_WC_ht', 'congruent': 4, 'same': False}, 'dst': {'type': 'addresses_WT_ht', 'congruent': 6, 'same': True}}
