...
rep movsw
and %r11, %r11
lea addresses_normal_ht+0x2c7e, %rsi
lea addresses_UC_ht+0x1985e, %rdi
nop
nop
nop
nop
...
nop
and $3463, %r9
lea addresses_normal_ht+0x1055e, %rsi
lea addresses_WC_ht+0xe86c, %rdi
nop
nop
nop
sub %r11, %r11
...
nop
cmp %rax, %rax
lea addresses_D_ht+0x375e, %rsi
lea addresses_normal_ht+0x3d9e, %rdi
nop
cmp %r9, %r9
mov $56, %rcx
rep movsb
nop
xor %rdx, %rdx
lea addresses_UC_ht+0xec1e, %r11
nop
cmp $56809, %rdx
movb (%r11), %r9b
sub %rdi, %rdi
lea addresses_D_ht+0x2132, %rcx
xor %r9, %r9
mov (%rcx), %r10w
xor %r10, %r10
lea addresses_A_ht+0x6a5e, %r11
clflush (%r11)
nop
nop
nop
...
nop
add %rdx, %rdx
lea addresses_UC_ht+0x19a8, %rdi
clflush (%rdi)
nop
nop
nop
...
{'OP': 'REPM', 'src': {'same': False, 'congruent': 5, 'type': 'addresses_normal_ht'}, 'dst': {'same': True, 'congruent': 8, 'type': 'addresses_UC_ht'}}
{'OP': 'REPM', 'src': {'same': False, 'congruent': 10, 'type': 'addresses_normal_ht'}, 'dst': {'same': False, 'congruent': 1, 'type': 'addresses_WC_ht'}}
{'OP': 'REPM', 'src': {'same': False, 'congruent': 9, 'type': 'addresses_D_ht'}, 'dst': {'same': False, 'congruent': 4, 'type': 'addresses_normal_ht'}}
