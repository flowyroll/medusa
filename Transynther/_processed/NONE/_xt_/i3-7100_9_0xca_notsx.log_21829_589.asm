...
nop
dec %rsi
lea addresses_normal_ht+0x6ddd, %r14
cmp $41726, %rdi
vmovups (%r14), %ymm0
...
{'OP': 'STOR', 'dst': {'same': False, 'congruent': 0, 'NT': False, 'type': 'addresses_NC', 'size': 16, 'AVXalign': False}}
[Faulty Load]
