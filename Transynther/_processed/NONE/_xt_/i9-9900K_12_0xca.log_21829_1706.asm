...
lea addresses_normal_ht+0x166ee, %rdi
nop
nop
nop
nop
...
lea addresses_UC_ht+0x1eefe, %rdi
clflush (%rsi)
nop
nop
nop
...
// Store
lea addresses_normal+0x1cd9e, %rcx
nop
and %r8, %r8
movl $0x51525354, (%rcx)
nop
...
{'OP': 'REPM', 'src': {'same': False, 'type': 'addresses_WT_ht', 'congruent': 10}, 'dst': {'same': False, 'type': 'addresses_normal_ht', 'congruent': 4}}
{'OP': 'REPM', 'src': {'same': False, 'type': 'addresses_WC_ht', 'congruent': 1}, 'dst': {'same': False, 'type': 'addresses_UC_ht', 'congruent': 4}}
