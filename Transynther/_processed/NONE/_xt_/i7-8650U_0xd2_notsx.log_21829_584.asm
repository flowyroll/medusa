...
push %rdi
push %rsi
lea addresses_UC_ht+0x143fa, %r14
sub %rax, %rax
mov (%r14), %r11w
nop
nop
...
nop
sub %r8, %r8
lea addresses_WT_ht+0x403a, %rax
nop
nop
sub $28655, %rdi
mov (%rax), %rcx
...
nop
inc %rcx
lea addresses_WT_ht+0x126fa, %r8
nop
nop
nop
nop
...
mov (%r8), %r14w
add %rax, %rax
lea addresses_D_ht+0x66fa, %rsi
lea addresses_UC_ht+0xf1be, %rdi
clflush (%rsi)
nop
nop
nop
...
nop
sub $17442, %rax
lea addresses_D_ht+0xf3fa, %rsi
lea addresses_A_ht+0x259a, %rdi
nop
nop
nop
add $26964, %rax
...
nop
and $46672, %r8
lea addresses_WT_ht+0x94ba, %rsi
...
<gen_prepare_buffer>
{'OP': 'LOAD', 'src': {'type': 'addresses_UC_ht', 'size': 2, 'AVXalign': True, 'NT': False, 'congruent': 10, 'same': True}}
