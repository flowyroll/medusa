...
push %rdi
push %rsi
lea addresses_WC_ht+0x957f, %rbx
nop
nop
nop
xor $16084, %rbp
...
nop
inc %rcx
lea addresses_normal_ht+0x1de3f, %rsi
...
rep movsl
cmp $30293, %rsi
lea addresses_D_ht+0x148ff, %r13
nop
nop
nop
nop
...
nop
sub %r8, %r8
lea addresses_A_ht+0x1a84f, %rsi
lea addresses_D_ht+0x17113, %rdi
inc %r10
mov $113, %rcx
rep movsw
nop
xor %r11, %r11
lea addresses_WC_ht+0xaa3c, %r10
nop
cmp %rcx, %rcx
mov (%r10), %si
nop
...
{'OP': 'REPM', 'src': {'type': 'addresses_A_ht', 'congruent': 4, 'same': True}, 'dst': {'type': 'addresses_D_ht', 'congruent': 2, 'same': False}}
{'OP': 'LOAD', 'src': {'type': 'addresses_WC_ht', 'size': 2, 'AVXalign': True, 'NT': False, 'congruent': 0, 'same': False}}
{'36': 18014}
