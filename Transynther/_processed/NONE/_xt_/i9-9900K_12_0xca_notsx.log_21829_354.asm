...
push %rdi
push %rsi
lea addresses_WT_ht+0x1903b, %r9
nop
nop
add $44294, %r14
movb (%r9), %r8b
...
nop
sub %rdi, %rdi
lea addresses_WT_ht+0xd082, %rbp
nop
and $19215, %r15
movw $0x6162, (%rbp)
nop
...
nop
and $7832, %r15
lea addresses_WT_ht+0xb23b, %rsi
nop
nop
nop
nop
...
nop
add $57693, %rsi
lea addresses_WT_ht+0x4097, %rsi
lea addresses_A_ht+0x49d5, %rdi
nop
nop
nop
xor %r9, %r9
...
nop
cmp %r8, %r8
lea addresses_normal_ht+0x1a23b, %r9
nop
nop
sub %rsi, %rsi
movb (%r9), %r8b
...
{'OP': 'REPM', 'src': {'same': True, 'congruent': 0, 'type': 'addresses_WT_ht'}, 'dst': {'same': False, 'congruent': 0, 'type': 'addresses_A_ht'}}
