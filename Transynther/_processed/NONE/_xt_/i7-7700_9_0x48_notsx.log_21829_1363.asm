...
push %rdx
push %rsi
lea addresses_A_ht+0x11dc3, %rbp
and $45397, %r15
mov (%rbp), %edi
nop
nop
mfence
lea addresses_WT_ht+0xc193, %rdx
nop
nop
nop
cmp $35952, %r13
...
nop
add %rdi, %rdi
lea addresses_WC_ht+0x12313, %r13
nop
nop
nop
nop
...
nop
sub %rdi, %rdi
lea addresses_WT_ht+0x2b13, %rsi
nop
nop
nop
sub $44595, %rdi
...
rep movsw
add %rsi, %rsi
lea addresses_A_ht+0x1b813, %rsi
lea addresses_A_ht+0x1c313, %rdi
nop
nop
xor %r14, %r14
mov $123, %rcx
...
nop
add %rbp, %rbp
lea addresses_WC_ht+0x1cad3, %rsi
lea addresses_WT_ht+0xaed3, %rdi
nop
nop
and $53926, %rdx
mov $7, %rcx
...
nop
inc %rdx
lea addresses_UC_ht+0xeb11, %rcx
nop
inc %rdi
mov (%rcx), %r13
nop
...
nop
xor $6794, %r14
lea addresses_UC_ht+0x128af, %rcx
nop
sub $7372, %rsi
mov (%rcx), %r14w
nop
...
{'dst': {'same': False, 'NT': True, 'AVXalign': True, 'size': 1, 'type': 'addresses_WC_ht', 'congruent': 7}, 'OP': 'STOR'}
{'dst': {'same': False, 'NT': False, 'AVXalign': False, 'size': 2, 'type': 'addresses_WT_ht', 'congruent': 6}, 'OP': 'STOR'}
{'dst': {'same': False, 'congruent': 1, 'type': 'addresses_UC_ht'}, 'OP': 'REPM', 'src': {'same': False, 'congruent': 5, 'type': 'addresses_D_ht'}}
{'dst': {'same': False, 'congruent': 10, 'type': 'addresses_A_ht'}, 'OP': 'REPM', 'src': {'same': False, 'congruent': 7, 'type': 'addresses_A_ht'}}
{'dst': {'same': True, 'congruent': 6, 'type': 'addresses_WT_ht'}, 'OP': 'REPM', 'src': {'same': False, 'congruent': 3, 'type': 'addresses_WC_ht'}}
