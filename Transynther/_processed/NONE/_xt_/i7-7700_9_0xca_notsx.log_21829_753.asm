...
push %rdi
push %rsi
lea addresses_normal_ht+0x82c6, %r10
nop
nop
xor $60252, %r9
movb (%r10), %r13b
and %rsi, %rsi
lea addresses_UC_ht+0x15ac0, %rax
nop
nop
nop
add $24584, %rdi
...
nop
and $15928, %rax
lea addresses_normal_ht+0x7b04, %rax
nop
nop
cmp %rdi, %rdi
movb (%rax), %r12b
