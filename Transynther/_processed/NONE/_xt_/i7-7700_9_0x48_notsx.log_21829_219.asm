...
nop
sub %rbx, %rbx
lea addresses_normal_ht+0x31f, %r14
nop
nop
cmp $34800, %r12
mov (%r14), %bx
...
nop
sub %rbx, %rbx
lea addresses_WT_ht+0xc7d7, %rdi
nop
nop
nop
nop
...
nop
sub $26451, %r12
lea addresses_WT_ht+0x1c307, %rdi
nop
nop
cmp %r9, %r9
movb (%rdi), %r12b
nop
sub %r14, %r14
lea addresses_UC_ht+0x14f07, %r9
clflush (%r9)
nop
and %r14, %r14
movups (%r9), %xmm7
...
nop
cmp %rdi, %rdi
lea addresses_WC_ht+0x9b07, %rsi
nop
nop
nop
nop
...
{'dst': {'same': False, 'congruent': 4, 'type': 'addresses_NC'}, 'OP': 'REPM', 'src': {'same': False, 'congruent': 2, 'type': 'addresses_P'}}
[Faulty Load]
{'OP': 'LOAD', 'src': {'same': True, 'NT': False, 'AVXalign': False, 'size': 1, 'type': 'addresses_WT', 'congruent': 0}}
<gen_prepare_buffer>
{'dst': {'same': True, 'congruent': 2, 'type': 'addresses_normal_ht'}, 'OP': 'REPM', 'src': {'same': False, 'congruent': 8, 'type': 'addresses_D_ht'}}
{'OP': 'LOAD', 'src': {'same': False, 'NT': False, 'AVXalign': False, 'size': 8, 'type': 'addresses_WT_ht', 'congruent': 5}}
{'OP': 'LOAD', 'src': {'same': False, 'NT': True, 'AVXalign': False, 'size': 2, 'type': 'addresses_normal_ht', 'congruent': 2}}
