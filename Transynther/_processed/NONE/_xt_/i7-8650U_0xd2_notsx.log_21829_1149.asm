...
push %rdx
push %rsi
lea addresses_WC_ht+0x1e906, %rbx
clflush (%rbx)
nop
nop
cmp %rdx, %rdx
...
nop
add $56735, %r10
lea addresses_D_ht+0x1ef30, %r11
sub %rax, %rax
movups (%r11), %xmm0
vpextrq $0, %xmm0, %rbx
nop
...
nop
and %rax, %rax
lea addresses_normal_ht+0xadee, %rsi
lea addresses_D_ht+0x18468, %rdi
clflush (%rdi)
nop
sub %r11, %r11
mov $73, %rcx
...
nop
cmp $33473, %r11
lea addresses_WC_ht+0x123ce, %rsi
lea addresses_WC_ht+0x13470, %rdi
nop
nop
nop
add $38728, %rax
...
nop
and $47092, %r11
lea addresses_A_ht+0xccb0, %rsi
lea addresses_A_ht+0x13870, %rdi
and $24355, %r11
mov $5, %rcx
rep movsq
nop
...
nop
xor $20815, %rbx
lea addresses_WT_ht+0x183e0, %rsi
lea addresses_normal_ht+0x1c550, %rdi
sub $35395, %rdx
mov $37, %rcx
rep movsw
nop
...
nop
sub $57649, %rsi
lea addresses_WT_ht+0x18670, %rsi
lea addresses_UC_ht+0xf200, %rdi
and $26056, %rbx
mov $45, %rcx
rep movsq
nop
nop
add %rbp, %rbp
lea addresses_normal_ht+0xa894, %rdx
and $14191, %rbx
movb (%rdx), %al
nop
inc %rsi
lea addresses_normal_ht+0x1a5c, %rax
clflush (%rax)
nop
and %rbp, %rbp
movb $0x61, (%rax)
...
nop
dec %rax
lea addresses_D_ht+0x1e870, %rdi
cmp $30342, %r10
movb (%rdi), %cl
inc %rbx
lea addresses_D_ht+0x6370, %rcx
nop
nop
nop
xor %rbx, %rbx
...
{'OP': 'REPM', 'src': {'type': 'addresses_WT_ht', 'congruent': 4, 'same': True}, 'dst': {'type': 'addresses_normal_ht', 'congruent': 4, 'same': False}}
