...
push %rcx
push %rsi
lea addresses_UC_ht+0x2a6c, %rcx
nop
add $2932, %rsi
movl $0x61626364, (%rcx)
nop
...
nop
add $35007, %rax
lea addresses_normal_ht+0xeefc, %r10
nop
nop
nop
nop
...
nop
dec %r11
lea addresses_WT_ht+0x779e, %rsi
nop
and $45246, %r9
...
nop
xor $23502, %rax
lea addresses_WT_ht+0x166fc, %rsi
nop
nop
nop
and %rcx, %rcx
...
nop
add %r10, %r10
lea addresses_WT_ht+0x17c7c, %r9
nop
nop
nop
add %r10, %r10
...
nop
cmp $10254, %r13
lea addresses_WT_ht+0x3f7c, %r13
nop
nop
inc %r9
mov $0x6162636465666768, %rax
...
nop
inc %rax
lea addresses_UC_ht+0x8cb1, %rcx
sub %r13, %r13
movw $0x6162, (%rcx)
nop
sub $22572, %r10
lea addresses_normal_ht+0xfd7c, %r11
nop
nop
nop
nop
...
nop
dec %rax
lea addresses_WT_ht+0xb2f0, %rcx
nop
nop
nop
nop
...
nop
dec %rcx
lea addresses_D_ht+0x1b8f0, %rcx
nop
nop
sub %r10, %r10
...
nop
xor $56711, %r13
lea addresses_WC_ht+0x9c9c, %rsi
nop
nop
nop
nop
...
{'dst': {'same': True, 'NT': False, 'AVXalign': False, 'size': 2, 'type': 'addresses_WT_ht', 'congruent': 1}, 'OP': 'STOR'}
{'dst': {'same': False, 'NT': True, 'AVXalign': False, 'size': 8, 'type': 'addresses_D_ht', 'congruent': 2}, 'OP': 'STOR'}
