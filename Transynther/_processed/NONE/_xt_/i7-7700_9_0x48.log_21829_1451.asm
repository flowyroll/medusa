...
push %rdi
push %rsi
lea addresses_UC_ht+0x16c6d, %rsi
lea addresses_D_ht+0x1cb3d, %rdi
clflush (%rsi)
nop
inc %r8
mov $2, %rcx
rep movsb
sub %r11, %r11
lea addresses_A_ht+0x1873d, %r12
nop
nop
nop
nop
...
nop
xor $3723, %r8
lea addresses_UC_ht+0x673d, %rdi
nop
nop
nop
cmp $14020, %r12
...
nop
cmp %r15, %r15
lea addresses_WT_ht+0x430d, %r15
clflush (%r15)
nop
nop
nop
...
nop
xor $21486, %rdi
lea addresses_normal_ht+0x18b3d, %r15
nop
sub $22535, %rdi
mov (%r15), %r11
add %r15, %r15
lea addresses_UC_ht+0xf13d, %rsi
lea addresses_WT_ht+0x1847d, %rdi
clflush (%rsi)
nop
nop
nop
...
nop
dec %r15
lea addresses_D_ht+0x1017d, %rsi
lea addresses_WC_ht+0x163d, %rdi
nop
nop
nop
nop
...
rep movsb
sub %rbx, %rbx
lea addresses_D_ht+0x10f3d, %rsi
nop
nop
add %rdi, %rdi
movups (%rsi), %xmm1
