...
push %rdx
push %rsi
lea addresses_WT_ht+0x5bb7, %rsi
lea addresses_WC_ht+0x8017, %rdi
nop
nop
nop
nop
...
nop
xor $36733, %r15
lea addresses_D_ht+0x1a747, %rbx
nop
nop
add %rdx, %rdx
mov (%rbx), %edi
...
nop
cmp %rbx, %rbx
lea addresses_UC_ht+0xb637, %r15
cmp $19697, %rax
...
<gen_prepare_buffer>
{'src': {'type': 'addresses_WT_ht', 'congruent': 2, 'same': False}, 'OP': 'REPM', 'dst': {'type': 'addresses_WC_ht', 'congruent': 4, 'same': False}}
...
{'src': {'same': False, 'congruent': 11, 'NT': True, 'type': 'addresses_A_ht', 'size': 16, 'AVXalign': True}, 'OP': 'LOAD'}
{'38': 21829}
