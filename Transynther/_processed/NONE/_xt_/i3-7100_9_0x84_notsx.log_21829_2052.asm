...
push %rdi
push %rsi
lea addresses_normal_ht+0x1ae6b, %r15
nop
nop
cmp %r12, %r12
mov (%r15), %r8d
...
nop
sub $18159, %rbp
lea addresses_normal_ht+0xf9db, %r13
nop
nop
nop
nop
...
nop
add %r15, %r15
lea addresses_WC_ht+0x152eb, %r12
nop
nop
dec %r13
movb (%r12), %r15b
...
nop
cmp $36312, %rbp
lea addresses_D_ht+0x11b8b, %r13
nop
nop
nop
nop
...
nop
and %rbp, %rbp
lea addresses_WT_ht+0x3e0b, %r15
clflush (%r15)
nop
nop
nop
...
mov (%r15), %r12
dec %r12
lea addresses_WC_ht+0x6c6b, %r12
nop
nop
nop
nop
