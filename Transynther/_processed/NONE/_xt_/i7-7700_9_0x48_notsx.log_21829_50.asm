...
push %rdi
push %rsi
lea addresses_normal_ht+0x1babd, %rbp
nop
nop
nop
nop
...
nop
and %rdi, %rdi
lea addresses_WT_ht+0x5bdf, %rsi
lea addresses_normal_ht+0x92fd, %rdi
nop
nop
nop
nop
...
// Load
lea addresses_normal+0xaf26, %r8
nop
nop
nop
nop
...
{'dst': {'same': False, 'congruent': 0, 'type': 'addresses_normal_ht'}, 'OP': 'REPM', 'src': {'same': False, 'congruent': 1, 'type': 'addresses_WT_ht'}}
{'35': 21829}
