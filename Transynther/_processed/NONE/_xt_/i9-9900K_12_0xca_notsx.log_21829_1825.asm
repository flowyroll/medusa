...
rep movsq
add %rbx, %rbx
lea addresses_UC_ht+0x15419, %rax
nop
add $37840, %r14
vmovups (%rax), %ymm6
...
vpextrq $1, %xmm6, %rsi
add %rdi, %rdi
lea addresses_normal_ht+0x153e9, %rsi
lea addresses_WT_ht+0xd0c9, %rdi
nop
add %r10, %r10
mov $76, %rcx
rep movsw
...
nop
inc %r14
lea addresses_A_ht+0x14d49, %rax
clflush (%rax)
nop
nop
nop
...
vmovups %ymm5, (%rax)
sub $11187, %r15
lea addresses_UC_ht+0xb49, %rsi
lea addresses_WT_ht+0x8149, %rdi
clflush (%rsi)
nop
nop
sub $20164, %r15
...
nop
and $4448, %r10
lea addresses_WT_ht+0xed49, %rsi
nop
nop
nop
nop
...
nop
and $56505, %rsi
lea addresses_WT_ht+0xf715, %rcx
nop
nop
nop
nop
...
nop
sub %rax, %rax
lea addresses_UC_ht+0x14549, %rcx
xor $43454, %rsi
movw $0x6162, (%rcx)
nop
and %r10, %r10
...
{'OP': 'REPM', 'src': {'same': False, 'congruent': 5, 'type': 'addresses_normal_ht'}, 'dst': {'same': False, 'congruent': 5, 'type': 'addresses_WT_ht'}}
{'OP': 'STOR', 'dst': {'same': False, 'type': 'addresses_A_ht', 'NT': False, 'AVXalign': False, 'size': 32, 'congruent': 7}}
{'OP': 'REPM', 'src': {'same': False, 'congruent': 8, 'type': 'addresses_UC_ht'}, 'dst': {'same': True, 'congruent': 8, 'type': 'addresses_WT_ht'}}
