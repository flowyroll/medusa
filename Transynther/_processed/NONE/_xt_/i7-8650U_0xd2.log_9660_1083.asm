...
push %rdx
push %rsi
lea addresses_normal_ht+0x194df, %rax
clflush (%rax)
nop
nop
nop
...
nop
add %rdi, %rdi
lea addresses_A_ht+0x1ed6f, %rdx
nop
and %rbx, %rbx
mov (%rdx), %ecx
nop
...
nop
and $3466, %r12
lea addresses_D_ht+0x1164b, %rdi
clflush (%rdi)
xor $4196, %r12
movb $0x61, (%rdi)
nop
...
nop
and $18028, %rdx
lea addresses_UC_ht+0x9c8b, %r10
xor %rdi, %rdi
movb (%r10), %al
nop
nop
...
nop
xor $54454, %r10
lea addresses_WT_ht+0xcacb, %rsi
lea addresses_UC_ht+0x263b, %rdi
clflush (%rsi)
nop
nop
nop
...
nop
cmp $883, %rdx
lea addresses_WC_ht+0x15837, %rdx
nop
nop
sub $62779, %r12
mov (%rdx), %ax
add %rsi, %rsi
lea addresses_D_ht+0x1c4ab, %rdi
nop
nop
nop
nop
...
nop
add $14724, %r12
lea addresses_A_ht+0x14e4b, %rdi
nop
nop
nop
and %rcx, %rcx
...
lea addresses_UC_ht+0x1e94b, %rdi
clflush (%rdi)
nop
nop
nop
...
nop
cmp $24188, %rbx
lea addresses_D_ht+0x14e4b, %rbx
nop
nop
xor %r12, %r12
vmovups (%rbx), %ymm0
...
nop
sub %rcx, %rcx
lea addresses_A_ht+0x14463, %rdx
nop
inc %rax
movups (%rdx), %xmm7
vpextrq $1, %xmm7, %rdi
cmp %r10, %r10
lea addresses_A_ht+0xfe2b, %rcx
nop
nop
nop
nop
...
// Faulty Load
lea addresses_normal+0xbe4b, %r14
nop
nop
nop
add %rdi, %rdi
...
{'OP': 'LOAD', 'src': {'type': 'addresses_NC', 'size': 4, 'AVXalign': False, 'NT': True, 'congruent': 11, 'same': False}}
...
{'OP': 'REPM', 'src': {'type': 'addresses_A_ht', 'congruent': 0, 'same': False}, 'dst': {'type': 'addresses_UC_ht', 'congruent': 7, 'same': False}}
{'OP': 'LOAD', 'src': {'type': 'addresses_D_ht', 'size': 32, 'AVXalign': False, 'NT': False, 'congruent': 11, 'same': False}}
{'OP': 'LOAD', 'src': {'type': 'addresses_A_ht', 'size': 16, 'AVXalign': False, 'NT': False, 'congruent': 3, 'same': True}}
