...
nop
xor %rbp, %rbp
lea addresses_UC_ht+0x2358, %rdi
nop
nop
add $7394, %rbp
mov (%rdi), %r12
...
nop
cmp %rsi, %rsi
lea addresses_A_ht+0xcb5c, %rbp
and %rbx, %rbx
mov (%rbp), %r11
nop
nop
sub %rsi, %rsi
lea addresses_normal_ht+0xa40c, %rsi
clflush (%rsi)
nop
nop
nop
...
nop
add $44500, %rbx
lea addresses_normal_ht+0x1514c, %rsi
nop
nop
nop
add $24001, %rdi
...
nop
and $20984, %rbp
lea addresses_A_ht+0x307a, %rsi
lea addresses_UC_ht+0x1eeaa, %rdi
nop
nop
sub %rbx, %rbx
mov $91, %rcx
...
nop
add $56948, %r11
lea addresses_normal_ht+0x14bbc, %rsi
lea addresses_normal_ht+0x205c, %rdi
nop
nop
nop
nop
...
nop
cmp $1897, %rbp
lea addresses_D_ht+0x1865c, %rdi
nop
nop
nop
nop
...
nop
inc %rbp
lea addresses_UC_ht+0x6d4e, %rsi
lea addresses_WT_ht+0x1d0f8, %rdi
nop
sub $16448, %r14
mov $117, %rcx
rep movsq
...
{'src': {'congruent': 1, 'same': False, 'type': 'addresses_A_ht'}, 'OP': 'REPM', 'dst': {'congruent': 1, 'same': False, 'type': 'addresses_UC_ht'}}
