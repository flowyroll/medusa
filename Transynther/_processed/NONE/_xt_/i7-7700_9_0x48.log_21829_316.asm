...
push %rdi
push %rsi
lea addresses_normal_ht+0xe846, %r14
nop
nop
nop
nop
...
nop
add $27233, %rbp
lea addresses_WT_ht+0x11415, %rbp
nop
nop
nop
xor %r14, %r14
...
nop
add $49250, %r10
lea addresses_UC_ht+0x19e2d, %rsi
nop
nop
sub %r14, %r14
movw $0x6162, (%rsi)
...
vpextrq $1, %xmm1, %rsi
cmp $53573, %r14
lea addresses_A_ht+0x8cf5, %rsi
lea addresses_D_ht+0xd1cd, %rdi
clflush (%rdi)
and %r14, %r14
mov $93, %rcx
rep movsl
...
nop
dec %r11
lea addresses_UC_ht+0x18807, %rbp
nop
nop
nop
nop
