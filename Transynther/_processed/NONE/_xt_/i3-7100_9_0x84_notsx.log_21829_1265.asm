...
push %rdx
push %rsi
lea addresses_D_ht+0x159f5, %rsi
lea addresses_A_ht+0xf915, %rdi
nop
nop
nop
nop
...
nop
sub $38353, %r9
lea addresses_normal_ht+0x13a5d, %r8
xor %rsi, %rsi
movl $0x61626364, (%r8)
nop
nop
nop
dec %rcx
lea addresses_A_ht+0x13a05, %r12
mfence
movw $0x6162, (%r12)
add $52886, %rax
lea addresses_WT_ht+0x8edd, %r8
nop
nop
dec %r9
movl $0x61626364, (%r8)
...
nop
and $33701, %rcx
lea addresses_normal_ht+0x100a5, %rsi
lea addresses_WT_ht+0xdd25, %rdi
nop
and $3616, %rdx
mov $99, %rcx
rep movsl
sub %r9, %r9
lea addresses_UC_ht+0x12515, %rcx
clflush (%rcx)
and $52739, %rdx
movb (%rcx), %r12b
nop
...
nop
sub $41812, %r9
lea addresses_A_ht+0x144df, %rsi
nop
nop
cmp $35049, %r12
mov (%rsi), %rdx
nop
cmp $7336, %r9
lea addresses_D_ht+0x132f5, %rcx
nop
dec %r12
movl $0x61626364, (%rcx)
nop
...
nop
sub $38959, %rdx
lea addresses_A_ht+0x1b7bf, %rsi
lea addresses_A_ht+0xe205, %rdi
clflush (%rsi)
nop
nop
nop
...
nop
add %r12, %r12
lea addresses_D_ht+0x192ed, %r12
nop
nop
xor $54046, %rax
movups (%r12), %xmm0
...
nop
sub %rsi, %rsi
lea addresses_A_ht+0x1eac5, %rax
nop
nop
and %rcx, %rcx
...
nop
xor %r12, %r12
lea addresses_normal_ht+0x11b29, %rcx
nop
nop
xor %rdi, %rdi
...
// Store
lea addresses_normal+0x3185, %r8
nop
nop
nop
nop
...
{'src': {'type': 'addresses_A_ht', 'same': False, 'size': 8, 'congruent': 0, 'NT': True, 'AVXalign': False}, 'OP': 'LOAD'}
