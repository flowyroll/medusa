...
nop
add %rdi, %rdi
lea addresses_WC_ht+0x220c, %rdi
xor $2135, %rsi
...
nop
cmp %r12, %r12
lea addresses_WC_ht+0x12c50, %rdi
nop
and $32857, %rbx
movl $0x61626364, (%rdi)
xor $20804, %r12
lea addresses_UC_ht+0x426c, %rsi
lea addresses_WT_ht+0x17e14, %rdi
clflush (%rsi)
nop
nop
nop
...
rep movsb
xor $45448, %r12
lea addresses_A_ht+0x16248, %rdx
nop
nop
inc %rbx
...
nop
add $43196, %r11
lea addresses_WC_ht+0x1126c, %r10
clflush (%r10)
nop
nop
sub %r12, %r12
...
nop
sub $46139, %rdi
lea addresses_WT_ht+0xce6c, %r12
nop
nop
dec %r11
mov (%r12), %si
...
nop
cmp %r10, %r10
lea addresses_WC_ht+0x1126c, %rdi
nop
nop
and %rsi, %rsi
movb $0x61, (%rdi)
...
nop
and $19660, %rcx
lea addresses_UC_ht+0x1557, %r11
nop
nop
nop
nop
...
movw $0x6162, (%r11)
sub $47210, %rdx
lea addresses_D_ht+0x1856c, %rbx
sub $42202, %rdi
mov (%rbx), %cx
and $37388, %r12
lea addresses_WT_ht+0x7d7c, %rsi
inc %r10
vmovups (%rsi), %ymm0
...
nop
cmp %rbx, %rbx
lea addresses_D_ht+0x5fcc, %rsi
lea addresses_A_ht+0xce6c, %rdi
clflush (%rdi)
nop
nop
nop
...
nop
inc %rcx
lea addresses_WT_ht+0x8c6c, %r11
nop
nop
nop
nop
...
<gen_prepare_buffer>
{'OP': 'LOAD', 'src': {'type': 'addresses_WC_ht', 'size': 2, 'AVXalign': False, 'NT': False, 'congruent': 6, 'same': True}}
