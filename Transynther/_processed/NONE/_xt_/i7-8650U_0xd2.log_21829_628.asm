...
push %rdx
push %rsi
lea addresses_WC_ht+0xc14e, %rsi
lea addresses_WC_ht+0xb86e, %rdi
nop
nop
nop
nop
...
nop
and $57271, %r13
lea addresses_WC_ht+0x12fb8, %r14
xor %r15, %r15
movl $0x61626364, (%r14)
nop
nop
...
nop
and $15513, %r14
lea addresses_normal_ht+0x62ef, %rcx
nop
and $5667, %rdx
...
nop
inc %rdi
lea addresses_normal_ht+0xdece, %rsi
lea addresses_UC_ht+0x1726a, %rdi
clflush (%rdi)
nop
nop
nop
...
{'OP': 'STOR', 'dst': {'type': 'addresses_normal_ht', 'size': 16, 'AVXalign': True, 'NT': False, 'congruent': 0, 'same': False}}
