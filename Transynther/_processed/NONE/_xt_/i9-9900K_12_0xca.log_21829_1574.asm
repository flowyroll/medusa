...
push %rdx
push %rsi
lea addresses_WT_ht+0xce55, %rcx
nop
nop
nop
sub %rdx, %rdx
...
nop
inc %rdx
lea addresses_WC_ht+0xbc75, %r11
nop
nop
nop
sub $32339, %r10
...
nop
add %rcx, %rcx
lea addresses_UC_ht+0x1ce75, %r11
nop
nop
add %r10, %r10
...
nop
inc %rcx
lea addresses_normal_ht+0x6a75, %rax
sub %r10, %r10
...
nop
cmp $5738, %rax
lea addresses_WC_ht+0x1aeb6, %r10
sub $14273, %rax
movb $0x61, (%r10)
inc %rdx
lea addresses_WC_ht+0x90f5, %rsi
lea addresses_D_ht+0x1a675, %rdi
nop
nop
lfence
mov $100, %rcx
...
// Faulty Load
lea addresses_normal+0xf675, %r9
nop
nop
add $8489, %rsi
vmovups (%r9), %ymm0
...
{'OP': 'STOR', 'dst': {'size': 16, 'NT': False, 'type': 'addresses_normal_ht', 'same': True, 'AVXalign': False, 'congruent': 10}}
{'OP': 'STOR', 'dst': {'size': 1, 'NT': False, 'type': 'addresses_WC_ht', 'same': False, 'AVXalign': False, 'congruent': 0}}
{'OP': 'REPM', 'src': {'same': False, 'type': 'addresses_WC_ht', 'congruent': 5}, 'dst': {'same': False, 'type': 'addresses_D_ht', 'congruent': 7}}
{'34': 21829}
