...
push %rdx
push %rsi
lea addresses_UC_ht+0x1db0b, %r12
nop
nop
nop
nop
...
mov (%r12), %r10
sub $40745, %r14
lea addresses_A_ht+0x1ca9b, %r11
nop
nop
add $50651, %rdx
mov (%r11), %r10w
and %r14, %r14
lea addresses_normal_ht+0xf043, %r14
sub $8450, %r15
mov (%r14), %r10d
nop
cmp %r11, %r11
lea addresses_A_ht+0x71cb, %r10
cmp $49473, %r15
mov (%r10), %r11d
nop
xor $63887, %r11
lea addresses_normal_ht+0x1ac9b, %r10
nop
cmp $12865, %rcx
movl $0x61626364, (%r10)
nop
...
nop
cmp $58106, %r15
lea addresses_WT_ht+0x1d7db, %r11
nop
add $61927, %rcx
mov (%r11), %dx
nop
...
nop
add %r10, %r10
lea addresses_WT_ht+0x1789b, %rsi
lea addresses_WC_ht+0x187f1, %rdi
nop
nop
nop
sub $7887, %rdx
...
{'src': {'NT': False, 'AVXalign': False, 'size': 2, 'congruent': 1, 'same': False, 'type': 'addresses_US'}, 'OP': 'LOAD'}
{'src': {'NT': True, 'AVXalign': False, 'size': 16, 'congruent': 9, 'same': False, 'type': 'addresses_RW'}, 'OP': 'LOAD'}
...
{'dst': {'NT': False, 'AVXalign': False, 'size': 4, 'congruent': 8, 'same': True, 'type': 'addresses_normal_ht'}, 'OP': 'STOR'}
