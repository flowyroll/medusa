...
push %rdx
push %rsi
lea addresses_normal_ht+0x161d7, %rdi
nop
xor %r13, %r13
mov (%rdi), %dx
nop
nop
dec %rdi
lea addresses_WT_ht+0xd0c7, %rax
nop
inc %r14
mov (%rax), %bp
nop
...
nop
sub %r14, %r14
lea addresses_UC_ht+0x1aefc, %r14
xor $45809, %rdi
mov $0x6162636465666768, %r13
movq %r13, %xmm2
movups %xmm2, (%r14)
sub $37929, %r14
lea addresses_UC_ht+0xf0d7, %rdx
nop
nop
nop
add $44993, %rax
...
nop
cmp $59469, %rdi
lea addresses_D_ht+0xd1d7, %rsi
lea addresses_A_ht+0xb557, %rdi
nop
nop
nop
nop
...
nop
cmp $42574, %rdx
lea addresses_UC_ht+0x2df3, %rsi
lea addresses_UC_ht+0x18957, %rdi
clflush (%rsi)
nop
nop
nop
...
rep movsq
dec %r14
lea addresses_normal_ht+0xbd7, %r14
xor $59403, %rsi
vmovups (%r14), %ymm5
...
nop
inc %rsi
lea addresses_WT_ht+0xb9d7, %rdi
cmp $3467, %rcx
movups (%rdi), %xmm7
vpextrq $0, %xmm7, %rsi
xor $61979, %rcx
lea addresses_A_ht+0x1ebd7, %r13
nop
nop
sub $875, %rax
...
lea addresses_WC_ht+0xf5d7, %rdi
nop
nop
nop
xor $48936, %r13
...
nop
cmp $54610, %r13
lea addresses_D_ht+0x179d7, %r14
clflush (%r14)
nop
nop
cmp %rdx, %rdx
...
nop
add %rbp, %rbp
lea addresses_normal_ht+0x71d7, %rbp
nop
nop
nop
sub %r13, %r13
...
// REPMOV
lea addresses_WT+0x100d7, %rsi
lea addresses_UC+0x76e1, %rdi
nop
xor %rdx, %rdx
mov $68, %rcx
rep movsw
...
{'src': {'type': 'addresses_WT', 'congruent': 8, 'same': False}, 'dst': {'type': 'addresses_UC', 'congruent': 1, 'same': False}, 'OP': 'REPM'}
[Faulty Load]
...
{'dst': {'type': 'addresses_A_ht', 'same': False, 'size': 8, 'congruent': 10, 'NT': True, 'AVXalign': False}, 'OP': 'STOR'}
{'src': {'type': 'addresses_D_ht', 'congruent': 11, 'same': False}, 'dst': {'type': 'addresses_A_ht', 'congruent': 7, 'same': False}, 'OP': 'REPM'}
{'src': {'type': 'addresses_UC_ht', 'congruent': 0, 'same': True}, 'dst': {'type': 'addresses_UC_ht', 'congruent': 5, 'same': False}, 'OP': 'REPM'}
...
{'src': {'type': 'addresses_WT_ht', 'congruent': 1, 'same': False}, 'dst': {'type': 'addresses_WC_ht', 'congruent': 10, 'same': False}, 'OP': 'REPM'}
