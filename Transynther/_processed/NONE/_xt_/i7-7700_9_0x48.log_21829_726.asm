...
lea addresses_WT_ht+0x6ddc, %rdi
clflush (%rsi)
nop
nop
nop
...
rep movsl
add %rcx, %rcx
lea addresses_WT_ht+0x18968, %rcx
nop
nop
nop
nop
...
movups %xmm5, (%rcx)
inc %rdi
lea addresses_D_ht+0x11cef, %rcx
nop
nop
nop
nop
...
mov (%rcx), %r10w
sub $34158, %rdi
lea addresses_normal_ht+0x1365c, %rbp
nop
nop
add $15485, %r14
mov (%rbp), %r8w
add %r14, %r14
lea addresses_D_ht+0x1c3dc, %rsi
lea addresses_A_ht+0x38dc, %rdi
nop
nop
nop
nop
...
rep movsl
xor $49359, %r15
lea addresses_A_ht+0x9ddc, %rsi
lea addresses_A_ht+0x10288, %rdi
nop
nop
nop
nop
...
nop
cmp $52997, %r15
lea addresses_UC_ht+0x89dc, %r10
nop
add $7, %rsi
mov (%r10), %r14
nop
...
nop
inc %rbp
lea addresses_UC_ht+0x5fdc, %r14
cmp %r10, %r10
mov (%r14), %rcx
and $4074, %rbp
lea addresses_D_ht+0x6b2c, %r14
nop
nop
nop
nop
...
nop
inc %r8
lea addresses_UC_ht+0x7ddc, %r10
cmp $27930, %r15
vmovups (%r10), %ymm7
...
// Load
lea addresses_normal+0x17ea3, %rcx
nop
add $5028, %r13
movaps (%rcx), %xmm7
vpextrq $1, %xmm7, %r9
...
{'OP': 'REPM', 'src': {'type': 'addresses_A_ht', 'congruent': 11, 'same': False}, 'dst': {'type': 'addresses_WT_ht', 'congruent': 11, 'same': False}}
...
{'OP': 'LOAD', 'src': {'type': 'addresses_normal_ht', 'AVXalign': True, 'congruent': 7, 'size': 2, 'same': True, 'NT': False}}
{'OP': 'REPM', 'src': {'type': 'addresses_D_ht', 'congruent': 9, 'same': False}, 'dst': {'type': 'addresses_A_ht', 'congruent': 7, 'same': False}}
{'OP': 'REPM', 'src': {'type': 'addresses_A_ht', 'congruent': 11, 'same': True}, 'dst': {'type': 'addresses_A_ht', 'congruent': 0, 'same': False}}
