...
nop
cmp $29091, %r14
lea addresses_D_ht+0x1dc54, %r11
nop
nop
nop
nop
...
mov (%r11), %r15w
cmp $35997, %r15
lea addresses_D_ht+0xf514, %rsi
lea addresses_normal_ht+0xdd14, %rdi
sub %rbx, %rbx
mov $112, %rcx
rep movsb
nop
...
nop
xor %rdi, %rdi
lea addresses_UC_ht+0x3114, %rsi
lea addresses_WT_ht+0x1609e, %rdi
nop
nop
nop
nop
