...
push %rdx
push %rsi
lea addresses_WT_ht+0xec5c, %r12
nop
and %rcx, %rcx
mov (%r12), %r10d
nop
nop
add %rbp, %rbp
lea addresses_WC_ht+0x4c14, %r12
nop
and %rdi, %rdi
mov (%r12), %r10d
nop
...
nop
and $20784, %rbp
lea addresses_normal_ht+0x164f4, %rsi
lea addresses_WC_ht+0x9120, %rdi
clflush (%rdi)
nop
nop
nop
...
rep movsl
add $44364, %rdi
lea addresses_UC_ht+0x17708, %rsi
nop
sub %rbp, %rbp
mov (%rsi), %r10d
xor %rsi, %rsi
lea addresses_UC_ht+0x1dd5c, %rsi
lea addresses_normal_ht+0xef4, %rdi
clflush (%rsi)
nop
and $58553, %rbp
mov $52, %rcx
...
nop
xor %rsi, %rsi
lea addresses_D_ht+0x2cf4, %rsi
lea addresses_A_ht+0x16f34, %rdi
clflush (%rdi)
nop
nop
xor %rax, %rax
...
nop
add $25311, %rdi
lea addresses_A_ht+0xc618, %rsi
lea addresses_WC_ht+0x1bcf4, %rdi
nop
nop
nop
nop
...
nop
cmp %rsi, %rsi
lea addresses_UC_ht+0x17f9c, %rsi
dec %r10
mov $0x6162636465666768, %r12
movq %r12, %xmm5
vmovups %ymm5, (%rsi)
add $48444, %rcx
lea addresses_UC_ht+0x10f6e, %rcx
nop
and %rbp, %rbp
...
nop
inc %r10
lea addresses_WC_ht+0x12604, %rdx
nop
nop
nop
nop
...
{'src': {'same': False, 'congruent': 11, 'type': 'addresses_normal_ht'}, 'OP': 'REPM', 'dst': {'same': False, 'congruent': 2, 'type': 'addresses_WC_ht'}}
{'src': {'NT': True, 'same': False, 'congruent': 1, 'type': 'addresses_UC_ht', 'AVXalign': False, 'size': 4}, 'OP': 'LOAD'}
{'src': {'same': True, 'congruent': 1, 'type': 'addresses_UC_ht'}, 'OP': 'REPM', 'dst': {'same': False, 'congruent': 7, 'type': 'addresses_normal_ht'}}
...
{'src': {'same': False, 'congruent': 1, 'type': 'addresses_A_ht'}, 'OP': 'REPM', 'dst': {'same': False, 'congruent': 9, 'type': 'addresses_WC_ht'}}
