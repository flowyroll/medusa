...
push %rdx
push %rsi
lea addresses_WT_ht+0x10cf4, %rsi
lea addresses_WT_ht+0x1e517, %rdi
inc %rax
mov $34, %rcx
rep movsw
nop
...
nop
sub %rbx, %rbx
lea addresses_UC_ht+0x8234, %rsi
lea addresses_D_ht+0x1e590, %rdi
nop
nop
nop
nop
...
nop
cmp %rsi, %rsi
lea addresses_WC_ht+0x1da74, %rdi
nop
nop
nop
nop
...
nop
sub %rdi, %rdi
lea addresses_A_ht+0x19734, %rsi
lea addresses_WC_ht+0x1bc6c, %rdi
nop
nop
cmp $35389, %r8
mov $51, %rcx
...
nop
sub $8105, %rdi
lea addresses_WC_ht+0x1d31c, %r8
nop
nop
nop
nop
...
lea addresses_normal_ht+0x14970, %rdi
nop
and $36055, %rdx
mov $40, %rcx
rep movsl
dec %r8
lea addresses_D_ht+0x1cf34, %r10
nop
sub $22475, %r8
movl $0x61626364, (%r10)
nop
...
lea addresses_WT_ht+0x96f4, %rdi
nop
sub %r8, %r8
mov $28, %rcx
rep movsb
...
nop
and %rdx, %rdx
lea addresses_normal_ht+0x90f4, %r8
nop
nop
nop
nop
...
nop
add $44143, %rdi
lea addresses_A_ht+0x14ef4, %r10
nop
nop
nop
nop
...
// Store
lea addresses_normal+0xfff4, %r9
nop
nop
nop
nop
...
{'src': {'type': 'addresses_UC_ht', 'congruent': 5, 'same': False}, 'dst': {'type': 'addresses_WT_ht', 'congruent': 9, 'same': False}, 'OP': 'REPM'}
