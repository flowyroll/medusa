...
movups %xmm4, (%r9)
sub $4364, %r14
lea addresses_WC_ht+0x45fb, %rsi
lea addresses_UC_ht+0x13dff, %rdi
clflush (%rdi)
nop
nop
nop
...
rep movsl
cmp $56252, %rax
lea addresses_WT_ht+0x695b, %rax
nop
nop
nop
nop
