...
nop
sub %rax, %rax
lea addresses_WT_ht+0x7b5f, %rbx
nop
dec %r10
...
nop
and $64615, %rcx
lea addresses_normal_ht+0xb0cd, %rax
nop
nop
nop
sub $59716, %rbx
...
nop
cmp %r12, %r12
lea addresses_A_ht+0x2fb5, %rsi
lea addresses_WC_ht+0xbdcd, %rdi
clflush (%rdi)
nop
and %r14, %r14
mov $31, %rcx
...
nop
and $51275, %rbx
lea addresses_WT_ht+0x13d15, %r10
nop
nop
nop
xor %r12, %r12
...
nop
dec %rsi
lea addresses_D_ht+0x908d, %r12
and $58819, %rbx
movl $0x61626364, (%r12)
xor $31877, %rbx
lea addresses_UC_ht+0x1ddcd, %rsi
lea addresses_normal_ht+0x618d, %rdi
nop
nop
sub $6371, %rax
mov $4, %rcx
rep movsl
xor $2294, %r12
lea addresses_UC_ht+0xb7cd, %rsi
lea addresses_D_ht+0x4e0d, %rdi
nop
nop
nop
add $46836, %r10
...
nop
mfence
lea addresses_normal_ht+0x1b5ed, %rcx
nop
nop
nop
nop
...
nop
add $46065, %rsi
lea addresses_WC_ht+0x178cd, %r12
nop
nop
nop
nop
...
nop
and $524, %rcx
lea addresses_WC_ht+0x4ebd, %rdi
add %rcx, %rcx
mov (%rdi), %rsi
nop
xor %r10, %r10
...
<gen_prepare_buffer>
{'src': {'type': 'addresses_normal_ht', 'congruent': 3, 'same': False}, 'OP': 'REPM', 'dst': {'type': 'addresses_normal_ht', 'congruent': 5, 'same': True}}
...
{'src': {'type': 'addresses_A_ht', 'congruent': 3, 'same': False}, 'OP': 'REPM', 'dst': {'type': 'addresses_WC_ht', 'congruent': 9, 'same': False}}
...
{'src': {'type': 'addresses_UC_ht', 'congruent': 9, 'same': False}, 'OP': 'REPM', 'dst': {'type': 'addresses_D_ht', 'congruent': 6, 'same': False}}
{'src': {'type': 'addresses_normal_ht', 'AVXalign': True, 'size': 32, 'NT': False, 'same': False, 'congruent': 5}, 'OP': 'LOAD'}
