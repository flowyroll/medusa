...
nop
and $52733, %rcx
lea addresses_WC_ht+0x12bcf, %rbp
nop
nop
and %rbx, %rbx
...
nop
and %r8, %r8
lea addresses_A_ht+0x13ccf, %rbp
nop
nop
dec %rcx
mov (%rbp), %r8
...
nop
sub $32960, %r9
lea addresses_normal_ht+0x16927, %r13
nop
nop
and $31973, %rbx
movw $0x6162, (%r13)
...
nop
mfence
lea addresses_normal_ht+0xf58f, %r9
clflush (%r9)
nop
nop
nop
...
movb (%r9), %r8b
add %r9, %r9
lea addresses_D_ht+0x1a7cf, %rsi
lea addresses_D_ht+0xc193, %rdi
nop
nop
nop
nop
...
rep movsq
cmp $56645, %rcx
lea addresses_UC_ht+0xf29f, %rbx
add $15142, %r9
mov (%rbx), %rbp
lfence
pop %rsi
...
{'OP': 'REPM', 'src': {'type': 'addresses_D_ht', 'congruent': 7, 'same': False}, 'dst': {'type': 'addresses_D_ht', 'congruent': 2, 'same': True}}
