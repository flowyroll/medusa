...
push %rdi
push %rsi
lea addresses_WT_ht+0xa804, %rbx
nop
nop
nop
nop
...
nop
sub $52015, %rbx
lea addresses_A_ht+0x11204, %r14
nop
nop
nop
nop
...
nop
cmp $52624, %r8
lea addresses_WT_ht+0x4f04, %rbp
nop
nop
nop
nop
...
nop
cmp $62270, %rbx
lea addresses_D_ht+0x11945, %rbx
nop
nop
nop
nop
...
nop
add $21648, %rbp
lea addresses_UC_ht+0x9204, %rsi
lea addresses_A_ht+0x8e44, %rdi
and $41972, %rax
mov $89, %rcx
rep movsq
nop
...
// Load
lea addresses_normal+0x13f04, %r10
nop
nop
xor %rdx, %rdx
vmovups (%r10), %ymm3
...
// Faulty Load
lea addresses_normal+0x13f04, %rax
clflush (%rax)
nop
inc %r9
movb (%rax), %bl
