...
push %rdx
push %rsi
lea addresses_WC_ht+0x1a583, %r15
nop
nop
nop
sub %r8, %r8
...
movq %rdx, (%r15)
xor $13482, %r9
lea addresses_D_ht+0xee0b, %rsi
lea addresses_A_ht+0xad0b, %rdi
nop
nop
nop
nop
...
nop
and %rdi, %rdi
lea addresses_UC_ht+0x2497, %rsi
nop
nop
cmp %r10, %r10
...
nop
cmp $31554, %r8
lea addresses_normal_ht+0xaeeb, %r15
nop
nop
sub %rdx, %rdx
movw $0x6162, (%r15)
...
nop
and %r9, %r9
lea addresses_WT_ht+0x2aeb, %rsi
lea addresses_normal_ht+0x103eb, %rdi
nop
cmp $2479, %r9
mov $81, %rcx
rep movsq
...
{'src': {'same': False, 'congruent': 0, 'NT': True, 'type': 'addresses_D', 'size': 1, 'AVXalign': True}, 'OP': 'LOAD'}
[Faulty Load]
{'src': {'same': True, 'congruent': 0, 'NT': False, 'type': 'addresses_D', 'size': 2, 'AVXalign': False}, 'OP': 'LOAD'}
<gen_prepare_buffer>
{'OP': 'STOR', 'dst': {'same': True, 'congruent': 2, 'NT': True, 'type': 'addresses_WC_ht', 'size': 8, 'AVXalign': False}}
{'src': {'type': 'addresses_D_ht', 'congruent': 4, 'same': False}, 'OP': 'REPM', 'dst': {'type': 'addresses_A_ht', 'congruent': 5, 'same': False}}
