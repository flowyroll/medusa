...
push %rdi
push %rsi
lea addresses_WC_ht+0x11326, %rsi
lea addresses_WT_ht+0xcc56, %rdi
add %r10, %r10
mov $20, %rcx
rep movsw
nop
nop
and %r10, %r10
lea addresses_D_ht+0x12c76, %rsi
lea addresses_normal_ht+0x5000, %rdi
clflush (%rsi)
nop
nop
nop
...
nop
cmp $33217, %r10
lea addresses_WC_ht+0x1d306, %rbx
nop
nop
cmp $16450, %r9
...
nop
dec %rdi
lea addresses_WT_ht+0x1c92e, %r10
nop
nop
nop
add $32958, %rsi
...
nop
and $18432, %rdi
lea addresses_normal_ht+0xd26, %r11
nop
nop
xor %rcx, %rcx
movl $0x61626364, (%r11)
...
nop
dec %rsi
lea addresses_WT_ht+0x2626, %rdi
cmp $28168, %r10
vmovups (%rdi), %ymm3
...
nop
inc %rdi
lea addresses_WT_ht+0x12e06, %rsi
lea addresses_A_ht+0x2906, %rdi
nop
and %r10, %r10
mov $66, %rcx
rep movsq
...
nop
add %r9, %r9
lea addresses_normal_ht+0x16706, %rsi
...
{'OP': 'LOAD', 'src': {'same': False, 'NT': False, 'AVXalign': True, 'size': 8, 'type': 'addresses_WT_ht', 'congruent': 3}}
{'OP': 'LOAD', 'src': {'same': False, 'NT': False, 'AVXalign': False, 'size': 8, 'type': 'addresses_D_ht', 'congruent': 8}}
{'dst': {'same': False, 'NT': False, 'AVXalign': True, 'size': 4, 'type': 'addresses_normal_ht', 'congruent': 5}, 'OP': 'STOR'}
