...
nop
inc %r8
lea addresses_UC_ht+0xb2a0, %rdi
nop
nop
add %r15, %r15
movb $0x61, (%rdi)
...
nop
xor %rcx, %rcx
lea addresses_normal_ht+0x1a194, %rsi
lea addresses_WT_ht+0x744, %rdi
clflush (%rsi)
nop
nop
nop
