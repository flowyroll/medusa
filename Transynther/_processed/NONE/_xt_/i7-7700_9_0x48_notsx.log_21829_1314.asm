...
nop
xor %rbx, %rbx
lea addresses_WT_ht+0x19e8, %rsi
lea addresses_D_ht+0xf294, %rdi
nop
nop
nop
nop
...
nop
xor $11421, %rbp
lea addresses_D_ht+0x4e14, %rsi
lea addresses_UC_ht+0x11774, %rdi
nop
nop
nop
nop
...
nop
xor %rbx, %rbx
lea addresses_WT_ht+0x1c46d, %rdi
nop
nop
xor %r15, %r15
movb (%rdi), %cl
...
nop
add $30249, %r9
lea addresses_normal_ht+0x19354, %rdi
clflush (%rdi)
nop
sub %rbx, %rbx
vmovups (%rdi), %ymm2
...
nop
add %rsi, %rsi
lea addresses_WT_ht+0x1da14, %rbx
nop
nop
nop
nop
...
nop
xor $1480, %r13
lea addresses_A_ht+0x15cd4, %rbp
nop
nop
nop
nop
...
nop
sub %r9, %r9
lea addresses_A_ht+0x11794, %rbx
inc %r9
...
nop
and $23562, %r15
lea addresses_D_ht+0x2fd4, %rdi
cmp %r9, %r9
movw $0x6162, (%rdi)
nop
nop
cmp $7290, %rsi
lea addresses_D_ht+0x8bf4, %rsi
lea addresses_UC_ht+0x17014, %rdi
clflush (%rsi)
nop
nop
nop
...
{'dst': {'same': False, 'congruent': 7, 'type': 'addresses_D_ht'}, 'OP': 'REPM', 'src': {'same': False, 'congruent': 0, 'type': 'addresses_WT_ht'}}
...
{'dst': {'same': False, 'NT': True, 'AVXalign': False, 'size': 2, 'type': 'addresses_D_ht', 'congruent': 5}, 'OP': 'STOR'}
{'dst': {'same': False, 'congruent': 8, 'type': 'addresses_UC_ht'}, 'OP': 'REPM', 'src': {'same': False, 'congruent': 5, 'type': 'addresses_D_ht'}}
{'33': 21829}
