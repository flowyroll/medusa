...
push %rdx
push %rsi
lea addresses_normal_ht+0x47c3, %r11
nop
nop
nop
nop
...
nop
xor $55918, %rcx
lea addresses_normal_ht+0xb9a7, %rbp
nop
nop
nop
nop
...
nop
lfence
lea addresses_normal_ht+0x9870, %r12
nop
mfence
movb (%r12), %bl
nop
...
nop
dec %r12
lea addresses_UC_ht+0xa84b, %rdx
nop
and %r14, %r14
...
nop
sub $11352, %rcx
lea addresses_WC_ht+0x1a267, %rbx
nop
nop
nop
nop
...
nop
xor $55252, %rbp
lea addresses_WC_ht+0x6067, %r14
nop
nop
nop
nop
...
movl $0x61626364, (%r14)
add %r12, %r12
lea addresses_D_ht+0xa967, %rsi
lea addresses_normal_ht+0xed67, %rdi
clflush (%rsi)
nop
nop
nop
...
nop
xor %rbx, %rbx
lea addresses_WC_ht+0x19303, %rsi
lea addresses_D_ht+0x10467, %rdi
nop
nop
and %rbp, %rbp
mov $48, %rcx
...
nop
add $28847, %rdi
lea addresses_UC_ht+0x6467, %rcx
nop
nop
nop
nop
...
// Load
lea addresses_normal+0x158a5, %r13
nop
nop
nop
nop
...
// Faulty Load
lea addresses_normal+0xb067, %r11
dec %rax
mov (%r11), %r12
lea oracles, %rsi
and $0xff, %r12
