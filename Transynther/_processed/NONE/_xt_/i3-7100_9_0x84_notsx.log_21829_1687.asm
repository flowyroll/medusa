...
lea addresses_A_ht+0x1cfda, %rdi
clflush (%rsi)
nop
nop
nop
...
lea addresses_WT_ht+0x10252, %rdi
nop
xor %rax, %rax
mov $85, %rcx
rep movsb
...
vpextrq $0, %xmm4, %rdi
xor %rcx, %rcx
lea addresses_normal_ht+0x199ca, %r12
nop
nop
add %rax, %rax
movb $0x61, (%r12)
nop
dec %r12
lea addresses_UC_ht+0xcd8a, %rdi
clflush (%rdi)
nop
nop
nop
...
mov (%rdi), %rsi
add %r10, %r10
lea addresses_WC_ht+0x1410a, %rsi
lea addresses_D_ht+0x13f1a, %rdi
nop
add $18453, %rbp
mov $121, %rcx
rep movsb
...
nop
inc %r10
lea addresses_WT_ht+0x7c8a, %rdi
nop
nop
nop
sub $57046, %r12
...
{'dst': {'type': 'addresses_normal_ht', 'same': False, 'size': 1, 'congruent': 6, 'NT': False, 'AVXalign': True}, 'OP': 'STOR'}
{'src': {'type': 'addresses_UC_ht', 'same': False, 'size': 8, 'congruent': 8, 'NT': False, 'AVXalign': True}, 'OP': 'LOAD'}
{'src': {'type': 'addresses_WC_ht', 'congruent': 7, 'same': False}, 'dst': {'type': 'addresses_D_ht', 'congruent': 3, 'same': False}, 'OP': 'REPM'}
