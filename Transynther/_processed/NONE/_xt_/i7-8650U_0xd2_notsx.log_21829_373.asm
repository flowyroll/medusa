...
push %rdi
push %rsi
lea addresses_UC_ht+0x89ec, %rsi
xor %r14, %r14
mov (%rsi), %rbx
and %rcx, %rcx
lea addresses_WC_ht+0x4f78, %r8
nop
nop
nop
nop
...
nop
add %r13, %r13
lea addresses_normal_ht+0x5b8, %rbx
nop
nop
nop
add $73, %rcx
...
nop
dec %rcx
lea addresses_WC_ht+0x13db8, %rbx
add $59594, %r9
...
nop
cmp $63678, %r8
lea addresses_WT_ht+0x17438, %rsi
lea addresses_A_ht+0xe4fc, %rdi
nop
cmp $11713, %r8
mov $40, %rcx
rep movsl
add %r8, %r8
lea addresses_D_ht+0xc228, %rsi
lea addresses_WT_ht+0x5db8, %rdi
clflush (%rdi)
nop
nop
dec %rbx
...
nop
sub $29011, %rsi
lea addresses_WC_ht+0x131b8, %r14
dec %r9
movb $0x61, (%r14)
dec %r9
...
nop
dec %rbx
lea addresses_A_ht+0x148a8, %rsi
nop
nop
nop
nop
...
vpextrq $1, %xmm1, %rcx
add %r14, %r14
lea addresses_UC_ht+0xd5b8, %rsi
cmp $33760, %rbx
movl $0x61626364, (%rsi)
sub $14845, %r14
pop %rsi
...
{'OP': 'REPM', 'src': {'type': 'addresses_D_ht', 'congruent': 4, 'same': True}, 'dst': {'type': 'addresses_WT_ht', 'congruent': 11, 'same': True}}
