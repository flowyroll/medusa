...
push %rdi
push %rsi
lea addresses_WT_ht+0x5d3a, %rsi
lea addresses_WC_ht+0x18656, %rdi
nop
nop
lfence
mov $104, %rcx
...
nop
xor %r8, %r8
lea addresses_normal_ht+0x165af, %r8
nop
nop
nop
nop
...
nop
cmp $49076, %rdi
lea addresses_A_ht+0x15696, %rsi
lea addresses_normal_ht+0xfdb3, %rdi
nop
nop
xor %rax, %rax
mov $62, %rcx
...
nop
dec %rcx
lea addresses_normal_ht+0xc4f6, %rsi
lea addresses_UC_ht+0x2f56, %rdi
nop
nop
xor $10409, %r8
mov $110, %rcx
...
nop
cmp $21257, %rax
lea addresses_WC_ht+0x1df56, %rsi
...
// Faulty Load
lea addresses_normal+0x13756, %rax
nop
nop
nop
nop
