...
push %rdx
push %rsi
lea addresses_WC_ht+0x13058, %rdi
nop
nop
nop
nop
...
nop
sub %rcx, %rcx
lea addresses_UC_ht+0x38d8, %rbp
xor %rcx, %rcx
...
nop
add $18273, %r10
lea addresses_D_ht+0x10308, %rsi
lea addresses_WC_ht+0xca88, %rdi
nop
nop
sub %r11, %r11
mov $21, %rcx
rep movsb
xor %rsi, %rsi
lea addresses_WC_ht+0x7d08, %r11
nop
nop
nop
add %r10, %r10
...
nop
dec %rbp
lea addresses_D_ht+0x167e8, %rbp
nop
add $55152, %rdx
mov (%rbp), %di
nop
add %r10, %r10
lea addresses_WC_ht+0xac88, %rsi
nop
nop
and $56628, %rdi
movw $0x6162, (%rsi)
...
lea addresses_UC_ht+0x36a8, %rdi
nop
nop
nop
nop
...
rep movsw
xor $49909, %rcx
lea addresses_WC_ht+0x7908, %rax
nop
nop
nop
nop
...
nop
cmp $2431, %r10
lea addresses_WC_ht+0x166a8, %r10
xor %r11, %r11
...
nop
add %rcx, %rcx
lea addresses_WT_ht+0xe818, %rdi
cmp %rcx, %rcx
movb $0x61, (%rdi)
nop
nop
...
// Store
lea addresses_normal+0x18588, %rdi
nop
nop
nop
sub $4319, %r8
...
{'OP': 'STOR', 'dst': {'type': 'addresses_RW', 'size': 8, 'AVXalign': True, 'NT': False, 'congruent': 6, 'same': False}}
...
{'OP': 'REPM', 'src': {'type': 'addresses_D_ht', 'congruent': 11, 'same': True}, 'dst': {'type': 'addresses_WC_ht', 'congruent': 7, 'same': False}}
