...
movw $0x6162, (%rsi)
dec %rbp
lea addresses_normal_ht+0xf3e9, %rsi
lea addresses_A_ht+0x126e9, %rdi
and %r10, %r10
mov $124, %rcx
rep movsq
nop
nop
xor %rcx, %rcx
lea addresses_WT_ht+0x18e79, %rbp
nop
nop
nop
nop
...
{'OP': 'REPM', 'src': {'type': 'addresses_normal_ht', 'congruent': 4, 'same': True}, 'dst': {'type': 'addresses_A_ht', 'congruent': 3, 'same': False}}
