...
push %rdx
push %rsi
lea addresses_UC_ht+0x1d9d, %rsi
lea addresses_normal_ht+0x157a5, %rdi
nop
nop
nop
and $3350, %r14
...
rep movsl
xor %r8, %r8
lea addresses_WT_ht+0x1ef35, %rsi
lea addresses_UC_ht+0x13575, %rdi
and %rax, %rax
mov $17, %rcx
rep movsw
nop
dec %rdi
lea addresses_D_ht+0xe835, %r8
nop
nop
and $27754, %r15
vmovups (%r8), %ymm1
...
nop
cmp $23244, %rdi
lea addresses_normal_ht+0x3f95, %r8
nop
nop
nop
nop
...
movw $0x6162, (%r8)
add %rcx, %rcx
lea addresses_UC_ht+0x1a035, %rdi
clflush (%rdi)
nop
nop
nop
...
nop
sub $52641, %rdi
lea addresses_normal_ht+0xc435, %rcx
nop
xor %r15, %r15
...
nop
inc %rdi
lea addresses_WT_ht+0x1c285, %rcx
nop
nop
nop
and %r15, %r15
...
nop
and %rsi, %rsi
lea addresses_D_ht+0x13c19, %rsi
lea addresses_UC_ht+0x14c35, %rdi
nop
nop
nop
add %rdx, %rdx
...
rep movsl
sub %rcx, %rcx
lea addresses_WC_ht+0x1e525, %r15
nop
nop
add %r8, %r8
movl $0x61626364, (%r15)
...
<gen_prepare_buffer>
{'src': {'type': 'addresses_UC_ht', 'congruent': 3, 'same': True}, 'dst': {'type': 'addresses_normal_ht', 'congruent': 1, 'same': False}, 'OP': 'REPM'}
...
{'dst': {'type': 'addresses_normal_ht', 'same': False, 'size': 32, 'congruent': 10, 'NT': True, 'AVXalign': False}, 'OP': 'STOR'}
