...
push %rdi
push %rsi
lea addresses_normal_ht+0x13a55, %r9
nop
nop
xor %rax, %rax
movw $0x6162, (%r9)
sub %rcx, %rcx
lea addresses_WC_ht+0x14555, %rsi
lea addresses_A_ht+0x11e55, %rdi
nop
nop
and $15730, %r9
mov $91, %rcx
...
nop
add $6363, %rsi
lea addresses_UC_ht+0x1ab55, %r13
nop
xor %r11, %r11
movl $0x61626364, (%r13)
nop
add $65294, %r9
lea addresses_WT_ht+0x120ac, %rax
clflush (%rax)
nop
nop
cmp $10673, %rdi
...
nop
add $49282, %r9
lea addresses_normal_ht+0x13575, %r11
nop
nop
sub $22375, %rdi
movw $0x6162, (%r11)
...
{'src': {'type': 'addresses_PSE', 'AVXalign': False, 'size': 4, 'NT': True, 'same': False, 'congruent': 5}, 'OP': 'LOAD'}
...
{'src': {'type': 'addresses_WC_ht', 'congruent': 8, 'same': False}, 'OP': 'REPM', 'dst': {'type': 'addresses_A_ht', 'congruent': 9, 'same': False}}
{'src': {'type': 'addresses_D_ht', 'congruent': 9, 'same': True}, 'OP': 'REPM', 'dst': {'type': 'addresses_D_ht', 'congruent': 1, 'same': False}}
