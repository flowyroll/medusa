...
push %rdi
push %rsi
lea addresses_UC_ht+0x10e8c, %r15
nop
nop
nop
nop
...
nop
add %r13, %r13
lea addresses_A_ht+0x1ab78, %r13
nop
nop
nop
nop
...
// Faulty Load
lea addresses_normal+0x6c0c, %r9
nop
nop
sub $56643, %rdx
mov (%r9), %di
...
{'OP': 'STOR', 'dst': {'type': 'addresses_P', 'size': 32, 'AVXalign': True, 'NT': False, 'congruent': 10, 'same': False}}
[Faulty Load]
