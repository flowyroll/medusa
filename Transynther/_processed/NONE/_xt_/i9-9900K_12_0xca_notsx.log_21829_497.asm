...
push %rdi
push %rsi
lea addresses_UC_ht+0x1aa8d, %r13
nop
dec %rax
movups (%r13), %xmm5
vpextrq $1, %xmm5, %rbp
nop
add $30854, %r8
lea addresses_WC_ht+0x1e06d, %r11
clflush (%r11)
nop
nop
nop
...
nop
sub $31859, %r13
lea addresses_WT_ht+0x1a76d, %rsi
lea addresses_A_ht+0x7e8d, %rdi
nop
nop
inc %rbp
mov $55, %rcx
...
nop
xor $59298, %rbp
lea addresses_D_ht+0x15e8d, %rbp
clflush (%rbp)
nop
nop
nop
...
{'OP': 'STOR', 'dst': {'same': False, 'type': 'addresses_WC', 'NT': False, 'AVXalign': True, 'size': 8, 'congruent': 1}}
{'OP': 'LOAD', 'src': {'same': False, 'type': 'addresses_NC', 'NT': True, 'AVXalign': False, 'size': 16, 'congruent': 2}}
...
{'OP': 'REPM', 'src': {'same': False, 'congruent': 4, 'type': 'addresses_WT_ht'}, 'dst': {'same': False, 'congruent': 9, 'type': 'addresses_A_ht'}}
