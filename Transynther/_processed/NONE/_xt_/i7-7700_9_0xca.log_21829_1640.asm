...
push %rdx
push %rsi
lea addresses_UC_ht+0x1dd9d, %r10
nop
nop
nop
dec %rdi
...
nop
and $53684, %rdx
lea addresses_WC_ht+0x16905, %r10
sub $41027, %r12
movb $0x61, (%r10)
nop
nop
...
nop
and %rdi, %rdi
lea addresses_D_ht+0x10186, %rsi
lea addresses_WT_ht+0xb1a5, %rdi
nop
nop
nop
cmp $40366, %rbp
...
rep movsw
cmp $1481, %rdi
lea addresses_WC_ht+0x46a9, %rsi
lea addresses_D_ht+0x15435, %rdi
nop
nop
nop
nop
...
lea addresses_WC_ht+0x8c05, %rdi
clflush (%rsi)
nop
nop
nop
...
nop
sub %rdx, %rdx
lea addresses_D_ht+0x1e805, %rsi
lea addresses_WT_ht+0x16285, %rdi
nop
nop
nop
nop
...
{'OP': 'STOR', 'dst': {'congruent': 6, 'AVXalign': False, 'same': False, 'size': 16, 'NT': True, 'type': 'addresses_NC'}}
[Faulty Load]
...
{'src': {'congruent': 2, 'same': False, 'type': 'addresses_WC_ht'}, 'OP': 'REPM', 'dst': {'congruent': 3, 'same': False, 'type': 'addresses_D_ht'}}
{'src': {'congruent': 3, 'same': False, 'type': 'addresses_WC_ht'}, 'OP': 'REPM', 'dst': {'congruent': 8, 'same': False, 'type': 'addresses_WC_ht'}}
