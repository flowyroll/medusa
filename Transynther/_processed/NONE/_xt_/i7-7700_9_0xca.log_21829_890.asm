...
push %rdi
push %rsi
lea addresses_UC_ht+0xf787, %rsi
lea addresses_WC_ht+0x13d67, %rdi
nop
nop
and $62896, %r14
mov $23, %rcx
...
nop
inc %r12
lea addresses_normal_ht+0x17a77, %r8
and %r10, %r10
vmovups (%r8), %ymm0
...
nop
xor $11548, %rcx
lea addresses_A_ht+0x6b01, %rsi
lea addresses_UC_ht+0x185a7, %rdi
clflush (%rsi)
sub %r11, %r11
mov $76, %rcx
rep movsq
...
nop
cmp $33756, %rsi
lea addresses_WT_ht+0x95a7, %r14
cmp $39891, %r8
mov (%r14), %r12w
nop
nop
xor $6498, %rsi
lea addresses_UC_ht+0x10fd7, %rsi
...
movw $0x6162, (%rdi)
xor %r10, %r10
lea addresses_WC_ht+0x10da7, %r10
nop
nop
nop
nop
...
<gen_prepare_buffer>
{'src': {'congruent': 5, 'same': False, 'type': 'addresses_UC_ht'}, 'OP': 'REPM', 'dst': {'congruent': 5, 'same': False, 'type': 'addresses_WC_ht'}}
