...
push %rdi
push %rsi
lea addresses_UC_ht+0x58dc, %rsi
...
nop
dec %r14
lea addresses_UC_ht+0x1abec, %rcx
nop
nop
nop
nop
...
movb (%rcx), %r9b
xor $21440, %r9
lea addresses_UC_ht+0x17abc, %rsi
nop
nop
sub $53580, %r14
movl $0x61626364, (%rsi)
nop
xor %r14, %r14
lea addresses_normal_ht+0x170b4, %rcx
clflush (%rcx)
nop
nop
nop
...
nop
xor %r10, %r10
lea addresses_normal_ht+0x38c, %rsi
...
{'dst': {'same': False, 'NT': False, 'AVXalign': True, 'size': 16, 'type': 'addresses_WT_ht', 'congruent': 8}, 'OP': 'STOR'}
