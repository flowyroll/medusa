...
push %rdx
push %rsi
lea addresses_normal_ht+0xfb91, %rdx
nop
inc %rbx
movb $0x61, (%rdx)
nop
...
nop
xor $65454, %r15
lea addresses_UC_ht+0x10241, %rsi
lea addresses_UC_ht+0x13e79, %rdi
nop
nop
nop
nop
...
nop
add %rdx, %rdx
lea addresses_UC_ht+0xc241, %rsi
lea addresses_UC_ht+0x2d94, %rdi
nop
nop
nop
sub $1472, %rbp
...
nop
sub $30846, %rbp
lea addresses_WT_ht+0x1fa1, %rbx
xor %rdx, %rdx
...
nop
cmp $60645, %rbp
lea addresses_A_ht+0x15c41, %rsi
lea addresses_WT_ht+0x16f41, %rdi
nop
nop
nop
nop
...
nop
and %rdx, %rdx
lea addresses_A_ht+0x16128, %r15
nop
nop
nop
nop
...
movl $0x61626364, (%r15)
xor $2205, %rdx
lea addresses_WT_ht+0x6b2f, %rdi
nop
nop
xor $40121, %rdx
mov (%rdi), %ebx
nop
and $63004, %rcx
lea addresses_A_ht+0xd8f9, %rsi
lea addresses_UC_ht+0x17a41, %rdi
nop
nop
nop
nop
...
nop
sub $14492, %r9
lea addresses_WC_ht+0x10795, %rdi
nop
nop
sub $62332, %rbx
vmovups (%rdi), %ymm3
...
{'src': {'type': 'addresses_WT_ht', 'AVXalign': True, 'size': 4, 'NT': False, 'same': False, 'congruent': 1}, 'OP': 'LOAD'}
