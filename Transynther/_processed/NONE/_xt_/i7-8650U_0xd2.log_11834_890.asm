...
push %rdi
push %rsi
lea addresses_WC_ht+0x19f32, %rbx
nop
nop
nop
nop
...
nop
sub %rbp, %rbp
lea addresses_normal_ht+0x1e852, %rsi
lea addresses_A_ht+0xee05, %rdi
and $38655, %r11
mov $10, %rcx
rep movsl
nop
...
nop
add %rbp, %rbp
lea addresses_UC_ht+0x10252, %rbx
cmp %rsi, %rsi
mov (%rbx), %ebp
nop
nop
...
nop
cmp %r14, %r14
lea addresses_D_ht+0x1b25a, %rdi
nop
nop
xor $42269, %rcx
mov (%rdi), %r14d
...
nop
and $64088, %rdi
lea addresses_WT_ht+0x852, %rsi
lea addresses_D_ht+0x13052, %rdi
sub $25870, %r11
mov $13, %rcx
rep movsw
nop
...
nop
and %r14, %r14
lea addresses_A_ht+0x144d8, %rbp
nop
nop
nop
nop
...
{'OP': 'REPM', 'src': {'type': 'addresses_normal_ht', 'congruent': 11, 'same': False}, 'dst': {'type': 'addresses_A_ht', 'congruent': 0, 'same': True}}
