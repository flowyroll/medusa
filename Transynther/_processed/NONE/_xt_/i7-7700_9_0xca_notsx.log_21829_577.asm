...
push %rdi
push %rsi
lea addresses_normal_ht+0x1a32, %rsi
lea addresses_normal_ht+0xbef2, %rdi
nop
nop
cmp $16420, %rbp
mov $87, %rcx
...
lea addresses_A_ht+0x1dd36, %rdi
clflush (%rsi)
inc %r14
mov $42, %rcx
rep movsw
nop
sub $63604, %r14
lea addresses_normal_ht+0x3572, %r8
nop
nop
nop
nop
...
mov (%r8), %ebp
and $26141, %rdi
lea addresses_WT_ht+0x70b2, %r14
nop
nop
inc %r12
...
nop
cmp $59052, %r14
lea addresses_A_ht+0x106f2, %r12
nop
nop
nop
nop
...
nop
add $6150, %r14
lea addresses_A_ht+0x17cf2, %rsi
lea addresses_WT_ht+0x4272, %rdi
nop
nop
nop
nop
...
nop
sub $17290, %r8
lea addresses_A_ht+0xa672, %r12
and %rcx, %rcx
mov $0x6162636465666768, %rdi
movq %rdi, (%r12)
sub $52363, %rdi
lea addresses_normal_ht+0x1acf2, %rsi
lea addresses_WT_ht+0x5b92, %rdi
nop
cmp $14753, %r13
mov $31, %rcx
rep movsq
...
nop
and %r8, %r8
lea addresses_UC_ht+0x59b6, %rsi
lea addresses_normal_ht+0xb456, %rdi
clflush (%rdi)
nop
nop
nop
...
lea addresses_WT_ht+0x3492, %rdi
nop
nop
nop
cmp %rbp, %rbp
...
{'dst': {'NT': False, 'AVXalign': False, 'size': 16, 'congruent': 8, 'same': True, 'type': 'addresses_A_ht'}, 'OP': 'STOR'}
{'src': {'congruent': 5, 'same': False, 'type': 'addresses_A_ht'}, 'dst': {'congruent': 6, 'same': False, 'type': 'addresses_WT_ht'}, 'OP': 'REPM'}
{'dst': {'NT': False, 'AVXalign': False, 'size': 8, 'congruent': 5, 'same': False, 'type': 'addresses_A_ht'}, 'OP': 'STOR'}
{'src': {'congruent': 9, 'same': False, 'type': 'addresses_normal_ht'}, 'dst': {'congruent': 5, 'same': True, 'type': 'addresses_WT_ht'}, 'OP': 'REPM'}
{'src': {'congruent': 2, 'same': False, 'type': 'addresses_UC_ht'}, 'dst': {'congruent': 2, 'same': False, 'type': 'addresses_normal_ht'}, 'OP': 'REPM'}
{'src': {'congruent': 3, 'same': False, 'type': 'addresses_UC_ht'}, 'dst': {'congruent': 3, 'same': False, 'type': 'addresses_WT_ht'}, 'OP': 'REPM'}
{'36': 21829}
