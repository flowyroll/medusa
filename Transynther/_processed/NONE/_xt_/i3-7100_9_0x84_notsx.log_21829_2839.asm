...
push %rdi
push %rsi
lea addresses_normal_ht+0x50eb, %rsi
lea addresses_D_ht+0x84eb, %rdi
nop
nop
nop
add $37663, %r12
...
nop
dec %r9
lea addresses_D_ht+0x652f, %rsi
lea addresses_UC_ht+0x1e2b3, %rdi
add $53367, %r10
mov $92, %rcx
rep movsl
nop
...
lea addresses_D_ht+0x1b20b, %rdi
nop
nop
nop
and %r11, %r11
...
nop
xor $29634, %r9
lea addresses_UC_ht+0xdc15, %r12
and %r11, %r11
movb (%r12), %cl
nop
nop
nop
sub %rsi, %rsi
lea addresses_normal_ht+0x1467d, %rsi
lea addresses_normal_ht+0x1250b, %rdi
sub %rax, %rax
mov $76, %rcx
rep movsl
nop
...
nop
cmp %rax, %rax
lea addresses_WC_ht+0x16fab, %rdi
clflush (%rdi)
nop
nop
nop
...
nop
mfence
lea addresses_WC_ht+0x1bf4b, %rsi
lea addresses_normal_ht+0x1e01b, %rdi
nop
nop
nop
nop
...
nop
sub %r9, %r9
lea addresses_normal_ht+0x3eeb, %r11
nop
cmp $5752, %rsi
...
{'src': {'type': 'addresses_WC_ht', 'congruent': 3, 'same': False}, 'dst': {'type': 'addresses_normal_ht', 'congruent': 1, 'same': False}, 'OP': 'REPM'}
