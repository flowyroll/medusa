...
push %rdx
push %rsi
lea addresses_UC_ht+0xa2e3, %r14
nop
add $19464, %r13
mov (%r14), %si
nop
...
nop
inc %r14
lea addresses_WT_ht+0x99bb, %r14
nop
xor $63619, %r12
movw $0x6162, (%r14)
nop
...
nop
and %rdx, %rdx
lea addresses_UC_ht+0x16792, %rcx
clflush (%rcx)
nop
nop
nop
...
nop
sub $22296, %r14
lea addresses_WT_ht+0x168f3, %r13
nop
nop
nop
nop
...
nop
xor $43596, %r14
lea addresses_WC_ht+0x71f3, %rsi
...
rep movsw
add $64306, %rcx
lea addresses_D_ht+0x6073, %r11
nop
dec %r12
movw $0x6162, (%r11)
sub %rcx, %rcx
lea addresses_normal_ht+0xec99, %rsi
lea addresses_UC_ht+0x1823, %rdi
nop
nop
nop
nop
...
// Faulty Load
lea addresses_normal+0x19073, %rdi
nop
add $7377, %rbx
mov (%rdi), %ecx
lea oracles, %r15
...
{'OP': 'STOR', 'dst': {'type': 'addresses_US', 'size': 4, 'AVXalign': False, 'NT': True, 'congruent': 0, 'same': False}}
[Faulty Load]
...
{'OP': 'REPM', 'src': {'type': 'addresses_normal_ht', 'congruent': 0, 'same': True}, 'dst': {'type': 'addresses_UC_ht', 'congruent': 2, 'same': True}}
{'34': 11352}
