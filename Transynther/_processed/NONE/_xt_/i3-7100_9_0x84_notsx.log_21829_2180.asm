...
nop
cmp $19142, %r15
lea addresses_WC_ht+0x17b32, %rsi
lea addresses_A_ht+0xf132, %rdi
clflush (%rdi)
nop
and %r14, %r14
mov $123, %rcx
...
nop
xor %rdi, %rdi
lea addresses_A_ht+0x13e32, %rdi
nop
nop
sub $63868, %r13
movups (%rdi), %xmm2
...
nop
sub $10389, %rbx
lea addresses_UC_ht+0x15b32, %rsi
lea addresses_WC_ht+0x19812, %rdi
cmp $55200, %rax
mov $87, %rcx
rep movsl
nop
inc %rdi
lea addresses_A_ht+0x19256, %r13
nop
nop
nop
nop
...
movl $0x61626364, (%r13)
inc %rdi
lea addresses_WT_ht+0x114fa, %rsi
lea addresses_WC_ht+0x1e832, %rdi
nop
nop
nop
sub $54829, %r15
...
nop
and %rax, %rax
lea addresses_A_ht+0x1453c, %rdi
nop
sub $35189, %rcx
vmovups (%rdi), %ymm4
...
vpextrq $1, %xmm4, %r14
cmp %rcx, %rcx
lea addresses_D_ht+0x15712, %rbx
clflush (%rbx)
nop
and $38689, %r15
movw $0x6162, (%rbx)
...
{'src': {'type': 'addresses_WC_ht', 'congruent': 6, 'same': False}, 'dst': {'type': 'addresses_A_ht', 'congruent': 8, 'same': False}, 'OP': 'REPM'}
...
{'src': {'type': 'addresses_WT_ht', 'congruent': 2, 'same': False}, 'dst': {'type': 'addresses_WC_ht', 'congruent': 9, 'same': True}, 'OP': 'REPM'}
...
{'dst': {'type': 'addresses_D_ht', 'same': False, 'size': 2, 'congruent': 5, 'NT': True, 'AVXalign': False}, 'OP': 'STOR'}
{'33': 21829}
