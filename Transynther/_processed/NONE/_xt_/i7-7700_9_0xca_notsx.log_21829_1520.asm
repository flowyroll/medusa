...
nop
inc %r8
lea addresses_WC_ht+0x554f, %rbp
nop
nop
nop
nop
...
nop
add %rdi, %rdi
lea addresses_D_ht+0x189d7, %rbp
nop
nop
nop
nop
...
nop
inc %rdi
lea addresses_D_ht+0x105ab, %r12
and %r8, %r8
...
nop
sub %rbp, %rbp
lea addresses_WT_ht+0x554f, %rbp
clflush (%rbp)
nop
nop
nop
...
nop
cmp %rcx, %rcx
lea addresses_WT_ht+0x9d4f, %rcx
nop
nop
nop
nop
...
nop
cmp $55551, %rbp
lea addresses_WT_ht+0x1d4f, %rcx
nop
nop
nop
nop
...
<gen_prepare_buffer>
{'src': {'congruent': 5, 'same': False, 'type': 'addresses_A_ht'}, 'dst': {'congruent': 2, 'same': False, 'type': 'addresses_UC_ht'}, 'OP': 'REPM'}
