...
push %rdx
push %rsi
lea addresses_normal_ht+0x1e1ba, %r15
nop
add %rdi, %rdi
mov (%r15), %rsi
nop
...
nop
xor %rbp, %rbp
lea addresses_UC_ht+0x11f3a, %rsi
lea addresses_D_ht+0x4ba, %rdi
nop
nop
dec %r13
mov $64, %rcx
...
nop
cmp $59074, %r13
lea addresses_UC_ht+0x8a7a, %r13
clflush (%r13)
nop
nop
xor %rdx, %rdx
...
nop
and %r15, %r15
lea addresses_WT_ht+0x1b72a, %rsi
nop
nop
cmp $25048, %rdx
mov (%rsi), %ebp
...
nop
add %rbp, %rbp
lea addresses_A_ht+0x12a9d, %rsi
lea addresses_WT_ht+0x2b3a, %rdi
clflush (%rdi)
nop
nop
nop
...
nop
sub $3713, %rdx
lea addresses_WC_ht+0x11e3a, %rsi
...
nop
add $62873, %rbp
lea addresses_A_ht+0x3f68, %rsi
lea addresses_normal_ht+0xb93a, %rdi
nop
nop
nop
dec %r15
...
{'src': {'type': 'addresses_A_ht', 'congruent': 0, 'same': False}, 'OP': 'REPM', 'dst': {'type': 'addresses_WT_ht', 'congruent': 11, 'same': False}}
{'src': {'type': 'addresses_WC_ht', 'congruent': 8, 'same': False}, 'OP': 'REPM', 'dst': {'type': 'addresses_A_ht', 'congruent': 0, 'same': False}}
{'src': {'type': 'addresses_A_ht', 'congruent': 1, 'same': False}, 'OP': 'REPM', 'dst': {'type': 'addresses_normal_ht', 'congruent': 5, 'same': False}}
{'38': 21829}
