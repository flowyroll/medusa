...
nop
cmp $56252, %r12
lea addresses_WT_ht+0xbb3, %rsi
lea addresses_normal_ht+0x10d53, %rdi
nop
cmp $38001, %r11
mov $69, %rcx
rep movsq
and $8789, %rcx
lea addresses_WC_ht+0xc733, %rsi
lea addresses_normal_ht+0x77d3, %rdi
clflush (%rdi)
nop
add %r12, %r12
mov $31, %rcx
...
nop
add $9989, %r11
lea addresses_A_ht+0x1b533, %rsi
lea addresses_UC_ht+0xaa31, %rdi
nop
cmp $15290, %r15
mov $57, %rcx
rep movsb
