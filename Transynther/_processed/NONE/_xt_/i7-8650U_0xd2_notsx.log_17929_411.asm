...
push %rdi
push %rsi
lea addresses_WC_ht+0x1c5, %rsi
lea addresses_normal_ht+0x1d5c5, %rdi
nop
nop
nop
nop
...
nop
sub $65223, %rax
lea addresses_normal_ht+0x1cfc5, %r14
nop
nop
nop
nop
...
nop
dec %rbp
lea addresses_A_ht+0x150c5, %rcx
nop
dec %rdi
movb $0x61, (%rcx)
nop
...
nop
and $29490, %r14
lea addresses_WT_ht+0x1a9c5, %rdi
inc %rbx
movb $0x61, (%rdi)
nop
nop
cmp $54287, %rcx
lea addresses_UC_ht+0xb791, %r14
nop
nop
nop
xor $54759, %rcx
...
nop
xor %rax, %rax
lea addresses_WC_ht+0xb4c5, %rsi
lea addresses_UC_ht+0xc2d1, %rdi
nop
nop
nop
nop
...
rep movsl
add $50805, %rcx
lea addresses_D_ht+0x1ca91, %rsi
lea addresses_D_ht+0x35c5, %rdi
nop
nop
nop
xor %r8, %r8
...
{'OP': 'LOAD', 'src': {'type': 'addresses_UC_ht', 'size': 8, 'AVXalign': True, 'NT': False, 'congruent': 2, 'same': False}}
