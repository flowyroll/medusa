...
push %rax
push %rsi
lea addresses_A_ht+0x1d1e8, %r11
dec %rsi
mov (%r11), %r13d
nop
nop
...
nop
add %r10, %r10
lea addresses_normal_ht+0x67c8, %r9
clflush (%r9)
nop
add $9912, %r13
...
// Load
lea addresses_normal+0x15e8, %rax
add $3132, %rbx
movups (%rax), %xmm5
vpextrq $1, %xmm5, %rdx
xor %rax, %rax
