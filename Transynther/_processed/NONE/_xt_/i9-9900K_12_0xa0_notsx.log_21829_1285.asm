...
nop
xor %r11, %r11
lea addresses_normal_ht+0xd89e, %rax
nop
nop
nop
xor %rdi, %rdi
...
nop
xor $6943, %r9
lea addresses_D_ht+0x1657e, %rsi
lea addresses_A_ht+0xed7e, %rdi
and %rbp, %rbp
mov $34, %rcx
rep movsb
add %rcx, %rcx
