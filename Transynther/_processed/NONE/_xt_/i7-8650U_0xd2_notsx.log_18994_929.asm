...
push %rbp
push %rsi
lea addresses_normal_ht+0x14e6a, %r10
nop
nop
xor $1372, %rsi
movb (%r10), %r12b
...
nop
and $27587, %rbp
lea addresses_WT_ht+0x3d97, %rbp
clflush (%rbp)
nop
cmp $51870, %r10
movw $0x6162, (%rbp)
...
// Faulty Load
lea addresses_normal+0x9097, %rsi
nop
nop
nop
nop
