...
push %rdi
push %rsi
lea addresses_D_ht+0x366a, %rsi
lea addresses_WC_ht+0xa7a, %rdi
nop
nop
nop
nop
...
nop
sub $14489, %rcx
lea addresses_normal_ht+0xeffa, %rbp
nop
nop
nop
and $14481, %r12
...
nop
dec %rdi
lea addresses_D_ht+0xcb48, %rsi
sub %rax, %rax
mov (%rsi), %r12w
nop
nop
xor $54738, %rax
lea addresses_A_ht+0x194ae, %rcx
nop
nop
nop
and %rbp, %rbp
mov (%rcx), %di
cmp %rcx, %rcx
lea addresses_D_ht+0x17104, %rcx
nop
nop
nop
cmp $62313, %rax
...
nop
sub $56470, %rsi
lea addresses_A_ht+0xb17a, %rsi
lea addresses_normal_ht+0x98a, %rdi
nop
nop
nop
sub %rbx, %rbx
...
lea addresses_WT_ht+0x1936a, %rdi
nop
xor %rax, %rax
mov $102, %rcx
rep movsb
...
{'src': {'congruent': 5, 'same': True, 'type': 'addresses_A_ht'}, 'dst': {'congruent': 2, 'same': False, 'type': 'addresses_normal_ht'}, 'OP': 'REPM'}
