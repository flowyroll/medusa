...
push %rdi
push %rsi
lea addresses_UC_ht+0x17118, %rdi
nop
add $35398, %rsi
movb $0x61, (%rdi)
nop
...
nop
and %rsi, %rsi
lea addresses_D_ht+0x1e9e8, %r14
add $28882, %rbp
...
nop
dec %r15
lea addresses_A_ht+0x870, %rbp
nop
cmp $10112, %rax
movw $0x6162, (%rbp)
nop
sub $21993, %rbp
lea addresses_UC_ht+0xda58, %rax
nop
nop
nop
nop
...
nop
and %rsi, %rsi
lea addresses_WC_ht+0x12258, %rsi
lea addresses_normal_ht+0x16cc, %rdi
clflush (%rdi)
nop
nop
xor $33834, %r10
