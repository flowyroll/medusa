...
nop
sub %rcx, %rcx
lea addresses_WT_ht+0x1ce67, %rsi
lea addresses_normal_ht+0xa7a9, %rdi
nop
xor %r15, %r15
mov $31, %rcx
rep movsq
xor %r15, %r15
lea addresses_UC_ht+0x16da9, %rsi
lea addresses_normal_ht+0x171e9, %rdi
nop
nop
nop
add $61220, %r15
...
nop
inc %rsi
lea addresses_A_ht+0x147e9, %rsi
nop
add %r12, %r12
...
nop
cmp %r9, %r9
lea addresses_normal_ht+0x1b3a9, %r8
clflush (%r8)
cmp $51042, %r9
mov (%r8), %r12d
nop
...
nop
cmp $42171, %r9
lea addresses_UC_ht+0x11205, %rsi
nop
nop
add %r8, %r8
movw $0x6162, (%rsi)
...
nop
sub $21769, %r8
lea addresses_normal_ht+0x9454, %rsi
lea addresses_WT_ht+0x52a9, %rdi
nop
nop
inc %r15
mov $26, %rcx
...
// Store
lea addresses_normal+0xdf95, %rsi
nop
sub %rax, %rax
...
{'OP': 'STOR', 'dst': {'same': False, 'congruent': 3, 'NT': True, 'type': 'addresses_P', 'size': 8, 'AVXalign': False}}
...
{'OP': 'STOR', 'dst': {'same': True, 'congruent': 3, 'NT': False, 'type': 'addresses_WC_ht', 'size': 2, 'AVXalign': False}}
{'33': 21829}
