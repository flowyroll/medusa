...
nop
cmp $19828, %r14
lea addresses_UC_ht+0x1cdcb, %r15
nop
nop
nop
add %r14, %r14
movl $0x61626364, (%r15)
sub $34480, %r14
lea addresses_normal_ht+0x9d93, %r9
nop
nop
nop
nop
...
movw $0x6162, (%r9)
add %rdx, %rdx
lea addresses_normal_ht+0x9abb, %r11
dec %r15
mov (%r11), %r14w
nop
nop
...
lea addresses_WT_ht+0x3fbb, %rdi
nop
nop
nop
nop
...
nop
and $18226, %rsi
lea addresses_normal_ht+0xdd9f, %rsi
lea addresses_WT_ht+0x7bb, %rdi
clflush (%rsi)
sub $63143, %r14
mov $115, %rcx
rep movsw
...
nop
dec %rdi
lea addresses_WC_ht+0x18cb, %rcx
clflush (%rcx)
nop
inc %rdi
movb (%rcx), %r15b
...
nop
lfence
lea addresses_WT_ht+0xfefd, %rcx
clflush (%rcx)
nop
nop
cmp %rsi, %rsi
...
vmovups %ymm7, (%rcx)
add %rdi, %rdi
lea addresses_WC_ht+0x371b, %rsi
lea addresses_normal_ht+0xf36f, %rdi
nop
nop
nop
nop
...
nop
inc %rsi
lea addresses_UC_ht+0x1c9f3, %rcx
and %r13, %r13
...
nop
xor $20225, %r9
lea addresses_D_ht+0x1a93b, %r14
nop
nop
cmp $29250, %r13
movl $0x61626364, (%r14)
...
nop
add %r9, %r9
lea addresses_UC_ht+0x1c743, %rsi
nop
nop
nop
nop
...
{'OP': 'STOR', 'dst': {'same': True, 'congruent': 3, 'NT': False, 'type': 'addresses_UC_ht', 'size': 4, 'AVXalign': False}}
...
{'src': {'type': 'addresses_WC_ht', 'congruent': 5, 'same': False}, 'OP': 'REPM', 'dst': {'type': 'addresses_normal_ht', 'congruent': 2, 'same': True}}
...
{'src': {'same': True, 'congruent': 3, 'NT': False, 'type': 'addresses_UC_ht', 'size': 32, 'AVXalign': False}, 'OP': 'LOAD'}
{'36': 21829}
