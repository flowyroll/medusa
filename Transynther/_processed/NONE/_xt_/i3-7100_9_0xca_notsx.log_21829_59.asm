...
push %rdx
push %rsi
lea addresses_WT_ht+0x15ce2, %rsi
nop
xor $45449, %r14
movw $0x6162, (%rsi)
nop
nop
sub $32250, %rbx
lea addresses_A_ht+0x1d5e2, %r11
nop
nop
nop
nop
...
nop
add %r11, %r11
lea addresses_WC_ht+0xc262, %rsi
lea addresses_UC_ht+0x140e2, %rdi
nop
add $25658, %rbx
mov $13, %rcx
rep movsl
cmp %rbx, %rbx
lea addresses_WT_ht+0x14ce2, %rbx
nop
nop
and %r10, %r10
movl $0x61626364, (%rbx)
nop
and $56188, %r14
lea addresses_A_ht+0x160e2, %rcx
nop
cmp $35624, %rbx
...
vmovups %ymm5, (%rcx)
sub $32266, %rsi
lea addresses_WC_ht+0x14740, %rdi
nop
nop
nop
add $60269, %rcx
movb (%rdi), %bl
and %r10, %r10
lea addresses_WC_ht+0x5ee2, %rsi
lea addresses_WT_ht+0x1b3d2, %rdi
and %rdx, %rdx
mov $119, %rcx
rep movsb
nop
...
nop
and %rdi, %rdi
lea addresses_A_ht+0x1cce2, %rsi
clflush (%rsi)
xor $63875, %rdi
movb $0x61, (%rsi)
nop
dec %rdi
lea addresses_UC_ht+0x6416, %rsi
lea addresses_A_ht+0x1106e, %rdi
clflush (%rsi)
and %rbx, %rbx
mov $122, %rcx
rep movsq
dec %rbx
lea addresses_WT_ht+0x164e2, %rsi
lea addresses_WT_ht+0x92cc, %rdi
clflush (%rsi)
add %rdx, %rdx
mov $33, %rcx
rep movsq
...
nop
and $41442, %rcx
lea addresses_WC_ht+0x18862, %r10
nop
nop
nop
nop
...
vpextrq $0, %xmm5, %rsi
xor %rdx, %rdx
lea addresses_WC_ht+0x1ce62, %rsi
lea addresses_WC_ht+0xcee2, %rdi
nop
nop
nop
nop
...
nop
cmp %r10, %r10
lea addresses_WT_ht+0x9902, %r10
nop
nop
cmp $45309, %rcx
...
nop
dec %r14
lea addresses_WT_ht+0x1c0f2, %r10
nop
nop
nop
add %rdi, %rdi
...
{'src': {'type': 'addresses_UC_ht', 'congruent': 1, 'same': False}, 'OP': 'REPM', 'dst': {'type': 'addresses_A_ht', 'congruent': 1, 'same': True}}
...
{'OP': 'STOR', 'dst': {'same': False, 'congruent': 0, 'NT': False, 'type': 'addresses_WT_ht', 'size': 16, 'AVXalign': True}}
