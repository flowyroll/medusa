...
push %rdx
push %rsi
lea addresses_D_ht+0xdb32, %rsi
lea addresses_WT_ht+0x16372, %rdi
nop
add $28070, %r8
mov $35, %rcx
rep movsb
...
nop
cmp $3308, %rbp
lea addresses_D_ht+0xcfc, %rdx
nop
cmp $23414, %rcx
mov (%rdx), %bp
nop
sub %rcx, %rcx
lea addresses_normal_ht+0x17532, %r8
inc %rcx
movw $0x6162, (%r8)
nop
nop
...
nop
and %rbp, %rbp
lea addresses_WT_ht+0xb732, %rsi
sub $37176, %r14
movw $0x6162, (%rsi)
nop
nop
nop
xor %rcx, %rcx
lea addresses_WT_ht+0xb9c9, %rsi
lea addresses_WC_ht+0xb832, %rdi
nop
nop
nop
nop
...
nop
add %rcx, %rcx
lea addresses_WT_ht+0x7b2, %rsi
lea addresses_A_ht+0x10b32, %rdi
and $13302, %rax
mov $125, %rcx
rep movsb
nop
