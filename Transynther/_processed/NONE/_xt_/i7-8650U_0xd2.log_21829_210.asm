...
mov (%rdi), %rcx
add $62268, %rax
lea addresses_UC_ht+0xb317, %rsi
lea addresses_A_ht+0x1981b, %rdi
xor %r14, %r14
mov $81, %rcx
rep movsq
nop
...
nop
dec %rax
lea addresses_UC_ht+0x4557, %rsi
nop
nop
nop
nop
...
nop
xor $25898, %rax
lea addresses_WT_ht+0xbb57, %rbp
clflush (%rbp)
nop
nop
nop
...
{'OP': 'LOAD', 'src': {'type': 'addresses_WT_ht', 'size': 16, 'AVXalign': False, 'NT': True, 'congruent': 4, 'same': False}}
{'36': 21829}
