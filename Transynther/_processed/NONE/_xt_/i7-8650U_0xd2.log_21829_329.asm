...
push %rdi
push %rsi
lea addresses_WC_ht+0x17386, %r8
nop
xor $13822, %r13
movl $0x61626364, (%r8)
nop
...
nop
xor %r11, %r11
lea addresses_WT_ht+0xa6d2, %rsi
lea addresses_WC_ht+0x956a, %rdi
add %rbp, %rbp
mov $114, %rcx
rep movsb
nop
...
{'OP': 'STOR', 'dst': {'type': 'addresses_WT_ht', 'size': 8, 'AVXalign': False, 'NT': True, 'congruent': 3, 'same': True}}
