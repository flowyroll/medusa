...
push %rdx
push %rsi
lea addresses_D_ht+0x1e69b, %rdi
nop
nop
nop
and $41306, %r12
...
nop
sub %r12, %r12
lea addresses_normal_ht+0x9a9b, %r13
add %r10, %r10
mov $0x6162636465666768, %r9
movq %r9, %xmm0
movups %xmm0, (%r13)
and %rbx, %rbx
lea addresses_WT_ht+0x2a9b, %rdi
nop
nop
sub $62768, %r12
mov (%rdi), %r10d
...
nop
cmp %rbx, %rbx
lea addresses_normal_ht+0xae9b, %rbx
clflush (%rbx)
add $62001, %rdx
movl $0x61626364, (%rbx)
add $3052, %r9
lea addresses_WT_ht+0x15a9b, %rdi
nop
nop
and $890, %r13
movl $0x61626364, (%rdi)
and %r13, %r13
lea addresses_D_ht+0x6a9b, %rdx
clflush (%rdx)
nop
nop
nop
...
movups %xmm7, (%r13)
sub %rdi, %rdi
lea addresses_UC_ht+0xcf7b, %r12
nop
nop
nop
nop
...
nop
add $11473, %rdi
lea addresses_WT_ht+0x1399b, %rsi
lea addresses_normal_ht+0x1d9b, %rdi
nop
nop
nop
sub $12061, %rdx
...
nop
cmp %rsi, %rsi
lea addresses_UC_ht+0x1569b, %rsi
lea addresses_WC_ht+0xa52b, %rdi
nop
nop
nop
nop
...
{'OP': 'LOAD', 'src': {'same': False, 'NT': False, 'AVXalign': True, 'size': 4, 'type': 'addresses_WT_ht', 'congruent': 9}}
{'dst': {'same': False, 'NT': False, 'AVXalign': True, 'size': 4, 'type': 'addresses_normal_ht', 'congruent': 10}, 'OP': 'STOR'}
...
{'dst': {'same': False, 'congruent': 8, 'type': 'addresses_normal_ht'}, 'OP': 'REPM', 'src': {'same': False, 'congruent': 8, 'type': 'addresses_WT_ht'}}
...
{'dst': {'same': False, 'congruent': 4, 'type': 'addresses_WC_ht'}, 'OP': 'REPM', 'src': {'same': False, 'congruent': 10, 'type': 'addresses_UC_ht'}}
{'37': 21829}
