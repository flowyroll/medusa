...
push %rdi
push %rsi
lea addresses_A_ht+0x18462, %r10
clflush (%r10)
nop
nop
nop
...
nop
add $2486, %r10
lea addresses_normal_ht+0x1e19a, %r9
nop
and %r8, %r8
movups (%r9), %xmm5
vpextrq $1, %xmm5, %rcx
nop
inc %rcx
lea addresses_normal_ht+0x113a2, %r9
clflush (%r9)
nop
nop
nop
...
nop
xor %rax, %rax
lea addresses_UC_ht+0x9d52, %rax
nop
nop
cmp %rdi, %rdi
...
nop
and $17194, %r10
lea addresses_normal_ht+0x1c7a2, %r9
nop
cmp %r10, %r10
...
nop
add %r9, %r9
lea addresses_normal_ht+0x51a2, %rax
add $64133, %r8
movb $0x61, (%rax)
nop
nop
sub $30492, %r9
lea addresses_normal_ht+0x1d882, %rsi
lea addresses_WC_ht+0x7f2, %rdi
nop
and %rax, %rax
mov $17, %rcx
rep movsq
...
nop
xor %r11, %r11
lea addresses_WC_ht+0x4536, %rsi
