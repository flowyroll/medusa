...
nop
sub %rdx, %rdx
lea addresses_A_ht+0x1bfe1, %rsi
lea addresses_WC_ht+0x1045e, %rdi
nop
nop
nop
inc %rbx
...
rep movsw
dec %r10
lea addresses_UC_ht+0xe120, %rdi
nop
nop
nop
nop
...
nop
inc %rdi
lea addresses_UC_ht+0x135e, %rdx
nop
xor %rbx, %rbx
vmovups (%rdx), %ymm0
...
nop
xor %r13, %r13
lea addresses_WT_ht+0x11ede, %r13
nop
nop
nop
nop
...
nop
dec %rcx
lea addresses_WC_ht+0x14246, %rsi
lea addresses_UC_ht+0x157ce, %rdi
nop
nop
nop
sub %r15, %r15
...
nop
sub %rcx, %rcx
lea addresses_WT_ht+0x192de, %rsi
clflush (%rsi)
nop
nop
nop
...
nop
and %rdx, %rdx
lea addresses_UC_ht+0x10abe, %rsi
lea addresses_normal_ht+0xd25e, %rdi
clflush (%rsi)
nop
nop
nop
...
nop
inc %rcx
lea addresses_D_ht+0x126de, %rdx
nop
nop
nop
nop
...
// Faulty Load
lea addresses_normal+0xeede, %r9
nop
nop
sub $39114, %r11
mov (%r9), %cx
...
<gen_prepare_buffer>
{'OP': 'LOAD', 'src': {'type': 'addresses_A_ht', 'size': 1, 'AVXalign': True, 'NT': False, 'congruent': 0, 'same': False}}
...
{'OP': 'LOAD', 'src': {'type': 'addresses_WT_ht', 'size': 4, 'AVXalign': True, 'NT': True, 'congruent': 10, 'same': False}}
