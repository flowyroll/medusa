...
push %rdi
push %rsi
lea addresses_A_ht+0x12b57, %rcx
nop
nop
nop
nop
...
nop
add %rsi, %rsi
lea addresses_UC_ht+0xc4b7, %r14
nop
nop
nop
nop
...
nop
and %rsi, %rsi
lea addresses_WT_ht+0x1eb97, %r14
nop
nop
nop
nop
...
vpextrq $0, %xmm2, %rsi
xor %r15, %r15
lea addresses_UC_ht+0x14667, %rsi
lea addresses_A_ht+0x1cd57, %rdi
and $1091, %r14
mov $70, %rcx
rep movsw
cmp %rcx, %rcx
lea addresses_D_ht+0x6a88, %rsi
lea addresses_D_ht+0x44db, %rdi
nop
xor %r13, %r13
mov $66, %rcx
rep movsq
...
nop
sub %r15, %r15
lea addresses_A_ht+0x6757, %rsi
lea addresses_A_ht+0x1c51b, %rdi
nop
nop
nop
nop
...
nop
lfence
lea addresses_normal_ht+0x1ca97, %rdi
nop
nop
nop
nop
...
movb $0x61, (%rdi)
and %r12, %r12
lea addresses_normal_ht+0x9357, %rcx
nop
nop
xor $12761, %r13
movw $0x6162, (%rcx)
...
nop
xor %r15, %r15
lea addresses_WT_ht+0xbcf7, %r12
nop
nop
xor $908, %r14
...
// REPMOV
lea addresses_A+0x1a8a7, %rsi
lea addresses_normal+0x7a57, %rdi
nop
add %rdx, %rdx
mov $34, %rcx
rep movsq
...
<gen_faulty_load>
[REF]
{'src': {'same': False, 'congruent': 0, 'NT': True, 'type': 'addresses_D', 'size': 2, 'AVXalign': False}, 'OP': 'LOAD'}
{'OP': 'STOR', 'dst': {'same': False, 'congruent': 4, 'NT': True, 'type': 'addresses_D', 'size': 4, 'AVXalign': False}}
{'OP': 'STOR', 'dst': {'same': False, 'congruent': 7, 'NT': False, 'type': 'addresses_WT', 'size': 2, 'AVXalign': False}}
{'src': {'type': 'addresses_A', 'congruent': 3, 'same': False}, 'OP': 'REPM', 'dst': {'type': 'addresses_normal', 'congruent': 8, 'same': False}}
{'OP': 'STOR', 'dst': {'same': False, 'congruent': 5, 'NT': False, 'type': 'addresses_P', 'size': 2, 'AVXalign': False}}
{'OP': 'STOR', 'dst': {'same': False, 'congruent': 9, 'NT': False, 'type': 'addresses_WC', 'size': 16, 'AVXalign': True}}
...
{'src': {'type': 'addresses_D_ht', 'congruent': 0, 'same': False}, 'OP': 'REPM', 'dst': {'type': 'addresses_D_ht', 'congruent': 1, 'same': False}}
