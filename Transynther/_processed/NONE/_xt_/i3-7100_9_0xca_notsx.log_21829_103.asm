...
push %rdi
push %rsi
lea addresses_WC_ht+0x1b3ba, %r12
nop
nop
nop
nop
...
nop
cmp %rbx, %rbx
lea addresses_WT_ht+0x1523a, %rdi
nop
nop
nop
nop
...
nop
cmp $36975, %rbx
lea addresses_D_ht+0x15aba, %rdi
nop
nop
add %rbx, %rbx
vmovups (%rdi), %ymm0
...
nop
add %r14, %r14
lea addresses_D_ht+0x12aba, %rbx
nop
and $14248, %r15
mov (%rbx), %si
nop
...
lea addresses_UC_ht+0xaeba, %rdi
nop
xor %r15, %r15
mov $87, %rcx
rep movsw
...
nop
xor $28503, %r13
lea addresses_WC_ht+0x7862, %rsi
nop
nop
add $2038, %rbx
movups (%rsi), %xmm3
...
nop
add $43872, %r13
lea addresses_WC_ht+0xc0d2, %rsi
lea addresses_UC_ht+0xe2ba, %rdi
nop
nop
nop
and %r13, %r13
...
nop
xor $15946, %rbx
lea addresses_WT_ht+0x1234c, %r13
nop
nop
inc %r12
...
{'src': {'type': 'addresses_D_ht', 'congruent': 2, 'same': False}, 'OP': 'REPM', 'dst': {'type': 'addresses_UC_ht', 'congruent': 11, 'same': False}}
