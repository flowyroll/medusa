...
push %rdx
push %rsi
lea addresses_normal_ht+0x1a01b, %rax
nop
nop
add %r13, %r13
movw $0x6162, (%rax)
...
nop
add $26510, %rbp
lea addresses_WT_ht+0x1ecab, %rbp
and $16120, %r14
mov (%rbp), %r9
xor $60319, %r13
lea addresses_normal_ht+0xd49b, %r13
nop
nop
nop
and %rdx, %rdx
...
nop
sub %r14, %r14
lea addresses_normal_ht+0x194db, %rsi
lea addresses_WT_ht+0x331b, %rdi
nop
sub %rbp, %rbp
mov $105, %rcx
rep movsb
...
nop
cmp $25272, %rbp
lea addresses_WT_ht+0x10b9b, %rsi
lea addresses_normal_ht+0x12ddb, %rdi
nop
sub %r9, %r9
mov $32, %rcx
rep movsb
...
nop
xor %rdx, %rdx
lea addresses_WT_ht+0x824f, %r13
clflush (%r13)
nop
nop
nop
...
nop
and %rax, %rax
lea addresses_UC_ht+0x1699b, %rax
nop
add $58899, %rdi
mov (%rax), %ebp
nop
...
// REPMOV
lea addresses_normal+0x1019b, %rsi
mov $0x93b, %rdi
cmp $52291, %r10
mov $2, %rcx
rep movsq
...
// Store
lea addresses_normal+0x1dc3b, %rdi
clflush (%rdi)
nop
nop
nop
...
// Faulty Load
lea addresses_normal+0x1019b, %rdi
nop
nop
nop
nop
...
{'OP': 'REPM', 'src': {'type': 'addresses_normal', 'congruent': 0, 'same': True}, 'dst': {'type': 'addresses_P', 'congruent': 4, 'same': False}}
