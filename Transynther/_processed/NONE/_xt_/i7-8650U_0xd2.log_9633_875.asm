...
nop
xor %r15, %r15
lea addresses_normal_ht+0xa27a, %rbx
nop
nop
nop
xor %rbp, %rbp
movb $0x61, (%rbx)
cmp $53303, %rbx
lea addresses_WC_ht+0x118fa, %rcx
clflush (%rcx)
nop
nop
nop
...
nop
add %r15, %r15
lea addresses_D_ht+0x77a, %rsi
lea addresses_WC_ht+0x185fa, %rdi
nop
nop
nop
nop
...
nop
cmp $54057, %r15
lea addresses_A_ht+0x177fa, %rcx
nop
nop
nop
cmp %r9, %r9
...
nop
xor %r9, %r9
lea addresses_normal_ht+0x9ade, %rcx
nop
cmp %rbp, %rbp
movb (%rcx), %r14b
sub $47568, %rcx
lea addresses_D_ht+0xd80a, %rbx
clflush (%rbx)
add %r9, %r9
mov (%rbx), %edi
nop
nop
sub %rsi, %rsi
lea addresses_normal_ht+0x187fa, %rcx
nop
nop
nop
nop
...
nop
xor $37464, %r15
lea addresses_UC_ht+0xed76, %rsi
lea addresses_normal_ht+0x16c8a, %rdi
nop
nop
nop
dec %r9
...
nop
add $32861, %rbx
lea addresses_normal_ht+0x182db, %rsi
lea addresses_normal_ht+0x18c5e, %rdi
nop
nop
nop
nop
...
nop
dec %rbp
lea addresses_WC_ht+0x187fa, %rbx
nop
nop
nop
nop
...
{'OP': 'LOAD', 'src': {'type': 'addresses_normal_ht', 'size': 16, 'AVXalign': False, 'NT': False, 'congruent': 11, 'same': True}}
{'OP': 'REPM', 'src': {'type': 'addresses_UC_ht', 'congruent': 1, 'same': False}, 'dst': {'type': 'addresses_normal_ht', 'congruent': 4, 'same': False}}
{'OP': 'REPM', 'src': {'type': 'addresses_normal_ht', 'congruent': 0, 'same': True}, 'dst': {'type': 'addresses_normal_ht', 'congruent': 2, 'same': False}}
