...
push %rdx
push %rsi
lea addresses_UC_ht+0x9451, %rsi
lea addresses_normal_ht+0xa4e1, %rdi
nop
nop
nop
add $17033, %r11
...
nop
xor $38461, %rbp
lea addresses_WT_ht+0x1b641, %rdx
nop
nop
nop
nop
...
nop
sub $29169, %r11
lea addresses_UC_ht+0x76a1, %r11
cmp $19724, %rcx
mov $0x6162636465666768, %r8
movq %r8, (%r11)
cmp $14737, %rdi
lea addresses_WC_ht+0x2e61, %rdi
nop
nop
nop
nop
...
nop
and $64961, %rbp
lea addresses_normal_ht+0xd8d5, %rdi
nop
nop
nop
nop
...
nop
add $33772, %rcx
lea addresses_WT_ht+0x1cf41, %rsi
nop
nop
nop
nop
...
nop
cmp %r8, %r8
lea addresses_A_ht+0x1c1cd, %rdx
clflush (%rdx)
nop
nop
and %r15, %r15
...
<gen_prepare_buffer>
{'src': {'type': 'addresses_UC_ht', 'congruent': 1, 'same': False}, 'dst': {'type': 'addresses_normal_ht', 'congruent': 6, 'same': False}, 'OP': 'REPM'}
...
{'dst': {'type': 'addresses_WT_ht', 'same': False, 'size': 8, 'congruent': 4, 'NT': True, 'AVXalign': False}, 'OP': 'STOR'}
