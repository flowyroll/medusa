...
push %rdi
push %rsi
lea addresses_WC_ht+0x19d15, %rbp
nop
inc %rax
mov $0x6162636465666768, %r9
movq %r9, (%rbp)
and %rsi, %rsi
lea addresses_WT_ht+0x18cd5, %rdi
nop
nop
cmp %rbp, %rbp
movl $0x61626364, (%rdi)
...
nop
cmp %rbp, %rbp
lea addresses_normal_ht+0x19b15, %rsi
cmp $32842, %rbp
movups (%rsi), %xmm5
vpextrq $0, %xmm5, %rdi
xor %r15, %r15
lea addresses_D_ht+0x1bd38, %rdi
nop
nop
nop
nop
...
nop
dec %r10
lea addresses_normal_ht+0x54bd, %r15
nop
cmp $65362, %r10
movb $0x61, (%r15)
nop
...
{'OP': 'STOR', 'dst': {'type': 'addresses_WT', 'size': 16, 'AVXalign': True, 'NT': False, 'congruent': 7, 'same': False}}
