...
vpextrq $1, %xmm7, %rdi
inc %rdi
lea addresses_UC_ht+0xcb24, %r10
nop
nop
nop
dec %rcx
...
nop
cmp $29567, %rcx
lea addresses_WT_ht+0x141c4, %rdi
add $63030, %r15
movw $0x6162, (%rdi)
nop
add %r10, %r10
lea addresses_D_ht+0x213b, %rdi
clflush (%rdi)
nop
and $49597, %r10
...
nop
dec %rcx
lea addresses_normal_ht+0x2f24, %rsi
nop
add %rax, %rax
movb $0x61, (%rsi)
and %r10, %r10
lea addresses_A_ht+0x8e4, %rdi
nop
nop
sub %rsi, %rsi
mov (%rdi), %r10
sub $49136, %rdi
lea addresses_WT_ht+0x1cb8c, %rsi
lea addresses_WC_ht+0x168d0, %rdi
inc %r10
mov $91, %rcx
rep movsw
nop
...
// REPMOV
lea addresses_WT+0x8fad, %rsi
lea addresses_D+0x3f24, %rdi
clflush (%rsi)
nop
dec %r14
mov $112, %rcx
...
// Store
lea addresses_normal+0xe324, %rdi
clflush (%rdi)
nop
nop
nop
...
// Faulty Load
lea addresses_normal+0xa724, %r15
nop
nop
nop
nop
...
{'src': {'type': 'addresses_WT', 'congruent': 0, 'same': False}, 'OP': 'REPM', 'dst': {'type': 'addresses_D', 'congruent': 10, 'same': False}}
...
{'src': {'type': 'addresses_normal', 'AVXalign': False, 'size': 2, 'NT': False, 'same': True, 'congruent': 0}, 'OP': 'LOAD'}
<gen_prepare_buffer>
{'src': {'type': 'addresses_WC_ht', 'congruent': 0, 'same': True}, 'OP': 'REPM', 'dst': {'type': 'addresses_UC_ht', 'congruent': 5, 'same': False}}
...
{'src': {'type': 'addresses_WT_ht', 'congruent': 3, 'same': False}, 'OP': 'REPM', 'dst': {'type': 'addresses_WC_ht', 'congruent': 2, 'same': True}}
