...
push %rbx
push %rdx
lea addresses_UC_ht+0x7c5b, %rax
nop
and $25356, %r13
...
nop
dec %rdx
lea addresses_normal_ht+0x95d7, %rdx
cmp $11092, %rbx
...
nop
xor $18607, %r10
lea addresses_normal_ht+0x8637, %r10
clflush (%r10)
and $1651, %r14
movl $0x61626364, (%r10)
nop
...
nop
and $32810, %rax
lea addresses_D_ht+0x194f7, %rbp
nop
add $28988, %r10
movb $0x61, (%rbp)
nop
...
// Store
lea addresses_normal+0x102f7, %rbp
nop
nop
nop
nop
...
// Store
lea addresses_normal+0x4703, %rax
clflush (%rax)
nop
nop
nop
