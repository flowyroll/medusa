...
push %rcx
push %rdi
lea addresses_WT_ht+0x8d27, %rdi
nop
nop
nop
nop
...
nop
cmp %r11, %r11
lea addresses_WC_ht+0x1691b, %rcx
nop
nop
nop
dec %rax
...
nop
inc %r11
lea addresses_normal_ht+0x8f1b, %rcx
nop
nop
add %r15, %r15
mov (%rcx), %bp
