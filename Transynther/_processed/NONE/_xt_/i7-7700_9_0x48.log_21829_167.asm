...
push %rdi
push %rsi
lea addresses_WT_ht+0xf00b, %r15
xor $33100, %rdi
mov (%r15), %r14d
nop
nop
...
nop
and %r11, %r11
lea addresses_D_ht+0x784b, %rsi
lea addresses_D_ht+0x1304b, %rdi
nop
nop
nop
nop
...
nop
add $40561, %r12
lea addresses_WT_ht+0x24b, %rsi
lea addresses_A_ht+0x169cb, %rdi
nop
cmp %r15, %r15
mov $52, %rcx
rep movsl
...
nop
sub $42498, %r11
lea addresses_WT_ht+0xf6cb, %r15
nop
nop
add $32627, %rcx
movb $0x61, (%r15)
...
nop
xor %r12, %r12
lea addresses_normal_ht+0x552b, %r12
clflush (%r12)
xor $50089, %rdi
mov (%r12), %r14w
nop
xor %r15, %r15
lea addresses_D_ht+0x1aa4b, %rsi
lea addresses_WC_ht+0x588b, %rdi
xor $886, %r8
mov $16, %rcx
rep movsb
cmp $2732, %r11
lea addresses_D_ht+0x1824b, %rsi
nop
nop
nop
nop
...
nop
xor %rdi, %rdi
lea addresses_WT_ht+0x10ccb, %r14
nop
nop
nop
sub $47142, %r11
...
nop
add %r11, %r11
lea addresses_normal_ht+0x7ff, %rsi
lea addresses_normal_ht+0x1cc4b, %rdi
clflush (%rdi)
nop
nop
nop
...
nop
cmp $5258, %rcx
lea addresses_WT_ht+0x1ba4b, %rsi
lea addresses_WT_ht+0x15ccb, %rdi
nop
nop
nop
cmp $53061, %r11
...
{'OP': 'LOAD', 'src': {'type': 'addresses_A_ht', 'AVXalign': True, 'congruent': 8, 'size': 1, 'same': True, 'NT': False}}
{'OP': 'STOR', 'dst': {'type': 'addresses_WT_ht', 'AVXalign': False, 'congruent': 7, 'size': 1, 'same': False, 'NT': False}}
{'OP': 'LOAD', 'src': {'type': 'addresses_normal_ht', 'AVXalign': True, 'congruent': 5, 'size': 2, 'same': False, 'NT': False}}
{'OP': 'REPM', 'src': {'type': 'addresses_D_ht', 'congruent': 10, 'same': False}, 'dst': {'type': 'addresses_WC_ht', 'congruent': 5, 'same': True}}
{'OP': 'STOR', 'dst': {'type': 'addresses_D_ht', 'AVXalign': False, 'congruent': 11, 'size': 4, 'same': True, 'NT': False}}
