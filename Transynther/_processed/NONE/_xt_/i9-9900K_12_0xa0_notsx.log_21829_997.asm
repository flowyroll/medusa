...
push %rdi
push %rsi
lea addresses_WC_ht+0x83aa, %rdi
nop
nop
nop
nop
...
nop
sub $22470, %r12
lea addresses_normal_ht+0x1beea, %rsi
lea addresses_A_ht+0x3faa, %rdi
nop
nop
nop
nop
...
nop
add %rbp, %rbp
lea addresses_A_ht+0x142aa, %rcx
nop
nop
nop
add $11213, %r8
...
nop
sub $2565, %rsi
lea addresses_WT_ht+0x7bb4, %rsi
lea addresses_normal_ht+0x7aaa, %rdi
nop
nop
nop
cmp %r12, %r12
...
rep movsw
add $1653, %r12
lea addresses_UC_ht+0x6aca, %rcx
nop
and %r12, %r12
...
nop
xor $54904, %r8
lea addresses_UC_ht+0xe2aa, %r11
nop
nop
add %rbp, %rbp
movb $0x61, (%r11)
...
nop
mfence
lea addresses_A_ht+0x12d5a, %rsi
lea addresses_WT_ht+0x9f88, %rdi
inc %r15
mov $38, %rcx
rep movsb
nop
sub %rsi, %rsi
lea addresses_D_ht+0xb9aa, %rsi
and %r12, %r12
movups (%rsi), %xmm1
vpextrq $0, %xmm1, %rdi
nop
...
nop
xor $17431, %rcx
lea addresses_A_ht+0x12342, %rsi
lea addresses_WT_ht+0xf8a, %rdi
clflush (%rsi)
add %r12, %r12
mov $108, %rcx
rep movsw
...
nop
cmp %r8, %r8
lea addresses_D_ht+0x4a3a, %rbp
nop
and $52221, %r11
movw $0x6162, (%rbp)
nop
and %r15, %r15
lea addresses_D_ht+0x10bdd, %r12
nop
nop
nop
nop
...
// Store
lea addresses_normal+0x6aa, %r15
clflush (%r15)
nop
nop
nop
...
// Faulty Load
lea addresses_normal+0x6aa, %rax
nop
nop
nop
inc %r13
...
{'src': {'type': 'addresses_WT_ht', 'congruent': 8, 'same': True}, 'OP': 'REPM', 'dst': {'type': 'addresses_A_ht', 'congruent': 8, 'same': False}}
{'OP': 'STOR', 'dst': {'type': 'addresses_UC_ht', 'AVXalign': False, 'size': 1, 'NT': False, 'same': False, 'congruent': 10}}
{'src': {'type': 'addresses_A_ht', 'congruent': 4, 'same': False}, 'OP': 'REPM', 'dst': {'type': 'addresses_WT_ht', 'congruent': 1, 'same': False}}
...
{'OP': 'STOR', 'dst': {'type': 'addresses_D_ht', 'AVXalign': True, 'size': 2, 'NT': False, 'same': True, 'congruent': 3}}
