...
push %rdi
push %rsi
lea addresses_WC_ht+0x74cb, %rsi
nop
nop
nop
nop
...
nop
cmp %r15, %r15
lea addresses_UC_ht+0x10ecb, %rbp
nop
dec %r9
...
movups %xmm2, (%rbp)
and %rbp, %rbp
lea addresses_normal_ht+0x196a2, %r9
nop
nop
and %rbp, %rbp
mov $0x6162636465666768, %r14
...
nop
sub $39548, %r15
lea addresses_A_ht+0x11ccb, %rsi
lea addresses_WC_ht+0xc6e7, %rdi
lfence
mov $121, %rcx
rep movsw
nop
...
nop
add $42697, %rsi
lea addresses_WC_ht+0x17a0b, %rbp
nop
nop
nop
nop
...
nop
cmp %r14, %r14
lea addresses_A_ht+0x100cb, %rbp
nop
nop
nop
nop
...
nop
dec %r15
lea addresses_WC_ht+0xfecb, %rdi
nop
nop
dec %r15
movl $0x61626364, (%rdi)
...
{'OP': 'LOAD', 'src': {'type': 'addresses_WC_ht', 'size': 4, 'AVXalign': True, 'NT': False, 'congruent': 6, 'same': True}}
