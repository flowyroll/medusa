...
push %rdx
push %rsi
lea addresses_D_ht+0x159c0, %rsi
lea addresses_WC_ht+0xad10, %rdi
clflush (%rsi)
nop
nop
sub $32601, %r8
...
nop
sub $46127, %rsi
lea addresses_normal_ht+0x2f00, %rsi
clflush (%rsi)
nop
nop
nop
...
nop
xor $12929, %r8
lea addresses_WC_ht+0x5e20, %r14
nop
nop
nop
xor $54063, %rdx
...
nop
cmp $61803, %r14
lea addresses_A_ht+0x9300, %rdx
sub $63114, %rax
mov $0x6162636465666768, %r14
movq %r14, (%rdx)
add $29867, %rsi
lea addresses_normal_ht+0xa54, %rsi
lea addresses_A_ht+0x1b20, %rdi
sub $33208, %rdx
mov $89, %rcx
rep movsl
nop
