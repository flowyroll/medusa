...
push %rdx
push %rsi
lea addresses_WC_ht+0x1a1bd, %rsi
lea addresses_A_ht+0x1904c, %rdi
nop
nop
nop
nop
...
nop
inc %rcx
lea addresses_D_ht+0x130c, %rsi
lea addresses_A_ht+0x587d, %rdi
nop
add $18917, %r8
mov $51, %rcx
rep movsl
nop
cmp %rdi, %rdi
lea addresses_UC_ht+0xfdbd, %rsi
lea addresses_D_ht+0x1d5e9, %rdi
nop
nop
nop
nop
...
nop
sub %rcx, %rcx
lea addresses_UC_ht+0x145bd, %rbp
nop
nop
add %rdi, %rdi
mov (%rbp), %r9
...
lea addresses_UC_ht+0x15bbd, %rdi
nop
and $19800, %r8
mov $74, %rcx
rep movsb
...
// Store
lea addresses_normal+0xa5bd, %rsi
nop
nop
dec %r9
...
{'src': {'congruent': 0, 'same': False, 'type': 'addresses_D_ht'}, 'dst': {'congruent': 4, 'same': False, 'type': 'addresses_A_ht'}, 'OP': 'REPM'}
...
{'src': {'congruent': 3, 'same': False, 'type': 'addresses_D_ht'}, 'dst': {'congruent': 8, 'same': False, 'type': 'addresses_UC_ht'}, 'OP': 'REPM'}
