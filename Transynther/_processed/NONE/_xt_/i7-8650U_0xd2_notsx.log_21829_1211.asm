...
push %rdx
push %rsi
lea addresses_WT_ht+0xaa27, %rsi
lea addresses_D_ht+0xdb1, %rdi
cmp $29789, %r8
mov $113, %rcx
rep movsb
nop
...
nop
cmp %r12, %r12
lea addresses_A_ht+0x247, %rsi
lea addresses_UC_ht+0x19e27, %rdi
nop
nop
nop
nop
...
nop
and $18429, %rsi
lea addresses_WC_ht+0xe925, %r8
nop
xor %r13, %r13
mov (%r8), %rdx
nop
xor %rsi, %rsi
lea addresses_UC_ht+0xf3b7, %rsi
lea addresses_normal_ht+0xe247, %rdi
nop
nop
nop
xor $59755, %r12
...
nop
dec %r13
lea addresses_UC_ht+0x367, %rsi
lea addresses_WT_ht+0x11051, %rdi
nop
sub $1935, %rbp
mov $2, %rcx
rep movsb
...
nop
add $9068, %r13
lea addresses_WC_ht+0xe607, %r13
clflush (%r13)
nop
nop
nop
...
nop
dec %rcx
lea addresses_A_ht+0x1af07, %rsi
nop
nop
xor %r12, %r12
movb $0x61, (%rsi)
...
nop
dec %rdi
lea addresses_WT_ht+0x19e47, %r12
nop
nop
xor $43450, %rsi
...
{'OP': 'STOR', 'dst': {'type': 'addresses_A_ht', 'size': 1, 'AVXalign': False, 'NT': True, 'congruent': 5, 'same': True}}
