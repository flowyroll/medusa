...
push %rdi
push %rsi
lea addresses_D_ht+0x10478, %rcx
clflush (%rcx)
nop
nop
nop
...
nop
sub %rcx, %rcx
lea addresses_D_ht+0xc428, %r12
nop
xor %r11, %r11
movb $0x61, (%r12)
nop
add $37259, %r12
lea addresses_D_ht+0x16728, %r8
nop
dec %rcx
mov (%r8), %r12
nop
add $3069, %rcx
lea addresses_WC_ht+0x2968, %rsi
lea addresses_WT_ht+0x8f68, %rdi
clflush (%rdi)
inc %r13
mov $3, %rcx
rep movsb
