...
push %rdi
push %rsi
lea addresses_UC_ht+0x5158, %rsi
lea addresses_D_ht+0x944d, %rdi
clflush (%rdi)
nop
nop
and %rax, %rax
...
nop
add $39474, %rsi
lea addresses_normal_ht+0x1815d, %rsi
...
nop
sub $19829, %r13
lea addresses_WT_ht+0x1bf9f, %r9
nop
nop
nop
nop
...
nop
sub $58975, %r13
lea addresses_UC_ht+0xb7a3, %rsi
...
// REPMOV
lea addresses_UC+0x71b1, %rsi
lea addresses_normal+0x17c4d, %rdi
nop
nop
nop
and $8612, %r15
...
// Faulty Load
lea addresses_normal+0x44d, %rdx
nop
nop
xor $31342, %rdi
vmovups (%rdx), %ymm4
...
{'src': {'type': 'addresses_UC', 'congruent': 0, 'same': False}, 'OP': 'REPM', 'dst': {'type': 'addresses_normal', 'congruent': 10, 'same': False}}
{'OP': 'STOR', 'dst': {'type': 'addresses_WC', 'AVXalign': False, 'size': 16, 'NT': False, 'same': False, 'congruent': 10}}
{'src': {'type': 'addresses_WC', 'congruent': 8, 'same': False}, 'OP': 'REPM', 'dst': {'type': 'addresses_P', 'congruent': 1, 'same': False}}
[Faulty Load]
{'src': {'type': 'addresses_normal', 'AVXalign': False, 'size': 32, 'NT': False, 'same': True, 'congruent': 0}, 'OP': 'LOAD'}
<gen_prepare_buffer>
{'src': {'type': 'addresses_UC_ht', 'congruent': 0, 'same': False}, 'OP': 'REPM', 'dst': {'type': 'addresses_D_ht', 'congruent': 7, 'same': False}}
