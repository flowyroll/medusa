...
movl $0x61626364, (%rdx)
inc %rcx
lea addresses_A_ht+0x1c6de, %r10
xor %rax, %rax
movl $0x61626364, (%r10)
nop
sub $33984, %rax
...
// REPMOV
lea addresses_D+0x1851e, %rsi
lea addresses_WT+0x67c2, %rdi
clflush (%rdi)
cmp %r8, %r8
mov $99, %rcx
rep movsq
...
{'OP': 'REPM', 'src': {'type': 'addresses_D', 'congruent': 2, 'same': False}, 'dst': {'type': 'addresses_WT', 'congruent': 2, 'same': False}}
