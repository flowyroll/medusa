...
push %rdx
push %rsi
lea addresses_UC_ht+0x17d23, %rdi
nop
nop
cmp $36534, %rdx
mov (%rdi), %r13d
nop
cmp $37368, %rdx
lea addresses_WT_ht+0x17e66, %rsi
lea addresses_normal_ht+0x11ad7, %rdi
nop
nop
nop
cmp %rdx, %rdx
...
nop
and %r13, %r13
lea addresses_WT_ht+0x116e3, %rsi
lea addresses_D_ht+0x13f74, %rdi
add $9328, %r14
mov $21, %rcx
rep movsl
nop
nop
xor %r14, %r14
lea addresses_D_ht+0x6313, %rsi
lea addresses_WT_ht+0x19ee3, %rdi
nop
nop
cmp %rdx, %rdx
mov $35, %rcx
...
nop
xor %rsi, %rsi
lea addresses_normal_ht+0x13953, %rcx
nop
nop
nop
nop
