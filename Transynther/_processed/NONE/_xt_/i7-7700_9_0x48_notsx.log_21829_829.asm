...
nop
inc %r12
lea addresses_normal_ht+0x1a0b9, %rdx
nop
nop
nop
nop
...
nop
add %rdx, %rdx
lea addresses_WC_ht+0x1bc1d, %r12
and $57535, %rbx
mov (%r12), %r8d
nop
nop
xor $38920, %r13
lea addresses_WC_ht+0x184fd, %rsi
...
// REPMOV
lea addresses_normal+0x182bd, %rsi
lea addresses_PSE+0x30bd, %rdi
nop
nop
nop
nop
...
// Store
lea addresses_normal+0x7d7d, %rdx
xor %r15, %r15
...
// REPMOV
lea addresses_PSE+0x1ccbd, %rsi
lea addresses_A+0x1aebd, %rdi
nop
nop
nop
nop
...
{'dst': {'same': False, 'congruent': 9, 'type': 'addresses_PSE'}, 'OP': 'REPM', 'src': {'same': False, 'congruent': 9, 'type': 'addresses_normal'}}
{'dst': {'same': False, 'NT': False, 'AVXalign': False, 'size': 8, 'type': 'addresses_normal', 'congruent': 2}, 'OP': 'STOR'}
{'dst': {'same': False, 'NT': False, 'AVXalign': False, 'size': 1, 'type': 'addresses_WT', 'congruent': 4}, 'OP': 'STOR'}
{'dst': {'same': False, 'congruent': 6, 'type': 'addresses_A'}, 'OP': 'REPM', 'src': {'same': False, 'congruent': 9, 'type': 'addresses_PSE'}}
[Faulty Load]
...
{'dst': {'same': False, 'congruent': 10, 'type': 'addresses_WT_ht'}, 'OP': 'REPM', 'src': {'same': False, 'congruent': 4, 'type': 'addresses_WC_ht'}}
{'39': 21829}
