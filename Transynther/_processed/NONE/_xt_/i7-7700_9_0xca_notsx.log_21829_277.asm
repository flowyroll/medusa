...
push %rdx
push %rsi
lea addresses_WT_ht+0x9231, %r14
nop
nop
nop
cmp $52190, %r12
...
nop
and $35239, %rsi
lea addresses_D_ht+0x1243b, %rdx
dec %r14
movb $0x61, (%rdx)
nop
nop
...
nop
sub $59155, %rdi
lea addresses_WT_ht+0x864b, %r11
nop
nop
nop
inc %rdi
...
nop
add $63092, %r14
lea addresses_UC_ht+0x15b3b, %r14
nop
nop
nop
dec %r13
...
nop
xor $34553, %r11
lea addresses_WC_ht+0xb2a8, %rsi
lea addresses_normal_ht+0x5b3b, %rdi
sub %rdx, %rdx
mov $122, %rcx
rep movsw
nop
...
nop
xor $63550, %r12
lea addresses_UC_ht+0xa33b, %r14
nop
nop
nop
and $42736, %r12
...
nop
add %r11, %r11
lea addresses_WC_ht+0xa94f, %rsi
lea addresses_WC_ht+0x473b, %rdi
nop
xor $51701, %rdx
mov $71, %rcx
rep movsl
...
nop
sub %rdx, %rdx
lea addresses_normal_ht+0x31bb, %r13
inc %rdx
movups (%r13), %xmm2
vpextrq $1, %xmm2, %r14
nop
xor $46612, %r11
lea addresses_A_ht+0x401f, %r13
nop
nop
nop
nop
...
movl $0x61626364, (%r13)
xor $9131, %r12
lea addresses_WT_ht+0x16c3b, %rcx
nop
xor %r13, %r13
mov (%rcx), %dx
nop
...
nop
cmp $45711, %rdi
lea addresses_UC_ht+0xceab, %rsi
lea addresses_D_ht+0xab3b, %rdi
nop
nop
nop
nop
...
rep movsl
xor %r11, %r11
lea addresses_WC_ht+0x107e7, %r13
nop
nop
and $60460, %rdx
...
{'src': {'NT': False, 'AVXalign': True, 'size': 32, 'congruent': 11, 'same': False, 'type': 'addresses_UC_ht'}, 'OP': 'LOAD'}
...
{'dst': {'NT': True, 'AVXalign': False, 'size': 32, 'congruent': 2, 'same': False, 'type': 'addresses_WC_ht'}, 'OP': 'STOR'}
