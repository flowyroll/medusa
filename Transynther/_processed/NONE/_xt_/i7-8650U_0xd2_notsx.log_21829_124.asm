...
push %rdx
push %rsi
lea addresses_normal_ht+0x19763, %rax
clflush (%rax)
nop
nop
nop
...
nop
xor $28940, %r8
lea addresses_UC_ht+0xdd03, %rsi
lea addresses_normal_ht+0x9b63, %rdi
clflush (%rsi)
nop
nop
nop
...
rep movsw
add %rsi, %rsi
lea addresses_normal_ht+0x3b63, %rcx
nop
dec %r8
...
nop
add $43044, %rdx
lea addresses_UC_ht+0xa063, %rcx
sub $26154, %rsi
...
nop
xor %rdx, %rdx
lea addresses_normal_ht+0x363, %rsi
lea addresses_normal_ht+0xfa63, %rdi
nop
nop
nop
dec %r8
...
rep movsw
dec %rsi
lea addresses_D_ht+0x1e627, %rdx
nop
nop
nop
nop
...
nop
xor $16467, %rax
lea addresses_WC_ht+0xc363, %rsi
lea addresses_UC_ht+0x86d8, %rdi
clflush (%rdi)
nop
nop
nop
...
nop
add %rdx, %rdx
lea addresses_WC_ht+0x5163, %rsi
nop
nop
nop
nop
...
{'OP': 'REPM', 'src': {'type': 'addresses_normal_ht', 'congruent': 10, 'same': False}, 'dst': {'type': 'addresses_normal_ht', 'congruent': 8, 'same': False}}
