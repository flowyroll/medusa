...
push %rdi
push %rsi
lea addresses_WC_ht+0xe32a, %r15
nop
nop
nop
nop
...
nop
cmp $18028, %rsi
lea addresses_A_ht+0x1b29e, %r13
nop
nop
add %r14, %r14
movl $0x61626364, (%r13)
...
vpextrq $1, %xmm5, %r14
xor $531, %rsi
lea addresses_A_ht+0x1096a, %r15
clflush (%r15)
nop
nop
nop
...
nop
inc %r13
lea addresses_WT_ht+0x577a, %rsi
lea addresses_UC_ht+0x9ea, %rdi
cmp %r13, %r13
mov $1, %rcx
rep movsb
nop
...
nop
add $50176, %r13
lea addresses_WT_ht+0x118ea, %rdi
clflush (%rdi)
nop
nop
nop
...
nop
dec %rax
lea addresses_UC_ht+0xe70b, %rcx
and %rsi, %rsi
...
nop
add %rax, %rax
lea addresses_normal_ht+0x1e926, %rsi
nop
add %r13, %r13
mov (%rsi), %r15
nop
sub %rax, %rax
lea addresses_A_ht+0x300a, %rax
clflush (%rax)
sub $39118, %r11
mov (%rax), %rcx
nop
...
nop
xor %rsi, %rsi
lea addresses_WC_ht+0x103ca, %r15
clflush (%r15)
nop
nop
nop
...
nop
xor %r15, %r15
lea addresses_WT_ht+0x108dd, %rsi
lea addresses_WT_ht+0xcfe, %rdi
nop
nop
and %r15, %r15
mov $5, %rcx
...
{'src': {'congruent': 4, 'same': False, 'type': 'addresses_WT_ht'}, 'dst': {'congruent': 8, 'same': False, 'type': 'addresses_UC_ht'}, 'OP': 'REPM'}
