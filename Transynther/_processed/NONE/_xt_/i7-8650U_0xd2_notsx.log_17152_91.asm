...
nop
dec %rbp
lea addresses_WC_ht+0x15c2f, %r13
nop
nop
nop
nop
...
nop
and $43328, %rbp
lea addresses_normal_ht+0x95fb, %r8
nop
cmp %rdx, %rdx
movb (%r8), %r14b
nop
nop
cmp %rbp, %rbp
lea addresses_normal_ht+0xe0cf, %rdx
nop
nop
nop
and %r9, %r9
...
nop
sub %r15, %r15
lea addresses_UC_ht+0x11bcf, %rsi
lea addresses_normal_ht+0x36c7, %rdi
nop
dec %r14
mov $53, %rcx
rep movsl
...
nop
sub %rdx, %rdx
lea addresses_D_ht+0x19f97, %rbp
nop
nop
sub %r9, %r9
mov (%rbp), %cx
...
nop
dec %r9
lea addresses_normal_ht+0x18ef6, %r15
nop
nop
nop
dec %rdi
...
// Faulty Load
lea addresses_normal+0x184cf, %r8
nop
xor %rbp, %rbp
mov (%r8), %r15
lea oracles, %r10
...
<gen_prepare_buffer>
{'OP': 'STOR', 'dst': {'type': 'addresses_UC_ht', 'size': 1, 'AVXalign': True, 'NT': False, 'congruent': 11, 'same': False}}
