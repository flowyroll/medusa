...
push %rdx
push %rsi
lea addresses_normal_ht+0x1873c, %r8
clflush (%r8)
nop
nop
nop
...
nop
cmp %rcx, %rcx
lea addresses_A_ht+0x12f52, %rbx
nop
nop
nop
nop
...
nop
add %rdx, %rdx
lea addresses_normal_ht+0x11556, %rsi
lea addresses_WT_ht+0xad0c, %rdi
nop
nop
nop
cmp %rdx, %rdx
...
nop
cmp %rbx, %rbx
lea addresses_UC_ht+0x139bc, %r8
and $56505, %rdx
movb $0x61, (%r8)
nop
add %r11, %r11
lea addresses_A_ht+0xcebc, %rsi
lea addresses_WT_ht+0xc9bc, %rdi
nop
nop
add $59755, %rbx
mov $78, %rcx
rep movsw
xor $17074, %rbx
lea addresses_WT_ht+0xd7fc, %rcx
nop
nop
nop
sub $5071, %rdi
...
nop
inc %rsi
lea addresses_A_ht+0x13abc, %rsi
nop
nop
nop
nop
...
nop
add $7691, %rdi
lea addresses_UC_ht+0x47bc, %r10
sub %r8, %r8
mov (%r10), %r11
nop
nop
add $45101, %rdi
lea addresses_normal_ht+0x11fbc, %rdx
nop
nop
add %r8, %r8
movl $0x61626364, (%rdx)
...
{'dst': {'type': 'addresses_D', 'same': False, 'size': 2, 'congruent': 9, 'NT': False, 'AVXalign': True}, 'OP': 'STOR'}
...
{'src': {'type': 'addresses_A_ht', 'congruent': 8, 'same': False}, 'dst': {'type': 'addresses_WT_ht', 'congruent': 4, 'same': True}, 'OP': 'REPM'}
