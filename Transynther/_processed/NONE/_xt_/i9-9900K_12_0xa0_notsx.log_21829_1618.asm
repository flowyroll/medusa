...
push %rdi
push %rsi
lea addresses_normal_ht+0xb7de, %r15
nop
nop
sub %r14, %r14
mov (%r15), %r11
...
nop
cmp $19075, %r10
lea addresses_WC_ht+0x1aab2, %r10
nop
cmp %r13, %r13
movl $0x61626364, (%r10)
nop
...
nop
sub %r13, %r13
lea addresses_D_ht+0xf643, %rsi
lea addresses_WT_ht+0x1bde, %rdi
nop
nop
nop
nop
...
nop
xor $56876, %r10
lea addresses_normal_ht+0x8dde, %r13
nop
dec %rcx
mov $0x6162636465666768, %r11
movq %r11, (%r13)
sub %r15, %r15
lea addresses_D_ht+0x176be, %rsi
lea addresses_WT_ht+0x1bb0a, %rdi
nop
nop
nop
nop
...
nop
cmp %r13, %r13
lea addresses_WT_ht+0x40de, %r13
nop
nop
nop
nop
...
nop
cmp %rcx, %rcx
lea addresses_UC_ht+0xae66, %rcx
nop
nop
nop
inc %r13
...
nop
inc %r11
lea addresses_D_ht+0xce5e, %rsi
lea addresses_A_ht+0xbf40, %rdi
nop
nop
nop
nop
...
nop
and $19332, %r15
lea addresses_WC_ht+0x19de, %r10
nop
nop
nop
nop
...
nop
cmp %rsi, %rsi
lea addresses_normal_ht+0x1d7de, %rsi
clflush (%rsi)
nop
nop
nop
...
// REPMOV
mov $0xfde, %rsi
lea addresses_normal+0x5f1e, %rdi
nop
nop
nop
nop
...
{'src': {'type': 'addresses_P', 'congruent': 8, 'same': False}, 'OP': 'REPM', 'dst': {'type': 'addresses_normal', 'congruent': 5, 'same': False}}
[Faulty Load]
{'src': {'type': 'addresses_WT', 'AVXalign': False, 'size': 1, 'NT': False, 'same': True, 'congruent': 0}, 'OP': 'LOAD'}
<gen_prepare_buffer>
{'src': {'type': 'addresses_normal_ht', 'AVXalign': False, 'size': 8, 'NT': True, 'same': False, 'congruent': 9}, 'OP': 'LOAD'}
...
{'OP': 'STOR', 'dst': {'type': 'addresses_normal_ht', 'AVXalign': False, 'size': 8, 'NT': False, 'same': True, 'congruent': 11}}
...
{'src': {'type': 'addresses_UC_ht', 'AVXalign': True, 'size': 1, 'NT': False, 'same': True, 'congruent': 2}, 'OP': 'LOAD'}
