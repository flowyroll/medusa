...
push %rdi
push %rsi
lea addresses_normal_ht+0x1717c, %r10
nop
nop
nop
nop
...
movb $0x61, (%r10)
cmp $4758, %r13
lea addresses_UC_ht+0x195d5, %rsi
lea addresses_D_ht+0xbcd5, %rdi
nop
nop
nop
nop
...
nop
add $58623, %r13
lea addresses_UC_ht+0x193d5, %rbx
nop
nop
nop
nop
...
nop
xor %r10, %r10
lea addresses_A_ht+0x184c9, %rdi
nop
nop
nop
nop
...
nop
and $64315, %rdi
lea addresses_UC_ht+0x2175, %rdi
nop
nop
nop
nop
...
{'OP': 'LOAD', 'src': {'same': True, 'type': 'addresses_UC_ht', 'NT': False, 'AVXalign': True, 'size': 2, 'congruent': 9}}
