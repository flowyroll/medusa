...
nop
xor %rax, %rax
lea addresses_UC_ht+0xdb45, %rbx
nop
add $56914, %r12
movb $0x61, (%rbx)
nop
...
movb (%rdx), %al
add %rdi, %rdi
lea addresses_D_ht+0xdf65, %rsi
lea addresses_WC_ht+0xfd15, %rdi
nop
nop
and $17392, %rax
mov $56, %rcx
...
nop
add $61348, %rsi
lea addresses_A_ht+0x1bc25, %rsi
lea addresses_D_ht+0xbeaf, %rdi
nop
nop
nop
sub %rbx, %rbx
...
nop
sub %rdx, %rdx
lea addresses_WC_ht+0x4925, %rsi
lea addresses_WC_ht+0x1d3d, %rdi
nop
nop
nop
nop
...
nop
xor %r15, %r15
lea addresses_UC_ht+0x5855, %rsi
...
nop
add %rsi, %rsi
lea addresses_UC_ht+0x2ec5, %rsi
nop
nop
nop
and %rbx, %rbx
...
nop
inc %rax
lea addresses_WT_ht+0x8f25, %rsi
nop
nop
nop
sub $6460, %rbx
mov (%rsi), %edi
and %r15, %r15
lea addresses_WT_ht+0x17431, %r12
nop
nop
cmp $23376, %r15
movups (%r12), %xmm1
...
{'OP': 'STOR', 'dst': {'type': 'addresses_RW', 'size': 2, 'AVXalign': True, 'NT': False, 'congruent': 7, 'same': False}}
[Faulty Load]
...
{'OP': 'STOR', 'dst': {'type': 'addresses_UC_ht', 'size': 1, 'AVXalign': False, 'NT': True, 'congruent': 5, 'same': True}}
...
{'OP': 'LOAD', 'src': {'type': 'addresses_UC_ht', 'size': 1, 'AVXalign': True, 'NT': False, 'congruent': 4, 'same': False}}
