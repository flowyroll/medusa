...
push %rdx
push %rsi
lea addresses_UC_ht+0x1bb87, %r10
nop
xor %r13, %r13
vmovups (%r10), %ymm1
...
nop
sub $2851, %rdi
lea addresses_normal_ht+0x102db, %r12
xor %rdx, %rdx
movb (%r12), %r8b
add %rdx, %rdx
lea addresses_D_ht+0x1d6a7, %rsi
lea addresses_A_ht+0x17213, %rdi
nop
nop
xor %r8, %r8
mov $106, %rcx
...
nop
and %rdi, %rdi
lea addresses_normal_ht+0xb87, %rdx
nop
inc %r10
mov (%rdx), %r13
nop
...
// Store
lea addresses_normal+0xcb87, %rsi
nop
nop
nop
add $64761, %r11
