...
push %rdi
push %rsi
lea addresses_UC_ht+0x3c4b, %rbx
clflush (%rbx)
nop
nop
nop
...
nop
sub $17107, %r10
lea addresses_WT_ht+0xa946, %rsi
lea addresses_D_ht+0x16132, %rdi
nop
nop
nop
and $32431, %r11
...
nop
cmp $26765, %r10
lea addresses_A_ht+0x1cec2, %r14
nop
nop
nop
inc %r11
...
vpextrq $1, %xmm2, %rcx
add $54255, %rcx
lea addresses_D_ht+0x8998, %rsi
lea addresses_normal_ht+0x1e02, %rdi
nop
nop
nop
nop
...
nop
and $33158, %r15
lea addresses_A_ht+0x8eb0, %r10
sub %rdi, %rdi
mov (%r10), %rcx
nop
nop
sub %rbx, %rbx
lea addresses_D_ht+0x1e4c2, %rsi
nop
nop
nop
xor %r15, %r15
...
// REPMOV
lea addresses_D+0x40c2, %rsi
lea addresses_PSE+0xb8c2, %rdi
nop
nop
nop
xor $55878, %rbx
...
{'OP': 'REPM', 'src': {'type': 'addresses_D', 'congruent': 9, 'same': False}, 'dst': {'type': 'addresses_PSE', 'congruent': 9, 'same': False}}
