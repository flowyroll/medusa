...
push %rdx
push %rsi
lea addresses_WC_ht+0x7769, %rdx
nop
nop
nop
nop
...
vpextrq $0, %xmm1, %r12
sub %rsi, %rsi
lea addresses_WC_ht+0x481d, %rsi
lea addresses_D_ht+0x148a1, %rdi
add %r10, %r10
mov $51, %rcx
rep movsq
nop
cmp $47304, %rbp
lea addresses_WC_ht+0x11609, %r12
nop
nop
nop
nop
...
nop
inc %r12
lea addresses_D_ht+0x81f1, %rsi
lea addresses_WT_ht+0x1a4c9, %rdi
clflush (%rdi)
nop
nop
nop
...
nop
cmp %rcx, %rcx
lea addresses_D_ht+0x12629, %rbp
nop
nop
nop
nop
...
nop
inc %r12
lea addresses_normal_ht+0xe3cf, %rdx
nop
nop
nop
nop
...
nop
sub $31779, %rsi
lea addresses_normal_ht+0x15f99, %r12
nop
nop
cmp $6307, %r9
vmovups (%r12), %ymm4
...
nop
and %r12, %r12
lea addresses_WT_ht+0xc1a9, %rdx
nop
nop
cmp $15158, %rsi
movb $0x61, (%rdx)
