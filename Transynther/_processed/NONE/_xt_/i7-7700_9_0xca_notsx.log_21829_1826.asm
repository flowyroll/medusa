...
push %rdi
push %rsi
lea addresses_D_ht+0x134c4, %rax
clflush (%rax)
nop
nop
nop
...
mov (%rax), %r11d
and $8592, %r10
lea addresses_UC_ht+0x1bec4, %rcx
nop
nop
nop
xor $47987, %r14
...
nop
cmp %r11, %r11
lea addresses_normal_ht+0x1d6b4, %rsi
...
nop
xor $32037, %r11
lea addresses_normal_ht+0x9704, %r11
nop
add %r10, %r10
movups (%r11), %xmm7
vpextrq $1, %xmm7, %rbp
...
nop
and %rsi, %rsi
lea addresses_normal_ht+0x13b6c, %r11
nop
nop
and $29491, %rdi
vmovups (%r11), %ymm3
...
nop
cmp $52150, %rdi
lea addresses_D_ht+0x1a444, %r11
nop
nop
nop
nop
...
nop
and %rax, %rax
lea addresses_WT_ht+0x1bc30, %rdi
nop
nop
nop
nop
...
{'src': {'congruent': 4, 'same': False, 'type': 'addresses_normal_ht'}, 'dst': {'congruent': 2, 'same': False, 'type': 'addresses_UC_ht'}, 'OP': 'REPM'}
