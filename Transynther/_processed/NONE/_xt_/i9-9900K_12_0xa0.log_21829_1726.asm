...
push %rdi
push %rsi
lea addresses_WT_ht+0x5820, %r13
nop
nop
nop
cmp $7440, %r15
...
vpextrq $1, %xmm2, %r11
add %r9, %r9
lea addresses_normal_ht+0x7900, %r11
nop
sub $18762, %r9
vmovups (%r11), %ymm2
...
nop
mfence
lea addresses_D_ht+0x3924, %rsi
lea addresses_UC_ht+0x8c90, %rdi
clflush (%rdi)
inc %r11
mov $96, %rcx
rep movsb
nop
add %r15, %r15
lea addresses_normal_ht+0x19fe0, %rsi
lea addresses_A_ht+0x19420, %rdi
nop
nop
inc %rax
mov $26, %rcx
...
nop
add $44859, %r9
lea addresses_A_ht+0x11a00, %r13
nop
nop
nop
nop
...
nop
sub %rax, %rax
lea addresses_A_ht+0xa750, %rsi
lea addresses_normal_ht+0x169e0, %rdi
nop
nop
nop
nop
...
nop
sub %r13, %r13
lea addresses_UC_ht+0x13820, %rsi
lea addresses_WT_ht+0x9fa0, %rdi
nop
nop
nop
nop
...
{'src': {'same': False, 'congruent': 6, 'type': 'addresses_normal_ht'}, 'OP': 'REPM', 'dst': {'same': False, 'congruent': 10, 'type': 'addresses_A_ht'}}
...
{'src': {'same': False, 'congruent': 4, 'type': 'addresses_A_ht'}, 'OP': 'REPM', 'dst': {'same': True, 'congruent': 6, 'type': 'addresses_normal_ht'}}
