...
push %rdi
push %rsi
lea addresses_WT_ht+0x9ff1, %rsi
...
rep movsw
xor $20708, %r8
lea addresses_UC_ht+0x3931, %rsi
nop
nop
nop
xor %rbx, %rbx
...
nop
xor %rcx, %rcx
lea addresses_WT_ht+0x14311, %rax
dec %rbx
...
nop
dec %rcx
lea addresses_normal_ht+0x29dd, %r8
clflush (%r8)
nop
nop
nop
...
nop
inc %rdi
lea addresses_D_ht+0x19bd1, %rbx
inc %rsi
...
// Faulty Load
lea addresses_normal+0x11b1, %rax
nop
nop
xor %r14, %r14
movb (%rax), %r12b
...
{'OP': 'LOAD', 'src': {'type': 'addresses_RW', 'size': 32, 'AVXalign': False, 'NT': False, 'congruent': 9, 'same': False}}
[Faulty Load]
...
{'OP': 'LOAD', 'src': {'type': 'addresses_D_ht', 'size': 16, 'AVXalign': True, 'NT': False, 'congruent': 3, 'same': False}}
{'34': 8007}
