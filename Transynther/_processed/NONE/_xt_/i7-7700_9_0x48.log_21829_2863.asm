...
push %rdx
push %rsi
lea addresses_A_ht+0x14b4a, %rsi
lea addresses_D_ht+0xe7ba, %rdi
nop
nop
xor $15015, %r10
mov $94, %rcx
...
nop
and $31952, %r10
lea addresses_UC_ht+0x1c8f2, %rsi
lea addresses_D_ht+0x15122, %rdi
sub %rbx, %rbx
mov $84, %rcx
rep movsq
nop
lfence
lea addresses_normal_ht+0x162d5, %rsi
lea addresses_normal_ht+0x1122, %rdi
clflush (%rdi)
nop
nop
nop
...
nop
cmp $65284, %r10
lea addresses_normal_ht+0x4162, %rcx
nop
nop
add $35691, %rdx
movb (%rcx), %r14b
...
nop
cmp $40964, %rdi
lea addresses_WT_ht+0x2972, %r10
dec %rcx
vmovups (%r10), %ymm0
...
nop
and %rsi, %rsi
lea addresses_D_ht+0x1bc72, %rdi
nop
nop
nop
nop
...
nop
dec %rdi
lea addresses_WT_ht+0xf242, %r10
add %rdx, %rdx
...
nop
dec %rsi
lea addresses_normal_ht+0x1c172, %rbx
nop
nop
nop
nop
...
nop
add $25362, %r14
lea addresses_D_ht+0x15d72, %rsi
lea addresses_WT_ht+0x12796, %rdi
nop
nop
nop
xor $36509, %r9
...
rep movsl
xor %r14, %r14
lea addresses_WC_ht+0x14022, %rdi
nop
nop
nop
nop
...
// Faulty Load
lea addresses_normal+0x1fd72, %rsi
nop
nop
nop
xor %r15, %r15
...
{'OP': 'REPM', 'src': {'type': 'addresses_D_ht', 'congruent': 11, 'same': False}, 'dst': {'type': 'addresses_WT_ht', 'congruent': 2, 'same': False}}
