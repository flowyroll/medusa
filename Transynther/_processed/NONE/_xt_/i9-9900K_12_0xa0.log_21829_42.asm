...
push %rdi
push %rsi
lea addresses_WC_ht+0x508f, %rbp
xor %r10, %r10
mov (%rbp), %r12d
nop
nop
...
nop
sub %rdi, %rdi
lea addresses_D_ht+0x1be0f, %r11
nop
nop
nop
xor %rbx, %rbx
...
nop
xor %rbp, %rbp
lea addresses_D_ht+0x1e32f, %r12
nop
nop
nop
nop
...
movq %rbp, (%r12)
cmp $37748, %r9
lea addresses_WC_ht+0x1da7c, %rsi
...
nop
xor $31258, %rbx
lea addresses_D_ht+0x1334b, %rsi
lea addresses_WT_ht+0x1608f, %rdi
and $2791, %rbx
mov $57, %rcx
rep movsw
nop
...
nop
cmp $20197, %r11
lea addresses_A_ht+0x18c8f, %rbp
and %r11, %r11
...
// Faulty Load
lea addresses_normal+0x14c8f, %rcx
nop
nop
sub %rax, %rax
mov (%rcx), %r8w
...
{'OP': 'STOR', 'dst': {'NT': True, 'same': True, 'congruent': 9, 'type': 'addresses_A_ht', 'AVXalign': False, 'size': 16}}
{'34': 21829}
