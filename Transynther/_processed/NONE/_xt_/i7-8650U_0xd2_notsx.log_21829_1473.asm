...
push %rdi
push %rsi
lea addresses_normal_ht+0x18f7b, %rsi
nop
nop
nop
cmp %r14, %r14
...
nop
cmp $47420, %rbx
lea addresses_WC_ht+0x7d03, %rbp
sub %rcx, %rcx
vmovups (%rbp), %ymm7
...
nop
xor $12082, %rsi
lea addresses_D_ht+0x14903, %rsi
lea addresses_A_ht+0xe683, %rdi
nop
cmp $12368, %rax
mov $100, %rcx
rep movsw
...
nop
cmp $13632, %rcx
lea addresses_UC_ht+0x1703, %rsi
lea addresses_D_ht+0x76c3, %rdi
clflush (%rdi)
nop
nop
nop
...
nop
sub %rsi, %rsi
lea addresses_normal_ht+0x1c6f5, %rbp
clflush (%rbp)
cmp $4032, %rax
movups (%rbp), %xmm4
vpextrq $0, %xmm4, %rdi
...
nop
and $60511, %rbx
lea addresses_UC_ht+0x9303, %r14
nop
nop
nop
nop
...
nop
xor $41189, %r14
lea addresses_normal_ht+0x14903, %rsi
lea addresses_normal_ht+0x193eb, %rdi
nop
nop
nop
nop
...
nop
add $12547, %rsi
lea addresses_normal_ht+0x12903, %rbp
nop
nop
nop
inc %rcx
...
nop
and %rsi, %rsi
lea addresses_A_ht+0x14903, %rsi
lea addresses_A_ht+0x11f03, %rdi
nop
nop
nop
nop
...
rep movsw
add $59826, %rcx
lea addresses_WC_ht+0x1db63, %rsi
nop
nop
nop
nop
...
nop
sub $13644, %rax
lea addresses_UC_ht+0x1bc83, %rsi
and %rbp, %rbp
...
// Faulty Load
lea addresses_normal+0x13103, %rsi
nop
nop
and $2266, %r15
mov (%rsi), %r11
...
{'OP': 'REPM', 'src': {'type': 'addresses_UC_ht', 'congruent': 9, 'same': True}, 'dst': {'type': 'addresses_D_ht', 'congruent': 6, 'same': False}}
...
{'OP': 'LOAD', 'src': {'type': 'addresses_D_ht', 'size': 2, 'AVXalign': False, 'NT': True, 'congruent': 5, 'same': False}}
