...
nop
xor %r8, %r8
lea addresses_WC_ht+0x8491, %rsi
lea addresses_UC_ht+0x691, %rdi
nop
nop
inc %r13
mov $127, %rcx
...
nop
inc %r13
lea addresses_normal_ht+0xd5a9, %rsi
lea addresses_WT_ht+0x1b91, %rdi
inc %r10
mov $77, %rcx
rep movsq
nop
...
// Store
lea addresses_normal+0x7691, %r13
nop
nop
nop
and %r9, %r9
