...
push %rdx
push %rsi
lea addresses_normal_ht+0x1a5ae, %rsi
lea addresses_D_ht+0x1c8ae, %rdi
nop
cmp %rdx, %rdx
mov $16, %rcx
rep movsb
and $30209, %rdx
lea addresses_WC_ht+0x882, %rbp
xor $64864, %r11
mov $0x6162636465666768, %rax
movq %rax, (%rbp)
dec %rcx
lea addresses_A_ht+0x10d0a, %rbp
nop
nop
nop
nop
...
nop
and %rax, %rax
lea addresses_WC_ht+0x1702e, %rax
clflush (%rax)
nop
nop
nop
...
<gen_prepare_buffer>
{'dst': {'same': False, 'congruent': 8, 'type': 'addresses_D_ht'}, 'OP': 'REPM', 'src': {'same': False, 'congruent': 8, 'type': 'addresses_normal_ht'}}
