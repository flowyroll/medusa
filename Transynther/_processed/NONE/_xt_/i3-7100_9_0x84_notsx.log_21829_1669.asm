...
push %rdi
push %rsi
lea addresses_WT_ht+0x1eda7, %r14
nop
nop
nop
cmp %rdi, %rdi
mov (%r14), %r13
sub %rbp, %rbp
lea addresses_UC_ht+0x1bba7, %r13
nop
nop
nop
nop
...
nop
xor %r13, %r13
lea addresses_normal_ht+0x34a7, %r13
nop
nop
sub %r10, %r10
movb $0x61, (%r13)
...
nop
dec %rbp
lea addresses_WC_ht+0x16ba7, %rdi
nop
nop
nop
xor $14634, %r9
...
lea addresses_A_ht+0x12593, %rdi
nop
nop
nop
nop
...
{'dst': {'type': 'addresses_A', 'same': False, 'size': 8, 'congruent': 6, 'NT': False, 'AVXalign': True}, 'OP': 'STOR'}
...
{'src': {'type': 'addresses_UC_ht', 'same': False, 'size': 2, 'congruent': 11, 'NT': False, 'AVXalign': True}, 'OP': 'LOAD'}
