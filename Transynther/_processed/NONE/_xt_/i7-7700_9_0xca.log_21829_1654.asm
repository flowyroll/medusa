...
push %rdi
push %rsi
lea addresses_A_ht+0x2953, %rcx
dec %r8
mov $0x6162636465666768, %rsi
movq %rsi, (%rcx)
mfence
lea addresses_A_ht+0x12083, %rsi
...
// Store
lea addresses_normal+0x176c2, %r15
clflush (%r15)
cmp $64608, %rax
movw $0x5152, (%r15)
nop
...
{'src': {'congruent': 3, 'AVXalign': False, 'same': False, 'size': 1, 'NT': False, 'type': 'addresses_US'}, 'OP': 'LOAD'}
{'OP': 'STOR', 'dst': {'congruent': 0, 'AVXalign': False, 'same': False, 'size': 2, 'NT': False, 'type': 'addresses_normal'}}
{'OP': 'STOR', 'dst': {'congruent': 4, 'AVXalign': True, 'same': False, 'size': 2, 'NT': False, 'type': 'addresses_WT'}}
...
{'src': {'congruent': 4, 'same': False, 'type': 'addresses_A_ht'}, 'OP': 'REPM', 'dst': {'congruent': 8, 'same': False, 'type': 'addresses_A_ht'}}
{'33': 21829}
