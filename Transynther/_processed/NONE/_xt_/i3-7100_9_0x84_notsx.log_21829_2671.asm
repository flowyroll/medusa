...
push %rdx
push %rsi
lea addresses_D_ht+0xb7c3, %rsi
lea addresses_A_ht+0x5c3, %rdi
nop
nop
nop
cmp %rdx, %rdx
...
nop
sub $53877, %r10
lea addresses_A_ht+0x1dfc3, %rax
xor $28307, %rbp
movl $0x61626364, (%rax)
nop
nop
nop
dec %rdi
lea addresses_UC_ht+0xafc3, %rsi
lea addresses_A_ht+0xaa43, %rdi
nop
nop
nop
nop
...
nop
xor %rdi, %rdi
lea addresses_A_ht+0x1aec3, %r10
nop
inc %rcx
...
nop
sub $42723, %rdi
lea addresses_A_ht+0x121c3, %rsi
nop
nop
nop
xor %rdx, %rdx
...
nop
xor $410, %r8
lea addresses_D_ht+0x14cc3, %r10
nop
nop
nop
sub $39650, %r8
...
nop
sub $57924, %rdx
lea addresses_D_ht+0x103eb, %rsi
...
nop
sub %rbp, %rbp
lea addresses_WT_ht+0x9003, %rdx
clflush (%rdx)
and $512, %rbp
...
nop
and %rbp, %rbp
lea addresses_WC_ht+0x1c9af, %rdx
clflush (%rdx)
nop
nop
nop
...
vpextrq $0, %xmm4, %rcx
cmp $26052, %rbp
lea addresses_UC_ht+0x127c3, %rdi
nop
nop
nop
cmp %rbp, %rbp
...
nop
inc %rax
lea addresses_WC_ht+0x97c3, %rsi
lea addresses_normal_ht+0x155c3, %rdi
nop
nop
nop
nop
...
{'src': {'type': 'addresses_D', 'same': False, 'size': 4, 'congruent': 5, 'NT': False, 'AVXalign': False}, 'OP': 'LOAD'}
...
{'src': {'type': 'addresses_UC_ht', 'congruent': 11, 'same': False}, 'dst': {'type': 'addresses_A_ht', 'congruent': 7, 'same': False}, 'OP': 'REPM'}
...
{'src': {'type': 'addresses_D_ht', 'congruent': 3, 'same': False}, 'dst': {'type': 'addresses_UC_ht', 'congruent': 9, 'same': False}, 'OP': 'REPM'}
