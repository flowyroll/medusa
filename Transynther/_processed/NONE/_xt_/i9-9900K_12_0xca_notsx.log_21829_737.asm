...
push %rdi
push %rsi
lea addresses_normal_ht+0xc43b, %rsi
lea addresses_normal_ht+0x136db, %rdi
nop
nop
cmp $16648, %rax
mov $61, %rcx
...
nop
xor %r14, %r14
lea addresses_WT_ht+0x17d4b, %rax
nop
nop
dec %r14
movb $0x61, (%rax)
...
nop
add %rcx, %rcx
lea addresses_normal_ht+0x83bb, %rsi
lea addresses_A_ht+0xacfb, %rdi
nop
sub $29634, %r13
mov $46, %rcx
rep movsl
nop
xor %rsi, %rsi
lea addresses_A_ht+0x11b87, %rsi
lea addresses_UC_ht+0x853b, %rdi
nop
nop
nop
add %r11, %r11
...
rep movsw
cmp %rcx, %rcx
lea addresses_normal_ht+0x14c83, %r11
cmp $47046, %rax
movl $0x61626364, (%r11)
nop
nop
cmp %rsi, %rsi
lea addresses_normal_ht+0x1dbbb, %rdi
and $9271, %r14
movb $0x61, (%rdi)
nop
nop
...
nop
cmp %rax, %rax
lea addresses_D_ht+0x15d9f, %r13
nop
cmp $15935, %rax
movl $0x61626364, (%r13)
nop
xor $14940, %rax
lea addresses_WT_ht+0x16bb, %rsi
nop
nop
nop
nop
...
nop
add %rdi, %rdi
lea addresses_A_ht+0x18ab3, %rcx
nop
nop
nop
nop
...
{'OP': 'REPM', 'src': {'same': False, 'congruent': 0, 'type': 'addresses_A_ht'}, 'dst': {'same': False, 'congruent': 7, 'type': 'addresses_UC_ht'}}
