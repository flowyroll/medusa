...
rep movsw
add $203, %r14
lea addresses_normal_ht+0x16f68, %rdx
clflush (%rdx)
nop
nop
nop
...
nop
sub %rdx, %rdx
lea addresses_WT_ht+0x1b838, %rsi
lea addresses_WT_ht+0xb438, %rdi
nop
nop
nop
sub %rax, %rax
...
nop
add %r11, %r11
lea addresses_UC_ht+0x15838, %rsi
lea addresses_A_ht+0x13a38, %rdi
nop
cmp $19826, %r12
mov $63, %rcx
rep movsq
...
nop
cmp %rsi, %rsi
lea addresses_A_ht+0x10208, %rax
nop
cmp %rsi, %rsi
movb $0x61, (%rax)
dec %rdi
lea addresses_WT_ht+0x164d8, %r12
nop
nop
nop
nop
...
nop
xor $40723, %rax
lea addresses_WT_ht+0x6038, %rsi
lea addresses_WT_ht+0x4ef4, %rdi
nop
nop
nop
nop
...
nop
cmp %r14, %r14
lea addresses_WC_ht+0x72d6, %rcx
clflush (%rcx)
nop
nop
nop
...
nop
sub $8562, %r14
lea addresses_UC_ht+0xee78, %r11
clflush (%r11)
cmp %r14, %r14
mov (%r11), %ecx
nop
nop
and $16690, %rcx
lea addresses_WT_ht+0x6ce4, %r11
nop
nop
nop
nop
...
nop
add $24716, %rax
lea addresses_WC_ht+0x19438, %rsi
clflush (%rsi)
nop
nop
nop
...
nop
add $8708, %rsi
lea addresses_WT_ht+0x17a30, %rsi
lea addresses_UC_ht+0x98c8, %rdi
nop
nop
sub $11467, %rax
mov $56, %rcx
...
nop
and $6538, %r12
lea addresses_normal_ht+0xadf8, %rsi
lea addresses_D_ht+0x113b3, %rdi
clflush (%rdi)
nop
and %r11, %r11
mov $16, %rcx
...
// Faulty Load
lea addresses_normal+0x1dc38, %r12
nop
nop
nop
cmp $28927, %r10
...
{'OP': 'STOR', 'dst': {'type': 'addresses_WC_ht', 'AVXalign': False, 'congruent': 11, 'size': 16, 'same': False, 'NT': True}}
{'OP': 'REPM', 'src': {'type': 'addresses_WT_ht', 'congruent': 1, 'same': True}, 'dst': {'type': 'addresses_UC_ht', 'congruent': 3, 'same': False}}
