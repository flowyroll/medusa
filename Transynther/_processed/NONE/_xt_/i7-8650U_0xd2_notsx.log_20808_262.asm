...
movq %r14, (%r9)
and $38369, %r9
lea addresses_A_ht+0x11372, %r11
xor $36637, %r14
movups (%r11), %xmm1
vpextrq $1, %xmm1, %rsi
nop
...
movl $0x61626364, (%r11)
cmp $2864, %r15
lea addresses_D_ht+0x13428, %rsi
lea addresses_normal_ht+0xab72, %rdi
inc %r15
mov $23, %rcx
rep movsw
nop
nop
add $63054, %rsi
lea addresses_WT_ht+0x94b2, %r15
clflush (%r15)
xor %rsi, %rsi
mov (%r15), %r14
nop
...
nop
add $60900, %r14
lea addresses_A_ht+0x14922, %rcx
nop
add $33860, %rbp
mov (%rcx), %r15d
and $57360, %rdi
lea addresses_WC_ht+0x7558, %rsi
nop
nop
nop
nop
...
nop
dec %rcx
lea addresses_UC_ht+0x9952, %r15
nop
nop
nop
nop
...
nop
cmp $6345, %r15
lea addresses_normal_ht+0x9972, %rsi
clflush (%rsi)
dec %r11
vmovups (%rsi), %ymm3
...
nop
xor $16859, %r15
lea addresses_D_ht+0x15772, %r11
nop
and $42474, %r14
...
// REPMOV
lea addresses_PSE+0x185ea, %rsi
lea addresses_normal+0x469e, %rdi
nop
nop
nop
nop
...
// REPMOV
lea addresses_D+0xf072, %rsi
lea addresses_A+0x116ca, %rdi
cmp %rax, %rax
mov $55, %rcx
rep movsq
nop
...
{'OP': 'REPM', 'src': {'type': 'addresses_PSE', 'congruent': 2, 'same': False}, 'dst': {'type': 'addresses_normal', 'congruent': 1, 'same': False}}
{'OP': 'REPM', 'src': {'type': 'addresses_D', 'congruent': 8, 'same': False}, 'dst': {'type': 'addresses_A', 'congruent': 0, 'same': False}}
[Faulty Load]
