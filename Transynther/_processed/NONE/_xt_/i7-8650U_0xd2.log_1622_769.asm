...
push %rdi
push %rsi
lea addresses_A_ht+0x1c080, %rsi
lea addresses_normal_ht+0x9b80, %rdi
nop
nop
nop
nop
...
lea addresses_normal_ht+0x11080, %rdi
nop
nop
nop
nop
...
nop
sub %rsi, %rsi
lea addresses_WC_ht+0x488c, %rbx
nop
nop
nop
cmp %rbp, %rbp
...
nop
add %rbp, %rbp
lea addresses_UC_ht+0x7080, %rbx
xor $14966, %rsi
vmovups (%rbx), %ymm6
...
nop
add %rdi, %rdi
lea addresses_WC_ht+0x13880, %rcx
nop
nop
nop
add $7678, %r12
...
nop
xor %rcx, %rcx
lea addresses_WC_ht+0xad20, %rcx
nop
nop
add $65432, %rbx
mov (%rcx), %rdi
...
{'OP': 'LOAD', 'src': {'type': 'addresses_NC', 'size': 8, 'AVXalign': True, 'NT': False, 'congruent': 9, 'same': False}}
[Faulty Load]
...
{'OP': 'LOAD', 'src': {'type': 'addresses_UC_ht', 'size': 32, 'AVXalign': False, 'NT': False, 'congruent': 10, 'same': True}}
