...
lea addresses_D_ht+0x1098e, %rdi
nop
nop
add %r9, %r9
mov $81, %rcx
...
nop
xor %r15, %r15
lea addresses_WT_ht+0x14ec8, %r15
nop
nop
nop
nop
...
nop
and $26356, %r15
lea addresses_normal_ht+0x15878, %r13
clflush (%r13)
nop
nop
nop
...
nop
sub %rdi, %rdi
lea addresses_UC_ht+0xf350, %rsi
lea addresses_normal_ht+0x18848, %rdi
nop
cmp $48999, %rbp
mov $63, %rcx
rep movsq
nop
dec %rcx
lea addresses_UC_ht+0x10248, %rbp
nop
nop
nop
nop
...
mov (%rbp), %ecx
and $25955, %r13
lea addresses_WT_ht+0x7548, %rsi
lea addresses_UC_ht+0x5a48, %rdi
nop
nop
nop
nop
...
nop
add $30658, %rax
lea addresses_WT_ht+0x5ec8, %rbp
nop
nop
nop
nop
...
nop
sub %rax, %rax
lea addresses_A_ht+0x1b248, %rcx
nop
nop
nop
nop
...
nop
add $11375, %rbp
lea addresses_UC_ht+0x1ddc4, %rsi
lea addresses_WC_ht+0x1b928, %rdi
and $55603, %r13
mov $77, %rcx
rep movsw
nop
cmp %rcx, %rcx
lea addresses_WC_ht+0x1b548, %rsi
...
rep movsw
lfence
lea addresses_UC_ht+0x5e48, %r15
nop
cmp %rax, %rax
...
nop
and $11657, %r15
lea addresses_UC_ht+0x2968, %rbp
clflush (%rbp)
cmp %rax, %rax
...
nop
cmp $5511, %rcx
lea addresses_UC_ht+0x15688, %r13
nop
nop
nop
nop
...
nop
dec %rcx
lea addresses_WC_ht+0x1e348, %r13
nop
nop
nop
nop
...
<gen_prepare_buffer>
{'OP': 'REPM', 'src': {'same': False, 'congruent': 6, 'type': 'addresses_WT_ht'}, 'dst': {'same': False, 'congruent': 1, 'type': 'addresses_D_ht'}}
...
{'OP': 'REPM', 'src': {'same': False, 'congruent': 3, 'type': 'addresses_UC_ht'}, 'dst': {'same': False, 'congruent': 8, 'type': 'addresses_normal_ht'}}
...
{'OP': 'REPM', 'src': {'same': False, 'congruent': 1, 'type': 'addresses_UC_ht'}, 'dst': {'same': False, 'congruent': 3, 'type': 'addresses_WC_ht'}}
