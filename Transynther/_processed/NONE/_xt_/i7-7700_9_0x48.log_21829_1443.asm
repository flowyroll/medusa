...
lea addresses_WC_ht+0x10b50, %rdi
nop
nop
inc %rbx
mov $125, %rcx
...
lea addresses_A_ht+0x15350, %rdi
add $45618, %r8
mov $61, %rcx
rep movsb
add %rdi, %rdi
lea addresses_D_ht+0x1b2de, %rsi
lea addresses_UC_ht+0x17fc0, %rdi
nop
dec %r11
mov $121, %rcx
rep movsq
...
// Faulty Load
lea addresses_normal+0xbb50, %rdi
sub $30138, %r13
movups (%rdi), %xmm1
vpextrq $0, %xmm1, %r14
lea oracles, %rdx
