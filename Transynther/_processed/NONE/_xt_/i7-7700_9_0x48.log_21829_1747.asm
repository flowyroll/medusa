...
lea addresses_UC_ht+0xcfee, %rdi
nop
nop
cmp %r15, %r15
mov $55, %rcx
...
nop
and %rsi, %rsi
lea addresses_WT_ht+0xfbee, %r11
nop
nop
and $29958, %r10
movw $0x6162, (%r11)
...
nop
xor $28327, %r15
lea addresses_WC_ht+0x13bee, %rsi
...
lea addresses_WT_ht+0xc6ee, %rdi
and $39227, %r12
mov $85, %rcx
rep movsw
nop
and $51302, %r10
lea addresses_WC_ht+0x10a0e, %rsi
lea addresses_WC_ht+0x44ee, %rdi
nop
nop
nop
nop
...
nop
sub $3164, %r11
lea addresses_normal_ht+0x18d0e, %rsi
nop
nop
nop
nop
...
nop
add $4881, %rbx
lea addresses_WC_ht+0xcdee, %rsi
lea addresses_D_ht+0x176ee, %rdi
nop
cmp $58279, %r12
mov $99, %rcx
rep movsq
...
nop
xor %rdi, %rdi
lea addresses_UC_ht+0x8eee, %rsi
lea addresses_UC_ht+0x580e, %rdi
nop
nop
nop
nop
...
nop
cmp %rcx, %rcx
lea addresses_A_ht+0x1150e, %r12
nop
nop
nop
add $59922, %rdi
...
nop
sub %rcx, %rcx
lea addresses_A_ht+0x154ee, %rsi
nop
nop
nop
nop
...
// Store
lea addresses_normal+0x1a8ee, %rsi
add $48196, %r8
movl $0x51525354, (%rsi)
nop
nop
...
// Faulty Load
lea addresses_normal+0x10eee, %r10
nop
cmp %rsi, %rsi
mov (%r10), %r8d
lea oracles, %r11
...
{'OP': 'LOAD', 'src': {'type': 'addresses_US', 'AVXalign': False, 'congruent': 6, 'size': 8, 'same': False, 'NT': False}}
...
{'OP': 'REPM', 'src': {'type': 'addresses_WC_ht', 'congruent': 3, 'same': True}, 'dst': {'type': 'addresses_WC_ht', 'congruent': 9, 'same': False}}
...
{'OP': 'REPM', 'src': {'type': 'addresses_UC_ht', 'congruent': 10, 'same': False}, 'dst': {'type': 'addresses_UC_ht', 'congruent': 5, 'same': True}}
{'OP': 'LOAD', 'src': {'type': 'addresses_A_ht', 'AVXalign': False, 'congruent': 6, 'size': 32, 'same': True, 'NT': False}}
{'OP': 'LOAD', 'src': {'type': 'addresses_A_ht', 'AVXalign': True, 'congruent': 2, 'size': 16, 'same': False, 'NT': False}}
