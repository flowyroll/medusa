...
// Store
lea addresses_WT+0x8de8, %r14
xor %r8, %r8
movl $0x51525354, (%r14)
sub $38119, %r8

// Store
lea addresses_D+0x16541, %r11
nop
nop
nop
inc %rbx
...
{'OP': 'STOR', 'dst': {'type': 'addresses_D', 'AVXalign': True, 'size': 8, 'NT': False, 'same': False, 'congruent': 11}}
{'OP': 'STOR', 'dst': {'type': 'addresses_UC', 'AVXalign': False, 'size': 4, 'NT': False, 'same': False, 'congruent': 5}}
{'OP': 'STOR', 'dst': {'type': 'addresses_WT', 'AVXalign': False, 'size': 4, 'NT': True, 'same': False, 'congruent': 2}}
