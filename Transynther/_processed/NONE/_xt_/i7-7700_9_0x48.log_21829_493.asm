...
lea addresses_WC_ht+0x9547, %rdi
nop
nop
lfence
mov $69, %rcx
...
nop
sub %rdi, %rdi
lea addresses_D_ht+0x19947, %rsi
lea addresses_UC_ht+0x189e7, %rdi
nop
nop
nop
inc %rax
...
nop
inc %r8
lea addresses_UC_ht+0x10b43, %r12
clflush (%r12)
nop
inc %r15
...
nop
lfence
lea addresses_normal_ht+0x1c547, %rsi
...
nop
and $19407, %rax
lea addresses_WT_ht+0x12547, %r13
nop
lfence
mov $0x6162636465666768, %rsi
movq %rsi, (%r13)
...
lea addresses_WC_ht+0x11547, %rdi
nop
add %rax, %rax
mov $28, %rcx
rep movsw
nop
add %r12, %r12
lea addresses_normal_ht+0x8e2f, %rsi
lea addresses_A_ht+0x1b86d, %rdi
nop
sub $9055, %rax
mov $72, %rcx
rep movsb
nop
add $47521, %rax
lea addresses_UC_ht+0x72c3, %rsi
...
nop
add $45833, %r8
lea addresses_normal_ht+0x18147, %rsi
lea addresses_WT_ht+0x200f, %rdi
sub $2016, %r12
mov $97, %rcx
rep movsq
nop
...
nop
add $47535, %r8
lea addresses_WT_ht+0x6e2d, %rdi
clflush (%rdi)
nop
nop
nop
...
nop
inc %r12
lea addresses_normal_ht+0x1a165, %r13
clflush (%r13)
nop
nop
nop
...
nop
sub %r15, %r15
lea addresses_UC_ht+0xf647, %rsi
lea addresses_WC_ht+0x9947, %rdi
nop
cmp %r15, %r15
mov $2, %rcx
rep movsw
...
// Faulty Load
lea addresses_normal+0xd47, %r10
nop
nop
nop
add $46282, %r13
...
{'OP': 'STOR', 'dst': {'type': 'addresses_NC', 'AVXalign': False, 'congruent': 8, 'size': 32, 'same': False, 'NT': True}}
[Faulty Load]
{'OP': 'LOAD', 'src': {'type': 'addresses_normal', 'AVXalign': False, 'congruent': 0, 'size': 4, 'same': True, 'NT': False}}
<gen_prepare_buffer>
{'OP': 'REPM', 'src': {'type': 'addresses_UC_ht', 'congruent': 9, 'same': False}, 'dst': {'type': 'addresses_WC_ht', 'congruent': 10, 'same': True}}
{'OP': 'REPM', 'src': {'type': 'addresses_D_ht', 'congruent': 9, 'same': False}, 'dst': {'type': 'addresses_UC_ht', 'congruent': 5, 'same': True}}
...
{'OP': 'REPM', 'src': {'type': 'addresses_WT_ht', 'congruent': 5, 'same': False}, 'dst': {'type': 'addresses_WC_ht', 'congruent': 11, 'same': True}}
{'OP': 'REPM', 'src': {'type': 'addresses_normal_ht', 'congruent': 2, 'same': False}, 'dst': {'type': 'addresses_A_ht', 'congruent': 1, 'same': True}}
