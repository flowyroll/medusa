...
push %rdx
push %rsi
lea addresses_UC_ht+0xa730, %rsi
lea addresses_normal_ht+0x5390, %rdi
clflush (%rdi)
nop
nop
nop
...
nop
cmp $56080, %r8
lea addresses_normal_ht+0x14690, %r8
nop
sub $56309, %rdx
vmovups (%r8), %ymm4
...
nop
sub $37361, %rdi
lea addresses_UC_ht+0x16b10, %rsi
lea addresses_A_ht+0x11510, %rdi
nop
nop
nop
nop
...
nop
inc %r8
lea addresses_D_ht+0x11d10, %rdi
and $57931, %r9
...
nop
and %r8, %r8
lea addresses_D_ht+0x1e7f0, %rdi
cmp $38714, %rdx
mov (%rdi), %rcx
nop
nop
add $7696, %r9
lea addresses_WC_ht+0xb850, %r9
nop
nop
nop
nop
...
nop
add %rsi, %rsi
lea addresses_A_ht+0x1be18, %r8
nop
cmp %rdx, %rdx
mov (%r8), %cx
nop
cmp %rsi, %rsi
lea addresses_D_ht+0xd710, %rsi
lea addresses_A_ht+0xd9d6, %rdi
nop
xor %r8, %r8
mov $68, %rcx
rep movsw
cmp %rcx, %rcx
lea addresses_A_ht+0x10d88, %rax
nop
nop
cmp $15097, %r9
mov (%rax), %r8
...
nop
inc %rcx
lea addresses_normal_ht+0x14248, %r8
clflush (%r8)
nop
nop
nop
...
// Faulty Load
lea addresses_normal+0xab10, %r10
nop
inc %rbp
movups (%r10), %xmm5
vpextrq $0, %xmm5, %r15
...
<gen_prepare_buffer>
{'OP': 'REPM', 'src': {'same': False, 'type': 'addresses_UC_ht', 'congruent': 5}, 'dst': {'same': False, 'type': 'addresses_normal_ht', 'congruent': 7}}
...
{'OP': 'STOR', 'dst': {'size': 2, 'NT': False, 'type': 'addresses_A_ht', 'same': False, 'AVXalign': True, 'congruent': 3}}
{'OP': 'LOAD', 'src': {'size': 2, 'NT': True, 'type': 'addresses_D_ht', 'same': True, 'AVXalign': False, 'congruent': 8}}
{'OP': 'LOAD', 'src': {'size': 2, 'NT': False, 'type': 'addresses_A_ht', 'same': False, 'AVXalign': False, 'congruent': 3}}
{'OP': 'REPM', 'src': {'same': False, 'type': 'addresses_D_ht', 'congruent': 9}, 'dst': {'same': False, 'type': 'addresses_A_ht', 'congruent': 1}}
