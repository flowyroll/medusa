...
push %rdi
push %rsi
lea addresses_D_ht+0xabd2, %r11
nop
nop
add %r9, %r9
mov (%r11), %bx
dec %r13
lea addresses_WC_ht+0x1d932, %rsi
lea addresses_UC_ht+0x9926, %rdi
nop
nop
and %r12, %r12
mov $44, %rcx
rep movsl
xor $56848, %rdi
lea addresses_WC_ht+0x13f56, %r13
clflush (%r13)
cmp %rsi, %rsi
...
nop
cmp $58659, %rbx
lea addresses_UC_ht+0x1a262, %rdi
nop
nop
nop
nop
...
movw $0x6162, (%rdi)
sub $22039, %r11
lea addresses_normal_ht+0x12262, %r11
clflush (%r11)
xor %r12, %r12
...
nop
cmp $53008, %rsi
lea addresses_UC_ht+0x1b0a2, %rcx
nop
nop
nop
dec %rdi
...
nop
add $42317, %rbx
lea addresses_WT_ht+0x15e2, %r12
dec %r11
mov (%r12), %esi
nop
nop
...
{'OP': 'LOAD', 'src': {'size': 2, 'NT': False, 'type': 'addresses_UC_ht', 'same': False, 'AVXalign': True, 'congruent': 9}}
{'OP': 'LOAD', 'src': {'size': 4, 'NT': True, 'type': 'addresses_A_ht', 'same': False, 'AVXalign': False, 'congruent': 4}}
{'OP': 'REPM', 'src': {'same': False, 'type': 'addresses_A_ht', 'congruent': 3}, 'dst': {'same': False, 'type': 'addresses_D_ht', 'congruent': 1}}
{'OP': 'REPM', 'src': {'same': False, 'type': 'addresses_D_ht', 'congruent': 11}, 'dst': {'same': False, 'type': 'addresses_UC_ht', 'congruent': 6}}
{'OP': 'LOAD', 'src': {'size': 4, 'NT': False, 'type': 'addresses_WT_ht', 'same': False, 'AVXalign': False, 'congruent': 6}}
{'36': 21829}
