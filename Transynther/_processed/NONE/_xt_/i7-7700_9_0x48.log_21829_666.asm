...
push %rdi
push %rsi
lea addresses_D_ht+0x11de6, %r11
sub $33376, %r14
...
nop
sub %r12, %r12
lea addresses_UC_ht+0x30e6, %r11
nop
and $8880, %r13
movw $0x6162, (%r11)
nop
dec %rax
lea addresses_WT_ht+0x1d9ce, %rsi
lea addresses_WT_ht+0xd066, %rdi
nop
nop
nop
nop
...
nop
dec %r13
lea addresses_normal_ht+0x124c6, %r14
nop
sub $15579, %rcx
vmovups (%r14), %ymm0
...
vpextrq $0, %xmm0, %r12
inc %r11
lea addresses_normal_ht+0x1d266, %rsi
...
nop
dec %rcx
lea addresses_WT_ht+0x1c624, %r11
xor %r12, %r12
movb $0x61, (%r11)
nop
nop
add $23655, %r14
lea addresses_WT_ht+0x17e26, %rax
nop
nop
nop
nop
...
nop
add $46503, %r12
lea addresses_UC_ht+0xcb66, %rcx
clflush (%rcx)
nop
nop
nop
...
nop
dec %rax
lea addresses_WT_ht+0x12866, %rdi
nop
nop
add %r14, %r14
...
// Store
lea addresses_normal+0x16966, %r9
sub %rbp, %rbp
