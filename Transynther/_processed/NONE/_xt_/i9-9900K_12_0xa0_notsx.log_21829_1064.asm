...
push %rdx
push %rsi
lea addresses_WT_ht+0x2291, %rsi
lea addresses_normal_ht+0xbf55, %rdi
nop
nop
nop
nop
...
nop
inc %rcx
lea addresses_UC_ht+0xea91, %rdx
nop
nop
nop
nop
...
nop
sub $7777, %rbx
lea addresses_WT_ht+0x15a91, %rsi
lea addresses_normal_ht+0xb1f7, %rdi
nop
nop
inc %r10
mov $6, %rcx
...
nop
xor $2672, %rsi
lea addresses_WC_ht+0x1d67, %rdx
nop
nop
nop
nop
...
nop
xor $62067, %rdi
lea addresses_normal_ht+0x12291, %rbp
dec %rcx
mov (%rbp), %rbx
cmp %rcx, %rcx
lea addresses_D_ht+0xe209, %rcx
clflush (%rcx)
and %r14, %r14
...
movups %xmm0, (%rcx)
sub $30243, %rsi
lea addresses_UC_ht+0xa051, %r14
nop
nop
cmp %rdx, %rdx
movups (%r14), %xmm3
...
nop
sub $18210, %rsi
lea addresses_WT_ht+0x230b, %r14
cmp %rsi, %rsi
...
nop
sub %rsi, %rsi
lea addresses_UC_ht+0xa831, %rsi
clflush (%rsi)
nop
nop
nop
...
nop
xor $36835, %rbx
lea addresses_WC_ht+0x1317d, %rbp
nop
nop
and $11762, %rdi
...
nop
dec %r10
lea addresses_UC_ht+0x1b291, %rbp
cmp %rdx, %rdx
mov (%rbp), %edi
sub %rsi, %rsi
pop %rsi
...
{'OP': 'STOR', 'dst': {'type': 'addresses_A', 'AVXalign': False, 'size': 4, 'NT': True, 'same': False, 'congruent': 3}}
{'src': {'type': 'addresses_NC', 'AVXalign': True, 'size': 8, 'NT': False, 'same': False, 'congruent': 2}, 'OP': 'LOAD'}
{'OP': 'STOR', 'dst': {'type': 'addresses_US', 'AVXalign': False, 'size': 2, 'NT': False, 'same': False, 'congruent': 4}}
...
{'src': {'type': 'addresses_WT_ht', 'congruent': 11, 'same': False}, 'OP': 'REPM', 'dst': {'type': 'addresses_normal_ht', 'congruent': 0, 'same': False}}
