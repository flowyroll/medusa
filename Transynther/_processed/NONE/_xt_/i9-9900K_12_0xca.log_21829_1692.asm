...
lea addresses_WC_ht+0xd343, %rdi
nop
nop
nop
nop
...
lea addresses_WT_ht+0x18df3, %rdi
nop
dec %rbx
mov $39, %rcx
rep movsw
...
nop
xor %r12, %r12
lea addresses_normal_ht+0xf153, %rsi
xor %r14, %r14
mov (%rsi), %bx
nop
nop
nop
and $40556, %rdi
lea addresses_WC_ht+0xcdf3, %r11
nop
nop
nop
nop
...
movq %r12, (%r11)
xor %rdi, %rdi
lea addresses_WC_ht+0x1a6a1, %rsi
clflush (%rsi)
nop
nop
xor $59144, %r11
...
nop
inc %r11
lea addresses_D_ht+0x69f3, %rsi
lea addresses_A_ht+0x6ce3, %rdi
nop
nop
nop
nop
...
<gen_prepare_buffer>
{'OP': 'REPM', 'src': {'same': False, 'type': 'addresses_UC_ht', 'congruent': 11}, 'dst': {'same': False, 'type': 'addresses_WC_ht', 'congruent': 3}}
...
{'OP': 'REPM', 'src': {'same': False, 'type': 'addresses_D_ht', 'congruent': 9}, 'dst': {'same': False, 'type': 'addresses_A_ht', 'congruent': 2}}
{'32': 21829}
