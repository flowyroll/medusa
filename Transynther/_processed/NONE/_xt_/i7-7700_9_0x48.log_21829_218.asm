...
nop
cmp $9750, %r14
lea addresses_WT_ht+0xf426, %r12
nop
nop
nop
xor %r15, %r15
...
nop
and %r14, %r14
lea addresses_WT_ht+0x11aca, %rsi
...
nop
add %rcx, %rcx
lea addresses_WC_ht+0x75d0, %rbx
nop
nop
nop
nop
...
nop
sub $43553, %r9
lea addresses_A_ht+0x3dd0, %rsi
lea addresses_WC_ht+0x139d0, %rdi
nop
nop
xor %r12, %r12
mov $108, %rcx
...
nop
sub %rsi, %rsi
lea addresses_UC_ht+0x10150, %r9
nop
nop
xor $23983, %r15
movups (%r9), %xmm0
vpextrq $1, %xmm0, %rcx
inc %r14
lea addresses_normal_ht+0xf38, %rsi
lea addresses_WT_ht+0xc9d0, %rdi
nop
nop
sub %r14, %r14
mov $77, %rcx
...
lea addresses_A_ht+0x13730, %rdi
nop
nop
nop
nop
...
nop
add %rbx, %rbx
lea addresses_D_ht+0x143d0, %rsi
lea addresses_D_ht+0xbd00, %rdi
nop
nop
nop
dec %r15
...
nop
dec %rbx
lea addresses_UC_ht+0xe950, %rdi
nop
sub $10302, %r14
movl $0x61626364, (%rdi)
nop
...
// Faulty Load
lea addresses_normal+0x149d0, %rbx
nop
sub $27881, %r10
mov (%rbx), %edi
lea oracles, %r8
...
{'OP': 'STOR', 'dst': {'type': 'addresses_WC_ht', 'AVXalign': True, 'congruent': 7, 'size': 8, 'same': True, 'NT': False}}
