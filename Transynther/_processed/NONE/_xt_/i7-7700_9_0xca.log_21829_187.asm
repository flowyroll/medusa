...
push %rdi
push %rsi
lea addresses_UC_ht+0x183a6, %rsi
lea addresses_A_ht+0x1010b, %rdi
nop
nop
xor $1325, %r14
mov $114, %rcx
...
nop
sub $58768, %rdi
lea addresses_A_ht+0xafa9, %rsi
lea addresses_WT_ht+0xd937, %rdi
cmp %r13, %r13
mov $18, %rcx
rep movsq
nop
...
lea addresses_WC_ht+0x1c6a2, %rdi
nop
nop
nop
add %r9, %r9
...
nop
and $168, %r15
lea addresses_normal_ht+0x129b3, %r14
nop
nop
nop
and %rcx, %rcx
...
nop
cmp %r9, %r9
lea addresses_normal_ht+0x1cd37, %r9
clflush (%r9)
nop
nop
nop
...
nop
inc %r14
lea addresses_UC_ht+0x17537, %r14
nop
nop
nop
nop
...
{'src': {'congruent': 8, 'AVXalign': False, 'same': False, 'size': 8, 'NT': True, 'type': 'addresses_D_ht'}, 'OP': 'LOAD'}
...
{'src': {'congruent': 2, 'AVXalign': True, 'same': False, 'size': 1, 'NT': True, 'type': 'addresses_normal_ht'}, 'OP': 'LOAD'}
