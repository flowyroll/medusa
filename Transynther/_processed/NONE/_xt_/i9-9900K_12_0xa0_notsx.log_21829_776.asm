...
nop
and $3383, %rdi
lea addresses_normal_ht+0xf6a6, %rcx
nop
nop
nop
dec %r10
...
nop
and $14916, %r13
lea addresses_UC_ht+0x1963e, %r13
nop
nop
nop
nop
...
nop
cmp $44007, %r10
lea addresses_normal_ht+0x1487e, %rsi
lea addresses_D_ht+0x152c6, %rdi
xor $5923, %r11
mov $15, %rcx
rep movsw
nop
...
{'src': {'type': 'addresses_normal_ht', 'congruent': 3, 'same': True}, 'OP': 'REPM', 'dst': {'type': 'addresses_D_ht', 'congruent': 5, 'same': False}}
{'33': 21829}
