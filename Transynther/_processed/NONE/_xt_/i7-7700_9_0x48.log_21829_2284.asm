...
nop
sub %r15, %r15
lea addresses_UC_ht+0x1a8f6, %rsi
nop
nop
and %r9, %r9
vmovups (%rsi), %ymm2
...
nop
and %rsi, %rsi
lea addresses_WC_ht+0x37ec, %rsi
lea addresses_normal_ht+0x1c26c, %rdi
nop
inc %r15
mov $20, %rcx
rep movsl
...
nop
xor $60628, %rdi
lea addresses_UC_ht+0x1710c, %rsi
lea addresses_UC_ht+0xdb6c, %rdi
nop
nop
nop
sub $61809, %r15
...
nop
dec %rdx
lea addresses_D_ht+0x1170c, %rcx
dec %rsi
...
nop
cmp $10882, %rsi
lea addresses_D_ht+0x1caec, %rdx
nop
nop
nop
nop
...
mov (%rdx), %ecx
inc %rax
lea addresses_A_ht+0x1650c, %rcx
nop
nop
nop
nop
...
nop
and $60221, %rdx
lea addresses_UC_ht+0x1b99, %r15
nop
nop
add $52825, %rdi
...
nop
sub $64811, %rdx
lea addresses_normal_ht+0xcd0c, %rsi
lea addresses_A_ht+0xf0fe, %rdi
nop
nop
nop
nop
...
nop
add %rdx, %rdx
lea addresses_WT_ht+0xaeba, %rsi
lea addresses_normal_ht+0x1010c, %rdi
sub %r11, %r11
mov $101, %rcx
rep movsw
nop
add %rcx, %rcx
lea addresses_UC_ht+0x1450c, %rsi
lea addresses_WT_ht+0x2d0c, %rdi
clflush (%rsi)
clflush (%rdi)
nop
nop
...
{'OP': 'REPM', 'src': {'type': 'addresses_WT_ht', 'congruent': 1, 'same': False}, 'dst': {'type': 'addresses_normal_ht', 'congruent': 10, 'same': False}}
