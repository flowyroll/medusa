...
push %rdx
push %rsi
lea addresses_A_ht+0x16252, %rcx
nop
nop
nop
nop
...
movq %r12, (%r11)
cmp $60676, %r10
lea addresses_WC_ht+0x1bb9a, %rdx
nop
nop
dec %r15
mov (%rdx), %r10
...
nop
inc %rdx
lea addresses_A_ht+0x1e31a, %r10
nop
nop
nop
add $53091, %r15
...
movw $0x6162, (%r8)
inc %rdx
lea addresses_WC_ht+0x14d9a, %r8
clflush (%r8)
and $45644, %r15
...
nop
cmp $10173, %rdx
lea addresses_normal_ht+0x1509a, %rsi
lea addresses_normal_ht+0xcc5a, %rdi
nop
cmp $35052, %r8
mov $10, %rcx
rep movsb
...
nop
sub $58792, %r15
lea addresses_UC_ht+0x1c59a, %r10
nop
nop
nop
nop
...
{'src': {'type': 'addresses_WC_ht', 'AVXalign': True, 'size': 32, 'NT': False, 'same': False, 'congruent': 7}, 'OP': 'LOAD'}
{'src': {'type': 'addresses_normal_ht', 'congruent': 8, 'same': False}, 'OP': 'REPM', 'dst': {'type': 'addresses_normal_ht', 'congruent': 5, 'same': True}}
{'OP': 'STOR', 'dst': {'type': 'addresses_UC_ht', 'AVXalign': False, 'size': 32, 'NT': False, 'same': True, 'congruent': 10}}
{'36': 21829}
