...
push %rdi
push %rsi
lea addresses_A_ht+0x10afd, %rax
nop
xor $65102, %r9
...
nop
sub %rbx, %rbx
lea addresses_UC_ht+0xbd39, %rax
nop
inc %r8
movw $0x6162, (%rax)
nop
...
nop
add %r8, %r8
lea addresses_UC_ht+0x523d, %rbx
dec %rdi
movl $0x61626364, (%rbx)
nop
nop
and $13388, %rdi
lea addresses_WT_ht+0xe4bd, %rsi
lea addresses_UC_ht+0x663d, %rdi
nop
nop
nop
nop
...
nop
inc %rax
lea addresses_A_ht+0x2c3d, %r14
sub $56994, %r9
mov (%r14), %r8d
nop
nop
sub $61682, %r10
lea addresses_normal_ht+0x98fd, %rcx
nop
nop
cmp %r14, %r14
movups (%rcx), %xmm3
...
nop
inc %rbx
lea addresses_normal_ht+0x1aa5d, %r14
nop
nop
xor $2239, %rax
vmovups (%r14), %ymm6
...
nop
sub %rsi, %rsi
lea addresses_WT_ht+0x1beb5, %r8
nop
nop
dec %rax
vmovups (%r8), %ymm4
...
<gen_faulty_load>
[REF]
{'src': {'type': 'addresses_D', 'AVXalign': True, 'size': 1, 'NT': True, 'same': False, 'congruent': 0}, 'OP': 'LOAD'}
[Faulty Load]
...
{'src': {'type': 'addresses_D_ht', 'AVXalign': True, 'size': 16, 'NT': False, 'same': False, 'congruent': 10}, 'OP': 'LOAD'}
