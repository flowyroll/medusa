...
push %rdx
push %rsi
lea addresses_A_ht+0x10d8f, %rsi
lea addresses_WT_ht+0x1e163, %rdi
nop
nop
and $62625, %r15
mov $3, %rcx
...
nop
xor %rbx, %rbx
lea addresses_WT_ht+0x1b283, %r15
nop
and $49743, %rdx
movw $0x6162, (%r15)
nop
...
nop
cmp $211, %rcx
lea addresses_normal_ht+0xdc43, %rsi
lea addresses_A_ht+0x15d63, %rdi
nop
nop
dec %r14
mov $104, %rcx
...
nop
and %r15, %r15
lea addresses_WT_ht+0x3163, %rdi
clflush (%rdi)
nop
nop
lfence
...
nop
cmp %r15, %r15
lea addresses_WT_ht+0x17163, %rsi
lea addresses_normal_ht+0x17480, %rdi
nop
nop
nop
nop
...
nop
inc %r14
lea addresses_WC_ht+0x13c63, %rsi
nop
nop
sub %rdi, %rdi
mov (%rsi), %ebp
...
nop
add %rcx, %rcx
lea addresses_A_ht+0x1c163, %rdi
nop
nop
nop
add $20889, %rdx
...
<gen_prepare_buffer>
{'src': {'same': True, 'congruent': 1, 'type': 'addresses_A_ht'}, 'OP': 'REPM', 'dst': {'same': False, 'congruent': 11, 'type': 'addresses_WT_ht'}}
...
{'src': {'same': False, 'congruent': 11, 'type': 'addresses_WT_ht'}, 'OP': 'REPM', 'dst': {'same': True, 'congruent': 0, 'type': 'addresses_normal_ht'}}
