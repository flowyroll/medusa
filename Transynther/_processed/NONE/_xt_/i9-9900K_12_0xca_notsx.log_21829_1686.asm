...
nop
cmp $20686, %rax
lea addresses_normal_ht+0x1d48c, %rsi
...
nop
add $65455, %r15
lea addresses_A_ht+0x1a580, %r13
nop
nop
sub %rcx, %rcx
mov (%r13), %r15
...
nop
xor $22058, %rdi
lea addresses_D_ht+0x103d4, %rsi
lea addresses_UC_ht+0x3dbc, %rdi
xor %r11, %r11
mov $19, %rcx
rep movsl
nop
...
nop
cmp %r11, %r11
lea addresses_UC_ht+0x7479, %rax
nop
nop
nop
nop
...
nop
add %rsi, %rsi
lea addresses_D_ht+0x15354, %rcx
nop
nop
nop
nop
...
vpextrq $0, %xmm7, %r9
xor $31629, %rax
lea addresses_WT_ht+0x1d718, %rsi
lea addresses_WC_ht+0xf354, %rdi
clflush (%rsi)
clflush (%rdi)
nop
and $6006, %r13
...
nop
xor $10816, %r15
lea addresses_WT_ht+0x1a04a, %rcx
nop
nop
dec %r11
mov (%rcx), %r9d
...
<gen_prepare_buffer>
{'OP': 'LOAD', 'src': {'same': True, 'type': 'addresses_D_ht', 'NT': False, 'AVXalign': True, 'size': 4, 'congruent': 3}}
...
{'OP': 'REPM', 'src': {'same': False, 'congruent': 3, 'type': 'addresses_normal_ht'}, 'dst': {'same': False, 'congruent': 4, 'type': 'addresses_A_ht'}}
{'OP': 'LOAD', 'src': {'same': False, 'type': 'addresses_A_ht', 'NT': True, 'AVXalign': False, 'size': 8, 'congruent': 2}}
{'OP': 'REPM', 'src': {'same': False, 'congruent': 7, 'type': 'addresses_D_ht'}, 'dst': {'same': False, 'congruent': 2, 'type': 'addresses_UC_ht'}}
...
{'OP': 'REPM', 'src': {'same': False, 'congruent': 0, 'type': 'addresses_WT_ht'}, 'dst': {'same': False, 'congruent': 10, 'type': 'addresses_WC_ht'}}
