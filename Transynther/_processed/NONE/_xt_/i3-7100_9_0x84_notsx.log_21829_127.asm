...
push %rdx
push %rsi
lea addresses_D_ht+0x1c372, %r14
nop
nop
nop
inc %r9
...
nop
add $38347, %r13
lea addresses_WC_ht+0x1992c, %rsi
nop
nop
nop
dec %r9
...
nop
add %rsi, %rsi
lea addresses_normal_ht+0x16472, %r14
nop
nop
nop
nop
...
nop
dec %r13
lea addresses_normal_ht+0xcf32, %rsi
lea addresses_A_ht+0x13d72, %rdi
clflush (%rsi)
clflush (%rdi)
nop
nop
...
nop
and %rdx, %rdx
lea addresses_WT_ht+0x1a72, %r13
clflush (%r13)
nop
nop
inc %r9
...
vpextrq $1, %xmm3, %r10
add $23362, %rdi
lea addresses_UC_ht+0x16d12, %rsi
lea addresses_normal_ht+0x13f2, %rdi
nop
nop
sub $63286, %r13
mov $29, %rcx
...
nop
inc %r14
lea addresses_UC_ht+0xf2c2, %r10
nop
cmp $23980, %rdx
movups (%r10), %xmm7
vpextrq $0, %xmm7, %r13
...
nop
add $34924, %r13
lea addresses_WC_ht+0xc17a, %rsi
lea addresses_D_ht+0x18e92, %rdi
sub %r9, %r9
mov $4, %rcx
rep movsq
nop
...
{'src': {'type': 'addresses_WC_ht', 'congruent': 1, 'same': False}, 'dst': {'type': 'addresses_D_ht', 'congruent': 5, 'same': False}, 'OP': 'REPM'}
{'35': 21829}
