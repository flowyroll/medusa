...
nop
add $8752, %rdx
lea addresses_UC_ht+0x996b, %rbx
xor %rdx, %rdx
mov (%rbx), %di
nop
nop
...
nop
cmp $60859, %r12
lea addresses_WT_ht+0x8fbd, %rsi
nop
nop
nop
nop
...
nop
dec %rbx
lea addresses_WT_ht+0x1242b, %rsi
lea addresses_UC_ht+0x165ab, %rdi
nop
nop
nop
nop
...
{'dst': {'type': 'addresses_P', 'same': False, 'size': 8, 'congruent': 8, 'NT': False, 'AVXalign': True}, 'OP': 'STOR'}
[Faulty Load]
{'src': {'type': 'addresses_PSE', 'same': True, 'size': 4, 'congruent': 0, 'NT': False, 'AVXalign': False}, 'OP': 'LOAD'}
<gen_prepare_buffer>
{'src': {'type': 'addresses_D_ht', 'congruent': 7, 'same': True}, 'dst': {'type': 'addresses_WT_ht', 'congruent': 3, 'same': False}, 'OP': 'REPM'}
