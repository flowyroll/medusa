...
push %rdi
push %rsi
lea addresses_WC_ht+0x18828, %r11
nop
nop
nop
nop
...
nop
add %r12, %r12
lea addresses_UC_ht+0x9e64, %rdi
nop
add $64397, %r10
mov (%rdi), %r13w
nop
...
nop
xor %r13, %r13
lea addresses_WC_ht+0x67fc, %rsi
lea addresses_A_ht+0xa333, %rdi
nop
nop
sub %r10, %r10
mov $126, %rcx
rep movsw
dec %r11
lea addresses_WT_ht+0xaac6, %rbx
clflush (%rbx)
nop
cmp $24101, %r11
movups (%rbx), %xmm3
...
nop
sub $31486, %r13
lea addresses_normal_ht+0x1ecac, %r12
nop
sub %rdi, %rdi
...
nop
xor %rsi, %rsi
lea addresses_UC_ht+0xc10c, %r10
nop
nop
and $52768, %r11
mov (%r10), %rcx
...
{'src': {'type': 'addresses_D', 'AVXalign': False, 'size': 16, 'NT': False, 'same': False, 'congruent': 8}, 'OP': 'LOAD'}
[Faulty Load]
...
{'src': {'type': 'addresses_WC_ht', 'congruent': 4, 'same': True}, 'OP': 'REPM', 'dst': {'type': 'addresses_A_ht', 'congruent': 0, 'same': False}}
