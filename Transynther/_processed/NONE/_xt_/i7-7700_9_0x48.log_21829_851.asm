...
nop
inc %r9
lea addresses_UC_ht+0x1224a, %r10
nop
xor $41100, %r8
movw $0x6162, (%r10)
nop
...
nop
cmp $31225, %rbp
lea addresses_WC_ht+0x2926, %rsi
lea addresses_UC_ht+0x10ba, %rdi
nop
and $26876, %r14
mov $90, %rcx
rep movsl
