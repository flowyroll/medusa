...
nop
add $60287, %r14
lea addresses_WC_ht+0xfd3f, %rdx
nop
nop
and %r15, %r15
movb $0x61, (%rdx)
nop
and %r8, %r8
lea addresses_UC_ht+0x156cb, %r11
nop
nop
sub $61786, %rdx
...
nop
and $30796, %r11
lea addresses_UC_ht+0x1ca2f, %r8
nop
nop
sub $54758, %rdx
movl $0x61626364, (%r8)
...
nop
dec %r13
lea addresses_A_ht+0x4963, %rsi
lea addresses_normal_ht+0x15a3f, %rdi
nop
inc %r14
mov $95, %rcx
rep movsl
...
nop
sub $14721, %rsi
lea addresses_WC_ht+0x10b4f, %rcx
nop
nop
nop
nop
...
nop
inc %rcx
lea addresses_WT_ht+0x120ff, %rsi
lea addresses_normal_ht+0x8fef, %rdi
nop
nop
nop
nop
...
nop
dec %rdx
lea addresses_A_ht+0x1823f, %rsi
lea addresses_normal_ht+0x11837, %rdi
nop
nop
nop
add $5917, %r13
...
nop
cmp $55080, %r14
lea addresses_normal_ht+0x1386f, %rcx
nop
nop
nop
nop
...
nop
dec %r15
lea addresses_normal_ht+0x1633f, %rcx
nop
cmp $58222, %r14
movl $0x61626364, (%rcx)
xor %rcx, %rcx
...
{'OP': 'STOR', 'dst': {'NT': False, 'same': False, 'congruent': 4, 'type': 'addresses_UC_ht', 'AVXalign': True, 'size': 4}}
...
{'src': {'same': True, 'congruent': 5, 'type': 'addresses_WT_ht'}, 'OP': 'REPM', 'dst': {'same': False, 'congruent': 4, 'type': 'addresses_normal_ht'}}
{'src': {'same': False, 'congruent': 8, 'type': 'addresses_A_ht'}, 'OP': 'REPM', 'dst': {'same': True, 'congruent': 1, 'type': 'addresses_normal_ht'}}
