...
push %rdx
push %rsi
lea addresses_WC_ht+0x1c836, %rsi
lea addresses_D_ht+0x13f36, %rdi
nop
nop
nop
nop
...
nop
add %r15, %r15
lea addresses_A_ht+0x19076, %rdx
nop
nop
dec %r10
mov (%rdx), %edi
...
nop
add $61757, %rsi
lea addresses_normal_ht+0x1dbf6, %rsi
lea addresses_D_ht+0x17bf6, %rdi
nop
dec %r9
mov $121, %rcx
rep movsq
...
nop
dec %rsi
lea addresses_normal_ht+0x102f6, %rsi
lea addresses_UC_ht+0x37f6, %rdi
xor %r9, %r9
mov $71, %rcx
rep movsl
nop
nop
add $7412, %rcx
lea addresses_WC_ht+0xf1f6, %rcx
nop
nop
nop
nop
...
nop
sub %rdi, %rdi
lea addresses_WC_ht+0x19a26, %rsi
nop
nop
add $17091, %r10
movl $0x61626364, (%rsi)
