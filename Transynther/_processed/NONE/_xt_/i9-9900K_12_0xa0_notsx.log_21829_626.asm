...
push %rdi
push %rsi
lea addresses_WC_ht+0x1c3d2, %r8
nop
nop
nop
inc %r10
...
nop
add $59630, %rbx
lea addresses_normal_ht+0xc632, %rdi
nop
nop
nop
nop
...
vmovups %ymm3, (%rdi)
sub %r8, %r8
lea addresses_A_ht+0xf222, %rdi
nop
nop
dec %rsi
movl $0x61626364, (%rdi)
add $10457, %rsi
lea addresses_D_ht+0x1a586, %rbp
nop
nop
xor $52816, %r8
movw $0x6162, (%rbp)
...
{'src': {'type': 'addresses_A', 'AVXalign': False, 'size': 1, 'NT': False, 'same': False, 'congruent': 5}, 'OP': 'LOAD'}
...
{'OP': 'STOR', 'dst': {'type': 'addresses_D_ht', 'AVXalign': True, 'size': 2, 'NT': False, 'same': False, 'congruent': 10}}
