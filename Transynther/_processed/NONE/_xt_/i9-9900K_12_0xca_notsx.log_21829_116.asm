...
nop
xor %r15, %r15
lea addresses_WT_ht+0x17d55, %r8
nop
nop
xor $16496, %r14
...
nop
add %r8, %r8
lea addresses_WT_ht+0xaa4d, %rax
nop
nop
nop
add %r15, %r15
...
nop
add %r8, %r8
lea addresses_normal_ht+0x6955, %rsi
lea addresses_normal_ht+0x12f75, %rdi
nop
nop
nop
dec %r8
...
nop
dec %r8
lea addresses_WT_ht+0x1e955, %rax
xor %r15, %r15
movb (%rax), %cl
nop
nop
inc %rsi
lea addresses_D_ht+0x9f55, %r14
and $38361, %rsi
...
nop
xor $45542, %rdi
lea addresses_WT_ht+0xe609, %rcx
nop
and %r8, %r8
movl $0x61626364, (%rcx)
nop
nop
dec %r13
lea addresses_WT_ht+0x7755, %rsi
lea addresses_UC_ht+0xf5d5, %rdi
nop
nop
add %rax, %rax
mov $42, %rcx
...
{'OP': 'LOAD', 'src': {'same': True, 'type': 'addresses_WT_ht', 'NT': False, 'AVXalign': True, 'size': 16, 'congruent': 9}}
{'OP': 'LOAD', 'src': {'same': False, 'type': 'addresses_WT_ht', 'NT': False, 'AVXalign': True, 'size': 2, 'congruent': 3}}
{'OP': 'REPM', 'src': {'same': False, 'congruent': 10, 'type': 'addresses_normal_ht'}, 'dst': {'same': False, 'congruent': 5, 'type': 'addresses_normal_ht'}}
...
{'OP': 'REPM', 'src': {'same': True, 'congruent': 7, 'type': 'addresses_WT_ht'}, 'dst': {'same': False, 'congruent': 6, 'type': 'addresses_UC_ht'}}
{'36': 21829}
