...
push %rdx
push %rsi
lea addresses_UC_ht+0x8bd9, %r15
nop
add $45328, %r8
...
nop
add $58373, %rbx
lea addresses_UC_ht+0xf46b, %rsi
lea addresses_A_ht+0x11149, %rdi
nop
nop
nop
add $59433, %rbx
...
nop
xor $54642, %rdi
lea addresses_normal_ht+0x68b9, %r15
clflush (%r15)
xor %rcx, %rcx
...
lea addresses_WT_ht+0x11395, %rdi
nop
nop
inc %r13
mov $55, %rcx
rep movsl
inc %rdi
lea addresses_WC_ht+0x15859, %rsi
lea addresses_UC_ht+0x10605, %rdi
clflush (%rsi)
nop
nop
and $2040, %rdx
...
nop
cmp %rdi, %rdi
lea addresses_WC_ht+0x7eb9, %r13
add %rdi, %rdi
movb $0x61, (%r13)
nop
nop
xor $24683, %r15
lea addresses_A_ht+0x40b9, %rsi
cmp $2406, %rdx
...
{'OP': 'REPM', 'src': {'type': 'addresses_WC_ht', 'congruent': 5, 'same': False}, 'dst': {'type': 'addresses_UC_ht', 'congruent': 1, 'same': True}}
