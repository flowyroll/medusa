...
push %rdx
push %rsi
lea addresses_UC_ht+0x3d43, %rsi
lea addresses_D_ht+0x13d7b, %rdi
sub $48920, %r10
mov $47, %rcx
rep movsl
nop
...
nop
and $44819, %r13
lea addresses_normal_ht+0x9e7b, %rdx
nop
nop
nop
nop
...
nop
dec %r11
lea addresses_normal_ht+0x1cc7b, %r10
nop
xor %rcx, %rcx
mov (%r10), %dx
nop
nop
add $12616, %rcx
lea addresses_UC_ht+0x2afc, %r11
nop
nop
nop
nop
...
nop
sub %rdx, %rdx
lea addresses_WC_ht+0x47fb, %r13
cmp %r11, %r11
...
lea addresses_normal_ht+0xad7b, %rdi
nop
nop
nop
xor $25595, %rdx
...
nop
xor %r13, %r13
lea addresses_UC_ht+0x19c03, %rsi
lea addresses_WC_ht+0x527b, %rdi
nop
nop
nop
nop
...
nop
add %rdx, %rdx
lea addresses_A_ht+0x1bd7b, %rsi
nop
nop
and $43642, %rcx
mov (%rsi), %r11
...
<gen_prepare_buffer>
{'OP': 'REPM', 'src': {'type': 'addresses_UC_ht', 'congruent': 1, 'same': False}, 'dst': {'type': 'addresses_D_ht', 'congruent': 7, 'same': False}}
