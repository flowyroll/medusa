...
push %rdi
push %rsi
lea addresses_normal_ht+0xf2a, %rbx
nop
nop
inc %r11
mov (%rbx), %si
...
nop
add %r15, %r15
lea addresses_WT_ht+0x1242a, %rdi
nop
nop
nop
nop
...
nop
add %r12, %r12
lea addresses_WT_ht+0x17c2a, %rsi
lea addresses_normal_ht+0x1816a, %rdi
nop
nop
nop
nop
...
rep movsl
inc %rcx
lea addresses_UC_ht+0x18e26, %rsi
lea addresses_UC_ht+0x14429, %rdi
nop
nop
nop
nop
...
nop
xor $36464, %rbx
lea addresses_normal_ht+0x127aa, %rdi
nop
nop
nop
nop
...
nop
sub %r11, %r11
lea addresses_WC_ht+0xe7aa, %r10
nop
nop
nop
cmp $59237, %r12
...
nop
cmp %r15, %r15
lea addresses_WC_ht+0x1e25a, %r12
nop
sub $52827, %rsi
...
nop
inc %r15
lea addresses_normal_ht+0xadca, %rsi
lea addresses_A_ht+0x2df1, %rdi
clflush (%rsi)
nop
nop
nop
...
lea addresses_WT_ht+0x1e2aa, %rdi
nop
and $58898, %r15
mov $57, %rcx
rep movsw
...
{'OP': 'REPM', 'src': {'type': 'addresses_WT_ht', 'congruent': 6, 'same': False}, 'dst': {'type': 'addresses_normal_ht', 'congruent': 5, 'same': False}}
{'OP': 'REPM', 'src': {'type': 'addresses_UC_ht', 'congruent': 1, 'same': True}, 'dst': {'type': 'addresses_UC_ht', 'congruent': 0, 'same': False}}
...
{'OP': 'REPM', 'src': {'type': 'addresses_normal_ht', 'congruent': 4, 'same': False}, 'dst': {'type': 'addresses_A_ht', 'congruent': 0, 'same': False}}
