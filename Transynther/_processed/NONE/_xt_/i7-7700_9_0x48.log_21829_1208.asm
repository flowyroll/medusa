...
lea addresses_normal_ht+0x125e2, %rdi
nop
and $31367, %r15
mov $112, %rcx
rep movsw
cmp $24863, %rax
lea addresses_A_ht+0xfa7a, %rax
nop
sub $48968, %r15
movl $0x61626364, (%rax)
nop
nop
add $24291, %rcx
lea addresses_WT_ht+0xee7c, %rsi
lea addresses_A_ht+0x147a2, %rdi
nop
nop
nop
sub %rax, %rax
