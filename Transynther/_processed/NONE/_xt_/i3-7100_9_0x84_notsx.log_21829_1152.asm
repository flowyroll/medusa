...
push %rdi
push %rsi
lea addresses_A_ht+0x1e864, %rsi
lea addresses_normal_ht+0x1e20, %rdi
nop
xor %rbp, %rbp
mov $77, %rcx
rep movsb
...
nop
cmp $36315, %rdi
lea addresses_D_ht+0x15d1c, %rcx
nop
nop
nop
nop
...
lea addresses_WC_ht+0x1921c, %rdi
nop
nop
nop
nop
...
nop
add $28788, %rdi
lea addresses_UC_ht+0x13ddc, %rcx
nop
nop
nop
nop
...
nop
and %rsi, %rsi
lea addresses_A_ht+0x5f9c, %rsi
lea addresses_WT_ht+0x1c5bc, %rdi
and $12804, %r15
mov $67, %rcx
rep movsl
nop
and %r15, %r15
lea addresses_WC_ht+0x275c, %r8
nop
nop
add %rsi, %rsi
mov (%r8), %r15
inc %rax
lea addresses_WC_ht+0xce5c, %rsi
nop
nop
nop
add $43709, %rax
...
nop
add %r12, %r12
lea addresses_D_ht+0x11044, %rsi
lea addresses_WC_ht+0x46f4, %rdi
xor $61961, %r15
mov $88, %rcx
rep movsl
nop
...
nop
add $50851, %r15
lea addresses_WT_ht+0x735c, %rsi
lea addresses_D_ht+0xe55c, %rdi
nop
nop
nop
cmp $20264, %r15
...
nop
and %r8, %r8
lea addresses_D_ht+0x2a1c, %rsi
lea addresses_WC_ht+0x1375c, %rdi
clflush (%rdi)
nop
nop
sub %r8, %r8
...
nop
mfence
lea addresses_WT_ht+0x1635c, %rsi
lea addresses_normal_ht+0x64ec, %rdi
nop
nop
nop
nop
...
nop
cmp $48419, %r15
lea addresses_WC_ht+0xd884, %rsi
nop
nop
nop
nop
...
nop
and $26782, %rbp
lea addresses_WT_ht+0x1ed5c, %r15
nop
nop
nop
dec %rcx
...
{'src': {'type': 'addresses_D_ht', 'congruent': 3, 'same': False}, 'dst': {'type': 'addresses_WC_ht', 'congruent': 2, 'same': False}, 'OP': 'REPM'}
{'src': {'type': 'addresses_WT_ht', 'congruent': 10, 'same': False}, 'dst': {'type': 'addresses_D_ht', 'congruent': 9, 'same': False}, 'OP': 'REPM'}
{'src': {'type': 'addresses_D_ht', 'congruent': 6, 'same': False}, 'dst': {'type': 'addresses_WC_ht', 'congruent': 6, 'same': True}, 'OP': 'REPM'}
{'src': {'type': 'addresses_WT_ht', 'congruent': 8, 'same': False}, 'dst': {'type': 'addresses_normal_ht', 'congruent': 4, 'same': False}, 'OP': 'REPM'}
