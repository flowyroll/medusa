...
push %rdx
push %rsi
lea addresses_A_ht+0x130bc, %rsi
lea addresses_WC_ht+0x80bc, %rdi
nop
nop
lfence
mov $49, %rcx
...
nop
dec %rsi
lea addresses_WT_ht+0x160de, %rsi
lea addresses_A_ht+0x8cbc, %rdi
clflush (%rdi)
nop
nop
nop
...
lea addresses_UC_ht+0x9f7c, %rdi
nop
cmp %r9, %r9
mov $102, %rcx
rep movsb
...
nop
and %r10, %r10
lea addresses_WC_ht+0x140bc, %rdx
nop
nop
nop
nop
...
movl $0x61626364, (%rdx)
add $23573, %r10
lea addresses_normal_ht+0x1c33c, %r9
nop
nop
nop
nop
...
{'OP': 'REPM', 'src': {'same': False, 'congruent': 1, 'type': 'addresses_WT_ht'}, 'dst': {'same': False, 'congruent': 10, 'type': 'addresses_A_ht'}}
{'OP': 'REPM', 'src': {'same': False, 'congruent': 8, 'type': 'addresses_normal_ht'}, 'dst': {'same': False, 'congruent': 5, 'type': 'addresses_UC_ht'}}
