...
push %rdi
push %rsi
lea addresses_D_ht+0x100cd, %rbp
nop
nop
xor %r9, %r9
movw $0x6162, (%rbp)
...
nop
and $53229, %rax
lea addresses_UC_ht+0x19e81, %r11
nop
nop
nop
nop
...
movw $0x6162, (%r11)
cmp %rax, %rax
lea addresses_normal_ht+0x1ab81, %r11
nop
nop
nop
and %r8, %r8
...
nop
xor %r8, %r8
lea addresses_WC_ht+0x4981, %rax
nop
nop
nop
xor %rbp, %rbp
...
nop
cmp %rdi, %rdi
lea addresses_normal_ht+0x1bcc1, %rbx
nop
nop
nop
cmp $1217, %rbp
...
nop
xor $18766, %rdi
lea addresses_WT_ht+0x19c1, %r11
nop
nop
nop
nop
...
nop
cmp $55906, %rbx
lea addresses_WC_ht+0x5f81, %rsi
lea addresses_A_ht+0x5541, %rdi
clflush (%rsi)
nop
nop
nop
...
nop
dec %r9
lea addresses_UC_ht+0x6381, %rsi
add $49055, %rax
movw $0x6162, (%rsi)
add $65423, %rcx
...
nop
and %rbp, %rbp
lea addresses_normal_ht+0x13941, %rbp
clflush (%rbp)
add $59549, %rsi
vmovups (%rbp), %ymm0
...
{'src': {'type': 'addresses_WC_ht', 'congruent': 9, 'same': True}, 'dst': {'type': 'addresses_A_ht', 'congruent': 3, 'same': False}, 'OP': 'REPM'}
