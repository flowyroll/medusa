...
nop
inc %r13
lea addresses_normal_ht+0x78e9, %rdi
nop
cmp %rsi, %rsi
mov (%rdi), %r14d
nop
...
lea addresses_WC_ht+0xd12b, %rdi
nop
nop
nop
xor $38044, %r8
...
movl $0x61626364, (%rdi)
xor $57928, %rcx
lea addresses_WC_ht+0x10f29, %rdi
nop
nop
cmp %r8, %r8
movb $0x61, (%rdi)
...
nop
cmp %rax, %rax
lea addresses_UC_ht+0x16501, %rcx
nop
nop
nop
and $45119, %rdi
...
nop
dec %r15
lea addresses_UC_ht+0x1d8e9, %r15
nop
nop
nop
inc %rax
...
nop
xor $9500, %rsi
lea addresses_WC_ht+0xbe69, %rsi
nop
add $9638, %r14
mov (%rsi), %rax
nop
...
{'dst': {'same': False, 'NT': True, 'AVXalign': False, 'size': 4, 'type': 'addresses_UC', 'congruent': 8}, 'OP': 'STOR'}
[Faulty Load]
...
{'dst': {'same': False, 'congruent': 1, 'type': 'addresses_WC_ht'}, 'OP': 'REPM', 'src': {'same': True, 'congruent': 0, 'type': 'addresses_normal_ht'}}
