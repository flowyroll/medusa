...
nop
and %rsi, %rsi
lea addresses_UC_ht+0x1d458, %r13
nop
nop
nop
and %rax, %rax
...
nop
xor %rsi, %rsi
lea addresses_D_ht+0x2058, %r12
nop
sub $62772, %r8
movw $0x6162, (%r12)
and $31763, %rax
lea addresses_UC_ht+0x28f8, %rax
nop
nop
add $48375, %r14
...
nop
add %r12, %r12
lea addresses_normal_ht+0x2458, %rsi
lea addresses_D_ht+0xc758, %rdi
and $601, %r8
mov $86, %rcx
rep movsl
nop
...
nop
cmp %r9, %r9
lea addresses_A_ht+0x17a08, %rsi
lea addresses_WT_ht+0x67f, %rdi
nop
nop
nop
add $14657, %r8
...
nop
cmp %rax, %rax
lea addresses_D_ht+0x1c1d8, %r13
nop
nop
nop
sub $32510, %rsi
...
nop
inc %rax
lea addresses_UC_ht+0x1b978, %r9
clflush (%r9)
nop
nop
nop
...
// Faulty Load
lea addresses_normal+0x19c58, %r9
nop
nop
nop
nop
...
{'OP': 'REPM', 'src': {'same': False, 'type': 'addresses_A_ht', 'congruent': 2}, 'dst': {'same': False, 'type': 'addresses_WT_ht', 'congruent': 0}}
