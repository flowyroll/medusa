...
push %rdi
push %rsi
lea addresses_WT_ht+0x8534, %rbx
nop
nop
xor $52634, %r12
mov (%rbx), %di
...
nop
cmp %r12, %r12
lea addresses_UC_ht+0x1c5f6, %r8
nop
sub %r14, %r14
...
nop
inc %r12
lea addresses_UC_ht+0x10492, %rax
nop
sub %rsi, %rsi
...
nop
cmp $60548, %rax
lea addresses_UC_ht+0x38ba, %rsi
lea addresses_WC_ht+0x1d726, %rdi
clflush (%rsi)
nop
nop
nop
...
nop
xor $42719, %r8
lea addresses_WT_ht+0x13edb, %rsi
nop
nop
nop
nop
...
nop
sub $44976, %r14
lea addresses_WC_ht+0x66b6, %rbx
nop
add %r14, %r14
movb $0x61, (%rbx)
nop
...
nop
sub $22639, %rdi
lea addresses_UC_ht+0x1a33e, %r14
nop
nop
inc %r8
movb (%r14), %cl
...
nop
and %r14, %r14
lea addresses_WT_ht+0x1c6d3, %rdi
nop
nop
nop
nop
...
{'src': {'type': 'addresses_UC_ht', 'AVXalign': True, 'size': 16, 'NT': False, 'same': False, 'congruent': 4}, 'OP': 'LOAD'}
...
{'src': {'type': 'addresses_UC_ht', 'AVXalign': False, 'size': 1, 'NT': False, 'same': True, 'congruent': 3}, 'OP': 'LOAD'}
