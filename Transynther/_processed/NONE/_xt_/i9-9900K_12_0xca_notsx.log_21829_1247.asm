...
push %rdi
push %rsi
lea addresses_D_ht+0xa185, %rsi
lea addresses_WC_ht+0x1b785, %rdi
clflush (%rdi)
nop
nop
nop
...
nop
add $32592, %r13
lea addresses_WC_ht+0x13785, %r13
nop
nop
nop
nop
