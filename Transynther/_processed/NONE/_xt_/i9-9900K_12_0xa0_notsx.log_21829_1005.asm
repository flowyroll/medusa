...
nop
inc %rdi
lea addresses_D_ht+0x149ea, %rdi
cmp %r10, %r10
...
nop
inc %rbp
lea addresses_WC_ht+0x1dcea, %rbp
nop
nop
nop
nop
...
nop
and $56681, %rbp
lea addresses_WC_ht+0xf86a, %rdi
nop
nop
nop
nop
...
nop
xor %r15, %r15
lea addresses_WC_ht+0x22ea, %rsi
lea addresses_UC_ht+0x78f2, %rdi
nop
nop
nop
nop
...
nop
add $53237, %rsi
lea addresses_UC_ht+0x12efa, %rcx
clflush (%rcx)
nop
nop
xor $44358, %rdi
...
nop
and $38729, %rcx
lea addresses_UC_ht+0x2eca, %rsi
lea addresses_WT_ht+0x1edd2, %rdi
nop
nop
nop
sub $25771, %r9
...
nop
cmp %rsi, %rsi
lea addresses_normal_ht+0x1465a, %rbx
nop
nop
nop
nop
...
nop
inc %rdi
lea addresses_normal_ht+0xdd8a, %rbp
nop
xor %rsi, %rsi
mov $0x6162636465666768, %rbx
movq %rbx, %xmm6
...
// REPMOV
lea addresses_normal+0xca6a, %rsi
lea addresses_WT+0x1902, %rdi
nop
nop
nop
sub $24370, %r8
...
{'src': {'type': 'addresses_normal', 'congruent': 5, 'same': False}, 'OP': 'REPM', 'dst': {'type': 'addresses_WT', 'congruent': 3, 'same': False}}
[Faulty Load]
...
{'src': {'type': 'addresses_WT_ht', 'congruent': 4, 'same': False}, 'OP': 'REPM', 'dst': {'type': 'addresses_WC_ht', 'congruent': 3, 'same': False}}
