...
lea addresses_UC_ht+0x134a4, %rdi
nop
nop
nop
nop
...
rep movsw
and $28398, %rsi
lea addresses_normal_ht+0x17fc4, %r10
nop
nop
nop
nop
...
movq %rdi, (%r10)
cmp $13798, %rdi
lea addresses_WC_ht+0x1d3c4, %rdi
add $30323, %r9
...
nop
cmp %rsi, %rsi
lea addresses_WT_ht+0x1e184, %rdi
nop
nop
and $10587, %r11
mov (%rdi), %r9w
...
nop
add %rsi, %rsi
lea addresses_WT_ht+0x77c4, %rsi
lea addresses_WC_ht+0x69c4, %rdi
clflush (%rsi)
clflush (%rdi)
nop
nop
...
nop
dec %rdi
lea addresses_D_ht+0x10ddc, %rsi
lea addresses_normal_ht+0x177c4, %rdi
clflush (%rsi)
nop
nop
nop
...
{'src': {'congruent': 2, 'same': False, 'type': 'addresses_D_ht'}, 'dst': {'congruent': 8, 'same': False, 'type': 'addresses_normal_ht'}, 'OP': 'REPM'}
{'36': 21829}
