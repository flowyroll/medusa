...
push %rdi
push %rsi
lea addresses_WT_ht+0x1429a, %rsi
lea addresses_A_ht+0x3f32, %rdi
and %rbx, %rbx
mov $71, %rcx
rep movsq
nop
...
nop
and %r8, %r8
lea addresses_UC_ht+0x1309a, %rsi
nop
nop
nop
nop
...
nop
and $30157, %r15
lea addresses_A_ht+0x1549a, %rdi
nop
nop
nop
nop
...
movq %rcx, (%rdi)
dec %r15
lea addresses_WT_ht+0x1409a, %r15
clflush (%r15)
and %rbx, %rbx
movb $0x61, (%r15)
nop
...
nop
and %rdi, %rdi
lea addresses_normal_ht+0x1b09a, %rbx
inc %r9
movl $0x61626364, (%rbx)
nop
nop
xor $15035, %r9
lea addresses_D_ht+0xce25, %rsi
lea addresses_D_ht+0x5b1a, %rdi
nop
nop
nop
nop
...
nop
sub %rbp, %rbp
lea addresses_WT_ht+0x11bce, %rsi
lea addresses_D_ht+0x47c2, %rdi
nop
nop
nop
nop
...
{'src': {'same': True, 'congruent': 1, 'type': 'addresses_WT_ht'}, 'OP': 'REPM', 'dst': {'same': False, 'congruent': 2, 'type': 'addresses_D_ht'}}
{'36': 21829}
