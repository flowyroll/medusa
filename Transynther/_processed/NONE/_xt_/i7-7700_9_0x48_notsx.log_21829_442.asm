...
push %rdi
push %rsi
lea addresses_D_ht+0x15ff9, %rbp
nop
xor $65503, %r8
...
nop
add $11434, %r12
lea addresses_normal_ht+0x87b1, %r8
nop
sub %rbx, %rbx
...
nop
inc %r12
lea addresses_WC_ht+0xd039, %rbx
nop
nop
nop
nop
...
nop
add $61626, %r12
lea addresses_WT_ht+0x16880, %rsi
lea addresses_normal_ht+0x6579, %rdi
nop
nop
nop
dec %r8
...
nop
dec %rdi
lea addresses_WT_ht+0x1b4c9, %rcx
clflush (%rcx)
nop
nop
nop
...
nop
cmp %rdi, %rdi
lea addresses_normal_ht+0x409e, %rbp
nop
nop
nop
nop
...
vmovups %ymm6, (%rbp)
xor $43591, %rbx
lea addresses_UC_ht+0x17349, %r12
nop
inc %rdi
mov (%r12), %cx
nop
