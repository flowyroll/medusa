...
push %rdx
push %rsi
lea addresses_WC_ht+0xdbd3, %r12
nop
and $2009, %rbp
mov (%r12), %r15w
cmp $28371, %rdx
lea addresses_normal_ht+0x18093, %r14
nop
nop
nop
nop
...
nop
cmp %r8, %r8
lea addresses_A_ht+0x417b, %rsi
lea addresses_WT_ht+0xe7b, %rdi
clflush (%rsi)
nop
nop
nop
...
{'OP': 'STOR', 'dst': {'type': 'addresses_D', 'size': 2, 'AVXalign': True, 'NT': False, 'congruent': 2, 'same': False}}
...
{'OP': 'REPM', 'src': {'type': 'addresses_A_ht', 'congruent': 8, 'same': False}, 'dst': {'type': 'addresses_WT_ht', 'congruent': 10, 'same': False}}
{'36': 1191}
