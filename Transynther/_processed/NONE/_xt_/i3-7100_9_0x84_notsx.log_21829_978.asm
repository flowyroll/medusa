...
push %rdx
push %rsi
lea addresses_A_ht+0x42af, %rsi
lea addresses_WC_ht+0x1839f, %rdi
nop
and %rdx, %rdx
mov $0, %rcx
rep movsl
...
nop
and %rcx, %rcx
lea addresses_D_ht+0x1b6ff, %rax
nop
nop
dec %r8
...
vmovups %ymm2, (%rax)
sub $24750, %rcx
lea addresses_WT_ht+0x118af, %rsi
nop
nop
nop
nop
...
nop
xor %r10, %r10
lea addresses_WT_ht+0x7aaf, %rdx
cmp %r8, %r8
mov $0x6162636465666768, %r10
movq %r10, %xmm1
movups %xmm1, (%rdx)
...
nop
inc %rcx
lea addresses_UC_ht+0x6aaf, %r10
nop
nop
nop
and $19100, %rsi
...
// REPMOV
lea addresses_D+0x1d56c, %rsi
lea addresses_normal+0x14c2f, %rdi
nop
nop
nop
nop
...
{'src': {'type': 'addresses_D', 'congruent': 0, 'same': True}, 'dst': {'type': 'addresses_normal', 'congruent': 6, 'same': True}, 'OP': 'REPM'}
[Faulty Load]
{'src': {'type': 'addresses_WC', 'same': True, 'size': 2, 'congruent': 0, 'NT': False, 'AVXalign': False}, 'OP': 'LOAD'}
<gen_prepare_buffer>
{'src': {'type': 'addresses_A_ht', 'congruent': 10, 'same': False}, 'dst': {'type': 'addresses_WC_ht', 'congruent': 1, 'same': False}, 'OP': 'REPM'}
{'dst': {'type': 'addresses_D_ht', 'same': False, 'size': 32, 'congruent': 4, 'NT': False, 'AVXalign': False}, 'OP': 'STOR'}
{'dst': {'type': 'addresses_WT_ht', 'same': True, 'size': 2, 'congruent': 5, 'NT': True, 'AVXalign': False}, 'OP': 'STOR'}
