...
push %rdi
push %rsi
lea addresses_UC_ht+0xf3a9, %rsi
lea addresses_WT_ht+0x14fdb, %rdi
nop
nop
nop
nop
...
nop
sub %rax, %rax
lea addresses_WC_ht+0x1065b, %rsi
dec %rbp
vmovups (%rsi), %ymm4
...
nop
cmp %rsi, %rsi
lea addresses_UC_ht+0x13f5b, %rax
nop
nop
nop
nop
...
nop
dec %rcx
lea addresses_WC_ht+0x13203, %r8
nop
nop
nop
and %rsi, %rsi
...
nop
dec %rbp
lea addresses_A_ht+0x4f03, %rsi
lea addresses_A_ht+0x1735b, %rdi
nop
nop
nop
xor $48324, %r9
...
rep movsw
xor $37011, %rcx
lea addresses_normal_ht+0x60a1, %r9
nop
nop
xor %rdi, %rdi
mov (%r9), %r8d
...
nop
and %r9, %r9
lea addresses_UC_ht+0x13f5b, %r9
clflush (%r9)
nop
nop
nop
...
// Faulty Load
lea addresses_normal+0x1365b, %rcx
inc %r12
mov (%rcx), %r14w
lea oracles, %r12
and $0xff, %r14
