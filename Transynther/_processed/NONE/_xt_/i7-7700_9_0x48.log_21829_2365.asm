...
push %rdx
push %rsi
lea addresses_normal_ht+0x1af4f, %rbp
nop
nop
nop
nop
...
lea addresses_UC_ht+0x580f, %rdi
nop
nop
nop
xor %rbx, %rbx
...
nop
add $23892, %rsi
lea addresses_D_ht+0x7f4f, %rsi
lea addresses_normal_ht+0x1ef4f, %rdi
add %rdx, %rdx
mov $13, %rcx
rep movsb
nop
...
nop
and %rdi, %rdi
lea addresses_UC_ht+0x1274f, %rcx
nop
nop
nop
inc %rsi
movb $0x61, (%rcx)
sub %rdx, %rdx
lea addresses_UC_ht+0x1068f, %rsi
lea addresses_UC_ht+0x1276f, %rdi
nop
nop
nop
nop
...
nop
add %rdx, %rdx
lea addresses_D_ht+0x104f, %rcx
cmp %r10, %r10
movb (%rcx), %bl
nop
add $58512, %rdi
lea addresses_A_ht+0xdc2f, %rbp
nop
nop
dec %rdi
...
nop
add %rsi, %rsi
lea addresses_normal_ht+0x1374f, %rsi
...
nop
cmp %r8, %r8
lea addresses_WT_ht+0x1c74f, %rsi
nop
nop
sub %rdi, %rdi
movups (%rsi), %xmm1
...
nop
and %rbx, %rbx
lea addresses_WT_ht+0x1b11f, %r10
nop
nop
nop
nop
...
nop
xor %rdx, %rdx
lea addresses_WT_ht+0x1354f, %rsi
lea addresses_D_ht+0x8fcf, %rdi
clflush (%rsi)
nop
nop
nop
...
rep movsw
add %rdi, %rdi
lea addresses_WC_ht+0x30cf, %rdx
nop
xor $65297, %r8
movw $0x6162, (%rdx)
and $18659, %rdx
lea addresses_WT_ht+0x2401, %rsi
lea addresses_WT_ht+0x618f, %rdi
nop
nop
nop
cmp %r10, %r10
...
{'OP': 'REPM', 'src': {'type': 'addresses_UC_ht', 'congruent': 6, 'same': True}, 'dst': {'type': 'addresses_UC_ht', 'congruent': 5, 'same': False}}
...
{'OP': 'REPM', 'src': {'type': 'addresses_normal_ht', 'congruent': 11, 'same': False}, 'dst': {'type': 'addresses_UC_ht', 'congruent': 1, 'same': False}}
