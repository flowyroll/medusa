...
nop
and $14832, %rbx
lea addresses_WC_ht+0x61fe, %r15
nop
nop
nop
nop
...
nop
add %rcx, %rcx
lea addresses_WC_ht+0xb6f0, %rsi
nop
sub $16370, %rdi
movw $0x6162, (%rsi)
nop
add $20506, %r15
lea addresses_WT_ht+0x140cc, %r15
nop
nop
cmp %rsi, %rsi
movb (%r15), %bl
...
nop
and $30198, %rsi
lea addresses_WC_ht+0x1aa2e, %rdx
nop
nop
dec %rbp
mov (%rdx), %rcx
...
nop
and %rcx, %rcx
lea addresses_UC_ht+0x176fe, %rsi
nop
nop
nop
nop
...
nop
cmp %rcx, %rcx
lea addresses_WT_ht+0x11fce, %rdi
nop
nop
nop
nop
...
nop
cmp $29933, %r15
lea addresses_A_ht+0x1630e, %rdi
and %rsi, %rsi
mov (%rdi), %rbx
nop
nop
nop
inc %rbx
lea addresses_normal_ht+0x11530, %rdx
nop
sub %rcx, %rcx
movl $0x61626364, (%rdx)
cmp %r15, %r15
lea addresses_WT_ht+0x25fe, %rdi
and %r15, %r15
mov (%rdi), %ebp
cmp %rcx, %rcx
pop %rsi
...
<gen_prepare_buffer>
{'dst': {'same': False, 'congruent': 9, 'type': 'addresses_A_ht'}, 'OP': 'REPM', 'src': {'same': False, 'congruent': 6, 'type': 'addresses_WC_ht'}}
