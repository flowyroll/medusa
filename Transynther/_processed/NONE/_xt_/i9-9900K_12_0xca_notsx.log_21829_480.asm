...
push %rdx
push %rsi
lea addresses_A_ht+0x1e892, %rdi
nop
nop
nop
nop
...
nop
xor %r9, %r9
lea addresses_UC_ht+0xe300, %rsi
nop
nop
nop
nop
...
nop
dec %r13
lea addresses_D_ht+0x145ae, %r13
nop
nop
nop
nop
...
nop
mfence
lea addresses_WC_ht+0x72b6, %rcx
nop
nop
nop
nop
...
// REPMOV
lea addresses_normal+0x16b06, %rsi
lea addresses_A+0x4ef6, %rdi
clflush (%rsi)
xor $65037, %r13
mov $123, %rcx
rep movsq
...
{'OP': 'REPM', 'src': {'same': False, 'congruent': 3, 'type': 'addresses_normal'}, 'dst': {'same': False, 'congruent': 9, 'type': 'addresses_A'}}
[Faulty Load]
