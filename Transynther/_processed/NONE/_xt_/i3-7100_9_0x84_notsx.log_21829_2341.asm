...
vmovups %ymm6, (%r14)
cmp %rcx, %rcx
lea addresses_D_ht+0x18f1b, %rcx
clflush (%rcx)
nop
nop
nop
...
nop
cmp $37030, %r15
lea addresses_A_ht+0x9aca, %rsi
lea addresses_UC_ht+0x11d1b, %rdi
sub %r8, %r8
mov $40, %rcx
rep movsl
inc %rcx
lea addresses_D_ht+0x611b, %r8
nop
nop
nop
nop
...
nop
xor $3275, %r15
lea addresses_WT_ht+0x787b, %r15
nop
nop
nop
nop
...
nop
inc %r15
lea addresses_normal_ht+0x4e9f, %r15
nop
nop
and %r14, %r14
...
nop
sub $8472, %r14
lea addresses_UC_ht+0xd91b, %r14
nop
nop
nop
nop
...
vpextrq $1, %xmm7, %rcx
sub %r8, %r8
lea addresses_UC_ht+0xceb3, %rax
clflush (%rax)
add %r14, %r14
movw $0x6162, (%rax)
and $40551, %rcx
lea addresses_UC_ht+0x851b, %rsi
nop
nop
dec %rcx
vmovups (%rsi), %ymm4
...
{'src': {'type': 'addresses_UC', 'same': True, 'size': 32, 'congruent': 0, 'NT': False, 'AVXalign': False}, 'OP': 'LOAD'}
<gen_prepare_buffer>
{'src': {'type': 'addresses_D_ht', 'congruent': 1, 'same': False}, 'dst': {'type': 'addresses_normal_ht', 'congruent': 10, 'same': False}, 'OP': 'REPM'}
...
{'src': {'type': 'addresses_A_ht', 'congruent': 0, 'same': False}, 'dst': {'type': 'addresses_UC_ht', 'congruent': 9, 'same': False}, 'OP': 'REPM'}
