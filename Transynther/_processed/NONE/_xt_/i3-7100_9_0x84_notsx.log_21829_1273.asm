...
mov (%r13), %r10d
and %rsi, %rsi
lea addresses_normal_ht+0x6d2c, %rsi
lea addresses_UC_ht+0xbd2c, %rdi
nop
sub %rbp, %rbp
mov $123, %rcx
rep movsq
cmp $49764, %r15
lea addresses_normal_ht+0x164c, %rsi
lea addresses_A_ht+0x1292c, %rdi
nop
nop
and $14006, %r10
mov $60, %rcx
...
nop
cmp $15314, %r14
lea addresses_normal_ht+0xa8ac, %rcx
clflush (%rcx)
nop
nop
nop
...
nop
sub %rcx, %rcx
lea addresses_normal_ht+0x2c6c, %r13
nop
nop
nop
nop
...
nop
cmp %r10, %r10
lea addresses_WC_ht+0x566c, %rcx
nop
nop
inc %r15
movl $0x61626364, (%rcx)
...
nop
inc %r15
lea addresses_D_ht+0x1932c, %rsi
...
nop
sub %r15, %r15
lea addresses_WT_ht+0x15d2c, %rsi
lea addresses_D_ht+0x1752c, %rdi
nop
and $56639, %r15
mov $18, %rcx
rep movsb
...
// REPMOV
lea addresses_WC+0x39ca, %rsi
lea addresses_WT+0x17e9c, %rdi
clflush (%rdi)
nop
nop
nop
...
{'src': {'type': 'addresses_WC', 'congruent': 1, 'same': False}, 'dst': {'type': 'addresses_WT', 'congruent': 4, 'same': False}, 'OP': 'REPM'}
[Faulty Load]
...
{'src': {'type': 'addresses_normal_ht', 'congruent': 0, 'same': True}, 'dst': {'type': 'addresses_A_ht', 'congruent': 8, 'same': False}, 'OP': 'REPM'}
...
{'src': {'type': 'addresses_A_ht', 'same': False, 'size': 16, 'congruent': 7, 'NT': False, 'AVXalign': True}, 'OP': 'LOAD'}
