...
push %rdi
push %rsi
lea addresses_normal_ht+0xea6c, %rsi
nop
nop
add $14516, %rdi
mov (%rsi), %ecx
...
nop
sub %r13, %r13
lea addresses_A_ht+0x3b44, %rsi
lea addresses_A_ht+0x1e684, %rdi
clflush (%rsi)
nop
xor $30065, %r9
mov $75, %rcx
...
{'OP': 'STOR', 'dst': {'size': 32, 'NT': True, 'type': 'addresses_D', 'same': False, 'AVXalign': False, 'congruent': 3}}
