...
lea addresses_UC_ht+0x1c050, %rdi
nop
nop
nop
nop
...
nop
add %rsi, %rsi
lea addresses_normal_ht+0x18b3e, %rsi
lea addresses_WT_ht+0x1811e, %rdi
nop
sub $1786, %r14
mov $26, %rcx
rep movsw
...
nop
xor $52378, %rcx
lea addresses_normal_ht+0x19d1e, %rsi
lea addresses_UC_ht+0xb050, %rdi
nop
nop
xor $30342, %r15
mov $110, %rcx
...
nop
cmp $43691, %rsi
lea addresses_WT_ht+0x5d50, %rcx
nop
nop
nop
nop
...
// Store
lea addresses_normal+0x6c50, %r9
nop
xor $36597, %rdx
...
{'src': {'congruent': 0, 'same': False, 'type': 'addresses_normal_ht'}, 'dst': {'congruent': 8, 'same': False, 'type': 'addresses_UC_ht'}, 'OP': 'REPM'}
