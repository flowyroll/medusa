...
push %rdi
push %rsi
lea addresses_WT_ht+0x13188, %rsi
lea addresses_WT_ht+0x7b88, %rdi
nop
nop
nop
nop
...
nop
dec %rsi
lea addresses_A_ht+0x198bc, %rbp
nop
nop
nop
sub $37650, %rax
...
nop
cmp $33055, %rax
lea addresses_UC_ht+0xcf08, %rsi
nop
nop
nop
nop
...
nop
cmp %rbp, %rbp
lea addresses_normal_ht+0x14a10, %r12
nop
nop
add $54543, %r14
...
nop
sub %r12, %r12
lea addresses_WC_ht+0x10388, %r14
nop
nop
nop
nop
...
nop
sub %rcx, %rcx
lea addresses_UC_ht+0x18a18, %r14
cmp $37106, %rbp
mov (%r14), %rdi
nop
cmp %rsi, %rsi
lea addresses_WT_ht+0x1cb88, %r14
nop
nop
inc %rbp
vmovups (%r14), %ymm3
...
<gen_prepare_buffer>
{'OP': 'REPM', 'src': {'type': 'addresses_WT_ht', 'congruent': 8, 'same': True}, 'dst': {'type': 'addresses_WT_ht', 'congruent': 11, 'same': False}}
...
{'OP': 'STOR', 'dst': {'type': 'addresses_normal_ht', 'size': 8, 'AVXalign': True, 'NT': False, 'congruent': 3, 'same': True}}
{'OP': 'STOR', 'dst': {'type': 'addresses_WC_ht', 'size': 4, 'AVXalign': False, 'NT': False, 'congruent': 11, 'same': False}}
{'OP': 'LOAD', 'src': {'type': 'addresses_UC_ht', 'size': 8, 'AVXalign': True, 'NT': False, 'congruent': 4, 'same': False}}
