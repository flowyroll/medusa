...
push %rdi
push %rsi
lea addresses_UC_ht+0x1d9f7, %rsi
lea addresses_normal_ht+0xe5f7, %rdi
nop
nop
nop
nop
...
nop
sub $40877, %rbx
lea addresses_WT_ht+0x12375, %rsi
lea addresses_UC_ht+0x18277, %rdi
sub $32894, %rbx
mov $102, %rcx
rep movsl
nop
...
nop
sub $1852, %rax
lea addresses_UC_ht+0x1bda9, %rcx
clflush (%rcx)
nop
nop
nop
...
<gen_prepare_buffer>
{'src': {'type': 'addresses_UC_ht', 'congruent': 7, 'same': False}, 'OP': 'REPM', 'dst': {'type': 'addresses_normal_ht', 'congruent': 7, 'same': True}}
