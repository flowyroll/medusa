...
nop
and $32792, %rcx
lea addresses_normal_ht+0x13164, %rsi
lea addresses_UC_ht+0x1df5c, %rdi
nop
nop
nop
nop
...
nop
dec %rcx
lea addresses_UC_ht+0x12df4, %rsi
lea addresses_D_ht+0x601c, %rdi
clflush (%rsi)
nop
nop
and $36220, %rbx
...
nop
add %rdx, %rdx
lea addresses_normal_ht+0xaee4, %rsi
lea addresses_WC_ht+0x70a4, %rdi
nop
nop
sub $42603, %rdx
mov $77, %rcx
...
nop
dec %r14
lea addresses_normal_ht+0x9b84, %rsi
lea addresses_UC_ht+0x1541e, %rdi
nop
nop
add $28933, %rbx
mov $63, %rcx
...
nop
cmp %r15, %r15
lea addresses_WC_ht+0x2b3c, %rsi
lea addresses_WT_ht+0x1e924, %rdi
clflush (%rsi)
nop
sub %rbp, %rbp
mov $1, %rcx
...
nop
inc %rbp
lea addresses_D_ht+0x1a9e4, %r14
nop
nop
nop
sub %rbp, %rbp
...
movups %xmm0, (%r14)
sub %rdx, %rdx
lea addresses_D_ht+0x5ce4, %rbp
nop
xor %rbx, %rbx
mov (%rbp), %r14
nop
xor $30712, %r15
lea addresses_WT_ht+0x1164, %rcx
nop
xor %r14, %r14
mov (%rcx), %rbp
nop
...
nop
cmp %rcx, %rcx
lea addresses_WC_ht+0x12f64, %rbx
nop
nop
nop
add $2968, %rdi
...
// Store
lea addresses_UC+0x16079, %rdx
dec %rsi
movl $0x51525354, (%rdx)
sub %rdx, %rdx

// Store
mov $0x7fd12f0000000b64, %rbx
nop
nop
nop
nop
...
{'OP': 'REPM', 'src': {'same': False, 'congruent': 5, 'type': 'addresses_A_ht'}, 'dst': {'same': False, 'congruent': 1, 'type': 'addresses_D_ht'}}
{'OP': 'REPM', 'src': {'same': True, 'congruent': 10, 'type': 'addresses_normal_ht'}, 'dst': {'same': False, 'congruent': 0, 'type': 'addresses_UC_ht'}}
...
{'OP': 'REPM', 'src': {'same': False, 'congruent': 4, 'type': 'addresses_normal_ht'}, 'dst': {'same': True, 'congruent': 1, 'type': 'addresses_UC_ht'}}
{'OP': 'REPM', 'src': {'same': False, 'congruent': 3, 'type': 'addresses_WC_ht'}, 'dst': {'same': False, 'congruent': 6, 'type': 'addresses_WT_ht'}}
