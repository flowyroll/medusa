...
push %rdi
push %rsi
lea addresses_UC_ht+0x137c3, %rsi
lea addresses_WC_ht+0x14759, %rdi
nop
nop
nop
nop
...
nop
and $22065, %rcx
lea addresses_WC_ht+0x1a99, %r15
nop
nop
nop
and $332, %r8
...
nop
cmp $1756, %r8
lea addresses_A_ht+0x14d9, %rsi
lea addresses_D_ht+0x1d7bf, %rdi
add %r9, %r9
mov $118, %rcx
rep movsb
nop
...
nop
cmp %rsi, %rsi
lea addresses_UC_ht+0x4b59, %rsi
nop
nop
nop
nop
...
nop
xor $38861, %rcx
lea addresses_D_ht+0xd919, %rdi
xor %rcx, %rcx
vmovups (%rdi), %ymm2
vextracti128 $0, %ymm2, %xmm2
vpextrq $0, %xmm2, %r8
and %r8, %r8
lea addresses_WC_ht+0xcf59, %rsi
and $54112, %rdi
...
nop
cmp $33072, %rbp
lea addresses_normal_ht+0xb801, %rcx
cmp %r9, %r9
...
// Store
lea addresses_normal+0x359, %rdx
nop
nop
and %r12, %r12
movb $0x51, (%rdx)
...
// Faulty Load
lea addresses_normal+0x3f59, %rdx
cmp %r13, %r13
movb (%rdx), %r11b
lea oracles, %rsi
and $0xff, %r11
...
<gen_prepare_buffer>
{'OP': 'REPM', 'src': {'type': 'addresses_UC_ht', 'congruent': 1, 'same': False}, 'dst': {'type': 'addresses_WC_ht', 'congruent': 9, 'same': True}}
...
{'OP': 'REPM', 'src': {'type': 'addresses_A_ht', 'congruent': 7, 'same': False}, 'dst': {'type': 'addresses_D_ht', 'congruent': 1, 'same': True}}
