...
push %rdx
push %rsi
lea addresses_normal_ht+0x9a78, %rdx
nop
nop
nop
nop
...
nop
add %r12, %r12
lea addresses_WT_ht+0x11078, %rbx
nop
xor %rdi, %rdi
...
nop
sub $31354, %r8
lea addresses_A_ht+0x1278, %rdx
sub $8348, %r9
movb (%rdx), %r13b
cmp $9445, %rdi
lea addresses_UC_ht+0xda78, %r8
nop
nop
xor %r9, %r9
mov (%r8), %r13w
xor $20850, %rbx
lea addresses_D_ht+0x628, %rbx
nop
xor %r12, %r12
...
lea addresses_WT_ht+0x1e578, %rdi
inc %rdx
mov $96, %rcx
rep movsl
nop
...
nop
sub $51138, %rcx
lea addresses_normal_ht+0x178, %r8
xor %rcx, %rcx
...
{'dst': {'same': False, 'congruent': 7, 'type': 'addresses_WT_ht'}, 'OP': 'REPM', 'src': {'same': False, 'congruent': 8, 'type': 'addresses_D_ht'}}
