...
push %rdi
push %rsi
lea addresses_normal_ht+0x15946, %rsi
lea addresses_UC_ht+0x3f0a, %rdi
nop
nop
nop
nop
...
rep movsl
inc %r11
lea addresses_WC_ht+0x1a62a, %rsi
lea addresses_A_ht+0x6092, %rdi
nop
nop
nop
inc %rbp
...
rep movsq
cmp $55526, %rbx
lea addresses_A_ht+0x9fa2, %rdi
xor $36861, %rbp
vmovups (%rdi), %ymm1
vextracti128 $0, %ymm1, %xmm1
vpextrq $1, %xmm1, %r11
sub $52257, %rbx
lea addresses_D_ht+0x10592, %rsi
nop
nop
xor $42414, %rbp
...
<gen_prepare_buffer>
{'src': {'type': 'addresses_normal_ht', 'congruent': 2, 'same': True}, 'OP': 'REPM', 'dst': {'type': 'addresses_UC_ht', 'congruent': 3, 'same': False}}
{'src': {'type': 'addresses_WC_ht', 'congruent': 3, 'same': False}, 'OP': 'REPM', 'dst': {'type': 'addresses_A_ht', 'congruent': 8, 'same': False}}
