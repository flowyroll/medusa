...
push %rdi
push %rsi
lea addresses_WT_ht+0x73bd, %rbx
nop
nop
nop
nop
...
nop
and %r13, %r13
lea addresses_WC_ht+0x19485, %rsi
lea addresses_D_ht+0xa9bd, %rdi
nop
nop
nop
nop
...
nop
cmp %r10, %r10
lea addresses_D_ht+0x1bfbd, %rcx
clflush (%rcx)
nop
nop
nop
...
nop
and $47926, %rsi
lea addresses_normal_ht+0x1b6ad, %rcx
nop
add %r10, %r10
movw $0x6162, (%rcx)
nop
...
nop
xor %r10, %r10
lea addresses_A_ht+0xe5bd, %rsi
lea addresses_A_ht+0x1465d, %rdi
nop
cmp %r13, %r13
mov $63, %rcx
rep movsq
...
nop
xor $43223, %rcx
lea addresses_D_ht+0x177bd, %r13
nop
and %rsi, %rsi
...
nop
inc %r13
lea addresses_WC_ht+0xa139, %rsi
lea addresses_normal_ht+0x6991, %rdi
clflush (%rsi)
nop
nop
nop
...
nop
inc %rsi
lea addresses_D_ht+0xa425, %rsi
lea addresses_WT_ht+0x1837d, %rdi
nop
nop
nop
nop
...
nop
add $61096, %rcx
lea addresses_UC_ht+0x557d, %r11
nop
nop
nop
cmp $16782, %r13
...
nop
inc %r11
lea addresses_WC_ht+0x1ec1b, %r13
clflush (%r13)
nop
xor $50242, %r14
mov (%r13), %r11
...
nop
mfence
lea addresses_A_ht+0x1b6bd, %rsi
lea addresses_A_ht+0x15a7d, %rdi
nop
nop
nop
nop
...
nop
cmp $33270, %rcx
lea addresses_UC_ht+0x73bd, %r14
nop
nop
nop
cmp %r13, %r13
...
nop
cmp %r13, %r13
lea addresses_WT_ht+0xba8d, %rsi
...
// Load
lea addresses_normal+0x1eeb5, %rbx
nop
nop
nop
and %rbp, %rbp
...
{'src': {'type': 'addresses_A_ht', 'congruent': 11, 'same': False}, 'OP': 'REPM', 'dst': {'type': 'addresses_A_ht', 'congruent': 5, 'same': False}}
...
{'src': {'type': 'addresses_WC_ht', 'congruent': 2, 'same': False}, 'OP': 'REPM', 'dst': {'type': 'addresses_normal_ht', 'congruent': 2, 'same': False}}
...
{'src': {'type': 'addresses_A_ht', 'congruent': 8, 'same': False}, 'OP': 'REPM', 'dst': {'type': 'addresses_A_ht', 'congruent': 5, 'same': False}}
{'src': {'type': 'addresses_UC_ht', 'AVXalign': False, 'size': 16, 'NT': False, 'same': False, 'congruent': 8}, 'OP': 'LOAD'}
{'src': {'type': 'addresses_WT_ht', 'congruent': 4, 'same': False}, 'OP': 'REPM', 'dst': {'type': 'addresses_D_ht', 'congruent': 11, 'same': False}}
{'38': 21829}
