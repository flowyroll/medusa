...
nop
sub %r13, %r13
lea addresses_normal_ht+0xa63b, %r12
cmp %rcx, %rcx
mov (%r12), %r14w
nop
nop
cmp %rdi, %rdi
lea addresses_WT_ht+0x168bb, %rdi
nop
nop
nop
nop
...
nop
and $15605, %r15
lea addresses_D_ht+0x1c7fb, %rdi
nop
xor $42406, %rcx
mov (%rdi), %r14
nop
...
nop
and %r14, %r14
lea addresses_WT_ht+0x1d93b, %rax
nop
nop
nop
nop
