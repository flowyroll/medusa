...
nop
inc %r8
lea addresses_WT_ht+0x19d93, %rsi
lea addresses_normal_ht+0x12193, %rdi
clflush (%rsi)
nop
nop
cmp %rdx, %rdx
...
lea addresses_WC_ht+0x1b62b, %rdi
nop
sub %r9, %r9
mov $95, %rcx
rep movsl
...
nop
sub %rsi, %rsi
lea addresses_normal_ht+0x1bb33, %rbp
nop
nop
nop
nop
...
nop
xor $29036, %r9
lea addresses_WC_ht+0x1a25b, %rdi
nop
nop
nop
nop
...
nop
add %rdi, %rdi
lea addresses_A_ht+0x9093, %rsi
lea addresses_WT_ht+0x1b186, %rdi
nop
nop
nop
inc %r9
...
nop
dec %rbx
lea addresses_WC_ht+0xa7ab, %rcx
nop
nop
nop
nop
...
mov (%rcx), %rsi
add $21289, %rbx
lea addresses_WC_ht+0x11193, %rsi
...
nop
and %rdi, %rdi
lea addresses_WT_ht+0x3993, %rsi
lea addresses_D_ht+0x1ba93, %rdi
nop
nop
nop
nop
...
nop
sub $27057, %rdi
lea addresses_A_ht+0x112b3, %rdi
nop
nop
xor %r9, %r9
movb $0x61, (%rdi)
