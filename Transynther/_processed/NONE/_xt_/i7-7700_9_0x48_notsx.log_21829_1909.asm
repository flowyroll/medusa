...
nop
mfence
lea addresses_normal_ht+0x1e3df, %r11
nop
nop
nop
nop
...
nop
sub $33670, %r8
lea addresses_WC_ht+0x121ef, %r11
nop
sub %r15, %r15
movups (%r11), %xmm3
vpextrq $0, %xmm3, %r12
...
// Store
lea addresses_normal+0x192f, %rdx
clflush (%rdx)
dec %r10
movl $0x51525354, (%rdx)
nop
