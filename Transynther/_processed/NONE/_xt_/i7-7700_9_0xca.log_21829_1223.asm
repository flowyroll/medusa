...
push %rdx
push %rsi
lea addresses_WC_ht+0x834b, %r15
nop
nop
nop
nop
...
nop
xor %r15, %r15
lea addresses_WC_ht+0x2757, %rdx
nop
nop
nop
nop
...
movl $0x61626364, (%rdx)
xor %r15, %r15
lea addresses_A_ht+0x105eb, %r9
cmp %rsi, %rsi
mov (%r9), %cx
nop
add $48209, %rcx
lea addresses_A_ht+0x1363, %rdi
nop
nop
nop
nop
...
// Store
lea addresses_normal+0x15e8b, %rdi
clflush (%rdi)
nop
nop
nop
...
{'OP': 'STOR', 'dst': {'congruent': 2, 'AVXalign': False, 'same': False, 'size': 4, 'NT': True, 'type': 'addresses_WC_ht'}}
