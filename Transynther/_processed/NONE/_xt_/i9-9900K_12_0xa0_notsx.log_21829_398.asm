...
lea addresses_WC_ht+0x145fe, %rdi
nop
nop
nop
nop
...
nop
and $16472, %rsi
lea addresses_WC_ht+0xbf81, %rcx
nop
nop
add %r12, %r12
movw $0x6162, (%rcx)
...
nop
sub $32172, %r12
lea addresses_WT_ht+0x117c4, %r9
nop
nop
inc %rsi
mov (%r9), %ecx
...
movb (%rsi), %r9b
add $18830, %rcx
lea addresses_UC_ht+0x1071e, %rcx
nop
add %rdi, %rdi
movb $0x61, (%rcx)
sub $22820, %r12
lea addresses_WC_ht+0x11a9e, %rsi
lea addresses_WC_ht+0x531e, %rdi
nop
nop
nop
nop
...
movb (%rsi), %cl
and $54915, %r12
lea addresses_WT_ht+0x1591e, %r12
nop
nop
nop
xor $63831, %r9
...
// Load
mov $0xc55bd0000000f5e, %rdi
dec %rdx
movb (%rdi), %r10b
cmp %r10, %r10

// Faulty Load
lea addresses_D+0x9f1e, %r15
nop
xor $31397, %rbx
movb (%r15), %r10b
lea oracles, %r15
...
{'src': {'type': 'addresses_NC', 'AVXalign': False, 'size': 1, 'NT': False, 'same': False, 'congruent': 5}, 'OP': 'LOAD'}
[Faulty Load]
...
{'OP': 'STOR', 'dst': {'type': 'addresses_WC_ht', 'AVXalign': False, 'size': 2, 'NT': True, 'same': False, 'congruent': 0}}
...
{'src': {'type': 'addresses_WC_ht', 'congruent': 7, 'same': False}, 'OP': 'REPM', 'dst': {'type': 'addresses_WC_ht', 'congruent': 10, 'same': False}}
