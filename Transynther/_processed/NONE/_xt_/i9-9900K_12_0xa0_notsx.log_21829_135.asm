...
push %rdi
push %rsi
lea addresses_normal_ht+0x1d5e, %r12
sub $51075, %r8
mov (%r12), %cx
nop
nop
nop
cmp %r14, %r14
lea addresses_normal_ht+0x11eae, %r9
and %r14, %r14
mov (%r9), %di
xor %r9, %r9
lea addresses_normal_ht+0x16ede, %rsi
lea addresses_WT_ht+0x146de, %rdi
nop
nop
nop
nop
...
nop
add %rbp, %rbp
lea addresses_WT_ht+0x82de, %rsi
...
{'OP': 'STOR', 'dst': {'type': 'addresses_WT', 'AVXalign': False, 'size': 4, 'NT': True, 'same': False, 'congruent': 9}}
