...
nop
xor %rbp, %rbp
lea addresses_A_ht+0x5bee, %rsi
lea addresses_UC_ht+0x652e, %rdi
nop
nop
xor %rbp, %rbp
mov $11, %rcx
rep movsl
add $16722, %rbp
lea addresses_normal_ht+0x352e, %r12
nop
nop
nop
and %r9, %r9
...
vpextrq $0, %xmm6, %rsi
xor $58409, %r10
lea addresses_UC_ht+0xcc2e, %r12
clflush (%r12)
nop
nop
nop
...
nop
xor $5916, %rdi
lea addresses_normal_ht+0x1e0e, %r10
nop
nop
nop
nop
...
nop
add $32221, %rdi
lea addresses_normal_ht+0x884e, %rdi
xor $46870, %rax
mov (%rdi), %edx
nop
nop
nop
cmp %rdx, %rdx
lea addresses_WC_ht+0xc22e, %rsi
lea addresses_UC_ht+0x7aee, %rdi
nop
nop
nop
nop
...
// Store
lea addresses_WT+0xd62e, %r15
cmp $11717, %r8
movw $0x5152, (%r15)
sub $58856, %r12

// Faulty Load
lea addresses_D+0x1f52e, %r11
nop
nop
inc %r8
mov (%r11), %ax
...
{'src': {'type': 'addresses_A_ht', 'congruent': 4, 'same': False}, 'dst': {'type': 'addresses_UC_ht', 'congruent': 9, 'same': False}, 'OP': 'REPM'}
{'src': {'type': 'addresses_normal_ht', 'same': True, 'size': 16, 'congruent': 11, 'NT': False, 'AVXalign': False}, 'OP': 'LOAD'}
