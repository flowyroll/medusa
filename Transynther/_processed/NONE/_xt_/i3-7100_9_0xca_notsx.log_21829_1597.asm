...
push %rdi
push %rsi
lea addresses_normal_ht+0xb329, %rsi
lea addresses_normal_ht+0x100b9, %rdi
nop
nop
nop
lfence
...
nop
sub %r8, %r8
lea addresses_UC_ht+0x1c3b9, %rsi
nop
nop
xor %rdi, %rdi
movl $0x61626364, (%rsi)
...
nop
dec %rsi
lea addresses_WT_ht+0xd7f9, %rsi
lea addresses_UC_ht+0x15a3d, %rdi
nop
cmp %r8, %r8
mov $101, %rcx
rep movsl
...
nop
dec %r8
lea addresses_normal_ht+0x7639, %rsi
lea addresses_D_ht+0x1e9e0, %rdi
xor $16898, %r11
mov $71, %rcx
rep movsw
nop
...
// Store
lea addresses_normal+0x117bd, %rcx
xor %rbp, %rbp
...
<gen_prepare_buffer>
{'src': {'type': 'addresses_normal_ht', 'congruent': 1, 'same': False}, 'OP': 'REPM', 'dst': {'type': 'addresses_normal_ht', 'congruent': 7, 'same': False}}
