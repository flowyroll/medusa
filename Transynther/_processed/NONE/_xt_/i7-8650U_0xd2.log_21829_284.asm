...
push %rdi
push %rsi
lea addresses_normal_ht+0x167d3, %rsi
lea addresses_WC_ht+0x57d3, %rdi
clflush (%rdi)
add $58866, %r15
mov $94, %rcx
rep movsb
nop
add $13735, %rdi
lea addresses_WT_ht+0xfcb1, %rsi
lea addresses_normal_ht+0x1cf73, %rdi
clflush (%rsi)
nop
nop
nop
...
nop
sub %rsi, %rsi
lea addresses_normal_ht+0x4bd3, %r10
cmp %r11, %r11
movups (%r10), %xmm3
vpextrq $1, %xmm3, %r15
nop
...
nop
inc %rcx
lea addresses_WT_ht+0x1a77b, %rsi
lea addresses_WT_ht+0x3d53, %rdi
and %r11, %r11
mov $3, %rcx
rep movsl
nop
nop
add $1919, %r10
lea addresses_normal_ht+0xc3d3, %rsi
lea addresses_WC_ht+0x97d3, %rdi
clflush (%rdi)
nop
nop
mfence
...
nop
and $12934, %r15
lea addresses_WT_ht+0x43d3, %r15
nop
nop
lfence
mov (%r15), %ecx
sub $53934, %rcx
lea addresses_UC_ht+0x1a053, %r11
nop
add $45040, %r10
movl $0x61626364, (%r11)
nop
nop
and $33249, %r15
lea addresses_WC_ht+0xbdf3, %rsi
lea addresses_UC_ht+0x1e09f, %rdi
nop
add %r9, %r9
mov $122, %rcx
rep movsq
...
nop
sub %rcx, %rcx
lea addresses_D_ht+0x13c03, %r10
nop
cmp %rcx, %rcx
movw $0x6162, (%r10)
nop
...
nop
add %rcx, %rcx
lea addresses_normal_ht+0x1e3f3, %rsi
nop
nop
and %rcx, %rcx
movb $0x61, (%rsi)
...
{'OP': 'REPM', 'src': {'type': 'addresses_WT_ht', 'congruent': 1, 'same': False}, 'dst': {'type': 'addresses_normal_ht', 'congruent': 4, 'same': False}}
{'OP': 'LOAD', 'src': {'type': 'addresses_normal_ht', 'size': 16, 'AVXalign': False, 'NT': False, 'congruent': 11, 'same': True}}
{'OP': 'REPM', 'src': {'type': 'addresses_WT_ht', 'congruent': 2, 'same': False}, 'dst': {'type': 'addresses_WT_ht', 'congruent': 4, 'same': False}}
