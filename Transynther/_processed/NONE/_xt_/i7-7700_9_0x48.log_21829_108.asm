...
push %rdx
push %rsi
lea addresses_D_ht+0x14464, %rsi
lea addresses_D_ht+0x119a4, %rdi
nop
dec %r15
mov $27, %rcx
rep movsl
...
nop
and %r14, %r14
lea addresses_WT_ht+0x11a2c, %r10
add $23022, %rbp
mov $0x6162636465666768, %r14
movq %r14, %xmm6
movups %xmm6, (%r10)
and $56328, %rdi
lea addresses_WC_ht+0xc64, %r14
nop
nop
nop
nop
...
nop
add %rbp, %rbp
lea addresses_normal_ht+0x14eb9, %rcx
nop
and $2783, %r15
mov (%rcx), %di
nop
add %rbp, %rbp
lea addresses_WT_ht+0xc764, %r14
nop
nop
nop
dec %r10
...
nop
add $32625, %r10
lea addresses_D_ht+0xba64, %rsi
lea addresses_D_ht+0x17ee4, %rdi
nop
nop
nop
xor %r15, %r15
...
nop
mfence
lea addresses_WT_ht+0xf0a4, %rcx
clflush (%rcx)
nop
and %r10, %r10
movw $0x6162, (%rcx)
nop
xor %rcx, %rcx
lea addresses_UC_ht+0x35d8, %rcx
clflush (%rcx)
nop
nop
nop
...
nop
sub %r10, %r10
lea addresses_D_ht+0x1a47c, %rsi
lea addresses_WT_ht+0x1848c, %rdi
nop
dec %rdx
mov $115, %rcx
rep movsw
...
nop
add $39625, %rbp
lea addresses_WC_ht+0x100d4, %rsi
lea addresses_WC_ht+0x17c6c, %rdi
nop
nop
nop
nop
...
nop
inc %rdi
lea addresses_WT_ht+0x3864, %rsi
nop
xor %rcx, %rcx
...
// Faulty Load
lea addresses_normal+0xc064, %rcx
clflush (%rcx)
nop
nop
nop
...
{'OP': 'LOAD', 'src': {'type': 'addresses_WC_ht', 'AVXalign': False, 'congruent': 9, 'size': 32, 'same': False, 'NT': True}}
...
{'OP': 'REPM', 'src': {'type': 'addresses_D_ht', 'congruent': 9, 'same': False}, 'dst': {'type': 'addresses_D_ht', 'congruent': 7, 'same': True}}
