...
nop
inc %rdx
lea addresses_WC_ht+0x1ec12, %rsi
lea addresses_normal_ht+0x58a2, %rdi
nop
nop
nop
nop
...
nop
xor %rdx, %rdx
lea addresses_D_ht+0x156a2, %rdi
nop
nop
nop
nop
...
nop
sub $25839, %r9
lea addresses_A_ht+0x2862, %rsi
lea addresses_WT_ht+0x53e2, %rdi
nop
nop
nop
nop
...
nop
cmp %rbx, %rbx
lea addresses_UC_ht+0x12ba2, %rbx
nop
nop
nop
xor %r9, %r9
...
nop
and %r9, %r9
lea addresses_WC_ht+0x1537e, %rbx
nop
nop
nop
nop
...
movw $0x6162, (%rbx)
sub $31715, %r9
lea addresses_normal_ht+0x1daba, %rsi
...
nop
cmp %rbx, %rbx
lea addresses_WT_ht+0x179e2, %rdx
nop
nop
add $45744, %r15
mov (%rdx), %r9
cmp %rsi, %rsi
lea addresses_A_ht+0xc9d3, %rsi
lea addresses_UC_ht+0x10262, %rdi
add %rdx, %rdx
mov $32, %rcx
rep movsl
inc %rdi
lea addresses_normal_ht+0x156a2, %rcx
nop
and $15935, %rbp
...
nop
sub %rcx, %rcx
lea addresses_WT_ht+0x6434, %rdx
nop
inc %rbx
mov (%rdx), %r15d
nop
...
{'src': {'type': 'addresses_A_ht', 'congruent': 0, 'same': True}, 'dst': {'type': 'addresses_UC_ht', 'congruent': 6, 'same': False}, 'OP': 'REPM'}
...
{'dst': {'type': 'addresses_A_ht', 'same': False, 'size': 32, 'congruent': 3, 'NT': False, 'AVXalign': True}, 'OP': 'STOR'}
{'37': 21829}
