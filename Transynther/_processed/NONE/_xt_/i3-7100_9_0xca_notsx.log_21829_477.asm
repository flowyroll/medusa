...
push %rdx
push %rsi
lea addresses_normal_ht+0x2f82, %r11
clflush (%r11)
nop
nop
nop
...
nop
inc %r9
lea addresses_WT_ht+0x82e2, %rsi
lea addresses_D_ht+0xad42, %rdi
nop
nop
nop
dec %rdx
...
nop
cmp %rdi, %rdi
lea addresses_normal_ht+0x7642, %rbp
nop
nop
nop
nop
...
nop
add $61473, %r11
lea addresses_WC_ht+0x161c2, %rsi
lea addresses_A_ht+0xdac2, %rdi
nop
nop
inc %rax
mov $73, %rcx
