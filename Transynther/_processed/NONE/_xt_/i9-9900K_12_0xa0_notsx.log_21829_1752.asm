...
lea addresses_normal_ht+0x4e0c, %rdi
nop
nop
nop
add $19078, %rbx
...
nop
inc %rcx
lea addresses_UC_ht+0x48aa, %rax
sub %rdi, %rdi
...
nop
xor %rbx, %rbx
lea addresses_WT_ht+0xb2a, %rsi
lea addresses_UC_ht+0x14b7a, %rdi
nop
nop
nop
nop
...
nop
dec %r14
lea addresses_A_ht+0x9caa, %rsi
lea addresses_D_ht+0x7c02, %rdi
nop
nop
nop
cmp %r14, %r14
...
nop
cmp $46670, %r14
lea addresses_normal_ht+0x14c2a, %rsi
lea addresses_normal_ht+0x7c1a, %rdi
nop
nop
nop
nop
...
// Store
lea addresses_A+0x652a, %r11
sub %rcx, %rcx
movw $0x5152, (%r11)
sub $2457, %r9

// Faulty Load
lea addresses_UC+0x1a4aa, %r13
dec %rbp
mov (%r13), %rcx
lea oracles, %r11
and $0xff, %rcx
...
{'src': {'type': 'addresses_WT_ht', 'congruent': 6, 'same': False}, 'OP': 'REPM', 'dst': {'type': 'addresses_UC_ht', 'congruent': 2, 'same': False}}
