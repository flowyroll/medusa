...
nop
add %rdi, %rdi
lea addresses_normal_ht+0x595c, %rax
nop
inc %rsi
mov (%rax), %r13
nop
nop
sub $58559, %rsi
lea addresses_WC_ht+0x14bc6, %rax
nop
nop
nop
nop
...
nop
xor $54204, %rdi
lea addresses_WC_ht+0x1b334, %rsi
lea addresses_A_ht+0x17e74, %rdi
nop
nop
nop
cmp $62623, %rdx
...
rep movsb
sub %rdx, %rdx
lea addresses_UC_ht+0x1a074, %rsi
...
nop
sub $14011, %rcx
lea addresses_WT_ht+0xaf6c, %rdi
add $46643, %r13
vmovups (%rdi), %ymm3
...
nop
and %rsi, %rsi
lea addresses_WC_ht+0xccfa, %rsi
lea addresses_WC_ht+0x471c, %rdi
nop
nop
nop
nop
...
// Store
lea addresses_normal+0x1b234, %rdi
nop
nop
nop
add %rax, %rax
...
<gen_prepare_buffer>
{'src': {'NT': False, 'AVXalign': False, 'size': 32, 'congruent': 9, 'same': True, 'type': 'addresses_UC_ht'}, 'OP': 'LOAD'}
...
{'src': {'congruent': 11, 'same': False, 'type': 'addresses_UC_ht'}, 'dst': {'congruent': 7, 'same': False, 'type': 'addresses_WC_ht'}, 'OP': 'REPM'}
