...
push %rdx
push %rsi
lea addresses_normal_ht+0x6566, %rbp
nop
nop
nop
sub $29608, %r12
mov (%rbp), %r11d
and $9602, %rdx
lea addresses_WT_ht+0x6052, %rsi
lea addresses_D_ht+0x1539a, %rdi
nop
nop
nop
inc %rbx
...
nop
dec %r12
lea addresses_A_ht+0x11f42, %rdi
nop
nop
nop
dec %r11
...
nop
add $28832, %rdi
lea addresses_UC_ht+0x1a149, %rbx
nop
nop
nop
sub %rdi, %rdi
...
nop
add %rsi, %rsi
lea addresses_WT_ht+0x15052, %r12
clflush (%r12)
xor %rbp, %rbp
mov (%r12), %edx
add $44701, %rbx
lea addresses_UC_ht+0xc6d2, %r11
and %r12, %r12
movb (%r11), %dl
nop
cmp $28250, %rbx
lea addresses_WT_ht+0x52, %rcx
nop
and %rbp, %rbp
movw $0x6162, (%rcx)
nop
...
{'OP': 'STOR', 'dst': {'size': 16, 'NT': False, 'type': 'addresses_UC_ht', 'same': False, 'AVXalign': True, 'congruent': 0}}
{'OP': 'LOAD', 'src': {'size': 4, 'NT': False, 'type': 'addresses_WT_ht', 'same': False, 'AVXalign': False, 'congruent': 11}}
{'OP': 'LOAD', 'src': {'size': 1, 'NT': False, 'type': 'addresses_UC_ht', 'same': False, 'AVXalign': True, 'congruent': 7}}
