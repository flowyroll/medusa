...
lea addresses_UC_ht+0xf97f, %rdi
cmp %r14, %r14
mov $127, %rcx
rep movsl
nop
cmp $62119, %rcx
lea addresses_WT_ht+0xd94f, %rax
nop
cmp %r8, %r8
...
nop
add $6458, %rsi
lea addresses_normal_ht+0x23ef, %r14
nop
cmp $9208, %rdi
movb $0x61, (%r14)
nop
...
lea addresses_WT_ht+0x1a21f, %rdi
nop
nop
nop
nop
...
nop
dec %rdi
lea addresses_normal_ht+0xeb2f, %rsi
lea addresses_WC_ht+0x17d0f, %rdi
clflush (%rdi)
nop
nop
nop
...
vmovntdq %ymm1, (%rcx)
inc %r14
lea addresses_WC_ht+0x16a6f, %rsi
lea addresses_normal_ht+0x718f, %rdi
nop
nop
nop
dec %r9
...
nop
sub %rax, %rax
lea addresses_A_ht+0x1950f, %rax
nop
nop
nop
nop
...
vpextrq $0, %xmm1, %rsi
xor %rsi, %rsi
lea addresses_WC_ht+0xe10f, %rcx
nop
nop
sub $2580, %r8
movups (%rcx), %xmm0
...
nop
add %rax, %rax
lea addresses_WT_ht+0xd8ef, %rcx
nop
nop
nop
nop
...
nop
and %r9, %r9
lea addresses_WC_ht+0xc1e9, %rsi
add %rcx, %rcx
mov (%rsi), %rdi
nop
nop
sub %rsi, %rsi
lea addresses_A_ht+0x6d0f, %rsi
...
{'src': {'type': 'addresses_WT_ht', 'congruent': 6, 'same': False}, 'OP': 'REPM', 'dst': {'type': 'addresses_WT_ht', 'congruent': 3, 'same': False}}
...
{'OP': 'STOR', 'dst': {'type': 'addresses_D_ht', 'AVXalign': False, 'size': 32, 'NT': True, 'same': False, 'congruent': 5}}
{'src': {'type': 'addresses_WC_ht', 'congruent': 4, 'same': False}, 'OP': 'REPM', 'dst': {'type': 'addresses_normal_ht', 'congruent': 6, 'same': False}}
...
{'src': {'type': 'addresses_A_ht', 'congruent': 11, 'same': False}, 'OP': 'REPM', 'dst': {'type': 'addresses_UC_ht', 'congruent': 6, 'same': False}}
{'37': 21829}
