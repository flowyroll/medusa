...
lea addresses_normal_ht+0x1ec5e, %rdi
nop
nop
nop
nop
...
nop
cmp %rcx, %rcx
lea addresses_normal_ht+0x122fc, %rcx
cmp $51452, %r15
mov (%rcx), %edx
nop
nop
...
nop
sub $18385, %rdx
lea addresses_UC_ht+0x1ccfc, %r13
nop
nop
nop
nop
...
nop
xor %r15, %r15
lea addresses_WT_ht+0x16ffc, %rbp
clflush (%rbp)
nop
nop
nop
...
nop
and $25573, %rax
lea addresses_normal_ht+0x16dc4, %r15
nop
sub %rsi, %rsi
movups (%r15), %xmm0
vpextrq $0, %xmm0, %rax
...
nop
xor %rdi, %rdi
lea addresses_UC_ht+0xcefc, %r15
mfence
mov (%r15), %r13d
nop
and %rdi, %rdi
...
{'src': {'type': 'addresses_A_ht', 'congruent': 8, 'same': False}, 'OP': 'REPM', 'dst': {'type': 'addresses_D_ht', 'congruent': 8, 'same': False}}
