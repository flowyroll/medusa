...
push %rbx
push %rcx
lea addresses_normal_ht+0x15f29, %r9
mfence
movb (%r9), %bl
nop
nop
...
// Store
lea addresses_normal+0x8bc9, %rsi
clflush (%rsi)
nop
nop
nop
...
// REPMOV
lea addresses_normal+0xcba9, %rsi
lea addresses_D+0x15935, %rdi
nop
nop
xor $57959, %rbx
mov $95, %rcx
...
{'OP': 'STOR', 'dst': {'same': False, 'type': 'addresses_WT', 'NT': True, 'AVXalign': False, 'size': 1, 'congruent': 6}}
{'OP': 'REPM', 'src': {'same': False, 'congruent': 6, 'type': 'addresses_normal'}, 'dst': {'same': False, 'congruent': 2, 'type': 'addresses_D'}}
[Faulty Load]
