...
push %rdi
push %rsi
lea addresses_WT_ht+0x18020, %rsi
lea addresses_A_ht+0x5a0, %rdi
nop
nop
nop
and $46991, %r11
...
rep movsw
xor $48746, %r15
lea addresses_WC_ht+0x14c20, %r15
inc %rax
...
nop
sub $44590, %rax
lea addresses_UC_ht+0x4c20, %rsi
lea addresses_WC_ht+0xe020, %rdi
nop
nop
nop
nop
...
{'OP': 'LOAD', 'src': {'same': False, 'NT': False, 'AVXalign': True, 'size': 32, 'type': 'addresses_WC_ht', 'congruent': 8}}
