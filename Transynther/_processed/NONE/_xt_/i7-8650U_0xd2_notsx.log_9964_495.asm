...
push %rdi
push %rsi
lea addresses_WC_ht+0x13563, %rsi
lea addresses_D_ht+0x14d43, %rdi
clflush (%rdi)
nop
inc %r13
mov $1, %rcx
...
nop
xor %rcx, %rcx
lea addresses_WT_ht+0x23a2, %rdi
nop
nop
nop
dec %r14
...
nop
inc %rcx
lea addresses_WT_ht+0x19c43, %r14
nop
nop
nop
nop
...
nop
xor $34336, %r9
lea addresses_normal_ht+0x10943, %r13
nop
nop
nop
nop
...
nop
cmp %r14, %r14
lea addresses_WT_ht+0x9543, %rsi
lea addresses_D_ht+0x5b83, %rdi
cmp $48162, %r12
mov $102, %rcx
rep movsl
nop
