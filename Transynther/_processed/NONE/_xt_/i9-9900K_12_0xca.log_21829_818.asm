...
push %rdx
push %rsi
lea addresses_WC_ht+0x1ed5c, %rsi
lea addresses_D_ht+0x5d4a, %rdi
nop
nop
nop
nop
...
rep movsl
xor %rdx, %rdx
lea addresses_WT_ht+0x47a4, %rsi
lea addresses_UC_ht+0x17e5c, %rdi
nop
cmp $17373, %rdx
mov $54, %rcx
rep movsq
...
nop
add $11941, %rsi
lea addresses_WC_ht+0x5cdc, %rcx
nop
cmp %rdx, %rdx
movb (%rcx), %bl
and %rdx, %rdx
lea addresses_D_ht+0x1bc5c, %rcx
nop
add %rbp, %rbp
movb $0x61, (%rcx)
nop
...
nop
and %rcx, %rcx
lea addresses_normal_ht+0x1375c, %rsi
lea addresses_normal_ht+0x1a95c, %rdi
nop
nop
nop
nop
...
{'OP': 'STOR', 'dst': {'size': 8, 'NT': True, 'type': 'addresses_UC', 'same': False, 'AVXalign': False, 'congruent': 0}}
[Faulty Load]
{'OP': 'LOAD', 'src': {'size': 1, 'NT': False, 'type': 'addresses_PSE', 'same': True, 'AVXalign': False, 'congruent': 0}}
<gen_prepare_buffer>
{'OP': 'REPM', 'src': {'same': False, 'type': 'addresses_WC_ht', 'congruent': 9}, 'dst': {'same': False, 'type': 'addresses_D_ht', 'congruent': 0}}
