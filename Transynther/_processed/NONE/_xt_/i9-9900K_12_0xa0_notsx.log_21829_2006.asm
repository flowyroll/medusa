...
push %rdi
push %rsi
lea addresses_WC_ht+0x13c35, %r15
clflush (%r15)
inc %rbp
mov (%r15), %r14d
nop
...
nop
dec %rbx
lea addresses_normal_ht+0x1c855, %rsi
lea addresses_D_ht+0xff7d, %rdi
clflush (%rdi)
nop
nop
nop
...
nop
xor $53445, %rdi
lea addresses_WT_ht+0x84fd, %rcx
nop
nop
nop
nop
...
nop
add %r14, %r14
lea addresses_WT_ht+0xfd3d, %rsi
lea addresses_UC_ht+0x8ffd, %rdi
nop
nop
nop
nop
...
rep movsw
add %rdi, %rdi
lea addresses_WC_ht+0x1c5bd, %rcx
nop
nop
nop
inc %r10
...
nop
cmp $65379, %rcx
lea addresses_WT_ht+0x1e2fd, %rcx
nop
nop
nop
cmp %r15, %r15
...
nop
xor %r15, %r15
lea addresses_WC_ht+0x16785, %rsi
lea addresses_D_ht+0x94fd, %rdi
nop
nop
cmp $38995, %r10
mov $125, %rcx
...
nop
dec %rcx
lea addresses_UC_ht+0x23cf, %r15
nop
nop
sub $54050, %rbx
...
nop
xor %rbx, %rbx
lea addresses_normal_ht+0x41e1, %rbx
nop
nop
nop
nop
...
nop
and $44406, %rcx
lea addresses_D_ht+0x348d, %rsi
lea addresses_A_ht+0x84fd, %rdi
add %r14, %r14
mov $93, %rcx
rep movsb
sub %rsi, %rsi
lea addresses_normal_ht+0x11bfd, %r10
nop
and $53936, %rbp
mov (%r10), %r15w
nop
sub %rdi, %rdi
lea addresses_WT_ht+0xe569, %rdi
nop
nop
nop
nop
...
{'src': {'type': 'addresses_WT_ht', 'congruent': 6, 'same': False}, 'OP': 'REPM', 'dst': {'type': 'addresses_UC_ht', 'congruent': 10, 'same': False}}
{'src': {'type': 'addresses_WC_ht', 'AVXalign': True, 'size': 8, 'NT': False, 'same': False, 'congruent': 0}, 'OP': 'LOAD'}
...
{'src': {'type': 'addresses_UC_ht', 'AVXalign': True, 'size': 32, 'NT': False, 'same': False, 'congruent': 0}, 'OP': 'LOAD'}
