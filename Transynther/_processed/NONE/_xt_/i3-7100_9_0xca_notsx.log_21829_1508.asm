...
push %rdi
push %rsi
lea addresses_WT_ht+0x9c7f, %rdi
nop
nop
nop
add $2415, %rcx
...
nop
add %r12, %r12
lea addresses_UC_ht+0x1aff, %rsi
lea addresses_WT_ht+0x16aff, %rdi
clflush (%rsi)
nop
nop
and %rax, %rax
...
// Store
lea addresses_normal+0x15ebf, %rsi
nop
nop
nop
nop
