...
push %rdi
push %rsi
lea addresses_D_ht+0x1e7e5, %r11
clflush (%r11)
nop
nop
nop
...
nop
inc %rcx
lea addresses_UC_ht+0x8795, %rsi
lea addresses_D_ht+0x14c5d, %rdi
nop
nop
nop
dec %r13
...
nop
sub $28895, %rcx
lea addresses_WC_ht+0x25e5, %rsi
lea addresses_UC_ht+0x1e85d, %rdi
nop
nop
cmp $3735, %r15
mov $86, %rcx
...
nop
sub $24899, %rbx
lea addresses_WC_ht+0x13ce1, %r11
nop
nop
nop
sub $40613, %rcx
...
nop
xor $51200, %rcx
lea addresses_WC_ht+0x1c5d, %rsi
nop
nop
nop
nop
...
nop
add $11920, %r14
lea addresses_WC_ht+0x210d, %r11
nop
nop
xor %rcx, %rcx
...
nop
sub $64849, %r15
lea addresses_WC_ht+0xa65d, %rdi
nop
nop
nop
nop
...
movw $0x6162, (%rdi)
and %r13, %r13
lea addresses_UC_ht+0x89dd, %rsi
lea addresses_A_ht+0x9085, %rdi
xor $63372, %r14
mov $94, %rcx
rep movsb
nop
...
nop
add $60538, %r11
lea addresses_normal_ht+0xe25d, %rsi
lea addresses_UC_ht+0x18de1, %rdi
nop
xor %r11, %r11
mov $45, %rcx
rep movsl
...
nop
inc %rcx
lea addresses_D_ht+0x1c95d, %rcx
nop
nop
nop
nop
...
{'OP': 'STOR', 'dst': {'type': 'addresses_RW', 'size': 1, 'AVXalign': True, 'NT': False, 'congruent': 7, 'same': False}}
[Faulty Load]
