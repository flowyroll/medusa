...
push %rdi
push %rsi
lea addresses_A_ht+0x11a41, %rbx
nop
nop
nop
nop
...
nop
and %rbp, %rbp
lea addresses_A_ht+0xf1c1, %rsi
lea addresses_WC_ht+0x9741, %rdi
nop
nop
nop
nop
...
nop
dec %rdi
lea addresses_A_ht+0x108b9, %rsi
nop
xor %r14, %r14
movb $0x61, (%rsi)
nop
cmp $26520, %rbp
lea addresses_WT_ht+0xa7c8, %rcx
nop
and $20268, %r14
...
lea addresses_A_ht+0x1d359, %rdi
xor %r12, %r12
mov $125, %rcx
rep movsb
nop
...
lea addresses_WC_ht+0x144c1, %rdi
nop
nop
nop
nop
...
nop
sub $6489, %r13
lea addresses_normal_ht+0x1dde7, %rsi
lea addresses_A_ht+0xaaa9, %rdi
nop
nop
dec %rbp
mov $23, %rcx
...
{'OP': 'REPM', 'src': {'type': 'addresses_WC_ht', 'congruent': 1, 'same': False}, 'dst': {'type': 'addresses_A_ht', 'congruent': 2, 'same': False}}
