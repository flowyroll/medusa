...
push %rdx
push %rsi
lea addresses_normal_ht+0x15161, %rsi
lea addresses_UC_ht+0x8487, %rdi
nop
nop
nop
nop
...
nop
xor $19849, %rax
lea addresses_WC_ht+0x113a1, %r12
nop
nop
sub $810, %r10
mov (%r12), %di
...
nop
xor %r10, %r10
lea addresses_normal_ht+0x73e1, %rax
nop
nop
nop
add %rcx, %rcx
...
nop
and %rax, %rax
lea addresses_WC_ht+0xbfa1, %rdi
nop
nop
nop
nop
...
movb $0x61, (%rdi)
xor $48054, %r12
lea addresses_normal_ht+0x1e821, %r12
nop
nop
sub %rdi, %rdi
movl $0x61626364, (%r12)
nop
sub $10007, %r12
lea addresses_D_ht+0x1573d, %r15
nop
nop
xor $32999, %rax
...
nop
and %rcx, %rcx
lea addresses_normal_ht+0x16fa1, %r10
nop
nop
nop
xor $59586, %rsi
...
nop
cmp %rcx, %rcx
lea addresses_WC_ht+0x1a35d, %rsi
lea addresses_WT_ht+0x19f79, %rdi
nop
nop
nop
nop
...
rep movsb
add $27661, %rdi
lea addresses_WT_ht+0xc7a1, %rsi
nop
nop
nop
cmp %rdi, %rdi
...
nop
add %r10, %r10
lea addresses_WT_ht+0x13655, %rsi
lea addresses_UC_ht+0x16a01, %rdi
nop
nop
sub $58870, %rdx
mov $118, %rcx
...
nop
cmp $49201, %rdx
lea addresses_WT_ht+0x1b931, %rsi
lea addresses_UC_ht+0x10ba1, %rdi
nop
nop
nop
sub %r10, %r10
...
nop
sub $14235, %rcx
lea addresses_A_ht+0x295, %rcx
cmp $51203, %rdi
mov $0x6162636465666768, %rax
movq %rax, (%rcx)
cmp $7817, %rsi
lea addresses_A_ht+0x437f, %rsi
lea addresses_WC_ht+0x2ba1, %rdi
nop
nop
nop
nop
...
nop
sub $26924, %rdi
lea addresses_normal_ht+0xf3a1, %rsi
lea addresses_UC_ht+0x1d021, %rdi
nop
xor %r15, %r15
mov $123, %rcx
rep movsw
...
<gen_prepare_buffer>
{'OP': 'REPM', 'src': {'type': 'addresses_normal_ht', 'congruent': 6, 'same': False}, 'dst': {'type': 'addresses_UC_ht', 'congruent': 0, 'same': False}}
