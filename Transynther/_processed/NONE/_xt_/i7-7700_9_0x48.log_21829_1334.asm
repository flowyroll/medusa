...
push %rdx
push %rsi
lea addresses_normal_ht+0x12359, %r10
nop
nop
nop
nop
...
nop
xor %rsi, %rsi
lea addresses_WT_ht+0x10665, %rsi
lea addresses_WC_ht+0x160b9, %rdi
nop
nop
nop
sub %rbx, %rbx
...
lea addresses_D_ht+0x126b9, %rdi
nop
nop
nop
nop
...
rep movsb
xor $53717, %rcx
lea addresses_WC_ht+0x17051, %r10
nop
nop
nop
nop
...
nop
cmp %rbx, %rbx
lea addresses_A_ht+0x10eb9, %rdx
xor $21522, %rbx
movw $0x6162, (%rdx)
nop
nop
...
nop
and $28933, %r10
lea addresses_WT_ht+0x16b9, %rdx
clflush (%rdx)
nop
nop
nop
...
nop
cmp %r13, %r13
lea addresses_WT_ht+0xbeb9, %rsi
lea addresses_WT_ht+0xdeb9, %rdi
and %r8, %r8
mov $49, %rcx
rep movsw
xor $12302, %r10
...
{'OP': 'REPM', 'src': {'type': 'addresses_WT_ht', 'congruent': 2, 'same': False}, 'dst': {'type': 'addresses_WC_ht', 'congruent': 8, 'same': False}}
...
{'OP': 'STOR', 'dst': {'type': 'addresses_WT_ht', 'AVXalign': True, 'congruent': 11, 'size': 16, 'same': False, 'NT': False}}
