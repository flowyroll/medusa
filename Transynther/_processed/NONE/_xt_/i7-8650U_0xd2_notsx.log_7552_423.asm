...
push %rdi
push %rsi
lea addresses_WC_ht+0x1ccc8, %rsi
lea addresses_WC_ht+0xf2c8, %rdi
cmp %r14, %r14
mov $34, %rcx
rep movsb
nop
...
rep movsb
xor $31082, %rsi
lea addresses_A_ht+0xdec8, %rsi
lea addresses_A_ht+0x136c8, %rdi
clflush (%rsi)
nop
cmp $4301, %r10
mov $24, %rcx
...
nop
cmp %rdi, %rdi
lea addresses_UC_ht+0x1218c, %r14
nop
nop
sub %r10, %r10
mov (%r14), %r11w
nop
sub %rsi, %rsi
lea addresses_A_ht+0x132b4, %rsi
lea addresses_UC_ht+0xb7c8, %rdi
nop
nop
nop
nop
...
nop
add %rsi, %rsi
lea addresses_WT_ht+0x182e8, %rdi
nop
nop
nop
dec %r11
...
movq %rcx, (%rdi)
sub $44434, %r10
lea addresses_WT_ht+0x156c8, %rsi
lea addresses_WC_ht+0x1a69a, %rdi
nop
nop
nop
add %r10, %r10
...
nop
dec %r14
lea addresses_WT_ht+0x11608, %rdi
nop
add %r15, %r15
movb (%rdi), %r14b
nop
...
nop
cmp $7359, %rdi
lea addresses_WT_ht+0xf2c8, %r11
nop
nop
nop
nop
...
nop
xor $35905, %r15
lea addresses_WC_ht+0x13476, %r11
clflush (%r11)
nop
nop
nop
...
{'OP': 'REPM', 'src': {'type': 'addresses_UC_ht', 'congruent': 6, 'same': False}, 'dst': {'type': 'addresses_D_ht', 'congruent': 5, 'same': True}}
{'OP': 'REPM', 'src': {'type': 'addresses_A_ht', 'congruent': 11, 'same': False}, 'dst': {'type': 'addresses_A_ht', 'congruent': 11, 'same': False}}
{'OP': 'LOAD', 'src': {'type': 'addresses_UC_ht', 'size': 2, 'AVXalign': False, 'NT': True, 'congruent': 2, 'same': True}}
