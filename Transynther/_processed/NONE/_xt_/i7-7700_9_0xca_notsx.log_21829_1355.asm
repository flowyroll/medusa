...
nop
xor %r12, %r12
lea addresses_UC_ht+0xaee5, %r11
nop
nop
nop
nop
...
{'dst': {'NT': False, 'AVXalign': False, 'size': 32, 'congruent': 7, 'same': True, 'type': 'addresses_UC_ht'}, 'OP': 'STOR'}
