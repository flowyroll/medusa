...
push %rdx
push %rsi
lea addresses_WT_ht+0x5769, %rbx
clflush (%rbx)
nop
add %rdx, %rdx
movb $0x61, (%rbx)
mfence
lea addresses_D_ht+0x1a2a9, %rax
nop
nop
nop
nop
...
lea addresses_WC_ht+0x1dbc9, %rdi
xor $38088, %rbx
mov $26, %rcx
rep movsq
nop
...
nop
inc %rcx
lea addresses_WC_ht+0x12159, %r15
clflush (%r15)
inc %rax
...
movups %xmm1, (%r15)
xor %rdi, %rdi
lea addresses_A_ht+0x1caa9, %r15
nop
nop
xor %rdi, %rdi
movb (%r15), %r13b
...
nop
and %rsi, %rsi
lea addresses_WT_ht+0x132a9, %r15
nop
mfence
mov (%r15), %edi
nop
...
nop
sub $51085, %r15
lea addresses_UC_ht+0x17ca9, %r15
nop
nop
nop
nop
...
nop
and $63503, %r13
lea addresses_normal_ht+0xcae1, %rcx
dec %r15
movb $0x61, (%rcx)
nop
nop
...
vmovups %ymm1, (%rdx)
dec %rdx
lea addresses_WC_ht+0x8519, %r13
nop
nop
and %rdx, %rdx
mov (%r13), %eax
...
// REPMOV
lea addresses_WT+0xc8a9, %rsi
lea addresses_A+0x10869, %rdi
cmp %r10, %r10
mov $50, %rcx
rep movsq
nop
...
// Faulty Load
lea addresses_normal+0x1eca9, %rsi
nop
nop
nop
nop
...
{'dst': {'type': 'addresses_WC', 'same': False, 'size': 8, 'congruent': 6, 'NT': True, 'AVXalign': False}, 'OP': 'STOR'}
{'src': {'type': 'addresses_WT', 'congruent': 10, 'same': False}, 'dst': {'type': 'addresses_A', 'congruent': 5, 'same': False}, 'OP': 'REPM'}
[Faulty Load]
...
{'src': {'type': 'addresses_UC_ht', 'same': False, 'size': 32, 'congruent': 10, 'NT': True, 'AVXalign': True}, 'OP': 'LOAD'}
