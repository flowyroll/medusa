...
nop
add %r15, %r15
lea addresses_UC_ht+0x1e103, %r9
nop
nop
nop
nop
...
nop
xor $46889, %r10
lea addresses_UC_ht+0x9653, %rbx
nop
add $33826, %rcx
...
nop
dec %rbx
lea addresses_UC_ht+0x5513, %r12
nop
nop
nop
inc %rcx
...
nop
sub %rbx, %rbx
lea addresses_WC_ht+0x3493, %rsi
...
nop
xor %r10, %r10
lea addresses_UC_ht+0x16153, %r14
nop
nop
nop
add $26828, %rsi
...
nop
cmp %r14, %r14
lea addresses_D_ht+0x1d793, %rsi
lea addresses_WT_ht+0x1813, %rdi
sub %r14, %r14
mov $11, %rcx
rep movsl
nop
nop
sub %rsi, %rsi
lea addresses_WC_ht+0x14013, %rsi
nop
nop
nop
nop
...
nop
sub $27455, %rdi
lea addresses_UC_ht+0xa013, %r15
nop
nop
nop
cmp %rbx, %rbx
...
// Store
lea addresses_normal+0x60af, %rdx
and %r12, %r12
movw $0x5152, (%rdx)
dec %rax

// Faulty Load
lea addresses_normal+0x13, %r12
nop
inc %rsi
mov (%r12), %di
lea oracles, %rcx
...
{'src': {'type': 'addresses_PSE', 'congruent': 6, 'same': False}, 'OP': 'REPM', 'dst': {'type': 'addresses_P', 'congruent': 11, 'same': False}}
{'src': {'type': 'addresses_UC', 'AVXalign': False, 'size': 1, 'NT': False, 'same': False, 'congruent': 7}, 'OP': 'LOAD'}
...
{'OP': 'STOR', 'dst': {'type': 'addresses_UC_ht', 'AVXalign': False, 'size': 1, 'NT': True, 'same': False, 'congruent': 3}}
{'src': {'type': 'addresses_D_ht', 'congruent': 7, 'same': False}, 'OP': 'REPM', 'dst': {'type': 'addresses_WT_ht', 'congruent': 10, 'same': False}}
{'OP': 'STOR', 'dst': {'type': 'addresses_WC_ht', 'AVXalign': False, 'size': 4, 'NT': False, 'same': True, 'congruent': 11}}
