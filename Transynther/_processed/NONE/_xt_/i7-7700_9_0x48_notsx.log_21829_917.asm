...
push %rdi
push %rsi
lea addresses_WT_ht+0xbaa9, %rsi
lea addresses_D_ht+0x7329, %rdi
clflush (%rsi)
nop
nop
nop
...
nop
and $13581, %r8
lea addresses_normal_ht+0xc001, %r9
nop
nop
nop
nop
...
nop
inc %r13
lea addresses_WC_ht+0x1d129, %rcx
nop
nop
nop
nop
...
nop
dec %rsi
lea addresses_WT_ht+0x1b329, %rdi
nop
nop
nop
nop
...
{'OP': 'LOAD', 'src': {'same': False, 'NT': True, 'AVXalign': False, 'size': 16, 'type': 'addresses_D_ht', 'congruent': 6}}
