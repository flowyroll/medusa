...
push %rbx
push %rdi
lea addresses_UC_ht+0xac70, %r10
nop
nop
nop
nop
...
nop
xor %r8, %r8
lea addresses_WT_ht+0x7650, %r15
nop
nop
nop
nop
...
nop
sub %r10, %r10
lea addresses_UC_ht+0x18107, %r15
nop
nop
nop
add %rax, %rax
...
nop
and %rbx, %rbx
lea addresses_WC_ht+0x19c70, %r8
nop
dec %rdi
...
// Store
lea addresses_normal+0x14dd6, %rsi
nop
nop
nop
xor %r12, %r12
...
{'OP': 'STOR', 'dst': {'type': 'addresses_D', 'AVXalign': False, 'congruent': 6, 'size': 32, 'same': False, 'NT': True}}
...
{'OP': 'LOAD', 'src': {'type': 'addresses_D_ht', 'AVXalign': True, 'congruent': 3, 'size': 1, 'same': False, 'NT': False}}
