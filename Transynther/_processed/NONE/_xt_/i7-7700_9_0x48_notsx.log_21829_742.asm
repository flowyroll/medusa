...
push %rdx
push %rsi
lea addresses_UC_ht+0x12212, %r14
nop
nop
nop
nop
...
nop
dec %r13
lea addresses_WT_ht+0x1b0c, %rdi
nop
nop
and %rbx, %rbx
mov (%rdi), %edx
...
nop
sub $27554, %rdi
lea addresses_WT_ht+0x9ba2, %rsi
lea addresses_UC_ht+0xd5b2, %rdi
sub $56289, %r14
mov $95, %rcx
rep movsb
nop
...
nop
and $52445, %r13
lea addresses_WT_ht+0x11c12, %rsi
nop
nop
nop
nop
...
nop
inc %rcx
lea addresses_WT_ht+0x3b12, %rsi
lea addresses_A_ht+0xe432, %rdi
nop
nop
cmp $46664, %r11
mov $109, %rcx
...
lea addresses_WT_ht+0xeaaa, %rdi
nop
nop
nop
xor %r14, %r14
...
nop
lfence
lea addresses_D_ht+0x1c0c6, %rbx
clflush (%rbx)
nop
nop
add %r13, %r13
...
nop
dec %r11
lea addresses_normal_ht+0xb9de, %rdx
nop
nop
cmp %r13, %r13
...
{'dst': {'same': False, 'congruent': 4, 'type': 'addresses_UC_ht'}, 'OP': 'REPM', 'src': {'same': False, 'congruent': 3, 'type': 'addresses_WT_ht'}}
