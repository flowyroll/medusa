...
push %rdx
push %rsi
lea addresses_UC_ht+0x1d6ed, %r15
and $24260, %r12
movb (%r15), %r14b
add $53114, %r15
lea addresses_D_ht+0x1c0cd, %rdx
nop
nop
cmp %rbx, %rbx
mov (%rdx), %r11
xor %r14, %r14
lea addresses_A_ht+0x4eed, %rbx
clflush (%rbx)
nop
nop
nop
...
nop
and %r10, %r10
lea addresses_A_ht+0x1b2ed, %r12
nop
nop
nop
nop
...
nop
xor $8204, %rdx
lea addresses_UC_ht+0x182cd, %rdx
clflush (%rdx)
nop
nop
sub %rbx, %rbx
...
nop
dec %rdx
lea addresses_UC_ht+0x376d, %r15
nop
xor %r14, %r14
movl $0x61626364, (%r15)
nop
...
nop
add %rdx, %rdx
lea addresses_A_ht+0x19cf5, %r14
nop
nop
cmp %r12, %r12
movb (%r14), %r15b
...
nop
and %rdx, %rdx
lea addresses_normal_ht+0x146ed, %rsi
lea addresses_D_ht+0x183ed, %rdi
nop
sub $15300, %rbx
mov $88, %rcx
rep movsl
...
nop
add %rsi, %rsi
lea addresses_normal_ht+0x1beed, %r14
nop
xor %r15, %r15
mov (%r14), %esi
nop
...
nop
dec %rsi
lea addresses_WC_ht+0x1c3ed, %rsi
lea addresses_D_ht+0x18e4d, %rdi
nop
nop
nop
dec %r12
...
{'src': {'type': 'addresses_D_ht', 'same': True, 'size': 8, 'congruent': 2, 'NT': False, 'AVXalign': False}, 'OP': 'LOAD'}
...
{'src': {'type': 'addresses_normal_ht', 'congruent': 9, 'same': False}, 'dst': {'type': 'addresses_D_ht', 'congruent': 7, 'same': True}, 'OP': 'REPM'}
