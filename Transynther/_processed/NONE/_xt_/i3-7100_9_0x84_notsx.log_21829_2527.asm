...
push %rdx
push %rsi
lea addresses_A_ht+0x13f1c, %rax
nop
nop
nop
nop
...
nop
cmp %rsi, %rsi
lea addresses_WC_ht+0xba1c, %rsi
lea addresses_A_ht+0x19114, %rdi
nop
nop
nop
nop
...
nop
and $15988, %r8
lea addresses_D_ht+0x14f2c, %rsi
lea addresses_D_ht+0xd70c, %rdi
nop
nop
nop
nop
...
nop
and $30939, %rsi
lea addresses_WC_ht+0x1e595, %rdx
nop
nop
nop
nop
...
// Store
lea addresses_normal+0x661c, %rcx
clflush (%rcx)
nop
nop
xor $48316, %rdx
...
{'src': {'type': 'addresses_WC_ht', 'congruent': 10, 'same': False}, 'dst': {'type': 'addresses_A_ht', 'congruent': 3, 'same': False}, 'OP': 'REPM'}
{'src': {'type': 'addresses_D_ht', 'congruent': 3, 'same': False}, 'dst': {'type': 'addresses_D_ht', 'congruent': 4, 'same': False}, 'OP': 'REPM'}
