...
push %rdi
push %rsi
lea addresses_D_ht+0xfc42, %rsi
lea addresses_normal_ht+0x2882, %rdi
clflush (%rsi)
nop
nop
nop
...
nop
inc %rdi
lea addresses_D_ht+0x1a3c2, %rdi
clflush (%rdi)
nop
nop
nop
...
lea addresses_D_ht+0x1dfc2, %rdi
nop
cmp %r14, %r14
mov $85, %rcx
rep movsl
add %r15, %r15
lea addresses_normal_ht+0xa5c2, %r15
nop
nop
nop
nop
...
nop
inc %r11
lea addresses_WC_ht+0x891a, %rsi
lea addresses_WC_ht+0x9d21, %rdi
nop
nop
cmp %r9, %r9
mov $21, %rcx
...
// Faulty Load
lea addresses_normal+0x43c2, %r11
nop
cmp $25874, %r15
movb (%r11), %dl
lea oracles, %r11
...
<gen_faulty_load>
[REF]
{'src': {'congruent': 0, 'AVXalign': True, 'same': False, 'size': 32, 'NT': True, 'type': 'addresses_normal'}, 'OP': 'LOAD'}
[Faulty Load]
