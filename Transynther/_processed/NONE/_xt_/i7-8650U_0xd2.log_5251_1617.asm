...
nop
xor $29441, %rax
lea addresses_A_ht+0x18f93, %rsi
lea addresses_D_ht+0xaf13, %rdi
nop
nop
xor $51068, %r11
mov $98, %rcx
...
lea addresses_UC_ht+0x8a93, %rdi
clflush (%rsi)
nop
cmp %rax, %rax
mov $57, %rcx
...
nop
sub $10558, %rbx
lea addresses_UC_ht+0xa413, %rbx
nop
nop
nop
nop
...
nop
cmp $33828, %rbx
lea addresses_WC_ht+0xd853, %r11
nop
nop
inc %rsi
movups (%r11), %xmm0
...
// Store
lea addresses_normal+0x693, %rsi
nop
add $39469, %r15
movl $0x51525354, (%rsi)
nop
...
// Store
lea addresses_normal+0x14d93, %r9
nop
nop
nop
nop
