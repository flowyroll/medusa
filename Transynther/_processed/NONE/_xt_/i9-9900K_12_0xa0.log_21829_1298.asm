...
push %rdi
push %rsi
lea addresses_D_ht+0x139ef, %r13
nop
nop
sub %r9, %r9
mov (%r13), %r14w
cmp %r12, %r12
lea addresses_D_ht+0x1eaa3, %r14
nop
nop
nop
sub %r11, %r11
...
movq %r12, (%r14)
sub $60798, %r11
lea addresses_UC_ht+0x1647b, %r14
nop
nop
inc %r12
movups (%r14), %xmm1
...
nop
add $16442, %r14
lea addresses_A_ht+0x1d343, %rsi
lea addresses_A_ht+0x1a9c3, %rdi
nop
nop
nop
add $23503, %r9
...
nop
cmp $34798, %r12
lea addresses_UC_ht+0xbf43, %rsi
lea addresses_UC_ht+0xdfc3, %rdi
clflush (%rdi)
nop
nop
nop
