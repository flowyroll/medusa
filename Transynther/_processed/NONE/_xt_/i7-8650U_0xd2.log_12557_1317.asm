...
push %rdi
push %rsi
lea addresses_WT_ht+0x1a24c, %rdi
nop
nop
nop
nop
...
nop
inc %rdi
lea addresses_normal_ht+0x155d4, %r9
nop
nop
nop
xor $62087, %rax
mov (%r9), %r11d
and $53019, %r13
lea addresses_normal_ht+0x105d4, %rsi
lea addresses_A_ht+0x4c54, %rdi
nop
nop
nop
nop
...
nop
inc %r11
lea addresses_normal_ht+0xc064, %rsi
lea addresses_normal_ht+0x15d4, %rdi
clflush (%rdi)
nop
nop
add $57781, %r13
...
nop
and %r9, %r9
lea addresses_UC_ht+0x35d4, %r10
nop
nop
nop
nop
...
nop
xor $30816, %rdi
lea addresses_normal_ht+0xc50c, %rsi
lea addresses_WC_ht+0x115d4, %rdi
nop
nop
nop
nop
...
nop
sub %r11, %r11
lea addresses_D_ht+0x1b5d4, %r9
nop
xor $29921, %r8
mov (%r9), %r11
nop
sub %r11, %r11
lea addresses_WC_ht+0x29d4, %rcx
nop
nop
nop
xor $45858, %rdi
...
// Faulty Load
lea addresses_normal+0xe9d4, %r14
nop
add %rcx, %rcx
mov (%r14), %r15w
lea oracles, %rbx
...
{'OP': 'REPM', 'src': {'type': 'addresses_normal_ht', 'congruent': 9, 'same': False}, 'dst': {'type': 'addresses_A_ht', 'congruent': 7, 'same': True}}
...
{'OP': 'STOR', 'dst': {'type': 'addresses_D_ht', 'size': 32, 'AVXalign': False, 'NT': False, 'congruent': 8, 'same': True}}
