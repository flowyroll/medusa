...
push %rdi
push %rsi
lea addresses_WT_ht+0x10a55, %rbp
nop
and %rdi, %rdi
movw $0x6162, (%rbp)
add $62765, %r8
lea addresses_A_ht+0x11a08, %r8
nop
nop
nop
nop
...
nop
dec %rsi
lea addresses_WT_ht+0xb015, %rsi
lea addresses_WT_ht+0xdc05, %rdi
nop
nop
nop
xor %r11, %r11
...
nop
add %r14, %r14
lea addresses_WC_ht+0xac45, %rbp
nop
nop
nop
nop
...
nop
xor $11702, %rbp
lea addresses_normal_ht+0x13b85, %r8
nop
nop
dec %r14
movl $0x61626364, (%r8)
...
nop
and $12899, %rsi
lea addresses_A_ht+0x7d45, %rsi
lea addresses_WT_ht+0x4da5, %rdi
nop
nop
sub $52158, %r13
mov $95, %rcx
...
nop
inc %rdi
lea addresses_WT_ht+0x1b425, %r13
nop
nop
nop
xor $9090, %rcx
movb (%r13), %r14b
cmp %rbp, %rbp
lea addresses_WC_ht+0x1ef5d, %rcx
nop
nop
sub $20345, %rsi
