...
nop
xor %rax, %rax
lea addresses_WT_ht+0x16a64, %r9
nop
cmp %r15, %r15
...
nop
inc %rdi
lea addresses_WT_ht+0x1e6c8, %rsi
lea addresses_WT_ht+0xdc64, %rdi
clflush (%rdi)
nop
nop
nop
...
nop
lfence
lea addresses_WT_ht+0x18e64, %r10
nop
nop
and $12646, %r9
...
<gen_prepare_buffer>
{'OP': 'REPM', 'src': {'same': False, 'type': 'addresses_UC_ht', 'congruent': 0}, 'dst': {'same': False, 'type': 'addresses_normal_ht', 'congruent': 6}}
