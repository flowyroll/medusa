...
movl $0x61626364, (%r8)
add $6259, %rdi
lea addresses_UC_ht+0x17b65, %r12
nop
sub $35963, %rdx
...
nop
xor %r8, %r8
lea addresses_WC_ht+0x15a7d, %r13
nop
cmp $8765, %r12
movl $0x61626364, (%r13)
and $31414, %rdx
...
// Store
lea addresses_normal+0x6c6d, %rax
nop
nop
nop
nop
...
{'OP': 'STOR', 'dst': {'type': 'addresses_UC', 'size': 32, 'AVXalign': True, 'NT': False, 'congruent': 11, 'same': False}}
[Faulty Load]
