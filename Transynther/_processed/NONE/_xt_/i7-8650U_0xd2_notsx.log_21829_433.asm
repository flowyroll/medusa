...
push %rax
push %rcx
lea addresses_UC_ht+0x10c15, %rcx
clflush (%rcx)
nop
nop
nop
...
nop
sub $282, %rcx
lea addresses_WT_ht+0xa693, %r13
sub $33423, %rcx
movb (%r13), %r10b
nop
nop
