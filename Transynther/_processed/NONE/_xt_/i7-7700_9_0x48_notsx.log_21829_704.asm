...
push %rdi
push %rsi
lea addresses_normal_ht+0xe6a3, %rsi
...
nop
add $11956, %r12
lea addresses_A_ht+0x115a3, %rsi
nop
nop
nop
nop
...
mov (%rsi), %r12
inc %rsi
lea addresses_WC_ht+0x8ca3, %rdi
nop
nop
nop
mfence
...
<gen_prepare_buffer>
{'dst': {'same': True, 'congruent': 3, 'type': 'addresses_A_ht'}, 'OP': 'REPM', 'src': {'same': False, 'congruent': 6, 'type': 'addresses_normal_ht'}}
