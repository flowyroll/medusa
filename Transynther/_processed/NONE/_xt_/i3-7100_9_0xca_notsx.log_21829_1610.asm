...
push %rdx
push %rsi
lea addresses_WT_ht+0x1b771, %r8
add %rbp, %rbp
mov (%r8), %dx
nop
nop
...
nop
sub %r14, %r14
lea addresses_WT_ht+0x136b9, %rsi
lea addresses_WC_ht+0x5439, %rdi
xor %r10, %r10
mov $109, %rcx
rep movsb
nop
cmp %rsi, %rsi
lea addresses_WT_ht+0x10339, %rsi
lea addresses_WC_ht+0x13331, %rdi
clflush (%rsi)
nop
nop
nop
...
rep movsb
xor $10667, %r8
lea addresses_WT_ht+0x3f39, %rsi
xor %r10, %r10
movb (%rsi), %cl
nop
nop
and %r8, %r8
lea addresses_UC_ht+0x15719, %rsi
lea addresses_WC_ht+0x9639, %rdi
clflush (%rsi)
nop
xor %r14, %r14
mov $32, %rcx
rep movsq
and %rdi, %rdi
lea addresses_WT_ht+0x12289, %r14
nop
nop
nop
nop
...
nop
sub $57251, %rsi
lea addresses_WT_ht+0x3679, %rsi
lea addresses_A_ht+0x1cd9d, %rdi
nop
nop
nop
nop
...
nop
add $58083, %rdx
lea addresses_UC_ht+0x7d79, %rsi
lea addresses_WC_ht+0x14e79, %rdi
nop
nop
nop
nop
...
rep movsw
xor $51164, %rsi
lea addresses_normal_ht+0x147c7, %r8
xor %rdx, %rdx
movb $0x61, (%r8)
nop
nop
...
nop
sub $41797, %rcx
lea addresses_UC_ht+0xe879, %rsi
lea addresses_D_ht+0x1e3da, %rdi
nop
add %r8, %r8
mov $65, %rcx
rep movsl
...
nop
sub %rdx, %rdx
lea addresses_UC_ht+0x11fcd, %r14
add $61014, %rdi
...
<gen_prepare_buffer>
{'src': {'same': True, 'congruent': 1, 'NT': True, 'type': 'addresses_WT_ht', 'size': 2, 'AVXalign': False}, 'OP': 'LOAD'}
{'src': {'type': 'addresses_WT_ht', 'congruent': 6, 'same': False}, 'OP': 'REPM', 'dst': {'type': 'addresses_WC_ht', 'congruent': 4, 'same': False}}
{'src': {'type': 'addresses_WT_ht', 'congruent': 6, 'same': False}, 'OP': 'REPM', 'dst': {'type': 'addresses_WC_ht', 'congruent': 3, 'same': False}}
{'src': {'same': False, 'congruent': 5, 'NT': False, 'type': 'addresses_WT_ht', 'size': 1, 'AVXalign': True}, 'OP': 'LOAD'}
