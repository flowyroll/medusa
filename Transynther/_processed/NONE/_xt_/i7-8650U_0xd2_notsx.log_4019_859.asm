...
push %r9
push %rax
lea addresses_UC_ht+0x8ffc, %r14
nop
and $27346, %r9
mov (%r14), %ax
sub %r12, %r12
...
// REPMOV
lea addresses_UC+0x140, %rsi
lea addresses_normal+0x18eca, %rdi
nop
cmp %r15, %r15
mov $1, %rcx
rep movsq
...
// Faulty Load
lea addresses_normal+0x5540, %r10
clflush (%r10)
nop
nop
nop
...
{'OP': 'REPM', 'src': {'type': 'addresses_UC', 'congruent': 10, 'same': False}, 'dst': {'type': 'addresses_normal', 'congruent': 1, 'same': False}}
{'OP': 'LOAD', 'src': {'type': 'addresses_UC', 'size': 16, 'AVXalign': False, 'NT': False, 'congruent': 10, 'same': False}}
{'OP': 'LOAD', 'src': {'type': 'addresses_WC', 'size': 2, 'AVXalign': False, 'NT': True, 'congruent': 3, 'same': False}}
