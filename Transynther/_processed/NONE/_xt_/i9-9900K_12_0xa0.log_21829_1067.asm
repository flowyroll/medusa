...
push %rdx
push %rsi
lea addresses_UC_ht+0x5559, %rsi
lea addresses_D_ht+0x799, %rdi
clflush (%rsi)
nop
nop
nop
...
nop
xor %rdi, %rdi
lea addresses_normal_ht+0x3259, %rdx
nop
nop
inc %rbx
mov (%rdx), %r10d
...
nop
cmp $64415, %rdi
lea addresses_UC_ht+0xe659, %rsi
nop
nop
and $29977, %rdx
mov (%rsi), %r10w
...
nop
add %r10, %r10
lea addresses_UC_ht+0x12aa9, %rsi
lea addresses_A_ht+0x1e459, %rdi
nop
nop
nop
sub $35575, %rdx
...
nop
sub %rdi, %rdi
lea addresses_D_ht+0x9201, %rsi
lea addresses_UC_ht+0x3b9d, %rdi
nop
nop
nop
xor $9231, %r14
...
nop
and %rdx, %rdx
lea addresses_WC_ht+0x68f1, %rdx
nop
nop
nop
cmp %r15, %r15
...
nop
sub %r10, %r10
lea addresses_WC_ht+0x1e959, %r15
nop
nop
nop
nop
...
nop
cmp %rdx, %rdx
lea addresses_A_ht+0x1d6f9, %rsi
lea addresses_normal_ht+0x113d9, %rdi
nop
nop
nop
cmp $55750, %r14
...
nop
and %rbx, %rbx
lea addresses_WC_ht+0x18f99, %rdx
cmp %r14, %r14
mov (%rdx), %rsi
nop
cmp %rsi, %rsi
lea addresses_UC_ht+0x9e49, %r15
clflush (%r15)
nop
sub $38462, %rcx
...
nop
sub $54660, %r14
lea addresses_WC_ht+0x1c809, %rcx
nop
nop
cmp %rdi, %rdi
movl $0x61626364, (%rcx)
...
// Faulty Load
lea addresses_normal+0x1aa59, %r10
nop
nop
nop
sub $32670, %rcx
...
{'src': {'same': False, 'congruent': 0, 'type': 'addresses_A_ht'}, 'OP': 'REPM', 'dst': {'same': False, 'congruent': 7, 'type': 'addresses_normal_ht'}}
...
{'OP': 'STOR', 'dst': {'NT': True, 'same': False, 'congruent': 3, 'type': 'addresses_WC_ht', 'AVXalign': True, 'size': 4}}
{'34': 21829}
