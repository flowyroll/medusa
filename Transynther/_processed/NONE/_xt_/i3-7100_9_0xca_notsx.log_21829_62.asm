...
nop
add $5044, %r12
lea addresses_WC_ht+0x164bb, %r13
nop
add $49225, %rbp
movb (%r13), %r8b
sub %r8, %r8
lea addresses_A_ht+0x74bb, %rsi
...
nop
inc %r13
lea addresses_UC_ht+0xdebb, %rdx
nop
nop
cmp $44109, %rsi
movb (%rdx), %r12b
nop
sub $40998, %rsi
lea addresses_A_ht+0xbdbb, %rsi
lea addresses_D_ht+0x150bb, %rdi
nop
nop
nop
nop
...
nop
dec %rbp
lea addresses_normal_ht+0x33cb, %rsi
lea addresses_UC_ht+0x77a2, %rdi
nop
nop
nop
nop
...
nop
cmp %rsi, %rsi
lea addresses_D_ht+0x19301, %rbx
nop
nop
add $35346, %rbp
movw $0x6162, (%rbx)
...
nop
sub %r12, %r12
lea addresses_WC_ht+0xf33b, %rsi
lea addresses_WC_ht+0xbb, %rdi
nop
nop
nop
nop
...
nop
inc %rsi
lea addresses_WC_ht+0x7fb7, %rsi
lea addresses_A_ht+0x1440b, %rdi
nop
xor $34125, %r13
mov $90, %rcx
rep movsl
...
// Store
lea addresses_D+0x3abb, %rdx
cmp %r13, %r13
movl $0x51525354, (%rdx)
cmp %r11, %r11

// Faulty Load
lea addresses_PSE+0x8ebb, %r11
nop
nop
nop
nop
...
{'src': {'type': 'addresses_WC_ht', 'congruent': 7, 'same': True}, 'OP': 'REPM', 'dst': {'type': 'addresses_WC_ht', 'congruent': 9, 'same': False}}
