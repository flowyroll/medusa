...
nop
sub $11398, %rsi
lea addresses_UC_ht+0x87c9, %rcx
nop
nop
nop
nop
...
nop
cmp $50970, %r8
lea addresses_D_ht+0x1d1e5, %rbp
nop
nop
add %r11, %r11
...
{'OP': 'LOAD', 'src': {'type': 'addresses_P', 'size': 4, 'AVXalign': True, 'NT': False, 'congruent': 1, 'same': False}}
