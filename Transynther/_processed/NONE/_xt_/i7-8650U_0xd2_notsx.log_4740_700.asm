...
push %rdi
push %rsi
lea addresses_D_ht+0x5fbd, %rsi
lea addresses_D_ht+0x8cb7, %rdi
nop
nop
add %r13, %r13
mov $76, %rcx
...
nop
xor %rsi, %rsi
lea addresses_UC_ht+0x1afbd, %r13
nop
nop
nop
nop
...
lea addresses_WC_ht+0x98fd, %rdi
nop
nop
nop
and $32766, %r12
...
{'OP': 'STOR', 'dst': {'type': 'addresses_NC', 'size': 8, 'AVXalign': False, 'NT': True, 'congruent': 8, 'same': False}}
