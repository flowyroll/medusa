...
push %rdx
push %rsi
lea addresses_normal_ht+0x1676e, %r9
nop
nop
nop
nop
...
vpextrq $0, %xmm3, %r11
and $10569, %r9
lea addresses_WC_ht+0x126d3, %r9
add $49218, %r8
mov (%r9), %ecx
nop
nop
...
nop
add %r11, %r11
lea addresses_WC_ht+0x1206e, %rsi
lea addresses_normal_ht+0x155ee, %rdi
nop
nop
inc %r9
mov $68, %rcx
...
nop
dec %r11
lea addresses_UC_ht+0x145ee, %r9
nop
sub %rdi, %rdi
...
movups %xmm2, (%r9)
sub $54703, %rsi
lea addresses_normal_ht+0x5ddc, %r13
xor %rdx, %rdx
movb (%r13), %r8b
nop
dec %rcx
lea addresses_A_ht+0x1bd4a, %rdx
nop
nop
nop
nop
...
nop
add $64611, %rdx
lea addresses_WT_ht+0xe06e, %rsi
lea addresses_A_ht+0xdfee, %rdi
nop
nop
xor $51167, %r11
mov $64, %rcx
...
nop
cmp %r9, %r9
lea addresses_UC_ht+0x79b9, %rsi
lea addresses_UC_ht+0x1b795, %rdi
nop
nop
nop
nop
...
movw $0x6162, (%r8)
cmp $19144, %rsi
lea addresses_normal_ht+0x1104e, %rdx
nop
add $50790, %r11
movb (%rdx), %r8b
nop
...
nop
add $64941, %r8
lea addresses_UC_ht+0xb06e, %rdi
xor $44004, %r9
movb (%rdi), %r11b
nop
nop
...
{'src': {'type': 'addresses_WC_ht', 'congruent': 10, 'same': False}, 'dst': {'type': 'addresses_normal_ht', 'congruent': 7, 'same': False}, 'OP': 'REPM'}
...
{'src': {'type': 'addresses_WT_ht', 'congruent': 11, 'same': False}, 'dst': {'type': 'addresses_A_ht', 'congruent': 7, 'same': False}, 'OP': 'REPM'}
