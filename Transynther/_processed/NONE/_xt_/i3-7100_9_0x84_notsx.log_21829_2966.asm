...
push %rdi
push %rsi
lea addresses_D_ht+0x196ce, %rbp
nop
nop
sub %r13, %r13
mov (%rbp), %r15
...
nop
inc %rbx
lea addresses_WC_ht+0x1df8e, %rax
nop
cmp $7707, %r9
...
nop
inc %r9
lea addresses_A_ht+0x1af8e, %rsi
...
nop
xor $49390, %rax
lea addresses_A_ht+0x166ae, %rcx
xor %rsi, %rsi
...
nop
sub %rcx, %rcx
lea addresses_WC_ht+0x898e, %rdi
nop
nop
nop
nop
...
mov (%rdi), %bp
cmp $7564, %r13
lea addresses_normal_ht+0x51c6, %rsi
lea addresses_normal_ht+0x1eee, %rdi
clflush (%rdi)
and $60797, %rbp
mov $117, %rcx
rep movsb
...
nop
xor %rsi, %rsi
lea addresses_WT_ht+0x305a, %rbx
nop
nop
nop
nop
...
nop
and %r13, %r13
lea addresses_A_ht+0x1d14e, %rcx
nop
cmp %r15, %r15
...
nop
add $18424, %r15
lea addresses_normal_ht+0xfb8e, %rsi
...
nop
sub $24430, %rcx
lea addresses_A_ht+0x196ce, %r15
nop
inc %rbx
mov (%r15), %eax
nop
...
nop
cmp %rsi, %rsi
lea addresses_UC_ht+0xb362, %rax
cmp $14926, %rsi
mov (%rax), %r15w
nop
sub %rsi, %rsi
...
{'src': {'type': 'addresses_A_ht', 'congruent': 10, 'same': True}, 'dst': {'type': 'addresses_WC_ht', 'congruent': 11, 'same': False}, 'OP': 'REPM'}
...
{'dst': {'type': 'addresses_A_ht', 'same': False, 'size': 8, 'congruent': 6, 'NT': False, 'AVXalign': True}, 'OP': 'STOR'}
{'src': {'type': 'addresses_normal_ht', 'congruent': 6, 'same': False}, 'dst': {'type': 'addresses_D_ht', 'congruent': 8, 'same': False}, 'OP': 'REPM'}
