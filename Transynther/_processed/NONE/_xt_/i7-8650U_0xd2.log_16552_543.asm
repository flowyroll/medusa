...
push %rdi
push %rsi
lea addresses_WC_ht+0x4998, %rbx
clflush (%rbx)
nop
nop
nop
...
nop
xor %r14, %r14
lea addresses_WC_ht+0x15300, %rsi
...
rep movsq
xor $46635, %r14
lea addresses_UC_ht+0x14ccb, %rdi
clflush (%rdi)
cmp %r10, %r10
movups (%rdi), %xmm0
vpextrq $1, %xmm0, %rsi
nop
cmp $49979, %r10
lea addresses_normal_ht+0x19700, %rbx
nop
nop
nop
nop
...
nop
and %r14, %r14
lea addresses_UC_ht+0xafe0, %rsi
nop
xor $20096, %rdi
...
nop
cmp %r10, %r10
lea addresses_WT_ht+0x5f00, %r14
cmp %r10, %r10
...
nop
and %rsi, %rsi
lea addresses_WC_ht+0x19ca8, %r13
nop
nop
inc %rsi
movw $0x6162, (%r13)
...
// Faulty Load
lea addresses_normal+0x1eb00, %rbx
nop
nop
nop
nop
...
{'OP': 'REPM', 'src': {'type': 'addresses_WC_ht', 'congruent': 11, 'same': False}, 'dst': {'type': 'addresses_UC_ht', 'congruent': 1, 'same': True}}
...
{'OP': 'STOR', 'dst': {'type': 'addresses_WC_ht', 'size': 2, 'AVXalign': True, 'NT': False, 'congruent': 3, 'same': True}}
{'34': 16552}
