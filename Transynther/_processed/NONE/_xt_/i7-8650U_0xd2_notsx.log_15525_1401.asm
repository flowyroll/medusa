...
// REPMOV
lea addresses_normal+0x5e0a, %rsi
lea addresses_D+0x140a, %rdi
nop
nop
nop
nop
...
{'OP': 'REPM', 'src': {'type': 'addresses_normal', 'congruent': 8, 'same': False}, 'dst': {'type': 'addresses_D', 'congruent': 11, 'same': False}}
