...
push %rdi
push %rsi
lea addresses_WC_ht+0x14205, %r14
nop
nop
nop
nop
...
movb $0x61, (%r14)
add %r14, %r14
lea addresses_D_ht+0x1ea6d, %rdi
nop
nop
nop
nop
...
nop
and $60141, %rbp
lea addresses_A_ht+0x106a3, %rsi
lea addresses_WT_ht+0xec07, %rdi
nop
nop
nop
nop
...
nop
xor %rdi, %rdi
lea addresses_D_ht+0x2245, %r14
nop
dec %r10
movw $0x6162, (%r14)
dec %r14
lea addresses_WT_ht+0xebea, %rbx
nop
nop
nop
nop
...
movw $0x6162, (%rbx)
sub $32774, %rcx
lea addresses_WT_ht+0x9f89, %rsi
lea addresses_D_ht+0xb60d, %rdi
nop
nop
cmp $37270, %rax
mov $35, %rcx
...
// REPMOV
lea addresses_D+0x1805, %rsi
lea addresses_UC+0x3f0b, %rdi
nop
nop
nop
dec %r11
...
// Faulty Load
lea addresses_normal+0x8205, %r13
nop
nop
sub $6630, %rax
mov (%r13), %di
...
{'OP': 'REPM', 'src': {'type': 'addresses_D', 'congruent': 9, 'same': False}, 'dst': {'type': 'addresses_UC', 'congruent': 1, 'same': False}}
...
{'OP': 'REPM', 'src': {'type': 'addresses_A_ht', 'congruent': 1, 'same': True}, 'dst': {'type': 'addresses_WT_ht', 'congruent': 1, 'same': False}}
...
{'OP': 'REPM', 'src': {'type': 'addresses_WT_ht', 'congruent': 2, 'same': False}, 'dst': {'type': 'addresses_D_ht', 'congruent': 2, 'same': False}}
{'34': 19938}
