...
push %rbp
push %rdi
lea addresses_normal_ht+0x6ccd, %r14
nop
cmp $57234, %r11
...
movups %xmm1, (%r14)
xor %r12, %r12
lea addresses_D_ht+0x1716d, %r14
xor %r11, %r11
vmovups (%r14), %ymm6
...
nop
and $48024, %r9
lea addresses_WC_ht+0x2c2d, %rdi
nop
xor %rbp, %rbp
mov (%rdi), %r11d
nop
...
// REPMOV
lea addresses_normal+0x18d6d, %rsi
lea addresses_D+0x646d, %rdi
clflush (%rdi)
nop
xor $45349, %r8
mov $61, %rcx
...
{'OP': 'REPM', 'src': {'same': False, 'congruent': 7, 'type': 'addresses_normal'}, 'dst': {'same': False, 'congruent': 3, 'type': 'addresses_D'}}
[Faulty Load]
