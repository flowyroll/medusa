...
nop
cmp %rax, %rax
lea addresses_WT_ht+0x1dac7, %rbx
nop
nop
nop
nop
...
// Faulty Load
lea addresses_normal+0x1bb77, %rdi
nop
cmp %rcx, %rcx
mov (%rdi), %r10w
lea oracles, %rdi
...
{'OP': 'STOR', 'dst': {'size': 16, 'NT': True, 'type': 'addresses_NC', 'same': False, 'AVXalign': False, 'congruent': 8}}
[Faulty Load]
...
{'OP': 'STOR', 'dst': {'size': 32, 'NT': True, 'type': 'addresses_D_ht', 'same': False, 'AVXalign': True, 'congruent': 7}}
{'34': 21829}
