...
push %rdi
push %rsi
lea addresses_WC_ht+0xd8b9, %r12
xor $8348, %rbp
movb (%r12), %bl
sub $26289, %r11
lea addresses_A_ht+0x25d9, %r9
nop
nop
nop
sub %rbx, %rbx
...
nop
lfence
lea addresses_WT_ht+0xd479, %rsi
...
nop
and $18920, %rax
lea addresses_D_ht+0xf639, %rsi
lea addresses_WC_ht+0xf880, %rdi
nop
add $46745, %r9
mov $104, %rcx
rep movsw
...
nop
cmp $62160, %rax
lea addresses_WC_ht+0x171dd, %rcx
nop
nop
add $40243, %rbp
...
nop
cmp %rsi, %rsi
lea addresses_UC_ht+0x14469, %rsi
nop
nop
nop
nop
...
movb $0x61, (%rsi)
and %r11, %r11
lea addresses_D_ht+0xedc9, %rbx
nop
xor $8412, %r9
movw $0x6162, (%rbx)
nop
add $24543, %rbx
lea addresses_D_ht+0x92b9, %rcx
nop
sub $44806, %rbx
movl $0x61626364, (%rcx)
nop
...
nop
dec %rax
lea addresses_normal_ht+0x18419, %rsi
lea addresses_WC_ht+0x1d5f8, %rdi
nop
nop
nop
and $2620, %r11
...
rep movsw
cmp %rsi, %rsi
lea addresses_UC_ht+0xc021, %r11
dec %rdi
vmovups (%r11), %ymm4
...
nop
sub %rbx, %rbx
lea addresses_normal_ht+0x8a56, %r12
nop
cmp $44106, %rsi
...
<gen_prepare_buffer>
{'OP': 'LOAD', 'src': {'same': True, 'type': 'addresses_WC_ht', 'NT': False, 'AVXalign': False, 'size': 1, 'congruent': 10}}
{'OP': 'STOR', 'dst': {'same': False, 'type': 'addresses_A_ht', 'NT': False, 'AVXalign': False, 'size': 2, 'congruent': 5}}
{'OP': 'REPM', 'src': {'same': False, 'congruent': 6, 'type': 'addresses_WT_ht'}, 'dst': {'same': False, 'congruent': 8, 'type': 'addresses_WC_ht'}}
...
{'OP': 'STOR', 'dst': {'same': False, 'type': 'addresses_UC_ht', 'NT': True, 'AVXalign': False, 'size': 1, 'congruent': 3}}
