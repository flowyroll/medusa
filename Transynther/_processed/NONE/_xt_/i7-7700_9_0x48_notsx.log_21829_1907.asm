...
lea addresses_WT_ht+0xfc50, %rdi
nop
nop
xor %r10, %r10
mov $19, %rcx
...
nop
sub %rsi, %rsi
lea addresses_normal_ht+0x1dce, %r12
nop
nop
nop
dec %rbp
...
nop
inc %r14
lea addresses_normal_ht+0x11adc, %rcx
nop
nop
nop
and $49524, %r10
...
nop
and $28104, %rbp
lea addresses_WT_ht+0x55b6, %rdi
nop
nop
sub %rbp, %rbp
mov $0x6162636465666768, %r14
...
<gen_prepare_buffer>
{'dst': {'same': False, 'congruent': 9, 'type': 'addresses_WT_ht'}, 'OP': 'REPM', 'src': {'same': True, 'congruent': 10, 'type': 'addresses_normal_ht'}}
