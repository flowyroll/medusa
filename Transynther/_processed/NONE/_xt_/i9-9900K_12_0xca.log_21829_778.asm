...
push %rdi
push %rsi
lea addresses_WC_ht+0xe43d, %r14
clflush (%r14)
xor $40154, %rax
movb (%r14), %r12b
nop
...
nop
add $16756, %r9
lea addresses_A_ht+0xf93d, %rsi
lea addresses_WT_ht+0x11ccf, %rdi
clflush (%rdi)
nop
cmp %r13, %r13
mov $93, %rcx
...
{'OP': 'REPM', 'src': {'same': False, 'type': 'addresses_A_ht', 'congruent': 11}, 'dst': {'same': False, 'type': 'addresses_WT_ht', 'congruent': 0}}
