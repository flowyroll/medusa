...
push %rdi
push %rsi
lea addresses_UC_ht+0xb352, %r15
nop
nop
nop
nop
...
nop
cmp $17098, %r9
lea addresses_WC_ht+0x62aa, %rcx
xor %rdi, %rdi
movw $0x6162, (%rcx)
nop
xor $31579, %r9
lea addresses_D_ht+0x1966a, %rsi
lea addresses_WC_ht+0x1e85e, %rdi
nop
nop
and %r9, %r9
mov $1, %rcx
...
nop
and %rdi, %rdi
lea addresses_D_ht+0xbe6a, %r15
nop
nop
xor $50620, %rbx
movb $0x61, (%r15)
sub $11479, %r9
lea addresses_D_ht+0x184aa, %r15
nop
nop
nop
dec %rdi
...
nop
dec %rbx
lea addresses_normal_ht+0x9d0a, %rsi
lea addresses_normal_ht+0xf6f8, %rdi
nop
nop
sub $18773, %r15
mov $78, %rcx
...
// Faulty Load
lea addresses_normal+0xa6a, %rbx
nop
nop
nop
nop
...
{'dst': {'same': False, 'NT': False, 'AVXalign': True, 'size': 1, 'type': 'addresses_A', 'congruent': 8}, 'OP': 'STOR'}
[Faulty Load]
...
{'dst': {'same': False, 'congruent': 0, 'type': 'addresses_normal_ht'}, 'OP': 'REPM', 'src': {'same': False, 'congruent': 0, 'type': 'addresses_normal_ht'}}
{'34': 21829}
