...
push %rdi
push %rsi
lea addresses_WC_ht+0x150a8, %rsi
lea addresses_WC_ht+0x1d764, %rdi
xor %rax, %rax
mov $70, %rcx
rep movsb
nop
...
nop
sub %rax, %rax
lea addresses_WC_ht+0x15488, %rbp
nop
nop
nop
nop
...
nop
dec %rsi
lea addresses_normal_ht+0x3488, %r13
nop
nop
nop
nop
...
nop
add %rcx, %rcx
lea addresses_WC_ht+0x11388, %rbp
nop
nop
nop
nop
...
nop
and %rdi, %rdi
lea addresses_WC_ht+0xde48, %rsi
lea addresses_WT_ht+0x8fc8, %rdi
clflush (%rdi)
nop
nop
nop
...
nop
and $54931, %rdi
lea addresses_A_ht+0x1cd40, %rax
nop
nop
nop
nop
...
nop
xor %rsi, %rsi
lea addresses_D_ht+0x10128, %r11
nop
nop
cmp %r13, %r13
...
nop
sub %rsi, %rsi
lea addresses_WC_ht+0x2d5e, %rsi
lea addresses_D_ht+0x19088, %rdi
nop
nop
xor %rax, %rax
mov $102, %rcx
...
<gen_prepare_buffer>
{'src': {'type': 'addresses_WC_ht', 'congruent': 5, 'same': False}, 'dst': {'type': 'addresses_WC_ht', 'congruent': 2, 'same': False}, 'OP': 'REPM'}
...
{'src': {'type': 'addresses_WC_ht', 'congruent': 6, 'same': False}, 'dst': {'type': 'addresses_WT_ht', 'congruent': 3, 'same': True}, 'OP': 'REPM'}
