...
push %rdx
push %rsi
lea addresses_WC_ht+0x18e36, %rsi
lea addresses_WC_ht+0x12276, %rdi
nop
nop
sub $17299, %rax
mov $18, %rcx
...
nop
and $15807, %r9
lea addresses_WC_ht+0x130b6, %rdx
nop
nop
cmp %r12, %r12
mov (%rdx), %rax
...
mov (%rsi), %edx
add $32147, %rdx
lea addresses_A_ht+0xb36, %rsi
lea addresses_normal_ht+0x1e8b2, %rdi
add $26211, %r15
mov $78, %rcx
rep movsq
sub $30370, %rax
lea addresses_UC_ht+0x78b6, %r9
nop
dec %rdi
...
nop
add %rdx, %rdx
lea addresses_D_ht+0x17ba8, %rsi
lea addresses_D_ht+0x12536, %rdi
nop
add %r15, %r15
mov $109, %rcx
rep movsb
xor %r12, %r12
lea addresses_UC_ht+0x1b4b6, %rsi
lea addresses_normal_ht+0x1bb46, %rdi
clflush (%rdi)
nop
nop
nop
...
nop
sub %r12, %r12
lea addresses_normal_ht+0x128ac, %rax
and $56096, %r15
mov (%rax), %r9d
nop
nop
add $63316, %rdx
lea addresses_UC_ht+0x3dd4, %rdx
nop
nop
cmp %rsi, %rsi
mov (%rdx), %ecx
nop
dec %rcx
lea addresses_WT_ht+0xa10e, %rax
nop
nop
nop
nop
...
nop
sub %rdi, %rdi
lea addresses_normal_ht+0xceb6, %rcx
nop
nop
nop
nop
...
nop
xor %r9, %r9
lea addresses_normal_ht+0x3206, %r15
xor $11919, %rcx
movb $0x61, (%r15)
nop
nop
...
{'src': {'type': 'addresses_A_ht', 'congruent': 6, 'same': False}, 'dst': {'type': 'addresses_normal_ht', 'congruent': 2, 'same': False}, 'OP': 'REPM'}
