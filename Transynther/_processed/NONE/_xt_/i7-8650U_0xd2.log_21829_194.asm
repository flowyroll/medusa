...
nop
add $50547, %rsi
lea addresses_WC_ht+0x12a6b, %rsi
nop
nop
nop
inc %r12
mov (%rsi), %r13w
cmp $17273, %rsi
lea addresses_UC_ht+0x811b, %rcx
nop
nop
xor $52393, %rbx
movups (%rcx), %xmm5
...
lea addresses_WT_ht+0x136e7, %rdi
nop
nop
nop
nop
...
nop
add %rbx, %rbx
lea addresses_normal_ht+0xd48f, %rsi
lea addresses_A_ht+0x1e2e0, %rdi
nop
cmp $9440, %rax
mov $1, %rcx
rep movsq
...
nop
cmp $40607, %rcx
lea addresses_normal_ht+0x356b, %rsi
lea addresses_A_ht+0x1121b, %rdi
clflush (%rsi)
nop
nop
nop
...
nop
and $40047, %r12
lea addresses_WT_ht+0x1e973, %r12
nop
nop
nop
nop
...
nop
and %r13, %r13
lea addresses_D_ht+0x1d21b, %rcx
nop
nop
nop
nop
...
{'OP': 'LOAD', 'src': {'type': 'addresses_A_ht', 'size': 4, 'AVXalign': False, 'NT': False, 'congruent': 10, 'same': True}}
...
{'OP': 'STOR', 'dst': {'type': 'addresses_WC_ht', 'size': 32, 'AVXalign': False, 'NT': False, 'congruent': 3, 'same': True}}
...
{'OP': 'REPM', 'src': {'type': 'addresses_normal_ht', 'congruent': 4, 'same': False}, 'dst': {'type': 'addresses_A_ht', 'congruent': 11, 'same': False}}
