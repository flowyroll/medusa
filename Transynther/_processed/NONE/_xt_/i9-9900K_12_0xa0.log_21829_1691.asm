...
push %rdx
push %rsi
lea addresses_normal_ht+0x9141, %rdi
nop
nop
and %r11, %r11
movb (%rdi), %dl
...
nop
cmp %r9, %r9
lea addresses_D_ht+0x19e01, %r14
nop
nop
nop
nop
...
movb $0x61, (%r14)
sub %r11, %r11
lea addresses_normal_ht+0x1a6f1, %r9
xor %rsi, %rsi
mov (%r9), %edi
sub $34948, %rdx
lea addresses_WC_ht+0x124b9, %rcx
cmp %r9, %r9
...
nop
xor $26403, %r14
lea addresses_normal_ht+0x19031, %r14
clflush (%r14)
nop
nop
nop
...
nop
sub $39542, %r9
lea addresses_WC_ht+0xe631, %rsi
lea addresses_WC_ht+0xc511, %rdi
nop
sub $15043, %r10
mov $18, %rcx
rep movsw
...
nop
sub %r10, %r10
lea addresses_WT_ht+0x6181, %rcx
nop
nop
nop
xor %r9, %r9
movl $0x61626364, (%rcx)
cmp $16635, %r11
lea addresses_WT_ht+0x5731, %rsi
lea addresses_WT_ht+0x7a54, %rdi
nop
nop
xor $8211, %rdx
mov $20, %rcx
...
{'src': {'same': False, 'congruent': 8, 'type': 'addresses_WC_ht'}, 'OP': 'REPM', 'dst': {'same': True, 'congruent': 5, 'type': 'addresses_WC_ht'}}
{'OP': 'STOR', 'dst': {'NT': False, 'same': False, 'congruent': 3, 'type': 'addresses_WT_ht', 'AVXalign': False, 'size': 4}}
{'src': {'same': False, 'congruent': 11, 'type': 'addresses_WT_ht'}, 'OP': 'REPM', 'dst': {'same': False, 'congruent': 0, 'type': 'addresses_WT_ht'}}
{'32': 21829}
