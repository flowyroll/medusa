...
push %rdx
push %rsi
lea addresses_normal_ht+0x1269e, %rcx
nop
nop
xor %rdx, %rdx
movb $0x61, (%rcx)
...
lea addresses_UC_ht+0x1a5f0, %rdi
nop
add $63436, %r9
mov $111, %rcx
rep movsw
...
nop
dec %rbp
lea addresses_WC_ht+0x8dd0, %rsi
lea addresses_UC_ht+0xab60, %rdi
nop
nop
nop
nop
...
nop
dec %r9
lea addresses_A_ht+0x193a4, %rsi
lea addresses_WC_ht+0x21d0, %rdi
nop
nop
nop
cmp %r11, %r11
...
nop
xor %rdi, %rdi
lea addresses_normal_ht+0x1b580, %r9
nop
nop
cmp $45608, %rbp
movups (%r9), %xmm1
...
nop
dec %r15
lea addresses_UC_ht+0x109d0, %rsi
lea addresses_UC_ht+0xd470, %rdi
xor $41037, %rbp
mov $105, %rcx
rep movsw
nop
nop
add %r11, %r11
lea addresses_WC_ht+0x1bad0, %rsi
lea addresses_D_ht+0x1b210, %rdi
nop
nop
nop
nop
...
{'src': {'type': 'addresses_WC_ht', 'congruent': 10, 'same': True}, 'OP': 'REPM', 'dst': {'type': 'addresses_UC_ht', 'congruent': 4, 'same': False}}
