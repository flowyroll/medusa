...
nop
sub %rsi, %rsi
lea addresses_WT_ht+0x1c7aa, %rsi
clflush (%rsi)
xor %r11, %r11
...
nop
sub $24318, %r8
lea addresses_WT_ht+0x5baa, %rsi
lea addresses_UC_ht+0x111aa, %rdi
nop
nop
nop
nop
...
nop
and $8565, %rdi
lea addresses_UC_ht+0xde26, %r11
nop
cmp %r9, %r9
movb (%r11), %r8b
nop
cmp $37963, %r8
lea addresses_normal_ht+0x13aa, %rcx
nop
nop
xor $43257, %rbp
...
nop
xor $42598, %r9
lea addresses_normal_ht+0x12faa, %r11
clflush (%r11)
nop
nop
nop
...
nop
add %rsi, %rsi
lea addresses_normal_ht+0xa9aa, %rbp
clflush (%rbp)
nop
nop
nop
...
nop
inc %rdi
lea addresses_WC_ht+0x1820a, %rsi
lea addresses_WC_ht+0x3baa, %rdi
clflush (%rdi)
nop
nop
nop
...
{'src': {'type': 'addresses_WT_ht', 'same': False, 'size': 16, 'congruent': 5, 'NT': True, 'AVXalign': False}, 'OP': 'LOAD'}
{'dst': {'type': 'addresses_D_ht', 'same': False, 'size': 8, 'congruent': 11, 'NT': False, 'AVXalign': True}, 'OP': 'STOR'}
