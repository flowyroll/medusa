...
push %rdx
push %rsi
lea addresses_UC_ht+0xdbf6, %rbx
clflush (%rbx)
and $1133, %r11
movb $0x61, (%rbx)
nop
...
nop
sub %r10, %r10
lea addresses_UC_ht+0x18e96, %rdx
nop
nop
nop
cmp %rbx, %rbx
...
nop
and $15566, %r9
lea addresses_A_ht+0x10696, %rdx
nop
nop
inc %r11
mov (%rdx), %ebx
...
nop
and $20903, %r10
lea addresses_WT_ht+0x1a5ce, %rsi
...
nop
dec %rcx
lea addresses_UC_ht+0x8f96, %rsi
lea addresses_D_ht+0x2ca6, %rdi
nop
sub $16442, %r9
mov $15, %rcx
rep movsl
...
nop
add %r13, %r13
lea addresses_normal_ht+0x18696, %r13
nop
nop
nop
sub %rdx, %rdx
...
nop
dec %rcx
lea addresses_D_ht+0x18b1e, %rsi
lea addresses_D_ht+0x14e0c, %rdi
nop
nop
nop
nop
...
rep movsw
add %r9, %r9
lea addresses_A_ht+0x10296, %rsi
lea addresses_A_ht+0xddfa, %rdi
clflush (%rdi)
nop
nop
nop
...
nop
cmp %rbx, %rbx
lea addresses_normal_ht+0x17c3e, %rsi
lea addresses_WT_ht+0x6546, %rdi
nop
nop
nop
sub %r11, %r11
...
// Store
lea addresses_normal+0x11d96, %r14
clflush (%r14)
nop
nop
nop
...
{'OP': 'STOR', 'dst': {'type': 'addresses_normal', 'AVXalign': True, 'congruent': 8, 'size': 4, 'same': False, 'NT': False}}
[Faulty Load]
...
{'OP': 'REPM', 'src': {'type': 'addresses_D_ht', 'congruent': 3, 'same': False}, 'dst': {'type': 'addresses_D_ht', 'congruent': 1, 'same': True}}
