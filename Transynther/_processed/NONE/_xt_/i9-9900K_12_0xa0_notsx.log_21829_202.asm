...
nop
and %r11, %r11
lea addresses_A_ht+0x1230b, %rsi
cmp $38764, %rbx
mov $0x6162636465666768, %rdi
movq %rdi, (%rsi)
cmp $26715, %r11
lea addresses_WC_ht+0x472b, %rsi
lea addresses_WT_ht+0xaf0b, %rdi
clflush (%rdi)
nop
nop
nop
...
nop
and $21700, %rbp
lea addresses_WC_ht+0x408b, %r11
nop
dec %rdi
movw $0x6162, (%r11)
nop
...
{'src': {'type': 'addresses_WC_ht', 'congruent': 5, 'same': False}, 'OP': 'REPM', 'dst': {'type': 'addresses_WT_ht', 'congruent': 11, 'same': False}}
