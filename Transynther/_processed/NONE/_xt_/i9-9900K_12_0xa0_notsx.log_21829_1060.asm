...
push %rdi
push %rsi
lea addresses_UC_ht+0x12216, %rsi
add %r9, %r9
movl $0x61626364, (%rsi)
nop
nop
add $35927, %r8
lea addresses_D_ht+0x147b6, %rax
clflush (%rax)
nop
nop
nop
...
nop
add %r12, %r12
lea addresses_D_ht+0x1c16, %rsi
xor $25507, %r12
mov $0x6162636465666768, %rdi
movq %rdi, (%rsi)
nop
inc %rbx
lea addresses_normal_ht+0x17116, %rsi
lea addresses_normal_ht+0x1ca16, %rdi
nop
add %r12, %r12
mov $26, %rcx
rep movsw
nop
add %rsi, %rsi
lea addresses_WT_ht+0x518e, %rcx
nop
nop
nop
nop
...
nop
cmp $41514, %rsi
lea addresses_WC_ht+0x16aa6, %rdi
nop
nop
nop
nop
...
nop
cmp %rax, %rax
lea addresses_D_ht+0x11016, %rsi
...
nop
add %r12, %r12
lea addresses_WC_ht+0xafc6, %rdi
xor $7645, %rsi
vmovups (%rdi), %ymm0
vextracti128 $1, %ymm0, %xmm0
vpextrq $0, %xmm0, %r12
add %rcx, %rcx
lea addresses_A_ht+0x1ce16, %rbx
nop
nop
nop
nop
...
nop
xor %r8, %r8
lea addresses_UC_ht+0x11296, %r9
nop
nop
nop
nop
...
nop
inc %rdi
lea addresses_normal_ht+0x1b6d6, %rsi
lea addresses_D_ht+0x16516, %rdi
nop
dec %rbx
mov $13, %rcx
rep movsl
...
{'OP': 'STOR', 'dst': {'type': 'addresses_D_ht', 'AVXalign': False, 'size': 16, 'NT': True, 'same': True, 'congruent': 4}}
...
{'src': {'type': 'addresses_normal_ht', 'congruent': 8, 'same': False}, 'OP': 'REPM', 'dst': {'type': 'addresses_normal_ht', 'congruent': 11, 'same': False}}
