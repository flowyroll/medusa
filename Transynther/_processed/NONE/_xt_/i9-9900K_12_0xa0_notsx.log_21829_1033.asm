...
nop
add $19935, %r8
lea addresses_D_ht+0x4e65, %rsi
lea addresses_WT_ht+0x124f9, %rdi
nop
nop
nop
inc %rbp
...
nop
xor $54138, %rsi
lea addresses_A_ht+0x1c365, %rdi
nop
nop
dec %rbp
movb (%rdi), %r11b
...
nop
sub %r11, %r11
lea addresses_WC_ht+0xef16, %r13
nop
nop
nop
nop
...
mov (%r13), %esi
and $31562, %r13
lea addresses_WC_ht+0x1ea75, %rsi
lea addresses_A_ht+0x12e65, %rdi
clflush (%rsi)
nop
nop
nop
