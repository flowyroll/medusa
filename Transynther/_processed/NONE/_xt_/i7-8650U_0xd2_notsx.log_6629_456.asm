...
push %rdi
push %rsi
lea addresses_A_ht+0x5384, %rsi
lea addresses_UC_ht+0x184c4, %rdi
clflush (%rdi)
inc %rax
mov $125, %rcx
rep movsl
dec %rbx
lea addresses_normal_ht+0x170c4, %r8
clflush (%r8)
nop
dec %r10
...
nop
inc %rbx
lea addresses_D_ht+0x1ecd8, %rdi
clflush (%rdi)
sub $62939, %rsi
movups (%rdi), %xmm5
vpextrq $1, %xmm5, %rbx
...
nop
add $56272, %rbx
lea addresses_WT_ht+0x114c4, %rsi
lea addresses_A_ht+0x14bc4, %rdi
clflush (%rdi)
nop
nop
nop
...
nop
xor $30635, %r8
lea addresses_normal_ht+0x3b04, %rdi
nop
nop
nop
nop
...
// Load
lea addresses_normal+0xecc4, %r9
nop
nop
nop
cmp %r12, %r12
...
// Faulty Load
lea addresses_normal+0xecc4, %rcx
xor $4732, %r12
vmovups (%rcx), %ymm3
...
{'OP': 'STOR', 'dst': {'type': 'addresses_WT', 'size': 2, 'AVXalign': False, 'NT': True, 'congruent': 0, 'same': False}}
...
<gen_prepare_buffer>
{'OP': 'REPM', 'src': {'type': 'addresses_A_ht', 'congruent': 5, 'same': False}, 'dst': {'type': 'addresses_UC_ht', 'congruent': 6, 'same': False}}
