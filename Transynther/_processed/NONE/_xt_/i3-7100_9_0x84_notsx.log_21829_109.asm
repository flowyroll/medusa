...
lea addresses_D_ht+0x12e35, %rdi
clflush (%rdi)
nop
nop
cmp $10166, %rbx
...
nop
xor %rsi, %rsi
lea addresses_UC_ht+0x18875, %rcx
nop
nop
nop
nop
...
nop
add %rdi, %rdi
lea addresses_UC_ht+0x14235, %rbx
add %rdi, %rdi
mov (%rbx), %ecx
nop
nop
...
nop
inc %r15
lea addresses_WT_ht+0xa635, %rdi
nop
nop
nop
sub %rcx, %rcx
...
nop
cmp %r12, %r12
lea addresses_normal_ht+0x3435, %rsi
lea addresses_A_ht+0x15535, %rdi
clflush (%rsi)
nop
and %rax, %rax
mov $105, %rcx
...
nop
sub $6224, %rax
lea addresses_D_ht+0x13751, %r12
nop
nop
nop
nop
...
nop
sub $56687, %rsi
lea addresses_normal_ht+0xa08d, %rsi
lea addresses_WC_ht+0xf555, %rdi
nop
nop
nop
and %rax, %rax
...
nop
cmp $2198, %rax
lea addresses_UC_ht+0x12fb5, %rsi
nop
nop
nop
sub %rdi, %rdi
...
nop
dec %rdi
lea addresses_normal_ht+0x8ab5, %rsi
lea addresses_WT_ht+0xa235, %rdi
nop
nop
nop
and $53213, %rdx
...
{'src': {'type': 'addresses_D_ht', 'congruent': 3, 'same': False}, 'dst': {'type': 'addresses_D_ht', 'congruent': 11, 'same': False}, 'OP': 'REPM'}
...
{'src': {'type': 'addresses_normal_ht', 'congruent': 7, 'same': False}, 'dst': {'type': 'addresses_A_ht', 'congruent': 7, 'same': False}, 'OP': 'REPM'}
...
{'src': {'type': 'addresses_normal_ht', 'congruent': 7, 'same': False}, 'dst': {'type': 'addresses_WT_ht', 'congruent': 10, 'same': False}, 'OP': 'REPM'}
{'32': 21829}
