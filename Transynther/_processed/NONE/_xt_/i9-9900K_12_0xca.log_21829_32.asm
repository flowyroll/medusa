...
push %rdi
push %rsi
lea addresses_WT_ht+0x1d8c9, %r14
nop
nop
nop
nop
...
nop
cmp %r14, %r14
lea addresses_D_ht+0x906d, %rsi
lea addresses_A_ht+0x112fd, %rdi
nop
nop
and %r12, %r12
mov $30, %rcx
...
nop
add %r12, %r12
lea addresses_WT_ht+0x1c2fd, %rdi
nop
sub %r8, %r8
movl $0x61626364, (%rdi)
nop
...
nop
dec %r10
lea addresses_A_ht+0xa6f8, %rsi
lea addresses_WC_ht+0x183bd, %rdi
nop
sub $18498, %r14
mov $64, %rcx
rep movsq
...
movups %xmm4, (%rsi)
xor $7952, %r8
lea addresses_D_ht+0x4ed, %rsi
lea addresses_WT_ht+0x199fd, %rdi
nop
nop
nop
nop
...
nop
and $62691, %r14
lea addresses_D_ht+0x511d, %rsi
lea addresses_normal_ht+0x1049d, %rdi
inc %r12
mov $121, %rcx
rep movsw
nop
...
nop
xor $40801, %r10
lea addresses_UC_ht+0x51fd, %rdi
nop
nop
nop
xor $44472, %rsi
...
// Faulty Load
lea addresses_normal+0xbefd, %r8
nop
nop
nop
nop
...
{'OP': 'REPM', 'src': {'same': False, 'type': 'addresses_D_ht', 'congruent': 4}, 'dst': {'same': False, 'type': 'addresses_A_ht', 'congruent': 8}}
...
{'OP': 'REPM', 'src': {'same': False, 'type': 'addresses_D_ht', 'congruent': 5}, 'dst': {'same': False, 'type': 'addresses_normal_ht', 'congruent': 5}}
