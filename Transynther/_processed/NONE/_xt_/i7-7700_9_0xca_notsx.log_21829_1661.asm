...
push %rdi
push %rsi
lea addresses_D_ht+0x1e9f5, %rsi
nop
nop
nop
nop
...
nop
and $6659, %rax
lea addresses_WT_ht+0xada3, %r13
nop
nop
cmp %rdi, %rdi
movb (%r13), %cl
...
nop
and %r9, %r9
lea addresses_UC_ht+0xda97, %r14
nop
nop
nop
nop
...
nop
inc %r14
lea addresses_UC_ht+0x173f5, %rsi
lea addresses_UC_ht+0x35f5, %rdi
nop
nop
nop
nop
...
nop
add %r14, %r14
lea addresses_UC_ht+0x1e475, %rsi
cmp $22777, %rdi
mov (%rsi), %r8w
nop
nop
...
nop
cmp %r14, %r14
lea addresses_UC_ht+0x1bdf5, %r9
nop
dec %rdi
mov (%r9), %eax
nop
...
{'dst': {'NT': True, 'AVXalign': False, 'size': 16, 'congruent': 1, 'same': False, 'type': 'addresses_UC_ht'}, 'OP': 'STOR'}
{'src': {'congruent': 10, 'same': False, 'type': 'addresses_UC_ht'}, 'dst': {'congruent': 9, 'same': False, 'type': 'addresses_UC_ht'}, 'OP': 'REPM'}
{'dst': {'NT': False, 'AVXalign': True, 'size': 32, 'congruent': 7, 'same': True, 'type': 'addresses_D_ht'}, 'OP': 'STOR'}
