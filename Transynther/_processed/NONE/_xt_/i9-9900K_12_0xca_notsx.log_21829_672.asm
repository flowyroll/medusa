...
push %rdx
push %rsi
lea addresses_WT_ht+0x4316, %r10
nop
nop
nop
xor %rdx, %rdx
...
nop
add $4611, %r11
lea addresses_D_ht+0x1c396, %rbp
nop
and $25749, %r13
...
nop
sub %r11, %r11
lea addresses_WT_ht+0x8c96, %rsi
lea addresses_A_ht+0x10f96, %rdi
and %r11, %r11
mov $95, %rcx
rep movsq
nop
...
mov (%r13), %edi
cmp $48882, %rcx
lea addresses_D_ht+0x1c856, %r13
nop
nop
nop
nop
...
// REPMOV
lea addresses_D+0x1ba16, %rsi
lea addresses_D+0x1ba16, %rdi
nop
nop
nop
nop
...
<gen_prepare_buffer>
{'OP': 'STOR', 'dst': {'same': False, 'type': 'addresses_WT_ht', 'NT': True, 'AVXalign': False, 'size': 4, 'congruent': 8}}
