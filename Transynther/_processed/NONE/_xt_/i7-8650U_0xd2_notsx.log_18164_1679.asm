...
push %rdx
push %rsi
lea addresses_WC_ht+0xd2a7, %rsi
xor %rdx, %rdx
movb $0x61, (%rsi)
nop
inc %r11
lea addresses_A_ht+0xbf6f, %rsi
lea addresses_UC_ht+0xf6f, %rdi
sub $35518, %r13
mov $27, %rcx
rep movsw
nop
...
nop
dec %r11
lea addresses_normal_ht+0x1dfef, %rcx
nop
nop
nop
xor $11355, %r11
movb (%rcx), %r13b
and $25527, %rdx
lea addresses_D_ht+0x1ee53, %rdx
nop
nop
xor %r13, %r13
movups (%rdx), %xmm1
vpextrq $1, %xmm1, %rsi
dec %r14
lea addresses_WC_ht+0x22e6, %rsi
nop
nop
nop
dec %rdx
...
nop
xor $45913, %rcx
lea addresses_WC_ht+0x1b36f, %rsi
lea addresses_A_ht+0x7991, %rdi
nop
nop
nop
nop
...
nop
and %rdx, %rdx
lea addresses_normal_ht+0xdafd, %rcx
xor %rsi, %rsi
mov $0x6162636465666768, %rdi
movq %rdi, %xmm3
...
nop
sub $33837, %rsi
lea addresses_WT_ht+0x1056f, %rsi
lea addresses_WC_ht+0x76f, %rdi
clflush (%rsi)
clflush (%rdi)
nop
nop
...
// Faulty Load
lea addresses_normal+0x4f6f, %r12
nop
nop
cmp $41193, %r15
movb (%r12), %r11b
...
{'OP': 'REPM', 'src': {'type': 'addresses_A_ht', 'congruent': 10, 'same': True}, 'dst': {'type': 'addresses_UC_ht', 'congruent': 7, 'same': False}}
...
{'OP': 'LOAD', 'src': {'type': 'addresses_D_ht', 'size': 16, 'AVXalign': False, 'NT': False, 'congruent': 2, 'same': True}}
{'OP': 'LOAD', 'src': {'type': 'addresses_WC_ht', 'size': 8, 'AVXalign': False, 'NT': False, 'congruent': 0, 'same': True}}
{'OP': 'REPM', 'src': {'type': 'addresses_WC_ht', 'congruent': 10, 'same': False}, 'dst': {'type': 'addresses_A_ht', 'congruent': 1, 'same': False}}
