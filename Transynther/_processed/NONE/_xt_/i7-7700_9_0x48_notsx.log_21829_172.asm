...
push %rdx
push %rsi
lea addresses_UC_ht+0x1dbb5, %rsi
lea addresses_WC_ht+0x18c55, %rdi
nop
nop
xor $952, %r11
mov $94, %rcx
...
nop
and %rdx, %rdx
lea addresses_UC_ht+0xb53d, %rsi
nop
nop
nop
nop
...
// Store
lea addresses_normal+0x14535, %rdi
nop
nop
nop
nop
...
// REPMOV
lea addresses_normal+0xc7d, %rsi
lea addresses_D+0x1816d, %rdi
clflush (%rsi)
sub $9226, %rax
mov $103, %rcx
rep movsw
...
{'dst': {'same': False, 'congruent': 8, 'type': 'addresses_D'}, 'OP': 'REPM', 'src': {'same': False, 'congruent': 4, 'type': 'addresses_normal'}}
[Faulty Load]
{'OP': 'LOAD', 'src': {'same': True, 'NT': False, 'AVXalign': False, 'size': 1, 'type': 'addresses_D', 'congruent': 0}}
<gen_prepare_buffer>
{'dst': {'same': False, 'congruent': 3, 'type': 'addresses_WC_ht'}, 'OP': 'REPM', 'src': {'same': False, 'congruent': 3, 'type': 'addresses_UC_ht'}}
