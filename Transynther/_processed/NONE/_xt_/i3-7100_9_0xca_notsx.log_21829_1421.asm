...
push %rdx
push %rsi
lea addresses_WT_ht+0x3c5d, %r11
sub %r10, %r10
...
nop
mfence
lea addresses_WT_ht+0x1a6dd, %rsi
lea addresses_WC_ht+0x13f65, %rdi
nop
nop
cmp $6254, %rbp
mov $0, %rcx
...
nop
dec %rcx
lea addresses_WT_ht+0x1ddf7, %rbp
and $61618, %rdx
movw $0x6162, (%rbp)
nop
add %rdi, %rdi
lea addresses_A_ht+0xe5d5, %rsi
lea addresses_WT_ht+0x1e45, %rdi
nop
nop
dec %rbp
mov $112, %rcx
...
nop
cmp $442, %rcx
lea addresses_UC_ht+0x1dbdd, %r12
nop
nop
nop
nop
...
nop
cmp %r11, %r11
lea addresses_normal_ht+0x8d, %rsi
lea addresses_normal_ht+0x4b7, %rdi
nop
nop
nop
nop
...
nop
and $14316, %rsi
lea addresses_UC_ht+0x1c6dd, %r11
cmp $53365, %rcx
mov (%r11), %ebp
nop
nop
...
nop
cmp $32959, %r10
lea addresses_WT_ht+0x1addd, %r11
nop
nop
and %rdx, %rdx
movw $0x6162, (%r11)
...
nop
sub %rcx, %rcx
lea addresses_WC_ht+0x3ff7, %rsi
lea addresses_WC_ht+0x13dd, %rdi
nop
nop
cmp %rbp, %rbp
mov $86, %rcx
...
// Faulty Load
lea addresses_normal+0x1bfdd, %r14
nop
nop
nop
nop
...
{'src': {'type': 'addresses_A_ht', 'congruent': 2, 'same': False}, 'OP': 'REPM', 'dst': {'type': 'addresses_WT_ht', 'congruent': 3, 'same': False}}
...
{'src': {'type': 'addresses_normal_ht', 'congruent': 4, 'same': True}, 'OP': 'REPM', 'dst': {'type': 'addresses_normal_ht', 'congruent': 0, 'same': False}}
...
{'src': {'type': 'addresses_WC_ht', 'congruent': 1, 'same': False}, 'OP': 'REPM', 'dst': {'type': 'addresses_WC_ht', 'congruent': 10, 'same': True}}
{'34': 21829}
