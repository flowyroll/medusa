...
nop
sub %rbx, %rbx
lea addresses_WC_ht+0x36da, %r10
nop
nop
nop
cmp %rbx, %rbx
...
nop
xor %rcx, %rcx
lea addresses_D_ht+0x6fda, %rsi
lea addresses_A_ht+0x1e9f3, %rdi
clflush (%rdi)
nop
nop
nop
...
nop
add %r8, %r8
lea addresses_normal_ht+0x2862, %rdi
nop
nop
nop
cmp $20436, %rbx
...
nop
sub $3178, %rbp
lea addresses_WC_ht+0x17870, %r12
clflush (%r12)
nop
nop
nop
...
{'src': {'NT': False, 'same': False, 'congruent': 8, 'type': 'addresses_P', 'AVXalign': False, 'size': 16}, 'OP': 'LOAD'}
[Faulty Load]
{'src': {'NT': False, 'same': True, 'congruent': 0, 'type': 'addresses_RW', 'AVXalign': False, 'size': 2}, 'OP': 'LOAD'}
<gen_prepare_buffer>
{'src': {'same': True, 'congruent': 6, 'type': 'addresses_normal_ht'}, 'OP': 'REPM', 'dst': {'same': False, 'congruent': 0, 'type': 'addresses_WT_ht'}}
...
{'src': {'same': False, 'congruent': 8, 'type': 'addresses_D_ht'}, 'OP': 'REPM', 'dst': {'same': False, 'congruent': 0, 'type': 'addresses_A_ht'}}
