...
nop
and $1849, %rdi
lea addresses_UC_ht+0x1cafe, %rdi
nop
nop
inc %r10
movw $0x6162, (%rdi)
...
nop
and $19868, %r8
lea addresses_WT_ht+0x1c8de, %rsi
...
<gen_faulty_load>
[REF]
{'OP': 'LOAD', 'src': {'type': 'addresses_UC', 'size': 16, 'AVXalign': True, 'NT': True, 'congruent': 0, 'same': False}}
