...
lea addresses_WT_ht+0x138a3, %rdi
nop
nop
nop
nop
...
nop
cmp $12133, %rsi
lea addresses_WC_ht+0x13983, %r11
xor $31142, %rsi
...
nop
inc %rdi
lea addresses_UC_ht+0x14483, %rdi
nop
nop
nop
nop
...
nop
cmp %r8, %r8
lea addresses_WC_ht+0x1baa3, %rsi
lea addresses_D_ht+0x169a3, %rdi
nop
nop
nop
nop
