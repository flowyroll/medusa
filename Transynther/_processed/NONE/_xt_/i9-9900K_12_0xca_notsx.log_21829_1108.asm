...
lea addresses_UC_ht+0xe635, %rdi
nop
nop
nop
nop
...
nop
dec %r11
lea addresses_normal_ht+0x27b5, %rsi
nop
and %r13, %r13
mov $0x6162636465666768, %rdi
movq %rdi, (%rsi)
dec %rdi
lea addresses_A_ht+0xe235, %r11
nop
nop
nop
xor %rbp, %rbp
...
nop
dec %rdi
lea addresses_WC_ht+0x161ed, %rsi
nop
mfence
mov (%rsi), %r11
nop
...
nop
add %r11, %r11
lea addresses_WC_ht+0x14f85, %rsi
lea addresses_WT_ht+0x2988, %rdi
and $63440, %r14
mov $41, %rcx
rep movsb
nop
add $13251, %r15
lea addresses_WC_ht+0x9125, %rcx
nop
nop
nop
nop
...
movb (%rcx), %r14b
xor %r13, %r13
lea addresses_D_ht+0x1939d, %r13
nop
nop
sub $11218, %r15
mov (%r13), %r11w
