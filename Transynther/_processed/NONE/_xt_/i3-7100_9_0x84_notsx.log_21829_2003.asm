...
push %rdi
push %rsi
lea addresses_A_ht+0xeae0, %rsi
lea addresses_UC_ht+0xa3c0, %rdi
nop
nop
xor %r14, %r14
mov $2, %rcx
...
nop
xor $64688, %rsi
lea addresses_D_ht+0xfb70, %r10
nop
sub %rdi, %rdi
mov (%r10), %r11w
xor $17071, %rdi
lea addresses_D_ht+0x4bf8, %rcx
nop
nop
nop
add %r15, %r15
...
nop
add %rdi, %rdi
lea addresses_D_ht+0x1e370, %rsi
lea addresses_normal_ht+0x165f0, %rdi
nop
nop
nop
and $1345, %r11
...
nop
xor %rsi, %rsi
lea addresses_A_ht+0x11ec8, %rsi
lea addresses_WT_ht+0x1b290, %rdi
nop
cmp $64768, %r9
mov $17, %rcx
rep movsb
...
// Faulty Load
lea addresses_normal+0x12370, %rax
nop
nop
add %r15, %r15
movups (%rax), %xmm5
