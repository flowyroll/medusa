...
push %rdi
push %rsi
lea addresses_normal_ht+0x16df, %rsi
lea addresses_D_ht+0x811d, %rdi
nop
nop
nop
dec %r11
...
rep movsb
dec %r10
lea addresses_UC_ht+0x1683d, %r14
nop
nop
nop
xor %r15, %r15
...
nop
inc %r10
lea addresses_WT_ht+0x423d, %rsi
lea addresses_WC_ht+0x303d, %rdi
mfence
mov $64, %rcx
rep movsq
nop
...
{'OP': 'LOAD', 'src': {'same': False, 'type': 'addresses_WT', 'NT': True, 'AVXalign': True, 'size': 2, 'congruent': 2}}
{'OP': 'STOR', 'dst': {'same': False, 'type': 'addresses_WC', 'NT': False, 'AVXalign': False, 'size': 4, 'congruent': 11}}
{'OP': 'LOAD', 'src': {'same': False, 'type': 'addresses_US', 'NT': False, 'AVXalign': False, 'size': 4, 'congruent': 9}}
...
{'OP': 'STOR', 'dst': {'same': False, 'type': 'addresses_PSE', 'NT': False, 'AVXalign': True, 'size': 4, 'congruent': 4}}
...
{'OP': 'REPM', 'src': {'same': False, 'congruent': 9, 'type': 'addresses_WT_ht'}, 'dst': {'same': True, 'congruent': 11, 'type': 'addresses_WC_ht'}}
{'33': 21829}
