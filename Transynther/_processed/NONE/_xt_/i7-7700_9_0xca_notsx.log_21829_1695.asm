...
push %rdx
push %rsi
lea addresses_A_ht+0x16f33, %rbx
nop
nop
nop
nop
...
nop
add %rdi, %rdi
lea addresses_WC_ht+0x187c3, %rdi
xor $43120, %rsi
...
nop
cmp $52745, %rbx
lea addresses_WT_ht+0x1a9cb, %rsi
lea addresses_WC_ht+0x7ccb, %rdi
clflush (%rsi)
nop
nop
and %rdx, %rdx
...
nop
sub %rbx, %rbx
lea addresses_WT_ht+0xe718, %rdx
clflush (%rdx)
nop
nop
nop
...
nop
xor $32660, %rdi
lea addresses_A_ht+0x150eb, %rbp
and $29128, %rcx
...
nop
dec %rsi
lea addresses_WC_ht+0x4e25, %rsi
lea addresses_A_ht+0x154cb, %rdi
nop
sub $56204, %r15
mov $25, %rcx
rep movsb
...
nop
cmp %rdi, %rdi
lea addresses_normal_ht+0xce1b, %rcx
nop
nop
nop
nop
...
nop
sub $1463, %rcx
lea addresses_normal_ht+0x91eb, %rdi
nop
nop
inc %rsi
...
nop
dec %rbx
lea addresses_normal_ht+0xcc1f, %rbx
nop
nop
nop
nop
...
nop
cmp $29463, %r14
lea addresses_normal_ht+0x1c8fb, %rbx
and %rsi, %rsi
movb $0x61, (%rbx)
sub %rbp, %rbp
pop %rsi
...
{'src': {'congruent': 7, 'same': False, 'type': 'addresses_WT_ht'}, 'dst': {'congruent': 9, 'same': True, 'type': 'addresses_WC_ht'}, 'OP': 'REPM'}
...
{'src': {'congruent': 0, 'same': True, 'type': 'addresses_WC_ht'}, 'dst': {'congruent': 10, 'same': False, 'type': 'addresses_A_ht'}, 'OP': 'REPM'}
