...
push %rdx
push %rsi
lea addresses_normal_ht+0x888, %r9
sub %rbx, %rbx
vmovups (%r9), %ymm4
...
nop
and $40757, %r13
lea addresses_normal_ht+0x12ac8, %r12
nop
sub %rdx, %rdx
vmovups (%r12), %ymm2
...
{'OP': 'STOR', 'dst': {'type': 'addresses_PSE', 'size': 16, 'AVXalign': False, 'NT': True, 'congruent': 5, 'same': False}}
[Faulty Load]
