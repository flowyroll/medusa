...
push %rdi
push %rsi
lea addresses_normal_ht+0x2ae4, %r9
add $32691, %r14
...
nop
cmp $11888, %rbx
lea addresses_UC_ht+0x17ee4, %rsi
lea addresses_normal_ht+0x138e4, %rdi
clflush (%rsi)
nop
nop
xor %r13, %r13
...
nop
add $52475, %rdi
lea addresses_normal_ht+0x2a84, %r15
clflush (%r15)
nop
nop
add $9852, %rdi
movb $0x61, (%r15)
inc %rdi
lea addresses_UC_ht+0x5dcc, %r14
nop
nop
nop
nop
