...
push %rdi
push %rsi
lea addresses_WC_ht+0x16f05, %r12
nop
and %r11, %r11
movups (%r12), %xmm0
vpextrq $1, %xmm0, %rdi
add $48981, %r8
lea addresses_normal_ht+0x1205, %rax
nop
nop
nop
nop
...
nop
and %r12, %r12
lea addresses_normal_ht+0x7005, %r11
nop
nop
nop
add %r14, %r14
...
nop
add %r11, %r11
lea addresses_UC_ht+0x8005, %rax
nop
nop
nop
nop
...
nop
cmp $11260, %r14
lea addresses_UC_ht+0x7e21, %r14
clflush (%r14)
nop
nop
nop
...
nop
and %r8, %r8
lea addresses_UC_ht+0x1b085, %r14
nop
inc %r11
movb (%r14), %al
nop
...
nop
sub %r8, %r8
lea addresses_WC_ht+0x17805, %rax
nop
nop
nop
dec %r11
...
nop
lfence
lea addresses_A_ht+0x16517, %rsi
lea addresses_WT_ht+0x10515, %rdi
dec %r14
mov $50, %rcx
rep movsq
nop
...
{'OP': 'STOR', 'dst': {'same': True, 'congruent': 0, 'NT': False, 'type': 'addresses_UC_ht', 'size': 1, 'AVXalign': False}}
