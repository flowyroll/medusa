...
push %rdi
push %rsi
lea addresses_A_ht+0x536a, %rsi
lea addresses_normal_ht+0x6bea, %rdi
nop
sub %r13, %r13
mov $106, %rcx
rep movsq
...
nop
add $13833, %rax
lea addresses_A_ht+0x32d6, %rcx
nop
cmp %r8, %r8
movb (%rcx), %r9b
nop
cmp $57113, %r9
lea addresses_A_ht+0x146fa, %rsi
lea addresses_WT_ht+0x1bbea, %rdi
nop
nop
nop
cmp %r10, %r10
...
{'OP': 'STOR', 'dst': {'type': 'addresses_WT', 'size': 32, 'AVXalign': False, 'NT': True, 'congruent': 0, 'same': False}}
[Faulty Load]
