...
nop
inc %rcx
lea addresses_normal_ht+0x1c907, %rcx
dec %rdx
movl $0x61626364, (%rcx)
nop
nop
sub $27003, %r12
lea addresses_UC_ht+0x33e7, %rdx
nop
nop
mfence
movw $0x6162, (%rdx)
xor $13127, %rdx
lea addresses_WC_ht+0x1627b, %rbp
add %r12, %r12
mov (%rbp), %ecx
and %r15, %r15
lea addresses_normal_ht+0x13167, %rcx
nop
nop
nop
and %r15, %r15
...
movq %rdx, (%rcx)
and %r12, %r12
lea addresses_UC_ht+0xa367, %rdx
nop
nop
nop
nop
...
nop
and %r15, %r15
lea addresses_normal_ht+0xabea, %rdx
clflush (%rdx)
add $17330, %r15
...
nop
and %rcx, %rcx
lea addresses_WC_ht+0x15d67, %rdx
nop
nop
nop
sub $15469, %r15
...
nop
sub %rsi, %rsi
lea addresses_WT_ht+0x19f87, %r15
nop
nop
nop
nop
...
// Faulty Load
lea addresses_normal+0xc967, %rbp
nop
nop
nop
nop
...
{'src': {'congruent': 9, 'same': False, 'type': 'addresses_WT_ht'}, 'dst': {'congruent': 8, 'same': False, 'type': 'addresses_D_ht'}, 'OP': 'REPM'}
...
{'src': {'NT': False, 'AVXalign': True, 'size': 4, 'congruent': 2, 'same': False, 'type': 'addresses_WC_ht'}, 'OP': 'LOAD'}
...
{'dst': {'NT': True, 'AVXalign': False, 'size': 32, 'congruent': 10, 'same': False, 'type': 'addresses_WC_ht'}, 'OP': 'STOR'}
