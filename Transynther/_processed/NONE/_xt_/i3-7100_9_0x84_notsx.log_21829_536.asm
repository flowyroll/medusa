...
nop
and %r10, %r10
lea addresses_UC_ht+0x18e5, %rbx
clflush (%rbx)
cmp %r12, %r12
...
movups %xmm1, (%rbx)
add $42750, %rbx
lea addresses_normal_ht+0x3a35, %rsi
...
nop
sub %rbx, %rbx
lea addresses_WC_ht+0xc3ef, %rsi
lea addresses_UC_ht+0x56d9, %rdi
nop
nop
nop
nop
...
nop
inc %rsi
lea addresses_normal_ht+0x113cb, %r12
nop
nop
and %rdx, %rdx
...
nop
xor %r12, %r12
lea addresses_UC_ht+0xdc35, %rsi
...
// REPMOV
lea addresses_D+0x16435, %rsi
lea addresses_D+0xda35, %rdi
nop
nop
nop
nop
...
{'src': {'type': 'addresses_D', 'congruent': 9, 'same': False}, 'dst': {'type': 'addresses_D', 'congruent': 0, 'same': True}, 'OP': 'REPM'}
...
{'src': {'type': 'addresses_WC_ht', 'congruent': 0, 'same': False}, 'dst': {'type': 'addresses_UC_ht', 'congruent': 2, 'same': False}, 'OP': 'REPM'}
{'dst': {'type': 'addresses_normal_ht', 'same': False, 'size': 16, 'congruent': 1, 'NT': False, 'AVXalign': True}, 'OP': 'STOR'}
{'src': {'type': 'addresses_UC_ht', 'congruent': 7, 'same': False}, 'dst': {'type': 'addresses_A_ht', 'congruent': 0, 'same': True}, 'OP': 'REPM'}
{'36': 21829}
