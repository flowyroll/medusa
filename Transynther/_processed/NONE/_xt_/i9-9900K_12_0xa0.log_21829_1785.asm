...
push %rdx
push %rsi
lea addresses_WT_ht+0x4eb2, %rsi
lea addresses_WC_ht+0x1de90, %rdi
nop
nop
nop
dec %rdx
...
nop
cmp $22651, %rdi
lea addresses_A_ht+0x16ef2, %rsi
lea addresses_WT_ht+0x19e72, %rdi
and %r13, %r13
mov $116, %rcx
rep movsq
nop
...
nop
xor $42474, %rdx
lea addresses_WC_ht+0x8e72, %rsi
...
rep movsb
xor $17705, %rdx
lea addresses_D_ht+0x139f2, %rsi
lea addresses_WC_ht+0x6a72, %rdi
clflush (%rsi)
nop
nop
and %r8, %r8
...
nop
cmp %r13, %r13
lea addresses_D_ht+0xaa72, %rsi
lea addresses_WC_ht+0x7c1a, %rdi
inc %r11
mov $112, %rcx
rep movsl
nop
...
nop
add $396, %rbx
lea addresses_UC_ht+0x1af72, %r8
nop
nop
nop
nop
...
nop
and %rbx, %rbx
lea addresses_UC_ht+0x1672, %rdi
nop
nop
nop
add $29748, %r11
...
nop
and %r8, %r8
lea addresses_WC_ht+0x14972, %r11
nop
nop
xor $50589, %r13
...
nop
and $2886, %rcx
lea addresses_D_ht+0x16654, %rsi
lea addresses_UC_ht+0x78da, %rdi
nop
nop
cmp $17151, %r13
mov $87, %rcx
...
// Faulty Load
lea addresses_normal+0x7272, %rax
clflush (%rax)
nop
nop
nop
...
<gen_prepare_buffer>
{'src': {'same': False, 'congruent': 4, 'type': 'addresses_WT_ht'}, 'OP': 'REPM', 'dst': {'same': False, 'congruent': 0, 'type': 'addresses_WC_ht'}}
...
{'src': {'same': False, 'congruent': 8, 'type': 'addresses_WC_ht'}, 'OP': 'REPM', 'dst': {'same': False, 'congruent': 3, 'type': 'addresses_WC_ht'}}
...
{'OP': 'STOR', 'dst': {'NT': True, 'same': False, 'congruent': 7, 'type': 'addresses_WC_ht', 'AVXalign': False, 'size': 16}}
