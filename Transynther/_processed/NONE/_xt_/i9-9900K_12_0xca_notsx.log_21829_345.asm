...
lea addresses_WC_ht+0xe95c, %rdi
clflush (%rdi)
nop
nop
nop
...
nop
dec %r10
lea addresses_WT_ht+0x160dc, %r10
nop
xor $10252, %rax
mov (%r10), %r9
add $55999, %rsi
lea addresses_normal_ht+0x32a4, %r10
nop
nop
nop
nop
...
<gen_prepare_buffer>
{'OP': 'REPM', 'src': {'same': False, 'congruent': 10, 'type': 'addresses_D_ht'}, 'dst': {'same': False, 'congruent': 11, 'type': 'addresses_WT_ht'}}
{'OP': 'REPM', 'src': {'same': False, 'congruent': 10, 'type': 'addresses_A_ht'}, 'dst': {'same': False, 'congruent': 10, 'type': 'addresses_WC_ht'}}
