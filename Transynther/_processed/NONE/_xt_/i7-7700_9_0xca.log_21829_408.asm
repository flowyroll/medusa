...
nop
sub %rdi, %rdi
lea addresses_UC_ht+0x1ba14, %rsi
lea addresses_D_ht+0x6014, %rdi
clflush (%rsi)
nop
nop
nop
...
nop
sub $32229, %r11
lea addresses_WT_ht+0xb014, %rdi
nop
nop
nop
sub %r9, %r9
...
nop
sub %r9, %r9
lea addresses_UC_ht+0x5f14, %rsi
lea addresses_UC_ht+0x12814, %rdi
nop
nop
cmp $18732, %r14
mov $89, %rcx
...
nop
add %r11, %r11
lea addresses_D_ht+0x173e9, %rcx
nop
nop
nop
xor $32357, %r13
...
nop
inc %r14
lea addresses_normal_ht+0x8414, %rsi
lea addresses_WT_ht+0x5a14, %rdi
nop
nop
nop
nop
...
rep movsb
sub %r11, %r11
lea addresses_WT_ht+0x14194, %rsi
lea addresses_D_ht+0x19014, %rdi
nop
nop
dec %r9
mov $86, %rcx
...
nop
xor %r9, %r9
lea addresses_WC_ht+0x1408c, %r11
and %rsi, %rsi
mov (%r11), %di
nop
nop
...
<gen_faulty_load>
[REF]
{'src': {'congruent': 0, 'AVXalign': False, 'same': True, 'size': 1, 'NT': True, 'type': 'addresses_D'}, 'OP': 'LOAD'}
...
{'OP': 'STOR', 'dst': {'congruent': 0, 'AVXalign': True, 'same': False, 'size': 4, 'NT': False, 'type': 'addresses_D_ht'}}
{'src': {'congruent': 5, 'same': False, 'type': 'addresses_normal_ht'}, 'OP': 'REPM', 'dst': {'congruent': 8, 'same': False, 'type': 'addresses_WT_ht'}}
{'src': {'congruent': 6, 'same': True, 'type': 'addresses_WT_ht'}, 'OP': 'REPM', 'dst': {'congruent': 11, 'same': False, 'type': 'addresses_D_ht'}}
