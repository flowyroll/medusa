...
push %rdi
push %rsi
lea addresses_D_ht+0x8ca1, %rsi
lea addresses_WT_ht+0x8b41, %rdi
nop
nop
nop
nop
...
lea addresses_WT_ht+0x81ef, %rdi
nop
nop
and $35577, %rbx
mov $123, %rcx
...
nop
sub $41723, %rax
lea addresses_WT_ht+0x1b041, %rax
nop
nop
nop
inc %rdi
...
{'src': {'NT': False, 'AVXalign': False, 'size': 1, 'congruent': 3, 'same': False, 'type': 'addresses_A'}, 'OP': 'LOAD'}
{'src': {'congruent': 2, 'same': False, 'type': 'addresses_P'}, 'dst': {'congruent': 0, 'same': False, 'type': 'addresses_UC'}, 'OP': 'REPM'}
[Faulty Load]
...
{'src': {'congruent': 2, 'same': False, 'type': 'addresses_D_ht'}, 'dst': {'congruent': 1, 'same': False, 'type': 'addresses_WT_ht'}, 'OP': 'REPM'}
