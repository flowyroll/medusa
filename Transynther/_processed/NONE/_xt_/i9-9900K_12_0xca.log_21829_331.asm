...
lea addresses_normal_ht+0x1691a, %rdi
clflush (%rsi)
clflush (%rdi)
nop
nop
...
rep movsl
inc %rsi
lea addresses_D_ht+0x11b9a, %rsi
lea addresses_A_ht+0x13fe4, %rdi
cmp $42753, %rbx
mov $37, %rcx
rep movsl
nop
...
nop
add %rdi, %rdi
lea addresses_WC_ht+0x11eda, %r14
clflush (%r14)
inc %r15
...
// Load
lea addresses_normal+0x10fea, %r9
xor %r15, %r15
mov (%r9), %r11
nop
nop
...
// Load
lea addresses_normal+0x1853e, %rbp
nop
cmp %rsi, %rsi
mov (%rbp), %r11w
nop
...
<gen_prepare_buffer>
{'OP': 'REPM', 'src': {'same': True, 'type': 'addresses_WC_ht', 'congruent': 4}, 'dst': {'same': False, 'type': 'addresses_normal_ht', 'congruent': 5}}
