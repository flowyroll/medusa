...
nop
sub $19497, %rdx
lea addresses_A_ht+0x16831, %rdi
nop
nop
nop
nop
...
nop
add $14536, %r11
lea addresses_D_ht+0x11015, %r11
cmp $17009, %rdi
...
nop
add %r11, %r11
lea addresses_WT_ht+0x1bc99, %rcx
cmp $54285, %rdi
vmovups (%rcx), %ymm3
...
nop
xor $21904, %rdi
lea addresses_normal_ht+0x19c61, %r8
clflush (%r8)
nop
nop
nop
...
nop
sub $53074, %rdx
lea addresses_UC_ht+0x1ebb1, %rcx
nop
nop
inc %rsi
...
nop
cmp %r9, %r9
lea addresses_normal_ht+0xb4c1, %rdx
nop
xor $2436, %rcx
movl $0x61626364, (%rdx)
nop
...
{'OP': 'STOR', 'dst': {'same': False, 'congruent': 4, 'NT': False, 'type': 'addresses_US', 'size': 2, 'AVXalign': False}}
...
<gen_prepare_buffer>
{'OP': 'STOR', 'dst': {'same': True, 'congruent': 6, 'NT': False, 'type': 'addresses_WT_ht', 'size': 4, 'AVXalign': False}}
{'src': {'type': 'addresses_UC_ht', 'congruent': 10, 'same': False}, 'OP': 'REPM', 'dst': {'type': 'addresses_WC_ht', 'congruent': 5, 'same': True}}
{'src': {'same': False, 'congruent': 4, 'NT': False, 'type': 'addresses_A_ht', 'size': 32, 'AVXalign': True}, 'OP': 'LOAD'}
