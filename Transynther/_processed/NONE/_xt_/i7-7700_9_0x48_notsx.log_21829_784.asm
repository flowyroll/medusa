...
nop
xor %r12, %r12
lea addresses_A_ht+0x156a5, %rdi
and %r14, %r14
...
nop
and %r15, %r15
lea addresses_WC_ht+0x10928, %r12
nop
nop
nop
xor $24665, %r14
...
nop
dec %rax
lea addresses_UC_ht+0x16e65, %rsi
lea addresses_A_ht+0x1a9d, %rdi
xor %r15, %r15
mov $21, %rcx
rep movsl
nop
...
nop
sub $53387, %rax
lea addresses_UC_ht+0xc4a1, %r12
nop
nop
and %rdi, %rdi
vmovups (%r12), %ymm4
...
// Faulty Load
lea addresses_normal+0xe065, %r14
nop
nop
nop
nop
...
{'dst': {'same': False, 'NT': False, 'AVXalign': False, 'size': 32, 'type': 'addresses_UC', 'congruent': 8}, 'OP': 'STOR'}
...
{'dst': {'same': True, 'congruent': 3, 'type': 'addresses_A_ht'}, 'OP': 'REPM', 'src': {'same': False, 'congruent': 5, 'type': 'addresses_UC_ht'}}
