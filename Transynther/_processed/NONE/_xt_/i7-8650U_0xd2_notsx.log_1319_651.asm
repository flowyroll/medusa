...
push %rdi
push %rsi
lea addresses_UC_ht+0x13f81, %rcx
nop
nop
nop
nop
...
nop
dec %rdi
lea addresses_A_ht+0x13dfd, %r14
nop
nop
and %r10, %r10
movb $0x61, (%r14)
...
nop
cmp %rdi, %rdi
lea addresses_UC_ht+0x44c1, %rcx
nop
cmp %r8, %r8
movl $0x61626364, (%rcx)
nop
nop
add $36311, %rcx
lea addresses_WT_ht+0x8cc1, %r11
clflush (%r11)
nop
nop
nop
...
nop
and %rcx, %rcx
lea addresses_A_ht+0x160c1, %rsi
lea addresses_A_ht+0x5081, %rdi
nop
nop
nop
nop
...
rep movsl
dec %r10
lea addresses_WT_ht+0x1b961, %rsi
...
{'OP': 'STOR', 'dst': {'type': 'addresses_A', 'size': 4, 'AVXalign': True, 'NT': True, 'congruent': 3, 'same': False}}
