...
push %rdx
push %rsi
lea addresses_UC_ht+0x6f82, %r11
nop
nop
nop
xor %rdx, %rdx
...
nop
sub $60690, %rcx
lea addresses_normal_ht+0x1975e, %rsi
lea addresses_UC_ht+0x3b83, %rdi
nop
xor %r15, %r15
mov $126, %rcx
rep movsl
and $57082, %rbp
lea addresses_WT_ht+0x18bc, %rbp
nop
nop
nop
and $41580, %rdx
...
nop
cmp %rbp, %rbp
lea addresses_normal_ht+0x515c, %rdx
sub %rdi, %rdi
vmovups (%rdx), %ymm5
