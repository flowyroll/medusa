...
nop
and $17722, %r8
lea addresses_UC_ht+0xf458, %rbx
nop
nop
nop
nop
...
nop
add $13396, %r8
lea addresses_UC_ht+0x11d48, %rbx
nop
nop
add $23300, %rsi
...
nop
sub $18785, %r8
lea addresses_WC_ht+0xa4a0, %rbx
clflush (%rbx)
nop
nop
nop
...
nop
and $63889, %rdi
lea addresses_normal_ht+0xb2b2, %r8
clflush (%r8)
nop
nop
nop
...
nop
add $55552, %rcx
lea addresses_WC_ht+0x12a88, %r15
nop
nop
nop
xor %rbx, %rbx
...
nop
and $36361, %rdi
lea addresses_WC_ht+0x37f6, %rsi
...
nop
cmp $50981, %rdi
lea addresses_normal_ht+0x1e9f8, %r15
nop
sub $17445, %rbx
vmovups (%r15), %ymm7
...
nop
cmp $38448, %rbx
lea addresses_WT_ht+0x131f8, %rsi
lea addresses_A_ht+0xbd38, %rdi
clflush (%rdi)
nop
nop
nop
...
rep movsb
sub %rax, %rax
lea addresses_normal_ht+0x87f8, %r8
nop
nop
nop
cmp %rbp, %rbp
...
{'OP': 'LOAD', 'src': {'same': True, 'type': 'addresses_D_ht', 'NT': False, 'AVXalign': False, 'size': 32, 'congruent': 0}}
{'OP': 'STOR', 'dst': {'same': False, 'type': 'addresses_UC_ht', 'NT': False, 'AVXalign': True, 'size': 1, 'congruent': 0}}
{'OP': 'STOR', 'dst': {'same': False, 'type': 'addresses_UC_ht', 'NT': True, 'AVXalign': False, 'size': 8, 'congruent': 4}}
...
{'OP': 'REPM', 'src': {'same': False, 'congruent': 9, 'type': 'addresses_WT_ht'}, 'dst': {'same': False, 'congruent': 6, 'type': 'addresses_A_ht'}}
