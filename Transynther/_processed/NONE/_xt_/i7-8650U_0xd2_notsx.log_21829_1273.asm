...
push %rdx
push %rsi
lea addresses_A_ht+0x1510f, %r12
nop
nop
nop
nop
...
lea addresses_WC_ht+0x15145, %rdi
add %r9, %r9
mov $9, %rcx
rep movsb
nop
...
nop
sub $25411, %r9
lea addresses_normal_ht+0xe68f, %rsi
dec %r9
...
nop
and %rcx, %rcx
lea addresses_UC_ht+0x101cf, %rsi
lea addresses_UC_ht+0x11a7, %rdi
nop
nop
nop
sub $11538, %r15
...
nop
xor %rdx, %rdx
lea addresses_WC_ht+0x11e0f, %rsi
lea addresses_UC_ht+0xf0f, %rdi
nop
nop
nop
nop
...
rep movsw
add %r13, %r13
lea addresses_normal_ht+0x13f0f, %r15
nop
nop
nop
sub %rsi, %rsi
...
lea addresses_D_ht+0x1b15f, %rdi
nop
nop
nop
xor %r15, %r15
...
nop
and $5115, %rcx
lea addresses_normal_ht+0x40cf, %rsi
nop
nop
nop
and $35474, %r15
...
{'OP': 'REPM', 'src': {'type': 'addresses_A_ht', 'congruent': 10, 'same': True}, 'dst': {'type': 'addresses_D_ht', 'congruent': 4, 'same': False}}
