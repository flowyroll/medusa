...
push %rcx
push %rdi
lea addresses_normal_ht+0x8d99, %rdi
nop
nop
nop
cmp $32178, %rcx
...
nop
dec %rcx
lea addresses_WC_ht+0x3199, %r14
inc %r13
mov (%r14), %rbp
nop
inc %r12
lea addresses_WC_ht+0x172b2, %r12
sub %rbp, %rbp
vmovups (%r12), %ymm0
...
nop
xor $20486, %rbp
lea addresses_normal_ht+0x899, %rcx
nop
nop
nop
sub $15338, %rbp
...
// Faulty Load
lea addresses_normal+0x12999, %rsi
nop
nop
cmp %r10, %r10
mov (%rsi), %rcx
...
<gen_prepare_buffer>
{'dst': {'same': False, 'NT': False, 'AVXalign': True, 'size': 2, 'type': 'addresses_normal_ht', 'congruent': 10}, 'OP': 'STOR'}
