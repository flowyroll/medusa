...
push %rdx
push %rsi
lea addresses_A_ht+0xd98b, %rsi
lea addresses_WT_ht+0x1544b, %rdi
nop
nop
and $50461, %rax
mov $1, %rcx
...
nop
and %rax, %rax
lea addresses_UC_ht+0x1b96b, %rsi
lea addresses_A_ht+0x1416b, %rdi
clflush (%rsi)
and $11210, %rbx
mov $6, %rcx
rep movsb
...
nop
sub $6582, %rdi
lea addresses_normal_ht+0x1526b, %rsi
lea addresses_WT_ht+0xb5cb, %rdi
nop
nop
nop
nop
...
{'src': {'type': 'addresses_normal_ht', 'congruent': 8, 'same': False}, 'OP': 'REPM', 'dst': {'type': 'addresses_WT_ht', 'congruent': 2, 'same': True}}
{'33': 18812}
