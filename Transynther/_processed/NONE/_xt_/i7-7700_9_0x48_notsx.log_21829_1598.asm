...
push %rdi
push %rsi
lea addresses_UC_ht+0x3d4d, %rsi
nop
sub %r8, %r8
movl $0x61626364, (%rsi)
nop
inc %r9
lea addresses_WT_ht+0x1631, %rsi
nop
nop
nop
nop
...
movb (%rsi), %al
add $34124, %rbx
lea addresses_WT_ht+0x17ca9, %rbx
nop
nop
nop
add $20084, %rcx
...
nop
xor $13136, %rsi
lea addresses_UC_ht+0x1c81d, %rbx
nop
add $41355, %r11
movups (%rbx), %xmm3
vpextrq $1, %xmm3, %r9
cmp $25247, %rcx
lea addresses_A_ht+0x6db9, %r11
clflush (%r11)
nop
nop
and $40516, %rcx
...
vpextrq $1, %xmm2, %rsi
add $14246, %rcx
lea addresses_WT_ht+0x14e1d, %r11
clflush (%r11)
nop
add %rcx, %rcx
movw $0x6162, (%r11)
...
nop
sub $59700, %r11
lea addresses_WT_ht+0x1105d, %rsi
lea addresses_normal_ht+0x231d, %rdi
nop
nop
nop
inc %rbx
...
rep movsb
cmp %rdi, %rdi
lea addresses_WT_ht+0x1561d, %r9
nop
nop
and %rcx, %rcx
movups (%r9), %xmm6
vpextrq $0, %xmm6, %r11
sub %rcx, %rcx
lea addresses_WC_ht+0x194ed, %r9
nop
sub %rcx, %rcx
...
// Store
lea addresses_normal+0x1da1d, %r9
cmp %r14, %r14
movw $0x5152, (%r9)
nop
nop
...
{'OP': 'LOAD', 'src': {'same': True, 'NT': False, 'AVXalign': False, 'size': 2, 'type': 'addresses_WT_ht', 'congruent': 2}}
...
{'dst': {'same': False, 'congruent': 7, 'type': 'addresses_normal_ht'}, 'OP': 'REPM', 'src': {'same': False, 'congruent': 5, 'type': 'addresses_WT_ht'}}
