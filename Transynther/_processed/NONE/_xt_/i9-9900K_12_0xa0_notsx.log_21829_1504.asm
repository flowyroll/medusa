...
// REPMOV
lea addresses_D+0xdf6c, %rsi
lea addresses_normal+0x5bcc, %rdi
nop
nop
sub %r11, %r11
mov $119, %rcx
...
{'src': {'type': 'addresses_D', 'congruent': 10, 'same': False}, 'OP': 'REPM', 'dst': {'type': 'addresses_normal', 'congruent': 4, 'same': False}}
