...
push %rdx
push %rsi
lea addresses_UC_ht+0x5fa7, %rsi
lea addresses_D_ht+0x9837, %rdi
cmp $31080, %r10
mov $26, %rcx
rep movsb
nop
nop
and %r15, %r15
lea addresses_D_ht+0x1db72, %rbx
nop
nop
nop
xor %rdx, %rdx
movw $0x6162, (%rbx)
sub $55077, %rdi
lea addresses_WT_ht+0x60e7, %r10
sub $38500, %r15
movl $0x61626364, (%r10)
nop
nop
...
nop
add %r10, %r10
lea addresses_UC_ht+0xf627, %rdx
nop
sub $60100, %rbx
movups (%rdx), %xmm6
vpextrq $1, %xmm6, %rcx
mfence
lea addresses_UC_ht+0x1211, %rsi
lea addresses_normal_ht+0x183a7, %rdi
nop
and %rax, %rax
mov $44, %rcx
rep movsl
xor $163, %rdx
lea addresses_D_ht+0x1bfc7, %rbx
nop
nop
and %rdi, %rdi
movl $0x61626364, (%rbx)
nop
xor $54488, %rdx
lea addresses_WC_ht+0x7995, %rax
nop
nop
nop
nop
...
nop
dec %r15
lea addresses_WC_ht+0x16827, %rsi
lea addresses_D_ht+0x4ff7, %rdi
nop
add $34888, %rbx
mov $42, %rcx
rep movsb
...
nop
and %rcx, %rcx
lea addresses_WC_ht+0x1bda7, %rsi
lea addresses_WT_ht+0x177a7, %rdi
nop
nop
nop
nop
...
nop
xor $3644, %rdx
lea addresses_WC_ht+0xf4c7, %r10
clflush (%r10)
nop
nop
nop
...
{'src': {'congruent': 8, 'same': True, 'type': 'addresses_WC_ht'}, 'dst': {'congruent': 8, 'same': False, 'type': 'addresses_WT_ht'}, 'OP': 'REPM'}
