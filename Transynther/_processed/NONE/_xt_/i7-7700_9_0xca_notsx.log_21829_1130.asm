...
lea addresses_WC_ht+0xe78f, %rdi
nop
nop
nop
nop
...
nop
and %rbp, %rbp
lea addresses_WT_ht+0x158d7, %r10
nop
nop
add $326, %r15
movb (%r10), %cl
...
nop
and %r15, %r15
lea addresses_normal_ht+0x11097, %r15
nop
lfence
movb $0x61, (%r15)
nop
...
nop
cmp $10306, %rcx
lea addresses_UC_ht+0x9167, %r10
nop
sub %rcx, %rcx
movups (%r10), %xmm5
vpextrq $0, %xmm5, %rbp
...
nop
dec %rbp
lea addresses_WT_ht+0x17d97, %rsi
lea addresses_A_ht+0xe797, %rdi
clflush (%rsi)
nop
nop
nop
...
rep movsb
xor $58585, %rbp
lea addresses_UC_ht+0x3457, %rdi
nop
nop
nop
cmp $173, %rsi
...
nop
sub $845, %r15
lea addresses_D_ht+0x19597, %rdi
nop
nop
nop
sub $49794, %rax
...
nop
dec %r9
lea addresses_WT_ht+0x1e597, %rcx
nop
add %r9, %r9
...
{'src': {'congruent': 10, 'same': False, 'type': 'addresses_WT_ht'}, 'dst': {'congruent': 7, 'same': False, 'type': 'addresses_A_ht'}, 'OP': 'REPM'}
...
{'src': {'congruent': 0, 'same': False, 'type': 'addresses_D_ht'}, 'dst': {'congruent': 8, 'same': False, 'type': 'addresses_UC_ht'}, 'OP': 'REPM'}
