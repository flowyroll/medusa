...
push %rdx
push %rsi
lea addresses_A_ht+0x1c519, %r12
sub %r8, %r8
and $0xffffffffffffffc0, %r12
movaps (%r12), %xmm4
vpextrq $0, %xmm4, %rdx
inc %r15
lea addresses_UC_ht+0xc919, %rsi
lea addresses_UC_ht+0x5f39, %rdi
nop
nop
nop
xor %r14, %r14
...
nop
cmp $47405, %r15
lea addresses_A_ht+0x10819, %rcx
nop
nop
dec %rdi
...
{'OP': 'LOAD', 'src': {'same': False, 'NT': False, 'AVXalign': False, 'size': 2, 'type': 'addresses_WC', 'congruent': 11}}
...
{'dst': {'same': True, 'NT': False, 'AVXalign': False, 'size': 16, 'type': 'addresses_WC_ht', 'congruent': 11}, 'OP': 'STOR'}
