...
nop
add %r10, %r10
lea addresses_WC_ht+0x9514, %rsi
lea addresses_normal_ht+0x19337, %rdi
cmp %rbp, %rbp
mov $66, %rcx
rep movsw
nop
cmp %rsi, %rsi
lea addresses_WT_ht+0xb37, %rsi
nop
nop
nop
xor %r10, %r10
...
vmovups %ymm1, (%rsi)
add $65161, %rbp
lea addresses_normal_ht+0x19dd7, %rsi
nop
nop
nop
nop
...
nop
xor $20617, %r8
lea addresses_WT_ht+0x71a0, %rbp
nop
nop
inc %rcx
mov (%rbp), %r14w
...
// REPMOV
lea addresses_normal+0xc3a5, %rsi
lea addresses_normal+0x6637, %rdi
nop
inc %r8
mov $15, %rcx
rep movsq
...
{'OP': 'REPM', 'src': {'same': False, 'type': 'addresses_normal', 'congruent': 1}, 'dst': {'same': False, 'type': 'addresses_normal', 'congruent': 7}}
...
{'OP': 'REPM', 'src': {'same': False, 'type': 'addresses_WC_ht', 'congruent': 0}, 'dst': {'same': True, 'type': 'addresses_normal_ht', 'congruent': 11}}
