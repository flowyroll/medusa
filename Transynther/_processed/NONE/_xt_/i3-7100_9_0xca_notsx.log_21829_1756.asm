...
push %rdx
push %rsi
lea addresses_WT_ht+0xf68b, %rsi
lea addresses_WC_ht+0x187ab, %rdi
nop
nop
nop
nop
...
nop
sub %rcx, %rcx
lea addresses_WT_ht+0x261b, %r10
nop
nop
nop
nop
...
movb $0x61, (%r10)
and $64167, %r9
lea addresses_WT_ht+0xb5cb, %rcx
nop
nop
nop
xor %r9, %r9
...
nop
dec %rcx
lea addresses_WT_ht+0x102ab, %r13
sub $16583, %r10
vmovups (%r13), %ymm4
vextracti128 $0, %ymm4, %xmm4
vpextrq $0, %xmm4, %rdi
add $11989, %rdi
lea addresses_D_ht+0xdba7, %rsi
lea addresses_WT_ht+0xa7ab, %rdi
nop
and $48474, %r10
mov $66, %rcx
rep movsb
...
lea addresses_D_ht+0x13c4b, %rdi
clflush (%rdi)
and $6803, %r15
mov $65, %rcx
rep movsq
...
nop
and $21559, %rdi
lea addresses_UC_ht+0xb6ab, %rsi
lea addresses_normal_ht+0x632b, %rdi
nop
nop
nop
nop
...
nop
add %r9, %r9
lea addresses_A_ht+0x1252b, %r10
nop
nop
nop
nop
...
// REPMOV
lea addresses_RW+0x14fab, %rsi
lea addresses_D+0xaaab, %rdi
nop
nop
cmp $5567, %r10
mov $39, %rcx
...
// Faulty Load
lea addresses_normal+0x167ab, %r13
xor $16139, %r14
movb (%r13), %cl
lea oracles, %rsi
and $0xff, %rcx
...
{'src': {'type': 'addresses_RW', 'congruent': 11, 'same': False}, 'OP': 'REPM', 'dst': {'type': 'addresses_D', 'congruent': 7, 'same': False}}
[Faulty Load]
