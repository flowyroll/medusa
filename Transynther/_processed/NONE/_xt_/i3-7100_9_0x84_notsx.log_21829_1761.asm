...
vmovups %ymm2, (%r11)
and $48729, %r10
lea addresses_WT_ht+0x1bd2c, %rdx
nop
add %rdi, %rdi
...
nop
xor %r9, %r9
lea addresses_normal_ht+0x1ad6c, %rsi
lea addresses_D_ht+0x10bec, %rdi
clflush (%rdi)
nop
sub %rdx, %rdx
mov $82, %rcx
...
nop
add %rdi, %rdi
lea addresses_A_ht+0x14bac, %r10
nop
sub %rcx, %rcx
movups (%r10), %xmm1
vpextrq $0, %xmm1, %r11
...
nop
and $9793, %r10
lea addresses_normal_ht+0x153c, %rdx
nop
nop
nop
xor %r8, %r8
...
nop
dec %r9
lea addresses_A_ht+0x3cec, %r9
sub %rdi, %rdi
movb (%r9), %r8b
xor %rdx, %rdx
lea addresses_WT_ht+0x11bec, %rsi
lea addresses_WC_ht+0x4894, %rdi
clflush (%rsi)
cmp %r9, %r9
mov $31, %rcx
rep movsw
...
nop
inc %rdx
lea addresses_normal_ht+0x12bec, %rsi
lea addresses_WT_ht+0x17e64, %rdi
nop
nop
nop
sub $30144, %r9
...
nop
sub %rdx, %rdx
lea addresses_normal_ht+0x493c, %rdx
nop
nop
nop
nop
...
nop
add %rsi, %rsi
lea addresses_A_ht+0x3ec, %rsi
lea addresses_D_ht+0x1dfec, %rdi
nop
dec %r10
mov $14, %rcx
rep movsq
...
nop
and %rsi, %rsi
lea addresses_D_ht+0x12a4, %rsi
lea addresses_WC_ht+0x9c1f, %rdi
nop
nop
nop
nop
...
{'src': {'type': 'addresses_D_ht', 'congruent': 3, 'same': False}, 'dst': {'type': 'addresses_WC_ht', 'congruent': 0, 'same': False}, 'OP': 'REPM'}
{'38': 21829}
