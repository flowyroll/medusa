...
push %rdi
push %rsi
lea addresses_D_ht+0x42c9, %rsi
lea addresses_WC_ht+0x1e823, %rdi
add %r13, %r13
mov $113, %rcx
rep movsl
nop
dec %r9
lea addresses_A_ht+0x1de31, %rsi
lea addresses_UC_ht+0x54c9, %rdi
nop
xor %r11, %r11
mov $31, %rcx
rep movsl
...
nop
add $11159, %r13
lea addresses_A_ht+0xbfc9, %rsi
lea addresses_D_ht+0xf3c9, %rdi
clflush (%rdi)
nop
nop
nop
...
nop
add $33608, %r11
lea addresses_WC_ht+0x9a19, %rbx
nop
nop
nop
xor $65259, %r11
...
vpextrq $1, %xmm1, %rcx
and %rbx, %rbx
lea addresses_WT_ht+0x9d59, %r13
nop
nop
add $7054, %rsi
movw $0x6162, (%r13)
...
nop
sub %r9, %r9
lea addresses_A_ht+0x1dfb5, %rsi
lea addresses_D_ht+0x13719, %rdi
nop
xor %r12, %r12
mov $48, %rcx
rep movsq
...
nop
and $40307, %rbx
lea addresses_WC_ht+0x135c9, %rbx
nop
inc %rcx
...
{'OP': 'STOR', 'dst': {'type': 'addresses_UC', 'AVXalign': True, 'congruent': 9, 'size': 2, 'same': False, 'NT': False}}
[Faulty Load]
...
{'OP': 'REPM', 'src': {'type': 'addresses_A_ht', 'congruent': 0, 'same': False}, 'dst': {'type': 'addresses_D_ht', 'congruent': 3, 'same': False}}
