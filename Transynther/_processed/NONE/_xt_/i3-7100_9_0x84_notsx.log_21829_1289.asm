...
push %rdi
push %rsi
lea addresses_normal_ht+0x12156, %r13
nop
nop
nop
nop
...
nop
and $53317, %rbx
lea addresses_WT_ht+0xe556, %rax
cmp %r13, %r13
movups (%rax), %xmm3
vpextrq $0, %xmm3, %rsi
nop
nop
add $9440, %rax
lea addresses_WC_ht+0x1d386, %rsi
lea addresses_WC_ht+0x12e16, %rdi
nop
nop
nop
nop
...
rep movsl
xor %rax, %rax
lea addresses_WT_ht+0x11acd, %rsi
lea addresses_WC_ht+0xbe4e, %rdi
nop
nop
nop
nop
...
nop
dec %rsi
lea addresses_A_ht+0x78d6, %rax
nop
nop
and %rdi, %rdi
movb $0x61, (%rax)
and $55278, %rsi
lea addresses_normal_ht+0x12356, %rsi
lea addresses_A_ht+0xf9ba, %rdi
nop
nop
nop
nop
...
nop
sub $35757, %r11
lea addresses_UC_ht+0x1728e, %rcx
nop
nop
sub %r13, %r13
movb $0x61, (%rcx)
...
nop
sub $58693, %r13
lea addresses_WT_ht+0x1a796, %rsi
nop
nop
cmp $41840, %rbx
movups (%rsi), %xmm1
...
{'src': {'type': 'addresses_normal_ht', 'congruent': 6, 'same': False}, 'dst': {'type': 'addresses_A_ht', 'congruent': 1, 'same': False}, 'OP': 'REPM'}
