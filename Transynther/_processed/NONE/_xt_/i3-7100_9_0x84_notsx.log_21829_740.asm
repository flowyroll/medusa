...
push %rdi
push %rsi
lea addresses_D_ht+0x1a912, %rcx
nop
xor %rdi, %rdi
movl $0x61626364, (%rcx)
nop
...
nop
sub %rsi, %rsi
lea addresses_UC_ht+0x15ce4, %rdi
clflush (%rdi)
nop
nop
nop
...
// Faulty Load
lea addresses_normal+0x7518, %r8
add $10226, %r10
movups (%r8), %xmm6
vpextrq $0, %xmm6, %r13
lea oracles, %r8
...
<gen_prepare_buffer>
{'dst': {'type': 'addresses_D_ht', 'same': False, 'size': 4, 'congruent': 1, 'NT': True, 'AVXalign': False}, 'OP': 'STOR'}
...
{'src': {'type': 'addresses_A_ht', 'congruent': 2, 'same': False}, 'dst': {'type': 'addresses_WC_ht', 'congruent': 9, 'same': False}, 'OP': 'REPM'}
{'34': 21829}
