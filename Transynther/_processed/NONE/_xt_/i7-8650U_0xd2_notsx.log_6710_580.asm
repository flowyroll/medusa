...
push %rdi
push %rsi
lea addresses_WT_ht+0x16b80, %r12
nop
nop
cmp %r10, %r10
...
nop
xor %rbp, %rbp
lea addresses_normal_ht+0xb35, %rcx
nop
nop
nop
inc %r13
...
nop
and $3037, %r10
lea addresses_WC_ht+0x80fd, %r12
nop
nop
nop
xor %r10, %r10
...
nop
add $39163, %r13
lea addresses_WT_ht+0x1a556, %rsi
lea addresses_A_ht+0x18e35, %rdi
nop
nop
nop
nop
...
nop
sub $51346, %rdi
lea addresses_normal_ht+0x154b5, %rcx
clflush (%rcx)
nop
nop
add %rsi, %rsi
...
nop
and $10984, %rdi
lea addresses_WT_ht+0xf745, %r12
nop
and %r15, %r15
movups (%r12), %xmm3
vpextrq $0, %xmm3, %rcx
nop
dec %r15
lea addresses_A_ht+0x15d25, %rsi
lea addresses_WT_ht+0xaab5, %rdi
nop
nop
nop
nop
...
rep movsb
and %r12, %r12
lea addresses_WT_ht+0x14b5, %rsi
lea addresses_WC_ht+0x162b5, %rdi
nop
nop
inc %r12
mov $10, %rcx
...
// Store
lea addresses_normal+0x1bf19, %r8
nop
nop
nop
cmp $7082, %rcx
...
// Faulty Load
lea addresses_normal+0x10eb5, %r11
add %rbx, %rbx
movups (%r11), %xmm1
vpextrq $0, %xmm1, %r8
lea oracles, %rsi
...
{'OP': 'STOR', 'dst': {'type': 'addresses_normal', 'size': 8, 'AVXalign': False, 'NT': True, 'congruent': 1, 'same': False}}
[Faulty Load]
...
{'OP': 'LOAD', 'src': {'type': 'addresses_normal_ht', 'size': 8, 'AVXalign': True, 'NT': False, 'congruent': 7, 'same': True}}
...
{'OP': 'REPM', 'src': {'type': 'addresses_WT_ht', 'congruent': 8, 'same': True}, 'dst': {'type': 'addresses_WC_ht', 'congruent': 3, 'same': False}}
{'34': 6710}
