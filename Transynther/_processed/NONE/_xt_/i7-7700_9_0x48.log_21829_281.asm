...
push %rdx
push %rsi
lea addresses_WC_ht+0x5e88, %rax
nop
nop
nop
add $44802, %r14
...
nop
cmp %r8, %r8
lea addresses_D_ht+0x1799c, %rcx
nop
add %rax, %rax
...
vpextrq $0, %xmm4, %r12
cmp $47743, %rcx
lea addresses_normal_ht+0x1cb88, %r15
nop
nop
nop
nop
...
nop
xor $31996, %rcx
lea addresses_UC_ht+0x9a06, %rsi
lea addresses_WC_ht+0xfa8, %rdi
nop
and $9159, %r8
mov $62, %rcx
rep movsb
...
nop
inc %rax
lea addresses_normal_ht+0x1a6e8, %rsi
nop
nop
nop
nop
...
{'OP': 'LOAD', 'src': {'type': 'addresses_UC_ht', 'AVXalign': True, 'congruent': 7, 'size': 8, 'same': False, 'NT': False}}
