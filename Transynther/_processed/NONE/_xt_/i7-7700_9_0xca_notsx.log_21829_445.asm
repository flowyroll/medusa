...
nop
add %r13, %r13
lea addresses_WC_ht+0x1ede0, %r13
nop
nop
inc %rsi
mov (%r13), %r11d
...
nop
add %rsi, %rsi
lea addresses_UC_ht+0x4912, %rsi
lea addresses_WT_ht+0x4fa2, %rdi
nop
nop
nop
nop
...
nop
cmp $17880, %r10
lea addresses_D_ht+0x1298e, %r11
nop
nop
sub %rcx, %rcx
movups (%r11), %xmm2
...
nop
add %rdx, %rdx
lea addresses_WT_ht+0x16452, %r11
nop
nop
nop
xor $13174, %rsi
...
nop
add $13049, %rsi
lea addresses_WC_ht+0x15192, %r11
nop
nop
nop
nop
...
nop
and $20966, %r11
lea addresses_WT_ht+0x199ba, %rcx
dec %r11
mov (%rcx), %rdi
nop
nop
dec %r11
lea addresses_A_ht+0x1be52, %rsi
lea addresses_A_ht+0x119d2, %rdi
clflush (%rsi)
nop
nop
nop
...
// Store
lea addresses_normal+0x9112, %r15
nop
nop
nop
nop
...
{'src': {'congruent': 5, 'same': False, 'type': 'addresses_UC_ht'}, 'dst': {'congruent': 3, 'same': False, 'type': 'addresses_WT_ht'}, 'OP': 'REPM'}
{'src': {'NT': False, 'AVXalign': False, 'size': 16, 'congruent': 1, 'same': False, 'type': 'addresses_D_ht'}, 'OP': 'LOAD'}
{'src': {'NT': False, 'AVXalign': True, 'size': 32, 'congruent': 5, 'same': False, 'type': 'addresses_WT_ht'}, 'OP': 'LOAD'}
{'src': {'NT': False, 'AVXalign': False, 'size': 1, 'congruent': 6, 'same': False, 'type': 'addresses_WC_ht'}, 'OP': 'LOAD'}
{'src': {'NT': False, 'AVXalign': False, 'size': 8, 'congruent': 3, 'same': True, 'type': 'addresses_WT_ht'}, 'OP': 'LOAD'}
