...
push %rdx
push %rsi
lea addresses_UC_ht+0x7de1, %r11
dec %r9
movups (%r11), %xmm6
vpextrq $1, %xmm6, %rbp
nop
...
nop
xor %r14, %r14
lea addresses_UC_ht+0x165e1, %rbp
nop
nop
add $61723, %r11
mov (%rbp), %edx
...
nop
inc %r9
lea addresses_UC_ht+0x184ab, %r15
nop
add $46115, %r13
...
nop
cmp %r11, %r11
lea addresses_WC_ht+0xfce1, %rsi
lea addresses_WT_ht+0x19ce1, %rdi
xor %r11, %r11
mov $108, %rcx
rep movsb
and %rdx, %rdx
lea addresses_WT_ht+0x71e1, %rsi
lea addresses_WT_ht+0x16ae1, %rdi
nop
and %r11, %r11
mov $109, %rcx
rep movsw
nop
inc %r15
lea addresses_WT_ht+0x4c1f, %rbp
nop
sub $60980, %r9
movb (%rbp), %r14b
nop
...
nop
cmp $27105, %r15
lea addresses_WT_ht+0xfd01, %rsi
lea addresses_UC_ht+0x51c1, %rdi
nop
inc %r15
mov $23, %rcx
rep movsl
...
nop
add %rcx, %rcx
lea addresses_normal_ht+0x101c1, %rsi
lea addresses_UC_ht+0x13441, %rdi
nop
nop
nop
add $6472, %r13
...
nop
cmp $54712, %r9
lea addresses_WT_ht+0x279f, %rsi
...
nop
add $13403, %rdx
lea addresses_WC_ht+0x1db41, %rsi
lea addresses_D_ht+0x44e1, %rdi
nop
nop
nop
xor $16089, %r11
...
nop
cmp %r13, %r13
lea addresses_WT_ht+0xe881, %rsi
...
nop
cmp $34698, %r15
lea addresses_D_ht+0x1dee1, %r11
nop
and $31199, %r14
mov (%r11), %ebp
nop
