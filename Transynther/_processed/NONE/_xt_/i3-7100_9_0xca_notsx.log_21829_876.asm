...
push %rdx
push %rsi
lea addresses_normal_ht+0x8b94, %rsi
lea addresses_A_ht+0x7254, %rdi
nop
xor %r8, %r8
mov $51, %rcx
rep movsl
...
nop
cmp %r11, %r11
lea addresses_WC_ht+0x1c854, %r8
xor %r15, %r15
mov $0x6162636465666768, %rsi
movq %rsi, (%r8)
add $56957, %rcx
lea addresses_D_ht+0x7ef4, %rsi
lea addresses_WT_ht+0x1b4f4, %rdi
nop
nop
nop
nop
...
rep movsb
and %rsi, %rsi
lea addresses_D_ht+0x12174, %rsi
lea addresses_WT_ht+0x5294, %rdi
nop
nop
nop
nop
...
nop
and %r15, %r15
lea addresses_WC_ht+0x19584, %rsi
lea addresses_normal_ht+0x1be54, %rdi
dec %rdx
mov $124, %rcx
rep movsw
nop
...
nop
inc %rcx
lea addresses_UC_ht+0x14c54, %r11
nop
nop
nop
and $47644, %r9
...
nop
add $64274, %rsi
lea addresses_WT_ht+0x4824, %rdx
nop
nop
nop
add %r8, %r8
...
nop
cmp $55028, %rcx
lea addresses_WC_ht+0x7254, %rdx
nop
nop
nop
nop
...
nop
dec %r9
lea addresses_WT_ht+0x12a64, %r11
nop
and %r8, %r8
movups (%r11), %xmm1
vpextrq $0, %xmm1, %rdi
...
nop
cmp %r9, %r9
lea addresses_D_ht+0xf9b4, %rsi
lea addresses_WT_ht+0x12dd4, %rdi
nop
nop
nop
nop
...
<gen_prepare_buffer>
{'src': {'type': 'addresses_normal_ht', 'congruent': 2, 'same': False}, 'OP': 'REPM', 'dst': {'type': 'addresses_A_ht', 'congruent': 9, 'same': False}}
{'OP': 'STOR', 'dst': {'same': True, 'congruent': 7, 'NT': False, 'type': 'addresses_WC_ht', 'size': 8, 'AVXalign': False}}
{'src': {'type': 'addresses_D_ht', 'congruent': 4, 'same': False}, 'OP': 'REPM', 'dst': {'type': 'addresses_WT_ht', 'congruent': 5, 'same': False}}
{'src': {'type': 'addresses_D_ht', 'congruent': 5, 'same': False}, 'OP': 'REPM', 'dst': {'type': 'addresses_WT_ht', 'congruent': 6, 'same': False}}
{'src': {'type': 'addresses_WC_ht', 'congruent': 3, 'same': False}, 'OP': 'REPM', 'dst': {'type': 'addresses_normal_ht', 'congruent': 11, 'same': False}}
