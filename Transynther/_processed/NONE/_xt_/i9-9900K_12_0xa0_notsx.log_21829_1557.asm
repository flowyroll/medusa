...
mov (%r8), %edi
add %rdi, %rdi
lea addresses_WT_ht+0x1c72, %rbx
nop
xor %r13, %r13
mov (%rbx), %r15
nop
...
nop
cmp %r8, %r8
lea addresses_A_ht+0x160f6, %r10
sub %rax, %rax
...
nop
inc %r8
lea addresses_WT_ht+0x130de, %r15
nop
nop
nop
nop
...
movb $0x61, (%r15)
xor $60036, %r13
lea addresses_UC_ht+0xddd6, %rbx
clflush (%rbx)
nop
nop
nop
...
// Store
lea addresses_normal+0x80f6, %rcx
cmp $22747, %r8
...
{'src': {'type': 'addresses_WT_ht', 'AVXalign': True, 'size': 8, 'NT': True, 'same': False, 'congruent': 1}, 'OP': 'LOAD'}
