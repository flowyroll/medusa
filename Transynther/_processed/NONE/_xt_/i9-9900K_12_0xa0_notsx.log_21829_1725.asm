...
vpextrq $1, %xmm1, %rsi
add $16656, %r9
lea addresses_A_ht+0xbf81, %r9
inc %rsi
movb $0x61, (%r9)
inc %r10
lea addresses_WT_ht+0x1bfb9, %r9
nop
nop
nop
nop
...
nop
cmp $58518, %r8
lea addresses_UC_ht+0x15209, %rdi
nop
nop
nop
nop
...
nop
cmp $23119, %rdi
lea addresses_WC_ht+0x15f9, %rsi
lea addresses_D_ht+0xbd19, %rdi
nop
nop
nop
inc %rax
...
nop
inc %r8
lea addresses_normal_ht+0xc379, %rbp
nop
nop
nop
nop
...
// Faulty Load
lea addresses_normal+0x1a279, %rdi
and %rax, %rax
movb (%rdi), %r15b
lea oracles, %rsi
and $0xff, %r15
...
{'src': {'type': 'addresses_WC', 'congruent': 5, 'same': False}, 'OP': 'REPM', 'dst': {'type': 'addresses_P', 'congruent': 10, 'same': False}}
...
<gen_prepare_buffer>
{'src': {'type': 'addresses_UC_ht', 'congruent': 8, 'same': False}, 'OP': 'REPM', 'dst': {'type': 'addresses_A_ht', 'congruent': 2, 'same': True}}
