...
push %r15
push %rbp
lea addresses_UC_ht+0x11f95, %rbp
and %r15, %r15
mov (%rbp), %r10
sub %r10, %r10
pop %rbp
...
// Store
lea addresses_normal+0x7935, %r9
nop
nop
dec %r15
...
// REPMOV
lea addresses_normal+0x1ccd5, %rsi
lea addresses_A+0x6095, %rdi
nop
nop
nop
nop
...
{'dst': {'same': False, 'congruent': 9, 'type': 'addresses_A'}, 'OP': 'REPM', 'src': {'same': False, 'congruent': 1, 'type': 'addresses_normal'}}
[Faulty Load]
{'OP': 'LOAD', 'src': {'same': True, 'NT': False, 'AVXalign': False, 'size': 32, 'type': 'addresses_WC', 'congruent': 0}}
<gen_prepare_buffer>
{'OP': 'LOAD', 'src': {'same': True, 'NT': False, 'AVXalign': False, 'size': 8, 'type': 'addresses_UC_ht', 'congruent': 8}}
{'38': 21829}
