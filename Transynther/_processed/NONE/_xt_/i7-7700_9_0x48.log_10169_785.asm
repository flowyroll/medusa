...
push %rdi
push %rsi
lea addresses_WC_ht+0xe79d, %r9
nop
and %r15, %r15
mov (%r9), %rax
sub $33278, %r9
lea addresses_D_ht+0x6caf, %rsi
lea addresses_WT_ht+0x128df, %rdi
nop
nop
nop
nop
...
nop
sub %rcx, %rcx
lea addresses_WT_ht+0x1e24d, %r9
nop
nop
nop
xor $40929, %rdi
movw $0x6162, (%r9)
cmp %r9, %r9
lea addresses_UC_ht+0x1875f, %r9
nop
nop
dec %r12
movb (%r9), %cl
...
nop
add $17709, %rax
lea addresses_UC_ht+0xbb5f, %rdi
nop
nop
nop
xor $16703, %r12
mov (%rdi), %ecx
cmp $49305, %rdi
lea addresses_WT_ht+0x635f, %r15
nop
nop
sub $50522, %rdi
movups (%r15), %xmm1
...
nop
sub $53879, %r15
lea addresses_WC_ht+0xf75f, %r12
nop
nop
nop
nop
...
// Faulty Load
lea addresses_normal+0x10f5f, %rax
nop
nop
nop
cmp $65211, %r11
...
{'OP': 'LOAD', 'src': {'type': 'addresses_UC_ht', 'AVXalign': True, 'congruent': 0, 'size': 16, 'same': False, 'NT': False}}
