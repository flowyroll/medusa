...
push %rdi
push %rsi
lea addresses_UC_ht+0x1219c, %rsi
lea addresses_WC_ht+0x1e912, %rdi
xor $1043, %r13
mov $62, %rcx
rep movsb
nop
...
nop
cmp %r8, %r8
lea addresses_WT_ht+0x4892, %rsi
nop
nop
nop
add $30226, %rdi
mov (%rsi), %r13w
sub %r13, %r13
lea addresses_UC_ht+0xf532, %rsi
lea addresses_D_ht+0x18f92, %rdi
nop
nop
nop
dec %rax
...
nop
xor %rax, %rax
lea addresses_WT_ht+0x1db12, %rsi
lea addresses_WC_ht+0x7be2, %rdi
clflush (%rdi)
nop
and %r8, %r8
mov $53, %rcx
...
nop
dec %rcx
lea addresses_D_ht+0x1192, %rsi
lea addresses_UC_ht+0x586a, %rdi
sub $28176, %r9
mov $21, %rcx
rep movsl
nop
and %rax, %rax
lea addresses_A_ht+0x9fd2, %r9
nop
nop
nop
nop
...
nop
dec %r13
lea addresses_WC_ht+0x1412, %rsi
nop
nop
nop
xor %r9, %r9
...
nop
sub $19017, %rdi
lea addresses_WC_ht+0x19292, %rsi
lea addresses_D_ht+0x9092, %rdi
clflush (%rdi)
nop
nop
nop
...
nop
xor %rcx, %rcx
lea addresses_UC_ht+0x164dc, %rsi
lea addresses_WC_ht+0xedb2, %rdi
nop
nop
nop
nop
...
{'src': {'type': 'addresses_D_ht', 'congruent': 7, 'same': True}, 'OP': 'REPM', 'dst': {'type': 'addresses_UC_ht', 'congruent': 2, 'same': False}}
...
{'src': {'type': 'addresses_UC_ht', 'congruent': 0, 'same': False}, 'OP': 'REPM', 'dst': {'type': 'addresses_WC_ht', 'congruent': 5, 'same': False}}
{'36': 21829}
