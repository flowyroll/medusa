...
nop
inc %rbp
lea addresses_D_ht+0xe5f0, %rsi
lea addresses_WC_ht+0xd588, %rdi
nop
nop
nop
xor $30334, %rbp
...
nop
sub %rbx, %rbx
lea addresses_WC_ht+0xef68, %rbp
nop
and $55422, %rsi
movl $0x61626364, (%rbp)
dec %rbx
lea addresses_UC_ht+0xfa08, %rcx
nop
nop
nop
cmp $27250, %r11
...
// Store
lea addresses_normal+0x2408, %rax
add %rsi, %rsi
...
// Load
lea addresses_WC+0x1985c, %rbx
and $11856, %r15
mov (%rbx), %r10w
dec %rax

// Store
lea addresses_US+0xce08, %rbx
and %rsi, %rsi
...
{'OP': 'REPM', 'src': {'same': False, 'congruent': 0, 'type': 'addresses_D_ht'}, 'dst': {'same': False, 'congruent': 6, 'type': 'addresses_WC_ht'}}
