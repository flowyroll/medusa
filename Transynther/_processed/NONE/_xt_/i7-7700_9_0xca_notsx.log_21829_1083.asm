...
lea addresses_normal_ht+0x234c, %rdi
nop
and %r11, %r11
mov $2, %rcx
rep movsw
...
nop
xor $26639, %rdi
lea addresses_UC_ht+0x1790c, %r15
nop
xor $15699, %r11
mov (%r15), %r9w
nop
...
nop
add $793, %r14
lea addresses_WT_ht+0x1080c, %rcx
nop
nop
nop
xor %rax, %rax
...
nop
add %rax, %rax
lea addresses_WC_ht+0x1610c, %rsi
lea addresses_normal_ht+0x77ac, %rdi
nop
nop
and %r11, %r11
mov $52, %rcx
...
// Load
lea addresses_normal+0x4a64, %rbx
inc %rax
movb (%rbx), %r10b
nop
nop
...
{'dst': {'NT': False, 'AVXalign': False, 'size': 32, 'congruent': 0, 'same': False, 'type': 'addresses_P'}, 'OP': 'STOR'}
[Faulty Load]
