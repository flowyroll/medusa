...
nop
add $46543, %r12
lea addresses_WC_ht+0x7514, %rsi
lea addresses_WC_ht+0x1394, %rdi
nop
nop
nop
nop
...
nop
dec %rbx
lea addresses_normal_ht+0x9b94, %r10
inc %r14
...
nop
xor $10930, %r12
lea addresses_WC_ht+0x1a94, %rdi
nop
nop
xor %rsi, %rsi
movb $0x61, (%rdi)
...
lea addresses_WT_ht+0x3ab4, %rdi
clflush (%rsi)
nop
nop
nop
...
rep movsq
xor $48287, %r10
lea addresses_normal_ht+0x16c2, %rdi
nop
nop
nop
nop
...
nop
dec %r14
lea addresses_A_ht+0x1894, %r12
add $49123, %r10
movb (%r12), %r14b
nop
nop
inc %r10
lea addresses_normal_ht+0x15a94, %rsi
lea addresses_WC_ht+0x3494, %rdi
clflush (%rsi)
xor %r10, %r10
mov $47, %rcx
rep movsw
...
lea addresses_normal_ht+0x954, %rdi
and %r14, %r14
mov $65, %rcx
rep movsl
nop
...
<gen_prepare_buffer>
{'OP': 'REPM', 'src': {'type': 'addresses_WC_ht', 'congruent': 3, 'same': True}, 'dst': {'type': 'addresses_UC_ht', 'congruent': 3, 'same': False}}
{'OP': 'REPM', 'src': {'type': 'addresses_A_ht', 'congruent': 5, 'same': False}, 'dst': {'type': 'addresses_WT_ht', 'congruent': 11, 'same': False}}
...
{'OP': 'REPM', 'src': {'type': 'addresses_WT_ht', 'congruent': 8, 'same': True}, 'dst': {'type': 'addresses_WT_ht', 'congruent': 2, 'same': False}}
