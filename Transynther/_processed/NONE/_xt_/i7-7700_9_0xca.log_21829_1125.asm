...
nop
sub %r10, %r10
lea addresses_D_ht+0x16be8, %rsi
nop
nop
nop
nop
...
nop
xor %r10, %r10
lea addresses_normal_ht+0xea68, %rax
nop
nop
nop
nop
...
nop
and %r11, %r11
lea addresses_normal_ht+0x4268, %rsi
lea addresses_WC_ht+0xae68, %rdi
nop
nop
nop
nop
...
lea addresses_normal_ht+0x18738, %rdi
nop
nop
cmp %r11, %r11
mov $39, %rcx
...
nop
xor %r11, %r11
lea addresses_WC_ht+0x7da8, %rcx
nop
nop
nop
nop
...
nop
sub %rax, %rax
lea addresses_D_ht+0x167c8, %rsi
nop
nop
nop
nop
...
nop
xor $20831, %rax
lea addresses_WC_ht+0x13068, %rsi
nop
nop
nop
sub %rax, %rax
...
// Faulty Load
lea addresses_normal+0x4668, %r12
nop
nop
nop
sub $7226, %rbp
...
{'OP': 'STOR', 'dst': {'congruent': 7, 'AVXalign': False, 'same': False, 'size': 16, 'NT': True, 'type': 'addresses_D_ht'}}
{'src': {'congruent': 10, 'AVXalign': False, 'same': False, 'size': 32, 'NT': False, 'type': 'addresses_normal_ht'}, 'OP': 'LOAD'}
{'src': {'congruent': 7, 'same': True, 'type': 'addresses_normal_ht'}, 'OP': 'REPM', 'dst': {'congruent': 9, 'same': False, 'type': 'addresses_WC_ht'}}
