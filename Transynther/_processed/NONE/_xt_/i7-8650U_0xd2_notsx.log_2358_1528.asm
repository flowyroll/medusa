...
push %rdx
push %rsi
lea addresses_D_ht+0x63c7, %rsi
lea addresses_A_ht+0x23c7, %rdi
nop
nop
nop
nop
...
rep movsw
sub %rcx, %rcx
lea addresses_UC_ht+0x1dd47, %rdx
nop
nop
nop
nop
...
nop
add %rsi, %rsi
lea addresses_D_ht+0xa647, %rdi
add %rbp, %rbp
mov (%rdi), %r14w
nop
lfence
lea addresses_A_ht+0x59c7, %r14
cmp $47689, %r10
...
nop
cmp $8388, %rdx
lea addresses_A_ht+0x15847, %rsi
lea addresses_WT_ht+0x86e3, %rdi
dec %r10
mov $116, %rcx
rep movsq
nop
sub %rdi, %rdi
lea addresses_WT_ht+0xc74f, %rsi
lea addresses_WC_ht+0x5dc7, %rdi
xor $50919, %r11
mov $32, %rcx
rep movsb
add %rdi, %rdi
