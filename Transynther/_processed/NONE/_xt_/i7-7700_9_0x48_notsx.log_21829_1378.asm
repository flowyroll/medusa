...
push %rdi
push %rsi
lea addresses_normal_ht+0x11c26, %rcx
nop
nop
sub %r10, %r10
mov (%rcx), %r8d
...
nop
xor $53110, %rsi
lea addresses_UC_ht+0x1ec76, %r13
clflush (%r13)
add %r10, %r10
...
nop
add %r10, %r10
lea addresses_WC_ht+0x13836, %r10
add $13880, %r15
mov (%r10), %rsi
nop
nop
nop
sub %r15, %r15
lea addresses_WC_ht+0x1e010, %rsi
lea addresses_normal_ht+0x1c476, %rdi
nop
nop
add $50090, %r13
mov $101, %rcx
...
// Faulty Load
lea addresses_normal+0xe436, %r9
nop
nop
nop
nop
