...
push %rdi
push %rsi
lea addresses_D_ht+0x1113b, %r10
xor $62638, %rsi
...
nop
xor %r10, %r10
lea addresses_UC_ht+0x4cb3, %r15
nop
nop
nop
nop
...
nop
add %r13, %r13
lea addresses_normal_ht+0x12d3b, %rsi
lea addresses_WT_ht+0x1653b, %rdi
nop
add $46629, %r10
mov $51, %rcx
rep movsl
...
nop
add %r10, %r10
lea addresses_normal_ht+0x1a87b, %rcx
nop
nop
add %r10, %r10
...
nop
cmp $433, %r13
lea addresses_WC_ht+0x1b13b, %rax
nop
xor $22172, %r10
movw $0x6162, (%rax)
nop
cmp $29883, %rdi
lea addresses_UC_ht+0xfcff, %rcx
nop
nop
nop
cmp $63882, %r10
...
nop
sub %r13, %r13
lea addresses_WT_ht+0x1a13b, %rsi
lea addresses_UC_ht+0x51e3, %rdi
clflush (%rdi)
nop
nop
sub $48177, %r10
...
nop
sub $36147, %rcx
lea addresses_A_ht+0x1593b, %r10
add %r15, %r15
vmovups (%r10), %ymm5
vextracti128 $0, %ymm5, %xmm5
vpextrq $0, %xmm5, %rcx
xor %rdi, %rdi
lea addresses_WC_ht+0xee7b, %rsi
lea addresses_UC_ht+0x1d3a7, %rdi
clflush (%rsi)
nop
nop
nop
...
nop
and $14344, %rax
lea addresses_D_ht+0x1d19d, %rsi
lea addresses_WT_ht+0x114d, %rdi
nop
nop
and $14336, %r8
mov $30, %rcx
...
{'OP': 'REPM', 'src': {'type': 'addresses_WT_ht', 'congruent': 11, 'same': True}, 'dst': {'type': 'addresses_UC_ht', 'congruent': 0, 'same': True}}
