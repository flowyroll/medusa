...
lea addresses_normal_ht+0x25c8, %rdi
clflush (%rdi)
nop
xor %rax, %rax
mov $27, %rcx
...
nop
cmp $21611, %rax
lea addresses_D_ht+0xff68, %rsi
lea addresses_D_ht+0x10da8, %rdi
nop
nop
cmp $29361, %rbx
mov $98, %rcx
...
nop
add %rbx, %rbx
lea addresses_D_ht+0x51f8, %rdi
and $48560, %rax
vmovups (%rdi), %ymm2
vextracti128 $0, %ymm2, %xmm2
vpextrq $0, %xmm2, %rcx
and $36194, %rbx
lea addresses_D_ht+0xe668, %r13
nop
sub $35939, %rbp
...
nop
xor %rsi, %rsi
lea addresses_WT_ht+0x164c8, %rsi
lea addresses_UC_ht+0x117ff, %rdi
nop
nop
nop
nop
...
rep movsq
add $14937, %rax
lea addresses_WC_ht+0x18e68, %rsi
...
nop
xor %rsi, %rsi
lea addresses_normal_ht+0x1ed98, %rsi
lea addresses_UC_ht+0x49a8, %rdi
nop
nop
nop
nop
...
nop
inc %r11
lea addresses_A_ht+0x2b50, %rsi
lea addresses_WC_ht+0x59a8, %rdi
nop
sub %rbp, %rbp
mov $70, %rcx
rep movsq
...
// Faulty Load
lea addresses_normal+0xb1a8, %r8
inc %rdi
movb (%r8), %r10b
lea oracles, %rdi
and $0xff, %r10
...
{'OP': 'REPM', 'src': {'type': 'addresses_D_ht', 'congruent': 6, 'same': False}, 'dst': {'type': 'addresses_D_ht', 'congruent': 9, 'same': False}}
