...
push %rdi
push %rsi
lea addresses_UC_ht+0x20f6, %rsi
lea addresses_WT_ht+0x1051, %rdi
clflush (%rsi)
nop
and $56669, %r12
mov $74, %rcx
rep movsl
sub %r11, %r11
lea addresses_WT_ht+0x13b91, %r13
nop
nop
cmp $44331, %r11
...
nop
dec %r12
lea addresses_normal_ht+0x9219, %r12
nop
nop
nop
nop
...
nop
add %r13, %r13
lea addresses_A_ht+0x15cd1, %r12
nop
nop
nop
dec %r13
...
nop
and %rsi, %rsi
lea addresses_WC_ht+0xe651, %rsi
lea addresses_WC_ht+0x19c51, %rdi
cmp $21107, %r12
mov $95, %rcx
rep movsl
nop
and %rsi, %rsi
lea addresses_D_ht+0xf0b1, %r11
nop
nop
nop
nop
...
mov (%rcx), %r13w
cmp $32368, %r13
lea addresses_UC_ht+0xd4d1, %rcx
sub $41625, %r13
mov (%rcx), %r11w
nop
nop
...
// REPMOV
lea addresses_RW+0xb87d, %rsi
lea addresses_PSE+0x1c921, %rdi
add $62909, %r9
mov $99, %rcx
rep movsb
nop
...
{'src': {'type': 'addresses_WT', 'AVXalign': False, 'size': 16, 'NT': False, 'same': False, 'congruent': 7}, 'OP': 'LOAD'}
{'src': {'type': 'addresses_RW', 'congruent': 2, 'same': False}, 'OP': 'REPM', 'dst': {'type': 'addresses_PSE', 'congruent': 1, 'same': False}}
...
{'src': {'type': 'addresses_UC_ht', 'AVXalign': True, 'size': 2, 'NT': False, 'same': False, 'congruent': 6}, 'OP': 'LOAD'}
{'36': 21829}
