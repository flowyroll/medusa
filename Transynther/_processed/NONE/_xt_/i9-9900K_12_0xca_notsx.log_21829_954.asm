...
push %rbp
push %rbx
lea addresses_UC_ht+0xd6f8, %r10
xor $62493, %r9
movups (%r10), %xmm0
vpextrq $0, %xmm0, %rax
cmp %r9, %r9
lea addresses_WC_ht+0x3742, %r10
nop
nop
nop
nop
...
nop
xor %r9, %r9
lea addresses_normal_ht+0x126a2, %rbp
nop
nop
nop
nop
...
nop
xor %rbx, %rbx
lea addresses_WC_ht+0x155a2, %r12
nop
nop
nop
nop
...
mov (%r12), %r9
add %r10, %r10
lea addresses_WC_ht+0xacc2, %rax
clflush (%rax)
nop
nop
nop
...
// Load
lea addresses_normal+0x136a2, %rdi
nop
nop
nop
nop
...
// Faulty Load
lea addresses_normal+0x136a2, %rbx
nop
nop
nop
nop
