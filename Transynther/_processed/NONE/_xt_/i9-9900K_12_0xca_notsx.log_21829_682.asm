...
nop
add $63060, %rdi
lea addresses_UC_ht+0x9583, %rdx
nop
sub $34177, %r11
mov $0x6162636465666768, %r10
movq %r10, (%rdx)
xor $62442, %rcx
lea addresses_D_ht+0x17a4b, %r12
nop
nop
nop
nop
...
nop
inc %r12
lea addresses_A_ht+0x19d13, %rsi
lea addresses_normal_ht+0x350b, %rdi
cmp %rbp, %rbp
mov $12, %rcx
rep movsb
add $51451, %rsi
...
{'OP': 'STOR', 'dst': {'same': True, 'type': 'addresses_D_ht', 'NT': False, 'AVXalign': True, 'size': 16, 'congruent': 6}}
{'OP': 'STOR', 'dst': {'same': False, 'type': 'addresses_WT_ht', 'NT': False, 'AVXalign': False, 'size': 32, 'congruent': 4}}
{'OP': 'REPM', 'src': {'same': False, 'congruent': 3, 'type': 'addresses_A_ht'}, 'dst': {'same': False, 'congruent': 11, 'type': 'addresses_normal_ht'}}
{'32': 21829}
