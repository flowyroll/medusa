...
push %rdi
push %rsi
lea addresses_D_ht+0x1e566, %rax
clflush (%rax)
nop
nop
nop
...
nop
sub %r14, %r14
lea addresses_WC_ht+0x16fb0, %rsi
lea addresses_WT_ht+0x8130, %rdi
clflush (%rsi)
nop
nop
nop
...
nop
xor $57755, %rax
lea addresses_normal_ht+0x1a4e8, %rdi
nop
nop
nop
sub $18049, %r14
...
vpextrq $0, %xmm6, %r9
add $34897, %r9
lea addresses_A_ht+0x1b530, %rsi
lea addresses_D_ht+0x19c78, %rdi
clflush (%rsi)
dec %r10
mov $110, %rcx
rep movsb
...
nop
dec %r9
lea addresses_WC_ht+0x7db0, %r10
dec %rsi
mov $0x6162636465666768, %rax
movq %rax, %xmm3
movups %xmm3, (%r10)
add %rdi, %rdi
lea addresses_WT_ht+0x4bb0, %rax
nop
and %r14, %r14
mov (%rax), %rsi
nop
...
nop
and %r14, %r14
lea addresses_normal_ht+0x640a, %r10
nop
cmp $7635, %r14
movl $0x61626364, (%r10)
nop
dec %rdi
lea addresses_A_ht+0x17fb0, %rsi
lea addresses_WC_ht+0xaf38, %rdi
clflush (%rdi)
nop
nop
and %r12, %r12
...
nop
cmp %r14, %r14
lea addresses_UC_ht+0x168dc, %rsi
lea addresses_D_ht+0x1cbcd, %rdi
nop
nop
nop
sub $9386, %r10
...
{'OP': 'REPM', 'src': {'same': False, 'type': 'addresses_WC_ht', 'congruent': 11}, 'dst': {'same': False, 'type': 'addresses_WT_ht', 'congruent': 7}}
...
{'OP': 'REPM', 'src': {'same': False, 'type': 'addresses_A_ht', 'congruent': 8}, 'dst': {'same': False, 'type': 'addresses_WC_ht', 'congruent': 2}}
