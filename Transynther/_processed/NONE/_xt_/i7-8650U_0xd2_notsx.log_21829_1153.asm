...
nop
sub $49681, %rsi
lea addresses_WC_ht+0xad2c, %r12
nop
nop
nop
nop
...
nop
add %rcx, %rcx
lea addresses_normal_ht+0x532c, %r13
nop
xor %rsi, %rsi
vmovups (%r13), %ymm0
...
nop
cmp $31338, %rsi
lea addresses_A_ht+0x14a2c, %rsi
lea addresses_UC_ht+0x1c4ac, %rdi
nop
nop
sub $50135, %rbp
mov $114, %rcx
...
movups %xmm0, (%rbp)
cmp %rsi, %rsi
lea addresses_D_ht+0x692c, %rsi
lea addresses_A_ht+0x972c, %rdi
clflush (%rdi)
add $24888, %rbx
mov $39, %rcx
rep movsb
...
nop
dec %rcx
lea addresses_A_ht+0x1efac, %rdi
nop
nop
nop
add %r12, %r12
...
nop
sub %rbx, %rbx
lea addresses_normal_ht+0x61ea, %rbx
nop
nop
nop
nop
...
nop
cmp %r12, %r12
lea addresses_normal_ht+0x1d6c, %r12
nop
nop
nop
nop
...
{'OP': 'REPM', 'src': {'type': 'addresses_A_ht', 'congruent': 7, 'same': False}, 'dst': {'type': 'addresses_UC_ht', 'congruent': 5, 'same': True}}
{'OP': 'STOR', 'dst': {'type': 'addresses_A_ht', 'size': 16, 'AVXalign': False, 'NT': False, 'congruent': 2, 'same': False}}
{'OP': 'REPM', 'src': {'type': 'addresses_D_ht', 'congruent': 10, 'same': True}, 'dst': {'type': 'addresses_A_ht', 'congruent': 9, 'same': False}}
