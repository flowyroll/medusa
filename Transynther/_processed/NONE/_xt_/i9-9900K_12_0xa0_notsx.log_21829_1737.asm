...
push %rdx
push %rsi
lea addresses_WC_ht+0x16c54, %rsi
lea addresses_WC_ht+0x134c4, %rdi
nop
nop
inc %r13
mov $53, %rcx
...
nop
and %r10, %r10
lea addresses_D_ht+0x1d70, %rsi
lea addresses_UC_ht+0x4354, %rdi
mfence
mov $81, %rcx
rep movsq
cmp %rdx, %rdx
lea addresses_UC_ht+0xedd4, %rsi
nop
nop
nop
xor $11985, %r8
...
nop
and %rdi, %rdi
lea addresses_WC_ht+0x10154, %rdx
xor %r13, %r13
...
nop
xor $54338, %rdx
lea addresses_D_ht+0x1898, %rsi
lea addresses_UC_ht+0xbb20, %rdi
nop
nop
nop
nop
...
nop
add $61155, %rdx
lea addresses_D_ht+0x19354, %r13
nop
add %rcx, %rcx
vmovups (%r13), %ymm1
...
nop
dec %rdx
lea addresses_UC_ht+0x1d54, %rdx
nop
nop
nop
dec %r13
mov (%rdx), %ecx
dec %rsi
lea addresses_A_ht+0x40e2, %rsi
lea addresses_A_ht+0x90d4, %rdi
nop
and $30856, %r15
mov $84, %rcx
rep movsw
...
lea addresses_D_ht+0x18fc8, %rdi
nop
nop
nop
nop
...
nop
cmp $32967, %r10
lea addresses_A_ht+0x12bd4, %rsi
lea addresses_normal_ht+0x4954, %rdi
nop
cmp %r8, %r8
mov $74, %rcx
rep movsw
nop
and $16217, %r8
lea addresses_normal_ht+0xa234, %rsi
lea addresses_UC_ht+0xa854, %rdi
nop
nop
nop
xor %r8, %r8
...
rep movsw
add %rcx, %rcx
lea addresses_A_ht+0x1954, %rcx
nop
nop
xor %rdx, %rdx
movb $0x61, (%rcx)
sub $28238, %rcx
lea addresses_A_ht+0x10c54, %rsi
nop
nop
nop
nop
...
nop
sub $7860, %r10
lea addresses_WC_ht+0x1c754, %rdx
nop
nop
xor $9697, %r15
mov $0x6162636465666768, %rcx
...
nop
and $26947, %rcx
lea addresses_normal_ht+0x11cbc, %rsi
lea addresses_WC_ht+0x362a, %rdi
and $6102, %r13
mov $44, %rcx
rep movsl
nop
...
// Faulty Load
lea addresses_normal+0x14b54, %r8
nop
nop
nop
cmp %r11, %r11
...
{'src': {'type': 'addresses_A_ht', 'congruent': 1, 'same': True}, 'OP': 'REPM', 'dst': {'type': 'addresses_A_ht', 'congruent': 7, 'same': False}}
...
{'src': {'type': 'addresses_normal_ht', 'congruent': 3, 'same': False}, 'OP': 'REPM', 'dst': {'type': 'addresses_UC_ht', 'congruent': 6, 'same': False}}
