...
push %rdx
push %rsi
lea addresses_WC_ht+0x163d1, %rdx
nop
nop
nop
and $49588, %r8
...
nop
inc %r12
lea addresses_D_ht+0x378f, %rsi
lea addresses_normal_ht+0x7d51, %rdi
nop
nop
add %r15, %r15
mov $88, %rcx
...
// Store
lea addresses_normal+0xb811, %r10
nop
nop
nop
cmp $32057, %r12
...
{'OP': 'STOR', 'dst': {'type': 'addresses_UC', 'AVXalign': False, 'congruent': 0, 'size': 32, 'same': False, 'NT': True}}
