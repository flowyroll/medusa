...
nop
xor %r9, %r9
lea addresses_UC_ht+0x1744e, %rdi
nop
nop
add $21457, %r12
...
nop
sub $10008, %r13
lea addresses_WC_ht+0x16fd8, %r12
sub %rbx, %rbx
...
vpextrq $0, %xmm2, %rcx
dec %r9
lea addresses_WT_ht+0x1e0f2, %rbx
nop
sub $46324, %r13
movb $0x61, (%rbx)
xor %rcx, %rcx
lea addresses_D_ht+0xb84e, %rsi
lea addresses_WT_ht+0x6bce, %rdi
clflush (%rsi)
sub $40852, %r12
mov $10, %rcx
rep movsq
...
nop
and %rcx, %rcx
lea addresses_WC_ht+0xba6e, %rcx
nop
nop
nop
xor $10512, %r12
...
{'src': {'type': 'addresses_D_ht', 'congruent': 11, 'same': False}, 'dst': {'type': 'addresses_WT_ht', 'congruent': 6, 'same': False}, 'OP': 'REPM'}
