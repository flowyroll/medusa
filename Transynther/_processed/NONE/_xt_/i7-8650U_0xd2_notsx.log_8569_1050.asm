...
push %rdx
push %rsi
lea addresses_WC_ht+0x5f00, %rsi
nop
nop
inc %r11
movl $0x61626364, (%rsi)
...
nop
inc %rdx
lea addresses_UC_ht+0x15b00, %r14
nop
nop
nop
nop
...
nop
cmp %rsi, %rsi
lea addresses_UC_ht+0x16060, %r14
nop
nop
nop
nop
...
nop
cmp $39840, %r14
lea addresses_UC_ht+0x1ba72, %rsi
lea addresses_D_ht+0x1d300, %rdi
nop
nop
nop
nop
...
rep movsb
and $49084, %rdx
lea addresses_D_ht+0xa500, %rsi
lea addresses_normal_ht+0x1b0d9, %rdi
nop
nop
nop
cmp $52515, %r10
...
nop
sub %rdx, %rdx
lea addresses_UC_ht+0x1e820, %r11
clflush (%r11)
nop
and $15357, %rdx
movb (%r11), %cl
...
nop
xor $8688, %rdi
lea addresses_WC_ht+0x1dc38, %r11
clflush (%r11)
nop
nop
nop
...
{'OP': 'STOR', 'dst': {'type': 'addresses_P', 'size': 1, 'AVXalign': False, 'NT': True, 'congruent': 0, 'same': False}}
