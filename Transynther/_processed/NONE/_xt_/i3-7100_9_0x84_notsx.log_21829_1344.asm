...
nop
add %rdx, %rdx
lea addresses_UC_ht+0xbe9c, %rcx
add $10485, %r9
movb $0x61, (%rcx)
nop
sub %r11, %r11
lea addresses_normal_ht+0x10e9c, %r8
nop
nop
nop
nop
...
nop
and %rdi, %rdi
lea addresses_UC_ht+0x1efc4, %rdi
nop
dec %r8
mov (%rdi), %edx
add $18251, %rcx
lea addresses_WC_ht+0xd418, %rdi
nop
nop
xor $32554, %r9
movb $0x61, (%rdi)
