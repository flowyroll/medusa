...
push %rdi
push %rsi
lea addresses_UC_ht+0xcf65, %r10
nop
dec %r12
movw $0x6162, (%r10)
nop
nop
dec %r11
lea addresses_D_ht+0x13ccb, %rbp
nop
nop
nop
nop
...
nop
add $11666, %rbp
lea addresses_normal_ht+0x1c8e5, %rsi
...
// Store
lea addresses_normal+0x133a5, %rbx
clflush (%rbx)
nop
nop
nop
...
// REPMOV
lea addresses_UC+0x134e5, %rsi
lea addresses_WT+0x1eea5, %rdi
clflush (%rdi)
nop
nop
nop
...
// Store
lea addresses_normal+0x1f981, %rdi
nop
nop
nop
dec %rbp
...
{'dst': {'type': 'addresses_normal', 'same': False, 'size': 1, 'congruent': 1, 'NT': False, 'AVXalign': True}, 'OP': 'STOR'}
...
{'src': {'type': 'addresses_UC', 'congruent': 11, 'same': False}, 'dst': {'type': 'addresses_WT', 'congruent': 2, 'same': False}, 'OP': 'REPM'}
...
{'src': {'type': 'addresses_normal_ht', 'congruent': 9, 'same': False}, 'dst': {'type': 'addresses_WT_ht', 'congruent': 5, 'same': True}, 'OP': 'REPM'}
{'32': 21829}
