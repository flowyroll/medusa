...
push %rdx
push %rsi
lea addresses_A_ht+0x1db9f, %rsi
...
nop
and $16233, %r9
lea addresses_WC_ht+0x14715, %rdx
nop
nop
and $43587, %r12
movb (%rdx), %r9b
nop
sub $40791, %r9
lea addresses_D_ht+0x146bf, %rsi
nop
xor $17431, %r12
movb (%rsi), %dl
cmp %rbx, %rbx
lea addresses_WT_ht+0x107ff, %rsi
lea addresses_WC_ht+0x8bff, %rdi
nop
add $46588, %r11
mov $2, %rcx
rep movsq
nop
sub $36492, %rcx
lea addresses_A_ht+0x1d7ff, %rdi
clflush (%rdi)
nop
nop
nop
...
{'OP': 'REPM', 'src': {'type': 'addresses_WT_ht', 'congruent': 9, 'same': True}, 'dst': {'type': 'addresses_WC_ht', 'congruent': 11, 'same': False}}
