...
nop
and %r12, %r12
lea addresses_UC_ht+0xd771, %r14
nop
cmp %rbx, %rbx
...
nop
xor $36236, %r12
lea addresses_UC_ht+0x11cf1, %rsi
cmp $27974, %r13
mov (%rsi), %r14
nop
and %r14, %r14
...
// Store
lea addresses_D+0x13ff1, %r8
cmp $24558, %rdi
movw $0x5152, (%r8)
sub $35452, %rdx

// Load
lea addresses_D+0x4ff1, %rbx
cmp %r11, %r11
mov (%rbx), %r15d
nop
nop
...
{'OP': 'REPM', 'src': {'type': 'addresses_normal_ht', 'congruent': 10, 'same': True}, 'dst': {'type': 'addresses_UC_ht', 'congruent': 11, 'same': False}}
