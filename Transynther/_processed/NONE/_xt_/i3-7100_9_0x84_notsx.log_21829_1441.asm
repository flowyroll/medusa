...
push %rdi
push %rsi
lea addresses_D_ht+0xd91c, %r10
dec %rbx
mov (%r10), %r9w
nop
cmp $64174, %rdi
lea addresses_WC_ht+0x156a4, %rsi
lea addresses_normal_ht+0x14ba4, %rdi
nop
xor $34131, %r9
mov $7, %rcx
rep movsb
...
{'src': {'type': 'addresses_WT', 'same': False, 'size': 1, 'congruent': 6, 'NT': False, 'AVXalign': False}, 'OP': 'LOAD'}
...
{'src': {'type': 'addresses_WC_ht', 'congruent': 11, 'same': False}, 'dst': {'type': 'addresses_normal_ht', 'congruent': 8, 'same': True}, 'OP': 'REPM'}
{'37': 21829}
