...
nop
cmp $37913, %rax
lea addresses_UC_ht+0x18c51, %r11
nop
nop
nop
and $40802, %r12
...
nop
add %rdi, %rdi
lea addresses_A_ht+0x1c7b1, %rdx
nop
and $30058, %r9
movb $0x61, (%rdx)
nop
...
nop
add %rdi, %rdi
lea addresses_normal_ht+0x11e9, %rdx
nop
nop
nop
nop
...
nop
and %r11, %r11
lea addresses_normal_ht+0x71b1, %r9
nop
nop
xor $30482, %rax
mov (%r9), %r12w
...
nop
sub %rcx, %rcx
lea addresses_normal_ht+0x146a5, %r12
nop
nop
nop
nop
...
nop
cmp $28036, %rdx
lea addresses_WC_ht+0x1634b, %rax
nop
nop
nop
and $15368, %r9
mov (%rax), %edi
dec %rdi
lea addresses_UC_ht+0x12531, %r9
nop
nop
nop
cmp %rdi, %rdi
...
nop
add %r11, %r11
lea addresses_A_ht+0x1d671, %rsi
lea addresses_UC_ht+0x173b1, %rdi
add %r12, %r12
mov $125, %rcx
rep movsl
nop
sub %rdx, %rdx
lea addresses_WC_ht+0x18c11, %rcx
nop
nop
nop
nop
...
nop
cmp $65140, %rdx
lea addresses_A_ht+0xcfb1, %rsi
lea addresses_normal_ht+0x13cf1, %rdi
nop
nop
nop
nop
...
rep movsb
add %rcx, %rcx
lea addresses_normal_ht+0x31b1, %rsi
lea addresses_WC_ht+0x1d3b1, %rdi
nop
nop
add %rdx, %rdx
mov $29, %rcx
...
{'src': {'type': 'addresses_WC_ht', 'same': False, 'size': 4, 'congruent': 0, 'NT': False, 'AVXalign': True}, 'OP': 'LOAD'}
