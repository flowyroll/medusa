...
push %rdx
push %rsi
lea addresses_WT_ht+0x111e, %r15
nop
nop
nop
nop
...
nop
dec %rdi
lea addresses_D_ht+0x901e, %rsi
lea addresses_normal_ht+0xfd1e, %rdi
and %r9, %r9
mov $46, %rcx
rep movsl
nop
...
nop
dec %rsi
lea addresses_normal_ht+0x132ee, %rsi
lea addresses_WC_ht+0xcf1c, %rdi
nop
nop
and %r9, %r9
mov $115, %rcx
...
nop
xor $16513, %r12
lea addresses_UC_ht+0x12063, %r10
nop
nop
nop
nop
...
nop
cmp %rcx, %rcx
lea addresses_D_ht+0x14232, %rsi
lea addresses_normal_ht+0x1c91e, %rdi
clflush (%rsi)
and $6614, %rdx
mov $59, %rcx
rep movsq
nop
sub $45192, %r10
lea addresses_D_ht+0x1251e, %rdi
nop
nop
nop
nop
...
nop
lfence
lea addresses_WT_ht+0xd65e, %r12
cmp $52890, %r15
movups (%r12), %xmm2
vpextrq $0, %xmm2, %r9
nop
cmp $25983, %rcx
lea addresses_A_ht+0x14866, %rsi
lea addresses_UC_ht+0x12c56, %rdi
nop
nop
dec %r12
mov $58, %rcx
...
nop
xor $31122, %r12
lea addresses_D_ht+0x49e, %r10
sub $42959, %rcx
movb $0x61, (%r10)
nop
nop
lfence
lea addresses_D_ht+0xad4e, %r12
nop
nop
and %rdi, %rdi
movb $0x61, (%r12)
...
nop
and %rdi, %rdi
lea addresses_A_ht+0x1d31e, %rsi
lea addresses_WC_ht+0x1e541, %rdi
cmp $43780, %r12
mov $112, %rcx
rep movsl
nop
...
nop
add %r15, %r15
lea addresses_UC_ht+0x791e, %rdx
nop
nop
nop
nop
...
nop
dec %r15
lea addresses_UC_ht+0xa11e, %rsi
nop
nop
nop
nop
...
nop
dec %rcx
lea addresses_WC_ht+0x17ff6, %rsi
lea addresses_WC_ht+0x1ce7, %rdi
sub %r10, %r10
mov $57, %rcx
rep movsl
nop
...
{'src': {'type': 'addresses_A_ht', 'congruent': 3, 'same': False}, 'OP': 'REPM', 'dst': {'type': 'addresses_UC_ht', 'congruent': 3, 'same': False}}
