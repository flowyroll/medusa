...
push %rdx
push %rsi
lea addresses_UC_ht+0x15904, %rdi
xor $28909, %rax
...
nop
cmp %rsi, %rsi
lea addresses_WC_ht+0x1be64, %rdx
nop
nop
nop
and %rbx, %rbx
...
{'OP': 'STOR', 'dst': {'type': 'addresses_P', 'AVXalign': False, 'congruent': 0, 'size': 1, 'same': False, 'NT': True}}
