...
nop
sub %r13, %r13
lea addresses_WC_ht+0x1d0f6, %r15
nop
nop
nop
nop
...
nop
xor $13306, %r13
lea addresses_UC_ht+0x1e6ae, %rbp
nop
nop
add %rdx, %rdx
mov (%rbp), %r9w
...
nop
sub $27122, %r15
lea addresses_UC_ht+0xcaae, %rax
and $38215, %r15
...
nop
mfence
lea addresses_D_ht+0xd32e, %rsi
lea addresses_WC_ht+0xe6e, %rdi
nop
nop
and $10478, %rdx
mov $44, %rcx
...
nop
cmp $44541, %r13
lea addresses_normal_ht+0x1d2e, %rcx
add $47947, %rdx
mov (%rcx), %r9d
nop
nop
...
nop
add %rbp, %rbp
lea addresses_UC_ht+0x13aae, %rsi
lea addresses_D_ht+0xfaae, %rdi
nop
nop
nop
nop
...
rep movsw
xor $209, %r9
lea addresses_WC_ht+0x17e2e, %rdx
nop
and $57484, %rax
movb $0x61, (%rdx)
nop
...
mov (%r13), %r14w
add %r9, %r9
lea addresses_WC_ht+0x112e, %rsi
nop
inc %r13
movl $0x61626364, (%rsi)
nop
nop
xor %rdx, %rdx
lea addresses_A_ht+0x1edc, %r9
nop
xor %r15, %r15
mov $0x6162636465666768, %rdi
movq %rdi, (%r9)
and %rdi, %rdi
lea addresses_UC_ht+0x1a876, %rsi
lea addresses_A_ht+0x2a6e, %rdi
inc %rbp
mov $80, %rcx
rep movsl
nop
...
<gen_prepare_buffer>
{'OP': 'LOAD', 'src': {'same': False, 'type': 'addresses_normal_ht', 'NT': False, 'AVXalign': True, 'size': 1, 'congruent': 2}}
...
{'OP': 'REPM', 'src': {'same': False, 'congruent': 7, 'type': 'addresses_D_ht'}, 'dst': {'same': False, 'congruent': 4, 'type': 'addresses_WC_ht'}}
{'OP': 'LOAD', 'src': {'same': True, 'type': 'addresses_normal_ht', 'NT': False, 'AVXalign': False, 'size': 4, 'congruent': 7}}
