...
push %rdi
push %rsi
lea addresses_D_ht+0x85ac, %rsi
lea addresses_WT_ht+0x158b2, %rdi
nop
nop
add %rbx, %rbx
mov $70, %rcx
rep movsw
and $37250, %r15
lea addresses_normal_ht+0x30ac, %r8
nop
and %rdi, %rdi
movb (%r8), %r15b
nop
and $81, %rbx
lea addresses_D_ht+0x10124, %rcx
nop
nop
nop
nop
...
nop
sub $3450, %r12
lea addresses_UC_ht+0x1ef80, %rcx
nop
nop
nop
nop
...
nop
cmp %r12, %r12
lea addresses_A_ht+0x183ec, %rsi
lea addresses_WC_ht+0x1d3ac, %rdi
nop
nop
nop
nop
...
nop
and $12299, %rbx
lea addresses_normal_ht+0x1c0ac, %r15
nop
nop
nop
nop
...
nop
xor %rsi, %rsi
lea addresses_D_ht+0x1ecc0, %rsi
nop
nop
nop
inc %rcx
...
// Store
lea addresses_normal+0x7dac, %r8
nop
sub %rdx, %rdx
...
{'src': {'type': 'addresses_D_ht', 'same': False, 'size': 4, 'congruent': 0, 'NT': True, 'AVXalign': True}, 'OP': 'LOAD'}
{'32': 21829}
