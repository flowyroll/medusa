...
push %rdi
push %rsi
lea addresses_D_ht+0x103a, %r11
and %r12, %r12
mov (%r11), %si
nop
sub $1954, %r15
lea addresses_UC_ht+0x16fa, %rdi
nop
nop
nop
nop
...
nop
and $19044, %rsi
lea addresses_WC_ht+0x566a, %rsi
lea addresses_WT_ht+0x10fa, %rdi
clflush (%rdi)
nop
nop
nop
...
// Store
lea addresses_normal+0x1a7fa, %r10
nop
nop
nop
nop
...
{'dst': {'same': False, 'congruent': 9, 'type': 'addresses_WT_ht'}, 'OP': 'REPM', 'src': {'same': False, 'congruent': 3, 'type': 'addresses_WC_ht'}}
{'36': 21829}
