...
nop
sub %rdi, %rdi
lea addresses_WC_ht+0x19616, %r13
nop
dec %rsi
...
nop
dec %r13
lea addresses_WT_ht+0xecc3, %r15
nop
xor %rsi, %rsi
mov (%r15), %di
nop
add $56876, %r13
lea addresses_A_ht+0xb856, %r11
nop
nop
sub %r15, %r15
movl $0x61626364, (%r11)
cmp %r13, %r13
lea addresses_WC_ht+0x18316, %rsi
lea addresses_WC_ht+0x1acc6, %rdi
nop
xor $33062, %r11
mov $54, %rcx
rep movsq
...
nop
and $34432, %rcx
lea addresses_A_ht+0x4e16, %rsi
lea addresses_WC_ht+0xf216, %rdi
nop
nop
xor $59022, %r9
mov $37, %rcx
...
nop
cmp %rdi, %rdi
lea addresses_WT_ht+0x1d16, %r15
nop
nop
nop
nop
...
{'OP': 'LOAD', 'src': {'size': 4, 'NT': False, 'type': 'addresses_WC', 'same': False, 'AVXalign': False, 'congruent': 6}}
{'OP': 'STOR', 'dst': {'size': 2, 'NT': False, 'type': 'addresses_UC', 'same': False, 'AVXalign': False, 'congruent': 3}}
[Faulty Load]
...
{'OP': 'REPM', 'src': {'same': False, 'type': 'addresses_WC_ht', 'congruent': 9}, 'dst': {'same': False, 'type': 'addresses_WC_ht', 'congruent': 2}}
