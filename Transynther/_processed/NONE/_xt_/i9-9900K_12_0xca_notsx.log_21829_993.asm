...
push %rdi
push %rsi
lea addresses_WC_ht+0x52ba, %rcx
nop
nop
dec %rsi
mov (%rcx), %r12
...
nop
inc %rsi
lea addresses_A_ht+0x128fa, %r11
clflush (%r11)
nop
nop
nop
...
nop
xor %r15, %r15
lea addresses_A_ht+0xeafa, %rsi
clflush (%rsi)
add %r12, %r12
movl $0x61626364, (%rsi)
nop
sub $63376, %r11
lea addresses_A_ht+0xc4ba, %rbp
nop
cmp $18695, %r15
vmovups (%rbp), %ymm4
