...
nop
sub $18420, %r13
lea addresses_WC_ht+0x1bf9a, %r12
nop
nop
nop
nop
...
lea addresses_WT_ht+0x15ae6, %rdi
nop
add $15507, %r12
mov $86, %rcx
rep movsw
...
lea addresses_WC_ht+0x1c406, %rdi
nop
nop
nop
nop
...
nop
cmp %r12, %r12
lea addresses_normal_ht+0xfe7b, %rsi
lea addresses_normal_ht+0x1c756, %rdi
nop
nop
nop
nop
...
nop
cmp $55757, %rcx
lea addresses_D_ht+0x1eced, %rdi
clflush (%rdi)
nop
sub %rcx, %rcx
movw $0x6162, (%rdi)
...
// Faulty Load
lea addresses_normal+0x4756, %r12
clflush (%r12)
nop
nop
nop
...
{'src': {'same': True, 'congruent': 5, 'type': 'addresses_UC_ht'}, 'OP': 'REPM', 'dst': {'same': False, 'congruent': 3, 'type': 'addresses_WT_ht'}}
{'src': {'same': True, 'congruent': 10, 'type': 'addresses_A_ht'}, 'OP': 'REPM', 'dst': {'same': False, 'congruent': 1, 'type': 'addresses_WC_ht'}}
{'src': {'same': False, 'congruent': 0, 'type': 'addresses_normal_ht'}, 'OP': 'REPM', 'dst': {'same': False, 'congruent': 11, 'type': 'addresses_normal_ht'}}
