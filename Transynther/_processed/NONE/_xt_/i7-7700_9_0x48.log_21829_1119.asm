...
nop
xor %rdx, %rdx
lea addresses_WC_ht+0x45af, %rsi
lea addresses_A_ht+0x1adaf, %rdi
clflush (%rsi)
nop
nop
nop
...
mov (%rsi), %ebx
add %r10, %r10
lea addresses_WC_ht+0x1631f, %rcx
nop
nop
nop
nop
...
nop
sub %rbx, %rbx
lea addresses_normal_ht+0x128af, %rdx
nop
nop
nop
nop
...
movw $0x6162, (%rdx)
cmp $60589, %r11
lea addresses_A_ht+0x1036f, %rsi
lea addresses_normal_ht+0xba2f, %rdi
clflush (%rsi)
nop
nop
nop
...
nop
xor $62231, %rbx
lea addresses_normal_ht+0x122f, %r12
nop
nop
nop
and %r11, %r11
movb $0x61, (%r12)
cmp $9284, %rdi
lea addresses_WC_ht+0x1dbaf, %r12
nop
nop
cmp %rdx, %rdx
mov (%r12), %r10
nop
inc %rcx
lea addresses_WT_ht+0x1b0ff, %rsi
lea addresses_A_ht+0x12baf, %rdi
clflush (%rdi)
nop
nop
nop
...
nop
inc %rbx
lea addresses_WT_ht+0x1eabf, %rbx
nop
cmp $42190, %rcx
...
// Faulty Load
lea addresses_normal+0x1ddaf, %r14
nop
nop
nop
nop
...
{'OP': 'REPM', 'src': {'type': 'addresses_WT_ht', 'congruent': 4, 'same': True}, 'dst': {'type': 'addresses_A_ht', 'congruent': 9, 'same': False}}
