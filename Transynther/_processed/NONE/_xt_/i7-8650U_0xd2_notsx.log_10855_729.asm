...
push %rdi
push %rsi
lea addresses_WT_ht+0x4320, %rsi
lea addresses_UC_ht+0xd24e, %rdi
nop
nop
nop
nop
...
nop
sub %rdi, %rdi
lea addresses_UC_ht+0x14ffa, %rsi
nop
nop
nop
nop
...
nop
add %rcx, %rcx
lea addresses_WC_ht+0x105b3, %rsi
lea addresses_D_ht+0x170b2, %rdi
nop
nop
sub $56357, %r15
mov $8, %rcx
...
nop
sub $31812, %rdi
lea addresses_UC_ht+0x1b1fa, %rsi
lea addresses_WC_ht+0x13ce2, %rdi
clflush (%rsi)
nop
nop
nop
...
rep movsw
add $65202, %r15
lea addresses_WC_ht+0x11056, %rdi
dec %rcx
movb $0x61, (%rdi)
nop
add $2464, %rax
