...
nop
cmp $20488, %rdi
lea addresses_D_ht+0x1010c, %rcx
add $36061, %r13
mov (%rcx), %r10
nop
nop
...
nop
cmp %rdi, %rdi
lea addresses_WC_ht+0x82f2, %rsi
lea addresses_WC_ht+0x2311, %rdi
nop
nop
nop
xor $24569, %r11
...
nop
inc %rcx
lea addresses_D_ht+0x1aed1, %r13
clflush (%r13)
nop
add $1487, %r11
movb $0x61, (%r13)
...
nop
xor $40275, %r10
lea addresses_A_ht+0x18721, %rsi
lea addresses_normal_ht+0x48d1, %rdi
inc %r8
mov $125, %rcx
rep movsl
nop
...
nop
sub %rcx, %rcx
lea addresses_UC_ht+0x1c1a1, %rsi
lea addresses_D_ht+0x3711, %rdi
clflush (%rsi)
nop
nop
nop
...
nop
and $60020, %rcx
lea addresses_UC_ht+0x133db, %r10
nop
nop
nop
nop
...
nop
add %r8, %r8
lea addresses_WC_ht+0xa611, %rdi
nop
nop
nop
nop
...
nop
dec %rcx
lea addresses_WC_ht+0x11b1, %rdi
nop
nop
xor %r10, %r10
...
nop
sub $46288, %rbp
lea addresses_WT_ht+0x108d1, %rsi
lea addresses_UC_ht+0xd891, %rdi
nop
nop
sub $21465, %r8
mov $30, %rcx
...
nop
and $12214, %r11
lea addresses_A_ht+0x1ed91, %r13
nop
nop
nop
nop
...
{'OP': 'REPM', 'src': {'type': 'addresses_A_ht', 'congruent': 4, 'same': False}, 'dst': {'type': 'addresses_normal_ht', 'congruent': 6, 'same': True}}
{'OP': 'REPM', 'src': {'type': 'addresses_UC_ht', 'congruent': 4, 'same': False}, 'dst': {'type': 'addresses_D_ht', 'congruent': 10, 'same': False}}
