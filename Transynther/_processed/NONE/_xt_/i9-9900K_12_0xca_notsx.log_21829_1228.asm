...
nop
add $52239, %r12
lea addresses_WC_ht+0xce08, %rsi
lea addresses_WT_ht+0x1b585, %rdi
clflush (%rdi)
xor $14823, %rdx
mov $38, %rcx
rep movsq
...
nop
xor %rdi, %rdi
lea addresses_UC_ht+0xf488, %rcx
cmp $32509, %rbp
mov (%rcx), %si
nop
nop
...
nop
and $12965, %rsi
lea addresses_WT_ht+0xe608, %rbx
nop
nop
nop
add $5172, %r14
mov (%rbx), %cx
dec %rdi
lea addresses_D_ht+0x157f4, %rsi
...
nop
cmp %r14, %r14
lea addresses_normal_ht+0x180e8, %rsi
lea addresses_normal_ht+0xca08, %rdi
clflush (%rdi)
nop
nop
cmp %rbp, %rbp
...
rep movsw
add $20090, %rcx
lea addresses_A_ht+0x11e08, %rdi
and $47243, %rdx
...
nop
and $15382, %rsi
lea addresses_WT_ht+0x167c8, %rbp
nop
add %rbx, %rbx
...
// Faulty Load
lea addresses_normal+0x8e08, %r13
nop
nop
nop
cmp $63697, %rbx
...
<gen_faulty_load>
[REF]
{'OP': 'LOAD', 'src': {'same': False, 'type': 'addresses_normal', 'NT': False, 'AVXalign': True, 'size': 1, 'congruent': 0}}
...
{'OP': 'REPM', 'src': {'same': False, 'congruent': 10, 'type': 'addresses_WC_ht'}, 'dst': {'same': False, 'congruent': 0, 'type': 'addresses_WT_ht'}}
...
{'OP': 'REPM', 'src': {'same': False, 'congruent': 3, 'type': 'addresses_normal_ht'}, 'dst': {'same': False, 'congruent': 7, 'type': 'addresses_normal_ht'}}
{'OP': 'STOR', 'dst': {'same': False, 'type': 'addresses_A_ht', 'NT': True, 'AVXalign': False, 'size': 32, 'congruent': 9}}
