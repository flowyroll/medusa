...
push %rdi
push %rsi
lea addresses_UC_ht+0x1486, %rsi
lea addresses_D_ht+0xe7e2, %rdi
cmp %r11, %r11
mov $98, %rcx
rep movsl
nop
nop
and %r11, %r11
lea addresses_WT_ht+0x1bea6, %rdi
nop
nop
nop
nop
...
nop
sub %r11, %r11
lea addresses_UC_ht+0x13d86, %rsi
lea addresses_UC_ht+0xe21f, %rdi
clflush (%rdi)
nop
nop
nop
...
nop
add $48997, %rsi
lea addresses_normal_ht+0xe886, %rsi
lea addresses_D_ht+0x4286, %rdi
nop
nop
nop
nop
...
nop
add $59405, %rsi
lea addresses_WT_ht+0x3dc6, %r11
nop
nop
nop
nop
...
nop
and %rbp, %rbp
lea addresses_normal_ht+0x1a786, %r12
cmp $6298, %rcx
mov (%r12), %edi
nop
nop
