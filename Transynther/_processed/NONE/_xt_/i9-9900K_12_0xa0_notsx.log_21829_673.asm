...
nop
inc %rdi
lea addresses_UC_ht+0x1ea82, %rsi
lea addresses_WT_ht+0x11cc2, %rdi
nop
nop
nop
nop
...
nop
dec %r8
lea addresses_UC_ht+0x10042, %rdi
nop
nop
nop
nop
...
{'src': {'type': 'addresses_D_ht', 'congruent': 5, 'same': False}, 'OP': 'REPM', 'dst': {'type': 'addresses_UC_ht', 'congruent': 8, 'same': True}}
