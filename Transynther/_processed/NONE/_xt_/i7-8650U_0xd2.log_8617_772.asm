...
push %rdi
push %rsi
lea addresses_normal_ht+0x6ae2, %rsi
...
nop
and $61278, %r13
lea addresses_UC_ht+0x12254, %r10
nop
nop
cmp %r8, %r8
movw $0x6162, (%r10)
...
nop
inc %r13
lea addresses_WT_ht+0x3a41, %r11
nop
nop
nop
nop
...
nop
sub %r11, %r11
lea addresses_D_ht+0x101c2, %r10
nop
xor %rsi, %rsi
...
nop
sub %r13, %r13
lea addresses_normal_ht+0x8442, %r10
nop
nop
nop
nop
...
nop
dec %rsi
lea addresses_D_ht+0x1c832, %rsi
lea addresses_D_ht+0x1132, %rdi
nop
and %rbx, %rbx
mov $48, %rcx
rep movsl
