...
push %rdi
push %rsi
lea addresses_D_ht+0x18ed2, %rsi
nop
dec %r8
mov (%rsi), %edi
nop
and $12414, %rbx
lea addresses_A_ht+0x9332, %r12
clflush (%r12)
nop
nop
nop
...
nop
xor $4023, %rbp
lea addresses_D_ht+0x1d612, %r12
nop
xor %rsi, %rsi
movw $0x6162, (%r12)
nop
inc %r11
lea addresses_WC_ht+0xc9b2, %rbx
nop
nop
xor $31661, %r8
mov (%rbx), %r12w
...
nop
dec %r11
lea addresses_WC_ht+0x12932, %rdi
nop
add %r11, %r11
mov (%rdi), %ebp
nop
...
nop
cmp $51365, %r11
lea addresses_UC_ht+0xca32, %rbx
nop
nop
cmp %r12, %r12
movw $0x6162, (%rbx)
...
nop
xor $23445, %rsi
lea addresses_WC_ht+0x14252, %rbp
clflush (%rbp)
nop
nop
nop
...
movb (%r11), %bl
add %r12, %r12
lea addresses_UC_ht+0xd932, %rsi
lea addresses_WC_ht+0x2e32, %rdi
clflush (%rdi)
nop
nop
nop
...
rep movsw
add %rcx, %rcx
lea addresses_D_ht+0x10a82, %rcx
nop
inc %r12
movups (%rcx), %xmm2
vpextrq $1, %xmm2, %r11
...
nop
add %rdi, %rdi
lea addresses_WT_ht+0x1c098, %r12
sub $64036, %rbp
movb (%r12), %cl
nop
nop
nop
sub $21989, %r8
lea addresses_D_ht+0x123b2, %r11
sub %rdi, %rdi
...
nop
add %r12, %r12
lea addresses_normal_ht+0x147b2, %rsi
lea addresses_WC_ht+0x1b3ae, %rdi
nop
dec %r12
mov $107, %rcx
rep movsq
...
nop
cmp %r8, %r8
lea addresses_WC_ht+0x50b0, %rsi
lea addresses_normal_ht+0x622, %rdi
clflush (%rdi)
nop
nop
nop
...
{'dst': {'same': False, 'NT': True, 'AVXalign': False, 'size': 16, 'type': 'addresses_A', 'congruent': 4}, 'OP': 'STOR'}
[Faulty Load]
...
{'dst': {'same': False, 'NT': True, 'AVXalign': False, 'size': 2, 'type': 'addresses_UC_ht', 'congruent': 8}, 'OP': 'STOR'}
...
{'dst': {'same': False, 'congruent': 8, 'type': 'addresses_WC_ht'}, 'OP': 'REPM', 'src': {'same': True, 'congruent': 10, 'type': 'addresses_UC_ht'}}
...
{'dst': {'same': False, 'congruent': 1, 'type': 'addresses_WC_ht'}, 'OP': 'REPM', 'src': {'same': False, 'congruent': 4, 'type': 'addresses_normal_ht'}}
{'dst': {'same': False, 'congruent': 4, 'type': 'addresses_normal_ht'}, 'OP': 'REPM', 'src': {'same': True, 'congruent': 1, 'type': 'addresses_WC_ht'}}
{'36': 1120}
