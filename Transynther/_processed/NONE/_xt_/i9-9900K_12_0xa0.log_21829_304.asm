...
push %rdi
push %rsi
lea addresses_A_ht+0x9a64, %rbp
nop
cmp $38817, %rsi
mov (%rbp), %r14d
nop
add $23386, %rbx
lea addresses_WT_ht+0x1cf75, %rcx
nop
nop
nop
nop
...
movups %xmm3, (%rcx)
cmp %r14, %r14
lea addresses_A_ht+0x7b34, %rsi
lea addresses_normal_ht+0x1c804, %rdi
nop
nop
nop
nop
...
nop
sub %r8, %r8
lea addresses_WT_ht+0x2c74, %rsi
lea addresses_WT_ht+0x183e4, %rdi
nop
xor %r14, %r14
mov $79, %rcx
rep movsl
...
nop
cmp %r14, %r14
lea addresses_A_ht+0x3e1e, %r8
and $497, %rbx
mov (%r8), %ebp
nop
nop
add $58506, %rbx
lea addresses_UC_ht+0x3064, %rbx
clflush (%rbx)
nop
nop
nop
...
nop
and $28901, %r8
lea addresses_normal_ht+0x2da4, %rsi
lea addresses_D_ht+0x17204, %rdi
nop
nop
add %r9, %r9
mov $2, %rcx
...
// Store
lea addresses_normal+0xc54c, %r15
nop
nop
dec %rcx
...
{'src': {'same': False, 'congruent': 4, 'type': 'addresses_A_ht'}, 'OP': 'REPM', 'dst': {'same': True, 'congruent': 5, 'type': 'addresses_normal_ht'}}
...
{'src': {'NT': False, 'same': False, 'congruent': 0, 'type': 'addresses_A_ht', 'AVXalign': True, 'size': 4}, 'OP': 'LOAD'}
