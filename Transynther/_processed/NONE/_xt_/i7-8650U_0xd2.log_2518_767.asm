...
push %rdx
push %rsi
lea addresses_UC_ht+0x1655d, %rax
nop
nop
nop
nop
...
nop
and %rdx, %rdx
lea addresses_WT_ht+0x1325d, %rsi
nop
nop
nop
and %r15, %r15
...
nop
sub $38724, %rax
lea addresses_A_ht+0x1575d, %rdx
nop
nop
nop
nop
...
mov (%rdx), %r9w
and $22602, %r9
lea addresses_WC_ht+0x1ee1d, %r8
nop
nop
nop
inc %rdx
...
vpextrq $1, %xmm4, %rcx
add $65113, %rax
lea addresses_UC_ht+0x13f9d, %rcx
nop
nop
nop
nop
...
nop
add %r8, %r8
lea addresses_normal_ht+0x15c8d, %rdx
nop
sub $60839, %r9
mov (%rdx), %r8
nop
...
nop
cmp %r9, %r9
lea addresses_normal_ht+0x1027d, %rsi
lea addresses_UC_ht+0xef82, %rdi
nop
and %r9, %r9
mov $96, %rcx
rep movsq
...
nop
xor %r15, %r15
lea addresses_WT_ht+0x1c1b5, %rcx
nop
lfence
movb (%rcx), %r9b
xor $5904, %rdx
lea addresses_WT_ht+0x3f5d, %r8
nop
nop
nop
nop
...
nop
and $19114, %r8
lea addresses_A_ht+0x1698d, %rsi
lea addresses_WT_ht+0x25, %rdi
nop
nop
nop
nop
...
nop
cmp $31604, %rsi
lea addresses_A_ht+0x13651, %rsi
lea addresses_normal_ht+0xec5d, %rdi
nop
nop
nop
sub $34987, %r9
...
{'OP': 'LOAD', 'src': {'type': 'addresses_WC_ht', 'size': 32, 'AVXalign': False, 'NT': True, 'congruent': 6, 'same': True}}
{'OP': 'STOR', 'dst': {'type': 'addresses_UC_ht', 'size': 16, 'AVXalign': False, 'NT': False, 'congruent': 4, 'same': False}}
{'OP': 'LOAD', 'src': {'type': 'addresses_normal_ht', 'size': 8, 'AVXalign': False, 'NT': False, 'congruent': 3, 'same': True}}
{'OP': 'REPM', 'src': {'type': 'addresses_normal_ht', 'congruent': 5, 'same': False}, 'dst': {'type': 'addresses_UC_ht', 'congruent': 0, 'same': True}}
