...
movl $0x61626364, (%r10)
add %r10, %r10
lea addresses_D_ht+0xa6ec, %rsi
lea addresses_UC_ht+0x8aec, %rdi
clflush (%rsi)
clflush (%rdi)
nop
nop
...
nop
add %rdi, %rdi
lea addresses_WC_ht+0x1caec, %rsi
nop
and %rbx, %rbx
...
nop
xor $32032, %rax
lea addresses_UC_ht+0x13d2c, %rbx
clflush (%rbx)
nop
cmp %rax, %rax
movups (%rbx), %xmm6
...
nop
inc %r12
lea addresses_UC_ht+0x166ec, %rsi
lea addresses_A_ht+0x127e8, %rdi
nop
dec %r15
mov $108, %rcx
rep movsl
...
nop
mfence
lea addresses_UC_ht+0x11eec, %rbx
nop
nop
nop
cmp %rdi, %rdi
mov (%rbx), %eax
dec %rsi
lea addresses_normal_ht+0x2dcc, %rbx
clflush (%rbx)
add %rdi, %rdi
movb (%rbx), %r10b
nop
...
nop
sub $35350, %r12
lea addresses_D_ht+0x158ec, %r15
nop
nop
nop
nop
...
nop
inc %rbx
lea addresses_A_ht+0x188ec, %rax
nop
nop
dec %rbx
vmovups (%rax), %ymm1
...
nop
sub %r15, %r15
lea addresses_normal_ht+0x144ec, %rcx
nop
nop
nop
add %rbx, %rbx
...
// Store
lea addresses_normal+0x3734, %r11
nop
nop
nop
nop
...
<gen_faulty_load>
[REF]
{'src': {'congruent': 0, 'AVXalign': True, 'same': True, 'size': 2, 'NT': False, 'type': 'addresses_D'}, 'OP': 'LOAD'}
{'OP': 'STOR', 'dst': {'congruent': 10, 'AVXalign': False, 'same': False, 'size': 16, 'NT': False, 'type': 'addresses_D'}}
{'OP': 'STOR', 'dst': {'congruent': 3, 'AVXalign': False, 'same': False, 'size': 1, 'NT': True, 'type': 'addresses_A'}}
{'OP': 'STOR', 'dst': {'congruent': 0, 'AVXalign': False, 'same': False, 'size': 2, 'NT': True, 'type': 'addresses_normal'}}
...
{'OP': 'STOR', 'dst': {'congruent': 4, 'AVXalign': False, 'same': True, 'size': 4, 'NT': False, 'type': 'addresses_normal_ht'}}
{'src': {'congruent': 10, 'same': False, 'type': 'addresses_D_ht'}, 'OP': 'REPM', 'dst': {'congruent': 11, 'same': False, 'type': 'addresses_UC_ht'}}
