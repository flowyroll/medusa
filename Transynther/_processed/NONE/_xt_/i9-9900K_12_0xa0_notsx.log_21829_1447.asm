...
push %rdi
push %rsi
lea addresses_WT_ht+0x190ec, %rsi
nop
nop
nop
inc %r12
...
nop
cmp %r9, %r9
lea addresses_A_ht+0x3488, %rsi
lea addresses_normal_ht+0x18c8, %rdi
nop
nop
nop
add %r8, %r8
...
nop
and $1348, %r8
lea addresses_A_ht+0x52c8, %rsi
lea addresses_normal_ht+0x56c8, %rdi
nop
and %r11, %r11
mov $100, %rcx
rep movsl
...
nop
inc %r12
lea addresses_D_ht+0xff08, %rsi
dec %rbp
mov (%rsi), %r12w
sub $23999, %rcx
lea addresses_normal_ht+0x98f0, %rsi
lea addresses_A_ht+0x67c8, %rdi
nop
nop
xor %r10, %r10
mov $55, %rcx
rep movsq
cmp %r12, %r12
lea addresses_WC_ht+0x9648, %rsi
lea addresses_normal_ht+0x13ec8, %rdi
nop
nop
nop
dec %r9
...
nop
add %rbp, %rbp
lea addresses_WT_ht+0x133c8, %rsi
lea addresses_UC_ht+0x18a98, %rdi
clflush (%rdi)
nop
nop
add $50997, %rbp
...
nop
add $32437, %r10
lea addresses_WC_ht+0x1d2c8, %rsi
lea addresses_A_ht+0x1bec8, %rdi
nop
nop
cmp %rbp, %rbp
mov $104, %rcx
...
nop
sub $62921, %r10
lea addresses_D_ht+0x1d4c8, %r10
nop
nop
xor %rdi, %rdi
movb (%r10), %r11b
...
nop
and %rsi, %rsi
lea addresses_UC_ht+0xe6c8, %rsi
lea addresses_WT_ht+0x19e08, %rdi
and %r11, %r11
mov $70, %rcx
rep movsb
nop
...
nop
xor %r12, %r12
lea addresses_UC_ht+0x12508, %rsi
lea addresses_UC_ht+0x162c8, %rdi
nop
nop
nop
sub $13430, %r11
...
nop
xor %rdi, %rdi
lea addresses_A_ht+0x1eac8, %rsi
lea addresses_normal_ht+0x1bfa0, %rdi
add %r11, %r11
mov $12, %rcx
rep movsl
xor $32857, %r8
...
{'src': {'type': 'addresses_WC_ht', 'congruent': 6, 'same': False}, 'OP': 'REPM', 'dst': {'type': 'addresses_normal_ht', 'congruent': 9, 'same': False}}
{'src': {'type': 'addresses_WT_ht', 'congruent': 7, 'same': False}, 'OP': 'REPM', 'dst': {'type': 'addresses_UC_ht', 'congruent': 4, 'same': False}}
{'src': {'type': 'addresses_WC_ht', 'congruent': 0, 'same': False}, 'OP': 'REPM', 'dst': {'type': 'addresses_A_ht', 'congruent': 10, 'same': False}}
...
{'src': {'type': 'addresses_UC_ht', 'congruent': 6, 'same': False}, 'OP': 'REPM', 'dst': {'type': 'addresses_UC_ht', 'congruent': 7, 'same': True}}
