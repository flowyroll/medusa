...
movb (%r14), %r13b
cmp %r13, %r13
lea addresses_WC_ht+0xe1b2, %rbp
nop
nop
nop
inc %rdi
...
nop
and $28232, %rbp
lea addresses_D_ht+0x11ff0, %rsi
...
nop
and $32552, %rdi
lea addresses_normal_ht+0x14fb2, %rsi
lea addresses_normal_ht+0x1b134, %rdi
nop
nop
nop
nop
...
nop
cmp $4759, %rbp
lea addresses_D_ht+0x6120, %rsi
lea addresses_A_ht+0x1dfd2, %rdi
nop
nop
nop
nop
...
nop
add $60536, %rbp
lea addresses_A_ht+0x116f2, %rsi
lea addresses_normal_ht+0x16112, %rdi
clflush (%rsi)
nop
nop
nop
...
nop
cmp $30935, %rsi
lea addresses_WT_ht+0x1a2f2, %rsi
nop
nop
nop
and $52425, %r14
...
{'src': {'type': 'addresses_D_ht', 'congruent': 1, 'same': True}, 'OP': 'REPM', 'dst': {'type': 'addresses_A_ht', 'congruent': 5, 'same': False}}
