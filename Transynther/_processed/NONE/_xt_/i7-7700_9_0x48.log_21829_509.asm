...
nop
sub $7070, %r13
lea addresses_D_ht+0x591b, %rsi
lea addresses_A_ht+0xbe37, %rdi
clflush (%rdi)
nop
nop
nop
...
nop
add $36128, %r13
lea addresses_WT_ht+0xe2fb, %rbp
nop
sub %r10, %r10
mov (%rbp), %ecx
nop
...
nop
xor %r13, %r13
lea addresses_WC_ht+0x7eb7, %rbp
nop
nop
nop
add %r8, %r8
...
nop
dec %rbp
lea addresses_normal_ht+0xc637, %r8
nop
inc %r10
mov (%r8), %r13w
nop
...
nop
and $29509, %rdi
lea addresses_normal_ht+0x1237, %rsi
...
nop
and $37326, %rax
lea addresses_A_ht+0x1a937, %rsi
nop
and %r10, %r10
movl $0x61626364, (%rsi)
nop
...
// Faulty Load
lea addresses_normal+0xde37, %r10
nop
sub $19747, %rbp
movb (%r10), %dl
lea oracles, %rbp
...
{'OP': 'STOR', 'dst': {'type': 'addresses_D', 'AVXalign': False, 'congruent': 2, 'size': 2, 'same': False, 'NT': True}}
...
{'OP': 'STOR', 'dst': {'type': 'addresses_WC_ht', 'AVXalign': False, 'congruent': 7, 'size': 2, 'same': True, 'NT': True}}
{'OP': 'LOAD', 'src': {'type': 'addresses_normal_ht', 'AVXalign': False, 'congruent': 11, 'size': 2, 'same': False, 'NT': False}}
{'OP': 'REPM', 'src': {'type': 'addresses_normal_ht', 'congruent': 9, 'same': False}, 'dst': {'type': 'addresses_A_ht', 'congruent': 0, 'same': True}}
