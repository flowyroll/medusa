...
push %rdx
push %rsi
lea addresses_D_ht+0x9118, %rsi
lea addresses_WT_ht+0x60d8, %rdi
nop
nop
nop
nop
...
lea addresses_A_ht+0x1e8ae, %rdi
nop
nop
and $3110, %rax
mov $21, %rcx
...
nop
cmp $14846, %r10
lea addresses_WT_ht+0x30c8, %r10
nop
nop
nop
nop
...
nop
dec %rdi
lea addresses_normal_ht+0x1c680, %rsi
lea addresses_WT_ht+0x12048, %rdi
nop
nop
nop
nop
...
nop
dec %r10
lea addresses_WC_ht+0x16918, %r12
nop
inc %rdi
...
nop
and %rax, %rax
lea addresses_WT_ht+0x13d18, %rdx
nop
nop
and %rsi, %rsi
...
nop
inc %rdx
lea addresses_WT_ht+0x3318, %r10
nop
nop
nop
nop
