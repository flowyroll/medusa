...
push %rdi
push %rsi
lea addresses_UC_ht+0xd4bf, %r10
nop
cmp $19128, %r9
...
nop
inc %r13
lea addresses_D_ht+0x54c7, %rsi
lea addresses_WC_ht+0xa08b, %rdi
nop
nop
nop
nop
...
nop
xor %rdi, %rdi
lea addresses_UC_ht+0x17447, %rsi
lea addresses_D_ht+0x1647, %rdi
clflush (%rsi)
nop
nop
nop
...
nop
and %r10, %r10
lea addresses_WC_ht+0x11167, %rsi
lea addresses_A_ht+0x17627, %rdi
clflush (%rdi)
nop
cmp %r12, %r12
mov $66, %rcx
...
nop
sub $47874, %r12
lea addresses_WC_ht+0xe947, %rcx
nop
and $63656, %rsi
...
nop
add $46183, %rdi
lea addresses_normal_ht+0x124ef, %r9
clflush (%r9)
nop
nop
dec %rcx
...
nop
inc %r13
lea addresses_WC_ht+0x9147, %rcx
add $64975, %r12
movl $0x61626364, (%rcx)
nop
nop
nop
add $35131, %rbx
lea addresses_D_ht+0x1b31e, %r13
nop
dec %r9
mov (%r13), %cx
and $61819, %rcx
lea addresses_UC_ht+0xca47, %rdi
nop
nop
nop
sub %r12, %r12
...
{'OP': 'REPM', 'src': {'type': 'addresses_D_ht', 'congruent': 5, 'same': True}, 'dst': {'type': 'addresses_WC_ht', 'congruent': 1, 'same': False}}
...
{'OP': 'STOR', 'dst': {'type': 'addresses_WC_ht', 'AVXalign': False, 'congruent': 7, 'size': 4, 'same': False, 'NT': True}}
