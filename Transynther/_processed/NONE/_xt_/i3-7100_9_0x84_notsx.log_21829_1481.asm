...
nop
cmp %r9, %r9
lea addresses_normal_ht+0x1acb9, %rsi
lea addresses_normal_ht+0x57ad, %rdi
nop
nop
nop
nop
...
nop
and %rbp, %rbp
lea addresses_A_ht+0x141d9, %rsi
lea addresses_WC_ht+0x11ec9, %rdi
clflush (%rdi)
nop
mfence
mov $79, %rcx
...
nop
add %rsi, %rsi
lea addresses_WT_ht+0xb059, %r11
nop
nop
xor $65048, %rdi
movb (%r11), %r9b
sub %r11, %r11
lea addresses_D_ht+0x90d9, %r11
clflush (%r11)
nop
sub $37708, %rdx
mov (%r11), %cx
...
nop
dec %r11
lea addresses_normal_ht+0x543a, %rsi
lea addresses_A_ht+0x11561, %rdi
nop
nop
nop
nop
...
// REPMOV
lea addresses_UC+0x54d9, %rsi
lea addresses_A+0x9633, %rdi
nop
nop
nop
nop
...
{'src': {'type': 'addresses_UC', 'congruent': 9, 'same': False}, 'dst': {'type': 'addresses_A', 'congruent': 0, 'same': False}, 'OP': 'REPM'}
...
{'src': {'type': 'addresses_normal_ht', 'congruent': 0, 'same': True}, 'dst': {'type': 'addresses_A_ht', 'congruent': 1, 'same': False}, 'OP': 'REPM'}
