...
nop
sub $6994, %r8
lea addresses_WT_ht+0x2f5b, %rsi
lea addresses_normal_ht+0x1eb9b, %rdi
clflush (%rsi)
nop
nop
add %r9, %r9
...
nop
sub %r15, %r15
lea addresses_UC_ht+0xdb91, %rsi
lea addresses_WC_ht+0x1619b, %rdi
and $23345, %r10
mov $52, %rcx
rep movsq
xor $6125, %rdx
lea addresses_UC_ht+0x1dd9b, %rdx
nop
inc %r9
mov (%rdx), %r15
nop
...
nop
cmp %r15, %r15
lea addresses_normal_ht+0x1719b, %rsi
lea addresses_A_ht+0x1259b, %rdi
cmp $42327, %r9
mov $126, %rcx
rep movsb
nop
...
nop
sub $3783, %r8
lea addresses_UC_ht+0x1171b, %r8
nop
nop
nop
nop
...
{'src': {'NT': True, 'AVXalign': False, 'size': 1, 'congruent': 4, 'same': False, 'type': 'addresses_WT_ht'}, 'OP': 'LOAD'}
...
{'src': {'NT': True, 'AVXalign': False, 'size': 8, 'congruent': 7, 'same': False, 'type': 'addresses_UC_ht'}, 'OP': 'LOAD'}
