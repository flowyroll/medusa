...
nop
sub %rsi, %rsi
lea addresses_WC_ht+0x1b7a3, %r9
nop
nop
nop
and $24074, %rsi
...
nop
add $6156, %rdx
lea addresses_A_ht+0x1ee13, %r12
nop
nop
nop
nop
...
nop
and %rcx, %rcx
lea addresses_WC_ht+0x1eb03, %rsi
...
nop
cmp %r9, %r9
lea addresses_WT_ht+0x15813, %r10
nop
add %rdx, %rdx
mov (%r10), %ecx
cmp $1063, %r12
lea addresses_D_ht+0x16013, %rsi
lea addresses_normal_ht+0x4813, %rdi
nop
nop
nop
nop
...
nop
add %r9, %r9
lea addresses_WT_ht+0x196ea, %r10
nop
nop
dec %r9
movw $0x6162, (%r10)
...
nop
add %r9, %r9
lea addresses_WC_ht+0x12dfb, %r9
nop
cmp $11602, %r14
mov (%r9), %rdx
nop
...
nop
lfence
lea addresses_UC_ht+0xf013, %r14
nop
nop
xor $9585, %rsi
movb $0x61, (%r14)
sub $63795, %rdi
lea addresses_D_ht+0x19d13, %r12
nop
nop
cmp %r9, %r9
movl $0x61626364, (%r12)
nop
add $50845, %r14
lea addresses_normal_ht+0x4213, %rsi
lea addresses_WT_ht+0xbe13, %rdi
nop
dec %r10
mov $22, %rcx
rep movsq
...
nop
cmp %r10, %r10
lea addresses_WT_ht+0x14c4b, %rsi
nop
nop
nop
nop
