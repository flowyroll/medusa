...
nop
cmp %r10, %r10
lea addresses_D_ht+0x1ac41, %rdi
nop
inc %rcx
mov (%rdi), %r13w
nop
...
nop
inc %r9
lea addresses_WC_ht+0x18b41, %rsi
lea addresses_UC_ht+0x13071, %rdi
nop
nop
nop
nop
...
rep movsq
add %r11, %r11
lea addresses_WT_ht+0x13dc1, %rax
nop
nop
nop
nop
...
nop
add %r11, %r11
lea addresses_UC_ht+0x6c41, %rsi
lea addresses_normal_ht+0x117c1, %rdi
add %r10, %r10
mov $111, %rcx
rep movsw
cmp $65437, %rcx
lea addresses_WT_ht+0x81, %rcx
nop
nop
nop
nop
...
movb $0x61, (%rcx)
and %r13, %r13
lea addresses_WC_ht+0x1221d, %rsi
lea addresses_A_ht+0x17ea1, %rdi
nop
add $53765, %r9
mov $33, %rcx
rep movsl
...
{'src': {'type': 'addresses_WC_ht', 'congruent': 7, 'same': False}, 'dst': {'type': 'addresses_UC_ht', 'congruent': 4, 'same': False}, 'OP': 'REPM'}
