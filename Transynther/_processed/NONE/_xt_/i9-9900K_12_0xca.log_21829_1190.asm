...
push %rdi
push %rsi
lea addresses_WC_ht+0x107ec, %rbx
nop
add %rcx, %rcx
mov (%rbx), %rbp
nop
sub %r11, %r11
lea addresses_normal_ht+0x129cc, %rcx
nop
nop
nop
nop
...
nop
add %r13, %r13
lea addresses_D_ht+0xe1cc, %rsi
lea addresses_UC_ht+0x5d8c, %rdi
nop
nop
nop
nop
...
nop
xor %rbx, %rbx
lea addresses_normal_ht+0x7fc, %rcx
nop
nop
nop
nop
...
// Faulty Load
lea addresses_normal+0x1cdcc, %r12
cmp $33103, %r11
movups (%r12), %xmm4
vpextrq $1, %xmm4, %rsi
lea oracles, %r13
...
{'OP': 'STOR', 'dst': {'size': 4, 'NT': False, 'type': 'addresses_normal_ht', 'same': False, 'AVXalign': True, 'congruent': 10}}
...
{'OP': 'REPM', 'src': {'same': False, 'type': 'addresses_D_ht', 'congruent': 7}, 'dst': {'same': False, 'type': 'addresses_UC_ht', 'congruent': 5}}
