...
nop
add %r14, %r14
lea addresses_normal_ht+0x17d59, %rcx
nop
nop
sub %rdx, %rdx
movb (%rcx), %r10b
...
// Store
lea addresses_normal+0x18b91, %r8
nop
add $19005, %rsi
movb $0x51, (%r8)
add $60629, %r14
...
// Faulty Load
lea addresses_normal+0xf159, %r14
nop
nop
nop
nop
...
{'src': {'NT': False, 'AVXalign': False, 'size': 2, 'congruent': 5, 'same': False, 'type': 'addresses_WT'}, 'OP': 'LOAD'}
[Faulty Load]
