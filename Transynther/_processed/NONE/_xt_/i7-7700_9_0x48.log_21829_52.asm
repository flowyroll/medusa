...
push %rdi
push %rsi
lea addresses_WT_ht+0xe2de, %rsi
lea addresses_A_ht+0x71e, %rdi
cmp $36507, %r13
mov $108, %rcx
rep movsw
nop
mfence
lea addresses_D_ht+0x1335e, %r9
and $31289, %r11
mov (%r9), %r14
nop
nop
...
nop
sub %r9, %r9
lea addresses_WC_ht+0xeb5e, %r14
nop
nop
nop
nop
...
nop
xor %rdi, %rdi
lea addresses_WT_ht+0x1015e, %r13
nop
nop
xor %rdi, %rdi
movb (%r13), %cl
...
nop
and %rdi, %rdi
lea addresses_WC_ht+0x1375e, %rsi
lea addresses_A_ht+0x1167f, %rdi
nop
dec %r12
mov $0, %rcx
rep movsw
...
nop
and %r12, %r12
lea addresses_UC_ht+0xa85e, %r12
nop
cmp $10941, %r14
movb $0x61, (%r12)
nop
...
// Faulty Load
lea addresses_normal+0x17b5e, %rax
nop
nop
and %rbp, %rbp
mov (%rax), %rbx
