...
push %rdx
push %rsi
lea addresses_WT_ht+0x1335c, %r14
nop
and %r12, %r12
mov (%r14), %r13w
nop
nop
cmp $31986, %r12
lea addresses_A_ht+0xd33c, %rsi
lea addresses_WT_ht+0x97e2, %rdi
nop
add %r14, %r14
mov $111, %rcx
rep movsb
...
lea addresses_UC_ht+0x10162, %rdi
dec %r13
mov $21, %rcx
rep movsw
nop
...
nop
sub $500, %rcx
lea addresses_UC_ht+0x741c, %rsi
...
rep movsq
dec %r14
lea addresses_UC_ht+0xbd7c, %r14
nop
nop
nop
nop
...
lea addresses_WC_ht+0xcd64, %rdi
add %r10, %r10
mov $81, %rcx
rep movsw
cmp %r10, %r10
lea addresses_D_ht+0xa35c, %r10
nop
nop
nop
nop
...
nop
inc %rdi
lea addresses_WC_ht+0xf95c, %r12
nop
nop
nop
add %rsi, %rsi
...
// Faulty Load
lea addresses_normal+0xd35c, %rdi
nop
nop
nop
nop
...
{'OP': 'REPM', 'src': {'type': 'addresses_A_ht', 'congruent': 1, 'same': False}, 'dst': {'type': 'addresses_WT_ht', 'congruent': 0, 'same': False}}
