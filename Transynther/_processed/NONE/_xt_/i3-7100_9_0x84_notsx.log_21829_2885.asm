...
push %rdx
push %rsi
lea addresses_WT_ht+0x1c926, %rbx
nop
add $23882, %r12
...
nop
and %rax, %rax
lea addresses_A_ht+0x114aa, %rbp
nop
nop
sub $8151, %rdx
movb (%rbp), %r14b
nop
dec %r12
lea addresses_UC_ht+0xcfaa, %rax
nop
and $18797, %rsi
movb $0x61, (%rax)
nop
...
nop
sub %rbp, %rbp
lea addresses_normal_ht+0x127aa, %rbx
add %rbp, %rbp
movl $0x61626364, (%rbx)
nop
nop
nop
add $23326, %rax
lea addresses_UC_ht+0xefaa, %rsi
...
nop
sub $62707, %r14
lea addresses_D_ht+0x1a7aa, %rax
nop
nop
cmp %rcx, %rcx
mov (%rax), %edi
...
nop
dec %rbx
lea addresses_UC_ht+0x15df2, %rbx
nop
sub $11260, %rbp
movw $0x6162, (%rbx)
nop
...
nop
add $38130, %rbx
lea addresses_D_ht+0x1aa32, %rdi
nop
nop
nop
nop
...
// Store
lea addresses_RW+0xdeaa, %rcx
and %rdi, %rdi
movb $0x51, (%rcx)
and $64511, %rcx

// Store
lea addresses_RW+0x165aa, %r14
nop
cmp %r13, %r13
...
// Store
lea addresses_normal+0x1372a, %r13
nop
nop
nop
cmp %rsi, %rsi
...
// Faulty Load
lea addresses_normal+0x6faa, %rax
nop
nop
nop
add $20, %rsi
...
{'dst': {'type': 'addresses_RW', 'same': False, 'size': 1, 'congruent': 0, 'NT': True, 'AVXalign': False}, 'OP': 'STOR'}
...
{'dst': {'type': 'addresses_normal_ht', 'same': False, 'size': 4, 'congruent': 11, 'NT': True, 'AVXalign': False}, 'OP': 'STOR'}
