...
push %rdi
push %rdx
lea addresses_WT_ht+0x3ce4, %rcx
nop
nop
sub %rdi, %rdi
...
nop
and $27682, %r13
lea addresses_UC_ht+0x8464, %r13
add %r14, %r14
mov (%r13), %r12w
nop
nop
...
nop
add $64731, %r14
lea addresses_UC_ht+0x1c53a, %rcx
nop
and %rdi, %rdi
...
nop
add %rdi, %rdi
lea addresses_WC_ht+0xdcb7, %r10
clflush (%r10)
nop
nop
dec %r14
...
vpextrq $0, %xmm5, %r13
cmp $50144, %r10
lea addresses_WT_ht+0x8064, %r12
xor %r13, %r13
movw $0x6162, (%r12)
nop
nop
...
// Faulty Load
lea addresses_normal+0x19064, %r14
sub $50818, %rcx
movups (%r14), %xmm2
vpextrq $1, %xmm2, %r13
lea oracles, %r10
...
{'OP': 'LOAD', 'src': {'type': 'addresses_WC', 'AVXalign': False, 'congruent': 8, 'size': 2, 'same': False, 'NT': False}}
[Faulty Load]
{'OP': 'LOAD', 'src': {'type': 'addresses_normal', 'AVXalign': False, 'congruent': 0, 'size': 16, 'same': True, 'NT': False}}
<gen_prepare_buffer>
{'OP': 'LOAD', 'src': {'type': 'addresses_WT_ht', 'AVXalign': False, 'congruent': 7, 'size': 16, 'same': True, 'NT': True}}
