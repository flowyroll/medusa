...
push %rdi
push %rsi
lea addresses_normal_ht+0xe8e5, %rsi
lea addresses_UC_ht+0x16045, %rdi
nop
cmp %r13, %r13
mov $105, %rcx
rep movsb
...
nop
dec %rcx
lea addresses_normal_ht+0x15f19, %r8
clflush (%r8)
nop
nop
nop
...
nop
dec %r8
lea addresses_D_ht+0x18ae5, %rcx
sub %r13, %r13
movb $0x61, (%rcx)
and $64069, %rcx
lea addresses_WT_ht+0xc0e5, %r13
nop
nop
add %rdi, %rdi
movl $0x61626364, (%r13)
...
nop
cmp %r15, %r15
lea addresses_normal_ht+0x12665, %rsi
lea addresses_WC_ht+0x1edad, %rdi
nop
sub $55114, %r13
mov $29, %rcx
rep movsw
...
nop
sub $9816, %r13
lea addresses_UC_ht+0x145e9, %rsi
lea addresses_D_ht+0xc7c0, %rdi
nop
nop
nop
nop
...
nop
sub $44267, %r15
lea addresses_WT_ht+0x74e5, %rcx
nop
nop
add %r14, %r14
movw $0x6162, (%rcx)
nop
dec %r15
lea addresses_normal_ht+0x18985, %r8
nop
nop
nop
nop
...
nop
cmp $4936, %r9
lea addresses_WC_ht+0xe4e5, %rsi
lea addresses_normal_ht+0x6ce5, %rdi
clflush (%rsi)
nop
nop
cmp %r8, %r8
...
nop
xor $41862, %rdi
lea addresses_UC_ht+0x150e5, %r14
nop
xor $13804, %r9
movb $0x61, (%r14)
nop
...
nop
cmp $8678, %r15
lea addresses_normal_ht+0x4ce5, %r9
nop
nop
nop
nop
...
{'OP': 'REPM', 'src': {'type': 'addresses_normal_ht', 'congruent': 6, 'same': True}, 'dst': {'type': 'addresses_WC_ht', 'congruent': 2, 'same': False}}
...
{'OP': 'REPM', 'src': {'type': 'addresses_WC_ht', 'congruent': 11, 'same': False}, 'dst': {'type': 'addresses_normal_ht', 'congruent': 11, 'same': False}}
