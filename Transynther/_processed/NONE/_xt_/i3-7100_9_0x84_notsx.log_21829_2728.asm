...
nop
xor %r11, %r11
lea addresses_WT_ht+0x10088, %rdx
nop
nop
cmp %r13, %r13
mov (%rdx), %r10
...
nop
cmp %rdi, %rdi
lea addresses_UC_ht+0x3238, %rsi
lea addresses_A_ht+0x1ecf4, %rdi
nop
add %r11, %r11
mov $104, %rcx
rep movsw
cmp $23603, %r13
lea addresses_normal_ht+0x130a8, %rdi
nop
nop
nop
nop
...
nop
cmp %rsi, %rsi
lea addresses_D_ht+0x19ca8, %r13
nop
sub %r14, %r14
movl $0x61626364, (%r13)
nop
nop
and $38261, %rdx
lea addresses_normal_ht+0x19488, %rsi
lea addresses_normal_ht+0xbf1b, %rdi
add $40180, %r14
mov $29, %rcx
rep movsw
nop
...
// Store
lea addresses_normal+0x195a8, %rbp
nop
nop
nop
nop
...
<gen_prepare_buffer>
{'dst': {'type': 'addresses_A_ht', 'same': False, 'size': 1, 'congruent': 0, 'NT': True, 'AVXalign': False}, 'OP': 'STOR'}
...
{'dst': {'type': 'addresses_normal_ht', 'same': False, 'size': 4, 'congruent': 6, 'NT': False, 'AVXalign': True}, 'OP': 'STOR'}
