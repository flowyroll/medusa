...
nop
sub %r15, %r15
lea addresses_WT_ht+0x116d, %r12
nop
nop
nop
nop
...
nop
xor %rdi, %rdi
lea addresses_D_ht+0xde3d, %r15
and %r14, %r14
movw $0x6162, (%r15)
nop
cmp %r10, %r10
lea addresses_A_ht+0xba3d, %r14
nop
nop
nop
nop
...
nop
cmp $16233, %rdi
lea addresses_A_ht+0x1731d, %r12
clflush (%r12)
nop
nop
nop
...
// Faulty Load
lea addresses_normal+0x18e3d, %r10
nop
nop
nop
and $34795, %r8
...
{'dst': {'same': False, 'NT': False, 'AVXalign': False, 'size': 1, 'type': 'addresses_A', 'congruent': 3}, 'OP': 'STOR'}
{'OP': 'LOAD', 'src': {'same': False, 'NT': False, 'AVXalign': False, 'size': 4, 'type': 'addresses_US', 'congruent': 2}}
{'dst': {'same': False, 'NT': True, 'AVXalign': False, 'size': 4, 'type': 'addresses_P', 'congruent': 11}, 'OP': 'STOR'}
[Faulty Load]
...
{'OP': 'LOAD', 'src': {'same': True, 'NT': False, 'AVXalign': False, 'size': 2, 'type': 'addresses_WT_ht', 'congruent': 4}}
