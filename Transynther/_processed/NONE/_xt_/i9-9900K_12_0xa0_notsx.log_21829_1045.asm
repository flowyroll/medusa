...
push %rbx
push %rsi
lea addresses_normal_ht+0x1c15b, %r8
nop
nop
nop
nop
...
// Store
lea addresses_normal+0x1ef5b, %r8
nop
nop
nop
sub %r9, %r9
...
// Store
lea addresses_normal+0x1b33, %r13
nop
nop
xor $60047, %rdx
mov $0x5152535455565758, %r9
...
{'src': {'type': 'addresses_WT', 'AVXalign': True, 'size': 1, 'NT': False, 'same': False, 'congruent': 7}, 'OP': 'LOAD'}
...
{'OP': 'STOR', 'dst': {'type': 'addresses_US', 'AVXalign': False, 'size': 1, 'NT': False, 'same': False, 'congruent': 8}}
[Faulty Load]
