...
push %rdi
push %rsi
lea addresses_UC_ht+0xfb5a, %rsi
lea addresses_normal_ht+0x17bf6, %rdi
nop
inc %r13
mov $74, %rcx
rep movsl
...
nop
and $17508, %r15
lea addresses_UC_ht+0x12c5a, %rsi
lea addresses_D_ht+0xa8da, %rdi
nop
nop
nop
nop
...
nop
and $7673, %rdi
lea addresses_WC_ht+0xcc5a, %r13
nop
nop
nop
nop
...
nop
add $18366, %r10
lea addresses_UC_ht+0x14f5a, %rdi
nop
nop
nop
and %r14, %r14
...
nop
cmp %rdi, %rdi
lea addresses_A_ht+0x1a09a, %rdi
nop
nop
nop
nop
...
nop
dec %r15
lea addresses_WT_ht+0x1a8da, %rdi
clflush (%rdi)
nop
nop
nop
...
<gen_prepare_buffer>
{'src': {'congruent': 7, 'same': True, 'type': 'addresses_UC_ht'}, 'OP': 'REPM', 'dst': {'congruent': 1, 'same': False, 'type': 'addresses_normal_ht'}}
{'src': {'congruent': 11, 'same': False, 'type': 'addresses_UC_ht'}, 'OP': 'REPM', 'dst': {'congruent': 7, 'same': False, 'type': 'addresses_D_ht'}}
