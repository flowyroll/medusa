...
nop
dec %rcx
lea addresses_WC_ht+0xdec2, %r14
nop
nop
nop
xor %r12, %r12
...
nop
sub $9237, %r12
lea addresses_normal_ht+0x15fa2, %rdi
nop
nop
nop
nop
...
nop
cmp $1582, %r9
lea addresses_D_ht+0x1c3d2, %rsi
lea addresses_UC_ht+0x1a9a2, %rdi
clflush (%rdi)
nop
nop
nop
...
nop
add $24404, %rcx
lea addresses_D_ht+0x13422, %r15
nop
nop
sub $48092, %r9
...
nop
sub $4869, %rcx
lea addresses_WC_ht+0x19152, %rsi
inc %r12
...
nop
cmp %rcx, %rcx
lea addresses_A_ht+0x1322, %rsi
lea addresses_normal_ht+0xcb22, %rdi
nop
xor $8104, %r11
mov $4, %rcx
rep movsq
...
nop
xor %r15, %r15
lea addresses_WC_ht+0xc3c2, %r15
and %r12, %r12
mov (%r15), %si
nop
and $32802, %r14
lea addresses_D_ht+0x1b9a2, %r14
nop
xor $9053, %r15
mov (%r14), %r12
cmp %rcx, %rcx
lea addresses_WC_ht+0x109a2, %rcx
nop
nop
nop
nop
...
{'OP': 'LOAD', 'src': {'same': False, 'NT': False, 'AVXalign': False, 'size': 4, 'type': 'addresses_RW', 'congruent': 9}}
{'dst': {'same': False, 'NT': False, 'AVXalign': True, 'size': 1, 'type': 'addresses_PSE', 'congruent': 4}, 'OP': 'STOR'}
[Faulty Load]
...
{'dst': {'same': False, 'congruent': 7, 'type': 'addresses_WC_ht'}, 'OP': 'REPM', 'src': {'same': False, 'congruent': 3, 'type': 'addresses_WT_ht'}}
...
{'dst': {'same': False, 'congruent': 8, 'type': 'addresses_UC_ht'}, 'OP': 'REPM', 'src': {'same': False, 'congruent': 0, 'type': 'addresses_D_ht'}}
...
{'dst': {'same': False, 'congruent': 1, 'type': 'addresses_normal_ht'}, 'OP': 'REPM', 'src': {'same': False, 'congruent': 6, 'type': 'addresses_A_ht'}}
