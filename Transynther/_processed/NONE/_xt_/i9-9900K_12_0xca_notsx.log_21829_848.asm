...
push %rdx
push %rsi
lea addresses_UC_ht+0x8fdb, %r14
nop
xor $15093, %r12
vmovups (%r14), %ymm6
...
nop
xor %r15, %r15
lea addresses_normal_ht+0x1de3b, %r14
cmp $12059, %rdx
movb $0x61, (%r14)
nop
cmp $660, %rsi
lea addresses_A_ht+0x15d1b, %rsi
...
nop
and $60352, %r15
lea addresses_WT_ht+0x115b, %r14
nop
nop
nop
dec %r15
...
nop
dec %rdi
lea addresses_WC_ht+0xc1a5, %rsi
lea addresses_WC_ht+0x1379b, %rdi
nop
nop
nop
nop
...
nop
add %rsi, %rsi
lea addresses_D_ht+0x669b, %r14
nop
nop
xor %rbx, %rbx
mov (%r14), %dx
xor %rdi, %rdi
lea addresses_WT_ht+0x18793, %rbx
nop
cmp %rdx, %rdx
movw $0x6162, (%rbx)
nop
...
nop
sub $50835, %r15
lea addresses_UC_ht+0x4a5b, %rsi
lea addresses_UC_ht+0xce9b, %rdi
nop
nop
cmp $63620, %rbx
mov $31, %rcx
...
{'OP': 'LOAD', 'src': {'same': False, 'type': 'addresses_D_ht', 'NT': True, 'AVXalign': True, 'size': 4, 'congruent': 3}}
{'OP': 'STOR', 'dst': {'same': True, 'type': 'addresses_normal_ht', 'NT': True, 'AVXalign': False, 'size': 1, 'congruent': 4}}
{'OP': 'REPM', 'src': {'same': False, 'congruent': 4, 'type': 'addresses_A_ht'}, 'dst': {'same': False, 'congruent': 11, 'type': 'addresses_WC_ht'}}
{'OP': 'STOR', 'dst': {'same': False, 'type': 'addresses_WT_ht', 'NT': False, 'AVXalign': False, 'size': 1, 'congruent': 1}}
{'OP': 'REPM', 'src': {'same': False, 'congruent': 0, 'type': 'addresses_WC_ht'}, 'dst': {'same': False, 'congruent': 7, 'type': 'addresses_WC_ht'}}
