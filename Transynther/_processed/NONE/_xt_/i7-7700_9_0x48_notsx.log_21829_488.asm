...
push %rdx
push %rsi
lea addresses_UC_ht+0x13fe, %rbx
nop
inc %rcx
movb (%rbx), %r15b
nop
add %r15, %r15
lea addresses_WT_ht+0x4b3, %r10
nop
nop
nop
nop
...
nop
cmp %rcx, %rcx
lea addresses_UC_ht+0x1257b, %r15
nop
nop
add %rdx, %rdx
movl $0x61626364, (%r15)
...
nop
add %rdx, %rdx
lea addresses_UC_ht+0x7fb3, %rcx
nop
nop
nop
xor %rdx, %rdx
...
nop
dec %rbx
lea addresses_WC_ht+0x1d103, %rsi
lea addresses_UC_ht+0x1d7b3, %rdi
nop
nop
nop
nop
...
rep movsq
dec %rsi
lea addresses_normal_ht+0x1d6c5, %r15
nop
nop
nop
xor $55543, %rdi
...
nop
xor $14201, %r11
lea addresses_WT_ht+0xafb3, %rsi
lea addresses_normal_ht+0x1353b, %rdi
nop
nop
nop
nop
...
nop
lfence
lea addresses_WT_ht+0xf56f, %rdx
nop
nop
nop
cmp %rsi, %rsi
...
nop
and %r15, %r15
lea addresses_normal_ht+0xed33, %rdx
inc %r15
movl $0x61626364, (%rdx)
sub %rax, %rax
lea addresses_WC_ht+0xb7b3, %rax
nop
nop
add $46915, %r10
movl $0x61626364, (%rax)
...
{'dst': {'same': False, 'congruent': 3, 'type': 'addresses_normal_ht'}, 'OP': 'REPM', 'src': {'same': False, 'congruent': 10, 'type': 'addresses_WT_ht'}}
