...
nop
add $30991, %rax
lea addresses_A_ht+0x1c86f, %rsi
lea addresses_WT_ht+0xf664, %rdi
cmp $4458, %r14
mov $96, %rcx
rep movsw
nop
...
movl $0x61626364, (%r14)
xor $8653, %r14
lea addresses_UC_ht+0x100c, %rsi
inc %rdi
mov (%rsi), %r14
nop
nop
...
nop
and $56329, %r14
lea addresses_normal_ht+0xc664, %rsi
lea addresses_A_ht+0x523e, %rdi
inc %r11
mov $19, %rcx
rep movsw
inc %rsi
lea addresses_normal_ht+0xad58, %rsi
lea addresses_WC_ht+0x199a4, %rdi
inc %r12
mov $88, %rcx
rep movsl
nop
...
nop
add $26881, %r12
lea addresses_A_ht+0x1ab66, %rsi
lea addresses_normal_ht+0x11ff8, %rdi
nop
nop
nop
nop
...
nop
inc %r11
lea addresses_WT_ht+0x13164, %rcx
nop
nop
xor $13626, %r11
movb (%rcx), %al
...
{'OP': 'REPM', 'src': {'same': False, 'type': 'addresses_A_ht', 'congruent': 0}, 'dst': {'same': False, 'type': 'addresses_WT_ht', 'congruent': 2}}
...
{'OP': 'REPM', 'src': {'same': False, 'type': 'addresses_normal_ht', 'congruent': 2}, 'dst': {'same': False, 'type': 'addresses_WC_ht', 'congruent': 4}}
