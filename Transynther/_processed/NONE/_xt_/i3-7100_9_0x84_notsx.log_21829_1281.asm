...
push %rdi
push %rsi
lea addresses_UC_ht+0x16007, %r14
clflush (%r14)
nop
nop
nop
...
vmovaps %ymm5, (%rbp)
sub $802, %r13
lea addresses_UC_ht+0x1e95f, %rdi
clflush (%rdi)
nop
nop
nop
...
vmovups %ymm0, (%rdi)
inc %r14
lea addresses_A_ht+0x1aec7, %rdi
nop
nop
nop
nop
...
// Load
lea addresses_normal+0x5c07, %r15
nop
nop
nop
sub $60964, %rdx
