...
push %rbx
push %rsi
lea addresses_WT_ht+0x6ff7, %rbx
add $59126, %rsi
movl $0x61626364, (%rbx)
nop
cmp %r8, %r8
lea addresses_normal_ht+0x3384, %r13
nop
nop
nop
nop
...
nop
and %r13, %r13
lea addresses_normal_ht+0x8434, %rax
xor $39701, %r12
movb (%rax), %r13b
nop
nop
...
<gen_prepare_buffer>
{'OP': 'STOR', 'dst': {'same': True, 'type': 'addresses_WT_ht', 'NT': False, 'AVXalign': False, 'size': 4, 'congruent': 0}}
