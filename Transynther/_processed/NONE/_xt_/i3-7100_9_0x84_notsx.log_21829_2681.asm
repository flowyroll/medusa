...
push %rdi
push %rsi
lea addresses_UC_ht+0x1101, %r11
nop
nop
nop
nop
...
nop
xor %r11, %r11
lea addresses_UC_ht+0xf69f, %r12
nop
nop
add $64384, %rbx
vmovups (%r12), %ymm7
...
nop
xor %r15, %r15
lea addresses_normal_ht+0x15c0f, %rbx
nop
inc %rax
movw $0x6162, (%rbx)
nop
nop
cmp %r12, %r12
lea addresses_UC_ht+0x18d9f, %rbx
xor %r13, %r13
movb (%rbx), %r12b
nop
nop
nop
mfence
lea addresses_UC_ht+0x9e73, %rsi
lea addresses_WC_ht+0xde9f, %rdi
nop
nop
nop
nop
...
nop
cmp %rsi, %rsi
lea addresses_D_ht+0xfe9f, %r14
and %r15, %r15
movb $0x61, (%r14)
xor $3817, %r11
lea addresses_normal_ht+0x1559f, %r14
nop
nop
nop
nop
...
nop
add %r14, %r14
lea addresses_WC_ht+0x17e9f, %rsi
lea addresses_A_ht+0xcd7f, %rdi
nop
nop
nop
sub %r13, %r13
...
// Store
lea addresses_normal+0x1d89f, %r15
nop
nop
nop
nop
...
// Faulty Load
lea addresses_normal+0x17e9f, %r15
clflush (%r15)
xor $54102, %rdx
mov (%r15), %r9
lea oracles, %r11
...
{'src': {'type': 'addresses_WC_ht', 'congruent': 10, 'same': False}, 'dst': {'type': 'addresses_A_ht', 'congruent': 5, 'same': False}, 'OP': 'REPM'}
{'34': 21829}
