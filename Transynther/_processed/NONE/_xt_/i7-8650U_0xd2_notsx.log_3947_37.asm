...
push %rdi
push %rsi
lea addresses_A_ht+0xeaaa, %rsi
lea addresses_WC_ht+0x10016, %rdi
clflush (%rsi)
nop
nop
nop
...
nop
add $39389, %rbp
lea addresses_A_ht+0x1bf12, %r14
nop
nop
cmp %rdi, %rdi
mov (%r14), %rcx
...
nop
add %rcx, %rcx
lea addresses_A_ht+0x13312, %r14
cmp $58140, %r13
vmovups (%r14), %ymm1
...
nop
cmp %rbp, %rbp
lea addresses_WT_ht+0x1ba12, %r15
nop
nop
nop
nop
...
nop
and $3575, %rsi
lea addresses_D_ht+0x812, %rsi
lea addresses_WT_ht+0x15a96, %rdi
clflush (%rdi)
dec %r8
mov $70, %rcx
rep movsw
cmp %r13, %r13
lea addresses_WC_ht+0x4312, %r15
nop
nop
nop
inc %rcx
...
nop
lfence
lea addresses_WC_ht+0xf1b2, %r14
nop
sub $33577, %rcx
...
movq %rbp, (%r14)
inc %rdi
lea addresses_WC_ht+0x1e9ca, %r14
nop
nop
nop
nop
...
nop
dec %r8
lea addresses_D_ht+0x14312, %r8
sub %rbp, %rbp
mov (%r8), %r13d
nop
nop
cmp %r13, %r13
lea addresses_normal_ht+0x192d1, %rsi
lea addresses_D_ht+0x2992, %rdi
inc %r13
mov $36, %rcx
rep movsw
nop
...
nop
dec %r13
lea addresses_normal_ht+0x153f2, %rsi
lea addresses_normal_ht+0x13f12, %rdi
nop
nop
nop
cmp %rbp, %rbp
...
// REPMOV
lea addresses_PSE+0x19912, %rsi
lea addresses_normal+0xa512, %rdi
nop
sub %r10, %r10
mov $109, %rcx
rep movsl
...
{'OP': 'STOR', 'dst': {'type': 'addresses_UC', 'size': 2, 'AVXalign': False, 'NT': True, 'congruent': 6, 'same': False}}
{'OP': 'REPM', 'src': {'type': 'addresses_PSE', 'congruent': 8, 'same': False}, 'dst': {'type': 'addresses_normal', 'congruent': 9, 'same': False}}
[Faulty Load]
