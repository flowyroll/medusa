...
push %rdi
push %rsi
lea addresses_UC_ht+0xb51d, %rsi
lea addresses_UC_ht+0x1cc79, %rdi
dec %r14
mov $93, %rcx
rep movsw
dec %r11
...
// Store
lea addresses_normal+0x1b279, %rcx
nop
nop
cmp %rdx, %rdx
movw $0x5152, (%rcx)
...
// Store
lea addresses_normal+0x158c1, %r14
nop
add %rax, %rax
mov $0x5152535455565758, %r9
movq %r9, (%r14)
...
{'OP': 'STOR', 'dst': {'type': 'addresses_normal', 'AVXalign': True, 'congruent': 9, 'size': 2, 'same': False, 'NT': False}}
...
{'OP': 'STOR', 'dst': {'type': 'addresses_normal', 'AVXalign': True, 'congruent': 3, 'size': 8, 'same': False, 'NT': False}}
[Faulty Load]
