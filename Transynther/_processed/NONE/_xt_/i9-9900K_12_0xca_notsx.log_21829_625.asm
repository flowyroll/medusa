...
push %rdi
push %rsi
lea addresses_UC_ht+0x1643b, %r10
nop
nop
and $23962, %r9
movw $0x6162, (%r10)
nop
add $18133, %r9
lea addresses_WT_ht+0x307b, %rsi
lea addresses_WT_ht+0x1327b, %rdi
nop
xor $27783, %r8
mov $64, %rcx
rep movsw
...
nop
inc %r9
lea addresses_normal_ht+0x2c7b, %r8
nop
inc %rcx
movb (%r8), %r15b
nop
add $22759, %r15
lea addresses_normal_ht+0x12dbb, %rcx
nop
nop
nop
nop
...
movq %r15, (%rcx)
xor %r15, %r15
lea addresses_WC_ht+0x17d7b, %rdi
nop
add %r10, %r10
movups (%rdi), %xmm2
vpextrq $1, %xmm2, %r15
...
nop
dec %r10
lea addresses_WT_ht+0x1b32f, %rsi
lea addresses_D_ht+0x1717b, %rdi
nop
nop
sub %r14, %r14
mov $74, %rcx
...
nop
cmp $14907, %r14
lea addresses_WC_ht+0x1c77b, %rsi
lea addresses_normal_ht+0x8f7f, %rdi
nop
nop
nop
nop
...
nop
sub $61160, %rdi
lea addresses_WT_ht+0x1b291, %r15
clflush (%r15)
nop
nop
nop
...
nop
xor %rdi, %rdi
lea addresses_WC_ht+0x1527b, %r9
nop
nop
nop
nop
...
nop
cmp %r9, %r9
lea addresses_normal_ht+0x17a7b, %r14
nop
xor %rcx, %rcx
movb $0x61, (%r14)
nop
nop
cmp %r14, %r14
lea addresses_UC_ht+0x1aa7b, %rsi
lea addresses_UC_ht+0x1c627, %rdi
nop
nop
nop
nop
...
{'OP': 'REPM', 'src': {'same': False, 'congruent': 9, 'type': 'addresses_UC_ht'}, 'dst': {'same': False, 'congruent': 0, 'type': 'addresses_UC_ht'}}
{'37': 21829}
