...
push %rdi
push %rsi
lea addresses_A_ht+0x1eda7, %rcx
add %rsi, %rsi
movb $0x61, (%rcx)
nop
nop
...
nop
add $40377, %rsi
lea addresses_WC_ht+0x15a47, %r10
sub %r8, %r8
movb (%r10), %r12b
sub %rcx, %rcx
lea addresses_D_ht+0x4417, %rsi
lea addresses_D_ht+0xbeff, %rdi
nop
nop
nop
nop
...
nop
xor $8021, %r13
lea addresses_WT_ht+0x19b47, %rdi
sub $19819, %r8
mov (%rdi), %r13
nop
nop
...
// Faulty Load
lea addresses_normal+0x1cf47, %r10
nop
add $53941, %r11
mov (%r10), %ax
lea oracles, %rbp
