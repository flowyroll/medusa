...
nop
and %r14, %r14
lea addresses_normal_ht+0xe1f9, %rsi
...
nop
and $13742, %rdi
lea addresses_normal_ht+0x158f3, %r15
nop
nop
xor %rdi, %rdi
...
nop
xor %rsi, %rsi
lea addresses_UC_ht+0x1ce93, %rsi
lea addresses_D_ht+0x108b3, %rdi
nop
nop
nop
dec %r14
...
nop
dec %r14
lea addresses_A_ht+0x18bd3, %rsi
lea addresses_D_ht+0xd193, %rdi
nop
nop
add %rbx, %rbx
mov $40, %rcx
...
nop
cmp $39004, %rsi
lea addresses_WT_ht+0x19d3b, %rdi
clflush (%rdi)
nop
cmp $36066, %r14
movups (%rdi), %xmm0
vpextrq $0, %xmm0, %rbp
and $20948, %r15
lea addresses_A_ht+0x1e453, %rsi
lea addresses_normal_ht+0x4633, %rdi
add $53917, %r14
mov $86, %rcx
rep movsq
nop
...
nop
sub %r15, %r15
lea addresses_D_ht+0x1b4f3, %rcx
inc %rbp
mov $0x6162636465666768, %r14
movq %r14, (%rcx)
nop
...
{'src': {'type': 'addresses_UC_ht', 'congruent': 4, 'same': False}, 'dst': {'type': 'addresses_D_ht', 'congruent': 3, 'same': False}, 'OP': 'REPM'}
{'src': {'type': 'addresses_A_ht', 'congruent': 4, 'same': True}, 'dst': {'type': 'addresses_D_ht', 'congruent': 7, 'same': False}, 'OP': 'REPM'}
{'src': {'type': 'addresses_WT_ht', 'same': True, 'size': 16, 'congruent': 3, 'NT': False, 'AVXalign': False}, 'OP': 'LOAD'}
{'src': {'type': 'addresses_A_ht', 'congruent': 6, 'same': False}, 'dst': {'type': 'addresses_normal_ht', 'congruent': 5, 'same': False}, 'OP': 'REPM'}
