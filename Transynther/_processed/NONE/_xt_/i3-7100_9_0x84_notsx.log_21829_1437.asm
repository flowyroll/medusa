...
lea addresses_WC_ht+0xd395, %rdi
nop
sub $8409, %r12
mov $15, %rcx
rep movsw
and $13745, %r12
lea addresses_WC_ht+0x1550b, %r12
nop
nop
nop
and $17490, %rax
...
nop
xor $59877, %rax
lea addresses_A_ht+0x1b12d, %rcx
nop
nop
nop
add $16189, %r12
...
<gen_prepare_buffer>
{'src': {'type': 'addresses_WT_ht', 'congruent': 7, 'same': False}, 'dst': {'type': 'addresses_D_ht', 'congruent': 9, 'same': False}, 'OP': 'REPM'}
{'src': {'type': 'addresses_WT_ht', 'congruent': 1, 'same': False}, 'dst': {'type': 'addresses_WC_ht', 'congruent': 11, 'same': False}, 'OP': 'REPM'}
