...
push %rdi
push %rsi
lea addresses_normal_ht+0x143c9, %rdi
nop
nop
nop
nop
...
nop
cmp $17772, %r14
lea addresses_D_ht+0xf149, %rsi
lea addresses_A_ht+0x1b49, %rdi
clflush (%rsi)
and %r9, %r9
mov $8, %rcx
rep movsb
...
// Store
lea addresses_normal+0x1f89, %rdi
nop
nop
nop
nop
...
// REPMOV
lea addresses_D+0x5549, %rsi
lea addresses_D+0x1097d, %rdi
nop
nop
nop
xor %r9, %r9
...
// Store
lea addresses_normal+0x1d49, %rbp
nop
nop
nop
nop
...
{'OP': 'STOR', 'dst': {'type': 'addresses_A', 'size': 2, 'AVXalign': False, 'NT': True, 'congruent': 9, 'same': False}}
{'OP': 'REPM', 'src': {'type': 'addresses_D', 'congruent': 0, 'same': True}, 'dst': {'type': 'addresses_D', 'congruent': 1, 'same': False}}
