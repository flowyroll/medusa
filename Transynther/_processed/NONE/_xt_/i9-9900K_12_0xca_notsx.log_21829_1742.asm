...
push %rdx
push %rsi
lea addresses_normal_ht+0x482e, %r8
nop
nop
dec %r15
mov (%r8), %rax
nop
xor %rcx, %rcx
lea addresses_normal_ht+0x182d6, %rsi
lea addresses_normal_ht+0x7bf6, %rdi
nop
nop
nop
nop
...
lea addresses_D_ht+0x1b28e, %rdi
nop
nop
xor $27476, %rdx
mov $120, %rcx
...
nop
dec %rsi
lea addresses_A_ht+0x1258e, %rsi
lea addresses_normal_ht+0x1ef52, %rdi
nop
nop
and $44329, %r15
mov $59, %rcx
...
nop
inc %rax
lea addresses_WT_ht+0x1770b, %rdx
inc %rbp
movb (%rdx), %r15b
nop
nop
nop
add $34328, %rbp
lea addresses_D_ht+0x1c84e, %rsi
lea addresses_UC_ht+0xd88e, %rdi
inc %rdx
mov $1, %rcx
rep movsw
nop
...
{'OP': 'REPM', 'src': {'same': False, 'congruent': 10, 'type': 'addresses_normal_ht'}, 'dst': {'same': False, 'congruent': 8, 'type': 'addresses_D_ht'}}
{'OP': 'REPM', 'src': {'same': False, 'congruent': 7, 'type': 'addresses_A_ht'}, 'dst': {'same': False, 'congruent': 1, 'type': 'addresses_normal_ht'}}
