...
push %rdi
push %rsi
lea addresses_normal_ht+0x13de6, %r12
nop
nop
and $61723, %rbp
movb $0x61, (%r12)
cmp $64861, %r10
lea addresses_WC_ht+0x56d6, %rsi
...
nop
sub $11745, %rsi
lea addresses_WC_ht+0x84a6, %rbp
add $62955, %r9
movb $0x61, (%rbp)
nop
nop
...
nop
inc %rsi
lea addresses_A_ht+0x2172, %rsi
lea addresses_WT_ht+0x15fd6, %rdi
clflush (%rdi)
nop
nop
nop
...
nop
xor %rsi, %rsi
lea addresses_WT_ht+0x6ed6, %r10
nop
nop
nop
nop
...
nop
add %r10, %r10
lea addresses_D_ht+0x15906, %rsi
cmp $49287, %r14
movups (%rsi), %xmm6
vpextrq $1, %xmm6, %rbp
nop
...
// Faulty Load
lea addresses_normal+0x4ed6, %r13
nop
nop
nop
nop
...
{'OP': 'LOAD', 'src': {'type': 'addresses_WT', 'AVXalign': False, 'congruent': 3, 'size': 16, 'same': False, 'NT': False}}
[Faulty Load]
