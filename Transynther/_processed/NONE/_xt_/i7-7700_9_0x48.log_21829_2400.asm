...
push %rdi
push %rsi
lea addresses_WT_ht+0x1849f, %rbp
nop
nop
nop
nop
...
movw $0x6162, (%rbp)
xor %r12, %r12
lea addresses_A_ht+0x1de0b, %rax
nop
nop
nop
nop
...
nop
sub %r12, %r12
lea addresses_WC_ht+0xcc9b, %rsi
...
rep movsw
xor %rbp, %rbp
lea addresses_normal_ht+0x18325, %rsi
lea addresses_D_ht+0x40b, %rdi
nop
nop
nop
and %rbp, %rbp
...
rep movsl
and $6412, %rbp
lea addresses_WC_ht+0x1ee6b, %rbp
nop
nop
nop
dec %rdi
...
{'OP': 'STOR', 'dst': {'type': 'addresses_PSE', 'AVXalign': False, 'congruent': 10, 'size': 8, 'same': False, 'NT': True}}
[Faulty Load]
