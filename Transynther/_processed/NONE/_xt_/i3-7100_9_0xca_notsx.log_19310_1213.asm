...
nop
add %rbx, %rbx
lea addresses_UC_ht+0x1ceb3, %r14
nop
nop
nop
nop
...
nop
and %rcx, %rcx
lea addresses_WT_ht+0xda0f, %rdx
clflush (%rdx)
nop
add %rdi, %rdi
...
{'src': {'type': 'addresses_P', 'congruent': 10, 'same': False}, 'OP': 'REPM', 'dst': {'type': 'addresses_WT', 'congruent': 2, 'same': False}}
...
{'src': {'same': False, 'congruent': 7, 'NT': False, 'type': 'addresses_RW', 'size': 2, 'AVXalign': True}, 'OP': 'LOAD'}
[Faulty Load]
