...
push %rdi
push %rsi
lea addresses_UC_ht+0x8b1a, %rsi
nop
nop
add $53835, %r11
movb $0x61, (%rsi)
...
nop
cmp $18844, %rax
lea addresses_UC_ht+0xb1da, %r13
nop
nop
inc %r8
...
nop
add %r8, %r8
lea addresses_normal_ht+0x42b4, %rsi
lea addresses_UC_ht+0x159ba, %rdi
nop
nop
mfence
mov $18, %rcx
...
nop
xor %r14, %r14
lea addresses_WT_ht+0x8bfa, %rsi
lea addresses_UC_ht+0xfdee, %rdi
xor %r13, %r13
mov $114, %rcx
rep movsq
nop
nop
inc %r14
lea addresses_D_ht+0xe032, %r13
sub %rsi, %rsi
movb $0x61, (%r13)
sub %rcx, %rcx
lea addresses_normal_ht+0x15eba, %rsi
inc %rcx
movb (%rsi), %r8b
add $13801, %rax
lea addresses_D_ht+0x141ba, %r11
nop
nop
nop
nop
...
nop
and $62964, %r14
lea addresses_WT_ht+0x5e2, %rsi
lea addresses_normal_ht+0xe4a, %rdi
nop
dec %r9
mov $2, %rcx
rep movsq
sub %r14, %r14
lea addresses_WC_ht+0x16c12, %rsi
lea addresses_A_ht+0x1d8c6, %rdi
nop
sub %r13, %r13
mov $99, %rcx
rep movsq
...
{'src': {'congruent': 6, 'same': False, 'type': 'addresses_WT_ht'}, 'OP': 'REPM', 'dst': {'congruent': 2, 'same': False, 'type': 'addresses_UC_ht'}}
...
{'src': {'congruent': 3, 'same': False, 'type': 'addresses_WC_ht'}, 'OP': 'REPM', 'dst': {'congruent': 2, 'same': False, 'type': 'addresses_A_ht'}}
{'36': 21829}
