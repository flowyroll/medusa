...
push %rbx
push %rdi
lea addresses_normal_ht+0x1b120, %r9
nop
nop
cmp %r11, %r11
vmovups (%r9), %ymm6
...
// Load
lea addresses_normal+0xc920, %rdi
nop
nop
and $23454, %r12
mov (%rdi), %rsi
...
{'dst': {'NT': False, 'AVXalign': True, 'size': 2, 'congruent': 2, 'same': False, 'type': 'addresses_D'}, 'OP': 'STOR'}
...
{'dst': {'NT': False, 'AVXalign': True, 'size': 32, 'congruent': 6, 'same': False, 'type': 'addresses_WT'}, 'OP': 'STOR'}
[Faulty Load]
