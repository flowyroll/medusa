...
push %rdx
push %rsi
lea addresses_A_ht+0x18729, %r12
nop
nop
nop
nop
...
movb $0x61, (%rcx)
dec %r10
lea addresses_UC_ht+0x19e29, %rsi
lea addresses_UC_ht+0x769, %rdi
nop
nop
nop
nop
...
nop
cmp $50437, %rdx
lea addresses_A_ht+0x18589, %rcx
nop
nop
nop
sub %r10, %r10
...
nop
inc %rdx
lea addresses_UC_ht+0x1e729, %rdx
nop
nop
mfence
movb $0x61, (%rdx)
...
nop
cmp %rsi, %rsi
lea addresses_A_ht+0x1b299, %rsi
lea addresses_normal_ht+0x2629, %rdi
nop
sub %r10, %r10
mov $2, %rcx
rep movsq
and %rdx, %rdx
lea addresses_WC_ht+0x7e29, %rbp
nop
nop
sub $47191, %rdx
...
// Store
lea addresses_normal+0x11a29, %rax
nop
nop
nop
nop
...
{'OP': 'STOR', 'dst': {'type': 'addresses_PSE', 'size': 2, 'AVXalign': True, 'NT': False, 'congruent': 10, 'same': False}}
