...
nop
add $43195, %rax
lea addresses_normal_ht+0x13659, %rbp
dec %rax
movl $0x61626364, (%rbp)
nop
nop
nop
sub $15133, %rax
lea addresses_normal_ht+0x17459, %r15
nop
nop
nop
nop
...
nop
sub %rax, %rax
lea addresses_WC_ht+0x16c06, %r15
nop
cmp $5802, %rcx
vmovups (%r15), %ymm5
...
vpextrq $1, %xmm5, %rdi
add $23213, %rax
lea addresses_normal_ht+0x12e8f, %rdi
clflush (%rdi)
nop
nop
nop
...
nop
sub %r13, %r13
lea addresses_UC_ht+0x18874, %r15
clflush (%r15)
nop
nop
dec %rbp
...
nop
xor $10913, %rbp
lea addresses_UC_ht+0x6e59, %rsi
lea addresses_WC_ht+0x7859, %rdi
nop
nop
cmp $23137, %r15
mov $58, %rcx
...
nop
dec %rsi
lea addresses_WC_ht+0x15a59, %rsi
lea addresses_A_ht+0xe2d9, %rdi
clflush (%rdi)
nop
nop
and %rax, %rax
...
nop
and $36531, %r11
lea addresses_UC_ht+0xee59, %rax
nop
nop
inc %r11
movups (%rax), %xmm5
...
// Load
lea addresses_normal+0xfc59, %r10
nop
dec %rbp
vmovups (%r10), %ymm6
...
{'OP': 'LOAD', 'src': {'same': False, 'NT': False, 'AVXalign': True, 'size': 4, 'type': 'addresses_normal_ht', 'congruent': 1}}
...
{'dst': {'same': False, 'NT': True, 'AVXalign': False, 'size': 2, 'type': 'addresses_WT_ht', 'congruent': 7}, 'OP': 'STOR'}
{'dst': {'same': False, 'congruent': 7, 'type': 'addresses_A_ht'}, 'OP': 'REPM', 'src': {'same': True, 'congruent': 7, 'type': 'addresses_WC_ht'}}
