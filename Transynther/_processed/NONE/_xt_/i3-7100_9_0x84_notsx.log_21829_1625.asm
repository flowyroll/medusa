...
// REPMOV
lea addresses_PSE+0x3d6f, %rsi
lea addresses_WT+0x756f, %rdi
nop
nop
inc %r11
mov $24, %rcx
...
// Load
lea addresses_normal+0x10507, %rbp
nop
nop
nop
nop
...
{'src': {'type': 'addresses_A', 'same': False, 'size': 8, 'congruent': 7, 'NT': False, 'AVXalign': True}, 'OP': 'LOAD'}
...
{'src': {'type': 'addresses_PSE', 'congruent': 11, 'same': False}, 'dst': {'type': 'addresses_WT', 'congruent': 11, 'same': False}, 'OP': 'REPM'}
{'src': {'type': 'addresses_normal', 'same': True, 'size': 2, 'congruent': 1, 'NT': False, 'AVXalign': False}, 'OP': 'LOAD'}
[Faulty Load]
