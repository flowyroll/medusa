...
nop
add $62418, %rbx
lea addresses_UC_ht+0x8e24, %rsi
lea addresses_D_ht+0x18ce4, %rdi
nop
nop
nop
nop
...
lea addresses_UC_ht+0x3ee4, %rdi
nop
nop
nop
nop
...
nop
cmp %rbx, %rbx
lea addresses_normal_ht+0x6e4, %rdi
nop
nop
nop
nop
...
nop
and $17655, %r14
lea addresses_WC_ht+0x50e4, %rdi
nop
nop
nop
nop
...
nop
add $17178, %r9
lea addresses_A_ht+0x1eae4, %rcx
clflush (%rcx)
nop
nop
nop
...
nop
cmp %r13, %r13
lea addresses_normal_ht+0x116e4, %rdi
add %rsi, %rsi
mov (%rdi), %r13
sub $56785, %rdi
lea addresses_normal_ht+0x1ae4, %r9
nop
and $58729, %rcx
movb $0x61, (%r9)
sub %r13, %r13
lea addresses_UC_ht+0x7484, %rdi
nop
nop
nop
sub %r13, %r13
...
nop
cmp $37881, %rdi
lea addresses_WC_ht+0x13364, %rsi
nop
xor %r13, %r13
movw $0x6162, (%rsi)
nop
...
nop
add %rsi, %rsi
lea addresses_D_ht+0x1d8a6, %rsi
lea addresses_WC_ht+0x1aee4, %rdi
nop
nop
and %r8, %r8
mov $43, %rcx
...
nop
cmp %r8, %r8
lea addresses_WC_ht+0x96e4, %rcx
nop
nop
nop
nop
...
{'OP': 'STOR', 'dst': {'same': False, 'congruent': 4, 'NT': True, 'type': 'addresses_A_ht', 'size': 8, 'AVXalign': True}}
