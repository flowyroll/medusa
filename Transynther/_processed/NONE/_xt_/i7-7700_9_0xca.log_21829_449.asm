...
push %rdi
push %rsi
lea addresses_normal_ht+0x13f19, %rdi
nop
nop
nop
sub %r8, %r8
...
nop
sub $4286, %rcx
lea addresses_UC_ht+0x12839, %rsi
lea addresses_UC_ht+0x6539, %rdi
nop
nop
nop
nop
...
nop
sub $19747, %r11
lea addresses_UC_ht+0x19939, %rsi
nop
nop
xor $63611, %r15
movl $0x61626364, (%rsi)
...
nop
add $64424, %rcx
lea addresses_WT_ht+0x18571, %rsi
...
nop
add %rcx, %rcx
lea addresses_UC_ht+0x10111, %rsi
lea addresses_UC_ht+0xcdb9, %rdi
nop
cmp $7312, %r9
mov $87, %rcx
rep movsq
...
{'src': {'congruent': 7, 'same': True, 'type': 'addresses_UC_ht'}, 'OP': 'REPM', 'dst': {'congruent': 11, 'same': True, 'type': 'addresses_UC_ht'}}
{'OP': 'STOR', 'dst': {'congruent': 10, 'AVXalign': True, 'same': False, 'size': 4, 'NT': False, 'type': 'addresses_UC_ht'}}
{'src': {'congruent': 2, 'same': True, 'type': 'addresses_WT_ht'}, 'OP': 'REPM', 'dst': {'congruent': 6, 'same': False, 'type': 'addresses_normal_ht'}}
