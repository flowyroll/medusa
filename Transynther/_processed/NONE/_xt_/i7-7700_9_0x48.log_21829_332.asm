...
push %rdi
push %rsi
lea addresses_D_ht+0x1d942, %rsi
lea addresses_normal_ht+0x13542, %rdi
sub %rax, %rax
mov $13, %rcx
rep movsq
nop
...
nop
add %r15, %r15
lea addresses_WT_ht+0x1313a, %rsi
nop
nop
and $63475, %r15
movl $0x61626364, (%rsi)
...
nop
dec %rsi
lea addresses_UC_ht+0x1b42, %r13
nop
nop
nop
xor $30246, %rbx
...
movq %rdi, (%r13)
and %rsi, %rsi
lea addresses_WC_ht+0xa2c2, %rsi
lea addresses_D_ht+0x542, %rdi
clflush (%rsi)
nop
nop
nop
...
nop
sub $8850, %r15
lea addresses_normal_ht+0xe942, %rbx
nop
nop
sub %rdi, %rdi
...
nop
sub %rcx, %rcx
lea addresses_WT_ht+0x18d42, %rax
cmp $26156, %r13
mov (%rax), %cx
nop
and $5194, %rcx
lea addresses_D_ht+0x1a342, %rsi
lea addresses_WC_ht+0x1942, %rdi
nop
nop
nop
nop
...
<gen_prepare_buffer>
{'OP': 'REPM', 'src': {'type': 'addresses_D_ht', 'congruent': 8, 'same': False}, 'dst': {'type': 'addresses_normal_ht', 'congruent': 10, 'same': False}}
