...
push %rdx
push %rsi
lea addresses_WC_ht+0x5602, %rdx
nop
nop
nop
nop
...
vpextrq $1, %xmm7, %r13
add %rdi, %rdi
lea addresses_UC_ht+0x16362, %rsi
lea addresses_A_ht+0x1082a, %rdi
nop
nop
nop
nop
...
nop
sub $31789, %rdi
lea addresses_normal_ht+0x1af76, %rsi
lea addresses_normal_ht+0x18482, %rdi
add $34673, %r14
mov $56, %rcx
rep movsb
nop
...
nop
sub $58471, %r15
lea addresses_UC_ht+0x1c48e, %r11
nop
nop
nop
and $3904, %r15
...
nop
add $43433, %rsi
lea addresses_WC_ht+0x10d82, %r15
xor $29684, %rcx
mov (%r15), %r13
nop
nop
sub %r14, %r14
lea addresses_normal_ht+0x15db3, %rcx
nop
nop
nop
cmp %r15, %r15
...
nop
inc %r14
lea addresses_WC_ht+0x4d1a, %r14
nop
dec %rcx
mov (%r14), %r15
nop
...
nop
xor $62948, %rdi
lea addresses_UC_ht+0x164c0, %r13
nop
nop
sub $55030, %r11
mov (%r13), %esi
dec %r13
lea addresses_WT_ht+0x1b282, %rsi
lea addresses_D_ht+0x127f2, %rdi
clflush (%rsi)
nop
nop
sub %r15, %r15
...
{'dst': {'NT': False, 'AVXalign': True, 'size': 1, 'congruent': 2, 'same': False, 'type': 'addresses_RW'}, 'OP': 'STOR'}
{'dst': {'NT': True, 'AVXalign': False, 'size': 16, 'congruent': 5, 'same': False, 'type': 'addresses_P'}, 'OP': 'STOR'}
{'dst': {'NT': False, 'AVXalign': False, 'size': 32, 'congruent': 3, 'same': False, 'type': 'addresses_D'}, 'OP': 'STOR'}
{'dst': {'NT': True, 'AVXalign': True, 'size': 32, 'congruent': 8, 'same': False, 'type': 'addresses_WC'}, 'OP': 'STOR'}
{'dst': {'NT': True, 'AVXalign': False, 'size': 4, 'congruent': 8, 'same': False, 'type': 'addresses_RW'}, 'OP': 'STOR'}
[Faulty Load]
...
{'src': {'congruent': 5, 'same': False, 'type': 'addresses_UC_ht'}, 'dst': {'congruent': 3, 'same': False, 'type': 'addresses_A_ht'}, 'OP': 'REPM'}
