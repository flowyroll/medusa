...
push %rdx
push %rsi
lea addresses_normal_ht+0x1e81f, %rbx
nop
inc %r10
movb $0x61, (%rbx)
nop
...
nop
xor %r9, %r9
lea addresses_WC_ht+0x6297, %rdi
nop
nop
nop
nop
...
nop
cmp $17457, %rsi
lea addresses_WC_ht+0x14b0f, %rdx
clflush (%rdx)
sub %r13, %r13
mov (%rdx), %di
cmp $8134, %rdi
lea addresses_A_ht+0x8d57, %rsi
lea addresses_A_ht+0x180f7, %rdi
nop
nop
nop
nop
...
nop
xor $24989, %r9
lea addresses_normal_ht+0x141ef, %r13
clflush (%r13)
nop
nop
nop
...
nop
and %r10, %r10
lea addresses_WT_ht+0x14c4f, %rsi
lea addresses_UC_ht+0x8577, %rdi
nop
nop
mfence
mov $46, %rcx
rep movsb
add $12693, %r9
lea addresses_WC_ht+0x8977, %rsi
lea addresses_normal_ht+0x1c697, %rdi
nop
nop
nop
nop
...
nop
cmp $21451, %rdi
lea addresses_WT_ht+0xb017, %rsi
...
// Faulty Load
lea addresses_normal+0x12977, %rax
nop
nop
xor %r15, %r15
mov (%rax), %r14
...
{'OP': 'STOR', 'dst': {'NT': False, 'same': False, 'congruent': 11, 'type': 'addresses_RW', 'AVXalign': False, 'size': 32}}
[Faulty Load]
...
{'src': {'same': False, 'congruent': 5, 'type': 'addresses_A_ht'}, 'OP': 'REPM', 'dst': {'same': False, 'congruent': 7, 'type': 'addresses_A_ht'}}
...
{'src': {'same': False, 'congruent': 4, 'type': 'addresses_WT_ht'}, 'OP': 'REPM', 'dst': {'same': False, 'congruent': 0, 'type': 'addresses_A_ht'}}
{'34': 21829}
