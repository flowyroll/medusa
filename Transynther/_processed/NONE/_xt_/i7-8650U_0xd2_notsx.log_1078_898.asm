...
push %rdi
push %rsi
lea addresses_A_ht+0x1d1e1, %r15
clflush (%r15)
nop
sub $39408, %r10
mov (%r15), %di
nop
add $47252, %r13
lea addresses_WC_ht+0x2b17, %rbx
xor %r8, %r8
...
nop
and $17243, %rdi
lea addresses_WT_ht+0x15ae1, %r15
clflush (%r15)
nop
nop
nop
...
nop
sub $12592, %rdi
lea addresses_WT_ht+0x57e3, %r15
nop
cmp %r8, %r8
mov (%r15), %r13d
nop
...
// Faulty Load
lea addresses_normal+0xe1e1, %r12
nop
and %rcx, %rcx
vmovups (%r12), %ymm4
