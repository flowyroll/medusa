...
push %rcx
push %rdx
lea addresses_normal_ht+0x194c8, %rcx
nop
nop
nop
nop
...
// Store
lea addresses_normal+0x165a8, %r10
clflush (%r10)
nop
nop
nop
...
// REPMOV
lea addresses_PSE+0x1eea8, %rsi
lea addresses_A+0xafd0, %rdi
clflush (%rdi)
xor %rbp, %rbp
mov $127, %rcx
rep movsq
...
// Store
lea addresses_normal+0x85a8, %rbp
cmp %rbx, %rbx
movl $0x51525354, (%rbp)
nop
nop
...
{'src': {'type': 'addresses_PSE', 'congruent': 10, 'same': False}, 'dst': {'type': 'addresses_A', 'congruent': 3, 'same': False}, 'OP': 'REPM'}
