...
push %rdx
push %rsi
lea addresses_UC_ht+0x91ff, %r10
nop
nop
nop
nop
...
nop
add %r10, %r10
lea addresses_UC_ht+0x112ff, %rsi
lea addresses_WT_ht+0x90ff, %rdi
nop
nop
nop
and $25567, %r11
...
rep movsw
and %r8, %r8
lea addresses_WC_ht+0x3d23, %rcx
clflush (%rcx)
nop
cmp %r8, %r8
movl $0x61626364, (%rcx)
and %r15, %r15
lea addresses_D_ht+0x10656, %r12
nop
nop
nop
nop
...
nop
and %rcx, %rcx
lea addresses_UC_ht+0x1caf9, %r15
nop
nop
nop
nop
...
nop
and $21110, %rdi
lea addresses_UC_ht+0x188ff, %rsi
nop
cmp $3736, %r8
movl $0x61626364, (%rsi)
nop
...
nop
sub $7504, %r10
lea addresses_normal_ht+0xd19f, %rsi
lea addresses_normal_ht+0x9f6f, %rdi
nop
nop
dec %rdx
mov $85, %rcx
...
// Faulty Load
lea addresses_normal+0x1acff, %r13
nop
and $25344, %rbp
movups (%r13), %xmm0
vpextrq $0, %xmm0, %r10
...
<gen_prepare_buffer>
{'src': {'congruent': 8, 'AVXalign': False, 'same': False, 'size': 2, 'NT': True, 'type': 'addresses_UC_ht'}, 'OP': 'LOAD'}
...
{'OP': 'STOR', 'dst': {'congruent': 0, 'AVXalign': True, 'same': False, 'size': 8, 'NT': True, 'type': 'addresses_D_ht'}}
