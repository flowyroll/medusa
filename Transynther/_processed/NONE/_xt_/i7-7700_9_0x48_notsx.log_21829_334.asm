...
nop
inc %r8
lea addresses_D_ht+0x19481, %rax
nop
nop
nop
nop
...
nop
dec %rcx
lea addresses_UC_ht+0x1e71d, %rsi
lea addresses_D_ht+0xa324, %rdi
nop
nop
nop
nop
...
nop
add %rbp, %rbp
lea addresses_normal_ht+0x1385d, %r8
nop
nop
nop
nop
...
nop
sub %r13, %r13
lea addresses_UC_ht+0x66dd, %r13
nop
inc %rdx
movw $0x6162, (%r13)
nop
...
{'dst': {'same': False, 'congruent': 0, 'type': 'addresses_D_ht'}, 'OP': 'REPM', 'src': {'same': True, 'congruent': 6, 'type': 'addresses_UC_ht'}}
