...
push %rdi
push %rsi
lea addresses_normal_ht+0x10816, %rsi
...
nop
cmp $51763, %r8
lea addresses_WC_ht+0x17bb6, %r13
nop
nop
nop
nop
...
nop
add %rax, %rax
lea addresses_normal_ht+0x296, %r8
clflush (%r8)
nop
nop
nop
...
nop
cmp $13120, %r10
lea addresses_D_ht+0x1ba16, %rsi
lea addresses_A_ht+0x19b16, %rdi
add %rbx, %rbx
mov $84, %rcx
rep movsq
cmp %rbx, %rbx
lea addresses_UC_ht+0x3f16, %rsi
lea addresses_WC_ht+0x15716, %rdi
nop
nop
nop
nop
...
nop
and $26382, %r13
lea addresses_WT_ht+0x14d56, %rax
nop
nop
sub %rdi, %rdi
movb $0x61, (%rax)
...
nop
and $28629, %r10
lea addresses_D_ht+0x12bbe, %r13
nop
nop
nop
nop
...
nop
and %rsi, %rsi
lea addresses_WC_ht+0xbc16, %rcx
and %r8, %r8
movb $0x61, (%rcx)
cmp %rcx, %rcx
lea addresses_WT_ht+0xe3fe, %rsi
lea addresses_UC_ht+0x6cbe, %rdi
nop
nop
nop
nop
...
<gen_prepare_buffer>
{'src': {'type': 'addresses_normal_ht', 'congruent': 8, 'same': False}, 'dst': {'type': 'addresses_normal_ht', 'congruent': 11, 'same': True}, 'OP': 'REPM'}
...
{'src': {'type': 'addresses_D_ht', 'congruent': 10, 'same': True}, 'dst': {'type': 'addresses_A_ht', 'congruent': 8, 'same': False}, 'OP': 'REPM'}
...
{'src': {'type': 'addresses_WT_ht', 'congruent': 1, 'same': False}, 'dst': {'type': 'addresses_UC_ht', 'congruent': 1, 'same': False}, 'OP': 'REPM'}
{'37': 21829}
