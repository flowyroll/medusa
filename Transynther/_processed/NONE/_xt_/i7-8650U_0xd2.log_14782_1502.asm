...
movl $0x61626364, (%r11)
and %r11, %r11
lea addresses_D_ht+0xc38c, %rsi
lea addresses_UC_ht+0x13474, %rdi
xor %r8, %r8
mov $105, %rcx
rep movsq
nop
...
nop
cmp $40402, %rdi
lea addresses_A_ht+0x18f2c, %rcx
clflush (%rcx)
nop
nop
xor %rbx, %rbx
...
nop
sub %rsi, %rsi
lea addresses_normal_ht+0xb29c, %rsi
lea addresses_WT_ht+0x1769c, %rdi
and $4999, %rbx
mov $32, %rcx
rep movsb
nop
...
nop
sub $23938, %rsi
lea addresses_normal_ht+0x7a9c, %r8
nop
sub %rdi, %rdi
movw $0x6162, (%r8)
nop
and $35551, %rcx
lea addresses_A_ht+0x1326c, %rsi
lea addresses_D_ht+0x1b610, %rdi
nop
nop
nop
nop
...
nop
add %r11, %r11
lea addresses_WT_ht+0x1e9b7, %rdx
nop
nop
nop
nop
...
nop
add $36169, %r8
lea addresses_normal_ht+0x229c, %rbx
nop
nop
xor %rsi, %rsi
movb $0x61, (%rbx)
