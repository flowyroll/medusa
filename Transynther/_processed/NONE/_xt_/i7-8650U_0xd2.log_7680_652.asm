...
push %rdi
push %rsi
lea addresses_normal_ht+0x1350d, %r11
clflush (%r11)
nop
dec %rbx
movl $0x61626364, (%r11)
...
nop
sub %r15, %r15
lea addresses_WT_ht+0x1a69c, %rax
nop
nop
nop
nop
...
nop
and %rax, %rax
lea addresses_WT_ht+0x17f9c, %rsi
lea addresses_WT_ht+0x1eb9c, %rdi
clflush (%rdi)
dec %r15
mov $91, %rcx
rep movsq
...
nop
cmp %rcx, %rcx
lea addresses_UC_ht+0x6b9c, %r15
nop
nop
nop
nop
...
nop
cmp $7167, %rbp
lea addresses_WT_ht+0x92ac, %rsi
lea addresses_A_ht+0x11b9c, %rdi
clflush (%rsi)
nop
add $56093, %r15
mov $77, %rcx
...
nop
inc %r15
lea addresses_A_ht+0x1265c, %rcx
nop
nop
nop
nop
...
// Store
lea addresses_normal+0x1df9c, %rbx
nop
add $28132, %rdi
