...
nop
sub %rbp, %rbp
lea addresses_UC_ht+0x14e07, %rdx
nop
nop
sub %r10, %r10
...
nop
xor $46595, %r10
lea addresses_WC_ht+0x3f9b, %r15
nop
nop
nop
nop
...
nop
cmp $39501, %r14
lea addresses_WC_ht+0x18983, %rsi
lea addresses_WT_ht+0x1ccb3, %rdi
nop
and %r13, %r13
mov $116, %rcx
rep movsb
...
nop
xor $44284, %rdx
lea addresses_A_ht+0x19567, %r15
nop
xor $22413, %rdx
movl $0x61626364, (%r15)
nop
...
nop
dec %r13
lea addresses_normal_ht+0xf3b5, %rdx
nop
nop
nop
nop
...
nop
dec %rdi
lea addresses_UC_ht+0x186eb, %rbp
nop
nop
nop
add $22424, %rcx
...
nop
add $59691, %r14
lea addresses_WT_ht+0x16f9b, %r15
nop
nop
nop
nop
...
nop
and $36445, %rdx
lea addresses_WC_ht+0x999b, %r15
nop
nop
nop
cmp %rbp, %rbp
