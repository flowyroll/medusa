...
push %rdx
push %rsi
lea addresses_WC_ht+0x1df86, %r10
add $19373, %rdx
...
nop
add %rcx, %rcx
lea addresses_WT_ht+0x13386, %rsi
lea addresses_UC_ht+0xf206, %rdi
nop
nop
inc %r10
mov $60, %rcx
rep movsb
dec %rsi
lea addresses_WT_ht+0x13ea6, %rsi
lea addresses_normal_ht+0x7b66, %rdi
sub $58778, %r11
mov $77, %rcx
rep movsb
add %rdx, %rdx
lea addresses_D_ht+0x2e36, %r10
nop
nop
nop
nop
...
// Faulty Load
lea addresses_normal+0xdb86, %r8
nop
nop
nop
nop
...
{'OP': 'STOR', 'dst': {'same': True, 'type': 'addresses_WT', 'NT': True, 'AVXalign': False, 'size': 8, 'congruent': 6}}
[Faulty Load]
...
{'OP': 'REPM', 'src': {'same': False, 'congruent': 5, 'type': 'addresses_WT_ht'}, 'dst': {'same': False, 'congruent': 4, 'type': 'addresses_normal_ht'}}
