...
push %rdi
push %rsi
lea addresses_normal_ht+0x16819, %rsi
lea addresses_UC_ht+0xd8f9, %rdi
sub %r8, %r8
mov $8, %rcx
rep movsb
nop
...
nop
add $50981, %rbp
lea addresses_UC_ht+0xd59, %rsi
lea addresses_A_ht+0x8a02, %rdi
sub %r12, %r12
mov $79, %rcx
rep movsq
nop
...
nop
xor %r8, %r8
lea addresses_WT_ht+0x4e19, %rsi
...
nop
sub %rsi, %rsi
lea addresses_normal_ht+0x6d99, %rsi
lea addresses_A_ht+0x1e199, %rdi
clflush (%rsi)
nop
nop
nop
...
<gen_prepare_buffer>
{'src': {'type': 'addresses_normal_ht', 'congruent': 8, 'same': True}, 'OP': 'REPM', 'dst': {'type': 'addresses_UC_ht', 'congruent': 5, 'same': False}}
