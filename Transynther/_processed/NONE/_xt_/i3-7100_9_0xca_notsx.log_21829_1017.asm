...
lea addresses_normal_ht+0x17c50, %rdi
nop
nop
nop
nop
...
nop
xor $36485, %rbp
lea addresses_A_ht+0x13920, %rbp
nop
nop
nop
nop
...
nop
cmp $18131, %r15
lea addresses_normal_ht+0x9b90, %rsi
lea addresses_UC_ht+0x9b6c, %rdi
dec %r12
mov $37, %rcx
rep movsl
add $38805, %r15
lea addresses_WT_ht+0x174dc, %r15
nop
nop
nop
nop
...
nop
add %rcx, %rcx
lea addresses_A_ht+0x12150, %r13
nop
nop
nop
nop
...
movb $0x61, (%r13)
cmp %r12, %r12
lea addresses_WT_ht+0x4a50, %rsi
cmp %r8, %r8
movl $0x61626364, (%rsi)
nop
nop
...
nop
sub %rcx, %rcx
lea addresses_WC_ht+0x18a50, %rsi
lea addresses_normal_ht+0xde0e, %rdi
and %r13, %r13
mov $111, %rcx
rep movsl
nop
...
{'src': {'type': 'addresses_normal_ht', 'congruent': 6, 'same': False}, 'OP': 'REPM', 'dst': {'type': 'addresses_UC_ht', 'congruent': 0, 'same': False}}
...
{'OP': 'STOR', 'dst': {'same': False, 'congruent': 9, 'NT': True, 'type': 'addresses_WT_ht', 'size': 4, 'AVXalign': False}}
{'src': {'type': 'addresses_WC_ht', 'congruent': 9, 'same': False}, 'OP': 'REPM', 'dst': {'type': 'addresses_normal_ht', 'congruent': 1, 'same': False}}
{'33': 21829}
