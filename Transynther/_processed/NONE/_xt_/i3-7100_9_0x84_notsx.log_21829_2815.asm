...
nop
add $30602, %rcx
lea addresses_normal_ht+0x121cf, %r11
nop
cmp $59606, %rdi
...
nop
xor %rdi, %rdi
lea addresses_A_ht+0x1b32d, %r12
nop
and $31762, %rbp
movl $0x61626364, (%r12)
nop
...
nop
sub $32095, %rcx
lea addresses_WT_ht+0x1e2c5, %r11
nop
nop
nop
nop
...
nop
cmp %r12, %r12
lea addresses_normal_ht+0x1cd9f, %rsi
lea addresses_D_ht+0xadbf, %rdi
clflush (%rsi)
nop
sub %r15, %r15
mov $113, %rcx
...
nop
cmp $7225, %rcx
lea addresses_WT_ht+0xff8f, %r11
nop
nop
nop
nop
...
nop
mfence
lea addresses_UC_ht+0x18f82, %rsi
lea addresses_D_ht+0xd15f, %rdi
nop
and %r8, %r8
mov $8, %rcx
rep movsq
...
nop
inc %r12
lea addresses_WC_ht+0x70ef, %rcx
nop
sub %rsi, %rsi
movl $0x61626364, (%rcx)
sub $5054, %rbp
lea addresses_A_ht+0x120bf, %rsi
nop
nop
dec %r15
mov (%rsi), %rdi
...
nop
dec %rsi
lea addresses_normal_ht+0x16bf, %r8
nop
nop
nop
nop
