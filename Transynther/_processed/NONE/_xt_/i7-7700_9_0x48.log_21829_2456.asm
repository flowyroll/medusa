...
movb $0x61, (%rdi)
cmp %rcx, %rcx
lea addresses_WC_ht+0x9ff9, %rsi
lea addresses_WT_ht+0x9c6d, %rdi
nop
nop
cmp $20894, %r12
mov $115, %rcx
...
nop
mfence
lea addresses_WC_ht+0x1d979, %rsi
lea addresses_WT_ht+0x19779, %rdi
clflush (%rsi)
nop
nop
nop
...
nop
mfence
lea addresses_normal_ht+0x14a79, %rcx
nop
nop
nop
add $7997, %r12
...
// Store
lea addresses_normal+0xc179, %r14
xor $42389, %r9
...
<gen_prepare_buffer>
{'OP': 'REPM', 'src': {'type': 'addresses_D_ht', 'congruent': 9, 'same': True}, 'dst': {'type': 'addresses_WT_ht', 'congruent': 1, 'same': False}}
...
{'OP': 'REPM', 'src': {'type': 'addresses_WC_ht', 'congruent': 11, 'same': False}, 'dst': {'type': 'addresses_WT_ht', 'congruent': 9, 'same': True}}
