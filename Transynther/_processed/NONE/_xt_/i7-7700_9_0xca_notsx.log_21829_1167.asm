...
push %rdx
push %rsi
lea addresses_A_ht+0x128e4, %r11
nop
nop
add $61459, %rax
movw $0x6162, (%r11)
...
nop
sub %rsi, %rsi
lea addresses_WC_ht+0xef84, %rsi
...
nop
cmp $12599, %rdi
lea addresses_WC_ht+0x193d7, %rcx
nop
nop
nop
nop
...
// REPMOV
lea addresses_RW+0x13444, %rsi
lea addresses_D+0x9944, %rdi
nop
nop
nop
nop
...
{'src': {'congruent': 8, 'same': False, 'type': 'addresses_RW'}, 'dst': {'congruent': 8, 'same': False, 'type': 'addresses_D'}, 'OP': 'REPM'}
{'dst': {'NT': False, 'AVXalign': False, 'size': 8, 'congruent': 6, 'same': False, 'type': 'addresses_PSE'}, 'OP': 'STOR'}
{'dst': {'NT': False, 'AVXalign': True, 'size': 8, 'congruent': 10, 'same': False, 'type': 'addresses_WT'}, 'OP': 'STOR'}
