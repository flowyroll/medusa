...
push %rdx
push %rsi
lea addresses_normal_ht+0xa1fb, %r8
clflush (%r8)
nop
nop
and %r15, %r15
...
nop
sub %rdx, %rdx
lea addresses_D_ht+0x12d69, %rcx
nop
nop
nop
and %r15, %r15
mov (%rcx), %bp
sub $12090, %rcx
lea addresses_D_ht+0x1e8a9, %rdx
nop
nop
nop
nop
...
nop
sub %rcx, %rcx
lea addresses_normal_ht+0x7f69, %r8
nop
nop
nop
nop
...
nop
and $1310, %r15
lea addresses_A_ht+0x1ef69, %rbp
nop
nop
nop
nop
...
nop
and $58065, %rbp
lea addresses_A_ht+0x1ca9, %rsi
lea addresses_WT_ht+0x17989, %rdi
nop
nop
nop
nop
...
// Store
lea addresses_normal+0x13091, %rdx
nop
nop
and %rsi, %rsi
...
// REPMOV
lea addresses_normal+0x146, %rsi
lea addresses_WC+0x17d69, %rdi
nop
nop
mfence
mov $65, %rcx
...
// REPMOV
lea addresses_UC+0x197c9, %rsi
lea addresses_UC+0xf369, %rdi
nop
nop
nop
nop
...
// Store
lea addresses_normal+0x11b69, %r9
clflush (%r9)
inc %rsi
movb $0x51, (%r9)
nop
...
// Faulty Load
lea addresses_normal+0xef69, %rsi
nop
nop
xor $32783, %rax
vmovups (%rsi), %ymm3
...
{'src': {'type': 'addresses_normal', 'congruent': 0, 'same': False}, 'OP': 'REPM', 'dst': {'type': 'addresses_WC', 'congruent': 7, 'same': False}}
{'src': {'type': 'addresses_UC', 'congruent': 4, 'same': False}, 'OP': 'REPM', 'dst': {'type': 'addresses_UC', 'congruent': 9, 'same': False}}
