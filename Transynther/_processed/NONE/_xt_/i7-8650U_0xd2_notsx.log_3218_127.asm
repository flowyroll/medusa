...
nop
cmp $24675, %r9
lea addresses_normal_ht+0xa857, %rsi
lea addresses_A_ht+0x54ab, %rdi
nop
nop
nop
inc %rbx
...
rep movsl
inc %r9
lea addresses_WT_ht+0xe8a0, %rsi
lea addresses_normal_ht+0xe4cb, %rdi
nop
nop
nop
and $51445, %rdx
...
nop
cmp $60805, %rdi
lea addresses_WC_ht+0x11deb, %rsi
nop
nop
nop
nop
...
nop
dec %r9
lea addresses_normal_ht+0x19189, %rsi
lea addresses_D_ht+0x1ae81, %rdi
clflush (%rsi)
sub %rdx, %rdx
mov $83, %rcx
rep movsw
...
{'OP': 'REPM', 'src': {'type': 'addresses_normal_ht', 'congruent': 1, 'same': False}, 'dst': {'type': 'addresses_D_ht', 'congruent': 0, 'same': False}}
{'37': 3218}
