...
push %rax
push %rdi
lea addresses_WC_ht+0x1e333, %r15
nop
nop
nop
nop
...
nop
sub $38606, %rdi
lea addresses_A_ht+0x190b4, %rax
nop
add %r13, %r13
vmovups (%rax), %ymm6
...
nop
dec %r15
lea addresses_UC_ht+0x59e3, %r15
nop
nop
nop
sub $2228, %r14
movw $0x6162, (%r15)
add %r13, %r13
lea addresses_WC_ht+0x18a69, %rdi
nop
nop
nop
and $55199, %r13
...
nop
sub $58136, %r15
lea addresses_normal_ht+0x1c1f3, %rax
nop
nop
nop
nop
...
{'OP': 'STOR', 'dst': {'type': 'addresses_RW', 'AVXalign': True, 'size': 1, 'NT': False, 'same': False, 'congruent': 1}}
...
{'OP': 'STOR', 'dst': {'type': 'addresses_WC_ht', 'AVXalign': False, 'size': 1, 'NT': True, 'same': False, 'congruent': 1}}
