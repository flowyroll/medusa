...
nop
dec %rsi
lea addresses_UC_ht+0x14455, %rbx
nop
cmp $24095, %rax
...
{'OP': 'STOR', 'dst': {'same': False, 'congruent': 5, 'NT': False, 'type': 'addresses_UC_ht', 'size': 16, 'AVXalign': True}}
{'32': 21829}
