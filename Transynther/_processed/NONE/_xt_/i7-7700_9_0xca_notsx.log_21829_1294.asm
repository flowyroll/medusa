...
push %rdi
push %rsi
lea addresses_WC_ht+0x17f00, %rcx
nop
and $27456, %r12
...
nop
dec %rsi
lea addresses_A_ht+0x100c8, %rdi
inc %rcx
mov (%rdi), %r10w
nop
nop
cmp %rdi, %rdi
lea addresses_WC_ht+0x136f0, %rsi
lea addresses_WT_ht+0xac70, %rdi
nop
nop
nop
nop
...
nop
add %rbp, %rbp
lea addresses_WT_ht+0x1caf0, %r9
clflush (%r9)
xor %r10, %r10
mov (%r9), %si
nop
add $61108, %r12
lea addresses_A_ht+0x1dba0, %rsi
lea addresses_D_ht+0x16f0, %rdi
sub %r9, %r9
mov $94, %rcx
rep movsb
nop
...
nop
and %rcx, %rcx
lea addresses_UC_ht+0x7470, %rsi
lea addresses_D_ht+0x8df0, %rdi
clflush (%rdi)
nop
nop
nop
...
nop
cmp $61647, %r10
lea addresses_WC_ht+0x16458, %r9
nop
nop
sub $45302, %rcx
...
movups %xmm0, (%r9)
dec %rbp
lea addresses_UC_ht+0xcef0, %r10
nop
nop
xor $21934, %r12
mov (%r10), %rbp
...
{'src': {'congruent': 9, 'same': False, 'type': 'addresses_WC_ht'}, 'dst': {'congruent': 7, 'same': False, 'type': 'addresses_WT_ht'}, 'OP': 'REPM'}
{'src': {'NT': False, 'AVXalign': False, 'size': 2, 'congruent': 9, 'same': False, 'type': 'addresses_WT_ht'}, 'OP': 'LOAD'}
{'src': {'congruent': 2, 'same': False, 'type': 'addresses_A_ht'}, 'dst': {'congruent': 11, 'same': False, 'type': 'addresses_D_ht'}, 'OP': 'REPM'}
