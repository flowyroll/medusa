...
push %rdx
push %rsi
lea addresses_A_ht+0x10b6d, %rsi
clflush (%rsi)
dec %r13
movw $0x6162, (%rsi)
cmp %r8, %r8
lea addresses_D_ht+0x1796d, %rbx
nop
nop
nop
nop
...
mov (%rbx), %esi
xor %rbx, %rbx
lea addresses_WT_ht+0x986d, %r11
nop
nop
nop
nop
...
lea addresses_A_ht+0x1e96d, %rdi
clflush (%rsi)
nop
nop
nop
...
nop
add %r8, %r8
lea addresses_WT_ht+0xd5ed, %r11
nop
nop
nop
and %rsi, %rsi
...
{'dst': {'type': 'addresses_WT_ht', 'same': True, 'size': 8, 'congruent': 3, 'NT': True, 'AVXalign': False}, 'OP': 'STOR'}
{'39': 21829}
