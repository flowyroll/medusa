...
push %rdx
push %rsi
lea addresses_WT_ht+0xb8dc, %r12
nop
dec %rbx
...
lea addresses_normal_ht+0x1857c, %rdi
nop
nop
nop
nop
...
nop
add %rdi, %rdi
lea addresses_D_ht+0x119c, %rsi
lea addresses_WT_ht+0xb03c, %rdi
nop
nop
xor %rdx, %rdx
mov $122, %rcx
...
nop
cmp %r10, %r10
lea addresses_normal_ht+0x717c, %rcx
nop
nop
nop
nop
...
{'src': {'congruent': 5, 'same': True, 'type': 'addresses_D_ht'}, 'OP': 'REPM', 'dst': {'congruent': 2, 'same': False, 'type': 'addresses_WT_ht'}}
