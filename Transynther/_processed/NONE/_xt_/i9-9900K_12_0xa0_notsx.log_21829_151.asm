...
push %rdx
push %rsi
lea addresses_WT_ht+0x14588, %rsi
...
nop
and %r8, %r8
lea addresses_UC_ht+0xedd8, %rsi
...
nop
cmp $19481, %rcx
lea addresses_normal_ht+0x1b557, %r15
nop
nop
mfence
movl $0x61626364, (%r15)
...
nop
add $34960, %rcx
lea addresses_WT_ht+0xdc98, %r14
nop
nop
nop
nop
...
nop
xor $42516, %r14
lea addresses_WT_ht+0x10c90, %r15
clflush (%r15)
and %r14, %r14
movups (%r15), %xmm5
vpextrq $0, %xmm5, %r8
...
{'OP': 'STOR', 'dst': {'type': 'addresses_normal_ht', 'AVXalign': False, 'size': 4, 'NT': True, 'same': False, 'congruent': 0}}
{'OP': 'STOR', 'dst': {'type': 'addresses_D_ht', 'AVXalign': False, 'size': 16, 'NT': False, 'same': True, 'congruent': 9}}
