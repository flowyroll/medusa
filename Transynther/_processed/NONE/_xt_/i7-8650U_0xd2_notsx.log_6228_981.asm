...
nop
and $34084, %r13
lea addresses_UC_ht+0x11a1c, %rsi
and $42266, %r8
mov (%rsi), %r15w
nop
nop
...
nop
and %r8, %r8
lea addresses_UC_ht+0x3ac0, %rsi
lea addresses_WT_ht+0x7ec0, %rdi
clflush (%rsi)
nop
nop
nop
...
nop
inc %r8
lea addresses_UC_ht+0x1e950, %r13
nop
cmp $62937, %r14
mov (%r13), %r15d
dec %r11
lea addresses_UC_ht+0x10281, %r13
nop
nop
sub %rdi, %rdi
movl $0x61626364, (%r13)
