...
push %rdi
push %rsi
lea addresses_D_ht+0xde3f, %rsi
lea addresses_A_ht+0xc43f, %rdi
nop
nop
nop
nop
...
nop
sub %r10, %r10
lea addresses_D_ht+0x1113f, %rbx
nop
nop
nop
nop
...
nop
xor $34726, %r15
lea addresses_WT_ht+0x1b2a7, %r14
nop
nop
nop
nop
...
nop
dec %r14
lea addresses_UC_ht+0xb3a1, %r10
clflush (%r10)
nop
nop
dec %rdi
...
<gen_prepare_buffer>
{'OP': 'REPM', 'src': {'type': 'addresses_D_ht', 'congruent': 8, 'same': False}, 'dst': {'type': 'addresses_A_ht', 'congruent': 9, 'same': False}}
