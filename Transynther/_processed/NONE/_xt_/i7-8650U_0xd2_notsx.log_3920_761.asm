...
push %rdi
push %rsi
lea addresses_D_ht+0x15302, %rbp
nop
nop
nop
nop
...
nop
sub %rax, %rax
lea addresses_normal_ht+0xaba2, %rax
nop
nop
nop
nop
...
// REPMOV
lea addresses_UC+0x4502, %rsi
lea addresses_WC+0x11982, %rdi
nop
nop
nop
add %r10, %r10
...
// Faulty Load
lea addresses_normal+0x13b02, %rax
nop
nop
nop
add $64732, %r11
...
{'OP': 'REPM', 'src': {'type': 'addresses_UC', 'congruent': 8, 'same': False}, 'dst': {'type': 'addresses_WC', 'congruent': 7, 'same': False}}
[Faulty Load]
{'OP': 'LOAD', 'src': {'type': 'addresses_normal', 'size': 8, 'AVXalign': False, 'NT': False, 'congruent': 0, 'same': True}}
<gen_prepare_buffer>
{'OP': 'LOAD', 'src': {'type': 'addresses_D_ht', 'size': 8, 'AVXalign': False, 'NT': False, 'congruent': 10, 'same': True}}
