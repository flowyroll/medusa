...
// REPMOV
lea addresses_RW+0xb2cf, %rsi
lea addresses_UC+0x6e4f, %rdi
nop
nop
nop
nop
...
// Store
lea addresses_normal+0x441f, %rdi
nop
nop
nop
xor $39870, %rbp
...
{'OP': 'REPM', 'src': {'type': 'addresses_RW', 'congruent': 6, 'same': False}, 'dst': {'type': 'addresses_UC', 'congruent': 9, 'same': False}}
