...
push %rdi
push %rsi
lea addresses_D_ht+0x1b124, %rsi
nop
nop
nop
nop
...
nop
xor $14893, %r11
lea addresses_D_ht+0x19924, %rsi
lea addresses_normal_ht+0x1e824, %rdi
nop
nop
nop
nop
...
rep movsq
sub %r11, %r11
lea addresses_UC_ht+0x4203, %rsi
lea addresses_normal_ht+0x1cde6, %rdi
and $64348, %r12
mov $113, %rcx
rep movsw
nop
...
nop
and $52459, %rsi
lea addresses_normal_ht+0x196a4, %r12
nop
nop
nop
inc %rbx
...
nop
add %rdi, %rdi
lea addresses_D_ht+0x572a, %rsi
lea addresses_UC_ht+0x1b972, %rdi
nop
nop
and %r11, %r11
mov $104, %rcx
...
nop
and $27169, %rdi
lea addresses_WT_ht+0x2f24, %rsi
lea addresses_WT_ht+0x17763, %rdi
nop
dec %r9
mov $80, %rcx
rep movsq
...
nop
xor %rsi, %rsi
lea addresses_UC_ht+0x19424, %rsi
lea addresses_A_ht+0x149f4, %rdi
nop
nop
nop
nop
...
nop
sub $34267, %rbx
lea addresses_WC_ht+0x18424, %r9
nop
dec %r13
mov (%r9), %r12d
inc %r12
lea addresses_D_ht+0xfba4, %r11
add $16002, %rbx
...
// Faulty Load
lea addresses_normal+0x9924, %r13
nop
nop
nop
nop
...
{'src': {'same': False, 'congruent': 1, 'type': 'addresses_D_ht'}, 'OP': 'REPM', 'dst': {'same': False, 'congruent': 1, 'type': 'addresses_UC_ht'}}
{'src': {'same': False, 'congruent': 5, 'type': 'addresses_WT_ht'}, 'OP': 'REPM', 'dst': {'same': False, 'congruent': 0, 'type': 'addresses_WT_ht'}}
