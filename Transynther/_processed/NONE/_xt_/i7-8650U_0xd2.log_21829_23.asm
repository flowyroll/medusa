...
push %rdi
push %rsi
lea addresses_WT_ht+0x8195, %r12
nop
nop
nop
nop
...
vpextrq $0, %xmm5, %rax
xor %r12, %r12
lea addresses_WT_ht+0xe0d5, %rsi
lea addresses_A_ht+0x9151, %rdi
nop
nop
xor %r15, %r15
mov $117, %rcx
rep movsl
add $54812, %r12
lea addresses_D_ht+0x121d5, %r15
inc %rcx
mov (%r15), %di
nop
nop
and $45578, %rsi
lea addresses_D_ht+0x1128d, %r8
nop
nop
xor %r15, %r15
movl $0x61626364, (%r8)
...
nop
sub %rsi, %rsi
lea addresses_WC_ht+0x161d5, %rsi
lea addresses_UC_ht+0x1b15, %rdi
xor $2591, %r9
mov $71, %rcx
rep movsw
nop
...
// Faulty Load
lea addresses_normal+0x65d5, %r9
nop
nop
nop
add %r12, %r12
