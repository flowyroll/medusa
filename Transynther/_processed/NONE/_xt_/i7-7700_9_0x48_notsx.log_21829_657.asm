...
nop
cmp $26677, %rcx
lea addresses_UC_ht+0x119a9, %r14
nop
add %rbp, %rbp
mov $0x6162636465666768, %r9
movq %r9, (%r14)
and %r9, %r9
lea addresses_WC_ht+0x3429, %rsi
lea addresses_A_ht+0x18e29, %rdi
nop
add %r15, %r15
mov $46, %rcx
rep movsw
...
nop
xor $59890, %r9
lea addresses_normal_ht+0xa9e9, %r15
nop
nop
nop
nop
...
nop
inc %rcx
lea addresses_A_ht+0xec21, %rsi
lea addresses_UC_ht+0x1434f, %rdi
cmp %r10, %r10
mov $109, %rcx
rep movsl
sub %r14, %r14
lea addresses_WT_ht+0x5529, %rbp
nop
nop
add %r14, %r14
movb $0x61, (%rbp)
...
nop
dec %rcx
lea addresses_A_ht+0x127e9, %rsi
lea addresses_WT_ht+0x1e629, %rdi
and $38595, %r10
mov $66, %rcx
rep movsl
nop
...
nop
xor %r9, %r9
lea addresses_WC_ht+0x106d1, %r15
nop
nop
nop
nop
...
{'dst': {'same': False, 'congruent': 8, 'type': 'addresses_A_ht'}, 'OP': 'REPM', 'src': {'same': False, 'congruent': 10, 'type': 'addresses_WC_ht'}}
...
{'dst': {'same': False, 'congruent': 8, 'type': 'addresses_WT_ht'}, 'OP': 'REPM', 'src': {'same': False, 'congruent': 4, 'type': 'addresses_A_ht'}}
