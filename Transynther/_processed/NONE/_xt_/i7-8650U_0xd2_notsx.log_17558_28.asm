...
push %rdi
push %rsi
lea addresses_UC_ht+0x15672, %rcx
nop
nop
sub %r12, %r12
movl $0x61626364, (%rcx)
cmp $48873, %r11
lea addresses_A_ht+0xbe72, %rax
nop
and $3756, %rcx
mov $0x6162636465666768, %rbp
movq %rbp, (%rax)
cmp %rax, %rax
lea addresses_WC_ht+0x14a72, %rsi
lea addresses_WT_ht+0x56d2, %rdi
nop
nop
cmp $56537, %r11
mov $107, %rcx
...
nop
dec %r12
lea addresses_UC_ht+0x15d72, %rsi
nop
nop
nop
nop
...
nop
sub $59867, %r12
lea addresses_normal_ht+0xeb2a, %r11
nop
nop
sub $27076, %r12
mov (%r11), %si
...
nop
dec %r11
lea addresses_normal_ht+0xc1d2, %rsi
lea addresses_normal_ht+0x6358, %rdi
nop
nop
inc %r8
mov $12, %rcx
...
nop
xor $22194, %rdi
lea addresses_UC_ht+0x2072, %rcx
nop
nop
nop
nop
