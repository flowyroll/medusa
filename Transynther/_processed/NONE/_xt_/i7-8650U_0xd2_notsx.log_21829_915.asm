...
push %rdx
push %rsi
lea addresses_WC_ht+0x6f64, %rcx
nop
nop
nop
nop
...
nop
add $29105, %rdi
lea addresses_UC_ht+0x1d99b, %rdi
nop
nop
nop
nop
...
nop
inc %rdx
lea addresses_normal_ht+0x13bfb, %rsi
lea addresses_normal_ht+0x919b, %rdi
and %rdx, %rdx
mov $35, %rcx
rep movsb
nop
...
nop
cmp $19896, %r13
lea addresses_D_ht+0x1359b, %rcx
clflush (%rcx)
nop
and %rdi, %rdi
mov (%rcx), %si
...
nop
sub $31811, %r10
lea addresses_WT_ht+0x1669b, %rdi
clflush (%rdi)
nop
and $47669, %r11
movb $0x61, (%rdi)
...
nop
add $32378, %rsi
lea addresses_D_ht+0x9edb, %rsi
lea addresses_WT_ht+0x15613, %rdi
clflush (%rsi)
nop
xor $58135, %r11
mov $64, %rcx
...
{'OP': 'STOR', 'dst': {'type': 'addresses_WT_ht', 'size': 1, 'AVXalign': False, 'NT': True, 'congruent': 8, 'same': False}}
{'OP': 'REPM', 'src': {'type': 'addresses_D_ht', 'congruent': 4, 'same': False}, 'dst': {'type': 'addresses_WT_ht', 'congruent': 2, 'same': False}}
