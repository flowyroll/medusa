...
push %rbx
push %rsi
lea addresses_WT_ht+0x11ce0, %r10
clflush (%r10)
nop
nop
nop
...
nop
sub $26005, %r11
lea addresses_normal_ht+0x16350, %rbx
clflush (%rbx)
nop
cmp $12275, %r9
...
nop
xor $47016, %rsi
lea addresses_WT_ht+0x4e97, %r10
nop
nop
nop
xor %rsi, %rsi
...
nop
cmp $57484, %rsi
lea addresses_WT_ht+0x1eae0, %rsi
nop
nop
nop
nop
...
nop
and %rsi, %rsi
lea addresses_D_ht+0x19a26, %r11
nop
nop
nop
nop
...
{'dst': {'type': 'addresses_WT_ht', 'same': False, 'size': 1, 'congruent': 4, 'NT': False, 'AVXalign': True}, 'OP': 'STOR'}
