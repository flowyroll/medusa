...
push %rdi
push %rsi
lea addresses_D_ht+0x48e9, %rsi
lea addresses_D_ht+0x2869, %rdi
nop
nop
nop
nop
...
rep movsb
cmp $14401, %rbx
lea addresses_D_ht+0x15e69, %rax
nop
nop
nop
and $31674, %rbp
...
nop
xor $39863, %r13
lea addresses_D_ht+0xbb19, %rsi
xor %rdi, %rdi
movl $0x61626364, (%rsi)
nop
inc %rbx
lea addresses_D_ht+0x7869, %rbx
nop
nop
xor $13420, %r13
mov (%rbx), %esi
...
nop
inc %rdi
lea addresses_normal_ht+0x15669, %r13
nop
nop
nop
dec %rcx
...
{'dst': {'same': True, 'NT': False, 'AVXalign': False, 'size': 4, 'type': 'addresses_D_ht', 'congruent': 2}, 'OP': 'STOR'}
