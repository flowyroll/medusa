...
nop
dec %rax
lea addresses_WC_ht+0xd3b1, %rsi
lea addresses_UC_ht+0x1bf51, %rdi
nop
cmp %rdx, %rdx
mov $15, %rcx
rep movsq
...
nop
cmp $15244, %r15
lea addresses_WT_ht+0xb51, %rcx
cmp %r15, %r15
vmovups (%rcx), %ymm6
vextracti128 $1, %ymm6, %xmm6
vpextrq $0, %xmm6, %rdi
and %rdx, %rdx
lea addresses_WT_ht+0x1c751, %rsi
clflush (%rsi)
nop
nop
nop
...
<gen_prepare_buffer>
{'OP': 'STOR', 'dst': {'same': False, 'type': 'addresses_A_ht', 'NT': True, 'AVXalign': False, 'size': 2, 'congruent': 4}}
{'OP': 'REPM', 'src': {'same': True, 'congruent': 0, 'type': 'addresses_A_ht'}, 'dst': {'same': False, 'congruent': 3, 'type': 'addresses_WC_ht'}}
{'OP': 'REPM', 'src': {'same': False, 'congruent': 5, 'type': 'addresses_WC_ht'}, 'dst': {'same': False, 'congruent': 10, 'type': 'addresses_UC_ht'}}
{'OP': 'LOAD', 'src': {'same': True, 'type': 'addresses_WT_ht', 'NT': False, 'AVXalign': False, 'size': 32, 'congruent': 8}}
