...
nop
sub $56929, %rdx
lea addresses_D_ht+0x1c203, %rbx
nop
nop
nop
nop
...
nop
dec %r11
lea addresses_WC_ht+0x4143, %rsi
lea addresses_WC_ht+0x1edf7, %rdi
nop
nop
nop
nop
...
nop
xor %rbx, %rbx
lea addresses_normal_ht+0xdfe3, %rax
nop
cmp %rcx, %rcx
mov $0x6162636465666768, %rdx
movq %rdx, (%rax)
and $41823, %r11
lea addresses_WT_ht+0xc843, %rsi
lea addresses_normal_ht+0xf50b, %rdi
nop
nop
nop
nop
...
nop
sub $28152, %rdi
lea addresses_WT_ht+0x18f33, %rdx
xor $15245, %r14
mov $0x6162636465666768, %rcx
movq %rcx, %xmm0
vmovups %ymm0, (%rdx)
sub %rdi, %rdi
lea addresses_UC_ht+0x2d43, %rsi
lea addresses_UC_ht+0xbc23, %rdi
nop
nop
nop
nop
...
nop
cmp %r10, %r10
lea addresses_WC_ht+0x108c3, %rsi
lea addresses_UC_ht+0xac83, %rdi
clflush (%rdi)
dec %r10
mov $8, %rcx
rep movsl
...
{'OP': 'LOAD', 'src': {'type': 'addresses_WC', 'AVXalign': False, 'congruent': 10, 'size': 8, 'same': False, 'NT': False}}
