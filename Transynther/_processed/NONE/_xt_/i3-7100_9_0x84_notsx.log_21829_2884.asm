...
push %rdx
push %rsi
lea addresses_A_ht+0x1ca75, %rcx
nop
nop
add %rbp, %rbp
movl $0x61626364, (%rcx)
...
nop
xor %rdi, %rdi
lea addresses_WC_ht+0x1aa5, %r10
nop
nop
nop
sub $32693, %rdx
...
nop
add %rdx, %rdx
lea addresses_D_ht+0x18775, %r13
nop
dec %rdx
mov (%r13), %di
nop
sub %rdx, %rdx
lea addresses_A_ht+0x18675, %r15
nop
nop
and %r13, %r13
movb (%r15), %r10b
...
lea addresses_A_ht+0x18075, %rdi
clflush (%rsi)
nop
sub %r15, %r15
mov $85, %rcx
rep movsq
sub $46901, %r10
lea addresses_normal_ht+0x1a675, %rdx
clflush (%rdx)
nop
dec %rdi
movups (%rdx), %xmm1
...
nop
inc %rsi
lea addresses_A_ht+0x1608d, %rdx
nop
nop
nop
xor %r15, %r15
...
nop
cmp %rbp, %rbp
lea addresses_D_ht+0x15d75, %rdi
nop
nop
and $53423, %r13
...
nop
add %rdi, %rdi
lea addresses_A_ht+0x10c75, %r13
clflush (%r13)
nop
nop
sub $49335, %rdx
...
nop
and %rsi, %rsi
lea addresses_WT_ht+0x3f35, %rsi
lea addresses_UC_ht+0x14c75, %rdi
nop
nop
nop
nop
...
// Store
lea addresses_normal+0x12f6d, %r10
nop
nop
add %r12, %r12
movw $0x5152, (%r10)
