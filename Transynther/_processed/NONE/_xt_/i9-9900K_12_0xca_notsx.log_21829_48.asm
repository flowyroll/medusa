...
nop
cmp $10288, %rdx
lea addresses_UC_ht+0x18dc3, %r11
clflush (%r11)
nop
nop
nop
...
nop
sub $39724, %rax
lea addresses_UC_ht+0x51c3, %rsi
lea addresses_A_ht+0x11f43, %rdi
nop
nop
nop
nop
...
movups %xmm4, (%r10)
cmp %rdi, %rdi
lea addresses_WT_ht+0x3243, %rsi
lea addresses_UC_ht+0x21c3, %rdi
nop
nop
nop
nop
...
rep movsw
cmp %rsi, %rsi
lea addresses_A_ht+0x114a3, %r10
nop
nop
add %r11, %r11
movw $0x6162, (%r10)
...
nop
xor %rcx, %rcx
lea addresses_normal_ht+0x5663, %rbx
clflush (%rbx)
nop
nop
cmp %r15, %r15
...
nop
add $54991, %r10
lea addresses_normal_ht+0xba43, %rsi
lea addresses_normal_ht+0xbae6, %rdi
nop
nop
nop
add %r10, %r10
...
{'OP': 'REPM', 'src': {'same': True, 'congruent': 5, 'type': 'addresses_WT_ht'}, 'dst': {'same': False, 'congruent': 10, 'type': 'addresses_UC_ht'}}
