...
// Store
lea addresses_normal+0x9288, %rbx
nop
nop
xor %r11, %r11
movb $0x51, (%rbx)
...
// Faulty Load
lea addresses_normal+0x158d8, %r9
nop
nop
nop
nop
...
<gen_prepare_buffer>
{'dst': {'same': True, 'NT': True, 'AVXalign': False, 'size': 4, 'type': 'addresses_D_ht', 'congruent': 3}, 'OP': 'STOR'}
{'dst': {'same': False, 'NT': True, 'AVXalign': False, 'size': 32, 'type': 'addresses_WC_ht', 'congruent': 1}, 'OP': 'STOR'}
{'34': 21829}
