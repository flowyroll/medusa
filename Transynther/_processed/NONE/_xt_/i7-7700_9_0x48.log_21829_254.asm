...
push %rdx
push %rsi
lea addresses_WC_ht+0x19ef0, %r12
nop
nop
nop
nop
...
nop
xor %rdi, %rdi
lea addresses_D_ht+0x19b2c, %r14
nop
nop
dec %rdx
mov (%r14), %rdi
...
nop
and $46088, %rcx
lea addresses_D_ht+0xca2c, %rsi
lea addresses_WC_ht+0x1e59c, %rdi
nop
nop
inc %r12
mov $66, %rcx
...
nop
add $12701, %r14
lea addresses_WC_ht+0x46ac, %r12
nop
nop
xor %r14, %r14
movl $0x61626364, (%r12)
...
mov (%r9), %edi
xor %rsi, %rsi
lea addresses_WC_ht+0x1282c, %r14
nop
nop
and %rcx, %rcx
movb (%r14), %r15b
...
nop
add %r14, %r14
lea addresses_A_ht+0x1dbcc, %r14
inc %rdx
movups (%r14), %xmm5
vpextrq $1, %xmm5, %rsi
add %rsi, %rsi
lea addresses_A_ht+0x402c, %rcx
add $57365, %r14
mov (%rcx), %edx
nop
nop
...
// Load
lea addresses_normal+0x942c, %rsi
nop
nop
add $3148, %rdx
movb (%rsi), %al
...
// Faulty Load
lea addresses_normal+0x9c2c, %rsi
nop
nop
dec %r10
mov (%rsi), %r11w
...
{'OP': 'REPM', 'src': {'type': 'addresses_D_ht', 'congruent': 9, 'same': True}, 'dst': {'type': 'addresses_WC_ht', 'congruent': 4, 'same': True}}
