...
push %rdi
push %rsi
lea addresses_WT_ht+0x14661, %r9
nop
nop
nop
sub $33680, %rcx
...
nop
inc %rdi
lea addresses_A_ht+0x1c041, %rsi
lea addresses_WT_ht+0x1a4e1, %rdi
clflush (%rdi)
nop
nop
cmp $10865, %rbx
...
nop
dec %rbx
lea addresses_normal_ht+0x1861, %rsi
lea addresses_WC_ht+0x9ca1, %rdi
nop
nop
nop
nop
...
nop
sub %rbx, %rbx
lea addresses_D_ht+0x1d461, %rcx
nop
cmp %r11, %r11
mov (%rcx), %rbx
nop
...
nop
sub $4912, %r9
lea addresses_D_ht+0xa4b6, %r10
nop
and $1626, %rcx
movw $0x6162, (%r10)
sub %r12, %r12
lea addresses_WC_ht+0x13061, %rbx
nop
nop
nop
nop
...
nop
sub $29289, %rbx
lea addresses_WT_ht+0x14fcb, %rcx
nop
xor $2638, %r9
movl $0x61626364, (%rcx)
dec %rbx
lea addresses_WT_ht+0x1e4a1, %rbx
nop
add %r12, %r12
movb (%rbx), %cl
nop
...
// REPMOV
lea addresses_PSE+0x1834a, %rsi
lea addresses_normal+0x17e61, %rdi
nop
nop
nop
nop
