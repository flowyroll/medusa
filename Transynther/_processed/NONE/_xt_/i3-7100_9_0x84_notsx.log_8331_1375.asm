...
push %rdi
push %rsi
lea addresses_A_ht+0x16704, %rsi
lea addresses_UC_ht+0x1c904, %rdi
clflush (%rsi)
nop
nop
xor %r9, %r9
...
// Store
lea addresses_normal+0x5304, %rcx
nop
nop
nop
nop
...
// REPMOV
lea addresses_US+0x9904, %rsi
lea addresses_WT+0x1f063, %rdi
nop
nop
nop
nop
...
{'src': {'type': 'addresses_US', 'congruent': 11, 'same': False}, 'dst': {'type': 'addresses_WT', 'congruent': 0, 'same': False}, 'OP': 'REPM'}
...
{'src': {'type': 'addresses_A_ht', 'congruent': 5, 'same': True}, 'dst': {'type': 'addresses_A_ht', 'congruent': 2, 'same': False}, 'OP': 'REPM'}
