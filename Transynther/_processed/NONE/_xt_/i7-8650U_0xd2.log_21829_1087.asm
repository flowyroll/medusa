...
push %rdi
push %rsi
lea addresses_UC_ht+0xa734, %rsi
lea addresses_D_ht+0x6025, %rdi
nop
nop
nop
nop
...
nop
xor %r12, %r12
lea addresses_WT_ht+0x18ca5, %r8
dec %r9
mov $0x6162636465666768, %rcx
movq %rcx, (%r8)
sub %r12, %r12
lea addresses_D_ht+0x192e5, %r9
nop
nop
nop
nop
...
vpextrq $0, %xmm1, %r8
cmp $18498, %r9
lea addresses_UC_ht+0x19b99, %rsi
lea addresses_D_ht+0xd4a5, %rdi
nop
nop
nop
xor %r13, %r13
...
movw $0x6162, (%r9)
add $16306, %r9
lea addresses_normal_ht+0x108eb, %r12
nop
nop
sub $60546, %r13
mov $0x6162636465666768, %rcx
...
nop
cmp $56025, %rsi
lea addresses_UC_ht+0x32e5, %rsi
lea addresses_UC_ht+0xcee5, %rdi
nop
nop
cmp %r12, %r12
mov $69, %rcx
...
nop
dec %r13
lea addresses_WC_ht+0x1d97, %rbp
and %r12, %r12
mov (%rbp), %r9
nop
nop
...
nop
sub $24428, %r9
lea addresses_WT_ht+0x1e8b1, %r9
nop
nop
nop
nop
...
movl $0x61626364, (%r9)
add %r13, %r13
lea addresses_normal_ht+0x15e1d, %rdi
nop
sub $16465, %rsi
...
// Faulty Load
lea addresses_normal+0x1bae5, %rbx
nop
nop
nop
nop
...
<gen_prepare_buffer>
{'OP': 'REPM', 'src': {'type': 'addresses_UC_ht', 'congruent': 0, 'same': True}, 'dst': {'type': 'addresses_D_ht', 'congruent': 5, 'same': False}}
