...
push %rdi
push %rsi
lea addresses_UC_ht+0x1b32f, %rsi
lea addresses_normal_ht+0xb213, %rdi
nop
nop
nop
nop
...
nop
and %r10, %r10
lea addresses_D_ht+0x187d3, %rax
nop
sub $8779, %rdi
...
nop
cmp %r10, %r10
lea addresses_WT_ht+0x319d, %r15
clflush (%r15)
nop
sub %rax, %rax
mov (%r15), %r13
nop
xor $20375, %rsi
lea addresses_WT_ht+0x11bf3, %rdi
nop
nop
nop
nop
...
nop
xor %r15, %r15
lea addresses_A_ht+0x158d3, %r10
nop
nop
add $20275, %r13
...
lea addresses_D_ht+0x10723, %rdi
clflush (%rdi)
nop
nop
cmp %rbp, %rbp
...
nop
cmp %r13, %r13
lea addresses_A_ht+0x1a513, %r15
nop
nop
nop
add $59568, %rsi
