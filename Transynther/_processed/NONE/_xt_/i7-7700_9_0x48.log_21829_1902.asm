...
push %rdi
push %rsi
lea addresses_A_ht+0x13351, %rcx
nop
nop
sub %r10, %r10
...
nop
and $3156, %r8
lea addresses_normal_ht+0x1a7d1, %r13
nop
nop
nop
and %rsi, %rsi
...
nop
add $2995, %r10
lea addresses_A_ht+0x1dfd1, %rsi
lea addresses_D_ht+0xc4b3, %rdi
nop
cmp $44098, %r14
mov $83, %rcx
rep movsb
and $43974, %r10
lea addresses_WC_ht+0x19201, %rcx
clflush (%rcx)
nop
nop
nop
...
movb $0x61, (%rcx)
dec %rcx
lea addresses_WC_ht+0xbdf9, %rsi
nop
nop
nop
sub $44277, %r10
...
<gen_prepare_buffer>
{'OP': 'LOAD', 'src': {'type': 'addresses_A_ht', 'AVXalign': True, 'congruent': 2, 'size': 32, 'same': False, 'NT': True}}
