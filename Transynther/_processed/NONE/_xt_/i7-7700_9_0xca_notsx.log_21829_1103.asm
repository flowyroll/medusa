...
nop
sub %rdi, %rdi
lea addresses_UC_ht+0x1d995, %rbx
nop
and $6464, %rax
movw $0x6162, (%rbx)
nop
nop
sub $50424, %rcx
lea addresses_WC_ht+0x1966c, %rsi
nop
nop
nop
nop
...
nop
cmp $12609, %rax
lea addresses_D_ht+0x10195, %rdi
nop
nop
and $3906, %rcx
mov $0x6162636465666768, %r8
...
nop
add %rax, %rax
lea addresses_UC_ht+0x1df5d, %r8
clflush (%r8)
nop
nop
nop
...
nop
and %rax, %rax
lea addresses_D_ht+0x23a8, %rsi
lea addresses_normal_ht+0x1ebe9, %rdi
clflush (%rsi)
nop
nop
nop
...
nop
cmp $58010, %rdi
lea addresses_UC_ht+0xad95, %rcx
nop
sub $10931, %r10
...
nop
sub %rax, %rax
lea addresses_A_ht+0x12cf5, %rbx
clflush (%rbx)
nop
nop
nop
...
nop
inc %rsi
lea addresses_UC_ht+0x7d95, %rsi
lea addresses_WC_ht+0x1af65, %rdi
clflush (%rsi)
nop
xor %r8, %r8
mov $93, %rcx
...
nop
xor %rdi, %rdi
lea addresses_WC_ht+0x1ec3a, %rsi
...
nop
cmp %rax, %rax
lea addresses_WT_ht+0x1b90f, %rsi
nop
nop
nop
nop
...
{'src': {'congruent': 0, 'same': False, 'type': 'addresses_D_ht'}, 'dst': {'congruent': 2, 'same': False, 'type': 'addresses_normal_ht'}, 'OP': 'REPM'}
...
{'src': {'congruent': 0, 'same': False, 'type': 'addresses_WC_ht'}, 'dst': {'congruent': 9, 'same': False, 'type': 'addresses_D_ht'}, 'OP': 'REPM'}
{'src': {'NT': False, 'AVXalign': False, 'size': 16, 'congruent': 1, 'same': True, 'type': 'addresses_WT_ht'}, 'OP': 'LOAD'}
{'38': 21829}
