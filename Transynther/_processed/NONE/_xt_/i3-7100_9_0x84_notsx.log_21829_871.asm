...
lea addresses_WT_ht+0x1b2d2, %rdi
sub %r15, %r15
mov $35, %rcx
rep movsq
xor %rsi, %rsi
lea addresses_D_ht+0x3816, %rsi
lea addresses_UC_ht+0x4d6a, %rdi
nop
add %r14, %r14
mov $79, %rcx
rep movsq
and %r14, %r14
lea addresses_WC_ht+0x626a, %r9
nop
nop
nop
inc %rsi
...
nop
cmp $1757, %rax
lea addresses_normal_ht+0x186de, %rcx
nop
nop
nop
nop
...
nop
add %r15, %r15
lea addresses_normal_ht+0x18d6a, %rsi
lea addresses_D_ht+0x1d40e, %rdi
nop
nop
nop
inc %rbp
...
nop
cmp $3900, %r14
lea addresses_WC_ht+0x2a2a, %rsi
lea addresses_D_ht+0x1c56a, %rdi
nop
nop
sub %r9, %r9
mov $48, %rcx
...
nop
sub $1248, %rcx
lea addresses_WC_ht+0x5d6a, %rbp
nop
xor %rsi, %rsi
mov (%rbp), %eax
nop
dec %r9
lea addresses_WT_ht+0x1dd7a, %rsi
lea addresses_WC_ht+0x4b6a, %rdi
nop
nop
nop
nop
...
nop
cmp $18755, %r9
lea addresses_A_ht+0x16aea, %rsi
lea addresses_A_ht+0xae70, %rdi
clflush (%rdi)
nop
nop
cmp %r9, %r9
...
<gen_prepare_buffer>
{'dst': {'type': 'addresses_WT_ht', 'same': False, 'size': 8, 'congruent': 6, 'NT': True, 'AVXalign': False}, 'OP': 'STOR'}
{'src': {'type': 'addresses_normal_ht', 'congruent': 4, 'same': True}, 'dst': {'type': 'addresses_WT_ht', 'congruent': 3, 'same': False}, 'OP': 'REPM'}
{'src': {'type': 'addresses_D_ht', 'congruent': 2, 'same': False}, 'dst': {'type': 'addresses_UC_ht', 'congruent': 8, 'same': False}, 'OP': 'REPM'}
