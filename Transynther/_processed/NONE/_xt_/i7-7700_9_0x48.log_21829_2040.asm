...
push %rdi
push %rsi
lea addresses_WC_ht+0x8dd1, %rsi
lea addresses_A_ht+0x1ad61, %rdi
nop
nop
nop
cmp $6428, %r12
...
mov (%r14), %di
dec %rdi
lea addresses_D_ht+0x16fd1, %rsi
inc %r11
mov (%rsi), %r12d
dec %rcx
lea addresses_normal_ht+0x743, %r12
nop
nop
nop
nop
...
nop
sub %rdi, %rdi
lea addresses_D_ht+0x1a0b1, %r12
sub $39847, %r14
movw $0x6162, (%r12)
nop
nop
...
{'OP': 'LOAD', 'src': {'type': 'addresses_D_ht', 'AVXalign': True, 'congruent': 8, 'size': 4, 'same': False, 'NT': False}}
