...
push %rdi
push %rsi
lea addresses_normal_ht+0x1ddb8, %r13
clflush (%r13)
nop
nop
nop
...
nop
add $29044, %r11
lea addresses_normal_ht+0x4fb8, %rbx
nop
nop
nop
nop
...
nop
and %rax, %rax
lea addresses_UC_ht+0x15d9a, %rbp
nop
xor $34583, %r14
mov (%rbp), %r11
xor %r13, %r13
lea addresses_UC_ht+0x6cf8, %rsi
