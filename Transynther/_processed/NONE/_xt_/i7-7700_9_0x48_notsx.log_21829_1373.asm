...
push %rdx
push %rsi
lea addresses_normal_ht+0x17ddc, %rcx
clflush (%rcx)
nop
nop
nop
...
rep movsw
and $37331, %r10
lea addresses_WC_ht+0x7668, %rsi
add %rdi, %rdi
movl $0x61626364, (%rsi)
nop
nop
...
nop
sub %rsi, %rsi
lea addresses_UC_ht+0x609c, %r13
nop
xor %rcx, %rcx
...
nop
cmp $37933, %r13
lea addresses_D_ht+0x33dc, %rsi
lea addresses_WC_ht+0xa5cc, %rdi
nop
nop
sub %r8, %r8
mov $119, %rcx
...
{'dst': {'same': False, 'congruent': 2, 'type': 'addresses_WC_ht'}, 'OP': 'REPM', 'src': {'same': False, 'congruent': 6, 'type': 'addresses_D_ht'}}
{'38': 21829}
