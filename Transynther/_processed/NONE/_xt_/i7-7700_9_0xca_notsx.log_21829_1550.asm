...
push %rdx
push %rsi
lea addresses_WT_ht+0x9bb, %rsi
lea addresses_UC_ht+0x14c8b, %rdi
nop
nop
xor $33660, %r10
mov $13, %rcx
...
nop
inc %rdx
lea addresses_WT_ht+0x1b76b, %rbx
nop
nop
nop
nop
...
nop
sub $55847, %rdi
lea addresses_normal_ht+0x9deb, %rsi
lea addresses_WC_ht+0x1b36b, %rdi
clflush (%rdi)
nop
nop
nop
...
// Store
lea addresses_normal+0xf7ab, %rax
nop
nop
nop
nop
...
// Store
lea addresses_normal+0x1b6b, %rbp
nop
nop
nop
nop
...
<gen_prepare_buffer>
{'src': {'congruent': 3, 'same': False, 'type': 'addresses_WT_ht'}, 'dst': {'congruent': 5, 'same': False, 'type': 'addresses_UC_ht'}, 'OP': 'REPM'}
