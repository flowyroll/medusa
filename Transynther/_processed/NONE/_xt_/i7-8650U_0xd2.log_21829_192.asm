...
push %rdx
push %rsi
lea addresses_WC_ht+0x16167, %rdi
nop
nop
nop
dec %rsi
...
nop
and %rdx, %rdx
lea addresses_A_ht+0x17367, %rsi
...
nop
inc %rbx
lea addresses_A_ht+0x18367, %rsi
lea addresses_UC_ht+0x1bb67, %rdi
nop
nop
cmp %r14, %r14
mov $16, %rcx
...
nop
and $19662, %r14
lea addresses_normal_ht+0xc9e7, %rsi
lea addresses_WC_ht+0x1aa67, %rdi
nop
nop
nop
nop
...
nop
mfence
lea addresses_WT_ht+0x10de7, %rdx
nop
nop
nop
xor %rcx, %rcx
...
nop
sub %rsi, %rsi
lea addresses_A_ht+0x13c67, %rdx
nop
nop
cmp %rbx, %rbx
