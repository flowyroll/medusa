...
nop
and %r13, %r13
lea addresses_UC_ht+0xb07f, %rbp
inc %r13
...
movq %rbx, (%rdi)
and %r8, %r8
lea addresses_D_ht+0x1d467, %r14
nop
nop
sub $402, %rbp
movb (%r14), %r13b
...
nop
xor $54069, %rbp
lea addresses_WT_ht+0x1c0ff, %r14
clflush (%r14)
nop
nop
nop
...
nop
add %r14, %r14
lea addresses_WC_ht+0x1031f, %rsi
lea addresses_A_ht+0x627f, %rdi
nop
nop
nop
dec %rbp
...
nop
add $377, %rcx
lea addresses_normal_ht+0x1d4df, %rcx
clflush (%rcx)
add $63720, %rdi
mov (%rcx), %r8
nop
...
nop
and $49247, %r13
lea addresses_UC_ht+0x4e47, %rbx
nop
nop
nop
sub $65043, %r14
...
nop
sub $19178, %rbp
lea addresses_normal_ht+0xe47f, %rbx
nop
nop
nop
nop
...
{'OP': 'STOR', 'dst': {'type': 'addresses_normal_ht', 'AVXalign': False, 'size': 8, 'NT': True, 'same': False, 'congruent': 11}}
...
{'src': {'type': 'addresses_WC_ht', 'congruent': 5, 'same': False}, 'OP': 'REPM', 'dst': {'type': 'addresses_A_ht', 'congruent': 8, 'same': False}}
...
{'src': {'type': 'addresses_normal_ht', 'AVXalign': True, 'size': 4, 'NT': False, 'same': False, 'congruent': 10}, 'OP': 'LOAD'}
{'32': 21829}
