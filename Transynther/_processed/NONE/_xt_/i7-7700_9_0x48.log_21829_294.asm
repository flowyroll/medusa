...
push %rdx
push %rsi
lea addresses_WT_ht+0x11f6b, %rcx
nop
nop
nop
nop
...
nop
dec %r13
lea addresses_normal_ht+0x1547d, %rsi
lea addresses_UC_ht+0x1344d, %rdi
nop
nop
nop
nop
...
nop
add %rcx, %rcx
lea addresses_UC_ht+0x1584d, %rsi
lea addresses_D_ht+0x17fcd, %rdi
nop
nop
nop
nop
...
nop
dec %rsi
lea addresses_WT_ht+0x1c4bd, %rdx
nop
nop
nop
add $47550, %rsi
...
nop
cmp %rax, %rax
lea addresses_WT_ht+0x1624d, %r14
xor $43771, %rdx
...
nop
xor %rdi, %rdi
lea addresses_normal_ht+0x1532d, %rdi
nop
nop
nop
nop
...
nop
and %r13, %r13
lea addresses_normal_ht+0x1ea6d, %rsi
lea addresses_normal_ht+0x1ae8d, %rdi
nop
nop
nop
nop
...
nop
inc %r8
lea addresses_A_ht+0x12b4d, %rcx
and $59615, %r13
movb $0x61, (%rcx)
nop
nop
...
// Faulty Load
lea addresses_normal+0x1e24d, %r14
nop
cmp %r10, %r10
vmovups (%r14), %ymm5
...
{'OP': 'STOR', 'dst': {'type': 'addresses_NC', 'AVXalign': True, 'congruent': 2, 'size': 8, 'same': False, 'NT': False}}
...
{'OP': 'LOAD', 'src': {'type': 'addresses_normal_ht', 'AVXalign': True, 'congruent': 4, 'size': 4, 'same': True, 'NT': False}}
{'OP': 'STOR', 'dst': {'type': 'addresses_WT_ht', 'AVXalign': False, 'congruent': 8, 'size': 2, 'same': False, 'NT': False}}
{'OP': 'REPM', 'src': {'type': 'addresses_normal_ht', 'congruent': 4, 'same': False}, 'dst': {'type': 'addresses_normal_ht', 'congruent': 2, 'same': True}}
{'OP': 'STOR', 'dst': {'type': 'addresses_A_ht', 'AVXalign': False, 'congruent': 4, 'size': 1, 'same': False, 'NT': True}}
{'34': 21829}
