...
push %rcx
push %rdi
lea addresses_WT_ht+0x1dd0b, %r15
nop
nop
nop
nop
...
nop
add %r9, %r9
lea addresses_D_ht+0x13f0b, %rdi
nop
nop
xor $57260, %rcx
vmovups (%rdi), %ymm0
...
nop
add $60667, %r9
lea addresses_WT_ht+0x3863, %rbx
nop
nop
and %rbp, %rbp
movb $0x61, (%rbx)
add %rcx, %rcx
lea addresses_WC_ht+0x12c8b, %r9
nop
nop
nop
nop
...
nop
add %r15, %r15
lea addresses_normal_ht+0xa70b, %rdi
clflush (%rdi)
nop
nop
nop
...
nop
and $2262, %rbp
lea addresses_WT_ht+0xab63, %rbx
nop
nop
cmp $35873, %r9
...
// Store
lea addresses_normal+0x15c8b, %r15
nop
nop
nop
inc %r12
...
// Load
lea addresses_normal+0x498b, %r10
sub $22205, %rax
movb (%r10), %r8b
nop
nop
...
{'OP': 'LOAD', 'src': {'same': False, 'NT': False, 'AVXalign': False, 'size': 1, 'type': 'addresses_normal', 'congruent': 5}}
[Faulty Load]
