...
nop
and %rcx, %rcx
lea addresses_WT_ht+0x10e2f, %rax
nop
nop
nop
nop
...
vpextrq $1, %xmm4, %r15
cmp $29713, %rax
lea addresses_WC_ht+0x12d7f, %rbx
nop
nop
nop
add %rax, %rax
...
vpextrq $1, %xmm2, %rsi
xor %r12, %r12
lea addresses_WT_ht+0xd8ff, %rsi
...
nop
xor $27360, %rcx
lea addresses_UC_ht+0xa41, %rsi
lea addresses_A_ht+0x7c9f, %rdi
nop
cmp $65152, %rbx
mov $29, %rcx
rep movsb
...
nop
xor $3074, %r15
lea addresses_D_ht+0xbc49, %r11
nop
add $1829, %rcx
mov (%r11), %si
nop
sub %rbx, %rbx
lea addresses_A_ht+0x16fdf, %rax
nop
nop
nop
mfence
...
nop
sub %rax, %rax
lea addresses_WT_ht+0x7a69, %rsi
nop
nop
nop
nop
...
nop
sub $20871, %rax
lea addresses_WT_ht+0xf717, %r12
nop
nop
nop
nop
...
nop
dec %rsi
lea addresses_normal_ht+0x1253f, %r15
clflush (%r15)
nop
nop
nop
...
{'dst': {'same': False, 'congruent': 10, 'type': 'addresses_WC_ht'}, 'OP': 'REPM', 'src': {'same': False, 'congruent': 7, 'type': 'addresses_WT_ht'}}
{'dst': {'same': False, 'congruent': 5, 'type': 'addresses_A_ht'}, 'OP': 'REPM', 'src': {'same': False, 'congruent': 1, 'type': 'addresses_UC_ht'}}
{'OP': 'LOAD', 'src': {'same': False, 'NT': False, 'AVXalign': False, 'size': 2, 'type': 'addresses_D_ht', 'congruent': 1}}
{'OP': 'LOAD', 'src': {'same': False, 'NT': True, 'AVXalign': False, 'size': 8, 'type': 'addresses_A_ht', 'congruent': 5}}
{'OP': 'LOAD', 'src': {'same': False, 'NT': False, 'AVXalign': False, 'size': 1, 'type': 'addresses_WT_ht', 'congruent': 1}}
{'dst': {'same': False, 'congruent': 4, 'type': 'addresses_WT_ht'}, 'OP': 'REPM', 'src': {'same': False, 'congruent': 4, 'type': 'addresses_WT_ht'}}
