...
push %rdi
push %rsi
lea addresses_WC_ht+0x5df2, %rbp
xor %rsi, %rsi
...
nop
add $19251, %rbp
lea addresses_UC_ht+0x11d72, %r14
nop
nop
nop
nop
...
movb (%r8), %al
sub %rsi, %rsi
lea addresses_normal_ht+0x1110, %rsi
lea addresses_D_ht+0x12d72, %rdi
nop
nop
and $48218, %r14
mov $70, %rcx
...
nop
and %r10, %r10
lea addresses_normal_ht+0x6d52, %rbp
nop
nop
nop
nop
