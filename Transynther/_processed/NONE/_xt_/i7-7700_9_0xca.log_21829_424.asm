...
push %rdx
push %rsi
lea addresses_D_ht+0x7974, %r13
nop
xor %r12, %r12
mov (%r13), %r10w
add $24671, %r8
lea addresses_normal_ht+0xafe8, %rax
nop
nop
add $12978, %rdx
movl $0x61626364, (%rax)
...
nop
add $46026, %r8
lea addresses_WC_ht+0x193e8, %r10
nop
nop
nop
and %r14, %r14
...
nop
add %r13, %r13
lea addresses_WC_ht+0x33ec, %r12
nop
nop
and %r8, %r8
mov (%r12), %rdx
xor %rdx, %rdx
lea addresses_WC_ht+0x8fe8, %r14
nop
nop
nop
cmp %rdx, %rdx
...
lea addresses_D_ht+0xc058, %rdi
nop
xor %r10, %r10
mov $60, %rcx
rep movsq
and $59326, %rax
lea addresses_WC_ht+0x16328, %r12
inc %r14
...
nop
and $26670, %r10
lea addresses_D_ht+0x11ae8, %rsi
lea addresses_A_ht+0x17ee8, %rdi
nop
add %rdx, %rdx
mov $7, %rcx
rep movsb
nop
xor %r10, %r10
lea addresses_A_ht+0x11768, %rdx
nop
nop
nop
nop
...
// Load
lea addresses_normal+0x7a18, %r12
nop
nop
nop
nop
...
{'src': {'congruent': 2, 'AVXalign': False, 'same': False, 'size': 8, 'NT': False, 'type': 'addresses_RW'}, 'OP': 'LOAD'}
{'src': {'congruent': 4, 'AVXalign': False, 'same': False, 'size': 1, 'NT': False, 'type': 'addresses_normal'}, 'OP': 'LOAD'}
[Faulty Load]
...
{'src': {'congruent': 11, 'AVXalign': False, 'same': True, 'size': 4, 'NT': False, 'type': 'addresses_WC_ht'}, 'OP': 'LOAD'}
{'src': {'congruent': 7, 'same': False, 'type': 'addresses_UC_ht'}, 'OP': 'REPM', 'dst': {'congruent': 1, 'same': False, 'type': 'addresses_D_ht'}}
