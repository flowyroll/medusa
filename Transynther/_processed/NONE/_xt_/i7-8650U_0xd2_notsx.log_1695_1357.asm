...
push %rdi
push %rsi
lea addresses_WC_ht+0xd50a, %rax
sub %rsi, %rsi
movups (%rax), %xmm2
vpextrq $1, %xmm2, %r13
nop
cmp $45088, %r15
lea addresses_A_ht+0x1e56a, %r9
nop
nop
nop
nop
...
nop
cmp %rax, %rax
lea addresses_UC_ht+0x10fae, %r9
clflush (%r9)
nop
nop
nop
...
nop
sub %r13, %r13
lea addresses_A_ht+0x1e802, %rax
sub $33893, %rdi
movups (%rax), %xmm5
vpextrq $1, %xmm5, %r9
nop
...
nop
cmp %r9, %r9
lea addresses_UC_ht+0x3c82, %r15
nop
nop
nop
nop
...
{'OP': 'STOR', 'dst': {'type': 'addresses_A_ht', 'size': 2, 'AVXalign': True, 'NT': False, 'congruent': 1, 'same': False}}
