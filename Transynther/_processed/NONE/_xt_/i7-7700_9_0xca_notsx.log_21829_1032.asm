...
push %rdx
push %rsi
lea addresses_A_ht+0x1d924, %rdx
nop
and $50506, %r10
movups (%rdx), %xmm3
vpextrq $0, %xmm3, %rcx
...
nop
add $6850, %rax
lea addresses_D_ht+0xc472, %rsi
lea addresses_D_ht+0x18b12, %rdi
clflush (%rsi)
nop
nop
nop
...
rep movsq
add %rcx, %rcx
lea addresses_WC_ht+0xda12, %rsi
lea addresses_normal_ht+0x9e12, %rdi
sub %rbx, %rbx
mov $24, %rcx
rep movsw
nop
...
nop
and %rdx, %rdx
lea addresses_D_ht+0x14192, %r14
nop
nop
nop
nop
...
nop
xor $64542, %rsi
lea addresses_UC_ht+0x15f12, %rsi
nop
add $36719, %rcx
...
nop
xor $45482, %r14
lea addresses_WT_ht+0x92a2, %rbx
sub $49956, %rsi
vmovups (%rbx), %ymm2
...
nop
xor %rdx, %rdx
lea addresses_A_ht+0xcf12, %rsi
lea addresses_UC_ht+0x14b12, %rdi
xor %r10, %r10
mov $85, %rcx
rep movsl
nop
...
{'dst': {'NT': False, 'AVXalign': True, 'size': 16, 'congruent': 5, 'same': False, 'type': 'addresses_US'}, 'OP': 'STOR'}
[Faulty Load]
...
{'src': {'congruent': 5, 'same': False, 'type': 'addresses_D_ht'}, 'dst': {'congruent': 8, 'same': False, 'type': 'addresses_D_ht'}, 'OP': 'REPM'}
{'src': {'congruent': 6, 'same': True, 'type': 'addresses_WC_ht'}, 'dst': {'congruent': 7, 'same': True, 'type': 'addresses_normal_ht'}, 'OP': 'REPM'}
...
{'src': {'congruent': 7, 'same': False, 'type': 'addresses_A_ht'}, 'dst': {'congruent': 8, 'same': True, 'type': 'addresses_UC_ht'}, 'OP': 'REPM'}
{'32': 21829}
