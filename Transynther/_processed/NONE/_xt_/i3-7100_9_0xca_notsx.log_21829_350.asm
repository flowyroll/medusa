...
push %rdi
push %rsi
lea addresses_WC_ht+0x14135, %rsi
lea addresses_WT_ht+0xd2b5, %rdi
and $14151, %r9
mov $40, %rcx
rep movsq
cmp $6823, %r11
lea addresses_normal_ht+0x7169, %rsi
lea addresses_A_ht+0x2fd9, %rdi
xor %r9, %r9
mov $124, %rcx
rep movsl
add $33546, %r9
lea addresses_WC_ht+0x1ef59, %r10
nop
nop
nop
nop
...
{'src': {'type': 'addresses_P', 'congruent': 11, 'same': False}, 'OP': 'REPM', 'dst': {'type': 'addresses_WC', 'congruent': 9, 'same': False}}
...
{'src': {'type': 'addresses_normal_ht', 'congruent': 4, 'same': True}, 'OP': 'REPM', 'dst': {'type': 'addresses_A_ht', 'congruent': 11, 'same': False}}
