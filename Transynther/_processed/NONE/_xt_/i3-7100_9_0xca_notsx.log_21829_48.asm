...
lea addresses_UC_ht+0x148ad, %rdi
nop
nop
dec %rax
mov $87, %rcx
...
lea addresses_WC_ht+0x52ad, %rdi
dec %r8
mov $58, %rcx
rep movsl
nop
...
nop
sub %rbx, %rbx
lea addresses_WC_ht+0x184ad, %rsi
...
<gen_prepare_buffer>
{'src': {'type': 'addresses_normal_ht', 'congruent': 7, 'same': False}, 'OP': 'REPM', 'dst': {'type': 'addresses_UC_ht', 'congruent': 10, 'same': False}}
