...
push %rdi
push %rsi
lea addresses_WC_ht+0x28df, %rsi
lea addresses_A_ht+0xf17e, %rdi
nop
dec %r10
mov $90, %rcx
rep movsl
...
nop
cmp $4980, %rsi
lea addresses_normal_ht+0x1b87e, %rsi
lea addresses_WT_ht+0xa57e, %rdi
nop
nop
nop
nop
...
{'OP': 'LOAD', 'src': {'same': False, 'type': 'addresses_WC', 'NT': False, 'AVXalign': True, 'size': 1, 'congruent': 10}}
[Faulty Load]
{'OP': 'LOAD', 'src': {'same': True, 'type': 'addresses_RW', 'NT': False, 'AVXalign': False, 'size': 4, 'congruent': 0}}
<gen_prepare_buffer>
{'OP': 'REPM', 'src': {'same': False, 'congruent': 0, 'type': 'addresses_WC_ht'}, 'dst': {'same': True, 'congruent': 8, 'type': 'addresses_A_ht'}}
