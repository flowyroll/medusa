...
push %rdi
push %rsi
lea addresses_WT_ht+0x1d315, %r8
clflush (%r8)
xor $8446, %r14
movb $0x61, (%r8)
and %r12, %r12
lea addresses_A_ht+0x1be55, %r11
nop
nop
nop
xor %r8, %r8
movb $0x61, (%r11)
xor $28752, %r14
lea addresses_normal_ht+0x51d5, %r15
nop
nop
nop
nop
...
nop
dec %r8
lea addresses_A_ht+0xf1d5, %rsi
lea addresses_normal_ht+0x10809, %rdi
clflush (%rsi)
nop
nop
sub $63522, %r8
...
nop
and $58140, %rsi
lea addresses_WT_ht+0x9f55, %r14
nop
nop
nop
nop
...
// Faulty Load
lea addresses_normal+0x149d5, %rbx
nop
nop
and %rsi, %rsi
mov (%rbx), %r13w
...
<gen_prepare_buffer>
{'dst': {'NT': True, 'AVXalign': True, 'size': 1, 'congruent': 6, 'same': True, 'type': 'addresses_WT_ht'}, 'OP': 'STOR'}
...
{'src': {'congruent': 10, 'same': False, 'type': 'addresses_A_ht'}, 'dst': {'congruent': 0, 'same': False, 'type': 'addresses_normal_ht'}, 'OP': 'REPM'}
