...
nop
and %r13, %r13
lea addresses_UC_ht+0x186e7, %rsi
nop
nop
nop
nop
...
nop
xor $25725, %r13
lea addresses_WT_ht+0x1d9e7, %rcx
nop
nop
nop
add $27040, %rbp
...
nop
dec %r8
lea addresses_WC_ht+0x188c7, %rcx
clflush (%rcx)
nop
nop
nop
...
{'src': {'same': False, 'congruent': 9, 'NT': True, 'type': 'addresses_WC_ht', 'size': 4, 'AVXalign': False}, 'OP': 'LOAD'}
{'32': 21829}
