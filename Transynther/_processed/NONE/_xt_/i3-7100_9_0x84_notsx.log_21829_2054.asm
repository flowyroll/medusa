...
vpextrq $0, %xmm2, %r11
sub $49254, %rbp
lea addresses_normal_ht+0x9d1d, %rbx
nop
inc %rdx
movl $0x61626364, (%rbx)
nop
...
nop
lfence
lea addresses_WC_ht+0x1b835, %rbp
nop
nop
nop
inc %rdx
...
nop
and $63573, %rdx
lea addresses_normal_ht+0x5c2d, %r11
nop
nop
nop
sub %rbx, %rbx
...
{'dst': {'type': 'addresses_normal_ht', 'same': False, 'size': 2, 'congruent': 7, 'NT': True, 'AVXalign': False}, 'OP': 'STOR'}
{'33': 21829}
