...
push %rdi
push %rsi
lea addresses_WT_ht+0x190da, %r11
nop
nop
xor %r8, %r8
mov (%r11), %rbp
...
nop
sub $32745, %r10
lea addresses_UC_ht+0x18da, %rdi
nop
nop
nop
nop
...
mov (%rdi), %eax
and %r11, %r11
lea addresses_normal_ht+0xbf62, %r11
clflush (%r11)
nop
nop
and %rcx, %rcx
...
nop
sub %r11, %r11
lea addresses_UC_ht+0xb7da, %rbp
nop
nop
nop
nop
...
nop
add %rdi, %rdi
lea addresses_normal_ht+0x188b4, %r8
nop
nop
nop
and $53342, %rcx
...
nop
and $30845, %r11
lea addresses_A_ht+0x1911a, %rcx
nop
nop
add %r8, %r8
movl $0x61626364, (%rcx)
...
nop
and $33290, %rax
lea addresses_UC_ht+0x19b5a, %r11
nop
nop
nop
nop
...
nop
sub %rax, %rax
lea addresses_normal_ht+0x48da, %rsi
...
nop
and $7336, %r10
lea addresses_UC_ht+0xc89a, %rcx
nop
nop
nop
nop
