...
movb (%r9), %dl
inc %rbx
lea addresses_normal_ht+0xede7, %rbx
nop
nop
nop
nop
...
nop
add %r10, %r10
lea addresses_normal_ht+0x1b5f7, %rbx
nop
nop
nop
nop
...
nop
and %r10, %r10
lea addresses_D_ht+0x18937, %r11
nop
nop
nop
nop
...
nop
cmp %rbp, %rbp
lea addresses_WC_ht+0x4577, %r11
nop
add %rdx, %rdx
movw $0x6162, (%r11)
nop
...
lea addresses_WC_ht+0x14c0f, %rdi
and $55738, %rdx
mov $55, %rcx
rep movsb
nop
...
nop
add %r10, %r10
lea addresses_WC_ht+0x2247, %rsi
lea addresses_WT_ht+0x12213, %rdi
nop
nop
nop
nop
...
rep movsl
add %rbp, %rbp
lea addresses_normal_ht+0x126a9, %rsi
clflush (%rsi)
cmp $12816, %rcx
...
nop
xor %rdx, %rdx
lea addresses_normal_ht+0xcccb, %rsi
lea addresses_WC_ht+0x127d7, %rdi
nop
nop
nop
nop
...
nop
add $62806, %r11
lea addresses_D_ht+0x7357, %rsi
lea addresses_WC_ht+0xda97, %rdi
nop
nop
nop
lfence
...
rep movsw
add %rbx, %rbx
lea addresses_UC_ht+0x10152, %rbx
nop
nop
nop
nop
...
{'src': {'congruent': 8, 'same': False, 'type': 'addresses_UC_ht'}, 'OP': 'REPM', 'dst': {'congruent': 0, 'same': True, 'type': 'addresses_WC_ht'}}
{'src': {'congruent': 1, 'same': False, 'type': 'addresses_WC_ht'}, 'OP': 'REPM', 'dst': {'congruent': 1, 'same': False, 'type': 'addresses_WT_ht'}}
{'OP': 'STOR', 'dst': {'congruent': 0, 'AVXalign': False, 'same': True, 'size': 16, 'NT': False, 'type': 'addresses_normal_ht'}}
{'src': {'congruent': 0, 'same': True, 'type': 'addresses_normal_ht'}, 'OP': 'REPM', 'dst': {'congruent': 11, 'same': False, 'type': 'addresses_WC_ht'}}
{'src': {'congruent': 7, 'same': False, 'type': 'addresses_D_ht'}, 'OP': 'REPM', 'dst': {'congruent': 5, 'same': False, 'type': 'addresses_WC_ht'}}
