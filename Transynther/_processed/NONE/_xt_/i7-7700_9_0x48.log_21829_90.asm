...
push %rdx
push %rsi
lea addresses_WC_ht+0x636a, %rdi
cmp $1236, %r9
vmovups (%rdi), %ymm6
...
lea addresses_WC_ht+0x1862c, %rdi
nop
nop
nop
xor %rbx, %rbx
...
nop
dec %rsi
lea addresses_UC_ht+0x1e07c, %rsi
lea addresses_normal_ht+0x145cc, %rdi
add %r14, %r14
mov $26, %rcx
rep movsl
and %rbx, %rbx
lea addresses_normal_ht+0x1bffb, %rsi
lea addresses_D_ht+0x74bc, %rdi
clflush (%rdi)
nop
nop
and %rdx, %rdx
...
{'OP': 'STOR', 'dst': {'type': 'addresses_A', 'AVXalign': False, 'congruent': 6, 'size': 16, 'same': False, 'NT': True}}
