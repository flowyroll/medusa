...
push %rdx
push %rsi
lea addresses_A_ht+0x1e6d1, %rsi
lea addresses_WC_ht+0x1b838, %rdi
nop
nop
nop
nop
...
nop
cmp $50437, %rsi
lea addresses_WT_ht+0x14fd1, %r8
nop
nop
nop
nop
...
nop
cmp %r8, %r8
lea addresses_WT_ht+0xe651, %rsi
lea addresses_WC_ht+0xa0d1, %rdi
clflush (%rdi)
nop
nop
nop
...
nop
cmp $6339, %r8
lea addresses_WT_ht+0x3399, %rsi
nop
nop
nop
nop
...
nop
cmp %r11, %r11
lea addresses_A_ht+0x15151, %r11
and %rdx, %rdx
mov $0x6162636465666768, %rsi
movq %rsi, (%r11)
inc %rcx
lea addresses_A_ht+0x19bd1, %rcx
nop
dec %r9
mov (%rcx), %dx
nop
sub $48120, %r11
lea addresses_UC_ht+0xffd1, %rcx
dec %rsi
...
nop
inc %r9
lea addresses_WT_ht+0x3e51, %r11
nop
nop
and $23024, %rdi
vmovups (%r11), %ymm1
...
nop
xor %rcx, %rcx
lea addresses_WC_ht+0xcbd1, %rsi
lea addresses_normal_ht+0xe2d1, %rdi
nop
and $17905, %rbp
mov $71, %rcx
rep movsw
...
{'OP': 'STOR', 'dst': {'same': True, 'type': 'addresses_UC_ht', 'NT': False, 'AVXalign': False, 'size': 32, 'congruent': 10}}
{'OP': 'LOAD', 'src': {'same': False, 'type': 'addresses_WT_ht', 'NT': False, 'AVXalign': False, 'size': 32, 'congruent': 7}}
{'OP': 'REPM', 'src': {'same': False, 'congruent': 10, 'type': 'addresses_WC_ht'}, 'dst': {'same': False, 'congruent': 8, 'type': 'addresses_normal_ht'}}
{'36': 21829}
