...
push %rdi
push %rsi
lea addresses_D_ht+0x127e4, %rsi
lea addresses_D_ht+0x13b54, %rdi
nop
nop
nop
nop
...
nop
sub $30412, %r9
lea addresses_WT_ht+0x67e4, %rsi
lea addresses_normal_ht+0x1e164, %rdi
nop
nop
nop
nop
...
nop
cmp $63944, %rsi
lea addresses_UC_ht+0x1d164, %rsi
...
nop
and $4164, %rdi
lea addresses_normal_ht+0x29e4, %rsi
lea addresses_normal_ht+0x286, %rdi
clflush (%rdi)
nop
nop
cmp $35363, %r8
...
lea addresses_normal_ht+0x5464, %rdi
nop
inc %r9
mov $68, %rcx
rep movsb
...
nop
cmp $44221, %r8
lea addresses_normal_ht+0x124aa, %rax
xor %rcx, %rcx
movb $0x61, (%rax)
dec %rdi
lea addresses_WC_ht+0x6764, %rsi
nop
nop
nop
nop
...
// Faulty Load
lea addresses_normal+0x16764, %rbp
clflush (%rbp)
nop
nop
nop
...
{'OP': 'STOR', 'dst': {'type': 'addresses_D_ht', 'AVXalign': False, 'congruent': 4, 'size': 16, 'same': True, 'NT': False}}
{'OP': 'REPM', 'src': {'type': 'addresses_WT_ht', 'congruent': 2, 'same': False}, 'dst': {'type': 'addresses_normal_ht', 'congruent': 9, 'same': False}}
{'OP': 'REPM', 'src': {'type': 'addresses_UC_ht', 'congruent': 8, 'same': True}, 'dst': {'type': 'addresses_normal_ht', 'congruent': 3, 'same': False}}
{'OP': 'LOAD', 'src': {'type': 'addresses_A_ht', 'AVXalign': False, 'congruent': 10, 'size': 4, 'same': False, 'NT': False}}
{'OP': 'REPM', 'src': {'type': 'addresses_normal_ht', 'congruent': 7, 'same': False}, 'dst': {'type': 'addresses_normal_ht', 'congruent': 1, 'same': False}}
