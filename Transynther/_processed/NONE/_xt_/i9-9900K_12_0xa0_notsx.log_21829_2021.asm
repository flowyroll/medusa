...
nop
cmp %r10, %r10
lea addresses_UC_ht+0x1e37d, %r9
nop
nop
nop
nop
...
nop
sub %r9, %r9
lea addresses_UC_ht+0x2cbd, %r14
nop
nop
xor %rbx, %rbx
movw $0x6162, (%r14)
nop
cmp %rcx, %rcx
lea addresses_A_ht+0x3575, %r14
nop
xor $52045, %r8
movl $0x61626364, (%r14)
dec %rbx
lea addresses_WC_ht+0x15a3d, %rsi
lea addresses_UC_ht+0xbd4d, %rdi
nop
nop
nop
nop
...
nop
and %rsi, %rsi
lea addresses_WC_ht+0xf141, %rbx
cmp %rcx, %rcx
mov (%rbx), %si
nop
nop
...
nop
lfence
lea addresses_A_ht+0x1a1e0, %rcx
xor %r8, %r8
movb (%rcx), %r9b
nop
nop
...
lea addresses_WT_ht+0x1603d, %rdi
nop
nop
nop
sub $41052, %r14
...
nop
add %r10, %r10
lea addresses_WT_ht+0x97f9, %r14
nop
nop
nop
nop
...
{'OP': 'STOR', 'dst': {'type': 'addresses_UC_ht', 'AVXalign': False, 'size': 2, 'NT': False, 'same': True, 'congruent': 7}}
{'OP': 'STOR', 'dst': {'type': 'addresses_A_ht', 'AVXalign': False, 'size': 4, 'NT': False, 'same': False, 'congruent': 1}}
{'src': {'type': 'addresses_WC_ht', 'congruent': 7, 'same': False}, 'OP': 'REPM', 'dst': {'type': 'addresses_UC_ht', 'congruent': 2, 'same': False}}
