...
nop
cmp $32822, %rdx
lea addresses_WC_ht+0x1d32c, %rsi
lea addresses_WC_ht+0x10f2c, %rdi
nop
nop
nop
and %r9, %r9
...
nop
add %r8, %r8
lea addresses_UC_ht+0x2f2c, %rbx
nop
nop
nop
nop
...
nop
sub %r8, %r8
lea addresses_WC_ht+0x1152c, %r9
nop
sub %rsi, %rsi
vmovups (%r9), %ymm4
...
nop
cmp $7743, %rdx
lea addresses_normal_ht+0x182c, %rsi
lea addresses_A_ht+0x19504, %rdi
nop
add $54950, %r11
mov $27, %rcx
rep movsb
nop
and $5483, %r11
lea addresses_UC_ht+0x1d720, %r11
and $22412, %rsi
mov (%r11), %di
nop
nop
nop
xor $5239, %rsi
lea addresses_WT_ht+0x88b3, %rdi
nop
nop
xor %r11, %r11
...
vmovups %ymm6, (%rdi)
dec %rsi
lea addresses_A_ht+0x4b2c, %rsi
lea addresses_WC_ht+0x1d14c, %rdi
nop
nop
nop
add $55496, %r9
...
{'src': {'type': 'addresses_normal_ht', 'congruent': 8, 'same': False}, 'dst': {'type': 'addresses_A_ht', 'congruent': 2, 'same': False}, 'OP': 'REPM'}
...
{'src': {'type': 'addresses_A_ht', 'congruent': 10, 'same': False}, 'dst': {'type': 'addresses_WC_ht', 'congruent': 4, 'same': True}, 'OP': 'REPM'}
{'src': {'type': 'addresses_A_ht', 'same': False, 'size': 2, 'congruent': 9, 'NT': True, 'AVXalign': False}, 'OP': 'LOAD'}
{'33': 21829}
