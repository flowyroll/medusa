...
push %rdi
push %rsi
lea addresses_A_ht+0x38d, %rsi
lea addresses_WC_ht+0x6805, %rdi
nop
nop
nop
cmp $15812, %r13
...
nop
add %r13, %r13
lea addresses_normal_ht+0x12b8d, %rsi
...
nop
xor $35930, %r13
lea addresses_D_ht+0x14a8d, %rsi
nop
nop
nop
cmp %r15, %r15
...
nop
xor %r10, %r10
lea addresses_A_ht+0x658d, %rsi
lea addresses_WC_ht+0x195df, %rdi
nop
and $37211, %r10
mov $4, %rcx
rep movsl
