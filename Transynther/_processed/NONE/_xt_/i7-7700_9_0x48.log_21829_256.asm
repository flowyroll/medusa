...
push %rdx
push %rsi
lea addresses_WT_ht+0x10030, %rax
nop
inc %r13
...
nop
sub $13336, %r15
lea addresses_normal_ht+0x4eaa, %rsi
nop
lfence
mov (%rsi), %rdi
nop
...
nop
add %r14, %r14
lea addresses_UC_ht+0x178e0, %rsi
nop
nop
nop
xor %r15, %r15
...
nop
add %rcx, %rcx
lea addresses_normal_ht+0x125b0, %rsi
nop
nop
nop
nop
...
nop
and $37055, %rcx
lea addresses_normal_ht+0x18fb0, %rsi
lea addresses_UC_ht+0x960b, %rdi
nop
nop
nop
nop
...
rep movsl
add %rcx, %rcx
lea addresses_UC_ht+0x12830, %rsi
lea addresses_WC_ht+0x197b0, %rdi
nop
nop
inc %rdx
mov $113, %rcx
...
// Faulty Load
lea addresses_normal+0x16fb0, %r9
nop
sub $53911, %rdx
movb (%r9), %r10b
lea oracles, %rcx
...
<gen_prepare_buffer>
{'OP': 'STOR', 'dst': {'type': 'addresses_WT_ht', 'AVXalign': False, 'congruent': 6, 'size': 32, 'same': True, 'NT': False}}
...
{'OP': 'REPM', 'src': {'type': 'addresses_UC_ht', 'congruent': 6, 'same': False}, 'dst': {'type': 'addresses_WC_ht', 'congruent': 8, 'same': True}}
{'34': 21829}
