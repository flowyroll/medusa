...
lea addresses_UC_ht+0x191f, %rdi
clflush (%rdi)
nop
nop
nop
...
rep movsq
inc %rdx
lea addresses_WT_ht+0x14b81, %rdi
nop
nop
nop
inc %r13
...
nop
inc %rdx
lea addresses_WT_ht+0x5477, %rcx
nop
nop
nop
nop
...
nop
xor %rdx, %rdx
lea addresses_WC_ht+0x19523, %rsi
lea addresses_UC_ht+0xe3af, %rdi
nop
nop
nop
sub $17501, %r11
...
nop
add $23952, %rdx
lea addresses_UC_ht+0x1eb1f, %rsi
lea addresses_A_ht+0xff8f, %rdi
nop
nop
nop
nop
...
nop
add $13281, %r11
lea addresses_WC_ht+0x18d1f, %rcx
nop
nop
xor %rsi, %rsi
...
vpextrq $0, %xmm5, %r13
and $52191, %rsi
lea addresses_WC_ht+0xa91f, %rax
nop
nop
nop
nop
...
nop
xor $56221, %rbp
lea addresses_A_ht+0x1ed1f, %rdi
inc %rax
mov $0x6162636465666768, %rdx
movq %rdx, (%rdi)
sub %rbp, %rbp
lea addresses_A_ht+0x12b3f, %r11
clflush (%r11)
nop
nop
nop
...
{'OP': 'STOR', 'dst': {'type': 'addresses_WT_ht', 'AVXalign': True, 'congruent': 1, 'size': 32, 'same': False, 'NT': False}}
...
{'OP': 'REPM', 'src': {'type': 'addresses_UC_ht', 'congruent': 9, 'same': False}, 'dst': {'type': 'addresses_A_ht', 'congruent': 4, 'same': False}}
