...
push %rdx
push %rsi
lea addresses_D_ht+0x12e79, %rdi
clflush (%rdi)
nop
nop
sub %rdx, %rdx
...
nop
cmp %rbp, %rbp
lea addresses_WT_ht+0x8431, %rsi
lea addresses_WT_ht+0x7962, %rdi
nop
nop
nop
nop
...
nop
add $24743, %rax
lea addresses_WT_ht+0x5e31, %rsi
lea addresses_WC_ht+0x116b1, %rdi
clflush (%rsi)
nop
nop
nop
...
nop
sub $37723, %rdx
lea addresses_normal_ht+0x129d1, %rsi
lea addresses_UC_ht+0xb7f1, %rdi
nop
nop
nop
nop
...
nop
and %rdi, %rdi
lea addresses_UC_ht+0x1fc1, %rbp
nop
nop
nop
nop
...
nop
add %rbp, %rbp
lea addresses_WT_ht+0xd831, %rbp
inc %rsi
mov (%rbp), %r11w
nop
nop
...
nop
sub %rsi, %rsi
lea addresses_UC_ht+0x122e1, %rsi
lea addresses_D_ht+0x14cd1, %rdi
nop
inc %rax
mov $14, %rcx
rep movsq
...
lea addresses_D_ht+0x15f11, %rdi
sub $64354, %r12
mov $127, %rcx
rep movsb
cmp $60049, %r12
lea addresses_WT_ht+0x17631, %rsi
lea addresses_WT_ht+0x154d9, %rdi
nop
nop
nop
nop
...
{'src': {'congruent': 9, 'same': False, 'type': 'addresses_WT_ht'}, 'dst': {'congruent': 0, 'same': False, 'type': 'addresses_WT_ht'}, 'OP': 'REPM'}
{'src': {'congruent': 7, 'same': False, 'type': 'addresses_WT_ht'}, 'dst': {'congruent': 7, 'same': False, 'type': 'addresses_WC_ht'}, 'OP': 'REPM'}
{'dst': {'NT': False, 'AVXalign': False, 'size': 1, 'congruent': 7, 'same': True, 'type': 'addresses_D_ht'}, 'OP': 'STOR'}
{'src': {'congruent': 2, 'same': True, 'type': 'addresses_normal_ht'}, 'dst': {'congruent': 5, 'same': False, 'type': 'addresses_UC_ht'}, 'OP': 'REPM'}
