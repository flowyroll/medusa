...
push %rdi
push %rsi
lea addresses_WC_ht+0x1a9bd, %rsi
lea addresses_UC_ht+0xf37d, %rdi
nop
nop
add %r11, %r11
mov $82, %rcx
...
nop
and $39213, %r8
lea addresses_A_ht+0x17afd, %rbx
inc %r9
movb $0x61, (%rbx)
nop
nop
nop
add $15351, %rdi
lea addresses_normal_ht+0x695d, %rsi
xor %rdi, %rdi
...
nop
xor %r9, %r9
lea addresses_WT_ht+0x5efd, %rdi
nop
nop
and $5559, %r11
movb $0x61, (%rdi)
...
nop
sub %rbx, %rbx
lea addresses_A_ht+0x56fd, %r11
nop
dec %rdi
movb $0x61, (%r11)
nop
cmp $64320, %rbx
lea addresses_D_ht+0x8efd, %rsi
lea addresses_UC_ht+0x19e7d, %rdi
and $57506, %r14
mov $16, %rcx
rep movsl
nop
