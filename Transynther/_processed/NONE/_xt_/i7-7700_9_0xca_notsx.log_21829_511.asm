...
push %rdx
push %rsi
lea addresses_A_ht+0x103f5, %rsi
nop
nop
cmp $32182, %rbx
...
movq %rcx, (%rsi)
xor $24442, %r14
lea addresses_D_ht+0x6aa5, %r11
nop
add $19291, %r15
mov (%r11), %r14w
and $54495, %r11
lea addresses_A_ht+0xc855, %r11
clflush (%r11)
nop
nop
nop
...
nop
inc %rdx
lea addresses_WT_ht+0x103e5, %r15
nop
nop
nop
xor %rdx, %rdx
...
nop
inc %r15
lea addresses_UC_ht+0x1e5b5, %rsi
lea addresses_D_ht+0x12665, %rdi
nop
nop
nop
nop
...
nop
add %r15, %r15
lea addresses_normal_ht+0x1aef5, %rsi
lea addresses_WT_ht+0x1bd75, %rdi
nop
cmp %rdx, %rdx
mov $109, %rcx
rep movsq
...
nop
add $49421, %rcx
lea addresses_A_ht+0x1dbd5, %r14
nop
nop
nop
nop
...
nop
add %rbx, %rbx
lea addresses_WT_ht+0xe69d, %rdi
nop
nop
nop
nop
...
{'src': {'NT': False, 'AVXalign': True, 'size': 4, 'congruent': 6, 'same': True, 'type': 'addresses_A_ht'}, 'OP': 'LOAD'}
{'src': {'congruent': 4, 'same': False, 'type': 'addresses_normal_ht'}, 'dst': {'congruent': 7, 'same': False, 'type': 'addresses_WT_ht'}, 'OP': 'REPM'}
{'dst': {'NT': False, 'AVXalign': False, 'size': 8, 'congruent': 4, 'same': True, 'type': 'addresses_A_ht'}, 'OP': 'STOR'}
