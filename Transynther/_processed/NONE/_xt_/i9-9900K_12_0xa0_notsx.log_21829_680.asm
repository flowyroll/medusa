...
nop
and %r10, %r10
lea addresses_WC_ht+0x1ae6f, %rsi
lea addresses_WT_ht+0xdfd6, %rdi
nop
xor %rax, %rax
mov $31, %rcx
rep movsl
...
nop
xor %r12, %r12
lea addresses_normal_ht+0x5493, %rsi
nop
cmp %r9, %r9
...
nop
sub $42998, %rsi
lea addresses_normal_ht+0xdda3, %rsi
...
nop
add %rdi, %rdi
lea addresses_A_ht+0x1e963, %rcx
and $15429, %r13
...
nop
sub $48567, %r9
lea addresses_UC_ht+0x141d7, %r12
nop
xor $14941, %rsi
mov (%r12), %rdi
nop
...
nop
sub $48575, %rdi
lea addresses_A_ht+0x1fe3, %rsi
nop
dec %rdi
movb $0x61, (%rsi)
nop
cmp %r13, %r13
lea addresses_normal_ht+0x14f63, %r12
nop
nop
inc %r13
movw $0x6162, (%r12)
...
{'OP': 'STOR', 'dst': {'type': 'addresses_A_ht', 'AVXalign': False, 'size': 2, 'NT': True, 'same': False, 'congruent': 8}}
...
{'OP': 'STOR', 'dst': {'type': 'addresses_A_ht', 'AVXalign': True, 'size': 1, 'NT': False, 'same': False, 'congruent': 5}}
