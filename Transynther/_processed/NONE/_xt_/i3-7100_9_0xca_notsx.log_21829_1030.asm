...
push %rdx
push %rsi
lea addresses_WC_ht+0x14feb, %rax
nop
nop
nop
nop
...
nop
inc %rdx
lea addresses_WC_ht+0x10a8b, %rbx
nop
nop
sub $30133, %r9
movw $0x6162, (%rbx)
...
nop
add %rbx, %rbx
lea addresses_normal_ht+0x1805b, %r9
xor $4270, %r8
vmovups (%r9), %ymm3
...
nop
xor $47184, %rbx
lea addresses_WT_ht+0x106bb, %r13
nop
sub %r9, %r9
movl $0x61626364, (%r13)
and %r13, %r13
lea addresses_D_ht+0x1dbab, %r11
nop
cmp %rdx, %rdx
...
nop
cmp $42454, %r8
lea addresses_A_ht+0xb70b, %rsi
lea addresses_WT_ht+0xce2b, %rdi
nop
dec %r9
mov $83, %rcx
rep movsq
...
{'src': {'type': 'addresses_A_ht', 'congruent': 5, 'same': False}, 'OP': 'REPM', 'dst': {'type': 'addresses_WT_ht', 'congruent': 4, 'same': False}}
{'33': 21829}
