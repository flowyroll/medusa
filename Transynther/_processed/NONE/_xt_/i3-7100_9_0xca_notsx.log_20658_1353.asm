...
push %rdi
push %rdx
lea addresses_WT_ht+0x1541, %r14
nop
nop
xor %rdx, %rdx
mov (%r14), %r15
...
nop
add %rcx, %rcx
lea addresses_UC_ht+0x81c1, %r14
nop
sub $29805, %rdx
...
nop
sub %r12, %r12
lea addresses_WT_ht+0x113c1, %r9
nop
nop
add %rdi, %rdi
vmovups (%r9), %ymm6
...
// Load
lea addresses_normal+0x1e841, %r12
nop
nop
nop
xor $39783, %r15
...
// Faulty Load
lea addresses_normal+0xd9c1, %r13
nop
nop
nop
nop
...
<gen_faulty_load>
[REF]
{'src': {'same': False, 'congruent': 0, 'NT': False, 'type': 'addresses_normal', 'size': 32, 'AVXalign': True}, 'OP': 'LOAD'}
{'OP': 'STOR', 'dst': {'same': False, 'congruent': 4, 'NT': False, 'type': 'addresses_WT', 'size': 1, 'AVXalign': True}}
{'src': {'same': False, 'congruent': 3, 'NT': True, 'type': 'addresses_normal', 'size': 32, 'AVXalign': False}, 'OP': 'LOAD'}
[Faulty Load]
