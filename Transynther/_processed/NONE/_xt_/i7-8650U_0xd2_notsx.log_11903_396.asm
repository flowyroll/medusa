...
push %rdi
push %rsi
lea addresses_normal_ht+0x1d5f7, %r13
nop
nop
sub $27079, %r9
mov (%r13), %eax
...
nop
sub $41174, %rax
lea addresses_D_ht+0x99f7, %rsi
lea addresses_WC_ht+0x77f7, %rdi
dec %rax
mov $49, %rcx
rep movsb
nop
...
nop
xor %rdi, %rdi
lea addresses_WC_ht+0xebf7, %r13
nop
xor $33609, %r10
movw $0x6162, (%r13)
nop
...
nop
sub %rcx, %rcx
lea addresses_WC_ht+0x8c7, %rsi
lea addresses_WT_ht+0x13007, %rdi
nop
nop
nop
add %r8, %r8
...
nop
add %rdi, %rdi
lea addresses_A_ht+0x17db7, %r11
nop
nop
nop
xor %r10, %r10
