...
push %rdi
push %rsi
lea addresses_D_ht+0x19f54, %r14
nop
nop
nop
nop
...
nop
add %r14, %r14
lea addresses_UC_ht+0x1abac, %r15
sub %r10, %r10
mov $0x6162636465666768, %rdi
movq %rdi, (%r15)
and %r12, %r12
lea addresses_D_ht+0x1531c, %rsi
nop
nop
nop
sub $40668, %r12
...
nop
xor %r10, %r10
lea addresses_UC_ht+0x1039c, %r10
nop
nop
nop
xor $557, %rsi
...
nop
add %r13, %r13
lea addresses_WT_ht+0xfe20, %rsi
lea addresses_UC_ht+0x1d39c, %rdi
nop
nop
nop
xor %r12, %r12
...
nop
sub %rsi, %rsi
lea addresses_UC_ht+0x419c, %rsi
lea addresses_WT_ht+0x1b55c, %rdi
sub $3360, %r13
mov $76, %rcx
rep movsw
nop
...
{'src': {'NT': False, 'AVXalign': True, 'size': 16, 'congruent': 7, 'same': False, 'type': 'addresses_D_ht'}, 'OP': 'LOAD'}
...
{'src': {'congruent': 3, 'same': True, 'type': 'addresses_UC_ht'}, 'dst': {'congruent': 6, 'same': False, 'type': 'addresses_WT_ht'}, 'OP': 'REPM'}
{'32': 21829}
