...
push %rdx
push %rsi
lea addresses_UC_ht+0x16ca8, %r13
clflush (%r13)
nop
and $27851, %r14
movw $0x6162, (%r13)
...
nop
xor $32455, %rdx
lea addresses_D_ht+0x18de5, %rsi
lea addresses_normal_ht+0x2287, %rdi
nop
nop
nop
nop
...
nop
sub %r14, %r14
lea addresses_WT_ht+0x1364d, %r14
nop
nop
inc %rcx
mov (%r14), %edx
nop
add $36580, %r14
lea addresses_A_ht+0x1525, %rsi
lea addresses_UC_ht+0x11d51, %rdi
nop
nop
nop
dec %r13
...
nop
and $45029, %r10
lea addresses_D_ht+0x8525, %rsi
nop
and %r8, %r8
mov (%rsi), %r10w
add %r10, %r10
lea addresses_UC_ht+0x7225, %r8
nop
nop
nop
add $28167, %r10
...
// Load
lea addresses_RW+0x6885, %rcx
xor %rdi, %rdi
movb (%rcx), %r10b
cmp $7435, %r15

// Store
lea addresses_WC+0x2625, %r13
add $26280, %rdi
...
{'src': {'NT': False, 'same': False, 'congruent': 5, 'type': 'addresses_RW', 'AVXalign': False, 'size': 1}, 'OP': 'LOAD'}
...
{'src': {'same': False, 'congruent': 5, 'type': 'addresses_A_ht'}, 'OP': 'REPM', 'dst': {'same': False, 'congruent': 1, 'type': 'addresses_UC_ht'}}
