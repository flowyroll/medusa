...
push %rdx
push %rsi
lea addresses_UC_ht+0xb5ed, %r13
nop
mfence
...
nop
sub %rdx, %rdx
lea addresses_D_ht+0x1de10, %rcx
nop
nop
nop
nop
...
nop
sub %r12, %r12
lea addresses_WC_ht+0x6570, %rcx
xor %rdi, %rdi
mov $0x6162636465666768, %rbp
movq %rbp, %xmm2
vmovups %ymm2, (%rcx)
...
nop
inc %r13
lea addresses_WC_ht+0x3bf0, %rsi
lea addresses_A_ht+0x7b70, %rdi
nop
nop
nop
nop
...
{'OP': 'LOAD', 'src': {'type': 'addresses_WC', 'AVXalign': False, 'congruent': 8, 'size': 32, 'same': False, 'NT': False}}
