...
push %rdi
push %rsi
lea addresses_UC_ht+0x9595, %rbp
nop
nop
xor %rcx, %rcx
...
movb $0x61, (%r13)
sub $59271, %r12
lea addresses_WT_ht+0x19ff5, %rsi
lea addresses_D_ht+0xf935, %rdi
nop
nop
nop
nop
...
nop
add $19804, %rsi
lea addresses_normal_ht+0x8635, %rbp
nop
xor $32028, %rax
mov (%rbp), %rdi
nop
...
lea addresses_WT_ht+0xf7b5, %rdi
nop
nop
and %rax, %rax
mov $41, %rcx
...
nop
inc %rax
lea addresses_A_ht+0x10235, %rsi
nop
nop
nop
sub $63799, %r12
...
nop
and %rcx, %rcx
lea addresses_D_ht+0x10943, %r12
nop
inc %rsi
...
nop
xor $38605, %rax
lea addresses_WC_ht+0x122b5, %r10
and %rsi, %rsi
movw $0x6162, (%r10)
nop
nop
...
nop
inc %rcx
lea addresses_WC_ht+0x17635, %rsi
lea addresses_WT_ht+0x15455, %rdi
nop
nop
mfence
mov $114, %rcx
rep movsq
add %rax, %rax
lea addresses_normal_ht+0x1d2f5, %r13
nop
nop
and %r10, %r10
movb (%r13), %al
nop
add $48681, %rsi
lea addresses_WC_ht+0x5135, %rdi
nop
nop
nop
add %rsi, %rsi
...
{'OP': 'REPM', 'src': {'type': 'addresses_WT_ht', 'congruent': 3, 'same': False}, 'dst': {'type': 'addresses_D_ht', 'congruent': 6, 'same': False}}
{'OP': 'LOAD', 'src': {'type': 'addresses_normal_ht', 'size': 8, 'AVXalign': False, 'NT': False, 'congruent': 9, 'same': False}}
{'OP': 'REPM', 'src': {'type': 'addresses_WC_ht', 'congruent': 9, 'same': False}, 'dst': {'type': 'addresses_WT_ht', 'congruent': 7, 'same': False}}
...
{'OP': 'LOAD', 'src': {'type': 'addresses_normal_ht', 'size': 1, 'AVXalign': False, 'NT': True, 'congruent': 6, 'same': False}}
