...
push %rdx
push %rsi
lea addresses_normal_ht+0xceb, %rbx
nop
sub %r12, %r12
movw $0x6162, (%rbx)
nop
...
nop
cmp $45346, %r15
lea addresses_WC_ht+0x81d1, %rcx
nop
nop
nop
nop
...
nop
add %r15, %r15
lea addresses_WT_ht+0x11deb, %r12
nop
nop
cmp %r14, %r14
mov (%r12), %r15
cmp $6260, %r12
lea addresses_WC_ht+0x11ab, %rsi
lea addresses_WC_ht+0xb6eb, %rdi
nop
nop
nop
add $48821, %rax
...
nop
dec %r15
lea addresses_WC_ht+0xe9eb, %rsi
lea addresses_WT_ht+0x91eb, %rdi
nop
nop
nop
and %rdx, %rdx
...
nop
sub $58678, %r15
lea addresses_WC_ht+0x990b, %r15
add %rdx, %rdx
mov (%r15), %rsi
nop
add $58964, %rbx
lea addresses_normal_ht+0x1bb9c, %rsi
lea addresses_UC_ht+0xe82b, %rdi
nop
nop
cmp $26961, %r15
mov $52, %rcx
...
// Faulty Load
lea addresses_normal+0x45eb, %rsi
nop
cmp $55445, %rax
mov (%rsi), %bp
lea oracles, %r9
...
{'src': {'type': 'addresses_normal_ht', 'congruent': 0, 'same': False}, 'OP': 'REPM', 'dst': {'type': 'addresses_UC_ht', 'congruent': 5, 'same': False}}
{'34': 21829}
