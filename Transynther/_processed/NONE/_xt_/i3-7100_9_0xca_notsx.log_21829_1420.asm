...
nop
mfence
lea addresses_D_ht+0x16622, %rsi
lea addresses_A_ht+0x18abe, %rdi
nop
nop
nop
nop
...
nop
cmp %r15, %r15
lea addresses_D_ht+0xda52, %rsi
lea addresses_A_ht+0x14dbe, %rdi
clflush (%rdi)
xor $7737, %r8
mov $63, %rcx
rep movsl
...
nop
add %r15, %r15
lea addresses_WT_ht+0x18ff3, %rsi
lea addresses_D_ht+0x916e, %rdi
clflush (%rdi)
sub $31690, %r15
mov $36, %rcx
rep movsl
nop
and $48995, %rdi
lea addresses_WT_ht+0xd542, %rcx
nop
nop
nop
nop
...
// REPMOV
lea addresses_PSE+0x1e12a, %rsi
lea addresses_normal+0xe82c, %rdi
clflush (%rsi)
nop
nop
nop
...
{'src': {'type': 'addresses_PSE', 'congruent': 2, 'same': False}, 'OP': 'REPM', 'dst': {'type': 'addresses_normal', 'congruent': 1, 'same': False}}
[Faulty Load]
...
{'src': {'type': 'addresses_D_ht', 'congruent': 1, 'same': False}, 'OP': 'REPM', 'dst': {'type': 'addresses_UC_ht', 'congruent': 8, 'same': True}}
