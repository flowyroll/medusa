...
movb $0x61, (%r10)
add %r10, %r10
lea addresses_WC_ht+0x6d1, %r15
nop
nop
add %r13, %r13
mov (%r15), %rbp
and $26370, %rdx
lea addresses_D_ht+0x2fd1, %rbp
nop
xor %rdx, %rdx
...
movups %xmm4, (%rbp)
dec %r12
lea addresses_normal_ht+0x16ed1, %r8
nop
nop
nop
nop
...
// REPMOV
lea addresses_UC+0x1ead1, %rsi
lea addresses_PSE+0x1b2d1, %rdi
cmp $4445, %r15
mov $101, %rcx
rep movsq
sub $877, %r15
...
{'src': {'type': 'addresses_UC', 'congruent': 8, 'same': False}, 'dst': {'type': 'addresses_PSE', 'congruent': 5, 'same': False}, 'OP': 'REPM'}
...
{'dst': {'type': 'addresses_A_ht', 'same': False, 'size': 1, 'congruent': 8, 'NT': False, 'AVXalign': True}, 'OP': 'STOR'}
