...
push %rdx
push %rsi
lea addresses_WC_ht+0x1dc2a, %rdx
clflush (%rdx)
nop
add %r9, %r9
movb (%rdx), %r15b
...
nop
and $31200, %rcx
lea addresses_A_ht+0x1d73a, %r15
nop
nop
nop
nop
...
mov (%r15), %r14d
add %r9, %r9
lea addresses_A_ht+0x1e7c8, %r13
clflush (%r13)
nop
nop
nop
...
nop
dec %r15
lea addresses_WT_ht+0x4c5a, %r13
nop
nop
nop
nop
...
nop
sub %r14, %r14
lea addresses_WT_ht+0x1e7c2, %rdx
nop
nop
cmp $22756, %r10
...
movups %xmm1, (%rdx)
cmp %rdx, %rdx
lea addresses_A_ht+0x17ce6, %rsi
lea addresses_WC_ht+0x1a79a, %rdi
nop
nop
xor $9476, %rdx
mov $17, %rcx
rep movsw
add %rsi, %rsi
lea addresses_D_ht+0x15e1a, %rsi
nop
dec %r9
movups (%rsi), %xmm7
vpextrq $0, %xmm7, %r10
nop
sub %r14, %r14
lea addresses_A_ht+0x1da8e, %rdi
nop
nop
mfence
mov (%rdi), %r15d
...
nop
sub %r9, %r9
lea addresses_WC_ht+0x2c74, %rsi
lea addresses_WC_ht+0x269a, %rdi
nop
nop
nop
dec %r9
...
nop
inc %r10
lea addresses_normal_ht+0x1011a, %rdi
nop
nop
nop
and $5053, %rcx
...
nop
xor $29102, %r13
lea addresses_normal_ht+0xc59a, %rsi
lea addresses_A_ht+0x1b19a, %rdi
cmp %r15, %r15
mov $41, %rcx
rep movsb
nop
...
{'src': {'congruent': 2, 'same': False, 'type': 'addresses_A_ht'}, 'OP': 'REPM', 'dst': {'congruent': 4, 'same': True, 'type': 'addresses_WC_ht'}}
...
{'src': {'congruent': 1, 'same': False, 'type': 'addresses_WC_ht'}, 'OP': 'REPM', 'dst': {'congruent': 8, 'same': False, 'type': 'addresses_WC_ht'}}
{'OP': 'STOR', 'dst': {'congruent': 6, 'AVXalign': False, 'same': False, 'size': 1, 'NT': False, 'type': 'addresses_normal_ht'}}
{'src': {'congruent': 9, 'same': False, 'type': 'addresses_normal_ht'}, 'OP': 'REPM', 'dst': {'congruent': 10, 'same': False, 'type': 'addresses_A_ht'}}
{'36': 21829}
