...
push %rdx
push %rsi
lea addresses_normal_ht+0x10bd7, %r10
nop
nop
add %r12, %r12
...
nop
and $27117, %rsi
lea addresses_WT_ht+0x193d7, %rsi
cmp %r11, %r11
mov $0x6162636465666768, %r10
movq %r10, (%rsi)
nop
dec %rsi
lea addresses_normal_ht+0x2eb7, %rsi
lea addresses_WT_ht+0xb937, %rdi
nop
cmp %r12, %r12
mov $36, %rcx
rep movsq
...
nop
inc %r10
lea addresses_D_ht+0x197d7, %rsi
lea addresses_WC_ht+0x13983, %rdi
nop
nop
nop
nop
...
rep movsb
xor %r11, %r11
lea addresses_A_ht+0x6307, %rsi
lea addresses_WC_ht+0x19757, %rdi
nop
sub $60816, %r12
mov $114, %rcx
rep movsl
...
nop
inc %rsi
lea addresses_D_ht+0x176ef, %rcx
nop
cmp $4431, %r12
movl $0x61626364, (%rcx)
nop
add %r11, %r11
lea addresses_UC_ht+0x1dbd7, %rdx
nop
sub $45101, %rbx
movw $0x6162, (%rdx)
nop
...
// Faulty Load
lea addresses_normal+0x103d7, %r15
nop
nop
nop
cmp $2383, %r10
