...
push %rdx
push %rsi
lea addresses_UC_ht+0xae41, %rsi
nop
nop
nop
nop
...
nop
xor $23119, %rsi
lea addresses_normal_ht+0x14a5d, %rsi
lea addresses_D_ht+0x1715d, %rdi
nop
cmp %r10, %r10
mov $10, %rcx
rep movsl
nop
and %rdi, %rdi
lea addresses_A_ht+0x1e8dd, %rcx
nop
cmp $25080, %rbx
vmovups (%rcx), %ymm4
...
vpextrq $0, %xmm4, %rdx
and %rsi, %rsi
lea addresses_D_ht+0x1945d, %rsi
lea addresses_A_ht+0xa21, %rdi
add $42446, %rax
mov $4, %rcx
rep movsw
nop
...
nop
and $11029, %r10
lea addresses_WT_ht+0x13a5d, %rcx
nop
nop
nop
nop
...
nop
and %rcx, %rcx
lea addresses_normal_ht+0x157d5, %rsi
lea addresses_WC_ht+0xdf5d, %rdi
nop
nop
nop
nop
...
nop
and $52379, %rsi
lea addresses_WT_ht+0xb15d, %rsi
lea addresses_normal_ht+0x1617d, %rdi
nop
nop
nop
add $16627, %rdx
