...
push %rdx
push %rsi
lea addresses_WC_ht+0xb459, %rdi
nop
nop
nop
sub $56730, %rbx
...
nop
dec %rax
lea addresses_UC_ht+0xc941, %rbx
xor %r14, %r14
movb $0x61, (%rbx)
nop
nop
add %rdx, %rdx
lea addresses_UC_ht+0x1af61, %rdi
nop
nop
nop
nop
...
nop
inc %r11
lea addresses_normal_ht+0xa5f2, %rax
nop
xor $58687, %r13
movb (%rax), %bl
nop
...
nop
add %r14, %r14
lea addresses_A_ht+0x12b01, %rbx
nop
nop
nop
nop
...
nop
cmp %r11, %r11
lea addresses_WC_ht+0x116c3, %rsi
lea addresses_WC_ht+0x8fd3, %rdi
inc %rbx
mov $4, %rcx
rep movsb
nop
nop
and $31230, %rdx
lea addresses_A_ht+0x44c1, %rsi
lea addresses_WC_ht+0x63c1, %rdi
nop
nop
nop
nop
...
nop
dec %r11
lea addresses_UC_ht+0x16f41, %rsi
lea addresses_D_ht+0xc941, %rdi
nop
nop
nop
nop
...
nop
cmp %r13, %r13
lea addresses_D_ht+0x18919, %rsi
lea addresses_WT_ht+0xb141, %rdi
and $64056, %rbx
mov $15, %rcx
rep movsw
nop
...
nop
inc %r11
lea addresses_D_ht+0x10a87, %rcx
nop
nop
nop
nop
...
movups %xmm0, (%rcx)
add %rdx, %rdx
lea addresses_WC_ht+0x74b1, %rbx
nop
and $30395, %r14
...
nop
sub %rax, %rax
lea addresses_normal_ht+0x3941, %rdx
nop
nop
nop
nop
...
nop
xor %r11, %r11
lea addresses_UC_ht+0x1e941, %r13
nop
nop
xor %rdi, %rdi
movb (%r13), %dl
nop
xor $62797, %rsi
lea addresses_UC_ht+0x1cc21, %rdi
nop
nop
nop
nop
...
{'src': {'type': 'addresses_WC_ht', 'congruent': 1, 'same': False}, 'dst': {'type': 'addresses_WC_ht', 'congruent': 0, 'same': False}, 'OP': 'REPM'}
