...
nop
and %rdi, %rdi
lea addresses_UC_ht+0x62c3, %rdi
nop
nop
lfence
mov (%rdi), %si
and $65160, %r10
lea addresses_D_ht+0xc203, %r9
nop
nop
cmp %rdi, %rdi
...
nop
add %r10, %r10
lea addresses_WT_ht+0x104c3, %rsi
nop
nop
cmp %rdx, %rdx
movw $0x6162, (%rsi)
...
nop
xor %rdx, %rdx
lea addresses_WC_ht+0x51ab, %rbx
nop
nop
dec %r9
mov (%rbx), %cx
...
nop
dec %rdi
lea addresses_normal_ht+0x1db43, %rsi
lea addresses_normal_ht+0x1bde3, %rdi
nop
nop
nop
nop
...
nop
add %rdx, %rdx
lea addresses_WC_ht+0xbf43, %rsi
lea addresses_A_ht+0x3777, %rdi
nop
nop
nop
nop
...
// Faulty Load
lea addresses_normal+0x8f43, %r14
clflush (%r14)
nop
nop
and %rdi, %rdi
...
{'src': {'type': 'addresses_UC_ht', 'same': False, 'size': 2, 'congruent': 6, 'NT': False, 'AVXalign': True}, 'OP': 'LOAD'}
