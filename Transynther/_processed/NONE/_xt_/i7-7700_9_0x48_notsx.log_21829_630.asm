...
push %rdi
push %rsi
lea addresses_A_ht+0x405d, %rsi
lea addresses_UC_ht+0x16723, %rdi
nop
nop
nop
nop
...
nop
xor $32001, %rbx
lea addresses_WT_ht+0x1ec5, %rax
nop
xor $53268, %r9
movb $0x61, (%rax)
nop
...
nop
inc %rbp
lea addresses_WT_ht+0x1ea8d, %rsi
nop
nop
nop
xor $2797, %rbp
...
nop
and %rsi, %rsi
lea addresses_A_ht+0x102b5, %rsi
sub $16043, %rbx
movups (%rsi), %xmm1
vpextrq $1, %xmm1, %rax
nop
...
nop
sub %rax, %rax
lea addresses_D_ht+0x154b5, %rcx
nop
nop
cmp %rdi, %rdi
movb (%rcx), %bl
...
// Faulty Load
lea addresses_normal+0xaeb5, %rsi
nop
nop
add %r8, %r8
vmovups (%rsi), %ymm6
...
{'dst': {'same': False, 'NT': False, 'AVXalign': True, 'size': 8, 'type': 'addresses_WT', 'congruent': 2}, 'OP': 'STOR'}
[Faulty Load]
