...
push %rdx
push %rsi
lea addresses_normal_ht+0xa3fb, %r10
nop
nop
nop
nop
...
nop
and $413, %r12
lea addresses_normal_ht+0x1604b, %r10
nop
nop
sub %rdx, %rdx
mov (%r10), %r8w
...
nop
xor %r10, %r10
lea addresses_WT_ht+0x1ab7b, %rsi
lea addresses_WC_ht+0xaa23, %rdi
clflush (%rsi)
nop
nop
nop
...
nop
sub %rdx, %rdx
lea addresses_WC_ht+0x5ed1, %r12
nop
nop
nop
nop
...
nop
and %rsi, %rsi
lea addresses_UC_ht+0x63fb, %r8
xor $4896, %rsi
mov $0x6162636465666768, %rdx
movq %rdx, (%r8)
inc %rdx
lea addresses_UC_ht+0x5e1b, %r10
xor $10729, %rcx
...
nop
cmp %rdx, %rdx
lea addresses_UC_ht+0xbfbb, %rbx
clflush (%rbx)
nop
lfence
mov (%rbx), %edx
