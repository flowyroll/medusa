...
push %rdx
push %rsi
lea addresses_WC_ht+0x31b5, %r10
nop
nop
nop
inc %rdi
...
nop
cmp $44502, %r9
lea addresses_UC_ht+0x17295, %rbx
nop
nop
nop
cmp $23909, %rdx
...
nop
xor %r8, %r8
lea addresses_WT_ht+0x1b625, %rsi
lea addresses_WT_ht+0x1e9d5, %rdi
add %r9, %r9
mov $127, %rcx
rep movsq
nop
...
mov (%rsi), %r9w
lfence
lea addresses_D_ht+0x1dad5, %r10
clflush (%r10)
nop
nop
dec %rsi
...
nop
and %r8, %r8
lea addresses_WC_ht+0x12db5, %rsi
lea addresses_normal_ht+0x5617, %rdi
nop
nop
nop
sub %r8, %r8
...
nop
add $30967, %rdi
lea addresses_WC_ht+0x19f5, %rsi
nop
add $36091, %r9
mov $0x6162636465666768, %rdx
movq %rdx, %xmm7
...
nop
xor $28578, %r11
lea addresses_WT_ht+0xad5, %rsi
lea addresses_UC_ht+0x18ed5, %rdi
nop
nop
nop
add %r10, %r10
...
nop
add %rbx, %rbx
lea addresses_UC_ht+0xf271, %rsi
...
nop
and %rcx, %rcx
lea addresses_UC_ht+0x199b5, %rcx
clflush (%rcx)
nop
nop
nop
...
nop
sub $41552, %rdx
lea addresses_WC_ht+0x9fb5, %r11
nop
nop
sub $53349, %r8
mov (%r11), %dx
...
{'OP': 'REPM', 'src': {'same': False, 'congruent': 2, 'type': 'addresses_WT_ht'}, 'dst': {'same': True, 'congruent': 5, 'type': 'addresses_WT_ht'}}
...
{'OP': 'REPM', 'src': {'same': False, 'congruent': 8, 'type': 'addresses_WC_ht'}, 'dst': {'same': False, 'congruent': 1, 'type': 'addresses_normal_ht'}}
{'OP': 'STOR', 'dst': {'same': False, 'type': 'addresses_WC_ht', 'NT': False, 'AVXalign': False, 'size': 32, 'congruent': 6}}
{'OP': 'REPM', 'src': {'same': True, 'congruent': 5, 'type': 'addresses_WT_ht'}, 'dst': {'same': False, 'congruent': 4, 'type': 'addresses_UC_ht'}}
