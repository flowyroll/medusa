...
push %rdx
push %rsi
lea addresses_D_ht+0x5b21, %rdi
add %rbp, %rbp
mov (%rdi), %ecx
and $7411, %rdi
lea addresses_D_ht+0x16221, %rsi
dec %rdx
mov (%rsi), %r9
nop
nop
...
nop
and %rbp, %rbp
lea addresses_WT_ht+0x9a21, %rsi
lea addresses_WC_ht+0xd621, %rdi
nop
nop
and %r14, %r14
mov $9, %rcx
...
movw $0x6162, (%r9)
add $33874, %rcx
lea addresses_WT_ht+0x1b439, %r14
nop
nop
nop
nop
...
nop
inc %rcx
lea addresses_WC_ht+0x5e21, %rdi
nop
nop
nop
nop
...
nop
sub $12418, %rbp
lea addresses_WT_ht+0x17461, %rdx
nop
nop
nop
nop
...
nop
cmp $25865, %rbp
lea addresses_WC_ht+0x1df9d, %rcx
nop
nop
nop
nop
...
nop
add $46705, %rcx
lea addresses_normal_ht+0x9619, %rsi
nop
nop
nop
sub $62224, %rdx
...
nop
cmp $21771, %rcx
lea addresses_WC_ht+0x6521, %rsi
lea addresses_D_ht+0x17e89, %rdi
nop
dec %rbx
mov $125, %rcx
rep movsw
cmp %r14, %r14
lea addresses_WC_ht+0x7221, %rsi
nop
nop
nop
nop
...
// Faulty Load
lea addresses_normal+0xca21, %r8
nop
nop
nop
nop
...
{'OP': 'LOAD', 'src': {'type': 'addresses_D_ht', 'size': 8, 'AVXalign': True, 'NT': False, 'congruent': 11, 'same': True}}
{'OP': 'REPM', 'src': {'type': 'addresses_WT_ht', 'congruent': 11, 'same': False}, 'dst': {'type': 'addresses_WC_ht', 'congruent': 8, 'same': False}}
{'OP': 'LOAD', 'src': {'type': 'addresses_A_ht', 'size': 32, 'AVXalign': True, 'NT': False, 'congruent': 3, 'same': False}}
