...
nop
xor $11407, %rbx
lea addresses_normal_ht+0x209, %r14
nop
dec %rbp
movb $0x61, (%r14)
nop
...
nop
dec %r15
lea addresses_WC_ht+0x47fd, %rsi
lea addresses_WT_ht+0x3f7d, %rdi
nop
and $22185, %r11
mov $76, %rcx
rep movsb
...
lea addresses_WT_ht+0xb1fd, %rdi
nop
nop
nop
nop
...
nop
sub %rsi, %rsi
lea addresses_WC_ht+0x1ddfd, %rbp
nop
nop
nop
and %rcx, %rcx
