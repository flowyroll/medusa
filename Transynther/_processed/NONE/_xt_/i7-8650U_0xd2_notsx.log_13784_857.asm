...
push %rdi
push %rsi
lea addresses_UC_ht+0x6210, %r14
nop
nop
nop
nop
...
nop
and $58066, %rax
lea addresses_WC_ht+0xc700, %r13
sub %r10, %r10
vmovups (%r13), %ymm5
...
nop
add %rcx, %rcx
lea addresses_normal_ht+0x10300, %r13
nop
cmp $33219, %rax
movb (%r13), %r11b
nop
...
nop
cmp %rax, %rax
lea addresses_WC_ht+0x1659c, %rsi
lea addresses_WT_ht+0x1eae0, %rdi
add $62277, %r11
mov $60, %rcx
rep movsl
nop
dec %rdi
lea addresses_WT_ht+0x12940, %r14
xor %rdi, %rdi
movl $0x61626364, (%r14)
nop
xor $50215, %rdi
