...
nop
cmp $46610, %r15
lea addresses_normal_ht+0x14714, %rsi
lea addresses_WC_ht+0xad14, %rdi
nop
nop
nop
nop
...
rep movsq
xor %rcx, %rcx
lea addresses_WT_ht+0x6554, %r15
nop
nop
nop
nop
...
nop
cmp %r15, %r15
lea addresses_normal_ht+0xbd54, %r15
nop
inc %r8
mov (%r15), %cx
nop
nop
xor $35827, %r14
lea addresses_UC_ht+0x5501, %rax
nop
nop
sub $6042, %r8
mov (%rax), %edi
nop
sub $19839, %rsi
lea addresses_WC_ht+0xf554, %rdi
nop
nop
nop
xor %rcx, %rcx
...
lea addresses_UC_ht+0x9854, %rdi
nop
nop
xor $37301, %rax
mov $21, %rcx
...
nop
cmp %r10, %r10
lea addresses_WT_ht+0xfb94, %r15
nop
nop
add %r10, %r10
vmovups (%r15), %ymm2
...
nop
cmp %r14, %r14
lea addresses_WC_ht+0x17316, %rsi
nop
nop
nop
nop
...
nop
add $63668, %r15
lea addresses_D_ht+0x17954, %rsi
lea addresses_D_ht+0x8754, %rdi
clflush (%rdi)
nop
nop
nop
...
nop
and %r14, %r14
lea addresses_normal_ht+0x4524, %rsi
lea addresses_normal_ht+0xf014, %rdi
nop
nop
nop
dec %r14
...
{'src': {'congruent': 0, 'AVXalign': False, 'same': True, 'size': 1, 'NT': False, 'type': 'addresses_PSE'}, 'OP': 'LOAD'}
<gen_prepare_buffer>
{'src': {'congruent': 11, 'same': True, 'type': 'addresses_A_ht'}, 'OP': 'REPM', 'dst': {'congruent': 8, 'same': False, 'type': 'addresses_WC_ht'}}
{'OP': 'STOR', 'dst': {'congruent': 3, 'AVXalign': False, 'same': False, 'size': 32, 'NT': False, 'type': 'addresses_WT_ht'}}
{'src': {'congruent': 4, 'same': False, 'type': 'addresses_normal_ht'}, 'OP': 'REPM', 'dst': {'congruent': 6, 'same': False, 'type': 'addresses_WC_ht'}}
...
{'src': {'congruent': 10, 'AVXalign': False, 'same': True, 'size': 2, 'NT': False, 'type': 'addresses_normal_ht'}, 'OP': 'LOAD'}
...
{'OP': 'STOR', 'dst': {'congruent': 2, 'AVXalign': False, 'same': True, 'size': 1, 'NT': False, 'type': 'addresses_A_ht'}}
...
{'src': {'congruent': 4, 'same': False, 'type': 'addresses_normal_ht'}, 'OP': 'REPM', 'dst': {'congruent': 5, 'same': False, 'type': 'addresses_normal_ht'}}
{'33': 21829}
