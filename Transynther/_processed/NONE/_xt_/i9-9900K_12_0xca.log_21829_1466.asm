...
push %rdi
push %rsi
lea addresses_normal_ht+0xe066, %rcx
nop
sub %rsi, %rsi
vmovups (%rcx), %ymm4
...
vpextrq $1, %xmm4, %r13
cmp %rcx, %rcx
lea addresses_WC_ht+0x3ee6, %rsi
lea addresses_A_ht+0x16774, %rdi
cmp %r15, %r15
mov $110, %rcx
rep movsq
nop
...
nop
sub %rcx, %rcx
lea addresses_D_ht+0x6566, %rsi
lea addresses_normal_ht+0x62a6, %rdi
nop
nop
nop
nop
...
nop
sub $63831, %r13
lea addresses_WT_ht+0x7c26, %rax
nop
nop
nop
nop
...
nop
xor %rbx, %rbx
lea addresses_normal_ht+0x9c26, %rsi
lea addresses_A_ht+0x3cb6, %rdi
nop
nop
cmp %r9, %r9
mov $0, %rcx
...
nop
add $23574, %r13
lea addresses_UC_ht+0xe026, %rsi
lea addresses_WT_ht+0x426, %rdi
nop
nop
cmp $11054, %rax
mov $17, %rcx
...
nop
xor %rsi, %rsi
lea addresses_WT_ht+0xf262, %r15
cmp $1232, %rax
...
nop
inc %r9
lea addresses_UC_ht+0x50da, %rbx
nop
nop
nop
nop
...
nop
and $24548, %r13
lea addresses_WT_ht+0xf966, %r13
clflush (%r13)
nop
nop
nop
...
{'OP': 'REPM', 'src': {'same': False, 'type': 'addresses_D_ht', 'congruent': 4}, 'dst': {'same': False, 'type': 'addresses_normal_ht', 'congruent': 6}}
...
{'OP': 'REPM', 'src': {'same': False, 'type': 'addresses_UC_ht', 'congruent': 10}, 'dst': {'same': False, 'type': 'addresses_WT_ht', 'congruent': 8}}
