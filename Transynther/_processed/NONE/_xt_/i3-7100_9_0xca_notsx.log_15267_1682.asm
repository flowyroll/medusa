...
push %rdi
push %rsi
lea addresses_UC_ht+0x1a334, %rsi
lea addresses_WC_ht+0x1e298, %rdi
nop
nop
xor $36333, %rbp
mov $123, %rcx
...
nop
add %r15, %r15
lea addresses_UC_ht+0x1af34, %r11
nop
dec %r10
movb $0x61, (%r11)
nop
...
nop
xor %rsi, %rsi
lea addresses_normal_ht+0x132a8, %rsi
lea addresses_UC_ht+0x18c94, %rdi
nop
nop
cmp $7849, %r9
mov $63, %rcx
rep movsq
add $30535, %rdi
lea addresses_D_ht+0x3c34, %rsi
lea addresses_WT_ht+0x1e1ac, %rdi
nop
nop
dec %r10
mov $28, %rcx
...
nop
cmp $40458, %rbp
lea addresses_normal_ht+0xac34, %rdi
nop
nop
nop
dec %r11
...
lea addresses_WC_ht+0x11234, %rdi
clflush (%rdi)
nop
nop
add %r15, %r15
...
nop
cmp $17016, %r9
lea addresses_normal_ht+0x40d3, %r15
cmp $29791, %rdi
movups (%r15), %xmm7
vpextrq $1, %xmm7, %rbp
nop
...
nop
xor %r10, %r10
lea addresses_UC_ht+0x1d434, %rbp
nop
nop
nop
nop
...
// Faulty Load
lea addresses_normal+0x17c34, %r8
add $9513, %rsi
mov (%r8), %edi
lea oracles, %rbx
and $0xff, %rdi
...
{'OP': 'STOR', 'dst': {'same': False, 'congruent': 8, 'NT': True, 'type': 'addresses_UC_ht', 'size': 1, 'AVXalign': True}}
{'src': {'type': 'addresses_normal_ht', 'congruent': 2, 'same': False}, 'OP': 'REPM', 'dst': {'type': 'addresses_UC_ht', 'congruent': 5, 'same': True}}
{'src': {'type': 'addresses_D_ht', 'congruent': 7, 'same': False}, 'OP': 'REPM', 'dst': {'type': 'addresses_WT_ht', 'congruent': 3, 'same': False}}
{'src': {'same': False, 'congruent': 0, 'NT': False, 'type': 'addresses_D_ht', 'size': 16, 'AVXalign': True}, 'OP': 'LOAD'}
