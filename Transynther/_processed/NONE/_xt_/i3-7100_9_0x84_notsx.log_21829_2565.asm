...
push %rdx
push %rsi
lea addresses_WT_ht+0xee3f, %r14
nop
nop
cmp %r8, %r8
mov (%r14), %rdx
nop
dec %rdx
lea addresses_A_ht+0xae3f, %rsi
lea addresses_WT_ht+0x24f1, %rdi
clflush (%rsi)
nop
nop
nop
...
rep movsl
add $49479, %rsi
lea addresses_normal_ht+0x1aeff, %r8
nop
nop
add $843, %r14
mov (%r8), %edx
...
nop
dec %r14
lea addresses_WC_ht+0x1be73, %rsi
lea addresses_D_ht+0x5e59, %rdi
mfence
mov $92, %rcx
rep movsw
nop
and $36144, %rcx
lea addresses_D_ht+0x1b5f, %r8
nop
cmp %rdx, %rdx
...
nop
add %r9, %r9
lea addresses_normal_ht+0x605f, %rsi
nop
nop
nop
nop
