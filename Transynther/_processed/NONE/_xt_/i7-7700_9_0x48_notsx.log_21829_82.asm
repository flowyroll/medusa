...
push %rdi
push %rsi
lea addresses_WC_ht+0x1b4c5, %rsi
lea addresses_D_ht+0xcac5, %rdi
and $28960, %rbx
mov $81, %rcx
rep movsb
nop
...
nop
sub $52466, %r10
lea addresses_UC_ht+0x18ffb, %r9
nop
nop
nop
nop
...
{'dst': {'same': False, 'NT': False, 'AVXalign': False, 'size': 1, 'type': 'addresses_A', 'congruent': 4}, 'OP': 'STOR'}
