...
push %rdi
push %rsi
lea addresses_WT_ht+0xcbd2, %rsi
lea addresses_UC_ht+0x29cd, %rdi
clflush (%rdi)
nop
nop
dec %r13
...
nop
xor %rsi, %rsi
lea addresses_D_ht+0x618d, %rsi
lea addresses_WC_ht+0x110d, %rdi
nop
nop
nop
cmp %rax, %rax
...
// REPMOV
lea addresses_WT+0x41a9, %rsi
lea addresses_normal+0x1b0d, %rdi
sub %r11, %r11
mov $72, %rcx
rep movsl
nop
...
{'src': {'type': 'addresses_WT', 'congruent': 2, 'same': False}, 'OP': 'REPM', 'dst': {'type': 'addresses_normal', 'congruent': 8, 'same': False}}
[Faulty Load]
