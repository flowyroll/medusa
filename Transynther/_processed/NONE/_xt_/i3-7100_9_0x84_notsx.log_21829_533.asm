...
push %rdx
push %rsi
lea addresses_UC_ht+0x1d8d8, %rdi
nop
add $5135, %r10
...
nop
cmp %r14, %r14
lea addresses_WT_ht+0xdad8, %rdx
lfence
...
nop
and %rdx, %rdx
lea addresses_WT_ht+0x3218, %rdi
nop
nop
nop
nop
...
nop
and %rdx, %rdx
lea addresses_UC_ht+0x50d8, %rdx
clflush (%rdx)
nop
cmp $62680, %rdi
movups (%rdx), %xmm6
vpextrq $1, %xmm6, %r10
sub $19976, %rdx
lea addresses_WT_ht+0x14cd8, %r10
xor %r14, %r14
mov (%r10), %bp
xor $3482, %r10
lea addresses_A_ht+0x44d8, %rdi
nop
nop
inc %rbp
mov (%rdi), %ax
...
nop
xor $3202, %rdx
lea addresses_WT_ht+0x81b8, %rsi
lea addresses_A_ht+0x1b6b8, %rdi
nop
nop
nop
nop
...
{'src': {'type': 'addresses_P', 'congruent': 8, 'same': False}, 'dst': {'type': 'addresses_NC', 'congruent': 5, 'same': False}, 'OP': 'REPM'}
[Faulty Load]
...
{'src': {'type': 'addresses_A_ht', 'same': False, 'size': 2, 'congruent': 9, 'NT': False, 'AVXalign': True}, 'OP': 'LOAD'}
