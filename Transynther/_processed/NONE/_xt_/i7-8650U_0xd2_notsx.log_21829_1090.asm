...
push %rdi
push %rsi
lea addresses_WC_ht+0x1897a, %r10
nop
nop
nop
cmp %rsi, %rsi
...
nop
sub $32418, %r12
lea addresses_UC_ht+0x1717a, %r14
clflush (%r14)
nop
nop
nop
...
nop
xor %rcx, %rcx
lea addresses_UC_ht+0x14bac, %r9
nop
nop
nop
and %rsi, %rsi
...
nop
and %r9, %r9
lea addresses_normal_ht+0x9c6, %rsi
lea addresses_WT_ht+0x1e1da, %rdi
nop
nop
add %r11, %r11
mov $90, %rcx
...
{'OP': 'STOR', 'dst': {'type': 'addresses_UC_ht', 'size': 16, 'AVXalign': False, 'NT': False, 'congruent': 1, 'same': True}}
