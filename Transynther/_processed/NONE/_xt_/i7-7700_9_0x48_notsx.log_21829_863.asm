...
push %rdx
push %rsi
lea addresses_WT_ht+0x1bfcc, %rdx
nop
nop
nop
nop
...
nop
cmp $19331, %r9
lea addresses_D_ht+0xf4cc, %rsi
lea addresses_WC_ht+0x2922, %rdi
clflush (%rsi)
add %r14, %r14
mov $89, %rcx
rep movsq
nop
sub $29921, %rdi
lea addresses_UC_ht+0x1dcdc, %r14
clflush (%r14)
nop
nop
xor %r9, %r9
...
nop
add $38559, %rcx
lea addresses_UC_ht+0x1514c, %r14
nop
nop
nop
and %rdx, %rdx
...
vpextrq $0, %xmm1, %rdi
xor %rsi, %rsi
lea addresses_WT_ht+0x1e88c, %rsi
lea addresses_D_ht+0x1374c, %rdi
and %r13, %r13
mov $51, %rcx
rep movsb
nop
...
nop
inc %r13
lea addresses_normal_ht+0xe33c, %rcx
cmp %rsi, %rsi
movups (%rcx), %xmm2
vpextrq $0, %xmm2, %rdi
nop
sub %r14, %r14
lea addresses_WT_ht+0x1b3cc, %r9
nop
nop
nop
dec %r14
mov (%r9), %dx
mfence
lea addresses_normal_ht+0x2f4c, %rcx
nop
nop
add %r9, %r9
...
nop
xor $40216, %r13
lea addresses_WT_ht+0x1214c, %rdi
xor %r14, %r14
movl $0x61626364, (%rdi)
nop
nop
...
{'dst': {'same': False, 'congruent': 1, 'type': 'addresses_WC_ht'}, 'OP': 'REPM', 'src': {'same': True, 'congruent': 6, 'type': 'addresses_D_ht'}}
{'dst': {'same': False, 'NT': False, 'AVXalign': False, 'size': 2, 'type': 'addresses_UC_ht', 'congruent': 4}, 'OP': 'STOR'}
{'OP': 'LOAD', 'src': {'same': True, 'NT': False, 'AVXalign': False, 'size': 32, 'type': 'addresses_UC_ht', 'congruent': 8}}
{'dst': {'same': False, 'congruent': 10, 'type': 'addresses_D_ht'}, 'OP': 'REPM', 'src': {'same': False, 'congruent': 6, 'type': 'addresses_WT_ht'}}
