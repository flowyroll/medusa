...
push %rcx
push %rdx
lea addresses_WT_ht+0x1b935, %rax
nop
nop
and $33781, %rdx
mov (%rax), %rcx
...
nop
cmp $2688, %rbx
lea addresses_D_ht+0x1a235, %rbp
nop
nop
nop
nop
...
nop
cmp %rax, %rax
lea addresses_WC_ht+0x13ce5, %rbp
nop
and %rbx, %rbx
movb (%rbp), %al
nop
nop
and %rax, %rax
lea addresses_WT_ht+0xeca7, %r12
nop
nop
nop
nop
...
movb (%r12), %dl
cmp %rax, %rax
lea addresses_UC_ht+0x11039, %rax
nop
nop
sub $25795, %r12
movl $0x61626364, (%rax)
...
// Faulty Load
lea addresses_normal+0x9935, %rsi
clflush (%rsi)
nop
nop
nop
