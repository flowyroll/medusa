...
push %rdi
push %rsi
lea addresses_normal_ht+0xca87, %r13
nop
nop
nop
inc %rbp
...
nop
and %rbx, %rbx
lea addresses_UC_ht+0x2dc7, %rsi
nop
nop
nop
nop
...
nop
add $38862, %rbx
lea addresses_A_ht+0x19f47, %rsi
...
nop
add $18995, %r10
lea addresses_normal_ht+0xb447, %rbx
nop
nop
nop
sub $33520, %rdi
...
nop
and $47800, %rbx
lea addresses_WT_ht+0x1e867, %rsi
nop
nop
nop
nop
...
nop
xor %rsi, %rsi
lea addresses_WT_ht+0x111c7, %rcx
nop
sub %r15, %r15
movb $0x61, (%rcx)
nop
...
nop
add $29260, %rdi
lea addresses_WT_ht+0x1fc7, %rdi
clflush (%rdi)
nop
nop
nop
...
movb $0x61, (%rdi)
and $15563, %r15
lea addresses_WT_ht+0x1c987, %rdi
nop
nop
nop
inc %rbx
...
// Store
lea addresses_normal+0x1c1c7, %r14
nop
sub %r9, %r9
...
{'OP': 'STOR', 'dst': {'type': 'addresses_normal', 'AVXalign': True, 'size': 8, 'NT': False, 'same': False, 'congruent': 9}}
[Faulty Load]
