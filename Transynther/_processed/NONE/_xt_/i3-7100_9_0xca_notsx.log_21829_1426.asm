...
push %rdi
push %rsi
lea addresses_D_ht+0x1674a, %rsi
lea addresses_A_ht+0x1868a, %rdi
nop
xor %r11, %r11
mov $16, %rcx
rep movsb
and $38061, %r11
lea addresses_A_ht+0x1e904, %rsi
lea addresses_WC_ht+0x37ca, %rdi
nop
nop
nop
sub %r8, %r8
...
nop
dec %r11
lea addresses_A_ht+0xe8ca, %rsi
lea addresses_normal_ht+0x1bb4b, %rdi
clflush (%rdi)
nop
nop
sub %r12, %r12
...
nop
dec %r11
lea addresses_normal_ht+0x19d7a, %rsi
lea addresses_normal_ht+0x8109, %rdi
nop
nop
nop
and %rax, %rax
...
nop
and %rsi, %rsi
lea addresses_D_ht+0xa08a, %r11
nop
nop
and $31414, %rax
mov (%r11), %si
cmp %r8, %r8
lea addresses_normal_ht+0x1dcca, %rsi
lea addresses_D_ht+0x1b5ba, %rdi
nop
nop
xor %r8, %r8
mov $109, %rcx
...
{'src': {'type': 'addresses_A_ht', 'congruent': 1, 'same': False}, 'OP': 'REPM', 'dst': {'type': 'addresses_WC_ht', 'congruent': 6, 'same': False}}
