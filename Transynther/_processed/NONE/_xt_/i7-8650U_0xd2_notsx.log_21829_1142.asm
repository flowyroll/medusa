...
push %rdi
push %rsi
lea addresses_normal_ht+0x5783, %r9
nop
nop
nop
nop
...
nop
and %rax, %rax
lea addresses_D_ht+0x1907d, %rsi
...
nop
cmp $13826, %rbp
lea addresses_A_ht+0x12f79, %r15
nop
nop
sub %r9, %r9
movw $0x6162, (%r15)
nop
and $42516, %rcx
lea addresses_WC_ht+0xa665, %r15
nop
nop
inc %rcx
movl $0x61626364, (%r15)
...
nop
sub %rdi, %rdi
lea addresses_WT_ht+0x1d065, %rcx
nop
sub %rsi, %rsi
vmovups (%rcx), %ymm5
...
nop
add $38749, %rcx
lea addresses_A_ht+0x15665, %r15
nop
nop
nop
cmp $22852, %r9
...
nop
cmp $64079, %rcx
lea addresses_UC_ht+0x5665, %r15
nop
nop
nop
nop
