...
nop
add $58135, %rcx
lea addresses_UC_ht+0xf5a0, %r15
inc %rdx
movl $0x61626364, (%r15)
nop
nop
...
nop
cmp $26000, %rdx
lea addresses_A_ht+0x1a820, %rdi
xor $12794, %rcx
movl $0x61626364, (%rdi)
nop
nop
...
nop
sub %rdx, %rdx
lea addresses_WT_ht+0x180d0, %rsi
lea addresses_normal_ht+0x8af4, %rdi
clflush (%rdi)
nop
nop
xor $53971, %r10
...
nop
cmp %r13, %r13
lea addresses_A_ht+0x19750, %r15
inc %rsi
...
<gen_prepare_buffer>
{'src': {'type': 'addresses_normal_ht', 'congruent': 8, 'same': False}, 'dst': {'type': 'addresses_D_ht', 'congruent': 0, 'same': True}, 'OP': 'REPM'}
