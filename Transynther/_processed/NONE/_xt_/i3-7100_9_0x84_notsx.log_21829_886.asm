...
push %rdi
push %rsi
lea addresses_D_ht+0x15467, %rsi
lea addresses_WC_ht+0x660f, %rdi
dec %r12
mov $58, %rcx
rep movsl
nop
nop
add $2062, %rbp
lea addresses_WT_ht+0x14487, %rax
xor $25798, %rbx
vmovups (%rax), %ymm4
...
nop
xor %rsi, %rsi
lea addresses_normal_ht+0x1cf87, %rax
nop
cmp %rdi, %rdi
mov (%rax), %esi
xor $6352, %r12
lea addresses_A_ht+0xc987, %rdi
nop
nop
nop
inc %rax
...
{'dst': {'type': 'addresses_P', 'same': False, 'size': 8, 'congruent': 1, 'NT': True, 'AVXalign': False}, 'OP': 'STOR'}
