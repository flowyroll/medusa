...
push %rax
push %rbx
lea addresses_D_ht+0x12376, %r15
dec %rbx
...
nop
dec %r8
lea addresses_WC_ht+0xdb76, %rax
nop
nop
nop
nop
...
nop
lfence
lea addresses_normal_ht+0x1eec6, %rax
nop
nop
nop
add %r9, %r9
...
nop
inc %r9
lea addresses_UC_ht+0x5236, %r13
nop
nop
nop
nop
...
nop
add $14375, %rbx
lea addresses_normal_ht+0x10776, %r15
clflush (%r15)
nop
and $8675, %rax
mov (%r15), %r9
