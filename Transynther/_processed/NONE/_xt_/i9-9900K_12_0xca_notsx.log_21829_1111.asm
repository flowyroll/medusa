...
push %rdx
push %rsi
lea addresses_WT_ht+0x14ed9, %rsi
...
nop
add %r8, %r8
lea addresses_WC_ht+0x74de, %rsi
lea addresses_normal_ht+0x89fd, %rdi
nop
nop
nop
nop
...
nop
xor %rsi, %rsi
lea addresses_WT_ht+0x162fd, %r8
nop
nop
nop
nop
...
nop
mfence
lea addresses_A_ht+0x933a, %rsi
lea addresses_WT_ht+0x17afd, %rdi
nop
nop
xor $46452, %rdx
mov $123, %rcx
...
movw $0x6162, (%r15)
add %r15, %r15
lea addresses_UC_ht+0x14afd, %rsi
lea addresses_WT_ht+0x3efd, %rdi
nop
nop
nop
nop
...
nop
xor %rdi, %rdi
lea addresses_D_ht+0x1b3ad, %r15
nop
add $33749, %r8
movups (%r15), %xmm0
vpextrq $0, %xmm0, %rcx
...
// Store
lea addresses_normal+0x61bd, %r11
nop
nop
nop
nop
...
{'OP': 'REPM', 'src': {'same': False, 'congruent': 0, 'type': 'addresses_A_ht'}, 'dst': {'same': False, 'congruent': 10, 'type': 'addresses_WT_ht'}}
