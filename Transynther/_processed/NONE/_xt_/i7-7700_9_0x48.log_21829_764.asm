...
nop
add %rsi, %rsi
lea addresses_UC_ht+0x4953, %r11
xor $54503, %rdi
mov (%r11), %si
nop
sub $54486, %r15
lea addresses_UC_ht+0x2e95, %r8
nop
nop
nop
nop
...
vpextrq $0, %xmm5, %r15
sub $14705, %rsi
lea addresses_A_ht+0x1a813, %r11
sub %r15, %r15
...
nop
cmp %rcx, %rcx
lea addresses_UC_ht+0xf06b, %r8
inc %rcx
mov (%r8), %si
xor %r8, %r8
lea addresses_WC_ht+0x11d3, %rsi
nop
nop
nop
and $64152, %r11
...
nop
cmp $20128, %r9
lea addresses_WC_ht+0x37d3, %rsi
lea addresses_WC_ht+0x11dd3, %rdi
nop
nop
nop
dec %rax
...
rep movsb
dec %r9
lea addresses_WC_ht+0x16f5f, %rdi
nop
nop
nop
nop
...
nop
and $26282, %r15
lea addresses_WT_ht+0x1e0d3, %rax
nop
cmp %r11, %r11
movw $0x6162, (%rax)
nop
sub %rcx, %rcx
lea addresses_D_ht+0x35d5, %rsi
and %rax, %rax
movw $0x6162, (%rsi)
nop
and $3997, %r15
lea addresses_UC_ht+0x169d3, %rsi
lea addresses_A_ht+0x4503, %rdi
nop
nop
nop
nop
...
nop
cmp $43486, %rsi
lea addresses_normal_ht+0x6dd3, %rsi
nop
nop
nop
xor $33962, %rax
...
// Faulty Load
lea addresses_normal+0xfdd3, %rsi
nop
nop
nop
nop
...
{'OP': 'REPM', 'src': {'type': 'addresses_WC_ht', 'congruent': 8, 'same': False}, 'dst': {'type': 'addresses_WC_ht', 'congruent': 11, 'same': True}}
