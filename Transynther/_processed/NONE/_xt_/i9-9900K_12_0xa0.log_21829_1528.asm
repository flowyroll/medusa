...
push %r9
push %rcx
lea addresses_WC_ht+0x1c3ee, %r13
nop
nop
nop
cmp $25092, %r14
...
nop
sub %r9, %r9
lea addresses_A_ht+0x138ee, %r15
clflush (%r15)
nop
nop
sub %rcx, %rcx
...
nop
xor %rcx, %rcx
lea addresses_normal_ht+0x80ee, %r13
nop
nop
nop
nop
...
nop
cmp $20983, %rcx
lea addresses_UC_ht+0x11ae, %r11
clflush (%r11)
nop
add %r8, %r8
movl $0x61626364, (%r11)
nop
cmp %r8, %r8
lea addresses_WT_ht+0x1bdee, %rcx
add $54639, %r15
movb $0x61, (%rcx)
nop
inc %r14
