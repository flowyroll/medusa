...
push %rdx
push %rsi
lea addresses_WT_ht+0x160ab, %rbp
xor $19405, %r14
vmovups (%rbp), %ymm4
...
nop
and %r13, %r13
lea addresses_WC_ht+0x133ab, %r8
nop
nop
nop
nop
...
nop
mfence
lea addresses_A_ht+0x1a5ab, %rsi
lea addresses_normal_ht+0x11dab, %rdi
nop
nop
nop
xor %r15, %r15
...
rep movsb
sub %rdx, %rdx
lea addresses_normal_ht+0x254b, %rsi
lea addresses_WC_ht+0x11dab, %rdi
nop
nop
inc %r9
mov $35, %rcx
...
nop
add %rsi, %rsi
lea addresses_D_ht+0x6cae, %r14
clflush (%r14)
cmp $49535, %rbp
movb $0x61, (%r14)
nop
xor $27755, %rdx
lea addresses_WC_ht+0x3cab, %rdi
nop
nop
dec %r15
...
nop
dec %rsi
lea addresses_UC_ht+0x1afab, %r8
nop
nop
nop
and $8287, %rsi
...
// Load
lea addresses_normal+0x1afcb, %r13
nop
nop
nop
nop
