...
push %rdx
push %rsi
lea addresses_normal_ht+0x7f60, %rsi
clflush (%rsi)
xor $62783, %rdi
mov (%rsi), %r9
nop
...
nop
cmp %r15, %r15
lea addresses_A_ht+0x1a240, %rsi
lea addresses_WT_ht+0x49c4, %rdi
and $21628, %r9
mov $117, %rcx
rep movsl
nop
...
lea addresses_A_ht+0x15460, %rdi
nop
sub %rdx, %rdx
mov $51, %rcx
rep movsw
...
// Store
lea addresses_normal+0x1b7f2, %r12
add %rdi, %rdi
...
{'OP': 'LOAD', 'src': {'type': 'addresses_WT', 'size': 4, 'AVXalign': True, 'NT': False, 'congruent': 6, 'same': False}}
