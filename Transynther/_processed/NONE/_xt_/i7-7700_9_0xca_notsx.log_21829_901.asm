...
push %rdx
push %rsi
lea addresses_WT_ht+0x11839, %rdx
nop
nop
nop
nop
...
nop
inc %r9
lea addresses_WC_ht+0x19305, %rsi
lea addresses_normal_ht+0xcd45, %rdi
nop
nop
nop
nop
...
nop
sub %rsi, %rsi
lea addresses_normal_ht+0x19e35, %rsi
nop
nop
nop
nop
...
{'src': {'NT': True, 'AVXalign': True, 'size': 1, 'congruent': 3, 'same': False, 'type': 'addresses_normal_ht'}, 'OP': 'LOAD'}
{'32': 21829}
