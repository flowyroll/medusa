...
push %rdi
push %rsi
lea addresses_D_ht+0x1a716, %r13
nop
nop
nop
nop
...
nop
dec %r8
lea addresses_UC_ht+0x1b7a6, %rsi
lea addresses_D_ht+0x1d9a6, %rdi
nop
nop
dec %r15
mov $102, %rcx
...
nop
cmp %r14, %r14
lea addresses_A_ht+0x3396, %rsi
lea addresses_WT_ht+0x1ed4f, %rdi
nop
nop
nop
nop
...
nop
xor $29496, %r11
lea addresses_A_ht+0xb55e, %rsi
lea addresses_WT_ht+0x3b16, %rdi
clflush (%rsi)
add $42170, %r11
mov $25, %rcx
rep movsq
...
{'OP': 'REPM', 'src': {'same': False, 'congruent': 7, 'type': 'addresses_A_ht'}, 'dst': {'same': False, 'congruent': 0, 'type': 'addresses_WT_ht'}}
