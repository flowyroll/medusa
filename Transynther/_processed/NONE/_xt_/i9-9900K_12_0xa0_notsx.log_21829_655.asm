...
push %rdi
push %rsi
lea addresses_UC_ht+0x48e4, %rsi
lea addresses_WT_ht+0x9a4, %rdi
nop
and $3009, %rbp
mov $29, %rcx
rep movsl
...
nop
sub %r14, %r14
lea addresses_WC_ht+0xffa4, %rbp
nop
nop
nop
nop
...
movb (%rbp), %cl
and %rdi, %rdi
lea addresses_normal_ht+0x99ee, %rbp
clflush (%rbp)
nop
nop
nop
...
nop
inc %r8
lea addresses_normal_ht+0x1b724, %rdi
nop
nop
and %r14, %r14
...
movq %r11, (%rdi)
and %rcx, %rcx
lea addresses_UC_ht+0x13de4, %rdi
nop
nop
inc %rsi
mov $0x6162636465666768, %r11
...
vmovups %ymm6, (%rdi)
dec %rsi
lea addresses_A_ht+0x1b3fc, %rsi
nop
nop
nop
nop
...
nop
xor %r8, %r8
lea addresses_WC_ht+0x18210, %rsi
lea addresses_WC_ht+0x80a4, %rdi
clflush (%rdi)
sub $26100, %r14
mov $86, %rcx
rep movsq
...
nop
and $11662, %r11
lea addresses_D_ht+0x10824, %rcx
and $1110, %r8
mov (%rcx), %di
nop
nop
...
nop
sub %rdi, %rdi
lea addresses_A_ht+0x5ba4, %rsi
lea addresses_UC_ht+0x168a4, %rdi
nop
sub $21531, %rax
mov $92, %rcx
rep movsw
cmp %r11, %r11
lea addresses_UC_ht+0xabdc, %r14
nop
nop
cmp $22106, %r8
movb $0x61, (%r14)
...
{'OP': 'STOR', 'dst': {'type': 'addresses_A_ht', 'AVXalign': False, 'size': 1, 'NT': True, 'same': False, 'congruent': 2}}
{'src': {'type': 'addresses_A_ht', 'AVXalign': False, 'size': 32, 'NT': False, 'same': False, 'congruent': 11}, 'OP': 'LOAD'}
{'src': {'type': 'addresses_WC_ht', 'congruent': 2, 'same': False}, 'OP': 'REPM', 'dst': {'type': 'addresses_WC_ht', 'congruent': 8, 'same': False}}
