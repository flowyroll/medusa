...
push %rdx
push %rsi
lea addresses_WC_ht+0x1692b, %rsi
lea addresses_A_ht+0x15c63, %rdi
cmp %r10, %r10
mov $63, %rcx
rep movsb
nop
...
nop
xor %rbx, %rbx
lea addresses_WC_ht+0xfecb, %rsi
lea addresses_WC_ht+0x13bdb, %rdi
nop
dec %r13
mov $59, %rcx
rep movsw
...
nop
add $40298, %rsi
lea addresses_UC_ht+0x9e57, %rbx
nop
add %r10, %r10
...
nop
xor $17077, %rdi
lea addresses_WC_ht+0x1baeb, %rdi
nop
and %rdx, %rdx
movw $0x6162, (%rdi)
nop
...
nop
dec %r13
lea addresses_UC_ht+0x3bab, %rcx
nop
nop
and %r13, %r13
...
nop
and %r10, %r10
lea addresses_WT_ht+0x16bab, %rsi
cmp $21827, %r10
mov (%rsi), %edx
nop
nop
...
nop
sub %rdi, %rdi
lea addresses_WC_ht+0x93ab, %rsi
nop
nop
nop
sub $31492, %r10
...
<gen_prepare_buffer>
{'OP': 'REPM', 'src': {'same': False, 'congruent': 5, 'type': 'addresses_WC_ht'}, 'dst': {'same': False, 'congruent': 3, 'type': 'addresses_A_ht'}}
{'OP': 'REPM', 'src': {'same': False, 'congruent': 4, 'type': 'addresses_WC_ht'}, 'dst': {'same': False, 'congruent': 4, 'type': 'addresses_WC_ht'}}
