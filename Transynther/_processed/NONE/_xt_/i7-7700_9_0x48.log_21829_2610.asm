...
push %rdx
push %rsi
lea addresses_WT_ht+0x26fc, %rsi
lea addresses_WC_ht+0x1754e, %rdi
clflush (%rsi)
nop
nop
nop
...
nop
lfence
lea addresses_normal_ht+0xf7a4, %r13
nop
nop
nop
sub $49946, %r15
...
nop
cmp %r13, %r13
lea addresses_D_ht+0x9ca4, %rsi
lea addresses_normal_ht+0x8de4, %rdi
clflush (%rsi)
nop
nop
nop
...
nop
dec %rdx
lea addresses_UC_ht+0x194a4, %rdi
nop
nop
nop
inc %r14
...
nop
and $42412, %r14
lea addresses_UC_ht+0x1c0a4, %r13
clflush (%r13)
nop
nop
nop
...
{'OP': 'REPM', 'src': {'type': 'addresses_D_ht', 'congruent': 10, 'same': False}, 'dst': {'type': 'addresses_normal_ht', 'congruent': 4, 'same': True}}
