...
nop
sub $44240, %rsi
lea addresses_UC_ht+0x78d6, %rax
nop
nop
nop
xor %rsi, %rsi
...
nop
and %rax, %rax
lea addresses_WT_ht+0x5a0e, %r15
nop
nop
nop
and $58076, %rsi
...
nop
and %rbx, %rbx
lea addresses_normal_ht+0x17b0e, %rcx
clflush (%rcx)
xor %r15, %r15
vmovups (%rcx), %ymm0
