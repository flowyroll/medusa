...
nop
and %r15, %r15
lea addresses_WT_ht+0x185e7, %rdx
nop
nop
xor %r15, %r15
movb $0x61, (%rdx)
...
nop
add $33952, %r15
lea addresses_normal_ht+0x3d59, %rcx
add %rsi, %rsi
movl $0x61626364, (%rcx)
nop
nop
sub %rdx, %rdx
lea addresses_A_ht+0x5e31, %rcx
clflush (%rcx)
sub %rsi, %rsi
movups (%rcx), %xmm3
vpextrq $0, %xmm3, %rdi
and $34082, %r15
lea addresses_A_ht+0x11171, %rdi
nop
nop
nop
nop
...
nop
sub $41835, %rdi
lea addresses_WT_ht+0x17fb1, %rcx
nop
cmp %r8, %r8
movw $0x6162, (%rcx)
nop
...
lea addresses_WT_ht+0x53bb, %rdi
nop
nop
nop
cmp $38415, %r11
...
rep movsw
sub $30979, %rsi
lea addresses_normal_ht+0x5c4b, %rcx
nop
nop
cmp $60556, %r15
mov (%rcx), %esi
and %rsi, %rsi
lea addresses_UC_ht+0x106e9, %rsi
lea addresses_normal_ht+0x16c31, %rdi
nop
nop
add %r11, %r11
mov $91, %rcx
rep movsq
add $803, %r15
lea addresses_WT_ht+0xa011, %rsi
lea addresses_UC_ht+0x5151, %rdi
nop
nop
nop
nop
...
{'OP': 'STOR', 'dst': {'same': True, 'type': 'addresses_WT_ht', 'NT': False, 'AVXalign': False, 'size': 2, 'congruent': 8}}
...
{'OP': 'REPM', 'src': {'same': False, 'congruent': 1, 'type': 'addresses_UC_ht'}, 'dst': {'same': False, 'congruent': 7, 'type': 'addresses_normal_ht'}}
