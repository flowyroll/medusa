...
push %rdx
push %rsi
lea addresses_WT_ht+0x1ddf3, %r9
nop
nop
sub %r13, %r13
...
nop
xor $4720, %r14
lea addresses_D_ht+0xd733, %rsi
lea addresses_WT_ht+0xca27, %rdi
sub %r8, %r8
mov $16, %rcx
rep movsb
nop
nop
and $19855, %rdx
lea addresses_UC_ht+0x5253, %rdx
nop
nop
dec %rdi
mov (%rdx), %r9w
nop
xor $13576, %rsi
lea addresses_normal_ht+0x180b3, %r13
nop
nop
nop
nop
...
movq %rdx, (%r13)
sub %r8, %r8
lea addresses_normal_ht+0x6d33, %r8
nop
nop
xor %r13, %r13
...
nop
xor $3596, %r14
lea addresses_normal_ht+0x14cf3, %rsi
...
// Faulty Load
lea addresses_normal+0x4733, %r9
cmp $37617, %r8
mov (%r9), %bx
lea oracles, %r13
and $0xff, %rbx
