...
nop
inc %rdi
lea addresses_UC_ht+0x9e6f, %rax
clflush (%rax)
nop
sub %rbp, %rbp
movb (%rax), %r14b
...
nop
dec %r14
lea addresses_WT_ht+0x10def, %rax
nop
nop
nop
dec %r14
...
movq %rbp, (%rax)
xor $44854, %rcx
lea addresses_WC_ht+0x1ed6f, %rcx
nop
nop
dec %r13
mov (%rcx), %rax
sub %r13, %r13
lea addresses_D_ht+0x1666f, %rax
nop
nop
nop
nop
...
nop
cmp %r14, %r14
lea addresses_WT_ht+0x13601, %rax
nop
nop
and %rbp, %rbp
...
nop
and %rbp, %rbp
lea addresses_UC_ht+0x8eef, %rcx
nop
sub $497, %rax
movb (%rcx), %r11b
nop
...
nop
sub $41661, %rax
lea addresses_UC_ht+0x4f6f, %rsi
lea addresses_normal_ht+0x9dcf, %rdi
sub %r11, %r11
mov $60, %rcx
rep movsl
nop
...
nop
dec %rbp
lea addresses_WT_ht+0xc66f, %rbp
nop
nop
nop
and $51563, %rcx
mov (%rbp), %rax
and $35879, %rbp
lea addresses_UC_ht+0x1752f, %rcx
nop
nop
nop
nop
...
vpextrq $1, %xmm7, %rax
cmp %r14, %r14
lea addresses_A_ht+0x19ce1, %rsi
lea addresses_WC_ht+0x1cf6f, %rdi
nop
nop
nop
nop
...
nop
add $19091, %rsi
lea addresses_normal_ht+0x127af, %rcx
nop
nop
nop
nop
...
nop
and %rax, %rax
lea addresses_WC_ht+0x1916f, %r11
dec %r14
movw $0x6162, (%r11)
nop
nop
...
nop
add $128, %rsi
lea addresses_UC_ht+0x1306f, %rsi
lea addresses_WC_ht+0x161af, %rdi
nop
nop
nop
nop
...
{'OP': 'LOAD', 'src': {'type': 'addresses_WC_ht', 'AVXalign': True, 'congruent': 8, 'size': 8, 'same': False, 'NT': False}}
{'OP': 'STOR', 'dst': {'type': 'addresses_D_ht', 'AVXalign': False, 'congruent': 10, 'size': 16, 'same': False, 'NT': False}}
{'OP': 'LOAD', 'src': {'type': 'addresses_WT_ht', 'AVXalign': False, 'congruent': 0, 'size': 16, 'same': False, 'NT': True}}
{'OP': 'LOAD', 'src': {'type': 'addresses_UC_ht', 'AVXalign': False, 'congruent': 5, 'size': 1, 'same': False, 'NT': False}}
{'OP': 'REPM', 'src': {'type': 'addresses_UC_ht', 'congruent': 8, 'same': True}, 'dst': {'type': 'addresses_normal_ht', 'congruent': 2, 'same': False}}
...
{'OP': 'LOAD', 'src': {'type': 'addresses_normal_ht', 'AVXalign': True, 'congruent': 3, 'size': 4, 'same': False, 'NT': True}}
