...
nop
and $46861, %rsi
lea addresses_A_ht+0x9894, %rsi
nop
nop
and %r8, %r8
movl $0x61626364, (%rsi)
and $47493, %rdx
lea addresses_WC_ht+0xe18c, %rsi
lea addresses_normal_ht+0x130c, %rdi
nop
nop
add $30551, %r15
mov $40, %rcx
...
{'src': {'type': 'addresses_D', 'AVXalign': False, 'size': 32, 'NT': False, 'same': False, 'congruent': 2}, 'OP': 'LOAD'}
