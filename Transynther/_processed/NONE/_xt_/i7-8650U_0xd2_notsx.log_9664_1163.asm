...
push %rdx
push %rsi
lea addresses_D_ht+0x119c4, %rax
nop
nop
nop
nop
...
nop
add $60653, %rdx
lea addresses_WT_ht+0x18120, %rsi
lea addresses_D_ht+0xf0e0, %rdi
nop
nop
nop
dec %r13
...
rep movsq
sub %rdi, %rdi
lea addresses_WC_ht+0x2780, %rbp
nop
nop
nop
nop
...
nop
add %rsi, %rsi
lea addresses_UC_ht+0x1b320, %rsi
lea addresses_WT_ht+0x134d4, %rdi
nop
nop
nop
nop
...
rep movsb
lfence
lea addresses_normal_ht+0x1d88, %rdx
nop
nop
nop
xor %rbp, %rbp
...
{'OP': 'REPM', 'src': {'type': 'addresses_UC_ht', 'congruent': 8, 'same': False}, 'dst': {'type': 'addresses_WT_ht', 'congruent': 2, 'same': True}}
