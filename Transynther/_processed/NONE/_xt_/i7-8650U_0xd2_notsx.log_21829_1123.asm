...
push %rdi
push %rsi
lea addresses_UC_ht+0x11957, %r11
nop
xor %r9, %r9
...
nop
add $64139, %r10
lea addresses_normal_ht+0xbeb7, %rax
nop
nop
inc %r15
movb $0x61, (%rax)
...
nop
sub %rdi, %rdi
lea addresses_A_ht+0x132b7, %rax
nop
nop
and $4269, %rcx
movups (%rax), %xmm3
...
nop
add %r15, %r15
lea addresses_D_ht+0x100b7, %rsi
lea addresses_WC_ht+0x14537, %rdi
nop
nop
nop
nop
...
// Store
lea addresses_normal+0xe137, %rbp
nop
nop
nop
nop
...
{'OP': 'REPM', 'src': {'type': 'addresses_D_ht', 'congruent': 8, 'same': False}, 'dst': {'type': 'addresses_WC_ht', 'congruent': 6, 'same': False}}
{'32': 21829}
