...
push %rcx
push %rdi
lea addresses_WC_ht+0x59fb, %r14
nop
nop
add $2019, %rcx
movl $0x61626364, (%r14)
...
nop
sub $17562, %rdi
lea addresses_WT_ht+0x1a1fb, %r9
nop
and $3102, %r12
movups (%r9), %xmm4
vpextrq $0, %xmm4, %rbx
...
nop
xor $12627, %r12
lea addresses_UC_ht+0x13fb, %r12
clflush (%r12)
nop
nop
inc %r11
...
nop
sub $60527, %rdi
lea addresses_A_ht+0x44fb, %r12
and %r11, %r11
vmovups (%r12), %ymm1
vextracti128 $0, %ymm1, %xmm1
vpextrq $1, %xmm1, %rcx
xor $40556, %r12
lea addresses_normal_ht+0x13943, %rcx
nop
nop
nop
sub $15550, %rdi
...
nop
sub $38870, %r14
lea addresses_WC_ht+0x1b5fb, %r12
nop
nop
nop
nop
...
nop
sub $20249, %r11
lea addresses_WC_ht+0xbc08, %rdi
nop
and $17960, %r14
mov (%rdi), %ebx
nop
...
{'OP': 'STOR', 'dst': {'type': 'addresses_WC', 'AVXalign': True, 'size': 1, 'NT': False, 'same': False, 'congruent': 9}}
[Faulty Load]
