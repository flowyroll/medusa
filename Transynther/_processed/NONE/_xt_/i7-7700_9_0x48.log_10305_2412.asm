...
push %rdi
push %rsi
lea addresses_normal_ht+0x188f2, %rsi
lea addresses_UC_ht+0x54f2, %rdi
nop
nop
dec %rbx
mov $28, %rcx
rep movsq
add $42093, %r11
lea addresses_WC_ht+0x164f2, %rbp
cmp $38639, %r12
movb $0x61, (%rbp)
nop
nop
...
nop
add $33766, %r11
lea addresses_normal_ht+0x14f06, %rbx
nop
inc %rdi
movb (%rbx), %cl
nop
