...
nop
inc %rdi
lea addresses_D_ht+0x101f5, %rsi
lea addresses_WT_ht+0xd265, %rdi
nop
nop
nop
inc %rdx
...
nop
sub %rax, %rax
lea addresses_normal_ht+0x13ce9, %rsi
lea addresses_UC_ht+0x5259, %rdi
nop
nop
nop
nop
...
nop
add $40746, %rax
lea addresses_UC_ht+0x15ba5, %rcx
nop
nop
and $59890, %rdi
...
// Store
lea addresses_normal+0x365, %rbp
nop
nop
nop
and %rcx, %rcx
...
{'OP': 'STOR', 'dst': {'same': False, 'type': 'addresses_D_ht', 'NT': True, 'AVXalign': False, 'size': 2, 'congruent': 2}}
{'OP': 'REPM', 'src': {'same': False, 'congruent': 3, 'type': 'addresses_D_ht'}, 'dst': {'same': True, 'congruent': 8, 'type': 'addresses_WT_ht'}}
{'OP': 'REPM', 'src': {'same': False, 'congruent': 2, 'type': 'addresses_normal_ht'}, 'dst': {'same': False, 'congruent': 1, 'type': 'addresses_UC_ht'}}
{'OP': 'STOR', 'dst': {'same': False, 'type': 'addresses_UC_ht', 'NT': True, 'AVXalign': False, 'size': 16, 'congruent': 6}}
{'37': 21829}
