...
rep movsq
sub $39069, %rcx
lea addresses_UC_ht+0x1662c, %rsi
lea addresses_normal_ht+0x1db30, %rdi
nop
sub %rax, %rax
mov $40, %rcx
rep movsw
and $8751, %r12
lea addresses_WT_ht+0x8dc0, %r12
inc %r8
movb (%r12), %r11b
nop
nop
xor %r10, %r10
lea addresses_WT_ht+0x4a00, %rsi
...
rep movsq
and %rsi, %rsi
lea addresses_normal_ht+0x17e90, %rdi
nop
dec %rcx
movups (%rdi), %xmm0
vpextrq $0, %xmm0, %r10
...
nop
sub %rcx, %rcx
lea addresses_WC_ht+0x9048, %rsi
lea addresses_D_ht+0x1ae70, %rdi
nop
nop
nop
nop
...
nop
xor %rcx, %rcx
lea addresses_WT_ht+0x6930, %rdi
clflush (%rdi)
nop
nop
cmp $32774, %rsi
...
{'OP': 'REPM', 'src': {'same': False, 'congruent': 2, 'type': 'addresses_UC_ht'}, 'dst': {'same': True, 'congruent': 5, 'type': 'addresses_normal_ht'}}
{'OP': 'LOAD', 'src': {'same': False, 'type': 'addresses_WT_ht', 'NT': False, 'AVXalign': False, 'size': 1, 'congruent': 1}}
{'OP': 'REPM', 'src': {'same': False, 'congruent': 2, 'type': 'addresses_WT_ht'}, 'dst': {'same': False, 'congruent': 1, 'type': 'addresses_UC_ht'}}
