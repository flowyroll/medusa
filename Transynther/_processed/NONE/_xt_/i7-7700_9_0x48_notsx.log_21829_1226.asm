...
push %rdx
push %rsi
lea addresses_A_ht+0x1adbb, %r12
nop
nop
nop
nop
...
nop
add $8855, %rbp
lea addresses_normal_ht+0x1e633, %rdx
nop
nop
nop
nop
...
movb (%rdx), %bl
and %rdx, %rdx
lea addresses_normal_ht+0x1b17b, %rsi
lea addresses_WT_ht+0x263b, %rdi
nop
nop
nop
nop
...
rep movsl
sub $5355, %rcx
lea addresses_UC_ht+0xd63b, %rbp
nop
nop
nop
add %r8, %r8
...
nop
sub $41984, %r8
lea addresses_A_ht+0x12f3b, %rdi
nop
nop
inc %rbx
movb (%rdi), %cl
