...
push %rdx
push %rsi
lea addresses_normal_ht+0x1167d, %rsi
lea addresses_A_ht+0x1ccca, %rdi
clflush (%rdi)
nop
nop
inc %r11
...
nop
add $31015, %r14
lea addresses_WT_ht+0x5d36, %rsi
lea addresses_WT_ht+0x1a402, %rdi
inc %r14
mov $25, %rcx
rep movsl
nop
...
nop
add %rcx, %rcx
lea addresses_WT_ht+0x8eea, %rax
nop
nop
nop
xor $55367, %rdx
...
nop
add %rsi, %rsi
lea addresses_WT_ht+0x5f82, %rcx
xor $18830, %r11
movl $0x61626364, (%rcx)
nop
nop
...
nop
sub %rdx, %rdx
lea addresses_WC_ht+0x9882, %rcx
xor $12918, %rsi
vmovups (%rcx), %ymm6
...
// Store
lea addresses_normal+0xa082, %rcx
nop
nop
sub %rdx, %rdx
movw $0x5152, (%rcx)
...
<gen_prepare_buffer>
{'OP': 'REPM', 'src': {'same': False, 'congruent': 0, 'type': 'addresses_normal_ht'}, 'dst': {'same': False, 'congruent': 3, 'type': 'addresses_A_ht'}}
