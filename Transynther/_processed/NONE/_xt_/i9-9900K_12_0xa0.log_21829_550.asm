...
nop
and %r14, %r14
lea addresses_normal_ht+0x16b36, %rsi
lea addresses_D_ht+0x8494, %rdi
nop
cmp %r8, %r8
mov $102, %rcx
rep movsq
...
nop
sub %rdi, %rdi
lea addresses_WT_ht+0x14764, %rsi
lea addresses_A_ht+0x1c764, %rdi
nop
nop
nop
nop
...
nop
add $1174, %rcx
lea addresses_WT_ht+0xcc24, %rsi
lea addresses_UC_ht+0x8f64, %rdi
nop
nop
nop
add $40827, %r13
...
{'src': {'NT': True, 'same': False, 'congruent': 1, 'type': 'addresses_normal_ht', 'AVXalign': False, 'size': 1}, 'OP': 'LOAD'}
