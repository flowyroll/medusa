...
push %rdi
push %rsi
lea addresses_UC_ht+0x8b34, %rsi
nop
and %r9, %r9
...
nop
cmp $48245, %r10
lea addresses_WC_ht+0x6988, %rdi
nop
and $13837, %r10
...
nop
sub %rdi, %rdi
lea addresses_D_ht+0x188c8, %rsi
nop
nop
nop
nop
...
nop
sub %r15, %r15
lea addresses_A_ht+0x14ef0, %rsi
lea addresses_UC_ht+0x15148, %rdi
nop
nop
nop
sub %r8, %r8
...
nop
xor $39893, %r15
lea addresses_UC_ht+0x16f80, %r10
dec %r8
...
nop
inc %rdi
lea addresses_WC_ht+0x7622, %rdi
nop
nop
nop
and %rsi, %rsi
...
nop
sub $46664, %rcx
lea addresses_D_ht+0x2468, %rsi
lea addresses_A_ht+0x1c914, %rdi
and $6728, %r15
mov $78, %rcx
rep movsl
nop
...
nop
and $37167, %rdi
lea addresses_A_ht+0x181c8, %rsi
lea addresses_normal_ht+0x40c8, %rdi
clflush (%rdi)
nop
nop
nop
...
rep movsq
add $31159, %rdi
lea addresses_UC_ht+0x1c8c8, %r15
nop
inc %rsi
...
{'OP': 'STOR', 'dst': {'type': 'addresses_UC', 'AVXalign': True, 'congruent': 6, 'size': 2, 'same': False, 'NT': False}}
[Faulty Load]
...
{'OP': 'REPM', 'src': {'type': 'addresses_A_ht', 'congruent': 8, 'same': False}, 'dst': {'type': 'addresses_normal_ht', 'congruent': 9, 'same': True}}
...
{'OP': 'LOAD', 'src': {'type': 'addresses_A_ht', 'AVXalign': True, 'congruent': 11, 'size': 8, 'same': False, 'NT': False}}
