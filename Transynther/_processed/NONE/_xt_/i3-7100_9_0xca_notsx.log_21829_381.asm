...
push %rdx
push %rsi
lea addresses_WC_ht+0x1cef4, %rsi
...
rep movsl
dec %r15
lea addresses_WT_ht+0xae84, %r14
nop
nop
xor $30136, %r8
mov (%r14), %edi
...
nop
cmp %rcx, %rcx
lea addresses_normal_ht+0x1144, %rsi
nop
nop
nop
nop
...
nop
sub %rdi, %rdi
lea addresses_A_ht+0x1616f, %rsi
lea addresses_normal_ht+0x1ddc4, %rdi
nop
nop
nop
dec %rdx
...
<gen_prepare_buffer>
{'src': {'type': 'addresses_WC_ht', 'congruent': 4, 'same': False}, 'OP': 'REPM', 'dst': {'type': 'addresses_UC_ht', 'congruent': 6, 'same': False}}
