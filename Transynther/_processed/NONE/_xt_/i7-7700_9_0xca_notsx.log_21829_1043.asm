...
nop
inc %rcx
lea addresses_WC_ht+0xec8f, %r15
nop
nop
nop
nop
...
nop
add %r10, %r10
lea addresses_A_ht+0x1567c, %rcx
nop
nop
nop
nop
...
nop
add %rsi, %rsi
lea addresses_UC_ht+0x1b40f, %r10
nop
cmp %r15, %r15
movups (%r10), %xmm6
vpextrq $0, %xmm6, %rax
...
nop
cmp %rcx, %rcx
lea addresses_UC_ht+0x334f, %rsi
lea addresses_normal_ht+0x1a28f, %rdi
and $25937, %rax
mov $69, %rcx
rep movsw
nop
...
nop
xor %r10, %r10
lea addresses_A_ht+0x95bf, %rsi
lea addresses_D_ht+0x1d9e6, %rdi
nop
dec %r10
mov $3, %rcx
rep movsb
xor %rsi, %rsi
lea addresses_UC_ht+0xc94f, %rsi
lea addresses_WC_ht+0x1a94f, %rdi
nop
nop
nop
dec %r15
...
nop
inc %rcx
lea addresses_UC_ht+0x11a4f, %rax
nop
nop
cmp %r8, %r8
movl $0x61626364, (%rax)
...
nop
sub $31773, %r8
lea addresses_A_ht+0x10c4f, %r10
and $42340, %rcx
movw $0x6162, (%r10)
nop
nop
...
{'dst': {'NT': True, 'AVXalign': False, 'size': 1, 'congruent': 8, 'same': False, 'type': 'addresses_WC'}, 'OP': 'STOR'}
...
{'src': {'congruent': 5, 'same': False, 'type': 'addresses_UC_ht'}, 'dst': {'congruent': 1, 'same': False, 'type': 'addresses_normal_ht'}, 'OP': 'REPM'}
{'src': {'congruent': 4, 'same': False, 'type': 'addresses_A_ht'}, 'dst': {'congruent': 0, 'same': False, 'type': 'addresses_D_ht'}, 'OP': 'REPM'}
{'src': {'congruent': 10, 'same': False, 'type': 'addresses_UC_ht'}, 'dst': {'congruent': 10, 'same': False, 'type': 'addresses_WC_ht'}, 'OP': 'REPM'}
{'dst': {'NT': False, 'AVXalign': False, 'size': 4, 'congruent': 8, 'same': True, 'type': 'addresses_UC_ht'}, 'OP': 'STOR'}
