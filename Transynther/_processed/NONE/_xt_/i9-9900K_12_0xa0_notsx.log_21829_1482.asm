...
push %rdx
push %rsi
lea addresses_normal_ht+0x16372, %r10
nop
inc %rdi
movl $0x61626364, (%r10)
nop
...
nop
xor %rdx, %rdx
lea addresses_normal_ht+0x1cc82, %r15
nop
nop
nop
add $18988, %rcx
...
nop
xor $48155, %rdx
lea addresses_UC_ht+0x1790a, %rdi
nop
nop
nop
cmp $13993, %rax
...
nop
xor %r12, %r12
lea addresses_normal_ht+0x1b8ee, %rax
nop
nop
nop
nop
...
nop
and $10972, %rcx
lea addresses_WT_ht+0xcb72, %rax
nop
nop
nop
nop
...
{'OP': 'STOR', 'dst': {'type': 'addresses_WT_ht', 'AVXalign': True, 'size': 1, 'NT': True, 'same': False, 'congruent': 10}}
