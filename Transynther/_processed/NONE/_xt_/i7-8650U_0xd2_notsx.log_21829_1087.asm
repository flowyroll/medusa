...
push %rdi
push %rsi
lea addresses_D_ht+0x452a, %rsi
lea addresses_WT_ht+0x1dc6a, %rdi
nop
nop
nop
nop
...
nop
dec %r12
lea addresses_WT_ht+0x1a3ea, %rsi
nop
cmp %rcx, %rcx
...
nop
inc %rdi
lea addresses_UC_ht+0x16fc9, %r8
nop
nop
nop
nop
...
vpextrq $1, %xmm2, %rsi
cmp $59533, %rcx
lea addresses_UC_ht+0x1466a, %r8
nop
dec %r12
movb $0x61, (%r8)
nop
nop
add $65334, %r12
lea addresses_normal_ht+0x1647e, %r8
nop
sub $41977, %rdi
mov $0x6162636465666768, %r12
movq %r12, (%r8)
cmp %r8, %r8
lea addresses_WC_ht+0x1360a, %rsi
nop
nop
nop
nop
...
nop
add $2323, %rcx
lea addresses_WC_ht+0xf5ea, %r12
nop
nop
nop
xor $56495, %r10
...
nop
add %r10, %r10
lea addresses_normal_ht+0x1466a, %r10
nop
nop
nop
nop
