...
nop
sub %rcx, %rcx
lea addresses_UC_ht+0xcef0, %rsi
lea addresses_UC_ht+0x17770, %rdi
add $50634, %r14
mov $86, %rcx
rep movsl
nop
nop
sub %rdx, %rdx
lea addresses_normal_ht+0x9370, %rdi
nop
nop
nop
nop
...
nop
sub $14522, %rdx
lea addresses_UC_ht+0xd1f0, %rsi
nop
nop
nop
xor $6160, %r14
