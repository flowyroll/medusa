...
push %rdi
push %rsi
lea addresses_WC_ht+0xa118, %rcx
nop
nop
nop
add $32280, %r15
...
nop
and %r11, %r11
lea addresses_UC_ht+0x15778, %rsi
lea addresses_WT_ht+0x2498, %rdi
nop
nop
nop
nop
...
nop
xor %r15, %r15
lea addresses_WC_ht+0x2698, %r15
and %rbx, %rbx
movw $0x6162, (%r15)
nop
nop
...
nop
cmp %rsi, %rsi
lea addresses_normal_ht+0xaf18, %r11
nop
xor $36152, %r14
movw $0x6162, (%r11)
nop
...
nop
inc %rsi
lea addresses_normal_ht+0x13b18, %rsi
lea addresses_WC_ht+0xd88f, %rdi
inc %r11
mov $100, %rcx
rep movsl
nop
