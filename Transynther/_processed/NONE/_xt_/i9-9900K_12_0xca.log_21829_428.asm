...
lea addresses_A_ht+0x12f0c, %rdi
nop
nop
add $48044, %r12
mov $57, %rcx
...
nop
and $16002, %rsi
lea addresses_UC_ht+0x1a9ec, %rsi
lea addresses_WT_ht+0xb146, %rdi
clflush (%rsi)
nop
inc %rbp
mov $101, %rcx
...
nop
cmp $36384, %r14
lea addresses_WC_ht+0x1d21c, %rsi
lea addresses_UC_ht+0xabcc, %rdi
nop
nop
nop
nop
...
nop
cmp $55509, %rbp
lea addresses_WC_ht+0x19937, %r14
nop
nop
nop
nop
...
nop
inc %rdi
lea addresses_WC_ht+0x4fcc, %r14
nop
add %r13, %r13
mov (%r14), %r12w
nop
...
// Load
lea addresses_normal+0x15d9c, %r15
nop
xor %rax, %rax
mov (%r15), %r10
nop
...
// Load
lea addresses_normal+0x1410c, %rax
sub $1277, %r15
movups (%rax), %xmm4
vpextrq $1, %xmm4, %r12
nop
...
{'OP': 'LOAD', 'src': {'size': 16, 'NT': False, 'type': 'addresses_normal', 'same': False, 'AVXalign': False, 'congruent': 6}}
[Faulty Load]
...
{'OP': 'LOAD', 'src': {'size': 1, 'NT': True, 'type': 'addresses_normal_ht', 'same': False, 'AVXalign': False, 'congruent': 11}}
{'OP': 'REPM', 'src': {'same': False, 'type': 'addresses_WC_ht', 'congruent': 3}, 'dst': {'same': False, 'type': 'addresses_A_ht', 'congruent': 5}}
{'OP': 'REPM', 'src': {'same': False, 'type': 'addresses_UC_ht', 'congruent': 5}, 'dst': {'same': False, 'type': 'addresses_WT_ht', 'congruent': 1}}
