...
nop
xor %rbx, %rbx
lea addresses_normal_ht+0x9e51, %rbx
nop
nop
nop
nop
...
nop
cmp %r10, %r10
lea addresses_A_ht+0x9611, %r8
and $17380, %r10
mov $0x6162636465666768, %rcx
movq %rcx, %xmm2
vmovups %ymm2, (%r8)
and %rsi, %rsi
lea addresses_A_ht+0x551, %rbx
nop
nop
nop
xor %rdi, %rdi
...
nop
cmp $12561, %rbx
lea addresses_WC_ht+0x1d031, %rcx
nop
nop
and %rbx, %rbx
mov (%rcx), %rdi
xor %rsi, %rsi
lea addresses_normal_ht+0x6501, %rsi
lea addresses_normal_ht+0xada2, %rdi
nop
nop
nop
nop
...
nop
add $16571, %rbx
lea addresses_WT_ht+0x44d1, %rsi
lea addresses_WC_ht+0x39d1, %rdi
and $46152, %r10
mov $77, %rcx
rep movsl
nop
...
nop
add $2681, %rcx
lea addresses_normal_ht+0x798f, %rbx
inc %r10
movl $0x61626364, (%rbx)
nop
nop
...
nop
sub $62062, %r10
lea addresses_UC_ht+0xb2c9, %rsi
nop
nop
xor %r12, %r12
vmovups (%rsi), %ymm7
...
// Store
lea addresses_normal+0x1d169, %r14
clflush (%r14)
sub %rdi, %rdi
movb $0x51, (%r14)
nop
...
// Faulty Load
lea addresses_normal+0x1e351, %r9
nop
sub $15216, %r14
mov (%r9), %di
lea oracles, %rax
...
{'OP': 'STOR', 'dst': {'type': 'addresses_A_ht', 'size': 4, 'AVXalign': True, 'NT': False, 'congruent': 9, 'same': False}}
