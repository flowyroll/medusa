...
push %rdi
push %rsi
lea addresses_WC_ht+0x1e435, %rsi
lea addresses_WT_ht+0x17355, %rdi
nop
nop
nop
nop
...
lea addresses_A_ht+0x1a7f5, %rdi
nop
nop
nop
dec %r13
...
nop
add %r11, %r11
lea addresses_A_ht+0x10535, %rdi
nop
dec %r11
movb (%rdi), %r13b
add %rsi, %rsi
lea addresses_normal_ht+0x194bd, %r11
nop
nop
nop
nop
...
<gen_prepare_buffer>
{'src': {'type': 'addresses_WC_ht', 'congruent': 5, 'same': True}, 'OP': 'REPM', 'dst': {'type': 'addresses_WT_ht', 'congruent': 5, 'same': False}}
{'OP': 'STOR', 'dst': {'type': 'addresses_WT_ht', 'AVXalign': False, 'size': 8, 'NT': False, 'same': False, 'congruent': 0}}
{'src': {'type': 'addresses_UC_ht', 'congruent': 2, 'same': False}, 'OP': 'REPM', 'dst': {'type': 'addresses_A_ht', 'congruent': 7, 'same': False}}
