...
nop
cmp $6070, %r8
lea addresses_normal_ht+0x12c25, %r8
nop
nop
nop
nop
...
nop
xor %rbp, %rbp
lea addresses_WT_ht+0x12f64, %r13
cmp $25496, %r8
mov (%r13), %rsi
nop
nop
...
nop
xor %rbp, %rbp
lea addresses_A_ht+0x1d844, %r13
nop
and %r11, %r11
movups (%r13), %xmm6
vpextrq $0, %xmm6, %rbp
...
nop
and $40876, %rsi
lea addresses_normal_ht+0xcee4, %rdi
add $23587, %rsi
movl $0x61626364, (%rdi)
nop
nop
...
nop
cmp $59874, %rbp
lea addresses_UC_ht+0x1d6a4, %rsi
lea addresses_WT_ht+0x171e0, %rdi
clflush (%rsi)
nop
nop
add $42165, %r8
...
nop
cmp $34562, %rcx
lea addresses_UC_ht+0xd8c4, %rax
nop
nop
nop
add %r13, %r13
...
nop
lfence
lea addresses_WT_ht+0x342a, %rsi
lea addresses_normal_ht+0x2ac4, %rdi
nop
nop
nop
nop
