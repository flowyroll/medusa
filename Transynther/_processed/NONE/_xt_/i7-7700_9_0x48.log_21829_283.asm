...
push %rdi
push %rsi
lea addresses_normal_ht+0x15bca, %r10
nop
nop
nop
add %rax, %rax
...
nop
and %rcx, %rcx
lea addresses_D_ht+0x942, %rsi
lea addresses_WT_ht+0x7b42, %rdi
nop
nop
nop
nop
