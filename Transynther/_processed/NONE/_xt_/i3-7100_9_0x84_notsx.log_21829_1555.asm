...
push %rdx
push %rsi
lea addresses_A_ht+0x1d2be, %rsi
...
nop
add $58484, %rdi
lea addresses_UC_ht+0x47be, %rdx
nop
nop
nop
cmp %r14, %r14
...
// Store
lea addresses_normal+0xf87e, %rax
add $45036, %r9
