...
push %rdx
push %rsi
lea addresses_normal_ht+0x2ca6, %rdi
nop
nop
nop
and %rbp, %rbp
...
nop
xor $43362, %rcx
lea addresses_WC_ht+0xb7c2, %r12
nop
dec %r9
mov (%r12), %esi
nop
...
nop
sub %r15, %r15
lea addresses_WT_ht+0x1bee2, %rsi
lea addresses_A_ht+0x5182, %rdi
nop
inc %rdx
mov $21, %rcx
rep movsq
...
nop
sub %rsi, %rsi
lea addresses_WT_ht+0x61b2, %rdx
clflush (%rdx)
nop
nop
xor $9931, %r12
...
nop
and $37324, %rbp
lea addresses_normal_ht+0xac82, %r9
nop
nop
nop
and %rdi, %rdi
...
movups %xmm2, (%r9)
dec %rcx
lea addresses_WT_ht+0x11ba6, %r15
and %rcx, %rcx
movb (%r15), %r12b
nop
nop
...
nop
cmp %rsi, %rsi
lea addresses_UC_ht+0x5982, %rdi
add $2022, %rbp
movb (%rdi), %r9b
nop
nop
...
nop
cmp %r12, %r12
lea addresses_UC_ht+0x9d38, %rsi
lea addresses_D_ht+0x11382, %rdi
nop
nop
nop
nop
...
nop
sub %r15, %r15
lea addresses_WT_ht+0x4672, %r12
nop
nop
add $62207, %rdx
movb (%r12), %r9b
...
nop
dec %r9
lea addresses_UC_ht+0x1bd82, %rsi
nop
nop
nop
and %rdi, %rdi
...
nop
sub %rsi, %rsi
lea addresses_WC_ht+0x10882, %rsi
...
rep movsl
add $23776, %r9
lea addresses_A_ht+0x1ad82, %rdx
nop
nop
nop
add %r9, %r9
...
lea addresses_UC_ht+0x14982, %rdi
clflush (%rsi)
nop
nop
nop
