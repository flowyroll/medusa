...
nop
add $53454, %r11
lea addresses_D_ht+0x1803c, %rsi
lea addresses_D_ht+0x13790, %rdi
nop
nop
nop
nop
...
nop
cmp %r14, %r14
lea addresses_UC_ht+0x16b12, %r12
nop
nop
nop
nop
...
nop
and $13809, %r12
lea addresses_WT_ht+0xd930, %r12
nop
nop
nop
inc %rdi
...
vpextrq $1, %xmm7, %r11
cmp $11510, %rdi
lea addresses_D_ht+0x16970, %rax
nop
nop
nop
and %rdi, %rdi
...
nop
xor $148, %r14
lea addresses_WT_ht+0x5040, %r15
nop
nop
nop
nop
...
movw $0x6162, (%r15)
inc %r12
lea addresses_WC_ht+0x17950, %rax
nop
nop
add %rcx, %rcx
...
nop
sub %r14, %r14
lea addresses_UC_ht+0xc670, %rcx
nop
nop
sub %rax, %rax
movb $0x61, (%rcx)
...
{'OP': 'STOR', 'dst': {'same': False, 'type': 'addresses_UC', 'NT': True, 'AVXalign': False, 'size': 1, 'congruent': 0}}
...
<gen_prepare_buffer>
{'OP': 'STOR', 'dst': {'same': False, 'type': 'addresses_WC_ht', 'NT': True, 'AVXalign': True, 'size': 1, 'congruent': 0}}
{'OP': 'STOR', 'dst': {'same': False, 'type': 'addresses_A_ht', 'NT': False, 'AVXalign': True, 'size': 2, 'congruent': 7}}
{'OP': 'LOAD', 'src': {'same': False, 'type': 'addresses_UC_ht', 'NT': True, 'AVXalign': False, 'size': 4, 'congruent': 3}}
{'OP': 'REPM', 'src': {'same': False, 'congruent': 2, 'type': 'addresses_D_ht'}, 'dst': {'same': True, 'congruent': 1, 'type': 'addresses_D_ht'}}
...
{'OP': 'STOR', 'dst': {'same': False, 'type': 'addresses_D_ht', 'NT': True, 'AVXalign': False, 'size': 8, 'congruent': 11}}
