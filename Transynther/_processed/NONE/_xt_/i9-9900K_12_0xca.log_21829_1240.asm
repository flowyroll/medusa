...
nop
inc %rbp
lea addresses_normal_ht+0xd01e, %rbp
and $20590, %r8
mov $0x6162636465666768, %rcx
movq %rcx, %xmm1
vmovups %ymm1, (%rbp)
add %rdi, %rdi
lea addresses_WT_ht+0x24ee, %rsi
lea addresses_WC_ht+0x7dbe, %rdi
inc %r14
mov $25, %rcx
rep movsl
nop
...
nop
and %r14, %r14
lea addresses_A_ht+0x1a09e, %rbp
cmp $25612, %rsi
...
nop
sub $46771, %r8
lea addresses_normal_ht+0x1409e, %rsi
lea addresses_normal_ht+0x2e9e, %rdi
sub %r12, %r12
mov $31, %rcx
rep movsl
nop
nop
sub %rcx, %rcx
lea addresses_WT_ht+0x16956, %r14
nop
add %rdi, %rdi
...
<gen_prepare_buffer>
{'OP': 'REPM', 'src': {'same': False, 'type': 'addresses_WC_ht', 'congruent': 3}, 'dst': {'same': False, 'type': 'addresses_WT_ht', 'congruent': 3}}
{'OP': 'STOR', 'dst': {'size': 4, 'NT': False, 'type': 'addresses_D_ht', 'same': False, 'AVXalign': False, 'congruent': 5}}
{'OP': 'LOAD', 'src': {'size': 8, 'NT': True, 'type': 'addresses_D_ht', 'same': False, 'AVXalign': False, 'congruent': 0}}
...
{'OP': 'REPM', 'src': {'same': False, 'type': 'addresses_normal_ht', 'congruent': 10}, 'dst': {'same': False, 'type': 'addresses_normal_ht', 'congruent': 9}}
