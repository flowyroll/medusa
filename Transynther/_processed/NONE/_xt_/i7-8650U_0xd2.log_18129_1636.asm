...
nop
dec %r9
lea addresses_WT_ht+0x8a8, %rsi
lea addresses_A_ht+0x1a3a8, %rdi
nop
nop
nop
cmp %r8, %r8
...
nop
sub %rcx, %rcx
lea addresses_A_ht+0x18224, %rsi
lea addresses_normal_ht+0x16f28, %rdi
nop
nop
nop
nop
...
nop
cmp %rdi, %rdi
lea addresses_WT_ht+0xbf64, %r13
nop
nop
xor $40139, %rdi
movw $0x6162, (%r13)
...
nop
xor %rsi, %rsi
lea addresses_A_ht+0x19b94, %rcx
add %rdi, %rdi
movups (%rcx), %xmm7
vpextrq $1, %xmm7, %rsi
nop
xor %rax, %rax
lea addresses_WC_ht+0xeba8, %rsi
lea addresses_WT_ht+0x1712c, %rdi
nop
nop
cmp $4641, %rax
mov $12, %rcx
...
// Store
lea addresses_normal+0x117a8, %r15
nop
nop
nop
nop
...
// Store
lea addresses_normal+0x194e0, %rdi
clflush (%rdi)
nop
nop
and %rdx, %rdx
...
{'OP': 'STOR', 'dst': {'type': 'addresses_normal', 'size': 32, 'AVXalign': True, 'NT': False, 'congruent': 3, 'same': False}}
[Faulty Load]
