...
push %rdx
push %rsi
lea addresses_UC_ht+0x1768f, %rax
nop
nop
nop
nop
...
nop
lfence
lea addresses_normal_ht+0x19f50, %r15
nop
cmp %rdx, %rdx
mov (%r15), %r9
nop
...
nop
add %r15, %r15
lea addresses_normal_ht+0x16e8f, %rax
nop
nop
nop
nop
...
nop
dec %rax
lea addresses_A_ht+0x2cbd, %rax
xor %r10, %r10
mov (%rax), %r15
nop
nop
cmp $45585, %rbp
lea addresses_WT_ht+0x1378f, %rsi
lea addresses_WC_ht+0x5a8f, %rdi
clflush (%rsi)
nop
nop
nop
...
nop
xor $17005, %r15
lea addresses_A_ht+0x1c70f, %rsi
lea addresses_D_ht+0x125d9, %rdi
nop
nop
nop
nop
