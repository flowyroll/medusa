...
movups %xmm7, (%r8)
cmp %r14, %r14
lea addresses_WT_ht+0x1ee54, %rdx
nop
nop
nop
and %rbx, %rbx
...
vmovups %ymm5, (%r9)
cmp %r8, %r8
lea addresses_D_ht+0x707c, %r9
cmp $19888, %r8
movb (%r9), %r14b
add $57076, %r8
lea addresses_WC_ht+0x8b4c, %rsi
lea addresses_A_ht+0x1e362, %rdi
nop
xor $10331, %r9
mov $19, %rcx
rep movsb
cmp %rdi, %rdi
lea addresses_UC_ht+0xed54, %r9
nop
cmp $55522, %r8
movb $0x61, (%r9)
nop
...
// Faulty Load
lea addresses_normal+0xb994, %rdx
nop
nop
nop
nop
