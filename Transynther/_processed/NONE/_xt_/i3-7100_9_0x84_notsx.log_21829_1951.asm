...
lea addresses_normal_ht+0x1c438, %rdi
nop
add $62191, %rbp
mov $91, %rcx
rep movsl
...
nop
add $41457, %rsi
lea addresses_D_ht+0x3028, %rsi
lea addresses_UC_ht+0x18838, %rdi
add %r13, %r13
mov $71, %rcx
rep movsl
nop
nop
xor $17826, %rcx
lea addresses_UC_ht+0x1838c, %rsi
nop
nop
nop
cmp $12167, %rbp
...
nop
dec %r13
lea addresses_normal_ht+0x11638, %r13
nop
nop
nop
nop
...
nop
inc %rcx
lea addresses_A_ht+0x59a, %rsi
lea addresses_UC_ht+0x16b8, %rdi
nop
nop
nop
nop
...
// Store
lea addresses_normal+0x1e438, %rcx
nop
nop
nop
nop
