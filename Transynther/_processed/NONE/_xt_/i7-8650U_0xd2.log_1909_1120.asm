...
push %rdi
push %rsi
lea addresses_UC_ht+0x19d9, %rbx
nop
nop
nop
nop
...
nop
inc %rbp
lea addresses_normal_ht+0x107cb, %rsi
lea addresses_normal_ht+0xcecb, %rdi
nop
nop
nop
and $38311, %r8
...
lea addresses_WC_ht+0x1449b, %rdi
mfence
mov $86, %rcx
rep movsl
and %r8, %r8
lea addresses_WT_ht+0x43eb, %rsi
lea addresses_WC_ht+0x1326b, %rdi
nop
nop
nop
nop
...
nop
dec %rsi
lea addresses_WT_ht+0x1d73b, %rsi
lea addresses_D_ht+0x17e4b, %rdi
nop
nop
cmp %rbx, %rbx
mov $75, %rcx
rep movsq
and $19185, %r10
lea addresses_normal_ht+0x1014b, %r13
nop
nop
inc %r10
movups (%r13), %xmm5
...
nop
cmp %r13, %r13
lea addresses_D_ht+0x1c38f, %rcx
nop
nop
nop
cmp $13015, %rdi
...
{'OP': 'REPM', 'src': {'type': 'addresses_WT_ht', 'congruent': 4, 'same': False}, 'dst': {'type': 'addresses_WC_ht', 'congruent': 5, 'same': True}}
