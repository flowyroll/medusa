...
push %rdi
push %rsi
lea addresses_WC_ht+0x13af, %rsi
lea addresses_D_ht+0x8a2f, %rdi
nop
nop
nop
nop
...
nop
cmp $63538, %r10
lea addresses_A_ht+0x1c432, %rcx
nop
nop
and %r9, %r9
mov (%rcx), %si
...
nop
add $13948, %r10
lea addresses_WC_ht+0x7aaf, %rsi
lea addresses_WT_ht+0x1d40f, %rdi
nop
nop
nop
nop
...
rep movsq
xor %rsi, %rsi
lea addresses_WC_ht+0x15a53, %rsi
lea addresses_D_ht+0x57ef, %rdi
nop
nop
nop
cmp $33029, %r10
...
nop
inc %r13
lea addresses_WC_ht+0xe08f, %rdi
nop
nop
nop
nop
...
nop
add $21827, %rdi
lea addresses_WT_ht+0x190af, %rsi
nop
xor $27577, %r9
movb $0x61, (%rsi)
dec %r10
lea addresses_UC_ht+0xd5bf, %rsi
lea addresses_D_ht+0xffaf, %rdi
nop
cmp $58852, %r15
mov $125, %rcx
rep movsl
...
nop
inc %rsi
lea addresses_A_ht+0x1eaf, %rsi
lea addresses_UC_ht+0xd3af, %rdi
nop
nop
cmp %r8, %r8
mov $92, %rcx
...
nop
and $32626, %rdi
lea addresses_normal_ht+0x1babf, %rdi
xor %r15, %r15
mov $0x6162636465666768, %r13
movq %r13, %xmm7
vmovups %ymm7, (%rdi)
dec %r10
lea addresses_normal_ht+0x1d14f, %r9
clflush (%r9)
nop
nop
nop
...
nop
xor %r15, %r15
lea addresses_WT_ht+0x4eaf, %r13
xor $45294, %r15
mov (%r13), %ecx
nop
nop
cmp %r9, %r9
lea addresses_UC_ht+0x14cf, %rdi
clflush (%rdi)
nop
nop
xor $59219, %r9
...
nop
xor %rsi, %rsi
lea addresses_UC_ht+0x18eaf, %rsi
lea addresses_D_ht+0xbd2f, %rdi
nop
nop
cmp %r9, %r9
mov $120, %rcx
...
nop
xor $26608, %r15
lea addresses_normal_ht+0x1226b, %rsi
nop
nop
add $62082, %r13
movb $0x61, (%rsi)
...
// Faulty Load
lea addresses_normal+0x12eaf, %rbp
nop
nop
nop
add $47863, %rdi
...
{'OP': 'REPM', 'src': {'type': 'addresses_WC_ht', 'congruent': 2, 'same': False}, 'dst': {'type': 'addresses_D_ht', 'congruent': 2, 'same': False}}
