...
push %rdi
push %rsi
lea addresses_A_ht+0x3dcb, %rsi
lea addresses_WT_ht+0x11713, %rdi
nop
nop
cmp %r8, %r8
mov $91, %rcx
rep movsq
sub $17306, %rcx
lea addresses_A_ht+0x187c3, %r14
nop
and $61484, %r12
movl $0x61626364, (%r14)
dec %r14
lea addresses_WC_ht+0x5493, %r14
nop
nop
nop
nop
...
nop
sub $32195, %rdi
lea addresses_D_ht+0x1eb33, %rsi
nop
xor %r12, %r12
movb (%rsi), %r14b
nop
...
nop
lfence
lea addresses_WC_ht+0x17ed3, %rsi
lea addresses_A_ht+0x66d3, %rdi
nop
nop
nop
nop
...
nop
inc %r8
lea addresses_WC_ht+0x1cd5f, %rbp
nop
nop
sub %rcx, %rcx
movl $0x61626364, (%rbp)
...
nop
xor %rbp, %rbp
lea addresses_D_ht+0x1d6d3, %rcx
xor %r12, %r12
movb $0x61, (%rcx)
nop
nop
cmp $8629, %r12
lea addresses_UC_ht+0xa113, %rsi
lea addresses_A_ht+0x1e223, %rdi
nop
sub $35474, %rbp
mov $62, %rcx
rep movsq
...
{'dst': {'type': 'addresses_A_ht', 'same': True, 'size': 4, 'congruent': 4, 'NT': False, 'AVXalign': True}, 'OP': 'STOR'}
...
{'src': {'type': 'addresses_WC_ht', 'congruent': 10, 'same': False}, 'dst': {'type': 'addresses_A_ht', 'congruent': 11, 'same': False}, 'OP': 'REPM'}
...
{'src': {'type': 'addresses_UC_ht', 'congruent': 6, 'same': False}, 'dst': {'type': 'addresses_A_ht', 'congruent': 3, 'same': False}, 'OP': 'REPM'}
{'32': 21829}
