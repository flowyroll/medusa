...
push %rdx
push %rsi
lea addresses_UC_ht+0x5fed, %rdx
nop
nop
nop
nop
...
nop
and $17427, %rbp
lea addresses_WT_ht+0x1e02d, %rsi
lea addresses_UC_ht+0x93ed, %rdi
nop
nop
nop
nop
...
{'OP': 'REPM', 'src': {'type': 'addresses_WT_ht', 'congruent': 4, 'same': True}, 'dst': {'type': 'addresses_UC_ht', 'congruent': 7, 'same': False}}
{'36': 21829}
