...
nop
cmp $57967, %rcx
lea addresses_WT_ht+0x8add, %r9
inc %r8
mov $0x6162636465666768, %rcx
movq %rcx, %xmm7
movups %xmm7, (%r9)
cmp %r8, %r8
lea addresses_D_ht+0x15a4e, %rsi
lea addresses_UC_ht+0x17c0d, %rdi
nop
dec %r9
mov $56, %rcx
rep movsb
...
nop
add $41720, %rsi
lea addresses_WT_ht+0x1203d, %r14
nop
nop
nop
nop
...
nop
cmp %rbp, %rbp
lea addresses_normal_ht+0x1c1ad, %rsi
lea addresses_normal_ht+0xf1fd, %rdi
inc %r9
mov $107, %rcx
rep movsb
and $17281, %r8
lea addresses_UC_ht+0x9bad, %rsi
lea addresses_WC_ht+0x160ed, %rdi
nop
nop
nop
nop
...
{'dst': {'type': 'addresses_WT_ht', 'same': True, 'size': 16, 'congruent': 4, 'NT': False, 'AVXalign': False}, 'OP': 'STOR'}
