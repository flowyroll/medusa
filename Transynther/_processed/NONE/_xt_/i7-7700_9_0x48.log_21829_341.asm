...
push %rdi
push %rsi
lea addresses_UC_ht+0x1579c, %rbp
nop
and $38164, %r10
movb (%rbp), %bl
nop
...
nop
dec %rbx
lea addresses_A_ht+0x17fc, %rbp
xor $29254, %r9
mov (%rbp), %edi
nop
and $44393, %r10
lea addresses_WT_ht+0x1fda, %rsi
lea addresses_D_ht+0x58cc, %rdi
nop
nop
nop
nop
...
nop
sub $33067, %rbp
lea addresses_WC_ht+0x41fc, %r9
inc %rcx
mov (%r9), %r10w
nop
nop
xor $29019, %r8
lea addresses_normal_ht+0x9bfc, %r8
nop
dec %r9
...
nop
add $22297, %r9
lea addresses_UC_ht+0x1ab74, %r8
nop
nop
nop
nop
...
nop
add $43013, %r8
lea addresses_D_ht+0x10435, %rsi
nop
nop
inc %rbx
movb (%rsi), %r9b
...
nop
sub %rdi, %rdi
lea addresses_normal_ht+0x36ac, %rbx
nop
nop
and %rsi, %rsi
...
<gen_prepare_buffer>
{'OP': 'LOAD', 'src': {'type': 'addresses_UC_ht', 'AVXalign': False, 'congruent': 3, 'size': 1, 'same': False, 'NT': True}}
...
{'OP': 'LOAD', 'src': {'type': 'addresses_WC_ht', 'AVXalign': False, 'congruent': 6, 'size': 2, 'same': False, 'NT': True}}
