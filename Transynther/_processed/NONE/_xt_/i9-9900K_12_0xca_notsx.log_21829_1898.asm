...
push %rdi
push %rsi
lea addresses_UC_ht+0x3fd0, %r14
nop
nop
nop
cmp %r11, %r11
...
nop
cmp $65444, %rax
lea addresses_normal_ht+0x780a, %rsi
lea addresses_A_ht+0x17f8a, %rdi
nop
nop
add %rax, %rax
mov $19, %rcx
...
nop
xor %r11, %r11
lea addresses_UC_ht+0x1e70a, %rsi
nop
nop
nop
nop
...
nop
sub $52723, %rdi
lea addresses_normal_ht+0x1912a, %rdi
nop
nop
inc %rsi
...
vmovups %ymm2, (%rdi)
and $22250, %r14
lea addresses_normal_ht+0xfd0a, %rax
nop
nop
nop
nop
...
nop
sub $18364, %r14
lea addresses_D_ht+0x181f6, %rsi
lea addresses_normal_ht+0x340a, %rdi
clflush (%rdi)
nop
nop
nop
...
nop
dec %r11
lea addresses_UC_ht+0x14f92, %rsi
lea addresses_WC_ht+0x14cfa, %rdi
nop
nop
nop
nop
...
lea addresses_WC_ht+0x797a, %rdi
nop
xor $330, %rax
mov $105, %rcx
rep movsl
...
lea addresses_normal_ht+0x14d0a, %rdi
nop
cmp $7094, %rbp
mov $13, %rcx
rep movsl
...
nop
xor %rdi, %rdi
lea addresses_normal_ht+0x3b8a, %rcx
nop
xor %rdi, %rdi
movb $0x61, (%rcx)
nop
nop
sub $61652, %rcx
lea addresses_WC_ht+0x162fd, %rsi
add %rax, %rax
vmovups (%rsi), %ymm0
...
nop
and $27807, %rdi
lea addresses_A_ht+0xb8a, %rsi
lea addresses_D_ht+0x23aa, %rdi
inc %r14
mov $96, %rcx
rep movsb
nop
add %r14, %r14
lea addresses_D_ht+0x1050a, %rcx
nop
nop
nop
nop
...
nop
sub $52764, %rbp
lea addresses_WC_ht+0x850a, %rsi
nop
nop
nop
nop
...
{'OP': 'STOR', 'dst': {'same': False, 'type': 'addresses_PSE', 'NT': True, 'AVXalign': False, 'size': 2, 'congruent': 11}}
...
{'OP': 'REPM', 'src': {'same': False, 'congruent': 3, 'type': 'addresses_UC_ht'}, 'dst': {'same': False, 'congruent': 4, 'type': 'addresses_WC_ht'}}
