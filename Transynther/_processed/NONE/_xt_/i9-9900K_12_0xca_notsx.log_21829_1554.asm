...
nop
dec %r15
lea addresses_WT_ht+0x16ad5, %rsi
lea addresses_WC_ht+0x172d5, %rdi
clflush (%rsi)
nop
nop
nop
...
nop
add $23272, %rax
lea addresses_D_ht+0x186d5, %rax
nop
cmp $63419, %r12
...
nop
cmp $41540, %r12
lea addresses_UC_ht+0x12575, %r15
nop
and $25203, %rsi
mov $0x6162636465666768, %rdi
movq %rdi, %xmm4
...
nop
and $8226, %rax
lea addresses_WT_ht+0x21e7, %rdx
nop
nop
nop
nop
...
// Store
lea addresses_D+0x13b55, %r8
xor $17609, %rbx
movw $0x5152, (%r8)
sub $37789, %rdx

// Faulty Load
lea addresses_UC+0x3ed5, %r12
clflush (%r12)
nop
and %r9, %r9
movb (%r12), %bl
