...
push %rdi
push %rsi
lea addresses_normal_ht+0x1303b, %r14
clflush (%r14)
nop
nop
nop
...
nop
cmp %r10, %r10
lea addresses_WC_ht+0x2dcb, %rbx
nop
nop
nop
nop
...
nop
and %r14, %r14
lea addresses_UC_ht+0x167d3, %rcx
add %rbx, %rbx
movups (%rcx), %xmm3
vpextrq $0, %xmm3, %rdi
nop
...
nop
xor $46642, %r14
lea addresses_UC_ht+0x16c3b, %rsi
lea addresses_UC_ht+0x1143b, %rdi
nop
nop
nop
nop
...
nop
inc %rbx
lea addresses_WT_ht+0x1e1b3, %r13
nop
nop
nop
sub $58321, %rbx
...
nop
sub $30094, %rdi
lea addresses_WC_ht+0x1877b, %rsi
lea addresses_UC_ht+0xa03b, %rdi
nop
nop
nop
nop
...
nop
cmp %rsi, %rsi
lea addresses_normal_ht+0xc03b, %r8
nop
add %r14, %r14
...
nop
cmp $30429, %rsi
lea addresses_A_ht+0x16103, %rsi
lea addresses_A_ht+0x543b, %rdi
nop
inc %r10
mov $105, %rcx
rep movsw
...
nop
add $55811, %rdi
lea addresses_WC_ht+0xe1fb, %r13
nop
nop
nop
add $39191, %r10
...
{'src': {'same': False, 'congruent': 9, 'type': 'addresses_UC_ht'}, 'OP': 'REPM', 'dst': {'same': False, 'congruent': 10, 'type': 'addresses_UC_ht'}}
{'OP': 'STOR', 'dst': {'NT': False, 'same': False, 'congruent': 2, 'type': 'addresses_WT_ht', 'AVXalign': True, 'size': 16}}
