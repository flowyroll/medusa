...
lea addresses_UC_ht+0x14741, %rdi
nop
nop
nop
xor %r9, %r9
...
nop
cmp $51213, %rdi
lea addresses_WC_ht+0x8d41, %rbx
nop
nop
nop
nop
...
nop
inc %rsi
lea addresses_WC_ht+0xf3c1, %rcx
nop
nop
cmp %rdi, %rdi
...
nop
cmp $20761, %rax
lea addresses_normal_ht+0xe1c4, %rbx
nop
nop
nop
nop
