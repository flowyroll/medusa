...
push %rdx
push %rsi
lea addresses_WC_ht+0x1987d, %rcx
nop
nop
nop
inc %r13
...
nop
xor $16519, %r8
lea addresses_WT_ht+0x2e6d, %rsi
...
nop
cmp %r13, %r13
lea addresses_D_ht+0x17e2d, %rsi
nop
nop
nop
and $38765, %r8
...
nop
inc %r13
lea addresses_D_ht+0x3ad1, %r13
cmp %rcx, %rcx
mov (%r13), %rsi
nop
and %r13, %r13
lea addresses_D_ht+0xc7ad, %rsi
lea addresses_WC_ht+0xbe6d, %rdi
nop
xor %rdx, %rdx
mov $74, %rcx
rep movsb
nop
inc %rdi
lea addresses_A_ht+0x4b6d, %rsi
lea addresses_WC_ht+0x1772d, %rdi
nop
cmp $33349, %r8
mov $39, %rcx
rep movsq
...
nop
xor $4245, %rdx
lea addresses_A_ht+0x3141, %r12
cmp $12942, %r10
mov (%r12), %dx
nop
add $59764, %rdi
lea addresses_WC_ht+0x30ad, %r10
nop
dec %r13
...
nop
and $50826, %r13
lea addresses_D_ht+0x1a6ad, %rsi
nop
nop
inc %r13
movups (%rsi), %xmm6
...
nop
dec %rdx
lea addresses_normal_ht+0x170ad, %r10
nop
nop
nop
nop
...
{'src': {'type': 'addresses_D_ht', 'congruent': 7, 'same': False}, 'dst': {'type': 'addresses_WC_ht', 'congruent': 6, 'same': False}, 'OP': 'REPM'}
{'src': {'type': 'addresses_A_ht', 'congruent': 6, 'same': False}, 'dst': {'type': 'addresses_WC_ht', 'congruent': 3, 'same': False}, 'OP': 'REPM'}
{'src': {'type': 'addresses_A_ht', 'same': True, 'size': 2, 'congruent': 2, 'NT': False, 'AVXalign': False}, 'OP': 'LOAD'}
