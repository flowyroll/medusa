...
push %rdi
push %rsi
lea addresses_A_ht+0x1efa8, %r10
cmp $55666, %rcx
mov $0x6162636465666768, %r9
movq %r9, (%r10)
inc %r15
lea addresses_normal_ht+0x1a268, %rbp
nop
nop
nop
nop
...
nop
dec %r10
lea addresses_WC_ht+0x1d648, %r13
inc %r15
movb (%r13), %cl
nop
nop
xor $9763, %r14
lea addresses_A_ht+0x0, %rcx
nop
nop
nop
cmp $65031, %rbp
...
vpextrq $0, %xmm6, %r13
cmp %rcx, %rcx
lea addresses_WT_ht+0x68, %rbp
nop
nop
inc %r9
movl $0x61626364, (%rbp)
inc %r15
lea addresses_WT_ht+0x17e48, %r9
nop
xor %rcx, %rcx
movl $0x61626364, (%r9)
nop
...
nop
sub $42394, %r13
lea addresses_D_ht+0x14c7a, %rbp
add $2180, %r13
...
nop
add $18955, %r13
lea addresses_WT_ht+0x11848, %rsi
lea addresses_WT_ht+0x17a08, %rdi
nop
xor $53706, %r15
mov $87, %rcx
rep movsw
...
nop
cmp %r15, %r15
lea addresses_normal_ht+0xa4c5, %rcx
clflush (%rcx)
nop
nop
nop
...
nop
xor %r9, %r9
lea addresses_WT_ht+0x1ae48, %r9
nop
add %rbp, %rbp
movb (%r9), %r13b
nop
xor %rbp, %rbp
lea addresses_D_ht+0x4248, %rsi
lea addresses_UC_ht+0x17248, %rdi
nop
nop
nop
cmp %r9, %r9
...
{'OP': 'STOR', 'dst': {'same': True, 'congruent': 0, 'NT': False, 'type': 'addresses_D_ht', 'size': 32, 'AVXalign': False}}
{'src': {'type': 'addresses_WT_ht', 'congruent': 9, 'same': False}, 'OP': 'REPM', 'dst': {'type': 'addresses_WT_ht', 'congruent': 6, 'same': False}}
{'OP': 'STOR', 'dst': {'same': False, 'congruent': 0, 'NT': False, 'type': 'addresses_normal_ht', 'size': 4, 'AVXalign': True}}
{'src': {'same': False, 'congruent': 6, 'NT': False, 'type': 'addresses_A_ht', 'size': 4, 'AVXalign': False}, 'OP': 'LOAD'}
{'src': {'same': False, 'congruent': 9, 'NT': False, 'type': 'addresses_WT_ht', 'size': 1, 'AVXalign': True}, 'OP': 'LOAD'}
{'src': {'type': 'addresses_D_ht', 'congruent': 9, 'same': False}, 'OP': 'REPM', 'dst': {'type': 'addresses_UC_ht', 'congruent': 8, 'same': False}}
{'35': 21829}
