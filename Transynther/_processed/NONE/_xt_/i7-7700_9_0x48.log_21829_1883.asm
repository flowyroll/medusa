...
push %rdi
push %rsi
lea addresses_normal_ht+0x16729, %rax
nop
nop
nop
nop
...
nop
cmp $31090, %rsi
lea addresses_normal_ht+0xf11, %r13
nop
nop
cmp %rcx, %rcx
...
nop
add $9190, %rax
lea addresses_A_ht+0x11c31, %rax
nop
nop
add $65510, %r10
mov (%rax), %r13w
xor %r13, %r13
lea addresses_D_ht+0x13711, %rsi
lea addresses_UC_ht+0x2079, %rdi
nop
sub $32667, %r10
mov $5, %rcx
rep movsq
...
nop
sub $15805, %rcx
lea addresses_WC_ht+0xae11, %rsi
lea addresses_WC_ht+0x3abd, %rdi
clflush (%rsi)
nop
nop
nop
...
nop
sub %r13, %r13
lea addresses_UC_ht+0xd811, %rsi
nop
nop
nop
nop
...
nop
cmp $28831, %r10
lea addresses_WC_ht+0xec9e, %rsi
lea addresses_WT_ht+0x11281, %rdi
nop
nop
dec %r14
mov $64, %rcx
...
nop
add $42048, %rax
lea addresses_normal_ht+0x109f1, %r13
nop
nop
nop
nop
...
<gen_prepare_buffer>
{'OP': 'STOR', 'dst': {'type': 'addresses_normal_ht', 'AVXalign': True, 'congruent': 2, 'size': 8, 'same': True, 'NT': False}}
