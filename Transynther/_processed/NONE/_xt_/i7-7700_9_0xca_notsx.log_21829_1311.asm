...
nop
sub %rdx, %rdx
lea addresses_WC_ht+0x2d46, %rbp
nop
and %rcx, %rcx
movb (%rbp), %r9b
nop
...
nop
add %r8, %r8
lea addresses_UC_ht+0x6e30, %rsi
lea addresses_A_ht+0x16230, %rdi
nop
cmp %rdx, %rdx
mov $113, %rcx
rep movsb
...
lea addresses_WT_ht+0x6e9a, %rdi
nop
lfence
mov $61, %rcx
rep movsq
...
nop
sub %rdi, %rdi
lea addresses_normal_ht+0x15830, %rsi
clflush (%rsi)
nop
nop
nop
...
// Faulty Load
lea addresses_normal+0x1b830, %r15
xor %r11, %r11
movb (%r15), %cl
lea oracles, %r11
and $0xff, %rcx
...
{'src': {'NT': False, 'AVXalign': True, 'size': 8, 'congruent': 10, 'same': False, 'type': 'addresses_A'}, 'OP': 'LOAD'}
