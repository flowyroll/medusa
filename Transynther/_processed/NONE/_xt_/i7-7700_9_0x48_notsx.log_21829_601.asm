...
nop
cmp %r8, %r8
lea addresses_WT_ht+0xe294, %rsi
lea addresses_A_ht+0x16ea0, %rdi
cmp $9539, %r10
mov $95, %rcx
rep movsq
nop
...
nop
sub %r12, %r12
lea addresses_D_ht+0x121b4, %rsi
nop
dec %rcx
...
nop
lfence
lea addresses_UC_ht+0x19e5e, %r10
nop
nop
nop
nop
...
nop
xor $40398, %rax
lea addresses_WC_ht+0x1a314, %r10
nop
nop
xor %rax, %rax
...
nop
add %rcx, %rcx
lea addresses_WC_ht+0x1c8b4, %rsi
lea addresses_A_ht+0x1a2b4, %rdi
nop
nop
add $20779, %r8
mov $28, %rcx
...
nop
dec %r8
lea addresses_UC_ht+0x1c7f4, %rax
nop
sub %rbx, %rbx
movb $0x61, (%rax)
nop
...
nop
cmp %r8, %r8
lea addresses_normal_ht+0x1e4f4, %r10
nop
nop
and %rax, %rax
movl $0x61626364, (%r10)
...
{'dst': {'same': True, 'congruent': 8, 'type': 'addresses_A_ht'}, 'OP': 'REPM', 'src': {'same': False, 'congruent': 8, 'type': 'addresses_WC_ht'}}
...
{'dst': {'same': False, 'NT': True, 'AVXalign': False, 'size': 32, 'type': 'addresses_A_ht', 'congruent': 9}, 'OP': 'STOR'}
{'dst': {'same': False, 'congruent': 3, 'type': 'addresses_D_ht'}, 'OP': 'REPM', 'src': {'same': False, 'congruent': 0, 'type': 'addresses_D_ht'}}
{'38': 21829}
