...
push %rdx
push %rsi
lea addresses_WT_ht+0x5d2a, %r12
sub $6042, %rdx
mov (%r12), %r13
nop
nop
...
nop
inc %rax
lea addresses_normal_ht+0x1ce2a, %r14
cmp %r9, %r9
...
nop
add %rax, %rax
lea addresses_A_ht+0x18e2a, %rdx
and %r13, %r13
mov $0x6162636465666768, %r12
movq %r12, (%rdx)
sub $4854, %r12
lea addresses_WT_ht+0x1148a, %r14
nop
nop
nop
nop
...
nop
add $38631, %r11
lea addresses_D_ht+0x17e2a, %r13
nop
nop
nop
xor %r11, %r11
...
nop
and %r9, %r9
lea addresses_WC_ht+0x412a, %r12
nop
nop
nop
sub $45643, %r9
...
nop
dec %rdx
lea addresses_D_ht+0x15cfa, %rsi
lea addresses_WT_ht+0x962a, %rdi
clflush (%rdi)
sub $55107, %r12
mov $76, %rcx
rep movsw
...
{'OP': 'REPM', 'src': {'same': False, 'type': 'addresses_D_ht', 'congruent': 4}, 'dst': {'same': False, 'type': 'addresses_WT_ht', 'congruent': 10}}
{'32': 21829}
