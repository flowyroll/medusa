...
push %rdx
push %rsi
lea addresses_UC_ht+0xd33d, %rdx
nop
nop
nop
nop
...
// Load
lea addresses_normal+0x1b479, %r13
nop
nop
nop
sub %rbx, %rbx
...
{'OP': 'STOR', 'dst': {'same': False, 'congruent': 4, 'NT': False, 'type': 'addresses_UC', 'size': 8, 'AVXalign': False}}
{'src': {'same': False, 'congruent': 4, 'NT': False, 'type': 'addresses_PSE', 'size': 16, 'AVXalign': False}, 'OP': 'LOAD'}
