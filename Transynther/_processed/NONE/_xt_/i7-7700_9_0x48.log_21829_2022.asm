...
push %rdx
push %rsi
lea addresses_D_ht+0x1dfb9, %rcx
nop
nop
nop
and %r8, %r8
mov (%rcx), %r11
xor $10904, %r8
lea addresses_WC_ht+0x13ab9, %rcx
nop
sub %r9, %r9
...
nop
cmp %rax, %rax
lea addresses_A_ht+0x16cb9, %r13
nop
nop
nop
nop
...
nop
add $40187, %r13
lea addresses_UC_ht+0x14b9, %rsi
lea addresses_normal_ht+0x176b9, %rdi
nop
add $58312, %r8
mov $69, %rcx
rep movsb
...
nop
sub %r11, %r11
lea addresses_normal_ht+0x18cb9, %rdx
clflush (%rdx)
sub %rcx, %rcx
movb $0x61, (%rdx)
nop
add %rsi, %rsi
lea addresses_UC_ht+0x17cf9, %rsi
lea addresses_normal_ht+0x3d39, %rdi
nop
xor $3360, %r8
mov $64, %rcx
rep movsb
...
nop
sub %r8, %r8
lea addresses_UC_ht+0x7279, %rax
cmp $3534, %r11
...
nop
sub $18026, %r11
lea addresses_normal_ht+0x4671, %r8
nop
xor $10814, %rdi
movw $0x6162, (%r8)
nop
...
{'OP': 'STOR', 'dst': {'type': 'addresses_WC_ht', 'AVXalign': False, 'congruent': 10, 'size': 16, 'same': False, 'NT': True}}
