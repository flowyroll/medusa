...
push %rdi
push %rsi
lea addresses_UC_ht+0x2daf, %rsi
lea addresses_UC_ht+0x2667, %rdi
clflush (%rsi)
and $24412, %r8
mov $40, %rcx
rep movsl
...
nop
cmp %rbp, %rbp
lea addresses_normal_ht+0x902f, %rsi
lea addresses_WT_ht+0x15daf, %rdi
nop
nop
nop
xor %r12, %r12
...
nop
sub $39893, %r8
lea addresses_WC_ht+0x11e0f, %r12
nop
nop
nop
nop
...
mov (%r8), %rcx
inc %rsi
lea addresses_D_ht+0x10eef, %rsi
lea addresses_WT_ht+0x282f, %rdi
nop
dec %r15
mov $108, %rcx
rep movsw
...
// REPMOV
lea addresses_PSE+0x1982f, %rsi
lea addresses_UC+0x882f, %rdi
nop
nop
inc %r8
mov $83, %rcx
...
{'src': {'type': 'addresses_PSE', 'congruent': 0, 'same': True}, 'dst': {'type': 'addresses_UC', 'congruent': 11, 'same': False}, 'OP': 'REPM'}
...
<gen_prepare_buffer>
{'src': {'type': 'addresses_UC_ht', 'congruent': 6, 'same': False}, 'dst': {'type': 'addresses_UC_ht', 'congruent': 1, 'same': False}, 'OP': 'REPM'}
...
{'src': {'type': 'addresses_D_ht', 'congruent': 6, 'same': False}, 'dst': {'type': 'addresses_WT_ht', 'congruent': 9, 'same': False}, 'OP': 'REPM'}
