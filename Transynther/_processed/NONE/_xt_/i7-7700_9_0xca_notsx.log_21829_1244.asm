...
nop
add %r8, %r8
lea addresses_UC_ht+0xd9ad, %rsi
lea addresses_A_ht+0x18755, %rdi
add $14533, %r13
mov $44, %rcx
rep movsb
nop
...
nop
xor $1801, %r9
lea addresses_WC_ht+0x1314d, %r13
nop
nop
nop
xor $21290, %r11
...
{'src': {'NT': False, 'AVXalign': False, 'size': 16, 'congruent': 3, 'same': True, 'type': 'addresses_WC_ht'}, 'OP': 'LOAD'}
