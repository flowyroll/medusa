...
nop
cmp %r11, %r11
lea addresses_UC_ht+0x144a2, %r9
nop
nop
nop
nop
...
nop
and $1087, %rsi
lea addresses_WT_ht+0x252, %rsi
lea addresses_normal_ht+0x3ca2, %rdi
and %rbp, %rbp
mov $56, %rcx
rep movsl
nop
...
{'OP': 'STOR', 'dst': {'type': 'addresses_A_ht', 'AVXalign': False, 'congruent': 3, 'size': 8, 'same': True, 'NT': False}}
{'OP': 'REPM', 'src': {'type': 'addresses_WT_ht', 'congruent': 4, 'same': False}, 'dst': {'type': 'addresses_normal_ht', 'congruent': 6, 'same': False}}
