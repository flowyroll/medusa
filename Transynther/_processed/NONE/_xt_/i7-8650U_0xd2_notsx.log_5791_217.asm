...
push %rdi
push %rsi
lea addresses_A_ht+0x727a, %rsi
lea addresses_normal_ht+0x1ef7a, %rdi
nop
sub %r12, %r12
mov $85, %rcx
rep movsl
nop
add $57067, %r14
lea addresses_D_ht+0x12ffa, %rsi
lea addresses_D_ht+0x107a, %rdi
nop
sub $31484, %r8
mov $97, %rcx
rep movsw
nop
cmp $22469, %rsi
lea addresses_WC_ht+0x123fa, %rsi
xor $43333, %r13
vmovups (%rsi), %ymm0
...
nop
sub %r13, %r13
lea addresses_UC_ht+0x15cfa, %r8
nop
nop
nop
nop
