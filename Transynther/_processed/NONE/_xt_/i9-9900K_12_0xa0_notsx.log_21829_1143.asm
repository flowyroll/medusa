...
push %rdi
push %rsi
lea addresses_WT_ht+0x9557, %rcx
nop
nop
nop
nop
...
nop
add $28511, %rcx
lea addresses_A_ht+0x15c1f, %r14
nop
nop
nop
xor $45270, %rdi
...
nop
add %r12, %r12
lea addresses_WC_ht+0x60af, %rsi
nop
and $3784, %r11
mov (%rsi), %r14
nop
...
<gen_prepare_buffer>
{'src': {'type': 'addresses_WT_ht', 'AVXalign': True, 'size': 32, 'NT': False, 'same': False, 'congruent': 10}, 'OP': 'LOAD'}
{'OP': 'STOR', 'dst': {'type': 'addresses_A_ht', 'AVXalign': False, 'size': 8, 'NT': False, 'same': True, 'congruent': 2}}
