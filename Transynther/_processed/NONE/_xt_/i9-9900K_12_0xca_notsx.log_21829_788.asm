...
push %rdx
push %rsi
lea addresses_WT_ht+0x126fe, %r14
nop
nop
nop
and $13708, %r8
...
nop
cmp %rdi, %rdi
lea addresses_D_ht+0x13721, %r12
nop
nop
nop
nop
...
movw $0x6162, (%r8)
dec %r8
lea addresses_UC_ht+0x70be, %r11
nop
nop
nop
nop
...
nop
xor $50447, %rdx
lea addresses_WC_ht+0x3bbe, %r12
nop
nop
nop
sub %r8, %r8
...
nop
cmp $59985, %r8
lea addresses_WT_ht+0x4f7e, %rsi
lea addresses_D_ht+0x190be, %rdi
nop
and %r11, %r11
mov $29, %rcx
rep movsq
...
// REPMOV
lea addresses_WC+0x1e8be, %rsi
lea addresses_PSE+0x1bb1e, %rdi
add $39189, %r13
mov $35, %rcx
rep movsb
sub %rdi, %rdi
...
{'OP': 'REPM', 'src': {'same': True, 'congruent': 0, 'type': 'addresses_WC'}, 'dst': {'same': False, 'congruent': 4, 'type': 'addresses_PSE'}}
[Faulty Load]
...
{'OP': 'LOAD', 'src': {'same': False, 'type': 'addresses_A_ht', 'NT': False, 'AVXalign': True, 'size': 32, 'congruent': 11}}
