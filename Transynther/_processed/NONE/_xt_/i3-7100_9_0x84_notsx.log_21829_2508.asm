...
push %rdx
push %rsi
lea addresses_WC_ht+0x1884b, %rsi
nop
xor $60732, %r9
...
nop
inc %r9
lea addresses_D_ht+0x16d9f, %rbx
xor $28670, %rsi
movl $0x61626364, (%rbx)
nop
nop
...
nop
and $37733, %r9
lea addresses_WT_ht+0xf04b, %r12
xor %r8, %r8
mov (%r12), %rdx
nop
nop
...
nop
sub %rsi, %rsi
lea addresses_normal_ht+0x189fb, %rsi
lea addresses_WC_ht+0x1ddbb, %rdi
nop
nop
add $41632, %rdx
mov $57, %rcx
...
nop
inc %rbx
lea addresses_WT_ht+0xb18b, %rcx
clflush (%rcx)
nop
nop
nop
