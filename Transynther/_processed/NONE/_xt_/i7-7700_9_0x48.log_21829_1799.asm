...
push %rdi
push %rsi
lea addresses_WT_ht+0xb98c, %rbp
nop
nop
nop
nop
...
nop
cmp %r13, %r13
lea addresses_WC_ht+0x13814, %r10
nop
nop
nop
nop
...
nop
cmp %r15, %r15
lea addresses_WC_ht+0x11135, %rcx
nop
add %r15, %r15
movb $0x61, (%rcx)
nop
inc %r15
lea addresses_UC_ht+0x1668c, %r10
mfence
vmovups (%r10), %ymm3
...
nop
sub $3264, %r13
lea addresses_normal_ht+0x6bac, %r15
inc %rbp
movb (%r15), %cl
nop
nop
...
nop
sub $46535, %r15
lea addresses_D_ht+0x5d1c, %rsi
lea addresses_WT_ht+0x45cc, %rdi
clflush (%rdi)
nop
nop
mfence
...
nop
and %rdi, %rdi
lea addresses_normal_ht+0x31cc, %rsi
nop
nop
nop
cmp $20929, %rcx
...
nop
add %r10, %r10
lea addresses_UC_ht+0x15010, %rax
nop
inc %r13
mov (%rax), %ebp
nop
...
nop
cmp $35556, %rcx
lea addresses_A_ht+0x6dcc, %rsi
lea addresses_normal_ht+0x19b40, %rdi
nop
nop
nop
cmp %r10, %r10
...
{'OP': 'STOR', 'dst': {'type': 'addresses_WC_ht', 'AVXalign': True, 'congruent': 0, 'size': 1, 'same': False, 'NT': False}}
...
{'OP': 'REPM', 'src': {'type': 'addresses_D_ht', 'congruent': 1, 'same': False}, 'dst': {'type': 'addresses_WT_ht', 'congruent': 10, 'same': True}}
...
{'OP': 'LOAD', 'src': {'type': 'addresses_WT_ht', 'AVXalign': False, 'congruent': 6, 'size': 2, 'same': False, 'NT': True}}
{'OP': 'STOR', 'dst': {'type': 'addresses_UC_ht', 'AVXalign': False, 'congruent': 7, 'size': 2, 'same': True, 'NT': False}}
