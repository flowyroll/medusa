...
push %rdx
push %rsi
lea addresses_WC_ht+0x491a, %rdx
nop
nop
nop
nop
...
nop
add $55767, %rdx
lea addresses_WT_ht+0x364a, %rsi
nop
nop
nop
nop
...
nop
cmp %rdi, %rdi
lea addresses_UC_ht+0xa746, %r12
nop
nop
nop
nop
...
mov (%r12), %si
dec %r12
lea addresses_D_ht+0x16a1a, %rbx
nop
nop
nop
nop
...
nop
cmp %r14, %r14
lea addresses_A_ht+0x11e3a, %rdi
and $56762, %r14
mov (%rdi), %r12w
nop
nop
...
nop
and %rdi, %rdi
lea addresses_D_ht+0x1891a, %r12
nop
nop
nop
nop
...
nop
mfence
lea addresses_normal_ht+0x142c2, %rsi
lea addresses_A_ht+0x1ed5a, %rdi
nop
dec %r15
mov $2, %rcx
rep movsq
...
nop
xor $64409, %r14
lea addresses_normal_ht+0x10406, %rsi
nop
nop
nop
nop
...
nop
cmp %r14, %r14
lea addresses_A_ht+0x1c11a, %rsi
lea addresses_A_ht+0x18a9a, %rdi
nop
nop
nop
nop
...
nop
and $14387, %r12
lea addresses_D_ht+0x1d41a, %rsi
add %r15, %r15
...
<gen_prepare_buffer>
{'OP': 'STOR', 'dst': {'type': 'addresses_WC_ht', 'size': 32, 'AVXalign': False, 'NT': True, 'congruent': 9, 'same': False}}
...
{'OP': 'LOAD', 'src': {'type': 'addresses_normal_ht', 'size': 16, 'AVXalign': False, 'NT': False, 'congruent': 1, 'same': True}}
