...
nop
and %r13, %r13
lea addresses_WC_ht+0xa253, %rbp
nop
nop
nop
dec %r13
...
nop
and %r15, %r15
lea addresses_normal_ht+0x18233, %rbp
nop
dec %r15
...
nop
inc %rbp
lea addresses_WC_ht+0x98c3, %r12
xor %rdi, %rdi
...
{'OP': 'STOR', 'dst': {'same': False, 'type': 'addresses_UC_ht', 'NT': True, 'AVXalign': False, 'size': 8, 'congruent': 1}}
