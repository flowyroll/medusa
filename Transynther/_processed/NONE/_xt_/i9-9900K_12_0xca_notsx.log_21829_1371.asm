...
nop
dec %r11
lea addresses_D_ht+0x1b940, %rcx
nop
nop
nop
and %r10, %r10
...
nop
cmp $51839, %r11
lea addresses_normal_ht+0x18588, %rsi
lea addresses_WC_ht+0x12ec8, %rdi
clflush (%rsi)
nop
nop
nop
...
nop
and $18534, %rdi
lea addresses_A_ht+0x1b9c8, %r14
and $8309, %r11
...
nop
inc %rsi
lea addresses_WT_ht+0x5fa8, %rsi
lea addresses_WT_ht+0x1fc8, %rdi
nop
nop
nop
nop
...
nop
sub $8728, %r11
lea addresses_UC_ht+0xbfb0, %rdi
nop
nop
nop
inc %r11
mov (%rdi), %r14w
add %r13, %r13
lea addresses_UC_ht+0x16fa8, %r13
nop
and %r8, %r8
mov (%r13), %rsi
nop
...
{'OP': 'LOAD', 'src': {'same': False, 'type': 'addresses_UC', 'NT': False, 'AVXalign': False, 'size': 1, 'congruent': 9}}
[Faulty Load]
{'OP': 'LOAD', 'src': {'same': True, 'type': 'addresses_D', 'NT': False, 'AVXalign': False, 'size': 16, 'congruent': 0}}
<gen_prepare_buffer>
{'OP': 'REPM', 'src': {'same': True, 'congruent': 0, 'type': 'addresses_A_ht'}, 'dst': {'same': False, 'congruent': 9, 'type': 'addresses_WC_ht'}}
...
{'OP': 'REPM', 'src': {'same': False, 'congruent': 5, 'type': 'addresses_normal_ht'}, 'dst': {'same': False, 'congruent': 8, 'type': 'addresses_WC_ht'}}
...
{'OP': 'LOAD', 'src': {'same': False, 'type': 'addresses_UC_ht', 'NT': False, 'AVXalign': True, 'size': 2, 'congruent': 3}}
