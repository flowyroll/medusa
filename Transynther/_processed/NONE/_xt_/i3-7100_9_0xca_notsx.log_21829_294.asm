...
nop
and $54578, %rdx
lea addresses_normal_ht+0xce37, %rsi
lea addresses_WC_ht+0x1bed7, %rdi
nop
nop
nop
nop
...
movw $0x6162, (%r9)
cmp %rcx, %rcx
lea addresses_UC_ht+0x4b65, %rsi
lea addresses_D_ht+0x8137, %rdi
nop
cmp %r9, %r9
mov $79, %rcx
rep movsb
...
nop
inc %rax
lea addresses_WT_ht+0x10b8f, %rcx
nop
nop
nop
sub $13133, %rdi
...
{'OP': 'STOR', 'dst': {'same': False, 'congruent': 8, 'NT': False, 'type': 'addresses_UC_ht', 'size': 2, 'AVXalign': True}}
...
{'src': {'type': 'addresses_UC_ht', 'congruent': 0, 'same': False}, 'OP': 'REPM', 'dst': {'type': 'addresses_D_ht', 'congruent': 8, 'same': False}}
