...
nop
and %rdx, %rdx
lea addresses_D_ht+0x1c184, %r12
nop
nop
nop
nop
...
nop
add $5582, %rcx
lea addresses_UC_ht+0x1c104, %rdi
nop
nop
nop
nop
...
nop
add $25854, %r14
lea addresses_WT_ht+0x17d04, %rsi
clflush (%rsi)
nop
nop
nop
...
movb $0x61, (%rsi)
add $16288, %r12
lea addresses_WC_ht+0x11010, %rsi
lea addresses_UC_ht+0x9704, %rdi
nop
add %r15, %r15
mov $51, %rcx
rep movsq
...
nop
xor $16763, %r12
lea addresses_normal_ht+0x18454, %rcx
nop
nop
nop
nop
...
vpextrq $1, %xmm6, %rsi
inc %rdi
lea addresses_WT_ht+0xf104, %rsi
nop
nop
xor $29396, %r12
mov (%rsi), %r14d
...
lea addresses_WT_ht+0x8984, %rdi
clflush (%rsi)
clflush (%rdi)
nop
nop
...
// Faulty Load
lea addresses_normal+0x3f04, %r11
and $10305, %rax
movups (%r11), %xmm1
vpextrq $1, %xmm1, %r10
lea oracles, %rax
...
{'OP': 'REPM', 'src': {'type': 'addresses_WC_ht', 'congruent': 0, 'same': True}, 'dst': {'type': 'addresses_UC_ht', 'congruent': 10, 'same': False}}
