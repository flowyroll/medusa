...
push %rdi
push %rsi
lea addresses_normal_ht+0xf41c, %rsi
lea addresses_UC_ht+0xabfe, %rdi
nop
nop
nop
nop
...
nop
and $54638, %r14
lea addresses_UC_ht+0x1cffe, %rsi
lea addresses_A_ht+0x6fe, %rdi
nop
nop
nop
nop
...
nop
sub %r12, %r12
lea addresses_D_ht+0x1404e, %rdi
nop
nop
nop
nop
...
<gen_prepare_buffer>
{'OP': 'REPM', 'src': {'type': 'addresses_normal_ht', 'congruent': 1, 'same': False}, 'dst': {'type': 'addresses_UC_ht', 'congruent': 8, 'same': False}}
