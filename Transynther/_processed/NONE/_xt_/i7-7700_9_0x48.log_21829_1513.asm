...
nop
cmp %rcx, %rcx
lea addresses_normal_ht+0x1662c, %r15
clflush (%r15)
dec %r14
mov (%r15), %r11
nop
...
nop
and %r11, %r11
lea addresses_normal_ht+0xafda, %r12
nop
nop
nop
nop
...
movups %xmm1, (%r12)
cmp $6313, %rcx
lea addresses_D_ht+0x310c, %rsi
lea addresses_D_ht+0x1418c, %rdi
nop
nop
nop
nop
