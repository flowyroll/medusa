...
push %rdi
push %rsi
lea addresses_WC_ht+0x85b9, %r11
clflush (%r11)
nop
nop
nop
...
nop
add $43586, %r15
lea addresses_WC_ht+0xeba1, %r14
nop
nop
nop
xor $64403, %rsi
...
nop
cmp %rbp, %rbp
lea addresses_normal_ht+0x165b9, %r14
nop
nop
nop
nop
...
nop
inc %rbp
lea addresses_UC_ht+0x17e49, %rsi
lea addresses_normal_ht+0x91b9, %rdi
clflush (%rsi)
clflush (%rdi)
nop
nop
...
rep movsw
sub $16739, %r14
lea addresses_WT_ht+0x10c79, %rsi
lea addresses_D_ht+0x1a7b9, %rdi
cmp $10117, %r14
mov $19, %rcx
rep movsw
xor $59617, %r15
lea addresses_A_ht+0xfa39, %r13
and $38369, %rsi
mov (%r13), %r14w
nop
nop
...
nop
xor %rdi, %rdi
lea addresses_normal_ht+0x1e9b9, %rsi
nop
nop
nop
nop
...
nop
xor %r8, %r8
lea addresses_WC_ht+0x84b9, %r13
cmp $7946, %rcx
mov (%r13), %ebp
inc %rdi
lea addresses_D_ht+0x3b69, %rsi
lea addresses_WC_ht+0x1b5b9, %rdi
clflush (%rdi)
nop
add $25427, %r13
mov $86, %rcx
rep movsb
add %r13, %r13
lea addresses_A_ht+0x9639, %rsi
lea addresses_WT_ht+0x5089, %rdi
nop
add %r15, %r15
mov $77, %rcx
rep movsb
...
// Load
lea addresses_normal+0x13ac5, %r13
clflush (%r13)
nop
nop
nop
...
{'OP': 'REPM', 'src': {'type': 'addresses_UC_ht', 'congruent': 2, 'same': False}, 'dst': {'type': 'addresses_normal_ht', 'congruent': 11, 'same': False}}
{'OP': 'REPM', 'src': {'type': 'addresses_WT_ht', 'congruent': 3, 'same': False}, 'dst': {'type': 'addresses_D_ht', 'congruent': 9, 'same': False}}
{'OP': 'LOAD', 'src': {'type': 'addresses_A_ht', 'size': 2, 'AVXalign': False, 'NT': False, 'congruent': 5, 'same': False}}
{'OP': 'STOR', 'dst': {'type': 'addresses_normal_ht', 'size': 8, 'AVXalign': False, 'NT': False, 'congruent': 11, 'same': True}}
...
{'OP': 'REPM', 'src': {'type': 'addresses_A_ht', 'congruent': 6, 'same': True}, 'dst': {'type': 'addresses_WT_ht', 'congruent': 4, 'same': False}}
{'37': 13655}
