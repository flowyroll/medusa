...
nop
add %r10, %r10
lea addresses_WT_ht+0x13ca0, %r14
nop
nop
nop
nop
...
nop
cmp %rsi, %rsi
lea addresses_WC_ht+0x6ca0, %r13
nop
nop
dec %rbx
mov (%r13), %r10w
...
nop
add %rax, %rax
lea addresses_WT_ht+0x18ea0, %rsi
lea addresses_UC_ht+0x1b2a0, %rdi
nop
nop
add %r13, %r13
mov $101, %rcx
...
// Load
lea addresses_normal+0x1b7a0, %r8
nop
nop
nop
nop
...
// Faulty Load
lea addresses_normal+0x20a0, %r14
nop
sub $22035, %rdx
movups (%r14), %xmm5
vpextrq $1, %xmm5, %rax
...
{'OP': 'LOAD', 'src': {'type': 'addresses_normal', 'size': 32, 'AVXalign': False, 'NT': True, 'congruent': 8, 'same': False}}
...
{'OP': 'STOR', 'dst': {'type': 'addresses_NC', 'size': 1, 'AVXalign': True, 'NT': True, 'congruent': 11, 'same': False}}
[Faulty Load]
