...
push %rdi
push %rsi
lea addresses_normal_ht+0x1388e, %rsi
lea addresses_A_ht+0x162d5, %rdi
nop
nop
nop
nop
...
rep movsl
add $42470, %r14
lea addresses_WT_ht+0x768e, %rbx
nop
nop
nop
nop
...
nop
cmp %rcx, %rcx
lea addresses_D_ht+0x1320e, %rcx
nop
nop
nop
add $3773, %rsi
movw $0x6162, (%rcx)
and $25216, %r13
lea addresses_normal_ht+0x1d48e, %rcx
nop
nop
nop
inc %r14
...
nop
xor $39994, %rsi
lea addresses_normal_ht+0x948e, %rcx
dec %r14
movb (%rcx), %r13b
and $9890, %rcx
lea addresses_normal_ht+0xadfe, %r14
clflush (%r14)
nop
sub $58919, %rcx
movw $0x6162, (%r14)
...
nop
dec %rcx
lea addresses_A_ht+0x1554a, %r14
nop
nop
nop
nop
...
nop
and $16426, %rdi
lea addresses_normal_ht+0xc8e, %rsi
lea addresses_normal_ht+0x148e, %rdi
sub $39255, %r10
mov $28, %rcx
rep movsw
sub %rdi, %rdi
lea addresses_normal_ht+0x19b8e, %rdi
nop
nop
nop
sub $58246, %r13
...
nop
sub %rcx, %rcx
lea addresses_WC_ht+0x2e8e, %r15
nop
nop
nop
cmp %rcx, %rcx
...
nop
sub $1491, %r10
lea addresses_WT_ht+0x1992e, %r10
clflush (%r10)
add %r14, %r14
movb (%r10), %cl
nop
...
// Faulty Load
lea addresses_normal+0x1948e, %r15
nop
nop
nop
dec %r9
...
{'OP': 'STOR', 'dst': {'same': False, 'congruent': 8, 'NT': False, 'type': 'addresses_WT_ht', 'size': 2, 'AVXalign': True}}
...
{'src': {'type': 'addresses_normal_ht', 'congruent': 11, 'same': False}, 'OP': 'REPM', 'dst': {'type': 'addresses_normal_ht', 'congruent': 9, 'same': False}}
