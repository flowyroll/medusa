...
push %rdi
push %rsi
lea addresses_WT_ht+0x1bef7, %rsi
nop
nop
nop
nop
...
nop
xor %r12, %r12
lea addresses_D_ht+0x11a17, %rdi
and $32107, %rbp
...
nop
add %rsi, %rsi
lea addresses_A_ht+0x1d797, %r8
nop
add $51336, %r14
mov (%r8), %r12d
nop
and $51816, %r12
lea addresses_WC_ht+0x17797, %rsi
lea addresses_UC_ht+0x1a297, %rdi
nop
nop
nop
nop
...
movq %r8, (%rsi)
and %rsi, %rsi
lea addresses_WC_ht+0x596f, %rsi
lea addresses_A_ht+0x143a8, %rdi
nop
and $35977, %r13
mov $55, %rcx
rep movsq
nop
lfence
lea addresses_WC_ht+0x1d517, %rsi
lea addresses_normal_ht+0xc797, %rdi
nop
and %r8, %r8
mov $34, %rcx
rep movsb
and %rdi, %rdi
lea addresses_A_ht+0x15f97, %rsi
...
nop
inc %rcx
lea addresses_WC_ht+0x143fb, %rdi
cmp $16162, %rsi
movb (%rdi), %r8b
nop
nop
...
nop
xor $14450, %rbp
lea addresses_normal_ht+0x1ddf7, %rsi
lea addresses_A_ht+0x182c7, %rdi
nop
nop
nop
nop
...
nop
xor $64553, %rcx
lea addresses_UC_ht+0x1caf3, %rsi
lea addresses_normal_ht+0xe397, %rdi
nop
and %r12, %r12
mov $125, %rcx
rep movsw
...
// Faulty Load
lea addresses_normal+0xb797, %rax
nop
nop
nop
xor $5420, %r11
...
{'OP': 'STOR', 'dst': {'type': 'addresses_D_ht', 'size': 8, 'AVXalign': False, 'NT': True, 'congruent': 5, 'same': True}}
...
{'OP': 'REPM', 'src': {'type': 'addresses_UC_ht', 'congruent': 2, 'same': False}, 'dst': {'type': 'addresses_normal_ht', 'congruent': 9, 'same': False}}
{'34': 2666}
