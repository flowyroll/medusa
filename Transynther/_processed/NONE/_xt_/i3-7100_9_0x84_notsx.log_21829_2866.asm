...
push %rdi
push %rsi
lea addresses_normal_ht+0xb8dc, %rcx
nop
nop
sub %r12, %r12
mov (%rcx), %bx
...
nop
and $23548, %rdi
lea addresses_normal_ht+0x6dfc, %r10
nop
nop
nop
nop
...
nop
dec %rbx
lea addresses_WC_ht+0xfe7c, %rsi
lea addresses_WT_ht+0x10b7c, %rdi
nop
nop
lfence
mov $124, %rcx
