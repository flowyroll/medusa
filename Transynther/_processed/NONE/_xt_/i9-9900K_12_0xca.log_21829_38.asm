...
push %rcx
push %rdx
lea addresses_D_ht+0x1bf0b, %r12
nop
nop
xor %rax, %rax
movb (%r12), %r10b
...
nop
and %rbp, %rbp
lea addresses_WT_ht+0x1310b, %rax
nop
nop
nop
nop
...
nop
add $2749, %rax
lea addresses_WC_ht+0xce0b, %r14
nop
nop
nop
add %rdx, %rdx
...
nop
xor %rbp, %rbp
lea addresses_normal_ht+0x14a0b, %rbp
nop
inc %rax
mov (%rbp), %ecx
nop
...
nop
xor $25820, %r12
lea addresses_UC_ht+0x1f0b, %rcx
nop
nop
nop
nop
...
{'OP': 'LOAD', 'src': {'size': 4, 'NT': False, 'type': 'addresses_US', 'same': False, 'AVXalign': False, 'congruent': 10}}
[Faulty Load]
