...
nop
cmp $65151, %r15
lea addresses_D_ht+0x1397d, %rsi
lea addresses_WT_ht+0xa2cd, %rdi
xor %rdx, %rdx
mov $95, %rcx
rep movsq
nop
...
nop
cmp $4396, %r15
lea addresses_D_ht+0x17dcd, %rdx
nop
nop
nop
nop
...
vpextrq $1, %xmm5, %rsi
add %r15, %r15
lea addresses_D_ht+0x8acd, %rsi
lea addresses_WC_ht+0x1624d, %rdi
sub $19592, %r12
mov $35, %rcx
rep movsq
nop
...
nop
xor %r12, %r12
lea addresses_UC_ht+0x12883, %rdx
nop
and %rdi, %rdi
movl $0x61626364, (%rdx)
nop
nop
add %r8, %r8
lea addresses_WC_ht+0x1e34d, %rsi
sub $56951, %r15
movb $0x61, (%rsi)
nop
nop
nop
and $43004, %r8
lea addresses_normal_ht+0x2cd1, %r12
nop
nop
nop
sub %rdx, %rdx
...
lea addresses_WT_ht+0x16c6d, %rdi
nop
nop
nop
sub %r11, %r11
...
// Store
lea addresses_normal+0x97cd, %r13
nop
sub %r12, %r12
movb $0x51, (%r13)
cmp %r12, %r12
...
<gen_prepare_buffer>
{'dst': {'NT': False, 'AVXalign': True, 'size': 32, 'congruent': 7, 'same': False, 'type': 'addresses_A_ht'}, 'OP': 'STOR'}
{'src': {'congruent': 2, 'same': True, 'type': 'addresses_D_ht'}, 'dst': {'congruent': 10, 'same': False, 'type': 'addresses_WT_ht'}, 'OP': 'REPM'}
{'src': {'NT': False, 'AVXalign': False, 'size': 32, 'congruent': 7, 'same': False, 'type': 'addresses_D_ht'}, 'OP': 'LOAD'}
{'src': {'congruent': 10, 'same': False, 'type': 'addresses_D_ht'}, 'dst': {'congruent': 6, 'same': False, 'type': 'addresses_WC_ht'}, 'OP': 'REPM'}
...
{'src': {'congruent': 11, 'same': False, 'type': 'addresses_WC_ht'}, 'dst': {'congruent': 0, 'same': False, 'type': 'addresses_WT_ht'}, 'OP': 'REPM'}
{'38': 21829}
