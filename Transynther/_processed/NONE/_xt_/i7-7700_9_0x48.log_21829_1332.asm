...
push %rdi
push %rsi
lea addresses_WT_ht+0x7062, %rbx
nop
nop
nop
nop
...
nop
sub %rbp, %rbp
lea addresses_UC_ht+0xd200, %rax
nop
nop
nop
nop
...
nop
dec %rax
lea addresses_UC_ht+0x1cd71, %rdi
nop
add $37830, %r13
mov (%rdi), %rbp
nop
...
lea addresses_WT_ht+0xf6b8, %rdi
clflush (%rsi)
nop
nop
nop
...
nop
cmp $21761, %r13
lea addresses_normal_ht+0x15bf2, %rbx
nop
xor %rax, %rax
movups (%rbx), %xmm7
vpextrq $1, %xmm7, %rcx
...
nop
xor $40177, %r10
lea addresses_normal_ht+0xb4b0, %rcx
nop
and $10294, %rsi
movb $0x61, (%rcx)
nop
...
nop
and $14632, %rsi
lea addresses_D_ht+0x10d80, %rsi
lea addresses_A_ht+0x18a00, %rdi
clflush (%rsi)
nop
nop
nop
...
nop
cmp %r13, %r13
lea addresses_WT_ht+0x1ca00, %rcx
nop
sub %rbx, %rbx
movw $0x6162, (%rcx)
nop
...
nop
xor $62262, %rsi
lea addresses_normal_ht+0x1cb00, %rcx
add $46109, %r13
movb (%rcx), %al
nop
nop
