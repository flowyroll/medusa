...
nop
xor $13081, %r9
lea addresses_WC_ht+0x1b9af, %rsi
nop
nop
nop
nop
...
mov (%rsi), %r15w
cmp $45765, %r11
lea addresses_WC_ht+0x16969, %rcx
cmp %r9, %r9
mov (%rcx), %r11w
nop
nop
...
nop
cmp %rcx, %rcx
lea addresses_WC_ht+0x1ab6f, %rdx
nop
nop
nop
nop
...
nop
sub $7402, %r8
lea addresses_normal_ht+0x1d27b, %rcx
nop
nop
nop
add %r9, %r9
...
nop
add $42586, %rsi
lea addresses_UC_ht+0xc26f, %rdx
nop
nop
nop
inc %r11
...
{'OP': 'STOR', 'dst': {'congruent': 7, 'AVXalign': False, 'same': False, 'size': 16, 'NT': True, 'type': 'addresses_WC_ht'}}
