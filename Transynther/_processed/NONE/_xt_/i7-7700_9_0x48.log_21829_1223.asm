...
nop
and $58326, %r14
lea addresses_UC_ht+0x1dbde, %rsi
lea addresses_normal_ht+0x187d6, %rdi
nop
nop
nop
nop
...
nop
sub %rsi, %rsi
lea addresses_A_ht+0x1791e, %rbx
cmp %rsi, %rsi
mov (%rbx), %ax
nop
nop
...
nop
sub %rax, %rax
lea addresses_UC_ht+0x1a1de, %rsi
lea addresses_A_ht+0x19b3e, %rdi
nop
nop
add $7097, %rbp
mov $122, %rcx
...
nop
cmp $17167, %rdi
lea addresses_A_ht+0x1378e, %rsi
nop
nop
xor %rax, %rax
...
nop
and $5263, %r8
lea addresses_WC_ht+0x49ba, %rsi
lea addresses_normal_ht+0xef1e, %rdi
nop
nop
sub $61783, %r8
mov $78, %rcx
...
nop
sub %rax, %rax
lea addresses_WC_ht+0x7fda, %rbx
xor %rsi, %rsi
movups (%rbx), %xmm3
vpextrq $0, %xmm3, %rbp
nop
sub %rbp, %rbp
lea addresses_D_ht+0x53ca, %r8
nop
nop
sub $36120, %rdi
movups (%r8), %xmm4
...
lea addresses_WC_ht+0x509e, %rdi
nop
xor $54155, %r8
mov $44, %rcx
rep movsq
add $1276, %rdi
lea addresses_D_ht+0xe016, %rsi
lea addresses_UC_ht+0xfe9e, %rdi
nop
nop
and $17287, %rbp
mov $108, %rcx
...
// Store
lea addresses_normal+0x1ce9e, %r9
nop
inc %rbp
movb $0x51, (%r9)
nop
...
// Faulty Load
lea addresses_normal+0x1ce9e, %r8
nop
nop
and $32406, %r10
vmovups (%r8), %ymm6
...
{'OP': 'STOR', 'dst': {'type': 'addresses_normal', 'AVXalign': False, 'congruent': 0, 'size': 1, 'same': True, 'NT': True}}
[Faulty Load]
...
{'OP': 'REPM', 'src': {'type': 'addresses_WC_ht', 'congruent': 0, 'same': True}, 'dst': {'type': 'addresses_normal_ht', 'congruent': 5, 'same': False}}
...
{'OP': 'STOR', 'dst': {'type': 'addresses_A_ht', 'AVXalign': True, 'congruent': 11, 'size': 16, 'same': False, 'NT': False}}
{'34': 21829}
