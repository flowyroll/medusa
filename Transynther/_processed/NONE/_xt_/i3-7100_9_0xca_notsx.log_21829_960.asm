...
nop
dec %r12
lea addresses_normal_ht+0x6f56, %rsi
lea addresses_WC_ht+0x17756, %rdi
nop
nop
nop
nop
...
nop
cmp $2714, %r15
lea addresses_A_ht+0x13556, %r12
nop
nop
nop
nop
...
nop
and $65482, %rdi
lea addresses_UC_ht+0xec56, %rsi
nop
nop
dec %rdi
vmovups (%rsi), %ymm0
...
{'OP': 'STOR', 'dst': {'same': True, 'congruent': 5, 'NT': False, 'type': 'addresses_UC', 'size': 32, 'AVXalign': False}}
...
{'src': {'type': 'addresses_normal_ht', 'congruent': 8, 'same': False}, 'OP': 'REPM', 'dst': {'type': 'addresses_WC_ht', 'congruent': 9, 'same': True}}
