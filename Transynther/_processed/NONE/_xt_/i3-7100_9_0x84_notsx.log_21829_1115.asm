...
push %rdx
push %rsi
lea addresses_D_ht+0x1af38, %rsi
lea addresses_WT_ht+0xaa3f, %rdi
nop
xor $46885, %r9
mov $36, %rcx
rep movsb
...
nop
and $1163, %r10
lea addresses_UC_ht+0x14807, %r10
nop
nop
nop
nop
...
mov (%r10), %r9d
cmp %rbx, %rbx
lea addresses_UC_ht+0x2187, %r10
nop
nop
nop
nop
...
nop
and %r10, %r10
lea addresses_WC_ht+0x11a87, %r9
nop
nop
nop
nop
...
nop
add $46370, %r9
lea addresses_WC_ht+0x14f07, %rsi
lea addresses_UC_ht+0xa0e7, %rdi
nop
nop
nop
nop
...
nop
dec %r10
lea addresses_UC_ht+0xfb07, %rsi
lea addresses_normal_ht+0x2187, %rdi
clflush (%rdi)
and $52528, %r8
mov $29, %rcx
rep movsq
dec %r10
lea addresses_D_ht+0x14307, %rcx
nop
sub $50340, %r9
...
movntdq %xmm6, (%rcx)
xor $2844, %rdx
lea addresses_normal_ht+0x422f, %rdx
clflush (%rdx)
nop
nop
nop
...
nop
and %r8, %r8
lea addresses_UC_ht+0x11367, %rcx
cmp %rsi, %rsi
mov $0x6162636465666768, %r9
movq %r9, (%rcx)
nop
dec %r10
lea addresses_A_ht+0xf295, %r9
nop
nop
sub $25420, %r8
...
{'dst': {'type': 'addresses_D_ht', 'same': False, 'size': 8, 'congruent': 3, 'NT': False, 'AVXalign': True}, 'OP': 'STOR'}
{'src': {'type': 'addresses_UC_ht', 'same': False, 'size': 4, 'congruent': 9, 'NT': True, 'AVXalign': False}, 'OP': 'LOAD'}
{'dst': {'type': 'addresses_UC_ht', 'same': False, 'size': 16, 'congruent': 7, 'NT': False, 'AVXalign': False}, 'OP': 'STOR'}
{'dst': {'type': 'addresses_WC_ht', 'same': True, 'size': 2, 'congruent': 2, 'NT': False, 'AVXalign': True}, 'OP': 'STOR'}
