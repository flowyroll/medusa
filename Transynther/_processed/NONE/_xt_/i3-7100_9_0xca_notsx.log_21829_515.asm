...
push %rdi
push %rsi
lea addresses_D_ht+0x2b56, %rsi
lea addresses_normal_ht+0x3b56, %rdi
clflush (%rdi)
nop
nop
nop
...
nop
xor %r9, %r9
lea addresses_WT_ht+0x2fd6, %rsi
lea addresses_WT_ht+0xa656, %rdi
and $10977, %r8
mov $84, %rcx
rep movsq
nop
...
nop
sub $11986, %rdi
lea addresses_WC_ht+0x10f0a, %r11
nop
nop
nop
nop
...
<gen_prepare_buffer>
{'src': {'type': 'addresses_D_ht', 'congruent': 9, 'same': False}, 'OP': 'REPM', 'dst': {'type': 'addresses_normal_ht', 'congruent': 7, 'same': False}}
