...
nop
sub $1618, %r9
lea addresses_normal_ht+0x176c2, %rdx
nop
nop
add $24776, %r9
movups (%rdx), %xmm5
...
nop
xor $20947, %r14
lea addresses_normal_ht+0x13f62, %rsi
lea addresses_WC_ht+0x30c2, %rdi
nop
dec %r15
mov $11, %rcx
rep movsb
nop
xor $38619, %rcx
lea addresses_normal_ht+0x1c1ee, %rsi
lea addresses_A_ht+0xac2, %rdi
nop
nop
sub %rdx, %rdx
mov $47, %rcx
...
nop
cmp %r15, %r15
lea addresses_normal_ht+0xf826, %r14
clflush (%r14)
nop
nop
nop
...
nop
dec %r15
lea addresses_UC_ht+0x1e8c2, %r15
nop
nop
nop
nop
...
nop
xor $40382, %rdi
lea addresses_normal_ht+0x74c2, %rbp
nop
and %r9, %r9
movb (%rbp), %r15b
nop
...
nop
and $34902, %rsi
lea addresses_UC_ht+0x17f82, %rdi
nop
nop
add %rsi, %rsi
movl $0x61626364, (%rdi)
...
nop
xor $34815, %rcx
lea addresses_WT_ht+0x198c2, %rdx
nop
nop
nop
nop
...
movups %xmm1, (%rdx)
xor $48503, %rsi
lea addresses_normal_ht+0x1abc2, %r15
nop
nop
nop
nop
...
nop
cmp $27988, %r15
lea addresses_UC_ht+0x15b42, %rcx
nop
xor $3678, %rdi
mov (%rcx), %esi
nop
nop
add %r14, %r14
lea addresses_A_ht+0x19bc2, %rbp
nop
nop
nop
nop
...
<gen_prepare_buffer>
{'dst': {'same': True, 'NT': False, 'AVXalign': False, 'size': 8, 'type': 'addresses_A_ht', 'congruent': 2}, 'OP': 'STOR'}
...
{'dst': {'same': False, 'congruent': 9, 'type': 'addresses_A_ht'}, 'OP': 'REPM', 'src': {'same': False, 'congruent': 2, 'type': 'addresses_normal_ht'}}
{'OP': 'LOAD', 'src': {'same': False, 'NT': False, 'AVXalign': True, 'size': 4, 'type': 'addresses_A_ht', 'congruent': 4}}
...
{'OP': 'LOAD', 'src': {'same': True, 'NT': False, 'AVXalign': False, 'size': 32, 'type': 'addresses_normal_ht', 'congruent': 7}}
{'OP': 'LOAD', 'src': {'same': True, 'NT': False, 'AVXalign': True, 'size': 4, 'type': 'addresses_UC_ht', 'congruent': 7}}
