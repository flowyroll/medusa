...
nop
sub $45291, %rcx
lea addresses_WC_ht+0x776f, %rbp
nop
nop
xor $8778, %rax
movb $0x61, (%rbp)
...
nop
and $46176, %r15
lea addresses_UC_ht+0x14be7, %rsi
lea addresses_WC_ht+0x1814f, %rdi
clflush (%rsi)
nop
nop
inc %r13
...
lea addresses_WC_ht+0xe4bf, %rdi
nop
nop
and %rdx, %rdx
mov $55, %rcx
...
nop
sub $40551, %rdi
lea addresses_UC_ht+0xa06f, %r15
nop
nop
dec %rax
...
nop
add %rdi, %rdi
lea addresses_WC_ht+0x946f, %rcx
nop
nop
nop
nop
...
nop
dec %rsi
lea addresses_normal_ht+0x1d5c7, %rdi
clflush (%rdi)
nop
nop
nop
...
movw $0x6162, (%rdi)
xor $56012, %rbp
lea addresses_WC_ht+0xa0ef, %r15
nop
nop
nop
nop
...
{'src': {'congruent': 3, 'same': False, 'type': 'addresses_UC_ht'}, 'OP': 'REPM', 'dst': {'congruent': 5, 'same': False, 'type': 'addresses_WC_ht'}}
{'src': {'congruent': 3, 'same': False, 'type': 'addresses_WC_ht'}, 'OP': 'REPM', 'dst': {'congruent': 2, 'same': False, 'type': 'addresses_WC_ht'}}
{'src': {'congruent': 7, 'AVXalign': False, 'same': False, 'size': 32, 'NT': True, 'type': 'addresses_D_ht'}, 'OP': 'LOAD'}
