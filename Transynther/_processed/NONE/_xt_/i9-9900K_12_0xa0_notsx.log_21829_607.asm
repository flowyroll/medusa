...
nop
and $5627, %r15
lea addresses_WC_ht+0x1a97c, %rsi
lea addresses_normal_ht+0x324, %rdi
nop
nop
nop
nop
...
lea addresses_A_ht+0x16724, %rdi
and $48873, %rbp
mov $78, %rcx
rep movsl
nop
and %rbp, %rbp
lea addresses_UC_ht+0xaac4, %r15
nop
nop
nop
nop
...
nop
sub $54288, %rdi
lea addresses_UC_ht+0x174a9, %r15
clflush (%r15)
nop
nop
nop
...
{'src': {'type': 'addresses_WT_ht', 'AVXalign': True, 'size': 1, 'NT': False, 'same': False, 'congruent': 1}, 'OP': 'LOAD'}
