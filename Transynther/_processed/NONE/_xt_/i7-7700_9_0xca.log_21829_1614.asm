...
push %rdi
push %rsi
lea addresses_UC_ht+0x120c, %rsi
lea addresses_A_ht+0x9a7c, %rdi
nop
nop
sub $25496, %r14
mov $19, %rcx
...
nop
dec %r12
lea addresses_normal_ht+0x11fc4, %rsi
lea addresses_WT_ht+0x18e0c, %rdi
clflush (%rdi)
nop
inc %r13
mov $56, %rcx
rep movsq
dec %rcx
lea addresses_normal_ht+0x299c, %rdi
nop
dec %r14
movups (%rdi), %xmm1
vpextrq $1, %xmm1, %r13
...
// Store
lea addresses_normal+0x180fc, %r13
sub $94, %rax
movw $0x5152, (%r13)
nop
sub $49579, %r11
...
// Faulty Load
lea addresses_normal+0x2e0c, %rax
nop
nop
nop
nop
...
{'src': {'congruent': 3, 'same': False, 'type': 'addresses_normal_ht'}, 'OP': 'REPM', 'dst': {'congruent': 11, 'same': False, 'type': 'addresses_WT_ht'}}
