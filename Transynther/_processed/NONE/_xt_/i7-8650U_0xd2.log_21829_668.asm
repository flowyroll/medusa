...
lea addresses_UC_ht+0x1d381, %rdi
nop
xor %rdx, %rdx
mov $60, %rcx
rep movsb
...
nop
and %rax, %rax
lea addresses_D_ht+0x1b901, %rbx
nop
nop
nop
nop
...
nop
sub %rbx, %rbx
lea addresses_normal_ht+0x10351, %rsi
lea addresses_normal_ht+0x1ad81, %rdi
nop
nop
dec %r14
mov $76, %rcx
...
nop
and %rdx, %rdx
lea addresses_UC_ht+0x1de2d, %r8
nop
nop
nop
nop
...
nop
xor $53918, %rbx
lea addresses_D_ht+0x18549, %rsi
lea addresses_WC_ht+0x17f81, %rdi
nop
nop
nop
nop
...
nop
and %r8, %r8
lea addresses_WC_ht+0x1ab81, %rbx
nop
nop
nop
nop
...
mov (%rbx), %r14d
add %rcx, %rcx
lea addresses_normal_ht+0xacf1, %r14
nop
nop
nop
nop
...
nop
dec %rdi
lea addresses_D_ht+0x166d3, %r14
nop
nop
sub %rbx, %rbx
mov (%r14), %rcx
sub %rdx, %rdx
lea addresses_WT_ht+0x10981, %rdx
clflush (%rdx)
nop
nop
nop
...
// Faulty Load
lea addresses_normal+0xe381, %rcx
nop
and %r13, %r13
vmovups (%rcx), %ymm0
...
{'OP': 'REPM', 'src': {'type': 'addresses_A_ht', 'congruent': 9, 'same': False}, 'dst': {'type': 'addresses_UC_ht', 'congruent': 10, 'same': False}}
...
{'OP': 'REPM', 'src': {'type': 'addresses_D_ht', 'congruent': 2, 'same': True}, 'dst': {'type': 'addresses_WC_ht', 'congruent': 10, 'same': False}}
