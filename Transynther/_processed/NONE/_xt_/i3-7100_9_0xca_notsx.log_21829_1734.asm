...
push %rdi
push %rsi
lea addresses_WC_ht+0x195f2, %rbx
nop
add $46131, %r8
movw $0x6162, (%rbx)
nop
inc %r9
lea addresses_normal_ht+0x17b16, %rdi
clflush (%rdi)
sub %r9, %r9
vmovups (%rdi), %ymm0
...
nop
sub $43871, %rdi
lea addresses_UC_ht+0x19442, %rdi
clflush (%rdi)
nop
nop
add %r8, %r8
...
nop
and %r8, %r8
lea addresses_WT_ht+0xc80c, %rsi
lea addresses_WT_ht+0x1416, %rdi
nop
inc %rbx
mov $2, %rcx
rep movsb
nop
xor %rbx, %rbx
lea addresses_normal_ht+0x7116, %rbx
nop
and %rdi, %rdi
vmovups (%rbx), %ymm3
...
movq %r9, (%rbx)
cmp %rcx, %rcx
lea addresses_A_ht+0x13c0a, %rsi
lea addresses_normal_ht+0x12016, %rdi
clflush (%rsi)
nop
nop
nop
...
<gen_prepare_buffer>
{'OP': 'STOR', 'dst': {'same': True, 'congruent': 2, 'NT': False, 'type': 'addresses_WC_ht', 'size': 2, 'AVXalign': False}}
{'src': {'same': False, 'congruent': 8, 'NT': False, 'type': 'addresses_normal_ht', 'size': 32, 'AVXalign': False}, 'OP': 'LOAD'}
{'src': {'same': False, 'congruent': 2, 'NT': True, 'type': 'addresses_UC_ht', 'size': 2, 'AVXalign': False}, 'OP': 'LOAD'}
...
{'OP': 'STOR', 'dst': {'same': False, 'congruent': 2, 'NT': True, 'type': 'addresses_UC_ht', 'size': 8, 'AVXalign': False}}
