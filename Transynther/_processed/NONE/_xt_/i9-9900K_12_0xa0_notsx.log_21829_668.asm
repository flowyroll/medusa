...
lea addresses_normal_ht+0xe9c9, %rdi
nop
nop
nop
nop
...
nop
inc %rax
lea addresses_normal_ht+0x16109, %rax
xor %rcx, %rcx
movb $0x61, (%rax)
inc %rax
lea addresses_A_ht+0xe999, %rsi
nop
nop
nop
and %r14, %r14
...
vpextrq $1, %xmm7, %rcx
cmp $34956, %rcx
lea addresses_WT_ht+0x7bc9, %rsi
nop
nop
nop
dec %r14
...
nop
sub %rcx, %rcx
lea addresses_normal_ht+0x2789, %rsi
lea addresses_normal_ht+0x19139, %rdi
clflush (%rdi)
sub %rax, %rax
mov $0, %rcx
rep movsw
...
nop
inc %rcx
lea addresses_WC_ht+0x3e7b, %rdx
clflush (%rdx)
add $26005, %rax
...
nop
dec %rcx
lea addresses_WC_ht+0x1e0c9, %rsi
lea addresses_UC_ht+0x159c9, %rdi
nop
nop
and %rbx, %rbx
mov $71, %rcx
...
nop
add %rcx, %rcx
lea addresses_WT_ht+0x15444, %rax
clflush (%rax)
xor $20207, %rcx
mov (%rax), %bx
nop
...
lea addresses_WC_ht+0xb9f9, %rdi
nop
nop
nop
xor %rdx, %rdx
...
nop
cmp %rdx, %rdx
lea addresses_WC_ht+0x1a449, %rsi
dec %r9
...
nop
dec %rax
lea addresses_WT_ht+0x1269b, %rdi
nop
nop
xor $24540, %rdx
mov (%rdi), %rsi
...
nop
and $29437, %rcx
lea addresses_D_ht+0x13549, %rsi
lea addresses_WC_ht+0x1696b, %rdi
nop
nop
xor %r14, %r14
mov $96, %rcx
...
<gen_prepare_buffer>
{'src': {'type': 'addresses_normal_ht', 'congruent': 3, 'same': False}, 'OP': 'REPM', 'dst': {'type': 'addresses_normal_ht', 'congruent': 11, 'same': True}}
...
{'src': {'type': 'addresses_WT_ht', 'AVXalign': False, 'size': 2, 'NT': False, 'same': True, 'congruent': 0}, 'OP': 'LOAD'}
