...
// Store
lea addresses_normal+0x10fcb, %r14
nop
nop
nop
nop
...
{'src': {'type': 'addresses_RW', 'same': False, 'size': 2, 'congruent': 2, 'NT': False, 'AVXalign': False}, 'OP': 'LOAD'}
