...
push %rdx
push %rsi
lea addresses_WC_ht+0x6aa, %rsi
lea addresses_UC_ht+0x1a7aa, %rdi
nop
nop
nop
xor $31336, %r8
...
nop
cmp $10457, %r13
lea addresses_D_ht+0xbd16, %r8
xor %rdx, %rdx
movups (%r8), %xmm6
vpextrq $1, %xmm6, %r13
nop
cmp $33126, %rdi
lea addresses_A_ht+0xef4a, %r13
sub $36084, %rbx
movl $0x61626364, (%r13)
inc %rbx
lea addresses_normal_ht+0xacaa, %rbx
clflush (%rbx)
nop
nop
nop
...
{'src': {'type': 'addresses_UC_ht', 'congruent': 4, 'same': False}, 'OP': 'REPM', 'dst': {'type': 'addresses_WT_ht', 'congruent': 6, 'same': False}}
