...
push %rdx
push %rsi
lea addresses_UC_ht+0x82e1, %rsi
lea addresses_D_ht+0x1dee1, %rdi
and $55161, %rdx
mov $45, %rcx
rep movsl
nop
...
nop
add %rsi, %rsi
lea addresses_UC_ht+0xc5e1, %rsi
lea addresses_WT_ht+0x6431, %rdi
xor $21938, %r9
mov $22, %rcx
rep movsq
nop
...
nop
and %rcx, %rcx
lea addresses_WT_ht+0x66b1, %rsi
lea addresses_D_ht+0x1c47e, %rdi
nop
nop
nop
cmp $30834, %rdx
...
nop
xor %rsi, %rsi
lea addresses_normal_ht+0x1d8e1, %rsi
nop
nop
xor %r9, %r9
mov (%rsi), %dx
nop
dec %rbx
lea addresses_normal_ht+0xa3ed, %r9
dec %rsi
...
nop
add %r9, %r9
lea addresses_WT_ht+0x119e1, %rbx
nop
nop
nop
nop
...
nop
inc %r8
lea addresses_normal_ht+0xfd41, %r8
nop
nop
nop
add %rsi, %rsi
...
nop
cmp $42426, %rdi
lea addresses_normal_ht+0x3f21, %rdx
nop
nop
nop
nop
...
nop
cmp $4405, %rcx
lea addresses_WT_ht+0xef0d, %rsi
lea addresses_normal_ht+0x13d51, %rdi
nop
sub %r8, %r8
mov $79, %rcx
rep movsw
...
nop
inc %rdi
lea addresses_normal_ht+0x153e1, %r9
nop
nop
nop
add $50650, %rbx
...
{'OP': 'STOR', 'dst': {'same': False, 'type': 'addresses_RW', 'NT': False, 'AVXalign': False, 'size': 8, 'congruent': 9}}
...
<gen_prepare_buffer>
{'OP': 'REPM', 'src': {'same': False, 'congruent': 8, 'type': 'addresses_UC_ht'}, 'dst': {'same': True, 'congruent': 6, 'type': 'addresses_D_ht'}}
...
{'OP': 'REPM', 'src': {'same': False, 'congruent': 4, 'type': 'addresses_WT_ht'}, 'dst': {'same': False, 'congruent': 0, 'type': 'addresses_D_ht'}}
