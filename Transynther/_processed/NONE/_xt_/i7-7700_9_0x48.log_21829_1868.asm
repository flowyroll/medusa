...
nop
inc %r14
lea addresses_WC_ht+0x18b3b, %rsi
...
nop
and %r15, %r15
lea addresses_A_ht+0x1c9fb, %rcx
nop
nop
sub %r13, %r13
...
nop
sub $28359, %r13
lea addresses_WT_ht+0x71bb, %rsi
lea addresses_WC_ht+0x1531b, %rdi
nop
nop
nop
nop
...
nop
xor $32218, %rsi
lea addresses_UC_ht+0x118fb, %rcx
nop
nop
dec %r15
movl $0x61626364, (%rcx)
...
nop
cmp %rcx, %rcx
lea addresses_WC_ht+0x71fb, %rdi
nop
nop
nop
nop
