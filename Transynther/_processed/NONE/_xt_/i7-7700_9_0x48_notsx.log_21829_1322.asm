...
push %rdi
push %rsi
lea addresses_WT_ht+0xda03, %rsi
lea addresses_WT_ht+0xcfa3, %rdi
nop
nop
nop
nop
...
rep movsq
and $52289, %rcx
lea addresses_WC_ht+0xb71b, %rdi
and $43859, %r15
vmovups (%rdi), %ymm4
...
nop
and $51144, %rdi
lea addresses_WC_ht+0xebb3, %rcx
nop
nop
mfence
vmovups (%rcx), %ymm5
