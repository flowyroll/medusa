...
nop
sub %rcx, %rcx
lea addresses_normal_ht+0x147aa, %rax
nop
nop
nop
nop
...
lea addresses_WC_ht+0x46f2, %rdi
nop
nop
nop
nop
...
nop
dec %rdi
lea addresses_D_ht+0x88aa, %rsi
lea addresses_WT_ht+0x1ecaa, %rdi
clflush (%rsi)
nop
dec %r10
mov $34, %rcx
...
nop
cmp %r10, %r10
lea addresses_D_ht+0x14a0a, %rax
nop
nop
nop
nop
...
movq %rax, (%r14)
inc %rdi
lea addresses_WC_ht+0x30aa, %rsi
lea addresses_D_ht+0x1e8aa, %rdi
nop
nop
nop
nop
...
rep movsl
inc %r9
lea addresses_UC_ht+0xafea, %rdi
nop
cmp %r10, %r10
...
nop
and %rdi, %rdi
lea addresses_A_ht+0x1422d, %r14
dec %rbx
mov $0x6162636465666768, %r10
movq %r10, %xmm7
vmovups %ymm7, (%r14)
...
{'OP': 'STOR', 'dst': {'type': 'addresses_D_ht', 'AVXalign': False, 'congruent': 9, 'size': 2, 'same': False, 'NT': True}}
