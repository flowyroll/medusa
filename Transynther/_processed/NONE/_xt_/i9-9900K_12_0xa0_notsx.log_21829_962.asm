...
push %rdx
push %rsi
lea addresses_D_ht+0x16ab2, %rdx
and $53339, %r14
movb (%rdx), %al
nop
nop
nop
cmp $39754, %r10
lea addresses_WT_ht+0x201a, %rsi
lea addresses_normal_ht+0x7a2a, %rdi
nop
nop
add $16165, %rbp
mov $54, %rcx
rep movsq
xor $17129, %rcx
lea addresses_WC_ht+0xcf4e, %rax
nop
nop
nop
nop
...
nop
sub $39278, %rdi
lea addresses_WC_ht+0xed96, %rsi
lea addresses_WT_ht+0x496a, %rdi
nop
nop
nop
nop
...
nop
and %rcx, %rcx
lea addresses_UC_ht+0x1ac74, %rdx
nop
add $31246, %rdi
mov (%rdx), %r14d
nop
nop
and %rcx, %rcx
lea addresses_normal_ht+0x1f7a, %rsi
lea addresses_UC_ht+0x1278a, %rdi
cmp $30642, %r14
mov $28, %rcx
rep movsq
nop
xor %r14, %r14
lea addresses_UC_ht+0x931a, %rax
nop
nop
nop
nop
...
nop
add %rdx, %rdx
lea addresses_A_ht+0x1d4da, %rsi
sub $1904, %r14
...
{'src': {'type': 'addresses_US', 'AVXalign': False, 'size': 4, 'NT': False, 'same': False, 'congruent': 6}, 'OP': 'LOAD'}
[Faulty Load]
...
{'OP': 'STOR', 'dst': {'type': 'addresses_A_ht', 'AVXalign': False, 'size': 32, 'NT': False, 'same': True, 'congruent': 5}}
{'32': 21829}
