...
nop
cmp %r13, %r13
lea addresses_normal_ht+0xd0c3, %rdi
dec %r13
...
nop
add $18432, %rbx
lea addresses_normal_ht+0x18ec3, %rcx
nop
nop
nop
and %rbx, %rbx
...
nop
sub %r9, %r9
lea addresses_WT_ht+0x18fc3, %rdi
nop
nop
nop
nop
...
nop
and %rsi, %rsi
lea addresses_WT_ht+0xb04b, %rdi
nop
nop
sub $50277, %rbx
vmovups (%rdi), %ymm5
...
nop
cmp $48647, %r9
lea addresses_WT_ht+0x10cc3, %rsi
lea addresses_UC_ht+0x419b, %rdi
inc %r15
mov $49, %rcx
rep movsw
nop
...
nop
cmp $33417, %rsi
lea addresses_D_ht+0x1c543, %rsi
lea addresses_A_ht+0x6883, %rdi
clflush (%rdi)
nop
nop
nop
...
nop
sub $48395, %r13
lea addresses_normal_ht+0x1ece2, %r15
nop
nop
nop
xor $17618, %r9
...
nop
sub %rcx, %rcx
lea addresses_WC_ht+0x1e0c3, %rbx
nop
nop
cmp %r9, %r9
mov $0x6162636465666768, %rdi
