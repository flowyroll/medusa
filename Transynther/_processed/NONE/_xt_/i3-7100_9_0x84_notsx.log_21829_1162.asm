...
nop
cmp %r15, %r15
lea addresses_WC_ht+0x15ab8, %rdi
nop
nop
nop
add $20557, %rcx
...
nop
add %rdi, %rdi
lea addresses_WT_ht+0x8145, %r15
nop
nop
nop
nop
...
nop
and %r14, %r14
lea addresses_WT_ht+0xec45, %rsi
lea addresses_A_ht+0xf185, %rdi
clflush (%rdi)
xor $24762, %r10
mov $30, %rcx
rep movsb
nop
xor %r12, %r12
lea addresses_D_ht+0x1b405, %r11
nop
nop
nop
nop
