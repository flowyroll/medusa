...
push %rdi
push %rsi
lea addresses_WT_ht+0x1907e, %rbp
nop
nop
inc %r9
vmovups (%rbp), %ymm7
...
nop
add %rdi, %rdi
lea addresses_D_ht+0x4403, %rsi
lea addresses_WT_ht+0x1afdf, %rdi
nop
nop
nop
nop
...
nop
lfence
lea addresses_normal_ht+0x1e95f, %rsi
lea addresses_normal_ht+0x1265f, %rdi
clflush (%rdi)
nop
nop
nop
...
nop
cmp $55082, %rcx
lea addresses_WC_ht+0x193df, %r9
nop
nop
add $37458, %rbp
...
nop
cmp $1000, %r9
lea addresses_UC_ht+0x15fbf, %r9
dec %rcx
mov (%r9), %si
nop
cmp $49939, %r9
lea addresses_WT_ht+0x4a5f, %rsi
lea addresses_WC_ht+0x19bad, %rdi
nop
nop
xor %rbp, %rbp
mov $82, %rcx
...
nop
cmp $8284, %rdi
lea addresses_WT_ht+0x11aff, %rsi
lea addresses_A_ht+0xce5f, %rdi
clflush (%rsi)
nop
nop
nop
...
rep movsq
add $19448, %r14
lea addresses_WT_ht+0x116df, %rsi
nop
nop
nop
dec %r14
...
nop
sub $11569, %rdi
lea addresses_WC_ht+0x865f, %r14
nop
nop
sub %rsi, %rsi
mov (%r14), %cx
add %rdi, %rdi
lea addresses_UC_ht+0x1de5f, %rbp
cmp $45111, %rsi
movb $0x61, (%rbp)
nop
nop
...
nop
xor $10031, %r11
lea addresses_WC_ht+0xea73, %rsi
lea addresses_A_ht+0xbf0f, %rdi
cmp %r11, %r11
mov $3, %rcx
rep movsl
nop
...
nop
and $29123, %r14
lea addresses_normal_ht+0x12ffb, %r14
inc %rcx
mov (%r14), %r9d
nop
nop
...
{'src': {'type': 'addresses_normal_ht', 'congruent': 8, 'same': False}, 'dst': {'type': 'addresses_normal_ht', 'congruent': 8, 'same': False}, 'OP': 'REPM'}
...
{'src': {'type': 'addresses_WC_ht', 'same': True, 'size': 2, 'congruent': 11, 'NT': False, 'AVXalign': False}, 'OP': 'LOAD'}
