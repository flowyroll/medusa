...
push %rdi
push %rsi
lea addresses_WC_ht+0xc049, %r11
nop
nop
nop
nop
...
mov (%r11), %di
sub %rcx, %rcx
lea addresses_UC_ht+0x1e5b9, %rsi
lea addresses_normal_ht+0x1d049, %rdi
clflush (%rdi)
nop
nop
nop
...
nop
dec %rbx
lea addresses_WC_ht+0x69e1, %rsi
lea addresses_normal_ht+0x1ae09, %rdi
nop
nop
nop
inc %rax
...
vpextrq $0, %xmm5, %rsi
add $27489, %rdi
lea addresses_WT_ht+0xe0f1, %rbp
cmp %rcx, %rcx
movb (%rbp), %r11b
nop
nop
nop
add $13684, %rsi
lea addresses_UC_ht+0xd449, %rax
clflush (%rax)
nop
nop
nop
...
{'src': {'type': 'addresses_UC_ht', 'congruent': 4, 'same': False}, 'OP': 'REPM', 'dst': {'type': 'addresses_normal_ht', 'congruent': 8, 'same': False}}
{'src': {'type': 'addresses_WC_ht', 'congruent': 3, 'same': False}, 'OP': 'REPM', 'dst': {'type': 'addresses_normal_ht', 'congruent': 5, 'same': True}}
