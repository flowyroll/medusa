...
push %rdx
push %rsi
lea addresses_WC_ht+0x18e83, %r10
dec %rax
movw $0x6162, (%r10)
nop
xor $59095, %r12
lea addresses_A_ht+0x3ea3, %rdi
nop
nop
cmp %rdx, %rdx
mov (%rdi), %r11w
...
nop
and $42406, %rdi
lea addresses_WT_ht+0xe201, %rsi
lea addresses_WC_ht+0x69a3, %rdi
nop
nop
xor %rdx, %rdx
mov $34, %rcx
...
nop
cmp $25765, %r10
lea addresses_WC_ht+0x9a8d, %r12
nop
nop
nop
nop
...
nop
add %rcx, %rcx
lea addresses_WC_ht+0xfcb3, %rsi
lea addresses_A_ht+0xe63b, %rdi
nop
and $17890, %rdx
mov $84, %rcx
rep movsq
nop
and %r14, %r14
lea addresses_normal_ht+0x79b3, %rax
and %r10, %r10
mov (%rax), %ecx
nop
nop
xor %r10, %r10
lea addresses_normal_ht+0xa063, %rdi
nop
nop
nop
add %rdx, %rdx
...
vpextrq $1, %xmm3, %r14
sub %rsi, %rsi
lea addresses_UC_ht+0x1c793, %rsi
lea addresses_UC_ht+0x165e3, %rdi
nop
nop
nop
add %r12, %r12
...
nop
inc %rdx
lea addresses_WT_ht+0x100d3, %rdi
clflush (%rdi)
nop
add $11121, %rdx
movw $0x6162, (%rdi)
...
nop
and %rdx, %rdx
lea addresses_UC_ht+0x1250d, %rsi
lea addresses_WC_ht+0xac63, %rdi
nop
nop
nop
nop
...
nop
cmp %rdx, %rdx
lea addresses_WT_ht+0x2c63, %rdi
nop
nop
inc %rsi
mov (%rdi), %r11d
...
{'OP': 'LOAD', 'src': {'type': 'addresses_WC_ht', 'size': 4, 'AVXalign': False, 'NT': False, 'congruent': 1, 'same': True}}
{'OP': 'REPM', 'src': {'type': 'addresses_WC_ht', 'congruent': 4, 'same': False}, 'dst': {'type': 'addresses_A_ht', 'congruent': 3, 'same': False}}
{'OP': 'LOAD', 'src': {'type': 'addresses_normal_ht', 'size': 4, 'AVXalign': True, 'NT': False, 'congruent': 2, 'same': True}}
...
{'OP': 'STOR', 'dst': {'type': 'addresses_WT_ht', 'size': 2, 'AVXalign': True, 'NT': False, 'congruent': 3, 'same': False}}
