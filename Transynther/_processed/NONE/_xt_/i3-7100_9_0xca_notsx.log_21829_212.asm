...
push %rdx
push %rsi
lea addresses_UC_ht+0x2e2a, %r14
nop
nop
nop
nop
...
nop
xor %rdi, %rdi
lea addresses_WC_ht+0x183e2, %rsi
lea addresses_D_ht+0xaf4a, %rdi
nop
add $3491, %r11
mov $30, %rcx
rep movsl
...
// Store
lea addresses_normal+0x180d2, %r12
nop
nop
nop
nop
...
{'src': {'type': 'addresses_WC_ht', 'congruent': 3, 'same': True}, 'OP': 'REPM', 'dst': {'type': 'addresses_D_ht', 'congruent': 9, 'same': True}}
{'38': 21829}
