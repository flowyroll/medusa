...
push %rdx
push %rsi
lea addresses_normal_ht+0x12570, %rsi
lea addresses_normal_ht+0x16b74, %rdi
cmp %rdx, %rdx
mov $25, %rcx
rep movsq
nop
sub $45404, %r10
lea addresses_normal_ht+0xcb5c, %rsi
lea addresses_UC_ht+0x7491, %rdi
nop
add $7862, %r8
mov $28, %rcx
rep movsb
...
nop
cmp %rcx, %rcx
lea addresses_normal_ht+0x1e1f4, %rcx
nop
nop
nop
sub %r10, %r10
...
nop
xor %r10, %r10
lea addresses_UC_ht+0x92c8, %rdx
nop
nop
nop
nop
...
nop
lfence
lea addresses_D_ht+0x1d7f4, %rdx
xor $56283, %rax
movb (%rdx), %r10b
sub $19627, %rsi
lea addresses_UC_ht+0xf574, %r10
nop
nop
sub $14325, %rsi
movb $0x61, (%r10)
...
lea addresses_D_ht+0x11d6c, %rdi
clflush (%rdi)
nop
nop
sub %rax, %rax
...
nop
inc %rdi
lea addresses_A_ht+0x14f54, %rsi
lea addresses_D_ht+0x7a64, %rdi
nop
nop
dec %r12
mov $120, %rcx
...
{'src': {'type': 'addresses_UC_ht', 'congruent': 9, 'same': False}, 'OP': 'REPM', 'dst': {'type': 'addresses_D_ht', 'congruent': 1, 'same': False}}
{'src': {'type': 'addresses_A_ht', 'congruent': 5, 'same': False}, 'OP': 'REPM', 'dst': {'type': 'addresses_D_ht', 'congruent': 2, 'same': False}}
{'39': 21829}
