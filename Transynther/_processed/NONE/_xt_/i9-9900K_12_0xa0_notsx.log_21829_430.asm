...
push %rdi
push %rsi
lea addresses_D_ht+0x1c401, %rax
nop
sub $41911, %r9
movb (%rax), %r11b
nop
nop
add $5078, %r10
lea addresses_WC_ht+0x178c1, %rsi
...
nop
dec %r11
lea addresses_WC_ht+0x12981, %r10
nop
nop
nop
nop
...
movups %xmm2, (%r10)
dec %rax
lea addresses_WT_ht+0xe2c1, %rsi
lea addresses_A_ht+0x2741, %rdi
dec %r15
mov $107, %rcx
rep movsw
nop
...
nop
xor %rax, %rax
lea addresses_A_ht+0x688b, %rsi
lea addresses_normal_ht+0xa4c1, %rdi
nop
cmp $64724, %r15
mov $122, %rcx
rep movsw
inc %r10
lea addresses_UC_ht+0x1c401, %r10
clflush (%r10)
nop
nop
nop
...
nop
dec %rdi
lea addresses_WC_ht+0xccc1, %r11
nop
nop
nop
nop
...
nop
xor %r10, %r10
lea addresses_A_ht+0x1e4c1, %r11
nop
nop
nop
and %rcx, %rcx
...
nop
and %r10, %r10
lea addresses_normal_ht+0x2c1, %r10
nop
nop
cmp $12074, %r15
vmovups (%r10), %ymm3
...
// Faulty Load
lea addresses_normal+0xa4c1, %r12
sub %r9, %r9
movb (%r12), %r14b
lea oracles, %r9
and $0xff, %r14
...
{'src': {'type': 'addresses_WT_ht', 'congruent': 9, 'same': False}, 'OP': 'REPM', 'dst': {'type': 'addresses_A_ht', 'congruent': 6, 'same': True}}
{'OP': 'STOR', 'dst': {'type': 'addresses_D_ht', 'AVXalign': True, 'size': 2, 'NT': False, 'same': False, 'congruent': 0}}
