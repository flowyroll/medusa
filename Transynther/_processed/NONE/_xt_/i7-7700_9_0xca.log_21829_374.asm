...
push %rdi
push %rsi
lea addresses_UC_ht+0x40d1, %r15
nop
nop
and $43020, %r10
movw $0x6162, (%r15)
dec %r12
lea addresses_D_ht+0x12f11, %r15
nop
nop
nop
nop
...
nop
cmp %r15, %r15
lea addresses_WC_ht+0x196d0, %r15
nop
nop
nop
nop
...
mov (%r15), %r10d
xor $14980, %r12
lea addresses_D_ht+0x17f0d, %r15
nop
nop
nop
add $37463, %r12
...
nop
sub %r15, %r15
lea addresses_WT_ht+0x1011, %r12
nop
add $2058, %r15
vmovups (%r12), %ymm6
...
nop
xor $30603, %r10
lea addresses_UC_ht+0x2e11, %rsi
lea addresses_A_ht+0x891, %rdi
nop
nop
sub $394, %r12
mov $52, %rcx
...
nop
sub $40350, %r15
lea addresses_WT_ht+0x714d, %rbx
nop
sub %rdi, %rdi
mov $0x6162636465666768, %r12
movq %r12, %xmm0
...
nop
sub %rbp, %rbp
lea addresses_WC_ht+0x3411, %rdi
nop
nop
nop
dec %rsi
...
lea addresses_WC_ht+0x1b121, %rdi
nop
nop
nop
cmp %r10, %r10
...
nop
add %rbx, %rbx
lea addresses_normal_ht+0x3655, %rsi
...
// Faulty Load
lea addresses_normal+0xfc11, %r10
nop
cmp %rbp, %rbp
vmovups (%r10), %ymm3
...
{'src': {'congruent': 1, 'AVXalign': False, 'same': False, 'size': 32, 'NT': True, 'type': 'addresses_D_ht'}, 'OP': 'LOAD'}
...
{'src': {'congruent': 9, 'same': False, 'type': 'addresses_UC_ht'}, 'OP': 'REPM', 'dst': {'congruent': 7, 'same': False, 'type': 'addresses_A_ht'}}
{'src': {'congruent': 6, 'AVXalign': False, 'same': True, 'size': 8, 'NT': False, 'type': 'addresses_A_ht'}, 'OP': 'LOAD'}
