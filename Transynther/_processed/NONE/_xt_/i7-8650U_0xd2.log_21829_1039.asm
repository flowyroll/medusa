...
push %rdi
push %rsi
lea addresses_normal_ht+0x19414, %rsi
lea addresses_WT_ht+0x8294, %rdi
clflush (%rsi)
nop
nop
nop
...
nop
xor $41008, %rbp
lea addresses_UC_ht+0x15794, %r13
nop
nop
nop
nop
...
nop
add $25948, %r13
lea addresses_normal_ht+0xe194, %rbp
nop
nop
nop
nop
...
nop
and %rsi, %rsi
lea addresses_WC_ht+0x13f54, %r11
nop
nop
nop
and %rdi, %rdi
...
nop
add $55243, %rbx
lea addresses_WC_ht+0x1454, %rcx
and %rsi, %rsi
...
nop
sub $31282, %r13
lea addresses_normal_ht+0x6b94, %rsi
lea addresses_A_ht+0xe4a4, %rdi
nop
nop
nop
mfence
...
// Faulty Load
lea addresses_normal+0x1ef94, %r11
nop
nop
nop
nop
...
{'OP': 'REPM', 'src': {'type': 'addresses_normal_ht', 'congruent': 8, 'same': True}, 'dst': {'type': 'addresses_A_ht', 'congruent': 4, 'same': True}}
