...
nop
sub $5364, %rdi
lea addresses_UC_ht+0x911c, %rdx
nop
nop
nop
nop
...
vpextrq $1, %xmm3, %rax
dec %rax
lea addresses_normal_ht+0x1731c, %rsi
lea addresses_WT_ht+0x197ea, %rdi
xor $16923, %r14
mov $111, %rcx
rep movsw
nop
...
lea addresses_WT_ht+0x10cf4, %rdi
clflush (%rdi)
nop
nop
nop
...
rep movsb
lfence
lea addresses_normal_ht+0x1351c, %rax
nop
nop
nop
nop
...
nop
sub $25566, %rsi
lea addresses_A_ht+0x1041c, %r14
nop
and %rax, %rax
...
nop
lfence
lea addresses_WC_ht+0x18265, %r8
nop
nop
nop
and %r10, %r10
...
nop
dec %rax
lea addresses_WT_ht+0x1958c, %r8
nop
xor %r10, %r10
...
nop
cmp $10865, %rsi
lea addresses_A_ht+0x1931c, %rsi
lea addresses_D_ht+0x1c6ac, %rdi
nop
nop
nop
nop
...
// Store
lea addresses_normal+0x7723, %r12
cmp %r8, %r8
...
{'OP': 'STOR', 'dst': {'type': 'addresses_D', 'AVXalign': True, 'congruent': 2, 'size': 2, 'same': False, 'NT': False}}
...
{'OP': 'STOR', 'dst': {'type': 'addresses_WC_ht', 'AVXalign': False, 'congruent': 7, 'size': 1, 'same': True, 'NT': False}}
...
{'OP': 'REPM', 'src': {'type': 'addresses_WT_ht', 'congruent': 6, 'same': False}, 'dst': {'type': 'addresses_WT_ht', 'congruent': 2, 'same': False}}
...
{'OP': 'STOR', 'dst': {'type': 'addresses_WC_ht', 'AVXalign': True, 'congruent': 0, 'size': 4, 'same': True, 'NT': False}}
