...
push %rdx
push %rsi
lea addresses_WT_ht+0x1b8a5, %r12
nop
dec %r14
movb (%r12), %r11b
nop
...
nop
dec %r9
lea addresses_UC_ht+0x140a5, %rdx
nop
nop
xor $56571, %rax
mov (%rdx), %ebx
nop
xor %r12, %r12
lea addresses_normal_ht+0x1aee5, %rsi
lea addresses_WT_ht+0x1e325, %rdi
nop
nop
nop
dec %r9
...
<gen_prepare_buffer>
{'OP': 'LOAD', 'src': {'type': 'addresses_WT_ht', 'AVXalign': False, 'congruent': 10, 'size': 1, 'same': False, 'NT': True}}
