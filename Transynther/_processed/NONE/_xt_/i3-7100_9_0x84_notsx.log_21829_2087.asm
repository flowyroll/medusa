...
push %rdi
push %rsi
lea addresses_WT_ht+0x16ccf, %rsi
lea addresses_WT_ht+0xba73, %rdi
nop
nop
nop
xor $64310, %r8
...
nop
and %r13, %r13
lea addresses_normal_ht+0x8f4f, %rsi
lea addresses_A_ht+0xaf9f, %rdi
nop
nop
nop
sub %r9, %r9
...
nop
add %rsi, %rsi
lea addresses_normal_ht+0x529f, %r8
add %r9, %r9
movw $0x6162, (%r8)
nop
nop
...
nop
add $14609, %rsi
lea addresses_A_ht+0xe467, %rsi
lea addresses_D_ht+0x1529f, %rdi
inc %r12
mov $37, %rcx
rep movsw
nop
...
nop
and $40979, %r9
lea addresses_WC_ht+0x1589f, %rsi
lea addresses_A_ht+0x1c10f, %rdi
clflush (%rsi)
sub %r11, %r11
mov $106, %rcx
rep movsq
...
nop
sub $29954, %rdi
lea addresses_normal_ht+0x16d63, %r12
nop
nop
dec %rsi
movl $0x61626364, (%r12)
...
nop
sub $22953, %rdi
lea addresses_WT_ht+0x17c0f, %rsi
...
nop
cmp %r12, %r12
lea addresses_A_ht+0x1369f, %r12
nop
nop
nop
nop
...
nop
xor $49949, %r9
lea addresses_UC_ht+0x14e9f, %r8
add $30190, %rsi
movb $0x61, (%r8)
nop
nop
...
nop
xor $64363, %r11
lea addresses_WC_ht+0x1049f, %rdi
nop
nop
nop
nop
...
movw $0x6162, (%rcx)
and %r12, %r12
lea addresses_UC_ht+0x1e637, %rsi
lea addresses_WT_ht+0x1a2ff, %rdi
clflush (%rsi)
nop
nop
nop
...
<gen_prepare_buffer>
{'src': {'type': 'addresses_WT_ht', 'congruent': 4, 'same': False}, 'dst': {'type': 'addresses_WT_ht', 'congruent': 2, 'same': False}, 'OP': 'REPM'}
...
{'src': {'type': 'addresses_A_ht', 'congruent': 3, 'same': True}, 'dst': {'type': 'addresses_D_ht', 'congruent': 10, 'same': False}, 'OP': 'REPM'}
