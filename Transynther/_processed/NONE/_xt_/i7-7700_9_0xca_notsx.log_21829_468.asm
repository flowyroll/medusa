...
nop
and $62467, %r14
lea addresses_normal_ht+0x8a2e, %r15
clflush (%r15)
nop
nop
add %rbx, %rbx
...
nop
add $42074, %r15
lea addresses_normal_ht+0xc6e, %rsi
nop
nop
nop
nop
...
nop
add %rbx, %rbx
lea addresses_UC_ht+0xdc6e, %r15
clflush (%r15)
nop
nop
nop
...
mov (%r15), %rsi
xor %r9, %r9
lea addresses_WT_ht+0xc50e, %rbx
nop
nop
and $63758, %rsi
movb (%rbx), %al
...
nop
cmp $685, %rsi
lea addresses_normal_ht+0x10522, %rdi
nop
dec %rsi
mov (%rdi), %ax
nop
inc %r15
lea addresses_WC_ht+0xf26e, %r14
nop
nop
dec %rsi
movw $0x6162, (%r14)
...
// Load
lea addresses_normal+0xab16, %rbx
nop
and %r14, %r14
movb (%rbx), %cl
dec %rbp
...
{'src': {'NT': False, 'AVXalign': False, 'size': 1, 'congruent': 1, 'same': False, 'type': 'addresses_normal'}, 'OP': 'LOAD'}
...
{'src': {'NT': False, 'AVXalign': True, 'size': 4, 'congruent': 6, 'same': False, 'type': 'addresses_normal_ht'}, 'OP': 'LOAD'}
...
{'src': {'congruent': 8, 'same': False, 'type': 'addresses_WT_ht'}, 'dst': {'congruent': 2, 'same': False, 'type': 'addresses_A_ht'}, 'OP': 'REPM'}
{'37': 21829}
