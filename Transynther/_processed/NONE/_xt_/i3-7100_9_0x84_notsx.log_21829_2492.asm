...
nop
xor %r11, %r11
lea addresses_WC_ht+0x1df2d, %rax
nop
nop
nop
xor $59845, %r8
...
nop
add $3305, %rax
lea addresses_normal_ht+0x1d5bd, %rbp
clflush (%rbp)
nop
nop
nop
...
nop
dec %r11
lea addresses_UC_ht+0xc87d, %rax
nop
nop
nop
nop
...
nop
cmp $56399, %rax
lea addresses_normal_ht+0x8f7d, %rbp
nop
nop
nop
nop
...
nop
dec %rcx
lea addresses_normal_ht+0x69fd, %r12
nop
nop
nop
nop
...
nop
and $7314, %r11
lea addresses_D_ht+0x1007d, %rcx
nop
nop
nop
sub %r12, %r12
...
nop
dec %r8
lea addresses_normal_ht+0x185bd, %rax
nop
nop
nop
and $15353, %rcx
...
nop
add $53686, %r8
lea addresses_D_ht+0xfc43, %rsi
lea addresses_WT_ht+0xa1bd, %rdi
nop
nop
nop
nop
...
nop
inc %rdi
lea addresses_A_ht+0x15a5d, %rdi
nop
nop
nop
and %rsi, %rsi
...
nop
dec %rsi
lea addresses_WT_ht+0x14abd, %rcx
nop
nop
nop
xor %rsi, %rsi
...
nop
xor %r11, %r11
lea addresses_D_ht+0xbb3d, %rsi
lea addresses_normal_ht+0x78a9, %rdi
cmp $58617, %rax
mov $2, %rcx
rep movsw
add %r12, %r12
...
{'src': {'type': 'addresses_normal_ht', 'same': False, 'size': 2, 'congruent': 6, 'NT': False, 'AVXalign': True}, 'OP': 'LOAD'}
...
{'src': {'type': 'addresses_D_ht', 'congruent': 1, 'same': False}, 'dst': {'type': 'addresses_WT_ht', 'congruent': 8, 'same': False}, 'OP': 'REPM'}
