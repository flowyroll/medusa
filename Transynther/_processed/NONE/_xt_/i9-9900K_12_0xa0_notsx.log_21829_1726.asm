...
push %rdx
push %rsi
lea addresses_A_ht+0x2268, %r10
nop
xor $2761, %r8
mov (%r10), %dx
nop
cmp %r12, %r12
lea addresses_normal_ht+0xd600, %rsi
...
nop
cmp %r12, %r12
lea addresses_normal_ht+0xfcc8, %rsi
lea addresses_A_ht+0x7408, %rdi
nop
and $28652, %r10
mov $105, %rcx
rep movsl
...
nop
and %rdx, %rdx
lea addresses_A_ht+0x1911f, %rsi
lea addresses_normal_ht+0x13068, %rdi
nop
nop
nop
inc %rdx
...
nop
cmp %r10, %r10
lea addresses_D_ht+0x1e8c4, %rdx
add %rdi, %rdi
mov (%rdx), %r13w
nop
cmp %rcx, %rcx
lea addresses_WC_ht+0x3008, %r10
nop
nop
and %rdi, %rdi
...
nop
cmp $17453, %rdx
lea addresses_WC_ht+0xe808, %r13
clflush (%r13)
nop
nop
sub $64354, %r10
...
// Faulty Load
lea addresses_normal+0x15808, %rsi
nop
nop
add $13447, %r15
mov (%rsi), %ebx
...
{'src': {'type': 'addresses_normal_ht', 'congruent': 3, 'same': False}, 'OP': 'REPM', 'dst': {'type': 'addresses_WC_ht', 'congruent': 3, 'same': False}}
