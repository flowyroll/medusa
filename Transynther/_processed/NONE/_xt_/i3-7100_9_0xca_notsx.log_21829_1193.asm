...
push %rdi
push %rsi
lea addresses_WT_ht+0x1bdf1, %r15
nop
nop
nop
nop
...
nop
and %rax, %rax
lea addresses_A_ht+0xfe0b, %rsi
lea addresses_normal_ht+0x179b, %rdi
add %r15, %r15
mov $39, %rcx
rep movsb
nop
...
nop
cmp %rsi, %rsi
lea addresses_WC_ht+0x1f0b, %rdi
nop
nop
lfence
mov (%rdi), %r14w
...
nop
dec %rax
lea addresses_normal_ht+0x3512, %rsi
lea addresses_normal_ht+0xcb0b, %rdi
nop
nop
nop
nop
...
<gen_prepare_buffer>
{'src': {'same': False, 'congruent': 1, 'NT': False, 'type': 'addresses_WT_ht', 'size': 4, 'AVXalign': True}, 'OP': 'LOAD'}
{'src': {'type': 'addresses_A_ht', 'congruent': 8, 'same': True}, 'OP': 'REPM', 'dst': {'type': 'addresses_normal_ht', 'congruent': 4, 'same': False}}
