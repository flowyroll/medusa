...
nop
sub $8467, %rcx
lea addresses_WC_ht+0xb786, %rcx
nop
nop
add $5782, %r12
movw $0x6162, (%rcx)
...
nop
cmp %rbx, %rbx
lea addresses_normal_ht+0x1be06, %rax
nop
nop
nop
nop
...
nop
and %r14, %r14
lea addresses_WT_ht+0xa3c6, %rsi
lea addresses_normal_ht+0x1d058, %rdi
sub $19452, %r15
mov $28, %rcx
rep movsb
xor %rcx, %rcx
lea addresses_UC_ht+0x1b36e, %r15
xor %rax, %rax
