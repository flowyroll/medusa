...
push %rdx
push %rsi
lea addresses_WT_ht+0x2075, %rbx
nop
lfence
mov (%rbx), %r12
nop
sub $40326, %r15
lea addresses_D_ht+0x9d55, %rsi
lea addresses_normal_ht+0x1865, %rdi
cmp %r8, %r8
mov $50, %rcx
rep movsw
nop
...
nop
add $36287, %r12
lea addresses_WT_ht+0x35d5, %rsi
lea addresses_WT_ht+0x9695, %rdi
nop
sub $57685, %rdx
mov $95, %rcx
rep movsl
...
nop
add $55934, %r15
lea addresses_WC_ht+0x1b9e5, %rdi
and %r8, %r8
...
nop
sub %r15, %r15
lea addresses_normal_ht+0x6b95, %rdx
nop
inc %rsi
movb $0x61, (%rdx)
nop
