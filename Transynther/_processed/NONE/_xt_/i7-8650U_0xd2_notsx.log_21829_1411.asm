...
push %rdx
push %rsi
lea addresses_D_ht+0x18818, %rsi
lea addresses_D_ht+0x1c5a8, %rdi
nop
cmp $46111, %r8
mov $18, %rcx
rep movsb
...
nop
add %r14, %r14
lea addresses_A_ht+0x19ed8, %rsi
nop
nop
nop
nop
...
nop
sub %r8, %r8
lea addresses_WT_ht+0x15c18, %r8
and $1951, %rdx
vmovups (%r8), %ymm6
...
nop
xor %rsi, %rsi
lea addresses_UC_ht+0x19400, %rsi
nop
nop
sub %rcx, %rcx
movups (%rsi), %xmm5
...
nop
xor $59645, %rdi
lea addresses_UC_ht+0x18118, %r8
clflush (%r8)
add %r14, %r14
movw $0x6162, (%r8)
nop
nop
add $60611, %r14
lea addresses_A_ht+0x1e418, %rdx
nop
nop
nop
nop
...
nop
xor %rcx, %rcx
lea addresses_WC_ht+0xc920, %rsi
nop
and %r8, %r8
movl $0x61626364, (%rsi)
nop
...
nop
xor %rdi, %rdi
lea addresses_D_ht+0x15a6c, %rsi
xor $42855, %rdx
movw $0x6162, (%rsi)
nop
nop
...
nop
inc %rsi
lea addresses_UC_ht+0x5dd8, %rdx
nop
and %r14, %r14
mov (%rdx), %rcx
nop
