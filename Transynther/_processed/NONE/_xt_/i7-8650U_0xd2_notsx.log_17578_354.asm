...
push %rdx
push %rsi
lea addresses_A_ht+0x1d8a0, %rsi
lea addresses_UC_ht+0x19a73, %rdi
nop
nop
nop
nop
...
nop
sub %r12, %r12
lea addresses_A_ht+0x620, %rcx
cmp %rdx, %rdx
mov (%rcx), %r12d
nop
and $53443, %r12
lea addresses_WT_ht+0x9620, %rsi
lea addresses_D_ht+0x6cd8, %rdi
clflush (%rdi)
nop
nop
nop
...
nop
and $33359, %rbp
lea addresses_WC_ht+0x190c8, %r15
nop
nop
cmp $29899, %rdx
mov (%r15), %r12d
...
nop
and $49266, %r15
lea addresses_WC_ht+0x1012c, %rsi
lea addresses_UC_ht+0x16138, %rdi
nop
nop
nop
nop
...
nop
xor $63739, %rdi
lea addresses_WC_ht+0x6c20, %rsi
nop
nop
nop
nop
...
movw $0x6162, (%rsi)
dec %rcx
lea addresses_normal_ht+0x1420, %rcx
nop
nop
nop
cmp %r11, %r11
mov (%rcx), %edi
add %rdi, %rdi
lea addresses_WT_ht+0x18620, %rbp
nop
nop
nop
nop
...
{'OP': 'REPM', 'src': {'type': 'addresses_WT_ht', 'congruent': 11, 'same': False}, 'dst': {'type': 'addresses_D_ht', 'congruent': 2, 'same': True}}
...
{'OP': 'STOR', 'dst': {'type': 'addresses_WC_ht', 'size': 2, 'AVXalign': True, 'NT': False, 'congruent': 7, 'same': True}}
