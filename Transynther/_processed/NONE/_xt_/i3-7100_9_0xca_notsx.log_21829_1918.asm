...
push %rdx
push %rsi
lea addresses_normal_ht+0xa7ad, %rax
and $42183, %r15
movb $0x61, (%rax)
nop
nop
nop
sub %rcx, %rcx
lea addresses_normal_ht+0xef55, %r8
xor $6759, %rdi
vmovups (%r8), %ymm1
...
nop
xor $55217, %rdx
lea addresses_D_ht+0x1296d, %rsi
lea addresses_UC_ht+0x10f8d, %rdi
nop
nop
nop
cmp $23789, %rax
...
nop
inc %rdx
lea addresses_WC_ht+0x1b00d, %r15
add %rdi, %rdi
...
nop
xor $7018, %rdi
lea addresses_D_ht+0xec8d, %rsi
lea addresses_UC_ht+0xc38d, %rdi
nop
nop
and $162, %rbp
mov $57, %rcx
...
nop
and %rax, %rax
lea addresses_A_ht+0x608d, %rsi
lea addresses_D_ht+0x608d, %rdi
nop
nop
nop
nop
...
nop
sub %rax, %rax
lea addresses_WC_ht+0x4fbd, %rdx
nop
nop
nop
sub $23768, %r8
...
lea addresses_D_ht+0x15a8d, %rdi
nop
nop
nop
sub $56891, %rax
...
nop
cmp %rcx, %rcx
lea addresses_WC_ht+0x1bb4d, %rsi
lea addresses_WC_ht+0x4b8d, %rdi
nop
nop
nop
cmp $46923, %rdx
...
nop
and %rdx, %rdx
lea addresses_WC_ht+0x2bcd, %rsi
lea addresses_UC_ht+0x17e8d, %rdi
nop
cmp %rdx, %rdx
mov $45, %rcx
rep movsw
...
{'src': {'type': 'addresses_A_ht', 'congruent': 7, 'same': False}, 'OP': 'REPM', 'dst': {'type': 'addresses_D_ht', 'congruent': 6, 'same': False}}
...
{'src': {'type': 'addresses_WC_ht', 'congruent': 4, 'same': False}, 'OP': 'REPM', 'dst': {'type': 'addresses_UC_ht', 'congruent': 8, 'same': False}}
