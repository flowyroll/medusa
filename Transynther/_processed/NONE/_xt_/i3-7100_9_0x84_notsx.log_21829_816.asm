...
push %rdi
push %rsi
lea addresses_WC_ht+0x10447, %rbp
nop
dec %rax
...
nop
inc %rax
lea addresses_A_ht+0x19c87, %r12
nop
sub %r10, %r10
movl $0x61626364, (%r12)
cmp %r10, %r10
lea addresses_A_ht+0xdd69, %rsi
lea addresses_WC_ht+0x5e87, %rdi
dec %r9
mov $18, %rcx
rep movsb
nop
...
nop
inc %rax
lea addresses_UC_ht+0x1deeb, %rsi
lea addresses_UC_ht+0x19c87, %rdi
nop
nop
nop
add %r12, %r12
...
nop
cmp %r12, %r12
lea addresses_A_ht+0x1a887, %rbp
nop
nop
xor %r9, %r9
movb (%rbp), %r12b
...
nop
add $53113, %rdi
lea addresses_UC_ht+0x12a97, %rsi
