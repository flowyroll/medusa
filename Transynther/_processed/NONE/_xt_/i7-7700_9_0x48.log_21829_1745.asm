...
push %rdx
push %rsi
lea addresses_WT_ht+0x8afd, %rbx
nop
nop
nop
nop
...
nop
xor %r8, %r8
lea addresses_WT_ht+0x84b3, %rsi
nop
nop
nop
nop
...
nop
cmp $55471, %r8
lea addresses_normal_ht+0x116fd, %r15
nop
nop
nop
sub %r13, %r13
...
nop
cmp $22421, %rbx
lea addresses_WT_ht+0x162fd, %r13
nop
nop
nop
nop
...
nop
and %r8, %r8
lea addresses_WC_ht+0xe5fd, %rbx
nop
nop
nop
add $29696, %r13
...
nop
sub %r13, %r13
lea addresses_D_ht+0x13cbd, %rdx
nop
nop
cmp $45924, %r8
...
nop
and $23995, %rax
lea addresses_A_ht+0x418e, %rsi
lea addresses_A_ht+0x102fd, %rdi
nop
nop
nop
nop
...
// Faulty Load
lea addresses_normal+0x192fd, %r13
nop
sub %rcx, %rcx
movb (%r13), %bl
lea oracles, %r9
...
{'OP': 'LOAD', 'src': {'type': 'addresses_WC', 'AVXalign': False, 'congruent': 11, 'size': 4, 'same': False, 'NT': False}}
