...
push %rdx
push %rsi
lea addresses_UC_ht+0x12305, %r12
add $11569, %rdx
movb $0x61, (%r12)
xor %rdi, %rdi
lea addresses_A_ht+0xbe85, %r14
clflush (%r14)
nop
cmp %rsi, %rsi
mov (%r14), %r10d
xor $39022, %r10
lea addresses_A_ht+0x13ccd, %r9
nop
nop
nop
nop
