...
nop
xor %rsi, %rsi
lea addresses_D_ht+0x1b72e, %r10
nop
nop
nop
inc %rdi
...
nop
dec %r9
lea addresses_WC_ht+0xd26e, %r12
nop
nop
nop
xor $52648, %r8
...
nop
add %r9, %r9
lea addresses_normal_ht+0x1aac6, %r12
nop
nop
nop
add $15186, %r9
...
nop
sub $43893, %r12
lea addresses_A_ht+0x1273e, %r10
nop
nop
inc %rcx
...
vmovups %ymm3, (%r12)
cmp $57825, %r12
lea addresses_normal_ht+0xc72e, %r12
nop
nop
nop
nop
...
nop
sub %rdi, %rdi
lea addresses_WT_ht+0x1ba0c, %rcx
and $20295, %r9
mov (%rcx), %r12
nop
inc %rsi
...
<gen_prepare_buffer>
{'src': {'type': 'addresses_WT_ht', 'congruent': 1, 'same': False}, 'dst': {'type': 'addresses_WT_ht', 'congruent': 11, 'same': False}, 'OP': 'REPM'}
...
{'src': {'type': 'addresses_A_ht', 'same': True, 'size': 32, 'congruent': 4, 'NT': True, 'AVXalign': False}, 'OP': 'LOAD'}
