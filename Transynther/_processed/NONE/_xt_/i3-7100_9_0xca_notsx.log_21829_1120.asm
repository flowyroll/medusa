...
nop
and %r14, %r14
lea addresses_UC_ht+0x3e01, %r15
and $42243, %r11
mov (%r15), %r8w
nop
xor $5240, %r11
lea addresses_WT_ht+0x13db2, %r13
nop
nop
inc %rdi
movb $0x61, (%r13)
...
nop
inc %r14
lea addresses_WT_ht+0x4da2, %r11
nop
sub $40243, %rdi
vmovups (%r11), %ymm7
...
nop
sub $29537, %r13
lea addresses_WC_ht+0x15aa, %rsi
lea addresses_D_ht+0x1b022, %rdi
nop
nop
dec %r11
mov $30, %rcx
...
nop
cmp %rcx, %rcx
lea addresses_WC_ht+0x16632, %rdx
cmp $6130, %r15
mov (%rdx), %si
nop
nop
...
// REPMOV
lea addresses_WC+0xe43a, %rsi
lea addresses_WT+0x1ffd2, %rdi
nop
nop
add $1357, %rdx
mov $27, %rcx
...
<gen_faulty_load>
[REF]
{'src': {'same': False, 'congruent': 0, 'NT': True, 'type': 'addresses_PSE', 'size': 1, 'AVXalign': True}, 'OP': 'LOAD'}
...
{'src': {'type': 'addresses_WC', 'congruent': 3, 'same': False}, 'OP': 'REPM', 'dst': {'type': 'addresses_WT', 'congruent': 4, 'same': False}}
...
<gen_prepare_buffer>
{'OP': 'STOR', 'dst': {'same': False, 'congruent': 1, 'NT': True, 'type': 'addresses_normal_ht', 'size': 2, 'AVXalign': False}}
