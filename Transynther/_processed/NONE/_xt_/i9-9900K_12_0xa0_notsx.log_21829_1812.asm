...
lea addresses_WT_ht+0x8e1e, %rdi
nop
nop
nop
nop
...
nop
cmp %rsi, %rsi
lea addresses_normal_ht+0x1a566, %r11
and %rcx, %rcx
...
nop
add $50914, %r14
lea addresses_normal_ht+0x28a6, %rsi
lea addresses_A_ht+0xdf52, %rdi
nop
nop
nop
nop
...
nop
sub %rdi, %rdi
lea addresses_WT_ht+0x11436, %rsi
...
nop
sub %rcx, %rcx
lea addresses_A_ht+0xc566, %rsi
lea addresses_WC_ht+0xed66, %rdi
nop
cmp %r9, %r9
mov $81, %rcx
rep movsw
nop
add $7504, %rsi
lea addresses_WT_ht+0x13d66, %rdi
inc %rsi
mov (%rdi), %r13w
nop
nop
nop
sub $39906, %r11
lea addresses_normal_ht+0x1110, %rbx
nop
nop
nop
nop
...
nop
xor $17567, %r9
lea addresses_normal_ht+0xf66, %r9
nop
sub $46991, %r14
mov $0x6162636465666768, %rsi
movq %rsi, %xmm4
...
nop
dec %r9
lea addresses_UC_ht+0x1ee6, %rsi
lea addresses_WT_ht+0x1ef66, %rdi
nop
add $57404, %r13
mov $23, %rcx
rep movsb
...
nop
cmp %rcx, %rcx
lea addresses_D_ht+0x19966, %rsi
lea addresses_WT_ht+0x379a, %rdi
nop
nop
nop
and $18872, %r9
...
rep movsq
sub $19128, %rsi
lea addresses_normal_ht+0x6fa6, %r9
nop
nop
inc %rbx
movups (%r9), %xmm1
...
{'src': {'type': 'addresses_A_ht', 'congruent': 11, 'same': True}, 'OP': 'REPM', 'dst': {'type': 'addresses_WC_ht', 'congruent': 11, 'same': False}}
