...
lea addresses_UC_ht+0x1a9d9, %rdi
nop
nop
add %r13, %r13
mov $79, %rcx
...
nop
sub %rsi, %rsi
lea addresses_D_ht+0x1a979, %rsi
lea addresses_normal_ht+0x35f9, %rdi
nop
nop
nop
nop
...
nop
and $56284, %r8
lea addresses_WC_ht+0x5179, %rdi
clflush (%rdi)
nop
nop
nop
...
nop
inc %rcx
lea addresses_D_ht+0x4aa3, %rsi
lea addresses_WT_ht+0x12c95, %rdi
nop
nop
nop
nop
...
nop
and $21443, %r8
lea addresses_WC_ht+0x123f2, %rsi
lea addresses_normal_ht+0x1685, %rdi
nop
nop
nop
dec %r15
...
nop
and $36600, %r8
lea addresses_WC_ht+0x67f9, %rsi
lea addresses_normal_ht+0x1579, %rdi
sub $1496, %r8
mov $113, %rcx
rep movsq
nop
...
nop
and $35382, %rcx
lea addresses_WT_ht+0x10179, %rdi
nop
xor $57488, %rsi
...
{'OP': 'REPM', 'src': {'type': 'addresses_A_ht', 'congruent': 8, 'same': True}, 'dst': {'type': 'addresses_UC_ht', 'congruent': 5, 'same': False}}
{'OP': 'REPM', 'src': {'type': 'addresses_D_ht', 'congruent': 11, 'same': False}, 'dst': {'type': 'addresses_normal_ht', 'congruent': 7, 'same': False}}
{'OP': 'REPM', 'src': {'type': 'addresses_D_ht', 'congruent': 7, 'same': True}, 'dst': {'type': 'addresses_UC_ht', 'congruent': 6, 'same': False}}
...
{'OP': 'LOAD', 'src': {'type': 'addresses_D_ht', 'size': 8, 'AVXalign': False, 'NT': False, 'congruent': 1, 'same': True}}
{'32': 4149}
