...
nop
xor $45588, %rsi
lea addresses_WC_ht+0x80dd, %r14
xor $53529, %r11
movb $0x61, (%r14)
nop
dec %r11
lea addresses_UC_ht+0x3267, %rbx
add %r11, %r11
mov (%rbx), %bp
nop
nop
...
nop
xor $63727, %rsi
lea addresses_normal_ht+0x1a49d, %r14
nop
cmp %rbp, %rbp
movw $0x6162, (%r14)
nop
