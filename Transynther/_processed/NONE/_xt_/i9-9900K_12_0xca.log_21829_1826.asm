...
nop
and $17425, %rbp
lea addresses_A_ht+0x1b1b4, %rsi
lea addresses_WC_ht+0x1614, %rdi
nop
nop
nop
nop
...
nop
and %rsi, %rsi
lea addresses_WC_ht+0x1e494, %r13
nop
add $27732, %r15
mov (%r13), %r12w
cmp %r15, %r15
lea addresses_WC_ht+0x13500, %rdi
nop
nop
nop
nop
...
nop
sub $23609, %r15
lea addresses_normal_ht+0x1204e, %rdi
nop
nop
nop
nop
...
nop
sub %rcx, %rcx
lea addresses_UC_ht+0x22c0, %rsi
lea addresses_D_ht+0x9d94, %rdi
nop
nop
nop
dec %rdx
