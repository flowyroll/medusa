...
push %rdi
push %rsi
lea addresses_A_ht+0x1abac, %rsi
lea addresses_D_ht+0x1bc6c, %rdi
inc %r9
mov $34, %rcx
rep movsw
nop
...
nop
cmp %rax, %rax
lea addresses_WT_ht+0x121dc, %rcx
nop
nop
nop
nop
...
mov (%rcx), %rdi
sub %r9, %r9
lea addresses_WT_ht+0x13fac, %rsi
...
nop
xor $27716, %rcx
lea addresses_WC_ht+0x1d7ac, %rax
clflush (%rax)
nop
nop
nop
...
nop
and %r9, %r9
lea addresses_WT_ht+0xedec, %rcx
nop
xor $6078, %r9
movw $0x6162, (%rcx)
nop
...
nop
xor %rax, %rax
lea addresses_A_ht+0x1d6c, %rsi
lea addresses_UC_ht+0x1bfac, %rdi
nop
nop
nop
nop
...
nop
and $8320, %rbx
lea addresses_WC_ht+0x1829e, %rsi
lea addresses_UC_ht+0x1dec4, %rdi
clflush (%rsi)
nop
nop
nop
...
nop
xor %r8, %r8
lea addresses_D_ht+0x1a7ac, %r12
nop
xor %rsi, %rsi
vmovups (%r12), %ymm4
...
vpextrq $1, %xmm4, %rax
and %r8, %r8
lea addresses_UC_ht+0x29ac, %r12
nop
nop
nop
xor $53063, %rbx
