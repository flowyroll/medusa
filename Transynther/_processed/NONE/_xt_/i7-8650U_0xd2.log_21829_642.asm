...
nop
and %r13, %r13
lea addresses_D_ht+0x15e5b, %rsi
lea addresses_WT_ht+0x3232, %rdi
nop
nop
sub $62117, %r12
mov $112, %rcx
...
nop
add $19869, %r10
lea addresses_normal_ht+0xc6f2, %rdx
nop
nop
add $32272, %rsi
...
movq %r13, (%rdx)
add %r13, %r13
lea addresses_WT_ht+0x12d5e, %r13
nop
nop
nop
nop
...
nop
xor %rdi, %rdi
lea addresses_D_ht+0x19ab2, %rsi
lea addresses_A_ht+0x1d1d2, %rdi
nop
and %r10, %r10
mov $35, %rcx
rep movsl
...
nop
cmp $63072, %r10
lea addresses_normal_ht+0x19702, %r13
nop
nop
nop
inc %rdi
...
nop
dec %r12
lea addresses_normal_ht+0xddf4, %rdi
clflush (%rdi)
nop
sub %rax, %rax
movl $0x61626364, (%rdi)
...
nop
xor $23035, %rdx
lea addresses_A_ht+0x18432, %rsi
lea addresses_A_ht+0x3eb2, %rdi
nop
nop
cmp $59548, %r12
mov $32, %rcx
...
// Faulty Load
lea addresses_normal+0x1eeb2, %r8
clflush (%r8)
nop
nop
dec %r13
...
{'OP': 'REPM', 'src': {'type': 'addresses_D_ht', 'congruent': 0, 'same': False}, 'dst': {'type': 'addresses_WT_ht', 'congruent': 5, 'same': False}}
...
{'OP': 'REPM', 'src': {'type': 'addresses_A_ht', 'congruent': 7, 'same': False}, 'dst': {'type': 'addresses_A_ht', 'congruent': 11, 'same': True}}
{'34': 21829}
