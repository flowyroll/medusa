...
lea addresses_WT_ht+0xb21a, %rdi
nop
nop
nop
xor $5672, %rdx
...
nop
xor %rcx, %rcx
lea addresses_WT_ht+0x40ea, %rsi
lea addresses_UC_ht+0x1711a, %rdi
nop
nop
nop
nop
...
nop
sub %rdx, %rdx
lea addresses_WT_ht+0x1db7a, %r9
nop
nop
nop
sub $55223, %rdx
...
nop
dec %r11
lea addresses_normal_ht+0x311a, %rsi
lea addresses_WC_ht+0x10fda, %rdi
clflush (%rdi)
nop
sub $16462, %r10
mov $84, %rcx
...
nop
add $44777, %r11
lea addresses_WT_ht+0x10b1a, %r10
nop
nop
nop
sub %rdx, %rdx
...
// Store
lea addresses_normal+0xa15a, %r11
clflush (%r11)
nop
nop
nop
...
<gen_prepare_buffer>
{'src': {'type': 'addresses_normal_ht', 'congruent': 1, 'same': True}, 'dst': {'type': 'addresses_WT_ht', 'congruent': 6, 'same': False}, 'OP': 'REPM'}
