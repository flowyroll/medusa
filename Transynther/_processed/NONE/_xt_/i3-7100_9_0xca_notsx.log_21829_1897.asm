...
push %rdx
push %rsi
lea addresses_normal_ht+0x1317f, %r13
nop
nop
nop
nop
...
nop
add %r14, %r14
lea addresses_WT_ht+0x17ea7, %r14
nop
nop
nop
nop
...
nop
cmp $4560, %rax
lea addresses_UC_ht+0x1e4bc, %r13
nop
add $43459, %rdi
...
nop
cmp %r13, %r13
lea addresses_D_ht+0xf5cf, %rsi
lea addresses_WT_ht+0x15f7f, %rdi
and $29408, %rdx
mov $23, %rcx
rep movsq
nop
...
nop
and $6818, %r14
lea addresses_D_ht+0x16dff, %rdx
nop
nop
sub %rsi, %rsi
mov (%rdx), %r10
...
nop
add $40045, %rdi
lea addresses_A_ht+0x1757d, %r14
nop
nop
dec %r13
vmovups (%r14), %ymm7
...
nop
inc %r13
lea addresses_WC_ht+0x1acff, %rsi
lea addresses_A_ht+0xde7f, %rdi
nop
nop
nop
nop
...
{'OP': 'STOR', 'dst': {'same': True, 'congruent': 0, 'NT': False, 'type': 'addresses_UC_ht', 'size': 8, 'AVXalign': False}}
{'src': {'type': 'addresses_D_ht', 'congruent': 3, 'same': False}, 'OP': 'REPM', 'dst': {'type': 'addresses_WT_ht', 'congruent': 9, 'same': False}}
{'src': {'same': False, 'congruent': 7, 'NT': False, 'type': 'addresses_D_ht', 'size': 8, 'AVXalign': True}, 'OP': 'LOAD'}
{'src': {'same': False, 'congruent': 1, 'NT': False, 'type': 'addresses_A_ht', 'size': 32, 'AVXalign': False}, 'OP': 'LOAD'}
{'src': {'type': 'addresses_WC_ht', 'congruent': 7, 'same': True}, 'OP': 'REPM', 'dst': {'type': 'addresses_A_ht', 'congruent': 2, 'same': False}}
{'33': 21829}
