...
push %rdi
push %rsi
lea addresses_D_ht+0x18bd3, %r10
nop
inc %r8
...
nop
xor %r9, %r9
lea addresses_normal_ht+0x1a913, %r14
nop
nop
nop
nop
...
mov (%r14), %r15w
and %r9, %r9
lea addresses_D_ht+0x18ac7, %r10
clflush (%r10)
nop
nop
nop
...
nop
add %r9, %r9
lea addresses_normal_ht+0x13a0, %rsi
lea addresses_A_ht+0xdcb3, %rdi
clflush (%rsi)
clflush (%rdi)
cmp $20562, %r9
mov $52, %rcx
rep movsb
dec %r14
lea addresses_normal_ht+0x15213, %rdi
nop
and $9428, %r14
mov (%rdi), %esi
xor $42162, %rcx
lea addresses_UC_ht+0x1b513, %rsi
lea addresses_WC_ht+0x1dd13, %rdi
nop
nop
nop
nop
...
nop
sub %r8, %r8
lea addresses_UC_ht+0x5793, %rcx
xor %rdi, %rdi
...
nop
and $49817, %rdi
lea addresses_WC_ht+0x17f01, %r15
clflush (%r15)
nop
nop
nop
...
movl $0x61626364, (%r15)
inc %rbp
lea addresses_D_ht+0x14e13, %rbp
nop
nop
add $62826, %rcx
movl $0x61626364, (%rbp)
...
nop
inc %rsi
lea addresses_WT_ht+0x1e513, %rdi
nop
nop
nop
xor %rbp, %rbp
...
nop
sub %r9, %r9
lea addresses_UC_ht+0x4571, %r15
nop
nop
nop
sub $29025, %r9
...
nop
sub %rsi, %rsi
lea addresses_A_ht+0x14d13, %rdi
clflush (%rdi)
nop
nop
nop
...
nop
cmp $49916, %rcx
lea addresses_normal_ht+0x129a1, %rbp
nop
nop
nop
xor %r9, %r9
...
nop
cmp %rdi, %rdi
lea addresses_WT_ht+0x1518b, %r9
nop
nop
nop
nop
...
// Faulty Load
lea addresses_normal+0x18513, %r10
nop
nop
nop
xor $13010, %r13
...
{'src': {'type': 'addresses_UC_ht', 'congruent': 11, 'same': False}, 'OP': 'REPM', 'dst': {'type': 'addresses_WC_ht', 'congruent': 11, 'same': False}}
...
{'src': {'type': 'addresses_UC_ht', 'AVXalign': True, 'size': 16, 'NT': False, 'same': False, 'congruent': 0}, 'OP': 'LOAD'}
