...
push %rdi
push %rsi
lea addresses_normal_ht+0x1d0a5, %rax
xor %rbx, %rbx
...
nop
and $10906, %r12
lea addresses_UC_ht+0x17df5, %rcx
nop
nop
xor $38446, %r14
...
nop
dec %r14
lea addresses_UC_ht+0x67d1, %rsi
lea addresses_UC_ht+0x1b5f5, %rdi
nop
nop
inc %r15
mov $11, %rcx
...
nop
and %r12, %r12
lea addresses_A_ht+0xa505, %rsi
lea addresses_D_ht+0xc599, %rdi
clflush (%rsi)
nop
nop
nop
...
nop
dec %rdi
lea addresses_A_ht+0x7cf5, %rsi
lea addresses_D_ht+0x12885, %rdi
nop
nop
xor %r12, %r12
mov $56, %rcx
...
{'dst': {'same': False, 'congruent': 10, 'type': 'addresses_UC_ht'}, 'OP': 'REPM', 'src': {'same': False, 'congruent': 1, 'type': 'addresses_UC_ht'}}
