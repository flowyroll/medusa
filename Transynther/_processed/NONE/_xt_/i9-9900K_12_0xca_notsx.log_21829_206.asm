...
nop
add $25909, %rsi
lea addresses_WC_ht+0x1ecea, %r14
nop
nop
nop
inc %r9
...
nop
cmp %rax, %rax
lea addresses_normal_ht+0x4d38, %rbx
nop
nop
add %r9, %r9
vmovups (%rbx), %ymm5
...
nop
cmp $9983, %r9
lea addresses_UC_ht+0xecfc, %rsi
clflush (%rsi)
nop
sub $51639, %r9
movb $0x61, (%rsi)
add %r10, %r10
lea addresses_D_ht+0x14048, %r10
nop
dec %rax
mov (%r10), %rbx
nop
...
nop
xor %r10, %r10
lea addresses_WC_ht+0x1aed8, %rsi
lea addresses_normal_ht+0x17938, %rdi
nop
sub %r14, %r14
mov $70, %rcx
rep movsq
...
nop
sub %r14, %r14
lea addresses_A_ht+0x14578, %rbx
nop
nop
nop
nop
...
mov (%rdi), %rbx
cmp %rcx, %rcx
lea addresses_D_ht+0x15c38, %rsi
lea addresses_A_ht+0x78d8, %rdi
nop
nop
and %r15, %r15
mov $62, %rcx
...
nop
add $21365, %r15
lea addresses_D_ht+0x2338, %rsi
lea addresses_A_ht+0x1c88, %rdi
nop
nop
nop
nop
...
lea addresses_WT_ht+0x11794, %rdi
sub $31856, %r14
mov $17, %rcx
rep movsq
nop
...
{'OP': 'REPM', 'src': {'same': False, 'congruent': 9, 'type': 'addresses_normal_ht'}, 'dst': {'same': True, 'congruent': 1, 'type': 'addresses_WT_ht'}}
{'32': 21829}
