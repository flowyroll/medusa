...
nop
xor %r15, %r15
lea addresses_WC_ht+0x1ef99, %rcx
nop
nop
nop
nop
...
mov (%rcx), %r13
xor $48252, %r8
lea addresses_D_ht+0x17219, %r13
add $13300, %r14
...
nop
dec %r14
lea addresses_UC_ht+0x1a319, %rsi
lea addresses_UC_ht+0x1a619, %rdi
nop
nop
xor %r14, %r14
mov $76, %rcx
rep movsq
and %rcx, %rcx
lea addresses_WT_ht+0x6219, %rax
clflush (%rax)
nop
nop
nop
...
nop
add %r13, %r13
lea addresses_WC_ht+0x14119, %rax
clflush (%rax)
nop
nop
nop
...
<gen_prepare_buffer>
{'src': {'type': 'addresses_A_ht', 'same': False, 'size': 1, 'congruent': 10, 'NT': True, 'AVXalign': False}, 'OP': 'LOAD'}
...
{'src': {'type': 'addresses_UC_ht', 'congruent': 0, 'same': False}, 'dst': {'type': 'addresses_normal_ht', 'congruent': 6, 'same': False}, 'OP': 'REPM'}
{'src': {'type': 'addresses_UC_ht', 'congruent': 7, 'same': False}, 'dst': {'type': 'addresses_UC_ht', 'congruent': 9, 'same': False}, 'OP': 'REPM'}
