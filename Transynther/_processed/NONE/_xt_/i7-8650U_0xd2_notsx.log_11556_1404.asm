...
push %rdi
push %rsi
lea addresses_WT_ht+0xe053, %rdi
nop
nop
nop
nop
...
nop
dec %r13
lea addresses_normal_ht+0x14793, %r9
nop
nop
nop
nop
...
nop
inc %rbx
lea addresses_UC_ht+0xb76f, %rsi
lea addresses_D_ht+0x1c96d, %rdi
nop
nop
add %rbx, %rbx
mov $108, %rcx
...
nop
and %rsi, %rsi
lea addresses_D_ht+0x11293, %rbx
add %rcx, %rcx
movw $0x6162, (%rbx)
nop
nop
