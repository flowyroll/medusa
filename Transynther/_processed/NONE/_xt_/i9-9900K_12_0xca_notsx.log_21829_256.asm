...
push %rdi
push %rsi
lea addresses_normal_ht+0x5a6f, %r11
nop
nop
xor %r10, %r10
...
nop
inc %r10
lea addresses_A_ht+0x16eaf, %rdi
nop
nop
add $10996, %r10
movb $0x61, (%rdi)
...
nop
xor %rbp, %rbp
lea addresses_normal_ht+0x5c6f, %rcx
nop
nop
cmp %r10, %r10
...
movq %rbp, (%rcx)
sub $38351, %rcx
lea addresses_WT_ht+0x1634f, %rdi
nop
nop
nop
sub $50225, %r12
...
nop
dec %r9
lea addresses_WC_ht+0x12373, %rbp
and $45702, %rdi
movups (%rbp), %xmm1
vpextrq $0, %xmm1, %r9
nop
and $27854, %rbp
lea addresses_normal_ht+0x5b2f, %rdi
nop
nop
nop
add $39834, %r9
movw $0x6162, (%rdi)
and $14553, %rbp
lea addresses_WT_ht+0xf3af, %rbp
nop
sub %rdi, %rdi
vmovups (%rbp), %ymm6
...
lea addresses_normal_ht+0x39af, %rdi
xor %r9, %r9
mov $49, %rcx
rep movsl
xor $9728, %r11
lea addresses_D_ht+0x1826f, %r11
nop
nop
nop
add $34144, %r10
...
nop
sub %r11, %r11
lea addresses_normal_ht+0x17c8d, %rcx
nop
dec %rsi
movl $0x61626364, (%rcx)
lfence
