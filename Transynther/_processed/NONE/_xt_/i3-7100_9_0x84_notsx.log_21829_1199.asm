...
push %rdx
push %rsi
lea addresses_UC_ht+0x42fd, %r13
nop
nop
nop
nop
...
nop
and %r14, %r14
lea addresses_UC_ht+0xd545, %r10
nop
nop
xor %r8, %r8
mov (%r10), %r12w
...
nop
inc %r13
lea addresses_UC_ht+0x4155, %rsi
lea addresses_normal_ht+0x19c45, %rdi
nop
nop
add %rdx, %rdx
mov $65, %rcx
...
nop
cmp $32171, %r8
lea addresses_UC_ht+0x1bd25, %rdi
nop
sub %r8, %r8
mov (%rdi), %rsi
cmp $2429, %rcx
lea addresses_WC_ht+0x14f45, %rsi
nop
nop
nop
nop
...
nop
add $13446, %rsi
lea addresses_WC_ht+0x1e445, %rcx
nop
nop
nop
nop
...
nop
and %r8, %r8
lea addresses_UC_ht+0x5ec5, %rsi
lea addresses_WC_ht+0x1b1ac, %rdi
nop
nop
nop
nop
...
nop
and $11061, %rsi
lea addresses_A_ht+0x1e245, %r14
nop
nop
nop
nop
...
// Store
lea addresses_normal+0x8045, %r14
nop
inc %r8
movl $0x51525354, (%r14)
nop
...
{'src': {'type': 'addresses_UC_ht', 'same': True, 'size': 2, 'congruent': 5, 'NT': False, 'AVXalign': True}, 'OP': 'LOAD'}
{'src': {'type': 'addresses_UC_ht', 'congruent': 4, 'same': False}, 'dst': {'type': 'addresses_normal_ht', 'congruent': 10, 'same': False}, 'OP': 'REPM'}
...
{'dst': {'type': 'addresses_A_ht', 'same': False, 'size': 8, 'congruent': 8, 'NT': False, 'AVXalign': True}, 'OP': 'STOR'}
