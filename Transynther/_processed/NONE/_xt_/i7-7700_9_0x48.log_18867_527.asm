...
push %rdi
push %rsi
lea addresses_D_ht+0x14955, %rbx
add %r15, %r15
movb (%rbx), %cl
sub $52847, %rbp
lea addresses_A_ht+0x5ab5, %rsi
nop
sub %rdi, %rdi
movl $0x61626364, (%rsi)
cmp %rsi, %rsi
lea addresses_WT_ht+0x17c89, %r11
nop
nop
nop
nop
...
nop
add $59138, %rbx
lea addresses_WT_ht+0x196b5, %rbx
xor $58074, %rbp
movb $0x61, (%rbx)
nop
nop
mfence
lea addresses_WC_ht+0x2b5, %rsi
lea addresses_UC_ht+0xaab5, %rdi
nop
nop
nop
nop
...
{'OP': 'LOAD', 'src': {'type': 'addresses_WT_ht', 'AVXalign': True, 'congruent': 0, 'size': 1, 'same': False, 'NT': False}}
{'OP': 'STOR', 'dst': {'type': 'addresses_D_ht', 'AVXalign': False, 'congruent': 2, 'size': 8, 'same': False, 'NT': False}}
{'OP': 'STOR', 'dst': {'type': 'addresses_WT_ht', 'AVXalign': True, 'congruent': 11, 'size': 1, 'same': False, 'NT': False}}
