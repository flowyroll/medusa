...
push %rdx
push %rsi
lea addresses_UC_ht+0xe43f, %rsi
lea addresses_WT_ht+0x17627, %rdi
nop
nop
nop
nop
...
nop
and %rdx, %rdx
lea addresses_normal_ht+0x12747, %r14
nop
nop
nop
add %r13, %r13
...
nop
and $9648, %rsi
lea addresses_WC_ht+0xd047, %rsi
lea addresses_WT_ht+0x15947, %rdi
xor $23820, %r14
mov $61, %rcx
rep movsb
nop
...
nop
and $60381, %r14
lea addresses_WC_ht+0x12747, %rcx
nop
nop
nop
nop
...
movl $0x61626364, (%rcx)
xor %r15, %r15
lea addresses_WT_ht+0x13047, %rsi
nop
nop
sub $42865, %r9
...
nop
sub $44343, %rdi
lea addresses_D_ht+0x17887, %rdx
sub %r15, %r15
movb (%rdx), %cl
nop
nop
dec %r14
lea addresses_A_ht+0x1e347, %r15
nop
cmp %r14, %r14
...
movups %xmm1, (%r15)
cmp %r14, %r14
lea addresses_A_ht+0x14c77, %rdi
nop
xor $4364, %rdx
...
nop
cmp %r9, %r9
lea addresses_UC_ht+0x8c47, %rsi
lea addresses_D_ht+0x1bf47, %rdi
nop
sub $30261, %r9
mov $54, %rcx
rep movsb
...
nop
mfence
lea addresses_normal_ht+0x9f6f, %rdx
clflush (%rdx)
nop
cmp $16917, %r14
mov $0x6162636465666768, %r15
...
nop
cmp $42816, %r15
lea addresses_UC_ht+0x8783, %rdx
nop
nop
cmp %r13, %r13
...
nop
dec %r14
lea addresses_normal_ht+0x198c7, %rdi
nop
nop
nop
xor $42214, %r9
...
nop
xor %r9, %r9
lea addresses_normal_ht+0x4ec7, %rcx
nop
nop
sub %r14, %r14
...
<gen_prepare_buffer>
{'dst': {'same': False, 'congruent': 5, 'type': 'addresses_WT_ht'}, 'OP': 'REPM', 'src': {'same': False, 'congruent': 3, 'type': 'addresses_UC_ht'}}
...
{'dst': {'same': False, 'congruent': 11, 'type': 'addresses_normal_ht'}, 'OP': 'REPM', 'src': {'same': True, 'congruent': 10, 'type': 'addresses_WT_ht'}}
...
{'OP': 'LOAD', 'src': {'same': False, 'NT': False, 'AVXalign': True, 'size': 32, 'type': 'addresses_WT_ht', 'congruent': 7}}
...
{'dst': {'same': False, 'congruent': 11, 'type': 'addresses_D_ht'}, 'OP': 'REPM', 'src': {'same': False, 'congruent': 8, 'type': 'addresses_UC_ht'}}
