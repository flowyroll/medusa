...
nop
and %rax, %rax
lea addresses_WC_ht+0xfec6, %rsi
lea addresses_normal_ht+0x14412, %rdi
nop
nop
nop
dec %r8
...
nop
cmp %rdi, %rdi
lea addresses_UC_ht+0xc550, %rsi
nop
nop
nop
nop
...
nop
add %rdx, %rdx
lea addresses_WC_ht+0x151a6, %rsi
lea addresses_D_ht+0xa746, %rdi
add $24470, %r13
mov $68, %rcx
rep movsb
nop
...
mov (%rsi), %r15w
cmp %r13, %r13
lea addresses_normal_ht+0x16b46, %rcx
nop
nop
xor $27995, %r13
movups (%rcx), %xmm4
...
nop
and %rdx, %rdx
lea addresses_A_ht+0x13462, %rcx
nop
nop
nop
nop
...
{'OP': 'STOR', 'dst': {'type': 'addresses_NC', 'AVXalign': True, 'congruent': 4, 'size': 1, 'same': False, 'NT': False}}
[Faulty Load]
{'OP': 'LOAD', 'src': {'type': 'addresses_D', 'AVXalign': False, 'congruent': 0, 'size': 4, 'same': True, 'NT': False}}
<gen_prepare_buffer>
{'OP': 'REPM', 'src': {'type': 'addresses_A_ht', 'congruent': 0, 'same': False}, 'dst': {'type': 'addresses_WC_ht', 'congruent': 1, 'same': False}}
