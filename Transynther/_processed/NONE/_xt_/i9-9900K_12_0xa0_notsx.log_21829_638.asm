...
push %rdi
push %rsi
lea addresses_WT_ht+0x6901, %r12
nop
xor $36873, %rsi
mov (%r12), %rbp
nop
...
nop
sub $57489, %r12
lea addresses_A_ht+0x1663, %rsi
lea addresses_D_ht+0x13c39, %rdi
nop
nop
nop
nop
...
nop
dec %r12
lea addresses_WT_ht+0x17cd1, %rsi
...
nop
sub %rsi, %rsi
lea addresses_UC_ht+0x11501, %r8
nop
add %rbp, %rbp
...
{'src': {'type': 'addresses_WT_ht', 'congruent': 4, 'same': False}, 'OP': 'REPM', 'dst': {'type': 'addresses_WC_ht', 'congruent': 7, 'same': False}}
...
{'OP': 'STOR', 'dst': {'type': 'addresses_UC_ht', 'AVXalign': False, 'size': 16, 'NT': False, 'same': True, 'congruent': 7}}
{'38': 21829}
