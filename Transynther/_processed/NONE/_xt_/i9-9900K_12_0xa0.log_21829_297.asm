...
push %rdi
push %rsi
lea addresses_UC_ht+0x1375e, %rsi
lea addresses_A_ht+0x38ca, %rdi
xor %rax, %rax
mov $16, %rcx
rep movsw
add $30624, %rcx
lea addresses_normal_ht+0x1ee0a, %rsi
...
nop
add %rbp, %rbp
lea addresses_normal_ht+0x94ca, %r13
add $40275, %r15
...
nop
add $64406, %rbp
lea addresses_A_ht+0x1ccca, %rax
nop
add %r15, %r15
mov (%rax), %r13d
nop
...
nop
xor $65469, %rbp
lea addresses_UC_ht+0x12ca2, %r13
nop
nop
nop
nop
