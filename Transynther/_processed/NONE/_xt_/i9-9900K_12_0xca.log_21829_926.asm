...
push %rdi
push %rsi
lea addresses_UC_ht+0x1cef0, %rsi
...
nop
inc %r14
lea addresses_D_ht+0x1bef0, %rbp
and %rbx, %rbx
...
nop
xor %rbp, %rbp
lea addresses_A_ht+0x96f0, %rsi
lea addresses_UC_ht+0x2e70, %rdi
nop
nop
nop
nop
...
nop
cmp $42917, %rsi
lea addresses_UC_ht+0x12470, %rcx
nop
nop
nop
sub $14684, %rbp
...
{'OP': 'REPM', 'src': {'same': True, 'type': 'addresses_A_ht', 'congruent': 9}, 'dst': {'same': False, 'type': 'addresses_UC_ht', 'congruent': 6}}
...
{'OP': 'LOAD', 'src': {'size': 1, 'NT': False, 'type': 'addresses_A_ht', 'same': False, 'AVXalign': True, 'congruent': 4}}
{'36': 21829}
