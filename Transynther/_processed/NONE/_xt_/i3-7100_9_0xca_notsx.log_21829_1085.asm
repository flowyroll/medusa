...
nop
xor %rsi, %rsi
lea addresses_normal_ht+0x155b4, %r11
nop
nop
nop
nop
...
nop
dec %rsi
lea addresses_WC_ht+0x5200, %rsi
nop
nop
nop
nop
...
nop
cmp $11378, %r14
lea addresses_WC_ht+0x1ee2c, %r13
nop
nop
nop
nop
...
nop
xor %rbx, %rbx
lea addresses_UC_ht+0x13b4c, %rsi
lea addresses_WC_ht+0x24cc, %rdi
nop
nop
nop
nop
...
nop
xor $49749, %r14
lea addresses_WT_ht+0x8cf0, %rsi
add $21287, %rcx
...
nop
xor $33475, %rbx
lea addresses_D_ht+0xc34c, %rsi
lea addresses_normal_ht+0x15161, %rdi
nop
nop
sub %r13, %r13
mov $68, %rcx
...
// Faulty Load
lea addresses_normal+0x274c, %rsi
and %r10, %r10
vmovups (%rsi), %ymm1
