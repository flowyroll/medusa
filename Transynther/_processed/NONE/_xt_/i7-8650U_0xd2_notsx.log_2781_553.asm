...
push %rdx
push %rsi
lea addresses_D_ht+0x1655, %r12
xor %rdx, %rdx
mov (%r12), %rsi
nop
nop
and $50815, %rsi
lea addresses_normal_ht+0x1433a, %rsi
lea addresses_WT_ht+0x9515, %rdi
nop
dec %r15
mov $26, %rcx
rep movsb
...
nop
and %rdx, %rdx
lea addresses_WT_ht+0x4e9d, %rdx
nop
dec %rbx
movl $0x61626364, (%rdx)
nop
...
nop
dec %rsi
lea addresses_A_ht+0x10155, %rsi
...
nop
xor $58171, %rcx
lea addresses_WT_ht+0x1b57, %rsi
lea addresses_A_ht+0x186d5, %rdi
clflush (%rdi)
dec %r13
mov $71, %rcx
rep movsw
...
nop
lfence
lea addresses_WC_ht+0x8015, %rbx
sub %r13, %r13
...
nop
add $21651, %rsi
lea addresses_WC_ht+0xfb55, %rcx
nop
nop
sub %rbx, %rbx
movups (%rcx), %xmm7
...
nop
and $44794, %r15
lea addresses_WC_ht+0x19e55, %rsi
lea addresses_WC_ht+0x1ad89, %rdi
clflush (%rdi)
nop
sub $26270, %rbx
mov $73, %rcx
...
nop
add $4846, %rsi
lea addresses_UC_ht+0x91f5, %rbx
nop
nop
sub $26840, %rsi
mov (%rbx), %di
nop
sub %r13, %r13
lea addresses_D_ht+0x19f2f, %rsi
lea addresses_normal_ht+0xeb25, %rdi
clflush (%rsi)
nop
nop
nop
...
nop
xor %r12, %r12
lea addresses_normal_ht+0x51f9, %r15
clflush (%r15)
nop
nop
nop
...
nop
add $44617, %rbx
lea addresses_D_ht+0x1c6dd, %rbx
inc %r13
...
// Faulty Load
lea addresses_normal+0x17655, %rbp
nop
add $9542, %r15
movups (%rbp), %xmm0
vpextrq $1, %xmm0, %r10
...
{'OP': 'REPM', 'src': {'type': 'addresses_normal_ht', 'congruent': 0, 'same': True}, 'dst': {'type': 'addresses_WT_ht', 'congruent': 5, 'same': False}}
...
{'OP': 'REPM', 'src': {'type': 'addresses_D_ht', 'congruent': 0, 'same': True}, 'dst': {'type': 'addresses_normal_ht', 'congruent': 2, 'same': False}}
