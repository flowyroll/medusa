...
push %rdi
push %rsi
lea addresses_WT_ht+0x1a7a0, %rsi
nop
nop
nop
nop
...
movl $0x61626364, (%rsi)
xor $2172, %r15
lea addresses_normal_ht+0xfc0, %r8
add %r11, %r11
mov $0x6162636465666768, %r15
movq %r15, (%r8)
cmp $49862, %r11
lea addresses_WT_ht+0x2f8a, %r15
nop
cmp %rbx, %rbx
movb (%r15), %r13b
nop
nop
cmp %r15, %r15
lea addresses_WC_ht+0x446f, %rsi
nop
nop
nop
nop
...
nop
and $18740, %rbx
lea addresses_WT_ht+0x1be80, %r8
nop
nop
xor %r15, %r15
...
nop
xor $19778, %r11
lea addresses_WT_ht+0x12b4c, %rsi
lea addresses_D_ht+0xfe40, %rdi
nop
nop
nop
nop
...
nop
cmp $47707, %rcx
lea addresses_A_ht+0x144bc, %rdi
nop
nop
xor %rbx, %rbx
movw $0x6162, (%rdi)
...
{'src': {'type': 'addresses_WT_ht', 'congruent': 1, 'same': False}, 'dst': {'type': 'addresses_D_ht', 'congruent': 11, 'same': False}, 'OP': 'REPM'}
