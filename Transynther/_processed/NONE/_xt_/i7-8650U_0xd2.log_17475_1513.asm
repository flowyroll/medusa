...
push %rdx
push %rsi
lea addresses_WT_ht+0x1ebf1, %rax
nop
nop
nop
nop
...
nop
inc %rbx
lea addresses_A_ht+0x11f41, %rbx
clflush (%rbx)
nop
nop
nop
...
nop
add %rbx, %rbx
lea addresses_UC_ht+0x4b11, %rbx
nop
nop
nop
cmp %r8, %r8
...
nop
cmp $57519, %rax
lea addresses_WC_ht+0xbb49, %r10
sub %rax, %rax
...
nop
and %rax, %rax
lea addresses_WT_ht+0x10edc, %rsi
lea addresses_normal_ht+0x169d5, %rdi
nop
nop
cmp %r10, %r10
mov $17, %rcx
...
{'OP': 'REPM', 'src': {'type': 'addresses_WT_ht', 'congruent': 0, 'same': False}, 'dst': {'type': 'addresses_normal_ht', 'congruent': 1, 'same': False}}
{'33': 17475}
