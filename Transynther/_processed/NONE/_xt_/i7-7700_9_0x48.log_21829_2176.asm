...
nop
and %rbp, %rbp
lea addresses_WT_ht+0xb171, %rsi
lea addresses_WC_ht+0x108f9, %rdi
clflush (%rdi)
nop
nop
nop
...
nop
cmp $21263, %rbp
lea addresses_UC_ht+0x1a4bb, %rsi
nop
nop
nop
xor %rbp, %rbp
movw $0x6162, (%rsi)
xor $56334, %r8
lea addresses_UC_ht+0x3971, %rax
clflush (%rax)
nop
nop
nop
...
{'OP': 'REPM', 'src': {'type': 'addresses_WT_ht', 'congruent': 8, 'same': True}, 'dst': {'type': 'addresses_WC_ht', 'congruent': 2, 'same': False}}
