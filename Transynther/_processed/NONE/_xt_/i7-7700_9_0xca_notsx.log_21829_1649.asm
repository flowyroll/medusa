...
nop
xor $38722, %r13
lea addresses_WC_ht+0x1bad4, %rsi
lea addresses_A_ht+0xa594, %rdi
clflush (%rdi)
nop
nop
cmp %r10, %r10
...
nop
xor $19551, %r12
lea addresses_A_ht+0x1c754, %r12
nop
xor $38874, %r11
movb $0x61, (%r12)
nop
...
nop
cmp $21065, %rcx
lea addresses_UC_ht+0x13704, %rcx
nop
nop
cmp %r10, %r10
movl $0x61626364, (%rcx)
dec %rsi
lea addresses_WC_ht+0xf665, %rsi
nop
nop
nop
inc %r10
...
vpextrq $1, %xmm1, %rcx
cmp %r10, %r10
lea addresses_normal_ht+0x1e4d0, %rsi
lea addresses_WC_ht+0x16b14, %rdi
nop
nop
nop
nop
...
nop
and $53463, %r10
lea addresses_normal_ht+0x15dc, %r11
add %r12, %r12
movb $0x61, (%r11)
nop
nop
xor %r13, %r13
lea addresses_WT_ht+0x1e1f0, %r11
nop
nop
nop
xor %rsi, %rsi
...
nop
add %r13, %r13
lea addresses_UC_ht+0x1e4d4, %rsi
...
rep movsw
and $13618, %r13
lea addresses_WT_ht+0xbb54, %rcx
clflush (%rcx)
nop
nop
nop
...
nop
xor $34927, %rcx
lea addresses_UC_ht+0x36b5, %r10
nop
nop
nop
sub %r11, %r11
...
nop
sub $10980, %rdi
lea addresses_WT_ht+0x10a24, %rdi
nop
nop
nop
sub $16890, %rsi
...
mov (%rsi), %r13
and %rsi, %rsi
lea addresses_UC_ht+0x1b070, %rsi
nop
add %r12, %r12
mov $0x6162636465666768, %r13
movq %r13, %xmm7
...
nop
and %r12, %r12
lea addresses_UC_ht+0xf2d4, %rsi
lea addresses_D_ht+0x124f4, %rdi
nop
nop
nop
nop
...
{'src': {'congruent': 9, 'same': False, 'type': 'addresses_WC_ht'}, 'dst': {'congruent': 2, 'same': False, 'type': 'addresses_A_ht'}, 'OP': 'REPM'}
{'dst': {'NT': False, 'AVXalign': False, 'size': 1, 'congruent': 6, 'same': False, 'type': 'addresses_A_ht'}, 'OP': 'STOR'}
{'dst': {'NT': True, 'AVXalign': False, 'size': 4, 'congruent': 3, 'same': False, 'type': 'addresses_UC_ht'}, 'OP': 'STOR'}
{'src': {'NT': False, 'AVXalign': False, 'size': 32, 'congruent': 0, 'same': False, 'type': 'addresses_WC_ht'}, 'OP': 'LOAD'}
{'src': {'congruent': 1, 'same': True, 'type': 'addresses_normal_ht'}, 'dst': {'congruent': 5, 'same': False, 'type': 'addresses_WC_ht'}, 'OP': 'REPM'}
{'dst': {'NT': False, 'AVXalign': False, 'size': 1, 'congruent': 2, 'same': False, 'type': 'addresses_normal_ht'}, 'OP': 'STOR'}
{'src': {'NT': False, 'AVXalign': False, 'size': 1, 'congruent': 0, 'same': True, 'type': 'addresses_WT_ht'}, 'OP': 'LOAD'}
{'src': {'congruent': 11, 'same': False, 'type': 'addresses_UC_ht'}, 'dst': {'congruent': 8, 'same': False, 'type': 'addresses_A_ht'}, 'OP': 'REPM'}
{'src': {'NT': False, 'AVXalign': False, 'size': 32, 'congruent': 6, 'same': True, 'type': 'addresses_WT_ht'}, 'OP': 'LOAD'}
