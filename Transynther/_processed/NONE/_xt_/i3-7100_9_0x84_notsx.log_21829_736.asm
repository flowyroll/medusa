...
nop
sub $61244, %rsi
lea addresses_WT_ht+0xcebe, %rsi
...
nop
inc %rsi
lea addresses_WT_ht+0x829a, %r15
nop
nop
nop
cmp %r9, %r9
...
nop
cmp $19385, %r15
lea addresses_D_ht+0x96de, %rsi
lea addresses_D_ht+0x1b8de, %rdi
nop
cmp $58667, %rbx
mov $121, %rcx
rep movsl
...
nop
sub %r15, %r15
lea addresses_normal_ht+0xcb1e, %rsi
and %r8, %r8
movl $0x61626364, (%rsi)
nop
inc %rbx
lea addresses_D_ht+0xf2b2, %rcx
add %r8, %r8
...
{'src': {'type': 'addresses_D_ht', 'congruent': 8, 'same': False}, 'dst': {'type': 'addresses_D_ht', 'congruent': 11, 'same': False}, 'OP': 'REPM'}
{'dst': {'type': 'addresses_normal_ht', 'same': False, 'size': 4, 'congruent': 4, 'NT': True, 'AVXalign': False}, 'OP': 'STOR'}
