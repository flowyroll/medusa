...
movb (%rdx), %r14b
cmp $29543, %rbp
lea addresses_WT_ht+0xcebb, %r15
add $46368, %r11
movb $0x61, (%r15)
nop
xor %r14, %r14
lea addresses_A_ht+0x4d7b, %r11
nop
nop
sub %rdx, %rdx
movb (%r11), %r15b
sub %rdi, %rdi
lea addresses_WC_ht+0xe0bb, %rdi
and %rbp, %rbp
movl $0x61626364, (%rdi)
nop
nop
...
nop
dec %rsi
lea addresses_UC_ht+0x186bb, %rdx
nop
nop
nop
nop
...
nop
add %r15, %r15
lea addresses_normal_ht+0xbb3b, %rbp
nop
cmp $57870, %r15
mov (%rbp), %r11w
nop
xor %r15, %r15
lea addresses_UC_ht+0x1dad3, %rsi
clflush (%rsi)
nop
sub %rdx, %rdx
movw $0x6162, (%rsi)
sub $7500, %rsi
lea addresses_WT_ht+0xa77b, %rdx
nop
nop
nop
nop
...
nop
add $25992, %r15
lea addresses_WT_ht+0x2ebb, %rsi
nop
nop
cmp %r11, %r11
movl $0x61626364, (%rsi)
...
nop
add %rdi, %rdi
lea addresses_WT_ht+0x1973, %rbp
nop
nop
nop
nop
...
{'OP': 'STOR', 'dst': {'type': 'addresses_RW', 'AVXalign': False, 'size': 1, 'NT': False, 'same': False, 'congruent': 2}}
{'src': {'type': 'addresses_P', 'AVXalign': False, 'size': 8, 'NT': False, 'same': False, 'congruent': 4}, 'OP': 'LOAD'}
{'OP': 'STOR', 'dst': {'type': 'addresses_RW', 'AVXalign': False, 'size': 16, 'NT': False, 'same': False, 'congruent': 4}}
[Faulty Load]
...
{'OP': 'STOR', 'dst': {'type': 'addresses_WT_ht', 'AVXalign': False, 'size': 1, 'NT': False, 'same': True, 'congruent': 11}}
...
{'src': {'type': 'addresses_UC_ht', 'AVXalign': True, 'size': 32, 'NT': False, 'same': False, 'congruent': 11}, 'OP': 'LOAD'}
...
{'OP': 'STOR', 'dst': {'type': 'addresses_WT_ht', 'AVXalign': True, 'size': 4, 'NT': False, 'same': False, 'congruent': 5}}
