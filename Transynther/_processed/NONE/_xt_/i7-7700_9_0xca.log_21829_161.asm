...
nop
and $2736, %r13
lea addresses_normal_ht+0xffcd, %rsi
sub %r14, %r14
vmovups (%rsi), %ymm6
...
nop
inc %rsi
lea addresses_A_ht+0x11acd, %rbx
cmp $62728, %r9
mov (%rbx), %r8
nop
nop
nop
sub $22341, %r9
lea addresses_UC_ht+0x8f4d, %rsi
nop
nop
nop
cmp %rbx, %rbx
...
nop
and %rbx, %rbx
lea addresses_D_ht+0x1145, %rsi
lea addresses_UC_ht+0xa94d, %rdi
clflush (%rsi)
nop
nop
nop
...
rep movsq
xor $43645, %r15
lea addresses_WC_ht+0x1de25, %r14
cmp $8505, %rcx
movl $0x61626364, (%r14)
nop
dec %r14
...
{'src': {'congruent': 3, 'AVXalign': False, 'same': False, 'size': 8, 'NT': True, 'type': 'addresses_A_ht'}, 'OP': 'LOAD'}
{'OP': 'STOR', 'dst': {'congruent': 10, 'AVXalign': False, 'same': False, 'size': 2, 'NT': False, 'type': 'addresses_UC_ht'}}
{'src': {'congruent': 2, 'same': False, 'type': 'addresses_D_ht'}, 'OP': 'REPM', 'dst': {'congruent': 9, 'same': False, 'type': 'addresses_UC_ht'}}
