...
push %rdi
push %rsi
lea addresses_D_ht+0x188c6, %rsi
nop
sub $35235, %rdi
movb $0x61, (%rsi)
nop
...
nop
sub $57940, %rsi
lea addresses_WC_ht+0x38c6, %r12
nop
nop
nop
xor $49952, %r15
...
nop
add %rbp, %rbp
lea addresses_WT_ht+0x1cd06, %rsi
nop
xor $59781, %r15
movw $0x6162, (%rsi)
nop
...
nop
xor %rsi, %rsi
lea addresses_WC_ht+0x48c6, %rsi
...
nop
xor %rsi, %rsi
lea addresses_normal_ht+0x27c6, %r10
dec %rsi
movw $0x6162, (%r10)
nop
nop
...
nop
sub %rcx, %rcx
lea addresses_normal_ht+0x20c6, %rdi
sub $44591, %rsi
...
nop
add %r10, %r10
lea addresses_WT_ht+0xf986, %rcx
nop
inc %rsi
movb $0x61, (%rcx)
nop
...
nop
cmp %rbp, %rbp
lea addresses_D_ht+0x184c6, %r10
nop
xor $63029, %rdi
mov (%r10), %rbp
inc %r15
lea addresses_A_ht+0xe5c6, %r9
nop
nop
cmp %rcx, %rcx
movb $0x61, (%r9)
...
// Store
lea addresses_normal+0x64c6, %rax
nop
nop
nop
nop
...
{'src': {'type': 'addresses_WC_ht', 'congruent': 11, 'same': False}, 'OP': 'REPM', 'dst': {'type': 'addresses_UC_ht', 'congruent': 3, 'same': False}}
...
{'OP': 'STOR', 'dst': {'type': 'addresses_normal_ht', 'AVXalign': True, 'size': 16, 'NT': False, 'same': False, 'congruent': 11}}
{'OP': 'STOR', 'dst': {'type': 'addresses_A_ht', 'AVXalign': True, 'size': 8, 'NT': True, 'same': False, 'congruent': 6}}
{'OP': 'STOR', 'dst': {'type': 'addresses_A_ht', 'AVXalign': False, 'size': 16, 'NT': True, 'same': False, 'congruent': 5}}
...
{'OP': 'STOR', 'dst': {'type': 'addresses_A_ht', 'AVXalign': False, 'size': 1, 'NT': True, 'same': False, 'congruent': 6}}
{'36': 21829}
