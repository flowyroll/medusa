...
// REPMOV
lea addresses_A+0x8bf5, %rsi
lea addresses_WC+0x28a9, %rdi
clflush (%rsi)
nop
nop
nop
...
// REPMOV
lea addresses_D+0x58d5, %rsi
lea addresses_D+0x1a315, %rdi
cmp %rax, %rax
mov $116, %rcx
rep movsb
xor $12509, %r12
...
{'OP': 'REPM', 'src': {'type': 'addresses_A', 'congruent': 10, 'same': False}, 'dst': {'type': 'addresses_WC', 'congruent': 1, 'same': False}}
{'OP': 'REPM', 'src': {'type': 'addresses_D', 'congruent': 5, 'same': False}, 'dst': {'type': 'addresses_D', 'congruent': 5, 'same': False}}
