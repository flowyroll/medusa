...
push %rdx
push %rsi
lea addresses_D_ht+0x1a3db, %rsi
lea addresses_A_ht+0x1459b, %rdi
nop
nop
nop
nop
...
rep movsb
sub $17968, %rcx
lea addresses_WT_ht+0x16d1b, %rcx
nop
nop
nop
nop
...
nop
and $41828, %r8
lea addresses_WC_ht+0x611b, %rdx
clflush (%rdx)
nop
nop
xor $46236, %r12
...
// Faulty Load
lea addresses_normal+0x351b, %rdx
nop
nop
nop
nop
...
{'src': {'same': False, 'congruent': 10, 'NT': False, 'type': 'addresses_UC', 'size': 16, 'AVXalign': True}, 'OP': 'LOAD'}
[Faulty Load]
