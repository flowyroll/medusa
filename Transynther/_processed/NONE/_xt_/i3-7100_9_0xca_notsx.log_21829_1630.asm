...
nop
xor $6837, %r10
lea addresses_UC_ht+0xd84, %rsi
lea addresses_normal_ht+0x10488, %rdi
nop
dec %rdx
mov $48, %rcx
rep movsq
...
nop
dec %r10
lea addresses_D_ht+0xe254, %rsi
lea addresses_UC_ht+0x1dd04, %rdi
clflush (%rsi)
clflush (%rdi)
add $60474, %rbp
mov $95, %rcx
...
nop
sub $11373, %rdi
lea addresses_A_ht+0x1e2c4, %rsi
lea addresses_WC_ht+0x8484, %rdi
nop
nop
nop
nop
...
{'src': {'type': 'addresses_A_ht', 'congruent': 6, 'same': False}, 'OP': 'REPM', 'dst': {'type': 'addresses_WC_ht', 'congruent': 6, 'same': False}}
{'38': 21829}
