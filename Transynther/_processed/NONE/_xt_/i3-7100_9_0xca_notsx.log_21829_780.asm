...
push %rdi
push %rsi
lea addresses_UC_ht+0xed8c, %rsi
xor $16144, %r9
movw $0x6162, (%rsi)
nop
and $53988, %rdi
lea addresses_D_ht+0x1e8cc, %rsi
lea addresses_normal_ht+0x1e34c, %rdi
xor %r9, %r9
mov $113, %rcx
rep movsq
nop
nop
add $23564, %rcx
lea addresses_normal_ht+0xd70c, %rsi
lea addresses_UC_ht+0xab6c, %rdi
and $52272, %r12
mov $52, %rcx
rep movsq
cmp %r12, %r12
...
// Faulty Load
lea addresses_normal+0xe70c, %rcx
nop
nop
nop
add %r15, %r15
...
{'OP': 'STOR', 'dst': {'same': False, 'congruent': 3, 'NT': True, 'type': 'addresses_WT', 'size': 4, 'AVXalign': False}}
[Faulty Load]
...
{'src': {'type': 'addresses_D_ht', 'congruent': 6, 'same': False}, 'OP': 'REPM', 'dst': {'type': 'addresses_normal_ht', 'congruent': 6, 'same': False}}
