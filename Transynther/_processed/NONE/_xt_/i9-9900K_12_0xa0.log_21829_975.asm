...
push %rdx
push %rsi
lea addresses_UC_ht+0x13a9f, %r12
nop
cmp %rcx, %rcx
vmovups (%r12), %ymm6
...
nop
sub $52601, %r12
lea addresses_normal_ht+0x9bdf, %rax
nop
cmp %rcx, %rcx
mov (%rax), %r14
nop
...
nop
sub %r15, %r15
lea addresses_normal_ht+0x1c35f, %rsi
lea addresses_normal_ht+0x3b5f, %rdi
clflush (%rsi)
nop
nop
and %rdx, %rdx
...
nop
dec %rdi
lea addresses_A_ht+0x8d4f, %rsi
lea addresses_normal_ht+0xb61, %rdi
clflush (%rdi)
add $1846, %r12
mov $31, %rcx
rep movsw
...
nop
dec %rcx
lea addresses_WC_ht+0x1475f, %rsi
lea addresses_normal_ht+0xc57f, %rdi
nop
cmp $36723, %rax
mov $120, %rcx
rep movsl
...
nop
and %r14, %r14
lea addresses_D_ht+0x10c4b, %r15
nop
add $24308, %rax
mov (%r15), %dx
nop
nop
and %r12, %r12
lea addresses_UC_ht+0x13f5f, %rcx
nop
nop
nop
nop
...
nop
sub %rdi, %rdi
lea addresses_UC_ht+0x1b85f, %rsi
lea addresses_A_ht+0xfd5f, %rdi
nop
add %r14, %r14
mov $90, %rcx
rep movsq
...
// Store
lea addresses_normal+0x18adf, %rdx
clflush (%rdx)
nop
cmp $22310, %r13
...
{'src': {'NT': True, 'same': False, 'congruent': 6, 'type': 'addresses_normal_ht', 'AVXalign': False, 'size': 8}, 'OP': 'LOAD'}
{'src': {'same': False, 'congruent': 10, 'type': 'addresses_normal_ht'}, 'OP': 'REPM', 'dst': {'same': False, 'congruent': 8, 'type': 'addresses_normal_ht'}}
{'src': {'same': False, 'congruent': 0, 'type': 'addresses_A_ht'}, 'OP': 'REPM', 'dst': {'same': True, 'congruent': 1, 'type': 'addresses_normal_ht'}}
