...
push %rdx
push %rsi
lea addresses_A_ht+0x1b240, %rsi
lea addresses_WC_ht+0x122a0, %rdi
nop
nop
nop
cmp $13205, %rdx
...
rep movsw
cmp $8483, %r14
lea addresses_D_ht+0x17c20, %rdx
nop
nop
add $2398, %rbp
...
nop
cmp $62974, %rbp
lea addresses_WC_ht+0x10750, %rdi
nop
nop
nop
nop
...
nop
inc %rbp
lea addresses_A_ht+0x146a3, %rsi
lea addresses_D_ht+0x1820, %rdi
nop
sub $4620, %rbx
mov $89, %rcx
rep movsb
...
nop
and %rdi, %rdi
lea addresses_normal_ht+0x2388, %rcx
nop
nop
cmp %rdi, %rdi
movb (%rcx), %r14b
...
{'OP': 'REPM', 'src': {'type': 'addresses_A_ht', 'congruent': 0, 'same': True}, 'dst': {'type': 'addresses_D_ht', 'congruent': 10, 'same': False}}
