...
lea addresses_normal_ht+0xc7b7, %rdi
nop
nop
nop
nop
...
nop
cmp $32725, %r10
lea addresses_WT_ht+0x14767, %r11
nop
nop
add $21483, %rcx
mov (%r11), %si
...
nop
and %rdi, %rdi
lea addresses_normal_ht+0x4137, %rsi
sub $32405, %rbp
movb (%rsi), %cl
nop
nop
nop
cmp $40978, %rcx
lea addresses_WT_ht+0x74f7, %rbp
nop
sub %rdi, %rdi
...
<gen_prepare_buffer>
{'OP': 'REPM', 'src': {'same': False, 'congruent': 1, 'type': 'addresses_D_ht'}, 'dst': {'same': False, 'congruent': 11, 'type': 'addresses_WT_ht'}}
