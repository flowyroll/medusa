...
push %rdi
push %rsi
lea addresses_D_ht+0xbda5, %rsi
lea addresses_WC_ht+0x1e10d, %rdi
nop
add %r8, %r8
mov $60, %rcx
rep movsw
...
nop
sub $49215, %r8
lea addresses_WC_ht+0xcf6d, %rsi
add %r8, %r8
movw $0x6162, (%rsi)
nop
nop
...
nop
dec %rsi
lea addresses_WT_ht+0x18965, %r8
nop
nop
nop
nop
...
nop
cmp %r11, %r11
lea addresses_D_ht+0x1006d, %r13
nop
sub %rdi, %rdi
...
{'src': {'congruent': 5, 'same': False, 'type': 'addresses_A_ht'}, 'OP': 'REPM', 'dst': {'congruent': 3, 'same': False, 'type': 'addresses_WT_ht'}}
