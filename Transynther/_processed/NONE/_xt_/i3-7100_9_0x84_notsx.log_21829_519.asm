...
push %rdx
push %rsi
lea addresses_D_ht+0xa009, %rsi
lea addresses_normal_ht+0xbce9, %rdi
add %r14, %r14
mov $114, %rcx
rep movsq
nop
...
nop
cmp %rcx, %rcx
lea addresses_UC_ht+0x6c09, %rdx
nop
nop
nop
add $23234, %r14
movb (%rdx), %cl
cmp %rsi, %rsi
lea addresses_UC_ht+0x13ed1, %r9
nop
nop
nop
nop
...
nop
xor $59123, %rcx
lea addresses_WC_ht+0x1e11b, %rdx
nop
sub $40897, %r14
movups (%rdx), %xmm4
vpextrq $0, %xmm4, %rcx
...
nop
dec %rdi
lea addresses_D_ht+0x1c769, %rcx
nop
add $41839, %rdi
vmovups (%rcx), %ymm7
...
nop
dec %rcx
lea addresses_WT_ht+0xd6b9, %rcx
nop
nop
nop
nop
...
nop
xor %rdi, %rdi
lea addresses_A_ht+0x12009, %r14
nop
nop
dec %r10
...
nop
cmp $38502, %r14
lea addresses_WC_ht+0x19009, %rsi
nop
nop
nop
nop
...
lea addresses_normal_ht+0xef59, %rdi
nop
nop
nop
sub $61463, %r12
...
nop
add $25646, %r12
lea addresses_UC_ht+0x9afd, %r10
clflush (%r10)
nop
sub $41651, %r9
...
movq %rcx, (%r10)
sub $14216, %rsi
lea addresses_normal_ht+0x1bc09, %rcx
clflush (%rcx)
nop
nop
nop
...
nop
add %rdx, %rdx
lea addresses_A_ht+0xba09, %rsi
lea addresses_WC_ht+0x5009, %rdi
nop
nop
nop
nop
...
nop
cmp $28917, %rdx
lea addresses_WC_ht+0x1fc9, %rsi
lea addresses_A_ht+0x2c09, %rdi
nop
nop
nop
nop
...
{'src': {'type': 'addresses_A_ht', 'congruent': 9, 'same': False}, 'dst': {'type': 'addresses_WC_ht', 'congruent': 11, 'same': True}, 'OP': 'REPM'}
{'src': {'type': 'addresses_WC_ht', 'congruent': 4, 'same': False}, 'dst': {'type': 'addresses_A_ht', 'congruent': 9, 'same': False}, 'OP': 'REPM'}
{'39': 21829}
