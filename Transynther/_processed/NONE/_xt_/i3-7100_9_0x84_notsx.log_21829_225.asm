...
push %rdi
push %rsi
lea addresses_normal_ht+0x10f90, %r8
nop
nop
nop
nop
...
nop
and $2477, %r11
lea addresses_D_ht+0xaf80, %rsi
lea addresses_WT_ht+0x1c840, %rdi
clflush (%rsi)
add $42434, %r12
mov $20, %rcx
rep movsw
add $46389, %rcx
lea addresses_UC_ht+0x13c40, %r11
xor $14609, %rsi
movb (%r11), %cl
nop
nop
...
nop
and $2313, %rbp
lea addresses_UC_ht+0x1a040, %rcx
inc %rsi
...
nop
cmp %rcx, %rcx
lea addresses_UC_ht+0xa840, %rsi
lea addresses_UC_ht+0x179b8, %rdi
nop
nop
nop
add $41626, %rbp
...
nop
xor %r11, %r11
lea addresses_WC_ht+0x157a0, %rsi
...
{'src': {'type': 'addresses_UC_ht', 'congruent': 11, 'same': True}, 'dst': {'type': 'addresses_UC_ht', 'congruent': 0, 'same': False}, 'OP': 'REPM'}
{'src': {'type': 'addresses_WC_ht', 'congruent': 3, 'same': False}, 'dst': {'type': 'addresses_UC_ht', 'congruent': 8, 'same': False}, 'OP': 'REPM'}
{'dst': {'type': 'addresses_D_ht', 'same': False, 'size': 2, 'congruent': 0, 'NT': True, 'AVXalign': False}, 'OP': 'STOR'}
{'37': 21829}
