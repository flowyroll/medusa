...
push %rdi
push %rsi
lea addresses_UC_ht+0x12b86, %r8
xor $26854, %rsi
...
nop
cmp $31816, %rbp
lea addresses_D_ht+0x17220, %r11
nop
nop
nop
nop
...
nop
dec %r11
lea addresses_WC_ht+0x1a76, %r11
add %rbp, %rbp
movups (%r11), %xmm6
vpextrq $0, %xmm6, %r12
nop
xor %r13, %r13
lea addresses_A_ht+0x16976, %r8
nop
sub $51017, %rbp
movw $0x6162, (%r8)
nop
...
nop
and %rbp, %rbp
lea addresses_UC_ht+0x4b6e, %r15
nop
nop
nop
sub %rsi, %rsi
...
nop
cmp $40241, %r15
lea addresses_normal_ht+0x129f6, %r11
add $29374, %r8
mov (%r11), %esi
nop
inc %r15
lea addresses_WT_ht+0x5276, %r13
nop
nop
nop
nop
...
nop
add %r8, %r8
lea addresses_UC_ht+0xc676, %rsi
lea addresses_A_ht+0xe7b6, %rdi
clflush (%rsi)
nop
nop
dec %r15
...
// Store
lea addresses_normal+0x5f14, %rbp
clflush (%rbp)
nop
nop
nop
...
// REPMOV
lea addresses_normal+0x99d6, %rsi
lea addresses_UC+0x32aa, %rdi
clflush (%rsi)
clflush (%rdi)
nop
add $7953, %rbp
...
// Faulty Load
lea addresses_normal+0x12a76, %r12
nop
nop
nop
nop
...
{'OP': 'STOR', 'dst': {'type': 'addresses_normal', 'size': 32, 'AVXalign': True, 'NT': False, 'congruent': 1, 'same': False}}
{'OP': 'REPM', 'src': {'type': 'addresses_normal', 'congruent': 3, 'same': False}, 'dst': {'type': 'addresses_UC', 'congruent': 1, 'same': False}}
