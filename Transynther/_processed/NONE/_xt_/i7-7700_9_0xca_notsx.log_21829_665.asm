...
push %rdi
push %rsi
lea addresses_D_ht+0x100c7, %rbx
xor %r11, %r11
mov $0x6162636465666768, %r10
movq %r10, (%rbx)
and $62277, %rcx
lea addresses_WC_ht+0x1e3c7, %rsi
lea addresses_WT_ht+0x31f7, %rdi
nop
nop
nop
cmp %r13, %r13
...
nop
cmp %rcx, %rcx
lea addresses_WC_ht+0x18aca, %r13
clflush (%r13)
nop
nop
nop
...
nop
cmp %r11, %r11
lea addresses_WC_ht+0x15eef, %rbx
nop
nop
nop
xor %rcx, %rcx
movb (%rbx), %r10b
xor $3734, %rcx
lea addresses_UC_ht+0x6cb7, %r13
inc %r11
vmovups (%r13), %ymm0
...
{'src': {'congruent': 3, 'same': False, 'type': 'addresses_WC_ht'}, 'dst': {'congruent': 9, 'same': True, 'type': 'addresses_WT_ht'}, 'OP': 'REPM'}
