...
push %rdi
push %rsi
lea addresses_A_ht+0x18789, %rbp
sub %r13, %r13
movb (%rbp), %r12b
nop
nop
nop
cmp $7382, %rcx
lea addresses_A_ht+0x6537, %rsi
lea addresses_normal_ht+0x12b89, %rdi
nop
nop
and $3110, %rbx
mov $96, %rcx
...
nop
dec %rbx
lea addresses_WT_ht+0x12689, %rbx
nop
nop
nop
nop
...
nop
sub %rsi, %rsi
lea addresses_WC_ht+0x1afc1, %rbx
nop
nop
nop
cmp $29460, %rcx
...
nop
add $56338, %rcx
lea addresses_normal_ht+0xb489, %rcx
nop
nop
nop
nop
...
nop
xor $17686, %rcx
lea addresses_UC_ht+0x1a969, %rsi
lea addresses_normal_ht+0xfb49, %rdi
nop
nop
inc %rax
mov $106, %rcx
...
{'src': {'congruent': 1, 'same': False, 'type': 'addresses_A_ht'}, 'dst': {'congruent': 8, 'same': False, 'type': 'addresses_normal_ht'}, 'OP': 'REPM'}
...
{'src': {'congruent': 4, 'same': False, 'type': 'addresses_UC_ht'}, 'dst': {'congruent': 4, 'same': False, 'type': 'addresses_normal_ht'}, 'OP': 'REPM'}
