...
nop
and $8781, %r14
lea addresses_UC_ht+0x73bb, %rsi
nop
nop
nop
nop
...
nop
and %rbp, %rbp
lea addresses_A_ht+0x12a8f, %rsi
...
nop
sub $20306, %rcx
lea addresses_D_ht+0x19dbb, %rcx
clflush (%rcx)
nop
nop
sub %rbp, %rbp
...
nop
inc %r11
lea addresses_A_ht+0x1b976, %rsi
...
nop
add $42007, %rbp
lea addresses_normal_ht+0x1923b, %r14
nop
nop
add $23610, %rdi
mov (%r14), %rdx
