...
nop
mfence
lea addresses_UC_ht+0x11316, %rsi
lea addresses_A_ht+0x9106, %rdi
nop
nop
nop
nop
...
nop
cmp %r12, %r12
lea addresses_WC_ht+0x14d16, %rsi
lea addresses_A_ht+0xdc8a, %rdi
nop
cmp $50104, %rdx
mov $26, %rcx
rep movsw
...
lea addresses_D_ht+0x18926, %rdi
nop
nop
nop
nop
...
nop
add %r10, %r10
lea addresses_UC_ht+0x3ba2, %rdi
nop
nop
xor %rdx, %rdx
movw $0x6162, (%rdi)
inc %r10
lea addresses_normal_ht+0x296, %r12
nop
add $42932, %rdx
movw $0x6162, (%r12)
cmp %rdi, %rdi
lea addresses_normal_ht+0x12eb6, %rdi
nop
nop
nop
nop
