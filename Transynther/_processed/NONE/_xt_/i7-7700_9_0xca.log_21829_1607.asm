...
nop
inc %r13
lea addresses_A_ht+0x11b73, %r14
nop
nop
nop
nop
...
nop
cmp $32182, %rbp
lea addresses_WT_ht+0x1dc59, %r15
nop
nop
nop
nop
...
nop
sub $57439, %r15
lea addresses_UC_ht+0x1b439, %r14
nop
nop
cmp $50271, %r13
...
nop
xor %r14, %r14
lea addresses_D_ht+0x18e79, %r11
clflush (%r11)
nop
add $46559, %r13
movb (%r11), %r14b
nop
cmp $56626, %r13
lea addresses_WC_ht+0x3b39, %rbx
nop
sub $29045, %rbp
movups (%rbx), %xmm5
vpextrq $1, %xmm5, %r11
...
nop
dec %rbp
lea addresses_A_ht+0x8419, %rsi
lea addresses_UC_ht+0x839, %rdi
clflush (%rdi)
nop
dec %rdx
mov $43, %rcx
...
// Faulty Load
lea addresses_normal+0x1d639, %rbx
nop
cmp %rdi, %rdi
mov (%rbx), %cx
lea oracles, %rbp
...
{'src': {'congruent': 4, 'same': False, 'type': 'addresses_A_ht'}, 'OP': 'REPM', 'dst': {'congruent': 9, 'same': False, 'type': 'addresses_UC_ht'}}
{'34': 21829}
