...
nop
and $20453, %r10
lea addresses_normal_ht+0xbef5, %rcx
nop
nop
nop
nop
...
nop
sub %r10, %r10
lea addresses_UC_ht+0x8478, %rcx
add $14051, %r10
movl $0x61626364, (%rcx)
nop
xor $3139, %rdx
...
// Faulty Load
lea addresses_normal+0x1bc78, %r11
nop
nop
nop
and %rbp, %rbp
