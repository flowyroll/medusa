...
nop
add %r11, %r11
lea addresses_WC_ht+0x1b9d2, %r11
clflush (%r11)
nop
nop
nop
...
nop
dec %r10
lea addresses_UC_ht+0x112, %rsi
lea addresses_normal_ht+0x78e2, %rdi
nop
add $14302, %r13
mov $53, %rcx
rep movsb
...
nop
dec %rbp
lea addresses_A_ht+0x11b12, %rdx
nop
nop
nop
xor $41957, %r10
...
nop
and %rbx, %rbx
lea addresses_A_ht+0x1ed92, %rbx
nop
nop
nop
nop
...
mov (%rbx), %r13w
sub $12247, %rdi
lea addresses_A_ht+0x1ea92, %r11
nop
nop
nop
nop
...
nop
xor $29437, %rsi
lea addresses_A_ht+0x128f6, %r11
nop
nop
nop
nop
...
// Store
lea addresses_normal+0x11452, %r11
inc %rdi
movl $0x51525354, (%r11)
nop
nop
