...
push %rdi
push %rsi
lea addresses_WC_ht+0x123b3, %rbp
nop
nop
nop
nop
...
nop
sub %rsi, %rsi
lea addresses_A_ht+0x1788b, %rsi
lea addresses_WC_ht+0xc193, %rdi
nop
nop
nop
nop
...
nop
and %r8, %r8
lea addresses_normal_ht+0x16e6b, %rsi
lea addresses_UC_ht+0x11ad3, %rdi
clflush (%rsi)
inc %r8
mov $72, %rcx
rep movsw
...
nop
xor %rcx, %rcx
lea addresses_A_ht+0xf143, %rsi
lea addresses_UC_ht+0xd993, %rdi
clflush (%rdi)
nop
nop
nop
...
{'src': {'type': 'addresses_A_ht', 'congruent': 3, 'same': True}, 'OP': 'REPM', 'dst': {'type': 'addresses_UC_ht', 'congruent': 6, 'same': True}}
{'32': 21829}
