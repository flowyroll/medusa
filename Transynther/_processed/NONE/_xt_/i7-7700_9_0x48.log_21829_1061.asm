...
push %rdi
push %rsi
lea addresses_WC_ht+0x1d662, %rbx
nop
nop
nop
cmp $32256, %rdi
mov (%rbx), %r12
dec %rbx
lea addresses_WC_ht+0xfd7a, %rbx
sub %r11, %r11
vmovups (%rbx), %ymm1
...
nop
inc %r15
lea addresses_normal_ht+0x1e34a, %r15
clflush (%r15)
nop
nop
nop
...
lea addresses_UC_ht+0x1774a, %rdi
nop
inc %r11
mov $2, %rcx
rep movsb
...
nop
and $48604, %rsi
lea addresses_WT_ht+0x24f0, %rsi
lea addresses_WC_ht+0x1b34a, %rdi
nop
nop
inc %rbx
mov $17, %rcx
...
{'OP': 'STOR', 'dst': {'type': 'addresses_WC', 'AVXalign': True, 'congruent': 11, 'size': 4, 'same': False, 'NT': False}}
[Faulty Load]
