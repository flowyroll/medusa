...
push %rdi
push %rsi
lea addresses_UC_ht+0x1739, %r13
clflush (%r13)
nop
nop
nop
...
nop
and %rsi, %rsi
lea addresses_WT_ht+0x17a19, %rsi
lea addresses_A_ht+0x1c779, %rdi
clflush (%rdi)
nop
nop
dec %rax
...
nop
xor %r13, %r13
lea addresses_normal_ht+0x1df39, %rax
nop
inc %rdi
...
nop
and $22807, %rdi
lea addresses_UC_ht+0xbf39, %r12
nop
nop
nop
cmp %rsi, %rsi
...
nop
and %rdi, %rdi
lea addresses_WT_ht+0x11e71, %r12
nop
nop
nop
nop
...
nop
cmp %r13, %r13
lea addresses_D_ht+0x193f5, %rsi
lea addresses_UC_ht+0x1956d, %rdi
nop
and %rbp, %rbp
mov $68, %rcx
rep movsq
...
nop
and %r10, %r10
lea addresses_WC_ht+0x5df9, %rcx
nop
nop
nop
nop
...
nop
cmp $41614, %rbp
lea addresses_normal_ht+0x10f39, %rdi
nop
nop
add %rsi, %rsi
...
nop
and %rcx, %rcx
lea addresses_D_ht+0x8d19, %rsi
lea addresses_D_ht+0xb739, %rdi
nop
nop
nop
nop
...
<gen_prepare_buffer>
{'OP': 'STOR', 'dst': {'size': 2, 'NT': False, 'type': 'addresses_UC_ht', 'same': True, 'AVXalign': False, 'congruent': 10}}
...
{'OP': 'STOR', 'dst': {'size': 32, 'NT': True, 'type': 'addresses_UC_ht', 'same': False, 'AVXalign': False, 'congruent': 11}}
...
{'OP': 'LOAD', 'src': {'size': 16, 'NT': False, 'type': 'addresses_normal_ht', 'same': False, 'AVXalign': True, 'congruent': 9}}
