...
nop
inc %r14
lea addresses_normal_ht+0xee20, %rsi
lea addresses_D_ht+0xe8a0, %rdi
nop
cmp $60555, %r11
mov $99, %rcx
rep movsq
nop
inc %rdi
lea addresses_A_ht+0x5620, %rdi
clflush (%rdi)
nop
sub $23424, %rax
mov (%rdi), %r13w
dec %rax
lea addresses_D_ht+0xc298, %rsi
lea addresses_normal_ht+0x93a0, %rdi
nop
nop
nop
inc %rbp
...
nop
cmp %rbp, %rbp
lea addresses_WC_ht+0x151e8, %rsi
nop
nop
nop
nop
...
nop
dec %rax
lea addresses_WC_ht+0x16544, %rsi
lea addresses_A_ht+0x9d20, %rdi
nop
inc %r11
mov $43, %rcx
rep movsb
...
nop
xor $62970, %r14
lea addresses_WT_ht+0x13abe, %r11
nop
nop
add $36541, %r14
movl $0x61626364, (%r11)
...
nop
sub %rax, %rax
lea addresses_D_ht+0x1abd0, %rdi
nop
sub $44473, %rsi
...
nop
xor $21805, %rcx
lea addresses_WC_ht+0x1fa0, %rcx
nop
nop
nop
nop
...
nop
sub $54258, %rbp
lea addresses_WT_ht+0x11780, %rsi
nop
nop
nop
nop
...
// REPMOV
lea addresses_D+0xa9a0, %rsi
lea addresses_A+0x171e8, %rdi
nop
nop
nop
nop
...
// Faulty Load
lea addresses_normal+0x12520, %rsi
clflush (%rsi)
sub %rdi, %rdi
vmovups (%rsi), %ymm6
...
{'src': {'congruent': 7, 'same': False, 'type': 'addresses_D'}, 'dst': {'congruent': 3, 'same': False, 'type': 'addresses_A'}, 'OP': 'REPM'}
[Faulty Load]
...
{'src': {'congruent': 8, 'same': True, 'type': 'addresses_normal_ht'}, 'dst': {'congruent': 3, 'same': False, 'type': 'addresses_D_ht'}, 'OP': 'REPM'}
{'src': {'NT': True, 'AVXalign': False, 'size': 2, 'congruent': 8, 'same': False, 'type': 'addresses_A_ht'}, 'OP': 'LOAD'}
{'src': {'congruent': 3, 'same': False, 'type': 'addresses_D_ht'}, 'dst': {'congruent': 7, 'same': False, 'type': 'addresses_normal_ht'}, 'OP': 'REPM'}
{'src': {'NT': False, 'AVXalign': False, 'size': 32, 'congruent': 3, 'same': False, 'type': 'addresses_WC_ht'}, 'OP': 'LOAD'}
{'src': {'congruent': 2, 'same': False, 'type': 'addresses_WC_ht'}, 'dst': {'congruent': 8, 'same': True, 'type': 'addresses_A_ht'}, 'OP': 'REPM'}
