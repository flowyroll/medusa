...
nop
xor %rdi, %rdi
lea addresses_UC_ht+0x18a50, %r12
and $60037, %rdx
vmovups (%r12), %ymm1
...
// Store
lea addresses_normal+0xcd75, %r11
clflush (%r11)
nop
nop
nop
...
// Load
lea addresses_normal+0x12346, %r11
nop
nop
nop
cmp %r8, %r8
...
// Faulty Load
lea addresses_normal+0xd810, %r11
nop
cmp $37890, %r8
mov (%r11), %dx
lea oracles, %rcx
...
{'dst': {'NT': False, 'AVXalign': True, 'size': 2, 'congruent': 10, 'same': False, 'type': 'addresses_PSE'}, 'OP': 'STOR'}
...
<gen_prepare_buffer>
{'dst': {'NT': False, 'AVXalign': False, 'size': 16, 'congruent': 2, 'same': True, 'type': 'addresses_D_ht'}, 'OP': 'STOR'}
