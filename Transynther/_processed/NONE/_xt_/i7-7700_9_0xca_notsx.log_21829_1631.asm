...
lea addresses_D_ht+0x1ae1d, %rdi
nop
nop
nop
nop
...
rep movsl
add $63331, %rdx
lea addresses_WT_ht+0x1bccd, %r8
nop
nop
nop
nop
...
nop
cmp %rdx, %rdx
lea addresses_WT_ht+0x10ed, %rcx
nop
nop
and %r9, %r9
movb $0x61, (%rcx)
