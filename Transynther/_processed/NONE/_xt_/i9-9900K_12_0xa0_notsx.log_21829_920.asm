...
nop
and %rcx, %rcx
lea addresses_A_ht+0x16b0, %rdx
clflush (%rdx)
cmp %r9, %r9
mov (%rdx), %r12
xor $57128, %rcx
lea addresses_WT_ht+0x90c4, %rsi
lea addresses_WT_ht+0x140c4, %rdi
nop
nop
nop
nop
...
nop
cmp %r9, %r9
lea addresses_UC_ht+0x17644, %rsi
lea addresses_WT_ht+0xae54, %rdi
nop
nop
and $61664, %rax
mov $58, %rcx
...
nop
cmp $37390, %rax
lea addresses_normal_ht+0x4e44, %rsi
lea addresses_normal_ht+0x11ba9, %rdi
nop
nop
inc %r12
mov $44, %rcx
...
// Store
lea addresses_normal+0x19f24, %r15
nop
nop
nop
xor $29150, %rcx
...
// Faulty Load
lea addresses_normal+0x1ae44, %rcx
xor $56176, %r10
mov (%rcx), %rbx
lea oracles, %r10
and $0xff, %rbx
...
{'src': {'type': 'addresses_UC_ht', 'congruent': 10, 'same': False}, 'OP': 'REPM', 'dst': {'type': 'addresses_WT_ht', 'congruent': 3, 'same': False}}
