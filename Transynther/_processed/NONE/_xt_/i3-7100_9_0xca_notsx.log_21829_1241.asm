...
nop
sub %r13, %r13
lea addresses_WT_ht+0x1bf42, %rsi
lea addresses_normal_ht+0x19282, %rdi
nop
nop
nop
add %rbx, %rbx
...
nop
add %rsi, %rsi
lea addresses_normal_ht+0x59d2, %rdx
nop
nop
nop
nop
...
nop
add %r14, %r14
lea addresses_normal_ht+0x149d2, %rsi
lea addresses_UC_ht+0xb182, %rdi
nop
and %r15, %r15
mov $76, %rcx
rep movsb
...
nop
sub %r14, %r14
lea addresses_UC_ht+0x10282, %r15
add %rsi, %rsi
movb (%r15), %r14b
nop
nop
...
nop
xor $1795, %rdx
lea addresses_WC_ht+0x1e5ea, %rsi
...
// Store
lea addresses_normal+0x13a82, %rsi
nop
nop
nop
nop
...
{'src': {'same': False, 'congruent': 10, 'NT': False, 'type': 'addresses_A', 'size': 4, 'AVXalign': True}, 'OP': 'LOAD'}
...
{'src': {'type': 'addresses_normal_ht', 'congruent': 4, 'same': True}, 'OP': 'REPM', 'dst': {'type': 'addresses_UC_ht', 'congruent': 8, 'same': False}}
