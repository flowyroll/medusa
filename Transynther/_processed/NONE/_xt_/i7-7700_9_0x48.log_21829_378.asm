...
lea addresses_normal_ht+0x14ba2, %rdi
nop
nop
nop
nop
...
nop
and %r15, %r15
lea addresses_UC_ht+0x1bcdc, %rbx
nop
nop
nop
nop
...
nop
dec %rsi
lea addresses_WT_ht+0x37f2, %r15
nop
xor %rcx, %rcx
...
nop
add %rsi, %rsi
lea addresses_UC_ht+0xf94e, %rbx
nop
nop
nop
nop
...
vmovups %ymm0, (%rbx)
add $60151, %rcx
lea addresses_D_ht+0x11f12, %r8
clflush (%r8)
nop
add %r12, %r12
movb $0x61, (%r8)
and $38044, %rcx
lea addresses_D_ht+0x13992, %rsi
lea addresses_WT_ht+0x7d2, %rdi
sub %rdx, %rdx
mov $70, %rcx
rep movsq
nop
...
// Load
lea addresses_normal+0x17d92, %r9
nop
nop
xor %r11, %r11
movb (%r9), %r12b
...
{'OP': 'REPM', 'src': {'type': 'addresses_D_ht', 'congruent': 9, 'same': False}, 'dst': {'type': 'addresses_WT_ht', 'congruent': 6, 'same': False}}
{'36': 21829}
