...
push %rdx
push %rsi
lea addresses_UC_ht+0xd21a, %rdx
nop
dec %r15
...
nop
add %r8, %r8
lea addresses_WT_ht+0x691a, %rdx
nop
nop
cmp %r14, %r14
mov (%rdx), %r8
...
lea addresses_WC_ht+0x6f1a, %rdi
nop
nop
nop
cmp %r8, %r8
...
rep movsw
and $4892, %rdi
lea addresses_D_ht+0x1873e, %rdi
nop
nop
nop
nop
...
nop
add %rbx, %rbx
lea addresses_normal_ht+0x188f4, %rdx
sub %r8, %r8
movl $0x61626364, (%rdx)
nop
nop
nop
sub $8201, %r8
lea addresses_D_ht+0x14bda, %rdi
nop
and %r14, %r14
movw $0x6162, (%rdi)
nop
...
nop
and $22805, %rsi
lea addresses_normal_ht+0x1691a, %r14
nop
nop
cmp $62862, %r15
mov (%r14), %r8w
add $61746, %rsi
lea addresses_WT_ht+0x1331a, %rcx
nop
nop
nop
nop
...
nop
xor %r15, %r15
lea addresses_D_ht+0x1ab2e, %rsi
...
// Faulty Load
lea addresses_normal+0x971a, %r8
cmp $47592, %r11
movups (%r8), %xmm0
vpextrq $1, %xmm0, %rax
lea oracles, %r14
...
{'src': {'type': 'addresses_WT_ht', 'AVXalign': True, 'size': 8, 'NT': False, 'same': True, 'congruent': 9}, 'OP': 'LOAD'}
{'src': {'type': 'addresses_WC_ht', 'congruent': 2, 'same': False}, 'OP': 'REPM', 'dst': {'type': 'addresses_WC_ht', 'congruent': 10, 'same': True}}
...
{'OP': 'STOR', 'dst': {'type': 'addresses_normal_ht', 'AVXalign': True, 'size': 4, 'NT': False, 'same': False, 'congruent': 1}}
...
{'src': {'type': 'addresses_D_ht', 'congruent': 2, 'same': False}, 'OP': 'REPM', 'dst': {'type': 'addresses_UC_ht', 'congruent': 6, 'same': False}}
{'34': 21829}
