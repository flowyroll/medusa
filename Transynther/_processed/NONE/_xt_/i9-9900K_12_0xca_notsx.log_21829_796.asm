...
push %rdi
push %rsi
lea addresses_A_ht+0x1883a, %rsi
lea addresses_WC_ht+0x663a, %rdi
nop
nop
nop
nop
...
nop
and %r11, %r11
lea addresses_WT_ht+0x1e83a, %rsi
lea addresses_A_ht+0x1b05a, %rdi
clflush (%rsi)
nop
nop
cmp $62405, %r13
...
nop
dec %r13
lea addresses_normal_ht+0x1261a, %rcx
nop
cmp %r11, %r11
...
nop
cmp $42950, %rsi
lea addresses_normal_ht+0x362d, %r14
nop
xor %rbp, %rbp
mov $0x6162636465666768, %rsi
movq %rsi, %xmm5
...
// Load
lea addresses_normal+0x43a, %rcx
nop
nop
nop
nop
...
{'OP': 'REPM', 'src': {'same': False, 'congruent': 7, 'type': 'addresses_WC'}, 'dst': {'same': False, 'congruent': 3, 'type': 'addresses_P'}}
{'OP': 'LOAD', 'src': {'same': True, 'type': 'addresses_normal', 'NT': False, 'AVXalign': False, 'size': 1, 'congruent': 0}}
{'OP': 'STOR', 'dst': {'same': False, 'type': 'addresses_P', 'NT': False, 'AVXalign': True, 'size': 1, 'congruent': 7}}
[Faulty Load]
{'OP': 'LOAD', 'src': {'same': True, 'type': 'addresses_normal', 'NT': False, 'AVXalign': False, 'size': 2, 'congruent': 0}}
<gen_prepare_buffer>
{'OP': 'REPM', 'src': {'same': True, 'congruent': 10, 'type': 'addresses_A_ht'}, 'dst': {'same': False, 'congruent': 8, 'type': 'addresses_WC_ht'}}
