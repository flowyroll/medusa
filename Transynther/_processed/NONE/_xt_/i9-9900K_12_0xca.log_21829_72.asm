...
push %rdi
push %rsi
lea addresses_normal_ht+0xfc36, %rcx
cmp $20123, %r12
movb $0x61, (%rcx)
nop
inc %rax
...
rep movsl
add %rdi, %rdi
lea addresses_normal_ht+0xa45a, %rcx
cmp $38935, %r9
movups (%rcx), %xmm1
vpextrq $1, %xmm1, %r15
nop
sub %rcx, %rcx
lea addresses_WT_ht+0x38fa, %rsi
nop
xor $42414, %r15
movl $0x61626364, (%rsi)
nop
...
nop
add $20357, %r15
lea addresses_WC_ht+0x17f3a, %r9
clflush (%r9)
nop
xor $46419, %r12
...
nop
xor %r15, %r15
lea addresses_WT_ht+0x1765a, %r9
clflush (%r9)
nop
sub %rax, %rax
...
{'OP': 'LOAD', 'src': {'size': 4, 'NT': True, 'type': 'addresses_A', 'same': False, 'AVXalign': False, 'congruent': 5}}
...
{'OP': 'REPM', 'src': {'same': False, 'type': 'addresses_WC_ht', 'congruent': 0}, 'dst': {'same': False, 'type': 'addresses_A_ht', 'congruent': 5}}
...
{'OP': 'STOR', 'dst': {'size': 16, 'NT': True, 'type': 'addresses_WT_ht', 'same': False, 'AVXalign': False, 'congruent': 8}}
{'33': 21829}
