...
push %rdi
push %rsi
lea addresses_UC_ht+0x1164e, %r13
nop
nop
nop
nop
...
nop
xor $56239, %r14
lea addresses_normal_ht+0x1d8b6, %r9
nop
nop
sub $24134, %r11
movw $0x6162, (%r9)
nop
and $42617, %r14
lea addresses_WT_ht+0x13bb6, %rax
nop
nop
sub $19826, %r14
movl $0x61626364, (%rax)
and $41160, %r9
lea addresses_A_ht+0x8216, %rsi
lea addresses_WT_ht+0x2c68, %rdi
clflush (%rdi)
nop
nop
nop
...
// REPMOV
lea addresses_normal+0x1bb6, %rsi
lea addresses_PSE+0x1b3ee, %rdi
clflush (%rsi)
nop
nop
nop
...
// Faulty Load
lea addresses_normal+0x1bb6, %rax
nop
cmp $13386, %rsi
movups (%rax), %xmm4
vpextrq $0, %xmm4, %r15
...
{'src': {'congruent': 0, 'same': True, 'type': 'addresses_normal'}, 'dst': {'congruent': 3, 'same': False, 'type': 'addresses_PSE'}, 'OP': 'REPM'}
...
{'src': {'congruent': 5, 'same': False, 'type': 'addresses_A_ht'}, 'dst': {'congruent': 1, 'same': False, 'type': 'addresses_WT_ht'}, 'OP': 'REPM'}
{'34': 21829}
