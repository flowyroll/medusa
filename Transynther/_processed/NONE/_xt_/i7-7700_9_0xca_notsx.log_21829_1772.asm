...
push %rdx
push %rsi
lea addresses_WT_ht+0xc2e4, %rbp
nop
nop
inc %r14
movw $0x6162, (%rbp)
inc %r13
lea addresses_D_ht+0x1d930, %rcx
nop
nop
and %rbp, %rbp
movw $0x6162, (%rcx)
...
nop
sub $26152, %r14
lea addresses_UC_ht+0x11730, %rbx
nop
nop
nop
nop
...
nop
sub %rcx, %rcx
lea addresses_normal_ht+0xd030, %rsi
lea addresses_D_ht+0xfb30, %rdi
nop
nop
nop
sub %rdx, %rdx
...
{'src': {'NT': False, 'AVXalign': True, 'size': 1, 'congruent': 1, 'same': False, 'type': 'addresses_RW'}, 'OP': 'LOAD'}
[Faulty Load]
...
{'src': {'congruent': 4, 'same': False, 'type': 'addresses_normal_ht'}, 'dst': {'congruent': 6, 'same': False, 'type': 'addresses_D_ht'}, 'OP': 'REPM'}
{'32': 21829}
