...
push %rdx
push %rsi
lea addresses_WC_ht+0x10fa5, %r13
nop
nop
xor %r15, %r15
mov (%r13), %edx
nop
cmp $27818, %rbp
lea addresses_UC_ht+0x13879, %r11
nop
nop
nop
add $49035, %r8
...
nop
add $11249, %r13
lea addresses_D_ht+0x1c1c5, %rsi
lea addresses_WC_ht+0x198f7, %rdi
clflush (%rdi)
nop
add %rbp, %rbp
mov $84, %rcx
rep movsl
and $6216, %r11
lea addresses_A_ht+0x9915, %rsi
lea addresses_WC_ht+0x1c405, %rdi
nop
nop
nop
nop
...
rep movsl
sub $7419, %rdx
lea addresses_D_ht+0x183c7, %r11
and %r13, %r13
mov $0x6162636465666768, %r8
movq %r8, (%r11)
nop
and $27929, %rdi
lea addresses_normal_ht+0x168a5, %r11
nop
nop
nop
xor %r8, %r8
...
nop
add $47026, %rdx
lea addresses_WT_ht+0x35c5, %rsi
nop
nop
nop
nop
...
nop
and $28451, %r8
lea addresses_WT_ht+0x1ebc5, %r8
nop
nop
nop
nop
...
nop
dec %r8
lea addresses_A_ht+0x109c5, %r13
sub $18362, %rdx
...
nop
cmp $63973, %r11
lea addresses_normal_ht+0x185c5, %rsi
lea addresses_UC_ht+0x14ca1, %rdi
clflush (%rsi)
clflush (%rdi)
nop
nop
...
nop
mfence
lea addresses_D_ht+0xfe45, %rsi
lea addresses_WC_ht+0x192c5, %rdi
nop
nop
nop
nop
...
nop
add %r8, %r8
lea addresses_normal_ht+0x1a9c5, %rsi
lea addresses_A_ht+0xe1c5, %rdi
nop
and %rdx, %rdx
mov $54, %rcx
rep movsq
and $33220, %r13
lea addresses_WT_ht+0x140c5, %rsi
lea addresses_WC_ht+0x18605, %rdi
nop
nop
nop
inc %r11
...
nop
cmp $50420, %r15
lea addresses_WT_ht+0x1e7c5, %rsi
...
{'OP': 'REPM', 'src': {'type': 'addresses_A_ht', 'congruent': 4, 'same': True}, 'dst': {'type': 'addresses_WC_ht', 'congruent': 6, 'same': False}}
...
{'OP': 'REPM', 'src': {'type': 'addresses_WT_ht', 'congruent': 9, 'same': True}, 'dst': {'type': 'addresses_WC_ht', 'congruent': 5, 'same': False}}
{'33': 3528}
