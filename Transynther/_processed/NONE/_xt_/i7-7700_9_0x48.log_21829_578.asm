...
movb (%r13), %r9b
and %rdi, %rdi
lea addresses_WT_ht+0x15444, %r15
nop
nop
xor $10834, %r14
mov (%r15), %cx
...
nop
xor %r15, %r15
lea addresses_normal_ht+0x1904b, %r13
nop
xor %r15, %r15
...
vpextrq $0, %xmm6, %rsi
add %r15, %r15
lea addresses_D_ht+0x13f5f, %rsi
lea addresses_A_ht+0x1c84b, %rdi
nop
nop
nop
nop
...
rep movsl
xor %r13, %r13
lea addresses_WC_ht+0x18f9f, %rsi
lea addresses_A_ht+0x68e5, %rdi
nop
nop
nop
sub $4025, %r12
...
nop
xor $7036, %r14
lea addresses_normal_ht+0x1934b, %rsi
lea addresses_WC_ht+0x24eb, %rdi
clflush (%rsi)
nop
nop
nop
...
nop
cmp %r14, %r14
lea addresses_WC_ht+0x12c4b, %r9
nop
nop
nop
nop
...
{'OP': 'LOAD', 'src': {'type': 'addresses_normal_ht', 'AVXalign': False, 'congruent': 8, 'size': 32, 'same': False, 'NT': True}}
