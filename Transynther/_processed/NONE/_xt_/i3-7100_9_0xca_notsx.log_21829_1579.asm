...
nop
sub %rcx, %rcx
lea addresses_A_ht+0x1b485, %rsi
lea addresses_UC_ht+0x15385, %rdi
clflush (%rdi)
nop
nop
nop
...
nop
add $1916, %rsi
lea addresses_D_ht+0x1a585, %rcx
inc %r10
...
nop
inc %rdi
lea addresses_WT_ht+0xe545, %r10
and $64168, %rsi
...
nop
inc %rax
lea addresses_WT_ht+0x16685, %r14
sub %rdi, %rdi
movb $0x61, (%r14)
nop
nop
...
{'src': {'type': 'addresses_A_ht', 'congruent': 8, 'same': False}, 'OP': 'REPM', 'dst': {'type': 'addresses_UC_ht', 'congruent': 7, 'same': False}}
