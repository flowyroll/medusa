...
push %rdx
push %rsi
lea addresses_WC_ht+0x17931, %rcx
xor $40448, %r12
...
nop
inc %r11
lea addresses_normal_ht+0x4d81, %rdx
nop
nop
dec %rcx
movb $0x61, (%rdx)
...
nop
dec %r11
lea addresses_A_ht+0xc989, %rsi
lea addresses_normal_ht+0x8fa4, %rdi
nop
nop
nop
nop
...
nop
sub $11987, %rdx
lea addresses_D_ht+0x15946, %rsi
lea addresses_UC_ht+0x3279, %rdi
nop
nop
nop
nop
...
nop
xor $52915, %r8
lea addresses_D_ht+0x109c9, %r12
xor %rcx, %rcx
movb $0x61, (%r12)
nop
nop
cmp %r8, %r8
lea addresses_A_ht+0x6d49, %r11
nop
nop
nop
sub $31755, %rbx
...
nop
sub $31551, %r8
lea addresses_WT_ht+0x2475, %r12
nop
nop
nop
nop
...
{'OP': 'STOR', 'dst': {'type': 'addresses_WT', 'AVXalign': False, 'congruent': 10, 'size': 16, 'same': False, 'NT': True}}
[Faulty Load]
...
{'OP': 'REPM', 'src': {'type': 'addresses_A_ht', 'congruent': 4, 'same': False}, 'dst': {'type': 'addresses_normal_ht', 'congruent': 0, 'same': False}}
