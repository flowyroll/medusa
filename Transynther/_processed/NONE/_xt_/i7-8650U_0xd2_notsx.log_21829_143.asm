...
push %rdi
push %rsi
lea addresses_WC_ht+0x9e3d, %rsi
nop
sub %rcx, %rcx
movl $0x61626364, (%rsi)
nop
...
nop
dec %r10
lea addresses_WC_ht+0x1bcbd, %rsi
lea addresses_WC_ht+0x803d, %rdi
nop
nop
nop
sub $59751, %r9
...
nop
xor %rsi, %rsi
lea addresses_UC_ht+0x1c929, %rbp
nop
nop
nop
nop
...
nop
dec %rcx
lea addresses_normal_ht+0x1823d, %rbp
sub $14700, %r10
movb (%rbp), %cl
nop
nop
and $63300, %r9
lea addresses_D_ht+0x11fd4, %rsi
lea addresses_A_ht+0x1be3d, %rdi
nop
nop
xor $40188, %r14
mov $79, %rcx
...
{'OP': 'REPM', 'src': {'type': 'addresses_WC_ht', 'congruent': 7, 'same': True}, 'dst': {'type': 'addresses_WC_ht', 'congruent': 9, 'same': False}}
