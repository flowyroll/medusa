...
push %rdi
push %rsi
lea addresses_WC_ht+0xf879, %r15
and %r10, %r10
mov (%r15), %r9
nop
inc %r15
lea addresses_D_ht+0x3179, %rsi
nop
nop
nop
and %rdi, %rdi
...
movq %rbp, (%rsi)
xor %rbp, %rbp
lea addresses_WC_ht+0x10a79, %r9
nop
nop
nop
nop
...
nop
sub %rsi, %rsi
lea addresses_D_ht+0x13479, %rsi
cmp $57410, %r12
movl $0x61626364, (%rsi)
nop
nop
nop
xor $51859, %rdi
lea addresses_WC_ht+0xe4f9, %rsi
nop
nop
nop
nop
...
nop
add %r12, %r12
lea addresses_WT_ht+0x17da5, %rdi
nop
nop
nop
nop
...
nop
sub $21315, %rdi
lea addresses_A_ht+0x1379, %rsi
lea addresses_WC_ht+0x100f9, %rdi
nop
lfence
mov $56, %rcx
rep movsl
nop
sub $21309, %rcx
lea addresses_WT_ht+0xaa99, %rsi
lea addresses_normal_ht+0x7879, %rdi
nop
nop
dec %r9
mov $45, %rcx
...
nop
and %rcx, %rcx
lea addresses_UC_ht+0xd78b, %r10
nop
nop
nop
sub $64204, %r12
...
{'src': {'congruent': 8, 'same': False, 'type': 'addresses_A_ht'}, 'dst': {'congruent': 6, 'same': False, 'type': 'addresses_WC_ht'}, 'OP': 'REPM'}
