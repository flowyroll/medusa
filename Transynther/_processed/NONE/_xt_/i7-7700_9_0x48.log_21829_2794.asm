...
movaps %xmm6, (%rbp)
and %rbp, %rbp
lea addresses_WT_ht+0x18831, %r14
nop
nop
nop
nop
...
// Store
lea addresses_normal+0x17822, %rax
clflush (%rax)
nop
xor $44436, %r9
