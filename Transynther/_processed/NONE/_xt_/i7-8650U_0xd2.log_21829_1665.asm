...
push %rdx
push %rsi
lea addresses_A_ht+0x12da1, %rax
nop
nop
nop
dec %r15
...
movups %xmm3, (%r8)
and %r8, %r8
lea addresses_WC_ht+0x16f31, %r15
nop
nop
xor %rdx, %rdx
movw $0x6162, (%r15)
nop
xor $49982, %rax
lea addresses_UC_ht+0x18bb9, %r8
nop
nop
nop
nop
...
nop
cmp %rsi, %rsi
lea addresses_WC_ht+0xfa28, %rsi
nop
nop
nop
nop
...
nop
and $38354, %rsi
lea addresses_A_ht+0x1ae61, %r15
clflush (%r15)
add %rsi, %rsi
mov (%r15), %edi
nop
...
nop
sub %r11, %r11
lea addresses_normal_ht+0x5ba1, %rdi
nop
nop
nop
nop
