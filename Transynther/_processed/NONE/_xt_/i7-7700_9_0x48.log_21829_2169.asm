...
nop
sub %r14, %r14
lea addresses_A_ht+0xaaf7, %r13
nop
cmp $316, %rsi
mov $0x6162636465666768, %r11
movq %r11, (%r13)
and $29758, %r9
lea addresses_WC_ht+0x62f7, %rsi
nop
and %r8, %r8
movw $0x6162, (%rsi)
nop
add $54730, %r14
lea addresses_UC_ht+0x6f7, %r13
nop
nop
nop
and $35006, %r9
...
nop
and %r14, %r14
lea addresses_A_ht+0x7239, %rsi
lea addresses_WT_ht+0x1bdf7, %rdi
nop
and $50178, %r8
mov $72, %rcx
rep movsw
...
nop
sub $64713, %rcx
lea addresses_WC_ht+0x166f7, %rsi
lea addresses_normal_ht+0x17a47, %rdi
nop
nop
inc %r9
mov $94, %rcx
...
nop
add %rcx, %rcx
lea addresses_UC_ht+0x146f7, %r14
nop
xor $15448, %rsi
...
nop
cmp %r14, %r14
lea addresses_UC_ht+0x136d7, %rdi
nop
nop
nop
nop
...
nop
sub %rdi, %rdi
lea addresses_D_ht+0x1b6f7, %rsi
lea addresses_WC_ht+0x5b57, %rdi
cmp $18179, %r11
mov $14, %rcx
rep movsq
nop
...
// Faulty Load
lea addresses_normal+0x66f7, %r10
nop
nop
and $13260, %rax
movb (%r10), %r9b
