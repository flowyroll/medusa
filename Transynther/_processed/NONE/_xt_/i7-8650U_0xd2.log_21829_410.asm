...
push %rdx
push %rsi
lea addresses_normal_ht+0xf4da, %rsi
nop
xor $49813, %rdi
vmovups (%rsi), %ymm2
...
vpextrq $0, %xmm3, %rdx
dec %r8
lea addresses_UC_ht+0x1946a, %rcx
nop
nop
sub %r9, %r9
movw $0x6162, (%rcx)
nop
sub %r9, %r9
lea addresses_D_ht+0x702a, %rsi
lea addresses_UC_ht+0x486a, %rdi
nop
nop
nop
nop
...
nop
and %rbp, %rbp
lea addresses_WC_ht+0x18a62, %rdi
nop
nop
inc %rcx
vmovups (%rdi), %ymm2
...
nop
xor %r9, %r9
lea addresses_WT_ht+0x119ea, %rdi
nop
nop
nop
nop
...
nop
dec %rsi
lea addresses_D_ht+0x2e6a, %rsi
lea addresses_normal_ht+0x2e6a, %rdi
nop
nop
nop
nop
