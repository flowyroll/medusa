...
nop
xor %rcx, %rcx
lea addresses_normal_ht+0x17dba, %r10
nop
nop
nop
add $63767, %r12
...
nop
add $22322, %rdi
lea addresses_UC_ht+0x132da, %rcx
nop
nop
nop
nop
...
nop
add %r11, %r11
lea addresses_UC_ht+0x101da, %rsi
lea addresses_A_ht+0xa8da, %rdi
nop
nop
nop
cmp $30973, %rbp
...
rep movsq
xor $8301, %rsi
lea addresses_normal_ht+0x138ce, %rsi
lea addresses_UC_ht+0xf8da, %rdi
nop
and %r12, %r12
mov $12, %rcx
rep movsl
...
nop
sub $36599, %r10
lea addresses_D_ht+0x164da, %rsi
lea addresses_WT_ht+0xfc2a, %rdi
nop
nop
nop
nop
...
rep movsw
sub $7437, %rbp
lea addresses_normal_ht+0xaf7a, %rcx
nop
nop
add $49183, %rbp
mov (%rcx), %r12w
...
nop
and $9663, %rbp
lea addresses_UC_ht+0x863a, %rbp
cmp %r12, %r12
vmovups (%rbp), %ymm0
...
nop
sub $61121, %r10
lea addresses_WT_ht+0xa4a, %rsi
lea addresses_WC_ht+0x13cda, %rdi
nop
nop
nop
nop
...
rep movsl
xor %rcx, %rcx
lea addresses_D_ht+0x1d6da, %r10
nop
nop
cmp $53721, %r12
movb (%r10), %r11b
...
{'src': {'congruent': 2, 'AVXalign': False, 'same': False, 'size': 2, 'NT': False, 'type': 'addresses_D'}, 'OP': 'LOAD'}
[Faulty Load]
...
{'src': {'congruent': 3, 'same': False, 'type': 'addresses_WT_ht'}, 'OP': 'REPM', 'dst': {'congruent': 11, 'same': True, 'type': 'addresses_WC_ht'}}
