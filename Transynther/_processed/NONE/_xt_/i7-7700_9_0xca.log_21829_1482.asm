...
push %rdx
push %rsi
lea addresses_normal_ht+0x196f2, %rbp
cmp $60963, %rcx
vmovups (%rbp), %ymm2
vextracti128 $0, %ymm2, %xmm2
vpextrq $0, %xmm2, %r14
inc %r15
lea addresses_UC_ht+0xb0ea, %rbp
nop
nop
nop
nop
...
nop
cmp $1713, %rbx
lea addresses_WT_ht+0x1b562, %r15
clflush (%r15)
nop
cmp %rdx, %rdx
...
nop
xor $7641, %r15
lea addresses_UC_ht+0x1d79a, %rsi
lea addresses_normal_ht+0x251c, %rdi
nop
nop
nop
nop
...
nop
add $64273, %rdx
lea addresses_UC_ht+0x772a, %rsi
lea addresses_UC_ht+0x2132, %rdi
nop
nop
nop
nop
...
nop
dec %rcx
lea addresses_D_ht+0x177ea, %r15
nop
nop
inc %r12
mov (%r15), %cx
nop
sub $685, %rdi
lea addresses_normal_ht+0x17812, %rbx
nop
nop
dec %r14
movb $0x61, (%rbx)
inc %r15
lea addresses_WT_ht+0x432c, %rbx
nop
nop
xor %rdx, %rdx
vmovups (%rbx), %ymm4
...
nop
and %r12, %r12
lea addresses_normal_ht+0x1419a, %rbp
cmp $51252, %rcx
mov (%rbp), %r14d
nop
nop
...
nop
sub %r12, %r12
lea addresses_WC_ht+0x1639a, %rsi
lea addresses_A_ht+0x1b35a, %rdi
nop
nop
nop
nop
...
nop
cmp $26414, %r14
lea addresses_WT_ht+0xc11a, %rbp
nop
nop
nop
nop
...
lea addresses_UC_ht+0x1b0ca, %rdi
nop
nop
nop
nop
...
nop
xor $6259, %r15
lea addresses_normal_ht+0x1e79a, %r15
nop
nop
nop
xor %rbp, %rbp
...
nop
and %rdx, %rdx
lea addresses_WC_ht+0xb792, %rsi
...
{'src': {'congruent': 8, 'same': False, 'type': 'addresses_UC_ht'}, 'OP': 'REPM', 'dst': {'congruent': 1, 'same': True, 'type': 'addresses_normal_ht'}}
{'src': {'congruent': 4, 'same': False, 'type': 'addresses_UC_ht'}, 'OP': 'REPM', 'dst': {'congruent': 3, 'same': False, 'type': 'addresses_UC_ht'}}
...
{'src': {'congruent': 1, 'same': False, 'type': 'addresses_WC_ht'}, 'OP': 'REPM', 'dst': {'congruent': 9, 'same': False, 'type': 'addresses_A_ht'}}
{'33': 21829}
