...
nop
cmp $7134, %rdx
lea addresses_WT_ht+0x18257, %r10
nop
nop
nop
nop
...
nop
add %r14, %r14
lea addresses_A_ht+0xc02f, %rsi
lea addresses_A_ht+0x1663f, %rdi
nop
nop
nop
nop
...
rep movsl
sub %rsi, %rsi
lea addresses_normal_ht+0x143f, %r13
sub $8709, %rbp
...
mov (%rsi), %ecx
sub $26620, %r11
lea addresses_UC_ht+0xb83f, %r10
nop
nop
nop
nop
...
// Store
lea addresses_normal+0x15f3f, %r11
clflush (%r11)
nop
nop
nop
...
// Load
lea addresses_normal+0xf13f, %rdi
nop
nop
nop
xor %r11, %r11
...
{'OP': 'LOAD', 'src': {'type': 'addresses_normal', 'size': 32, 'AVXalign': False, 'NT': False, 'congruent': 8, 'same': False}}
[Faulty Load]
