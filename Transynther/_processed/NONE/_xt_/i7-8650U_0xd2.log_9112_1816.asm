...
nop
add $65019, %r15
lea addresses_WT_ht+0x8ce4, %r13
clflush (%r13)
nop
add $16349, %rdx
movl $0x61626364, (%r13)
...
nop
sub %rdx, %rdx
lea addresses_WT_ht+0x13ca4, %rsi
lea addresses_WC_ht+0x14164, %rdi
nop
add $43080, %r14
mov $73, %rcx
rep movsw
...
{'OP': 'REPM', 'src': {'type': 'addresses_WT_ht', 'congruent': 5, 'same': False}, 'dst': {'type': 'addresses_WC_ht', 'congruent': 6, 'same': False}}
{'33': 9112}
