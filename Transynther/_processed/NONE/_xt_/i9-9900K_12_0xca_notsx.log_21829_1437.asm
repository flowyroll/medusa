...
nop
dec %r12
lea addresses_WT_ht+0x542f, %r12
nop
nop
nop
xor %r15, %r15
...
nop
xor $64685, %r15
lea addresses_WC_ht+0x6547, %rsi
nop
nop
xor %rax, %rax
...
lea addresses_UC_ht+0x19cc7, %rdi
clflush (%rdi)
nop
nop
nop
...
nop
dec %rax
lea addresses_normal_ht+0x1289b, %r15
add $1619, %r8
mov (%r15), %rax
nop
nop
...
nop
xor %rsi, %rsi
lea addresses_WC_ht+0x4a47, %rcx
nop
sub %rsi, %rsi
