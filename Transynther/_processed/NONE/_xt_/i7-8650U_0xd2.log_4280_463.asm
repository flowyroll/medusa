...
push %rdi
push %rsi
lea addresses_WT_ht+0x10f6a, %r8
nop
nop
add $6582, %rsi
movl $0x61626364, (%r8)
...
nop
xor %rsi, %rsi
lea addresses_WC_ht+0x5e4a, %rdi
nop
nop
nop
and $18670, %r10
...
nop
xor $50177, %r10
lea addresses_WT_ht+0x9c36, %rsi
lea addresses_A_ht+0x544a, %rdi
cmp %r11, %r11
mov $99, %rcx
rep movsw
xor $29282, %rdi
lea addresses_WC_ht+0x6e75, %r11
nop
nop
nop
nop
...
// Faulty Load
lea addresses_normal+0x1b24a, %r10
nop
nop
nop
nop
