...
nop
inc %rcx
lea addresses_D_ht+0x1cded, %r10
nop
xor %rcx, %rcx
movb (%r10), %r9b
nop
nop
xor %r9, %r9
lea addresses_normal_ht+0x11e0d, %r14
nop
nop
nop
nop
...
{'OP': 'LOAD', 'src': {'type': 'addresses_D_ht', 'AVXalign': True, 'congruent': 5, 'size': 1, 'same': False, 'NT': False}}
