...
push %rbp
push %rsi
lea addresses_WT_ht+0x1c984, %r14
nop
nop
nop
nop
...
nop
and $64254, %r13
lea addresses_normal_ht+0xae84, %r13
nop
nop
nop
nop
...
movb $0x61, (%r13)
and $49330, %r14
lea addresses_WC_ht+0x106ac, %r13
cmp $24383, %rax
mov (%r13), %r14d
nop
nop
sub $40111, %rbp
lea addresses_A_ht+0xda3e, %r13
nop
nop
cmp $54506, %r11
movl $0x61626364, (%r13)
...
nop
add %r11, %r11
lea addresses_D_ht+0x12d58, %r15
cmp %r11, %r11
movb $0x61, (%r15)
nop
sub %r11, %r11
lea addresses_UC_ht+0xced4, %r11
nop
nop
nop
and %r15, %r15
...
nop
and %rbp, %rbp
lea addresses_normal_ht+0x1cd84, %rbp
nop
nop
nop
nop
...
nop
cmp $31363, %r13
lea addresses_normal_ht+0x1d324, %r14
nop
nop
add $19326, %r13
...
// REPMOV
mov $0x3bf9670000000c44, %rsi
lea addresses_UC+0xf584, %rdi
nop
nop
add %r8, %r8
mov $0, %rcx
...
{'src': {'type': 'addresses_NC', 'congruent': 4, 'same': False}, 'dst': {'type': 'addresses_UC', 'congruent': 11, 'same': False}, 'OP': 'REPM'}
[Faulty Load]
