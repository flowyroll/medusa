...
push %rdx
push %rsi
lea addresses_A_ht+0xd80c, %rbx
nop
sub $17881, %rax
mov $0x6162636465666768, %rdx
movq %rdx, (%rbx)
xor $14591, %r8
lea addresses_normal_ht+0x11a1c, %rsi
lea addresses_WT_ht+0x387c, %rdi
clflush (%rsi)
nop
nop
nop
...
nop
and %r8, %r8
lea addresses_UC_ht+0x1a80c, %rcx
xor $13802, %rax
movb (%rcx), %bl
nop
nop
...
nop
add %rdx, %rdx
lea addresses_D_ht+0x1720c, %rsi
lea addresses_A_ht+0x1e80c, %rdi
nop
nop
nop
nop
...
nop
add %rcx, %rcx
lea addresses_WT_ht+0x1560c, %rsi
lea addresses_WC_ht+0xe3ca, %rdi
nop
nop
nop
sub %rbp, %rbp
...
nop
xor $6827, %rdi
lea addresses_UC_ht+0xdb3e, %rsi
lea addresses_WT_ht+0xd76c, %rdi
nop
nop
nop
sub %r8, %r8
...
nop
sub %rbp, %rbp
lea addresses_normal_ht+0xf00c, %rsi
lea addresses_WC_ht+0x1439c, %rdi
nop
nop
nop
nop
...
nop
add %rdi, %rdi
lea addresses_A_ht+0x1463c, %rsi
lea addresses_D_ht+0xe40c, %rdi
clflush (%rdi)
nop
sub $64719, %rbx
mov $96, %rcx
...
{'src': {'type': 'addresses_normal_ht', 'congruent': 4, 'same': False}, 'dst': {'type': 'addresses_WT_ht', 'congruent': 4, 'same': False}, 'OP': 'REPM'}
