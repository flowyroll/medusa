...
nop
cmp $27329, %rcx
lea addresses_A_ht+0x1c71c, %rsi
lea addresses_A_ht+0x8d84, %rdi
nop
sub %rdx, %rdx
mov $27, %rcx
rep movsq
...
nop
xor $34060, %r10
lea addresses_A_ht+0x1ac84, %rsi
lea addresses_UC_ht+0x566c, %rdi
nop
nop
nop
nop
...
nop
add %rsi, %rsi
lea addresses_WT_ht+0x1b34, %rdx
nop
nop
nop
nop
...
movq %rdi, (%r12)
mfence
lea addresses_WT_ht+0x13e84, %rsi
lea addresses_normal_ht+0x1ec84, %rdi
cmp %r10, %r10
mov $98, %rcx
rep movsw
nop
...
lea addresses_A_ht+0x18584, %rdi
nop
nop
nop
nop
...
nop
add %r8, %r8
lea addresses_WT_ht+0x1350c, %rdi
clflush (%rdi)
xor $58313, %rdx
movb (%rdi), %cl
nop
and $65156, %rsi
lea addresses_normal_ht+0x3644, %rsi
lea addresses_D_ht+0xdc44, %rdi
nop
nop
nop
cmp $38838, %r13
...
nop
xor %rdi, %rdi
lea addresses_normal_ht+0x2264, %r10
clflush (%r10)
nop
nop
nop
...
vmovups %ymm2, (%r10)
sub $17452, %r13
lea addresses_normal_ht+0x173c4, %r13
clflush (%r13)
nop
nop
nop
...
{'OP': 'LOAD', 'src': {'type': 'addresses_RW', 'size': 1, 'AVXalign': False, 'NT': False, 'congruent': 11, 'same': False}}
[Faulty Load]
...
{'OP': 'REPM', 'src': {'type': 'addresses_normal_ht', 'congruent': 6, 'same': False}, 'dst': {'type': 'addresses_D_ht', 'congruent': 5, 'same': False}}
