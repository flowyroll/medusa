...
push %rdx
push %rsi
lea addresses_UC_ht+0x1e669, %rdx
nop
nop
nop
nop
...
movb (%r13), %r10b
cmp $63263, %rdi
lea addresses_A_ht+0xba69, %rsi
lea addresses_A_ht+0x9269, %rdi
nop
nop
cmp %rdx, %rdx
mov $23, %rcx
...
nop
add $16534, %r8
lea addresses_UC_ht+0x8369, %rdx
nop
nop
nop
xor %r13, %r13
...
movq %r8, (%rdx)
add %rdx, %rdx
lea addresses_UC_ht+0x1e869, %rax
nop
xor %rsi, %rsi
...
// Store
lea addresses_normal+0xca69, %rcx
nop
nop
add $13061, %r9
...
{'src': {'congruent': 10, 'same': False, 'type': 'addresses_A_ht'}, 'dst': {'congruent': 9, 'same': False, 'type': 'addresses_A_ht'}, 'OP': 'REPM'}
{'dst': {'NT': False, 'AVXalign': True, 'size': 8, 'congruent': 8, 'same': False, 'type': 'addresses_D_ht'}, 'OP': 'STOR'}
