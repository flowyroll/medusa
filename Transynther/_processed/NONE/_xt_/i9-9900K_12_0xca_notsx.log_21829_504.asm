...
push %rdi
push %rsi
lea addresses_normal_ht+0x19c2a, %rax
nop
nop
nop
nop
...
mov (%rax), %r14d
xor %rdi, %rdi
lea addresses_A_ht+0x131da, %rax
nop
and %rcx, %rcx
movw $0x6162, (%rax)
nop
nop
and $22052, %r14
lea addresses_UC_ht+0xbc2a, %rsi
lea addresses_D_ht+0xfe3a, %rdi
nop
nop
nop
xor $43367, %rbp
...
// REPMOV
lea addresses_UC+0xf3ea, %rsi
lea addresses_UC+0x1cd6a, %rdi
clflush (%rdi)
cmp $40717, %rax
mov $34, %rcx
rep movsl
