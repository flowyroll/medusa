...
nop
lfence
lea addresses_UC_ht+0x56d3, %rsi
lea addresses_WT_ht+0x6753, %rdi
xor %r13, %r13
mov $27, %rcx
rep movsq
nop
...
nop
cmp $41898, %r15
lea addresses_normal_ht+0x22d3, %rcx
nop
nop
nop
nop
...
nop
sub %rcx, %rcx
lea addresses_WC_ht+0x17813, %rsi
lea addresses_WC_ht+0x102d3, %rdi
nop
nop
inc %r15
mov $63, %rcx
...
<gen_faulty_load>
[REF]
{'src': {'type': 'addresses_RW', 'AVXalign': True, 'size': 8, 'NT': False, 'same': False, 'congruent': 0}, 'OP': 'LOAD'}
[Faulty Load]
