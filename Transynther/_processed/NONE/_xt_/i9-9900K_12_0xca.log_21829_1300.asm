...
nop
sub %r12, %r12
lea addresses_normal_ht+0xa323, %rsi
lea addresses_D_ht+0x1b987, %rdi
clflush (%rdi)
nop
nop
nop
...
rep movsl
cmp %rbx, %rbx
lea addresses_UC_ht+0x3cf0, %rsi
lea addresses_UC_ht+0x1afd7, %rdi
nop
xor %rdx, %rdx
mov $25, %rcx
rep movsw
nop
and %rbp, %rbp
lea addresses_WC_ht+0x19507, %r12
sub $11299, %rbx
movl $0x61626364, (%r12)
nop
nop
...
{'OP': 'REPM', 'src': {'same': False, 'type': 'addresses_normal_ht', 'congruent': 0}, 'dst': {'same': False, 'type': 'addresses_D_ht', 'congruent': 9}}
{'OP': 'REPM', 'src': {'same': True, 'type': 'addresses_UC_ht', 'congruent': 0}, 'dst': {'same': False, 'type': 'addresses_UC_ht', 'congruent': 4}}
