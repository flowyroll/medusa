...
nop
cmp $41820, %r15
lea addresses_normal_ht+0x4be3, %rsi
lea addresses_WC_ht+0x17443, %rdi
clflush (%rdi)
nop
nop
cmp $14576, %rbp
...
nop
sub $58177, %rcx
lea addresses_normal_ht+0xe237, %rsi
lea addresses_A_ht+0x9d3f, %rdi
nop
nop
nop
xor %rbp, %rbp
...
vmovups %ymm3, (%r9)
cmp $62268, %rdx
lea addresses_WC_ht+0x129e3, %rsi
clflush (%rsi)
nop
xor $60252, %rcx
movb $0x61, (%rsi)
nop
dec %rbp
lea addresses_A_ht+0x13ae3, %r15
nop
nop
nop
and $14340, %r9
...
nop
xor %rcx, %rcx
lea addresses_D_ht+0xbbe3, %rsi
lea addresses_UC_ht+0x83e3, %rdi
clflush (%rsi)
nop
cmp %r15, %r15
mov $112, %rcx
...
{'dst': {'NT': False, 'AVXalign': True, 'size': 1, 'congruent': 2, 'same': False, 'type': 'addresses_UC'}, 'OP': 'STOR'}
{'dst': {'NT': True, 'AVXalign': False, 'size': 32, 'congruent': 1, 'same': False, 'type': 'addresses_P'}, 'OP': 'STOR'}
[Faulty Load]
...
{'src': {'congruent': 8, 'same': False, 'type': 'addresses_normal_ht'}, 'dst': {'congruent': 4, 'same': False, 'type': 'addresses_WC_ht'}, 'OP': 'REPM'}
