...
// Store
lea addresses_normal+0xd005, %r13
nop
nop
and $54803, %rax
movw $0x5152, (%r13)
...
// REPMOV
lea addresses_WC+0x1c6a9, %rsi
lea addresses_WT+0xeb59, %rdi
nop
nop
xor %r12, %r12
mov $96, %rcx
...
{'src': {'type': 'addresses_WT', 'same': False, 'size': 4, 'congruent': 10, 'NT': False, 'AVXalign': True}, 'OP': 'LOAD'}
...
{'src': {'type': 'addresses_WC', 'congruent': 2, 'same': False}, 'dst': {'type': 'addresses_WT', 'congruent': 2, 'same': False}, 'OP': 'REPM'}
