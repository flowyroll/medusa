...
push %rdi
push %rsi
lea addresses_WC_ht+0x13847, %r9
add $62700, %r8
vmovups (%r9), %ymm1
...
nop
inc %r8
lea addresses_normal_ht+0xfcc7, %rsi
nop
inc %rcx
vmovups (%rsi), %ymm2
...
nop
sub $813, %rcx
lea addresses_WC_ht+0x2647, %r11
nop
nop
nop
nop
...
nop
cmp %r11, %r11
lea addresses_WT_ht+0x15047, %rsi
lea addresses_D_ht+0x1b787, %rdi
nop
nop
nop
and %r9, %r9
...
nop
dec %r8
lea addresses_UC_ht+0x12f6f, %rsi
nop
dec %rbx
...
nop
xor %rsi, %rsi
lea addresses_normal_ht+0x441f, %rcx
nop
nop
sub $48841, %rsi
...
nop
add %r9, %r9
lea addresses_normal_ht+0x1abc7, %rsi
lea addresses_UC_ht+0x12347, %rdi
nop
nop
nop
nop
...
nop
xor $45246, %r11
lea addresses_normal_ht+0x1e647, %r9
xor $61132, %r8
...
nop
and $21082, %rcx
lea addresses_WC_ht+0x6047, %rsi
lea addresses_WT_ht+0x1136b, %rdi
nop
nop
nop
nop
...
rep movsq
add $57656, %rdi
lea addresses_normal_ht+0xf3a7, %rsi
clflush (%rsi)
nop
nop
nop
...
nop
sub $33854, %rbx
lea addresses_WT_ht+0xaa11, %rsi
lea addresses_WC_ht+0x18fc7, %rdi
nop
nop
nop
nop
...
// Faulty Load
lea addresses_normal+0xe047, %rax
nop
nop
nop
nop
