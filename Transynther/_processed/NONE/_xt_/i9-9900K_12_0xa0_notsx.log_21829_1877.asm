...
push %rdx
push %rsi
lea addresses_D_ht+0x6089, %rsi
lea addresses_D_ht+0xab69, %rdi
dec %r12
mov $120, %rcx
rep movsq
nop
nop
sub %r10, %r10
lea addresses_UC_ht+0x15ab9, %rsi
lea addresses_UC_ht+0x35e0, %rdi
nop
nop
cmp %r13, %r13
mov $106, %rcx
...
nop
and $36194, %rcx
lea addresses_D_ht+0xfea3, %rsi
lea addresses_WT_ht+0x16089, %rdi
nop
nop
nop
nop
...
nop
cmp %rsi, %rsi
lea addresses_WC_ht+0x14889, %rsi
nop
nop
nop
nop
...
vpextrq $0, %xmm7, %rcx
xor %rdi, %rdi
lea addresses_D_ht+0x1b7cd, %rsi
lea addresses_WC_ht+0x11409, %rdi
nop
and %rbx, %rbx
mov $110, %rcx
rep movsb
...
nop
add $8494, %r10
lea addresses_normal_ht+0x19fe7, %rbx
nop
nop
nop
nop
...
nop
xor $24515, %rdx
lea addresses_WT_ht+0x15f91, %rsi
nop
nop
nop
nop
...
nop
inc %rcx
lea addresses_WC_ht+0x5489, %rsi
lea addresses_D_ht+0x3889, %rdi
nop
nop
nop
nop
...
nop
xor %r13, %r13
lea addresses_UC_ht+0x6c49, %rdi
nop
nop
nop
nop
...
<gen_prepare_buffer>
{'src': {'type': 'addresses_D_ht', 'congruent': 11, 'same': False}, 'OP': 'REPM', 'dst': {'type': 'addresses_D_ht', 'congruent': 5, 'same': False}}
...
{'src': {'type': 'addresses_D_ht', 'congruent': 1, 'same': False}, 'OP': 'REPM', 'dst': {'type': 'addresses_WC_ht', 'congruent': 2, 'same': True}}
