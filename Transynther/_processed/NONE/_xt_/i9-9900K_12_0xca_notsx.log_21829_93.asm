...
push %rdx
push %rsi
lea addresses_WC_ht+0x11b9e, %rsi
lea addresses_normal_ht+0x1c49e, %rdi
lfence
mov $102, %rcx
rep movsq
nop
...
nop
and %r9, %r9
lea addresses_D_ht+0x14bbe, %r14
inc %rdx
movl $0x61626364, (%r14)
nop
nop
...
nop
sub %r14, %r14
lea addresses_D_ht+0x16b9e, %r14
nop
nop
nop
dec %rsi
...
nop
xor $60841, %rcx
lea addresses_WT_ht+0x8436, %rdi
nop
nop
and %r14, %r14
movups (%rdi), %xmm6
...
nop
and $31413, %rsi
lea addresses_A_ht+0x1039e, %r14
nop
nop
xor %r10, %r10
movups (%r14), %xmm4
...
<gen_prepare_buffer>
{'OP': 'REPM', 'src': {'same': False, 'congruent': 10, 'type': 'addresses_WC_ht'}, 'dst': {'same': True, 'congruent': 7, 'type': 'addresses_normal_ht'}}
