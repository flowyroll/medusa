...
push %rdi
push %rsi
lea addresses_WT_ht+0xf3ef, %r12
nop
nop
nop
nop
...
vpextrq $1, %xmm0, %rbx
inc %rbx
lea addresses_A_ht+0x1c285, %r11
nop
nop
cmp %r15, %r15
movw $0x6162, (%r11)
nop
inc %r15
lea addresses_UC_ht+0x13ef, %rsi
lea addresses_UC_ht+0x12f87, %rdi
clflush (%rdi)
nop
nop
nop
...
nop
cmp %rbx, %rbx
lea addresses_UC_ht+0x11ea6, %r12
nop
nop
nop
nop
...
mov (%r12), %r15
xor $270, %r8
lea addresses_WC_ht+0x1b7ef, %rbx
nop
nop
nop
cmp $6520, %rdi
...
nop
cmp %r11, %r11
lea addresses_D_ht+0x13f2f, %rbx
nop
nop
nop
sub $10232, %r8
...
{'src': {'type': 'addresses_UC_ht', 'congruent': 6, 'same': False}, 'dst': {'type': 'addresses_UC_ht', 'congruent': 0, 'same': False}, 'OP': 'REPM'}
...
{'src': {'type': 'addresses_D_ht', 'same': True, 'size': 8, 'congruent': 6, 'NT': False, 'AVXalign': False}, 'OP': 'LOAD'}
{'33': 21829}
