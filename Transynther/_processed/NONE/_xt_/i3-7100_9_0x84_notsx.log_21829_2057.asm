...
push %rdx
push %rsi
lea addresses_WC_ht+0x172c0, %rsi
...
nop
and %r8, %r8
lea addresses_WC_ht+0xa5cc, %rdx
nop
nop
nop
xor $36109, %rbx
...
movw $0x6162, (%rsi)
sub %rdi, %rdi
lea addresses_UC_ht+0x55cc, %r13
nop
nop
nop
sub $3214, %rdx
...
nop
xor %rsi, %rsi
lea addresses_WC_ht+0x197ac, %rdi
clflush (%rdi)
nop
nop
nop
...
nop
cmp %rsi, %rsi
lea addresses_UC_ht+0x111cc, %rcx
clflush (%rcx)
nop
xor %r8, %r8
movw $0x6162, (%rcx)
...
{'src': {'type': 'addresses_P', 'congruent': 4, 'same': False}, 'dst': {'type': 'addresses_US', 'congruent': 7, 'same': False}, 'OP': 'REPM'}
[Faulty Load]
{'src': {'type': 'addresses_RW', 'same': True, 'size': 4, 'congruent': 0, 'NT': False, 'AVXalign': False}, 'OP': 'LOAD'}
<gen_prepare_buffer>
{'src': {'type': 'addresses_WC_ht', 'congruent': 2, 'same': False}, 'dst': {'type': 'addresses_WT_ht', 'congruent': 3, 'same': False}, 'OP': 'REPM'}
