...
push %rdi
push %rsi
lea addresses_WC_ht+0x86ab, %rsi
lea addresses_D_ht+0xce6b, %rdi
clflush (%rdi)
nop
nop
nop
...
rep movsb
xor %rdi, %rdi
lea addresses_WC_ht+0x14bab, %rsi
lea addresses_WT_ht+0x18bab, %rdi
nop
inc %rbx
mov $65, %rcx
rep movsb
...
mov (%rbp), %r12
sub %rbx, %rbx
lea addresses_D_ht+0x133ab, %rbx
nop
nop
dec %r12
vmovups (%rbx), %ymm2
...
nop
xor %rbp, %rbp
lea addresses_UC_ht+0x9fab, %rbp
nop
nop
add $61229, %r15
...
nop
add $45357, %r15
lea addresses_D_ht+0x1d3ab, %rsi
lea addresses_A_ht+0x1b74b, %rdi
nop
and $40449, %rbx
mov $17, %rcx
rep movsq
...
// REPMOV
lea addresses_WC+0x17303, %rsi
lea addresses_normal+0x1e7ab, %rdi
cmp %rax, %rax
mov $41, %rcx
rep movsq
nop
...
{'OP': 'REPM', 'src': {'type': 'addresses_WC', 'congruent': 0, 'same': False}, 'dst': {'type': 'addresses_normal', 'congruent': 8, 'same': False}}
[Faulty Load]
...
{'OP': 'REPM', 'src': {'type': 'addresses_WC_ht', 'congruent': 11, 'same': False}, 'dst': {'type': 'addresses_WT_ht', 'congruent': 11, 'same': False}}
