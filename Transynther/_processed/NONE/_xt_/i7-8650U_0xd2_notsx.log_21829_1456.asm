...
push %rdi
push %rsi
lea addresses_UC_ht+0x1b3ca, %r12
clflush (%r12)
nop
nop
nop
...
nop
xor %r9, %r9
lea addresses_WC_ht+0x9b22, %rcx
nop
nop
nop
sub $56186, %r13
...
nop
and %rcx, %rcx
lea addresses_WC_ht+0x7d02, %rcx
nop
nop
xor %r11, %r11
mov (%rcx), %r9
...
nop
sub %r15, %r15
lea addresses_UC_ht+0x1906e, %rsi
lea addresses_WC_ht+0x19782, %rdi
clflush (%rdi)
nop
nop
xor %r9, %r9
...
nop
cmp %r9, %r9
lea addresses_normal_ht+0x16502, %r12
clflush (%r12)
nop
nop
nop
...
{'OP': 'LOAD', 'src': {'type': 'addresses_WC_ht', 'size': 8, 'AVXalign': False, 'NT': True, 'congruent': 7, 'same': False}}
{'OP': 'REPM', 'src': {'type': 'addresses_UC_ht', 'congruent': 1, 'same': False}, 'dst': {'type': 'addresses_WC_ht', 'congruent': 10, 'same': True}}
