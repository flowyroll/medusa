...
push %rdx
push %rsi
lea addresses_WC_ht+0x2f10, %r15
nop
nop
nop
cmp $51630, %rax
...
nop
cmp $19066, %rbx
lea addresses_UC_ht+0x12bc8, %rsi
lea addresses_UC_ht+0x16a2a, %rdi
clflush (%rdi)
nop
nop
nop
...
// REPMOV
lea addresses_WT+0x1654a, %rsi
lea addresses_A+0x260a, %rdi
clflush (%rsi)
nop
inc %r9
mov $29, %rcx
...
{'src': {'type': 'addresses_WT', 'congruent': 4, 'same': False}, 'OP': 'REPM', 'dst': {'type': 'addresses_A', 'congruent': 4, 'same': False}}
{'OP': 'STOR', 'dst': {'same': False, 'congruent': 7, 'NT': False, 'type': 'addresses_P', 'size': 4, 'AVXalign': False}}
[Faulty Load]
