...
push %rdi
push %rsi
lea addresses_WT_ht+0x14a39, %rcx
nop
nop
nop
nop
...
nop
and %r13, %r13
lea addresses_normal_ht+0x12939, %rsi
lea addresses_WC_ht+0x15739, %rdi
add $13862, %rbp
mov $121, %rcx
rep movsq
nop
and %rbp, %rbp
lea addresses_A_ht+0x12e39, %r13
nop
nop
sub $11652, %r9
...
movq %rcx, (%r13)
cmp %rsi, %rsi
lea addresses_normal_ht+0x189e1, %rsi
nop
dec %rdi
movl $0x61626364, (%rsi)
nop
...
nop
xor %rcx, %rcx
lea addresses_UC_ht+0x1a139, %rsi
lea addresses_normal_ht+0x10139, %rdi
clflush (%rdi)
sub $14476, %r11
mov $34, %rcx
rep movsw
...
nop
dec %rdi
lea addresses_WT_ht+0xca89, %rsi
...
nop
add %rbp, %rbp
lea addresses_UC_ht+0xd539, %rdi
nop
nop
nop
nop
...
nop
dec %rcx
lea addresses_A_ht+0x11eb9, %rax
cmp $9987, %rdi
movups (%rax), %xmm7
vpextrq $0, %xmm7, %r13
sub %rax, %rax
