...
nop
sub $2953, %r10
lea addresses_WC_ht+0x6819, %rsi
clflush (%rsi)
nop
nop
nop
...
nop
add $47617, %r15
lea addresses_UC_ht+0x12119, %r15
dec %rcx
mov (%r15), %r10w
nop
nop
...
lea addresses_UC_ht+0x11d19, %rdi
nop
nop
nop
dec %rbx
...
nop
cmp %r15, %r15
lea addresses_normal_ht+0x10919, %r11
nop
nop
nop
nop
...
nop
cmp $61167, %rsi
lea addresses_A_ht+0x1e259, %rsi
lea addresses_WT_ht+0x1b699, %rdi
nop
nop
nop
nop
