...
nop
add %r10, %r10
lea addresses_UC_ht+0x174f8, %rsi
lea addresses_normal_ht+0x10098, %rdi
nop
nop
add %r11, %r11
mov $123, %rcx
...
nop
cmp %r9, %r9
lea addresses_WT_ht+0x4eb8, %rdi
nop
add %r10, %r10
movb (%rdi), %cl
nop
nop
and %rdi, %rdi
lea addresses_WT_ht+0x13438, %r15
nop
nop
nop
sub %rsi, %rsi
...
{'OP': 'STOR', 'dst': {'type': 'addresses_PSE', 'size': 8, 'AVXalign': True, 'NT': True, 'congruent': 6, 'same': False}}
[Faulty Load]
