...
push %rdi
push %rsi
lea addresses_WC_ht+0x15532, %r9
nop
nop
nop
nop
...
nop
and %r11, %r11
lea addresses_WT_ht+0x1d912, %rsi
...
nop
sub $28174, %rcx
lea addresses_D_ht+0xa19e, %rsi
lea addresses_WC_ht+0xc9e1, %rdi
xor $14530, %rax
mov $87, %rcx
rep movsl
and $14839, %rax
lea addresses_A_ht+0x64b2, %rsi
lea addresses_D_ht+0x1828a, %rdi
cmp %rax, %rax
mov $55, %rcx
rep movsl
nop
...
nop
inc %rsi
lea addresses_WC_ht+0x12012, %r9
nop
nop
nop
add %rbp, %rbp
...
nop
xor %r14, %r14
lea addresses_normal_ht+0x14dfc, %r9
nop
nop
nop
nop
...
// REPMOV
lea addresses_PSE+0xd2de, %rsi
lea addresses_A+0x7612, %rdi
nop
nop
nop
nop
...
{'src': {'type': 'addresses_PSE', 'congruent': 2, 'same': False}, 'OP': 'REPM', 'dst': {'type': 'addresses_A', 'congruent': 11, 'same': False}}
...
{'src': {'type': 'addresses_A_ht', 'congruent': 4, 'same': True}, 'OP': 'REPM', 'dst': {'type': 'addresses_D_ht', 'congruent': 3, 'same': False}}
{'src': {'type': 'addresses_WC_ht', 'AVXalign': False, 'size': 16, 'NT': False, 'same': False, 'congruent': 9}, 'OP': 'LOAD'}
{'src': {'type': 'addresses_normal_ht', 'AVXalign': True, 'size': 1, 'NT': False, 'same': True, 'congruent': 1}, 'OP': 'LOAD'}
{'36': 21829}
