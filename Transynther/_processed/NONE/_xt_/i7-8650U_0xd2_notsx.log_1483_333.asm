...
nop
xor %rdi, %rdi
lea addresses_D_ht+0xb656, %rsi
lea addresses_A_ht+0x14c56, %rdi
clflush (%rdi)
nop
nop
nop
...
nop
sub %rax, %rax
lea addresses_WC_ht+0x1b297, %rsi
lea addresses_normal_ht+0x19fee, %rdi
add %r14, %r14
mov $46, %rcx
rep movsl
sub %r14, %r14
lea addresses_normal_ht+0x17b16, %rcx
nop
nop
nop
nop
...
nop
cmp %rdi, %rdi
lea addresses_UC_ht+0x14b16, %rax
nop
nop
nop
inc %rsi
...
nop
sub $33508, %rdi
lea addresses_UC_ht+0x13316, %r9
nop
nop
nop
nop
...
nop
cmp %rax, %rax
lea addresses_normal_ht+0xb216, %rdi
nop
sub $1607, %rsi
movl $0x61626364, (%rdi)
nop
...
lea addresses_D_ht+0x1ec14, %rdi
nop
nop
nop
nop
...
nop
add $11663, %rax
lea addresses_WT_ht+0x1e8ce, %r9
nop
nop
nop
xor %rax, %rax
mov (%r9), %r13d
sub $17622, %r9
lea addresses_A_ht+0xa516, %rsi
lea addresses_WC_ht+0x15846, %rdi
nop
nop
cmp %r9, %r9
mov $61, %rcx
...
lea addresses_WT_ht+0xd716, %rdi
nop
nop
cmp %r11, %r11
mov $53, %rcx
...
nop
and %rcx, %rcx
lea addresses_WC_ht+0x1d616, %rax
nop
nop
nop
nop
...
nop
sub $37510, %r14
lea addresses_WT_ht+0x14b16, %r13
nop
nop
cmp $11647, %rsi
movups (%r13), %xmm1
...
nop
and $35396, %r14
lea addresses_normal_ht+0x4316, %rax
nop
nop
nop
nop
...
{'OP': 'REPM', 'src': {'type': 'addresses_D_ht', 'congruent': 6, 'same': False}, 'dst': {'type': 'addresses_A_ht', 'congruent': 6, 'same': False}}
...
{'OP': 'REPM', 'src': {'type': 'addresses_WC_ht', 'congruent': 6, 'same': False}, 'dst': {'type': 'addresses_WT_ht', 'congruent': 8, 'same': False}}
...
{'OP': 'STOR', 'dst': {'type': 'addresses_normal_ht', 'size': 1, 'AVXalign': False, 'NT': False, 'congruent': 10, 'same': True}}
{'38': 1483}
