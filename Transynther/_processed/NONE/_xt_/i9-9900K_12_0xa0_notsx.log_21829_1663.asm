...
nop
xor $48404, %rax
lea addresses_WC_ht+0x7357, %rsi
nop
nop
nop
xor %r10, %r10
...
nop
xor $53501, %r12
lea addresses_normal_ht+0x69c7, %rsi
lea addresses_normal_ht+0x2129, %rdi
nop
nop
nop
nop
...
nop
and %r13, %r13
lea addresses_D_ht+0x18cf7, %rsi
lea addresses_UC_ht+0x110f7, %rdi
clflush (%rsi)
nop
nop
nop
...
nop
xor %rcx, %rcx
lea addresses_D_ht+0x169ef, %rdi
nop
dec %rcx
...
{'src': {'type': 'addresses_WT', 'AVXalign': False, 'size': 32, 'NT': False, 'same': False, 'congruent': 8}, 'OP': 'LOAD'}
[Faulty Load]
...
{'src': {'type': 'addresses_normal_ht', 'congruent': 2, 'same': False}, 'OP': 'REPM', 'dst': {'type': 'addresses_normal_ht', 'congruent': 0, 'same': False}}
