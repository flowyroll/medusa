...
push %rdi
push %rsi
lea addresses_A_ht+0x108df, %rcx
nop
nop
nop
nop
...
nop
dec %rbp
lea addresses_WT_ht+0x1bfdf, %rsi
lea addresses_WT_ht+0x3259, %rdi
nop
xor %rbx, %rbx
mov $96, %rcx
rep movsq
...
nop
add $60518, %rbx
lea addresses_WC_ht+0x1107f, %rcx
nop
nop
nop
nop
...
nop
xor $34262, %rdi
lea addresses_D_ht+0x182af, %rsi
nop
nop
nop
and $37514, %r10
...
nop
and $62622, %rdi
lea addresses_UC_ht+0xa0df, %rbx
and %rbp, %rbp
movb (%rbx), %cl
nop
nop
inc %rcx
lea addresses_WC_ht+0x90df, %rcx
inc %rbx
movb (%rcx), %r10b
nop
nop
...
{'src': {'NT': True, 'same': False, 'congruent': 4, 'type': 'addresses_WC_ht', 'AVXalign': False, 'size': 2}, 'OP': 'LOAD'}
