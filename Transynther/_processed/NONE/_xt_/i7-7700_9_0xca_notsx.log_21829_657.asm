...
nop
and $40714, %r12
lea addresses_WT_ht+0x2c5f, %rbx
clflush (%rbx)
nop
xor %r13, %r13
mov (%rbx), %r12d
...
nop
sub $9115, %r13
lea addresses_WC_ht+0x8c89, %r13
nop
nop
nop
nop
...
nop
add %r13, %r13
lea addresses_D_ht+0xd49, %rsi
lea addresses_normal_ht+0x10b49, %rdi
nop
nop
nop
nop
...
// REPMOV
lea addresses_normal+0x7b49, %rsi
lea addresses_UC+0x1db49, %rdi
clflush (%rdi)
add $21795, %r9
mov $15, %rcx
rep movsw
...
// Faulty Load
lea addresses_normal+0x7b49, %r9
nop
nop
nop
add %r13, %r13
...
{'src': {'congruent': 0, 'same': True, 'type': 'addresses_normal'}, 'dst': {'congruent': 8, 'same': False, 'type': 'addresses_UC'}, 'OP': 'REPM'}
[Faulty Load]
