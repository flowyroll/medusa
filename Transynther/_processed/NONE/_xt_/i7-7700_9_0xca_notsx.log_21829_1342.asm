...
push %rdi
push %rsi
lea addresses_D_ht+0x16861, %rsi
lea addresses_WC_ht+0x1d8f7, %rdi
nop
nop
nop
sub %r13, %r13
...
nop
and %r10, %r10
lea addresses_A_ht+0x13bb7, %rsi
nop
cmp $25909, %r10
...
nop
and %r8, %r8
lea addresses_A_ht+0x1d6f7, %rsi
lea addresses_WC_ht+0x681d, %rdi
nop
xor %r15, %r15
mov $28, %rcx
rep movsq
...
nop
add $35211, %r8
lea addresses_D_ht+0x1a3c7, %rsi
lea addresses_normal_ht+0x16fc7, %rdi
clflush (%rdi)
nop
and $50486, %r10
mov $58, %rcx
...
nop
cmp %rsi, %rsi
lea addresses_D_ht+0x10489, %rsi
...
nop
cmp $46395, %rcx
lea addresses_WC_ht+0xa27, %rsi
lea addresses_WC_ht+0x10177, %rdi
nop
nop
nop
nop
...
rep movsq
sub %r9, %r9
lea addresses_UC_ht+0x592b, %r13
nop
nop
nop
nop
...
// Store
lea addresses_normal+0xfd17, %rsi
add %r9, %r9
movw $0x5152, (%rsi)
nop
nop
...
<gen_prepare_buffer>
{'src': {'congruent': 1, 'same': False, 'type': 'addresses_D_ht'}, 'dst': {'congruent': 4, 'same': False, 'type': 'addresses_WC_ht'}, 'OP': 'REPM'}
...
{'src': {'congruent': 1, 'same': False, 'type': 'addresses_D_ht'}, 'dst': {'congruent': 6, 'same': False, 'type': 'addresses_D_ht'}, 'OP': 'REPM'}
{'src': {'congruent': 3, 'same': True, 'type': 'addresses_WC_ht'}, 'dst': {'congruent': 6, 'same': False, 'type': 'addresses_WC_ht'}, 'OP': 'REPM'}
