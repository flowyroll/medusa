...
nop
and %r10, %r10
lea addresses_WT_ht+0xba69, %rax
and $57965, %rcx
movups (%rax), %xmm1
vpextrq $1, %xmm1, %r8
nop
and $4813, %rcx
lea addresses_WT_ht+0x28b9, %rax
sub %r13, %r13
...
nop
inc %r8
lea addresses_WT_ht+0xe615, %rsi
lea addresses_A_ht+0x10469, %rdi
nop
nop
nop
dec %r15
...
{'src': {'type': 'addresses_WT_ht', 'congruent': 1, 'same': False}, 'dst': {'type': 'addresses_A_ht', 'congruent': 8, 'same': True}, 'OP': 'REPM'}
