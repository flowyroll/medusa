...
push %rdi
push %rsi
lea addresses_D_ht+0x177ab, %rsi
lea addresses_A_ht+0x10c93, %rdi
nop
nop
nop
nop
...
nop
and %rbp, %rbp
lea addresses_normal_ht+0x1dccb, %rsi
lea addresses_A_ht+0x12a4b, %rdi
xor %rax, %rax
mov $3, %rcx
rep movsw
nop
nop
cmp %rax, %rax
lea addresses_WT_ht+0x4d4b, %rcx
and $57532, %rbp
...
nop
and $26044, %rdi
lea addresses_WT_ht+0xf0cb, %rax
nop
sub $5107, %r8
mov (%rax), %ebp
nop
...
nop
and %rcx, %rcx
lea addresses_normal_ht+0x11bee, %rdi
nop
nop
nop
nop
...
nop
add %rbx, %rbx
lea addresses_UC_ht+0x214b, %rcx
nop
and $57511, %rax
mov (%rcx), %rdi
sub $8228, %rdi
...
// Store
lea addresses_normal+0x454b, %r14
nop
nop
cmp $5311, %r12
