...
lea addresses_A_ht+0x16e69, %rdi
clflush (%rdi)
nop
nop
dec %rbx
...
rep movsq
and %r12, %r12
lea addresses_D_ht+0x11789, %r12
nop
nop
add %rbp, %rbp
mov (%r12), %si
...
nop
sub %rbx, %rbx
lea addresses_WC_ht+0x1b629, %rdi
nop
add $1671, %rbp
movl $0x61626364, (%rdi)
cmp $17078, %rsi
lea addresses_normal_ht+0x1069, %rbx
nop
nop
nop
nop
...
nop
dec %rcx
lea addresses_WC_ht+0x7069, %rsi
nop
nop
nop
nop
...
movw $0x6162, (%rsi)
xor %rsi, %rsi
lea addresses_UC_ht+0xe18d, %rsi
lea addresses_UC_ht+0x607d, %rdi
nop
nop
nop
nop
...
rep movsw
and %r8, %r8
lea addresses_WT_ht+0x69, %rsi
lea addresses_normal_ht+0x1b969, %rdi
nop
nop
nop
nop
...
nop
add $41931, %rdi
lea addresses_D_ht+0x17d29, %rsi
lea addresses_A_ht+0x4be9, %rdi
clflush (%rdi)
cmp $47183, %rbx
mov $106, %rcx
rep movsq
...
// Faulty Load
lea addresses_normal+0x4069, %r11
nop
sub %rdx, %rdx
movups (%r11), %xmm1
vpextrq $1, %xmm1, %rcx
