...
push %rdi
push %rsi
lea addresses_WT_ht+0x1692, %r12
nop
nop
nop
sub %r14, %r14
...
nop
sub $25958, %rbp
lea addresses_D_ht+0x1efce, %r10
nop
add %r9, %r9
movw $0x6162, (%r10)
nop
nop
inc %rbp
lea addresses_A_ht+0x13252, %rbp
nop
nop
nop
nop
...
nop
cmp $46679, %rbx
lea addresses_WC_ht+0x5d32, %rbp
sub $53141, %r14
...
nop
sub $12053, %r15
lea addresses_UC_ht+0x1cdd2, %r15
sub $64661, %rbp
movb $0x61, (%r15)
dec %rbp
lea addresses_D_ht+0x1ddd2, %r10
nop
cmp %r14, %r14
movb (%r10), %r9b
xor %r9, %r9
lea addresses_UC_ht+0x143ba, %r14
nop
nop
nop
nop
...
nop
add $61998, %rbp
lea addresses_UC_ht+0x459e, %r15
nop
add $65005, %rbx
mov (%r15), %r9d
nop
...
nop
and %rbp, %rbp
lea addresses_normal_ht+0x7e92, %rsi
lea addresses_D_ht+0x4b53, %rdi
nop
nop
nop
nop
...
nop
add $64813, %r14
lea addresses_WT_ht+0x1e692, %r12
clflush (%r12)
nop
nop
nop
...
nop
sub %rbx, %rbx
lea addresses_WC_ht+0xc3fa, %r10
nop
nop
inc %r12
mov $0x6162636465666768, %r9
...
nop
inc %r10
lea addresses_UC_ht+0x19912, %r10
nop
nop
dec %rsi
vmovups (%r10), %ymm0
...
nop
cmp $19334, %rbp
lea addresses_WC_ht+0x1e892, %rsi
lea addresses_UC_ht+0x179ba, %rdi
nop
nop
nop
nop
...
{'OP': 'LOAD', 'src': {'same': False, 'type': 'addresses_D_ht', 'NT': True, 'AVXalign': False, 'size': 1, 'congruent': 4}}
{'OP': 'LOAD', 'src': {'same': False, 'type': 'addresses_UC_ht', 'NT': True, 'AVXalign': True, 'size': 32, 'congruent': 2}}
{'OP': 'LOAD', 'src': {'same': False, 'type': 'addresses_UC_ht', 'NT': False, 'AVXalign': False, 'size': 4, 'congruent': 2}}
{'OP': 'REPM', 'src': {'same': False, 'congruent': 11, 'type': 'addresses_normal_ht'}, 'dst': {'same': False, 'congruent': 0, 'type': 'addresses_D_ht'}}
