...
push %rdi
push %rsi
lea addresses_WT_ht+0x140db, %r9
clflush (%r9)
nop
nop
dec %r11
...
nop
add $59296, %rcx
lea addresses_WT_ht+0x21db, %rsi
lea addresses_WC_ht+0x947b, %rdi
nop
nop
nop
nop
...
nop
xor $1234, %rdi
lea addresses_normal_ht+0xd83b, %rsi
nop
nop
nop
xor %r9, %r9
...
nop
add %r11, %r11
lea addresses_D_ht+0x1463b, %rbx
cmp %r9, %r9
mov (%rbx), %rsi
nop
nop
...
nop
cmp $38875, %rsi
lea addresses_UC_ht+0x1be3b, %r11
nop
cmp $14868, %rbx
vmovups (%r11), %ymm3
...
nop
dec %rbx
lea addresses_WT_ht+0x303b, %r12
nop
nop
nop
dec %rdi
...
nop
add $39726, %r9
lea addresses_D_ht+0x1443b, %r11
cmp $19846, %rbx
movb (%r11), %r9b
nop
nop
...
nop
inc %rcx
lea addresses_WC_ht+0xba9b, %rbx
nop
nop
dec %r12
movb $0x61, (%rbx)
...
// Faulty Load
lea addresses_normal+0x8c3b, %rdx
nop
sub %rcx, %rcx
movups (%rdx), %xmm5
vpextrq $0, %xmm5, %rdi
...
{'src': {'type': 'addresses_WT_ht', 'congruent': 11, 'same': True}, 'OP': 'REPM', 'dst': {'type': 'addresses_D_ht', 'congruent': 5, 'same': False}}
...
{'src': {'same': True, 'congruent': 10, 'NT': False, 'type': 'addresses_D_ht', 'size': 1, 'AVXalign': False}, 'OP': 'LOAD'}
