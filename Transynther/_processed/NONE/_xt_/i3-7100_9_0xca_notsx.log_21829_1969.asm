...
nop
and %rdx, %rdx
lea addresses_UC_ht+0xa5f6, %rcx
nop
nop
nop
mfence
...
nop
add %rdx, %rdx
lea addresses_UC_ht+0xe0ca, %r14
nop
nop
nop
nop
...
nop
add $64037, %rsi
lea addresses_WC_ht+0x1090a, %rcx
nop
nop
nop
nop
...
nop
sub $54228, %rdi
lea addresses_normal_ht+0x5bca, %rsi
lea addresses_WT_ht+0x181ba, %rdi
nop
nop
nop
nop
...
movb (%rsi), %dl
cmp %rsi, %rsi
lea addresses_D_ht+0x4b0a, %rsi
lea addresses_WC_ht+0xdb0a, %rdi
nop
nop
nop
inc %r9
...
nop
xor %r9, %r9
lea addresses_WC_ht+0x17b0a, %rsi
lea addresses_UC_ht+0x16aa3, %rdi
and %rax, %rax
mov $77, %rcx
rep movsb
nop
...
{'OP': 'STOR', 'dst': {'same': False, 'congruent': 0, 'NT': False, 'type': 'addresses_UC_ht', 'size': 8, 'AVXalign': True}}
{'src': {'same': False, 'congruent': 4, 'NT': False, 'type': 'addresses_UC_ht', 'size': 2, 'AVXalign': True}, 'OP': 'LOAD'}
{'OP': 'STOR', 'dst': {'same': True, 'congruent': 8, 'NT': False, 'type': 'addresses_WC_ht', 'size': 32, 'AVXalign': False}}
...
{'src': {'type': 'addresses_D_ht', 'congruent': 10, 'same': False}, 'OP': 'REPM', 'dst': {'type': 'addresses_WC_ht', 'congruent': 10, 'same': False}}
