...
nop
lfence
lea addresses_normal_ht+0x6822, %r15
nop
sub $22141, %r9
mov (%r15), %r10d
nop
sub $8838, %r14
lea addresses_D_ht+0x4822, %r15
xor $51029, %r12
vmovups (%r15), %ymm7
...
nop
add %r11, %r11
lea addresses_UC_ht+0x18e0a, %rsi
lea addresses_WT_ht+0x4908, %rdi
nop
nop
nop
nop
...
lea addresses_WT_ht+0xe2e2, %rdi
dec %r9
mov $21, %rcx
rep movsb
nop
