...
nop
inc %r15
lea addresses_WC_ht+0x5fb8, %r11
nop
and %rbx, %rbx
movw $0x6162, (%r11)
nop
xor $43927, %rsi
lea addresses_A_ht+0x9378, %rsi
lea addresses_A_ht+0xde58, %rdi
and %r15, %r15
mov $49, %rcx
rep movsb
nop
cmp $47417, %rsi
lea addresses_A_ht+0x11f8, %rdi
nop
xor $16658, %r12
...
{'src': {'same': False, 'congruent': 10, 'NT': False, 'type': 'addresses_US', 'size': 32, 'AVXalign': False}, 'OP': 'LOAD'}
...
{'src': {'same': False, 'congruent': 10, 'NT': False, 'type': 'addresses_UC', 'size': 4, 'AVXalign': False}, 'OP': 'LOAD'}
[Faulty Load]
