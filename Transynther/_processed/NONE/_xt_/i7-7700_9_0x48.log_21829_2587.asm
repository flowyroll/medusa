...
nop
and $3816, %rsi
lea addresses_normal_ht+0x11694, %rbx
nop
nop
nop
nop
...
nop
add $46830, %rdx
lea addresses_A_ht+0xee4, %rsi
lea addresses_A_ht+0x19e44, %rdi
nop
nop
nop
cmp %r11, %r11
...
nop
xor %r14, %r14
lea addresses_WC_ht+0x1ce4, %rdx
nop
nop
inc %rbp
movb $0x61, (%rdx)
inc %rsi
lea addresses_A_ht+0x1ddd4, %rcx
nop
nop
nop
nop
...
nop
sub $19852, %rcx
lea addresses_WT_ht+0x1df7c, %rsi
nop
nop
nop
nop
...
nop
cmp $44568, %rsi
lea addresses_UC_ht+0x170e4, %r11
nop
cmp $28674, %rbp
movb $0x61, (%r11)
nop
...
nop
xor $51975, %rdx
lea addresses_normal_ht+0x10284, %rdi
add %rbp, %rbp
vmovups (%rdi), %ymm0
...
{'OP': 'LOAD', 'src': {'type': 'addresses_A', 'AVXalign': False, 'congruent': 1, 'size': 4, 'same': False, 'NT': False}}
[Faulty Load]
...
{'OP': 'STOR', 'dst': {'type': 'addresses_D_ht', 'AVXalign': True, 'congruent': 0, 'size': 4, 'same': False, 'NT': False}}
...
{'OP': 'LOAD', 'src': {'type': 'addresses_normal_ht', 'AVXalign': False, 'congruent': 4, 'size': 32, 'same': True, 'NT': False}}
{'36': 21829}
