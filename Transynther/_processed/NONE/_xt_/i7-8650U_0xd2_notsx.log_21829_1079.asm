...
nop
add $30277, %r8
lea addresses_A_ht+0x3b6b, %rsi
lea addresses_UC_ht+0x1d3cb, %rdi
nop
nop
nop
nop
...
nop
and %r11, %r11
lea addresses_normal_ht+0x1c40b, %rsi
lea addresses_WC_ht+0x13e4b, %rdi
nop
add $33668, %r10
mov $123, %rcx
rep movsw
...
nop
sub $54573, %rdi
lea addresses_normal_ht+0x8293, %r13
clflush (%r13)
nop
nop
nop
...
movb $0x61, (%r13)
sub %r8, %r8
lea addresses_WT_ht+0xa92b, %rcx
nop
nop
nop
nop
...
nop
sub %r8, %r8
lea addresses_A_ht+0x13dcb, %rcx
nop
add %r10, %r10
mov (%rcx), %r13d
xor $24655, %r11
lea addresses_A_ht+0x15dcb, %rcx
nop
and $55122, %rsi
...
nop
and %r8, %r8
lea addresses_WT_ht+0x1dc6e, %r10
xor %r13, %r13
vmovups (%r10), %ymm5
...
nop
add %r13, %r13
lea addresses_A_ht+0x29cb, %rsi
lea addresses_normal_ht+0x15fd3, %rdi
nop
nop
nop
nop
...
nop
xor %rsi, %rsi
lea addresses_normal_ht+0xd9cb, %rsi
lea addresses_D_ht+0x17029, %rdi
inc %r11
mov $71, %rcx
rep movsb
nop
...
{'OP': 'REPM', 'src': {'type': 'addresses_A_ht', 'congruent': 8, 'same': False}, 'dst': {'type': 'addresses_normal_ht', 'congruent': 3, 'same': False}}
