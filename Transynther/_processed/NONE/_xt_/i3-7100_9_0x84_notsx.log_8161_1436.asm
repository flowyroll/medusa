...
lea addresses_WC_ht+0x1003a, %rdi
nop
nop
nop
and %r13, %r13
...
nop
dec %r14
lea addresses_WC_ht+0x1b03a, %rax
nop
nop
nop
nop
...
nop
sub $61712, %rcx
lea addresses_WT_ht+0x1ec3a, %rsi
lea addresses_normal_ht+0x2369, %rdi
nop
nop
nop
nop
...
nop
xor %r13, %r13
lea addresses_WT_ht+0x24ba, %r13
nop
inc %rbp
movb $0x61, (%r13)
nop
...
nop
sub %rax, %rax
lea addresses_normal_ht+0xdc3a, %rcx
nop
nop
nop
sub %rbp, %rbp
mov (%rcx), %r13d
sub $59018, %r13
lea addresses_UC_ht+0x6872, %r15
nop
nop
nop
nop
...
nop
sub %r13, %r13
lea addresses_A_ht+0x1c79a, %r15
nop
nop
nop
nop
...
nop
and %r14, %r14
lea addresses_WT_ht+0x1397a, %r15
nop
dec %rsi
mov (%r15), %r13
nop
nop
and $5046, %r14
lea addresses_WC_ht+0x10c3a, %rax
nop
nop
cmp %rsi, %rsi
...
nop
and %r13, %r13
lea addresses_WT_ht+0x81d2, %rcx
nop
nop
dec %rsi
vmovups (%rcx), %ymm7
...
nop
cmp %rbp, %rbp
lea addresses_UC_ht+0x16fba, %rbp
nop
nop
xor %rdi, %rdi
...
nop
sub $30460, %r13
lea addresses_D_ht+0x1009a, %rbp
nop
nop
nop
sub $40367, %rsi
...
nop
inc %rcx
lea addresses_A_ht+0x1c47a, %rsi
lea addresses_WT_ht+0x12a3a, %rdi
nop
nop
nop
xor %r13, %r13
...
{'dst': {'type': 'addresses_NC', 'same': False, 'size': 1, 'congruent': 2, 'NT': True, 'AVXalign': False}, 'OP': 'STOR'}
[Faulty Load]
{'src': {'type': 'addresses_RW', 'same': True, 'size': 2, 'congruent': 0, 'NT': False, 'AVXalign': False}, 'OP': 'LOAD'}
<gen_prepare_buffer>
{'src': {'type': 'addresses_normal_ht', 'congruent': 9, 'same': False}, 'dst': {'type': 'addresses_WC_ht', 'congruent': 9, 'same': False}, 'OP': 'REPM'}
...
{'src': {'type': 'addresses_WT_ht', 'congruent': 11, 'same': True}, 'dst': {'type': 'addresses_normal_ht', 'congruent': 0, 'same': False}, 'OP': 'REPM'}
...
{'dst': {'type': 'addresses_WC_ht', 'same': True, 'size': 8, 'congruent': 10, 'NT': False, 'AVXalign': True}, 'OP': 'STOR'}
