...
push %rdi
push %rsi
lea addresses_WC_ht+0xdae1, %rsi
lea addresses_D_ht+0x8aa1, %rdi
clflush (%rsi)
nop
nop
nop
...
nop
dec %rdi
lea addresses_normal_ht+0x10119, %r13
nop
inc %r9
mov (%r13), %r14
nop
...
nop
cmp $31216, %r9
lea addresses_WC_ht+0x18fc1, %r13
nop
nop
nop
nop
...
nop
add $30623, %r13
lea addresses_WC_ht+0x5961, %r13
nop
nop
nop
inc %r9
...
<gen_prepare_buffer>
{'OP': 'REPM', 'src': {'same': False, 'congruent': 7, 'type': 'addresses_WC_ht'}, 'dst': {'same': False, 'congruent': 6, 'type': 'addresses_D_ht'}}
