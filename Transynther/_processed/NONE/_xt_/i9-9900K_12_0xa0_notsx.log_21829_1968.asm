...
push %rdx
push %rsi
lea addresses_WT_ht+0xe68f, %rsi
lea addresses_A_ht+0x643, %rdi
nop
nop
nop
dec %r10
...
rep movsw
sub %rsi, %rsi
lea addresses_WC_ht+0x188d1, %rsi
lea addresses_UC_ht+0xeb0f, %rdi
clflush (%rdi)
nop
nop
nop
...
movb $0x61, (%rsi)
add %r11, %r11
lea addresses_D_ht+0x31f7, %rsi
lea addresses_D_ht+0x1028f, %rdi
nop
nop
nop
nop
...
nop
cmp %r10, %r10
lea addresses_normal_ht+0x3a8f, %r10
nop
cmp $54440, %rbp
mov (%r10), %rdx
nop
and $64557, %rdx
lea addresses_WT_ht+0x1428f, %rbp
nop
nop
nop
nop
...
nop
cmp %rsi, %rsi
lea addresses_normal_ht+0x6523, %rsi
nop
nop
nop
nop
...
movups %xmm7, (%rsi)
and $16376, %rbp
lea addresses_normal_ht+0x669f, %r11
nop
add %rdx, %rdx
...
// Faulty Load
lea addresses_normal+0x12e8f, %r13
and %r8, %r8
mov (%r13), %r9w
lea oracles, %r8
and $0xff, %r9
...
{'src': {'type': 'addresses_WC_ht', 'congruent': 0, 'same': True}, 'OP': 'REPM', 'dst': {'type': 'addresses_UC_ht', 'congruent': 7, 'same': False}}
...
{'OP': 'STOR', 'dst': {'type': 'addresses_normal_ht', 'AVXalign': False, 'size': 32, 'NT': False, 'same': True, 'congruent': 3}}
{'34': 21829}
