...
push %rdx
push %rsi
lea addresses_normal_ht+0x9acc, %rcx
nop
nop
nop
and %r9, %r9
...
nop
sub $14727, %r13
lea addresses_WC_ht+0x1d60a, %rdi
and %r8, %r8
vmovups (%rdi), %ymm1
...
nop
sub %r9, %r9
lea addresses_WT_ht+0xda7c, %rsi
lea addresses_D_ht+0x126fc, %rdi
clflush (%rdi)
nop
nop
sub $12033, %r11
...
nop
cmp $4321, %r9
lea addresses_WT_ht+0x130fc, %rsi
lea addresses_WC_ht+0x1dc3c, %rdi
cmp %rdx, %rdx
mov $38, %rcx
rep movsw
nop
...
nop
sub $35918, %r8
lea addresses_WC_ht+0x1ac0c, %rsi
lea addresses_UC_ht+0x1de6c, %rdi
nop
nop
nop
nop
...
nop
cmp %r8, %r8
lea addresses_normal_ht+0x10f04, %rdi
nop
nop
sub $12174, %rdx
mov (%rdi), %cx
...
nop
add %rdx, %rdx
lea addresses_D_ht+0x108fc, %rdx
nop
nop
nop
nop
...
nop
cmp %rdi, %rdi
lea addresses_UC_ht+0x120fc, %rdx
sub $34567, %rdi
movups (%rdx), %xmm7
vpextrq $0, %xmm7, %rcx
xor %rdx, %rdx
lea addresses_UC_ht+0x9316, %rcx
nop
nop
nop
and $33123, %rsi
...
nop
cmp $49572, %r9
lea addresses_normal_ht+0x13754, %rsi
lea addresses_WC_ht+0x8980, %rdi
nop
nop
nop
nop
...
nop
sub %rdx, %rdx
lea addresses_A_ht+0x15e74, %r11
nop
inc %r13
vmovups (%r11), %ymm2
...
// Faulty Load
lea addresses_normal+0x1e0fc, %rdx
clflush (%rdx)
nop
nop
nop
...
{'src': {'type': 'addresses_US', 'same': False, 'size': 32, 'congruent': 4, 'NT': False, 'AVXalign': False}, 'OP': 'LOAD'}
...
{'src': {'type': 'addresses_WT_ht', 'congruent': 11, 'same': False}, 'dst': {'type': 'addresses_WC_ht', 'congruent': 5, 'same': False}, 'OP': 'REPM'}
{'src': {'type': 'addresses_WC_ht', 'congruent': 4, 'same': False}, 'dst': {'type': 'addresses_UC_ht', 'congruent': 4, 'same': False}, 'OP': 'REPM'}
...
{'src': {'type': 'addresses_normal_ht', 'congruent': 1, 'same': False}, 'dst': {'type': 'addresses_WC_ht', 'congruent': 2, 'same': False}, 'OP': 'REPM'}
