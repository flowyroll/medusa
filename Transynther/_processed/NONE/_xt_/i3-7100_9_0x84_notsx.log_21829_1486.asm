...
push %rdx
push %rsi
lea addresses_D_ht+0x1b179, %r14
nop
nop
nop
nop
...
nop
add %r15, %r15
lea addresses_WT_ht+0x120b9, %r12
nop
nop
nop
and %r10, %r10
movb (%r12), %dl
dec %r12
lea addresses_normal_ht+0xb659, %r11
add %r9, %r9
movb $0x61, (%r11)
nop
nop
nop
xor $21655, %r9
lea addresses_normal_ht+0x10d79, %rsi
lea addresses_WC_ht+0x11b31, %rdi
nop
nop
nop
nop
...
rep movsl
cmp $6968, %r12
lea addresses_WC_ht+0xcf09, %rsi
lea addresses_D_ht+0x14f79, %rdi
nop
dec %r15
mov $121, %rcx
rep movsb
...
nop
add %r14, %r14
lea addresses_A_ht+0xf90d, %rsi
lea addresses_D_ht+0x2179, %rdi
cmp %r14, %r14
mov $103, %rcx
rep movsb
nop
nop
sub %r11, %r11
lea addresses_D_ht+0x12779, %r11
nop
nop
nop
nop
...
vmovups %ymm0, (%r11)
xor %r12, %r12
lea addresses_WC_ht+0x7079, %rdx
nop
and %r10, %r10
...
nop
mfence
lea addresses_normal_ht+0x7cf1, %rsi
inc %rcx
mov (%rsi), %rdi
sub %rsi, %rsi
pop %rsi
...
// Faulty Load
lea addresses_normal+0x1d979, %r13
nop
nop
nop
nop
