...
// REPMOV
lea addresses_A+0x7c81, %rsi
lea addresses_A+0x35a1, %rdi
nop
nop
nop
nop
...
// Store
lea addresses_normal+0xccb1, %rdi
nop
nop
and $52344, %rsi
movb $0x51, (%rdi)
...
{'src': {'type': 'addresses_A', 'congruent': 5, 'same': False}, 'dst': {'type': 'addresses_A', 'congruent': 0, 'same': True}, 'OP': 'REPM'}
