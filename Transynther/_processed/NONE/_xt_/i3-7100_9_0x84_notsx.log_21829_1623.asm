...
push %rdx
push %rsi
lea addresses_UC_ht+0x14e95, %rsi
lea addresses_WC_ht+0xa0a5, %rdi
nop
and $65493, %r12
mov $125, %rcx
rep movsb
...
nop
inc %rdx
lea addresses_WT_ht+0x1ab4e, %rsi
lea addresses_UC_ht+0x1d607, %rdi
clflush (%rsi)
nop
nop
nop
...
nop
cmp $40213, %rdi
lea addresses_UC_ht+0x1585a, %rsi
lea addresses_UC_ht+0x76de, %rdi
clflush (%rsi)
nop
nop
nop
...
nop
inc %r13
lea addresses_D_ht+0x1154e, %r15
nop
nop
nop
nop
...
nop
xor $17083, %rcx
lea addresses_WT_ht+0x5ffe, %rdx
sub $26975, %rsi
mov (%rdx), %r13d
nop
nop
...
<gen_prepare_buffer>
{'src': {'type': 'addresses_UC_ht', 'congruent': 0, 'same': False}, 'dst': {'type': 'addresses_WC_ht', 'congruent': 0, 'same': False}, 'OP': 'REPM'}
