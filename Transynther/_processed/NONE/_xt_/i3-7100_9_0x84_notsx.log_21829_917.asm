...
push %rdx
push %rsi
lea addresses_UC_ht+0x1047, %rdx
nop
nop
nop
and $8070, %rax
...
movaps %xmm6, (%rdx)
sub $45277, %r10
lea addresses_UC_ht+0x1ba37, %rsi
lea addresses_normal_ht+0x4937, %rdi
nop
nop
nop
dec %rax
...
nop
sub %r12, %r12
lea addresses_WC_ht+0xe1b7, %rsi
lea addresses_WT_ht+0x13f56, %rdi
nop
nop
nop
nop
...
nop
cmp %r10, %r10
lea addresses_UC_ht+0x129b7, %rsi
nop
nop
xor $3631, %rdx
mov (%rsi), %r9w
sub %r9, %r9
lea addresses_D_ht+0x72b7, %rsi
nop
add $8440, %r9
...
nop
add %rdx, %rdx
lea addresses_A_ht+0x1d5b7, %rsi
nop
nop
nop
nop
...
movw $0x6162, (%rsi)
and $36671, %rdi
lea addresses_WC_ht+0x1cae7, %rdi
clflush (%rdi)
nop
nop
nop
...
nop
and $17578, %r12
lea addresses_normal_ht+0x7db7, %rcx
nop
cmp $3348, %rax
movw $0x6162, (%rcx)
nop
...
nop
add $9485, %r12
lea addresses_UC_ht+0x45b7, %rsi
lea addresses_normal_ht+0xefb7, %rdi
nop
nop
add %r9, %r9
mov $21, %rcx
...
nop
sub $11475, %rax
lea addresses_WC_ht+0xe617, %rcx
clflush (%rcx)
nop
nop
nop
...
{'src': {'type': 'addresses_WC_ht', 'congruent': 10, 'same': False}, 'dst': {'type': 'addresses_WT_ht', 'congruent': 0, 'same': False}, 'OP': 'REPM'}
...
{'src': {'type': 'addresses_UC_ht', 'congruent': 11, 'same': False}, 'dst': {'type': 'addresses_normal_ht', 'congruent': 9, 'same': True}, 'OP': 'REPM'}
