...
push %rdi
push %rsi
lea addresses_WT_ht+0x7740, %rsi
nop
nop
dec %rbx
...
nop
sub $42641, %r11
lea addresses_WC_ht+0x1c840, %r9
clflush (%r9)
nop
inc %r14
...
nop
inc %r8
lea addresses_normal_ht+0x15c40, %r9
cmp $28746, %r14
mov $0x6162636465666768, %r8
movq %r8, %xmm0
vmovups %ymm0, (%r9)
...
nop
xor %rdi, %rdi
lea addresses_UC_ht+0x19040, %r8
nop
nop
nop
nop
...
nop
lfence
lea addresses_WC_ht+0x77d0, %rsi
nop
nop
nop
nop
...
nop
sub $15835, %r11
lea addresses_WC_ht+0x18610, %rbx
nop
nop
nop
nop
...
nop
and $15985, %r14
lea addresses_WC_ht+0x11340, %rsi
...
nop
sub %rcx, %rcx
lea addresses_normal_ht+0x6a60, %r8
and $5438, %rdi
mov (%r8), %r9
nop
nop
nop
inc %rbx
lea addresses_D_ht+0x1345a, %r11
nop
nop
and $37995, %rsi
...
nop
and $60328, %rdi
lea addresses_WC_ht+0x1e640, %rsi
lea addresses_UC_ht+0x11500, %rdi
nop
nop
nop
xor %r14, %r14
...
lea addresses_normal_ht+0x118c0, %rdi
nop
nop
nop
nop
...
{'src': {'type': 'addresses_WC_ht', 'congruent': 9, 'same': False}, 'dst': {'type': 'addresses_UC_ht', 'congruent': 2, 'same': False}, 'OP': 'REPM'}
{'src': {'type': 'addresses_WT_ht', 'congruent': 6, 'same': False}, 'dst': {'type': 'addresses_normal_ht', 'congruent': 3, 'same': False}, 'OP': 'REPM'}
{'36': 21829}
