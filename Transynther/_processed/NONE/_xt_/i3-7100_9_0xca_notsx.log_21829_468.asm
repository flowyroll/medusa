...
push %rdi
push %rsi
lea addresses_normal_ht+0x4cb, %r8
nop
nop
nop
nop
...
nop
add %r9, %r9
lea addresses_WT_ht+0x4e0b, %rbx
dec %rax
mov (%rbx), %r10w
nop
add $33628, %rcx
lea addresses_WT_ht+0x122cb, %rsi
lea addresses_D_ht+0x1e9cb, %rdi
nop
and %rax, %rax
mov $104, %rcx
rep movsw
...
// Load
lea addresses_normal+0x170cb, %r10
nop
nop
nop
xor $8947, %r12
...
// Faulty Load
lea addresses_normal+0x19acb, %r13
nop
nop
nop
and $63889, %r14
