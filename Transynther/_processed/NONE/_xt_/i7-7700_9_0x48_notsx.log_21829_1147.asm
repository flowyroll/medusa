...
push %rdx
push %rsi
lea addresses_WT_ht+0x1d795, %rcx
nop
nop
nop
nop
...
mov (%rcx), %rdx
xor $60020, %rax
lea addresses_normal_ht+0xcc5, %r10
clflush (%r10)
nop
nop
nop
...
movups %xmm6, (%r10)
cmp $59425, %r10
lea addresses_WT_ht+0x1bdf5, %rax
add $19180, %r15
movl $0x61626364, (%rax)
xor $2820, %rcx
lea addresses_normal_ht+0x14c55, %rsi
lea addresses_WC_ht+0x96a5, %rdi
nop
dec %r15
mov $67, %rcx
rep movsq
...
nop
sub %r10, %r10
lea addresses_UC_ht+0x13f48, %rbp
nop
nop
nop
add %r10, %r10
...
nop
cmp %rdx, %rdx
lea addresses_normal_ht+0x15cd5, %rsi
lea addresses_D_ht+0xd1dd, %rdi
nop
dec %r14
mov $66, %rcx
rep movsl
...
nop
and %rbp, %rbp
lea addresses_UC_ht+0x17f15, %rsi
lea addresses_A_ht+0x4a55, %rdi
clflush (%rdi)
nop
and $34939, %r10
mov $96, %rcx
...
nop
inc %rax
lea addresses_WC_ht+0x1b055, %rbp
nop
add $4842, %r14
movb $0x61, (%rbp)
nop
...
nop
sub $60803, %rdx
lea addresses_UC_ht+0x7075, %rsi
lea addresses_D_ht+0x14189, %rdi
nop
nop
nop
nop
...
rep movsw
and $39829, %rsi
lea addresses_normal_ht+0x179cd, %r15
nop
inc %rdx
movl $0x61626364, (%r15)
nop
...
nop
and $17703, %r14
lea addresses_WC_ht+0x1ce86, %r14
inc %rsi
...
nop
add $18205, %rax
lea addresses_A_ht+0x17da5, %rsi
lea addresses_A_ht+0x2455, %rdi
nop
dec %r14
mov $63, %rcx
rep movsq
...
nop
add $9807, %rbp
lea addresses_D_ht+0x7355, %rsi
lea addresses_D_ht+0x1eed5, %rdi
clflush (%rdi)
nop
nop
nop
...
rep movsl
add %rax, %rax
lea addresses_WC_ht+0x12055, %rdi
nop
nop
dec %r10
movb (%rdi), %r14b
nop
cmp %r14, %r14
lea addresses_normal_ht+0x17055, %rsi
lea addresses_normal_ht+0x7a55, %rdi
clflush (%rsi)
nop
add $47047, %r14
mov $27, %rcx
...
{'dst': {'same': False, 'congruent': 2, 'type': 'addresses_D_ht'}, 'OP': 'REPM', 'src': {'same': True, 'congruent': 3, 'type': 'addresses_normal_ht'}}
...
{'dst': {'same': False, 'congruent': 2, 'type': 'addresses_D_ht'}, 'OP': 'REPM', 'src': {'same': False, 'congruent': 5, 'type': 'addresses_UC_ht'}}
...
{'dst': {'same': False, 'congruent': 7, 'type': 'addresses_D_ht'}, 'OP': 'REPM', 'src': {'same': True, 'congruent': 7, 'type': 'addresses_D_ht'}}
