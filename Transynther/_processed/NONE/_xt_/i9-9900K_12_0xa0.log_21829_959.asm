...
push %rdx
push %rsi
lea addresses_normal_ht+0x11806, %r10
nop
nop
nop
nop
...
nop
inc %rcx
lea addresses_WT_ht+0xa63c, %rdx
nop
nop
add $21006, %r15
mov (%rdx), %bp
sub $11075, %rdx
lea addresses_WT_ht+0x16f54, %rsi
lea addresses_normal_ht+0x1433c, %rdi
nop
nop
nop
xor $54696, %rdx
...
nop
cmp $17390, %rcx
lea addresses_UC_ht+0xad9c, %rdi
nop
nop
nop
nop
