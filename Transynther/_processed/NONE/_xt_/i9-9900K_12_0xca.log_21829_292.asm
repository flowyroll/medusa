...
nop
and $10298, %r8
lea addresses_UC_ht+0x14d62, %rax
nop
nop
nop
nop
...
nop
cmp $38542, %rbx
lea addresses_WT_ht+0x14eb2, %rsi
lea addresses_WC_ht+0xeb4d, %rdi
nop
add %rbp, %rbp
mov $90, %rcx
rep movsq
...
nop
inc %r8
lea addresses_WC_ht+0xabaa, %rsi
lea addresses_WT_ht+0x1185a, %rdi
clflush (%rsi)
nop
nop
nop
...
rep movsl
and %rcx, %rcx
lea addresses_normal_ht+0x1d9aa, %rbp
nop
xor %r8, %r8
mov (%rbp), %si
nop
...
// Load
lea addresses_normal+0x41aa, %r14
nop
nop
nop
nop
...
// Faulty Load
lea addresses_normal+0x41aa, %r11
nop
nop
nop
nop
...
{'OP': 'REPM', 'src': {'same': False, 'type': 'addresses_WT_ht', 'congruent': 4}, 'dst': {'same': False, 'type': 'addresses_D_ht', 'congruent': 7}}
{'OP': 'STOR', 'dst': {'size': 16, 'NT': True, 'type': 'addresses_UC_ht', 'same': False, 'AVXalign': False, 'congruent': 3}}
{'OP': 'REPM', 'src': {'same': False, 'type': 'addresses_WT_ht', 'congruent': 3}, 'dst': {'same': False, 'type': 'addresses_WC_ht', 'congruent': 0}}
{'OP': 'REPM', 'src': {'same': False, 'type': 'addresses_WC_ht', 'congruent': 8}, 'dst': {'same': False, 'type': 'addresses_WT_ht', 'congruent': 2}}
