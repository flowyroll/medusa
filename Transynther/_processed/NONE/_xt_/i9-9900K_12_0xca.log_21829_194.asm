...
nop
and %rcx, %rcx
lea addresses_WT_ht+0x53e6, %rsi
nop
add $64442, %rdx
...
nop
cmp %r9, %r9
lea addresses_normal_ht+0x4406, %rsi
lea addresses_WT_ht+0x91a, %rdi
nop
nop
nop
nop
...
nop
add $2099, %r10
lea addresses_WC_ht+0x43e6, %rsi
clflush (%rsi)
nop
nop
nop
...
nop
xor %rsi, %rsi
lea addresses_normal_ht+0x8527, %rcx
nop
nop
nop
xor %rdx, %rdx
...
nop
inc %r9
lea addresses_D_ht+0xe8e6, %rsi
lea addresses_UC_ht+0x171e6, %rdi
nop
nop
nop
nop
...
nop
sub $2709, %rdx
lea addresses_D_ht+0x10540, %rcx
nop
nop
nop
cmp $38808, %rdx
...
{'OP': 'STOR', 'dst': {'size': 16, 'NT': True, 'type': 'addresses_UC', 'same': False, 'AVXalign': False, 'congruent': 8}}
...
<gen_prepare_buffer>
{'OP': 'REPM', 'src': {'same': False, 'type': 'addresses_UC_ht', 'congruent': 6}, 'dst': {'same': False, 'type': 'addresses_UC_ht', 'congruent': 11}}
