...
push %rdi
push %rsi
lea addresses_normal_ht+0x1bd7b, %r12
inc %r8
movl $0x61626364, (%r12)
nop
nop
...
nop
cmp %rsi, %rsi
lea addresses_WC_ht+0xde3b, %r10
nop
nop
nop
add %rbp, %rbp
mov (%r10), %r11w
xor $5886, %r10
lea addresses_normal_ht+0xf247, %r8
nop
nop
nop
nop
...
nop
inc %r10
lea addresses_normal_ht+0x63fb, %r13
nop
nop
nop
cmp %r11, %r11
...
nop
cmp $43634, %r11
lea addresses_normal_ht+0x8bb, %rsi
nop
nop
nop
cmp %r8, %r8
...
nop
sub %r13, %r13
lea addresses_UC_ht+0xa83b, %rsi
lea addresses_UC_ht+0x427b, %rdi
nop
nop
nop
nop
...
{'src': {'congruent': 2, 'AVXalign': True, 'same': False, 'size': 2, 'NT': False, 'type': 'addresses_normal_ht'}, 'OP': 'LOAD'}
{'src': {'congruent': 6, 'AVXalign': False, 'same': True, 'size': 8, 'NT': False, 'type': 'addresses_normal_ht'}, 'OP': 'LOAD'}
{'src': {'congruent': 5, 'AVXalign': False, 'same': False, 'size': 8, 'NT': False, 'type': 'addresses_normal_ht'}, 'OP': 'LOAD'}
{'src': {'congruent': 7, 'same': False, 'type': 'addresses_UC_ht'}, 'OP': 'REPM', 'dst': {'congruent': 6, 'same': False, 'type': 'addresses_UC_ht'}}
{'36': 21829}
