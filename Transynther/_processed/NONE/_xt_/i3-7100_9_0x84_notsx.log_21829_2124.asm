...
push %rdi
push %rsi
lea addresses_D_ht+0xc11f, %rsi
lea addresses_UC_ht+0x1c0fb, %rdi
nop
nop
nop
nop
...
nop
and %r14, %r14
lea addresses_UC_ht+0x168df, %rsi
lea addresses_A_ht+0xe537, %rdi
nop
xor %r10, %r10
mov $36, %rcx
rep movsl
...
nop
sub $29384, %rdi
lea addresses_normal_ht+0x8a8b, %r10
nop
nop
nop
nop
...
{'src': {'type': 'addresses_WC', 'same': False, 'size': 8, 'congruent': 8, 'NT': True, 'AVXalign': True}, 'OP': 'LOAD'}
...
<gen_prepare_buffer>
{'src': {'type': 'addresses_D_ht', 'congruent': 9, 'same': True}, 'dst': {'type': 'addresses_UC_ht', 'congruent': 1, 'same': False}, 'OP': 'REPM'}
