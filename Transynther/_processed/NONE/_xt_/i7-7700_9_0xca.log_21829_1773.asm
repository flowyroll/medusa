...
push %rdx
push %rsi
lea addresses_A_ht+0x18747, %rbp
nop
nop
nop
nop
...
nop
dec %rcx
lea addresses_WT_ht+0x18347, %rax
cmp $53337, %r11
mov (%rax), %di
nop
nop
nop
xor %rdx, %rdx
lea addresses_normal_ht+0x6f47, %rsi
lea addresses_UC_ht+0xe5c7, %rdi
clflush (%rdi)
nop
nop
nop
...
rep movsb
add %rcx, %rcx
lea addresses_A_ht+0x17b47, %rdi
nop
nop
xor $9935, %r11
mov (%rdi), %dx
...
nop
sub $51326, %rsi
lea addresses_WC_ht+0x19347, %rsi
lea addresses_normal_ht+0x1ce1f, %rdi
cmp %rdx, %rdx
mov $38, %rcx
rep movsb
nop
...
nop
xor $62794, %r11
lea addresses_UC_ht+0x16257, %rbp
nop
nop
nop
nop
...
{'src': {'congruent': 7, 'same': False, 'type': 'addresses_normal_ht'}, 'OP': 'REPM', 'dst': {'congruent': 7, 'same': True, 'type': 'addresses_UC_ht'}}
