...
push %rcx
push %rsi
lea addresses_normal_ht+0x139e0, %rcx
nop
nop
nop
nop
...
nop
xor $24006, %r12
lea addresses_A_ht+0x1214e, %r10
and %r15, %r15
mov (%r10), %rsi
sub $51319, %rcx
lea addresses_WC_ht+0x8f80, %r12
add %rsi, %rsi
...
{'OP': 'LOAD', 'src': {'same': False, 'type': 'addresses_WC_ht', 'NT': False, 'AVXalign': True, 'size': 16, 'congruent': 9}}
{'39': 21829}
