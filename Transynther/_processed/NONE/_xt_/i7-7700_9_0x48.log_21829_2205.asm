...
nop
add %r12, %r12
lea addresses_WC_ht+0x13df8, %rsi
...
nop
inc %rdx
lea addresses_normal_ht+0xe254, %r15
nop
xor %r14, %r14
...
nop
dec %r15
lea addresses_normal_ht+0x4138, %rdi
nop
nop
nop
nop
...
nop
dec %rcx
lea addresses_WC_ht+0x1c8f8, %r12
nop
and $7327, %rsi
movb $0x61, (%r12)
nop
...
nop
sub $49260, %r15
lea addresses_WC_ht+0x5aa0, %r15
sub $26749, %rdi
...
nop
mfence
lea addresses_D_ht+0x15df8, %r14
nop
nop
inc %rdx
movb $0x61, (%r14)
...
{'OP': 'STOR', 'dst': {'type': 'addresses_UC', 'AVXalign': True, 'congruent': 2, 'size': 2, 'same': False, 'NT': True}}
[Faulty Load]
