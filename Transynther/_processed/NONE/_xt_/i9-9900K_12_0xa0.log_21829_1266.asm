...
push %rdx
push %rsi
lea addresses_D_ht+0x15272, %rdx
nop
nop
nop
nop
...
nop
and $25732, %rdi
lea addresses_A_ht+0x15a72, %r11
clflush (%r11)
nop
nop
nop
...
nop
xor $63555, %r11
lea addresses_normal_ht+0x491a, %r8
nop
nop
sub %r12, %r12
vmovups (%r8), %ymm7
...
vpextrq $1, %xmm7, %r11
sub %r8, %r8
lea addresses_WC_ht+0xb17e, %r10
clflush (%r10)
nop
nop
nop
...
nop
cmp $49464, %rdi
lea addresses_WC_ht+0x11aba, %rsi
lea addresses_D_ht+0x46f2, %rdi
nop
nop
nop
dec %r10
...
rep movsl
xor %r8, %r8
lea addresses_WT_ht+0x17dba, %rsi
lea addresses_UC_ht+0x1e712, %rdi
nop
nop
nop
nop
...
// Store
lea addresses_normal+0x10df2, %r11
nop
nop
nop
nop
...
<gen_prepare_buffer>
{'OP': 'STOR', 'dst': {'NT': True, 'same': False, 'congruent': 7, 'type': 'addresses_D_ht', 'AVXalign': False, 'size': 2}}
...
{'src': {'same': False, 'congruent': 3, 'type': 'addresses_WC_ht'}, 'OP': 'REPM', 'dst': {'same': False, 'congruent': 11, 'type': 'addresses_D_ht'}}
