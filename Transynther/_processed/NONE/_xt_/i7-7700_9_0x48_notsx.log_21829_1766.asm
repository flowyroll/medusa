...
push %rdi
push %rsi
lea addresses_WC_ht+0xf3a0, %r12
nop
nop
and %r10, %r10
mov (%r12), %edi
...
nop
and %r14, %r14
lea addresses_normal_ht+0x1904c, %r11
sub $38703, %r15
movw $0x6162, (%r11)
nop
nop
...
nop
and %r11, %r11
lea addresses_UC_ht+0x1edac, %r12
nop
nop
nop
inc %r14
...
nop
and %r15, %r15
lea addresses_normal_ht+0xffac, %r12
sub %rdi, %rdi
vmovups (%r12), %ymm1
...
nop
sub $2986, %r10
lea addresses_UC_ht+0x1667a, %rsi
lea addresses_normal_ht+0xb284, %rdi
nop
nop
nop
add %r14, %r14
...
rep movsw
add $7858, %rcx
lea addresses_A_ht+0x1248c, %r15
cmp %r10, %r10
movl $0x61626364, (%r15)
nop
nop
...
nop
add %rdi, %rdi
lea addresses_UC_ht+0x72ec, %rax
nop
nop
nop
cmp $32536, %r14
...
nop
cmp $64326, %r10
lea addresses_WT_ht+0x12cc8, %r11
nop
nop
nop
nop
...
mov (%r11), %r12
add $29414, %r14
lea addresses_A_ht+0x1b0ac, %rsi
lea addresses_WT_ht+0x2d50, %rdi
clflush (%rdi)
nop
cmp %r12, %r12
mov $57, %rcx
...
{'dst': {'same': False, 'NT': False, 'AVXalign': True, 'size': 2, 'type': 'addresses_normal_ht', 'congruent': 4}, 'OP': 'STOR'}
{'dst': {'same': False, 'NT': False, 'AVXalign': True, 'size': 1, 'type': 'addresses_UC_ht', 'congruent': 10}, 'OP': 'STOR'}
...
{'dst': {'same': True, 'congruent': 1, 'type': 'addresses_WT_ht'}, 'OP': 'REPM', 'src': {'same': False, 'congruent': 5, 'type': 'addresses_A_ht'}}
{'36': 21829}
