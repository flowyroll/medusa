...
push %rdx
push %rsi
lea addresses_WT_ht+0xc138, %rbx
nop
nop
nop
sub %r14, %r14
...
nop
dec %rdx
lea addresses_A_ht+0x4938, %rsi
lea addresses_A_ht+0x11950, %rdi
clflush (%rsi)
nop
nop
nop
...
nop
add $49849, %r14
lea addresses_WC_ht+0x14118, %rsi
lea addresses_A_ht+0x9b38, %rdi
nop
dec %r11
mov $71, %rcx
rep movsl
