...
push %rdi
push %rsi
lea addresses_UC_ht+0xe0c7, %rsi
lea addresses_A_ht+0x1976a, %rdi
nop
nop
dec %r11
mov $61, %rcx
...
nop
add $56751, %r11
lea addresses_D_ht+0x7357, %r11
nop
and %rax, %rax
movb $0x61, (%r11)
xor $47339, %r11
lea addresses_D_ht+0x168d7, %rbx
nop
nop
nop
add %rax, %rax
...
{'OP': 'STOR', 'dst': {'same': True, 'congruent': 7, 'NT': False, 'type': 'addresses_D_ht', 'size': 1, 'AVXalign': True}}
