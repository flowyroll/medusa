...
nop
and $27253, %r11
lea addresses_D_ht+0x5224, %r12
xor %rax, %rax
movw $0x6162, (%r12)
nop
xor %rcx, %rcx
lea addresses_UC_ht+0xe9d0, %r11
cmp %rcx, %rcx
...
nop
add $62548, %r8
lea addresses_D_ht+0x3ca4, %rsi
lea addresses_D_ht+0x1bda9, %rdi
nop
nop
nop
cmp $19899, %rax
...
{'OP': 'STOR', 'dst': {'same': False, 'type': 'addresses_D_ht', 'NT': True, 'AVXalign': False, 'size': 2, 'congruent': 6}}
{'OP': 'STOR', 'dst': {'same': False, 'type': 'addresses_UC_ht', 'NT': False, 'AVXalign': False, 'size': 16, 'congruent': 0}}
{'OP': 'REPM', 'src': {'same': False, 'congruent': 11, 'type': 'addresses_D_ht'}, 'dst': {'same': False, 'congruent': 0, 'type': 'addresses_D_ht'}}
{'32': 10035}
