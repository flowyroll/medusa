...
nop
add %rbp, %rbp
lea addresses_normal_ht+0x11a73, %rsi
lea addresses_D_ht+0x5cc6, %rdi
nop
nop
nop
xor $44441, %r11
...
nop
dec %rbx
lea addresses_D_ht+0x1c346, %rsi
lea addresses_normal_ht+0x1715a, %rdi
inc %r9
mov $66, %rcx
rep movsq
nop
add %rdi, %rdi
lea addresses_A_ht+0x112c6, %rbp
nop
sub %rsi, %rsi
...
// Store
lea addresses_normal+0x17b6e, %rsi
nop
nop
cmp %rbp, %rbp
movb $0x51, (%rsi)
...
{'OP': 'STOR', 'dst': {'size': 1, 'NT': False, 'type': 'addresses_normal', 'same': False, 'AVXalign': True, 'congruent': 3}}
{'OP': 'STOR', 'dst': {'size': 16, 'NT': False, 'type': 'addresses_A', 'same': False, 'AVXalign': True, 'congruent': 5}}
{'OP': 'LOAD', 'src': {'size': 32, 'NT': False, 'type': 'addresses_PSE', 'same': False, 'AVXalign': False, 'congruent': 1}}
