...
nop
inc %r11
lea addresses_WT_ht+0xc25, %rsi
lea addresses_normal_ht+0x18525, %rdi
nop
nop
nop
inc %r8
...
nop
xor $33904, %rdi
lea addresses_A_ht+0x17ca5, %rsi
lea addresses_WC_ht+0x201d, %rdi
nop
nop
nop
nop
...
nop
dec %r10
lea addresses_UC_ht+0x7ced, %rsi
lea addresses_WC_ht+0x11f65, %rdi
clflush (%rdi)
nop
nop
nop
...
{'src': {'type': 'addresses_WT_ht', 'congruent': 7, 'same': False}, 'dst': {'type': 'addresses_normal_ht', 'congruent': 8, 'same': False}, 'OP': 'REPM'}
