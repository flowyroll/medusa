...
push %rdi
push %rsi
lea addresses_WT_ht+0x111af, %rsi
lea addresses_A_ht+0x28ef, %rdi
clflush (%rsi)
nop
nop
nop
...
nop
add %rcx, %rcx
lea addresses_UC_ht+0xc341, %rcx
nop
nop
nop
nop
...
mov (%rcx), %esi
cmp %r13, %r13
lea addresses_normal_ht+0x1d5af, %r15
clflush (%r15)
nop
nop
nop
...
nop
xor %r14, %r14
lea addresses_WT_ht+0xb9d7, %r12
sub $13015, %rdi
mov (%r12), %r15d
nop
sub %rdi, %rdi
lea addresses_A_ht+0x157ef, %rsi
lea addresses_WC_ht+0x1bdaf, %rdi
nop
nop
nop
nop
...
{'OP': 'LOAD', 'src': {'same': False, 'NT': True, 'AVXalign': False, 'size': 16, 'type': 'addresses_normal_ht', 'congruent': 11}}
{'OP': 'LOAD', 'src': {'same': False, 'NT': False, 'AVXalign': False, 'size': 4, 'type': 'addresses_WT_ht', 'congruent': 2}}
{'dst': {'same': False, 'congruent': 9, 'type': 'addresses_WC_ht'}, 'OP': 'REPM', 'src': {'same': False, 'congruent': 5, 'type': 'addresses_A_ht'}}
{'33': 21829}
