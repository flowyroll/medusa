...
lea addresses_WT_ht+0x10d89, %rdi
nop
nop
sub $8997, %r15
mov $10, %rcx
...
nop
add $57441, %r15
lea addresses_WC_ht+0x12b9, %r15
nop
xor $36977, %r10
mov (%r15), %r9
nop
...
nop
sub $63732, %rsi
lea addresses_WT_ht+0x16189, %r11
clflush (%r11)
cmp %r15, %r15
mov (%r11), %di
nop
add $22721, %r10
lea addresses_WT_ht+0x17f67, %r9
clflush (%r9)
nop
sub $31838, %r11
movl $0x61626364, (%r9)
...
nop
lfence
lea addresses_normal_ht+0x10989, %r9
nop
cmp $28613, %r11
vmovups (%r9), %ymm5
...
vpextrq $0, %xmm5, %rcx
dec %r10
lea addresses_UC_ht+0x1c589, %r10
xor %rsi, %rsi
mov (%r10), %r9d
nop
nop
...
nop
inc %r9
lea addresses_D_ht+0x12e89, %rsi
nop
nop
xor $27852, %r9
mov (%rsi), %r10
...
nop
cmp $56490, %r11
lea addresses_normal_ht+0x168b1, %r11
nop
nop
nop
and %rdi, %rdi
...
nop
xor %r10, %r10
lea addresses_WC_ht+0xdd89, %rsi
lea addresses_normal_ht+0x589, %rdi
nop
inc %r14
mov $83, %rcx
rep movsl
...
nop
and %r10, %r10
lea addresses_normal_ht+0x1ae09, %r9
nop
nop
inc %rsi
vmovups (%r9), %ymm6
...
// Faulty Load
lea addresses_normal+0x13d89, %rax
nop
nop
xor %r15, %r15
movups (%rax), %xmm6
...
{'src': {'NT': True, 'AVXalign': False, 'size': 16, 'congruent': 2, 'same': False, 'type': 'addresses_US'}, 'OP': 'LOAD'}
[Faulty Load]
{'src': {'NT': False, 'AVXalign': False, 'size': 16, 'congruent': 0, 'same': True, 'type': 'addresses_normal'}, 'OP': 'LOAD'}
<gen_prepare_buffer>
{'src': {'congruent': 4, 'same': False, 'type': 'addresses_normal_ht'}, 'dst': {'congruent': 11, 'same': False, 'type': 'addresses_WT_ht'}, 'OP': 'REPM'}
...
{'src': {'NT': False, 'AVXalign': True, 'size': 4, 'congruent': 11, 'same': False, 'type': 'addresses_UC_ht'}, 'OP': 'LOAD'}
...
{'src': {'congruent': 10, 'same': False, 'type': 'addresses_WC_ht'}, 'dst': {'congruent': 11, 'same': False, 'type': 'addresses_normal_ht'}, 'OP': 'REPM'}
