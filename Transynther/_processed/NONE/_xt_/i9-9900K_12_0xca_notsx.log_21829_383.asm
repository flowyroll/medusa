...
push %rdx
push %rsi
lea addresses_WT_ht+0x1585b, %rsi
lea addresses_A_ht+0xb85b, %rdi
clflush (%rsi)
nop
add $9036, %rbx
mov $48, %rcx
rep movsw
sub %rsi, %rsi
lea addresses_A_ht+0x1b05b, %rsi
lea addresses_UC_ht+0x981b, %rdi
nop
nop
nop
add $10377, %rdx
...
nop
sub $27105, %rdi
lea addresses_UC_ht+0x1d9c3, %rsi
lea addresses_UC_ht+0x159ff, %rdi
clflush (%rdi)
dec %r11
mov $102, %rcx
rep movsw
sub $57476, %rdx
lea addresses_WC_ht+0xd086, %rsi
lea addresses_A_ht+0x4c5b, %rdi
clflush (%rdi)
nop
nop
nop
...
nop
xor %rcx, %rcx
lea addresses_WT_ht+0x1249b, %rcx
nop
nop
and %rsi, %rsi
mov (%rcx), %rbx
inc %rbx
lea addresses_WT_ht+0xe65b, %r13
nop
nop
nop
cmp %rbx, %rbx
...
nop
and $42112, %rdi
lea addresses_A_ht+0x10183, %rsi
...
rep movsb
and $50039, %rsi
lea addresses_WT_ht+0x1bafb, %rsi
lea addresses_D_ht+0xa25b, %rdi
clflush (%rsi)
clflush (%rdi)
nop
nop
...
// Store
lea addresses_normal+0x1b45b, %r14
nop
nop
nop
nop
...
{'OP': 'REPM', 'src': {'same': True, 'congruent': 7, 'type': 'addresses_A_ht'}, 'dst': {'same': False, 'congruent': 5, 'type': 'addresses_UC_ht'}}
...
{'OP': 'REPM', 'src': {'same': False, 'congruent': 4, 'type': 'addresses_WT_ht'}, 'dst': {'same': False, 'congruent': 9, 'type': 'addresses_D_ht'}}
{'38': 21829}
