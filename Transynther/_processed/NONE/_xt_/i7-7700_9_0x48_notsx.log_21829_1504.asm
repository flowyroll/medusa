...
push %rdx
push %rsi
lea addresses_D_ht+0x11455, %rax
nop
nop
nop
nop
...
nop
cmp %rdi, %rdi
lea addresses_D_ht+0x1ab59, %rsi
lea addresses_normal_ht+0x4725, %rdi
nop
nop
nop
inc %rdx
...
nop
and $25108, %r12
lea addresses_WT_ht+0x1bfa5, %rcx
nop
dec %rax
movw $0x6162, (%rcx)
cmp $32903, %rdx
lea addresses_D_ht+0x18b25, %rsi
clflush (%rsi)
nop
nop
nop
...
nop
xor $2407, %rcx
lea addresses_WT_ht+0x10ccd, %rsi
lea addresses_D_ht+0x24b5, %rdi
nop
nop
nop
nop
...
rep movsq
dec %rcx
lea addresses_WT_ht+0xace5, %rax
nop
inc %rdx
mov (%rax), %si
add $62800, %rdi
lea addresses_WC_ht+0xf9a5, %r13
nop
xor %rsi, %rsi
movb $0x61, (%r13)
nop
...
// Faulty Load
lea addresses_normal+0x67a5, %r11
nop
nop
nop
nop
...
{'dst': {'same': False, 'congruent': 6, 'type': 'addresses_normal_ht'}, 'OP': 'REPM', 'src': {'same': False, 'congruent': 2, 'type': 'addresses_D_ht'}}
...
{'dst': {'same': False, 'congruent': 4, 'type': 'addresses_D_ht'}, 'OP': 'REPM', 'src': {'same': False, 'congruent': 3, 'type': 'addresses_WT_ht'}}
{'dst': {'same': True, 'congruent': 9, 'type': 'addresses_normal_ht'}, 'OP': 'REPM', 'src': {'same': False, 'congruent': 6, 'type': 'addresses_D_ht'}}
