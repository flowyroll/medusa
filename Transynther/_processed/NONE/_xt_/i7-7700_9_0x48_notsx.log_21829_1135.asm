...
push %rdx
push %rsi
lea addresses_normal_ht+0x1e9a8, %r11
nop
nop
add $11694, %rsi
...
nop
add %r14, %r14
lea addresses_WT_ht+0x1c443, %rsi
lea addresses_normal_ht+0xa8ff, %rdi
nop
nop
nop
dec %rdx
...
{'OP': 'LOAD', 'src': {'same': False, 'NT': False, 'AVXalign': False, 'size': 2, 'type': 'addresses_PSE', 'congruent': 3}}
[Faulty Load]
...
{'dst': {'same': True, 'congruent': 0, 'type': 'addresses_normal_ht'}, 'OP': 'REPM', 'src': {'same': True, 'congruent': 6, 'type': 'addresses_WT_ht'}}
{'39': 21829}
