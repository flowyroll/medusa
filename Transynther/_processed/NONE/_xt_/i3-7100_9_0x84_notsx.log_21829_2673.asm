...
rep movsw
and %r11, %r11
lea addresses_D_ht+0x11061, %r13
nop
nop
sub $37257, %rdi
movb (%r13), %al
cmp %r14, %r14
lea addresses_normal_ht+0x19161, %rsi
lea addresses_WT_ht+0x6fe1, %rdi
nop
nop
nop
nop
...
// Store
lea addresses_normal+0x1b961, %rcx
nop
nop
nop
cmp %rbx, %rbx
...
{'src': {'type': 'addresses_A', 'same': False, 'size': 16, 'congruent': 6, 'NT': False, 'AVXalign': False}, 'OP': 'LOAD'}
{'src': {'type': 'addresses_WC', 'same': False, 'size': 1, 'congruent': 1, 'NT': False, 'AVXalign': False}, 'OP': 'LOAD'}
{'dst': {'type': 'addresses_UC', 'same': False, 'size': 2, 'congruent': 6, 'NT': False, 'AVXalign': True}, 'OP': 'STOR'}
[Faulty Load]
...
{'src': {'type': 'addresses_D_ht', 'congruent': 7, 'same': False}, 'dst': {'type': 'addresses_D_ht', 'congruent': 11, 'same': True}, 'OP': 'REPM'}
...
{'src': {'type': 'addresses_normal_ht', 'congruent': 11, 'same': False}, 'dst': {'type': 'addresses_WT_ht', 'congruent': 6, 'same': True}, 'OP': 'REPM'}
{'34': 21829}
