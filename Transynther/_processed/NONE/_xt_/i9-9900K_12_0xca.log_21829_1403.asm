...
push %rdi
push %rsi
lea addresses_normal_ht+0xa385, %r15
nop
xor %rax, %rax
...
nop
xor $4393, %r15
lea addresses_WC_ht+0x33ef, %r11
nop
cmp %rbp, %rbp
movb (%r11), %r9b
nop
...
lea addresses_UC_ht+0x1ab27, %rdi
nop
nop
nop
nop
...
nop
cmp $22950, %rbp
lea addresses_D_ht+0x63af, %rsi
lea addresses_D_ht+0xc30f, %rdi
and $51580, %r10
mov $60, %rcx
rep movsq
xor $64210, %r9
lea addresses_UC_ht+0x9ba7, %rbp
nop
nop
xor $24114, %rcx
mov (%rbp), %r15w
...
// Store
lea addresses_normal+0x8b27, %r13
clflush (%r13)
nop
nop
nop
...
{'OP': 'STOR', 'dst': {'size': 1, 'NT': False, 'type': 'addresses_D', 'same': False, 'AVXalign': False, 'congruent': 3}}
[Faulty Load]
{'OP': 'LOAD', 'src': {'size': 16, 'NT': False, 'type': 'addresses_PSE', 'same': True, 'AVXalign': False, 'congruent': 0}}
<gen_prepare_buffer>
{'OP': 'STOR', 'dst': {'size': 8, 'NT': True, 'type': 'addresses_normal_ht', 'same': False, 'AVXalign': True, 'congruent': 0}}
{'OP': 'STOR', 'dst': {'size': 8, 'NT': False, 'type': 'addresses_A_ht', 'same': False, 'AVXalign': False, 'congruent': 4}}
{'OP': 'LOAD', 'src': {'size': 1, 'NT': True, 'type': 'addresses_WC_ht', 'same': False, 'AVXalign': True, 'congruent': 1}}
