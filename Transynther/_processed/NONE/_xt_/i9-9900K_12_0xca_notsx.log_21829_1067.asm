...
push %rdx
push %rsi
lea addresses_WC_ht+0x11718, %r15
nop
nop
add %r14, %r14
mov (%r15), %ebp
...
nop
xor %r11, %r11
lea addresses_normal_ht+0x1270, %rax
nop
nop
nop
nop
...
nop
cmp %rsi, %rsi
lea addresses_D_ht+0x17118, %rbp
nop
nop
nop
nop
...
mov (%r14), %ebp
inc %rdx
lea addresses_A_ht+0x1a008, %rbp
dec %r11
movw $0x6162, (%rbp)
cmp %r11, %r11
pop %rsi
...
{'OP': 'STOR', 'dst': {'same': True, 'type': 'addresses_normal_ht', 'NT': False, 'AVXalign': False, 'size': 2, 'congruent': 0}}
