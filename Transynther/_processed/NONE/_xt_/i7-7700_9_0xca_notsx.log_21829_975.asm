...
push %rcx
push %rdx
lea addresses_UC_ht+0x2b37, %rcx
nop
nop
nop
nop
...
nop
xor $64172, %r13
lea addresses_normal_ht+0x144e1, %r11
nop
nop
nop
sub $39647, %rbx
...
nop
xor $5055, %r13
lea addresses_WT_ht+0x18c49, %rbx
nop
nop
and %rdx, %rdx
mov (%rbx), %rcx
...
nop
lfence
lea addresses_UC_ht+0x14049, %rbx
nop
nop
sub %r11, %r11
movl $0x61626364, (%rbx)
...
nop
xor $6549, %rcx
lea addresses_normal_ht+0x150ad, %rdx
nop
xor $41364, %r13
mov (%rdx), %ecx
nop
...
// Faulty Load
lea addresses_normal+0x17849, %r14
nop
cmp $17499, %rdx
movups (%r14), %xmm4
vpextrq $0, %xmm4, %rdi
