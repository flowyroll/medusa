...
push %rdi
push %rsi
lea addresses_A_ht+0x1943e, %rsi
lea addresses_UC_ht+0x1b33e, %rdi
clflush (%rdi)
nop
nop
sub %r8, %r8
...
nop
lfence
lea addresses_UC_ht+0xf091, %r12
nop
nop
xor %r13, %r13
vmovups (%r12), %ymm7
...
nop
inc %rcx
lea addresses_WT_ht+0xcf3e, %rsi
nop
nop
dec %r13
movb (%rsi), %cl
...
nop
xor %rdi, %rdi
lea addresses_UC_ht+0xbc3e, %r13
nop
nop
nop
nop
...
nop
dec %r8
lea addresses_A_ht+0x6e8e, %r8
xor $35122, %rdi
mov (%r8), %si
nop
nop
mfence
lea addresses_WT_ht+0x249e, %rsi
lea addresses_WC_ht+0xe504, %rdi
nop
nop
sub $25497, %rax
mov $18, %rcx
...
nop
add %r8, %r8
lea addresses_A_ht+0x1cf3e, %rsi
lea addresses_normal_ht+0x19b02, %rdi
and $49399, %r8
mov $102, %rcx
rep movsq
inc %r8
lea addresses_UC_ht+0x9bc0, %r12
nop
nop
add %rdi, %rdi
...
<gen_prepare_buffer>
{'dst': {'same': False, 'congruent': 8, 'type': 'addresses_UC_ht'}, 'OP': 'REPM', 'src': {'same': False, 'congruent': 11, 'type': 'addresses_A_ht'}}
{'dst': {'same': False, 'congruent': 8, 'type': 'addresses_A_ht'}, 'OP': 'REPM', 'src': {'same': False, 'congruent': 8, 'type': 'addresses_A_ht'}}
...
{'dst': {'same': False, 'congruent': 0, 'type': 'addresses_WC_ht'}, 'OP': 'REPM', 'src': {'same': False, 'congruent': 5, 'type': 'addresses_WT_ht'}}
