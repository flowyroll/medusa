...
nop
and $3489, %r10
lea addresses_WC_ht+0x1413, %rsi
lea addresses_WT_ht+0xaca3, %rdi
clflush (%rsi)
nop
sub $54010, %r11
mov $34, %rcx
...
nop
and %rcx, %rcx
lea addresses_normal_ht+0x19583, %r11
nop
add $32598, %r10
movl $0x61626364, (%r11)
nop
...
nop
sub $52983, %r15
lea addresses_UC_ht+0x1b28e, %rsi
lea addresses_normal_ht+0x166a3, %rdi
nop
nop
nop
add $61229, %rbp
...
{'dst': {'same': True, 'NT': False, 'AVXalign': True, 'size': 32, 'type': 'addresses_WC', 'congruent': 11}, 'OP': 'STOR'}
...
{'OP': 'LOAD', 'src': {'same': False, 'NT': False, 'AVXalign': False, 'size': 8, 'type': 'addresses_NC', 'congruent': 9}}
[Faulty Load]
...
{'dst': {'same': False, 'congruent': 5, 'type': 'addresses_WT_ht'}, 'OP': 'REPM', 'src': {'same': False, 'congruent': 4, 'type': 'addresses_WC_ht'}}
