...
push %rdi
push %rsi
lea addresses_A_ht+0x1cf07, %r11
and $59573, %r15
vmovups (%r11), %ymm7
...
nop
cmp %r12, %r12
lea addresses_WT_ht+0xe507, %r8
sub $4243, %r13
mov $0x6162636465666768, %r12
movq %r12, (%r8)
cmp $38200, %r8
lea addresses_normal_ht+0x8d57, %r12
nop
nop
nop
nop
...
nop
sub $8725, %r8
lea addresses_UC_ht+0xf007, %rax
nop
cmp %rdi, %rdi
movb $0x61, (%rax)
nop
and %r15, %r15
lea addresses_A_ht+0x672b, %rsi
lea addresses_WC_ht+0x26c7, %rdi
nop
dec %r13
mov $32, %rcx
rep movsl
nop
cmp $60644, %rdi
lea addresses_WC_ht+0x16507, %r11
nop
nop
dec %rsi
movups (%r11), %xmm0
...
nop
sub %rax, %rax
lea addresses_A_ht+0x179e2, %rsi
lea addresses_WT_ht+0x14b53, %rdi
nop
cmp %rax, %rax
mov $102, %rcx
rep movsq
...
{'OP': 'STOR', 'dst': {'type': 'addresses_PSE', 'AVXalign': True, 'congruent': 10, 'size': 4, 'same': False, 'NT': False}}
[Faulty Load]
...
{'OP': 'STOR', 'dst': {'type': 'addresses_WT_ht', 'AVXalign': True, 'congruent': 8, 'size': 8, 'same': False, 'NT': False}}
...
{'OP': 'REPM', 'src': {'type': 'addresses_A_ht', 'congruent': 2, 'same': False}, 'dst': {'type': 'addresses_WC_ht', 'congruent': 6, 'same': False}}
