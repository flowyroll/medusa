...
push %rdi
push %rsi
lea addresses_normal_ht+0x11fa0, %rsi
...
nop
and $36277, %r13
lea addresses_A_ht+0xfd0, %rdi
and %rbx, %rbx
movl $0x61626364, (%rdi)
nop
nop
xor %rsi, %rsi
lea addresses_WT_ht+0x15150, %rbx
nop
nop
nop
and %rax, %rax
...
nop
add $45869, %rcx
lea addresses_D_ht+0x1db50, %rax
clflush (%rax)
nop
nop
add %r13, %r13
...
nop
sub %r13, %r13
lea addresses_WT_ht+0x153e0, %rsi
lea addresses_WC_ht+0x19bd0, %rdi
nop
add %r10, %r10
mov $5, %rcx
rep movsw
...
nop
sub %r15, %r15
lea addresses_WT_ht+0xd6b0, %r10
sub %r13, %r13
...
nop
inc %rcx
lea addresses_D_ht+0x2bd0, %rsi
lea addresses_normal_ht+0x83c, %rdi
nop
xor $24599, %r15
mov $0, %rcx
rep movsw
...
nop
sub %rbx, %rbx
lea addresses_UC_ht+0x16d0, %r10
nop
nop
nop
nop
...
nop
inc %rcx
lea addresses_D_ht+0xefd0, %rbx
nop
nop
and %r10, %r10
movb (%rbx), %cl
dec %rax
lea addresses_D_ht+0x6b50, %rsi
nop
nop
nop
dec %r10
...
nop
add $45335, %rdi
lea addresses_normal_ht+0x3ed0, %rax
nop
nop
cmp %rdi, %rdi
movb (%rax), %r15b
...
nop
sub %rcx, %rcx
lea addresses_WC_ht+0x1e9d0, %r13
dec %rbx
...
<gen_prepare_buffer>
{'OP': 'REPM', 'src': {'same': False, 'congruent': 3, 'type': 'addresses_normal_ht'}, 'dst': {'same': False, 'congruent': 5, 'type': 'addresses_normal_ht'}}
...
{'OP': 'REPM', 'src': {'same': False, 'congruent': 4, 'type': 'addresses_WT_ht'}, 'dst': {'same': True, 'congruent': 11, 'type': 'addresses_WC_ht'}}
