...
push %rdx
push %rsi
lea addresses_normal_ht+0x4811, %rcx
nop
nop
nop
nop
...
nop
and %r11, %r11
lea addresses_WT_ht+0xc22d, %rbp
nop
nop
nop
add %r10, %r10
...
nop
and %r11, %r11
lea addresses_D_ht+0x1262d, %rsi
lea addresses_WT_ht+0x14623, %rdi
clflush (%rsi)
nop
nop
nop
...
nop
inc %r12
lea addresses_UC_ht+0x772d, %rsi
lea addresses_D_ht+0xfcbd, %rdi
add $15842, %rbp
mov $19, %rcx
rep movsl
nop
...
{'src': {'type': 'addresses_UC_ht', 'congruent': 8, 'same': False}, 'dst': {'type': 'addresses_D_ht', 'congruent': 4, 'same': True}, 'OP': 'REPM'}
{'38': 21829}
