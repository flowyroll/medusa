...
movb (%r14), %r11b
dec %rdi
lea addresses_WC_ht+0x84bf, %rsi
lea addresses_UC_ht+0xa49f, %rdi
clflush (%rsi)
nop
nop
nop
...
nop
lfence
lea addresses_D_ht+0x1ac2f, %rcx
nop
nop
nop
sub %rdi, %rdi
...
nop
sub %rsi, %rsi
lea addresses_normal_ht+0x1189f, %rdi
nop
nop
nop
add $27479, %r11
...
vmovups %ymm3, (%rdi)
xor $57308, %r12
lea addresses_normal_ht+0x38bf, %rsi
clflush (%rsi)
inc %r15
mov (%rsi), %rdi
nop
nop
add %r15, %r15
lea addresses_normal_ht+0x2b8f, %rsi
...
nop
sub $1827, %rdi
lea addresses_D_ht+0xffbf, %rsi
lea addresses_normal_ht+0x555f, %rdi
nop
nop
inc %rdx
mov $7, %rcx
...
nop
xor %rdx, %rdx
lea addresses_WC_ht+0x1a17f, %rdx
clflush (%rdx)
nop
nop
and %r15, %r15
...
nop
dec %r11
lea addresses_UC_ht+0xbd51, %rcx
clflush (%rcx)
nop
nop
nop
...
movq %r12, (%rsi)
inc %rcx
lea addresses_WT_ht+0x663b, %rsi
lea addresses_WC_ht+0xbdff, %rdi
nop
nop
cmp %r11, %r11
mov $9, %rcx
...
nop
xor $56591, %rcx
lea addresses_UC_ht+0x7571, %rcx
xor $20689, %rdi
movw $0x6162, (%rcx)
nop
nop
add $45517, %rdi
lea addresses_A_ht+0xd57f, %rsi
lea addresses_normal_ht+0x99c3, %rdi
nop
sub %r12, %r12
mov $127, %rcx
rep movsb
...
nop
xor %rcx, %rcx
lea addresses_WC_ht+0x1dbb, %rcx
clflush (%rcx)
nop
nop
xor %rdx, %rdx
...
movq %rdi, (%rcx)
and $13015, %rdx
lea addresses_UC_ht+0x15cbf, %r12
dec %rdx
mov $0x6162636465666768, %rdi
movq %rdi, (%r12)
nop
...
// Faulty Load
lea addresses_normal+0xb4bf, %r10
dec %r15
mov (%r10), %r12w
lea oracles, %r15
and $0xff, %r12
...
{'OP': 'REPM', 'src': {'type': 'addresses_WC_ht', 'congruent': 10, 'same': False}, 'dst': {'type': 'addresses_UC_ht', 'congruent': 5, 'same': False}}
...
{'OP': 'REPM', 'src': {'type': 'addresses_WT_ht', 'congruent': 2, 'same': True}, 'dst': {'type': 'addresses_WC_ht', 'congruent': 6, 'same': False}}
