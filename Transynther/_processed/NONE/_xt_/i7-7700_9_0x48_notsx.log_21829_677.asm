...
nop
and $61557, %r9
lea addresses_D_ht+0x123f8, %rax
nop
nop
cmp %rbx, %rbx
movups (%rax), %xmm2
...
nop
cmp %r9, %r9
lea addresses_D_ht+0x12e18, %rsi
lea addresses_WT_ht+0x2fb8, %rdi
clflush (%rsi)
clflush (%rdi)
nop
nop
...
{'dst': {'same': False, 'congruent': 8, 'type': 'addresses_WT_ht'}, 'OP': 'REPM', 'src': {'same': False, 'congruent': 4, 'type': 'addresses_D_ht'}}
