...
push %rdi
push %rsi
lea addresses_normal_ht+0x186e9, %rbx
nop
nop
cmp %rsi, %rsi
movb $0x61, (%rbx)
nop
sub $41520, %rsi
lea addresses_WT_ht+0x14d45, %rsi
lea addresses_normal_ht+0xa731, %rdi
nop
xor %rbp, %rbp
mov $126, %rcx
rep movsb
...
nop
cmp $44825, %rbp
lea addresses_WC_ht+0x16231, %rsi
lea addresses_WT_ht+0x17075, %rdi
nop
nop
cmp $56852, %rax
mov $91, %rcx
...
nop
sub $27817, %rbx
lea addresses_WC_ht+0x6351, %rdi
nop
nop
sub %r15, %r15
mov (%rdi), %si
...
nop
cmp %rbx, %rbx
lea addresses_WC_ht+0x5e31, %rax
nop
nop
sub %rdi, %rdi
mov (%rax), %bx
