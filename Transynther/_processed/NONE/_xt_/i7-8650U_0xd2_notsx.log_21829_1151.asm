...
push %rdi
push %rsi
lea addresses_WT_ht+0x1dcbe, %rsi
lea addresses_A_ht+0x669e, %rdi
nop
nop
nop
nop
...
nop
dec %r11
lea addresses_WC_ht+0x12353, %rdi
nop
nop
nop
nop
...
nop
and %rcx, %rcx
lea addresses_UC_ht+0x132de, %r11
nop
nop
nop
nop
...
nop
sub $30475, %rcx
lea addresses_UC_ht+0x1dc6e, %rdi
nop
nop
nop
nop
...
movups %xmm1, (%rdi)
sub %rcx, %rcx
lea addresses_UC_ht+0x7596, %rbx
clflush (%rbx)
nop
nop
xor %rsi, %rsi
...
// Faulty Load
lea addresses_normal+0x185e, %rbp
nop
nop
nop
nop
