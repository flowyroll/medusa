...
push %rdx
push %rsi
lea addresses_normal_ht+0x15b69, %r14
add %rcx, %rcx
...
nop
dec %r14
lea addresses_WC_ht+0xf30e, %rdx
nop
nop
nop
nop
...
vpextrq $0, %xmm5, %r14
add %r15, %r15
lea addresses_D_ht+0x15a03, %rbp
add $3138, %r14
movb $0x61, (%rbp)
nop
nop
...
lea addresses_UC_ht+0x9fc3, %rdi
nop
nop
nop
nop
...
nop
xor $35379, %rbp
lea addresses_WT_ht+0x1bfdb, %rbp
nop
nop
cmp %rsi, %rsi
movl $0x61626364, (%rbp)
cmp $9517, %r9
lea addresses_D_ht+0x7983, %rdi
nop
nop
nop
sub $24074, %rcx
...
nop
and %rdi, %rdi
lea addresses_normal_ht+0x19203, %rsi
lea addresses_A_ht+0x14da9, %rdi
nop
nop
nop
cmp %r15, %r15
...
nop
add $29989, %rdx
lea addresses_WC_ht+0x11203, %r9
nop
nop
dec %rbp
movb (%r9), %r14b
...
nop
sub $59993, %rcx
lea addresses_normal_ht+0xbc83, %rdi
nop
nop
sub %rdx, %rdx
...
nop
xor %rdx, %rdx
lea addresses_UC_ht+0xbb13, %r11
nop
nop
and $36279, %rdi
movl $0x61626364, (%r11)
...
{'OP': 'STOR', 'dst': {'type': 'addresses_normal_ht', 'size': 8, 'AVXalign': False, 'NT': True, 'congruent': 5, 'same': False}}
