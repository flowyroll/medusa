...
push %rdx
push %rsi
lea addresses_WT_ht+0x9f5, %rsi
lea addresses_A_ht+0x8269, %rdi
cmp %rbx, %rbx
mov $103, %rcx
rep movsb
nop
and %r11, %r11
lea addresses_A_ht+0x67e9, %r13
add $36972, %r12
movups (%r13), %xmm3
vpextrq $0, %xmm3, %r11
nop
...
nop
dec %rsi
lea addresses_WT_ht+0x39e9, %rbx
nop
nop
nop
nop
...
nop
xor %rbx, %rbx
lea addresses_D_ht+0x10ad7, %rsi
lea addresses_D_ht+0xe481, %rdi
cmp $59837, %rdx
mov $102, %rcx
rep movsb
nop
...
nop
add %rsi, %rsi
lea addresses_A_ht+0x2e85, %r11
xor $44305, %rbx
mov (%r11), %rdi
dec %rbx
lea addresses_WT_ht+0xace9, %rsi
lea addresses_A_ht+0x22ed, %rdi
nop
nop
sub $33507, %rbx
mov $42, %rcx
...
vpextrq $1, %xmm3, %rbx
cmp $4303, %r13
lea addresses_A_ht+0x113e9, %rbx
nop
nop
nop
cmp %r12, %r12
...
nop
xor $29590, %rdi
lea addresses_D_ht+0x1ebe9, %rcx
nop
nop
nop
nop
...
mov (%rcx), %edx
xor %rdx, %rdx
lea addresses_WT_ht+0x1a1e9, %rsi
lea addresses_UC_ht+0x8ee9, %rdi
cmp $11105, %r12
mov $9, %rcx
rep movsb
nop
...
// Store
lea addresses_normal+0x85e9, %r12
nop
xor $14281, %rdx
...
{'dst': {'same': False, 'NT': False, 'AVXalign': True, 'size': 8, 'type': 'addresses_PSE', 'congruent': 8}, 'OP': 'STOR'}
[Faulty Load]
{'OP': 'LOAD', 'src': {'same': True, 'NT': False, 'AVXalign': False, 'size': 16, 'type': 'addresses_PSE', 'congruent': 0}}
<gen_prepare_buffer>
{'dst': {'same': False, 'congruent': 7, 'type': 'addresses_A_ht'}, 'OP': 'REPM', 'src': {'same': False, 'congruent': 2, 'type': 'addresses_WT_ht'}}
...
{'dst': {'same': True, 'congruent': 2, 'type': 'addresses_D_ht'}, 'OP': 'REPM', 'src': {'same': False, 'congruent': 1, 'type': 'addresses_D_ht'}}
...
{'dst': {'same': False, 'congruent': 2, 'type': 'addresses_A_ht'}, 'OP': 'REPM', 'src': {'same': False, 'congruent': 8, 'type': 'addresses_WT_ht'}}
...
{'dst': {'same': True, 'NT': False, 'AVXalign': False, 'size': 2, 'type': 'addresses_WC_ht', 'congruent': 10}, 'OP': 'STOR'}
{'33': 21829}
