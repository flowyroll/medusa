...
mov (%rax), %r13
sub %rbp, %rbp
lea addresses_UC_ht+0x1acd4, %rsi
lea addresses_A_ht+0xf4f4, %rdi
nop
nop
and $35627, %rdx
mov $40, %rcx
...
nop
dec %r8
lea addresses_WC_ht+0x1d015, %r13
nop
nop
nop
nop
...
nop
add $65332, %rbp
lea addresses_WT_ht+0x27b4, %rsi
lea addresses_WT_ht+0x3dd4, %rdi
nop
inc %rax
mov $39, %rcx
rep movsw
...
nop
dec %rbp
lea addresses_normal_ht+0xa1d4, %rsi
lea addresses_UC_ht+0x7654, %rdi
clflush (%rdi)
nop
nop
nop
...
nop
sub $19876, %rax
lea addresses_UC_ht+0xd7d4, %rsi
lea addresses_A_ht+0x16b84, %rdi
clflush (%rdi)
nop
nop
nop
...
nop
inc %r8
lea addresses_WT_ht+0x2dd4, %rax
nop
nop
add $43450, %rsi
movb (%rax), %r8b
inc %rcx
lea addresses_normal_ht+0x1c9d4, %r8
nop
nop
nop
nop
...
// Load
lea addresses_normal+0x31d4, %rbx
clflush (%rbx)
nop
nop
xor %rbp, %rbp
...
// Store
lea addresses_normal+0x12214, %r9
nop
nop
inc %rbp
...
// Faulty Load
lea addresses_normal+0x31d4, %r9
and $31835, %rsi
mov (%r9), %r13
lea oracles, %rbx
and $0xff, %r13
...
{'OP': 'LOAD', 'src': {'size': 32, 'NT': False, 'type': 'addresses_US', 'same': False, 'AVXalign': False, 'congruent': 11}}
{'OP': 'STOR', 'dst': {'size': 16, 'NT': False, 'type': 'addresses_normal', 'same': False, 'AVXalign': False, 'congruent': 5}}
{'OP': 'STOR', 'dst': {'size': 2, 'NT': True, 'type': 'addresses_D', 'same': False, 'AVXalign': False, 'congruent': 9}}
[Faulty Load]
...
{'OP': 'REPM', 'src': {'same': False, 'type': 'addresses_WT_ht', 'congruent': 5}, 'dst': {'same': False, 'type': 'addresses_WT_ht', 'congruent': 7}}
{'OP': 'REPM', 'src': {'same': True, 'type': 'addresses_normal_ht', 'congruent': 11}, 'dst': {'same': False, 'type': 'addresses_UC_ht', 'congruent': 3}}
