...
push %rdi
push %rsi
lea addresses_D_ht+0x16e06, %rsi
lea addresses_WT_ht+0x7f74, %rdi
nop
nop
cmp $11283, %r9
mov $84, %rcx
...
nop
add $30864, %r9
lea addresses_UC_ht+0x1b074, %rsi
nop
nop
nop
nop
...
nop
add $23130, %rdi
lea addresses_A_ht+0x12c48, %r15
nop
and $410, %r10
mov (%r15), %ecx
nop
nop
lfence
lea addresses_UC_ht+0x173c4, %rcx
nop
nop
nop
nop
...
nop
and %r10, %r10
lea addresses_WC_ht+0x2cf4, %rdi
sub $11938, %r10
mov (%rdi), %r9w
nop
sub $5930, %r10
lea addresses_WT_ht+0x14174, %rsi
lea addresses_WC_ht+0x14574, %rdi
xor $13159, %r13
mov $46, %rcx
rep movsw
nop
...
nop
add $41762, %r15
lea addresses_A_ht+0x113f4, %rdi
dec %rcx
vmovups (%rdi), %ymm7
...
{'src': {'same': False, 'congruent': 0, 'NT': False, 'type': 'addresses_A_ht', 'size': 4, 'AVXalign': True}, 'OP': 'LOAD'}
{'src': {'same': False, 'congruent': 4, 'NT': False, 'type': 'addresses_UC_ht', 'size': 16, 'AVXalign': False}, 'OP': 'LOAD'}
{'src': {'same': True, 'congruent': 5, 'NT': False, 'type': 'addresses_WC_ht', 'size': 2, 'AVXalign': False}, 'OP': 'LOAD'}
