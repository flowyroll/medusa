...
nop
add $53870, %rdi
lea addresses_UC_ht+0x42ef, %r13
nop
nop
nop
xor %rax, %rax
...
nop
and %rdx, %rdx
lea addresses_UC_ht+0xbfcd, %rsi
lea addresses_UC_ht+0x1206d, %rdi
clflush (%rdi)
nop
sub $31962, %rbx
mov $48, %rcx
rep movsq
add %r13, %r13
lea addresses_UC_ht+0xa339, %rax
nop
nop
inc %rdx
mov (%rax), %di
...
{'src': {'NT': True, 'same': False, 'congruent': 10, 'type': 'addresses_P', 'AVXalign': False, 'size': 4}, 'OP': 'LOAD'}
[Faulty Load]
