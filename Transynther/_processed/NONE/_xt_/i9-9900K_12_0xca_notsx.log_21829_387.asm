...
nop
xor %rsi, %rsi
lea addresses_D_ht+0xd616, %rsi
lea addresses_D_ht+0x14466, %rdi
nop
nop
nop
dec %rbx
...
nop
sub %rdi, %rdi
lea addresses_A_ht+0x19bfd, %r13
xor $54376, %r11
mov $0x6162636465666768, %r14
movq %r14, (%r13)
nop
...
nop
and $9977, %rcx
lea addresses_A_ht+0x12666, %r14
nop
nop
xor %rbx, %rbx
movb (%r14), %r11b
...
// Load
lea addresses_normal+0x194de, %r13
nop
and %rsi, %rsi
mov (%r13), %r12d
nop
...
// REPMOV
lea addresses_A+0x6a66, %rsi
lea addresses_PSE+0xe5d6, %rdi
nop
inc %rdx
mov $60, %rcx
rep movsb
...
{'OP': 'LOAD', 'src': {'same': False, 'type': 'addresses_normal', 'NT': False, 'AVXalign': False, 'size': 4, 'congruent': 1}}
{'OP': 'REPM', 'src': {'same': False, 'congruent': 11, 'type': 'addresses_A'}, 'dst': {'same': False, 'congruent': 4, 'type': 'addresses_PSE'}}
...
{'OP': 'REPM', 'src': {'same': False, 'congruent': 0, 'type': 'addresses_D_ht'}, 'dst': {'same': False, 'congruent': 5, 'type': 'addresses_D_ht'}}
...
{'OP': 'LOAD', 'src': {'same': True, 'type': 'addresses_D_ht', 'NT': False, 'AVXalign': False, 'size': 16, 'congruent': 11}}
{'32': 21829}
