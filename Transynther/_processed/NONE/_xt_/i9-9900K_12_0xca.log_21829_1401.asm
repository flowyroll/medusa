...
nop
xor %r12, %r12
lea addresses_normal_ht+0x1ce00, %rdi
clflush (%rdi)
nop
nop
nop
...
movb $0x61, (%rdi)
add $24974, %r8
lea addresses_WC_ht+0x212c, %rax
and $26949, %rcx
mov (%rax), %rbp
nop
lfence
...
// Load
lea addresses_normal+0x1e454, %r10
sub %r12, %r12
mov (%r10), %rax
nop
nop
...
{'OP': 'LOAD', 'src': {'size': 8, 'NT': False, 'type': 'addresses_NC', 'same': False, 'AVXalign': False, 'congruent': 5}}
