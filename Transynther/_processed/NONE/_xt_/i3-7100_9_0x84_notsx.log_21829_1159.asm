...
nop
dec %rcx
lea addresses_normal_ht+0x1da37, %rbx
nop
nop
nop
nop
...
nop
sub $20642, %r13
lea addresses_WT_ht+0x16ad7, %rdx
sub $1191, %r14
movb $0x61, (%rdx)
dec %r10
lea addresses_WT_ht+0x1bbd7, %r10
nop
nop
sub %r9, %r9
mov (%r10), %r14d
...
nop
inc %rbx
lea addresses_normal_ht+0xc5d7, %r9
clflush (%r9)
nop
nop
nop
