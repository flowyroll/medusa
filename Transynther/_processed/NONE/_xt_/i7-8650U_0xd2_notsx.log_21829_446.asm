...
push %rdi
push %rsi
lea addresses_WT_ht+0x93bc, %rdi
nop
nop
nop
nop
...
nop
inc %rax
lea addresses_WC_ht+0x12ac4, %rax
clflush (%rax)
nop
sub $34791, %rdi
vmovups (%rax), %ymm7
...
nop
xor $52624, %rsi
lea addresses_WC_ht+0x1264, %r11
nop
nop
nop
and $55990, %rsi
...
// REPMOV
lea addresses_RW+0x80c4, %rsi
lea addresses_normal+0x6644, %rdi
clflush (%rdi)
nop
and %rdx, %rdx
mov $102, %rcx
...
// Load
lea addresses_normal+0x12644, %r13
nop
nop
add %rdi, %rdi
mov (%r13), %r14d
...
// REPMOV
lea addresses_PSE+0xd012, %rsi
lea addresses_UC+0x1e204, %rdi
nop
inc %r11
mov $2, %rcx
rep movsl
...
// Faulty Load
lea addresses_normal+0x1dec4, %r9
and $30449, %rsi
mov (%r9), %r14w
lea oracles, %rdx
and $0xff, %r14
...
{'OP': 'REPM', 'src': {'type': 'addresses_RW', 'congruent': 9, 'same': False}, 'dst': {'type': 'addresses_normal', 'congruent': 6, 'same': False}}
{'OP': 'LOAD', 'src': {'type': 'addresses_normal', 'size': 4, 'AVXalign': False, 'NT': False, 'congruent': 0, 'same': False}}
{'OP': 'REPM', 'src': {'type': 'addresses_PSE', 'congruent': 1, 'same': False}, 'dst': {'type': 'addresses_UC', 'congruent': 5, 'same': False}}
