...
mov (%rsi), %r11
cmp $12612, %rbp
lea addresses_WT_ht+0xb87d, %r14
xor %r9, %r9
...
mov (%r9), %rsi
cmp $12220, %r9
lea addresses_D_ht+0x1e07d, %r10
nop
add %rsi, %rsi
movb (%r10), %r9b
nop
...
// Faulty Load
lea addresses_normal+0x1387d, %rbp
nop
cmp $24231, %r10
mov (%rbp), %r8w
lea oracles, %r9
...
<gen_prepare_buffer>
{'OP': 'LOAD', 'src': {'same': False, 'NT': True, 'AVXalign': False, 'size': 8, 'type': 'addresses_WT_ht', 'congruent': 11}}
