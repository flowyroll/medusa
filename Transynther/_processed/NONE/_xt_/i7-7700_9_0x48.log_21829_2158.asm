...
push %rdx
push %rsi
lea addresses_D_ht+0x1e211, %rdx
nop
nop
nop
nop
...
nop
cmp $62880, %rax
lea addresses_A_ht+0x3031, %rsi
lea addresses_D_ht+0xf3e5, %rdi
nop
nop
nop
nop
...
nop
xor $33782, %rax
lea addresses_A_ht+0x10ae1, %rsi
lea addresses_WC_ht+0xba91, %rdi
nop
nop
nop
nop
...
nop
xor %r14, %r14
lea addresses_WC_ht+0x6611, %rsi
lea addresses_WC_ht+0xdc4f, %rdi
nop
nop
nop
nop
...
rep movsq
xor $39990, %rdx
lea addresses_WT_ht+0x13a11, %rdi
nop
nop
nop
inc %rax
...
movq %r9, (%rdi)
cmp $62616, %rdi
lea addresses_D_ht+0x18e11, %rax
nop
inc %rcx
movups (%rax), %xmm1
vpextrq $1, %xmm1, %rdi
...
nop
and $8654, %r12
lea addresses_WT_ht+0x1865f, %rcx
nop
nop
nop
nop
...
nop
xor $62797, %r12
lea addresses_WT_ht+0x19e11, %rsi
lea addresses_WT_ht+0x10611, %rdi
nop
nop
add $14557, %rax
mov $30, %rcx
...
nop
xor $46073, %r14
lea addresses_D_ht+0x1d97, %rcx
nop
cmp %rdi, %rdi
movb (%rcx), %al
nop
sub $62775, %rcx
lea addresses_normal_ht+0x91, %r12
nop
and %rsi, %rsi
mov $0x6162636465666768, %r9
movq %r9, %xmm2
...
nop
sub $15270, %rcx
lea addresses_WC_ht+0xa551, %rdx
dec %rdi
movups (%rdx), %xmm1
vpextrq $1, %xmm1, %r12
nop
...
nop
cmp %r12, %r12
lea addresses_UC_ht+0x4221, %rsi
lea addresses_WT_ht+0xc5d1, %rdi
nop
dec %rax
mov $3, %rcx
rep movsq
...
{'OP': 'REPM', 'src': {'type': 'addresses_A_ht', 'congruent': 4, 'same': True}, 'dst': {'type': 'addresses_WC_ht', 'congruent': 4, 'same': False}}
...
{'OP': 'LOAD', 'src': {'type': 'addresses_D_ht', 'AVXalign': True, 'congruent': 1, 'size': 1, 'same': False, 'NT': False}}
