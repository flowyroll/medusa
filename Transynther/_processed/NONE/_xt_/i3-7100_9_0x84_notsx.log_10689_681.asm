...
push %rdi
push %rsi
lea addresses_A_ht+0xe7f7, %rsi
lea addresses_A_ht+0x54f7, %rdi
clflush (%rsi)
nop
nop
nop
...
nop
inc %rcx
lea addresses_UC_ht+0x6157, %rdi
inc %r11
movw $0x6162, (%rdi)
and $20122, %rdi
pop %rsi
...
// REPMOV
lea addresses_A+0x16ba7, %rsi
lea addresses_A+0xbb03, %rdi
nop
nop
nop
nop
...
{'src': {'type': 'addresses_A', 'congruent': 4, 'same': False}, 'dst': {'type': 'addresses_A', 'congruent': 2, 'same': False}, 'OP': 'REPM'}
...
<gen_prepare_buffer>
{'src': {'type': 'addresses_A_ht', 'congruent': 9, 'same': False}, 'dst': {'type': 'addresses_A_ht', 'congruent': 8, 'same': True}, 'OP': 'REPM'}
