...
nop
dec %r11
lea addresses_UC_ht+0x1dc37, %rsi
lea addresses_normal_ht+0x1057, %rdi
nop
nop
nop
nop
...
// Faulty Load
lea addresses_normal+0x15257, %rdi
nop
nop
nop
nop
...
{'OP': 'STOR', 'dst': {'congruent': 8, 'AVXalign': True, 'same': False, 'size': 2, 'NT': True, 'type': 'addresses_PSE'}}
