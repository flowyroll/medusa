...
vmovntdq %ymm1, (%r13)
cmp $42249, %r15
lea addresses_WT_ht+0x10872, %rdx
nop
nop
nop
nop
...
// Store
lea addresses_normal+0x974a, %rbp
nop
nop
nop
nop
...
{'OP': 'STOR', 'dst': {'size': 16, 'NT': True, 'type': 'addresses_US', 'same': False, 'AVXalign': False, 'congruent': 0}}
