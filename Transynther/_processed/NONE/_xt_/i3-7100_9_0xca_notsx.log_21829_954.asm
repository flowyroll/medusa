...
push %rdx
push %rsi
lea addresses_D_ht+0x16c25, %rsi
lea addresses_D_ht+0xf405, %rdi
nop
dec %r12
mov $70, %rcx
rep movsl
...
nop
and $27036, %rdi
lea addresses_D_ht+0x195f9, %r12
and %r14, %r14
movb $0x61, (%r12)
nop
nop
...
nop
and $53662, %rdi
lea addresses_UC_ht+0x10a25, %rsi
nop
nop
nop
nop
...
// REPMOV
lea addresses_WC+0x9425, %rsi
lea addresses_A+0x1e525, %rdi
nop
nop
nop
and $4120, %rbp
...
{'src': {'type': 'addresses_WC', 'congruent': 10, 'same': False}, 'OP': 'REPM', 'dst': {'type': 'addresses_A', 'congruent': 7, 'same': False}}
...
{'src': {'type': 'addresses_D_ht', 'congruent': 1, 'same': True}, 'OP': 'REPM', 'dst': {'type': 'addresses_A_ht', 'congruent': 1, 'same': False}}
