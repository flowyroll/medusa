...
nop
and $62261, %rdx
lea addresses_WT_ht+0x67ff, %rsi
lea addresses_WT_ht+0x1cd0c, %rdi
clflush (%rdi)
nop
nop
nop
...
rep movsb
cmp %r10, %r10
lea addresses_D_ht+0xacbf, %rsi
lea addresses_D_ht+0x1333f, %rdi
nop
nop
nop
nop
...
nop
cmp %rdx, %rdx
lea addresses_UC_ht+0x100bf, %rsi
lea addresses_D_ht+0x17def, %rdi
nop
and %r11, %r11
mov $104, %rcx
rep movsb
...
nop
xor $14898, %rdi
lea addresses_WT_ht+0x14abf, %rdi
nop
nop
nop
xor $40144, %rcx
...
nop
cmp %rdi, %rdi
lea addresses_WC_ht+0x12dc7, %rcx
nop
nop
nop
nop
...
nop
xor $11195, %rdx
lea addresses_UC_ht+0x11d39, %rsi
nop
nop
nop
nop
...
nop
and %r10, %r10
lea addresses_WC_ht+0x1a83f, %r11
nop
nop
nop
cmp %rsi, %rsi
...
nop
add $65089, %rdx
lea addresses_A_ht+0x119ff, %rcx
nop
and %r10, %r10
...
nop
mfence
lea addresses_A_ht+0x1c4f9, %rsi
lea addresses_UC_ht+0x1883f, %rdi
nop
nop
nop
and $33534, %r10
...
rep movsl
sub $38871, %rdi
lea addresses_D_ht+0x114bf, %rax
nop
nop
nop
nop
...
<gen_prepare_buffer>
{'OP': 'REPM', 'src': {'type': 'addresses_UC_ht', 'congruent': 10, 'same': False}, 'dst': {'type': 'addresses_WC_ht', 'congruent': 0, 'same': False}}
{'OP': 'REPM', 'src': {'type': 'addresses_WT_ht', 'congruent': 6, 'same': False}, 'dst': {'type': 'addresses_WT_ht', 'congruent': 0, 'same': False}}
{'OP': 'REPM', 'src': {'type': 'addresses_D_ht', 'congruent': 7, 'same': False}, 'dst': {'type': 'addresses_D_ht', 'congruent': 7, 'same': False}}
