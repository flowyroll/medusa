...
push %rdi
push %rsi
lea addresses_UC_ht+0x9272, %r14
nop
xor $21026, %rcx
movw $0x6162, (%r14)
nop
...
nop
cmp $52015, %rdi
lea addresses_WC_ht+0x3b8e, %rcx
nop
nop
nop
and $39806, %rbp
...
nop
and %rsi, %rsi
lea addresses_UC_ht+0xd5f6, %r15
nop
nop
nop
nop
...
// Faulty Load
lea addresses_normal+0x39f6, %rax
nop
nop
cmp $42877, %rbx
movb (%rax), %r8b
