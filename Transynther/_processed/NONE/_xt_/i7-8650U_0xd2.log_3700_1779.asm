...
push %rdi
push %rsi
lea addresses_WT_ht+0xb786, %r10
nop
nop
nop
cmp $47279, %r14
...
nop
inc %r13
lea addresses_WT_ht+0x1db86, %rcx
clflush (%rcx)
nop
nop
nop
...
nop
dec %r10
lea addresses_A_ht+0x1aa06, %rsi
...
nop
cmp %r10, %r10
lea addresses_normal_ht+0x2286, %rcx
nop
nop
sub $17924, %r15
mov (%rcx), %r10
dec %rdi
lea addresses_WC_ht+0x4a02, %r10
and %r13, %r13
movups (%r10), %xmm2
vpextrq $0, %xmm2, %r14
nop
...
nop
and $7928, %r8
lea addresses_UC_ht+0x15d46, %rcx
nop
nop
nop
dec %r10
