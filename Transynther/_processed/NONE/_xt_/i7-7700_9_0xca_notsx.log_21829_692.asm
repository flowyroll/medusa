...
nop
add $16433, %rcx
lea addresses_UC_ht+0x831e, %r15
nop
nop
cmp %rdi, %rdi
movl $0x61626364, (%r15)
...
lea addresses_A_ht+0x11bd6, %rdi
nop
nop
nop
nop
...
nop
and $3499, %rcx
lea addresses_D_ht+0x10d6, %rsi
lea addresses_WC_ht+0x1cbd6, %rdi
clflush (%rdi)
nop
nop
nop
...
nop
inc %rcx
lea addresses_UC_ht+0x1dfe6, %r13
nop
nop
and $35862, %rsi
mov (%r13), %di
...
nop
and $45656, %rdi
lea addresses_UC_ht+0x98c0, %rsi
clflush (%rsi)
nop
nop
nop
...
{'src': {'congruent': 8, 'same': True, 'type': 'addresses_UC_ht'}, 'dst': {'congruent': 10, 'same': False, 'type': 'addresses_A_ht'}, 'OP': 'REPM'}
