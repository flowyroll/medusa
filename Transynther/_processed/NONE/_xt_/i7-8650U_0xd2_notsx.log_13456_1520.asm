...
push %rdi
push %rsi
lea addresses_UC_ht+0x184f7, %rsi
lea addresses_WT_ht+0x8b91, %rdi
nop
nop
add %r10, %r10
mov $108, %rcx
rep movsb
xor $50751, %r14
lea addresses_WT_ht+0x164f7, %rsi
nop
nop
nop
and %r13, %r13
...
movq %r10, (%rsi)
and %r10, %r10
lea addresses_WC_ht+0x1a9cf, %rsi
...
nop
cmp %r10, %r10
lea addresses_D_ht+0x2cf7, %rdi
nop
add %rbp, %rbp
movb (%rdi), %r10b
nop
cmp $23920, %rsi
lea addresses_A_ht+0x174f7, %rsi
lea addresses_A_ht+0x170f7, %rdi
clflush (%rsi)
nop
nop
nop
...
nop
dec %r9
lea addresses_UC_ht+0x128f7, %rbp
clflush (%rbp)
nop
nop
nop
...
vpextrq $1, %xmm1, %r9
cmp %r9, %r9
lea addresses_UC_ht+0x1ccf7, %rsi
lea addresses_normal_ht+0x11607, %rdi
cmp %r9, %r9
mov $116, %rcx
rep movsb
nop
add $45280, %rcx
lea addresses_D_ht+0x1e4f7, %rcx
nop
nop
nop
nop
...
nop
and $54652, %r10
lea addresses_WT_ht+0xbcf7, %r10
nop
nop
nop
nop
...
<gen_prepare_buffer>
{'OP': 'REPM', 'src': {'type': 'addresses_UC_ht', 'congruent': 9, 'same': False}, 'dst': {'type': 'addresses_WT_ht', 'congruent': 0, 'same': False}}
{'OP': 'STOR', 'dst': {'type': 'addresses_WT_ht', 'size': 8, 'AVXalign': False, 'NT': False, 'congruent': 11, 'same': False}}
{'OP': 'REPM', 'src': {'type': 'addresses_WC_ht', 'congruent': 3, 'same': False}, 'dst': {'type': 'addresses_WC_ht', 'congruent': 7, 'same': False}}
...
{'OP': 'LOAD', 'src': {'type': 'addresses_D_ht', 'size': 1, 'AVXalign': False, 'NT': False, 'congruent': 10, 'same': True}}
