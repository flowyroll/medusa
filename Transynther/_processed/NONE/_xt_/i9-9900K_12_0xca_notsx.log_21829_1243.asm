...
nop
xor %rcx, %rcx
lea addresses_WC_ht+0x110a2, %r10
nop
nop
nop
add $55100, %rdi
...
nop
and $31601, %r8
lea addresses_WT_ht+0xd8b2, %rsi
lea addresses_normal_ht+0x1bab2, %rdi
clflush (%rdi)
nop
cmp $35385, %r13
mov $11, %rcx
