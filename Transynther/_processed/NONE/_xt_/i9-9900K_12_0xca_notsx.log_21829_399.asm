...
nop
sub $61017, %r10
lea addresses_WC_ht+0x1dde6, %rax
nop
nop
and %rdx, %rdx
movb $0x61, (%rax)
...
nop
xor %r13, %r13
lea addresses_normal_ht+0x5edd, %rsi
lea addresses_normal_ht+0xffc0, %rdi
sub $2484, %r8
mov $95, %rcx
rep movsl
nop
...
nop
cmp %rdi, %rdi
lea addresses_WC_ht+0x134d0, %r13
nop
nop
xor $4916, %r8
movups (%r13), %xmm6
...
nop
cmp $40980, %rcx
lea addresses_D_ht+0x11db8, %rdi
nop
nop
nop
nop
...
{'OP': 'REPM', 'src': {'same': False, 'congruent': 0, 'type': 'addresses_normal_ht'}, 'dst': {'same': False, 'congruent': 2, 'type': 'addresses_normal_ht'}}
