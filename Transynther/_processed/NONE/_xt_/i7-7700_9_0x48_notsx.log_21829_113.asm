...
nop
add $554, %rdi
lea addresses_A_ht+0x13a2c, %rsi
lea addresses_WT_ht+0x165b0, %rdi
nop
and $22755, %rdx
mov $15, %rcx
rep movsl
...
nop
add %rdi, %rdi
lea addresses_WT_ht+0x2318, %rbx
nop
nop
nop
nop
...
movq %r8, (%rbx)
and $40957, %rdi
lea addresses_D_ht+0xd5ac, %rsi
lea addresses_WT_ht+0x152c, %rdi
nop
nop
dec %r9
mov $105, %rcx
...
nop
dec %rdx
lea addresses_WT_ht+0x13df0, %rbx
nop
nop
nop
nop
...
// Load
lea addresses_normal+0x13bc8, %rbp
nop
nop
nop
nop
...
{'dst': {'same': False, 'congruent': 2, 'type': 'addresses_WT_ht'}, 'OP': 'REPM', 'src': {'same': False, 'congruent': 7, 'type': 'addresses_A_ht'}}
