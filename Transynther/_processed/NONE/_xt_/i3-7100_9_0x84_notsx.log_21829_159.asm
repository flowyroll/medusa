...
push %rbx
push %rcx
lea addresses_UC_ht+0xfe1d, %rbx
nop
inc %rcx
movb $0x61, (%rbx)
cmp $31303, %rax
lea addresses_D_ht+0xf06d, %rcx
nop
nop
and %r11, %r11
movb (%rcx), %r8b
dec %rcx
lea addresses_D_ht+0x1ab1d, %r11
cmp $18993, %rbp
movw $0x6162, (%r11)
nop
nop
nop
inc %r11
lea addresses_UC_ht+0x621d, %r12
dec %rcx
mov (%r12), %bp
nop
nop
...
// REPMOV
lea addresses_A+0x1459d, %rsi
mov $0x582cac0000000e1d, %rdi
clflush (%rsi)
nop
nop
add %rax, %rax
...
// REPMOV
lea addresses_D+0xecbd, %rsi
lea addresses_UC+0x601d, %rdi
nop
nop
nop
nop
...
{'src': {'type': 'addresses_A', 'congruent': 6, 'same': False}, 'dst': {'type': 'addresses_NC', 'congruent': 11, 'same': False}, 'OP': 'REPM'}
{'dst': {'type': 'addresses_WC', 'same': False, 'size': 1, 'congruent': 9, 'NT': False, 'AVXalign': False}, 'OP': 'STOR'}
{'src': {'type': 'addresses_D', 'congruent': 4, 'same': False}, 'dst': {'type': 'addresses_UC', 'congruent': 8, 'same': False}, 'OP': 'REPM'}
...
<gen_prepare_buffer>
{'dst': {'type': 'addresses_UC_ht', 'same': False, 'size': 1, 'congruent': 10, 'NT': False, 'AVXalign': True}, 'OP': 'STOR'}
