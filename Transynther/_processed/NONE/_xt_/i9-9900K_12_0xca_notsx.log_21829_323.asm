...
nop
xor $37665, %rax
lea addresses_A_ht+0x15408, %rax
nop
nop
nop
inc %r15
...
nop
cmp $36340, %rax
lea addresses_UC_ht+0x16208, %r12
nop
nop
cmp %r13, %r13
movw $0x6162, (%r12)
...
nop
add $61139, %r9
lea addresses_UC_ht+0x1c608, %rsi
lea addresses_A_ht+0x1bc08, %rdi
sub $48715, %r13
mov $23, %rcx
rep movsw
nop
...
lea addresses_A_ht+0x1a008, %rdi
cmp %r9, %r9
mov $84, %rcx
rep movsl
nop
...
// Faulty Load
lea addresses_normal+0x9c08, %r15
nop
nop
sub %r10, %r10
mov (%r15), %rdx
...
{'OP': 'STOR', 'dst': {'same': False, 'type': 'addresses_PSE', 'NT': False, 'AVXalign': True, 'size': 2, 'congruent': 7}}
[Faulty Load]
...
{'OP': 'REPM', 'src': {'same': False, 'congruent': 8, 'type': 'addresses_UC_ht'}, 'dst': {'same': False, 'congruent': 10, 'type': 'addresses_A_ht'}}
{'OP': 'REPM', 'src': {'same': False, 'congruent': 11, 'type': 'addresses_normal_ht'}, 'dst': {'same': False, 'congruent': 6, 'type': 'addresses_A_ht'}}
{'OP': 'REPM', 'src': {'same': False, 'congruent': 0, 'type': 'addresses_UC_ht'}, 'dst': {'same': False, 'congruent': 11, 'type': 'addresses_A_ht'}}
{'34': 21829}
