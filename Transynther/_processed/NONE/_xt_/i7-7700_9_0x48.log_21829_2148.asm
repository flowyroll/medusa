...
nop
sub %rcx, %rcx
lea addresses_UC_ht+0xf366, %rdi
nop
add %r9, %r9
...
nop
and %rdx, %rdx
lea addresses_D_ht+0xa962, %rsi
lea addresses_D_ht+0x19d66, %rdi
clflush (%rdi)
nop
nop
nop
...
nop
sub $55177, %rsi
lea addresses_D_ht+0x140e6, %rsi
lea addresses_A_ht+0x13466, %rdi
nop
sub %rax, %rax
mov $79, %rcx
rep movsq
...
// Store
lea addresses_normal+0xb42f, %r8
cmp %r13, %r13
movb $0x51, (%r8)
nop
add %r9, %r9
...
{'OP': 'STOR', 'dst': {'type': 'addresses_normal', 'AVXalign': True, 'congruent': 0, 'size': 1, 'same': False, 'NT': False}}
