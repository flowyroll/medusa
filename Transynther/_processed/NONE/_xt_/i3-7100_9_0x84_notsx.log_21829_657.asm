...
push %rdx
push %rsi
lea addresses_WT_ht+0xdfc5, %rbx
nop
nop
xor $32411, %rdx
vmovups (%rbx), %ymm6
...
nop
xor %rbx, %rbx
lea addresses_normal_ht+0x16f85, %rdi
nop
nop
and $165, %r14
...
nop
sub $8791, %rbx
lea addresses_WC_ht+0x1332d, %rdx
nop
nop
and %rsi, %rsi
...
movups %xmm5, (%rdx)
sub $23651, %rbx
lea addresses_D_ht+0x1bd1f, %rcx
nop
add $21967, %r14
vmovups (%rcx), %ymm5
...
vpextrq $0, %xmm5, %rsi
cmp %rdi, %rdi
lea addresses_D_ht+0x15b65, %rsi
lea addresses_A_ht+0x15a97, %rdi
clflush (%rdi)
nop
nop
nop
...
nop
inc %r11
lea addresses_WC_ht+0x1065, %r14
xor $2836, %rcx
...
nop
and $21142, %rsi
lea addresses_WT_ht+0x3e0b, %rsi
lea addresses_A_ht+0x166e5, %rdi
clflush (%rdi)
nop
xor %r15, %r15
mov $116, %rcx
...
nop
and $3687, %rsi
lea addresses_UC_ht+0xbfe5, %r15
nop
nop
nop
nop
...
// Faulty Load
lea addresses_normal+0x1a6e5, %rcx
nop
nop
nop
nop
