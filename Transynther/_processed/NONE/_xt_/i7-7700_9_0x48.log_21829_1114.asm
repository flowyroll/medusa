...
nop
and %rbx, %rbx
lea addresses_WC_ht+0xbd11, %r13
nop
nop
nop
nop
...
nop
add %rsi, %rsi
lea addresses_WT_ht+0x1f6d, %r10
nop
nop
nop
nop
...
nop
mfence
lea addresses_WC_ht+0xbeed, %rbx
nop
nop
nop
inc %rsi
...
nop
cmp %rbp, %rbp
lea addresses_normal_ht+0xe8ad, %rbx
nop
nop
nop
nop
...
nop
add %rbx, %rbx
lea addresses_WT_ht+0xfd2d, %rsi
lea addresses_WC_ht+0x1326d, %rdi
inc %rbx
mov $37, %rcx
rep movsw
nop
...
// Faulty Load
lea addresses_normal+0x266d, %rdi
nop
nop
nop
nop
