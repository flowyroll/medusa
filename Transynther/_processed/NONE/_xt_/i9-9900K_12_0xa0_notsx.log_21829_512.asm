...
push %rdi
push %rsi
lea addresses_normal_ht+0xc7ff, %r12
nop
sub %rbx, %rbx
movups (%r12), %xmm4
vpextrq $1, %xmm4, %rcx
...
nop
lfence
lea addresses_WC_ht+0x747f, %r10
nop
nop
nop
nop
...
rep movsb
and $47614, %rdi
lea addresses_WC_ht+0x1737f, %r13
nop
nop
nop
nop
...
nop
cmp $63693, %r13
lea addresses_D_ht+0x10a23, %rsi
nop
nop
and %rcx, %rcx
mov (%rsi), %r12w
nop
and $51407, %rdi
lea addresses_WC_ht+0x1e57f, %rdi
clflush (%rdi)
nop
nop
nop
...
nop
xor %r12, %r12
lea addresses_WT_ht+0x1717f, %rbp
nop
nop
nop
nop
...
{'src': {'type': 'addresses_A_ht', 'congruent': 11, 'same': False}, 'OP': 'REPM', 'dst': {'type': 'addresses_A_ht', 'congruent': 6, 'same': True}}
