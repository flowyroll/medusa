...
push %rdi
push %rsi
lea addresses_normal_ht+0x14457, %r11
and $10019, %rax
...
nop
and %r14, %r14
lea addresses_UC_ht+0xb927, %rbx
nop
nop
nop
cmp $49259, %r10
...
nop
xor $49229, %rbx
lea addresses_normal_ht+0x1a33f, %rsi
lea addresses_D_ht+0x1d6ff, %rdi
clflush (%rdi)
nop
nop
nop
...
nop
xor %r14, %r14
lea addresses_WC_ht+0x237f, %rsi
clflush (%rsi)
nop
nop
nop
...
nop
xor %rax, %rax
lea addresses_WC_ht+0x8dee, %rax
nop
nop
nop
and $2386, %rcx
...
nop
inc %rcx
lea addresses_WT_ht+0x69a7, %rbx
clflush (%rbx)
nop
nop
nop
...
mov (%rbx), %esi
xor $63352, %rax
lea addresses_A_ht+0x11cff, %r15
nop
inc %r11
mov $0x6162636465666768, %rax
movq %rax, %xmm1
...
nop
sub %r15, %r15
lea addresses_A_ht+0x180ef, %rcx
nop
nop
nop
nop
...
nop
sub $55175, %rax
lea addresses_WC_ht+0xdeff, %rsi
lea addresses_UC_ht+0x12a3f, %rdi
clflush (%rsi)
nop
nop
xor $56880, %rax
...
nop
cmp $4499, %rcx
lea addresses_WT_ht+0xdb86, %rdi
add $9342, %rax
movl $0x61626364, (%rdi)
nop
add $4877, %rbx
lea addresses_D_ht+0xfaff, %rcx
xor %rsi, %rsi
mov (%rcx), %r11w
nop
nop
...
{'src': {'same': False, 'congruent': 6, 'type': 'addresses_normal_ht'}, 'OP': 'REPM', 'dst': {'same': False, 'congruent': 10, 'type': 'addresses_D_ht'}}
{'OP': 'STOR', 'dst': {'NT': False, 'same': False, 'congruent': 6, 'type': 'addresses_WC_ht', 'AVXalign': False, 'size': 32}}
{'src': {'NT': False, 'same': False, 'congruent': 0, 'type': 'addresses_WC_ht', 'AVXalign': True, 'size': 1}, 'OP': 'LOAD'}
...
{'OP': 'STOR', 'dst': {'NT': False, 'same': False, 'congruent': 4, 'type': 'addresses_A_ht', 'AVXalign': True, 'size': 2}}
{'src': {'same': False, 'congruent': 11, 'type': 'addresses_WC_ht'}, 'OP': 'REPM', 'dst': {'same': True, 'congruent': 4, 'type': 'addresses_UC_ht'}}
