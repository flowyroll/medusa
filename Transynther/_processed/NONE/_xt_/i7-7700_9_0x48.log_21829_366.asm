...
push %rdi
push %rsi
lea addresses_UC_ht+0x18635, %rsi
lea addresses_UC_ht+0x16631, %rdi
nop
and %r15, %r15
mov $24, %rcx
rep movsw
...
nop
xor $6196, %r13
lea addresses_D_ht+0x12eab, %rcx
nop
nop
nop
dec %r13
...
nop
and %r13, %r13
lea addresses_WC_ht+0x15231, %r10
nop
nop
nop
nop
...
mov (%r10), %edi
add $16467, %r10
lea addresses_A_ht+0x16f45, %r13
nop
nop
nop
nop
...
nop
and $11557, %rdi
lea addresses_normal_ht+0x6671, %r15
nop
sub $54590, %r13
...
nop
cmp %r10, %r10
lea addresses_normal_ht+0xb7b1, %rsi
lea addresses_D_ht+0x18231, %rdi
nop
nop
add %r12, %r12
mov $21, %rcx
...
nop
inc %r15
lea addresses_UC_ht+0x15e31, %rsi
lea addresses_WT_ht+0xd231, %rdi
nop
nop
and $15743, %r15
mov $114, %rcx
...
nop
xor %r12, %r12
lea addresses_WC_ht+0x17249, %rsi
clflush (%rsi)
nop
nop
nop
...
<gen_prepare_buffer>
{'OP': 'REPM', 'src': {'type': 'addresses_UC_ht', 'congruent': 2, 'same': False}, 'dst': {'type': 'addresses_UC_ht', 'congruent': 9, 'same': False}}
...
{'OP': 'REPM', 'src': {'type': 'addresses_D_ht', 'congruent': 1, 'same': False}, 'dst': {'type': 'addresses_A_ht', 'congruent': 10, 'same': True}}
