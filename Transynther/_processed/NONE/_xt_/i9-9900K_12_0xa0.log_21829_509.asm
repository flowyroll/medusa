...
push %rdi
push %rsi
lea addresses_WC_ht+0x931e, %rax
nop
nop
nop
nop
...
lea addresses_WT_ht+0x10e52, %rdi
nop
nop
nop
sub %rbp, %rbp
...
nop
and %r8, %r8
lea addresses_WT_ht+0x6952, %r15
nop
nop
nop
nop
...
nop
add $36661, %r15
lea addresses_WC_ht+0x12652, %r15
nop
nop
cmp $28054, %rbp
movb (%r15), %cl
...
nop
sub %rdi, %rdi
lea addresses_UC_ht+0x7ad2, %rax
nop
nop
xor %rcx, %rcx
movups (%rax), %xmm4
...
nop
inc %rcx
lea addresses_WT_ht+0xa312, %rsi
lea addresses_A_ht+0x10cd2, %rdi
clflush (%rdi)
nop
and $47532, %rax
mov $104, %rcx
...
nop
sub %r8, %r8
lea addresses_WC_ht+0xa312, %rsi
lea addresses_WC_ht+0x10aa6, %rdi
nop
nop
nop
nop
...
nop
xor %r12, %r12
lea addresses_WT_ht+0x14143, %rcx
clflush (%rcx)
nop
nop
nop
...
nop
mfence
lea addresses_A_ht+0x1e0d2, %rsi
lea addresses_D_ht+0xcff2, %rdi
nop
add %rax, %rax
mov $21, %rcx
rep movsq
nop
cmp $37811, %r12
lea addresses_WT_ht+0xa6d2, %rax
xor $16813, %r15
mov (%rax), %rdi
nop
nop
nop
xor %rax, %rax
lea addresses_normal_ht+0x13dd2, %r8
and %r15, %r15
...
nop
and %r15, %r15
lea addresses_WT_ht+0x17f1a, %rdi
and $20657, %r15
vmovups (%rdi), %ymm6
vextracti128 $1, %ymm6, %xmm6
vpextrq $1, %xmm6, %rbp
cmp $12931, %r15
lea addresses_UC_ht+0x126d2, %r12
nop
nop
nop
nop
...
{'src': {'same': False, 'congruent': 11, 'type': 'addresses_A_ht'}, 'OP': 'REPM', 'dst': {'same': False, 'congruent': 7, 'type': 'addresses_WT_ht'}}
...
{'src': {'same': True, 'congruent': 4, 'type': 'addresses_WT_ht'}, 'OP': 'REPM', 'dst': {'same': False, 'congruent': 8, 'type': 'addresses_A_ht'}}
{'src': {'same': False, 'congruent': 5, 'type': 'addresses_WC_ht'}, 'OP': 'REPM', 'dst': {'same': False, 'congruent': 2, 'type': 'addresses_WC_ht'}}
...
{'src': {'NT': False, 'same': True, 'congruent': 10, 'type': 'addresses_UC_ht', 'AVXalign': True, 'size': 8}, 'OP': 'LOAD'}
{'33': 21829}
