...
nop
dec %rcx
lea addresses_WC_ht+0x1611d, %r9
nop
nop
nop
nop
...
nop
dec %r8
lea addresses_WC_ht+0xe2c1, %rsi
lea addresses_WT_ht+0xcb13, %rdi
nop
nop
mfence
mov $10, %rcx
...
nop
xor $30654, %rcx
lea addresses_WT_ht+0x15a95, %rdi
nop
sub %rsi, %rsi
...
movups %xmm6, (%rdi)
sub %rax, %rax
lea addresses_UC_ht+0x1d095, %rsi
lea addresses_normal_ht+0x128d1, %rdi
nop
cmp $28630, %r8
mov $68, %rcx
rep movsb
...
nop
sub %rsi, %rsi
lea addresses_normal_ht+0x1c9d5, %rcx
nop
nop
nop
nop
...
mov (%rcx), %r11
sub %r9, %r9
lea addresses_A_ht+0x13f55, %rsi
clflush (%rsi)
nop
nop
sub $42207, %rdi
...
vmovntdq %ymm3, (%rcx)
add $47374, %rsi
lea addresses_UC_ht+0x12e6b, %r11
nop
nop
nop
sub %rdi, %rdi
...
// Faulty Load
lea addresses_normal+0x13795, %r13
cmp $36739, %rdi
mov (%r13), %r12w
lea oracles, %rdi
and $0xff, %r12
...
{'OP': 'STOR', 'dst': {'type': 'addresses_UC_ht', 'AVXalign': True, 'congruent': 1, 'size': 1, 'same': False, 'NT': False}}
{'34': 21829}
