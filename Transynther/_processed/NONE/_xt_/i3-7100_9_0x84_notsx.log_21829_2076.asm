...
push %rbp
push %rcx
lea addresses_UC_ht+0x13687, %r9
clflush (%r9)
nop
nop
nop
...
nop
inc %rbp
lea addresses_UC_ht+0x7f5f, %r10
nop
nop
and %r8, %r8
...
nop
inc %r10
lea addresses_WC_ht+0x11247, %r12
clflush (%r12)
add %rcx, %rcx
mov (%r12), %rbp
nop
...
nop
sub %r12, %r12
lea addresses_UC_ht+0x1c247, %rcx
nop
nop
nop
nop
...
nop
cmp $20072, %r10
lea addresses_WT_ht+0x9f97, %rbp
nop
nop
nop
nop
...
nop
mfence
lea addresses_normal_ht+0xd047, %r10
dec %r14
mov (%r10), %rbp
nop
nop
...
nop
add $3852, %r8
lea addresses_UC_ht+0x1dc15, %r8
clflush (%r8)
nop
nop
nop
...
{'src': {'type': 'addresses_PSE', 'same': False, 'size': 32, 'congruent': 9, 'NT': False, 'AVXalign': False}, 'OP': 'LOAD'}
