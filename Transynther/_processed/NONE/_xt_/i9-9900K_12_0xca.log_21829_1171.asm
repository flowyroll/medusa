...
push %rdx
push %rsi
lea addresses_UC_ht+0xb530, %rsi
lea addresses_UC_ht+0x14966, %rdi
clflush (%rdi)
nop
nop
nop
...
rep movsb
cmp %r12, %r12
lea addresses_UC_ht+0x85b0, %r14
nop
nop
xor $12236, %rsi
mov (%r14), %r12d
...
nop
xor $53591, %rcx
lea addresses_UC_ht+0x1e0b0, %rsi
lea addresses_WC_ht+0x1b4b0, %rdi
nop
nop
nop
nop
...
nop
sub $15462, %r12
lea addresses_normal_ht+0x1bbb0, %rdi
nop
nop
nop
nop
...
nop
and %r8, %r8
lea addresses_UC_ht+0x16ac8, %r8
nop
nop
nop
nop
...
nop
xor %rdx, %rdx
lea addresses_UC_ht+0xc950, %rdx
nop
nop
cmp %rsi, %rsi
movups (%rdx), %xmm7
...
nop
add %r12, %r12
lea addresses_normal_ht+0xe4b0, %rsi
lea addresses_WC_ht+0xf5b0, %rdi
nop
nop
nop
nop
...
nop
add $22823, %r12
lea addresses_UC_ht+0x1b270, %r14
sub $24817, %r8
mov (%r14), %edi
nop
nop
...
nop
and %r8, %r8
lea addresses_D_ht+0x105b0, %r12
and $29817, %r8
movb (%r12), %cl
nop
add %r14, %r14
lea addresses_WC_ht+0x186a4, %r8
nop
xor $10773, %r12
movb (%r8), %cl
nop
and $5446, %r14
lea addresses_A_ht+0x190b0, %r14
nop
nop
nop
add $57529, %rdx
...
<gen_prepare_buffer>
{'OP': 'REPM', 'src': {'same': False, 'type': 'addresses_UC_ht', 'congruent': 6}, 'dst': {'same': False, 'type': 'addresses_UC_ht', 'congruent': 1}}
{'OP': 'LOAD', 'src': {'size': 4, 'NT': False, 'type': 'addresses_UC_ht', 'same': False, 'AVXalign': False, 'congruent': 8}}
{'OP': 'REPM', 'src': {'same': False, 'type': 'addresses_UC_ht', 'congruent': 9}, 'dst': {'same': False, 'type': 'addresses_WC_ht', 'congruent': 11}}
...
{'OP': 'REPM', 'src': {'same': False, 'type': 'addresses_normal_ht', 'congruent': 10}, 'dst': {'same': False, 'type': 'addresses_WC_ht', 'congruent': 8}}
...
{'OP': 'STOR', 'dst': {'size': 4, 'NT': True, 'type': 'addresses_A_ht', 'same': False, 'AVXalign': False, 'congruent': 9}}
{'33': 21829}
