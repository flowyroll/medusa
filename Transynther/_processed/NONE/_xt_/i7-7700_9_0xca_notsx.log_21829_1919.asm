...
push %rdi
push %rsi
lea addresses_WT_ht+0x13df3, %r10
nop
nop
nop
nop
...
nop
add $22754, %r11
lea addresses_normal_ht+0x1247a, %r13
nop
add $28202, %r11
mov (%r13), %r12w
nop
...
nop
sub %r11, %r11
lea addresses_WT_ht+0x1c586, %r12
nop
nop
nop
nop
...
nop
and %r10, %r10
lea addresses_normal_ht+0x10f5, %r15
nop
nop
nop
cmp $22169, %r13
...
nop
dec %rdi
lea addresses_WT_ht+0xc673, %r13
nop
nop
xor %r15, %r15
movl $0x61626364, (%r13)
...
nop
and %r8, %r8
lea addresses_A_ht+0xf95a, %rsi
lea addresses_WC_ht+0x18a6d, %rdi
sub %r15, %r15
mov $52, %rcx
rep movsw
nop
nop
cmp %r13, %r13
lea addresses_A_ht+0x1e9a3, %rsi
lea addresses_normal_ht+0x307, %rdi
nop
cmp %r8, %r8
mov $107, %rcx
rep movsq
xor $3711, %r10
lea addresses_UC_ht+0xc208, %r10
nop
nop
nop
nop
...
nop
and $6649, %rcx
lea addresses_WT_ht+0x4e53, %rsi
clflush (%rsi)
nop
dec %r8
mov $0x6162636465666768, %r13
...
nop
and %r10, %r10
lea addresses_normal_ht+0xc3f3, %rsi
lea addresses_WC_ht+0x110c3, %rdi
nop
nop
nop
dec %r15
...
nop
add $26383, %rsi
lea addresses_WT_ht+0x31cb, %r10
xor $45441, %rdi
vmovups (%r10), %ymm0
...
{'src': {'congruent': 0, 'same': False, 'type': 'addresses_A_ht'}, 'dst': {'congruent': 1, 'same': False, 'type': 'addresses_WC_ht'}, 'OP': 'REPM'}
