...
push %rdi
push %rsi
lea addresses_UC_ht+0x1bac7, %r15
nop
nop
and $20136, %rax
mov (%r15), %r14
xor %r15, %r15
lea addresses_UC_ht+0xc5c7, %rcx
nop
nop
sub %rbp, %rbp
movb (%rcx), %r8b
dec %rax
lea addresses_D_ht+0x78c7, %rsi
lea addresses_WC_ht+0x9407, %rdi
nop
nop
nop
nop
...
nop
sub %r15, %r15
lea addresses_UC_ht+0x1c4c7, %rbp
cmp %r8, %r8
movb (%rbp), %cl
nop
nop
xor $17071, %r14
lea addresses_UC_ht+0x3047, %r8
nop
nop
nop
sub %rbp, %rbp
...
vmovups %ymm3, (%r8)
inc %rbp
lea addresses_WT_ht+0x15947, %r15
nop
nop
nop
nop
...
nop
cmp %rdi, %rdi
lea addresses_WT_ht+0x4787, %rsi
lea addresses_UC_ht+0x7ec7, %rdi
nop
nop
nop
nop
...
nop
dec %rdi
lea addresses_WC_ht+0x1b1c7, %rsi
lea addresses_D_ht+0x39c7, %rdi
add %r14, %r14
mov $11, %rcx
rep movsw
nop
...
{'OP': 'REPM', 'src': {'same': False, 'congruent': 9, 'type': 'addresses_D_ht'}, 'dst': {'same': False, 'congruent': 6, 'type': 'addresses_WC_ht'}}
...
{'OP': 'REPM', 'src': {'same': False, 'congruent': 5, 'type': 'addresses_WT_ht'}, 'dst': {'same': False, 'congruent': 9, 'type': 'addresses_UC_ht'}}
