...
nop
cmp %rsi, %rsi
lea addresses_UC_ht+0xab6f, %rsi
lea addresses_WC_ht+0x179fb, %rdi
nop
dec %rax
mov $126, %rcx
rep movsb
...
nop
and $3784, %r15
lea addresses_UC_ht+0x743b, %rsi
lea addresses_UC_ht+0x277b, %rdi
nop
nop
and %r14, %r14
mov $104, %rcx
