...
push %rdx
push %rsi
lea addresses_WT_ht+0x17de5, %rdx
nop
nop
nop
nop
...
nop
inc %r11
lea addresses_UC_ht+0x1732d, %rsi
nop
nop
cmp $41042, %r13
mov (%rsi), %r10w
...
nop
add $2782, %rsi
lea addresses_normal_ht+0xeaed, %rsi
...
mov (%rsi), %dx
sub $59355, %r11
lea addresses_WC_ht+0xba2d, %rsi
lea addresses_WC_ht+0xa32d, %rdi
clflush (%rsi)
add %r11, %r11
mov $100, %rcx
rep movsw
...
{'OP': 'REPM', 'src': {'same': False, 'congruent': 7, 'type': 'addresses_WC_ht'}, 'dst': {'same': False, 'congruent': 10, 'type': 'addresses_WC_ht'}}
