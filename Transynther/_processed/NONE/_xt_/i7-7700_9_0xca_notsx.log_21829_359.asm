...
push %rdx
push %rsi
lea addresses_normal_ht+0x10946, %r8
nop
nop
nop
dec %rcx
...
nop
add $9632, %rcx
lea addresses_WC_ht+0x15718, %rdx
nop
nop
nop
nop
...
nop
add %rcx, %rcx
lea addresses_WT_ht+0x1c718, %rdx
nop
nop
nop
nop
...
nop
dec %rbx
lea addresses_A_ht+0x77e8, %rsi
lea addresses_A_ht+0xb8e8, %rdi
nop
nop
nop
nop
...
nop
and $45935, %rcx
lea addresses_UC_ht+0x15a68, %rsi
lea addresses_normal_ht+0x15648, %rdi
nop
add %r12, %r12
mov $52, %rcx
rep movsw
...
nop
sub $44669, %r14
lea addresses_WC_ht+0x141e8, %rbx
nop
nop
and $33443, %rcx
movups (%rbx), %xmm2
...
nop
sub %r12, %r12
lea addresses_WC_ht+0x137e8, %rsi
nop
nop
nop
nop
...
{'src': {'congruent': 7, 'same': False, 'type': 'addresses_UC_ht'}, 'dst': {'congruent': 5, 'same': False, 'type': 'addresses_normal_ht'}, 'OP': 'REPM'}
