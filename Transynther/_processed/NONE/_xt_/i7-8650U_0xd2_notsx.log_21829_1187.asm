...
movw $0x6162, (%r14)
and %rbx, %rbx
lea addresses_normal_ht+0x12b88, %r11
nop
add $17011, %r9
mov (%r11), %r12w
xor %r9, %r9
lea addresses_normal_ht+0x1c908, %rdx
nop
nop
nop
nop
...
nop
cmp $15364, %r12
lea addresses_D_ht+0x3788, %r9
nop
and %rdi, %rdi
mov (%r9), %r14w
nop
xor %r9, %r9
lea addresses_WT_ht+0x1bff8, %r11
nop
and %rdi, %rdi
vmovups (%r11), %ymm4
...
nop
sub $1040, %r12
lea addresses_WC_ht+0x8f88, %rsi
lea addresses_A_ht+0x1bb78, %rdi
clflush (%rdi)
nop
nop
nop
...
nop
dec %r14
lea addresses_normal_ht+0x4d88, %rsi
lea addresses_A_ht+0xad88, %rdi
nop
nop
nop
nop
...
nop
sub $18127, %r9
lea addresses_UC_ht+0xdd88, %r14
nop
and %rdx, %rdx
movw $0x6162, (%r14)
nop
nop
cmp %r14, %r14
lea addresses_WT_ht+0x6788, %rdx
and $9670, %rsi
movl $0x61626364, (%rdx)
nop
nop
and %rdi, %rdi
lea addresses_WC_ht+0x19188, %r11
clflush (%r11)
nop
sub $26338, %rbx
...
// Faulty Load
lea addresses_normal+0x15388, %rsi
nop
and %rdx, %rdx
movups (%rsi), %xmm0
vpextrq $1, %xmm0, %rcx
...
{'OP': 'STOR', 'dst': {'type': 'addresses_WT', 'size': 4, 'AVXalign': True, 'NT': False, 'congruent': 5, 'same': False}}
...
{'OP': 'REPM', 'src': {'type': 'addresses_WC_ht', 'congruent': 10, 'same': True}, 'dst': {'type': 'addresses_A_ht', 'congruent': 4, 'same': True}}
...
{'OP': 'STOR', 'dst': {'type': 'addresses_WC_ht', 'size': 16, 'AVXalign': False, 'NT': True, 'congruent': 9, 'same': False}}
{'34': 21829}
