...
push %rdi
push %rsi
lea addresses_WC_ht+0xbb9, %rsi
lea addresses_UC_ht+0xea89, %rdi
nop
sub $62211, %r10
mov $12, %rcx
rep movsl
...
nop
sub %rbx, %rbx
lea addresses_D_ht+0x1deb9, %rsi
lea addresses_WC_ht+0xc1b9, %rdi
nop
nop
nop
nop
...
nop
xor $35735, %rdi
lea addresses_normal_ht+0x4db9, %rsi
...
nop
and $8977, %r10
lea addresses_normal_ht+0x10969, %rsi
lea addresses_D_ht+0xb61, %rdi
nop
nop
nop
xor $45065, %rax
...
{'OP': 'LOAD', 'src': {'same': False, 'NT': False, 'AVXalign': True, 'size': 1, 'type': 'addresses_UC', 'congruent': 3}}
...
{'dst': {'same': False, 'congruent': 1, 'type': 'addresses_D_ht'}, 'OP': 'REPM', 'src': {'same': False, 'congruent': 2, 'type': 'addresses_normal_ht'}}
{'38': 21829}
