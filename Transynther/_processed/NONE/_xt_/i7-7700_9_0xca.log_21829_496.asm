...
push %rdx
push %rsi
lea addresses_A_ht+0x1c4b3, %rcx
nop
nop
nop
nop
...
movq %rdx, (%rcx)
and $33933, %rdx
lea addresses_normal_ht+0xf68b, %rcx
nop
and %r10, %r10
movl $0x61626364, (%rcx)
inc %rsi
lea addresses_WT_ht+0xf763, %rsi
lea addresses_WT_ht+0x61db, %rdi
nop
nop
nop
nop
...
nop
xor $56021, %rbx
lea addresses_A_ht+0xd0ad, %rsi
lea addresses_WT_ht+0xcf93, %rdi
sub $53663, %rbp
mov $74, %rcx
rep movsb
nop
...
{'src': {'congruent': 4, 'same': False, 'type': 'addresses_WT_ht'}, 'OP': 'REPM', 'dst': {'congruent': 3, 'same': True, 'type': 'addresses_WT_ht'}}
