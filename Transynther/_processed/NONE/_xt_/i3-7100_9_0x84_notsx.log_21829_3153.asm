...
push %rdi
push %rsi
lea addresses_A_ht+0x287, %r12
and %r13, %r13
mov $0x6162636465666768, %r10
movq %r10, %xmm6
movups %xmm6, (%r12)
sub %rbx, %rbx
lea addresses_A_ht+0xa330, %rax
nop
nop
xor %r8, %r8
...
nop
and %r12, %r12
lea addresses_normal_ht+0x9687, %r13
nop
nop
nop
nop
...
nop
and %rax, %rax
lea addresses_WC_ht+0x1a627, %r13
nop
nop
nop
cmp %rax, %rax
...
nop
add %r13, %r13
lea addresses_normal_ht+0x18687, %rsi
lea addresses_normal_ht+0xe087, %rdi
nop
nop
nop
nop
...
nop
xor $57818, %r12
lea addresses_normal_ht+0xfce7, %rdi
nop
nop
sub %rcx, %rcx
movl $0x61626364, (%rdi)
...
nop
add $50965, %r12
lea addresses_UC_ht+0x11e87, %rsi
lea addresses_WC_ht+0x1e5c7, %rdi
xor %r12, %r12
mov $94, %rcx
rep movsq
and %r13, %r13
lea addresses_A_ht+0x50c7, %r13
nop
nop
nop
nop
...
nop
sub $17512, %rbx
lea addresses_normal_ht+0x18287, %rsi
lea addresses_WC_ht+0x1d087, %rdi
nop
nop
nop
and %rax, %rax
...
nop
xor $25052, %rbx
lea addresses_normal_ht+0x1bc87, %rsi
lea addresses_normal_ht+0x17267, %rdi
nop
nop
dec %r12
mov $36, %rcx
...
nop
cmp %rdi, %rdi
lea addresses_normal_ht+0x17c7, %r12
clflush (%r12)
nop
nop
xor $50303, %rbx
...
nop
add %rdi, %rdi
lea addresses_A_ht+0x7877, %rsi
lea addresses_WT_ht+0x9d90, %rdi
nop
nop
nop
inc %rbx
...
nop
and $60163, %rax
lea addresses_UC_ht+0xbd47, %r10
nop
xor $1157, %rcx
movups (%r10), %xmm5
vpextrq $1, %xmm5, %rdi
...
nop
xor $43762, %rcx
lea addresses_D_ht+0x15d17, %rsi
lea addresses_UC_ht+0x9b7, %rdi
nop
sub %r12, %r12
mov $90, %rcx
rep movsq
...
{'src': {'type': 'addresses_normal_ht', 'congruent': 10, 'same': False}, 'dst': {'type': 'addresses_normal_ht', 'congruent': 9, 'same': False}, 'OP': 'REPM'}
{'dst': {'type': 'addresses_normal_ht', 'same': False, 'size': 4, 'congruent': 5, 'NT': False, 'AVXalign': False}, 'OP': 'STOR'}
{'src': {'type': 'addresses_UC_ht', 'congruent': 10, 'same': False}, 'dst': {'type': 'addresses_WC_ht', 'congruent': 5, 'same': False}, 'OP': 'REPM'}
...
{'src': {'type': 'addresses_D_ht', 'congruent': 4, 'same': False}, 'dst': {'type': 'addresses_UC_ht', 'congruent': 3, 'same': False}, 'OP': 'REPM'}
{'39': 21829}
