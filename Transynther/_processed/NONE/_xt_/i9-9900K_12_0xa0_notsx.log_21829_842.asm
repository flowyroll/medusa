...
nop
sub $12618, %r9
lea addresses_WC_ht+0x1c680, %rsi
...
nop
cmp %r9, %r9
lea addresses_WC_ht+0x14780, %rcx
nop
sub $2222, %r8
mov (%rcx), %rsi
sub $7163, %r14
lea addresses_A_ht+0x1cc80, %rsi
nop
nop
nop
add %rdi, %rdi
...
vpextrq $0, %xmm2, %rcx
sub %r10, %r10
lea addresses_WT_ht+0x1b700, %rbp
nop
nop
nop
nop
...
nop
inc %r8
lea addresses_A_ht+0x19090, %rsi
nop
nop
nop
nop
...
movq %r9, (%rsi)
add %r9, %r9
lea addresses_UC_ht+0xf080, %rsi
lea addresses_WC_ht+0x1ea40, %rdi
nop
nop
xor %r10, %r10
mov $112, %rcx
...
nop
xor $48552, %rdi
lea addresses_A_ht+0x13206, %rcx
clflush (%rcx)
nop
nop
nop
...
nop
and %rbp, %rbp
lea addresses_WC_ht+0x6740, %rcx
nop
cmp %rdi, %rdi
movl $0x61626364, (%rcx)
nop
...
nop
cmp %rsi, %rsi
lea addresses_WT_ht+0x163c0, %rbp
nop
nop
sub $5475, %r9
movb $0x61, (%rbp)
...
nop
and %r14, %r14
lea addresses_normal_ht+0x11280, %rsi
lea addresses_UC_ht+0x18c08, %rdi
nop
nop
xor $33405, %r14
mov $110, %rcx
...
nop
and %rdi, %rdi
lea addresses_UC_ht+0x12ca4, %rsi
lea addresses_A_ht+0x8680, %rdi
nop
nop
nop
nop
...
{'src': {'type': 'addresses_UC_ht', 'congruent': 1, 'same': False}, 'OP': 'REPM', 'dst': {'type': 'addresses_A_ht', 'congruent': 11, 'same': False}}
{'38': 21829}
