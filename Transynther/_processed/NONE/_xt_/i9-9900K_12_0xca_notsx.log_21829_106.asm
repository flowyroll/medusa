...
nop
and %rcx, %rcx
lea addresses_normal_ht+0x9591, %r15
nop
nop
add %rax, %rax
movups (%r15), %xmm5
...
nop
add %rbp, %rbp
lea addresses_UC_ht+0x1005, %rax
clflush (%rax)
nop
nop
inc %rcx
...
nop
and %rax, %rax
lea addresses_UC_ht+0x6b91, %rax
nop
nop
nop
cmp %rcx, %rcx
