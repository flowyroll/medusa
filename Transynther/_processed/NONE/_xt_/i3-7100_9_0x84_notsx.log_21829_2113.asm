...
rep movsl
xor $34, %rdx
lea addresses_normal_ht+0x12b60, %rdx
nop
nop
nop
nop
...
nop
inc %rcx
lea addresses_WC_ht+0xeb90, %rdi
clflush (%rdi)
and %r12, %r12
mov (%rdi), %esi
nop
...
nop
sub $23122, %r12
lea addresses_UC_ht+0x62c0, %rcx
nop
nop
nop
xor $35431, %r12
...
nop
inc %rsi
lea addresses_A_ht+0x124d0, %rsi
nop
and $40409, %rdi
vmovups (%rsi), %ymm3
