...
push %rdi
push %rsi
lea addresses_normal_ht+0x1139b, %rax
nop
nop
nop
nop
...
movb (%rsi), %al
and %rsi, %rsi
lea addresses_WT_ht+0x1681b, %rdi
nop
nop
xor %rbx, %rbx
movb $0x61, (%rdi)
...
nop
xor %r15, %r15
lea addresses_WC_ht+0x921b, %rbx
nop
nop
nop
nop
...
mov (%rbx), %r9
dec %rbp
lea addresses_UC_ht+0x1a376, %rdi
nop
nop
sub %r15, %r15
mov (%rdi), %rbx
...
nop
and %rax, %rax
lea addresses_UC_ht+0x501b, %rbx
nop
add %rbp, %rbp
mov $0x6162636465666768, %rdi
movq %rdi, %xmm2
