...
rep movsb
xor %rcx, %rcx
lea addresses_WT_ht+0x8f7b, %rbx
nop
nop
nop
nop
...
nop
xor $35027, %rsi
lea addresses_A_ht+0x18193, %rdi
nop
nop
add $26693, %rax
mov (%rdi), %r8d
cmp %r10, %r10
lea addresses_WC_ht+0xc993, %rax
nop
nop
nop
nop
...
nop
add %rax, %rax
lea addresses_normal_ht+0x17d53, %rcx
nop
nop
nop
cmp $23410, %r10
...
nop
xor $11555, %r10
lea addresses_WT_ht+0x1a593, %rax
nop
nop
nop
cmp %r10, %r10
...
nop
cmp $57857, %rcx
lea addresses_normal_ht+0x2213, %r10
clflush (%r10)
nop
nop
nop
...
// Store
lea addresses_normal+0x10553, %r12
nop
nop
nop
nop
