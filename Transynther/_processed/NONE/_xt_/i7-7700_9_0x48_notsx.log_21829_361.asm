...
push %rax
push %rbx
lea addresses_D_ht+0x16535, %r11
nop
nop
nop
nop
...
nop
cmp $39934, %rax
lea addresses_UC_ht+0x16d39, %r9
nop
nop
nop
nop
...
nop
xor %rax, %rax
lea addresses_A_ht+0x1d689, %r11
xor %r8, %r8
...
nop
sub $837, %r11
lea addresses_WC_ht+0x1c689, %r13
clflush (%r13)
nop
dec %r8
mov (%r13), %ax
and $48826, %rax
lea addresses_WT_ht+0x18b1, %r12
nop
nop
nop
nop
