...
// REPMOV
lea addresses_RW+0x6a44, %rsi
lea addresses_A+0x7a2c, %rdi
nop
and %r9, %r9
mov $8, %rcx
rep movsb
...
// REPMOV
lea addresses_WT+0x10164, %rsi
lea addresses_A+0x3c39, %rdi
clflush (%rsi)
nop
nop
nop
...
{'OP': 'REPM', 'src': {'same': False, 'congruent': 2, 'type': 'addresses_RW'}, 'dst': {'same': False, 'congruent': 3, 'type': 'addresses_A'}}
{'OP': 'REPM', 'src': {'same': False, 'congruent': 9, 'type': 'addresses_WT'}, 'dst': {'same': False, 'congruent': 0, 'type': 'addresses_A'}}
