...
push %rdx
push %rsi
lea addresses_WT_ht+0x6e47, %rbp
nop
inc %r12
movl $0x61626364, (%rbp)
nop
...
nop
sub $15903, %rbp
lea addresses_WC_ht+0x13fdf, %rsi
lea addresses_WC_ht+0x869b, %rdi
nop
nop
xor %r14, %r14
mov $114, %rcx
...
nop
inc %rsi
lea addresses_WT_ht+0x68db, %r14
nop
nop
nop
lfence
...
nop
cmp $46990, %r12
lea addresses_UC_ht+0x57a9, %rdx
nop
add %rbp, %rbp
mov (%rdx), %r14
nop
add %rdi, %rdi
lea addresses_UC_ht+0x1a6db, %rbp
nop
sub %rsi, %rsi
movb (%rbp), %r12b
sub %rbp, %rbp
lea addresses_WT_ht+0xa0db, %rdi
nop
nop
dec %rbp
mov (%rdi), %edx
...
nop
add %rbp, %rbp
lea addresses_UC_ht+0xfa3b, %rbp
nop
nop
nop
nop
...
nop
cmp $56108, %rdi
lea addresses_WC_ht+0xeae1, %rbp
nop
nop
nop
nop
...
{'src': {'same': False, 'congruent': 1, 'NT': False, 'type': 'addresses_UC_ht', 'size': 8, 'AVXalign': True}, 'OP': 'LOAD'}
