...
lea addresses_WC_ht+0x7d15, %rdi
and $40831, %rbx
mov $0, %rcx
rep movsw
nop
...
nop
xor $32970, %r8
lea addresses_WC_ht+0x1b539, %r13
nop
nop
nop
nop
...
// Faulty Load
lea addresses_normal+0x2515, %r9
nop
and %rcx, %rcx
vmovups (%r9), %ymm3
...
{'OP': 'REPM', 'src': {'same': False, 'congruent': 8, 'type': 'addresses_WT_ht'}, 'dst': {'same': False, 'congruent': 10, 'type': 'addresses_WC_ht'}}
{'OP': 'LOAD', 'src': {'same': False, 'type': 'addresses_D_ht', 'NT': True, 'AVXalign': False, 'size': 32, 'congruent': 8}}
