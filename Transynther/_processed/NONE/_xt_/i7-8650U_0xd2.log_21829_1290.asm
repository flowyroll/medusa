...
push %rdi
push %rsi
lea addresses_UC_ht+0x13323, %rsi
lea addresses_UC_ht+0x397f, %rdi
clflush (%rsi)
nop
nop
nop
...
nop
dec %r13
lea addresses_WC_ht+0x12c23, %rax
nop
nop
nop
nop
...
nop
add %rax, %rax
lea addresses_WT_ht+0x16823, %rsi
nop
nop
nop
nop
...
nop
add $59000, %r13
lea addresses_D_ht+0x12e73, %rsi
lea addresses_WT_ht+0x12123, %rdi
clflush (%rdi)
nop
inc %r8
mov $25, %rcx
...
nop
cmp %r8, %r8
lea addresses_UC_ht+0x19723, %rsi
lea addresses_normal_ht+0x1c5c3, %rdi
nop
nop
and $55386, %rbx
mov $18, %rcx
...
nop
add $10406, %r13
lea addresses_UC_ht+0xf7a3, %rsi
clflush (%rsi)
nop
nop
nop
