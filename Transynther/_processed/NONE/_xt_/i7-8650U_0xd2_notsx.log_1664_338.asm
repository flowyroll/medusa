...
push %rdi
push %rsi
lea addresses_UC_ht+0x143f3, %r13
nop
sub $63276, %r14
mov (%r13), %si
nop
...
nop
cmp %r10, %r10
lea addresses_WT_ht+0x44e3, %r9
nop
cmp %r12, %r12
movups (%r9), %xmm6
vpextrq $0, %xmm6, %r14
dec %r10
lea addresses_D_ht+0x40b3, %r12
add %rsi, %rsi
movl $0x61626364, (%r12)
nop
add %r13, %r13
lea addresses_WT_ht+0x8ebf, %rsi
nop
nop
nop
xor %r12, %r12
...
nop
dec %r13
lea addresses_A_ht+0x13a9b, %rsi
nop
inc %r14
movw $0x6162, (%rsi)
nop
...
nop
cmp %r12, %r12
lea addresses_normal_ht+0x19d73, %rsi
nop
nop
nop
nop
...
nop
xor %rsi, %rsi
lea addresses_D_ht+0x4105, %r13
clflush (%r13)
add $45216, %r8
movw $0x6162, (%r13)
sub %r8, %r8
lea addresses_normal_ht+0x15573, %r9
nop
dec %r14
vmovups (%r9), %ymm6
...
nop
dec %r12
lea addresses_D_ht+0x71f3, %rsi
lea addresses_normal_ht+0x9cab, %rdi
nop
nop
nop
add $44741, %r13
...
rep movsq
xor %r14, %r14
lea addresses_normal_ht+0x11773, %r14
nop
add %r8, %r8
vmovups (%r14), %ymm3
vextracti128 $0, %ymm3, %xmm3
...
nop
inc %r13
lea addresses_D_ht+0x1a373, %rsi
...
{'OP': 'REPM', 'src': {'type': 'addresses_D_ht', 'congruent': 8, 'same': False}, 'dst': {'type': 'addresses_normal_ht', 'congruent': 11, 'same': False}}
