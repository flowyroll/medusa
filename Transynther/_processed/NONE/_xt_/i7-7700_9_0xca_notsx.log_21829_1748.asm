...
push %rdi
push %rsi
lea addresses_A_ht+0x165dd, %rsi
lea addresses_A_ht+0x151dd, %rdi
nop
nop
nop
nop
...
nop
and %r15, %r15
lea addresses_D_ht+0x2ddd, %rsi
lea addresses_WT_ht+0x1b101, %rdi
clflush (%rdi)
nop
nop
nop
...
nop
sub %rcx, %rcx
lea addresses_UC_ht+0x74d6, %rcx
nop
nop
nop
nop
...
nop
add %r11, %r11
lea addresses_UC_ht+0xe71d, %rsi
nop
nop
nop
nop
...
nop
inc %rbp
lea addresses_A_ht+0x1d0a5, %rbx
nop
nop
nop
nop
