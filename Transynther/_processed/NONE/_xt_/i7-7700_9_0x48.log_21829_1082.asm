...
nop
dec %rcx
lea addresses_UC_ht+0x1cd01, %rax
nop
nop
nop
xor $57532, %r14
...
nop
sub %r9, %r9
lea addresses_normal_ht+0x127ea, %r14
and $46755, %r11
mov (%r14), %ax
nop
nop
nop
dec %rcx
lea addresses_WT_ht+0x12dda, %rcx
nop
nop
nop
add %rax, %rax
...
nop
sub %r14, %r14
lea addresses_D_ht+0x15cea, %r11
nop
nop
xor $45362, %r8
mov (%r11), %r12
dec %r14
lea addresses_UC_ht+0x184ea, %rcx
and $17140, %rax
mov $0x6162636465666768, %r8
movq %r8, %xmm7
...
{'OP': 'STOR', 'dst': {'type': 'addresses_UC_ht', 'AVXalign': True, 'congruent': 11, 'size': 32, 'same': True, 'NT': False}}
{'33': 21829}
