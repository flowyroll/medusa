...
movups %xmm0, (%r15)
sub %r15, %r15
lea addresses_A_ht+0x18f85, %rsi
lea addresses_normal_ht+0x12f85, %rdi
clflush (%rsi)
nop
nop
nop
...
nop
and $33236, %rcx
lea addresses_D_ht+0x5785, %rsi
lea addresses_normal_ht+0x1deb5, %rdi
nop
and %r8, %r8
mov $123, %rcx
rep movsw
nop
add %rdi, %rdi
lea addresses_UC_ht+0x10331, %r12
clflush (%r12)
add %rdi, %rdi
movups (%r12), %xmm6
vpextrq $1, %xmm6, %rsi
cmp %rcx, %rcx
lea addresses_D_ht+0x8385, %rsi
lea addresses_A_ht+0x45e9, %rdi
clflush (%rsi)
nop
nop
nop
...
nop
and $63592, %rdx
lea addresses_WC_ht+0x11115, %rdi
nop
nop
nop
sub $47950, %r12
...
nop
sub %rdx, %rdx
lea addresses_WT_ht+0xc285, %rsi
lea addresses_UC_ht+0x14ecc, %rdi
nop
nop
nop
cmp $9481, %r10
...
nop
and $50661, %r10
lea addresses_normal_ht+0x7b85, %rsi
lea addresses_UC_ht+0x13958, %rdi
nop
xor $52709, %r10
mov $1, %rcx
rep movsq
...
// REPMOV
lea addresses_UC+0x1efd7, %rsi
lea addresses_UC+0x7145, %rdi
nop
nop
nop
nop
...
// Store
lea addresses_normal+0x4a85, %rcx
add %rsi, %rsi
...
// Faulty Load
lea addresses_normal+0x2f85, %r10
nop
sub $3266, %rax
mov (%r10), %r14d
lea oracles, %rsi
...
{'src': {'type': 'addresses_UC', 'congruent': 0, 'same': False}, 'OP': 'REPM', 'dst': {'type': 'addresses_UC', 'congruent': 6, 'same': False}}
...
{'src': {'type': 'addresses_A_ht', 'congruent': 9, 'same': False}, 'OP': 'REPM', 'dst': {'type': 'addresses_normal_ht', 'congruent': 9, 'same': False}}
{'OP': 'STOR', 'dst': {'type': 'addresses_WT_ht', 'AVXalign': False, 'size': 16, 'NT': False, 'same': False, 'congruent': 2}}
{'src': {'type': 'addresses_D_ht', 'congruent': 9, 'same': False}, 'OP': 'REPM', 'dst': {'type': 'addresses_normal_ht', 'congruent': 1, 'same': False}}
