...
push %rdx
push %rsi
lea addresses_UC_ht+0x1ae0d, %rsi
...
nop
add $22075, %r14
lea addresses_WC_ht+0x127a4, %r9
nop
nop
nop
cmp $30902, %rdx
...
nop
add %rsi, %rsi
lea addresses_A_ht+0x1d66d, %rsi
lea addresses_WC_ht+0x1df3d, %rdi
xor $49200, %r12
mov $89, %rcx
rep movsw
nop
...
nop
inc %rsi
lea addresses_WT_ht+0xd8f9, %rsi
lea addresses_WC_ht+0xad6d, %rdi
nop
nop
nop
sub $5731, %rdx
...
nop
add $12182, %rax
lea addresses_UC_ht+0x12e37, %r12
nop
nop
nop
add $44373, %rsi
...
nop
dec %rdx
lea addresses_UC_ht+0x2d7d, %rsi
lea addresses_WC_ht+0xebc5, %rdi
nop
nop
dec %rdx
mov $32, %rcx
...
nop
xor $64163, %r9
lea addresses_normal_ht+0x10e4d, %rcx
nop
and $61876, %r9
movb (%rcx), %r12b
nop
sub $37719, %rsi
lea addresses_WT_ht+0xe94d, %rdi
nop
nop
sub %rsi, %rsi
...
nop
xor $51282, %rdi
lea addresses_WT_ht+0x1bc4d, %rsi
lea addresses_WC_ht+0x604d, %rdi
nop
nop
nop
nop
...
nop
and $31739, %r9
lea addresses_normal_ht+0x524d, %rsi
lea addresses_WC_ht+0x6635, %rdi
clflush (%rdi)
nop
nop
nop
...
{'src': {'same': False, 'congruent': 11, 'NT': False, 'type': 'addresses_WT', 'size': 32, 'AVXalign': False}, 'OP': 'LOAD'}
[Faulty Load]
...
{'src': {'type': 'addresses_A_ht', 'congruent': 1, 'same': False}, 'OP': 'REPM', 'dst': {'type': 'addresses_WC_ht', 'congruent': 3, 'same': False}}
...
{'src': {'type': 'addresses_WT_ht', 'congruent': 9, 'same': False}, 'OP': 'REPM', 'dst': {'type': 'addresses_WC_ht', 'congruent': 9, 'same': True}}
