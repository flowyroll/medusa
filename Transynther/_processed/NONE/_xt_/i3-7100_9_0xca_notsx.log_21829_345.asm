...
vpextrq $1, %xmm2, %r10
and $62279, %r9
lea addresses_normal_ht+0x102da, %rdx
and $53320, %r12
movw $0x6162, (%rdx)
nop
nop
...
nop
xor %rcx, %rcx
lea addresses_WT_ht+0x361e, %rdx
dec %rcx
mov (%rdx), %r12d
add $54998, %r12
lea addresses_WC_ht+0x1519a, %r11
clflush (%r11)
nop
and $60576, %rcx
mov (%r11), %r12
...
nop
add %rcx, %rcx
lea addresses_UC_ht+0x4022, %rsi
...
vpextrq $0, %xmm6, %rdi
xor %rsi, %rsi
lea addresses_WC_ht+0x1e59a, %rcx
clflush (%rcx)
nop
nop
nop
...
// Store
lea addresses_normal+0xc97a, %r10
dec %rsi
