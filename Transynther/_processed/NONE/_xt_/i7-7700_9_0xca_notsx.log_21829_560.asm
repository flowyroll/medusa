...
nop
and $10378, %rdi
lea addresses_A_ht+0x13574, %rdi
nop
nop
nop
nop
...
nop
sub %rdi, %rdi
lea addresses_UC_ht+0x18f74, %rsi
lea addresses_WT_ht+0x27c4, %rdi
and %r14, %r14
mov $81, %rcx
rep movsb
nop
...
nop
add $11502, %rcx
lea addresses_normal_ht+0x11634, %r14
nop
nop
and %r13, %r13
...
movups %xmm7, (%r14)
cmp $53831, %r14
lea addresses_UC_ht+0x183f4, %rsi
lea addresses_normal_ht+0x1da4, %rdi
nop
and %r14, %r14
mov $102, %rcx
rep movsq
dec %rdi
lea addresses_WC_ht+0x1b5f4, %rsi
lea addresses_D_ht+0xbf74, %rdi
nop
and %r8, %r8
mov $4, %rcx
rep movsw
...
nop
inc %rsi
lea addresses_normal_ht+0x1994, %r9
nop
nop
cmp %rsi, %rsi
mov (%r9), %r14
...
nop
xor %rcx, %rcx
lea addresses_WC_ht+0x1b4fc, %r8
nop
nop
nop
nop
...
nop
sub %r13, %r13
lea addresses_D_ht+0x10b74, %rdi
nop
nop
dec %r13
mov (%rdi), %ecx
...
nop
cmp %rsi, %rsi
lea addresses_WC_ht+0xb474, %r14
and %r9, %r9
mov $0x6162636465666768, %rbp
movq %rbp, %xmm7
movups %xmm7, (%r14)
nop
dec %rsi
lea addresses_normal_ht+0x3272, %rsi
lea addresses_A_ht+0x2f74, %rdi
nop
nop
nop
nop
...
{'src': {'congruent': 11, 'same': False, 'type': 'addresses_UC_ht'}, 'dst': {'congruent': 2, 'same': False, 'type': 'addresses_WT_ht'}, 'OP': 'REPM'}
{'dst': {'NT': False, 'AVXalign': True, 'size': 4, 'congruent': 6, 'same': True, 'type': 'addresses_normal_ht'}, 'OP': 'STOR'}
...
{'src': {'congruent': 7, 'same': False, 'type': 'addresses_WC_ht'}, 'dst': {'congruent': 11, 'same': False, 'type': 'addresses_D_ht'}, 'OP': 'REPM'}
...
{'src': {'congruent': 1, 'same': False, 'type': 'addresses_normal_ht'}, 'dst': {'congruent': 11, 'same': False, 'type': 'addresses_A_ht'}, 'OP': 'REPM'}
{'37': 21829}
