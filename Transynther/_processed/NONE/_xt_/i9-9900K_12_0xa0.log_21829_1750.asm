...
push %rdx
push %rsi
lea addresses_normal_ht+0x2e0c, %rsi
lea addresses_UC_ht+0x65cc, %rdi
nop
nop
nop
nop
...
nop
xor %r15, %r15
lea addresses_normal_ht+0x10f0c, %rcx
xor %r8, %r8
mov (%rcx), %di
nop
nop
...
nop
cmp $25084, %rsi
lea addresses_normal_ht+0xfd1c, %rsi
lea addresses_WT_ht+0x990c, %rdi
nop
nop
nop
nop
...
nop
sub %rsi, %rsi
lea addresses_normal_ht+0x1410c, %r9
nop
nop
nop
nop
...
movl $0x61626364, (%r9)
add %r10, %r10
lea addresses_WT_ht+0xd80c, %rsi
lea addresses_WT_ht+0xa60c, %rdi
clflush (%rdi)
sub %rdx, %rdx
mov $37, %rcx
rep movsq
...
nop
sub %r10, %r10
lea addresses_normal_ht+0x688c, %rsi
lea addresses_WC_ht+0x1b376, %rdi
clflush (%rsi)
nop
nop
nop
...
nop
xor %r15, %r15
lea addresses_normal_ht+0x1880c, %rsi
lea addresses_UC_ht+0x16e94, %rdi
nop
nop
nop
nop
...
rep movsb
add %rsi, %rsi
lea addresses_A_ht+0x18e90, %rsi
lea addresses_normal_ht+0x1488c, %rdi
clflush (%rdi)
nop
nop
nop
...
{'OP': 'STOR', 'dst': {'NT': False, 'same': True, 'congruent': 7, 'type': 'addresses_normal_ht', 'AVXalign': False, 'size': 4}}
...
{'src': {'same': False, 'congruent': 1, 'type': 'addresses_A_ht'}, 'OP': 'REPM', 'dst': {'same': False, 'congruent': 6, 'type': 'addresses_normal_ht'}}
{'33': 21829}
