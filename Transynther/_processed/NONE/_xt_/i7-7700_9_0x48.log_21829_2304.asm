...
push %rdi
push %rsi
lea addresses_WT_ht+0x1d985, %rdi
nop
nop
inc %r12
mov (%rdi), %r10
...
nop
sub $51440, %r12
lea addresses_WT_ht+0x7fe5, %rsi
lea addresses_A_ht+0x1395e, %rdi
add %r12, %r12
mov $32, %rcx
rep movsl
nop
...
nop
sub %rsi, %rsi
lea addresses_WT_ht+0x1e425, %r9
clflush (%r9)
nop
nop
nop
...
nop
add $53215, %r9
lea addresses_WT_ht+0x1b7e5, %rsi
...
// Faulty Load
lea addresses_normal+0x142e5, %r13
nop
nop
cmp %r10, %r10
mov (%r13), %si
...
{'OP': 'STOR', 'dst': {'type': 'addresses_WT_ht', 'AVXalign': False, 'congruent': 6, 'size': 2, 'same': False, 'NT': True}}
