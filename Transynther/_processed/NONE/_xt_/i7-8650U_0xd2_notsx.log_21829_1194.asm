...
push %rdx
push %rsi
lea addresses_D_ht+0x1b992, %r10
nop
cmp $14096, %rcx
movups (%r10), %xmm4
vpextrq $0, %xmm4, %rdx
...
nop
and $37716, %r15
lea addresses_UC_ht+0xd56a, %rcx
nop
nop
nop
sub %r8, %r8
...
nop
cmp $30262, %rdx
lea addresses_normal_ht+0x5f28, %rsi
lea addresses_WT_ht+0x1040c, %rdi
nop
nop
nop
nop
...
nop
add $5625, %r10
lea addresses_WC_ht+0x1221a, %rsi
lea addresses_normal_ht+0x116a, %rdi
nop
nop
nop
add %r13, %r13
...
rep movsb
cmp $12942, %r10
lea addresses_normal_ht+0xc16a, %rcx
nop
add $47685, %rdi
movl $0x61626364, (%rcx)
nop
...
nop
inc %rsi
lea addresses_WC_ht+0x1d16a, %rsi
lea addresses_WC_ht+0x1c16a, %rdi
nop
nop
nop
nop
...
nop
inc %r8
lea addresses_A_ht+0x1816a, %r10
nop
nop
nop
cmp $53781, %r13
movb (%r10), %r8b
cmp %rcx, %rcx
lea addresses_WT_ht+0x1a16a, %r10
nop
cmp $13745, %rsi
movl $0x61626364, (%r10)
nop
xor $9293, %rdx
lea addresses_WC_ht+0xcb6a, %rsi
lea addresses_D_ht+0x11b3a, %rdi
nop
nop
xor $42785, %rdx
mov $101, %rcx
...
{'OP': 'LOAD', 'src': {'type': 'addresses_UC_ht', 'size': 2, 'AVXalign': True, 'NT': False, 'congruent': 9, 'same': False}}
