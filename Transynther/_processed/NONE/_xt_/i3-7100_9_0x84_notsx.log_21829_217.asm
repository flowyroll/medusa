...
push %rdx
push %rsi
lea addresses_WT_ht+0xe604, %rdi
nop
nop
nop
add %r8, %r8
...
nop
xor %r12, %r12
lea addresses_D_ht+0xcb04, %r14
xor %rdx, %rdx
movw $0x6162, (%r14)
nop
xor %r8, %r8
lea addresses_D_ht+0x17669, %rsi
lea addresses_WT_ht+0xc394, %rdi
nop
cmp $15031, %r12
mov $33, %rcx
rep movsb
...
nop
sub $3266, %rcx
lea addresses_normal_ht+0x1b904, %r12
and %r8, %r8
mov (%r12), %rsi
nop
xor %r12, %r12
lea addresses_normal_ht+0x87d, %r8
and %rcx, %rcx
movl $0x61626364, (%r8)
nop
nop
...
nop
dec %r14
lea addresses_UC_ht+0x18884, %rdx
cmp $18952, %r12
movb $0x61, (%rdx)
sub $65476, %rdx
lea addresses_WC_ht+0xd82c, %r14
add %r8, %r8
...
nop
and $32627, %r12
lea addresses_UC_ht+0x4504, %rsi
lea addresses_A_ht+0x1e104, %rdi
add %r14, %r14
mov $118, %rcx
rep movsw
nop
...
nop
xor %rdi, %rdi
lea addresses_A_ht+0x1e504, %rdi
nop
nop
dec %r8
...
movq %rbx, (%rdi)
xor %rcx, %rcx
lea addresses_D_ht+0x14b04, %rsi
clflush (%rsi)
nop
nop
nop
...
movl $0x61626364, (%rsi)
and $64661, %rsi
lea addresses_normal_ht+0xe944, %rdi
nop
lfence
movb $0x61, (%rdi)
nop
...
nop
xor $59516, %rdx
lea addresses_WC_ht+0x14d44, %r8
nop
xor %rbx, %rbx
...
nop
cmp %r12, %r12
lea addresses_WC_ht+0x1c844, %rsi
lea addresses_A_ht+0xe18e, %rdi
add %r14, %r14
mov $20, %rcx
rep movsw
nop
...
nop
add %r14, %r14
lea addresses_A_ht+0x17004, %rdi
nop
nop
nop
nop
...
// Faulty Load
lea addresses_normal+0x1cf04, %rdi
nop
nop
nop
nop
...
{'dst': {'type': 'addresses_WC_ht', 'same': True, 'size': 16, 'congruent': 6, 'NT': False, 'AVXalign': False}, 'OP': 'STOR'}
{'src': {'type': 'addresses_WC_ht', 'congruent': 5, 'same': False}, 'dst': {'type': 'addresses_A_ht', 'congruent': 1, 'same': False}, 'OP': 'REPM'}
