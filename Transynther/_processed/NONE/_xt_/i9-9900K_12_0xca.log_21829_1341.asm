...
push %rdx
push %rsi
lea addresses_UC_ht+0x1d11e, %r15
nop
lfence
...
nop
sub $31627, %rbx
lea addresses_WT_ht+0xfed2, %rsi
lea addresses_D_ht+0x1e9b6, %rdi
nop
nop
nop
nop
...
nop
sub %rdx, %rdx
lea addresses_UC_ht+0x1b732, %rsi
nop
nop
nop
nop
...
nop
and $10608, %r10
lea addresses_normal_ht+0xec32, %r8
nop
nop
sub $648, %rax
movb (%r8), %cl
nop
inc %rcx
lea addresses_A_ht+0x198d2, %rax
nop
sub %r8, %r8
mov (%rax), %di
nop
...
nop
xor %rsi, %rsi
lea addresses_WC_ht+0x1adee, %rsi
clflush (%rsi)
dec %r10
movb $0x61, (%rsi)
sub %rax, %rax
lea addresses_D_ht+0xa282, %rsi
lea addresses_A_ht+0x1c242, %rdi
nop
inc %r15
mov $55, %rcx
rep movsl
and %rdi, %rdi
lea addresses_WC_ht+0x180d2, %rdx
nop
nop
nop
nop
...
nop
add %r10, %r10
lea addresses_UC_ht+0x4812, %r15
nop
nop
nop
nop
...
nop
add %rdx, %rdx
lea addresses_UC_ht+0xb3de, %rdx
xor %rdi, %rdi
mov (%rdx), %rbx
nop
nop
nop
xor %rdx, %rdx
lea addresses_WC_ht+0x1132, %rsi
lea addresses_WC_ht+0x11212, %rdi
nop
nop
and %r15, %r15
mov $65, %rcx
...
{'OP': 'REPM', 'src': {'same': False, 'type': 'addresses_D_ht', 'congruent': 4}, 'dst': {'same': True, 'type': 'addresses_A_ht', 'congruent': 4}}
...
{'OP': 'REPM', 'src': {'same': False, 'type': 'addresses_WC_ht', 'congruent': 5}, 'dst': {'same': False, 'type': 'addresses_WC_ht', 'congruent': 4}}
{'32': 21829}
