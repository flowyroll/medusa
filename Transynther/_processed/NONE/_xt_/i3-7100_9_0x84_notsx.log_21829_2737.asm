...
push %rdx
push %rsi
lea addresses_WC_ht+0x1164e, %rsi
lea addresses_WT_ht+0x183c5, %rdi
clflush (%rsi)
nop
nop
nop
...
nop
sub %rcx, %rcx
lea addresses_WC_ht+0xd5e1, %rbx
nop
nop
add %rax, %rax
...
nop
add $1848, %rsi
lea addresses_normal_ht+0x17305, %rsi
lea addresses_WC_ht+0x13828, %rdi
clflush (%rdi)
nop
add $7976, %rdx
mov $80, %rcx
...
nop
mfence
lea addresses_D_ht+0x17b05, %rbx
nop
xor $49891, %rdx
movb $0x61, (%rbx)
nop
...
// Load
lea addresses_normal+0x5b05, %rdi
sub %r9, %r9
vmovaps (%rdi), %ymm2
...
{'src': {'type': 'addresses_WT', 'same': False, 'size': 2, 'congruent': 4, 'NT': True, 'AVXalign': False}, 'OP': 'LOAD'}
{'dst': {'type': 'addresses_P', 'same': False, 'size': 4, 'congruent': 7, 'NT': False, 'AVXalign': False}, 'OP': 'STOR'}
{'src': {'type': 'addresses_normal', 'same': False, 'size': 32, 'congruent': 10, 'NT': False, 'AVXalign': True}, 'OP': 'LOAD'}
[Faulty Load]
