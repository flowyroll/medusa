...
push %rdx
push %rsi
lea addresses_D_ht+0x1e988, %rsi
lea addresses_A_ht+0x12354, %rdi
nop
nop
nop
nop
...
rep movsl
and $24716, %rdx
lea addresses_UC_ht+0x1ba0a, %r11
nop
nop
cmp $3231, %rdi
movb $0x61, (%r11)
nop
and %rcx, %rcx
lea addresses_WT_ht+0x17708, %r11
nop
nop
sub %rbx, %rbx
mov (%r11), %rsi
...
nop
and $38670, %rsi
lea addresses_WC_ht+0x11308, %rdi
nop
nop
nop
dec %r8
...
nop
and %r8, %r8
lea addresses_A_ht+0xb688, %rsi
lea addresses_D_ht+0xa188, %rdi
and $14126, %rax
mov $96, %rcx
rep movsq
nop
xor %rcx, %rcx
lea addresses_WC_ht+0xf202, %r11
nop
nop
nop
nop
