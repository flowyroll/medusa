...
push %rdx
push %rsi
lea addresses_normal_ht+0x92d2, %rsi
lea addresses_WT_ht+0xe9fa, %rdi
cmp %r15, %r15
mov $90, %rcx
rep movsl
and $17855, %rdx
lea addresses_WT_ht+0x89d2, %r10
nop
nop
nop
sub $49890, %r14
...
nop
cmp $32629, %r14
lea addresses_WT_ht+0x7132, %rdx
nop
nop
nop
add %r10, %r10
...
nop
cmp %r14, %r14
lea addresses_WT_ht+0x79d2, %rsi
cmp %rcx, %rcx
movl $0x61626364, (%rsi)
nop
nop
