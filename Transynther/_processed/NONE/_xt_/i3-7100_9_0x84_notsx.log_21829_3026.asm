...
push %rdi
push %rsi
lea addresses_WC_ht+0x1a153, %r15
nop
nop
nop
nop
...
nop
sub %r10, %r10
lea addresses_WT_ht+0xd803, %rsi
lea addresses_WC_ht+0xbc33, %rdi
nop
nop
nop
nop
...
nop
xor $2459, %r15
lea addresses_WT_ht+0x13003, %r15
clflush (%r15)
nop
nop
and $63358, %r11
...
nop
xor %rsi, %rsi
lea addresses_D_ht+0x1643, %rsi
lea addresses_A_ht+0x16803, %rdi
nop
nop
nop
add $9630, %r15
...
nop
and %r15, %r15
lea addresses_WT_ht+0x13483, %r15
nop
nop
nop
inc %rsi
...
nop
cmp $49960, %r10
lea addresses_D_ht+0x1763, %rsi
nop
and $54540, %r10
movb $0x61, (%rsi)
and %rax, %rax
lea addresses_WC_ht+0x11a84, %rcx
dec %r10
mov (%rcx), %di
nop
nop
nop
cmp %rdi, %rdi
lea addresses_WT_ht+0xd543, %r15
nop
nop
cmp %rcx, %rcx
...
movups %xmm4, (%r15)
xor $14317, %r11
lea addresses_WT_ht+0x19f83, %rdi
nop
nop
and $33514, %r11
...
<gen_faulty_load>
[REF]
{'src': {'type': 'addresses_UC', 'same': False, 'size': 32, 'congruent': 0, 'NT': False, 'AVXalign': True}, 'OP': 'LOAD'}
...
{'dst': {'type': 'addresses_D_ht', 'same': True, 'size': 1, 'congruent': 5, 'NT': False, 'AVXalign': True}, 'OP': 'STOR'}
