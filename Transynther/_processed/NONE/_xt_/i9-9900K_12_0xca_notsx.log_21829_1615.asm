...
push %rdi
push %rsi
lea addresses_D_ht+0x1a327, %rdi
nop
nop
nop
nop
...
nop
cmp $63270, %rax
lea addresses_UC_ht+0x1c627, %r11
nop
nop
nop
nop
...
nop
cmp %r15, %r15
lea addresses_A_ht+0x10c27, %rsi
lea addresses_normal_ht+0x9343, %rdi
nop
and $2356, %r13
mov $27, %rcx
rep movsb
...
nop
xor $51432, %rcx
lea addresses_A_ht+0x12f17, %r11
and %rbx, %rbx
mov (%r11), %rsi
nop
nop
...
nop
cmp $61582, %rax
lea addresses_WT_ht+0x1d327, %rsi
...
rep movsb
xor %r13, %r13
lea addresses_WC_ht+0x1c27, %rsi
lea addresses_WC_ht+0x141cd, %rdi
add $28288, %r15
mov $7, %rcx
rep movsl
nop
...
nop
inc %r15
lea addresses_A_ht+0x1a227, %rsi
nop
nop
nop
nop
...
nop
xor $49639, %rdi
lea addresses_UC_ht+0xf627, %rsi
lea addresses_normal_ht+0xb8e7, %rdi
nop
nop
nop
cmp %rbx, %rbx
...
rep movsw
sub $47336, %rcx
lea addresses_WC_ht+0x11d67, %rsi
nop
nop
nop
xor %rbx, %rbx
...
nop
sub $18090, %r15
lea addresses_WT_ht+0xba27, %rbx
nop
nop
nop
add $24902, %rsi
movb $0x61, (%rbx)
and $37242, %r11
lea addresses_A_ht+0x14627, %r15
nop
nop
nop
nop
...
// Faulty Load
lea addresses_normal+0x15627, %rdi
cmp %r10, %r10
vmovups (%rdi), %ymm3
...
{'OP': 'LOAD', 'src': {'same': False, 'type': 'addresses_D', 'NT': False, 'AVXalign': False, 'size': 8, 'congruent': 11}}
...
{'OP': 'REPM', 'src': {'same': False, 'congruent': 5, 'type': 'addresses_A_ht'}, 'dst': {'same': True, 'congruent': 2, 'type': 'addresses_normal_ht'}}
{'OP': 'LOAD', 'src': {'same': False, 'type': 'addresses_A_ht', 'NT': False, 'AVXalign': False, 'size': 8, 'congruent': 4}}
{'OP': 'LOAD', 'src': {'same': False, 'type': 'addresses_WC_ht', 'NT': False, 'AVXalign': True, 'size': 4, 'congruent': 6}}
{'OP': 'REPM', 'src': {'same': False, 'congruent': 5, 'type': 'addresses_WT_ht'}, 'dst': {'same': False, 'congruent': 7, 'type': 'addresses_WT_ht'}}
...
{'OP': 'LOAD', 'src': {'same': True, 'type': 'addresses_WC_ht', 'NT': False, 'AVXalign': False, 'size': 8, 'congruent': 5}}
