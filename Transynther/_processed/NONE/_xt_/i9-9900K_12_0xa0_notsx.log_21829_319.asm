...
push %rdi
push %rsi
lea addresses_UC_ht+0x694d, %r12
nop
nop
xor %rax, %rax
movups (%r12), %xmm1
...
nop
xor $6728, %rax
lea addresses_UC_ht+0x13641, %rax
nop
dec %rcx
mov (%rax), %rbp
nop
...
nop
cmp %rax, %rax
lea addresses_normal_ht+0x11f95, %r9
nop
nop
nop
nop
...
nop
dec %r9
lea addresses_WC_ht+0x18f0d, %rax
nop
nop
nop
nop
...
// Faulty Load
lea addresses_normal+0xba41, %rdi
clflush (%rdi)
nop
and $54472, %rsi
mov (%rdi), %ecx
...
{'src': {'type': 'addresses_P', 'congruent': 1, 'same': False}, 'OP': 'REPM', 'dst': {'type': 'addresses_WT', 'congruent': 9, 'same': False}}
