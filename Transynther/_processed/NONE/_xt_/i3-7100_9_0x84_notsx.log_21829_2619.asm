...
push %rdx
push %rsi
lea addresses_WC_ht+0x14449, %rcx
nop
nop
nop
nop
...
nop
add %rax, %rax
lea addresses_UC_ht+0x7d59, %rsi
lea addresses_UC_ht+0x65c9, %rdi
cmp $3864, %r13
mov $82, %rcx
rep movsq
nop
...
nop
add %rdx, %rdx
lea addresses_normal_ht+0x1c149, %rax
xor $12584, %rdi
...
nop
and %rsi, %rsi
lea addresses_UC_ht+0x5019, %rsi
...
{'src': {'type': 'addresses_UC_ht', 'congruent': 4, 'same': False}, 'dst': {'type': 'addresses_UC_ht', 'congruent': 9, 'same': False}, 'OP': 'REPM'}
