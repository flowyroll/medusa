...
nop
xor %rcx, %rcx
lea addresses_WT_ht+0x95be, %r11
dec %r8
mov (%r11), %r14d
nop
nop
...
nop
xor %r8, %r8
lea addresses_normal_ht+0x1e27e, %r8
nop
nop
xor %rbp, %rbp
movl $0x61626364, (%r8)
...
<gen_prepare_buffer>
{'src': {'type': 'addresses_D_ht', 'same': False, 'size': 32, 'congruent': 11, 'NT': True, 'AVXalign': True}, 'OP': 'LOAD'}
{'src': {'type': 'addresses_A_ht', 'same': False, 'size': 8, 'congruent': 4, 'NT': False, 'AVXalign': False}, 'OP': 'LOAD'}
{'src': {'type': 'addresses_WT_ht', 'same': False, 'size': 4, 'congruent': 9, 'NT': True, 'AVXalign': True}, 'OP': 'LOAD'}
