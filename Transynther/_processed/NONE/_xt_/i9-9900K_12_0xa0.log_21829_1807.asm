...
push %rdi
push %rsi
lea addresses_WT_ht+0x129c, %rsi
...
nop
add %r11, %r11
lea addresses_WT_ht+0x1b09c, %rax
nop
nop
nop
add $24591, %rsi
...
nop
xor %r8, %r8
lea addresses_WC_ht+0xa86c, %rdi
nop
nop
nop
nop
...
<gen_prepare_buffer>
{'src': {'same': False, 'congruent': 7, 'type': 'addresses_WT_ht'}, 'OP': 'REPM', 'dst': {'same': True, 'congruent': 4, 'type': 'addresses_WT_ht'}}
{'src': {'NT': False, 'same': True, 'congruent': 9, 'type': 'addresses_WT_ht', 'AVXalign': False, 'size': 4}, 'OP': 'LOAD'}
