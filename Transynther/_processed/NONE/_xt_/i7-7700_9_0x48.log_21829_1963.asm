...
nop
add %rdx, %rdx
lea addresses_WC_ht+0xc838, %r15
nop
add $37992, %rbx
movb $0x61, (%r15)
nop
...
nop
xor %rdx, %rdx
lea addresses_WC_ht+0x7e98, %rbp
nop
nop
nop
nop
...
mov (%rbp), %r15
inc %r9
lea addresses_WT_ht+0x1fb8, %rsi
nop
nop
sub %rdx, %rdx
mov (%rsi), %r9w
...
nop
xor %rbx, %rbx
lea addresses_A_ht+0x146b8, %rsi
lea addresses_D_ht+0x1187e, %rdi
nop
sub %r15, %r15
mov $83, %rcx
rep movsb
...
nop
sub $30445, %r15
lea addresses_UC_ht+0x11cfd, %rsi
lea addresses_UC_ht+0x17ab8, %rdi
cmp %r15, %r15
mov $30, %rcx
rep movsq
nop
...
nop
sub %r15, %r15
lea addresses_WC_ht+0x71f8, %rdx
nop
nop
nop
nop
...
nop
mfence
lea addresses_WC_ht+0x6278, %rdx
nop
add %rdi, %rdi
movb (%rdx), %r9b
nop
