...
push %rdi
push %rsi
lea addresses_UC_ht+0x1a8b9, %rbp
clflush (%rbp)
nop
nop
sub %r13, %r13
...
nop
cmp %r10, %r10
lea addresses_normal_ht+0xb4b9, %rsi
lea addresses_A_ht+0x99b9, %rdi
nop
cmp %r11, %r11
mov $35, %rcx
rep movsl
...
lea addresses_A_ht+0x13eb9, %rdi
nop
nop
nop
nop
...
nop
and %rsi, %rsi
lea addresses_D_ht+0x1e479, %rsi
lea addresses_WT_ht+0x63b9, %rdi
nop
nop
nop
nop
...
<gen_prepare_buffer>
{'OP': 'LOAD', 'src': {'same': False, 'type': 'addresses_UC_ht', 'NT': True, 'AVXalign': False, 'size': 32, 'congruent': 9}}
...
{'OP': 'REPM', 'src': {'same': True, 'congruent': 6, 'type': 'addresses_D_ht'}, 'dst': {'same': False, 'congruent': 7, 'type': 'addresses_WT_ht'}}
{'39': 21829}
