...
push %rdi
push %rsi
lea addresses_normal_ht+0x1ee8e, %r13
nop
and %r8, %r8
...
vmovups %ymm4, (%r13)
sub $38820, %rsi
lea addresses_D_ht+0x1cb0e, %rsi
...
nop
cmp %rbx, %rbx
lea addresses_D_ht+0x10e8e, %rdi
nop
sub $31716, %r10
mov (%rdi), %r8w
nop
nop
sub %rcx, %rcx
lea addresses_D_ht+0xe68e, %rsi
lea addresses_D_ht+0x19bce, %rdi
nop
add $39680, %r10
mov $41, %rcx
rep movsw
...
nop
cmp %rdi, %rdi
lea addresses_WC_ht+0x1947c, %rsi
lea addresses_D_ht+0x668e, %rdi
clflush (%rsi)
nop
dec %r15
mov $70, %rcx
...
lea addresses_WT_ht+0x70ae, %rdi
clflush (%rdi)
nop
nop
xor %r10, %r10
...
{'src': {'type': 'addresses_WC_ht', 'congruent': 1, 'same': False}, 'OP': 'REPM', 'dst': {'type': 'addresses_D_ht', 'congruent': 9, 'same': False}}
{'src': {'type': 'addresses_UC_ht', 'congruent': 7, 'same': False}, 'OP': 'REPM', 'dst': {'type': 'addresses_WT_ht', 'congruent': 5, 'same': False}}
{'39': 21829}
