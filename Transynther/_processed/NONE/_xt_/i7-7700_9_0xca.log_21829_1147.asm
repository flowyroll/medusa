...
push %rdx
push %rsi
lea addresses_A_ht+0x1b334, %rbx
nop
nop
dec %rax
...
nop
inc %rdi
lea addresses_UC_ht+0x13c14, %rdx
sub $46911, %rdi
mov $0x6162636465666768, %rcx
movq %rcx, (%rdx)
nop
cmp %rbx, %rbx
lea addresses_WT_ht+0xd0e5, %rax
nop
nop
nop
nop
...
nop
xor $44644, %r14
lea addresses_WC_ht+0x11e50, %rsi
lea addresses_D_ht+0x9734, %rdi
nop
dec %rdx
mov $118, %rcx
rep movsb
sub $17350, %rdi
lea addresses_WT_ht+0x1d44, %rax
clflush (%rax)
nop
nop
nop
...
nop
cmp %rsi, %rsi
lea addresses_UC_ht+0x9f34, %rsi
lea addresses_WC_ht+0x884c, %rdi
nop
nop
nop
nop
...
nop
sub %rbx, %rbx
lea addresses_D_ht+0x18034, %rcx
nop
nop
nop
and $57824, %rbx
...
nop
cmp %rdi, %rdi
lea addresses_UC_ht+0x126f4, %r8
nop
nop
nop
nop
...
{'src': {'congruent': 1, 'same': False, 'type': 'addresses_WC_ht'}, 'OP': 'REPM', 'dst': {'congruent': 11, 'same': False, 'type': 'addresses_D_ht'}}
{'OP': 'STOR', 'dst': {'congruent': 3, 'AVXalign': False, 'same': False, 'size': 8, 'NT': False, 'type': 'addresses_WT_ht'}}
{'src': {'congruent': 8, 'same': True, 'type': 'addresses_UC_ht'}, 'OP': 'REPM', 'dst': {'congruent': 3, 'same': False, 'type': 'addresses_WC_ht'}}
