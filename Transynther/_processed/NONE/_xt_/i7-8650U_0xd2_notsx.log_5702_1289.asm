...
push %rdi
push %rsi
lea addresses_WC_ht+0x5a97, %r15
add %r10, %r10
mov $0x6162636465666768, %r8
movq %r8, (%r15)
nop
add %rbp, %rbp
lea addresses_D_ht+0xfa97, %r9
sub %rdi, %rdi
mov (%r9), %ebx
nop
nop
...
nop
sub %rbp, %rbp
lea addresses_UC_ht+0x12697, %r15
nop
nop
and $51142, %rbx
mov (%r15), %rdi
...
nop
and %r8, %r8
lea addresses_WT_ht+0x1a1f6, %rbx
nop
nop
xor $37099, %rdi
...
nop
cmp %rbx, %rbx
lea addresses_WT_ht+0x1ec77, %rsi
lea addresses_normal_ht+0xbca7, %rdi
nop
nop
nop
nop
...
nop
xor %rsi, %rsi
lea addresses_normal_ht+0xf097, %rdi
clflush (%rdi)
nop
nop
nop
...
nop
cmp $59896, %r15
lea addresses_WT_ht+0x172c7, %r8
inc %r15
...
nop
inc %rbx
lea addresses_A_ht+0x14e97, %rsi
lea addresses_WC_ht+0xae97, %rdi
clflush (%rsi)
nop
nop
nop
...
rep movsw
inc %r15
lea addresses_normal_ht+0xb787, %rsi
...
{'OP': 'LOAD', 'src': {'type': 'addresses_D_ht', 'size': 4, 'AVXalign': False, 'NT': False, 'congruent': 9, 'same': True}}
{'OP': 'LOAD', 'src': {'type': 'addresses_UC_ht', 'size': 8, 'AVXalign': False, 'NT': True, 'congruent': 8, 'same': False}}
