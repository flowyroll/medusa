...
mov (%rax), %r10w
and %r15, %r15
lea addresses_normal_ht+0x196b, %rsi
clflush (%rsi)
nop
nop
nop
...
nop
add $28472, %r15
lea addresses_WC_ht+0x12ee7, %rsi
nop
nop
nop
add %r8, %r8
...
nop
and %r15, %r15
lea addresses_WT_ht+0x781c, %rax
nop
nop
nop
nop
...
movups %xmm3, (%rax)
xor $30727, %r13
lea addresses_normal_ht+0x2ccb, %rsi
lea addresses_A_ht+0x124cb, %rdi
clflush (%rsi)
add $9779, %r15
mov $31, %rcx
rep movsb
...
{'OP': 'LOAD', 'src': {'type': 'addresses_WC_ht', 'size': 32, 'AVXalign': False, 'NT': True, 'congruent': 0, 'same': False}}
