...
push %rcx
push %rdx
lea addresses_normal_ht+0x15c5d, %rbx
nop
nop
nop
nop
...
nop
cmp $14967, %r9
lea addresses_WC_ht+0x15e4d, %r11
add %rcx, %rcx
...
nop
and %r8, %r8
lea addresses_WT_ht+0x12809, %r11
nop
nop
nop
nop
...
vpextrq $0, %xmm5, %r13
dec %rdx
lea addresses_normal_ht+0x15c99, %r11
nop
nop
nop
nop
...
// Faulty Load
lea addresses_normal+0x19009, %r12
nop
dec %r10
mov (%r12), %r9
lea oracles, %r10
