...
push %rdx
push %rsi
lea addresses_WT_ht+0x1664d, %rdx
nop
xor %r9, %r9
...
nop
cmp %r11, %r11
lea addresses_WC_ht+0x1dc8d, %r13
and $32293, %rsi
mov (%r13), %r10d
nop
nop
and $54063, %rsi
lea addresses_WT_ht+0x18a4d, %r10
sub %rdx, %rdx
movl $0x61626364, (%r10)
nop
nop
...
nop
xor $19784, %r10
lea addresses_normal_ht+0x94cd, %r13
nop
nop
sub %r12, %r12
movl $0x61626364, (%r13)
...
nop
add %r9, %r9
lea addresses_UC_ht+0x1aabd, %rsi
clflush (%rsi)
add $34597, %r10
movups (%rsi), %xmm5
vpextrq $1, %xmm5, %r11
...
<gen_faulty_load>
[REF]
{'src': {'NT': True, 'AVXalign': True, 'size': 32, 'congruent': 0, 'same': False, 'type': 'addresses_A'}, 'OP': 'LOAD'}
[Faulty Load]
