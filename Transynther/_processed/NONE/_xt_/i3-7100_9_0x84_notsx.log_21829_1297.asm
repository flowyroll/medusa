...
push %rdi
push %rsi
lea addresses_WC_ht+0x9f1f, %rsi
clflush (%rsi)
nop
add %rcx, %rcx
...
nop
add %r9, %r9
lea addresses_D_ht+0x12c3f, %rsi
lea addresses_D_ht+0xa69f, %rdi
nop
add $9182, %r15
mov $23, %rcx
rep movsl
...
nop
cmp %r9, %r9
lea addresses_WC_ht+0x1579f, %rcx
nop
nop
nop
nop
...
nop
xor $55910, %rbp
lea addresses_A_ht+0x6870, %rsi
lea addresses_normal_ht+0x769f, %rdi
nop
and %rbp, %rbp
mov $68, %rcx
rep movsl
...
// REPMOV
lea addresses_RW+0xde9f, %rsi
lea addresses_A+0x1ea67, %rdi
cmp $59771, %rax
mov $83, %rcx
rep movsl
cmp $44012, %r11
...
{'src': {'type': 'addresses_RW', 'congruent': 0, 'same': True}, 'dst': {'type': 'addresses_A', 'congruent': 1, 'same': False}, 'OP': 'REPM'}
...
{'src': {'type': 'addresses_D_ht', 'congruent': 4, 'same': True}, 'dst': {'type': 'addresses_D_ht', 'congruent': 9, 'same': False}, 'OP': 'REPM'}
