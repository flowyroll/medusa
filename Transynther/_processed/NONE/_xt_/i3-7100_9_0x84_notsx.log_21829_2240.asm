...
push %rdi
push %rsi
lea addresses_WC_ht+0x9ac4, %rsi
lea addresses_D_ht+0x99e4, %rdi
nop
nop
nop
nop
...
rep movsw
cmp %r14, %r14
lea addresses_normal_ht+0xeee4, %rax
clflush (%rax)
nop
nop
nop
...
nop
and $24110, %rcx
lea addresses_normal_ht+0x172e4, %r14
and %rbx, %rbx
vmovups (%r14), %ymm1
...
nop
sub $18106, %r14
lea addresses_normal_ht+0xeaf0, %r9
nop
nop
nop
nop
...
mov (%r9), %cx
mfence
lea addresses_WC_ht+0x10ae4, %rsi
lea addresses_WT_ht+0x229c, %rdi
nop
nop
dec %rbx
mov $14, %rcx
...
// Faulty Load
lea addresses_normal+0x1fee4, %rsi
nop
nop
nop
nop
...
<gen_prepare_buffer>
{'src': {'type': 'addresses_WC_ht', 'congruent': 4, 'same': False}, 'dst': {'type': 'addresses_D_ht', 'congruent': 7, 'same': True}, 'OP': 'REPM'}
