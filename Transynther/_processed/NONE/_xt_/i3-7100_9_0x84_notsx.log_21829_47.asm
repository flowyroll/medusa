...
push %rdx
push %rsi
lea addresses_D_ht+0x125f4, %rcx
nop
nop
and $23738, %r11
movb (%rcx), %al
...
nop
inc %r8
lea addresses_normal_ht+0x127f4, %rax
nop
nop
nop
xor %r13, %r13
...
nop
add $659, %r11
lea addresses_WC_ht+0x7674, %rsi
lea addresses_A_ht+0x183f4, %rdi
clflush (%rsi)
nop
nop
and %rdx, %rdx
...
rep movsb
add $54180, %r8
lea addresses_WT_ht+0x1ccf4, %r8
add %rdi, %rdi
movups (%r8), %xmm0
vpextrq $0, %xmm0, %rax
nop
...
lea addresses_WT_ht+0x143d4, %rdi
and %rdx, %rdx
mov $29, %rcx
rep movsl
nop
...
nop
sub %rdx, %rdx
lea addresses_A_ht+0x3eb4, %rsi
lea addresses_UC_ht+0x153f4, %rdi
nop
cmp $23585, %r13
mov $3, %rcx
rep movsw
...
nop
dec %rsi
lea addresses_D_ht+0x66b8, %rsi
lea addresses_D_ht+0x1c858, %rdi
nop
nop
nop
and %rax, %rax
...
nop
add $18667, %rsi
lea addresses_WC_ht+0x1d3f0, %r13
nop
nop
nop
nop
...
nop
xor %rsi, %rsi
lea addresses_WT_ht+0x11c34, %r8
and $22681, %rax
movb (%r8), %dl
nop
nop
...
nop
inc %r11
lea addresses_A_ht+0x152f4, %rax
nop
and $43087, %rdx
movw $0x6162, (%rax)
dec %rax
lea addresses_WT_ht+0x236a, %rdi
nop
nop
nop
nop
...
nop
cmp $60871, %rax
lea addresses_normal_ht+0x814, %rcx
nop
nop
nop
nop
...
// Faulty Load
lea addresses_normal+0x5bf4, %rdi
nop
and %rsi, %rsi
vmovups (%rdi), %ymm3
...
{'src': {'type': 'addresses_US', 'same': False, 'size': 1, 'congruent': 4, 'NT': False, 'AVXalign': False}, 'OP': 'LOAD'}
[Faulty Load]
