...
nop
xor %rdi, %rdi
lea addresses_WT_ht+0x1e2d3, %rsi
lea addresses_WC_ht+0x165a3, %rdi
clflush (%rsi)
nop
nop
sub $43699, %r9
...
rep movsl
sub $64972, %rbx
lea addresses_normal_ht+0x124d3, %rbx
xor %rax, %rax
movups (%rbx), %xmm0
vpextrq $0, %xmm0, %rcx
and $59935, %rsi
lea addresses_D_ht+0x19e33, %rcx
clflush (%rcx)
nop
nop
nop
...
nop
cmp $56956, %r9
lea addresses_normal_ht+0x15293, %rax
nop
add %rsi, %rsi
movb $0x61, (%rax)
nop
...
nop
add %rcx, %rcx
lea addresses_normal_ht+0x10d3, %rdx
nop
nop
nop
nop
...
nop
add $63043, %rdx
lea addresses_UC_ht+0x1b8d3, %rsi
nop
inc %rdi
movb (%rsi), %cl
nop
...
// Store
lea addresses_RW+0x14dc9, %r14
dec %rcx
movw $0x5152, (%r14)
add $36606, %r13

// Load
lea addresses_UC+0x1ae83, %r8
nop
nop
nop
dec %rsi
...
{'OP': 'LOAD', 'src': {'same': False, 'NT': True, 'AVXalign': False, 'size': 16, 'type': 'addresses_WT_ht', 'congruent': 5}}
{'OP': 'LOAD', 'src': {'same': False, 'NT': True, 'AVXalign': False, 'size': 4, 'type': 'addresses_UC_ht', 'congruent': 5}}
{'dst': {'same': False, 'congruent': 4, 'type': 'addresses_WC_ht'}, 'OP': 'REPM', 'src': {'same': False, 'congruent': 6, 'type': 'addresses_WT_ht'}}
...
{'OP': 'LOAD', 'src': {'same': False, 'NT': False, 'AVXalign': True, 'size': 16, 'type': 'addresses_D_ht', 'congruent': 6}}
{'39': 21829}
