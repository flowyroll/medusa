...
nop
sub $7786, %r15
lea addresses_UC_ht+0x188cb, %rbx
nop
nop
nop
nop
...
nop
add $1752, %r12
lea addresses_UC_ht+0x1a167, %r15
nop
nop
nop
nop
...
nop
and %rbx, %rbx
lea addresses_WT_ht+0xd5c7, %rsi
lea addresses_A_ht+0x1c827, %rdi
clflush (%rdi)
nop
nop
sub $16189, %r9
...
nop
add %r15, %r15
lea addresses_UC_ht+0x17007, %r8
nop
nop
inc %rsi
movb (%r8), %cl
...
// Store
lea addresses_normal+0x2dc7, %rdx
nop
nop
and %rbx, %rbx
movw $0x5152, (%rdx)
...
{'dst': {'same': False, 'NT': True, 'AVXalign': False, 'size': 32, 'type': 'addresses_UC_ht', 'congruent': 1}, 'OP': 'STOR'}
{'OP': 'LOAD', 'src': {'same': False, 'NT': False, 'AVXalign': False, 'size': 32, 'type': 'addresses_UC_ht', 'congruent': 5}}
{'dst': {'same': False, 'congruent': 5, 'type': 'addresses_A_ht'}, 'OP': 'REPM', 'src': {'same': False, 'congruent': 3, 'type': 'addresses_WT_ht'}}
{'OP': 'LOAD', 'src': {'same': False, 'NT': False, 'AVXalign': False, 'size': 16, 'type': 'addresses_D_ht', 'congruent': 9}}
{'OP': 'LOAD', 'src': {'same': False, 'NT': True, 'AVXalign': False, 'size': 1, 'type': 'addresses_UC_ht', 'congruent': 9}}
{'32': 21829}
