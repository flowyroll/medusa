...
push %rdx
push %rsi
lea addresses_D_ht+0x14d69, %r12
nop
nop
sub %r8, %r8
mov (%r12), %r13w
...
nop
sub %r9, %r9
lea addresses_UC_ht+0x1998e, %rdi
cmp %rdx, %rdx
vmovups (%rdi), %ymm6
...
nop
sub %r8, %r8
lea addresses_A_ht+0x95fa, %rsi
lea addresses_D_ht+0xfd96, %rdi
nop
cmp $1360, %r9
mov $41, %rcx
rep movsb
...
nop
dec %r13
lea addresses_WT_ht+0x1d796, %rcx
nop
nop
nop
nop
...
mov (%rcx), %r12w
sub $33306, %r9
lea addresses_normal_ht+0x1a316, %rsi
lea addresses_D_ht+0x10b96, %rdi
nop
nop
nop
xor $42932, %r9
...
{'src': {'NT': False, 'AVXalign': True, 'size': 2, 'congruent': 10, 'same': False, 'type': 'addresses_WT_ht'}, 'OP': 'LOAD'}
{'src': {'congruent': 5, 'same': False, 'type': 'addresses_normal_ht'}, 'dst': {'congruent': 11, 'same': False, 'type': 'addresses_D_ht'}, 'OP': 'REPM'}
{'37': 21829}
