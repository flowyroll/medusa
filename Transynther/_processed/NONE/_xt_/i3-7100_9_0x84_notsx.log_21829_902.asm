...
lea addresses_UC_ht+0x3893, %rdi
clflush (%rsi)
nop
nop
nop
...
nop
xor $48125, %rcx
lea addresses_UC_ht+0x1a79b, %rsi
lea addresses_A_ht+0x12bf3, %rdi
clflush (%rdi)
nop
nop
nop
...
nop
cmp $31236, %rcx
lea addresses_WT_ht+0xff93, %rsi
lea addresses_WC_ht+0x17633, %rdi
nop
nop
xor %rbp, %rbp
mov $41, %rcx
...
// Faulty Load
lea addresses_normal+0xeb93, %rbx
clflush (%rbx)
nop
nop
nop
...
{'src': {'type': 'addresses_WT_ht', 'congruent': 9, 'same': False}, 'dst': {'type': 'addresses_WC_ht', 'congruent': 3, 'same': False}, 'OP': 'REPM'}
{'34': 21829}
