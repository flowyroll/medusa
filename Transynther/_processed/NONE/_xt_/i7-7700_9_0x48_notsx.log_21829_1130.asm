...
push %rdi
push %rsi
lea addresses_normal_ht+0x2792, %rbp
nop
nop
nop
cmp %r12, %r12
...
lea addresses_WT_ht+0x1c122, %rdi
nop
nop
nop
nop
...
nop
sub $50198, %rdi
lea addresses_WC_ht+0x10f22, %rsi
lea addresses_WT_ht+0x1a382, %rdi
add %r10, %r10
mov $5, %rcx
rep movsq
nop
...
{'dst': {'same': True, 'congruent': 5, 'type': 'addresses_WT_ht'}, 'OP': 'REPM', 'src': {'same': False, 'congruent': 5, 'type': 'addresses_WC_ht'}}
