...
nop
and $15242, %r9
lea addresses_UC_ht+0xd4b2, %rsi
nop
dec %r10
...
nop
xor $17631, %r14
lea addresses_WT_ht+0x16fe2, %rcx
nop
nop
nop
nop
...
nop
sub $46725, %rcx
lea addresses_UC_ht+0x103d2, %rsi
lea addresses_WT_ht+0x53f, %rdi
add %r14, %r14
mov $66, %rcx
rep movsw
nop
...
{'src': {'type': 'addresses_UC_ht', 'congruent': 3, 'same': False}, 'OP': 'REPM', 'dst': {'type': 'addresses_WT_ht', 'congruent': 0, 'same': False}}
