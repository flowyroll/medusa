...
push %rdx
push %rsi
lea addresses_D_ht+0x13c86, %r14
add %r8, %r8
...
nop
dec %rdi
lea addresses_normal_ht+0x7f06, %r15
cmp $18253, %rbx
mov (%r15), %r8w
nop
nop
sub %rdx, %rdx
lea addresses_normal_ht+0x1e486, %rsi
lea addresses_D_ht+0x3c1e, %rdi
clflush (%rdi)
sub %rbx, %rbx
mov $53, %rcx
rep movsq
...
nop
add %rsi, %rsi
lea addresses_WC_ht+0x38a6, %rbx
nop
nop
nop
nop
...
nop
xor %r14, %r14
lea addresses_WT_ht+0x305c, %rsi
lea addresses_D_ht+0x7c5e, %rdi
nop
nop
nop
nop
...
nop
inc %r8
lea addresses_UC_ht+0x11a52, %r8
dec %rsi
...
nop
xor $43332, %r15
lea addresses_UC_ht+0xea86, %rdx
clflush (%rdx)
nop
nop
nop
...
nop
cmp $32056, %r15
lea addresses_WC_ht+0xaa86, %rcx
add %rdx, %rdx
movups (%rcx), %xmm3
vpextrq $0, %xmm3, %rsi
nop
nop
inc %rcx
lea addresses_D_ht+0xf9d6, %rsi
lea addresses_A_ht+0x3c21, %rdi
nop
and %rdx, %rdx
mov $49, %rcx
rep movsq
...
<gen_prepare_buffer>
{'OP': 'LOAD', 'src': {'size': 32, 'NT': False, 'type': 'addresses_D_ht', 'same': False, 'AVXalign': True, 'congruent': 9}}
...
{'OP': 'LOAD', 'src': {'size': 16, 'NT': True, 'type': 'addresses_UC_ht', 'same': True, 'AVXalign': False, 'congruent': 2}}
...
{'OP': 'REPM', 'src': {'same': False, 'type': 'addresses_D_ht', 'congruent': 4}, 'dst': {'same': False, 'type': 'addresses_A_ht', 'congruent': 0}}
