...
push %rdi
push %rsi
lea addresses_WC_ht+0x22ea, %rax
nop
nop
nop
nop
...
nop
cmp %rbx, %rbx
lea addresses_A_ht+0x1358a, %r11
nop
nop
nop
nop
...
movaps %xmm0, (%r11)
add %rax, %rax
lea addresses_WT_ht+0x6f6e, %r10
nop
nop
nop
nop
...
nop
and $35962, %r10
lea addresses_WT_ht+0x1140a, %rax
dec %r10
movb (%rax), %r14b
add $10271, %r10
lea addresses_WC_ht+0x1a452, %rsi
...
// Faulty Load
lea addresses_normal+0xd78a, %r8
dec %rbx
mov (%r8), %r12d
lea oracles, %rdx
and $0xff, %r12
...
{'OP': 'STOR', 'dst': {'size': 16, 'NT': False, 'type': 'addresses_A_ht', 'same': True, 'AVXalign': True, 'congruent': 8}}
...
{'OP': 'REPM', 'src': {'same': False, 'type': 'addresses_WC_ht', 'congruent': 3}, 'dst': {'same': True, 'type': 'addresses_WT_ht', 'congruent': 10}}
{'34': 21829}
