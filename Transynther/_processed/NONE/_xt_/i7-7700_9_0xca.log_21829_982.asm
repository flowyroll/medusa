...
nop
inc %r8
lea addresses_WC_ht+0xb28f, %rcx
nop
xor %rbp, %rbp
movw $0x6162, (%rcx)
nop
nop
cmp $55696, %rdx
lea addresses_WC_ht+0x5f6f, %rsi
lea addresses_A_ht+0x1a2b7, %rdi
nop
nop
nop
nop
...
nop
and %rdx, %rdx
lea addresses_UC_ht+0x1914f, %r8
nop
cmp %rdi, %rdi
mov (%r8), %ebp
nop
...
// REPMOV
lea addresses_D+0x10d9f, %rsi
lea addresses_normal+0x17ee3, %rdi
nop
nop
xor $7486, %r14
mov $63, %rcx
...
{'src': {'congruent': 4, 'same': False, 'type': 'addresses_D'}, 'OP': 'REPM', 'dst': {'congruent': 2, 'same': False, 'type': 'addresses_normal'}}
...
{'src': {'congruent': 5, 'same': False, 'type': 'addresses_WC_ht'}, 'OP': 'REPM', 'dst': {'congruent': 3, 'same': False, 'type': 'addresses_A_ht'}}
