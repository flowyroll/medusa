...
push %rdx
push %rsi
lea addresses_D_ht+0x14114, %rsi
lea addresses_D_ht+0x1d174, %rdi
clflush (%rdi)
nop
nop
nop
...
nop
add $49781, %rcx
lea addresses_WT_ht+0x1674, %r12
nop
sub $19745, %rdx
vmovups (%r12), %ymm0
...
nop
sub $10748, %r9
lea addresses_D_ht+0x16af8, %rdx
nop
nop
nop
nop
...
nop
add %rcx, %rcx
lea addresses_WT_ht+0xe90c, %rdi
nop
nop
nop
nop
...
nop
xor %rdi, %rdi
lea addresses_UC_ht+0x1a679, %r9
nop
nop
nop
nop
