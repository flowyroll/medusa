...
push %rdx
push %rsi
lea addresses_normal_ht+0xc810, %rbx
nop
nop
nop
nop
...
nop
and $26538, %r10
lea addresses_D_ht+0x1dbb0, %r14
nop
nop
nop
nop
...
nop
sub $58372, %rax
lea addresses_D_ht+0x108b0, %r11
clflush (%r11)
nop
nop
xor $17652, %r10
movl $0x61626364, (%r11)
cmp $53708, %r14
lea addresses_D_ht+0xfb0, %rsi
lea addresses_normal_ht+0xfe70, %rdi
nop
nop
nop
nop
...
nop
xor %r11, %r11
lea addresses_UC_ht+0x189b0, %r11
xor $47728, %rdi
movups (%r11), %xmm3
vpextrq $0, %xmm3, %rsi
nop
...
movw $0x6162, (%rcx)
cmp $17312, %rbx
lea addresses_WC_ht+0x97b0, %rsi
lea addresses_UC_ht+0x3b0, %rdi
dec %r11
mov $57, %rcx
rep movsl
nop
cmp $51512, %rdx
lea addresses_WC_ht+0x2586, %rsi
lea addresses_normal_ht+0xd30, %rdi
clflush (%rdi)
nop
nop
nop
...
nop
xor $10419, %rax
lea addresses_UC_ht+0x5fb0, %rdi
nop
add %rcx, %rcx
movb $0x61, (%rdi)
and %rcx, %rcx
lea addresses_UC_ht+0x1bca6, %rsi
nop
nop
nop
nop
...
{'dst': {'same': False, 'congruent': 10, 'type': 'addresses_UC_ht'}, 'OP': 'REPM', 'src': {'same': False, 'congruent': 10, 'type': 'addresses_WC_ht'}}
