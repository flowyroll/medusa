...
nop
sub $14236, %r10
lea addresses_D_ht+0x1803a, %rdx
nop
nop
sub %r10, %r10
...
nop
cmp $30893, %rdi
lea addresses_normal_ht+0x1724e, %rdi
nop
nop
nop
nop
...
movb $0x61, (%rdi)
and $38869, %rdx
lea addresses_WT_ht+0x15aa, %rsi
...
// REPMOV
lea addresses_WT+0x75ce, %rsi
lea addresses_WC+0x8086, %rdi
clflush (%rsi)
nop
nop
nop
...
{'src': {'congruent': 5, 'same': False, 'type': 'addresses_WT'}, 'dst': {'congruent': 3, 'same': False, 'type': 'addresses_WC'}, 'OP': 'REPM'}
...
{'src': {'congruent': 2, 'same': False, 'type': 'addresses_WT_ht'}, 'dst': {'congruent': 11, 'same': False, 'type': 'addresses_normal_ht'}, 'OP': 'REPM'}
{'33': 21829}
