...
push %rdx
push %rsi
lea addresses_D_ht+0x1d2f4, %rsi
lea addresses_WT_ht+0x185d4, %rdi
nop
nop
add %rdx, %rdx
mov $120, %rcx
...
nop
and $32759, %r15
lea addresses_normal_ht+0x17b94, %r15
nop
nop
nop
nop
...
nop
xor $54819, %r15
lea addresses_UC_ht+0x894, %rsi
lea addresses_WC_ht+0x4494, %rdi
nop
nop
sub %r15, %r15
mov $14, %rcx
...
nop
add $65121, %rdi
lea addresses_WT_ht+0x1cdb4, %rax
clflush (%rax)
nop
nop
nop
...
// Load
lea addresses_normal+0x19432, %rbp
nop
nop
nop
nop
...
{'OP': 'STOR', 'dst': {'type': 'addresses_RW', 'AVXalign': False, 'congruent': 0, 'size': 16, 'same': False, 'NT': True}}
