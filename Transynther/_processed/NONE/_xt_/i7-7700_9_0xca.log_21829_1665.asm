...
push %rdx
push %rsi
lea addresses_WC_ht+0x8bfc, %rax
nop
nop
nop
nop
...
nop
xor $44324, %r13
lea addresses_A_ht+0x1abfc, %rsi
lea addresses_UC_ht+0xbffc, %rdi
nop
nop
add $38722, %rbx
mov $65, %rcx
...
nop
and $24786, %r13
lea addresses_WC_ht+0xc0bc, %rsi
clflush (%rsi)
nop
nop
nop
...
nop
and %r13, %r13
lea addresses_WC_ht+0x3358, %rsi
lea addresses_WT_ht+0x17dfc, %rdi
nop
nop
xor $3083, %r15
mov $82, %rcx
...
nop
and %rdi, %rdi
lea addresses_A_ht+0x96e4, %rsi
lea addresses_A_ht+0x15424, %rdi
clflush (%rdi)
nop
nop
sub %r13, %r13
...
lea addresses_WC_ht+0xc8cc, %rdi
lfence
mov $34, %rcx
rep movsb
nop
...
nop
inc %rcx
lea addresses_UC_ht+0x10afc, %rbx
xor %rcx, %rcx
movw $0x6162, (%rbx)
and $45264, %rax
lea addresses_A_ht+0xfdc, %r15
nop
nop
nop
xor $5720, %rdi
...
// Faulty Load
lea addresses_normal+0x8bfc, %r13
nop
nop
nop
nop
...
{'src': {'congruent': 2, 'same': False, 'type': 'addresses_WC_ht'}, 'OP': 'REPM', 'dst': {'congruent': 9, 'same': False, 'type': 'addresses_WT_ht'}}
{'src': {'congruent': 0, 'same': False, 'type': 'addresses_A_ht'}, 'OP': 'REPM', 'dst': {'congruent': 3, 'same': True, 'type': 'addresses_A_ht'}}
