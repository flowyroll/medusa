...
push %rdi
push %rsi
lea addresses_normal_ht+0x10386, %r10
nop
nop
and %rbx, %rbx
movups (%r10), %xmm5
...
nop
xor $14161, %r15
lea addresses_WT_ht+0x1b2f6, %r11
nop
dec %r13
mov (%r11), %r12d
nop
...
nop
cmp %r13, %r13
lea addresses_WT_ht+0xdcf6, %rsi
lea addresses_D_ht+0xd2b6, %rdi
nop
sub %r12, %r12
mov $62, %rcx
rep movsb
...
nop
xor $51545, %r10
lea addresses_WT_ht+0x15af6, %rsi
lea addresses_WC_ht+0x1c463, %rdi
nop
nop
nop
nop
...
rep movsb
sub $65423, %r11
lea addresses_A_ht+0x19ef6, %rdi
clflush (%rdi)
nop
nop
xor $31955, %r15
...
nop
and $27256, %r13
lea addresses_UC_ht+0x2cee, %rsi
lea addresses_UC_ht+0x13a36, %rdi
nop
nop
nop
cmp %rbx, %rbx
...
rep movsq
add %rbx, %rbx
lea addresses_WC_ht+0xe34e, %rsi
nop
nop
nop
nop
...
// Faulty Load
lea addresses_normal+0x7af6, %r11
nop
nop
nop
nop
