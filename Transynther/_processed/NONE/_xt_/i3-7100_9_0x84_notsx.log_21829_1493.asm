...
lea addresses_normal_ht+0x1b8d9, %rdi
nop
nop
nop
nop
...
nop
and $20348, %rbp
lea addresses_UC_ht+0x183a5, %rsi
lea addresses_WC_ht+0x10c61, %rdi
dec %r14
mov $96, %rcx
rep movsq
cmp %rcx, %rcx
lea addresses_UC_ht+0x1dd9, %rsi
lea addresses_UC_ht+0xcd9, %rdi
add $61368, %rdx
mov $59, %rcx
rep movsq
nop
...
nop
cmp $16435, %rsi
lea addresses_normal_ht+0x3113, %rbx
nop
nop
nop
nop
...
{'src': {'type': 'addresses_WC_ht', 'congruent': 8, 'same': False}, 'dst': {'type': 'addresses_normal_ht', 'congruent': 8, 'same': True}, 'OP': 'REPM'}
