...
push %rcx
push %rsi
lea addresses_UC_ht+0xc65e, %rcx
nop
nop
nop
nop
...
mov (%rcx), %r8
cmp $16279, %r8
lea addresses_D_ht+0x1b3be, %rcx
nop
nop
nop
sub $15072, %r9
...
mov (%r8), %r12
and %rcx, %rcx
lea addresses_D_ht+0x18ef6, %r10
nop
nop
nop
nop
...
nop
cmp %rbp, %rbp
lea addresses_WC_ht+0x18546, %r10
nop
nop
nop
add %r12, %r12
