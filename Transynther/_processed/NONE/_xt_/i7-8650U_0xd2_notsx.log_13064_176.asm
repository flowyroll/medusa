...
nop
cmp $33634, %r9
lea addresses_WT_ht+0x125ff, %rsi
nop
nop
nop
nop
...
nop
sub $9846, %rbx
lea addresses_WT_ht+0x1d9bf, %rsi
lea addresses_normal_ht+0x1bc1f, %rdi
nop
nop
nop
and %r8, %r8
...
nop
sub $33964, %r12
lea addresses_UC_ht+0x1cc8f, %r9
nop
nop
nop
cmp $15786, %r12
...
nop
and %rdi, %rdi
lea addresses_normal_ht+0x18873, %r8
and $39641, %rdi
mov (%r8), %r15
nop
nop
nop
xor $34722, %r12
lea addresses_normal_ht+0x1c5ff, %rsi
nop
nop
nop
nop
...
nop
sub %rsi, %rsi
lea addresses_A_ht+0x1d743, %rdi
nop
nop
sub %r12, %r12
mov (%rdi), %rbx
...
nop
and $26787, %rbx
lea addresses_A_ht+0x109ed, %rsi
lea addresses_WT_ht+0x115ff, %rdi
clflush (%rdi)
nop
nop
nop
...
nop
and $52007, %r8
lea addresses_normal_ht+0x180ff, %rbx
nop
nop
nop
nop
...
movl $0x61626364, (%rbx)
cmp %r8, %r8
lea addresses_WC_ht+0xf7f, %rsi
lea addresses_WC_ht+0x1cdff, %rdi
sub $4389, %r9
mov $89, %rcx
rep movsb
nop
...
nop
add $60473, %r8
lea addresses_normal_ht+0xedff, %r15
nop
lfence
...
nop
cmp $5716, %rcx
lea addresses_WC_ht+0x1307f, %rsi
clflush (%rsi)
nop
nop
nop
...
nop
add %r9, %r9
lea addresses_normal_ht+0xf89f, %r8
nop
and $38752, %rcx
movl $0x61626364, (%r8)
nop
...
{'OP': 'STOR', 'dst': {'type': 'addresses_UC', 'size': 8, 'AVXalign': False, 'NT': True, 'congruent': 10, 'same': False}}
...
<gen_prepare_buffer>
{'OP': 'STOR', 'dst': {'type': 'addresses_D_ht', 'size': 8, 'AVXalign': True, 'NT': False, 'congruent': 1, 'same': False}}
...
{'OP': 'STOR', 'dst': {'type': 'addresses_UC_ht', 'size': 4, 'AVXalign': True, 'NT': False, 'congruent': 4, 'same': True}}
