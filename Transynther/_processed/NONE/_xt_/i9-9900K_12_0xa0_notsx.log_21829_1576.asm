...
push %rdx
push %rsi
lea addresses_D_ht+0x113e6, %rdx
nop
inc %rsi
mov (%rdx), %r15w
nop
...
nop
sub $22886, %r14
lea addresses_normal_ht+0x7f92, %rcx
cmp %rax, %rax
mov $0x6162636465666768, %rbx
movq %rbx, (%rcx)
add %rcx, %rcx
lea addresses_A_ht+0x1b12, %r14
clflush (%r14)
nop
nop
nop
...
nop
sub $11527, %rbx
lea addresses_A_ht+0x3ecb, %rsi
lea addresses_A_ht+0x19792, %rdi
clflush (%rsi)
xor %r15, %r15
mov $1, %rcx
rep movsq
...
nop
sub %r14, %r14
lea addresses_WC_ht+0x14392, %rsi
lea addresses_WC_ht+0xaf92, %rdi
nop
nop
add $46610, %rbx
mov $36, %rcx
...
nop
inc %rcx
lea addresses_D_ht+0x1d992, %rax
nop
nop
xor $39072, %rdx
...
movups %xmm2, (%rax)
xor $54142, %rax
lea addresses_normal_ht+0xa9aa, %rcx
nop
nop
nop
sub $3331, %r14
...
nop
xor $49119, %rdi
lea addresses_UC_ht+0x9792, %rax
nop
nop
dec %rcx
mov (%rax), %bx
xor %rsi, %rsi
lea addresses_WC_ht+0x14f92, %rsi
lea addresses_WC_ht+0x17fbe, %rdi
nop
nop
nop
nop
...
{'src': {'type': 'addresses_WC_ht', 'congruent': 10, 'same': False}, 'OP': 'REPM', 'dst': {'type': 'addresses_WC_ht', 'congruent': 11, 'same': False}}
...
{'src': {'type': 'addresses_WC_ht', 'congruent': 10, 'same': False}, 'OP': 'REPM', 'dst': {'type': 'addresses_WC_ht', 'congruent': 1, 'same': False}}
{'32': 21829}
