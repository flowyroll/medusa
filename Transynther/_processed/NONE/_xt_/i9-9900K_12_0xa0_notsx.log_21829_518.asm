...
nop
cmp $813, %rsi
lea addresses_WT_ht+0x7eb8, %rdx
dec %rcx
mov (%rdx), %r11w
nop
nop
...
nop
add $63885, %rsi
lea addresses_WT_ht+0x213e, %rsi
nop
nop
nop
nop
...
nop
xor %rcx, %rcx
lea addresses_normal_ht+0x4a08, %rsi
lea addresses_UC_ht+0xaf08, %rdi
cmp %r14, %r14
mov $19, %rcx
rep movsq
nop
nop
sub %rcx, %rcx
lea addresses_normal_ht+0x1208, %rcx
nop
nop
and %r14, %r14
...
nop
cmp $50659, %rsi
lea addresses_WT_ht+0xd268, %r11
nop
nop
nop
nop
...
nop
add %rsi, %rsi
lea addresses_D_ht+0x11fa6, %rcx
xor %r14, %r14
movw $0x6162, (%rcx)
nop
inc %r11
lea addresses_normal_ht+0x1d7c8, %rdi
nop
nop
nop
nop
...
nop
dec %rcx
lea addresses_A_ht+0x156ec, %rsi
lea addresses_UC_ht+0x1a608, %rdi
clflush (%rdi)
nop
nop
nop
...
<gen_prepare_buffer>
{'src': {'type': 'addresses_D_ht', 'congruent': 8, 'same': False}, 'OP': 'REPM', 'dst': {'type': 'addresses_normal_ht', 'congruent': 11, 'same': False}}
...
{'src': {'type': 'addresses_A_ht', 'congruent': 2, 'same': False}, 'OP': 'REPM', 'dst': {'type': 'addresses_UC_ht', 'congruent': 11, 'same': False}}
{'33': 21829}
