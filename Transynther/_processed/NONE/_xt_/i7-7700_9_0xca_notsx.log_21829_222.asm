...
push %rdx
push %rsi
lea addresses_D_ht+0x1c591, %rsi
lea addresses_WT_ht+0x2971, %rdi
sub $27599, %r13
mov $127, %rcx
rep movsq
nop
lfence
lea addresses_D_ht+0x1a531, %rdi
nop
nop
nop
nop
...
vmovups %ymm4, (%rdi)
xor %r11, %r11
lea addresses_normal_ht+0x14571, %r13
nop
nop
nop
nop
...
vpextrq $0, %xmm0, %r11
add $7926, %rcx
lea addresses_normal_ht+0x130d, %rcx
nop
nop
sub $15713, %rdx
vmovups (%rcx), %ymm0
...
{'src': {'NT': False, 'AVXalign': False, 'size': 4, 'congruent': 7, 'same': False, 'type': 'addresses_A'}, 'OP': 'LOAD'}
[Faulty Load]
