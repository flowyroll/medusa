...
push %rdx
push %rsi
lea addresses_UC_ht+0x18b69, %r12
xor %rdx, %rdx
...
nop
add $26578, %r12
lea addresses_UC_ht+0x2921, %r12
nop
nop
nop
dec %rdi
...
nop
cmp %r8, %r8
lea addresses_WC_ht+0x13f69, %rsi
lea addresses_UC_ht+0x2469, %rdi
nop
nop
nop
nop
...
nop
sub $24920, %rax
lea addresses_UC_ht+0x15569, %rsi
...
nop
inc %r12
lea addresses_UC_ht+0xcc69, %rsi
lea addresses_WT_ht+0x1dfb9, %rdi
nop
add %r8, %r8
mov $12, %rcx
rep movsb
...
nop
sub $16334, %rcx
lea addresses_normal_ht+0x196e9, %rsi
...
nop
sub %rax, %rax
lea addresses_A_ht+0xa469, %rax
nop
nop
xor $30684, %rcx
movb $0x61, (%rax)
cmp $29654, %rcx
lea addresses_D_ht+0x12a9, %r8
nop
nop
nop
add $19253, %rax
...
nop
add $7353, %r8
lea addresses_D_ht+0x1d469, %rdx
add $6312, %r15
...
nop
add %rcx, %rcx
lea addresses_normal_ht+0x1ec69, %rsi
dec %r12
mov (%rsi), %dx
nop
nop
nop
sub $36125, %r15
lea addresses_WC_ht+0xbd09, %rdi
nop
nop
nop
dec %r12
...
vpextrq $1, %xmm6, %rdi
xor %r12, %r12
lea addresses_UC_ht+0x6859, %rdi
dec %r15
movups (%rdi), %xmm7
vpextrq $1, %xmm7, %rsi
nop
...
// Faulty Load
lea addresses_normal+0x13c69, %rdx
add %rsi, %rsi
vmovups (%rdx), %ymm2
...
{'src': {'type': 'addresses_WC_ht', 'congruent': 7, 'same': False}, 'dst': {'type': 'addresses_UC_ht', 'congruent': 6, 'same': False}, 'OP': 'REPM'}
