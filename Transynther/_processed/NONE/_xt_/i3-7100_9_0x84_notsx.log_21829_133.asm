...
push %rdi
push %rdx
lea addresses_UC_ht+0xaa4e, %rbx
nop
nop
nop
nop
...
nop
xor %r14, %r14
lea addresses_WC_ht+0x129b2, %rdi
nop
add %rbx, %rbx
movb $0x61, (%rdi)
cmp %rdi, %rdi
lea addresses_UC_ht+0x18921, %rdx
nop
nop
nop
nop
...
// REPMOV
lea addresses_PSE+0x1bff2, %rsi
lea addresses_WT+0x7456, %rdi
nop
nop
nop
nop
...
{'src': {'type': 'addresses_WT', 'same': False, 'size': 4, 'congruent': 6, 'NT': False, 'AVXalign': False}, 'OP': 'LOAD'}
{'src': {'type': 'addresses_PSE', 'congruent': 7, 'same': False}, 'dst': {'type': 'addresses_WT', 'congruent': 2, 'same': False}, 'OP': 'REPM'}
[Faulty Load]
