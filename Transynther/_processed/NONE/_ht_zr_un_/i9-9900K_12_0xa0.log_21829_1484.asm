...
push %rdi
push %rsi
lea addresses_WT_ht+0x144f2, %rbx
nop
nop
nop
nop
...
nop
sub %rdi, %rdi
lea addresses_WC_ht+0xd98c, %rsi
lea addresses_WT_ht+0x187b0, %rdi
nop
nop
nop
xor %rbp, %rbp
...
nop
inc %rbx
lea addresses_UC_ht+0x6e50, %rcx
nop
nop
xor $2724, %r12
mov (%rcx), %si
xor %r12, %r12
lea addresses_A_ht+0x158b0, %rdi
nop
nop
dec %r12
...
nop
dec %rdi
lea addresses_WC_ht+0x15bb0, %r13
nop
nop
nop
nop
...
nop
inc %rsi
lea addresses_WC_ht+0x1a60, %rsi
lea addresses_UC_ht+0x138b0, %rdi
xor $49480, %rbp
mov $82, %rcx
rep movsw
nop
nop
xor %rbx, %rbx
lea addresses_WT_ht+0x1a1a0, %rcx
clflush (%rcx)
nop
nop
nop
...
{'src': {'same': False, 'congruent': 2, 'type': 'addresses_WC_ht'}, 'OP': 'REPM', 'dst': {'same': False, 'congruent': 11, 'type': 'addresses_WT_ht'}}
{'src': {'NT': False, 'same': False, 'congruent': 4, 'type': 'addresses_UC_ht', 'AVXalign': False, 'size': 2}, 'OP': 'LOAD'}
{'OP': 'STOR', 'dst': {'NT': False, 'same': False, 'congruent': 8, 'type': 'addresses_A_ht', 'AVXalign': True, 'size': 16}}
...
{'90': 1, '48': 6, '61': 1, '8f': 1, '00': 21819, 'e9': 1}
