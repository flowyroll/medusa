...
push %rdi
push %rsi
lea addresses_WT_ht+0x4634, %rsi
lea addresses_WT_ht+0x13e34, %rdi
nop
nop
nop
mfence
...
nop
xor %rcx, %rcx
lea addresses_normal_ht+0x7424, %rsi
lea addresses_A_ht+0x3fb4, %rdi
cmp $3645, %rax
mov $63, %rcx
rep movsq
nop
...
nop
xor $37835, %rdi
lea addresses_normal_ht+0x1ce34, %r15
nop
cmp %r13, %r13
...
{'src': {'same': False, 'congruent': 1, 'type': 'addresses_normal_ht'}, 'OP': 'REPM', 'dst': {'same': True, 'congruent': 6, 'type': 'addresses_A_ht'}}
{'OP': 'STOR', 'dst': {'NT': False, 'same': False, 'congruent': 9, 'type': 'addresses_D_ht', 'AVXalign': True, 'size': 16}}
{'OP': 'STOR', 'dst': {'NT': False, 'same': False, 'congruent': 11, 'type': 'addresses_normal_ht', 'AVXalign': True, 'size': 32}}
{'44': 21829}
