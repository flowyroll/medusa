...
push %rdi
push %rsi
lea addresses_WT_ht+0xdc5e, %r10
clflush (%r10)
nop
nop
nop
...
movups %xmm0, (%rbp)
add $43299, %r12
lea addresses_WC_ht+0xe15e, %r10
nop
cmp $8803, %r9
movl $0x61626364, (%r10)
nop
...
nop
cmp $48234, %r10
lea addresses_A_ht+0x1ea5e, %rdi
clflush (%rdi)
nop
nop
nop
...
nop
and $22018, %r14
lea addresses_D_ht+0xca7e, %rsi
lea addresses_WC_ht+0x15026, %rdi
clflush (%rdi)
nop
inc %rbp
mov $45, %rcx
...
nop
dec %rax
lea addresses_UC_ht+0x1cd5e, %r14
nop
nop
nop
nop
...
{'src': {'same': False, 'congruent': 4, 'type': 'addresses_D_ht'}, 'OP': 'REPM', 'dst': {'same': False, 'congruent': 3, 'type': 'addresses_WC_ht'}}
