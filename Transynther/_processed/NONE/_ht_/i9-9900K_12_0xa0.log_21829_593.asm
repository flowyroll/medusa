...
nop
xor $31055, %r8
lea addresses_A_ht+0x154c7, %rsi
lea addresses_WC_ht+0xb6c7, %rdi
nop
nop
nop
nop
...
nop
and $55613, %r9
lea addresses_normal_ht+0xdd87, %rsi
lea addresses_WC_ht+0x42c7, %rdi
xor $9693, %r8
mov $30, %rcx
rep movsb
nop
...
// Store
lea addresses_normal+0xdfc7, %r15
sub $21507, %rbx
...
{'OP': 'STOR', 'dst': {'NT': False, 'same': False, 'congruent': 8, 'type': 'addresses_normal', 'AVXalign': True, 'size': 16}}
...
{'OP': 'STOR', 'dst': {'NT': False, 'same': True, 'congruent': 7, 'type': 'addresses_D_ht', 'AVXalign': False, 'size': 2}}
