...
push %rdi
push %rsi
lea addresses_WT_ht+0xfc7f, %rsi
lea addresses_UC_ht+0xe0f, %rdi
nop
nop
nop
and $11219, %r8
...
rep movsl
add %r9, %r9
lea addresses_WT_ht+0x188f, %rcx
clflush (%rcx)
and $27555, %r14
movl $0x61626364, (%rcx)
nop
...
nop
add $8428, %rcx
lea addresses_WC_ht+0x1ca0f, %rsi
...
nop
sub %r8, %r8
lea addresses_WT_ht+0x10c4f, %rsi
nop
nop
nop
nop
...
movb $0x61, (%rsi)
and $23060, %rcx
lea addresses_WC_ht+0x121cf, %rsi
nop
nop
nop
nop
...
nop
sub $1171, %rdi
lea addresses_normal_ht+0x1ec7b, %rsi
...
rep movsl
and %r12, %r12
lea addresses_WT_ht+0x6a4f, %rdi
nop
nop
nop
nop
...
nop
mfence
lea addresses_WC_ht+0x1008f, %r8
nop
nop
nop
lfence
...
nop
sub $55932, %r14
lea addresses_normal_ht+0x16d2e, %rcx
nop
nop
sub $6655, %rsi
mov (%rcx), %r11
...
nop
sub $51577, %rcx
lea addresses_A_ht+0x1c6df, %rsi
lea addresses_A_ht+0x1878f, %rdi
nop
nop
nop
xor %r8, %r8
...
{'OP': 'LOAD', 'src': {'size': 32, 'NT': False, 'type': 'addresses_RW', 'same': False, 'AVXalign': False, 'congruent': 9}}
...
<gen_prepare_buffer>
{'OP': 'REPM', 'src': {'same': False, 'type': 'addresses_WT_ht', 'congruent': 3}, 'dst': {'same': False, 'type': 'addresses_UC_ht', 'congruent': 6}}
...
{'OP': 'REPM', 'src': {'same': False, 'type': 'addresses_normal_ht', 'congruent': 2}, 'dst': {'same': True, 'type': 'addresses_D_ht', 'congruent': 2}}
...
{'OP': 'LOAD', 'src': {'size': 8, 'NT': False, 'type': 'addresses_normal_ht', 'same': False, 'AVXalign': True, 'congruent': 0}}
{'OP': 'STOR', 'dst': {'size': 32, 'NT': False, 'type': 'addresses_WT_ht', 'same': False, 'AVXalign': True, 'congruent': 10}}
{'OP': 'STOR', 'dst': {'size': 1, 'NT': False, 'type': 'addresses_D_ht', 'same': False, 'AVXalign': False, 'congruent': 5}}
{'OP': 'REPM', 'src': {'same': False, 'type': 'addresses_A_ht', 'congruent': 4}, 'dst': {'same': False, 'type': 'addresses_A_ht', 'congruent': 4}}
{'44': 21829}
