...
nop
and %r13, %r13
lea addresses_normal_ht+0xd063, %r13
clflush (%r13)
nop
and %rax, %rax
movl $0x61626364, (%r13)
...
nop
xor %rdx, %rdx
lea addresses_A_ht+0x13a63, %rsi
lea addresses_normal_ht+0xff3, %rdi
sub $8164, %r12
mov $48, %rcx
rep movsl
cmp $5549, %rdi
lea addresses_UC_ht+0x15273, %r12
nop
nop
nop
sub $14760, %r13
...
nop
and %rdi, %rdi
lea addresses_D_ht+0x152f3, %rdx
clflush (%rdx)
nop
nop
nop
...
{'OP': 'STOR', 'dst': {'size': 16, 'NT': True, 'type': 'addresses_WT', 'same': False, 'AVXalign': False, 'congruent': 8}}
{'OP': 'STOR', 'dst': {'size': 4, 'NT': False, 'type': 'addresses_RW', 'same': False, 'AVXalign': True, 'congruent': 0}}
[Faulty Load]
{'OP': 'LOAD', 'src': {'size': 32, 'NT': False, 'type': 'addresses_UC', 'same': True, 'AVXalign': False, 'congruent': 0}}
<gen_prepare_buffer>
{'OP': 'LOAD', 'src': {'size': 4, 'NT': False, 'type': 'addresses_WC_ht', 'same': True, 'AVXalign': False, 'congruent': 2}}
...
{'OP': 'REPM', 'src': {'same': False, 'type': 'addresses_A_ht', 'congruent': 3}, 'dst': {'same': False, 'type': 'addresses_normal_ht', 'congruent': 11}}
