...
push %rdx
push %rsi
lea addresses_normal_ht+0x384d, %rsi
lea addresses_WC_ht+0x10cef, %rdi
nop
nop
add %r10, %r10
mov $107, %rcx
...
nop
sub $55780, %rsi
lea addresses_WT_ht+0x4f0d, %r11
nop
sub %rdx, %rdx
...
nop
mfence
lea addresses_UC_ht+0x1858d, %rdx
nop
nop
nop
and %r10, %r10
movw $0x6162, (%rdx)
and %rbx, %rbx
lea addresses_WC_ht+0x1c4b1, %rcx
xor $19567, %rdi
mov $0x6162636465666768, %rbx
movq %rbx, %xmm5
vmovups %ymm5, (%rcx)
...
nop
and $64574, %rsi
lea addresses_WT_ht+0x1d29, %rbx
and %rdi, %rdi
mov (%rbx), %r11w
xor %rsi, %rsi
lea addresses_normal_ht+0x2a8d, %r10
nop
sub %r11, %r11
movw $0x6162, (%r10)
nop
nop
add $46681, %r10
lea addresses_WC_ht+0x868d, %r10
cmp $47966, %rdi
