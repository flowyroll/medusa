...
push %rdx
push %rsi
lea addresses_D_ht+0xc468, %rsi
lea addresses_normal_ht+0xaf5c, %rdi
cmp %r10, %r10
mov $117, %rcx
rep movsl
nop
dec %r9
lea addresses_WC_ht+0x1aa5c, %r11
nop
inc %r10
mov (%r11), %cx
nop
cmp %rsi, %rsi
lea addresses_normal_ht+0x9338, %rsi
lea addresses_UC_ht+0x6834, %rdi
nop
nop
nop
nop
...
nop
inc %rdx
lea addresses_A_ht+0x1ce5c, %rsi
lea addresses_WT_ht+0x199c, %rdi
nop
nop
nop
nop
...
nop
dec %rcx
lea addresses_D_ht+0x1529c, %r15
nop
nop
nop
nop
...
nop
inc %r15
lea addresses_normal_ht+0x1495c, %rsi
lea addresses_normal_ht+0x1145c, %rdi
cmp $5709, %r15
mov $45, %rcx
rep movsb
nop
...
{'OP': 'STOR', 'dst': {'NT': False, 'same': True, 'congruent': 3, 'type': 'addresses_A', 'AVXalign': False, 'size': 16}}
{'OP': 'STOR', 'dst': {'NT': False, 'same': False, 'congruent': 3, 'type': 'addresses_RW', 'AVXalign': False, 'size': 8}}
[Faulty Load]
...
{'src': {'same': False, 'congruent': 9, 'type': 'addresses_A_ht'}, 'OP': 'REPM', 'dst': {'same': False, 'congruent': 6, 'type': 'addresses_WT_ht'}}
{'src': {'NT': False, 'same': True, 'congruent': 6, 'type': 'addresses_D_ht', 'AVXalign': False, 'size': 2}, 'OP': 'LOAD'}
{'src': {'same': False, 'congruent': 4, 'type': 'addresses_normal_ht'}, 'OP': 'REPM', 'dst': {'same': False, 'congruent': 6, 'type': 'addresses_normal_ht'}}
{'44': 21829}
