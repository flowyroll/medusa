...
push %rdi
push %rsi
lea addresses_normal_ht+0x3466, %rsi
lea addresses_D_ht+0x1eca, %rdi
nop
sub $46992, %r14
mov $3, %rcx
rep movsq
nop
and $45516, %r13
lea addresses_WC_ht+0x15251, %r8
nop
xor %r14, %r14
...
nop
and %rdi, %rdi
lea addresses_A_ht+0x14991, %r13
cmp $56463, %rbp
...
nop
and $23756, %rbp
lea addresses_UC_ht+0xca51, %rdi
nop
add $11602, %r13
movb (%rdi), %cl
nop
...
nop
cmp %rdi, %rdi
lea addresses_UC_ht+0x72e3, %rbp
nop
nop
nop
nop
