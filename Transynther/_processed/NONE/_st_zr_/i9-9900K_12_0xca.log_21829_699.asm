...
nop
cmp $63860, %r8
lea addresses_normal_ht+0x197c1, %rsi
lea addresses_UC_ht+0x72a9, %rdi
inc %r12
mov $83, %rcx
rep movsw
add %r15, %r15
lea addresses_WC_ht+0x14629, %r15
nop
nop
nop
nop
...
nop
dec %rcx
lea addresses_WT_ht+0x18f29, %r13
nop
nop
nop
nop
...
nop
xor $14391, %r15
lea addresses_normal_ht+0x15e29, %rsi
nop
nop
nop
nop
...
nop
add $28758, %rcx
lea addresses_normal_ht+0x1729, %r12
nop
nop
add $24229, %rdi
vmovups (%r12), %ymm3
...
nop
dec %rcx
lea addresses_normal_ht+0x1c5e9, %rbp
clflush (%rbp)
nop
nop
nop
...
// Store
lea addresses_normal+0x10029, %r15
nop
nop
nop
nop
...
{'OP': 'STOR', 'dst': {'size': 2, 'NT': False, 'type': 'addresses_WC', 'same': False, 'AVXalign': False, 'congruent': 2}}
