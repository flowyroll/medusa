...
lea addresses_normal_ht+0x10e3c, %rdi
nop
nop
nop
nop
...
nop
and %r15, %r15
lea addresses_WC_ht+0x1cc65, %rsi
lea addresses_D_ht+0x1bc54, %rdi
nop
nop
nop
nop
...
nop
and %r11, %r11
lea addresses_A_ht+0x9154, %rsi
lea addresses_D_ht+0x5854, %rdi
nop
nop
nop
nop
...
nop
xor %r11, %r11
lea addresses_UC_ht+0x5224, %rcx
nop
nop
xor %r15, %r15
mov (%rcx), %rax
...
nop
xor %rax, %rax
lea addresses_WC_ht+0x11454, %r15
clflush (%r15)
nop
inc %rcx
movl $0x61626364, (%r15)
