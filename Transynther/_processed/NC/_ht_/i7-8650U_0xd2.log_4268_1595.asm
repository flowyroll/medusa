...
push %rdi
push %rsi
lea addresses_UC_ht+0x6bba, %r15
nop
nop
nop
nop
...
nop
sub $16626, %r14
lea addresses_WC_ht+0xa7ba, %rbp
nop
nop
nop
nop
...
nop
inc %r14
lea addresses_WC_ht+0x1847a, %rbp
clflush (%rbp)
add $51171, %r15
mov (%rbp), %r10
xor %r8, %r8
lea addresses_A_ht+0x153ba, %r14
nop
nop
nop
xor $15311, %rbp
...
nop
cmp $57069, %rbp
lea addresses_D_ht+0xd13a, %rsi
lea addresses_A_ht+0x47ba, %rdi
nop
xor %r8, %r8
mov $115, %rcx
rep movsw
and %rcx, %rcx
lea addresses_D_ht+0x9a3a, %rcx
nop
nop
nop
nop
...
nop
add $57590, %r10
lea addresses_WT_ht+0x6d3a, %r13
nop
nop
nop
dec %r14
