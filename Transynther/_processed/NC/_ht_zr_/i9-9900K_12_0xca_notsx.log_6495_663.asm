...
push %rax
push %rdi
lea addresses_A_ht+0x17534, %r11
nop
nop
nop
dec %rax
...
nop
inc %r8
lea addresses_UC_ht+0x19b34, %r8
nop
nop
nop
nop
...
nop
add $21053, %r9
lea addresses_WT_ht+0x15f1c, %r9
nop
nop
nop
nop
...
nop
and $20498, %r15
lea addresses_UC_ht+0x3f20, %rax
nop
nop
nop
nop
