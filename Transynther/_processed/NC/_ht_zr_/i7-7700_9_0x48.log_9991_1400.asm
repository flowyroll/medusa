...
push %rdi
push %rsi
lea addresses_A_ht+0xdbe5, %rsi
lea addresses_A_ht+0x180c1, %rdi
nop
nop
nop
add %r9, %r9
...
nop
xor $44720, %rdi
lea addresses_WT_ht+0xc701, %rsi
lea addresses_A_ht+0x15191, %rdi
clflush (%rdi)
cmp $24994, %rax
mov $55, %rcx
rep movsb
...
{'OP': 'LOAD', 'src': {'type': 'addresses_WT', 'AVXalign': False, 'congruent': 4, 'size': 8, 'same': False, 'NT': False}}
...
{'OP': 'LOAD', 'src': {'type': 'addresses_A_ht', 'AVXalign': False, 'congruent': 4, 'size': 1, 'same': False, 'NT': True}}
{'49': 3, '00': 9988}
