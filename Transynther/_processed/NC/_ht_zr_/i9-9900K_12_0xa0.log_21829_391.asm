...
push %rdx
push %rsi
lea addresses_A_ht+0x3d53, %rsi
lea addresses_A_ht+0xf0a3, %rdi
nop
nop
nop
nop
...
nop
and %rdi, %rdi
lea addresses_WC_ht+0xd539, %r11
nop
nop
nop
cmp %rcx, %rcx
...
nop
dec %r11
lea addresses_UC_ht+0x68ea, %rdx
nop
nop
dec %r11
mov (%rdx), %edi
sub %r11, %r11
lea addresses_UC_ht+0x19813, %rsi
lea addresses_normal_ht+0xdda3, %rdi
nop
add $44607, %r8
mov $98, %rcx
rep movsl
...
nop
cmp $58521, %rcx
lea addresses_D_ht+0x16593, %rdx
nop
nop
nop
nop
...
nop
dec %r8
lea addresses_normal_ht+0x164d3, %rsi
lea addresses_WC_ht+0x170d3, %rdi
nop
nop
and %r15, %r15
mov $47, %rcx
...
nop
inc %r15
lea addresses_normal_ht+0x8413, %r15
nop
nop
nop
nop
...
nop
and %rdx, %rdx
lea addresses_normal_ht+0x1324d, %rsi
nop
nop
and %rcx, %rcx
mov (%rsi), %r15
...
nop
sub %rcx, %rcx
lea addresses_D_ht+0xc8d3, %rsi
lea addresses_WC_ht+0x16651, %rdi
nop
nop
nop
nop
...
nop
sub $13492, %rdx
lea addresses_A_ht+0x15c7b, %rax
nop
nop
nop
dec %rcx
...
nop
cmp $62450, %rax
lea addresses_WC_ht+0x1bd0b, %rsi
nop
nop
nop
nop
...
nop
and %r8, %r8
lea addresses_UC_ht+0xa20b, %rcx
nop
and %rdi, %rdi
movl $0x61626364, (%rcx)
nop
nop
cmp %r11, %r11
lea addresses_UC_ht+0xc0d3, %rax
add $35727, %r11
movl $0x61626364, (%rax)
nop
nop
...
{'OP': 'STOR', 'dst': {'NT': False, 'same': False, 'congruent': 8, 'type': 'addresses_D', 'AVXalign': False, 'size': 1}}
...
{'src': {'same': False, 'congruent': 6, 'type': 'addresses_UC_ht'}, 'OP': 'REPM', 'dst': {'same': False, 'congruent': 3, 'type': 'addresses_normal_ht'}}
{'src': {'NT': False, 'same': False, 'congruent': 6, 'type': 'addresses_D_ht', 'AVXalign': False, 'size': 32}, 'OP': 'LOAD'}
{'src': {'same': False, 'congruent': 10, 'type': 'addresses_normal_ht'}, 'OP': 'REPM', 'dst': {'same': True, 'congruent': 7, 'type': 'addresses_WC_ht'}}
...
{'src': {'same': False, 'congruent': 11, 'type': 'addresses_D_ht'}, 'OP': 'REPM', 'dst': {'same': False, 'congruent': 1, 'type': 'addresses_WC_ht'}}
