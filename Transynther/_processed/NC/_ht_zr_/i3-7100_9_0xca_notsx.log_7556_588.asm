...
push %rdx
push %rsi
lea addresses_WC_ht+0x18857, %r10
nop
nop
nop
nop
...
nop
add %rsi, %rsi
lea addresses_UC_ht+0xef57, %r14
nop
nop
nop
nop
...
vpextrq $0, %xmm3, %rcx
inc %rsi
lea addresses_WT_ht+0x17f97, %r14
clflush (%r14)
xor $34015, %rbx
mov (%r14), %dx
nop
...
nop
cmp $8104, %r14
lea addresses_WT_ht+0x7697, %r10
nop
nop
nop
inc %r13
...
nop
dec %rcx
lea addresses_A_ht+0x1d2a7, %rsi
lea addresses_WT_ht+0x6cff, %rdi
nop
nop
nop
sub $44728, %r10
...
nop
add %r10, %r10
lea addresses_UC_ht+0x682d, %rdx
nop
nop
dec %r14
movw $0x6162, (%rdx)
nop
dec %rbx
lea addresses_WC_ht+0x13257, %rcx
nop
xor $13930, %rdx
mov (%rcx), %r10d
xor $59208, %r10
lea addresses_normal_ht+0x1c457, %r10
nop
nop
nop
nop
...
nop
sub %r13, %r13
lea addresses_WC_ht+0x132de, %rcx
nop
nop
xor $5193, %rsi
movl $0x61626364, (%rcx)
