...
push %rdx
push %rsi
lea addresses_A_ht+0x84a8, %rsi
lea addresses_D_ht+0xd37e, %rdi
nop
nop
nop
nop
...
nop
xor $56409, %r12
lea addresses_normal_ht+0x159be, %rbx
nop
add $50343, %rdx
...
vmovntdq %ymm7, (%rbx)
sub %rdi, %rdi
lea addresses_A_ht+0xb17e, %rsi
lea addresses_A_ht+0x17e7e, %rdi
inc %r9
mov $13, %rcx
rep movsb
and %rbx, %rbx
lea addresses_UC_ht+0xbd7e, %rsi
lea addresses_WT_ht+0x1b97e, %rdi
nop
nop
nop
nop
...
nop
and %r13, %r13
lea addresses_WC_ht+0x4405, %rsi
lea addresses_UC_ht+0x1c97e, %rdi
nop
nop
nop
and $64036, %r13
...
nop
dec %rsi
lea addresses_WC_ht+0x450e, %rbx
nop
nop
nop
inc %rcx
mov (%rbx), %r13
cmp %r9, %r9
lea addresses_WC_ht+0xd77e, %rsi
lea addresses_D_ht+0xe17e, %rdi
and $22295, %r12
mov $123, %rcx
rep movsw
xor $49302, %rdi
...
<gen_prepare_buffer>
{'OP': 'REPM', 'src': {'type': 'addresses_A_ht', 'congruent': 0, 'same': False}, 'dst': {'type': 'addresses_D_ht', 'congruent': 9, 'same': False}}
...
{'OP': 'REPM', 'src': {'type': 'addresses_WC_ht', 'congruent': 0, 'same': False}, 'dst': {'type': 'addresses_UC_ht', 'congruent': 10, 'same': False}}
