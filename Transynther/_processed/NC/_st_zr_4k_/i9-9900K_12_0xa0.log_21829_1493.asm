...
push %rdi
push %rsi
lea addresses_D_ht+0x8865, %rsi
lea addresses_UC_ht+0x15f65, %rdi
nop
nop
and %r11, %r11
mov $38, %rcx
rep movsl
inc %r15
lea addresses_UC_ht+0xf065, %rsi
lea addresses_normal_ht+0x12ee3, %rdi
nop
nop
dec %r12
mov $27, %rcx
...
nop
sub %rcx, %rcx
lea addresses_D_ht+0xd265, %r12
xor $7920, %r15
mov $0x6162636465666768, %rdi
movq %rdi, %xmm1
movups %xmm1, (%r12)
sub $32052, %r11
lea addresses_A_ht+0x1e865, %r12
clflush (%r12)
nop
nop
nop
...
// Store
lea addresses_normal+0x15865, %r11
nop
nop
and $61262, %rbp
movl $0x51525354, (%r11)
...
{'src': {'NT': False, 'same': False, 'congruent': 10, 'type': 'addresses_PSE', 'AVXalign': True, 'size': 16}, 'OP': 'LOAD'}
...
<gen_prepare_buffer>
{'src': {'same': False, 'congruent': 11, 'type': 'addresses_D_ht'}, 'OP': 'REPM', 'dst': {'same': False, 'congruent': 8, 'type': 'addresses_UC_ht'}}
