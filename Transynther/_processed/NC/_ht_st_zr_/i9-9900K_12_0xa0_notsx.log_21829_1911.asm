...
nop
sub %r11, %r11
lea addresses_D_ht+0x148b0, %rsi
lea addresses_UC_ht+0x4498, %rdi
xor %r13, %r13
mov $15, %rcx
rep movsl
nop
...
// Load
lea addresses_normal+0x158b8, %rdi
clflush (%rdi)
nop
cmp %r13, %r13
mov (%rdi), %r14d
...
{'src': {'type': 'addresses_normal', 'AVXalign': False, 'size': 4, 'NT': True, 'same': False, 'congruent': 7}, 'OP': 'LOAD'}
