...
push %rdx
push %rsi
lea addresses_WC_ht+0x1ca2a, %r14
nop
nop
nop
add %rdx, %rdx
...
nop
xor %r11, %r11
lea addresses_D_ht+0x382a, %rsi
lea addresses_UC_ht+0x2e2a, %rdi
dec %rbp
mov $117, %rcx
rep movsq
nop
...
// Store
lea addresses_normal+0x141fa, %rax
inc %rbp
movb $0x51, (%rax)
nop
and %r13, %r13
...
// Load
lea addresses_normal+0x5dda, %rdx
nop
nop
dec %rcx
movups (%rdx), %xmm0
...
{'src': {'type': 'addresses_D_ht', 'congruent': 11, 'same': True}, 'dst': {'type': 'addresses_UC_ht', 'congruent': 8, 'same': True}, 'OP': 'REPM'}
{'00': 32, '58': 21796, '50': 1}
