...
nop
and %rcx, %rcx
lea addresses_WT_ht+0x14dbb, %rsi
lea addresses_WT_ht+0xe79b, %rdi
nop
nop
cmp %r10, %r10
mov $32, %rcx
...
nop
xor $6503, %rbx
lea addresses_WC_ht+0x1ac3b, %rsi
lea addresses_normal_ht+0xea3b, %rdi
clflush (%rsi)
clflush (%rdi)
nop
nop
...
nop
cmp $5911, %rcx
lea addresses_D_ht+0xddbb, %rsi
lea addresses_A_ht+0x19e1b, %rdi
nop
add %rax, %rax
mov $24, %rcx
rep movsw
...
nop
lfence
lea addresses_WT_ht+0x14f7b, %rsi
lea addresses_WT_ht+0x24fb, %rdi
nop
nop
xor $50877, %rdx
mov $119, %rcx
rep movsq
xor $63530, %rax
lea addresses_UC_ht+0xecee, %rsi
nop
cmp $50296, %rdx
movups (%rsi), %xmm7
vpextrq $0, %xmm7, %r9
and $4422, %rcx
lea addresses_D_ht+0x159bb, %rsi
lea addresses_WT_ht+0x19fbb, %rdi
xor $22156, %rax
mov $5, %rcx
rep movsw
nop
...
nop
sub $41664, %rcx
lea addresses_A_ht+0x421b, %rsi
lea addresses_D_ht+0x10c3b, %rdi
nop
nop
nop
nop
...
nop
xor %rax, %rax
lea addresses_A_ht+0xf5bb, %rsi
lea addresses_normal_ht+0x1cdbb, %rdi
nop
nop
xor $3570, %r10
mov $26, %rcx
...
nop
cmp %rsi, %rsi
lea addresses_normal_ht+0x1469b, %rdi
clflush (%rdi)
nop
nop
nop
...
nop
sub %r10, %r10
lea addresses_A_ht+0x15f1b, %rsi
lea addresses_WT_ht+0x179bb, %rdi
nop
nop
nop
and $29365, %rax
...
{'OP': 'STOR', 'dst': {'size': 32, 'NT': True, 'type': 'addresses_WC', 'same': False, 'AVXalign': False, 'congruent': 6}}
...
{'OP': 'REPM', 'src': {'same': False, 'type': 'addresses_WT_ht', 'congruent': 11}, 'dst': {'same': False, 'type': 'addresses_WT_ht', 'congruent': 2}}
{'OP': 'STOR', 'dst': {'size': 8, 'NT': True, 'type': 'addresses_A_ht', 'same': False, 'AVXalign': False, 'congruent': 0}}
{'OP': 'REPM', 'src': {'same': False, 'type': 'addresses_WC_ht', 'congruent': 6}, 'dst': {'same': False, 'type': 'addresses_normal_ht', 'congruent': 7}}
{'OP': 'REPM', 'src': {'same': False, 'type': 'addresses_D_ht', 'congruent': 11}, 'dst': {'same': True, 'type': 'addresses_A_ht', 'congruent': 5}}
...
{'OP': 'REPM', 'src': {'same': False, 'type': 'addresses_D_ht', 'congruent': 10}, 'dst': {'same': False, 'type': 'addresses_WT_ht', 'congruent': 8}}
{'OP': 'REPM', 'src': {'same': False, 'type': 'addresses_A_ht', 'congruent': 5}, 'dst': {'same': False, 'type': 'addresses_D_ht', 'congruent': 6}}
...
{'OP': 'REPM', 'src': {'same': False, 'type': 'addresses_A_ht', 'congruent': 5}, 'dst': {'same': False, 'type': 'addresses_WT_ht', 'congruent': 10}}
{'b0': 66, '00': 171, '58': 21592}
