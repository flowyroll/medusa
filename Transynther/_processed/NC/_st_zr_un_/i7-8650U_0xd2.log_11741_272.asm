...
push %rdi
push %rsi
lea addresses_UC_ht+0x13aaa, %r14
nop
nop
nop
nop
...
nop
sub %r15, %r15
lea addresses_D_ht+0x542a, %rsi
lea addresses_A_ht+0x1682a, %rdi
add %rbx, %rbx
mov $100, %rcx
rep movsl
nop
...
nop
and $48521, %r15
lea addresses_WC_ht+0x565e, %rcx
nop
nop
nop
sub $15912, %rbx
...
nop
inc %rcx
lea addresses_WC_ht+0xbc9a, %rcx
nop
xor $44015, %rbx
mov (%rcx), %r11
and $9638, %rsi
lea addresses_WC_ht+0x942a, %r11
nop
and $32385, %rcx
mov (%r11), %r15d
nop
