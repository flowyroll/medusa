...
push %rdi
push %rsi
lea addresses_UC_ht+0x7791, %rsi
lea addresses_WC_ht+0x12751, %rdi
nop
nop
nop
nop
...
nop
and %r9, %r9
lea addresses_WC_ht+0x187d1, %r8
clflush (%r8)
nop
nop
nop
...
nop
add %r8, %r8
lea addresses_WC_ht+0x14951, %r8
nop
nop
nop
nop
...
nop
cmp %r9, %r9
lea addresses_normal_ht+0xa471, %rdi
nop
nop
nop
and %r8, %r8
...
<gen_prepare_buffer>
{'src': {'type': 'addresses_UC_ht', 'congruent': 5, 'same': False}, 'dst': {'type': 'addresses_WC_ht', 'congruent': 8, 'same': False}, 'OP': 'REPM'}
...
{'04': 1, '21': 1, '44': 5, '00': 21819, '08': 2, '40': 1}
