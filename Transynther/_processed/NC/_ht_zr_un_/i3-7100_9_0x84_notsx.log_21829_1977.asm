...
push %rdx
push %rsi
lea addresses_WC_ht+0xadb1, %r14
nop
nop
nop
nop
...
nop
add %rbx, %rbx
lea addresses_normal_ht+0x14301, %r14
nop
xor %r8, %r8
movups (%r14), %xmm0
vpextrq $1, %xmm0, %r10
...
nop
and %rdx, %rdx
lea addresses_UC_ht+0x18409, %r14
nop
nop
nop
sub %r10, %r10
...
nop
xor %r12, %r12
lea addresses_UC_ht+0xe889, %rsi
lea addresses_normal_ht+0x7851, %rdi
nop
nop
sub %r10, %r10
mov $109, %rcx
...
nop
cmp $64754, %rbx
lea addresses_normal_ht+0xfb09, %rsi
lea addresses_A_ht+0x10499, %rdi
clflush (%rdi)
nop
nop
nop
...
nop
and %rbx, %rbx
lea addresses_normal_ht+0x1839, %rdi
nop
nop
nop
nop
...
nop
and $4122, %rdi
lea addresses_UC_ht+0x1b609, %rsi
lea addresses_UC_ht+0x18f09, %rdi
nop
nop
nop
nop
...
nop
dec %rdx
lea addresses_A_ht+0x1b318, %rsi
lea addresses_normal_ht+0x3c09, %rdi
nop
nop
nop
nop
...
nop
sub $54464, %rsi
lea addresses_D_ht+0x1a29, %rsi
lea addresses_D_ht+0x9639, %rdi
nop
nop
nop
nop
...
rep movsb
inc %rdx
lea addresses_D_ht+0x1ec09, %rbx
nop
nop
nop
cmp $38471, %rdx
...
nop
inc %rdi
lea addresses_D_ht+0x1cc09, %rdx
cmp %rbx, %rbx
movb $0x61, (%rdx)
inc %rdx
lea addresses_WC_ht+0x7f6, %rsi
lea addresses_D_ht+0x1ae79, %rdi
clflush (%rdi)
nop
add $28348, %r14
mov $41, %rcx
...
{'src': {'type': 'addresses_UC_ht', 'congruent': 6, 'same': False}, 'dst': {'type': 'addresses_normal_ht', 'congruent': 0, 'same': False}, 'OP': 'REPM'}
...
{'src': {'type': 'addresses_UC_ht', 'congruent': 9, 'same': False}, 'dst': {'type': 'addresses_UC_ht', 'congruent': 8, 'same': False}, 'OP': 'REPM'}
