...
nop
cmp $57951, %r15
lea addresses_WC_ht+0xaf9a, %rbx
and %r9, %r9
movups (%rbx), %xmm3
vpextrq $0, %xmm3, %r8
nop
...
// Store
lea addresses_normal+0x1ea9a, %rbx
nop
nop
nop
nop
