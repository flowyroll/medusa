...
nop
xor $37147, %rax
lea addresses_A_ht+0x17053, %rcx
nop
nop
nop
dec %rbp
...
nop
inc %rsi
lea addresses_normal_ht+0x6b42, %r13
nop
nop
nop
nop
...
nop
xor $1881, %rax
lea addresses_UC_ht+0x18653, %rsi
lea addresses_WT_ht+0x14053, %rdi
nop
cmp $27407, %rbx
mov $59, %rcx
rep movsq
...
nop
cmp $3270, %rcx
lea addresses_WC_ht+0x1e53, %rax
nop
nop
nop
nop
...
nop
mfence
lea addresses_WC_ht+0x1808b, %rsi
lea addresses_D_ht+0x25, %rdi
nop
nop
sub $49353, %rbp
mov $125, %rcx
...
// Store
lea addresses_normal+0x18b53, %rax
nop
and %r10, %r10
movb $0x51, (%rax)
nop
...
{'OP': 'LOAD', 'src': {'type': 'addresses_RW', 'AVXalign': True, 'congruent': 10, 'size': 16, 'same': False, 'NT': False}}
...
{'OP': 'REPM', 'src': {'type': 'addresses_WC_ht', 'congruent': 3, 'same': False}, 'dst': {'type': 'addresses_D_ht', 'congruent': 1, 'same': False}}
{'58': 1, '00': 21828}
