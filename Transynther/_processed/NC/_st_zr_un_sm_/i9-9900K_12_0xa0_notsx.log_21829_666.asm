...
movq %r14, (%r13)
add %r8, %r8
lea addresses_WC_ht+0x38c6, %rsi
nop
cmp $43151, %r14
...
nop
and $36192, %rsi
lea addresses_A_ht+0xa0ce, %rsi
nop
nop
add %rbx, %rbx
movl $0x61626364, (%rsi)
sub $20540, %rdi
lea addresses_A_ht+0x14d4e, %r13
nop
nop
nop
and %rsi, %rsi
...
{'src': {'type': 'addresses_UC', 'AVXalign': False, 'size': 2, 'NT': False, 'same': False, 'congruent': 10}, 'OP': 'LOAD'}
{'OP': 'STOR', 'dst': {'type': 'addresses_NC', 'AVXalign': False, 'size': 4, 'NT': True, 'same': True, 'congruent': 0}}
[Faulty Load]
