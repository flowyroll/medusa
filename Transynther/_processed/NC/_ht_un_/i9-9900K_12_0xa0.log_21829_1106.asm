...
push %rdi
push %rsi
lea addresses_UC_ht+0x1751b, %rbp
nop
nop
cmp $10204, %r12
movb $0x61, (%rbp)
...
nop
xor %r14, %r14
lea addresses_A_ht+0x17903, %rsi
lea addresses_A_ht+0x1d635, %rdi
sub $59295, %rax
mov $67, %rcx
rep movsl
nop
...
nop
and $40745, %rax
lea addresses_UC_ht+0x1ac47, %rax
add %r12, %r12
movb (%rax), %r14b
nop
nop
nop
cmp %r12, %r12
lea addresses_A_ht+0x122b3, %rax
and $34904, %rsi
vmovups (%rax), %ymm5
...
nop
and $26000, %r14
lea addresses_WT_ht+0x5cb3, %rsi
nop
nop
sub %rbp, %rbp
mov (%rsi), %rcx
nop
add $58595, %r14
lea addresses_normal_ht+0x100b3, %rsi
nop
and %rcx, %rcx
movb (%rsi), %r12b
nop
...
nop
add $50319, %r14
lea addresses_normal_ht+0xc679, %r14
nop
nop
nop
xor %rbp, %rbp
...
{'src': {'NT': False, 'same': True, 'congruent': 11, 'type': 'addresses_A_ht', 'AVXalign': False, 'size': 4}, 'OP': 'LOAD'}
