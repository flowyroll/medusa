...
push %rbp
push %rcx
lea addresses_normal_ht+0xd9e2, %rcx
nop
sub $53260, %r12
vmovups (%rcx), %ymm7
...
vpextrq $0, %xmm7, %r13
sub $59798, %r9
lea addresses_UC_ht+0x14348, %r12
xor $55698, %r8
movw $0x6162, (%r12)
nop
nop
...
// REPMOV
lea addresses_WT+0x4692, %rsi
lea addresses_WC+0xa142, %rdi
nop
nop
nop
nop
...
{'src': {'type': 'addresses_WT', 'congruent': 2, 'same': False}, 'dst': {'type': 'addresses_WC', 'congruent': 4, 'same': False}, 'OP': 'REPM'}
...
{'dst': {'type': 'addresses_US', 'same': False, 'size': 1, 'congruent': 10, 'NT': True, 'AVXalign': False}, 'OP': 'STOR'}
[Faulty Load]
