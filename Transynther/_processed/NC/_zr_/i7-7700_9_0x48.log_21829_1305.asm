...
nop
xor $57922, %rbp
lea addresses_WC_ht+0x138de, %rbp
nop
nop
sub $11716, %r10
mov (%rbp), %r8w
nop
xor $59683, %rdi
lea addresses_normal_ht+0x17ece, %r10
nop
nop
nop
and $70, %r9
...
nop
dec %rdx
lea addresses_WC_ht+0xf0ce, %rdx
nop
nop
nop
nop
...
nop
add %r9, %r9
lea addresses_A_ht+0x13bb4, %rdi
clflush (%rdi)
xor $14652, %r9
vmovups (%rdi), %ymm4
...
nop
inc %r11
lea addresses_UC_ht+0x973a, %rsi
lea addresses_A_ht+0xdece, %rdi
nop
cmp %r8, %r8
mov $90, %rcx
rep movsq
nop
and $22310, %rsi
lea addresses_D_ht+0x162ce, %rbp
nop
nop
sub $35455, %r9
movups (%rbp), %xmm7
...
nop
sub $25757, %rdi
lea addresses_WT_ht+0x10cce, %rsi
lea addresses_normal_ht+0xa2ce, %rdi
nop
add %r10, %r10
mov $9, %rcx
rep movsb
...
nop
xor %r8, %r8
lea addresses_WT_ht+0x136ce, %r8
nop
nop
and %rdx, %rdx
...
nop
and $19662, %rdi
lea addresses_WC_ht+0x16ce, %rdi
nop
and $15706, %rsi
movb (%rdi), %r9b
nop
...
{'OP': 'REPM', 'src': {'type': 'addresses_UC_ht', 'congruent': 2, 'same': True}, 'dst': {'type': 'addresses_A_ht', 'congruent': 10, 'same': False}}
{'OP': 'LOAD', 'src': {'type': 'addresses_D_ht', 'AVXalign': False, 'congruent': 10, 'size': 16, 'same': False, 'NT': False}}
{'OP': 'REPM', 'src': {'type': 'addresses_WT_ht', 'congruent': 9, 'same': True}, 'dst': {'type': 'addresses_normal_ht', 'congruent': 8, 'same': False}}
