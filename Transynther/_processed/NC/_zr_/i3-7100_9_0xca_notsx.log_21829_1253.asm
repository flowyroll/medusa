...
push %rdi
push %rsi
lea addresses_D_ht+0xfab1, %rsi
lea addresses_A_ht+0xfa71, %rdi
nop
nop
nop
and %r12, %r12
...
lea addresses_A_ht+0x13eb1, %rdi
clflush (%rsi)
nop
nop
and %rax, %rax
...
rep movsb
xor $8992, %rsi
lea addresses_UC_ht+0x137b1, %r11
nop
nop
add $24441, %rbx
...
nop
cmp %rax, %rax
lea addresses_D_ht+0x18eb1, %rax
nop
nop
nop
nop
...
vmovntdq %ymm2, (%rcx)
xor %r12, %r12
lea addresses_WT_ht+0x1b1f9, %rdi
nop
nop
nop
nop
