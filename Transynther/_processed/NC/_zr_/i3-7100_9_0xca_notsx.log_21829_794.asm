...
lea addresses_UC_ht+0xc59a, %rdi
inc %r8
mov $49, %rcx
rep movsb
nop
nop
sub $11469, %r14
lea addresses_normal_ht+0x1396e, %rsi
lea addresses_A_ht+0x1142e, %rdi
nop
nop
cmp %r13, %r13
mov $38, %rcx
...
vpextrq $1, %xmm6, %rsi
cmp $62855, %r13
lea addresses_WC_ht+0xa36e, %rcx
nop
dec %rbp
movb (%rcx), %r14b
nop
nop
dec %rsi
lea addresses_normal_ht+0x871e, %r13
and $35527, %rbp
mov (%r13), %edi
nop
nop
...
nop
add $53288, %r13
lea addresses_UC_ht+0xda5e, %rcx
nop
nop
nop
nop
...
{'src': {'type': 'addresses_A_ht', 'congruent': 1, 'same': True}, 'OP': 'REPM', 'dst': {'type': 'addresses_UC_ht', 'congruent': 2, 'same': False}}
