...
push %rdi
push %rsi
lea addresses_UC_ht+0x12de8, %r9
and %r12, %r12
movw $0x6162, (%r9)
dec %r8
lea addresses_WT_ht+0x89e8, %r9
nop
nop
nop
nop
...
nop
xor %r10, %r10
lea addresses_A_ht+0x27e8, %rsi
lea addresses_WT_ht+0x31e8, %rdi
nop
nop
nop
nop
...
nop
and %rsi, %rsi
lea addresses_A_ht+0x16ce8, %rsi
lea addresses_WC_ht+0x69e8, %rdi
nop
nop
nop
and %r10, %r10
...
nop
xor %r14, %r14
lea addresses_WT_ht+0x1d6a8, %rsi
lea addresses_normal_ht+0x1d1e8, %rdi
nop
nop
nop
add %r10, %r10
...
rep movsb
sub %r10, %r10
lea addresses_UC_ht+0x1b1e8, %rsi
lea addresses_WT_ht+0xc3d8, %rdi
nop
nop
xor $47892, %r14
mov $64, %rcx
...
// Store
lea addresses_normal+0x165e8, %r12
nop
cmp $15605, %r15
movw $0x5152, (%r12)
nop
...
{'OP': 'LOAD', 'src': {'size': 4, 'NT': False, 'type': 'addresses_UC', 'same': True, 'AVXalign': False, 'congruent': 8}}
...
{'OP': 'REPM', 'src': {'same': False, 'type': 'addresses_A_ht', 'congruent': 9}, 'dst': {'same': False, 'type': 'addresses_WT_ht', 'congruent': 11}}
