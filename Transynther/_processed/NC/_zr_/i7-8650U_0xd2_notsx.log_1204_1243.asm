...
push %rdx
push %rsi
lea addresses_UC_ht+0x1cf84, %rbx
nop
inc %r10
movb $0x61, (%rbx)
nop
nop
xor $63714, %rdx
lea addresses_D_ht+0x19b1c, %rsi
lea addresses_D_ht+0x3c84, %rdi
nop
nop
nop
nop
...
nop
cmp %rdi, %rdi
lea addresses_WT_ht+0x2104, %r14
sub %rsi, %rsi
mov (%r14), %r10
nop
nop
...
nop
add %rsi, %rsi
lea addresses_WT_ht+0xa484, %r11
nop
nop
and %rbx, %rbx
...
nop
xor %rcx, %rcx
lea addresses_WC_ht+0x8984, %rbx
nop
nop
nop
add %rcx, %rcx
...
nop
xor $63209, %rdi
lea addresses_D_ht+0x157c1, %rdi
nop
nop
nop
nop
...
nop
sub %r11, %r11
lea addresses_A_ht+0xc084, %rsi
lea addresses_A_ht+0x9484, %rdi
nop
nop
nop
xor $43857, %r10
...
nop
xor $58467, %rbx
lea addresses_normal_ht+0x13cc4, %rdi
nop
nop
inc %r11
...
nop
add $20302, %rdi
lea addresses_A_ht+0x1b084, %rcx
nop
and $57313, %rsi
movups (%rcx), %xmm3
vpextrq $1, %xmm3, %rdx
...
{'OP': 'STOR', 'dst': {'type': 'addresses_WT_ht', 'size': 32, 'AVXalign': False, 'NT': False, 'congruent': 9, 'same': True}}
...
{'OP': 'LOAD', 'src': {'type': 'addresses_D_ht', 'size': 2, 'AVXalign': True, 'NT': False, 'congruent': 2, 'same': True}}
