...
push %rdi
push %rsi
lea addresses_D_ht+0x1541d, %r13
nop
nop
nop
nop
...
nop
xor %rsi, %rsi
lea addresses_WC_ht+0x1ab18, %r12
clflush (%r12)
nop
nop
nop
...
nop
xor %rcx, %rcx
lea addresses_WT_ht+0x1ea48, %r10
clflush (%r10)
add %rsi, %rsi
movb $0x61, (%r10)
nop
inc %rax
lea addresses_WT_ht+0x1f08, %rax
nop
nop
xor $7500, %r10
mov (%rax), %r13
...
nop
xor %r10, %r10
lea addresses_UC_ht+0x1898, %rsi
add $11071, %r10
movb (%rsi), %al
nop
cmp $16217, %rcx
lea addresses_UC_ht+0x1ef28, %rbx
nop
nop
nop
sub %rcx, %rcx
mov (%rbx), %r10d
cmp $1026, %r13
lea addresses_WC_ht+0x1e88, %rsi
lea addresses_WT_ht+0x4088, %rdi
cmp %rbx, %rbx
mov $86, %rcx
rep movsw
nop
...
nop
inc %r10
lea addresses_D_ht+0x8788, %rsi
lea addresses_D_ht+0xe88, %rdi
nop
and $7708, %rbx
mov $62, %rcx
rep movsl
nop
and $54068, %rcx
lea addresses_UC_ht+0x16288, %rbx
mfence
mov (%rbx), %r13
nop
nop
add %rsi, %rsi
lea addresses_UC_ht+0xd564, %rax
nop
nop
nop
nop
...
nop
sub $62670, %r12
lea addresses_normal_ht+0x16da0, %rsi
...
{'src': {'congruent': 4, 'AVXalign': False, 'same': True, 'size': 4, 'NT': False, 'type': 'addresses_UC_ht'}, 'OP': 'LOAD'}
{'src': {'congruent': 11, 'same': False, 'type': 'addresses_WC_ht'}, 'OP': 'REPM', 'dst': {'congruent': 9, 'same': False, 'type': 'addresses_WT_ht'}}
{'src': {'congruent': 8, 'same': True, 'type': 'addresses_D_ht'}, 'OP': 'REPM', 'dst': {'congruent': 9, 'same': False, 'type': 'addresses_D_ht'}}
...
{'src': {'congruent': 2, 'same': False, 'type': 'addresses_normal_ht'}, 'OP': 'REPM', 'dst': {'congruent': 7, 'same': False, 'type': 'addresses_normal_ht'}}
{'00': 21829}
