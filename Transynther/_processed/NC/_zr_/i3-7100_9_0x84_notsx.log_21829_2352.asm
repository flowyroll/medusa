...
push %rdx
push %rsi
lea addresses_normal_ht+0x13c86, %rcx
clflush (%rcx)
nop
nop
nop
...
nop
dec %rsi
lea addresses_WT_ht+0x4c46, %rsi
lea addresses_UC_ht+0x14986, %rdi
clflush (%rsi)
nop
nop
xor $56572, %rdx
...
rep movsq
and $2186, %r13
lea addresses_A_ht+0x141f6, %rdi
cmp %rcx, %rcx
mov $0x6162636465666768, %rdx
movq %rdx, %xmm0
...
{'src': {'type': 'addresses_WT_ht', 'congruent': 11, 'same': True}, 'dst': {'type': 'addresses_UC_ht', 'congruent': 6, 'same': False}, 'OP': 'REPM'}
