...
push %rdx
push %rsi
lea addresses_A_ht+0x13295, %rsi
add %r13, %r13
movb $0x61, (%rsi)
cmp %rdx, %rdx
lea addresses_normal_ht+0x1d015, %rdx
nop
nop
nop
nop
...
rep movsb
dec %rcx
lea addresses_A_ht+0x15785, %rsi
lea addresses_D_ht+0x17295, %rdi
nop
nop
nop
nop
...
nop
and %rdi, %rdi
lea addresses_normal_ht+0x1395, %r9
mfence
movw $0x6162, (%r9)
nop
nop
...
{'OP': 'STOR', 'dst': {'congruent': 8, 'AVXalign': False, 'same': False, 'size': 2, 'NT': True, 'type': 'addresses_normal_ht'}}
{'00': 21829}
