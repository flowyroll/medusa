...
push %rdx
push %rsi
lea addresses_WC_ht+0x3682, %rsi
lea addresses_A_ht+0xec52, %rdi
nop
nop
nop
cmp %rdx, %rdx
...
rep movsw
and $50601, %rax
lea addresses_D_ht+0xce82, %rbx
cmp %r12, %r12
movb $0x61, (%rbx)
nop
and %rsi, %rsi
lea addresses_UC_ht+0x2682, %rdi
nop
nop
nop
nop
...
nop
xor $61672, %rdx
lea addresses_WT_ht+0x7427, %rdx
nop
nop
nop
nop
...
nop
xor %rdx, %rdx
lea addresses_normal_ht+0x6282, %rsi
lea addresses_UC_ht+0x14182, %rdi
nop
sub %r8, %r8
mov $53, %rcx
rep movsb
and %rax, %rax
lea addresses_normal_ht+0x7d82, %rsi
lea addresses_normal_ht+0x6882, %rdi
clflush (%rsi)
clflush (%rdi)
nop
nop
...
nop
cmp %r12, %r12
lea addresses_WC_ht+0xdbca, %rsi
nop
nop
nop
nop
...
nop
and %rax, %rax
lea addresses_D_ht+0xcfc2, %rsi
lea addresses_WC_ht+0x8342, %rdi
nop
nop
inc %r8
mov $93, %rcx
rep movsl
xor $25607, %rdi
lea addresses_D_ht+0x8178, %rax
and $50353, %rbx
movb (%rax), %dl
nop
nop
dec %rbx
lea addresses_WC_ht+0x168a7, %r12
nop
nop
cmp %rbx, %rbx
...
nop
add $21745, %rdx
lea addresses_normal_ht+0xf082, %rsi
lea addresses_UC_ht+0x1e702, %rdi
clflush (%rsi)
xor %r12, %r12
mov $37, %rcx
rep movsb
sub %rdx, %rdx
lea addresses_D_ht+0x19ba2, %rdi
nop
nop
nop
sub %rsi, %rsi
...
nop
sub %rbx, %rbx
lea addresses_WT_ht+0xa252, %rsi
lea addresses_WT_ht+0x16bf6, %rdi
sub %rdx, %rdx
mov $73, %rcx
rep movsb
nop
...
{'src': {'type': 'addresses_D', 'AVXalign': False, 'size': 1, 'NT': False, 'same': False, 'congruent': 1}, 'OP': 'LOAD'}
...
{'src': {'type': 'addresses_WT_ht', 'AVXalign': True, 'size': 32, 'NT': False, 'same': False, 'congruent': 0}, 'OP': 'LOAD'}
{'src': {'type': 'addresses_normal_ht', 'congruent': 11, 'same': False}, 'OP': 'REPM', 'dst': {'type': 'addresses_UC_ht', 'congruent': 5, 'same': False}}
{'src': {'type': 'addresses_normal_ht', 'congruent': 6, 'same': False}, 'OP': 'REPM', 'dst': {'type': 'addresses_normal_ht', 'congruent': 7, 'same': True}}
{'src': {'type': 'addresses_WC_ht', 'AVXalign': False, 'size': 8, 'NT': False, 'same': False, 'congruent': 2}, 'OP': 'LOAD'}
{'src': {'type': 'addresses_D_ht', 'congruent': 6, 'same': False}, 'OP': 'REPM', 'dst': {'type': 'addresses_WC_ht', 'congruent': 5, 'same': True}}
