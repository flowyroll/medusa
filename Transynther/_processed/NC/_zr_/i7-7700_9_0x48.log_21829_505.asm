...
push %rdx
push %rsi
lea addresses_normal_ht+0xd925, %rdi
nop
nop
sub %r11, %r11
movups (%rdi), %xmm1
...
nop
xor %rbp, %rbp
lea addresses_WC_ht+0x169e5, %rdi
nop
nop
nop
inc %r10
...
lea addresses_WC_ht+0x12091, %rdi
nop
nop
add $33712, %r12
mov $45, %rcx
...
nop
lfence
lea addresses_WT_ht+0x25e5, %rsi
lea addresses_WC_ht+0x16225, %rdi
clflush (%rsi)
nop
add $46109, %r12
mov $69, %rcx
...
nop
inc %rcx
lea addresses_D_ht+0xffa5, %rsi
lea addresses_normal_ht+0x129d5, %rdi
nop
nop
nop
nop
...
nop
inc %r11
lea addresses_D_ht+0x1bcf5, %rbp
nop
nop
and %rdi, %rdi
mov (%rbp), %r11w
...
nop
dec %r12
lea addresses_UC_ht+0x5b25, %rdx
nop
nop
nop
nop
...
nop
and $42718, %rbp
lea addresses_A_ht+0xbd47, %rsi
lea addresses_WT_ht+0x8ba5, %rdi
clflush (%rdi)
nop
nop
nop
...
nop
xor $9777, %rbp
lea addresses_normal_ht+0x7bd, %r10
cmp %rbp, %rbp
...
nop
add $22045, %rdi
lea addresses_normal_ht+0x160d5, %rbp
clflush (%rbp)
nop
nop
sub $56044, %rdx
...
{'OP': 'REPM', 'src': {'type': 'addresses_WC_ht', 'congruent': 11, 'same': False}, 'dst': {'type': 'addresses_WC_ht', 'congruent': 2, 'same': False}}
...
{'OP': 'LOAD', 'src': {'type': 'addresses_UC_ht', 'AVXalign': False, 'congruent': 9, 'size': 1, 'same': False, 'NT': True}}
