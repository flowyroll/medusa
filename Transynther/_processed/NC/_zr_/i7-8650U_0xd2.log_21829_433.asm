...
push %rdx
push %rsi
lea addresses_WC_ht+0x13293, %r15
nop
nop
nop
nop
...
nop
xor %r10, %r10
lea addresses_WC_ht+0x1873, %rbx
nop
nop
nop
nop
...
nop
cmp %rdx, %rdx
lea addresses_WC_ht+0x6c73, %rsi
lea addresses_A_ht+0x4753, %rdi
clflush (%rsi)
nop
nop
nop
...
nop
add %r10, %r10
lea addresses_D_ht+0x1c873, %rsi
lea addresses_normal_ht+0x15073, %rdi
clflush (%rdi)
nop
add $17213, %r10
mov $91, %rcx
rep movsq
inc %rdx
lea addresses_WC_ht+0x16073, %rsi
lea addresses_D_ht+0x11d6b, %rdi
nop
nop
cmp %r14, %r14
mov $113, %rcx
...
nop
cmp $34187, %r9
lea addresses_D_ht+0xca1b, %rcx
nop
cmp $25590, %r15
movups (%rcx), %xmm4
vpextrq $1, %xmm4, %rdi
cmp $39967, %r10
lea addresses_normal_ht+0x12673, %rbx
nop
nop
nop
mfence
...
nop
add $17536, %r14
lea addresses_UC_ht+0x11873, %rsi
lea addresses_D_ht+0xf13a, %rdi
clflush (%rdi)
nop
nop
nop
...
nop
inc %rcx
lea addresses_normal_ht+0x4473, %rsi
lea addresses_D_ht+0xe3d3, %rdi
nop
nop
nop
nop
...
{'OP': 'REPM', 'src': {'type': 'addresses_UC_ht', 'congruent': 10, 'same': False}, 'dst': {'type': 'addresses_D_ht', 'congruent': 0, 'same': True}}
{'OP': 'REPM', 'src': {'type': 'addresses_normal_ht', 'congruent': 10, 'same': False}, 'dst': {'type': 'addresses_D_ht', 'congruent': 4, 'same': True}}
{'00': 21829}
