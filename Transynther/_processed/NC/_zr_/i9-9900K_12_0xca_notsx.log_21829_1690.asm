...
push %rdi
push %rsi
lea addresses_WC_ht+0x1ef17, %rsi
lea addresses_A_ht+0x1325f, %rdi
nop
add $4341, %r10
mov $67, %rcx
rep movsq
...
nop
inc %r12
lea addresses_UC_ht+0x95f, %rsi
lea addresses_WC_ht+0x1e25f, %rdi
nop
nop
nop
cmp $37119, %rbx
...
nop
sub %rbx, %rbx
lea addresses_D_ht+0xe8df, %rsi
lea addresses_A_ht+0x1015f, %rdi
sub $55083, %rax
mov $58, %rcx
rep movsb
nop
...
nop
sub %rsi, %rsi
lea addresses_UC_ht+0x10d5f, %rsi
lea addresses_D_ht+0xab5f, %rdi
nop
nop
nop
and %r9, %r9
...
nop
xor %r9, %r9
lea addresses_normal_ht+0xbd5f, %rbx
nop
nop
nop
nop
...
mov (%rbx), %r9
xor $8702, %rdi
lea addresses_WT_ht+0x1eadb, %rax
nop
nop
nop
nop
...
{'OP': 'REPM', 'src': {'same': False, 'congruent': 8, 'type': 'addresses_UC_ht'}, 'dst': {'same': False, 'congruent': 9, 'type': 'addresses_D_ht'}}
