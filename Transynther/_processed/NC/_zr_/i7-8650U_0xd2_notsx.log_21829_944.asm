...
push %rdi
push %rsi
lea addresses_normal_ht+0x2b80, %r14
nop
nop
nop
nop
...
nop
xor $16813, %rsi
lea addresses_UC_ht+0xe05c, %rsi
...
lea addresses_normal_ht+0x16b80, %rdi
nop
nop
nop
dec %r14
...
// Store
lea addresses_normal+0x1d140, %r14
nop
nop
xor %r8, %r8
movw $0x5152, (%r14)
...
// Store
lea addresses_normal+0x3500, %r8
nop
nop
nop
nop
...
{'OP': 'REPM', 'src': {'type': 'addresses_UC_ht', 'congruent': 2, 'same': False}, 'dst': {'type': 'addresses_WT_ht', 'congruent': 2, 'same': False}}
{'OP': 'LOAD', 'src': {'type': 'addresses_WC_ht', 'size': 32, 'AVXalign': False, 'NT': False, 'congruent': 11, 'same': True}}
{'OP': 'REPM', 'src': {'type': 'addresses_normal_ht', 'congruent': 9, 'same': False}, 'dst': {'type': 'addresses_normal_ht', 'congruent': 10, 'same': False}}
{'00': 21829}
