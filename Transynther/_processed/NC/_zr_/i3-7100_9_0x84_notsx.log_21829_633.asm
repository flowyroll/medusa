...
push %rdi
push %rsi
lea addresses_WT_ht+0xc956, %rsi
nop
nop
sub %r13, %r13
movb $0x61, (%rsi)
...
nop
xor $4041, %r10
lea addresses_WT_ht+0xedc6, %r12
nop
dec %r8
...
nop
cmp $36211, %r14
lea addresses_normal_ht+0x71b4, %r13
dec %rsi
mov (%r13), %r10d
nop
nop
...
nop
xor %r14, %r14
lea addresses_normal_ht+0x1c8f6, %rsi
lea addresses_A_ht+0x43a6, %rdi
nop
nop
nop
nop
...
nop
sub %r10, %r10
lea addresses_UC_ht+0x15756, %r13
nop
nop
nop
xor $19847, %r14
...
nop
inc %r12
lea addresses_WT_ht+0x146d6, %rdi
inc %rsi
mov (%rdi), %r8
nop
nop
nop
and $16809, %r14
lea addresses_WC_ht+0x14446, %rsi
lea addresses_normal_ht+0x95d0, %rdi
clflush (%rsi)
nop
nop
nop
...
nop
and $56449, %r8
lea addresses_normal_ht+0x1a956, %r14
nop
nop
and %r12, %r12
movw $0x6162, (%r14)
...
nop
sub %rdi, %rdi
lea addresses_UC_ht+0x1c0f6, %rsi
lea addresses_WC_ht+0xdd4a, %rdi
dec %r10
mov $24, %rcx
rep movsl
nop
...
// Store
lea addresses_normal+0x12956, %r12
nop
nop
nop
nop
...
// Store
lea addresses_normal+0xa8fe, %r12
inc %rbx
...
{'src': {'type': 'addresses_normal_ht', 'congruent': 5, 'same': False}, 'dst': {'type': 'addresses_A_ht', 'congruent': 3, 'same': False}, 'OP': 'REPM'}
...
{'src': {'type': 'addresses_WT_ht', 'same': True, 'size': 8, 'congruent': 5, 'NT': False, 'AVXalign': True}, 'OP': 'LOAD'}
{'src': {'type': 'addresses_WC_ht', 'congruent': 4, 'same': False}, 'dst': {'type': 'addresses_normal_ht', 'congruent': 1, 'same': False}, 'OP': 'REPM'}
