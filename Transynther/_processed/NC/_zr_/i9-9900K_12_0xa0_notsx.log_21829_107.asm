...
push %rdi
push %rsi
lea addresses_WC_ht+0x1b69d, %r14
nop
nop
nop
nop
...
nop
add %rsi, %rsi
lea addresses_UC_ht+0x5a13, %rsi
lea addresses_UC_ht+0x14e33, %rdi
nop
and %r11, %r11
mov $82, %rcx
rep movsb
...
nop
dec %rsi
lea addresses_normal_ht+0x19fb3, %rsi
lea addresses_normal_ht+0x1c2af, %rdi
nop
nop
nop
xor %r15, %r15
...
nop
dec %r15
lea addresses_normal_ht+0xd4f3, %rsi
nop
sub $30670, %r11
mov (%rsi), %r14
and $64188, %r14
lea addresses_A_ht+0x12e13, %r15
nop
nop
add %rcx, %rcx
...
nop
and %rsi, %rsi
lea addresses_WC_ht+0xe4a7, %rsi
lea addresses_D_ht+0x12613, %rdi
nop
nop
nop
mfence
...
nop
sub %r11, %r11
lea addresses_normal_ht+0x1ddd3, %rsi
lea addresses_UC_ht+0x1ac03, %rdi
clflush (%rdi)
cmp %r14, %r14
mov $92, %rcx
rep movsw
dec %r15
lea addresses_WC_ht+0x1b5f7, %r14
nop
nop
nop
nop
...
nop
cmp $2297, %rdi
lea addresses_WC_ht+0xd413, %r14
cmp %rdi, %rdi
...
nop
add %r11, %r11
lea addresses_UC_ht+0x16313, %r15
nop
nop
nop
xor %r8, %r8
...
{'src': {'type': 'addresses_US', 'AVXalign': False, 'size': 2, 'NT': False, 'same': False, 'congruent': 2}, 'OP': 'LOAD'}
[Faulty Load]
