...
push %rdx
push %rsi
lea addresses_normal_ht+0x1149e, %rsi
lea addresses_WT_ht+0x1a1be, %rdi
clflush (%rdi)
nop
xor $44952, %r10
mov $33, %rcx
...
nop
cmp %rdi, %rdi
lea addresses_WT_ht+0xdb1e, %r14
nop
nop
xor %rsi, %rsi
movl $0x61626364, (%r14)
...
nop
cmp $32611, %rdi
lea addresses_WC_ht+0x1201e, %rcx
nop
nop
nop
nop
...
vpextrq $0, %xmm3, %r10
dec %r10
lea addresses_A_ht+0xa54e, %r14
sub %rdx, %rdx
mov $0x6162636465666768, %rsi
movq %rsi, (%r14)
nop
xor $53016, %rsi
lea addresses_WT_ht+0x16c8, %rdx
clflush (%rdx)
nop
xor %r9, %r9
mov (%rdx), %r10d
...
nop
sub %rcx, %rcx
lea addresses_WC_ht+0xbb1e, %rsi
lea addresses_normal_ht+0xd71e, %rdi
nop
nop
nop
nop
...
nop
sub %r14, %r14
lea addresses_normal_ht+0x410e, %rsi
lea addresses_WC_ht+0x171e, %rdi
add $62641, %r12
mov $108, %rcx
rep movsw
nop
add $48939, %r14
lea addresses_UC_ht+0x1be72, %rsi
nop
nop
xor $28057, %r10
...
// Store
lea addresses_normal+0x13ede, %rdi
nop
nop
cmp $53845, %r15
...
<gen_prepare_buffer>
{'src': {'type': 'addresses_normal_ht', 'congruent': 7, 'same': False}, 'dst': {'type': 'addresses_WT_ht', 'congruent': 5, 'same': False}, 'OP': 'REPM'}
...
{'src': {'type': 'addresses_normal_ht', 'congruent': 4, 'same': True}, 'dst': {'type': 'addresses_WC_ht', 'congruent': 11, 'same': False}, 'OP': 'REPM'}
