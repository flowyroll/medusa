...
push %rdi
push %rsi
lea addresses_A_ht+0x1439, %rsi
lea addresses_UC_ht+0x1ba03, %rdi
nop
nop
nop
nop
...
nop
cmp $45062, %r13
lea addresses_normal_ht+0xcdb9, %rsi
lea addresses_WC_ht+0x94b9, %rdi
clflush (%rdi)
nop
nop
nop
...
rep movsw
add %rdi, %rdi
lea addresses_D_ht+0x91b9, %r14
nop
inc %rsi
movb $0x61, (%r14)
nop
and %r11, %r11
lea addresses_WT_ht+0xd14, %r14
nop
nop
nop
inc %rbp
...
nop
sub $61618, %r13
lea addresses_normal_ht+0xf3b9, %rdi
nop
nop
add %rsi, %rsi
movb $0x61, (%rdi)
sub %r14, %r14
lea addresses_normal_ht+0x4fb9, %rcx
nop
nop
nop
sub $23674, %rdi
...
{'OP': 'STOR', 'dst': {'type': 'addresses_PSE', 'size': 16, 'AVXalign': False, 'NT': True, 'congruent': 8, 'same': False}}
{'OP': 'STOR', 'dst': {'type': 'addresses_D', 'size': 16, 'AVXalign': False, 'NT': False, 'congruent': 6, 'same': False}}
{'OP': 'STOR', 'dst': {'type': 'addresses_RW', 'size': 32, 'AVXalign': False, 'NT': True, 'congruent': 0, 'same': False}}
[Faulty Load]
