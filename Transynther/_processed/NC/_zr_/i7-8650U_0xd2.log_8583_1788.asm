...
push %rdi
push %rsi
lea addresses_normal_ht+0x1dff8, %rdi
clflush (%rdi)
nop
nop
nop
...
nop
inc %r11
lea addresses_A_ht+0x566a, %rsi
lea addresses_UC_ht+0x1a71a, %rdi
nop
nop
sub $50112, %r10
mov $127, %rcx
...
nop
cmp $28340, %r11
lea addresses_UC_ht+0x1466a, %rdi
nop
and $36815, %rbx
...
nop
cmp $11258, %rdi
lea addresses_D_ht+0x1e5ea, %rbx
nop
nop
cmp %rsi, %rsi
movb (%rbx), %cl
nop
sub $45446, %rcx
lea addresses_WT_ht+0xba6a, %rcx
nop
nop
cmp %rdi, %rdi
...
movq %r11, (%rcx)
cmp %rdi, %rdi
lea addresses_WC_ht+0x12e0e, %rsi
nop
sub %r11, %r11
mov $0x6162636465666768, %rax
movq %rax, (%rsi)
sub $47506, %rax
lea addresses_D_ht+0x1a668, %rdi
nop
nop
nop
nop
...
movb (%rdi), %cl
dec %r10
lea addresses_normal_ht+0xe66a, %r11
nop
nop
nop
nop
...
nop
sub $49571, %rcx
lea addresses_UC_ht+0x706a, %rcx
nop
nop
nop
nop
...
nop
sub %rcx, %rcx
lea addresses_normal_ht+0x1ac36, %r11
clflush (%r11)
nop
nop
add %r10, %r10
...
{'OP': 'STOR', 'dst': {'type': 'addresses_UC_ht', 'size': 16, 'AVXalign': False, 'NT': False, 'congruent': 9, 'same': True}}
