...
push %rdi
push %rsi
lea addresses_D_ht+0x1edeb, %rbp
clflush (%rbp)
nop
nop
nop
...
nop
xor %r12, %r12
lea addresses_WT_ht+0x1d53b, %rsi
lea addresses_normal_ht+0xd9fb, %rdi
nop
nop
nop
nop
...
rep movsq
xor $57098, %r14
lea addresses_WC_ht+0xdb6b, %rsi
lea addresses_normal_ht+0x2f6b, %rdi
sub $45795, %r13
mov $1, %rcx
rep movsb
nop
sub $33076, %r12
lea addresses_WT_ht+0x1350f, %rsi
sub $1237, %rcx
mov (%rsi), %r12w
nop
xor %rcx, %rcx
lea addresses_D_ht+0x1d6eb, %rax
nop
nop
nop
add %rdi, %rdi
...
nop
xor %rax, %rax
lea addresses_normal_ht+0x7deb, %rsi
lea addresses_normal_ht+0x11aeb, %rdi
nop
nop
nop
and $838, %r13
...
rep movsb
sub $44602, %r14
lea addresses_normal_ht+0x11bd3, %r13
nop
nop
add $33552, %r14
movups (%r13), %xmm4
...
nop
sub $25765, %r13
lea addresses_UC_ht+0x4be3, %rsi
lea addresses_UC_ht+0x1bae9, %rdi
nop
nop
nop
nop
...
nop
cmp %r14, %r14
lea addresses_D_ht+0x1cd87, %rdi
nop
nop
nop
nop
...
{'OP': 'LOAD', 'src': {'type': 'addresses_D', 'AVXalign': True, 'congruent': 2, 'size': 16, 'same': False, 'NT': False}}
[Faulty Load]
