...
push %rdx
push %rsi
lea addresses_UC_ht+0x16cdc, %rdx
nop
nop
nop
nop
...
nop
inc %rcx
lea addresses_normal_ht+0x1e624, %rsi
lea addresses_WT_ht+0xddf4, %rdi
nop
nop
nop
nop
...
nop
and $7197, %rcx
lea addresses_UC_ht+0x1ed4, %rcx
nop
nop
cmp $21394, %rdi
movb $0x61, (%rcx)
...
nop
cmp $49512, %rbp
lea addresses_WC_ht+0x3ed4, %rbp
nop
nop
add $58641, %r12
movl $0x61626364, (%rbp)
inc %rbp
lea addresses_normal_ht+0x10814, %rsi
lea addresses_WC_ht+0x149d4, %rdi
clflush (%rdi)
nop
nop
nop
...
rep movsb
sub %rbx, %rbx
lea addresses_normal_ht+0xfcd4, %r13
nop
nop
add $12817, %rdx
movups (%r13), %xmm3
...
nop
and $50584, %r12
lea addresses_WC_ht+0x5ed4, %rsi
lea addresses_WT_ht+0xb694, %rdi
nop
nop
add %r12, %r12
mov $98, %rcx
...
nop
add %r12, %r12
lea addresses_A_ht+0x10e54, %rbp
clflush (%rbp)
nop
nop
nop
...
nop
and %rbp, %rbp
lea addresses_WT_ht+0x1d094, %rsi
lea addresses_D_ht+0x93d0, %rdi
nop
and %rbx, %rbx
mov $29, %rcx
rep movsb
...
nop
xor $44975, %rdi
lea addresses_A_ht+0x144d4, %rdx
nop
nop
and $60644, %r13
...
vmovntdq %ymm5, (%rdx)
sub %r13, %r13
lea addresses_A_ht+0x6ed4, %rsi
lea addresses_D_ht+0x156d4, %rdi
cmp $33321, %rdx
mov $77, %rcx
rep movsw
nop
...
{'OP': 'REPM', 'src': {'type': 'addresses_WC_ht', 'congruent': 11, 'same': True}, 'dst': {'type': 'addresses_WT_ht', 'congruent': 5, 'same': False}}
