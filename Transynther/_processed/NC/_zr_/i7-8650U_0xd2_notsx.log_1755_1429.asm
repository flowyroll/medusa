...
push %rdi
push %rsi
lea addresses_WT_ht+0x7c7b, %rbx
nop
cmp %r9, %r9
movb (%rbx), %r8b
nop
...
nop
cmp $59602, %r8
lea addresses_WC_ht+0x1cefb, %r13
nop
nop
nop
nop
...
nop
cmp $28348, %rbp
lea addresses_D_ht+0x7dfb, %rsi
lea addresses_UC_ht+0xa68b, %rdi
clflush (%rdi)
nop
nop
nop
...
nop
add %rbp, %rbp
lea addresses_UC_ht+0x1d7fb, %rcx
nop
nop
nop
nop
