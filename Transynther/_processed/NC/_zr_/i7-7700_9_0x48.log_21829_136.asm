...
nop
inc %r10
lea addresses_UC_ht+0x6c39, %rdi
nop
nop
nop
nop
...
nop
inc %r9
lea addresses_WC_ht+0x260d, %r10
clflush (%r10)
nop
nop
nop
...
nop
cmp $24940, %rsi
lea addresses_UC_ht+0x5cbd, %rsi
lea addresses_WT_ht+0x1510d, %rdi
nop
add %r12, %r12
mov $21, %rcx
rep movsw
...
nop
cmp %rsi, %rsi
lea addresses_normal_ht+0x9615, %r15
nop
nop
nop
nop
...
nop
xor $14845, %r15
lea addresses_UC_ht+0x150dd, %rsi
lea addresses_D_ht+0x14b0d, %rdi
nop
nop
nop
nop
...
nop
add $31598, %rdi
lea addresses_WC_ht+0xc48d, %rsi
lea addresses_normal_ht+0xb64d, %rdi
dec %rbx
mov $22, %rcx
rep movsb
nop
...
nop
inc %rsi
lea addresses_WT_ht+0x1ed0d, %r15
nop
nop
nop
nop
