...
push %rdx
push %rsi
lea addresses_UC_ht+0x66a7, %rsi
lea addresses_D_ht+0x38c7, %rdi
nop
nop
nop
nop
...
lea addresses_D_ht+0x14f05, %rdi
clflush (%rsi)
nop
nop
nop
...
nop
add %r9, %r9
lea addresses_UC_ht+0x66a7, %rdx
xor $31360, %rsi
movups (%rdx), %xmm7
vpextrq $0, %xmm7, %r8
nop
nop
cmp %r8, %r8
lea addresses_A_ht+0x16be4, %rcx
nop
nop
sub $34029, %r11
movups (%rcx), %xmm7
vpextrq $1, %xmm7, %rdi
inc %rcx
lea addresses_WT_ht+0x1e2a3, %rcx
nop
nop
nop
nop
...
nop
add $14742, %rdx
lea addresses_WC_ht+0xf867, %rdi
add %rcx, %rcx
mov $0x6162636465666768, %r11
movq %r11, %xmm5
vmovups %ymm5, (%rdi)
sub %r9, %r9
lea addresses_UC_ht+0x1aa7, %rsi
lea addresses_WT_ht+0x1cd47, %rdi
clflush (%rsi)
nop
nop
nop
...
rep movsb
and %r9, %r9
lea addresses_normal_ht+0x96f3, %rsi
lea addresses_A_ht+0x1a3d7, %rdi
clflush (%rsi)
nop
nop
nop
...
nop
xor $50892, %rdx
lea addresses_A_ht+0x112c7, %rsi
...
nop
sub $29653, %r10
lea addresses_WC_ht+0x14be7, %r10
nop
nop
nop
nop
...
nop
add %rdx, %rdx
lea addresses_normal_ht+0x11ea7, %rdi
cmp $49528, %rcx
movups (%rdi), %xmm0
vpextrq $0, %xmm0, %r8
nop
nop
cmp %rdx, %rdx
lea addresses_normal_ht+0x1e4a7, %rdi
nop
nop
nop
nop
...
{'OP': 'LOAD', 'src': {'type': 'addresses_NC', 'AVXalign': True, 'congruent': 5, 'size': 4, 'same': False, 'NT': False}}
...
{'OP': 'REPM', 'src': {'type': 'addresses_WC_ht', 'congruent': 7, 'same': True}, 'dst': {'type': 'addresses_D_ht', 'congruent': 0, 'same': True}}
