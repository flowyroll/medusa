...
nop
and $35057, %r8
lea addresses_WC_ht+0x5e68, %r11
clflush (%r11)
and $45949, %rdx
mov (%r11), %r15
nop
...
nop
sub %r11, %r11
lea addresses_WT_ht+0x5fc8, %rax
clflush (%rax)
nop
nop
nop
...
nop
sub $13290, %r13
lea addresses_A_ht+0xecfc, %rsi
lea addresses_normal_ht+0x120e8, %rdi
nop
nop
nop
and $51082, %r13
...
nop
sub %rbx, %rbx
lea addresses_UC_ht+0x9bbc, %rax
nop
nop
nop
cmp %r15, %r15
...
nop
cmp $11731, %rsi
lea addresses_UC_ht+0xfce8, %rdx
nop
nop
add %r8, %r8
mov (%rdx), %rbx
...
{'src': {'congruent': 2, 'same': False, 'type': 'addresses_A_ht'}, 'OP': 'REPM', 'dst': {'congruent': 11, 'same': False, 'type': 'addresses_normal_ht'}}
