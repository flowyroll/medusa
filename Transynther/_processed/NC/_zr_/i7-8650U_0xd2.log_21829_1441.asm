...
push %rdx
push %rsi
lea addresses_D_ht+0x1c344, %r11
clflush (%r11)
nop
nop
xor $43098, %r14
...
nop
and %rdx, %rdx
lea addresses_A_ht+0x1da04, %rdi
nop
nop
nop
nop
...
nop
inc %r11
lea addresses_WC_ht+0x85a4, %r14
nop
add $32292, %rdi
mov $0x6162636465666768, %rbp
movq %rbp, %xmm7
...
nop
and $1222, %rdi
lea addresses_normal_ht+0xc380, %r14
nop
nop
nop
nop
...
vpextrq $1, %xmm7, %r14
inc %rdx
lea addresses_WC_ht+0x154e4, %rdi
nop
add %r13, %r13
vmovups (%rdi), %ymm2
...
nop
add %rdi, %rdi
lea addresses_WT_ht+0x9b62, %rsi
lea addresses_A_ht+0x13524, %rdi
sub %r13, %r13
mov $39, %rcx
rep movsw
nop
...
nop
xor %r11, %r11
lea addresses_WC_ht+0xca0c, %r13
clflush (%r13)
nop
nop
nop
...
mov (%r9), %r11
xor $24259, %rdi
lea addresses_WC_ht+0x366a, %rsi
lea addresses_WT_ht+0x1aa9a, %rdi
nop
nop
nop
nop
...
rep movsw
add $39190, %r13
lea addresses_UC_ht+0x11444, %rdx
nop
nop
nop
cmp $8144, %r11
...
{'OP': 'STOR', 'dst': {'type': 'addresses_WC_ht', 'size': 4, 'AVXalign': False, 'NT': True, 'congruent': 3, 'same': False}}
...
{'OP': 'REPM', 'src': {'type': 'addresses_WC_ht', 'congruent': 1, 'same': True}, 'dst': {'type': 'addresses_WT_ht', 'congruent': 1, 'same': False}}
