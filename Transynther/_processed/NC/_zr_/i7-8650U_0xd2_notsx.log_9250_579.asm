...
push %rdi
push %rsi
lea addresses_WT_ht+0x7772, %rsi
lea addresses_D_ht+0x14f84, %rdi
nop
nop
add %r12, %r12
mov $96, %rcx
...
nop
xor $39114, %r8
lea addresses_WC_ht+0x8888, %r9
xor %rax, %rax
vmovups (%r9), %ymm5
vextracti128 $0, %ymm5, %xmm5
vpextrq $1, %xmm5, %rcx
xor %rdi, %rdi
lea addresses_WC_ht+0x5c04, %rsi
lea addresses_UC_ht+0x1a064, %rdi
dec %rax
mov $90, %rcx
rep movsw
xor %rsi, %rsi
lea addresses_D_ht+0x1cf1c, %r8
nop
nop
nop
nop
...
nop
inc %r12
lea addresses_A_ht+0x16f84, %r12
add %rax, %rax
...
nop
cmp %r12, %r12
lea addresses_WC_ht+0x1de04, %r12
nop
nop
nop
cmp $54444, %rcx
...
nop
inc %rcx
lea addresses_WC_ht+0x3a44, %rsi
nop
nop
inc %r8
...
<gen_prepare_buffer>
{'OP': 'REPM', 'src': {'type': 'addresses_WT_ht', 'congruent': 0, 'same': False}, 'dst': {'type': 'addresses_D_ht', 'congruent': 11, 'same': True}}
