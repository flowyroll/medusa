...
push %rdi
push %rsi
lea addresses_normal_ht+0x3ddb, %rsi
nop
nop
sub $17835, %rbp
movl $0x61626364, (%rsi)
...
nop
sub %rbx, %rbx
lea addresses_WC_ht+0x42cb, %r11
nop
nop
nop
nop
...
nop
xor %rsi, %rsi
lea addresses_WT_ht+0xa5bf, %rsi
lea addresses_WC_ht+0xdd7b, %rdi
nop
nop
nop
sub $2353, %r11
...
nop
sub $3339, %rcx
lea addresses_UC_ht+0x74db, %r11
add %r14, %r14
mov $0x6162636465666768, %rbp
movq %rbp, %xmm1
vmovups %ymm1, (%r11)
dec %rcx
lea addresses_UC_ht+0xfdb, %rsi
lea addresses_WT_ht+0x1a87b, %rdi
nop
nop
nop
nop
...
nop
add $563, %rax
lea addresses_A_ht+0x53fb, %rsi
mfence
mov (%rsi), %r14w
nop
cmp $439, %rcx
lea addresses_normal_ht+0x16dc7, %rsi
lea addresses_A_ht+0x1badb, %rdi
clflush (%rdi)
nop
nop
nop
...
nop
dec %rcx
lea addresses_UC_ht+0xd25b, %rdi
nop
nop
nop
nop
...
nop
sub %r14, %r14
lea addresses_WT_ht+0xd49b, %r15
nop
nop
nop
dec %rsi
...
vpextrq $1, %xmm6, %rdi
sub $14723, %rsi
lea addresses_WC_ht+0x1a2db, %rax
nop
nop
nop
nop
...
{'OP': 'REPM', 'src': {'type': 'addresses_UC_ht', 'congruent': 8, 'same': True}, 'dst': {'type': 'addresses_WT_ht', 'congruent': 5, 'same': False}}
