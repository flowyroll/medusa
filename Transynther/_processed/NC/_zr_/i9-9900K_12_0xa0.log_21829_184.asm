...
push %rdi
push %rsi
lea addresses_D_ht+0xabea, %rsi
lea addresses_A_ht+0x1625e, %rdi
nop
inc %rbx
mov $121, %rcx
rep movsw
...
nop
xor $28100, %rdi
lea addresses_D_ht+0x1de5e, %rsi
lea addresses_A_ht+0x8bde, %rdi
cmp %r15, %r15
mov $118, %rcx
rep movsq
nop
...
movb $0x61, (%r12)
xor %r11, %r11
lea addresses_UC_ht+0xfd1e, %rsi
lea addresses_normal_ht+0x189d6, %rdi
nop
nop
nop
nop
...
rep movsl
add %r15, %r15
lea addresses_WT_ht+0x1152e, %rdi
sub %rsi, %rsi
movl $0x61626364, (%rdi)
nop
nop
...
<gen_prepare_buffer>
{'src': {'same': False, 'congruent': 2, 'type': 'addresses_D_ht'}, 'OP': 'REPM', 'dst': {'same': False, 'congruent': 10, 'type': 'addresses_A_ht'}}
