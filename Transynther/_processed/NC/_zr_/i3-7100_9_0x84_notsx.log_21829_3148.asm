...
vpextrq $0, %xmm2, %rdi
and %rbp, %rbp
lea addresses_WC_ht+0xefce, %r10
clflush (%r10)
nop
nop
and $48834, %rcx
...
nop
and %rbp, %rbp
lea addresses_normal_ht+0x48ba, %rbp
nop
nop
nop
nop
...
movb (%rbp), %r11b
add $21592, %rcx
lea addresses_A_ht+0x1a6aa, %rbp
nop
nop
nop
nop
...
nop
xor $28519, %rcx
lea addresses_WC_ht+0x189aa, %r8
nop
nop
nop
xor $40988, %r11
...
nop
dec %r9
lea addresses_A_ht+0x17caa, %r11
nop
nop
nop
sub %r10, %r10
...
nop
cmp %r10, %r10
lea addresses_WC_ht+0x178fe, %rsi
lea addresses_A_ht+0x3836, %rdi
nop
nop
nop
nop
