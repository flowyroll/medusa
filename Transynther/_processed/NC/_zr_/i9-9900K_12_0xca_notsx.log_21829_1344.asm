...
lea addresses_WC_ht+0x1e617, %rdi
inc %rbx
mov $69, %rcx
rep movsb
nop
cmp %r9, %r9
lea addresses_UC_ht+0x1b397, %r11
clflush (%r11)
nop
nop
nop
...
nop
sub $5521, %r10
lea addresses_WC_ht+0x1ad97, %rsi
nop
nop
dec %r10
movl $0x61626364, (%rsi)
...
nop
xor $12406, %rdi
lea addresses_UC_ht+0x827, %rsi
lea addresses_UC_ht+0x1bd97, %rdi
nop
mfence
mov $112, %rcx
rep movsb
...
nop
cmp $57148, %rcx
lea addresses_WC_ht+0x8e47, %rcx
nop
cmp %r10, %r10
movb $0x61, (%rcx)
nop
...
nop
xor %rbx, %rbx
lea addresses_UC_ht+0x2e1b, %rsi
lea addresses_D_ht+0x10e97, %rdi
clflush (%rsi)
add %rbx, %rbx
mov $77, %rcx
rep movsw
...
nop
add $63173, %rsi
lea addresses_D_ht+0x1cc97, %r10
clflush (%r10)
nop
and %rdi, %rdi
movups (%r10), %xmm3
...
nop
xor $35791, %rbx
lea addresses_normal_ht+0x1ea50, %r10
nop
cmp %r13, %r13
movb $0x61, (%r10)
nop
dec %r10
lea addresses_normal_ht+0xa61b, %rsi
lea addresses_WT_ht+0xc057, %rdi
nop
nop
nop
nop
...
nop
inc %rbx
lea addresses_A_ht+0x17097, %rsi
lea addresses_A_ht+0x11227, %rdi
clflush (%rsi)
add $12213, %rbx
mov $65, %rcx
rep movsw
...
{'OP': 'LOAD', 'src': {'same': True, 'type': 'addresses_A_ht', 'NT': False, 'AVXalign': False, 'size': 8, 'congruent': 6}}
