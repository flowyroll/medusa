...
nop
xor $32325, %r15
lea addresses_WC_ht+0x10399, %rax
nop
nop
nop
nop
...
nop
xor $2718, %r8
lea addresses_WT_ht+0x18a1a, %rsi
lea addresses_normal_ht+0xed75, %rdi
cmp $12425, %r11
mov $65, %rcx
rep movsw
nop
...
nop
sub %r10, %r10
lea addresses_UC_ht+0xf6d9, %rdx
nop
nop
nop
dec %r10
...
movups %xmm6, (%rdx)
cmp %rdi, %rdi
lea addresses_WT_ht+0xa8f5, %rsi
lea addresses_UC_ht+0x104f5, %rdi
clflush (%rsi)
sub $43630, %r8
mov $22, %rcx
rep movsb
sub %rsi, %rsi
lea addresses_WT_ht+0x14e35, %rcx
and $60998, %rsi
movw $0x6162, (%rcx)
nop
nop
...
nop
and %r11, %r11
lea addresses_normal_ht+0x7275, %rdx
nop
nop
nop
nop
...
mov (%rdx), %ax
sub %rdi, %rdi
lea addresses_WC_ht+0x11af5, %rsi
lea addresses_D_ht+0x9b19, %rdi
nop
sub %r11, %r11
mov $64, %rcx
rep movsl
dec %rdx
lea addresses_UC_ht+0xe8f5, %r15
nop
xor %rdi, %rdi
...
nop
lfence
lea addresses_WC_ht+0x48f5, %rdi
nop
nop
nop
sub $37085, %rcx
...
nop
sub %rax, %rax
lea addresses_WT_ht+0x1bf5, %rcx
nop
nop
and %r10, %r10
mov (%rcx), %edx
...
// Store
lea addresses_normal+0x178f5, %rsi
sub %r15, %r15
...
{'src': {'type': 'addresses_WT_ht', 'congruent': 0, 'same': True}, 'dst': {'type': 'addresses_normal_ht', 'congruent': 7, 'same': False}, 'OP': 'REPM'}
...
{'src': {'type': 'addresses_WC_ht', 'congruent': 7, 'same': False}, 'dst': {'type': 'addresses_D_ht', 'congruent': 1, 'same': False}, 'OP': 'REPM'}
