...
push %rdi
push %rsi
lea addresses_D_ht+0x2bb5, %rax
nop
and %r10, %r10
movb (%rax), %r14b
nop
xor %r8, %r8
lea addresses_D_ht+0x12890, %rsi
lea addresses_WT_ht+0x7ae7, %rdi
nop
nop
cmp %r13, %r13
mov $52, %rcx
...
nop
inc %rsi
lea addresses_UC_ht+0xcb23, %rcx
sub $19488, %r8
movw $0x6162, (%rcx)
nop
nop
cmp %rcx, %rcx
lea addresses_UC_ht+0x4727, %rax
clflush (%rax)
nop
nop
nop
...
nop
xor %rcx, %rcx
lea addresses_normal_ht+0xa6f7, %r14
clflush (%r14)
dec %rdi
movb $0x61, (%r14)
nop
inc %r10
lea addresses_WT_ht+0x78e7, %rcx
nop
nop
inc %r10
mov $0x6162636465666768, %r8
...
nop
mfence
lea addresses_UC_ht+0xb19d, %rsi
lea addresses_D_ht+0x68c7, %rdi
clflush (%rdi)
nop
nop
nop
...
nop
sub $61174, %rsi
lea addresses_WT_ht+0x16467, %r13
add $44182, %r8
movw $0x6162, (%r13)
nop
nop
...
lea addresses_WC_ht+0xea67, %rdi
nop
nop
nop
dec %rax
...
{'src': {'type': 'addresses_D_ht', 'congruent': 0, 'same': False}, 'OP': 'REPM', 'dst': {'type': 'addresses_WT_ht', 'congruent': 4, 'same': False}}
...
{'src': {'type': 'addresses_UC_ht', 'congruent': 0, 'same': False}, 'OP': 'REPM', 'dst': {'type': 'addresses_D_ht', 'congruent': 4, 'same': False}}
{'OP': 'STOR', 'dst': {'same': False, 'congruent': 11, 'NT': False, 'type': 'addresses_WT_ht', 'size': 2, 'AVXalign': False}}
{'src': {'type': 'addresses_D_ht', 'congruent': 5, 'same': False}, 'OP': 'REPM', 'dst': {'type': 'addresses_WC_ht', 'congruent': 9, 'same': False}}
{'00': 21829}
