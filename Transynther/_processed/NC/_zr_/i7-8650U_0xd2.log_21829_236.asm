...
lea addresses_normal_ht+0x13f20, %rdi
nop
and $23602, %r12
mov $11, %rcx
rep movsb
...
nop
cmp %r12, %r12
lea addresses_WC_ht+0x2ee0, %rsi
clflush (%rsi)
nop
and $62059, %rcx
movb $0x61, (%rsi)
...
nop
cmp $23282, %rbx
lea addresses_WC_ht+0x1a8e0, %rsi
lea addresses_WC_ht+0x3860, %rdi
cmp $3746, %r10
mov $125, %rcx
rep movsq
and %rcx, %rcx
lea addresses_UC_ht+0xa620, %rdi
nop
nop
nop
cmp %r10, %r10
...
nop
cmp $44878, %rbp
lea addresses_UC_ht+0x2840, %rdi
nop
nop
nop
xor %rbp, %rbp
...
nop
and %r10, %r10
lea addresses_normal_ht+0x1cae0, %rsi
sub %rbp, %rbp
mov (%rsi), %rcx
nop
nop
...
nop
cmp $13256, %rdi
lea addresses_UC_ht+0x1ab60, %r12
nop
xor %r9, %r9
mov (%r12), %si
nop
...
nop
add $48043, %rsi
lea addresses_WT_ht+0x6be0, %rbp
nop
and $11248, %r10
movw $0x6162, (%rbp)
nop
...
{'OP': 'STOR', 'dst': {'type': 'addresses_D_ht', 'size': 4, 'AVXalign': True, 'NT': False, 'congruent': 1, 'same': False}}
...
{'OP': 'REPM', 'src': {'type': 'addresses_D_ht', 'congruent': 3, 'same': False}, 'dst': {'type': 'addresses_UC_ht', 'congruent': 2, 'same': True}}
{'00': 21829}
