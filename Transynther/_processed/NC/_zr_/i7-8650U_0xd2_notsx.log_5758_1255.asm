...
push %rdx
push %rsi
lea addresses_WC_ht+0x16a86, %r11
nop
nop
nop
nop
...
nop
add %r15, %r15
lea addresses_D_ht+0x1ef86, %rbx
nop
nop
nop
nop
...
nop
dec %rbx
lea addresses_WT_ht+0xa806, %rsi
lea addresses_WT_ht+0x5a26, %rdi
nop
nop
nop
add %r13, %r13
...
rep movsl
cmp %rdx, %rdx
lea addresses_WC_ht+0xf9e6, %r11
xor $21882, %r13
...
nop
sub $12572, %rbx
lea addresses_WT_ht+0x1e786, %rcx
clflush (%rcx)
sub $41701, %rdx
mov (%rcx), %rsi
nop
...
nop
xor $27114, %rbx
lea addresses_normal_ht+0x5081, %rsi
...
// Load
lea addresses_normal+0x73ae, %rdi
nop
nop
nop
xor %r10, %r10
...
{'OP': 'LOAD', 'src': {'type': 'addresses_normal', 'size': 8, 'AVXalign': False, 'NT': False, 'congruent': 3, 'same': False}}
...
{'OP': 'REPM', 'src': {'type': 'addresses_WT_ht', 'congruent': 7, 'same': True}, 'dst': {'type': 'addresses_WT_ht', 'congruent': 4, 'same': False}}
