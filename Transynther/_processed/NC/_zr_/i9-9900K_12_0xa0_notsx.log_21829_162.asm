...
push %rdx
push %rsi
lea addresses_normal_ht+0x1acd0, %r8
nop
nop
add $63376, %r14
vmovups (%r8), %ymm1
...
movups %xmm7, (%rdx)
cmp %r8, %r8
lea addresses_WT_ht+0x1ef30, %r9
clflush (%r9)
and $36908, %rsi
mov (%r9), %r12w
nop
nop
dec %rdx
lea addresses_WC_ht+0x197ce, %rsi
lea addresses_UC_ht+0x49d0, %rdi
nop
nop
nop
nop
...
nop
xor %r12, %r12
lea addresses_A_ht+0x1345c, %rsi
nop
nop
nop
nop
...
movq %rdx, (%rsi)
cmp %r8, %r8
lea addresses_A_ht+0x4330, %rsi
lea addresses_WT_ht+0x3330, %rdi
nop
nop
nop
nop
...
nop
sub $60196, %r9
lea addresses_A_ht+0xcc30, %rdx
nop
cmp $26865, %r9
mov (%rdx), %r12d
nop
inc %r8
lea addresses_WT_ht+0x7b60, %r12
nop
nop
nop
nop
...
vpextrq $0, %xmm1, %r14
sub %rdi, %rdi
lea addresses_normal_ht+0xd630, %r9
cmp %r14, %r14
movw $0x6162, (%r9)
nop
nop
nop
add %rdi, %rdi
lea addresses_A_ht+0x1a04d, %r12
nop
nop
nop
nop
...
vmovups %ymm6, (%r12)
xor %rsi, %rsi
lea addresses_WC_ht+0x9530, %r14
nop
nop
nop
nop
...
{'src': {'type': 'addresses_WT_ht', 'AVXalign': False, 'size': 2, 'NT': True, 'same': False, 'congruent': 10}, 'OP': 'LOAD'}
...
{'OP': 'STOR', 'dst': {'type': 'addresses_normal_ht', 'AVXalign': False, 'size': 2, 'NT': True, 'same': False, 'congruent': 8}}
