...
push %rdi
push %rsi
lea addresses_A_ht+0x10a6c, %rsi
nop
nop
nop
nop
...
nop
xor %rcx, %rcx
lea addresses_WC_ht+0xd32c, %rcx
clflush (%rcx)
nop
nop
nop
...
nop
dec %rbx
lea addresses_WT_ht+0xf6ac, %rsi
lea addresses_normal_ht+0x5a8c, %rdi
clflush (%rdi)
nop
nop
nop
...
nop
and $40443, %rbx
lea addresses_WC_ht+0x136ac, %rsi
lea addresses_D_ht+0x3e98, %rdi
nop
nop
nop
nop
...
nop
add %rcx, %rcx
lea addresses_WT_ht+0x122ac, %rsi
nop
nop
nop
inc %r15
...
nop
xor %r9, %r9
lea addresses_normal_ht+0x43a8, %rdi
nop
nop
dec %rcx
...
nop
add $10785, %rax
lea addresses_UC_ht+0x1d2ac, %rax
clflush (%rax)
and %rdi, %rdi
movl $0x61626364, (%rax)
nop
...
// Store
lea addresses_D+0xd4cc, %r8
add $56021, %r15
movb $0x51, (%r8)
add %r9, %r9

// Load
lea addresses_WC+0x64ac, %r14
clflush (%r14)
and $10321, %r9
mov (%r14), %rax
cmp %rbp, %rbp
...
{'OP': 'LOAD', 'src': {'type': 'addresses_WC', 'AVXalign': True, 'congruent': 9, 'size': 8, 'same': False, 'NT': False}}
[Faulty Load]
