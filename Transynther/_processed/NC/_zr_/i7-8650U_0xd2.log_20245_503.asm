...
nop
sub %r9, %r9
lea addresses_normal_ht+0xb305, %rsi
nop
nop
nop
nop
...
nop
sub %rsi, %rsi
lea addresses_normal_ht+0x12045, %rsi
clflush (%rsi)
nop
cmp %r15, %r15
...
nop
and $56695, %rsi
lea addresses_WC_ht+0x17a05, %rsi
lea addresses_WC_ht+0x15a45, %rdi
nop
nop
dec %r15
mov $46, %rcx
...
nop
add %r10, %r10
lea addresses_UC_ht+0x1b905, %r10
nop
nop
nop
nop
...
movups %xmm4, (%r9)
and %r15, %r15
lea addresses_WC_ht+0x1b54a, %r10
nop
nop
nop
nop
...
nop
inc %r9
lea addresses_UC_ht+0x18c05, %rbp
nop
nop
cmp $13436, %r9
mov (%rbp), %rdi
dec %r9
lea addresses_WT_ht+0x9005, %rbx
nop
dec %r15
mov $0x6162636465666768, %r10
movq %r10, %xmm1
...
nop
cmp $6661, %rdi
lea addresses_D_ht+0x11805, %r15
clflush (%r15)
nop
nop
and %rbp, %rbp
