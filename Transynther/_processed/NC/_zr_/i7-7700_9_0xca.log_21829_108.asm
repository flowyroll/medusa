...
push %rdi
push %rsi
lea addresses_UC_ht+0x61f4, %r11
nop
add $178, %r15
movb (%r11), %al
nop
add $64380, %r15
lea addresses_WT_ht+0xdc54, %r9
clflush (%r9)
nop
nop
nop
...
rep movsw
sub %r9, %r9
lea addresses_UC_ht+0xb354, %rsi
lea addresses_WC_ht+0x49f4, %rdi
xor %r9, %r9
mov $33, %rcx
rep movsw
nop
nop
xor %r11, %r11
lea addresses_A_ht+0x1254, %rsi
lea addresses_D_ht+0x179f4, %rdi
nop
xor %r9, %r9
mov $5, %rcx
rep movsw
...
nop
xor %rax, %rax
lea addresses_WT_ht+0xdbe4, %rcx
clflush (%rcx)
dec %r15
...
nop
sub $43658, %rcx
lea addresses_normal_ht+0xf974, %r9
xor $234, %rbp
...
nop
add %rbp, %rbp
lea addresses_D_ht+0x1a7f4, %rsi
lea addresses_normal_ht+0xb64a, %rdi
nop
nop
nop
add $64224, %r11
...
lea addresses_UC_ht+0x113f4, %rdi
nop
nop
nop
nop
...
{'src': {'congruent': 4, 'same': False, 'type': 'addresses_UC_ht'}, 'OP': 'REPM', 'dst': {'congruent': 7, 'same': False, 'type': 'addresses_WC_ht'}}
...
{'src': {'congruent': 9, 'same': True, 'type': 'addresses_D_ht'}, 'OP': 'REPM', 'dst': {'congruent': 0, 'same': False, 'type': 'addresses_normal_ht'}}
