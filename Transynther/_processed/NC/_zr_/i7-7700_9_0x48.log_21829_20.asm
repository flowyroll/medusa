...
push %rdx
push %rsi
lea addresses_normal_ht+0x3eb4, %rdi
nop
sub %rdx, %rdx
movl $0x61626364, (%rdi)
nop
...
nop
sub %rcx, %rcx
lea addresses_D_ht+0xa3f4, %rsi
lea addresses_normal_ht+0x107f4, %rdi
nop
nop
nop
cmp %rax, %rax
...
nop
sub %rdx, %rdx
lea addresses_WC_ht+0x17df4, %rsi
...
rep movsw
add %rax, %rax
lea addresses_D_ht+0x1e874, %rdi
nop
nop
nop
nop
...
nop
cmp %r14, %r14
lea addresses_D_ht+0x15842, %rdi
nop
nop
nop
nop
...
nop
and %rax, %rax
lea addresses_A_ht+0x104dc, %r14
nop
nop
dec %r10
...
movups %xmm3, (%r14)
xor %rdi, %rdi
lea addresses_WC_ht+0x1d1d4, %rsi
lea addresses_normal_ht+0xf874, %rdi
nop
nop
nop
nop
...
nop
cmp %rbp, %rbp
lea addresses_WC_ht+0x1d374, %rax
add $54988, %rdx
movl $0x61626364, (%rax)
nop
nop
...
nop
sub %r14, %r14
lea addresses_WC_ht+0x19df4, %rsi
nop
nop
nop
nop
...
nop
and $8200, %rdx
lea addresses_UC_ht+0xb174, %rdi
clflush (%rdi)
nop
nop
nop
...
movl $0x61626364, (%rdi)
and %r10, %r10
lea addresses_WT_ht+0x1e5e0, %rdx
nop
and %rbp, %rbp
mov (%rdx), %cx
sub $34, %rax
...
<gen_prepare_buffer>
{'OP': 'STOR', 'dst': {'type': 'addresses_normal_ht', 'AVXalign': False, 'congruent': 6, 'size': 4, 'same': False, 'NT': True}}
...
{'OP': 'STOR', 'dst': {'type': 'addresses_UC_ht', 'AVXalign': False, 'congruent': 0, 'size': 4, 'same': True, 'NT': False}}
