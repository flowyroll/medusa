...
push %rdi
push %rsi
lea addresses_UC_ht+0x19bab, %rsi
lea addresses_UC_ht+0x1caab, %rdi
add %rbp, %rbp
mov $24, %rcx
rep movsq
nop
...
nop
sub $31813, %rsi
lea addresses_WT_ht+0x4aab, %r14
nop
nop
nop
dec %r15
...
nop
cmp $8990, %r15
lea addresses_UC_ht+0xd94b, %rdi
clflush (%rdi)
sub $38233, %r15
movb (%rdi), %cl
nop
cmp %rsi, %rsi
lea addresses_D_ht+0x1449, %rsi
...
nop
and $51858, %r14
lea addresses_UC_ht+0x8e9b, %rsi
...
nop
xor %rbp, %rbp
lea addresses_A_ht+0x15cab, %rcx
clflush (%rcx)
nop
add $11743, %r14
...
nop
sub $4252, %rcx
lea addresses_UC_ht+0x76db, %rsi
lea addresses_WC_ht+0xecab, %rdi
nop
xor %r12, %r12
mov $90, %rcx
rep movsl
...
{'src': {'type': 'addresses_UC_ht', 'congruent': 4, 'same': True}, 'dst': {'type': 'addresses_WC_ht', 'congruent': 8, 'same': True}, 'OP': 'REPM'}
{'00': 1706}
