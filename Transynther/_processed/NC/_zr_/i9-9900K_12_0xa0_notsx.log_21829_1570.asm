...
nop
lfence
lea addresses_WT_ht+0x1ae20, %rsi
lea addresses_UC_ht+0x73ca, %rdi
nop
nop
nop
and $55607, %r10
...
nop
add %r10, %r10
lea addresses_WC_ht+0x1d324, %rcx
and %r13, %r13
movw $0x6162, (%rcx)
nop
xor %rcx, %rcx
lea addresses_A_ht+0xc738, %rsi
lea addresses_WT_ht+0x16738, %rdi
nop
nop
nop
nop
...
nop
sub %r13, %r13
lea addresses_WT_ht+0x19338, %rsi
lea addresses_D_ht+0x16178, %rdi
clflush (%rsi)
nop
nop
nop
...
nop
cmp %r12, %r12
lea addresses_WC_ht+0xfb38, %r15
nop
nop
nop
nop
...
// REPMOV
lea addresses_normal+0x11f38, %rsi
lea addresses_D+0xf938, %rdi
clflush (%rsi)
nop
nop
nop
...
{'src': {'type': 'addresses_D', 'AVXalign': False, 'size': 1, 'NT': False, 'same': False, 'congruent': 3}, 'OP': 'LOAD'}
...
{'src': {'type': 'addresses_A_ht', 'congruent': 11, 'same': True}, 'OP': 'REPM', 'dst': {'type': 'addresses_WT_ht', 'congruent': 11, 'same': False}}
