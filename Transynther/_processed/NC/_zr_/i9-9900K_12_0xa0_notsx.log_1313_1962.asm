...
push %rdi
push %rsi
lea addresses_WT_ht+0xd622, %r11
nop
cmp $48935, %r12
movb $0x61, (%r11)
and %r8, %r8
lea addresses_UC_ht+0xd432, %rsi
lea addresses_WC_ht+0x8cf2, %rdi
nop
nop
nop
add %r9, %r9
...
rep movsl
inc %r8
lea addresses_D_ht+0x36c2, %r9
add $31628, %rcx
movw $0x6162, (%r9)
nop
cmp $1820, %r11
lea addresses_WC_ht+0x1a792, %rsi
lea addresses_A_ht+0x9a6a, %rdi
nop
nop
nop
xor %r15, %r15
...
// Load
mov $0x1b88430000000b52, %r11
sub %rcx, %rcx
mov (%r11), %r8w
and $6155, %r8

// Store
lea addresses_normal+0x10cc2, %r11
clflush (%r11)
nop
nop
nop
...
{'src': {'type': 'addresses_NC', 'AVXalign': False, 'size': 2, 'NT': True, 'same': False, 'congruent': 6}, 'OP': 'LOAD'}
