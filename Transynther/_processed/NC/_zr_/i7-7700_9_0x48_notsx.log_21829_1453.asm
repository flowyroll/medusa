...
nop
sub $16230, %r12
lea addresses_WC_ht+0x1c1ed, %r8
sub %rsi, %rsi
mov (%r8), %ax
nop
mfence
lea addresses_WC_ht+0x13f67, %rcx
nop
and $24784, %r10
mov (%rcx), %r12d
nop
...
nop
add $30557, %r11
lea addresses_A_ht+0x2cd3, %rsi
lea addresses_UC_ht+0x1d49, %rdi
nop
nop
nop
nop
...
{'dst': {'same': True, 'NT': True, 'AVXalign': False, 'size': 16, 'type': 'addresses_WC', 'congruent': 2}, 'OP': 'STOR'}
[Faulty Load]
...
{'dst': {'same': False, 'congruent': 1, 'type': 'addresses_UC_ht'}, 'OP': 'REPM', 'src': {'same': False, 'congruent': 1, 'type': 'addresses_A_ht'}}
{'00': 21829}
