...
push %rdx
push %rsi
lea addresses_normal_ht+0x16576, %rcx
clflush (%rcx)
nop
nop
nop
...
nop
dec %r11
lea addresses_WC_ht+0xf976, %rsi
cmp %r12, %r12
vmovups (%rsi), %ymm4
...
nop
dec %rcx
lea addresses_normal_ht+0x10a76, %rdx
nop
nop
nop
and $63305, %r12
...
nop
dec %r14
lea addresses_D_ht+0x18a76, %rsi
lea addresses_WT_ht+0x6abe, %rdi
clflush (%rsi)
clflush (%rdi)
nop
nop
...
// Store
lea addresses_normal+0x11cb6, %rdx
nop
nop
nop
nop
...
{'OP': 'STOR', 'dst': {'same': False, 'type': 'addresses_RW', 'NT': True, 'AVXalign': True, 'size': 32, 'congruent': 0}}
...
<gen_prepare_buffer>
{'OP': 'STOR', 'dst': {'same': True, 'type': 'addresses_normal_ht', 'NT': False, 'AVXalign': False, 'size': 32, 'congruent': 5}}
