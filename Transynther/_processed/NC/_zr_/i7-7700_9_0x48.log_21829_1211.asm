...
nop
add $24137, %rdi
lea addresses_WT_ht+0x13118, %rdi
nop
nop
cmp %r8, %r8
mov (%rdi), %r13w
...
nop
and %r9, %r9
lea addresses_A_ht+0x1de58, %rsi
lea addresses_UC_ht+0x1dd18, %rdi
nop
nop
nop
nop
...
rep movsw
add $46835, %rdx
lea addresses_WC_ht+0x22d4, %rsi
lea addresses_WC_ht+0x14618, %rdi
clflush (%rdi)
nop
nop
nop
...
rep movsl
dec %r9
lea addresses_D_ht+0x10b8, %rsi
lea addresses_UC_ht+0x6518, %rdi
nop
nop
nop
xor %r10, %r10
...
nop
add %r13, %r13
lea addresses_UC_ht+0x10618, %r8
clflush (%r8)
nop
nop
xor %rcx, %rcx
