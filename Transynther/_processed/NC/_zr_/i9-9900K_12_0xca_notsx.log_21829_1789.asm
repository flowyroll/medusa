...
nop
xor $34473, %rdi
lea addresses_D_ht+0x10b01, %rsi
lea addresses_WC_ht+0x8789, %rdi
clflush (%rdi)
nop
nop
inc %r12
...
rep movsl
sub %rbx, %rbx
lea addresses_WC_ht+0x17901, %rdi
nop
sub $34901, %r12
movups (%rdi), %xmm6
vpextrq $1, %xmm6, %r11
nop
inc %rsi
lea addresses_WT_ht+0x1a901, %rbx
nop
nop
add %rcx, %rcx
mov (%rbx), %r12w
...
nop
add $26863, %rcx
lea addresses_D_ht+0x13320, %rsi
lea addresses_A_ht+0x4701, %rdi
nop
nop
nop
cmp $48175, %r14
...
nop
xor %rdi, %rdi
lea addresses_WT_ht+0xb901, %r14
nop
nop
nop
nop
...
nop
add $50414, %rdx
lea addresses_normal_ht+0x168cc, %rdx
nop
nop
nop
nop
...
nop
add %rsi, %rsi
lea addresses_WT_ht+0x1e2cd, %rdi
nop
nop
cmp %rbx, %rbx
mov (%rdi), %rsi
...
nop
and %rcx, %rcx
lea addresses_D_ht+0x12701, %r12
nop
nop
nop
nop
...
nop
cmp $10770, %rdi
lea addresses_WT_ht+0x1ab01, %rsi
lea addresses_normal_ht+0x1ae87, %rdi
nop
nop
nop
xor %rdx, %rdx
...
// REPMOV
lea addresses_UC+0x140c1, %rsi
lea addresses_UC+0xe8f9, %rdi
nop
nop
sub $30668, %rax
mov $113, %rcx
...
{'OP': 'REPM', 'src': {'same': False, 'congruent': 5, 'type': 'addresses_UC'}, 'dst': {'same': False, 'congruent': 3, 'type': 'addresses_UC'}}
[Faulty Load]
...
{'OP': 'REPM', 'src': {'same': False, 'congruent': 6, 'type': 'addresses_WC_ht'}, 'dst': {'same': True, 'congruent': 9, 'type': 'addresses_A_ht'}}
...
{'OP': 'LOAD', 'src': {'same': False, 'type': 'addresses_WT_ht', 'NT': True, 'AVXalign': False, 'size': 2, 'congruent': 9}}
{'OP': 'LOAD', 'src': {'same': False, 'type': 'addresses_D_ht', 'NT': False, 'AVXalign': False, 'size': 8, 'congruent': 0}}
{'OP': 'REPM', 'src': {'same': False, 'congruent': 0, 'type': 'addresses_D_ht'}, 'dst': {'same': False, 'congruent': 11, 'type': 'addresses_A_ht'}}
...
{'OP': 'STOR', 'dst': {'same': True, 'type': 'addresses_A_ht', 'NT': False, 'AVXalign': False, 'size': 8, 'congruent': 8}}
{'00': 21829}
