...
push %rdx
push %rsi
lea addresses_normal_ht+0x9d97, %rax
nop
nop
xor $15265, %rbp
movl $0x61626364, (%rax)
...
nop
sub $18087, %r11
lea addresses_A_ht+0x12661, %rdx
nop
dec %r10
vmovups (%rdx), %ymm6
...
nop
cmp %r13, %r13
lea addresses_UC_ht+0x9e97, %rax
xor %rbx, %rbx
...
nop
cmp %r13, %r13
lea addresses_normal_ht+0x175e1, %r11
nop
nop
and $55852, %rax
movb (%r11), %bl
nop
cmp %r13, %r13
lea addresses_UC_ht+0x18261, %r11
nop
cmp %r10, %r10
mov (%r11), %ebx
nop
...
nop
dec %r11
lea addresses_A_ht+0x14261, %rsi
lea addresses_A_ht+0x1e7c1, %rdi
clflush (%rdi)
sub %rbp, %rbp
mov $6, %rcx
rep movsw
...
nop
xor $29879, %rdx
lea addresses_normal_ht+0x4261, %rsi
lea addresses_WC_ht+0x10a1, %rdi
clflush (%rdi)
xor %r11, %r11
mov $118, %rcx
rep movsb
...
nop
add %rax, %rax
lea addresses_WT_ht+0x18261, %rdx
nop
nop
nop
inc %rbx
...
nop
add $42414, %r10
lea addresses_A_ht+0x96e1, %rsi
lea addresses_A_ht+0xe59d, %rdi
nop
add %rdx, %rdx
mov $8, %rcx
rep movsq
...
nop
cmp $48273, %r11
lea addresses_WC_ht+0x1e969, %rsi
clflush (%rsi)
nop
nop
nop
...
{'src': {'same': False, 'congruent': 8, 'NT': True, 'type': 'addresses_WT', 'size': 8, 'AVXalign': True}, 'OP': 'LOAD'}
[Faulty Load]
...
{'OP': 'STOR', 'dst': {'same': False, 'congruent': 1, 'NT': True, 'type': 'addresses_UC_ht', 'size': 16, 'AVXalign': False}}
{'src': {'same': False, 'congruent': 5, 'NT': True, 'type': 'addresses_normal_ht', 'size': 1, 'AVXalign': True}, 'OP': 'LOAD'}
