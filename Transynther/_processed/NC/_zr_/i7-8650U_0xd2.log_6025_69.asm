...
push %rdx
push %rsi
lea addresses_UC_ht+0x1344c, %rax
nop
nop
nop
nop
...
nop
cmp %rax, %rax
lea addresses_D_ht+0x19a2a, %rsi
nop
add %rdi, %rdi
movb (%rsi), %al
nop
...
{'OP': 'STOR', 'dst': {'type': 'addresses_P', 'size': 32, 'AVXalign': True, 'NT': False, 'congruent': 11, 'same': False}}
[Faulty Load]
