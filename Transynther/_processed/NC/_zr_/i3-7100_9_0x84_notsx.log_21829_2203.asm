...
push %rdi
push %rsi
lea addresses_normal_ht+0x1a76c, %rbp
cmp %r14, %r14
movl $0x61626364, (%rbp)
nop
nop
inc %rax
lea addresses_normal_ht+0x16854, %rbx
nop
nop
nop
nop
...
nop
sub $61899, %rbx
lea addresses_A_ht+0x176c, %r8
nop
inc %rsi
movw $0x6162, (%r8)
xor $42076, %r14
lea addresses_WT_ht+0xa96c, %rsi
lea addresses_WC_ht+0xd36c, %rdi
nop
nop
nop
xor %r15, %r15
...
nop
sub $38371, %r14
lea addresses_D_ht+0xc7f2, %rsi
lea addresses_normal_ht+0xbd2c, %rdi
nop
nop
and $18376, %r15
mov $71, %rcx
...
nop
dec %r8
lea addresses_A_ht+0x10f24, %r15
nop
nop
cmp %rsi, %rsi
movw $0x6162, (%r15)
nop
sub $57933, %rax
lea addresses_normal_ht+0x186cc, %r15
nop
nop
nop
nop
...
nop
sub $8849, %rbx
lea addresses_A_ht+0x144cc, %rsi
nop
nop
inc %r15
mov (%rsi), %r14d
...
{'src': {'type': 'addresses_WT_ht', 'congruent': 9, 'same': True}, 'dst': {'type': 'addresses_WC_ht', 'congruent': 10, 'same': False}, 'OP': 'REPM'}
...
{'dst': {'type': 'addresses_A_ht', 'same': False, 'size': 2, 'congruent': 2, 'NT': True, 'AVXalign': True}, 'OP': 'STOR'}
