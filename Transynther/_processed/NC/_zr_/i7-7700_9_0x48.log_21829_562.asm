...
push %rdi
push %rsi
lea addresses_A_ht+0x113b, %rsi
nop
nop
add %r15, %r15
mov (%rsi), %r8w
dec %rdi
lea addresses_D_ht+0x9f19, %rax
nop
nop
nop
add $38884, %rcx
movb $0x61, (%rax)
xor %r15, %r15
lea addresses_WC_ht+0x18703, %rsi
lea addresses_A_ht+0x6ffb, %rdi
nop
nop
add $15988, %r13
mov $28, %rcx
...
nop
sub $48925, %rax
lea addresses_A_ht+0x1d141, %rsi
lea addresses_UC_ht+0x1063b, %rdi
nop
nop
nop
nop
...
nop
sub $32921, %rdi
lea addresses_A_ht+0x1341b, %rdi
nop
nop
and $43605, %rsi
...
nop
and %r15, %r15
lea addresses_normal_ht+0x16dbb, %rsi
nop
nop
nop
mfence
...
nop
xor %r13, %r13
lea addresses_UC_ht+0x81fb, %rbx
inc %rsi
...
nop
xor %rcx, %rcx
lea addresses_WC_ht+0x1561f, %rsi
inc %r13
mov (%rsi), %di
nop
nop
cmp $17261, %r8
lea addresses_UC_ht+0x1a9bb, %r15
nop
nop
nop
nop
...
{'OP': 'LOAD', 'src': {'type': 'addresses_NC', 'AVXalign': False, 'congruent': 5, 'size': 2, 'same': False, 'NT': False}}
...
<gen_prepare_buffer>
{'OP': 'LOAD', 'src': {'type': 'addresses_A_ht', 'AVXalign': False, 'congruent': 7, 'size': 2, 'same': False, 'NT': True}}
...
{'OP': 'REPM', 'src': {'type': 'addresses_UC_ht', 'congruent': 5, 'same': False}, 'dst': {'type': 'addresses_D_ht', 'congruent': 8, 'same': False}}
