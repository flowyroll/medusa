...
mov (%rbx), %r15w
inc %rbx
lea addresses_UC_ht+0x1d7e6, %r10
nop
and $18967, %rdi
movups (%r10), %xmm3
vpextrq $1, %xmm3, %rbx
...
nop
sub %r8, %r8
lea addresses_UC_ht+0x7637, %rsi
lea addresses_UC_ht+0x18a43, %rdi
nop
nop
cmp $42627, %r10
mov $116, %rcx
...
nop
and $47437, %rax
lea addresses_A_ht+0x13d57, %rbx
nop
nop
cmp $48528, %rcx
mov (%rbx), %r10
nop
and $39755, %r8
lea addresses_WT_ht+0x14557, %r8
nop
add $58079, %rsi
...
{'src': {'congruent': 5, 'same': False, 'type': 'addresses_UC_ht'}, 'OP': 'REPM', 'dst': {'congruent': 1, 'same': False, 'type': 'addresses_UC_ht'}}
{'src': {'congruent': 4, 'AVXalign': False, 'same': False, 'size': 8, 'NT': False, 'type': 'addresses_A_ht'}, 'OP': 'LOAD'}
{'OP': 'STOR', 'dst': {'congruent': 6, 'AVXalign': False, 'same': False, 'size': 8, 'NT': True, 'type': 'addresses_WT_ht'}}
{'00': 21829}
