...
push %rdx
push %rsi
lea addresses_WT_ht+0x14a9c, %rdi
nop
nop
nop
nop
...
nop
cmp $18586, %rsi
lea addresses_UC_ht+0x1a10c, %rsi
lea addresses_WC_ht+0x3e9c, %rdi
nop
xor $4682, %rax
mov $78, %rcx
rep movsq
...
nop
cmp $36538, %rcx
lea addresses_UC_ht+0x1241c, %rdi
nop
nop
inc %rdx
vmovups (%rdi), %ymm2
...
vpextrq $1, %xmm2, %rcx
add $182, %r12
lea addresses_A_ht+0x1c39c, %rsi
lea addresses_WT_ht+0xf89c, %rdi
and $61426, %r13
mov $66, %rcx
rep movsl
nop
nop
inc %rdx
lea addresses_UC_ht+0xa29c, %r10
nop
nop
nop
nop
...
nop
and %rdi, %rdi
lea addresses_D_ht+0x1519c, %r12
nop
sub %r13, %r13
...
nop
cmp $47933, %rcx
lea addresses_normal_ht+0x1c0dc, %r13
nop
xor $48939, %rcx
movw $0x6162, (%r13)
nop
...
nop
and $54769, %rsi
lea addresses_normal_ht+0x1734e, %r10
clflush (%r10)
inc %r12
mov (%r10), %di
nop
xor $29674, %rsi
lea addresses_WC_ht+0x19afe, %rdx
nop
nop
dec %rax
mov (%rdx), %edi
...
lea addresses_normal_ht+0x16a9c, %rdi
clflush (%rdi)
nop
nop
nop
...
nop
cmp $38312, %rax
lea addresses_A_ht+0x1549c, %rsi
lea addresses_normal_ht+0x18a9c, %rdi
nop
nop
nop
nop
...
nop
xor %rcx, %rcx
lea addresses_WC_ht+0x1e5bc, %r10
nop
nop
nop
sub %rax, %rax
...
nop
dec %rax
lea addresses_WC_ht+0x19353, %rdx
nop
nop
and %r13, %r13
...
nop
sub $54282, %r12
lea addresses_normal_ht+0x1015c, %r10
nop
nop
nop
nop
...
nop
cmp %r13, %r13
lea addresses_WC_ht+0x1d5fc, %rdi
nop
nop
cmp $13980, %rcx
movb (%rdi), %dl
...
{'OP': 'REPM', 'src': {'type': 'addresses_UC_ht', 'congruent': 4, 'same': False}, 'dst': {'type': 'addresses_WC_ht', 'congruent': 10, 'same': True}}
...
{'OP': 'STOR', 'dst': {'type': 'addresses_UC_ht', 'AVXalign': False, 'congruent': 11, 'size': 8, 'same': False, 'NT': True}}
{'OP': 'STOR', 'dst': {'type': 'addresses_D_ht', 'AVXalign': False, 'congruent': 8, 'size': 8, 'same': False, 'NT': False}}
{'OP': 'STOR', 'dst': {'type': 'addresses_normal_ht', 'AVXalign': True, 'congruent': 5, 'size': 2, 'same': True, 'NT': False}}
{'OP': 'LOAD', 'src': {'type': 'addresses_normal_ht', 'AVXalign': False, 'congruent': 1, 'size': 2, 'same': True, 'NT': False}}
{'OP': 'LOAD', 'src': {'type': 'addresses_WC_ht', 'AVXalign': True, 'congruent': 1, 'size': 4, 'same': False, 'NT': False}}
{'OP': 'REPM', 'src': {'type': 'addresses_D_ht', 'congruent': 3, 'same': False}, 'dst': {'type': 'addresses_normal_ht', 'congruent': 9, 'same': False}}
