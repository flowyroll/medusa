...
push %rdi
push %rsi
lea addresses_UC_ht+0x1c475, %rbp
xor %rsi, %rsi
...
movb $0x61, (%rax)
dec %rcx
lea addresses_A_ht+0x19ad3, %rsi
...
// Store
lea addresses_PSE+0x1a945, %rcx
sub $33789, %r10
movw $0x5152, (%rcx)
and $35128, %rbx

// Faulty Load
mov $0x7386a0000000c75, %rbx
nop
nop
sub $56082, %r15
mov (%rbx), %rax
...
{'src': {'congruent': 1, 'same': False, 'type': 'addresses_A_ht'}, 'dst': {'congruent': 9, 'same': False, 'type': 'addresses_WC_ht'}, 'OP': 'REPM'}
{'00': 21829}
