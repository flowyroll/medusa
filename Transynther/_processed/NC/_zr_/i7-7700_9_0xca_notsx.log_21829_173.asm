...
movw $0x6162, (%r15)
add %r14, %r14
lea addresses_WT_ht+0x12580, %rbp
nop
nop
nop
nop
...
movb (%rbp), %r14b
lfence
lea addresses_WC_ht+0x1a00, %rsi
lea addresses_D_ht+0x11d40, %rdi
nop
and %r10, %r10
mov $42, %rcx
rep movsq
...
nop
sub %r9, %r9
lea addresses_normal_ht+0x9380, %r15
nop
nop
nop
nop
...
nop
dec %rsi
lea addresses_WC_ht+0xe380, %rbp
nop
nop
nop
nop
...
movq %r14, (%r9)
add $50040, %rsi
lea addresses_normal_ht+0x9ac8, %r9
clflush (%r9)
and $14268, %rdi
...
movups %xmm4, (%r9)
and $47050, %rbp
lea addresses_WC_ht+0xb980, %rsi
lea addresses_D_ht+0x11068, %rdi
nop
nop
sub %r14, %r14
mov $117, %rcx
rep movsb
xor %r10, %r10
lea addresses_D_ht+0x196c0, %rsi
...
{'src': {'NT': False, 'AVXalign': True, 'size': 1, 'congruent': 10, 'same': True, 'type': 'addresses_WT_ht'}, 'OP': 'LOAD'}
{'src': {'congruent': 7, 'same': False, 'type': 'addresses_WC_ht'}, 'dst': {'congruent': 6, 'same': False, 'type': 'addresses_D_ht'}, 'OP': 'REPM'}
