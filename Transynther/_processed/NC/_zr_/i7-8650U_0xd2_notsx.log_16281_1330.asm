...
push %rdi
push %rsi
lea addresses_D_ht+0xa4d5, %rsi
lea addresses_normal_ht+0xc23f, %rdi
nop
nop
nop
nop
...
nop
dec %r15
lea addresses_WC_ht+0x1e4e7, %r15
cmp %r10, %r10
movb (%r15), %r11b
nop
add %rbp, %rbp
lea addresses_WC_ht+0x158df, %rsi
lea addresses_UC_ht+0x1d5df, %rdi
xor $52381, %r9
mov $48, %rcx
rep movsw
nop
...
nop
and $10134, %r11
lea addresses_UC_ht+0x16ddf, %r15
nop
nop
inc %rsi
movw $0x6162, (%r15)
...
nop
dec %r9
lea addresses_normal_ht+0x1ebdf, %r15
nop
nop
nop
nop
