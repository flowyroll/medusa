...
push %rdi
push %rsi
lea addresses_UC_ht+0x16102, %rsi
lea addresses_D_ht+0x5b02, %rdi
nop
nop
add %r14, %r14
mov $37, %rcx
...
nop
xor %r14, %r14
lea addresses_normal_ht+0xc402, %r12
nop
nop
nop
nop
...
nop
cmp %r14, %r14
lea addresses_UC_ht+0x185c2, %rsi
lea addresses_D_ht+0x148c4, %rdi
nop
nop
nop
and %r13, %r13
...
nop
add $20381, %rdi
lea addresses_UC_ht+0x4b02, %rsi
nop
nop
add %r12, %r12
mov (%rsi), %edi
sub %rcx, %rcx
lea addresses_normal_ht+0xf002, %rcx
nop
nop
nop
dec %rdi
...
nop
add %r13, %r13
lea addresses_D_ht+0x189ba, %rsi
lea addresses_WC_ht+0x7188, %rdi
clflush (%rdi)
nop
nop
nop
...
rep movsw
add $836, %r12
lea addresses_D_ht+0xec42, %rsi
lea addresses_A_ht+0x8862, %rdi
nop
nop
cmp %rbp, %rbp
mov $89, %rcx
...
{'OP': 'STOR', 'dst': {'type': 'addresses_A', 'size': 4, 'AVXalign': True, 'NT': True, 'congruent': 8, 'same': False}}
[Faulty Load]
