...
push %rdi
push %rsi
lea addresses_normal_ht+0x8594, %rsi
lea addresses_UC_ht+0x16914, %rdi
xor $30933, %rbp
mov $123, %rcx
rep movsb
nop
...
nop
xor %r8, %r8
lea addresses_UC_ht+0xb94, %r11
and $46112, %rax
mov $0x6162636465666768, %r8
movq %r8, (%r11)
dec %r11
lea addresses_A_ht+0x18d14, %r11
nop
xor %rcx, %rcx
mov (%r11), %ebp
nop
...
nop
cmp %rsi, %rsi
lea addresses_WC_ht+0x15b84, %rax
nop
nop
nop
nop
...
vmovups %ymm1, (%rdi)
sub %rax, %rax
lea addresses_normal_ht+0x18fd4, %rbp
nop
nop
nop
nop
...
movq %rcx, (%rbp)
and %rcx, %rcx
lea addresses_UC_ht+0x5e14, %rcx
clflush (%rcx)
nop
nop
nop
...
vpextrq $1, %xmm0, %r11
cmp $53144, %rcx
lea addresses_WC_ht+0x6714, %rcx
nop
nop
nop
nop
...
nop
add %rbp, %rbp
lea addresses_WT_ht+0xb565, %rsi
lea addresses_D_ht+0x17654, %rdi
nop
nop
nop
dec %rbp
