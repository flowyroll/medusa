...
movb $0x61, (%r10)
add %r12, %r12
lea addresses_UC_ht+0xb2fe, %rcx
nop
nop
cmp $54039, %rsi
movups (%rcx), %xmm0
...
rep movsw
xor $28896, %r12
lea addresses_A_ht+0xc17e, %rsi
lea addresses_A_ht+0x1c7be, %rdi
nop
nop
sub %r10, %r10
mov $115, %rcx
...
nop
inc %rsi
lea addresses_UC_ht+0x1e37e, %rsi
nop
nop
cmp $6724, %r12
movb (%rsi), %r15b
sub $35510, %rdx
lea addresses_A_ht+0xdf3e, %rsi
lea addresses_WT_ht+0x178fe, %rdi
nop
nop
nop
nop
...
nop
sub %rdx, %rdx
lea addresses_D_ht+0x11d2e, %rsi
lea addresses_WT_ht+0x1829e, %rdi
dec %rdx
mov $108, %rcx
rep movsw
nop
sub %r10, %r10
lea addresses_normal_ht+0x1977e, %rax
nop
nop
nop
nop
...
nop
inc %r12
lea addresses_normal_ht+0x283e, %r12
clflush (%r12)
nop
nop
nop
...
nop
add %r12, %r12
lea addresses_UC_ht+0x1c27e, %rsi
lea addresses_normal_ht+0x11b7e, %rdi
nop
nop
nop
sub %r12, %r12
...
rep movsq
sub %rax, %rax
lea addresses_WC_ht+0x308e, %rsi
lea addresses_A_ht+0xc646, %rdi
nop
nop
nop
nop
...
{'OP': 'LOAD', 'src': {'type': 'addresses_UC_ht', 'AVXalign': True, 'congruent': 11, 'size': 1, 'same': True, 'NT': True}}
