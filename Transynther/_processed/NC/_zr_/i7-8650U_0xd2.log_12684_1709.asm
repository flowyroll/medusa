...
nop
add %r9, %r9
lea addresses_WC_ht+0x16397, %rdx
nop
nop
add %r12, %r12
movups (%rdx), %xmm3
vpextrq $1, %xmm3, %r15
sub %rdx, %rdx
lea addresses_WT_ht+0x15651, %rsi
lea addresses_A_ht+0x19797, %rdi
clflush (%rdi)
nop
nop
dec %r9
...
rep movsq
and %r9, %r9
lea addresses_WC_ht+0x1533d, %r12
nop
nop
and %rsi, %rsi
movb (%r12), %cl
nop
cmp %rbp, %rbp
lea addresses_UC_ht+0x1c2b7, %r9
nop
nop
nop
add $27610, %r12
...
{'OP': 'STOR', 'dst': {'type': 'addresses_RW', 'size': 4, 'AVXalign': True, 'NT': True, 'congruent': 0, 'same': False}}
