...
push %rdi
push %rsi
lea addresses_normal_ht+0x120c, %rbp
clflush (%rbp)
nop
nop
nop
...
movb $0x61, (%rbp)
add %r12, %r12
lea addresses_UC_ht+0x1cb6c, %rsi
lea addresses_A_ht+0xdc4c, %rdi
nop
add $36060, %rbp
mov $93, %rcx
rep movsb
...
nop
sub $59656, %rbp
lea addresses_WC_ht+0x456c, %rsi
lea addresses_D_ht+0x376c, %rdi
clflush (%rsi)
nop
nop
nop
...
nop
add $39065, %r12
lea addresses_normal_ht+0x1bfc, %rsi
nop
nop
nop
nop
...
movb (%rsi), %r12b
cmp %rdi, %rdi
lea addresses_D_ht+0x996c, %r15
add $44576, %rsi
movb (%r15), %r12b
nop
and %rbp, %rbp
lea addresses_A_ht+0xad6c, %rbp
nop
cmp %r11, %r11
...
nop
and %r11, %r11
lea addresses_WC_ht+0x21ec, %rbp
nop
nop
xor $57924, %rdi
movb $0x61, (%rbp)
cmp $43840, %r12
lea addresses_UC_ht+0xf9cd, %r11
clflush (%r11)
nop
nop
nop
...
nop
cmp %rdi, %rdi
lea addresses_WT_ht+0x1713c, %rsi
lea addresses_UC_ht+0x1d4ac, %rdi
nop
inc %r12
mov $58, %rcx
rep movsl
...
nop
inc %rcx
lea addresses_A_ht+0x4f3c, %rsi
lea addresses_D_ht+0x656c, %rdi
nop
nop
nop
and %r10, %r10
...
movb (%rdi), %cl
add %rdi, %rdi
lea addresses_UC_ht+0x510c, %rdi
nop
xor %rcx, %rcx
movups (%rdi), %xmm4
vpextrq $0, %xmm4, %r12
nop
and %rdi, %rdi
lea addresses_WC_ht+0x159ec, %r12
nop
nop
nop
nop
...
{'src': {'type': 'addresses_normal_ht', 'same': True, 'size': 1, 'congruent': 4, 'NT': False, 'AVXalign': True}, 'OP': 'LOAD'}
...
{'src': {'type': 'addresses_WT_ht', 'congruent': 3, 'same': False}, 'dst': {'type': 'addresses_UC_ht', 'congruent': 5, 'same': False}, 'OP': 'REPM'}
