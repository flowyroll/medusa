...
push %rdi
push %rsi
lea addresses_WT_ht+0x1bd1d, %r14
nop
nop
nop
nop
...
nop
xor $31548, %r12
lea addresses_normal_ht+0x1844d, %r14
nop
nop
sub %r15, %r15
movl $0x61626364, (%r14)
nop
and $49740, %r14
lea addresses_UC_ht+0x7507, %rsi
lea addresses_UC_ht+0x15f6d, %rdi
nop
nop
add %r9, %r9
mov $81, %rcx
...
{'src': {'type': 'addresses_UC_ht', 'congruent': 0, 'same': False}, 'OP': 'REPM', 'dst': {'type': 'addresses_UC_ht', 'congruent': 0, 'same': False}}
