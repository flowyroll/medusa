...
push %rdx
push %rsi
lea addresses_normal_ht+0x197d1, %rsi
lea addresses_WC_ht+0x15e51, %rdi
nop
nop
xor $29682, %r13
mov $79, %rcx
...
nop
add %rdx, %rdx
lea addresses_WT_ht+0x1b2f1, %r9
xor %rax, %rax
movl $0x61626364, (%r9)
cmp $10790, %r9
lea addresses_normal_ht+0x48f1, %rsi
lea addresses_UC_ht+0x1aeb1, %rdi
nop
and %rdx, %rdx
mov $0, %rcx
rep movsl
...
nop
cmp %r13, %r13
lea addresses_normal_ht+0x9fd1, %rsi
lea addresses_UC_ht+0x5011, %rdi
nop
nop
nop
nop
...
nop
dec %rdi
lea addresses_normal_ht+0xe9d1, %rsi
lea addresses_normal_ht+0xc011, %rdi
nop
nop
add %rax, %rax
mov $117, %rcx
...
lea addresses_normal_ht+0x108ba, %rdi
nop
nop
nop
xor %rdx, %rdx
...
{'OP': 'LOAD', 'src': {'type': 'addresses_UC', 'AVXalign': True, 'congruent': 4, 'size': 16, 'same': False, 'NT': False}}
[Faulty Load]
...
{'OP': 'STOR', 'dst': {'type': 'addresses_WT_ht', 'AVXalign': False, 'congruent': 4, 'size': 4, 'same': False, 'NT': True}}
...
{'OP': 'STOR', 'dst': {'type': 'addresses_A_ht', 'AVXalign': False, 'congruent': 2, 'size': 1, 'same': True, 'NT': False}}
{'00': 21829}
