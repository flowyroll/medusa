...
nop
add $19657, %rcx
lea addresses_WC_ht+0xad1f, %rdx
nop
nop
nop
xor %rcx, %rcx
...
nop
xor $39064, %r11
lea addresses_UC_ht+0x12c29, %r11
clflush (%r11)
nop
nop
and $53728, %rbp
movb $0x61, (%r11)
and $13302, %rcx
lea addresses_normal_ht+0x190c9, %rsi
...
rep movsw
sub $20378, %r8
lea addresses_A_ht+0x126e9, %rsi
lea addresses_WC_ht+0x29, %rdi
nop
nop
nop
nop
...
nop
cmp $20609, %rdx
lea addresses_WT_ht+0x12c29, %rcx
nop
nop
nop
xor %r11, %r11
...
// Store
lea addresses_normal+0x1f4af, %r12
nop
nop
nop
nop
...
{'src': {'type': 'addresses_PSE', 'same': False, 'size': 2, 'congruent': 1, 'NT': True, 'AVXalign': False}, 'OP': 'LOAD'}
...
<gen_prepare_buffer>
{'dst': {'type': 'addresses_WT_ht', 'same': True, 'size': 1, 'congruent': 8, 'NT': False, 'AVXalign': False}, 'OP': 'STOR'}
...
{'dst': {'type': 'addresses_UC_ht', 'same': False, 'size': 1, 'congruent': 11, 'NT': False, 'AVXalign': True}, 'OP': 'STOR'}
{'src': {'type': 'addresses_normal_ht', 'congruent': 5, 'same': False}, 'dst': {'type': 'addresses_WC_ht', 'congruent': 5, 'same': False}, 'OP': 'REPM'}
