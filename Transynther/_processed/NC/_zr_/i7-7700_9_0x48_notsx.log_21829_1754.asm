...
push %rdi
push %rsi
lea addresses_UC_ht+0xf58b, %rsi
lea addresses_normal_ht+0x14cb, %rdi
nop
sub $3213, %r14
mov $79, %rcx
rep movsw
...
nop
cmp $41958, %r12
lea addresses_UC_ht+0x17ecb, %r14
clflush (%r14)
nop
nop
nop
...
nop
add $7858, %r14
lea addresses_UC_ht+0x10b8b, %rdi
nop
nop
nop
nop
...
lea addresses_UC_ht+0x10f4b, %rdi
nop
nop
nop
nop
...
// Store
lea addresses_normal+0x162cb, %rdx
add %rbx, %rbx
...
<gen_prepare_buffer>
{'dst': {'same': True, 'congruent': 9, 'type': 'addresses_normal_ht'}, 'OP': 'REPM', 'src': {'same': False, 'congruent': 5, 'type': 'addresses_UC_ht'}}
...
{'dst': {'same': False, 'congruent': 7, 'type': 'addresses_UC_ht'}, 'OP': 'REPM', 'src': {'same': False, 'congruent': 7, 'type': 'addresses_normal_ht'}}
{'00': 21829}
