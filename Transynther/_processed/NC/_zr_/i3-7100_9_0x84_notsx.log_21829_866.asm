...
push %rdi
push %rsi
lea addresses_A_ht+0x19bbd, %rax
clflush (%rax)
nop
nop
and %r12, %r12
...
movups %xmm7, (%rax)
and %rbp, %rbp
lea addresses_WT_ht+0x146d1, %rsi
lea addresses_normal_ht+0xdc91, %rdi
nop
nop
nop
nop
...
nop
add %rcx, %rcx
lea addresses_D_ht+0x38d1, %rcx
nop
nop
dec %r12
movb $0x61, (%rcx)
lfence
lea addresses_A_ht+0x19ad1, %rsi
lea addresses_WC_ht+0xbba7, %rdi
clflush (%rsi)
nop
xor %rax, %rax
mov $23, %rcx
...
nop
xor %rbx, %rbx
lea addresses_D_ht+0x1e6d1, %rsi
lea addresses_normal_ht+0x1d13d, %rdi
nop
nop
nop
nop
...
{'src': {'type': 'addresses_D_ht', 'congruent': 4, 'same': True}, 'dst': {'type': 'addresses_normal_ht', 'congruent': 1, 'same': False}, 'OP': 'REPM'}
