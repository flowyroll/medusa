...
push %rcx
push %rdi
lea addresses_WC_ht+0xfd77, %rcx
nop
nop
nop
sub $6187, %r13
...
nop
cmp %r14, %r14
lea addresses_WC_ht+0x1c71b, %rbx
nop
nop
and %rdi, %rdi
mov (%rbx), %eax
...
nop
and $41731, %rdi
lea addresses_WT_ht+0xfcd9, %r14
nop
inc %r9
movb (%r14), %bl
nop
...
nop
dec %r14
lea addresses_UC_ht+0x7a59, %rcx
nop
nop
nop
xor $40354, %r14
movb $0x61, (%rcx)
and %r13, %r13
lea addresses_D_ht+0x14555, %rbx
nop
nop
xor $48909, %r14
movups (%rbx), %xmm3
...
nop
xor $53946, %r14
lea addresses_WC_ht+0xd459, %r14
nop
sub %r9, %r9
movb $0x61, (%r14)
sub $16464, %rbx
