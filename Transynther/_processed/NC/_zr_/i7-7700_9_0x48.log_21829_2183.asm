...
nop
sub %rdi, %rdi
lea addresses_A_ht+0xd8e2, %rsi
lea addresses_normal_ht+0x1b622, %rdi
clflush (%rsi)
nop
nop
nop
...
nop
dec %rdx
lea addresses_D_ht+0xe822, %rcx
nop
and $46320, %rdi
movb (%rcx), %dl
and $20293, %rdx
lea addresses_D_ht+0x14622, %r9
xor $7522, %r14
movb $0x61, (%r9)
nop
nop
...
nop
inc %rdi
lea addresses_WT_ht+0x9922, %r14
mfence
...
nop
dec %rdx
lea addresses_normal_ht+0x19a22, %rdi
nop
nop
nop
nop
...
nop
inc %r9
lea addresses_WT_ht+0x14e22, %r8
and $44386, %rdi
movups (%r8), %xmm1
vpextrq $1, %xmm1, %rdx
nop
