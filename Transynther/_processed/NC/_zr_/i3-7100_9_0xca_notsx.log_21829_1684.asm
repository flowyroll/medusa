...
push %rdx
push %rsi
lea addresses_normal_ht+0x130af, %rbp
nop
and %rcx, %rcx
movups (%rbp), %xmm0
vpextrq $1, %xmm0, %rsi
nop
cmp %rdx, %rdx
lea addresses_normal_ht+0x1778f, %rsi
lea addresses_WC_ht+0x17ef, %rdi
clflush (%rsi)
nop
nop
nop
...
nop
inc %rbp
lea addresses_normal_ht+0x936f, %r15
clflush (%r15)
cmp $61862, %rdx
vmovups (%r15), %ymm7
...
nop
add %rbp, %rbp
lea addresses_WC_ht+0x1076f, %rcx
and %rbp, %rbp
mov (%rcx), %rdx
xor $25775, %r15
lea addresses_WT_ht+0xb36f, %rsi
lea addresses_UC_ht+0x188e0, %rdi
nop
nop
nop
add %r10, %r10
...
nop
cmp $24890, %rdx
lea addresses_WC_ht+0x139af, %rbp
xor %r10, %r10
mov (%rbp), %rsi
sub $6970, %r10
lea addresses_D_ht+0x11e6f, %r15
nop
xor $36324, %r10
movups (%r15), %xmm2
vpextrq $1, %xmm2, %rdi
...
nop
and %r10, %r10
lea addresses_WT_ht+0x8543, %rsi
lea addresses_UC_ht+0x6d6f, %rdi
nop
nop
nop
nop
...
nop
add %rdi, %rdi
lea addresses_normal_ht+0x806f, %rdi
nop
and $6725, %rcx
movl $0x61626364, (%rdi)
nop
...
// Store
lea addresses_normal+0x1b42d, %rdx
nop
nop
sub $22185, %r13
movw $0x5152, (%rdx)
...
{'src': {'same': True, 'congruent': 6, 'NT': False, 'type': 'addresses_normal_ht', 'size': 32, 'AVXalign': False}, 'OP': 'LOAD'}
{'src': {'same': False, 'congruent': 8, 'NT': True, 'type': 'addresses_WC_ht', 'size': 8, 'AVXalign': False}, 'OP': 'LOAD'}
{'src': {'type': 'addresses_WT_ht', 'congruent': 8, 'same': True}, 'OP': 'REPM', 'dst': {'type': 'addresses_UC_ht', 'congruent': 0, 'same': False}}
