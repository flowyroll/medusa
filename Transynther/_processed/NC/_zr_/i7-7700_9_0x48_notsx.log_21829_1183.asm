...
lea addresses_normal_ht+0xce99, %rdi
nop
nop
xor %r9, %r9
mov $23, %rcx
...
nop
cmp %rdi, %rdi
lea addresses_D_ht+0x15319, %rsi
lea addresses_normal_ht+0x1ce19, %rdi
sub %r10, %r10
mov $86, %rcx
rep movsw
nop
nop
sub %r10, %r10
lea addresses_WC_ht+0x1b619, %r10
nop
nop
nop
nop
...
nop
dec %rsi
lea addresses_WC_ht+0x1e19, %rsi
...
nop
cmp $8337, %rbp
lea addresses_WC_ht+0x1eef9, %rdi
add $12634, %rdx
mov (%rdi), %r10d
nop
nop
...
nop
and $12555, %r9
lea addresses_A_ht+0xb719, %rsi
lea addresses_A_ht+0x9d59, %rdi
nop
dec %rdx
mov $50, %rcx
rep movsw
...
nop
sub %rsi, %rsi
lea addresses_WC_ht+0x46b9, %rsi
nop
nop
nop
nop
...
nop
cmp %rcx, %rcx
lea addresses_UC_ht+0x1d4f1, %rdi
nop
nop
nop
nop
...
nop
and $5123, %rdi
lea addresses_A_ht+0x1a619, %rcx
nop
nop
add %rbp, %rbp
movb (%rcx), %dl
...
{'dst': {'same': True, 'congruent': 6, 'type': 'addresses_normal_ht'}, 'OP': 'REPM', 'src': {'same': False, 'congruent': 5, 'type': 'addresses_D_ht'}}
{'dst': {'same': True, 'congruent': 9, 'type': 'addresses_normal_ht'}, 'OP': 'REPM', 'src': {'same': False, 'congruent': 8, 'type': 'addresses_D_ht'}}
{'dst': {'same': False, 'NT': True, 'AVXalign': False, 'size': 32, 'type': 'addresses_WC_ht', 'congruent': 8}, 'OP': 'STOR'}
{'dst': {'same': False, 'congruent': 3, 'type': 'addresses_WC_ht'}, 'OP': 'REPM', 'src': {'same': False, 'congruent': 11, 'type': 'addresses_WC_ht'}}
...
{'dst': {'same': False, 'congruent': 6, 'type': 'addresses_A_ht'}, 'OP': 'REPM', 'src': {'same': False, 'congruent': 8, 'type': 'addresses_A_ht'}}
