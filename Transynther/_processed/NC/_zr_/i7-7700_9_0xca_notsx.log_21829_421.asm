...
push %rdx
push %rsi
lea addresses_WC_ht+0x5c4c, %rsi
lea addresses_WC_ht+0x104c, %rdi
nop
nop
nop
nop
...
nop
add %rdx, %rdx
lea addresses_UC_ht+0x10d4c, %r15
nop
nop
nop
nop
...
nop
and %rcx, %rcx
lea addresses_UC_ht+0x8bfc, %rcx
nop
nop
nop
nop
...
nop
xor $16872, %r15
lea addresses_D_ht+0x14796, %r10
nop
nop
nop
nop
...
movb $0x61, (%r10)
and %r14, %r14
lea addresses_normal_ht+0x6e4c, %r10
clflush (%r10)
nop
nop
nop
...
nop
add %rdx, %rdx
lea addresses_WT_ht+0xf7cc, %rcx
nop
nop
dec %r10
movb $0x61, (%rcx)
...
nop
cmp $10948, %r14
lea addresses_WT_ht+0x10b4c, %rdi
nop
nop
nop
nop
...
nop
dec %rdi
lea addresses_D_ht+0x1a954, %rsi
lea addresses_normal_ht+0x8811, %rdi
nop
nop
cmp %r9, %r9
mov $66, %rcx
...
nop
cmp $30133, %rsi
lea addresses_UC_ht+0x10d8c, %r10
nop
nop
nop
nop
...
nop
and %rdi, %rdi
lea addresses_WC_ht+0x1502a, %rdi
nop
nop
nop
sub %r15, %r15
...
<gen_prepare_buffer>
{'src': {'congruent': 10, 'same': False, 'type': 'addresses_WC_ht'}, 'dst': {'congruent': 10, 'same': False, 'type': 'addresses_WC_ht'}, 'OP': 'REPM'}
...
{'src': {'NT': False, 'AVXalign': True, 'size': 16, 'congruent': 8, 'same': False, 'type': 'addresses_normal_ht'}, 'OP': 'LOAD'}
