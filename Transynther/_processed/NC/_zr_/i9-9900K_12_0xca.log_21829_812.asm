...
push %rdi
push %rsi
lea addresses_A_ht+0x151a5, %r10
sub %rcx, %rcx
movl $0x61626364, (%r10)
nop
nop
...
nop
inc %r8
lea addresses_normal_ht+0x1be65, %rsi
lea addresses_UC_ht+0x123bd, %rdi
nop
nop
nop
nop
...
nop
add $51046, %rdi
lea addresses_A_ht+0x7109, %rsi
lea addresses_A_ht+0x1cab5, %rdi
nop
nop
nop
xor %r8, %r8
...
{'OP': 'LOAD', 'src': {'size': 16, 'NT': False, 'type': 'addresses_A', 'same': False, 'AVXalign': True, 'congruent': 1}}
{'OP': 'STOR', 'dst': {'size': 16, 'NT': False, 'type': 'addresses_RW', 'same': False, 'AVXalign': False, 'congruent': 6}}
{'OP': 'STOR', 'dst': {'size': 4, 'NT': False, 'type': 'addresses_US', 'same': False, 'AVXalign': False, 'congruent': 4}}
[Faulty Load]
...
{'OP': 'REPM', 'src': {'same': False, 'type': 'addresses_A_ht', 'congruent': 1}, 'dst': {'same': False, 'type': 'addresses_A_ht', 'congruent': 4}}
{'00': 21829}
