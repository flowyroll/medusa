...
push %rdx
push %rsi
lea addresses_WT_ht+0x112e4, %rsi
lea addresses_WC_ht+0x68ec, %rdi
nop
inc %r9
mov $39, %rcx
rep movsq
...
nop
sub %rdx, %rdx
lea addresses_D_ht+0x1670c, %r13
nop
nop
cmp $10516, %r14
mov (%r13), %di
nop
cmp $34066, %r14
lea addresses_UC_ht+0x16a78, %rdx
add %r9, %r9
mov (%rdx), %rsi
nop
nop
...
nop
xor %rdi, %rdi
lea addresses_normal_ht+0x44ec, %rsi
clflush (%rsi)
nop
sub $25947, %rdx
movb $0x61, (%rsi)
...
nop
cmp %r9, %r9
lea addresses_WT_ht+0x55ec, %r13
clflush (%r13)
nop
and %rdx, %rdx
...
nop
dec %rdx
lea addresses_A_ht+0x1204, %rsi
lea addresses_WC_ht+0xb8ec, %rdi
xor %r12, %r12
mov $106, %rcx
rep movsw
nop
nop
add %rsi, %rsi
lea addresses_UC_ht+0x273c, %rsi
lea addresses_A_ht+0x626c, %rdi
nop
sub $41230, %r13
mov $45, %rcx
rep movsw
...
lea addresses_WC_ht+0x13cec, %rdi
nop
nop
nop
nop
...
nop
dec %rcx
lea addresses_WC_ht+0x8b00, %rsi
sub %r9, %r9
mov (%rsi), %rdx
nop
nop
...
{'src': {'type': 'addresses_US', 'same': False, 'size': 2, 'congruent': 8, 'NT': False, 'AVXalign': True}, 'OP': 'LOAD'}
...
<gen_prepare_buffer>
{'src': {'type': 'addresses_WT_ht', 'congruent': 3, 'same': False}, 'dst': {'type': 'addresses_WC_ht', 'congruent': 9, 'same': True}, 'OP': 'REPM'}
...
{'src': {'type': 'addresses_normal_ht', 'congruent': 3, 'same': True}, 'dst': {'type': 'addresses_WC_ht', 'congruent': 10, 'same': False}, 'OP': 'REPM'}
