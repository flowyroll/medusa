...
nop
dec %rdi
lea addresses_UC_ht+0x11ab9, %rbx
nop
nop
and $46534, %rdx
mov (%rbx), %r15w
...
nop
dec %rax
lea addresses_normal_ht+0xe651, %rbx
nop
nop
nop
nop
...
nop
sub $50966, %rax
lea addresses_D_ht+0x1e593, %r15
nop
nop
nop
and %r11, %r11
...
nop
add $32685, %rbx
lea addresses_WC_ht+0x1db9, %r15
nop
nop
nop
nop
...
nop
sub $33559, %r15
lea addresses_UC_ht+0x146b9, %rsi
lea addresses_A_ht+0x5db9, %rdi
nop
nop
nop
xor $37571, %rdx
...
nop
cmp $60422, %r15
lea addresses_normal_ht+0xf4b9, %rsi
lea addresses_WC_ht+0x4951, %rdi
nop
nop
sub $56464, %r11
mov $36, %rcx
rep movsw
add %r15, %r15
lea addresses_normal_ht+0x48b9, %rbx
nop
nop
nop
nop
...
movb (%rbx), %r15b
xor %rcx, %rcx
lea addresses_WT_ht+0x162b9, %r15
nop
nop
xor $41389, %rdi
mov (%r15), %cx
...
nop
add $20746, %rdi
lea addresses_WC_ht+0x1d3b9, %rax
nop
nop
nop
nop
...
{'src': {'congruent': 9, 'same': False, 'type': 'addresses_UC_ht'}, 'dst': {'congruent': 8, 'same': False, 'type': 'addresses_A_ht'}, 'OP': 'REPM'}
{'src': {'NT': False, 'AVXalign': False, 'size': 16, 'congruent': 11, 'same': False, 'type': 'addresses_D_ht'}, 'OP': 'LOAD'}
{'src': {'congruent': 9, 'same': False, 'type': 'addresses_normal_ht'}, 'dst': {'congruent': 3, 'same': True, 'type': 'addresses_WC_ht'}, 'OP': 'REPM'}
{'src': {'NT': False, 'AVXalign': False, 'size': 1, 'congruent': 9, 'same': True, 'type': 'addresses_normal_ht'}, 'OP': 'LOAD'}
