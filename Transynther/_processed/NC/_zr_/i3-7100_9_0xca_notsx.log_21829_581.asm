...
push %rdx
push %rsi
lea addresses_A_ht+0x1324d, %rsi
lea addresses_WT_ht+0xaa4d, %rdi
clflush (%rdi)
nop
nop
nop
...
nop
sub %rsi, %rsi
lea addresses_UC_ht+0x174ed, %rdx
nop
nop
nop
nop
...
nop
cmp %rbx, %rbx
lea addresses_D_ht+0xafd, %rdi
nop
nop
add $2767, %r15
mov (%rdi), %r10d
cmp %r10, %r10
lea addresses_A_ht+0xa0cd, %rcx
and %r10, %r10
