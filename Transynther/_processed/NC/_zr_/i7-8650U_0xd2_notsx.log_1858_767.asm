...
push %rdx
push %rsi
lea addresses_UC_ht+0xf94b, %rcx
nop
cmp $46805, %rax
movw $0x6162, (%rcx)
nop
sub $3547, %r8
lea addresses_WC_ht+0x114e3, %rsi
lea addresses_WC_ht+0xb54b, %rdi
clflush (%rdi)
nop
add $44065, %rdx
mov $89, %rcx
...
lea addresses_D_ht+0x1b9cb, %rdi
nop
nop
nop
nop
...
nop
cmp $49031, %rax
lea addresses_WC_ht+0x1d2cb, %r8
nop
sub $39381, %rax
mov (%r8), %edi
nop
...
nop
xor $12780, %rdi
lea addresses_WC_ht+0x559d, %rsi
...
nop
inc %r12
lea addresses_A_ht+0x954b, %rsi
lea addresses_A_ht+0xbf89, %rdi
nop
nop
xor $48679, %r11
mov $49, %rcx
...
mov (%r11), %di
add %rdi, %rdi
lea addresses_UC_ht+0x944b, %rsi
nop
nop
nop
sub $14755, %rcx
...
{'OP': 'STOR', 'dst': {'type': 'addresses_UC', 'size': 16, 'AVXalign': False, 'NT': True, 'congruent': 3, 'same': False}}
...
{'OP': 'REPM', 'src': {'type': 'addresses_A_ht', 'congruent': 9, 'same': False}, 'dst': {'type': 'addresses_A_ht', 'congruent': 1, 'same': True}}
