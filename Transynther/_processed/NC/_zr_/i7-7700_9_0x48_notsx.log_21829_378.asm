...
push %rdx
push %rsi
lea addresses_UC_ht+0xa3ee, %r13
nop
nop
nop
nop
...
nop
and %r15, %r15
lea addresses_normal_ht+0x1c6ba, %rdx
nop
nop
nop
cmp %r14, %r14
...
nop
inc %rsi
lea addresses_WC_ht+0x15fee, %rsi
lea addresses_UC_ht+0xcb8b, %rdi
clflush (%rsi)
nop
nop
sub $4767, %rbx
...
rep movsw
and %rsi, %rsi
lea addresses_UC_ht+0x10fee, %rdi
nop
sub %r15, %r15
movups (%rdi), %xmm7
vpextrq $0, %xmm7, %rcx
...
nop
cmp $53283, %rdi
lea addresses_D_ht+0xedee, %rsi
lea addresses_UC_ht+0x129ee, %rdi
and %rbx, %rbx
mov $34, %rcx
rep movsq
nop
...
nop
add %rbx, %rbx
lea addresses_WC_ht+0x578d, %rcx
nop
nop
nop
nop
...
movb $0x61, (%rcx)
add $61448, %rcx
lea addresses_WC_ht+0xa7ee, %rsi
lea addresses_D_ht+0x1072e, %rdi
nop
sub %r15, %r15
mov $60, %rcx
rep movsq
...
nop
dec %rdx
lea addresses_WT_ht+0x160ca, %r15
nop
nop
nop
nop
...
nop
cmp %rdi, %rdi
lea addresses_A_ht+0xceea, %rsi
lea addresses_D_ht+0xbb6e, %rdi
nop
nop
nop
nop
...
nop
cmp $25521, %rdx
lea addresses_normal_ht+0x18fee, %rbx
clflush (%rbx)
nop
nop
nop
...
{'dst': {'same': False, 'congruent': 9, 'type': 'addresses_UC_ht'}, 'OP': 'REPM', 'src': {'same': False, 'congruent': 9, 'type': 'addresses_D_ht'}}
{'dst': {'same': False, 'NT': False, 'AVXalign': False, 'size': 1, 'type': 'addresses_WC_ht', 'congruent': 0}, 'OP': 'STOR'}
{'dst': {'same': False, 'congruent': 4, 'type': 'addresses_D_ht'}, 'OP': 'REPM', 'src': {'same': True, 'congruent': 9, 'type': 'addresses_WC_ht'}}
