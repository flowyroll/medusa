...
nop
sub $13696, %r11
lea addresses_normal_ht+0x35ad, %r15
nop
nop
nop
dec %rcx
...
nop
lfence
lea addresses_UC_ht+0x163c9, %r14
sub $7777, %r10
movw $0x6162, (%r14)
dec %rdi
lea addresses_A_ht+0x10659, %rcx
nop
nop
nop
nop
...
lea addresses_A_ht+0x110a9, %rdi
clflush (%rdi)
sub $27886, %rdx
mov $80, %rcx
rep movsw
nop
dec %r10
lea addresses_A_ht+0x37c9, %rsi
lea addresses_D_ht+0x1c185, %rdi
nop
nop
nop
nop
...
movl $0x61626364, (%rdx)
cmp %rcx, %rcx
lea addresses_A_ht+0xcfc9, %rsi
lea addresses_WT_ht+0x1dd89, %rdi
nop
and %r14, %r14
mov $29, %rcx
rep movsq
...
nop
xor $20168, %r11
lea addresses_normal_ht+0x13601, %rcx
nop
add $32974, %r10
mov (%rcx), %di
nop
...
{'OP': 'REPM', 'src': {'type': 'addresses_WC_ht', 'congruent': 2, 'same': True}, 'dst': {'type': 'addresses_A_ht', 'congruent': 5, 'same': False}}
{'OP': 'REPM', 'src': {'type': 'addresses_A_ht', 'congruent': 11, 'same': False}, 'dst': {'type': 'addresses_D_ht', 'congruent': 0, 'same': True}}
