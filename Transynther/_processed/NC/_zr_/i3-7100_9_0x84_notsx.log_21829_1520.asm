...
push %rdi
push %rsi
lea addresses_A_ht+0x1502, %rsi
lea addresses_D_ht+0x13002, %rdi
nop
nop
nop
add %r10, %r10
...
nop
and $6933, %rdi
lea addresses_normal_ht+0x1b382, %rsi
nop
nop
nop
xor %rcx, %rcx
...
nop
sub %rsi, %rsi
lea addresses_D_ht+0x1c9a2, %rsi
nop
nop
add %rbp, %rbp
...
nop
xor %r14, %r14
lea addresses_normal_ht+0x2382, %rbp
nop
nop
nop
nop
...
vmovups %ymm2, (%rbp)
sub %r10, %r10
lea addresses_D_ht+0x4a76, %rsi
lea addresses_UC_ht+0x1a0ae, %rdi
nop
nop
nop
sub %r9, %r9
...
nop
sub $47606, %rcx
lea addresses_WC_ht+0x3b82, %r14
nop
sub $44026, %r10
mov (%r14), %esi
nop
...
<gen_prepare_buffer>
{'src': {'type': 'addresses_A_ht', 'congruent': 6, 'same': True}, 'dst': {'type': 'addresses_D_ht', 'congruent': 7, 'same': False}, 'OP': 'REPM'}
{'dst': {'type': 'addresses_normal_ht', 'same': False, 'size': 4, 'congruent': 9, 'NT': True, 'AVXalign': True}, 'OP': 'STOR'}
