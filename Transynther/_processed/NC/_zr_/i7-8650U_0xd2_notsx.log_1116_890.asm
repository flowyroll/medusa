...
nop
and $63996, %rcx
lea addresses_WT_ht+0x1bfd4, %rdx
nop
nop
nop
nop
...
nop
xor $11227, %rdi
lea addresses_D_ht+0x18454, %rbp
nop
nop
nop
nop
...
nop
xor %rbp, %rbp
lea addresses_WT_ht+0x113d4, %rsi
lea addresses_WT_ht+0xd9d0, %rdi
nop
nop
nop
nop
...
nop
add $34910, %rbp
lea addresses_D_ht+0x1e8d4, %rbp
nop
inc %r13
...
nop
xor $35406, %rbp
lea addresses_D_ht+0x16374, %rdi
clflush (%rdi)
nop
nop
nop
...
nop
and %rcx, %rcx
lea addresses_D_ht+0x187d4, %r13
nop
xor %rcx, %rcx
...
nop
xor $28189, %rax
lea addresses_normal_ht+0xcc6a, %rsi
lea addresses_D_ht+0x44d4, %rdi
nop
nop
nop
nop
...
nop
sub %rdx, %rdx
lea addresses_A_ht+0x1a1b4, %rdi
nop
nop
nop
nop
...
nop
xor $45931, %r10
lea addresses_normal_ht+0xa8d0, %rsi
lea addresses_UC_ht+0x15104, %rdi
nop
nop
cmp %r13, %r13
mov $114, %rcx
...
{'OP': 'REPM', 'src': {'type': 'addresses_normal_ht', 'congruent': 0, 'same': False}, 'dst': {'type': 'addresses_UC_ht', 'congruent': 1, 'same': True}}
{'00': 1116}
