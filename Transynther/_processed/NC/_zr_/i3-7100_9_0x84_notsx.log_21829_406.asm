...
push %rdi
push %rsi
lea addresses_WC_ht+0xc786, %rsi
lea addresses_UC_ht+0xed46, %rdi
nop
nop
nop
nop
...
nop
xor %r15, %r15
lea addresses_UC_ht+0xbf06, %rbx
nop
nop
nop
nop
...
nop
and $62765, %rdi
lea addresses_normal_ht+0x8b76, %rsi
lea addresses_D_ht+0x1a646, %rdi
nop
and $63182, %r9
mov $66, %rcx
rep movsq
...
nop
add $34317, %rcx
lea addresses_WT_ht+0xd446, %rsi
lea addresses_A_ht+0x18a46, %rdi
nop
nop
nop
and $25118, %r10
...
nop
add %rdi, %rdi
lea addresses_UC_ht+0x53c6, %rsi
lea addresses_D_ht+0x3a96, %rdi
nop
nop
nop
sub $49019, %r9
...
nop
add $29185, %rdi
lea addresses_WC_ht+0x9810, %rbp
nop
xor $4448, %rbx
movb $0x61, (%rbp)
nop
...
nop
cmp %rcx, %rcx
lea addresses_A_ht+0x1c754, %rsi
lea addresses_A_ht+0x1146, %rdi
clflush (%rdi)
dec %r10
mov $12, %rcx
rep movsb
...
<gen_prepare_buffer>
{'src': {'type': 'addresses_WC_ht', 'congruent': 5, 'same': True}, 'dst': {'type': 'addresses_UC_ht', 'congruent': 7, 'same': False}, 'OP': 'REPM'}
{'dst': {'type': 'addresses_UC_ht', 'same': False, 'size': 2, 'congruent': 6, 'NT': False, 'AVXalign': False}, 'OP': 'STOR'}
{'src': {'type': 'addresses_normal_ht', 'congruent': 4, 'same': True}, 'dst': {'type': 'addresses_D_ht', 'congruent': 11, 'same': False}, 'OP': 'REPM'}
