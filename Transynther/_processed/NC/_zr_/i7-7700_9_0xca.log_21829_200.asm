...
push %rdx
push %rsi
lea addresses_WT_ht+0x1edd7, %r13
clflush (%r13)
nop
nop
nop
...
nop
and $7737, %r13
lea addresses_A_ht+0x1b637, %rbx
nop
nop
sub %rdi, %rdi
movb (%rbx), %al
...
nop
and %rax, %rax
lea addresses_WT_ht+0x13d59, %rbx
nop
nop
nop
nop
...
nop
cmp %rbx, %rbx
lea addresses_A_ht+0x1a037, %r13
nop
nop
nop
nop
...
nop
inc %rdi
lea addresses_A_ht+0xc0f7, %rax
nop
inc %r13
movb $0x61, (%rax)
nop
dec %rax
lea addresses_normal_ht+0xbc37, %rsi
lea addresses_normal_ht+0x62ef, %rdi
nop
nop
nop
nop
...
{'src': {'congruent': 1, 'AVXalign': True, 'same': True, 'size': 1, 'NT': True, 'type': 'addresses_WT_ht'}, 'OP': 'LOAD'}
...
{'src': {'congruent': 10, 'same': True, 'type': 'addresses_normal_ht'}, 'OP': 'REPM', 'dst': {'congruent': 3, 'same': False, 'type': 'addresses_normal_ht'}}
