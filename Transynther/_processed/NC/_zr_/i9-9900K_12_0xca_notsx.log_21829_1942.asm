...
push %rdx
push %rsi
lea addresses_WC_ht+0x12c99, %r13
nop
nop
nop
inc %r8
mov (%r13), %cx
sub %rdx, %rdx
lea addresses_normal_ht+0x1cc19, %r11
nop
add $25349, %rsi
movb (%r11), %al
nop
...
nop
xor $6950, %rsi
lea addresses_normal_ht+0x8819, %r11
cmp %rax, %rax
mov (%r11), %rcx
nop
nop
...
nop
add %r8, %r8
lea addresses_WC_ht+0x1e439, %rdx
clflush (%rdx)
xor %r11, %r11
mov (%rdx), %rsi
nop
...
nop
inc %rax
lea addresses_A_ht+0x12559, %rcx
nop
nop
nop
cmp $53882, %r11
...
nop
add $27860, %rax
lea addresses_WT_ht+0x8419, %rsi
...
{'OP': 'LOAD', 'src': {'same': False, 'type': 'addresses_A_ht', 'NT': False, 'AVXalign': True, 'size': 2, 'congruent': 4}}
{'OP': 'REPM', 'src': {'same': False, 'congruent': 10, 'type': 'addresses_WT_ht'}, 'dst': {'same': False, 'congruent': 6, 'type': 'addresses_A_ht'}}
{'00': 21829}
