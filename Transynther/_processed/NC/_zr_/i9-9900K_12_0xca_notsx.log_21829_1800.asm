...
nop
sub %rdx, %rdx
lea addresses_UC_ht+0xa883, %rbp
inc %r12
movb (%rbp), %r11b
nop
cmp %rbx, %rbx
lea addresses_WC_ht+0x117db, %rsi
lea addresses_A_ht+0x22e, %rdi
xor %rdx, %rdx
mov $95, %rcx
rep movsb
nop
...
vpextrq $1, %xmm7, %rbp
cmp %rdx, %rdx
lea addresses_normal_ht+0x116d, %rbp
nop
nop
nop
nop
...
nop
cmp $26362, %rcx
lea addresses_normal_ht+0xc33b, %rsi
...
nop
add $22261, %rcx
lea addresses_normal_ht+0x17b57, %rbp
clflush (%rbp)
nop
nop
nop
...
movl $0x61626364, (%rbp)
add $33418, %rbp
lea addresses_UC_ht+0x1d223, %rdx
nop
nop
nop
dec %rbp
...
nop
sub $37652, %rdx
lea addresses_WT_ht+0x551b, %rsi
lea addresses_UC_ht+0xa3db, %rdi
nop
cmp $4946, %rax
mov $10, %rcx
rep movsl
...
{'OP': 'REPM', 'src': {'same': False, 'congruent': 4, 'type': 'addresses_WC_ht'}, 'dst': {'same': False, 'congruent': 0, 'type': 'addresses_A_ht'}}
...
{'OP': 'REPM', 'src': {'same': False, 'congruent': 9, 'type': 'addresses_WT_ht'}, 'dst': {'same': False, 'congruent': 6, 'type': 'addresses_UC_ht'}}
{'00': 21829}
