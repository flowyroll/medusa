...
push %rdi
push %rsi
lea addresses_WT_ht+0x1e16e, %r10
nop
nop
nop
nop
...
nop
sub %r12, %r12
lea addresses_D_ht+0x756e, %rsi
lea addresses_WT_ht+0xf2d8, %rdi
xor $24659, %r12
mov $59, %rcx
rep movsq
sub $46234, %r12
lea addresses_UC_ht+0x11476, %rsi
lea addresses_WT_ht+0x3d6e, %rdi
cmp %r8, %r8
mov $126, %rcx
rep movsl
nop
add $5663, %rdi
lea addresses_normal_ht+0x156ae, %rax
dec %rcx
mov (%rax), %r12w
nop
and %r12, %r12
...
// Store
lea addresses_normal+0x8b6e, %rbx
nop
mfence
movw $0x5152, (%rbx)
nop
...
// Store
lea addresses_normal+0x1a4de, %r8
nop
nop
nop
nop
...
{'OP': 'STOR', 'dst': {'congruent': 9, 'AVXalign': True, 'same': False, 'size': 2, 'NT': False, 'type': 'addresses_normal'}}
