...
push %rdx
push %rsi
lea addresses_D_ht+0xf59c, %rsi
lea addresses_D_ht+0x25b8, %rdi
clflush (%rsi)
nop
nop
nop
...
nop
cmp $62868, %rbx
lea addresses_A_ht+0x19fc2, %rsi
...
rep movsb
xor $52014, %rbx
lea addresses_UC_ht+0x3c3c, %rsi
lea addresses_UC_ht+0xcd9c, %rdi
nop
nop
nop
nop
...
nop
cmp $59953, %rbx
lea addresses_UC_ht+0x182a4, %rcx
nop
dec %rdi
movw $0x6162, (%rcx)
nop
...
nop
sub $915, %r11
lea addresses_normal_ht+0x2d8c, %rbx
nop
nop
sub %rcx, %rcx
mov (%rbx), %si
...
nop
and $64691, %rcx
lea addresses_A_ht+0x183d2, %r12
nop
nop
nop
cmp $54069, %rdi
...
nop
sub %rbx, %rbx
lea addresses_A_ht+0x18c78, %r11
nop
nop
nop
nop
...
{'OP': 'REPM', 'src': {'type': 'addresses_A_ht', 'congruent': 1, 'same': False}, 'dst': {'type': 'addresses_UC_ht', 'congruent': 4, 'same': False}}
...
{'OP': 'STOR', 'dst': {'type': 'addresses_UC_ht', 'AVXalign': True, 'congruent': 3, 'size': 2, 'same': False, 'NT': False}}
