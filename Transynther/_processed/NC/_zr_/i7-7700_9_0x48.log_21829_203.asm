...
nop
cmp $16293, %r12
lea addresses_WC_ht+0xb192, %r12
and %r13, %r13
mov (%r12), %edx
nop
nop
and $23976, %r9
lea addresses_A_ht+0x1ca, %r14
nop
nop
nop
inc %rsi
...
nop
and %r14, %r14
lea addresses_normal_ht+0x1a54a, %rsi
nop
nop
xor %r14, %r14
mov (%rsi), %r12
...
nop
sub %rdx, %rdx
lea addresses_WT_ht+0x1bd4a, %rsi
lea addresses_WT_ht+0xd8f2, %rdi
clflush (%rsi)
nop
nop
xor %r9, %r9
...
rep movsb
sub $12988, %rdx
lea addresses_D_ht+0xa032, %rsi
lea addresses_WT_ht+0x9d4a, %rdi
clflush (%rsi)
nop
nop
nop
...
rep movsw
xor $31903, %r12
lea addresses_normal_ht+0x6f4a, %r9
nop
inc %r12
...
nop
cmp $8711, %rdx
lea addresses_normal_ht+0x116c2, %rsi
...
nop
cmp $50828, %r13
lea addresses_WC_ht+0x1c2da, %rdx
nop
nop
nop
nop
...
{'OP': 'STOR', 'dst': {'type': 'addresses_UC_ht', 'AVXalign': False, 'congruent': 6, 'size': 8, 'same': False, 'NT': True}}
...
{'OP': 'REPM', 'src': {'type': 'addresses_WT_ht', 'congruent': 11, 'same': False}, 'dst': {'type': 'addresses_WT_ht', 'congruent': 3, 'same': False}}
