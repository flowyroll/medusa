...
push %rdx
push %rsi
lea addresses_D_ht+0xdb8e, %rax
nop
add %rsi, %rsi
movl $0x61626364, (%rax)
and %r14, %r14
lea addresses_WC_ht+0x1710e, %r14
clflush (%r14)
sub $34600, %rbp
vmovups (%r14), %ymm0
...
nop
add %rax, %rax
lea addresses_UC_ht+0x1ce0e, %rsi
lea addresses_WC_ht+0x1478e, %rdi
nop
nop
cmp %rbx, %rbx
mov $81, %rcx
...
movq %rdi, (%rsi)
cmp %rsi, %rsi
lea addresses_UC_ht+0x8a8e, %rsi
nop
nop
nop
nop
...
{'src': {'type': 'addresses_UC_ht', 'congruent': 6, 'same': False}, 'OP': 'REPM', 'dst': {'type': 'addresses_WC_ht', 'congruent': 10, 'same': False}}
