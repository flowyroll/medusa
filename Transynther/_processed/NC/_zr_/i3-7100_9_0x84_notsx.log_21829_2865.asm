...
push %rdx
push %rsi
lea addresses_WT_ht+0x1d141, %r12
nop
cmp $58417, %rcx
movb $0x61, (%r12)
nop
add $64770, %r15
lea addresses_A_ht+0x8c99, %r8
nop
nop
nop
inc %rbx
...
nop
sub %r15, %r15
lea addresses_WT_ht+0x1ae3f, %rbx
nop
add $48059, %rdx
movb (%rbx), %r15b
nop
...
nop
inc %r12
lea addresses_UC_ht+0x17eb9, %rbx
clflush (%rbx)
nop
nop
nop
...
mov (%rbx), %dx
add %rbp, %rbp
lea addresses_normal_ht+0x15080, %rcx
nop
nop
sub %r15, %r15
movb $0x61, (%rcx)
...
nop
dec %rdx
lea addresses_WT_ht+0x7c99, %r12
nop
nop
nop
nop
...
nop
and %rbx, %rbx
lea addresses_WT_ht+0x19211, %rsi
lea addresses_normal_ht+0x1767f, %rdi
nop
nop
nop
nop
...
{'dst': {'type': 'addresses_A_ht', 'same': False, 'size': 32, 'congruent': 7, 'NT': True, 'AVXalign': False}, 'OP': 'STOR'}
