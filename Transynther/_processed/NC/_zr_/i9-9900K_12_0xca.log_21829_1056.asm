...
push %rdx
push %rsi
lea addresses_normal_ht+0x13824, %rdx
nop
nop
nop
nop
...
movb $0x61, (%rdx)
and %rbp, %rbp
lea addresses_WC_ht+0xe424, %rax
nop
nop
nop
nop
...
mov (%rax), %r11d
and $58553, %rax
lea addresses_D_ht+0x203f, %rsi
lea addresses_WT_ht+0x143a1, %rdi
nop
nop
nop
nop
...
nop
xor $8298, %r14
lea addresses_normal_ht+0x51cc, %r14
nop
nop
nop
sub %rcx, %rcx
...
nop
and %rdi, %rdi
lea addresses_normal_ht+0x7924, %rsi
lea addresses_WC_ht+0x8c24, %rdi
nop
nop
nop
nop
...
rep movsw
add %rsi, %rsi
lea addresses_WC_ht+0xdb24, %rdi
clflush (%rdi)
nop
nop
and %r15, %r15
...
movntdq %xmm3, (%rdi)
add $37295, %rbp
lea addresses_A_ht+0x14c24, %rsi
nop
nop
sub $8869, %rdi
mov (%rsi), %r14w
nop
cmp %rdi, %rdi
lea addresses_WT_ht+0x16444, %rbp
nop
add %r14, %r14
...
// Store
lea addresses_normal+0x24a4, %rcx
nop
nop
and $47265, %rdx
...
{'OP': 'STOR', 'dst': {'size': 16, 'NT': True, 'type': 'addresses_WC_ht', 'same': False, 'AVXalign': False, 'congruent': 8}}
