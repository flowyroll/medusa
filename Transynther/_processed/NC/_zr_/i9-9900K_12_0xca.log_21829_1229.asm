...
push %rdi
push %rsi
lea addresses_UC_ht+0x18277, %rsi
lea addresses_WC_ht+0x11daf, %rdi
nop
nop
nop
nop
...
nop
add %r8, %r8
lea addresses_WT_ht+0x91af, %rbx
nop
nop
nop
nop
...
nop
add $44079, %r8
lea addresses_WC_ht+0x54af, %r10
nop
nop
nop
nop
...
{'OP': 'STOR', 'dst': {'size': 4, 'NT': True, 'type': 'addresses_NC', 'same': False, 'AVXalign': False, 'congruent': 3}}
[Faulty Load]
