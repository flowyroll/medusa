...
nop
sub %r8, %r8
lea addresses_normal_ht+0x1d8aa, %rbp
nop
nop
nop
nop
...
nop
add $14249, %rbp
lea addresses_D_ht+0xc4aa, %rsi
lea addresses_A_ht+0x4da2, %rdi
nop
nop
and $42629, %rbp
mov $114, %rcx
...
nop
cmp %rsi, %rsi
lea addresses_WC_ht+0xc8ea, %r15
nop
nop
nop
xor %r14, %r14
...
movq %rsi, (%r15)
inc %rdi
lea addresses_WT_ht+0x1ce78, %rax
nop
nop
nop
nop
...
nop
inc %r10
lea addresses_UC_ht+0x16dea, %rcx
nop
nop
nop
inc %r8
movl $0x61626364, (%rcx)
dec %r14
lea addresses_UC_ht+0x1176a, %rcx
nop
nop
nop
nop
...
nop
add $37588, %r15
lea addresses_A_ht+0x17cca, %rdx
nop
nop
nop
add $58362, %rax
mov (%rdx), %r10d
sub $1337, %rcx
lea addresses_normal_ht+0xd4ea, %rdi
nop
nop
nop
add %rcx, %rcx
...
movntdq %xmm1, (%rbp)
sub %r10, %r10
lea addresses_UC_ht+0x14c9a, %rax
clflush (%rax)
nop
nop
sub $26519, %r10
...
nop
xor %rsi, %rsi
lea addresses_UC_ht+0x8af2, %r15
nop
nop
nop
cmp $56876, %r14
...
nop
sub $32311, %r8
lea addresses_D_ht+0x123c2, %rsi
lea addresses_normal_ht+0x1b9ea, %rdi
nop
add $10115, %r14
mov $15, %rcx
rep movsw
and $17011, %rsi
lea addresses_normal_ht+0x148c2, %r14
nop
nop
nop
nop
...
{'OP': 'REPM', 'src': {'type': 'addresses_D_ht', 'congruent': 4, 'same': True}, 'dst': {'type': 'addresses_A_ht', 'congruent': 3, 'same': False}}
...
{'OP': 'STOR', 'dst': {'type': 'addresses_A_ht', 'size': 16, 'AVXalign': False, 'NT': True, 'congruent': 4, 'same': True}}
...
{'OP': 'REPM', 'src': {'type': 'addresses_D_ht', 'congruent': 2, 'same': False}, 'dst': {'type': 'addresses_normal_ht', 'congruent': 10, 'same': False}}
