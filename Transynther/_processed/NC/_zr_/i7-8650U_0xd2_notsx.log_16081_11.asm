...
push %rdi
push %rsi
lea addresses_A_ht+0xba7c, %rsi
lea addresses_WC_ht+0x91f6, %rdi
clflush (%rdi)
nop
nop
add %rbp, %rbp
...
nop
inc %r9
lea addresses_WC_ht+0x1287c, %rax
nop
nop
nop
nop
...
nop
dec %r9
lea addresses_UC_ht+0x39fc, %rsi
lea addresses_WC_ht+0xdf0c, %rdi
nop
nop
nop
sub %r10, %r10
...
{'OP': 'STOR', 'dst': {'type': 'addresses_WT', 'size': 8, 'AVXalign': False, 'NT': True, 'congruent': 6, 'same': False}}
...
{'OP': 'STOR', 'dst': {'type': 'addresses_WC_ht', 'size': 2, 'AVXalign': False, 'NT': True, 'congruent': 7, 'same': False}}
{'OP': 'REPM', 'src': {'type': 'addresses_UC_ht', 'congruent': 7, 'same': False}, 'dst': {'type': 'addresses_WC_ht', 'congruent': 4, 'same': False}}
{'00': 16081}
