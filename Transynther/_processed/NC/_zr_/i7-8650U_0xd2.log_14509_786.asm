...
push %rdi
push %rsi
lea addresses_WC_ht+0x1624e, %r8
nop
nop
sub %r14, %r14
movb (%r8), %r13b
...
nop
and $52426, %r14
lea addresses_D_ht+0x101f6, %r13
nop
nop
sub $28900, %r9
...
movq %rax, (%r13)
dec %r9
lea addresses_WC_ht+0x6a86, %rsi
lea addresses_A_ht+0x1e0f6, %rdi
clflush (%rdi)
nop
nop
nop
...
nop
add $26483, %r8
lea addresses_WT_ht+0x199ae, %rsi
lea addresses_WC_ht+0x28f6, %rdi
nop
and %r9, %r9
mov $13, %rcx
rep movsb
...
nop
inc %rdi
lea addresses_normal_ht+0x20f6, %rsi
...
nop
dec %rax
lea addresses_UC_ht+0x1accd, %r13
cmp $19192, %rsi
mov (%r13), %di
add %rdi, %rdi
lea addresses_normal_ht+0xf6, %rsi
lea addresses_WT_ht+0xfa76, %rdi
nop
nop
xor %r8, %r8
mov $2, %rcx
...
{'OP': 'STOR', 'dst': {'type': 'addresses_NC', 'size': 8, 'AVXalign': True, 'NT': False, 'congruent': 2, 'same': False}}
[Faulty Load]
{'OP': 'LOAD', 'src': {'type': 'addresses_NC', 'size': 32, 'AVXalign': False, 'NT': False, 'congruent': 0, 'same': True}}
<gen_prepare_buffer>
{'OP': 'LOAD', 'src': {'type': 'addresses_WC_ht', 'size': 1, 'AVXalign': False, 'NT': False, 'congruent': 3, 'same': True}}
{'OP': 'STOR', 'dst': {'type': 'addresses_D_ht', 'size': 8, 'AVXalign': True, 'NT': True, 'congruent': 8, 'same': False}}
