...
push %rdi
push %rsi
lea addresses_normal_ht+0x84f0, %rbx
nop
nop
nop
add $7493, %r8
...
nop
sub $4267, %rax
lea addresses_normal_ht+0x15508, %r12
nop
nop
dec %rbx
...
nop
and $33988, %rbx
lea addresses_normal_ht+0x85e4, %rsi
lea addresses_D_ht+0xdbd0, %rdi
nop
nop
nop
nop
...
nop
cmp $49615, %rsi
lea addresses_UC_ht+0xeff0, %rsi
lea addresses_D_ht+0x17af0, %rdi
clflush (%rsi)
clflush (%rdi)
nop
nop
...
nop
cmp %rdi, %rdi
lea addresses_UC_ht+0x19250, %r15
nop
nop
nop
nop
...
nop
cmp $26601, %r15
lea addresses_A_ht+0x1e6f0, %rsi
nop
and $32865, %rbx
vmovups (%rsi), %ymm5
...
{'OP': 'STOR', 'dst': {'same': False, 'congruent': 9, 'NT': False, 'type': 'addresses_P', 'size': 1, 'AVXalign': True}}
[Faulty Load]
...
{'src': {'type': 'addresses_normal_ht', 'congruent': 2, 'same': False}, 'OP': 'REPM', 'dst': {'type': 'addresses_D_ht', 'congruent': 5, 'same': False}}
{'src': {'type': 'addresses_UC_ht', 'congruent': 8, 'same': False}, 'OP': 'REPM', 'dst': {'type': 'addresses_D_ht', 'congruent': 11, 'same': False}}
