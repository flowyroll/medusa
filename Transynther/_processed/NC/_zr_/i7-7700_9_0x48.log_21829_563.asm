...
push %rdi
push %rsi
lea addresses_UC_ht+0x2059, %r14
nop
nop
inc %r9
movb $0x61, (%r14)
...
nop
xor $12143, %r10
lea addresses_UC_ht+0x16d31, %r11
nop
nop
nop
inc %rax
...
nop
and %rdi, %rdi
lea addresses_D_ht+0x4a59, %rsi
lea addresses_normal_ht+0x8a59, %rdi
nop
nop
nop
sub %r12, %r12
...
nop
and %r12, %r12
lea addresses_A_ht+0x126d9, %r11
nop
nop
nop
nop
...
nop
sub $12558, %rdi
lea addresses_WC_ht+0xd9f9, %rsi
lea addresses_WC_ht+0x13155, %rdi
clflush (%rsi)
nop
xor $65043, %r11
mov $91, %rcx
...
nop
inc %r12
lea addresses_A_ht+0x83d9, %rsi
lea addresses_D_ht+0x3c99, %rdi
mfence
mov $8, %rcx
rep movsl
inc %r14
lea addresses_WC_ht+0x785d, %r14
nop
nop
nop
nop
...
nop
dec %r11
lea addresses_D_ht+0x6a59, %rsi
lea addresses_WC_ht+0xadd9, %rdi
nop
nop
nop
cmp %r9, %r9
...
nop
xor %r11, %r11
lea addresses_WT_ht+0xd619, %rdi
nop
nop
nop
nop
...
nop
xor $21931, %r14
lea addresses_WC_ht+0x14989, %rsi
lea addresses_A_ht+0x123ad, %rdi
nop
nop
nop
nop
...
nop
and $11257, %r14
lea addresses_WC_ht+0x12259, %rsi
lea addresses_WC_ht+0x1c59, %rdi
nop
nop
nop
xor $47452, %r14
...
nop
xor %r9, %r9
lea addresses_normal_ht+0x11959, %rax
nop
nop
nop
nop
...
<gen_prepare_buffer>
{'OP': 'STOR', 'dst': {'type': 'addresses_UC_ht', 'AVXalign': True, 'congruent': 9, 'size': 1, 'same': False, 'NT': False}}
