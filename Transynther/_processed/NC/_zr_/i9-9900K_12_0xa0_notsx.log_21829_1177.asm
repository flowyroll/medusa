...
push %rdi
push %rsi
lea addresses_UC_ht+0xabd7, %r12
clflush (%r12)
nop
nop
sub $62372, %rbx
...
nop
add %r10, %r10
lea addresses_WC_ht+0x101d7, %r10
xor $51992, %rbx
movb (%r10), %r11b
nop
and %rsi, %rsi
lea addresses_normal_ht+0x1af3b, %r11
dec %r15
movw $0x6162, (%r11)
nop
nop
cmp %r15, %r15
lea addresses_WT_ht+0x12b57, %r15
nop
nop
nop
sub %rsi, %rsi
...
nop
dec %r12
lea addresses_UC_ht+0x16ed9, %rsi
lea addresses_WC_ht+0x139b7, %rdi
nop
add $63439, %rbx
mov $60, %rcx
rep movsb
...
nop
add $33650, %r10
lea addresses_normal_ht+0xac67, %rsi
...
nop
inc %r8
lea addresses_WT_ht+0x9701, %r10
nop
nop
nop
nop
...
{'src': {'type': 'addresses_D_ht', 'AVXalign': False, 'size': 1, 'NT': False, 'same': True, 'congruent': 4}, 'OP': 'LOAD'}
...
{'src': {'type': 'addresses_normal_ht', 'congruent': 3, 'same': False}, 'OP': 'REPM', 'dst': {'type': 'addresses_WT_ht', 'congruent': 8, 'same': False}}
