...
push %rdi
push %rsi
lea addresses_A_ht+0x14f2f, %r14
nop
nop
nop
nop
...
nop
cmp $45953, %rcx
lea addresses_WC_ht+0x11eef, %rsi
lea addresses_WT_ht+0x12e2f, %rdi
dec %r9
mov $25, %rcx
rep movsq
nop
cmp %rax, %rax
lea addresses_UC_ht+0x19017, %rdi
nop
nop
nop
sub %rcx, %rcx
...
nop
add %rcx, %rcx
lea addresses_UC_ht+0x13c8f, %rsi
nop
nop
nop
nop
...
movups %xmm6, (%rsi)
xor $14921, %rcx
lea addresses_WC_ht+0x1162f, %rsi
lea addresses_WT_ht+0x1a76f, %rdi
nop
sub $33028, %rax
mov $55, %rcx
rep movsl
...
nop
and $42942, %rsi
lea addresses_WC_ht+0x1512f, %rsi
lea addresses_WC_ht+0x1064, %rdi
clflush (%rsi)
nop
nop
inc %r9
...
nop
sub $13750, %rax
lea addresses_D_ht+0x6136, %r9
nop
nop
cmp %r10, %r10
movb (%r9), %r14b
dec %rdi
lea addresses_UC_ht+0x12980, %rdi
nop
xor %rsi, %rsi
...
nop
add $3968, %rdi
lea addresses_D_ht+0x1662f, %rdi
clflush (%rdi)
nop
nop
nop
...
nop
mfence
lea addresses_normal_ht+0x2e2f, %rdi
nop
nop
nop
nop
...
{'OP': 'STOR', 'dst': {'NT': True, 'same': False, 'congruent': 5, 'type': 'addresses_D', 'AVXalign': False, 'size': 8}}
[Faulty Load]
{'src': {'NT': False, 'same': True, 'congruent': 0, 'type': 'addresses_NC', 'AVXalign': False, 'size': 4}, 'OP': 'LOAD'}
<gen_prepare_buffer>
...
{'OP': 'STOR', 'dst': {'NT': False, 'same': True, 'congruent': 0, 'type': 'addresses_UC_ht', 'AVXalign': True, 'size': 8}}
