...
nop
dec %r15
lea addresses_D_ht+0xfd38, %rbp
nop
xor $37256, %rbx
movl $0x61626364, (%rbp)
dec %rbx
lea addresses_UC_ht+0x163c0, %rsi
lea addresses_D_ht+0x3168, %rdi
dec %r14
mov $59, %rcx
rep movsq
inc %rsi
lea addresses_normal_ht+0xc9a8, %rdi
clflush (%rdi)
nop
nop
nop
...
nop
xor %rdx, %rdx
lea addresses_normal_ht+0x12098, %r14
nop
nop
and $11066, %rsi
...
nop
sub %rbp, %rbp
lea addresses_WT_ht+0xb3e1, %rdx
nop
nop
nop
mfence
...
nop
xor $40668, %rbx
lea addresses_WT_ht+0x6d38, %rsi
lea addresses_A_ht+0xc845, %rdi
nop
nop
add %rdx, %rdx
mov $69, %rcx
...
nop
add %rsi, %rsi
lea addresses_A_ht+0x382a, %rdi
nop
add %rax, %rax
mov (%rdi), %edx
nop
xor %r13, %r13
lea addresses_WT_ht+0x20d8, %rsi
lea addresses_A_ht+0xa2b8, %rdi
clflush (%rsi)
nop
nop
nop
...
nop
add %rsi, %rsi
lea addresses_WT_ht+0x11b11, %rbp
add %r13, %r13
movups (%rbp), %xmm7
vpextrq $0, %xmm7, %rdi
sub $53241, %rbp
lea addresses_normal_ht+0x12d38, %rsi
lea addresses_WT_ht+0x46b0, %rdi
nop
nop
nop
nop
...
{'src': {'congruent': 2, 'same': False, 'type': 'addresses_UC_ht'}, 'dst': {'congruent': 2, 'same': False, 'type': 'addresses_D_ht'}, 'OP': 'REPM'}
{'dst': {'NT': True, 'AVXalign': False, 'size': 8, 'congruent': 1, 'same': False, 'type': 'addresses_normal_ht'}, 'OP': 'STOR'}
{'dst': {'NT': False, 'AVXalign': False, 'size': 16, 'congruent': 5, 'same': True, 'type': 'addresses_normal_ht'}, 'OP': 'STOR'}
