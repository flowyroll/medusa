...
push %rdi
push %rsi
lea addresses_WT_ht+0xfc14, %r13
nop
sub %rcx, %rcx
...
nop
add %r8, %r8
lea addresses_UC_ht+0x4166, %rbx
nop
nop
nop
nop
...
movw $0x6162, (%r8)
add $7782, %rbx
lea addresses_UC_ht+0x11566, %rbx
nop
nop
nop
and %r13, %r13
...
nop
inc %rcx
lea addresses_WC_ht+0x7886, %rsi
lea addresses_A_ht+0x4766, %rdi
nop
cmp %r13, %r13
mov $13, %rcx
rep movsb
...
nop
xor %rbx, %rbx
lea addresses_WC_ht+0x2a66, %r13
xor $56857, %rcx
mov (%r13), %r8w
nop
nop
...
lea addresses_WC_ht+0x14666, %rdi
nop
nop
nop
sub $48897, %r14
...
nop
dec %rcx
lea addresses_UC_ht+0x1a93f, %r8
nop
nop
nop
nop
...
{'src': {'congruent': 4, 'same': False, 'type': 'addresses_WC_ht'}, 'OP': 'REPM', 'dst': {'congruent': 8, 'same': False, 'type': 'addresses_A_ht'}}
