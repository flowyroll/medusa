...
push %rdi
push %rsi
lea addresses_UC_ht+0xb51c, %rcx
cmp %r9, %r9
movl $0x61626364, (%rcx)
nop
nop
nop
cmp %r11, %r11
lea addresses_D_ht+0x86a4, %rcx
add $18661, %r11
movb $0x61, (%rcx)
nop
nop
dec %r13
lea addresses_WC_ht+0x4d1c, %rsi
lea addresses_WC_ht+0x1121c, %rdi
nop
nop
nop
nop
...
nop
add $9827, %r13
lea addresses_WT_ht+0xf11c, %r13
nop
nop
nop
nop
...
mov (%r9), %si
cmp %rcx, %rcx
lea addresses_UC_ht+0xd91c, %rsi
lea addresses_WT_ht+0x19e9c, %rdi
nop
nop
inc %r13
mov $25, %rcx
...
nop
and $39111, %r11
lea addresses_D_ht+0x251c, %rsi
lea addresses_UC_ht+0x5b1c, %rdi
nop
add $46483, %r13
mov $41, %rcx
rep movsw
...
nop
cmp $11366, %r13
lea addresses_UC_ht+0x19d1c, %rcx
nop
nop
nop
inc %rdi
...
nop
lfence
lea addresses_D_ht+0xae0c, %rsi
lea addresses_D_ht+0x121dc, %rdi
clflush (%rsi)
nop
nop
sub %rbp, %rbp
...
{'src': {'type': 'addresses_A_ht', 'same': True, 'size': 2, 'congruent': 9, 'NT': False, 'AVXalign': False}, 'OP': 'LOAD'}
{'src': {'type': 'addresses_UC_ht', 'congruent': 10, 'same': False}, 'dst': {'type': 'addresses_WT_ht', 'congruent': 4, 'same': True}, 'OP': 'REPM'}
...
{'src': {'type': 'addresses_D_ht', 'congruent': 2, 'same': False}, 'dst': {'type': 'addresses_D_ht', 'congruent': 4, 'same': False}, 'OP': 'REPM'}
{'00': 21829}
