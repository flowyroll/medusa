...
nop
cmp $63669, %rax
lea addresses_normal_ht+0x1d8a1, %rsi
lea addresses_WC_ht+0xfee1, %rdi
clflush (%rsi)
cmp $4676, %r13
mov $11, %rcx
rep movsw
...
nop
xor %rdx, %rdx
lea addresses_WT_ht+0x14ae1, %rdx
clflush (%rdx)
dec %rsi
...
{'OP': 'STOR', 'dst': {'type': 'addresses_A', 'size': 16, 'AVXalign': True, 'NT': False, 'congruent': 7, 'same': False}}
[Faulty Load]
