...
push %rdi
push %rsi
lea addresses_A_ht+0x1b67e, %rsi
lea addresses_UC_ht+0x15a7e, %rdi
nop
nop
nop
add $44072, %r8
...
rep movsl
cmp %rbx, %rbx
lea addresses_normal_ht+0x15e9e, %rsi
lea addresses_WT_ht+0x1ea16, %rdi
nop
nop
nop
inc %r13
...
nop
and %rsi, %rsi
lea addresses_WC_ht+0xe05a, %rsi
lea addresses_A_ht+0x1347e, %rdi
clflush (%rdi)
nop
nop
nop
...
nop
sub $47849, %rsi
lea addresses_UC_ht+0x17e7e, %rsi
nop
nop
cmp $29937, %rdi
...
nop
sub %r13, %r13
lea addresses_WT_ht+0x1a826, %rdi
clflush (%rdi)
nop
nop
add %rax, %rax
...
vpextrq $1, %xmm2, %r8
and %rsi, %rsi
lea addresses_A_ht+0x3d92, %rsi
lea addresses_WT_ht+0x1c266, %rdi
clflush (%rsi)
clflush (%rdi)
nop
nop
...
rep movsb
sub %rbx, %rbx
lea addresses_WT_ht+0x15cf6, %rdi
nop
nop
nop
nop
...
{'src': {'same': True, 'congruent': 1, 'type': 'addresses_WC_ht'}, 'OP': 'REPM', 'dst': {'same': False, 'congruent': 8, 'type': 'addresses_A_ht'}}
...
{'src': {'same': False, 'congruent': 2, 'type': 'addresses_A_ht'}, 'OP': 'REPM', 'dst': {'same': False, 'congruent': 3, 'type': 'addresses_WT_ht'}}
