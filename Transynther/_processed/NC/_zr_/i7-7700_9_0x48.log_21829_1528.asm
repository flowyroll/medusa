...
nop
sub $64514, %rsi
lea addresses_normal_ht+0xde7e, %r11
sub $4282, %rdi
vmovups (%r11), %ymm7
...
nop
cmp $62256, %rcx
lea addresses_A_ht+0x1087e, %r11
nop
nop
nop
nop
...
{'OP': 'LOAD', 'src': {'type': 'addresses_A', 'AVXalign': False, 'congruent': 7, 'size': 8, 'same': False, 'NT': False}}
{'OP': 'STOR', 'dst': {'type': 'addresses_RW', 'AVXalign': False, 'congruent': 2, 'size': 2, 'same': False, 'NT': True}}
[Faulty Load]
{'OP': 'LOAD', 'src': {'type': 'addresses_NC', 'AVXalign': False, 'congruent': 0, 'size': 16, 'same': True, 'NT': False}}
<gen_prepare_buffer>
