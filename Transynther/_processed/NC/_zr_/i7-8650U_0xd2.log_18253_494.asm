...
push %r9
push %rcx
lea addresses_A_ht+0x1146c, %r13
nop
nop
nop
nop
...
nop
xor %r13, %r13
lea addresses_UC_ht+0xa090, %rcx
nop
nop
nop
inc %r12
...
nop
sub %r9, %r9
lea addresses_WC_ht+0x17e5b, %r9
nop
nop
nop
nop
...
<gen_faulty_load>
[REF]
{'OP': 'LOAD', 'src': {'type': 'addresses_NC', 'size': 16, 'AVXalign': True, 'NT': True, 'congruent': 0, 'same': False}}
{'OP': 'LOAD', 'src': {'type': 'addresses_RW', 'size': 8, 'AVXalign': True, 'NT': True, 'congruent': 2, 'same': False}}
