...
push %rdi
push %rsi
lea addresses_D_ht+0x15d9b, %rsi
lea addresses_UC_ht+0x12441, %rdi
nop
nop
nop
xor $26840, %r10
...
nop
cmp $24079, %r8
lea addresses_normal_ht+0x1cbab, %r14
nop
nop
nop
inc %r13
...
nop
cmp %rcx, %rcx
lea addresses_WC_ht+0x13e87, %r13
nop
nop
nop
nop
...
nop
sub $31978, %rdi
lea addresses_WC_ht+0x1c56b, %rsi
lea addresses_D_ht+0xbdeb, %rdi
nop
nop
xor $52314, %r8
mov $104, %rcx
