...
push %rdi
push %rsi
lea addresses_WT_ht+0x29a3, %rsi
add $15385, %rcx
...
nop
dec %r8
lea addresses_WC_ht+0x9963, %rdi
clflush (%rdi)
nop
nop
nop
...
nop
xor %r8, %r8
lea addresses_normal_ht+0x13aa3, %rcx
nop
nop
and %rdi, %rdi
mov (%rcx), %r15d
nop
dec %r12
lea addresses_WT_ht+0x1243b, %r15
xor $63888, %rsi
movups (%r15), %xmm6
vpextrq $1, %xmm6, %rdi
nop
