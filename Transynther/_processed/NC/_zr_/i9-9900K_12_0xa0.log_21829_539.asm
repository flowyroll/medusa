...
push %rdi
push %rsi
lea addresses_normal_ht+0x182fa, %rbp
nop
nop
nop
nop
...
nop
and $1871, %r9
lea addresses_normal_ht+0x8f8e, %rbp
clflush (%rbp)
nop
and %rsi, %rsi
movups (%rbp), %xmm6
...
nop
add $62697, %r13
lea addresses_A_ht+0x1d40a, %r11
nop
nop
nop
nop
...
nop
sub $64154, %r9
lea addresses_WT_ht+0x1d5fe, %rsi
lea addresses_D_ht+0xc80e, %rdi
clflush (%rdi)
nop
nop
nop
...
// Store
lea addresses_UC+0x9e3e, %rsi
add $41234, %r10
movb $0x51, (%rsi)
cmp %r9, %r9

// Faulty Load
mov $0x6d270a0000000c0e, %r8
nop
nop
nop
nop
...
{'src': {'NT': True, 'same': False, 'congruent': 2, 'type': 'addresses_A_ht', 'AVXalign': False, 'size': 8}, 'OP': 'LOAD'}
{'OP': 'STOR', 'dst': {'NT': False, 'same': False, 'congruent': 4, 'type': 'addresses_D_ht', 'AVXalign': False, 'size': 32}}
{'src': {'same': False, 'congruent': 4, 'type': 'addresses_WT_ht'}, 'OP': 'REPM', 'dst': {'same': False, 'congruent': 10, 'type': 'addresses_D_ht'}}
