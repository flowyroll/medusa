...
push %rdi
push %rsi
lea addresses_WT_ht+0x16cfe, %rsi
lea addresses_normal_ht+0x96fe, %rdi
cmp %rbx, %rbx
mov $92, %rcx
rep movsw
nop
...
nop
cmp %rsi, %rsi
lea addresses_WT_ht+0x139fe, %rbp
nop
nop
nop
dec %r14
...
nop
xor $7896, %rbp
lea addresses_UC_ht+0x11bec, %rbp
nop
nop
cmp $28888, %rax
...
nop
dec %rsi
lea addresses_normal_ht+0x2bfe, %rax
nop
nop
nop
nop
