...
push %rdi
push %rdx
lea addresses_WC_ht+0x1a656, %rcx
and $64048, %rdx
vmovups (%rcx), %ymm3
...
nop
cmp %rdi, %rdi
lea addresses_normal_ht+0x2554, %r9
nop
nop
nop
nop
