...
push %rdi
push %rsi
lea addresses_A_ht+0x3b39, %rcx
nop
sub $31378, %r15
movw $0x6162, (%rcx)
nop
sub %r10, %r10
lea addresses_UC_ht+0x30d9, %r14
nop
nop
nop
nop
...
nop
cmp %rsi, %rsi
lea addresses_WT_ht+0x1c819, %r10
nop
nop
sub %rsi, %rsi
movb (%r10), %al
nop
and $7508, %r15
lea addresses_A_ht+0x13859, %rsi
lea addresses_UC_ht+0x1a7d9, %rdi
clflush (%rsi)
nop
nop
xor %rbp, %rbp
...
{'OP': 'REPM', 'src': {'type': 'addresses_A_ht', 'congruent': 7, 'same': False}, 'dst': {'type': 'addresses_UC_ht', 'congruent': 9, 'same': True}}
{'00': 21829}
