...
push %rdx
push %rsi
lea addresses_UC_ht+0x10657, %r8
nop
add $51682, %rbx
movb $0x61, (%r8)
nop
nop
add $9090, %rbp
lea addresses_normal_ht+0x388f, %rsi
lea addresses_WC_ht+0x1a8f, %rdi
clflush (%rsi)
nop
nop
nop
...
nop
add %r13, %r13
lea addresses_D_ht+0xc376, %rsi
lea addresses_A_ht+0x1e5c, %rdi
cmp $33539, %r8
mov $81, %rcx
rep movsl
nop
...
nop
add $49626, %r8
lea addresses_WC_ht+0x1e48f, %rsi
lea addresses_D_ht+0x2e0f, %rdi
cmp %rbx, %rbx
mov $40, %rcx
rep movsq
xor %r13, %r13
lea addresses_normal_ht+0xf40f, %rbp
nop
nop
nop
nop
...
nop
inc %rbp
lea addresses_WC_ht+0x1868f, %rdx
xor $31870, %r13
...
nop
sub $5861, %r13
lea addresses_normal_ht+0x468f, %rsi
nop
nop
nop
sub $36335, %rbx
...
nop
add $30493, %rbx
lea addresses_WT_ht+0x1014f, %rbp
nop
nop
nop
nop
...
nop
xor %r8, %r8
lea addresses_WC_ht+0x18ae7, %rsi
nop
nop
nop
nop
...
nop
and %r8, %r8
lea addresses_normal_ht+0x8f, %r8
nop
nop
nop
add %rbx, %rbx
...
{'OP': 'REPM', 'src': {'same': False, 'congruent': 0, 'type': 'addresses_D_ht'}, 'dst': {'same': False, 'congruent': 0, 'type': 'addresses_A_ht'}}
{'OP': 'REPM', 'src': {'same': False, 'congruent': 11, 'type': 'addresses_WC_ht'}, 'dst': {'same': False, 'congruent': 7, 'type': 'addresses_D_ht'}}
{'OP': 'LOAD', 'src': {'same': False, 'type': 'addresses_normal_ht', 'NT': True, 'AVXalign': False, 'size': 1, 'congruent': 1}}
