...
nop
add $14265, %rbx
lea addresses_D_ht+0x29ee, %rsi
lea addresses_normal_ht+0xa948, %rdi
nop
nop
nop
mfence
...
// Load
lea addresses_normal+0x12c78, %rbx
nop
nop
nop
nop
...
{'OP': 'STOR', 'dst': {'congruent': 5, 'AVXalign': True, 'same': False, 'size': 1, 'NT': False, 'type': 'addresses_UC'}}
...
{'OP': 'STOR', 'dst': {'congruent': 8, 'AVXalign': False, 'same': False, 'size': 8, 'NT': True, 'type': 'addresses_D_ht'}}
