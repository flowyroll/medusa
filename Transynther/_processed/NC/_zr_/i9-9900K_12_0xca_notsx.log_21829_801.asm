...
nop
xor $53788, %rax
lea addresses_A_ht+0x12b31, %r14
clflush (%r14)
nop
nop
cmp $44480, %rdx
...
nop
dec %rdx
lea addresses_normal_ht+0x13c19, %rsi
lea addresses_normal_ht+0x187b1, %rdi
nop
nop
nop
nop
...
nop
sub %rax, %rax
lea addresses_UC_ht+0xf7b1, %rcx
nop
nop
nop
nop
...
nop
and %r15, %r15
lea addresses_WT_ht+0x1a6b1, %rdi
nop
nop
and %rcx, %rcx
mov (%rdi), %ax
...
nop
sub $10265, %rcx
lea addresses_WT_ht+0xbf77, %rdi
xor %r15, %r15
movl $0x61626364, (%rdi)
nop
dec %rdx
lea addresses_UC_ht+0x4e4f, %rsi
nop
nop
nop
nop
...
nop
inc %rbp
lea addresses_normal_ht+0x10bb1, %rsi
lea addresses_WT_ht+0x10bb1, %rdi
nop
nop
cmp $676, %r12
mov $52, %rcx
...
nop
and %r14, %r14
lea addresses_WC_ht+0xcbb1, %rsi
lea addresses_normal_ht+0x6bb1, %rdi
clflush (%rdi)
nop
nop
nop
...
{'OP': 'REPM', 'src': {'same': False, 'congruent': 0, 'type': 'addresses_normal_ht'}, 'dst': {'same': False, 'congruent': 10, 'type': 'addresses_normal_ht'}}
...
{'OP': 'REPM', 'src': {'same': False, 'congruent': 10, 'type': 'addresses_normal_ht'}, 'dst': {'same': True, 'congruent': 9, 'type': 'addresses_WT_ht'}}
{'OP': 'REPM', 'src': {'same': False, 'congruent': 9, 'type': 'addresses_WC_ht'}, 'dst': {'same': False, 'congruent': 9, 'type': 'addresses_normal_ht'}}
{'00': 21829}
