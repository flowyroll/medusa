...
push %rdx
push %rsi
lea addresses_normal_ht+0x125a5, %r12
and %rbp, %rbp
movw $0x6162, (%r12)
nop
nop
...
nop
sub %r9, %r9
lea addresses_normal_ht+0x1747d, %r12
nop
nop
sub %r11, %r11
...
nop
sub $64158, %rdx
lea addresses_D_ht+0xc725, %rsi
lea addresses_WC_ht+0x1c8dd, %rdi
clflush (%rsi)
nop
cmp $43237, %rbp
mov $65, %rcx
...
nop
cmp $12618, %rcx
lea addresses_D_ht+0x17325, %r12
nop
nop
nop
nop
...
nop
cmp $14596, %r11
lea addresses_D_ht+0x109a5, %rdx
nop
nop
nop
nop
...
vmovups %ymm5, (%rdx)
lfence
lea addresses_normal_ht+0x13425, %rsi
lea addresses_D_ht+0x5da5, %rdi
clflush (%rdi)
nop
nop
nop
