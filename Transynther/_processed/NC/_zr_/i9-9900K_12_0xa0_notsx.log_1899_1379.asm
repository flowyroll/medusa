...
push %rdx
push %rsi
lea addresses_WT_ht+0x1b744, %rdx
nop
nop
nop
nop
...
nop
cmp %rbx, %rbx
lea addresses_A_ht+0x16444, %rsi
nop
nop
nop
nop
...
nop
inc %rbx
lea addresses_D_ht+0x8944, %rsi
lea addresses_normal_ht+0x1d744, %rdi
nop
add %rdx, %rdx
mov $40, %rcx
rep movsb
sub %rcx, %rcx
lea addresses_D_ht+0x17744, %rsi
lea addresses_A_ht+0x4814, %rdi
clflush (%rsi)
nop
nop
add $30644, %rbx
...
nop
xor %rdi, %rdi
lea addresses_UC_ht+0x8f44, %r14
sub %r8, %r8
...
nop
cmp $58572, %r8
lea addresses_UC_ht+0xd664, %r14
nop
nop
nop
nop
...
nop
sub $37343, %rbx
lea addresses_WT_ht+0x178c4, %rbx
nop
sub %rsi, %rsi
movb (%rbx), %r14b
nop
...
nop
cmp %rdi, %rdi
lea addresses_WT_ht+0x1cad0, %rbx
nop
nop
nop
nop
...
vpextrq $0, %xmm3, %rdx
add %rdi, %rdi
lea addresses_WT_ht+0x12fc4, %r14
nop
nop
nop
nop
...
mov (%r14), %rdi
and %rcx, %rcx
lea addresses_UC_ht+0x5344, %rcx
clflush (%rcx)
nop
nop
nop
...
nop
inc %rsi
lea addresses_normal_ht+0x95a4, %rsi
lea addresses_UC_ht+0x1a544, %rdi
clflush (%rdi)
dec %rdx
mov $19, %rcx
rep movsw
...
nop
and $9772, %rbx
lea addresses_A_ht+0x1dd77, %rsi
lea addresses_WC_ht+0xca04, %rdi
nop
nop
nop
dec %r8
...
nop
and %rcx, %rcx
lea addresses_D_ht+0x3064, %rsi
lea addresses_WT_ht+0x17134, %rdi
nop
nop
nop
nop
...
{'OP': 'STOR', 'dst': {'type': 'addresses_A_ht', 'AVXalign': False, 'size': 8, 'NT': True, 'same': False, 'congruent': 8}}
...
{'src': {'type': 'addresses_A_ht', 'congruent': 0, 'same': False}, 'OP': 'REPM', 'dst': {'type': 'addresses_WC_ht', 'congruent': 5, 'same': False}}
