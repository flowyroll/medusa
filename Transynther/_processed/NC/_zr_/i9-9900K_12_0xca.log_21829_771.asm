...
push %rdx
push %rsi
lea addresses_D_ht+0x1cabf, %rsi
nop
nop
nop
nop
...
nop
xor $39333, %r8
lea addresses_normal_ht+0x7585, %rcx
nop
nop
nop
nop
...
nop
add %r8, %r8
lea addresses_normal_ht+0x3933, %r8
nop
nop
sub %rcx, %rcx
...
vpextrq $0, %xmm5, %rdi
add %r8, %r8
lea addresses_A_ht+0x19417, %rdi
nop
nop
nop
add $18070, %r8
