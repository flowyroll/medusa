...
push %rdi
push %rsi
lea addresses_WC_ht+0x151fc, %r15
nop
nop
nop
cmp $58108, %r9
...
nop
lfence
lea addresses_WT_ht+0x6ffc, %rdi
clflush (%rdi)
inc %r11
mov (%rdi), %ax
nop
...
nop
cmp $51824, %rdi
lea addresses_normal_ht+0x2dfc, %r15
xor $14132, %rax
movb (%r15), %r11b
nop
nop
cmp $35602, %r8
lea addresses_normal_ht+0x1e87c, %r15
nop
nop
add %rdi, %rdi
movb (%r15), %r11b
and $34165, %r8
lea addresses_A_ht+0x393c, %r9
nop
nop
nop
nop
...
nop
sub $43155, %r11
lea addresses_WC_ht+0x2dfc, %rdi
clflush (%rdi)
sub %r9, %r9
mov (%rdi), %r12w
nop
...
nop
cmp $25000, %r12
lea addresses_WC_ht+0x1e82c, %rsi
lea addresses_UC_ht+0xefdc, %rdi
nop
nop
nop
sub $39820, %r9
...
{'OP': 'STOR', 'dst': {'NT': True, 'same': False, 'congruent': 2, 'type': 'addresses_D', 'AVXalign': False, 'size': 1}}
[Faulty Load]
{'src': {'NT': False, 'same': True, 'congruent': 0, 'type': 'addresses_NC', 'AVXalign': False, 'size': 16}, 'OP': 'LOAD'}
<gen_prepare_buffer>
{'src': {'NT': False, 'same': False, 'congruent': 8, 'type': 'addresses_WC_ht', 'AVXalign': True, 'size': 8}, 'OP': 'LOAD'}
