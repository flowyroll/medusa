...
push %rdi
push %rsi
lea addresses_WT_ht+0x869c, %rbp
nop
nop
sub %rdi, %rdi
movb (%rbp), %al
nop
cmp %r15, %r15
lea addresses_normal_ht+0xfbdc, %r8
nop
nop
add %r11, %r11
...
nop
add $12899, %r15
lea addresses_WC_ht+0x15c44, %rsi
lea addresses_D_ht+0x1c5c, %rdi
nop
nop
and $42456, %rax
mov $109, %rcx
...
nop
add %rcx, %rcx
lea addresses_D_ht+0x1450e, %rsi
lea addresses_A_ht+0x1d39c, %rdi
and $6576, %rbp
mov $6, %rcx
rep movsq
nop
...
nop
add %rsi, %rsi
lea addresses_WT_ht+0x18e9c, %rdi
nop
nop
nop
dec %r8
...
nop
and %r15, %r15
lea addresses_WC_ht+0x17f9c, %rbp
and %rcx, %rcx
movups (%rbp), %xmm7
vpextrq $1, %xmm7, %r11
nop
...
nop
add %r8, %r8
lea addresses_WT_ht+0xa91c, %rbp
sub %r11, %r11
movups (%rbp), %xmm5
vpextrq $0, %xmm5, %r8
nop
xor %r11, %r11
lea addresses_WT_ht+0x1a91c, %rsi
nop
nop
nop
nop
...
nop
cmp %r11, %r11
lea addresses_D_ht+0x1e2f4, %r11
nop
nop
nop
nop
...
nop
and $62573, %rsi
lea addresses_A_ht+0x19f9c, %rsi
lea addresses_UC_ht+0x1aa1c, %rdi
nop
nop
xor %r8, %r8
mov $64, %rcx
...
nop
and $27263, %r15
lea addresses_WT_ht+0x848c, %rcx
nop
nop
nop
nop
...
{'OP': 'REPM', 'src': {'type': 'addresses_WC_ht', 'congruent': 2, 'same': False}, 'dst': {'type': 'addresses_D_ht', 'congruent': 5, 'same': False}}
...
{'OP': 'LOAD', 'src': {'type': 'addresses_WT_ht', 'size': 32, 'AVXalign': False, 'NT': True, 'congruent': 7, 'same': False}}
