...
vpextrq $0, %xmm6, %rcx
sub $14667, %r14
lea addresses_normal_ht+0x18390, %rsi
lea addresses_A_ht+0x1a390, %rdi
dec %r11
mov $35, %rcx
rep movsb
nop
...
nop
sub $40623, %rsi
lea addresses_normal_ht+0x7ac1, %r15
nop
nop
nop
and $44026, %rbx
...
nop
and $20514, %rcx
lea addresses_WC_ht+0x2552, %r15
nop
nop
nop
nop
...
nop
and $51209, %r15
lea addresses_normal_ht+0x19490, %r11
sub $18996, %rbx
movl $0x61626364, (%r11)
nop
cmp %r15, %r15
lea addresses_WC_ht+0x19122, %rsi
lea addresses_normal_ht+0x1bb16, %rdi
nop
xor %r13, %r13
mov $46, %rcx
rep movsq
...
{'OP': 'REPM', 'src': {'type': 'addresses_normal_ht', 'congruent': 7, 'same': False}, 'dst': {'type': 'addresses_A_ht', 'congruent': 8, 'same': False}}
