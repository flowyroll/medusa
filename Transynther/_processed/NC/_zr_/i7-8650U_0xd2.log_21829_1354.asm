...
push %rdx
push %rsi
lea addresses_WT_ht+0x15e16, %rsi
lea addresses_UC_ht+0x176a, %rdi
clflush (%rdi)
nop
nop
nop
...
nop
sub $22266, %r13
lea addresses_WT_ht+0x1d302, %r10
nop
add %rdx, %rdx
mov (%r10), %cx
nop
...
nop
add $57004, %r10
lea addresses_WC_ht+0x1d9ba, %rdi
nop
nop
nop
add $8561, %rdx
...
nop
sub $41962, %rbp
lea addresses_normal_ht+0x39ba, %rsi
lea addresses_UC_ht+0x1daaa, %rdi
nop
nop
nop
add $21177, %rax
...
nop
and $64727, %rcx
lea addresses_WC_ht+0x9dba, %rsi
lea addresses_WT_ht+0x1773a, %rdi
clflush (%rsi)
xor %r13, %r13
mov $28, %rcx
rep movsw
sub %r10, %r10
lea addresses_WC_ht+0x105ba, %rcx
cmp %rax, %rax
mov $0x6162636465666768, %rsi
movq %rsi, %xmm5
movups %xmm5, (%rcx)
...
<gen_prepare_buffer>
{'OP': 'REPM', 'src': {'type': 'addresses_WT_ht', 'congruent': 1, 'same': False}, 'dst': {'type': 'addresses_UC_ht', 'congruent': 4, 'same': False}}
{'OP': 'LOAD', 'src': {'type': 'addresses_WT_ht', 'size': 2, 'AVXalign': False, 'NT': False, 'congruent': 3, 'same': False}}
{'OP': 'STOR', 'dst': {'type': 'addresses_WC_ht', 'size': 8, 'AVXalign': False, 'NT': True, 'congruent': 11, 'same': False}}
