...
push %rdx
push %rsi
lea addresses_UC_ht+0x1ab3a, %rbp
nop
nop
nop
nop
...
nop
cmp $17467, %rbp
lea addresses_A_ht+0x1228a, %rsi
lea addresses_D_ht+0xad22, %rdi
nop
nop
and $22805, %r13
mov $69, %rcx
rep movsl
and $18436, %rbx
lea addresses_D_ht+0x5f3a, %rsi
lea addresses_D_ht+0x33a, %rdi
nop
nop
nop
xor $37592, %rdx
...
nop
xor $23715, %rdi
lea addresses_UC_ht+0x354a, %rcx
nop
nop
nop
sub $33705, %rbp
...
nop
cmp %rcx, %rcx
lea addresses_WT_ht+0x333a, %rdx
nop
nop
nop
sub $11952, %rcx
...
nop
dec %rsi
lea addresses_UC_ht+0x1793a, %rbx
and %rcx, %rcx
movb (%rbx), %dl
nop
add $26756, %r13
...
// REPMOV
lea addresses_UC+0x1dbfa, %rsi
lea addresses_PSE+0x161fa, %rdi
nop
nop
nop
nop
...
{'src': {'congruent': 2, 'same': False, 'type': 'addresses_UC'}, 'dst': {'congruent': 6, 'same': False, 'type': 'addresses_PSE'}, 'OP': 'REPM'}
...
{'dst': {'NT': False, 'AVXalign': True, 'size': 16, 'congruent': 11, 'same': False, 'type': 'addresses_A_ht'}, 'OP': 'STOR'}
