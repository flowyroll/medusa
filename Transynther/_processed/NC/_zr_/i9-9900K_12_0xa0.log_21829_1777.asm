...
push %rdi
push %rsi
lea addresses_UC_ht+0x2d64, %rsi
lea addresses_WC_ht+0x6564, %rdi
nop
nop
nop
nop
...
nop
dec %r13
lea addresses_D_ht+0x14d64, %r9
xor $12666, %r8
mov (%r9), %ecx
nop
nop
xor $18684, %r13
lea addresses_UC_ht+0x3564, %rsi
nop
nop
inc %r8
movups (%rsi), %xmm2
...
nop
and %rdi, %rdi
lea addresses_normal_ht+0x1a564, %rsi
lea addresses_A_ht+0x153dc, %rdi
nop
nop
nop
cmp $48374, %r9
...
{'OP': 'STOR', 'dst': {'NT': True, 'same': False, 'congruent': 9, 'type': 'addresses_D', 'AVXalign': False, 'size': 32}}
[Faulty Load]
...
{'src': {'same': True, 'congruent': 11, 'type': 'addresses_normal_ht'}, 'OP': 'REPM', 'dst': {'same': False, 'congruent': 1, 'type': 'addresses_A_ht'}}
{'00': 21829}
