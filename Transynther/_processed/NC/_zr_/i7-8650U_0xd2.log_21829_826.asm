...
push %rdi
push %rsi
lea addresses_normal_ht+0x81ba, %r12
nop
nop
sub $48152, %rax
movb (%r12), %cl
sub $47569, %rsi
lea addresses_WT_ht+0x103a, %rsi
lea addresses_WT_ht+0x1be90, %rdi
nop
nop
nop
nop
...
nop
xor %rdi, %rdi
lea addresses_normal_ht+0x7266, %rdi
nop
nop
nop
nop
...
nop
and %rax, %rax
lea addresses_A_ht+0xbc8a, %rsi
lea addresses_A_ht+0x18bba, %rdi
add %rbp, %rbp
mov $41, %rcx
rep movsl
nop
...
{'OP': 'STOR', 'dst': {'type': 'addresses_P', 'size': 32, 'AVXalign': True, 'NT': False, 'congruent': 6, 'same': False}}
[Faulty Load]
...
{'OP': 'REPM', 'src': {'type': 'addresses_A_ht', 'congruent': 4, 'same': False}, 'dst': {'type': 'addresses_A_ht', 'congruent': 9, 'same': False}}
