...
push %rdi
push %rsi
lea addresses_WC_ht+0x110ae, %rsi
lea addresses_WT_ht+0x18076, %rdi
nop
xor $7891, %rbp
mov $104, %rcx
rep movsq
...
nop
add $39529, %r8
lea addresses_normal_ht+0x5f2e, %rdi
clflush (%rdi)
nop
nop
dec %r11
movb (%rdi), %cl
cmp $6886, %rsi
lea addresses_WT_ht+0x11b56, %rbp
add %rsi, %rsi
mov (%rbp), %cx
nop
nop
...
lea addresses_UC_ht+0x1c56, %rdi
nop
cmp $49550, %r11
mov $96, %rcx
rep movsl
...
{'OP': 'LOAD', 'src': {'type': 'addresses_WT_ht', 'AVXalign': True, 'congruent': 5, 'size': 2, 'same': False, 'NT': False}}
{'OP': 'LOAD', 'src': {'type': 'addresses_A_ht', 'AVXalign': True, 'congruent': 10, 'size': 16, 'same': False, 'NT': False}}
