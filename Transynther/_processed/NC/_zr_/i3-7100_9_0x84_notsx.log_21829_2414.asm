...
push %rdx
push %rsi
lea addresses_WT_ht+0x5759, %r13
and $3521, %r8
movl $0x61626364, (%r13)
nop
nop
nop
xor %rsi, %rsi
lea addresses_WT_ht+0x12959, %rsi
nop
nop
nop
nop
...
nop
and $24416, %rdx
lea addresses_normal_ht+0x17a39, %r8
nop
nop
nop
nop
...
nop
xor $10876, %r10
lea addresses_WT_ht+0x17219, %r13
nop
nop
nop
and $64594, %r10
...
nop
sub %r8, %r8
lea addresses_UC_ht+0x14619, %r13
nop
nop
inc %rdx
movl $0x61626364, (%r13)
...
nop
sub $62783, %r8
lea addresses_UC_ht+0x1c259, %rsi
lea addresses_normal_ht+0x16659, %rdi
nop
nop
nop
xor $2708, %r12
...
// REPMOV
lea addresses_A+0x27bf, %rsi
lea addresses_PSE+0x22dc, %rdi
nop
nop
nop
nop
...
{'src': {'type': 'addresses_A', 'congruent': 1, 'same': False}, 'dst': {'type': 'addresses_PSE', 'congruent': 0, 'same': False}, 'OP': 'REPM'}
...
{'src': {'type': 'addresses_UC_ht', 'congruent': 10, 'same': False}, 'dst': {'type': 'addresses_normal_ht', 'congruent': 10, 'same': False}, 'OP': 'REPM'}
{'00': 21829}
