...
nop
add $36220, %rax
lea addresses_WC_ht+0x1cf56, %r9
nop
xor $28065, %rsi
...
nop
add $57149, %r9
lea addresses_UC_ht+0xdb06, %r11
nop
nop
nop
nop
...
movq %rax, (%r11)
xor $1463, %rbp
lea addresses_WT_ht+0x17fe6, %r10
nop
nop
xor $59981, %rsi
movl $0x61626364, (%r10)
...
nop
and %r9, %r9
lea addresses_normal_ht+0xd1e6, %rsi
lea addresses_WT_ht+0xdfe6, %rdi
nop
nop
nop
nop
...
nop
sub $29538, %rax
lea addresses_WT_ht+0x8316, %rcx
nop
nop
nop
nop
...
nop
dec %rdi
lea addresses_WC_ht+0xd026, %rdi
nop
nop
nop
and $9734, %r9
...
{'OP': 'STOR', 'dst': {'same': False, 'type': 'addresses_NC', 'NT': False, 'AVXalign': True, 'size': 4, 'congruent': 5}}
[Faulty Load]
...
{'OP': 'STOR', 'dst': {'same': False, 'type': 'addresses_normal_ht', 'NT': True, 'AVXalign': True, 'size': 16, 'congruent': 10}}
...
{'OP': 'REPM', 'src': {'same': False, 'congruent': 8, 'type': 'addresses_normal_ht'}, 'dst': {'same': False, 'congruent': 9, 'type': 'addresses_WT_ht'}}
{'OP': 'LOAD', 'src': {'same': True, 'type': 'addresses_WT_ht', 'NT': True, 'AVXalign': False, 'size': 2, 'congruent': 2}}
