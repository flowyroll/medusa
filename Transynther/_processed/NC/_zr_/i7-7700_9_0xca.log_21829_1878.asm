...
lea addresses_WT_ht+0x749d, %rdi
nop
inc %rbx
mov $19, %rcx
rep movsq
nop
inc %r15
lea addresses_D_ht+0x1613d, %rcx
nop
nop
nop
cmp $62140, %rdi
...
nop
cmp $35843, %rdi
lea addresses_normal_ht+0x1171d, %rsi
lea addresses_A_ht+0x1c89d, %rdi
nop
nop
cmp %r8, %r8
mov $48, %rcx
...
// Store
lea addresses_normal+0xb01d, %rdi
nop
nop
nop
nop
...
// Store
lea addresses_normal+0x6775, %r10
clflush (%r10)
nop
nop
nop
...
{'OP': 'STOR', 'dst': {'congruent': 2, 'AVXalign': True, 'same': False, 'size': 4, 'NT': False, 'type': 'addresses_A'}}
[Faulty Load]
