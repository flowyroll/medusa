...
movb $0x61, (%r8)
xor $3484, %r9
lea addresses_D_ht+0xce83, %rsi
lea addresses_normal_ht+0x2940, %rdi
nop
nop
sub %r15, %r15
mov $11, %rcx
rep movsl
and $15205, %r10
lea addresses_A_ht+0x13540, %r12
nop
xor %r9, %r9
mov (%r12), %r15w
nop
xor $17459, %rcx
lea addresses_WT_ht+0x18d40, %rsi
nop
xor %r10, %r10
movb (%rsi), %r9b
nop
sub %rcx, %rcx
lea addresses_WT_ht+0x10140, %rsi
lea addresses_normal_ht+0xb200, %rdi
inc %r8
mov $124, %rcx
rep movsl
nop
...
{'src': {'same': False, 'congruent': 0, 'type': 'addresses_D_ht'}, 'OP': 'REPM', 'dst': {'same': False, 'congruent': 11, 'type': 'addresses_normal_ht'}}
...
{'src': {'same': False, 'congruent': 11, 'type': 'addresses_WT_ht'}, 'OP': 'REPM', 'dst': {'same': False, 'congruent': 5, 'type': 'addresses_normal_ht'}}
