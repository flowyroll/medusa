...
nop
and $5666, %rdi
lea addresses_A_ht+0x1c31f, %r10
add $1218, %rcx
mov (%r10), %r8w
nop
xor %r10, %r10
...
<gen_prepare_buffer>
{'dst': {'same': True, 'NT': False, 'AVXalign': False, 'size': 32, 'type': 'addresses_WC_ht', 'congruent': 0}, 'OP': 'STOR'}
