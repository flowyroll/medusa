...
push %rdi
push %rdx
lea addresses_WT_ht+0x19c32, %rdi
nop
nop
nop
dec %rbx
...
nop
and %rbp, %rbp
lea addresses_WT_ht+0x4222, %rdx
nop
nop
nop
nop
...
nop
dec %r14
lea addresses_normal_ht+0xf222, %rdx
nop
nop
nop
nop
...
nop
add %r9, %r9
lea addresses_normal_ht+0x150bc, %rdx
clflush (%rdx)
nop
nop
nop
...
{'OP': 'STOR', 'dst': {'congruent': 11, 'AVXalign': False, 'same': False, 'size': 2, 'NT': True, 'type': 'addresses_normal_ht'}}
