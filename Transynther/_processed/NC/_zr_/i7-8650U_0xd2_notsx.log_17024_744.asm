...
push %rbx
push %rdi
lea addresses_WT_ht+0x1424f, %r9
clflush (%r9)
nop
nop
nop
...
vpextrq $1, %xmm3, %rbx
and %r10, %r10
lea addresses_A_ht+0x17134, %rdi
nop
nop
nop
nop
...
mov (%rdi), %r11w
add %r10, %r10
lea addresses_WT_ht+0x1c7e4, %r8
nop
nop
nop
dec %rbx
...
nop
xor $12419, %rdi
lea addresses_WT_ht+0x1b4f4, %r8
clflush (%r8)
add %r15, %r15
...
nop
and $26287, %r8
lea addresses_normal_ht+0x76b4, %r11
nop
nop
and $62672, %rdi
...
<gen_prepare_buffer>
{'OP': 'LOAD', 'src': {'type': 'addresses_WT_ht', 'size': 32, 'AVXalign': True, 'NT': False, 'congruent': 0, 'same': False}}
