...
push %rdx
push %rsi
lea addresses_WT_ht+0x11991, %r13
nop
nop
nop
nop
...
nop
add %rbp, %rbp
lea addresses_D_ht+0x1d879, %rsi
lea addresses_UC_ht+0xe879, %rdi
nop
nop
nop
nop
...
nop
add %rcx, %rcx
lea addresses_A_ht+0x6d79, %r13
clflush (%r13)
xor %r12, %r12
movw $0x6162, (%r13)
mfence
lea addresses_D_ht+0x1a679, %r12
nop
nop
nop
and %rdx, %rdx
