...
push %rdx
push %rsi
lea addresses_WT_ht+0x196fa, %rsi
lea addresses_normal_ht+0xfe2a, %rdi
nop
xor %r13, %r13
mov $76, %rcx
rep movsb
nop
xor %rdx, %rdx
lea addresses_normal_ht+0x98a, %rdx
nop
nop
nop
sub %r8, %r8
...
nop
add $44914, %rdi
lea addresses_A_ht+0xf002, %rsi
lea addresses_A_ht+0x1968c, %rdi
nop
nop
cmp %r13, %r13
mov $71, %rcx
...
nop
sub %r13, %r13
lea addresses_WC_ht+0x1798a, %rcx
nop
nop
nop
and %r11, %r11
...
nop
add %rcx, %rcx
lea addresses_WC_ht+0x1dc2a, %r11
nop
nop
nop
nop
...
nop
add $63541, %rdi
lea addresses_normal_ht+0xa08a, %rsi
...
nop
cmp %rdx, %rdx
lea addresses_WC_ht+0x1648a, %rsi
lea addresses_WC_ht+0x1bb2a, %rdi
clflush (%rsi)
nop
nop
nop
...
nop
dec %r8
lea addresses_WT_ht+0x1e58a, %r11
nop
nop
nop
nop
...
nop
xor $11734, %rdx
lea addresses_normal_ht+0xb3e4, %r13
sub $29646, %r11
...
// Store
lea addresses_normal+0x1b00a, %rsi
nop
add $61630, %rbp
...
{'dst': {'NT': False, 'AVXalign': False, 'size': 8, 'congruent': 7, 'same': False, 'type': 'addresses_normal'}, 'OP': 'STOR'}
...
{'src': {'NT': True, 'AVXalign': False, 'size': 16, 'congruent': 9, 'same': False, 'type': 'addresses_normal_ht'}, 'OP': 'LOAD'}
...
{'src': {'congruent': 7, 'same': False, 'type': 'addresses_WC_ht'}, 'dst': {'congruent': 3, 'same': False, 'type': 'addresses_WC_ht'}, 'OP': 'REPM'}
