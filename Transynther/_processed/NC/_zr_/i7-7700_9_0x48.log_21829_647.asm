...
push %rdi
push %rsi
lea addresses_normal_ht+0x97d9, %rsi
lea addresses_WT_ht+0x50b9, %rdi
nop
nop
nop
nop
...
nop
and $4658, %rax
lea addresses_A_ht+0x1ccd9, %rbx
clflush (%rbx)
nop
nop
nop
...
nop
add $18785, %rsi
lea addresses_D_ht+0x7fd9, %rsi
lea addresses_D_ht+0xa179, %rdi
nop
nop
nop
xor $6980, %r9
...
nop
cmp $8536, %rcx
lea addresses_WT_ht+0x13019, %r9
nop
nop
nop
add $51317, %rbx
...
nop
xor %rbx, %rbx
lea addresses_D_ht+0x18a84, %rcx
nop
nop
nop
nop
...
nop
inc %rax
lea addresses_WT_ht+0x4b69, %rsi
lea addresses_normal_ht+0x1d8d9, %rdi
clflush (%rsi)
cmp %r10, %r10
mov $34, %rcx
rep movsq
...
nop
xor %r8, %r8
lea addresses_normal_ht+0x1d2b5, %rsi
nop
nop
nop
cmp %rdi, %rdi
...
nop
add $14744, %r9
lea addresses_WC_ht+0xe101, %rsi
lea addresses_WT_ht+0x1ca19, %rdi
nop
and $15787, %r10
mov $88, %rcx
rep movsw
...
nop
xor %rdi, %rdi
lea addresses_WC_ht+0xc619, %rsi
lea addresses_WC_ht+0x1d7d9, %rdi
nop
nop
sub $35073, %r10
mov $94, %rcx
...
// REPMOV
lea addresses_RW+0x5867, %rsi
lea addresses_PSE+0x1e679, %rdi
nop
nop
and %rdx, %rdx
mov $48, %rcx
...
{'OP': 'REPM', 'src': {'type': 'addresses_RW', 'congruent': 0, 'same': False}, 'dst': {'type': 'addresses_PSE', 'congruent': 5, 'same': False}}
...
{'OP': 'STOR', 'dst': {'type': 'addresses_A_ht', 'AVXalign': True, 'congruent': 8, 'size': 1, 'same': False, 'NT': True}}
...
{'OP': 'REPM', 'src': {'type': 'addresses_WC_ht', 'congruent': 3, 'same': False}, 'dst': {'type': 'addresses_WT_ht', 'congruent': 3, 'same': False}}
