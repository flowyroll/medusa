...
movups %xmm7, (%rax)
inc %rdx
lea addresses_D_ht+0x11b8e, %r8
nop
xor %rsi, %rsi
movw $0x6162, (%r8)
nop
cmp $58777, %rdx
lea addresses_WT_ht+0x148a, %rsi
lea addresses_WT_ht+0xf08a, %rdi
clflush (%rsi)
nop
add $45458, %r8
mov $35, %rcx
...
nop
xor $22795, %rax
lea addresses_UC_ht+0xa892, %rdi
nop
nop
nop
nop
...
nop
inc %rdx
lea addresses_WT_ht+0xd00a, %r15
nop
nop
nop
nop
...
{'src': {'type': 'addresses_WT_ht', 'congruent': 6, 'same': False}, 'dst': {'type': 'addresses_WT_ht', 'congruent': 5, 'same': False}, 'OP': 'REPM'}
