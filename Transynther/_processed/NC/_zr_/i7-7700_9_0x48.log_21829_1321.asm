...
lea addresses_WT_ht+0x6e67, %rdi
nop
nop
nop
nop
...
nop
and $31666, %r14
lea addresses_WC_ht+0xd6e3, %rsi
lea addresses_WT_ht+0x4071, %rdi
nop
nop
nop
nop
...
nop
cmp %r15, %r15
lea addresses_normal_ht+0xa8f5, %rsi
lea addresses_WT_ht+0xaee5, %rdi
clflush (%rsi)
nop
and %rdx, %rdx
mov $96, %rcx
...
nop
xor $49011, %rcx
lea addresses_WC_ht+0x5398, %r15
dec %r8
mov (%r15), %r14
nop
nop
nop
and $49237, %rdi
lea addresses_UC_ht+0x1bc3b, %r15
nop
nop
nop
nop
...
nop
and $38783, %r14
lea addresses_D_ht+0x15ff1, %r15
nop
nop
nop
sub %rdi, %rdi
...
nop
lfence
lea addresses_UC_ht+0xf3f1, %rcx
nop
inc %rdx
mov $0x6162636465666768, %r14
movq %r14, %xmm2
...
nop
inc %r8
lea addresses_normal_ht+0xa671, %r14
add %r15, %r15
mov (%r14), %di
nop
and %rcx, %rcx
lea addresses_A_ht+0x191e1, %r8
nop
and %rcx, %rcx
mov (%r8), %rdx
sub $55714, %r8
lea addresses_WT_ht+0x10971, %rbx
nop
nop
xor %r15, %r15
movl $0x61626364, (%rbx)
...
{'OP': 'STOR', 'dst': {'type': 'addresses_UC', 'AVXalign': False, 'congruent': 1, 'size': 8, 'same': False, 'NT': False}}
[Faulty Load]
...
{'OP': 'REPM', 'src': {'type': 'addresses_normal_ht', 'congruent': 2, 'same': False}, 'dst': {'type': 'addresses_WT_ht', 'congruent': 1, 'same': False}}
...
{'OP': 'STOR', 'dst': {'type': 'addresses_D_ht', 'AVXalign': True, 'congruent': 7, 'size': 16, 'same': False, 'NT': True}}
