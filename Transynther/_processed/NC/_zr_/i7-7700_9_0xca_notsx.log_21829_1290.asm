...
push %rdi
push %rsi
lea addresses_UC_ht+0x139d8, %rsi
lea addresses_normal_ht+0xa070, %rdi
xor %r8, %r8
mov $10, %rcx
rep movsl
nop
...
nop
xor %r12, %r12
lea addresses_A_ht+0x1bf28, %rsi
lea addresses_D_ht+0x7df8, %rdi
nop
nop
nop
nop
...
nop
add $40016, %r12
lea addresses_UC_ht+0xb618, %rax
nop
nop
nop
xor $24574, %rcx
...
nop
dec %r8
lea addresses_WT_ht+0x1698, %r12
clflush (%r12)
nop
nop
cmp %rax, %rax
...
nop
sub $37084, %r12
lea addresses_normal_ht+0xd4c8, %rsi
...
<gen_prepare_buffer>
{'src': {'congruent': 3, 'same': False, 'type': 'addresses_UC_ht'}, 'dst': {'congruent': 0, 'same': False, 'type': 'addresses_normal_ht'}, 'OP': 'REPM'}
