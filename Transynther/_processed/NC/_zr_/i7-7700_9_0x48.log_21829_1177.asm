...
nop
xor $31272, %rbx
lea addresses_normal_ht+0x2eec, %r12
nop
nop
cmp %rax, %rax
movl $0x61626364, (%r12)
nop
cmp $8523, %r15
lea addresses_WT_ht+0xb4ec, %r15
sub %rax, %rax
movb (%r15), %r12b
nop
add $56936, %rcx
lea addresses_A_ht+0x2aec, %rsi
lea addresses_D_ht+0x1d804, %rdi
nop
cmp %rdx, %rdx
mov $50, %rcx
rep movsq
nop
cmp %rcx, %rcx
lea addresses_WT_ht+0x1272c, %rsi
lea addresses_WT_ht+0x13f4c, %rdi
nop
inc %r15
mov $7, %rcx
rep movsb
...
nop
xor $3880, %r13
lea addresses_WC_ht+0x14ec, %r13
nop
and %rdx, %rdx
mov (%r13), %rsi
nop
nop
sub $25729, %rsi
lea addresses_D_ht+0x566c, %rax
nop
inc %rsi
mov (%rax), %r15d
dec %rax
lea addresses_UC_ht+0x1cec, %rsi
nop
nop
cmp %rbx, %rbx
mov (%rsi), %r12d
nop
xor %rsi, %rsi
lea addresses_WC_ht+0x17fa4, %rax
clflush (%rax)
nop
nop
nop
...
{'OP': 'LOAD', 'src': {'type': 'addresses_WC_ht', 'AVXalign': False, 'congruent': 10, 'size': 8, 'same': True, 'NT': False}}
