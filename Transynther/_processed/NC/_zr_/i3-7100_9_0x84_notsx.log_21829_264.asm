...
push %rdi
push %rsi
lea addresses_WT_ht+0xa78c, %rbp
inc %rsi
movb $0x61, (%rbp)
nop
cmp $29196, %r12
lea addresses_D_ht+0x12280, %rsi
lea addresses_UC_ht+0x1bec8, %rdi
nop
nop
nop
sub %r10, %r10
...
nop
xor %r12, %r12
lea addresses_WC_ht+0xc68c, %rsi
...
nop
dec %r13
lea addresses_WC_ht+0x17c2c, %rsi
lea addresses_A_ht+0x16d8c, %rdi
nop
nop
nop
nop
...
{'src': {'type': 'addresses_D_ht', 'congruent': 2, 'same': True}, 'dst': {'type': 'addresses_UC_ht', 'congruent': 1, 'same': False}, 'OP': 'REPM'}
{'src': {'type': 'addresses_UC_ht', 'same': False, 'size': 4, 'congruent': 6, 'NT': False, 'AVXalign': True}, 'OP': 'LOAD'}
