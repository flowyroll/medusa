...
nop
sub $33706, %rcx
lea addresses_WT_ht+0x1e31a, %rcx
nop
nop
xor %r9, %r9
mov (%rcx), %di
...
nop
sub $30608, %r10
lea addresses_WT_ht+0x1671a, %rsi
nop
nop
sub %rcx, %rcx
...
nop
dec %rcx
lea addresses_WC_ht+0xca3a, %rsi
lea addresses_WT_ht+0x579a, %rdi
clflush (%rsi)
nop
nop
nop
...
{'src': {'same': False, 'congruent': 5, 'type': 'addresses_WC_ht'}, 'OP': 'REPM', 'dst': {'same': True, 'congruent': 7, 'type': 'addresses_WT_ht'}}
{'00': 21829}
