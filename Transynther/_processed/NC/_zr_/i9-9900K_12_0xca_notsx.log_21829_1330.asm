...
nop
inc %r14
lea addresses_UC_ht+0x93a9, %rdx
mfence
mov (%rdx), %bp
add $34901, %r9
lea addresses_A_ht+0x100a9, %rsi
lea addresses_A_ht+0xaea9, %rdi
clflush (%rdi)
nop
nop
nop
...
rep movsq
xor %rdi, %rdi
lea addresses_WC_ht+0xd6a9, %rdi
xor $456, %r14
movups (%rdi), %xmm0
vpextrq $1, %xmm0, %rbp
nop
...
nop
and %r14, %r14
lea addresses_normal_ht+0x100e5, %rsi
lea addresses_D_ht+0x19589, %rdi
nop
nop
inc %rbp
mov $57, %rcx
...
nop
cmp $48110, %rdx
lea addresses_UC_ht+0xe029, %rsi
lea addresses_WC_ht+0x10203, %rdi
nop
nop
xor $2125, %r14
mov $125, %rcx
...
nop
sub %rcx, %rcx
lea addresses_WC_ht+0x5801, %rbp
nop
nop
add $11964, %rbx
mov (%rbp), %rdx
...
nop
dec %rbx
lea addresses_D_ht+0x16338, %r14
nop
nop
nop
nop
...
movb (%r14), %cl
inc %rdi
lea addresses_WT_ht+0x7ca9, %rsi
lea addresses_WT_ht+0xf8a9, %rdi
nop
nop
nop
nop
...
// Store
lea addresses_normal+0x1decd, %r13
clflush (%r13)
nop
nop
sub $27347, %r12
