...
push %rdi
push %rsi
lea addresses_WT_ht+0x8da9, %rsi
lea addresses_WC_ht+0x115c5, %rdi
clflush (%rsi)
nop
nop
nop
...
nop
sub $44609, %r8
lea addresses_D_ht+0x77c5, %rdi
nop
sub $756, %r10
mov (%rdi), %r14w
inc %r14
lea addresses_normal_ht+0xae9, %r14
nop
nop
nop
nop
...
nop
add $41770, %r8
lea addresses_WT_ht+0x199c5, %r10
nop
cmp $18947, %r14
mov $0x6162636465666768, %rbx
movq %rbx, (%r10)
add %rsi, %rsi
lea addresses_A_ht+0x7fc5, %r10
nop
nop
sub $47109, %rsi
mov $0x6162636465666768, %rbx
...
nop
xor $13431, %r14
lea addresses_WT_ht+0x13e85, %rsi
nop
nop
nop
nop
...
nop
xor $62649, %r10
lea addresses_A_ht+0x10c9d, %rsi
lea addresses_normal_ht+0x65c5, %rdi
nop
nop
nop
nop
...
nop
and $29382, %rsi
lea addresses_normal_ht+0x1d081, %rbx
add %rsi, %rsi
movl $0x61626364, (%rbx)
nop
nop
cmp %rbx, %rbx
lea addresses_A_ht+0x16385, %rsi
nop
nop
nop
nop
...
nop
dec %r10
lea addresses_A_ht+0x1e3c5, %r8
dec %r14
mov $0x6162636465666768, %rbx
movq %rbx, %xmm7
vmovups %ymm7, (%r8)
cmp %r14, %r14
lea addresses_D_ht+0x15f43, %r14
nop
nop
mfence
movw $0x6162, (%r14)
...
// Load
lea addresses_normal+0x7ac5, %r9
clflush (%r9)
nop
nop
nop
...
{'OP': 'STOR', 'dst': {'NT': True, 'same': False, 'congruent': 6, 'type': 'addresses_UC', 'AVXalign': False, 'size': 8}}
...
<gen_prepare_buffer>
{'src': {'same': False, 'congruent': 1, 'type': 'addresses_WT_ht'}, 'OP': 'REPM', 'dst': {'same': False, 'congruent': 10, 'type': 'addresses_WC_ht'}}
...
{'OP': 'STOR', 'dst': {'NT': False, 'same': True, 'congruent': 8, 'type': 'addresses_WT_ht', 'AVXalign': False, 'size': 8}}
