...
push %rdx
push %rsi
lea addresses_WT_ht+0xb97c, %rsi
lea addresses_UC_ht+0x92b8, %rdi
clflush (%rsi)
clflush (%rdi)
nop
nop
...
nop
and $64970, %r11
lea addresses_normal_ht+0x4535, %r10
nop
nop
nop
nop
...
mov (%r10), %r11
sub %rdx, %rdx
lea addresses_WC_ht+0xebf8, %r10
nop
nop
sub $1759, %rdx
mov (%r10), %si
...
nop
xor %rdx, %rdx
lea addresses_A_ht+0x15a38, %rcx
nop
nop
nop
nop
...
{'OP': 'STOR', 'dst': {'same': False, 'congruent': 1, 'NT': False, 'type': 'addresses_RW', 'size': 16, 'AVXalign': True}}
[Faulty Load]
