...
push %rdx
push %rsi
lea addresses_WT_ht+0x159d3, %rsi
and %rcx, %rcx
vmovups (%rsi), %ymm6
...
nop
inc %r9
lea addresses_normal_ht+0x1dc7c, %r12
nop
nop
nop
xor %rdi, %rdi
...
nop
mfence
lea addresses_WT_ht+0x1ca4f, %rdx
nop
nop
nop
nop
...
nop
sub %rbx, %rbx
lea addresses_UC_ht+0xfcef, %rbx
lfence
movups (%rbx), %xmm3
vpextrq $1, %xmm3, %r12
cmp %rcx, %rcx
lea addresses_WT_ht+0xcef, %rsi
lea addresses_D_ht+0x1a4b4, %rdi
nop
nop
add $44577, %rdx
mov $94, %rcx
...
nop
sub %rsi, %rsi
lea addresses_UC_ht+0x316f, %rbx
nop
nop
inc %rdx
movups (%rbx), %xmm5
...
nop
xor $41698, %r12
lea addresses_normal_ht+0x144ef, %rbx
nop
nop
nop
and $18027, %rdi
...
movq %r12, (%rbx)
cmp $31267, %rdi
lea addresses_A_ht+0x168ef, %r12
nop
nop
nop
nop
...
nop
and $9813, %rcx
lea addresses_D_ht+0x4aef, %rsi
lea addresses_WT_ht+0x126ef, %rdi
clflush (%rsi)
nop
nop
add %r11, %r11
...
nop
cmp %rsi, %rsi
lea addresses_UC_ht+0x1bcef, %rsi
nop
cmp %r9, %r9
mov (%rsi), %dx
nop
...
{'dst': {'same': True, 'congruent': 0, 'type': 'addresses_D_ht'}, 'OP': 'REPM', 'src': {'same': False, 'congruent': 11, 'type': 'addresses_WT_ht'}}
