...
push %rdx
push %rsi
lea addresses_A_ht+0x16a34, %rsi
lea addresses_WT_ht+0xf8d4, %rdi
nop
nop
nop
sub %r15, %r15
...
nop
xor $48694, %r15
lea addresses_normal_ht+0xe534, %rsi
lea addresses_UC_ht+0x150dc, %rdi
nop
nop
nop
nop
...
nop
and $63808, %rdi
lea addresses_A_ht+0x12d94, %r10
nop
nop
nop
cmp $54500, %rdx
...
nop
and $33016, %r10
lea addresses_A_ht+0xc614, %rsi
lea addresses_A_ht+0x5c94, %rdi
nop
nop
nop
nop
...
nop
dec %rcx
lea addresses_WT_ht+0xae14, %rsi
cmp $20222, %rdi
movb (%rsi), %r10b
nop
nop
...
{'OP': 'REPM', 'src': {'type': 'addresses_A_ht', 'congruent': 6, 'same': False}, 'dst': {'type': 'addresses_A_ht', 'congruent': 8, 'same': True}}
