...
push %rdx
push %rsi
lea addresses_WT_ht+0xafd6, %rsi
nop
nop
nop
nop
...
nop
add %rdx, %rdx
lea addresses_WC_ht+0x149fe, %r14
nop
and $32266, %rax
...
vmovups %ymm5, (%r14)
and $22482, %r14
lea addresses_UC_ht+0x1605e, %rdx
nop
nop
add %r8, %r8
movb (%rdx), %r15b
...
nop
xor %r8, %r8
lea addresses_WT_ht+0x1bc5e, %rsi
lea addresses_WT_ht+0x176de, %rdi
clflush (%rsi)
nop
nop
and %r14, %r14
...
nop
xor $37265, %r8
lea addresses_WC_ht+0x145e, %rsi
lea addresses_D_ht+0x1529e, %rdi
clflush (%rdi)
sub %r13, %r13
mov $88, %rcx
rep movsq
...
nop
and %rax, %rax
lea addresses_WC_ht+0x305e, %rcx
nop
nop
sub %r8, %r8
mov (%rcx), %esi
xor $41587, %r13
lea addresses_WC_ht+0x1cfae, %rsi
lea addresses_WC_ht+0x1d4b6, %rdi
clflush (%rsi)
nop
nop
nop
...
{'OP': 'STOR', 'dst': {'type': 'addresses_WT_ht', 'AVXalign': False, 'size': 32, 'NT': True, 'same': True, 'congruent': 10}}
{'src': {'type': 'addresses_WC_ht', 'congruent': 10, 'same': False}, 'OP': 'REPM', 'dst': {'type': 'addresses_D_ht', 'congruent': 6, 'same': False}}
