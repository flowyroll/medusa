...
nop
sub %r13, %r13
lea addresses_normal_ht+0xdc2e, %r11
clflush (%r11)
nop
nop
and %r14, %r14
...
nop
xor $37089, %rcx
lea addresses_WC_ht+0x1816e, %r14
clflush (%r14)
nop
nop
nop
...
nop
sub $49525, %rbx
lea addresses_WT_ht+0x146ee, %rsi
add $46414, %r8
movb $0x61, (%rsi)
nop
nop
...
nop
sub $20562, %rcx
lea addresses_WC_ht+0x2b2e, %r14
nop
nop
nop
nop
...
vpextrq $1, %xmm0, %r13
xor %rbx, %rbx
lea addresses_normal_ht+0x11c6, %r8
nop
nop
nop
cmp %rsi, %rsi
...
nop
sub %r14, %r14
lea addresses_WC_ht+0x1c16e, %rcx
nop
nop
nop
nop
...
nop
inc %r13
lea addresses_UC_ht+0x1258e, %rsi
...
nop
add $22300, %rdi
lea addresses_WC_ht+0x5a6e, %r11
nop
sub %rsi, %rsi
movb (%r11), %cl
nop
...
nop
xor $36414, %rbx
lea addresses_D_ht+0x1d060, %rsi
lea addresses_A_ht+0x1756e, %rdi
xor %r11, %r11
mov $42, %rcx
rep movsb
add %rsi, %rsi
...
{'src': {'congruent': 9, 'AVXalign': True, 'same': False, 'size': 16, 'NT': False, 'type': 'addresses_D_ht'}, 'OP': 'LOAD'}
{'src': {'congruent': 0, 'AVXalign': False, 'same': True, 'size': 32, 'NT': False, 'type': 'addresses_UC_ht'}, 'OP': 'LOAD'}
...
{'src': {'congruent': 1, 'same': False, 'type': 'addresses_D_ht'}, 'OP': 'REPM', 'dst': {'congruent': 10, 'same': False, 'type': 'addresses_A_ht'}}
{'00': 21829}
