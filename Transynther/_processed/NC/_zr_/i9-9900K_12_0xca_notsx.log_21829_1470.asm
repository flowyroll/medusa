...
push %rdi
push %rsi
lea addresses_UC_ht+0x17cec, %rcx
nop
nop
sub %r10, %r10
mov (%rcx), %r12w
...
nop
inc %rbp
lea addresses_normal_ht+0xf50c, %r15
nop
nop
add %rbp, %rbp
mov (%r15), %r14
...
nop
inc %r15
lea addresses_WT_ht+0x18cf4, %rbx
clflush (%rbx)
cmp $35347, %r12
mov (%rbx), %r15w
nop
...
nop
xor $53452, %rbp
lea addresses_UC_ht+0xa19c, %r15
nop
nop
and %rbx, %rbx
movb (%r15), %r10b
nop
dec %r14
lea addresses_normal_ht+0x66e4, %rsi
lea addresses_D_ht+0x229c, %rdi
nop
nop
nop
nop
...
nop
and %rcx, %rcx
lea addresses_WC_ht+0xca6c, %rbx
nop
cmp $19908, %r14
vmovups (%rbx), %ymm6
...
vpextrq $1, %xmm6, %rbp
dec %r12
lea addresses_WC_ht+0x7e2c, %rsi
lea addresses_WC_ht+0x1656c, %rdi
sub %r14, %r14
mov $104, %rcx
rep movsb
nop
dec %r15
lea addresses_WC_ht+0x5eb2, %rbp
nop
nop
cmp %rbx, %rbx
...
{'OP': 'REPM', 'src': {'same': False, 'congruent': 2, 'type': 'addresses_normal_ht'}, 'dst': {'same': False, 'congruent': 4, 'type': 'addresses_D_ht'}}
{'OP': 'LOAD', 'src': {'same': False, 'type': 'addresses_WC_ht', 'NT': False, 'AVXalign': False, 'size': 32, 'congruent': 6}}
{'OP': 'REPM', 'src': {'same': False, 'congruent': 2, 'type': 'addresses_WC_ht'}, 'dst': {'same': False, 'congruent': 6, 'type': 'addresses_WC_ht'}}
{'OP': 'STOR', 'dst': {'same': False, 'type': 'addresses_WC_ht', 'NT': True, 'AVXalign': False, 'size': 8, 'congruent': 0}}
