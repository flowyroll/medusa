...
mov (%rax), %ebp
xor $25543, %rcx
lea addresses_A_ht+0x12d44, %rsi
lea addresses_WT_ht+0x181c4, %rdi
nop
nop
nop
dec %r15
...
nop
sub %rax, %rax
lea addresses_D_ht+0x16838, %rsi
lea addresses_normal_ht+0x544, %rdi
nop
inc %r8
mov $0, %rcx
rep movsq
nop
inc %rax
lea addresses_WT_ht+0x3a84, %rsi
lea addresses_UC_ht+0x7244, %rdi
clflush (%rsi)
nop
nop
nop
...
nop
sub %rcx, %rcx
lea addresses_WC_ht+0x3ad8, %rsi
nop
nop
and $44479, %r15
mov (%rsi), %bp
...
nop
dec %rsi
lea addresses_normal_ht+0x1b820, %r12
nop
nop
nop
nop
...
nop
add $30862, %rsi
lea addresses_WT_ht+0x13044, %r12
clflush (%r12)
nop
nop
nop
...
nop
sub $12837, %r12
lea addresses_WT_ht+0xd844, %rsi
nop
nop
nop
nop
...
{'OP': 'LOAD', 'src': {'type': 'addresses_WC_ht', 'AVXalign': False, 'congruent': 7, 'size': 4, 'same': False, 'NT': True}}
