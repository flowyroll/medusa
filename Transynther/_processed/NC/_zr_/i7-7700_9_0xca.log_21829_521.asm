...
push %rdi
push %rsi
lea addresses_WC_ht+0x105d0, %rsi
lea addresses_UC_ht+0xf280, %rdi
nop
nop
nop
sub $54403, %rbx
...
nop
sub %rbx, %rbx
lea addresses_normal_ht+0x97b0, %rsi
...
nop
sub $58318, %rdi
lea addresses_WT_ht+0xdd70, %rsi
lea addresses_D_ht+0x121d0, %rdi
clflush (%rdi)
nop
nop
nop
...
rep movsq
and $7951, %rdi
lea addresses_A_ht+0x113cc, %rcx
nop
nop
nop
and %r11, %r11
...
vpextrq $0, %xmm2, %rdi
and $43958, %rsi
lea addresses_UC_ht+0x14f70, %rsi
lea addresses_WC_ht+0x1e2d0, %rdi
nop
dec %r14
mov $107, %rcx
rep movsl
...
nop
add %rbx, %rbx
lea addresses_WT_ht+0x1d5d0, %rsi
lea addresses_normal_ht+0x18dd0, %rdi
clflush (%rsi)
nop
nop
nop
...
nop
cmp %r14, %r14
lea addresses_WT_ht+0x14e68, %r14
clflush (%r14)
dec %rbx
movb $0x61, (%r14)
nop
add $12288, %rcx
lea addresses_WT_ht+0xe5d0, %rsi
lea addresses_WT_ht+0x95d0, %rdi
nop
nop
nop
nop
...
{'src': {'congruent': 5, 'same': False, 'type': 'addresses_UC_ht'}, 'OP': 'REPM', 'dst': {'congruent': 8, 'same': False, 'type': 'addresses_WC_ht'}}
