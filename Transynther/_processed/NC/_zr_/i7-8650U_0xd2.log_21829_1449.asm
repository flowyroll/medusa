...
nop
and %r11, %r11
lea addresses_A_ht+0x17a6f, %rsi
lea addresses_A_ht+0x17b6f, %rdi
add $18353, %r9
mov $120, %rcx
rep movsw
nop
...
nop
inc %rcx
lea addresses_normal_ht+0x1bd2f, %rsi
nop
nop
nop
nop
...
nop
and %rsi, %rsi
lea addresses_WT_ht+0x15c2f, %rsi
lea addresses_normal_ht+0x69cb, %rdi
nop
nop
nop
nop
...
nop
cmp $13916, %r11
lea addresses_A_ht+0x1ec67, %rdi
nop
nop
nop
nop
...
nop
and %rdi, %rdi
lea addresses_normal_ht+0x789, %rcx
nop
nop
mfence
mov (%rcx), %rbp
xor %r12, %r12
lea addresses_D_ht+0x646f, %rsi
lea addresses_WC_ht+0x636f, %rdi
nop
sub $51509, %rbp
mov $50, %rcx
rep movsq
...
vpextrq $1, %xmm7, %rsi
xor %r15, %r15
lea addresses_normal_ht+0x36f, %rsi
lea addresses_A_ht+0x136f, %rdi
clflush (%rsi)
nop
add %r12, %r12
mov $23, %rcx
...
nop
xor $9827, %r15
lea addresses_WT_ht+0x12ab9, %rbp
clflush (%rbp)
nop
nop
nop
...
nop
xor %rsi, %rsi
lea addresses_A_ht+0x11bcf, %rsi
lea addresses_UC_ht+0x1cb6f, %rdi
nop
cmp %r9, %r9
mov $59, %rcx
rep movsl
...
nop
add %r15, %r15
lea addresses_normal_ht+0x10f2f, %rcx
nop
nop
nop
nop
...
nop
dec %r11
lea addresses_D_ht+0x1ac6f, %r11
nop
nop
nop
add $33771, %rcx
...
{'OP': 'STOR', 'dst': {'type': 'addresses_A', 'size': 8, 'AVXalign': False, 'NT': True, 'congruent': 4, 'same': False}}
...
{'OP': 'REPM', 'src': {'type': 'addresses_A_ht', 'congruent': 5, 'same': False}, 'dst': {'type': 'addresses_UC_ht', 'congruent': 11, 'same': False}}
