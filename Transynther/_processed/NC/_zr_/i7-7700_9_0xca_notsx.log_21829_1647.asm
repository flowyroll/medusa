...
// Store
lea addresses_normal+0xb234, %rcx
nop
nop
nop
nop
...
// Store
lea addresses_normal+0x1e083, %r9
cmp %r12, %r12
movw $0x5152, (%r9)
nop
nop
...
// REPMOV
lea addresses_RW+0x2253, %rsi
lea addresses_normal+0x6593, %rdi
nop
nop
add %r9, %r9
mov $101, %rcx
...
{'src': {'congruent': 10, 'same': False, 'type': 'addresses_RW'}, 'dst': {'congruent': 6, 'same': False, 'type': 'addresses_normal'}, 'OP': 'REPM'}
...
{'dst': {'NT': True, 'AVXalign': False, 'size': 4, 'congruent': 5, 'same': False, 'type': 'addresses_US'}, 'OP': 'STOR'}
{'dst': {'NT': False, 'AVXalign': False, 'size': 2, 'congruent': 5, 'same': False, 'type': 'addresses_WT'}, 'OP': 'STOR'}
[Faulty Load]
