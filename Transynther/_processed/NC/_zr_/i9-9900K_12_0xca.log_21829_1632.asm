...
push %rdi
push %rsi
lea addresses_WC_ht+0x23b2, %rsi
...
nop
cmp %rdi, %rdi
lea addresses_A_ht+0x169b2, %rsi
nop
nop
nop
and $52675, %r12
...
nop
add $23371, %r13
lea addresses_WC_ht+0x17b32, %r12
nop
nop
sub %rcx, %rcx
...
<gen_prepare_buffer>
{'OP': 'REPM', 'src': {'same': False, 'type': 'addresses_WC_ht', 'congruent': 9}, 'dst': {'same': False, 'type': 'addresses_UC_ht', 'congruent': 6}}
