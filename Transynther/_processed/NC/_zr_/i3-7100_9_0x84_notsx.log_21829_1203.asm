...
push %rdx
push %rsi
lea addresses_UC_ht+0x9f7c, %rbx
nop
nop
add %rdx, %rdx
mov (%rbx), %r15w
...
nop
add $30014, %rdx
lea addresses_normal_ht+0x1b19c, %r10
nop
nop
xor %rax, %rax
movl $0x61626364, (%r10)
...
nop
cmp $60085, %rbx
lea addresses_UC_ht+0x1a244, %rbx
nop
nop
add %r11, %r11
mov (%rbx), %dx
...
nop
xor $31765, %rax
lea addresses_normal_ht+0x1233c, %r10
nop
nop
cmp %r11, %r11
movb (%r10), %bl
nop
add %r11, %r11
lea addresses_A_ht+0xaf3c, %rsi
lea addresses_A_ht+0x629c, %rdi
nop
sub %r10, %r10
mov $127, %rcx
rep movsb
sub $15112, %rax
lea addresses_D_ht+0x1db24, %rdx
nop
nop
nop
sub %r15, %r15
...
nop
sub %r15, %r15
lea addresses_D_ht+0x1b13c, %rax
and $29267, %r11
