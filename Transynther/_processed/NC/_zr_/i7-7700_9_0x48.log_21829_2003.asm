...
nop
and $25579, %rsi
lea addresses_WC_ht+0x1254b, %rsi
lea addresses_D_ht+0x554b, %rdi
nop
nop
nop
cmp $5963, %rax
...
nop
sub %rcx, %rcx
lea addresses_UC_ht+0x1464b, %rsi
xor %r15, %r15
movb (%rsi), %cl
nop
nop
...
nop
xor %r15, %r15
lea addresses_WT_ht+0x32e7, %r10
nop
nop
and $23954, %rax
movb (%r10), %dl
...
nop
sub %rax, %rax
lea addresses_normal_ht+0x1546b, %rax
nop
nop
and %rcx, %rcx
vmovups (%rax), %ymm3
...
nop
cmp $45639, %rsi
lea addresses_WC_ht+0xda4b, %rdi
nop
nop
nop
nop
...
nop
add %rcx, %rcx
lea addresses_WC_ht+0x204b, %rdi
nop
add %r10, %r10
movb $0x61, (%rdi)
nop
nop
xor %rsi, %rsi
lea addresses_normal_ht+0x18ddb, %rsi
lea addresses_A_ht+0xdd4b, %rdi
nop
nop
nop
nop
