...
push %rdx
push %rsi
lea addresses_A_ht+0x17c92, %r12
nop
nop
nop
nop
...
nop
xor $51062, %r14
lea addresses_WT_ht+0x10342, %rcx
nop
nop
nop
nop
...
nop
sub $25380, %rdx
lea addresses_normal_ht+0x1da62, %rdi
nop
nop
nop
nop
...
<gen_prepare_buffer>
{'src': {'NT': False, 'AVXalign': True, 'size': 16, 'congruent': 3, 'same': False, 'type': 'addresses_A_ht'}, 'OP': 'LOAD'}
