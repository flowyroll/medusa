...
push %rdi
push %rsi
lea addresses_D_ht+0x1c5aa, %r15
add %rbp, %rbp
movb (%r15), %r8b
nop
nop
and $31669, %r12
lea addresses_UC_ht+0x1ec3a, %rsi
lea addresses_WT_ht+0x134ea, %rdi
nop
nop
nop
nop
...
nop
sub $22134, %r12
lea addresses_WC_ht+0x123aa, %rsi
lea addresses_UC_ht+0x13aa, %rdi
nop
nop
nop
nop
