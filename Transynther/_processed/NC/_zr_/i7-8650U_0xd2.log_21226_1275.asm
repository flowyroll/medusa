...
push %rbx
push %rsi
lea addresses_normal_ht+0x139b1, %r10
nop
xor $54462, %rbx
movb (%r10), %r11b
nop
...
{'OP': 'STOR', 'dst': {'type': 'addresses_D', 'size': 2, 'AVXalign': False, 'NT': True, 'congruent': 8, 'same': False}}
