...
nop
add $2638, %rdx
lea addresses_UC_ht+0x15e7d, %rsi
lea addresses_D_ht+0x19d91, %rdi
nop
nop
nop
nop
...
nop
and %rdx, %rdx
lea addresses_WC_ht+0x1add1, %rsi
lea addresses_WT_ht+0x12691, %rdi
nop
nop
nop
nop
...
nop
sub $47839, %rcx
lea addresses_A_ht+0xedd1, %rsi
lea addresses_WT_ht+0x1c429, %rdi
clflush (%rdi)
nop
nop
nop
...
nop
dec %rdi
lea addresses_UC_ht+0x1b9e5, %r14
nop
nop
nop
nop
...
{'src': {'congruent': 0, 'same': False, 'type': 'addresses_UC_ht'}, 'OP': 'REPM', 'dst': {'congruent': 3, 'same': False, 'type': 'addresses_D_ht'}}
...
{'src': {'congruent': 7, 'same': True, 'type': 'addresses_A_ht'}, 'OP': 'REPM', 'dst': {'congruent': 2, 'same': False, 'type': 'addresses_WT_ht'}}
