...
push %rdi
push %rsi
lea addresses_WT_ht+0x14aa9, %r12
xor $15454, %rcx
movb (%r12), %r9b
nop
nop
...
nop
and %rbx, %rbx
lea addresses_UC_ht+0xcf49, %rdi
nop
nop
nop
nop
...
movq %rbx, (%rdi)
cmp %r12, %r12
lea addresses_WC_ht+0x132f9, %rsi
...
nop
sub %rsi, %rsi
lea addresses_normal_ht+0x7731, %rax
nop
nop
nop
nop
...
nop
dec %rcx
lea addresses_A_ht+0x1a41b, %rsi
nop
nop
nop
xor %rbx, %rbx
...
nop
sub $29822, %rsi
lea addresses_WC_ht+0x13aa9, %rsi
lea addresses_D_ht+0x5929, %rdi
nop
nop
dec %rax
mov $31, %rcx
...
<gen_faulty_load>
[REF]
{'src': {'type': 'addresses_NC', 'same': False, 'size': 8, 'congruent': 0, 'NT': True, 'AVXalign': False}, 'OP': 'LOAD'}
[Faulty Load]
...
{'src': {'type': 'addresses_WC_ht', 'congruent': 3, 'same': False}, 'dst': {'type': 'addresses_WC_ht', 'congruent': 5, 'same': False}, 'OP': 'REPM'}
