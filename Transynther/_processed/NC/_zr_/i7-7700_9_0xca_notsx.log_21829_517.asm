...
push %rdi
push %rsi
lea addresses_normal_ht+0x8829, %r10
nop
nop
xor %r14, %r14
mov (%r10), %rcx
nop
add $34808, %r9
lea addresses_WC_ht+0x11319, %rdi
xor %rax, %rax
mov (%rdi), %rbx
nop
nop
...
nop
add $20084, %r14
lea addresses_WC_ht+0x102e9, %rax
nop
inc %r10
movb $0x61, (%rax)
nop
...
nop
xor %rcx, %rcx
lea addresses_D_ht+0x5129, %rsi
lea addresses_WT_ht+0x12959, %rdi
nop
nop
nop
nop
...
nop
sub %r9, %r9
lea addresses_WT_ht+0x1d8e9, %rsi
lea addresses_UC_ht+0x169a9, %rdi
nop
nop
sub %rax, %rax
mov $16, %rcx
...
nop
and $34251, %rsi
lea addresses_WT_ht+0x2198, %rsi
lea addresses_WC_ht+0x152e9, %rdi
clflush (%rdi)
nop
nop
nop
...
{'src': {'congruent': 1, 'same': True, 'type': 'addresses_D_ht'}, 'dst': {'congruent': 4, 'same': False, 'type': 'addresses_WT_ht'}, 'OP': 'REPM'}
