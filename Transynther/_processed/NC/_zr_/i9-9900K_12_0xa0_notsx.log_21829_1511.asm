...
push %rdx
push %rsi
lea addresses_WT_ht+0x16d74, %r12
nop
nop
nop
nop
...
nop
xor $38035, %rdi
lea addresses_WC_ht+0x1e870, %rcx
nop
nop
nop
nop
...
nop
dec %rcx
lea addresses_WC_ht+0x1a470, %rdi
inc %rdx
movb $0x61, (%rdi)
nop
sub %rdx, %rdx
lea addresses_normal_ht+0x30b0, %r8
sub $45025, %rdx
movb $0x61, (%r8)
nop
nop
...
nop
cmp $43256, %r12
lea addresses_normal_ht+0x13070, %rsi
lea addresses_D_ht+0xf870, %rdi
nop
xor $40840, %r10
mov $32, %rcx
rep movsq
...
{'src': {'type': 'addresses_normal_ht', 'congruent': 9, 'same': False}, 'OP': 'REPM', 'dst': {'type': 'addresses_D_ht', 'congruent': 11, 'same': False}}
{'00': 21829}
