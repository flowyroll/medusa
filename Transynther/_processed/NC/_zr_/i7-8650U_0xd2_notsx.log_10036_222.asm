...
push %rdi
push %rsi
lea addresses_UC_ht+0x1dc96, %r12
nop
nop
nop
nop
...
nop
cmp $44556, %r10
lea addresses_normal_ht+0x17376, %rsi
lea addresses_D_ht+0x5a76, %rdi
nop
nop
sub %rax, %rax
mov $71, %rcx
...
nop
and %r12, %r12
lea addresses_WC_ht+0x6e76, %r12
nop
nop
cmp %rax, %rax
mov (%r12), %edi
...
nop
add $6569, %rax
lea addresses_WT_ht+0x1181e, %rsi
lea addresses_normal_ht+0x19b76, %rdi
nop
xor %r10, %r10
mov $60, %rcx
rep movsb
...
nop
cmp %rcx, %rcx
lea addresses_UC_ht+0x67d8, %r13
clflush (%r13)
nop
nop
nop
...
mov (%r13), %r10d
sub %rax, %rax
lea addresses_D_ht+0xb816, %rsi
lea addresses_A_ht+0x1e556, %rdi
dec %r10
mov $45, %rcx
rep movsq
sub %rdi, %rdi
lea addresses_D_ht+0x1c376, %r10
nop
nop
nop
nop
...
nop
and %rdi, %rdi
lea addresses_normal_ht+0x1d188, %rsi
and $38101, %rax
mov $0x6162636465666768, %rbx
movq %rbx, (%rsi)
nop
...
nop
sub $12585, %rsi
lea addresses_WT_ht+0x1a3f6, %rsi
nop
nop
nop
nop
...
nop
and $39907, %r10
lea addresses_A_ht+0x10776, %rdi
clflush (%rdi)
nop
nop
nop
...
movb (%rdi), %bl
xor $47331, %rax
lea addresses_WT_ht+0xe50e, %r13
and $49762, %rax
mov (%r13), %esi
nop
nop
...
<gen_prepare_buffer>
{'OP': 'STOR', 'dst': {'type': 'addresses_UC_ht', 'size': 8, 'AVXalign': True, 'NT': True, 'congruent': 3, 'same': True}}
...
{'OP': 'STOR', 'dst': {'type': 'addresses_WT_ht', 'size': 32, 'AVXalign': False, 'NT': False, 'congruent': 7, 'same': True}}
