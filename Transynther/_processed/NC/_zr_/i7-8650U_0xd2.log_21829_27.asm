...
push %rdi
push %rsi
lea addresses_WT_ht+0x12f81, %rsi
lea addresses_WT_ht+0x45bd, %rdi
cmp $64777, %r10
mov $51, %rcx
rep movsl
nop
...
nop
dec %rdi
lea addresses_D_ht+0x178c9, %rcx
nop
nop
inc %r15
mov (%rcx), %r13w
...
nop
and %r15, %r15
lea addresses_normal_ht+0x5b81, %rdi
nop
nop
nop
nop
...
nop
cmp $4700, %rdi
lea addresses_normal_ht+0x9e81, %rsi
lea addresses_UC_ht+0xd29d, %rdi
clflush (%rdi)
nop
nop
nop
...
rep movsw
xor $38811, %rbp
lea addresses_normal_ht+0x1c81, %r13
nop
nop
and $32414, %rbp
movups (%r13), %xmm2
...
nop
xor %rcx, %rcx
lea addresses_normal_ht+0x14dce, %rsi
lea addresses_UC_ht+0x3701, %rdi
nop
nop
nop
and %r13, %r13
