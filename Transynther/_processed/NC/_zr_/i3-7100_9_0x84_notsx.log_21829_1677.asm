...
push %rdi
push %rsi
lea addresses_WC_ht+0x5275, %rsi
nop
nop
nop
inc %r15
...
nop
inc %r15
lea addresses_D_ht+0x1ddb5, %rsi
nop
nop
nop
nop
...
nop
inc %rsi
lea addresses_A_ht+0x1db8c, %rbx
clflush (%rbx)
dec %rax
movb (%rbx), %r12b
nop
sub %rsi, %rsi
lea addresses_UC_ht+0x126f5, %rsi
lea addresses_normal_ht+0x4ef5, %rdi
nop
nop
nop
nop
...
nop
add $2738, %rcx
lea addresses_normal_ht+0x5bb5, %rcx
cmp %rax, %rax
movb $0x61, (%rcx)
nop
and %rbx, %rbx
...
<gen_prepare_buffer>
{'dst': {'type': 'addresses_WC_ht', 'same': False, 'size': 16, 'congruent': 3, 'NT': False, 'AVXalign': True}, 'OP': 'STOR'}
