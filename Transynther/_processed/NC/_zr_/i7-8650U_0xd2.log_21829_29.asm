...
push %rdx
push %rsi
lea addresses_UC_ht+0x1ab0d, %rax
nop
nop
and %rdx, %rdx
mov (%rax), %r8
...
nop
and %rcx, %rcx
lea addresses_WC_ht+0x18f3c, %rsi
lea addresses_D_ht+0x16ffc, %rdi
clflush (%rdi)
nop
nop
nop
...
rep movsl
and %rdx, %rdx
lea addresses_D_ht+0x26bc, %rsi
lea addresses_D_ht+0x13690, %rdi
clflush (%rsi)
nop
nop
nop
...
nop
sub $24850, %r8
lea addresses_UC_ht+0x2d3c, %rax
sub $25458, %rsi
mov (%rax), %rcx
nop
and $33819, %r12
lea addresses_A_ht+0x1242a, %rax
nop
nop
nop
and $54675, %rcx
...
nop
add %rdx, %rdx
lea addresses_UC_ht+0x1c83c, %rsi
lea addresses_A_ht+0x863c, %rdi
nop
cmp $34710, %r11
mov $17, %rcx
rep movsw
xor %rdx, %rdx
lea addresses_A_ht+0x5250, %rsi
nop
nop
add $23390, %r11
movb (%rsi), %cl
...
nop
and %r11, %r11
lea addresses_WT_ht+0xb3a8, %rsi
lea addresses_normal_ht+0x1ca2c, %rdi
nop
nop
nop
add $61509, %r12
...
nop
sub $30615, %r12
lea addresses_WT_ht+0x9f3c, %rax
nop
nop
nop
nop
...
nop
xor $58996, %rax
lea addresses_A_ht+0x1219e, %rsi
lea addresses_normal_ht+0x18d7a, %rdi
clflush (%rsi)
dec %rax
mov $113, %rcx
rep movsw
dec %rdi
lea addresses_WC_ht+0x1653c, %rdi
nop
nop
nop
nop
...
{'OP': 'REPM', 'src': {'type': 'addresses_WT_ht', 'congruent': 1, 'same': False}, 'dst': {'type': 'addresses_normal_ht', 'congruent': 4, 'same': True}}
