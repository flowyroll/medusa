...
movq %r9, (%rcx)
and %rsi, %rsi
lea addresses_A_ht+0x13d1e, %rsi
...
nop
add $9573, %rbx
lea addresses_UC_ht+0x1269e, %rsi
lea addresses_UC_ht+0x13e1e, %rdi
dec %r9
mov $33, %rcx
rep movsw
nop
...
nop
xor $26676, %rbx
lea addresses_A_ht+0x10440, %rcx
cmp %rbp, %rbp
mov (%rcx), %si
nop
nop
nop
dec %r9
lea addresses_UC_ht+0x129a6, %rcx
cmp $15133, %rsi
mov (%rcx), %rbx
nop
nop
and $49826, %r9
lea addresses_normal_ht+0x629e, %rcx
nop
nop
add $25898, %r9
...
nop
cmp %r9, %r9
lea addresses_D_ht+0x1361e, %rcx
nop
cmp $63261, %rax
movb (%rcx), %bl
nop
...
{'src': {'same': False, 'congruent': 9, 'NT': False, 'type': 'addresses_WC', 'size': 8, 'AVXalign': True}, 'OP': 'LOAD'}
...
{'src': {'type': 'addresses_UC_ht', 'congruent': 10, 'same': False}, 'OP': 'REPM', 'dst': {'type': 'addresses_UC_ht', 'congruent': 4, 'same': False}}
...
{'OP': 'STOR', 'dst': {'same': True, 'congruent': 11, 'NT': True, 'type': 'addresses_normal_ht', 'size': 32, 'AVXalign': False}}
