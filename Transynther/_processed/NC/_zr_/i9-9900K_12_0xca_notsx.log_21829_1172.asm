...
push %rdi
push %rsi
lea addresses_normal_ht+0xde15, %rsi
lea addresses_A_ht+0xfc4a, %rdi
clflush (%rdi)
nop
nop
nop
...
nop
sub $44786, %r11
lea addresses_UC_ht+0x8e8a, %rcx
nop
and %rax, %rax
mov (%rcx), %r9
nop
...
nop
add %rdi, %rdi
lea addresses_WC_ht+0xaf7a, %rax
nop
nop
nop
nop
...
<gen_prepare_buffer>
{'OP': 'REPM', 'src': {'same': False, 'congruent': 0, 'type': 'addresses_normal_ht'}, 'dst': {'same': False, 'congruent': 8, 'type': 'addresses_A_ht'}}
{'OP': 'LOAD', 'src': {'same': True, 'type': 'addresses_A_ht', 'NT': False, 'AVXalign': True, 'size': 8, 'congruent': 0}}
{'OP': 'LOAD', 'src': {'same': True, 'type': 'addresses_UC_ht', 'NT': False, 'AVXalign': False, 'size': 8, 'congruent': 4}}
