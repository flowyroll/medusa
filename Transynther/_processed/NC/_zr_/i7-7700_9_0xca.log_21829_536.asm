...
push %rdx
push %rsi
lea addresses_WT_ht+0x5697, %r10
clflush (%r10)
nop
nop
and %rdx, %rdx
...
nop
sub $3801, %rdi
lea addresses_WT_ht+0x367, %r13
sub $30190, %rax
mov (%r13), %rcx
add $9216, %r10
lea addresses_UC_ht+0x5cef, %rsi
lea addresses_WT_ht+0x11b03, %rdi
nop
and %r10, %r10
mov $90, %rcx
rep movsq
...
nop
inc %rsi
lea addresses_D_ht+0x1e367, %rcx
clflush (%rcx)
nop
nop
nop
...
{'src': {'congruent': 1, 'same': False, 'type': 'addresses_UC_ht'}, 'OP': 'REPM', 'dst': {'congruent': 1, 'same': False, 'type': 'addresses_WT_ht'}}
