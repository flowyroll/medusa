...
push %rdi
push %rsi
lea addresses_UC_ht+0xbd5d, %r15
nop
and %rax, %rax
vmovups (%r15), %ymm0
...
nop
cmp $39618, %r14
lea addresses_WC_ht+0x13d2d, %rsi
lea addresses_WC_ht+0x1c07d, %rdi
clflush (%rsi)
nop
nop
nop
...
nop
add %r9, %r9
lea addresses_normal_ht+0x1797d, %rsi
...
nop
add %rcx, %rcx
lea addresses_normal_ht+0x12b65, %r9
nop
nop
dec %rsi
...
movups %xmm3, (%r9)
xor %r15, %r15
lea addresses_WT_ht+0x11336, %rbp
nop
dec %rdi
...
nop
sub %rsi, %rsi
lea addresses_WC_ht+0x17534, %rdi
nop
nop
nop
nop
...
nop
xor %rsi, %rsi
lea addresses_UC_ht+0x1957d, %r14
clflush (%r14)
nop
nop
nop
...
{'OP': 'REPM', 'src': {'same': False, 'congruent': 1, 'type': 'addresses_WC_ht'}, 'dst': {'same': False, 'congruent': 9, 'type': 'addresses_WC_ht'}}
{'OP': 'REPM', 'src': {'same': False, 'congruent': 8, 'type': 'addresses_normal_ht'}, 'dst': {'same': False, 'congruent': 2, 'type': 'addresses_normal_ht'}}
