...
push %rdi
push %rsi
lea addresses_normal_ht+0xdab9, %rsi
lea addresses_D_ht+0x14f9c, %rdi
add $54291, %r15
mov $46, %rcx
rep movsb
nop
...
nop
dec %r9
lea addresses_WT_ht+0x11c39, %rsi
lea addresses_UC_ht+0x6e79, %rdi
nop
add %r14, %r14
mov $44, %rcx
rep movsw
nop
sub %rcx, %rcx
lea addresses_WT_ht+0x9c39, %r15
nop
nop
nop
nop
...
vpextrq $0, %xmm0, %rcx
add %r9, %r9
lea addresses_A_ht+0x1c4b9, %r13
nop
nop
nop
nop
...
nop
sub $48734, %rsi
lea addresses_normal_ht+0xde36, %r9
add $30009, %rsi
vmovups (%r9), %ymm2
...
<gen_prepare_buffer>
{'OP': 'REPM', 'src': {'same': False, 'type': 'addresses_normal_ht', 'congruent': 7}, 'dst': {'same': False, 'type': 'addresses_D_ht', 'congruent': 0}}
{'OP': 'REPM', 'src': {'same': False, 'type': 'addresses_WT_ht', 'congruent': 10}, 'dst': {'same': False, 'type': 'addresses_UC_ht', 'congruent': 6}}
