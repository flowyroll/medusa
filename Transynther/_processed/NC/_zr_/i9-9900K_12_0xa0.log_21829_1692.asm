...
nop
add $18201, %r15
lea addresses_UC_ht+0x16a45, %rdi
nop
nop
sub %rsi, %rsi
...
nop
inc %rdi
lea addresses_D_ht+0x10ef5, %r11
nop
nop
nop
sub $42267, %rdx
...
<gen_prepare_buffer>
{'src': {'same': True, 'congruent': 7, 'type': 'addresses_normal_ht'}, 'OP': 'REPM', 'dst': {'same': False, 'congruent': 10, 'type': 'addresses_A_ht'}}
{'src': {'same': False, 'congruent': 4, 'type': 'addresses_A_ht'}, 'OP': 'REPM', 'dst': {'same': False, 'congruent': 2, 'type': 'addresses_D_ht'}}
