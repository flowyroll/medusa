...
nop
cmp %r11, %r11
lea addresses_WC_ht+0x57c4, %rsi
lea addresses_WT_ht+0x544, %rdi
clflush (%rdi)
add $9387, %rax
mov $2, %rcx
rep movsq
...
nop
cmp %rax, %rax
lea addresses_D_ht+0x1edc4, %rsi
lea addresses_D_ht+0x1544, %rdi
nop
nop
nop
nop
...
nop
cmp %rax, %rax
lea addresses_WC_ht+0x13874, %rcx
nop
nop
nop
nop
...
nop
xor $51253, %r15
lea addresses_WT_ht+0x89ba, %rdx
cmp $7449, %r11
mov (%rdx), %rax
nop
nop
...
nop
cmp %rdx, %rdx
lea addresses_WC_ht+0x23c4, %rsi
lea addresses_WC_ht+0xcbc4, %rdi
nop
nop
nop
nop
...
nop
xor $61871, %rcx
lea addresses_UC_ht+0x41c4, %rcx
nop
add %rdx, %rdx
vmovups (%rcx), %ymm3
...
nop
add %r15, %r15
lea addresses_UC_ht+0x12cc4, %r15
nop
nop
nop
nop
...
movb $0x61, (%r15)
and %rdi, %rdi
lea addresses_normal_ht+0xd744, %rsi
lea addresses_WC_ht+0xa6c4, %rdi
clflush (%rdi)
nop
nop
nop
...
nop
cmp %rsi, %rsi
lea addresses_normal_ht+0x16984, %rdx
nop
nop
cmp $16280, %r11
...
{'OP': 'STOR', 'dst': {'congruent': 5, 'AVXalign': False, 'same': False, 'size': 4, 'NT': False, 'type': 'addresses_RW'}}
[Faulty Load]
{'src': {'congruent': 0, 'AVXalign': False, 'same': True, 'size': 8, 'NT': False, 'type': 'addresses_NC'}, 'OP': 'LOAD'}
<gen_prepare_buffer>
{'OP': 'STOR', 'dst': {'congruent': 1, 'AVXalign': False, 'same': False, 'size': 2, 'NT': True, 'type': 'addresses_D_ht'}}
