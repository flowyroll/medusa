...
push %rdx
push %rsi
lea addresses_UC_ht+0x3066, %rsi
...
nop
inc %rbp
lea addresses_D_ht+0x13a72, %rsi
...
nop
sub $65446, %rbx
lea addresses_A_ht+0x10272, %rbx
add %rdx, %rdx
mov (%rbx), %si
and %rdx, %rdx
lea addresses_WC_ht+0xe72, %rcx
nop
add %rdi, %rdi
movl $0x61626364, (%rcx)
nop
nop
cmp $47283, %rbx
lea addresses_WT_ht+0x16d8a, %rbx
sub %rsi, %rsi
movl $0x61626364, (%rbx)
xor $19491, %rsi
lea addresses_A_ht+0x3894, %rcx
nop
nop
nop
nop
...
nop
add $46735, %rdx
lea addresses_WT_ht+0x71a2, %rcx
nop
nop
nop
nop
...
<gen_prepare_buffer>
{'src': {'same': False, 'congruent': 2, 'type': 'addresses_UC_ht'}, 'OP': 'REPM', 'dst': {'same': False, 'congruent': 10, 'type': 'addresses_WT_ht'}}
