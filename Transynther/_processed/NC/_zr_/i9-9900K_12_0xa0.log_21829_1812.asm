...
push %rdi
push %rsi
lea addresses_WC_ht+0x1ab1b, %rsi
lea addresses_WT_ht+0xe51b, %rdi
nop
nop
nop
nop
...
nop
dec %r8
lea addresses_WC_ht+0x7dcf, %r11
clflush (%r11)
nop
nop
nop
...
nop
cmp $9784, %rcx
lea addresses_WC_ht+0x551b, %rcx
nop
add %r12, %r12
...
nop
add %r15, %r15
lea addresses_D_ht+0xaefb, %rsi
lea addresses_normal_ht+0x3d1b, %rdi
xor %r9, %r9
mov $56, %rcx
rep movsw
and %r11, %r11
lea addresses_WT_ht+0x19bbb, %r8
nop
sub $37765, %r11
mov (%r8), %r12d
nop
...
nop
xor %r15, %r15
lea addresses_normal_ht+0xad1b, %rdi
add $33753, %r9
vmovups (%rdi), %ymm2
...
nop
cmp $5762, %r8
lea addresses_WT_ht+0x37cb, %rsi
lea addresses_WT_ht+0x1951b, %rdi
nop
nop
nop
nop
...
{'src': {'same': False, 'congruent': 4, 'type': 'addresses_D_ht'}, 'OP': 'REPM', 'dst': {'same': False, 'congruent': 11, 'type': 'addresses_normal_ht'}}
...
{'OP': 'STOR', 'dst': {'NT': False, 'same': True, 'congruent': 0, 'type': 'addresses_WC_ht', 'AVXalign': False, 'size': 32}}
{'00': 21829}
