...
push %rdx
push %rsi
lea addresses_normal_ht+0x1bb09, %rcx
nop
nop
nop
and %r15, %r15
...
nop
inc %r8
lea addresses_UC_ht+0x1ed8f, %r12
clflush (%r12)
nop
nop
add $40403, %rdi
...
nop
and $12391, %rdi
lea addresses_WC_ht+0x1aec9, %rdi
sub $38851, %rdx
movw $0x6162, (%rdi)
xor $13020, %rdx
lea addresses_WT_ht+0xa699, %rdx
nop
nop
nop
nop
...
movw $0x6162, (%rdx)
add %rcx, %rcx
lea addresses_WC_ht+0x12809, %rsi
lea addresses_normal_ht+0xee29, %rdi
nop
nop
nop
inc %r8
...
nop
xor %rcx, %rcx
lea addresses_normal_ht+0x16709, %r15
nop
nop
nop
nop
...
nop
and $5852, %r12
lea addresses_D_ht+0x1db09, %rbx
nop
inc %rcx
vmovups (%rbx), %ymm5
...
nop
xor $4167, %r15
lea addresses_WT_ht+0x19d09, %rsi
nop
cmp $45839, %r8
movups (%rsi), %xmm3
vpextrq $1, %xmm3, %rbx
...
// Load
lea addresses_normal+0x5689, %rbx
nop
xor %rbp, %rbp
mov (%rbx), %r9d
nop
...
{'OP': 'LOAD', 'src': {'type': 'addresses_D_ht', 'AVXalign': False, 'congruent': 11, 'size': 32, 'same': True, 'NT': False}}
