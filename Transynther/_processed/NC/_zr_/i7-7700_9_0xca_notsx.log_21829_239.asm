...
push %rdx
push %rsi
lea addresses_normal_ht+0xb335, %r8
nop
nop
xor $52337, %rcx
mov (%r8), %ax
...
nop
cmp $64826, %r8
lea addresses_WC_ht+0x39d5, %rsi
nop
nop
xor %r10, %r10
...
nop
add %rax, %rax
lea addresses_UC_ht+0x994d, %rdx
nop
nop
nop
nop
...
nop
xor %rdi, %rdi
lea addresses_WC_ht+0x9f35, %rcx
nop
nop
and $54271, %rdx
mov $0x6162636465666768, %rax
...
nop
cmp $52470, %rdx
lea addresses_WC_ht+0x16945, %rsi
lea addresses_UC_ht+0x767b, %rdi
nop
nop
nop
sub $56449, %r12
...
{'src': {'congruent': 11, 'same': False, 'type': 'addresses_WT_ht'}, 'dst': {'congruent': 4, 'same': False, 'type': 'addresses_A_ht'}, 'OP': 'REPM'}
...
{'src': {'congruent': 4, 'same': False, 'type': 'addresses_WC_ht'}, 'dst': {'congruent': 0, 'same': False, 'type': 'addresses_UC_ht'}, 'OP': 'REPM'}
{'00': 21829}
