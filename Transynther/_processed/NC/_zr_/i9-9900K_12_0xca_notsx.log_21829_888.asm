...
push %rdi
push %rsi
lea addresses_UC_ht+0x1b668, %rsi
clflush (%rsi)
nop
nop
nop
...
nop
add %rdi, %rdi
lea addresses_normal_ht+0xb168, %rsi
nop
nop
nop
nop
...
nop
sub $16293, %r15
lea addresses_WC_ht+0x1ba68, %r15
nop
nop
nop
xor $23281, %r12
...
nop
cmp %r12, %r12
lea addresses_WT_ht+0x6a49, %r10
nop
nop
nop
nop
...
nop
cmp %r12, %r12
lea addresses_A_ht+0x1474d, %r12
cmp $25478, %rbp
movl $0x61626364, (%r12)
nop
nop
...
nop
and %r10, %r10
lea addresses_WC_ht+0x1a1b8, %rsi
lea addresses_UC_ht+0x12868, %rdi
nop
nop
xor %r9, %r9
mov $85, %rcx
...
nop
cmp %rcx, %rcx
lea addresses_WT_ht+0x1e268, %r9
nop
nop
cmp %r15, %r15
movl $0x61626364, (%r9)
...
nop
and $62461, %r10
lea addresses_WC_ht+0x3998, %rsi
add $40832, %r12
movw $0x6162, (%rsi)
and $41964, %rdi
pop %rsi
...
{'OP': 'REPM', 'src': {'same': False, 'congruent': 4, 'type': 'addresses_WC_ht'}, 'dst': {'same': False, 'congruent': 8, 'type': 'addresses_UC_ht'}}
