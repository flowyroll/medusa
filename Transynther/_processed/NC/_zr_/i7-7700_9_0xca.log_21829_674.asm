...
push %rdi
push %rsi
lea addresses_WT_ht+0x72a0, %r15
nop
nop
add $4463, %r12
...
nop
add %rax, %rax
lea addresses_WT_ht+0x14aa8, %rdi
nop
add $60782, %r12
movw $0x6162, (%rdi)
nop
...
nop
cmp $63213, %r15
lea addresses_WC_ht+0x1192a, %rsi
lea addresses_WC_ht+0x1dca0, %rdi
nop
nop
nop
nop
...
nop
xor $38778, %rcx
lea addresses_normal_ht+0x161b0, %r15
nop
nop
nop
nop
...
nop
and %rdi, %rdi
lea addresses_normal_ht+0x14320, %rbx
nop
nop
nop
and $22778, %rsi
...
nop
xor $35508, %rcx
lea addresses_WT_ht+0xab3c, %rbx
nop
nop
nop
nop
