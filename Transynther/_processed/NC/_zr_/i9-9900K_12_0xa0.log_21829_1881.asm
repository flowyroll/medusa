...
lea addresses_D_ht+0x1319c, %rdi
and $63231, %r9
mov $82, %rcx
rep movsw
nop
...
mov (%rsi), %r15d
and $45887, %rsi
lea addresses_WT_ht+0x15b98, %rsi
nop
nop
and %r15, %r15
vmovups (%rsi), %ymm6
...
nop
sub $20098, %r15
lea addresses_WC_ht+0x1998f, %r10
nop
nop
nop
nop
...
nop
sub $3694, %r9
lea addresses_WC_ht+0x9c44, %rcx
nop
nop
sub %r12, %r12
movw $0x6162, (%rcx)
cmp %r10, %r10
lea addresses_WC_ht+0xa2b4, %rsi
lea addresses_UC_ht+0x50bc, %rdi
nop
xor %r14, %r14
mov $111, %rcx
rep movsl
sub $46444, %r9
lea addresses_normal_ht+0x1ed68, %rcx
nop
nop
and %rdi, %rdi
movups (%rcx), %xmm2
...
nop
dec %rdi
lea addresses_normal_ht+0x66be, %r14
and %rsi, %rsi
mov (%r14), %r9w
nop
nop
...
{'src': {'same': False, 'congruent': 1, 'type': 'addresses_UC_ht'}, 'OP': 'REPM', 'dst': {'same': True, 'congruent': 11, 'type': 'addresses_D_ht'}}
{'OP': 'STOR', 'dst': {'NT': True, 'same': False, 'congruent': 3, 'type': 'addresses_A_ht', 'AVXalign': False, 'size': 16}}
...
{'src': {'same': False, 'congruent': 2, 'type': 'addresses_WC_ht'}, 'OP': 'REPM', 'dst': {'same': True, 'congruent': 5, 'type': 'addresses_UC_ht'}}
