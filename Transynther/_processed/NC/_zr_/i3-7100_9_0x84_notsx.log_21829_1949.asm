...
push %rdi
push %rsi
lea addresses_normal_ht+0x14305, %rbx
nop
nop
nop
dec %r9
...
movntdq %xmm7, (%r8)
inc %rbx
lea addresses_D_ht+0x9a05, %rsi
lea addresses_D_ht+0xb245, %rdi
and $51921, %rbx
mov $108, %rcx
rep movsw
nop
...
nop
sub %rbx, %rbx
lea addresses_UC_ht+0xd717, %r10
nop
nop
nop
nop
...
nop
and %rbx, %rbx
lea addresses_WT_ht+0x1969, %rsi
nop
cmp $33755, %r8
mov (%rsi), %rdi
nop
...
{'src': {'type': 'addresses_D_ht', 'congruent': 11, 'same': True}, 'dst': {'type': 'addresses_D_ht', 'congruent': 3, 'same': False}, 'OP': 'REPM'}
