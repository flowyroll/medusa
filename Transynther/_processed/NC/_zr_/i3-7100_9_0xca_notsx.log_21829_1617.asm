...
push %rdi
push %rdx
lea addresses_A_ht+0x16dc2, %rcx
nop
and $41230, %rdx
movl $0x61626364, (%rcx)
nop
add $16723, %r10
lea addresses_A_ht+0x1a60e, %r9
inc %r8
...
nop
add $29798, %r9
lea addresses_UC_ht+0x1686a, %r10
nop
cmp $43477, %r15
movb $0x61, (%r10)
nop
cmp $50352, %rdi
lea addresses_UC_ht+0x5f2a, %rcx
nop
nop
and $62247, %r9
mov (%rcx), %r10w
...
{'OP': 'STOR', 'dst': {'same': False, 'congruent': 2, 'NT': True, 'type': 'addresses_P', 'size': 4, 'AVXalign': False}}
...
{'src': {'same': False, 'congruent': 6, 'NT': False, 'type': 'addresses_UC_ht', 'size': 2, 'AVXalign': True}, 'OP': 'LOAD'}
{'00': 21829}
