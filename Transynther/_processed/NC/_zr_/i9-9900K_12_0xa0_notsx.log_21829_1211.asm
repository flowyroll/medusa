...
push %rdi
push %rsi
lea addresses_WC_ht+0x11197, %r12
nop
nop
nop
nop
...
nop
cmp %r11, %r11
lea addresses_WT_ht+0xffa3, %r13
nop
nop
and $42879, %rsi
movl $0x61626364, (%r13)
...
nop
xor $14936, %r11
lea addresses_D_ht+0x173d7, %r13
nop
nop
nop
nop
...
nop
sub %r14, %r14
lea addresses_normal_ht+0x19557, %rsi
nop
xor $43735, %r12
mov (%rsi), %r11d
nop
...
nop
and %rdi, %rdi
lea addresses_normal_ht+0x9d7, %rsi
...
nop
and $40054, %r10
lea addresses_WT_ht+0x1e127, %rdi
nop
nop
nop
cmp $21541, %r13
...
nop
inc %r11
lea addresses_UC_ht+0x12bd7, %r14
nop
nop
nop
sub %r11, %r11
...
nop
dec %rcx
lea addresses_UC_ht+0x2bd7, %r13
nop
nop
nop
nop
...
nop
add %rsi, %rsi
lea addresses_D_ht+0x2617, %rsi
lea addresses_UC_ht+0x12973, %rdi
nop
nop
nop
sub %r12, %r12
...
{'OP': 'STOR', 'dst': {'type': 'addresses_P', 'AVXalign': False, 'size': 8, 'NT': True, 'same': False, 'congruent': 8}}
[Faulty Load]
