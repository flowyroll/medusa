...
nop
cmp $43641, %rdi
lea addresses_normal_ht+0x15df9, %rcx
nop
nop
nop
nop
...
nop
and $43718, %rax
lea addresses_A_ht+0xc8e5, %rsi
lea addresses_WC_ht+0x1c7f5, %rdi
nop
nop
nop
nop
...
nop
xor %rcx, %rcx
lea addresses_normal_ht+0x9d09, %rsi
lea addresses_WC_ht+0x3ec9, %rdi
nop
nop
nop
nop
...
nop
sub $37772, %rcx
lea addresses_WC_ht+0x1d419, %rax
nop
add $18492, %r11
mov (%rax), %r9d
nop
cmp %r11, %r11
lea addresses_normal_ht+0x18909, %rax
nop
xor %rdi, %rdi
movl $0x61626364, (%rax)
nop
...
nop
cmp $22704, %rdi
lea addresses_WT_ht+0x4a49, %rsi
lea addresses_D_ht+0x85c9, %rdi
sub %r10, %r10
mov $24, %rcx
rep movsw
nop
sub %rax, %rax
lea addresses_UC_ht+0x19a09, %rsi
lea addresses_UC_ht+0x5f09, %rdi
add $2544, %r9
mov $7, %rcx
rep movsb
nop
...
nop
add $1407, %rdx
lea addresses_A_ht+0xb49, %rsi
lea addresses_D_ht+0xe409, %rdi
add %r9, %r9
mov $104, %rcx
rep movsb
nop
...
nop
xor $22767, %rax
lea addresses_WC_ht+0xf709, %rsi
lea addresses_A_ht+0xee69, %rdi
nop
nop
nop
nop
...
<gen_prepare_buffer>
{'src': {'type': 'addresses_WT_ht', 'congruent': 7, 'same': False}, 'dst': {'type': 'addresses_normal_ht', 'congruent': 6, 'same': False}, 'OP': 'REPM'}
{'dst': {'type': 'addresses_normal_ht', 'same': False, 'size': 32, 'congruent': 5, 'NT': False, 'AVXalign': False}, 'OP': 'STOR'}
{'dst': {'type': 'addresses_normal_ht', 'same': False, 'size': 2, 'congruent': 4, 'NT': False, 'AVXalign': True}, 'OP': 'STOR'}
...
{'src': {'type': 'addresses_A_ht', 'same': False, 'size': 2, 'congruent': 1, 'NT': False, 'AVXalign': True}, 'OP': 'LOAD'}
...
{'src': {'type': 'addresses_UC_ht', 'congruent': 8, 'same': False}, 'dst': {'type': 'addresses_UC_ht', 'congruent': 11, 'same': False}, 'OP': 'REPM'}
...
{'src': {'type': 'addresses_WC_ht', 'congruent': 10, 'same': False}, 'dst': {'type': 'addresses_A_ht', 'congruent': 5, 'same': True}, 'OP': 'REPM'}
{'00': 21829}
