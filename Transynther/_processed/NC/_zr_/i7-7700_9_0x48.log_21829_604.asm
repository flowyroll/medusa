...
push %rdx
push %rsi
lea addresses_D_ht+0x18180, %rsi
lea addresses_WC_ht+0x9600, %rdi
nop
nop
nop
nop
...
rep movsq
xor %rsi, %rsi
lea addresses_WC_ht+0x1e000, %rdx
nop
nop
nop
nop
...
nop
xor $13485, %rsi
lea addresses_WC_ht+0x13f00, %rdi
nop
xor %r15, %r15
movb $0x61, (%rdi)
nop
...
nop
sub $16481, %rcx
lea addresses_WC_ht+0x7f00, %r14
dec %rdi
movb $0x61, (%r14)
nop
nop
nop
add %r14, %r14
lea addresses_WC_ht+0xf664, %rsi
lea addresses_WT_ht+0xaa40, %rdi
add $56913, %r11
mov $84, %rcx
rep movsq
nop
add %r12, %r12
lea addresses_UC_ht+0x16344, %r14
nop
nop
nop
sub $53455, %r15
...
lea addresses_WT_ht+0x1b700, %rdi
nop
nop
nop
nop
...
nop
sub $16705, %rdx
lea addresses_normal_ht+0x1e800, %rsi
lea addresses_WC_ht+0x4a80, %rdi
nop
sub $50476, %r15
mov $91, %rcx
rep movsb
mfence
lea addresses_A_ht+0x14b00, %rsi
lea addresses_WC_ht+0x4410, %rdi
nop
nop
nop
nop
...
rep movsl
cmp %r12, %r12
lea addresses_D_ht+0x1d080, %r15
nop
nop
nop
cmp $32940, %rdi
movb $0x61, (%r15)
add %rdx, %rdx
lea addresses_normal_ht+0xb180, %r15
nop
nop
nop
and $16781, %r14
...
nop
sub $25400, %r12
lea addresses_normal_ht+0x185ac, %rsi
lea addresses_UC_ht+0xb25c, %rdi
nop
nop
nop
nop
...
nop
and %r15, %r15
lea addresses_UC_ht+0xea80, %rdx
nop
nop
nop
sub %rdi, %rdi
...
{'OP': 'STOR', 'dst': {'type': 'addresses_WC_ht', 'AVXalign': False, 'congruent': 4, 'size': 8, 'same': True, 'NT': False}}
{'OP': 'STOR', 'dst': {'type': 'addresses_WC_ht', 'AVXalign': False, 'congruent': 10, 'size': 1, 'same': False, 'NT': False}}
{'OP': 'STOR', 'dst': {'type': 'addresses_WC_ht', 'AVXalign': False, 'congruent': 9, 'size': 1, 'same': False, 'NT': True}}
...
{'OP': 'LOAD', 'src': {'type': 'addresses_UC_ht', 'AVXalign': False, 'congruent': 6, 'size': 1, 'same': True, 'NT': False}}
{'00': 21829}
