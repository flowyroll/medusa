...
push %rdi
push %rsi
lea addresses_WT_ht+0x6d6d, %rcx
nop
sub $20097, %r13
movw $0x6162, (%rcx)
nop
add %r12, %r12
lea addresses_WT_ht+0x1753d, %r9
nop
xor $60339, %rax
...
nop
cmp %r13, %r13
lea addresses_D_ht+0x12d3d, %r11
cmp $18736, %r13
mov (%r11), %ecx
nop
nop
...
nop
add $61529, %r13
lea addresses_WT_ht+0xc93d, %rsi
lea addresses_WC_ht+0x13f3d, %rdi
nop
sub %r13, %r13
mov $110, %rcx
rep movsq
...
nop
cmp $60232, %r9
lea addresses_normal_ht+0x1857d, %rsi
nop
nop
sub $26179, %rcx
mov (%rsi), %r11
...
nop
xor $45477, %r9
lea addresses_UC_ht+0x4d3d, %r12
add $6527, %rcx
vmovups (%r12), %ymm5
vextracti128 $1, %ymm5, %xmm5
vpextrq $0, %xmm5, %r13
and %r13, %r13
lea addresses_D_ht+0x17f7d, %r12
nop
nop
nop
nop
...
{'OP': 'LOAD', 'src': {'type': 'addresses_P', 'AVXalign': False, 'congruent': 10, 'size': 16, 'same': False, 'NT': False}}
