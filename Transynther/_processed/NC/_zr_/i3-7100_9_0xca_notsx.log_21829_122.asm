...
push %rdx
push %rsi
lea addresses_A_ht+0xfe33, %rsi
lea addresses_WC_ht+0x11733, %rdi
nop
dec %r13
mov $113, %rcx
rep movsb
...
nop
dec %rsi
lea addresses_WC_ht+0x19f3, %rcx
clflush (%rcx)
nop
nop
xor $24504, %rsi
...
nop
and %rsi, %rsi
lea addresses_WC_ht+0x10033, %rcx
nop
nop
nop
nop
...
nop
sub $25481, %r13
lea addresses_D_ht+0x1ae33, %rsi
nop
nop
sub %rcx, %rcx
movb (%rsi), %r11b
...
nop
cmp %r14, %r14
lea addresses_normal_ht+0x177b, %rcx
clflush (%rcx)
cmp %r14, %r14
mov (%rcx), %si
nop
...
nop
cmp %rdx, %rdx
lea addresses_UC_ht+0xc033, %rcx
nop
nop
nop
nop
...
{'OP': 'STOR', 'dst': {'same': False, 'congruent': 7, 'NT': False, 'type': 'addresses_D', 'size': 2, 'AVXalign': True}}
[Faulty Load]
...
{'src': {'same': False, 'congruent': 11, 'NT': False, 'type': 'addresses_D_ht', 'size': 1, 'AVXalign': True}, 'OP': 'LOAD'}
...
{'OP': 'STOR', 'dst': {'same': False, 'congruent': 0, 'NT': False, 'type': 'addresses_normal_ht', 'size': 16, 'AVXalign': True}}
{'00': 21829}
