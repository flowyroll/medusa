...
nop
dec %r10
lea addresses_A_ht+0x190ab, %rsi
nop
nop
xor $28499, %r11
vmovups (%rsi), %ymm2
...
// Store
lea addresses_normal+0x933a, %rdx
nop
nop
nop
dec %r14
...
// Store
lea addresses_normal+0x1aab, %r15
cmp %rdi, %rdi
movb $0x51, (%r15)
nop
nop
...
{'dst': {'NT': False, 'AVXalign': True, 'size': 4, 'congruent': 9, 'same': False, 'type': 'addresses_UC'}, 'OP': 'STOR'}
{'dst': {'NT': False, 'AVXalign': False, 'size': 8, 'congruent': 3, 'same': False, 'type': 'addresses_US'}, 'OP': 'STOR'}
{'dst': {'NT': True, 'AVXalign': False, 'size': 32, 'congruent': 6, 'same': False, 'type': 'addresses_PSE'}, 'OP': 'STOR'}
...
<gen_prepare_buffer>
{'src': {'congruent': 8, 'same': False, 'type': 'addresses_A_ht'}, 'dst': {'congruent': 1, 'same': True, 'type': 'addresses_WC_ht'}, 'OP': 'REPM'}
