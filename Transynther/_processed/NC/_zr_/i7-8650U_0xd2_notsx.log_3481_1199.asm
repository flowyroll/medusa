...
push %rdi
push %rsi
lea addresses_normal_ht+0x15ae3, %r12
nop
nop
nop
nop
...
vpextrq $0, %xmm3, %rbx
cmp $21996, %r9
lea addresses_UC_ht+0x16833, %rcx
nop
nop
nop
nop
...
nop
cmp %r13, %r13
lea addresses_WC_ht+0x1fd3, %r13
nop
nop
nop
dec %r12
...
nop
add %r12, %r12
lea addresses_D_ht+0x65d3, %rsi
lea addresses_normal_ht+0x1ece3, %rdi
sub %r9, %r9
mov $33, %rcx
rep movsw
nop
...
nop
cmp $27221, %rbp
lea addresses_normal_ht+0xbd7, %rbx
nop
dec %r11
movb (%rbx), %cl
dec %rbp
lea addresses_UC_ht+0x1b283, %rbx
nop
nop
dec %r11
movups (%rbx), %xmm4
...
nop
and $39414, %rdi
lea addresses_WC_ht+0x4283, %r11
nop
nop
nop
and $26814, %r9
...
nop
cmp $12274, %r13
lea addresses_UC_ht+0xcacf, %r13
nop
nop
and $44165, %r9
mov (%r13), %rbx
...
nop
sub %rbp, %rbp
lea addresses_normal_ht+0xd3e3, %r11
nop
nop
nop
nop
...
nop
cmp $1555, %rsi
lea addresses_A_ht+0x6ce3, %rsi
lea addresses_WC_ht+0x13a03, %rdi
nop
nop
xor %rbx, %rbx
mov $42, %rcx
