...
push %rdi
push %rsi
lea addresses_WT_ht+0xc5cc, %rsi
lea addresses_WT_ht+0xdde7, %rdi
nop
sub $3331, %rax
mov $50, %rcx
rep movsb
...
nop
cmp $33453, %rcx
lea addresses_A_ht+0x1bfe7, %rsi
lea addresses_WC_ht+0x152a7, %rdi
clflush (%rsi)
nop
and %r15, %r15
mov $38, %rcx
rep movsb
xor %r15, %r15
lea addresses_D_ht+0x14457, %r12
nop
nop
nop
nop
...
mov (%r12), %di
cmp $41933, %r15
lea addresses_D_ht+0x1d9e7, %rax
nop
nop
add %r12, %r12
movb $0x61, (%rax)
nop
and %r12, %r12
lea addresses_normal_ht+0x1c5e7, %r10
nop
nop
nop
nop
...
nop
and %r15, %r15
lea addresses_normal_ht+0x10bc7, %rax
nop
nop
nop
nop
...
nop
add %r10, %r10
lea addresses_normal_ht+0x139e7, %rcx
clflush (%rcx)
nop
xor %r10, %r10
mov (%rcx), %r15w
...
nop
xor $19737, %rsi
lea addresses_normal_ht+0xabe7, %r10
nop
nop
nop
nop
...
{'OP': 'REPM', 'src': {'type': 'addresses_A_ht', 'congruent': 9, 'same': False}, 'dst': {'type': 'addresses_WC_ht', 'congruent': 6, 'same': True}}
