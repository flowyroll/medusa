...
push %rdi
push %rsi
lea addresses_D_ht+0x1da26, %r11
nop
nop
xor %r13, %r13
movl $0x61626364, (%r11)
...
nop
inc %rax
lea addresses_WT_ht+0x157c4, %rsi
lea addresses_UC_ht+0x13484, %rdi
clflush (%rdi)
nop
cmp $4146, %r11
mov $113, %rcx
...
nop
add $45584, %rsi
lea addresses_D_ht+0x173a4, %r13
nop
lfence
...
nop
and $2992, %rcx
lea addresses_WC_ht+0x1ab84, %r11
nop
inc %r13
movw $0x6162, (%r11)
nop
...
nop
and %rdi, %rdi
lea addresses_normal_ht+0x583c, %rcx
xor $4642, %r8
movb (%rcx), %al
nop
xor $58142, %rax
...
{'OP': 'STOR', 'dst': {'type': 'addresses_UC', 'size': 8, 'AVXalign': False, 'NT': True, 'congruent': 6, 'same': False}}
[Faulty Load]
{'OP': 'LOAD', 'src': {'type': 'addresses_NC', 'size': 16, 'AVXalign': False, 'NT': False, 'congruent': 0, 'same': True}}
<gen_prepare_buffer>
{'OP': 'STOR', 'dst': {'type': 'addresses_D_ht', 'size': 4, 'AVXalign': False, 'NT': False, 'congruent': 1, 'same': True}}
{'OP': 'REPM', 'src': {'type': 'addresses_WT_ht', 'congruent': 5, 'same': False}, 'dst': {'type': 'addresses_UC_ht', 'congruent': 8, 'same': True}}
