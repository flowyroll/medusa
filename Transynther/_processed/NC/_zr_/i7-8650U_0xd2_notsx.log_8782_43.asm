...
push %rdx
push %rsi
lea addresses_D_ht+0x1c808, %rsi
lea addresses_UC_ht+0x97e8, %rdi
nop
nop
sub %r10, %r10
mov $41, %rcx
...
nop
cmp %r10, %r10
lea addresses_normal_ht+0x17a30, %rsi
nop
nop
sub %r14, %r14
...
nop
cmp %rdi, %rdi
lea addresses_normal_ht+0x1c7b8, %r9
nop
nop
nop
inc %rbx
...
nop
inc %rdi
lea addresses_WC_ht+0x18f88, %r14
nop
add $23125, %r10
movb $0x61, (%r14)
nop
sub $31875, %rdi
lea addresses_D_ht+0x16908, %rbx
cmp %r10, %r10
vmovups (%rbx), %ymm4
...
nop
sub %rbx, %rbx
lea addresses_D_ht+0x10488, %rdi
nop
nop
nop
sub %rcx, %rcx
...
nop
add $37269, %rdi
lea addresses_A_ht+0x10e48, %rsi
lea addresses_A_ht+0x4008, %rdi
clflush (%rsi)
nop
nop
nop
...
// REPMOV
lea addresses_WC+0x15858, %rsi
lea addresses_PSE+0x1820c, %rdi
nop
nop
nop
cmp %rax, %rax
...
// Store
lea addresses_normal+0x3108, %rdx
dec %rcx
mov $0x5152535455565758, %r15
movq %r15, %xmm6
movups %xmm6, (%rdx)
...
{'OP': 'REPM', 'src': {'type': 'addresses_WC', 'congruent': 4, 'same': False}, 'dst': {'type': 'addresses_PSE', 'congruent': 1, 'same': False}}
...
{'OP': 'REPM', 'src': {'type': 'addresses_A_ht', 'congruent': 6, 'same': True}, 'dst': {'type': 'addresses_A_ht', 'congruent': 7, 'same': False}}
{'00': 8782}
