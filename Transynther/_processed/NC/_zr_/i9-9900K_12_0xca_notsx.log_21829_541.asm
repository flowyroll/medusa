...
push %rdx
push %rsi
lea addresses_WT_ht+0x1a4fa, %r10
nop
nop
nop
nop
...
nop
sub %rdx, %rdx
lea addresses_WC_ht+0x1e42e, %r11
nop
nop
nop
nop
...
nop
cmp $58760, %r13
lea addresses_A_ht+0x1a19a, %rdi
nop
and %rdx, %rdx
mov (%rdi), %r13d
nop
...
nop
cmp $3457, %r10
lea addresses_normal_ht+0x6508, %r10
nop
nop
nop
xor $7106, %rdi
...
nop
and %r10, %r10
lea addresses_D_ht+0x4ae, %rsi
lea addresses_WT_ht+0x1b452, %rdi
clflush (%rsi)
nop
nop
sub $44031, %r10
...
nop
add %r9, %r9
lea addresses_normal_ht+0x121ae, %rdx
sub %r9, %r9
...
nop
and %r10, %r10
lea addresses_WT_ht+0x152ae, %r9
nop
nop
nop
cmp $50542, %r13
...
nop
add $19819, %rdx
lea addresses_UC_ht+0x82ae, %r10
nop
nop
nop
nop
...
nop
and $20999, %rdi
lea addresses_normal_ht+0x102ae, %rsi
lea addresses_D_ht+0x15d2e, %rdi
nop
nop
nop
and %r12, %r12
...
nop
sub %rsi, %rsi
lea addresses_normal_ht+0x188f6, %rdx
nop
xor %r13, %r13
movb (%rdx), %r10b
nop
...
nop
dec %r12
lea addresses_normal_ht+0x17aae, %rsi
...
nop
xor %rsi, %rsi
lea addresses_WT_ht+0x10a9e, %rcx
nop
xor %rdx, %rdx
movw $0x6162, (%rcx)
cmp %rdi, %rdi
lea addresses_UC_ht+0xb6a2, %rsi
lea addresses_UC_ht+0x1446e, %rdi
nop
nop
cmp $13526, %rdx
mov $43, %rcx
rep movsl
sub %r13, %r13
lea addresses_WT_ht+0x13a2e, %r11
and %r10, %r10
movl $0x61626364, (%r11)
nop
nop
...
{'OP': 'STOR', 'dst': {'same': True, 'type': 'addresses_normal_ht', 'NT': False, 'AVXalign': False, 'size': 16, 'congruent': 8}}
{'OP': 'STOR', 'dst': {'same': False, 'type': 'addresses_WT_ht', 'NT': False, 'AVXalign': False, 'size': 16, 'congruent': 11}}
{'OP': 'STOR', 'dst': {'same': False, 'type': 'addresses_UC_ht', 'NT': False, 'AVXalign': True, 'size': 8, 'congruent': 9}}
