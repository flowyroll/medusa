...
push %rdi
push %rdx
lea addresses_UC_ht+0x18356, %rbx
nop
nop
nop
nop
...
nop
add $28079, %rdi
lea addresses_WC_ht+0x1a544, %rdx
nop
nop
nop
and $25898, %r9
...
vpextrq $1, %xmm6, %rdx
add %rbx, %rbx
lea addresses_UC_ht+0xb26e, %rdx
nop
cmp $674, %r9
movl $0x61626364, (%rdx)
nop
