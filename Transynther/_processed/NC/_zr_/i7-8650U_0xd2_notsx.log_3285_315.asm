...
push %rdi
push %rsi
lea addresses_WT_ht+0x19c96, %rax
nop
nop
nop
nop
...
vpextrq $1, %xmm4, %r13
cmp %rsi, %rsi
lea addresses_UC_ht+0x9b20, %rsi
lea addresses_normal_ht+0x1aa20, %rdi
nop
nop
nop
xor %rbx, %rbx
...
rep movsb
cmp %r13, %r13
lea addresses_WC_ht+0xd6a0, %rcx
nop
nop
nop
sub %rbp, %rbp
...
{'OP': 'LOAD', 'src': {'type': 'addresses_D', 'size': 8, 'AVXalign': False, 'NT': True, 'congruent': 4, 'same': False}}
[Faulty Load]
