...
nop
mfence
lea addresses_WC_ht+0x1b69c, %rsi
nop
nop
nop
inc %r11
...
nop
xor %rbx, %rbx
lea addresses_WC_ht+0x121a, %rsi
lea addresses_A_ht+0x3b1a, %rdi
clflush (%rdi)
nop
nop
nop
...
movups %xmm5, (%rbx)
xor $4320, %r10
lea addresses_WC_ht+0x1ba1a, %rsi
lea addresses_normal_ht+0x1b74a, %rdi
nop
nop
nop
cmp %r10, %r10
...
{'OP': 'LOAD', 'src': {'type': 'addresses_A_ht', 'size': 8, 'AVXalign': False, 'NT': True, 'congruent': 1, 'same': False}}
