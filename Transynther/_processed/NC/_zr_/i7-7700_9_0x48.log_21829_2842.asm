...
lea addresses_WC_ht+0x392c, %rdi
nop
nop
nop
nop
...
nop
and $63913, %rdi
lea addresses_WT_ht+0x1625c, %rax
nop
nop
nop
nop
...
nop
and $4593, %rdi
lea addresses_WC_ht+0x60f4, %rsi
cmp %r15, %r15
vmovups (%rsi), %ymm3
...
// REPMOV
lea addresses_D+0x13cdc, %rsi
lea addresses_WC+0x15d7c, %rdi
nop
cmp $30565, %r9
mov $43, %rcx
rep movsb
...
{'OP': 'REPM', 'src': {'type': 'addresses_D', 'congruent': 5, 'same': False}, 'dst': {'type': 'addresses_WC', 'congruent': 4, 'same': False}}
[Faulty Load]
{'OP': 'LOAD', 'src': {'type': 'addresses_NC', 'AVXalign': False, 'congruent': 0, 'size': 1, 'same': True, 'NT': False}}
<gen_prepare_buffer>
{'OP': 'REPM', 'src': {'type': 'addresses_WT_ht', 'congruent': 2, 'same': False}, 'dst': {'type': 'addresses_WC_ht', 'congruent': 4, 'same': True}}
