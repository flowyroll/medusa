...
push %rdi
push %rsi
lea addresses_UC_ht+0xfa4e, %rsi
lea addresses_D_ht+0x16fb0, %rdi
clflush (%rdi)
nop
nop
nop
...
nop
xor $15283, %rbp
lea addresses_WC_ht+0x60ec, %rsi
lea addresses_D_ht+0x1cfb0, %rdi
nop
nop
nop
cmp %r15, %r15
...
// Store
lea addresses_normal+0x11130, %rbx
nop
inc %rdi
...
// REPMOV
lea addresses_WC+0x127b0, %rsi
lea addresses_A+0x86b0, %rdi
nop
nop
nop
nop
...
{'OP': 'REPM', 'src': {'type': 'addresses_WC', 'congruent': 9, 'same': False}, 'dst': {'type': 'addresses_A', 'congruent': 6, 'same': False}}
[Faulty Load]
...
{'OP': 'REPM', 'src': {'type': 'addresses_WC_ht', 'congruent': 2, 'same': True}, 'dst': {'type': 'addresses_D_ht', 'congruent': 11, 'same': False}}
{'00': 3048}
