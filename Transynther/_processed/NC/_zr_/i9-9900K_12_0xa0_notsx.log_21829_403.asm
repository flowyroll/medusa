...
push %rdi
push %rsi
lea addresses_WC_ht+0x1d612, %r10
nop
cmp $42762, %r14
movb $0x61, (%r10)
nop
...
nop
sub %rdi, %rdi
lea addresses_normal_ht+0x14612, %r12
clflush (%r12)
nop
nop
nop
...
nop
xor %r10, %r10
lea addresses_D_ht+0x8702, %rsi
lea addresses_WC_ht+0x172aa, %rdi
nop
nop
nop
nop
...
nop
and %r8, %r8
lea addresses_WT_ht+0xa11c, %rbp
clflush (%rbp)
nop
nop
sub %rdi, %rdi
...
nop
xor %r8, %r8
lea addresses_A_ht+0x1e312, %rcx
nop
nop
nop
add %rdi, %rdi
