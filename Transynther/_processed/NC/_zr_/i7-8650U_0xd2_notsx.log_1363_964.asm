...
nop
sub $10608, %r9
lea addresses_A_ht+0x9c18, %r13
nop
inc %r12
movw $0x6162, (%r13)
sub $58024, %r9
lea addresses_D_ht+0x1298, %rbx
nop
nop
nop
and $57879, %rdx
