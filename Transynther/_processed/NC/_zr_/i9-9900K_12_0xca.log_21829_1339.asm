...
push %rdx
push %rsi
lea addresses_WC_ht+0x1c1d7, %rdx
nop
nop
nop
nop
...
nop
dec %rbp
lea addresses_normal_ht+0x151d7, %r9
nop
nop
nop
nop
...
nop
dec %r13
lea addresses_WC_ht+0x40d7, %r13
nop
cmp $2342, %r9
...
nop
and $30126, %r13
lea addresses_UC_ht+0x1d24b, %r13
nop
nop
nop
nop
...
nop
sub %rdx, %rdx
lea addresses_UC_ht+0x18dd7, %rsi
lea addresses_normal_ht+0x15817, %rdi
inc %r10
mov $72, %rcx
rep movsl
nop
and $38253, %rcx
lea addresses_WT_ht+0x5bd7, %rsi
lea addresses_UC_ht+0x7d7, %rdi
nop
nop
nop
and %rbx, %rbx
...
nop
add $2207, %rbp
lea addresses_WT_ht+0x1d7, %rcx
nop
nop
cmp %rdi, %rdi
movb (%rcx), %bl
and %rcx, %rcx
lea addresses_UC_ht+0x9f57, %rsi
lea addresses_UC_ht+0x9157, %rdi
nop
nop
nop
nop
...
rep movsq
dec %rsi
lea addresses_WT_ht+0x161d7, %rsi
nop
cmp $5725, %r8
movb (%rsi), %r10b
nop
...
// Store
lea addresses_normal+0x1ca47, %rdx
nop
nop
nop
nop
...
{'OP': 'STOR', 'dst': {'size': 32, 'NT': True, 'type': 'addresses_A', 'same': False, 'AVXalign': False, 'congruent': 4}}
...
<gen_prepare_buffer>
{'OP': 'LOAD', 'src': {'size': 1, 'NT': False, 'type': 'addresses_WC_ht', 'same': False, 'AVXalign': True, 'congruent': 10}}
...
{'OP': 'REPM', 'src': {'same': False, 'type': 'addresses_UC_ht', 'congruent': 8}, 'dst': {'same': False, 'type': 'addresses_normal_ht', 'congruent': 6}}
...
{'OP': 'REPM', 'src': {'same': False, 'type': 'addresses_UC_ht', 'congruent': 5}, 'dst': {'same': False, 'type': 'addresses_UC_ht', 'congruent': 7}}
