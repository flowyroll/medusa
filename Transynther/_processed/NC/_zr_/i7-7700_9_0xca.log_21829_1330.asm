...
nop
and %r9, %r9
lea addresses_UC_ht+0x134ac, %r15
nop
nop
nop
add $46431, %rcx
...
nop
xor %rbp, %rbp
lea addresses_WC_ht+0x7c2c, %r15
nop
nop
nop
nop
...
nop
xor %rcx, %rcx
lea addresses_WC_ht+0xc6cc, %rbp
nop
nop
nop
nop
...
nop
cmp $6780, %rcx
lea addresses_WC_ht+0x14404, %rax
nop
nop
nop
nop
...
nop
and %r15, %r15
lea addresses_A_ht+0x1c5fc, %rdi
nop
nop
nop
nop
...
lea addresses_A_ht+0x12fc6, %rdi
clflush (%rdi)
nop
nop
nop
...
nop
and %rbp, %rbp
lea addresses_WC_ht+0x122ec, %rcx
nop
nop
nop
nop
...
nop
and %r9, %r9
lea addresses_WC_ht+0x30cc, %rsi
lea addresses_WC_ht+0xddec, %rdi
clflush (%rsi)
nop
dec %r9
mov $69, %rcx
rep movsl
add %r9, %r9
lea addresses_UC_ht+0xe88c, %rax
cmp $52569, %rbp
mov (%rax), %rcx
nop
nop
