...
movups %xmm3, (%rax)
xor $62475, %r15
lea addresses_WC_ht+0xdf3a, %rsi
lea addresses_D_ht+0x7cba, %rdi
nop
nop
nop
nop
...
nop
inc %r10
lea addresses_A_ht+0x1d2e1, %rcx
nop
and %rsi, %rsi
mov (%rcx), %r10
nop
add $60645, %r13
lea addresses_D_ht+0x1223a, %r9
clflush (%r9)
nop
nop
nop
...
{'OP': 'LOAD', 'src': {'size': 2, 'NT': False, 'type': 'addresses_WT', 'same': False, 'AVXalign': False, 'congruent': 11}}
[Faulty Load]
...
{'OP': 'REPM', 'src': {'same': False, 'type': 'addresses_WC_ht', 'congruent': 6}, 'dst': {'same': True, 'type': 'addresses_D_ht', 'congruent': 9}}
