...
push %rdi
push %rsi
lea addresses_WC_ht+0x19937, %r10
inc %rax
mov $0x6162636465666768, %r15
movq %r15, %xmm2
movups %xmm2, (%r10)
xor %rbx, %rbx
lea addresses_A_ht+0x3037, %rsi
lea addresses_UC_ht+0x46f7, %rdi
clflush (%rdi)
nop
nop
nop
...
nop
add %r10, %r10
lea addresses_A_ht+0x197e7, %r12
clflush (%r12)
nop
nop
nop
...
nop
cmp $23358, %r15
lea addresses_UC_ht+0xd937, %rsi
and $38634, %rax
mov $0x6162636465666768, %r10
movq %r10, %xmm5
movups %xmm5, (%rsi)
add %rbx, %rbx
lea addresses_A_ht+0x4a49, %rsi
lea addresses_A_ht+0xbdbb, %rdi
nop
nop
nop
nop
...
nop
sub $37347, %rsi
lea addresses_UC_ht+0x1765d, %rbx
sub %r15, %r15
movl $0x61626364, (%rbx)
nop
inc %r15
lea addresses_D_ht+0xeb31, %rsi
lea addresses_D_ht+0xc39a, %rdi
nop
nop
nop
nop
...
{'OP': 'REPM', 'src': {'type': 'addresses_A_ht', 'congruent': 1, 'same': False}, 'dst': {'type': 'addresses_A_ht', 'congruent': 1, 'same': False}}
...
{'OP': 'REPM', 'src': {'type': 'addresses_D_ht', 'congruent': 1, 'same': False}, 'dst': {'type': 'addresses_D_ht', 'congruent': 0, 'same': True}}
{'00': 20537}
