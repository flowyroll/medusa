...
nop
cmp $56759, %rdi
lea addresses_normal_ht+0xb554, %rsi
lea addresses_A_ht+0xd334, %rdi
add %r8, %r8
mov $45, %rcx
rep movsw
nop
...
nop
dec %rdi
lea addresses_normal_ht+0x8e24, %rsi
lea addresses_UC_ht+0xa154, %rdi
nop
nop
nop
nop
...
nop
xor $39186, %rcx
lea addresses_WC_ht+0x7874, %rdi
nop
nop
cmp $63678, %r14
movb $0x61, (%rdi)
...
nop
sub $33663, %rdi
lea addresses_A_ht+0x1ad54, %r13
xor %rdi, %rdi
...
nop
cmp %r8, %r8
lea addresses_normal_ht+0xeb54, %rdi
add %r14, %r14
movw $0x6162, (%rdi)
nop
nop
...
{'OP': 'REPM', 'src': {'same': False, 'type': 'addresses_D_ht', 'congruent': 8}, 'dst': {'same': False, 'type': 'addresses_normal_ht', 'congruent': 3}}
...
{'OP': 'STOR', 'dst': {'size': 8, 'NT': False, 'type': 'addresses_A_ht', 'same': True, 'AVXalign': False, 'congruent': 5}}
