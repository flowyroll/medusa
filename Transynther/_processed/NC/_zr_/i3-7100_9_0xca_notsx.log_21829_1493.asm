...
push %rdx
push %rsi
lea addresses_D_ht+0x10675, %r12
nop
nop
nop
inc %rdx
...
nop
inc %rsi
lea addresses_UC_ht+0x8695, %rsi
lea addresses_A_ht+0x63b5, %rdi
nop
nop
nop
nop
...
nop
sub %rdx, %rdx
lea addresses_WT_ht+0x96cd, %r10
nop
nop
nop
and %r8, %r8
...
nop
cmp $45304, %rdx
lea addresses_D_ht+0x1ee75, %rsi
lea addresses_D_ht+0x184c5, %rdi
nop
nop
nop
nop
...
nop
inc %rdi
lea addresses_WT_ht+0x19a75, %r10
nop
nop
nop
nop
...
nop
xor $47886, %r8
lea addresses_normal_ht+0x1457d, %rdx
nop
nop
nop
xor $54446, %r8
...
nop
inc %r10
lea addresses_UC_ht+0x9047, %rcx
nop
dec %r10
mov (%rcx), %r12w
nop
...
nop
add %rdx, %rdx
lea addresses_normal_ht+0x1de10, %rsi
lea addresses_A_ht+0x1d66f, %rdi
nop
dec %rbp
mov $10, %rcx
rep movsb
...
nop
xor %r8, %r8
lea addresses_WT_ht+0x6b8d, %rsi
lea addresses_WC_ht+0x1a275, %rdi
xor %r8, %r8
mov $5, %rcx
rep movsq
nop
...
{'src': {'same': False, 'congruent': 1, 'NT': True, 'type': 'addresses_UC_ht', 'size': 2, 'AVXalign': False}, 'OP': 'LOAD'}
