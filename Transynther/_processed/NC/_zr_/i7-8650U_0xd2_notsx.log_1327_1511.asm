...
nop
and $26158, %rcx
lea addresses_A_ht+0x15b00, %rsi
...
nop
xor %rdi, %rdi
lea addresses_normal_ht+0x14460, %rcx
nop
xor %rsi, %rsi
mov (%rcx), %r15
nop
nop
xor $49418, %r15
lea addresses_WT_ht+0x1c100, %rsi
nop
xor $37320, %r10
movw $0x6162, (%rsi)
nop
nop
cmp %r10, %r10
lea addresses_normal_ht+0x4630, %rdi
nop
nop
nop
nop
...
nop
add $8934, %rsi
lea addresses_A_ht+0x1c200, %r14
nop
nop
nop
cmp %rsi, %rsi
...
nop
xor %rdi, %rdi
lea addresses_WC_ht+0x15068, %rsi
lea addresses_D_ht+0x13300, %rdi
nop
nop
nop
nop
...
nop
xor $49200, %r14
lea addresses_normal_ht+0xbfd7, %r9
nop
nop
nop
nop
...
mov (%r9), %r14w
dec %r9
lea addresses_A_ht+0x10600, %r15
nop
xor %r9, %r9
mov (%r15), %r10w
nop
...
nop
xor %r15, %r15
lea addresses_normal_ht+0x8dc0, %rdi
nop
nop
nop
nop
...
nop
xor %r14, %r14
lea addresses_D_ht+0xb748, %rsi
xor $62661, %rcx
mov (%rsi), %r15d
nop
xor $4618, %r9
lea addresses_WT_ht+0x7940, %rsi
...
// REPMOV
lea addresses_US+0x3b00, %rsi
lea addresses_PSE+0x2b38, %rdi
nop
nop
xor %r12, %r12
mov $59, %rcx
...
{'OP': 'REPM', 'src': {'type': 'addresses_US', 'congruent': 10, 'same': False}, 'dst': {'type': 'addresses_PSE', 'congruent': 2, 'same': False}}
[Faulty Load]
...
{'OP': 'REPM', 'src': {'type': 'addresses_WC_ht', 'congruent': 3, 'same': True}, 'dst': {'type': 'addresses_D_ht', 'congruent': 9, 'same': False}}
