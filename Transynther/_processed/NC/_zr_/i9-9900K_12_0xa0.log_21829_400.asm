...
push %rdi
push %rsi
lea addresses_WT_ht+0xd15a, %r10
and %r11, %r11
movl $0x61626364, (%r10)
nop
nop
nop
add %rbp, %rbp
lea addresses_A_ht+0x120a3, %rbp
nop
nop
nop
nop
...
nop
add $41240, %r8
lea addresses_UC_ht+0x2d3f, %r10
nop
nop
nop
nop
...
vpextrq $0, %xmm2, %rbp
cmp %rbp, %rbp
lea addresses_UC_ht+0x14afb, %rbp
clflush (%rbp)
nop
nop
nop
...
nop
sub $21775, %r10
lea addresses_WT_ht+0x5403, %rsi
lea addresses_D_ht+0x1c0c3, %rdi
nop
nop
inc %r11
mov $65, %rcx
