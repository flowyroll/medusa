...
nop
sub %rdi, %rdi
lea addresses_D_ht+0x1d3d7, %rbx
clflush (%rbx)
nop
nop
nop
...
nop
sub $40916, %rbx
lea addresses_UC_ht+0x6777, %rsi
lea addresses_D_ht+0x908f, %rdi
nop
nop
nop
xor %rax, %rax
...
vpextrq $1, %xmm0, %rsi
sub $57949, %rcx
lea addresses_A_ht+0x1eed7, %r15
nop
nop
and $58945, %rdi
movb $0x61, (%r15)
...
nop
dec %r13
lea addresses_normal_ht+0x8d97, %rsi
lea addresses_A_ht+0xc8d7, %rdi
clflush (%rsi)
clflush (%rdi)
nop
nop
...
{'OP': 'STOR', 'dst': {'type': 'addresses_WT', 'AVXalign': False, 'congruent': 2, 'size': 2, 'same': False, 'NT': False}}
[Faulty Load]
...
{'OP': 'REPM', 'src': {'type': 'addresses_normal_ht', 'congruent': 5, 'same': False}, 'dst': {'type': 'addresses_A_ht', 'congruent': 9, 'same': True}}
{'00': 21829}
