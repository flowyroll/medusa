...
nop
cmp $35682, %r14
lea addresses_WT_ht+0x19e26, %rsi
lea addresses_WT_ht+0x13a26, %rdi
clflush (%rsi)
nop
nop
sub %r13, %r13
...
nop
cmp $62851, %rcx
lea addresses_WC_ht+0x1866, %r13
clflush (%r13)
nop
nop
nop
...
nop
sub $47445, %rdx
lea addresses_UC_ht+0x17026, %rax
nop
nop
xor %r13, %r13
movups (%rax), %xmm4
...
nop
xor %rcx, %rcx
lea addresses_UC_ht+0x18a26, %rcx
nop
nop
dec %r13
mov (%rcx), %esi
and %rdi, %rdi
lea addresses_A_ht+0x9c26, %rsi
lea addresses_normal_ht+0x8f26, %rdi
nop
nop
nop
nop
...
nop
and $64302, %r13
lea addresses_UC_ht+0x1c284, %rsi
nop
nop
nop
sub %rdx, %rdx
...
nop
sub %rsi, %rsi
lea addresses_WC_ht+0x11626, %rdx
nop
nop
nop
nop
...
nop
cmp %rsi, %rsi
lea addresses_WC_ht+0xf226, %rsi
lea addresses_D_ht+0xca26, %rdi
nop
nop
nop
sub $61940, %rdx
...
{'OP': 'STOR', 'dst': {'type': 'addresses_A_ht', 'AVXalign': False, 'congruent': 11, 'size': 4, 'same': True, 'NT': False}}
