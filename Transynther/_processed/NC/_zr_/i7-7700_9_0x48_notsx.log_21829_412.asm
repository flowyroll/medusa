...
nop
sub %rdi, %rdi
lea addresses_normal_ht+0x1ddb2, %r11
clflush (%r11)
nop
nop
nop
...
vpextrq $1, %xmm3, %r10
add $41827, %rdi
lea addresses_UC_ht+0x15822, %rsi
...
nop
cmp %r13, %r13
lea addresses_WC_ht+0x27c2, %rsi
nop
nop
nop
inc %r12
...
nop
add %r8, %r8
lea addresses_WT_ht+0x1cbe2, %rcx
nop
add $8500, %r12
mov (%rcx), %rdi
and %rcx, %rcx
lea addresses_UC_ht+0xe30a, %rsi
lea addresses_UC_ht+0x192e2, %rdi
nop
nop
nop
nop
...
nop
and $54725, %rdi
lea addresses_normal_ht+0x1b1e2, %rdx
add $31901, %rdi
movups (%rdx), %xmm5
vpextrq $0, %xmm5, %r11
nop
...
{'dst': {'same': False, 'congruent': 11, 'type': 'addresses_normal_ht'}, 'OP': 'REPM', 'src': {'same': False, 'congruent': 6, 'type': 'addresses_UC_ht'}}
...
{'dst': {'same': False, 'congruent': 8, 'type': 'addresses_UC_ht'}, 'OP': 'REPM', 'src': {'same': True, 'congruent': 2, 'type': 'addresses_UC_ht'}}
