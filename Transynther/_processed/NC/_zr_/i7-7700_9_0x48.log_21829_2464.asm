...
push %rdi
push %rsi
lea addresses_WT_ht+0x10457, %r15
nop
nop
xor %rsi, %rsi
mov (%r15), %r10w
nop
xor %rsi, %rsi
lea addresses_A_ht+0x17c63, %rsi
lea addresses_D_ht+0x1930f, %rdi
nop
nop
nop
nop
...
nop
dec %r10
lea addresses_D_ht+0x343, %rsi
lea addresses_WC_ht+0xc663, %rdi
nop
nop
nop
nop
...
nop
add $36567, %rdi
lea addresses_D_ht+0x1c263, %rsi
lea addresses_A_ht+0x5863, %rdi
nop
nop
nop
dec %rbp
...
nop
and $6838, %rdi
lea addresses_UC_ht+0x17c43, %rsi
lea addresses_WC_ht+0x9e63, %rdi
nop
nop
nop
inc %r12
...
nop
and $38257, %r10
lea addresses_normal_ht+0x9c63, %rsi
lea addresses_UC_ht+0xbd83, %rdi
clflush (%rdi)
nop
nop
nop
...
rep movsb
cmp $48359, %rdi
lea addresses_D_ht+0x1be63, %rsi
lea addresses_A_ht+0x9a0b, %rdi
nop
nop
nop
nop
...
// Load
lea addresses_normal+0xfc63, %rdi
nop
xor $50381, %r12
movb (%rdi), %r9b
add %rbx, %rbx
...
{'OP': 'REPM', 'src': {'type': 'addresses_D_ht', 'congruent': 8, 'same': False}, 'dst': {'type': 'addresses_A_ht', 'congruent': 6, 'same': False}}
