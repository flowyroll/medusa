...
push %rdx
push %rsi
lea addresses_UC_ht+0x91a6, %rcx
nop
nop
nop
and %rax, %rax
...
nop
add %rdx, %rdx
lea addresses_normal_ht+0x1cf06, %r13
nop
nop
dec %rdi
mov (%r13), %r12d
...
nop
add %rcx, %rcx
lea addresses_A_ht+0x1af26, %rcx
nop
and $7070, %r13
mov (%rcx), %r8w
xor $47621, %r12
lea addresses_UC_ht+0x17826, %r12
nop
nop
add %rcx, %rcx
mov (%r12), %dx
...
nop
add %rdi, %rdi
lea addresses_UC_ht+0x2bd6, %r13
clflush (%r13)
nop
nop
cmp $56625, %rdx
...
nop
cmp %rdi, %rdi
lea addresses_WT_ht+0x1ed26, %rsi
...
nop
sub %r8, %r8
lea addresses_WT_ht+0x18bb6, %r13
nop
nop
nop
lfence
