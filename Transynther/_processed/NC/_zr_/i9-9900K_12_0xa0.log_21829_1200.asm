...
nop
and %rax, %rax
lea addresses_D_ht+0x1da92, %rbx
nop
add $47561, %r12
movb (%rbx), %r10b
nop
...
nop
dec %r10
lea addresses_WT_ht+0xe885, %rbx
clflush (%rbx)
nop
nop
nop
...
movl $0x61626364, (%rbx)
sub $49044, %r15
lea addresses_UC_ht+0x72c1, %rsi
lea addresses_D_ht+0x990d, %rdi
nop
nop
nop
nop
...
nop
inc %rbx
lea addresses_D_ht+0x1b845, %rdi
nop
sub $41688, %rcx
movw $0x6162, (%rdi)
nop
...
nop
dec %r12
lea addresses_WT_ht+0x8256, %r15
nop
nop
nop
nop
...
nop
xor $30846, %rsi
lea addresses_WC_ht+0x12c85, %r15
nop
nop
nop
nop
...
mov (%r15), %bx
add $18155, %r15
lea addresses_WC_ht+0xe885, %rbx
nop
nop
nop
nop
...
{'src': {'same': True, 'congruent': 2, 'type': 'addresses_UC_ht'}, 'OP': 'REPM', 'dst': {'same': False, 'congruent': 3, 'type': 'addresses_D_ht'}}
...
{'src': {'NT': True, 'same': True, 'congruent': 9, 'type': 'addresses_WC_ht', 'AVXalign': False, 'size': 4}, 'OP': 'LOAD'}
