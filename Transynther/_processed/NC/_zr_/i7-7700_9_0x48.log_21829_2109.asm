...
nop
sub $52690, %r11
lea addresses_D_ht+0x16957, %rdi
nop
nop
inc %rbp
movb (%rdi), %bl
...
nop
cmp $59194, %r8
lea addresses_UC_ht+0x10657, %rsi
lea addresses_A_ht+0x6057, %rdi
nop
nop
nop
nop
...
lea addresses_WC_ht+0x17f6f, %rdi
add %rbp, %rbp
mov $109, %rcx
rep movsl
nop
...
nop
dec %rsi
lea addresses_A_ht+0x142b7, %rsi
nop
nop
inc %rcx
movb (%rsi), %bl
...
nop
sub $37449, %r11
lea addresses_normal_ht+0x14f26, %rcx
nop
nop
nop
sub $47710, %rbp
...
nop
add $41223, %rbp
lea addresses_UC_ht+0x1d687, %rsi
nop
nop
nop
dec %r8
...
nop
add $29015, %rbp
lea addresses_WT_ht+0x1c817, %r10
nop
nop
nop
nop
...
nop
add $16675, %r10
lea addresses_UC_ht+0x8091, %rsi
lea addresses_UC_ht+0xa857, %rdi
nop
nop
inc %r10
mov $55, %rcx
...
nop
xor %r8, %r8
lea addresses_A_ht+0xb797, %rsi
lea addresses_WT_ht+0x2057, %rdi
clflush (%rdi)
nop
nop
inc %rbx
...
{'OP': 'LOAD', 'src': {'type': 'addresses_UC_ht', 'AVXalign': True, 'congruent': 4, 'size': 2, 'same': False, 'NT': False}}
...
{'OP': 'LOAD', 'src': {'type': 'addresses_A_ht', 'AVXalign': False, 'congruent': 5, 'size': 1, 'same': True, 'NT': False}}
