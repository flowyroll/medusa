...
push %rdi
push %rsi
lea addresses_A_ht+0x8b14, %rsi
lea addresses_D_ht+0xf96c, %rdi
clflush (%rsi)
nop
nop
nop
...
movw $0x6162, (%rdi)
xor $14255, %rsi
lea addresses_WC_ht+0x123dc, %rsi
nop
nop
nop
add %rbx, %rbx
...
nop
cmp %rcx, %rcx
lea addresses_normal_ht+0xccc2, %rcx
nop
nop
nop
nop
...
{'src': {'same': True, 'congruent': 1, 'NT': True, 'type': 'addresses_normal_ht', 'size': 32, 'AVXalign': False}, 'OP': 'LOAD'}
{'00': 21829}
