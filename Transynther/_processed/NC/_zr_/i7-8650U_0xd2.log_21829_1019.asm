...
nop
xor $49804, %rsi
lea addresses_UC_ht+0x3415, %rsi
lea addresses_WT_ht+0x187b5, %rdi
nop
nop
nop
cmp $27666, %r10
...
nop
cmp $46436, %r14
lea addresses_UC_ht+0x85a3, %r10
nop
nop
nop
nop
...
nop
sub $63854, %rdx
lea addresses_WC_ht+0xc7b5, %rsi
...
nop
cmp %r10, %r10
lea addresses_WT_ht+0x17835, %rbx
nop
nop
nop
xor $6852, %rdx
...
// Store
lea addresses_normal+0x20ce, %r9
and %rdx, %rdx
movb $0x51, (%r9)
nop
nop
...
{'OP': 'LOAD', 'src': {'type': 'addresses_UC', 'size': 8, 'AVXalign': False, 'NT': True, 'congruent': 10, 'same': False}}
