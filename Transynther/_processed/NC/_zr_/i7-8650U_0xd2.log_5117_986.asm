...
push %rdx
push %rsi
lea addresses_WC_ht+0x1cee5, %r12
clflush (%r12)
nop
sub $21954, %r9
movl $0x61626364, (%r12)
...
nop
inc %r8
lea addresses_WC_ht+0x1e6e5, %r11
nop
nop
nop
nop
...
nop
inc %r11
lea addresses_D_ht+0x19ae5, %rsi
lea addresses_normal_ht+0xd4e5, %rdi
nop
nop
nop
nop
...
nop
sub $56404, %rcx
lea addresses_WC_ht+0xf195, %rdx
nop
nop
nop
nop
...
nop
cmp %r11, %r11
lea addresses_D_ht+0x1ab0d, %rsi
...
nop
cmp %r9, %r9
lea addresses_normal_ht+0x7463, %r12
nop
and $44182, %r11
movups (%r12), %xmm2
vpextrq $0, %xmm2, %rdi
...
// Store
lea addresses_normal+0x16945, %rax
nop
nop
nop
nop
...
{'OP': 'STOR', 'dst': {'type': 'addresses_UC', 'size': 4, 'AVXalign': False, 'NT': True, 'congruent': 8, 'same': False}}
...
{'OP': 'REPM', 'src': {'type': 'addresses_D_ht', 'congruent': 9, 'same': True}, 'dst': {'type': 'addresses_normal_ht', 'congruent': 9, 'same': False}}
