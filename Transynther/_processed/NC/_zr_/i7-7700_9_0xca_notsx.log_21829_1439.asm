...
push %rdi
push %rsi
lea addresses_WT_ht+0x12565, %r9
nop
nop
sub %r13, %r13
movups (%r9), %xmm7
...
nop
cmp $268, %rsi
lea addresses_A_ht+0x12d4d, %r15
clflush (%r15)
nop
nop
nop
...
nop
sub %rcx, %rcx
lea addresses_WT_ht+0x12f82, %rsi
nop
nop
nop
nop
...
nop
inc %rdi
lea addresses_WT_ht+0xa7e2, %rsi
lea addresses_D_ht+0x1ec5, %rdi
clflush (%rsi)
clflush (%rdi)
sub %rbp, %rbp
mov $124, %rcx
...
<gen_faulty_load>
[REF]
{'src': {'NT': True, 'AVXalign': True, 'size': 1, 'congruent': 0, 'same': False, 'type': 'addresses_NC'}, 'OP': 'LOAD'}
...
{'src': {'congruent': 0, 'same': False, 'type': 'addresses_WT_ht'}, 'dst': {'congruent': 3, 'same': False, 'type': 'addresses_D_ht'}, 'OP': 'REPM'}
{'00': 21829}
