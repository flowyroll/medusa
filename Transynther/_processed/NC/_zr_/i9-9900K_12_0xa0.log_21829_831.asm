...
push %rbx
push %rdx
lea addresses_normal_ht+0x1727c, %r9
nop
nop
nop
add %r13, %r13
...
nop
and $32671, %r9
lea addresses_WC_ht+0x1475c, %rax
nop
nop
nop
nop
...
nop
cmp %r9, %r9
lea addresses_UC_ht+0x15c3c, %r13
nop
nop
nop
nop
...
nop
sub %r11, %r11
lea addresses_UC_ht+0x162d5, %rdx
nop
nop
cmp %rax, %rax
movw $0x6162, (%rdx)
xor $35399, %rdx
lea addresses_normal_ht+0xe944, %r10
nop
add $53761, %r13
vmovups (%r10), %ymm5
...
{'src': {'NT': False, 'same': False, 'congruent': 4, 'type': 'addresses_UC_ht', 'AVXalign': True, 'size': 32}, 'OP': 'LOAD'}
