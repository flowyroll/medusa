...
nop
add $62229, %rax
lea addresses_A_ht+0x14eec, %rbx
clflush (%rbx)
nop
nop
nop
...
nop
cmp %rax, %rax
lea addresses_D_ht+0x1983c, %rax
nop
nop
nop
nop
...
nop
sub %r13, %r13
lea addresses_normal_ht+0x7f1c, %r12
nop
cmp $51355, %rsi
mov (%r12), %r13w
nop
nop
xor $41195, %r12
lea addresses_UC_ht+0x779c, %rdx
nop
nop
nop
and $2070, %rax
...
nop
add %rax, %rax
lea addresses_D_ht+0x145bc, %rsi
lea addresses_WC_ht+0xa9bc, %rdi
nop
nop
nop
nop
...
nop
cmp %rax, %rax
lea addresses_UC_ht+0x51bc, %r12
add %rbx, %rbx
movb (%r12), %al
nop
nop
and %r13, %r13
lea addresses_normal_ht+0x53bc, %r13
cmp $32989, %rax
movb $0x61, (%r13)
nop
nop
...
nop
xor $44928, %rdi
lea addresses_D_ht+0xedec, %rax
dec %rdx
movb (%rax), %r12b
sub %rcx, %rcx
lea addresses_D_ht+0x185bc, %rbx
nop
nop
nop
nop
...
{'OP': 'LOAD', 'src': {'same': False, 'type': 'addresses_PSE', 'NT': True, 'AVXalign': False, 'size': 32, 'congruent': 2}}
...
{'OP': 'LOAD', 'src': {'same': False, 'type': 'addresses_A_ht', 'NT': True, 'AVXalign': False, 'size': 1, 'congruent': 1}}
...
{'OP': 'REPM', 'src': {'same': False, 'congruent': 9, 'type': 'addresses_D_ht'}, 'dst': {'same': False, 'congruent': 7, 'type': 'addresses_WC_ht'}}
...
{'OP': 'STOR', 'dst': {'same': False, 'type': 'addresses_D_ht', 'NT': False, 'AVXalign': True, 'size': 16, 'congruent': 10}}
{'00': 21829}
