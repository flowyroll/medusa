...
push %rdi
push %rsi
lea addresses_normal_ht+0x4ba5, %rsi
lea addresses_normal_ht+0x1ef72, %rdi
add $4328, %r9
mov $100, %rcx
rep movsw
nop
add $9959, %r13
lea addresses_D_ht+0x96c5, %r11
and $56982, %r12
...
nop
and %r12, %r12
lea addresses_UC_ht+0x990a, %r11
nop
cmp $56464, %rcx
mov $0x6162636465666768, %r13
movq %r13, %xmm7
...
nop
and %r11, %r11
lea addresses_normal_ht+0x11ec5, %rdi
nop
nop
nop
and %r9, %r9
mov (%rdi), %r12d
add $62979, %r13
lea addresses_normal_ht+0xf445, %rsi
nop
nop
nop
nop
...
// Store
lea addresses_normal+0xc4e5, %r9
nop
nop
nop
nop
