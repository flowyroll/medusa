...
push %rdi
push %rsi
lea addresses_A_ht+0x17a2a, %rsi
lea addresses_D_ht+0x1daaa, %rdi
nop
xor $47148, %r13
mov $67, %rcx
rep movsw
and %rcx, %rcx
lea addresses_UC_ht+0x11aaa, %r10
nop
nop
nop
nop
...
nop
add $40836, %r13
lea addresses_WT_ht+0xf7ea, %rsi
nop
nop
and %r13, %r13
movw $0x6162, (%rsi)
nop
and $49179, %r10
lea addresses_D_ht+0x1162a, %rcx
nop
xor %rdi, %rdi
movb (%rcx), %r10b
nop
sub $34444, %rcx
lea addresses_WC_ht+0xfe2a, %rdi
nop
nop
nop
nop
...
mov (%rdi), %r9w
and $26973, %r13
lea addresses_D_ht+0x15baa, %rdi
nop
nop
dec %rcx
mov (%rdi), %r9w
nop
sub $3922, %r13
lea addresses_A_ht+0x352a, %rsi
lea addresses_UC_ht+0xc854, %rdi
clflush (%rdi)
xor %r15, %r15
mov $57, %rcx
rep movsq
nop
add $41501, %r9
lea addresses_WC_ht+0x90ea, %r13
nop
nop
nop
nop
...
nop
dec %rcx
lea addresses_WC_ht+0x1562a, %r13
nop
nop
nop
nop
...
nop
inc %rcx
lea addresses_WC_ht+0x4c2a, %rsi
lea addresses_D_ht+0x1c00e, %rdi
clflush (%rsi)
nop
sub %r10, %r10
mov $121, %rcx
...
nop
add %r13, %r13
lea addresses_WT_ht+0xe06a, %rsi
lea addresses_WT_ht+0x170aa, %rdi
nop
nop
nop
inc %r9
...
// REPMOV
lea addresses_WC+0xdf2a, %rsi
lea addresses_A+0xff4a, %rdi
clflush (%rdi)
nop
nop
nop
...
{'OP': 'REPM', 'src': {'type': 'addresses_WC', 'congruent': 7, 'same': False}, 'dst': {'type': 'addresses_A', 'congruent': 5, 'same': False}}
...
<gen_prepare_buffer>
{'OP': 'REPM', 'src': {'type': 'addresses_A_ht', 'congruent': 10, 'same': True}, 'dst': {'type': 'addresses_D_ht', 'congruent': 6, 'same': False}}
...
{'OP': 'LOAD', 'src': {'type': 'addresses_WC_ht', 'size': 2, 'AVXalign': True, 'NT': False, 'congruent': 4, 'same': False}}
