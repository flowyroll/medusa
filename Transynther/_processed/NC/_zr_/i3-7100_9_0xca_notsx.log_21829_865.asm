...
push %rdi
push %rsi
lea addresses_D_ht+0x170a9, %r10
nop
sub %rbx, %rbx
movw $0x6162, (%r10)
nop
...
nop
dec %r10
lea addresses_D_ht+0x19209, %rsi
lea addresses_WC_ht+0x3e79, %rdi
nop
nop
nop
nop
...
nop
and %rsi, %rsi
lea addresses_D_ht+0x57c9, %rsi
lea addresses_D_ht+0xe6c9, %rdi
nop
nop
nop
nop
...
nop
sub %r15, %r15
lea addresses_A_ht+0x1d6c9, %r12
nop
and %rbx, %rbx
mov (%r12), %r10w
nop
...
{'src': {'type': 'addresses_D_ht', 'congruent': 6, 'same': True}, 'OP': 'REPM', 'dst': {'type': 'addresses_WC_ht', 'congruent': 3, 'same': False}}
