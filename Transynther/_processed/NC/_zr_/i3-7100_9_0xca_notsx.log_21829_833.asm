...
push %rdi
push %rsi
lea addresses_normal_ht+0x4f3e, %rax
nop
nop
nop
nop
...
movb $0x61, (%rax)
and $37687, %r10
lea addresses_normal_ht+0x5afe, %rsi
lea addresses_UC_ht+0x3e86, %rdi
nop
nop
xor $37722, %rax
mov $68, %rcx
...
nop
xor %r15, %r15
lea addresses_WT_ht+0x1db7e, %rsi
nop
dec %r14
movb $0x61, (%rsi)
nop
...
// Store
lea addresses_normal+0x18b7e, %r12
nop
nop
nop
nop
