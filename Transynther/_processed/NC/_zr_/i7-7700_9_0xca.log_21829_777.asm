...
nop
add $22168, %rdx
lea addresses_UC_ht+0x1d57d, %r15
nop
nop
nop
nop
...
nop
add $52887, %r8
lea addresses_WT_ht+0x106fd, %rsi
clflush (%rsi)
nop
nop
and $24983, %r11
...
nop
dec %rbp
lea addresses_WT_ht+0x1c047, %rdx
nop
nop
add $11847, %rsi
...
// Store
lea addresses_normal+0x1107d, %rbp
sub %r12, %r12
...
{'OP': 'STOR', 'dst': {'congruent': 1, 'AVXalign': True, 'same': False, 'size': 32, 'NT': True, 'type': 'addresses_WT_ht'}}
{'00': 21829}
