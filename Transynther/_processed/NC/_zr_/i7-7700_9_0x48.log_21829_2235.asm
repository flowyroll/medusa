...
nop
and $58738, %r15
lea addresses_WC_ht+0x1b125, %r10
cmp %rcx, %rcx
movb $0x61, (%r10)
nop
inc %r15
lea addresses_WC_ht+0x79a5, %r8
nop
nop
nop
nop
...
nop
add %r8, %r8
lea addresses_A_ht+0xd3a5, %rsi
lea addresses_WT_ht+0x156a5, %rdi
clflush (%rdi)
nop
nop
cmp %r9, %r9
...
nop
cmp $17148, %r15
lea addresses_D_ht+0x37a5, %rdi
nop
and $4852, %r10
mov (%rdi), %si
and $60923, %r10
lea addresses_UC_ht+0x49a5, %rcx
nop
nop
nop
cmp %r8, %r8
...
nop
cmp $59889, %rcx
lea addresses_D_ht+0xd3a5, %rsi
lea addresses_UC_ht+0x11f8d, %rdi
nop
nop
nop
nop
...
nop
inc %rdi
lea addresses_UC_ht+0xce5, %rsi
lea addresses_D_ht+0x2bbd, %rdi
nop
nop
nop
nop
...
lea addresses_D_ht+0x18461, %rdi
nop
and $23337, %r15
mov $13, %rcx
rep movsl
