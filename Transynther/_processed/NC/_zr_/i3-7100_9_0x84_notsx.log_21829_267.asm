...
push %rdi
push %rsi
lea addresses_UC_ht+0x1cd3, %rsi
lea addresses_normal_ht+0x19ed3, %rdi
cmp $58474, %r9
mov $13, %rcx
rep movsw
nop
...
nop
sub $23549, %r11
lea addresses_WT_ht+0x192d3, %rsi
lea addresses_WT_ht+0x1ebf6, %rdi
nop
nop
and %rax, %rax
mov $79, %rcx
...
nop
cmp $48618, %r11
lea addresses_WT_ht+0x1a2d3, %rsi
cmp $60197, %rdi
vmovups (%rsi), %ymm4
...
nop
cmp %rsi, %rsi
lea addresses_WT_ht+0x12193, %rsi
lea addresses_UC_ht+0x16b73, %rdi
nop
nop
nop
sub $5813, %r9
...
nop
inc %r9
lea addresses_WT_ht+0x7d13, %rsi
lea addresses_WC_ht+0x1a58b, %rdi
nop
dec %r10
mov $25, %rcx
rep movsw
