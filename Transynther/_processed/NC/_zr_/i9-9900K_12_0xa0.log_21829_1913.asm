...
push %rdi
push %rsi
lea addresses_UC_ht+0xf253, %rsi
lea addresses_WC_ht+0x3e6d, %rdi
clflush (%rsi)
xor %r11, %r11
mov $98, %rcx
rep movsw
...
nop
sub $52704, %rax
lea addresses_WC_ht+0x197d3, %r15
xor %r8, %r8
movl $0x61626364, (%r15)
nop
nop
nop
cmp %rdi, %rdi
lea addresses_WC_ht+0x16989, %rdi
nop
xor $3632, %r11
mov (%rdi), %ax
nop
nop
sub %rsi, %rsi
lea addresses_WC_ht+0x2513, %rax
clflush (%rax)
nop
nop
and %rdi, %rdi
...
<gen_faulty_load>
[REF]
{'src': {'NT': True, 'same': False, 'congruent': 0, 'type': 'addresses_NC', 'AVXalign': True, 'size': 4}, 'OP': 'LOAD'}
