...
push %rdx
push %rsi
lea addresses_normal_ht+0x1a4b, %rsi
lea addresses_D_ht+0x1df5b, %rdi
nop
nop
nop
nop
...
nop
inc %rdx
lea addresses_UC_ht+0xaa85, %rdi
nop
nop
nop
cmp $31961, %r10
...
lea addresses_UC_ht+0xe95b, %rdi
nop
nop
xor %r10, %r10
mov $43, %rcx
...
nop
and %rdi, %rdi
lea addresses_UC_ht+0x1e55b, %rsi
lea addresses_A_ht+0x1d95b, %rdi
nop
inc %r10
mov $14, %rcx
rep movsq
...
nop
sub $2321, %r10
lea addresses_WC_ht+0x1efdb, %r15
nop
nop
cmp %rsi, %rsi
movb $0x61, (%r15)
add $2626, %r8
lea addresses_UC_ht+0xd55b, %rsi
lea addresses_normal_ht+0x1c95b, %rdi
nop
nop
nop
nop
...
rep movsl
dec %r10
lea addresses_normal_ht+0x6e5b, %rbx
clflush (%rbx)
nop
nop
cmp %rdx, %rdx
...
{'src': {'type': 'addresses_P', 'AVXalign': False, 'size': 4, 'NT': False, 'same': False, 'congruent': 10}, 'OP': 'LOAD'}
...
{'src': {'type': 'addresses_WC_ht', 'congruent': 0, 'same': True}, 'OP': 'REPM', 'dst': {'type': 'addresses_D_ht', 'congruent': 1, 'same': False}}
