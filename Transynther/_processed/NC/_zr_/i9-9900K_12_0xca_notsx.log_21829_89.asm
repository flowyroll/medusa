...
push %rdi
push %rsi
lea addresses_WC_ht+0x1109, %rdi
nop
nop
add %r11, %r11
mov (%rdi), %r13
nop
inc %rdi
lea addresses_WC_ht+0xeb4f, %r13
nop
nop
nop
cmp %rax, %rax
...
nop
inc %rbx
lea addresses_WC_ht+0x12b09, %rsi
add %r11, %r11
movl $0x61626364, (%rsi)
nop
nop
...
nop
sub %rdi, %rdi
lea addresses_normal_ht+0x144ed, %rsi
lea addresses_WC_ht+0x7d09, %rdi
nop
and %rbx, %rbx
mov $112, %rcx
rep movsq
and %rdi, %rdi
lea addresses_A_ht+0x1e509, %r11
clflush (%r11)
dec %rbx
movups (%r11), %xmm4
vpextrq $0, %xmm4, %rsi
...
nop
and $63811, %rbx
lea addresses_UC_ht+0x7269, %rbx
clflush (%rbx)
add %rsi, %rsi
mov (%rbx), %r13w
nop
add $24580, %rsi
lea addresses_normal_ht+0x1c95d, %rsi
lea addresses_normal_ht+0x1f1d, %rdi
clflush (%rdi)
nop
add $50273, %r13
mov $66, %rcx
...
nop
sub $39594, %r13
lea addresses_WC_ht+0x5f09, %rdi
nop
nop
nop
nop
...
nop
cmp $15999, %rdi
lea addresses_WC_ht+0x16c19, %rsi
lea addresses_D_ht+0xce41, %rdi
xor %r10, %r10
mov $45, %rcx
rep movsq
nop
...
nop
and $4638, %r13
lea addresses_A_ht+0x13029, %rsi
lea addresses_WC_ht+0x14151, %rdi
xor %rbx, %rbx
mov $39, %rcx
rep movsb
xor $57346, %rbx
lea addresses_WC_ht+0x15d09, %rbx
nop
nop
nop
add %rcx, %rcx
...
nop
add %r11, %r11
lea addresses_normal_ht+0x118ff, %rsi
lea addresses_A_ht+0x11309, %rdi
nop
nop
nop
nop
...
nop
sub $12482, %rbx
lea addresses_A_ht+0x1be2d, %rax
nop
nop
nop
cmp %r11, %r11
...
vpextrq $0, %xmm6, %r10
add $56809, %rbx
lea addresses_D_ht+0x1055c, %rsi
nop
sub %r13, %r13
...
<gen_prepare_buffer>
{'OP': 'LOAD', 'src': {'same': True, 'type': 'addresses_WC_ht', 'NT': True, 'AVXalign': False, 'size': 8, 'congruent': 10}}
...
{'OP': 'REPM', 'src': {'same': False, 'congruent': 1, 'type': 'addresses_normal_ht'}, 'dst': {'same': False, 'congruent': 7, 'type': 'addresses_A_ht'}}
