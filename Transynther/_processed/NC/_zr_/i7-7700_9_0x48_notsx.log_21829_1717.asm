...
push %rdi
push %rsi
lea addresses_WC_ht+0xa345, %rcx
nop
dec %r15
movb $0x61, (%rcx)
nop
xor $13962, %rcx
lea addresses_WC_ht+0x8b33, %rsi
lea addresses_WT_ht+0xab33, %rdi
clflush (%rdi)
nop
nop
nop
...
nop
and %rdi, %rdi
lea addresses_normal_ht+0x1cc13, %rsi
lea addresses_D_ht+0x3553, %rdi
nop
nop
nop
nop
...
nop
cmp %r15, %r15
lea addresses_WC_ht+0x48ff, %rsi
lea addresses_D_ht+0x2b33, %rdi
nop
and %r15, %r15
mov $13, %rcx
rep movsb
...
nop
sub $8874, %rbp
lea addresses_WC_ht+0xcd23, %r15
nop
nop
nop
nop
...
vmovups %ymm5, (%r15)
add $21759, %rcx
lea addresses_WC_ht+0x9333, %rdi
nop
nop
nop
nop
...
nop
xor $33099, %rsi
lea addresses_WT_ht+0x3533, %rdi
nop
nop
nop
nop
...
nop
sub %rcx, %rcx
lea addresses_A_ht+0x1ea93, %rsi
nop
nop
cmp %r15, %r15
mov (%rsi), %r10
...
{'dst': {'same': False, 'congruent': 9, 'type': 'addresses_WT_ht'}, 'OP': 'REPM', 'src': {'same': False, 'congruent': 9, 'type': 'addresses_WC_ht'}}
{'dst': {'same': False, 'congruent': 4, 'type': 'addresses_D_ht'}, 'OP': 'REPM', 'src': {'same': False, 'congruent': 4, 'type': 'addresses_normal_ht'}}
{'dst': {'same': True, 'congruent': 9, 'type': 'addresses_D_ht'}, 'OP': 'REPM', 'src': {'same': True, 'congruent': 2, 'type': 'addresses_WC_ht'}}
...
{'dst': {'same': False, 'NT': False, 'AVXalign': True, 'size': 1, 'type': 'addresses_WT_ht', 'congruent': 10}, 'OP': 'STOR'}
