...
push %rdx
push %rsi
lea addresses_normal_ht+0xb0d3, %rax
nop
nop
and $15741, %r15
movups (%rax), %xmm0
...
nop
xor $21845, %rdx
lea addresses_A_ht+0x1e0d3, %rsi
lea addresses_A_ht+0x4577, %rdi
cmp $20596, %r15
mov $95, %rcx
rep movsq
nop
...
nop
dec %r10
lea addresses_normal_ht+0xb793, %rdx
nop
nop
nop
xor %r10, %r10
...
nop
xor %r10, %r10
lea addresses_UC_ht+0x80d3, %rcx
nop
nop
nop
nop
...
nop
xor %rdi, %rdi
lea addresses_WT_ht+0x82d3, %rsi
lea addresses_UC_ht+0x124d3, %rdi
clflush (%rsi)
nop
nop
nop
...
nop
sub $52866, %r13
lea addresses_UC_ht+0x168d3, %rsi
lea addresses_D_ht+0x36d3, %rdi
clflush (%rdi)
nop
sub $14859, %rdx
mov $60, %rcx
...
nop
lfence
lea addresses_A_ht+0x129e3, %r10
nop
nop
nop
cmp %rcx, %rcx
...
nop
mfence
lea addresses_UC_ht+0x8b56, %rsi
lea addresses_D_ht+0x10d3, %rdi
clflush (%rsi)
clflush (%rdi)
nop
nop
...
rep movsb
cmp $37784, %rdi
lea addresses_A_ht+0x19463, %rdi
nop
nop
add %r10, %r10
vmovups (%rdi), %ymm1
