...
nop
dec %r12
lea addresses_WC_ht+0x1bf1a, %r13
clflush (%r13)
nop
nop
xor $20208, %r11
...
movups %xmm4, (%r13)
and %r9, %r9
lea addresses_WT_ht+0xcd7a, %rsi
lea addresses_A_ht+0xc01a, %rdi
inc %r10
mov $44, %rcx
rep movsq
nop
...
nop
xor $57367, %rcx
lea addresses_normal_ht+0x13980, %rsi
nop
cmp %rdi, %rdi
mov (%rsi), %r11d
nop
nop
xor %r10, %r10
lea addresses_WT_ht+0x3e1a, %r13
nop
nop
nop
nop
...
nop
xor $60687, %r10
lea addresses_UC_ht+0xf21a, %rsi
lea addresses_UC_ht+0x971a, %rdi
nop
dec %r12
mov $63, %rcx
rep movsw
...
nop
and $55055, %r12
lea addresses_D_ht+0x1b99a, %rsi
lea addresses_WC_ht+0xa65a, %rdi
nop
nop
nop
nop
...
nop
sub $3135, %r11
lea addresses_WC_ht+0x1b2ee, %r10
nop
and $5955, %rcx
movups (%r10), %xmm1
vpextrq $0, %xmm1, %r12
...
nop
sub %r13, %r13
lea addresses_UC_ht+0x196da, %rsi
lea addresses_UC_ht+0x50f8, %rdi
nop
nop
inc %r12
mov $29, %rcx
...
{'OP': 'REPM', 'src': {'type': 'addresses_UC_ht', 'congruent': 8, 'same': False}, 'dst': {'type': 'addresses_UC_ht', 'congruent': 9, 'same': False}}
...
{'OP': 'REPM', 'src': {'type': 'addresses_UC_ht', 'congruent': 3, 'same': True}, 'dst': {'type': 'addresses_UC_ht', 'congruent': 1, 'same': True}}
