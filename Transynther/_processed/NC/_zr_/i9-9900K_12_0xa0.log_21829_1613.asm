...
rep movsw
add $58359, %rcx
lea addresses_WC_ht+0x1c79d, %rdi
nop
nop
nop
nop
...
nop
and $43855, %rcx
lea addresses_UC_ht+0x1225d, %rbp
nop
nop
and %rsi, %rsi
movb $0x61, (%rbp)
...
nop
inc %rsi
lea addresses_UC_ht+0x1af5d, %r9
nop
and %rdi, %rdi
mov (%r9), %bx
nop
...
nop
inc %r13
lea addresses_UC_ht+0x1b0ba, %r9
nop
nop
nop
sub %rdi, %rdi
...
{'src': {'same': False, 'congruent': 9, 'type': 'addresses_WC_ht'}, 'OP': 'REPM', 'dst': {'same': False, 'congruent': 4, 'type': 'addresses_WC_ht'}}
{'OP': 'STOR', 'dst': {'NT': False, 'same': True, 'congruent': 6, 'type': 'addresses_WC_ht', 'AVXalign': False, 'size': 32}}
