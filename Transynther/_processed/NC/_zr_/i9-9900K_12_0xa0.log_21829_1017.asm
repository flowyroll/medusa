...
push %rcx
push %rdx
lea addresses_normal_ht+0x183c8, %rax
nop
nop
nop
nop
...
nop
and $55679, %rax
lea addresses_normal_ht+0x6cc8, %rcx
mfence
mov (%rcx), %edx
nop
nop
nop
cmp $49180, %rax
lea addresses_A_ht+0x1a648, %r15
sub $36925, %rbp
...
nop
inc %r14
lea addresses_normal_ht+0xc4e4, %r13
nop
nop
nop
sub $44138, %r15
...
<gen_prepare_buffer>
{'src': {'NT': False, 'same': True, 'congruent': 8, 'type': 'addresses_normal_ht', 'AVXalign': True, 'size': 8}, 'OP': 'LOAD'}
...
{'src': {'NT': True, 'same': True, 'congruent': 1, 'type': 'addresses_normal_ht', 'AVXalign': True, 'size': 32}, 'OP': 'LOAD'}
{'00': 21829}
