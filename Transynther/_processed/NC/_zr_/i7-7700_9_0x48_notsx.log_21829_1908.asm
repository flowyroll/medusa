...
push %rdi
push %rsi
lea addresses_UC_ht+0xaff, %rsi
lea addresses_WT_ht+0x12cff, %rdi
clflush (%rsi)
nop
nop
xor $13054, %rax
...
nop
cmp $1944, %rdi
lea addresses_normal_ht+0x124ff, %rbx
nop
nop
nop
add $20348, %r13
...
// Store
lea addresses_normal+0x231f, %r13
nop
nop
nop
nop
...
// Store
mov $0x33efea000000037f, %r12
sub $58686, %r15
movl $0x51525354, (%r12)
add $39754, %r12

// Faulty Load
mov $0x4e064d00000004ff, %r12
nop
cmp %rcx, %rcx
mov (%r12), %rdi
lea oracles, %r13
