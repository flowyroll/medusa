...
push %rdi
push %rsi
lea addresses_A_ht+0x13c19, %r15
nop
nop
nop
sub %rax, %rax
...
nop
and $28130, %r9
lea addresses_UC_ht+0x19fe7, %r12
nop
nop
nop
nop
...
nop
xor $28759, %rax
lea addresses_A_ht+0x16d67, %rax
nop
nop
nop
add $2741, %rsi
...
nop
and %rcx, %rcx
lea addresses_WT_ht+0x12d67, %rax
nop
xor $25661, %r9
movb $0x61, (%rax)
nop
...
nop
cmp %rax, %rax
lea addresses_A_ht+0x1760d, %rax
nop
nop
nop
nop
...
nop
and $26776, %r9
lea addresses_normal_ht+0x1ed67, %rbx
nop
nop
add $57111, %r9
mov (%rbx), %esi
...
nop
sub $21382, %rcx
lea addresses_normal_ht+0x8647, %rcx
nop
nop
nop
nop
...
nop
cmp %r15, %r15
lea addresses_D_ht+0x10117, %rsi
lea addresses_D_ht+0x9de7, %rdi
nop
nop
nop
dec %r12
...
nop
xor $49790, %rdi
lea addresses_UC_ht+0x14a67, %rsi
lea addresses_normal_ht+0x1da47, %rdi
nop
nop
nop
nop
...
lea addresses_normal_ht+0x19ee7, %rdi
nop
xor %rbx, %rbx
mov $95, %rcx
rep movsw
nop
add $36999, %r15
lea addresses_WC_ht+0x1e567, %rsi
lea addresses_WC_ht+0xc1b, %rdi
xor $11819, %r15
mov $85, %rcx
rep movsq
nop
...
{'OP': 'LOAD', 'src': {'type': 'addresses_normal_ht', 'size': 4, 'AVXalign': True, 'NT': False, 'congruent': 11, 'same': False}}
{'OP': 'LOAD', 'src': {'type': 'addresses_normal_ht', 'size': 8, 'AVXalign': False, 'NT': True, 'congruent': 5, 'same': False}}
{'OP': 'REPM', 'src': {'type': 'addresses_D_ht', 'congruent': 2, 'same': False}, 'dst': {'type': 'addresses_D_ht', 'congruent': 7, 'same': False}}
{'OP': 'REPM', 'src': {'type': 'addresses_UC_ht', 'congruent': 8, 'same': True}, 'dst': {'type': 'addresses_normal_ht', 'congruent': 5, 'same': True}}
