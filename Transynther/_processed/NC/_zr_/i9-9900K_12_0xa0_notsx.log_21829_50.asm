...
nop
sub %rbx, %rbx
lea addresses_WT_ht+0xca0a, %rsi
lea addresses_UC_ht+0x59b6, %rdi
nop
nop
add %rax, %rax
mov $20, %rcx
...
nop
cmp $3550, %r13
lea addresses_A_ht+0x108b6, %r13
nop
nop
nop
nop
...
nop
cmp $19944, %rdi
lea addresses_A_ht+0x1c476, %rsi
lea addresses_UC_ht+0x133f6, %rdi
nop
nop
nop
nop
...
nop
dec %rcx
lea addresses_WT_ht+0x114b6, %r12
nop
nop
nop
nop
...
nop
and $41608, %r12
lea addresses_WT_ht+0x8a8a, %r13
nop
nop
nop
nop
...
nop
and $52454, %r13
lea addresses_normal_ht+0xe2b6, %rcx
nop
nop
nop
nop
