...
lea addresses_A_ht+0x116cc, %rdi
clflush (%rsi)
xor $39091, %r11
mov $127, %rcx
rep movsl
...
nop
sub %rsi, %rsi
lea addresses_D_ht+0x120cc, %rbp
clflush (%rbp)
nop
nop
nop
...
nop
dec %rax
lea addresses_WT_ht+0x1726e, %rcx
clflush (%rcx)
nop
nop
nop
...
mov (%rcx), %rbp
xor $30935, %rax
lea addresses_D_ht+0x1e890, %rbp
nop
nop
nop
nop
...
nop
cmp %rcx, %rcx
lea addresses_WT_ht+0x1ecc, %rcx
add $8193, %r11
...
<gen_prepare_buffer>
{'OP': 'REPM', 'src': {'type': 'addresses_UC_ht', 'congruent': 4, 'same': False}, 'dst': {'type': 'addresses_UC_ht', 'congruent': 7, 'same': True}}
{'OP': 'REPM', 'src': {'type': 'addresses_UC_ht', 'congruent': 11, 'same': False}, 'dst': {'type': 'addresses_A_ht', 'congruent': 11, 'same': False}}
{'OP': 'STOR', 'dst': {'type': 'addresses_D_ht', 'size': 4, 'AVXalign': True, 'NT': True, 'congruent': 8, 'same': False}}
