...
push %rdx
push %rsi
lea addresses_WC_ht+0x2dc8, %rsi
lea addresses_A_ht+0x29a8, %rdi
clflush (%rsi)
nop
nop
nop
...
nop
add %rbx, %rbx
lea addresses_WC_ht+0xea8, %rdx
nop
nop
and %rbp, %rbp
mov (%rdx), %rax
inc %rax
lea addresses_D_ht+0x86a8, %rdx
nop
nop
nop
nop
...
nop
cmp $33577, %rcx
lea addresses_A_ht+0x18764, %rsi
lea addresses_A_ht+0x4c30, %rdi
nop
sub %r14, %r14
mov $60, %rcx
rep movsl
...
nop
and $26013, %rdi
lea addresses_UC_ht+0xae28, %rbp
nop
nop
nop
dec %rbx
...
nop
dec %rdx
lea addresses_UC_ht+0x17028, %rdi
nop
nop
nop
nop
...
nop
add $54934, %rdx
lea addresses_UC_ht+0x12790, %rcx
mfence
movups (%rcx), %xmm3
vpextrq $1, %xmm3, %rbp
nop
...
// Store
lea addresses_normal+0xcda8, %rbx
nop
nop
nop
cmp %rbp, %rbp
...
// Store
lea addresses_normal+0x1a2b0, %rbx
nop
nop
nop
nop
...
<gen_prepare_buffer>
{'OP': 'REPM', 'src': {'same': False, 'type': 'addresses_WC_ht', 'congruent': 3}, 'dst': {'same': False, 'type': 'addresses_A_ht', 'congruent': 7}}
...
{'OP': 'REPM', 'src': {'same': False, 'type': 'addresses_A_ht', 'congruent': 1}, 'dst': {'same': False, 'type': 'addresses_A_ht', 'congruent': 2}}
