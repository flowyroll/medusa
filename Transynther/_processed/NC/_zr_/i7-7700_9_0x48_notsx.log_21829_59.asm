...
push %rdi
push %rsi
lea addresses_normal_ht+0x107b1, %rsi
lea addresses_UC_ht+0xa411, %rdi
sub %rbp, %rbp
mov $10, %rcx
rep movsl
nop
...
nop
xor %r10, %r10
lea addresses_WC_ht+0x1c631, %rsi
lea addresses_UC_ht+0x7011, %rdi
nop
nop
nop
dec %r11
...
nop
xor $40519, %rcx
lea addresses_D_ht+0xc7c9, %rsi
lea addresses_WT_ht+0x1a029, %rdi
nop
nop
xor $46722, %r9
mov $11, %rcx
rep movsq
dec %r10
lea addresses_normal_ht+0x6521, %rdi
nop
nop
nop
nop
...
nop
add $22111, %r11
lea addresses_WT_ht+0x431, %rsi
lea addresses_WT_ht+0xf225, %rdi
nop
nop
nop
nop
...
nop
dec %r11
lea addresses_A_ht+0xf471, %rsi
lea addresses_WT_ht+0x8c31, %rdi
nop
nop
nop
nop
...
nop
cmp %rdi, %rdi
lea addresses_WC_ht+0x1e3c9, %rbp
nop
xor %r11, %r11
movl $0x61626364, (%rbp)
nop
...
{'dst': {'same': False, 'congruent': 3, 'type': 'addresses_WT_ht'}, 'OP': 'REPM', 'src': {'same': False, 'congruent': 3, 'type': 'addresses_D_ht'}}
