...
push %rdx
push %rsi
lea addresses_A_ht+0x1c286, %rdx
nop
nop
sub %rsi, %rsi
movb $0x61, (%rdx)
...
nop
cmp %r8, %r8
lea addresses_WT_ht+0x3906, %rsi
lea addresses_WT_ht+0x137b2, %rdi
clflush (%rdi)
nop
nop
nop
...
rep movsb
and $6854, %rdi
lea addresses_WC_ht+0x1ce86, %rcx
nop
nop
nop
nop
...
nop
cmp $2348, %rdx
lea addresses_WC_ht+0x4c86, %rsi
lea addresses_A_ht+0xad86, %rdi
nop
nop
and $36359, %rax
mov $34, %rcx
rep movsb
cmp $17661, %rax
lea addresses_WT_ht+0x16846, %rsi
lea addresses_UC_ht+0x5e86, %rdi
nop
nop
nop
nop
...
nop
xor $1103, %rdi
lea addresses_WT_ht+0x7486, %rax
nop
nop
xor %rdx, %rdx
...
nop
lfence
lea addresses_normal_ht+0x51e6, %rsi
lea addresses_A_ht+0x59d6, %rdi
nop
nop
nop
nop
...
nop
add $22703, %rsi
lea addresses_normal_ht+0x11966, %rsi
cmp %r9, %r9
mov (%rsi), %r15
nop
nop
...
nop
inc %r15
lea addresses_A_ht+0x108a6, %rdi
nop
nop
nop
nop
...
nop
xor %rsi, %rsi
lea addresses_WC_ht+0x1148d, %rsi
lea addresses_UC_ht+0x12006, %rdi
clflush (%rsi)
nop
nop
nop
...
nop
add %r8, %r8
lea addresses_A_ht+0xf5e, %rsi
lea addresses_WC_ht+0x93e6, %rdi
add %r9, %r9
mov $117, %rcx
rep movsb
nop
...
nop
add %rax, %rax
lea addresses_normal_ht+0xd25e, %rsi
lea addresses_A_ht+0xc286, %rdi
nop
nop
nop
sub $46074, %r8
...
nop
dec %rdi
lea addresses_WC_ht+0x16846, %r15
clflush (%r15)
sub %rsi, %rsi
movb $0x61, (%r15)
nop
nop
and %rdx, %rdx
lea addresses_UC_ht+0x1d886, %rax
nop
nop
nop
nop
...
{'src': {'type': 'addresses_WT_ht', 'congruent': 6, 'same': False}, 'dst': {'type': 'addresses_WT_ht', 'congruent': 2, 'same': False}, 'OP': 'REPM'}
...
{'src': {'type': 'addresses_normal_ht', 'congruent': 1, 'same': False}, 'dst': {'type': 'addresses_A_ht', 'congruent': 2, 'same': False}, 'OP': 'REPM'}
{'src': {'type': 'addresses_normal_ht', 'same': False, 'size': 8, 'congruent': 4, 'NT': False, 'AVXalign': True}, 'OP': 'LOAD'}
{'src': {'type': 'addresses_A_ht', 'same': False, 'size': 2, 'congruent': 5, 'NT': True, 'AVXalign': False}, 'OP': 'LOAD'}
...
{'src': {'type': 'addresses_normal_ht', 'congruent': 2, 'same': False}, 'dst': {'type': 'addresses_A_ht', 'congruent': 8, 'same': False}, 'OP': 'REPM'}
