...
push %rdi
push %rsi
lea addresses_WC_ht+0x721c, %r13
nop
nop
nop
nop
...
lea addresses_WC_ht+0xc21c, %rdi
nop
nop
and $3726, %r10
mov $13, %rcx
...
lea addresses_A_ht+0x1df1c, %rdi
nop
nop
nop
cmp %r9, %r9
...
rep movsb
xor $43413, %rdi
lea addresses_UC_ht+0x10b5c, %r13
nop
nop
nop
sub $45880, %rcx
...
movups %xmm1, (%r13)
and %r13, %r13
lea addresses_WT_ht+0x9a1c, %rsi
lea addresses_WT_ht+0x6d9c, %rdi
nop
nop
nop
nop
...
nop
cmp %rsi, %rsi
lea addresses_WC_ht+0xfd7c, %rsi
clflush (%rsi)
nop
and $7535, %r13
movw $0x6162, (%rsi)
...
nop
add %rbp, %rbp
lea addresses_A_ht+0xc278, %rsi
lea addresses_WT_ht+0x1e21c, %rdi
nop
nop
nop
mfence
...
nop
lfence
lea addresses_D_ht+0x1da1c, %rbp
nop
nop
nop
nop
...
{'OP': 'REPM', 'src': {'type': 'addresses_WT_ht', 'congruent': 11, 'same': False}, 'dst': {'type': 'addresses_WT_ht', 'congruent': 7, 'same': True}}
{'OP': 'STOR', 'dst': {'type': 'addresses_WC_ht', 'AVXalign': False, 'congruent': 3, 'size': 2, 'same': False, 'NT': False}}
{'OP': 'REPM', 'src': {'type': 'addresses_A_ht', 'congruent': 1, 'same': True}, 'dst': {'type': 'addresses_WT_ht', 'congruent': 4, 'same': False}}
