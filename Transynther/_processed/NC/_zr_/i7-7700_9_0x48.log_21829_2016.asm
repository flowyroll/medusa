...
push %rdi
push %rsi
lea addresses_WT_ht+0x2c4c, %rsi
and $23313, %r11
movb (%rsi), %r8b
nop
nop
nop
xor $14053, %rbp
lea addresses_D_ht+0xac8c, %rsi
lea addresses_UC_ht+0x1588c, %rdi
nop
nop
nop
nop
...
nop
add $54372, %r11
lea addresses_WT_ht+0x5c8c, %rbp
clflush (%rbp)
nop
nop
nop
...
nop
xor %rax, %rax
lea addresses_WT_ht+0x562c, %r11
nop
nop
nop
inc %rdi
...
nop
add $3089, %r11
lea addresses_WC_ht+0x90a8, %rdi
nop
nop
add $65525, %r8
vmovups (%rdi), %ymm3
...
nop
cmp %rax, %rax
lea addresses_UC_ht+0x1115c, %r11
clflush (%r11)
nop
nop
nop
...
nop
add $56514, %rcx
lea addresses_normal_ht+0xb48c, %rbp
nop
nop
dec %rdi
movb (%rbp), %r8b
...
// Store
lea addresses_UC+0x1412, %rax
dec %rbp
movw $0x5152, (%rax)
and %r14, %r14

// Store
lea addresses_RW+0x160c, %r9
nop
and %rdi, %rdi
movb $0x51, (%r9)
nop
...
{'OP': 'STOR', 'dst': {'type': 'addresses_A', 'AVXalign': False, 'congruent': 1, 'size': 1, 'same': False, 'NT': True}}
...
{'OP': 'STOR', 'dst': {'type': 'addresses_US', 'AVXalign': False, 'congruent': 2, 'size': 2, 'same': False, 'NT': True}}
{'OP': 'STOR', 'dst': {'type': 'addresses_UC', 'AVXalign': False, 'congruent': 1, 'size': 2, 'same': False, 'NT': False}}
[Faulty Load]
{'OP': 'LOAD', 'src': {'type': 'addresses_NC', 'AVXalign': False, 'congruent': 0, 'size': 4, 'same': True, 'NT': False}}
<gen_prepare_buffer>
{'OP': 'LOAD', 'src': {'type': 'addresses_WT_ht', 'AVXalign': True, 'congruent': 4, 'size': 1, 'same': False, 'NT': False}}
...
{'OP': 'STOR', 'dst': {'type': 'addresses_UC_ht', 'AVXalign': False, 'congruent': 4, 'size': 4, 'same': False, 'NT': True}}
