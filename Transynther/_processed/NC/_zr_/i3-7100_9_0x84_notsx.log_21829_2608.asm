...
push %rdi
push %rsi
lea addresses_WT_ht+0xe06e, %r13
nop
nop
nop
nop
...
nop
xor $44215, %r8
lea addresses_D_ht+0x3054, %rsi
and %rbp, %rbp
movb $0x61, (%rsi)
cmp $23012, %r8
lea addresses_normal_ht+0x80c2, %r10
nop
nop
nop
xor %rdi, %rdi
...
nop
dec %r8
lea addresses_normal_ht+0xbf72, %rsi
lea addresses_A_ht+0x4a42, %rdi
nop
nop
nop
nop
...
nop
lfence
lea addresses_D_ht+0x10b52, %r13
nop
cmp %r8, %r8
...
{'dst': {'type': 'addresses_RW', 'same': False, 'size': 16, 'congruent': 1, 'NT': False, 'AVXalign': True}, 'OP': 'STOR'}
[Faulty Load]
