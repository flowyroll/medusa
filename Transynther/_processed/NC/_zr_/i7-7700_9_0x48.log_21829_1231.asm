...
nop
and $5714, %rcx
lea addresses_UC_ht+0xc78c, %r10
nop
nop
nop
inc %rsi
...
nop
cmp $29553, %rsi
lea addresses_UC_ht+0x1b9ec, %r15
nop
nop
nop
nop
...
nop
xor $19326, %r10
lea addresses_WT_ht+0x3bfc, %rax
nop
nop
nop
dec %r9
...
movntdq %xmm0, (%rax)
sub %r15, %r15
lea addresses_WC_ht+0x1b3fc, %r10
add %rsi, %rsi
mov (%r10), %r15w
nop
nop
nop
add $1969, %r9
lea addresses_WT_ht+0xe1fa, %rsi
lea addresses_D_ht+0x165fc, %rdi
nop
cmp $57881, %r15
mov $44, %rcx
rep movsl
nop
and $434, %r15
lea addresses_D_ht+0x1065c, %rcx
nop
add %rax, %rax
mov (%rcx), %r15d
nop
...
nop
xor %rcx, %rcx
lea addresses_D_ht+0x19b3c, %rcx
nop
cmp %r15, %r15
movl $0x61626364, (%rcx)
nop
nop
inc %rdx
lea addresses_WT_ht+0x12efc, %rsi
lea addresses_WC_ht+0x1be44, %rdi
nop
nop
sub %rax, %rax
mov $27, %rcx
...
{'OP': 'STOR', 'dst': {'type': 'addresses_WT_ht', 'AVXalign': False, 'congruent': 11, 'size': 16, 'same': False, 'NT': True}}
{'OP': 'LOAD', 'src': {'type': 'addresses_WC_ht', 'AVXalign': True, 'congruent': 11, 'size': 2, 'same': False, 'NT': False}}
