...
push %rdi
push %rsi
lea addresses_WT_ht+0x14366, %r13
cmp $36208, %r9
movups (%r13), %xmm2
vpextrq $1, %xmm2, %rsi
cmp %r12, %r12
lea addresses_UC_ht+0x1c16a, %rcx
nop
dec %r12
mov (%rcx), %r14w
nop
...
nop
sub $25122, %r14
lea addresses_D_ht+0x745a, %r9
cmp %r11, %r11
vmovups (%r9), %ymm2
vextracti128 $1, %ymm2, %xmm2
vpextrq $1, %xmm2, %r14
and $15087, %r11
lea addresses_WT_ht+0x1af9a, %r13
clflush (%r13)
cmp %rsi, %rsi
...
nop
sub $33000, %rsi
lea addresses_D_ht+0x19e22, %r9
nop
and $61750, %r11
movb (%r9), %cl
nop
add %r13, %r13
lea addresses_WT_ht+0xbe62, %rsi
...
{'OP': 'STOR', 'dst': {'NT': False, 'same': False, 'congruent': 3, 'type': 'addresses_WT_ht', 'AVXalign': True, 'size': 32}}
