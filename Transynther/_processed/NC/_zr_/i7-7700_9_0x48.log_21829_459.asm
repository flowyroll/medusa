...
push %rdx
push %rsi
lea addresses_WT_ht+0x1658b, %r11
nop
inc %r13
movw $0x6162, (%r11)
nop
...
nop
dec %r13
lea addresses_D_ht+0x14443, %rsi
xor %rbx, %rbx
movw $0x6162, (%rsi)
nop
and $7410, %r13
lea addresses_WC_ht+0x130cb, %rsi
lea addresses_A_ht+0xc603, %rdi
nop
nop
nop
nop
...
nop
and %rdi, %rdi
lea addresses_normal_ht+0x13f29, %rsi
lea addresses_normal_ht+0xdca3, %rdi
nop
nop
cmp %rbx, %rbx
mov $125, %rcx
rep movsb
xor %rdx, %rdx
lea addresses_WC_ht+0xb643, %rbp
nop
nop
nop
cmp %r11, %r11
...
nop
cmp $32224, %r11
lea addresses_UC_ht+0x8e43, %rsi
lea addresses_D_ht+0xf4c3, %rdi
nop
add $56090, %r11
mov $51, %rcx
rep movsl
...
nop
cmp $57188, %rdx
lea addresses_D_ht+0x1e843, %rbx
nop
nop
nop
nop
...
{'OP': 'STOR', 'dst': {'type': 'addresses_D_ht', 'AVXalign': False, 'congruent': 10, 'size': 2, 'same': True, 'NT': False}}
