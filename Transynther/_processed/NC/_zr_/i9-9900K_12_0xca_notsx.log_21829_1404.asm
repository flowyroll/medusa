...
push %rdi
push %rdx
lea addresses_WT_ht+0x1be3a, %rdx
add $63233, %rdi
movb (%rdx), %r9b
nop
xor $65314, %rcx
lea addresses_WT_ht+0x16177, %rbx
add $17087, %r10
movw $0x6162, (%rbx)
nop
nop
cmp %r10, %r10
lea addresses_UC_ht+0x13c3a, %rcx
nop
nop
nop
nop
...
nop
add $64572, %rdi
lea addresses_WT_ht+0x1b0fa, %rbx
xor %rdi, %rdi
movl $0x61626364, (%rbx)
nop
nop
...
nop
sub %rdi, %rdi
lea addresses_UC_ht+0x1603a, %rdx
nop
sub %r12, %r12
movups (%rdx), %xmm1
vpextrq $1, %xmm1, %rcx
nop
and %rbx, %rbx
lea addresses_A_ht+0x1ee3a, %rdx
nop
nop
inc %rcx
mov (%rdx), %r10d
...
{'OP': 'LOAD', 'src': {'same': False, 'type': 'addresses_UC_ht', 'NT': True, 'AVXalign': False, 'size': 32, 'congruent': 1}}
