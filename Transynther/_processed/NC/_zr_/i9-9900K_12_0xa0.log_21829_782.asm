...
push %rdi
push %rsi
lea addresses_WT_ht+0x3cd5, %rsi
lea addresses_WT_ht+0x199ad, %rdi
add %r13, %r13
mov $108, %rcx
rep movsq
nop
sub $29484, %rbp
lea addresses_normal_ht+0x1738d, %rsi
lea addresses_D_ht+0x18a8d, %rdi
add $60069, %rbx
mov $88, %rcx
rep movsw
nop
...
nop
cmp %rdi, %rdi
lea addresses_WC_ht+0x17d8d, %rdi
add %rsi, %rsi
...
nop
and %rcx, %rcx
lea addresses_UC_ht+0x958d, %rsi
nop
nop
nop
nop
...
nop
and %rbx, %rbx
lea addresses_WT_ht+0x2331, %rsi
and $55783, %rax
...
nop
sub $51665, %rcx
lea addresses_D_ht+0x3b4d, %rsi
lea addresses_A_ht+0x13452, %rdi
nop
inc %rax
mov $116, %rcx
rep movsq
...
nop
cmp $16886, %r13
lea addresses_WC_ht+0x5f8d, %rdi
nop
nop
nop
nop
...
lea addresses_UC_ht+0xf64d, %rdi
nop
nop
nop
sub $9298, %r10
...
nop
add %r10, %r10
lea addresses_A_ht+0x17e0d, %rbp
nop
nop
nop
nop
...
<gen_prepare_buffer>
{'src': {'same': False, 'congruent': 3, 'type': 'addresses_WT_ht'}, 'OP': 'REPM', 'dst': {'same': False, 'congruent': 5, 'type': 'addresses_WT_ht'}}
{'src': {'same': True, 'congruent': 9, 'type': 'addresses_normal_ht'}, 'OP': 'REPM', 'dst': {'same': True, 'congruent': 8, 'type': 'addresses_D_ht'}}
...
{'OP': 'STOR', 'dst': {'NT': False, 'same': False, 'congruent': 6, 'type': 'addresses_D_ht', 'AVXalign': True, 'size': 4}}
{'00': 21829}
