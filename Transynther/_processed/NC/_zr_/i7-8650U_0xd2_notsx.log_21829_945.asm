...
push %rbx
push %rcx
lea addresses_WC_ht+0x13163, %r9
nop
nop
and %r12, %r12
vmovups (%r9), %ymm5
...
vpextrq $1, %xmm5, %rcx
dec %rbx
lea addresses_UC_ht+0x106d3, %rax
nop
nop
nop
nop
...
nop
and %r9, %r9
lea addresses_UC_ht+0x195d3, %rax
nop
lfence
mov (%rax), %bx
nop
...
// Store
lea addresses_normal+0xa6eb, %r10
nop
nop
xor %rsi, %rsi
...
{'OP': 'STOR', 'dst': {'type': 'addresses_A', 'size': 4, 'AVXalign': True, 'NT': False, 'congruent': 0, 'same': False}}
