...
nop
xor %r14, %r14
lea addresses_A_ht+0xcd26, %rsi
lea addresses_normal_ht+0x162a6, %rdi
nop
cmp %r10, %r10
mov $0, %rcx
rep movsl
and %r10, %r10
lea addresses_UC_ht+0x1da6, %rsi
lea addresses_WC_ht+0x10466, %rdi
nop
nop
xor $42974, %r9
mov $46, %rcx
...
nop
cmp $6306, %rdi
lea addresses_A_ht+0x14adb, %rbx
nop
nop
nop
nop
...
nop
inc %rdi
lea addresses_WC_ht+0xdbe6, %rsi
nop
nop
nop
nop
...
nop
add $28930, %rsi
lea addresses_WT_ht+0xcb66, %rbx
nop
nop
and %rdi, %rdi
...
nop
and $44636, %rbx
lea addresses_UC_ht+0x15c1, %rsi
lea addresses_D_ht+0x170a6, %rdi
nop
nop
add $25025, %rdx
mov $49, %rcx
...
nop
add %rdi, %rdi
lea addresses_normal_ht+0xd026, %rsi
nop
nop
nop
nop
...
nop
sub %rdi, %rdi
lea addresses_normal_ht+0x60a6, %rdx
nop
add $58396, %r14
movl $0x61626364, (%rdx)
nop
sub $721, %rdi
lea addresses_WT_ht+0x14446, %r9
nop
nop
nop
xor $59618, %rsi
...
mov (%r9), %r14w
cmp %r9, %r9
lea addresses_normal_ht+0x1c406, %rcx
nop
nop
nop
and %rsi, %rsi
...
nop
and %r10, %r10
lea addresses_normal_ht+0x196a6, %rbx
add $36156, %rsi
...
nop
dec %r10
lea addresses_A_ht+0x1cc2a, %rdi
nop
add $63034, %r9
movb (%rdi), %cl
nop
...
nop
and $58887, %rbx
lea addresses_normal_ht+0x1bcac, %r10
nop
nop
nop
nop
...
<gen_prepare_buffer>
{'src': {'congruent': 7, 'same': False, 'type': 'addresses_WC_ht'}, 'OP': 'REPM', 'dst': {'congruent': 4, 'same': False, 'type': 'addresses_normal_ht'}}
...
{'OP': 'STOR', 'dst': {'congruent': 0, 'AVXalign': True, 'same': False, 'size': 4, 'NT': False, 'type': 'addresses_A_ht'}}
...
{'src': {'congruent': 0, 'same': True, 'type': 'addresses_UC_ht'}, 'OP': 'REPM', 'dst': {'congruent': 9, 'same': False, 'type': 'addresses_D_ht'}}
{'src': {'congruent': 7, 'AVXalign': False, 'same': False, 'size': 4, 'NT': True, 'type': 'addresses_normal_ht'}, 'OP': 'LOAD'}
...
{'OP': 'STOR', 'dst': {'congruent': 5, 'AVXalign': True, 'same': False, 'size': 32, 'NT': False, 'type': 'addresses_normal_ht'}}
