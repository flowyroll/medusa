...
lea addresses_WC_ht+0x1c4a3, %rdi
nop
nop
and %r15, %r15
mov $28, %rcx
...
nop
dec %rax
lea addresses_UC_ht+0x1c2a3, %rbp
nop
nop
nop
sub $59561, %r10
...
nop
inc %rax
lea addresses_A_ht+0x26a3, %rsi
lea addresses_WC_ht+0x131a3, %rdi
clflush (%rsi)
nop
nop
nop
...
nop
xor %rsi, %rsi
lea addresses_D_ht+0x774b, %rsi
lea addresses_WC_ht+0x17d0d, %rdi
sub %r13, %r13
mov $111, %rcx
rep movsq
nop
sub $11775, %rdi
lea addresses_normal_ht+0x1747f, %r13
nop
nop
nop
nop
...
{'OP': 'REPM', 'src': {'type': 'addresses_A_ht', 'congruent': 10, 'same': False}, 'dst': {'type': 'addresses_WC_ht', 'congruent': 7, 'same': False}}
