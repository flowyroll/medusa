...
nop
cmp $18892, %r12
lea addresses_A_ht+0xb774, %rsi
lea addresses_D_ht+0x1374, %rdi
cmp $44966, %r12
mov $14, %rcx
rep movsb
nop
...
nop
cmp %rdi, %rdi
lea addresses_normal_ht+0xc4b4, %rbp
nop
sub %r8, %r8
...
rep movsl
xor $20467, %rdi
lea addresses_UC_ht+0x44ec, %rsi
lea addresses_normal_ht+0x1b574, %rdi
nop
nop
nop
nop
...
nop
sub $25971, %r14
lea addresses_WC_ht+0xff74, %rcx
nop
nop
nop
nop
...
nop
cmp $27192, %rdi
lea addresses_A_ht+0x13574, %r14
nop
nop
nop
inc %rcx
...
vpextrq $1, %xmm0, %r12
and $2349, %r10
lea addresses_normal_ht+0xdb4, %rsi
lea addresses_WC_ht+0x2eb4, %rdi
nop
sub $64964, %r12
mov $63, %rcx
rep movsl
...
nop
xor %r12, %r12
lea addresses_WT_ht+0x193d4, %rbp
nop
nop
nop
sub %rcx, %rcx
...
{'OP': 'REPM', 'src': {'type': 'addresses_D_ht', 'congruent': 10, 'same': False}, 'dst': {'type': 'addresses_UC_ht', 'congruent': 6, 'same': False}}
