...
push %rdi
push %rsi
lea addresses_WT_ht+0x1b862, %rsi
lea addresses_normal_ht+0xb62, %rdi
clflush (%rsi)
nop
nop
nop
...
nop
sub $50594, %r8
lea addresses_normal_ht+0x16262, %r8
nop
nop
nop
nop
...
nop
cmp $61544, %r8
lea addresses_UC_ht+0xf4e2, %rbp
add $19398, %r14
movb (%rbp), %r13b
nop
nop
nop
and %rsi, %rsi
lea addresses_UC_ht+0x85ce, %rcx
nop
nop
nop
add $24978, %r8
...
nop
add %rbp, %rbp
lea addresses_WC_ht+0x2c22, %rsi
lea addresses_UC_ht+0x19262, %rdi
clflush (%rdi)
add $5398, %r9
mov $99, %rcx
rep movsl
...
lea addresses_WC_ht+0xaae2, %rdi
nop
nop
add $32087, %r9
mov $124, %rcx
...
nop
and %rdi, %rdi
lea addresses_A_ht+0x16e62, %rsi
nop
nop
sub $4085, %r13
...
nop
inc %r13
lea addresses_UC_ht+0x1c822, %rdi
nop
nop
nop
nop
...
nop
and $22102, %rdi
lea addresses_WT_ht+0xf032, %rsi
clflush (%rsi)
nop
nop
nop
...
nop
cmp $37371, %r9
lea addresses_normal_ht+0x18c42, %r9
nop
nop
nop
nop
...
// Store
lea addresses_normal+0x10a82, %rdx
cmp %rax, %rax
...
// Store
lea addresses_normal+0x43a2, %rsi
nop
nop
nop
nop
...
<gen_prepare_buffer>
{'OP': 'REPM', 'src': {'same': False, 'congruent': 8, 'type': 'addresses_WT_ht'}, 'dst': {'same': True, 'congruent': 8, 'type': 'addresses_normal_ht'}}
...
{'OP': 'REPM', 'src': {'same': False, 'congruent': 11, 'type': 'addresses_normal_ht'}, 'dst': {'same': True, 'congruent': 7, 'type': 'addresses_WC_ht'}}
...
{'OP': 'LOAD', 'src': {'same': False, 'type': 'addresses_UC_ht', 'NT': True, 'AVXalign': True, 'size': 32, 'congruent': 6}}
{'OP': 'LOAD', 'src': {'same': False, 'type': 'addresses_UC_ht', 'NT': True, 'AVXalign': True, 'size': 32, 'congruent': 0}}
{'OP': 'LOAD', 'src': {'same': True, 'type': 'addresses_normal_ht', 'NT': False, 'AVXalign': False, 'size': 8, 'congruent': 5}}
{'00': 21829}
