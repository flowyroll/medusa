...
nop
add $17001, %rcx
lea addresses_UC_ht+0x18a7d, %rsi
lea addresses_D_ht+0xa415, %rdi
nop
nop
nop
add %r14, %r14
...
nop
add $2974, %rdi
lea addresses_UC_ht+0x18c55, %rcx
nop
nop
nop
nop
...
nop
inc %rax
lea addresses_A_ht+0x16a3d, %r10
nop
nop
nop
nop
...
nop
sub $18854, %rsi
lea addresses_normal_ht+0xcbbd, %rcx
nop
nop
nop
add $6775, %rbx
...
nop
add %rdi, %rdi
lea addresses_normal_ht+0x73f5, %rsi
...
nop
inc %rdi
lea addresses_WT_ht+0x9a3d, %rax
sub $29859, %rbx
mov (%rax), %cx
nop
nop
nop
xor %r14, %r14
lea addresses_A_ht+0x1bd1d, %rsi
lea addresses_WT_ht+0x1de3d, %rdi
nop
nop
nop
inc %r15
...
rep movsw
add $12355, %rsi
lea addresses_A_ht+0x1023d, %rsi
lea addresses_A_ht+0x22d7, %rdi
clflush (%rsi)
nop
nop
cmp $29038, %rbx
...
<gen_prepare_buffer>
{'src': {'type': 'addresses_WC_ht', 'congruent': 0, 'same': False}, 'dst': {'type': 'addresses_WC_ht', 'congruent': 11, 'same': False}, 'OP': 'REPM'}
{'src': {'type': 'addresses_A_ht', 'same': True, 'size': 8, 'congruent': 8, 'NT': False, 'AVXalign': False}, 'OP': 'LOAD'}
{'src': {'type': 'addresses_UC_ht', 'congruent': 6, 'same': False}, 'dst': {'type': 'addresses_D_ht', 'congruent': 3, 'same': False}, 'OP': 'REPM'}
