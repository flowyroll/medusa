...
nop
dec %r11
lea addresses_A_ht+0x1b941, %r14
nop
nop
nop
nop
...
nop
xor $65152, %rsi
lea addresses_WT_ht+0x11901, %rdi
nop
nop
cmp $17240, %rax
movl $0x61626364, (%rdi)
...
{'OP': 'LOAD', 'src': {'same': False, 'type': 'addresses_A_ht', 'NT': False, 'AVXalign': True, 'size': 8, 'congruent': 2}}
