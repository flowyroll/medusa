...
nop
cmp $55587, %rbx
lea addresses_A_ht+0x4830, %rsi
lea addresses_UC_ht+0x1ea7e, %rdi
sub %rbx, %rbx
mov $31, %rcx
rep movsw
nop
...
nop
sub $27075, %rsi
lea addresses_A_ht+0x137be, %r14
nop
nop
nop
nop
...
nop
sub $25914, %r14
lea addresses_WC_ht+0x16e8a, %rsi
lea addresses_D_ht+0x129be, %rdi
nop
cmp %r9, %r9
mov $121, %rcx
rep movsl
...
nop
dec %r14
lea addresses_WC_ht+0x127be, %rsi
...
nop
and %r15, %r15
lea addresses_D_ht+0x18906, %r15
nop
and $13142, %r12
movups (%r15), %xmm2
vpextrq $0, %xmm2, %rdi
...
{'OP': 'REPM', 'src': {'same': False, 'congruent': 0, 'type': 'addresses_A_ht'}, 'dst': {'same': False, 'congruent': 6, 'type': 'addresses_UC_ht'}}
...
{'OP': 'REPM', 'src': {'same': False, 'congruent': 9, 'type': 'addresses_WC_ht'}, 'dst': {'same': False, 'congruent': 1, 'type': 'addresses_WT_ht'}}
