...
nop
add $41725, %rsi
lea addresses_D_ht+0x1dff1, %rsi
lea addresses_D_ht+0x18808, %rdi
nop
nop
nop
nop
...
nop
xor %r10, %r10
lea addresses_D_ht+0x17408, %rbp
nop
xor $57582, %r11
mov (%rbp), %esi
add $32379, %r10
lea addresses_A_ht+0xbe88, %r11
nop
nop
nop
nop
...
nop
cmp $13660, %rsi
lea addresses_normal_ht+0x1d008, %rsi
lea addresses_WT_ht+0x7608, %rdi
clflush (%rdi)
nop
nop
nop
...
rep movsb
inc %rdi
lea addresses_UC_ht+0x6008, %rcx
nop
nop
sub $41479, %rbp
movb $0x61, (%rcx)
sub %rdi, %rdi
lea addresses_D_ht+0x1b538, %r10
nop
nop
nop
cmp $12718, %rdx
...
nop
add $41879, %r11
lea addresses_D_ht+0x6ca8, %rdx
inc %rsi
movl $0x61626364, (%rdx)
nop
sub %r10, %r10
lea addresses_UC_ht+0x4648, %rsi
lea addresses_A_ht+0xe8a8, %rdi
nop
nop
nop
and $48076, %r9
...
// REPMOV
lea addresses_PSE+0xc2b7, %rsi
lea addresses_RW+0xf5c4, %rdi
nop
nop
nop
nop
...
{'OP': 'REPM', 'src': {'type': 'addresses_PSE', 'congruent': 0, 'same': False}, 'dst': {'type': 'addresses_RW', 'congruent': 0, 'same': False}}
[Faulty Load]
{'OP': 'LOAD', 'src': {'type': 'addresses_NC', 'size': 4, 'AVXalign': False, 'NT': False, 'congruent': 0, 'same': True}}
<gen_prepare_buffer>
{'OP': 'REPM', 'src': {'type': 'addresses_UC_ht', 'congruent': 3, 'same': True}, 'dst': {'type': 'addresses_WC_ht', 'congruent': 10, 'same': False}}
...
{'OP': 'LOAD', 'src': {'type': 'addresses_A_ht', 'size': 8, 'AVXalign': False, 'NT': True, 'congruent': 7, 'same': False}}
{'OP': 'REPM', 'src': {'type': 'addresses_normal_ht', 'congruent': 8, 'same': True}, 'dst': {'type': 'addresses_WT_ht', 'congruent': 8, 'same': False}}
