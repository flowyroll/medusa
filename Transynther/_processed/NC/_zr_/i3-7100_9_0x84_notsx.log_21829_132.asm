...
push %rdi
push %rsi
lea addresses_normal_ht+0x10c65, %rsi
...
nop
add %r11, %r11
lea addresses_WC_ht+0x7825, %rsi
lea addresses_UC_ht+0x9225, %rdi
nop
nop
xor $14106, %r8
mov $64, %rcx
...
nop
and $32127, %r11
lea addresses_normal_ht+0x1bf25, %r15
and %rdi, %rdi
movb (%r15), %r11b
nop
nop
dec %rcx
lea addresses_UC_ht+0x16dc1, %rsi
nop
dec %rbx
...
nop
xor %r8, %r8
lea addresses_UC_ht+0xda5, %rsi
lea addresses_normal_ht+0x1ce25, %rdi
nop
cmp $35880, %r8
mov $12, %rcx
rep movsl
...
nop
dec %rdi
lea addresses_WC_ht+0x7865, %r15
nop
nop
nop
nop
...
nop
add %r11, %r11
lea addresses_A_ht+0x13025, %rsi
lea addresses_UC_ht+0x18eea, %rdi
nop
sub %r13, %r13
mov $80, %rcx
rep movsw
...
nop
and $27180, %r11
lea addresses_A_ht+0x1b0e5, %r13
dec %rbx
mov (%r13), %r8w
nop
nop
...
{'src': {'type': 'addresses_UC_ht', 'congruent': 7, 'same': False}, 'dst': {'type': 'addresses_normal_ht', 'congruent': 9, 'same': False}, 'OP': 'REPM'}
{'dst': {'type': 'addresses_WC_ht', 'same': False, 'size': 2, 'congruent': 5, 'NT': False, 'AVXalign': False}, 'OP': 'STOR'}
{'src': {'type': 'addresses_A_ht', 'congruent': 9, 'same': False}, 'dst': {'type': 'addresses_UC_ht', 'congruent': 0, 'same': True}, 'OP': 'REPM'}
