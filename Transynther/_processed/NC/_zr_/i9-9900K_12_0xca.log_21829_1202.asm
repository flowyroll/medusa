...
push %rbp
push %rbx
lea addresses_normal_ht+0xb27c, %r8
cmp %r10, %r10
movw $0x6162, (%r8)
nop
nop
...
nop
cmp %rbp, %rbp
lea addresses_UC_ht+0x7d7c, %rax
nop
nop
cmp $24205, %r10
movl $0x61626364, (%rax)
...
nop
xor $705, %r10
lea addresses_WT_ht+0x1e67c, %rax
nop
nop
nop
xor %rbx, %rbx
...
nop
xor $52082, %r10
lea addresses_D_ht+0x1797c, %rbp
nop
nop
nop
add %r8, %r8
...
nop
and $26941, %rbx
lea addresses_A_ht+0x1c77c, %rbp
nop
nop
inc %r11
movw $0x6162, (%rbp)
xor $49702, %rbx
lea addresses_normal_ht+0x14bc, %r11
nop
nop
inc %r13
movw $0x6162, (%r11)
cmp $20985, %r11
lea addresses_A_ht+0x7b1c, %r11
nop
cmp %r8, %r8
vmovups (%r11), %ymm5
