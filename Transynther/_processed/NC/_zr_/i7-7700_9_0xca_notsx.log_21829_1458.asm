...
push %rdx
push %rsi
lea addresses_D_ht+0xf41d, %rsi
lea addresses_D_ht+0x453d, %rdi
clflush (%rdi)
nop
nop
nop
...
nop
cmp $28186, %rdi
lea addresses_normal_ht+0x118e5, %rsi
nop
dec %rdx
movups (%rsi), %xmm0
vpextrq $1, %xmm0, %r11
...
nop
cmp $11250, %rcx
lea addresses_A_ht+0x160a5, %rsi
lea addresses_WC_ht+0xd53d, %rdi
nop
nop
nop
nop
...
nop
sub %rdi, %rdi
lea addresses_normal_ht+0xb3d, %rdx
nop
nop
nop
nop
...
nop
add $4745, %rdi
lea addresses_normal_ht+0x1693d, %rdx
nop
nop
nop
inc %rbx
...
movq %rsi, (%rdx)
sub $62164, %rdx
lea addresses_WC_ht+0x255d, %rbx
nop
nop
nop
nop
...
{'src': {'congruent': 1, 'same': False, 'type': 'addresses_A_ht'}, 'dst': {'congruent': 7, 'same': False, 'type': 'addresses_WC_ht'}, 'OP': 'REPM'}
