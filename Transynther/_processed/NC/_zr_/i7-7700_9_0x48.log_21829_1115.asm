...
nop
dec %r8
lea addresses_normal_ht+0x1e9a6, %rsi
lea addresses_WT_ht+0x1c59, %rdi
nop
nop
nop
nop
...
rep movsw
xor %rbp, %rbp
lea addresses_UC_ht+0x18ba, %r15
nop
nop
nop
add $8638, %rsi
...
nop
dec %r13
lea addresses_WC_ht+0xe1de, %rcx
and $38823, %r13
...
nop
sub $39795, %rsi
lea addresses_WT_ht+0x7666, %r13
nop
and $62556, %rdi
movl $0x61626364, (%r13)
nop
nop
and %rcx, %rcx
lea addresses_UC_ht+0xb7f6, %r12
nop
nop
cmp $11477, %r13
...
nop
sub %r15, %r15
lea addresses_normal_ht+0x1215e, %rsi
lea addresses_WC_ht+0x34de, %rdi
nop
nop
nop
nop
...
nop
and %rsi, %rsi
lea addresses_normal_ht+0xd86, %r15
nop
nop
nop
nop
...
movb (%r15), %r8b
and %rsi, %rsi
lea addresses_normal_ht+0x5cde, %rsi
lea addresses_UC_ht+0xbcfe, %rdi
nop
nop
nop
dec %rbp
...
nop
sub %rcx, %rcx
lea addresses_UC_ht+0x2cde, %rcx
nop
nop
nop
nop
...
nop
sub $60228, %r15
lea addresses_WT_ht+0xdcde, %rsi
clflush (%rsi)
add %rdi, %rdi
vmovups (%rsi), %ymm4
...
<gen_prepare_buffer>
{'OP': 'STOR', 'dst': {'type': 'addresses_WC_ht', 'AVXalign': False, 'congruent': 1, 'size': 2, 'same': True, 'NT': False}}
...
{'OP': 'REPM', 'src': {'type': 'addresses_normal_ht', 'congruent': 7, 'same': True}, 'dst': {'type': 'addresses_WC_ht', 'congruent': 9, 'same': False}}
{'OP': 'LOAD', 'src': {'type': 'addresses_normal_ht', 'AVXalign': True, 'congruent': 2, 'size': 1, 'same': False, 'NT': False}}
{'OP': 'REPM', 'src': {'type': 'addresses_normal_ht', 'congruent': 6, 'same': False}, 'dst': {'type': 'addresses_UC_ht', 'congruent': 3, 'same': True}}
