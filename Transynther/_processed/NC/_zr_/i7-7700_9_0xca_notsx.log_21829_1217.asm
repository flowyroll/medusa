...
push %rdi
push %rsi
lea addresses_A_ht+0x154c4, %rsi
lea addresses_WT_ht+0x9bc4, %rdi
nop
nop
xor %r9, %r9
mov $5, %rcx
...
nop
add $52756, %r10
lea addresses_normal_ht+0xea65, %r9
nop
nop
nop
cmp %rbp, %rbp
...
movq %rcx, (%r9)
lfence
lea addresses_WT_ht+0x5c4, %rdi
clflush (%rdi)
nop
xor $55714, %r13
movb $0x61, (%rdi)
add $14015, %rdi
lea addresses_D_ht+0x33b8, %rcx
dec %r10
movw $0x6162, (%rcx)
nop
nop
...
// REPMOV
lea addresses_normal+0x1a9c4, %rsi
lea addresses_PSE+0x2dc4, %rdi
nop
nop
nop
and %r10, %r10
...
{'src': {'congruent': 9, 'same': False, 'type': 'addresses_normal'}, 'dst': {'congruent': 4, 'same': False, 'type': 'addresses_PSE'}, 'OP': 'REPM'}
{'src': {'NT': True, 'AVXalign': False, 'size': 4, 'congruent': 4, 'same': False, 'type': 'addresses_US'}, 'OP': 'LOAD'}
[Faulty Load]
