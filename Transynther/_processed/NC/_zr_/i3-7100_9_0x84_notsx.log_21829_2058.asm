...
push %rdx
push %rsi
lea addresses_WT_ht+0x17a4d, %rsi
lea addresses_normal_ht+0x1b24d, %rdi
nop
nop
nop
nop
...
nop
and %rdx, %rdx
lea addresses_A_ht+0x1452d, %rsi
...
nop
xor $49459, %rdx
lea addresses_normal_ht+0x1a24d, %rbp
xor %r11, %r11
movb $0x61, (%rbp)
nop
nop
nop
dec %rsi
lea addresses_WT_ht+0x1314d, %rsi
lea addresses_normal_ht+0xae45, %rdi
sub %r8, %r8
mov $21, %rcx
rep movsw
nop
...
<gen_prepare_buffer>
{'src': {'type': 'addresses_WT_ht', 'congruent': 11, 'same': False}, 'dst': {'type': 'addresses_normal_ht', 'congruent': 11, 'same': False}, 'OP': 'REPM'}
