...
push %rcx
push %rsi
lea addresses_WT_ht+0x11a6c, %rcx
nop
nop
sub %rsi, %rsi
...
// REPMOV
lea addresses_WT+0x17c58, %rsi
lea addresses_D+0x2658, %rdi
clflush (%rsi)
nop
nop
nop
...
{'src': {'type': 'addresses_WT', 'congruent': 8, 'same': False}, 'dst': {'type': 'addresses_D', 'congruent': 10, 'same': False}, 'OP': 'REPM'}
