...
lea addresses_UC_ht+0x8822, %rdi
nop
nop
nop
cmp $60701, %r9
...
nop
and %rcx, %rcx
lea addresses_normal_ht+0x166f4, %rsi
clflush (%rsi)
nop
nop
cmp %r10, %r10
...
nop
sub %r9, %r9
lea addresses_D_ht+0x1478c, %r10
nop
nop
nop
nop
...
nop
and $48215, %r9
lea addresses_WT_ht+0x17f0c, %rbp
and $3222, %r10
vmovups (%rbp), %ymm6
...
nop
xor %rcx, %rcx
lea addresses_UC_ht+0x19378, %rsi
lea addresses_WT_ht+0x11c5c, %rdi
nop
cmp %rax, %rax
mov $99, %rcx
rep movsl
...
// Store
lea addresses_normal+0x844c, %rbx
nop
nop
nop
nop
...
{'OP': 'STOR', 'dst': {'type': 'addresses_NC', 'size': 1, 'AVXalign': False, 'NT': True, 'congruent': 2, 'same': False}}
...
{'OP': 'REPM', 'src': {'type': 'addresses_UC_ht', 'congruent': 2, 'same': False}, 'dst': {'type': 'addresses_WT_ht', 'congruent': 2, 'same': True}}
{'00': 21829}
