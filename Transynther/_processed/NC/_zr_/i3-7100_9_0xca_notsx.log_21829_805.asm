...
nop
xor %r9, %r9
lea addresses_WT_ht+0x16984, %r12
nop
nop
nop
nop
...
nop
inc %r9
lea addresses_normal_ht+0x2d04, %r9
clflush (%r9)
add $56162, %rdx
movb (%r9), %r11b
nop
...
nop
and %r12, %r12
lea addresses_WC_ht+0xe484, %rsi
lea addresses_D_ht+0x13546, %rdi
clflush (%rdi)
nop
nop
nop
...
nop
dec %rdx
lea addresses_A_ht+0x17504, %rdx
nop
nop
and $33912, %r12
vmovups (%rdx), %ymm2
...
nop
xor %rbp, %rbp
lea addresses_UC_ht+0x15a04, %rsi
lea addresses_UC_ht+0xba84, %rdi
nop
nop
add %r9, %r9
mov $28, %rcx
...
nop
sub $27702, %rdx
lea addresses_normal_ht+0x17f04, %rsi
cmp $61571, %r9
mov (%rsi), %r11w
nop
nop
...
nop
mfence
lea addresses_WT_ht+0x27ec, %rbp
nop
nop
nop
add $55936, %r11
...
lea addresses_D_ht+0x11a84, %rdi
nop
and %rdx, %rdx
mov $112, %rcx
rep movsw
...
{'src': {'type': 'addresses_WC_ht', 'congruent': 8, 'same': False}, 'OP': 'REPM', 'dst': {'type': 'addresses_D_ht', 'congruent': 1, 'same': True}}
