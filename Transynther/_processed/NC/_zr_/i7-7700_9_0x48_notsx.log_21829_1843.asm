...
push %rdx
push %rsi
lea addresses_WT_ht+0xd2f1, %rsi
lea addresses_normal_ht+0x1c871, %rdi
nop
nop
nop
nop
...
nop
add $11793, %rsi
lea addresses_A_ht+0x69b1, %rbp
add %r15, %r15
movl $0x61626364, (%rbp)
nop
inc %rcx
lea addresses_WT_ht+0xe3e1, %rsi
nop
nop
nop
xor $35111, %rcx
...
movq %rdi, (%rsi)
add %r10, %r10
lea addresses_A_ht+0x35b1, %rsi
lea addresses_D_ht+0x1d8b1, %rdi
nop
xor %r11, %r11
mov $33, %rcx
rep movsb
...
nop
inc %r10
lea addresses_WT_ht+0x1a1b1, %r10
sub %r15, %r15
...
nop
add %r10, %r10
lea addresses_WT_ht+0x75b1, %r11
nop
nop
nop
nop
...
nop
and %rcx, %rcx
lea addresses_A_ht+0x15f31, %r10
nop
nop
nop
and %rcx, %rcx
...
nop
xor $51566, %rcx
lea addresses_WT_ht+0x105b1, %r11
nop
nop
nop
cmp $26839, %rdx
...
movups %xmm2, (%r11)
sub $24810, %rbp
lea addresses_WC_ht+0x13db1, %rcx
cmp $37433, %r10
mov $0x6162636465666768, %rsi
movq %rsi, (%rcx)
nop
...
nop
xor $25766, %rdi
lea addresses_A_ht+0x1e5b1, %rdi
nop
nop
nop
xor %r11, %r11
...
nop
sub %rbp, %rbp
lea addresses_UC_ht+0x1b0f1, %r15
nop
nop
and $61306, %rcx
mov $0x6162636465666768, %rsi
...
nop
cmp %rbp, %rbp
lea addresses_normal_ht+0xc799, %rdi
nop
nop
nop
xor %r10, %r10
...
nop
xor $22094, %rdi
lea addresses_UC_ht+0x135b1, %rsi
lea addresses_UC_ht+0x65b1, %rdi
dec %r10
mov $105, %rcx
rep movsl
nop
...
// Load
lea addresses_normal+0x13bd1, %rax
nop
nop
nop
and $44168, %r8
...
{'OP': 'LOAD', 'src': {'same': False, 'NT': False, 'AVXalign': False, 'size': 1, 'type': 'addresses_D', 'congruent': 11}}
{'dst': {'same': False, 'NT': False, 'AVXalign': False, 'size': 8, 'type': 'addresses_D', 'congruent': 7}, 'OP': 'STOR'}
{'OP': 'LOAD', 'src': {'same': False, 'NT': False, 'AVXalign': False, 'size': 2, 'type': 'addresses_WT', 'congruent': 8}}
...
<gen_prepare_buffer>
{'dst': {'same': False, 'congruent': 6, 'type': 'addresses_normal_ht'}, 'OP': 'REPM', 'src': {'same': True, 'congruent': 4, 'type': 'addresses_WT_ht'}}
...
{'dst': {'same': False, 'NT': False, 'AVXalign': False, 'size': 16, 'type': 'addresses_WT_ht', 'congruent': 11}, 'OP': 'STOR'}
{'dst': {'same': False, 'NT': False, 'AVXalign': True, 'size': 8, 'type': 'addresses_WC_ht', 'congruent': 9}, 'OP': 'STOR'}
...
{'dst': {'same': False, 'congruent': 11, 'type': 'addresses_UC_ht'}, 'OP': 'REPM', 'src': {'same': False, 'congruent': 10, 'type': 'addresses_UC_ht'}}
{'00': 21829}
