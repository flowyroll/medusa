...
push %rdi
push %rsi
lea addresses_normal_ht+0x11d5b, %rdi
nop
dec %r8
movups (%rdi), %xmm3
vpextrq $1, %xmm3, %r10
sub $56815, %rax
lea addresses_WT_ht+0x5a5b, %r13
nop
sub %r9, %r9
mov (%r13), %r10
dec %r9
lea addresses_WT_ht+0x1b95b, %r13
nop
nop
nop
nop
...
nop
sub $3215, %r10
lea addresses_WC_ht+0x17353, %rsi
lea addresses_A_ht+0x1215b, %rdi
inc %r8
mov $74, %rcx
rep movsw
cmp $48501, %rsi
lea addresses_UC_ht+0x14cb1, %r8
nop
and $15154, %rdi
...
nop
add %rsi, %rsi
lea addresses_WT_ht+0x823b, %rax
nop
inc %r9
mov $0x6162636465666768, %r8
movq %r8, (%rax)
sub $3528, %rdi
lea addresses_WT_ht+0xa55b, %rsi
lea addresses_D_ht+0x18a25, %rdi
clflush (%rdi)
nop
nop
nop
...
nop
cmp $3761, %r10
lea addresses_UC_ht+0x1dadb, %r13
cmp $6701, %rsi
mov (%r13), %rcx
nop
nop
dec %r8
lea addresses_UC_ht+0x755b, %rsi
lea addresses_WC_ht+0x9f5b, %rdi
clflush (%rsi)
mfence
mov $126, %rcx
rep movsb
...
nop
xor $15361, %rcx
lea addresses_A_ht+0x15a83, %rcx
clflush (%rcx)
xor $33227, %rax
mov $0x6162636465666768, %rdi
movq %rdi, (%rcx)
cmp $540, %r13
lea addresses_WT_ht+0x1bb5b, %rax
nop
nop
nop
xor $19129, %r10
...
nop
and $53664, %rcx
lea addresses_normal_ht+0x12e97, %r9
nop
nop
nop
nop
...
{'OP': 'REPM', 'src': {'type': 'addresses_UC_ht', 'congruent': 9, 'same': True}, 'dst': {'type': 'addresses_WC_ht', 'congruent': 6, 'same': False}}
