...
push %rdi
push %rsi
lea addresses_D_ht+0xb872, %rsi
lea addresses_WT_ht+0x29f2, %rdi
nop
nop
nop
dec %r10
...
nop
sub %rsi, %rsi
lea addresses_WT_ht+0x10672, %rdi
nop
nop
cmp %r10, %r10
...
nop
xor $59261, %rdi
lea addresses_WC_ht+0x398a, %rsi
lea addresses_normal_ht+0x132f2, %rdi
nop
nop
nop
inc %r13
...
// Store
lea addresses_normal+0x11c28, %r11
nop
nop
nop
nop
...
{'OP': 'STOR', 'dst': {'type': 'addresses_A', 'size': 32, 'AVXalign': False, 'NT': True, 'congruent': 0, 'same': False}}
...
{'OP': 'REPM', 'src': {'type': 'addresses_WC_ht', 'congruent': 3, 'same': False}, 'dst': {'type': 'addresses_normal_ht', 'congruent': 7, 'same': True}}
{'00': 21289}
