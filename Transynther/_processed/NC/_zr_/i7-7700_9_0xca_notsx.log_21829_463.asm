...
nop
inc %r15
lea addresses_WC_ht+0x1dec9, %rsi
lea addresses_WC_ht+0xedc3, %rdi
and $22705, %r14
mov $98, %rcx
rep movsw
nop
...
nop
sub $46071, %r15
lea addresses_UC_ht+0x3c89, %rsi
lea addresses_D_ht+0x15c9, %rdi
nop
and %r15, %r15
mov $59, %rcx
rep movsb
...
nop
dec %r12
lea addresses_D_ht+0x1b09d, %r15
nop
nop
nop
add $25639, %rdi
...
// Store
lea addresses_normal+0xedc9, %r13
nop
nop
and %r11, %r11
movw $0x5152, (%r13)
...
// Store
lea addresses_normal+0xefc9, %r12
clflush (%r12)
nop
nop
nop
...
{'src': {'congruent': 1, 'same': False, 'type': 'addresses_WC_ht'}, 'dst': {'congruent': 1, 'same': False, 'type': 'addresses_WC_ht'}, 'OP': 'REPM'}
{'src': {'congruent': 6, 'same': False, 'type': 'addresses_UC_ht'}, 'dst': {'congruent': 9, 'same': False, 'type': 'addresses_D_ht'}, 'OP': 'REPM'}
