...
push %rdx
push %rsi
lea addresses_UC_ht+0xf4aa, %rbp
nop
xor %r13, %r13
mov (%rbp), %r15w
nop
and $63573, %r8
lea addresses_WC_ht+0x18e52, %rdx
nop
nop
nop
nop
...
vmovups %ymm5, (%rdx)
sub $23327, %r15
lea addresses_WT_ht+0x19722, %rbp
nop
nop
nop
nop
...
nop
xor %r15, %r15
lea addresses_normal_ht+0xc392, %rbp
nop
nop
nop
nop
...
mov (%rbp), %r8
add %r8, %r8
lea addresses_WT_ht+0x10f92, %r12
nop
nop
nop
dec %r15
...
nop
cmp $3958, %r13
lea addresses_WC_ht+0x1e4f2, %r12
nop
nop
add $40844, %r8
...
nop
sub $40941, %rdx
lea addresses_WC_ht+0x1b652, %rsi
lea addresses_WT_ht+0xa392, %rdi
clflush (%rsi)
sub $22998, %r13
mov $43, %rcx
rep movsq
...
nop
sub $11339, %rcx
lea addresses_normal_ht+0x8f92, %rsi
...
nop
xor %r13, %r13
lea addresses_WT_ht+0x11592, %rsi
lea addresses_D_ht+0x9192, %rdi
nop
nop
nop
nop
...
nop
sub $32989, %rdi
lea addresses_UC_ht+0x16462, %rbp
nop
nop
nop
nop
...
nop
inc %r12
lea addresses_normal_ht+0x14f22, %rcx
nop
nop
dec %r15
movups (%rcx), %xmm1
...
nop
cmp %r15, %r15
lea addresses_D_ht+0x1934a, %rsi
nop
nop
nop
nop
...
nop
cmp $13185, %rdi
lea addresses_WT_ht+0xe412, %r12
cmp $25807, %r13
movl $0x61626364, (%r12)
nop
nop
...
nop
xor %rdi, %rdi
lea addresses_normal_ht+0x15792, %rsi
lea addresses_WC_ht+0x14a92, %rdi
clflush (%rdi)
nop
nop
nop
...
{'OP': 'LOAD', 'src': {'type': 'addresses_UC_ht', 'AVXalign': False, 'congruent': 4, 'size': 2, 'same': True, 'NT': False}}
