...
nop
cmp $53742, %r11
lea addresses_WT_ht+0x15bf9, %rsi
lea addresses_WT_ht+0x197f9, %rdi
nop
inc %r14
mov $26, %rcx
rep movsb
...
nop
dec %r8
lea addresses_UC_ht+0x9e29, %rsi
lea addresses_WT_ht+0x16b79, %rdi
clflush (%rsi)
nop
nop
nop
...
nop
add %r13, %r13
lea addresses_UC_ht+0x179a1, %r11
nop
nop
nop
nop
...
nop
add $25845, %r9
lea addresses_UC_ht+0x96b9, %rsi
lea addresses_UC_ht+0x4639, %rdi
nop
nop
nop
nop
...
nop
xor %r11, %r11
lea addresses_UC_ht+0x5b19, %r13
cmp $44505, %r8
movb $0x61, (%r13)
xor %rdi, %rdi
lea addresses_D_ht+0x2f79, %rsi
lea addresses_UC_ht+0x11f9, %rdi
clflush (%rdi)
and %r9, %r9
mov $89, %rcx
rep movsb
...
{'OP': 'REPM', 'src': {'type': 'addresses_WT_ht', 'congruent': 11, 'same': True}, 'dst': {'type': 'addresses_WT_ht', 'congruent': 10, 'same': False}}
