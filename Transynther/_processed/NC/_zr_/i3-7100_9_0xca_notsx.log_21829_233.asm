...
push %rdi
push %rsi
lea addresses_A_ht+0x174e6, %rax
nop
nop
add %r15, %r15
...
movups %xmm4, (%rax)
cmp $47322, %r12
lea addresses_normal_ht+0x156ae, %r9
nop
nop
add %rbx, %rbx
...
nop
add $62901, %r12
lea addresses_WT_ht+0x5be6, %rsi
lea addresses_UC_ht+0x189c6, %rdi
clflush (%rsi)
nop
cmp $61795, %r15
mov $47, %rcx
...
nop
and %r12, %r12
lea addresses_WC_ht+0x94b2, %rsi
lea addresses_normal_ht+0xe3e6, %rdi
nop
cmp $1465, %r12
mov $40, %rcx
rep movsw
...
nop
cmp $11027, %rdi
lea addresses_D_ht+0x177a6, %rax
nop
cmp $4354, %rcx
movb (%rax), %r15b
nop
nop
add %rbx, %rbx
lea addresses_normal_ht+0xeee6, %rdi
nop
xor %rsi, %rsi
mov (%rdi), %r12
sub $14554, %rsi
lea addresses_UC_ht+0x1ad72, %rsi
lea addresses_WT_ht+0x1d2e6, %rdi
and $27914, %rax
mov $81, %rcx
rep movsl
inc %r8
...
{'OP': 'STOR', 'dst': {'same': False, 'congruent': 9, 'NT': True, 'type': 'addresses_D_ht', 'size': 32, 'AVXalign': False}}
...
{'src': {'type': 'addresses_UC_ht', 'congruent': 2, 'same': True}, 'OP': 'REPM', 'dst': {'type': 'addresses_WT_ht', 'congruent': 8, 'same': False}}
{'00': 21829}
