...
push %rdi
push %rsi
lea addresses_D_ht+0x14319, %rbx
nop
nop
nop
nop
...
nop
inc %r15
lea addresses_UC_ht+0x150ed, %rsi
lea addresses_WT_ht+0x90ad, %rdi
nop
nop
nop
sub $9253, %rbp
...
rep movsw
cmp %rcx, %rcx
lea addresses_A_ht+0x44ed, %rsi
lea addresses_WT_ht+0x362d, %rdi
nop
nop
sub $46595, %r13
mov $107, %rcx
...
nop
xor $2762, %rsi
lea addresses_A_ht+0x134ed, %rsi
lea addresses_WC_ht+0xd14d, %rdi
clflush (%rdi)
nop
nop
and $37086, %r15
...
nop
dec %rbp
lea addresses_normal_ht+0x6055, %rsi
lea addresses_WT_ht+0x125ad, %rdi
nop
nop
nop
mfence
...
nop
add $33884, %r13
lea addresses_UC_ht+0x18531, %rbx
nop
xor %r15, %r15
movb (%rbx), %r13b
nop
inc %rbx
lea addresses_WT_ht+0x8b4d, %rsi
nop
nop
nop
nop
...
rep movsq
sub $27639, %r15
lea addresses_normal_ht+0x30ed, %rdi
nop
nop
nop
nop
...
movw $0x6162, (%rdi)
sub $27815, %r15
lea addresses_UC_ht+0x1555d, %r13
nop
nop
dec %rbp
movb $0x61, (%r13)
...
{'src': {'congruent': 10, 'same': False, 'type': 'addresses_A_ht'}, 'dst': {'congruent': 5, 'same': False, 'type': 'addresses_WC_ht'}, 'OP': 'REPM'}
{'src': {'congruent': 3, 'same': False, 'type': 'addresses_normal_ht'}, 'dst': {'congruent': 3, 'same': False, 'type': 'addresses_WT_ht'}, 'OP': 'REPM'}
