...
push %rdi
push %rsi
lea addresses_WC_ht+0x63c2, %rsi
lea addresses_normal_ht+0x1a3a2, %rdi
nop
nop
nop
nop
...
nop
inc %r10
lea addresses_normal_ht+0xa24c, %r9
nop
nop
nop
and %rbx, %rbx
...
nop
cmp %r9, %r9
lea addresses_WT_ht+0x15c2, %rdi
nop
nop
nop
cmp $58664, %rsi
...
nop
cmp %rdi, %rdi
lea addresses_D_ht+0x18f4a, %r10
nop
nop
inc %r12
mov (%r10), %r9w
