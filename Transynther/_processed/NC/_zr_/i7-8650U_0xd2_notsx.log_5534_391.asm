...
push %rdi
push %rsi
lea addresses_normal_ht+0xef71, %r14
nop
nop
xor %r8, %r8
mov (%r14), %r9d
...
nop
cmp $3330, %r8
lea addresses_WT_ht+0x1671, %rsi
lea addresses_A_ht+0x1e071, %rdi
and $12188, %r15
mov $74, %rcx
rep movsw
nop
add %rcx, %rcx
lea addresses_WC_ht+0x1381, %rsi
lea addresses_D_ht+0x18971, %rdi
nop
nop
nop
nop
...
nop
xor $12911, %rdi
lea addresses_normal_ht+0xc729, %rcx
nop
nop
nop
nop
...
nop
cmp $42905, %rbx
lea addresses_A_ht+0xb071, %rsi
nop
nop
xor %rcx, %rcx
movw $0x6162, (%rsi)
inc %r9
lea addresses_A_ht+0x8171, %r8
clflush (%r8)
nop
nop
nop
...
nop
sub $16481, %rdi
lea addresses_WC_ht+0x5371, %rsi
lea addresses_normal_ht+0x8771, %rdi
clflush (%rdi)
nop
nop
nop
...
rep movsq
sub $18459, %rdi
lea addresses_normal_ht+0x10ef1, %rsi
...
nop
and $41041, %rbx
lea addresses_normal_ht+0x3dc9, %r14
nop
nop
nop
and $28467, %rdi
...
nop
and %r8, %r8
lea addresses_normal_ht+0x1ecf1, %rsi
lea addresses_WT_ht+0xbbb1, %rdi
xor $18904, %r15
mov $55, %rcx
rep movsb
xor $25923, %rcx
...
{'OP': 'REPM', 'src': {'type': 'addresses_WT_ht', 'congruent': 7, 'same': False}, 'dst': {'type': 'addresses_A_ht', 'congruent': 7, 'same': False}}
{'OP': 'REPM', 'src': {'type': 'addresses_WC_ht', 'congruent': 3, 'same': False}, 'dst': {'type': 'addresses_D_ht', 'congruent': 7, 'same': False}}
{'OP': 'STOR', 'dst': {'type': 'addresses_normal_ht', 'size': 8, 'AVXalign': False, 'NT': False, 'congruent': 3, 'same': True}}
...
{'OP': 'REPM', 'src': {'type': 'addresses_normal_ht', 'congruent': 7, 'same': False}, 'dst': {'type': 'addresses_WC_ht', 'congruent': 0, 'same': True}}
