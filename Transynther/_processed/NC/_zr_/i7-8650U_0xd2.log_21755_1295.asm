...
nop
and %rdi, %rdi
lea addresses_D_ht+0x12af9, %r14
nop
nop
cmp %rdi, %rdi
...
nop
and %rbx, %rbx
lea addresses_D_ht+0x1508f, %r14
nop
xor $50743, %rdi
mov (%r14), %rbx
nop
nop
inc %r13
lea addresses_normal_ht+0x19679, %rsi
lea addresses_normal_ht+0x1a730, %rdi
nop
nop
nop
xor %r9, %r9
...
nop
sub $33045, %r14
lea addresses_WT_ht+0x1d369, %rcx
nop
nop
nop
nop
