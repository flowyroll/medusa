...
push %rdi
push %rsi
lea addresses_A_ht+0x1080e, %rsi
lea addresses_WC_ht+0x5d34, %rdi
clflush (%rdi)
nop
nop
add %rbx, %rbx
...
nop
dec %r10
lea addresses_WC_ht+0xe730, %rdi
nop
nop
sub $27413, %r9
mov (%rdi), %r10d
...
// REPMOV
lea addresses_WT+0x1b70e, %rsi
lea addresses_PSE+0x14bde, %rdi
nop
nop
inc %r12
mov $52, %rcx
...
{'src': {'type': 'addresses_WT', 'congruent': 11, 'same': False}, 'dst': {'type': 'addresses_PSE', 'congruent': 4, 'same': False}, 'OP': 'REPM'}
