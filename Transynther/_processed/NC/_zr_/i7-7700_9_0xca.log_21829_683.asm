...
nop
inc %rsi
lea addresses_normal_ht+0x15eb9, %r10
nop
nop
nop
nop
...
nop
xor %r11, %r11
lea addresses_WT_ht+0x1a8b9, %rcx
nop
nop
add $31845, %r11
movups (%rcx), %xmm6
...
nop
xor $8543, %r13
lea addresses_UC_ht+0xe019, %rcx
cmp $51580, %rsi
movw $0x6162, (%rcx)
and %rsi, %rsi
lea addresses_normal_ht+0x112b9, %rsi
...
{'OP': 'STOR', 'dst': {'congruent': 5, 'AVXalign': False, 'same': False, 'size': 8, 'NT': True, 'type': 'addresses_UC_ht'}}
...
{'OP': 'STOR', 'dst': {'congruent': 3, 'AVXalign': True, 'same': False, 'size': 2, 'NT': False, 'type': 'addresses_UC_ht'}}
{'src': {'congruent': 10, 'same': False, 'type': 'addresses_normal_ht'}, 'OP': 'REPM', 'dst': {'congruent': 1, 'same': False, 'type': 'addresses_WC_ht'}}
{'00': 21829}
