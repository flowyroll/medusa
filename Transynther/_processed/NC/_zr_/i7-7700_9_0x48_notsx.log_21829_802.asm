...
push %rdi
push %rsi
lea addresses_A_ht+0x1908d, %r14
nop
nop
nop
xor %rbx, %rbx
mov (%r14), %rdi
inc %r12
lea addresses_WC_ht+0xbe9f, %rsi
...
rep movsb
add $5475, %rdi
lea addresses_D_ht+0x1d88d, %rsi
lea addresses_UC_ht+0x908d, %rdi
nop
nop
nop
xor %r15, %r15
...
nop
xor $28638, %r10
lea addresses_A_ht+0xb269, %rsi
lea addresses_WC_ht+0x948d, %rdi
nop
nop
cmp $58164, %r10
mov $38, %rcx
...
nop
xor $59146, %r15
lea addresses_normal_ht+0xcd8d, %rbx
nop
xor %rcx, %rcx
movb $0x61, (%rbx)
nop
nop
cmp %rsi, %rsi
lea addresses_UC_ht+0xfa0d, %r12
nop
nop
nop
xor %rdi, %rdi
...
nop
xor %rdi, %rdi
lea addresses_D_ht+0x1ea10, %rsi
lea addresses_WT_ht+0x7475, %rdi
nop
nop
nop
sub $12038, %r14
...
nop
and %r15, %r15
lea addresses_UC_ht+0x1bc4d, %rdi
nop
nop
nop
nop
...
nop
add $36207, %r15
lea addresses_WC_ht+0xdec1, %r12
nop
nop
nop
nop
...
nop
add $61879, %r15
lea addresses_WC_ht+0x808d, %rcx
nop
nop
nop
xor $31874, %r10
...
{'dst': {'same': False, 'congruent': 9, 'type': 'addresses_UC_ht'}, 'OP': 'REPM', 'src': {'same': False, 'congruent': 8, 'type': 'addresses_D_ht'}}
{'dst': {'same': True, 'congruent': 10, 'type': 'addresses_WC_ht'}, 'OP': 'REPM', 'src': {'same': False, 'congruent': 2, 'type': 'addresses_A_ht'}}
...
{'OP': 'LOAD', 'src': {'same': False, 'NT': True, 'AVXalign': True, 'size': 16, 'type': 'addresses_UC_ht', 'congruent': 4}}
