...
nop
add $57806, %rdx
lea addresses_WC_ht+0x17755, %r14
nop
nop
and $61792, %r11
...
nop
add %r11, %r11
lea addresses_D_ht+0x16355, %rsi
lea addresses_WC_ht+0x8655, %rdi
xor %r11, %r11
mov $54, %rcx
rep movsq
add $10576, %r9
lea addresses_A_ht+0x455, %rsi
lea addresses_A_ht+0x3ad3, %rdi
nop
nop
nop
sub %r12, %r12
...
rep movsl
and %r11, %r11
lea addresses_normal_ht+0x1155, %rcx
nop
sub %r14, %r14
movw $0x6162, (%rcx)
nop
...
nop
xor $57, %rdi
lea addresses_normal_ht+0xdd55, %rdi
nop
nop
nop
nop
...
{'OP': 'REPM', 'src': {'type': 'addresses_D_ht', 'congruent': 10, 'same': False}, 'dst': {'type': 'addresses_WC_ht', 'congruent': 8, 'same': True}}
