...
nop
and %rcx, %rcx
lea addresses_WT_ht+0xbfcd, %rdi
nop
inc %rax
...
nop
sub $49463, %r14
lea addresses_WC_ht+0x2fcd, %rsi
nop
nop
nop
inc %r10
...
nop
and $31949, %r13
lea addresses_WT_ht+0x195cd, %rsi
nop
and %r10, %r10
...
vmovups %ymm6, (%rsi)
and %r14, %r14
lea addresses_WT_ht+0x1664d, %rsi
lea addresses_D_ht+0x21a5, %rdi
nop
nop
nop
and %r15, %r15
...
rep movsw
cmp %rax, %rax
lea addresses_D_ht+0x18faa, %rcx
nop
cmp %r10, %r10
mov (%rcx), %rdi
nop
...
// REPMOV
lea addresses_UC+0x145cd, %rsi
lea addresses_normal+0xfc4d, %rdi
clflush (%rsi)
nop
nop
nop
...
{'src': {'type': 'addresses_UC', 'congruent': 10, 'same': False}, 'dst': {'type': 'addresses_normal', 'congruent': 7, 'same': False}, 'OP': 'REPM'}
[Faulty Load]
{'src': {'type': 'addresses_NC', 'same': True, 'size': 4, 'congruent': 0, 'NT': False, 'AVXalign': False}, 'OP': 'LOAD'}
<gen_prepare_buffer>
{'src': {'type': 'addresses_WT_ht', 'congruent': 2, 'same': False}, 'dst': {'type': 'addresses_normal_ht', 'congruent': 10, 'same': False}, 'OP': 'REPM'}
