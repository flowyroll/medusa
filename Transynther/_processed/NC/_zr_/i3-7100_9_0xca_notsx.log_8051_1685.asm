...
push %rdi
push %rsi
lea addresses_UC_ht+0x18212, %rcx
nop
nop
nop
nop
...
movq %r9, (%rcx)
xor $52692, %r8
lea addresses_WT_ht+0x1eb48, %r10
nop
nop
sub $33014, %r15
movw $0x6162, (%r10)
...
nop
sub %rcx, %rcx
lea addresses_WT_ht+0x12012, %r8
clflush (%r8)
nop
nop
nop
...
nop
dec %r8
lea addresses_A_ht+0x1effa, %rax
nop
nop
nop
nop
...
nop
and %r10, %r10
lea addresses_WT_ht+0xaa92, %rax
nop
sub $53275, %rdi
...
nop
cmp %rdi, %rdi
lea addresses_normal_ht+0x1e912, %rsi
lea addresses_D_ht+0xc752, %rdi
nop
nop
add %r15, %r15
mov $60, %rcx
rep movsl
inc %r15
lea addresses_D_ht+0x1e812, %rax
nop
nop
nop
nop
...
nop
cmp %rax, %rax
lea addresses_WT_ht+0x13a12, %r8
nop
nop
cmp %rcx, %rcx
...
movq %rdi, (%r8)
xor $5239, %r8
lea addresses_WT_ht+0x6012, %rsi
lea addresses_normal_ht+0x197ce, %rdi
nop
nop
nop
nop
...
nop
inc %r8
lea addresses_normal_ht+0x15f8c, %rsi
dec %rdi
...
{'OP': 'STOR', 'dst': {'same': False, 'congruent': 9, 'NT': False, 'type': 'addresses_RW', 'size': 4, 'AVXalign': True}}
[Faulty Load]
...
{'OP': 'STOR', 'dst': {'same': True, 'congruent': 8, 'NT': True, 'type': 'addresses_D_ht', 'size': 1, 'AVXalign': False}}
