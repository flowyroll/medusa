...
mov (%rbp), %r10w
inc %r8
lea addresses_WT_ht+0x1986e, %rax
sub %r12, %r12
mov (%rax), %r10
nop
nop
nop
add $20319, %rax
lea addresses_normal_ht+0x10785, %rax
nop
nop
nop
add %r10, %r10
...
lea addresses_WC_ht+0x1e615, %rdi
nop
nop
nop
cmp $33346, %r8
...
nop
add $156, %r10
lea addresses_WT_ht+0xe28d, %rsi
lea addresses_normal_ht+0x294b, %rdi
clflush (%rsi)
nop
nop
nop
...
// Store
lea addresses_normal+0x1aea3, %r9
nop
sub %r15, %r15
movw $0x5152, (%r9)
nop
...
{'src': {'NT': True, 'same': False, 'congruent': 3, 'type': 'addresses_UC_ht', 'AVXalign': False, 'size': 2}, 'OP': 'LOAD'}
...
{'src': {'same': False, 'congruent': 10, 'type': 'addresses_normal_ht'}, 'OP': 'REPM', 'dst': {'same': False, 'congruent': 4, 'type': 'addresses_WC_ht'}}
