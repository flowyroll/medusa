...
push %rdx
push %rsi
lea addresses_D_ht+0x1cca0, %rbp
nop
nop
nop
nop
...
nop
xor $7297, %r12
lea addresses_D_ht+0x1067c, %rsi
lea addresses_A_ht+0xfa60, %rdi
nop
nop
nop
nop
...
nop
sub %rdi, %rdi
lea addresses_WC_ht+0x6570, %rsi
lea addresses_UC_ht+0x2230, %rdi
add %r12, %r12
mov $43, %rcx
rep movsq
nop
