...
push %rdx
push %rsi
lea addresses_D_ht+0x641a, %rsi
lea addresses_normal_ht+0x2bd2, %rdi
clflush (%rsi)
nop
nop
nop
...
rep movsb
dec %rdx
lea addresses_A_ht+0x1c409, %rbp
nop
nop
nop
nop
...
nop
add %rbp, %rbp
lea addresses_WT_ht+0x3872, %rsi
lea addresses_A_ht+0x1959a, %rdi
nop
sub $55598, %r9
mov $28, %rcx
rep movsl
...
nop
dec %r8
lea addresses_WC_ht+0x1cd9a, %rsi
lea addresses_WT_ht+0x959a, %rdi
clflush (%rdi)
nop
nop
add %r8, %r8
...
nop
xor %rdi, %rdi
lea addresses_D_ht+0x1d532, %rcx
add $28444, %rdi
mov $0x6162636465666768, %rsi
movq %rsi, (%rcx)
sub %rsi, %rsi
lea addresses_WT_ht+0x1bc02, %r9
and $32373, %rcx
mov (%r9), %ebp
nop
nop
sub $36519, %rcx
lea addresses_WC_ht+0x705a, %r9
add $4962, %rsi
movb (%r9), %r8b
nop
nop
sub %rdi, %rdi
lea addresses_UC_ht+0x1381a, %rsi
lea addresses_WC_ht+0x434a, %rdi
add $24768, %rbp
mov $62, %rcx
rep movsq
nop
...
nop
add $64012, %rcx
lea addresses_UC_ht+0x439a, %rsi
nop
nop
add $37973, %r10
movb (%rsi), %r8b
...
{'OP': 'LOAD', 'src': {'type': 'addresses_A', 'AVXalign': False, 'congruent': 6, 'size': 4, 'same': False, 'NT': False}}
[Faulty Load]
...
{'OP': 'REPM', 'src': {'type': 'addresses_WT_ht', 'congruent': 0, 'same': False}, 'dst': {'type': 'addresses_A_ht', 'congruent': 10, 'same': False}}
{'OP': 'STOR', 'dst': {'type': 'addresses_D_ht', 'AVXalign': True, 'congruent': 8, 'size': 8, 'same': False, 'NT': False}}
