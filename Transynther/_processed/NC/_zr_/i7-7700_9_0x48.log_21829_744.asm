...
push %rdx
push %rsi
lea addresses_UC_ht+0xc207, %rsi
lea addresses_normal_ht+0x8527, %rdi
nop
nop
nop
nop
...
movups %xmm7, (%r10)
xor $56360, %r11
lea addresses_WT_ht+0xef67, %rcx
nop
nop
nop
nop
...
nop
cmp $52180, %rcx
lea addresses_A_ht+0x1d987, %rsi
...
{'OP': 'STOR', 'dst': {'type': 'addresses_NC', 'AVXalign': True, 'congruent': 5, 'size': 1, 'same': False, 'NT': False}}
[Faulty Load]
{'OP': 'LOAD', 'src': {'type': 'addresses_NC', 'AVXalign': False, 'congruent': 0, 'size': 1, 'same': True, 'NT': False}}
<gen_prepare_buffer>
{'OP': 'REPM', 'src': {'type': 'addresses_UC_ht', 'congruent': 11, 'same': True}, 'dst': {'type': 'addresses_normal_ht', 'congruent': 5, 'same': False}}
