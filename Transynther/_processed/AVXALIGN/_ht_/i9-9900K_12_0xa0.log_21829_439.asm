...
lea addresses_WC_ht+0x452c, %rdi
nop
nop
nop
nop
...
nop
inc %rax
lea addresses_A_ht+0x15b18, %r15
cmp %rax, %rax
mov (%r15), %r9w
sub $30456, %r15
lea addresses_normal_ht+0x12fec, %r15
nop
nop
nop
nop
...
{'OP': 'STOR', 'dst': {'NT': True, 'same': False, 'congruent': 10, 'type': 'addresses_US', 'AVXalign': True, 'size': 32}}
{'OP': 'STOR', 'dst': {'NT': False, 'same': False, 'congruent': 5, 'type': 'addresses_PSE', 'AVXalign': True, 'size': 4}}
