...
push %rdx
push %rsi
lea addresses_WT_ht+0xc09e, %r14
nop
nop
add $49203, %rsi
...
nop
sub $15080, %r12
lea addresses_WT_ht+0xffbe, %r10
inc %r12
...
nop
sub $2325, %rdi
lea addresses_UC_ht+0x2fae, %rdi
nop
nop
cmp %rcx, %rcx
mov $0x6162636465666768, %rdx
...
nop
xor %rdx, %rdx
lea addresses_normal_ht+0xf29e, %rsi
lea addresses_D_ht+0xf89e, %rdi
lfence
mov $115, %rcx
rep movsq
xor $64021, %rdx
lea addresses_D_ht+0x44de, %r14
nop
nop
nop
nop
...
nop
and $24813, %rcx
lea addresses_WC_ht+0x1cb9e, %r12
dec %rsi
movb (%r12), %r10b
nop
nop
...
nop
and %r12, %r12
lea addresses_D_ht+0x11d9e, %r14
nop
nop
nop
nop
...
{'OP': 'REPM', 'src': {'type': 'addresses_normal_ht', 'congruent': 9, 'same': False}, 'dst': {'type': 'addresses_D_ht', 'congruent': 9, 'same': False}}
{'OP': 'LOAD', 'src': {'type': 'addresses_D_ht', 'AVXalign': True, 'congruent': 6, 'size': 8, 'same': False, 'NT': False}}
