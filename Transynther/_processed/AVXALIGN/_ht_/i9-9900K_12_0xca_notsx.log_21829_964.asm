...
nop
add %rsi, %rsi
lea addresses_normal_ht+0x4beb, %rsi
lea addresses_normal_ht+0x1733b, %rdi
xor $37208, %r11
mov $98, %rcx
rep movsw
nop
and $737, %r14
lea addresses_normal_ht+0x30ab, %r11
cmp $56786, %rbx
movl $0x61626364, (%r11)
nop
nop
dec %rbp
lea addresses_normal_ht+0x1243, %r14
nop
nop
add %rbx, %rbx
mov (%r14), %si
...
nop
sub %rbx, %rbx
lea addresses_normal_ht+0x80ab, %rsi
lea addresses_A_ht+0x1126b, %rdi
nop
nop
sub $28051, %r8
mov $28, %rcx
...
{'OP': 'LOAD', 'src': {'same': False, 'type': 'addresses_UC', 'NT': False, 'AVXalign': False, 'size': 2, 'congruent': 6}}
{'OP': 'STOR', 'dst': {'same': False, 'type': 'addresses_WT', 'NT': False, 'AVXalign': True, 'size': 8, 'congruent': 1}}
[Faulty Load]
{'OP': 'LOAD', 'src': {'same': True, 'type': 'addresses_NC', 'NT': True, 'AVXalign': False, 'size': 32, 'congruent': 0}}
<gen_prepare_buffer>
{'OP': 'STOR', 'dst': {'same': False, 'type': 'addresses_D_ht', 'NT': False, 'AVXalign': True, 'size': 1, 'congruent': 6}}
...
{'OP': 'REPM', 'src': {'same': False, 'congruent': 4, 'type': 'addresses_normal_ht'}, 'dst': {'same': False, 'congruent': 4, 'type': 'addresses_A_ht'}}
