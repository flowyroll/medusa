...
push %rdi
push %rsi
lea addresses_A_ht+0x10b35, %rsi
lea addresses_D_ht+0xd0e5, %rdi
clflush (%rsi)
nop
nop
nop
...
nop
xor %rbp, %rbp
lea addresses_UC_ht+0x1729d, %rsi
lea addresses_WC_ht+0x3d45, %rdi
inc %r13
mov $5, %rcx
rep movsb
nop
xor $45423, %rbp
lea addresses_WC_ht+0x5, %rsi
nop
nop
xor %r8, %r8
mov (%rsi), %r10d
...
nop
dec %r10
lea addresses_D_ht+0x1674d, %r10
nop
nop
cmp $16593, %r15
movb $0x61, (%r10)
...
nop
and $46856, %rsi
lea addresses_A_ht+0x16475, %r13
dec %r10
movl $0x61626364, (%r13)
add $24821, %r8
pop %rsi
...
<gen_prepare_buffer>
{'OP': 'REPM', 'src': {'type': 'addresses_A_ht', 'congruent': 4, 'same': False}, 'dst': {'type': 'addresses_D_ht', 'congruent': 4, 'same': True}}
