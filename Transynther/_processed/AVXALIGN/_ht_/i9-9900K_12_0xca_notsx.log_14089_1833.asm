...
nop
cmp $136, %rdi
lea addresses_normal_ht+0x1c3f4, %rsi
lea addresses_WT_ht+0x143f4, %rdi
nop
nop
nop
nop
...
nop
cmp %r15, %r15
lea addresses_normal_ht+0x7c74, %rsi
lea addresses_UC_ht+0x4df4, %rdi
nop
nop
nop
add $11299, %r14
...
nop
cmp $55691, %r15
lea addresses_UC_ht+0x15bf4, %r15
clflush (%r15)
add %rdi, %rdi
mov (%r15), %r9w
nop
...
nop
and %rcx, %rcx
lea addresses_WC_ht+0x5674, %rcx
nop
nop
xor %r9, %r9
movl $0x61626364, (%rcx)
...
{'OP': 'REPM', 'src': {'same': False, 'congruent': 11, 'type': 'addresses_normal_ht'}, 'dst': {'same': False, 'congruent': 9, 'type': 'addresses_WT_ht'}}
{'OP': 'REPM', 'src': {'same': False, 'congruent': 0, 'type': 'addresses_normal_ht'}, 'dst': {'same': False, 'congruent': 8, 'type': 'addresses_UC_ht'}}
