...
nop
dec %r12
lea addresses_D_ht+0xe329, %rbp
and %r12, %r12
mov (%rbp), %bx
nop
sub $65039, %r12
lea addresses_normal_ht+0x17129, %r13
nop
nop
nop
nop
...
nop
sub $11594, %r14
lea addresses_WT_ht+0x6729, %rsi
lea addresses_WT_ht+0x1356b, %rdi
nop
nop
nop
nop
...
nop
xor %rbp, %rbp
lea addresses_WC_ht+0x10401, %r12
nop
nop
nop
nop
...
nop
xor %rdi, %rdi
lea addresses_D_ht+0x1b29, %rsi
lea addresses_D_ht+0xc27d, %rdi
clflush (%rsi)
clflush (%rdi)
nop
nop
...
nop
cmp %r9, %r9
lea addresses_WT_ht+0xc8a9, %rbx
nop
nop
nop
add %r9, %r9
...
nop
cmp %rsi, %rsi
lea addresses_normal_ht+0x111ff, %r13
nop
nop
xor $2122, %r9
mov $0x6162636465666768, %rdi
