...
push %rdi
push %rsi
lea addresses_D_ht+0x18c31, %rdi
nop
xor %rbp, %rbp
movb (%rdi), %r10b
nop
...
nop
sub $61093, %r15
lea addresses_normal_ht+0xe511, %rbx
cmp %rsi, %rsi
...
nop
cmp $39829, %rsi
lea addresses_D_ht+0x10591, %rsi
lea addresses_D_ht+0x1c061, %rdi
nop
xor %r9, %r9
mov $86, %rcx
rep movsl
xor $49135, %rbp
lea addresses_D_ht+0x7d91, %r10
nop
nop
nop
nop
...
// Store
lea addresses_WT+0x611, %r11
inc %rcx
movw $0x5152, (%r11)
cmp $27832, %r11

// Load
lea addresses_WC+0x6f71, %r9
nop
nop
sub %r8, %r8
mov (%r9), %r11
...
{'src': {'type': 'addresses_WC', 'AVXalign': False, 'size': 8, 'NT': True, 'same': False, 'congruent': 4}, 'OP': 'LOAD'}
{'src': {'type': 'addresses_P', 'AVXalign': False, 'size': 4, 'NT': False, 'same': False, 'congruent': 2}, 'OP': 'LOAD'}
[Faulty Load]
...
{'src': {'type': 'addresses_D_ht', 'congruent': 9, 'same': False}, 'OP': 'REPM', 'dst': {'type': 'addresses_D_ht', 'congruent': 2, 'same': True}}
{'src': {'type': 'addresses_D_ht', 'AVXalign': True, 'size': 32, 'NT': False, 'same': True, 'congruent': 10}, 'OP': 'LOAD'}
{'46': 21829}
