...
push %rdx
push %rsi
lea addresses_UC_ht+0x1b17f, %rdi
nop
sub $36599, %rdx
mov (%rdi), %r8d
nop
add %r8, %r8
lea addresses_UC_ht+0x1b487, %rsi
lea addresses_UC_ht+0x1b37f, %rdi
nop
nop
nop
sub $24368, %r8
...
nop
sub %rdx, %rdx
lea addresses_WC_ht+0x817f, %r15
nop
cmp %r8, %r8
movw $0x6162, (%r15)
sub $24446, %rcx
lea addresses_UC_ht+0x101ff, %rdi
nop
nop
nop
mfence
...
lea addresses_A_ht+0x1d97f, %rdi
nop
nop
nop
nop
...
rep movsw
dec %rdi
lea addresses_normal_ht+0xd57f, %r15
nop
nop
nop
nop
...
nop
add $64477, %r8
lea addresses_WT_ht+0xf91f, %rcx
nop
and $10118, %r15
mov (%rcx), %edx
nop
...
{'src': {'type': 'addresses_UC_ht', 'congruent': 2, 'same': False}, 'OP': 'REPM', 'dst': {'type': 'addresses_UC_ht', 'congruent': 9, 'same': False}}
