...
movw $0x6162, (%rcx)
sub $4496, %rsi
lea addresses_WT_ht+0xf117, %rbp
clflush (%rbp)
nop
nop
nop
...
{'src': {'type': 'addresses_P', 'same': False, 'size': 32, 'congruent': 5, 'NT': False, 'AVXalign': False}, 'OP': 'LOAD'}
