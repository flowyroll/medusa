...
push %rdx
push %rsi
lea addresses_UC_ht+0x8cef, %rsi
nop
nop
nop
nop
...
nop
and %rcx, %rcx
lea addresses_D_ht+0x1cb27, %rsi
lea addresses_WC_ht+0x1138f, %rdi
nop
sub $48017, %r15
mov $99, %rcx
rep movsl
...
nop
and $29390, %r8
lea addresses_UC_ht+0x1a20f, %rsi
lea addresses_D_ht+0x3f0f, %rdi
nop
nop
xor $13755, %r10
mov $1, %rcx
...
nop
inc %r8
lea addresses_D_ht+0x13eab, %rsi
lea addresses_normal_ht+0xde1f, %rdi
cmp $26708, %rbp
mov $50, %rcx
rep movsl
nop
...
{'src': {'same': False, 'congruent': 3, 'type': 'addresses_D_ht'}, 'OP': 'REPM', 'dst': {'same': False, 'congruent': 7, 'type': 'addresses_WC_ht'}}
{'src': {'same': False, 'congruent': 10, 'type': 'addresses_UC_ht'}, 'OP': 'REPM', 'dst': {'same': False, 'congruent': 8, 'type': 'addresses_D_ht'}}
{'OP': 'STOR', 'dst': {'NT': True, 'same': False, 'congruent': 0, 'type': 'addresses_D_ht', 'AVXalign': False, 'size': 16}}
{'src': {'same': False, 'congruent': 0, 'type': 'addresses_D_ht'}, 'OP': 'REPM', 'dst': {'same': False, 'congruent': 4, 'type': 'addresses_normal_ht'}}
{'46': 21829}
