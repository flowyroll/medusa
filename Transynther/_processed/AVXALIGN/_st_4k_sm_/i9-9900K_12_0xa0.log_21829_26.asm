...
push %rdi
push %rsi
lea addresses_WC_ht+0xade5, %rsi
lea addresses_UC_ht+0x8425, %rdi
clflush (%rdi)
nop
nop
cmp $56235, %r10
...
nop
dec %r9
lea addresses_A_ht+0x17e25, %rdi
nop
nop
nop
xor %rbp, %rbp
...
nop
add %rbp, %rbp
lea addresses_D_ht+0x1c425, %rsi
lea addresses_WC_ht+0xbba5, %rdi
nop
nop
nop
nop
...
<gen_prepare_buffer>
{'src': {'same': True, 'congruent': 4, 'type': 'addresses_WC_ht'}, 'OP': 'REPM', 'dst': {'same': False, 'congruent': 6, 'type': 'addresses_UC_ht'}}
...
{'src': {'same': True, 'congruent': 10, 'type': 'addresses_D_ht'}, 'OP': 'REPM', 'dst': {'same': True, 'congruent': 7, 'type': 'addresses_WC_ht'}}
{'58': 21829}
