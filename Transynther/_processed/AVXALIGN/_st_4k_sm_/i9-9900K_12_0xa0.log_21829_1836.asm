...
nop
dec %rcx
lea addresses_normal_ht+0x128d1, %r8
nop
nop
nop
sub %rbp, %rbp
...
nop
cmp $36733, %rbp
lea addresses_UC_ht+0xb751, %r10
nop
sub %r12, %r12
mov (%r10), %rcx
inc %r8
lea addresses_WT_ht+0x2a91, %r11
clflush (%r11)
nop
nop
nop
...
{'OP': 'STOR', 'dst': {'NT': False, 'same': False, 'congruent': 11, 'type': 'addresses_PSE', 'AVXalign': False, 'size': 4}}
