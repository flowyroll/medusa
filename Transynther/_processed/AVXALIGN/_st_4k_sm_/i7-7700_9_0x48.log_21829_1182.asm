...
nop
cmp $21466, %rbp
lea addresses_normal_ht+0x7fe1, %r9
nop
inc %r8
movl $0x61626364, (%r9)
xor %rax, %rax
lea addresses_A_ht+0x5a8d, %rsi
...
nop
and %rdi, %rdi
lea addresses_normal_ht+0x3c1d, %rax
nop
nop
nop
nop
...
nop
cmp %r15, %r15
lea addresses_UC_ht+0x1181d, %rsi
...
nop
inc %r8
lea addresses_UC_ht+0xf61d, %r15
nop
nop
nop
nop
...
lea addresses_WC_ht+0xf81d, %rdi
nop
nop
nop
dec %r15
...
nop
and $17993, %r8
lea addresses_WT_ht+0x14f1, %rdi
cmp $3387, %rax
mov (%rdi), %r8d
nop
nop
...
// Store
lea addresses_D+0x1f81d, %r15
inc %rdx
movl $0x51525354, (%r15)
add $31154, %r12

// Store
lea addresses_normal+0x10d5, %r15
nop
nop
nop
dec %r14
...
{'OP': 'STOR', 'dst': {'type': 'addresses_UC', 'AVXalign': False, 'congruent': 11, 'size': 32, 'same': True, 'NT': False}}
...
{'OP': 'REPM', 'src': {'type': 'addresses_UC_ht', 'congruent': 11, 'same': False}, 'dst': {'type': 'addresses_WT_ht', 'congruent': 10, 'same': True}}
...
{'OP': 'LOAD', 'src': {'type': 'addresses_WT_ht', 'AVXalign': True, 'congruent': 1, 'size': 4, 'same': False, 'NT': False}}
