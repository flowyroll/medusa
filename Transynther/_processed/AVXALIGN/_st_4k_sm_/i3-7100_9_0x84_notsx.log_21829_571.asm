...
push %rdx
push %rsi
lea addresses_WC_ht+0x177e8, %rsi
lea addresses_UC_ht+0x19fe8, %rdi
nop
nop
and $29901, %r14
mov $44, %rcx
...
nop
add $40826, %rdi
lea addresses_WT_ht+0x82f8, %r13
nop
nop
nop
cmp %r10, %r10
...
// Store
lea addresses_normal+0x4be8, %r8
cmp $35065, %r14
...
{'src': {'type': 'addresses_WT', 'same': False, 'size': 1, 'congruent': 5, 'NT': True, 'AVXalign': False}, 'OP': 'LOAD'}
