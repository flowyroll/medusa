...
nop
and %rcx, %rcx
lea addresses_WC_ht+0x1dd2f, %rdi
nop
nop
nop
nop
...
// Store
lea addresses_normal+0xecf, %r14
clflush (%r14)
nop
nop
nop
...
{'src': {'type': 'addresses_WC', 'same': False, 'size': 8, 'congruent': 7, 'NT': False, 'AVXalign': False}, 'OP': 'LOAD'}
{'dst': {'type': 'addresses_US', 'same': False, 'size': 16, 'congruent': 9, 'NT': True, 'AVXalign': False}, 'OP': 'STOR'}
[Faulty Load]
