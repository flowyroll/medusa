...
push %rdi
push %rsi
lea addresses_A_ht+0x19800, %r12
nop
nop
nop
nop
...
nop
cmp $45879, %rbp
lea addresses_D_ht+0x16598, %rsi
nop
nop
nop
nop
...
nop
xor %rdi, %rdi
lea addresses_WT_ht+0x185c8, %r12
nop
and $2313, %r14
movb (%r12), %cl
sub %r12, %r12
...
{'44': 1, 'de': 1, '58': 21821, 'b4': 1, '2e': 1, '90': 1, '4a': 1, '80': 1, '5c': 1}
