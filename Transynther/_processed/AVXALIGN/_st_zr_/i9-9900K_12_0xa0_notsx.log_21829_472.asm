...
push %rdi
push %rsi
lea addresses_D_ht+0xc7cd, %rsi
lea addresses_UC_ht+0xdd4d, %rdi
nop
nop
nop
nop
...
lea addresses_UC_ht+0x9efd, %rdi
cmp $13589, %r12
mov $115, %rcx
rep movsq
nop
...
nop
and %rsi, %rsi
lea addresses_WT_ht+0x14dcd, %rcx
nop
nop
nop
dec %rax
...
nop
cmp %rbx, %rbx
lea addresses_WC_ht+0x3a0d, %rsi
lea addresses_A_ht+0x1e074, %rdi
nop
sub %r8, %r8
mov $9, %rcx
rep movsq
xor $60010, %r8
lea addresses_A_ht+0x19d25, %rsi
...
nop
add $16119, %r8
lea addresses_WT_ht+0x4e89, %rdi
nop
and %rcx, %rcx
movw $0x6162, (%rdi)
nop
...
nop
add $20183, %rbx
lea addresses_WT_ht+0x1a36d, %rsi
lea addresses_WT_ht+0x1c1cd, %rdi
nop
nop
dec %rax
mov $4, %rcx
...
nop
and %rax, %rax
lea addresses_D_ht+0x9fed, %rsi
lea addresses_WC_ht+0x81cd, %rdi
nop
nop
nop
nop
...
nop
xor %rbx, %rbx
lea addresses_A_ht+0x13f21, %rsi
lea addresses_WC_ht+0x19faf, %rdi
nop
nop
nop
nop
...
rep movsl
dec %rdi
lea addresses_normal_ht+0x111cd, %r8
nop
nop
add $64015, %rbx
movb (%r8), %cl
...
{'src': {'type': 'addresses_normal_ht', 'congruent': 8, 'same': False}, 'OP': 'REPM', 'dst': {'type': 'addresses_UC_ht', 'congruent': 3, 'same': False}}
...
{'src': {'type': 'addresses_WT_ht', 'congruent': 5, 'same': True}, 'OP': 'REPM', 'dst': {'type': 'addresses_WT_ht', 'congruent': 6, 'same': False}}
