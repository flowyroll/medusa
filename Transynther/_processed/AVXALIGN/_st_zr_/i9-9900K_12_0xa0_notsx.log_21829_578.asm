...
push %rdi
push %rsi
lea addresses_normal_ht+0x20c4, %r8
nop
nop
and $24242, %r12
movl $0x61626364, (%r8)
...
nop
cmp %rcx, %rcx
lea addresses_normal_ht+0x1da51, %r15
dec %r14
movl $0x61626364, (%r15)
nop
nop
add %r8, %r8
lea addresses_WC_ht+0xf2e1, %rsi
lea addresses_WC_ht+0x17494, %rdi
nop
nop
nop
nop
...
// Store
lea addresses_normal+0xad51, %r8
nop
nop
and %rbx, %rbx
movl $0x51525354, (%r8)
...
// Store
lea addresses_normal+0x13829, %rbp
nop
nop
nop
nop
...
{'src': {'type': 'addresses_P', 'AVXalign': False, 'size': 4, 'NT': True, 'same': False, 'congruent': 3}, 'OP': 'LOAD'}
