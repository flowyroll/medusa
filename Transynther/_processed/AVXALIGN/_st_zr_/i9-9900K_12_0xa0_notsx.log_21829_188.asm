...
push %rdi
push %rsi
lea addresses_A_ht+0x183ee, %r12
nop
nop
nop
xor %r11, %r11
...
nop
add $55130, %rdi
lea addresses_A_ht+0x1b1ee, %rsi
...
nop
dec %rsi
lea addresses_D_ht+0x1d3ee, %rbp
nop
nop
nop
xor %r12, %r12
mov (%rbp), %r11
sub $14714, %rsi
lea addresses_UC_ht+0x1aade, %rdi
nop
nop
nop
nop
...
nop
xor %rax, %rax
lea addresses_UC_ht+0x1d732, %rdi
dec %r11
mov (%rdi), %r12d
nop
nop
...
nop
sub $39720, %rdi
lea addresses_WC_ht+0x1732f, %rsi
nop
cmp $26323, %r11
mov $0x6162636465666768, %rbp
movq %rbp, %xmm7
...
nop
add $24319, %rcx
lea addresses_UC_ht+0xb52a, %rsi
lea addresses_A_ht+0x8e6e, %rdi
nop
nop
and $49550, %rax
mov $71, %rcx
...
{'OP': 'STOR', 'dst': {'type': 'addresses_WC_ht', 'AVXalign': False, 'size': 32, 'NT': True, 'same': False, 'congruent': 0}}
{'src': {'type': 'addresses_A_ht', 'AVXalign': False, 'size': 2, 'NT': False, 'same': True, 'congruent': 7}, 'OP': 'LOAD'}
{'src': {'type': 'addresses_UC_ht', 'congruent': 1, 'same': False}, 'OP': 'REPM', 'dst': {'type': 'addresses_A_ht', 'congruent': 5, 'same': False}}
