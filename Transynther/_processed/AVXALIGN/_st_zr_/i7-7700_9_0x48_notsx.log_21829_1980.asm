...
push %rdx
push %rsi
lea addresses_A_ht+0x1122a, %rbp
nop
nop
nop
nop
...
nop
sub %r11, %r11
lea addresses_WC_ht+0x13f0a, %rsi
nop
sub $65105, %r14
movb $0x61, (%rsi)
nop
...
nop
sub %rdx, %rdx
lea addresses_WT_ht+0x1619a, %rsi
lea addresses_normal_ht+0x152aa, %rdi
clflush (%rdi)
nop
nop
nop
...
nop
dec %r14
lea addresses_A_ht+0x1062a, %rdx
sub %rbp, %rbp
movl $0x61626364, (%rdx)
nop
nop
...
nop
inc %rcx
lea addresses_WT_ht+0xaa2a, %rbp
nop
nop
nop
nop
...
nop
inc %r11
lea addresses_A_ht+0x1ec1a, %rsi
clflush (%rsi)
nop
nop
nop
...
nop
dec %r14
lea addresses_normal_ht+0x790a, %r10
nop
nop
nop
nop
...
nop
add %r13, %r13
lea addresses_normal_ht+0xe85a, %r11
nop
nop
nop
add %rcx, %rcx
