...
push %rbx
push %rdx
lea addresses_A_ht+0x479b, %r14
add $56966, %r8
movb $0x61, (%r14)
cmp $50055, %r12
lea addresses_A_ht+0x108d3, %rbx
nop
nop
nop
nop
...
movups %xmm5, (%rbx)
xor $28867, %r8
lea addresses_UC_ht+0xedc3, %r15
nop
nop
nop
nop
...
// REPMOV
lea addresses_normal+0xa907, %rsi
lea addresses_WT+0x1b453, %rdi
nop
nop
nop
nop
...
// Faulty Load
lea addresses_normal+0x15d3, %r13
nop
nop
add %rdi, %rdi
movntdqa (%r13), %xmm5
...
{'src': {'type': 'addresses_normal', 'congruent': 1, 'same': False}, 'dst': {'type': 'addresses_WT', 'congruent': 6, 'same': False}, 'OP': 'REPM'}
{'dst': {'type': 'addresses_UC', 'same': False, 'size': 2, 'congruent': 10, 'NT': False, 'AVXalign': False}, 'OP': 'STOR'}
{'dst': {'type': 'addresses_RW', 'same': False, 'size': 2, 'congruent': 5, 'NT': True, 'AVXalign': False}, 'OP': 'STOR'}
[Faulty Load]
