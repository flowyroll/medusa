...
lea addresses_WT_ht+0x17aa5, %rdi
nop
nop
nop
nop
...
nop
xor %rcx, %rcx
lea addresses_WT_ht+0x16b25, %r9
nop
and $15810, %rcx
...
nop
cmp $17428, %r11
lea addresses_normal_ht+0x1b955, %rcx
nop
nop
nop
cmp $49009, %rbx
...
nop
cmp %rdi, %rdi
lea addresses_WT_ht+0x5add, %rbx
clflush (%rbx)
nop
nop
nop
...
nop
cmp %r11, %r11
lea addresses_WT_ht+0x1ca05, %r9
nop
nop
nop
nop
...
lea addresses_WT_ht+0x1c881, %rdi
clflush (%rsi)
nop
inc %rbx
mov $86, %rcx
