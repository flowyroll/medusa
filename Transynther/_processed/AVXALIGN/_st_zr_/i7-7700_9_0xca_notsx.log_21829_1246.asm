...
push %rdx
push %rsi
lea addresses_normal_ht+0x1238e, %rax
nop
nop
nop
nop
...
nop
sub %r13, %r13
lea addresses_UC_ht+0x1332e, %rsi
lea addresses_WC_ht+0x1bdd6, %rdi
clflush (%rsi)
nop
nop
nop
...
{'dst': {'NT': False, 'AVXalign': True, 'size': 4, 'congruent': 3, 'same': False, 'type': 'addresses_WT'}, 'OP': 'STOR'}
...
{'src': {'congruent': 10, 'same': False, 'type': 'addresses_UC_ht'}, 'dst': {'congruent': 3, 'same': False, 'type': 'addresses_WC_ht'}, 'OP': 'REPM'}
