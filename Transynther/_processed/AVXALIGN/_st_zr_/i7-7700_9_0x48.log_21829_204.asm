...
push %rdx
push %rsi
lea addresses_WC_ht+0x187e5, %rsi
lea addresses_WT_ht+0x17e5, %rdi
dec %r11
mov $31, %rcx
rep movsb
nop
sub %rdx, %rdx
lea addresses_WC_ht+0x13165, %rsi
lea addresses_WT_ht+0x2925, %rdi
nop
nop
nop
nop
...
nop
sub $29974, %rsi
lea addresses_UC_ht+0x19d9e, %rsi
lea addresses_D_ht+0xb3e5, %rdi
nop
nop
nop
nop
...
nop
and %rcx, %rcx
lea addresses_D_ht+0x16e93, %rsi
lea addresses_normal_ht+0x87e5, %rdi
nop
nop
nop
sub %r8, %r8
...
rep movsw
dec %rdx
lea addresses_D_ht+0x4065, %rsi
lea addresses_WT_ht+0x57e5, %rdi
nop
nop
nop
nop
...
nop
xor $50839, %rdx
lea addresses_UC_ht+0x7de5, %rdi
clflush (%rdi)
nop
nop
nop
...
nop
and %rdi, %rdi
lea addresses_UC_ht+0x19125, %rsi
...
nop
sub $6147, %rsi
lea addresses_D_ht+0x10daf, %rsi
lea addresses_D_ht+0x1cf65, %rdi
nop
nop
nop
nop
...
lea addresses_WC_ht+0x1cde5, %rdi
clflush (%rdi)
cmp %r8, %r8
mov $94, %rcx
rep movsq
...
nop
sub %rdx, %rdx
lea addresses_WC_ht+0x147e5, %rdi
nop
nop
sub $4429, %r8
...
movq %r11, (%rdi)
and $34518, %rsi
lea addresses_D_ht+0x137e5, %r11
nop
cmp %rdx, %rdx
vmovups (%r11), %ymm5
...
nop
cmp %r13, %r13
lea addresses_UC_ht+0x19d2d, %rdx
cmp $26160, %rdi
...
nop
dec %rcx
lea addresses_A_ht+0x177f9, %rbp
clflush (%rbp)
nop
nop
nop
...
{'OP': 'REPM', 'src': {'type': 'addresses_WC_ht', 'congruent': 5, 'same': False}, 'dst': {'type': 'addresses_WT_ht', 'congruent': 5, 'same': False}}
{'OP': 'REPM', 'src': {'type': 'addresses_UC_ht', 'congruent': 0, 'same': False}, 'dst': {'type': 'addresses_D_ht', 'congruent': 10, 'same': False}}
{'OP': 'REPM', 'src': {'type': 'addresses_D_ht', 'congruent': 1, 'same': False}, 'dst': {'type': 'addresses_normal_ht', 'congruent': 8, 'same': False}}
