...
nop
xor $32986, %r8
lea addresses_D_ht+0x3e95, %rsi
lea addresses_D_ht+0x4121, %rdi
clflush (%rdi)
nop
nop
nop
...
nop
and $30913, %rsi
lea addresses_UC_ht+0x1b695, %r13
nop
nop
nop
xor $20043, %r8
...
nop
and %rcx, %rcx
lea addresses_WT_ht+0x2b95, %rsi
lea addresses_D_ht+0x13e95, %rdi
nop
nop
nop
nop
...
rep movsq
and $8822, %rcx
lea addresses_D_ht+0x4fd5, %rsi
lea addresses_WC_ht+0x10295, %rdi
cmp $38855, %r11
mov $34, %rcx
rep movsb
nop
...
[Faulty Load]
{'src': {'type': 'addresses_A', 'same': True, 'size': 4, 'congruent': 0, 'NT': False, 'AVXalign': True}, 'OP': 'LOAD'}
<gen_prepare_buffer>
...
{'src': {'type': 'addresses_WT_ht', 'congruent': 6, 'same': False}, 'dst': {'type': 'addresses_D_ht', 'congruent': 11, 'same': True}, 'OP': 'REPM'}
