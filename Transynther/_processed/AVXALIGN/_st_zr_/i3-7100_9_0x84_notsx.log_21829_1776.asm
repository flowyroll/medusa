...
nop
add %r13, %r13
lea addresses_UC_ht+0x1d844, %rsi
lea addresses_A_ht+0x15c84, %rdi
nop
nop
nop
nop
...
nop
cmp %r13, %r13
lea addresses_WT_ht+0x13d24, %rsi
lea addresses_A_ht+0x167e4, %rdi
dec %r14
mov $48, %rcx
rep movsl
nop
and $53768, %r14
lea addresses_A_ht+0x8274, %rdi
nop
lfence
mov (%rdi), %r14d
nop
...
{'src': {'type': 'addresses_UC_ht', 'congruent': 5, 'same': False}, 'dst': {'type': 'addresses_A_ht', 'congruent': 3, 'same': False}, 'OP': 'REPM'}
{'src': {'type': 'addresses_WT_ht', 'congruent': 5, 'same': False}, 'dst': {'type': 'addresses_A_ht', 'congruent': 7, 'same': False}, 'OP': 'REPM'}
