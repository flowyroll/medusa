...
push %rdi
push %rsi
lea addresses_UC_ht+0x93a9, %rsi
lea addresses_UC_ht+0xeb01, %rdi
nop
and %rbp, %rbp
mov $6, %rcx
rep movsl
...
nop
dec %r13
lea addresses_normal_ht+0x1c101, %rcx
clflush (%rcx)
nop
nop
add $48523, %r11
...
nop
cmp %rsi, %rsi
lea addresses_WC_ht+0xc701, %rsi
lea addresses_normal_ht+0x1eea1, %rdi
nop
nop
nop
nop
...
nop
inc %rcx
lea addresses_WC_ht+0x16b01, %r11
xor %rbp, %rbp
mov (%r11), %cx
nop
nop
...
nop
sub %rsi, %rsi
lea addresses_WC_ht+0xc901, %r14
nop
and $40009, %r11
mov (%r14), %r13d
nop
nop
and $63006, %rcx
lea addresses_A_ht+0x12101, %r11
clflush (%r11)
nop
nop
nop
...
nop
dec %r14
lea addresses_normal_ht+0x1b501, %r11
xor $58696, %rbp
movb $0x61, (%r11)
nop
nop
...
// REPMOV
lea addresses_normal+0x62d1, %rsi
lea addresses_normal+0x3c01, %rdi
nop
nop
nop
nop
...
// REPMOV
lea addresses_WC+0x19101, %rsi
lea addresses_WC+0x1e2f7, %rdi
and $22090, %r13
mov $122, %rcx
rep movsw
add %r13, %r13
...
// Store
lea addresses_normal+0x9701, %rax
inc %rdi
movb $0x51, (%rax)
nop
nop
...
{'OP': 'LOAD', 'src': {'type': 'addresses_WT', 'size': 2, 'AVXalign': False, 'NT': False, 'congruent': 2, 'same': True}}
{'OP': 'STOR', 'dst': {'type': 'addresses_WT', 'size': 1, 'AVXalign': False, 'NT': False, 'congruent': 5, 'same': False}}
{'OP': 'REPM', 'src': {'type': 'addresses_normal', 'congruent': 3, 'same': False}, 'dst': {'type': 'addresses_normal', 'congruent': 8, 'same': False}}
{'OP': 'STOR', 'dst': {'type': 'addresses_A', 'size': 8, 'AVXalign': True, 'NT': False, 'congruent': 1, 'same': False}}
{'OP': 'REPM', 'src': {'type': 'addresses_WC', 'congruent': 10, 'same': False}, 'dst': {'type': 'addresses_WC', 'congruent': 1, 'same': False}}
