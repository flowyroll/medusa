...
lea addresses_UC_ht+0x1405d, %rdi
nop
sub $64949, %rbp
mov $13, %rcx
rep movsq
...
nop
cmp $59728, %rdx
lea addresses_WC_ht+0x8709, %rbp
nop
nop
cmp $55987, %r8
movb (%rbp), %r11b
nop
sub %rcx, %rcx
lea addresses_UC_ht+0x585d, %r11
nop
nop
nop
inc %rbp
...
nop
inc %r8
lea addresses_UC_ht+0x13b5d, %rdx
nop
nop
cmp %rdi, %rdi
mov (%rdx), %rcx
...
nop
and %rsi, %rsi
lea addresses_D_ht+0x1345d, %rcx
nop
add %rdi, %rdi
mov (%rcx), %edx
nop
...
movups %xmm2, (%r8)
dec %rcx
lea addresses_normal_ht+0x1693d, %rsi
lea addresses_WC_ht+0x1485d, %rdi
nop
nop
nop
nop
...
nop
add %r10, %r10
lea addresses_UC_ht+0x1a1cf, %rsi
lea addresses_normal_ht+0x190fc, %rdi
clflush (%rdi)
nop
xor $15063, %rdx
mov $103, %rcx
...
nop
add %r11, %r11
lea addresses_WC_ht+0x2131, %r10
nop
xor $60735, %rcx
mov (%r10), %rdi
cmp $11545, %rbp
lea addresses_normal_ht+0xe89d, %rbp
nop
xor $46903, %r11
mov (%rbp), %r8d
sub %rbp, %rbp
lea addresses_D_ht+0x165dd, %rsi
lea addresses_WC_ht+0x21cb, %rdi
clflush (%rsi)
xor $42579, %r10
mov $69, %rcx
rep movsl
...
nop
and $8668, %r11
lea addresses_A_ht+0x139d5, %r11
and %rbp, %rbp
