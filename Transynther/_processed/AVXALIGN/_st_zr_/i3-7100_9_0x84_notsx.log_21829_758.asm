...
// REPMOV
lea addresses_normal+0x1995e, %rsi
lea addresses_A+0x20fa, %rdi
nop
nop
nop
cmp %r15, %r15
...
{'src': {'type': 'addresses_normal', 'congruent': 3, 'same': False}, 'dst': {'type': 'addresses_A', 'congruent': 2, 'same': False}, 'OP': 'REPM'}
[Faulty Load]
