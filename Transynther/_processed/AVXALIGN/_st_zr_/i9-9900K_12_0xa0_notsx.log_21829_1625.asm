...
push %rdi
push %rsi
lea addresses_D_ht+0x192e0, %r14
nop
nop
sub %r10, %r10
vmovups (%r14), %ymm3
...
nop
xor $17522, %r11
lea addresses_A_ht+0x1e8e0, %r13
nop
nop
nop
cmp %r14, %r14
...
nop
inc %r11
lea addresses_A_ht+0x6b60, %rsi
lea addresses_A_ht+0xf8c0, %rdi
nop
nop
nop
nop
...
nop
cmp $27071, %rcx
lea addresses_normal_ht+0x1cbe0, %r9
nop
xor $40109, %rsi
...
nop
add %r14, %r14
lea addresses_UC_ht+0xd320, %rsi
lea addresses_D_ht+0xbf0, %rdi
add %r14, %r14
mov $60, %rcx
rep movsq
nop
xor $31383, %rsi
lea addresses_normal_ht+0xdad3, %rsi
lea addresses_A_ht+0x3cd6, %rdi
nop
nop
nop
nop
...
nop
and %r13, %r13
lea addresses_WC_ht+0x1d2e0, %rsi
lea addresses_D_ht+0x186e0, %rdi
nop
nop
nop
add $4631, %r11
...
nop
cmp $41269, %r9
lea addresses_WC_ht+0x1c480, %r9
clflush (%r9)
nop
nop
add %rcx, %rcx
movl $0x61626364, (%r9)
add $28713, %r11
lea addresses_WT_ht+0x18980, %r9
add %r11, %r11
mov (%r9), %di
nop
nop
...
{'OP': 'STOR', 'dst': {'type': 'addresses_D', 'AVXalign': False, 'size': 4, 'NT': False, 'same': False, 'congruent': 3}}
[Faulty Load]
...
{'src': {'type': 'addresses_A_ht', 'congruent': 5, 'same': False}, 'OP': 'REPM', 'dst': {'type': 'addresses_A_ht', 'congruent': 4, 'same': True}}
{'OP': 'STOR', 'dst': {'type': 'addresses_normal_ht', 'AVXalign': False, 'size': 32, 'NT': False, 'same': False, 'congruent': 7}}
{'src': {'type': 'addresses_UC_ht', 'congruent': 3, 'same': False}, 'OP': 'REPM', 'dst': {'type': 'addresses_D_ht', 'congruent': 3, 'same': True}}
