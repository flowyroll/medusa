...
push %rdi
push %rsi
lea addresses_WC_ht+0x1454d, %rcx
nop
nop
nop
inc %r11
...
nop
inc %r11
lea addresses_A_ht+0x190b1, %rsi
nop
xor %r12, %r12
...
nop
inc %rcx
lea addresses_WT_ht+0x844d, %rbp
nop
nop
nop
xor %rbx, %rbx
...
vpextrq $1, %xmm4, %r11
xor $35947, %rsi
lea addresses_WT_ht+0x1119c, %rsi
lea addresses_WT_ht+0xb3fd, %rdi
nop
nop
nop
nop
...
nop
add %rbp, %rbp
lea addresses_WT_ht+0x1c34d, %r10
nop
nop
nop
sub %rcx, %rcx
...
nop
add %r12, %r12
lea addresses_A_ht+0x1c7b5, %rbp
cmp %rbx, %rbx
movups (%rbp), %xmm3
vpextrq $1, %xmm3, %r12
nop
...
nop
and $6853, %r10
lea addresses_UC_ht+0xa74d, %rdi
nop
and %rbp, %rbp
vmovups (%rdi), %ymm6
...
nop
lfence
lea addresses_WT_ht+0x19945, %rsi
lea addresses_normal_ht+0x2b4d, %rdi
nop
nop
inc %rbp
mov $103, %rcx
...
nop
cmp $49082, %rsi
lea addresses_A_ht+0x1414d, %r10
nop
nop
sub %rdi, %rdi
movb (%r10), %r12b
nop
add $5258, %rcx
lea addresses_D_ht+0x1d5dd, %rcx
nop
nop
nop
nop
...
nop
xor %rcx, %rcx
lea addresses_WC_ht+0x254d, %rcx
nop
nop
nop
nop
...
mov (%rcx), %rdi
sub $8256, %rbx
lea addresses_WC_ht+0x1eecd, %rsi
lea addresses_UC_ht+0x6d4d, %rdi
nop
nop
nop
nop
...
// Load
lea addresses_normal+0x9562, %r13
nop
nop
sub $49859, %rdx
mov (%r13), %r11d
...
[Faulty Load]
{'src': {'congruent': 0, 'AVXalign': False, 'same': True, 'size': 1, 'NT': True, 'type': 'addresses_WT'}, 'OP': 'LOAD'}
<gen_prepare_buffer>
...
{'src': {'congruent': 3, 'same': False, 'type': 'addresses_WT_ht'}, 'OP': 'REPM', 'dst': {'congruent': 9, 'same': True, 'type': 'addresses_normal_ht'}}
...
{'src': {'congruent': 6, 'same': False, 'type': 'addresses_WC_ht'}, 'OP': 'REPM', 'dst': {'congruent': 11, 'same': False, 'type': 'addresses_UC_ht'}}
{'58': 21829}
