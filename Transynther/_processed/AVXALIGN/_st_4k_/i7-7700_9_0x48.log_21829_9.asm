...
nop
xor %rbx, %rbx
lea addresses_UC_ht+0x11ad7, %rbp
nop
xor $18704, %rbx
movw $0x6162, (%rbp)
sub %r12, %r12
lea addresses_D_ht+0xf08c, %rsi
lea addresses_D_ht+0x7c1d, %rdi
clflush (%rsi)
nop
dec %rbp
mov $69, %rcx
...
nop
add $56255, %r13
lea addresses_UC_ht+0xd357, %rbp
nop
nop
nop
nop
...
nop
inc %rax
lea addresses_WT_ht+0x16ad7, %rcx
nop
xor $22252, %rbp
mov (%rcx), %ax
nop
...
{'OP': 'STOR', 'dst': {'type': 'addresses_UC', 'AVXalign': False, 'congruent': 9, 'size': 2, 'same': False, 'NT': True}}
...
{'OP': 'REPM', 'src': {'type': 'addresses_D_ht', 'congruent': 0, 'same': False}, 'dst': {'type': 'addresses_D_ht', 'congruent': 1, 'same': True}}
