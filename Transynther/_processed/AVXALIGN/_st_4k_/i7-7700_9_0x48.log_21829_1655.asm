...
push %rdi
push %rsi
lea addresses_WT_ht+0x1ed97, %r8
nop
nop
sub %r14, %r14
movb (%r8), %cl
nop
dec %rsi
lea addresses_WT_ht+0x3889, %r10
dec %r11
...
nop
sub %r14, %r14
lea addresses_A_ht+0x1a197, %rsi
lea addresses_normal_ht+0xe8e2, %rdi
nop
nop
nop
nop
...
rep movsb
xor %r14, %r14
lea addresses_UC_ht+0xe097, %r14
nop
nop
nop
cmp $46670, %rsi
...
nop
xor %rcx, %rcx
lea addresses_WC_ht+0x14a65, %r8
nop
add $51787, %rsi
movw $0x6162, (%r8)
nop
cmp %r10, %r10
lea addresses_UC_ht+0x7329, %rsi
lea addresses_WT_ht+0x2097, %rdi
nop
nop
nop
cmp $420, %r8
...
nop
dec %rsi
lea addresses_A_ht+0x1b407, %r14
nop
nop
nop
nop
...
vpextrq $0, %xmm6, %r11
cmp %r11, %r11
lea addresses_WC_ht+0x64af, %rsi
...
// Store
lea addresses_normal+0xc497, %rsi
nop
nop
xor %r8, %r8
movl $0x51525354, (%rsi)
...
// Store
lea addresses_normal+0x10c97, %r15
cmp %rsi, %rsi
...
{'OP': 'LOAD', 'src': {'type': 'addresses_RW', 'AVXalign': False, 'congruent': 11, 'size': 16, 'same': False, 'NT': False}}
...
{'OP': 'STOR', 'dst': {'type': 'addresses_WC_ht', 'AVXalign': True, 'congruent': 1, 'size': 2, 'same': False, 'NT': False}}
