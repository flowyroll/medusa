...
push %rdx
push %rsi
lea addresses_WT_ht+0x157bb, %rax
nop
nop
cmp $5144, %r8
movb $0x61, (%rax)
...
nop
xor %r8, %r8
lea addresses_UC_ht+0x4e60, %rdi
nop
nop
nop
nop
...
nop
and %rax, %rax
lea addresses_normal_ht+0x1ab5b, %rsi
lea addresses_normal_ht+0x7d1b, %rdi
clflush (%rsi)
clflush (%rdi)
nop
nop
...
rep movsl
dec %r13
lea addresses_normal_ht+0x1eddb, %r13
nop
nop
nop
nop
...
nop
and $15650, %rdi
lea addresses_WC_ht+0xb51b, %rdi
clflush (%rdi)
nop
add $13787, %r14
movl $0x61626364, (%rdi)
...
nop
xor %rsi, %rsi
lea addresses_normal_ht+0x21e3, %rsi
lea addresses_WT_ht+0x7c1b, %rdi
sub %r13, %r13
mov $47, %rcx
rep movsl
cmp %rcx, %rcx
lea addresses_WC_ht+0x11e5b, %rbp
xor %rax, %rax
movups (%rbp), %xmm7
vpextrq $1, %xmm7, %rdx
nop
...
nop
sub $53754, %rdx
lea addresses_normal_ht+0x231b, %rcx
clflush (%rcx)
nop
nop
add $33575, %rsi
...
nop
and $4531, %rbp
lea addresses_normal_ht+0x11bcb, %rsi
lea addresses_A_ht+0x1d51b, %rdi
nop
nop
nop
nop
...
rep movsw
add $33916, %rdx
lea addresses_normal_ht+0x1ad1b, %rax
nop
nop
nop
nop
...
nop
xor %rdi, %rdi
lea addresses_normal_ht+0x1811b, %rsi
lea addresses_UC_ht+0x1851b, %rdi
nop
nop
nop
cmp $37658, %r14
