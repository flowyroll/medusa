...
nop
add %rcx, %rcx
lea addresses_WT_ht+0x1b4eb, %rsi
nop
nop
nop
lfence
...
nop
dec %rsi
lea addresses_D_ht+0x1a0eb, %rsi
lea addresses_normal_ht+0x1296b, %rdi
nop
nop
nop
nop
...
nop
sub %rdi, %rdi
lea addresses_normal_ht+0x57cb, %rdi
nop
nop
xor %r15, %r15
movb (%rdi), %bl
...
// Store
lea addresses_normal+0x177ab, %r8
nop
sub %rbx, %rbx
movl $0x51525354, (%r8)
xor $46717, %rbx
