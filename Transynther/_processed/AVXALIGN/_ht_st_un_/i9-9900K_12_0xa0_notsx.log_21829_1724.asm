...
nop
sub %r15, %r15
lea addresses_A_ht+0x2f55, %rsi
lea addresses_WT_ht+0x1ca55, %rdi
nop
nop
nop
nop
...
nop
dec %rdi
lea addresses_WC_ht+0x6da0, %rsi
nop
nop
nop
nop
...
nop
add %r12, %r12
lea addresses_UC_ht+0x4c55, %rsi
lea addresses_normal_ht+0xa71d, %rdi
nop
nop
cmp $53552, %r12
mov $75, %rcx
...
nop
inc %r13
lea addresses_UC_ht+0x159a9, %rsi
lea addresses_normal_ht+0x1afd5, %rdi
nop
xor $36353, %rax
mov $16, %rcx
rep movsq
...
nop
xor %r13, %r13
lea addresses_A_ht+0x1e255, %rsi
lea addresses_normal_ht+0x17255, %rdi
nop
nop
xor $47059, %r12
mov $85, %rcx
...
{'src': {'type': 'addresses_A_ht', 'congruent': 7, 'same': False}, 'OP': 'REPM', 'dst': {'type': 'addresses_WT_ht', 'congruent': 10, 'same': False}}
...
{'OP': 'STOR', 'dst': {'type': 'addresses_WC_ht', 'AVXalign': False, 'size': 32, 'NT': True, 'same': True, 'congruent': 0}}
{'src': {'type': 'addresses_UC_ht', 'congruent': 8, 'same': False}, 'OP': 'REPM', 'dst': {'type': 'addresses_normal_ht', 'congruent': 3, 'same': False}}
