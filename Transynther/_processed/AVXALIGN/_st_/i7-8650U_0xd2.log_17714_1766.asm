...
push %rdx
push %rsi
lea addresses_normal_ht+0xc01e, %rsi
lea addresses_A_ht+0x8a40, %rdi
add $58994, %rbp
mov $42, %rcx
rep movsq
add $11103, %rbp
lea addresses_A_ht+0x10a66, %rdx
nop
nop
inc %rax
...
nop
xor $33877, %rax
lea addresses_normal_ht+0xeca6, %rbp
clflush (%rbp)
nop
nop
nop
...
nop
inc %rsi
lea addresses_A_ht+0x126c6, %rbp
nop
nop
nop
nop
...
nop
sub $46506, %r11
lea addresses_WC_ht+0x86c6, %rsi
lea addresses_D_ht+0xd146, %rdi
nop
inc %r13
mov $87, %rcx
rep movsb
nop
sub %rdx, %rdx
lea addresses_normal_ht+0x29c6, %rax
clflush (%rax)
nop
and %rdi, %rdi
mov (%rax), %r11w
...
nop
sub $50194, %rsi
lea addresses_A_ht+0x176c6, %rsi
lea addresses_A_ht+0x1eec6, %rdi
nop
nop
nop
nop
...
nop
inc %rax
lea addresses_WC_ht+0x27c6, %rsi
...
nop
xor %r13, %r13
lea addresses_WC_ht+0xac6, %rsi
lea addresses_WT_ht+0xd8c6, %rdi
xor %r13, %r13
mov $118, %rcx
rep movsq
inc %rdx
lea addresses_D_ht+0x183b6, %rcx
nop
nop
nop
xor $6149, %rdx
...
nop
add $14944, %r13
lea addresses_WT_ht+0x623e, %rsi
...
// Faulty Load
lea addresses_normal+0xec6, %r14
nop
nop
nop
nop
...
{'OP': 'LOAD', 'src': {'type': 'addresses_A_ht', 'size': 32, 'AVXalign': True, 'NT': True, 'congruent': 4, 'same': False}}
...
{'OP': 'REPM', 'src': {'type': 'addresses_A_ht', 'congruent': 11, 'same': False}, 'dst': {'type': 'addresses_A_ht', 'congruent': 8, 'same': True}}
...
{'OP': 'REPM', 'src': {'type': 'addresses_WT_ht', 'congruent': 2, 'same': False}, 'dst': {'type': 'addresses_D_ht', 'congruent': 7, 'same': False}}
