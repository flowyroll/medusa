...
push %rdx
push %rsi
lea addresses_WT_ht+0x793e, %r8
dec %r15
movl $0x61626364, (%r8)
cmp %rdx, %rdx
lea addresses_D_ht+0x16de5, %rbx
nop
dec %r13
mov (%rbx), %r8w
nop
cmp $43664, %rbx
lea addresses_A_ht+0x12198, %r8
clflush (%r8)
nop
nop
nop
...
movb (%r8), %bl
and $59131, %rbx
lea addresses_WT_ht+0x15126, %r12
nop
nop
nop
sub %rdi, %rdi
...
nop
and %r15, %r15
lea addresses_normal_ht+0x1eb36, %r13
nop
and $7673, %rdi
movb (%r13), %dl
dec %r15
lea addresses_WT_ht+0x346, %rsi
lea addresses_D_ht+0x185e6, %rdi
nop
nop
sub $42447, %rbx
mov $27, %rcx
...
nop
sub $19080, %r15
lea addresses_normal_ht+0x10db2, %r12
nop
nop
nop
and %r13, %r13
...
nop
and $60288, %rdi
lea addresses_A_ht+0x170f2, %rcx
nop
and $62522, %rdx
movups (%rcx), %xmm3
vpextrq $0, %xmm3, %r13
...
nop
cmp $8699, %r13
lea addresses_A_ht+0x19446, %rcx
nop
nop
nop
xor %r15, %r15
...
nop
and $28857, %rcx
lea addresses_normal_ht+0x4446, %r12
nop
nop
nop
nop
...
nop
and %r15, %r15
lea addresses_D_ht+0xf346, %rsi
lea addresses_normal_ht+0xdefe, %rdi
nop
nop
nop
xor $6869, %r12
...
nop
add %rdi, %rdi
lea addresses_UC_ht+0x1ca7c, %rsi
lea addresses_WC_ht+0x18f0f, %rdi
nop
nop
nop
sub $33448, %rbx
...
{'OP': 'LOAD', 'src': {'same': True, 'type': 'addresses_normal_ht', 'NT': False, 'AVXalign': False, 'size': 1, 'congruent': 4}}
...
{'OP': 'STOR', 'dst': {'same': False, 'type': 'addresses_A_ht', 'NT': True, 'AVXalign': False, 'size': 1, 'congruent': 8}}
{'OP': 'STOR', 'dst': {'same': False, 'type': 'addresses_normal_ht', 'NT': False, 'AVXalign': False, 'size': 4, 'congruent': 7}}
{'OP': 'REPM', 'src': {'same': False, 'congruent': 11, 'type': 'addresses_D_ht'}, 'dst': {'same': False, 'congruent': 1, 'type': 'addresses_normal_ht'}}
{'OP': 'REPM', 'src': {'same': False, 'congruent': 0, 'type': 'addresses_UC_ht'}, 'dst': {'same': False, 'congruent': 0, 'type': 'addresses_WC_ht'}}
{'32': 21829}
