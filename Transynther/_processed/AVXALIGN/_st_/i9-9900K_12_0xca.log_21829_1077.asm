...
nop
add %rdi, %rdi
lea addresses_normal_ht+0x133ae, %rdx
xor %rax, %rax
movb $0x61, (%rdx)
nop
cmp $36363, %rax
lea addresses_D_ht+0xa114, %rsi
lea addresses_normal_ht+0x1a3ae, %rdi
nop
nop
xor $29401, %r10
mov $119, %rcx
rep movsq
xor $57274, %r10
lea addresses_A_ht+0x128ce, %rax
sub $23510, %rcx
vmovups (%rax), %ymm3
...
{'OP': 'STOR', 'dst': {'size': 32, 'NT': True, 'type': 'addresses_D', 'same': False, 'AVXalign': False, 'congruent': 9}}
{'OP': 'LOAD', 'src': {'size': 16, 'NT': False, 'type': 'addresses_NC', 'same': False, 'AVXalign': False, 'congruent': 9}}
...
{'OP': 'REPM', 'src': {'same': False, 'type': 'addresses_D_ht', 'congruent': 1}, 'dst': {'same': True, 'type': 'addresses_normal_ht', 'congruent': 9}}
