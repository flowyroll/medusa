...
push %rdi
push %rsi
lea addresses_D_ht+0x1d2c7, %r12
nop
add $54479, %rcx
movb (%r12), %al
xor $6204, %r14
lea addresses_UC_ht+0x1be43, %r13
inc %r12
movb (%r13), %r10b
nop
sub $5232, %rcx
lea addresses_normal_ht+0x1eb07, %r14
nop
dec %r13
mov (%r14), %r12d
nop
...
nop
add %rcx, %rcx
lea addresses_normal_ht+0xb607, %r13
and $37586, %r11
mov (%r13), %r14w
nop
nop
inc %rax
lea addresses_normal_ht+0x14487, %r12
nop
nop
nop
nop
...
nop
add $37844, %r12
lea addresses_normal_ht+0xe127, %rcx
add $63580, %rax
mov (%rcx), %r11d
nop
nop
...
nop
and $17889, %r10
lea addresses_WC_ht+0x1a507, %rsi
lea addresses_WT_ht+0x1b407, %rdi
nop
add %r13, %r13
mov $26, %rcx
rep movsw
...
{'OP': 'LOAD', 'src': {'type': 'addresses_UC_ht', 'AVXalign': True, 'congruent': 1, 'size': 1, 'same': False, 'NT': True}}
{'OP': 'LOAD', 'src': {'type': 'addresses_normal_ht', 'AVXalign': False, 'congruent': 9, 'size': 4, 'same': False, 'NT': False}}
{'OP': 'LOAD', 'src': {'type': 'addresses_normal_ht', 'AVXalign': True, 'congruent': 8, 'size': 2, 'same': False, 'NT': True}}
