...
push %rdx
push %rsi
lea addresses_WT_ht+0x1c536, %rdx
nop
cmp $19657, %r8
mov (%rdx), %r10w
nop
xor %rbx, %rbx
lea addresses_WC_ht+0x5390, %rsi
lea addresses_A_ht+0xb6f9, %rdi
clflush (%rsi)
nop
nop
nop
...
{'src': {'congruent': 0, 'same': False, 'type': 'addresses_WC_ht'}, 'OP': 'REPM', 'dst': {'congruent': 3, 'same': True, 'type': 'addresses_A_ht'}}
