...
push %rdx
push %rsi
lea addresses_normal_ht+0xa378, %rsi
lea addresses_A_ht+0x1e9a0, %rdi
clflush (%rsi)
xor %rdx, %rdx
mov $34, %rcx
rep movsw
nop
inc %rbp
lea addresses_D_ht+0x1aa1c, %rsi
lea addresses_normal_ht+0x8010, %rdi
clflush (%rsi)
nop
cmp %r14, %r14
mov $11, %rcx
...
nop
add $31490, %rcx
lea addresses_D_ht+0x15eb8, %rbp
nop
nop
nop
nop
...
nop
add %rdi, %rdi
lea addresses_UC_ht+0x9af8, %rsi
lea addresses_A_ht+0x7df8, %rdi
nop
nop
cmp $61926, %r11
mov $74, %rcx
...
nop
dec %r11
lea addresses_WC_ht+0x1d6f8, %rcx
xor %r14, %r14
mov $0x6162636465666768, %rdx
movq %rdx, %xmm0
vmovups %ymm0, (%rcx)
dec %rsi
lea addresses_A_ht+0x1525c, %rcx
mfence
vmovups (%rcx), %ymm3
...
nop
add $22362, %rsi
lea addresses_A_ht+0x1c7f8, %rdi
nop
nop
xor %r14, %r14
movb $0x61, (%rdi)
...
// Faulty Load
lea addresses_normal+0x16af8, %rax
nop
nop
nop
nop
...
{'OP': 'STOR', 'dst': {'type': 'addresses_P', 'AVXalign': True, 'size': 4, 'NT': False, 'same': False, 'congruent': 4}}
{'OP': 'STOR', 'dst': {'type': 'addresses_WT', 'AVXalign': True, 'size': 4, 'NT': False, 'same': False, 'congruent': 5}}
[Faulty Load]
...
{'src': {'type': 'addresses_D_ht', 'congruent': 2, 'same': False}, 'OP': 'REPM', 'dst': {'type': 'addresses_normal_ht', 'congruent': 2, 'same': False}}
