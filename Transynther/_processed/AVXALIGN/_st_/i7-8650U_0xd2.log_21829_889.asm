...
push %rdi
push %rsi
lea addresses_UC_ht+0x1ebb4, %rsi
add $33116, %rbx
...
nop
cmp %r9, %r9
lea addresses_WC_ht+0x1bd10, %rsi
nop
and %r15, %r15
vmovups (%rsi), %ymm7
...
nop
inc %r15
lea addresses_UC_ht+0x12c60, %rbx
nop
nop
cmp %r8, %r8
mov $0x6162636465666768, %rbp
movq %rbp, (%rbx)
xor %r8, %r8
lea addresses_normal_ht+0x1b110, %rsi
lea addresses_normal_ht+0x7490, %rdi
nop
nop
nop
nop
...
nop
sub %r8, %r8
lea addresses_A_ht+0x13510, %rbp
and $38445, %rdi
...
// Store
lea addresses_normal+0x3b10, %r10
clflush (%r10)
nop
dec %rcx
...
// Store
lea addresses_normal+0x7b10, %rbp
nop
nop
nop
nop
