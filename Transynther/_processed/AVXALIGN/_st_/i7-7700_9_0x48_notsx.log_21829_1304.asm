...
push %rdx
push %rsi
lea addresses_UC_ht+0x1cae2, %rsi
lea addresses_WT_ht+0x14ae2, %rdi
nop
nop
cmp %r9, %r9
mov $120, %rcx
...
nop
sub %r10, %r10
lea addresses_D_ht+0x1d3eb, %rbp
nop
nop
sub $22484, %r14
...
nop
and $10438, %rcx
lea addresses_UC_ht+0x169c2, %r14
and $27123, %r10
mov (%r14), %bp
nop
nop
and $63207, %rcx
lea addresses_WC_ht+0xe4e2, %rsi
...
rep movsw
cmp $32615, %rbp
lea addresses_WC_ht+0xc0e2, %rsi
nop
nop
nop
nop
...
nop
cmp $50242, %r10
lea addresses_normal_ht+0x1a98a, %rsi
nop
nop
nop
nop
...
nop
inc %rbp
lea addresses_normal_ht+0x50e2, %r10
nop
nop
cmp %r14, %r14
movw $0x6162, (%r10)
...
nop
cmp %rdx, %rdx
lea addresses_normal_ht+0x2c2a, %rcx
nop
nop
nop
nop
...
movq %r10, (%rcx)
sub $4446, %rsi
lea addresses_WT_ht+0x1a1cb, %rsi
lea addresses_A_ht+0x158e2, %rdi
clflush (%rsi)
nop
nop
nop
...
nop
inc %rbp
lea addresses_normal_ht+0x10e2, %rbp
nop
nop
and %rdi, %rdi
mov (%rbp), %r10d
nop
xor %rcx, %rcx
lea addresses_A_ht+0x11ae2, %rdx
clflush (%rdx)
nop
nop
nop
...
nop
add %rdx, %rdx
lea addresses_normal_ht+0x6ee2, %rsi
lea addresses_WT_ht+0x1944c, %rdi
nop
nop
nop
nop
...
nop
cmp $21533, %rbp
lea addresses_A_ht+0x103b2, %rdx
and %r9, %r9
mov $0x6162636465666768, %r10
movq %r10, (%rdx)
nop
...
{'dst': {'same': False, 'NT': True, 'AVXalign': False, 'size': 4, 'type': 'addresses_A_ht', 'congruent': 7}, 'OP': 'STOR'}
...
{'dst': {'same': False, 'NT': True, 'AVXalign': False, 'size': 2, 'type': 'addresses_normal_ht', 'congruent': 11}, 'OP': 'STOR'}
...
{'dst': {'same': True, 'congruent': 0, 'type': 'addresses_WT_ht'}, 'OP': 'REPM', 'src': {'same': False, 'congruent': 9, 'type': 'addresses_normal_ht'}}
