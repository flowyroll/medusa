...
push %rdi
push %rsi
lea addresses_WT_ht+0x1a690, %rcx
cmp $45478, %rbx
...
nop
cmp %rbx, %rbx
lea addresses_normal_ht+0x120a0, %rsi
lea addresses_WC_ht+0x4160, %rdi
nop
nop
nop
cmp %r9, %r9
...
nop
sub $42315, %r9
lea addresses_normal_ht+0x4ea0, %rsi
lea addresses_WT_ht+0x10550, %rdi
nop
nop
nop
nop
...
nop
and $64792, %rdi
lea addresses_D_ht+0x156f0, %rsi
nop
nop
nop
nop
...
nop
dec %r11
lea addresses_WT_ht+0x8396, %rdi
nop
nop
nop
nop
...
nop
dec %r9
lea addresses_WC_ht+0x10c94, %r14
nop
nop
nop
nop
...
nop
sub %r9, %r9
lea addresses_normal_ht+0x1c560, %rsi
lea addresses_A_ht+0x1dda0, %rdi
nop
nop
nop
inc %rax
...
nop
add $14671, %rax
lea addresses_normal_ht+0x58a0, %rdi
inc %r14
mov $0x6162636465666768, %rsi
movq %rsi, (%rdi)
add $29721, %rsi
lea addresses_A_ht+0x18ca0, %rsi
lea addresses_WT_ht+0x87a0, %rdi
nop
nop
nop
nop
...
nop
sub $52892, %rdi
lea addresses_WC_ht+0x1b0d8, %r9
nop
nop
nop
nop
...
nop
inc %r14
lea addresses_WC_ht+0x84c0, %rax
nop
nop
nop
nop
...
{'OP': 'REPM', 'src': {'type': 'addresses_normal_ht', 'congruent': 11, 'same': True}, 'dst': {'type': 'addresses_WC_ht', 'congruent': 6, 'same': False}}
{'OP': 'REPM', 'src': {'type': 'addresses_normal_ht', 'congruent': 9, 'same': False}, 'dst': {'type': 'addresses_WT_ht', 'congruent': 4, 'same': False}}
{'OP': 'LOAD', 'src': {'type': 'addresses_D_ht', 'AVXalign': False, 'congruent': 3, 'size': 8, 'same': True, 'NT': False}}
