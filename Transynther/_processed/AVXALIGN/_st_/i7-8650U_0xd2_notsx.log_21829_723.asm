...
push %rdx
push %rsi
lea addresses_WT_ht+0x13206, %r11
nop
sub $60306, %r10
movl $0x61626364, (%r11)
and %r14, %r14
lea addresses_UC_ht+0x849e, %r10
nop
nop
xor $52819, %rdx
movb $0x61, (%r10)
...
nop
dec %rsi
lea addresses_UC_ht+0xf6ce, %rsi
lea addresses_A_ht+0x15c32, %rdi
nop
nop
nop
nop
...
nop
sub %rcx, %rcx
lea addresses_D_ht+0x1334e, %rdx
nop
nop
nop
sub $40781, %r9
