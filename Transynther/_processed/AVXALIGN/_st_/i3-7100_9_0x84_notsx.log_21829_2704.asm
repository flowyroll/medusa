...
push %rdi
push %rsi
lea addresses_WC_ht+0x1c2e6, %rbp
xor %rbx, %rbx
mov (%rbp), %r15w
nop
cmp %rdi, %rdi
lea addresses_D_ht+0xd77e, %rax
nop
and $48774, %r13
...
nop
and %r15, %r15
lea addresses_normal_ht+0x1ce3e, %rbp
nop
nop
and %r15, %r15
...
nop
xor $785, %rbx
lea addresses_A_ht+0x1af7e, %r15
nop
nop
nop
sub $36564, %r12
...
nop
cmp $2455, %r13
lea addresses_normal_ht+0x1c794, %rsi
lea addresses_WC_ht+0x1dca6, %rdi
nop
nop
nop
nop
...
nop
add $18376, %rsi
lea addresses_WC_ht+0x13be, %r13
nop
cmp %r12, %r12
movups (%r13), %xmm5
vpextrq $0, %xmm5, %rbx
