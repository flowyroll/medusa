...
push %rdx
push %rsi
lea addresses_normal_ht+0x11221, %rax
nop
inc %r11
...
nop
sub %rbx, %rbx
lea addresses_A_ht+0x372d, %rsi
lea addresses_UC_ht+0x62d, %rdi
nop
cmp %r9, %r9
mov $64, %rcx
rep movsb
xor %r11, %r11
lea addresses_D_ht+0xa98d, %r11
nop
nop
and %r9, %r9
...
nop
add $18748, %rdx
lea addresses_WT_ht+0x892d, %rbx
nop
xor $63190, %r9
movw $0x6162, (%rbx)
nop
...
{'OP': 'STOR', 'dst': {'same': False, 'congruent': 0, 'NT': False, 'type': 'addresses_PSE', 'size': 4, 'AVXalign': True}}
[Faulty Load]
