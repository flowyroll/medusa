...
push %rdx
push %rsi
lea addresses_WC_ht+0x1dbba, %r15
clflush (%r15)
xor %rdx, %rdx
movups (%r15), %xmm6
vpextrq $1, %xmm6, %rcx
...
vpextrq $1, %xmm7, %rcx
xor $6486, %rdx
lea addresses_WC_ht+0x31f4, %r14
nop
nop
nop
nop
...
nop
xor %rax, %rax
lea addresses_UC_ht+0x16224, %rcx
inc %rbx
and $0xffffffffffffffc0, %rcx
movaps (%rcx), %xmm1
vpextrq $0, %xmm1, %r15
xor $35088, %r13
lea addresses_A_ht+0x8be4, %r15
nop
nop
add %rbx, %rbx
...
nop
add %r13, %r13
lea addresses_A_ht+0x13574, %rbx
nop
cmp %rdx, %rdx
movb $0x61, (%rbx)
nop
and $42324, %rcx
lea addresses_normal_ht+0x14ce4, %rsi
lea addresses_A_ht+0x16fe4, %rdi
nop
nop
nop
cmp $56844, %rdx
