...
lea addresses_WT_ht+0x1189c, %rdi
nop
nop
nop
nop
...
rep movsq
lfence
lea addresses_UC_ht+0x2d9c, %rdi
and $53879, %rbp
...
nop
dec %rdi
lea addresses_WC_ht+0x17a9c, %r15
nop
nop
nop
xor $55549, %rsi
...
nop
cmp %r12, %r12
lea addresses_WT_ht+0xb557, %rsi
nop
nop
nop
nop
...
nop
cmp %rcx, %rcx
lea addresses_normal_ht+0x1ac9c, %rbx
clflush (%rbx)
nop
nop
sub $14782, %rdi
...
// REPMOV
lea addresses_WC+0xa9c, %rsi
lea addresses_WC+0x16a7c, %rdi
nop
nop
nop
nop
...
// REPMOV
lea addresses_UC+0x1229c, %rsi
lea addresses_WC+0xa9c, %rdi
nop
nop
xor $52198, %r15
mov $56, %rcx
...
{'src': {'type': 'addresses_WC', 'congruent': 0, 'same': True}, 'dst': {'type': 'addresses_WC', 'congruent': 4, 'same': False}, 'OP': 'REPM'}
{'src': {'type': 'addresses_UC', 'congruent': 10, 'same': False}, 'dst': {'type': 'addresses_WC', 'congruent': 0, 'same': True}, 'OP': 'REPM'}
[Faulty Load]
