...
push %rdx
push %rsi
lea addresses_WC_ht+0xe43a, %rsi
lea addresses_A_ht+0xb6ba, %rdi
nop
nop
xor %r11, %r11
mov $65, %rcx
...
nop
inc %rdi
lea addresses_UC_ht+0x14c3a, %rsi
lea addresses_UC_ht+0x9a3a, %rdi
add $33444, %r10
mov $17, %rcx
rep movsl
nop
...
lea addresses_UC_ht+0x97e7, %rdi
clflush (%rsi)
nop
nop
nop
...
nop
dec %r10
lea addresses_WT_ht+0x6502, %rsi
lea addresses_D_ht+0x143a, %rdi
nop
nop
sub %r11, %r11
mov $60, %rcx
rep movsw
dec %rsi
lea addresses_UC_ht+0x1a23a, %r10
nop
sub %rdx, %rdx
mov (%r10), %rsi
nop
and $29574, %rsi
lea addresses_UC_ht+0x157a, %rbx
nop
nop
nop
nop
...
movw $0x6162, (%rsi)
cmp $38517, %rdi
lea addresses_normal_ht+0x1038c, %rsi
lea addresses_WT_ht+0x233a, %rdi
add %rbx, %rbx
mov $17, %rcx
rep movsl
nop
...
nop
add %rcx, %rcx
lea addresses_WT_ht+0x7c3a, %rsi
cmp $42975, %rdi
...
[Faulty Load]
{'src': {'type': 'addresses_D', 'same': True, 'size': 8, 'congruent': 0, 'NT': True, 'AVXalign': False}, 'OP': 'LOAD'}
<gen_prepare_buffer>
{'src': {'type': 'addresses_WC_ht', 'congruent': 9, 'same': False}, 'dst': {'type': 'addresses_A_ht', 'congruent': 7, 'same': False}, 'OP': 'REPM'}
{'src': {'type': 'addresses_UC_ht', 'congruent': 11, 'same': False}, 'dst': {'type': 'addresses_UC_ht', 'congruent': 9, 'same': False}, 'OP': 'REPM'}
{'src': {'type': 'addresses_WT_ht', 'congruent': 3, 'same': False}, 'dst': {'type': 'addresses_UC_ht', 'congruent': 0, 'same': False}, 'OP': 'REPM'}
...
{'dst': {'type': 'addresses_UC_ht', 'same': False, 'size': 2, 'congruent': 2, 'NT': False, 'AVXalign': True}, 'OP': 'STOR'}
