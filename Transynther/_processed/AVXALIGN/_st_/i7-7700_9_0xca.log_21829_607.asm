...
lea addresses_WT_ht+0x65f, %rdi
inc %r15
mov $122, %rcx
rep movsl
dec %r8
lea addresses_A_ht+0xe1a9, %rbx
nop
nop
nop
nop
...
// Faulty Load
lea addresses_normal+0xc39, %r10
nop
nop
sub $48560, %rbx
mov (%r10), %ax
...
{'OP': 'STOR', 'dst': {'congruent': 8, 'AVXalign': True, 'same': False, 'size': 2, 'NT': False, 'type': 'addresses_A'}}
...
<gen_prepare_buffer>
{'src': {'congruent': 0, 'same': False, 'type': 'addresses_WC_ht'}, 'OP': 'REPM', 'dst': {'congruent': 0, 'same': False, 'type': 'addresses_WT_ht'}}
