...
push %rdx
push %rsi
lea addresses_A_ht+0x5d4f, %rsi
lea addresses_WC_ht+0xf94f, %rdi
nop
dec %rdx
mov $109, %rcx
rep movsq
cmp $53187, %rdx
lea addresses_D_ht+0x1a74f, %r10
nop
nop
inc %r12
...
nop
add %rsi, %rsi
lea addresses_WC_ht+0x12995, %r10
nop
nop
nop
sub $20272, %rcx
...
nop
inc %rdx
lea addresses_D_ht+0x11770, %rdx
nop
nop
nop
nop
...
nop
inc %rcx
lea addresses_D_ht+0x69bf, %r12
and $51957, %rcx
mov (%r12), %bp
dec %r12
lea addresses_D_ht+0x131d7, %rdi
nop
nop
cmp %r10, %r10
mov (%rdi), %cx
...
<gen_prepare_buffer>
{'src': {'congruent': 8, 'same': False, 'type': 'addresses_A_ht'}, 'OP': 'REPM', 'dst': {'congruent': 9, 'same': False, 'type': 'addresses_WC_ht'}}
