...
nop
add %rdi, %rdi
lea addresses_D_ht+0x57e8, %rsi
nop
nop
add $35524, %rcx
movb (%rsi), %r8b
dec %r14
lea addresses_WC_ht+0x175d8, %r8
dec %r14
mov (%r8), %ebx
and $44064, %rbp
lea addresses_normal_ht+0x12928, %rsi
lea addresses_normal_ht+0xe9d8, %rdi
nop
nop
nop
mfence
...
lea addresses_WT_ht+0x1c5d8, %rdi
cmp $44319, %r14
mov $78, %rcx
rep movsw
nop
...
{'OP': 'STOR', 'dst': {'type': 'addresses_PSE', 'AVXalign': False, 'congruent': 9, 'size': 2, 'same': False, 'NT': True}}
...
{'OP': 'LOAD', 'src': {'type': 'addresses_WC_ht', 'AVXalign': False, 'congruent': 10, 'size': 4, 'same': False, 'NT': True}}
