...
push %rdi
push %rsi
lea addresses_UC_ht+0x18892, %r9
nop
nop
nop
cmp $34756, %r15
...
nop
cmp %r13, %r13
lea addresses_A_ht+0x18816, %rsi
...
nop
cmp %rdi, %rdi
lea addresses_WT_ht+0x1d296, %rsi
lea addresses_WT_ht+0x17d41, %rdi
nop
nop
nop
cmp $16743, %rbp
...
nop
mfence
lea addresses_WT_ht+0x161be, %r15
clflush (%r15)
nop
cmp %rcx, %rcx
movups (%r15), %xmm4
vpextrq $0, %xmm4, %rsi
and $59492, %r13
lea addresses_WT_ht+0x1d416, %rsi
lea addresses_WC_ht+0xa16, %rdi
nop
nop
nop
sub $54553, %r14
...
nop
dec %rbp
lea addresses_D_ht+0x10416, %rsi
nop
nop
xor $39270, %r14
mov (%rsi), %r15
...
mov (%rbp), %r13d
and %rdi, %rdi
lea addresses_UC_ht+0x14be2, %rcx
and $64711, %r9
vmovups (%rcx), %ymm5
...
nop
and $57590, %r9
lea addresses_WT_ht+0xce96, %r15
nop
cmp $48964, %r9
movl $0x61626364, (%r15)
nop
xor %rdi, %rdi
lea addresses_D_ht+0xb5c6, %r14
clflush (%r14)
nop
nop
add %rbp, %rbp
...
nop
dec %r15
lea addresses_WC_ht+0x6416, %r15
nop
nop
nop
nop
...
nop
xor $54920, %rdi
lea addresses_UC_ht+0xf926, %rsi
nop
nop
nop
cmp $22801, %rdi
...
nop
dec %rbp
lea addresses_UC_ht+0x8ed6, %r14
clflush (%r14)
nop
and %r9, %r9
movups (%r14), %xmm4
...
// Faulty Load
lea addresses_normal+0x7816, %r8
nop
nop
sub %rsi, %rsi
mov (%r8), %ecx
...
{'OP': 'REPM', 'src': {'type': 'addresses_D', 'congruent': 5, 'same': False}, 'dst': {'type': 'addresses_P', 'congruent': 5, 'same': False}}
[Faulty Load]
...
{'OP': 'REPM', 'src': {'type': 'addresses_WT_ht', 'congruent': 4, 'same': False}, 'dst': {'type': 'addresses_WT_ht', 'congruent': 0, 'same': False}}
...
{'OP': 'LOAD', 'src': {'type': 'addresses_D_ht', 'size': 4, 'AVXalign': True, 'NT': False, 'congruent': 10, 'same': False}}
