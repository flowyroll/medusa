...
push %rdi
push %rsi
lea addresses_D_ht+0x1a093, %rbp
clflush (%rbp)
nop
nop
xor %rcx, %rcx
...
vmovups %ymm1, (%rbp)
sub $23790, %rdi
lea addresses_UC_ht+0x1b803, %r13
dec %r9
movw $0x6162, (%r13)
xor %r14, %r14
lea addresses_normal_ht+0x10883, %rsi
lea addresses_normal_ht+0xef9f, %rdi
xor %rax, %rax
mov $14, %rcx
rep movsw
nop
...
nop
and %rax, %rax
lea addresses_UC_ht+0x11b75, %rcx
nop
xor %r14, %r14
...
nop
inc %r14
lea addresses_normal_ht+0x3723, %rsi
nop
nop
add %rbp, %rbp
movw $0x6162, (%rsi)
...
nop
and $4882, %rax
lea addresses_UC_ht+0x4d23, %rsi
lea addresses_UC_ht+0x1adaf, %rdi
clflush (%rsi)
nop
nop
inc %rax
...
{'src': {'type': 'addresses_UC_ht', 'congruent': 7, 'same': True}, 'OP': 'REPM', 'dst': {'type': 'addresses_UC_ht', 'congruent': 0, 'same': False}}
{'OP': 'STOR', 'dst': {'type': 'addresses_UC_ht', 'AVXalign': False, 'size': 2, 'NT': False, 'same': False, 'congruent': 11}}
{'OP': 'STOR', 'dst': {'type': 'addresses_A_ht', 'AVXalign': True, 'size': 32, 'NT': False, 'same': False, 'congruent': 1}}
{'36': 21829}
