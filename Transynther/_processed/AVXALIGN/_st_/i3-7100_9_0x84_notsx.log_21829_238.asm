...
nop
xor %r8, %r8
lea addresses_WT_ht+0x7af5, %rsi
clflush (%rsi)
nop
nop
nop
...
nop
sub %rsi, %rsi
lea addresses_WT_ht+0xc3fd, %r8
nop
cmp $53149, %r11
mov (%r8), %rcx
sub $32128, %rcx
lea addresses_WT_ht+0xfdfd, %rsi
lea addresses_D_ht+0x4eeb, %rdi
inc %r15
mov $90, %rcx
rep movsw
inc %r10
lea addresses_D_ht+0x51bd, %r11
and $63312, %r15
...
nop
sub $48618, %rdi
lea addresses_WC_ht+0xeafd, %rsi
nop
nop
nop
nop
...
{'dst': {'type': 'addresses_WT_ht', 'same': False, 'size': 2, 'congruent': 1, 'NT': True, 'AVXalign': False}, 'OP': 'STOR'}
