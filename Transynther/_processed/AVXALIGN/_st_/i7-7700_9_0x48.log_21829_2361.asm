...
lea addresses_normal_ht+0x1065, %rdi
nop
nop
nop
nop
...
nop
sub $38925, %r13
lea addresses_D_ht+0x126d, %rsi
lea addresses_WC_ht+0x865, %rdi
nop
inc %r8
mov $125, %rcx
rep movsl
...
nop
dec %rdi
lea addresses_WT_ht+0x180c9, %rsi
lea addresses_A_ht+0x739d, %rdi
dec %rbp
mov $100, %rcx
rep movsq
nop
and %rsi, %rsi
lea addresses_normal_ht+0x118b5, %r8
and $49707, %r13
mov (%r8), %edi
nop
nop
inc %rcx
lea addresses_UC_ht+0xecf7, %rax
nop
nop
sub %rsi, %rsi
...
nop
and %rbp, %rbp
lea addresses_UC_ht+0xbb15, %rsi
lea addresses_A_ht+0x78e7, %rdi
add $15380, %r12
mov $47, %rcx
rep movsw
nop
nop
sub %rsi, %rsi
lea addresses_WT_ht+0x1ad45, %rcx
nop
nop
nop
xor %r12, %r12
...
nop
xor $23716, %rdi
lea addresses_normal_ht+0x4de5, %rsi
lea addresses_D_ht+0x9351, %rdi
clflush (%rdi)
nop
nop
nop
...
lea addresses_A_ht+0x12c65, %rdi
cmp %rbp, %rbp
mov $56, %rcx
rep movsw
xor %rdi, %rdi
lea addresses_A_ht+0xc865, %rcx
and $27414, %rsi
mov (%rcx), %r8w
nop
nop
nop
and %r12, %r12
lea addresses_normal_ht+0xa665, %r13
nop
nop
nop
nop
...
<gen_prepare_buffer>
{'OP': 'REPM', 'src': {'type': 'addresses_WC_ht', 'congruent': 4, 'same': False}, 'dst': {'type': 'addresses_normal_ht', 'congruent': 10, 'same': False}}
...
{'OP': 'REPM', 'src': {'type': 'addresses_UC_ht', 'congruent': 4, 'same': False}, 'dst': {'type': 'addresses_A_ht', 'congruent': 1, 'same': False}}
