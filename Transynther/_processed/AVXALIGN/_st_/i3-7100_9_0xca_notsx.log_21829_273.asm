...
push %rdx
push %rsi
lea addresses_normal_ht+0x8df4, %r11
clflush (%r11)
nop
inc %rcx
movups (%r11), %xmm0
...
nop
dec %rdx
lea addresses_A_ht+0x188d6, %r11
nop
nop
dec %rbp
vmovups (%r11), %ymm4
...
nop
cmp %rbp, %rbp
lea addresses_A_ht+0x14d56, %rdx
nop
nop
nop
nop
...
nop
cmp $25684, %rdi
lea addresses_WC_ht+0x5196, %r11
nop
sub $8214, %rbx
...
nop
xor $57387, %r13
lea addresses_UC_ht+0xadd6, %rbp
nop
sub $55416, %rbx
movw $0x6162, (%rbp)
nop
xor $28464, %rdi
lea addresses_normal_ht+0xa456, %rbx
nop
nop
nop
add %rdi, %rdi
...
nop
xor %r11, %r11
lea addresses_WC_ht+0xbcf6, %rdi
nop
and $1041, %rbp
movb $0x61, (%rdi)
nop
add %rbx, %rbx
lea addresses_UC_ht+0xf976, %rbp
nop
nop
nop
nop
...
nop
cmp %rdx, %rdx
lea addresses_WT_ht+0x135d6, %rbp
nop
nop
nop
nop
...
nop
and $30902, %rbp
lea addresses_A_ht+0x1ea26, %rsi
lea addresses_normal_ht+0x448e, %rdi
clflush (%rdi)
nop
nop
xor $53501, %rbp
...
nop
add $51886, %rbx
lea addresses_A_ht+0xa7d6, %rsi
lea addresses_UC_ht+0x39d6, %rdi
nop
nop
nop
nop
