...
push %rdi
push %rsi
lea addresses_WC_ht+0xfd89, %rsi
lea addresses_WT_ht+0xdd09, %rdi
nop
nop
nop
xor %r9, %r9
...
nop
sub $54846, %rbx
lea addresses_A_ht+0x1889, %rsi
lea addresses_D_ht+0x12989, %rdi
xor %r15, %r15
mov $110, %rcx
rep movsw
nop
...
nop
cmp %rsi, %rsi
lea addresses_WT_ht+0x1878b, %r9
nop
nop
nop
nop
...
{'src': {'type': 'addresses_A_ht', 'congruent': 8, 'same': True}, 'OP': 'REPM', 'dst': {'type': 'addresses_D_ht', 'congruent': 7, 'same': False}}
...
{'src': {'same': False, 'congruent': 1, 'NT': True, 'type': 'addresses_WT_ht', 'size': 4, 'AVXalign': False}, 'OP': 'LOAD'}
{'39': 21829}
