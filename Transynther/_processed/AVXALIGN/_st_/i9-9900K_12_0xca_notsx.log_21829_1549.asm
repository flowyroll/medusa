...
push %rdx
push %rsi
lea addresses_UC_ht+0x1a6e0, %rsi
lea addresses_D_ht+0x1e260, %rdi
nop
nop
nop
nop
...
// Store
lea addresses_normal+0x14c04, %r9
nop
nop
nop
nop
...
// Store
lea addresses_normal+0x1954a, %r14
nop
add %r11, %r11
...
// Store
lea addresses_normal+0x3318, %r11
nop
xor %r12, %r12
...
{'OP': 'STOR', 'dst': {'same': False, 'type': 'addresses_normal', 'NT': False, 'AVXalign': True, 'size': 16, 'congruent': 0}}
{'OP': 'LOAD', 'src': {'same': False, 'type': 'addresses_A', 'NT': False, 'AVXalign': False, 'size': 4, 'congruent': 2}}
