...
nop
and $60023, %r8
lea addresses_D_ht+0x11b52, %rsi
lea addresses_normal_ht+0x742, %rdi
nop
nop
nop
nop
...
rep movsb
and %rcx, %rcx
lea addresses_WC_ht+0x1d552, %rsi
lea addresses_A_ht+0x19752, %rdi
nop
nop
nop
and %r11, %r11
...
nop
cmp $47984, %r11
lea addresses_normal_ht+0x17752, %r11
cmp $6535, %rbx
movb $0x61, (%r11)
nop
nop
...
nop
sub %r12, %r12
lea addresses_WC_ht+0x14772, %rsi
lea addresses_A_ht+0x16982, %rdi
nop
cmp %r12, %r12
mov $72, %rcx
rep movsl
...
nop
mfence
lea addresses_D_ht+0x1a52, %rsi
lea addresses_UC_ht+0x3b72, %rdi
clflush (%rdi)
nop
nop
nop
...
nop
add $56192, %r8
lea addresses_WC_ht+0x13792, %rsi
lea addresses_A_ht+0xe352, %rdi
clflush (%rdi)
nop
nop
nop
...
nop
inc %rdi
lea addresses_WC_ht+0x16a72, %rbx
nop
nop
and %rdi, %rdi
movb $0x61, (%rbx)
...
nop
dec %rsi
lea addresses_WC_ht+0x1b77a, %rsi
lea addresses_UC_ht+0x752, %rdi
nop
nop
sub $45211, %r8
mov $92, %rcx
...
vmovups %ymm7, (%rdi)
xor %rcx, %rcx
lea addresses_normal_ht+0xb552, %rsi
lea addresses_WT_ht+0x1d922, %rdi
nop
nop
add $17658, %rbp
mov $105, %rcx
...
nop
sub $8016, %rsi
lea addresses_normal_ht+0x9f52, %r11
nop
nop
nop
sub %rbp, %rbp
...
<gen_prepare_buffer>
{'src': {'type': 'addresses_D_ht', 'congruent': 7, 'same': True}, 'dst': {'type': 'addresses_D_ht', 'congruent': 1, 'same': True}, 'OP': 'REPM'}
...
{'src': {'type': 'addresses_WC_ht', 'congruent': 9, 'same': True}, 'dst': {'type': 'addresses_A_ht', 'congruent': 9, 'same': False}, 'OP': 'REPM'}
{'dst': {'type': 'addresses_normal_ht', 'same': False, 'size': 1, 'congruent': 9, 'NT': True, 'AVXalign': True}, 'OP': 'STOR'}
...
{'src': {'type': 'addresses_WC_ht', 'congruent': 5, 'same': False}, 'dst': {'type': 'addresses_A_ht', 'congruent': 4, 'same': True}, 'OP': 'REPM'}
...
{'src': {'type': 'addresses_WC_ht', 'congruent': 0, 'same': True}, 'dst': {'type': 'addresses_UC_ht', 'congruent': 11, 'same': False}, 'OP': 'REPM'}
