...
push %rdi
push %rsi
lea addresses_UC_ht+0xc45e, %rsi
...
rep movsw
sub $10168, %r15
lea addresses_UC_ht+0x17114, %r12
nop
nop
nop
nop
...
// Store
lea addresses_normal+0xa93e, %r12
nop
nop
nop
nop
...
{'OP': 'STOR', 'dst': {'type': 'addresses_normal', 'AVXalign': True, 'congruent': 9, 'size': 16, 'same': False, 'NT': True}}
{'OP': 'STOR', 'dst': {'type': 'addresses_US', 'AVXalign': False, 'congruent': 7, 'size': 4, 'same': False, 'NT': False}}
{'OP': 'LOAD', 'src': {'type': 'addresses_WC', 'AVXalign': False, 'congruent': 4, 'size': 4, 'same': False, 'NT': True}}
[Faulty Load]
