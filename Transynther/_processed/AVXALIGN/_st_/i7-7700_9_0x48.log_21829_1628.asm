...
nop
inc %r10
lea addresses_WC_ht+0x1d7e5, %rsi
lea addresses_D_ht+0xfe5, %rdi
nop
nop
nop
add $14688, %r11
...
nop
and %rbp, %rbp
lea addresses_normal_ht+0x1ce65, %rbp
nop
nop
nop
nop
...
nop
sub %rbx, %rbx
lea addresses_A_ht+0x1d5cc, %rsi
lea addresses_normal_ht+0x7fe5, %rdi
clflush (%rdi)
sub %r11, %r11
mov $37, %rcx
rep movsq
xor %r10, %r10
lea addresses_UC_ht+0x92c9, %rsi
lea addresses_normal_ht+0x1a9e5, %rdi
inc %r10
mov $60, %rcx
rep movsb
xor $56721, %rcx
lea addresses_normal_ht+0xf9e5, %r9
nop
nop
nop
sub %r10, %r10
...
nop
sub %r10, %r10
lea addresses_normal_ht+0x150b1, %rsi
...
{'OP': 'STOR', 'dst': {'type': 'addresses_A_ht', 'AVXalign': False, 'congruent': 7, 'size': 16, 'same': True, 'NT': False}}
