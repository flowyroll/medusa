...
push %rdi
push %rsi
lea addresses_WC_ht+0x1babd, %r11
nop
nop
nop
add %r13, %r13
...
nop
sub %r13, %r13
lea addresses_normal_ht+0x6295, %rsi
lea addresses_UC_ht+0x8595, %rdi
nop
nop
nop
sub %r12, %r12
...
nop
sub %rdi, %rdi
lea addresses_WT_ht+0x895, %rsi
lea addresses_D_ht+0xa595, %rdi
nop
nop
dec %r8
mov $57, %rcx
...
nop
sub %r8, %r8
lea addresses_D_ht+0x1995, %rsi
lea addresses_WT_ht+0x402d, %rdi
nop
nop
nop
nop
...
nop
add %rax, %rax
lea addresses_A_ht+0x16ed5, %r8
dec %rcx
movw $0x6162, (%r8)
nop
cmp $747, %r11
lea addresses_WC_ht+0x4595, %rdi
nop
nop
nop
dec %r8
...
<gen_prepare_buffer>
{'src': {'type': 'addresses_WC_ht', 'AVXalign': False, 'size': 2, 'NT': False, 'same': True, 'congruent': 3}, 'OP': 'LOAD'}
