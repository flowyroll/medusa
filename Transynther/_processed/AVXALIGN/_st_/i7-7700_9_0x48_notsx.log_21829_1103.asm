...
nop
add %rbp, %rbp
lea addresses_normal_ht+0x146a0, %rbp
clflush (%rbp)
nop
nop
nop
...
nop
inc %rsi
lea addresses_normal_ht+0xff20, %rdi
nop
nop
add %rsi, %rsi
mov (%rdi), %r11d
cmp $59978, %rdi
lea addresses_WT_ht+0x1df20, %rcx
clflush (%rcx)
nop
nop
nop
...
nop
xor $50802, %rcx
lea addresses_WC_ht+0xaf20, %rsi
lea addresses_A_ht+0xdc40, %rdi
xor $37606, %r14
mov $44, %rcx
rep movsq
and $53182, %r14
lea addresses_WT_ht+0x33eb, %r14
nop
nop
nop
nop
...
// REPMOV
lea addresses_WC+0x3720, %rsi
lea addresses_D+0x10720, %rdi
nop
dec %rax
mov $39, %rcx
rep movsq
...
// Faulty Load
lea addresses_normal+0x720, %rcx
add $17989, %r14
mov (%rcx), %di
lea oracles, %rcx
and $0xff, %rdi
...
{'dst': {'same': False, 'congruent': 11, 'type': 'addresses_D'}, 'OP': 'REPM', 'src': {'same': False, 'congruent': 8, 'type': 'addresses_WC'}}
[Faulty Load]
...
{'dst': {'same': False, 'congruent': 3, 'type': 'addresses_A_ht'}, 'OP': 'REPM', 'src': {'same': False, 'congruent': 10, 'type': 'addresses_WC_ht'}}
