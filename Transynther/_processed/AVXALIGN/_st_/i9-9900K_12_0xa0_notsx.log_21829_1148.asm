...
push %rdx
push %rsi
lea addresses_D_ht+0x3021, %rbp
nop
nop
inc %r9
movl $0x61626364, (%rbp)
add %rdx, %rdx
lea addresses_A_ht+0x1e161, %rax
nop
nop
nop
nop
...
nop
and %r9, %r9
lea addresses_A_ht+0x19f21, %rsi
...
nop
and $35176, %rbp
lea addresses_UC_ht+0x2215, %r10
nop
nop
and %rbp, %rbp
movb (%r10), %r15b
...
nop
dec %rbp
lea addresses_UC_ht+0x16721, %rdx
nop
nop
nop
nop
...
nop
inc %rcx
lea addresses_UC_ht+0x12521, %rdi
nop
nop
nop
nop
...
nop
xor %rsi, %rsi
lea addresses_D_ht+0x763, %rsi
lea addresses_WC_ht+0x1e721, %rdi
nop
nop
inc %r15
mov $58, %rcx
...
nop
dec %rcx
lea addresses_UC_ht+0x1e721, %rdi
nop
nop
nop
nop
...
nop
dec %r10
lea addresses_WC_ht+0x4ca1, %rsi
lea addresses_A_ht+0x1e321, %rdi
nop
nop
add $20717, %rdx
mov $33, %rcx
rep movsb
lfence
lea addresses_WT_ht+0x19721, %rax
nop
nop
nop
sub %rsi, %rsi
...
{'src': {'type': 'addresses_A_ht', 'congruent': 11, 'same': False}, 'OP': 'REPM', 'dst': {'type': 'addresses_UC_ht', 'congruent': 0, 'same': False}}
...
{'src': {'type': 'addresses_UC_ht', 'AVXalign': True, 'size': 4, 'NT': False, 'same': True, 'congruent': 7}, 'OP': 'LOAD'}
...
{'src': {'type': 'addresses_WC_ht', 'congruent': 7, 'same': True}, 'OP': 'REPM', 'dst': {'type': 'addresses_A_ht', 'congruent': 10, 'same': False}}
