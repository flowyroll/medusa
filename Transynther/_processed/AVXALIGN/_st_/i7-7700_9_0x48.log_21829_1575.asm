...
push %rdi
push %rsi
lea addresses_UC_ht+0x231b, %r11
nop
sub %rax, %rax
...
nop
and $35076, %r9
lea addresses_WC_ht+0x15bbf, %rdi
nop
nop
nop
nop
...
nop
add $11979, %rax
lea addresses_WT_ht+0xc599, %r11
nop
nop
nop
nop
...
nop
sub %rsi, %rsi
lea addresses_WC_ht+0x13a87, %r11
nop
add %rsi, %rsi
movl $0x61626364, (%r11)
nop
...
lea addresses_WT_ht+0x7757, %rdi
nop
nop
nop
nop
...
nop
xor $28136, %rbx
lea addresses_WC_ht+0x1e01, %rsi
nop
nop
nop
nop
...
movb $0x61, (%rsi)
and $31981, %rbx
lea addresses_normal_ht+0x17467, %rsi
clflush (%rsi)
nop
nop
cmp $53086, %r9
...
nop
xor %rax, %rax
lea addresses_WC_ht+0xb797, %rsi
lea addresses_WT_ht+0x1a18a, %rdi
add %r11, %r11
mov $29, %rcx
rep movsw
nop
...
nop
add $60576, %r11
lea addresses_D_ht+0x16207, %rbx
nop
nop
nop
xor %r11, %r11
...
nop
and $21070, %rdi
lea addresses_WC_ht+0x1c147, %rsi
lea addresses_UC_ht+0x19dd7, %rdi
nop
nop
nop
nop
...
{'OP': 'STOR', 'dst': {'type': 'addresses_normal_ht', 'AVXalign': False, 'congruent': 5, 'size': 1, 'same': True, 'NT': False}}
{'OP': 'STOR', 'dst': {'type': 'addresses_A_ht', 'AVXalign': False, 'congruent': 9, 'size': 1, 'same': False, 'NT': False}}
{'OP': 'REPM', 'src': {'type': 'addresses_WC_ht', 'congruent': 4, 'same': False}, 'dst': {'type': 'addresses_WT_ht', 'congruent': 0, 'same': True}}
