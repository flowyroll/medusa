...
nop
add %rsi, %rsi
lea addresses_normal_ht+0x1084b, %r10
nop
nop
cmp $54059, %rcx
movb (%r10), %dl
nop
sub $18402, %rsi
lea addresses_normal_ht+0xd4b, %rsi
lea addresses_normal_ht+0x13bfb, %rdi
nop
nop
nop
xor %rax, %rax
...
nop
dec %r10
lea addresses_A_ht+0xeb4b, %rsi
lea addresses_UC_ht+0x1484b, %rdi
nop
nop
add %r11, %r11
mov $1, %rcx
rep movsb
cmp $23619, %rcx
lea addresses_WC_ht+0x664b, %rcx
nop
nop
dec %r14
movl $0x61626364, (%rcx)
...
nop
xor %rdx, %rdx
lea addresses_WC_ht+0x50d3, %rdi
nop
nop
nop
xor $9794, %rdx
...
{'OP': 'REPM', 'src': {'same': False, 'congruent': 5, 'type': 'addresses_normal_ht'}, 'dst': {'same': False, 'congruent': 4, 'type': 'addresses_normal_ht'}}
{'OP': 'REPM', 'src': {'same': False, 'congruent': 7, 'type': 'addresses_A_ht'}, 'dst': {'same': False, 'congruent': 9, 'type': 'addresses_UC_ht'}}
