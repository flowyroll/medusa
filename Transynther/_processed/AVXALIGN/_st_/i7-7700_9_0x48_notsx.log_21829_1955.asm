...
movups %xmm1, (%r13)
inc %r9
lea addresses_A_ht+0x173e, %r12
nop
sub %rsi, %rsi
movups (%r12), %xmm3
vpextrq $0, %xmm3, %rcx
xor %r9, %r9
lea addresses_WT_ht+0x10b54, %rsi
lea addresses_WC_ht+0xdb7c, %rdi
nop
nop
xor %r11, %r11
mov $60, %rcx
...
nop
and $2120, %rsi
lea addresses_WT_ht+0x14b24, %r12
nop
nop
dec %rsi
mov (%r12), %r9
...
nop
xor $43595, %r9
lea addresses_D_ht+0x1450c, %rsi
lea addresses_WC_ht+0x100d4, %rdi
clflush (%rdi)
xor $16662, %r11
mov $18, %rcx
rep movsb
...
lea addresses_UC_ht+0x14e94, %rdi
nop
nop
add $51923, %r14
mov $15, %rcx
...
nop
and $44838, %r13
lea addresses_D_ht+0x1cf94, %r12
nop
nop
nop
inc %r13
mov (%r12), %r11
cmp $7949, %rcx
lea addresses_normal_ht+0x1bf8, %rsi
lea addresses_WT_ht+0x5e94, %rdi
nop
nop
nop
nop
...
rep movsq
sub $5916, %r12
lea addresses_WT_ht+0x1523c, %r11
nop
cmp %rcx, %rcx
movb $0x61, (%r11)
nop
...
{'dst': {'same': False, 'congruent': 3, 'type': 'addresses_WC_ht'}, 'OP': 'REPM', 'src': {'same': False, 'congruent': 3, 'type': 'addresses_WT_ht'}}
