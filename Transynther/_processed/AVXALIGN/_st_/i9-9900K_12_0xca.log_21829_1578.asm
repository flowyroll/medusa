...
push %rdi
push %rsi
lea addresses_WC_ht+0xa3ec, %r11
nop
nop
nop
xor $50411, %r14
...
nop
cmp $34856, %r9
lea addresses_D_ht+0x45d1, %rsi
lea addresses_UC_ht+0x1d851, %rdi
nop
nop
dec %r8
mov $81, %rcx
rep movsb
sub %rcx, %rcx
lea addresses_D_ht+0x1a441, %rsi
lea addresses_UC_ht+0x12e09, %rdi
nop
nop
xor %rbp, %rbp
mov $11, %rcx
rep movsq
cmp %r9, %r9
lea addresses_WT_ht+0xc601, %rcx
nop
lfence
mov (%rcx), %edi
nop
nop
and %rcx, %rcx
lea addresses_D_ht+0x110d1, %rsi
nop
nop
nop
nop
...
lea addresses_UC_ht+0x1dad1, %rdi
nop
and $36189, %r11
mov $61, %rcx
rep movsl
nop
add $40930, %rbp
lea addresses_normal_ht+0xf791, %r9
nop
cmp %r8, %r8
mov (%r9), %edi
nop
cmp %rsi, %rsi
lea addresses_D_ht+0x1ddd1, %rdi
nop
dec %r9
movb (%rdi), %r14b
sub $28495, %rcx
lea addresses_D_ht+0x193b1, %rsi
...
nop
and %rcx, %rcx
lea addresses_WC_ht+0xf0e1, %rsi
lea addresses_WC_ht+0x5a1, %rdi
clflush (%rsi)
sub %r14, %r14
mov $39, %rcx
rep movsw
add $27069, %r14
lea addresses_WT_ht+0x126d1, %rsi
lea addresses_UC_ht+0x1cad1, %rdi
nop
sub %r14, %r14
mov $6, %rcx
rep movsl
...
{'OP': 'REPM', 'src': {'same': False, 'type': 'addresses_D_ht', 'congruent': 3}, 'dst': {'same': True, 'type': 'addresses_UC_ht', 'congruent': 1}}
...
{'OP': 'REPM', 'src': {'same': False, 'type': 'addresses_WC_ht', 'congruent': 7}, 'dst': {'same': False, 'type': 'addresses_UC_ht', 'congruent': 11}}
...
{'OP': 'REPM', 'src': {'same': False, 'type': 'addresses_D_ht', 'congruent': 5}, 'dst': {'same': False, 'type': 'addresses_A_ht', 'congruent': 6}}
{'OP': 'REPM', 'src': {'same': False, 'type': 'addresses_WC_ht', 'congruent': 2}, 'dst': {'same': False, 'type': 'addresses_WC_ht', 'congruent': 3}}
{'OP': 'REPM', 'src': {'same': False, 'type': 'addresses_WT_ht', 'congruent': 6}, 'dst': {'same': False, 'type': 'addresses_UC_ht', 'congruent': 10}}
{'32': 21829}
