...
push %rdi
push %rsi
lea addresses_A_ht+0x164ee, %rbx
nop
nop
sub $30516, %rax
...
nop
and %rbp, %rbp
lea addresses_normal_ht+0x2c2e, %rsi
lea addresses_normal_ht+0x182e, %rdi
clflush (%rsi)
dec %r11
mov $63, %rcx
rep movsb
...
nop
xor $5664, %rcx
lea addresses_normal_ht+0xa2e4, %r8
nop
nop
nop
nop
...
nop
xor $5230, %rdi
lea addresses_WT_ht+0x1ea2e, %rcx
nop
nop
nop
nop
...
nop
cmp $363, %rbx
lea addresses_WC_ht+0x1eba2, %rsi
clflush (%rsi)
cmp $58168, %r11
movw $0x6162, (%rsi)
nop
nop
cmp %r8, %r8
lea addresses_WC_ht+0x382e, %rdi
add %r8, %r8
movb $0x61, (%rdi)
nop
nop
...
// Faulty Load
lea addresses_normal+0x1a02e, %r14
nop
nop
nop
nop
...
{'OP': 'LOAD', 'src': {'same': False, 'type': 'addresses_UC', 'NT': False, 'AVXalign': False, 'size': 8, 'congruent': 1}}
[Faulty Load]
{'OP': 'LOAD', 'src': {'same': True, 'type': 'addresses_normal', 'NT': False, 'AVXalign': True, 'size': 4, 'congruent': 0}}
<gen_prepare_buffer>
{'OP': 'STOR', 'dst': {'same': False, 'type': 'addresses_A_ht', 'NT': False, 'AVXalign': True, 'size': 32, 'congruent': 6}}
