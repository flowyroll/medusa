...
push %rdi
push %rsi
lea addresses_WT_ht+0xdcfa, %rsi
clflush (%rsi)
nop
nop
nop
...
nop
add %rax, %rax
lea addresses_A_ht+0x14d9a, %rsi
lea addresses_A_ht+0x692, %rdi
sub $27726, %rbx
mov $102, %rcx
rep movsw
nop
...
nop
sub %r15, %r15
lea addresses_WC_ht+0x15cea, %rbx
nop
nop
dec %rsi
movb $0x61, (%rbx)
...
nop
and %rdi, %rdi
lea addresses_WT_ht+0xd8e2, %rsi
lea addresses_normal_ht+0x1c445, %rdi
nop
and $44190, %r9
mov $39, %rcx
rep movsq
add $28419, %rdi
lea addresses_A_ht+0xec0e, %rdi
nop
nop
sub $57481, %r11
mov (%rdi), %ax
...
// Faulty Load
lea addresses_normal+0x1ee62, %r14
nop
nop
nop
nop
