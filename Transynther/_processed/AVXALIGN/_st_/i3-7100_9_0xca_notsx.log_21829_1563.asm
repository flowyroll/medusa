...
push %rdx
push %rsi
lea addresses_D_ht+0x1e748, %rdx
nop
nop
nop
dec %rbp
...
nop
xor $20579, %r8
lea addresses_D_ht+0x1b48, %rsi
lea addresses_normal_ht+0xd748, %rdi
clflush (%rdi)
nop
nop
nop
...
movb (%rsi), %cl
inc %rsi
lea addresses_D_ht+0xf288, %rsi
lea addresses_UC_ht+0x2748, %rdi
nop
nop
nop
add %r11, %r11
