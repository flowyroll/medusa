...
nop
add $15539, %rdx
lea addresses_WC_ht+0x11e48, %r12
nop
add $54729, %r13
movw $0x6162, (%r12)
nop
...
// Store
lea addresses_normal+0x1e840, %r12
nop
nop
nop
nop
...
{'src': {'same': False, 'congruent': 8, 'type': 'addresses_P'}, 'OP': 'REPM', 'dst': {'same': False, 'congruent': 5, 'type': 'addresses_US'}}
