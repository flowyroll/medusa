...
push %rdx
push %rsi
lea addresses_D_ht+0x19bc8, %r11
nop
nop
nop
nop
...
nop
cmp $34543, %rbx
lea addresses_UC_ht+0x19000, %r13
nop
sub $35681, %rdx
vmovups (%r13), %ymm4
...
vpextrq $1, %xmm4, %r10
dec %r10
lea addresses_WC_ht+0x1800, %rsi
lea addresses_WT_ht+0x5f10, %rdi
clflush (%rsi)
nop
cmp $40174, %rdx
mov $80, %rcx
rep movsl
sub $58398, %rdx
lea addresses_normal_ht+0x17e4, %r10
nop
nop
cmp $41324, %rcx
movups (%r10), %xmm0
...
nop
xor %r13, %r13
lea addresses_UC_ht+0x140b8, %r10
dec %rbx
mov $0x6162636465666768, %rdx
movq %rdx, (%r10)
nop
cmp %rdx, %rdx
lea addresses_normal_ht+0x1dce0, %r13
nop
nop
nop
nop
...
// Store
lea addresses_normal+0x11b80, %r12
nop
nop
cmp $15371, %rdi
movb $0x51, (%r12)
...
// Store
lea addresses_normal+0x10300, %r14
xor %r9, %r9
movl $0x51525354, (%r14)
nop
dec %r12
...
{'OP': 'LOAD', 'src': {'same': False, 'NT': False, 'AVXalign': False, 'size': 4, 'type': 'addresses_WT', 'congruent': 4}}
