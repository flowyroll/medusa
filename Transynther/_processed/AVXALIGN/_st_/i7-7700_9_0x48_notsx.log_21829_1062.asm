...
nop
xor %r10, %r10
lea addresses_WC_ht+0xeaeb, %rdx
nop
cmp $46355, %r14
vmovups (%rdx), %ymm7
...
nop
xor %rsi, %rsi
lea addresses_normal_ht+0x1b2fd, %rdx
nop
nop
dec %r10
movb (%rdx), %r14b
...
nop
sub %rdx, %rdx
lea addresses_normal_ht+0x13231, %rsi
lea addresses_WC_ht+0x140c9, %rdi
sub $40268, %r10
mov $100, %rcx
rep movsb
nop
