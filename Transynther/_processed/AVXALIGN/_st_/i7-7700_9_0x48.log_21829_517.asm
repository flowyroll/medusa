...
push %rdx
push %rsi
lea addresses_normal_ht+0x6ff8, %rsi
lea addresses_normal_ht+0x183f8, %rdi
nop
and %r9, %r9
mov $112, %rcx
rep movsq
...
lea addresses_UC_ht+0xea36, %rdi
sub %r11, %r11
mov $64, %rcx
rep movsb
nop
...
nop
cmp $36318, %r9
lea addresses_D_ht+0x8c88, %rsi
lea addresses_WT_ht+0xaeb8, %rdi
nop
nop
nop
cmp %r12, %r12
...
nop
add $39506, %rdi
lea addresses_normal_ht+0xd815, %rsi
nop
nop
nop
and %rdx, %rdx
...
[Faulty Load]
{'OP': 'LOAD', 'src': {'type': 'addresses_PSE', 'AVXalign': False, 'congruent': 0, 'size': 8, 'same': True, 'NT': True}}
<gen_prepare_buffer>
