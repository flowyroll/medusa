...
push %rdx
push %rsi
lea addresses_normal_ht+0x1707d, %rsi
lea addresses_D_ht+0x19ecd, %rdi
nop
nop
nop
nop
...
rep movsq
cmp %rax, %rax
lea addresses_A_ht+0x15142, %rsi
lea addresses_A_ht+0x14c9d, %rdi
nop
nop
nop
and $32980, %r12
...
rep movsb
and %rsi, %rsi
lea addresses_WT_ht+0x3bfd, %rax
clflush (%rax)
nop
nop
inc %r14
...
nop
inc %rsi
lea addresses_WT_ht+0x1357d, %rcx
nop
nop
nop
nop
...
mov (%rcx), %esi
and %rsi, %rsi
lea addresses_WC_ht+0x5535, %rsi
...
nop
xor %rdi, %rdi
lea addresses_UC_ht+0xecf1, %rsi
lea addresses_D_ht+0x1143d, %rdi
nop
nop
nop
nop
...
nop
and %rsi, %rsi
lea addresses_UC_ht+0xd57d, %r14
and $31756, %r12
movw $0x6162, (%r14)
nop
nop
...
{'src': {'type': 'addresses_UC_ht', 'congruent': 2, 'same': True}, 'OP': 'REPM', 'dst': {'type': 'addresses_D_ht', 'congruent': 6, 'same': False}}
