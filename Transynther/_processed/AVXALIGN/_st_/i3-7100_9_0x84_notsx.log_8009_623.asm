...
nop
sub %rsi, %rsi
lea addresses_WT_ht+0x17bbe, %r10
nop
nop
nop
nop
...
nop
add $64912, %r8
lea addresses_normal_ht+0x1e94d, %r10
nop
nop
nop
xor $14369, %r8
mov (%r10), %ebp
sub %r9, %r9
lea addresses_WC_ht+0x1b38d, %r9
nop
nop
xor %r10, %r10
...
nop
and $15582, %rbp
lea addresses_WT_ht+0x1744d, %rdx
nop
nop
cmp $51788, %r8
movb $0x61, (%rdx)
...
nop
sub %r10, %r10
lea addresses_WT_ht+0xbf8d, %rsi
sub $55874, %r9
...
{'dst': {'type': 'addresses_D', 'same': False, 'size': 32, 'congruent': 1, 'NT': False, 'AVXalign': True}, 'OP': 'STOR'}
{'dst': {'type': 'addresses_RW', 'same': False, 'size': 8, 'congruent': 9, 'NT': False, 'AVXalign': True}, 'OP': 'STOR'}
[Faulty Load]
...
{'src': {'type': 'addresses_WC_ht', 'same': False, 'size': 32, 'congruent': 10, 'NT': False, 'AVXalign': True}, 'OP': 'LOAD'}
