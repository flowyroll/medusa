...
push %rdi
push %rsi
lea addresses_D_ht+0x12089, %rsi
lea addresses_WC_ht+0x8f37, %rdi
nop
nop
nop
nop
...
nop
sub $15116, %r9
lea addresses_WC_ht+0x19989, %rbx
nop
nop
nop
nop
...
nop
cmp %rcx, %rcx
lea addresses_WT_ht+0x137e9, %rsi
lea addresses_D_ht+0x3109, %rdi
nop
nop
nop
nop
...
nop
xor $7095, %r9
lea addresses_D_ht+0x10789, %rsi
nop
cmp %rbx, %rbx
mov (%rsi), %r14
nop
