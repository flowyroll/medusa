...
push %rdi
push %rdx
lea addresses_WC_ht+0x1ca3f, %rbx
and %rdi, %rdi
movl $0x61626364, (%rbx)
nop
nop
...
// REPMOV
lea addresses_PSE+0x1e03f, %rsi
lea addresses_PSE+0xd23f, %rdi
nop
nop
nop
nop
...
// Store
lea addresses_normal+0x70f4, %r14
dec %r13
...
// Faulty Load
lea addresses_normal+0x583f, %r13
clflush (%r13)
inc %rdi
mov (%r13), %bx
lea oracles, %rsi
...
{'OP': 'REPM', 'src': {'type': 'addresses_PSE', 'congruent': 10, 'same': False}, 'dst': {'type': 'addresses_PSE', 'congruent': 8, 'same': False}}
