...
push %rdx
push %rsi
lea addresses_D_ht+0x1ab87, %rsi
lea addresses_A_ht+0x1e60b, %rdi
nop
nop
cmp $43753, %rbp
mov $35, %rcx
...
nop
and $25254, %rdi
lea addresses_normal_ht+0x2987, %rbx
xor $23336, %rdx
...
nop
add $6579, %rdx
lea addresses_A_ht+0x6b87, %rsi
lea addresses_D_ht+0x1ca47, %rdi
clflush (%rdi)
nop
nop
cmp %r15, %r15
...
rep movsl
cmp $40064, %rbx
lea addresses_UC_ht+0x6787, %rsi
...
nop
add %r8, %r8
lea addresses_D_ht+0x1c3bf, %rbx
nop
nop
nop
nop
...
nop
sub %r15, %r15
lea addresses_WC_ht+0x13a87, %rdx
nop
nop
cmp $45449, %rdi
movb $0x61, (%rdx)
...
nop
sub $4071, %rbp
lea addresses_WC_ht+0x5b87, %r15
nop
nop
nop
nop
...
nop
sub $8810, %rbx
lea addresses_D_ht+0x131c7, %rsi
lea addresses_D_ht+0x5b87, %rdi
nop
nop
xor $10383, %r15
mov $0, %rcx
...
nop
and %rsi, %rsi
lea addresses_WT_ht+0x1aff0, %rbx
clflush (%rbx)
nop
nop
nop
...
nop
xor $55806, %rdi
lea addresses_WT_ht+0x2787, %rsi
lea addresses_D_ht+0x16e8f, %rdi
nop
nop
nop
nop
...
nop
xor %rsi, %rsi
lea addresses_A_ht+0x1dac7, %rcx
nop
nop
nop
nop
...
nop
add $5814, %rcx
lea addresses_normal_ht+0x6020, %r8
sub $38413, %rsi
movups (%r8), %xmm7
vpextrq $0, %xmm7, %rdx
nop
...
{'OP': 'REPM', 'src': {'type': 'addresses_D_ht', 'congruent': 6, 'same': False}, 'dst': {'type': 'addresses_D_ht', 'congruent': 8, 'same': True}}
...
{'OP': 'STOR', 'dst': {'type': 'addresses_WC_ht', 'AVXalign': True, 'congruent': 8, 'size': 4, 'same': False, 'NT': False}}
