...
push %rbx
push %rsi
lea addresses_A_ht+0xdbae, %r8
add $25964, %r10
movb $0x61, (%r8)
inc %r15
lea addresses_A_ht+0x100c, %rbx
nop
nop
nop
dec %r11
...
nop
cmp %rbp, %rbp
lea addresses_normal_ht+0x790c, %r10
sub %rsi, %rsi
mov (%r10), %rbx
nop
nop
...
nop
xor %r11, %r11
lea addresses_D_ht+0x1268c, %r15
clflush (%r15)
nop
nop
nop
...
nop
cmp $16538, %rsi
lea addresses_A_ht+0x14d0c, %rsi
nop
nop
nop
inc %r11
...
nop
inc %r8
lea addresses_normal_ht+0x1a6f4, %rbp
nop
nop
add $53072, %r11
movb $0x61, (%rbp)
...
// Load
lea addresses_normal+0x1b50c, %rcx
nop
nop
nop
nop
...
{'src': {'type': 'addresses_normal', 'AVXalign': False, 'size': 16, 'NT': True, 'same': False, 'congruent': 11}, 'OP': 'LOAD'}
{'OP': 'STOR', 'dst': {'type': 'addresses_UC', 'AVXalign': True, 'size': 32, 'NT': False, 'same': False, 'congruent': 10}}
...
{'OP': 'STOR', 'dst': {'type': 'addresses_D_ht', 'AVXalign': False, 'size': 16, 'NT': False, 'same': True, 'congruent': 7}}
