...
push %rdi
push %rsi
lea addresses_A_ht+0xf61f, %rsi
lea addresses_WC_ht+0x168bf, %rdi
nop
and %rax, %rax
mov $112, %rcx
rep movsw
sub $39069, %r15
lea addresses_normal_ht+0x1189f, %r8
nop
add $10448, %rcx
...
nop
xor $53222, %rdi
lea addresses_A_ht+0x17cdf, %rsi
lea addresses_A_ht+0x1358f, %rdi
nop
nop
nop
nop
...
nop
xor %rcx, %rcx
lea addresses_D_ht+0x1909f, %rsi
lea addresses_WC_ht+0xbe9f, %rdi
nop
nop
nop
nop
...
nop
cmp $59719, %r15
lea addresses_normal_ht+0x1245f, %r15
and %rdi, %rdi
movups (%r15), %xmm2
vpextrq $1, %xmm2, %rbx
nop
...
nop
dec %r15
lea addresses_WT_ht+0x24df, %rsi
nop
nop
nop
add %rax, %rax
...
nop
add $51804, %rax
lea addresses_A_ht+0x11b97, %rdi
xor $38793, %rcx
movb $0x61, (%rdi)
nop
dec %rax
lea addresses_UC_ht+0x1ba7, %rdi
sub $4111, %r8
mov (%rdi), %si
nop
nop
...
{'dst': {'same': False, 'congruent': 9, 'type': 'addresses_normal_ht'}, 'OP': 'REPM', 'src': {'same': False, 'congruent': 2, 'type': 'addresses_UC_ht'}}
{'dst': {'same': False, 'NT': False, 'AVXalign': False, 'size': 2, 'type': 'addresses_UC_ht', 'congruent': 11}, 'OP': 'STOR'}
{'dst': {'same': False, 'congruent': 1, 'type': 'addresses_A_ht'}, 'OP': 'REPM', 'src': {'same': False, 'congruent': 5, 'type': 'addresses_A_ht'}}
{'dst': {'same': False, 'congruent': 6, 'type': 'addresses_WC_ht'}, 'OP': 'REPM', 'src': {'same': False, 'congruent': 8, 'type': 'addresses_D_ht'}}
...
{'dst': {'same': False, 'congruent': 5, 'type': 'addresses_D_ht'}, 'OP': 'REPM', 'src': {'same': False, 'congruent': 10, 'type': 'addresses_WC_ht'}}
