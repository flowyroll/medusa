...
push %rdx
push %rsi
lea addresses_A_ht+0x19e6b, %rdx
nop
nop
nop
and %rsi, %rsi
...
vpextrq $0, %xmm2, %r15
add %r10, %r10
lea addresses_A_ht+0x6f23, %r13
xor %r10, %r10
mov (%r13), %rdx
and $4596, %rdx
lea addresses_WT_ht+0x896b, %r13
clflush (%r13)
nop
nop
nop
...
mov (%r13), %esi
xor %r13, %r13
lea addresses_D_ht+0x8857, %r15
nop
xor %rbx, %rbx
movw $0x6162, (%r15)
xor %rsi, %rsi
lea addresses_normal_ht+0x2447, %r10
nop
nop
nop
nop
...
mov (%r10), %r15d
xor $49208, %rax
lea addresses_WT_ht+0x13dea, %rsi
lea addresses_UC_ht+0x3c0f, %rdi
clflush (%rsi)
nop
nop
sub %r15, %r15
...
nop
cmp %rbx, %rbx
lea addresses_WT_ht+0x1bc57, %r15
clflush (%r15)
nop
nop
nop
...
nop
sub $49896, %r13
lea addresses_WT_ht+0x1ef17, %rdx
nop
nop
cmp %rcx, %rcx
movl $0x61626364, (%rdx)
...
// Store
lea addresses_normal+0x13163, %rbp
sub %r15, %r15
movl $0x51525354, (%rbp)
nop
nop
...
{'OP': 'STOR', 'dst': {'type': 'addresses_normal', 'size': 4, 'AVXalign': True, 'NT': False, 'congruent': 0, 'same': False}}
{'OP': 'STOR', 'dst': {'type': 'addresses_WC', 'size': 4, 'AVXalign': False, 'NT': True, 'congruent': 6, 'same': False}}
{'OP': 'STOR', 'dst': {'type': 'addresses_US', 'size': 32, 'AVXalign': False, 'NT': True, 'congruent': 6, 'same': False}}
...
{'OP': 'LOAD', 'src': {'type': 'addresses_WT_ht', 'size': 32, 'AVXalign': True, 'NT': False, 'congruent': 9, 'same': False}}
