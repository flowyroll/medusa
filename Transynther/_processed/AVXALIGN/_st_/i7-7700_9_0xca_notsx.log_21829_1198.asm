...
push %rdx
push %rsi
lea addresses_D_ht+0x1e38a, %rsi
xor %r10, %r10
...
nop
sub %r12, %r12
lea addresses_A_ht+0x10d4a, %rcx
nop
cmp $49952, %r12
mov (%rcx), %dx
nop
...
nop
cmp %rdi, %rdi
lea addresses_WT_ht+0x14c4a, %rsi
lea addresses_D_ht+0x16d8a, %rdi
nop
nop
nop
nop
...
nop
dec %rcx
lea addresses_UC_ht+0xdd8a, %rdx
nop
nop
add %r15, %r15
movb $0x61, (%rdx)
and $53168, %r10
lea addresses_UC_ht+0xbdca, %rsi
lea addresses_WC_ht+0x4a7e, %rdi
nop
xor $22216, %r11
mov $33, %rcx
rep movsl
and $15036, %rdx
lea addresses_WC_ht+0x194e3, %r12
clflush (%r12)
nop
nop
xor %r10, %r10
...
nop
cmp %r11, %r11
lea addresses_WT_ht+0x4852, %r11
nop
nop
and $27600, %r15
mov (%r11), %rsi
...
nop
sub %r10, %r10
lea addresses_D_ht+0x1890a, %rsi
lea addresses_D_ht+0x398a, %rdi
nop
cmp $1587, %r11
mov $32, %rcx
rep movsq
...
nop
sub $110, %rcx
lea addresses_WC_ht+0x349a, %rsi
lea addresses_normal_ht+0x125d6, %rdi
nop
nop
nop
and %r10, %r10
...
// Store
lea addresses_normal+0x1c68a, %r13
nop
nop
nop
nop
...
{'src': {'congruent': 4, 'same': False, 'type': 'addresses_UC_ht'}, 'dst': {'congruent': 2, 'same': False, 'type': 'addresses_WC_ht'}, 'OP': 'REPM'}
