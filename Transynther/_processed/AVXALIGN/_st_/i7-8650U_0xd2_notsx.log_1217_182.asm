...
push %rdx
push %rsi
lea addresses_D_ht+0x4a8e, %rsi
lea addresses_normal_ht+0x1311e, %rdi
nop
nop
nop
cmp $55220, %rbx
...
nop
lfence
lea addresses_WT_ht+0x158de, %rbp
nop
nop
nop
and %r10, %r10
...
// Faulty Load
lea addresses_normal+0x1e5e, %r9
nop
sub $59637, %rax
movb (%r9), %r11b
lea oracles, %r15
