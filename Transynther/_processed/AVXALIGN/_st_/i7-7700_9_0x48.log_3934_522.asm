...
push %rdi
push %rsi
lea addresses_D_ht+0x119d0, %r14
nop
inc %rsi
mov (%r14), %r11
nop
sub $40406, %r14
lea addresses_WC_ht+0x1c3d0, %rdi
nop
nop
nop
cmp %rsi, %rsi
...
nop
add %r11, %r11
lea addresses_D_ht+0x1ad50, %rcx
nop
sub $54728, %r11
mov (%rcx), %r13w
nop
