...
push %rdi
push %rsi
lea addresses_normal_ht+0x64b1, %rsi
lea addresses_normal_ht+0xc131, %rdi
clflush (%rsi)
nop
nop
nop
...
nop
sub $32480, %rdi
lea addresses_WT_ht+0x3bb1, %rsi
lea addresses_D_ht+0xf931, %rdi
nop
nop
nop
nop
...
nop
xor %r12, %r12
lea addresses_UC_ht+0x1361, %rax
sub $14901, %r10
vmovups (%rax), %ymm0
