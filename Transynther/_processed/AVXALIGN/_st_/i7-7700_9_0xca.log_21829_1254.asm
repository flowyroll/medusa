...
push %rdx
push %rsi
lea addresses_UC_ht+0x18bf7, %rsi
lea addresses_normal_ht+0x7ef7, %rdi
sub %r12, %r12
mov $108, %rcx
rep movsb
nop
nop
sub $59448, %rbp
lea addresses_WC_ht+0x53cd, %rsi
lea addresses_D_ht+0x1aa17, %rdi
clflush (%rdi)
nop
nop
nop
...
nop
cmp %r12, %r12
lea addresses_WT_ht+0x193f7, %rcx
add %rbp, %rbp
movb (%rcx), %r14b
nop
inc %rcx
lea addresses_WT_ht+0x1d577, %r14
add $54453, %rsi
...
mov (%rdi), %cx
add %rcx, %rcx
lea addresses_UC_ht+0x7b5f, %rdi
clflush (%rdi)
nop
and %rsi, %rsi
vmovups (%rdi), %ymm6
...
nop
xor $18528, %r14
lea addresses_WT_ht+0xfef7, %rsi
lea addresses_normal_ht+0x177f7, %rdi
nop
nop
add %rbp, %rbp
mov $91, %rcx
rep movsb
xor %rdx, %rdx
lea addresses_WC_ht+0x1e577, %r14
xor %rcx, %rcx
mov (%r14), %edi
nop
nop
sub $43112, %r14
lea addresses_UC_ht+0xe2f7, %r14
nop
nop
and $6402, %r12
movb (%r14), %dl
...
<gen_prepare_buffer>
{'src': {'congruent': 10, 'same': False, 'type': 'addresses_UC_ht'}, 'OP': 'REPM', 'dst': {'congruent': 7, 'same': False, 'type': 'addresses_normal_ht'}}
