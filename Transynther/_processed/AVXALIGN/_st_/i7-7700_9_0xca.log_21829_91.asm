...
push %rdi
push %rdx
lea addresses_normal_ht+0x1dafb, %rdx
clflush (%rdx)
nop
nop
nop
...
movw $0x6162, (%rdx)
cmp $9809, %r14
lea addresses_D_ht+0x189bb, %rbp
nop
nop
and %r15, %r15
vmovups (%rbp), %ymm7
...
nop
sub %r14, %r14
lea addresses_UC_ht+0xa7fb, %rdi
nop
nop
cmp %r8, %r8
vmovups (%rdi), %ymm5
...
nop
inc %rcx
lea addresses_A_ht+0x2f1b, %r8
nop
nop
add $42975, %rdi
movl $0x61626364, (%r8)
and $34590, %r15
lea addresses_normal_ht+0x1c6f, %rbp
nop
nop
nop
nop
...
nop
cmp $30458, %rcx
lea addresses_normal_ht+0x1d43, %r15
nop
nop
nop
nop
...
nop
xor %rdx, %rdx
lea addresses_WC_ht+0xe11b, %r15
nop
nop
nop
sub %r8, %r8
...
nop
xor %rdi, %rdi
lea addresses_D_ht+0x1ec1b, %rdx
nop
nop
and %rbp, %rbp
mov (%rdx), %r14
cmp $31353, %r14
lea addresses_UC_ht+0x503, %rbp
nop
nop
nop
cmp $26967, %r14
