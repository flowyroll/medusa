...
push %rdi
push %rsi
lea addresses_WT_ht+0x9889, %rcx
nop
nop
cmp %r11, %r11
...
nop
sub %r8, %r8
lea addresses_UC_ht+0x1725d, %r15
nop
nop
nop
nop
...
nop
cmp $40245, %r8
lea addresses_normal_ht+0x39d, %r11
nop
xor $59201, %r15
movb $0x61, (%r11)
nop
add %r13, %r13
lea addresses_A_ht+0x1437d, %rsi
lea addresses_WC_ht+0x4c5d, %rdi
nop
nop
nop
sub $14194, %rax
...
nop
mfence
lea addresses_D_ht+0x1d85d, %rax
nop
cmp %r13, %r13
mov (%rax), %r11w
nop
and %r13, %r13
lea addresses_WT_ht+0x1435d, %rsi
nop
inc %r13
movl $0x61626364, (%rsi)
nop
...
nop
dec %r13
lea addresses_WT_ht+0x215d, %r11
nop
sub %rdi, %rdi
movl $0x61626364, (%r11)
nop
...
// Faulty Load
lea addresses_normal+0x985d, %rdx
nop
nop
nop
add $35148, %rcx
...
{'OP': 'STOR', 'dst': {'NT': True, 'same': False, 'congruent': 2, 'type': 'addresses_P', 'AVXalign': False, 'size': 8}}
{'OP': 'STOR', 'dst': {'NT': False, 'same': False, 'congruent': 1, 'type': 'addresses_P', 'AVXalign': True, 'size': 1}}
[Faulty Load]
...
{'src': {'same': False, 'congruent': 5, 'type': 'addresses_A_ht'}, 'OP': 'REPM', 'dst': {'same': True, 'congruent': 10, 'type': 'addresses_WC_ht'}}
