...
movb (%r15), %r8b
and $39250, %rdx
lea addresses_UC_ht+0x7ba, %rsi
clflush (%rsi)
and $25571, %r8
mov (%rsi), %rdx
cmp $45564, %rdx
lea addresses_D_ht+0xca62, %rsi
...
nop
add %r15, %r15
lea addresses_WC_ht+0x190a2, %r11
nop
nop
nop
dec %r8
...
{'src': {'type': 'addresses_D_ht', 'congruent': 5, 'same': True}, 'dst': {'type': 'addresses_WC_ht', 'congruent': 11, 'same': False}, 'OP': 'REPM'}
