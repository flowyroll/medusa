...
push %rdx
push %rsi
lea addresses_WC_ht+0xd891, %rsi
lea addresses_normal_ht+0x18e91, %rdi
inc %rdx
mov $40, %rcx
rep movsw
nop
nop
and %rdi, %rdi
lea addresses_WT_ht+0x129b9, %rsi
lea addresses_normal_ht+0xb091, %rdi
nop
nop
nop
nop
...
nop
and $64032, %rsi
lea addresses_WC_ht+0x7411, %rsi
lea addresses_normal_ht+0xc091, %rdi
clflush (%rdi)
nop
nop
nop
...
{'OP': 'STOR', 'dst': {'type': 'addresses_UC', 'AVXalign': False, 'congruent': 5, 'size': 16, 'same': True, 'NT': False}}
...
<gen_prepare_buffer>
{'OP': 'REPM', 'src': {'type': 'addresses_WC_ht', 'congruent': 10, 'same': False}, 'dst': {'type': 'addresses_normal_ht', 'congruent': 9, 'same': True}}
