...
push %rdi
push %rsi
lea addresses_normal_ht+0xc792, %rbx
nop
xor %rsi, %rsi
movb $0x61, (%rbx)
nop
...
nop
sub %rcx, %rcx
lea addresses_WC_ht+0x139e6, %r10
nop
nop
nop
nop
...
movb $0x61, (%r10)
inc %r11
lea addresses_D_ht+0x114c2, %rax
nop
sub $8637, %rsi
...
movups %xmm2, (%rax)
add %r11, %r11
lea addresses_WC_ht+0x9272, %rsi
lea addresses_UC_ht+0x5522, %rdi
nop
nop
nop
nop
...
{'OP': 'LOAD', 'src': {'same': False, 'NT': False, 'AVXalign': True, 'size': 16, 'type': 'addresses_WT_ht', 'congruent': 4}}
{'dst': {'same': False, 'congruent': 5, 'type': 'addresses_D_ht'}, 'OP': 'REPM', 'src': {'same': False, 'congruent': 0, 'type': 'addresses_UC_ht'}}
