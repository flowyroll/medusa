...
push %rdi
push %rsi
lea addresses_D_ht+0x13337, %rsi
lea addresses_A_ht+0x3c37, %rdi
nop
nop
sub %r14, %r14
mov $21, %rcx
...
nop
cmp %rcx, %rcx
lea addresses_WC_ht+0x1ca37, %r14
nop
nop
nop
add $23744, %rbp
...
nop
sub $39215, %r11
lea addresses_A_ht+0x18bc7, %rbp
nop
nop
and $18698, %rax
movb (%rbp), %r11b
...
nop
lfence
lea addresses_D_ht+0x9637, %rbp
nop
and %rsi, %rsi
movb $0x61, (%rbp)
xor %rcx, %rcx
lea addresses_A_ht+0x4457, %rsi
lea addresses_normal_ht+0xbc2d, %rdi
nop
nop
nop
nop
...
{'src': {'type': 'addresses_P', 'AVXalign': False, 'size': 1, 'NT': False, 'same': False, 'congruent': 6}, 'OP': 'LOAD'}
...
<gen_prepare_buffer>
{'src': {'type': 'addresses_D_ht', 'congruent': 8, 'same': True}, 'OP': 'REPM', 'dst': {'type': 'addresses_A_ht', 'congruent': 9, 'same': False}}
...
{'src': {'type': 'addresses_A_ht', 'congruent': 5, 'same': False}, 'OP': 'REPM', 'dst': {'type': 'addresses_normal_ht', 'congruent': 1, 'same': False}}
