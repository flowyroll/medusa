...
push %rdi
push %rsi
lea addresses_WT_ht+0x14220, %r8
nop
nop
nop
nop
...
nop
cmp %r10, %r10
lea addresses_UC_ht+0x18be6, %rbp
sub %r13, %r13
mov (%rbp), %r10d
nop
nop
...
nop
xor $12802, %r13
lea addresses_D_ht+0x1cd1a, %rsi
lea addresses_A_ht+0x13570, %rdi
clflush (%rsi)
nop
inc %r10
mov $116, %rcx
...
nop
dec %rdi
lea addresses_WT_ht+0x2170, %r14
nop
nop
add $35657, %r12
movb (%r14), %cl
nop
dec %rcx
lea addresses_normal_ht+0x9f70, %r10
nop
sub %r12, %r12
...
nop
sub %r13, %r13
lea addresses_WC_ht+0x12a30, %rbp
xor %rcx, %rcx
movb (%rbp), %r8b
nop
nop
...
nop
xor %rbp, %rbp
lea addresses_D_ht+0x104f0, %r14
nop
nop
dec %r8
mov $0x6162636465666768, %r12
...
nop
and %rsi, %rsi
lea addresses_WC_ht+0x14130, %rbp
nop
cmp $54318, %r8
movw $0x6162, (%rbp)
nop
cmp %r8, %r8
lea addresses_UC_ht+0x6570, %rdi
nop
nop
nop
nop
