...
nop
add $10815, %r11
lea addresses_A_ht+0x198e7, %rsi
lea addresses_UC_ht+0x462f, %rdi
add $40906, %r12
mov $69, %rcx
rep movsl
nop
...
nop
xor $6218, %rbx
lea addresses_normal_ht+0xfb1f, %rsi
lea addresses_WC_ht+0x610f, %rdi
add %r12, %r12
mov $29, %rcx
rep movsb
nop
...
nop
add $17077, %r14
lea addresses_normal_ht+0x1613f, %r12
nop
cmp $16052, %rcx
mov (%r12), %si
nop
...
nop
xor $6987, %rsi
lea addresses_UC_ht+0x14759, %rsi
lea addresses_A_ht+0x1811f, %rdi
nop
nop
nop
nop
...
nop
sub $1464, %r14
lea addresses_WT_ht+0x1131f, %rcx
nop
nop
nop
and %r11, %r11
...
nop
and $43118, %rbx
lea addresses_A_ht+0xb85f, %rsi
lea addresses_WT_ht+0xdbaf, %rdi
sub $43799, %r12
mov $118, %rcx
rep movsb
nop
...
nop
add %rcx, %rcx
lea addresses_WC_ht+0x13c47, %r11
nop
nop
nop
and $55171, %rdi
...
nop
add $13011, %rcx
lea addresses_D_ht+0x1ee89, %r11
and %rsi, %rsi
movb (%r11), %r9b
nop
nop
dec %rbx
lea addresses_WC_ht+0x1138f, %rbx
inc %rsi
movb $0x61, (%rbx)
nop
nop
...
nop
inc %rbx
lea addresses_A_ht+0x1ec1f, %rdi
clflush (%rdi)
nop
nop
nop
...
nop
dec %r12
lea addresses_WC_ht+0xab1f, %r11
nop
nop
nop
sub $13591, %r12
...
nop
xor %r11, %r11
lea addresses_A_ht+0x1571f, %rdi
xor %r14, %r14
movb $0x61, (%rdi)
nop
nop
...
{'OP': 'STOR', 'dst': {'type': 'addresses_D', 'size': 4, 'AVXalign': False, 'NT': True, 'congruent': 1, 'same': False}}
[Faulty Load]
...
{'OP': 'REPM', 'src': {'type': 'addresses_UC_ht', 'congruent': 1, 'same': True}, 'dst': {'type': 'addresses_A_ht', 'congruent': 9, 'same': False}}
