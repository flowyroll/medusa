...
nop
cmp %r15, %r15
lea addresses_WT_ht+0x9189, %rsi
...
lea addresses_normal_ht+0x5789, %rdi
clflush (%rdi)
and $13839, %r15
mov $113, %rcx
rep movsl
...
nop
add $34428, %rsi
lea addresses_A_ht+0x15189, %rsi
dec %rbp
movw $0x6162, (%rsi)
cmp %rcx, %rcx
...
nop
inc %rbp
lea addresses_normal_ht+0x124c9, %rsi
lea addresses_WT_ht+0x14bbf, %rdi
nop
nop
nop
cmp $17492, %rax
...
nop
add $43118, %rbp
lea addresses_UC_ht+0x2252, %rdx
nop
mfence
mov $0x6162636465666768, %r11
movq %r11, %xmm1
...
nop
inc %rdx
lea addresses_normal_ht+0x15a85, %rsi
lea addresses_normal_ht+0xb789, %rdi
nop
nop
cmp %rdx, %rdx
mov $92, %rcx
...
nop
and $22970, %rdx
lea addresses_D_ht+0x1c189, %r11
nop
nop
nop
nop
...
{'OP': 'REPM', 'src': {'type': 'addresses_normal_ht', 'congruent': 2, 'same': False}, 'dst': {'type': 'addresses_normal_ht', 'congruent': 9, 'same': False}}
