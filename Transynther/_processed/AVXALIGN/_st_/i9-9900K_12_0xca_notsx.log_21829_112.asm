...
nop
add $51636, %r8
lea addresses_D_ht+0x4959, %rsi
lea addresses_D_ht+0x17d79, %rdi
nop
nop
nop
nop
...
rep movsb
add $35976, %rsi
lea addresses_UC_ht+0x1a2f9, %r10
nop
nop
nop
nop
...
{'OP': 'REPM', 'src': {'same': False, 'congruent': 5, 'type': 'addresses_D_ht'}, 'dst': {'same': False, 'congruent': 11, 'type': 'addresses_D_ht'}}
