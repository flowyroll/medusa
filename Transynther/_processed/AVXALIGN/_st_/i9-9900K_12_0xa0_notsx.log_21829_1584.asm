...
push %rdi
push %rsi
lea addresses_normal_ht+0x13c5f, %rsi
lea addresses_normal_ht+0x1b8ff, %rdi
nop
nop
nop
nop
...
nop
cmp %r9, %r9
lea addresses_WT_ht+0x255f, %r12
nop
nop
sub %r15, %r15
mov (%r12), %esi
nop
xor %rsi, %rsi
lea addresses_normal_ht+0x725f, %rsi
nop
nop
nop
nop
...
nop
and $25190, %rdi
lea addresses_normal_ht+0x17d5f, %r15
nop
nop
nop
nop
...
nop
xor $5660, %rdi
lea addresses_A_ht+0x1e41f, %rdi
nop
nop
nop
sub $20059, %r9
...
nop
add $50559, %rbx
lea addresses_normal_ht+0x101df, %r15
nop
nop
nop
nop
...
lea addresses_D_ht+0x1131f, %rdi
inc %r9
mov $121, %rcx
rep movsq
nop
...
nop
inc %r15
lea addresses_A_ht+0x8fcf, %r14
xor $46170, %rbx
movups (%r14), %xmm4
vpextrq $0, %xmm4, %rcx
inc %rcx
lea addresses_WC_ht+0x156ef, %rsi
nop
nop
nop
and %rcx, %rcx
...
nop
dec %r14
lea addresses_WC_ht+0x12857, %rsi
lea addresses_normal_ht+0x1528f, %rdi
dec %r12
mov $115, %rcx
rep movsb
nop
...
nop
sub $64602, %r15
lea addresses_normal_ht+0x191ff, %rsi
lea addresses_WC_ht+0x1d35f, %rdi
clflush (%rdi)
and %rbx, %rbx
mov $36, %rcx
rep movsl
...
// Store
lea addresses_normal+0x1e857, %r10
nop
nop
nop
inc %r11
...
<gen_prepare_buffer>
{'src': {'type': 'addresses_normal_ht', 'congruent': 8, 'same': True}, 'OP': 'REPM', 'dst': {'type': 'addresses_normal_ht', 'congruent': 5, 'same': False}}
...
{'OP': 'STOR', 'dst': {'type': 'addresses_normal_ht', 'AVXalign': False, 'size': 4, 'NT': True, 'same': True, 'congruent': 10}}
...
{'src': {'type': 'addresses_A_ht', 'congruent': 8, 'same': False}, 'OP': 'REPM', 'dst': {'type': 'addresses_WC_ht', 'congruent': 10, 'same': False}}
{'OP': 'STOR', 'dst': {'type': 'addresses_normal_ht', 'AVXalign': False, 'size': 1, 'NT': False, 'same': False, 'congruent': 7}}
{'src': {'type': 'addresses_normal_ht', 'congruent': 1, 'same': False}, 'OP': 'REPM', 'dst': {'type': 'addresses_D_ht', 'congruent': 5, 'same': True}}
...
{'src': {'type': 'addresses_normal_ht', 'congruent': 5, 'same': True}, 'OP': 'REPM', 'dst': {'type': 'addresses_WC_ht', 'congruent': 9, 'same': False}}
{'32': 21829}
