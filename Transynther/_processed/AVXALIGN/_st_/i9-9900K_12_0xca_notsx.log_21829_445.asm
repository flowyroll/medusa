...
nop
xor %r15, %r15
lea addresses_UC_ht+0x13d92, %rdi
and %r10, %r10
...
nop
cmp %r15, %r15
lea addresses_WT_ht+0x12dc3, %r13
and %rbp, %rbp
movb (%r13), %r15b
nop
nop
...
nop
sub $35333, %r15
lea addresses_normal_ht+0x182c2, %r15
nop
nop
nop
and $46755, %rdi
