...
push %rdi
push %rsi
lea addresses_WC_ht+0x105, %rsi
add %r11, %r11
mov (%rsi), %r13d
add $2910, %rsi
lea addresses_normal_ht+0x5abd, %rsi
...
nop
cmp $24879, %rsi
lea addresses_UC_ht+0x7405, %r10
nop
nop
inc %rsi
mov (%r10), %r11w
...
nop
add %rcx, %rcx
lea addresses_UC_ht+0x4045, %rsi
lea addresses_UC_ht+0x1b005, %rdi
nop
nop
and %r8, %r8
mov $40, %rcx
...
{'OP': 'STOR', 'dst': {'same': False, 'congruent': 1, 'NT': False, 'type': 'addresses_D', 'size': 8, 'AVXalign': True}}
