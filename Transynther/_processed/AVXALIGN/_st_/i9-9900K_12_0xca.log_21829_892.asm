...
nop
and $15447, %rcx
lea addresses_WC_ht+0x199fc, %rbx
nop
nop
nop
nop
...
nop
add $22116, %r11
lea addresses_WC_ht+0x1207c, %rsi
lea addresses_UC_ht+0xea7c, %rdi
nop
cmp %r15, %r15
mov $76, %rcx
rep movsq
nop
xor $16949, %rdi
lea addresses_WC_ht+0x1b53c, %rsi
lea addresses_normal_ht+0x4370, %rdi
clflush (%rdi)
nop
nop
xor %r10, %r10
...
nop
and %rdi, %rdi
lea addresses_WT_ht+0x1a07c, %rbx
nop
nop
and $54244, %r15
movw $0x6162, (%rbx)
xor $37687, %r10
lea addresses_WC_ht+0xb17c, %rsi
nop
nop
add %r15, %r15
movw $0x6162, (%rsi)
nop
xor %rcx, %rcx
lea addresses_UC_ht+0x111dc, %r10
nop
nop
nop
nop
...
{'OP': 'REPM', 'src': {'same': True, 'type': 'addresses_normal_ht', 'congruent': 4}, 'dst': {'same': False, 'type': 'addresses_A_ht', 'congruent': 7}}
