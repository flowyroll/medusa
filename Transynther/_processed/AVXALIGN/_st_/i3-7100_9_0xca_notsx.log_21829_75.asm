...
nop
and $5922, %rsi
lea addresses_A_ht+0x1cf83, %rsi
lea addresses_UC_ht+0x19d53, %rdi
clflush (%rdi)
nop
dec %r12
mov $14, %rcx
rep movsw
cmp $40195, %rdi
lea addresses_UC_ht+0x3cd1, %rcx
nop
sub $28320, %r9
mov (%rcx), %r8w
nop
nop
xor %r13, %r13
lea addresses_WT_ht+0x12403, %r9
clflush (%r9)
nop
nop
nop
...
nop
and %r9, %r9
lea addresses_WC_ht+0x139af, %r13
nop
nop
nop
and %rdi, %rdi
...
nop
dec %r8
lea addresses_A_ht+0x1d583, %rsi
lea addresses_WC_ht+0x1bce3, %rdi
nop
add %rbp, %rbp
mov $100, %rcx
rep movsb
...
{'OP': 'STOR', 'dst': {'same': False, 'congruent': 4, 'NT': True, 'type': 'addresses_WT_ht', 'size': 2, 'AVXalign': False}}
