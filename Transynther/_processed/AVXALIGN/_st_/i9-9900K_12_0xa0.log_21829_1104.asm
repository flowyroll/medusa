...
push %rdi
push %rsi
lea addresses_normal_ht+0x1a1b5, %r8
nop
nop
add %r12, %r12
...
nop
xor $33922, %rsi
lea addresses_A_ht+0xa035, %rsi
lea addresses_A_ht+0x14045, %rdi
nop
add $25424, %r11
mov $83, %rcx
rep movsw
...
nop
sub %r11, %r11
lea addresses_WC_ht+0x1935, %rsi
lea addresses_WC_ht+0x1d275, %rdi
nop
nop
nop
nop
...
nop
dec %rdi
lea addresses_WT_ht+0xc5c0, %rsi
lea addresses_WT_ht+0x1ea72, %rdi
nop
and $44025, %r13
mov $42, %rcx
rep movsq
nop
and $50027, %r12
lea addresses_UC_ht+0xaeb5, %r13
clflush (%r13)
nop
nop
add %rsi, %rsi
...
nop
inc %rcx
lea addresses_UC_ht+0x3a2d, %rsi
lea addresses_A_ht+0x1a2f5, %rdi
nop
xor $17396, %r13
mov $72, %rcx
rep movsl
add $42711, %r9
lea addresses_UC_ht+0x1035, %rsi
lea addresses_A_ht+0x42b5, %rdi
clflush (%rdi)
nop
nop
nop
...
{'src': {'same': True, 'congruent': 0, 'type': 'addresses_WT_ht'}, 'OP': 'REPM', 'dst': {'same': False, 'congruent': 0, 'type': 'addresses_WT_ht'}}
{'OP': 'STOR', 'dst': {'NT': False, 'same': False, 'congruent': 7, 'type': 'addresses_UC_ht', 'AVXalign': False, 'size': 4}}
{'src': {'same': False, 'congruent': 3, 'type': 'addresses_UC_ht'}, 'OP': 'REPM', 'dst': {'same': False, 'congruent': 6, 'type': 'addresses_A_ht'}}
