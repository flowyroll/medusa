...
lea addresses_A_ht+0x22a, %rdi
nop
inc %r11
mov $29, %rcx
rep movsq
cmp $18841, %rcx
lea addresses_A_ht+0x17f1a, %rdi
nop
inc %r11
mov (%rdi), %rbx
nop
...
nop
dec %rbx
lea addresses_A_ht+0x1792a, %rcx
nop
nop
nop
cmp $18898, %r11
...
nop
add $55909, %rbx
lea addresses_WC_ht+0x1ea3a, %r11
clflush (%r11)
nop
nop
sub %rbx, %rbx
...
movq %rcx, (%r11)
cmp $40164, %r11
lea addresses_A_ht+0x1666a, %rcx
nop
nop
nop
nop
