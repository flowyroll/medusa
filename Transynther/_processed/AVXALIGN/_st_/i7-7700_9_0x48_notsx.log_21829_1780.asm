...
nop
cmp $19544, %rbp
lea addresses_D_ht+0x1107a, %rsi
lea addresses_normal_ht+0x672, %rdi
nop
nop
nop
cmp %r10, %r10
...
rep movsw
xor $59288, %rcx
lea addresses_WC_ht+0x19416, %rdi
nop
nop
nop
nop
...
nop
dec %rsi
lea addresses_WC_ht+0x19da2, %r10
nop
nop
nop
xor %rdi, %rdi
...
nop
sub %rcx, %rcx
lea addresses_D_ht+0x422a, %rsi
lea addresses_UC_ht+0xc272, %rdi
nop
nop
nop
nop
...
nop
add %r13, %r13
lea addresses_WT_ht+0xc7f2, %rsi
lea addresses_A_ht+0x124ea, %rdi
nop
xor %r13, %r13
mov $111, %rcx
rep movsl
...
// REPMOV
lea addresses_RW+0x13c72, %rsi
lea addresses_UC+0x17272, %rdi
nop
cmp %rdx, %rdx
mov $23, %rcx
rep movsl
...
// REPMOV
lea addresses_UC+0x17272, %rsi
lea addresses_PSE+0x141f2, %rdi
nop
nop
nop
dec %r11
...
{'dst': {'same': True, 'congruent': 0, 'type': 'addresses_UC'}, 'OP': 'REPM', 'src': {'same': False, 'congruent': 9, 'type': 'addresses_RW'}}
{'dst': {'same': False, 'congruent': 6, 'type': 'addresses_PSE'}, 'OP': 'REPM', 'src': {'same': True, 'congruent': 0, 'type': 'addresses_UC'}}
...
{'dst': {'same': False, 'congruent': 10, 'type': 'addresses_normal_ht'}, 'OP': 'REPM', 'src': {'same': False, 'congruent': 2, 'type': 'addresses_D_ht'}}
...
{'dst': {'same': True, 'congruent': 2, 'type': 'addresses_A_ht'}, 'OP': 'REPM', 'src': {'same': False, 'congruent': 6, 'type': 'addresses_WT_ht'}}
{'32': 21829}
