...
push %rdi
push %rsi
lea addresses_D_ht+0x18706, %rsi
lea addresses_A_ht+0x57c6, %rdi
nop
and %rbp, %rbp
mov $12, %rcx
rep movsl
xor $3161, %rcx
lea addresses_WC_ht+0x6cc6, %rsi
lea addresses_WT_ht+0x1e0ce, %rdi
inc %r9
mov $65, %rcx
rep movsw
nop
...
// Store
lea addresses_normal+0x1efc6, %r14
nop
nop
nop
nop
...
// Faulty Load
lea addresses_normal+0x11fc6, %r15
dec %rdi
mov (%r15), %r9
lea oracles, %r11
and $0xff, %r9
