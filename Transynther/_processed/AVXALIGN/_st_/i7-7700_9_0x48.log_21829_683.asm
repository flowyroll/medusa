...
nop
xor %rdi, %rdi
lea addresses_D_ht+0x12490, %r15
clflush (%r15)
add $44225, %r12
movl $0x61626364, (%r15)
nop
nop
inc %r11
lea addresses_A_ht+0x1012c, %r12
cmp %r13, %r13
mov (%r12), %si
nop
add %rdi, %rdi
lea addresses_WC_ht+0xba3a, %r12
and $32937, %r9
movb $0x61, (%r12)
nop
nop
inc %r15
lea addresses_UC_ht+0x17d2c, %rdi
nop
nop
xor %rsi, %rsi
movb $0x61, (%rdi)
...
nop
sub $55102, %r9
lea addresses_WT_ht+0x1a72c, %rsi
lea addresses_WT_ht+0x15a9c, %rdi
nop
nop
nop
nop
...
nop
and $12870, %r15
lea addresses_D_ht+0x1e67a, %rsi
lea addresses_WT_ht+0x11afc, %rdi
nop
nop
and $22498, %r15
mov $57, %rcx
...
nop
sub $23069, %r13
lea addresses_D_ht+0x15010, %rsi
lea addresses_normal_ht+0x438c, %rdi
nop
nop
nop
nop
...
rep movsq
sub $62109, %r12
lea addresses_WC_ht+0xe52c, %r11
nop
nop
nop
nop
...
nop
and %r12, %r12
lea addresses_D_ht+0x792c, %rsi
lea addresses_A_ht+0x3b8c, %rdi
clflush (%rdi)
cmp %r12, %r12
mov $39, %rcx
rep movsl
...
nop
dec %r13
lea addresses_D_ht+0x1e34c, %r11
nop
nop
nop
sub %r13, %r13
...
nop
xor %rdi, %rdi
lea addresses_D_ht+0x14eaf, %rcx
sub %r11, %r11
movb $0x61, (%rcx)
nop
xor $16816, %rcx
lea addresses_WT_ht+0xcd2c, %r9
nop
nop
nop
dec %r11
...
{'OP': 'STOR', 'dst': {'type': 'addresses_D_ht', 'AVXalign': True, 'congruent': 2, 'size': 4, 'same': True, 'NT': False}}
...
{'OP': 'REPM', 'src': {'type': 'addresses_D_ht', 'congruent': 0, 'same': False}, 'dst': {'type': 'addresses_WT_ht', 'congruent': 4, 'same': False}}
