...
push %rdi
push %rsi
lea addresses_WC_ht+0x2a7b, %r13
nop
nop
nop
nop
...
nop
dec %rbx
lea addresses_A_ht+0x10ccd, %rax
nop
nop
nop
nop
...
nop
sub %rax, %rax
lea addresses_UC_ht+0x13e9b, %r9
nop
nop
cmp $392, %r8
movups (%r9), %xmm4
...
nop
and %r13, %r13
lea addresses_A_ht+0x1d1fb, %rsi
lea addresses_D_ht+0xa4eb, %rdi
lfence
mov $69, %rcx
rep movsq
nop
...
nop
add $15359, %rsi
lea addresses_normal_ht+0x16a4b, %rbx
xor %r10, %r10
movb $0x61, (%rbx)
nop
nop
...
{'src': {'type': 'addresses_A_ht', 'congruent': 7, 'same': True}, 'OP': 'REPM', 'dst': {'type': 'addresses_D_ht', 'congruent': 4, 'same': False}}
