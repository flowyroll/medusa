...
push %rdx
push %rsi
lea addresses_D_ht+0x16730, %r10
and $15930, %r11
movb $0x61, (%r10)
nop
nop
dec %r12
lea addresses_D_ht+0x12dd8, %r14
nop
nop
nop
inc %rcx
...
nop
inc %r10
lea addresses_D_ht+0x2f00, %rcx
sub %r11, %r11
mov (%rcx), %r12d
nop
nop
xor %rcx, %rcx
lea addresses_A_ht+0x3060, %r11
sub $65224, %rdx
mov (%r11), %r12d
nop
sub $40465, %r12
lea addresses_A_ht+0xb69c, %r12
sub $17499, %rsi
...
lea addresses_WT_ht+0x16100, %rdi
xor %r14, %r14
mov $94, %rcx
rep movsw
nop
...
nop
dec %rsi
lea addresses_normal_ht+0x16c80, %r10
nop
nop
nop
nop
...
<gen_faulty_load>
[REF]
{'src': {'same': False, 'congruent': 0, 'NT': False, 'type': 'addresses_UC', 'size': 1, 'AVXalign': True}, 'OP': 'LOAD'}
[Faulty Load]
{'src': {'same': True, 'congruent': 0, 'NT': False, 'type': 'addresses_UC', 'size': 4, 'AVXalign': True}, 'OP': 'LOAD'}
<gen_prepare_buffer>
...
{'OP': 'STOR', 'dst': {'same': False, 'congruent': 8, 'NT': True, 'type': 'addresses_D_ht', 'size': 1, 'AVXalign': False}}
...
{'OP': 'STOR', 'dst': {'same': False, 'congruent': 2, 'NT': True, 'type': 'addresses_A_ht', 'size': 32, 'AVXalign': False}}
