...
push %rdi
push %rsi
lea addresses_A_ht+0x191db, %r10
nop
cmp $57055, %r9
movups (%r10), %xmm1
vpextrq $1, %xmm1, %rsi
nop
inc %rbx
lea addresses_normal_ht+0x535b, %r10
nop
nop
nop
nop
...
nop
xor $46004, %r9
lea addresses_UC_ht+0x1253b, %r11
nop
cmp $43500, %r9
...
nop
and %r10, %r10
lea addresses_WT_ht+0xa33b, %rsi
lea addresses_normal_ht+0x12efb, %rdi
nop
nop
inc %r14
mov $40, %rcx
rep movsb
add $3514, %r9
lea addresses_UC_ht+0xe13b, %r10
nop
nop
and %r14, %r14
vmovups (%r10), %ymm3
...
movb $0x61, (%rdi)
add $6101, %rcx
lea addresses_WC_ht+0xdd3b, %rcx
nop
dec %r10
movb $0x61, (%rcx)
nop
...
nop
cmp %rsi, %rsi
lea addresses_WT_ht+0x1163b, %rsi
lea addresses_D_ht+0x18c4b, %rdi
cmp %r11, %r11
mov $35, %rcx
rep movsb
nop
nop
sub %rbx, %rbx
lea addresses_WC_ht+0x16b3b, %r14
nop
nop
nop
and %r10, %r10
...
{'src': {'same': False, 'congruent': 8, 'type': 'addresses_WT_ht'}, 'OP': 'REPM', 'dst': {'same': False, 'congruent': 5, 'type': 'addresses_normal_ht'}}
...
{'OP': 'STOR', 'dst': {'NT': True, 'same': False, 'congruent': 9, 'type': 'addresses_A_ht', 'AVXalign': False, 'size': 4}}
{'src': {'same': False, 'congruent': 5, 'type': 'addresses_WT_ht'}, 'OP': 'REPM', 'dst': {'same': False, 'congruent': 4, 'type': 'addresses_D_ht'}}
