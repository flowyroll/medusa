...
push %rdx
push %rsi
lea addresses_WT_ht+0x8127, %rsi
...
nop
cmp %r9, %r9
lea addresses_D_ht+0x109a7, %r14
nop
nop
nop
nop
...
nop
cmp %r14, %r14
lea addresses_normal_ht+0xe3a7, %rsi
clflush (%rsi)
nop
add %r8, %r8
...
nop
and $17719, %r9
lea addresses_D_ht+0x19ce1, %rdx
clflush (%rdx)
nop
nop
cmp $34116, %r8
...
nop
xor %rcx, %rcx
lea addresses_UC_ht+0x1a3a7, %rsi
lea addresses_WC_ht+0x1ac27, %rdi
nop
xor $47359, %r8
mov $31, %rcx
rep movsq
...
nop
add %rdi, %rdi
lea addresses_WT_ht+0xd82b, %rdx
nop
nop
nop
nop
...
{'dst': {'type': 'addresses_normal_ht', 'same': False, 'size': 32, 'congruent': 10, 'NT': False, 'AVXalign': True}, 'OP': 'STOR'}
...
{'dst': {'type': 'addresses_WT_ht', 'same': False, 'size': 32, 'congruent': 2, 'NT': False, 'AVXalign': True}, 'OP': 'STOR'}
{'33': 21829}
