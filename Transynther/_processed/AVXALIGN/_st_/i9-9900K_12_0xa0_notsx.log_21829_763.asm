...
push %rdi
push %rsi
lea addresses_normal_ht+0x1cfcc, %rsi
lea addresses_normal_ht+0x6d4c, %rdi
nop
nop
nop
sub %rax, %rax
...
nop
sub $3176, %rbx
lea addresses_WC_ht+0x14c4c, %rsi
lea addresses_UC_ht+0x44c, %rdi
nop
nop
nop
nop
...
nop
inc %rax
lea addresses_D_ht+0xce4c, %r8
nop
sub %rbx, %rbx
mov (%r8), %cx
nop
xor $51379, %rcx
lea addresses_WC_ht+0xd64c, %rsi
lea addresses_WT_ht+0x9bfc, %rdi
nop
nop
nop
cmp %r11, %r11
...
lea addresses_UC_ht+0x183c5, %rdi
clflush (%rdi)
nop
nop
nop
...
{'src': {'type': 'addresses_WC_ht', 'congruent': 8, 'same': False}, 'OP': 'REPM', 'dst': {'type': 'addresses_WT_ht', 'congruent': 4, 'same': False}}
{'src': {'type': 'addresses_D_ht', 'congruent': 1, 'same': True}, 'OP': 'REPM', 'dst': {'type': 'addresses_UC_ht', 'congruent': 0, 'same': True}}
{'32': 21829}
