...
push %rdx
push %rsi
lea addresses_WT_ht+0xb28a, %rdi
nop
nop
nop
nop
...
nop
xor %r8, %r8
lea addresses_A_ht+0xe4e, %rsi
lea addresses_WC_ht+0x19ef6, %rdi
nop
nop
nop
nop
...
rep movsl
and $41226, %rsi
lea addresses_UC_ht+0x14cb6, %rsi
lea addresses_UC_ht+0xf976, %rdi
nop
xor %r9, %r9
mov $83, %rcx
rep movsb
and %rdi, %rdi
lea addresses_WC_ht+0xe41a, %rdx
nop
nop
nop
nop
...
nop
and %r9, %r9
lea addresses_normal_ht+0x134ce, %rsi
lea addresses_A_ht+0x1a02, %rdi
clflush (%rsi)
nop
nop
nop
...
nop
sub %r11, %r11
lea addresses_UC_ht+0x130a3, %rdx
clflush (%rdx)
nop
nop
nop
...
nop
cmp $49457, %r11
lea addresses_WC_ht+0xf076, %rsi
nop
nop
nop
sub %r9, %r9
...
// Faulty Load
lea addresses_normal+0xd576, %rcx
nop
nop
nop
and $34300, %rax
...
{'src': {'same': False, 'congruent': 3, 'type': 'addresses_A_ht'}, 'OP': 'REPM', 'dst': {'same': False, 'congruent': 6, 'type': 'addresses_WC_ht'}}
