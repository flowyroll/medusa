...
push %rdx
push %rsi
lea addresses_A_ht+0x35ee, %rsi
lea addresses_normal_ht+0x8576, %rdi
nop
nop
add $51219, %rbp
mov $15, %rcx
...
lea addresses_WT_ht+0x1e056, %rdi
clflush (%rsi)
nop
dec %r13
mov $109, %rcx
...
nop
cmp $60710, %rbp
lea addresses_D_ht+0x15ef6, %rsi
lea addresses_normal_ht+0x9df6, %rdi
nop
nop
nop
sub $1004, %r9
...
nop
xor %r9, %r9
lea addresses_A_ht+0x97f6, %rsi
lea addresses_normal_ht+0xdf56, %rdi
nop
nop
nop
sub %rbx, %rbx
...
nop
xor $34515, %rcx
lea addresses_UC_ht+0x1ec76, %rbp
nop
and $43865, %r9
...
nop
dec %rcx
lea addresses_A_ht+0xe2dc, %rsi
lea addresses_normal_ht+0x18e66, %rdi
nop
nop
nop
nop
...
nop
add $7843, %rdx
lea addresses_A_ht+0x19df6, %rbx
nop
nop
nop
nop
...
nop
sub $59159, %rsi
lea addresses_A_ht+0x15206, %rsi
lea addresses_normal_ht+0x1eef6, %rdi
nop
nop
add $7728, %r9
mov $11, %rcx
...
nop
cmp %rbp, %rbp
lea addresses_normal_ht+0x6bb5, %rbx
nop
nop
and %r13, %r13
movl $0x61626364, (%rbx)
...
{'OP': 'REPM', 'src': {'type': 'addresses_A_ht', 'congruent': 8, 'same': False}, 'dst': {'type': 'addresses_normal_ht', 'congruent': 2, 'same': False}}
