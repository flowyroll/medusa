...
push %rdx
push %rsi
lea addresses_WC_ht+0x7d06, %rdx
clflush (%rdx)
add $61588, %rax
...
nop
mfence
lea addresses_normal_ht+0x3f86, %rsi
lea addresses_normal_ht+0x2d76, %rdi
nop
nop
nop
dec %r15
...
rep movsl
xor %rax, %rax
lea addresses_WT_ht+0xb07c, %rsi
lea addresses_WT_ht+0x1d906, %rdi
and $47760, %rbp
mov $88, %rcx
rep movsq
nop
...
{'src': {'same': False, 'congruent': 2, 'NT': False, 'type': 'addresses_WC', 'size': 4, 'AVXalign': False}, 'OP': 'LOAD'}
[Faulty Load]
...
{'src': {'type': 'addresses_WT_ht', 'congruent': 1, 'same': False}, 'OP': 'REPM', 'dst': {'type': 'addresses_WT_ht', 'congruent': 9, 'same': True}}
{'36': 21829}
