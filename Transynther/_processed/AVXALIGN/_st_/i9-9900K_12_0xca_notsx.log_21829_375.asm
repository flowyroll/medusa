...
lea addresses_normal_ht+0x1ef84, %rdi
nop
nop
nop
cmp $12482, %r10
...
nop
dec %r11
lea addresses_UC_ht+0x173b8, %rsi
lea addresses_UC_ht+0x1c172, %rdi
cmp %rbx, %rbx
mov $96, %rcx
rep movsl
nop
...
nop
xor %rax, %rax
lea addresses_A_ht+0x7c20, %rsi
lea addresses_WC_ht+0x59e4, %rdi
nop
nop
dec %rax
mov $57, %rcx
...
nop
add $32142, %rcx
lea addresses_WT_ht+0x5f08, %rsi
lea addresses_D_ht+0x8c08, %rdi
nop
nop
inc %rax
mov $88, %rcx
...
nop
dec %rcx
lea addresses_D_ht+0x1a1e8, %rax
sub $63212, %rcx
mov (%rax), %r10d
nop
add $3138, %rbx
lea addresses_WT_ht+0xe652, %rdi
nop
nop
nop
nop
...
{'OP': 'REPM', 'src': {'same': False, 'congruent': 4, 'type': 'addresses_A_ht'}, 'dst': {'same': True, 'congruent': 1, 'type': 'addresses_normal_ht'}}
{'OP': 'REPM', 'src': {'same': False, 'congruent': 3, 'type': 'addresses_UC_ht'}, 'dst': {'same': False, 'congruent': 1, 'type': 'addresses_UC_ht'}}
{'OP': 'REPM', 'src': {'same': False, 'congruent': 1, 'type': 'addresses_A_ht'}, 'dst': {'same': False, 'congruent': 2, 'type': 'addresses_WC_ht'}}
