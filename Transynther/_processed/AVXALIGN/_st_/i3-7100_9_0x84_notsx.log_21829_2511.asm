...
push %rdi
push %rsi
lea addresses_normal_ht+0x1d9c6, %r9
nop
nop
nop
nop
...
nop
dec %r10
lea addresses_A_ht+0x1d1c6, %rsi
nop
sub %rcx, %rcx
movups (%rsi), %xmm6
vpextrq $1, %xmm6, %rdi
sub $6302, %rax
lea addresses_UC_ht+0xe1aa, %rax
nop
nop
nop
xor %r11, %r11
...
nop
and $542, %rcx
lea addresses_normal_ht+0xadc6, %rsi
lea addresses_WC_ht+0x6fc6, %rdi
nop
inc %r14
mov $81, %rcx
rep movsl
...
nop
and $7533, %rdi
lea addresses_WC_ht+0x7cc6, %rsi
nop
nop
nop
nop
...
nop
and %r11, %r11
lea addresses_UC_ht+0x188c6, %r14
dec %rdi
vmovups (%r14), %ymm7
vextracti128 $1, %ymm7, %xmm7
vpextrq $0, %xmm7, %rax
xor $23958, %rdi
lea addresses_normal_ht+0x11486, %rdi
nop
nop
mfence
...
{'src': {'type': 'addresses_normal_ht', 'congruent': 5, 'same': False}, 'dst': {'type': 'addresses_WC_ht', 'congruent': 1, 'same': False}, 'OP': 'REPM'}
...
{'src': {'type': 'addresses_normal_ht', 'same': False, 'size': 16, 'congruent': 3, 'NT': True, 'AVXalign': False}, 'OP': 'LOAD'}
{'35': 21829}
