...
push %rdi
push %rsi
lea addresses_UC_ht+0x151c1, %rsi
lea addresses_WT_ht+0xbe3f, %rdi
xor $4209, %r11
mov $99, %rcx
rep movsl
nop
inc %rbx
lea addresses_A_ht+0x70ff, %r10
nop
nop
nop
nop
...
mov (%r10), %r11
dec %r11
lea addresses_normal_ht+0x1c62c, %r10
nop
nop
nop
nop
...
nop
add %rcx, %rcx
lea addresses_UC_ht+0x14def, %rsi
...
nop
cmp $34860, %rbx
lea addresses_D_ht+0x1b065, %rcx
nop
nop
nop
nop
...
nop
sub $12873, %rcx
lea addresses_WT_ht+0xc8ff, %rcx
nop
nop
nop
nop
...
nop
sub $28543, %rdi
lea addresses_UC_ht+0x33ff, %r15
nop
nop
nop
nop
...
nop
and %rbx, %rbx
lea addresses_UC_ht+0x1c99f, %rsi
lea addresses_UC_ht+0xcd87, %rdi
nop
nop
nop
cmp %r10, %r10
...
// Faulty Load
lea addresses_normal+0x1ccff, %r8
nop
nop
dec %rax
mov (%r8), %r13d
...
{'OP': 'LOAD', 'src': {'type': 'addresses_UC_ht', 'size': 8, 'AVXalign': True, 'NT': False, 'congruent': 8, 'same': False}}
