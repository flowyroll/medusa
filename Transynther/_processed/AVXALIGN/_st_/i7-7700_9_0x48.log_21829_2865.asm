...
push %rdi
push %rsi
lea addresses_normal_ht+0xf731, %rsi
nop
nop
nop
nop
...
vmovups %ymm7, (%rsi)
add %rbx, %rbx
lea addresses_WT_ht+0x1e47b, %rax
nop
nop
nop
nop
...
vpextrq $1, %xmm2, %r10
add %rbx, %rbx
lea addresses_normal_ht+0x16831, %rsi
lea addresses_normal_ht+0x9b31, %rdi
nop
nop
nop
nop
...
nop
and %rcx, %rcx
lea addresses_UC_ht+0xe871, %rsi
lea addresses_D_ht+0x5e51, %rdi
nop
nop
nop
sub %rax, %rax
...
[Faulty Load]
{'OP': 'LOAD', 'src': {'type': 'addresses_D', 'AVXalign': True, 'congruent': 0, 'size': 8, 'same': True, 'NT': True}}
<gen_prepare_buffer>
