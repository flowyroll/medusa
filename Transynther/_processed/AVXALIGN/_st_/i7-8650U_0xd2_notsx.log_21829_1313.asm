...
push %rdx
push %rsi
lea addresses_A_ht+0x19840, %rdx
nop
nop
nop
nop
...
nop
add $49015, %rax
lea addresses_WC_ht+0xf060, %rsi
nop
nop
lfence
...
nop
cmp %r11, %r11
lea addresses_WT_ht+0x17540, %rbx
nop
and $55503, %r15
movb (%rbx), %r14b
nop
...
nop
add $41196, %rdx
lea addresses_A_ht+0xac60, %rsi
lea addresses_WC_ht+0x7460, %rdi
nop
nop
nop
and %r15, %r15
...
nop
inc %r15
lea addresses_WC_ht+0x12160, %rsi
lea addresses_A_ht+0x557e, %rdi
nop
nop
nop
xor %rax, %rax
...
rep movsl
inc %rbx
lea addresses_normal_ht+0x13878, %r14
nop
nop
sub $54755, %rax
movups (%r14), %xmm6
...
nop
cmp $16393, %r11
lea addresses_WT_ht+0x137f0, %rsi
lea addresses_A_ht+0x19d98, %rdi
clflush (%rsi)
clflush (%rdi)
nop
nop
...
rep movsq
dec %r11
lea addresses_WT_ht+0x1a7c0, %rsi
lea addresses_D_ht+0x18368, %rdi
nop
nop
cmp $22851, %rdx
mov $55, %rcx
...
nop
xor %rdx, %rdx
lea addresses_D_ht+0x1e8a0, %rsi
lea addresses_D_ht+0x1817c, %rdi
clflush (%rsi)
cmp $39505, %rbx
mov $51, %rcx
rep movsb
nop
xor %rax, %rax
lea addresses_UC_ht+0xc5e0, %rdx
cmp $17258, %r14
mov (%rdx), %r11d
dec %r14
pop %rsi
...
// Store
lea addresses_UC+0x107a4, %r9
dec %rbp
movl $0x51525354, (%r9)
sub $5184, %r9

// Faulty Load
lea addresses_D+0x1b860, %r9
nop
sub %r11, %r11
vmovaps (%r9), %ymm1
...
{'OP': 'LOAD', 'src': {'type': 'addresses_A_ht', 'size': 4, 'AVXalign': False, 'NT': True, 'congruent': 11, 'same': True}}
...
{'OP': 'REPM', 'src': {'type': 'addresses_A_ht', 'congruent': 8, 'same': False}, 'dst': {'type': 'addresses_WC_ht', 'congruent': 9, 'same': False}}
...
{'OP': 'REPM', 'src': {'type': 'addresses_D_ht', 'congruent': 0, 'same': False}, 'dst': {'type': 'addresses_D_ht', 'congruent': 2, 'same': False}}
