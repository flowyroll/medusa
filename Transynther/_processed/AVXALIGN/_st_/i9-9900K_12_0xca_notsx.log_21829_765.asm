...
nop
inc %r8
lea addresses_WC_ht+0x1259c, %rsi
lea addresses_WC_ht+0x3128, %rdi
nop
nop
nop
nop
...
// Store
lea addresses_normal+0x13cf8, %rax
nop
cmp $1891, %r9
movw $0x5152, (%rax)
nop
...
// Faulty Load
lea addresses_normal+0x1d1a4, %rcx
clflush (%rcx)
nop
nop
xor $60074, %r14
...
{'OP': 'REPM', 'src': {'same': False, 'congruent': 3, 'type': 'addresses_WC_ht'}, 'dst': {'same': False, 'congruent': 1, 'type': 'addresses_WC_ht'}}
{'34': 21829}
