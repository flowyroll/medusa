...
push %rdi
push %rsi
lea addresses_A_ht+0x17a6b, %rsi
lea addresses_D_ht+0x1e26b, %rdi
nop
nop
nop
sub $41006, %rbx
...
nop
cmp %rbp, %rbp
lea addresses_UC_ht+0x1266b, %rsi
cmp $12496, %rbp
movb (%rsi), %r14b
nop
nop
nop
xor %rbx, %rbx
lea addresses_D_ht+0x17337, %rbp
clflush (%rbp)
cmp %rsi, %rsi
mov (%rbp), %r15d
nop
...
<gen_prepare_buffer>
{'OP': 'REPM', 'src': {'same': False, 'congruent': 9, 'type': 'addresses_A_ht'}, 'dst': {'same': False, 'congruent': 10, 'type': 'addresses_D_ht'}}
