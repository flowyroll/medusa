...
nop
add $64493, %rcx
lea addresses_WT_ht+0xffed, %rbp
and $62912, %r11
movl $0x61626364, (%rbp)
nop
nop
...
nop
and %rdi, %rdi
lea addresses_D_ht+0x9cd, %rsi
lea addresses_WC_ht+0xf96d, %rdi
nop
nop
and $53627, %r12
mov $114, %rcx
...
nop
xor %rcx, %rcx
lea addresses_UC_ht+0x10e6d, %r8
nop
xor $17618, %rdi
movb $0x61, (%r8)
nop
sub %rdi, %rdi
lea addresses_UC_ht+0x422d, %rsi
lea addresses_WT_ht+0x12b6d, %rdi
nop
nop
nop
nop
...
nop
add $7400, %rdi
lea addresses_A_ht+0x18cad, %rdi
nop
nop
nop
nop
...
nop
xor $61099, %r8
lea addresses_normal_ht+0x1b2bd, %rbp
clflush (%rbp)
nop
cmp %r12, %r12
vmovups (%rbp), %ymm7
...
vpextrq $0, %xmm7, %rcx
dec %rcx
lea addresses_A_ht+0xa6ed, %rbp
nop
nop
cmp %r8, %r8
movl $0x61626364, (%rbp)
sub %rcx, %rcx
lea addresses_A_ht+0xe7ed, %rsi
lea addresses_UC_ht+0x1a1dd, %rdi
clflush (%rsi)
nop
dec %r10
mov $0, %rcx
...
nop
and %r10, %r10
lea addresses_WC_ht+0xa4ed, %rsi
lea addresses_UC_ht+0xf10d, %rdi
and %r10, %r10
mov $32, %rcx
rep movsw
nop
cmp $22896, %rbp
lea addresses_A_ht+0x137ad, %r8
clflush (%r8)
nop
nop
nop
...
nop
inc %rdi
lea addresses_UC_ht+0x87ed, %rcx
add $5183, %r11
movb $0x61, (%rcx)
nop
sub $4797, %r11
...
{'OP': 'REPM', 'src': {'type': 'addresses_A_ht', 'congruent': 10, 'same': False}, 'dst': {'type': 'addresses_UC_ht', 'congruent': 3, 'same': False}}
{'OP': 'REPM', 'src': {'type': 'addresses_WC_ht', 'congruent': 8, 'same': False}, 'dst': {'type': 'addresses_UC_ht', 'congruent': 5, 'same': False}}
