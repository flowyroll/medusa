...
nop
inc %r15
lea addresses_WC_ht+0x1b2c4, %r10
nop
nop
nop
nop
...
nop
inc %r11
lea addresses_normal_ht+0x19f04, %rsi
lea addresses_UC_ht+0x7984, %rdi
nop
nop
nop
nop
...
nop
sub $15284, %r9
lea addresses_WT_ht+0x153c4, %rdi
nop
nop
and $42906, %r9
mov (%rdi), %bx
nop
xor $256, %r10
lea addresses_WC_ht+0x16ac4, %r10
nop
nop
sub %rsi, %rsi
movb (%r10), %r15b
...
nop
sub $20689, %rsi
lea addresses_UC_ht+0x6c4, %rsi
lea addresses_WT_ht+0x13274, %rdi
nop
nop
nop
nop
...
nop
sub %r11, %r11
lea addresses_UC_ht+0x4744, %rcx
nop
nop
nop
nop
