...
push %rdi
push %rsi
lea addresses_D_ht+0x9c52, %rsi
lea addresses_A_ht+0x92fa, %rdi
nop
nop
nop
nop
...
nop
sub $20273, %rbx
lea addresses_UC_ht+0x1e16a, %rsi
nop
inc %rbp
movups (%rsi), %xmm1
vpextrq $0, %xmm1, %rcx
...
nop
cmp $1584, %rbx
lea addresses_normal_ht+0xb26a, %rbx
nop
nop
nop
nop
...
nop
cmp %rdi, %rdi
lea addresses_A_ht+0x12ed1, %rsi
nop
nop
nop
nop
...
nop
cmp %r12, %r12
lea addresses_UC_ht+0x912a, %rcx
nop
and $42892, %r9
mov $0x6162636465666768, %rdi
movq %rdi, %xmm4
movups %xmm4, (%rcx)
xor $24034, %rsi
lea addresses_WT_ht+0xe06a, %r12
and $1958, %rsi
mov (%r12), %cx
nop
nop
...
nop
add %rbx, %rbx
lea addresses_WC_ht+0x19d7a, %rbp
nop
nop
nop
nop
...
nop
sub $45813, %rsi
lea addresses_UC_ht+0x816a, %rbx
nop
nop
nop
nop
...
{'OP': 'LOAD', 'src': {'same': False, 'NT': False, 'AVXalign': False, 'size': 2, 'type': 'addresses_NC', 'congruent': 7}}
[Faulty Load]
{'OP': 'LOAD', 'src': {'same': True, 'NT': True, 'AVXalign': False, 'size': 2, 'type': 'addresses_WT', 'congruent': 0}}
<gen_prepare_buffer>
{'dst': {'same': False, 'congruent': 4, 'type': 'addresses_A_ht'}, 'OP': 'REPM', 'src': {'same': False, 'congruent': 2, 'type': 'addresses_D_ht'}}
