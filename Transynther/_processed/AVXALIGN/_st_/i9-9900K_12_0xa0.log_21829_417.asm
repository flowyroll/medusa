...
nop
and $4685, %rdi
lea addresses_WC_ht+0x7249, %rax
clflush (%rax)
nop
nop
nop
...
nop
inc %r8
lea addresses_WC_ht+0x1ccc, %r12
nop
add %rdi, %rdi
movb $0x61, (%r12)
inc %rdi
lea addresses_normal_ht+0x63cc, %rcx
nop
nop
nop
nop
...
vpextrq $1, %xmm2, %rdi
xor $49734, %rax
lea addresses_UC_ht+0x10214, %r12
nop
nop
add %rax, %rax
vmovups (%r12), %ymm2
...
nop
and %rcx, %rcx
lea addresses_WT_ht+0x16e3c, %rsi
lea addresses_UC_ht+0x4752, %rdi
nop
nop
nop
and $21886, %r13
...
nop
and $37692, %rcx
lea addresses_WC_ht+0x19a44, %r12
nop
nop
nop
nop
...
nop
cmp %r12, %r12
lea addresses_WT_ht+0x13821, %rax
nop
nop
nop
nop
