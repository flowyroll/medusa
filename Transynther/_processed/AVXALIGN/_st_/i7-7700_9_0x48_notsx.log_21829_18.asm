...
push %rdx
push %rsi
lea addresses_normal_ht+0x14096, %r11
nop
cmp %rsi, %rsi
...
nop
inc %r14
lea addresses_WC_ht+0x146a6, %rsi
lea addresses_D_ht+0x1887e, %rdi
nop
nop
nop
add %r11, %r11
...
nop
inc %rsi
lea addresses_D_ht+0x7256, %rsi
lea addresses_D_ht+0x13096, %rdi
xor $3458, %rax
mov $112, %rcx
rep movsb
and $36330, %rsi
lea addresses_WC_ht+0xd36d, %rcx
nop
nop
lfence
vmovups (%rcx), %ymm2
...
lea addresses_WC_ht+0x17896, %rdi
nop
sub %r11, %r11
mov $31, %rcx
rep movsb
...
// REPMOV
lea addresses_PSE+0xf496, %rsi
lea addresses_A+0x4376, %rdi
nop
nop
nop
and $1537, %r9
...
// Store
lea addresses_normal+0xa88f, %r11
nop
nop
sub %r9, %r9
...
{'dst': {'same': False, 'congruent': 2, 'type': 'addresses_A'}, 'OP': 'REPM', 'src': {'same': False, 'congruent': 11, 'type': 'addresses_PSE'}}
...
{'dst': {'same': False, 'congruent': 7, 'type': 'addresses_D_ht'}, 'OP': 'REPM', 'src': {'same': False, 'congruent': 6, 'type': 'addresses_D_ht'}}
