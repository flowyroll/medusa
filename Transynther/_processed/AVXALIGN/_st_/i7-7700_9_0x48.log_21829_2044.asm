...
push %rdi
push %rsi
lea addresses_WC_ht+0x20e9, %rsi
...
nop
add %r11, %r11
lea addresses_WC_ht+0x1e1c9, %r15
clflush (%r15)
nop
nop
xor $63856, %rdi
...
nop
xor %rdi, %rdi
lea addresses_UC_ht+0x8eed, %rdi
add $61743, %r13
movb $0x61, (%rdi)
nop
nop
...
mov (%r11), %si
xor $33672, %r15
lea addresses_D_ht+0x190e9, %rcx
nop
nop
nop
nop
...
nop
xor %r8, %r8
lea addresses_normal_ht+0x1ae35, %rcx
nop
nop
nop
nop
...
nop
and $45363, %r15
lea addresses_WT_ht+0x1a0e9, %rcx
nop
nop
dec %r15
...
nop
add $34285, %rcx
lea addresses_D_ht+0x151d1, %rsi
lea addresses_WC_ht+0x2ce9, %rdi
nop
nop
nop
nop
...
// Faulty Load
lea addresses_normal+0xece9, %rbp
nop
and %r9, %r9
mov (%rbp), %ax
lea oracles, %rdx
...
{'OP': 'LOAD', 'src': {'type': 'addresses_PSE', 'AVXalign': True, 'congruent': 10, 'size': 16, 'same': False, 'NT': False}}
