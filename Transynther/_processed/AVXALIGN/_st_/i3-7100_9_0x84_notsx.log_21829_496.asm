...
push %rcx
push %rsi
lea addresses_D_ht+0x5137, %r12
nop
and $29372, %r13
movb $0x61, (%r12)
xor %rbx, %rbx
lea addresses_WC_ht+0x14a07, %r13
clflush (%r13)
nop
nop
sub %r15, %r15
...
nop
sub %r12, %r12
lea addresses_WT_ht+0x64b7, %rbx
nop
add $47547, %r11
...
nop
inc %rbx
lea addresses_normal_ht+0x668b, %r13
nop
nop
nop
nop
...
nop
add %rsi, %rsi
lea addresses_WT_ht+0x366b, %rbx
nop
nop
inc %r12
mov (%rbx), %r11d
