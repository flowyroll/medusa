...
nop
inc %r8
lea addresses_WT_ht+0x163ed, %rsi
lea addresses_UC_ht+0x18f96, %rdi
nop
nop
nop
cmp %r8, %r8
...
{'OP': 'LOAD', 'src': {'type': 'addresses_RW', 'AVXalign': False, 'congruent': 10, 'size': 8, 'same': False, 'NT': False}}
