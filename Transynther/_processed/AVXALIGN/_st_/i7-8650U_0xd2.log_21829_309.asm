...
push %rdi
push %rsi
lea addresses_normal_ht+0x1bede, %r10
nop
nop
nop
nop
...
nop
and %r11, %r11
lea addresses_UC_ht+0x94b4, %rdi
nop
sub %rax, %rax
mov (%rdi), %r12w
nop
...
nop
dec %rdi
lea addresses_WC_ht+0xb790, %r12
nop
inc %rbx
