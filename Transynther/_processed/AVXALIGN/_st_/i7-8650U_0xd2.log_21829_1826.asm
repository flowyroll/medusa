...
push %rdx
push %rsi
lea addresses_A_ht+0x16988, %r12
nop
nop
nop
add %rcx, %rcx
...
nop
add %r9, %r9
lea addresses_UC_ht+0x8e38, %rsi
nop
nop
nop
nop
...
movw $0x6162, (%rsi)
cmp %r13, %r13
lea addresses_UC_ht+0x18b08, %r9
xor %rdx, %rdx
...
lea addresses_normal_ht+0x142c8, %rdi
nop
nop
nop
nop
...
nop
and %r9, %r9
lea addresses_WC_ht+0x18e08, %rdi
nop
nop
dec %rsi
mov (%rdi), %r9
...
nop
cmp $76, %r9
lea addresses_WT_ht+0x5cd2, %rsi
lea addresses_D_ht+0xc288, %rdi
nop
nop
nop
nop
...
nop
add %rdx, %rdx
lea addresses_D_ht+0x1e668, %rdx
clflush (%rdx)
nop
xor %r9, %r9
movl $0x61626364, (%rdx)
inc %r13
lea addresses_A_ht+0x8174, %rsi
lea addresses_D_ht+0x15888, %rdi
xor $23207, %rdx
mov $39, %rcx
rep movsl
nop
nop
cmp $53595, %rsi
lea addresses_WC_ht+0xb688, %rsi
lea addresses_D_ht+0x1ba88, %rdi
and %r13, %r13
mov $63, %rcx
rep movsq
nop
sub $53396, %rcx
lea addresses_A_ht+0xee88, %rsi
lea addresses_A_ht+0x689c, %rdi
nop
nop
nop
nop
...
{'OP': 'REPM', 'src': {'type': 'addresses_WT_ht', 'congruent': 6, 'same': True}, 'dst': {'type': 'addresses_normal_ht', 'congruent': 6, 'same': False}}
...
{'OP': 'STOR', 'dst': {'type': 'addresses_D_ht', 'size': 4, 'AVXalign': False, 'NT': True, 'congruent': 4, 'same': False}}
{'OP': 'REPM', 'src': {'type': 'addresses_A_ht', 'congruent': 0, 'same': False}, 'dst': {'type': 'addresses_D_ht', 'congruent': 8, 'same': False}}
{'OP': 'REPM', 'src': {'type': 'addresses_WC_ht', 'congruent': 10, 'same': False}, 'dst': {'type': 'addresses_D_ht', 'congruent': 10, 'same': True}}
