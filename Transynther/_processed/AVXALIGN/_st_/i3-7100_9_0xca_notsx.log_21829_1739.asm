...
nop
inc %r10
lea addresses_WT_ht+0xf3e, %rbx
sub %r14, %r14
mov (%rbx), %r15d
nop
nop
inc %r8
lea addresses_UC_ht+0x284e, %r14
nop
nop
nop
nop
...
nop
sub $12305, %rbx
lea addresses_normal_ht+0x1824e, %r13
nop
nop
nop
add %r10, %r10
