...
push %rdx
push %rsi
lea addresses_UC_ht+0x11824, %rsi
nop
nop
nop
and $56717, %rbp
...
nop
add $46858, %r15
lea addresses_normal_ht+0x9605, %r10
nop
nop
nop
nop
...
nop
cmp %rbp, %rbp
lea addresses_WC_ht+0x1ce7c, %rbp
cmp $22613, %rdi
mov (%rbp), %r15w
nop
nop
xor $36361, %r15
lea addresses_WC_ht+0x4e38, %rsi
...
nop
xor %rbp, %rbp
lea addresses_A_ht+0x107a4, %rcx
add $63247, %rdi
mov (%rcx), %edx
nop
nop
...
nop
add $27767, %r8
lea addresses_normal_ht+0x12cc9, %r15
nop
nop
nop
nop
...
// Load
lea addresses_normal+0x10ed4, %r11
nop
nop
nop
nop
...
// Store
lea addresses_normal+0x5f54, %rdx
nop
add $60007, %r15
movw $0x5152, (%rdx)
nop
...
{'OP': 'LOAD', 'src': {'same': False, 'NT': False, 'AVXalign': False, 'size': 16, 'type': 'addresses_normal', 'congruent': 6}}
...
{'dst': {'same': False, 'NT': False, 'AVXalign': False, 'size': 1, 'type': 'addresses_P', 'congruent': 6}, 'OP': 'STOR'}
{'dst': {'same': False, 'NT': False, 'AVXalign': False, 'size': 2, 'type': 'addresses_normal', 'congruent': 9}, 'OP': 'STOR'}
