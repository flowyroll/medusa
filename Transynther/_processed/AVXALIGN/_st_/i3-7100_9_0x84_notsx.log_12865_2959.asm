...
push %rdi
push %rsi
lea addresses_D_ht+0x15310, %r15
nop
nop
and $27999, %r8
mov (%r15), %r12
...
nop
and $6844, %r12
lea addresses_WT_ht+0x9530, %rsi
lea addresses_WC_ht+0x8c30, %rdi
nop
nop
and $10694, %r10
mov $60, %rcx
rep movsl
and $19439, %rdi
lea addresses_normal_ht+0x1d530, %rdi
xor %r10, %r10
movb $0x61, (%rdi)
nop
xor %rsi, %rsi
lea addresses_WC_ht+0xab10, %r8
dec %rdi
mov (%r8), %rcx
nop
nop
dec %rsi
lea addresses_UC_ht+0x6630, %r10
nop
nop
nop
sub %rdi, %rdi
...
// Load
lea addresses_normal+0x1c930, %rsi
nop
nop
nop
nop
...
{'src': {'type': 'addresses_normal', 'same': False, 'size': 1, 'congruent': 9, 'NT': False, 'AVXalign': False}, 'OP': 'LOAD'}
{'dst': {'type': 'addresses_P', 'same': False, 'size': 2, 'congruent': 4, 'NT': True, 'AVXalign': False}, 'OP': 'STOR'}
...
<gen_prepare_buffer>
{'src': {'type': 'addresses_D_ht', 'same': False, 'size': 8, 'congruent': 3, 'NT': True, 'AVXalign': False}, 'OP': 'LOAD'}
