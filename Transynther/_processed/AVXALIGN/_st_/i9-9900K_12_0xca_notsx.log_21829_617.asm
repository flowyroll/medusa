...
push %rdi
push %rsi
lea addresses_WC_ht+0x1819e, %rsi
nop
nop
nop
add $55048, %rbx
...
movq %r13, (%rsi)
and $44055, %r11
lea addresses_A_ht+0x1be2a, %r13
nop
nop
nop
nop
...
nop
cmp %r11, %r11
lea addresses_UC_ht+0x2f4e, %rsi
lea addresses_normal_ht+0xbb3e, %rdi
nop
add %rbx, %rbx
mov $10, %rcx
rep movsb
...
nop
cmp %r11, %r11
lea addresses_WC_ht+0x1e94e, %r13
nop
cmp %rsi, %rsi
mov (%r13), %rdi
and %r14, %r14
...
// Faulty Load
lea addresses_normal+0x794e, %r12
nop
and $49932, %rsi
mov (%r12), %r8d
lea oracles, %rbp
...
{'OP': 'REPM', 'src': {'same': False, 'congruent': 9, 'type': 'addresses_UC_ht'}, 'dst': {'same': True, 'congruent': 4, 'type': 'addresses_normal_ht'}}
