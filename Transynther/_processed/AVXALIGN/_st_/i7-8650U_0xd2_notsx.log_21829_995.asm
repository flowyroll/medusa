...
lea addresses_normal_ht+0x1d6aa, %rdi
nop
nop
nop
sub %r12, %r12
...
nop
and $49872, %r10
lea addresses_normal_ht+0x1aaaa, %r11
nop
nop
nop
nop
...
nop
cmp $15210, %r11
lea addresses_normal_ht+0x1222a, %r13
cmp $3075, %rdi
...
nop
add %rdi, %rdi
lea addresses_UC_ht+0x13962, %rsi
dec %r10
mov (%rsi), %r13d
nop
nop
...
nop
and %rsi, %rsi
lea addresses_A_ht+0x18eea, %r10
clflush (%r10)
nop
nop
nop
...
nop
inc %r11
lea addresses_UC_ht+0x70a2, %r11
nop
nop
and %r12, %r12
mov (%r11), %si
...
nop
and $61531, %r11
lea addresses_normal_ht+0x18faa, %rsi
lea addresses_UC_ht+0x13272, %rdi
nop
nop
add %rdx, %rdx
mov $14, %rcx
...
nop
dec %r11
lea addresses_WT_ht+0x123aa, %rdi
add $54552, %rdx
...
nop
and %r12, %r12
lea addresses_WC_ht+0x16dea, %rsi
lea addresses_UC_ht+0x17baa, %rdi
nop
nop
cmp $7469, %r10
mov $80, %rcx
...
nop
add %r13, %r13
lea addresses_WT_ht+0x5bba, %r11
nop
inc %r12
movb (%r11), %r10b
nop
...
{'OP': 'STOR', 'dst': {'type': 'addresses_normal_ht', 'size': 8, 'AVXalign': True, 'NT': True, 'congruent': 4, 'same': False}}
