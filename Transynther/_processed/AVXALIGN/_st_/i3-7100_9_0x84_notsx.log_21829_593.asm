...
push %rdi
push %rsi
lea addresses_A_ht+0x19461, %rax
nop
nop
and $20954, %r10
mov (%rax), %r9d
...
nop
sub %rax, %rax
lea addresses_normal_ht+0x12641, %rsi
lea addresses_D_ht+0x5e61, %rdi
nop
nop
nop
nop
...
nop
cmp %rcx, %rcx
lea addresses_UC_ht+0xefd0, %rsi
lea addresses_D_ht+0x19021, %rdi
cmp %r13, %r13
mov $25, %rcx
rep movsl
nop
...
nop
lfence
lea addresses_D_ht+0xf921, %rsi
lea addresses_normal_ht+0xc43, %rdi
nop
and $62195, %r9
mov $18, %rcx
rep movsq
...
nop
cmp $45887, %rax
lea addresses_normal_ht+0x6471, %rsi
nop
nop
nop
nop
...
nop
inc %rcx
lea addresses_WT_ht+0x11941, %r13
nop
nop
nop
xor $37329, %rsi
...
nop
cmp %r13, %r13
lea addresses_UC_ht+0x17f61, %rsi
nop
nop
sub %r10, %r10
movb $0x61, (%rsi)
