...
push %rdi
push %rsi
lea addresses_UC_ht+0x87fe, %rax
inc %rsi
mov $0x6162636465666768, %r10
movq %r10, (%rax)
cmp $28626, %r12
lea addresses_A_ht+0xf846, %rsi
nop
nop
nop
sub %r15, %r15
...
vmovups %ymm6, (%rsi)
xor $38312, %rcx
lea addresses_normal_ht+0x15d16, %rcx
nop
and %rbp, %rbp
movups (%rcx), %xmm4
vpextrq $1, %xmm4, %r15
...
nop
add %r10, %r10
lea addresses_WC_ht+0xa196, %rsi
lea addresses_normal_ht+0x1c8ed, %rdi
xor $61764, %rbp
mov $85, %rcx
rep movsl
nop
...
nop
inc %rdi
lea addresses_WT_ht+0x17556, %r15
nop
nop
and %rbp, %rbp
...
nop
cmp $5270, %rcx
lea addresses_normal_ht+0x15796, %rdi
nop
nop
nop
inc %rcx
...
nop
lfence
lea addresses_WC_ht+0x8796, %r12
nop
nop
nop
nop
...
movw $0x6162, (%rdi)
dec %r15
lea addresses_A_ht+0x1e86e, %rsi
...
{'src': {'type': 'addresses_WC_ht', 'congruent': 8, 'same': False}, 'dst': {'type': 'addresses_normal_ht', 'congruent': 0, 'same': False}, 'OP': 'REPM'}
{'dst': {'type': 'addresses_WT_ht', 'same': False, 'size': 16, 'congruent': 5, 'NT': False, 'AVXalign': False}, 'OP': 'STOR'}
{'src': {'type': 'addresses_A_ht', 'congruent': 11, 'same': False}, 'dst': {'type': 'addresses_UC_ht', 'congruent': 11, 'same': False}, 'OP': 'REPM'}
{'dst': {'type': 'addresses_normal_ht', 'same': False, 'size': 4, 'congruent': 9, 'NT': True, 'AVXalign': False}, 'OP': 'STOR'}
...
{'src': {'type': 'addresses_WC_ht', 'same': True, 'size': 4, 'congruent': 5, 'NT': False, 'AVXalign': False}, 'OP': 'LOAD'}
{'dst': {'type': 'addresses_D_ht', 'same': False, 'size': 2, 'congruent': 7, 'NT': False, 'AVXalign': False}, 'OP': 'STOR'}
{'src': {'type': 'addresses_A_ht', 'congruent': 3, 'same': True}, 'dst': {'type': 'addresses_WT_ht', 'congruent': 4, 'same': False}, 'OP': 'REPM'}
{'38': 21829}
