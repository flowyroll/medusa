...
push %rdi
push %rsi
lea addresses_WC_ht+0xb38e, %rsi
lea addresses_normal_ht+0x7df7, %rdi
nop
nop
nop
nop
...
nop
sub %r11, %r11
lea addresses_WT_ht+0x3437, %rsi
lea addresses_WT_ht+0x14f7, %rdi
nop
cmp %r11, %r11
mov $49, %rcx
rep movsl
...
nop
add %r15, %r15
lea addresses_D_ht+0x1be07, %r10
sub %r14, %r14
...
vmovntdq %ymm3, (%r10)
and %rdi, %rdi
lea addresses_UC_ht+0x12ef7, %r11
clflush (%r11)
nop
nop
nop
...
mov (%r11), %rdi
add %rsi, %rsi
lea addresses_UC_ht+0x75f7, %r10
nop
nop
sub %r15, %r15
mov (%r10), %rsi
...
nop
add %rcx, %rcx
lea addresses_WC_ht+0x15f2f, %rcx
nop
nop
nop
nop
...
nop
add %r11, %r11
lea addresses_WT_ht+0xe3f7, %r10
nop
cmp %r11, %r11
vmovups (%r10), %ymm7
...
nop
add %rsi, %rsi
lea addresses_A_ht+0x198f7, %r11
xor %r10, %r10
mov (%r11), %rdi
nop
nop
...
// Faulty Load
lea addresses_normal+0x40f7, %r11
nop
nop
nop
nop
