...
push %rdx
push %rsi
lea addresses_A_ht+0x1cf6c, %rdx
add %rsi, %rsi
movw $0x6162, (%rdx)
nop
nop
...
nop
dec %rdi
lea addresses_UC_ht+0x14f6c, %rbx
dec %r15
movl $0x61626364, (%rbx)
nop
nop
cmp %rdi, %rdi
lea addresses_WC_ht+0xbe0c, %rax
dec %rbx
movb (%rax), %r15b
nop
nop
...
nop
and %rbx, %rbx
lea addresses_WC_ht+0x216c, %r15
nop
nop
nop
xor $49004, %rbx
...
nop
dec %rax
lea addresses_WT_ht+0x2d51, %rdi
nop
nop
add $15727, %rsi
vmovups (%rdi), %ymm0
...
nop
inc %rbx
lea addresses_normal_ht+0x476c, %rax
nop
nop
nop
nop
...
nop
inc %rax
lea addresses_normal_ht+0x13394, %rdx
xor $11625, %r8
...
nop
sub %rdx, %rdx
lea addresses_UC_ht+0x1398c, %rsi
inc %rdi
movl $0x61626364, (%rsi)
nop
and %r15, %r15
...
// Load
lea addresses_normal+0x136c, %rsi
nop
dec %rbp
vmovups (%rsi), %ymm5
...
// Store
lea addresses_normal+0x1bbec, %r14
cmp $28616, %r13
movw $0x5152, (%r14)
nop
nop
...
{'OP': 'STOR', 'dst': {'type': 'addresses_D', 'size': 2, 'AVXalign': True, 'NT': False, 'congruent': 0, 'same': False}}
[Faulty Load]
