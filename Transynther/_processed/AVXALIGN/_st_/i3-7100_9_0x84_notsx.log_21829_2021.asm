...
push %rdx
push %rsi
lea addresses_UC_ht+0x1df6a, %r10
nop
add %r9, %r9
movb (%r10), %al
nop
...
nop
sub %rax, %rax
lea addresses_WC_ht+0x11eea, %rax
nop
and $65317, %rdx
movl $0x61626364, (%rax)
nop
and $48140, %rax
lea addresses_D_ht+0x196a, %rax
nop
nop
nop
sub %rsi, %rsi
...
nop
xor %rsi, %rsi
lea addresses_UC_ht+0x466a, %rax
nop
nop
nop
cmp $40560, %r9
...
nop
sub $33385, %rsi
lea addresses_WC_ht+0x143ca, %rbp
clflush (%rbp)
nop
nop
nop
...
nop
sub %r9, %r9
lea addresses_WT_ht+0x52ea, %rsi
lea addresses_D_ht+0xe838, %rdi
nop
nop
add $1169, %r10
mov $82, %rcx
rep movsb
sub %rcx, %rcx
lea addresses_normal_ht+0x1496a, %rax
nop
sub %rdx, %rdx
...
nop
and $3919, %rdx
lea addresses_A_ht+0xbb4a, %rsi
lea addresses_A_ht+0x4d35, %rdi
xor $55996, %r9
mov $42, %rcx
rep movsl
nop
...
// Load
lea addresses_WT+0x1556a, %rax
sub $14869, %r9
mov (%rax), %bx
add $26711, %r13

// Faulty Load
lea addresses_A+0x1d96a, %rsi
nop
cmp %r11, %r11
movb (%rsi), %bl
lea oracles, %rsi
...
<gen_prepare_buffer>
{'src': {'type': 'addresses_UC_ht', 'same': False, 'size': 1, 'congruent': 9, 'NT': True, 'AVXalign': False}, 'OP': 'LOAD'}
...
{'dst': {'type': 'addresses_UC_ht', 'same': False, 'size': 32, 'congruent': 8, 'NT': False, 'AVXalign': True}, 'OP': 'STOR'}
...
{'src': {'type': 'addresses_D_ht', 'same': False, 'size': 4, 'congruent': 5, 'NT': False, 'AVXalign': True}, 'OP': 'LOAD'}
{'src': {'type': 'addresses_A_ht', 'congruent': 1, 'same': True}, 'dst': {'type': 'addresses_A_ht', 'congruent': 0, 'same': False}, 'OP': 'REPM'}
{'35': 21829}
