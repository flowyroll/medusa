...
lea addresses_normal_ht+0x1a048, %rdi
nop
nop
cmp $55440, %r9
mov $104, %rcx
rep movsb
cmp %rdx, %rdx
lea addresses_D_ht+0x18248, %rsi
lea addresses_WT_ht+0x4808, %rdi
nop
xor %rbx, %rbx
mov $80, %rcx
rep movsl
...
nop
sub %rcx, %rcx
lea addresses_WT_ht+0xb748, %rcx
clflush (%rcx)
and $41416, %r10
mov (%rcx), %r9
nop
nop
cmp $57198, %rsi
lea addresses_A_ht+0x18d48, %rsi
...
nop
add %r9, %r9
lea addresses_D_ht+0x18c1a, %rdx
nop
nop
sub $38080, %r9
mov (%rdx), %edi
...
nop
sub $52754, %r9
lea addresses_WC_ht+0xa7c0, %rcx
clflush (%rcx)
nop
nop
nop
...
nop
sub %r10, %r10
lea addresses_normal_ht+0x17a6, %rsi
nop
nop
and %r10, %r10
mov (%rsi), %dx
...
// Faulty Load
lea addresses_normal+0x11048, %r14
clflush (%r14)
nop
nop
nop
...
<gen_prepare_buffer>
{'src': {'same': False, 'congruent': 6, 'type': 'addresses_normal_ht'}, 'OP': 'REPM', 'dst': {'same': False, 'congruent': 11, 'type': 'addresses_normal_ht'}}
...
{'src': {'same': True, 'congruent': 8, 'type': 'addresses_A_ht'}, 'OP': 'REPM', 'dst': {'same': False, 'congruent': 6, 'type': 'addresses_WT_ht'}}
