...
mov (%rax), %r8w
add %rsi, %rsi
lea addresses_A_ht+0x1d48, %rsi
lea addresses_UC_ht+0xd4a8, %rdi
nop
nop
nop
and $26966, %r11
...
nop
inc %rcx
lea addresses_WC_ht+0x1d888, %r8
nop
nop
nop
dec %r11
mov (%r8), %rax
xor $12489, %rsi
lea addresses_D_ht+0x10088, %rsi
lea addresses_A_ht+0x12d78, %rdi
nop
nop
nop
nop
...
nop
add $60420, %rbp
lea addresses_WC_ht+0x1b548, %rcx
nop
nop
nop
lfence
...
nop
add %rbp, %rbp
lea addresses_UC_ht+0x84f0, %rsi
lea addresses_WC_ht+0x191e0, %rdi
add %r11, %r11
mov $3, %rcx
rep movsq
nop
...
nop
dec %r11
lea addresses_WT_ht+0x11a08, %rdx
nop
nop
nop
nop
...
{'OP': 'REPM', 'src': {'type': 'addresses_UC_ht', 'congruent': 3, 'same': False}, 'dst': {'type': 'addresses_WC_ht', 'congruent': 1, 'same': True}}
