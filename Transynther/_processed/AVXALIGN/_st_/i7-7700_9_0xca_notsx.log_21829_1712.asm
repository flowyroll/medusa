...
push %rdx
push %rsi
lea addresses_WT_ht+0x5073, %r11
nop
add %r13, %r13
mov (%r11), %rdx
nop
...
nop
dec %rdx
lea addresses_normal_ht+0x1e46f, %rsi
lea addresses_A_ht+0xa5ef, %rdi
clflush (%rsi)
nop
nop
nop
...
rep movsb
and %rax, %rax
lea addresses_WT_ht+0x12364, %rdi
nop
nop
and $50464, %rdx
mov (%rdi), %r13d
...
nop
sub $52126, %rcx
lea addresses_WC_ht+0xe4af, %rdx
nop
nop
nop
and $31794, %rdi
...
nop
xor $21937, %rdi
lea addresses_WC_ht+0x1d8af, %r13
nop
nop
nop
nop
...
{'src': {'congruent': 6, 'same': False, 'type': 'addresses_normal_ht'}, 'dst': {'congruent': 4, 'same': False, 'type': 'addresses_A_ht'}, 'OP': 'REPM'}
