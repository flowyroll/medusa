...
push %rdx
push %rsi
lea addresses_normal_ht+0x17359, %rdx
nop
nop
nop
nop
...
nop
dec %r8
lea addresses_UC_ht+0x6bfe, %r13
nop
nop
nop
nop
...
movups %xmm3, (%r13)
and $30238, %r10
lea addresses_D_ht+0x142d9, %r13
nop
nop
inc %rdi
movups (%r13), %xmm0
...
nop
sub %r10, %r10
lea addresses_A_ht+0x1443c, %rsi
...
nop
cmp %rcx, %rcx
lea addresses_normal_ht+0xcb59, %r11
nop
nop
cmp %rdi, %rdi
...
nop
inc %r13
lea addresses_normal_ht+0x1419, %r11
nop
nop
nop
cmp $32499, %r10
...
nop
cmp %rcx, %rcx
lea addresses_A_ht+0x13b19, %rdx
nop
nop
nop
nop
...
mov (%rdx), %r14w
and %rdi, %rdi
lea addresses_normal_ht+0x6871, %r11
nop
cmp %rcx, %rcx
...
nop
inc %r11
lea addresses_WC_ht+0x7499, %r13
nop
lfence
movups (%r13), %xmm1
vpextrq $1, %xmm1, %rdx
...
{'dst': {'same': False, 'congruent': 10, 'type': 'addresses_D_ht'}, 'OP': 'REPM', 'src': {'same': False, 'congruent': 0, 'type': 'addresses_A_ht'}}
...
{'dst': {'same': False, 'NT': True, 'AVXalign': False, 'size': 8, 'type': 'addresses_normal_ht', 'congruent': 2}, 'OP': 'STOR'}
