...
push %rdi
push %rsi
lea addresses_WT_ht+0x1175c, %rsi
lea addresses_A_ht+0xa004, %rdi
nop
nop
nop
nop
...
nop
cmp $42372, %rbx
lea addresses_D_ht+0x1b2dc, %rbx
dec %r9
vmovups (%rbx), %ymm4
vextracti128 $0, %ymm4, %xmm4
vpextrq $0, %xmm4, %rax
add %rbx, %rbx
lea addresses_A_ht+0xaedc, %rdi
nop
nop
nop
add $1038, %rax
...
nop
xor %rax, %rax
lea addresses_normal_ht+0x12bcc, %r9
nop
nop
nop
add $22034, %rax
mov (%r9), %ebx
cmp $57901, %rsi
lea addresses_normal_ht+0x925c, %rax
nop
nop
nop
nop
...
nop
xor %rbx, %rbx
lea addresses_normal_ht+0x4adc, %rcx
nop
xor $61997, %r9
mov (%rcx), %esi
nop
...
lea addresses_normal_ht+0x8edc, %rdi
and %rax, %rax
mov $90, %rcx
rep movsb
nop
...
nop
cmp %rax, %rax
lea addresses_UC_ht+0xdedc, %rcx
nop
nop
nop
and %r10, %r10
...
nop
cmp $31956, %r10
lea addresses_normal_ht+0x19cdc, %rax
nop
nop
nop
nop
...
<gen_prepare_buffer>
{'OP': 'REPM', 'src': {'same': False, 'type': 'addresses_WT_ht', 'congruent': 7}, 'dst': {'same': False, 'type': 'addresses_A_ht', 'congruent': 1}}
{'OP': 'LOAD', 'src': {'size': 32, 'NT': False, 'type': 'addresses_D_ht', 'same': False, 'AVXalign': False, 'congruent': 10}}
{'OP': 'STOR', 'dst': {'size': 32, 'NT': True, 'type': 'addresses_A_ht', 'same': False, 'AVXalign': False, 'congruent': 11}}
{'OP': 'LOAD', 'src': {'size': 4, 'NT': False, 'type': 'addresses_normal_ht', 'same': False, 'AVXalign': False, 'congruent': 3}}
{'OP': 'LOAD', 'src': {'size': 1, 'NT': False, 'type': 'addresses_normal_ht', 'same': True, 'AVXalign': False, 'congruent': 2}}
