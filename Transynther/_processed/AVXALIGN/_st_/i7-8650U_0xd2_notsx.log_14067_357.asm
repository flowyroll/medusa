...
nop
add %rdx, %rdx
lea addresses_A_ht+0x9404, %rsi
lea addresses_normal_ht+0x1cb44, %rdi
nop
nop
nop
xor %rax, %rax
...
nop
dec %r15
lea addresses_normal_ht+0x7844, %rsi
lea addresses_WT_ht+0x12b50, %rdi
cmp %r9, %r9
mov $107, %rcx
rep movsw
nop
...
nop
add $41865, %r14
lea addresses_WT_ht+0x44, %rsi
lea addresses_A_ht+0x116a4, %rdi
nop
nop
add $35527, %rdx
mov $77, %rcx
...
nop
dec %r9
lea addresses_UC_ht+0x15c64, %rsi
lea addresses_D_ht+0x1ab7a, %rdi
clflush (%rdi)
nop
nop
nop
...
nop
and $29515, %r9
lea addresses_normal_ht+0xed44, %rsi
lea addresses_UC_ht+0xb544, %rdi
nop
nop
nop
xor $95, %r15
...
nop
and $1446, %rdx
lea addresses_WC_ht+0x1d924, %rdi
nop
nop
inc %rdx
movb $0x61, (%rdi)
...
nop
cmp %rcx, %rcx
lea addresses_WC_ht+0x13844, %rsi
lea addresses_normal_ht+0xc315, %rdi
nop
nop
nop
nop
...
// REPMOV
lea addresses_D+0xd6ba, %rsi
lea addresses_normal+0x14544, %rdi
nop
nop
nop
nop
...
// Faulty Load
lea addresses_normal+0x14544, %rsi
nop
nop
add $14154, %r15
mov (%rsi), %r11d
...
{'OP': 'REPM', 'src': {'type': 'addresses_D', 'congruent': 1, 'same': False}, 'dst': {'type': 'addresses_normal', 'congruent': 0, 'same': True}}
[Faulty Load]
