...
movb $0x61, (%r9)
add %r11, %r11
lea addresses_WC_ht+0x1251b, %r13
nop
nop
add %r9, %r9
movb $0x61, (%r13)
...
nop
sub $3839, %rdi
lea addresses_normal_ht+0x8dbb, %rdi
nop
nop
nop
add $30949, %rax
...
nop
add $47611, %rdi
lea addresses_D_ht+0xdcf9, %r11
sub $59116, %rax
vmovups (%r11), %ymm4
vextracti128 $1, %ymm4, %xmm4
vpextrq $0, %xmm4, %r13
dec %r14
lea addresses_A_ht+0x181b, %rsi
lea addresses_UC_ht+0x1906b, %rdi
nop
nop
nop
and %r14, %r14
...
lea addresses_WC_ht+0x1d7cb, %rdi
nop
nop
nop
nop
...
nop
xor $27436, %r14
lea addresses_WC_ht+0xd5bb, %rsi
nop
xor %r9, %r9
...
{'OP': 'STOR', 'dst': {'type': 'addresses_normal_ht', 'AVXalign': False, 'size': 1, 'NT': False, 'same': True, 'congruent': 10}}
