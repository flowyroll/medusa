...
nop
sub %rdi, %rdi
lea addresses_WT_ht+0xb62d, %r14
and %r8, %r8
movb $0x61, (%r14)
nop
add %rdi, %rdi
lea addresses_WC_ht+0x590d, %rsi
lea addresses_WC_ht+0x1b20d, %rdi
nop
nop
nop
nop
...
rep movsb
inc %r8
lea addresses_D_ht+0x30d, %rsi
lea addresses_UC_ht+0xfa39, %rdi
nop
nop
nop
sub %r14, %r14
...
rep movsb
cmp %r14, %r14
lea addresses_D_ht+0x1770d, %r10
nop
nop
nop
nop
...
nop
and $48545, %r8
lea addresses_WC_ht+0x6d4d, %r11
nop
xor $51438, %r10
...
nop
cmp %rdi, %rdi
lea addresses_WC_ht+0x1d70d, %rbx
clflush (%rbx)
nop
cmp $12052, %rdi
movups (%rbx), %xmm7
...
nop
cmp $15141, %r8
lea addresses_WC_ht+0x750d, %r10
clflush (%r10)
xor %rbx, %rbx
movups (%r10), %xmm2
vpextrq $0, %xmm2, %rcx
...
nop
dec %r14
lea addresses_UC_ht+0x1455d, %rdi
clflush (%rdi)
nop
dec %r10
mov (%rdi), %ecx
and $62176, %rdi
lea addresses_WC_ht+0x4cad, %rsi
nop
nop
nop
sub %rcx, %rcx
...
// Load
lea addresses_normal+0xab0d, %rdx
cmp $6977, %rcx
mov (%rdx), %rbp
cmp %rbx, %rbx

// Faulty Load
lea addresses_D+0x7f0d, %rcx
nop
nop
nop
nop
...
{'OP': 'LOAD', 'src': {'type': 'addresses_D_ht', 'size': 2, 'AVXalign': False, 'NT': True, 'congruent': 10, 'same': True}}
