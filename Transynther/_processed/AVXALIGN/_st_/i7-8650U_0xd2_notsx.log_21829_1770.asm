...
push %rdx
push %rsi
lea addresses_WT_ht+0x11a62, %r11
nop
sub $31022, %r9
...
nop
xor $5929, %rdx
lea addresses_WT_ht+0xa662, %r12
xor %rdi, %rdi
...
nop
xor $14451, %r10
lea addresses_normal_ht+0x13526, %rdx
nop
and %r9, %r9
movl $0x61626364, (%rdx)
and $52594, %r9
lea addresses_normal_ht+0x190dd, %r8
clflush (%r8)
nop
nop
nop
...
nop
xor $43844, %r9
lea addresses_normal_ht+0x1cfe2, %r10
nop
add $57449, %rdx
movups (%r10), %xmm6
vpextrq $0, %xmm6, %r11
...
nop
cmp $27557, %r9
lea addresses_normal_ht+0x9382, %rsi
lea addresses_WT_ht+0x1dc6e, %rdi
nop
nop
inc %r9
mov $72, %rcx
...
nop
sub $39354, %rdi
lea addresses_normal_ht+0x7a22, %rsi
nop
sub %r8, %r8
movb $0x61, (%rsi)
nop
...
nop
sub %r9, %r9
lea addresses_UC_ht+0xdcf2, %rdi
add %r8, %r8
...
nop
and %r10, %r10
lea addresses_WT_ht+0x128c1, %rsi
lea addresses_D_ht+0x16c92, %rdi
nop
dec %r9
mov $113, %rcx
rep movsl
sub %rdi, %rdi
lea addresses_normal_ht+0x2262, %rcx
nop
nop
nop
cmp %r12, %r12
...
{'OP': 'LOAD', 'src': {'type': 'addresses_A_ht', 'size': 8, 'AVXalign': False, 'NT': False, 'congruent': 11, 'same': True}}
{'OP': 'STOR', 'dst': {'type': 'addresses_WT_ht', 'size': 8, 'AVXalign': False, 'NT': False, 'congruent': 11, 'same': False}}
{'OP': 'STOR', 'dst': {'type': 'addresses_normal_ht', 'size': 4, 'AVXalign': False, 'NT': False, 'congruent': 2, 'same': True}}
...
{'OP': 'REPM', 'src': {'type': 'addresses_normal_ht', 'congruent': 5, 'same': True}, 'dst': {'type': 'addresses_WT_ht', 'congruent': 2, 'same': False}}
...
{'OP': 'REPM', 'src': {'type': 'addresses_WT_ht', 'congruent': 0, 'same': False}, 'dst': {'type': 'addresses_D_ht', 'congruent': 4, 'same': False}}
