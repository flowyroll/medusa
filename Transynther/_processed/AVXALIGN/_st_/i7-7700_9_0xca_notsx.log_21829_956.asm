...
push %rcx
push %rsi
lea addresses_WC_ht+0x11df, %r15
nop
nop
add %rcx, %rcx
mov (%r15), %esi
...
nop
sub %r9, %r9
lea addresses_D_ht+0x144b7, %r13
nop
nop
nop
xor %r14, %r14
...
nop
xor $2653, %rcx
lea addresses_WC_ht+0x1b2b7, %r13
nop
nop
nop
nop
...
nop
cmp %rsi, %rsi
lea addresses_normal_ht+0x102b7, %r9
and $33335, %rbp
mov $0x6162636465666768, %r15
movq %r15, (%r9)
nop
inc %r13
lea addresses_UC_ht+0x1418f, %rbp
nop
nop
nop
nop
...
nop
and %r15, %r15
lea addresses_WT_ht+0x187f7, %r15
nop
nop
nop
nop
...
nop
add $64600, %r15
lea addresses_normal_ht+0x849f, %rsi
xor %r13, %r13
movups (%rsi), %xmm2
vpextrq $0, %xmm2, %r15
nop
