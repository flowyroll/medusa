...
nop
dec %rbp
lea addresses_WC_ht+0xd258, %rsi
lea addresses_UC_ht+0x55c4, %rdi
nop
nop
nop
inc %r15
...
nop
and $5637, %rbp
lea addresses_UC_ht+0xaad8, %rsi
lea addresses_WT_ht+0x19f58, %rdi
nop
nop
nop
add %r15, %r15
...
nop
inc %r13
lea addresses_UC_ht+0x18e58, %rsi
lea addresses_UC_ht+0x2658, %rdi
clflush (%rdi)
xor $60426, %rbp
mov $39, %rcx
rep movsl
...
nop
and %rsi, %rsi
lea addresses_WC_ht+0x1cdb8, %rsi
lea addresses_UC_ht+0x14e58, %rdi
add %rbp, %rbp
mov $37, %rcx
rep movsw
nop
...
nop
dec %r13
lea addresses_WC_ht+0x12658, %r13
sub %rdi, %rdi
mov (%r13), %r15d
nop
cmp %rsi, %rsi
lea addresses_UC_ht+0x1210e, %rbp
nop
nop
lfence
...
{'src': {'type': 'addresses_UC_ht', 'congruent': 7, 'same': False}, 'OP': 'REPM', 'dst': {'type': 'addresses_WT_ht', 'congruent': 7, 'same': True}}
{'src': {'type': 'addresses_UC_ht', 'congruent': 10, 'same': True}, 'OP': 'REPM', 'dst': {'type': 'addresses_UC_ht', 'congruent': 11, 'same': True}}
...
{'OP': 'STOR', 'dst': {'type': 'addresses_UC_ht', 'AVXalign': False, 'size': 16, 'NT': False, 'same': True, 'congruent': 1}}
{'37': 21829}
