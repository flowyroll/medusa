...
nop
and $29703, %r10
lea addresses_WT_ht+0x268b, %rdx
clflush (%rdx)
nop
xor $52814, %r10
movw $0x6162, (%rdx)
...
nop
sub %rsi, %rsi
lea addresses_WT_ht+0x2249, %rdx
clflush (%rdx)
nop
nop
nop
...
nop
inc %r10
lea addresses_normal_ht+0x1c473, %rsi
lea addresses_D_ht+0xe887, %rdi
nop
nop
nop
nop
...
nop
sub $14578, %rbx
lea addresses_WT_ht+0xcfaf, %rbx
nop
nop
xor %r11, %r11
mov (%rbx), %r8w
...
nop
sub %rcx, %rcx
lea addresses_WT_ht+0x138c7, %r11
nop
nop
and $7428, %rsi
