...
push %rdi
push %rsi
lea addresses_WT_ht+0x4567, %rcx
and %r9, %r9
mov (%rcx), %rbp
nop
nop
nop
xor %r10, %r10
lea addresses_WC_ht+0x19c51, %r14
nop
dec %rbx
mov (%r14), %rbp
nop
...
nop
add %rbx, %rbx
lea addresses_UC_ht+0x8451, %rsi
lea addresses_normal_ht+0xe351, %rdi
nop
nop
nop
dec %r9
...
nop
and %r9, %r9
lea addresses_WC_ht+0x5769, %rbp
nop
xor $60128, %rsi
...
nop
sub $13825, %rbp
lea addresses_WT_ht+0x7c51, %rsi
lea addresses_WC_ht+0x951, %rdi
nop
nop
nop
sub %r14, %r14
...
rep movsb
cmp $34287, %rbp
lea addresses_WC_ht+0x1226, %rsi
...
nop
dec %r9
lea addresses_A_ht+0xfec3, %rsi
lea addresses_A_ht+0x1a051, %rdi
nop
nop
sub %r14, %r14
mov $30, %rcx
rep movsb
add %rbx, %rbx
lea addresses_D_ht+0x16405, %rsi
lea addresses_WT_ht+0xdee1, %rdi
nop
nop
nop
nop
...
{'src': {'type': 'addresses_WC_ht', 'congruent': 0, 'same': False}, 'dst': {'type': 'addresses_WT_ht', 'congruent': 11, 'same': False}, 'OP': 'REPM'}
{'src': {'type': 'addresses_A_ht', 'congruent': 1, 'same': False}, 'dst': {'type': 'addresses_A_ht', 'congruent': 11, 'same': False}, 'OP': 'REPM'}
