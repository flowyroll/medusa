...
push %rdi
push %rsi
lea addresses_WC_ht+0xe9ea, %rsi
lea addresses_A_ht+0x12cea, %rdi
nop
inc %r10
mov $103, %rcx
rep movsb
...
nop
and %rax, %rax
lea addresses_UC_ht+0x84ea, %rsi
lea addresses_WC_ht+0x178ea, %rdi
lfence
mov $66, %rcx
rep movsw
nop
...
nop
add $44784, %rsi
lea addresses_D_ht+0x16832, %rax
nop
nop
nop
nop
...
nop
inc %r10
lea addresses_WT_ht+0x1e3e6, %rax
nop
inc %r11
...
nop
add %rdi, %rdi
lea addresses_WC_ht+0x16b6a, %r11
cmp $47268, %rax
movw $0x6162, (%r11)
nop
nop
...
<gen_prepare_buffer>
{'OP': 'REPM', 'src': {'type': 'addresses_WC_ht', 'congruent': 10, 'same': False}, 'dst': {'type': 'addresses_A_ht', 'congruent': 4, 'same': False}}
...
{'OP': 'LOAD', 'src': {'type': 'addresses_A_ht', 'size': 2, 'AVXalign': False, 'NT': False, 'congruent': 0, 'same': True}}
