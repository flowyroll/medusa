...
nop
inc %rcx
lea addresses_WC_ht+0xcd19, %rsi
lea addresses_D_ht+0x104f9, %rdi
xor %rbp, %rbp
mov $127, %rcx
rep movsb
nop
...
nop
dec %rbx
lea addresses_UC_ht+0x11932, %rbp
clflush (%rbp)
nop
nop
nop
...
nop
add %rcx, %rcx
lea addresses_D_ht+0x15ca9, %rbx
nop
nop
nop
nop
...
nop
cmp $52159, %rbp
lea addresses_WT_ht+0xee15, %r14
xor $63729, %rdi
mov $0x6162636465666768, %rcx
movq %rcx, %xmm4
vmovups %ymm4, (%r14)
inc %r15
lea addresses_A_ht+0x15ff9, %rbx
nop
nop
nop
nop
...
nop
and $14554, %rcx
lea addresses_D_ht+0x24f9, %rsi
lea addresses_A_ht+0x8d65, %rdi
nop
nop
nop
nop
...
nop
and $44675, %rbx
lea addresses_UC_ht+0x6cfc, %rsi
lea addresses_A_ht+0x3cf9, %rdi
nop
nop
nop
nop
...
rep movsw
and $2471, %rdi
lea addresses_WC_ht+0x18af9, %rbx
nop
nop
dec %r14
mov (%rbx), %bp
and $892, %rdi
lea addresses_D_ht+0xd4f9, %rsi
lea addresses_UC_ht+0x186f9, %rdi
nop
nop
nop
and $21972, %r14
...
// Faulty Load
lea addresses_normal+0x94f9, %r15
nop
cmp %rbx, %rbx
mov (%r15), %esi
lea oracles, %rbp
...
{'OP': 'REPM', 'src': {'type': 'addresses_WC_ht', 'congruent': 5, 'same': False}, 'dst': {'type': 'addresses_D_ht', 'congruent': 11, 'same': True}}
...
{'OP': 'STOR', 'dst': {'type': 'addresses_D_ht', 'size': 1, 'AVXalign': True, 'NT': False, 'congruent': 4, 'same': False}}
...
{'OP': 'REPM', 'src': {'type': 'addresses_D_ht', 'congruent': 10, 'same': False}, 'dst': {'type': 'addresses_UC_ht', 'congruent': 8, 'same': False}}
{'34': 1429}
