...
push %rdi
push %rsi
lea addresses_D_ht+0x5ffe, %rsi
lea addresses_normal_ht+0xfffe, %rdi
nop
nop
nop
nop
...
rep movsw
xor $20842, %r11
lea addresses_UC_ht+0x127be, %rsi
lea addresses_UC_ht+0xbdfe, %rdi
nop
nop
nop
nop
...
nop
and $49600, %r8
lea addresses_WT_ht+0x4dfe, %rsi
lea addresses_UC_ht+0x677e, %rdi
clflush (%rsi)
sub $19585, %r8
mov $123, %rcx
rep movsb
xor $34513, %rsi
lea addresses_WC_ht+0x192fe, %rdi
nop
nop
nop
nop
