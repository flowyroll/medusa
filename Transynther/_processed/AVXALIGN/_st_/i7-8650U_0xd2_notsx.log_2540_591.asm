...
nop
sub $8926, %rdx
lea addresses_WC_ht+0x13746, %rsi
nop
nop
nop
nop
...
nop
cmp %rdx, %rdx
lea addresses_A_ht+0x1d0e6, %rsi
lea addresses_A_ht+0x2406, %rdi
nop
add $23777, %r14
mov $82, %rcx
rep movsw
cmp %rsi, %rsi
lea addresses_D_ht+0xbb46, %r9
clflush (%r9)
nop
nop
nop
...
nop
xor $18052, %rsi
lea addresses_WC_ht+0xbe46, %rsi
cmp %r14, %r14
movl $0x61626364, (%rsi)
nop
nop
...
nop
sub %r14, %r14
lea addresses_UC_ht+0x2ad4, %rcx
nop
nop
nop
and $58047, %rsi
...
nop
sub $42931, %rcx
lea addresses_D_ht+0x1e486, %rsi
lea addresses_WT_ht+0x1a246, %rdi
cmp %rbx, %rbx
mov $88, %rcx
rep movsq
nop
...
lea addresses_WT_ht+0x5646, %rdi
nop
nop
nop
cmp $1524, %rbx
...
{'OP': 'REPM', 'src': {'type': 'addresses_A_ht', 'congruent': 5, 'same': False}, 'dst': {'type': 'addresses_A_ht', 'congruent': 6, 'same': True}}
...
{'OP': 'REPM', 'src': {'type': 'addresses_D_ht', 'congruent': 6, 'same': False}, 'dst': {'type': 'addresses_WT_ht', 'congruent': 3, 'same': False}}
