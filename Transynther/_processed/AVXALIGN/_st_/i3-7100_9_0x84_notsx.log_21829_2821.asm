...
// REPMOV
lea addresses_D+0x19b8, %rsi
lea addresses_UC+0x13d98, %rdi
nop
nop
and $35925, %rbx
mov $34, %rcx
...
{'src': {'type': 'addresses_D', 'congruent': 3, 'same': True}, 'dst': {'type': 'addresses_UC', 'congruent': 3, 'same': False}, 'OP': 'REPM'}
...
[Faulty Load]
{'src': {'type': 'addresses_UC', 'same': True, 'size': 4, 'congruent': 0, 'NT': False, 'AVXalign': True}, 'OP': 'LOAD'}
<gen_prepare_buffer>
