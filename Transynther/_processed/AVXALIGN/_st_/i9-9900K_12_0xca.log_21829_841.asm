...
nop
xor $14223, %r13
lea addresses_WC_ht+0xc199, %rdi
nop
add $39625, %r11
movb $0x61, (%rdi)
nop
...
nop
and $3114, %rbp
lea addresses_UC_ht+0x1db75, %rsi
lea addresses_UC_ht+0xc509, %rdi
nop
nop
cmp $50376, %rbp
mov $24, %rcx
...
nop
cmp $23794, %rdi
lea addresses_D_ht+0x14199, %rdi
nop
nop
nop
xor %r13, %r13
...
nop
add %rbp, %rbp
lea addresses_WC_ht+0x17e09, %rsi
lea addresses_WC_ht+0x1c46b, %rdi
nop
nop
nop
lfence
...
nop
dec %rdi
lea addresses_D_ht+0x19809, %rbp
xor $2280, %r13
...
nop
add $49851, %r11
lea addresses_UC_ht+0x5332, %rsi
lea addresses_A_ht+0x12809, %rdi
nop
nop
nop
nop
...
{'OP': 'LOAD', 'src': {'size': 4, 'NT': False, 'type': 'addresses_P', 'same': False, 'AVXalign': False, 'congruent': 9}}
{'OP': 'STOR', 'dst': {'size': 32, 'NT': False, 'type': 'addresses_D', 'same': False, 'AVXalign': True, 'congruent': 7}}
[Faulty Load]
...
{'OP': 'REPM', 'src': {'same': False, 'type': 'addresses_UC_ht', 'congruent': 1}, 'dst': {'same': False, 'type': 'addresses_UC_ht', 'congruent': 8}}
{'OP': 'STOR', 'dst': {'size': 8, 'NT': False, 'type': 'addresses_D_ht', 'same': False, 'AVXalign': False, 'congruent': 4}}
{'OP': 'REPM', 'src': {'same': False, 'type': 'addresses_WC_ht', 'congruent': 1}, 'dst': {'same': True, 'type': 'addresses_WC_ht', 'congruent': 1}}
