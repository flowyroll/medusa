...
push %rdx
push %rsi
lea addresses_WC_ht+0x14fcf, %rsi
lea addresses_WT_ht+0x1e9cf, %rdi
nop
nop
nop
nop
...
nop
add $42624, %rdx
lea addresses_WT_ht+0x1db8f, %rsi
lea addresses_UC_ht+0x3dcf, %rdi
sub %r8, %r8
mov $44, %rcx
rep movsw
nop
...
lea addresses_D_ht+0x1bf81, %rdi
nop
sub $58803, %r8
mov $105, %rcx
rep movsl
...
nop
xor $32502, %rdx
lea addresses_WC_ht+0x1da71, %rsi
lea addresses_D_ht+0x17e7f, %rdi
nop
nop
add %r14, %r14
mov $61, %rcx
...
movups %xmm2, (%r8)
xor %rsi, %rsi
lea addresses_normal_ht+0x734f, %rsi
lea addresses_D_ht+0x47cf, %rdi
inc %r15
mov $41, %rcx
rep movsl
nop
