...
movups %xmm1, (%r15)
dec %r10
lea addresses_normal_ht+0x19d59, %rsi
lea addresses_UC_ht+0xecd9, %rdi
clflush (%rdi)
cmp %r9, %r9
mov $127, %rcx
rep movsw
...
nop
xor %r10, %r10
lea addresses_WT_ht+0x150e9, %r9
nop
nop
and $26792, %r8
movw $0x6162, (%r9)
...
nop
add %rcx, %rcx
lea addresses_WT_ht+0x170d9, %r10
nop
nop
nop
nop
...
nop
add %rsi, %rsi
lea addresses_normal_ht+0x13819, %rdi
and $32996, %rcx
mov $0x6162636465666768, %r10
movq %r10, (%rdi)
nop
sub %rsi, %rsi
lea addresses_WC_ht+0x1ef69, %r8
nop
nop
nop
nop
...
nop
sub %r9, %r9
lea addresses_UC_ht+0x1d0d9, %r10
nop
nop
nop
cmp $4890, %rdi
...
nop
xor %r10, %r10
lea addresses_WC_ht+0xf003, %rsi
lea addresses_A_ht+0x1a0d9, %rdi
nop
nop
nop
nop
...
nop
sub $55186, %r15
lea addresses_UC_ht+0x15599, %rsi
lea addresses_A_ht+0x1c7d9, %rdi
nop
nop
nop
nop
...
{'OP': 'REPM', 'src': {'type': 'addresses_WC_ht', 'congruent': 1, 'same': True}, 'dst': {'type': 'addresses_A_ht', 'congruent': 10, 'same': False}}
