...
nop
add %rcx, %rcx
lea addresses_WC_ht+0x4ef3, %rdx
dec %r15
mov (%rdx), %r12d
nop
nop
...
nop
and %r8, %r8
lea addresses_normal_ht+0x36f3, %rsi
lea addresses_A_ht+0x19033, %rdi
nop
nop
nop
and %r9, %r9
...
nop
add %r12, %r12
lea addresses_normal_ht+0x9064, %rsi
nop
nop
nop
dec %rdi
movw $0x6162, (%rsi)
cmp %rdi, %rdi
lea addresses_D_ht+0x106f3, %r12
nop
sub %rdx, %rdx
mov (%r12), %cx
nop
...
vpextrq $0, %xmm2, %r15
and %r8, %r8
lea addresses_WT_ht+0x1df3, %rcx
nop
nop
and $59520, %r8
vmovups (%rcx), %ymm2
...
movb $0x61, (%r9)
dec %rcx
lea addresses_WC_ht+0xb4f3, %rdi
nop
nop
and $62106, %rcx
movb (%rdi), %r12b
...
{'OP': 'LOAD', 'src': {'type': 'addresses_D_ht', 'AVXalign': False, 'congruent': 11, 'size': 2, 'same': False, 'NT': True}}
...
{'OP': 'LOAD', 'src': {'type': 'addresses_WC_ht', 'AVXalign': True, 'congruent': 9, 'size': 1, 'same': False, 'NT': True}}
{'36': 21829}
