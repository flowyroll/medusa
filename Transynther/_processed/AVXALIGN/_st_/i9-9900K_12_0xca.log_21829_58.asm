...
nop
and %rdi, %rdi
lea addresses_WT_ht+0xf921, %rsi
nop
nop
nop
nop
...
mov (%rsi), %r14
add $1495, %rsi
lea addresses_WT_ht+0xd933, %rdi
nop
cmp %r9, %r9
movb (%rdi), %r10b
nop
...
nop
dec %rax
lea addresses_normal_ht+0x1da93, %r14
nop
nop
xor %rax, %rax
movw $0x6162, (%r14)
...
nop
add $660, %rbx
lea addresses_WT_ht+0x147f9, %rsi
lea addresses_A_ht+0x1b9a5, %rdi
nop
nop
nop
cmp %r9, %r9
