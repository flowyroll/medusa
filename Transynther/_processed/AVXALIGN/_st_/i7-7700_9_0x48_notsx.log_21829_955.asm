...
push %rdx
push %rsi
lea addresses_D_ht+0x1c72a, %r11
nop
nop
xor $21051, %rdx
mov (%r11), %r9d
...
nop
and %rsi, %rsi
lea addresses_UC_ht+0x747e, %r11
add %rdx, %rdx
...
lea addresses_WC_ht+0x14238, %rdi
nop
nop
and $13301, %rax
mov $52, %rcx
...
nop
and %r9, %r9
lea addresses_normal_ht+0x6d7e, %r9
nop
dec %rdi
mov (%r9), %r11
nop
nop
cmp %r8, %r8
lea addresses_WT_ht+0x100be, %r13
nop
nop
nop
nop
...
lea addresses_UC_ht+0x5a46, %rdi
nop
nop
nop
nop
...
nop
xor %r9, %r9
lea addresses_WT_ht+0x68a6, %r9
sub $47953, %rsi
mov (%r9), %r13
nop
sub %r11, %r11
lea addresses_UC_ht+0x1e7fe, %r8
nop
nop
xor $65316, %rdx
mov (%r8), %r11w
...
nop
cmp %r13, %r13
lea addresses_WT_ht+0x4a7e, %rdx
nop
nop
sub $16723, %rcx
movl $0x61626364, (%rdx)
...
movl $0x61626364, (%rdi)
add %rsi, %rsi
lea addresses_WT_ht+0x47ce, %r11
nop
sub %rdx, %rdx
movb $0x61, (%r11)
nop
...
// Faulty Load
lea addresses_normal+0x1ee7e, %r14
sub %rbp, %rbp
mov (%r14), %r10d
lea oracles, %rbx
and $0xff, %r10
...
{'dst': {'same': False, 'congruent': 1, 'type': 'addresses_WC_ht'}, 'OP': 'REPM', 'src': {'same': False, 'congruent': 2, 'type': 'addresses_UC_ht'}}
...
{'dst': {'same': False, 'congruent': 3, 'type': 'addresses_UC_ht'}, 'OP': 'REPM', 'src': {'same': False, 'congruent': 3, 'type': 'addresses_normal_ht'}}
...
{'dst': {'same': False, 'NT': False, 'AVXalign': True, 'size': 4, 'type': 'addresses_D_ht', 'congruent': 1}, 'OP': 'STOR'}
