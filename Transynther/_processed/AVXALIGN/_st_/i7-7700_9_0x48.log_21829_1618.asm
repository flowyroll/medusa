...
push %rdx
push %rsi
lea addresses_WC_ht+0x8d4, %rsi
lea addresses_WC_ht+0x54d4, %rdi
add $36326, %r12
mov $84, %rcx
rep movsw
nop
...
nop
cmp %rdx, %rdx
lea addresses_UC_ht+0x45d4, %rsi
lea addresses_UC_ht+0x153d4, %rdi
clflush (%rsi)
nop
nop
cmp $20089, %r15
...
nop
dec %r12
lea addresses_normal_ht+0x10514, %rsi
lea addresses_WC_ht+0xbcd4, %rdi
nop
nop
sub %rbp, %rbp
mov $18, %rcx
rep movsb
xor %rdi, %rdi
lea addresses_A_ht+0x6814, %rdx
dec %rdi
movw $0x6162, (%rdx)
nop
nop
sub %rcx, %rcx
lea addresses_WC_ht+0x148d4, %r15
nop
nop
nop
cmp $16728, %r12
...
nop
cmp $45434, %rbp
lea addresses_WT_ht+0x1e0d4, %r15
dec %r12
movb $0x61, (%r15)
cmp %r15, %r15
pop %rsi
...
{'OP': 'REPM', 'src': {'type': 'addresses_UC_ht', 'congruent': 4, 'same': True}, 'dst': {'type': 'addresses_UC_ht', 'congruent': 8, 'same': False}}
...
{'OP': 'STOR', 'dst': {'type': 'addresses_WT_ht', 'AVXalign': False, 'congruent': 10, 'size': 1, 'same': False, 'NT': True}}
{'32': 21829}
