...
push %rdx
push %rsi
lea addresses_UC_ht+0x5e45, %rdi
nop
nop
nop
xor %rdx, %rdx
...
nop
cmp $53345, %rcx
lea addresses_WT_ht+0x19bed, %rsi
lea addresses_D_ht+0xf4dd, %rdi
nop
xor $16805, %rax
mov $70, %rcx
rep movsb
...
nop
cmp %rdi, %rdi
lea addresses_WT_ht+0x1331d, %rdi
sub $47103, %r15
mov (%rdi), %rax
nop
nop
...
nop
cmp $39626, %rcx
lea addresses_normal_ht+0x17435, %rsi
lea addresses_UC_ht+0x8f1d, %rdi
nop
nop
nop
nop
...
movb $0x61, (%rdi)
sub %rsi, %rsi
lea addresses_D_ht+0x473, %rsi
lea addresses_A_ht+0x681d, %rdi
nop
cmp $42984, %r13
mov $105, %rcx
rep movsl
...
nop
xor %rax, %rax
lea addresses_A_ht+0x1229d, %rsi
lea addresses_WT_ht+0x29b5, %rdi
xor $39509, %r15
mov $47, %rcx
rep movsq
nop
sub $60135, %r11
lea addresses_D_ht+0x1251d, %r11
nop
sub %rdi, %rdi
vmovups (%r11), %ymm0
...
nop
and $7080, %rdx
lea addresses_WC_ht+0x10855, %rsi
lea addresses_A_ht+0xd3eb, %rdi
nop
nop
add $33643, %rdx
mov $60, %rcx
...
nop
xor $39373, %rsi
lea addresses_UC_ht+0x1688d, %rsi
lea addresses_WT_ht+0x1221d, %rdi
nop
nop
nop
xor $19583, %rax
...
rep movsw
cmp $16712, %r11
lea addresses_normal_ht+0x1401d, %rsi
nop
add $61773, %rdx
mov (%rsi), %r15w
sub $36628, %r13
lea addresses_WT_ht+0x8c1d, %rsi
lea addresses_UC_ht+0xd31d, %rdi
nop
add $39851, %r13
mov $22, %rcx
rep movsl
...
nop
add %rsi, %rsi
lea addresses_D_ht+0x567d, %rsi
lea addresses_WT_ht+0x11e35, %rdi
nop
nop
sub %r13, %r13
mov $89, %rcx
...
{'OP': 'REPM', 'src': {'type': 'addresses_WT_ht', 'congruent': 3, 'same': True}, 'dst': {'type': 'addresses_D_ht', 'congruent': 4, 'same': False}}
...
{'OP': 'REPM', 'src': {'type': 'addresses_D_ht', 'congruent': 1, 'same': False}, 'dst': {'type': 'addresses_A_ht', 'congruent': 9, 'same': False}}
...
{'OP': 'REPM', 'src': {'type': 'addresses_WT_ht', 'congruent': 8, 'same': False}, 'dst': {'type': 'addresses_UC_ht', 'congruent': 8, 'same': True}}
