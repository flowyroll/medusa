...
push %rdx
push %rsi
lea addresses_normal_ht+0x824c, %rdi
clflush (%rdi)
nop
nop
nop
...
nop
cmp %rsi, %rsi
lea addresses_UC_ht+0x574c, %rsi
lea addresses_WT_ht+0xaa4c, %rdi
nop
nop
and $42922, %r8
mov $56, %rcx
rep movsw
and %r12, %r12
lea addresses_WT_ht+0x1824c, %rsi
lea addresses_UC_ht+0x1d64c, %rdi
nop
nop
sub %r15, %r15
mov $10, %rcx
...
nop
xor $35110, %rcx
lea addresses_D_ht+0x1d24c, %r15
nop
xor $49576, %r8
movb $0x61, (%r15)
xor $3856, %r15
lea addresses_A_ht+0x1c0cc, %rcx
nop
nop
nop
nop
...
nop
inc %rsi
lea addresses_normal_ht+0x1324c, %r8
nop
nop
nop
nop
...
nop
dec %r8
lea addresses_UC_ht+0x5a4c, %rdx
nop
nop
nop
and $50032, %r8
movl $0x61626364, (%rdx)
and $33668, %r15
lea addresses_WC_ht+0x8c4c, %r15
nop
nop
inc %rdx
movl $0x61626364, (%r15)
and %rdx, %rdx
lea addresses_A_ht+0x824c, %rcx
clflush (%rcx)
nop
nop
xor $44644, %r12
...
nop
xor %rdi, %rdi
lea addresses_WC_ht+0x183cc, %r12
nop
nop
nop
nop
...
// Faulty Load
lea addresses_normal+0x1824c, %r12
clflush (%r12)
nop
nop
nop
...
{'src': {'congruent': 7, 'same': False, 'type': 'addresses_UC_ht'}, 'OP': 'REPM', 'dst': {'congruent': 11, 'same': False, 'type': 'addresses_WT_ht'}}
{'src': {'congruent': 11, 'same': False, 'type': 'addresses_WT_ht'}, 'OP': 'REPM', 'dst': {'congruent': 10, 'same': False, 'type': 'addresses_UC_ht'}}
...
{'src': {'congruent': 11, 'AVXalign': True, 'same': False, 'size': 2, 'NT': False, 'type': 'addresses_A_ht'}, 'OP': 'LOAD'}
