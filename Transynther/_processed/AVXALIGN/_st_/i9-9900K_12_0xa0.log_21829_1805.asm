...
push %rdx
push %rsi
lea addresses_D_ht+0x1072c, %rcx
nop
nop
nop
nop
...
movups %xmm7, (%rbp)
add $22789, %rbx
lea addresses_UC_ht+0x1784c, %rsi
lea addresses_WC_ht+0x16f2c, %rdi
nop
nop
nop
xor %rax, %rax
...
nop
xor %rcx, %rcx
lea addresses_normal_ht+0xba1c, %rax
nop
add %r11, %r11
...
nop
and $10823, %rdx
lea addresses_WT_ht+0x1b72c, %rdi
clflush (%rdi)
nop
nop
dec %rcx
movw $0x6162, (%rdi)
sub $27035, %rdx
lea addresses_UC_ht+0x1cf54, %rdi
sub %rax, %rax
movl $0x61626364, (%rdi)
nop
and %r11, %r11
lea addresses_UC_ht+0x500c, %rbx
nop
add %rsi, %rsi
mov (%rbx), %edx
nop
...
nop
xor %rsi, %rsi
lea addresses_WC_ht+0x1432c, %rsi
lea addresses_normal_ht+0x19ec, %rdi
nop
nop
nop
add $51654, %rbp
...
mov (%rsi), %ebp
and %rdx, %rdx
lea addresses_normal_ht+0x1ba2c, %rdi
clflush (%rdi)
nop
nop
nop
...
// Faulty Load
lea addresses_normal+0xf2c, %r11
nop
nop
lfence
mov (%r11), %r9
...
{'src': {'same': False, 'congruent': 10, 'type': 'addresses_WC_ht'}, 'OP': 'REPM', 'dst': {'same': False, 'congruent': 6, 'type': 'addresses_normal_ht'}}
{'src': {'NT': False, 'same': True, 'congruent': 9, 'type': 'addresses_D_ht', 'AVXalign': False, 'size': 4}, 'OP': 'LOAD'}
