...
push %rdx
push %rsi
lea addresses_UC_ht+0x7a78, %r14
nop
nop
nop
nop
...
nop
sub %rdx, %rdx
lea addresses_normal_ht+0x4bc4, %rsi
lea addresses_normal_ht+0x2904, %rdi
clflush (%rdi)
nop
nop
cmp %r13, %r13
...
nop
dec %r14
lea addresses_A_ht+0x15e74, %rsi
lea addresses_WC_ht+0x1c880, %rdi
nop
nop
dec %r11
mov $45, %rcx
...
nop
sub %r13, %r13
lea addresses_WT_ht+0x5444, %r11
nop
nop
nop
cmp $32484, %rcx
...
vpextrq $1, %xmm4, %rsi
and %rdi, %rdi
lea addresses_D_ht+0x105c4, %rsi
lea addresses_UC_ht+0x1bc4, %rdi
nop
nop
nop
nop
...
nop
sub $5901, %r8
lea addresses_WC_ht+0x8064, %rcx
nop
nop
nop
nop
...
nop
add $57137, %rsi
lea addresses_WC_ht+0x1bc5a, %rsi
lea addresses_normal_ht+0x4306, %rdi
nop
nop
nop
sub %r11, %r11
...
{'src': {'type': 'addresses_A_ht', 'congruent': 4, 'same': False}, 'OP': 'REPM', 'dst': {'type': 'addresses_WC_ht', 'congruent': 2, 'same': False}}
