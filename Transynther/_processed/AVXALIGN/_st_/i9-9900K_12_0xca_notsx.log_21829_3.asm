...
nop
add $27185, %r13
lea addresses_UC_ht+0x6338, %rsi
lea addresses_WC_ht+0x4097, %rdi
nop
nop
nop
nop
...
rep movsb
cmp $24122, %rcx
lea addresses_WT_ht+0x3ab8, %rsi
lea addresses_UC_ht+0xb750, %rdi
sub %rdx, %rdx
mov $29, %rcx
rep movsl
nop
...
// REPMOV
lea addresses_PSE+0x16338, %rsi
mov $0x28f2fb00000002f8, %rdi
nop
nop
nop
nop
...
{'OP': 'REPM', 'src': {'same': True, 'congruent': 0, 'type': 'addresses_PSE'}, 'dst': {'same': False, 'congruent': 5, 'type': 'addresses_NC'}}
[Faulty Load]
...
{'OP': 'REPM', 'src': {'same': False, 'congruent': 7, 'type': 'addresses_WT_ht'}, 'dst': {'same': False, 'congruent': 1, 'type': 'addresses_UC_ht'}}
