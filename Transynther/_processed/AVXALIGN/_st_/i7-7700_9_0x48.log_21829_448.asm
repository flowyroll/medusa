...
push %rdi
push %rsi
lea addresses_WC_ht+0x51d7, %rsi
cmp %r11, %r11
vmovups (%rsi), %ymm0
...
nop
and $48016, %r12
lea addresses_UC_ht+0x149d7, %rsi
lea addresses_WC_ht+0x3ed7, %rdi
nop
sub $59842, %r13
mov $1, %rcx
rep movsl
...
nop
inc %r13
lea addresses_WT_ht+0x5c57, %r12
clflush (%r12)
dec %r13
mov (%r12), %cx
nop
xor %r13, %r13
lea addresses_normal_ht+0x1c08f, %r10
nop
nop
nop
nop
...
nop
xor $62326, %rdi
lea addresses_normal_ht+0xe957, %rsi
lea addresses_A_ht+0x11737, %rdi
nop
nop
nop
sub $32216, %r12
...
// Faulty Load
lea addresses_normal+0x41d7, %r13
inc %rbp
mov (%r13), %esi
lea oracles, %r12
and $0xff, %rsi
