...
push %rdi
push %rsi
lea addresses_WC_ht+0x9d66, %rdi
nop
nop
nop
cmp $63701, %r14
...
nop
cmp $29544, %rbx
lea addresses_WC_ht+0x10122, %rbx
nop
nop
nop
nop
...
movq %r9, (%rbx)
xor $22651, %r9
lea addresses_D_ht+0x19e34, %rsi
lea addresses_D_ht+0x2a6, %rdi
nop
nop
nop
xor $12063, %rax
...
nop
inc %rax
lea addresses_WC_ht+0x18166, %rax
nop
sub $46306, %rdi
mov (%rax), %si
nop
nop
inc %rsi
lea addresses_WC_ht+0x175e6, %rbx
nop
nop
nop
nop
...
nop
cmp %rax, %rax
lea addresses_A_ht+0x10606, %rax
nop
sub $23328, %rcx
movw $0x6162, (%rax)
nop
...
nop
dec %r9
lea addresses_UC_ht+0x18ea6, %rsi
nop
nop
nop
nop
...
nop
xor %rcx, %rcx
lea addresses_D_ht+0x1e414, %rsi
lea addresses_normal_ht+0x121e6, %rdi
nop
nop
nop
nop
...
nop
cmp $23928, %rbp
lea addresses_WC_ht+0x9986, %rbp
nop
nop
nop
nop
...
// Faulty Load
lea addresses_normal+0xf166, %rbp
nop
nop
nop
nop
...
{'OP': 'LOAD', 'src': {'type': 'addresses_WC_ht', 'size': 32, 'AVXalign': True, 'NT': False, 'congruent': 5, 'same': True}}
{'34': 15610}
