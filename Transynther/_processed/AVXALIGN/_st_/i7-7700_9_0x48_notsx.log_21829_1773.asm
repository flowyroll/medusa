...
lea addresses_WT_ht+0x18817, %rdi
clflush (%rsi)
nop
nop
nop
...
nop
add %rcx, %rcx
lea addresses_UC_ht+0x9097, %r15
and %r10, %r10
movb $0x61, (%r15)
xor $950, %r15
lea addresses_WT_ht+0xe11b, %rdi
nop
nop
nop
xor %rbp, %rbp
...
vmovups %ymm1, (%rdi)
add $53221, %rcx
lea addresses_A_ht+0x13057, %rsi
nop
nop
xor %r13, %r13
movups (%rsi), %xmm6
...
nop
xor %r15, %r15
lea addresses_normal_ht+0xd717, %rsi
lea addresses_WT_ht+0xddff, %rdi
nop
and $13201, %rbp
mov $70, %rcx
rep movsq
...
{'dst': {'same': False, 'congruent': 2, 'type': 'addresses_WT_ht'}, 'OP': 'REPM', 'src': {'same': False, 'congruent': 6, 'type': 'addresses_normal_ht'}}
{'32': 21829}
