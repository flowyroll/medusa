...
nop
add %r11, %r11
lea addresses_WT_ht+0x151fd, %rsi
lea addresses_UC_ht+0x6b7d, %rdi
nop
and %rdx, %rdx
mov $56, %rcx
rep movsq
...
nop
and $41468, %r8
lea addresses_UC_ht+0x16b25, %r14
nop
nop
nop
sub %rsi, %rsi
...
nop
and $58374, %rsi
lea addresses_WT_ht+0x1d145, %rbx
nop
nop
nop
nop
...
nop
sub $39841, %rdx
lea addresses_A_ht+0x195fd, %rsi
lea addresses_WT_ht+0xed8d, %rdi
nop
sub $38947, %rbx
mov $103, %rcx
rep movsq
...
nop
cmp %rbx, %rbx
lea addresses_WT_ht+0xa7fd, %r11
nop
add $31534, %rdi
movw $0x6162, (%r11)
nop
...
nop
xor %r14, %r14
lea addresses_normal_ht+0x1b9fd, %rsi
lea addresses_WC_ht+0x1051d, %rdi
nop
add %rbx, %rbx
mov $73, %rcx
rep movsl
nop
dec %rsi
lea addresses_A_ht+0x13bfd, %rcx
nop
nop
nop
cmp $3213, %rdx
...
// Load
lea addresses_normal+0xcdfd, %rdx
nop
add $15969, %rsi
mov (%rdx), %r15
nop
...
// Faulty Load
lea addresses_normal+0x1cdfd, %rax
nop
cmp $54888, %r8
movb (%rax), %r15b
lea oracles, %rdx
...
{'src': {'type': 'addresses_normal', 'same': False, 'size': 8, 'congruent': 11, 'NT': False, 'AVXalign': False}, 'OP': 'LOAD'}
...
{'src': {'type': 'addresses_A_ht', 'congruent': 10, 'same': False}, 'dst': {'type': 'addresses_WT_ht', 'congruent': 2, 'same': True}, 'OP': 'REPM'}
...
{'src': {'type': 'addresses_normal_ht', 'congruent': 9, 'same': False}, 'dst': {'type': 'addresses_WC_ht', 'congruent': 5, 'same': True}, 'OP': 'REPM'}
