...
push %rdi
push %rsi
lea addresses_normal_ht+0x835f, %rsi
lea addresses_UC_ht+0x139df, %rdi
nop
nop
and %r8, %r8
mov $58, %rcx
...
nop
add $11668, %r11
lea addresses_normal_ht+0xbfdf, %rsi
lea addresses_WC_ht+0x18bdf, %rdi
nop
nop
nop
nop
...
nop
and $65279, %r8
lea addresses_WC_ht+0x167df, %rcx
nop
nop
xor %r14, %r14
vmovups (%rcx), %ymm6
...
// REPMOV
lea addresses_UC+0x76df, %rsi
lea addresses_normal+0x122df, %rdi
nop
nop
nop
nop
...
// Faulty Load
lea addresses_normal+0x122df, %r10
nop
nop
nop
nop
...
{'src': {'type': 'addresses_UC', 'congruent': 9, 'same': False}, 'OP': 'REPM', 'dst': {'type': 'addresses_normal', 'congruent': 0, 'same': True}}
[Faulty Load]
