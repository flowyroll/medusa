...
push %rdi
push %rsi
lea addresses_A_ht+0x12882, %rdi
nop
nop
dec %r12
movw $0x6162, (%rdi)
...
nop
sub $57546, %rbx
lea addresses_UC_ht+0x10c82, %rsi
lea addresses_UC_ht+0x9902, %rdi
nop
nop
nop
nop
...
nop
and %rsi, %rsi
lea addresses_WT_ht+0x1e82, %rsi
lea addresses_normal_ht+0x1cc02, %rdi
cmp %r10, %r10
mov $28, %rcx
rep movsw
nop
...
nop
sub $27436, %r10
lea addresses_D_ht+0x1eb2a, %rsi
nop
nop
nop
nop
...
nop
add %r9, %r9
lea addresses_normal_ht+0xdd7d, %r13
clflush (%r13)
nop
nop
nop
...
nop
cmp %rdi, %rdi
lea addresses_D_ht+0x1c902, %rsi
nop
add %r12, %r12
movups (%rsi), %xmm3
vpextrq $0, %xmm3, %rcx
...
nop
add %r13, %r13
lea addresses_D_ht+0x75c2, %rbx
sub $33955, %r12
movups (%rbx), %xmm4
vpextrq $0, %xmm4, %rdi
nop
lfence
lea addresses_D_ht+0x14902, %rsi
lea addresses_D_ht+0x5902, %rdi
nop
nop
nop
nop
...
nop
cmp %r10, %r10
lea addresses_UC_ht+0x19102, %rsi
lea addresses_D_ht+0x1e702, %rdi
nop
nop
nop
xor %r10, %r10
...
nop
xor %rcx, %rcx
lea addresses_normal_ht+0x7502, %r13
nop
nop
nop
nop
...
nop
and $21746, %r13
lea addresses_normal_ht+0x14f42, %rsi
...
nop
add $1256, %rbx
lea addresses_WT_ht+0x12902, %r10
nop
sub $55886, %r12
mov (%r10), %bx
nop
...
// Faulty Load
lea addresses_normal+0x1e902, %r8
nop
nop
nop
add $41050, %r12
...
{'OP': 'REPM', 'src': {'type': 'addresses_WT_ht', 'congruent': 3, 'same': False}, 'dst': {'type': 'addresses_normal_ht', 'congruent': 8, 'same': False}}
...
{'OP': 'LOAD', 'src': {'type': 'addresses_D_ht', 'AVXalign': False, 'congruent': 10, 'size': 16, 'same': True, 'NT': False}}
...
{'OP': 'REPM', 'src': {'type': 'addresses_UC_ht', 'congruent': 11, 'same': False}, 'dst': {'type': 'addresses_D_ht', 'congruent': 9, 'same': True}}
