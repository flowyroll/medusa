...
nop
dec %r14
lea addresses_UC_ht+0xf867, %rsi
lea addresses_WC_ht+0xf357, %rdi
add %r11, %r11
mov $61, %rcx
rep movsw
nop
...
{'dst': {'same': False, 'NT': False, 'AVXalign': False, 'size': 32, 'type': 'addresses_P', 'congruent': 2}, 'OP': 'STOR'}
...
<gen_prepare_buffer>
{'OP': 'LOAD', 'src': {'same': True, 'NT': False, 'AVXalign': False, 'size': 2, 'type': 'addresses_D_ht', 'congruent': 9}}
