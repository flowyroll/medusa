...
push %rdi
push %rsi
lea addresses_A_ht+0x47bf, %rsi
lea addresses_A_ht+0x1dbbf, %rdi
clflush (%rdi)
nop
nop
nop
...
rep movsq
sub %rbp, %rbp
lea addresses_WC_ht+0x179bf, %rcx
nop
nop
nop
nop
...
nop
and $40916, %rsi
lea addresses_normal_ht+0xa599, %rsi
lea addresses_A_ht+0x79bf, %rdi
clflush (%rsi)
clflush (%rdi)
nop
nop
...
nop
and $57173, %r10
lea addresses_WC_ht+0xb7bf, %r10
nop
nop
nop
nop
...
nop
add %rbp, %rbp
lea addresses_UC_ht+0x9c3f, %r11
nop
inc %rcx
...
nop
xor $27986, %rdi
lea addresses_WC_ht+0x1d5bf, %r11
nop
nop
nop
nop
...
nop
sub $59154, %rcx
lea addresses_WC_ht+0x4321, %rsi
dec %rcx
movl $0x61626364, (%rsi)
nop
nop
...
// Faulty Load
lea addresses_normal+0x71bf, %rax
add %r10, %r10
mov (%rax), %r14
lea oracles, %rbp
and $0xff, %r14
...
{'src': {'type': 'addresses_WC_ht', 'same': False, 'size': 1, 'congruent': 11, 'NT': False, 'AVXalign': True}, 'OP': 'LOAD'}
{'src': {'type': 'addresses_D_ht', 'same': True, 'size': 8, 'congruent': 1, 'NT': False, 'AVXalign': False}, 'OP': 'LOAD'}
