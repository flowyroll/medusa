...
nop
cmp $61549, %rcx
lea addresses_A_ht+0x18f8a, %r15
and %rbx, %rbx
movw $0x6162, (%r15)
nop
nop
sub %r9, %r9
lea addresses_D_ht+0x1c0db, %rsi
lea addresses_WT_ht+0x695b, %rdi
nop
nop
nop
nop
...
{'dst': {'type': 'addresses_NC', 'same': False, 'size': 1, 'congruent': 7, 'NT': True, 'AVXalign': False}, 'OP': 'STOR'}
[Faulty Load]
...
{'src': {'type': 'addresses_D_ht', 'same': False, 'size': 4, 'congruent': 2, 'NT': True, 'AVXalign': True}, 'OP': 'LOAD'}
{'39': 6478}
