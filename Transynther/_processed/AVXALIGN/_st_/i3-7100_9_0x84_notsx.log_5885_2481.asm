...
nop
cmp $40004, %rcx
lea addresses_WT_ht+0x7d0d, %rsi
lea addresses_A_ht+0x888d, %rdi
nop
nop
nop
nop
...
nop
dec %rdi
lea addresses_WC_ht+0x10c8d, %rsi
lea addresses_D_ht+0x1c4d, %rdi
nop
nop
nop
nop
...
nop
add %r9, %r9
lea addresses_normal_ht+0x1d58d, %rsi
lea addresses_normal_ht+0x1c88d, %rdi
sub $30547, %rax
mov $122, %rcx
rep movsq
nop
inc %r14
lea addresses_WC_ht+0x3e8d, %rax
cmp %rdi, %rdi
...
nop
add $33011, %rsi
lea addresses_WT_ht+0xa88d, %rbp
nop
and %rsi, %rsi
mov (%rbp), %rdi
nop
...
nop
cmp $23963, %rsi
lea addresses_A_ht+0x1a618, %rsi
nop
nop
nop
dec %r10
...
// Faulty Load
lea addresses_normal+0x1e48d, %rsi
nop
nop
nop
nop
...
{'src': {'type': 'addresses_WT_ht', 'congruent': 7, 'same': False}, 'dst': {'type': 'addresses_A_ht', 'congruent': 9, 'same': False}, 'OP': 'REPM'}
