...
push %rdi
push %rsi
lea addresses_UC_ht+0x1d9cd, %r15
nop
nop
nop
add $40980, %rbp
...
nop
sub $52127, %r8
lea addresses_normal_ht+0xf42d, %r12
nop
nop
nop
nop
...
nop
add $33949, %r12
lea addresses_WT_ht+0x1efdd, %r11
nop
nop
add $41967, %rsi
vmovups (%r11), %ymm3
...
nop
add $24384, %r11
lea addresses_WC_ht+0xad9c, %rsi
nop
nop
and %r13, %r13
...
nop
sub %r12, %r12
lea addresses_A_ht+0xec2d, %rsi
lea addresses_A_ht+0x7fa1, %rdi
and %rbp, %rbp
mov $2, %rcx
rep movsl
nop
...
nop
xor %rsi, %rsi
lea addresses_normal_ht+0xbfcd, %rsi
...
nop
cmp %r8, %r8
lea addresses_WT_ht+0xb50d, %rsi
lea addresses_A_ht+0x15dcd, %rdi
nop
nop
nop
xor $4581, %rbp
...
nop
and $27241, %r12
lea addresses_A_ht+0xa8b4, %rdi
dec %r11
vmovups (%rdi), %ymm6
vextracti128 $1, %ymm6, %xmm6
vpextrq $1, %xmm6, %rsi
sub %rcx, %rcx
lea addresses_A_ht+0x10431, %r13
nop
sub $7002, %rdi
movups (%r13), %xmm1
vpextrq $0, %xmm1, %rsi
...
{'OP': 'STOR', 'dst': {'size': 32, 'NT': True, 'type': 'addresses_RW', 'same': False, 'AVXalign': False, 'congruent': 4}}
...
{'OP': 'LOAD', 'src': {'size': 16, 'NT': False, 'type': 'addresses_D_ht', 'same': False, 'AVXalign': True, 'congruent': 6}}
