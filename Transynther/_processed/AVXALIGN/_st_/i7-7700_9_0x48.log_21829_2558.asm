...
push %rdx
push %rsi
lea addresses_WT_ht+0x135c7, %rdi
nop
nop
nop
nop
...
nop
add %rdx, %rdx
lea addresses_UC_ht+0x1cdc7, %r12
nop
nop
nop
nop
...
nop
sub %rax, %rax
lea addresses_WT_ht+0x1edc7, %r15
nop
nop
inc %rbx
...
nop
dec %rdi
lea addresses_D_ht+0x15e1b, %rsi
lea addresses_UC_ht+0x35c7, %rdi
nop
nop
nop
nop
...
nop
sub %r12, %r12
lea addresses_normal_ht+0x9d07, %r12
nop
nop
and %rdi, %rdi
...
nop
add %rsi, %rsi
lea addresses_normal_ht+0xa507, %rdi
nop
nop
nop
nop
...
nop
add $27728, %rax
lea addresses_UC_ht+0x12747, %rsi
lea addresses_D_ht+0x15dc7, %rdi
nop
nop
nop
inc %r12
...
nop
cmp %rcx, %rcx
lea addresses_WT_ht+0x9fc7, %r12
nop
nop
xor %rbx, %rbx
mov (%r12), %r15
...
{'OP': 'LOAD', 'src': {'type': 'addresses_D_ht', 'AVXalign': False, 'congruent': 0, 'size': 8, 'same': True, 'NT': False}}
...
{'OP': 'LOAD', 'src': {'type': 'addresses_WT_ht', 'AVXalign': False, 'congruent': 9, 'size': 8, 'same': False, 'NT': True}}
{'32': 21829}
