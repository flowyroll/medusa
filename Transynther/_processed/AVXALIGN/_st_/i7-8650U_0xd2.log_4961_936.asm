...
lea addresses_WT_ht+0x6e8f, %rdi
inc %r11
mov $80, %rcx
rep movsb
nop
...
// Faulty Load
lea addresses_normal+0x5bdf, %r10
sub $39179, %rbx
mov (%r10), %r14
lea oracles, %r11
and $0xff, %r14
