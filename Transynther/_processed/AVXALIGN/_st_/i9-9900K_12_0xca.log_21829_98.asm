...
push %rdx
push %rsi
lea addresses_normal_ht+0x1c284, %rbp
nop
nop
nop
nop
...
nop
sub %r11, %r11
lea addresses_WT_ht+0x2d2d, %r12
nop
and %r10, %r10
movups (%r12), %xmm4
vpextrq $1, %xmm4, %rdx
...
nop
sub %rbp, %rbp
lea addresses_UC_ht+0x1beb5, %rsi
lea addresses_UC_ht+0x8f2d, %rdi
nop
nop
nop
nop
...
{'OP': 'LOAD', 'src': {'size': 4, 'NT': False, 'type': 'addresses_US', 'same': False, 'AVXalign': False, 'congruent': 2}}
...
{'OP': 'REPM', 'src': {'same': True, 'type': 'addresses_UC_ht', 'congruent': 3}, 'dst': {'same': False, 'type': 'addresses_UC_ht', 'congruent': 8}}
{'33': 21829}
