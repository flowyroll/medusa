...
nop
add %r15, %r15
lea addresses_UC_ht+0x48cd, %r13
nop
nop
nop
nop
...
nop
xor %rcx, %rcx
lea addresses_normal_ht+0xc28b, %r13
nop
nop
cmp %r11, %r11
movb (%r13), %cl
nop
and %rdi, %rdi
lea addresses_WC_ht+0x1c3c5, %rax
nop
add %r8, %r8
vmovups (%rax), %ymm1
...
nop
sub %r15, %r15
lea addresses_WT_ht+0x1deb3, %r11
nop
nop
nop
xor $5027, %r8
