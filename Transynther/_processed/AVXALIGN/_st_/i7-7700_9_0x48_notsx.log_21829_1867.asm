...
nop
xor $33095, %r15
lea addresses_normal_ht+0xcec, %r10
nop
add %rsi, %rsi
movb (%r10), %al
add $4318, %r8
lea addresses_WC_ht+0x1a486, %rsi
...
nop
cmp $15799, %r11
lea addresses_UC_ht+0xb943, %rsi
lea addresses_WC_ht+0x1d243, %rdi
nop
nop
nop
nop
...
nop
cmp %r11, %r11
lea addresses_D_ht+0x15bc3, %rsi
lea addresses_A_ht+0xe9c3, %rdi
nop
nop
nop
nop
...
nop
and %rdi, %rdi
lea addresses_WT_ht+0x34bb, %rsi
nop
nop
nop
nop
...
nop
add $46798, %rbx
lea addresses_A_ht+0x1158a, %rsi
lea addresses_WC_ht+0xa7a3, %rdi
nop
nop
nop
and $38825, %rax
...
nop
mfence
lea addresses_D_ht+0x115c3, %rsi
lea addresses_WC_ht+0x1edc3, %rdi
nop
nop
nop
cmp $55311, %r11
...
{'OP': 'LOAD', 'src': {'same': False, 'NT': False, 'AVXalign': True, 'size': 1, 'type': 'addresses_normal_ht', 'congruent': 0}}
{'dst': {'same': False, 'congruent': 6, 'type': 'addresses_A_ht'}, 'OP': 'REPM', 'src': {'same': False, 'congruent': 0, 'type': 'addresses_WC_ht'}}
{'dst': {'same': False, 'congruent': 7, 'type': 'addresses_WC_ht'}, 'OP': 'REPM', 'src': {'same': False, 'congruent': 7, 'type': 'addresses_UC_ht'}}
{'dst': {'same': False, 'NT': False, 'AVXalign': False, 'size': 1, 'type': 'addresses_WT_ht', 'congruent': 9}, 'OP': 'STOR'}
{'dst': {'same': False, 'congruent': 8, 'type': 'addresses_A_ht'}, 'OP': 'REPM', 'src': {'same': False, 'congruent': 10, 'type': 'addresses_D_ht'}}
