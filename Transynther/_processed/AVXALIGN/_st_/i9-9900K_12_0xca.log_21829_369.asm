...
push %rdx
push %rsi
lea addresses_WT_ht+0x1c07d, %r15
xor $37557, %rdi
mov (%r15), %r12
nop
nop
inc %rdx
lea addresses_UC_ht+0x11c7d, %rdi
nop
nop
nop
cmp %rdx, %rdx
mov (%rdi), %r10d
and $16620, %rdi
lea addresses_D_ht+0x14825, %rsi
lea addresses_A_ht+0x1a7fd, %rdi
nop
nop
sub $56341, %r10
mov $109, %rcx
...
nop
dec %rdi
lea addresses_WT_ht+0x1d65d, %rsi
lea addresses_normal_ht+0x26af, %rdi
nop
nop
nop
xor %rax, %rax
...
nop
cmp $43847, %rax
lea addresses_normal_ht+0x13215, %rax
nop
add $38391, %rdi
movb (%rax), %dl
nop
...
nop
sub $9376, %rdi
lea addresses_WT_ht+0x8448, %rsi
clflush (%rsi)
nop
nop
nop
...
{'OP': 'REPM', 'src': {'same': False, 'type': 'addresses_D_ht', 'congruent': 3}, 'dst': {'same': False, 'type': 'addresses_A_ht', 'congruent': 10}}
