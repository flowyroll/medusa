...
push %rdx
push %rsi
lea addresses_WT_ht+0x1c4f5, %r15
nop
cmp $56492, %rdi
movb $0x61, (%r15)
and %rsi, %rsi
lea addresses_UC_ht+0x1e2f5, %rsi
lea addresses_D_ht+0x6375, %rdi
nop
cmp %rax, %rax
mov $121, %rcx
rep movsw
xor %rsi, %rsi
lea addresses_normal_ht+0x11619, %r10
nop
nop
and %rdx, %rdx
...
movq %rdi, (%r10)
and $46988, %rdx
lea addresses_UC_ht+0x15b5, %rsi
nop
nop
nop
sub %r15, %r15
...
nop
and %r15, %r15
lea addresses_WC_ht+0x8415, %rax
nop
nop
nop
nop
...
nop
add %r10, %r10
lea addresses_UC_ht+0x196f5, %r15
sub $11731, %rax
...
vpextrq $0, %xmm0, %rcx
sub %rsi, %rsi
lea addresses_A_ht+0x5875, %rsi
lea addresses_WT_ht+0x4707, %rdi
nop
cmp %r15, %r15
mov $33, %rcx
rep movsl
...
nop
xor $35173, %rax
lea addresses_normal_ht+0xa7b5, %rsi
lea addresses_UC_ht+0x68f5, %rdi
nop
nop
nop
inc %r15
...
nop
xor %rax, %rax
lea addresses_normal_ht+0x7af5, %rsi
lea addresses_WT_ht+0x3385, %rdi
nop
nop
nop
nop
...
nop
sub %r10, %r10
lea addresses_WC_ht+0xc1d0, %rsi
lea addresses_UC_ht+0x1e475, %rdi
clflush (%rsi)
nop
sub $38101, %r15
mov $94, %rcx
...
nop
and %r15, %r15
lea addresses_A_ht+0x14935, %rsi
lea addresses_D_ht+0xa8f5, %rdi
clflush (%rdi)
nop
nop
nop
...
nop
and %rdi, %rdi
lea addresses_normal_ht+0x1c2f5, %rdi
nop
nop
nop
nop
...
{'src': {'type': 'addresses_normal_ht', 'congruent': 5, 'same': False}, 'dst': {'type': 'addresses_UC_ht', 'congruent': 9, 'same': False}, 'OP': 'REPM'}
...
{'src': {'type': 'addresses_A_ht', 'congruent': 5, 'same': True}, 'dst': {'type': 'addresses_D_ht', 'congruent': 9, 'same': False}, 'OP': 'REPM'}
