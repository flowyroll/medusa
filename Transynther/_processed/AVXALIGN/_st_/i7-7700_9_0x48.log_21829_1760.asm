...
push %rdi
push %rsi
lea addresses_WT_ht+0x1d482, %r11
nop
nop
sub $47036, %rdi
...
nop
add %rdi, %rdi
lea addresses_A_ht+0xcf36, %rsi
lea addresses_D_ht+0x7d0a, %rdi
nop
nop
nop
nop
...
nop
sub %rbp, %rbp
lea addresses_UC_ht+0x175b6, %rsi
nop
nop
xor %r15, %r15
movw $0x6162, (%rsi)
...
nop
add $52435, %r14
lea addresses_D_ht+0x1e9b6, %r11
nop
add %r9, %r9
...
nop
inc %rcx
lea addresses_WC_ht+0x39b6, %rsi
lea addresses_UC_ht+0x53b6, %rdi
nop
add $42565, %r14
mov $96, %rcx
rep movsl
...
nop
add %r9, %r9
lea addresses_UC_ht+0x1b6, %rsi
lea addresses_A_ht+0xdbb6, %rdi
clflush (%rdi)
dec %rbp
mov $87, %rcx
rep movsb
...
nop
cmp %rdi, %rdi
lea addresses_A_ht+0x1c1b6, %rsi
lea addresses_WT_ht+0x139b6, %rdi
nop
nop
nop
nop
...
nop
inc %rcx
lea addresses_normal_ht+0x1b146, %r9
and %r14, %r14
mov (%r9), %si
nop
nop
...
nop
xor $15340, %r11
lea addresses_normal_ht+0x128b6, %r11
clflush (%r11)
nop
nop
nop
...
vpextrq $0, %xmm4, %r15
xor $31054, %r15
lea addresses_D_ht+0x179b6, %r14
nop
nop
nop
nop
...
movups %xmm5, (%r9)
and $50053, %r11
lea addresses_WC_ht+0x12fb6, %rsi
lea addresses_A_ht+0x13fd6, %rdi
nop
nop
nop
sub $46579, %r11
...
// Faulty Load
lea addresses_normal+0x199b6, %r9
nop
and %rdx, %rdx
mov (%r9), %eax
lea oracles, %rbx
...
{'OP': 'LOAD', 'src': {'type': 'addresses_D_ht', 'AVXalign': True, 'congruent': 11, 'size': 4, 'same': False, 'NT': False}}
{'OP': 'STOR', 'dst': {'type': 'addresses_D_ht', 'AVXalign': False, 'congruent': 3, 'size': 16, 'same': False, 'NT': False}}
{'OP': 'REPM', 'src': {'type': 'addresses_WC_ht', 'congruent': 8, 'same': False}, 'dst': {'type': 'addresses_A_ht', 'congruent': 4, 'same': False}}
{'34': 21829}
