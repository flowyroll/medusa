...
push %rdi
push %rsi
lea addresses_WT_ht+0x65af, %rsi
lea addresses_D_ht+0x187e7, %rdi
nop
nop
nop
nop
...
nop
and $28434, %r8
lea addresses_A_ht+0x194bf, %r12
nop
nop
nop
nop
...
nop
sub %rcx, %rcx
lea addresses_UC_ht+0x13bf, %rsi
lea addresses_D_ht+0x703f, %rdi
nop
nop
add %r12, %r12
mov $121, %rcx
rep movsw
xor %rdi, %rdi
lea addresses_WC_ht+0x1ef3f, %rsi
lea addresses_normal_ht+0x7e8b, %rdi
nop
nop
nop
xor $51809, %rbx
...
nop
xor %r10, %r10
lea addresses_normal_ht+0x763f, %rdi
nop
nop
nop
cmp $14526, %r12
...
{'src': {'congruent': 9, 'same': False, 'type': 'addresses_UC_ht'}, 'dst': {'congruent': 7, 'same': False, 'type': 'addresses_D_ht'}, 'OP': 'REPM'}
