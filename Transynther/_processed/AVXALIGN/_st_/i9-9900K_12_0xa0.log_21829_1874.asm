...
push %rdi
push %rsi
lea addresses_UC_ht+0xaf60, %r14
add $22476, %rdi
movw $0x6162, (%r14)
nop
nop
nop
add %r11, %r11
lea addresses_UC_ht+0x65e0, %rdi
clflush (%rdi)
add %r14, %r14
...
nop
dec %r11
lea addresses_D_ht+0x125e0, %rsi
lea addresses_UC_ht+0xb595, %rdi
clflush (%rdi)
nop
nop
nop
...
// Store
lea addresses_RW+0x18360, %r15
xor $5951, %r11
movw $0x5152, (%r15)
cmp %r15, %r15

// Store
mov $0x4a4a2f0000000c80, %r13
nop
nop
nop
cmp $51706, %r9
...
{'src': {'same': False, 'congruent': 7, 'type': 'addresses_D_ht'}, 'OP': 'REPM', 'dst': {'same': False, 'congruent': 0, 'type': 'addresses_UC_ht'}}
