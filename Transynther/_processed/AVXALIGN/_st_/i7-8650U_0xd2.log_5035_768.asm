...
push %rdx
push %rsi
lea addresses_normal_ht+0x10bbb, %r9
nop
nop
nop
nop
...
nop
xor $34402, %rdx
lea addresses_WT_ht+0x1d3bb, %r15
nop
nop
nop
inc %rbx
...
nop
sub %rdx, %rdx
lea addresses_UC_ht+0x609e, %rsi
lea addresses_UC_ht+0x2bb, %rdi
nop
nop
nop
nop
...
nop
sub %r15, %r15
lea addresses_UC_ht+0x166d, %rcx
nop
dec %rdi
vmovups (%rcx), %ymm1
...
{'OP': 'LOAD', 'src': {'type': 'addresses_US', 'size': 2, 'AVXalign': False, 'NT': True, 'congruent': 6, 'same': False}}
...
{'OP': 'STOR', 'dst': {'type': 'addresses_RW', 'size': 2, 'AVXalign': False, 'NT': True, 'congruent': 3, 'same': False}}
{'OP': 'LOAD', 'src': {'type': 'addresses_PSE', 'size': 4, 'AVXalign': False, 'NT': False, 'congruent': 0, 'same': True}}
{'OP': 'STOR', 'dst': {'type': 'addresses_UC', 'size': 1, 'AVXalign': True, 'NT': False, 'congruent': 4, 'same': False}}
[Faulty Load]
