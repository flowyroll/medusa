...
push %rdx
push %rsi
lea addresses_UC_ht+0x8a94, %rcx
nop
nop
nop
nop
...
nop
and $30386, %rdi
lea addresses_D_ht+0x1d294, %rdx
clflush (%rdx)
nop
nop
xor %rax, %rax
...
nop
xor $26610, %rcx
lea addresses_UC_ht+0xdd6c, %rsi
nop
nop
nop
nop
