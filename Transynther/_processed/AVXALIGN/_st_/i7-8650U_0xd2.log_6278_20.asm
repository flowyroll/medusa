...
nop
dec %rbx
lea addresses_WC_ht+0x1add4, %rcx
sub %r15, %r15
mov $0x6162636465666768, %r14
movq %r14, %xmm3
movups %xmm3, (%rcx)
cmp $17967, %r15
lea addresses_WC_ht+0x3984, %rsi
lea addresses_A_ht+0x142b5, %rdi
clflush (%rsi)
clflush (%rdi)
nop
nop
...
nop
add $53543, %rcx
lea addresses_WC_ht+0x1d434, %r12
nop
nop
nop
nop
...
nop
cmp $25238, %r14
lea addresses_WT_ht+0xeba0, %r14
inc %r12
vmovups (%r14), %ymm6
...
nop
add %rbx, %rbx
lea addresses_WT_ht+0x39fc, %rsi
nop
nop
nop
cmp $22310, %r14
...
nop
inc %r14
lea addresses_UC_ht+0x238a, %rsi
lea addresses_WT_ht+0x146d4, %rdi
nop
nop
nop
nop
...
nop
dec %rax
lea addresses_WC_ht+0x159d4, %rsi
lea addresses_WC_ht+0x17d4, %rdi
nop
nop
nop
nop
...
nop
add $56470, %rax
lea addresses_WT_ht+0x12a43, %r15
add %rax, %rax
...
{'OP': 'REPM', 'src': {'type': 'addresses_UC_ht', 'congruent': 1, 'same': False}, 'dst': {'type': 'addresses_WT_ht', 'congruent': 5, 'same': True}}
