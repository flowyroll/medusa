...
push %rdi
push %rsi
lea addresses_A_ht+0xf468, %rsi
lea addresses_UC_ht+0x14b28, %rdi
clflush (%rsi)
nop
sub $10818, %r15
mov $112, %rcx
...
lea addresses_D_ht+0x186c0, %rdi
nop
nop
add $65042, %r11
mov $105, %rcx
...
nop
cmp %rdi, %rdi
lea addresses_UC_ht+0x143be, %rsi
lea addresses_WC_ht+0x5d68, %rdi
nop
nop
nop
cmp $41140, %r12
...
nop
sub %r11, %r11
lea addresses_D_ht+0x14fa8, %rsi
nop
sub $50960, %rcx
...
{'OP': 'REPM', 'src': {'same': False, 'congruent': 0, 'type': 'addresses_A_ht'}, 'dst': {'same': True, 'congruent': 3, 'type': 'addresses_D_ht'}}
{'OP': 'REPM', 'src': {'same': False, 'congruent': 1, 'type': 'addresses_UC_ht'}, 'dst': {'same': False, 'congruent': 9, 'type': 'addresses_WC_ht'}}
