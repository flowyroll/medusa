...
// REPMOV
lea addresses_WT+0x147fe, %rsi
lea addresses_D+0x58ce, %rdi
nop
nop
add %rbx, %rbx
mov $14, %rcx
...
// REPMOV
lea addresses_D+0x691e, %rsi
lea addresses_WT+0x219e, %rdi
clflush (%rsi)
nop
nop
nop
...
// Load
lea addresses_A+0x142fe, %r12
sub $37858, %rdi
mov (%r12), %bx
xor %rcx, %rcx

// Faulty Load
lea addresses_D+0xf7fe, %r12
nop
nop
nop
nop
...
{'OP': 'REPM', 'src': {'same': False, 'congruent': 10, 'type': 'addresses_WT'}, 'dst': {'same': False, 'congruent': 4, 'type': 'addresses_D'}}
{'OP': 'STOR', 'dst': {'same': False, 'type': 'addresses_PSE', 'NT': False, 'AVXalign': False, 'size': 32, 'congruent': 3}}
{'OP': 'REPM', 'src': {'same': False, 'congruent': 5, 'type': 'addresses_D'}, 'dst': {'same': False, 'congruent': 5, 'type': 'addresses_WT'}}
