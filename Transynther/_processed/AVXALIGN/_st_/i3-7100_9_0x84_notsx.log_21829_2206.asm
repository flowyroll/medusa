...
push %rdi
push %rsi
lea addresses_A_ht+0x1566d, %r10
nop
nop
nop
inc %r9
...
nop
cmp $7612, %rbx
lea addresses_D_ht+0x1536d, %rsi
lea addresses_D_ht+0x1116d, %rdi
nop
nop
nop
nop
...
nop
inc %rax
lea addresses_WC_ht+0x157f9, %rdi
add %r9, %r9
mov $0x6162636465666768, %rbx
movq %rbx, %xmm7
...
nop
sub %rcx, %rcx
lea addresses_normal_ht+0x177f, %rbx
nop
nop
nop
add %rax, %rax
...
vmovups %ymm3, (%rbx)
add %rdi, %rdi
lea addresses_WT_ht+0xb6d, %rsi
lea addresses_WC_ht+0x10407, %rdi
nop
nop
and %r9, %r9
mov $68, %rcx
...
nop
xor %r9, %r9
lea addresses_WT_ht+0x17b6d, %rsi
nop
nop
cmp %rcx, %rcx
mov $0x6162636465666768, %rbx
...
nop
xor $2877, %rbx
lea addresses_UC_ht+0x6a25, %r10
mfence
...
nop
inc %rdi
lea addresses_normal_ht+0x4a79, %r10
nop
add %rax, %rax
movb (%r10), %cl
add %rcx, %rcx
lea addresses_normal_ht+0x17a6d, %rdi
nop
nop
nop
nop
...
movb $0x61, (%rdi)
sub $12597, %rax
lea addresses_normal_ht+0x1428d, %rdi
nop
nop
nop
nop
...
// REPMOV
lea addresses_A+0x936d, %rsi
lea addresses_WT+0xeb6d, %rdi
nop
cmp %r12, %r12
mov $104, %rcx
rep movsb
...
{'src': {'type': 'addresses_A', 'congruent': 11, 'same': False}, 'dst': {'type': 'addresses_WT', 'congruent': 10, 'same': False}, 'OP': 'REPM'}
[Faulty Load]
{'src': {'type': 'addresses_D', 'same': True, 'size': 8, 'congruent': 0, 'NT': False, 'AVXalign': True}, 'OP': 'LOAD'}
<gen_prepare_buffer>
{'dst': {'type': 'addresses_A_ht', 'same': True, 'size': 16, 'congruent': 8, 'NT': False, 'AVXalign': False}, 'OP': 'STOR'}
{'src': {'type': 'addresses_D_ht', 'congruent': 8, 'same': False}, 'dst': {'type': 'addresses_D_ht', 'congruent': 9, 'same': False}, 'OP': 'REPM'}
...
{'dst': {'type': 'addresses_WT_ht', 'same': False, 'size': 8, 'congruent': 11, 'NT': False, 'AVXalign': True}, 'OP': 'STOR'}
