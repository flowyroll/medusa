...
push %rdx
push %rsi
lea addresses_A_ht+0x729e, %rsi
lea addresses_WC_ht+0x9cde, %rdi
nop
nop
nop
nop
...
nop
xor $27955, %r10
lea addresses_WT_ht+0x6d3e, %rsi
lea addresses_normal_ht+0xde3e, %rdi
nop
sub $56543, %r13
mov $19, %rcx
rep movsb
...
nop
cmp $45423, %rsi
lea addresses_UC_ht+0x6559, %rcx
dec %rax
mov (%rcx), %edx
nop
nop
...
nop
cmp %rax, %rax
lea addresses_WC_ht+0x1e23e, %rsi
nop
cmp %rdx, %rdx
vmovups (%rsi), %ymm4
...
nop
mfence
lea addresses_UC_ht+0x1323e, %rdx
nop
nop
nop
add $34029, %r13
...
lea addresses_UC_ht+0x7a7e, %rdi
nop
nop
cmp %r12, %r12
mov $85, %rcx
...
nop
sub $11074, %r13
lea addresses_D_ht+0xe43e, %r12
nop
nop
and $41650, %rdx
mov (%r12), %rsi
and $21972, %rax
lea addresses_WT_ht+0xd63e, %rdx
nop
nop
add $2897, %r12
movb (%rdx), %cl
xor $3286, %rax
lea addresses_UC_ht+0x1213b, %rsi
lea addresses_WT_ht+0xf9c4, %rdi
nop
xor $1032, %r12
mov $84, %rcx
rep movsl
...
add %rdx, %rdx
lea addresses_WC_ht+0x1e23e, %rsi
lea addresses_normal_ht+0x14e6, %rdi
nop
nop
nop
nop
...
rep movsw
and $64515, %rdx
lea addresses_A_ht+0x1707e, %rsi
nop
sub %rcx, %rcx
...
{'OP': 'STOR', 'dst': {'type': 'addresses_NC', 'AVXalign': False, 'congruent': 8, 'size': 1, 'same': False, 'NT': False}}
