...
lea addresses_WC_ht+0xb23d, %rdi
nop
nop
nop
sub $48367, %r9
...
nop
inc %rbp
lea addresses_normal_ht+0x1dcad, %rsi
lea addresses_normal_ht+0x115d, %rdi
nop
nop
nop
cmp $254, %rbx
...
nop
xor %rbp, %rbp
lea addresses_D_ht+0x17abd, %rsi
lea addresses_WC_ht+0x11b8d, %rdi
nop
nop
nop
nop
...
rep movsw
inc %r9
lea addresses_WT_ht+0x15bc3, %rbx
nop
nop
nop
nop
...
movq %rcx, (%rbx)
cmp $16601, %r11
lea addresses_UC_ht+0x1155d, %r15
nop
nop
nop
and %rdi, %rdi
...
{'OP': 'LOAD', 'src': {'type': 'addresses_D_ht', 'size': 4, 'AVXalign': True, 'NT': True, 'congruent': 11, 'same': False}}
...
{'OP': 'REPM', 'src': {'type': 'addresses_D_ht', 'congruent': 3, 'same': False}, 'dst': {'type': 'addresses_WC_ht', 'congruent': 4, 'same': True}}
