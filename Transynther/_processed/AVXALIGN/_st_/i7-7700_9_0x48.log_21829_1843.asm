...
nop
add %r8, %r8
lea addresses_UC_ht+0x1d1ab, %rsi
lea addresses_WT_ht+0x693, %rdi
nop
nop
nop
sub $450, %rbx
...
nop
cmp %r12, %r12
lea addresses_WT_ht+0x12493, %rcx
nop
sub $39413, %rbx
mov (%rcx), %si
nop
...
{'OP': 'LOAD', 'src': {'type': 'addresses_D_ht', 'AVXalign': True, 'congruent': 5, 'size': 4, 'same': False, 'NT': True}}
{'36': 21829}
