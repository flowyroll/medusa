...
push %rdi
push %rsi
lea addresses_D_ht+0x89fc, %rsi
lea addresses_A_ht+0x12d4, %rdi
cmp %r9, %r9
mov $69, %rcx
rep movsq
nop
...
nop
inc %r13
lea addresses_A_ht+0x1ed9c, %r10
nop
nop
nop
nop
...
mov (%r10), %rsi
dec %rsi
lea addresses_normal_ht+0x123d4, %rsi
lea addresses_UC_ht+0x19b14, %rdi
sub %rax, %rax
mov $65, %rcx
rep movsl
dec %r9
...
[Faulty Load]
{'OP': 'LOAD', 'src': {'type': 'addresses_UC', 'AVXalign': True, 'congruent': 0, 'size': 8, 'same': True, 'NT': True}}
<gen_prepare_buffer>
