...
push %rdi
push %rsi
lea addresses_D_ht+0x141d6, %r12
nop
sub $15209, %rsi
movw $0x6162, (%r12)
nop
...
nop
add $1722, %r10
lea addresses_UC_ht+0x184ee, %rbp
nop
sub $33984, %r11
...
nop
xor $12647, %r10
lea addresses_D_ht+0x1c0ee, %r11
nop
nop
and $39120, %rbp
mov (%r11), %eax
cmp %rsi, %rsi
lea addresses_UC_ht+0x1c0ee, %rax
nop
nop
nop
nop
...
movb $0x61, (%rax)
add %r11, %r11
lea addresses_WT_ht+0x54ee, %rsi
lea addresses_WC_ht+0xb0ee, %rdi
nop
nop
nop
nop
...
{'OP': 'LOAD', 'src': {'type': 'addresses_WC_ht', 'AVXalign': True, 'congruent': 9, 'size': 1, 'same': True, 'NT': False}}
{'32': 21829}
