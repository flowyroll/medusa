...
nop
xor $59021, %r12
lea addresses_WC_ht+0xc5d5, %rax
clflush (%rax)
nop
sub %r8, %r8
vmovups (%rax), %ymm3
...
nop
and %rdi, %rdi
lea addresses_D_ht+0x10db5, %r12
clflush (%r12)
nop
nop
nop
...
vmovups %ymm5, (%r12)
cmp $37781, %r8
lea addresses_normal_ht+0x1e255, %rsi
lea addresses_D_ht+0x1df8d, %rdi
dec %r13
mov $40, %rcx
rep movsb
nop
...
vpextrq $0, %xmm1, %r8
sub %r8, %r8
lea addresses_WC_ht+0x8fe5, %rsi
lea addresses_WC_ht+0x16819, %rdi
clflush (%rdi)
nop
nop
nop
...
nop
inc %r12
lea addresses_UC_ht+0x2bd5, %rsi
lea addresses_UC_ht+0x19f55, %rdi
nop
cmp $62118, %r11
mov $48, %rcx
rep movsb
and $52475, %rcx
lea addresses_A_ht+0x16155, %rsi
lea addresses_D_ht+0x7d55, %rdi
nop
nop
sub %r12, %r12
mov $33, %rcx
...
nop
inc %r11
lea addresses_D_ht+0x1e315, %rsi
lea addresses_UC_ht+0x16aad, %rdi
nop
nop
nop
nop
...
nop
xor %r13, %r13
lea addresses_A_ht+0x1a4b5, %r11
nop
sub %rsi, %rsi
movw $0x6162, (%r11)
nop
nop
dec %r12
lea addresses_normal_ht+0x1a955, %r12
nop
nop
nop
nop
...
[Faulty Load]
{'src': {'type': 'addresses_UC', 'AVXalign': True, 'size': 4, 'NT': False, 'same': True, 'congruent': 0}, 'OP': 'LOAD'}
<gen_prepare_buffer>
...
{'src': {'type': 'addresses_normal_ht', 'congruent': 8, 'same': False}, 'OP': 'REPM', 'dst': {'type': 'addresses_D_ht', 'congruent': 3, 'same': False}}
{'src': {'type': 'addresses_A_ht', 'AVXalign': False, 'size': 32, 'NT': True, 'same': False, 'congruent': 11}, 'OP': 'LOAD'}
...
{'src': {'type': 'addresses_A_ht', 'congruent': 10, 'same': False}, 'OP': 'REPM', 'dst': {'type': 'addresses_D_ht', 'congruent': 6, 'same': False}}
{'src': {'type': 'addresses_D_ht', 'AVXalign': False, 'size': 8, 'NT': True, 'same': False, 'congruent': 1}, 'OP': 'LOAD'}
