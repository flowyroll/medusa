...
push %rdi
push %rsi
lea addresses_A_ht+0x14d60, %rbx
nop
add %r9, %r9
movups (%rbx), %xmm0
vpextrq $1, %xmm0, %r12
...
nop
add $63262, %r13
lea addresses_D_ht+0x429c, %rsi
lea addresses_A_ht+0xc560, %rdi
inc %r13
mov $45, %rcx
rep movsq
nop
...
nop
cmp $67, %r12
lea addresses_WT_ht+0x80ba, %r12
xor %rbx, %rbx
movups (%r12), %xmm1
vpextrq $0, %xmm1, %rcx
nop
...
nop
add $5326, %rsi
lea addresses_WC_ht+0x1b2fe, %rdi
clflush (%rdi)
inc %rcx
movb (%rdi), %r9b
nop
...
nop
cmp $9191, %rsi
lea addresses_A_ht+0xf8e4, %rsi
lea addresses_D_ht+0x12ad8, %rdi
clflush (%rdi)
nop
nop
nop
...
nop
inc %r13
lea addresses_normal_ht+0x8760, %rsi
clflush (%rsi)
nop
nop
xor $18989, %r9
...
nop
cmp $15550, %r12
lea addresses_UC_ht+0x1b994, %r9
clflush (%r9)
xor $5918, %rdi
...
nop
inc %rdi
lea addresses_normal_ht+0x31c0, %rsi
nop
nop
nop
nop
...
nop
inc %rdi
lea addresses_normal_ht+0x4160, %rsi
lea addresses_D_ht+0x1e560, %rdi
nop
nop
nop
sub %r14, %r14
...
nop
xor %rbx, %rbx
lea addresses_D_ht+0x3560, %r9
nop
cmp %rbx, %rbx
movups (%r9), %xmm0
vpextrq $1, %xmm0, %rcx
and $12801, %rbx
lea addresses_WC_ht+0x15f60, %rdi
nop
xor $51863, %rbx
movups (%rdi), %xmm4
vpextrq $1, %xmm4, %rcx
