...
push %rdi
push %rsi
lea addresses_WT_ht+0xfee9, %r15
nop
nop
nop
sub $15611, %r11
...
nop
add %rbp, %rbp
lea addresses_D_ht+0x133b1, %rcx
nop
nop
nop
nop
...
nop
add %rcx, %rcx
lea addresses_normal_ht+0x18829, %rsi
...
nop
dec %r10
lea addresses_WT_ht+0x3ae9, %rsi
clflush (%rsi)
nop
nop
nop
...
mov (%rsi), %r15d
lfence
lea addresses_D_ht+0x161ed, %rsi
lea addresses_WC_ht+0x9fe9, %rdi
inc %r12
mov $117, %rcx
rep movsw
nop
xor %r15, %r15
lea addresses_WT_ht+0x1be9, %rsi
lea addresses_UC_ht+0x7569, %rdi
nop
nop
nop
nop
...
nop
sub $9487, %r12
lea addresses_WC_ht+0x1dbe9, %rbp
nop
nop
nop
nop
...
nop
dec %rdi
lea addresses_UC_ht+0xc2b3, %r10
nop
nop
nop
dec %rsi
...
{'OP': 'REPM', 'src': {'type': 'addresses_WT_ht', 'congruent': 9, 'same': True}, 'dst': {'type': 'addresses_UC_ht', 'congruent': 7, 'same': True}}
