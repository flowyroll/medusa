...
// Store
lea addresses_normal+0x1fe4d, %rax
nop
nop
nop
and %r13, %r13
...
// Store
lea addresses_normal+0x16083, %rdi
clflush (%rdi)
nop
and $40987, %rcx
...
{'OP': 'LOAD', 'src': {'same': False, 'type': 'addresses_UC', 'NT': False, 'AVXalign': False, 'size': 32, 'congruent': 3}}
{'OP': 'STOR', 'dst': {'same': False, 'type': 'addresses_A', 'NT': True, 'AVXalign': False, 'size': 4, 'congruent': 10}}
{'OP': 'STOR', 'dst': {'same': False, 'type': 'addresses_D', 'NT': False, 'AVXalign': True, 'size': 2, 'congruent': 9}}
