...
push %rdx
push %rsi
lea addresses_D_ht+0x1c4e1, %rsi
lea addresses_WT_ht+0x10105, %rdi
add $31422, %r14
mov $42, %rcx
rep movsq
nop
...
nop
xor %rdi, %rdi
lea addresses_WC_ht+0x5a4d, %rcx
nop
nop
nop
nop
...
nop
sub %r14, %r14
lea addresses_UC_ht+0x16896, %r8
nop
xor %rcx, %rcx
mov (%r8), %r10d
nop
nop
and %rcx, %rcx
lea addresses_UC_ht+0xc325, %r14
nop
nop
nop
nop
...
lea addresses_WC_ht+0x15125, %rdi
xor $57201, %r10
mov $58, %rcx
rep movsl
nop
dec %rdi
lea addresses_normal_ht+0x143f1, %rsi
lea addresses_UC_ht+0x142f5, %rdi
nop
nop
xor %r10, %r10
mov $122, %rcx
...
nop
xor %r10, %r10
lea addresses_UC_ht+0x8225, %rbp
nop
add $65326, %rsi
vmovups (%rbp), %ymm6
...
nop
and %r14, %r14
lea addresses_UC_ht+0x6ba5, %rsi
...
<gen_prepare_buffer>
{'OP': 'REPM', 'src': {'same': False, 'congruent': 2, 'type': 'addresses_D_ht'}, 'dst': {'same': False, 'congruent': 5, 'type': 'addresses_WT_ht'}}
...
{'OP': 'REPM', 'src': {'same': False, 'congruent': 7, 'type': 'addresses_A_ht'}, 'dst': {'same': False, 'congruent': 11, 'type': 'addresses_WC_ht'}}
