...
push %rdi
push %rsi
lea addresses_A_ht+0x188c2, %r9
cmp $22050, %rcx
mov $0x6162636465666768, %r14
movq %r14, (%r9)
nop
and $61227, %rbx
lea addresses_normal_ht+0x18c6f, %rsi
lea addresses_WC_ht+0xd56f, %rdi
nop
nop
nop
nop
...
nop
dec %rbx
lea addresses_WT_ht+0x1d66f, %r9
nop
nop
nop
nop
...
nop
and $23481, %r8
lea addresses_D_ht+0xac6f, %rsi
lea addresses_A_ht+0x1a86f, %rdi
clflush (%rsi)
add $60668, %r9
mov $115, %rcx
rep movsl
...
nop
sub %rcx, %rcx
lea addresses_UC_ht+0x1746f, %rsi
nop
nop
nop
add %rdi, %rdi
...
nop
inc %rbx
lea addresses_WC_ht+0x1b64f, %rsi
lea addresses_normal_ht+0xc66f, %rdi
clflush (%rsi)
nop
and $64280, %r8
mov $106, %rcx
...
nop
sub $31292, %r9
lea addresses_A_ht+0x146f, %r8
cmp $4779, %rcx
mov (%r8), %rdi
nop
nop
sub %r8, %r8
lea addresses_UC_ht+0x5e0f, %rsi
lea addresses_UC_ht+0x1a32f, %rdi
nop
dec %r8
mov $52, %rcx
rep movsq
xor %rcx, %rcx
lea addresses_A_ht+0x13e6f, %rsi
nop
nop
nop
nop
...
{'src': {'type': 'addresses_normal_ht', 'congruent': 10, 'same': True}, 'OP': 'REPM', 'dst': {'type': 'addresses_WC_ht', 'congruent': 8, 'same': False}}
...
{'src': {'type': 'addresses_UC_ht', 'congruent': 5, 'same': False}, 'OP': 'REPM', 'dst': {'type': 'addresses_UC_ht', 'congruent': 4, 'same': False}}
