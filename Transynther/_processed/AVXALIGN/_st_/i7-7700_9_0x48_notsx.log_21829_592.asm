...
push %rdx
push %rsi
lea addresses_D_ht+0x17a83, %r10
nop
dec %r15
...
nop
sub $42451, %rax
lea addresses_normal_ht+0x16283, %r9
xor $64629, %r10
mov (%r9), %r15w
nop
nop
sub $17964, %r15
lea addresses_A_ht+0x15fe3, %rsi
lea addresses_A_ht+0x5183, %rdi
sub %r13, %r13
mov $120, %rcx
rep movsq
nop
inc %rcx
lea addresses_D_ht+0xca83, %r10
nop
nop
nop
add %r9, %r9
...
nop
cmp %r15, %r15
lea addresses_WT_ht+0xe9bb, %rsi
lea addresses_UC_ht+0x19989, %rdi
nop
nop
xor $54807, %r15
mov $65, %rcx
...
nop
and %rdi, %rdi
lea addresses_A_ht+0xf72d, %rsi
lea addresses_D_ht+0x1d683, %rdi
sub $21379, %r15
mov $47, %rcx
rep movsb
nop
cmp %rsi, %rsi
lea addresses_A_ht+0x151e7, %rdx
nop
nop
nop
nop
...
nop
xor %rdi, %rdi
lea addresses_UC_ht+0x1c7e3, %rsi
lea addresses_D_ht+0x18f9e, %rdi
clflush (%rdi)
nop
nop
nop
...
<gen_prepare_buffer>
{'dst': {'same': False, 'NT': True, 'AVXalign': False, 'size': 8, 'type': 'addresses_D_ht', 'congruent': 9}, 'OP': 'STOR'}
...
{'dst': {'same': False, 'congruent': 4, 'type': 'addresses_A_ht'}, 'OP': 'REPM', 'src': {'same': False, 'congruent': 4, 'type': 'addresses_A_ht'}}
{'dst': {'same': False, 'NT': False, 'AVXalign': False, 'size': 4, 'type': 'addresses_D_ht', 'congruent': 8}, 'OP': 'STOR'}
{'dst': {'same': False, 'congruent': 1, 'type': 'addresses_UC_ht'}, 'OP': 'REPM', 'src': {'same': True, 'congruent': 3, 'type': 'addresses_WT_ht'}}
