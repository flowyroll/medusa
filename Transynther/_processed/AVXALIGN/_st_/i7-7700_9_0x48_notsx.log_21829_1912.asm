...
push %rdi
push %rdx
lea addresses_normal_ht+0x6935, %r15
nop
sub %rax, %rax
movb $0x61, (%r15)
nop
...
// Store
lea addresses_normal+0xbb35, %rsi
nop
nop
nop
sub $7610, %rdx
