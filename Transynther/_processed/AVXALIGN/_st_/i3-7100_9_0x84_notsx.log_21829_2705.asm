...
push %rdx
push %rsi
lea addresses_normal_ht+0x77b4, %rsi
lea addresses_A_ht+0x99b4, %rdi
nop
xor $56873, %r11
mov $54, %rcx
rep movsl
...
nop
add $36319, %r15
lea addresses_normal_ht+0x1b634, %r11
nop
nop
nop
add %rdi, %rdi
...
nop
xor %rsi, %rsi
lea addresses_normal_ht+0x12034, %r11
nop
nop
nop
sub %rax, %rax
...
nop
sub $32285, %rax
lea addresses_UC_ht+0x11b8c, %rsi
...
rep movsq
inc %rdi
lea addresses_WC_ht+0x122b4, %rdi
nop
nop
nop
cmp %rsi, %rsi
...
nop
cmp %r11, %r11
lea addresses_normal_ht+0x1c1b4, %rsi
lea addresses_D_ht+0x29b4, %rdi
nop
nop
nop
nop
...
<gen_prepare_buffer>
{'src': {'type': 'addresses_normal_ht', 'congruent': 7, 'same': False}, 'dst': {'type': 'addresses_A_ht', 'congruent': 11, 'same': False}, 'OP': 'REPM'}
...
{'dst': {'type': 'addresses_D_ht', 'same': False, 'size': 8, 'congruent': 0, 'NT': True, 'AVXalign': False}, 'OP': 'STOR'}
...
{'src': {'type': 'addresses_D_ht', 'congruent': 9, 'same': False}, 'dst': {'type': 'addresses_WT_ht', 'congruent': 7, 'same': True}, 'OP': 'REPM'}
