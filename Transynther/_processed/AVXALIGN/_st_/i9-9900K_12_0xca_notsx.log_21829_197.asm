...
push %rdx
push %rsi
lea addresses_normal_ht+0x173c3, %rsi
nop
nop
add %r14, %r14
...
movups %xmm7, (%rsi)
sub %rsi, %rsi
lea addresses_WT_ht+0x5cfb, %r12
nop
nop
nop
xor %r10, %r10
...
nop
and $31877, %r14
lea addresses_WT_ht+0x53c3, %rax
nop
nop
nop
nop
...
nop
and %rsi, %rsi
lea addresses_WT_ht+0x3dc3, %rdx
clflush (%rdx)
sub $24478, %r8
movups (%rdx), %xmm0
vpextrq $0, %xmm0, %r14
...
nop
and %rax, %rax
lea addresses_A_ht+0xe403, %r10
and $61551, %rax
movb $0x61, (%r10)
nop
and %r14, %r14
lea addresses_A_ht+0x3879, %rsi
nop
nop
nop
nop
...
nop
sub %r8, %r8
lea addresses_UC_ht+0xf5c3, %rdx
nop
nop
nop
nop
...
nop
cmp %r8, %r8
lea addresses_A_ht+0x136b5, %rsi
...
nop
sub %rdi, %rdi
lea addresses_A_ht+0x1d3d7, %rax
nop
nop
nop
nop
...
mov (%rax), %ecx
add $55163, %r8
lea addresses_WT_ht+0x1d3df, %rax
nop
nop
xor $59801, %r12
movl $0x61626364, (%rax)
nop
and $28174, %r12
lea addresses_A_ht+0xf2c3, %rsi
lea addresses_WT_ht+0x11cf, %rdi
nop
nop
and %r8, %r8
mov $29, %rcx
...
{'OP': 'STOR', 'dst': {'same': False, 'type': 'addresses_UC', 'NT': False, 'AVXalign': True, 'size': 4, 'congruent': 10}}
