...
nop
cmp %rdx, %rdx
lea addresses_D_ht+0x828c, %rcx
nop
and $32171, %r8
mov $0x6162636465666768, %rsi
movq %rsi, (%rcx)
add $65430, %rdi
lea addresses_WC_ht+0x1a5dc, %rsi
lea addresses_WT_ht+0x4718, %rdi
nop
xor $51317, %r8
mov $59, %rcx
rep movsq
xor %r10, %r10
lea addresses_A_ht+0x168d8, %rsi
lea addresses_WC_ht+0x95a8, %rdi
clflush (%rdi)
nop
nop
nop
...
nop
xor %rsi, %rsi
lea addresses_WC_ht+0x2f98, %r10
clflush (%r10)
nop
nop
nop
...
nop
and $56279, %r10
lea addresses_WC_ht+0xa0d8, %rsi
lea addresses_normal_ht+0x15fb8, %rdi
nop
nop
cmp $14069, %r10
mov $81, %rcx
...
// Store
lea addresses_normal+0x3dc, %r10
dec %rdx
movb $0x51, (%r10)
nop
nop
...
{'OP': 'REPM', 'src': {'type': 'addresses_WC_ht', 'congruent': 1, 'same': False}, 'dst': {'type': 'addresses_WT_ht', 'congruent': 6, 'same': True}}
...
{'OP': 'REPM', 'src': {'type': 'addresses_WC_ht', 'congruent': 9, 'same': False}, 'dst': {'type': 'addresses_normal_ht', 'congruent': 5, 'same': False}}
{'33': 21829}
