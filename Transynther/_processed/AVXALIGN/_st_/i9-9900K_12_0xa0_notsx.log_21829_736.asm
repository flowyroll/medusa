...
nop
and $23205, %r12
lea addresses_A_ht+0x178c6, %rsi
lea addresses_UC_ht+0xc0ce, %rdi
nop
nop
nop
nop
...
nop
add %rbx, %rbx
lea addresses_UC_ht+0x1dac6, %rsi
lea addresses_UC_ht+0x1b666, %rdi
nop
mfence
mov $84, %rcx
rep movsb
...
nop
xor %rcx, %rcx
lea addresses_UC_ht+0x3254, %rdi
nop
dec %r11
movb $0x61, (%rdi)
nop
nop
cmp %r13, %r13
lea addresses_WT_ht+0x1cac6, %rsi
lea addresses_UC_ht+0x98c6, %rdi
nop
nop
nop
nop
...
nop
add $7008, %rdx
lea addresses_WC_ht+0x10f46, %rdi
nop
nop
nop
nop
...
<gen_prepare_buffer>
{'src': {'type': 'addresses_D_ht', 'congruent': 10, 'same': False}, 'OP': 'REPM', 'dst': {'type': 'addresses_UC_ht', 'congruent': 10, 'same': False}}
