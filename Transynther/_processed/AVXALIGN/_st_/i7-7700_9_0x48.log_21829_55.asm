...
nop
xor %r9, %r9
lea addresses_normal_ht+0xbb29, %r14
nop
dec %r11
movl $0x61626364, (%r14)
nop
...
nop
inc %rbx
lea addresses_UC_ht+0x1f29, %rbp
nop
nop
nop
nop
...
nop
add %rbp, %rbp
lea addresses_UC_ht+0xec39, %rdi
nop
nop
nop
nop
...
nop
xor %r14, %r14
lea addresses_UC_ht+0x14b29, %rsi
lea addresses_WC_ht+0xbcd1, %rdi
nop
nop
nop
xor $21091, %r9
...
nop
add $57838, %rcx
lea addresses_normal_ht+0x83d9, %rsi
lea addresses_WC_ht+0x1c329, %rdi
nop
and $11869, %r14
mov $21, %rcx
rep movsq
...
{'OP': 'LOAD', 'src': {'type': 'addresses_WC', 'AVXalign': False, 'congruent': 10, 'size': 16, 'same': False, 'NT': False}}
[Faulty Load]
