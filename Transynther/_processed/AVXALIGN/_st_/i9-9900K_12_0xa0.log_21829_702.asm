...
nop
and $5008, %rcx
lea addresses_WC_ht+0x5300, %rsi
lea addresses_normal_ht+0x17900, %rdi
nop
xor $27029, %r9
mov $76, %rcx
rep movsw
...
nop
add $12479, %rcx
lea addresses_D_ht+0x1bbb8, %rsi
nop
nop
nop
xor $11985, %rbx
mov (%rsi), %r9
sub %rcx, %rcx
lea addresses_A_ht+0xd080, %rbx
nop
inc %rax
movl $0x61626364, (%rbx)
and %rdi, %rdi
lea addresses_WT_ht+0x1d500, %rsi
nop
nop
xor $65189, %rbx
mov (%rsi), %di
...
nop
and %rbx, %rbx
lea addresses_A_ht+0x1e100, %rsi
lea addresses_UC_ht+0x182c, %rdi
clflush (%rsi)
nop
nop
nop
...
nop
inc %rsi
lea addresses_WC_ht+0x106c4, %rsi
...
nop
xor %rax, %rax
lea addresses_normal_ht+0xe8a0, %rax
nop
cmp %r9, %r9
movups (%rax), %xmm0
vpextrq $0, %xmm0, %rbp
...
nop
xor %rbp, %rbp
lea addresses_WC_ht+0x1aeab, %rdi
nop
cmp $50151, %rbx
...
nop
add $12925, %rax
lea addresses_UC_ht+0x7500, %r9
nop
nop
and $10506, %rcx
movb (%r9), %bl
cmp %rbx, %rbx
lea addresses_UC_ht+0xc3b8, %rsi
nop
nop
nop
nop
...
// Store
lea addresses_normal+0x10814, %r8
nop
inc %r10
movl $0x51525354, (%r8)
nop
...
// Store
lea addresses_normal+0x16100, %rdx
nop
nop
nop
nop
...
// Faulty Load
lea addresses_normal+0x11d00, %r13
nop
nop
cmp %r9, %r9
mov (%r13), %r8w
...
{'src': {'NT': False, 'same': False, 'congruent': 4, 'type': 'addresses_NC', 'AVXalign': True, 'size': 2}, 'OP': 'LOAD'}
...
{'src': {'same': False, 'congruent': 9, 'type': 'addresses_WT_ht'}, 'OP': 'REPM', 'dst': {'same': False, 'congruent': 2, 'type': 'addresses_D_ht'}}
{'src': {'same': False, 'congruent': 9, 'type': 'addresses_WC_ht'}, 'OP': 'REPM', 'dst': {'same': False, 'congruent': 10, 'type': 'addresses_normal_ht'}}
{'src': {'NT': False, 'same': True, 'congruent': 2, 'type': 'addresses_D_ht', 'AVXalign': False, 'size': 8}, 'OP': 'LOAD'}
...
{'src': {'same': False, 'congruent': 6, 'type': 'addresses_A_ht'}, 'OP': 'REPM', 'dst': {'same': True, 'congruent': 2, 'type': 'addresses_UC_ht'}}
{'src': {'same': False, 'congruent': 1, 'type': 'addresses_WC_ht'}, 'OP': 'REPM', 'dst': {'same': False, 'congruent': 5, 'type': 'addresses_normal_ht'}}
