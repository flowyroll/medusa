...
push %rdx
push %rsi
lea addresses_WC_ht+0x1c199, %rsi
and $39203, %rbp
mov (%rsi), %r11w
nop
nop
...
nop
sub $30022, %rcx
lea addresses_UC_ht+0x11c05, %rsi
lea addresses_D_ht+0x17a05, %rdi
cmp %rdx, %rdx
mov $50, %rcx
rep movsq
nop
...
lea addresses_WC_ht+0x11845, %rdi
clflush (%rdi)
add $5621, %rbp
mov $94, %rcx
rep movsb
dec %rsi
lea addresses_A_ht+0x12a5, %rbp
inc %r15
...
nop
add $33210, %r11
lea addresses_WT_ht+0x5b95, %rsi
lea addresses_D_ht+0x1c005, %rdi
clflush (%rdi)
cmp %rbp, %rbp
mov $89, %rcx
rep movsb
...
nop
xor %rdi, %rdi
lea addresses_D_ht+0x1a605, %r11
nop
sub $47779, %rbp
movw $0x6162, (%r11)
and %rbp, %rbp
lea addresses_UC_ht+0x17c05, %r11
nop
nop
nop
nop
...
nop
and $27576, %rcx
lea addresses_A_ht+0x14a05, %rsi
...
nop
sub $29128, %rsi
lea addresses_A_ht+0x14e45, %r15
nop
nop
nop
xor %r10, %r10
...
nop
sub $11663, %rcx
lea addresses_UC_ht+0x16405, %rsi
lea addresses_normal_ht+0x3405, %rdi
nop
nop
nop
and %r15, %r15
...
nop
and %rbp, %rbp
lea addresses_WT_ht+0x1c05, %rsi
cmp %rdx, %rdx
mov (%rsi), %r15
nop
and %rcx, %rcx
lea addresses_normal_ht+0x1c085, %r11
nop
dec %rdx
...
movups %xmm1, (%r11)
xor %rdx, %rdx
lea addresses_D_ht+0xee80, %rsi
lea addresses_WC_ht+0x54a5, %rdi
nop
cmp $5202, %r11
mov $11, %rcx
rep movsq
...
nop
inc %rsi
lea addresses_WT_ht+0x12229, %rsi
lea addresses_UC_ht+0x113e5, %rdi
and %rbp, %rbp
mov $10, %rcx
rep movsl
nop
...
{'src': {'type': 'addresses_UC_ht', 'congruent': 9, 'same': False}, 'dst': {'type': 'addresses_D_ht', 'congruent': 8, 'same': False}, 'OP': 'REPM'}
{'src': {'type': 'addresses_A_ht', 'congruent': 10, 'same': False}, 'dst': {'type': 'addresses_WC_ht', 'congruent': 5, 'same': True}, 'OP': 'REPM'}
{'dst': {'type': 'addresses_A_ht', 'same': False, 'size': 32, 'congruent': 5, 'NT': False, 'AVXalign': False}, 'OP': 'STOR'}
{'src': {'type': 'addresses_WT_ht', 'congruent': 4, 'same': False}, 'dst': {'type': 'addresses_D_ht', 'congruent': 9, 'same': False}, 'OP': 'REPM'}
...
{'src': {'type': 'addresses_WT_ht', 'same': False, 'size': 8, 'congruent': 10, 'NT': True, 'AVXalign': False}, 'OP': 'LOAD'}
...
{'src': {'type': 'addresses_WT_ht', 'congruent': 2, 'same': False}, 'dst': {'type': 'addresses_UC_ht', 'congruent': 5, 'same': False}, 'OP': 'REPM'}
{'33': 21829}
