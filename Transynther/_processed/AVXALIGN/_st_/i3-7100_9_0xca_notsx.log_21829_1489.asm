...
nop
cmp %rbp, %rbp
lea addresses_WC_ht+0x11b17, %r9
nop
nop
xor %r11, %r11
movl $0x61626364, (%r9)
...
nop
cmp $49726, %rbp
lea addresses_UC_ht+0xbff3, %rdi
nop
nop
nop
xor %rsi, %rsi
...
nop
add %r9, %r9
lea addresses_normal_ht+0x294d, %r9
nop
and %r14, %r14
...
{'src': {'same': False, 'congruent': 8, 'NT': False, 'type': 'addresses_D_ht', 'size': 4, 'AVXalign': True}, 'OP': 'LOAD'}
