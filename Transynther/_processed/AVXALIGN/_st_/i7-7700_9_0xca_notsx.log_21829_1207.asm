...
nop
inc %r14
lea addresses_A_ht+0x11960, %r13
clflush (%r13)
nop
nop
nop
...
nop
sub %r14, %r14
lea addresses_A_ht+0x11320, %r12
inc %rbp
mov (%r12), %r8
nop
nop
xor %r13, %r13
lea addresses_WT_ht+0x15a60, %r13
xor %r9, %r9
movups (%r13), %xmm4
vpextrq $1, %xmm4, %r14
nop
...
nop
dec %r9
lea addresses_normal_ht+0x7840, %rsi
lea addresses_A_ht+0x14de0, %rdi
nop
add $7492, %r8
mov $119, %rcx
rep movsq
...
nop
dec %rcx
lea addresses_normal_ht+0x9db8, %r14
nop
nop
nop
add $11665, %r9
...
nop
cmp %r12, %r12
lea addresses_UC_ht+0xd298, %rsi
lea addresses_A_ht+0xd08, %rdi
and %r9, %r9
mov $119, %rcx
rep movsw
nop
...
nop
dec %r13
lea addresses_WC_ht+0x12f60, %r14
nop
nop
nop
nop
...
vpextrq $0, %xmm3, %r11
sub %r8, %r8
lea addresses_WT_ht+0x90e0, %r12
nop
nop
nop
nop
...
<gen_faulty_load>
[REF]
{'src': {'NT': True, 'AVXalign': False, 'size': 8, 'congruent': 0, 'same': False, 'type': 'addresses_WT'}, 'OP': 'LOAD'}
...
{'src': {'congruent': 3, 'same': False, 'type': 'addresses_UC_ht'}, 'dst': {'congruent': 1, 'same': False, 'type': 'addresses_A_ht'}, 'OP': 'REPM'}
{'src': {'NT': False, 'AVXalign': False, 'size': 16, 'congruent': 8, 'same': False, 'type': 'addresses_WC_ht'}, 'OP': 'LOAD'}
{'src': {'NT': False, 'AVXalign': False, 'size': 8, 'congruent': 7, 'same': True, 'type': 'addresses_WT_ht'}, 'OP': 'LOAD'}
{'39': 21829}
