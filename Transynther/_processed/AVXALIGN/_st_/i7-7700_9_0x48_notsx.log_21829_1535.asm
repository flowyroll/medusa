...
push %rdi
push %rsi
lea addresses_WT_ht+0x12280, %rsi
...
rep movsb
dec %rax
lea addresses_D_ht+0x1ac1c, %rax
nop
dec %rbp
movups (%rax), %xmm6
vpextrq $1, %xmm6, %rsi
...
nop
add %rcx, %rcx
lea addresses_normal_ht+0xbae0, %rsi
nop
nop
cmp $49440, %r14
movups (%rsi), %xmm1
vpextrq $0, %xmm1, %rcx
dec %rcx
lea addresses_A_ht+0x15440, %rsi
nop
cmp $17107, %r14
mov (%rsi), %r15
sub $60150, %rsi
lea addresses_A_ht+0xb740, %rsi
lea addresses_WC_ht+0x9be0, %rdi
nop
nop
nop
nop
...
nop
and $21920, %rbp
lea addresses_WC_ht+0x1b221, %rsi
lea addresses_WT_ht+0x1c944, %rdi
nop
nop
nop
sub %r15, %r15
...
// Load
lea addresses_normal+0x1fd20, %rdi
nop
and $17416, %rbp
vmovups (%rdi), %ymm2
...
{'dst': {'same': False, 'NT': False, 'AVXalign': True, 'size': 1, 'type': 'addresses_P', 'congruent': 1}, 'OP': 'STOR'}
...
<gen_prepare_buffer>
{'dst': {'same': False, 'congruent': 10, 'type': 'addresses_WT_ht'}, 'OP': 'REPM', 'src': {'same': False, 'congruent': 6, 'type': 'addresses_WT_ht'}}
...
{'dst': {'same': False, 'congruent': 2, 'type': 'addresses_WT_ht'}, 'OP': 'REPM', 'src': {'same': False, 'congruent': 0, 'type': 'addresses_WC_ht'}}
{'32': 21829}
