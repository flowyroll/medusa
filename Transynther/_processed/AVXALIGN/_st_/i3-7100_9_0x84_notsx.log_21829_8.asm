...
push %rdi
push %rsi
lea addresses_UC_ht+0x11541, %rdi
nop
nop
nop
cmp $56408, %rcx
...
nop
and $25147, %r10
lea addresses_WT_ht+0x7aa1, %rcx
nop
nop
xor %rsi, %rsi
mov (%rcx), %eax
...
nop
sub $11620, %r15
lea addresses_WC_ht+0x1aba1, %r15
nop
nop
nop
nop
