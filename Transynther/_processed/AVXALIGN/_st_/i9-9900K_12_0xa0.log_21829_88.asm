...
push %rdi
push %rsi
lea addresses_UC_ht+0x1c98c, %rsi
lea addresses_normal_ht+0xbd8c, %rdi
nop
nop
add $4916, %r14
mov $23, %rcx
...
nop
and $17723, %r15
lea addresses_WT_ht+0x178cc, %rsi
lea addresses_A_ht+0xa90c, %rdi
sub %r12, %r12
mov $38, %rcx
rep movsw
nop
add %r12, %r12
lea addresses_UC_ht+0x18b0c, %rcx
nop
nop
cmp $12424, %r12
mov (%rcx), %r15
...
nop
add %r14, %r14
lea addresses_normal_ht+0xcf75, %r12
nop
nop
and $43068, %r14
...
nop
and $39672, %rsi
lea addresses_D_ht+0x18b70, %rsi
lea addresses_UC_ht+0x9c8c, %rdi
nop
nop
nop
add $30682, %rbp
...
nop
sub %rdi, %rdi
lea addresses_D_ht+0x1aa2c, %rsi
lea addresses_D_ht+0x1d90c, %rdi
nop
nop
nop
nop
...
nop
dec %r15
lea addresses_UC_ht+0x18c8c, %rdi
nop
add $15728, %r9
movl $0x61626364, (%rdi)
nop
inc %r15
lea addresses_WC_ht+0x1f23, %rcx
nop
nop
nop
nop
...
nop
and %rcx, %rcx
lea addresses_UC_ht+0x1051c, %r9
clflush (%r9)
nop
nop
nop
...
{'src': {'NT': True, 'same': False, 'congruent': 4, 'type': 'addresses_UC_ht', 'AVXalign': False, 'size': 8}, 'OP': 'LOAD'}
{'OP': 'STOR', 'dst': {'NT': False, 'same': False, 'congruent': 0, 'type': 'addresses_normal_ht', 'AVXalign': False, 'size': 16}}
{'src': {'same': False, 'congruent': 2, 'type': 'addresses_D_ht'}, 'OP': 'REPM', 'dst': {'same': False, 'congruent': 11, 'type': 'addresses_UC_ht'}}
