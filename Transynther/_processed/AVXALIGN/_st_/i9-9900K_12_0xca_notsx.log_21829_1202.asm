...
nop
and %rbp, %rbp
lea addresses_UC_ht+0x12b4, %rsi
nop
nop
nop
nop
...
nop
cmp $52203, %rdx
lea addresses_WC_ht+0xcaec, %rsi
lea addresses_WT_ht+0x1108c, %rdi
nop
nop
nop
add $61922, %r11
...
nop
sub %rdx, %rdx
lea addresses_normal_ht+0x36d3, %r10
nop
nop
nop
nop
...
movb $0x61, (%r10)
xor %rsi, %rsi
lea addresses_UC_ht+0x10d2c, %rsi
nop
sub $52337, %rdx
...
nop
sub $54414, %rbp
lea addresses_D_ht+0x6d9a, %rsi
lea addresses_WT_ht+0xc67e, %rdi
nop
nop
nop
lfence
...
nop
mfence
lea addresses_D_ht+0x15fcc, %rsi
lea addresses_normal_ht+0x1972c, %rdi
nop
nop
add $44835, %r10
mov $125, %rcx
...
nop
cmp %rbp, %rbp
lea addresses_WT_ht+0xfe8c, %rsi
lea addresses_WT_ht+0x1b68c, %rdi
nop
nop
nop
and %r11, %r11
...
nop
add $16360, %r10
lea addresses_D_ht+0x1c98c, %rbp
nop
add %r9, %r9
vmovups (%rbp), %ymm6
...
// Load
lea addresses_normal+0x13ef2, %r14
nop
nop
nop
add %rbx, %rbx
...
{'OP': 'LOAD', 'src': {'same': False, 'type': 'addresses_normal', 'NT': True, 'AVXalign': False, 'size': 8, 'congruent': 1}}
[Faulty Load]
...
{'OP': 'STOR', 'dst': {'same': False, 'type': 'addresses_UC_ht', 'NT': False, 'AVXalign': True, 'size': 16, 'congruent': 4}}
{'OP': 'REPM', 'src': {'same': False, 'congruent': 1, 'type': 'addresses_D_ht'}, 'dst': {'same': False, 'congruent': 0, 'type': 'addresses_WT_ht'}}
{'OP': 'REPM', 'src': {'same': False, 'congruent': 2, 'type': 'addresses_D_ht'}, 'dst': {'same': False, 'congruent': 5, 'type': 'addresses_normal_ht'}}
{'OP': 'REPM', 'src': {'same': True, 'congruent': 10, 'type': 'addresses_WT_ht'}, 'dst': {'same': False, 'congruent': 10, 'type': 'addresses_WT_ht'}}
