...
push %rdx
push %rsi
lea addresses_UC_ht+0x1a63a, %r13
nop
nop
nop
nop
...
nop
xor $8934, %rax
lea addresses_D_ht+0x1962a, %rsi
lea addresses_WC_ht+0x9062, %rdi
nop
cmp %rax, %rax
mov $126, %rcx
rep movsq
...
nop
xor %rdi, %rdi
lea addresses_A_ht+0x1a70a, %rsi
lea addresses_WC_ht+0x12936, %rdi
nop
nop
nop
nop
...
nop
inc %rdi
lea addresses_D_ht+0x1602a, %rdx
clflush (%rdx)
nop
nop
nop
...
{'OP': 'STOR', 'dst': {'same': False, 'type': 'addresses_WC', 'NT': True, 'AVXalign': False, 'size': 2, 'congruent': 9}}
...
{'OP': 'STOR', 'dst': {'same': False, 'type': 'addresses_US', 'NT': False, 'AVXalign': False, 'size': 4, 'congruent': 0}}
...
{'OP': 'LOAD', 'src': {'same': False, 'type': 'addresses_P', 'NT': False, 'AVXalign': False, 'size': 32, 'congruent': 11}}
[Faulty Load]
...
{'OP': 'REPM', 'src': {'same': False, 'congruent': 3, 'type': 'addresses_A_ht'}, 'dst': {'same': False, 'congruent': 2, 'type': 'addresses_WC_ht'}}
