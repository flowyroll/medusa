...
// REPMOV
lea addresses_WC+0x1cbc2, %rsi
lea addresses_PSE+0x163c2, %rdi
clflush (%rsi)
nop
nop
nop
...
// Store
lea addresses_normal+0x113c2, %rdi
nop
nop
nop
nop
...
{'src': {'type': 'addresses_WC', 'congruent': 10, 'same': False}, 'dst': {'type': 'addresses_PSE', 'congruent': 0, 'same': True}, 'OP': 'REPM'}
...
<gen_prepare_buffer>
{'src': {'type': 'addresses_A_ht', 'same': False, 'size': 4, 'congruent': 10, 'NT': True, 'AVXalign': False}, 'OP': 'LOAD'}
