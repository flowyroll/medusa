...
push %rdx
push %rsi
lea addresses_WC_ht+0x16d44, %r11
nop
nop
nop
add %r8, %r8
...
nop
dec %r14
lea addresses_normal_ht+0x174e, %r10
nop
nop
nop
nop
...
nop
add $61955, %r14
lea addresses_WC_ht+0x17644, %r10
clflush (%r10)
nop
nop
nop
...
vpextrq $1, %xmm3, %r9
dec %rbx
lea addresses_WC_ht+0x54bc, %rbx
nop
nop
nop
nop
...
nop
dec %r11
lea addresses_D_ht+0x19d44, %r14
nop
nop
nop
nop
...
nop
cmp %r8, %r8
lea addresses_D_ht+0x4944, %rsi
lea addresses_A_ht+0xeb14, %rdi
nop
nop
and %r14, %r14
mov $79, %rcx
...
nop
add %rsi, %rsi
lea addresses_WC_ht+0x6d44, %rbx
nop
nop
nop
nop
...
vpextrq $0, %xmm3, %rcx
xor $36118, %rcx
lea addresses_WT_ht+0x163c4, %rcx
nop
nop
nop
nop
...
nop
sub %r10, %r10
lea addresses_WC_ht+0x10144, %r8
nop
nop
nop
nop
...
// Store
lea addresses_WT+0x18d70, %rax
cmp $3893, %r15
movl $0x51525354, (%rax)
sub $35995, %r15

// Load
lea addresses_D+0xe864, %r13
nop
xor $31127, %rax
mov (%r13), %r9d
nop
...
{'OP': 'STOR', 'dst': {'type': 'addresses_WT', 'AVXalign': False, 'congruent': 1, 'size': 4, 'same': False, 'NT': True}}
...
{'OP': 'STOR', 'dst': {'type': 'addresses_WC', 'AVXalign': False, 'congruent': 10, 'size': 4, 'same': False, 'NT': True}}
[Faulty Load]
