...
push %rdx
push %rsi
lea addresses_WC_ht+0x1a37, %rbp
nop
and $7123, %r8
movb (%rbp), %cl
nop
sub $64633, %rsi
lea addresses_A_ht+0x14176, %rbx
nop
mfence
mov (%rbx), %rbp
nop
xor %rbx, %rbx
lea addresses_UC_ht+0x15136, %rsi
lea addresses_WC_ht+0xc916, %rdi
cmp $56444, %rdx
mov $78, %rcx
rep movsq
nop
...
nop
cmp %r8, %r8
lea addresses_WC_ht+0x469e, %rsi
nop
nop
nop
cmp $31626, %r8
movb $0x61, (%rsi)
xor $17760, %r8
lea addresses_UC_ht+0x11c9e, %rbx
nop
nop
nop
nop
...
nop
add %r12, %r12
lea addresses_A_ht+0x217a, %rsi
lea addresses_UC_ht+0xc036, %rdi
nop
nop
nop
nop
...
// Faulty Load
lea addresses_normal+0xd036, %r11
dec %r15
mov (%r11), %r13w
lea oracles, %rsi
and $0xff, %r13
