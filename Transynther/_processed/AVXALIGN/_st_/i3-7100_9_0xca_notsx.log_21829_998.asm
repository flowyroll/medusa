...
push %rdi
push %rsi
lea addresses_WT_ht+0xf2af, %rbx
nop
nop
nop
nop
...
nop
sub $55209, %rbp
lea addresses_WT_ht+0x1c04f, %r8
cmp %rbx, %rbx
mov $0x6162636465666768, %r10
movq %r10, (%r8)
nop
add $13467, %rbx
lea addresses_WT_ht+0x16c77, %rsi
lea addresses_UC_ht+0x11c4f, %rdi
nop
nop
sub $38957, %r9
mov $55, %rcx
...
nop
inc %rdi
lea addresses_WT_ht+0x1614f, %rsi
...
nop
add $52685, %r10
lea addresses_WC_ht+0x1b2ff, %rsi
lea addresses_UC_ht+0x1adf7, %rdi
nop
nop
and %r9, %r9
mov $30, %rcx
...
{'src': {'type': 'addresses_WC_ht', 'congruent': 4, 'same': False}, 'OP': 'REPM', 'dst': {'type': 'addresses_UC_ht', 'congruent': 1, 'same': False}}
{'51': 21829}
