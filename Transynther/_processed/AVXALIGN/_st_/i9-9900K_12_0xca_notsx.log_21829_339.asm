...
push %rdx
push %rsi
lea addresses_D_ht+0x1e459, %rdx
nop
nop
nop
nop
...
nop
and %rbx, %rbx
lea addresses_normal_ht+0x101e1, %rdi
nop
sub $33049, %rcx
...
vmovups %ymm5, (%rdi)
xor $43146, %rbp
lea addresses_WC_ht+0x26f9, %rdx
nop
nop
and $6183, %r8
movb $0x61, (%rdx)
nop
sub %r13, %r13
lea addresses_normal_ht+0x37d9, %rsi
lea addresses_D_ht+0x1e919, %rdi
nop
nop
sub %rbx, %rbx
mov $94, %rcx
...
nop
sub %rsi, %rsi
lea addresses_normal_ht+0xce59, %rcx
nop
cmp $2614, %rbx
movl $0x61626364, (%rcx)
nop
...
nop
inc %rdi
lea addresses_WT_ht+0x18db9, %rdx
add $37813, %rdi
movl $0x61626364, (%rdx)
and $38978, %r13
pop %rsi
...
// REPMOV
lea addresses_A+0x187d9, %rsi
lea addresses_normal+0xd759, %rdi
nop
nop
nop
nop
...
{'OP': 'REPM', 'src': {'same': False, 'congruent': 7, 'type': 'addresses_A'}, 'dst': {'same': False, 'congruent': 8, 'type': 'addresses_normal'}}
...
{'OP': 'REPM', 'src': {'same': False, 'congruent': 7, 'type': 'addresses_normal_ht'}, 'dst': {'same': False, 'congruent': 6, 'type': 'addresses_D_ht'}}
