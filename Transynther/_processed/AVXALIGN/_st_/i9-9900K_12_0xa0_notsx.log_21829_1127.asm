...
push %rdi
push %rsi
lea addresses_normal_ht+0xc861, %rsi
lea addresses_WT_ht+0xd7c1, %rdi
nop
nop
sub %r11, %r11
mov $70, %rcx
...
nop
xor $58683, %r11
lea addresses_UC_ht+0x1641c, %r11
nop
nop
nop
add %r14, %r14
...
nop
cmp $54076, %rsi
lea addresses_UC_ht+0x1c79, %rsi
lfence
movb (%rsi), %al
nop
sub %r11, %r11
lea addresses_WT_ht+0x9461, %rcx
xor %rsi, %rsi
vmovups (%rcx), %ymm3
...
nop
add %r13, %r13
lea addresses_WC_ht+0x1e861, %rdi
nop
nop
nop
nop
...
<gen_prepare_buffer>
{'src': {'type': 'addresses_normal_ht', 'congruent': 9, 'same': False}, 'OP': 'REPM', 'dst': {'type': 'addresses_WT_ht', 'congruent': 5, 'same': True}}
...
{'OP': 'STOR', 'dst': {'type': 'addresses_WC_ht', 'AVXalign': False, 'size': 16, 'NT': True, 'same': False, 'congruent': 6}}
{'32': 21829}
