...
push %rdx
push %rsi
lea addresses_WT_ht+0x8a79, %r14
nop
nop
nop
nop
...
nop
add %rdx, %rdx
lea addresses_UC_ht+0x2961, %rbx
nop
nop
dec %r9
vmovups (%rbx), %ymm7
...
nop
cmp $20643, %rbp
lea addresses_WT_ht+0xac41, %r12
nop
add %r14, %r14
...
nop
and $28395, %rbx
lea addresses_A_ht+0x17f15, %rdx
nop
nop
nop
nop
...
nop
cmp %r9, %r9
lea addresses_normal_ht+0x1356e, %rsi
lea addresses_WT_ht+0x13341, %rdi
nop
dec %rbx
mov $4, %rcx
rep movsq
...
nop
dec %r12
lea addresses_WC_ht+0x14c41, %rsi
lea addresses_WT_ht+0x19c41, %rdi
sub %rbp, %rbp
mov $0, %rcx
rep movsq
nop
...
nop
xor %r9, %r9
lea addresses_normal_ht+0x12671, %rsi
lea addresses_UC_ht+0xbfc1, %rdi
nop
nop
inc %rbx
mov $18, %rcx
