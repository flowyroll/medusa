...
nop
sub %r14, %r14
lea addresses_WT_ht+0x100e0, %rbx
clflush (%rbx)
nop
add $29993, %rdx
...
movq %r13, (%rbx)
cmp %r14, %r14
lea addresses_WT_ht+0xf4a0, %r13
nop
nop
nop
cmp $57669, %rdi
...
nop
add %rbx, %rbx
lea addresses_WC_ht+0x9c60, %rsi
nop
nop
nop
nop
...
nop
sub $35310, %r13
lea addresses_WC_ht+0x1ba70, %rdi
nop
nop
nop
nop
...
nop
add $41653, %rsi
lea addresses_UC_ht+0x8ae0, %rdi
nop
nop
and $2717, %rsi
mov (%rdi), %r14d
...
nop
cmp $47020, %rbx
lea addresses_WC_ht+0x12653, %rsi
lea addresses_D_ht+0x78a0, %rdi
clflush (%rsi)
cmp %r9, %r9
mov $57, %rcx
rep movsw
sub $51766, %rdi
lea addresses_A_ht+0x8d5c, %rsi
lea addresses_A_ht+0x16ce0, %rdi
nop
nop
nop
dec %rdx
...
nop
and $10881, %r13
lea addresses_normal_ht+0x14ce0, %r13
inc %rbx
mov (%r13), %ecx
nop
nop
sub %rcx, %rcx
lea addresses_normal_ht+0x74e0, %rcx
xor $13288, %rsi
movb $0x61, (%rcx)
xor $40560, %r9
lea addresses_normal_ht+0x6ae, %r13
nop
nop
nop
nop
...
nop
sub %rsi, %rsi
lea addresses_D_ht+0x142e0, %rsi
lea addresses_normal_ht+0x13c04, %rdi
nop
nop
nop
nop
...
rep movsw
sub %r13, %r13
lea addresses_WC_ht+0x1aaf9, %rdx
nop
nop
nop
nop
...
{'src': {'NT': False, 'AVXalign': True, 'size': 4, 'congruent': 7, 'same': False, 'type': 'addresses_UC_ht'}, 'OP': 'LOAD'}
{'src': {'congruent': 0, 'same': False, 'type': 'addresses_WC_ht'}, 'dst': {'congruent': 6, 'same': False, 'type': 'addresses_D_ht'}, 'OP': 'REPM'}
{'src': {'congruent': 0, 'same': False, 'type': 'addresses_A_ht'}, 'dst': {'congruent': 11, 'same': False, 'type': 'addresses_A_ht'}, 'OP': 'REPM'}
