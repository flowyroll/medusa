...
push %rdi
push %rsi
lea addresses_UC_ht+0xa0c1, %r11
nop
nop
cmp %r9, %r9
...
nop
add $38757, %rsi
lea addresses_normal_ht+0x1c849, %r13
clflush (%r13)
nop
nop
nop
...
nop
xor %r11, %r11
lea addresses_WC_ht+0x7c49, %rsi
lea addresses_WT_ht+0x7b49, %rdi
nop
nop
nop
nop
...
nop
sub $7476, %r9
lea addresses_WT_ht+0x8a09, %rcx
nop
nop
nop
nop
...
nop
and $38373, %r9
lea addresses_D_ht+0x1b149, %r13
nop
nop
cmp $12991, %r11
...
{'src': {'type': 'addresses_WC_ht', 'congruent': 4, 'same': False}, 'dst': {'type': 'addresses_WT_ht', 'congruent': 9, 'same': False}, 'OP': 'REPM'}
