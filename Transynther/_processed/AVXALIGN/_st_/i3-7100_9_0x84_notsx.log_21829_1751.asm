...
push %rdx
push %rsi
lea addresses_D_ht+0x975d, %rsi
lea addresses_WT_ht+0xe35d, %rdi
nop
cmp %rbx, %rbx
mov $25, %rcx
rep movsl
...
nop
inc %rsi
lea addresses_D_ht+0x1835d, %rdx
nop
nop
nop
nop
...
nop
xor %rcx, %rcx
lea addresses_D_ht+0x1c3ee, %rsi
...
nop
sub %rsi, %rsi
lea addresses_WT_ht+0x4c73, %rsi
lea addresses_D_ht+0x1435d, %rdi
clflush (%rdi)
and $11580, %r10
mov $6, %rcx
rep movsq
...
{'src': {'type': 'addresses_WT_ht', 'congruent': 1, 'same': False}, 'dst': {'type': 'addresses_D_ht', 'congruent': 9, 'same': False}, 'OP': 'REPM'}
{'32': 21829}
