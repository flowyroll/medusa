...
push %rdi
push %rsi
lea addresses_D_ht+0x13016, %rdi
nop
nop
nop
nop
...
nop
dec %r12
lea addresses_UC_ht+0x13b3e, %r11
nop
nop
nop
nop
...
nop
cmp %rcx, %rcx
lea addresses_normal_ht+0x156fe, %rdi
nop
nop
nop
cmp %rbx, %rbx
...
nop
cmp $53583, %r9
lea addresses_WC_ht+0x1ce1e, %r11
nop
nop
nop
nop
...
nop
cmp $65308, %r9
lea addresses_A_ht+0x6e30, %rsi
lea addresses_A_ht+0x8c1e, %rdi
clflush (%rdi)
nop
nop
nop
...
{'OP': 'LOAD', 'src': {'same': False, 'type': 'addresses_WC', 'NT': True, 'AVXalign': False, 'size': 8, 'congruent': 6}}
...
{'OP': 'REPM', 'src': {'same': False, 'congruent': 0, 'type': 'addresses_A_ht'}, 'dst': {'same': True, 'congruent': 4, 'type': 'addresses_A_ht'}}
{'39': 21829}
