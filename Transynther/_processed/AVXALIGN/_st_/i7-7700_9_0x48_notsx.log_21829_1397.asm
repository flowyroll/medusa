...
push %rdi
push %rsi
lea addresses_A_ht+0x17cd5, %r15
clflush (%r15)
nop
nop
sub %r10, %r10
...
nop
and %rbp, %rbp
lea addresses_normal_ht+0x3ac1, %r12
nop
nop
nop
add %r14, %r14
...
nop
cmp %r11, %r11
lea addresses_UC_ht+0x166c1, %rsi
lea addresses_A_ht+0x136c1, %rdi
nop
nop
nop
xor $7587, %rax
...
nop
dec %rbp
lea addresses_normal_ht+0x16741, %rsi
lea addresses_WC_ht+0x152c1, %rdi
clflush (%rsi)
clflush (%rdi)
nop
nop
...
{'dst': {'same': False, 'congruent': 9, 'type': 'addresses_WC_ht'}, 'OP': 'REPM', 'src': {'same': False, 'congruent': 7, 'type': 'addresses_normal_ht'}}
{'36': 21829}
