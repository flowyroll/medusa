...
push %rdi
push %rsi
lea addresses_UC_ht+0x6ef9, %r15
nop
nop
nop
nop
...
vpextrq $1, %xmm6, %rax
sub %r14, %r14
lea addresses_normal_ht+0x14899, %rsi
lea addresses_D_ht+0x4619, %rdi
nop
nop
dec %rbx
mov $57, %rcx
...
nop
inc %rdi
lea addresses_D_ht+0x1e549, %rsi
lea addresses_D_ht+0x899, %rdi
nop
nop
nop
nop
...
nop
dec %rbx
lea addresses_UC_ht+0x12a99, %r15
nop
cmp $30575, %r14
movb $0x61, (%r15)
inc %rsi
lea addresses_WC_ht+0x9ea9, %rcx
nop
cmp $58026, %rbx
...
[Faulty Load]
{'OP': 'LOAD', 'src': {'same': True, 'type': 'addresses_A', 'NT': True, 'AVXalign': True, 'size': 4, 'congruent': 0}}
<gen_prepare_buffer>
