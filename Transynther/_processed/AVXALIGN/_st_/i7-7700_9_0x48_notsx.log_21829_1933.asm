...
push %rdi
push %rsi
lea addresses_normal_ht+0x1aab, %rbx
nop
nop
nop
xor $36731, %rcx
...
nop
sub %r12, %r12
lea addresses_D_ht+0x10049, %r10
nop
nop
nop
nop
...
nop
and $16958, %r12
lea addresses_WT_ht+0x7361, %rsi
lea addresses_WT_ht+0xc97, %rdi
nop
nop
nop
nop
...
nop
sub $53806, %r14
lea addresses_normal_ht+0xaff9, %r14
nop
nop
nop
nop
...
nop
add $24023, %r14
lea addresses_normal_ht+0x44f9, %rsi
...
nop
and $9047, %rdi
lea addresses_UC_ht+0xdf9, %rsi
lea addresses_normal_ht+0x17679, %rdi
nop
nop
nop
and %r10, %r10
...
nop
cmp $15874, %r14
lea addresses_normal_ht+0x169f9, %r13
add %r10, %r10
movb $0x61, (%r13)
nop
nop
...
nop
and $63447, %rbx
lea addresses_WT_ht+0x13b9, %r10
nop
nop
nop
sub $11980, %rcx
...
nop
cmp $50288, %r12
lea addresses_WC_ht+0x51f9, %rdi
nop
nop
cmp %r12, %r12
movw $0x6162, (%rdi)
...
// Faulty Load
lea addresses_normal+0x55f9, %r11
nop
nop
nop
cmp $22532, %r15
...
{'OP': 'LOAD', 'src': {'same': False, 'NT': True, 'AVXalign': False, 'size': 8, 'type': 'addresses_D_ht', 'congruent': 2}}
{'dst': {'same': False, 'NT': False, 'AVXalign': False, 'size': 2, 'type': 'addresses_D_ht', 'congruent': 11}, 'OP': 'STOR'}
{'dst': {'same': False, 'congruent': 3, 'type': 'addresses_WC_ht'}, 'OP': 'REPM', 'src': {'same': False, 'congruent': 8, 'type': 'addresses_normal_ht'}}
{'dst': {'same': True, 'congruent': 7, 'type': 'addresses_normal_ht'}, 'OP': 'REPM', 'src': {'same': False, 'congruent': 10, 'type': 'addresses_UC_ht'}}
