...
push %rdi
push %rsi
lea addresses_A_ht+0x1a734, %rbp
nop
nop
nop
nop
...
vmovups %ymm4, (%rbp)
add %rdi, %rdi
lea addresses_UC_ht+0x77b4, %rbx
nop
nop
nop
nop
...
nop
lfence
lea addresses_WT_ht+0x1a7b4, %r13
nop
sub %r10, %r10
movb (%r13), %r12b
nop
...
lea addresses_D_ht+0x1b148, %rdi
inc %r13
mov $66, %rcx
rep movsl
nop
add %rsi, %rsi
lea addresses_UC_ht+0xabd4, %r12
nop
xor %rdi, %rdi
movups (%r12), %xmm7
vpextrq $0, %xmm7, %rcx
...
nop
dec %rdi
lea addresses_UC_ht+0x5834, %rbx
nop
nop
nop
add $63923, %r13
...
[Faulty Load]
{'OP': 'LOAD', 'src': {'type': 'addresses_D', 'AVXalign': True, 'congruent': 0, 'size': 1, 'same': True, 'NT': True}}
<gen_prepare_buffer>
