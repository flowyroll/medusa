...
nop
dec %rcx
lea addresses_UC_ht+0xf248, %r11
nop
inc %rax
movb (%r11), %cl
nop
...
nop
mfence
lea addresses_normal_ht+0x6a08, %rdi
nop
nop
nop
xor $58685, %r11
...
nop
and %rbx, %rbx
lea addresses_UC_ht+0x11c08, %r9
nop
nop
nop
nop
...
nop
cmp $17627, %r13
lea addresses_normal_ht+0x1c95c, %rbx
nop
nop
nop
nop
...
mov (%rbx), %r9d
add $55999, %rcx
lea addresses_A_ht+0x1ad90, %rsi
...
rep movsw
sub $9441, %rdi
lea addresses_WT_ht+0x1c4f8, %rsi
lea addresses_UC_ht+0x10908, %rdi
nop
lfence
mov $51, %rcx
rep movsb
nop
cmp %r13, %r13
lea addresses_WT_ht+0x608, %rbx
dec %rdi
movl $0x61626364, (%rbx)
nop
sub %rbx, %rbx
lea addresses_WC_ht+0x6808, %r9
nop
nop
cmp %rax, %rax
mov (%r9), %r13d
nop
dec %rsi
lea addresses_A_ht+0x1e6c6, %r13
nop
nop
nop
and %rbx, %rbx
...
{'OP': 'STOR', 'dst': {'type': 'addresses_WT_ht', 'size': 4, 'AVXalign': False, 'NT': True, 'congruent': 10, 'same': True}}
