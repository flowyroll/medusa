...
nop
inc %rbp
lea addresses_normal_ht+0x4a1, %r8
nop
nop
and $13467, %rbx
...
lea addresses_WT_ht+0x50e9, %rdi
nop
nop
nop
nop
...
nop
dec %rbp
lea addresses_WT_ht+0x7c11, %rsi
nop
nop
nop
nop
...
nop
cmp $33806, %r13
lea addresses_normal_ht+0x124a1, %rcx
nop
nop
sub $16677, %r8
movl $0x61626364, (%rcx)
