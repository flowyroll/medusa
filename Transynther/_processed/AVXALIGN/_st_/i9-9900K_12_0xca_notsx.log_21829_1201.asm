...
nop
xor $26294, %r14
lea addresses_WT_ht+0x15496, %r10
nop
nop
nop
add $3427, %r15
...
nop
sub %r10, %r10
lea addresses_A_ht+0xfbd3, %rsi
lea addresses_normal_ht+0x16546, %rdi
nop
nop
nop
nop
...
nop
cmp $1433, %rcx
lea addresses_UC_ht+0x1bc02, %r14
nop
nop
sub $50342, %r15
movl $0x61626364, (%r14)
...
nop
cmp %r11, %r11
lea addresses_WC_ht+0x16f86, %r15
nop
nop
inc %r10
...
nop
and $55350, %rsi
lea addresses_WT_ht+0x11496, %rsi
lea addresses_WC_ht+0x18586, %rdi
nop
inc %r10
mov $31, %rcx
rep movsw
...
nop
and $54616, %r14
lea addresses_WC_ht+0x1ca7e, %rsi
lea addresses_normal_ht+0x1b0a6, %rdi
nop
nop
nop
sub %rbx, %rbx
...
{'OP': 'REPM', 'src': {'same': False, 'congruent': 0, 'type': 'addresses_A_ht'}, 'dst': {'same': False, 'congruent': 6, 'type': 'addresses_normal_ht'}}
...
{'OP': 'REPM', 'src': {'same': False, 'congruent': 4, 'type': 'addresses_WT_ht'}, 'dst': {'same': False, 'congruent': 9, 'type': 'addresses_WC_ht'}}
{'OP': 'REPM', 'src': {'same': False, 'congruent': 3, 'type': 'addresses_WC_ht'}, 'dst': {'same': False, 'congruent': 5, 'type': 'addresses_normal_ht'}}
{'39': 21829}
