...
push %rdi
push %rsi
lea addresses_A_ht+0xd290, %rsi
lea addresses_WC_ht+0x1ebd4, %rdi
clflush (%rsi)
nop
sub %r12, %r12
mov $5, %rcx
...
nop
sub %r12, %r12
lea addresses_D_ht+0x15254, %rsi
lea addresses_D_ht+0xc774, %rdi
clflush (%rsi)
clflush (%rdi)
nop
dec %rax
...
nop
sub $41402, %rax
lea addresses_WT_ht+0xf0d4, %rsi
lea addresses_WC_ht+0xd7d4, %rdi
clflush (%rsi)
nop
nop
sub %r10, %r10
...
nop
and %rsi, %rsi
lea addresses_WT_ht+0xdd4, %rsi
lea addresses_A_ht+0x640c, %rdi
nop
nop
nop
nop
...
nop
sub %rax, %rax
lea addresses_UC_ht+0x1d6cc, %rsi
nop
cmp $20013, %rax
...
nop
cmp %rax, %rax
lea addresses_UC_ht+0x1e114, %rax
dec %r15
movb $0x61, (%rax)
nop
nop
...
{'OP': 'REPM', 'src': {'type': 'addresses_WT_ht', 'congruent': 9, 'same': False}, 'dst': {'type': 'addresses_A_ht', 'congruent': 0, 'same': False}}
