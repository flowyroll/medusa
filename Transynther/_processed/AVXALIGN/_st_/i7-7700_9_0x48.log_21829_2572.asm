...
vmovups %ymm7, (%r13)
cmp $25891, %r13
lea addresses_normal_ht+0x1592e, %rdx
clflush (%rdx)
nop
nop
nop
...
nop
and $33348, %r13
lea addresses_normal_ht+0xfe5e, %rsi
lea addresses_WT_ht+0x195e, %rdi
xor %r11, %r11
mov $14, %rcx
rep movsw
nop
...
// Store
lea addresses_normal+0x717e, %rcx
nop
nop
nop
dec %r9
