...
nop
and $40405, %r9
lea addresses_normal_ht+0x9312, %r9
add %r10, %r10
movb (%r9), %al
cmp $62436, %r10
lea addresses_D_ht+0x3dbf, %r10
nop
nop
sub %rsi, %rsi
mov (%r10), %rax
nop
sub %rax, %rax
lea addresses_normal_ht+0x2d68, %rcx
nop
nop
nop
nop
...
nop
xor $30827, %rax
lea addresses_WC_ht+0x16c48, %r9
nop
nop
nop
nop
...
movups %xmm7, (%r9)
and $20028, %rcx
lea addresses_UC_ht+0x130b8, %r9
cmp $29972, %r10
movl $0x61626364, (%r9)
xor %rdi, %rdi
lea addresses_normal_ht+0x10844, %r13
nop
xor %rdi, %rdi
movb $0x61, (%r13)
nop
...
// REPMOV
lea addresses_RW+0xa108, %rsi
lea addresses_WC+0x1c548, %rdi
nop
nop
nop
nop
