...
push %rdi
push %rsi
lea addresses_normal_ht+0x17200, %rsi
lea addresses_WT_ht+0x1400, %rdi
nop
nop
nop
nop
...
nop
cmp %r14, %r14
lea addresses_normal_ht+0x8284, %rsi
lea addresses_normal_ht+0xec00, %rdi
nop
xor %r10, %r10
mov $121, %rcx
rep movsq
...
nop
sub $16487, %r10
lea addresses_A_ht+0x1cc00, %r14
nop
nop
add %rsi, %rsi
mov (%r14), %rdi
...
nop
dec %rcx
lea addresses_WT_ht+0xea00, %r14
nop
nop
nop
and %r15, %r15
...
nop
xor %r14, %r14
lea addresses_normal_ht+0x9560, %rsi
lea addresses_WT_ht+0x9000, %rdi
nop
nop
nop
xor %r14, %r14
...
nop
and $58927, %r10
lea addresses_WC_ht+0xf000, %rcx
nop
nop
nop
sub %rsi, %rsi
...
nop
sub $11941, %rcx
lea addresses_A_ht+0xf028, %rsi
lea addresses_A_ht+0x1d680, %rdi
nop
cmp $33425, %r10
mov $114, %rcx
rep movsb
