...
push %rdi
push %rsi
lea addresses_UC_ht+0x2167, %rsi
lea addresses_UC_ht+0x17f57, %rdi
nop
nop
nop
nop
...
nop
sub $62010, %rax
lea addresses_WT_ht+0x100d7, %rcx
inc %r15
movups (%rcx), %xmm0
vpextrq $0, %xmm0, %rax
nop
...
nop
add %rax, %rax
lea addresses_D_ht+0x14f57, %r10
nop
nop
nop
xor $46721, %r8
...
nop
xor $32188, %r8
lea addresses_UC_ht+0x4f57, %r10
nop
nop
nop
xor %r15, %r15
...
nop
and $51609, %r15
lea addresses_WT_ht+0xbf47, %rsi
nop
nop
cmp %rcx, %rcx
...
nop
cmp %r15, %r15
lea addresses_WC_ht+0x20c7, %rax
nop
nop
nop
nop
...
nop
and %r15, %r15
lea addresses_WC_ht+0x14e07, %r15
nop
nop
nop
nop
...
movb $0x61, (%r15)
xor %r15, %r15
lea addresses_WT_ht+0xc097, %rax
nop
inc %rcx
movups (%rax), %xmm3
vpextrq $0, %xmm3, %r8
...
nop
sub $59820, %rcx
lea addresses_A_ht+0x47b, %rsi
lea addresses_WT_ht+0x1dcfc, %rdi
nop
nop
add %r12, %r12
mov $47, %rcx
rep movsl
add $34286, %rax
lea addresses_normal_ht+0x13577, %r8
nop
dec %r10
...
<gen_prepare_buffer>
{'src': {'type': 'addresses_UC_ht', 'congruent': 1, 'same': True}, 'OP': 'REPM', 'dst': {'type': 'addresses_UC_ht', 'congruent': 9, 'same': False}}
{'src': {'type': 'addresses_WT_ht', 'AVXalign': False, 'size': 16, 'NT': False, 'same': False, 'congruent': 6}, 'OP': 'LOAD'}
{'src': {'type': 'addresses_D_ht', 'AVXalign': False, 'size': 16, 'NT': False, 'same': True, 'congruent': 11}, 'OP': 'LOAD'}
...
{'OP': 'STOR', 'dst': {'type': 'addresses_WC_ht', 'AVXalign': False, 'size': 1, 'NT': True, 'same': False, 'congruent': 4}}
{'src': {'type': 'addresses_WT_ht', 'AVXalign': False, 'size': 16, 'NT': False, 'same': False, 'congruent': 5}, 'OP': 'LOAD'}
{'src': {'type': 'addresses_A_ht', 'congruent': 2, 'same': False}, 'OP': 'REPM', 'dst': {'type': 'addresses_WT_ht', 'congruent': 0, 'same': False}}
