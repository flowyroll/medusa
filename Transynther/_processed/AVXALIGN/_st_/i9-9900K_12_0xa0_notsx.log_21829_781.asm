...
nop
xor %r11, %r11
lea addresses_WC_ht+0x5010, %r13
nop
cmp $9079, %r10
movw $0x6162, (%r13)
xor %r9, %r9
lea addresses_A_ht+0x14110, %rsi
lea addresses_normal_ht+0x12910, %rdi
and %r10, %r10
mov $121, %rcx
rep movsq
nop
...
nop
xor %r15, %r15
lea addresses_WT_ht+0x5870, %rcx
nop
nop
and %r11, %r11
movb (%rcx), %r12b
...
nop
xor %r10, %r10
lea addresses_normal_ht+0x18530, %rsi
lea addresses_UC_ht+0xb110, %rdi
nop
nop
inc %r12
mov $28, %rcx
...
{'src': {'type': 'addresses_A_ht', 'congruent': 9, 'same': False}, 'OP': 'REPM', 'dst': {'type': 'addresses_normal_ht', 'congruent': 7, 'same': False}}
