...
push %rdi
push %rsi
lea addresses_normal_ht+0xb393, %r9
nop
cmp $29990, %rbp
mov (%r9), %r15
nop
...
nop
dec %r15
lea addresses_WT_ht+0x3003, %r14
nop
add $5663, %rbp
movw $0x6162, (%r14)
nop
...
nop
inc %rbp
lea addresses_UC_ht+0x1ebe3, %rdi
clflush (%rdi)
nop
xor %rsi, %rsi
...
movups %xmm1, (%rdi)
sub %rbp, %rbp
lea addresses_UC_ht+0x146a3, %rsi
nop
nop
nop
cmp $9043, %r10
movb $0x61, (%rsi)
xor $462, %r10
lea addresses_A_ht+0x1a527, %rsi
...
nop
cmp $57372, %r10
lea addresses_WC_ht+0x1df23, %rcx
nop
sub %r15, %r15
...
nop
sub %rdi, %rdi
lea addresses_UC_ht+0xf663, %rsi
lea addresses_UC_ht+0x923, %rdi
nop
nop
nop
sub %r9, %r9
...
nop
mfence
lea addresses_normal_ht+0x3123, %rsi
nop
cmp $33458, %r14
movw $0x6162, (%rsi)
nop
nop
and $5464, %rsi
lea addresses_WC_ht+0xa36d, %r14
nop
nop
and %r9, %r9
mov $0x6162636465666768, %rbp
...
vmovups %ymm3, (%r14)
sub $46855, %rcx
lea addresses_WT_ht+0x3be3, %r14
nop
nop
nop
nop
...
// Faulty Load
lea addresses_normal+0x15123, %r11
nop
nop
nop
nop
