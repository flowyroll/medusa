...
nop
sub %rcx, %rcx
lea addresses_WT_ht+0x145e3, %r12
nop
nop
nop
and $14132, %r14
movb (%r12), %r10b
xor $157, %rsi
lea addresses_WT_ht+0x83d3, %r12
clflush (%r12)
nop
nop
nop
...
nop
cmp $17943, %r13
lea addresses_normal_ht+0x1427b, %rsi
lea addresses_D_ht+0xe863, %rdi
add $6919, %r8
mov $100, %rcx
rep movsl
nop
nop
sub %rdi, %rdi
lea addresses_WT_ht+0x15163, %rsi
...
nop
cmp %rsi, %rsi
lea addresses_WC_ht+0x5247, %rdi
dec %r14
...
// REPMOV
lea addresses_UC+0xfa63, %rsi
lea addresses_PSE+0xc263, %rdi
nop
inc %rdx
mov $86, %rcx
rep movsb
...
{'src': {'type': 'addresses_UC', 'congruent': 5, 'same': False}, 'dst': {'type': 'addresses_PSE', 'congruent': 7, 'same': False}, 'OP': 'REPM'}
{'src': {'type': 'addresses_A', 'same': False, 'size': 2, 'congruent': 4, 'NT': False, 'AVXalign': True}, 'OP': 'LOAD'}
[Faulty Load]
...
{'src': {'type': 'addresses_WT_ht', 'same': True, 'size': 1, 'congruent': 7, 'NT': True, 'AVXalign': False}, 'OP': 'LOAD'}
