...
push %rdi
push %rsi
lea addresses_normal_ht+0x15c96, %rsi
nop
nop
add %rbx, %rbx
...
nop
sub $16319, %r11
lea addresses_UC_ht+0xc00c, %r13
clflush (%r13)
and %r14, %r14
movw $0x6162, (%r13)
nop
...
nop
xor $17645, %rsi
lea addresses_UC_ht+0x1177e, %r13
nop
nop
nop
nop
...
// Store
lea addresses_normal+0x197fe, %r14
nop
nop
nop
nop
...
// Faulty Load
lea addresses_normal+0x1ffe, %r11
clflush (%r11)
nop
nop
nop
...
{'src': {'same': False, 'congruent': 2, 'NT': False, 'type': 'addresses_PSE', 'size': 2, 'AVXalign': False}, 'OP': 'LOAD'}
{'OP': 'STOR', 'dst': {'same': False, 'congruent': 11, 'NT': True, 'type': 'addresses_normal', 'size': 4, 'AVXalign': False}}
...
[Faulty Load]
{'src': {'same': True, 'congruent': 0, 'NT': True, 'type': 'addresses_normal', 'size': 8, 'AVXalign': True}, 'OP': 'LOAD'}
<gen_prepare_buffer>
