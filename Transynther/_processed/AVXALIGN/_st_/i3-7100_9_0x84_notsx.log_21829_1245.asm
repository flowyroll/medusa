...
push %rdi
push %rsi
lea addresses_UC_ht+0xdfe, %rsi
lea addresses_UC_ht+0x10e7e, %rdi
clflush (%rdi)
nop
nop
nop
...
movups %xmm6, (%rbx)
add $38795, %r15
lea addresses_normal_ht+0x11f7e, %r15
nop
add %r12, %r12
movb (%r15), %bl
nop
...
nop
sub %rsi, %rsi
lea addresses_WT_ht+0x73fe, %rsi
lea addresses_WT_ht+0x5dfe, %rdi
nop
nop
nop
and $13079, %r11
...
nop
and %rbx, %rbx
lea addresses_normal_ht+0x1d1fe, %rdi
nop
nop
and $1145, %r15
movups (%rdi), %xmm4
...
nop
sub $17574, %r15
lea addresses_normal_ht+0x4bae, %r11
nop
nop
nop
nop
...
nop
xor %rcx, %rcx
lea addresses_normal_ht+0xc5fe, %rbx
clflush (%rbx)
nop
nop
nop
...
// Store
lea addresses_normal+0x1e5fe, %rsi
nop
nop
and %r14, %r14
movl $0x51525354, (%rsi)
...
// REPMOV
lea addresses_A+0x129fe, %rsi
lea addresses_WT+0x13dfe, %rdi
nop
nop
nop
cmp %r12, %r12
...
{'dst': {'type': 'addresses_normal', 'same': False, 'size': 4, 'congruent': 9, 'NT': True, 'AVXalign': False}, 'OP': 'STOR'}
{'dst': {'type': 'addresses_PSE', 'same': False, 'size': 4, 'congruent': 5, 'NT': False, 'AVXalign': False}, 'OP': 'STOR'}
{'src': {'type': 'addresses_A', 'congruent': 9, 'same': False}, 'dst': {'type': 'addresses_WT', 'congruent': 11, 'same': False}, 'OP': 'REPM'}
[Faulty Load]
{'src': {'type': 'addresses_A', 'same': True, 'size': 1, 'congruent': 0, 'NT': True, 'AVXalign': False}, 'OP': 'LOAD'}
<gen_prepare_buffer>
{'src': {'type': 'addresses_UC_ht', 'congruent': 7, 'same': False}, 'dst': {'type': 'addresses_UC_ht', 'congruent': 7, 'same': False}, 'OP': 'REPM'}
...
{'src': {'type': 'addresses_WT_ht', 'congruent': 8, 'same': False}, 'dst': {'type': 'addresses_WT_ht', 'congruent': 11, 'same': False}, 'OP': 'REPM'}
