...
push %rdi
push %rsi
lea addresses_WT_ht+0x12e41, %rcx
nop
and $22921, %rbx
mov (%rcx), %esi
nop
nop
inc %r11
lea addresses_D_ht+0x2d41, %rsi
lea addresses_normal_ht+0x11781, %rdi
clflush (%rsi)
nop
add $44461, %r10
mov $109, %rcx
...
lea addresses_UC_ht+0x11855, %rdi
dec %r8
mov $108, %rcx
rep movsb
nop
...
nop
sub $11324, %rsi
lea addresses_A_ht+0x1e001, %r10
nop
nop
inc %rdi
...
{'OP': 'STOR', 'dst': {'size': 8, 'NT': True, 'type': 'addresses_PSE', 'same': False, 'AVXalign': False, 'congruent': 8}}
[Faulty Load]
...
{'OP': 'REPM', 'src': {'same': False, 'type': 'addresses_A_ht', 'congruent': 6}, 'dst': {'same': False, 'type': 'addresses_UC_ht', 'congruent': 1}}
