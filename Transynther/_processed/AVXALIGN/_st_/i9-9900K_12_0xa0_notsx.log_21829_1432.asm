...
push %rdi
push %rsi
lea addresses_WT_ht+0x884c, %rsi
lea addresses_A_ht+0x1914c, %rdi
clflush (%rsi)
clflush (%rdi)
nop
nop
...
nop
and $6717, %r8
lea addresses_UC_ht+0xaa9c, %r14
nop
nop
cmp $42645, %r15
...
nop
cmp $42089, %rsi
lea addresses_A_ht+0xb8e4, %rdi
cmp %r12, %r12
mov (%rdi), %r8w
nop
nop
dec %r15
lea addresses_normal_ht+0xcd4c, %r12
clflush (%r12)
nop
nop
nop
...
nop
sub %rdi, %rdi
lea addresses_WT_ht+0xa44c, %rdi
nop
nop
nop
nop
...
nop
and %rcx, %rcx
lea addresses_normal_ht+0x38d0, %r14
and %r15, %r15
...
nop
sub %r12, %r12
lea addresses_UC_ht+0x15e4c, %rsi
lea addresses_D_ht+0x1d84c, %rdi
nop
nop
nop
nop
...
// REPMOV
lea addresses_UC+0x7ad4, %rsi
lea addresses_normal+0x19e0c, %rdi
nop
nop
nop
nop
...
{'src': {'type': 'addresses_UC', 'AVXalign': True, 'size': 16, 'NT': False, 'same': False, 'congruent': 3}, 'OP': 'LOAD'}
