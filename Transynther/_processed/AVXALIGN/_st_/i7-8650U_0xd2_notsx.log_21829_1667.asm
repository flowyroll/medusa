...
push %rdx
push %rsi
lea addresses_D_ht+0xf3d9, %rsi
lea addresses_A_ht+0xc299, %rdi
nop
nop
xor %r11, %r11
mov $78, %rcx
...
nop
add $7442, %rcx
lea addresses_A_ht+0x174a1, %rdi
inc %rcx
movups (%rdi), %xmm3
vpextrq $0, %xmm3, %r11
nop
lfence
lea addresses_WT_ht+0x1d99, %rdx
nop
nop
add $21313, %rdi
mov (%rdx), %si
...
nop
cmp %rbx, %rbx
lea addresses_WC_ht+0x399, %rsi
lea addresses_UC_ht+0xb9c9, %rdi
nop
nop
xor %r9, %r9
mov $60, %rcx
...
nop
add %r8, %r8
lea addresses_WT_ht+0x16d91, %r9
nop
nop
nop
cmp $19995, %rbx
...
nop
and $59733, %r8
lea addresses_UC_ht+0x1da99, %rsi
lea addresses_WT_ht+0x1de99, %rdi
xor $32945, %rdx
mov $30, %rcx
rep movsq
nop
...
nop
sub %rdx, %rdx
lea addresses_normal_ht+0xd099, %rbx
inc %r11
movw $0x6162, (%rbx)
nop
nop
...
nop
xor $48884, %r8
lea addresses_WC_ht+0x13af5, %rcx
nop
nop
nop
nop
...
<gen_prepare_buffer>
{'OP': 'REPM', 'src': {'type': 'addresses_D_ht', 'congruent': 6, 'same': False}, 'dst': {'type': 'addresses_A_ht', 'congruent': 11, 'same': True}}
...
{'OP': 'REPM', 'src': {'type': 'addresses_WC_ht', 'congruent': 8, 'same': False}, 'dst': {'type': 'addresses_UC_ht', 'congruent': 4, 'same': True}}
