...
nop
xor %rsi, %rsi
lea addresses_WC_ht+0x5a5c, %r15
sub $51901, %rax
movl $0x61626364, (%r15)
nop
nop
...
nop
dec %rdx
lea addresses_normal_ht+0x1902, %rsi
...
nop
cmp %rax, %rax
lea addresses_UC_ht+0xe742, %rsi
lea addresses_D_ht+0xae02, %rdi
nop
nop
cmp %rdx, %rdx
mov $11, %rcx
...
nop
inc %r12
lea addresses_A_ht+0x1e142, %r10
dec %rsi
mov (%r10), %rax
nop
nop
...
nop
cmp $10814, %r15
lea addresses_WC_ht+0x139ea, %r15
nop
nop
nop
nop
...
nop
add %rdi, %rdi
lea addresses_WT_ht+0x17812, %rdi
nop
nop
nop
nop
...
nop
inc %r12
lea addresses_A_ht+0x5e3e, %r12
cmp $36715, %rsi
mov (%r12), %r15w
nop
add %rdi, %rdi
lea addresses_A_ht+0x14fc2, %rsi
lea addresses_D_ht+0x942, %rdi
clflush (%rsi)
nop
nop
nop
...
nop
inc %r10
lea addresses_UC_ht+0x14342, %rsi
...
nop
add %r10, %r10
lea addresses_A_ht+0x14742, %rsi
lea addresses_A_ht+0x1d542, %rdi
nop
nop
nop
nop
...
nop
sub $57044, %rdi
lea addresses_UC_ht+0x4742, %rdx
cmp %rcx, %rcx
...
{'OP': 'STOR', 'dst': {'same': False, 'congruent': 7, 'NT': True, 'type': 'addresses_D_ht', 'size': 1, 'AVXalign': False}}
...
{'src': {'type': 'addresses_A_ht', 'congruent': 7, 'same': False}, 'OP': 'REPM', 'dst': {'type': 'addresses_D_ht', 'congruent': 9, 'same': False}}
