...
lea addresses_WC_ht+0x16abd, %rdi
nop
nop
inc %r9
mov $53, %rcx
...
nop
xor %rbx, %rbx
lea addresses_A_ht+0x19ebd, %rdi
nop
nop
nop
nop
...
nop
xor %rcx, %rcx
lea addresses_D_ht+0x50bd, %rsi
lea addresses_WC_ht+0x93e9, %rdi
clflush (%rdi)
nop
and $45218, %r13
mov $0, %rcx
...
nop
sub %rbx, %rbx
lea addresses_WC_ht+0x8d95, %rsi
lea addresses_UC_ht+0x1329f, %rdi
nop
nop
nop
nop
...
nop
and %r10, %r10
lea addresses_WC_ht+0x68c9, %rcx
nop
nop
nop
nop
...
nop
and %rdi, %rdi
lea addresses_normal_ht+0x1c46d, %rbx
nop
nop
add %r13, %r13
mov (%rbx), %rcx
...
nop
cmp %r9, %r9
lea addresses_WT_ht+0x15525, %rsi
lea addresses_UC_ht+0xe4a5, %rdi
nop
nop
add %r13, %r13
mov $66, %rcx
...
nop
dec %r10
lea addresses_A_ht+0x1a4d, %rsi
lea addresses_UC_ht+0x132bd, %rdi
nop
nop
nop
dec %r13
...
nop
cmp %rdi, %rdi
lea addresses_D_ht+0x1ed3d, %rbx
nop
nop
nop
nop
...
nop
add $39245, %rbx
lea addresses_A_ht+0x6fd, %rsi
lea addresses_UC_ht+0x2147, %rdi
nop
nop
nop
sub %r10, %r10
...
<gen_prepare_buffer>
{'src': {'type': 'addresses_UC_ht', 'congruent': 8, 'same': False}, 'dst': {'type': 'addresses_WC_ht', 'congruent': 11, 'same': False}, 'OP': 'REPM'}
...
{'src': {'type': 'addresses_WC_ht', 'congruent': 3, 'same': False}, 'dst': {'type': 'addresses_UC_ht', 'congruent': 1, 'same': True}, 'OP': 'REPM'}
