...
push %rdi
push %rsi
lea addresses_normal_ht+0x17e6d, %rsi
lea addresses_UC_ht+0x194ed, %rdi
nop
nop
cmp %rbp, %rbp
mov $56, %rcx
rep movsw
cmp $29110, %rsi
lea addresses_A_ht+0x148ed, %rsi
...
nop
xor %r15, %r15
lea addresses_WT_ht+0x5eed, %r14
nop
nop
and %rdi, %rdi
movw $0x6162, (%r14)
...
nop
inc %r14
lea addresses_WT_ht+0x1986d, %rbp
nop
nop
nop
nop
...
nop
add $37438, %r14
lea addresses_WC_ht+0x4905, %rsi
lea addresses_A_ht+0xd43d, %rdi
nop
nop
nop
nop
...
nop
xor $33671, %rcx
lea addresses_normal_ht+0x19eed, %r15
nop
and $22743, %rdi
...
nop
dec %rsi
lea addresses_WT_ht+0x336d, %rsi
lea addresses_WT_ht+0x1aef5, %rdi
clflush (%rdi)
nop
nop
nop
...
nop
dec %r15
lea addresses_normal_ht+0x246d, %rsi
lea addresses_WC_ht+0x1ced, %rdi
nop
nop
nop
nop
...
rep movsq
xor $44442, %r10
lea addresses_WC_ht+0x1e06d, %r15
clflush (%r15)
lfence
movb (%r15), %r10b
nop
...
// Store
lea addresses_normal+0x646d, %r8
nop
nop
nop
nop
...
<gen_prepare_buffer>
{'OP': 'REPM', 'src': {'type': 'addresses_normal_ht', 'congruent': 9, 'same': True}, 'dst': {'type': 'addresses_UC_ht', 'congruent': 7, 'same': False}}
...
{'OP': 'REPM', 'src': {'type': 'addresses_WC_ht', 'congruent': 2, 'same': False}, 'dst': {'type': 'addresses_A_ht', 'congruent': 4, 'same': False}}
...
{'OP': 'REPM', 'src': {'type': 'addresses_WT_ht', 'congruent': 4, 'same': False}, 'dst': {'type': 'addresses_WT_ht', 'congruent': 0, 'same': True}}
