...
nop
cmp %r8, %r8
lea addresses_UC_ht+0x131a3, %r14
nop
add $8189, %r15
movb (%r14), %r9b
dec %r9
lea addresses_D_ht+0x4845, %r14
clflush (%r14)
nop
nop
nop
...
nop
xor $45279, %r14
lea addresses_normal_ht+0x17143, %r15
nop
nop
nop
add $8539, %r9
...
nop
xor $55526, %r8
lea addresses_normal_ht+0x1837b, %r14
nop
nop
nop
nop
...
nop
add $7370, %rbp
lea addresses_A_ht+0x14703, %r15
nop
nop
nop
nop
...
nop
cmp %r9, %r9
lea addresses_WC_ht+0x1e603, %rsi
lea addresses_UC_ht+0x43c7, %rdi
nop
nop
xor $40841, %r8
mov $1, %rcx
...
<gen_prepare_buffer>
{'OP': 'STOR', 'dst': {'type': 'addresses_WT_ht', 'size': 1, 'AVXalign': False, 'NT': True, 'congruent': 9, 'same': False}}
