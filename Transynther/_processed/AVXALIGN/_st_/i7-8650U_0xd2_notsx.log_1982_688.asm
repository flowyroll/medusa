...
push %rdx
push %rsi
lea addresses_A_ht+0x10ecf, %r14
nop
nop
nop
add $17083, %rsi
...
nop
and $3616, %r10
lea addresses_WC_ht+0x177b7, %rdi
nop
add %rsi, %rsi
movups (%rdi), %xmm4
vpextrq $0, %xmm4, %rdx
...
nop
and %rbx, %rbx
lea addresses_normal_ht+0x1da0d, %rdx
nop
nop
nop
nop
...
nop
xor %rbx, %rbx
lea addresses_D_ht+0x1823d, %rsi
nop
nop
nop
nop
...
nop
sub $44838, %rsi
lea addresses_UC_ht+0x2593, %r10
nop
nop
nop
nop
...
// Load
lea addresses_normal+0x11b0d, %r14
nop
nop
inc %r8
movups (%r14), %xmm6
