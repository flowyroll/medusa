...
nop
mfence
lea addresses_WC_ht+0x173cd, %rcx
nop
nop
nop
nop
...
nop
xor $52120, %r14
lea addresses_WT_ht+0x1ab75, %rsi
lea addresses_UC_ht+0x476b, %rdi
nop
nop
nop
and $54160, %r12
...
rep movsq
add $1052, %rdi
lea addresses_D_ht+0x1d803, %r15
nop
nop
nop
nop
...
nop
sub %r12, %r12
lea addresses_A_ht+0x15af5, %rsi
lea addresses_UC_ht+0x8f6, %rdi
nop
nop
nop
nop
...
nop
xor %rsi, %rsi
lea addresses_normal_ht+0x9a85, %rsi
lea addresses_UC_ht+0x1aab5, %rdi
clflush (%rsi)
nop
xor $5103, %rbp
mov $113, %rcx
...
nop
add $47206, %r10
lea addresses_WT_ht+0x7285, %rdi
nop
sub %rcx, %rcx
movups (%rdi), %xmm7
vpextrq $1, %xmm7, %r10
...
vmovntdq %ymm1, (%r15)
xor %rsi, %rsi
lea addresses_WT_ht+0x9775, %rsi
lea addresses_WT_ht+0xc1cd, %rdi
clflush (%rdi)
nop
nop
nop
...
nop
add %rdi, %rdi
lea addresses_D_ht+0xc63d, %rsi
lea addresses_WT_ht+0x1a895, %rdi
sub %rbp, %rbp
mov $77, %rcx
rep movsl
nop
...
nop
dec %r12
lea addresses_WT_ht+0x15795, %rsi
lea addresses_WT_ht+0x1a275, %rdi
clflush (%rdi)
nop
nop
nop
...
nop
add %r10, %r10
lea addresses_normal_ht+0x1674d, %rsi
lea addresses_WT_ht+0x17525, %rdi
dec %rbp
mov $63, %rcx
rep movsl
nop
...
// Faulty Load
lea addresses_normal+0xb375, %r11
nop
nop
cmp %r12, %r12
mov (%r11), %r10w
...
{'OP': 'REPM', 'src': {'type': 'addresses_normal_ht', 'congruent': 2, 'same': True}, 'dst': {'type': 'addresses_UC_ht', 'congruent': 5, 'same': False}}
