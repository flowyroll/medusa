...
push %rdi
push %rsi
lea addresses_WC_ht+0x18b1d, %r11
nop
nop
nop
nop
...
nop
and %r12, %r12
lea addresses_WC_ht+0xf51d, %r14
nop
nop
nop
nop
...
nop
add %r9, %r9
lea addresses_A_ht+0x2ffd, %rsi
lea addresses_normal_ht+0x851d, %rdi
add %r12, %r12
mov $10, %rcx
rep movsq
nop
...
nop
and $55547, %r14
lea addresses_UC_ht+0xed1d, %rsi
lea addresses_D_ht+0x1611d, %rdi
and %r13, %r13
mov $125, %rcx
rep movsq
nop
...
// Store
lea addresses_normal+0x1981d, %rdi
nop
nop
nop
nop
...
{'OP': 'LOAD', 'src': {'size': 1, 'NT': True, 'type': 'addresses_D', 'same': False, 'AVXalign': True, 'congruent': 0}}
{'OP': 'LOAD', 'src': {'size': 4, 'NT': True, 'type': 'addresses_D', 'same': False, 'AVXalign': False, 'congruent': 1}}
...
{'OP': 'REPM', 'src': {'same': False, 'type': 'addresses_A_ht', 'congruent': 5}, 'dst': {'same': False, 'type': 'addresses_normal_ht', 'congruent': 11}}
