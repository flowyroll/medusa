...
push %rcx
push %rsi
lea addresses_WC_ht+0x19c1d, %r15
nop
nop
sub %rcx, %rcx
...
nop
xor $2346, %rsi
lea addresses_WT_ht+0x17b33, %r15
nop
nop
nop
nop
...
nop
and %r15, %r15
lea addresses_WT_ht+0x95f3, %rax
nop
nop
sub $27478, %rbp
mov (%rax), %r8w
...
// REPMOV
lea addresses_RW+0x33b3, %rsi
lea addresses_WC+0x1a0c8, %rdi
nop
nop
nop
nop
...
// Faulty Load
lea addresses_normal+0x14933, %r11
nop
nop
nop
nop
