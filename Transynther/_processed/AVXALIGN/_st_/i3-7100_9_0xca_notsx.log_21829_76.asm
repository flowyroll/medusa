...
push %rdi
push %rsi
lea addresses_WT_ht+0xe980, %rax
nop
and %rbx, %rbx
movb (%rax), %r14b
nop
...
nop
sub %rbp, %rbp
lea addresses_WT_ht+0xc660, %rsi
lea addresses_D_ht+0x1b980, %rdi
nop
nop
and %r9, %r9
mov $40, %rcx
...
nop
add %r9, %r9
lea addresses_UC_ht+0x19d80, %rsi
nop
lfence
movb (%rsi), %r14b
nop
...
nop
cmp $38352, %rcx
lea addresses_D_ht+0x5c2, %rsi
lea addresses_D_ht+0x6888, %rdi
xor $18734, %r9
mov $59, %rcx
rep movsb
sub $42219, %rbp
...
// Faulty Load
lea addresses_normal+0x12580, %rax
nop
nop
nop
cmp %r10, %r10
...
{'src': {'type': 'addresses_D_ht', 'congruent': 0, 'same': False}, 'OP': 'REPM', 'dst': {'type': 'addresses_D_ht', 'congruent': 2, 'same': False}}
{'34': 21829}
