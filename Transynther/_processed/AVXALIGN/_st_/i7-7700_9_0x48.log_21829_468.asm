...
push %rdx
push %rsi
lea addresses_D_ht+0x1d5d1, %rbx
nop
nop
nop
add %r10, %r10
...
nop
sub $52910, %rax
lea addresses_WT_ht+0x8678, %r10
nop
add $27267, %r14
mov (%r10), %di
nop
...
nop
and $12815, %r10
lea addresses_WC_ht+0x81f8, %r15
nop
nop
nop
nop
...
nop
xor $57379, %rax
lea addresses_D_ht+0xb3f8, %rsi
lea addresses_WT_ht+0x167f8, %rdi
nop
nop
nop
inc %rax
...
vpextrq $1, %xmm2, %r10
cmp %rdx, %rdx
lea addresses_WT_ht+0x1bc00, %rbx
clflush (%rbx)
inc %r15
...
vmovups %ymm0, (%rbx)
xor $37188, %r15
lea addresses_WC_ht+0xd5f8, %rsi
nop
nop
nop
nop
...
nop
xor $60391, %rsi
lea addresses_WC_ht+0x6868, %rax
nop
nop
nop
nop
...
// Faulty Load
lea addresses_normal+0x173f8, %r9
and %rdi, %rdi
mov (%r9), %eax
lea oracles, %r8
and $0xff, %rax
