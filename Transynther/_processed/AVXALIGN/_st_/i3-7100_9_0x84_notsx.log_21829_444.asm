...
movl $0x61626364, (%rcx)
and %r9, %r9
lea addresses_WC_ht+0xca4c, %r10
clflush (%r10)
nop
nop
nop
...
nop
xor $30172, %r13
lea addresses_WT_ht+0xfb90, %rsi
lea addresses_WT_ht+0xee16, %rdi
xor $6531, %r8
mov $1, %rcx
rep movsb
nop
...
nop
dec %r11
lea addresses_A_ht+0x1db74, %rsi
lea addresses_WT_ht+0x1cecc, %rdi
clflush (%rsi)
nop
add %r13, %r13
mov $13, %rcx
...
nop
add $9526, %rsi
lea addresses_A_ht+0x6b30, %rcx
nop
cmp %r8, %r8
movw $0x6162, (%rcx)
and %r11, %r11
lea addresses_A_ht+0x16b30, %rsi
...
movl $0x61626364, (%rdi)
and $39473, %rcx
lea addresses_WC_ht+0x12f30, %r13
nop
nop
nop
nop
...
nop
and $45050, %rcx
lea addresses_WC_ht+0xb530, %r11
nop
nop
inc %rcx
movb (%r11), %r13b
...
{'dst': {'type': 'addresses_D_ht', 'same': False, 'size': 4, 'congruent': 7, 'NT': False, 'AVXalign': True}, 'OP': 'STOR'}
{'dst': {'type': 'addresses_WC_ht', 'same': True, 'size': 16, 'congruent': 10, 'NT': False, 'AVXalign': False}, 'OP': 'STOR'}
