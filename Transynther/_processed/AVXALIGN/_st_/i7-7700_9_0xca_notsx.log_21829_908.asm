...
push %rdx
push %rsi
lea addresses_normal_ht+0x17e85, %rdx
clflush (%rdx)
nop
nop
nop
...
nop
inc %r13
lea addresses_normal_ht+0xb785, %r8
nop
inc %rax
...
nop
inc %r9
lea addresses_WT_ht+0x3f71, %rsi
lea addresses_normal_ht+0x1df45, %rdi
clflush (%rdi)
sub $21103, %rax
mov $82, %rcx
rep movsw
...
nop
dec %r14
lea addresses_D_ht+0x1d085, %rcx
nop
nop
nop
nop
...
nop
cmp $60356, %rsi
lea addresses_normal_ht+0x1c685, %rsi
lea addresses_D_ht+0x13c5, %rdi
clflush (%rsi)
nop
nop
nop
...
nop
inc %rdx
lea addresses_UC_ht+0xfe05, %rax
and $54607, %r13
mov (%rax), %r9
nop
nop
...
lea addresses_WT_ht+0x7685, %rdi
add $60779, %rax
mov $108, %rcx
rep movsw
nop
nop
sub %rax, %rax
lea addresses_WT_ht+0x13a85, %rdi
nop
nop
nop
and %rdx, %rdx
...
nop
cmp %rsi, %rsi
lea addresses_WT_ht+0x7985, %rsi
sub %r13, %r13
movb (%rsi), %dl
cmp $20032, %rdx
lea addresses_normal_ht+0x795, %rsi
nop
nop
nop
nop
...
lea addresses_normal_ht+0x3ae1, %rdi
clflush (%rsi)
and $17648, %rax
mov $34, %rcx
rep movsw
...
{'src': {'NT': False, 'AVXalign': False, 'size': 32, 'congruent': 6, 'same': False, 'type': 'addresses_US'}, 'OP': 'LOAD'}
...
{'dst': {'NT': True, 'AVXalign': False, 'size': 16, 'congruent': 8, 'same': False, 'type': 'addresses_normal_ht'}, 'OP': 'STOR'}
...
{'src': {'congruent': 11, 'same': False, 'type': 'addresses_normal_ht'}, 'dst': {'congruent': 6, 'same': False, 'type': 'addresses_D_ht'}, 'OP': 'REPM'}
...
{'dst': {'NT': False, 'AVXalign': True, 'size': 8, 'congruent': 5, 'same': False, 'type': 'addresses_WT_ht'}, 'OP': 'STOR'}
