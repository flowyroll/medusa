...
push %rdi
push %rsi
lea addresses_A_ht+0x15c15, %rsi
lea addresses_A_ht+0x19395, %rdi
nop
nop
xor $26934, %rax
mov $64, %rcx
...
nop
sub $24428, %rbp
lea addresses_normal_ht+0x180d5, %rdi
cmp $46958, %r14
mov (%rdi), %bp
nop
cmp %rdi, %rdi
lea addresses_normal_ht+0x76a5, %rax
nop
nop
and $24671, %rdi
movw $0x6162, (%rax)
...
<gen_prepare_buffer>
{'src': {'type': 'addresses_A_ht', 'congruent': 11, 'same': False}, 'OP': 'REPM', 'dst': {'type': 'addresses_A_ht', 'congruent': 7, 'same': False}}
