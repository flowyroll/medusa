...
push %rdx
push %rsi
lea addresses_WC_ht+0x18ec2, %rsi
lea addresses_D_ht+0x1266e, %rdi
nop
xor %rbp, %rbp
mov $88, %rcx
rep movsw
sub $64702, %rdx
lea addresses_WT_ht+0x1b50e, %rcx
nop
nop
nop
and %rdi, %rdi
...
nop
mfence
lea addresses_UC_ht+0x1906e, %r14
nop
nop
nop
sub %r12, %r12
...
nop
xor %r12, %r12
lea addresses_normal_ht+0xdb9e, %rsi
lea addresses_A_ht+0x6c67, %rdi
clflush (%rsi)
nop
add %rax, %rax
mov $112, %rcx
...
nop
sub %rbp, %rbp
lea addresses_normal_ht+0x1876e, %rsi
lea addresses_A_ht+0x1976e, %rdi
nop
nop
nop
and %rax, %rax
...
// Store
lea addresses_normal+0x222e, %rdx
nop
add %rbp, %rbp
mov $0x5152535455565758, %rcx
movq %rcx, %xmm1
...
{'src': {'NT': False, 'same': False, 'congruent': 5, 'type': 'addresses_UC', 'AVXalign': True, 'size': 16}, 'OP': 'LOAD'}
...
{'OP': 'STOR', 'dst': {'NT': False, 'same': False, 'congruent': 1, 'type': 'addresses_normal', 'AVXalign': False, 'size': 32}}
...
<gen_prepare_buffer>
{'src': {'same': False, 'congruent': 2, 'type': 'addresses_WC_ht'}, 'OP': 'REPM', 'dst': {'same': False, 'congruent': 8, 'type': 'addresses_D_ht'}}
