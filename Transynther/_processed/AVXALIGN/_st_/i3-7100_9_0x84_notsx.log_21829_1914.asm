...
push %rdi
push %rsi
lea addresses_A_ht+0x1b9d5, %rsi
lea addresses_WT_ht+0x1c0e5, %rdi
and %rbx, %rbx
mov $33, %rcx
rep movsq
nop
...
nop
sub $28439, %r13
lea addresses_normal_ht+0x14265, %r12
nop
nop
nop
sub %rcx, %rcx
...
nop
inc %rcx
lea addresses_WC_ht+0x11655, %rbx
nop
nop
cmp %rdi, %rdi
movb $0x61, (%rbx)
...
lea addresses_A_ht+0x16ad5, %rdi
nop
nop
cmp %r8, %r8
mov $48, %rcx
...
nop
inc %r8
lea addresses_WC_ht+0xc555, %rsi
lea addresses_A_ht+0xa5d1, %rdi
nop
sub $55842, %r8
mov $28, %rcx
rep movsw
...
nop
xor %r13, %r13
lea addresses_WC_ht+0x7f55, %rbx
nop
add $38992, %r12
movb $0x61, (%rbx)
nop
nop
xor $16434, %rcx
lea addresses_UC_ht+0x143ad, %r12
nop
nop
nop
nop
...
{'src': {'type': 'addresses_A_ht', 'congruent': 3, 'same': True}, 'dst': {'type': 'addresses_A_ht', 'congruent': 4, 'same': False}, 'OP': 'REPM'}
...
{'dst': {'type': 'addresses_UC_ht', 'same': False, 'size': 32, 'congruent': 3, 'NT': True, 'AVXalign': True}, 'OP': 'STOR'}
{'35': 21829}
