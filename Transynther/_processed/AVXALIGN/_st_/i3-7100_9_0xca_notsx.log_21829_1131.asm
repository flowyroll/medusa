...
push %rdi
push %rsi
lea addresses_WT_ht+0xe3ca, %rsi
lea addresses_D_ht+0x199a, %rdi
clflush (%rdi)
nop
nop
nop
...
nop
sub %rdi, %rdi
lea addresses_WT_ht+0x4bfa, %rbp
xor $60452, %r12
movb $0x61, (%rbp)
nop
nop
...
nop
xor %r9, %r9
lea addresses_normal_ht+0x2e9a, %rdi
nop
nop
nop
nop
...
nop
and $18025, %rdi
lea addresses_D_ht+0x7d9a, %rsi
lea addresses_UC_ht+0x293a, %rdi
clflush (%rsi)
nop
add $38304, %r12
mov $37, %rcx
rep movsq
and $53884, %rbp
lea addresses_WC_ht+0x145aa, %rsi
lea addresses_UC_ht+0x12d1a, %rdi
nop
nop
nop
sub $52816, %r10
...
lea addresses_D_ht+0x1ea5a, %rdi
nop
nop
nop
xor $20587, %rax
...
nop
add $23319, %r9
lea addresses_UC_ht+0x1c07a, %rbp
nop
nop
cmp $27459, %r12
mov (%rbp), %r10
...
nop
add $12664, %rax
lea addresses_UC_ht+0x441a, %rsi
lea addresses_A_ht+0x1745e, %rdi
clflush (%rdi)
nop
nop
inc %r9
...
nop
inc %r9
lea addresses_A_ht+0x1de9a, %r9
and $7266, %rbp
mov (%r9), %r12d
nop
nop
and %r10, %r10
lea addresses_WC_ht+0x1c81a, %rax
cmp $27900, %r9
movl $0x61626364, (%rax)
nop
add %rdi, %rdi
...
{'OP': 'STOR', 'dst': {'same': False, 'congruent': 5, 'NT': False, 'type': 'addresses_WT_ht', 'size': 1, 'AVXalign': True}}
{'src': {'same': False, 'congruent': 11, 'NT': True, 'type': 'addresses_normal_ht', 'size': 4, 'AVXalign': False}, 'OP': 'LOAD'}
...
{'src': {'type': 'addresses_normal_ht', 'congruent': 3, 'same': False}, 'OP': 'REPM', 'dst': {'type': 'addresses_D_ht', 'congruent': 6, 'same': False}}
...
{'src': {'type': 'addresses_UC_ht', 'congruent': 2, 'same': False}, 'OP': 'REPM', 'dst': {'type': 'addresses_A_ht', 'congruent': 2, 'same': True}}
