...
push %rdi
push %rsi
lea addresses_normal_ht+0x14a4e, %rsi
lea addresses_WC_ht+0x1b586, %rdi
nop
nop
nop
xor %rbx, %rbx
...
nop
cmp $27597, %rsi
lea addresses_WT_ht+0x17346, %rsi
nop
add $16506, %r9
mov (%rsi), %r13
nop
lfence
lea addresses_A_ht+0xd99a, %r13
clflush (%r13)
cmp %rbp, %rbp
movb (%r13), %cl
nop
cmp $52939, %rcx
lea addresses_WC_ht+0x5cce, %r13
nop
nop
nop
nop
...
nop
cmp %rdi, %rdi
lea addresses_WC_ht+0x1eab, %r13
nop
nop
sub %r9, %r9
vmovups (%r13), %ymm3
...
nop
cmp $30580, %rdi
lea addresses_WT_ht+0x15e8e, %r9
clflush (%r9)
nop
nop
nop
...
vpextrq $1, %xmm6, %r13
and $52127, %rbp
lea addresses_normal_ht+0x7e, %rsi
lea addresses_A_ht+0x59b6, %rdi
nop
nop
nop
add %r10, %r10
...
nop
cmp %rsi, %rsi
lea addresses_WC_ht+0x1218a, %rdi
nop
nop
nop
and $24167, %r9
...
vpextrq $1, %xmm6, %r13
inc %rsi
lea addresses_D_ht+0x7c4e, %rsi
lea addresses_A_ht+0x4f2f, %rdi
nop
nop
nop
xor $35400, %r10
...
<gen_prepare_buffer>
{'OP': 'REPM', 'src': {'type': 'addresses_normal_ht', 'congruent': 8, 'same': False}, 'dst': {'type': 'addresses_WC_ht', 'congruent': 1, 'same': True}}
...
{'OP': 'REPM', 'src': {'type': 'addresses_D_ht', 'congruent': 11, 'same': False}, 'dst': {'type': 'addresses_A_ht', 'congruent': 0, 'same': False}}
{'33': 21829}
