...
nop
cmp $65297, %rbp
lea addresses_A_ht+0x1a71b, %rax
nop
nop
nop
cmp $53546, %rdx
...
nop
dec %rbp
lea addresses_A_ht+0x141e0, %rdi
cmp $9233, %rdx
mov (%rdi), %r8
nop
nop
...
movq %rax, (%r8)
add %rsi, %rsi
lea addresses_normal_ht+0x1e0, %rax
dec %r10
movw $0x6162, (%rax)
nop
nop
nop
dec %r10
lea addresses_UC_ht+0x7c1c, %r10
nop
xor $64656, %rdx
movb (%r10), %r8b
nop
...
nop
sub $37931, %r10
lea addresses_WC_ht+0x1a490, %r8
nop
nop
nop
cmp %r10, %r10
...
nop
sub %rax, %rax
lea addresses_UC_ht+0x19f20, %r10
nop
nop
nop
nop
...
nop
sub $25744, %rsi
lea addresses_D_ht+0x102e0, %rdi
nop
nop
nop
nop
...
<gen_faulty_load>
[REF]
{'OP': 'LOAD', 'src': {'size': 4, 'NT': True, 'type': 'addresses_RW', 'same': False, 'AVXalign': False, 'congruent': 0}}
[Faulty Load]
...
{'OP': 'STOR', 'dst': {'size': 32, 'NT': False, 'type': 'addresses_UC_ht', 'same': True, 'AVXalign': False, 'congruent': 11}}
