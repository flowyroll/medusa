...
push %rdi
push %rsi
lea addresses_WC_ht+0x1cc63, %rsi
lea addresses_normal_ht+0x1ca27, %rdi
nop
nop
nop
nop
...
rep movsw
sub %r8, %r8
lea addresses_D_ht+0x13527, %r13
nop
nop
add %r10, %r10
mov (%r13), %rcx
...
nop
cmp $57071, %r8
lea addresses_A_ht+0x1aa27, %r15
nop
nop
dec %r10
mov (%r15), %r8w
...
// Faulty Load
lea addresses_normal+0x8627, %rcx
nop
nop
nop
nop
...
<gen_prepare_buffer>
{'src': {'congruent': 2, 'same': False, 'type': 'addresses_WC_ht'}, 'OP': 'REPM', 'dst': {'congruent': 9, 'same': False, 'type': 'addresses_normal_ht'}}
