...
push %rdi
push %rsi
lea addresses_WT_ht+0xf766, %rsi
lea addresses_D_ht+0x4766, %rdi
dec %r9
mov $56, %rcx
rep movsw
nop
...
nop
cmp $6123, %rax
lea addresses_A_ht+0x14626, %rbx
add %r14, %r14
mov (%rbx), %r9d
nop
nop
...
nop
cmp %r9, %r9
lea addresses_WC_ht+0x145b6, %rcx
nop
nop
nop
nop
...
nop
add $7113, %rdi
lea addresses_normal_ht+0x1b66, %r14
nop
nop
cmp %rax, %rax
mov (%r14), %ecx
...
{'src': {'type': 'addresses_RW', 'AVXalign': True, 'size': 8, 'NT': False, 'same': False, 'congruent': 7}, 'OP': 'LOAD'}
...
<gen_prepare_buffer>
{'src': {'type': 'addresses_WT_ht', 'congruent': 3, 'same': False}, 'OP': 'REPM', 'dst': {'type': 'addresses_D_ht', 'congruent': 10, 'same': False}}
