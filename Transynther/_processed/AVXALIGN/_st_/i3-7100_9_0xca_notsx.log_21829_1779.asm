...
movl $0x61626364, (%r9)
cmp $47464, %r10
lea addresses_WC_ht+0x10ea9, %rsi
lea addresses_normal_ht+0x17c12, %rdi
cmp $8651, %rdx
mov $66, %rcx
rep movsl
nop
...
lea addresses_D_ht+0x1e979, %rdi
nop
add $20838, %r10
mov $101, %rcx
rep movsw
...
// Store
lea addresses_normal+0x6a59, %rcx
nop
nop
dec %r8
...
<gen_prepare_buffer>
{'OP': 'STOR', 'dst': {'same': True, 'congruent': 7, 'NT': False, 'type': 'addresses_D_ht', 'size': 2, 'AVXalign': False}}
{'OP': 'STOR', 'dst': {'same': False, 'congruent': 11, 'NT': False, 'type': 'addresses_UC_ht', 'size': 4, 'AVXalign': False}}
{'src': {'type': 'addresses_WC_ht', 'congruent': 4, 'same': False}, 'OP': 'REPM', 'dst': {'type': 'addresses_normal_ht', 'congruent': 0, 'same': False}}
