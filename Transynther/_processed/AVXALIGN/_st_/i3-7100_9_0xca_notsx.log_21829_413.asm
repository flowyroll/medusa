...
push %rdi
push %rsi
lea addresses_A_ht+0x1af97, %r14
nop
sub $61767, %r15
mov (%r14), %rsi
nop
...
nop
cmp %r15, %r15
lea addresses_D_ht+0x625b, %r14
dec %r10
mov (%r14), %r9
nop
nop
xor %r15, %r15
lea addresses_D_ht+0x205b, %rbp
clflush (%rbp)
nop
nop
nop
...
nop
sub $342, %r14
lea addresses_normal_ht+0x15c9b, %r9
nop
nop
nop
nop
...
movb $0x61, (%r9)
xor $18590, %r10
lea addresses_UC_ht+0x145b, %r10
nop
nop
nop
nop
...
nop
xor $46023, %rsi
lea addresses_D_ht+0x1ae5b, %rsi
lea addresses_WC_ht+0x305b, %rdi
nop
nop
dec %rbp
mov $61, %rcx
...
// Faulty Load
lea addresses_normal+0x1085b, %r9
nop
nop
and $29755, %rbp
mov (%r9), %r14w
...
{'src': {'type': 'addresses_D_ht', 'congruent': 9, 'same': False}, 'OP': 'REPM', 'dst': {'type': 'addresses_WC_ht', 'congruent': 11, 'same': False}}
{'34': 21829}
