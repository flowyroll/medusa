...
push %rdx
push %rsi
lea addresses_UC_ht+0xf393, %rsi
...
nop
add %rcx, %rcx
lea addresses_WC_ht+0xb1c3, %rsi
sub %rdx, %rdx
movw $0x6162, (%rsi)
nop
nop
nop
and %r15, %r15
lea addresses_normal_ht+0x12593, %r10
nop
nop
nop
xor $26912, %r11
...
// Load
lea addresses_normal+0x6793, %rcx
clflush (%rcx)
nop
nop
nop
...
// Store
lea addresses_normal+0x139cf, %r13
nop
sub $20994, %rcx
...
<gen_prepare_buffer>
{'OP': 'REPM', 'src': {'same': False, 'type': 'addresses_UC_ht', 'congruent': 11}, 'dst': {'same': False, 'type': 'addresses_WC_ht', 'congruent': 0}}
