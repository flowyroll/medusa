...
push %rdi
push %rsi
lea addresses_WC_ht+0x16f24, %r12
nop
nop
nop
add %rbp, %rbp
...
nop
and %r12, %r12
lea addresses_WT_ht+0x178d4, %rbx
nop
nop
nop
nop
...
vpextrq $1, %xmm0, %r12
and $8175, %r14
lea addresses_normal_ht+0x66a4, %r14
nop
nop
nop
nop
...
nop
sub %rbp, %rbp
lea addresses_normal_ht+0x1d864, %r15
nop
nop
nop
nop
...
nop
inc %rbx
lea addresses_normal_ht+0x15724, %rbp
dec %rdi
mov (%rbp), %r12
nop
add %rbp, %rbp
lea addresses_WC_ht+0x36a, %rsi
lea addresses_D_ht+0x2324, %rdi
nop
nop
nop
add %rbp, %rbp
...
nop
sub %rsi, %rsi
lea addresses_D_ht+0x1d84, %rsi
lea addresses_normal_ht+0x1dfae, %rdi
clflush (%rdi)
nop
nop
nop
