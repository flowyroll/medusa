...
nop
and %rsi, %rsi
lea addresses_UC_ht+0x1c662, %rsi
lea addresses_WT_ht+0x12142, %rdi
lfence
mov $16, %rcx
rep movsw
nop
...
nop
add %r14, %r14
lea addresses_D_ht+0x15862, %rsi
lea addresses_WC_ht+0x12f05, %rdi
nop
nop
nop
nop
...
nop
dec %rdi
lea addresses_WT_ht+0x1caa6, %rsi
lea addresses_D_ht+0x4662, %rdi
xor $29973, %r9
mov $52, %rcx
rep movsq
cmp $16035, %r15
lea addresses_A_ht+0x13662, %rsi
nop
nop
nop
nop
...
nop
mfence
lea addresses_normal_ht+0xc6fa, %rsi
lea addresses_D_ht+0x13482, %rdi
clflush (%rsi)
add $25639, %r8
mov $72, %rcx
rep movsl
...
nop
xor $21199, %rdi
lea addresses_A_ht+0x15662, %rsi
nop
nop
nop
nop
...
nop
dec %r9
lea addresses_WT_ht+0xc462, %rsi
lea addresses_WC_ht+0x1e1a, %rdi
nop
nop
nop
xor $28099, %r15
...
{'src': {'type': 'addresses_A_ht', 'AVXalign': False, 'size': 32, 'NT': True, 'same': False, 'congruent': 10}, 'OP': 'LOAD'}
