...
push %rdi
push %rdx
lea addresses_D_ht+0x12f59, %rdx
nop
inc %r13
mov (%rdx), %rbp
nop
...
nop
and %r8, %r8
lea addresses_UC_ht+0x16d0b, %rdi
nop
nop
sub $58096, %r9
mov (%rdi), %r14w
...
{'src': {'congruent': 1, 'AVXalign': False, 'same': False, 'size': 1, 'NT': False, 'type': 'addresses_WT'}, 'OP': 'LOAD'}
