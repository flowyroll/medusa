...
push %rdx
push %rsi
lea addresses_A_ht+0x18280, %rsi
cmp $38555, %rdi
...
nop
cmp $63061, %r14
lea addresses_WC_ht+0x1d680, %rdi
inc %r12
movl $0x61626364, (%rdi)
nop
nop
...
lea addresses_D_ht+0x14f7d, %rdi
nop
nop
xor $64524, %rax
mov $82, %rcx
rep movsl
xor $38083, %r10
lea addresses_normal_ht+0x1ee80, %rsi
...
// Faulty Load
lea addresses_normal+0xae80, %rcx
nop
nop
nop
sub %r14, %r14
...
{'src': {'NT': True, 'same': False, 'congruent': 7, 'type': 'addresses_NC', 'AVXalign': False, 'size': 4}, 'OP': 'LOAD'}
