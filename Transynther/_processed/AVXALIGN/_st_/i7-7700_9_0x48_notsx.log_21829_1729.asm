...
push %rdi
push %rsi
lea addresses_WT_ht+0xc466, %rsi
nop
nop
xor $20053, %r14
movb $0x61, (%rsi)
...
nop
add %r11, %r11
lea addresses_WT_ht+0xf686, %rsi
inc %rax
movups (%rsi), %xmm7
vpextrq $0, %xmm7, %r9
cmp $56780, %r13
lea addresses_normal_ht+0x1caf0, %r11
clflush (%r11)
nop
nop
nop
...
nop
add %rsi, %rsi
lea addresses_UC_ht+0x3a77, %r13
nop
cmp $32319, %r14
movb $0x61, (%r13)
nop
...
nop
inc %r9
lea addresses_normal_ht+0x1bb06, %rsi
lea addresses_normal_ht+0xbbee, %rdi
nop
nop
nop
nop
...
nop
add %rcx, %rcx
lea addresses_WC_ht+0x2206, %rsi
lea addresses_A_ht+0x6866, %rdi
clflush (%rsi)
nop
nop
nop
...
nop
cmp $18800, %r11
lea addresses_WT_ht+0x1eb76, %rax
nop
nop
nop
cmp %r11, %r11
...
nop
xor $28227, %rsi
lea addresses_UC_ht+0x11986, %rsi
nop
cmp %r9, %r9
movups (%rsi), %xmm4
vpextrq $1, %xmm4, %rcx
and %r11, %r11
lea addresses_D_ht+0x3a46, %r13
nop
sub $36688, %rsi
...
nop
and %rdi, %rdi
lea addresses_UC_ht+0xaae6, %r12
nop
nop
nop
nop
...
nop
inc %rsi
lea addresses_normal_ht+0x13468, %rcx
clflush (%rcx)
cmp $22938, %rdi
mov (%rcx), %ax
nop
...
nop
sub %r12, %r12
lea addresses_WT_ht+0x266e, %rsi
lea addresses_D_ht+0x15866, %rdi
nop
nop
nop
nop
...
rep movsl
cmp %rsi, %rsi
lea addresses_WC_ht+0x6666, %r12
nop
nop
nop
nop
...
nop
and $63013, %r11
lea addresses_normal_ht+0x15166, %rcx
and $3556, %r11
movups (%rcx), %xmm0
vpextrq $1, %xmm0, %r12
nop
...
// Faulty Load
lea addresses_normal+0x18066, %rax
cmp $29637, %r13
mov (%rax), %esi
lea oracles, %r13
and $0xff, %rsi
...
{'dst': {'same': False, 'congruent': 2, 'type': 'addresses_normal_ht'}, 'OP': 'REPM', 'src': {'same': False, 'congruent': 5, 'type': 'addresses_normal_ht'}}
{'dst': {'same': True, 'congruent': 11, 'type': 'addresses_A_ht'}, 'OP': 'REPM', 'src': {'same': False, 'congruent': 5, 'type': 'addresses_WC_ht'}}
{'OP': 'LOAD', 'src': {'same': False, 'NT': True, 'AVXalign': True, 'size': 4, 'type': 'addresses_WT_ht', 'congruent': 1}}
...
{'dst': {'same': False, 'congruent': 11, 'type': 'addresses_D_ht'}, 'OP': 'REPM', 'src': {'same': False, 'congruent': 2, 'type': 'addresses_WT_ht'}}
{'OP': 'LOAD', 'src': {'same': False, 'NT': True, 'AVXalign': False, 'size': 1, 'type': 'addresses_WC_ht', 'congruent': 8}}
