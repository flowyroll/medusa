...
nop
and $39941, %rdx
lea addresses_D_ht+0x1036e, %r12
nop
nop
nop
nop
...
nop
sub $51618, %r12
lea addresses_A_ht+0xf00, %rax
nop
and %r13, %r13
mov (%rax), %r11d
sub %r15, %r15
lea addresses_WT_ht+0x1d53a, %rdx
nop
nop
nop
add $41110, %r11
...
nop
and %rdx, %rdx
lea addresses_UC_ht+0x1993a, %rdx
nop
nop
nop
inc %r11
...
nop
add $15486, %r12
lea addresses_WT_ht+0xb13a, %rsi
lea addresses_normal_ht+0xad3a, %rdi
clflush (%rsi)
nop
and %rdx, %rdx
mov $5, %rcx
...
nop
xor $47788, %r11
lea addresses_WC_ht+0x13001, %r11
nop
nop
nop
dec %rsi
...
nop
add %rcx, %rcx
lea addresses_normal_ht+0x15ae, %rbx
nop
nop
nop
nop
...
nop
and $41888, %rdi
lea addresses_A_ht+0x10e52, %r11
nop
nop
nop
nop
...
nop
cmp %r11, %r11
lea addresses_A_ht+0x819a, %rsi
lea addresses_UC_ht+0x1293a, %rdi
nop
nop
nop
nop
...
nop
add %rsi, %rsi
lea addresses_WT_ht+0x1b3a, %rcx
nop
nop
cmp $50556, %rax
movb $0x61, (%rcx)
...
nop
cmp $38875, %rcx
lea addresses_WC_ht+0x9eda, %rsi
lea addresses_D_ht+0x137ae, %rdi
nop
nop
nop
dec %r12
...
nop
sub $52028, %r11
lea addresses_WT_ht+0x1541a, %r11
clflush (%r11)
nop
nop
nop
...
{'src': {'type': 'addresses_WT_ht', 'congruent': 10, 'same': True}, 'dst': {'type': 'addresses_normal_ht', 'congruent': 10, 'same': False}, 'OP': 'REPM'}
