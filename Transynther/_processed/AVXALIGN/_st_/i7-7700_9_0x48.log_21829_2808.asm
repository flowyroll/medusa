...
push %rdi
push %rsi
lea addresses_normal_ht+0x3664, %r8
nop
nop
nop
nop
...
vpextrq $1, %xmm4, %rbx
inc %rbx
lea addresses_D_ht+0x1a304, %rsi
lea addresses_WC_ht+0xfdac, %rdi
nop
and $42399, %r9
mov $77, %rcx
rep movsl
...
nop
cmp %r9, %r9
lea addresses_normal_ht+0x10aec, %r8
nop
cmp %rsi, %rsi
...
nop
xor $20958, %rdi
lea addresses_WT_ht+0x1c9ac, %rcx
nop
and $56166, %r15
movw $0x6162, (%rcx)
nop
...
nop
cmp $38292, %rbx
lea addresses_D_ht+0x159ac, %rbx
nop
nop
and %r9, %r9
movb $0x61, (%rbx)
...
// Store
lea addresses_normal+0x185ac, %r12
nop
nop
and $61036, %r15
movw $0x5152, (%r12)
...
// Store
lea addresses_normal+0xef58, %r15
nop
nop
nop
nop
...
{'OP': 'STOR', 'dst': {'type': 'addresses_RW', 'AVXalign': True, 'congruent': 3, 'size': 1, 'same': False, 'NT': False}}
