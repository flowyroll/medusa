...
nop
add $459, %r14
lea addresses_WC_ht+0x113cf, %rdx
sub %r8, %r8
movl $0x61626364, (%rdx)
nop
xor $37892, %rbp
lea addresses_normal_ht+0x18b8f, %r10
and $59191, %rdx
movb (%r10), %r13b
nop
nop
...
nop
and %rdx, %rdx
lea addresses_D_ht+0x4fcf, %rsi
lea addresses_WC_ht+0x8d71, %rdi
nop
nop
and %r10, %r10
mov $53, %rcx
...
nop
and %r10, %r10
lea addresses_WT_ht+0x16e08, %r10
nop
nop
xor %r8, %r8
movw $0x6162, (%r10)
...
nop
sub %r8, %r8
lea addresses_D_ht+0x13f66, %rsi
lea addresses_normal_ht+0x141ef, %rdi
dec %r13
mov $16, %rcx
rep movsb
nop
...
nop
dec %rdi
lea addresses_UC_ht+0x10bcf, %rdx
nop
nop
nop
nop
...
lea addresses_UC_ht+0xe563, %rdi
clflush (%rsi)
nop
nop
xor %rbp, %rbp
...
nop
xor $35539, %r13
lea addresses_UC_ht+0xbaff, %rsi
clflush (%rsi)
nop
nop
nop
...
nop
add %r14, %r14
lea addresses_WC_ht+0x15b4f, %rsi
nop
nop
nop
add %r13, %r13
...
// Faulty Load
lea addresses_normal+0xabcf, %r13
nop
nop
nop
nop
...
{'dst': {'same': False, 'congruent': 1, 'type': 'addresses_WC_ht'}, 'OP': 'REPM', 'src': {'same': False, 'congruent': 9, 'type': 'addresses_D_ht'}}
{'dst': {'same': False, 'NT': False, 'AVXalign': False, 'size': 2, 'type': 'addresses_WT_ht', 'congruent': 0}, 'OP': 'STOR'}
{'dst': {'same': False, 'congruent': 5, 'type': 'addresses_normal_ht'}, 'OP': 'REPM', 'src': {'same': True, 'congruent': 0, 'type': 'addresses_D_ht'}}
...
{'dst': {'same': False, 'congruent': 2, 'type': 'addresses_UC_ht'}, 'OP': 'REPM', 'src': {'same': False, 'congruent': 6, 'type': 'addresses_D_ht'}}
...
{'dst': {'same': False, 'congruent': 7, 'type': 'addresses_A_ht'}, 'OP': 'REPM', 'src': {'same': False, 'congruent': 2, 'type': 'addresses_normal_ht'}}
{'34': 21829}
