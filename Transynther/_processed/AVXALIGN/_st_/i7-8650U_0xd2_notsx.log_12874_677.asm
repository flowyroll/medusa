...
// REPMOV
lea addresses_A+0x11b6c, %rsi
lea addresses_PSE+0x13a50, %rdi
add %rbx, %rbx
mov $25, %rcx
rep movsq
nop
...
// Store
lea addresses_normal+0x192f4, %r15
nop
nop
nop
nop
...
// Faulty Load
lea addresses_normal+0xf3ec, %rcx
nop
nop
and %r15, %r15
mov (%rcx), %ebx
...
{'OP': 'REPM', 'src': {'type': 'addresses_A', 'congruent': 7, 'same': False}, 'dst': {'type': 'addresses_PSE', 'congruent': 0, 'same': False}}
