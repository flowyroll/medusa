...
push %rdx
push %rsi
lea addresses_normal_ht+0x16fc, %rdx
nop
nop
and $37778, %r8
...
movups %xmm2, (%rcx)
cmp $9703, %rcx
lea addresses_WT_ht+0x1adac, %rsi
...
nop
and %rdi, %rdi
lea addresses_UC_ht+0xc354, %rdx
nop
nop
nop
nop
...
movb (%rdx), %r8b
xor %r14, %r14
lea addresses_normal_ht+0x184ac, %rsi
lea addresses_UC_ht+0x1a130, %rdi
nop
cmp %r8, %r8
mov $92, %rcx
rep movsl
...
lea addresses_A_ht+0x1acac, %rdi
nop
nop
sub %r15, %r15
mov $40, %rcx
...
nop
inc %r14
lea addresses_WC_ht+0x1ecec, %r10
nop
nop
nop
and %rcx, %rcx
...
// REPMOV
mov $0x3345c20000000cac, %rsi
lea addresses_D+0xd4ac, %rdi
clflush (%rdi)
nop
nop
mfence
...
{'OP': 'REPM', 'src': {'type': 'addresses_NC', 'congruent': 11, 'same': False}, 'dst': {'type': 'addresses_D', 'congruent': 11, 'same': False}}
{'OP': 'STOR', 'dst': {'type': 'addresses_UC', 'size': 1, 'AVXalign': True, 'NT': True, 'congruent': 1, 'same': False}}
[Faulty Load]
...
{'OP': 'REPM', 'src': {'type': 'addresses_A_ht', 'congruent': 7, 'same': False}, 'dst': {'type': 'addresses_A_ht', 'congruent': 10, 'same': True}}
