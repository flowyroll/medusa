...
push %rdx
push %rsi
lea addresses_D_ht+0x1c84e, %r11
nop
nop
nop
lfence
...
nop
and %rax, %rax
lea addresses_UC_ht+0x96d6, %rsi
lea addresses_WT_ht+0x6ad6, %rdi
nop
cmp $60675, %rdx
mov $62, %rcx
rep movsq
nop
sub %rdx, %rdx
lea addresses_WC_ht+0x126d6, %rsi
lea addresses_D_ht+0x106ec, %rdi
nop
nop
nop
nop
...
nop
add %r11, %r11
lea addresses_WT_ht+0x11931, %r14
nop
nop
nop
nop
...
nop
xor %rdx, %rdx
lea addresses_WC_ht+0x116d6, %rcx
nop
nop
sub $45702, %rax
...
{'OP': 'LOAD', 'src': {'type': 'addresses_D', 'AVXalign': False, 'congruent': 9, 'size': 1, 'same': False, 'NT': False}}
[Faulty Load]
...
{'OP': 'REPM', 'src': {'type': 'addresses_WC_ht', 'congruent': 11, 'same': False}, 'dst': {'type': 'addresses_D_ht', 'congruent': 1, 'same': False}}
