...
push %rdi
push %rsi
lea addresses_normal_ht+0xe054, %r8
nop
nop
nop
cmp $62317, %rbx
...
nop
cmp %rcx, %rcx
lea addresses_WT_ht+0x1b400, %r13
clflush (%r13)
nop
nop
nop
...
nop
add $25838, %rsi
lea addresses_WT_ht+0x2228, %rsi
lea addresses_UC_ht+0x6198, %rdi
nop
sub $48636, %rbx
mov $70, %rcx
rep movsb
...
nop
cmp $63831, %r13
lea addresses_UC_ht+0x17880, %r12
nop
nop
and $60427, %rsi
movl $0x61626364, (%r12)
nop
cmp %r8, %r8
lea addresses_normal_ht+0x6c00, %rbx
nop
nop
nop
add $22915, %rdi
...
nop
dec %rax
lea addresses_D_ht+0x618, %rax
nop
nop
xor $37274, %rbx
mov (%rax), %si
sub $37065, %r12
lea addresses_WT_ht+0x102f3, %rsi
nop
nop
nop
nop
...
nop
cmp $389, %r8
lea addresses_UC_ht+0x9d80, %rsi
lea addresses_A_ht+0x1ce8a, %rdi
nop
nop
dec %rax
mov $74, %rcx
...
{'OP': 'REPM', 'src': {'type': 'addresses_UC_ht', 'congruent': 6, 'same': False}, 'dst': {'type': 'addresses_A_ht', 'congruent': 1, 'same': True}}
{'36': 21829}
