...
lea addresses_normal_ht+0x5873, %rdi
nop
nop
add $64214, %rbx
mov $13, %rcx
...
nop
xor %rbx, %rbx
lea addresses_normal_ht+0x16e73, %rsi
lea addresses_WC_ht+0x4273, %rdi
and $31774, %r14
mov $24, %rcx
rep movsw
nop
...
nop
sub $41762, %rbp
lea addresses_normal_ht+0x17df3, %r8
nop
nop
lfence
...
{'src': {'same': False, 'congruent': 8, 'type': 'addresses_normal_ht'}, 'OP': 'REPM', 'dst': {'same': False, 'congruent': 9, 'type': 'addresses_WC_ht'}}
