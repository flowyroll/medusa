...
nop
inc %rdi
lea addresses_A_ht+0x1e0ec, %rbp
nop
cmp $7463, %rdx
vmovups (%rbp), %ymm3
...
nop
and %rsi, %rsi
lea addresses_A_ht+0x1042c, %rdi
xor $58976, %r14
mov $0x6162636465666768, %rax
movq %rax, %xmm2
movups %xmm2, (%rdi)
...
nop
cmp %rsi, %rsi
lea addresses_normal_ht+0x1b094, %rdx
nop
nop
nop
nop
...
nop
cmp %r8, %r8
lea addresses_WC_ht+0x1dcec, %rsi
lea addresses_UC_ht+0xaec, %rdi
nop
nop
nop
and %rdx, %rdx
...
nop
xor $49137, %rsi
lea addresses_WT_ht+0x1b64c, %rax
nop
nop
add %rbp, %rbp
movb (%rax), %cl
...
nop
sub %r14, %r14
lea addresses_UC_ht+0x11fec, %rsi
lea addresses_A_ht+0x150ec, %rdi
clflush (%rsi)
nop
nop
nop
...
nop
cmp $30425, %r8
lea addresses_normal_ht+0x1ccec, %rdi
nop
nop
add %rsi, %rsi
