...
push %rdi
push %rsi
lea addresses_UC_ht+0xad70, %r15
sub %rsi, %rsi
movb (%r15), %r11b
nop
lfence
lea addresses_WC_ht+0x1a858, %rbp
nop
nop
nop
nop
...
mov (%rbp), %bx
inc %rbx
lea addresses_A_ht+0x109c, %rsi
lea addresses_UC_ht+0x1d870, %rdi
nop
nop
nop
nop
...
{'OP': 'STOR', 'dst': {'type': 'addresses_D_ht', 'AVXalign': True, 'congruent': 10, 'size': 8, 'same': False, 'NT': False}}
{'36': 21829}
