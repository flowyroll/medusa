...
push %rdi
push %rsi
lea addresses_A_ht+0x19a39, %rsi
lea addresses_WT_ht+0x1c639, %rdi
nop
nop
nop
dec %r14
...
nop
add %rax, %rax
lea addresses_D_ht+0x15959, %rax
nop
nop
nop
nop
...
nop
sub %rcx, %rcx
lea addresses_A_ht+0x7e39, %rsi
lea addresses_UC_ht+0x1dfb9, %rdi
nop
nop
add %r13, %r13
mov $90, %rcx
...
nop
cmp %r14, %r14
lea addresses_WC_ht+0x14c99, %rdi
add $3473, %rsi
movb (%rdi), %al
nop
add %rax, %rax
lea addresses_WC_ht+0x539, %r14
clflush (%r14)
nop
nop
nop
...
nop
cmp %rdi, %rdi
lea addresses_UC_ht+0xea39, %rsi
lea addresses_WT_ht+0xbdf9, %rdi
nop
nop
add $19309, %r15
mov $1, %rcx
...
nop
xor $24123, %r14
lea addresses_WT_ht+0x7139, %rcx
clflush (%rcx)
nop
nop
nop
...
nop
cmp $27317, %rdi
lea addresses_WT_ht+0x1a889, %rax
nop
nop
nop
nop
...
nop
dec %r15
lea addresses_WC_ht+0x1e089, %rsi
lea addresses_D_ht+0x1c1b9, %rdi
add $1394, %r10
mov $100, %rcx
rep movsb
nop
nop
dec %rsi
lea addresses_normal_ht+0x1d159, %r14
nop
nop
nop
nop
...
nop
dec %r10
lea addresses_WC_ht+0xea39, %r10
nop
nop
nop
nop
...
nop
dec %r14
lea addresses_WC_ht+0x17939, %rsi
...
nop
sub $12594, %r14
lea addresses_UC_ht+0x1e939, %rcx
nop
nop
nop
nop
...
nop
xor $11093, %r15
lea addresses_WC_ht+0x19e39, %rsi
nop
and $45403, %r10
movups (%rsi), %xmm2
vpextrq $1, %xmm2, %r14
...
{'dst': {'same': False, 'congruent': 6, 'type': 'addresses_UC_ht'}, 'OP': 'REPM', 'src': {'same': False, 'congruent': 10, 'type': 'addresses_A_ht'}}
...
{'dst': {'same': False, 'congruent': 4, 'type': 'addresses_WT_ht'}, 'OP': 'REPM', 'src': {'same': False, 'congruent': 6, 'type': 'addresses_UC_ht'}}
...
{'dst': {'same': False, 'congruent': 7, 'type': 'addresses_D_ht'}, 'OP': 'REPM', 'src': {'same': True, 'congruent': 4, 'type': 'addresses_WC_ht'}}
...
{'dst': {'same': False, 'congruent': 8, 'type': 'addresses_WT_ht'}, 'OP': 'REPM', 'src': {'same': False, 'congruent': 8, 'type': 'addresses_WC_ht'}}
