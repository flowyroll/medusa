...
nop
dec %r14
lea addresses_A_ht+0x10bd1, %rsi
lea addresses_D_ht+0x45a5, %rdi
and %rbx, %rbx
mov $44, %rcx
rep movsl
nop
...
nop
xor $43588, %rdx
lea addresses_WC_ht+0x4989, %rbx
nop
nop
nop
nop
...
nop
cmp $50370, %rdi
lea addresses_A_ht+0x1bd25, %rsi
lea addresses_UC_ht+0x8d49, %rdi
nop
nop
nop
nop
...
nop
and $21236, %r8
lea addresses_UC_ht+0x16d25, %rsi
lea addresses_normal_ht+0x18315, %rdi
clflush (%rsi)
nop
add %r14, %r14
mov $41, %rcx
...
nop
and $10314, %rsi
lea addresses_D_ht+0x1ea25, %r14
nop
add %rsi, %rsi
...
vmovntdq %ymm6, (%r14)
xor %r15, %r15
lea addresses_D_ht+0xef01, %rbx
dec %r15
mov (%rbx), %si
nop
and $63763, %r15
lea addresses_UC_ht+0x10743, %r15
nop
nop
nop
nop
...
{'src': {'type': 'addresses_A_ht', 'congruent': 8, 'same': False}, 'dst': {'type': 'addresses_UC_ht', 'congruent': 2, 'same': False}, 'OP': 'REPM'}
{'src': {'type': 'addresses_UC_ht', 'congruent': 11, 'same': False}, 'dst': {'type': 'addresses_normal_ht', 'congruent': 4, 'same': False}, 'OP': 'REPM'}
{'dst': {'type': 'addresses_D_ht', 'same': False, 'size': 32, 'congruent': 8, 'NT': True, 'AVXalign': False}, 'OP': 'STOR'}
