...
push %rdi
push %rsi
lea addresses_A_ht+0x1d6d0, %r11
clflush (%r11)
nop
nop
cmp $18360, %r14
...
nop
add %rbp, %rbp
lea addresses_normal_ht+0x12370, %rsi
lea addresses_WT_ht+0x1570, %rdi
nop
nop
nop
nop
...
// Faulty Load
lea addresses_normal+0x5170, %rbp
nop
nop
nop
dec %r13
...
{'OP': 'REPM', 'src': {'same': False, 'type': 'addresses_normal_ht', 'congruent': 9}, 'dst': {'same': True, 'type': 'addresses_WT_ht', 'congruent': 9}}
{'34': 21829}
