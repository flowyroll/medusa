...
nop
sub %rcx, %rcx
lea addresses_UC_ht+0xdbf6, %rsi
lea addresses_WC_ht+0x12716, %rdi
nop
nop
cmp %rax, %rax
mov $17, %rcx
...
nop
add $26317, %rdi
lea addresses_D_ht+0x18c02, %rsi
lea addresses_A_ht+0x1e376, %rdi
nop
nop
nop
nop
...
nop
and $29735, %r8
lea addresses_WC_ht+0x73f6, %rcx
add %rsi, %rsi
movw $0x6162, (%rcx)
nop
nop
xor $42740, %r12
lea addresses_D_ht+0x17626, %rdi
nop
nop
and %r8, %r8
movw $0x6162, (%rdi)
...
nop
inc %r12
lea addresses_UC_ht+0x8fd6, %rdi
nop
nop
nop
nop
...
nop
and $17944, %rdi
lea addresses_D_ht+0x18bf6, %rax
nop
nop
nop
nop
...
// Faulty Load
lea addresses_normal+0x33f6, %r13
nop
nop
nop
nop
...
{'src': {'type': 'addresses_UC_ht', 'congruent': 11, 'same': False}, 'OP': 'REPM', 'dst': {'type': 'addresses_WC_ht', 'congruent': 5, 'same': False}}
...
{'OP': 'STOR', 'dst': {'same': False, 'congruent': 3, 'NT': True, 'type': 'addresses_D_ht', 'size': 2, 'AVXalign': True}}
...
{'src': {'same': True, 'congruent': 11, 'NT': False, 'type': 'addresses_D_ht', 'size': 4, 'AVXalign': False}, 'OP': 'LOAD'}
{'34': 21829}
