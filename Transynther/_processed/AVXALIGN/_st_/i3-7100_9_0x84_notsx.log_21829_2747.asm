...
// REPMOV
lea addresses_normal+0x1c893, %rsi
lea addresses_normal+0x1c893, %rdi
nop
nop
nop
nop
...
// Faulty Load
lea addresses_normal+0x1c893, %rax
nop
nop
nop
sub %r12, %r12
...
{'src': {'type': 'addresses_normal', 'congruent': 0, 'same': True}, 'dst': {'type': 'addresses_normal', 'congruent': 0, 'same': True}, 'OP': 'REPM'}
