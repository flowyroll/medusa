...
lea addresses_WC_ht+0xbff0, %rdi
nop
nop
nop
and $59644, %r14
...
nop
add $56597, %rbp
lea addresses_A_ht+0x1fe4, %rsi
lea addresses_WT_ht+0x23f0, %rdi
sub $9283, %rdx
mov $18, %rcx
rep movsl
nop
...
nop
and %r13, %r13
lea addresses_UC_ht+0xf0f0, %r14
nop
nop
nop
nop
...
nop
and %rsi, %rsi
lea addresses_normal_ht+0xcf0c, %rbp
nop
nop
nop
nop
