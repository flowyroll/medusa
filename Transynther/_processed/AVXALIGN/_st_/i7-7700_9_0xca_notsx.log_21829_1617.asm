...
push %rdi
push %rdx
lea addresses_A_ht+0x17e04, %rdi
nop
nop
nop
nop
...
movb $0x61, (%rdi)
add %rbx, %rbx
lea addresses_WT_ht+0x417c, %rcx
nop
nop
nop
nop
...
nop
add $16218, %rdx
lea addresses_A_ht+0x12abc, %rdi
nop
nop
nop
nop
...
nop
add %rbp, %rbp
lea addresses_WC_ht+0xdd3c, %rdi
cmp $7638, %r8
vmovups (%rdi), %ymm6
...
nop
add %r12, %r12
lea addresses_UC_ht+0x97bc, %r12
nop
cmp $32225, %rbp
mov (%r12), %rbx
nop
...
nop
cmp %rdx, %rdx
lea addresses_normal_ht+0x1d14, %r8
nop
sub %rbx, %rbx
...
// Store
lea addresses_normal+0x6980, %r12
nop
nop
add %r15, %r15
...
{'dst': {'NT': True, 'AVXalign': False, 'size': 4, 'congruent': 6, 'same': False, 'type': 'addresses_D_ht'}, 'OP': 'STOR'}
{'src': {'NT': False, 'AVXalign': True, 'size': 8, 'congruent': 6, 'same': False, 'type': 'addresses_UC_ht'}, 'OP': 'LOAD'}
