...
push %rdx
push %rsi
lea addresses_UC_ht+0x3f16, %r11
nop
nop
nop
nop
...
nop
cmp %r11, %r11
lea addresses_WC_ht+0xf24a, %r10
xor %rdx, %rdx
movb $0x61, (%r10)
nop
nop
...
nop
xor %r10, %r10
lea addresses_WT_ht+0x15032, %r9
nop
nop
nop
nop
...
nop
cmp $18845, %r9
lea addresses_UC_ht+0x1d454, %r14
nop
nop
nop
nop
...
nop
dec %r11
lea addresses_UC_ht+0x1e7ca, %rsi
lea addresses_WT_ht+0x19ca, %rdi
nop
nop
nop
nop
...
nop
and %rdi, %rdi
lea addresses_D_ht+0x52ca, %r11
nop
nop
sub %rcx, %rcx
mov (%r11), %edx
add %rdi, %rdi
lea addresses_A_ht+0xa09e, %rsi
lea addresses_A_ht+0x1d7ca, %rdi
cmp %r10, %r10
mov $44, %rcx
rep movsq
add %r11, %r11
