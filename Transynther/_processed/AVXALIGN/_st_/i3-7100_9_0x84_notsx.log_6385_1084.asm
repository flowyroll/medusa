...
nop
and %r12, %r12
lea addresses_UC_ht+0x17cad, %rdx
nop
inc %rsi
...
nop
xor $2128, %rbp
lea addresses_UC_ht+0xfcad, %rsi
lea addresses_D_ht+0x5ad, %rdi
nop
nop
nop
xor $33738, %r15
...
{'dst': {'type': 'addresses_D_ht', 'same': True, 'size': 16, 'congruent': 8, 'NT': False, 'AVXalign': True}, 'OP': 'STOR'}
{'36': 6385}
