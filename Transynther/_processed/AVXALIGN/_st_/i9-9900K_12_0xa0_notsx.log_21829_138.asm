...
nop
cmp $8228, %rdi
lea addresses_UC_ht+0xa7c8, %r15
nop
sub $60006, %r13
...
nop
and %rdi, %rdi
lea addresses_WC_ht+0xd110, %r13
nop
nop
nop
sub %rbx, %rbx
...
nop
xor %rsi, %rsi
lea addresses_WT_ht+0x12340, %r13
nop
nop
nop
and %r15, %r15
