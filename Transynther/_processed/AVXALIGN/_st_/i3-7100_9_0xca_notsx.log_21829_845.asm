...
nop
and %rsi, %rsi
lea addresses_A_ht+0x136ac, %r13
nop
nop
nop
inc %r9
...
nop
sub %rsi, %rsi
lea addresses_D_ht+0x1e82c, %rsi
lea addresses_WT_ht+0xb4ac, %rdi
nop
nop
nop
nop
...
nop
sub %rsi, %rsi
lea addresses_normal_ht+0x1792c, %rsi
lea addresses_WT_ht+0x1a0da, %rdi
nop
nop
nop
nop
...
nop
sub %r9, %r9
lea addresses_D_ht+0x1e6fc, %rsi
nop
nop
dec %r9
...
movups %xmm6, (%rsi)
cmp %r12, %r12
lea addresses_UC_ht+0x14eac, %r11
nop
nop
nop
xor %rdx, %rdx
...
nop
sub %r11, %r11
lea addresses_D_ht+0x17cac, %rsi
lea addresses_A_ht+0xbaac, %rdi
nop
nop
nop
nop
...
nop
and $16707, %rdi
lea addresses_A_ht+0x102ac, %rdx
add $16299, %rcx
mov $0x6162636465666768, %r13
movq %r13, (%rdx)
cmp %rcx, %rcx
lea addresses_WT_ht+0x88b4, %r12
nop
nop
and %rcx, %rcx
movb (%r12), %r13b
...
nop
cmp %r9, %r9
lea addresses_normal_ht+0x28ac, %rsi
lea addresses_A_ht+0x1aa1c, %rdi
nop
nop
nop
inc %r11
...
nop
dec %r11
lea addresses_D_ht+0x1277c, %rdi
nop
nop
nop
nop
...
nop
sub $35767, %r11
lea addresses_normal_ht+0x85ac, %rsi
and $20824, %rdi
movb $0x61, (%rsi)
nop
nop
...
[Faulty Load]
{'src': {'same': True, 'congruent': 0, 'NT': False, 'type': 'addresses_D', 'size': 4, 'AVXalign': True}, 'OP': 'LOAD'}
<gen_prepare_buffer>
{'src': {'type': 'addresses_WC_ht', 'congruent': 11, 'same': False}, 'OP': 'REPM', 'dst': {'type': 'addresses_WT_ht', 'congruent': 9, 'same': True}}
...
{'src': {'type': 'addresses_D_ht', 'congruent': 5, 'same': False}, 'OP': 'REPM', 'dst': {'type': 'addresses_WT_ht', 'congruent': 10, 'same': False}}
{'src': {'type': 'addresses_normal_ht', 'congruent': 7, 'same': False}, 'OP': 'REPM', 'dst': {'type': 'addresses_WT_ht', 'congruent': 1, 'same': False}}
