...
push %rdi
push %rsi
lea addresses_normal_ht+0x173c8, %rsi
lea addresses_WT_ht+0x11f18, %rdi
nop
nop
nop
nop
...
nop
xor $37586, %r14
lea addresses_UC_ht+0xb498, %rbp
clflush (%rbp)
nop
nop
nop
...
vpextrq $0, %xmm3, %r14
add %rbp, %rbp
lea addresses_UC_ht+0x2518, %rbp
clflush (%rbp)
nop
nop
nop
...
nop
add $54619, %r14
lea addresses_WC_ht+0x1ad18, %rsi
nop
nop
nop
nop
...
nop
and $4613, %rbp
lea addresses_D_ht+0x1cb98, %rbx
add %rsi, %rsi
mov (%rbx), %edi
nop
nop
...
nop
and $28970, %r10
lea addresses_WC_ht+0x8ff8, %rdi
nop
add $8009, %rcx
...
// Faulty Load
lea addresses_normal+0x9d18, %r15
nop
nop
nop
nop
...
{'src': {'type': 'addresses_D', 'congruent': 1, 'same': False}, 'OP': 'REPM', 'dst': {'type': 'addresses_WT', 'congruent': 2, 'same': False}}
[Faulty Load]
{'src': {'same': True, 'congruent': 0, 'NT': False, 'type': 'addresses_normal', 'size': 4, 'AVXalign': True}, 'OP': 'LOAD'}
<gen_prepare_buffer>
{'src': {'type': 'addresses_normal_ht', 'congruent': 4, 'same': False}, 'OP': 'REPM', 'dst': {'type': 'addresses_WT_ht', 'congruent': 5, 'same': False}}
