...
nop
inc %rax
lea addresses_WT_ht+0x180e3, %r9
clflush (%r9)
nop
and $21602, %rdi
movb (%r9), %r10b
nop
dec %rax
lea addresses_UC_ht+0x1483, %r13
nop
xor $58359, %rcx
movb $0x61, (%r13)
nop
...
nop
sub %r9, %r9
lea addresses_UC_ht+0x1ada3, %rsi
lea addresses_A_ht+0x4ba3, %rdi
nop
nop
nop
nop
...
nop
cmp %r10, %r10
lea addresses_WT_ht+0x1c693, %r13
cmp %rdi, %rdi
mov (%r13), %r9
cmp $11979, %rdi
lea addresses_WT_ht+0x183a3, %rax
nop
nop
nop
nop
...
nop
cmp $16489, %r10
lea addresses_D_ht+0x15ba3, %rcx
xor $3157, %r9
mov (%rcx), %r13w
nop
nop
