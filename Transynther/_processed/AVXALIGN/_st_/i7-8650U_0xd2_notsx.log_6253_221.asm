...
nop
inc %r12
lea addresses_UC_ht+0xefd5, %rsi
lea addresses_A_ht+0x3537, %rdi
clflush (%rdi)
nop
nop
nop
...
nop
sub %rcx, %rcx
lea addresses_D_ht+0x1c789, %rsi
nop
nop
and %r14, %r14
movups (%rsi), %xmm0
...
nop
sub $32640, %rdi
lea addresses_UC_ht+0x18b29, %rsi
clflush (%rsi)
nop
cmp $27599, %rcx
...
nop
dec %r14
lea addresses_A_ht+0x17b49, %rsi
lea addresses_WT_ht+0xd129, %rdi
nop
nop
and $46425, %r10
mov $79, %rcx
...
nop
and $46780, %r11
lea addresses_D_ht+0x1e789, %rdi
and $9240, %r10
movw $0x6162, (%rdi)
nop
nop
...
nop
sub $55592, %rdi
lea addresses_WC_ht+0x105d8, %rsi
lea addresses_UC_ht+0xce30, %rdi
nop
nop
nop
cmp %rdx, %rdx
...
// Store
lea addresses_normal+0xd261, %r11
add $36385, %r8
...
// REPMOV
lea addresses_D+0x1f146, %rsi
lea addresses_WT+0x1a321, %rdi
clflush (%rsi)
dec %r11
mov $51, %rcx
rep movsl
...
{'OP': 'REPM', 'src': {'type': 'addresses_D', 'congruent': 0, 'same': False}, 'dst': {'type': 'addresses_WT', 'congruent': 3, 'same': False}}
