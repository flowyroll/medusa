...
nop
dec %rbx
lea addresses_D_ht+0x14f33, %rsi
lea addresses_WC_ht+0xddf8, %rdi
nop
nop
nop
nop
...
movl $0x61626364, (%rsi)
xor $48110, %rax
lea addresses_A_ht+0x3953, %rcx
nop
inc %rdi
mov (%rcx), %rsi
add %rbx, %rbx
lea addresses_WT_ht+0xfad3, %r11
nop
add %rcx, %rcx
movups (%r11), %xmm5
vpextrq $0, %xmm5, %r8
