...
push %rdx
push %rsi
lea addresses_UC_ht+0x6dd4, %rsi
lea addresses_WT_ht+0xe9c, %rdi
nop
nop
nop
cmp $48412, %r11
...
rep movsb
dec %r11
lea addresses_normal_ht+0xb5a4, %rsi
lea addresses_normal_ht+0xffd8, %rdi
clflush (%rdi)
nop
cmp $32358, %r11
mov $120, %rcx
...
nop
and $38423, %r11
lea addresses_UC_ht+0xf6c4, %rdi
nop
nop
nop
nop
...
movb (%rdi), %bl
and %rdi, %rdi
lea addresses_WC_ht+0xd140, %rsi
nop
nop
nop
nop
...
vmovups %ymm7, (%rsi)
and %r11, %r11
lea addresses_WC_ht+0x4c34, %rsi
nop
nop
nop
cmp $32593, %r11
...
movups %xmm3, (%rbx)
inc %rbx
lea addresses_D_ht+0x1e134, %rsi
...
{'src': {'type': 'addresses_D_ht', 'congruent': 9, 'same': False}, 'OP': 'REPM', 'dst': {'type': 'addresses_WT_ht', 'congruent': 8, 'same': False}}
