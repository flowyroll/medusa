...
nop
cmp $24459, %rdi
lea addresses_WC_ht+0x3c6e, %r14
nop
nop
nop
sub $34180, %rdi
...
nop
and %rsi, %rsi
lea addresses_WC_ht+0x1322c, %rsi
lea addresses_D_ht+0x1c08e, %rdi
nop
nop
nop
nop
...
nop
dec %r14
lea addresses_D_ht+0x1cc7e, %rsi
lea addresses_UC_ht+0xdc6e, %rdi
nop
and %rdx, %rdx
mov $48, %rcx
rep movsw
...
nop
add %r10, %r10
lea addresses_WT_ht+0xa06e, %rcx
cmp %r9, %r9
movb $0x61, (%rcx)
nop
cmp $11132, %rsi
...
{'OP': 'STOR', 'dst': {'size': 32, 'NT': False, 'type': 'addresses_WC_ht', 'same': False, 'AVXalign': True, 'congruent': 11}}
{'OP': 'REPM', 'src': {'same': False, 'type': 'addresses_WC_ht', 'congruent': 1}, 'dst': {'same': False, 'type': 'addresses_D_ht', 'congruent': 2}}
{'OP': 'REPM', 'src': {'same': False, 'type': 'addresses_D_ht', 'congruent': 3}, 'dst': {'same': False, 'type': 'addresses_UC_ht', 'congruent': 11}}
