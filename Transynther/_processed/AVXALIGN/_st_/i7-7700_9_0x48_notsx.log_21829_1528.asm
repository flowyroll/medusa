...
push %rdx
push %rsi
lea addresses_UC_ht+0x1c6c1, %rbp
nop
nop
nop
and %r14, %r14
...
nop
lfence
lea addresses_WT_ht+0x10067, %rsi
lea addresses_WT_ht+0x1b231, %rdi
clflush (%rdi)
nop
nop
cmp $57198, %rbx
...
nop
dec %rbx
lea addresses_WT_ht+0x1ba31, %rdi
dec %rdx
movw $0x6162, (%rdi)
nop
nop
and $10829, %rbx
lea addresses_WC_ht+0x17a11, %r14
nop
nop
nop
nop
...
nop
xor $50672, %rdx
lea addresses_WC_ht+0x1e18d, %rcx
nop
nop
lfence
movups (%rcx), %xmm3
...
nop
sub $62035, %rbp
lea addresses_WT_ht+0x18604, %rcx
add %rsi, %rsi
...
nop
xor %rbp, %rbp
lea addresses_D_ht+0x127de, %rdx
nop
dec %rdi
movl $0x61626364, (%rdx)
nop
...
nop
dec %rbp
lea addresses_UC_ht+0x7631, %rbp
nop
sub %rbx, %rbx
movb (%rbp), %cl
nop
and %rbp, %rbp
lea addresses_UC_ht+0x13c1f, %rdx
nop
nop
nop
nop
...
nop
cmp $62068, %rcx
lea addresses_normal_ht+0x9ab1, %rsi
...
nop
mfence
lea addresses_normal_ht+0xc31, %rsi
lea addresses_normal_ht+0xb231, %rdi
add $5627, %rdx
mov $104, %rcx
rep movsb
nop
and $55588, %r11
lea addresses_WC_ht+0xfc71, %rcx
nop
dec %rsi
movb $0x61, (%rcx)
nop
sub $10737, %rsi
lea addresses_normal_ht+0x6031, %rbx
nop
cmp %rbp, %rbp
movb (%rbx), %r14b
nop
...
lea addresses_D_ht+0x14c31, %rdi
nop
nop
nop
nop
...
rep movsl
inc %rbx
lea addresses_WC_ht+0x3409, %rbp
and $47222, %rsi
mov $0x6162636465666768, %rbx
movq %rbx, %xmm4
movups %xmm4, (%rbp)
...
// Faulty Load
lea addresses_normal+0x7231, %r10
nop
nop
nop
cmp %rsi, %rsi
...
{'OP': 'LOAD', 'src': {'same': False, 'NT': True, 'AVXalign': False, 'size': 16, 'type': 'addresses_UC_ht', 'congruent': 1}}
{'dst': {'same': False, 'congruent': 0, 'type': 'addresses_A_ht'}, 'OP': 'REPM', 'src': {'same': False, 'congruent': 7, 'type': 'addresses_normal_ht'}}
{'dst': {'same': False, 'congruent': 11, 'type': 'addresses_normal_ht'}, 'OP': 'REPM', 'src': {'same': False, 'congruent': 9, 'type': 'addresses_normal_ht'}}
{'dst': {'same': False, 'NT': False, 'AVXalign': True, 'size': 1, 'type': 'addresses_WC_ht', 'congruent': 0}, 'OP': 'STOR'}
{'OP': 'LOAD', 'src': {'same': False, 'NT': False, 'AVXalign': False, 'size': 1, 'type': 'addresses_normal_ht', 'congruent': 9}}
{'dst': {'same': True, 'congruent': 9, 'type': 'addresses_D_ht'}, 'OP': 'REPM', 'src': {'same': False, 'congruent': 3, 'type': 'addresses_normal_ht'}}
