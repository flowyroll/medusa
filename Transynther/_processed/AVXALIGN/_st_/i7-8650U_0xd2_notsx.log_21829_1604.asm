...
push %rdx
push %rsi
lea addresses_normal_ht+0x134cf, %rdx
nop
nop
nop
add %r13, %r13
...
nop
xor $34572, %r14
lea addresses_normal_ht+0x116c7, %r11
nop
nop
add %rcx, %rcx
mov (%r11), %r13w
and $33138, %rcx
lea addresses_normal_ht+0x1308f, %rbx
nop
nop
nop
nop
...
nop
sub %r11, %r11
lea addresses_WT_ht+0x6c4f, %rsi
lea addresses_UC_ht+0x944f, %rdi
clflush (%rdi)
nop
nop
nop
...
// Store
lea addresses_normal+0x974f, %r9
nop
nop
cmp $19251, %rsi
...
// Store
lea addresses_normal+0x844f, %r9
nop
nop
cmp $43786, %r12
movl $0x51525354, (%r9)
...
// Faulty Load
lea addresses_normal+0x11c4f, %r15
nop
nop
nop
nop
...
{'OP': 'REPM', 'src': {'type': 'addresses_WT_ht', 'congruent': 10, 'same': True}, 'dst': {'type': 'addresses_UC_ht', 'congruent': 7, 'same': False}}
{'OP': 'LOAD', 'src': {'type': 'addresses_D_ht', 'size': 8, 'AVXalign': True, 'NT': False, 'congruent': 11, 'same': False}}
{'34': 21829}
