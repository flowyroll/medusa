...
nop
sub $14219, %rsi
lea addresses_UC_ht+0x191c4, %rcx
nop
nop
nop
nop
...
nop
and %r10, %r10
lea addresses_WT_ht+0x9442, %r10
nop
inc %rcx
movb $0x61, (%r10)
nop
nop
sub $27219, %rbx
lea addresses_normal_ht+0x18bbc, %rbx
nop
nop
nop
nop
...
nop
xor $6812, %rdi
lea addresses_WC_ht+0x12984, %rsi
lea addresses_WC_ht+0x1443a, %rdi
nop
nop
nop
nop
...
{'OP': 'STOR', 'dst': {'type': 'addresses_UC_ht', 'AVXalign': False, 'congruent': 6, 'size': 2, 'same': True, 'NT': False}}
