...
push %rdx
push %rsi
lea addresses_WT_ht+0x75fe, %rsi
lea addresses_UC_ht+0x1313e, %rdi
cmp %rax, %rax
mov $76, %rcx
rep movsl
nop
...
nop
sub $56950, %rdx
lea addresses_D_ht+0x96be, %rsi
lea addresses_WC_ht+0x19bbe, %rdi
nop
nop
cmp %r13, %r13
mov $69, %rcx
...
nop
and %r13, %r13
lea addresses_WC_ht+0x1d23a, %rdi
nop
nop
dec %r13
movb $0x61, (%rdi)
and %rsi, %rsi
lea addresses_A_ht+0x1d5be, %r11
clflush (%r11)
nop
nop
nop
...
nop
sub $36562, %rsi
lea addresses_D_ht+0x1227e, %rsi
lea addresses_WT_ht+0x12b5c, %rdi
sub $10452, %r12
mov $76, %rcx
rep movsq
nop
...
nop
dec %rsi
lea addresses_WC_ht+0x133be, %rax
nop
nop
nop
nop
...
movq %rdi, (%rax)
sub $45734, %r13
lea addresses_A_ht+0x1b9be, %rsi
and $16888, %r12
vmovups (%rsi), %ymm7
...
nop
cmp $39275, %r12
lea addresses_WT_ht+0x15ab0, %rcx
nop
nop
nop
nop
...
nop
and $12845, %rax
lea addresses_A_ht+0x8c9e, %rsi
lea addresses_WC_ht+0x15fb6, %rdi
nop
nop
nop
nop
...
// Store
lea addresses_normal+0x145be, %r12
nop
nop
nop
nop
...
{'dst': {'type': 'addresses_normal', 'same': True, 'size': 2, 'congruent': 8, 'NT': False, 'AVXalign': False}, 'OP': 'STOR'}
...
{'src': {'type': 'addresses_D_ht', 'congruent': 6, 'same': False}, 'dst': {'type': 'addresses_WT_ht', 'congruent': 1, 'same': False}, 'OP': 'REPM'}
...
{'src': {'type': 'addresses_A_ht', 'congruent': 4, 'same': False}, 'dst': {'type': 'addresses_WC_ht', 'congruent': 1, 'same': False}, 'OP': 'REPM'}
{'39': 21829}
