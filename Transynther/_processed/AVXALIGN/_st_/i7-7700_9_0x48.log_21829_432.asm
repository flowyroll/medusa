...
push %rdx
push %rsi
lea addresses_normal_ht+0x18689, %rsi
lea addresses_normal_ht+0x1a17d, %rdi
nop
add $5851, %r8
mov $10, %rcx
rep movsq
...
nop
and %rdx, %rdx
lea addresses_WT_ht+0x1874d, %r9
cmp %r13, %r13
movups (%r9), %xmm3
vpextrq $0, %xmm3, %r8
nop
xor %rsi, %rsi
lea addresses_A_ht+0x1d1fd, %rsi
lea addresses_WC_ht+0xbf1b, %rdi
clflush (%rdi)
nop
nop
nop
...
nop
cmp $21622, %r8
lea addresses_normal_ht+0x8f7d, %rdx
nop
nop
nop
lfence
...
nop
mfence
lea addresses_UC_ht+0x1d839, %rcx
nop
nop
sub $35237, %r9
mov (%rcx), %edx
...
nop
cmp %r8, %r8
lea addresses_WC_ht+0x13767, %r8
nop
nop
xor $3716, %r13
movups (%r8), %xmm6
...
nop
cmp %rdi, %rdi
lea addresses_D_ht+0x12975, %rdi
nop
nop
nop
nop
...
{'OP': 'STOR', 'dst': {'type': 'addresses_normal_ht', 'AVXalign': True, 'congruent': 9, 'size': 1, 'same': False, 'NT': False}}
