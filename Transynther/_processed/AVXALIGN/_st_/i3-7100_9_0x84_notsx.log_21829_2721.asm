...
push %rdi
push %rsi
lea addresses_WT_ht+0x79a2, %rax
nop
add $6363, %rbx
mov (%rax), %r12w
nop
...
nop
and %r11, %r11
lea addresses_normal_ht+0xa570, %r12
inc %rdi
movb $0x61, (%r12)
nop
nop
nop
add %rax, %rax
lea addresses_normal_ht+0x7e2, %r11
nop
nop
add %rax, %rax
...
vpextrq $1, %xmm3, %rbx
xor %rdi, %rdi
lea addresses_WT_ht+0x32c6, %rdi
nop
nop
sub %r13, %r13
movl $0x61626364, (%rdi)
...
nop
sub %rax, %rax
lea addresses_WT_ht+0x107e2, %rbx
nop
nop
nop
and $52579, %r8
...
vmovups %ymm2, (%rbx)
add $22621, %r8
lea addresses_WT_ht+0xcf42, %rsi
lea addresses_WT_ht+0x10ba2, %rdi
nop
nop
nop
sub $62917, %rbx
...
{'dst': {'type': 'addresses_RW', 'same': False, 'size': 2, 'congruent': 10, 'NT': False, 'AVXalign': True}, 'OP': 'STOR'}
...
{'src': {'type': 'addresses_normal_ht', 'same': False, 'size': 32, 'congruent': 11, 'NT': False, 'AVXalign': True}, 'OP': 'LOAD'}
...
{'src': {'type': 'addresses_WT_ht', 'congruent': 5, 'same': False}, 'dst': {'type': 'addresses_WT_ht', 'congruent': 5, 'same': False}, 'OP': 'REPM'}
{'src': {'type': 'addresses_D_ht', 'congruent': 3, 'same': False}, 'dst': {'type': 'addresses_WT_ht', 'congruent': 9, 'same': False}, 'OP': 'REPM'}
{'32': 21829}
