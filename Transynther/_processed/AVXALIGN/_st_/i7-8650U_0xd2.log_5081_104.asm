...
nop
sub $57121, %r13
lea addresses_A_ht+0x18bd1, %rsi
clflush (%rsi)
nop
nop
nop
...
nop
sub %r13, %r13
lea addresses_normal_ht+0x6a51, %rsi
lea addresses_WC_ht+0x10fd1, %rdi
nop
nop
xor $65488, %r14
mov $99, %rcx
...
nop
add $21117, %rsi
lea addresses_normal_ht+0x88bd, %r9
nop
sub $11579, %rcx
movl $0x61626364, (%r9)
nop
nop
sub %r11, %r11
lea addresses_WC_ht+0x7ed1, %rsi
nop
nop
nop
xor $16222, %rdi
...
nop
dec %rcx
lea addresses_WC_ht+0x164f5, %rsi
clflush (%rsi)
nop
nop
nop
...
nop
add %r11, %r11
lea addresses_normal_ht+0x1a061, %rsi
lea addresses_UC_ht+0x45e1, %rdi
clflush (%rsi)
clflush (%rdi)
nop
nop
...
nop
sub $49488, %rdx
lea addresses_WT_ht+0x99d1, %rsi
lea addresses_D_ht+0x4351, %rdi
nop
nop
xor %r13, %r13
mov $52, %rcx
...
nop
sub $51428, %rdx
lea addresses_normal_ht+0x14451, %rcx
clflush (%rcx)
add %r9, %r9
movb $0x61, (%rcx)
nop
...
nop
inc %rsi
lea addresses_UC_ht+0x1ccd1, %r11
nop
nop
nop
inc %rcx
...
{'OP': 'STOR', 'dst': {'type': 'addresses_normal_ht', 'size': 1, 'AVXalign': True, 'NT': False, 'congruent': 6, 'same': False}}
