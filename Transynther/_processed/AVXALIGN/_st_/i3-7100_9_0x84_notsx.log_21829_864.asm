...
push %rdx
push %rsi
lea addresses_UC_ht+0xb020, %rsi
lea addresses_D_ht+0x1d13a, %rdi
cmp $47871, %r15
mov $107, %rcx
rep movsl
nop
nop
dec %r10
lea addresses_UC_ht+0x3c60, %rdx
clflush (%rdx)
add $23696, %r10
...
lea addresses_normal_ht+0x2460, %rdi
nop
nop
nop
nop
...
nop
xor %r15, %r15
lea addresses_A_ht+0x166f0, %rcx
nop
sub $63367, %rdi
mov (%rcx), %r9w
nop
nop
and %r10, %r10
lea addresses_WC_ht+0x13c60, %rsi
nop
nop
nop
nop
...
// REPMOV
lea addresses_UC+0x13460, %rsi
lea addresses_D+0x11040, %rdi
clflush (%rsi)
nop
nop
nop
...
{'src': {'type': 'addresses_UC', 'congruent': 0, 'same': True}, 'dst': {'type': 'addresses_D', 'congruent': 4, 'same': False}, 'OP': 'REPM'}
[Faulty Load]
...
{'src': {'type': 'addresses_WT_ht', 'congruent': 8, 'same': False}, 'dst': {'type': 'addresses_normal_ht', 'congruent': 10, 'same': False}, 'OP': 'REPM'}
