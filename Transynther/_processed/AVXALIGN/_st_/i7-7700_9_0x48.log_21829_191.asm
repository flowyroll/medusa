...
push %rdx
push %rsi
lea addresses_WC_ht+0x4ca8, %rax
nop
nop
nop
nop
...
nop
and %rsi, %rsi
lea addresses_WT_ht+0x10b10, %rsi
lea addresses_A_ht+0x7cc1, %rdi
nop
dec %r9
mov $113, %rcx
rep movsw
...
nop
cmp $28568, %rdx
lea addresses_WC_ht+0xc8b0, %rdi
nop
nop
nop
nop
...
nop
cmp $40489, %rdx
lea addresses_UC_ht+0x6230, %rcx
and $52276, %rdi
mov (%rcx), %ax
nop
nop
xor $19129, %rdx
lea addresses_D_ht+0x144b0, %rdx
and %r14, %r14
...
nop
xor %rdi, %rdi
lea addresses_WC_ht+0x64b0, %r14
nop
nop
nop
sub $27164, %rsi
movb $0x61, (%r14)
sub %rdx, %rdx
lea addresses_WT_ht+0x145b0, %rdx
nop
nop
nop
nop
...
// Faulty Load
lea addresses_normal+0x13cb0, %rcx
nop
nop
nop
cmp %rax, %rax
