...
push %rdx
push %rsi
lea addresses_WC_ht+0x1c7db, %r14
nop
nop
nop
nop
...
nop
sub $27898, %r11
lea addresses_WT_ht+0x335b, %rdx
nop
sub %rbx, %rbx
movw $0x6162, (%rdx)
nop
nop
xor $10820, %r14
lea addresses_WC_ht+0x132f3, %rbx
nop
nop
and %rsi, %rsi
movl $0x61626364, (%rbx)
