...
nop
sub %rsi, %rsi
lea addresses_UC_ht+0x1b9d0, %r14
nop
nop
nop
nop
...
rep movsq
dec %r9
lea addresses_UC_ht+0x8468, %r14
nop
nop
nop
nop
...
movw $0x6162, (%r14)
dec %rax
lea addresses_WT_ht+0x1b638, %rsi
lea addresses_WC_ht+0x12a78, %rdi
and $2244, %r12
mov $23, %rcx
rep movsw
nop
...
{'OP': 'REPM', 'src': {'type': 'addresses_D_ht', 'congruent': 5, 'same': False}, 'dst': {'type': 'addresses_A_ht', 'congruent': 6, 'same': False}}
