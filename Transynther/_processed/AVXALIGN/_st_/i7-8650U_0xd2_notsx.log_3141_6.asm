...
nop
cmp %rcx, %rcx
lea addresses_WT_ht+0x12238, %r15
nop
nop
sub $14572, %r9
...
nop
cmp %r9, %r9
lea addresses_normal_ht+0x19238, %rsi
lea addresses_normal_ht+0x16118, %rdi
nop
inc %r14
mov $23, %rcx
rep movsq
...
nop
cmp %r12, %r12
lea addresses_WT_ht+0x11df8, %rsi
nop
xor %r14, %r14
mov (%rsi), %edi
nop
...
nop
sub %r15, %r15
lea addresses_WT_ht+0x11d78, %rsi
lea addresses_normal_ht+0x4238, %rdi
nop
nop
nop
and $59384, %r14
...
{'OP': 'REPM', 'src': {'type': 'addresses_normal_ht', 'congruent': 11, 'same': False}, 'dst': {'type': 'addresses_normal_ht', 'congruent': 4, 'same': False}}
...
{'OP': 'REPM', 'src': {'type': 'addresses_WT_ht', 'congruent': 6, 'same': True}, 'dst': {'type': 'addresses_normal_ht', 'congruent': 10, 'same': False}}
