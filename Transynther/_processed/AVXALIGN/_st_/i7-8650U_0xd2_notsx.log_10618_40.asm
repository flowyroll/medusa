...
lea addresses_WC_ht+0x1c9a3, %rdi
cmp %rdx, %rdx
mov $51, %rcx
rep movsq
nop
...
nop
and $65231, %rcx
lea addresses_A_ht+0x1dfa3, %rsi
lea addresses_normal_ht+0x47a3, %rdi
clflush (%rsi)
inc %r10
mov $119, %rcx
rep movsl
...
lea addresses_WT_ht+0x8b63, %rdi
nop
nop
and $47812, %r10
mov $93, %rcx
...
nop
and %rdx, %rdx
lea addresses_WC_ht+0x1d763, %rsi
lea addresses_A_ht+0x1dfdb, %rdi
nop
nop
cmp %r10, %r10
mov $52, %rcx
...
nop
dec %rdx
lea addresses_A_ht+0x18503, %rsi
lea addresses_D_ht+0x5730, %rdi
nop
nop
cmp $35754, %r9
mov $54, %rcx
...
lea addresses_WT_ht+0x9a23, %rdi
clflush (%rsi)
nop
cmp $37448, %r12
mov $19, %rcx
...
lea addresses_normal_ht+0x1e3a3, %rdi
nop
nop
inc %r11
mov $13, %rcx
...
nop
inc %rdx
lea addresses_UC_ht+0x53a3, %rsi
lea addresses_WC_ht+0x15d63, %rdi
nop
nop
nop
xor $10312, %r12
...
nop
add $24054, %r11
lea addresses_UC_ht+0x4f36, %r11
nop
nop
dec %r9
mov (%r11), %r12
...
<gen_prepare_buffer>
{'OP': 'REPM', 'src': {'type': 'addresses_WC_ht', 'congruent': 9, 'same': False}, 'dst': {'type': 'addresses_D_ht', 'congruent': 4, 'same': False}}
{'OP': 'REPM', 'src': {'type': 'addresses_D_ht', 'congruent': 7, 'same': False}, 'dst': {'type': 'addresses_WC_ht', 'congruent': 9, 'same': False}}
{'OP': 'REPM', 'src': {'type': 'addresses_A_ht', 'congruent': 7, 'same': False}, 'dst': {'type': 'addresses_normal_ht', 'congruent': 8, 'same': False}}
