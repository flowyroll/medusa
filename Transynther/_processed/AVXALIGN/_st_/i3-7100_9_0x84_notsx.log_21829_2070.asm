...
push %rdx
push %rsi
lea addresses_D_ht+0x1574a, %rsi
lea addresses_WC_ht+0xbe4a, %rdi
clflush (%rsi)
nop
xor $13523, %r13
mov $99, %rcx
...
nop
and %r13, %r13
lea addresses_normal_ht+0x874a, %rsi
...
rep movsl
and $24426, %rsi
lea addresses_D_ht+0x1604a, %r13
nop
nop
nop
cmp $14289, %rsi
...
nop
cmp %r13, %r13
lea addresses_WT_ht+0x12de6, %rax
nop
nop
sub %r9, %r9
movw $0x6162, (%rax)
nop
xor $38804, %r9
lea addresses_normal_ht+0x9b4a, %rdi
nop
nop
xor $47734, %rax
mov (%rdi), %r9d
...
nop
add %rsi, %rsi
lea addresses_normal_ht+0x13b2, %rsi
lea addresses_D_ht+0x10dea, %rdi
nop
nop
nop
nop
...
rep movsl
sub $55044, %rsi
lea addresses_WT_ht+0x14bf6, %rdi
cmp %rbx, %rbx
...
// Store
lea addresses_normal+0x17bca, %rsi
clflush (%rsi)
add $30385, %r15
...
// Load
lea addresses_normal+0x97db, %rdx
nop
cmp $22705, %r12
movups (%rdx), %xmm6
vpextrq $0, %xmm6, %r14
...
{'src': {'type': 'addresses_normal_ht', 'congruent': 11, 'same': True}, 'dst': {'type': 'addresses_normal_ht', 'congruent': 9, 'same': False}, 'OP': 'REPM'}
{'src': {'type': 'addresses_D_ht', 'same': True, 'size': 8, 'congruent': 7, 'NT': False, 'AVXalign': True}, 'OP': 'LOAD'}
...
{'src': {'type': 'addresses_normal_ht', 'congruent': 2, 'same': False}, 'dst': {'type': 'addresses_D_ht', 'congruent': 5, 'same': False}, 'OP': 'REPM'}
