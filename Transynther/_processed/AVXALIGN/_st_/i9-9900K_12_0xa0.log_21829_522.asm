...
push %rdi
push %rsi
lea addresses_WT_ht+0x9faa, %rbx
add %r15, %r15
mov $0x6162636465666768, %rbp
movq %rbp, %xmm2
movups %xmm2, (%rbx)
sub $14849, %r14
lea addresses_WC_ht+0x1066a, %rcx
nop
nop
nop
nop
...
mov (%rcx), %r9
add $5444, %r15
lea addresses_WC_ht+0x13c2c, %rdi
nop
nop
sub %r9, %r9
mov (%rdi), %ecx
...
nop
add %rbp, %rbp
lea addresses_UC_ht+0x52ba, %rcx
clflush (%rcx)
dec %rdi
movb (%rcx), %r14b
nop
...
nop
xor $13042, %r9
lea addresses_WT_ht+0x9a6a, %rbp
nop
nop
nop
nop
...
nop
add $52291, %rdi
lea addresses_D_ht+0x1ad0a, %r15
nop
nop
nop
xor %r9, %r9
...
lea addresses_normal_ht+0x1766a, %rdi
nop
nop
nop
nop
...
{'src': {'NT': False, 'same': False, 'congruent': 4, 'type': 'addresses_UC_ht', 'AVXalign': True, 'size': 1}, 'OP': 'LOAD'}
{'OP': 'STOR', 'dst': {'NT': False, 'same': False, 'congruent': 10, 'type': 'addresses_WT_ht', 'AVXalign': True, 'size': 8}}
{'OP': 'STOR', 'dst': {'NT': False, 'same': False, 'congruent': 5, 'type': 'addresses_D_ht', 'AVXalign': False, 'size': 16}}
{'src': {'same': False, 'congruent': 6, 'type': 'addresses_D_ht'}, 'OP': 'REPM', 'dst': {'same': False, 'congruent': 11, 'type': 'addresses_normal_ht'}}
{'32': 21829}
