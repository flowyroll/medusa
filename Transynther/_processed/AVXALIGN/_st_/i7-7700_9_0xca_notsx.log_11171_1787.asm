...
push %rbp
push %rdx
lea addresses_normal_ht+0xf72b, %rdx
dec %r8
mov $0x6162636465666768, %r15
movq %r15, (%rdx)
sub $41190, %r12
lea addresses_UC_ht+0x1cb2b, %r13
nop
nop
and $23656, %rdx
movb $0x61, (%r13)
sub %r12, %r12
lea addresses_WT_ht+0x16c2b, %rbp
clflush (%rbp)
sub $35228, %r13
movups (%rbp), %xmm2
vpextrq $0, %xmm2, %r8
add $26131, %r8
lea addresses_WC_ht+0x3d2b, %r13
nop
nop
nop
sub $26944, %rax
...
vpextrq $1, %xmm4, %r8
inc %rdx
lea addresses_UC_ht+0x1b2ab, %rax
and $56038, %r12
movb (%rax), %r13b
cmp $6662, %r13
lea addresses_A_ht+0xc2b, %rax
nop
nop
nop
sub $54192, %r12
...
{'dst': {'NT': True, 'AVXalign': False, 'size': 16, 'congruent': 1, 'same': False, 'type': 'addresses_US'}, 'OP': 'STOR'}
