...
push %rdi
push %rsi
lea addresses_WC_ht+0x5486, %r9
sub $19758, %rcx
movb $0x61, (%r9)
lfence
lea addresses_A_ht+0x1183a, %rsi
lea addresses_WC_ht+0x10c86, %rdi
nop
nop
nop
add %rbp, %rbp
...
nop
xor %rcx, %rcx
lea addresses_normal_ht+0x6906, %r8
xor %rdi, %rdi
movb (%r8), %bl
nop
nop
nop
dec %rcx
lea addresses_WT_ht+0x1ce1c, %rbx
cmp %rdi, %rdi
movw $0x6162, (%rbx)
add %rbp, %rbp
lea addresses_A_ht+0x1726, %rcx
xor %rbx, %rbx
movl $0x61626364, (%rcx)
nop
nop
...
nop
xor %rbx, %rbx
lea addresses_UC_ht+0x9bfa, %rbp
nop
nop
nop
sub %r9, %r9
...
nop
sub $42627, %rbx
lea addresses_WC_ht+0x173fa, %rbp
nop
nop
nop
nop
...
// Store
lea addresses_normal+0x1e756, %r15
nop
nop
nop
dec %r14
...
{'OP': 'REPM', 'src': {'same': False, 'congruent': 1, 'type': 'addresses_A_ht'}, 'dst': {'same': False, 'congruent': 10, 'type': 'addresses_WC_ht'}}
...
{'OP': 'STOR', 'dst': {'same': False, 'type': 'addresses_WC_ht', 'NT': True, 'AVXalign': False, 'size': 16, 'congruent': 1}}
{'33': 21829}
