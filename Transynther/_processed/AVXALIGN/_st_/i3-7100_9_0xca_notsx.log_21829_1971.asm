...
push %rdi
push %rsi
lea addresses_A_ht+0x17000, %r15
nop
nop
nop
nop
...
nop
and %r8, %r8
lea addresses_D_ht+0x1a100, %rbp
nop
nop
and $1801, %r12
movb $0x61, (%rbp)
...
nop
sub $7421, %r15
lea addresses_D_ht+0x10fa0, %rsi
lea addresses_UC_ht+0x9120, %rdi
nop
nop
nop
add $8074, %r15
...
rep movsl
cmp $20085, %r9
lea addresses_D_ht+0xe778, %rsi
lea addresses_A_ht+0x12400, %rdi
nop
nop
nop
cmp %r8, %r8
...
nop
xor %rdi, %rdi
lea addresses_UC_ht+0x1894a, %rbp
nop
nop
nop
nop
...
nop
add $22135, %rbp
lea addresses_WT_ht+0x5100, %rcx
nop
nop
sub %r9, %r9
vmovups (%rcx), %ymm3
...
nop
dec %r9
lea addresses_UC_ht+0xb2e0, %rsi
lea addresses_normal_ht+0x13400, %rdi
nop
nop
nop
nop
...
nop
add %rbp, %rbp
lea addresses_UC_ht+0x161e0, %r12
add $6182, %rsi
mov (%r12), %di
nop
nop
xor $57857, %rbp
lea addresses_D_ht+0x41e0, %rsi
lea addresses_A_ht+0x15be0, %rdi
clflush (%rsi)
nop
nop
nop
...
nop
dec %rdi
lea addresses_A_ht+0x1e860, %rsi
lea addresses_A_ht+0x12370, %rdi
nop
nop
nop
nop
...
nop
add %r15, %r15
lea addresses_WC_ht+0x7100, %r12
lfence
vmovups (%r12), %ymm6
...
nop
add %r12, %r12
lea addresses_D_ht+0x1c700, %rsi
lea addresses_D_ht+0x8e20, %rdi
nop
add $18140, %r9
mov $121, %rcx
rep movsq
nop
cmp %r12, %r12
lea addresses_WC_ht+0x12c0, %rsi
nop
nop
nop
nop
...
nop
inc %rsi
lea addresses_WC_ht+0xc500, %r15
nop
nop
nop
sub %r9, %r9
...
{'src': {'same': True, 'congruent': 11, 'NT': False, 'type': 'addresses_WT_ht', 'size': 32, 'AVXalign': False}, 'OP': 'LOAD'}
...
{'src': {'type': 'addresses_A_ht', 'congruent': 4, 'same': True}, 'OP': 'REPM', 'dst': {'type': 'addresses_A_ht', 'congruent': 4, 'same': True}}
