...
push %rdx
push %rsi
lea addresses_normal_ht+0x9fcc, %rdi
nop
cmp %rax, %rax
vmovups (%rdi), %ymm6
...
nop
xor %rdx, %rdx
lea addresses_normal_ht+0x189cc, %rdx
nop
nop
nop
nop
...
nop
cmp $33708, %rbp
lea addresses_WC_ht+0xfcdc, %rbp
nop
nop
nop
add %r9, %r9
...
nop
dec %r14
lea addresses_WC_ht+0x1dbcc, %rsi
lea addresses_normal_ht+0x1748c, %rdi
clflush (%rsi)
xor $65126, %r9
mov $12, %rcx
rep movsb
nop
dec %rbp
lea addresses_WT_ht+0x17f4c, %rsi
lea addresses_A_ht+0x15ecc, %rdi
clflush (%rdi)
nop
nop
nop
...
nop
cmp $42027, %rax
lea addresses_normal_ht+0x524c, %rsi
lea addresses_WT_ht+0x554c, %rdi
clflush (%rdi)
nop
nop
dec %r14
...
nop
sub %rsi, %rsi
lea addresses_WC_ht+0x8bcc, %rsi
lea addresses_WT_ht+0x531c, %rdi
clflush (%rsi)
sub %r14, %r14
mov $121, %rcx
rep movsw
