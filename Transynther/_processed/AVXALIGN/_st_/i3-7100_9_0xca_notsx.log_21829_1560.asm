...
push %rdi
push %rsi
lea addresses_WC_ht+0x1dd92, %r10
nop
nop
nop
sub %rcx, %rcx
...
nop
dec %r9
lea addresses_UC_ht+0xc23e, %rsi
lea addresses_WT_ht+0x9f92, %rdi
clflush (%rsi)
nop
nop
inc %rax
...
nop
cmp %r11, %r11
lea addresses_normal_ht+0x6e92, %r11
nop
cmp $54248, %rdi
mov (%r11), %ecx
nop
...
nop
and $34412, %r11
lea addresses_D_ht+0x1ea92, %rsi
lea addresses_WT_ht+0x1a392, %rdi
nop
nop
nop
dec %r14
...
nop
sub $25634, %r11
lea addresses_UC_ht+0x11e92, %rcx
nop
nop
inc %r9
movb $0x61, (%rcx)
cmp $756, %rdi
lea addresses_WT_ht+0x14250, %rsi
nop
nop
nop
cmp $40913, %r9
...
nop
xor %r10, %r10
lea addresses_A_ht+0xc892, %rsi
lea addresses_WT_ht+0x1d992, %rdi
nop
add $47886, %r9
mov $100, %rcx
rep movsb
and $52518, %r14
lea addresses_UC_ht+0x74f2, %rax
nop
nop
nop
dec %r10
...
mov (%r9), %r14
add %rax, %rax
lea addresses_normal_ht+0x5dd2, %rcx
nop
nop
mfence
movb (%rcx), %r9b
...
lea addresses_WC_ht+0x18d92, %rdi
sub %r9, %r9
mov $9, %rcx
rep movsw
nop
...
// Store
lea addresses_normal+0x7b10, %rdi
nop
nop
add $50051, %rbp
movb $0x51, (%rdi)
...
{'src': {'same': True, 'congruent': 8, 'NT': False, 'type': 'addresses_normal_ht', 'size': 4, 'AVXalign': True}, 'OP': 'LOAD'}
{'src': {'type': 'addresses_D_ht', 'congruent': 8, 'same': False}, 'OP': 'REPM', 'dst': {'type': 'addresses_WT_ht', 'congruent': 8, 'same': False}}
