...
push %rdx
push %rsi
lea addresses_WT_ht+0x16471, %r11
nop
nop
nop
cmp %rcx, %rcx
...
nop
and $3570, %r11
lea addresses_normal_ht+0x95d, %rcx
cmp $63466, %r9
vmovups (%rcx), %ymm4
...
nop
and %rbp, %rbp
lea addresses_UC_ht+0xb811, %rcx
nop
nop
nop
nop
...
nop
sub $59653, %rcx
lea addresses_D_ht+0x16d79, %rsi
nop
nop
nop
xor %rcx, %rcx
mov (%rsi), %r9w
add %rbp, %rbp
lea addresses_WT_ht+0xa671, %r11
nop
xor %rcx, %rcx
...
nop
dec %r9
lea addresses_A_ht+0x13f71, %rsi
lea addresses_UC_ht+0x15271, %rdi
nop
sub %r11, %r11
mov $83, %rcx
rep movsb
...
// Store
lea addresses_normal+0xde71, %rsi
nop
nop
nop
nop
