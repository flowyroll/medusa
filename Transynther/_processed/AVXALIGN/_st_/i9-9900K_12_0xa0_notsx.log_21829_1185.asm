...
push %rdi
push %rsi
lea addresses_normal_ht+0xf405, %rsi
lea addresses_A_ht+0x1a705, %rdi
clflush (%rdi)
xor $32511, %rbx
mov $60, %rcx
rep movsl
...
nop
sub %r14, %r14
lea addresses_normal_ht+0x1bb05, %rbx
clflush (%rbx)
nop
nop
and %r8, %r8
...
nop
inc %r8
lea addresses_WC_ht+0x187ad, %rcx
nop
nop
nop
xor %r15, %r15
...
movq %r14, (%rcx)
sub $53455, %rbx
lea addresses_D_ht+0x3e05, %r15
and $47721, %rsi
movl $0x61626364, (%r15)
nop
dec %rdi
lea addresses_A_ht+0x8b05, %rcx
nop
nop
nop
sub %rdi, %rdi
...
// Store
lea addresses_normal+0x1d005, %r14
nop
xor %r9, %r9
...
<gen_prepare_buffer>
{'src': {'type': 'addresses_normal_ht', 'congruent': 7, 'same': False}, 'OP': 'REPM', 'dst': {'type': 'addresses_A_ht', 'congruent': 9, 'same': True}}
