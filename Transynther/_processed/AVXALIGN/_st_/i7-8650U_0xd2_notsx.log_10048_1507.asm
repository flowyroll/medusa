...
push %rdi
push %rsi
lea addresses_WT_ht+0x9a1b, %rcx
cmp $30803, %rdi
mov (%rcx), %r13d
nop
nop
...
nop
dec %rax
lea addresses_normal_ht+0x133ca, %rsi
lea addresses_D_ht+0x19b62, %rdi
sub $19348, %rbx
mov $88, %rcx
rep movsb
nop
xor %rdi, %rdi
lea addresses_WT_ht+0x1cbca, %rsi
...
{'OP': 'STOR', 'dst': {'type': 'addresses_UC', 'size': 4, 'AVXalign': True, 'NT': False, 'congruent': 0, 'same': False}}
[Faulty Load]
