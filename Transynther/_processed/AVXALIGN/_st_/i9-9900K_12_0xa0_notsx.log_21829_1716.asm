...
push %rdi
push %rsi
lea addresses_D_ht+0x13c86, %rsi
lea addresses_D_ht+0xe608, %rdi
nop
nop
sub $18334, %rbp
mov $1, %rcx
...
nop
add $62743, %r13
lea addresses_WT_ht+0x9bf8, %r15
nop
cmp %rax, %rax
movb $0x61, (%r15)
nop
...
nop
xor $6123, %rdi
lea addresses_normal_ht+0x129f8, %r15
clflush (%r15)
nop
nop
nop
...
nop
and %rdi, %rdi
lea addresses_WC_ht+0x10378, %r15
nop
add $14443, %rax
...
nop
add $3027, %r15
lea addresses_normal_ht+0x6ff8, %rcx
nop
dec %rax
movb (%rcx), %r13b
nop
cmp $1313, %rdi
lea addresses_WT_ht+0x1837a, %rsi
lea addresses_WC_ht+0x1dff8, %rdi
nop
cmp %r11, %r11
mov $101, %rcx
rep movsl
...
nop
sub $32872, %rcx
lea addresses_A_ht+0x11f8, %rsi
lea addresses_WC_ht+0x1b1f8, %rdi
clflush (%rdi)
nop
nop
add %rbp, %rbp
...
nop
inc %rbp
lea addresses_WT_ht+0x12fd8, %r15
nop
nop
nop
and $4647, %rsi
movb (%r15), %al
sub %rdi, %rdi
lea addresses_UC_ht+0xead8, %rbp
nop
nop
nop
inc %r15
...
{'src': {'type': 'addresses_A_ht', 'congruent': 11, 'same': False}, 'OP': 'REPM', 'dst': {'type': 'addresses_WC_ht', 'congruent': 9, 'same': False}}
