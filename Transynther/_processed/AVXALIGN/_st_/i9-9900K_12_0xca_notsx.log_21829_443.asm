...
push %rdi
push %rsi
lea addresses_D_ht+0x40d2, %rsi
lea addresses_A_ht+0x9ad2, %rdi
nop
nop
nop
cmp %r8, %r8
...
nop
add $37920, %rax
lea addresses_normal_ht+0x1ad46, %rbp
nop
nop
nop
nop
...
nop
add %r11, %r11
lea addresses_WC_ht+0x1c922, %rsi
nop
add %rax, %rax
mov (%rsi), %r8
nop
add %rdi, %rdi
lea addresses_A_ht+0xc172, %rcx
clflush (%rcx)
nop
and $18782, %r8
...
nop
inc %rax
lea addresses_D_ht+0x1e2a2, %r11
clflush (%r11)
nop
nop
xor %rsi, %rsi
...
nop
dec %rcx
lea addresses_A_ht+0x19d52, %rcx
nop
nop
nop
cmp $63973, %rdi
...
nop
xor %rax, %rax
lea addresses_WC_ht+0x171d2, %rsi
lea addresses_D_ht+0xcdb2, %rdi
nop
nop
nop
and $43508, %r8
...
rep movsl
cmp $16920, %rdi
lea addresses_A_ht+0x12e52, %rdi
clflush (%rdi)
nop
nop
nop
...
// Faulty Load
lea addresses_normal+0x1c8d2, %rcx
nop
nop
nop
inc %rax
...
{'OP': 'LOAD', 'src': {'same': False, 'type': 'addresses_A_ht', 'NT': True, 'AVXalign': False, 'size': 32, 'congruent': 5}}
{'OP': 'LOAD', 'src': {'same': False, 'type': 'addresses_WC_ht', 'NT': False, 'AVXalign': False, 'size': 16, 'congruent': 1}}
{'OP': 'STOR', 'dst': {'same': False, 'type': 'addresses_D_ht', 'NT': False, 'AVXalign': True, 'size': 16, 'congruent': 1}}
{'OP': 'STOR', 'dst': {'same': False, 'type': 'addresses_A_ht', 'NT': False, 'AVXalign': False, 'size': 16, 'congruent': 5}}
{'OP': 'REPM', 'src': {'same': False, 'congruent': 8, 'type': 'addresses_WC_ht'}, 'dst': {'same': False, 'congruent': 3, 'type': 'addresses_D_ht'}}
