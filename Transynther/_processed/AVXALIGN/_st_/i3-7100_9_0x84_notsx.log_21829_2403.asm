...
movb $0x61, (%r11)
add $58693, %rdx
lea addresses_WT_ht+0xb2db, %rsi
lea addresses_normal_ht+0x1529b, %rdi
and %r15, %r15
mov $73, %rcx
rep movsw
nop
...
nop
xor %rsi, %rsi
lea addresses_UC_ht+0x1d379, %rsi
lea addresses_A_ht+0x1e0bb, %rdi
nop
nop
nop
cmp $39914, %r15
...
nop
inc %rdx
lea addresses_normal_ht+0x1e2c9, %r10
nop
nop
nop
add $2790, %r9
...
{'src': {'type': 'addresses_UC_ht', 'congruent': 1, 'same': False}, 'dst': {'type': 'addresses_A_ht', 'congruent': 4, 'same': False}, 'OP': 'REPM'}
