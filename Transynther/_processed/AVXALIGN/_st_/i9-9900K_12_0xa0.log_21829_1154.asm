...
nop
cmp %r13, %r13
lea addresses_D_ht+0x6c6d, %rsi
lea addresses_A_ht+0x2ecd, %rdi
nop
nop
cmp $5836, %r9
mov $60, %rcx
...
nop
and %r8, %r8
lea addresses_UC_ht+0x17eed, %rsi
nop
nop
nop
nop
...
nop
lfence
lea addresses_D_ht+0x147cd, %r11
and %rdi, %rdi
movb $0x61, (%r11)
and %rcx, %rcx
pop %rsi
...
{'src': {'NT': True, 'same': False, 'congruent': 1, 'type': 'addresses_PSE', 'AVXalign': False, 'size': 8}, 'OP': 'LOAD'}
...
{'src': {'same': False, 'congruent': 4, 'type': 'addresses_D_ht'}, 'OP': 'REPM', 'dst': {'same': False, 'congruent': 5, 'type': 'addresses_A_ht'}}
