...
push %rdi
push %rsi
lea addresses_D_ht+0x29d0, %rsi
lea addresses_WC_ht+0xdc40, %rdi
and %r13, %r13
mov $78, %rcx
rep movsq
nop
...
nop
xor %rax, %rax
lea addresses_A_ht+0x9640, %rsi
lea addresses_UC_ht+0x13a40, %rdi
nop
nop
and %r11, %r11
mov $94, %rcx
rep movsb
cmp %r13, %r13
lea addresses_D_ht+0x178c2, %rax
nop
nop
nop
dec %rbp
...
nop
cmp %r11, %r11
lea addresses_WT_ht+0x2648, %r13
nop
nop
nop
nop
...
nop
sub %rsi, %rsi
lea addresses_WT_ht+0x18230, %r13
nop
nop
cmp %rbp, %rbp
mov (%r13), %r11
nop
add %r11, %r11
lea addresses_WC_ht+0xadc0, %rsi
nop
nop
nop
nop
...
nop
sub $33279, %rsi
lea addresses_A_ht+0x36c0, %rax
mfence
movb (%rax), %r13b
nop
nop
add $1538, %rdi
lea addresses_A_ht+0xf720, %rbp
nop
sub $19930, %rcx
mov $0x6162636465666768, %r11
movq %r11, %xmm1
...
vpextrq $0, %xmm6, %r11
xor $17953, %rcx
lea addresses_normal_ht+0x5a0c, %rsi
lea addresses_normal_ht+0xe640, %rdi
and $28438, %r10
mov $64, %rcx
rep movsq
nop
...
lea addresses_normal_ht+0x68a4, %rdi
clflush (%rsi)
nop
nop
nop
...
nop
xor %r13, %r13
lea addresses_WT_ht+0x18560, %rdi
cmp %rcx, %rcx
mov (%rdi), %r10w
and %r13, %r13
pop %rsi
...
<gen_prepare_buffer>
{'OP': 'REPM', 'src': {'type': 'addresses_D_ht', 'congruent': 3, 'same': False}, 'dst': {'type': 'addresses_WC_ht', 'congruent': 8, 'same': False}}
