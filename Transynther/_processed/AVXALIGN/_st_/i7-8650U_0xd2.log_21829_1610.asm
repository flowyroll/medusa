...
nop
and %rbp, %rbp
lea addresses_WT_ht+0x29a5, %rax
nop
nop
nop
sub %rbp, %rbp
...
// Store
lea addresses_normal+0xa383, %r13
nop
nop
nop
cmp $18976, %rbp
...
{'OP': 'LOAD', 'src': {'type': 'addresses_WT', 'size': 8, 'AVXalign': False, 'NT': True, 'congruent': 1, 'same': False}}
{'OP': 'STOR', 'dst': {'type': 'addresses_P', 'size': 4, 'AVXalign': True, 'NT': False, 'congruent': 11, 'same': False}}
...
{'OP': 'STOR', 'dst': {'type': 'addresses_WT_ht', 'size': 32, 'AVXalign': True, 'NT': False, 'congruent': 0, 'same': False}}
