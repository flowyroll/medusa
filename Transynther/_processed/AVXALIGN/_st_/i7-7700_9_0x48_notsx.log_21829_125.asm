...
push %rdi
push %rsi
lea addresses_WC_ht+0x14c4f, %r14
nop
nop
sub %r15, %r15
...
nop
xor %rdi, %rdi
lea addresses_UC_ht+0x1858f, %rdi
nop
nop
nop
nop
...
nop
inc %rdi
lea addresses_D_ht+0x1d94f, %r14
nop
nop
cmp $19420, %r10
mov (%r14), %r9
...
nop
and %rbx, %rbx
lea addresses_WT_ht+0x19882, %rsi
lea addresses_WC_ht+0xb84f, %rdi
clflush (%rdi)
cmp $7234, %rax
mov $85, %rcx
rep movsb
nop
and $10023, %rax
lea addresses_A_ht+0x162ef, %rsi
lea addresses_WT_ht+0x1e44f, %rdi
inc %r14
mov $49, %rcx
rep movsb
nop
...
nop
and $63753, %r10
lea addresses_UC_ht+0x1d24f, %rdi
nop
add $30669, %r10
mov (%rdi), %r15
nop
xor %rbx, %rbx
lea addresses_D_ht+0x4033, %r14
nop
nop
sub $35894, %r10
mov (%r14), %di
...
nop
dec %r10
lea addresses_UC_ht+0xc04f, %rax
nop
nop
sub $2357, %rdi
...
movq %rbx, (%rax)
cmp %rbx, %rbx
lea addresses_UC_ht+0x14257, %r15
nop
nop
nop
sub %rcx, %rcx
...
nop
add $42449, %rbx
lea addresses_WC_ht+0x1a0cf, %r15
xor $34171, %rax
movb (%r15), %r14b
nop
nop
...
{'OP': 'LOAD', 'src': {'same': False, 'NT': True, 'AVXalign': False, 'size': 8, 'type': 'addresses_D_ht', 'congruent': 6}}
{'dst': {'same': False, 'congruent': 11, 'type': 'addresses_WC_ht'}, 'OP': 'REPM', 'src': {'same': False, 'congruent': 0, 'type': 'addresses_WT_ht'}}
{'dst': {'same': True, 'congruent': 9, 'type': 'addresses_WT_ht'}, 'OP': 'REPM', 'src': {'same': False, 'congruent': 5, 'type': 'addresses_A_ht'}}
{'dst': {'same': False, 'NT': False, 'AVXalign': False, 'size': 8, 'type': 'addresses_UC_ht', 'congruent': 1}, 'OP': 'STOR'}
{'OP': 'LOAD', 'src': {'same': False, 'NT': False, 'AVXalign': True, 'size': 16, 'type': 'addresses_A_ht', 'congruent': 11}}
