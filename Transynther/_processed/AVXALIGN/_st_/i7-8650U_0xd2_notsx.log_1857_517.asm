...
push %rdi
push %rsi
lea addresses_UC_ht+0xf8b7, %r11
nop
nop
nop
nop
...
nop
xor %r10, %r10
lea addresses_WC_ht+0x1e1f7, %rsi
lea addresses_A_ht+0x131f7, %rdi
nop
nop
nop
and %r9, %r9
...
nop
dec %r10
lea addresses_WT_ht+0x73f7, %rsi
lea addresses_normal_ht+0x7277, %rdi
nop
sub %rbp, %rbp
mov $47, %rcx
rep movsl
...
nop
inc %r9
lea addresses_WT_ht+0x1492f, %r10
nop
nop
sub %rsi, %rsi
movb (%r10), %cl
...
nop
add $62567, %rsi
lea addresses_UC_ht+0x12277, %rsi
lea addresses_normal_ht+0x1a597, %rdi
nop
cmp %rbp, %rbp
mov $56, %rcx
rep movsq
...
nop
sub $33465, %rsi
lea addresses_D_ht+0x1a1ef, %rdi
nop
nop
cmp $29191, %r11
movb $0x61, (%rdi)
cmp %rax, %rax
lea addresses_WC_ht+0x51f7, %rsi
lea addresses_WC_ht+0x12037, %rdi
nop
nop
nop
nop
...
movups %xmm0, (%r10)
cmp $44871, %rsi
lea addresses_UC_ht+0x1b227, %r10
nop
nop
dec %rdi
...
nop
cmp $4488, %rdi
lea addresses_normal_ht+0x192f7, %rsi
lea addresses_D_ht+0xb9f7, %rdi
nop
nop
nop
cmp $22426, %r9
...
nop
cmp %rsi, %rsi
lea addresses_normal_ht+0xb577, %rsi
nop
nop
nop
nop
...
nop
and $28458, %rbp
lea addresses_A_ht+0x185f7, %rax
nop
nop
cmp $785, %rdi
movw $0x6162, (%rax)
...
nop
sub $10635, %rbp
lea addresses_UC_ht+0x19727, %rsi
lea addresses_D_ht+0x16357, %rdi
nop
nop
nop
nop
...
{'OP': 'REPM', 'src': {'type': 'addresses_WT_ht', 'congruent': 9, 'same': False}, 'dst': {'type': 'addresses_normal_ht', 'congruent': 5, 'same': False}}
...
{'OP': 'LOAD', 'src': {'type': 'addresses_normal_ht', 'size': 2, 'AVXalign': True, 'NT': True, 'congruent': 7, 'same': False}}
