...
push %rdx
push %rsi
lea addresses_normal_ht+0x1af93, %rsi
lea addresses_WC_ht+0x1c161, %rdi
nop
nop
and $39570, %rbx
mov $77, %rcx
...
nop
add %rdi, %rdi
lea addresses_WC_ht+0x18221, %r14
nop
nop
nop
nop
...
nop
cmp $9734, %rdi
lea addresses_normal_ht+0xd889, %rsi
lea addresses_D_ht+0xe14f, %rdi
nop
and $50859, %r10
mov $61, %rcx
rep movsl
...
nop
sub $17844, %r10
lea addresses_normal_ht+0x2589, %r10
nop
nop
nop
inc %rdi
...
<gen_prepare_buffer>
{'src': {'type': 'addresses_normal_ht', 'congruent': 0, 'same': False}, 'OP': 'REPM', 'dst': {'type': 'addresses_WC_ht', 'congruent': 1, 'same': False}}
