...
push %rdi
push %rdx
lea addresses_WC_ht+0x706f, %r8
nop
xor $18675, %r11
mov (%r8), %r13d
inc %r10
lea addresses_D_ht+0x10e6f, %r9
nop
nop
nop
nop
...
nop
and $48557, %r8
lea addresses_normal_ht+0x1122f, %rdx
nop
nop
nop
nop
...
// Load
lea addresses_normal+0x1b207, %rdx
nop
nop
xor $47777, %rdi
mov (%rdx), %r13d
...
{'OP': 'STOR', 'dst': {'type': 'addresses_WC', 'AVXalign': False, 'congruent': 0, 'size': 16, 'same': False, 'NT': True}}
{'OP': 'LOAD', 'src': {'type': 'addresses_normal', 'AVXalign': False, 'congruent': 3, 'size': 4, 'same': False, 'NT': False}}
