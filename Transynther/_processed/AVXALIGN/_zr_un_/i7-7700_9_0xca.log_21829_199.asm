...
nop
xor %rdx, %rdx
lea addresses_UC_ht+0x17c0b, %rdx
nop
nop
nop
nop
...
nop
mfence
lea addresses_UC_ht+0x17b0b, %rsi
lea addresses_WC_ht+0xa58b, %rdi
and %rbp, %rbp
mov $85, %rcx
rep movsl
inc %rsi
lea addresses_UC_ht+0x119cb, %rax
nop
nop
sub %r10, %r10
mov $0x6162636465666768, %rbp
...
nop
xor %rsi, %rsi
lea addresses_WT_ht+0xe1b7, %rdi
nop
nop
nop
nop
...
nop
sub $3576, %rdx
lea addresses_A_ht+0x1670b, %r10
nop
nop
nop
nop
...
nop
add %rdi, %rdi
lea addresses_D_ht+0x17c23, %rcx
nop
nop
nop
and %rsi, %rsi
...
{'src': {'congruent': 8, 'same': False, 'type': 'addresses_UC_ht'}, 'OP': 'REPM', 'dst': {'congruent': 5, 'same': False, 'type': 'addresses_WC_ht'}}
...
{'OP': 'STOR', 'dst': {'congruent': 3, 'AVXalign': True, 'same': False, 'size': 8, 'NT': False, 'type': 'addresses_D_ht'}}
{'c6': 1, '00': 21828}
