...
push %rdi
push %rsi
lea addresses_normal_ht+0x1a82d, %rbx
xor %r15, %r15
vmovups (%rbx), %ymm6
...
nop
xor %r11, %r11
lea addresses_A_ht+0x1095d, %rbx
add %r10, %r10
...
nop
cmp $22887, %r11
lea addresses_WC_ht+0x9a2d, %r11
nop
nop
nop
nop
...
nop
and %r15, %r15
lea addresses_UC_ht+0x16c45, %rsi
lea addresses_normal_ht+0x1b2b7, %rdi
clflush (%rsi)
nop
nop
nop
...
nop
and $57544, %r8
lea addresses_A_ht+0x1e586, %rsi
nop
inc %rdi
