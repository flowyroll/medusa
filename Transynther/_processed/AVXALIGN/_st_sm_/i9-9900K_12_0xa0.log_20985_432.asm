...
nop
cmp $20043, %r11
lea addresses_normal_ht+0x1a4a6, %rsi
lea addresses_WC_ht+0x698a, %rdi
nop
nop
cmp %rdx, %rdx
mov $36, %rcx
...
{'src': {'NT': False, 'same': False, 'congruent': 3, 'type': 'addresses_PSE', 'AVXalign': True, 'size': 8}, 'OP': 'LOAD'}
[Faulty Load]
{'src': {'NT': True, 'same': True, 'congruent': 0, 'type': 'addresses_A', 'AVXalign': True, 'size': 8}, 'OP': 'LOAD'}
<gen_prepare_buffer>
