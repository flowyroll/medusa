...
nop
and %r13, %r13
lea addresses_normal_ht+0xc26, %rdx
nop
nop
nop
inc %r8
...
nop
cmp %r15, %r15
lea addresses_D_ht+0xef82, %rsi
lea addresses_WC_ht+0x178b9, %rdi
nop
nop
sub %rdx, %rdx
mov $39, %rcx
...
nop
xor %r13, %r13
lea addresses_WC_ht+0xcda9, %rbx
nop
dec %rdi
mov (%rbx), %r13d
and $14479, %rbx
lea addresses_normal_ht+0x1a5c9, %r10
nop
add $1173, %rcx
movups (%r10), %xmm6
vpextrq $0, %xmm6, %rdi
...
{'src': {'NT': False, 'AVXalign': False, 'size': 1, 'congruent': 11, 'same': False, 'type': 'addresses_WT'}, 'OP': 'LOAD'}
[Faulty Load]
...
{'src': {'NT': False, 'AVXalign': True, 'size': 4, 'congruent': 3, 'same': False, 'type': 'addresses_WC_ht'}, 'OP': 'LOAD'}
