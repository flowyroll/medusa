...
push %rdi
push %rsi
lea addresses_WT_ht+0x176c4, %r13
and %rcx, %rcx
movb (%r13), %r9b
nop
nop
...
nop
xor %r9, %r9
lea addresses_UC_ht+0x7c74, %rbp
clflush (%rbp)
nop
nop
nop
...
nop
xor $20255, %r13
lea addresses_UC_ht+0x1ab74, %rbx
nop
nop
nop
nop
...
nop
sub $12990, %rbx
lea addresses_WC_ht+0x8d74, %rsi
lea addresses_WC_ht+0xd574, %rdi
clflush (%rsi)
add $54507, %rax
mov $25, %rcx
rep movsb
...
nop
and %r13, %r13
lea addresses_normal_ht+0x1d9e4, %rdi
nop
nop
inc %rbp
...
nop
cmp %rsi, %rsi
lea addresses_UC_ht+0x1964e, %r9
nop
lfence
mov (%r9), %ebx
nop
...
nop
add %rsi, %rsi
lea addresses_WC_ht+0xd974, %rcx
clflush (%rcx)
nop
nop
nop
...
nop
and $45852, %r13
lea addresses_D_ht+0x1174, %r13
add %rbp, %rbp
movb $0x61, (%r13)
dec %r9
lea addresses_A_ht+0x4b74, %r9
cmp $10339, %rdi
mov (%r9), %ecx
nop
dec %rbx
...
// Store
lea addresses_normal+0x17c44, %r14
nop
and $17221, %r9
mov $0x5152535455565758, %rdi
movq %rdi, %xmm2
...
// Store
lea addresses_PSE+0xfc54, %rbx
inc %rdi
movl $0x51525354, (%rbx)
xor $22877, %rbx

// Faulty Load
lea addresses_A+0x7174, %r14
nop
nop
nop
nop
...
{'OP': 'STOR', 'dst': {'type': 'addresses_US', 'size': 2, 'AVXalign': True, 'NT': True, 'congruent': 3, 'same': False}}
{'OP': 'STOR', 'dst': {'type': 'addresses_PSE', 'size': 4, 'AVXalign': False, 'NT': False, 'congruent': 5, 'same': False}}
[Faulty Load]
{'OP': 'LOAD', 'src': {'type': 'addresses_A', 'size': 4, 'AVXalign': True, 'NT': True, 'congruent': 0, 'same': True}}
<gen_prepare_buffer>
