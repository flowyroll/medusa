...
vpextrq $1, %xmm3, %rcx
xor $29829, %r13
lea addresses_UC_ht+0x7468, %rdi
nop
add $55102, %r9
...
movaps %xmm4, (%rdi)
add $46062, %r11
lea addresses_UC_ht+0x10368, %rcx
nop
sub %r9, %r9
...
nop
cmp %r8, %r8
lea addresses_D_ht+0x19168, %r11
nop
nop
nop
nop
...
nop
dec %r8
lea addresses_UC_ht+0x17a68, %rdi
nop
nop
nop
nop
...
{'OP': 'STOR', 'dst': {'type': 'addresses_UC_ht', 'AVXalign': True, 'congruent': 8, 'size': 16, 'same': True, 'NT': False}}
