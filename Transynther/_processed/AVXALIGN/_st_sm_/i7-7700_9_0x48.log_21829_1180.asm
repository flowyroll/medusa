...
push %rdi
push %rsi
lea addresses_WT_ht+0xbed7, %rbp
nop
nop
and %r10, %r10
mov (%rbp), %r14w
...
nop
xor %rbx, %rbx
lea addresses_UC_ht+0x131b7, %rsi
lea addresses_UC_ht+0x3c9f, %rdi
nop
nop
nop
inc %r9
...
nop
dec %r10
lea addresses_D_ht+0x1c637, %rsi
clflush (%rsi)
nop
add %rbp, %rbp
mov (%rsi), %r14w
...
nop
xor $38159, %r9
lea addresses_WC_ht+0x17a37, %rsi
lea addresses_WT_ht+0xb337, %rdi
nop
nop
inc %r14
mov $68, %rcx
