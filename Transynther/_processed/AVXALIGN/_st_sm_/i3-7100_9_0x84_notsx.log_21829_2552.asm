...
push %r9
push %rdi
lea addresses_WC_ht+0x185de, %r8
nop
nop
cmp $31111, %r9
mov (%r8), %rdi
...
// REPMOV
lea addresses_UC+0xbc7e, %rsi
lea addresses_D+0x107fe, %rdi
nop
nop
nop
add $52320, %r10
...
{'src': {'type': 'addresses_UC', 'congruent': 4, 'same': False}, 'dst': {'type': 'addresses_D', 'congruent': 3, 'same': False}, 'OP': 'REPM'}
