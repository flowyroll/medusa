...
// Store
lea addresses_normal+0x210f, %rax
nop
and $33974, %rbx
movl $0x51525354, (%rax)
nop
...
// Faulty Load
lea addresses_normal+0x210f, %r11
nop
nop
inc %r15
mov (%r11), %bx
...
{'OP': 'STOR', 'dst': {'congruent': 2, 'AVXalign': False, 'same': False, 'size': 8, 'NT': False, 'type': 'addresses_NC'}}
...
{'OP': 'STOR', 'dst': {'congruent': 3, 'AVXalign': False, 'same': False, 'size': 8, 'NT': False, 'type': 'addresses_RW'}}
[Faulty Load]
