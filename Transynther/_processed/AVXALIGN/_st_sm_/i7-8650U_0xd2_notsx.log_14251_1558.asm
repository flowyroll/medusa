...
nop
cmp $22709, %r14
lea addresses_D_ht+0xee1c, %rsi
lea addresses_A_ht+0x14b1c, %rdi
nop
nop
nop
nop
...
nop
cmp %rsi, %rsi
lea addresses_normal_ht+0xc11c, %rax
nop
xor $53118, %r12
mov (%rax), %rdi
nop
...
nop
dec %rsi
lea addresses_D_ht+0x18c1c, %rsi
lea addresses_normal_ht+0x2024, %rdi
nop
nop
nop
cmp $7428, %r8
...
nop
sub %r8, %r8
lea addresses_WT_ht+0xec1c, %rsi
nop
xor %r8, %r8
movups (%rsi), %xmm1
vpextrq $1, %xmm1, %rdx
...
nop
cmp $920, %rax
lea addresses_WT_ht+0x1dc4f, %rdx
nop
nop
nop
nop
...
<gen_prepare_buffer>
{'OP': 'REPM', 'src': {'type': 'addresses_A_ht', 'congruent': 8, 'same': False}, 'dst': {'type': 'addresses_WT_ht', 'congruent': 6, 'same': False}}
...
{'OP': 'LOAD', 'src': {'type': 'addresses_normal_ht', 'size': 8, 'AVXalign': False, 'NT': True, 'congruent': 7, 'same': False}}
