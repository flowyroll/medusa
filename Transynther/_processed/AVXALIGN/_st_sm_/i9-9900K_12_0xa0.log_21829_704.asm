...
nop
sub %r15, %r15
lea addresses_D_ht+0x7d39, %rsi
lea addresses_WT_ht+0x14939, %rdi
nop
nop
nop
xor $28462, %r10
...
nop
xor $42248, %rbp
lea addresses_normal_ht+0x8d39, %r15
clflush (%r15)
cmp %r12, %r12
movb (%r15), %r10b
nop
...
nop
and $32004, %rcx
lea addresses_WT_ht+0xd779, %rsi
nop
nop
cmp %r15, %r15
vmovups (%rsi), %ymm5
...
nop
add %rdi, %rdi
lea addresses_WC_ht+0x13d39, %rsi
lea addresses_normal_ht+0x9ab9, %rdi
add %r10, %r10
mov $37, %rcx
rep movsq
nop
...
{'src': {'NT': False, 'same': False, 'congruent': 1, 'type': 'addresses_P', 'AVXalign': False, 'size': 1}, 'OP': 'LOAD'}
...
{'src': {'same': False, 'congruent': 11, 'type': 'addresses_D_ht'}, 'OP': 'REPM', 'dst': {'same': False, 'congruent': 10, 'type': 'addresses_WT_ht'}}
{'src': {'NT': True, 'same': False, 'congruent': 11, 'type': 'addresses_normal_ht', 'AVXalign': False, 'size': 1}, 'OP': 'LOAD'}
{'OP': 'STOR', 'dst': {'NT': True, 'same': False, 'congruent': 3, 'type': 'addresses_D_ht', 'AVXalign': False, 'size': 32}}
{'src': {'NT': False, 'same': False, 'congruent': 6, 'type': 'addresses_WT_ht', 'AVXalign': False, 'size': 32}, 'OP': 'LOAD'}
{'src': {'same': False, 'congruent': 11, 'type': 'addresses_WC_ht'}, 'OP': 'REPM', 'dst': {'same': True, 'congruent': 4, 'type': 'addresses_normal_ht'}}
{'52': 21829}
