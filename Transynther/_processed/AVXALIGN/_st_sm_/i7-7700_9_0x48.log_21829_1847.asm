...
movb $0x61, (%rax)
cmp %r8, %r8
lea addresses_WC_ht+0xd728, %rsi
...
nop
and %r8, %r8
lea addresses_normal_ht+0x1b7c0, %r15
clflush (%r15)
nop
sub $22769, %rcx
mov (%r15), %rax
sub %r15, %r15
lea addresses_D_ht+0x16320, %rdi
nop
nop
nop
nop
...
nop
cmp $62173, %rcx
lea addresses_UC_ht+0x9720, %rax
nop
nop
nop
nop
...
nop
and %rcx, %rcx
lea addresses_normal_ht+0xe920, %r15
nop
nop
nop
sub %r14, %r14
...
{'OP': 'STOR', 'dst': {'type': 'addresses_RW', 'AVXalign': True, 'congruent': 0, 'size': 4, 'same': True, 'NT': False}}
