...
push %rdx
push %rsi
lea addresses_A_ht+0x3389, %rdx
nop
dec %rbp
movups (%rdx), %xmm2
vpextrq $0, %xmm2, %rbx
and %rbx, %rbx
lea addresses_normal_ht+0x1dba1, %rsi
lea addresses_WT_ht+0x1db09, %rdi
nop
inc %rax
mov $69, %rcx
rep movsb
...
nop
xor $15668, %rdx
lea addresses_WC_ht+0xe759, %rbp
dec %rax
movb $0x61, (%rbp)
nop
nop
...
nop
inc %rsi
lea addresses_UC_ht+0x17347, %rdx
add %rbp, %rbp
mov (%rdx), %rcx
add $23591, %rdi
lea addresses_WC_ht+0xecf9, %rax
nop
inc %rbp
movl $0x61626364, (%rax)
nop
...
nop
inc %rdx
lea addresses_WC_ht+0x7089, %rax
nop
nop
cmp %rbp, %rbp
...
nop
inc %rdx
lea addresses_WT_ht+0x1ac89, %rbx
xor %rcx, %rcx
...
nop
dec %rdx
lea addresses_normal_ht+0x18089, %rsi
lea addresses_A_ht+0x9769, %rdi
nop
nop
xor $53476, %r12
mov $45, %rcx
...
nop
cmp $37943, %rdi
lea addresses_WT_ht+0x3ab5, %rax
clflush (%rax)
nop
nop
nop
...
nop
sub %r12, %r12
lea addresses_WT_ht+0x11289, %rbx
xor $24924, %r12
movl $0x61626364, (%rbx)
nop
sub $6458, %rdx
lea addresses_D_ht+0x16b89, %rcx
nop
and %rdx, %rdx
...
nop
cmp %rax, %rax
lea addresses_WT_ht+0x1d649, %rax
nop
cmp $55345, %rbx
movl $0x61626364, (%rax)
nop
...
// Store
lea addresses_normal+0x16f89, %rcx
clflush (%rcx)
cmp %rsi, %rsi
movb $0x51, (%rcx)
nop
...
// Store
lea addresses_normal+0xeb89, %rbp
nop
cmp %r8, %r8
movb $0x51, (%rbp)
nop
...
// Faulty Load
lea addresses_normal+0xeb89, %rcx
add $33678, %rdi
mov (%rcx), %rsi
lea oracles, %r15
and $0xff, %rsi
...
{'OP': 'REPM', 'src': {'type': 'addresses_normal_ht', 'congruent': 3, 'same': False}, 'dst': {'type': 'addresses_WT_ht', 'congruent': 7, 'same': True}}
{'OP': 'STOR', 'dst': {'type': 'addresses_WC_ht', 'size': 1, 'AVXalign': False, 'NT': False, 'congruent': 4, 'same': False}}
{'OP': 'LOAD', 'src': {'type': 'addresses_UC_ht', 'size': 8, 'AVXalign': False, 'NT': True, 'congruent': 1, 'same': False}}
