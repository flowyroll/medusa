...
push %rbx
push %rcx
lea addresses_WC_ht+0x7580, %rcx
nop
lfence
mov (%rcx), %r14d
nop
nop
inc %r8
lea addresses_D_ht+0x1ec18, %rax
nop
nop
nop
nop
...
{'OP': 'LOAD', 'src': {'type': 'addresses_PSE', 'size': 2, 'AVXalign': False, 'NT': False, 'congruent': 6, 'same': False}}
[Faulty Load]
