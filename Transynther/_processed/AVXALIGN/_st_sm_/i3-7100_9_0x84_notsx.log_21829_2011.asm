...
push %rdx
push %rsi
lea addresses_WT_ht+0x163a5, %r8
xor %rdi, %rdi
mov $0x6162636465666768, %rsi
movq %rsi, %xmm5
vmovups %ymm5, (%r8)
cmp %r9, %r9
lea addresses_D_ht+0xb61d, %rcx
nop
nop
nop
nop
...
nop
add $24913, %rax
lea addresses_normal_ht+0xc10e, %rsi
nop
dec %rcx
movb (%rsi), %r9b
nop
...
nop
cmp $44476, %rdx
lea addresses_normal_ht+0x18885, %rsi
lea addresses_normal_ht+0xca1d, %rdi
nop
nop
xor %r8, %r8
mov $113, %rcx
...
nop
cmp %rdi, %rdi
lea addresses_A_ht+0x1991d, %rsi
lea addresses_UC_ht+0xc61d, %rdi
nop
nop
xor $12466, %rax
mov $55, %rcx
...
nop
sub $24199, %r9
lea addresses_UC_ht+0x1c0df, %rdi
nop
nop
nop
and %rdx, %rdx
...
vmovups %ymm1, (%rdi)
add $40759, %rax
lea addresses_WC_ht+0x1054d, %rdi
nop
sub %rdx, %rdx
mov (%rdi), %si
nop
...
nop
dec %rdi
lea addresses_WC_ht+0xd953, %rcx
nop
nop
xor %rax, %rax
mov (%rcx), %rdi
...
{'dst': {'type': 'addresses_A', 'same': False, 'size': 1, 'congruent': 9, 'NT': True, 'AVXalign': False}, 'OP': 'STOR'}
...
{'src': {'type': 'addresses_A_ht', 'congruent': 8, 'same': False}, 'dst': {'type': 'addresses_UC_ht', 'congruent': 11, 'same': False}, 'OP': 'REPM'}
