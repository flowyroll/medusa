...
push %rdi
push %rsi
lea addresses_D_ht+0x15772, %r12
clflush (%r12)
nop
nop
nop
...
nop
dec %r10
lea addresses_A_ht+0x3856, %rsi
lea addresses_D_ht+0x107a6, %rdi
nop
add $63712, %r15
mov $2, %rcx
rep movsq
...
nop
inc %r15
lea addresses_normal_ht+0xcee6, %rsi
lea addresses_WC_ht+0x201e, %rdi
clflush (%rsi)
nop
xor $46932, %rbx
mov $48, %rcx
...
// Store
lea addresses_normal+0x183e6, %r9
nop
nop
add %r14, %r14
movl $0x51525354, (%r9)
...
{'OP': 'STOR', 'dst': {'type': 'addresses_normal', 'AVXalign': False, 'congruent': 9, 'size': 4, 'same': False, 'NT': True}}
[Faulty Load]
