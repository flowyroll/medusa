...
vpextrq $1, %xmm0, %r12
cmp $727, %rcx
lea addresses_WT_ht+0xce3d, %rsi
lea addresses_WT_ht+0x47e5, %rdi
clflush (%rsi)
nop
nop
nop
...
{'src': {'type': 'addresses_WT_ht', 'congruent': 10, 'same': False}, 'dst': {'type': 'addresses_WT_ht', 'congruent': 3, 'same': False}, 'OP': 'REPM'}
