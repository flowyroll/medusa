...
push %rdx
push %rsi
lea addresses_WC_ht+0x187e5, %rdx
nop
nop
add $61354, %r15
mov (%rdx), %r13w
...
lea addresses_WC_ht+0xfe69, %rdi
nop
nop
dec %rbp
mov $45, %rcx
...
nop
cmp %rdi, %rdi
lea addresses_UC_ht+0xb08a, %r10
nop
nop
nop
nop
...
mov (%r10), %di
sub $30908, %rcx
lea addresses_D_ht+0x1cece, %rsi
nop
nop
nop
nop
...
{'src': {'type': 'addresses_WT_ht', 'congruent': 5, 'same': False}, 'OP': 'REPM', 'dst': {'type': 'addresses_WC_ht', 'congruent': 2, 'same': False}}
