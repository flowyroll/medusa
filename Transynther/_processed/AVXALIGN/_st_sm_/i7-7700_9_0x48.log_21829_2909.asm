...
push %rdx
push %rsi
lea addresses_UC_ht+0x19763, %rsi
...
nop
xor $25817, %rdx
lea addresses_A_ht+0x176a3, %r14
nop
nop
nop
xor %r13, %r13
movl $0x61626364, (%r14)
add $39310, %rdi
lea addresses_WT_ht+0xd5a3, %rdx
cmp $14358, %rdi
movb (%rdx), %cl
nop
nop
...
{'OP': 'STOR', 'dst': {'type': 'addresses_US', 'AVXalign': True, 'congruent': 0, 'size': 32, 'same': True, 'NT': False}}
{'OP': 'STOR', 'dst': {'type': 'addresses_A', 'AVXalign': True, 'congruent': 6, 'size': 16, 'same': False, 'NT': True}}
[Faulty Load]
