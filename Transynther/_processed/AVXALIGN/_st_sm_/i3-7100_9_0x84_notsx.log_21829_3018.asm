...
push %rdi
push %rsi
lea addresses_D_ht+0x1130f, %rsi
lea addresses_WT_ht+0xe48f, %rdi
sub %rax, %rax
mov $7, %rcx
rep movsw
nop
...
nop
inc %rbx
lea addresses_D_ht+0x1970f, %rbp
nop
nop
nop
nop
...
nop
sub $50210, %rax
lea addresses_D_ht+0x4f47, %rsi
lea addresses_UC_ht+0x70f, %rdi
nop
nop
nop
cmp %r10, %r10
...
rep movsb
add $2458, %rsi
lea addresses_WT_ht+0x1825f, %rax
nop
cmp %rsi, %rsi
vmovups (%rax), %ymm1
...
nop
sub %rcx, %rcx
lea addresses_normal_ht+0xc287, %r10
nop
nop
xor %rbp, %rbp
...
nop
and $88, %rcx
lea addresses_WC_ht+0x1cf9, %rsi
cmp $7010, %rdi
mov (%rsi), %r10d
nop
nop
...
// REPMOV
lea addresses_PSE+0x9f0f, %rsi
lea addresses_D+0x867b, %rdi
nop
nop
nop
nop
...
{'src': {'type': 'addresses_PSE', 'congruent': 10, 'same': False}, 'dst': {'type': 'addresses_D', 'congruent': 2, 'same': False}, 'OP': 'REPM'}
[Faulty Load]
{'src': {'type': 'addresses_WT', 'same': True, 'size': 8, 'congruent': 0, 'NT': False, 'AVXalign': True}, 'OP': 'LOAD'}
<gen_prepare_buffer>
{'src': {'type': 'addresses_D_ht', 'congruent': 11, 'same': True}, 'dst': {'type': 'addresses_WT_ht', 'congruent': 7, 'same': False}, 'OP': 'REPM'}
