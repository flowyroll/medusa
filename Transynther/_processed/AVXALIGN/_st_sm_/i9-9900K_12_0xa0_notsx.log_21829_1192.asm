...
push %rcx
push %rsi
lea addresses_UC_ht+0x12a51, %r12
cmp $22023, %r15
movb $0x61, (%r12)
nop
nop
...
nop
xor $22779, %r13
lea addresses_UC_ht+0x1ab51, %rsi
nop
nop
xor %r12, %r12
...
nop
add %r12, %r12
lea addresses_normal_ht+0x8f9, %r13
add %r12, %r12
vmovups (%r13), %ymm7
...
nop
cmp %r15, %r15
lea addresses_A_ht+0x12af1, %rsi
nop
nop
cmp $34991, %r15
movw $0x6162, (%rsi)
...
nop
cmp $32052, %rbx
lea addresses_normal_ht+0x651, %r13
xor %r12, %r12
mov (%r13), %rsi
nop
nop
...
// REPMOV
lea addresses_WT+0x14679, %rsi
lea addresses_UC+0x19251, %rdi
nop
nop
nop
nop
...
{'OP': 'STOR', 'dst': {'type': 'addresses_A_ht', 'AVXalign': True, 'size': 2, 'NT': False, 'same': True, 'congruent': 4}}
