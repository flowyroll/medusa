...
push %rdx
push %rsi
lea addresses_normal_ht+0x19b7f, %r11
nop
nop
nop
nop
...
nop
add %r13, %r13
lea addresses_normal_ht+0x937f, %r13
nop
nop
nop
nop
...
nop
cmp %r8, %r8
lea addresses_normal_ht+0x7b7f, %rsi
lea addresses_D_ht+0xa943, %rdi
nop
nop
nop
dec %r13
...
rep movsw
inc %rdx
lea addresses_UC_ht+0xe29f, %r11
nop
nop
nop
nop
...
nop
inc %r11
lea addresses_WT_ht+0xde67, %rsi
nop
nop
nop
nop
...
nop
cmp %rcx, %rcx
lea addresses_normal_ht+0x15cff, %rsi
lea addresses_A_ht+0x9d9f, %rdi
nop
nop
nop
nop
...
nop
add %r15, %r15
lea addresses_A_ht+0x1e87f, %r12
nop
nop
nop
cmp %r8, %r8
...
nop
add $2434, %r8
lea addresses_WT_ht+0x1e37f, %rdi
sub %r13, %r13
movb $0x61, (%rdi)
nop
nop
...
[Faulty Load]
{'src': {'type': 'addresses_A', 'AVXalign': True, 'size': 1, 'NT': False, 'same': True, 'congruent': 0}, 'OP': 'LOAD'}
<gen_prepare_buffer>
{'OP': 'STOR', 'dst': {'type': 'addresses_normal_ht', 'AVXalign': False, 'size': 2, 'NT': False, 'same': True, 'congruent': 10}}
...
{'src': {'type': 'addresses_normal_ht', 'congruent': 11, 'same': False}, 'OP': 'REPM', 'dst': {'type': 'addresses_D_ht', 'congruent': 2, 'same': False}}
