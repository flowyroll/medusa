...
push %rdi
push %rsi
lea addresses_WT_ht+0x158ea, %r14
nop
nop
nop
nop
...
nop
add $20225, %rax
lea addresses_UC_ht+0xedb9, %r10
clflush (%r10)
nop
nop
nop
...
nop
xor %rax, %rax
lea addresses_normal_ht+0x1af77, %r10
cmp $30797, %rsi
...
nop
and %rax, %rax
lea addresses_normal_ht+0x5e0f, %rsi
clflush (%rsi)
nop
nop
nop
...
movb (%rsi), %cl
and $63095, %r9
lea addresses_WC_ht+0x9097, %r10
nop
nop
nop
nop
...
nop
inc %r9
lea addresses_normal_ht+0x17bdf, %rsi
lea addresses_UC_ht+0x1a10f, %rdi
nop
nop
nop
nop
...
<gen_prepare_buffer>
{'OP': 'STOR', 'dst': {'congruent': 0, 'AVXalign': True, 'same': False, 'size': 8, 'NT': False, 'type': 'addresses_WT_ht'}}
