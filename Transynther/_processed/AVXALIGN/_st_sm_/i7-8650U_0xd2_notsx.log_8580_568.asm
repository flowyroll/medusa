...
push %rdx
push %rsi
lea addresses_WT_ht+0x12dbe, %rcx
nop
nop
nop
nop
...
nop
dec %r14
lea addresses_UC_ht+0xa9d9, %rdi
nop
nop
nop
inc %r8
...
nop
sub %rsi, %rsi
lea addresses_WT_ht+0xb859, %rdi
nop
nop
nop
nop
...
nop
sub $3159, %rsi
lea addresses_normal_ht+0x8f83, %rdi
nop
nop
nop
nop
...
nop
lfence
lea addresses_D_ht+0x13a19, %r11
nop
nop
nop
nop
...
nop
inc %rdi
lea addresses_WT_ht+0x9599, %rsi
lea addresses_normal_ht+0x137b9, %rdi
nop
nop
nop
nop
...
nop
and $38119, %r12
lea addresses_WT_ht+0x10dc9, %r11
nop
nop
nop
nop
...
nop
add $17507, %r8
lea addresses_normal_ht+0x16cf5, %rsi
nop
nop
nop
and $6974, %rdx
...
nop
dec %rcx
lea addresses_WT_ht+0x1e251, %r12
nop
nop
nop
nop
...
{'OP': 'LOAD', 'src': {'type': 'addresses_normal_ht', 'size': 32, 'AVXalign': False, 'NT': False, 'congruent': 0, 'same': True}}
