...
nop
cmp $36507, %rcx
lea addresses_WC_ht+0xc692, %rsi
lea addresses_WT_ht+0xfa05, %rdi
xor $47453, %rbp
mov $24, %rcx
rep movsq
nop
...
nop
add $38459, %rdi
lea addresses_WT_ht+0xbb92, %rdi
nop
nop
nop
nop
...
nop
add $19890, %rdi
lea addresses_WT_ht+0x1d6ee, %rsi
nop
cmp $46912, %rdi
movl $0x61626364, (%rsi)
nop
cmp $31535, %rdi
lea addresses_UC_ht+0x1d09a, %rbp
nop
nop
nop
and %rcx, %rcx
...
nop
and %rsi, %rsi
lea addresses_UC_ht+0x10b92, %rsi
lea addresses_WT_ht+0x1ae92, %rdi
nop
nop
nop
nop
...
nop
add %r8, %r8
lea addresses_A_ht+0x1b76a, %r10
nop
nop
sub $45441, %rsi
mov (%r10), %edi
...
// REPMOV
lea addresses_normal+0x11492, %rsi
lea addresses_UC+0x17ce, %rdi
nop
nop
nop
nop
...
{'OP': 'REPM', 'src': {'type': 'addresses_normal', 'congruent': 9, 'same': False}, 'dst': {'type': 'addresses_UC', 'congruent': 2, 'same': False}}
...
{'OP': 'REPM', 'src': {'type': 'addresses_WC_ht', 'congruent': 8, 'same': True}, 'dst': {'type': 'addresses_WT_ht', 'congruent': 0, 'same': False}}
