...
push %rdx
push %rsi
lea addresses_normal_ht+0x1cb12, %rdx
nop
nop
nop
nop
...
movq %r8, (%rdx)
sub %rax, %rax
lea addresses_normal_ht+0x7d52, %r11
nop
nop
add %r9, %r9
vmovups (%r11), %ymm5
...
nop
sub %r9, %r9
lea addresses_WT_ht+0xff12, %rsi
lea addresses_normal_ht+0x4b12, %rdi
clflush (%rsi)
nop
nop
nop
