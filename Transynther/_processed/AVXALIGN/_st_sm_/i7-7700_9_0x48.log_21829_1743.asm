...
push %rdi
push %rsi
lea addresses_WC_ht+0x1c587, %r11
nop
nop
nop
xor $33551, %rdi
...
nop
and %rbp, %rbp
lea addresses_normal_ht+0x11f87, %r15
nop
nop
nop
nop
...
movb (%r15), %al
dec %rbp
lea addresses_A_ht+0xe5d7, %rsi
lea addresses_WT_ht+0x3587, %rdi
nop
and $50100, %rax
mov $5, %rcx
rep movsq
...
nop
cmp %r11, %r11
lea addresses_UC_ht+0x1be67, %r8
add %r11, %r11
movl $0x61626364, (%r8)
nop
nop
...
nop
sub $37764, %rax
lea addresses_normal_ht+0x1d487, %rsi
...
{'OP': 'REPM', 'src': {'type': 'addresses_A_ht', 'congruent': 3, 'same': False}, 'dst': {'type': 'addresses_WT_ht', 'congruent': 11, 'same': False}}
