...
push %rdi
push %rsi
lea addresses_UC_ht+0x1c60, %rax
nop
sub $48666, %r15
movw $0x6162, (%rax)
nop
...
nop
dec %rax
lea addresses_WC_ht+0xcf5f, %rsi
lea addresses_WC_ht+0x11144, %rdi
nop
nop
nop
nop
...
[Faulty Load]
{'OP': 'LOAD', 'src': {'type': 'addresses_US', 'AVXalign': True, 'congruent': 0, 'size': 2, 'same': True, 'NT': True}}
<gen_prepare_buffer>
{'OP': 'STOR', 'dst': {'type': 'addresses_UC_ht', 'AVXalign': True, 'congruent': 11, 'size': 2, 'same': False, 'NT': False}}
