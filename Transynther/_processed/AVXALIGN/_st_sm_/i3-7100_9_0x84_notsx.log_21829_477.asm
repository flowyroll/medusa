...
nop
cmp %r13, %r13
lea addresses_UC_ht+0x182cf, %rsi
lea addresses_WT_ht+0x118cb, %rdi
nop
nop
nop
nop
...
nop
xor %rsi, %rsi
lea addresses_normal_ht+0x76bf, %rcx
clflush (%rcx)
nop
nop
add $676, %rdi
...
{'src': {'type': 'addresses_UC_ht', 'congruent': 4, 'same': False}, 'dst': {'type': 'addresses_WT_ht', 'congruent': 2, 'same': False}, 'OP': 'REPM'}
