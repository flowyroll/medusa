...
push %rbx
push %rsi
lea addresses_UC_ht+0x3580, %rbx
clflush (%rbx)
nop
nop
nop
...
nop
sub $14572, %rsi
lea addresses_UC_ht+0xf880, %r12
nop
nop
add $47246, %r8
...
nop
xor %rax, %rax
lea addresses_WT_ht+0x15eb4, %rsi
nop
nop
nop
nop
...
nop
sub $29663, %rsi
lea addresses_WC_ht+0x1d7e0, %rax
inc %r9
mov (%rax), %esi
sub $14371, %r9
lea addresses_WC_ht+0x10780, %r12
nop
nop
nop
cmp $4605, %r11
...
nop
add %r11, %r11
lea addresses_UC_ht+0xfed0, %rsi
nop
nop
nop
cmp %r12, %r12
...
// Store
lea addresses_normal+0x480, %rbp
dec %r14
movb $0x51, (%rbp)
nop
nop
...
{'OP': 'STOR', 'dst': {'type': 'addresses_WT_ht', 'AVXalign': True, 'size': 32, 'NT': False, 'same': False, 'congruent': 1}}
