...
push %rdi
push %rsi
lea addresses_D_ht+0x8349, %rsi
lea addresses_D_ht+0x3d11, %rdi
and $35722, %rbx
mov $0, %rcx
rep movsq
nop
...
nop
add $3041, %rsi
lea addresses_D_ht+0x1eb81, %rsi
...
nop
cmp $26338, %r13
lea addresses_UC_ht+0xcb19, %rcx
nop
nop
add $46032, %r10
...
nop
dec %r13
lea addresses_normal_ht+0x16b59, %rsi
lea addresses_WT_ht+0x12d19, %rdi
clflush (%rdi)
nop
nop
nop
...
nop
sub $45906, %r10
lea addresses_D_ht+0x16019, %rbx
add $10579, %rsi
mov (%rbx), %r13w
and %r8, %r8
lea addresses_D_ht+0x11d99, %r8
sub %r10, %r10
movl $0x61626364, (%r8)
nop
sub %rcx, %rcx
lea addresses_UC_ht+0x1f99, %rsi
lea addresses_WT_ht+0x10819, %rdi
clflush (%rsi)
nop
sub $6544, %rbx
mov $127, %rcx
...
nop
xor $15323, %r13
lea addresses_WT_ht+0x15bc5, %rbx
nop
sub %rsi, %rsi
...
{'src': {'type': 'addresses_D_ht', 'congruent': 3, 'same': False}, 'OP': 'REPM', 'dst': {'type': 'addresses_WT_ht', 'congruent': 8, 'same': True}}
