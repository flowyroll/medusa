...
push %rdi
push %rsi
lea addresses_normal_ht+0xc618, %r9
nop
add %r14, %r14
...
movups %xmm7, (%r9)
sub %r13, %r13
lea addresses_normal_ht+0x18b00, %rsi
lea addresses_WT_ht+0x5518, %rdi
nop
nop
nop
nop
...
nop
xor $26785, %r13
lea addresses_normal_ht+0x14ea8, %r15
nop
xor $27707, %rcx
...
vmovups %ymm4, (%r9)
cmp $56042, %r14
lea addresses_UC_ht+0xe098, %rdi
nop
nop
add $46821, %rcx
...
movq %rsi, (%rdi)
xor $23205, %r14
lea addresses_WT_ht+0x43c8, %rsi
nop
nop
nop
dec %r15
...
nop
sub $44797, %r13
lea addresses_normal_ht+0x17118, %rcx
nop
nop
nop
nop
...
nop
sub %rsi, %rsi
lea addresses_WC_ht+0x1b5ff, %r15
and $34193, %rsi
movb $0x61, (%r15)
nop
cmp %r15, %r15
lea addresses_D_ht+0x17398, %rsi
lea addresses_WC_ht+0xbd18, %rdi
nop
nop
and $60810, %r15
mov $48, %rcx
...
nop
sub $28067, %rsi
lea addresses_D_ht+0x1d818, %rdi
nop
nop
nop
sub %r13, %r13
...
nop
add $20651, %r9
lea addresses_A_ht+0x14918, %rsi
lea addresses_UC_ht+0x18d18, %rdi
lfence
mov $114, %rcx
rep movsq
nop
...
nop
mfence
lea addresses_UC_ht+0x5518, %rcx
nop
nop
nop
inc %r15
movb (%rcx), %r14b
add $12798, %rax
lea addresses_WT_ht+0x1cb38, %r14
nop
nop
nop
nop
...
// Store
lea addresses_normal+0xcd18, %rdx
nop
dec %r8
movb $0x51, (%rdx)
nop
...
// Load
lea addresses_normal+0x4548, %rbp
nop
add %r12, %r12
movups (%rbp), %xmm4
vpextrq $1, %xmm4, %r8
...
// Faulty Load
lea addresses_normal+0xcd18, %rcx
clflush (%rcx)
nop
nop
and %rbp, %rbp
...
{'src': {'NT': False, 'same': False, 'congruent': 2, 'type': 'addresses_normal', 'AVXalign': False, 'size': 16}, 'OP': 'LOAD'}
[Faulty Load]
...
{'src': {'same': False, 'congruent': 2, 'type': 'addresses_normal_ht'}, 'OP': 'REPM', 'dst': {'same': False, 'congruent': 5, 'type': 'addresses_WT_ht'}}
...
{'src': {'same': False, 'congruent': 7, 'type': 'addresses_D_ht'}, 'OP': 'REPM', 'dst': {'same': False, 'congruent': 11, 'type': 'addresses_WC_ht'}}
...
{'src': {'same': False, 'congruent': 10, 'type': 'addresses_A_ht'}, 'OP': 'REPM', 'dst': {'same': True, 'congruent': 11, 'type': 'addresses_UC_ht'}}
