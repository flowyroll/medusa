...
push %rdi
push %rsi
lea addresses_D_ht+0x1029d, %rsi
lea addresses_WC_ht+0xd49d, %rdi
nop
nop
nop
nop
...
nop
sub %r12, %r12
lea addresses_normal_ht+0x1545, %rbx
nop
nop
and %r11, %r11
vmovups (%rbx), %ymm7
...
nop
add %rdi, %rdi
lea addresses_D_ht+0x1559d, %r15
nop
nop
nop
nop
...
nop
xor %r15, %r15
lea addresses_normal_ht+0x108c9, %rsi
nop
dec %rbx
movb $0x61, (%rsi)
nop
...
nop
inc %rbx
lea addresses_UC_ht+0x95bd, %r12
nop
nop
inc %rcx
mov (%r12), %rbx
...
{'OP': 'STOR', 'dst': {'type': 'addresses_NC', 'AVXalign': False, 'size': 32, 'NT': True, 'same': False, 'congruent': 3}}
[Faulty Load]
{'src': {'type': 'addresses_PSE', 'AVXalign': True, 'size': 4, 'NT': False, 'same': True, 'congruent': 0}, 'OP': 'LOAD'}
<gen_prepare_buffer>
{'src': {'type': 'addresses_D_ht', 'congruent': 9, 'same': False}, 'OP': 'REPM', 'dst': {'type': 'addresses_WC_ht', 'congruent': 9, 'same': False}}
