...
push %rdx
push %rsi
lea addresses_A_ht+0x1d66e, %rsi
nop
nop
xor %r9, %r9
mov (%rsi), %edx
...
nop
xor $13970, %rcx
lea addresses_normal_ht+0x566e, %rdi
cmp %rcx, %rcx
vmovups (%rdi), %ymm5
...
nop
dec %rcx
lea addresses_WC_ht+0x19e6e, %r15
nop
nop
nop
nop
...
nop
cmp $53001, %r10
lea addresses_UC_ht+0x9cee, %rsi
lea addresses_A_ht+0x1b26e, %rdi
nop
nop
nop
nop
...
nop
and $25038, %rdi
lea addresses_UC_ht+0x8d4e, %rsi
lea addresses_D_ht+0x13df6, %rdi
clflush (%rdi)
nop
nop
and %r10, %r10
...
nop
add $46845, %rsi
lea addresses_D_ht+0x1d9be, %rsi
...
nop
cmp $24526, %rdi
lea addresses_UC_ht+0x110ae, %r15
nop
nop
sub %r12, %r12
movups (%r15), %xmm6
...
// Load
mov $0x557fec0000000ab6, %rsi
sub $10808, %rbx
movb (%rsi), %r9b
add %r9, %r9

// Store
lea addresses_WC+0x566e, %rsi
nop
nop
nop
nop
...
{'OP': 'LOAD', 'src': {'type': 'addresses_NC', 'AVXalign': False, 'congruent': 2, 'size': 1, 'same': False, 'NT': False}}
...
{'OP': 'REPM', 'src': {'type': 'addresses_A_ht', 'congruent': 8, 'same': True}, 'dst': {'type': 'addresses_A_ht', 'congruent': 11, 'same': False}}
