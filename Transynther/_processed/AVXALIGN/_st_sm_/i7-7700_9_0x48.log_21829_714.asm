...
push %rdi
push %rdx
lea addresses_WC_ht+0x1b11d, %rdx
nop
add $53653, %rcx
...
nop
and %r12, %r12
lea addresses_WC_ht+0x1587d, %rdx
nop
nop
and $61104, %rdi
mov (%rdx), %rcx
