...
lea addresses_WC_ht+0x1e651, %rdi
nop
nop
nop
nop
...
nop
add $58644, %r8
lea addresses_normal_ht+0xb4f5, %rsi
lea addresses_A_ht+0x19fd1, %rdi
clflush (%rdi)
nop
xor $366, %r8
mov $79, %rcx
...
lea addresses_D_ht+0x1ecd5, %rdi
nop
and $40050, %rax
mov $72, %rcx
rep movsl
...
nop
dec %r12
lea addresses_UC_ht+0x23d1, %r12
nop
nop
nop
nop
...
nop
dec %r15
lea addresses_normal_ht+0x151c9, %rsi
lea addresses_D_ht+0x1ecd1, %rdi
and %r10, %r10
mov $38, %rcx
rep movsw
nop
...
nop
and $34069, %rsi
lea addresses_normal_ht+0x11a1, %rsi
lea addresses_normal_ht+0x10b5, %rdi
dec %rax
mov $36, %rcx
rep movsw
nop
...
nop
inc %rsi
lea addresses_D_ht+0x6f1, %rsi
lea addresses_A_ht+0x6bd1, %rdi
nop
nop
nop
xor %rax, %rax
...
{'OP': 'REPM', 'src': {'type': 'addresses_normal_ht', 'congruent': 2, 'same': True}, 'dst': {'type': 'addresses_A_ht', 'congruent': 10, 'same': False}}
...
{'OP': 'REPM', 'src': {'type': 'addresses_D_ht', 'congruent': 2, 'same': True}, 'dst': {'type': 'addresses_A_ht', 'congruent': 9, 'same': False}}
{'58': 21829}
