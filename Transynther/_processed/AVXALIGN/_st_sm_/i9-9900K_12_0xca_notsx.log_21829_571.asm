...
push %rdi
push %rsi
lea addresses_UC_ht+0x441d, %r10
nop
nop
nop
nop
...
nop
add $24879, %rdi
lea addresses_WC_ht+0xb3d2, %rsi
lea addresses_UC_ht+0xf148, %rdi
nop
nop
nop
nop
...
rep movsq
xor $24191, %r14
lea addresses_WC_ht+0x1ce18, %rsi
lea addresses_normal_ht+0x2388, %rdi
nop
nop
nop
nop
...
vpextrq $0, %xmm7, %r13
cmp $27873, %r10
lea addresses_D_ht+0x15e88, %r13
nop
nop
nop
nop
...
nop
xor $27833, %rdi
lea addresses_WC_ht+0xd5c8, %rsi
lea addresses_A_ht+0x52c0, %rdi
clflush (%rsi)
nop
and %rbx, %rbx
mov $21, %rcx
...
<gen_prepare_buffer>
{'OP': 'STOR', 'dst': {'same': False, 'type': 'addresses_UC_ht', 'NT': False, 'AVXalign': True, 'size': 16, 'congruent': 0}}
{'OP': 'REPM', 'src': {'same': False, 'congruent': 1, 'type': 'addresses_WC_ht'}, 'dst': {'same': False, 'congruent': 6, 'type': 'addresses_UC_ht'}}
{'OP': 'REPM', 'src': {'same': False, 'congruent': 4, 'type': 'addresses_WC_ht'}, 'dst': {'same': False, 'congruent': 11, 'type': 'addresses_normal_ht'}}
