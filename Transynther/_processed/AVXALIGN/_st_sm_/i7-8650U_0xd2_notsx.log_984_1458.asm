...
push %rdi
push %rsi
lea addresses_A_ht+0x1171f, %r15
nop
nop
nop
nop
...
nop
inc %rbp
lea addresses_A_ht+0x100ab, %r12
nop
xor $45480, %r8
mov (%r12), %rsi
xor $54207, %rsi
lea addresses_UC_ht+0x1109b, %rsi
lea addresses_WC_ht+0x1eaeb, %rdi
clflush (%rdi)
nop
nop
cmp $57168, %r15
...
nop
add %rsi, %rsi
lea addresses_WT_ht+0x1a5b5, %r15
nop
nop
cmp %rsi, %rsi
...
movq %r9, (%r15)
xor %rbp, %rbp
lea addresses_UC_ht+0x130ab, %r8
nop
nop
nop
nop
...
// REPMOV
lea addresses_A+0x7cab, %rsi
lea addresses_D+0xcab, %rdi
clflush (%rdi)
xor $54046, %rax
mov $23, %rcx
rep movsl
...
{'OP': 'REPM', 'src': {'type': 'addresses_A', 'congruent': 0, 'same': True}, 'dst': {'type': 'addresses_D', 'congruent': 11, 'same': False}}
...
{'OP': 'REPM', 'src': {'type': 'addresses_UC_ht', 'congruent': 1, 'same': False}, 'dst': {'type': 'addresses_WC_ht', 'congruent': 6, 'same': True}}
