...
push %rdi
push %rsi
lea addresses_D_ht+0x1e774, %rbp
nop
nop
nop
add %rdi, %rdi
...
nop
dec %rbx
lea addresses_WC_ht+0x1386c, %rsi
lea addresses_D_ht+0x7f74, %rdi
dec %r12
mov $98, %rcx
rep movsw
nop
and $12695, %rbx
lea addresses_WT_ht+0x16f74, %rbx
nop
sub %rax, %rax
mov (%rbx), %r12
dec %rbx
...
// Store
lea addresses_normal+0x1c574, %r13
nop
nop
nop
cmp %r11, %r11
...
// Faulty Load
lea addresses_normal+0x1c574, %r14
nop
nop
nop
nop
