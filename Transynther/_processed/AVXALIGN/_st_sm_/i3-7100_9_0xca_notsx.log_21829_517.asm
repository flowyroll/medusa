...
// Store
lea addresses_normal+0x88c7, %r11
xor $54419, %r9
movl $0x51525354, (%r11)
nop
nop
...
// Store
lea addresses_normal+0x9cc7, %r8
and $28424, %rbx
movl $0x51525354, (%r8)
nop
nop
...
// Faulty Load
lea addresses_normal+0x9cc7, %rsi
nop
xor %rbx, %rbx
mov (%rsi), %r8d
lea oracles, %r9
