...
push %rdx
push %rsi
lea addresses_normal_ht+0x1acf, %r11
nop
nop
nop
nop
...
movq %r15, (%r9)
cmp %rsi, %rsi
lea addresses_A_ht+0x1bbcf, %rdx
clflush (%rdx)
nop
nop
nop
...
nop
add %rdi, %rdi
lea addresses_A_ht+0x1980f, %r11
sub $25665, %rdi
movl $0x61626364, (%r11)
nop
inc %rbp
lea addresses_UC_ht+0x16c7b, %rsi
lea addresses_UC_ht+0xa77, %rdi
nop
nop
add $36798, %r9
mov $37, %rcx
...
nop
sub $46392, %rsi
lea addresses_WC_ht+0x8667, %rsi
lea addresses_D_ht+0x1e64f, %rdi
nop
nop
inc %rbp
mov $94, %rcx
...
// REPMOV
lea addresses_normal+0x530f, %rsi
lea addresses_WT+0x31af, %rdi
nop
nop
nop
nop
...
// REPMOV
lea addresses_D+0x14cf, %rsi
lea addresses_D+0x830f, %rdi
nop
nop
sub %r9, %r9
mov $70, %rcx
...
// Store
lea addresses_normal+0x6fd3, %r9
nop
nop
nop
xor $14083, %r11
...
{'src': {'congruent': 5, 'same': False, 'type': 'addresses_normal'}, 'dst': {'congruent': 3, 'same': False, 'type': 'addresses_WT'}, 'OP': 'REPM'}
{'dst': {'NT': False, 'AVXalign': False, 'size': 4, 'congruent': 6, 'same': False, 'type': 'addresses_UC'}, 'OP': 'STOR'}
{'src': {'congruent': 8, 'same': False, 'type': 'addresses_D'}, 'dst': {'congruent': 5, 'same': False, 'type': 'addresses_D'}, 'OP': 'REPM'}
...
<gen_prepare_buffer>
{'dst': {'NT': True, 'AVXalign': False, 'size': 4, 'congruent': 8, 'same': False, 'type': 'addresses_normal_ht'}, 'OP': 'STOR'}
...
{'src': {'congruent': 1, 'same': False, 'type': 'addresses_UC_ht'}, 'dst': {'congruent': 2, 'same': False, 'type': 'addresses_UC_ht'}, 'OP': 'REPM'}
