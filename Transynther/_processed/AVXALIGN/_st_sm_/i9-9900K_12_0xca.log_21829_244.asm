...
nop
add %r15, %r15
lea addresses_normal_ht+0x6fdc, %rcx
nop
nop
nop
nop
...
nop
inc %r12
lea addresses_WC_ht+0x128ac, %rbp
nop
nop
nop
nop
...
lea addresses_WT_ht+0xaa8c, %rdi
nop
nop
nop
nop
...
{'OP': 'LOAD', 'src': {'size': 4, 'NT': False, 'type': 'addresses_P', 'same': False, 'AVXalign': False, 'congruent': 3}}
...
<gen_prepare_buffer>
{'OP': 'LOAD', 'src': {'size': 8, 'NT': True, 'type': 'addresses_D_ht', 'same': False, 'AVXalign': False, 'congruent': 11}}
