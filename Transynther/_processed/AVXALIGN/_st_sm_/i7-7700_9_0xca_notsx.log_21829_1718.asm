...
nop
add $37767, %r10
lea addresses_A_ht+0x1b996, %rbp
nop
nop
nop
cmp %r14, %r14
...
// Store
lea addresses_UC+0x159e6, %r10
inc %r9
movl $0x51525354, (%r10)
xor $27600, %r10

// Faulty Load
lea addresses_WT+0x85e6, %r13
clflush (%r13)
nop
nop
inc %r10
...
{'dst': {'NT': False, 'AVXalign': True, 'size': 1, 'congruent': 4, 'same': False, 'type': 'addresses_A_ht'}, 'OP': 'STOR'}
{'58': 21829}
