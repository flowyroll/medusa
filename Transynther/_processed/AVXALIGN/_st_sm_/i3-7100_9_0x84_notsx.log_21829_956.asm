...
nop
xor $17190, %rdi
lea addresses_D_ht+0x19d3c, %rsi
lea addresses_A_ht+0x1073c, %rdi
nop
nop
nop
nop
...
nop
xor %rax, %rax
lea addresses_WT_ht+0x4d3c, %rdi
nop
nop
nop
dec %rcx
...
nop
add $39723, %rcx
lea addresses_WT_ht+0x23ea, %rdi
nop
nop
nop
cmp $50693, %rsi
...
nop
sub $23109, %rbx
lea addresses_normal_ht+0x1a5bc, %r8
nop
add %rbp, %rbp
