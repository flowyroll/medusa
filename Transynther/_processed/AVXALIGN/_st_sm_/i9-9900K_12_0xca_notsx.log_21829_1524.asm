...
push %rax
push %rcx
lea addresses_D_ht+0x1d372, %rcx
add $5696, %rax
movw $0x6162, (%rcx)
nop
nop
...
nop
xor %r12, %r12
lea addresses_D_ht+0x14b2, %r13
dec %r9
movb (%r13), %r8b
cmp %r8, %r8
lea addresses_WC_ht+0x119b2, %r9
dec %r14
...
nop
xor $27267, %r12
lea addresses_normal_ht+0x169b2, %r12
cmp %rax, %rax
movl $0x61626364, (%r12)
nop
nop
...
nop
xor $50184, %rcx
lea addresses_D_ht+0x68b2, %r9
nop
sub $24046, %r12
mov (%r9), %rcx
dec %r14
lea addresses_UC_ht+0x13352, %r13
and $54043, %r12
movl $0x61626364, (%r13)
nop
nop
nop
add $45075, %r13
lea addresses_UC_ht+0x17512, %r8
nop
nop
nop
nop
...
nop
inc %rcx
lea addresses_WT_ht+0x14bf4, %r9
nop
nop
nop
nop
...
nop
cmp %r9, %r9
lea addresses_UC_ht+0x1c3b2, %r12
nop
nop
xor %rax, %rax
...
nop
inc %rax
lea addresses_WT_ht+0x127b2, %r13
clflush (%r13)
nop
nop
nop
...
// REPMOV
lea addresses_A+0x1fb32, %rsi
lea addresses_A+0x16b32, %rdi
nop
nop
sub $49487, %r13
mov $82, %rcx
...
{'OP': 'REPM', 'src': {'same': False, 'congruent': 4, 'type': 'addresses_A'}, 'dst': {'same': False, 'congruent': 7, 'type': 'addresses_A'}}
...
{'OP': 'STOR', 'dst': {'same': True, 'type': 'addresses_normal_ht', 'NT': False, 'AVXalign': False, 'size': 4, 'congruent': 10}}
...
{'OP': 'LOAD', 'src': {'same': True, 'type': 'addresses_WT_ht', 'NT': False, 'AVXalign': False, 'size': 4, 'congruent': 0}}
