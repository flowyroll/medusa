...
push %rdi
push %rsi
lea addresses_UC_ht+0x55f6, %rcx
nop
nop
nop
nop
...
nop
inc %r10
lea addresses_WT_ht+0x2356, %rcx
nop
cmp $45494, %rbp
mov (%rcx), %r10d
cmp %r14, %r14
lea addresses_WC_ht+0xb756, %r15
nop
nop
nop
nop
...
nop
and %r11, %r11
lea addresses_normal_ht+0x1b6ef, %rbp
nop
nop
nop
nop
...
nop
add %r13, %r13
lea addresses_WT_ht+0x3268, %rsi
lea addresses_UC_ht+0xea6, %rdi
nop
nop
nop
nop
...
nop
and %rsi, %rsi
lea addresses_normal_ht+0xea26, %r10
nop
nop
dec %r11
movups (%r10), %xmm6
...
nop
add $56632, %r14
lea addresses_WT_ht+0x1e2f6, %rsi
lea addresses_A_ht+0x7bf6, %rdi
nop
nop
nop
sub %r10, %r10
...
nop
cmp %rbp, %rbp
lea addresses_WT_ht+0x19a56, %r13
clflush (%r13)
nop
nop
nop
...
nop
and %r11, %r11
lea addresses_UC_ht+0xe7a8, %rsi
nop
dec %r14
movw $0x6162, (%rsi)
nop
nop
dec %r11
lea addresses_UC_ht+0x11bea, %rsi
lea addresses_D_ht+0xd876, %rdi
nop
nop
nop
nop
...
// Store
lea addresses_normal+0xa756, %r11
nop
nop
nop
nop
...
// Faulty Load
lea addresses_normal+0xa756, %rdx
nop
nop
xor %rsi, %rsi
mov (%rdx), %r8
...
{'src': {'congruent': 1, 'same': False, 'type': 'addresses_WT_ht'}, 'dst': {'congruent': 4, 'same': False, 'type': 'addresses_UC_ht'}, 'OP': 'REPM'}
...
{'src': {'congruent': 2, 'same': False, 'type': 'addresses_UC_ht'}, 'dst': {'congruent': 5, 'same': False, 'type': 'addresses_D_ht'}, 'OP': 'REPM'}
{'58': 21829}
