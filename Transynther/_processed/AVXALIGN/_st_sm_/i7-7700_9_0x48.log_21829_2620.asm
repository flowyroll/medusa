...
nop
cmp $64160, %r14
lea addresses_WC_ht+0x3afd, %r15
and %r10, %r10
movl $0x61626364, (%r15)
nop
cmp $170, %rcx
lea addresses_WT_ht+0x95, %r12
nop
nop
add %r15, %r15
...
nop
and %r14, %r14
lea addresses_normal_ht+0xfdef, %rdi
nop
nop
nop
nop
...
nop
inc %r12
lea addresses_UC_ht+0x7b95, %rcx
nop
nop
mfence
movl $0x61626364, (%rcx)
...
nop
xor $25010, %rcx
lea addresses_UC_ht+0x1c335, %rdi
clflush (%rdi)
nop
nop
xor $13887, %r15
...
// Store
lea addresses_normal+0x14d95, %r13
nop
xor $39584, %rbp
mov $0x5152535455565758, %rdx
movq %rdx, %xmm0
...
// Load
lea addresses_normal+0x9b95, %rdi
nop
inc %rbp
mov (%rdi), %r11
cmp $21701, %rbp
...
{'OP': 'STOR', 'dst': {'type': 'addresses_D', 'AVXalign': True, 'congruent': 7, 'size': 16, 'same': False, 'NT': False}}
...
{'OP': 'STOR', 'dst': {'type': 'addresses_PSE', 'AVXalign': False, 'congruent': 0, 'size': 1, 'same': True, 'NT': True}}
{'OP': 'STOR', 'dst': {'type': 'addresses_RW', 'AVXalign': False, 'congruent': 6, 'size': 4, 'same': False, 'NT': False}}
{'OP': 'LOAD', 'src': {'type': 'addresses_normal', 'AVXalign': False, 'congruent': 11, 'size': 8, 'same': False, 'NT': False}}
[Faulty Load]
...
{'OP': 'STOR', 'dst': {'type': 'addresses_WT_ht', 'AVXalign': False, 'congruent': 6, 'size': 32, 'same': True, 'NT': True}}
