...
nop
and $64829, %r14
lea addresses_WT_ht+0x2434, %rcx
nop
sub $4858, %rbp
movb (%rcx), %bl
nop
...
nop
sub %rbx, %rbx
lea addresses_UC_ht+0x14146, %rsi
lea addresses_D_ht+0x14946, %rdi
clflush (%rdi)
nop
and $34535, %r10
mov $57, %rcx
...
nop
xor %rsi, %rsi
lea addresses_normal_ht+0x2a96, %rcx
nop
nop
nop
sub $4195, %rbp
...
{'dst': {'type': 'addresses_D', 'same': True, 'size': 4, 'congruent': 0, 'NT': True, 'AVXalign': False}, 'OP': 'STOR'}
[Faulty Load]
...
{'src': {'type': 'addresses_UC_ht', 'congruent': 10, 'same': False}, 'dst': {'type': 'addresses_D_ht', 'congruent': 11, 'same': False}, 'OP': 'REPM'}
