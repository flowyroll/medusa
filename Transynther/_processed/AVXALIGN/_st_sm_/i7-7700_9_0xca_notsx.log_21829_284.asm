...
nop
sub $3723, %rbp
lea addresses_UC_ht+0x1e037, %r15
nop
nop
nop
nop
...
{'dst': {'NT': True, 'AVXalign': False, 'size': 1, 'congruent': 0, 'same': True, 'type': 'addresses_A'}, 'OP': 'STOR'}
...
<gen_prepare_buffer>
{'src': {'congruent': 1, 'same': False, 'type': 'addresses_A_ht'}, 'dst': {'congruent': 9, 'same': True, 'type': 'addresses_WC_ht'}, 'OP': 'REPM'}
