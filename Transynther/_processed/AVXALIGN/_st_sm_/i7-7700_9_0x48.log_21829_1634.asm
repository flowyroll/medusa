...
push %rdx
push %rsi
lea addresses_A_ht+0x12892, %rsi
lea addresses_normal_ht+0x153e2, %rdi
clflush (%rsi)
nop
and %r9, %r9
mov $47, %rcx
...
nop
xor $8805, %rax
lea addresses_A_ht+0x2e88, %rsi
lea addresses_D_ht+0x2492, %rdi
nop
sub $47327, %r11
mov $66, %rcx
rep movsl
...
nop
and %rdi, %rdi
lea addresses_WT_ht+0x4092, %r11
nop
nop
nop
nop
...
movups %xmm6, (%r11)
sub %rbp, %rbp
lea addresses_WT_ht+0x5c92, %rbp
nop
nop
nop
add $51115, %r9
...
nop
lfence
lea addresses_WC_ht+0xdfda, %r11
and %rcx, %rcx
...
nop
add %r9, %r9
lea addresses_UC_ht+0x12e11, %rsi
lea addresses_A_ht+0x10672, %rdi
nop
nop
nop
dec %rdx
...
rep movsw
add $64555, %rdi
lea addresses_UC_ht+0x14512, %rbp
nop
nop
nop
nop
...
mov (%rbp), %di
xor $463, %rdi
lea addresses_D_ht+0x14c92, %rsi
clflush (%rsi)
sub %r11, %r11
...
nop
inc %rbp
lea addresses_normal_ht+0xd292, %rax
nop
nop
inc %rdi
mov (%rax), %rsi
...
nop
dec %rbp
lea addresses_UC_ht+0x14392, %rsi
lea addresses_normal_ht+0x1d812, %rdi
clflush (%rsi)
clflush (%rdi)
nop
nop
...
rep movsl
sub $43707, %rcx
lea addresses_UC_ht+0x1a7e2, %r9
nop
nop
nop
nop
...
// Store
lea addresses_normal+0x2562, %rbx
nop
nop
xor %r10, %r10
movl $0x51525354, (%rbx)
...
{'OP': 'LOAD', 'src': {'type': 'addresses_NC', 'AVXalign': False, 'congruent': 4, 'size': 1, 'same': False, 'NT': False}}
{'OP': 'STOR', 'dst': {'type': 'addresses_WC', 'AVXalign': True, 'congruent': 0, 'size': 1, 'same': True, 'NT': False}}
...
{'OP': 'REPM', 'src': {'type': 'addresses_UC_ht', 'congruent': 8, 'same': False}, 'dst': {'type': 'addresses_normal_ht', 'congruent': 7, 'same': True}}
