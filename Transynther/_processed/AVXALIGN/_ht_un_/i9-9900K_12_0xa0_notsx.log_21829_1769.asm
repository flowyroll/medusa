...
nop
inc %rbp
lea addresses_WT_ht+0x1a2bd, %r12
nop
sub $27685, %r13
mov (%r12), %ebp
nop
...
nop
add $32877, %r8
lea addresses_normal_ht+0x69a6, %rsi
lea addresses_normal_ht+0x28ee, %rdi
clflush (%rsi)
nop
nop
nop
...
rep movsw
sub %rdi, %rdi
lea addresses_D_ht+0x18ec6, %rdi
nop
nop
nop
nop
...
nop
inc %rcx
lea addresses_UC_ht+0x18c32, %rsi
lea addresses_normal_ht+0x1dce6, %rdi
nop
nop
and $20615, %r11
mov $4, %rcx
