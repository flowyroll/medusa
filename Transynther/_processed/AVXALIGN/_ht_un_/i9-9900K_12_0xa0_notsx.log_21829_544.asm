...
push %rdx
push %rsi
lea addresses_normal_ht+0x13c6c, %r10
nop
sub $28448, %rdx
...
nop
dec %r9
lea addresses_WT_ht+0x1be6c, %rsi
lea addresses_UC_ht+0x18b84, %rdi
nop
nop
sub %r15, %r15
mov $23, %rcx
...
nop
and $186, %r15
lea addresses_UC_ht+0xbfec, %rdx
nop
nop
nop
nop
...
nop
inc %rdx
lea addresses_normal_ht+0x6870, %r13
nop
nop
nop
nop
...
nop
and $49422, %r10
lea addresses_WT_ht+0xb6f0, %rdi
nop
add $17646, %r13
mov (%rdi), %ecx
nop
...
nop
xor %rsi, %rsi
lea addresses_WC_ht+0x1526c, %rsi
lea addresses_WC_ht+0xdbec, %rdi
clflush (%rsi)
nop
nop
nop
...
nop
add %rsi, %rsi
lea addresses_normal_ht+0x17d1c, %rsi
lea addresses_normal_ht+0x1766c, %rdi
nop
and %r13, %r13
mov $21, %rcx
rep movsw
...
lea addresses_UC_ht+0x17e6c, %rdi
nop
nop
nop
nop
...
nop
cmp %rsi, %rsi
lea addresses_normal_ht+0x7532, %rdi
cmp $6154, %r10
mov $0x6162636465666768, %r15
movq %r15, %xmm7
vmovups %ymm7, (%rdi)
...
nop
cmp %r10, %r10
lea addresses_D_ht+0x5334, %rsi
lea addresses_WT_ht+0xe4dc, %rdi
nop
nop
dec %r15
mov $86, %rcx
...
<gen_prepare_buffer>
{'OP': 'STOR', 'dst': {'type': 'addresses_normal_ht', 'AVXalign': True, 'size': 32, 'NT': False, 'same': False, 'congruent': 11}}
{'src': {'type': 'addresses_WT_ht', 'congruent': 0, 'same': False}, 'OP': 'REPM', 'dst': {'type': 'addresses_UC_ht', 'congruent': 3, 'same': False}}
{'src': {'type': 'addresses_D_ht', 'AVXalign': False, 'size': 32, 'NT': True, 'same': False, 'congruent': 10}, 'OP': 'LOAD'}
...
{'src': {'type': 'addresses_WC_ht', 'congruent': 5, 'same': False}, 'OP': 'REPM', 'dst': {'type': 'addresses_WC_ht', 'congruent': 6, 'same': False}}
{'src': {'type': 'addresses_normal_ht', 'congruent': 4, 'same': False}, 'OP': 'REPM', 'dst': {'type': 'addresses_normal_ht', 'congruent': 9, 'same': True}}
...
{'OP': 'STOR', 'dst': {'type': 'addresses_A_ht', 'AVXalign': True, 'size': 4, 'NT': False, 'same': False, 'congruent': 9}}
{'de': 1, '46': 21821, '89': 7}
