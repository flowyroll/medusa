...
push %rdi
push %rsi
lea addresses_UC_ht+0x150a8, %r13
nop
nop
nop
nop
...
nop
xor %r10, %r10
lea addresses_D_ht+0xb794, %rsi
lea addresses_WT_ht+0x9f34, %rdi
nop
nop
xor %r8, %r8
mov $22, %rcx
...
nop
and $25800, %r15
lea addresses_WT_ht+0x162da, %r8
nop
nop
nop
nop
...
nop
and %r9, %r9
lea addresses_UC_ht+0x1199c, %r8
nop
nop
add %r10, %r10
movb $0x61, (%r8)
...
// Store
mov $0x5adbc10000000334, %rdi
inc %r14
movb $0x51, (%rdi)
add %r12, %r12

// Faulty Load
lea addresses_US+0x1e0f4, %r12
nop
nop
nop
add %r9, %r9
...
{'OP': 'STOR', 'dst': {'type': 'addresses_US', 'AVXalign': True, 'congruent': 0, 'size': 32, 'same': False, 'NT': False}}
{'OP': 'STOR', 'dst': {'type': 'addresses_RW', 'AVXalign': False, 'congruent': 4, 'size': 8, 'same': False, 'NT': False}}
{'OP': 'STOR', 'dst': {'type': 'addresses_NC', 'AVXalign': True, 'congruent': 6, 'size': 1, 'same': False, 'NT': True}}
[Faulty Load]
