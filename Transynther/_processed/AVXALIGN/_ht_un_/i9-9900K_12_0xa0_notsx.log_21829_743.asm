...
push %rdx
push %rsi
lea addresses_D_ht+0x1b687, %rsi
lea addresses_WC_ht+0x18e87, %rdi
xor %rdx, %rdx
mov $14, %rcx
rep movsw
nop
...
nop
xor %r12, %r12
lea addresses_WT_ht+0x7593, %rsi
lea addresses_D_ht+0x158d5, %rdi
nop
nop
nop
nop
...
nop
and $46299, %rdx
lea addresses_WC_ht+0x14e87, %r9
nop
nop
and $57488, %rdi
mov (%r9), %r12d
...
nop
sub %rcx, %rcx
lea addresses_normal_ht+0x130a7, %r11
nop
nop
nop
nop
...
nop
cmp %rcx, %rcx
lea addresses_UC_ht+0x10656, %r12
nop
nop
inc %rdi
mov (%r12), %si
...
nop
add %rdi, %rdi
lea addresses_WT_ht+0x10487, %r9
nop
inc %r12
movb (%r9), %cl
nop
...
nop
sub %r9, %r9
lea addresses_WC_ht+0x1a0a7, %rsi
nop
nop
add $57091, %rcx
movb (%rsi), %r9b
...
<gen_prepare_buffer>
{'src': {'type': 'addresses_D_ht', 'congruent': 11, 'same': False}, 'OP': 'REPM', 'dst': {'type': 'addresses_WC_ht', 'congruent': 7, 'same': True}}
...
{'src': {'type': 'addresses_WC_ht', 'AVXalign': False, 'size': 1, 'NT': True, 'same': False, 'congruent': 3}, 'OP': 'LOAD'}
{'08': 1, '46': 21828}
