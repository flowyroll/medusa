...
push %rdi
push %rsi
lea addresses_normal_ht+0xe6fb, %rsi
lea addresses_A_ht+0x26cb, %rdi
nop
nop
nop
xor %rax, %rax
...
nop
add %rax, %rax
lea addresses_WC_ht+0x1eb6b, %rax
nop
nop
nop
sub $1709, %rbx
...
nop
xor $41650, %rsi
lea addresses_A_ht+0x86eb, %rsi
lea addresses_UC_ht+0xa6cb, %rdi
nop
dec %r10
mov $47, %rcx
rep movsb
nop
inc %r10
lea addresses_WC_ht+0xc64b, %rbx
nop
nop
inc %r10
movb (%rbx), %r11b
...
nop
and $39532, %rbx
lea addresses_WT_ht+0x1ccb, %rbx
nop
add %r10, %r10
movb (%rbx), %al
nop
sub %rsi, %rsi
lea addresses_D_ht+0x98bd, %rbx
nop
nop
nop
nop
...
nop
cmp $40186, %rdi
lea addresses_D_ht+0xf20b, %rdi
cmp $9134, %rbx
movb $0x61, (%rdi)
nop
dec %r11
lea addresses_WC_ht+0x944b, %rsi
lea addresses_UC_ht+0x20cb, %rdi
nop
nop
nop
nop
...
nop
sub $39193, %rbx
lea addresses_normal_ht+0x83cb, %rdi
nop
nop
nop
nop
...
nop
and %rbx, %rbx
lea addresses_WC_ht+0xa83b, %rax
nop
and $43601, %rbx
...
nop
sub $11113, %rcx
lea addresses_normal_ht+0xb28b, %rdi
nop
nop
and $5713, %r10
mov (%rdi), %bx
...
// Load
lea addresses_RW+0x160cb, %rdi
dec %rbp
mov (%rdi), %r9w
sub $30934, %rdi

// Store
lea addresses_A+0x160cb, %rbp
nop
nop
nop
nop
...
<gen_prepare_buffer>
{'OP': 'REPM', 'src': {'type': 'addresses_normal_ht', 'congruent': 4, 'same': False}, 'dst': {'type': 'addresses_A_ht', 'congruent': 9, 'same': False}}
