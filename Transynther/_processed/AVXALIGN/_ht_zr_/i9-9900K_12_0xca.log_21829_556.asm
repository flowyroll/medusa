...
push %rdi
push %rsi
lea addresses_WT_ht+0x1a111, %rcx
clflush (%rcx)
nop
and %r11, %r11
movb $0x61, (%rcx)
cmp $1728, %r14
lea addresses_WT_ht+0x1b291, %r10
add %r14, %r14
movw $0x6162, (%r10)
nop
add %r10, %r10
lea addresses_D_ht+0x14511, %r15
clflush (%r15)
nop
cmp %rdi, %rdi
...
nop
cmp $576, %r15
lea addresses_UC_ht+0x1bf11, %r15
nop
nop
nop
nop
...
nop
xor %r15, %r15
lea addresses_A_ht+0xfb11, %r14
nop
nop
dec %r9
movb (%r14), %cl
and %r14, %r14
lea addresses_normal_ht+0xd091, %rsi
lea addresses_WT_ht+0x1cd11, %rdi
nop
nop
nop
and %r15, %r15
...
nop
sub $40287, %rdi
lea addresses_WT_ht+0x1c311, %rsi
lea addresses_normal_ht+0x6719, %rdi
nop
nop
add $56911, %r14
mov $47, %rcx
...
nop
add %rdi, %rdi
lea addresses_UC_ht+0x7ba1, %rsi
lea addresses_A_ht+0x111b1, %rdi
nop
nop
nop
cmp $64260, %r14
...
<gen_prepare_buffer>
{'OP': 'STOR', 'dst': {'size': 1, 'NT': False, 'type': 'addresses_WT_ht', 'same': True, 'AVXalign': False, 'congruent': 9}}
...
{'OP': 'REPM', 'src': {'same': False, 'type': 'addresses_normal_ht', 'congruent': 7}, 'dst': {'same': False, 'type': 'addresses_WT_ht', 'congruent': 9}}
{'OP': 'REPM', 'src': {'same': False, 'type': 'addresses_WT_ht', 'congruent': 11}, 'dst': {'same': False, 'type': 'addresses_normal_ht', 'congruent': 3}}
