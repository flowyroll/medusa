...
push %rdi
push %rsi
lea addresses_D_ht+0x1072f, %rdi
nop
nop
nop
nop
...
nop
inc %r15
lea addresses_UC_ht+0xdb1c, %r10
nop
nop
nop
add $43114, %rax
mov (%r10), %rdi
cmp %rax, %rax
lea addresses_A_ht+0xd72f, %rsi
lea addresses_UC_ht+0x1c62f, %rdi
nop
nop
nop
nop
...
nop
cmp $22855, %rdi
lea addresses_A_ht+0x4f97, %rsi
lea addresses_UC_ht+0xac6b, %rdi
nop
nop
nop
nop
...
nop
sub %r14, %r14
lea addresses_A_ht+0x1ff7, %rsi
lea addresses_normal_ht+0x1d32f, %rdi
clflush (%rsi)
nop
nop
and $29650, %rax
...
nop
and %r14, %r14
lea addresses_A_ht+0x1a72f, %rcx
nop
sub $19931, %r8
...
nop
xor %rcx, %rcx
lea addresses_normal_ht+0x7e3b, %r8
nop
nop
add %rsi, %rsi
movw $0x6162, (%r8)
