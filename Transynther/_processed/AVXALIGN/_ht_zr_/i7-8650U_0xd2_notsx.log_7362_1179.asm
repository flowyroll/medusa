...
push %rdi
push %rsi
lea addresses_WT_ht+0x37c2, %rsi
lea addresses_A_ht+0x1d4c2, %rdi
nop
inc %rbp
mov $19, %rcx
rep movsw
...
nop
xor %r9, %r9
lea addresses_D_ht+0xe0c2, %rsi
lea addresses_normal_ht+0xcbc2, %rdi
nop
and %rbx, %rbx
mov $97, %rcx
rep movsw
inc %r9
lea addresses_normal_ht+0xc3a4, %rsi
nop
nop
nop
nop
...
nop
sub $7058, %rdi
lea addresses_D_ht+0x142e2, %rbp
nop
sub %rdi, %rdi
...
// REPMOV
lea addresses_D+0xa522, %rsi
lea addresses_RW+0x134c2, %rdi
nop
nop
dec %r11
mov $3, %rcx
...
{'OP': 'REPM', 'src': {'type': 'addresses_D', 'congruent': 5, 'same': False}, 'dst': {'type': 'addresses_RW', 'congruent': 8, 'same': False}}
...
<gen_prepare_buffer>
{'OP': 'REPM', 'src': {'type': 'addresses_WT_ht', 'congruent': 10, 'same': False}, 'dst': {'type': 'addresses_A_ht', 'congruent': 7, 'same': False}}
{'OP': 'STOR', 'dst': {'type': 'addresses_D_ht', 'size': 1, 'AVXalign': False, 'NT': True, 'congruent': 2, 'same': False}}
{'OP': 'REPM', 'src': {'type': 'addresses_D_ht', 'congruent': 7, 'same': True}, 'dst': {'type': 'addresses_normal_ht', 'congruent': 10, 'same': False}}
