...
push %rdi
push %rsi
lea addresses_A_ht+0x14551, %rsi
lea addresses_UC_ht+0x7385, %rdi
nop
nop
nop
xor %r10, %r10
...
nop
sub $21028, %r10
lea addresses_normal_ht+0x1c185, %rax
nop
nop
nop
nop
...
mov (%rax), %r9
sub $58393, %r9
lea addresses_A_ht+0x2a5, %rsi
lea addresses_WT_ht+0x119ad, %rdi
nop
nop
cmp $57740, %rbx
mov $15, %rcx
...
nop
sub $64542, %r10
lea addresses_normal_ht+0x6ee5, %rsi
nop
nop
nop
nop
...
{'OP': 'STOR', 'dst': {'same': False, 'type': 'addresses_P', 'NT': True, 'AVXalign': False, 'size': 8, 'congruent': 5}}
