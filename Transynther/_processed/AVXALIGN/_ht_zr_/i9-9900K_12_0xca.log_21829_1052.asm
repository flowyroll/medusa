...
nop
add %rdi, %rdi
lea addresses_WC_ht+0x131e4, %r12
nop
nop
nop
nop
...
lea addresses_UC_ht+0x1a664, %rdi
clflush (%rdi)
nop
nop
add $47700, %rbx
...
rep movsw
add %r11, %r11
lea addresses_WT_ht+0x1a5e4, %rsi
lea addresses_D_ht+0x83e8, %rdi
nop
add %r15, %r15
mov $3, %rcx
rep movsw
...
mov (%r8), %r12
and %rcx, %rcx
lea addresses_UC_ht+0xe2a6, %rcx
nop
nop
cmp $53466, %rsi
mov (%rcx), %r11d
...
nop
sub $35654, %rcx
lea addresses_D_ht+0x178e4, %rsi
lea addresses_A_ht+0x68e4, %rdi
nop
nop
nop
nop
...
nop
dec %rbx
lea addresses_normal_ht+0x1e5e4, %rdi
nop
nop
nop
cmp %rcx, %rcx
...
{'OP': 'REPM', 'src': {'same': False, 'type': 'addresses_D_ht', 'congruent': 2}, 'dst': {'same': False, 'type': 'addresses_UC_ht', 'congruent': 7}}
