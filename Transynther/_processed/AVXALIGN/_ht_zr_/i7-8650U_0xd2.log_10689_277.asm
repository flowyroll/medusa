...
push %rdx
push %rsi
lea addresses_normal_ht+0x15144, %r8
nop
nop
xor $15476, %rdi
...
nop
dec %r14
lea addresses_UC_ht+0x153e4, %rsi
nop
nop
nop
nop
...
nop
xor $46938, %rdi
lea addresses_WC_ht+0x17a44, %r12
nop
dec %rdx
movb $0x61, (%r12)
nop
...
nop
xor %rdx, %rdx
lea addresses_D_ht+0x13384, %rdi
clflush (%rdi)
nop
nop
sub $29457, %r12
...
nop
sub %rdi, %rdi
lea addresses_WT_ht+0x8684, %r12
nop
cmp %rsi, %rsi
movw $0x6162, (%r12)
nop
cmp $7570, %r14
lea addresses_normal_ht+0x10584, %rdx
clflush (%rdx)
inc %r14
movups (%rdx), %xmm3
vpextrq $0, %xmm3, %rbx
nop
add $15495, %rdx
lea addresses_UC_ht+0xec84, %rsi
lea addresses_UC_ht+0x14ab0, %rdi
clflush (%rsi)
nop
nop
xor %r8, %r8
...
{'OP': 'STOR', 'dst': {'type': 'addresses_WT_ht', 'size': 2, 'AVXalign': True, 'NT': False, 'congruent': 1, 'same': False}}
{'OP': 'STOR', 'dst': {'type': 'addresses_WT_ht', 'size': 2, 'AVXalign': False, 'NT': True, 'congruent': 8, 'same': False}}
