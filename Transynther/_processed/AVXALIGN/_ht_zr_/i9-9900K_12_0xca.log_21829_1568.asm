...
nop
xor $57735, %rax
lea addresses_UC_ht+0x119f3, %r11
clflush (%r11)
nop
nop
nop
...
nop
cmp $16155, %r15
lea addresses_A_ht+0x127f3, %r11
nop
dec %rbx
...
nop
dec %rdi
lea addresses_WC_ht+0x4853, %r15
nop
nop
nop
nop
...
<gen_prepare_buffer>
{'OP': 'REPM', 'src': {'same': False, 'type': 'addresses_A_ht', 'congruent': 5}, 'dst': {'same': False, 'type': 'addresses_WT_ht', 'congruent': 3}}
{'OP': 'LOAD', 'src': {'size': 2, 'NT': False, 'type': 'addresses_UC_ht', 'same': False, 'AVXalign': False, 'congruent': 7}}
{'OP': 'STOR', 'dst': {'size': 16, 'NT': True, 'type': 'addresses_A_ht', 'same': True, 'AVXalign': True, 'congruent': 5}}
