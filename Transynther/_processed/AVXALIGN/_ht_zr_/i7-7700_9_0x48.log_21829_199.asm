...
lea addresses_UC_ht+0x1e8e4, %rdi
nop
sub $24728, %r13
mov $40, %rcx
rep movsq
nop
dec %r10
lea addresses_WC_ht+0xdbbc, %r12
nop
nop
nop
nop
...
// Store
lea addresses_normal+0x101bc, %rbx
nop
nop
nop
dec %rax
