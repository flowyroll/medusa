...
push %rdi
push %rsi
lea addresses_WC_ht+0x473, %rsi
lea addresses_UC_ht+0x1d078, %rdi
nop
nop
nop
dec %rbx
...
nop
xor %rbx, %rbx
lea addresses_UC_ht+0x140f3, %r13
xor $44912, %r11
movw $0x6162, (%r13)
nop
sub $5122, %r13
lea addresses_UC_ht+0x188bf, %r13
nop
nop
nop
xor $46541, %r15
...
nop
cmp %r15, %r15
lea addresses_WC_ht+0x9cf3, %r13
nop
nop
nop
nop
...
nop
and $323, %rsi
lea addresses_WC_ht+0x174f3, %rcx
nop
nop
nop
cmp $36315, %rbx
...
vpextrq $1, %xmm2, %r11
inc %r15
lea addresses_A_ht+0x161f3, %r13
nop
nop
xor $2092, %r15
mov (%r13), %cx
...
nop
add $28506, %rsi
lea addresses_UC_ht+0x1cf43, %rsi
clflush (%rsi)
nop
nop
nop
...
nop
dec %r13
lea addresses_normal_ht+0x151f3, %r15
nop
nop
nop
nop
...
nop
add %rdi, %rdi
lea addresses_normal_ht+0x166f7, %r11
nop
nop
nop
nop
...
// Store
lea addresses_D+0x10393, %r12
add %r13, %r13
movw $0x5152, (%r12)
cmp $26163, %r12

// Load
lea addresses_A+0xf6f3, %rsi
nop
nop
nop
nop
...
{'OP': 'LOAD', 'src': {'type': 'addresses_A', 'AVXalign': False, 'congruent': 9, 'size': 4, 'same': False, 'NT': False}}
[Faulty Load]
...
{'OP': 'STOR', 'dst': {'type': 'addresses_normal_ht', 'AVXalign': True, 'congruent': 7, 'size': 16, 'same': False, 'NT': True}}
