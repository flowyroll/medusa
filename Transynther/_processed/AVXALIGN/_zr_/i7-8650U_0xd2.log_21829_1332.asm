...
nop
xor $9680, %r15
lea addresses_WT_ht+0x4395, %rsi
lea addresses_D_ht+0x1bbf2, %rdi
nop
nop
add %rbx, %rbx
mov $3, %rcx
...
nop
cmp $65175, %rcx
lea addresses_normal_ht+0x38ac, %rsi
lea addresses_WT_ht+0x1b842, %rdi
nop
nop
cmp $55646, %r14
mov $5, %rcx
rep movsw
dec %rsi
lea addresses_WT_ht+0x1d042, %rsi
lea addresses_normal_ht+0x2b82, %rdi
nop
nop
nop
inc %rbp
...
nop
dec %r11
lea addresses_UC_ht+0x12682, %rsi
lea addresses_normal_ht+0x123c2, %rdi
nop
nop
nop
nop
...
{'OP': 'REPM', 'src': {'type': 'addresses_normal_ht', 'congruent': 1, 'same': False}, 'dst': {'type': 'addresses_WT_ht', 'congruent': 9, 'same': False}}
