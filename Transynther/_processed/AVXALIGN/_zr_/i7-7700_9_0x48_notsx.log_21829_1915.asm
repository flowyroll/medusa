...
lea addresses_UC_ht+0x7a64, %rdi
clflush (%rsi)
nop
nop
cmp $61439, %rbx
...
rep movsl
cmp $51556, %r10
lea addresses_WC_ht+0xd2e4, %rdx
nop
add $42455, %r12
mov (%rdx), %rcx
nop
...
// REPMOV
lea addresses_WC+0x9d64, %rsi
lea addresses_WC+0x1d2e4, %rdi
clflush (%rsi)
nop
nop
xor $46462, %r11
...
{'dst': {'same': False, 'congruent': 10, 'type': 'addresses_WC'}, 'OP': 'REPM', 'src': {'same': False, 'congruent': 7, 'type': 'addresses_WC'}}
...
[Faulty Load]
{'OP': 'LOAD', 'src': {'same': True, 'NT': True, 'AVXalign': True, 'size': 1, 'type': 'addresses_A', 'congruent': 0}}
<gen_prepare_buffer>
{'dst': {'same': False, 'NT': False, 'AVXalign': False, 'size': 4, 'type': 'addresses_normal_ht', 'congruent': 5}, 'OP': 'STOR'}
{'dst': {'same': False, 'congruent': 7, 'type': 'addresses_UC_ht'}, 'OP': 'REPM', 'src': {'same': False, 'congruent': 11, 'type': 'addresses_normal_ht'}}
