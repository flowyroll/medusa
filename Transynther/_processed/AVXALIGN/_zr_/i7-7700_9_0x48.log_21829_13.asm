...
push %rdi
push %rsi
lea addresses_WT_ht+0xb23c, %r10
nop
nop
nop
inc %r13
...
nop
cmp %rsi, %rsi
lea addresses_WT_ht+0x453c, %rsi
lea addresses_A_ht+0x180fc, %rdi
nop
nop
sub $10443, %r13
mov $120, %rcx
...
nop
cmp $47759, %r13
lea addresses_normal_ht+0x723c, %rsi
lea addresses_D_ht+0x172bc, %rdi
add %rax, %rax
mov $22, %rcx
rep movsb
nop
