...
push %rdi
push %rsi
lea addresses_WC_ht+0x1a71, %rsi
lea addresses_WT_ht+0x17a71, %rdi
nop
nop
inc %rbp
mov $32, %rcx
...
nop
cmp $41640, %r15
lea addresses_WT_ht+0x1e951, %rax
nop
sub %rdi, %rdi
movb $0x61, (%rax)
xor %rsi, %rsi
lea addresses_D_ht+0x10271, %r15
nop
add $20639, %rsi
movups (%r15), %xmm4
vpextrq $1, %xmm4, %rcx
...
nop
inc %r15
lea addresses_WC_ht+0x2a71, %rsi
nop
nop
nop
nop
...
nop
inc %rsi
lea addresses_WC_ht+0x1ee71, %rbp
nop
nop
nop
nop
...
nop
xor $55141, %rax
lea addresses_WT_ht+0x33b1, %rdi
nop
nop
nop
add %r13, %r13
mov (%rdi), %ecx
sub $14152, %rax
lea addresses_UC_ht+0x30f1, %rcx
clflush (%rcx)
cmp $34699, %r13
mov (%rcx), %rdi
nop
...
nop
dec %r15
lea addresses_WC_ht+0x75f1, %rbp
clflush (%rbp)
nop
nop
nop
...
nop
add %rcx, %rcx
lea addresses_WT_ht+0x706a, %rcx
nop
nop
nop
nop
...
nop
add $45948, %rax
lea addresses_normal_ht+0x3a71, %r15
nop
nop
sub $42977, %rcx
movw $0x6162, (%r15)
xor %rcx, %rcx
lea addresses_WT_ht+0xf871, %rdi
nop
nop
nop
nop
...
movb $0x61, (%rdi)
and $54234, %r15
lea addresses_UC_ht+0x14c71, %rsi
...
nop
dec %rbp
lea addresses_WC_ht+0x1dbcd, %rsi
lea addresses_UC_ht+0xc5d9, %rdi
and %r12, %r12
mov $25, %rcx
rep movsl
nop
...
nop
and $17572, %r13
lea addresses_WC_ht+0x5c61, %r13
nop
nop
nop
nop
...
nop
sub $17786, %r13
lea addresses_normal_ht+0x36d1, %rcx
nop
nop
add %rax, %rax
movl $0x61626364, (%rcx)
...
<gen_prepare_buffer>
{'src': {'same': False, 'congruent': 11, 'type': 'addresses_WC_ht'}, 'OP': 'REPM', 'dst': {'same': False, 'congruent': 10, 'type': 'addresses_WT_ht'}}
