...
nop
xor $26852, %rdi
lea addresses_WT_ht+0xc47e, %r13
nop
nop
add %r8, %r8
mov (%r13), %r15w
...
nop
sub $52130, %r11
lea addresses_A_ht+0xff16, %rsi
lea addresses_normal_ht+0x1b716, %rdi
nop
nop
nop
nop
...
nop
add %r15, %r15
lea addresses_A_ht+0x1e916, %r13
inc %r15
mov (%r13), %r8d
nop
nop
dec %rcx
lea addresses_WC_ht+0x13f16, %rcx
nop
add $11101, %rbx
movups (%rcx), %xmm7
vpextrq $1, %xmm7, %r11
...
nop
and %r11, %r11
lea addresses_normal_ht+0x1686, %rsi
...
nop
cmp $8126, %rcx
lea addresses_UC_ht+0x6276, %r13
nop
nop
cmp %rbx, %rbx
mov (%r13), %r8w
...
nop
add %r13, %r13
lea addresses_UC_ht+0xc816, %rsi
lea addresses_D_ht+0x1e716, %rdi
cmp %rbx, %rbx
mov $53, %rcx
rep movsq
nop
...
nop
add %rdi, %rdi
lea addresses_WT_ht+0x743f, %r13
and %r15, %r15
mov (%r13), %rsi
nop
nop
...
// Load
lea addresses_normal+0x1916, %r11
nop
nop
nop
sub %r9, %r9
...
{'src': {'type': 'addresses_WC', 'AVXalign': True, 'size': 32, 'NT': False, 'same': False, 'congruent': 9}, 'OP': 'LOAD'}
[Faulty Load]
...
{'src': {'type': 'addresses_A_ht', 'AVXalign': True, 'size': 4, 'NT': False, 'same': False, 'congruent': 4}, 'OP': 'LOAD'}
{'src': {'type': 'addresses_WC_ht', 'AVXalign': False, 'size': 16, 'NT': False, 'same': False, 'congruent': 11}, 'OP': 'LOAD'}
{'src': {'type': 'addresses_normal_ht', 'congruent': 1, 'same': False}, 'OP': 'REPM', 'dst': {'type': 'addresses_WT_ht', 'congruent': 4, 'same': False}}
...
{'src': {'type': 'addresses_WT_ht', 'AVXalign': False, 'size': 8, 'NT': True, 'same': False, 'congruent': 0}, 'OP': 'LOAD'}
{'00': 7502}
