...
push %rdi
push %rsi
lea addresses_UC_ht+0x15fa9, %r11
nop
nop
sub %r8, %r8
movb (%r11), %r15b
add %r8, %r8
lea addresses_WT_ht+0x1b413, %rsi
lea addresses_WT_ht+0x18acf, %rdi
nop
nop
nop
and $16567, %r11
...
// Store
lea addresses_normal+0xd0f, %rsi
nop
nop
nop
nop
...
<gen_faulty_load>
[REF]
{'OP': 'LOAD', 'src': {'type': 'addresses_P', 'size': 32, 'AVXalign': False, 'NT': False, 'congruent': 0, 'same': True}}
{'OP': 'STOR', 'dst': {'type': 'addresses_RW', 'size': 8, 'AVXalign': True, 'NT': False, 'congruent': 9, 'same': False}}
