...
lea addresses_WT_ht+0x1a02f, %rdi
nop
nop
nop
nop
...
rep movsb
dec %r13
lea addresses_UC_ht+0x8fcf, %rcx
nop
nop
nop
nop
...
{'src': {'type': 'addresses_UC_ht', 'congruent': 6, 'same': False}, 'OP': 'REPM', 'dst': {'type': 'addresses_WT_ht', 'congruent': 2, 'same': False}}
