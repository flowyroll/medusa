...
push %rdx
push %rsi
lea addresses_WC_ht+0x85f7, %r12
nop
xor %rdi, %rdi
movw $0x6162, (%r12)
nop
...
lea addresses_normal_ht+0x111c5, %rdi
nop
nop
nop
nop
...
nop
xor %r10, %r10
lea addresses_WT_ht+0x6145, %rsi
nop
nop
nop
nop
...
movw $0x6162, (%rsi)
cmp %rcx, %rcx
lea addresses_normal_ht+0xfac5, %rsi
nop
nop
nop
nop
...
nop
xor $11874, %r12
lea addresses_WC_ht+0xaf85, %r10
sub $41409, %rdx
vmovups (%r10), %ymm6
...
{'OP': 'STOR', 'dst': {'type': 'addresses_UC', 'AVXalign': True, 'size': 8, 'NT': False, 'same': False, 'congruent': 8}}
[Faulty Load]
...
{'src': {'type': 'addresses_A_ht', 'congruent': 6, 'same': True}, 'OP': 'REPM', 'dst': {'type': 'addresses_normal_ht', 'congruent': 7, 'same': False}}
