...
nop
xor $49232, %r12
lea addresses_WT_ht+0x11d26, %rsi
lea addresses_normal_ht+0x1d026, %rdi
nop
nop
nop
nop
...
nop
sub %r12, %r12
lea addresses_A_ht+0x1488c, %rsi
lea addresses_UC_ht+0x7a26, %rdi
nop
nop
nop
and %rbp, %rbp
...
lea addresses_normal_ht+0x12fd6, %rdi
nop
nop
nop
nop
...
nop
xor $6079, %r11
lea addresses_UC_ht+0x13526, %rsi
lea addresses_WC_ht+0x14ca6, %rdi
nop
nop
nop
nop
...
nop
inc %rdx
lea addresses_UC_ht+0x19a26, %r12
nop
nop
nop
nop
...
nop
sub $19309, %r12
lea addresses_A_ht+0xea26, %rsi
lea addresses_A_ht+0x13a26, %rdi
nop
nop
nop
nop
...
nop
inc %rdx
lea addresses_WT_ht+0x2626, %rcx
clflush (%rcx)
nop
nop
and %rbp, %rbp
...
nop
add $3741, %rcx
lea addresses_normal_ht+0x3626, %r12
nop
nop
cmp %rdi, %rdi
movups (%r12), %xmm2
vpextrq $1, %xmm2, %rdx
xor %rbp, %rbp
lea addresses_A_ht+0x13a26, %rsi
nop
nop
nop
nop
...
nop
xor %r11, %r11
lea addresses_WT_ht+0x5d1a, %rsi
lea addresses_A_ht+0x11fe6, %rdi
nop
nop
nop
add %rbp, %rbp
...
nop
inc %rsi
lea addresses_WC_ht+0x1b626, %rsi
lea addresses_WT_ht+0x175a6, %rdi
nop
nop
nop
nop
...
{'src': {'type': 'addresses_WT_ht', 'congruent': 8, 'same': False}, 'OP': 'REPM', 'dst': {'type': 'addresses_normal_ht', 'congruent': 8, 'same': False}}
...
{'OP': 'STOR', 'dst': {'type': 'addresses_A_ht', 'AVXalign': False, 'size': 2, 'NT': True, 'same': True, 'congruent': 9}}
