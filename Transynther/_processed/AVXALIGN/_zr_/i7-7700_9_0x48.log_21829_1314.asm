...
push %rdx
push %rsi
lea addresses_WC_ht+0xa869, %r14
nop
nop
nop
inc %r11
...
mov (%r11), %esi
add $3782, %rdx
lea addresses_WT_ht+0xdce9, %r14
clflush (%r14)
add %r13, %r13
movups (%r14), %xmm2
vpextrq $1, %xmm2, %rsi
...
nop
sub $50610, %r14
lea addresses_D_ht+0xe0e9, %rsi
lea addresses_UC_ht+0x7a69, %rdi
clflush (%rsi)
nop
nop
nop
...
nop
inc %r14
lea addresses_A_ht+0x14a89, %rbx
nop
add $57269, %rdx
...
nop
xor %r11, %r11
lea addresses_WC_ht+0x1b89, %rdi
nop
nop
nop
nop
...
nop
and %rsi, %rsi
lea addresses_A_ht+0x1bbe9, %r14
nop
nop
nop
cmp $12456, %rbx
...
nop
and $17415, %rbx
lea addresses_A_ht+0x8229, %rsi
lea addresses_A_ht+0x3069, %rdi
xor %r10, %r10
mov $113, %rcx
rep movsb
nop
...
nop
xor %r13, %r13
lea addresses_WT_ht+0xebe9, %rsi
lea addresses_WC_ht+0x8a69, %rdi
nop
nop
nop
mfence
...
nop
and $8113, %r13
lea addresses_UC_ht+0x6269, %rdi
nop
nop
nop
nop
...
{'OP': 'REPM', 'src': {'type': 'addresses_D_ht', 'congruent': 4, 'same': False}, 'dst': {'type': 'addresses_UC_ht', 'congruent': 11, 'same': False}}
...
{'OP': 'LOAD', 'src': {'type': 'addresses_UC_ht', 'AVXalign': False, 'congruent': 11, 'size': 4, 'same': False, 'NT': True}}
{'00': 21829}
