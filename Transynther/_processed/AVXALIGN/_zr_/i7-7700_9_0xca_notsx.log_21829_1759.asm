...
lea addresses_WC_ht+0x11859, %rdi
nop
nop
nop
xor $50855, %rbx
...
nop
cmp $5135, %rdi
lea addresses_A_ht+0x192d9, %r13
nop
and $27874, %rbx
mov (%r13), %cx
nop
xor %r13, %r13
lea addresses_UC_ht+0x16bd9, %rcx
nop
add $4106, %rdi
mov (%rcx), %rbx
nop
add $39565, %rcx
lea addresses_WT_ht+0xeb0f, %rcx
nop
nop
sub $2714, %rdx
...
<gen_prepare_buffer>
{'src': {'congruent': 8, 'same': False, 'type': 'addresses_WT_ht'}, 'dst': {'congruent': 11, 'same': False, 'type': 'addresses_A_ht'}, 'OP': 'REPM'}
{'src': {'congruent': 0, 'same': False, 'type': 'addresses_WC_ht'}, 'dst': {'congruent': 6, 'same': False, 'type': 'addresses_WC_ht'}, 'OP': 'REPM'}
