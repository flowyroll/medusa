...
nop
sub $59887, %rdx
lea addresses_normal_ht+0x246f, %rdi
nop
nop
nop
and $13483, %r8
...
nop
xor %r15, %r15
lea addresses_WT_ht+0x86df, %rsi
lea addresses_A_ht+0x1ecaf, %rdi
nop
nop
dec %r8
mov $103, %rcx
...
nop
add %r14, %r14
lea addresses_WT_ht+0x15d39, %rdx
xor %rdi, %rdi
mov (%rdx), %ecx
mfence
lea addresses_normal_ht+0xca1f, %r15
nop
nop
nop
nop
...
nop
sub %rsi, %rsi
lea addresses_A_ht+0x9a1b, %rsi
add $57640, %r15
movb (%rsi), %cl
nop
cmp %r14, %r14
lea addresses_D_ht+0xf997, %r8
nop
nop
nop
nop
...
nop
sub %r15, %r15
lea addresses_D_ht+0x194ef, %r14
xor $28862, %rdx
...
lea addresses_WT_ht+0xf35f, %rdi
clflush (%rdi)
nop
nop
and %r15, %r15
