...
push %rdi
push %rsi
lea addresses_WC_ht+0x13c68, %rsi
nop
nop
nop
nop
...
vpextrq $1, %xmm6, %r15
and %rsi, %rsi
lea addresses_UC_ht+0x129dc, %r8
nop
nop
add $60260, %r13
mov (%r8), %r9w
...
nop
cmp %r9, %r9
lea addresses_WT_ht+0x225c, %rsi
lea addresses_A_ht+0x110dc, %rdi
and $44973, %r13
mov $105, %rcx
rep movsw
add $26692, %rdi
lea addresses_WC_ht+0x1dcdc, %rcx
nop
nop
nop
inc %r9
...
// Store
lea addresses_normal+0x1058, %r15
nop
nop
nop
nop
