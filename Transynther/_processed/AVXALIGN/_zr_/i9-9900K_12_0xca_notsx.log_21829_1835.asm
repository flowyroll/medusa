...
push %rdx
push %rsi
lea addresses_WC_ht+0x13b86, %rdx
nop
nop
nop
and $29783, %r10
...
movb (%rbp), %r11b
inc %r11
lea addresses_WC_ht+0x10d16, %rsi
lea addresses_UC_ht+0x27e6, %rdi
and %r10, %r10
mov $92, %rcx
rep movsq
nop
xor %rdx, %rdx
lea addresses_D_ht+0x886, %r11
dec %rsi
...
nop
and $37830, %rbp
lea addresses_UC_ht+0x16666, %rsi
...
nop
dec %rbp
lea addresses_D_ht+0x18d86, %rdx
nop
nop
add $10181, %rdi
...
nop
dec %r10
lea addresses_WC_ht+0x1c986, %rdx
nop
nop
nop
nop
...
mov (%rdx), %ecx
dec %rbp
lea addresses_WC_ht+0x87d6, %rbp
cmp %rdx, %rdx
movb (%rbp), %r10b
nop
nop
...
nop
cmp %r8, %r8
lea addresses_normal_ht+0x19b06, %r10
nop
nop
sub %rbp, %rbp
movl $0x61626364, (%r10)
...
nop
cmp %rax, %rax
lea addresses_UC_ht+0x9586, %rsi
...
{'OP': 'REPM', 'src': {'same': False, 'congruent': 10, 'type': 'addresses_UC_ht'}, 'dst': {'same': False, 'congruent': 9, 'type': 'addresses_normal_ht'}}
{'00': 21829}
