...
push %rdi
push %rsi
lea addresses_WC_ht+0x13532, %r9
clflush (%r9)
nop
nop
nop
...
mov (%r9), %r14d
sub %rdi, %rdi
lea addresses_UC_ht+0x1672, %rsi
lea addresses_A_ht+0x16619, %rdi
nop
nop
inc %r12
mov $32, %rcx
...
nop
sub $45046, %rcx
lea addresses_UC_ht+0x1b532, %rsi
lea addresses_WC_ht+0x154ce, %rdi
nop
sub %r8, %r8
mov $39, %rcx
rep movsq
...
nop
xor %rsi, %rsi
lea addresses_WT_ht+0x1e532, %rsi
lea addresses_UC_ht+0x1d376, %rdi
cmp %rbx, %rbx
mov $97, %rcx
rep movsq
nop
inc %rsi
lea addresses_A_ht+0x93b6, %rsi
lea addresses_UC_ht+0x379e, %rdi
nop
nop
nop
nop
...
nop
add %r12, %r12
lea addresses_UC_ht+0x125a2, %rsi
nop
nop
cmp $44332, %r9
movw $0x6162, (%rsi)
dec %r9
lea addresses_UC_ht+0xc272, %r8
nop
nop
nop
nop
...
{'OP': 'REPM', 'src': {'type': 'addresses_UC_ht', 'congruent': 11, 'same': True}, 'dst': {'type': 'addresses_WC_ht', 'congruent': 1, 'same': False}}
