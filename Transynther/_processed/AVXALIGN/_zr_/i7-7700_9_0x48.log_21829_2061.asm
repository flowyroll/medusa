...
push %rdi
push %rsi
lea addresses_WC_ht+0x3785, %rsi
lea addresses_WC_ht+0x1d1d5, %rdi
nop
nop
nop
nop
...
rep movsb
xor $31521, %r15
lea addresses_normal_ht+0xb7ed, %r8
clflush (%r8)
sub $24995, %r10
mov (%r8), %si
nop
...
nop
inc %r10
lea addresses_normal_ht+0xdc55, %r8
clflush (%r8)
nop
nop
nop
...
nop
xor $50361, %rsi
lea addresses_UC_ht+0x1d4d5, %rsi
nop
nop
nop
nop
...
nop
add %rsi, %rsi
lea addresses_UC_ht+0xc615, %rcx
nop
nop
nop
nop
...
{'OP': 'STOR', 'dst': {'type': 'addresses_A', 'AVXalign': False, 'congruent': 3, 'size': 32, 'same': True, 'NT': False}}
