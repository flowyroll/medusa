...
push %rdx
push %rsi
lea addresses_WC_ht+0x47e4, %r13
nop
add %r8, %r8
movw $0x6162, (%r13)
dec %r13
lea addresses_WT_ht+0x102e0, %rdx
nop
nop
nop
nop
...
nop
xor %rsi, %rsi
lea addresses_D_ht+0x1a8e0, %rsi
lea addresses_WT_ht+0x1e760, %rdi
add $29031, %rax
mov $25, %rcx
rep movsb
nop
xor %rcx, %rcx
lea addresses_WT_ht+0x18e0, %rax
nop
xor %r9, %r9
mov (%rax), %rsi
nop
cmp $14210, %r8
lea addresses_A_ht+0x4130, %rsi
lea addresses_A_ht+0xb970, %rdi
nop
nop
nop
nop
...
nop
xor %r8, %r8
lea addresses_D_ht+0x1b9e2, %r13
nop
xor %rcx, %rcx
...
{'OP': 'REPM', 'src': {'same': True, 'type': 'addresses_D_ht', 'congruent': 8}, 'dst': {'same': False, 'type': 'addresses_WT_ht', 'congruent': 6}}
{'OP': 'LOAD', 'src': {'size': 8, 'NT': False, 'type': 'addresses_WT_ht', 'same': False, 'AVXalign': False, 'congruent': 7}}
{'OP': 'REPM', 'src': {'same': False, 'type': 'addresses_A_ht', 'congruent': 4}, 'dst': {'same': True, 'type': 'addresses_A_ht', 'congruent': 1}}
