...
nop
cmp %rdx, %rdx
lea addresses_A_ht+0x12188, %rbp
nop
nop
nop
and $24884, %rax
...
nop
sub %rax, %rax
lea addresses_WC_ht+0x2988, %rax
nop
nop
nop
nop
...
nop
inc %r11
lea addresses_WC_ht+0xdd88, %rdx
nop
nop
nop
nop
...
vmovups %ymm6, (%rbp)
inc %r8
lea addresses_UC_ht+0x17978, %r8
clflush (%r8)
nop
nop
lfence
...
nop
xor %rdx, %rdx
lea addresses_normal_ht+0x14c48, %rsi
lea addresses_A_ht+0x10248, %rdi
nop
nop
nop
nop
...
<gen_prepare_buffer>
{'src': {'type': 'addresses_D_ht', 'same': True, 'size': 4, 'congruent': 5, 'NT': False, 'AVXalign': True}, 'OP': 'LOAD'}
...
{'dst': {'type': 'addresses_A_ht', 'same': False, 'size': 8, 'congruent': 10, 'NT': False, 'AVXalign': True}, 'OP': 'STOR'}
{'src': {'type': 'addresses_normal_ht', 'congruent': 6, 'same': False}, 'dst': {'type': 'addresses_A_ht', 'congruent': 5, 'same': False}, 'OP': 'REPM'}
{'00': 21829}
