...
nop
cmp %rax, %rax
lea addresses_WC_ht+0xf5f8, %rsi
nop
cmp %r8, %r8
movb $0x61, (%rsi)
nop
...
nop
and %rax, %rax
lea addresses_D_ht+0x77f8, %rsi
lea addresses_WC_ht+0x95b2, %rdi
clflush (%rdi)
nop
nop
nop
...
nop
sub %r8, %r8
lea addresses_WC_ht+0xedf0, %rsi
lea addresses_UC_ht+0x173f8, %rdi
nop
nop
nop
nop
...
nop
and %r10, %r10
lea addresses_WC_ht+0x14dd8, %r15
add $6002, %r14
vmovups (%r15), %ymm0
vextracti128 $0, %ymm0, %xmm0
vpextrq $1, %xmm0, %r10
mfence
lea addresses_UC_ht+0x1d278, %rcx
nop
nop
sub $11107, %r8
movups (%rcx), %xmm3
...
nop
sub %rsi, %rsi
lea addresses_WC_ht+0x11978, %rcx
nop
nop
nop
nop
...
vpextrq $0, %xmm7, %rdi
cmp $13611, %rax
lea addresses_A_ht+0x19078, %r10
nop
nop
inc %r8
movw $0x6162, (%r10)
...
nop
cmp $8933, %rcx
lea addresses_normal_ht+0x21f8, %rsi
lea addresses_UC_ht+0xb1f8, %rdi
sub $18505, %r14
mov $37, %rcx
rep movsb
nop
...
nop
and %r8, %r8
lea addresses_WC_ht+0x2e18, %rsi
lea addresses_UC_ht+0x16f38, %rdi
nop
nop
nop
nop
...
nop
inc %r14
lea addresses_WT_ht+0x6118, %r15
nop
nop
nop
nop
...
nop
sub $53052, %r9
lea addresses_UC_ht+0xf3f8, %rsi
lea addresses_A_ht+0x7618, %rdi
nop
nop
nop
nop
...
// Store
lea addresses_A+0x5bf8, %rdi
xor $30275, %r11
movw $0x5152, (%rdi)
inc %r11

// Faulty Load
mov $0x4d85370000000ff8, %r11
nop
nop
nop
nop
...
<gen_prepare_buffer>
{'OP': 'LOAD', 'src': {'same': False, 'type': 'addresses_A_ht', 'NT': False, 'AVXalign': True, 'size': 4, 'congruent': 10}}
...
{'OP': 'REPM', 'src': {'same': False, 'congruent': 8, 'type': 'addresses_D_ht'}, 'dst': {'same': False, 'congruent': 1, 'type': 'addresses_WC_ht'}}
...
{'OP': 'REPM', 'src': {'same': False, 'congruent': 1, 'type': 'addresses_WC_ht'}, 'dst': {'same': False, 'congruent': 5, 'type': 'addresses_UC_ht'}}
{'OP': 'LOAD', 'src': {'same': False, 'type': 'addresses_WT_ht', 'NT': False, 'AVXalign': False, 'size': 4, 'congruent': 0}}
{'OP': 'REPM', 'src': {'same': False, 'congruent': 10, 'type': 'addresses_UC_ht'}, 'dst': {'same': False, 'congruent': 5, 'type': 'addresses_A_ht'}}
{'00': 21829}
