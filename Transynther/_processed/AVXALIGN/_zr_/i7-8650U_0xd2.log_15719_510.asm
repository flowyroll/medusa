...
push %rdi
push %rsi
lea addresses_WC_ht+0xda9d, %rsi
nop
sub %r9, %r9
...
vpextrq $0, %xmm2, %r10
add $972, %rbx
lea addresses_WC_ht+0x8f53, %r13
clflush (%r13)
nop
nop
nop
...
movl $0x61626364, (%r13)
and $42596, %rbx
lea addresses_D_ht+0x57ed, %rsi
lea addresses_A_ht+0x1d5ed, %rdi
nop
nop
nop
cmp %r13, %r13
...
nop
add $45615, %r13
lea addresses_normal_ht+0xd1ed, %r8
nop
nop
nop
mfence
...
{'OP': 'LOAD', 'src': {'type': 'addresses_WT', 'size': 2, 'AVXalign': False, 'NT': False, 'congruent': 1, 'same': False}}
{'OP': 'STOR', 'dst': {'type': 'addresses_PSE', 'size': 4, 'AVXalign': False, 'NT': True, 'congruent': 1, 'same': False}}
