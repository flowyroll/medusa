...
nop
xor $56366, %r11
lea addresses_WT_ht+0x1ae2, %rsi
...
nop
inc %r14
lea addresses_WT_ht+0xcbe, %rsi
lea addresses_UC_ht+0x1d17e, %rdi
nop
nop
nop
nop
...
nop
inc %r9
lea addresses_normal_ht+0x5f0c, %rsi
nop
nop
add $2233, %r10
...
movl $0x61626364, (%rdx)
dec %rdx
lea addresses_UC_ht+0xf41e, %rsi
nop
nop
nop
sub $10763, %r15
...
nop
sub %rdx, %rdx
lea addresses_WC_ht+0x5be2, %rsi
lea addresses_WC_ht+0x1b4e6, %rdi
dec %r9
mov $4, %rcx
rep movsq
nop
...
nop
sub $36118, %r10
lea addresses_D_ht+0x179fe, %r15
nop
nop
inc %r9
movw $0x6162, (%r15)
nop
sub $15061, %rsi
lea addresses_WC_ht+0x1fe2, %rcx
nop
nop
lfence
movl $0x61626364, (%rcx)
...
nop
inc %rdx
lea addresses_WT_ht+0xf7e2, %r10
nop
nop
nop
nop
...
{'OP': 'STOR', 'dst': {'NT': False, 'same': False, 'congruent': 2, 'type': 'addresses_D_ht', 'AVXalign': True, 'size': 2}}
{'OP': 'STOR', 'dst': {'NT': True, 'same': False, 'congruent': 9, 'type': 'addresses_WC_ht', 'AVXalign': False, 'size': 4}}
