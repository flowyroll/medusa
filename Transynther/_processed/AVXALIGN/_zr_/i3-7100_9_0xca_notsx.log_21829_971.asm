...
nop
sub $64898, %r11
lea addresses_WC_ht+0x15ac7, %r13
nop
nop
nop
nop
...
nop
and %rbp, %rbp
lea addresses_D_ht+0x1e9a7, %rsi
lea addresses_WT_ht+0xfc7, %rdi
nop
nop
nop
inc %rdx
...
nop
and %r13, %r13
lea addresses_WT_ht+0xb9c7, %rcx
nop
dec %r11
movups (%rcx), %xmm3
vpextrq $0, %xmm3, %rbp
...
nop
dec %rdx
lea addresses_UC_ht+0x112c7, %r11
add %r12, %r12
...
nop
add %rbp, %rbp
lea addresses_WC_ht+0x1bcdd, %rsi
...
rep movsq
add %rbp, %rbp
lea addresses_normal_ht+0x16125, %r13
inc %rcx
movw $0x6162, (%r13)
nop
xor %rdx, %rdx
...
nop
inc %r12
lea addresses_WC_ht+0xd73f, %rsi
lea addresses_A_ht+0xa447, %rdi
nop
nop
nop
nop
...
nop
sub %r12, %r12
lea addresses_WC_ht+0xeb87, %r11
nop
and $8568, %rdx
mov (%r11), %ecx
nop
...
nop
and %r12, %r12
lea addresses_A_ht+0x130f7, %rbp
xor $28902, %rsi
movw $0x6162, (%rbp)
nop
add %rsi, %rsi
...
// Faulty Load
lea addresses_normal+0x7ac7, %rbp
nop
and %rsi, %rsi
movntdqa (%rbp), %xmm7
vpextrq $0, %xmm7, %r10
...
{'OP': 'STOR', 'dst': {'same': False, 'congruent': 10, 'NT': True, 'type': 'addresses_WC_ht', 'size': 8, 'AVXalign': False}}
...
{'OP': 'STOR', 'dst': {'same': True, 'congruent': 2, 'NT': False, 'type': 'addresses_A_ht', 'size': 2, 'AVXalign': False}}
{'00': 21829}
