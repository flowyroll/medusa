...
push %rdi
push %rsi
lea addresses_A_ht+0xd886, %rsi
lea addresses_D_ht+0x1546e, %rdi
xor %rbx, %rbx
mov $113, %rcx
rep movsl
nop
xor $39403, %rax
lea addresses_A_ht+0x5a2e, %rbx
clflush (%rbx)
nop
nop
cmp $7242, %r13
...
movq %rcx, (%rbx)
mfence
lea addresses_WT_ht+0x8aee, %rsi
nop
xor %r10, %r10
movl $0x61626364, (%rsi)
nop
...
nop
xor $9402, %rbx
lea addresses_WT_ht+0x1a7ee, %rsi
lea addresses_WT_ht+0x13a14, %rdi
nop
nop
cmp $43696, %rax
mov $99, %rcx
