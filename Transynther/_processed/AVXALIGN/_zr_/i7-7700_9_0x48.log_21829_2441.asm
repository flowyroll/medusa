...
push %rdi
push %rsi
lea addresses_A_ht+0x17c7e, %rsi
lea addresses_UC_ht+0x148ce, %rdi
nop
nop
nop
mfence
...
nop
xor $42953, %r11
lea addresses_WT_ht+0xa4ce, %rdi
cmp %rcx, %rcx
movb $0x61, (%rdi)
nop
nop
and $36420, %rdi
lea addresses_A_ht+0x1446e, %rsi
and $24662, %r9
...
nop
and $20713, %r9
lea addresses_UC_ht+0x1d14e, %rcx
dec %rbp
vmovups (%rcx), %ymm5
...
nop
lfence
lea addresses_normal_ht+0x16196, %rbp
xor $29428, %rcx
mov (%rbp), %edi
nop
nop
...
nop
and %rsi, %rsi
lea addresses_WT_ht+0x128ce, %rsi
lea addresses_D_ht+0x132ce, %rdi
nop
nop
sub %r12, %r12
mov $87, %rcx
...
// Store
lea addresses_normal+0x1bc4e, %r14
nop
dec %r10
movb $0x51, (%r14)
nop
