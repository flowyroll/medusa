...
push %rdx
push %rsi
lea addresses_D_ht+0x1c2c2, %rsi
lea addresses_WT_ht+0x14b40, %rdi
nop
nop
add $223, %rax
mov $73, %rcx
...
nop
xor %r8, %r8
lea addresses_A_ht+0x107fe, %rsi
lea addresses_A_ht+0x1db6a, %rdi
nop
nop
xor $34172, %rdx
mov $104, %rcx
...
nop
and %rcx, %rcx
lea addresses_WT_ht+0x12d88, %rax
add $56402, %r8
...
nop
add $54848, %rcx
lea addresses_A_ht+0xffa, %rdi
nop
inc %rdx
mov $0x6162636465666768, %r8
movq %r8, (%rdi)
inc %r8
lea addresses_D_ht+0x242c, %r8
nop
sub %rax, %rax
...
nop
dec %rdx
lea addresses_WC_ht+0x17640, %rsi
...
nop
cmp %rdx, %rdx
lea addresses_UC_ht+0x1640, %rsi
lea addresses_normal_ht+0x9240, %rdi
and $10233, %r9
mov $81, %rcx
rep movsw
nop
...
nop
dec %rdi
lea addresses_A_ht+0x14dc0, %rsi
lea addresses_D_ht+0x12f04, %rdi
nop
cmp %r15, %r15
mov $29, %rcx
rep movsq
...
nop
and $62664, %r9
lea addresses_UC_ht+0x16e4a, %r9
clflush (%r9)
nop
nop
add %r8, %r8
...
nop
cmp %rdx, %rdx
lea addresses_normal_ht+0x11840, %rax
sub %rdi, %rdi
movw $0x6162, (%rax)
nop
nop
...
// Store
lea addresses_normal+0xae40, %rcx
nop
nop
and $57169, %rdx
...
{'OP': 'STOR', 'dst': {'type': 'addresses_D_ht', 'AVXalign': False, 'congruent': 0, 'size': 1, 'same': False, 'NT': True}}
...
{'OP': 'STOR', 'dst': {'type': 'addresses_normal_ht', 'AVXalign': False, 'congruent': 9, 'size': 2, 'same': False, 'NT': True}}
{'00': 21829}
