...
push %rdx
push %rsi
lea addresses_D_ht+0x6b7f, %rsi
lea addresses_A_ht+0x1bc17, %rdi
add %rdx, %rdx
mov $46, %rcx
rep movsq
dec %r14
lea addresses_UC_ht+0xa8a3, %rax
cmp $42746, %rdx
movw $0x6162, (%rax)
nop
nop
add %rax, %rax
lea addresses_UC_ht+0x1d597, %r14
nop
nop
nop
xor %r12, %r12
...
nop
cmp %rcx, %rcx
lea addresses_WT_ht+0x1597, %rsi
lea addresses_A_ht+0x18a83, %rdi
nop
nop
nop
and %rdx, %rdx
...
nop
and $42466, %rax
lea addresses_A_ht+0x7957, %rsi
lea addresses_WC_ht+0xc3d7, %rdi
nop
nop
nop
nop
...
rep movsq
cmp %rdx, %rdx
lea addresses_WT_ht+0x15597, %r12
clflush (%r12)
nop
nop
nop
...
nop
cmp %rdx, %rdx
lea addresses_normal_ht+0x15597, %rcx
sub %r14, %r14
mov (%rcx), %di
nop
nop
nop
xor %rax, %rax
lea addresses_UC_ht+0xf6f7, %rax
nop
nop
nop
nop
...
nop
cmp $33224, %r14
lea addresses_WT_ht+0xc9d7, %rsi
lea addresses_UC_ht+0x1e057, %rdi
clflush (%rsi)
nop
nop
nop
...
nop
and $36668, %r10
lea addresses_WT_ht+0xc597, %rdx
nop
nop
nop
inc %r14
...
nop
dec %rax
lea addresses_D_ht+0x1c997, %rsi
lea addresses_UC_ht+0xec3f, %rdi
nop
nop
sub $45412, %r10
mov $127, %rcx
...
nop
and %rdi, %rdi
lea addresses_WT_ht+0x13b9f, %rdx
nop
nop
and %r12, %r12
movw $0x6162, (%rdx)
...
<gen_prepare_buffer>
{'OP': 'REPM', 'src': {'type': 'addresses_D_ht', 'congruent': 2, 'same': False}, 'dst': {'type': 'addresses_A_ht', 'congruent': 5, 'same': False}}
...
{'OP': 'LOAD', 'src': {'type': 'addresses_normal_ht', 'AVXalign': True, 'congruent': 11, 'size': 2, 'same': False, 'NT': False}}
{'OP': 'LOAD', 'src': {'type': 'addresses_UC_ht', 'AVXalign': False, 'congruent': 5, 'size': 2, 'same': False, 'NT': False}}
{'OP': 'REPM', 'src': {'type': 'addresses_WT_ht', 'congruent': 6, 'same': False}, 'dst': {'type': 'addresses_UC_ht', 'congruent': 3, 'same': False}}
