...
push %rdx
push %rsi
lea addresses_A_ht+0x115f4, %rsi
lea addresses_normal_ht+0x1cfd6, %rdi
clflush (%rdi)
nop
nop
and $43587, %rax
...
nop
xor $22689, %r13
lea addresses_UC_ht+0x2f36, %rdx
and %rsi, %rsi
movb (%rdx), %al
xor %rax, %rax
lea addresses_UC_ht+0x12f70, %rsi
lea addresses_WC_ht+0x18e26, %rdi
nop
nop
nop
nop
...
nop
inc %rsi
lea addresses_WT_ht+0x8c86, %rdi
nop
add %r12, %r12
movl $0x61626364, (%rdi)
nop
...
nop
lfence
lea addresses_UC_ht+0x18936, %rsi
lea addresses_A_ht+0x2976, %rdi
clflush (%rdi)
nop
nop
nop
...
nop
xor %rdi, %rdi
lea addresses_UC_ht+0x111f6, %r12
nop
nop
nop
nop
...
movups %xmm0, (%r12)
sub %r12, %r12
lea addresses_WC_ht+0x10c36, %rcx
sub $64880, %r13
mov (%rcx), %rsi
nop
add $25752, %r13
lea addresses_WT_ht+0x1af36, %rsi
nop
nop
cmp $33016, %rcx
movw $0x6162, (%rsi)
...
nop
and %rdi, %rdi
lea addresses_A_ht+0x18eb6, %rsi
lea addresses_WT_ht+0x12536, %rdi
nop
xor %r11, %r11
mov $103, %rcx
rep movsq
...
nop
and $65019, %rax
lea addresses_normal_ht+0x17976, %rsi
lea addresses_WC_ht+0x3b36, %rdi
nop
nop
add %r13, %r13
mov $47, %rcx
...
movups %xmm5, (%r11)
xor %r11, %r11
lea addresses_WC_ht+0x8cf6, %rax
nop
nop
nop
nop
...
nop
cmp %rsi, %rsi
lea addresses_UC_ht+0xed36, %rsi
lea addresses_UC_ht+0x17336, %rdi
nop
nop
sub %rdx, %rdx
mov $93, %rcx
...
<gen_faulty_load>
[REF]
{'src': {'NT': True, 'same': False, 'congruent': 0, 'type': 'addresses_UC', 'AVXalign': True, 'size': 1}, 'OP': 'LOAD'}
[Faulty Load]
...
{'src': {'NT': False, 'same': True, 'congruent': 10, 'type': 'addresses_UC_ht', 'AVXalign': False, 'size': 1}, 'OP': 'LOAD'}
...
{'src': {'same': False, 'congruent': 6, 'type': 'addresses_A_ht'}, 'OP': 'REPM', 'dst': {'same': False, 'congruent': 7, 'type': 'addresses_WT_ht'}}
...
{'src': {'same': False, 'congruent': 2, 'type': 'addresses_D_ht'}, 'OP': 'REPM', 'dst': {'same': True, 'congruent': 4, 'type': 'addresses_D_ht'}}
