...
push %rdx
push %rsi
lea addresses_WT_ht+0x2a25, %rsi
lea addresses_normal_ht+0x149c5, %rdi
nop
nop
nop
nop
...
nop
dec %r9
lea addresses_UC_ht+0xb365, %rdx
nop
nop
nop
nop
...
nop
and $15853, %rsi
lea addresses_WC_ht+0xeea4, %rsi
lea addresses_WC_ht+0x1b225, %rdi
nop
nop
nop
add %r11, %r11
...
nop
xor $61694, %r9
lea addresses_WT_ht+0x4f45, %rdi
nop
nop
add $16853, %rcx
mov (%rdi), %r10d
nop
and %rdi, %rdi
lea addresses_A_ht+0x1bc99, %r10
nop
nop
nop
inc %rsi
...
nop
add $15230, %rdi
lea addresses_WT_ht+0x140e5, %r11
cmp %rcx, %rcx
movups (%r11), %xmm0
vpextrq $0, %xmm0, %rdi
nop
nop
inc %rcx
lea addresses_D_ht+0x17e25, %rsi
nop
and $11604, %r10
mov (%rsi), %r11w
nop
...
nop
sub $3826, %r10
lea addresses_WT_ht+0xca25, %rsi
lea addresses_D_ht+0xc325, %rdi
nop
nop
nop
nop
...
nop
and %rcx, %rcx
lea addresses_D_ht+0x29e5, %rsi
lea addresses_WC_ht+0x168d, %rdi
nop
nop
nop
nop
...
{'src': {'NT': False, 'same': True, 'congruent': 4, 'type': 'addresses_WT_ht', 'AVXalign': False, 'size': 4}, 'OP': 'LOAD'}
...
{'src': {'NT': False, 'same': True, 'congruent': 6, 'type': 'addresses_WT_ht', 'AVXalign': False, 'size': 16}, 'OP': 'LOAD'}
...
{'src': {'same': True, 'congruent': 6, 'type': 'addresses_D_ht'}, 'OP': 'REPM', 'dst': {'same': True, 'congruent': 2, 'type': 'addresses_WC_ht'}}
{'00': 21829}
