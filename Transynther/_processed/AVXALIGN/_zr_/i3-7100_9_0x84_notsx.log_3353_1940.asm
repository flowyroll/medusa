...
nop
add %r14, %r14
lea addresses_WC_ht+0x18ecd, %r13
dec %r14
mov (%r13), %cx
nop
nop
and $57720, %rdx
lea addresses_UC_ht+0x7cd5, %rdi
nop
nop
nop
and $10758, %r14
...
nop
cmp $17739, %r13
lea addresses_WT_ht+0x12cd, %rsi
lea addresses_A_ht+0x9a75, %rdi
nop
sub %r15, %r15
mov $47, %rcx
rep movsl
xor %rdi, %rdi
lea addresses_UC_ht+0xfb35, %rsi
lea addresses_D_ht+0x9e5a, %rdi
nop
sub $6376, %r15
mov $109, %rcx
rep movsl
...
nop
cmp %r13, %r13
lea addresses_normal_ht+0xfb75, %r13
nop
nop
nop
and %r15, %r15
mov (%r13), %rsi
dec %r14
lea addresses_normal_ht+0x7ff5, %r13
nop
nop
nop
nop
...
nop
sub $11951, %r13
lea addresses_UC_ht+0x251, %rsi
lea addresses_WC_ht+0x3f5, %rdi
clflush (%rsi)
nop
nop
nop
...
{'src': {'type': 'addresses_UC_ht', 'same': False, 'size': 32, 'congruent': 5, 'NT': True, 'AVXalign': False}, 'OP': 'LOAD'}
...
{'src': {'type': 'addresses_UC_ht', 'congruent': 2, 'same': False}, 'dst': {'type': 'addresses_WC_ht', 'congruent': 7, 'same': True}, 'OP': 'REPM'}
{'00': 3353}
