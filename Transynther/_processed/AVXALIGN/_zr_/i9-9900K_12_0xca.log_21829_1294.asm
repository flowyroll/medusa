...
push %rdx
push %rsi
lea addresses_UC_ht+0x1196f, %rsi
nop
nop
nop
add $51607, %rdx
...
nop
and %r10, %r10
lea addresses_WC_ht+0x144bf, %rax
and $2998, %r12
mov (%rax), %edx
sub %r13, %r13
lea addresses_UC_ht+0x980f, %r13
nop
nop
nop
nop
...
nop
sub $39115, %rdi
lea addresses_D_ht+0xe772, %r10
nop
and $42593, %r12
movups (%r10), %xmm7
vpextrq $1, %xmm7, %rdx
xor %rdx, %rdx
lea addresses_A_ht+0xa82d, %rsi
lea addresses_UC_ht+0x103df, %rdi
clflush (%rdi)
nop
nop
nop
...
nop
sub $58920, %r10
lea addresses_WC_ht+0x107df, %r12
nop
nop
nop
nop
...
nop
sub $3842, %r13
lea addresses_normal_ht+0x1831f, %r12
nop
nop
add %rcx, %rcx
mov $0x6162636465666768, %r13
...
nop
and $57121, %rsi
lea addresses_WC_ht+0x11df, %rdx
nop
nop
nop
nop
...
<gen_faulty_load>
[REF]
{'OP': 'LOAD', 'src': {'size': 16, 'NT': True, 'type': 'addresses_UC', 'same': False, 'AVXalign': False, 'congruent': 0}}
...
{'OP': 'REPM', 'src': {'same': False, 'type': 'addresses_WC_ht', 'congruent': 1}, 'dst': {'same': False, 'type': 'addresses_A_ht', 'congruent': 7}}
{'OP': 'LOAD', 'src': {'size': 16, 'NT': False, 'type': 'addresses_D_ht', 'same': False, 'AVXalign': False, 'congruent': 0}}
{'OP': 'REPM', 'src': {'same': False, 'type': 'addresses_A_ht', 'congruent': 1}, 'dst': {'same': False, 'type': 'addresses_UC_ht', 'congruent': 9}}
