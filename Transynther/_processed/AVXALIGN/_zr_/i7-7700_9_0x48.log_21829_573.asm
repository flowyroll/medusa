...
push %rdx
push %rsi
lea addresses_WT_ht+0x17247, %r11
nop
nop
nop
nop
...
nop
xor $47541, %r11
lea addresses_UC_ht+0x1d6e9, %rsi
...
nop
xor $44442, %rcx
lea addresses_WC_ht+0x19de9, %r9
sub $18981, %r8
movl $0x61626364, (%r9)
nop
nop
sub $22444, %rsi
lea addresses_A_ht+0xbee9, %rsi
lea addresses_WT_ht+0x1e0e9, %rdi
dec %r13
mov $45, %rcx
rep movsb
nop
nop
cmp $60912, %r9
lea addresses_normal_ht+0x191e9, %rcx
nop
nop
nop
nop
...
{'OP': 'STOR', 'dst': {'type': 'addresses_WC', 'AVXalign': False, 'congruent': 1, 'size': 2, 'same': False, 'NT': True}}
...
{'OP': 'REPM', 'src': {'type': 'addresses_UC_ht', 'congruent': 5, 'same': False}, 'dst': {'type': 'addresses_WC_ht', 'congruent': 5, 'same': True}}
