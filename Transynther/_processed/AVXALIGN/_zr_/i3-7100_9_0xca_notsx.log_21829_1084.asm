...
push %rdi
push %rsi
lea addresses_WC_ht+0x198fc, %r10
nop
nop
nop
dec %r12
...
nop
lfence
lea addresses_WC_ht+0x11e9c, %rdi
nop
nop
nop
nop
...
nop
xor %r13, %r13
lea addresses_UC_ht+0x1ca5d, %rbx
nop
nop
nop
cmp $30962, %r10
...
nop
cmp %r10, %r10
lea addresses_WC_ht+0xd068, %rbx
clflush (%rbx)
sub %rsi, %rsi
...
lea addresses_normal_ht+0xca2c, %rdi
inc %r9
mov $101, %rcx
rep movsb
and %rsi, %rsi
lea addresses_UC_ht+0x419c, %rdi
nop
nop
nop
sub $47629, %rsi
movl $0x61626364, (%rdi)
add $16461, %rcx
lea addresses_WT_ht+0xf79c, %rsi
lea addresses_WC_ht+0x16a1c, %rdi
clflush (%rdi)
nop
nop
cmp %r9, %r9
...
rep movsl
xor %rbx, %rbx
lea addresses_UC_ht+0x19d9c, %r13
nop
xor %rdi, %rdi
mov (%r13), %r10
nop
nop
cmp $64875, %rcx
lea addresses_WT_ht+0x513, %rsi
lea addresses_normal_ht+0x519c, %rdi
nop
and $23437, %r13
mov $59, %rcx
rep movsl
...
<gen_prepare_buffer>
{'src': {'same': False, 'congruent': 5, 'NT': True, 'type': 'addresses_WC_ht', 'size': 2, 'AVXalign': False}, 'OP': 'LOAD'}
...
{'src': {'type': 'addresses_normal_ht', 'congruent': 4, 'same': False}, 'OP': 'REPM', 'dst': {'type': 'addresses_normal_ht', 'congruent': 3, 'same': False}}
