...
push %rdx
push %rsi
lea addresses_UC_ht+0x18e53, %rsi
lea addresses_normal_ht+0x1dcf8, %rdi
nop
nop
nop
nop
...
nop
sub $49708, %rdx
lea addresses_D_ht+0x181c3, %rcx
sub %r12, %r12
mov (%rcx), %si
nop
add %rdx, %rdx
lea addresses_WT_ht+0x1e623, %rcx
nop
nop
nop
dec %r9
...
nop
and %rcx, %rcx
lea addresses_WT_ht+0x105c3, %r9
nop
nop
nop
nop
...
nop
inc %r13
lea addresses_D_ht+0x7e83, %rsi
lea addresses_UC_ht+0x19683, %rdi
nop
nop
nop
nop
...
{'src': {'type': 'addresses_WT_ht', 'AVXalign': False, 'size': 1, 'NT': True, 'same': False, 'congruent': 6}, 'OP': 'LOAD'}
