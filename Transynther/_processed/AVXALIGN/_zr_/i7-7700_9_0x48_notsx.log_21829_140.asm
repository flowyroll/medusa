...
push %rdx
push %rsi
lea addresses_WT_ht+0x18ed8, %r15
dec %rsi
...
nop
sub %rax, %rax
lea addresses_WC_ht+0xfd46, %r13
nop
nop
nop
inc %rdx
...
nop
sub $25894, %rdx
lea addresses_D_ht+0x10718, %r15
nop
nop
cmp %rbx, %rbx
mov (%r15), %rsi
add %rax, %rax
lea addresses_WC_ht+0x3f58, %rax
nop
nop
xor %rbx, %rbx
vmovups (%rax), %ymm3
...
nop
xor $48502, %rax
lea addresses_A_ht+0x12b18, %rsi
lea addresses_WT_ht+0x1318, %rdi
nop
nop
nop
nop
...
rep movsq
sub %rdi, %rdi
lea addresses_WT_ht+0x14798, %rsi
