...
push %rdi
push %rsi
lea addresses_UC_ht+0x1bc66, %rsi
dec %r8
movb (%rsi), %al
nop
nop
...
nop
and %rsi, %rsi
lea addresses_A_ht+0x1ac36, %rsi
lea addresses_D_ht+0x98f6, %rdi
clflush (%rdi)
nop
sub %r11, %r11
mov $25, %rcx
...
nop
add $38860, %rdi
lea addresses_normal_ht+0x9336, %r11
add $54951, %rax
movb $0x61, (%r11)
nop
nop
...
nop
inc %rcx
lea addresses_normal_ht+0x4fb6, %rsi
lea addresses_normal_ht+0x12cda, %rdi
nop
nop
nop
add $26043, %r8
...
nop
cmp %r13, %r13
lea addresses_WT_ht+0x15976, %rsi
nop
add $49886, %rax
movb (%rsi), %r8b
nop
...
{'OP': 'REPM', 'src': {'same': False, 'congruent': 8, 'type': 'addresses_A_ht'}, 'dst': {'same': False, 'congruent': 5, 'type': 'addresses_D_ht'}}
