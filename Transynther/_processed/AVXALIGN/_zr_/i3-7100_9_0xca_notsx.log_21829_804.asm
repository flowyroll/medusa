...
nop
xor $52516, %rbp
lea addresses_normal_ht+0x1d999, %r15
nop
add $8703, %rsi
mov (%r15), %r13d
nop
and $16917, %rax
lea addresses_normal_ht+0xbc29, %r10
nop
nop
nop
nop
...
nop
sub $52464, %rbp
lea addresses_WC_ht+0xba29, %r11
inc %rbp
movl $0x61626364, (%r11)
nop
nop
...
nop
cmp $53476, %rbp
lea addresses_UC_ht+0x6b09, %rsi
lea addresses_A_ht+0x5721, %rdi
clflush (%rsi)
nop
nop
nop
...
nop
sub $46673, %r13
lea addresses_D_ht+0x3bb3, %rsi
lea addresses_A_ht+0x698d, %rdi
nop
nop
nop
nop
...
nop
sub $30535, %rcx
lea addresses_A_ht+0x113e9, %rbp
nop
nop
nop
nop
...
nop
and $39225, %r11
lea addresses_UC_ht+0xa279, %rax
nop
add %rbp, %rbp
movb $0x61, (%rax)
nop
nop
sub %r10, %r10
lea addresses_normal_ht+0xc919, %rsi
lea addresses_WC_ht+0x19e89, %rdi
nop
nop
dec %r10
mov $42, %rcx
...
nop
xor %r15, %r15
lea addresses_WC_ht+0x1d979, %rdi
nop
nop
nop
nop
...
nop
sub %rbp, %rbp
lea addresses_D_ht+0x13229, %r13
nop
nop
nop
xor $2920, %rcx
...
nop
xor %rdi, %rdi
lea addresses_D_ht+0xae29, %rsi
lea addresses_WC_ht+0x93f9, %rdi
cmp $1513, %r10
mov $73, %rcx
rep movsl
nop
...
nop
and $12633, %rdi
lea addresses_UC_ht+0x12fe9, %r15
nop
nop
nop
nop
...
{'src': {'same': False, 'congruent': 4, 'NT': False, 'type': 'addresses_normal_ht', 'size': 4, 'AVXalign': True}, 'OP': 'LOAD'}
{'OP': 'STOR', 'dst': {'same': False, 'congruent': 8, 'NT': False, 'type': 'addresses_normal_ht', 'size': 1, 'AVXalign': True}}
{'OP': 'STOR', 'dst': {'same': False, 'congruent': 10, 'NT': True, 'type': 'addresses_WC_ht', 'size': 4, 'AVXalign': False}}
...
{'OP': 'STOR', 'dst': {'same': False, 'congruent': 4, 'NT': False, 'type': 'addresses_WC_ht', 'size': 8, 'AVXalign': True}}
{'src': {'same': False, 'congruent': 10, 'NT': False, 'type': 'addresses_D_ht', 'size': 16, 'AVXalign': False}, 'OP': 'LOAD'}
{'src': {'type': 'addresses_D_ht', 'congruent': 11, 'same': False}, 'OP': 'REPM', 'dst': {'type': 'addresses_WC_ht', 'congruent': 4, 'same': True}}
