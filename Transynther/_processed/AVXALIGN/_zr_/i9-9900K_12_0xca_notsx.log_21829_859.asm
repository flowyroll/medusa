...
nop
and %r8, %r8
lea addresses_UC_ht+0x12b2a, %rbp
nop
nop
nop
add $30141, %rdx
...
nop
and $47870, %rsi
lea addresses_UC_ht+0x15dca, %rsi
nop
nop
nop
nop
...
nop
sub %r8, %r8
lea addresses_normal_ht+0x16e3a, %r8
nop
nop
nop
sub $26777, %rdi
...
nop
sub $24149, %rbx
lea addresses_UC_ht+0x1e5ca, %rbp
nop
inc %rdi
mov (%rbp), %r8d
nop
...
nop
cmp %r8, %r8
lea addresses_normal_ht+0x750a, %rdi
nop
nop
and $8235, %rcx
movb $0x61, (%rdi)
...
{'OP': 'STOR', 'dst': {'same': False, 'type': 'addresses_UC_ht', 'NT': True, 'AVXalign': False, 'size': 1, 'congruent': 4}}
