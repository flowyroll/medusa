...
push %rdi
push %rsi
lea addresses_WT_ht+0xacf6, %rbp
nop
nop
nop
nop
...
nop
and %rdi, %rdi
lea addresses_WC_ht+0xc026, %r14
nop
nop
cmp %r13, %r13
movb (%r14), %r11b
cmp $55974, %r14
lea addresses_A_ht+0x8cdd, %rsi
lea addresses_D_ht+0x4c26, %rdi
nop
nop
nop
sub %r13, %r13
...
nop
add $17240, %r13
lea addresses_normal_ht+0x95c6, %rsi
nop
nop
nop
nop
...
nop
cmp %r10, %r10
lea addresses_normal_ht+0x12436, %rsi
nop
nop
nop
cmp $9611, %r11
...
nop
add %r11, %r11
lea addresses_WC_ht+0x2426, %rsi
...
nop
sub $14849, %r13
lea addresses_WT_ht+0x5a26, %rcx
nop
nop
nop
xor %rbp, %rbp
...
nop
sub $22699, %rbp
lea addresses_A_ht+0x744e, %rsi
lea addresses_normal_ht+0x124de, %rdi
nop
nop
nop
nop
...
nop
and $16901, %r11
lea addresses_WC_ht+0x8026, %rsi
lea addresses_A_ht+0x486, %rdi
add $41660, %r14
mov $4, %rcx
rep movsb
inc %r11
lea addresses_UC_ht+0x17462, %rsi
nop
nop
xor $32993, %r11
mov (%rsi), %ebp
nop
sub $51231, %r14
lea addresses_WT_ht+0x1ea26, %rsi
lea addresses_WC_ht+0x19846, %rdi
xor $27406, %r10
mov $53, %rcx
rep movsq
sub %r14, %r14
lea addresses_normal_ht+0x1a326, %rsi
lea addresses_normal_ht+0x1e026, %rdi
nop
add %r14, %r14
mov $16, %rcx
rep movsq
...
nop
inc %r11
lea addresses_UC_ht+0xe5af, %rsi
nop
sub $117, %rcx
mov (%rsi), %r14
nop
...
{'OP': 'STOR', 'dst': {'type': 'addresses_normal_ht', 'AVXalign': False, 'congruent': 4, 'size': 8, 'same': False, 'NT': True}}
...
{'OP': 'REPM', 'src': {'type': 'addresses_WC_ht', 'congruent': 11, 'same': True}, 'dst': {'type': 'addresses_A_ht', 'congruent': 4, 'same': False}}
