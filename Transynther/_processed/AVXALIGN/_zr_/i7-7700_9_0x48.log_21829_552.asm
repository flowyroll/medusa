...
push %rdx
push %rsi
lea addresses_normal_ht+0x17841, %rsi
lea addresses_WT_ht+0xe3c1, %rdi
nop
nop
nop
nop
...
nop
sub $7789, %rbx
lea addresses_normal_ht+0x1781, %r12
clflush (%r12)
nop
nop
nop
...
nop
sub $3187, %rdx
lea addresses_WT_ht+0xe4a1, %rbx
nop
nop
nop
nop
...
nop
cmp $12801, %rdi
lea addresses_D_ht+0x11581, %rcx
nop
nop
and %rdi, %rdi
vmovups (%rcx), %ymm3
...
nop
sub $7885, %r15
lea addresses_WC_ht+0x107e9, %rbx
nop
nop
nop
nop
...
nop
xor %r15, %r15
lea addresses_WT_ht+0x13681, %r12
add %rdx, %rdx
movl $0x61626364, (%r12)
nop
nop
...
nop
cmp $4770, %rdi
lea addresses_WT_ht+0x10481, %rsi
lea addresses_UC_ht+0x11381, %rdi
nop
and %r10, %r10
mov $35, %rcx
rep movsl
...
nop
xor $11610, %r12
lea addresses_D_ht+0xd901, %rsi
lea addresses_WC_ht+0x17f31, %rdi
xor $58016, %r15
mov $111, %rcx
rep movsw
nop
...
{'OP': 'STOR', 'dst': {'type': 'addresses_normal_ht', 'AVXalign': False, 'congruent': 9, 'size': 32, 'same': True, 'NT': False}}
...
{'OP': 'LOAD', 'src': {'type': 'addresses_D_ht', 'AVXalign': True, 'congruent': 0, 'size': 1, 'same': False, 'NT': False}}
