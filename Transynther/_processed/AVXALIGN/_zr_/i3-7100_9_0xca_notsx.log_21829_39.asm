...
nop
xor $48093, %r14
lea addresses_normal_ht+0xd848, %rbp
and $31594, %r13
mov $0x6162636465666768, %rdi
movq %rdi, %xmm4
vmovups %ymm4, (%rbp)
xor $9112, %rbx
lea addresses_WC_ht+0xfb18, %r14
nop
nop
nop
nop
...
nop
xor $4309, %rbx
lea addresses_WC_ht+0x10d54, %r14
cmp $5801, %rdi
mov (%r14), %rsi
nop
xor %r14, %r14
lea addresses_UC_ht+0x13818, %rsi
and %rbx, %rbx
...
nop
sub $9548, %rdi
lea addresses_A_ht+0x1d3c8, %r15
nop
nop
xor %r14, %r14
movw $0x6162, (%r15)
