...
nop
add $48627, %r8
lea addresses_WT_ht+0x11253, %r11
nop
nop
nop
inc %rcx
...
nop
cmp %r8, %r8
lea addresses_D_ht+0x1d763, %r15
clflush (%r15)
nop
nop
add $64631, %rcx
