...
lea addresses_UC_ht+0xa861, %rdi
nop
nop
nop
nop
...
nop
cmp %rdx, %rdx
lea addresses_WT_ht+0x5ddd, %rsi
lea addresses_A_ht+0x14e61, %rdi
nop
nop
nop
sub %r8, %r8
...
rep movsb
xor %rcx, %rcx
lea addresses_WT_ht+0x9b61, %rsi
nop
nop
nop
nop
