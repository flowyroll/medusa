...
lea addresses_WT_ht+0xb1e3, %rdi
nop
nop
nop
nop
...
nop
dec %r11
lea addresses_WC_ht+0xbfbb, %rsi
cmp $42951, %r13
mov (%rsi), %ebx
nop
nop
nop
add $53770, %rbx
lea addresses_normal_ht+0x10101, %rsi
lea addresses_D_ht+0x2911, %rdi
nop
nop
xor %r9, %r9
mov $24, %rcx
...
nop
and $2009, %r9
lea addresses_UC_ht+0xee1a, %r11
nop
nop
nop
nop
...
{'OP': 'STOR', 'dst': {'same': False, 'congruent': 9, 'NT': True, 'type': 'addresses_WT', 'size': 2, 'AVXalign': False}}
{'OP': 'STOR', 'dst': {'same': False, 'congruent': 0, 'NT': False, 'type': 'addresses_P', 'size': 4, 'AVXalign': False}}
{'OP': 'STOR', 'dst': {'same': False, 'congruent': 7, 'NT': False, 'type': 'addresses_NC', 'size': 16, 'AVXalign': False}}
[Faulty Load]
...
{'src': {'same': False, 'congruent': 3, 'NT': False, 'type': 'addresses_WT_ht', 'size': 4, 'AVXalign': True}, 'OP': 'LOAD'}
{'src': {'type': 'addresses_normal_ht', 'congruent': 1, 'same': False}, 'OP': 'REPM', 'dst': {'type': 'addresses_WT_ht', 'congruent': 0, 'same': True}}
{'src': {'same': False, 'congruent': 0, 'NT': False, 'type': 'addresses_WC_ht', 'size': 4, 'AVXalign': False}, 'OP': 'LOAD'}
{'src': {'type': 'addresses_normal_ht', 'congruent': 1, 'same': False}, 'OP': 'REPM', 'dst': {'type': 'addresses_D_ht', 'congruent': 9, 'same': False}}
