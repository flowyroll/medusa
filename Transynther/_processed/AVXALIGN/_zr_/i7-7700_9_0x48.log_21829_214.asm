...
push %rdx
push %rsi
lea addresses_D_ht+0x1b589, %rsi
lea addresses_UC_ht+0x16509, %rdi
nop
xor $51252, %rdx
mov $63, %rcx
rep movsq
...
nop
and %r9, %r9
lea addresses_UC_ht+0x132b5, %rsi
lea addresses_WC_ht+0xab09, %rdi
clflush (%rsi)
nop
nop
nop
...
nop
and %rdx, %rdx
lea addresses_D_ht+0x31e2, %rsi
lea addresses_WC_ht+0x11889, %rdi
nop
nop
and $48816, %rbp
mov $19, %rcx
...
nop
and $29826, %rdi
lea addresses_WT_ht+0x19a9, %rcx
nop
nop
nop
cmp $8628, %rsi
movl $0x61626364, (%rcx)
add $47238, %rcx
lea addresses_A_ht+0x13f82, %rsi
lea addresses_D_ht+0x15d89, %rdi
clflush (%rdi)
nop
nop
nop
...
nop
add %r9, %r9
lea addresses_WC_ht+0x13989, %rax
nop
cmp $53040, %rdi
movb $0x61, (%rax)
nop
nop
sub $10562, %rbp
lea addresses_WC_ht+0x23f1, %rax
nop
nop
nop
cmp %rdi, %rdi
...
nop
cmp %r9, %r9
lea addresses_WC_ht+0x1c529, %rax
nop
nop
nop
nop
...
nop
add $21112, %rax
lea addresses_UC_ht+0xad89, %rsi
lea addresses_UC_ht+0x15d89, %rdi
nop
nop
nop
and $55408, %rax
...
nop
cmp %rax, %rax
lea addresses_A_ht+0x11489, %rbp
nop
nop
nop
nop
...
nop
and $43975, %r9
lea addresses_A_ht+0x2cc1, %rsi
lea addresses_D_ht+0x94da, %rdi
nop
nop
nop
xor %rdx, %rdx
...
{'OP': 'REPM', 'src': {'type': 'addresses_A_ht', 'congruent': 0, 'same': False}, 'dst': {'type': 'addresses_D_ht', 'congruent': 0, 'same': False}}
{'00': 21829}
