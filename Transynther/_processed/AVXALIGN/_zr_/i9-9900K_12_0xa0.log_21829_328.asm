...
push %rdx
push %rsi
lea addresses_A_ht+0x16ff1, %rsi
lea addresses_UC_ht+0x4081, %rdi
nop
nop
nop
and $27303, %r15
...
nop
sub $16750, %rbp
lea addresses_WC_ht+0x12831, %r12
nop
nop
nop
add %rdx, %rdx
...
nop
inc %r12
lea addresses_normal_ht+0xd4d1, %rsi
lea addresses_D_ht+0x5031, %rdi
nop
nop
nop
cmp %rax, %rax
...
nop
add $16642, %rdx
lea addresses_D_ht+0x11031, %r15
nop
nop
and %rdi, %rdi
movb $0x61, (%r15)
nop
dec %rdi
lea addresses_normal_ht+0x15371, %rsi
lea addresses_WT_ht+0x3e31, %rdi
nop
nop
nop
cmp %rax, %rax
...
nop
xor $17453, %r15
lea addresses_WT_ht+0x5147, %rdx
nop
cmp %rbp, %rbp
mov (%rdx), %cx
nop
...
nop
sub %rbp, %rbp
lea addresses_UC_ht+0x82d1, %rax
inc %rdx
movw $0x6162, (%rax)
nop
nop
...
nop
add %rdx, %rdx
lea addresses_WC_ht+0x6631, %rcx
nop
nop
nop
nop
...
nop
cmp %r12, %r12
lea addresses_UC_ht+0x13b51, %rcx
nop
nop
nop
nop
...
<gen_prepare_buffer>
{'src': {'same': True, 'congruent': 6, 'type': 'addresses_A_ht'}, 'OP': 'REPM', 'dst': {'same': False, 'congruent': 1, 'type': 'addresses_UC_ht'}}
