...
nop
and $21792, %r8
lea addresses_UC_ht+0x150be, %rsi
lea addresses_WC_ht+0x13cd7, %rdi
nop
nop
and $29843, %r11
mov $64, %rcx
...
[Faulty Load]
{'OP': 'LOAD', 'src': {'size': 32, 'NT': True, 'type': 'addresses_WT', 'same': True, 'AVXalign': True, 'congruent': 0}}
<gen_prepare_buffer>
