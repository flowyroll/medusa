...
push %rdx
push %rsi
lea addresses_UC_ht+0x1519b, %rsi
lea addresses_UC_ht+0xa0d, %rdi
nop
and %r12, %r12
mov $50, %rcx
rep movsq
...
nop
xor $57799, %r13
lea addresses_WC_ht+0x1a25b, %r13
add %r12, %r12
mov (%r13), %edi
nop
nop
nop
cmp %rsi, %rsi
lea addresses_UC_ht+0xf85b, %rdi
nop
sub %rdx, %rdx
...
nop
dec %rsi
lea addresses_WT_ht+0xe83b, %rdi
dec %rsi
movb (%rdi), %cl
nop
inc %rcx
lea addresses_D_ht+0x13c87, %rcx
nop
nop
nop
nop
...
nop
and $50362, %r14
lea addresses_D_ht+0x5a5b, %rsi
lea addresses_D_ht+0xfd5b, %rdi
nop
nop
nop
nop
...
rep movsq
add %r13, %r13
lea addresses_WT_ht+0x9eeb, %rsi
nop
and %rdx, %rdx
movups (%rsi), %xmm5
vpextrq $0, %xmm5, %r13
