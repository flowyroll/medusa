...
push %rdi
push %rsi
lea addresses_A_ht+0x192bc, %rsi
lea addresses_normal_ht+0xcfc, %rdi
nop
nop
nop
nop
...
nop
and %r13, %r13
lea addresses_WC_ht+0x1780c, %rsi
...
nop
sub %r13, %r13
lea addresses_normal_ht+0xb058, %r10
nop
nop
nop
cmp %rbx, %rbx
...
movq %rdi, (%r10)
sub $59709, %rsi
lea addresses_WC_ht+0xc0c, %rsi
lea addresses_D_ht+0x1cb1c, %rdi
nop
nop
nop
nop
...
rep movsw
and $63826, %rcx
lea addresses_normal_ht+0x940c, %r10
nop
dec %rsi
vmovups (%r10), %ymm6
...
nop
and $22543, %r13
lea addresses_D_ht+0x1fc, %rsi
lea addresses_WC_ht+0x5f4c, %rdi
nop
nop
nop
nop
...
nop
cmp $36502, %rsi
lea addresses_A_ht+0x1150c, %r15
nop
nop
nop
nop
...
nop
and %rcx, %rcx
lea addresses_A_ht+0x19c0c, %rsi
lea addresses_WC_ht+0x440c, %rdi
add %r13, %r13
mov $73, %rcx
rep movsb
nop
...
nop
cmp $60059, %rbx
lea addresses_WT_ht+0x1523c, %rdi
nop
nop
nop
sub %rax, %rax
...
// REPMOV
mov $0x6f7038000000054c, %rsi
lea addresses_WT+0xb30c, %rdi
nop
nop
cmp $60322, %rax
mov $25, %rcx
...
{'OP': 'REPM', 'src': {'type': 'addresses_NC', 'congruent': 6, 'same': False}, 'dst': {'type': 'addresses_WT', 'congruent': 8, 'same': False}}
[Faulty Load]
...
{'OP': 'STOR', 'dst': {'type': 'addresses_normal_ht', 'AVXalign': False, 'congruent': 2, 'size': 8, 'same': False, 'NT': True}}
