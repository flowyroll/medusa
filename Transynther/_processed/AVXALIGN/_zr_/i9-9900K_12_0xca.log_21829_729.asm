...
nop
and $19378, %r12
lea addresses_WC_ht+0x13634, %rsi
lea addresses_normal_ht+0x19cf4, %rdi
nop
add $11758, %r12
mov $108, %rcx
rep movsw
inc %rax
lea addresses_WC_ht+0x12cf4, %rsi
lea addresses_UC_ht+0x11af4, %rdi
cmp $10644, %r12
mov $111, %rcx
rep movsw
nop
...
nop
and $20615, %r14
lea addresses_WT_ht+0xf964, %rcx
nop
nop
nop
dec %r14
...
nop
add %rdx, %rdx
lea addresses_WT_ht+0x100f4, %rdx
nop
nop
add $3023, %rdi
movups (%rdx), %xmm5
...
nop
inc %r12
lea addresses_WC_ht+0x7df4, %rsi
lea addresses_WT_ht+0x1e4c, %rdi
nop
nop
nop
nop
...
nop
and $18129, %r11
lea addresses_UC_ht+0x9ef4, %rax
nop
nop
nop
cmp $26618, %r14
mov (%rax), %r11
add %r12, %r12
lea addresses_WC_ht+0xf4, %rsi
lea addresses_WC_ht+0x1e46c, %rdi
add %r11, %r11
mov $90, %rcx
rep movsw
nop
...
nop
xor $37144, %rdi
lea addresses_WT_ht+0x1c094, %r11
nop
nop
nop
add $34106, %rax
...
nop
and %r14, %r14
lea addresses_WT_ht+0x14cf4, %rax
nop
nop
cmp $5584, %rdx
mov (%rax), %rcx
...
nop
sub $50995, %r11
lea addresses_UC_ht+0x111f4, %rsi
lea addresses_normal_ht+0x16cb4, %rdi
clflush (%rdi)
nop
nop
nop
...
{'OP': 'REPM', 'src': {'same': False, 'type': 'addresses_WC_ht', 'congruent': 5}, 'dst': {'same': False, 'type': 'addresses_normal_ht', 'congruent': 11}}
...
{'OP': 'LOAD', 'src': {'size': 4, 'NT': False, 'type': 'addresses_WT_ht', 'same': True, 'AVXalign': False, 'congruent': 3}}
