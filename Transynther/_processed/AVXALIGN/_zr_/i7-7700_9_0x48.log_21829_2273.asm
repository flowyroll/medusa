...
push %rdi
push %rsi
lea addresses_D_ht+0x14719, %rsi
lea addresses_normal_ht+0xff19, %rdi
nop
nop
nop
nop
...
vpextrq $0, %xmm6, %rcx
xor $60485, %rdi
lea addresses_WT_ht+0x3819, %r15
nop
dec %rbx
mov (%r15), %r9
nop
cmp $11783, %r15
lea addresses_D_ht+0xb719, %rsi
lea addresses_WT_ht+0xa9f9, %rdi
inc %r12
mov $40, %rcx
rep movsw
nop
...
nop
and %rbx, %rbx
lea addresses_UC_ht+0x142b1, %rbx
sub $19109, %rsi
mov (%rbx), %r12d
nop
nop
sub %r15, %r15
lea addresses_D_ht+0x3f19, %r15
cmp %r12, %r12
mov (%r15), %rdi
xor %rsi, %rsi
lea addresses_UC_ht+0xa779, %r9
nop
nop
nop
nop
...
{'OP': 'REPM', 'src': {'type': 'addresses_D_ht', 'congruent': 10, 'same': False}, 'dst': {'type': 'addresses_WT_ht', 'congruent': 4, 'same': False}}
