...
push %rdx
push %rsi
lea addresses_UC_ht+0x1b831, %rsi
...
nop
dec %r12
lea addresses_WT_ht+0xe634, %rdx
nop
nop
nop
and %r9, %r9
...
nop
add %rdx, %rdx
lea addresses_WC_ht+0x1e954, %rsi
lea addresses_normal_ht+0xe6fa, %rdi
nop
nop
nop
xor $1655, %r10
...
nop
dec %r12
lea addresses_WT_ht+0x6e23, %r13
nop
nop
nop
nop
...
nop
add %r9, %r9
lea addresses_UC_ht+0x17114, %rdi
clflush (%rdi)
cmp %r12, %r12
mov (%rdi), %r10d
nop
...
nop
xor %rsi, %rsi
lea addresses_normal_ht+0x1d194, %rdi
nop
nop
nop
nop
...
<gen_prepare_buffer>
{'src': {'congruent': 0, 'same': False, 'type': 'addresses_UC_ht'}, 'OP': 'REPM', 'dst': {'congruent': 9, 'same': False, 'type': 'addresses_normal_ht'}}
