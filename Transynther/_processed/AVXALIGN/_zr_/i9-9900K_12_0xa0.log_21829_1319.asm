...
nop
inc %r15
lea addresses_UC_ht+0x1d390, %r15
nop
nop
nop
nop
...
nop
cmp $32273, %r8
lea addresses_UC_ht+0x6738, %rsi
lea addresses_A_ht+0xa67e, %rdi
clflush (%rdi)
nop
nop
nop
...
nop
sub $29171, %rcx
lea addresses_A_ht+0x3d90, %rsi
lea addresses_WC_ht+0xcc50, %rdi
inc %rdx
mov $37, %rcx
rep movsl
nop
...
nop
dec %rax
lea addresses_A_ht+0xb48, %rsi
lea addresses_UC_ht+0x6b60, %rdi
nop
nop
and $18622, %rax
mov $92, %rcx
...
nop
add $2321, %rcx
lea addresses_UC_ht+0x1c150, %rdx
clflush (%rdx)
nop
nop
cmp $61248, %r8
...
nop
inc %r15
lea addresses_WC_ht+0x18228, %rsi
lea addresses_WC_ht+0x2e50, %rdi
nop
add %r9, %r9
mov $13, %rcx
rep movsl
...
{'OP': 'STOR', 'dst': {'NT': False, 'same': False, 'congruent': 1, 'type': 'addresses_WC', 'AVXalign': True, 'size': 32}}
...
{'src': {'NT': False, 'same': False, 'congruent': 11, 'type': 'addresses_D_ht', 'AVXalign': True, 'size': 2}, 'OP': 'LOAD'}
{'src': {'NT': False, 'same': False, 'congruent': 6, 'type': 'addresses_UC_ht', 'AVXalign': False, 'size': 32}, 'OP': 'LOAD'}
{'OP': 'STOR', 'dst': {'NT': True, 'same': True, 'congruent': 9, 'type': 'addresses_UC_ht', 'AVXalign': False, 'size': 4}}
{'src': {'same': False, 'congruent': 3, 'type': 'addresses_UC_ht'}, 'OP': 'REPM', 'dst': {'same': False, 'congruent': 1, 'type': 'addresses_A_ht'}}
...
{'src': {'same': False, 'congruent': 3, 'type': 'addresses_WC_ht'}, 'OP': 'REPM', 'dst': {'same': True, 'congruent': 8, 'type': 'addresses_WC_ht'}}
{'00': 21829}
