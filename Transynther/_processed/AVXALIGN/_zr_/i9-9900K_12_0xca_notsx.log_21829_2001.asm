...
push %rax
push %rdx
lea addresses_A_ht+0x1d2b8, %rax
mfence
...
nop
xor $58947, %r9
lea addresses_D_ht+0x19858, %r14
nop
nop
nop
and $2892, %r12
...
// REPMOV
mov $0xc38, %rsi
lea addresses_normal+0x2eb8, %rdi
nop
xor $2937, %rdx
mov $99, %rcx
rep movsb
...
// Faulty Load
lea addresses_normal+0x2eb8, %rsi
nop
nop
nop
nop
...
{'OP': 'STOR', 'dst': {'same': False, 'type': 'addresses_WT', 'NT': True, 'AVXalign': False, 'size': 2, 'congruent': 2}}
{'OP': 'STOR', 'dst': {'same': False, 'type': 'addresses_UC', 'NT': False, 'AVXalign': False, 'size': 32, 'congruent': 10}}
{'OP': 'REPM', 'src': {'same': False, 'congruent': 7, 'type': 'addresses_P'}, 'dst': {'same': True, 'congruent': 0, 'type': 'addresses_normal'}}
[Faulty Load]
