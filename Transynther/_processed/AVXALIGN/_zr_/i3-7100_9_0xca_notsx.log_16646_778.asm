...
lea addresses_WC_ht+0x603e, %rdi
nop
nop
mfence
mov $59, %rcx
rep movsl
cmp $34832, %rax
lea addresses_normal_ht+0x110de, %rsi
lea addresses_A_ht+0x8944, %rdi
clflush (%rsi)
sub %r9, %r9
mov $20, %rcx
rep movsl
...
{'src': {'same': False, 'congruent': 10, 'NT': False, 'type': 'addresses_D', 'size': 32, 'AVXalign': True}, 'OP': 'LOAD'}
...
{'OP': 'STOR', 'dst': {'same': False, 'congruent': 0, 'NT': True, 'type': 'addresses_WT', 'size': 16, 'AVXalign': False}}
{'OP': 'STOR', 'dst': {'same': False, 'congruent': 7, 'NT': False, 'type': 'addresses_NC', 'size': 2, 'AVXalign': False}}
[Faulty Load]
{'src': {'same': True, 'congruent': 0, 'NT': False, 'type': 'addresses_US', 'size': 2, 'AVXalign': True}, 'OP': 'LOAD'}
<gen_prepare_buffer>
