...
push %rdi
push %rsi
lea addresses_UC_ht+0x14abc, %rdi
nop
sub $59480, %r11
vmovups (%rdi), %ymm0
...
movb (%r15), %bl
inc %rsi
lea addresses_WT_ht+0xfdcb, %rsi
nop
nop
nop
nop
...
nop
xor %r15, %r15
lea addresses_normal_ht+0xe69c, %r9
add %rbx, %rbx
...
vmovaps %ymm6, (%r9)
and %rsi, %rsi
lea addresses_WC_ht+0xfcbc, %rbx
and $65416, %r15
mov (%rbx), %rcx
nop
nop
add $9229, %rcx
lea addresses_D_ht+0x156bc, %r15
nop
sub $35388, %r11
movl $0x61626364, (%r15)
nop
...
nop
xor %r15, %r15
lea addresses_normal_ht+0x58cc, %rcx
dec %rdi
...
nop
sub %rbx, %rbx
lea addresses_WT_ht+0x5832, %r11
nop
nop
inc %rdi
mov (%r11), %r9d
...
nop
xor $15010, %r15
lea addresses_D_ht+0x1bdbc, %rdi
cmp %r9, %r9
movw $0x6162, (%rdi)
nop
nop
sub $30801, %rsi
lea addresses_WT_ht+0x128a8, %rsi
lea addresses_UC_ht+0xe63c, %rdi
nop
nop
nop
nop
...
{'dst': {'type': 'addresses_D_ht', 'same': False, 'size': 4, 'congruent': 9, 'NT': False, 'AVXalign': True}, 'OP': 'STOR'}
...
{'src': {'type': 'addresses_WT_ht', 'congruent': 1, 'same': False}, 'dst': {'type': 'addresses_UC_ht', 'congruent': 7, 'same': False}, 'OP': 'REPM'}
{'00': 21829}
