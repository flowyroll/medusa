...
nop
inc %r8
lea addresses_WC_ht+0x97ff, %r11
nop
add $16160, %rax
mov (%r11), %r10
nop
xor $17624, %rdi
lea addresses_D_ht+0x988f, %r8
clflush (%r8)
nop
nop
nop
...
nop
cmp $54673, %rdi
lea addresses_WT_ht+0xf57f, %rax
clflush (%rax)
nop
nop
nop
...
nop
sub %rbp, %rbp
lea addresses_WT_ht+0x1740f, %r10
nop
nop
cmp $26656, %rax
...
nop
xor $41669, %rbp
lea addresses_normal_ht+0xb91f, %rsi
...
nop
inc %r10
lea addresses_normal_ht+0x19d0f, %rcx
nop
nop
nop
nop
...
// Store
lea addresses_normal+0x1f0d5, %r11
clflush (%r11)
nop
nop
nop
