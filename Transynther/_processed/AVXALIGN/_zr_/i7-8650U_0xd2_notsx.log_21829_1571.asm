...
push %rdx
push %rsi
lea addresses_UC_ht+0x1b926, %r8
nop
nop
nop
dec %rdx
...
nop
sub %rbp, %rbp
lea addresses_A_ht+0x12386, %rbx
nop
nop
nop
cmp %rdi, %rdi
...
nop
inc %rdx
lea addresses_WC_ht+0x16dba, %rsi
lea addresses_UC_ht+0x5b26, %rdi
clflush (%rsi)
nop
xor $49044, %rdx
mov $97, %rcx
