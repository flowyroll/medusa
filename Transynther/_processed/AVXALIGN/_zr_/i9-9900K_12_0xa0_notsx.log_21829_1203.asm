...
nop
add %rax, %rax
lea addresses_WC_ht+0x117ef, %rbx
nop
nop
nop
nop
...
nop
inc %rsi
lea addresses_A_ht+0x1c52f, %rsi
lea addresses_D_ht+0x167ef, %rdi
nop
nop
nop
cmp %r14, %r14
...
nop
xor $20547, %rax
lea addresses_normal_ht+0x3bef, %rsi
nop
nop
nop
dec %rbx
...
{'src': {'type': 'addresses_A_ht', 'congruent': 6, 'same': True}, 'OP': 'REPM', 'dst': {'type': 'addresses_D_ht', 'congruent': 8, 'same': False}}
