...
push %rdx
push %rsi
lea addresses_WT_ht+0x3d1a, %rsi
nop
nop
nop
nop
...
nop
and %r15, %r15
lea addresses_normal_ht+0x919a, %r12
nop
nop
nop
cmp $1739, %rdx
...
nop
inc %rdx
lea addresses_WC_ht+0x92ca, %rdx
nop
add %r11, %r11
...
nop
sub %rdx, %rdx
lea addresses_D_ht+0x17459, %rsi
lea addresses_D_ht+0x363a, %rdi
nop
nop
nop
add $1469, %r11
...
nop
add $6897, %r11
lea addresses_WT_ht+0x1319a, %rcx
and %r9, %r9
mov (%rcx), %r11d
nop
nop
...
nop
add %r12, %r12
lea addresses_UC_ht+0xa19a, %r11
clflush (%r11)
nop
dec %rdx
...
nop
and %rcx, %rcx
lea addresses_WC_ht+0x749a, %rcx
sub %r9, %r9
mov (%rcx), %edx
nop
nop
...
nop
sub %rsi, %rsi
lea addresses_normal_ht+0x1e6ce, %r15
nop
xor $38736, %rcx
movups (%r15), %xmm1
vpextrq $1, %xmm1, %rdx
...
{'dst': {'NT': True, 'AVXalign': False, 'size': 32, 'congruent': 1, 'same': False, 'type': 'addresses_PSE'}, 'OP': 'STOR'}
[Faulty Load]
...
{'src': {'congruent': 0, 'same': False, 'type': 'addresses_D_ht'}, 'dst': {'congruent': 5, 'same': False, 'type': 'addresses_D_ht'}, 'OP': 'REPM'}
