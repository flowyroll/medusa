...
push %rdx
push %rsi
lea addresses_D_ht+0xb35e, %rsi
lea addresses_A_ht+0x16450, %rdi
nop
nop
sub $18820, %r15
mov $106, %rcx
...
nop
add %rbp, %rbp
lea addresses_WC_ht+0x1e798, %rsi
lea addresses_UC_ht+0x1bc96, %rdi
nop
and %rbp, %rbp
mov $36, %rcx
rep movsq
...
nop
dec %rsi
lea addresses_UC_ht+0xa2e8, %rbp
nop
nop
nop
nop
...
nop
and %r15, %r15
lea addresses_WT_ht+0x1a138, %rcx
nop
cmp %rdx, %rdx
movups (%rcx), %xmm2
vpextrq $0, %xmm2, %rdi
...
<gen_prepare_buffer>
{'OP': 'REPM', 'src': {'same': False, 'type': 'addresses_D_ht', 'congruent': 1}, 'dst': {'same': True, 'type': 'addresses_A_ht', 'congruent': 3}}
