...
push %rdi
push %rsi
lea addresses_normal_ht+0x111c0, %r10
nop
nop
nop
nop
...
movb (%r10), %bl
inc %rax
lea addresses_normal_ht+0x17540, %rsi
lea addresses_D_ht+0x15580, %rdi
clflush (%rsi)
nop
nop
nop
...
nop
sub %rsi, %rsi
lea addresses_D_ht+0x1bbc0, %r10
nop
nop
nop
inc %rdi
...
lea addresses_normal_ht+0xb1c0, %rdi
nop
nop
sub %rbp, %rbp
mov $113, %rcx
rep movsq
cmp $40316, %rbx
lea addresses_normal_ht+0x83c0, %r10
nop
nop
nop
xor $42265, %rbp
...
nop
xor $57034, %rax
lea addresses_A_ht+0x16f40, %rsi
lea addresses_WC_ht+0x19ec0, %rdi
clflush (%rsi)
nop
nop
sub %rbp, %rbp
...
// Store
lea addresses_normal+0x93c0, %r11
nop
nop
add $12404, %r14
...
// Faulty Load
lea addresses_normal+0x93c0, %r9
nop
nop
nop
sub $56978, %r12
