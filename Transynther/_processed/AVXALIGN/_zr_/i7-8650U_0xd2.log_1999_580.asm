...
push %rdi
push %rsi
lea addresses_WT_ht+0x346b, %rsi
lea addresses_WC_ht+0x1c373, %rdi
clflush (%rdi)
nop
and %r12, %r12
mov $15, %rcx
...
nop
dec %r12
lea addresses_normal_ht+0x3273, %r8
clflush (%r8)
nop
nop
nop
...
nop
and $19945, %rsi
lea addresses_D_ht+0x1a673, %r12
nop
nop
dec %r9
movb (%r12), %r8b
...
nop
add $50555, %rcx
lea addresses_WC_ht+0x1aff3, %rdi
nop
add %rsi, %rsi
vmovups (%rdi), %ymm7
...
vpextrq $0, %xmm7, %r8
xor %r12, %r12
lea addresses_D_ht+0x15273, %rsi
nop
nop
nop
nop
...
nop
and %r8, %r8
lea addresses_WT_ht+0x1a393, %rdi
nop
sub %rcx, %rcx
movb (%rdi), %r12b
nop
nop
xor $43619, %r8
lea addresses_A_ht+0x5fe5, %rsi
lea addresses_A_ht+0x11473, %rdi
nop
nop
nop
nop
...
nop
cmp $26552, %rbx
lea addresses_A_ht+0xa94b, %rsi
lea addresses_D_ht+0x8e2c, %rdi
nop
nop
nop
nop
