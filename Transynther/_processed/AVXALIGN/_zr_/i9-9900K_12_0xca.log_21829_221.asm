...
lea addresses_WT_ht+0x195c9, %rdi
nop
sub $37065, %rbx
mov $63, %rcx
rep movsl
...
nop
cmp $34403, %rbx
lea addresses_UC_ht+0x12599, %rsi
lea addresses_normal_ht+0x113e1, %rdi
sub $38319, %r10
mov $103, %rcx
rep movsl
nop
...
nop
sub $48349, %rbx
lea addresses_UC_ht+0x8279, %r11
sub %r10, %r10
movl $0x61626364, (%r11)
nop
and $34106, %rdi
lea addresses_normal_ht+0x7fe9, %r10
nop
nop
nop
xor %r11, %r11
...
nop
sub $4233, %rsi
lea addresses_WT_ht+0x1d069, %rdi
nop
and $24093, %rbp
movups (%rdi), %xmm7
vpextrq $0, %xmm7, %rsi
nop
sub %rcx, %rcx
lea addresses_WC_ht+0x11e9, %rsi
lea addresses_WT_ht+0x1dd1b, %rdi
nop
cmp %rbx, %rbx
mov $93, %rcx
rep movsq
...
nop
dec %rsi
lea addresses_WT_ht+0x3903, %rbp
nop
nop
nop
nop
...
vpextrq $1, %xmm7, %r10
and $38292, %rcx
lea addresses_UC_ht+0x94a9, %rbx
add $38676, %r10
movw $0x6162, (%rbx)
nop
nop
...
nop
add $13748, %rdi
lea addresses_A_ht+0x4469, %rsi
lea addresses_WT_ht+0x196c9, %rdi
clflush (%rdi)
nop
add $19975, %r8
mov $100, %rcx
...
{'OP': 'REPM', 'src': {'same': False, 'type': 'addresses_UC_ht', 'congruent': 3}, 'dst': {'same': False, 'type': 'addresses_normal_ht', 'congruent': 2}}
...
{'OP': 'REPM', 'src': {'same': True, 'type': 'addresses_WC_ht', 'congruent': 8}, 'dst': {'same': False, 'type': 'addresses_WT_ht', 'congruent': 0}}
