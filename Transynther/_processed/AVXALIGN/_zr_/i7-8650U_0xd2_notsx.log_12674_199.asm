...
push %rdx
push %rsi
lea addresses_WC_ht+0x1a292, %r11
nop
nop
nop
nop
...
movups %xmm1, (%rbx)
and %rdx, %rdx
lea addresses_UC_ht+0x14386, %rbx
nop
nop
nop
nop
...
nop
cmp $34272, %r13
lea addresses_normal_ht+0xf8c6, %rsi
lea addresses_A_ht+0x1d86, %rdi
nop
add %r11, %r11
mov $87, %rcx
rep movsq
...
nop
xor $42813, %r11
lea addresses_UC_ht+0x1d18a, %r12
nop
nop
cmp $11716, %r9
movw $0x6162, (%r12)
...
nop
cmp $50030, %rax
lea addresses_normal_ht+0x1c376, %rcx
and %rsi, %rsi
movb (%rcx), %r9b
nop
nop
add %rdx, %rdx
lea addresses_D_ht+0x4b86, %rcx
add %rbx, %rbx
mov (%rcx), %r12d
inc %rsi
pop %rsi
...
// REPMOV
lea addresses_D+0x11f86, %rsi
lea addresses_WT+0x1286, %rdi
nop
sub $11248, %rbp
mov $75, %rcx
rep movsl
...
// Store
lea addresses_normal+0x10b6e, %r11
nop
nop
nop
nop
...
{'OP': 'REPM', 'src': {'type': 'addresses_D', 'congruent': 10, 'same': False}, 'dst': {'type': 'addresses_WT', 'congruent': 8, 'same': False}}
