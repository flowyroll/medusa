...
push %rdi
push %rsi
lea addresses_UC_ht+0x54c, %rax
nop
mfence
mov $0x6162636465666768, %rsi
movq %rsi, (%rax)
xor %r10, %r10
lea addresses_UC_ht+0x2cec, %r14
nop
nop
nop
nop
...
nop
inc %r14
lea addresses_WT_ht+0x399c, %r13
nop
nop
nop
nop
...
nop
cmp $29213, %r10
lea addresses_WC_ht+0x95cc, %r10
nop
nop
inc %r15
...
nop
and %r15, %r15
lea addresses_normal_ht+0x1b84c, %r10
nop
nop
nop
and $52843, %r15
...
nop
dec %r14
lea addresses_WC_ht+0x20cc, %rsi
lea addresses_A_ht+0x1b55f, %rdi
nop
nop
nop
nop
...
// Store
lea addresses_normal+0x5c4c, %rsi
nop
nop
nop
cmp %rcx, %rcx
...
// Faulty Load
lea addresses_normal+0x5c4c, %rdi
sub %r10, %r10
movntdqa (%rdi), %xmm3
vpextrq $1, %xmm3, %r8
lea oracles, %r10
...
{'OP': 'LOAD', 'src': {'size': 1, 'NT': False, 'type': 'addresses_WT_ht', 'same': False, 'AVXalign': True, 'congruent': 4}}
...
{'OP': 'REPM', 'src': {'same': False, 'type': 'addresses_WC_ht', 'congruent': 5}, 'dst': {'same': False, 'type': 'addresses_A_ht', 'congruent': 0}}
{'00': 21829}
