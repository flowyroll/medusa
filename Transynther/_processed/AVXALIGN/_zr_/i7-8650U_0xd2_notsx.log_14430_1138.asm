...
nop
xor %r12, %r12
lea addresses_D_ht+0x48f4, %rsi
lea addresses_D_ht+0x17864, %rdi
clflush (%rsi)
nop
nop
nop
...
nop
and %r13, %r13
lea addresses_normal_ht+0x14d94, %rsi
lea addresses_D_ht+0x1494, %rdi
clflush (%rdi)
inc %rbx
mov $49, %rcx
rep movsb
...
nop
sub %rsi, %rsi
lea addresses_normal_ht+0x9134, %r12
sub $1885, %r11
mov (%r12), %r10w
nop
nop
...
{'OP': 'LOAD', 'src': {'type': 'addresses_D_ht', 'size': 1, 'AVXalign': True, 'NT': True, 'congruent': 11, 'same': False}}
