...
push %rdi
push %rsi
lea addresses_UC_ht+0x8faf, %rsi
clflush (%rsi)
nop
nop
nop
...
nop
dec %rdi
lea addresses_D_ht+0x1e461, %rbx
nop
dec %r11
movb $0x61, (%rbx)
and %rbx, %rbx
lea addresses_WC_ht+0x414f, %r8
nop
sub $64771, %rcx
movl $0x61626364, (%r8)
nop
...
mov (%rdi), %si
inc %rsi
lea addresses_normal_ht+0x1c3bf, %r8
clflush (%r8)
nop
nop
nop
...
nop
add %rdi, %rdi
lea addresses_normal_ht+0xe52f, %rcx
nop
nop
nop
xor $63301, %r8
...
nop
dec %rbx
lea addresses_normal_ht+0xa132, %rdi
nop
add %rsi, %rsi
movl $0x61626364, (%rdi)
nop
cmp $19796, %rbx
lea addresses_WT_ht+0x612f, %rcx
nop
nop
nop
nop
...
movw $0x6162, (%rcx)
xor $29901, %rsi
lea addresses_normal_ht+0x19b5f, %rbx
nop
nop
nop
nop
...
nop
xor %rbx, %rbx
lea addresses_D_ht+0x165af, %rdi
nop
nop
add $34184, %r11
mov (%rdi), %rcx
nop
and %rbx, %rbx
lea addresses_WC_ht+0x1252f, %rsi
lea addresses_D_ht+0x1b60b, %rdi
nop
nop
inc %rbx
mov $126, %rcx
...
nop
dec %r9
lea addresses_WT_ht+0x6fa7, %rcx
nop
nop
nop
nop
...
nop
sub %rcx, %rcx
lea addresses_WT_ht+0x185b7, %rsi
nop
nop
add $34924, %rcx
...
// Load
lea addresses_normal+0x1552f, %rcx
cmp $51040, %r13
movb (%rcx), %r15b
nop
cmp $61774, %rbx
...
{'OP': 'LOAD', 'src': {'type': 'addresses_normal', 'AVXalign': True, 'congruent': 10, 'size': 1, 'same': False, 'NT': False}}
[Faulty Load]
...
{'OP': 'STOR', 'dst': {'type': 'addresses_WT_ht', 'AVXalign': False, 'congruent': 9, 'size': 2, 'same': True, 'NT': True}}
