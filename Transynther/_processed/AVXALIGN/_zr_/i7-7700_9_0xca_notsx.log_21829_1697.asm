...
nop
cmp $41793, %rax
lea addresses_normal_ht+0x40e9, %rdx
nop
add %rax, %rax
mov (%rdx), %r11
xor %rdx, %rdx
lea addresses_WC_ht+0x1aca9, %rsi
lea addresses_A_ht+0x129d1, %rdi
nop
nop
nop
nop
...
nop
and $6888, %r13
lea addresses_normal_ht+0x92f9, %rsi
lea addresses_WT_ht+0xcf89, %rdi
nop
nop
nop
nop
...
nop
dec %r13
lea addresses_D_ht+0x13ce9, %r11
add $26427, %rdx
...
nop
inc %r12
lea addresses_normal_ht+0x16469, %rsi
lea addresses_A_ht+0x67d9, %rdi
nop
nop
nop
nop
...
nop
sub %rdx, %rdx
lea addresses_UC_ht+0x15a79, %rax
nop
nop
nop
inc %rdx
...
{'src': {'NT': False, 'AVXalign': True, 'size': 32, 'congruent': 7, 'same': False, 'type': 'addresses_WC_ht'}, 'OP': 'LOAD'}
{'src': {'NT': False, 'AVXalign': False, 'size': 8, 'congruent': 8, 'same': False, 'type': 'addresses_normal_ht'}, 'OP': 'LOAD'}
{'src': {'congruent': 6, 'same': False, 'type': 'addresses_WC_ht'}, 'dst': {'congruent': 3, 'same': False, 'type': 'addresses_A_ht'}, 'OP': 'REPM'}
{'src': {'congruent': 4, 'same': False, 'type': 'addresses_normal_ht'}, 'dst': {'congruent': 5, 'same': True, 'type': 'addresses_WT_ht'}, 'OP': 'REPM'}
{'dst': {'NT': False, 'AVXalign': False, 'size': 32, 'congruent': 4, 'same': False, 'type': 'addresses_D_ht'}, 'OP': 'STOR'}
{'src': {'congruent': 6, 'same': False, 'type': 'addresses_normal_ht'}, 'dst': {'congruent': 2, 'same': False, 'type': 'addresses_A_ht'}, 'OP': 'REPM'}
