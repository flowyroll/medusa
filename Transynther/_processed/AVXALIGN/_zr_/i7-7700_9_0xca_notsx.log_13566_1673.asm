...
push %rdx
push %rsi
lea addresses_D_ht+0x13e33, %rbp
nop
nop
and %rax, %rax
mov (%rbp), %ecx
...
nop
add $46499, %r11
lea addresses_normal_ht+0x7233, %r13
nop
nop
nop
nop
...
nop
sub %r10, %r10
lea addresses_UC_ht+0xa080, %rcx
nop
nop
nop
nop
...
nop
cmp $4964, %rax
lea addresses_normal_ht+0x1c0f3, %rcx
clflush (%rcx)
nop
xor $40982, %rbp
vmovups (%rcx), %ymm0
...
vpextrq $1, %xmm0, %rdx
dec %rax
lea addresses_normal_ht+0x13ae4, %rsi
lea addresses_D_ht+0x6633, %rdi
nop
nop
nop
nop
...
rep movsb
cmp $9057, %rsi
lea addresses_normal_ht+0x18f33, %rsi
lea addresses_normal_ht+0x6953, %rdi
clflush (%rsi)
nop
nop
nop
...
nop
and %r10, %r10
lea addresses_UC_ht+0x11f33, %rsi
lea addresses_A_ht+0xa9f3, %rdi
nop
nop
xor %r10, %r10
mov $52, %rcx
...
nop
and $4526, %rcx
lea addresses_normal_ht+0x686d, %rdx
clflush (%rdx)
nop
nop
nop
...
[Faulty Load]
{'src': {'NT': True, 'AVXalign': True, 'size': 32, 'congruent': 0, 'same': True, 'type': 'addresses_UC'}, 'OP': 'LOAD'}
<gen_prepare_buffer>
{'src': {'NT': False, 'AVXalign': True, 'size': 4, 'congruent': 10, 'same': False, 'type': 'addresses_D_ht'}, 'OP': 'LOAD'}
...
{'src': {'congruent': 0, 'same': False, 'type': 'addresses_normal_ht'}, 'dst': {'congruent': 3, 'same': False, 'type': 'addresses_D_ht'}, 'OP': 'REPM'}
