...
push %rdx
push %rsi
lea addresses_UC_ht+0x1d3a6, %rsi
lea addresses_D_ht+0xf1ce, %rdi
nop
nop
nop
nop
...
nop
inc %rdx
lea addresses_UC_ht+0x5c26, %r11
nop
nop
add %r8, %r8
mov (%r11), %rbx
...
nop
add $63256, %rdx
lea addresses_WC_ht+0xf56, %rsi
lea addresses_WC_ht+0x6f25, %rdi
nop
nop
nop
sub %rbp, %rbp
...
nop
dec %rbp
lea addresses_normal_ht+0x8746, %rbx
nop
add $26885, %rcx
mov (%rbx), %si
nop
...
<gen_prepare_buffer>
{'src': {'congruent': 7, 'same': False, 'type': 'addresses_UC_ht'}, 'OP': 'REPM', 'dst': {'congruent': 3, 'same': False, 'type': 'addresses_D_ht'}}
