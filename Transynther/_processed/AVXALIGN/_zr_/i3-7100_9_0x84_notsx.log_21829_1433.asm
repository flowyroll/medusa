...
push %rdx
push %rsi
lea addresses_normal_ht+0x1e380, %rdx
nop
nop
cmp $25681, %r11
movl $0x61626364, (%rdx)
...
nop
dec %r11
lea addresses_WC_ht+0x12640, %rbp
nop
nop
nop
nop
...
nop
and $19924, %rbp
lea addresses_A_ht+0x12850, %rax
nop
nop
nop
nop
...
nop
add %rbx, %rbx
lea addresses_WC_ht+0x142a0, %rbx
nop
nop
nop
mfence
movw $0x6162, (%rbx)
inc %r13
lea addresses_WC_ht+0xe0b0, %rsi
lea addresses_D_ht+0x2300, %rdi
nop
xor %rbp, %rbp
mov $123, %rcx
rep movsq
...
nop
xor %rbx, %rbx
lea addresses_WC_ht+0xe5fd, %rax
nop
nop
nop
nop
...
movw $0x6162, (%rdi)
xor %r11, %r11
lea addresses_A_ht+0x1624a, %rcx
clflush (%rcx)
nop
lfence
mov (%rcx), %ax
...
nop
cmp %r11, %r11
lea addresses_normal_ht+0xef00, %rsi
lea addresses_WT_ht+0x3dc8, %rdi
nop
nop
nop
sub $32091, %rbx
...
nop
add $58487, %rsi
lea addresses_A_ht+0x8d00, %r11
nop
add $21619, %rbp
movl $0x61626364, (%r11)
nop
xor %rax, %rax
lea addresses_A_ht+0x12e28, %rsi
lea addresses_D_ht+0x12400, %rdi
nop
nop
nop
and $25667, %rax
...
nop
add %rax, %rax
lea addresses_normal_ht+0x3e9c, %rsi
lea addresses_normal_ht+0x9b24, %rdi
nop
nop
nop
nop
...
{'dst': {'type': 'addresses_WC_ht', 'same': False, 'size': 32, 'congruent': 3, 'NT': True, 'AVXalign': False}, 'OP': 'STOR'}
...
{'dst': {'type': 'addresses_WC_ht', 'same': True, 'size': 2, 'congruent': 10, 'NT': False, 'AVXalign': True}, 'OP': 'STOR'}
{'src': {'type': 'addresses_A_ht', 'same': False, 'size': 2, 'congruent': 1, 'NT': True, 'AVXalign': False}, 'OP': 'LOAD'}
...
{'dst': {'type': 'addresses_WC_ht', 'same': False, 'size': 8, 'congruent': 10, 'NT': False, 'AVXalign': True}, 'OP': 'STOR'}
