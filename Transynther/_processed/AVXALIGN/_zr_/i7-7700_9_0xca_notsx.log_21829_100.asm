...
push %rdi
push %rsi
lea addresses_WT_ht+0x94a3, %r13
and $42188, %rcx
vmovups (%r13), %ymm4
...
nop
dec %r9
lea addresses_WC_ht+0x1b8a3, %r9
nop
nop
nop
xor $36074, %rdi
...
nop
and %rcx, %rcx
lea addresses_D_ht+0x138a3, %rsi
lea addresses_normal_ht+0x1c2a3, %rdi
clflush (%rsi)
nop
nop
nop
...
rep movsw
add $24549, %r13
lea addresses_UC_ht+0xf8a3, %rcx
nop
nop
nop
nop
...
<gen_faulty_load>
[REF]
{'src': {'NT': True, 'AVXalign': False, 'size': 2, 'congruent': 0, 'same': False, 'type': 'addresses_NC'}, 'OP': 'LOAD'}
...
{'src': {'NT': False, 'AVXalign': False, 'size': 2, 'congruent': 2, 'same': False, 'type': 'addresses_UC'}, 'OP': 'LOAD'}
...
{'src': {'congruent': 10, 'same': False, 'type': 'addresses_D_ht'}, 'dst': {'congruent': 8, 'same': False, 'type': 'addresses_normal_ht'}, 'OP': 'REPM'}
