...
push %rdx
push %rsi
lea addresses_D_ht+0x127e2, %r11
nop
nop
nop
nop
...
nop
add %rbx, %rbx
lea addresses_A_ht+0x1c9f2, %rdx
clflush (%rdx)
nop
sub $26105, %r12
movups (%rdx), %xmm5
...
nop
xor $48876, %r10
lea addresses_WC_ht+0xe916, %rdx
nop
nop
cmp %r11, %r11
movb $0x61, (%rdx)
nop
xor $17372, %rdx
lea addresses_A_ht+0x1e3f2, %rsi
lea addresses_UC_ht+0x14c32, %rdi
nop
nop
nop
xor %r10, %r10
...
nop
xor $50491, %r12
lea addresses_D_ht+0x13e82, %r13
nop
nop
and %r10, %r10
movl $0x61626364, (%r13)
...
nop
add %rdx, %rdx
lea addresses_WC_ht+0x70f6, %r11
mfence
mov (%r11), %r8w
nop
nop
...
nop
and %rbx, %rbx
lea addresses_D_ht+0x1ab96, %rsi
lea addresses_WC_ht+0xf9f2, %rdi
clflush (%rsi)
lfence
mov $89, %rcx
rep movsq
...
nop
inc %r12
lea addresses_UC_ht+0x61b, %rsi
lea addresses_WC_ht+0x10d82, %rdi
nop
nop
nop
add %r12, %r12
...
nop
and $19519, %rbx
lea addresses_D_ht+0x159f2, %rdx
nop
nop
nop
inc %r12
...
{'OP': 'LOAD', 'src': {'type': 'addresses_WC_ht', 'size': 1, 'AVXalign': False, 'NT': False, 'congruent': 1, 'same': True}}
{'OP': 'LOAD', 'src': {'type': 'addresses_A_ht', 'size': 16, 'AVXalign': False, 'NT': False, 'congruent': 11, 'same': False}}
{'OP': 'STOR', 'dst': {'type': 'addresses_WC_ht', 'size': 1, 'AVXalign': True, 'NT': True, 'congruent': 2, 'same': True}}
...
{'OP': 'LOAD', 'src': {'type': 'addresses_WC_ht', 'size': 2, 'AVXalign': True, 'NT': False, 'congruent': 2, 'same': False}}
