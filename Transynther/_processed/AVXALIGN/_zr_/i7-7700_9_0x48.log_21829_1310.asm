...
push %rdi
push %rsi
lea addresses_WC_ht+0x4106, %rsi
lea addresses_UC_ht+0x3ac6, %rdi
add $61676, %r10
mov $17, %rcx
rep movsw
cmp %r9, %r9
...
nop
cmp $20333, %r9
lea addresses_A_ht+0x15906, %rbp
nop
and $1244, %rcx
mov (%rbp), %bx
nop
add $64328, %rdi
lea addresses_WC_ht+0xdd06, %r9
nop
cmp $15349, %rsi
mov (%r9), %bp
nop
...
nop
and %rsi, %rsi
lea addresses_WT_ht+0x7d06, %rsi
lea addresses_WC_ht+0x12906, %rdi
nop
nop
nop
nop
...
{'OP': 'REPM', 'src': {'type': 'addresses_WT_ht', 'congruent': 10, 'same': False}, 'dst': {'type': 'addresses_WC_ht', 'congruent': 10, 'same': False}}
{'00': 21829}
