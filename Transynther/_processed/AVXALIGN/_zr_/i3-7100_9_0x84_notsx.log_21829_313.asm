...
nop
add $63371, %r15
lea addresses_WC_ht+0x102a9, %rsi
lea addresses_A_ht+0x9619, %rdi
nop
nop
cmp %rbp, %rbp
mov $44, %rcx
...
nop
xor %rbp, %rbp
lea addresses_D_ht+0x11b19, %rsi
nop
nop
cmp %r15, %r15
movl $0x61626364, (%rsi)
...
nop
cmp $1021, %rax
lea addresses_A_ht+0x1a4e9, %rdi
nop
nop
nop
cmp %r15, %r15
...
nop
inc %r13
lea addresses_UC_ht+0xca19, %r12
nop
nop
nop
dec %rcx
...
nop
sub $52350, %rsi
lea addresses_UC_ht+0x9619, %rcx
clflush (%rcx)
nop
nop
nop
...
nop
sub %rcx, %rcx
lea addresses_WT_ht+0xdd99, %rsi
lea addresses_D_ht+0x11e39, %rdi
nop
nop
cmp %r13, %r13
mov $71, %rcx
...
// REPMOV
lea addresses_WC+0x1e759, %rsi
lea addresses_D+0x17f59, %rdi
nop
nop
nop
nop
...
// Load
lea addresses_normal+0x1bb99, %rdi
nop
nop
xor %rbx, %rbx
movb (%rdi), %dl
...
{'src': {'type': 'addresses_WC', 'congruent': 6, 'same': False}, 'dst': {'type': 'addresses_D', 'congruent': 5, 'same': False}, 'OP': 'REPM'}
...
{'src': {'type': 'addresses_WT', 'same': False, 'size': 4, 'congruent': 2, 'NT': False, 'AVXalign': False}, 'OP': 'LOAD'}
{'dst': {'type': 'addresses_PSE', 'same': False, 'size': 2, 'congruent': 6, 'NT': False, 'AVXalign': False}, 'OP': 'STOR'}
[Faulty Load]
{'src': {'type': 'addresses_NC', 'same': True, 'size': 4, 'congruent': 0, 'NT': True, 'AVXalign': True}, 'OP': 'LOAD'}
<gen_prepare_buffer>
