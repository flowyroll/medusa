...
push %rdx
push %rsi
lea addresses_WC_ht+0x185c9, %rsi
lea addresses_UC_ht+0x1bd29, %rdi
clflush (%rdi)
nop
nop
nop
...
nop
xor $58159, %rax
lea addresses_A_ht+0x12039, %rdi
nop
nop
nop
and $42099, %rdx
...
nop
xor %rdi, %rdi
lea addresses_WT_ht+0x11f29, %rsi
lea addresses_UC_ht+0x10729, %rdi
clflush (%rdi)
nop
nop
nop
...
nop
inc %rcx
lea addresses_D_ht+0xfd29, %rsi
lea addresses_D_ht+0x33b3, %rdi
nop
nop
nop
nop
...
nop
cmp %rdi, %rdi
lea addresses_normal_ht+0x15790, %rsi
lea addresses_D_ht+0x12929, %rdi
nop
nop
nop
nop
...
nop
xor $12238, %rdi
lea addresses_A_ht+0x12529, %rsi
nop
nop
cmp $38653, %r15
movb $0x61, (%rsi)
...
nop
dec %r15
lea addresses_A_ht+0xf529, %rsi
lea addresses_A_ht+0x1249, %rdi
nop
xor $13868, %rax
mov $57, %rcx
rep movsw
...
nop
sub %rax, %rax
lea addresses_UC_ht+0x16d79, %r14
xor %rdi, %rdi
mov (%r14), %ecx
nop
nop
...
{'OP': 'REPM', 'src': {'type': 'addresses_A_ht', 'congruent': 11, 'same': True}, 'dst': {'type': 'addresses_A_ht', 'congruent': 5, 'same': False}}
