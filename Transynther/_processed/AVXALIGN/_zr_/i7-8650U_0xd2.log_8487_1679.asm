...
push %rdx
push %rsi
lea addresses_WT_ht+0x1c37b, %r11
nop
nop
nop
and %r13, %r13
...
vpextrq $1, %xmm1, %rdx
and %rdx, %rdx
lea addresses_normal_ht+0x317b, %rsi
lea addresses_WC_ht+0x2b7b, %rdi
nop
nop
xor $57746, %rax
mov $5, %rcx
...
nop
and $22913, %rdx
lea addresses_D_ht+0x15fc3, %rbx
nop
dec %rax
mov (%rbx), %edi
nop
...
nop
xor $15170, %rdi
lea addresses_normal_ht+0x1817b, %rdx
nop
nop
nop
nop
...
nop
cmp %rdi, %rdi
lea addresses_WT_ht+0x1a07b, %rsi
lea addresses_D_ht+0xc3a3, %rdi
nop
nop
nop
nop
...
{'OP': 'REPM', 'src': {'type': 'addresses_normal_ht', 'congruent': 10, 'same': False}, 'dst': {'type': 'addresses_WC_ht', 'congruent': 8, 'same': False}}
...
{'OP': 'REPM', 'src': {'type': 'addresses_WT_ht', 'congruent': 7, 'same': False}, 'dst': {'type': 'addresses_D_ht', 'congruent': 1, 'same': True}}
{'00': 8487}
