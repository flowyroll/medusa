...
nop
xor %rcx, %rcx
lea addresses_WT_ht+0x533b, %r13
nop
cmp %rcx, %rcx
...
nop
sub %rax, %rax
lea addresses_UC_ht+0x1e8c5, %r12
sub %r14, %r14
movl $0x61626364, (%r12)
nop
xor %r11, %r11
lea addresses_WT_ht+0x1efbb, %rsi
lea addresses_A_ht+0x1707b, %rdi
clflush (%rdi)
nop
nop
nop
...
rep movsw
add %rax, %rax
lea addresses_normal_ht+0x29f7, %rax
nop
nop
nop
and $47816, %r13
...
nop
inc %r12
lea addresses_D_ht+0x15688, %rcx
clflush (%rcx)
nop
cmp %rsi, %rsi
movups (%rcx), %xmm2
...
nop
inc %r12
lea addresses_WC_ht+0x1116f, %rsi
nop
sub %rdi, %rdi
mov (%rsi), %r14
cmp $47653, %r11
lea addresses_WC_ht+0x37bb, %rsi
lea addresses_WC_ht+0x103fb, %rdi
clflush (%rdi)
nop
add %r11, %r11
mov $53, %rcx
...
nop
sub $24059, %r11
lea addresses_normal_ht+0x64df, %rsi
...
nop
add $33833, %r14
lea addresses_WC_ht+0x1bcbb, %rdi
nop
nop
nop
and %rax, %rax
...
nop
add %r13, %r13
lea addresses_UC_ht+0xd07b, %rax
nop
nop
nop
nop
...
nop
and $36984, %r14
lea addresses_UC_ht+0xb55b, %r13
nop
nop
dec %r14
mov (%r13), %rcx
...
nop
cmp %r13, %r13
lea addresses_WT_ht+0x1b193, %rsi
nop
nop
nop
nop
...
{'OP': 'STOR', 'dst': {'type': 'addresses_A', 'AVXalign': True, 'congruent': 0, 'size': 1, 'same': False, 'NT': False}}
[Faulty Load]
...
{'OP': 'STOR', 'dst': {'type': 'addresses_normal_ht', 'AVXalign': False, 'congruent': 9, 'size': 16, 'same': True, 'NT': False}}
...
{'OP': 'LOAD', 'src': {'type': 'addresses_UC_ht', 'AVXalign': True, 'congruent': 11, 'size': 1, 'same': False, 'NT': False}}
{'OP': 'LOAD', 'src': {'type': 'addresses_UC_ht', 'AVXalign': True, 'congruent': 2, 'size': 8, 'same': True, 'NT': False}}
{'OP': 'STOR', 'dst': {'type': 'addresses_WT_ht', 'AVXalign': True, 'congruent': 3, 'size': 2, 'same': True, 'NT': False}}
{'00': 21829}
