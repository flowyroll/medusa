...
push %rdi
push %rsi
lea addresses_WC_ht+0x12e50, %r12
nop
dec %rdi
...
nop
and %r11, %r11
lea addresses_WT_ht+0xf12a, %rsi
lea addresses_UC_ht+0x95e6, %rdi
nop
nop
add $60388, %r10
mov $62, %rcx
...
nop
xor $65244, %rsi
lea addresses_UC_ht+0x1873e, %r12
nop
nop
nop
cmp %r10, %r10
...
nop
add %r11, %r11
lea addresses_WC_ht+0x15daa, %rsi
nop
xor %r10, %r10
...
vmovups %ymm5, (%rsi)
dec %rsi
lea addresses_WT_ht+0x1ab2a, %rcx
nop
xor %r11, %r11
movb $0x61, (%rcx)
nop
...
nop
add $23771, %r10
lea addresses_normal_ht+0x1b92a, %rsi
nop
nop
nop
and %r15, %r15
...
{'OP': 'STOR', 'dst': {'type': 'addresses_UC_ht', 'AVXalign': False, 'congruent': 1, 'size': 16, 'same': True, 'NT': False}}
