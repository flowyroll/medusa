...
push %rdx
push %rsi
lea addresses_WT_ht+0xe8e8, %r12
nop
nop
nop
nop
...
nop
dec %rdi
lea addresses_WT_ht+0xeb20, %rsi
nop
nop
nop
xor %rdx, %rdx
...
nop
cmp %rdx, %rdx
lea addresses_WT_ht+0x10488, %rsi
lea addresses_A_ht+0x16088, %rdi
nop
nop
nop
nop
...
nop
sub %rdx, %rdx
lea addresses_WC_ht+0x1fc8, %r12
nop
nop
nop
lfence
movb $0x61, (%r12)
sub $26984, %rdx
lea addresses_WC_ht+0xd688, %r10
nop
nop
nop
nop
...
nop
cmp $7931, %r12
lea addresses_WT_ht+0x8288, %rsi
clflush (%rsi)
nop
nop
nop
...
nop
cmp %rcx, %rcx
lea addresses_UC_ht+0x172ee, %rsi
nop
nop
add $6057, %rcx
movb (%rsi), %r10b
and $1378, %rdi
lea addresses_WT_ht+0x161a8, %rsi
clflush (%rsi)
add $36502, %r12
...
// Store
lea addresses_normal+0x11c88, %r8
nop
nop
nop
dec %r14
