...
lea addresses_WC_ht+0x15ede, %rdi
clflush (%rsi)
nop
nop
nop
...
nop
add $42831, %rcx
lea addresses_WC_ht+0x11aae, %r13
nop
and $48915, %r15
...
nop
xor $34356, %rdi
lea addresses_UC_ht+0x1305e, %rcx
nop
nop
cmp %rsi, %rsi
...
nop
and %rbp, %rbp
lea addresses_UC_ht+0x1ed0c, %r15
nop
nop
nop
and %r11, %r11
...
nop
dec %rcx
lea addresses_normal_ht+0x145e, %r15
nop
add %r11, %r11
movl $0x61626364, (%r15)
nop
