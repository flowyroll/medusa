...
push %rdx
push %rsi
lea addresses_UC_ht+0x85c9, %rbx
nop
nop
nop
nop
...
mov (%rbx), %r12
sub %rdx, %rdx
lea addresses_WC_ht+0x855, %rsi
lea addresses_UC_ht+0x829d, %rdi
nop
dec %rdx
mov $121, %rcx
rep movsb
...
nop
and $27943, %rcx
lea addresses_WT_ht+0x21f9, %rsi
lea addresses_WC_ht+0x164f9, %rdi
nop
add %r14, %r14
mov $114, %rcx
rep movsq
cmp %rdi, %rdi
lea addresses_UC_ht+0x5a79, %rbx
nop
nop
add %r12, %r12
mov (%rbx), %r14
add $18093, %rdx
lea addresses_WT_ht+0x8109, %rcx
nop
nop
nop
dec %rsi
...
// Store
lea addresses_normal+0x1179, %rdi
nop
add $3303, %rcx
movb $0x51, (%rdi)
nop
