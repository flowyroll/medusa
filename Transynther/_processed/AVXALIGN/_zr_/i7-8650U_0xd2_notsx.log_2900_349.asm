...
push %rdi
push %rsi
lea addresses_A_ht+0x7dd4, %rsi
lea addresses_UC_ht+0xa994, %rdi
xor $39055, %r13
mov $48, %rcx
rep movsb
and %r11, %r11
lea addresses_D_ht+0xd9d4, %rax
nop
nop
nop
cmp $9200, %r11
...
nop
cmp %rdi, %rdi
lea addresses_WC_ht+0x15210, %rsi
lea addresses_WT_ht+0x18c4, %rdi
nop
nop
nop
nop
...
nop
and %rcx, %rcx
lea addresses_UC_ht+0x51d4, %rsi
nop
nop
add $10835, %r9
mov (%rsi), %edi
and $19628, %rsi
lea addresses_A_ht+0x32d4, %rsi
nop
nop
add %rax, %rax
...
nop
sub %rsi, %rsi
lea addresses_UC_ht+0xfe2, %rax
nop
nop
xor $23628, %rsi
mov (%rax), %rdi
and %rcx, %rcx
lea addresses_A_ht+0x18cd4, %r9
nop
inc %r11
movups (%r9), %xmm1
vpextrq $1, %xmm1, %rdi
...
lea addresses_A_ht+0x18fd4, %rdi
nop
nop
nop
nop
...
nop
and %r9, %r9
lea addresses_WC_ht+0x11612, %rax
nop
nop
nop
nop
...
// REPMOV
lea addresses_normal+0x7c5e, %rsi
lea addresses_PSE+0x1f9d4, %rdi
inc %r13
mov $6, %rcx
rep movsb
add %r8, %r8
...
// Store
lea addresses_normal+0x1b1d4, %rsi
nop
nop
and %rbp, %rbp
movw $0x5152, (%rsi)
...
{'OP': 'REPM', 'src': {'type': 'addresses_normal', 'congruent': 0, 'same': False}, 'dst': {'type': 'addresses_PSE', 'congruent': 0, 'same': True}}
...
{'OP': 'STOR', 'dst': {'type': 'addresses_RW', 'size': 16, 'AVXalign': False, 'NT': True, 'congruent': 9, 'same': False}}
[Faulty Load]
