...
push %rdi
push %rsi
lea addresses_UC_ht+0x10ce5, %rsi
lea addresses_UC_ht+0x1b5a5, %rdi
nop
nop
nop
inc %r10
...
nop
inc %rax
lea addresses_D_ht+0x1e265, %rsi
lea addresses_A_ht+0xe565, %rdi
clflush (%rdi)
nop
nop
xor %rbx, %rbx
...
nop
sub $3532, %rsi
lea addresses_UC_ht+0xa4e5, %rsi
clflush (%rsi)
dec %r14
movw $0x6162, (%rsi)
cmp $16864, %rcx
lea addresses_D_ht+0x168e5, %rbx
nop
nop
xor $46667, %rcx
movb $0x61, (%rbx)
nop
xor %rsi, %rsi
lea addresses_UC_ht+0x1e0e5, %rcx
nop
nop
nop
cmp $56577, %rsi
...
nop
xor $8073, %rdi
lea addresses_D_ht+0x14ae5, %r14
nop
nop
nop
nop
...
nop
dec %rcx
lea addresses_WC_ht+0x106e5, %r10
and %rbx, %rbx
movw $0x6162, (%r10)
nop
nop
sub $9089, %rbx
lea addresses_UC_ht+0xb0e5, %rcx
nop
nop
nop
nop
...
movl $0x61626364, (%rcx)
xor $41750, %r14
lea addresses_WC_ht+0x108fc, %rdi
nop
nop
nop
nop
...
nop
sub $27477, %rax
lea addresses_normal_ht+0x2565, %rsi
lea addresses_WT_ht+0x1dde5, %rdi
xor %r12, %r12
mov $35, %rcx
rep movsb
xor $41589, %rdi
lea addresses_UC_ht+0xdee5, %rsi
nop
nop
xor %rbx, %rbx
movb $0x61, (%rsi)
