...
nop
xor %rdx, %rdx
lea addresses_WT_ht+0x4b1f, %rdx
nop
nop
nop
sub $20191, %r8
...
nop
xor %rcx, %rcx
lea addresses_A_ht+0x8cbf, %rsi
lea addresses_UC_ht+0x11881, %rdi
nop
nop
nop
nop
...
nop
add $15224, %r13
lea addresses_UC_ht+0x968f, %rsi
nop
nop
nop
and $40165, %rdi
movb $0x61, (%rsi)
sub %rdx, %rdx
lea addresses_WC_ht+0x19e77, %rsi
nop
and $12198, %r11
vmovups (%rsi), %ymm5
...
nop
xor %r11, %r11
lea addresses_normal_ht+0x18a9f, %rcx
nop
nop
sub %rdx, %rdx
movw $0x6162, (%rcx)
...
mov (%r8), %edi
and %rdx, %rdx
lea addresses_A_ht+0x60af, %rsi
lea addresses_UC_ht+0x829f, %rdi
nop
add $46151, %r15
mov $51, %rcx
rep movsb
...
nop
add %rcx, %rcx
lea addresses_normal_ht+0xe61f, %rsi
...
[Faulty Load]
{'src': {'congruent': 0, 'AVXalign': False, 'same': True, 'size': 4, 'NT': True, 'type': 'addresses_UC'}, 'OP': 'LOAD'}
<gen_prepare_buffer>
{'src': {'congruent': 8, 'same': False, 'type': 'addresses_D_ht'}, 'OP': 'REPM', 'dst': {'congruent': 1, 'same': False, 'type': 'addresses_A_ht'}}
...
{'src': {'congruent': 7, 'same': False, 'type': 'addresses_normal_ht'}, 'OP': 'REPM', 'dst': {'congruent': 11, 'same': True, 'type': 'addresses_WC_ht'}}
{'00': 21829}
