...
push %rdi
push %rdx
lea addresses_WC_ht+0x1e2c5, %rbx
sub %rdi, %rdi
mov (%rbx), %r10
nop
xor %r14, %r14
lea addresses_D_ht+0x945, %rdx
nop
xor $30924, %r15
mov (%rdx), %r9
nop
