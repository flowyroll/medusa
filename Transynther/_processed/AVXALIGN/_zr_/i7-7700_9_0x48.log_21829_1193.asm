...
nop
dec %r15
lea addresses_normal_ht+0x7f23, %r12
nop
and $32043, %r11
...
nop
cmp %r13, %r13
lea addresses_normal_ht+0x1f51, %r8
nop
cmp $11204, %r9
mov (%r8), %r12w
nop
...
nop
xor $20258, %r8
lea addresses_UC_ht+0x68e7, %rsi
lea addresses_D_ht+0xd971, %rdi
nop
nop
nop
nop
...
nop
dec %r8
lea addresses_WC_ht+0x1b353, %r11
nop
nop
inc %r8
movl $0x61626364, (%r11)
...
nop
and $37976, %rcx
lea addresses_normal_ht+0x10951, %rsi
...
nop
sub $54516, %rdi
lea addresses_D_ht+0x17173, %r11
nop
inc %rdi
movl $0x61626364, (%r11)
nop
...
{'OP': 'LOAD', 'src': {'type': 'addresses_A_ht', 'AVXalign': False, 'congruent': 8, 'size': 4, 'same': True, 'NT': False}}
