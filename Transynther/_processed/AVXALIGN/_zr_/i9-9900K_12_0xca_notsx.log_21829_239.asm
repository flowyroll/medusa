...
nop
lfence
lea addresses_normal_ht+0x14f02, %r11
nop
nop
nop
add $30693, %r9
movb (%r11), %r14b
xor %r9, %r9
lea addresses_normal_ht+0xe4c2, %r9
nop
nop
nop
nop
...
lea addresses_WT_ht+0x1e00f, %rdi
nop
nop
nop
nop
...
nop
inc %r12
lea addresses_A_ht+0x14502, %rbp
nop
nop
nop
inc %rsi
...
nop
sub %r9, %r9
lea addresses_normal_ht+0x6f82, %rbp
nop
nop
nop
and $13503, %rdx
...
nop
add %r11, %r11
lea addresses_UC_ht+0x8182, %rsi
nop
nop
nop
nop
...
nop
add $57101, %r9
lea addresses_WC_ht+0x13f52, %r12
sub %r11, %r11
mov (%r12), %cx
nop
nop
dec %rsi
lea addresses_normal_ht+0x10ae2, %rcx
nop
nop
nop
lfence
...
nop
add $50681, %rsi
lea addresses_UC_ht+0x10e82, %rdi
nop
nop
nop
nop
...
nop
and %rdi, %rdi
lea addresses_UC_ht+0x10202, %rsi
lea addresses_WC_ht+0x3102, %rdi
nop
nop
nop
nop
...
nop
cmp %rdi, %rdi
lea addresses_A_ht+0x14f62, %r11
add $39487, %r12
...
{'OP': 'STOR', 'dst': {'same': False, 'type': 'addresses_NC', 'NT': False, 'AVXalign': False, 'size': 8, 'congruent': 2}}
[Faulty Load]
...
{'OP': 'LOAD', 'src': {'same': True, 'type': 'addresses_normal_ht', 'NT': False, 'AVXalign': False, 'size': 1, 'congruent': 11}}
{'OP': 'STOR', 'dst': {'same': False, 'type': 'addresses_normal_ht', 'NT': False, 'AVXalign': False, 'size': 2, 'congruent': 2}}
{'OP': 'REPM', 'src': {'same': False, 'congruent': 2, 'type': 'addresses_WC_ht'}, 'dst': {'same': False, 'congruent': 0, 'type': 'addresses_WT_ht'}}
...
{'OP': 'LOAD', 'src': {'same': True, 'type': 'addresses_UC_ht', 'NT': False, 'AVXalign': False, 'size': 1, 'congruent': 9}}
{'OP': 'REPM', 'src': {'same': False, 'congruent': 8, 'type': 'addresses_UC_ht'}, 'dst': {'same': False, 'congruent': 8, 'type': 'addresses_WC_ht'}}
