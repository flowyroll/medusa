...
push %rcx
push %rdx
lea addresses_D_ht+0x127f5, %r11
nop
add $26822, %rcx
mov (%r11), %r8w
add $21854, %r15
lea addresses_UC_ht+0x10cf5, %rax
nop
nop
nop
nop
...
movups %xmm3, (%rax)
xor %rcx, %rcx
lea addresses_normal_ht+0x1e6f5, %r15
nop
dec %r11
mov (%r15), %r14d
nop
...
nop
inc %r11
lea addresses_UC_ht+0x192f5, %rax
nop
nop
nop
and $22753, %r8
...
// REPMOV
lea addresses_normal+0xabf5, %rsi
lea addresses_A+0x1351d, %rdi
clflush (%rdi)
add %r12, %r12
mov $52, %rcx
rep movsw
...
{'src': {'type': 'addresses_normal', 'congruent': 7, 'same': False}, 'dst': {'type': 'addresses_A', 'congruent': 2, 'same': False}, 'OP': 'REPM'}
