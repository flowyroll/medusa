...
nop
cmp %r8, %r8
lea addresses_normal_ht+0x11d86, %rsi
lea addresses_D_ht+0x176ae, %rdi
clflush (%rsi)
xor %r13, %r13
mov $14, %rcx
rep movsb
...
nop
cmp %r9, %r9
lea addresses_WT_ht+0x1342e, %r9
nop
nop
nop
cmp $604, %rsi
mov (%r9), %r8
sub %rbp, %rbp
lea addresses_UC_ht+0xbf49, %r9
nop
mfence
movw $0x6162, (%r9)
nop
cmp $33638, %rbp
lea addresses_UC_ht+0x31e1, %rdi
nop
nop
nop
nop
...
nop
xor %rdi, %rdi
lea addresses_WC_ht+0x44ce, %r12
nop
nop
xor %r9, %r9
vmovups (%r12), %ymm4
...
vpextrq $1, %xmm4, %rsi
mfence
lea addresses_WT_ht+0x1aeea, %r13
clflush (%r13)
nop
nop
nop
...
nop
add $57758, %rdi
lea addresses_normal_ht+0x1e0a8, %rsi
...
rep movsl
cmp %rbp, %rbp
lea addresses_WT_ht+0x36a2, %rsi
lea addresses_WC_ht+0xc4ce, %rdi
nop
and %r13, %r13
mov $50, %rcx
rep movsq
nop
and $27205, %rdi
lea addresses_D_ht+0x12c8e, %rsi
lea addresses_WT_ht+0xd002, %rdi
cmp $7716, %r8
mov $34, %rcx
rep movsl
nop
...
nop
inc %rdi
lea addresses_D_ht+0xf1fe, %rsi
lea addresses_A_ht+0x4d04, %rdi
nop
and %r9, %r9
mov $127, %rcx
rep movsq
xor %rbp, %rbp
lea addresses_A_ht+0xbdce, %r8
nop
nop
nop
nop
...
nop
xor $25039, %rdi
lea addresses_D_ht+0x44e, %rsi
lea addresses_WC_ht+0x12cce, %rdi
clflush (%rsi)
clflush (%rdi)
nop
nop
...
{'src': {'type': 'addresses_normal_ht', 'congruent': 3, 'same': False}, 'OP': 'REPM', 'dst': {'type': 'addresses_D_ht', 'congruent': 4, 'same': False}}
...
{'src': {'type': 'addresses_WT_ht', 'congruent': 0, 'same': True}, 'OP': 'REPM', 'dst': {'type': 'addresses_WC_ht', 'congruent': 10, 'same': False}}
{'src': {'type': 'addresses_D_ht', 'congruent': 6, 'same': False}, 'OP': 'REPM', 'dst': {'type': 'addresses_WT_ht', 'congruent': 2, 'same': False}}
...
{'src': {'type': 'addresses_D_ht', 'congruent': 7, 'same': True}, 'OP': 'REPM', 'dst': {'type': 'addresses_WC_ht', 'congruent': 8, 'same': False}}
{'00': 18311}
