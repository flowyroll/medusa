...
push %rdi
push %rsi
lea addresses_normal_ht+0x19bbe, %rdi
nop
add %rbx, %rbx
...
vpextrq $1, %xmm6, %r13
add $22519, %rbp
lea addresses_WT_ht+0x14336, %rsi
lea addresses_UC_ht+0x4f4e, %rdi
nop
and %r10, %r10
mov $90, %rcx
rep movsl
...
lea addresses_normal_ht+0x1ef4e, %rdi
clflush (%rdi)
nop
nop
nop
...
rep movsb
and %rbx, %rbx
lea addresses_WT_ht+0x1f4e, %rsi
nop
nop
nop
dec %r13
...
nop
cmp %rdi, %rdi
lea addresses_WC_ht+0x604e, %rsi
nop
nop
nop
nop
...
{'OP': 'REPM', 'src': {'same': True, 'type': 'addresses_WC_ht', 'congruent': 9}, 'dst': {'same': False, 'type': 'addresses_normal_ht', 'congruent': 10}}
