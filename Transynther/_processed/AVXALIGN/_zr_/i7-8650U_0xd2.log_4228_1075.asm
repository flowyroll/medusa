...
push %rcx
push %rdi
lea addresses_WT_ht+0xbe07, %r10
nop
nop
nop
nop
...
nop
add $30277, %r10
lea addresses_normal_ht+0xac67, %rbp
clflush (%rbp)
nop
nop
nop
...
// Store
lea addresses_A+0x12b91, %rsi
inc %r10
movw $0x5152, (%rsi)
cmp $49952, %r10

// Faulty Load
mov $0x3b453c0000000c67, %rsi
nop
nop
nop
nop
