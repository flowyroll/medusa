...
push %rdx
push %rsi
lea addresses_WC_ht+0x10d96, %rdx
add $56553, %r12
mov $0x6162636465666768, %rcx
movq %rcx, %xmm2
vmovups %ymm2, (%rdx)
mfence
lea addresses_WC_ht+0x4686, %rcx
nop
nop
sub %rbp, %rbp
mov (%rcx), %bx
...
nop
xor $9754, %rdx
lea addresses_A_ht+0x19c96, %rsi
lea addresses_WT_ht+0xef96, %rdi
nop
nop
add %r13, %r13
mov $112, %rcx
rep movsw
sub $3853, %rbp
lea addresses_WT_ht+0x19d94, %r13
nop
nop
nop
nop
...
nop
xor $2875, %rbx
lea addresses_WC_ht+0x14973, %r13
nop
nop
nop
sub %rbp, %rbp
mov (%r13), %ecx
dec %r13
lea addresses_normal_ht+0x1d16, %r12
nop
nop
nop
nop
...
nop
add $41649, %rcx
lea addresses_normal_ht+0x1133a, %rbx
nop
nop
cmp %rdi, %rdi
movw $0x6162, (%rbx)
...
// Load
lea addresses_normal+0xf196, %rax
nop
nop
nop
sub $37919, %r13
...
{'OP': 'STOR', 'dst': {'congruent': 5, 'AVXalign': True, 'same': False, 'size': 32, 'NT': False, 'type': 'addresses_PSE'}}
{'OP': 'STOR', 'dst': {'congruent': 8, 'AVXalign': True, 'same': False, 'size': 16, 'NT': False, 'type': 'addresses_A'}}
...
{'src': {'congruent': 7, 'same': False, 'type': 'addresses_A_ht'}, 'OP': 'REPM', 'dst': {'congruent': 7, 'same': False, 'type': 'addresses_WT_ht'}}
...
{'OP': 'STOR', 'dst': {'congruent': 0, 'AVXalign': False, 'same': False, 'size': 2, 'NT': True, 'type': 'addresses_normal_ht'}}
{'00': 21829}
