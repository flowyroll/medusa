...
push %rdx
push %rsi
lea addresses_WC_ht+0x1c8b0, %r9
nop
nop
sub $50777, %rax
...
nop
sub $63379, %rdx
lea addresses_UC_ht+0x102f0, %rdi
nop
inc %r14
movb $0x61, (%rdi)
nop
...
nop
add %rdi, %rdi
lea addresses_A_ht+0x10b0, %rsi
lea addresses_WT_ht+0x4b30, %rdi
nop
nop
nop
nop
...
nop
cmp %rcx, %rcx
lea addresses_WC_ht+0x7910, %rcx
nop
nop
nop
sub %rsi, %rsi
...
nop
dec %r14
lea addresses_A_ht+0x11150, %rsi
...
nop
cmp $49413, %r14
lea addresses_D_ht+0xea30, %rsi
lea addresses_UC_ht+0x15710, %rdi
nop
nop
nop
nop
...
nop
sub $20587, %rdx
lea addresses_UC_ht+0x15f10, %rbp
nop
nop
nop
add $31423, %rsi
...
// Store
lea addresses_normal+0x1eb44, %r11
nop
nop
dec %rbp
movl $0x51525354, (%r11)
...
{'src': {'type': 'addresses_RW', 'same': False, 'size': 16, 'congruent': 5, 'NT': False, 'AVXalign': False}, 'OP': 'LOAD'}
...
{'src': {'type': 'addresses_A_ht', 'congruent': 6, 'same': True}, 'dst': {'type': 'addresses_normal_ht', 'congruent': 2, 'same': False}, 'OP': 'REPM'}
{'src': {'type': 'addresses_D_ht', 'congruent': 1, 'same': False}, 'dst': {'type': 'addresses_UC_ht', 'congruent': 8, 'same': True}, 'OP': 'REPM'}
