...
nop
and %rbp, %rbp
lea addresses_WT_ht+0x11af9, %r10
nop
nop
nop
dec %r15
...
nop
cmp %rsi, %rsi
lea addresses_WT_ht+0x1bb9, %r13
add $8318, %rsi
movb $0x61, (%r13)
nop
nop
...
nop
sub $1566, %r15
lea addresses_WC_ht+0x1bd79, %r15
nop
nop
nop
nop
...
nop
cmp $65382, %r10
lea addresses_D_ht+0x8499, %rsi
lea addresses_normal_ht+0x172f9, %rdi
nop
nop
nop
sub $3834, %rdx
...
nop
add %r10, %r10
lea addresses_normal_ht+0x7ef9, %rsi
lea addresses_D_ht+0x9331, %rdi
nop
nop
nop
dec %r13
...
{'OP': 'LOAD', 'src': {'type': 'addresses_P', 'size': 2, 'AVXalign': True, 'NT': False, 'congruent': 0, 'same': False}}
