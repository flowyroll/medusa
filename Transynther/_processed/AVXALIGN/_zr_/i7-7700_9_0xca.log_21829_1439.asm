...
push %rdi
push %rsi
lea addresses_D_ht+0x1b5e1, %r12
nop
and %rax, %rax
...
nop
cmp $34657, %r9
lea addresses_normal_ht+0x9859, %rsi
lea addresses_WT_ht+0x4859, %rdi
nop
nop
and %r9, %r9
mov $58, %rcx
...
lea addresses_WC_ht+0x7169, %rdi
nop
nop
nop
nop
...
nop
and %rcx, %rcx
lea addresses_WC_ht+0xc399, %r12
nop
nop
nop
sub %r13, %r13
...
{'src': {'congruent': 7, 'same': False, 'type': 'addresses_normal_ht'}, 'OP': 'REPM', 'dst': {'congruent': 3, 'same': False, 'type': 'addresses_WC_ht'}}
{'src': {'congruent': 3, 'same': False, 'type': 'addresses_D_ht'}, 'OP': 'REPM', 'dst': {'congruent': 11, 'same': False, 'type': 'addresses_normal_ht'}}
