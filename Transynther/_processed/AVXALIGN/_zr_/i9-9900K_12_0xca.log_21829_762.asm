...
push %rdx
push %rsi
lea addresses_D_ht+0x141db, %rbx
nop
nop
nop
nop
...
nop
add %rcx, %rcx
lea addresses_normal_ht+0x171d3, %r13
nop
nop
add %rdi, %rdi
movw $0x6162, (%r13)
...
nop
inc %r13
lea addresses_normal_ht+0x10a5b, %rbx
nop
inc %rdx
mov (%rbx), %r14d
nop
...
nop
add %rdx, %rdx
lea addresses_WC_ht+0x9e5b, %r14
clflush (%r14)
nop
nop
nop
...
nop
and $50353, %r14
lea addresses_UC_ht+0x801b, %r10
nop
nop
nop
nop
...
mov (%r10), %rcx
and %r10, %r10
lea addresses_WT_ht+0x205b, %rsi
lea addresses_D_ht+0x1e85b, %rdi
nop
nop
nop
nop
...
nop
and $10742, %rcx
lea addresses_UC_ht+0x1365b, %rbx
inc %rdx
movups (%rbx), %xmm5
vpextrq $0, %xmm5, %r13
nop
nop
sub $31879, %r10
lea addresses_WT_ht+0x1e3db, %rsi
lea addresses_UC_ht+0x1149b, %rdi
nop
and %rbx, %rbx
mov $71, %rcx
rep movsl
sub $14446, %rdx
lea addresses_D_ht+0x285b, %rdi
nop
nop
sub $38971, %r13
movb $0x61, (%rdi)
nop
xor %rdi, %rdi
lea addresses_UC_ht+0x885b, %rsi
...
{'OP': 'LOAD', 'src': {'size': 4, 'NT': False, 'type': 'addresses_A', 'same': False, 'AVXalign': False, 'congruent': 9}}
[Faulty Load]
...
{'OP': 'STOR', 'dst': {'size': 2, 'NT': False, 'type': 'addresses_normal_ht', 'same': True, 'AVXalign': False, 'congruent': 3}}
...
{'OP': 'REPM', 'src': {'same': False, 'type': 'addresses_UC_ht', 'congruent': 11}, 'dst': {'same': False, 'type': 'addresses_A_ht', 'congruent': 0}}
{'00': 21829}
