...
movl $0x61626364, (%rdx)
xor $51211, %r12
lea addresses_normal_ht+0x1caf1, %rsi
lea addresses_UC_ht+0x5ca1, %rdi
nop
nop
nop
cmp %r11, %r11
...
// Store
lea addresses_normal+0xc81, %rbx
clflush (%rbx)
nop
nop
nop
...
{'src': {'congruent': 3, 'same': False, 'type': 'addresses_normal_ht'}, 'OP': 'REPM', 'dst': {'congruent': 11, 'same': False, 'type': 'addresses_UC_ht'}}
{'00': 21829}
