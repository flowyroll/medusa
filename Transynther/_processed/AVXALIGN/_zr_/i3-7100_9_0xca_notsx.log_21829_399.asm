...
movb $0x61, (%rdi)
cmp %r14, %r14
lea addresses_WC_ht+0x12a77, %r14
clflush (%r14)
and %r9, %r9
...
nop
xor $45871, %rdi
lea addresses_WT_ht+0x17377, %rsi
lea addresses_D_ht+0x10dcf, %rdi
nop
nop
cmp %r9, %r9
mov $86, %rcx
...
nop
xor %r12, %r12
lea addresses_normal_ht+0xac74, %rsi
lea addresses_normal_ht+0x6537, %rdi
nop
nop
nop
nop
...
nop
sub %r10, %r10
lea addresses_WT_ht+0xd017, %r14
nop
nop
cmp %rsi, %rsi
vmovups (%r14), %ymm5
...
// Store
lea addresses_normal+0x6277, %r15
nop
nop
nop
nop
...
[Faulty Load]
{'src': {'same': True, 'congruent': 0, 'NT': True, 'type': 'addresses_NC', 'size': 16, 'AVXalign': True}, 'OP': 'LOAD'}
<gen_prepare_buffer>
{'OP': 'STOR', 'dst': {'same': False, 'congruent': 3, 'NT': False, 'type': 'addresses_A_ht', 'size': 1, 'AVXalign': True}}
...
{'src': {'type': 'addresses_normal_ht', 'congruent': 0, 'same': False}, 'OP': 'REPM', 'dst': {'type': 'addresses_normal_ht', 'congruent': 6, 'same': False}}
