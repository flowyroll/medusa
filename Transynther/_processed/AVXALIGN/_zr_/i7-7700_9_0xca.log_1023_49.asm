...
push %rdi
push %rsi
lea addresses_D_ht+0x18e67, %rsi
lea addresses_D_ht+0x8524, %rdi
clflush (%rdi)
nop
nop
nop
...
// Faulty Load
lea addresses_normal+0xfe24, %r11
cmp $4273, %r13
vmovntdqa (%r11), %ymm1
