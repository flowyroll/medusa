...
push %rdi
push %rsi
lea addresses_A_ht+0x98f9, %rsi
lea addresses_A_ht+0x1c5b9, %rdi
clflush (%rsi)
nop
nop
nop
...
nop
inc %rbp
lea addresses_normal_ht+0x50b9, %r13
nop
nop
and $41812, %r8
movw $0x6162, (%r13)
xor %rdi, %rdi
lea addresses_UC_ht+0x1cff9, %rsi
nop
nop
nop
nop
...
nop
cmp %rsi, %rsi
lea addresses_WC_ht+0x44c9, %rsi
nop
nop
nop
nop
...
nop
and %rbp, %rbp
lea addresses_A_ht+0x14539, %rsi
lea addresses_D_ht+0x48b9, %rdi
sub $9999, %r15
mov $36, %rcx
rep movsw
nop
...
nop
and %r10, %r10
lea addresses_D_ht+0xdb49, %rsi
lea addresses_D_ht+0xe8d, %rdi
nop
nop
nop
xor %r13, %r13
...
nop
xor $18999, %r15
lea addresses_A_ht+0x1ad79, %r10
nop
nop
nop
and %rbp, %rbp
...
nop
xor %rbp, %rbp
lea addresses_WT_ht+0x10e99, %rsi
lea addresses_A_ht+0x5339, %rdi
nop
nop
nop
nop
...
nop
and $10877, %r8
lea addresses_D_ht+0xad39, %rsi
lea addresses_WC_ht+0xdb39, %rdi
nop
nop
nop
nop
...
nop
xor $32756, %rdi
lea addresses_UC_ht+0x18959, %r10
nop
nop
nop
nop
...
nop
cmp %r10, %r10
lea addresses_D_ht+0x13b39, %rsi
lea addresses_UC_ht+0x97b9, %rdi
nop
nop
nop
nop
...
nop
xor $54505, %rdi
lea addresses_WT_ht+0x2b39, %rsi
lea addresses_A_ht+0x1b1b, %rdi
add %r15, %r15
mov $21, %rcx
rep movsq
nop
