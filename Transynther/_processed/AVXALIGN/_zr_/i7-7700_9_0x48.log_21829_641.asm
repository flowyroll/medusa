...
nop
cmp %rsi, %rsi
lea addresses_WT_ht+0xe44d, %rsi
lea addresses_D_ht+0x3c8d, %rdi
clflush (%rsi)
nop
nop
nop
...
nop
sub $12049, %r9
lea addresses_D_ht+0x1e84d, %r13
clflush (%r13)
nop
nop
add %rdi, %rdi
...
movq %rdx, (%r13)
cmp $55677, %rdx
lea addresses_UC_ht+0x344d, %rsi
lea addresses_D_ht+0x148e1, %rdi
nop
nop
and $59920, %rbx
mov $9, %rcx
...
nop
and $63891, %r9
lea addresses_UC_ht+0xa069, %rsi
lea addresses_WC_ht+0xde71, %rdi
nop
nop
nop
sub %r9, %r9
...
nop
add $528, %rbx
lea addresses_WT_ht+0x14b8d, %rsi
lea addresses_WC_ht+0x1b0ad, %rdi
nop
nop
nop
and %rbx, %rbx
...
rep movsq
inc %r8
lea addresses_WT_ht+0x207d, %rsi
lea addresses_D_ht+0x1534d, %rdi
nop
sub $26262, %r13
mov $123, %rcx
rep movsb
nop
and $35603, %rbx
lea addresses_normal_ht+0x1414d, %rdx
nop
sub $22795, %r13
vmovups (%rdx), %ymm2
...
{'OP': 'STOR', 'dst': {'type': 'addresses_D_ht', 'AVXalign': True, 'congruent': 9, 'size': 8, 'same': False, 'NT': False}}
{'OP': 'REPM', 'src': {'type': 'addresses_UC_ht', 'congruent': 11, 'same': False}, 'dst': {'type': 'addresses_D_ht', 'congruent': 1, 'same': False}}
{'OP': 'REPM', 'src': {'type': 'addresses_UC_ht', 'congruent': 0, 'same': False}, 'dst': {'type': 'addresses_WC_ht', 'congruent': 1, 'same': False}}
