...
rep movsl
and $30568, %r13
lea addresses_WT_ht+0xf5fd, %r14
nop
nop
nop
nop
...
movq %r11, (%rdi)
dec %rax
lea addresses_UC_ht+0x1777, %rsi
lea addresses_WT_ht+0x18047, %rdi
nop
nop
nop
nop
...
rep movsb
and %rax, %rax
lea addresses_UC_ht+0x11fb7, %r13
nop
nop
nop
dec %rsi
...
nop
add $62987, %rsi
lea addresses_D_ht+0x89b7, %rdi
sub %rdx, %rdx
movl $0x61626364, (%rdi)
inc %r13
lea addresses_WT_ht+0x93f7, %rsi
nop
nop
nop
nop
...
nop
cmp %rcx, %rcx
lea addresses_UC_ht+0x4717, %r14
sub %rcx, %rcx
movb $0x61, (%r14)
nop
add $24422, %r14
...
{'OP': 'REPM', 'src': {'type': 'addresses_UC_ht', 'congruent': 5, 'same': False}, 'dst': {'type': 'addresses_WT_ht', 'congruent': 2, 'same': False}}
