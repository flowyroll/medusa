...
nop
cmp $53998, %r15
lea addresses_normal_ht+0x8fe7, %rbp
nop
cmp $58467, %rsi
movups (%rbp), %xmm3
vpextrq $1, %xmm3, %rdx
add $13884, %rbp
lea addresses_UC_ht+0x1c67, %rsi
and %rax, %rax
vmovups (%rsi), %ymm6
...
{'OP': 'STOR', 'dst': {'same': False, 'congruent': 7, 'NT': False, 'type': 'addresses_D_ht', 'size': 16, 'AVXalign': True}}
