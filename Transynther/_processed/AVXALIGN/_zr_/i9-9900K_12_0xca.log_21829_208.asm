...
push %rdi
push %rsi
lea addresses_normal_ht+0x7856, %rax
nop
add $48123, %r11
movl $0x61626364, (%rax)
nop
...
nop
and $17372, %rsi
lea addresses_normal_ht+0x596a, %rbx
nop
nop
add %r12, %r12
vmovups (%rbx), %ymm0
...
nop
inc %r11
lea addresses_WT_ht+0x1161a, %rsi
lea addresses_A_ht+0x4fda, %rdi
nop
nop
nop
nop
...
nop
sub $37293, %rcx
lea addresses_A_ht+0x1e5da, %rsi
lea addresses_A_ht+0x7004, %rdi
nop
nop
add $30923, %rax
mov $60, %rcx
...
nop
sub %rsi, %rsi
lea addresses_A_ht+0x1455a, %rbx
nop
nop
nop
nop
...
mov (%rbx), %si
add %rax, %rax
lea addresses_WT_ht+0x1cfda, %r12
nop
nop
nop
nop
...
nop
add $56641, %rsi
lea addresses_normal_ht+0xd692, %rsi
nop
dec %rbx
mov $0x6162636465666768, %r11
movq %r11, (%rsi)
and %rcx, %rcx
lea addresses_UC_ht+0x1dbda, %rsi
nop
nop
nop
inc %r11
...
movq %rcx, (%rsi)
and %rdi, %rdi
lea addresses_WT_ht+0x12483, %rsi
lea addresses_A_ht+0x1e91a, %rdi
clflush (%rdi)
nop
nop
nop
...
nop
add $61880, %r9
lea addresses_normal_ht+0xe3da, %r12
nop
nop
nop
nop
...
nop
cmp %rdi, %rdi
lea addresses_normal_ht+0x1e036, %rdi
clflush (%rdi)
sub %r11, %r11
...
{'OP': 'REPM', 'src': {'same': False, 'type': 'addresses_A_ht', 'congruent': 6}, 'dst': {'same': True, 'type': 'addresses_A_ht', 'congruent': 1}}
{'OP': 'LOAD', 'src': {'size': 2, 'NT': False, 'type': 'addresses_A_ht', 'same': False, 'AVXalign': True, 'congruent': 6}}
