...
push %r9
push %rdx
lea addresses_UC_ht+0x1cf79, %r12
clflush (%r12)
nop
nop
nop
...
nop
cmp %r10, %r10
lea addresses_UC_ht+0x123d9, %rdx
clflush (%rdx)
nop
nop
nop
