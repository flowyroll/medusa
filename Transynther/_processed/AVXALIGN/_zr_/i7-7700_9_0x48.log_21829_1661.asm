...
push %rdi
push %rsi
lea addresses_D_ht+0x12a7c, %rsi
lea addresses_WC_ht+0xf27c, %rdi
clflush (%rdi)
nop
nop
sub $61505, %r14
...
nop
xor $25956, %r14
lea addresses_normal_ht+0x122cc, %r9
nop
nop
and %rbx, %rbx
movups (%r9), %xmm0
