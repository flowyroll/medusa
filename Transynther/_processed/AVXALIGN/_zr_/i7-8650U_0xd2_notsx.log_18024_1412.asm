...
push %rdi
push %rsi
lea addresses_UC_ht+0x134d4, %r12
clflush (%r12)
add $11675, %rsi
movb $0x61, (%r12)
nop
...
nop
cmp %rdi, %rdi
lea addresses_WC_ht+0x9fd4, %r10
nop
xor $62639, %r13
mov (%r10), %r12
nop
...
nop
xor %r13, %r13
lea addresses_UC_ht+0xb694, %rsi
lea addresses_UC_ht+0xeb3c, %rdi
nop
nop
nop
sub $14775, %r12
...
nop
sub %r9, %r9
lea addresses_D_ht+0x127d4, %rsi
clflush (%rsi)
nop
nop
nop
...
nop
inc %rsi
lea addresses_UC_ht+0x1e548, %r9
nop
nop
nop
nop
...
nop
cmp %rsi, %rsi
lea addresses_normal_ht+0xfd4, %rcx
clflush (%rcx)
nop
nop
nop
...
lea addresses_D_ht+0x1dbc4, %rdi
nop
add $34586, %r9
mov $112, %rcx
rep movsq
