...
push %rdx
push %rsi
lea addresses_WT_ht+0xaef1, %rcx
clflush (%rcx)
nop
add $53478, %rbx
movups (%rcx), %xmm5
...
nop
and $36561, %rdx
lea addresses_A_ht+0x1b7e9, %rsi
lea addresses_normal_ht+0x12c09, %rdi
nop
nop
and $3524, %rbp
mov $23, %rcx
...
nop
and $28695, %rcx
lea addresses_normal_ht+0x12f51, %rsi
...
nop
cmp $44362, %rbx
lea addresses_D_ht+0x18bb1, %rdi
nop
nop
dec %rbx
mov (%rdi), %rsi
...
nop
sub $53775, %rcx
lea addresses_D_ht+0x17bb1, %rbx
nop
nop
add $32886, %rcx
movups (%rbx), %xmm5
...
nop
and %rsi, %rsi
lea addresses_WT_ht+0x1e66d, %rbx
nop
and $8444, %rdx
...
nop
sub $14872, %rdx
lea addresses_normal_ht+0x195ce, %rdx
nop
nop
nop
nop
...
nop
add %rbp, %rbp
lea addresses_WT_ht+0x2cb1, %r14
nop
nop
nop
sub $8506, %rsi
...
nop
inc %rbx
lea addresses_D_ht+0x179b1, %rbx
nop
nop
nop
nop
...
{'dst': {'same': False, 'congruent': 3, 'type': 'addresses_normal_ht'}, 'OP': 'REPM', 'src': {'same': False, 'congruent': 3, 'type': 'addresses_A_ht'}}
{'dst': {'same': False, 'congruent': 8, 'type': 'addresses_normal_ht'}, 'OP': 'REPM', 'src': {'same': False, 'congruent': 4, 'type': 'addresses_normal_ht'}}
