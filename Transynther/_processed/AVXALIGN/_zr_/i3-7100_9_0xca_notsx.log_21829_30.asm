...
push %rdx
push %rsi
lea addresses_WT_ht+0x215f, %r15
inc %r9
movw $0x6162, (%r15)
nop
nop
nop
dec %rcx
lea addresses_normal_ht+0xf5e7, %r10
nop
nop
nop
nop
...
lea addresses_normal_ht+0x7a77, %rdi
clflush (%rdi)
nop
nop
sub $60024, %rdx
...
{'OP': 'STOR', 'dst': {'same': False, 'congruent': 5, 'NT': False, 'type': 'addresses_UC', 'size': 1, 'AVXalign': True}}
{'OP': 'STOR', 'dst': {'same': False, 'congruent': 5, 'NT': False, 'type': 'addresses_UC', 'size': 1, 'AVXalign': False}}
{'OP': 'STOR', 'dst': {'same': False, 'congruent': 7, 'NT': False, 'type': 'addresses_P', 'size': 2, 'AVXalign': False}}
...
{'src': {'type': 'addresses_A_ht', 'congruent': 3, 'same': False}, 'OP': 'REPM', 'dst': {'type': 'addresses_normal_ht', 'congruent': 2, 'same': True}}
