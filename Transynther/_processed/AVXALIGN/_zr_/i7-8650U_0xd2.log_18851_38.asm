...
push %rdx
push %rsi
lea addresses_UC_ht+0x19918, %rdx
nop
add %r10, %r10
movl $0x61626364, (%rdx)
nop
...
nop
and %rdi, %rdi
lea addresses_normal_ht+0xb818, %rsi
nop
nop
nop
xor %rbp, %rbp
...
nop
and %r11, %r11
lea addresses_UC_ht+0x11c98, %rsi
lea addresses_WT_ht+0x121b8, %rdi
nop
nop
nop
nop
