...
push %rdi
push %rsi
lea addresses_UC_ht+0x2e9e, %rsi
lea addresses_A_ht+0xf31e, %rdi
cmp %r8, %r8
mov $120, %rcx
rep movsl
cmp $21102, %rcx
lea addresses_D_ht+0x1ecde, %rbx
cmp %r15, %r15
...
nop
cmp $2191, %rcx
lea addresses_WC_ht+0xea1e, %rsi
...
nop
add %rsi, %rsi
lea addresses_normal_ht+0x17f1e, %rcx
nop
add $38620, %r9
movb $0x61, (%rcx)
nop
...
{'OP': 'LOAD', 'src': {'type': 'addresses_US', 'size': 2, 'AVXalign': False, 'NT': False, 'congruent': 2, 'same': False}}
...
<gen_prepare_buffer>
{'OP': 'REPM', 'src': {'type': 'addresses_UC_ht', 'congruent': 6, 'same': False}, 'dst': {'type': 'addresses_A_ht', 'congruent': 11, 'same': True}}
