...
nop
sub $62034, %r10
lea addresses_D_ht+0x1e13f, %r12
cmp %r15, %r15
mov (%r12), %ebp
add $7321, %r11
lea addresses_D_ht+0x537f, %rdx
nop
xor %r15, %r15
mov (%rdx), %bp
nop
nop
and %r15, %r15
lea addresses_normal_ht+0xc33f, %rsi
lea addresses_normal_ht+0x1783f, %rdi
sub $33177, %r11
mov $58, %rcx
rep movsl
nop
...
nop
add $62615, %rcx
lea addresses_UC_ht+0x107ff, %r12
clflush (%r12)
nop
nop
nop
...
mov (%r12), %esi
cmp %rbp, %rbp
lea addresses_UC_ht+0x1a723, %rsi
lea addresses_normal_ht+0x176bf, %rdi
clflush (%rsi)
nop
nop
nop
...
nop
xor %r10, %r10
lea addresses_WT_ht+0x233f, %rsi
lea addresses_D_ht+0x10b3f, %rdi
nop
nop
xor %r12, %r12
mov $19, %rcx
...
{'OP': 'STOR', 'dst': {'NT': True, 'same': False, 'congruent': 3, 'type': 'addresses_UC', 'AVXalign': False, 'size': 32}}
...
<gen_prepare_buffer>
{'src': {'NT': True, 'same': True, 'congruent': 0, 'type': 'addresses_A_ht', 'AVXalign': False, 'size': 1}, 'OP': 'LOAD'}
...
{'src': {'same': False, 'congruent': 2, 'type': 'addresses_UC_ht'}, 'OP': 'REPM', 'dst': {'same': False, 'congruent': 6, 'type': 'addresses_normal_ht'}}
