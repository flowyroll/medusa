...
nop
cmp %r10, %r10
lea addresses_normal_ht+0x73ad, %r14
nop
inc %r13
movw $0x6162, (%r14)
nop
and %rax, %rax
lea addresses_WC_ht+0xe3ed, %rsi
lea addresses_normal_ht+0x39dd, %rdi
nop
nop
nop
nop
...
nop
xor %r14, %r14
lea addresses_WT_ht+0x193d5, %r14
nop
nop
nop
add %rdi, %rdi
...
nop
sub %r11, %r11
lea addresses_UC_ht+0x1369d, %rsi
lea addresses_normal_ht+0xcd35, %rdi
nop
nop
nop
nop
...
nop
dec %rsi
lea addresses_D_ht+0x11f8b, %r11
nop
nop
dec %rsi
movb $0x61, (%r11)
...
nop
sub $51822, %r11
lea addresses_A_ht+0x162ad, %r10
xor $33964, %r14
mov (%r10), %edi
nop
nop
nop
cmp %r14, %r14
lea addresses_WT_ht+0x1170d, %rax
nop
add %rdi, %rdi
movl $0x61626364, (%rax)
nop
...
nop
xor %r10, %r10
lea addresses_A_ht+0x1b7ad, %r11
nop
nop
nop
xor $44267, %rsi
...
{'OP': 'REPM', 'src': {'type': 'addresses_UC_ht', 'congruent': 3, 'same': True}, 'dst': {'type': 'addresses_normal_ht', 'congruent': 3, 'same': False}}
