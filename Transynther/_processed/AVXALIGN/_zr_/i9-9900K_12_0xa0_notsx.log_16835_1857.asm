...
push %rdx
push %rsi
lea addresses_WC_ht+0x1d4b0, %rcx
nop
nop
nop
nop
...
mov (%rcx), %r8
sub $44758, %rcx
lea addresses_D_ht+0x177e8, %r14
clflush (%r14)
nop
nop
nop
...
nop
dec %rdx
lea addresses_A_ht+0x6812, %rsi
lea addresses_normal_ht+0x12382, %rdi
nop
sub $48513, %rax
mov $32, %rcx
rep movsq
xor %r15, %r15
lea addresses_WT_ht+0x10142, %rsi
cmp $58768, %rax
mov (%rsi), %r14w
nop
cmp %r15, %r15
lea addresses_A_ht+0x12982, %rdi
xor $56869, %r14
movb (%rdi), %dl
nop
nop
...
nop
cmp %r8, %r8
lea addresses_WC_ht+0x7682, %rax
nop
add %r8, %r8
movups (%rax), %xmm5
vpextrq $0, %xmm5, %r15
nop
inc %r13
lea addresses_normal_ht+0x10982, %rdi
nop
nop
nop
nop
...
nop
inc %r14
lea addresses_UC_ht+0x14822, %r14
clflush (%r14)
nop
nop
nop
...
{'src': {'type': 'addresses_A_ht', 'congruent': 4, 'same': False}, 'OP': 'REPM', 'dst': {'type': 'addresses_normal_ht', 'congruent': 9, 'same': True}}
...
{'OP': 'STOR', 'dst': {'type': 'addresses_D_ht', 'AVXalign': True, 'size': 2, 'NT': False, 'same': False, 'congruent': 3}}
