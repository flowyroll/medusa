...
push %rdx
push %rsi
lea addresses_WT_ht+0x7547, %r13
nop
nop
nop
nop
...
nop
sub $38095, %rax
lea addresses_WC_ht+0x167f, %rsi
...
nop
cmp $16179, %r12
lea addresses_WC_ht+0x14e97, %rsi
clflush (%rsi)
cmp %rcx, %rcx
...
nop
cmp $48146, %rsi
lea addresses_WC_ht+0x4807, %r12
nop
nop
nop
nop
...
nop
add $15617, %r12
lea addresses_UC_ht+0x14ce7, %rsi
lea addresses_D_ht+0xaec8, %rdi
nop
nop
nop
nop
...
rep movsl
and $13689, %rdi
lea addresses_UC_ht+0x18f07, %rsi
lea addresses_D_ht+0x1e4c7, %rdi
nop
and $45753, %r13
mov $115, %rcx
rep movsw
...
nop
dec %rax
lea addresses_D_ht+0x11007, %r12
nop
nop
xor %rdi, %rdi
...
{'src': {'same': False, 'congruent': 3, 'NT': True, 'type': 'addresses_WC_ht', 'size': 32, 'AVXalign': False}, 'OP': 'LOAD'}
