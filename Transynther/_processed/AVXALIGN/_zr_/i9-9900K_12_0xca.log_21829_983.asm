...
push %rdi
push %rsi
lea addresses_WT_ht+0x1a866, %r9
nop
nop
sub $35682, %rsi
...
nop
and $6947, %r14
lea addresses_UC_ht+0x10866, %rax
nop
nop
xor $10719, %rbp
mov (%rax), %r10d
and %r9, %r9
lea addresses_normal_ht+0xc706, %r14
nop
nop
nop
nop
...
nop
and %r14, %r14
lea addresses_WT_ht+0x2c66, %r14
nop
nop
and %rsi, %rsi
movl $0x61626364, (%r14)
...
nop
add %r9, %r9
lea addresses_normal_ht+0x6a26, %r9
and $12958, %rbp
movups (%r9), %xmm3
vpextrq $0, %xmm3, %rsi
nop
...
nop
sub $19352, %r13
lea addresses_UC_ht+0x265e, %rsi
...
rep movsl
mfence
lea addresses_UC_ht+0x8666, %rsi
lea addresses_D_ht+0x7b66, %rdi
clflush (%rdi)
xor %r10, %r10
mov $66, %rcx
rep movsq
...
nop
xor $29058, %rax
lea addresses_WT_ht+0x14586, %r14
nop
nop
nop
xor %rsi, %rsi
...
nop
inc %rax
lea addresses_WT_ht+0x17c66, %rcx
nop
xor $11120, %r13
mov (%rcx), %r14d
xor $31010, %r13
...
{'OP': 'STOR', 'dst': {'size': 16, 'NT': False, 'type': 'addresses_UC', 'same': False, 'AVXalign': False, 'congruent': 7}}
[Faulty Load]
...
{'OP': 'LOAD', 'src': {'size': 4, 'NT': False, 'type': 'addresses_WT_ht', 'same': False, 'AVXalign': True, 'congruent': 11}}
{'00': 21829}
