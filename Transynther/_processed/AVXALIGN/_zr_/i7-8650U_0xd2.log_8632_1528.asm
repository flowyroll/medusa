...
push %rdi
push %rsi
lea addresses_WT_ht+0xb600, %r13
nop
nop
nop
lfence
...
vmovups %ymm3, (%r13)
sub %rcx, %rcx
lea addresses_WT_ht+0x5928, %rsi
lea addresses_WC_ht+0x19dc8, %rdi
nop
sub $37594, %r8
mov $94, %rcx
rep movsb
...
nop
and $59807, %r14
lea addresses_D_ht+0x151a4, %r13
nop
nop
nop
nop
...
lea addresses_UC_ht+0x1e160, %rdi
clflush (%rsi)
nop
nop
nop
...
nop
add $35212, %rdi
lea addresses_normal_ht+0x9630, %r14
nop
nop
nop
nop
...
nop
cmp $5588, %rdi
lea addresses_WC_ht+0xdb30, %rcx
nop
nop
nop
nop
...
nop
sub $35963, %r14
lea addresses_D_ht+0x11730, %rsi
...
{'OP': 'LOAD', 'src': {'type': 'addresses_D_ht', 'size': 2, 'AVXalign': False, 'NT': False, 'congruent': 5, 'same': True}}
{'00': 8632}
