...
push %rdx
push %rsi
lea addresses_WT_ht+0xc2b0, %rcx
nop
nop
nop
sub %r9, %r9
...
nop
cmp $55825, %rdx
lea addresses_UC_ht+0x15a50, %rdx
nop
nop
nop
and %r10, %r10
...
nop
inc %rdx
lea addresses_UC_ht+0x139b0, %rsi
lea addresses_WT_ht+0x10230, %rdi
sub $32699, %r13
mov $85, %rcx
rep movsb
nop
...
nop
sub $62505, %r12
lea addresses_UC_ht+0xa330, %r10
nop
nop
nop
nop
...
mov (%r10), %r9
mfence
lea addresses_WT_ht+0x12f30, %rsi
lea addresses_WT_ht+0xe930, %rdi
nop
and %r9, %r9
mov $54, %rcx
rep movsl
...
nop
cmp %rcx, %rcx
lea addresses_WC_ht+0x8d00, %rdi
nop
nop
nop
nop
...
nop
add $5940, %r9
lea addresses_UC_ht+0x12f50, %r12
nop
nop
dec %rdi
mov (%r12), %r10w
