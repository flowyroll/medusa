...
push %rdx
push %rsi
lea addresses_normal_ht+0x16387, %rbx
clflush (%rbx)
nop
nop
nop
...
nop
dec %rdx
lea addresses_A_ht+0x17587, %rdi
nop
nop
nop
nop
...
movups %xmm5, (%rdi)
and %rbp, %rbp
lea addresses_WC_ht+0x16587, %rbx
nop
nop
nop
nop
...
nop
inc %r9
lea addresses_normal_ht+0x1a3df, %rsi
lea addresses_normal_ht+0x4907, %rdi
nop
nop
nop
xor %rbp, %rbp
...
nop
add $55723, %rdi
lea addresses_UC_ht+0x9f87, %rdi
nop
inc %r11
...
movups %xmm2, (%rdi)
sub $13901, %rbx
lea addresses_normal_ht+0x18f87, %rdx
nop
nop
nop
dec %rbp
...
nop
add $23349, %rbx
lea addresses_UC_ht+0x6c93, %rbp
nop
nop
sub $4539, %rdi
...
nop
xor %rax, %rax
lea addresses_UC_ht+0x17e87, %rdx
clflush (%rdx)
nop
nop
nop
...
nop
sub %rdi, %rdi
lea addresses_D_ht+0x5387, %rsi
lea addresses_WC_ht+0x12043, %rdi
xor %r9, %r9
mov $13, %rcx
rep movsw
nop
...
{'OP': 'REPM', 'src': {'type': 'addresses_D_ht', 'congruent': 11, 'same': True}, 'dst': {'type': 'addresses_WC_ht', 'congruent': 2, 'same': False}}
{'00': 21829}
