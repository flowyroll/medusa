...
nop
and $44018, %r8
lea addresses_WC_ht+0x16c30, %rbx
clflush (%rbx)
nop
nop
nop
...
nop
and %r8, %r8
lea addresses_WC_ht+0x1dbd0, %rsi
lea addresses_A_ht+0x19730, %rdi
nop
nop
xor $7665, %rdx
mov $97, %rcx
...
nop
xor $35461, %rbx
lea addresses_WC_ht+0x7a4c, %rbx
clflush (%rbx)
nop
nop
nop
...
nop
cmp %rsi, %rsi
lea addresses_UC_ht+0x1a8b0, %r12
nop
and $27293, %rdi
...
nop
cmp $38279, %rcx
lea addresses_normal_ht+0x75fe, %rdi
nop
nop
nop
and %rcx, %rcx
movb $0x61, (%rdi)
xor %rsi, %rsi
lea addresses_D_ht+0x14c30, %rcx
nop
add $39351, %rsi
movups (%rcx), %xmm6
vpextrq $0, %xmm6, %rdi
...
nop
add %rdi, %rdi
lea addresses_D_ht+0xa130, %rsi
lea addresses_A_ht+0x5968, %rdi
clflush (%rdi)
nop
nop
nop
...
nop
cmp %r12, %r12
lea addresses_WC_ht+0x1c7c0, %rcx
nop
nop
nop
nop
...
nop
xor $24570, %rbp
lea addresses_UC_ht+0x12c30, %rcx
nop
nop
nop
nop
...
nop
cmp $56271, %rbp
lea addresses_WT_ht+0x179b0, %rsi
lea addresses_UC_ht+0x17830, %rdi
nop
nop
nop
nop
...
{'src': {'congruent': 2, 'same': False, 'type': 'addresses_WC_ht'}, 'OP': 'REPM', 'dst': {'congruent': 4, 'same': False, 'type': 'addresses_A_ht'}}
...
{'OP': 'STOR', 'dst': {'congruent': 1, 'AVXalign': False, 'same': False, 'size': 1, 'NT': True, 'type': 'addresses_normal_ht'}}
{'src': {'congruent': 11, 'AVXalign': False, 'same': False, 'size': 16, 'NT': False, 'type': 'addresses_D_ht'}, 'OP': 'LOAD'}
{'src': {'congruent': 8, 'same': True, 'type': 'addresses_D_ht'}, 'OP': 'REPM', 'dst': {'congruent': 2, 'same': False, 'type': 'addresses_A_ht'}}
