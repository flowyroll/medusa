...
lea addresses_UC_ht+0x192c9, %rdi
sub %r14, %r14
mov $12, %rcx
rep movsq
nop
nop
xor $41016, %rcx
lea addresses_normal_ht+0x1eac9, %r8
nop
nop
add $58402, %rax
mov (%r8), %si
nop
and $105, %rax
lea addresses_WC_ht+0xd549, %r14
nop
nop
nop
nop
...
mov (%r14), %di
dec %rax
lea addresses_WC_ht+0xc7fd, %rdi
nop
and %rax, %rax
...
{'OP': 'STOR', 'dst': {'same': False, 'type': 'addresses_P', 'NT': True, 'AVXalign': False, 'size': 8, 'congruent': 4}}
{'OP': 'STOR', 'dst': {'same': False, 'type': 'addresses_WC', 'NT': False, 'AVXalign': False, 'size': 16, 'congruent': 4}}
{'OP': 'STOR', 'dst': {'same': False, 'type': 'addresses_P', 'NT': True, 'AVXalign': False, 'size': 2, 'congruent': 4}}
[Faulty Load]
