...
push %rdx
push %rsi
lea addresses_D_ht+0x16c31, %r13
nop
nop
xor %r9, %r9
...
vmovups %ymm5, (%r13)
cmp $28689, %rbx
lea addresses_A_ht+0xc5f1, %rsi
lea addresses_A_ht+0x150d1, %rdi
nop
nop
nop
nop
...
movb $0x61, (%r9)
add $3367, %rbp
lea addresses_UC_ht+0xf431, %rdx
nop
nop
nop
sub $18892, %rsi
...
nop
and %rcx, %rcx
lea addresses_normal_ht+0x4031, %rdx
nop
nop
mfence
movups (%rdx), %xmm7
...
nop
sub $8482, %rdi
lea addresses_WC_ht+0x133a7, %rsi
lea addresses_normal_ht+0xfb81, %rdi
clflush (%rsi)
nop
nop
nop
...
nop
xor %rdx, %rdx
lea addresses_normal_ht+0x16731, %rsi
lea addresses_A_ht+0x4431, %rdi
and %r13, %r13
mov $121, %rcx
rep movsq
nop
nop
sub $63464, %rdi
lea addresses_UC_ht+0x18c61, %rdi
nop
nop
nop
nop
...
nop
inc %rdx
lea addresses_WT_ht+0xcc31, %rdi
nop
add %rcx, %rcx
mov (%rdi), %r9
nop
...
{'OP': 'REPM', 'src': {'same': False, 'type': 'addresses_A_ht', 'congruent': 6}, 'dst': {'same': False, 'type': 'addresses_A_ht', 'congruent': 5}}
...
{'OP': 'LOAD', 'src': {'size': 8, 'NT': False, 'type': 'addresses_WT_ht', 'same': False, 'AVXalign': True, 'congruent': 11}}
{'00': 21829}
