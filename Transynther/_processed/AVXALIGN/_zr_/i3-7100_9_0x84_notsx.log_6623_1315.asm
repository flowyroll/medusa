...
push %rdi
push %rsi
lea addresses_normal_ht+0x17724, %rcx
inc %r12
...
nop
inc %r10
lea addresses_UC_ht+0x8aa4, %rsi
...
nop
sub %rdi, %rdi
lea addresses_A_ht+0x1b124, %rsi
nop
nop
nop
add %rdi, %rdi
...
nop
add $59645, %r10
lea addresses_WT_ht+0x16324, %rsi
...
rep movsl
xor %r14, %r14
lea addresses_WT_ht+0x2324, %rcx
nop
and %r12, %r12
movb (%rcx), %r10b
nop
nop
xor %r15, %r15
lea addresses_normal_ht+0x10ad4, %r15
clflush (%r15)
nop
nop
nop
...
nop
and %rdi, %rdi
lea addresses_normal_ht+0x1d2e4, %r14
nop
nop
nop
nop
...
nop
inc %rsi
lea addresses_WC_ht+0x4598, %rcx
nop
nop
nop
nop
...
mov (%rcx), %rsi
inc %r10
lea addresses_WC_ht+0x12b24, %rsi
nop
nop
nop
inc %rcx
...
nop
inc %rcx
lea addresses_UC_ht+0x176dc, %r14
nop
nop
add %rsi, %rsi
movl $0x61626364, (%r14)
nop
xor %r15, %r15
lea addresses_A_ht+0x15324, %rsi
lea addresses_WT_ht+0x1d5a4, %rdi
nop
nop
nop
nop
...
nop
sub $18038, %r11
lea addresses_WC_ht+0xa124, %r10
nop
sub $11050, %r12
movups (%r10), %xmm1
vpextrq $1, %xmm1, %rdi
...
{'src': {'type': 'addresses_UC_ht', 'congruent': 6, 'same': False}, 'dst': {'type': 'addresses_normal_ht', 'congruent': 4, 'same': False}, 'OP': 'REPM'}
{'src': {'type': 'addresses_A_ht', 'same': False, 'size': 4, 'congruent': 9, 'NT': False, 'AVXalign': True}, 'OP': 'LOAD'}
...
{'src': {'type': 'addresses_A_ht', 'congruent': 9, 'same': False}, 'dst': {'type': 'addresses_WT_ht', 'congruent': 7, 'same': False}, 'OP': 'REPM'}
