...
push %rdi
push %rsi
lea addresses_WT_ht+0x2728, %rdi
nop
add %rbp, %rbp
movw $0x6162, (%rdi)
dec %rsi
lea addresses_UC_ht+0x1a028, %r8
clflush (%r8)
nop
nop
nop
...
nop
xor %rsi, %rsi
lea addresses_WC_ht+0xaa28, %rbp
clflush (%rbp)
nop
nop
nop
...
nop
cmp $59901, %rcx
lea addresses_WT_ht+0x16e28, %rsi
xor %r9, %r9
mov (%rsi), %rbp
nop
nop
...
nop
xor %r8, %r8
lea addresses_UC_ht+0xa3d0, %rax
nop
nop
add %rsi, %rsi
movw $0x6162, (%rax)
add %rbp, %rbp
lea addresses_WT_ht+0x15464, %r9
nop
nop
sub %rax, %rax
movl $0x61626364, (%r9)
...
nop
cmp $596, %rcx
lea addresses_WT_ht+0x1d228, %rbp
clflush (%rbp)
cmp %rcx, %rcx
movb (%rbp), %r8b
nop
...
// Store
lea addresses_normal+0xfb28, %rbp
nop
nop
nop
nop
...
{'OP': 'STOR', 'dst': {'size': 2, 'NT': False, 'type': 'addresses_UC', 'same': False, 'AVXalign': False, 'congruent': 10}}
