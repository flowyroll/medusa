...
nop
xor $26330, %r12
lea addresses_normal_ht+0x4cdf, %r9
nop
nop
sub $20514, %r14
mov (%r9), %r10
sub %r10, %r10
lea addresses_WC_ht+0x62df, %r9
nop
nop
nop
xor %rdx, %rdx
...
nop
xor $34794, %r10
lea addresses_A_ht+0x10c5f, %r12
nop
nop
nop
xor %rcx, %rcx
...
vmovups %ymm6, (%r12)
sub $55220, %rcx
lea addresses_WT_ht+0x123e7, %rsi
lea addresses_normal_ht+0x18361, %rdi
nop
nop
nop
nop
...
nop
inc %rdx
lea addresses_WC_ht+0x257f, %rcx
and %rdi, %rdi
...
nop
inc %rcx
lea addresses_normal_ht+0xd0df, %r9
clflush (%r9)
nop
cmp $62006, %r14
...
[Faulty Load]
{'OP': 'LOAD', 'src': {'size': 2, 'NT': True, 'type': 'addresses_UC', 'same': True, 'AVXalign': True, 'congruent': 0}}
<gen_prepare_buffer>
