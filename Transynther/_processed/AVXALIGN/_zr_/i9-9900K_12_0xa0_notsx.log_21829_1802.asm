...
nop
and $47253, %r11
lea addresses_D_ht+0x1d8f8, %rdx
nop
nop
nop
nop
...
movl $0x61626364, (%rdx)
inc %r8
lea addresses_WT_ht+0x1131a, %rcx
nop
nop
nop
nop
...
// Load
lea addresses_normal+0x1a742, %rax
nop
inc %r13
mov (%rax), %r10
nop
...
{'src': {'type': 'addresses_normal', 'AVXalign': False, 'size': 8, 'NT': False, 'same': False, 'congruent': 3}, 'OP': 'LOAD'}
{'OP': 'STOR', 'dst': {'type': 'addresses_WC', 'AVXalign': False, 'size': 2, 'NT': False, 'same': False, 'congruent': 5}}
{'OP': 'STOR', 'dst': {'type': 'addresses_P', 'AVXalign': False, 'size': 32, 'NT': False, 'same': False, 'congruent': 3}}
[Faulty Load]
