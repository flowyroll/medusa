...
push %rdx
push %rsi
lea addresses_WT_ht+0xfbdc, %rbp
nop
nop
sub $51388, %rbx
...
nop
dec %rbx
lea addresses_WT_ht+0x5fd4, %r14
nop
and $39915, %rdx
mov (%r14), %r12w
nop
nop
sub $25007, %rbx
lea addresses_normal_ht+0x1badc, %rbx
nop
sub $21704, %rax
mov (%rbx), %rdx
nop
...
nop
dec %rbx
lea addresses_A_ht+0x1a1dc, %rbx
nop
nop
nop
nop
...
nop
sub $40366, %r12
lea addresses_WC_ht+0x193dc, %r14
nop
nop
nop
nop
...
nop
add %rbp, %rbp
lea addresses_UC_ht+0x10b5c, %rbx
clflush (%rbx)
nop
nop
nop
...
nop
xor %rbx, %rbx
lea addresses_WT_ht+0x251c, %rsi
lea addresses_WC_ht+0x12fdc, %rdi
clflush (%rsi)
nop
nop
dec %r14
...
nop
inc %rdi
lea addresses_WT_ht+0xdbc5, %rcx
nop
nop
nop
xor %rax, %rax
...
nop
add $63415, %rcx
lea addresses_WC_ht+0x765c, %rax
nop
xor $35898, %rbx
movw $0x6162, (%rax)
nop
...
nop
sub %rbx, %rbx
lea addresses_WT_ht+0x11dc, %rsi
nop
nop
nop
dec %r14
...
nop
inc %rbp
lea addresses_normal_ht+0x1c9dc, %rsi
lea addresses_UC_ht+0x12ffc, %rdi
nop
sub %rdx, %rdx
mov $89, %rcx
rep movsq
nop
sub $26609, %rsi
lea addresses_WT_ht+0x33dc, %rsi
lea addresses_normal_ht+0x33dc, %rdi
nop
nop
nop
nop
...
nop
xor %r12, %r12
lea addresses_A_ht+0x15c36, %rdx
clflush (%rdx)
nop
nop
cmp %rcx, %rcx
...
{'OP': 'REPM', 'src': {'type': 'addresses_normal_ht', 'congruent': 7, 'same': False}, 'dst': {'type': 'addresses_UC_ht', 'congruent': 3, 'same': True}}
