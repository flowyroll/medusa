...
push %rdx
push %rsi
lea addresses_A_ht+0x10946, %rdx
nop
nop
cmp %rax, %rax
movl $0x61626364, (%rdx)
...
nop
sub %rax, %rax
lea addresses_UC_ht+0x17c46, %rsi
nop
nop
nop
nop
...
nop
sub %r14, %r14
lea addresses_normal_ht+0xe46, %r13
nop
nop
nop
and $53276, %rbx
...
nop
and %rbx, %rbx
lea addresses_normal_ht+0xdd6b, %rsi
...
rep movsq
xor %r14, %r14
lea addresses_WT_ht+0x7f46, %rcx
clflush (%rcx)
nop
nop
nop
