...
nop
xor %rdx, %rdx
lea addresses_WC_ht+0x18c6b, %rbp
nop
nop
nop
dec %rsi
...
nop
and %rsi, %rsi
lea addresses_UC_ht+0xa1b3, %rsi
nop
cmp %r9, %r9
...
movups %xmm4, (%rsi)
add %rbp, %rbp
lea addresses_WC_ht+0x1b2e0, %r13
nop
nop
mfence
...
nop
dec %r15
lea addresses_UC_ht+0x170b3, %rsi
lea addresses_WT_ht+0x1c9b3, %rdi
xor %r9, %r9
mov $17, %rcx
rep movsw
cmp %rdi, %rdi
lea addresses_WT_ht+0x8ab3, %rsi
lea addresses_normal_ht+0x1b143, %rdi
clflush (%rsi)
nop
sub $43343, %r13
mov $62, %rcx
...
nop
add $16379, %rcx
lea addresses_A_ht+0x31b3, %rsi
lea addresses_WC_ht+0x1d8b3, %rdi
nop
nop
nop
nop
...
// Faulty Load
lea addresses_normal+0x89b3, %r12
nop
cmp %rsi, %rsi
movaps (%r12), %xmm5
vpextrq $0, %xmm5, %r10
...
{'OP': 'REPM', 'src': {'type': 'addresses_UC_ht', 'congruent': 8, 'same': False}, 'dst': {'type': 'addresses_WT_ht', 'congruent': 11, 'same': True}}
