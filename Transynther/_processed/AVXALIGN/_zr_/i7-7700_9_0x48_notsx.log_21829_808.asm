...
nop
add $8795, %rdx
lea addresses_D_ht+0x19b39, %rbx
nop
and $50743, %r12
movups (%rbx), %xmm2
vpextrq $1, %xmm2, %rdi
...
nop
inc %rdx
lea addresses_A_ht+0x138d6, %r12
nop
nop
nop
nop
...
nop
cmp $46804, %rbx
lea addresses_UC_ht+0x1ba56, %rax
clflush (%rax)
nop
lfence
movb (%rax), %bl
...
// Load
lea addresses_normal+0x154d6, %r9
nop
nop
nop
and $16303, %rdi
...
{'OP': 'LOAD', 'src': {'same': False, 'NT': False, 'AVXalign': False, 'size': 16, 'type': 'addresses_normal', 'congruent': 10}}
[Faulty Load]
