...
push %rcx
push %rdi
lea addresses_WT_ht+0xaa97, %r10
nop
nop
nop
and %r12, %r12
...
nop
sub $27950, %rbx
lea addresses_WT_ht+0xb488, %rdi
nop
nop
nop
nop
...
nop
and %rdi, %rdi
lea addresses_D_ht+0x14d17, %rbp
and %rcx, %rcx
...
// Store
lea addresses_normal+0xe6ef, %r9
nop
and %r12, %r12
movb $0x51, (%r9)
nop
...
{'dst': {'type': 'addresses_D_ht', 'same': True, 'size': 32, 'congruent': 10, 'NT': True, 'AVXalign': False}, 'OP': 'STOR'}
