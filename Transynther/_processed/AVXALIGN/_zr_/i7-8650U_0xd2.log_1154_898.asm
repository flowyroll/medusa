...
push %rdi
push %rsi
lea addresses_WT_ht+0x4c7c, %rsi
lea addresses_A_ht+0x2f3e, %rdi
nop
nop
nop
nop
...
nop
sub %r14, %r14
lea addresses_normal_ht+0xf0e4, %r13
add $43501, %r14
movb $0x61, (%r13)
nop
nop
