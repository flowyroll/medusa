...
push %rdx
push %rsi
lea addresses_WT_ht+0x153e0, %r14
cmp %rdi, %rdi
movb (%r14), %r13b
nop
nop
xor $16856, %rdx
lea addresses_A_ht+0x13b0f, %rsi
lea addresses_normal_ht+0x7200, %rdi
nop
nop
nop
nop
...
nop
sub %rcx, %rcx
lea addresses_UC_ht+0x2e5b, %rcx
nop
nop
dec %r14
...
{'OP': 'STOR', 'dst': {'type': 'addresses_UC_ht', 'AVXalign': False, 'congruent': 0, 'size': 32, 'same': True, 'NT': False}}
{'OP': 'STOR', 'dst': {'type': 'addresses_A_ht', 'AVXalign': True, 'congruent': 2, 'size': 8, 'same': False, 'NT': False}}
{'OP': 'LOAD', 'src': {'type': 'addresses_A_ht', 'AVXalign': True, 'congruent': 10, 'size': 8, 'same': False, 'NT': False}}
{'OP': 'STOR', 'dst': {'type': 'addresses_A_ht', 'AVXalign': True, 'congruent': 6, 'size': 32, 'same': False, 'NT': True}}
{'00': 21829}
