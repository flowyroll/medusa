...
nop
sub $29922, %r8
lea addresses_normal_ht+0x18cdf, %r8
nop
nop
nop
nop
...
nop
xor $62682, %r8
lea addresses_A_ht+0x199ff, %rsi
lea addresses_WT_ht+0x138ff, %rdi
clflush (%rdi)
nop
cmp $17136, %r9
mov $74, %rcx
...
nop
xor %r8, %r8
lea addresses_normal_ht+0x1901f, %rdi
sub $7033, %r8
movl $0x61626364, (%rdi)
nop
nop
and $9210, %rdi
lea addresses_UC_ht+0x114df, %rdi
nop
nop
nop
cmp $13712, %r8
...
nop
cmp $41947, %r14
lea addresses_WC_ht+0x181df, %r9
nop
xor $59373, %r14
...
nop
add %r8, %r8
lea addresses_WC_ht+0x1e1ff, %rsi
lea addresses_WT_ht+0x1b55f, %rdi
nop
nop
nop
nop
...
nop
add %r9, %r9
lea addresses_UC_ht+0xf5df, %rcx
nop
nop
nop
nop
...
mov (%rcx), %r8
and %r14, %r14
lea addresses_normal_ht+0x31df, %rsi
lea addresses_normal_ht+0x1486f, %rdi
nop
cmp $3717, %r8
mov $119, %rcx
rep movsb
...
nop
inc %rcx
lea addresses_A_ht+0x151df, %rsi
lea addresses_WC_ht+0xbd, %rdi
nop
nop
sub $46863, %rax
mov $37, %rcx
...
{'OP': 'STOR', 'dst': {'type': 'addresses_D', 'size': 4, 'AVXalign': True, 'NT': False, 'congruent': 0, 'same': False}}
...
{'OP': 'LOAD', 'src': {'type': 'addresses_D_ht', 'size': 1, 'AVXalign': False, 'NT': True, 'congruent': 3, 'same': False}}
...
{'OP': 'REPM', 'src': {'type': 'addresses_normal_ht', 'congruent': 10, 'same': False}, 'dst': {'type': 'addresses_normal_ht', 'congruent': 3, 'same': False}}
