...
push %rdx
push %rsi
lea addresses_UC_ht+0x3a29, %r14
xor $44392, %r11
movups (%r14), %xmm1
vpextrq $1, %xmm1, %rsi
nop
...
lea addresses_UC_ht+0x17981, %rdi
nop
nop
sub %r11, %r11
mov $56, %rcx
...
nop
and $17708, %rsi
lea addresses_WT_ht+0x19169, %r11
nop
sub %rax, %rax
...
nop
xor %rdi, %rdi
lea addresses_WC_ht+0x2c25, %rcx
nop
nop
sub %rax, %rax
vmovups (%rcx), %ymm4
...
movq %r11, (%rdx)
cmp $44341, %rdx
lea addresses_UC_ht+0x1a2d5, %rsi
...
nop
xor %rdx, %rdx
lea addresses_A_ht+0x10509, %rsi
...
nop
inc %rcx
lea addresses_A_ht+0x14869, %r11
nop
nop
and %rcx, %rcx
...
vmovups %ymm4, (%r11)
and $33967, %rax
lea addresses_normal_ht+0x10b69, %rsi
lea addresses_UC_ht+0x1bb69, %rdi
nop
nop
nop
nop
...
// Store
lea addresses_normal+0x16169, %rsi
and $14995, %r15
movw $0x5152, (%rsi)
nop
nop
...
{'OP': 'REPM', 'src': {'type': 'addresses_UC_ht', 'congruent': 2, 'same': False}, 'dst': {'type': 'addresses_UC_ht', 'congruent': 10, 'same': True}}
