...
push %rdi
push %rsi
lea addresses_WT_ht+0x1dec8, %rsi
lea addresses_normal_ht+0x16340, %rdi
nop
and $33064, %r12
mov $70, %rcx
rep movsw
...
nop
mfence
lea addresses_WC_ht+0x17bc8, %r12
inc %r9
movups (%r12), %xmm7
vpextrq $1, %xmm7, %rcx
nop
...
nop
dec %rcx
lea addresses_D_ht+0x1a4c8, %rsi
dec %rbx
...
nop
add $38506, %rdi
lea addresses_WC_ht+0x1bac8, %r10
nop
nop
cmp $20914, %r9
mov (%r10), %si
