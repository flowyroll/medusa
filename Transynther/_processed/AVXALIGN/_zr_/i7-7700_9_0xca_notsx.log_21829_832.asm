...
push %rdi
push %rsi
lea addresses_normal_ht+0xdea0, %rsi
lea addresses_WC_ht+0x5ce, %rdi
nop
nop
nop
nop
...
rep movsl
cmp $5082, %r14
lea addresses_WC_ht+0x12687, %rsi
nop
nop
nop
nop
...
vpextrq $1, %xmm2, %rbp
and $3544, %rdi
lea addresses_WC_ht+0x17aa0, %r10
and $58332, %rsi
mov (%r10), %rcx
nop
nop
...
nop
xor %rbp, %rbp
lea addresses_normal_ht+0x1da84, %rsi
cmp $48944, %r13
vmovups (%rsi), %ymm6
...
// REPMOV
lea addresses_US+0x6ca0, %rsi
lea addresses_US+0x7528, %rdi
nop
nop
nop
dec %r8
...
{'src': {'congruent': 8, 'same': False, 'type': 'addresses_US'}, 'dst': {'congruent': 1, 'same': False, 'type': 'addresses_US'}, 'OP': 'REPM'}
...
{'src': {'NT': True, 'AVXalign': False, 'size': 8, 'congruent': 10, 'same': False, 'type': 'addresses_WC_ht'}, 'OP': 'LOAD'}
