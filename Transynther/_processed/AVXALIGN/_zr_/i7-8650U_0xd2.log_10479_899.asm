...
push %rdi
push %rsi
lea addresses_UC_ht+0x19041, %rcx
nop
nop
nop
add %rax, %rax
...
nop
cmp $39062, %r15
lea addresses_A_ht+0x1b4a1, %r15
nop
nop
add $12360, %r8
...
nop
sub $1120, %r8
lea addresses_normal_ht+0x1d0f, %r13
nop
sub $25440, %r11
movb $0x61, (%r13)
nop
...
nop
cmp %rdi, %rdi
lea addresses_A_ht+0x11ca1, %rdi
add %r13, %r13
...
nop
cmp %r8, %r8
lea addresses_A_ht+0x65e1, %rsi
lea addresses_A_ht+0x25a1, %rdi
nop
nop
nop
add $40065, %r13
...
nop
cmp %rax, %rax
lea addresses_UC_ht+0x8ad7, %rcx
nop
nop
nop
nop
...
nop
cmp $55185, %r13
lea addresses_normal_ht+0x152a1, %rdi
nop
nop
xor %r11, %r11
...
nop
xor $7095, %rcx
lea addresses_D_ht+0x136a1, %r13
nop
nop
nop
nop
...
<gen_prepare_buffer>
{'OP': 'LOAD', 'src': {'type': 'addresses_UC_ht', 'size': 1, 'AVXalign': False, 'NT': True, 'congruent': 3, 'same': False}}
...
{'OP': 'REPM', 'src': {'type': 'addresses_A_ht', 'congruent': 5, 'same': False}, 'dst': {'type': 'addresses_A_ht', 'congruent': 7, 'same': False}}
