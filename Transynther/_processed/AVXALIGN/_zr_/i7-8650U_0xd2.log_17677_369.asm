...
push %rdi
push %rsi
lea addresses_UC_ht+0xd2f0, %rsi
lea addresses_WT_ht+0xdef0, %rdi
nop
nop
nop
nop
...
nop
add %r12, %r12
lea addresses_WT_ht+0x1a684, %r12
nop
nop
nop
nop
...
nop
and %rdi, %rdi
lea addresses_WC_ht+0x17720, %rsi
lea addresses_WC_ht+0x12bf0, %rdi
inc %rbp
mov $67, %rcx
rep movsw
nop
...
nop
add %rax, %rax
lea addresses_normal_ht+0x14b66, %rdi
nop
nop
dec %rcx
movl $0x61626364, (%rdi)
...
nop
add %rax, %rax
lea addresses_normal_ht+0x85b0, %r12
nop
nop
nop
nop
...
nop
and $37457, %rsi
lea addresses_normal_ht+0x17ef0, %r15
clflush (%r15)
and $24736, %r12
movb (%r15), %cl
nop
...
nop
add %rsi, %rsi
lea addresses_D_ht+0x18db0, %r15
nop
nop
nop
cmp $6016, %rdi
...
nop
xor $7161, %r15
lea addresses_D_ht+0xaef0, %rsi
lea addresses_normal_ht+0x4f5c, %rdi
nop
nop
nop
nop
...
nop
add %rax, %rax
lea addresses_WT_ht+0x1a6f0, %rsi
nop
nop
nop
dec %r15
...
// Store
lea addresses_normal+0xe130, %rcx
nop
nop
nop
nop
...
{'OP': 'STOR', 'dst': {'type': 'addresses_normal_ht', 'size': 4, 'AVXalign': False, 'NT': True, 'congruent': 1, 'same': False}}
