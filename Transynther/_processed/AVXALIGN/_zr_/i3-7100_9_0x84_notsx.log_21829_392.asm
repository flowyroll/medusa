...
push %rdi
push %rsi
lea addresses_WT_ht+0x1cfd7, %rbp
nop
nop
cmp $12615, %rsi
movl $0x61626364, (%rbp)
...
nop
cmp %r10, %r10
lea addresses_D_ht+0x18d97, %r14
nop
xor %r12, %r12
...
nop
cmp $48056, %r12
lea addresses_WT_ht+0x11c69, %rsi
lea addresses_D_ht+0x1e197, %rdi
cmp %r8, %r8
mov $62, %rcx
rep movsl
nop
...
nop
add %rbp, %rbp
lea addresses_D_ht+0x16997, %rcx
xor %r8, %r8
mov (%rcx), %r14
inc %rsi
lea addresses_UC_ht+0x8417, %r12
nop
nop
nop
and %r14, %r14
mov (%r12), %esi
cmp $46860, %r10
lea addresses_WT_ht+0x18507, %rsi
lea addresses_normal_ht+0x1bab7, %rdi
cmp $48246, %r8
mov $86, %rcx
rep movsb
xor %rsi, %rsi
lea addresses_normal_ht+0xe797, %r14
clflush (%r14)
nop
and %rdi, %rdi
vmovups (%r14), %ymm4
...
nop
and $52857, %rbp
lea addresses_normal_ht+0x17997, %rsi
lea addresses_D_ht+0x4bff, %rdi
nop
nop
sub %rbp, %rbp
mov $110, %rcx
...
nop
dec %r8
lea addresses_WC_ht+0x5317, %rsi
lea addresses_WT_ht+0xf197, %rdi
nop
nop
nop
nop
...
nop
xor %r12, %r12
lea addresses_UC_ht+0x7ef7, %r14
nop
xor $63348, %rcx
mov $0x6162636465666768, %rdi
movq %rdi, (%r14)
cmp %rdi, %rdi
lea addresses_WC_ht+0x1bc31, %r8
nop
nop
nop
nop
...
{'src': {'type': 'addresses_WT_ht', 'congruent': 0, 'same': False}, 'dst': {'type': 'addresses_D_ht', 'congruent': 10, 'same': False}, 'OP': 'REPM'}
...
{'src': {'type': 'addresses_UC_ht', 'same': True, 'size': 4, 'congruent': 4, 'NT': True, 'AVXalign': False}, 'OP': 'LOAD'}
...
{'src': {'type': 'addresses_normal_ht', 'congruent': 9, 'same': True}, 'dst': {'type': 'addresses_D_ht', 'congruent': 3, 'same': False}, 'OP': 'REPM'}
