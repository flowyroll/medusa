...
push %rdx
push %rsi
lea addresses_WC_ht+0xb820, %r11
nop
nop
nop
nop
...
nop
cmp $15750, %r13
lea addresses_UC_ht+0x15872, %rsi
lea addresses_D_ht+0x2486, %rdi
nop
sub $43089, %r8
mov $121, %rcx
rep movsl
dec %r8
lea addresses_WT_ht+0x7cde, %r11
nop
nop
nop
nop
...
nop
add %rsi, %rsi
lea addresses_WC_ht+0x195b6, %rsi
lea addresses_D_ht+0x3c92, %rdi
nop
nop
nop
nop
...
nop
cmp %r13, %r13
lea addresses_WC_ht+0x193a6, %rsi
nop
add $21047, %r15
vmovups (%rsi), %ymm0
...
nop
xor $22355, %r13
lea addresses_D_ht+0x17e62, %r11
nop
and $48394, %rsi
vmovups (%r11), %ymm4
...
vpextrq $1, %xmm4, %rcx
add $41227, %rdi
lea addresses_A_ht+0x7d96, %rsi
lea addresses_A_ht+0x4796, %rdi
nop
nop
nop
cmp %r15, %r15
...
nop
and %r13, %r13
lea addresses_normal_ht+0x171ce, %r15
nop
nop
add %rcx, %rcx
mov (%r15), %r8
