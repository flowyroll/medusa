...
push %rdx
push %rsi
lea addresses_normal_ht+0x1d841, %r9
clflush (%r9)
nop
nop
nop
...
nop
dec %rdx
lea addresses_WT_ht+0x1eb61, %rsi
lea addresses_UC_ht+0xd61, %rdi
nop
and %rbx, %rbx
mov $85, %rcx
rep movsq
nop
add %rdi, %rdi
lea addresses_WT_ht+0x128f1, %rsi
nop
nop
nop
xor $45184, %rdi
...
nop
inc %rcx
lea addresses_normal_ht+0x13941, %rbx
clflush (%rbx)
nop
nop
nop
...
nop
and $49829, %rdi
lea addresses_WC_ht+0x1d31, %rdi
nop
nop
nop
nop
...
nop
cmp %rsi, %rsi
lea addresses_normal_ht+0x8fb9, %rsi
lea addresses_UC_ht+0x146e9, %rdi
nop
sub %rdx, %rdx
mov $84, %rcx
rep movsl
...
nop
cmp %r15, %r15
lea addresses_WT_ht+0xe381, %rdi
nop
nop
nop
xor $62028, %r9
...
// Store
lea addresses_normal+0x4141, %r11
nop
add %r15, %r15
...
{'OP': 'STOR', 'dst': {'type': 'addresses_normal', 'size': 16, 'AVXalign': True, 'NT': False, 'congruent': 5, 'same': False}}
[Faulty Load]
