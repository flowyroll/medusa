...
push %rdi
push %rsi
lea addresses_A_ht+0x1b30d, %rdi
lfence
...
nop
add %rcx, %rcx
lea addresses_WC_ht+0x19dad, %r14
nop
inc %r8
mov (%r14), %edi
nop
...
[Faulty Load]
{'src': {'NT': True, 'same': True, 'congruent': 0, 'type': 'addresses_UC', 'AVXalign': False, 'size': 2}, 'OP': 'LOAD'}
<gen_prepare_buffer>
