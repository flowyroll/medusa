...
push %rdx
push %rsi
lea addresses_WC_ht+0x405c, %r12
nop
and $55752, %rbp
movl $0x61626364, (%r12)
nop
...
nop
xor $46610, %r13
lea addresses_UC_ht+0x6834, %rsi
lea addresses_A_ht+0x59f4, %rdi
cmp %rdx, %rdx
mov $66, %rcx
rep movsb
nop
nop
sub %rcx, %rcx
lea addresses_A_ht+0x125f4, %rax
add %rsi, %rsi
mov $0x6162636465666768, %rbp
movq %rbp, %xmm3
movups %xmm3, (%rax)
add %r13, %r13
lea addresses_D_ht+0x19034, %rdx
nop
nop
nop
nop
...
nop
cmp %rsi, %rsi
lea addresses_WC_ht+0x18c34, %rcx
nop
nop
nop
and %rbp, %rbp
...
nop
xor $58876, %rsi
lea addresses_A_ht+0x1489c, %rdx
cmp %r12, %r12
mov (%rdx), %ecx
nop
nop
...
nop
xor $30644, %rdi
lea addresses_D_ht+0x1c034, %rdi
nop
nop
nop
nop
...
nop
xor $701, %rax
lea addresses_WT_ht+0x1b7a4, %rdi
nop
xor $8947, %r12
movb (%rdi), %r13b
nop
...
nop
add $49352, %rdx
lea addresses_D_ht+0x160f4, %rbp
dec %rdi
movl $0x61626364, (%rbp)
and $43725, %r13
lea addresses_WT_ht+0xd247, %r13
nop
nop
nop
xor $17386, %rdx
...
nop
inc %rcx
lea addresses_D_ht+0x18034, %r13
nop
nop
cmp %rdx, %rdx
...
{'OP': 'LOAD', 'src': {'same': False, 'type': 'addresses_UC', 'NT': False, 'AVXalign': False, 'size': 32, 'congruent': 7}}
[Faulty Load]
...
{'OP': 'REPM', 'src': {'same': False, 'congruent': 10, 'type': 'addresses_UC_ht'}, 'dst': {'same': False, 'congruent': 6, 'type': 'addresses_A_ht'}}
...
{'OP': 'STOR', 'dst': {'same': False, 'type': 'addresses_A_ht', 'NT': True, 'AVXalign': False, 'size': 4, 'congruent': 5}}
{'00': 21829}
