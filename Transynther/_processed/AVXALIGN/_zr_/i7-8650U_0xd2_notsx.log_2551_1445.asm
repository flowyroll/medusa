...
push %rdi
push %rsi
lea addresses_normal_ht+0x1c72a, %rbx
nop
sub $14451, %r15
movl $0x61626364, (%rbx)
nop
...
nop
sub $54090, %rdi
lea addresses_WT_ht+0xcf7e, %r14
nop
nop
inc %r13
movb (%r14), %r11b
...
nop
xor %r13, %r13
lea addresses_normal_ht+0x22ca, %rsi
...
nop
add %rcx, %rcx
lea addresses_UC_ht+0x12c9a, %r14
nop
nop
nop
nop
...
nop
xor %rax, %rax
lea addresses_WT_ht+0x1c9ca, %rsi
lea addresses_WC_ht+0x80ca, %rdi
nop
nop
nop
add %r14, %r14
...
nop
sub %rcx, %rcx
lea addresses_A_ht+0x1cc02, %rsi
clflush (%rsi)
nop
xor %r13, %r13
movb (%rsi), %cl
sub $56990, %rax
lea addresses_D_ht+0x33aa, %rsi
lea addresses_D_ht+0xd3ca, %rdi
nop
add $5450, %rax
mov $95, %rcx
rep movsw
...
nop
cmp $64079, %rdi
lea addresses_UC_ht+0x19aca, %r11
nop
nop
add %rcx, %rcx
movw $0x6162, (%r11)
nop
sub %rsi, %rsi
lea addresses_normal_ht+0x172ca, %rax
nop
nop
add %rdi, %rdi
...
vpextrq $0, %xmm6, %rcx
cmp $61754, %r15
lea addresses_WC_ht+0x1fca, %rbx
nop
nop
nop
nop
...
nop
cmp %r14, %r14
lea addresses_UC_ht+0x132ca, %rsi
lea addresses_A_ht+0x19cb6, %rdi
add $38746, %r15
mov $67, %rcx
rep movsl
nop
and %rdi, %rdi
lea addresses_WC_ht+0xaada, %rax
nop
xor $31634, %r11
movb $0x61, (%rax)
nop
inc %rbx
lea addresses_A_ht+0x15aca, %rsi
lea addresses_normal_ht+0x13f3b, %rdi
nop
nop
nop
nop
...
[Faulty Load]
{'OP': 'LOAD', 'src': {'type': 'addresses_US', 'size': 1, 'AVXalign': True, 'NT': True, 'congruent': 0, 'same': True}}
<gen_prepare_buffer>
...
{'OP': 'STOR', 'dst': {'type': 'addresses_WC_ht', 'size': 1, 'AVXalign': True, 'NT': False, 'congruent': 4, 'same': False}}
