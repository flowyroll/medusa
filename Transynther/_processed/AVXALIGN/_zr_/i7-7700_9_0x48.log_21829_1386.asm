...
push %rdi
push %rsi
lea addresses_UC_ht+0x821b, %r13
nop
nop
nop
xor %r10, %r10
...
nop
sub $38500, %rbx
lea addresses_UC_ht+0x6037, %rbx
add %r14, %r14
...
nop
add %r13, %r13
lea addresses_WC_ht+0x5337, %rsi
lea addresses_normal_ht+0x82b7, %rdi
sub $17453, %r8
mov $52, %rcx
rep movsl
nop
nop
sub $52338, %r8
lea addresses_WT_ht+0x114bf, %r14
add $57422, %r13
...
nop
sub %r13, %r13
lea addresses_UC_ht+0xaeb7, %r14
nop
nop
nop
nop
