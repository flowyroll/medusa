...
push %rdx
push %rsi
lea addresses_A_ht+0x1111e, %r14
nop
nop
and %rbp, %rbp
movb (%r14), %dl
...
nop
sub $39686, %r13
lea addresses_normal_ht+0x15617, %r9
nop
nop
nop
nop
...
nop
sub %rcx, %rcx
lea addresses_normal_ht+0x1ef8f, %r14
nop
and %r9, %r9
movw $0x6162, (%r14)
nop
...
nop
cmp %r9, %r9
lea addresses_normal_ht+0x1df07, %rsi
lea addresses_UC_ht+0x7403, %rdi
nop
nop
nop
dec %rbp
...
nop
sub %rbp, %rbp
lea addresses_WT_ht+0x110cf, %rsi
lea addresses_UC_ht+0xd44f, %rdi
nop
sub %r9, %r9
mov $98, %rcx
rep movsq
...
nop
xor $39571, %rcx
lea addresses_normal_ht+0xdfd, %rsi
lea addresses_WC_ht+0x5f7f, %rdi
nop
nop
inc %r13
mov $30, %rcx
...
nop
mfence
lea addresses_UC_ht+0x764f, %rdi
nop
nop
dec %r9
...
nop
and %rcx, %rcx
lea addresses_WC_ht+0x4e4f, %rsi
lea addresses_D_ht+0x12b5f, %rdi
nop
nop
xor %rdx, %rdx
mov $100, %rcx
...
nop
and %rdx, %rdx
lea addresses_UC_ht+0x12e4f, %rdx
nop
nop
nop
dec %r14
...
nop
and %rdi, %rdi
lea addresses_WT_ht+0xd16d, %rsi
lea addresses_D_ht+0x15f4f, %rdi
nop
sub %r14, %r14
mov $49, %rcx
rep movsq
nop
add %rcx, %rcx
lea addresses_WT_ht+0x4d77, %rsi
...
rep movsq
cmp %rdi, %rdi
lea addresses_D_ht+0xc64f, %rsi
lea addresses_UC_ht+0xdbf1, %rdi
nop
nop
nop
nop
...
{'OP': 'STOR', 'dst': {'type': 'addresses_UC_ht', 'AVXalign': True, 'congruent': 9, 'size': 32, 'same': False, 'NT': False}}
...
{'OP': 'REPM', 'src': {'type': 'addresses_D_ht', 'congruent': 9, 'same': False}, 'dst': {'type': 'addresses_UC_ht', 'congruent': 1, 'same': True}}
{'00': 21829}
