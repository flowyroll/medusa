...
push %rdx
push %rsi
lea addresses_D_ht+0x115c0, %rdx
nop
nop
nop
nop
...
nop
xor %r10, %r10
lea addresses_D_ht+0x1d0f0, %r10
nop
nop
nop
cmp $56564, %r15
...
movq %r8, (%r10)
and $35894, %r9
lea addresses_D_ht+0x19cf0, %rsi
lea addresses_WC_ht+0x19ef0, %rdi
nop
nop
nop
nop
...
movw $0x6162, (%rdi)
sub $49214, %rbx
lea addresses_WT_ht+0x3894, %rbx
nop
sub %rdi, %rdi
...
{'src': {'congruent': 2, 'AVXalign': True, 'same': True, 'size': 32, 'NT': False, 'type': 'addresses_WT_ht'}, 'OP': 'LOAD'}
{'00': 21829}
