...
nop
add $3346, %r10
lea addresses_A_ht+0x1ac30, %rcx
nop
nop
nop
and %r11, %r11
...
nop
inc %r10
lea addresses_UC_ht+0x15f70, %r14
add %r10, %r10
...
nop
add %rax, %rax
lea addresses_A_ht+0x36e1, %rsi
lea addresses_A_ht+0x9d70, %rdi
clflush (%rsi)
nop
and $41834, %r14
mov $59, %rcx
...
nop
sub %r13, %r13
lea addresses_WC_ht+0x6e30, %r11
nop
xor $44482, %rsi
mov $0x6162636465666768, %rax
movq %rax, %xmm0
...
nop
add %rcx, %rcx
lea addresses_normal_ht+0x13970, %rsi
lea addresses_normal_ht+0xe330, %rdi
nop
nop
nop
nop
...
lea addresses_WC_ht+0xac00, %rdi
nop
nop
nop
nop
...
nop
cmp $48038, %r10
lea addresses_WC_ht+0x4370, %rsi
lea addresses_D_ht+0x1af70, %rdi
cmp $63679, %rdx
mov $24, %rcx
rep movsl
nop
xor $34075, %r10
lea addresses_UC_ht+0x18a30, %rdi
nop
add %r14, %r14
movl $0x61626364, (%rdi)
nop
