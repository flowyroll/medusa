...
nop
xor $34115, %r11
lea addresses_WT_ht+0xab15, %r11
nop
nop
sub %rdx, %rdx
movw $0x6162, (%r11)
...
nop
add %r9, %r9
lea addresses_WC_ht+0x17015, %rax
clflush (%rax)
nop
nop
nop
...
nop
and %r11, %r11
lea addresses_normal_ht+0x10515, %r9
nop
dec %r11
...
nop
sub $54701, %r9
lea addresses_normal_ht+0x10cd5, %r14
add $64404, %rdx
movb $0x61, (%r14)
nop
and %r14, %r14
...
{'OP': 'STOR', 'dst': {'NT': False, 'same': True, 'congruent': 5, 'type': 'addresses_WC_ht', 'AVXalign': True, 'size': 32}}
