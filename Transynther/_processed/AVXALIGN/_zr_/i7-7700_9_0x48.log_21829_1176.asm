...
nop
cmp $49766, %rsi
lea addresses_normal_ht+0x16d53, %rsi
nop
dec %r8
movb (%rsi), %al
nop
...
nop
cmp %rbp, %rbp
lea addresses_WC_ht+0x17653, %r12
and %rdx, %rdx
...
nop
add $9301, %r8
lea addresses_A_ht+0x18f73, %rsi
lea addresses_D_ht+0xd53, %rdi
nop
nop
lfence
mov $41, %rcx
...
nop
and $31593, %rax
lea addresses_A_ht+0xd613, %rsi
lea addresses_normal_ht+0x13c3, %rdi
nop
nop
inc %r12
mov $56, %rcx
...
nop
and $26100, %r15
lea addresses_normal_ht+0x12117, %rcx
nop
nop
nop
nop
...
nop
inc %rdx
lea addresses_UC_ht+0x10dc3, %r12
nop
nop
sub %rbp, %rbp
vmovups (%r12), %ymm4
...
vpextrq $0, %xmm4, %rdi
sub %rbp, %rbp
lea addresses_normal_ht+0x9053, %rbp
cmp $4146, %r8
mov (%rbp), %rcx
sub %r8, %r8
lea addresses_D_ht+0x1bf63, %rax
clflush (%rax)
nop
nop
nop
...
nop
sub $18963, %r12
lea addresses_WT_ht+0x52b3, %rbp
nop
and $14061, %r12
mov (%rbp), %r8w
nop
inc %rdi
lea addresses_D_ht+0x1d1b, %r12
nop
and $53630, %rdx
movups (%r12), %xmm4
vpextrq $1, %xmm4, %r8
...
// REPMOV
mov $0x2db4800000000553, %rsi
lea addresses_D+0x19c47, %rdi
nop
nop
sub %rax, %rax
mov $3, %rcx
...
{'OP': 'REPM', 'src': {'type': 'addresses_NC', 'congruent': 11, 'same': False}, 'dst': {'type': 'addresses_D', 'congruent': 2, 'same': False}}
[Faulty Load]
...
{'OP': 'STOR', 'dst': {'type': 'addresses_normal_ht', 'AVXalign': False, 'congruent': 2, 'size': 4, 'same': False, 'NT': True}}
