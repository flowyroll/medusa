...
nop
inc %rdx
lea addresses_UC_ht+0x1e6d1, %r8
nop
nop
inc %r10
movb $0x61, (%r8)
...
nop
mfence
lea addresses_UC_ht+0xf9e7, %rdi
nop
dec %rbx
mov (%rdi), %r13w
add $41204, %rbx
lea addresses_UC_ht+0x1884f, %rsi
lea addresses_WT_ht+0x6b01, %rdi
clflush (%rsi)
nop
nop
nop
...
{'OP': 'STOR', 'dst': {'type': 'addresses_D_ht', 'size': 2, 'AVXalign': True, 'NT': False, 'congruent': 3, 'same': True}}
