...
push %rdi
push %rsi
lea addresses_WT_ht+0x173d2, %rdi
nop
nop
nop
xor $7980, %rcx
...
nop
cmp $7803, %rdi
lea addresses_WC_ht+0xd016, %rsi
nop
nop
nop
nop
...
nop
xor %rdi, %rdi
lea addresses_WC_ht+0x17e9e, %rsi
nop
cmp %r15, %r15
mov (%rsi), %r11d
xor $44492, %rcx
lea addresses_WC_ht+0x132c2, %rsi
lea addresses_D_ht+0x2b9e, %rdi
nop
cmp $14717, %r11
mov $24, %rcx
rep movsq
...
nop
inc %rdi
lea addresses_WT_ht+0x13b9e, %r15
nop
nop
mfence
mov $0x6162636465666768, %r11
...
nop
dec %rdi
lea addresses_UC_ht+0x99e, %rsi
lea addresses_A_ht+0xd39e, %rdi
clflush (%rdi)
nop
nop
sub %rbx, %rbx
...
lea addresses_WT_ht+0x1865e, %rdi
nop
lfence
mov $47, %rcx
rep movsb
...
// Store
lea addresses_normal+0x47ee, %r13
nop
nop
nop
and %r9, %r9
...
// Store
lea addresses_normal+0x1179e, %rax
nop
sub $48742, %r13
movb $0x51, (%rax)
nop
...
{'OP': 'LOAD', 'src': {'type': 'addresses_UC', 'size': 4, 'AVXalign': False, 'NT': True, 'congruent': 0, 'same': True}}
{'OP': 'LOAD', 'src': {'type': 'addresses_WC', 'size': 16, 'AVXalign': False, 'NT': False, 'congruent': 3, 'same': False}}
{'OP': 'STOR', 'dst': {'type': 'addresses_normal', 'size': 32, 'AVXalign': True, 'NT': False, 'congruent': 2, 'same': False}}
...
{'OP': 'REPM', 'src': {'type': 'addresses_UC_ht', 'congruent': 10, 'same': False}, 'dst': {'type': 'addresses_A_ht', 'congruent': 9, 'same': True}}
