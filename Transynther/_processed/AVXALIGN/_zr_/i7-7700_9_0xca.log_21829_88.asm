...
nop
inc %rax
lea addresses_normal_ht+0x1bae2, %rbx
nop
nop
nop
nop
...
nop
sub $544, %rbx
lea addresses_D_ht+0x7dd2, %rsi
lea addresses_A_ht+0x1fe2, %rdi
nop
nop
nop
nop
...
nop
add $34131, %rax
lea addresses_A_ht+0x45e2, %rsi
lea addresses_WT_ht+0x1fe2, %rdi
nop
nop
nop
nop
...
nop
dec %r8
lea addresses_WC_ht+0x1cfe2, %rax
nop
nop
nop
sub $51660, %r10
...
nop
cmp %rdi, %rdi
lea addresses_WC_ht+0xe7d2, %rsi
lea addresses_A_ht+0x97e2, %rdi
nop
and $53478, %r10
mov $62, %rcx
rep movsw
...
// Store
lea addresses_normal+0x17f9a, %r8
nop
cmp $30869, %r11
...
{'src': {'congruent': 4, 'same': False, 'type': 'addresses_WC_ht'}, 'OP': 'REPM', 'dst': {'congruent': 10, 'same': False, 'type': 'addresses_A_ht'}}
{'00': 21829}
