...
push %rdi
push %rsi
lea addresses_normal_ht+0x41fd, %rsi
lea addresses_UC_ht+0x19c58, %rdi
clflush (%rsi)
xor %r11, %r11
mov $20, %rcx
rep movsw
...
nop
xor $37279, %r12
lea addresses_normal_ht+0x3a6f, %rbx
and %r10, %r10
movw $0x6162, (%rbx)
sub $48992, %r12
lea addresses_D_ht+0x1337d, %rsi
lea addresses_normal_ht+0x19a5d, %rdi
nop
nop
nop
sub $24830, %r9
...
nop
sub %rdi, %rdi
lea addresses_WC_ht+0xa06d, %rcx
and %r9, %r9
movb $0x61, (%rcx)
and %rsi, %rsi
lea addresses_UC_ht+0x557d, %rsi
nop
dec %r9
...
nop
sub %rsi, %rsi
lea addresses_WC_ht+0xc1f9, %rbx
nop
add %rdi, %rdi
...
nop
and $14843, %rcx
lea addresses_WC_ht+0x1b17d, %rcx
nop
dec %r9
...
{'dst': {'same': False, 'NT': True, 'AVXalign': True, 'size': 2, 'type': 'addresses_normal_ht', 'congruent': 1}, 'OP': 'STOR'}
{'dst': {'same': False, 'congruent': 5, 'type': 'addresses_normal_ht'}, 'OP': 'REPM', 'src': {'same': False, 'congruent': 10, 'type': 'addresses_D_ht'}}
