...
nop
dec %rsi
lea addresses_UC_ht+0x5bd1, %r12
nop
nop
nop
sub %r13, %r13
...
nop
xor %rsi, %rsi
lea addresses_normal_ht+0x776d, %rcx
and %rdx, %rdx
mov (%rcx), %r12d
lfence
lea addresses_WC_ht+0x8849, %rcx
nop
nop
xor %r13, %r13
mov (%rcx), %r12d
xor %rsi, %rsi
lea addresses_normal_ht+0x1d88d, %rsi
lea addresses_normal_ht+0x18ac5, %rdi
nop
nop
nop
sub $850, %r13
...
nop
add $11202, %r10
lea addresses_WT_ht+0x1c245, %rsi
nop
nop
cmp %r15, %r15
movb (%rsi), %cl
...
nop
add %rcx, %rcx
lea addresses_A_ht+0x1876d, %r15
nop
nop
cmp $64616, %rsi
vmovups (%r15), %ymm0
...
nop
and $33608, %r15
lea addresses_WT_ht+0x12a9d, %rsi
lea addresses_D_ht+0xd63f, %rdi
nop
nop
nop
and $4650, %rdx
...
// Faulty Load
lea addresses_normal+0x876d, %rdx
nop
nop
nop
nop
...
{'src': {'same': False, 'congruent': 1, 'NT': True, 'type': 'addresses_D', 'size': 8, 'AVXalign': False}, 'OP': 'LOAD'}
[Faulty Load]
{'src': {'same': True, 'congruent': 0, 'NT': False, 'type': 'addresses_normal', 'size': 32, 'AVXalign': True}, 'OP': 'LOAD'}
<gen_prepare_buffer>
{'src': {'same': True, 'congruent': 2, 'NT': False, 'type': 'addresses_WT_ht', 'size': 1, 'AVXalign': True}, 'OP': 'LOAD'}
...
{'src': {'type': 'addresses_normal_ht', 'congruent': 5, 'same': False}, 'OP': 'REPM', 'dst': {'type': 'addresses_normal_ht', 'congruent': 3, 'same': True}}
{'src': {'same': True, 'congruent': 3, 'NT': False, 'type': 'addresses_WT_ht', 'size': 1, 'AVXalign': False}, 'OP': 'LOAD'}
