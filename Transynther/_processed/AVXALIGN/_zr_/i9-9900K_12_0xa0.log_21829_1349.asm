...
push %rdx
push %rsi
lea addresses_WC_ht+0x53ec, %rdx
nop
nop
nop
nop
...
nop
dec %r14
lea addresses_WC_ht+0xc73a, %rsi
lea addresses_A_ht+0x446c, %rdi
clflush (%rsi)
nop
add %r9, %r9
mov $75, %rcx
...
movb $0x61, (%rdx)
and $23821, %r9
lea addresses_WC_ht+0x189d4, %rdx
nop
nop
nop
nop
...
nop
dec %r15
lea addresses_WT_ht+0xfe6c, %rsi
lea addresses_WT_ht+0x18cec, %rdi
nop
inc %r9
mov $23, %rcx
rep movsq
...
nop
xor %rdx, %rdx
lea addresses_normal_ht+0x5c2c, %rdx
nop
nop
nop
nop
...
{'OP': 'STOR', 'dst': {'NT': False, 'same': True, 'congruent': 6, 'type': 'addresses_D_ht', 'AVXalign': True, 'size': 1}}
{'src': {'NT': False, 'same': False, 'congruent': 3, 'type': 'addresses_WC_ht', 'AVXalign': False, 'size': 32}, 'OP': 'LOAD'}
{'src': {'same': False, 'congruent': 6, 'type': 'addresses_WT_ht'}, 'OP': 'REPM', 'dst': {'same': False, 'congruent': 4, 'type': 'addresses_WT_ht'}}
