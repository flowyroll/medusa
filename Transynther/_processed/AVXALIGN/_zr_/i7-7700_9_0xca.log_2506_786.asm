...
vpextrq $0, %xmm0, %rbx
and %r8, %r8
lea addresses_WT_ht+0x3290, %rsi
...
nop
add $6658, %rdi
lea addresses_UC_ht+0xf570, %rcx
nop
lfence
...
nop
xor $61164, %rbx
lea addresses_D_ht+0x1be9, %r10
and %rdi, %rdi
mov $0x6162636465666768, %rbx
movq %rbx, (%r10)
nop
inc %rdx
lea addresses_WT_ht+0xfa90, %rsi
lea addresses_A_ht+0xba90, %rdi
nop
nop
nop
and %r10, %r10
...
nop
add %r10, %r10
lea addresses_normal_ht+0x1dc6, %rdx
nop
nop
nop
nop
...
mov (%rdx), %r8d
cmp %rdx, %rdx
lea addresses_WC_ht+0x5cec, %rsi
lea addresses_WT_ht+0xabd0, %rdi
nop
nop
nop
nop
...
{'OP': 'STOR', 'dst': {'congruent': 6, 'AVXalign': False, 'same': False, 'size': 8, 'NT': False, 'type': 'addresses_WC'}}
...
{'src': {'congruent': 11, 'same': False, 'type': 'addresses_WT_ht'}, 'OP': 'REPM', 'dst': {'congruent': 11, 'same': False, 'type': 'addresses_A_ht'}}
