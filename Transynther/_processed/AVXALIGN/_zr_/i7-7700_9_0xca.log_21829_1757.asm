...
push %rdx
push %rsi
lea addresses_A_ht+0x16e3b, %rsi
nop
nop
nop
nop
...
nop
xor $53029, %r10
lea addresses_normal_ht+0x643b, %rsi
nop
nop
nop
xor %r11, %r11
...
nop
sub %rsi, %rsi
lea addresses_UC_ht+0x1833b, %r15
nop
nop
nop
cmp $43832, %rcx
...
nop
sub $50840, %r11
lea addresses_D_ht+0x122e3, %rcx
and %r15, %r15
movups (%rcx), %xmm7
vpextrq $1, %xmm7, %rdx
nop
xor %rax, %rax
lea addresses_A_ht+0x1525b, %r11
dec %rdx
mov (%r11), %eax
nop
sub %r10, %r10
lea addresses_WT_ht+0xc843, %r10
nop
cmp %rcx, %rcx
mov (%r10), %edx
nop
...
[Faulty Load]
{'src': {'congruent': 0, 'AVXalign': True, 'same': True, 'size': 1, 'NT': True, 'type': 'addresses_UC'}, 'OP': 'LOAD'}
<gen_prepare_buffer>
...
{'OP': 'STOR', 'dst': {'congruent': 1, 'AVXalign': False, 'same': True, 'size': 1, 'NT': False, 'type': 'addresses_D_ht'}}
...
{'src': {'congruent': 4, 'AVXalign': True, 'same': False, 'size': 4, 'NT': False, 'type': 'addresses_A_ht'}, 'OP': 'LOAD'}
