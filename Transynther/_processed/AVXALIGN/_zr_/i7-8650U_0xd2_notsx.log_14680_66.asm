...
push %rdx
push %rsi
lea addresses_normal_ht+0x1383e, %r8
mfence
movups (%r8), %xmm4
vpextrq $0, %xmm4, %r15
nop
...
nop
and %r8, %r8
lea addresses_WT_ht+0x94be, %r15
nop
nop
xor $47530, %rax
vmovups (%r15), %ymm1
...
nop
xor $11742, %rax
lea addresses_normal_ht+0x73e, %r11
clflush (%r11)
nop
dec %r9
...
nop
xor %rax, %rax
lea addresses_A_ht+0x1a5be, %r15
nop
sub %rcx, %rcx
movl $0x61626364, (%r15)
nop
...
nop
cmp $45744, %r11
lea addresses_WC_ht+0x11a54, %r15
nop
nop
inc %r11
movb (%r15), %r8b
...
nop
add $34612, %r9
lea addresses_WC_ht+0x98be, %rcx
nop
nop
nop
nop
...
nop
cmp $49070, %rdx
lea addresses_UC_ht+0x5790, %rax
nop
nop
nop
nop
...
nop
add %r8, %r8
lea addresses_WC_ht+0x16539, %rsi
lea addresses_D_ht+0x138ae, %rdi
nop
nop
cmp %rdx, %rdx
mov $5, %rcx
...
nop
add $12682, %r8
lea addresses_D_ht+0xe6f3, %rsi
lea addresses_D_ht+0x50a6, %rdi
dec %rax
mov $119, %rcx
rep movsq
sub $44957, %rax
lea addresses_WC_ht+0x119e, %r8
clflush (%r8)
nop
nop
nop
