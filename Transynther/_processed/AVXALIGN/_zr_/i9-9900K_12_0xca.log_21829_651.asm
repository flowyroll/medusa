...
push %rdx
push %rsi
lea addresses_normal_ht+0xad7f, %rbx
nop
nop
nop
nop
...
nop
sub $22658, %rbp
lea addresses_WT_ht+0xc77f, %rbp
clflush (%rbp)
nop
cmp %rdx, %rdx
movups (%rbp), %xmm1
...
nop
xor $10513, %r14
lea addresses_D_ht+0xa283, %r10
nop
cmp %r12, %r12
movw $0x6162, (%r10)
nop
xor $43046, %r12
lea addresses_WC_ht+0xdf7f, %r10
clflush (%r10)
add %r12, %r12
...
nop
sub %r10, %r10
lea addresses_UC_ht+0x15ef1, %r12
nop
and %rcx, %rcx
mov (%r12), %r14d
xor %r14, %r14
lea addresses_D_ht+0xf8, %rdx
nop
nop
nop
nop
...
nop
add $34648, %rbp
lea addresses_normal_ht+0x10149, %r10
add %r14, %r14
vmovups (%r10), %ymm7
vextracti128 $1, %ymm7, %xmm7
vpextrq $0, %xmm7, %r12
dec %rbp
lea addresses_WC_ht+0x85c3, %rsi
lea addresses_normal_ht+0x933f, %rdi
nop
nop
sub $16093, %rdx
mov $13, %rcx
...
{'OP': 'STOR', 'dst': {'size': 2, 'NT': True, 'type': 'addresses_D_ht', 'same': False, 'AVXalign': False, 'congruent': 2}}
