...
nop
add $6097, %r13
lea addresses_WC_ht+0xcec6, %rdi
nop
nop
nop
nop
...
nop
sub $17559, %r8
lea addresses_UC_ht+0x1c565, %r13
sub $1154, %rdx
movb (%r13), %r8b
nop
nop
...
lea addresses_normal_ht+0x12ea5, %rdi
and %rdx, %rdx
mov $93, %rcx
rep movsl
and %r12, %r12
lea addresses_normal_ht+0x10ea5, %rsi
nop
nop
sub $15741, %r10
movl $0x61626364, (%rsi)
...
nop
dec %rsi
lea addresses_normal_ht+0xf2a5, %r8
nop
nop
and %rdi, %rdi
movb (%r8), %r10b
...
nop
sub %r13, %r13
lea addresses_WC_ht+0xc2a5, %r12
nop
nop
nop
nop
