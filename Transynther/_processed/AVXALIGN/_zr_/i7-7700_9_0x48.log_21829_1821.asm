...
nop
xor %rsi, %rsi
lea addresses_normal_ht+0x1d3a6, %r13
nop
nop
mfence
...
vmovups %ymm1, (%r13)
sub $22650, %r11
lea addresses_UC_ht+0x8f46, %rsi
lea addresses_A_ht+0x12be6, %rdi
clflush (%rdi)
add %r8, %r8
mov $23, %rcx
rep movsb
...
lea addresses_D_ht+0x15706, %rdi
nop
xor %r10, %r10
mov $83, %rcx
rep movsl
...
nop
xor $27709, %rdi
lea addresses_D_ht+0x15c27, %rsi
lea addresses_WC_ht+0xc834, %rdi
clflush (%rdi)
nop
nop
nop
...
rep movsw
add $55048, %rcx
lea addresses_UC_ht+0x1efdb, %rsi
nop
nop
add %rdi, %rdi
movb (%rsi), %r10b
add %r10, %r10
lea addresses_normal_ht+0x18286, %rsi
lea addresses_WT_ht+0x149e6, %rdi
clflush (%rsi)
nop
dec %r11
mov $94, %rcx
...
nop
xor %r13, %r13
lea addresses_normal_ht+0xb1a6, %r8
nop
nop
nop
nop
...
nop
add $30204, %r10
lea addresses_normal_ht+0xc986, %r15
nop
nop
nop
nop
...
<gen_prepare_buffer>
{'OP': 'REPM', 'src': {'type': 'addresses_WC_ht', 'congruent': 7, 'same': True}, 'dst': {'type': 'addresses_WT_ht', 'congruent': 0, 'same': False}}
