...
push %rdx
push %rsi
lea addresses_WC_ht+0x15fdd, %rbp
nop
nop
nop
nop
...
nop
inc %r13
lea addresses_WT_ht+0xaead, %rbx
nop
add $64993, %rdx
movb $0x61, (%rbx)
nop
...
nop
dec %rbp
lea addresses_WC_ht+0xe6ad, %rsi
lea addresses_normal_ht+0x12aad, %rdi
clflush (%rsi)
nop
and %r15, %r15
mov $86, %rcx
...
nop
cmp $40120, %rbp
lea addresses_WT_ht+0x82ad, %rsi
lea addresses_WT_ht+0xb723, %rdi
nop
nop
nop
nop
...
nop
inc %rdx
lea addresses_UC_ht+0x12d2d, %rbp
cmp $12765, %rcx
movb $0x61, (%rbp)
xor $38709, %r12
lea addresses_normal_ht+0xbdf5, %rsi
lea addresses_WT_ht+0x1e2ad, %rdi
nop
nop
xor $22306, %r14
mov $89, %rcx
...
nop
cmp %rbx, %rbx
lea addresses_normal_ht+0x1352d, %rsi
lea addresses_normal_ht+0x40ad, %rdi
nop
nop
nop
nop
...
nop
add %rbx, %rbx
lea addresses_WC_ht+0x2a2d, %rdx
nop
add %rbp, %rbp
movw $0x6162, (%rdx)
nop
...
nop
and %r12, %r12
lea addresses_WT_ht+0x8c2d, %rsi
lea addresses_WC_ht+0xaead, %rdi
nop
nop
cmp $51889, %r12
mov $60, %rcx
rep movsw
sub $47737, %rbp
lea addresses_D_ht+0x137ad, %rsi
nop
nop
nop
nop
...
{'OP': 'REPM', 'src': {'type': 'addresses_WC_ht', 'congruent': 10, 'same': True}, 'dst': {'type': 'addresses_normal_ht', 'congruent': 10, 'same': False}}
{'OP': 'REPM', 'src': {'type': 'addresses_WT_ht', 'congruent': 8, 'same': False}, 'dst': {'type': 'addresses_WT_ht', 'congruent': 1, 'same': False}}
{'OP': 'STOR', 'dst': {'type': 'addresses_UC_ht', 'size': 1, 'AVXalign': True, 'NT': False, 'congruent': 7, 'same': False}}
{'OP': 'REPM', 'src': {'type': 'addresses_normal_ht', 'congruent': 2, 'same': True}, 'dst': {'type': 'addresses_WT_ht', 'congruent': 11, 'same': False}}
