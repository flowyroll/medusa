...
push %rdi
push %rsi
lea addresses_WC_ht+0x1383c, %rsi
add $50968, %rcx
movb $0x61, (%rsi)
nop
nop
...
nop
add $29713, %r11
lea addresses_normal_ht+0x7dbc, %r15
nop
nop
nop
nop
...
nop
add $41065, %rax
lea addresses_WT_ht+0x1b7fc, %rsi
...
rep movsq
xor $54991, %r15
lea addresses_normal_ht+0xd21c, %rdi
nop
nop
cmp %rax, %rax
mov (%rdi), %si
...
nop
sub %rsi, %rsi
lea addresses_normal_ht+0x19c10, %rdi
nop
nop
nop
nop
...
{'OP': 'STOR', 'dst': {'type': 'addresses_PSE', 'size': 2, 'AVXalign': False, 'NT': True, 'congruent': 10, 'same': False}}
