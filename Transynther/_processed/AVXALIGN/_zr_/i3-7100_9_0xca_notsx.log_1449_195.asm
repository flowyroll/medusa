...
push %rbp
push %rcx
lea addresses_A_ht+0x19563, %r12
nop
nop
lfence
movw $0x6162, (%r12)
...
nop
sub $61872, %r11
lea addresses_A_ht+0x1e973, %rbp
and $42254, %r8
mov (%rbp), %rcx
nop
nop
...
nop
and %r8, %r8
lea addresses_D_ht+0x1efe3, %rbp
nop
nop
and $50098, %r14
...
// Store
lea addresses_normal+0x84e3, %r9
cmp %rbp, %rbp
movw $0x5152, (%r9)
nop
nop
...
// Store
lea addresses_normal+0x1540b, %rdx
nop
dec %r12
...
{'OP': 'STOR', 'dst': {'same': True, 'congruent': 10, 'NT': False, 'type': 'addresses_normal', 'size': 2, 'AVXalign': False}}
...
{'src': {'same': True, 'congruent': 4, 'NT': False, 'type': 'addresses_A_ht', 'size': 8, 'AVXalign': False}, 'OP': 'LOAD'}
