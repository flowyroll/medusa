...
nop
and $29074, %r14
lea addresses_WC_ht+0x133b6, %r12
clflush (%r12)
nop
nop
nop
...
nop
dec %rbx
lea addresses_normal_ht+0x212e, %rsi
nop
inc %r14
...
nop
and %rdi, %rdi
lea addresses_D_ht+0x7836, %rsi
lea addresses_D_ht+0x1b036, %rdi
nop
nop
inc %r13
mov $90, %rcx
...
nop
xor $30397, %rbx
lea addresses_WC_ht+0x1141a, %rsi
lea addresses_D_ht+0x155ea, %rdi
nop
nop
nop
mfence
...
nop
and $27840, %r14
lea addresses_WT_ht+0x4796, %rdi
nop
nop
sub $19308, %r14
mov (%rdi), %bx
...
lea addresses_UC_ht+0x112f6, %rdi
nop
nop
nop
nop
...
nop
add $63335, %r14
lea addresses_WT_ht+0x12b36, %r9
clflush (%r9)
nop
nop
nop
...
nop
cmp $53650, %rsi
lea addresses_UC_ht+0x6076, %rsi
nop
nop
nop
and $27283, %r13
...
{'OP': 'STOR', 'dst': {'congruent': 7, 'AVXalign': True, 'same': False, 'size': 4, 'NT': False, 'type': 'addresses_D'}}
[Faulty Load]
...
{'src': {'congruent': 0, 'same': False, 'type': 'addresses_D_ht'}, 'OP': 'REPM', 'dst': {'congruent': 4, 'same': True, 'type': 'addresses_UC_ht'}}
