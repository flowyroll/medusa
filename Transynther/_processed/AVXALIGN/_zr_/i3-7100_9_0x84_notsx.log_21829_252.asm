...
push %rdi
push %rsi
lea addresses_A_ht+0x18e9d, %rsi
lea addresses_WT_ht+0x12b33, %rdi
clflush (%rsi)
nop
nop
nop
...
nop
lfence
lea addresses_UC_ht+0x4383, %r10
nop
nop
add %r14, %r14
mov (%r10), %r8d
xor %r15, %r15
lea addresses_WT_ht+0xf043, %r10
nop
nop
cmp %rsi, %rsi
mov (%r10), %cx
...
lea addresses_D_ht+0x16043, %rdi
xor %r9, %r9
mov $0, %rcx
rep movsw
nop
...
nop
cmp %rcx, %rcx
lea addresses_WC_ht+0x4fff, %rsi
lea addresses_normal_ht+0xc043, %rdi
nop
nop
xor %r14, %r14
mov $66, %rcx
...
{'src': {'type': 'addresses_A_ht', 'congruent': 8, 'same': True}, 'dst': {'type': 'addresses_D_ht', 'congruent': 9, 'same': False}, 'OP': 'REPM'}
