...
nop
dec %rdx
lea addresses_UC_ht+0x1c36, %rbp
nop
nop
add $43803, %rdi
movw $0x6162, (%rbp)
...
nop
cmp $3753, %r9
lea addresses_WT_ht+0xe8d9, %rsi
...
nop
xor %rcx, %rcx
lea addresses_D_ht+0x43e9, %rsi
lea addresses_WC_ht+0x13269, %rdi
nop
nop
nop
nop
...
// REPMOV
lea addresses_normal+0x7454, %rsi
lea addresses_WC+0xde49, %rdi
nop
nop
nop
cmp $22903, %r12
...
// Load
lea addresses_normal+0x91e9, %r13
nop
sub %rdi, %rdi
mov (%r13), %r10
nop
...
// Faulty Load
lea addresses_normal+0x91e9, %rbp
nop
sub %rdi, %rdi
vmovaps (%rbp), %ymm4
...
{'src': {'type': 'addresses_normal', 'congruent': 0, 'same': False}, 'dst': {'type': 'addresses_WC', 'congruent': 3, 'same': False}, 'OP': 'REPM'}
...
{'dst': {'type': 'addresses_P', 'same': False, 'size': 4, 'congruent': 9, 'NT': False, 'AVXalign': True}, 'OP': 'STOR'}
...
{'src': {'type': 'addresses_D_ht', 'congruent': 7, 'same': False}, 'dst': {'type': 'addresses_WC_ht', 'congruent': 7, 'same': False}, 'OP': 'REPM'}
{'00': 18807}
