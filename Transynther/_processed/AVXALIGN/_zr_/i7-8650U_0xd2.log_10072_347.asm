...
nop
dec %r11
lea addresses_D_ht+0x33e6, %rsi
lea addresses_A_ht+0x6fe6, %rdi
nop
add $54961, %rdx
mov $26, %rcx
rep movsl
...
nop
add $61276, %r11
lea addresses_A_ht+0x12516, %rdi
nop
nop
nop
nop
...
nop
and $61950, %rsi
lea addresses_normal_ht+0x4902, %rdx
cmp $50031, %rsi
...
// Faulty Load
lea addresses_normal+0xfe6, %rdi
nop
nop
nop
nop
