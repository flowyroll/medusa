...
push %rdx
push %rsi
lea addresses_A_ht+0x16741, %r10
nop
xor %rax, %rax
mov (%r10), %cx
nop
dec %r8
lea addresses_WC_ht+0x16ab1, %r11
inc %r12
mov (%r11), %edx
add $30391, %rdx
lea addresses_WT_ht+0x1c2bb, %r12
nop
nop
nop
nop
...
nop
dec %r8
lea addresses_WC_ht+0x16b01, %r12
clflush (%r12)
nop
nop
nop
...
nop
dec %r8
lea addresses_WC_ht+0x1d781, %rsi
lea addresses_WT_ht+0x19301, %rdi
nop
nop
nop
sub %rdx, %rdx
...
nop
xor %r12, %r12
lea addresses_UC_ht+0x1a201, %rdx
nop
nop
nop
cmp %r10, %r10
...
nop
inc %rax
lea addresses_WC_ht+0x8301, %rsi
lea addresses_A_ht+0x15f81, %rdi
nop
inc %rax
mov $6, %rcx
rep movsw
...
nop
dec %rsi
lea addresses_A_ht+0x8b01, %r10
dec %r12
movups (%r10), %xmm5
vpextrq $0, %xmm5, %r8
nop
dec %rdx
lea addresses_A_ht+0xd929, %rsi
lea addresses_WC_ht+0x2b01, %rdi
add %rdx, %rdx
mov $39, %rcx
rep movsl
nop
...
{'OP': 'STOR', 'dst': {'type': 'addresses_A', 'size': 2, 'AVXalign': True, 'NT': False, 'congruent': 9, 'same': False}}
{'OP': 'STOR', 'dst': {'type': 'addresses_P', 'size': 32, 'AVXalign': False, 'NT': True, 'congruent': 10, 'same': False}}
...
{'OP': 'REPM', 'src': {'type': 'addresses_WC_ht', 'congruent': 6, 'same': True}, 'dst': {'type': 'addresses_WT_ht', 'congruent': 10, 'same': False}}
...
{'OP': 'REPM', 'src': {'type': 'addresses_A_ht', 'congruent': 0, 'same': False}, 'dst': {'type': 'addresses_WC_ht', 'congruent': 8, 'same': True}}
{'00': 16854}
