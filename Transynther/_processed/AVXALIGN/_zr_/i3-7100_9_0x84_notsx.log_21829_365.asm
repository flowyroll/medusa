...
push %rdi
push %rsi
lea addresses_WC_ht+0x5e67, %rdi
cmp %r8, %r8
movups (%rdi), %xmm0
vpextrq $0, %xmm0, %r12
nop
nop
sub $56315, %r8
lea addresses_WT_ht+0x13c67, %rsi
lea addresses_UC_ht+0x1e830, %rdi
clflush (%rsi)
nop
nop
sub $39331, %r12
...
nop
and %r12, %r12
lea addresses_WT_ht+0xe667, %rbx
nop
nop
nop
sub $475, %r15
...
nop
dec %rdi
lea addresses_D_ht+0x82df, %rsi
lea addresses_WC_ht+0x1ec9f, %rdi
cmp %r11, %r11
mov $104, %rcx
rep movsw
nop
...
nop
add $31446, %rdi
lea addresses_UC_ht+0x16e67, %r11
nop
xor $9976, %r12
movb (%r11), %bl
nop
...
nop
xor %r15, %r15
lea addresses_UC_ht+0x15f07, %r12
nop
nop
nop
nop
...
mov (%r12), %esi
add $11953, %r12
lea addresses_WC_ht+0x1543, %r12
inc %r8
movw $0x6162, (%r12)
nop
sub %rdi, %rdi
lea addresses_UC_ht+0x1e67, %r12
clflush (%r12)
nop
and %r15, %r15
...
nop
inc %rdi
lea addresses_WT_ht+0xba67, %rcx
nop
sub $44592, %rdi
movl $0x61626364, (%rcx)
nop
...
nop
xor %r8, %r8
lea addresses_WT_ht+0x14de7, %rcx
nop
nop
nop
nop
...
nop
and %r11, %r11
lea addresses_UC_ht+0xce67, %r11
nop
nop
nop
add $36635, %rcx
