...
push %rdi
push %rsi
lea addresses_normal_ht+0x1549c, %rbx
clflush (%rbx)
nop
nop
xor %r14, %r14
...
nop
mfence
lea addresses_A_ht+0x15e34, %rsi
lea addresses_WT_ht+0x1433c, %rdi
sub $43733, %r11
mov $101, %rcx
rep movsb
nop
...
nop
cmp %rcx, %rcx
lea addresses_WT_ht+0x1a9fc, %rdi
nop
and $61550, %r8
...
nop
and $13742, %r11
lea addresses_normal_ht+0x1cf8f, %rsi
lea addresses_D_ht+0x1c51c, %rdi
add %r9, %r9
mov $96, %rcx
rep movsq
nop
...
nop
xor $26798, %r8
lea addresses_WC_ht+0xff5c, %r14
nop
and %rdi, %rdi
vmovups (%r14), %ymm2
...
// REPMOV
lea addresses_D+0x1f8dc, %rsi
lea addresses_PSE+0x182f8, %rdi
nop
dec %r9
mov $27, %rcx
rep movsl
...
// Load
lea addresses_normal+0xec4e, %r9
nop
sub %r8, %r8
movb (%r9), %dl
nop
...
{'OP': 'REPM', 'src': {'type': 'addresses_D', 'congruent': 4, 'same': False}, 'dst': {'type': 'addresses_PSE', 'congruent': 0, 'same': False}}
...
<gen_prepare_buffer>
{'OP': 'LOAD', 'src': {'type': 'addresses_normal_ht', 'size': 8, 'AVXalign': True, 'NT': False, 'congruent': 4, 'same': False}}
...
{'OP': 'REPM', 'src': {'type': 'addresses_normal_ht', 'congruent': 0, 'same': False}, 'dst': {'type': 'addresses_D_ht', 'congruent': 3, 'same': True}}
