...
push %rdx
push %rsi
lea addresses_WT_ht+0x11ce4, %rax
dec %r15
mov $0x6162636465666768, %r8
movq %r8, (%rax)
sub $51709, %rbx
lea addresses_UC_ht+0x15450, %r8
clflush (%r8)
nop
add %rdx, %rdx
...
nop
dec %rbx
lea addresses_WT_ht+0x16d50, %rax
nop
inc %r9
mov (%rax), %dx
nop
...
nop
add $17582, %rax
lea addresses_WT_ht+0xe8ba, %rax
nop
nop
add $50952, %r15
movb (%rax), %r8b
cmp %rdx, %rdx
lea addresses_normal_ht+0x11468, %r9
clflush (%r9)
and %rax, %rax
...
nop
inc %rax
lea addresses_UC_ht+0x6b10, %rsi
lea addresses_UC_ht+0x7d10, %rdi
nop
nop
nop
nop
...
nop
inc %rax
lea addresses_WC_ht+0x16570, %rsi
lea addresses_WT_ht+0x7550, %rdi
nop
nop
nop
inc %r8
...
nop
sub $65150, %rdi
lea addresses_UC_ht+0x199d0, %rdx
nop
nop
nop
nop
...
{'OP': 'LOAD', 'src': {'type': 'addresses_normal_ht', 'AVXalign': True, 'congruent': 2, 'size': 32, 'same': True, 'NT': True}}
{'OP': 'REPM', 'src': {'type': 'addresses_UC_ht', 'congruent': 6, 'same': False}, 'dst': {'type': 'addresses_UC_ht', 'congruent': 6, 'same': False}}
{'OP': 'REPM', 'src': {'type': 'addresses_WC_ht', 'congruent': 5, 'same': False}, 'dst': {'type': 'addresses_WT_ht', 'congruent': 7, 'same': True}}
