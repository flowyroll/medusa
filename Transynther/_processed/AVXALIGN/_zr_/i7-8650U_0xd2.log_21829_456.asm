...
push %rdi
push %rsi
lea addresses_WC_ht+0xd235, %rsi
lea addresses_WT_ht+0x14a85, %rdi
clflush (%rsi)
clflush (%rdi)
add %r14, %r14
mov $4, %rcx
...
nop
add $49544, %rbx
lea addresses_D_ht+0x155ed, %r15
nop
nop
nop
nop
...
movups %xmm4, (%r15)
add $37524, %r11
lea addresses_UC_ht+0xb9f9, %r15
nop
nop
nop
sub %rbx, %rbx
...
nop
add $16391, %rbx
lea addresses_WT_ht+0xafb5, %r15
nop
nop
nop
nop
...
nop
xor $52385, %rdi
lea addresses_normal_ht+0x16b35, %r11
nop
nop
nop
add %rsi, %rsi
...
nop
xor $23910, %rcx
lea addresses_UC_ht+0x16475, %rsi
lea addresses_normal_ht+0x3bf4, %rdi
nop
nop
cmp %r8, %r8
mov $100, %rcx
...
{'OP': 'STOR', 'dst': {'type': 'addresses_WT', 'size': 8, 'AVXalign': True, 'NT': False, 'congruent': 0, 'same': False}}
...
{'OP': 'REPM', 'src': {'type': 'addresses_A_ht', 'congruent': 4, 'same': True}, 'dst': {'type': 'addresses_A_ht', 'congruent': 10, 'same': False}}
