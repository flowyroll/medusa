...
push %rdi
push %rsi
lea addresses_WC_ht+0x1824e, %rax
nop
nop
sub %rsi, %rsi
movb $0x61, (%rax)
...
nop
add %r12, %r12
lea addresses_A_ht+0x192be, %rsi
lea addresses_normal_ht+0x114c6, %rdi
nop
nop
nop
add %r13, %r13
...
nop
add %r12, %r12
lea addresses_WC_ht+0x1b7f6, %r13
clflush (%r13)
nop
nop
cmp $18514, %rbp
...
movups %xmm6, (%r13)
xor $65102, %r13
lea addresses_WT_ht+0x157ce, %r10
nop
nop
and %rsi, %rsi
movw $0x6162, (%r10)
...
nop
sub %rcx, %rcx
lea addresses_normal_ht+0x34ae, %rsi
lea addresses_WT_ht+0xa40e, %rdi
nop
nop
nop
cmp $14310, %rbp
...
nop
xor $40011, %rcx
lea addresses_WC_ht+0xcce, %rsi
lea addresses_WC_ht+0x18a0e, %rdi
nop
nop
nop
sub %r13, %r13
...
nop
add %rbp, %rbp
lea addresses_WT_ht+0x1875a, %rsi
nop
nop
nop
and %rax, %rax
...
[Faulty Load]
{'OP': 'LOAD', 'src': {'type': 'addresses_A', 'size': 16, 'AVXalign': True, 'NT': True, 'congruent': 0, 'same': True}}
<gen_prepare_buffer>
...
{'OP': 'REPM', 'src': {'type': 'addresses_A_ht', 'congruent': 2, 'same': False}, 'dst': {'type': 'addresses_normal_ht', 'congruent': 3, 'same': False}}
...
{'OP': 'REPM', 'src': {'type': 'addresses_normal_ht', 'congruent': 4, 'same': False}, 'dst': {'type': 'addresses_WT_ht', 'congruent': 6, 'same': True}}
