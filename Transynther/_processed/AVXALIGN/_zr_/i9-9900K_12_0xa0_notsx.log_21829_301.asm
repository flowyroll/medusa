...
push %rdx
push %rsi
lea addresses_WC_ht+0x170e8, %rbp
nop
nop
nop
xor %r13, %r13
...
nop
sub %rcx, %rcx
lea addresses_UC_ht+0x1a048, %r12
nop
nop
nop
nop
...
nop
cmp %r12, %r12
lea addresses_WC_ht+0x16e72, %r12
nop
nop
nop
nop
...
nop
and $35932, %rdx
lea addresses_UC_ht+0x18188, %r14
nop
nop
cmp $45576, %rcx
...
nop
cmp %r12, %r12
lea addresses_WT_ht+0x9e9c, %r14
nop
and %rbp, %rbp
vmovups (%r14), %ymm1
...
nop
sub $46782, %r11
lea addresses_A_ht+0x17048, %rsi
lea addresses_WC_ht+0x182b0, %rdi
add $17510, %r13
mov $50, %rcx
rep movsw
nop
...
{'OP': 'STOR', 'dst': {'type': 'addresses_UC_ht', 'AVXalign': False, 'size': 16, 'NT': True, 'same': True, 'congruent': 6}}
