...
push %rbp
push %rdx
lea addresses_normal_ht+0xdc16, %rax
nop
nop
cmp $5113, %r14
...
nop
and %r15, %r15
lea addresses_WC_ht+0x11396, %rax
nop
nop
sub $49184, %r13
...
movaps %xmm7, (%rax)
xor %rax, %rax
lea addresses_UC_ht+0x16a96, %r8
nop
nop
nop
nop
...
nop
dec %r14
lea addresses_normal_ht+0xa5d5, %rax
nop
cmp $59448, %r15
mov (%rax), %r13d
nop
...
// Store
lea addresses_normal+0x3060, %rax
nop
nop
nop
cmp $43638, %rdi
...
<gen_prepare_buffer>
{'OP': 'LOAD', 'src': {'same': False, 'NT': True, 'AVXalign': False, 'size': 16, 'type': 'addresses_normal_ht', 'congruent': 7}}
{'OP': 'LOAD', 'src': {'same': False, 'NT': True, 'AVXalign': False, 'size': 4, 'type': 'addresses_WC_ht', 'congruent': 3}}
{'dst': {'same': False, 'NT': False, 'AVXalign': True, 'size': 16, 'type': 'addresses_WC_ht', 'congruent': 10}, 'OP': 'STOR'}
