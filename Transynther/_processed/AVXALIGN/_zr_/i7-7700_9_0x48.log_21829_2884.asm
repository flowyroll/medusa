...
lea addresses_UC_ht+0x11d0b, %rdi
nop
nop
nop
nop
...
nop
add %rsi, %rsi
lea addresses_UC_ht+0x1d60b, %rax
nop
nop
nop
nop
...
mov (%rax), %rdi
cmp %rsi, %rsi
lea addresses_UC_ht+0xde0b, %r14
nop
nop
nop
cmp %rcx, %rcx
...
nop
add %r14, %r14
lea addresses_D_ht+0x108ab, %rcx
cmp $55052, %rdi
movups (%rcx), %xmm5
vpextrq $0, %xmm5, %rsi
xor %rdi, %rdi
lea addresses_WT_ht+0xc067, %rax
nop
xor $54335, %rdi
mov (%rax), %rsi
nop
...
nop
xor %r14, %r14
lea addresses_A_ht+0x91ab, %rsi
lea addresses_D_ht+0x643, %rdi
nop
nop
xor %r14, %r14
mov $74, %rcx
...
nop
xor $14476, %rdi
lea addresses_D_ht+0x488b, %rdi
xor %r10, %r10
mov (%rdi), %ax
cmp %r14, %r14
lea addresses_D_ht+0x185de, %rsi
...
nop
and %rcx, %rcx
lea addresses_WC_ht+0x1560b, %rsi
lea addresses_UC_ht+0x149b, %rdi
add $22836, %r9
mov $10, %rcx
rep movsq
nop
...
{'OP': 'LOAD', 'src': {'type': 'addresses_UC_ht', 'AVXalign': True, 'congruent': 11, 'size': 8, 'same': False, 'NT': False}}
...
{'OP': 'REPM', 'src': {'type': 'addresses_WC_ht', 'congruent': 11, 'same': False}, 'dst': {'type': 'addresses_UC_ht', 'congruent': 1, 'same': False}}
{'00': 21829}
