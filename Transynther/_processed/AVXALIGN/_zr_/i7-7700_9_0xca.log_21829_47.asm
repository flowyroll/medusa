...
push %rdi
push %rsi
lea addresses_normal_ht+0x11fd0, %rdi
nop
add $58887, %rbx
mov (%rdi), %r15d
nop
...
nop
sub %rcx, %rcx
lea addresses_WT_ht+0x14d26, %rsi
lea addresses_UC_ht+0x2d34, %rdi
nop
nop
nop
nop
...
nop
cmp %rdi, %rdi
lea addresses_D_ht+0x274, %rbx
nop
xor %rdi, %rdi
movb $0x61, (%rbx)
sub $50760, %rdi
lea addresses_A_ht+0x8f0c, %rsi
nop
nop
nop
nop
...
// Store
lea addresses_normal+0x1ef9, %r11
nop
inc %rbx
