...
push %rdi
push %rsi
lea addresses_WC_ht+0xa6ca, %rax
nop
nop
sub $23815, %r12
movl $0x61626364, (%rax)
...
vpextrq $0, %xmm5, %rsi
cmp $51633, %rsi
lea addresses_D_ht+0x1cb32, %rax
nop
nop
nop
nop
...
nop
and %r8, %r8
lea addresses_WC_ht+0x26ca, %rsi
nop
nop
nop
nop
...
nop
cmp $13715, %r13
lea addresses_WT_ht+0xe7fa, %rsi
lea addresses_normal_ht+0xab0a, %rdi
nop
and $61025, %r8
mov $110, %rcx
rep movsl
...
nop
add $65204, %r12
lea addresses_normal_ht+0x192ca, %rax
clflush (%rax)
cmp %rsi, %rsi
movl $0x61626364, (%rax)
and $49390, %rsi
lea addresses_UC_ht+0xc34a, %rsi
lea addresses_WC_ht+0x17b06, %rdi
xor %r15, %r15
mov $61, %rcx
rep movsq
nop
