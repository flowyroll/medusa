...
vpextrq $0, %xmm0, %r11
and %r8, %r8
lea addresses_UC_ht+0x18639, %r9
clflush (%r9)
nop
nop
nop
...
nop
mfence
lea addresses_UC_ht+0x65a9, %r15
sub %rbx, %rbx
...
// Store
lea addresses_WC+0x18fb9, %rbp
add $10037, %r15
movl $0x51525354, (%rbp)
xor $48571, %r12

// Faulty Load
mov $0x36c64f0000000e39, %rax
nop
nop
nop
sub %rbp, %rbp
...
{'OP': 'STOR', 'dst': {'NT': False, 'same': False, 'congruent': 0, 'type': 'addresses_WC', 'AVXalign': True, 'size': 8}}
...
{'src': {'NT': False, 'same': False, 'congruent': 8, 'type': 'addresses_A_ht', 'AVXalign': True, 'size': 32}, 'OP': 'LOAD'}
