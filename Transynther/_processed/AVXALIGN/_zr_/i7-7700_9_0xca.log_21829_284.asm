...
push %rbx
push %rcx
lea addresses_WC_ht+0xedc4, %r12
cmp %r10, %r10
mov (%r12), %ebx
nop
nop
sub $6572, %r11
lea addresses_A_ht+0xfcc4, %r14
nop
sub $58446, %r8
...
nop
inc %r14
lea addresses_D_ht+0x12ec4, %rcx
nop
sub $21303, %r10
...
nop
inc %r10
lea addresses_UC_ht+0x198c4, %r12
nop
nop
and %r8, %r8
movw $0x6162, (%r12)
...
vpextrq $0, %xmm5, %rcx
and $9427, %r14
lea addresses_WT_ht+0x10264, %rcx
nop
nop
nop
nop
...
{'src': {'congruent': 11, 'AVXalign': False, 'same': False, 'size': 4, 'NT': False, 'type': 'addresses_PSE'}, 'OP': 'LOAD'}
[Faulty Load]
{'src': {'congruent': 0, 'AVXalign': True, 'same': True, 'size': 2, 'NT': True, 'type': 'addresses_A'}, 'OP': 'LOAD'}
<gen_prepare_buffer>
{'src': {'congruent': 8, 'AVXalign': False, 'same': False, 'size': 4, 'NT': False, 'type': 'addresses_WC_ht'}, 'OP': 'LOAD'}
{'src': {'congruent': 8, 'AVXalign': True, 'same': False, 'size': 16, 'NT': False, 'type': 'addresses_A_ht'}, 'OP': 'LOAD'}
