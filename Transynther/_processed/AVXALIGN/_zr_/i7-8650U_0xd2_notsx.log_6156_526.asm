...
nop
xor $42640, %rcx
lea addresses_D_ht+0x174f5, %rsi
dec %r12
mov $0x6162636465666768, %r11
movq %r11, (%rsi)
nop
...
nop
xor $58872, %rsi
lea addresses_WT_ht+0x7cf5, %rsi
lea addresses_D_ht+0x12bf5, %rdi
and %r13, %r13
mov $61, %rcx
rep movsb
nop
...
nop
sub %r10, %r10
lea addresses_WC_ht+0x8835, %rbp
nop
nop
cmp $58078, %rdi
mov (%rbp), %rsi
...
nop
sub $8179, %rdi
lea addresses_WT_ht+0xecf5, %rdi
nop
nop
nop
nop
...
nop
cmp $4761, %rcx
lea addresses_UC_ht+0x142b5, %rsi
lea addresses_WC_ht+0x59f5, %rdi
nop
nop
nop
nop
