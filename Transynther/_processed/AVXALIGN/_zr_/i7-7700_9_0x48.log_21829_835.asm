...
push %rdi
push %rsi
lea addresses_D_ht+0x1bae8, %rcx
nop
add %r11, %r11
vmovups (%rcx), %ymm0
...
nop
add %r11, %r11
lea addresses_D_ht+0x14208, %rsi
lea addresses_WT_ht+0x18718, %rdi
and %rbx, %rbx
mov $8, %rcx
rep movsq
nop
add %rbx, %rbx
lea addresses_normal_ht+0xca28, %rax
nop
nop
nop
dec %r15
...
nop
xor $15067, %r11
lea addresses_normal_ht+0x142e8, %rsi
lea addresses_WC_ht+0x156e8, %rdi
nop
nop
nop
nop
...
nop
sub $37415, %r14
lea addresses_A_ht+0x47f0, %rax
nop
nop
dec %rcx
mov (%rax), %r14
add $10904, %r11
lea addresses_WT_ht+0x8b68, %rsi
lea addresses_D_ht+0x4038, %rdi
nop
nop
nop
lfence
...
nop
xor $18267, %rax
lea addresses_D_ht+0x14700, %rcx
nop
nop
nop
sub $49475, %r11
...
nop
add %rbx, %rbx
lea addresses_WT_ht+0x1c9c8, %rsi
lea addresses_UC_ht+0xb8d8, %rdi
xor %r11, %r11
mov $34, %rcx
rep movsq
nop
...
<gen_prepare_buffer>
{'OP': 'LOAD', 'src': {'type': 'addresses_D_ht', 'AVXalign': False, 'congruent': 9, 'size': 32, 'same': True, 'NT': False}}
