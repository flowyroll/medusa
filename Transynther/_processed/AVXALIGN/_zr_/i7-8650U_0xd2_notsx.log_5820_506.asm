...
nop
and %rsi, %rsi
lea addresses_WC_ht+0x1edaf, %r15
cmp %rbx, %rbx
movups (%r15), %xmm0
vpextrq $1, %xmm0, %rdi
nop
...
nop
and $10781, %rdx
lea addresses_UC_ht+0x9e8f, %rdi
nop
nop
nop
nop
...
nop
add $62037, %r15
lea addresses_WC_ht+0xd9ff, %rdx
nop
nop
and %rcx, %rcx
movl $0x61626364, (%rdx)
nop
sub %rbx, %rbx
lea addresses_WT_ht+0x18e7f, %rsi
lea addresses_WT_ht+0x1992f, %rdi
clflush (%rsi)
nop
nop
nop
