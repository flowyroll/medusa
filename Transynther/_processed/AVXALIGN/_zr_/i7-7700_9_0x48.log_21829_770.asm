...
push %rdx
push %rsi
lea addresses_UC_ht+0x16b8f, %rbp
nop
nop
nop
inc %rdx
...
nop
xor $59861, %rax
lea addresses_WT_ht+0x1ab8f, %rdx
nop
nop
nop
dec %r14
...
nop
sub %rax, %rax
lea addresses_A_ht+0x16b8f, %rsi
lea addresses_normal_ht+0x1778f, %rdi
nop
nop
cmp %r8, %r8
mov $49, %rcx
...
nop
cmp $53851, %rax
lea addresses_UC_ht+0x1476f, %r8
nop
cmp $63925, %rcx
...
nop
add $59344, %r8
lea addresses_normal_ht+0x450f, %rsi
dec %rdi
movups (%rsi), %xmm5
vpextrq $1, %xmm5, %rbp
nop
...
nop
inc %rbp
lea addresses_normal_ht+0xc1af, %rsi
lea addresses_D_ht+0x1d6cf, %rdi
clflush (%rsi)
nop
nop
nop
...
lea addresses_UC_ht+0x278f, %rdi
nop
nop
nop
nop
...
nop
dec %rcx
lea addresses_WC_ht+0x7e27, %rsi
nop
nop
sub %rcx, %rcx
vmovups (%rsi), %ymm4
