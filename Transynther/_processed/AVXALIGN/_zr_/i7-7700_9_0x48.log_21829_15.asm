...
nop
cmp %r8, %r8
lea addresses_A_ht+0x1abc2, %rsi
lea addresses_D_ht+0x12e32, %rdi
xor $13491, %r8
mov $109, %rcx
rep movsb
nop
...
nop
cmp %rcx, %rcx
lea addresses_WC_ht+0x9930, %rdi
clflush (%rdi)
and $48485, %r10
movl $0x61626364, (%rdi)
nop
...
nop
cmp $58531, %r9
lea addresses_WC_ht+0x1a142, %r9
nop
nop
nop
sub $8212, %r10
...
// Store
lea addresses_normal+0xe142, %rdi
nop
nop
nop
xor $3551, %r14
...
{'OP': 'REPM', 'src': {'type': 'addresses_A_ht', 'congruent': 11, 'same': False}, 'dst': {'type': 'addresses_D_ht', 'congruent': 4, 'same': True}}
