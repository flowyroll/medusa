...
push %rdi
push %rsi
lea addresses_WC_ht+0xef05, %r11
clflush (%r11)
nop
nop
cmp $16970, %r14
...
nop
and %r15, %r15
lea addresses_WC_ht+0x14fc5, %r11
nop
nop
nop
nop
...
movq %rcx, (%r11)
cmp %r11, %r11
lea addresses_WT_ht+0x4205, %r14
nop
nop
nop
nop
...
nop
cmp $21867, %r15
lea addresses_D_ht+0x177f5, %rsi
lea addresses_A_ht+0x168e5, %rdi
clflush (%rdi)
nop
nop
nop
...
lea addresses_UC_ht+0x1005, %rdi
and %r15, %r15
mov $16, %rcx
rep movsw
nop
sub %rsi, %rsi
lea addresses_WT_ht+0x17c05, %rsi
lea addresses_WT_ht+0x1d365, %rdi
nop
nop
nop
nop
...
rep movsb
cmp $51333, %rbp
lea addresses_WT_ht+0xef05, %r15
nop
xor %rbp, %rbp
...
nop
and %r15, %r15
lea addresses_normal_ht+0x11405, %rsi
lea addresses_A_ht+0x1d105, %rdi
nop
nop
nop
sub $26248, %r14
...
// Store
lea addresses_normal+0x1b6ab, %r14
nop
xor %rbx, %rbx
...
{'OP': 'STOR', 'dst': {'same': False, 'type': 'addresses_normal', 'NT': False, 'AVXalign': True, 'size': 16, 'congruent': 1}}
[Faulty Load]
...
{'OP': 'REPM', 'src': {'same': False, 'congruent': 11, 'type': 'addresses_WT_ht'}, 'dst': {'same': False, 'congruent': 4, 'type': 'addresses_WT_ht'}}
