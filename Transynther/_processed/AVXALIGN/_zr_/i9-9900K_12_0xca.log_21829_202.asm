...
push %rdx
push %rsi
lea addresses_WC_ht+0xd64a, %r12
clflush (%r12)
nop
and %r11, %r11
...
nop
sub $31788, %r11
lea addresses_WT_ht+0x12ca2, %rsi
and $54144, %r15
movups (%rsi), %xmm7
vpextrq $0, %xmm7, %r11
nop
xor $9999, %rsi
lea addresses_WC_ht+0xba2a, %rsi
add $49878, %r11
movb $0x61, (%rsi)
and $41169, %r12
lea addresses_WC_ht+0x1894a, %r10
nop
nop
nop
nop
...
nop
sub $29001, %r11
lea addresses_UC_ht+0x4650, %r15
nop
nop
nop
sub %rdi, %rdi
...
{'OP': 'STOR', 'dst': {'size': 8, 'NT': False, 'type': 'addresses_UC_ht', 'same': False, 'AVXalign': True, 'congruent': 1}}
{'00': 21829}
