...
nop
add %r8, %r8
lea addresses_A_ht+0x17401, %r8
and %rsi, %rsi
movw $0x6162, (%r8)
sub $45334, %rsi
lea addresses_normal_ht+0x12e99, %r11
nop
nop
nop
nop
...
nop
xor $35781, %rax
lea addresses_A_ht+0x185af, %rdi
nop
nop
nop
nop
...
nop
xor %rax, %rax
lea addresses_WC_ht+0xa081, %r14
nop
and %rbp, %rbp
...
// Store
lea addresses_normal+0x7d81, %rcx
clflush (%rcx)
nop
nop
sub %r11, %r11
...
{'OP': 'STOR', 'dst': {'type': 'addresses_normal', 'AVXalign': False, 'congruent': 8, 'size': 4, 'same': False, 'NT': False}}
[Faulty Load]
...
{'OP': 'STOR', 'dst': {'type': 'addresses_normal_ht', 'AVXalign': False, 'congruent': 3, 'size': 4, 'same': False, 'NT': True}}
