...
// Store
lea addresses_normal+0x14fba, %rax
nop
nop
add %r15, %r15
...
// Faulty Load
lea addresses_normal+0x14fba, %rbp
nop
nop
nop
nop
...
{'OP': 'STOR', 'dst': {'congruent': 0, 'AVXalign': True, 'same': True, 'size': 8, 'NT': False, 'type': 'addresses_normal'}}
[Faulty Load]
