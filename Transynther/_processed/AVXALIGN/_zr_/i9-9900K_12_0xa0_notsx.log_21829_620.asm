...
nop
add $27109, %r12
lea addresses_A_ht+0x7d94, %rsi
lea addresses_normal_ht+0x2994, %rdi
nop
dec %r9
mov $105, %rcx
rep movsq
...
nop
add %rbx, %rbx
lea addresses_UC_ht+0x194c9, %r9
nop
nop
cmp %rbx, %rbx
mov (%r9), %r8w
nop
cmp $55014, %r11
lea addresses_WT_ht+0x19594, %rbx
dec %r13
movl $0x61626364, (%rbx)
and %rbp, %rbp
lea addresses_A_ht+0x17f94, %r13
nop
nop
nop
nop
...
{'src': {'type': 'addresses_A_ht', 'congruent': 8, 'same': False}, 'OP': 'REPM', 'dst': {'type': 'addresses_normal_ht', 'congruent': 10, 'same': False}}
