...
movups %xmm2, (%rdx)
add %rdi, %rdi
lea addresses_WC_ht+0x1b31c, %rsi
lea addresses_normal_ht+0x1541c, %rdi
nop
nop
xor %rdx, %rdx
mov $47, %rcx
...
movw $0x6162, (%rsi)
add %rsi, %rsi
lea addresses_D_ht+0x1bd5c, %rsi
lea addresses_D_ht+0x1babc, %rdi
nop
nop
nop
and $51199, %r12
...
{'OP': 'REPM', 'src': {'type': 'addresses_WC_ht', 'congruent': 4, 'same': True}, 'dst': {'type': 'addresses_normal_ht', 'congruent': 5, 'same': False}}
{'OP': 'REPM', 'src': {'type': 'addresses_A_ht', 'congruent': 11, 'same': False}, 'dst': {'type': 'addresses_UC_ht', 'congruent': 5, 'same': True}}
...
{'OP': 'REPM', 'src': {'type': 'addresses_D_ht', 'congruent': 5, 'same': False}, 'dst': {'type': 'addresses_D_ht', 'congruent': 11, 'same': True}}
{'00': 16225}
