...
push %rdi
push %rsi
lea addresses_normal_ht+0x1de1c, %r10
nop
nop
nop
nop
...
nop
xor $35996, %rcx
lea addresses_WT_ht+0x11564, %rsi
lea addresses_WT_ht+0xff0c, %rdi
nop
nop
nop
nop
...
nop
add %rsi, %rsi
lea addresses_WT_ht+0x8014, %r12
cmp $52464, %r11
...
nop
inc %r10
lea addresses_D_ht+0x52ce, %r12
xor $18531, %r11
mov (%r12), %r14d
dec %rsi
lea addresses_UC_ht+0x1d50c, %rsi
lea addresses_UC_ht+0x717c, %rdi
and %r15, %r15
mov $64, %rcx
rep movsw
nop
...
nop
xor $54696, %r10
lea addresses_A_ht+0x1030c, %rcx
xor %r11, %r11
movups (%rcx), %xmm0
vpextrq $1, %xmm0, %r12
and $56924, %r12
lea addresses_UC_ht+0xe60c, %rdi
nop
nop
add %r12, %r12
movl $0x61626364, (%rdi)
...
// Store
lea addresses_normal+0x5b64, %rdi
clflush (%rdi)
nop
nop
inc %r10
...
{'OP': 'STOR', 'dst': {'type': 'addresses_US', 'AVXalign': True, 'size': 16, 'NT': True, 'same': False, 'congruent': 1}}
{'OP': 'STOR', 'dst': {'type': 'addresses_NC', 'AVXalign': False, 'size': 1, 'NT': False, 'same': False, 'congruent': 6}}
{'OP': 'STOR', 'dst': {'type': 'addresses_normal', 'AVXalign': True, 'size': 16, 'NT': False, 'same': False, 'congruent': 3}}
[Faulty Load]
...
{'OP': 'STOR', 'dst': {'type': 'addresses_WT_ht', 'AVXalign': False, 'size': 8, 'NT': False, 'same': True, 'congruent': 3}}
