...
push %rdx
push %rsi
lea addresses_WC_ht+0xd8af, %rdi
nop
nop
nop
nop
...
nop
xor %r10, %r10
lea addresses_WT_ht+0x11ff, %rsi
nop
nop
nop
nop
...
nop
xor %rdi, %rdi
lea addresses_WT_ht+0x1b439, %rbp
add %rdi, %rdi
movb $0x61, (%rbp)
nop
nop
nop
add %r10, %r10
lea addresses_UC_ht+0xd553, %rsi
lea addresses_UC_ht+0x957b, %rdi
nop
nop
nop
nop
...
{'src': {'congruent': 8, 'AVXalign': False, 'same': True, 'size': 8, 'NT': False, 'type': 'addresses_WT_ht'}, 'OP': 'LOAD'}
{'OP': 'STOR', 'dst': {'congruent': 1, 'AVXalign': False, 'same': False, 'size': 1, 'NT': False, 'type': 'addresses_WT_ht'}}
{'src': {'congruent': 1, 'same': True, 'type': 'addresses_UC_ht'}, 'OP': 'REPM', 'dst': {'congruent': 2, 'same': True, 'type': 'addresses_UC_ht'}}
