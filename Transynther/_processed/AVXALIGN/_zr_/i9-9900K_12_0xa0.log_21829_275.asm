...
push %rdx
push %rsi
lea addresses_normal_ht+0xca6, %rsi
lea addresses_normal_ht+0x1b366, %rdi
clflush (%rdi)
nop
nop
add $60273, %r11
...
nop
xor $12981, %rax
lea addresses_WC_ht+0x12b66, %r14
and $6596, %r11
vmovups (%r14), %ymm2
...
nop
add $29064, %rsi
lea addresses_WC_ht+0x16966, %rsi
lea addresses_A_ht+0x748e, %rdi
nop
sub %rdx, %rdx
mov $14, %rcx
rep movsl
...
nop
sub $7331, %rsi
lea addresses_A_ht+0x5166, %rsi
lea addresses_A_ht+0x1c4a6, %rdi
xor %r8, %r8
mov $78, %rcx
rep movsw
nop
...
nop
add $18593, %r11
lea addresses_WC_ht+0x10a66, %r11
nop
nop
and $63328, %r14
movups (%r11), %xmm3
