...
push %rdx
push %rsi
lea addresses_WC_ht+0x121d7, %rbx
nop
add $36972, %rcx
movb (%rbx), %r13b
nop
...
nop
and %r15, %r15
lea addresses_D_ht+0x168b5, %r15
nop
nop
and %rcx, %rcx
mov (%r15), %edx
...
nop
xor %rdx, %rdx
lea addresses_normal_ht+0x14a47, %rsi
nop
nop
nop
inc %r9
...
nop
and %rbx, %rbx
lea addresses_D_ht+0x1ad1f, %rsi
lea addresses_normal_ht+0x98c7, %rdi
clflush (%rdi)
nop
nop
add %rdx, %rdx
...
// Store
lea addresses_normal+0x21c7, %rdx
nop
nop
nop
nop
...
{'OP': 'STOR', 'dst': {'same': False, 'congruent': 0, 'NT': True, 'type': 'addresses_D', 'size': 1, 'AVXalign': False}}
{'src': {'same': False, 'congruent': 7, 'NT': False, 'type': 'addresses_PSE', 'size': 16, 'AVXalign': False}, 'OP': 'LOAD'}
{'OP': 'STOR', 'dst': {'same': False, 'congruent': 7, 'NT': False, 'type': 'addresses_normal', 'size': 8, 'AVXalign': True}}
[Faulty Load]
