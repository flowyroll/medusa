...
push %rdi
push %rsi
lea addresses_normal_ht+0xe8ed, %rsi
lea addresses_normal_ht+0x15c18, %rdi
clflush (%rsi)
nop
nop
nop
...
nop
add %r14, %r14
lea addresses_normal_ht+0xf318, %r8
nop
nop
and $44903, %r13
mov (%r8), %ecx
nop
add $52688, %rsi
lea addresses_WT_ht+0xb8d8, %rsi
nop
nop
nop
xor $63248, %r13
...
// Store
lea addresses_normal+0xa295, %r12
inc %rax
movw $0x5152, (%r12)
and $13848, %r15

// Faulty Load
lea addresses_WC+0x19318, %r12
nop
add %r9, %r9
mov (%r12), %edi
lea oracles, %r9
...
{'OP': 'STOR', 'dst': {'type': 'addresses_US', 'size': 1, 'AVXalign': True, 'NT': False, 'congruent': 3, 'same': False}}
