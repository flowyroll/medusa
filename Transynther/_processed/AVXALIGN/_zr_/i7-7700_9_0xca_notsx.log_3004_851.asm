...
nop
cmp $23935, %rsi
lea addresses_WC_ht+0xfe7a, %r12
nop
nop
nop
nop
...
nop
xor $59401, %rbp
lea addresses_WT_ht+0x486a, %r12
and %rdx, %rdx
mov $0x6162636465666768, %r10
movq %r10, %xmm3
vmovups %ymm3, (%r12)
sub $56436, %rdx
lea addresses_WT_ht+0x42ea, %rsi
lea addresses_A_ht+0x1331a, %rdi
nop
nop
nop
and $53446, %rbx
...
rep movsq
add %r10, %r10
lea addresses_A_ht+0x606a, %rsi
lea addresses_WC_ht+0x6faa, %rdi
dec %rdx
mov $10, %rcx
rep movsw
nop
...
// Store
lea addresses_A+0x8c6a, %rdi
sub %rax, %rax
movl $0x51525354, (%rdi)
and %rcx, %rcx

// Store
lea addresses_UC+0x1bcaa, %rcx
nop
nop
nop
nop
...
// Faulty Load
lea addresses_normal+0x4e6a, %rdi
nop
nop
nop
nop
...
{'src': {'congruent': 7, 'same': False, 'type': 'addresses_A_ht'}, 'dst': {'congruent': 6, 'same': False, 'type': 'addresses_WC_ht'}, 'OP': 'REPM'}
{'00': 3004}
