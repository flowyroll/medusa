...
nop
add %r15, %r15
lea addresses_WC_ht+0x5c38, %rdi
nop
nop
xor $63964, %rsi
mov (%rdi), %dx
sub $31321, %rdi
lea addresses_WC_ht+0x13538, %rsi
lea addresses_WC_ht+0x156d8, %rdi
nop
nop
nop
xor %rbp, %rbp
...
nop
sub $10364, %r11
lea addresses_WT_ht+0x4bb8, %rsi
lea addresses_D_ht+0x1e9fa, %rdi
inc %rbp
mov $22, %rcx
rep movsb
nop
...
// Faulty Load
lea addresses_normal+0xcc38, %rdi
nop
sub $54972, %r11
movaps (%rdi), %xmm0
vpextrq $0, %xmm0, %rcx
...
{'OP': 'REPM', 'src': {'same': False, 'congruent': 7, 'type': 'addresses_A_ht'}, 'dst': {'same': True, 'congruent': 9, 'type': 'addresses_UC_ht'}}
