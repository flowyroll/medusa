...
nop
and $60208, %r10
lea addresses_WC_ht+0x1bc35, %rax
nop
nop
nop
nop
...
mov (%rax), %di
and %r10, %r10
lea addresses_WC_ht+0x9d25, %rsi
lea addresses_D_ht+0x1eb35, %rdi
nop
nop
nop
nop
...
{'OP': 'REPM', 'src': {'same': False, 'congruent': 4, 'type': 'addresses_WC_ht'}, 'dst': {'same': True, 'congruent': 7, 'type': 'addresses_D_ht'}}
{'00': 21829}
