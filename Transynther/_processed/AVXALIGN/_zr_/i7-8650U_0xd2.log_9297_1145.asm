...
push %rdi
push %rsi
lea addresses_normal_ht+0x10e58, %rsi
lea addresses_A_ht+0x1ccf0, %rdi
clflush (%rsi)
cmp %r12, %r12
mov $2, %rcx
rep movsl
xor %rax, %rax
lea addresses_UC_ht+0x12658, %r9
cmp %r8, %r8
...
nop
xor %rsi, %rsi
lea addresses_normal_ht+0x7f8a, %rsi
nop
nop
cmp %r9, %r9
movb (%rsi), %r12b
nop
xor %rcx, %rcx
lea addresses_UC_ht+0x14000, %rax
sub %r9, %r9
mov (%rax), %r8d
nop
nop
...
nop
inc %rdi
lea addresses_WC_ht+0x63cf, %rax
xor $58863, %r12
movl $0x61626364, (%rax)
nop
nop
cmp %r8, %r8
lea addresses_D_ht+0x1c938, %rcx
nop
nop
inc %r9
mov (%rcx), %r12
...
nop
and $11997, %rsi
lea addresses_D_ht+0x1df58, %rsi
lea addresses_D_ht+0x4558, %rdi
cmp %r15, %r15
mov $112, %rcx
rep movsq
nop
...
{'OP': 'LOAD', 'src': {'type': 'addresses_D_ht', 'size': 8, 'AVXalign': True, 'NT': True, 'congruent': 4, 'same': False}}
