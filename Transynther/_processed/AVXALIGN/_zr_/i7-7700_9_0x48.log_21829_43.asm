...
push %rdi
push %rdx
lea addresses_UC_ht+0x86ed, %rbx
nop
nop
nop
nop
...
vpextrq $1, %xmm0, %rdx
cmp $25207, %r8
lea addresses_normal_ht+0x15851, %r8
add %r13, %r13
movb (%r8), %al
nop
nop
nop
inc %r13
lea addresses_WT_ht+0xc5d1, %rbp
nop
nop
nop
nop
...
nop
and $17914, %rbp
lea addresses_WC_ht+0xca6f, %rdi
cmp $46553, %r8
movups (%rdi), %xmm7
vpextrq $1, %xmm7, %rdx
nop
nop
cmp %rbx, %rbx
lea addresses_normal_ht+0x10251, %rbp
clflush (%rbp)
nop
nop
nop
