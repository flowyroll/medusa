...
push %rbx
push %rsi
lea addresses_normal_ht+0x1d194, %rsi
nop
nop
nop
nop
...
nop
lfence
lea addresses_UC_ht+0x4594, %rbx
cmp %rax, %rax
movl $0x61626364, (%rbx)
nop
nop
...
nop
inc %rax
lea addresses_UC_ht+0x1d814, %r11
nop
nop
inc %r9
movb $0x61, (%r11)
...
vmovups %ymm7, (%rsi)
sub %r13, %r13
lea addresses_WC_ht+0x15d94, %r13
nop
nop
nop
nop
...
{'dst': {'NT': False, 'AVXalign': False, 'size': 1, 'congruent': 9, 'same': True, 'type': 'addresses_WC_ht'}, 'OP': 'STOR'}
{'00': 21829}
