...
movb $0x61, (%rbx)
dec %rax
lea addresses_normal_ht+0xe903, %rdi
sub %r11, %r11
mov (%rdi), %rcx
nop
nop
...
nop
cmp $47087, %rax
lea addresses_normal_ht+0xa0e3, %r8
nop
cmp %rbx, %rbx
...
nop
cmp %r11, %r11
lea addresses_normal_ht+0x1cb53, %rsi
lea addresses_UC_ht+0x16ccb, %rdi
nop
and $12151, %r12
mov $27, %rcx
rep movsl
...
lea addresses_WC_ht+0x6787, %rdi
clflush (%rsi)
nop
nop
nop
...
nop
xor $395, %rsi
lea addresses_normal_ht+0x15fbf, %rsi
nop
nop
nop
nop
...
nop
dec %r12
lea addresses_D_ht+0x12943, %rax
nop
nop
nop
nop
...
nop
add $43250, %rcx
lea addresses_normal_ht+0x7ddd, %rsi
lea addresses_WT_ht+0xea13, %rdi
xor %r8, %r8
mov $90, %rcx
rep movsq
nop
...
nop
sub %rbx, %rbx
lea addresses_WT_ht+0x1bb43, %rsi
lea addresses_D_ht+0x7de3, %rdi
add %r12, %r12
mov $2, %rcx
rep movsl
nop
...
nop
xor %r11, %r11
lea addresses_normal_ht+0xff59, %rdi
nop
nop
and %r8, %r8
mov (%rdi), %cx
...
nop
cmp %rdi, %rdi
lea addresses_WT_ht+0xc823, %rsi
nop
nop
nop
cmp $40745, %rax
...
nop
cmp %rcx, %rcx
lea addresses_A_ht+0x1b683, %rsi
lea addresses_WT_ht+0x663, %rdi
clflush (%rdi)
nop
nop
nop
...
nop
sub %r11, %r11
lea addresses_WT_ht+0xe790, %rsi
lea addresses_UC_ht+0x1b163, %rdi
cmp $33918, %rax
mov $11, %rcx
rep movsl
nop
...
// Load
lea addresses_normal+0x1be63, %r9
and %rdi, %rdi
mov (%r9), %r13w
nop
nop
...
{'OP': 'REPM', 'src': {'type': 'addresses_normal_ht', 'congruent': 3, 'same': True}, 'dst': {'type': 'addresses_UC_ht', 'congruent': 1, 'same': True}}
...
{'OP': 'REPM', 'src': {'type': 'addresses_normal_ht', 'congruent': 1, 'same': True}, 'dst': {'type': 'addresses_WT_ht', 'congruent': 4, 'same': False}}
...
{'OP': 'LOAD', 'src': {'type': 'addresses_WT_ht', 'size': 32, 'AVXalign': True, 'NT': False, 'congruent': 5, 'same': False}}
{'OP': 'REPM', 'src': {'type': 'addresses_A_ht', 'congruent': 5, 'same': False}, 'dst': {'type': 'addresses_WT_ht', 'congruent': 6, 'same': False}}
{'OP': 'REPM', 'src': {'type': 'addresses_WT_ht', 'congruent': 0, 'same': False}, 'dst': {'type': 'addresses_UC_ht', 'congruent': 6, 'same': False}}
{'00': 9339}
