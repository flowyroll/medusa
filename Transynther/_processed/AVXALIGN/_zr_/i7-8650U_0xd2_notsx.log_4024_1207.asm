...
push %rdx
push %rsi
lea addresses_WT_ht+0x1b008, %r12
clflush (%r12)
inc %rsi
movw $0x6162, (%r12)
nop
add $60568, %rdx
lea addresses_UC_ht+0x1ee2, %rsi
lea addresses_normal_ht+0xaaf8, %rdi
nop
sub $35747, %r11
mov $93, %rcx
rep movsb
...
nop
xor $39750, %rsi
lea addresses_UC_ht+0x16008, %r10
clflush (%r10)
nop
and $14220, %r12
movl $0x61626364, (%r10)
...
nop
dec %rdi
lea addresses_WC_ht+0x1443, %rsi
lea addresses_A_ht+0x7108, %rdi
nop
nop
nop
nop
...
nop
and $20171, %r11
lea addresses_D_ht+0x1d808, %r11
nop
nop
nop
nop
