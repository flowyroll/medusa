...
push %rdi
push %rsi
lea addresses_WT_ht+0x5f72, %rbx
sub $45154, %r8
vmovups (%rbx), %ymm5
...
nop
and %rax, %rax
lea addresses_UC_ht+0xad72, %rsi
...
nop
cmp $46693, %r15
lea addresses_WT_ht+0x3a3e, %rbx
nop
nop
nop
nop
...
nop
inc %r12
lea addresses_D_ht+0x3e70, %rsi
lea addresses_D_ht+0x4f72, %rdi
nop
nop
cmp $63367, %r15
mov $25, %rcx
...
nop
sub $56952, %r15
lea addresses_normal_ht+0x1d692, %r15
sub $13127, %rcx
...
{'OP': 'REPM', 'src': {'same': False, 'type': 'addresses_D_ht', 'congruent': 1}, 'dst': {'same': False, 'type': 'addresses_D_ht', 'congruent': 8}}
