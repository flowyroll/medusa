...
push %rdi
push %rsi
lea addresses_A_ht+0x120dd, %rax
nop
and %r15, %r15
vmovups (%rax), %ymm5
...
nop
add $59405, %r8
lea addresses_WT_ht+0x4b88, %r14
nop
nop
nop
nop
...
nop
xor %r15, %r15
lea addresses_UC_ht+0x12cc, %rax
clflush (%rax)
dec %r15
movl $0x61626364, (%rax)
add %rsi, %rsi
lea addresses_WT_ht+0x78ad, %rsi
...
nop
cmp $48217, %r8
lea addresses_normal_ht+0x19c4, %rsi
lea addresses_WT_ht+0x1b79d, %rdi
nop
nop
nop
nop
...
{'OP': 'STOR', 'dst': {'type': 'addresses_A_ht', 'size': 32, 'AVXalign': False, 'NT': True, 'congruent': 1, 'same': False}}
