...
nop
add %rbx, %rbx
lea addresses_UC_ht+0x19101, %rsi
lea addresses_A_ht+0x10a01, %rdi
nop
nop
nop
cmp $1489, %r12
...
nop
cmp $40100, %r8
lea addresses_D_ht+0x1db01, %rsi
nop
nop
inc %r11
mov (%rsi), %rcx
...
nop
dec %r12
lea addresses_WC_ht+0x2881, %rsi
lea addresses_normal_ht+0x23e1, %rdi
nop
nop
nop
nop
...
nop
and %rbx, %rbx
lea addresses_WC_ht+0xf621, %rdi
dec %r12
movl $0x61626364, (%rdi)
nop
nop
mfence
lea addresses_WC_ht+0xfffc, %rbx
nop
nop
nop
add %rcx, %rcx
...
nop
cmp $21416, %r12
lea addresses_A_ht+0x15881, %rsi
lea addresses_normal_ht+0x3403, %rdi
clflush (%rsi)
clflush (%rdi)
cmp %r8, %r8
mov $123, %rcx
...
nop
xor %r12, %r12
lea addresses_normal_ht+0x1c801, %rsi
lea addresses_WC_ht+0x13201, %rdi
nop
nop
nop
add $5255, %r8
...
<gen_prepare_buffer>
{'OP': 'REPM', 'src': {'type': 'addresses_UC_ht', 'congruent': 10, 'same': False}, 'dst': {'type': 'addresses_WC_ht', 'congruent': 10, 'same': True}}
{'OP': 'STOR', 'dst': {'type': 'addresses_WC_ht', 'AVXalign': False, 'congruent': 10, 'size': 32, 'same': False, 'NT': False}}
{'OP': 'REPM', 'src': {'type': 'addresses_UC_ht', 'congruent': 8, 'same': False}, 'dst': {'type': 'addresses_A_ht', 'congruent': 8, 'same': False}}
{'OP': 'LOAD', 'src': {'type': 'addresses_D_ht', 'AVXalign': False, 'congruent': 6, 'size': 8, 'same': False, 'NT': False}}
{'OP': 'REPM', 'src': {'type': 'addresses_WC_ht', 'congruent': 7, 'same': False}, 'dst': {'type': 'addresses_normal_ht', 'congruent': 5, 'same': False}}
...
{'OP': 'REPM', 'src': {'type': 'addresses_A_ht', 'congruent': 6, 'same': False}, 'dst': {'type': 'addresses_normal_ht', 'congruent': 1, 'same': False}}
