...
nop
and %rdx, %rdx
lea addresses_normal_ht+0x5548, %r15
nop
nop
dec %r10
mov (%r15), %r14
...
nop
sub %r10, %r10
lea addresses_UC_ht+0x1d94c, %rsi
nop
inc %r8
mov (%rsi), %r14d
nop
nop
xor %rsi, %rsi
lea addresses_UC_ht+0xdd48, %r15
dec %r10
...
nop
cmp %r8, %r8
lea addresses_UC_ht+0x162e0, %rsi
lea addresses_WC_ht+0x18e48, %rdi
nop
nop
nop
nop
...
nop
add $37291, %rdi
lea addresses_normal_ht+0x1d0f0, %rsi
lea addresses_A_ht+0xd90f, %rdi
nop
nop
nop
nop
...
nop
sub %r15, %r15
lea addresses_WT_ht+0x1ec48, %rsi
lea addresses_UC_ht+0x16247, %rdi
clflush (%rdi)
nop
nop
nop
...
// Store
lea addresses_normal+0x15b48, %rbp
nop
nop
nop
nop
...
{'OP': 'REPM', 'src': {'same': False, 'congruent': 1, 'type': 'addresses_UC_ht'}, 'dst': {'same': False, 'congruent': 8, 'type': 'addresses_WC_ht'}}
