...
push %rdx
push %rsi
lea addresses_A_ht+0x15f86, %rcx
nop
nop
nop
nop
...
nop
inc %rbx
lea addresses_normal_ht+0xa886, %rsi
lea addresses_A_ht+0x3a06, %rdi
nop
add $36076, %rdx
mov $33, %rcx
rep movsl
...
lea addresses_normal_ht+0xa19e, %rdi
clflush (%rsi)
nop
nop
nop
...
nop
cmp $43341, %rbx
lea addresses_D_ht+0xa486, %rsi
lea addresses_WC_ht+0x3206, %rdi
sub %r15, %r15
mov $66, %rcx
rep movsq
nop
...
nop
inc %r11
lea addresses_WC_ht+0xa966, %rsi
lea addresses_D_ht+0xbbda, %rdi
nop
nop
nop
nop
...
{'src': {'same': False, 'congruent': 7, 'NT': False, 'type': 'addresses_UC', 'size': 2, 'AVXalign': False}, 'OP': 'LOAD'}
[Faulty Load]
...
{'src': {'type': 'addresses_normal_ht', 'congruent': 10, 'same': False}, 'OP': 'REPM', 'dst': {'type': 'addresses_A_ht', 'congruent': 7, 'same': True}}
