...
// REPMOV
lea addresses_A+0xb7f2, %rsi
lea addresses_D+0x17169, %rdi
nop
nop
nop
add %r8, %r8
...
{'OP': 'REPM', 'src': {'same': False, 'congruent': 0, 'type': 'addresses_A'}, 'dst': {'same': True, 'congruent': 0, 'type': 'addresses_D'}}
