...
push %rcx
push %rdx
lea addresses_WC_ht+0xd38c, %r10
nop
nop
nop
cmp %r15, %r15
...
nop
add $36727, %rbx
lea addresses_normal_ht+0x14c0c, %rdx
nop
and $28662, %r12
...
nop
sub %r10, %r10
lea addresses_WT_ht+0x454c, %rbx
clflush (%rbx)
nop
nop
nop
...
nop
dec %rcx
lea addresses_UC_ht+0x2230, %r15
nop
nop
nop
nop
...
nop
cmp $43492, %rdx
lea addresses_WT_ht+0xd40c, %r10
nop
nop
nop
nop
...
nop
and $43508, %r12
lea addresses_WC_ht+0x182ac, %rdx
nop
inc %r8
...
{'src': {'same': False, 'congruent': 6, 'NT': True, 'type': 'addresses_P', 'size': 2, 'AVXalign': False}, 'OP': 'LOAD'}
...
[Faulty Load]
{'src': {'same': True, 'congruent': 0, 'NT': False, 'type': 'addresses_WC', 'size': 16, 'AVXalign': True}, 'OP': 'LOAD'}
<gen_prepare_buffer>
