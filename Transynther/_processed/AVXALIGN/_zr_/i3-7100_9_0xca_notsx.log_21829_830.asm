...
push %rdx
push %rsi
lea addresses_normal_ht+0x5318, %rbx
nop
nop
sub $30348, %r9
mov (%rbx), %rdi
...
nop
sub %rbx, %rbx
lea addresses_WT_ht+0x1eebc, %r9
and $46966, %r8
...
nop
cmp %r9, %r9
lea addresses_WC_ht+0x182cc, %r8
nop
cmp %r13, %r13
movups (%r8), %xmm3
vpextrq $1, %xmm3, %rdi
...
nop
xor %rdi, %rdi
lea addresses_WC_ht+0xd84c, %rdx
xor $37234, %rdi
mov (%rdx), %r13d
nop
nop
nop
add $17888, %r9
lea addresses_D_ht+0x11ccc, %r12
cmp %rdx, %rdx
...
nop
and $45362, %r13
lea addresses_WC_ht+0x14cc, %rsi
lea addresses_D_ht+0xa24c, %rdi
clflush (%rsi)
nop
cmp $42957, %r12
mov $115, %rcx
...
{'OP': 'STOR', 'dst': {'same': False, 'congruent': 5, 'NT': False, 'type': 'addresses_PSE', 'size': 4, 'AVXalign': True}}
{'OP': 'STOR', 'dst': {'same': False, 'congruent': 5, 'NT': False, 'type': 'addresses_A', 'size': 8, 'AVXalign': True}}
[Faulty Load]
