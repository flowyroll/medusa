...
push %rdi
push %rsi
lea addresses_UC_ht+0x1cd1c, %rsi
lea addresses_normal_ht+0x9e9c, %rdi
nop
nop
and %r13, %r13
mov $38, %rcx
...
mov (%r8), %ecx
sub %r8, %r8
lea addresses_A_ht+0x194f6, %rcx
and $52567, %r8
mov (%rcx), %si
nop
nop
nop
and %r8, %r8
lea addresses_A_ht+0x9cdc, %rsi
lea addresses_A_ht+0x16e22, %rdi
clflush (%rdi)
and %r14, %r14
mov $88, %rcx
rep movsb
...
nop
add $65382, %rcx
lea addresses_normal_ht+0x30ac, %r12
nop
nop
nop
and $44984, %r14
...
nop
cmp %rcx, %rcx
lea addresses_WT_ht+0x289c, %r13
clflush (%r13)
nop
nop
mfence
...
nop
cmp $20577, %r14
lea addresses_WC_ht+0x1149c, %rsi
lea addresses_normal_ht+0xf708, %rdi
nop
nop
nop
sub $43888, %r14
...
<gen_prepare_buffer>
{'OP': 'REPM', 'src': {'type': 'addresses_UC_ht', 'congruent': 5, 'same': False}, 'dst': {'type': 'addresses_normal_ht', 'congruent': 7, 'same': True}}
...
{'OP': 'REPM', 'src': {'type': 'addresses_A_ht', 'congruent': 4, 'same': False}, 'dst': {'type': 'addresses_A_ht', 'congruent': 1, 'same': False}}
...
{'OP': 'STOR', 'dst': {'type': 'addresses_UC_ht', 'size': 16, 'AVXalign': False, 'NT': False, 'congruent': 10, 'same': True}}
