...
lea addresses_WC_ht+0x8c4f, %rdi
nop
nop
inc %r9
mov $81, %rcx
...
nop
xor %rcx, %rcx
lea addresses_WT_ht+0x1435f, %rbp
sub %r14, %r14
movw $0x6162, (%rbp)
nop
nop
nop
cmp $16732, %rbp
lea addresses_WT_ht+0x17f5f, %rdi
nop
nop
nop
nop
...
nop
xor $58272, %r9
lea addresses_A_ht+0xef87, %rsi
lea addresses_D_ht+0x7bb1, %rdi
nop
nop
cmp $38986, %r8
mov $106, %rcx
...
nop
cmp $59305, %rdi
lea addresses_D_ht+0x1284f, %rbp
nop
nop
sub %r14, %r14
movl $0x61626364, (%rbp)
sub %rbp, %rbp
lea addresses_normal_ht+0xe24f, %rsi
nop
nop
nop
nop
...
mov (%rsi), %r14d
sub %rdi, %rdi
lea addresses_WT_ht+0x1b04f, %rsi
lea addresses_normal_ht+0x1bfcf, %rdi
nop
sub %r15, %r15
mov $14, %rcx
rep movsb
...
nop
sub %r8, %r8
lea addresses_normal_ht+0xa04f, %r9
nop
nop
nop
nop
...
{'dst': {'same': True, 'NT': True, 'AVXalign': False, 'size': 4, 'type': 'addresses_D_ht', 'congruent': 11}, 'OP': 'STOR'}
{'OP': 'LOAD', 'src': {'same': False, 'NT': False, 'AVXalign': False, 'size': 4, 'type': 'addresses_normal_ht', 'congruent': 9}}
{'dst': {'same': False, 'congruent': 3, 'type': 'addresses_normal_ht'}, 'OP': 'REPM', 'src': {'same': False, 'congruent': 8, 'type': 'addresses_WT_ht'}}
