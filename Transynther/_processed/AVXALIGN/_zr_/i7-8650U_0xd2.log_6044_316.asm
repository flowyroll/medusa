...
movb (%r14), %al
add $21549, %r12
lea addresses_D_ht+0x1a0fd, %rbx
nop
nop
nop
dec %r13
...
nop
add $29610, %rdx
lea addresses_normal_ht+0x17afd, %rsi
lea addresses_UC_ht+0x15741, %rdi
nop
nop
nop
nop
...
nop
dec %rcx
lea addresses_A_ht+0x1aced, %rsi
nop
nop
nop
add %r10, %r10
...
nop
xor $10274, %rcx
lea addresses_normal_ht+0x7c85, %rsi
lea addresses_D_ht+0x1077d, %rdi
dec %rax
mov $66, %rcx
rep movsl
nop
...
nop
inc %r13
lea addresses_D_ht+0x1a0fd, %rsi
nop
nop
nop
add %r12, %r12
...
nop
cmp $24605, %rdi
lea addresses_UC_ht+0x1d1d, %rax
nop
nop
nop
xor $59444, %rdi
...
nop
cmp $1770, %rax
lea addresses_UC_ht+0xe2fd, %rcx
add $53150, %r12
mov (%rcx), %r10
nop
nop
...
nop
add %r14, %r14
lea addresses_WT_ht+0x122fd, %rsi
lea addresses_WT_ht+0x1e3fd, %rdi
clflush (%rsi)
nop
nop
nop
...
nop
inc %r14
lea addresses_normal_ht+0x1b325, %rbx
nop
nop
dec %rdi
movb $0x61, (%rbx)
...
nop
dec %rdx
lea addresses_WT_ht+0x31fd, %rsi
...
{'OP': 'LOAD', 'src': {'type': 'addresses_A_ht', 'size': 2, 'AVXalign': False, 'NT': False, 'congruent': 3, 'same': True}}
{'OP': 'REPM', 'src': {'type': 'addresses_normal_ht', 'congruent': 3, 'same': False}, 'dst': {'type': 'addresses_D_ht', 'congruent': 6, 'same': False}}
...
{'OP': 'REPM', 'src': {'type': 'addresses_WT_ht', 'congruent': 8, 'same': True}, 'dst': {'type': 'addresses_WT_ht', 'congruent': 1, 'same': False}}
{'00': 6044}
