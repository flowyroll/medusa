...
push %rdi
push %rdx
lea addresses_WC_ht+0x11282, %r13
cmp %r12, %r12
mov (%r13), %di
nop
nop
...
nop
add %r12, %r12
lea addresses_UC_ht+0x14082, %r12
nop
nop
nop
nop
...
nop
sub %r8, %r8
lea addresses_UC_ht+0x17382, %r8
nop
nop
nop
nop
...
nop
dec %rdi
lea addresses_WC_ht+0xfd62, %r15
xor %r9, %r9
...
{'OP': 'STOR', 'dst': {'type': 'addresses_US', 'size': 1, 'AVXalign': True, 'NT': False, 'congruent': 0, 'same': True}}
