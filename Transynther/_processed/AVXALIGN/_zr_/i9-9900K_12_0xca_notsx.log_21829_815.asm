...
push %rdx
push %rsi
lea addresses_WC_ht+0x13700, %r10
nop
nop
nop
nop
...
nop
inc %r11
lea addresses_WC_ht+0x9240, %r13
nop
nop
nop
xor $45439, %r8
...
nop
add $65422, %r10
lea addresses_WT_ht+0x1be40, %r11
nop
nop
dec %r10
...
nop
cmp $24034, %r11
lea addresses_UC_ht+0x16a40, %rsi
lea addresses_normal_ht+0x2fc0, %rdi
nop
nop
nop
nop
...
nop
add %r10, %r10
lea addresses_WT_ht+0x4280, %rdx
nop
nop
nop
nop
...
// Store
lea addresses_normal+0x3370, %rdx
nop
nop
sub %r15, %r15
movw $0x5152, (%rdx)
...
{'OP': 'LOAD', 'src': {'same': False, 'type': 'addresses_WC_ht', 'NT': False, 'AVXalign': True, 'size': 2, 'congruent': 9}}
{'OP': 'STOR', 'dst': {'same': False, 'type': 'addresses_WT_ht', 'NT': False, 'AVXalign': False, 'size': 32, 'congruent': 10}}
{'OP': 'REPM', 'src': {'same': False, 'congruent': 8, 'type': 'addresses_UC_ht'}, 'dst': {'same': False, 'congruent': 7, 'type': 'addresses_normal_ht'}}
