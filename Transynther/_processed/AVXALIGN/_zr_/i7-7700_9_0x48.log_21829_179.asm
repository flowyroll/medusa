...
rep movsq
xor $59965, %rbx
lea addresses_normal_ht+0x15bf4, %rsi
lea addresses_D_ht+0x8c64, %rdi
nop
nop
nop
nop
...
nop
add %r10, %r10
lea addresses_A_ht+0x15f64, %rsi
lea addresses_A_ht+0x14e24, %rdi
nop
add $7887, %r13
mov $94, %rcx
rep movsb
...
nop
xor $14940, %r13
lea addresses_WT_ht+0x1b584, %rsi
nop
nop
nop
xor %r10, %r10
...
nop
cmp %rcx, %rcx
lea addresses_UC_ht+0x5554, %rsi
nop
nop
nop
nop
...
nop
lfence
lea addresses_normal_ht+0x17044, %rsi
lea addresses_UC_ht+0xbe24, %rdi
nop
nop
nop
nop
...
lea addresses_normal_ht+0xcba4, %rdi
nop
nop
and $52575, %r13
mov $32, %rcx
...
nop
cmp %rbp, %rbp
lea addresses_normal_ht+0x1ef14, %r10
nop
nop
nop
and %rsi, %rsi
...
nop
add $33275, %rbx
lea addresses_UC_ht+0x19664, %rsi
lea addresses_A_ht+0x1d224, %rdi
clflush (%rsi)
nop
nop
nop
...
rep movsl
sub %rsi, %rsi
lea addresses_D_ht+0x5554, %rsi
lea addresses_A_ht+0x4624, %rdi
nop
nop
nop
nop
...
nop
add %rdi, %rdi
lea addresses_UC_ht+0x7e24, %rsi
lea addresses_WT_ht+0x190c, %rdi
nop
nop
add $64725, %r14
mov $49, %rcx
...
nop
and $20398, %rbx
lea addresses_WC_ht+0x3e70, %rsi
lea addresses_WT_ht+0x1e854, %rdi
nop
nop
sub %rbp, %rbp
mov $95, %rcx
...
[Faulty Load]
{'OP': 'LOAD', 'src': {'type': 'addresses_UC', 'AVXalign': True, 'congruent': 0, 'size': 2, 'same': True, 'NT': True}}
<gen_prepare_buffer>
...
{'OP': 'REPM', 'src': {'type': 'addresses_normal_ht', 'congruent': 4, 'same': False}, 'dst': {'type': 'addresses_D_ht', 'congruent': 5, 'same': False}}
...
{'OP': 'LOAD', 'src': {'type': 'addresses_D_ht', 'AVXalign': False, 'congruent': 0, 'size': 4, 'same': True, 'NT': False}}
...
{'OP': 'REPM', 'src': {'type': 'addresses_WC_ht', 'congruent': 1, 'same': False}, 'dst': {'type': 'addresses_normal_ht', 'congruent': 7, 'same': False}}
...
{'OP': 'REPM', 'src': {'type': 'addresses_WC_ht', 'congruent': 1, 'same': True}, 'dst': {'type': 'addresses_WT_ht', 'congruent': 4, 'same': False}}
