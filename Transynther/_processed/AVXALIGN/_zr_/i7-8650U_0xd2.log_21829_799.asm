...
lea addresses_UC_ht+0x19dd6, %rdi
nop
nop
nop
and %r12, %r12
...
nop
inc %rdi
lea addresses_normal_ht+0x14d56, %rsi
...
nop
and $43910, %rdi
lea addresses_normal_ht+0x6916, %rsi
lea addresses_normal_ht+0xf156, %rdi
nop
nop
nop
nop
