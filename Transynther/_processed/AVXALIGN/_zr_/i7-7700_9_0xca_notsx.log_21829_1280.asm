...
nop
xor %rbx, %rbx
lea addresses_WC_ht+0x47f2, %r15
nop
nop
nop
mfence
...
nop
and %rbx, %rbx
lea addresses_normal_ht+0x2432, %r15
nop
nop
xor $5056, %rdi
movb $0x61, (%r15)
...
nop
and %rbx, %rbx
lea addresses_UC_ht+0x8f32, %rbx
nop
nop
nop
inc %r15
...
nop
and $4662, %r15
lea addresses_D_ht+0x16232, %rsi
nop
cmp %r14, %r14
...
nop
sub %rcx, %rcx
lea addresses_WC_ht+0x183f6, %rsi
lea addresses_WC_ht+0x7732, %rdi
nop
xor $2038, %r9
mov $104, %rcx
rep movsb
...
nop
and %rbx, %rbx
lea addresses_normal_ht+0x5e72, %rsi
nop
add $52092, %r14
mov (%rsi), %r9w
nop
nop
and $5023, %rbx
lea addresses_UC_ht+0xccf2, %rdi
nop
nop
add $60559, %r10
mov (%rdi), %r15d
...
// Store
lea addresses_normal+0xfdc2, %r15
clflush (%r15)
nop
nop
nop
...
{'dst': {'NT': True, 'AVXalign': False, 'size': 16, 'congruent': 6, 'same': False, 'type': 'addresses_D_ht'}, 'OP': 'STOR'}
