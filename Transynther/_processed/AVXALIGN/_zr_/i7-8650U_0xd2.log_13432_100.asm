...
push %rdx
push %rsi
lea addresses_WC_ht+0x7964, %r14
nop
cmp $18660, %r11
movl $0x61626364, (%r14)
nop
...
nop
xor $38456, %rbp
lea addresses_WT_ht+0x48b8, %rax
nop
nop
nop
nop
...
nop
and $40602, %r14
lea addresses_A_ht+0x17e78, %rsi
lea addresses_UC_ht+0x10af8, %rdi
nop
nop
nop
nop
...
nop
cmp $37898, %r14
lea addresses_WC_ht+0x10078, %rcx
nop
nop
and %rbp, %rbp
movb (%rcx), %dl
...
nop
cmp %rax, %rax
lea addresses_WT_ht+0x14878, %rdi
add %rbp, %rbp
mov (%rdi), %ax
nop
nop
