...
push %rdx
push %rsi
lea addresses_UC_ht+0x16f5, %rsi
lea addresses_D_ht+0xaf5, %rdi
nop
nop
nop
inc %r14
...
nop
xor %r9, %r9
lea addresses_UC_ht+0xcda5, %rdx
nop
add %r13, %r13
...
nop
and $8819, %r14
lea addresses_WT_ht+0x10775, %rcx
nop
nop
nop
cmp $62758, %r9
...
nop
cmp $25065, %r13
lea addresses_UC_ht+0x62f5, %r13
nop
nop
nop
nop
...
nop
cmp $16434, %rdi
lea addresses_WC_ht+0x17de4, %rsi
lea addresses_UC_ht+0x8f5, %rdi
nop
nop
inc %r12
mov $65, %rcx
...
nop
add %r14, %r14
lea addresses_WT_ht+0x11395, %rsi
xor $2470, %r14
...
{'OP': 'LOAD', 'src': {'size': 8, 'NT': False, 'type': 'addresses_WT_ht', 'same': False, 'AVXalign': True, 'congruent': 8}}
...
{'OP': 'REPM', 'src': {'same': True, 'type': 'addresses_WC_ht', 'congruent': 0}, 'dst': {'same': False, 'type': 'addresses_UC_ht', 'congruent': 10}}
