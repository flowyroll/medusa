...
nop
and $39704, %rdx
lea addresses_WC_ht+0x1eb53, %rsi
inc %rbp
...
nop
dec %rbp
lea addresses_normal_ht+0x132b3, %rsi
lea addresses_WT_ht+0x173c7, %rdi
add $35463, %r13
mov $99, %rcx
rep movsb
nop
...
nop
add %rbp, %rbp
lea addresses_normal_ht+0x1cf5f, %rsi
lea addresses_normal_ht+0xeb2b, %rdi
nop
nop
nop
nop
...
nop
add $25599, %rdi
lea addresses_A_ht+0xd5f3, %rsi
lea addresses_normal_ht+0xf9f3, %rdi
clflush (%rdi)
nop
nop
nop
...
nop
dec %r12
lea addresses_WT_ht+0x1d913, %r12
nop
nop
nop
nop
...
nop
add $30834, %rsi
lea addresses_UC_ht+0x35f3, %rdi
nop
nop
nop
sub $17576, %r11
...
nop
cmp $2645, %r13
lea addresses_WC_ht+0x4bc1, %rsi
lea addresses_normal_ht+0x16974, %rdi
nop
nop
nop
nop
...
{'OP': 'REPM', 'src': {'type': 'addresses_A_ht', 'congruent': 11, 'same': False}, 'dst': {'type': 'addresses_normal_ht', 'congruent': 10, 'same': False}}
