...
push %rdi
push %rsi
lea addresses_normal_ht+0x97f2, %r10
nop
nop
nop
nop
...
nop
sub %r15, %r15
lea addresses_WT_ht+0xe437, %rsi
lea addresses_UC_ht+0x1ad37, %rdi
clflush (%rdi)
nop
nop
nop
...
lea addresses_UC_ht+0x11137, %rdi
xor %r9, %r9
mov $117, %rcx
rep movsb
nop
...
// REPMOV
lea addresses_WC+0x1c637, %rsi
lea addresses_D+0x19d3, %rdi
nop
add $2753, %rbp
mov $78, %rcx
rep movsl
...
{'src': {'type': 'addresses_WC', 'congruent': 8, 'same': False}, 'dst': {'type': 'addresses_D', 'congruent': 2, 'same': False}, 'OP': 'REPM'}
[Faulty Load]
...
{'src': {'type': 'addresses_WT_ht', 'congruent': 8, 'same': True}, 'dst': {'type': 'addresses_UC_ht', 'congruent': 10, 'same': False}, 'OP': 'REPM'}
