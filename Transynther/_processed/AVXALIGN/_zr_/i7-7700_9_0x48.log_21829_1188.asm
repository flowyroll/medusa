...
push %rdx
push %rsi
lea addresses_WC_ht+0x85ef, %rdx
nop
nop
nop
xor %r8, %r8
...
nop
xor $30559, %r15
lea addresses_A_ht+0x6505, %rsi
lea addresses_UC_ht+0x197f3, %rdi
nop
and $7981, %r10
mov $118, %rcx
rep movsl
cmp $19449, %rdx
lea addresses_D_ht+0x99b3, %rsi
clflush (%rsi)
cmp $38210, %rcx
movw $0x6162, (%rsi)
nop
...
nop
cmp $52281, %r11
lea addresses_WT_ht+0x19fbe, %r10
clflush (%r10)
nop
dec %rdx
movups (%r10), %xmm4
...
nop
add $44141, %r11
lea addresses_normal_ht+0x11e48, %rsi
lea addresses_normal_ht+0x2eb3, %rdi
nop
nop
nop
and $26624, %r15
...
{'OP': 'REPM', 'src': {'type': 'addresses_A_ht', 'congruent': 1, 'same': False}, 'dst': {'type': 'addresses_UC_ht', 'congruent': 6, 'same': True}}
...
{'OP': 'REPM', 'src': {'type': 'addresses_normal_ht', 'congruent': 0, 'same': False}, 'dst': {'type': 'addresses_normal_ht', 'congruent': 7, 'same': False}}
