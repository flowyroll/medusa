...
push %rdi
push %rdx
lea addresses_WC_ht+0x11fd0, %rdi
inc %rdx
mov (%rdi), %rax
sub $21848, %rbx
lea addresses_D_ht+0x157d0, %r12
nop
cmp %rdi, %rdi
vmovups (%r12), %ymm3
...
nop
and %rax, %rax
lea addresses_UC_ht+0x169ea, %r13
xor $48110, %rbx
...
nop
inc %rdx
lea addresses_A_ht+0x19bd0, %rbx
nop
and $59815, %rdx
movw $0x6162, (%rbx)
nop
