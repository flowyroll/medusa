...
push %rdi
push %rsi
lea addresses_normal_ht+0xe64a, %r11
nop
nop
nop
add $23687, %r12
...
vmovups %ymm7, (%r11)
add $8825, %r8
lea addresses_WT_ht+0x31ca, %rsi
lea addresses_UC_ht+0xa6ca, %rdi
clflush (%rdi)
nop
nop
nop
...
nop
cmp %rsi, %rsi
lea addresses_WC_ht+0xadca, %r11
nop
nop
nop
nop
...
movw $0x6162, (%r10)
sub %r8, %r8
lea addresses_UC_ht+0x41ca, %r12
nop
nop
dec %r10
...
nop
xor %rcx, %rcx
lea addresses_D_ht+0x1840a, %r12
nop
nop
dec %r10
...
nop
add %r12, %r12
lea addresses_WT_ht+0x121ca, %r8
add %rax, %rax
movb $0x61, (%r8)
nop
nop
...
{'OP': 'LOAD', 'src': {'size': 1, 'NT': False, 'type': 'addresses_A', 'same': False, 'AVXalign': False, 'congruent': 5}}
[Faulty Load]
...
{'OP': 'LOAD', 'src': {'size': 32, 'NT': False, 'type': 'addresses_WC_ht', 'same': False, 'AVXalign': True, 'congruent': 9}}
