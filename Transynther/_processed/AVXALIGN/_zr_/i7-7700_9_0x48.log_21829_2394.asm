...
push %rdx
push %rsi
lea addresses_WT_ht+0xe8fa, %rbp
nop
nop
nop
nop
...
mov (%rbp), %cx
xor %rbp, %rbp
lea addresses_WT_ht+0x15aba, %rsi
lea addresses_WT_ht+0x1ad3a, %rdi
clflush (%rsi)
clflush (%rdi)
nop
nop
...
rep movsq
and %rcx, %rcx
lea addresses_UC_ht+0x130fa, %r15
nop
nop
nop
nop
...
nop
and $56984, %r15
lea addresses_WC_ht+0x1e4fa, %rcx
nop
nop
nop
nop
...
nop
xor %rdi, %rdi
lea addresses_D_ht+0x1a8fa, %rbp
add $18273, %rsi
movb $0x61, (%rbp)
nop
nop
