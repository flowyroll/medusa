...
movb $0x61, (%rbp)
mfence
lea addresses_WC_ht+0x159cf, %rsi
lea addresses_UC_ht+0x1108f, %rdi
nop
nop
nop
nop
...
nop
and $11739, %rdi
lea addresses_UC_ht+0x1d09f, %rsi
lea addresses_WT_ht+0x7abf, %rdi
nop
nop
nop
nop
...
nop
sub $64132, %rdi
lea addresses_UC_ht+0x1583f, %rsi
...
vpextrq $1, %xmm5, %rbp
cmp $60703, %rdi
lea addresses_normal_ht+0x1eeff, %rdi
nop
nop
cmp %r15, %r15
movups (%rdi), %xmm7
...
nop
dec %r8
lea addresses_UC_ht+0x693f, %rcx
nop
nop
nop
cmp %r14, %r14
...
movups %xmm0, (%rcx)
inc %r15
lea addresses_WC_ht+0x17eb7, %rsi
lea addresses_WT_ht+0xe67f, %rdi
nop
nop
and $15219, %r15
mov $6, %rcx
...
nop
xor %rbp, %rbp
lea addresses_normal_ht+0x1122f, %r8
nop
nop
nop
cmp $20706, %rdi
...
nop
xor $13380, %rsi
lea addresses_normal_ht+0xd6ff, %rsi
nop
add $27343, %rax
movb $0x61, (%rsi)
nop
...
nop
cmp $57211, %rbp
lea addresses_UC_ht+0x1debf, %r15
nop
nop
nop
cmp %rdi, %rdi
...
nop
sub %rcx, %rcx
lea addresses_A_ht+0xb97f, %rsi
lea addresses_UC_ht+0x172ff, %rdi
nop
nop
nop
and $61850, %r14
...
nop
cmp %rax, %rax
lea addresses_normal_ht+0x141f7, %r8
nop
add %r15, %r15
