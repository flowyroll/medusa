...
nop
xor %rsi, %rsi
lea addresses_D_ht+0x135ce, %rax
nop
nop
nop
nop
...
nop
cmp %rcx, %rcx
lea addresses_WT_ht+0x8f1a, %rdx
nop
nop
nop
nop
...
nop
inc %r9
lea addresses_UC_ht+0x11c9a, %rax
add $48795, %rdx
mov (%rax), %edi
nop
nop
...
{'dst': {'type': 'addresses_WT', 'same': False, 'size': 2, 'congruent': 4, 'NT': True, 'AVXalign': False}, 'OP': 'STOR'}
