...
push %rdi
push %rsi
lea addresses_WT_ht+0x356e, %rbp
nop
nop
nop
nop
...
vmovntdq %ymm2, (%rbp)
and %r14, %r14
lea addresses_A_ht+0x17d6e, %rsi
lea addresses_normal_ht+0x1eab8, %rdi
nop
nop
nop
nop
...
nop
xor $61870, %r8
lea addresses_WC_ht+0x10c6e, %rsi
lea addresses_WT_ht+0xb6f8, %rdi
nop
nop
nop
nop
