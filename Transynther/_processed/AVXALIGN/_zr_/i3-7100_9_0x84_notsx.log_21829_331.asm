...
push %rdx
push %rsi
lea addresses_WT_ht+0x5904, %rsi
lea addresses_WC_ht+0x5874, %rdi
nop
nop
nop
nop
...
rep movsw
xor %r13, %r13
lea addresses_WC_ht+0x4104, %rbp
and %r8, %r8
...
nop
sub $232, %rdx
lea addresses_WC_ht+0x11044, %rcx
nop
nop
nop
nop
...
nop
inc %r13
lea addresses_WT_ht+0x1ce64, %rsi
lea addresses_D_ht+0x8ab6, %rdi
inc %rdx
mov $68, %rcx
rep movsq
nop
...
// Store
lea addresses_normal+0x17dc4, %rbp
inc %r14
...
// Load
lea addresses_PSE+0xc59e, %rdx
and $29653, %r14
mov (%rdx), %cx
xor $48724, %r12

// Store
lea addresses_RW+0x1cd84, %r12
nop
nop
nop
inc %r9
