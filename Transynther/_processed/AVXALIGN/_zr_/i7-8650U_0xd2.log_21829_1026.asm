...
push %rdx
push %rsi
lea addresses_WC_ht+0x10105, %rsi
nop
nop
nop
cmp $52268, %rcx
...
nop
inc %rax
lea addresses_D_ht+0x19e7b, %rsi
lea addresses_D_ht+0x1811d, %rdi
nop
nop
nop
nop
...
nop
sub $35385, %rsi
lea addresses_normal_ht+0xe605, %rsi
...
nop
cmp %rdx, %rdx
lea addresses_D_ht+0x10d45, %rdi
nop
nop
nop
dec %rdx
...
nop
and $15116, %rdi
lea addresses_UC_ht+0x4c05, %rsi
lea addresses_UC_ht+0x16105, %rdi
clflush (%rdi)
nop
nop
add %rdx, %rdx
...
{'OP': 'REPM', 'src': {'type': 'addresses_UC_ht', 'congruent': 8, 'same': False}, 'dst': {'type': 'addresses_UC_ht', 'congruent': 11, 'same': True}}
{'00': 21829}
