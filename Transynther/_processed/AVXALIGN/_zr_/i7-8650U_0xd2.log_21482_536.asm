...
nop
sub %r8, %r8
lea addresses_normal_ht+0x139e4, %r11
nop
nop
nop
nop
...
mov (%r11), %r9d
dec %r11
lea addresses_D_ht+0x119e4, %r12
clflush (%r12)
nop
nop
nop
...
movups %xmm6, (%r12)
xor %rdx, %rdx
lea addresses_WT_ht+0x33e4, %r11
nop
nop
add %r10, %r10
movl $0x61626364, (%r11)
...
nop
xor %rdx, %rdx
lea addresses_normal_ht+0x4504, %rsi
lea addresses_A_ht+0x1b6e4, %rdi
nop
nop
cmp $63496, %r12
mov $26, %rcx
...
nop
cmp %rdi, %rdi
lea addresses_WC_ht+0x1af64, %rdx
nop
nop
add %r10, %r10
mov (%rdx), %r12w
nop
cmp %r8, %r8
lea addresses_WC_ht+0x16a64, %rsi
lea addresses_A_ht+0x550c, %rdi
and %r14, %r14
mov $79, %rcx
rep movsw
nop
...
nop
cmp %r9, %r9
lea addresses_D_ht+0x1c1e4, %r10
nop
nop
nop
nop
