...
push %rdx
push %rsi
lea addresses_WC_ht+0x3a5b, %r14
nop
nop
nop
nop
...
nop
sub $18593, %r15
lea addresses_WC_ht+0x14737, %r10
nop
xor %r11, %r11
mov (%r10), %rsi
nop
nop
inc %r10
lea addresses_UC_ht+0x1aef, %r15
nop
nop
cmp $36252, %r10
movups (%r15), %xmm5
...
nop
xor $52036, %r15
lea addresses_WT_ht+0x1e837, %r10
nop
nop
nop
nop
...
movups %xmm6, (%r10)
and %r11, %r11
lea addresses_D_ht+0x1dc87, %rsi
lea addresses_WC_ht+0xfcf7, %rdi
nop
nop
nop
nop
...
nop
inc %r11
lea addresses_normal_ht+0xf1f7, %r11
nop
nop
add $3331, %r10
mov (%r11), %cx
...
// Load
lea addresses_normal+0x8a49, %rax
clflush (%rax)
nop
nop
nop
...
// Load
lea addresses_normal+0xd1f7, %r8
nop
cmp $8413, %r14
mov (%r8), %eax
inc %rax
