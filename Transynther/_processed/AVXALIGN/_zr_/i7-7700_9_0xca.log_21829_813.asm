...
nop
dec %rsi
lea addresses_normal_ht+0x10fde, %r10
nop
sub %rax, %rax
mov (%r10), %edi
nop
...
nop
add $35962, %rbp
lea addresses_normal_ht+0x13a4a, %rdi
nop
nop
nop
nop
...
nop
xor %r10, %r10
lea addresses_A_ht+0xf91e, %rsi
lea addresses_WT_ht+0x4b36, %rdi
nop
nop
nop
cmp %rax, %rax
...
nop
add $20337, %rbp
lea addresses_WC_ht+0xe1ee, %rcx
nop
nop
nop
nop
...
<gen_prepare_buffer>
{'src': {'congruent': 2, 'AVXalign': True, 'same': False, 'size': 16, 'NT': False, 'type': 'addresses_D_ht'}, 'OP': 'LOAD'}
...
{'src': {'congruent': 2, 'same': False, 'type': 'addresses_A_ht'}, 'OP': 'REPM', 'dst': {'congruent': 4, 'same': False, 'type': 'addresses_WT_ht'}}
