...
nop
and %rsi, %rsi
lea addresses_WC_ht+0xd0a9, %rcx
nop
nop
nop
nop
...
nop
sub $17499, %r10
lea addresses_WC_ht+0x1e999, %rax
xor %r15, %r15
...
// Faulty Load
lea addresses_normal+0x2ca9, %r14
nop
add $29830, %r12
movntdqa (%r14), %xmm4
vpextrq $0, %xmm4, %rdi
...
{'dst': {'same': False, 'congruent': 11, 'type': 'addresses_D_ht'}, 'OP': 'REPM', 'src': {'same': False, 'congruent': 5, 'type': 'addresses_WC_ht'}}
