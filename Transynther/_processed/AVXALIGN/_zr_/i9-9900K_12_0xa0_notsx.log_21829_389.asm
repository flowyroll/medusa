...
push %rdx
push %rsi
lea addresses_A_ht+0x14ab8, %rsi
lea addresses_normal_ht+0x130b8, %rdi
nop
nop
nop
nop
...
nop
xor $43234, %r14
lea addresses_WC_ht+0x1ee78, %rsi
lea addresses_normal_ht+0xb0b8, %rdi
nop
nop
nop
nop
...
nop
and $45812, %r14
lea addresses_WC_ht+0x57b8, %rsi
lea addresses_D_ht+0x18b38, %rdi
nop
and $44328, %rdx
mov $30, %rcx
rep movsb
...
<gen_prepare_buffer>
{'src': {'type': 'addresses_A_ht', 'congruent': 10, 'same': False}, 'OP': 'REPM', 'dst': {'type': 'addresses_normal_ht', 'congruent': 7, 'same': False}}
