...
lea addresses_UC_ht+0x12073, %rdi
clflush (%rdi)
nop
nop
nop
...
nop
cmp $26291, %rdi
lea addresses_WT_ht+0x150f3, %rdi
nop
nop
nop
dec %rcx
...
nop
xor $29653, %r10
lea addresses_A_ht+0x77f3, %r8
cmp $30627, %rcx
movl $0x61626364, (%r8)
nop
nop
cmp %rcx, %rcx
lea addresses_UC_ht+0x160f3, %r9
nop
nop
xor $22971, %rax
mov (%r9), %r8
...
nop
add %rsi, %rsi
lea addresses_WT_ht+0x133f3, %rsi
...
nop
and $55266, %rcx
lea addresses_D_ht+0x1d4a3, %rsi
lea addresses_UC_ht+0xb729, %rdi
nop
nop
nop
inc %rax
