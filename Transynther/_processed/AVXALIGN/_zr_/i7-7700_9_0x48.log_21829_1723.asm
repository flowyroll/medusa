...
nop
cmp $43954, %r15
lea addresses_WT_ht+0x16d5, %r15
nop
nop
nop
nop
...
nop
sub $49272, %r9
lea addresses_normal_ht+0x20b5, %rsi
lea addresses_WC_ht+0x18535, %rdi
nop
xor %r10, %r10
mov $19, %rcx
rep movsw
sub $64402, %rcx
lea addresses_UC_ht+0x5475, %rsi
lea addresses_WT_ht+0x12d05, %rdi
nop
nop
nop
nop
...
nop
sub $43258, %rdx
lea addresses_A_ht+0x1ee49, %rsi
lea addresses_UC_ht+0xea35, %rdi
nop
nop
nop
xor $18361, %r10
...
nop
sub %r9, %r9
lea addresses_A_ht+0x1d5cd, %rsi
lea addresses_WC_ht+0x129b5, %rdi
nop
nop
nop
nop
...
nop
xor %r9, %r9
lea addresses_WT_ht+0x12d35, %rdi
nop
nop
nop
nop
...
{'OP': 'REPM', 'src': {'type': 'addresses_UC_ht', 'congruent': 4, 'same': False}, 'dst': {'type': 'addresses_A_ht', 'congruent': 4, 'same': True}}
