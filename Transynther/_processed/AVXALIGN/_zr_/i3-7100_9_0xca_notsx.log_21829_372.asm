...
push %rdi
push %rsi
lea addresses_WT_ht+0x5b3e, %r11
nop
nop
nop
nop
...
nop
and $50289, %r11
lea addresses_D_ht+0xd106, %rsi
lea addresses_normal_ht+0xcd3e, %rdi
nop
nop
cmp $38900, %r14
mov $15, %rcx
...
nop
xor $17906, %r11
lea addresses_A_ht+0x16393, %r12
nop
nop
nop
nop
...
// Store
lea addresses_normal+0x1e5be, %r8
nop
nop
nop
nop
...
// Store
lea addresses_normal+0x12c0e, %rdi
nop
nop
nop
and %r12, %r12
...
{'src': {'type': 'addresses_P', 'congruent': 8, 'same': False}, 'OP': 'REPM', 'dst': {'type': 'addresses_UC', 'congruent': 3, 'same': False}}
{'src': {'same': False, 'congruent': 3, 'NT': False, 'type': 'addresses_UC', 'size': 2, 'AVXalign': False}, 'OP': 'LOAD'}
[Faulty Load]
