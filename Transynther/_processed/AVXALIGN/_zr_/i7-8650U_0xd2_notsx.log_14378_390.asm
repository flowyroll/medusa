...
push %rdx
push %rsi
lea addresses_D_ht+0x145c2, %rsi
nop
nop
add %r9, %r9
mov (%rsi), %rbp
...
nop
cmp $36193, %rsi
lea addresses_A_ht+0x1429c, %rdi
nop
nop
xor $6800, %rsi
...
nop
and %rbp, %rbp
lea addresses_WT_ht+0x7e16, %r15
nop
nop
inc %rdx
mov $0x6162636465666768, %rbx
...
nop
add %rbx, %rbx
lea addresses_A_ht+0xf5f5, %rsi
lea addresses_WC_ht+0x4b96, %rdi
nop
cmp %rbx, %rbx
mov $52, %rcx
rep movsb
...
nop
add %rdi, %rdi
lea addresses_UC_ht+0x12f6, %rcx
nop
nop
nop
nop
