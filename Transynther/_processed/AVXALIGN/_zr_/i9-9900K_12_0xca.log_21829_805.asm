...
push %rdx
push %rsi
lea addresses_A_ht+0x1b91f, %r12
nop
nop
nop
xor $56861, %r13
...
nop
and $24019, %r14
lea addresses_UC_ht+0x13a03, %rsi
lea addresses_UC_ht+0x163d3, %rdi
nop
sub $35357, %r14
mov $120, %rcx
rep movsb
...
nop
inc %r14
lea addresses_WT_ht+0x1d31b, %r14
sub %r12, %r12
mov (%r14), %rdi
nop
nop
...
nop
dec %r13
lea addresses_WT_ht+0x12003, %r14
nop
nop
nop
cmp %rdx, %rdx
...
nop
cmp %r13, %r13
lea addresses_A_ht+0x11c64, %r14
nop
nop
nop
and %rsi, %rsi
...
nop
dec %rsi
lea addresses_UC_ht+0x1373f, %r14
nop
nop
nop
nop
...
nop
cmp %r13, %r13
lea addresses_normal_ht+0x2e03, %rdi
inc %rdx
...
{'OP': 'STOR', 'dst': {'size': 1, 'NT': True, 'type': 'addresses_UC', 'same': False, 'AVXalign': True, 'congruent': 9}}
...
{'OP': 'REPM', 'src': {'same': False, 'type': 'addresses_UC_ht', 'congruent': 3}, 'dst': {'same': True, 'type': 'addresses_UC_ht', 'congruent': 3}}
