...
push %rdi
push %rsi
lea addresses_UC_ht+0x14a5d, %rbp
nop
nop
nop
add %r10, %r10
...
nop
add %r14, %r14
lea addresses_WC_ht+0x1c32a, %rbx
nop
nop
nop
nop
...
mov (%rbx), %rcx
cmp %r13, %r13
lea addresses_WT_ht+0x12f2a, %rbp
clflush (%rbp)
nop
sub %rsi, %rsi
...
nop
and $31729, %rsi
lea addresses_A_ht+0x1c868, %rsi
lea addresses_A_ht+0x252a, %rdi
clflush (%rsi)
nop
nop
nop
...
nop
xor %rbp, %rbp
lea addresses_normal_ht+0xdcaa, %rsi
lea addresses_UC_ht+0xb61a, %rdi
cmp %r13, %r13
mov $92, %rcx
rep movsb
nop
...
<gen_prepare_buffer>
{'OP': 'LOAD', 'src': {'same': True, 'NT': False, 'AVXalign': False, 'size': 1, 'type': 'addresses_UC_ht', 'congruent': 0}}
...
{'dst': {'same': False, 'congruent': 2, 'type': 'addresses_UC_ht'}, 'OP': 'REPM', 'src': {'same': True, 'congruent': 7, 'type': 'addresses_normal_ht'}}
{'00': 21829}
