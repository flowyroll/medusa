...
push %rdx
push %rsi
lea addresses_WT_ht+0x18741, %r15
xor $64071, %r10
...
// Store
lea addresses_normal+0x6641, %rbx
nop
nop
nop
nop
...
{'OP': 'STOR', 'dst': {'size': 4, 'NT': False, 'type': 'addresses_US', 'same': False, 'AVXalign': False, 'congruent': 10}}
