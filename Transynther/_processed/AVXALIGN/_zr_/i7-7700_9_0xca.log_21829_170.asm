...
push %rdi
push %rsi
lea addresses_D_ht+0x1a6b6, %rsi
lea addresses_D_ht+0x5c36, %rdi
nop
nop
xor %rbx, %rbx
mov $75, %rcx
...
nop
xor $4939, %r8
lea addresses_normal_ht+0x198b6, %rcx
nop
nop
sub %rsi, %rsi
...
<gen_prepare_buffer>
{'src': {'congruent': 9, 'same': False, 'type': 'addresses_D_ht'}, 'OP': 'REPM', 'dst': {'congruent': 7, 'same': False, 'type': 'addresses_D_ht'}}
