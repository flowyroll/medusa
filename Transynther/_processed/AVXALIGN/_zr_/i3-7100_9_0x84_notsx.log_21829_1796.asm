...
push %rdi
push %rsi
lea addresses_WT_ht+0xc3c8, %rsi
lea addresses_normal_ht+0x1d1c8, %rdi
nop
and %r10, %r10
mov $80, %rcx
rep movsw
...
nop
sub $22350, %r10
lea addresses_WT_ht+0x14fc8, %rbp
xor $22420, %r13
movb $0x61, (%rbp)
cmp %r13, %r13
lea addresses_A_ht+0x2428, %rdi
nop
nop
nop
dec %r14
...
vpextrq $1, %xmm2, %rbp
add %rdi, %rdi
lea addresses_D_ht+0x18e43, %rdi
nop
nop
nop
dec %r14
movw $0x6162, (%rdi)
add $45167, %r10
lea addresses_UC_ht+0x73c8, %r13
nop
sub %rbp, %rbp
mov (%r13), %r10d
nop
...
nop
mfence
lea addresses_A_ht+0x187c8, %r13
and $5844, %r10
vmovups (%r13), %ymm1
...
nop
xor %rsi, %rsi
lea addresses_D_ht+0xff64, %rsi
sub %rbp, %rbp
mov $0x6162636465666768, %r10
movq %r10, (%rsi)
and $48259, %r10
lea addresses_A_ht+0x7bc8, %rcx
nop
nop
nop
and %rbp, %rbp
movb (%rcx), %r13b
add %r13, %r13
lea addresses_normal_ht+0xaa50, %rsi
lea addresses_A_ht+0x1efb0, %rdi
nop
xor $18093, %r11
mov $124, %rcx
rep movsl
...
<gen_prepare_buffer>
{'src': {'type': 'addresses_WT_ht', 'congruent': 10, 'same': False}, 'dst': {'type': 'addresses_normal_ht', 'congruent': 8, 'same': False}, 'OP': 'REPM'}
{'dst': {'type': 'addresses_WT_ht', 'same': False, 'size': 1, 'congruent': 10, 'NT': False, 'AVXalign': False}, 'OP': 'STOR'}
{'src': {'type': 'addresses_A_ht', 'same': False, 'size': 32, 'congruent': 5, 'NT': False, 'AVXalign': True}, 'OP': 'LOAD'}
