...
nop
xor $62534, %rcx
lea addresses_normal_ht+0x2dc5, %r12
clflush (%r12)
nop
nop
and $38231, %r13
...
nop
add %r13, %r13
lea addresses_normal_ht+0x120c5, %r15
nop
nop
nop
nop
...
nop
add $46141, %rax
lea addresses_WC_ht+0x8545, %rsi
lea addresses_WC_ht+0x17aeb, %rdi
nop
xor $963, %r12
mov $29, %rcx
rep movsb
nop
sub $58848, %rdi
lea addresses_UC_ht+0xe945, %rsi
lea addresses_UC_ht+0x1bb5c, %rdi
nop
nop
nop
nop
...
rep movsl
and %rax, %rax
lea addresses_WC_ht+0x2b45, %r13
nop
nop
inc %rcx
movups (%r13), %xmm7
