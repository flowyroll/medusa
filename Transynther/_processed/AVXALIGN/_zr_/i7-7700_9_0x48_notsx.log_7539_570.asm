...
lea addresses_WC_ht+0x13ef0, %rdi
dec %r12
mov $31, %rcx
rep movsq
nop
...
nop
dec %r13
lea addresses_WT_ht+0x5120, %rsi
lea addresses_D_ht+0x19b66, %rdi
nop
nop
dec %rax
mov $81, %rcx
...
nop
inc %r12
lea addresses_D_ht+0x1c8f0, %rdi
nop
nop
nop
nop
...
nop
inc %rcx
lea addresses_normal_ht+0x17410, %rsi
lea addresses_A_ht+0x4d08, %rdi
nop
nop
nop
cmp %r14, %r14
...
[Faulty Load]
{'OP': 'LOAD', 'src': {'same': True, 'NT': True, 'AVXalign': False, 'size': 1, 'type': 'addresses_P', 'congruent': 0}}
<gen_prepare_buffer>
{'dst': {'same': True, 'congruent': 9, 'type': 'addresses_A_ht'}, 'OP': 'REPM', 'src': {'same': False, 'congruent': 0, 'type': 'addresses_A_ht'}}
{'dst': {'same': False, 'congruent': 10, 'type': 'addresses_WC_ht'}, 'OP': 'REPM', 'src': {'same': False, 'congruent': 9, 'type': 'addresses_normal_ht'}}
{'dst': {'same': False, 'congruent': 1, 'type': 'addresses_D_ht'}, 'OP': 'REPM', 'src': {'same': True, 'congruent': 4, 'type': 'addresses_WT_ht'}}
