...
nop
and %rcx, %rcx
lea addresses_WC_ht+0x1861a, %r9
nop
nop
and %rbx, %rbx
movb $0x61, (%r9)
...
nop
dec %rsi
lea addresses_WT_ht+0xea52, %rsi
lea addresses_normal_ht+0x13cc2, %rdi
nop
nop
nop
sub $62660, %r11
...
nop
sub %rdi, %rdi
lea addresses_UC_ht+0xf094, %rdi
nop
nop
nop
nop
...
nop
inc %rcx
lea addresses_normal_ht+0x1d982, %rbx
nop
xor $31474, %r13
...
vpextrq $0, %xmm3, %r9
sub $20960, %rcx
lea addresses_normal_ht+0xd822, %rsi
lea addresses_WC_ht+0x7882, %rdi
nop
inc %r9
mov $70, %rcx
rep movsb
...
nop
xor $14681, %r9
lea addresses_WC_ht+0x106c2, %rsi
lea addresses_normal_ht+0xb13a, %rdi
clflush (%rsi)
and $60720, %rbx
mov $96, %rcx
rep movsb
inc %rcx
lea addresses_A_ht+0x5236, %r13
nop
nop
nop
nop
...
nop
xor $22743, %rsi
lea addresses_A_ht+0x1eec2, %r12
nop
inc %rsi
...
lea addresses_WC_ht+0xf0e2, %rdi
clflush (%rsi)
clflush (%rdi)
and %r11, %r11
mov $54, %rcx
...
nop
inc %r13
lea addresses_UC_ht+0xd022, %rsi
lea addresses_D_ht+0x1c8c2, %rdi
nop
nop
nop
nop
...
nop
xor $58443, %rcx
lea addresses_WT_ht+0x132c2, %r9
nop
nop
nop
nop
...
<gen_prepare_buffer>
{'OP': 'REPM', 'src': {'type': 'addresses_A_ht', 'congruent': 2, 'same': False}, 'dst': {'type': 'addresses_A_ht', 'congruent': 4, 'same': True}}
...
{'OP': 'LOAD', 'src': {'type': 'addresses_WT_ht', 'AVXalign': False, 'congruent': 10, 'size': 8, 'same': True, 'NT': False}}
{'00': 21829}
