...
push %rdi
push %rsi
lea addresses_normal_ht+0x5765, %r11
clflush (%r11)
nop
nop
nop
...
nop
cmp %r8, %r8
lea addresses_normal_ht+0x9ce5, %r9
nop
nop
nop
nop
...
nop
inc %r8
lea addresses_UC_ht+0x19505, %r9
nop
nop
nop
cmp $26239, %rbp
...
nop
inc %r11
lea addresses_WC_ht+0x8005, %rbp
xor $3425, %r11
...
nop
sub $46056, %r15
lea addresses_WT_ht+0x1c905, %r9
nop
nop
and %rax, %rax
vmovups (%r9), %ymm3
...
vpextrq $1, %xmm3, %rbp
inc %r9
lea addresses_normal_ht+0x10e25, %rsi
lea addresses_WT_ht+0x1c625, %rdi
nop
nop
nop
nop
...
{'OP': 'LOAD', 'src': {'same': True, 'NT': False, 'AVXalign': False, 'size': 8, 'type': 'addresses_normal_ht', 'congruent': 3}}
