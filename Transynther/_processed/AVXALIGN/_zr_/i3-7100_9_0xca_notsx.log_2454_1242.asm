...
push %rdx
push %rsi
lea addresses_normal_ht+0x104ef, %rax
and $9521, %rdx
mov (%rax), %r13
sub $23508, %r11
lea addresses_normal_ht+0x6c01, %rsi
lea addresses_A_ht+0x1a284, %rdi
clflush (%rsi)
nop
and %rax, %rax
mov $95, %rcx
...
nop
and $42062, %rdx
lea addresses_normal_ht+0x4c6f, %rsi
lea addresses_A_ht+0x172ef, %rdi
nop
nop
nop
nop
...
// Faulty Load
lea addresses_normal+0xbc6f, %rbx
sub %rsi, %rsi
movaps (%rbx), %xmm7
vpextrq $0, %xmm7, %r8
lea oracles, %rbp
...
{'OP': 'STOR', 'dst': {'same': False, 'congruent': 10, 'NT': False, 'type': 'addresses_A', 'size': 1, 'AVXalign': True}}
...
{'src': {'type': 'addresses_normal_ht', 'congruent': 1, 'same': False}, 'OP': 'REPM', 'dst': {'type': 'addresses_A_ht', 'congruent': 0, 'same': False}}
