...
push %rdi
push %rsi
lea addresses_D_ht+0x142bc, %r10
clflush (%r10)
nop
nop
nop
...
nop
add $61530, %r9
lea addresses_normal_ht+0x1c13c, %r11
nop
add $42409, %rax
movb $0x61, (%r11)
nop
...
nop
add $59149, %r11
lea addresses_WC_ht+0x1db6c, %rsi
lea addresses_D_ht+0xde7c, %rdi
nop
xor %r11, %r11
mov $15, %rcx
rep movsl
...
nop
sub %r11, %r11
lea addresses_D_ht+0x137cc, %rsi
nop
nop
nop
nop
...
nop
add %r13, %r13
lea addresses_normal_ht+0x1ed3c, %r10
nop
nop
nop
cmp $27432, %rcx
...
nop
cmp %r15, %r15
lea addresses_UC_ht+0x16df, %r10
clflush (%r10)
nop
cmp %rdi, %rdi
mov (%r10), %r13w
...
nop
xor $13522, %r9
lea addresses_normal_ht+0x7104, %rsi
lea addresses_normal_ht+0x18714, %rdi
nop
nop
nop
nop
...
nop
xor %rcx, %rcx
lea addresses_D_ht+0x138fc, %rax
nop
inc %rdi
...
nop
cmp %r11, %r11
lea addresses_WT_ht+0xde94, %r10
nop
nop
nop
add $40096, %rsi
...
nop
cmp %r15, %r15
lea addresses_WC_ht+0x1b6bd, %r13
nop
nop
nop
nop
...
movw $0x6162, (%r13)
dec %r13
lea addresses_WT_ht+0xe13c, %rax
nop
nop
nop
dec %rdi
...
{'OP': 'LOAD', 'src': {'type': 'addresses_A_ht', 'size': 4, 'AVXalign': False, 'NT': True, 'congruent': 10, 'same': False}}
