...
push %rdi
push %rsi
lea addresses_A_ht+0x4cfa, %rbx
clflush (%rbx)
sub %r14, %r14
mov (%rbx), %r15w
nop
sub %rcx, %rcx
lea addresses_D_ht+0x198ea, %rsi
sub $52685, %r9
...
nop
sub %rcx, %rcx
lea addresses_normal_ht+0xfc9, %rsi
lea addresses_normal_ht+0x11a9a, %rdi
nop
nop
nop
sub %r9, %r9
...
nop
xor $742, %r15
lea addresses_WC_ht+0x1c59a, %r13
nop
nop
nop
cmp %rdi, %rdi
...
vpextrq $0, %xmm1, %rcx
xor $10614, %r15
lea addresses_WC_ht+0x1096a, %rsi
sub %rbx, %rbx
mov (%rsi), %r15
nop
nop
...
{'src': {'congruent': 0, 'same': False, 'type': 'addresses_normal_ht'}, 'OP': 'REPM', 'dst': {'congruent': 4, 'same': False, 'type': 'addresses_normal_ht'}}
...
{'src': {'congruent': 4, 'AVXalign': False, 'same': False, 'size': 8, 'NT': True, 'type': 'addresses_WC_ht'}, 'OP': 'LOAD'}
{'00': 21829}
