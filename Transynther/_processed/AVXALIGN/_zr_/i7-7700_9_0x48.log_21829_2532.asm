...
push %rdx
push %rsi
lea addresses_A_ht+0x3b90, %rsi
lea addresses_normal_ht+0x4a70, %rdi
nop
nop
add $20905, %rdx
mov $89, %rcx
...
nop
inc %rbp
lea addresses_D_ht+0x16270, %rsi
lea addresses_UC_ht+0x17a88, %rdi
nop
sub %rdx, %rdx
mov $2, %rcx
rep movsl
cmp $20185, %rsi
lea addresses_WC_ht+0x1c800, %r13
clflush (%r13)
nop
and %r9, %r9
...
nop
inc %rbp
lea addresses_UC_ht+0xbb78, %rsi
lea addresses_A_ht+0x162b0, %rdi
cmp $28605, %r15
mov $127, %rcx
rep movsw
nop
nop
and $58131, %r15
lea addresses_WT_ht+0x8b8a, %rsi
lea addresses_A_ht+0x1cf70, %rdi
nop
nop
nop
and %r13, %r13
...
nop
cmp %r15, %r15
lea addresses_WT_ht+0x19110, %rdi
nop
nop
xor %rsi, %rsi
movb $0x61, (%rdi)
