...
push %rdi
push %rsi
lea addresses_normal_ht+0xb12c, %rcx
nop
nop
nop
inc %r9
...
nop
and $38956, %r11
lea addresses_WC_ht+0xa64c, %rsi
lea addresses_normal_ht+0x128ac, %rdi
nop
nop
nop
nop
...
rep movsl
and $44485, %rdi
lea addresses_A_ht+0x10d2c, %rsi
lea addresses_A_ht+0x622c, %rdi
nop
nop
nop
cmp %r15, %r15
...
nop
and %r11, %r11
lea addresses_D_ht+0x16cec, %rsi
nop
nop
nop
nop
...
lea addresses_WT_ht+0x1d57c, %rdi
nop
nop
nop
nop
...
nop
dec %r12
lea addresses_UC_ht+0xa92c, %rsi
clflush (%rsi)
nop
nop
nop
...
{'OP': 'LOAD', 'src': {'type': 'addresses_D_ht', 'AVXalign': False, 'congruent': 6, 'size': 32, 'same': True, 'NT': False}}
{'OP': 'REPM', 'src': {'type': 'addresses_UC_ht', 'congruent': 1, 'same': False}, 'dst': {'type': 'addresses_WT_ht', 'congruent': 2, 'same': False}}
