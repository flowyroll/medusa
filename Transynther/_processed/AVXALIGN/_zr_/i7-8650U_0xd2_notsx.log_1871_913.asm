...
push %rdi
push %rsi
lea addresses_UC_ht+0x7fca, %rsi
lea addresses_normal_ht+0x9738, %rdi
nop
nop
nop
nop
...
rep movsq
xor $26452, %rcx
lea addresses_WT_ht+0x8b58, %rax
nop
nop
nop
nop
...
nop
sub %r11, %r11
lea addresses_WC_ht+0x13c9d, %rsi
lea addresses_A_ht+0x175ca, %rdi
nop
xor $22576, %r13
mov $86, %rcx
rep movsb
cmp %rsi, %rsi
lea addresses_A_ht+0x2947, %rsi
cmp $63719, %r11
mov (%rsi), %rcx
nop
nop
...
nop
and $55720, %rsi
lea addresses_WC_ht+0x1834a, %rax
nop
nop
nop
nop
...
nop
sub $4244, %rdi
lea addresses_WC_ht+0x740a, %r10
nop
nop
nop
nop
...
nop
sub $49820, %r10
lea addresses_UC_ht+0x1ef4a, %rsi
lea addresses_WC_ht+0x1036a, %rdi
nop
dec %r8
mov $91, %rcx
rep movsl
...
nop
xor $5079, %r8
lea addresses_WT_ht+0x104a, %rsi
lea addresses_UC_ht+0xbdca, %rdi
clflush (%rsi)
nop
nop
nop
...
{'OP': 'STOR', 'dst': {'type': 'addresses_P', 'size': 1, 'AVXalign': False, 'NT': False, 'congruent': 0, 'same': True}}
{'OP': 'STOR', 'dst': {'type': 'addresses_WC', 'size': 8, 'AVXalign': False, 'NT': True, 'congruent': 2, 'same': False}}
...
{'OP': 'LOAD', 'src': {'type': 'addresses_WT_ht', 'size': 8, 'AVXalign': True, 'NT': False, 'congruent': 1, 'same': False}}
...
{'OP': 'REPM', 'src': {'type': 'addresses_UC_ht', 'congruent': 10, 'same': True}, 'dst': {'type': 'addresses_WC_ht', 'congruent': 3, 'same': False}}
{'OP': 'REPM', 'src': {'type': 'addresses_WT_ht', 'congruent': 6, 'same': False}, 'dst': {'type': 'addresses_UC_ht', 'congruent': 6, 'same': False}}
{'00': 1871}
