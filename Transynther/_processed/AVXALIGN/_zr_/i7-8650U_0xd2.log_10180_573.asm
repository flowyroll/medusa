...
push %rdi
push %rsi
lea addresses_D_ht+0x3722, %rsi
lea addresses_WC_ht+0x1bd2c, %rdi
nop
add $52879, %r11
mov $50, %rcx
rep movsl
...
nop
sub $30368, %r8
lea addresses_WC_ht+0xd32c, %rax
nop
nop
nop
nop
...
mov (%rax), %di
inc %r11
lea addresses_UC_ht+0xe32c, %r11
nop
dec %rsi
...
nop
xor %rdi, %rdi
lea addresses_WC_ht+0x1924c, %rsi
lea addresses_UC_ht+0xe384, %rdi
clflush (%rdi)
nop
nop
nop
...
nop
dec %rax
lea addresses_WC_ht+0x1812c, %rsi
lea addresses_D_ht+0x1119c, %rdi
clflush (%rdi)
nop
and $57693, %r13
mov $51, %rcx
...
nop
add $44430, %r11
lea addresses_D_ht+0x174ac, %rdi
nop
nop
sub $21466, %r11
movw $0x6162, (%rdi)
...
nop
lfence
lea addresses_normal_ht+0x1be9c, %rax
nop
nop
nop
nop
...
nop
cmp %r11, %r11
lea addresses_WC_ht+0x1e49c, %r8
sub %rsi, %rsi
movl $0x61626364, (%r8)
nop
nop
nop
sub $26326, %r8
lea addresses_normal_ht+0x1532c, %rdi
nop
xor %rcx, %rcx
mov (%rdi), %r11d
nop
