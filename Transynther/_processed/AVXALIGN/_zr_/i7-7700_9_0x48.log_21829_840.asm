...
push %rdx
push %rsi
lea addresses_normal_ht+0x16e0f, %rdi
inc %r10
movl $0x61626364, (%rdi)
nop
nop
...
nop
dec %r10
lea addresses_normal_ht+0x1a61f, %r11
cmp %r10, %r10
vmovups (%r11), %ymm3
...
nop
and %r11, %r11
lea addresses_UC_ht+0x1ac7f, %rsi
lea addresses_A_ht+0x12adf, %rdi
nop
nop
nop
inc %rdx
...
nop
inc %rdi
lea addresses_UC_ht+0x189a6, %rsi
lea addresses_D_ht+0x1b21f, %rdi
nop
nop
cmp %rbx, %rbx
mov $17, %rcx
...
nop
sub %rcx, %rcx
lea addresses_WC_ht+0x961f, %r11
nop
nop
nop
add $49912, %rsi
...
lea addresses_A_ht+0x19c01, %rdi
nop
nop
cmp $28629, %rbx
mov $43, %rcx
...
nop
add %rcx, %rcx
lea addresses_normal_ht+0x12bd1, %rsi
lea addresses_UC_ht+0x12c1f, %rdi
dec %r8
mov $115, %rcx
rep movsl
nop
...
nop
inc %rcx
lea addresses_normal_ht+0x1761f, %r10
nop
cmp %rbx, %rbx
vmovups (%r10), %ymm0
...
vpextrq $0, %xmm0, %rdx
add $10278, %rbx
lea addresses_UC_ht+0x138df, %r8
nop
nop
nop
nop
...
nop
add $56886, %r10
lea addresses_normal_ht+0x12b37, %rsi
xor %rcx, %rcx
...
nop
cmp $18794, %r8
lea addresses_normal_ht+0xea1f, %r8
nop
cmp %rcx, %rcx
movups (%r8), %xmm7
vpextrq $1, %xmm7, %rbx
dec %rcx
lea addresses_UC_ht+0x381f, %rsi
lea addresses_D_ht+0x7d9f, %rdi
sub %r10, %r10
mov $98, %rcx
rep movsl
nop
...
{'OP': 'REPM', 'src': {'type': 'addresses_UC_ht', 'congruent': 5, 'same': True}, 'dst': {'type': 'addresses_A_ht', 'congruent': 5, 'same': False}}
