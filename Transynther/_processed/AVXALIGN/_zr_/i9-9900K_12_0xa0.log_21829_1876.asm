...
lea addresses_A_ht+0x1b65b, %rdi
nop
nop
nop
nop
...
nop
inc %rcx
lea addresses_normal_ht+0x6583, %rsi
lea addresses_normal_ht+0x10c4d, %rdi
nop
add $38629, %r11
mov $38, %rcx
rep movsw
...
nop
add $52308, %r12
lea addresses_WC_ht+0x13dab, %rbx
nop
nop
add %r12, %r12
...
movb $0x61, (%r11)
add $18320, %r11
lea addresses_WT_ht+0xf583, %rsi
clflush (%rsi)
nop
nop
nop
...
nop
cmp $47410, %r12
lea addresses_WT_ht+0x1a7d2, %r14
nop
and $30896, %rcx
vmovups (%r14), %ymm5
...
{'src': {'same': True, 'congruent': 1, 'type': 'addresses_UC_ht'}, 'OP': 'REPM', 'dst': {'same': False, 'congruent': 3, 'type': 'addresses_A_ht'}}
{'src': {'same': False, 'congruent': 11, 'type': 'addresses_normal_ht'}, 'OP': 'REPM', 'dst': {'same': True, 'congruent': 1, 'type': 'addresses_normal_ht'}}
