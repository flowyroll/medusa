...
push %rdi
push %rsi
lea addresses_WT_ht+0x5868, %r13
nop
nop
nop
nop
...
nop
sub %r8, %r8
lea addresses_D_ht+0x16b18, %rsi
lea addresses_normal_ht+0x125f8, %rdi
nop
and %r11, %r11
mov $42, %rcx
rep movsl
...
nop
inc %r13
lea addresses_UC_ht+0x9bf4, %r13
clflush (%r13)
nop
nop
nop
...
vmovups %ymm6, (%rdi)
xor %r8, %r8
lea addresses_WT_ht+0x121f8, %r12
clflush (%r12)
nop
cmp $20083, %r13
...
nop
sub $37575, %rsi
lea addresses_D_ht+0x10df8, %rsi
nop
nop
nop
nop
...
nop
and $5312, %r8
lea addresses_WC_ht+0x1e200, %r11
nop
nop
cmp %r13, %r13
...
nop
sub $23990, %r13
lea addresses_UC_ht+0x18178, %r13
clflush (%r13)
nop
nop
nop
