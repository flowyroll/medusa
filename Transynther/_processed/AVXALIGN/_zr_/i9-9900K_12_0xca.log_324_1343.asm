...
push %r9
push %rsi
lea addresses_UC_ht+0x1d4c7, %r14
nop
nop
nop
nop
...
<gen_prepare_buffer>
{'OP': 'STOR', 'dst': {'size': 1, 'NT': False, 'type': 'addresses_UC_ht', 'same': False, 'AVXalign': True, 'congruent': 10}}
{'00': 324}
