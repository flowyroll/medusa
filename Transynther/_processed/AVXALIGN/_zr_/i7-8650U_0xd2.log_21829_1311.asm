...
push %rax
push %rdi
lea addresses_D_ht+0x1ee6d, %r13
clflush (%r13)
nop
xor %r12, %r12
...
nop
xor $5483, %rdi
lea addresses_WT_ht+0x167f5, %r13
nop
nop
nop
nop
...
nop
xor $58733, %rax
lea addresses_D_ht+0x9c85, %r12
add %r10, %r10
mov $0x6162636465666768, %r11
movq %r11, (%r12)
cmp $2290, %rax
lea addresses_UC_ht+0x16e8b, %r13
nop
nop
nop
nop
...
nop
dec %r11
lea addresses_A_ht+0x1e3f5, %r10
nop
nop
nop
nop
...
nop
add $25608, %r15
lea addresses_UC_ht+0x8a55, %r12
nop
nop
nop
nop
...
nop
inc %rdi
lea addresses_WC_ht+0x1da9d, %r11
nop
nop
nop
nop
...
{'OP': 'STOR', 'dst': {'type': 'addresses_D_ht', 'size': 1, 'AVXalign': True, 'NT': True, 'congruent': 11, 'same': False}}
