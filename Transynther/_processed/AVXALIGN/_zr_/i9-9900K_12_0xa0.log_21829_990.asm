...
rep movsw
inc %rdi
lea addresses_D_ht+0x18252, %rdi
sub $23019, %r11
...
nop
xor $10769, %rbp
lea addresses_D_ht+0x1d022, %r13
nop
nop
nop
sub %rcx, %rcx
...
{'src': {'same': False, 'congruent': 5, 'type': 'addresses_normal_ht'}, 'OP': 'REPM', 'dst': {'same': False, 'congruent': 5, 'type': 'addresses_WC_ht'}}
