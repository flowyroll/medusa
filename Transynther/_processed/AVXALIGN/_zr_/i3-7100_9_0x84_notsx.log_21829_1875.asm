...
movl $0x61626364, (%r9)
and %r8, %r8
lea addresses_UC_ht+0x6ab6, %r13
nop
add %rcx, %rcx
mov (%r13), %r8
nop
...
nop
xor %r8, %r8
lea addresses_UC_ht+0x11d74, %rcx
nop
nop
nop
nop
...
vpextrq $1, %xmm0, %r9
add $63872, %rdi
lea addresses_UC_ht+0x16032, %rdi
nop
nop
sub %r13, %r13
mov (%rdi), %r9w
...
nop
add $39244, %r8
lea addresses_UC_ht+0x2eb6, %r13
nop
nop
inc %rdi
movb $0x61, (%r13)
...
nop
sub %rcx, %rcx
lea addresses_normal_ht+0x114b6, %rsi
lea addresses_A_ht+0x8eb6, %rdi
and %r14, %r14
mov $29, %rcx
rep movsl
nop
dec %r8
lea addresses_WT_ht+0x14e36, %r13
nop
nop
sub $24495, %r9
vmovups (%r13), %ymm7
...
nop
cmp $40537, %r9
lea addresses_A_ht+0x16716, %rdi
xor $35698, %r13
movb (%rdi), %cl
nop
nop
...
nop
cmp $53274, %r8
lea addresses_UC_ht+0x4008, %r14
nop
nop
nop
add %r10, %r10
...
nop
add $12800, %rdi
lea addresses_WT_ht+0xa2b6, %r14
nop
nop
nop
nop
...
{'src': {'type': 'addresses_UC_ht', 'same': True, 'size': 8, 'congruent': 11, 'NT': False, 'AVXalign': False}, 'OP': 'LOAD'}
...
{'src': {'type': 'addresses_WT_ht', 'same': True, 'size': 8, 'congruent': 10, 'NT': False, 'AVXalign': False}, 'OP': 'LOAD'}
{'00': 21829}
