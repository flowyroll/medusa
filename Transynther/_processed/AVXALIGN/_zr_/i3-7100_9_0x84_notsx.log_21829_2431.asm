...
nop
add $29789, %r11
lea addresses_D_ht+0x1b3db, %r15
nop
inc %rdi
vmovups (%r15), %ymm4
...
nop
inc %r11
lea addresses_D_ht+0x1bd63, %rdi
nop
nop
nop
nop
...
nop
dec %r11
lea addresses_WC_ht+0xdc63, %rsi
nop
nop
nop
nop
...
vpextrq $0, %xmm0, %r10
and $15983, %rdi
lea addresses_A_ht+0xc7a3, %rsi
lea addresses_UC_ht+0xfc63, %rdi
nop
nop
nop
nop
...
nop
add %r11, %r11
lea addresses_normal_ht+0x8523, %rsi
nop
and $55398, %rdx
mov (%rsi), %r10
nop
...
nop
xor %rsi, %rsi
lea addresses_WT_ht+0xc023, %rax
nop
inc %r10
movb (%rax), %cl
nop
sub $711, %rcx
lea addresses_D_ht+0x8c07, %r11
clflush (%r11)
nop
xor $4440, %rdx
movb $0x61, (%r11)
...
nop
sub $16808, %rsi
lea addresses_WT_ht+0xa913, %rcx
nop
nop
nop
add $43202, %rdx
...
nop
xor %r15, %r15
lea addresses_D_ht+0x12463, %rax
clflush (%rax)
add $12668, %rdi
...
// Store
lea addresses_normal+0xe463, %r13
nop
xor %rbx, %rbx
movl $0x51525354, (%r13)
cmp $17119, %rax
...
// Faulty Load
lea addresses_normal+0x10c63, %rcx
nop
nop
nop
inc %rdi
...
{'src': {'type': 'addresses_WT_ht', 'same': True, 'size': 1, 'congruent': 6, 'NT': False, 'AVXalign': False}, 'OP': 'LOAD'}
