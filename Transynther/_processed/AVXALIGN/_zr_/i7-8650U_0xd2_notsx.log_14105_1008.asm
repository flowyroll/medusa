...
push %rbp
push %rdx
lea addresses_UC_ht+0xfd57, %r12
nop
nop
sub %rdx, %rdx
movb $0x61, (%r12)
...
nop
add $28758, %r10
lea addresses_UC_ht+0xab57, %r13
nop
nop
nop
nop
...
nop
inc %rdx
lea addresses_D_ht+0x9e57, %r12
nop
sub %r8, %r8
movb $0x61, (%r12)
inc %rdx
lea addresses_WT_ht+0xff77, %r13
nop
nop
nop
nop
...
// REPMOV
lea addresses_WC+0x1cb57, %rsi
lea addresses_PSE+0x13953, %rdi
clflush (%rsi)
nop
nop
xor %r10, %r10
...
// Store
lea addresses_normal+0x10357, %rdi
nop
nop
nop
dec %rax
...
{'OP': 'REPM', 'src': {'type': 'addresses_WC', 'congruent': 0, 'same': True}, 'dst': {'type': 'addresses_PSE', 'congruent': 2, 'same': False}}
...
{'OP': 'STOR', 'dst': {'type': 'addresses_UC_ht', 'size': 4, 'AVXalign': True, 'NT': False, 'congruent': 10, 'same': False}}
