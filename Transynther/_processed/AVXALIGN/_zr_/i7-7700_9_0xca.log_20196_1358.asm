...
push %rdi
push %rsi
lea addresses_D_ht+0x183bd, %rbp
nop
nop
nop
nop
...
nop
xor %r11, %r11
lea addresses_A_ht+0x1e4bd, %r13
nop
xor $18060, %rcx
mov (%r13), %esi
sub %rsi, %rsi
...
nop
xor %rcx, %rcx
lea addresses_UC_ht+0xaf53, %rsi
nop
nop
nop
cmp $38442, %r12
...
nop
and %r13, %r13
lea addresses_D_ht+0x1433d, %rbp
nop
nop
xor %r11, %r11
mov (%rbp), %r12w
...
nop
xor $41514, %rcx
lea addresses_normal_ht+0x10bd, %rsi
nop
nop
add %rcx, %rcx
...
nop
xor %r11, %r11
lea addresses_D_ht+0x97bd, %rsi
lea addresses_D_ht+0x12405, %rdi
nop
nop
xor $5817, %r12
mov $69, %rcx
...
nop
and %rsi, %rsi
lea addresses_WT_ht+0x4bb9, %rcx
cmp %rbp, %rbp
...
nop
xor $18658, %rbp
lea addresses_A_ht+0x1adbd, %rcx
nop
nop
and %rdi, %rdi
vmovups (%rcx), %ymm3
...
nop
cmp %r11, %r11
lea addresses_D_ht+0x1059d, %rsi
lea addresses_UC_ht+0x631d, %rdi
nop
nop
nop
sub %r13, %r13
...
nop
cmp %r12, %r12
lea addresses_UC_ht+0x1a6fd, %rsi
lea addresses_WC_ht+0x8a9d, %rdi
clflush (%rsi)
nop
nop
dec %r13
...
nop
sub $24986, %r13
lea addresses_UC_ht+0x191d3, %rcx
nop
nop
nop
sub %r8, %r8
...
{'OP': 'STOR', 'dst': {'congruent': 7, 'AVXalign': False, 'same': False, 'size': 32, 'NT': True, 'type': 'addresses_normal_ht'}}
{'src': {'congruent': 9, 'same': False, 'type': 'addresses_D_ht'}, 'OP': 'REPM', 'dst': {'congruent': 3, 'same': False, 'type': 'addresses_D_ht'}}
{'OP': 'STOR', 'dst': {'congruent': 1, 'AVXalign': True, 'same': False, 'size': 32, 'NT': False, 'type': 'addresses_WT_ht'}}
...
{'src': {'congruent': 3, 'same': False, 'type': 'addresses_D_ht'}, 'OP': 'REPM', 'dst': {'congruent': 5, 'same': False, 'type': 'addresses_UC_ht'}}
{'src': {'congruent': 6, 'same': True, 'type': 'addresses_UC_ht'}, 'OP': 'REPM', 'dst': {'congruent': 5, 'same': False, 'type': 'addresses_WC_ht'}}
