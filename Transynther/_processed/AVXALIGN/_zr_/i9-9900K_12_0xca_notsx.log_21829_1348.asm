...
push %rdi
push %rsi
lea addresses_normal_ht+0xf721, %r12
nop
and $1689, %r9
movw $0x6162, (%r12)
nop
sub $29464, %r10
lea addresses_A_ht+0x191b1, %rbp
nop
nop
nop
nop
...
nop
dec %r12
lea addresses_WC_ht+0xc7b1, %rsi
nop
nop
xor %r9, %r9
mov (%rsi), %r15d
...
nop
cmp $819, %rdi
lea addresses_UC_ht+0x11bf1, %rsi
nop
nop
nop
nop
...
// Store
lea addresses_normal+0x57b1, %rdx
nop
nop
nop
nop
...
{'OP': 'LOAD', 'src': {'same': False, 'type': 'addresses_WC', 'NT': False, 'AVXalign': False, 'size': 1, 'congruent': 9}}
...
{'OP': 'REPM', 'src': {'same': True, 'congruent': 0, 'type': 'addresses_D_ht'}, 'dst': {'same': False, 'congruent': 11, 'type': 'addresses_normal_ht'}}
{'OP': 'LOAD', 'src': {'same': True, 'type': 'addresses_WC_ht', 'NT': False, 'AVXalign': False, 'size': 4, 'congruent': 11}}
