...
nop
sub %r8, %r8
lea addresses_D_ht+0x12e1b, %rsi
...
vpextrq $0, %xmm2, %rsi
add %r8, %r8
lea addresses_WC_ht+0x1c192, %rsi
nop
nop
nop
nop
...
movl $0x61626364, (%rsi)
and %rcx, %rcx
lea addresses_normal_ht+0x19022, %r10
nop
nop
nop
nop
...
nop
cmp $36322, %rbx
lea addresses_WT_ht+0x18bb2, %rcx
nop
nop
nop
sub $63628, %r13
