...
push %rdx
push %rsi
lea addresses_WC_ht+0x119b5, %rcx
cmp $18538, %r8
mov $0x6162636465666768, %rbp
movq %rbp, (%rcx)
sub %r12, %r12
lea addresses_UC_ht+0x141b5, %rsi
lea addresses_WC_ht+0xac5, %rdi
inc %rdx
mov $17, %rcx
rep movsl
nop
...
nop
xor %r12, %r12
lea addresses_WC_ht+0x19ca5, %rcx
add $41570, %rsi
mov (%rcx), %r8
nop
nop
...
nop
sub $32896, %r12
lea addresses_UC_ht+0x30d5, %rsi
lea addresses_UC_ht+0xe845, %rdi
nop
nop
nop
nop
...
// Store
lea addresses_normal+0x1b9b5, %rax
nop
nop
nop
nop
...
// REPMOV
lea addresses_normal+0x65b5, %rsi
lea addresses_WT+0x119b5, %rdi
nop
nop
nop
nop
...
{'OP': 'REPM', 'src': {'same': False, 'congruent': 11, 'type': 'addresses_normal'}, 'dst': {'same': False, 'congruent': 8, 'type': 'addresses_WT'}}
[Faulty Load]
...
{'OP': 'STOR', 'dst': {'same': True, 'type': 'addresses_normal_ht', 'NT': False, 'AVXalign': False, 'size': 8, 'congruent': 2}}
