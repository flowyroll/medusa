...
push %rbx
push %rdi
lea addresses_A_ht+0x3cc0, %r8
nop
add $50828, %rbx
movw $0x6162, (%r8)
nop
sub %r9, %r9
lea addresses_WC_ht+0x11d86, %r12
nop
nop
add $57984, %r11
movl $0x61626364, (%r12)
...
nop
sub %r11, %r11
lea addresses_normal_ht+0xc04b, %r11
nop
nop
nop
nop
...
// Store
lea addresses_normal+0x968b, %r11
nop
nop
nop
nop
...
// Store
lea addresses_normal+0xaa8b, %r9
nop
sub $17014, %r11
...
{'src': {'type': 'addresses_UC', 'AVXalign': False, 'size': 2, 'NT': False, 'same': False, 'congruent': 5}, 'OP': 'LOAD'}
...
{'OP': 'STOR', 'dst': {'type': 'addresses_normal', 'AVXalign': True, 'size': 1, 'NT': False, 'same': False, 'congruent': 6}}
...
{'OP': 'STOR', 'dst': {'type': 'addresses_WC_ht', 'AVXalign': False, 'size': 4, 'NT': False, 'same': True, 'congruent': 0}}
