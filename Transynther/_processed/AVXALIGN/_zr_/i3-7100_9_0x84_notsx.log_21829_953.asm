...
vmovntdq %ymm3, (%rsi)
xor $36345, %rcx
lea addresses_D_ht+0x2491, %rsi
lea addresses_normal_ht+0x1e22d, %rdi
nop
nop
inc %rdx
mov $75, %rcx
...
nop
inc %rdi
lea addresses_UC_ht+0x10fb5, %rsi
lea addresses_D_ht+0x1012d, %rdi
nop
nop
nop
nop
...
movq %r12, (%rdx)
xor $13925, %r8
lea addresses_WT_ht+0x472d, %rcx
nop
and %rdx, %rdx
movb (%rcx), %r12b
nop
...
nop
dec %r9
lea addresses_UC_ht+0x6a4d, %rdx
nop
nop
nop
nop
...
nop
sub %r8, %r8
lea addresses_UC_ht+0xc58d, %rdi
cmp %r12, %r12
movl $0x61626364, (%rdi)
nop
nop
...
nop
xor %rcx, %rcx
lea addresses_D_ht+0x11e2d, %rdx
nop
nop
nop
nop
...
nop
add %rcx, %rcx
lea addresses_WC_ht+0x933d, %r12
and $42905, %rcx
...
nop
and $34108, %r8
lea addresses_WT_ht+0x173f9, %rcx
clflush (%rcx)
nop
nop
nop
...
// Store
lea addresses_normal+0x1aa2d, %rdx
nop
nop
and $62120, %r8
movw $0x5152, (%rdx)
...
<gen_prepare_buffer>
{'dst': {'type': 'addresses_WT_ht', 'same': False, 'size': 32, 'congruent': 7, 'NT': True, 'AVXalign': False}, 'OP': 'STOR'}
{'src': {'type': 'addresses_D_ht', 'congruent': 2, 'same': True}, 'dst': {'type': 'addresses_normal_ht', 'congruent': 8, 'same': False}, 'OP': 'REPM'}
{'src': {'type': 'addresses_UC_ht', 'congruent': 3, 'same': False}, 'dst': {'type': 'addresses_D_ht', 'congruent': 4, 'same': True}, 'OP': 'REPM'}
