...
push %rdx
push %rsi
lea addresses_WC_ht+0x1c26, %rdx
nop
nop
nop
nop
...
nop
add %rcx, %rcx
lea addresses_UC_ht+0x1dedb, %rsi
lea addresses_A_ht+0xedb, %rdi
nop
xor %r12, %r12
mov $9, %rcx
rep movsb
...
nop
and $4747, %r12
lea addresses_UC_ht+0x1e6e3, %rsi
lea addresses_WC_ht+0x14f5b, %rdi
dec %r12
mov $49, %rcx
rep movsb
sub %rdi, %rdi
lea addresses_normal_ht+0x120db, %rsi
lea addresses_UC_ht+0xb2b3, %rdi
nop
nop
nop
nop
...
{'OP': 'LOAD', 'src': {'type': 'addresses_NC', 'AVXalign': False, 'congruent': 10, 'size': 8, 'same': False, 'NT': False}}
...
{'OP': 'REPM', 'src': {'type': 'addresses_normal_ht', 'congruent': 7, 'same': False}, 'dst': {'type': 'addresses_UC_ht', 'congruent': 1, 'same': False}}
{'00': 21829}
