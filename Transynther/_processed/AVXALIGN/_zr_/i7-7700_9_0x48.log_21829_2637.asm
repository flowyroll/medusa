...
nop
xor $42077, %rdi
lea addresses_normal_ht+0xc9e2, %rsi
lea addresses_UC_ht+0x45e2, %rdi
nop
nop
nop
nop
...
{'OP': 'LOAD', 'src': {'type': 'addresses_NC', 'AVXalign': True, 'congruent': 9, 'size': 8, 'same': False, 'NT': False}}
