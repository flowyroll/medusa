...
push %rdi
push %rdx
lea addresses_D_ht+0x16066, %rdi
nop
nop
sub $60965, %r15
...
nop
sub $24670, %r12
lea addresses_normal_ht+0x5826, %r12
xor $32511, %rdx
movups (%r12), %xmm1
vpextrq $1, %xmm1, %rbp
nop
...
nop
cmp %rdx, %rdx
lea addresses_WT_ht+0x8066, %rax
nop
cmp %r14, %r14
mov (%rax), %dx
nop
nop
cmp %rdx, %rdx
lea addresses_D_ht+0x1dc66, %rbp
nop
nop
nop
nop
...
nop
add %rax, %rax
lea addresses_UC_ht+0x19866, %rdx
nop
nop
sub $61236, %rdi
vmovups (%rdx), %ymm5
...
nop
sub %rbp, %rbp
lea addresses_WC_ht+0xad66, %rax
nop
nop
add %rdi, %rdi
...
nop
inc %rdi
lea addresses_D_ht+0x127e6, %r12
nop
add $4563, %r15
movw $0x6162, (%r12)
nop
...
{'OP': 'LOAD', 'src': {'type': 'addresses_D_ht', 'AVXalign': False, 'congruent': 8, 'size': 32, 'same': True, 'NT': False}}
