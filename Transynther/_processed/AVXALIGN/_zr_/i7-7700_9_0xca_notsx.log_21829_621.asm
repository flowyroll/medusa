...
nop
add %r13, %r13
lea addresses_UC_ht+0x1a9a, %r14
sub $61387, %r13
movb $0x61, (%r14)
nop
nop
nop
sub %r11, %r11
lea addresses_A_ht+0x15e9a, %rsi
lea addresses_A_ht+0xd01a, %rdi
clflush (%rdi)
nop
nop
nop
...
nop
sub %r13, %r13
lea addresses_UC_ht+0xdc9a, %r11
nop
inc %r14
mov (%r11), %ax
xor $52005, %r14
...
// Store
lea addresses_normal+0xf09a, %r11
clflush (%r11)
nop
nop
nop
...
// Faulty Load
lea addresses_normal+0x1049a, %r10
nop
nop
nop
nop
...
{'src': {'NT': False, 'AVXalign': True, 'size': 8, 'congruent': 3, 'same': False, 'type': 'addresses_D_ht'}, 'OP': 'LOAD'}
{'src': {'congruent': 3, 'same': False, 'type': 'addresses_WT_ht'}, 'dst': {'congruent': 3, 'same': False, 'type': 'addresses_WT_ht'}, 'OP': 'REPM'}
