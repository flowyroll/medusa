...
push %rbx
push %rdx
lea addresses_WC_ht+0x1e09c, %rax
clflush (%rax)
nop
nop
nop
...
nop
add $24940, %r11
lea addresses_WT_ht+0x1d6b8, %rax
nop
nop
nop
nop
...
movw $0x6162, (%rax)
cmp %rbx, %rbx
lea addresses_WT_ht+0xa028, %r11
clflush (%r11)
nop
nop
nop
...
{'src': {'NT': False, 'same': False, 'congruent': 8, 'type': 'addresses_WC', 'AVXalign': False, 'size': 2}, 'OP': 'LOAD'}
...
<gen_prepare_buffer>
{'OP': 'STOR', 'dst': {'NT': False, 'same': True, 'congruent': 1, 'type': 'addresses_WC_ht', 'AVXalign': False, 'size': 1}}
