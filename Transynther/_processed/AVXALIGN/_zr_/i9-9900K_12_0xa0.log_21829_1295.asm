...
push %rdi
push %rsi
lea addresses_WC_ht+0x14c58, %rbx
clflush (%rbx)
nop
nop
nop
...
nop
dec %rax
lea addresses_WT_ht+0xd118, %rsi
lea addresses_D_ht+0xa4d4, %rdi
nop
nop
nop
nop
...
movups %xmm7, (%rbx)
and %rax, %rax
lea addresses_UC_ht+0x2130, %rax
nop
nop
cmp %rbx, %rbx
movups (%rax), %xmm7
...
nop
xor %rbx, %rbx
lea addresses_WC_ht+0x19518, %rsi
lea addresses_normal_ht+0x14518, %rdi
cmp %r10, %r10
mov $88, %rcx
rep movsl
nop
...
{'src': {'same': False, 'congruent': 11, 'type': 'addresses_WC_ht'}, 'OP': 'REPM', 'dst': {'same': True, 'congruent': 11, 'type': 'addresses_normal_ht'}}
{'00': 21829}
