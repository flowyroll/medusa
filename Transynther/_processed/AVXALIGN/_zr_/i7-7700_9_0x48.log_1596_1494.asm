...
nop
xor %rbp, %rbp
lea addresses_UC_ht+0x134f4, %r8
sub %r9, %r9
...
nop
xor %r14, %r14
lea addresses_WC_ht+0x107c, %rbp
nop
nop
nop
nop
...
nop
cmp %rcx, %rcx
lea addresses_WC_ht+0x1e5fc, %rsi
...
// REPMOV
lea addresses_UC+0x118fc, %rsi
lea addresses_US+0x1dad4, %rdi
clflush (%rdi)
sub $17885, %rbx
mov $1, %rcx
rep movsw
...
{'OP': 'REPM', 'src': {'type': 'addresses_UC', 'congruent': 11, 'same': False}, 'dst': {'type': 'addresses_US', 'congruent': 3, 'same': False}}
[Faulty Load]
...
{'OP': 'REPM', 'src': {'type': 'addresses_WC_ht', 'congruent': 5, 'same': True}, 'dst': {'type': 'addresses_WC_ht', 'congruent': 11, 'same': False}}
