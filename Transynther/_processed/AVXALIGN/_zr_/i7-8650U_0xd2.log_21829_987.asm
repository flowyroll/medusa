...
nop
cmp $50443, %r14
lea addresses_normal_ht+0x8775, %r10
nop
nop
nop
nop
...
nop
and $40757, %r15
lea addresses_WC_ht+0x1e015, %rdi
clflush (%rdi)
cmp %rax, %rax
movb $0x61, (%rdi)
nop
...
nop
and %r10, %r10
lea addresses_UC_ht+0x1bd4a, %rax
nop
and %r15, %r15
movups (%rax), %xmm3
vpextrq $0, %xmm3, %r8
...
nop
and $52782, %rdi
lea addresses_WT_ht+0x17795, %rcx
nop
nop
nop
nop
...
nop
add $26814, %r15
lea addresses_UC_ht+0xa36c, %rcx
nop
nop
nop
nop
...
nop
sub $53815, %rax
lea addresses_UC_ht+0x1a15, %r14
and $11925, %r15
movb $0x61, (%r14)
nop
nop
...
nop
add %r10, %r10
lea addresses_WC_ht+0x16015, %r14
nop
nop
cmp %rax, %rax
movb $0x61, (%r14)
...
nop
dec %r15
lea addresses_WC_ht+0x5b35, %rdi
nop
nop
xor %r15, %r15
mov (%rdi), %r10d
