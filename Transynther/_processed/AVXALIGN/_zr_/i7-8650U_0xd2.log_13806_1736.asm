...
push %rdi
push %rsi
lea addresses_WT_ht+0x17d9c, %r10
clflush (%r10)
nop
nop
inc %rbp
...
nop
and %r9, %r9
lea addresses_normal_ht+0x1d7ac, %rax
nop
nop
nop
xor $17511, %rbx
...
nop
dec %r15
lea addresses_WC_ht+0x7d0c, %rbx
nop
nop
nop
nop
...
nop
dec %r15
lea addresses_WC_ht+0x197c4, %rsi
lea addresses_WT_ht+0x1b8ec, %rdi
nop
nop
xor %rax, %rax
mov $45, %rcx
...
nop
and $62049, %rbx
lea addresses_normal_ht+0x6fec, %rsi
lea addresses_A_ht+0xd628, %rdi
sub $12333, %rax
mov $98, %rcx
rep movsb
nop
...
nop
cmp %r10, %r10
lea addresses_D_ht+0x16dac, %rsi
nop
nop
nop
nop
...
nop
add %rax, %rax
lea addresses_normal_ht+0xa42a, %r9
nop
nop
and $10853, %rcx
movl $0x61626364, (%r9)
...
nop
sub %rdi, %rdi
lea addresses_normal_ht+0x1e240, %rsi
lea addresses_A_ht+0x190ec, %rdi
nop
nop
xor $62758, %rbp
mov $117, %rcx
...
{'OP': 'LOAD', 'src': {'type': 'addresses_normal_ht', 'size': 1, 'AVXalign': True, 'NT': False, 'congruent': 5, 'same': False}}
