...
push %rdi
push %rsi
lea addresses_normal_ht+0x4e9, %r9
sub $26425, %rdi
movl $0x61626364, (%r9)
nop
nop
inc %r9
lea addresses_WT_ht+0x8e19, %r14
nop
nop
nop
add %rax, %rax
...
nop
inc %rsi
lea addresses_D_ht+0x19215, %rdi
nop
add %r9, %r9
movups (%rdi), %xmm2
vpextrq $0, %xmm2, %rcx
xor $31255, %r9
lea addresses_normal_ht+0x7de9, %rsi
lea addresses_D_ht+0x13929, %rdi
clflush (%rsi)
nop
nop
nop
...
nop
cmp %r9, %r9
lea addresses_WC_ht+0xb1b9, %rsi
lea addresses_A_ht+0x180a9, %rdi
nop
nop
add $62681, %rbx
mov $94, %rcx
...
nop
add %r9, %r9
lea addresses_WC_ht+0x19951, %rax
nop
nop
nop
cmp %rcx, %rcx
...
nop
cmp $30608, %rsi
lea addresses_UC_ht+0x48e9, %rsi
lea addresses_D_ht+0x1a749, %rdi
clflush (%rsi)
nop
nop
add %r9, %r9
...
{'OP': 'LOAD', 'src': {'size': 2, 'NT': False, 'type': 'addresses_PSE', 'same': False, 'AVXalign': False, 'congruent': 1}}
...
{'OP': 'LOAD', 'src': {'size': 1, 'NT': False, 'type': 'addresses_WT_ht', 'same': True, 'AVXalign': False, 'congruent': 4}}
...
{'OP': 'REPM', 'src': {'same': False, 'type': 'addresses_WC_ht', 'congruent': 2}, 'dst': {'same': True, 'type': 'addresses_A_ht', 'congruent': 5}}
...
{'OP': 'REPM', 'src': {'same': False, 'type': 'addresses_UC_ht', 'congruent': 7}, 'dst': {'same': False, 'type': 'addresses_D_ht', 'congruent': 5}}
{'00': 21829}
