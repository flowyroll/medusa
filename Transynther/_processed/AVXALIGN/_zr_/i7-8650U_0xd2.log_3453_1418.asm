...
nop
and %rsi, %rsi
lea addresses_WC_ht+0x1b76d, %r11
nop
nop
dec %rcx
movb $0x61, (%r11)
...
nop
cmp %rsi, %rsi
lea addresses_UC_ht+0xec23, %rsi
lea addresses_D_ht+0x19243, %rdi
nop
cmp %rdx, %rdx
mov $0, %rcx
rep movsq
...
{'OP': 'REPM', 'src': {'type': 'addresses_UC_ht', 'congruent': 3, 'same': True}, 'dst': {'type': 'addresses_D_ht', 'congruent': 3, 'same': False}}
{'00': 3453}
