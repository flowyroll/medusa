...
push %rdi
push %rsi
lea addresses_WT_ht+0x17cb2, %r12
nop
inc %rsi
...
{'OP': 'STOR', 'dst': {'size': 1, 'NT': True, 'type': 'addresses_P', 'same': False, 'AVXalign': False, 'congruent': 4}}
...
<gen_prepare_buffer>
{'OP': 'LOAD', 'src': {'size': 16, 'NT': False, 'type': 'addresses_WT_ht', 'same': False, 'AVXalign': True, 'congruent': 6}}
{'00': 21829}
