...
push %r15
push %rbx
lea addresses_normal_ht+0xfa4e, %r15
nop
inc %r13
movups (%r15), %xmm1
vpextrq $0, %xmm1, %r12
...
// REPMOV
lea addresses_UC+0xe4e, %rsi
lea addresses_D+0x164e, %rdi
nop
nop
and %r9, %r9
mov $41, %rcx
...
// Store
lea addresses_normal+0x1ed16, %r10
nop
inc %r14
movw $0x5152, (%r10)
nop
...
{'OP': 'REPM', 'src': {'type': 'addresses_UC', 'congruent': 9, 'same': False}, 'dst': {'type': 'addresses_D', 'congruent': 4, 'same': False}}
