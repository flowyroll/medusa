...
push %rdx
push %rsi
lea addresses_UC_ht+0x17f85, %r9
nop
nop
nop
nop
...
nop
sub %rdx, %rdx
lea addresses_WT_ht+0x12bd9, %rsi
nop
sub $47877, %r9
movl $0x61626364, (%rsi)
nop
nop
cmp %r9, %r9
lea addresses_WT_ht+0x18c2d, %rsi
lea addresses_UC_ht+0x166a5, %rdi
nop
nop
nop
nop
...
// Store
lea addresses_normal+0x17585, %rsi
clflush (%rsi)
nop
nop
nop
...
{'OP': 'STOR', 'dst': {'same': False, 'type': 'addresses_normal', 'NT': False, 'AVXalign': True, 'size': 4, 'congruent': 6}}
[Faulty Load]
...
{'OP': 'REPM', 'src': {'same': False, 'congruent': 0, 'type': 'addresses_WT_ht'}, 'dst': {'same': True, 'congruent': 5, 'type': 'addresses_UC_ht'}}
{'00': 21829}
