...
nop
dec %r13
lea addresses_UC_ht+0xfc69, %rsi
lea addresses_WC_ht+0x1b1e3, %rdi
clflush (%rsi)
cmp %rbp, %rbp
mov $109, %rcx
rep movsw
...
nop
cmp $14260, %rdx
lea addresses_D_ht+0xac29, %rsi
lea addresses_UC_ht+0x86f3, %rdi
clflush (%rsi)
nop
nop
nop
