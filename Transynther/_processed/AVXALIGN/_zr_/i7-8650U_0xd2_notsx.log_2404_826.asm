...
nop
cmp %rbp, %rbp
lea addresses_D_ht+0x149c8, %rbp
dec %rdi
...
nop
sub %rbp, %rbp
lea addresses_D_ht+0x11dc8, %r10
nop
nop
nop
nop
...
nop
xor %rbp, %rbp
lea addresses_WT_ht+0x52f0, %rsi
lea addresses_WT_ht+0x7e88, %rdi
nop
nop
nop
and $22306, %r13
...
rep movsq
xor %r10, %r10
lea addresses_A_ht+0xbdc8, %rsi
lea addresses_D_ht+0x12a98, %rdi
nop
xor %rdx, %rdx
mov $17, %rcx
rep movsl
...
nop
sub %r10, %r10
lea addresses_normal_ht+0x17504, %rsi
lea addresses_UC_ht+0xd5c8, %rdi
clflush (%rdi)
nop
cmp %r13, %r13
mov $1, %rcx
...
nop
cmp %rbx, %rbx
lea addresses_D_ht+0x1e5c8, %rbx
nop
nop
nop
nop
...
nop
dec %rdi
lea addresses_A_ht+0x1c2c8, %rsi
lea addresses_normal_ht+0x13e1e, %rdi
inc %rbp
mov $57, %rcx
rep movsl
nop
...
nop
and $15464, %r10
lea addresses_WC_ht+0x1e0c5, %rsi
sub %rdx, %rdx
mov (%rsi), %r13d
nop
nop
...
{'OP': 'STOR', 'dst': {'type': 'addresses_D_ht', 'size': 32, 'AVXalign': False, 'NT': True, 'congruent': 10, 'same': False}}
{'OP': 'REPM', 'src': {'type': 'addresses_WT_ht', 'congruent': 2, 'same': True}, 'dst': {'type': 'addresses_WT_ht', 'congruent': 6, 'same': False}}
{'OP': 'REPM', 'src': {'type': 'addresses_A_ht', 'congruent': 11, 'same': False}, 'dst': {'type': 'addresses_D_ht', 'congruent': 2, 'same': False}}
{'OP': 'REPM', 'src': {'type': 'addresses_normal_ht', 'congruent': 1, 'same': True}, 'dst': {'type': 'addresses_UC_ht', 'congruent': 11, 'same': False}}
