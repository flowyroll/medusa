...
nop
add %r10, %r10
lea addresses_A_ht+0x152e6, %r11
and %rdx, %rdx
movl $0x61626364, (%r11)
nop
nop
...
nop
xor $53943, %r8
lea addresses_D_ht+0x1ba1a, %r11
nop
nop
nop
xor %rdx, %rdx
...
// REPMOV
lea addresses_UC+0x2e5c, %rsi
lea addresses_D+0x1c7fe, %rdi
nop
nop
xor %r10, %r10
mov $98, %rcx
...
{'OP': 'REPM', 'src': {'type': 'addresses_UC', 'congruent': 1, 'same': False}, 'dst': {'type': 'addresses_D', 'congruent': 0, 'same': True}}
