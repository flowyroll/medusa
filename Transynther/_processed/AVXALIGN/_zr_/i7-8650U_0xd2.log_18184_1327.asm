...
push %rdi
push %rsi
lea addresses_UC_ht+0xc164, %rsi
...
rep movsb
dec %r11
lea addresses_normal_ht+0x17021, %rsi
lea addresses_D_ht+0x187bd, %rdi
dec %r15
mov $31, %rcx
rep movsb
nop
add %rcx, %rcx
lea addresses_UC_ht+0x1d11c, %rsi
lea addresses_A_ht+0x24bd, %rdi
clflush (%rdi)
nop
nop
nop
...
nop
add %r13, %r13
lea addresses_normal_ht+0x13f2d, %rdi
nop
nop
nop
nop
...
nop
and %rcx, %rcx
lea addresses_UC_ht+0x13c89, %rsi
nop
nop
nop
nop
...
nop
xor %r15, %r15
lea addresses_WT_ht+0x1237d, %rsi
lea addresses_WC_ht+0x188e3, %rdi
nop
nop
nop
nop
...
nop
inc %rcx
lea addresses_UC_ht+0x122bd, %rcx
nop
nop
nop
nop
...
nop
dec %r14
lea addresses_D_ht+0x194bd, %rdi
nop
nop
nop
add $46988, %rsi
...
nop
sub %r8, %r8
lea addresses_D_ht+0x158bd, %r13
nop
mfence
vmovups (%r13), %ymm0
...
nop
add %r8, %r8
lea addresses_WT_ht+0x182bd, %rcx
nop
nop
nop
nop
...
{'OP': 'REPM', 'src': {'type': 'addresses_UC_ht', 'congruent': 0, 'same': False}, 'dst': {'type': 'addresses_A_ht', 'congruent': 9, 'same': True}}
