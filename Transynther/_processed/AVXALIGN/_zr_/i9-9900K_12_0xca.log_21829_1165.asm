...
push %rdx
push %rsi
lea addresses_WT_ht+0xba3a, %rbx
nop
nop
sub $6459, %rax
movb (%rbx), %r11b
cmp $5520, %rax
lea addresses_WT_ht+0x16e3a, %rdx
nop
and %r9, %r9
movb $0x61, (%rdx)
nop
...
nop
xor $42834, %rsi
lea addresses_UC_ht+0x1ce72, %rsi
lea addresses_A_ht+0xa4ce, %rdi
nop
xor %rax, %rax
mov $106, %rcx
rep movsq
cmp $21143, %rax
lea addresses_WC_ht+0x9a3a, %rbx
nop
nop
dec %r11
movl $0x61626364, (%rbx)
nop
add $5202, %r9
lea addresses_UC_ht+0x203a, %rsi
nop
nop
nop
nop
...
nop
xor $18164, %r9
lea addresses_WT_ht+0x18636, %rsi
lea addresses_A_ht+0x14a02, %rdi
inc %rbx
mov $109, %rcx
rep movsb
nop
nop
inc %rcx
lea addresses_normal_ht+0x2192, %rcx
nop
nop
nop
sub %r11, %r11
...
{'OP': 'REPM', 'src': {'same': False, 'type': 'addresses_UC_ht', 'congruent': 3}, 'dst': {'same': False, 'type': 'addresses_A_ht', 'congruent': 2}}
...
{'OP': 'REPM', 'src': {'same': False, 'type': 'addresses_WT_ht', 'congruent': 2}, 'dst': {'same': False, 'type': 'addresses_A_ht', 'congruent': 1}}
