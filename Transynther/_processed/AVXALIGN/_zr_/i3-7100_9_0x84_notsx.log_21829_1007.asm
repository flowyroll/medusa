...
push %rcx
push %rsi
lea addresses_WT_ht+0x195be, %r8
nop
nop
nop
cmp $17030, %rcx
...
nop
and %rbp, %rbp
lea addresses_WT_ht+0x14e06, %r15
nop
nop
cmp $20687, %rcx
vmovups (%r15), %ymm0
...
vpextrq $1, %xmm0, %rsi
cmp %rsi, %rsi
lea addresses_normal_ht+0x877e, %rbp
add $25872, %rcx
mov (%rbp), %esi
sub %r14, %r14
pop %rsi
