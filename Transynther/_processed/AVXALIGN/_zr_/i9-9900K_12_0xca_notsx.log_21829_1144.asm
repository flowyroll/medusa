...
lea addresses_A_ht+0x13402, %rdi
nop
add %r14, %r14
mov $95, %rcx
rep movsw
...
nop
cmp $50405, %r14
lea addresses_WT_ht+0xcd3a, %rcx
inc %rdx
...
// Faulty Load
lea addresses_normal+0x16b82, %r10
nop
nop
nop
nop
