...
push %rdi
push %rsi
lea addresses_normal_ht+0x8b5b, %rsi
lea addresses_WC_ht+0x15a53, %rdi
clflush (%rsi)
inc %rax
mov $104, %rcx
rep movsw
...
nop
xor %rbp, %rbp
lea addresses_A_ht+0x3513, %rsi
lea addresses_WC_ht+0x9bd3, %rdi
nop
nop
and %r8, %r8
mov $54, %rcx
...
nop
sub $57794, %r8
lea addresses_normal_ht+0x14d63, %rdi
nop
nop
nop
nop
...
nop
xor %rdi, %rdi
lea addresses_WT_ht+0x1bf93, %rsi
lea addresses_A_ht+0x17999, %rdi
clflush (%rdi)
nop
nop
nop
...
nop
add $22815, %rdi
lea addresses_WT_ht+0x161d3, %r14
nop
nop
nop
nop
...
nop
xor %rsi, %rsi
lea addresses_D_ht+0x156bb, %rsi
lea addresses_normal_ht+0x10c53, %rdi
xor %r12, %r12
mov $96, %rcx
rep movsl
nop
add %rbp, %rbp
lea addresses_A_ht+0x14553, %rbp
nop
nop
nop
nop
...
nop
sub %rax, %rax
lea addresses_D_ht+0x132d3, %r12
nop
add $34326, %rcx
movw $0x6162, (%r12)
nop
...
nop
sub %rcx, %rcx
lea addresses_WT_ht+0x7e73, %rsi
lea addresses_D_ht+0xc273, %rdi
clflush (%rsi)
nop
nop
nop
...
{'OP': 'REPM', 'src': {'same': False, 'congruent': 5, 'type': 'addresses_WT_ht'}, 'dst': {'same': False, 'congruent': 1, 'type': 'addresses_A_ht'}}
...
{'OP': 'REPM', 'src': {'same': False, 'congruent': 5, 'type': 'addresses_WT_ht'}, 'dst': {'same': True, 'congruent': 5, 'type': 'addresses_D_ht'}}
{'00': 21829}
