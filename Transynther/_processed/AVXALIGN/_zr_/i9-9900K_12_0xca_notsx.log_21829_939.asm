...
push %rdx
push %rsi
lea addresses_WC_ht+0x16871, %rbx
nop
nop
nop
nop
...
nop
xor %r14, %r14
lea addresses_A_ht+0x10939, %r11
sub %rdx, %rdx
movb $0x61, (%r11)
nop
nop
...
nop
sub $36191, %rax
lea addresses_A_ht+0x19243, %r11
clflush (%r11)
nop
nop
nop
...
nop
sub %r13, %r13
lea addresses_A_ht+0x13c11, %r13
nop
add %r11, %r11
...
nop
and %rdx, %rdx
lea addresses_UC_ht+0x7f51, %rsi
lea addresses_UC_ht+0x19b1, %rdi
clflush (%rsi)
clflush (%rdi)
nop
xor %r8, %r8
...
nop
inc %rbx
lea addresses_UC_ht+0x1f11, %rdx
nop
nop
nop
nop
...
{'OP': 'LOAD', 'src': {'same': False, 'type': 'addresses_US', 'NT': False, 'AVXalign': False, 'size': 2, 'congruent': 1}}
[Faulty Load]
{'OP': 'LOAD', 'src': {'same': True, 'type': 'addresses_P', 'NT': True, 'AVXalign': False, 'size': 32, 'congruent': 0}}
<gen_prepare_buffer>
{'OP': 'STOR', 'dst': {'same': False, 'type': 'addresses_WC_ht', 'NT': True, 'AVXalign': True, 'size': 2, 'congruent': 5}}
...
{'OP': 'REPM', 'src': {'same': False, 'congruent': 6, 'type': 'addresses_UC_ht'}, 'dst': {'same': False, 'congruent': 5, 'type': 'addresses_UC_ht'}}
