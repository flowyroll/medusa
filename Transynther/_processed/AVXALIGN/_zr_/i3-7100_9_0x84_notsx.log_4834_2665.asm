...
nop
sub %rcx, %rcx
lea addresses_WT_ht+0x1d6bf, %rdx
nop
nop
nop
dec %r11
...
lea addresses_normal_ht+0xd0b3, %rdi
nop
add %r8, %r8
mov $92, %rcx
rep movsw
...
nop
cmp %rsi, %rsi
lea addresses_WC_ht+0x1588e, %r11
nop
nop
and %r12, %r12
mov (%r11), %ebx
...
nop
inc %rcx
lea addresses_WT_ht+0x1efd, %rbx
and %r8, %r8
mov (%rbx), %r12w
nop
sub %rcx, %rcx
lea addresses_UC_ht+0x5163, %rax
nop
nop
nop
nop
...
movq %r12, (%rax)
and %r11, %r11
lea addresses_normal_ht+0x11b33, %rdx
nop
nop
nop
dec %rbx
...
nop
xor $37916, %r12
lea addresses_A_ht+0x1700b, %rdi
nop
nop
nop
nop
...
vpextrq $1, %xmm7, %r11
cmp $58682, %rcx
lea addresses_WT_ht+0x1da33, %rsi
lea addresses_D_ht+0x10b73, %rdi
nop
nop
nop
cmp %rax, %rax
...
nop
sub %rbx, %rbx
lea addresses_normal_ht+0x138b3, %rsi
lea addresses_normal_ht+0xf8f3, %rdi
nop
nop
sub $31526, %r11
mov $79, %rcx
...
// REPMOV
lea addresses_US+0x1bf3, %rsi
lea addresses_WC+0x150f3, %rdi
nop
nop
nop
nop
...
{'src': {'type': 'addresses_US', 'congruent': 7, 'same': False}, 'dst': {'type': 'addresses_WC', 'congruent': 11, 'same': False}, 'OP': 'REPM'}
[Faulty Load]
...
{'src': {'type': 'addresses_normal_ht', 'same': False, 'size': 16, 'congruent': 5, 'NT': False, 'AVXalign': True}, 'OP': 'LOAD'}
{'src': {'type': 'addresses_A_ht', 'same': True, 'size': 32, 'congruent': 2, 'NT': False, 'AVXalign': False}, 'OP': 'LOAD'}
{'src': {'type': 'addresses_WT_ht', 'congruent': 6, 'same': False}, 'dst': {'type': 'addresses_D_ht', 'congruent': 6, 'same': False}, 'OP': 'REPM'}
{'src': {'type': 'addresses_UC_ht', 'congruent': 8, 'same': False}, 'dst': {'type': 'addresses_A_ht', 'congruent': 6, 'same': False}, 'OP': 'REPM'}
{'src': {'type': 'addresses_normal_ht', 'congruent': 6, 'same': False}, 'dst': {'type': 'addresses_normal_ht', 'congruent': 10, 'same': False}, 'OP': 'REPM'}
{'00': 4834}
