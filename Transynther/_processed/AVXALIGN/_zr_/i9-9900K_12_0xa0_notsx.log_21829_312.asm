...
nop
inc %rbx
lea addresses_WC_ht+0x9708, %r11
nop
nop
nop
nop
...
movl $0x61626364, (%r11)
and $18209, %rbx
lea addresses_normal_ht+0x1ad17, %r9
nop
nop
nop
xor %r10, %r10
...
nop
xor $1872, %rbx
lea addresses_normal_ht+0x16f88, %r11
nop
xor %r9, %r9
mov (%r11), %ebx
nop
...
nop
cmp $42571, %rsi
lea addresses_A_ht+0x139b8, %rsi
lea addresses_D_ht+0xc090, %rdi
add $2579, %r11
mov $13, %rcx
rep movsw
nop
nop
inc %rdi
lea addresses_WT_ht+0x1c788, %r11
nop
cmp $54376, %r10
...
vmovups %ymm0, (%r11)
add $60287, %r15
lea addresses_A_ht+0x14568, %rsi
lea addresses_normal_ht+0xe050, %rdi
clflush (%rsi)
nop
nop
nop
...
nop
xor %rdi, %rdi
lea addresses_A_ht+0x1af30, %rsi
lea addresses_WT_ht+0xccf0, %rdi
nop
nop
nop
nop
...
nop
add %r11, %r11
lea addresses_WT_ht+0xb788, %rsi
lea addresses_UC_ht+0x9388, %rdi
nop
nop
xor $43040, %r9
mov $126, %rcx
...
nop
xor %rbx, %rbx
lea addresses_UC_ht+0x88a8, %rdi
and %r10, %r10
mov (%rdi), %bx
nop
nop
...
nop
dec %r11
lea addresses_D_ht+0xbbac, %rsi
lea addresses_WT_ht+0x1ef88, %rdi
nop
nop
nop
nop
...
{'src': {'type': 'addresses_A_ht', 'congruent': 3, 'same': True}, 'OP': 'REPM', 'dst': {'type': 'addresses_D_ht', 'congruent': 2, 'same': False}}
...
{'src': {'type': 'addresses_A_ht', 'congruent': 3, 'same': False}, 'OP': 'REPM', 'dst': {'type': 'addresses_WT_ht', 'congruent': 3, 'same': False}}
...
{'src': {'type': 'addresses_D_ht', 'congruent': 1, 'same': False}, 'OP': 'REPM', 'dst': {'type': 'addresses_WT_ht', 'congruent': 11, 'same': False}}
{'00': 21829}
