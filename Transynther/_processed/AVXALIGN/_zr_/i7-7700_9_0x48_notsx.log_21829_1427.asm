...
nop
sub %r12, %r12
lea addresses_A_ht+0x1a1ab, %rsi
lea addresses_UC_ht+0x14be8, %rdi
nop
nop
xor $19115, %r14
mov $110, %rcx
rep movsl
add $51169, %r12
lea addresses_normal_ht+0x131ee, %rsi
lea addresses_WC_ht+0xcdf9, %rdi
nop
nop
nop
nop
...
nop
sub $11903, %rdx
lea addresses_WC_ht+0xc41c, %r13
sub %r14, %r14
...
nop
xor %r12, %r12
lea addresses_UC_ht+0x1156c, %rcx
nop
nop
nop
nop
...
// Store
lea addresses_normal+0xb4e8, %rcx
sub $38563, %r12
movw $0x5152, (%rcx)
nop
sub $9847, %rcx
...
{'dst': {'same': False, 'congruent': 8, 'type': 'addresses_RW'}, 'OP': 'REPM', 'src': {'same': False, 'congruent': 4, 'type': 'addresses_US'}}
...
{'dst': {'same': False, 'NT': False, 'AVXalign': True, 'size': 4, 'type': 'addresses_RW', 'congruent': 10}, 'OP': 'STOR'}
[Faulty Load]
