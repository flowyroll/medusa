...
nop
cmp $16973, %r11
lea addresses_WT_ht+0x18bae, %rcx
nop
nop
nop
add $38045, %r13
...
nop
cmp %r8, %r8
lea addresses_A_ht+0x17e26, %r13
nop
nop
nop
xor $29432, %rax
...
nop
add $12824, %r13
lea addresses_D_ht+0x18ffe, %r13
nop
add %r9, %r9
...
nop
sub $26639, %r8
lea addresses_A_ht+0xf18e, %rsi
lea addresses_D_ht+0x1322, %rdi
nop
nop
nop
nop
...
nop
add %r11, %r11
lea addresses_D_ht+0x1669, %rsi
lea addresses_WT_ht+0x3ae, %rdi
nop
nop
xor $43071, %rbx
mov $112, %rcx
...
{'OP': 'REPM', 'src': {'same': True, 'type': 'addresses_A_ht', 'congruent': 3}, 'dst': {'same': False, 'type': 'addresses_D_ht', 'congruent': 0}}
{'OP': 'STOR', 'dst': {'size': 2, 'NT': False, 'type': 'addresses_D_ht', 'same': True, 'AVXalign': False, 'congruent': 7}}
{'OP': 'REPM', 'src': {'same': True, 'type': 'addresses_D_ht', 'congruent': 0}, 'dst': {'same': False, 'type': 'addresses_WT_ht', 'congruent': 6}}
{'00': 21829}
