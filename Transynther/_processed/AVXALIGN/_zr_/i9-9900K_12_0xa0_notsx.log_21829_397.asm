...
push %rdi
push %rsi
lea addresses_UC_ht+0x6f70, %r10
nop
nop
nop
nop
...
nop
and %rbp, %rbp
lea addresses_D_ht+0x1e92a, %rcx
nop
nop
sub $14224, %r15
movl $0x61626364, (%rcx)
...
nop
cmp $7340, %r15
lea addresses_normal_ht+0x1488a, %r15
nop
xor %rsi, %rsi
...
nop
sub %rbx, %rbx
lea addresses_UC_ht+0x1ab0a, %rsi
lea addresses_A_ht+0x6aa, %rdi
nop
nop
nop
add %rbx, %rbx
...
nop
cmp %r10, %r10
lea addresses_normal_ht+0xbb76, %rsi
nop
nop
nop
sub $19794, %r15
...
nop
add $61810, %rcx
lea addresses_WT_ht+0xc778, %rbp
nop
dec %rcx
...
vmovups %ymm2, (%rbp)
inc %rsi
lea addresses_UC_ht+0xf08a, %rsi
lea addresses_normal_ht+0x1340a, %rdi
clflush (%rdi)
nop
nop
nop
...
nop
sub $30683, %rsi
lea addresses_D_ht+0x1008a, %rsi
lea addresses_normal_ht+0x1048a, %rdi
clflush (%rdi)
nop
sub $20820, %r9
mov $102, %rcx
...
// REPMOV
lea addresses_A+0x10f8a, %rsi
lea addresses_RW+0x1df0a, %rdi
nop
nop
nop
nop
...
{'src': {'type': 'addresses_A', 'congruent': 6, 'same': False}, 'OP': 'REPM', 'dst': {'type': 'addresses_RW', 'congruent': 7, 'same': False}}
[Faulty Load]
...
{'src': {'type': 'addresses_UC_ht', 'congruent': 7, 'same': True}, 'OP': 'REPM', 'dst': {'type': 'addresses_normal_ht', 'congruent': 7, 'same': False}}
