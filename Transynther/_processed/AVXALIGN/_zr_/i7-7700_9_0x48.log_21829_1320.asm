...
push %rdi
push %rsi
lea addresses_WT_ht+0xa5c7, %r13
nop
dec %r9
movl $0x61626364, (%r13)
nop
...
nop
xor %rax, %rax
lea addresses_normal_ht+0x7add, %r13
clflush (%r13)
nop
nop
nop
...
vpextrq $1, %xmm4, %r12
dec %r8
lea addresses_A_ht+0x6c87, %rsi
lea addresses_A_ht+0xbaab, %rdi
xor $47453, %r12
mov $12, %rcx
rep movsl
nop
...
nop
add %r8, %r8
lea addresses_UC_ht+0x16687, %r13
nop
nop
nop
sub $50112, %rsi
...
nop
sub %rcx, %rcx
lea addresses_WT_ht+0x160af, %r9
clflush (%r9)
nop
nop
nop
...
nop
sub $39840, %r8
lea addresses_WC_ht+0x1e787, %rdi
xor %rsi, %rsi
mov (%rdi), %cx
nop
nop
nop
cmp %rdi, %rdi
lea addresses_WC_ht+0x1a287, %rax
nop
nop
sub %r8, %r8
movups (%rax), %xmm4
...
{'OP': 'STOR', 'dst': {'type': 'addresses_UC_ht', 'AVXalign': True, 'congruent': 6, 'size': 2, 'same': False, 'NT': False}}
