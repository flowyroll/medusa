...
push %rdi
push %rsi
lea addresses_WT_ht+0x19de3, %rsi
lea addresses_UC_ht+0xb460, %rdi
xor $52614, %r14
mov $15, %rcx
rep movsl
nop
...
nop
and $31812, %r10
lea addresses_normal_ht+0x1c58f, %rcx
nop
nop
nop
nop
...
nop
cmp $23886, %r10
lea addresses_UC_ht+0xe088, %rcx
nop
nop
nop
nop
...
nop
cmp %rdi, %rdi
lea addresses_D_ht+0xc688, %rsi
lea addresses_WT_ht+0x17c, %rdi
add %r12, %r12
mov $11, %rcx
rep movsl
nop
nop
and $36487, %rsi
lea addresses_WT_ht+0x4e88, %r10
nop
nop
nop
nop
...
<gen_prepare_buffer>
{'src': {'congruent': 0, 'same': False, 'type': 'addresses_WT_ht'}, 'dst': {'congruent': 3, 'same': False, 'type': 'addresses_UC_ht'}, 'OP': 'REPM'}
