...
nop
cmp $46923, %r8
lea addresses_WT_ht+0x163a6, %rdi
clflush (%rdi)
nop
nop
sub $55834, %rcx
movb (%rdi), %r8b
sub %rbp, %rbp
lea addresses_UC_ht+0x199b2, %rsi
nop
nop
nop
nop
...
nop
add $11595, %rcx
lea addresses_UC_ht+0xe3e6, %rsi
lea addresses_D_ht+0x9fce, %rdi
nop
nop
and %r10, %r10
mov $91, %rcx
...
nop
add %rsi, %rsi
lea addresses_WC_ht+0x5fa6, %rsi
lea addresses_WC_ht+0x17be6, %rdi
nop
nop
and %rax, %rax
mov $35, %rcx
...
// Load
lea addresses_normal+0x103a6, %r10
nop
nop
nop
nop
...
{'OP': 'LOAD', 'src': {'type': 'addresses_normal', 'AVXalign': False, 'congruent': 10, 'size': 1, 'same': False, 'NT': True}}
...
{'OP': 'LOAD', 'src': {'type': 'addresses_UC_ht', 'AVXalign': False, 'congruent': 2, 'size': 16, 'same': False, 'NT': True}}
