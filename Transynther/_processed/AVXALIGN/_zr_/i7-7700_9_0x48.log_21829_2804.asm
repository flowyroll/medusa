...
nop
sub %rbp, %rbp
lea addresses_WT_ht+0x318c, %r14
nop
xor $48549, %r15
mov (%r14), %cx
nop
add $50045, %rbp
lea addresses_D_ht+0x656, %r15
nop
nop
nop
nop
...
nop
xor $58953, %rcx
lea addresses_WC_ht+0x96ac, %rsi
lea addresses_A_ht+0xb2c, %rdi
and $51621, %r15
mov $99, %rcx
rep movsq
nop
...
nop
add %rcx, %rcx
lea addresses_normal_ht+0x79ac, %r11
nop
nop
nop
nop
...
nop
sub $37412, %rcx
lea addresses_WT_ht+0x19fac, %rsi
...
{'OP': 'REPM', 'src': {'type': 'addresses_WT_ht', 'congruent': 4, 'same': True}, 'dst': {'type': 'addresses_WT_ht', 'congruent': 3, 'same': False}}
{'OP': 'LOAD', 'src': {'type': 'addresses_D_ht', 'AVXalign': False, 'congruent': 1, 'size': 1, 'same': True, 'NT': False}}
{'00': 21829}
