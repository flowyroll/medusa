...
push %rdi
push %rsi
lea addresses_D_ht+0x19b4f, %rsi
lea addresses_D_ht+0xae2f, %rdi
nop
nop
cmp %rbx, %rbx
mov $37, %rcx
...
nop
add $53611, %rdi
lea addresses_normal_ht+0x10b4f, %rsi
lea addresses_UC_ht+0xd3ff, %rdi
nop
nop
nop
nop
...
rep movsb
dec %rsi
lea addresses_WC_ht+0xbf0f, %rsi
lea addresses_A_ht+0x1e00f, %rdi
clflush (%rdi)
nop
nop
nop
...
nop
cmp $56428, %rbx
lea addresses_WT_ht+0x12f8f, %r15
nop
nop
nop
nop
...
nop
cmp $14708, %rbx
lea addresses_UC_ht+0xc857, %rbp
nop
nop
xor %rcx, %rcx
movb $0x61, (%rbp)
...
nop
add %r15, %r15
lea addresses_UC_ht+0x14be1, %rbp
nop
nop
nop
nop
...
nop
dec %rcx
lea addresses_A_ht+0x1a50f, %rsi
nop
nop
nop
nop
...
<gen_prepare_buffer>
{'OP': 'REPM', 'src': {'same': False, 'congruent': 5, 'type': 'addresses_D_ht'}, 'dst': {'same': False, 'congruent': 3, 'type': 'addresses_D_ht'}}
