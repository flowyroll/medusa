...
lea addresses_WT_ht+0x17b44, %rdi
nop
nop
nop
inc %rdx
...
nop
xor $51058, %rdi
lea addresses_UC_ht+0x1842c, %rsi
...
nop
add %rcx, %rcx
lea addresses_UC_ht+0x145da, %rbp
nop
nop
nop
add $55458, %r11
...
nop
xor %rbp, %rbp
lea addresses_UC_ht+0x3d24, %rdx
nop
nop
nop
cmp %rax, %rax
...
nop
and $63351, %rdx
lea addresses_normal_ht+0x16464, %rcx
nop
nop
dec %r12
vmovups (%rcx), %ymm6
...
nop
and %rax, %rax
lea addresses_normal_ht+0x1b744, %r12
nop
nop
nop
nop
...
{'src': {'same': False, 'congruent': 10, 'type': 'addresses_UC_ht'}, 'OP': 'REPM', 'dst': {'same': True, 'congruent': 8, 'type': 'addresses_WT_ht'}}
