...
push %rdi
push %rsi
lea addresses_normal_ht+0x409f, %rsi
...
nop
add $59994, %r15
lea addresses_normal_ht+0x1bd29, %r12
nop
nop
nop
nop
...
nop
xor %rsi, %rsi
lea addresses_WT_ht+0x8341, %rcx
nop
add %r12, %r12
...
nop
sub %r12, %r12
lea addresses_WC_ht+0x97c1, %r12
nop
nop
nop
nop
...
nop
xor %r12, %r12
lea addresses_UC_ht+0x11081, %rdi
nop
nop
xor $25034, %r12
vmovups (%rdi), %ymm4
...
nop
cmp $62013, %r15
lea addresses_WT_ht+0x1ac3, %rsi
nop
nop
nop
nop
...
movups %xmm4, (%rsi)
xor %r8, %r8
lea addresses_D_ht+0x19b41, %r13
nop
nop
nop
inc %r12
...
nop
sub %r8, %r8
lea addresses_UC_ht+0x1c801, %r8
nop
nop
nop
nop
...
nop
sub %r13, %r13
lea addresses_normal_ht+0x9781, %rsi
lea addresses_normal_ht+0xafc1, %rdi
nop
nop
xor %r13, %r13
mov $125, %rcx
...
<gen_prepare_buffer>
{'OP': 'REPM', 'src': {'type': 'addresses_normal_ht', 'congruent': 1, 'same': False}, 'dst': {'type': 'addresses_A_ht', 'congruent': 9, 'same': False}}
