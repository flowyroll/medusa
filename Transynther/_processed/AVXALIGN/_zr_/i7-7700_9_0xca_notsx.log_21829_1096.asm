...
push %rdi
push %rsi
lea addresses_WC_ht+0x145bf, %rdi
nop
and %r13, %r13
movb $0x61, (%rdi)
nop
...
nop
inc %rbp
lea addresses_WT_ht+0x4e2e, %rsi
lea addresses_WT_ht+0x1a662, %rdi
nop
nop
nop
nop
...
rep movsl
cmp %r8, %r8
lea addresses_A_ht+0x1b46e, %rbp
nop
lfence
movups (%rbp), %xmm1
vpextrq $1, %xmm1, %rcx
...
nop
sub %rsi, %rsi
lea addresses_WT_ht+0x113f6, %r13
nop
add %r10, %r10
movw $0x6162, (%r13)
nop
nop
add %r8, %r8
lea addresses_UC_ht+0x15e1e, %rsi
nop
nop
nop
inc %rbp
...
vpextrq $0, %xmm4, %rcx
and $21570, %rdi
lea addresses_normal_ht+0x262e, %rcx
nop
nop
nop
nop
...
movups %xmm7, (%rcx)
add $7836, %rcx
lea addresses_WT_ht+0x1c72e, %rsi
lea addresses_WT_ht+0xc1ee, %rdi
nop
sub %rax, %rax
mov $113, %rcx
rep movsq
...
nop
sub $28503, %rdi
lea addresses_WT_ht+0x17c2e, %rsi
nop
nop
and $53053, %r13
movb $0x61, (%rsi)
sub $47385, %r10
lea addresses_WC_ht+0x43ae, %r13
nop
nop
sub $50616, %r8
vmovups (%r13), %ymm3
...
nop
dec %r13
lea addresses_WT_ht+0x15e2e, %r10
nop
cmp %rdi, %rdi
movups (%r10), %xmm3
vpextrq $1, %xmm3, %rcx
...
nop
and $37132, %rcx
lea addresses_WT_ht+0x1acf4, %r8
nop
nop
add %r10, %r10
movl $0x61626364, (%r8)
...
<gen_prepare_buffer>
{'dst': {'NT': False, 'AVXalign': False, 'size': 1, 'congruent': 0, 'same': True, 'type': 'addresses_WC_ht'}, 'OP': 'STOR'}
{'src': {'congruent': 11, 'same': False, 'type': 'addresses_WT_ht'}, 'dst': {'congruent': 2, 'same': False, 'type': 'addresses_WT_ht'}, 'OP': 'REPM'}
{'src': {'NT': False, 'AVXalign': False, 'size': 16, 'congruent': 6, 'same': True, 'type': 'addresses_A_ht'}, 'OP': 'LOAD'}
...
{'src': {'congruent': 8, 'same': True, 'type': 'addresses_WT_ht'}, 'dst': {'congruent': 5, 'same': False, 'type': 'addresses_WT_ht'}, 'OP': 'REPM'}
