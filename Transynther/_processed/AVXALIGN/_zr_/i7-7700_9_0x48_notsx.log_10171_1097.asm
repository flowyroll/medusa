...
nop
xor $10934, %r14
lea addresses_WT_ht+0x94e1, %rsi
...
nop
add %rdi, %rdi
lea addresses_A_ht+0xbba1, %r15
xor %r9, %r9
movb (%r15), %cl
nop
nop
sub %rcx, %rcx
lea addresses_UC_ht+0x2ce1, %rsi
...
<gen_prepare_buffer>
{'dst': {'same': False, 'congruent': 7, 'type': 'addresses_WT_ht'}, 'OP': 'REPM', 'src': {'same': False, 'congruent': 6, 'type': 'addresses_A_ht'}}
...
{'dst': {'same': False, 'congruent': 1, 'type': 'addresses_normal_ht'}, 'OP': 'REPM', 'src': {'same': False, 'congruent': 11, 'type': 'addresses_UC_ht'}}
{'00': 10171}
