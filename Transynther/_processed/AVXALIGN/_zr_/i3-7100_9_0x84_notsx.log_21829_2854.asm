...
push %rdi
push %rsi
lea addresses_WT_ht+0x9128, %r15
nop
nop
sub %r14, %r14
movw $0x6162, (%r15)
...
nop
add $16077, %r14
lea addresses_WC_ht+0x16061, %rcx
nop
nop
nop
nop
...
nop
dec %r14
lea addresses_D_ht+0x1c4e7, %r12
inc %r10
movb (%r12), %cl
nop
nop
...
nop
xor %rcx, %rcx
lea addresses_WC_ht+0x44e7, %rsi
lea addresses_D_ht+0x1ece7, %rdi
nop
mfence
mov $70, %rcx
rep movsl
...
nop
and $9446, %r15
lea addresses_WT_ht+0x399f, %r9
nop
sub $58898, %r12
mov (%r9), %r14
nop
xor $7705, %r12
lea addresses_WT_ht+0x11b47, %r14
nop
nop
nop
nop
...
movq %r10, (%r14)
cmp $8229, %r12
lea addresses_UC_ht+0x13cb7, %r15
nop
nop
nop
nop
