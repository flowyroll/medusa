...
nop
add %rbx, %rbx
lea addresses_normal_ht+0x1de50, %r15
nop
sub $7108, %rdx
movb $0x61, (%r15)
nop
...
nop
inc %r9
lea addresses_WC_ht+0x150e0, %rbp
clflush (%rbp)
nop
nop
nop
...
[Faulty Load]
{'src': {'same': True, 'congruent': 0, 'NT': True, 'type': 'addresses_US', 'size': 2, 'AVXalign': True}, 'OP': 'LOAD'}
<gen_prepare_buffer>
{'OP': 'STOR', 'dst': {'same': False, 'congruent': 1, 'NT': True, 'type': 'addresses_D_ht', 'size': 16, 'AVXalign': False}}
{'OP': 'STOR', 'dst': {'same': True, 'congruent': 4, 'NT': False, 'type': 'addresses_normal_ht', 'size': 1, 'AVXalign': False}}
