...
push %rdi
push %rdx
lea addresses_normal_ht+0x520b, %r12
nop
nop
nop
nop
...
vpextrq $1, %xmm7, %rdi
sub $38816, %rbx
lea addresses_normal_ht+0xc63b, %r11
nop
nop
nop
nop
...
{'src': {'type': 'addresses_UC', 'same': False, 'size': 1, 'congruent': 4, 'NT': False, 'AVXalign': True}, 'OP': 'LOAD'}
