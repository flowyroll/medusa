...
push %rdx
push %rsi
lea addresses_normal_ht+0x1cb47, %rbx
and $58542, %rdx
...
nop
sub $22642, %r10
lea addresses_WT_ht+0x16547, %rsi
lea addresses_WC_ht+0x1cfd7, %rdi
nop
nop
nop
nop
...
nop
sub $62615, %rbx
lea addresses_WT_ht+0xa655, %rsi
lea addresses_UC_ht+0x17d02, %rdi
nop
nop
nop
nop
...
nop
inc %rdx
lea addresses_normal_ht+0xb08f, %r9
inc %rdi
...
nop
cmp %r14, %r14
lea addresses_normal_ht+0x12acf, %rsi
nop
add %rdx, %rdx
...
nop
dec %rdx
lea addresses_D_ht+0x1431f, %rbx
nop
nop
xor $15419, %rcx
mov (%rbx), %r9w
...
nop
and %r9, %r9
lea addresses_WC_ht+0x17fe7, %rsi
lea addresses_A_ht+0x1ab47, %rdi
nop
cmp $20759, %rbx
mov $58, %rcx
rep movsw
...
nop
cmp $63975, %rbx
lea addresses_UC_ht+0xad47, %rsi
lea addresses_D_ht+0x1ab47, %rdi
nop
nop
nop
sub $26964, %r10
...
nop
and $22100, %rdi
lea addresses_WT_ht+0xbf63, %rdi
nop
cmp $19960, %r14
mov (%rdi), %r9d
nop
...
// Store
lea addresses_normal+0x27c7, %r10
nop
nop
nop
inc %r9
...
{'dst': {'same': True, 'congruent': 4, 'type': 'addresses_WC_ht'}, 'OP': 'REPM', 'src': {'same': False, 'congruent': 11, 'type': 'addresses_WT_ht'}}
{'dst': {'same': False, 'congruent': 0, 'type': 'addresses_UC_ht'}, 'OP': 'REPM', 'src': {'same': False, 'congruent': 1, 'type': 'addresses_WT_ht'}}
...
{'dst': {'same': False, 'congruent': 9, 'type': 'addresses_A_ht'}, 'OP': 'REPM', 'src': {'same': False, 'congruent': 1, 'type': 'addresses_WC_ht'}}
