...
nop
xor %r15, %r15
lea addresses_WC_ht+0x19a8f, %rsi
lea addresses_D_ht+0x16765, %rdi
clflush (%rsi)
nop
nop
nop
...
nop
add %r15, %r15
lea addresses_UC_ht+0x6caf, %rsi
lea addresses_D_ht+0xb4d5, %rdi
nop
and $39709, %r13
mov $106, %rcx
rep movsl
...
nop
cmp %r15, %r15
lea addresses_A_ht+0x17165, %rsi
lea addresses_D_ht+0x1d209, %rdi
nop
cmp %r8, %r8
mov $44, %rcx
rep movsq
...
lea addresses_normal_ht+0x13665, %rdi
add $24453, %r9
mov $106, %rcx
rep movsq
nop
nop
cmp %rcx, %rcx
lea addresses_WC_ht+0x133e5, %rsi
lea addresses_normal_ht+0x140e5, %rdi
xor $53016, %rax
mov $17, %rcx
rep movsq
xor $6869, %rdi
lea addresses_WC_ht+0x9565, %rsi
lea addresses_D_ht+0x11861, %rdi
add %rax, %rax
mov $81, %rcx
rep movsq
nop
...
[Faulty Load]
{'OP': 'LOAD', 'src': {'type': 'addresses_WT', 'size': 32, 'AVXalign': True, 'NT': True, 'congruent': 0, 'same': True}}
<gen_prepare_buffer>
