...
push %rdi
push %rsi
lea addresses_WC_ht+0x17ccf, %rsi
lea addresses_normal_ht+0x60a7, %rdi
nop
nop
add $56869, %r10
mov $74, %rcx
...
nop
add $63981, %rax
lea addresses_normal_ht+0x1a16b, %rbp
nop
nop
nop
nop
...
nop
sub $46583, %rax
lea addresses_A_ht+0x192ff, %rsi
lea addresses_A_ht+0x97bf, %rdi
nop
nop
nop
nop
...
nop
cmp %rax, %rax
lea addresses_WC_ht+0x1d3f9, %rsi
lea addresses_A_ht+0x19dff, %rdi
nop
nop
inc %rax
mov $10, %rcx
...
nop
and $36156, %rbp
lea addresses_D_ht+0x1311f, %rcx
nop
nop
cmp %r12, %r12
...
nop
add $13531, %rsi
lea addresses_UC_ht+0xb47f, %rdi
nop
nop
nop
dec %rsi
...
nop
xor $21816, %r11
lea addresses_WC_ht+0x69ff, %r12
nop
nop
nop
xor $1187, %r10
...
nop
and %rcx, %rcx
lea addresses_WC_ht+0xf13f, %rsi
lea addresses_WC_ht+0x4157, %rdi
dec %rax
mov $56, %rcx
rep movsl
nop
...
{'OP': 'REPM', 'src': {'same': False, 'type': 'addresses_WC_ht', 'congruent': 1}, 'dst': {'same': False, 'type': 'addresses_A_ht', 'congruent': 8}}
