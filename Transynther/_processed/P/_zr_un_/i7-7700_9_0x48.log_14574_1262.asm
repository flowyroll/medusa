...
nop
and $11817, %r10
lea addresses_WC_ht+0x1288, %rdi
nop
nop
nop
nop
...
nop
add %r8, %r8
lea addresses_UC_ht+0x130a8, %rdi
inc %r10
mov $0x6162636465666768, %rbp
movq %rbp, (%rdi)
add %rdi, %rdi
lea addresses_WC_ht+0x9fbc, %r10
nop
nop
nop
nop
...
nop
and $26138, %r15
lea addresses_UC_ht+0x98a8, %rdi
nop
nop
add %r13, %r13
movb $0x61, (%rdi)
...
nop
cmp %r10, %r10
lea addresses_WC_ht+0x1b918, %rsi
lea addresses_D_ht+0xd4aa, %rdi
clflush (%rdi)
nop
nop
cmp %r13, %r13
...
nop
add %r15, %r15
lea addresses_WT_ht+0x13708, %rsi
lea addresses_WC_ht+0x1e708, %rdi
nop
and %r10, %r10
mov $13, %rcx
rep movsl
...
nop
sub $23715, %r10
lea addresses_D_ht+0x41c8, %rsi
lea addresses_A_ht+0x5f08, %rdi
nop
nop
nop
add %rax, %rax
...
{'OP': 'REPM', 'src': {'type': 'addresses_WC_ht', 'congruent': 0, 'same': False}, 'dst': {'type': 'addresses_D_ht', 'congruent': 0, 'same': True}}
