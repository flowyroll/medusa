...
rep movsl
sub $65027, %r15
lea addresses_WT_ht+0x99ec, %rsi
lea addresses_WT_ht+0x10d6c, %rdi
nop
nop
add $7480, %r12
mov $91, %rcx
...
nop
sub $64362, %r8
lea addresses_UC_ht+0x1786c, %rcx
clflush (%rcx)
nop
nop
nop
...
nop
dec %rcx
lea addresses_UC_ht+0x1342c, %rsi
xor $59921, %r12
mov (%rsi), %r8
nop
nop
cmp $51065, %rax
lea addresses_A_ht+0xf06c, %rsi
nop
nop
nop
inc %rcx
...
<gen_prepare_buffer>
{'src': {'type': 'addresses_D_ht', 'congruent': 10, 'same': False}, 'OP': 'REPM', 'dst': {'type': 'addresses_WC_ht', 'congruent': 2, 'same': False}}
...
{'src': {'type': 'addresses_UC_ht', 'AVXalign': False, 'size': 8, 'NT': True, 'same': False, 'congruent': 4}, 'OP': 'LOAD'}
