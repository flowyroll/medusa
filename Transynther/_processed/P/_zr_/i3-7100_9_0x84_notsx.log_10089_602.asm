...
nop
xor $62482, %rsi
lea addresses_normal_ht+0xca99, %rbx
nop
nop
nop
nop
...
nop
dec %r10
lea addresses_normal_ht+0x17d01, %r10
nop
nop
nop
nop
...
nop
dec %r14
lea addresses_WT_ht+0x10899, %rsi
lea addresses_WC_ht+0x2c17, %rdi
clflush (%rsi)
nop
nop
nop
...
nop
cmp %rbp, %rbp
lea addresses_normal_ht+0x24b4, %rdi
nop
sub $29593, %rbx
...
movaps %xmm4, (%rdi)
and %rbp, %rbp
lea addresses_WT_ht+0x17199, %r10
nop
nop
nop
sub %rdi, %rdi
...
nop
add $58868, %r11
lea addresses_WT_ht+0xd827, %rcx
nop
cmp %rbp, %rbp
movw $0x6162, (%rcx)
nop
...
lea addresses_A_ht+0x1cfd9, %rdi
nop
nop
nop
nop
...
rep movsl
and $35496, %r10
lea addresses_WC_ht+0x5fdb, %rcx
clflush (%rcx)
nop
nop
nop
...
{'dst': {'type': 'addresses_normal_ht', 'same': False, 'size': 16, 'congruent': 0, 'NT': False, 'AVXalign': True}, 'OP': 'STOR'}
