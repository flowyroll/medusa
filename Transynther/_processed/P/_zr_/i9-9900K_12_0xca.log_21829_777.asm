...
nop
xor $14922, %r15
lea addresses_WC_ht+0x1be85, %rbp
clflush (%rbp)
nop
xor $63148, %rdi
...
nop
and %rcx, %rcx
lea addresses_A_ht+0x2907, %rsi
lea addresses_normal_ht+0x198d, %rdi
clflush (%rsi)
clflush (%rdi)
nop
nop
...
nop
and %r8, %r8
lea addresses_WT_ht+0x8191, %rsi
lea addresses_WC_ht+0x9611, %rdi
nop
nop
dec %r8
mov $115, %rcx
...
nop
and $26295, %rbp
lea addresses_D_ht+0x18591, %rsi
lea addresses_D_ht+0x2191, %rdi
nop
nop
nop
and %rax, %rax
...
nop
inc %r8
lea addresses_normal_ht+0x12b91, %rsi
nop
nop
nop
cmp %rbp, %rbp
...
<gen_faulty_load>
[REF]
{'OP': 'LOAD', 'src': {'size': 32, 'NT': False, 'type': 'addresses_P', 'same': False, 'AVXalign': True, 'congruent': 0}}
[Faulty Load]
...
{'OP': 'REPM', 'src': {'same': False, 'type': 'addresses_D_ht', 'congruent': 10}, 'dst': {'same': False, 'type': 'addresses_D_ht', 'congruent': 11}}
