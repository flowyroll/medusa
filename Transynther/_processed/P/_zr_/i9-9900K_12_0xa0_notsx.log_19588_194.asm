...
push %rdx
push %rsi
lea addresses_A_ht+0x12eab, %rsi
lea addresses_WC_ht+0x287f, %rdi
nop
nop
nop
and %rax, %rax
...
nop
sub %r13, %r13
lea addresses_UC_ht+0xb22b, %r15
nop
nop
nop
xor $25694, %rcx
...
nop
dec %r15
lea addresses_D_ht+0x1a7ab, %rsi
add %rbp, %rbp
movl $0x61626364, (%rsi)
inc %rbp
lea addresses_UC_ht+0x1561c, %rbp
nop
sub %rsi, %rsi
mov (%rbp), %rdi
nop
...
nop
add $41571, %rdi
lea addresses_normal_ht+0xbd0b, %r13
nop
nop
nop
nop
...
nop
and %r15, %r15
lea addresses_UC_ht+0x142a7, %rcx
nop
nop
nop
and $5666, %r15
...
nop
inc %rbp
lea addresses_UC_ht+0x176ab, %r15
nop
nop
nop
nop
...
nop
add %rbp, %rbp
lea addresses_WC_ht+0xeeab, %rsi
nop
nop
nop
nop
...
nop
cmp $1321, %rsi
lea addresses_WC_ht+0x1a293, %rsi
...
nop
sub %rdx, %rdx
lea addresses_A_ht+0x176ab, %rsi
lea addresses_A_ht+0xe32b, %rdi
nop
inc %r15
mov $13, %rcx
rep movsw
...
<gen_prepare_buffer>
{'src': {'type': 'addresses_A_ht', 'congruent': 11, 'same': False}, 'OP': 'REPM', 'dst': {'type': 'addresses_WC_ht', 'congruent': 2, 'same': False}}
...
{'src': {'type': 'addresses_UC_ht', 'AVXalign': True, 'size': 16, 'NT': False, 'same': True, 'congruent': 1}, 'OP': 'LOAD'}
