...
push %rdi
push %rsi
lea addresses_normal_ht+0x1cf4d, %r11
clflush (%r11)
nop
and $2012, %r13
...
vmovups %ymm4, (%r11)
and %rdi, %rdi
lea addresses_WT_ht+0x1afb9, %rsi
lea addresses_WC_ht+0x18e6f, %rdi
nop
nop
nop
and %r10, %r10
...
nop
cmp $54157, %rsi
lea addresses_A_ht+0x1e61, %rsi
lea addresses_D_ht+0x13ccd, %rdi
nop
nop
nop
nop
...
nop
dec %r11
lea addresses_D_ht+0x1b7a1, %r10
nop
nop
nop
nop
...
vmovaps %ymm1, (%r10)
and $40822, %r9
lea addresses_D_ht+0x17341, %rsi
lea addresses_A_ht+0xcd89, %rdi
nop
nop
nop
nop
...
nop
cmp $11892, %r11
lea addresses_A_ht+0x104e1, %rsi
lea addresses_normal_ht+0x1d6c1, %rdi
nop
cmp $27062, %r9
mov $64, %rcx
rep movsw
...
nop
add %r10, %r10
lea addresses_normal_ht+0x2ba1, %rsi
lea addresses_A_ht+0x1a547, %rdi
clflush (%rdi)
nop
and $31734, %r11
mov $12, %rcx
...
nop
xor %rcx, %rcx
lea addresses_WT_ht+0xfe1, %rsi
lea addresses_WT_ht+0x1eba1, %rdi
nop
cmp %r9, %r9
mov $59, %rcx
rep movsw
...
{'dst': {'same': False, 'congruent': 0, 'type': 'addresses_WC_ht'}, 'OP': 'REPM', 'src': {'same': False, 'congruent': 3, 'type': 'addresses_WT_ht'}}
...
{'dst': {'same': False, 'congruent': 2, 'type': 'addresses_normal_ht'}, 'OP': 'REPM', 'src': {'same': False, 'congruent': 5, 'type': 'addresses_A_ht'}}
...
{'dst': {'same': False, 'congruent': 11, 'type': 'addresses_WT_ht'}, 'OP': 'REPM', 'src': {'same': False, 'congruent': 3, 'type': 'addresses_WT_ht'}}
{'00': 3877}
