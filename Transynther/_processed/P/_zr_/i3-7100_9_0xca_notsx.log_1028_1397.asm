...
push %rdi
push %rsi
lea addresses_A_ht+0x153e5, %r11
nop
nop
xor %r8, %r8
movb $0x61, (%r11)
...
nop
add %r9, %r9
lea addresses_D_ht+0x7ee5, %rsi
lea addresses_UC_ht+0x1165, %rdi
clflush (%rdi)
nop
nop
nop
...
nop
cmp $52485, %r11
lea addresses_WC_ht+0x15a5, %rsi
lea addresses_D_ht+0xa405, %rdi
nop
nop
nop
nop
...
rep movsw
and $20885, %r12
lea addresses_WT_ht+0x1ee1d, %r12
nop
nop
nop
nop
...
nop
xor $9439, %rcx
lea addresses_WT_ht+0x12c69, %rsi
lea addresses_UC_ht+0xb065, %rdi
clflush (%rsi)
nop
nop
nop
...
nop
xor $61915, %r8
lea addresses_UC_ht+0x1d90d, %r11
nop
nop
nop
cmp $3202, %rdi
...
nop
add $48091, %r11
lea addresses_D_ht+0x1e465, %rsi
...
{'src': {'type': 'addresses_A_ht', 'congruent': 1, 'same': False}, 'OP': 'REPM', 'dst': {'type': 'addresses_D_ht', 'congruent': 0, 'same': False}}
