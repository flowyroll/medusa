...
push %rdx
push %rsi
lea addresses_WT_ht+0x8507, %rsi
lea addresses_D_ht+0x1e87, %rdi
and $42933, %rbp
mov $4, %rcx
rep movsq
nop
...
nop
cmp %rdx, %rdx
lea addresses_normal_ht+0x17487, %rdx
nop
and %r12, %r12
movb $0x61, (%rdx)
sub %rdi, %rdi
lea addresses_WT_ht+0xca3f, %rsi
lea addresses_WT_ht+0x44e7, %rdi
clflush (%rsi)
nop
nop
nop
...
nop
cmp $10146, %r12
lea addresses_WT_ht+0x14b4f, %rcx
nop
nop
nop
nop
...
nop
add $25738, %rdi
lea addresses_A_ht+0x15e47, %rsi
nop
nop
nop
and $46587, %rdi
...
nop
cmp $21799, %rbp
lea addresses_normal_ht+0x11705, %rcx
add $52804, %rdi
movl $0x61626364, (%rcx)
nop
inc %rbp
