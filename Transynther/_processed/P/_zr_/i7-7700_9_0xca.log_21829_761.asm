...
movntdq %xmm2, (%r15)
add $2750, %r13
lea addresses_A_ht+0x1d3db, %rbx
nop
nop
nop
nop
...
nop
and %rsi, %rsi
lea addresses_UC_ht+0x125b, %rdx
nop
nop
nop
nop
...
nop
add $57955, %rsi
lea addresses_WC_ht+0xdfdb, %rsi
lea addresses_normal_ht+0x137db, %rdi
nop
cmp %r11, %r11
mov $27, %rcx
rep movsb
xor $44043, %r8
lea addresses_UC_ht+0xe9dd, %rsi
nop
nop
nop
cmp %r8, %r8
...
nop
and %rdi, %rdi
lea addresses_normal_ht+0xf65b, %r8
nop
nop
nop
nop
...
nop
inc %rbx
lea addresses_normal_ht+0x951b, %r15
add $64190, %rcx
mov $0x6162636465666768, %r11
movq %r11, %xmm6
movups %xmm6, (%r15)
sub %r11, %r11
lea addresses_WT_ht+0xe5db, %r8
nop
inc %rbx
mov $0x6162636465666768, %rdx
movq %rdx, %xmm1
...
nop
add %rcx, %rcx
lea addresses_UC_ht+0x7ddb, %rsi
lea addresses_D_ht+0xf25b, %rdi
clflush (%rdi)
nop
nop
nop
...
nop
xor $34244, %rcx
lea addresses_UC_ht+0x65db, %r11
nop
nop
nop
nop
...
nop
add $38053, %r11
lea addresses_D_ht+0x1119f, %rcx
nop
nop
nop
sub %r13, %r13
...
<gen_prepare_buffer>
{'OP': 'STOR', 'dst': {'congruent': 3, 'AVXalign': False, 'same': False, 'size': 16, 'NT': True, 'type': 'addresses_D_ht'}}
...
{'OP': 'STOR', 'dst': {'congruent': 1, 'AVXalign': False, 'same': True, 'size': 1, 'NT': False, 'type': 'addresses_UC_ht'}}
