...
push %rdi
push %rdx
lea addresses_normal_ht+0xefba, %rdi
and $49484, %rbp
movw $0x6162, (%rdi)
nop
lfence
lea addresses_WC_ht+0x1bad2, %r9
nop
nop
xor $10537, %rdx
...
nop
and %rbp, %rbp
lea addresses_UC_ht+0xf322, %rbp
cmp %rdi, %rdi
vmovups (%rbp), %ymm2
...
nop
dec %rdx
lea addresses_WC_ht+0x10b22, %r15
and %r10, %r10
movl $0x61626364, (%r15)
add %rdi, %rdi
pop %rdx
...
// REPMOV
lea addresses_WC+0x196fc, %rsi
lea addresses_UC+0x18722, %rdi
nop
nop
nop
xor $46481, %r11
...
{'src': {'type': 'addresses_WC', 'congruent': 0, 'same': False}, 'dst': {'type': 'addresses_UC', 'congruent': 10, 'same': False}, 'OP': 'REPM'}
[Faulty Load]
