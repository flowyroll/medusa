...
push %rbx
push %rcx
lea addresses_WC_ht+0xd189, %r10
nop
nop
nop
nop
...
nop
add $46551, %r14
lea addresses_WT_ht+0x1b0e9, %rcx
nop
nop
nop
nop
...
nop
and $36410, %r12
lea addresses_UC_ht+0xd289, %rbp
nop
cmp %r12, %r12
...
nop
and $18938, %r8
lea addresses_WT_ht+0x2b39, %r10
xor $38037, %rbp
mov (%r10), %r8
nop
nop
...
nop
cmp %rbp, %rbp
lea addresses_WC_ht+0x60f9, %rbp
nop
nop
nop
inc %r10
movw $0x6162, (%rbp)
sub $52240, %rcx
lea addresses_WC_ht+0xf309, %rbx
sub $48782, %rbp
mov (%rbx), %cx
nop
nop
nop
inc %rbp
lea addresses_WC_ht+0xa7a9, %rcx
nop
nop
add %r10, %r10
vmovups (%rcx), %ymm4
...
<gen_faulty_load>
[REF]
{'OP': 'LOAD', 'src': {'same': False, 'NT': False, 'AVXalign': True, 'size': 16, 'type': 'addresses_P', 'congruent': 0}}
