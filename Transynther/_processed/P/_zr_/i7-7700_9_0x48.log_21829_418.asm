...
push %rdx
push %rsi
lea addresses_WT_ht+0x19c2c, %rbp
nop
xor $19668, %r14
...
nop
xor %rsi, %rsi
lea addresses_normal_ht+0x1292c, %r12
add $50867, %r9
mov (%r12), %edx
nop
dec %rsi
lea addresses_WT_ht+0xd32c, %r9
and $56021, %rdx
movw $0x6162, (%r9)
nop
nop
nop
and $18028, %rbp
lea addresses_A_ht+0x1b82c, %rdx
clflush (%rdx)
nop
nop
nop
...
nop
inc %rdx
lea addresses_WT_ht+0x9ddc, %rsi
lea addresses_WC_ht+0x118ac, %rdi
nop
nop
nop
nop
