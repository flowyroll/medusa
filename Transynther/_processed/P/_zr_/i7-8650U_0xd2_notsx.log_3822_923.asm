...
push %rdi
push %rsi
lea addresses_WT_ht+0x6aa4, %rsi
lea addresses_normal_ht+0x12d54, %rdi
nop
and $64421, %r10
mov $99, %rcx
rep movsq
...
nop
xor %rcx, %rcx
lea addresses_normal_ht+0x16614, %r13
nop
nop
nop
nop
...
nop
xor %r10, %r10
lea addresses_WT_ht+0x18494, %r14
nop
add $59531, %rsi
mov (%r14), %r10d
nop
...
// REPMOV
lea addresses_D+0x3614, %rsi
lea addresses_normal+0x1d994, %rdi
clflush (%rdi)
nop
nop
nop
...
{'OP': 'REPM', 'src': {'type': 'addresses_D', 'congruent': 11, 'same': False}, 'dst': {'type': 'addresses_normal', 'congruent': 5, 'same': False}}
...
{'OP': 'STOR', 'dst': {'type': 'addresses_normal_ht', 'size': 16, 'AVXalign': True, 'NT': True, 'congruent': 11, 'same': False}}
