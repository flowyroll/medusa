...
push %rdi
push %rsi
lea addresses_WT_ht+0x1a030, %rdi
nop
nop
xor %rax, %rax
movl $0x61626364, (%rdi)
...
nop
add %r12, %r12
lea addresses_A_ht+0x19f70, %rax
nop
nop
nop
nop
...
nop
add $26738, %r15
lea addresses_D_ht+0x168f0, %rsi
lea addresses_UC_ht+0xeca0, %rdi
nop
nop
and %r8, %r8
mov $19, %rcx
...
nop
xor %rax, %rax
lea addresses_WT_ht+0x198f0, %r8
nop
nop
nop
nop
...
nop
add $43186, %r11
lea addresses_WT_ht+0x75ed, %rcx
nop
nop
nop
nop
...
nop
dec %r8
lea addresses_WC_ht+0xaf70, %rsi
lea addresses_WT_ht+0xc670, %rdi
nop
nop
nop
sub %r8, %r8
...
nop
and %r11, %r11
lea addresses_A_ht+0x15570, %rax
nop
nop
nop
nop
...
{'dst': {'type': 'addresses_A_ht', 'same': False, 'size': 16, 'congruent': 9, 'NT': True, 'AVXalign': True}, 'OP': 'STOR'}
...
{'src': {'type': 'addresses_WC_ht', 'congruent': 6, 'same': True}, 'dst': {'type': 'addresses_WT_ht', 'congruent': 7, 'same': False}, 'OP': 'REPM'}
{'src': {'type': 'addresses_A_ht', 'same': False, 'size': 32, 'congruent': 11, 'NT': False, 'AVXalign': True}, 'OP': 'LOAD'}
{'00': 1552}
