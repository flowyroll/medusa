...
push %rdx
push %rsi
lea addresses_A_ht+0x10235, %rax
clflush (%rax)
xor %rdx, %rdx
mov (%rax), %r12
nop
...
movq %rdx, (%r15)
and %rbp, %rbp
lea addresses_WT_ht+0x19035, %r15
nop
nop
nop
nop
...
nop
inc %rax
lea addresses_normal_ht+0x18635, %rdx
nop
nop
nop
nop
...
nop
xor %r15, %r15
lea addresses_WC_ht+0x1940b, %r13
nop
nop
mfence
mov $0x6162636465666768, %rdx
...
nop
xor %rax, %rax
lea addresses_normal_ht+0x11785, %rsi
lea addresses_normal_ht+0x1e7f5, %rdi
nop
nop
nop
nop
...
lea addresses_UC_ht+0xc2d5, %rdi
nop
nop
nop
nop
...
nop
cmp %rdx, %rdx
lea addresses_WT_ht+0xbe35, %r12
nop
cmp %rbp, %rbp
...
{'src': {'type': 'addresses_D_ht', 'congruent': 0, 'same': False}, 'OP': 'REPM', 'dst': {'type': 'addresses_UC_ht', 'congruent': 5, 'same': False}}
