...
nop
sub $23703, %rax
lea addresses_WT_ht+0x13432, %rax
nop
nop
nop
nop
...
nop
add %rax, %rax
lea addresses_WT_ht+0x64f2, %rbx
and $20299, %r8
mov (%rbx), %edx
nop
nop
nop
inc %rax
lea addresses_WC_ht+0xec52, %r15
nop
nop
nop
nop
...
nop
cmp $16421, %r10
lea addresses_WC_ht+0x1b232, %rsi
lea addresses_normal_ht+0x1a172, %rdi
clflush (%rsi)
cmp $3266, %rbx
mov $53, %rcx
rep movsl
...
nop
inc %rax
lea addresses_normal_ht+0x1270a, %rsi
lea addresses_UC_ht+0x1585, %rdi
nop
dec %rdx
mov $67, %rcx
rep movsq
...
nop
add %r8, %r8
lea addresses_D_ht+0x166b2, %rdi
nop
add $53191, %rax
mov (%rdi), %r8
nop
...
nop
and %r8, %r8
lea addresses_WC_ht+0x15efa, %r9
nop
xor $25538, %r8
mov (%r9), %r10d
nop
inc %rax
lea addresses_A_ht+0xf652, %r8
clflush (%r8)
nop
nop
nop
...
nop
sub %rbx, %rbx
lea addresses_WC_ht+0x1b482, %r8
clflush (%r8)
nop
nop
and $26506, %r15
...
nop
and %rdx, %rdx
lea addresses_A_ht+0x12832, %rbx
nop
nop
nop
nop
...
{'OP': 'STOR', 'dst': {'same': False, 'type': 'addresses_WC_ht', 'NT': False, 'AVXalign': True, 'size': 1, 'congruent': 3}}
{'OP': 'REPM', 'src': {'same': True, 'congruent': 7, 'type': 'addresses_WC_ht'}, 'dst': {'same': False, 'congruent': 6, 'type': 'addresses_normal_ht'}}
{'OP': 'REPM', 'src': {'same': False, 'congruent': 3, 'type': 'addresses_normal_ht'}, 'dst': {'same': False, 'congruent': 0, 'type': 'addresses_UC_ht'}}
