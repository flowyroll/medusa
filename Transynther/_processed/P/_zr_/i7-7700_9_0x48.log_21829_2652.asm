...
nop
sub $17385, %rbp
lea addresses_UC_ht+0x16fe0, %rcx
nop
sub %r12, %r12
mov (%rcx), %r11d
cmp %rbp, %rbp
lea addresses_normal_ht+0x10de0, %rsi
lea addresses_normal_ht+0x1e3a0, %rdi
nop
nop
nop
add %r14, %r14
...
nop
dec %rbp
lea addresses_WT_ht+0xe46f, %r11
nop
add %r8, %r8
movups (%r11), %xmm5
vpextrq $0, %xmm5, %rdi
...
nop
sub $28654, %rbp
lea addresses_WC_ht+0x6de0, %rdi
nop
nop
nop
add %rcx, %rcx
