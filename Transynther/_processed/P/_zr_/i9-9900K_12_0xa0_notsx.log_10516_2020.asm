...
push %rdi
push %rsi
lea addresses_UC_ht+0x1201d, %rbx
xor %r12, %r12
mov (%rbx), %eax
nop
nop
and %rax, %rax
lea addresses_WC_ht+0x11dcd, %rsi
add $63118, %r14
movups (%rsi), %xmm7
vpextrq $0, %xmm7, %r9
nop
and %r14, %r14
lea addresses_WT_ht+0x1670d, %rsi
dec %rdi
...
nop
cmp $8020, %rbx
lea addresses_WC_ht+0x1411d, %rsi
nop
add %r9, %r9
movb $0x61, (%rsi)
nop
...
{'OP': 'STOR', 'dst': {'type': 'addresses_WC_ht', 'AVXalign': False, 'size': 1, 'NT': True, 'same': False, 'congruent': 11}}
{'00': 10516}
