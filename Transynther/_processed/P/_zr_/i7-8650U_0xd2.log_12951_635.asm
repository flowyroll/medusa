...
push %rdx
push %rsi
lea addresses_D_ht+0x1257, %r9
nop
cmp $21898, %rdx
mov (%r9), %r11w
sub $16225, %r11
lea addresses_WT_ht+0x49ce, %rsi
lea addresses_WC_ht+0xc907, %rdi
nop
nop
nop
nop
...
nop
cmp %r9, %r9
lea addresses_WT_ht+0xf0f0, %rsi
lea addresses_UC_ht+0x137, %rdi
dec %rbp
mov $10, %rcx
rep movsl
nop
xor %r9, %r9
lea addresses_A_ht+0x113d7, %r11
nop
nop
nop
inc %rbp
...
nop
and $45509, %r10
lea addresses_WT_ht+0x1b737, %r10
nop
xor $25224, %rdi
...
movups %xmm4, (%r10)
cmp $3227, %rbp
lea addresses_WC_ht+0x1147c, %rdi
nop
nop
nop
nop
...
nop
xor %r10, %r10
lea addresses_UC_ht+0x1487f, %rsi
lea addresses_WC_ht+0x11137, %rdi
cmp %r9, %r9
mov $25, %rcx
rep movsb
xor $3860, %r10
lea addresses_normal_ht+0x12c37, %rdx
nop
nop
sub $42470, %rsi
...
// Store
lea addresses_normal+0x978d, %r15
nop
nop
nop
nop
...
{'OP': 'REPM', 'src': {'type': 'addresses_WT_ht', 'congruent': 0, 'same': True}, 'dst': {'type': 'addresses_UC_ht', 'congruent': 7, 'same': False}}
...
{'OP': 'REPM', 'src': {'type': 'addresses_UC_ht', 'congruent': 1, 'same': True}, 'dst': {'type': 'addresses_WC_ht', 'congruent': 8, 'same': False}}
