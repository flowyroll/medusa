...
push %rdi
push %rsi
lea addresses_D_ht+0x64d7, %rsi
lea addresses_UC_ht+0x5c57, %rdi
nop
inc %rax
mov $55, %rcx
rep movsb
nop
sub %r14, %r14
lea addresses_WC_ht+0x1ab3, %rsi
lea addresses_A_ht+0x6a37, %rdi
nop
nop
xor %r9, %r9
mov $55, %rcx
...
<gen_prepare_buffer>
{'dst': {'same': False, 'congruent': 11, 'type': 'addresses_UC_ht'}, 'OP': 'REPM', 'src': {'same': False, 'congruent': 6, 'type': 'addresses_D_ht'}}
{'dst': {'same': False, 'congruent': 5, 'type': 'addresses_A_ht'}, 'OP': 'REPM', 'src': {'same': False, 'congruent': 0, 'type': 'addresses_WC_ht'}}
