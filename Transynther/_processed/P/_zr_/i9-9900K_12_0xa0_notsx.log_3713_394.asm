...
nop
xor %r13, %r13
lea addresses_WC_ht+0x1be9a, %rsi
...
nop
cmp %rcx, %rcx
lea addresses_WT_ht+0x19a12, %r12
nop
nop
nop
nop
...
nop
dec %rdi
lea addresses_UC_ht+0x11e4, %r12
and %rdx, %rdx
mov (%r12), %ax
nop
nop
...
nop
xor %rdi, %rdi
lea addresses_A_ht+0x9522, %rsi
lea addresses_UC_ht+0xac1a, %rdi
nop
nop
nop
cmp %r12, %r12
...
nop
and %r10, %r10
lea addresses_WC_ht+0xae9a, %rdi
inc %r14
...
{'src': {'type': 'addresses_WT', 'AVXalign': False, 'size': 8, 'NT': False, 'same': False, 'congruent': 3}, 'OP': 'LOAD'}
[Faulty Load]
...
{'src': {'type': 'addresses_WC_ht', 'congruent': 6, 'same': False}, 'OP': 'REPM', 'dst': {'type': 'addresses_WC_ht', 'congruent': 1, 'same': True}}
