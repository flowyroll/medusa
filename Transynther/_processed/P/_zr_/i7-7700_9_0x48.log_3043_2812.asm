...
push %rdx
push %rsi
lea addresses_A_ht+0x1adbe, %rsi
...
rep movsl
inc %rax
lea addresses_WC_ht+0x660e, %rbp
nop
nop
add %rax, %rax
mov (%rbp), %cx
...
nop
add $41484, %r15
lea addresses_UC_ht+0x1d104, %rsi
nop
nop
nop
cmp $42457, %r14
...
nop
and $20340, %r15
lea addresses_WC_ht+0x1390e, %rsi
nop
nop
nop
nop
...
nop
and $46953, %rax
lea addresses_UC_ht+0x1452e, %rax
nop
cmp %rdi, %rdi
movb (%rax), %r15b
nop
...
nop
cmp $12737, %r14
lea addresses_UC_ht+0x2b0e, %rax
nop
nop
nop
nop
...
nop
add $17555, %r15
lea addresses_normal_ht+0x19f2e, %rsi
lea addresses_normal_ht+0x1b5b2, %rdi
clflush (%rdi)
xor $30609, %rdx
mov $8, %rcx
rep movsw
...
nop
cmp $10770, %rsi
lea addresses_WT_ht+0x15f2e, %rsi
