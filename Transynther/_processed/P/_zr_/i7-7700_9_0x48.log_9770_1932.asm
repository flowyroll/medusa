...
push %rdx
push %rsi
lea addresses_A_ht+0x15b0a, %rcx
clflush (%rcx)
nop
cmp $21397, %r12
movl $0x61626364, (%rcx)
...
rep movsw
add %rdi, %rdi
lea addresses_D_ht+0x19038, %r9
nop
and %rdi, %rdi
movb (%r9), %r12b
nop
sub $57502, %rdi
lea addresses_UC_ht+0xb25c, %rsi
...
nop
and $55466, %rax
lea addresses_UC_ht+0xec08, %rsi
lea addresses_A_ht+0xe70a, %rdi
cmp $58426, %rax
mov $21, %rcx
rep movsw
nop
...
{'OP': 'REPM', 'src': {'type': 'addresses_UC_ht', 'congruent': 1, 'same': False}, 'dst': {'type': 'addresses_A_ht', 'congruent': 6, 'same': True}}
