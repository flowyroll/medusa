...
push %rdi
push %rsi
lea addresses_UC_ht+0x1a115, %rbp
nop
nop
nop
nop
...
nop
cmp %r10, %r10
lea addresses_WC_ht+0x1a615, %rsi
lea addresses_A_ht+0xaf15, %rdi
nop
nop
nop
nop
...
nop
sub $59688, %r9
lea addresses_normal_ht+0x5715, %rsi
nop
nop
nop
nop
...
nop
cmp $65511, %rsi
lea addresses_D_ht+0x13f15, %rbp
nop
nop
nop
nop
...
nop
xor %rdi, %rdi
lea addresses_D_ht+0x16115, %rsi
lea addresses_D_ht+0x3815, %rdi
nop
nop
nop
cmp $49163, %rbp
...
rep movsl
and $23990, %rcx
lea addresses_D_ht+0x1cfd9, %r11
clflush (%r11)
and $29265, %r10
...
nop
and $29400, %r10
lea addresses_normal_ht+0x6971, %r11
nop
nop
nop
nop
