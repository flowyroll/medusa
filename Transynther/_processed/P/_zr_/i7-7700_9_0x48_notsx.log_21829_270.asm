...
push %rbx
push %rdi
lea addresses_D_ht+0x10ff3, %r13
nop
nop
sub %r15, %r15
movb $0x61, (%r13)
nop
dec %r11
lea addresses_UC_ht+0xdaf3, %rdi
nop
nop
nop
and $16075, %r8
...
nop
sub %r11, %r11
lea addresses_WC_ht+0x1031b, %r15
clflush (%r15)
nop
nop
nop
...
movq %rbp, (%r15)
cmp %r8, %r8
lea addresses_WT_ht+0x1a1f3, %rbx
nop
cmp $26614, %rdi
movw $0x6162, (%rbx)
nop
...
nop
sub %rbx, %rbx
lea addresses_normal_ht+0x1bdf3, %rbx
nop
nop
cmp $44289, %r13
mov $0x6162636465666768, %rbp
...
nop
and $60582, %r8
lea addresses_WC_ht+0x83f3, %rdi
nop
nop
nop
nop
...
nop
sub $5767, %r11
lea addresses_D_ht+0x1401d, %r11
nop
nop
nop
xor $35402, %rbp
