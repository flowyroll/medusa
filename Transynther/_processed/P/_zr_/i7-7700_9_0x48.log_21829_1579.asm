...
nop
and %r11, %r11
lea addresses_WC_ht+0xb514, %r12
nop
nop
nop
nop
...
nop
dec %rdi
lea addresses_normal_ht+0xc214, %r12
nop
and %r9, %r9
movb $0x61, (%r12)
nop
...
nop
inc %rdi
lea addresses_A_ht+0x50d4, %rsi
lea addresses_WC_ht+0x1b14, %rdi
nop
nop
nop
nop
...
nop
cmp %r9, %r9
lea addresses_A_ht+0x16694, %rdi
nop
nop
xor %r9, %r9
mov (%rdi), %ecx
...
lea addresses_normal_ht+0x1ad33, %rdi
clflush (%rdi)
nop
nop
add $53436, %rdx
...
nop
xor $8301, %rdx
lea addresses_WT_ht+0x11084, %r9
nop
sub $32019, %rdi
...
lea addresses_WC_ht+0x18054, %rdi
clflush (%rdi)
nop
sub %r9, %r9
mov $0, %rcx
...
nop
xor $8941, %rcx
lea addresses_WC_ht+0x14d3f, %rdi
dec %r8
mov (%rdi), %rsi
nop
nop
nop
xor $13002, %rcx
lea addresses_WT_ht+0x394, %rcx
cmp %rdi, %rdi
movb $0x61, (%rcx)
nop
nop
xor %rcx, %rcx
lea addresses_UC_ht+0x1c680, %rdi
nop
nop
sub $36324, %r9
movb (%rdi), %dl
...
nop
cmp %r8, %r8
lea addresses_WC_ht+0x1cd14, %rsi
lea addresses_WT_ht+0x3204, %rdi
clflush (%rsi)
nop
nop
nop
