...
nop
sub $23772, %rbp
lea addresses_WT_ht+0xc747, %rsi
nop
nop
and %rax, %rax
mov (%rsi), %r9
...
nop
xor $37335, %r9
lea addresses_D_ht+0x1b2a7, %rbp
nop
xor %rcx, %rcx
movb $0x61, (%rbp)
nop
...
nop
add $59230, %r12
lea addresses_WC_ht+0xf377, %rsi
lea addresses_WC_ht+0xbe8f, %rdi
nop
nop
sub $304, %r10
mov $27, %rcx
rep movsq
cmp %rax, %rax
lea addresses_WC_ht+0xfaa7, %rbp
clflush (%rbp)
cmp $60079, %rsi
movb $0x61, (%rbp)
nop
inc %r10
lea addresses_normal_ht+0x5917, %rdi
nop
sub $11355, %rcx
mov (%rdi), %rsi
nop
...
nop
and %r10, %r10
lea addresses_UC_ht+0x14a7, %r12
clflush (%r12)
nop
nop
nop
...
nop
dec %rbp
lea addresses_WC_ht+0x178aa, %rsi
lea addresses_normal_ht+0x19a17, %rdi
clflush (%rdi)
nop
nop
nop
...
nop
xor %r12, %r12
lea addresses_WC_ht+0x19ca7, %r10
nop
nop
nop
nop
...
movq %rsi, (%r10)
cmp %r12, %r12
lea addresses_WT_ht+0xa991, %r12
nop
add $50765, %rsi
mov (%r12), %bp
nop
...
{'OP': 'STOR', 'dst': {'same': False, 'type': 'addresses_D_ht', 'NT': False, 'AVXalign': True, 'size': 1, 'congruent': 9}}
{'OP': 'REPM', 'src': {'same': False, 'congruent': 4, 'type': 'addresses_WC_ht'}, 'dst': {'same': False, 'congruent': 3, 'type': 'addresses_WC_ht'}}
...
{'OP': 'REPM', 'src': {'same': False, 'congruent': 0, 'type': 'addresses_WC_ht'}, 'dst': {'same': False, 'congruent': 4, 'type': 'addresses_normal_ht'}}
