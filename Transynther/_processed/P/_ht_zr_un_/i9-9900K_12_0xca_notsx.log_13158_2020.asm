...
push %rdi
push %rsi
lea addresses_A_ht+0x1b183, %r10
nop
nop
nop
inc %rcx
...
nop
xor $35935, %rax
lea addresses_WC_ht+0xac4f, %rcx
clflush (%rcx)
nop
nop
cmp $64889, %rsi
...
nop
and %r10, %r10
lea addresses_WC_ht+0x13ba3, %rax
nop
nop
nop
nop
...
<gen_prepare_buffer>
{'OP': 'LOAD', 'src': {'same': True, 'type': 'addresses_A_ht', 'NT': False, 'AVXalign': True, 'size': 16, 'congruent': 8}}
