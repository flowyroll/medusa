...
nop
inc %rcx
lea addresses_UC_ht+0x10010, %rdi
nop
nop
inc %rcx
...
nop
xor %r15, %r15
lea addresses_D_ht+0xb84, %rdi
sub $8465, %rcx
mov (%rdi), %r13
sub %r15, %r15
lea addresses_WT_ht+0x11467, %rsi
lea addresses_WT_ht+0x15e00, %rdi
cmp $58131, %r9
mov $85, %rcx
rep movsw
nop
nop
add $45090, %r15
lea addresses_WT_ht+0x1810, %r11
add $5396, %r13
movb $0x61, (%r11)
nop
add $30166, %rsi
lea addresses_normal_ht+0x1ceea, %r9
nop
nop
xor $37072, %rcx
mov (%r9), %r15
...
nop
and %r8, %r8
lea addresses_normal_ht+0x15b50, %rsi
lea addresses_WC_ht+0x8e50, %rdi
nop
nop
nop
dec %r15
...
nop
cmp %r13, %r13
lea addresses_WC_ht+0xd9f0, %rsi
lea addresses_normal_ht+0x10e10, %rdi
nop
nop
nop
nop
...
nop
sub %r8, %r8
lea addresses_WT_ht+0x7541, %r13
nop
nop
nop
nop
...
{'OP': 'LOAD', 'src': {'size': 32, 'NT': False, 'type': 'addresses_UC_ht', 'same': True, 'AVXalign': True, 'congruent': 9}}
