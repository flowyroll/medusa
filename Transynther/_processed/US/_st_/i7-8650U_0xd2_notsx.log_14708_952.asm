...
nop
cmp $63444, %r12
lea addresses_WC_ht+0x19fde, %rcx
clflush (%rcx)
nop
nop
nop
...
movb $0x61, (%r12)
and $43630, %r9
lea addresses_WC_ht+0x1e898, %rsi
nop
nop
nop
inc %r13
...
// Load
lea addresses_normal+0x1d416, %rdx
nop
nop
nop
and $65528, %r11
