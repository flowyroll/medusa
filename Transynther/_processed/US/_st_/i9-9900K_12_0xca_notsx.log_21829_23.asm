...
push %rdx
push %rsi
lea addresses_WT_ht+0x10cba, %r9
nop
nop
nop
nop
...
nop
cmp %r13, %r13
lea addresses_A_ht+0x128aa, %rsi
nop
nop
nop
nop
...
nop
xor $50284, %r8
lea addresses_UC_ht+0xb4aa, %rsi
...
nop
inc %rcx
lea addresses_WT_ht+0x1acaa, %r10
xor $3492, %rcx
mov (%r10), %r13
add %rdx, %rdx
lea addresses_WC_ht+0x61aa, %rdi
clflush (%rdi)
dec %rdx
mov (%rdi), %r13d
xor $11817, %rsi
lea addresses_WT_ht+0xdcaa, %r10
nop
nop
nop
and $11102, %rcx
...
nop
and $3136, %rdi
lea addresses_UC_ht+0x1749e, %r9
clflush (%r9)
inc %rdx
mov (%r9), %rdi
nop
...
{'OP': 'STOR', 'dst': {'same': False, 'type': 'addresses_PSE', 'NT': True, 'AVXalign': False, 'size': 2, 'congruent': 1}}
...
{'OP': 'STOR', 'dst': {'same': False, 'type': 'addresses_NC', 'NT': True, 'AVXalign': False, 'size': 16, 'congruent': 10}}
{'OP': 'STOR', 'dst': {'same': False, 'type': 'addresses_WC', 'NT': False, 'AVXalign': False, 'size': 2, 'congruent': 10}}
{'OP': 'LOAD', 'src': {'same': False, 'type': 'addresses_A', 'NT': False, 'AVXalign': False, 'size': 16, 'congruent': 7}}
[Faulty Load]
...
{'OP': 'REPM', 'src': {'same': False, 'congruent': 11, 'type': 'addresses_UC_ht'}, 'dst': {'same': True, 'congruent': 7, 'type': 'addresses_A_ht'}}
