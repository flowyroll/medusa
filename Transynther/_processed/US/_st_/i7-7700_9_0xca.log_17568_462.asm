...
push %rdi
push %rsi
lea addresses_D_ht+0xf0e5, %rsi
lea addresses_WC_ht+0xd296, %rdi
xor %rax, %rax
mov $25, %rcx
rep movsl
nop
cmp $30524, %rdi
lea addresses_WC_ht+0x1c8e5, %rcx
nop
nop
nop
add %r12, %r12
...
nop
inc %rax
lea addresses_UC_ht+0x17a45, %rsi
lea addresses_D_ht+0xd785, %rdi
nop
nop
nop
cmp %r12, %r12
...
// Load
lea addresses_normal+0x1c8e5, %rbp
nop
nop
nop
inc %r13
...
{'OP': 'STOR', 'dst': {'congruent': 2, 'AVXalign': True, 'same': False, 'size': 8, 'NT': False, 'type': 'addresses_WT'}}
{'src': {'congruent': 5, 'AVXalign': False, 'same': False, 'size': 8, 'NT': False, 'type': 'addresses_NC'}, 'OP': 'LOAD'}
{'src': {'congruent': 9, 'AVXalign': False, 'same': False, 'size': 4, 'NT': False, 'type': 'addresses_D'}, 'OP': 'LOAD'}
{'src': {'congruent': 10, 'AVXalign': False, 'same': False, 'size': 4, 'NT': False, 'type': 'addresses_normal'}, 'OP': 'LOAD'}
{'OP': 'STOR', 'dst': {'congruent': 4, 'AVXalign': False, 'same': False, 'size': 32, 'NT': True, 'type': 'addresses_NC'}}
