...
push %rdi
push %rsi
lea addresses_normal_ht+0x6af7, %r10
sub $56456, %r12
vmovups (%r10), %ymm2
...
nop
and %r10, %r10
lea addresses_WC_ht+0x5927, %rax
nop
xor $52537, %r14
mov (%rax), %bx
nop
...
nop
xor %rbx, %rbx
lea addresses_A_ht+0x94a7, %rsi
lea addresses_WT_ht+0x1a0e7, %rdi
sub %r10, %r10
mov $53, %rcx
rep movsb
cmp $32673, %r10
...
{'src': {'congruent': 2, 'same': False, 'type': 'addresses_A_ht'}, 'OP': 'REPM', 'dst': {'congruent': 6, 'same': True, 'type': 'addresses_WT_ht'}}
{'51': 21829}
