...
// Store
lea addresses_normal+0xc20c, %rbx
nop
sub %r8, %r8
...
{'dst': {'type': 'addresses_WC', 'same': False, 'size': 4, 'congruent': 0, 'NT': True, 'AVXalign': False}, 'OP': 'STOR'}
