...
lea addresses_UC_ht+0xdd05, %rdi
nop
nop
add $16382, %r12
mov $42, %rcx
rep movsl
sub $65493, %rsi
lea addresses_A_ht+0x13245, %rsi
lea addresses_normal_ht+0x17add, %rdi
clflush (%rdi)
nop
nop
inc %rbp
...
nop
inc %r15
lea addresses_WC_ht+0x3c05, %rbx
cmp %r9, %r9
mov $0x6162636465666768, %rbp
movq %rbp, (%rbx)
nop
cmp $1724, %rcx
lea addresses_WC_ht+0x2b85, %r9
nop
nop
nop
nop
...
nop
sub $56223, %r12
lea addresses_A_ht+0x1ee5d, %rsi
nop
nop
nop
nop
...
{'OP': 'LOAD', 'src': {'type': 'addresses_A', 'size': 1, 'AVXalign': True, 'NT': False, 'congruent': 6, 'same': False}}
[Faulty Load]
...
{'OP': 'REPM', 'src': {'type': 'addresses_A_ht', 'congruent': 5, 'same': True}, 'dst': {'type': 'addresses_normal_ht', 'congruent': 3, 'same': False}}
