...
push %rdi
push %rsi
lea addresses_WT_ht+0x18429, %r12
nop
nop
nop
nop
...
nop
and %rbp, %rbp
lea addresses_UC_ht+0x16401, %r15
nop
nop
nop
xor %r10, %r10
...
nop
xor $16485, %rsi
lea addresses_WT_ht+0xbf11, %rbx
nop
nop
nop
nop
...
nop
add %r10, %r10
lea addresses_WT_ht+0x37ad, %rsi
clflush (%rsi)
nop
nop
nop
...
nop
inc %rsi
lea addresses_A_ht+0x591, %rsi
lea addresses_D_ht+0x1d711, %rdi
nop
nop
nop
nop
...
nop
dec %rsi
lea addresses_UC_ht+0x1c8b1, %rsi
lea addresses_UC_ht+0xdf11, %rdi
nop
nop
nop
nop
...
{'OP': 'LOAD', 'src': {'type': 'addresses_UC_ht', 'size': 2, 'AVXalign': False, 'NT': True, 'congruent': 3, 'same': False}}
