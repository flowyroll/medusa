...
push %rdx
push %rsi
lea addresses_UC_ht+0xb2dd, %r12
clflush (%r12)
add %r9, %r9
...
nop
xor %rbp, %rbp
lea addresses_A_ht+0x1bad5, %r13
nop
nop
nop
nop
...
nop
sub %r9, %r9
lea addresses_UC_ht+0x18c75, %rsi
lea addresses_D_ht+0x10927, %rdi
inc %r12
mov $98, %rcx
rep movsl
nop
...
{'OP': 'STOR', 'dst': {'type': 'addresses_D', 'AVXalign': False, 'congruent': 5, 'size': 1, 'same': False, 'NT': True}}
{'OP': 'STOR', 'dst': {'type': 'addresses_NC', 'AVXalign': True, 'congruent': 6, 'size': 32, 'same': False, 'NT': False}}
...
<gen_prepare_buffer>
{'OP': 'STOR', 'dst': {'type': 'addresses_UC_ht', 'AVXalign': False, 'congruent': 2, 'size': 8, 'same': True, 'NT': False}}
