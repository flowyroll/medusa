...
// Store
lea addresses_normal+0x65bc, %r13
clflush (%r13)
nop
dec %r11
mov $0x5152535455565758, %rdx
...
{'OP': 'STOR', 'dst': {'type': 'addresses_US', 'AVXalign': False, 'congruent': 1, 'size': 8, 'same': False, 'NT': True}}
