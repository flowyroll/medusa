...
push %rdi
push %rsi
lea addresses_WC_ht+0x8263, %rsi
...
nop
inc %rbp
lea addresses_A_ht+0xd3f4, %rsi
lea addresses_WC_ht+0x1c63, %rdi
clflush (%rsi)
clflush (%rdi)
nop
nop
...
nop
and %rcx, %rcx
lea addresses_normal_ht+0x171e8, %r8
cmp $27053, %r11
mov (%r8), %ecx
sub $19060, %r11
lea addresses_A_ht+0x132ff, %rsi
lea addresses_normal_ht+0x1925f, %rdi
mfence
mov $76, %rcx
rep movsl
cmp %r15, %r15
lea addresses_UC_ht+0x511b, %rcx
nop
nop
sub %r8, %r8
movb (%rcx), %r15b
