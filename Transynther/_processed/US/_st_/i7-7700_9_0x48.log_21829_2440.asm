...
push %rdi
push %rsi
lea addresses_WC_ht+0x87d4, %rsi
lea addresses_WT_ht+0x127b4, %rdi
clflush (%rdi)
nop
nop
dec %r10
...
nop
add $39589, %rcx
lea addresses_UC_ht+0x3a4c, %rbp
nop
add $53900, %r9
movb (%rbp), %bl
nop
sub $64171, %rsi
lea addresses_WT_ht+0xc854, %r10
nop
dec %rsi
vmovups (%r10), %ymm6
...
nop
and %rbp, %rbp
lea addresses_D_ht+0xf094, %rsi
lea addresses_D_ht+0x117d4, %rdi
clflush (%rsi)
clflush (%rdi)
cmp $29505, %r9
mov $124, %rcx
...
nop
xor $33533, %rdi
lea addresses_WC_ht+0x85d4, %rsi
lea addresses_WC_ht+0x1dae4, %rdi
sub %r11, %r11
mov $69, %rcx
rep movsq
add %rsi, %rsi
lea addresses_normal_ht+0x4edb, %rbx
nop
nop
nop
nop
