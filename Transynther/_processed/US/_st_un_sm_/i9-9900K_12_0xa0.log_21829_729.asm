...
push %rdx
push %rsi
lea addresses_D_ht+0x1baa9, %rdi
nop
nop
nop
and %r9, %r9
...
nop
add %rdx, %rdx
lea addresses_UC_ht+0x8b94, %rdx
nop
nop
nop
and $14292, %rax
...
nop
add %rdi, %rdi
lea addresses_WC_ht+0x81a2, %r15
nop
nop
nop
add %r12, %r12
...
nop
add %r12, %r12
lea addresses_D_ht+0x1753c, %r15
nop
xor %rax, %rax
mov (%r15), %rbx
nop
...
lea addresses_WC_ht+0x10894, %rdi
cmp $61600, %r9
mov $101, %rcx
rep movsl
nop
...
{'src': {'same': False, 'congruent': 8, 'type': 'addresses_WC_ht'}, 'OP': 'REPM', 'dst': {'same': False, 'congruent': 0, 'type': 'addresses_D_ht'}}
{'src': {'same': False, 'congruent': 11, 'type': 'addresses_A_ht'}, 'OP': 'REPM', 'dst': {'same': False, 'congruent': 6, 'type': 'addresses_WC_ht'}}
