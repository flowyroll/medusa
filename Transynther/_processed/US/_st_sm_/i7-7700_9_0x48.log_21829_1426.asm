...
push %rdx
push %rsi
lea addresses_WT_ht+0x12207, %r14
nop
nop
nop
nop
...
nop
add $17218, %r13
lea addresses_WC_ht+0x138a7, %r13
nop
nop
and $50127, %rdx
mov (%r13), %r9d
cmp %r13, %r13
lea addresses_WC_ht+0x10753, %r15
clflush (%r15)
nop
nop
xor $55301, %r12
movw $0x6162, (%r15)
xor $28939, %r11
lea addresses_D_ht+0x10ca7, %rsi
lea addresses_WC_ht+0xa427, %rdi
nop
nop
nop
xor %r14, %r14
...
nop
and $29514, %r14
lea addresses_normal_ht+0x1a667, %r13
nop
nop
add $210, %r14
mov (%r13), %r15w
...
{'OP': 'STOR', 'dst': {'type': 'addresses_WC_ht', 'AVXalign': True, 'congruent': 1, 'size': 2, 'same': True, 'NT': True}}
