...
push %rdi
push %rsi
lea addresses_normal_ht+0x10b27, %rcx
nop
and %r9, %r9
mov (%rcx), %r13d
nop
nop
cmp %rbx, %rbx
lea addresses_WT_ht+0x61cd, %rsi
lea addresses_WT_ht+0x19135, %rdi
dec %r12
mov $114, %rcx
rep movsq
nop
cmp %rbx, %rbx
lea addresses_WT_ht+0x1e1cd, %rsi
lea addresses_UC_ht+0xc54d, %rdi
nop
nop
nop
xor %r15, %r15
...
nop
add %r13, %r13
lea addresses_WC_ht+0x1bccd, %r13
nop
nop
nop
and $18980, %r9
movw $0x6162, (%r13)
xor $9130, %rsi
lea addresses_UC_ht+0x8dcd, %rdi
nop
nop
nop
nop
...
{'OP': 'STOR', 'dst': {'size': 16, 'NT': True, 'type': 'addresses_RW', 'same': False, 'AVXalign': True, 'congruent': 1}}
[Faulty Load]
...
{'OP': 'REPM', 'src': {'same': False, 'type': 'addresses_WT_ht', 'congruent': 4}, 'dst': {'same': False, 'type': 'addresses_WT_ht', 'congruent': 3}}
