...
push %rdi
push %rsi
lea addresses_normal_ht+0x158be, %rsi
...
nop
sub %r12, %r12
lea addresses_WC_ht+0x9619, %rsi
clflush (%rsi)
nop
nop
sub $28147, %rbx
...
{'OP': 'STOR', 'dst': {'size': 8, 'NT': True, 'type': 'addresses_US', 'same': True, 'AVXalign': False, 'congruent': 0}}
