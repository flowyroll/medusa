...
push %rdx
push %rsi
lea addresses_UC_ht+0xc991, %rbx
cmp $57072, %rbp
movups (%rbx), %xmm2
vpextrq $1, %xmm2, %rcx
and $62221, %r11
lea addresses_UC_ht+0x1eb91, %rdx
nop
nop
nop
nop
...
nop
sub %rdx, %rdx
lea addresses_UC_ht+0xc391, %r13
nop
nop
nop
nop
...
movq %rcx, (%r13)
sub $23085, %rdx
lea addresses_normal_ht+0x8291, %rbx
nop
dec %r13
movb $0x61, (%rbx)
nop
nop
add %rdx, %rdx
lea addresses_normal_ht+0x1ac59, %rdi
clflush (%rdi)
nop
nop
nop
...
nop
add $53174, %r11
lea addresses_WC_ht+0xdb91, %rbx
nop
nop
nop
nop
...
nop
sub $34178, %rbx
lea addresses_WC_ht+0x1a191, %r13
nop
nop
and %rbx, %rbx
movb $0x61, (%r13)
...
nop
add %r11, %r11
lea addresses_WT_ht+0x8e91, %rdi
clflush (%rdi)
nop
nop
add %rcx, %rcx
...
nop
and $20878, %rdi
lea addresses_WT_ht+0xc591, %rdi
nop
nop
nop
nop
...
nop
inc %r13
lea addresses_A_ht+0x1c95d, %rbx
nop
nop
nop
dec %rdi
...
nop
inc %r13
lea addresses_WT_ht+0x7991, %rsi
lea addresses_WC_ht+0x1c411, %rdi
and %rbp, %rbp
mov $124, %rcx
rep movsb
nop
...
nop
dec %rdx
lea addresses_normal_ht+0x2f5, %rdi
clflush (%rdi)
nop
and %rsi, %rsi
...
nop
inc %rdx
lea addresses_A_ht+0x1c811, %rbx
nop
xor %rcx, %rcx
mov $0x6162636465666768, %r13
movq %r13, (%rbx)
cmp $35054, %r11
lea addresses_D_ht+0x10a8b, %r11
clflush (%r11)
nop
nop
nop
...
nop
xor %rdi, %rdi
lea addresses_WC_ht+0xf011, %rsi
nop
nop
nop
nop
...
{'OP': 'STOR', 'dst': {'type': 'addresses_WT_ht', 'AVXalign': True, 'congruent': 7, 'size': 8, 'same': False, 'NT': False}}
...
{'OP': 'REPM', 'src': {'type': 'addresses_WT_ht', 'congruent': 8, 'same': False}, 'dst': {'type': 'addresses_WC_ht', 'congruent': 7, 'same': False}}
...
{'OP': 'STOR', 'dst': {'type': 'addresses_D_ht', 'AVXalign': False, 'congruent': 0, 'size': 4, 'same': False, 'NT': True}}
