...
push %rdx
push %rsi
lea addresses_UC_ht+0x1c9a0, %rcx
nop
nop
inc %r11
...
nop
sub $48174, %r14
lea addresses_WC_ht+0x5000, %rdx
clflush (%rdx)
nop
nop
nop
...
mov (%r9), %dx
dec %r9
lea addresses_WT_ht+0x14520, %rsi
lea addresses_WT_ht+0x12620, %rdi
nop
dec %rdx
mov $68, %rcx
rep movsb
sub $22532, %rdx
lea addresses_normal_ht+0x1cd20, %rsi
lea addresses_D_ht+0x1dd58, %rdi
nop
nop
sub $45293, %rbx
mov $124, %rcx
rep movsq
and $26004, %rdx
lea addresses_WT_ht+0xa1c4, %r14
nop
nop
nop
nop
...
nop
dec %r11
lea addresses_A_ht+0x15fbc, %rdx
nop
nop
nop
nop
...
nop
and $33821, %rdi
lea addresses_normal_ht+0x18d3, %r11
nop
nop
nop
nop
...
nop
add %rcx, %rcx
lea addresses_A_ht+0xd320, %rsi
lea addresses_A_ht+0x45a8, %rdi
nop
nop
nop
nop
...
nop
xor %r9, %r9
lea addresses_normal_ht+0xfee0, %rdx
and $35311, %r14
mov (%rdx), %r11d
nop
add %rsi, %rsi
lea addresses_A_ht+0x9180, %rsi
lea addresses_WC_ht+0x19388, %rdi
nop
nop
nop
nop
...
{'OP': 'STOR', 'dst': {'congruent': 6, 'AVXalign': False, 'same': False, 'size': 1, 'NT': True, 'type': 'addresses_US'}}
{'OP': 'STOR', 'dst': {'congruent': 4, 'AVXalign': True, 'same': False, 'size': 2, 'NT': True, 'type': 'addresses_A'}}
{'OP': 'STOR', 'dst': {'congruent': 7, 'AVXalign': False, 'same': False, 'size': 2, 'NT': False, 'type': 'addresses_UC'}}
{'OP': 'STOR', 'dst': {'congruent': 10, 'AVXalign': False, 'same': False, 'size': 2, 'NT': False, 'type': 'addresses_P'}}
...
{'src': {'congruent': 9, 'same': False, 'type': 'addresses_WT_ht'}, 'OP': 'REPM', 'dst': {'congruent': 8, 'same': False, 'type': 'addresses_WT_ht'}}
...
{'src': {'congruent': 0, 'AVXalign': True, 'same': False, 'size': 16, 'NT': False, 'type': 'addresses_A_ht'}, 'OP': 'LOAD'}
...
{'src': {'congruent': 0, 'same': False, 'type': 'addresses_A_ht'}, 'OP': 'REPM', 'dst': {'congruent': 1, 'same': False, 'type': 'addresses_WC_ht'}}
{'58': 21829}
