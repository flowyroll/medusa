...
push %rdi
push %rsi
lea addresses_normal_ht+0x1e78a, %rdi
nop
nop
nop
nop
...
nop
and $62989, %rsi
lea addresses_D_ht+0x199c2, %r15
nop
nop
nop
nop
...
nop
and %r15, %r15
lea addresses_normal_ht+0x7672, %rsi
...
nop
sub %rsi, %rsi
lea addresses_WC_ht+0x107f2, %rbp
nop
nop
nop
nop
...
nop
sub %r15, %r15
lea addresses_normal_ht+0x10732, %rdi
nop
cmp %r10, %r10
movl $0x61626364, (%rdi)
nop
sub %rbp, %rbp
lea addresses_WT_ht+0x35a3, %rsi
xor $21511, %rbp
...
nop
xor %rbp, %rbp
lea addresses_WC_ht+0xe1f2, %rsi
lea addresses_WT_ht+0xd272, %rdi
clflush (%rsi)
nop
nop
dec %rbx
...
nop
dec %r11
lea addresses_normal_ht+0x126f2, %rbp
nop
nop
add $2709, %r15
movb (%rbp), %bl
...
nop
and %r10, %r10
lea addresses_WT_ht+0x5b72, %rcx
nop
nop
inc %r10
...
nop
add %rdi, %rdi
lea addresses_A_ht+0x1832, %rsi
lea addresses_D_ht+0x5932, %rdi
and $60674, %r15
mov $27, %rcx
rep movsq
nop
...
{'OP': 'STOR', 'dst': {'type': 'addresses_US', 'AVXalign': False, 'congruent': 0, 'size': 32, 'same': True, 'NT': True}}
...
{'OP': 'REPM', 'src': {'type': 'addresses_normal_ht', 'congruent': 7, 'same': True}, 'dst': {'type': 'addresses_WT_ht', 'congruent': 8, 'same': False}}
