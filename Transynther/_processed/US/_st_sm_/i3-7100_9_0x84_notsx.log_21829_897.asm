...
push %rdi
push %rsi
lea addresses_normal_ht+0x1ae15, %rsi
lea addresses_A_ht+0xb915, %rdi
nop
nop
add $32482, %rbx
mov $58, %rcx
...
nop
xor %r13, %r13
lea addresses_UC_ht+0x1d8f5, %rsi
lea addresses_D_ht+0xcc15, %rdi
nop
nop
dec %rax
mov $5, %rcx
...
nop
add $51581, %rcx
lea addresses_WC_ht+0x1a415, %rax
xor $16560, %r15
...
vmovaps %ymm2, (%rax)
inc %rbx
lea addresses_normal_ht+0xb8f5, %r13
xor %r15, %r15
movups (%r13), %xmm0
vpextrq $1, %xmm0, %rdi
nop
...
{'src': {'type': 'addresses_UC_ht', 'congruent': 5, 'same': False}, 'dst': {'type': 'addresses_D_ht', 'congruent': 8, 'same': False}, 'OP': 'REPM'}
