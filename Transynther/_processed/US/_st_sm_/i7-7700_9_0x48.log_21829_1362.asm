...
nop
inc %r13
lea addresses_UC_ht+0x19240, %rsi
lea addresses_normal_ht+0x6143, %rdi
nop
nop
nop
cmp %r10, %r10
...
nop
cmp $16575, %rbx
lea addresses_WT_ht+0xcb3, %rsi
lea addresses_normal_ht+0x1d5b3, %rdi
nop
nop
xor %rdx, %rdx
mov $117, %rcx
...
nop
inc %rdi
lea addresses_WC_ht+0xb54f, %r10
nop
inc %rsi
mov (%r10), %edi
nop
...
// Store
lea addresses_normal+0x8773, %rbp
nop
nop
nop
add $21603, %r9
...
{'OP': 'STOR', 'dst': {'type': 'addresses_US', 'AVXalign': False, 'congruent': 9, 'size': 1, 'same': False, 'NT': False}}
[Faulty Load]
{'OP': 'LOAD', 'src': {'type': 'addresses_US', 'AVXalign': False, 'congruent': 0, 'size': 2, 'same': True, 'NT': False}}
<gen_prepare_buffer>
{'OP': 'REPM', 'src': {'type': 'addresses_UC_ht', 'congruent': 3, 'same': True}, 'dst': {'type': 'addresses_D_ht', 'congruent': 0, 'same': False}}
