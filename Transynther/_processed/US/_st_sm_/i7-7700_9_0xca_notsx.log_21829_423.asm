...
push %rdx
push %rsi
lea addresses_UC_ht+0xb5e7, %rdx
nop
nop
cmp %rcx, %rcx
movb (%rdx), %bl
...
nop
inc %r9
lea addresses_A_ht+0x1d8e7, %rsi
...
rep movsw
add $1647, %rdi
lea addresses_normal_ht+0x54ef, %rcx
xor $1185, %rdx
mov (%rcx), %si
nop
nop
nop
xor %rsi, %rsi
lea addresses_normal_ht+0x10d30, %rbx
nop
nop
nop
nop
...
{'dst': {'NT': True, 'AVXalign': False, 'size': 8, 'congruent': 0, 'same': True, 'type': 'addresses_US'}, 'OP': 'STOR'}
[Faulty Load]
...
{'src': {'congruent': 11, 'same': False, 'type': 'addresses_A_ht'}, 'dst': {'congruent': 1, 'same': False, 'type': 'addresses_D_ht'}, 'OP': 'REPM'}
