...
push %rdi
push %rsi
lea addresses_WT_ht+0xb16a, %rdi
nop
dec %r12
movw $0x6162, (%rdi)
nop
...
nop
inc %rbx
lea addresses_A_ht+0xc2b2, %rsi
lea addresses_UC_ht+0x12e26, %rdi
cmp $27665, %r14
mov $113, %rcx
rep movsw
nop
...
nop
add $60603, %r14
lea addresses_normal_ht+0xd928, %r12
add $8600, %r8
movb (%r12), %r14b
nop
nop
cmp %rbx, %rbx
lea addresses_WT_ht+0x13d6a, %rcx
clflush (%rcx)
nop
nop
nop
...
nop
and $24849, %rdi
lea addresses_WT_ht+0xb202, %rdi
nop
nop
cmp $8789, %rbx
mov (%rdi), %si
...
nop
add %r12, %r12
lea addresses_normal_ht+0x1356a, %r14
nop
nop
nop
nop
...
movw $0x6162, (%r14)
and $21740, %rbx
lea addresses_normal_ht+0x116a, %rbx
nop
nop
and %rsi, %rsi
...
nop
inc %rsi
lea addresses_normal_ht+0x1b91a, %r12
nop
xor $40920, %rdi
...
nop
add %rdi, %rdi
lea addresses_WC_ht+0x17bf2, %rbx
nop
and $7371, %r14
movb (%rbx), %cl
nop
