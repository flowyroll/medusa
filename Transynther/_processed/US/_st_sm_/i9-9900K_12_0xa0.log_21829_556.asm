...
push %rdi
push %rsi
lea addresses_normal_ht+0x5c4e, %r9
nop
nop
nop
nop
...
nop
and %rcx, %rcx
lea addresses_UC_ht+0x1b5ef, %rsi
lea addresses_UC_ht+0x1279a, %rdi
nop
nop
nop
nop
...
nop
and $52508, %r9
lea addresses_UC_ht+0x5d1a, %r10
nop
nop
nop
nop
...
{'OP': 'STOR', 'dst': {'NT': True, 'same': True, 'congruent': 0, 'type': 'addresses_US', 'AVXalign': False, 'size': 1}}
