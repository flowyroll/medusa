...
nop
sub %rax, %rax
lea addresses_WT_ht+0xe095, %rsi
nop
xor $11455, %r8
mov (%rsi), %r13
dec %r10
lea addresses_A_ht+0x12c3d, %rsi
lea addresses_A_ht+0x228d, %rdi
nop
nop
nop
cmp $55948, %rdx
...
nop
sub $42221, %r8
lea addresses_UC_ht+0xe495, %rax
add $39227, %r8
movl $0x61626364, (%rax)
nop
nop
...
nop
xor $64274, %rdi
lea addresses_WT_ht+0x12d06, %rcx
cmp $15414, %r13
mov (%rcx), %esi
xor %r13, %r13
lea addresses_D_ht+0x7d51, %rsi
lea addresses_WC_ht+0x1c95, %rdi
nop
nop
nop
nop
...
nop
add %rsi, %rsi
lea addresses_D_ht+0x1ce15, %rdi
nop
cmp $4144, %r8
movups (%rdi), %xmm1
vpextrq $1, %xmm1, %rsi
...
nop
add %rdx, %rdx
lea addresses_UC_ht+0xec95, %rsi
lea addresses_WC_ht+0xd111, %rdi
nop
cmp $17861, %r8
mov $51, %rcx
rep movsq
...
nop
inc %r13
lea addresses_UC_ht+0x144a5, %rdi
nop
nop
sub $23750, %rsi
movl $0x61626364, (%rdi)
add $15220, %r8
lea addresses_UC_ht+0xec95, %r13
nop
xor %r8, %r8
mov (%r13), %cx
nop
dec %rdi
lea addresses_WT_ht+0x18795, %rdx
nop
sub %rdi, %rdi
movups (%rdx), %xmm3
vpextrq $0, %xmm3, %rcx
...
nop
and %rcx, %rcx
lea addresses_WC_ht+0x154d, %rdi
nop
and %rsi, %rsi
...
nop
xor $41654, %rsi
lea addresses_WT_ht+0x162d5, %r13
nop
nop
nop
nop
...
nop
dec %r8
lea addresses_D_ht+0x3ce9, %rsi
lea addresses_D_ht+0x14495, %rdi
nop
nop
nop
nop
...
nop
add $55019, %r13
lea addresses_UC_ht+0x13537, %rdi
nop
nop
nop
inc %rax
...
// REPMOV
lea addresses_normal+0x2c85, %rsi
lea addresses_normal+0x675, %rdi
nop
nop
nop
add $34269, %rbp
...
// Store
lea addresses_normal+0x8e05, %r14
clflush (%r14)
and $49963, %r9
...
{'src': {'type': 'addresses_normal', 'congruent': 0, 'same': False}, 'dst': {'type': 'addresses_normal', 'congruent': 5, 'same': False}, 'OP': 'REPM'}
...
{'dst': {'type': 'addresses_UC_ht', 'same': True, 'size': 4, 'congruent': 3, 'NT': False, 'AVXalign': False}, 'OP': 'STOR'}
...
{'src': {'type': 'addresses_D_ht', 'congruent': 1, 'same': False}, 'dst': {'type': 'addresses_D_ht', 'congruent': 11, 'same': False}, 'OP': 'REPM'}
