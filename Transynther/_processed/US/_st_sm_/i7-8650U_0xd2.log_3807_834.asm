...
nop
cmp %r15, %r15
lea addresses_UC_ht+0x115b1, %r13
nop
nop
nop
nop
...
nop
and %rdi, %rdi
lea addresses_WC_ht+0xe411, %rax
nop
nop
nop
nop
...
mov (%rax), %r8
sub %r13, %r13
lea addresses_normal_ht+0x12179, %r13
sub %r12, %r12
movl $0x61626364, (%r13)
nop
nop
nop
sub $49070, %r15
lea addresses_WC_ht+0x13131, %r13
nop
nop
nop
nop
...
nop
dec %r15
lea addresses_normal_ht+0x1bdb1, %r13
clflush (%r13)
nop
nop
nop
...
nop
cmp %rax, %rax
lea addresses_normal_ht+0x1b621, %rdi
nop
nop
nop
nop
...
nop
xor $8482, %rdi
lea addresses_UC_ht+0xb9b1, %rax
nop
xor %rdi, %rdi
mov (%rax), %r15w
and %r10, %r10
lea addresses_WC_ht+0x6b8b, %r13
inc %r12
movb $0x61, (%r13)
sub %rdi, %rdi
lea addresses_A_ht+0x12531, %r8
nop
nop
nop
nop
...
nop
add %r10, %r10
lea addresses_WC_ht+0x15171, %rdi
nop
nop
nop
nop
...
{'OP': 'STOR', 'dst': {'type': 'addresses_normal_ht', 'size': 4, 'AVXalign': False, 'NT': False, 'congruent': 1, 'same': True}}
