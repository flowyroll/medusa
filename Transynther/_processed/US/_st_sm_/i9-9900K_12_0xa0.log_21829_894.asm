...
push %rdx
push %rsi
lea addresses_UC_ht+0x198f6, %rdi
clflush (%rdi)
nop
nop
nop
...
nop
and %r8, %r8
lea addresses_UC_ht+0x5cf6, %rsi
lea addresses_WT_ht+0x198d3, %rdi
nop
nop
nop
nop
...
nop
xor %r9, %r9
lea addresses_D_ht+0x1cf76, %r14
nop
nop
nop
nop
...
nop
cmp $19447, %r14
lea addresses_normal_ht+0xe7f6, %rdx
nop
nop
nop
sub %r14, %r14
...
nop
add %rcx, %rcx
lea addresses_WT_ht+0x6e80, %rdi
nop
nop
nop
nop
...
nop
and $34043, %rsi
lea addresses_normal_ht+0xb4f6, %r9
nop
xor %r14, %r14
mov (%r9), %si
nop
sub $19214, %r9
lea addresses_D_ht+0x16af6, %rsi
lea addresses_WC_ht+0x1d356, %rdi
nop
nop
nop
nop
...
rep movsw
cmp %rdx, %rdx
lea addresses_A_ht+0x1cf6, %rsi
lea addresses_normal_ht+0x1936, %rdi
nop
nop
nop
nop
...
{'src': {'same': False, 'congruent': 11, 'type': 'addresses_UC_ht'}, 'OP': 'REPM', 'dst': {'same': False, 'congruent': 0, 'type': 'addresses_WT_ht'}}
...
{'src': {'same': False, 'congruent': 9, 'type': 'addresses_D_ht'}, 'OP': 'REPM', 'dst': {'same': False, 'congruent': 5, 'type': 'addresses_WC_ht'}}
