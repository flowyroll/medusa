...
push %r9
push %rdx
lea addresses_UC_ht+0x1208d, %r9
nop
nop
nop
nop
...
{'OP': 'STOR', 'dst': {'same': False, 'congruent': 1, 'NT': False, 'type': 'addresses_P', 'size': 1, 'AVXalign': True}}
{'OP': 'STOR', 'dst': {'same': False, 'congruent': 9, 'NT': True, 'type': 'addresses_WC', 'size': 1, 'AVXalign': False}}
