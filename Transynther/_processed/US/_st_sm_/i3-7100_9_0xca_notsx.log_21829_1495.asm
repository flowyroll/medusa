...
push %rdi
push %rsi
lea addresses_WC_ht+0x1e7d6, %rsi
lea addresses_UC_ht+0xa0, %rdi
xor $14241, %r12
mov $79, %rcx
rep movsw
nop
nop
and $30896, %rsi
lea addresses_WT_ht+0x9600, %rsi
lea addresses_UC_ht+0x12880, %rdi
nop
nop
nop
nop
...
rep movsl
cmp $28363, %rcx
lea addresses_WT_ht+0x1d78, %rbp
cmp %r10, %r10
...
nop
add $2178, %r8
lea addresses_D_ht+0x15000, %rbp
add %rsi, %rsi
...
{'OP': 'STOR', 'dst': {'same': True, 'congruent': 0, 'NT': False, 'type': 'addresses_US', 'size': 1, 'AVXalign': True}}
...
<gen_prepare_buffer>
{'src': {'type': 'addresses_WC_ht', 'congruent': 1, 'same': True}, 'OP': 'REPM', 'dst': {'type': 'addresses_UC_ht', 'congruent': 2, 'same': False}}
{'src': {'type': 'addresses_WT_ht', 'congruent': 9, 'same': False}, 'OP': 'REPM', 'dst': {'type': 'addresses_UC_ht', 'congruent': 3, 'same': False}}
