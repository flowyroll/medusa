...
push %rdi
push %rsi
lea addresses_WC_ht+0x1c7c9, %r12
clflush (%r12)
nop
nop
nop
...
nop
dec %rcx
lea addresses_UC_ht+0x9519, %rcx
nop
and %r11, %r11
...
nop
dec %rbp
lea addresses_D_ht+0x1b427, %r11
xor %rsi, %rsi
...
nop
inc %r12
lea addresses_WC_ht+0x38c9, %rsi
nop
nop
nop
inc %r12
...
nop
and $10330, %rbx
lea addresses_A_ht+0x1bc8f, %rbx
nop
nop
cmp %r8, %r8
movb (%rbx), %r11b
...
nop
sub $1382, %r8
lea addresses_UC_ht+0x142e3, %rsi
lea addresses_WT_ht+0x1d3f9, %rdi
dec %r8
mov $91, %rcx
rep movsl
nop
...
{'OP': 'STOR', 'dst': {'type': 'addresses_D', 'size': 8, 'AVXalign': True, 'NT': False, 'congruent': 6, 'same': False}}
...
{'OP': 'REPM', 'src': {'type': 'addresses_UC_ht', 'congruent': 0, 'same': True}, 'dst': {'type': 'addresses_WT_ht', 'congruent': 4, 'same': False}}
{'58': 4917}
