...
nop
cmp %r8, %r8
lea addresses_WT_ht+0x10a4b, %rbx
nop
nop
nop
inc %r13
...
nop
sub $41964, %r9
lea addresses_WC_ht+0xfecb, %rax
clflush (%rax)
nop
add $41866, %r15
...
movups %xmm2, (%rax)
sub %r13, %r13
lea addresses_WT_ht+0x115cb, %r9
nop
nop
nop
nop
...
{'OP': 'STOR', 'dst': {'type': 'addresses_A', 'AVXalign': False, 'congruent': 7, 'size': 2, 'same': False, 'NT': True}}
...
<gen_prepare_buffer>
{'OP': 'STOR', 'dst': {'type': 'addresses_A_ht', 'AVXalign': True, 'congruent': 4, 'size': 2, 'same': False, 'NT': False}}
