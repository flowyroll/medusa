...
push %rdi
push %rsi
lea addresses_A_ht+0x159b6, %rsi
lea addresses_WT_ht+0x4b46, %rdi
nop
nop
add %rbx, %rbx
mov $15, %rcx
...
nop
cmp %rdi, %rdi
lea addresses_UC_ht+0x1d46, %rsi
nop
nop
sub $8818, %rcx
movl $0x61626364, (%rsi)
...
nop
inc %rsi
lea addresses_WT_ht+0xbb46, %rsi
lea addresses_A_ht+0xd946, %rdi
nop
nop
sub %rbx, %rbx
mov $56, %rcx
...
nop
xor $41819, %rdi
lea addresses_WT_ht+0xe496, %rsi
lea addresses_WC_ht+0x1c8e8, %rdi
nop
nop
sub $31397, %r14
mov $115, %rcx
...
{'OP': 'STOR', 'dst': {'NT': False, 'same': False, 'congruent': 1, 'type': 'addresses_P', 'AVXalign': False, 'size': 4}}
[Faulty Load]
...
{'src': {'same': False, 'congruent': 9, 'type': 'addresses_WT_ht'}, 'OP': 'REPM', 'dst': {'same': False, 'congruent': 7, 'type': 'addresses_A_ht'}}
{'src': {'same': True, 'congruent': 4, 'type': 'addresses_WT_ht'}, 'OP': 'REPM', 'dst': {'same': False, 'congruent': 1, 'type': 'addresses_WC_ht'}}
{'src': {'same': False, 'congruent': 0, 'type': 'addresses_D_ht'}, 'OP': 'REPM', 'dst': {'same': False, 'congruent': 4, 'type': 'addresses_UC_ht'}}
{'46': 21825, '3c': 1, '49': 1, '00': 2}
