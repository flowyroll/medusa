...
lea addresses_WT_ht+0x72bc, %rdi
nop
nop
and %r15, %r15
mov $8, %rcx
...
nop
inc %rcx
lea addresses_WC_ht+0xe9de, %rsi
nop
nop
nop
add $47614, %r11
...
nop
add %r11, %r11
lea addresses_WT_ht+0x1241e, %rsi
nop
nop
nop
nop
...
movups %xmm5, (%rsi)
inc %r14
lea addresses_WT_ht+0x10c5e, %rcx
nop
nop
nop
dec %r11
movw $0x6162, (%rcx)
sub $42074, %rcx
lea addresses_D_ht+0x1625e, %rsi
lea addresses_UC_ht+0x2182, %rdi
nop
nop
cmp %r15, %r15
mov $19, %rcx
...
nop
xor $62270, %rcx
lea addresses_UC_ht+0xe12e, %rsi
lea addresses_D_ht+0x1025e, %rdi
nop
sub $33842, %r11
mov $48, %rcx
rep movsl
cmp $58712, %r15
lea addresses_D_ht+0x1a96, %rsi
lea addresses_normal_ht+0x197f3, %rdi
clflush (%rsi)
nop
cmp %r10, %r10
mov $1, %rcx
...
nop
dec %r15
lea addresses_WC_ht+0x76f2, %r10
nop
nop
and %r14, %r14
movw $0x6162, (%r10)
...
{'OP': 'REPM', 'src': {'same': False, 'type': 'addresses_P', 'congruent': 8}, 'dst': {'same': True, 'type': 'addresses_US', 'congruent': 0}}
{'OP': 'STOR', 'dst': {'size': 2, 'NT': False, 'type': 'addresses_D', 'same': False, 'AVXalign': False, 'congruent': 4}}
{'OP': 'LOAD', 'src': {'size': 1, 'NT': False, 'type': 'addresses_RW', 'same': False, 'AVXalign': False, 'congruent': 7}}
[Faulty Load]
{'OP': 'LOAD', 'src': {'size': 2, 'NT': False, 'type': 'addresses_US', 'same': True, 'AVXalign': False, 'congruent': 0}}
<gen_prepare_buffer>
{'OP': 'REPM', 'src': {'same': False, 'type': 'addresses_D_ht', 'congruent': 9}, 'dst': {'same': True, 'type': 'addresses_A_ht', 'congruent': 1}}
{'OP': 'REPM', 'src': {'same': False, 'type': 'addresses_UC_ht', 'congruent': 1}, 'dst': {'same': False, 'type': 'addresses_WT_ht', 'congruent': 1}}
...
{'OP': 'REPM', 'src': {'same': False, 'type': 'addresses_D_ht', 'congruent': 3}, 'dst': {'same': False, 'type': 'addresses_normal_ht', 'congruent': 0}}
{'OP': 'STOR', 'dst': {'size': 2, 'NT': False, 'type': 'addresses_WC_ht', 'same': False, 'AVXalign': False, 'congruent': 2}}
{'54': 1, '5c': 1, '79': 3, '64': 1, '8a': 1, '5f': 4735}
