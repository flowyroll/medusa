...
push %rdi
push %rsi
lea addresses_D_ht+0x1cbd6, %rsi
lea addresses_normal_ht+0xdc46, %rdi
clflush (%rsi)
nop
nop
nop
...
nop
sub %rsi, %rsi
lea addresses_WT_ht+0x3cd6, %r11
nop
nop
nop
nop
...
movl $0x61626364, (%r11)
sub $24772, %r11
lea addresses_normal_ht+0xb37e, %rsi
...
nop
sub $37873, %rdi
lea addresses_WC_ht+0xb246, %rsi
lea addresses_normal_ht+0x98d6, %rdi
nop
nop
nop
nop
...
nop
inc %rdi
lea addresses_D_ht+0xd00, %rsi
lea addresses_D_ht+0x1262, %rdi
nop
nop
nop
nop
