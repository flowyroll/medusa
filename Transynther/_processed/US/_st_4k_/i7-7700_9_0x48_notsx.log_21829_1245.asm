...
push %rdx
push %rsi
lea addresses_D_ht+0xe94d, %rsi
lea addresses_normal_ht+0x1cad1, %rdi
nop
nop
sub %rdx, %rdx
mov $90, %rcx
...
nop
sub $33998, %rdx
lea addresses_WT_ht+0x9c51, %rsi
lea addresses_WT_ht+0x10591, %rdi
nop
nop
nop
nop
...
nop
sub %r12, %r12
lea addresses_normal_ht+0x5cd1, %r13
xor %r14, %r14
movw $0x6162, (%r13)
and $6179, %r12
lea addresses_WT_ht+0x183d1, %r14
nop
add $26244, %rdi
movb $0x61, (%r14)
nop
...
nop
cmp %rsi, %rsi
lea addresses_normal_ht+0x90d1, %rsi
nop
nop
nop
and $15505, %rdi
...
vpextrq $0, %xmm3, %rdx
sub %r14, %r14
lea addresses_D_ht+0x1bb81, %rsi
lea addresses_WC_ht+0x1c851, %rdi
nop
nop
nop
nop
...
{'dst': {'same': False, 'NT': False, 'AVXalign': False, 'size': 32, 'type': 'addresses_PSE', 'congruent': 10}, 'OP': 'STOR'}
...
<gen_prepare_buffer>
{'dst': {'same': True, 'congruent': 9, 'type': 'addresses_normal_ht'}, 'OP': 'REPM', 'src': {'same': False, 'congruent': 2, 'type': 'addresses_D_ht'}}
