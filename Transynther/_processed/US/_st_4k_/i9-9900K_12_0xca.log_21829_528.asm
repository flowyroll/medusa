...
push %rdx
push %rsi
lea addresses_UC_ht+0xeddc, %rsi
lea addresses_D_ht+0x16f0c, %rdi
nop
nop
nop
and $32465, %r14
...
nop
and $4492, %r11
lea addresses_UC_ht+0x18d62, %r15
nop
nop
nop
xor %rax, %rax
mov (%r15), %esi
xor %rcx, %rcx
lea addresses_WT_ht+0x1a71c, %rsi
nop
nop
nop
cmp %r11, %r11
...
nop
xor $54131, %rsi
lea addresses_D_ht+0x16d5b, %rdi
nop
nop
nop
nop
...
nop
cmp $34822, %r15
lea addresses_WT_ht+0xbef6, %rcx
xor %r15, %r15
mov (%rcx), %rax
add %r15, %r15
lea addresses_WC_ht+0x8f0c, %rsi
lea addresses_WT_ht+0x14a56, %rdi
nop
and %rdx, %rdx
mov $100, %rcx
rep movsq
...
{'OP': 'STOR', 'dst': {'size': 8, 'NT': False, 'type': 'addresses_A', 'same': False, 'AVXalign': True, 'congruent': 10}}
...
{'OP': 'REPM', 'src': {'same': False, 'type': 'addresses_A_ht', 'congruent': 1}, 'dst': {'same': True, 'type': 'addresses_UC_ht', 'congruent': 6}}
