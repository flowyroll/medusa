...
push %rdi
push %rsi
lea addresses_D_ht+0x88b1, %rsi
lea addresses_D_ht+0x9b2f, %rdi
nop
nop
dec %r12
mov $52, %rcx
...
nop
add $63706, %r15
lea addresses_WT_ht+0x1add1, %r11
nop
nop
nop
nop
...
nop
and %r15, %r15
lea addresses_WT_ht+0x192d1, %rsi
lea addresses_A_ht+0x1d59, %rdi
nop
xor %r12, %r12
mov $123, %rcx
rep movsb
...
// Store
lea addresses_normal+0x3d1, %r12
nop
nop
nop
nop
...
{'dst': {'NT': True, 'AVXalign': False, 'size': 32, 'congruent': 9, 'same': False, 'type': 'addresses_normal'}, 'OP': 'STOR'}
