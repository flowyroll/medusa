...
push %rdi
push %rsi
lea addresses_normal_ht+0x14783, %r11
nop
nop
cmp $18773, %r9
...
nop
add %rsi, %rsi
lea addresses_WC_ht+0x1803, %rbx
cmp $13560, %r8
movl $0x61626364, (%rbx)
xor %rbp, %rbp
lea addresses_D_ht+0x1cca3, %rbx
dec %r11
mov $0x6162636465666768, %r10
movq %r10, %xmm7
movups %xmm7, (%rbx)
...
nop
cmp %r8, %r8
lea addresses_D_ht+0x1e383, %rsi
nop
and $7342, %r8
...
vmovups %ymm3, (%rsi)
xor $6042, %rbp
lea addresses_normal_ht+0x12983, %rsi
lea addresses_WT_ht+0xe783, %rdi
xor %rbp, %rbp
mov $102, %rcx
rep movsq
nop
...
{'OP': 'REPM', 'src': {'same': False, 'type': 'addresses_normal_ht', 'congruent': 9}, 'dst': {'same': False, 'type': 'addresses_WT_ht', 'congruent': 11}}
{'58': 21829}
