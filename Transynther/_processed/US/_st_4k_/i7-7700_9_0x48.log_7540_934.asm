...
push %rdi
push %rsi
lea addresses_WC_ht+0xb066, %r13
nop
nop
nop
nop
...
nop
dec %rax
lea addresses_D_ht+0x1e1b6, %r14
nop
dec %rbx
...
nop
and $52138, %r14
lea addresses_WT_ht+0x1b31e, %rsi
lea addresses_D_ht+0x1c8a6, %rdi
nop
nop
nop
cmp %r9, %r9
...
nop
dec %r13
lea addresses_WT_ht+0xb8a6, %r13
clflush (%r13)
nop
nop
mfence
...
nop
dec %r13
lea addresses_WT_ht+0xe8a6, %r14
nop
add $35907, %r8
movw $0x6162, (%r14)
nop
...
// Store
lea addresses_normal+0x96a6, %rdi
and %r15, %r15
movl $0x51525354, (%rdi)
nop
nop
...
{'OP': 'STOR', 'dst': {'type': 'addresses_normal', 'AVXalign': True, 'congruent': 9, 'size': 4, 'same': False, 'NT': False}}
