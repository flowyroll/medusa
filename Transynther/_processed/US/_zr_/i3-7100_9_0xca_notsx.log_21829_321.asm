...
push %rdi
push %rsi
lea addresses_D_ht+0x11040, %r14
nop
nop
dec %rbp
...
nop
sub %rbp, %rbp
lea addresses_WT_ht+0x8ea0, %rsi
lea addresses_D_ht+0x9f90, %rdi
clflush (%rdi)
inc %r9
mov $65, %rcx
rep movsl
...
// Store
lea addresses_normal+0x19740, %r9
nop
nop
and $58623, %rbp
...
// Store
lea addresses_A+0x1452c, %rbp
and $43135, %r11
movw $0x5152, (%rbp)
inc %r9

// Faulty Load
lea addresses_US+0xe140, %r10
nop
nop
nop
nop
...
{'OP': 'STOR', 'dst': {'same': False, 'congruent': 5, 'NT': True, 'type': 'addresses_P', 'size': 4, 'AVXalign': True}}
...
{'src': {'type': 'addresses_WT_ht', 'congruent': 5, 'same': False}, 'OP': 'REPM', 'dst': {'type': 'addresses_D_ht', 'congruent': 3, 'same': True}}
{'00': 21829}
