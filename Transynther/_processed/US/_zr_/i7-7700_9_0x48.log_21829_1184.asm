...
push %rdi
push %rsi
lea addresses_WC_ht+0x53e7, %rsi
lea addresses_D_ht+0xb7cb, %rdi
nop
nop
nop
nop
...
nop
cmp $4559, %r14
lea addresses_WT_ht+0x1890b, %rsi
lea addresses_normal_ht+0x143cb, %rdi
nop
nop
add $18733, %rbx
mov $84, %rcx
rep movsw
sub %r15, %r15
lea addresses_WC_ht+0x10983, %r15
nop
add %rbx, %rbx
...
nop
add %rdi, %rdi
lea addresses_normal_ht+0x39cb, %r14
clflush (%r14)
nop
nop
nop
...
rep movsl
and $27609, %rsi
lea addresses_A_ht+0x5fcb, %rsi
lea addresses_WC_ht+0x1c48f, %rdi
nop
nop
nop
dec %rbx
...
nop
add %r8, %r8
lea addresses_A_ht+0x1cfb3, %rsi
xor $51947, %r14
mov (%rsi), %r8d
nop
nop
...
nop
cmp %r14, %r14
lea addresses_WT_ht+0xbdcb, %r15
nop
xor $39122, %rdi
movw $0x6162, (%r15)
nop
...
nop
xor %r8, %r8
lea addresses_D_ht+0x19f37, %r15
clflush (%r15)
nop
nop
nop
...
nop
and $55155, %r8
lea addresses_D_ht+0x138c5, %r11
nop
nop
nop
inc %r8
...
nop
xor %r8, %r8
lea addresses_normal_ht+0x1b64b, %rsi
lea addresses_UC_ht+0x7e7b, %rdi
nop
nop
nop
nop
...
{'OP': 'LOAD', 'src': {'type': 'addresses_normal_ht', 'AVXalign': True, 'congruent': 6, 'size': 2, 'same': False, 'NT': False}}
