...
push %rdi
push %rsi
lea addresses_normal_ht+0xf627, %rsi
lea addresses_normal_ht+0x55d7, %rdi
dec %r8
mov $74, %rcx
rep movsq
nop
add %r9, %r9
lea addresses_A_ht+0x13dd7, %r8
clflush (%r8)
nop
nop
nop
...
nop
cmp $42457, %r9
lea addresses_D_ht+0x5a17, %rsi
lea addresses_WC_ht+0x6dd7, %rdi
nop
nop
nop
nop
...
rep movsw
sub %rdi, %rdi
lea addresses_D_ht+0x1b597, %rbx
cmp $56133, %rcx
movb (%rbx), %r8b
nop
nop
...
nop
add $41123, %rsi
lea addresses_UC_ht+0xafd7, %rsi
...
nop
and $17186, %rbx
lea addresses_WT_ht+0x3e57, %rdi
inc %r15
mov (%rdi), %r9
xor $61833, %rsi
lea addresses_D_ht+0x5fd7, %rbx
nop
and $56930, %rcx
...
nop
add %rbx, %rbx
lea addresses_normal_ht+0x2507, %rcx
nop
nop
cmp %rbx, %rbx
mov (%rcx), %rsi
...
<gen_prepare_buffer>
{'src': {'type': 'addresses_normal_ht', 'congruent': 4, 'same': True}, 'OP': 'REPM', 'dst': {'type': 'addresses_normal_ht', 'congruent': 11, 'same': False}}
