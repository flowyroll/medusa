...
nop
inc %r15
lea addresses_UC_ht+0x13df2, %rsi
lea addresses_D_ht+0xe334, %rdi
nop
nop
nop
inc %r14
...
nop
dec %r14
lea addresses_WC_ht+0x7eb6, %rsi
lea addresses_WC_ht+0x14f08, %rdi
cmp $3623, %r12
mov $75, %rcx
rep movsq
nop
...
nop
add %r14, %r14
lea addresses_normal_ht+0x19d20, %rsi
nop
nop
nop
nop
...
nop
xor $30311, %rdi
lea addresses_WC_ht+0x13520, %rbx
xor $6412, %rdi
mov (%rbx), %rcx
cmp %r14, %r14
lea addresses_UC_ht+0xbbe0, %rsi
nop
nop
nop
nop
...
nop
cmp %rbx, %rbx
lea addresses_WT_ht+0x10390, %rdi
clflush (%rdi)
nop
nop
sub %rcx, %rcx
...
vpextrq $1, %xmm7, %r9
and %rdi, %rdi
lea addresses_UC_ht+0x18c44, %rdi
clflush (%rdi)
nop
nop
inc %r9
...
{'src': {'type': 'addresses_UC_ht', 'congruent': 1, 'same': False}, 'dst': {'type': 'addresses_D_ht', 'congruent': 1, 'same': False}, 'OP': 'REPM'}
