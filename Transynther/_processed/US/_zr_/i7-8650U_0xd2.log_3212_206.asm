...
nop
xor %r11, %r11
lea addresses_UC_ht+0xd7bd, %r12
nop
dec %r10
movl $0x61626364, (%r12)
nop
...
nop
sub $4314, %rcx
lea addresses_UC_ht+0x5bbd, %rsi
lea addresses_WT_ht+0x1cfbd, %rdi
nop
nop
nop
nop
...
nop
dec %r11
lea addresses_UC_ht+0xe341, %rbp
nop
nop
nop
inc %r10
...
{'OP': 'STOR', 'dst': {'type': 'addresses_A', 'size': 16, 'AVXalign': True, 'NT': True, 'congruent': 4, 'same': False}}
