...
push %rdi
push %rsi
lea addresses_D_ht+0x12ed8, %rsi
lea addresses_A_ht+0x1c2d8, %rdi
nop
nop
nop
nop
...
nop
and %r8, %r8
lea addresses_UC_ht+0xf458, %rsi
lea addresses_A_ht+0x1a2d8, %rdi
clflush (%rsi)
and $25530, %r11
mov $74, %rcx
rep movsl
...
nop
cmp $35515, %rsi
lea addresses_D_ht+0x10e5c, %rcx
nop
nop
nop
nop
...
nop
mfence
lea addresses_UC_ht+0x124dc, %rcx
nop
nop
nop
nop
...
nop
add %rax, %rax
lea addresses_normal_ht+0x1a058, %r11
nop
nop
nop
nop
...
nop
and $3062, %r11
lea addresses_A_ht+0x17ed8, %rax
nop
nop
nop
nop
