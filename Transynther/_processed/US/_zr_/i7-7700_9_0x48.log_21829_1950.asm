...
nop
sub %r8, %r8
lea addresses_D_ht+0x18d5c, %rsi
lea addresses_WC_ht+0xf85c, %rdi
clflush (%rsi)
nop
nop
nop
...
rep movsb
add $48814, %r11
lea addresses_normal_ht+0x4d7c, %rsi
lea addresses_UC_ht+0x1e7c, %rdi
nop
nop
nop
nop
...
rep movsq
cmp $18569, %rax
lea addresses_UC_ht+0x11178, %r11
nop
nop
nop
nop
...
nop
xor %rax, %rax
lea addresses_WT_ht+0x1675c, %r8
nop
nop
nop
nop
...
nop
sub %r12, %r12
lea addresses_WC_ht+0x955c, %r13
nop
nop
and $10435, %rcx
movl $0x61626364, (%r13)
