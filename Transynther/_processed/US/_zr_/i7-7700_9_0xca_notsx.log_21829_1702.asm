...
push %rdx
push %rsi
lea addresses_UC_ht+0x3d0d, %r11
nop
nop
sub $40682, %rbp
...
nop
xor $10266, %r14
lea addresses_normal_ht+0x131ed, %rsi
xor %rbx, %rbx
movb $0x61, (%rsi)
nop
lfence
lea addresses_WC_ht+0x78d, %rsi
lea addresses_WC_ht+0x13f8d, %rdi
nop
nop
add $33683, %rdx
mov $100, %rcx
...
nop
lfence
lea addresses_normal_ht+0x16fad, %rbx
clflush (%rbx)
nop
nop
nop
...
movb (%rbx), %cl
sub %rbx, %rbx
lea addresses_normal_ht+0x398d, %rsi
lea addresses_normal_ht+0x1bc0d, %rdi
clflush (%rdi)
nop
nop
sub $2054, %rdx
...
nop
add $12772, %r11
lea addresses_WC_ht+0xb3ad, %rdx
nop
cmp $59642, %rsi
mov (%rdx), %di
nop
nop
inc %rbp
lea addresses_UC_ht+0x1ec8d, %r14
nop
sub %rsi, %rsi
mov (%r14), %rcx
inc %rsi
lea addresses_normal_ht+0x1006e, %rsi
lea addresses_WC_ht+0x1af8d, %rdi
clflush (%rsi)
clflush (%rdi)
nop
nop
...
nop
cmp $3624, %rsi
lea addresses_WC_ht+0x1149d, %rsi
nop
nop
nop
nop
...
{'dst': {'NT': True, 'AVXalign': True, 'size': 16, 'congruent': 10, 'same': False, 'type': 'addresses_D'}, 'OP': 'STOR'}
[Faulty Load]
