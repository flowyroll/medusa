...
nop
add %r13, %r13
lea addresses_UC_ht+0x12134, %rax
nop
nop
nop
nop
...
nop
xor %rbp, %rbp
lea addresses_normal_ht+0xbc88, %rsi
lea addresses_A_ht+0x17b3d, %rdi
nop
xor %r15, %r15
mov $59, %rcx
rep movsl
...
nop
mfence
lea addresses_A_ht+0x17911, %rcx
nop
nop
cmp %rbp, %rbp
