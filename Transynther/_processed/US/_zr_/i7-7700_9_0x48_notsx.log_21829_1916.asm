...
nop
add %rdx, %rdx
lea addresses_WT_ht+0x106ec, %rsi
lea addresses_WC_ht+0xad78, %rdi
sub %r13, %r13
mov $100, %rcx
rep movsl
nop
...
nop
xor %r13, %r13
lea addresses_normal_ht+0x3ae1, %r13
nop
nop
nop
cmp $62144, %rax
...
nop
add $56332, %r13
lea addresses_WT_ht+0x1a168, %rdx
nop
nop
nop
cmp $33112, %r13
...
{'dst': {'same': True, 'congruent': 5, 'type': 'addresses_WC_ht'}, 'OP': 'REPM', 'src': {'same': False, 'congruent': 1, 'type': 'addresses_WT_ht'}}
