...
push %rdx
push %rsi
lea addresses_WT_ht+0x7a16, %r15
and $23653, %r11
mov (%r15), %r12w
nop
nop
...
nop
lfence
lea addresses_normal_ht+0x16a56, %rsi
lea addresses_WC_ht+0x1448e, %rdi
nop
nop
nop
nop
...
{'src': {'type': 'addresses_WC_ht', 'congruent': 5, 'same': True}, 'dst': {'type': 'addresses_normal_ht', 'congruent': 7, 'same': False}, 'OP': 'REPM'}
