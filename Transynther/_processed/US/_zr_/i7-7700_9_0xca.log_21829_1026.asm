...
push %rdx
push %rsi
lea addresses_normal_ht+0xbc4b, %rsi
lea addresses_normal_ht+0xb6bb, %rdi
nop
nop
nop
add %r11, %r11
...
nop
add %rdx, %rdx
lea addresses_UC_ht+0xdd8b, %rax
clflush (%rax)
nop
nop
sub $28130, %rbx
...
nop
xor $32225, %rdx
lea addresses_WC_ht+0x499b, %rdx
nop
nop
nop
nop
...
movb (%rdx), %cl
add %rcx, %rcx
lea addresses_D_ht+0x1555b, %rsi
...
nop
xor $40148, %rdx
lea addresses_WT_ht+0x151bf, %rax
clflush (%rax)
nop
nop
nop
...
nop
add %rcx, %rcx
lea addresses_WC_ht+0x10c9b, %r11
nop
nop
nop
nop
...
nop
cmp $38022, %rcx
lea addresses_normal_ht+0x1cd9b, %rsi
lea addresses_normal_ht+0x1da03, %rdi
clflush (%rsi)
nop
inc %rax
mov $55, %rcx
...
{'src': {'congruent': 11, 'same': False, 'type': 'addresses_normal_ht'}, 'OP': 'REPM', 'dst': {'congruent': 2, 'same': False, 'type': 'addresses_normal_ht'}}
{'00': 21829}
