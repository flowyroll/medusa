...
nop
add $41116, %r9
lea addresses_A_ht+0x16dbe, %r15
add $20056, %r8
movb $0x61, (%r15)
nop
nop
...
nop
add $33207, %r15
lea addresses_WC_ht+0x1e31e, %rsi
lea addresses_A_ht+0x1666e, %rdi
nop
nop
sub %r15, %r15
mov $49, %rcx
...
// Store
lea addresses_normal+0x1571e, %r12
nop
nop
nop
nop
...
// Load
lea addresses_normal+0x13d1e, %rdi
nop
nop
inc %rax
mov (%rdi), %r13d
