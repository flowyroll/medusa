...
push %rdi
push %rsi
lea addresses_A_ht+0x13a78, %rsi
lea addresses_UC_ht+0x1b2b4, %rdi
nop
nop
nop
sub %rax, %rax
...
nop
inc %r15
lea addresses_WT_ht+0x11ba4, %rbx
nop
nop
nop
nop
...
nop
and $6781, %rax
lea addresses_UC_ht+0x1dfd4, %r15
clflush (%r15)
nop
sub $18628, %rsi
...
<gen_prepare_buffer>
{'src': {'same': True, 'congruent': 1, 'type': 'addresses_A_ht'}, 'OP': 'REPM', 'dst': {'same': False, 'congruent': 10, 'type': 'addresses_UC_ht'}}
