...
nop
xor $59804, %rdi
lea addresses_D_ht+0x1a74f, %r15
nop
nop
and $59772, %rdi
vmovups (%r15), %ymm5
...
nop
xor $43335, %rdi
lea addresses_A_ht+0xb423, %rsi
lea addresses_normal_ht+0x4c5b, %rdi
clflush (%rsi)
nop
nop
nop
...
nop
inc %rdi
lea addresses_UC_ht+0x11fcf, %rdx
nop
nop
dec %rsi
movw $0x6162, (%rdx)
...
nop
add %r9, %r9
lea addresses_WT_ht+0x1fd7, %rsi
lea addresses_normal_ht+0x45cf, %rdi
clflush (%rsi)
inc %r8
mov $114, %rcx
rep movsl
...
nop
add %r15, %r15
lea addresses_A_ht+0x1e3f7, %r15
clflush (%r15)
nop
nop
cmp %rsi, %rsi
...
nop
add $64215, %r8
lea addresses_A_ht+0x1d1bb, %rdi
nop
nop
nop
nop
...
// REPMOV
lea addresses_PSE+0x13ec7, %rsi
lea addresses_PSE+0xeacf, %rdi
nop
nop
nop
nop
...
// Load
lea addresses_normal+0x1a7cf, %r15
nop
nop
nop
nop
...
{'OP': 'REPM', 'src': {'same': False, 'type': 'addresses_PSE', 'congruent': 2}, 'dst': {'same': False, 'type': 'addresses_PSE', 'congruent': 8}}
{'OP': 'STOR', 'dst': {'size': 1, 'NT': False, 'type': 'addresses_D', 'same': False, 'AVXalign': False, 'congruent': 3}}
{'OP': 'LOAD', 'src': {'size': 16, 'NT': False, 'type': 'addresses_normal', 'same': False, 'AVXalign': False, 'congruent': 9}}
[Faulty Load]
