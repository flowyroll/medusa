...
push %rdi
push %rsi
lea addresses_UC_ht+0xea03, %rbx
clflush (%rbx)
nop
nop
nop
...
nop
sub $16857, %r13
lea addresses_normal_ht+0x136bb, %rsi
nop
nop
nop
xor %rax, %rax
...
nop
cmp %r10, %r10
lea addresses_normal_ht+0xd3bb, %r9
xor %r13, %r13
mov (%r9), %eax
nop
nop
add $54300, %rsi
lea addresses_WC_ht+0x1d9c3, %rsi
lea addresses_WT_ht+0x92bb, %rdi
nop
nop
sub %r10, %r10
mov $79, %rcx
...
nop
sub $26739, %rcx
lea addresses_D_ht+0x1da07, %r10
add %rdi, %rdi
...
nop
add %rax, %rax
lea addresses_UC_ht+0x19f5b, %rax
nop
nop
nop
nop
...
nop
xor $44170, %r10
lea addresses_WC_ht+0xc6bb, %rsi
