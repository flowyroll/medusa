...
push %rdi
push %rsi
lea addresses_UC_ht+0x1c756, %r10
clflush (%r10)
and $29934, %rax
...
nop
sub %rsi, %rsi
lea addresses_A_ht+0x3756, %rsi
lea addresses_UC_ht+0x128e5, %rdi
nop
nop
nop
inc %rbx
...
nop
cmp $7974, %rdi
lea addresses_WT_ht+0x1d616, %rsi
nop
mfence
mov $0x6162636465666768, %r11
movq %r11, %xmm3
...
nop
add %r11, %r11
lea addresses_WT_ht+0x18356, %rdi
nop
nop
nop
nop
...
nop
sub %r10, %r10
lea addresses_WC_ht+0x44be, %rbx
add %rsi, %rsi
mov $0x6162636465666768, %r11
movq %r11, %xmm1
vmovups %ymm1, (%rbx)
dec %rax
lea addresses_D_ht+0x11156, %rsi
nop
nop
dec %rax
mov (%rsi), %rcx
...
nop
sub $44988, %rbx
lea addresses_WC_ht+0x5c96, %rcx
sub %r10, %r10
...
nop
cmp $8100, %rbx
lea addresses_A_ht+0x17216, %r10
nop
nop
nop
nop
...
nop
sub %rcx, %rcx
lea addresses_WC_ht+0x14f82, %rbx
nop
add $34349, %r11
...
<gen_faulty_load>
[REF]
{'src': {'NT': True, 'same': False, 'congruent': 0, 'type': 'addresses_US', 'AVXalign': False, 'size': 8}, 'OP': 'LOAD'}
[Faulty Load]
...
{'src': {'same': False, 'congruent': 10, 'type': 'addresses_A_ht'}, 'OP': 'REPM', 'dst': {'same': False, 'congruent': 0, 'type': 'addresses_UC_ht'}}
...
{'src': {'NT': False, 'same': False, 'congruent': 7, 'type': 'addresses_WT_ht', 'AVXalign': True, 'size': 1}, 'OP': 'LOAD'}
