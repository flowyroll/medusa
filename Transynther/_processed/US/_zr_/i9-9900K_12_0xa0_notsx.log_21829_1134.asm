...
push %rdi
push %rsi
lea addresses_WT_ht+0x16380, %r14
nop
nop
nop
nop
...
nop
add %r8, %r8
lea addresses_WT_ht+0x11740, %r10
add $64268, %r12
movb (%r10), %r13b
nop
nop
...
nop
xor $25983, %r14
lea addresses_A_ht+0x16659, %rsi
lea addresses_WT_ht+0x15bd8, %rdi
nop
nop
nop
nop
...
nop
sub %rdi, %rdi
lea addresses_normal_ht+0x3fc0, %rsi
lea addresses_A_ht+0x1ef70, %rdi
nop
xor $6126, %r10
mov $118, %rcx
rep movsb
