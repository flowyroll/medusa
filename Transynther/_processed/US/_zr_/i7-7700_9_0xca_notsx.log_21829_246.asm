...
push %rdx
push %rsi
lea addresses_D_ht+0x8d6a, %rax
nop
and %r9, %r9
movw $0x6162, (%rax)
sub %r14, %r14
lea addresses_WT_ht+0x1676a, %rdx
sub $43482, %rdi
movb $0x61, (%rdx)
add %rcx, %rcx
lea addresses_normal_ht+0x1e16e, %rax
nop
nop
nop
nop
...
nop
xor %rcx, %rcx
lea addresses_normal_ht+0x1036a, %rsi
lea addresses_WC_ht+0x13a26, %rdi
nop
nop
nop
nop
...
{'dst': {'NT': False, 'AVXalign': True, 'size': 8, 'congruent': 1, 'same': False, 'type': 'addresses_US'}, 'OP': 'STOR'}
...
<gen_prepare_buffer>
{'dst': {'NT': False, 'AVXalign': True, 'size': 2, 'congruent': 7, 'same': False, 'type': 'addresses_D_ht'}, 'OP': 'STOR'}
{'dst': {'NT': False, 'AVXalign': False, 'size': 1, 'congruent': 10, 'same': True, 'type': 'addresses_WT_ht'}, 'OP': 'STOR'}
{'dst': {'NT': False, 'AVXalign': False, 'size': 8, 'congruent': 2, 'same': True, 'type': 'addresses_normal_ht'}, 'OP': 'STOR'}
