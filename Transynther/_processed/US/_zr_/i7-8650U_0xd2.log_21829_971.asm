...
nop
xor $31852, %rbp
lea addresses_UC_ht+0x1c41b, %rdi
nop
nop
nop
and $44583, %r9
...
nop
xor $53997, %r9
lea addresses_UC_ht+0x1579b, %r12
nop
nop
nop
cmp $13735, %r14
...
nop
cmp $17012, %rdi
lea addresses_normal_ht+0x1cf9b, %r9
nop
lfence
mov (%r9), %rbp
nop
sub $9066, %r8
lea addresses_WT_ht+0x1089b, %rbp
nop
nop
sub %r9, %r9
movl $0x61626364, (%rbp)
...
nop
cmp %r14, %r14
lea addresses_WC_ht+0x1a5f3, %r12
nop
dec %rbp
mov (%r12), %r9w
nop
xor $15111, %rbp
lea addresses_A_ht+0x569b, %r14
nop
nop
nop
nop
...
vpextrq $1, %xmm5, %r9
mfence
lea addresses_normal_ht+0xd679, %rsi
lea addresses_UC_ht+0x6a53, %rdi
clflush (%rdi)
xor %r9, %r9
mov $57, %rcx
rep movsl
...
{'OP': 'LOAD', 'src': {'type': 'addresses_US', 'size': 16, 'AVXalign': False, 'NT': False, 'congruent': 6, 'same': False}}
[Faulty Load]
