...
lea addresses_normal_ht+0xb85d, %rdi
nop
nop
nop
nop
...
nop
sub %rcx, %rcx
lea addresses_WC_ht+0x19fd, %rsi
nop
nop
nop
nop
...
nop
sub %rcx, %rcx
lea addresses_A_ht+0x1fd, %rsi
lea addresses_normal_ht+0x8a5d, %rdi
nop
nop
nop
nop
...
// Store
lea addresses_normal+0xa1ad, %rdi
nop
nop
nop
sub $28907, %r9
...
{'OP': 'STOR', 'dst': {'type': 'addresses_normal', 'size': 2, 'AVXalign': True, 'NT': True, 'congruent': 2, 'same': False}}
