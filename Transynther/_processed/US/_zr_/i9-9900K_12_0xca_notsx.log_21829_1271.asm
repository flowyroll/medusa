...
push %rdx
push %rsi
lea addresses_D_ht+0x1cbe6, %r11
nop
nop
nop
nop
...
nop
sub $40323, %r11
lea addresses_normal_ht+0x149e6, %r9
nop
nop
nop
nop
...
nop
xor %r11, %r11
lea addresses_D_ht+0x18ae6, %r9
nop
inc %rdi
movl $0x61626364, (%r9)
add %r11, %r11
lea addresses_D_ht+0xcc6, %rsi
lea addresses_D_ht+0xf8f6, %rdi
nop
nop
sub $49106, %r11
mov $92, %rcx
...
nop
add %r14, %r14
lea addresses_UC_ht+0x17e6, %r10
sub %rax, %rax
mov (%r10), %r11d
nop
xor $26969, %rsi
lea addresses_normal_ht+0x13246, %rsi
lea addresses_UC_ht+0xede6, %rdi
nop
nop
nop
cmp %rax, %rax
...
nop
add %rax, %rax
lea addresses_normal_ht+0x15fe6, %rsi
nop
nop
nop
nop
...
nop
xor $8330, %rdi
lea addresses_A_ht+0x6d66, %rax
sub $60552, %rcx
movb $0x61, (%rax)
and %rdx, %rdx
lea addresses_UC_ht+0xdea6, %rsi
lea addresses_WT_ht+0x11e72, %rdi
nop
nop
nop
cmp %r11, %r11
...
vpextrq $0, %xmm3, %rdi
add %r14, %r14
lea addresses_WT_ht+0x181e6, %rsi
lea addresses_normal_ht+0xde6a, %rdi
nop
nop
nop
inc %r11
...
nop
xor $4587, %rsi
lea addresses_A_ht+0x14836, %rdi
nop
nop
dec %rdx
vmovups (%rdi), %ymm1
...
nop
xor $46584, %r14
lea addresses_WC_ht+0x1cde6, %rdi
nop
nop
and $33446, %rdx
mov (%rdi), %r14d
...
{'OP': 'STOR', 'dst': {'same': False, 'type': 'addresses_WC', 'NT': False, 'AVXalign': True, 'size': 32, 'congruent': 2}}
[Faulty Load]
...
{'OP': 'REPM', 'src': {'same': False, 'congruent': 4, 'type': 'addresses_normal_ht'}, 'dst': {'same': False, 'congruent': 9, 'type': 'addresses_UC_ht'}}
...
{'OP': 'LOAD', 'src': {'same': False, 'type': 'addresses_D_ht', 'NT': True, 'AVXalign': False, 'size': 16, 'congruent': 3}}
{'OP': 'REPM', 'src': {'same': False, 'congruent': 11, 'type': 'addresses_WT_ht'}, 'dst': {'same': False, 'congruent': 1, 'type': 'addresses_normal_ht'}}
{'OP': 'LOAD', 'src': {'same': True, 'type': 'addresses_A_ht', 'NT': False, 'AVXalign': False, 'size': 32, 'congruent': 4}}
