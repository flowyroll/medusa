...
nop
and %r12, %r12
lea addresses_WC_ht+0xd159, %rsi
lea addresses_WT_ht+0x19e23, %rdi
nop
nop
nop
sub $27310, %r10
...
rep movsl
cmp $37585, %rdi
lea addresses_WT_ht+0x1b85, %r12
nop
nop
nop
nop
...
nop
inc %r8
lea addresses_WC_ht+0xbadd, %rcx
nop
nop
cmp $15817, %r14
...
lea addresses_A_ht+0x427d, %rdi
add $46703, %rdx
mov $47, %rcx
rep movsb
nop
and $27967, %rbx
lea addresses_A_ht+0x1aedd, %rdx
nop
nop
nop
nop
...
nop
and %r8, %r8
lea addresses_WC_ht+0x218d, %rsi
...
nop
inc %rcx
lea addresses_UC_ht+0x92dd, %r12
nop
nop
add %rsi, %rsi
movb $0x61, (%r12)
...
nop
cmp $48530, %r8
lea addresses_normal_ht+0xd2eb, %rdi
nop
nop
nop
nop
...
movb $0x61, (%rdi)
sub %rdi, %rdi
lea addresses_A_ht+0x969d, %r12
sub %rdx, %rdx
mov (%r12), %r14d
nop
xor %rbx, %rbx
lea addresses_UC_ht+0x58dd, %rdi
clflush (%rdi)
nop
nop
nop
...
// Store
lea addresses_normal+0x84dd, %rax
nop
and $45898, %r14
...
{'OP': 'STOR', 'dst': {'type': 'addresses_normal', 'AVXalign': False, 'congruent': 7, 'size': 8, 'same': False, 'NT': False}}
{'OP': 'STOR', 'dst': {'type': 'addresses_US', 'AVXalign': True, 'congruent': 5, 'size': 16, 'same': False, 'NT': False}}
...
{'OP': 'REPM', 'src': {'type': 'addresses_WC_ht', 'congruent': 0, 'same': False}, 'dst': {'type': 'addresses_WT_ht', 'congruent': 1, 'same': False}}
...
{'OP': 'REPM', 'src': {'type': 'addresses_WT_ht', 'congruent': 8, 'same': False}, 'dst': {'type': 'addresses_A_ht', 'congruent': 4, 'same': False}}
...
{'OP': 'STOR', 'dst': {'type': 'addresses_normal_ht', 'AVXalign': False, 'congruent': 1, 'size': 1, 'same': True, 'NT': False}}
{'OP': 'LOAD', 'src': {'type': 'addresses_A_ht', 'AVXalign': False, 'congruent': 5, 'size': 4, 'same': True, 'NT': False}}
{'OP': 'LOAD', 'src': {'type': 'addresses_UC_ht', 'AVXalign': False, 'congruent': 9, 'size': 2, 'same': True, 'NT': False}}
{'00': 21829}
