...
nop
add $40146, %rbp
lea addresses_A_ht+0x1beb9, %r14
nop
nop
nop
add %r10, %r10
...
nop
inc %r9
lea addresses_UC_ht+0xb679, %rsi
lea addresses_D_ht+0x9cb9, %rdi
sub %r8, %r8
mov $82, %rcx
rep movsb
nop
...
nop
xor %r13, %r13
lea addresses_WC_ht+0x17e39, %r9
nop
nop
add $32545, %rdi
movb $0x61, (%r9)
nop
add %r8, %r8
lea addresses_WT_ht+0x41b9, %rdi
nop
nop
nop
nop
...
// Store
lea addresses_normal+0x2239, %r10
nop
and $13503, %rdx
...
{'OP': 'LOAD', 'src': {'same': False, 'type': 'addresses_WC', 'NT': True, 'AVXalign': False, 'size': 1, 'congruent': 4}}
[Faulty Load]
...
{'OP': 'STOR', 'dst': {'same': False, 'type': 'addresses_D_ht', 'NT': True, 'AVXalign': False, 'size': 32, 'congruent': 8}}
{'OP': 'STOR', 'dst': {'same': False, 'type': 'addresses_D_ht', 'NT': False, 'AVXalign': False, 'size': 1, 'congruent': 11}}
{'OP': 'REPM', 'src': {'same': False, 'congruent': 5, 'type': 'addresses_UC_ht'}, 'dst': {'same': False, 'congruent': 8, 'type': 'addresses_D_ht'}}
