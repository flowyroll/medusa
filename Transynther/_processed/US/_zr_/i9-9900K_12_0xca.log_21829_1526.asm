...
push %rdx
push %rsi
lea addresses_UC_ht+0x4ccf, %rsi
nop
nop
nop
xor $26589, %r8
...
nop
sub $45042, %r8
lea addresses_WT_ht+0x19dcd, %rdx
nop
nop
nop
cmp %rdi, %rdi
...
nop
sub $56024, %rdx
lea addresses_D_ht+0x11f4d, %rdx
nop
nop
nop
nop
...
nop
add $6641, %rdx
lea addresses_D_ht+0x775d, %rsi
lea addresses_D_ht+0x1017, %rdi
clflush (%rsi)
nop
nop
nop
...
rep movsb
cmp %rdx, %rdx
lea addresses_A_ht+0x17af7, %rcx
nop
nop
nop
nop
...
{'OP': 'LOAD', 'src': {'size': 32, 'NT': False, 'type': 'addresses_A_ht', 'same': False, 'AVXalign': True, 'congruent': 6}}
...
{'OP': 'REPM', 'src': {'same': False, 'type': 'addresses_D_ht', 'congruent': 6}, 'dst': {'same': False, 'type': 'addresses_D_ht', 'congruent': 0}}
