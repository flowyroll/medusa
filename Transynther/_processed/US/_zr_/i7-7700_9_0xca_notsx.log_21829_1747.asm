...
push %rdi
push %rsi
lea addresses_WC_ht+0x178c5, %rsi
lea addresses_UC_ht+0x3145, %rdi
clflush (%rdi)
nop
add $23341, %r12
mov $97, %rcx
...
nop
xor %rdi, %rdi
lea addresses_UC_ht+0xd181, %rsi
and %rax, %rax
vmovups (%rsi), %ymm3
...
nop
add $32961, %rdi
lea addresses_WT_ht+0x17161, %rcx
nop
nop
nop
nop
...
nop
dec %rsi
lea addresses_D_ht+0x1a53d, %rbx
nop
nop
nop
nop
...
nop
lfence
lea addresses_A_ht+0x1edd5, %rcx
nop
nop
and %r12, %r12
movb $0x61, (%rcx)
...
{'src': {'NT': True, 'AVXalign': False, 'size': 2, 'congruent': 0, 'same': False, 'type': 'addresses_WT_ht'}, 'OP': 'LOAD'}
