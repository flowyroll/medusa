...
nop
cmp %rsi, %rsi
lea addresses_normal_ht+0x123fa, %r12
nop
nop
nop
nop
...
nop
xor $10215, %rbx
lea addresses_WC_ht+0xa6f9, %r13
nop
nop
sub $18403, %rbx
vmovups (%r13), %ymm0
...
nop
xor %r12, %r12
lea addresses_UC_ht+0x1a6b, %rsi
lea addresses_WC_ht+0x7e19, %rdi
nop
xor $4074, %r9
mov $6, %rcx
rep movsq
...
nop
xor $26657, %rcx
lea addresses_A_ht+0x14279, %rsi
nop
nop
nop
nop
...
nop
and $38939, %r13
lea addresses_normal_ht+0xa351, %r12
nop
dec %r13
...
nop
and $38484, %r12
lea addresses_normal_ht+0x1a379, %rcx
clflush (%rcx)
nop
nop
nop
...
nop
xor %rcx, %rcx
lea addresses_UC_ht+0x937f, %rsi
nop
nop
nop
nop
...
nop
xor %r12, %r12
lea addresses_UC_ht+0x1d579, %rsi
lea addresses_WC_ht+0x1d4b9, %rdi
and $21158, %r9
mov $71, %rcx
rep movsl
sub $35812, %rsi
lea addresses_WT_ht+0x5a1, %r14
nop
nop
nop
cmp $3326, %rbx
...
nop
dec %rcx
lea addresses_WC_ht+0x1cb9, %r14
nop
nop
nop
nop
...
{'src': {'type': 'addresses_normal_ht', 'same': False, 'size': 1, 'congruent': 0, 'NT': False, 'AVXalign': True}, 'OP': 'LOAD'}
...
{'src': {'type': 'addresses_UC_ht', 'congruent': 1, 'same': False}, 'dst': {'type': 'addresses_WC_ht', 'congruent': 1, 'same': False}, 'OP': 'REPM'}
...
{'dst': {'type': 'addresses_WT_ht', 'same': False, 'size': 16, 'congruent': 2, 'NT': False, 'AVXalign': True}, 'OP': 'STOR'}
