...
push %rdi
push %rsi
lea addresses_WC_ht+0x18b34, %rcx
nop
nop
nop
nop
...
nop
cmp $20849, %rcx
lea addresses_UC_ht+0x2bd4, %r13
cmp $8026, %r12
mov (%r13), %r10d
nop
cmp %r12, %r12
lea addresses_normal_ht+0x5254, %r10
nop
dec %r12
movb (%r10), %cl
nop
xor %r10, %r10
lea addresses_WC_ht+0x1e324, %rsi
...
nop
and $45235, %rcx
lea addresses_D_ht+0x1504, %rsi
lea addresses_WC_ht+0x8150, %rdi
nop
nop
nop
nop
...
nop
xor $15138, %rsi
lea addresses_UC_ht+0xf3d4, %rsi
lea addresses_normal_ht+0x80c0, %rdi
nop
nop
nop
xor $37725, %r13
...
nop
add $1525, %rbx
lea addresses_WC_ht+0x5fd4, %rsi
lea addresses_WT_ht+0x111d4, %rdi
nop
nop
nop
nop
...
nop
dec %rbx
lea addresses_WT_ht+0x10568, %rsi
...
nop
dec %rsi
lea addresses_WC_ht+0xa334, %rsi
...
nop
and $37032, %r8
lea addresses_normal_ht+0x1b904, %r13
sub %r12, %r12
mov (%r13), %rbx
nop
nop
nop
add %rbx, %rbx
lea addresses_A_ht+0x16ed4, %rsi
lea addresses_WC_ht+0x2f14, %rdi
clflush (%rsi)
nop
nop
cmp $57451, %r12
...
{'OP': 'REPM', 'src': {'type': 'addresses_WC_ht', 'congruent': 4, 'same': False}, 'dst': {'type': 'addresses_WT_ht', 'congruent': 0, 'same': False}}
...
{'OP': 'REPM', 'src': {'type': 'addresses_WC_ht', 'congruent': 10, 'same': False}, 'dst': {'type': 'addresses_WT_ht', 'congruent': 5, 'same': True}}
...
{'OP': 'REPM', 'src': {'type': 'addresses_A_ht', 'congruent': 8, 'same': True}, 'dst': {'type': 'addresses_WC_ht', 'congruent': 1, 'same': False}}
{'00': 21829}
