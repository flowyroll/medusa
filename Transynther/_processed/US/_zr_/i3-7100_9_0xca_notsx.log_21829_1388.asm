...
push %rdx
push %rsi
lea addresses_WC_ht+0xaf00, %rsi
lea addresses_UC_ht+0xdca0, %rdi
clflush (%rdi)
nop
nop
and %r8, %r8
...
nop
dec %rdx
lea addresses_WT_ht+0x10b00, %rsi
lea addresses_WT_ht+0x1ed00, %rdi
nop
nop
nop
nop
...
rep movsq
cmp %rbx, %rbx
lea addresses_WC_ht+0x4500, %rsi
lea addresses_D_ht+0x16a80, %rdi
nop
add %rbx, %rbx
mov $18, %rcx
rep movsw
...
nop
add $29092, %rbx
lea addresses_WT_ht+0x1dd80, %rcx
nop
add $37515, %r8
movb (%rcx), %r12b
nop
...
nop
inc %r12
lea addresses_WC_ht+0x17480, %rsi
