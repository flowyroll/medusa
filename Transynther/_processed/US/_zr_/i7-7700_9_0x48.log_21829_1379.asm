...
nop
xor %rbx, %rbx
lea addresses_D_ht+0x1aa03, %rsi
lea addresses_normal_ht+0x10d03, %rdi
nop
nop
cmp %rbp, %rbp
mov $2, %rcx
...
nop
add %rsi, %rsi
lea addresses_normal_ht+0x6160, %rdx
nop
nop
nop
nop
...
nop
cmp $13895, %rsi
lea addresses_normal_ht+0x11b83, %rbx
nop
nop
nop
nop
...
nop
dec %rcx
lea addresses_WT_ht+0x10003, %rdx
nop
nop
mfence
...
nop
xor $25829, %rcx
lea addresses_WT_ht+0x1c65f, %rcx
nop
add $23187, %rbx
mov (%rcx), %rbp
and $59422, %rdx
lea addresses_normal_ht+0xdbc3, %rdi
nop
nop
nop
nop
...
nop
dec %r14
lea addresses_WC_ht+0x1e6ad, %rbx
nop
nop
nop
nop
...
nop
cmp $55660, %rbp
lea addresses_WC_ht+0x156a3, %r14
clflush (%r14)
and $19968, %rbx
movw $0x6162, (%r14)
sub $1503, %rbx
lea addresses_UC_ht+0x1ba97, %rsi
lea addresses_UC_ht+0x12603, %rdi
clflush (%rsi)
clflush (%rdi)
nop
nop
...
nop
inc %rsi
lea addresses_normal_ht+0x510d, %rsi
lea addresses_D_ht+0xe4a3, %rdi
clflush (%rdi)
nop
cmp $35887, %rbx
mov $79, %rcx
...
nop
xor %rbx, %rbx
lea addresses_UC_ht+0x13797, %rcx
clflush (%rcx)
nop
nop
dec %rdi
...
{'OP': 'LOAD', 'src': {'type': 'addresses_D_ht', 'AVXalign': False, 'congruent': 9, 'size': 4, 'same': False, 'NT': True}}
{'OP': 'REPM', 'src': {'type': 'addresses_D_ht', 'congruent': 10, 'same': False}, 'dst': {'type': 'addresses_normal_ht', 'congruent': 8, 'same': False}}
...
{'OP': 'STOR', 'dst': {'type': 'addresses_WT_ht', 'AVXalign': False, 'congruent': 5, 'size': 32, 'same': True, 'NT': False}}
{'OP': 'LOAD', 'src': {'type': 'addresses_WT_ht', 'AVXalign': False, 'congruent': 2, 'size': 8, 'same': True, 'NT': False}}
