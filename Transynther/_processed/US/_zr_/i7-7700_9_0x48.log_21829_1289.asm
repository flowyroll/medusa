...
lea addresses_UC_ht+0x20f1, %rdi
nop
nop
sub $19456, %r8
mov $21, %rcx
...
nop
xor $1895, %r10
lea addresses_A_ht+0x10411, %r14
nop
sub %r15, %r15
...
nop
xor %r10, %r10
lea addresses_UC_ht+0x17c91, %rcx
dec %r8
mov (%rcx), %edi
and %r14, %r14
pop %rsi
...
{'OP': 'STOR', 'dst': {'type': 'addresses_WC', 'AVXalign': True, 'congruent': 11, 'size': 32, 'same': False, 'NT': False}}
