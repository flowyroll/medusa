...
lea addresses_WT_ht+0x1c9e0, %rdi
nop
nop
add $57263, %rbx
mov $31, %rcx
...
nop
xor %r12, %r12
lea addresses_UC_ht+0x6588, %r12
nop
xor %rcx, %rcx
mov (%r12), %rbx
dec %r12
lea addresses_A_ht+0xa360, %r13
nop
nop
nop
sub %r9, %r9
...
nop
xor $8533, %r13
lea addresses_WC_ht+0x83ec, %rsi
lea addresses_WT_ht+0xb360, %rdi
nop
nop
sub $62465, %rbx
mov $94, %rcx
...
nop
dec %rcx
lea addresses_D_ht+0x17b60, %r12
nop
nop
nop
nop
...
// Load
lea addresses_PSE+0x16d44, %rdx
and %rsi, %rsi
mov (%rdx), %di
inc %rbp

// Store
lea addresses_WC+0x1c7a0, %rsi
nop
nop
xor $11526, %r11
...
{'src': {'NT': False, 'same': False, 'congruent': 2, 'type': 'addresses_PSE', 'AVXalign': True, 'size': 2}, 'OP': 'LOAD'}
{'OP': 'STOR', 'dst': {'NT': False, 'same': False, 'congruent': 5, 'type': 'addresses_WC', 'AVXalign': False, 'size': 32}}
{'OP': 'STOR', 'dst': {'NT': True, 'same': False, 'congruent': 1, 'type': 'addresses_US', 'AVXalign': True, 'size': 8}}
