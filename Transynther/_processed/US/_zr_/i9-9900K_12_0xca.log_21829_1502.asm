...
nop
cmp %r11, %r11
lea addresses_WT_ht+0x1dfd6, %r15
nop
nop
nop
nop
...
nop
add $8745, %rbx
lea addresses_WC_ht+0x6854, %rdx
nop
cmp $19618, %r10
mov $0x6162636465666768, %r14
movq %r14, (%rdx)
dec %r10
lea addresses_normal_ht+0x18156, %r11
nop
nop
sub $49179, %rdx
movl $0x61626364, (%r11)
and %r9, %r9
lea addresses_WT_ht+0x1ad42, %r11
nop
and $39489, %r15
movl $0x61626364, (%r11)
nop
...
{'OP': 'STOR', 'dst': {'size': 1, 'NT': False, 'type': 'addresses_A_ht', 'same': False, 'AVXalign': True, 'congruent': 3}}
...
{'OP': 'LOAD', 'src': {'size': 2, 'NT': True, 'type': 'addresses_WC_ht', 'same': False, 'AVXalign': True, 'congruent': 7}}
{'00': 21829}
