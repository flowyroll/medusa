...
push %rcx
push %rdi
lea addresses_WT_ht+0xc1e5, %rbp
nop
nop
nop
xor $44309, %rbx
...
nop
xor $46065, %rcx
lea addresses_UC_ht+0x2d4b, %rcx
nop
nop
nop
cmp $30929, %r14
mov (%rcx), %di
and %rdi, %rdi
lea addresses_UC_ht+0x1ba33, %rbx
nop
cmp $13441, %rbp
movw $0x6162, (%rbx)
nop
xor $55103, %rdi
lea addresses_UC_ht+0x550f, %rdi
nop
nop
nop
nop
...
nop
cmp $34182, %rbp
lea addresses_normal_ht+0x17d6b, %rcx
nop
add %r12, %r12
...
nop
add %rdi, %rdi
lea addresses_WT_ht+0x390f, %rdi
nop
add $40294, %rbp
movups (%rdi), %xmm2
vpextrq $1, %xmm2, %r14
...
{'OP': 'STOR', 'dst': {'size': 8, 'NT': True, 'type': 'addresses_normal_ht', 'same': False, 'AVXalign': True, 'congruent': 2}}
