...
push %rdx
push %rsi
lea addresses_normal_ht+0x19f56, %rbp
nop
nop
nop
nop
...
nop
sub $57170, %rdx
lea addresses_WC_ht+0x1a4ae, %rsi
lea addresses_UC_ht+0xa77e, %rdi
nop
nop
add $60442, %r11
mov $44, %rcx
...
nop
xor %rdx, %rdx
lea addresses_UC_ht+0x810c, %rbp
nop
nop
nop
and $43867, %r11
...
nop
add %rsi, %rsi
lea addresses_A_ht+0x1691e, %rsi
lea addresses_WT_ht+0x791e, %rdi
inc %rbp
mov $6, %rcx
rep movsq
nop
...
{'src': {'type': 'addresses_WT', 'congruent': 9, 'same': False}, 'dst': {'type': 'addresses_P', 'congruent': 7, 'same': False}, 'OP': 'REPM'}
