...
push %rdi
push %rsi
lea addresses_A_ht+0x1e92e, %rcx
clflush (%rcx)
nop
nop
dec %r10
...
nop
inc %rsi
lea addresses_normal_ht+0x1e936, %rsi
lea addresses_UC_ht+0x19ad6, %rdi
add %r10, %r10
mov $114, %rcx
rep movsb
nop
...
nop
dec %rsi
lea addresses_WT_ht+0x14736, %r9
nop
nop
nop
add %r12, %r12
...
lea addresses_D_ht+0x10236, %rdi
nop
nop
nop
nop
...
nop
xor $186, %r10
lea addresses_normal_ht+0x16636, %r8
inc %r12
vmovups (%r8), %ymm7
...
nop
xor %r11, %r11
lea addresses_WT_ht+0x3716, %r12
nop
nop
nop
dec %r11
...
{'OP': 'REPM', 'src': {'type': 'addresses_UC_ht', 'congruent': 5, 'same': True}, 'dst': {'type': 'addresses_D_ht', 'congruent': 7, 'same': False}}
...
{'OP': 'LOAD', 'src': {'type': 'addresses_D_ht', 'AVXalign': False, 'congruent': 0, 'size': 4, 'same': False, 'NT': True}}
