...
push %rdi
push %rsi
lea addresses_D_ht+0x17b76, %rbp
nop
nop
nop
nop
...
nop
sub %rcx, %rcx
lea addresses_normal_ht+0xa736, %r13
nop
nop
nop
nop
...
nop
and %r12, %r12
lea addresses_WC_ht+0xbc36, %rsi
lea addresses_A_ht+0xf8b6, %rdi
xor %r13, %r13
mov $28, %rcx
rep movsw
nop
...
nop
dec %r12
lea addresses_UC_ht+0x1ef76, %r9
nop
cmp $12845, %r13
mov $0x6162636465666768, %rbp
movq %rbp, (%r9)
and $34478, %rbp
lea addresses_UC_ht+0x1eae7, %rsi
clflush (%rsi)
nop
nop
nop
...
nop
add %rsi, %rsi
lea addresses_UC_ht+0x1e4f6, %r9
nop
nop
nop
nop
...
{'OP': 'STOR', 'dst': {'type': 'addresses_UC_ht', 'size': 8, 'AVXalign': True, 'NT': False, 'congruent': 11, 'same': False}}
{'OP': 'STOR', 'dst': {'type': 'addresses_UC_ht', 'size': 32, 'AVXalign': False, 'NT': False, 'congruent': 0, 'same': True}}
