...
push %rdx
push %rsi
lea addresses_WC_ht+0x19aba, %r14
nop
nop
nop
cmp %r12, %r12
...
nop
sub $46953, %r14
lea addresses_UC_ht+0x154ec, %rbx
nop
nop
add $57407, %r10
...
movups %xmm7, (%rbx)
inc %r11
lea addresses_normal_ht+0x1ad2c, %r14
nop
nop
nop
nop
...
nop
and $19187, %r10
lea addresses_normal_ht+0xcf6c, %rbx
nop
nop
mfence
movb (%rbx), %r11b
...
nop
cmp %r10, %r10
lea addresses_WC_ht+0x1a8dc, %rbx
nop
nop
dec %r12
...
nop
inc %r14
lea addresses_WC_ht+0x19d2c, %r10
nop
and $2681, %r14
movw $0x6162, (%r10)
nop
cmp $35157, %r10
lea addresses_D_ht+0x1cf6c, %r14
clflush (%r14)
nop
and %rdx, %rdx
mov $0x6162636465666768, %r11
...
// REPMOV
lea addresses_normal+0x1ce6c, %rsi
lea addresses_RW+0x676c, %rdi
nop
nop
nop
nop
...
{'src': {'type': 'addresses_normal', 'congruent': 8, 'same': False}, 'OP': 'REPM', 'dst': {'type': 'addresses_RW', 'congruent': 11, 'same': False}}
