...
push %rdx
push %rsi
lea addresses_normal_ht+0x1d50a, %rdx
nop
nop
xor %rbx, %rbx
mov (%rdx), %cx
...
nop
and %r8, %r8
lea addresses_UC_ht+0xc6a6, %rbx
nop
nop
nop
nop
...
nop
and %rbp, %rbp
lea addresses_D_ht+0xe2e6, %rsi
lea addresses_A_ht+0x17aa6, %rdi
nop
nop
dec %rbx
mov $53, %rcx
rep movsb
and %rsi, %rsi
lea addresses_WT_ht+0xa22a, %rdx
cmp %r12, %r12
mov (%rdx), %bp
nop
nop
nop
add $45995, %rdx
lea addresses_UC_ht+0x16ea6, %rcx
and %r8, %r8
mov $0x6162636465666768, %rdi
movq %rdi, %xmm2
vmovups %ymm2, (%rcx)
and $32084, %r8
lea addresses_UC_ht+0x116a6, %rsi
lea addresses_UC_ht+0x50a6, %rdi
nop
nop
nop
nop
...
nop
xor %rbp, %rbp
lea addresses_UC_ht+0x14a3, %rdx
nop
nop
nop
sub %r8, %r8
...
{'OP': 'REPM', 'src': {'type': 'addresses_UC_ht', 'congruent': 10, 'same': False}, 'dst': {'type': 'addresses_UC_ht', 'congruent': 8, 'same': True}}
