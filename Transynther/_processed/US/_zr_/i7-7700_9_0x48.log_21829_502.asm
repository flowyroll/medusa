...
push %rdi
push %rsi
lea addresses_normal_ht+0x1cf7c, %rax
nop
nop
nop
nop
...
nop
add %r8, %r8
lea addresses_A_ht+0xc774, %r9
nop
nop
and %rcx, %rcx
mov (%r9), %r8w
xor %r10, %r10
lea addresses_normal_ht+0x3974, %rsi
lea addresses_WT_ht+0x199c2, %rdi
nop
nop
and $36845, %r14
mov $120, %rcx
...
nop
add $14516, %rsi
lea addresses_WC_ht+0x12f4, %rsi
...
mov (%rcx), %rdi
cmp $1061, %r14
lea addresses_normal_ht+0x262e, %rsi
lea addresses_D_ht+0xa23c, %rdi
add %r14, %r14
mov $122, %rcx
rep movsw
nop
...
nop
sub $49604, %r10
lea addresses_A_ht+0x1c693, %rcx
dec %rax
mov (%rcx), %di
nop
nop
