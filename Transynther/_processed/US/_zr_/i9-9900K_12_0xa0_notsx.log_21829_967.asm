...
nop
xor $10152, %rax
lea addresses_D_ht+0x1cc20, %r11
nop
nop
nop
nop
...
mov (%r11), %ax
xor $1102, %rsi
lea addresses_UC_ht+0x19970, %rsi
lea addresses_D_ht+0x4bb0, %rdi
nop
nop
nop
nop
...
nop
add %rdi, %rdi
lea addresses_normal_ht+0x5990, %rax
nop
nop
dec %rcx
vmovups (%rax), %ymm3
...
nop
sub %r14, %r14
lea addresses_WC_ht+0xd88, %rsi
lea addresses_D_ht+0xfd70, %rdi
nop
nop
nop
nop
...
nop
and $6482, %rax
lea addresses_WC_ht+0x150f0, %rsi
nop
nop
nop
nop
...
{'src': {'type': 'addresses_D_ht', 'AVXalign': True, 'size': 2, 'NT': False, 'same': True, 'congruent': 3}, 'OP': 'LOAD'}
...
{'src': {'type': 'addresses_WC_ht', 'AVXalign': False, 'size': 32, 'NT': False, 'same': True, 'congruent': 7}, 'OP': 'LOAD'}
{'00': 21829}
