...
push %rdx
push %rsi
lea addresses_WC_ht+0x1567f, %rsi
lea addresses_WT_ht+0x6dbf, %rdi
and %rdx, %rdx
mov $20, %rcx
rep movsw
nop
...
nop
add $12635, %rsi
lea addresses_UC_ht+0x10dcf, %rdx
nop
nop
nop
dec %rcx
...
nop
add $56506, %r8
lea addresses_WT_ht+0x121f, %rsi
lea addresses_WT_ht+0x159bf, %rdi
nop
nop
xor %rax, %rax
mov $97, %rcx
...
nop
add %r8, %r8
lea addresses_normal_ht+0x1eb8f, %r9
nop
inc %rdi
movups (%r9), %xmm2
vpextrq $0, %xmm2, %r11
...
nop
dec %rax
lea addresses_normal_ht+0x1a4bf, %rdi
nop
and %r8, %r8
movl $0x61626364, (%rdi)
nop
...
nop
add %r8, %r8
lea addresses_WT_ht+0xbb2f, %rcx
and %r11, %r11
movw $0x6162, (%rcx)
nop
add %rdx, %rdx
lea addresses_WC_ht+0x1969f, %rsi
lea addresses_WC_ht+0x106ef, %rdi
clflush (%rdi)
nop
inc %r9
mov $72, %rcx
...
nop
and $3845, %rsi
lea addresses_normal_ht+0x1b803, %rsi
lea addresses_WT_ht+0x179bf, %rdi
nop
nop
nop
nop
...
{'src': {'same': False, 'congruent': 1, 'type': 'addresses_WT_ht'}, 'OP': 'REPM', 'dst': {'same': False, 'congruent': 10, 'type': 'addresses_WT_ht'}}
{'src': {'NT': False, 'same': False, 'congruent': 1, 'type': 'addresses_normal_ht', 'AVXalign': False, 'size': 16}, 'OP': 'LOAD'}
{'OP': 'STOR', 'dst': {'NT': False, 'same': True, 'congruent': 8, 'type': 'addresses_normal_ht', 'AVXalign': False, 'size': 4}}
...
{'src': {'same': False, 'congruent': 2, 'type': 'addresses_normal_ht'}, 'OP': 'REPM', 'dst': {'same': False, 'congruent': 11, 'type': 'addresses_WT_ht'}}
