...
push %rdx
push %rsi
lea addresses_D_ht+0xd247, %rsi
lea addresses_WT_ht+0xa447, %rdi
nop
nop
sub $9175, %r10
mov $25, %rcx
...
nop
dec %rsi
lea addresses_UC_ht+0x12b07, %rsi
lea addresses_D_ht+0x1c7c7, %rdi
clflush (%rdi)
nop
nop
nop
...
nop
and %rbp, %rbp
lea addresses_UC_ht+0x16e5d, %r14
clflush (%r14)
nop
nop
nop
...
movq %rbp, (%r14)
add %r10, %r10
lea addresses_normal_ht+0xc9df, %rsi
nop
nop
nop
nop
...
nop
add $14710, %r10
lea addresses_normal_ht+0x1c307, %rsi
...
nop
add $47592, %rdi
lea addresses_UC_ht+0x1e1c6, %rbp
nop
nop
nop
nop
...
nop
sub %rbp, %rbp
lea addresses_WC_ht+0x11d17, %rsi
nop
nop
nop
inc %r9
...
nop
cmp %rdi, %rdi
lea addresses_WC_ht+0x6111, %rsi
lea addresses_normal_ht+0x123f, %rdi
nop
nop
nop
and $49481, %r14
...
nop
cmp %r14, %r14
lea addresses_WT_ht+0x1ef87, %rdx
clflush (%rdx)
nop
nop
nop
