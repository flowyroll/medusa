...
push %rdi
push %rsi
lea addresses_WC_ht+0x1d0c1, %rsi
lea addresses_D_ht+0x157f1, %rdi
nop
nop
nop
xor $17812, %r15
...
nop
cmp $36590, %r8
lea addresses_normal_ht+0x14601, %rsi
lea addresses_normal_ht+0x14981, %rdi
nop
dec %rax
mov $127, %rcx
rep movsq
...
nop
sub $9904, %r15
lea addresses_normal_ht+0x12074, %r15
nop
nop
nop
nop
...
nop
and %rax, %rax
lea addresses_UC_ht+0x14dc1, %rax
nop
nop
dec %r9
...
movq %rsi, (%rax)
and %rdi, %rdi
lea addresses_normal_ht+0x16c81, %rsi
lea addresses_WC_ht+0xeb81, %rdi
and %r11, %r11
mov $107, %rcx
rep movsb
add $40203, %r15
lea addresses_normal_ht+0x1b8a1, %rcx
inc %rdi
movb $0x61, (%rcx)
nop
nop
...
{'OP': 'REPM', 'src': {'type': 'addresses_normal_ht', 'congruent': 7, 'same': True}, 'dst': {'type': 'addresses_normal_ht', 'congruent': 11, 'same': False}}
