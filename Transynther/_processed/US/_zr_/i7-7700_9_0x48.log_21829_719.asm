...
push %rcx
push %rdx
lea addresses_WT_ht+0xd3cc, %r10
nop
nop
nop
nop
...
nop
sub %r10, %r10
lea addresses_UC_ht+0x18fcc, %r8
nop
nop
nop
nop
...
movups %xmm0, (%r8)
and $56038, %r8
lea addresses_UC_ht+0x4b5e, %r14
nop
nop
nop
sub $20272, %rdx
...
nop
cmp $54960, %rdx
lea addresses_WC_ht+0x1884c, %r10
sub %r8, %r8
...
{'OP': 'LOAD', 'src': {'type': 'addresses_WT', 'AVXalign': False, 'congruent': 11, 'size': 4, 'same': False, 'NT': False}}
[Faulty Load]
