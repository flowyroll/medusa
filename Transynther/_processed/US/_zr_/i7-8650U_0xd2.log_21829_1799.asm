...
lea addresses_UC_ht+0xedb6, %rdi
nop
nop
nop
nop
...
nop
xor $5305, %rax
lea addresses_A_ht+0x1c1b6, %r13
nop
and %rbx, %rbx
movups (%r13), %xmm6
vpextrq $0, %xmm6, %rax
...
nop
lfence
lea addresses_WC_ht+0x115b6, %rcx
nop
nop
nop
nop
...
movb (%rcx), %al
and $36963, %rbx
lea addresses_WC_ht+0x1088a, %rsi
...
nop
inc %rdi
lea addresses_normal_ht+0x131b6, %rax
nop
xor %rsi, %rsi
mov (%rax), %ebx
add $3692, %rcx
lea addresses_WT_ht+0x161b6, %rsi
lea addresses_A_ht+0x45d4, %rdi
nop
nop
nop
nop
...
nop
cmp $44775, %rbp
lea addresses_normal_ht+0x9b6, %rbx
nop
nop
nop
nop
...
{'OP': 'STOR', 'dst': {'type': 'addresses_normal_ht', 'size': 2, 'AVXalign': True, 'NT': False, 'congruent': 9, 'same': False}}
