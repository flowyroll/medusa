...
nop
add $56454, %rdi
lea addresses_UC_ht+0xe34e, %rsi
xor $4372, %r14
...
nop
cmp %rax, %rax
lea addresses_A_ht+0x16f5e, %r9
add %rcx, %rcx
movb (%r9), %r14b
nop
and %rbx, %rbx
lea addresses_A_ht+0x716e, %rcx
nop
nop
nop
cmp $30687, %rbx
movw $0x6162, (%rcx)
and %rax, %rax
lea addresses_WT_ht+0x15d2e, %rdi
sub %rsi, %rsi
mov (%rdi), %r9d
nop
nop
add %rax, %rax
lea addresses_WT_ht+0x1936e, %rbx
nop
nop
nop
nop
...
nop
dec %rcx
lea addresses_WC_ht+0x19c3a, %rcx
nop
nop
nop
nop
...
nop
sub %rax, %rax
lea addresses_UC_ht+0x19aae, %rax
nop
nop
and $46999, %rbx
...
nop
sub $47773, %r9
lea addresses_A_ht+0x1b932, %rsi
lea addresses_UC_ht+0xcc0d, %rdi
nop
nop
nop
nop
...
{'src': {'congruent': 0, 'same': False, 'type': 'addresses_A_ht'}, 'dst': {'congruent': 0, 'same': False, 'type': 'addresses_UC_ht'}, 'OP': 'REPM'}
{'00': 3808}
