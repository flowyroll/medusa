...
push %rdi
push %rsi
lea addresses_A_ht+0x1aef2, %rbp
sub %rbx, %rbx
movl $0x61626364, (%rbp)
nop
nop
...
nop
sub %rbx, %rbx
lea addresses_WT_ht+0x13f2, %r13
nop
nop
nop
cmp %rbp, %rbp
...
nop
add $44797, %rbx
lea addresses_WC_ht+0xcaf2, %rsi
lea addresses_A_ht+0x7012, %rdi
nop
nop
sub %r10, %r10
mov $57, %rcx
...
// Store
lea addresses_normal+0x110f2, %r8
nop
nop
nop
inc %r11
...
{'dst': {'type': 'addresses_normal', 'same': False, 'size': 4, 'congruent': 8, 'NT': False, 'AVXalign': True}, 'OP': 'STOR'}
{'src': {'type': 'addresses_A', 'same': False, 'size': 4, 'congruent': 3, 'NT': True, 'AVXalign': False}, 'OP': 'LOAD'}
[Faulty Load]
