...
push %rdx
push %rsi
lea addresses_WT_ht+0x1bd9d, %rsi
lea addresses_normal_ht+0x1299d, %rdi
nop
nop
and $55261, %r15
mov $15, %rcx
...
nop
add %r15, %r15
lea addresses_WT_ht+0x1cbdd, %rsi
lea addresses_normal_ht+0x18f9d, %rdi
nop
nop
nop
nop
...
nop
cmp %r15, %r15
lea addresses_WT_ht+0x1551d, %rcx
nop
cmp $50606, %rdx
movw $0x6162, (%rcx)
nop
...
nop
sub %r15, %r15
lea addresses_A_ht+0xdfd, %rsi
lea addresses_WC_ht+0xd09d, %rdi
nop
nop
nop
nop
...
nop
inc %rdi
lea addresses_normal_ht+0x59d, %r15
add $1499, %rcx
...
nop
mfence
lea addresses_UC_ht+0x1ce9d, %rcx
nop
nop
and %rdi, %rdi
movb (%rcx), %r8b
...
{'OP': 'LOAD', 'src': {'type': 'addresses_US', 'AVXalign': True, 'congruent': 8, 'size': 16, 'same': False, 'NT': True}}
[Faulty Load]
