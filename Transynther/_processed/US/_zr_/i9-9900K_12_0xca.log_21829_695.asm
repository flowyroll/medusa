...
push %rdi
push %rsi
lea addresses_normal_ht+0x14261, %rsi
nop
nop
add $56220, %r9
mov (%rsi), %rbp
...
nop
xor %r8, %r8
lea addresses_UC_ht+0x1b8f4, %rbx
nop
nop
and $15194, %r12
mov (%rbx), %r14
...
nop
xor %rbp, %rbp
lea addresses_UC_ht+0x1b7c1, %r9
nop
nop
nop
cmp %r8, %r8
...
lea addresses_normal_ht+0xbd61, %rdi
nop
nop
xor %r9, %r9
mov $3, %rcx
...
nop
dec %rcx
lea addresses_WC_ht+0x11459, %rsi
lea addresses_WC_ht+0x9861, %rdi
nop
nop
xor %r12, %r12
mov $88, %rcx
...
nop
xor %rsi, %rsi
lea addresses_D_ht+0x16261, %r14
inc %rsi
mov (%r14), %cx
nop
nop
...
{'OP': 'REPM', 'src': {'same': False, 'type': 'addresses_D_ht', 'congruent': 3}, 'dst': {'same': False, 'type': 'addresses_normal_ht', 'congruent': 8}}
{'OP': 'REPM', 'src': {'same': True, 'type': 'addresses_WC_ht', 'congruent': 3}, 'dst': {'same': False, 'type': 'addresses_WC_ht', 'congruent': 7}}
