...
nop
add %r13, %r13
lea addresses_WT_ht+0x1e0cb, %rdx
clflush (%rdx)
nop
and $64846, %rdi
...
nop
cmp $33580, %rsi
lea addresses_WC_ht+0x1cd73, %rdx
nop
nop
sub $51628, %rdi
...
nop
sub $44384, %rdx
lea addresses_WT_ht+0x302f, %r11
nop
nop
nop
nop
...
nop
add %r11, %r11
lea addresses_D_ht+0x1d8cb, %r14
and %r13, %r13
movl $0x61626364, (%r14)
nop
nop
...
nop
xor %rdx, %rdx
lea addresses_normal_ht+0x5763, %rdi
and %rdx, %rdx
movw $0x6162, (%rdi)
inc %rdx
lea addresses_A_ht+0x1c6cb, %rdx
nop
nop
nop
nop
...
nop
inc %rsi
lea addresses_WC_ht+0x12341, %r13
nop
nop
add %r14, %r14
vmovups (%r13), %ymm5
...
nop
add %r13, %r13
lea addresses_WT_ht+0x45ab, %rdx
nop
and $49003, %r11
vmovups (%rdx), %ymm0
...
nop
sub %rdi, %rdi
lea addresses_WC_ht+0x119a5, %rsi
lea addresses_WT_ht+0x1524b, %rdi
cmp %rbx, %rbx
mov $101, %rcx
rep movsq
nop
...
{'OP': 'REPM', 'src': {'same': False, 'type': 'addresses_WC_ht', 'congruent': 1}, 'dst': {'same': False, 'type': 'addresses_WT_ht', 'congruent': 6}}
{'00': 21829}
