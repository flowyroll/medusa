...
push %rdi
push %rsi
lea addresses_A_ht+0x19073, %r12
clflush (%r12)
nop
and %r10, %r10
...
nop
xor $14081, %r10
lea addresses_WC_ht+0x88c3, %rsi
nop
nop
nop
nop
...
nop
and $20992, %r15
lea addresses_WC_ht+0x1c0b3, %r10
nop
nop
nop
nop
...
nop
and $26342, %rdi
lea addresses_normal_ht+0x3db3, %rsi
lea addresses_WT_ht+0x106f3, %rdi
dec %rbp
mov $33, %rcx
rep movsl
nop
...
nop
xor $4491, %r15
lea addresses_normal_ht+0x1e57d, %rax
nop
nop
nop
nop
...
movb $0x61, (%rax)
xor %rcx, %rcx
lea addresses_WC_ht+0x3723, %rbp
nop
nop
nop
sub %r15, %r15
...
nop
add $34999, %rdi
lea addresses_WC_ht+0x3e53, %rsi
lea addresses_UC_ht+0xcaf3, %rdi
nop
xor %rbp, %rbp
mov $66, %rcx
rep movsw
...
nop
cmp $60829, %r15
lea addresses_UC_ht+0x1a927, %rbp
nop
nop
sub %r15, %r15
movw $0x6162, (%rbp)
...
nop
inc %rax
lea addresses_WC_ht+0x4af3, %rsi
lea addresses_A_ht+0x5ef3, %rdi
nop
nop
nop
nop
...
{'OP': 'STOR', 'dst': {'same': False, 'type': 'addresses_A_ht', 'NT': True, 'AVXalign': False, 'size': 16, 'congruent': 10}}
{'OP': 'REPM', 'src': {'same': False, 'congruent': 6, 'type': 'addresses_normal_ht'}, 'dst': {'same': False, 'congruent': 10, 'type': 'addresses_WT_ht'}}
...
{'OP': 'REPM', 'src': {'same': False, 'congruent': 2, 'type': 'addresses_WC_ht'}, 'dst': {'same': False, 'congruent': 11, 'type': 'addresses_UC_ht'}}
{'OP': 'STOR', 'dst': {'same': False, 'type': 'addresses_UC_ht', 'NT': False, 'AVXalign': False, 'size': 2, 'congruent': 2}}
{'OP': 'REPM', 'src': {'same': False, 'congruent': 9, 'type': 'addresses_WC_ht'}, 'dst': {'same': False, 'congruent': 10, 'type': 'addresses_A_ht'}}
{'00': 21829}
