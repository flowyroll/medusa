...
push %rdx
push %rsi
lea addresses_WC_ht+0x1a6ba, %rdx
nop
nop
nop
nop
...
nop
xor $49728, %r8
lea addresses_normal_ht+0x1385e, %rdi
nop
nop
nop
nop
...
lea addresses_A_ht+0x190de, %rdi
nop
sub $16372, %rdx
mov $38, %rcx
rep movsl
...
nop
sub %r8, %r8
lea addresses_UC_ht+0x52de, %rdi
nop
nop
nop
nop
...
nop
cmp %r8, %r8
lea addresses_UC_ht+0x65de, %rdx
nop
nop
nop
mfence
