...
push %rdi
push %rsi
lea addresses_normal_ht+0x1125d, %rsi
lea addresses_normal_ht+0x13025, %rdi
nop
nop
nop
nop
...
nop
dec %rsi
lea addresses_UC_ht+0x1c7d, %rsi
nop
nop
nop
nop
...
movq %rbx, (%rsi)
add %rdi, %rdi
lea addresses_normal_ht+0x1eb33, %rbx
nop
nop
nop
dec %rsi
...
nop
and %rbx, %rbx
lea addresses_WC_ht+0x6803, %rsi
lea addresses_WC_ht+0x15f5d, %rdi
nop
nop
nop
dec %r11
...
nop
inc %rbx
lea addresses_WC_ht+0x975d, %r12
nop
inc %rdi
movb $0x61, (%r12)
nop
...
vmovups %ymm3, (%r15)
add $17225, %r12
lea addresses_UC_ht+0xa524, %r12
nop
sub %r15, %r15
movw $0x6162, (%r12)
nop
...
nop
xor %rcx, %rcx
lea addresses_normal_ht+0x1c55d, %rbx
nop
and %rsi, %rsi
mov (%rbx), %ecx
nop
...
{'OP': 'STOR', 'dst': {'same': False, 'congruent': 4, 'NT': True, 'type': 'addresses_WT', 'size': 1, 'AVXalign': False}}
[Faulty Load]
