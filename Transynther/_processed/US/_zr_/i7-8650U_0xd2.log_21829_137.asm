...
push %rdi
push %rsi
lea addresses_WC_ht+0x29cd, %rbp
sub $35022, %rax
...
nop
sub %rbx, %rbx
lea addresses_WC_ht+0x196cd, %rsi
lea addresses_D_ht+0xdbcd, %rdi
cmp %rbp, %rbp
mov $67, %rcx
rep movsb
add $59833, %rsi
lea addresses_WC_ht+0x1851b, %rbx
nop
nop
nop
nop
...
nop
and %rcx, %rcx
lea addresses_WT_ht+0x4a5a, %r13
nop
xor %rbx, %rbx
...
nop
and %rax, %rax
lea addresses_normal_ht+0x10da5, %rdi
nop
nop
nop
nop
...
movb (%rdi), %bl
xor %rdi, %rdi
lea addresses_normal_ht+0xebcd, %rcx
nop
inc %rax
movw $0x6162, (%rcx)
nop
nop
add $2157, %rcx
lea addresses_D_ht+0x10d69, %r13
add $34268, %rax
...
nop
cmp $7327, %rax
lea addresses_WT_ht+0xc5cd, %r13
nop
dec %rbp
movb $0x61, (%r13)
nop
...
nop
xor $1140, %rcx
lea addresses_WC_ht+0x13fcd, %rdi
nop
nop
nop
add %rsi, %rsi
...
{'OP': 'REPM', 'src': {'type': 'addresses_WC_ht', 'congruent': 8, 'same': False}, 'dst': {'type': 'addresses_D_ht', 'congruent': 7, 'same': True}}
