...
nop
cmp $50713, %r8
lea addresses_UC_ht+0x110a2, %rsi
lea addresses_A_ht+0x45fe, %rdi
nop
xor $38675, %rbp
mov $44, %rcx
rep movsl
...
nop
and %rbx, %rbx
lea addresses_WC_ht+0xebc6, %r14
nop
nop
nop
nop
...
mov (%r14), %r11
add $53612, %rbx
lea addresses_WT_ht+0x3bdd, %rsi
and %rdi, %rdi
movw $0x6162, (%rsi)
nop
nop
...
nop
add $64272, %rdi
lea addresses_normal_ht+0x67e2, %r14
nop
nop
nop
nop
...
nop
inc %rbp
lea addresses_WT_ht+0x1d4e2, %rsi
lea addresses_UC_ht+0x3da2, %rdi
nop
cmp $36186, %rbx
mov $127, %rcx
rep movsw
inc %r8
lea addresses_normal_ht+0x3c32, %rbx
nop
nop
nop
nop
...
nop
add %rcx, %rcx
lea addresses_D_ht+0x1d0a2, %rsi
lea addresses_WT_ht+0x5ca2, %rdi
nop
nop
nop
nop
...
nop
inc %rbp
lea addresses_UC_ht+0x1bbb8, %rbp
cmp $24261, %r11
...
nop
xor $13774, %rdi
lea addresses_UC_ht+0x184a2, %rsi
lea addresses_A_ht+0xd3c2, %rdi
nop
nop
nop
nop
...
{'OP': 'REPM', 'src': {'type': 'addresses_WT_ht', 'congruent': 4, 'same': False}, 'dst': {'type': 'addresses_UC_ht', 'congruent': 8, 'same': True}}
{'OP': 'LOAD', 'src': {'type': 'addresses_normal_ht', 'size': 1, 'AVXalign': False, 'NT': False, 'congruent': 2, 'same': False}}
{'OP': 'REPM', 'src': {'type': 'addresses_D_ht', 'congruent': 11, 'same': False}, 'dst': {'type': 'addresses_WT_ht', 'congruent': 6, 'same': True}}
