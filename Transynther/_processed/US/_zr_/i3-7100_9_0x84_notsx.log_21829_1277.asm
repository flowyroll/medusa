...
nop
add $17232, %rcx
lea addresses_D_ht+0x14ec1, %rdx
nop
sub $38532, %rcx
movl $0x61626364, (%rdx)
nop
nop
xor $53282, %rsi
lea addresses_WC_ht+0x6bb9, %rsi
lea addresses_WT_ht+0x16c1, %rdi
clflush (%rsi)
nop
nop
nop
...
{'src': {'type': 'addresses_WC_ht', 'congruent': 8, 'same': False}, 'dst': {'type': 'addresses_WC_ht', 'congruent': 2, 'same': False}, 'OP': 'REPM'}
...
{'src': {'type': 'addresses_WC_ht', 'congruent': 3, 'same': False}, 'dst': {'type': 'addresses_WT_ht', 'congruent': 2, 'same': True}, 'OP': 'REPM'}
{'00': 21829}
