...
// Store
lea addresses_normal+0x1b46a, %r13
nop
nop
nop
dec %r8
...
{'OP': 'STOR', 'dst': {'type': 'addresses_normal', 'size': 1, 'AVXalign': False, 'NT': True, 'congruent': 7, 'same': False}}
