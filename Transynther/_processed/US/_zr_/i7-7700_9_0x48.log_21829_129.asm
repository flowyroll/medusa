...
push %rdi
push %rsi
lea addresses_normal_ht+0x1c4e7, %r14
nop
cmp %rsi, %rsi
movb (%r14), %r9b
nop
...
nop
inc %r13
lea addresses_UC_ht+0xdf47, %rsi
lea addresses_A_ht+0x142e7, %rdi
nop
nop
nop
nop
...
nop
cmp $29343, %rcx
lea addresses_UC_ht+0x1c817, %r13
add %r12, %r12
...
nop
and $41417, %r12
lea addresses_WT_ht+0xe98b, %r13
nop
nop
sub %rdi, %rdi
...
nop
and $33296, %rsi
lea addresses_WC_ht+0xc579, %r14
nop
xor $37292, %rcx
mov (%r14), %r13w
nop
...
nop
dec %r12
lea addresses_D_ht+0x160e7, %rdi
nop
nop
mfence
movw $0x6162, (%rdi)
...
nop
xor %r13, %r13
lea addresses_UC_ht+0x1b0e7, %r14
nop
nop
and %r9, %r9
...
nop
dec %r14
lea addresses_normal_ht+0x52a7, %rcx
clflush (%rcx)
nop
nop
nop
...
nop
and $3244, %r9
lea addresses_WT_ht+0x1a8e7, %rsi
lea addresses_A_ht+0x6903, %rdi
nop
nop
nop
nop
...
nop
cmp %r13, %r13
lea addresses_D_ht+0x10e7, %rsi
lea addresses_D_ht+0x1316b, %rdi
nop
nop
nop
nop
...
{'OP': 'LOAD', 'src': {'type': 'addresses_UC_ht', 'AVXalign': True, 'congruent': 4, 'size': 32, 'same': False, 'NT': False}}
...
{'OP': 'REPM', 'src': {'type': 'addresses_D_ht', 'congruent': 10, 'same': False}, 'dst': {'type': 'addresses_D_ht', 'congruent': 0, 'same': False}}
{'00': 21829}
