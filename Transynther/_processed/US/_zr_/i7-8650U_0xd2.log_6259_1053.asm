...
push %rdx
push %rsi
lea addresses_A_ht+0x110bc, %rsi
lea addresses_UC_ht+0xed2c, %rdi
nop
nop
nop
nop
...
rep movsq
cmp $22323, %r15
lea addresses_WC_ht+0x1a61c, %rsi
...
nop
dec %rsi
lea addresses_D_ht+0x1261c, %r15
nop
nop
nop
lfence
...
nop
cmp %rcx, %rcx
lea addresses_normal_ht+0x11b2c, %rcx
nop
nop
nop
xor %r10, %r10
...
nop
dec %r10
lea addresses_A_ht+0x134cc, %r11
nop
nop
nop
nop
...
nop
lfence
lea addresses_WC_ht+0x768e, %r11
clflush (%r11)
cmp $48467, %rbp
vmovups (%r11), %ymm1
...
nop
cmp $15756, %r15
lea addresses_D_ht+0x1c45c, %rsi
lea addresses_WC_ht+0x970c, %rdi
nop
add %rdx, %rdx
mov $95, %rcx
rep movsw
...
nop
xor %r15, %r15
lea addresses_WC_ht+0x2803, %rdi
nop
nop
nop
nop
...
// Store
lea addresses_normal+0x1a8fc, %r15
nop
xor %rbx, %rbx
movl $0x51525354, (%r15)
nop
...
<gen_prepare_buffer>
{'OP': 'REPM', 'src': {'type': 'addresses_A_ht', 'congruent': 4, 'same': True}, 'dst': {'type': 'addresses_UC_ht', 'congruent': 4, 'same': False}}
