...
nop
add %r13, %r13
lea addresses_UC_ht+0x9d71, %rcx
nop
nop
nop
sub %r8, %r8
...
nop
xor %r8, %r8
lea addresses_normal_ht+0xa1ef, %rsi
lea addresses_WC_ht+0x7b23, %rdi
nop
xor %r15, %r15
mov $0, %rcx
rep movsw
