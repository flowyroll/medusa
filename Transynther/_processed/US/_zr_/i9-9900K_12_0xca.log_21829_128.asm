...
push %rdi
push %rsi
lea addresses_normal_ht+0x12eb9, %rsi
lea addresses_D_ht+0x162b9, %rdi
clflush (%rdi)
add %r14, %r14
mov $74, %rcx
rep movsw
...
nop
and %rdi, %rdi
lea addresses_D_ht+0x1cff3, %rsi
lea addresses_UC_ht+0x110ef, %rdi
clflush (%rsi)
nop
nop
nop
...
nop
and %r14, %r14
lea addresses_WC_ht+0x145d1, %rsi
lea addresses_normal_ht+0x4639, %rdi
nop
nop
nop
nop
...
nop
dec %rsi
lea addresses_normal_ht+0x172b9, %rdi
nop
nop
nop
nop
...
{'OP': 'STOR', 'dst': {'size': 4, 'NT': True, 'type': 'addresses_A', 'same': False, 'AVXalign': False, 'congruent': 6}}
{'OP': 'LOAD', 'src': {'size': 2, 'NT': False, 'type': 'addresses_P', 'same': False, 'AVXalign': False, 'congruent': 10}}
...
{'OP': 'REPM', 'src': {'same': False, 'type': 'addresses_WC_ht', 'congruent': 2}, 'dst': {'same': False, 'type': 'addresses_normal_ht', 'congruent': 7}}
