...
push %rdi
push %rsi
lea addresses_UC_ht+0x19909, %rbx
and %rbp, %rbp
movw $0x6162, (%rbx)
nop
nop
...
nop
xor %rdi, %rdi
lea addresses_WT_ht+0x1d513, %rsi
lea addresses_WT_ht+0x2ae1, %rdi
clflush (%rdi)
nop
and %rbx, %rbx
mov $53, %rcx
...
nop
sub %r12, %r12
lea addresses_normal_ht+0x1bef8, %rsi
nop
nop
nop
nop
