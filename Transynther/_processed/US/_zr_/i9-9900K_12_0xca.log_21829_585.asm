...
lea addresses_normal_ht+0x1bccc, %rdi
nop
nop
nop
nop
...
nop
and $42578, %rcx
lea addresses_D_ht+0x12fac, %rbp
and $53601, %r10
movups (%rbp), %xmm1
vpextrq $1, %xmm1, %rcx
nop
dec %rbp
lea addresses_D_ht+0x92cc, %r10
nop
nop
xor $19251, %rbp
...
nop
inc %rsi
lea addresses_UC_ht+0x1704c, %rcx
nop
and %rdx, %rdx
movups (%rcx), %xmm1
vpextrq $0, %xmm1, %rbp
...
nop
sub %rsi, %rsi
lea addresses_WC_ht+0x158cc, %rcx
nop
dec %r15
vmovups (%rcx), %ymm0
...
nop
and $15354, %rbp
lea addresses_WC_ht+0xb0cc, %rsi
lea addresses_WT_ht+0xc8cc, %rdi
clflush (%rdi)
nop
nop
nop
...
{'OP': 'STOR', 'dst': {'size': 8, 'NT': True, 'type': 'addresses_A', 'same': False, 'AVXalign': False, 'congruent': 1}}
[Faulty Load]
{'OP': 'LOAD', 'src': {'size': 2, 'NT': False, 'type': 'addresses_US', 'same': True, 'AVXalign': False, 'congruent': 0}}
<gen_prepare_buffer>
{'OP': 'STOR', 'dst': {'size': 1, 'NT': False, 'type': 'addresses_UC_ht', 'same': False, 'AVXalign': False, 'congruent': 11}}
{'OP': 'REPM', 'src': {'same': False, 'type': 'addresses_A_ht', 'congruent': 6}, 'dst': {'same': False, 'type': 'addresses_normal_ht', 'congruent': 10}}
