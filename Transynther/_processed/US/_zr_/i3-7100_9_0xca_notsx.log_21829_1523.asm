...
push %rdx
push %rsi
lea addresses_A_ht+0x1ec34, %rbx
nop
nop
nop
dec %rax
...
nop
dec %r12
lea addresses_WT_ht+0x10c74, %r13
cmp %rbp, %rbp
vmovups (%r13), %ymm7
...
nop
add $47943, %rbx
lea addresses_WC_ht+0x9124, %rax
nop
nop
nop
and %rbp, %rbp
...
nop
cmp %rbp, %rbp
lea addresses_D_ht+0x133e4, %rsi
lea addresses_WC_ht+0x1d664, %rdi
nop
nop
nop
nop
...
nop
and %rbp, %rbp
lea addresses_D_ht+0x15b24, %rdx
and $61813, %r13
movups (%rdx), %xmm2
vpextrq $0, %xmm2, %rcx
nop
sub $24419, %rcx
lea addresses_normal_ht+0xfa24, %rsi
lea addresses_WC_ht+0x1c224, %rdi
nop
nop
nop
nop
...
nop
sub $50098, %r8
lea addresses_A_ht+0x1dae4, %r12
nop
nop
nop
nop
...
// Store
lea addresses_normal+0x145a4, %r11
nop
nop
nop
nop
