...
nop
sub $57693, %r9
lea addresses_UC_ht+0x1d7f8, %r12
nop
nop
nop
nop
...
nop
cmp %rsi, %rsi
lea addresses_WT_ht+0xb4a6, %r15
cmp $49678, %rdi
movups (%r15), %xmm4
vpextrq $1, %xmm4, %r8
nop
add %rsi, %rsi
lea addresses_UC_ht+0x2708, %rsi
lea addresses_UC_ht+0xb6d8, %rdi
nop
nop
nop
inc %r8
...
nop
cmp $63075, %rdi
lea addresses_UC_ht+0x19a78, %rdi
nop
nop
nop
xor $44668, %r8
...
lea addresses_A_ht+0x18ad8, %rdi
add %r15, %r15
mov $20, %rcx
rep movsq
nop
...
nop
xor %r9, %r9
lea addresses_WT_ht+0x12858, %r9
clflush (%r9)
nop
nop
nop
...
nop
and %rsi, %rsi
lea addresses_normal_ht+0x64d8, %rbp
nop
nop
cmp %rsi, %rsi
movl $0x61626364, (%rbp)
...
nop
and %r12, %r12
lea addresses_normal_ht+0x15a1e, %rsi
lea addresses_UC_ht+0x52d8, %rdi
nop
nop
nop
nop
...
nop
sub %r12, %r12
lea addresses_WC_ht+0x1cee8, %r9
nop
nop
nop
nop
...
nop
sub $36347, %r9
lea addresses_WT_ht+0x112d8, %r12
nop
nop
nop
nop
...
nop
cmp $60303, %r12
lea addresses_WC_ht+0x7a58, %rsi
...
nop
dec %r9
lea addresses_UC_ht+0x18ed8, %rsi
clflush (%rsi)
sub %r9, %r9
...
{'src': {'type': 'addresses_US', 'same': False, 'size': 32, 'congruent': 5, 'NT': False, 'AVXalign': True}, 'OP': 'LOAD'}
...
{'src': {'type': 'addresses_UC_ht', 'same': False, 'size': 4, 'congruent': 4, 'NT': True, 'AVXalign': False}, 'OP': 'LOAD'}
...
{'src': {'type': 'addresses_normal_ht', 'congruent': 1, 'same': False}, 'dst': {'type': 'addresses_UC_ht', 'congruent': 10, 'same': False}, 'OP': 'REPM'}
