...
push %rdi
push %rsi
lea addresses_WT_ht+0xb658, %r12
nop
add %r10, %r10
movb $0x61, (%r12)
nop
nop
cmp $33560, %rax
lea addresses_WT_ht+0x122d8, %rsi
lea addresses_normal_ht+0x2970, %rdi
nop
nop
sub %r9, %r9
mov $13, %rcx
...
nop
dec %rbp
lea addresses_WC_ht+0x13c1a, %rax
nop
nop
cmp %rsi, %rsi
mov (%rax), %r9w
...
nop
inc %rbp
lea addresses_normal_ht+0x15c78, %rbp
nop
nop
xor %rcx, %rcx
mov (%rbp), %r10d
...
nop
cmp $63963, %rdi
lea addresses_WT_ht+0x3758, %rsi
lea addresses_D_ht+0x1d478, %rdi
clflush (%rsi)
nop
nop
nop
...
{'src': {'same': False, 'congruent': 5, 'type': 'addresses_WT_ht'}, 'OP': 'REPM', 'dst': {'same': False, 'congruent': 3, 'type': 'addresses_normal_ht'}}
...
{'src': {'same': False, 'congruent': 8, 'type': 'addresses_WT_ht'}, 'OP': 'REPM', 'dst': {'same': False, 'congruent': 4, 'type': 'addresses_D_ht'}}
{'00': 21829}
