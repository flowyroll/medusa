...
// REPMOV
lea addresses_UC+0x1f1ba, %rsi
lea addresses_PSE+0x16bba, %rdi
clflush (%rdi)
nop
nop
nop
...
{'dst': {'NT': False, 'AVXalign': True, 'size': 4, 'congruent': 9, 'same': False, 'type': 'addresses_WT'}, 'OP': 'STOR'}
{'src': {'congruent': 7, 'same': False, 'type': 'addresses_UC'}, 'dst': {'congruent': 10, 'same': False, 'type': 'addresses_PSE'}, 'OP': 'REPM'}
{'dst': {'NT': False, 'AVXalign': True, 'size': 8, 'congruent': 4, 'same': False, 'type': 'addresses_P'}, 'OP': 'STOR'}
