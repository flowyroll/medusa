...
push %rdx
push %rsi
lea addresses_A_ht+0x1105e, %rsi
lea addresses_normal_ht+0xbe6e, %rdi
nop
inc %rdx
mov $99, %rcx
rep movsw
...
nop
cmp %r10, %r10
lea addresses_UC_ht+0x1488e, %rdi
nop
nop
nop
nop
...
<gen_prepare_buffer>
{'OP': 'REPM', 'src': {'same': False, 'congruent': 4, 'type': 'addresses_A_ht'}, 'dst': {'same': False, 'congruent': 5, 'type': 'addresses_normal_ht'}}
