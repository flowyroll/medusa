...
push %rdx
push %rsi
lea addresses_WT_ht+0x44f3, %rsi
...
nop
sub $18450, %rsi
lea addresses_UC_ht+0x94f3, %r10
nop
nop
nop
inc %rdi
...
nop
sub $13285, %rsi
lea addresses_normal_ht+0x4867, %rsi
lea addresses_normal_ht+0x16ef3, %rdi
clflush (%rdi)
nop
nop
cmp $42771, %r11
...
rep movsw
dec %rdi
lea addresses_D_ht+0x1cf83, %rcx
nop
xor $46120, %r11
...
nop
inc %rdi
lea addresses_UC_ht+0xa0f3, %rsi
lea addresses_A_ht+0x1c845, %rdi
nop
nop
nop
inc %rdx
...
nop
and $26861, %rdx
lea addresses_WC_ht+0x1917b, %rsi
lea addresses_WT_ht+0xb0f3, %rdi
nop
nop
nop
nop
...
nop
cmp $36420, %rsi
lea addresses_A_ht+0x8073, %rcx
add %r8, %r8
movups (%rcx), %xmm6
vpextrq $1, %xmm6, %r10
and $10910, %rdi
lea addresses_D_ht+0x146db, %rsi
xor $29363, %r8
movl $0x61626364, (%rsi)
cmp $58922, %rsi
lea addresses_normal_ht+0x170f3, %r11
clflush (%r11)
sub %rdi, %rdi
vmovups (%r11), %ymm1
...
nop
and $51025, %r8
lea addresses_normal_ht+0x595e, %rsi
nop
nop
nop
nop
...
nop
cmp $46793, %r15
lea addresses_D_ht+0x5df3, %rsi
lea addresses_UC_ht+0x6003, %rdi
nop
nop
nop
nop
