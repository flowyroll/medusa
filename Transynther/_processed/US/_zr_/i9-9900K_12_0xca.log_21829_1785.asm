...
push %rdi
push %rsi
lea addresses_WC_ht+0xb781, %r8
cmp %r12, %r12
mov $0x6162636465666768, %rbx
movq %rbx, (%r8)
add $26294, %rcx
lea addresses_WT_ht+0x12301, %r13
nop
nop
nop
nop
...
nop
add %r12, %r12
lea addresses_WC_ht+0x13c41, %r9
nop
nop
add $50104, %r11
movw $0x6162, (%r9)
...
nop
sub %rbx, %rbx
lea addresses_WT_ht+0xd181, %rsi
lea addresses_WT_ht+0x7f81, %rdi
sub %r11, %r11
mov $39, %rcx
rep movsq
cmp $24671, %rdi
lea addresses_D_ht+0xe981, %rsi
lea addresses_D_ht+0x13d81, %rdi
xor %rbx, %rbx
mov $60, %rcx
rep movsw
nop
...
nop
dec %rcx
lea addresses_WT_ht+0x3221, %rsi
lea addresses_A_ht+0x5c1, %rdi
clflush (%rsi)
nop
nop
nop
...
{'OP': 'REPM', 'src': {'same': False, 'type': 'addresses_D_ht', 'congruent': 11}, 'dst': {'same': True, 'type': 'addresses_D_ht', 'congruent': 8}}
