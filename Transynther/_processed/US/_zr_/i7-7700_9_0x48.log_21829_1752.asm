...
push %rdx
push %rsi
lea addresses_normal_ht+0x11d05, %r13
nop
nop
nop
nop
...
nop
sub $27056, %rdi
lea addresses_normal_ht+0x1676b, %rsi
lea addresses_normal_ht+0x1539d, %rdi
nop
and $8110, %rdx
mov $58, %rcx
rep movsw
nop
and %rdx, %rdx
lea addresses_UC_ht+0xf5cd, %rsi
lea addresses_A_ht+0x154cd, %rdi
nop
nop
nop
add %r13, %r13
...
rep movsq
and %rax, %rax
lea addresses_WC_ht+0x810d, %rsi
nop
nop
inc %r14
movl $0x61626364, (%rsi)
and %r13, %r13
lea addresses_WC_ht+0x5595, %r12
nop
nop
add $38763, %rax
movb (%r12), %dl
...
nop
add %rcx, %rcx
lea addresses_WC_ht+0x1f75, %rax
add $17460, %r14
mov $0x6162636465666768, %rdx
movq %rdx, %xmm4
movups %xmm4, (%rax)
add $56036, %r12
lea addresses_A_ht+0xd14d, %rsi
...
{'OP': 'REPM', 'src': {'type': 'addresses_normal_ht', 'congruent': 1, 'same': True}, 'dst': {'type': 'addresses_normal_ht', 'congruent': 3, 'same': False}}
{'OP': 'REPM', 'src': {'type': 'addresses_UC_ht', 'congruent': 1, 'same': False}, 'dst': {'type': 'addresses_A_ht', 'congruent': 7, 'same': False}}
