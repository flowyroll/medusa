...
push %rdx
push %rsi
lea addresses_WT_ht+0x346e, %rdx
nop
nop
xor $2669, %rcx
vmovups (%rdx), %ymm1
...
nop
xor $19269, %r10
lea addresses_WT_ht+0xb914, %rsi
nop
xor $736, %r14
...
nop
inc %rsi
lea addresses_D_ht+0x1553a, %rcx
clflush (%rcx)
add $38491, %r14
...
nop
cmp %r14, %r14
lea addresses_normal_ht+0x18b5a, %rsi
lea addresses_normal_ht+0x189ba, %rdi
nop
add $28689, %rbx
mov $51, %rcx
rep movsb
...
nop
inc %r14
lea addresses_normal_ht+0x1cdba, %rbx
clflush (%rbx)
inc %rsi
mov (%rbx), %rdi
add $16083, %rdx
...
<gen_faulty_load>
[REF]
{'src': {'congruent': 0, 'AVXalign': True, 'same': False, 'size': 32, 'NT': True, 'type': 'addresses_US'}, 'OP': 'LOAD'}
[Faulty Load]
...
{'src': {'congruent': 5, 'same': False, 'type': 'addresses_normal_ht'}, 'OP': 'REPM', 'dst': {'congruent': 10, 'same': False, 'type': 'addresses_normal_ht'}}
