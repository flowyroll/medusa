...
nop
sub $7700, %r10
lea addresses_normal_ht+0x1d858, %rsi
lea addresses_WT_ht+0x35f8, %rdi
mfence
mov $53, %rcx
rep movsq
nop
...
nop
cmp %r13, %r13
lea addresses_D_ht+0xcbd8, %rsi
lea addresses_A_ht+0x1e818, %rdi
nop
nop
add $64936, %rdx
mov $99, %rcx
...
nop
and $21700, %rdi
lea addresses_WT_ht+0x1c358, %rsi
nop
nop
nop
nop
...
vpextrq $1, %xmm4, %r11
dec %r9
lea addresses_WT_ht+0xaf58, %rsi
nop
nop
nop
nop
...
nop
sub $59247, %r13
lea addresses_A_ht+0x189f8, %rsi
lea addresses_WT_ht+0x14a28, %rdi
clflush (%rdi)
nop
nop
nop
...
nop
and $9780, %rdi
lea addresses_UC_ht+0x1b98c, %rsi
lea addresses_D_ht+0x2958, %rdi
nop
nop
xor %rdx, %rdx
mov $19, %rcx
...
nop
cmp $10471, %rsi
lea addresses_WT_ht+0x15d58, %r10
clflush (%r10)
nop
nop
nop
...
nop
add $4436, %r9
lea addresses_normal_ht+0xe398, %rdi
clflush (%rdi)
nop
nop
nop
...
nop
add %rdi, %rdi
lea addresses_WT_ht+0x11858, %r9
clflush (%r9)
nop
cmp %rdi, %rdi
movups (%r9), %xmm6
