...
push %rdx
push %rsi
lea addresses_UC_ht+0x15bff, %r12
inc %rsi
movl $0x61626364, (%r12)
nop
nop
...
nop
sub %r11, %r11
lea addresses_normal_ht+0xe2ff, %r14
nop
nop
nop
nop
...
nop
cmp $10195, %r14
lea addresses_UC_ht+0x52ff, %r14
clflush (%r14)
nop
nop
and %rdx, %rdx
...
nop
add %r8, %r8
lea addresses_UC_ht+0x1b26f, %r14
nop
nop
nop
nop
...
nop
xor $42804, %r11
lea addresses_WT_ht+0xb9ff, %r11
add $16231, %rdx
movb $0x61, (%r11)
nop
inc %r10
lea addresses_WT_ht+0x5bff, %rdx
nop
nop
nop
nop
...
nop
dec %r8
lea addresses_UC_ht+0x1c79f, %rsi
nop
nop
nop
cmp %r11, %r11
...
nop
xor $55454, %r8
lea addresses_WT_ht+0x35d9, %rdx
dec %rsi
mov (%rdx), %r10w
nop
cmp %rdx, %rdx
lea addresses_normal_ht+0x1d18f, %rsi
lea addresses_WC_ht+0x1a3df, %rdi
clflush (%rsi)
clflush (%rdi)
cmp %r14, %r14
mov $104, %rcx
...
{'OP': 'STOR', 'dst': {'congruent': 0, 'AVXalign': True, 'same': False, 'size': 4, 'NT': False, 'type': 'addresses_US'}}
[Faulty Load]
{'src': {'congruent': 0, 'AVXalign': False, 'same': True, 'size': 1, 'NT': False, 'type': 'addresses_US'}, 'OP': 'LOAD'}
<gen_prepare_buffer>
{'OP': 'STOR', 'dst': {'congruent': 11, 'AVXalign': True, 'same': False, 'size': 4, 'NT': True, 'type': 'addresses_UC_ht'}}
...
{'src': {'congruent': 1, 'AVXalign': False, 'same': False, 'size': 2, 'NT': True, 'type': 'addresses_WT_ht'}, 'OP': 'LOAD'}
