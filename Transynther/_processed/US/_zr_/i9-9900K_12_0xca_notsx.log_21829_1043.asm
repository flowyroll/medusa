...
push %rdi
push %rsi
lea addresses_normal_ht+0x1fcd, %rsi
lea addresses_WC_ht+0x19c90, %rdi
and $43440, %rbx
mov $99, %rcx
rep movsl
nop
dec %r15
lea addresses_UC_ht+0xb72d, %rbp
nop
nop
nop
cmp $56878, %r10
mov (%rbp), %edi
cmp $21540, %rbx
lea addresses_normal_ht+0x1496d, %rcx
nop
nop
add $9540, %rdi
mov (%rcx), %r15
...
nop
xor %r15, %r15
lea addresses_UC_ht+0x1ee4d, %rbx
nop
nop
nop
nop
...
movq %rsi, (%rbx)
dec %rdi
lea addresses_WC_ht+0x11ead, %rsi
lea addresses_normal_ht+0x11cad, %rdi
clflush (%rsi)
nop
nop
nop
...
nop
sub %rcx, %rcx
lea addresses_normal_ht+0xb7ed, %rdi
nop
nop
xor $10765, %r13
movb $0x61, (%rdi)
...
mov (%rdi), %ebp
sub $55036, %rcx
lea addresses_normal_ht+0x1110d, %r13
nop
nop
nop
cmp %rdi, %rdi
...
vpextrq $0, %xmm3, %r10
dec %r13
lea addresses_UC_ht+0xcead, %rsi
dec %r15
movb $0x61, (%rsi)
nop
sub $30195, %rbx
lea addresses_WT_ht+0x1e30d, %rbx
nop
and %r10, %r10
...
{'OP': 'STOR', 'dst': {'same': False, 'type': 'addresses_NC', 'NT': False, 'AVXalign': True, 'size': 32, 'congruent': 6}}
[Faulty Load]
...
{'OP': 'REPM', 'src': {'same': True, 'congruent': 5, 'type': 'addresses_WC_ht'}, 'dst': {'same': False, 'congruent': 4, 'type': 'addresses_normal_ht'}}
