...
push %rdi
push %rsi
lea addresses_WC_ht+0x132e6, %rdi
and $22764, %r9
movw $0x6162, (%rdi)
nop
nop
...
nop
xor $7233, %rax
lea addresses_UC_ht+0x7a89, %rsi
lea addresses_UC_ht+0x76f8, %rdi
nop
nop
add $15352, %rbp
mov $83, %rcx
rep movsq
and %r9, %r9
lea addresses_normal_ht+0x18cf8, %r9
and %rcx, %rcx
movb (%r9), %al
nop
nop
...
nop
cmp $43226, %rdi
lea addresses_UC_ht+0xabf8, %rbp
sub $2181, %rbx
mov (%rbp), %cx
nop
nop
...
{'OP': 'LOAD', 'src': {'type': 'addresses_A', 'size': 2, 'AVXalign': True, 'NT': False, 'congruent': 10, 'same': False}}
[Faulty Load]
