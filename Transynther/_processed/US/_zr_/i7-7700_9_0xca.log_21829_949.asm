...
push %rdx
push %rsi
lea addresses_A_ht+0x1e5a8, %rsi
lea addresses_A_ht+0xfd68, %rdi
nop
nop
nop
nop
...
nop
cmp %rax, %rax
lea addresses_UC_ht+0x8be8, %rsi
lea addresses_A_ht+0x2e68, %rdi
clflush (%rsi)
cmp %rbp, %rbp
mov $114, %rcx
rep movsq
...
nop
dec %rcx
lea addresses_normal_ht+0xf268, %rdx
nop
xor $44644, %r9
movups (%rdx), %xmm2
vpextrq $1, %xmm2, %rdi
...
nop
inc %rcx
lea addresses_D_ht+0x13186, %rdx
nop
nop
nop
nop
...
nop
dec %rbp
lea addresses_UC_ht+0x1155c, %rdi
nop
nop
inc %rbp
vmovups (%rdi), %ymm3
...
nop
and %rdx, %rdx
lea addresses_A_ht+0x6138, %rsi
lea addresses_WC_ht+0x7a68, %rdi
nop
nop
nop
nop
...
{'src': {'congruent': 4, 'same': False, 'type': 'addresses_A_ht'}, 'OP': 'REPM', 'dst': {'congruent': 11, 'same': True, 'type': 'addresses_WC_ht'}}
{'00': 21829}
