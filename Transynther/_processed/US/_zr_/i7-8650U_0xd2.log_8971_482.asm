...
push %rdx
push %rsi
lea addresses_WT_ht+0xd0a3, %rsi
lea addresses_A_ht+0x191ea, %rdi
clflush (%rdi)
nop
nop
nop
...
nop
xor %rbp, %rbp
lea addresses_WC_ht+0x46a2, %r8
add %rsi, %rsi
mov (%r8), %bp
cmp $12426, %rcx
lea addresses_normal_ht+0x1df5a, %rdi
nop
cmp $56928, %rdx
mov (%rdi), %si
nop
sub %rcx, %rcx
lea addresses_D_ht+0xe57a, %rcx
nop
sub $47471, %rdi
...
{'OP': 'LOAD', 'src': {'type': 'addresses_US', 'size': 8, 'AVXalign': False, 'NT': True, 'congruent': 4, 'same': False}}
{'OP': 'STOR', 'dst': {'type': 'addresses_UC', 'size': 8, 'AVXalign': False, 'NT': False, 'congruent': 6, 'same': False}}
{'OP': 'STOR', 'dst': {'type': 'addresses_NC', 'size': 8, 'AVXalign': True, 'NT': False, 'congruent': 1, 'same': False}}
...
<gen_prepare_buffer>
{'OP': 'REPM', 'src': {'type': 'addresses_WT_ht', 'congruent': 0, 'same': True}, 'dst': {'type': 'addresses_A_ht', 'congruent': 3, 'same': False}}
