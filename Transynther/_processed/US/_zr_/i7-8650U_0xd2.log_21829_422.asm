...
vpextrq $1, %xmm3, %r12
and %rbx, %rbx
lea addresses_UC_ht+0xded0, %r14
nop
nop
nop
nop
...
nop
cmp $55740, %rdi
lea addresses_A_ht+0x8bd8, %rsi
lea addresses_WC_ht+0xb30, %rdi
nop
nop
nop
xor %r12, %r12
...
nop
add $46605, %rax
lea addresses_WT_ht+0x1d830, %rsi
lea addresses_WT_ht+0xb5f0, %rdi
clflush (%rsi)
nop
cmp $13895, %r14
mov $42, %rcx
...
{'OP': 'LOAD', 'src': {'type': 'addresses_UC_ht', 'size': 32, 'AVXalign': False, 'NT': False, 'congruent': 3, 'same': True}}
...
{'OP': 'REPM', 'src': {'type': 'addresses_WT_ht', 'congruent': 8, 'same': False}, 'dst': {'type': 'addresses_WT_ht', 'congruent': 6, 'same': False}}
{'00': 21829}
