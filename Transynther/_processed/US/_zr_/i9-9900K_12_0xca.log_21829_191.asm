...
push %rdi
push %rsi
lea addresses_A_ht+0xbddb, %rsi
lea addresses_WC_ht+0x1ce4b, %rdi
nop
nop
nop
nop
...
rep movsw
cmp %r15, %r15
lea addresses_WT_ht+0x19f7f, %r14
nop
nop
nop
nop
...
movl $0x61626364, (%r14)
add %r12, %r12
lea addresses_WC_ht+0x163eb, %r15
nop
nop
nop
add $35968, %r14
...
nop
sub %r12, %r12
lea addresses_WC_ht+0x1d49b, %rsi
...
nop
add %r8, %r8
lea addresses_UC_ht+0x8f8d, %rsi
inc %r8
movw $0x6162, (%rsi)
sub %r8, %r8
lea addresses_UC_ht+0x11acb, %rsi
lea addresses_WT_ht+0x1660b, %rdi
nop
nop
nop
nop
...
{'OP': 'REPM', 'src': {'same': False, 'type': 'addresses_UC_ht', 'congruent': 7}, 'dst': {'same': False, 'type': 'addresses_WT_ht', 'congruent': 6}}
{'00': 21829}
