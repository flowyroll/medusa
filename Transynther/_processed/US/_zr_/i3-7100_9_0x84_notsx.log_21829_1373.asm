...
lea addresses_UC_ht+0x10402, %rdi
nop
nop
nop
nop
...
nop
add %r15, %r15
lea addresses_normal_ht+0x4ad2, %r11
and %r14, %r14
movl $0x61626364, (%r11)
nop
nop
dec %rbx
lea addresses_normal_ht+0x332, %rsi
lea addresses_WC_ht+0x63c2, %rdi
clflush (%rdi)
nop
nop
cmp %r13, %r13
...
nop
add %rbx, %rbx
lea addresses_normal_ht+0x18842, %rsi
nop
cmp $2753, %r13
...
{'src': {'type': 'addresses_WC_ht', 'congruent': 3, 'same': False}, 'dst': {'type': 'addresses_UC_ht', 'congruent': 4, 'same': False}, 'OP': 'REPM'}
...
{'src': {'type': 'addresses_D_ht', 'congruent': 1, 'same': True}, 'dst': {'type': 'addresses_A_ht', 'congruent': 6, 'same': False}, 'OP': 'REPM'}
{'src': {'type': 'addresses_normal_ht', 'same': False, 'size': 32, 'congruent': 4, 'NT': True, 'AVXalign': True}, 'OP': 'LOAD'}
{'00': 21829}
