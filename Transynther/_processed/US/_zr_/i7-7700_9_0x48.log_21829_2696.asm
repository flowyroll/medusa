...
nop
inc %rsi
lea addresses_WT_ht+0x167e8, %r12
nop
nop
nop
nop
...
nop
cmp $13525, %rax
lea addresses_UC_ht+0x21c8, %rsi
lea addresses_A_ht+0x6b58, %rdi
nop
nop
nop
add %rax, %rax
...
nop
and %rcx, %rcx
lea addresses_A_ht+0x120c7, %rsi
