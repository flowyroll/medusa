...
push %rdx
push %rsi
lea addresses_WT_ht+0x12173, %r13
nop
nop
sub %rsi, %rsi
...
nop
sub $34378, %rcx
lea addresses_WC_ht+0x15d71, %rcx
nop
nop
nop
nop
...
nop
sub $51520, %rcx
lea addresses_UC_ht+0x16f13, %rsi
lea addresses_A_ht+0x16301, %rdi
sub $52117, %r8
mov $115, %rcx
rep movsw
mfence
lea addresses_UC_ht+0x1eb98, %rbp
nop
nop
nop
and $61170, %rdx
...
nop
sub $23277, %rdx
lea addresses_normal_ht+0x1ab6f, %r14
clflush (%r14)
nop
nop
nop
...
nop
inc %rdx
lea addresses_normal_ht+0xa793, %rcx
nop
nop
nop
nop
...
lea addresses_UC_ht+0x1b993, %rdi
nop
nop
nop
nop
...
nop
sub $42007, %rbp
lea addresses_WC_ht+0x5133, %r14
clflush (%r14)
nop
nop
nop
...
nop
xor $27665, %r13
lea addresses_D_ht+0x18c93, %rsi
lea addresses_WC_ht+0x54bb, %rdi
clflush (%rdi)
nop
nop
nop
...
{'OP': 'REPM', 'src': {'same': False, 'type': 'addresses_UC_ht', 'congruent': 7}, 'dst': {'same': False, 'type': 'addresses_A_ht', 'congruent': 1}}
...
{'OP': 'REPM', 'src': {'same': False, 'type': 'addresses_UC_ht', 'congruent': 8}, 'dst': {'same': False, 'type': 'addresses_UC_ht', 'congruent': 7}}
