...
lea addresses_D_ht+0x1d2c0, %rdi
nop
nop
nop
nop
...
lea addresses_UC_ht+0x8c00, %rdi
nop
nop
nop
nop
...
nop
dec %r11
lea addresses_normal_ht+0xa680, %r13
nop
xor %rcx, %rcx
...
nop
cmp %rsi, %rsi
lea addresses_D_ht+0xdfe0, %rsi
lea addresses_normal_ht+0x18a00, %rdi
nop
nop
nop
and $27058, %rax
...
nop
sub $52927, %rcx
lea addresses_WC_ht+0x17440, %rdi
nop
add %rsi, %rsi
movb $0x61, (%rdi)
nop
...
nop
add $59656, %rdi
lea addresses_normal_ht+0xab38, %r13
nop
nop
nop
nop
...
nop
xor $20476, %rbp
lea addresses_WT_ht+0x11acc, %rax
nop
nop
nop
nop
...
nop
and $28113, %rbp
lea addresses_UC_ht+0x13400, %rsi
lea addresses_WT_ht+0x1c400, %rdi
clflush (%rsi)
cmp $523, %rax
mov $60, %rcx
rep movsw
...
// REPMOV
lea addresses_UC+0x179b0, %rsi
lea addresses_D+0xd6b0, %rdi
add %rdx, %rdx
mov $100, %rcx
rep movsl
nop
...
{'src': {'congruent': 5, 'same': False, 'type': 'addresses_UC_ht'}, 'dst': {'congruent': 8, 'same': False, 'type': 'addresses_UC_ht'}, 'OP': 'REPM'}
{'dst': {'NT': False, 'AVXalign': False, 'size': 16, 'congruent': 5, 'same': False, 'type': 'addresses_normal_ht'}, 'OP': 'STOR'}
{'src': {'congruent': 3, 'same': False, 'type': 'addresses_D_ht'}, 'dst': {'congruent': 8, 'same': False, 'type': 'addresses_normal_ht'}, 'OP': 'REPM'}
