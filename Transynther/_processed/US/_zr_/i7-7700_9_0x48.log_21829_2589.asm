...
movl $0x61626364, (%r10)
xor $22333, %r13
lea addresses_WT_ht+0xc3ec, %rsi
lea addresses_WT_ht+0x1c1ec, %rdi
nop
add %r9, %r9
mov $74, %rcx
rep movsl
...
nop
and $30999, %rdi
lea addresses_WC_ht+0x2854, %r13
nop
nop
nop
add %rcx, %rcx
...
nop
xor $10988, %rsi
lea addresses_WC_ht+0x18afa, %rsi
lea addresses_WT_ht+0x1bc44, %rdi
nop
cmp $46661, %r12
mov $40, %rcx
rep movsb
...
nop
and $57598, %rcx
lea addresses_WC_ht+0x165e, %rsi
lea addresses_normal_ht+0xb4ec, %rdi
nop
and %r12, %r12
mov $116, %rcx
rep movsb
...
nop
and $475, %r13
lea addresses_normal_ht+0x118ec, %rsi
lea addresses_D_ht+0x63ec, %rdi
nop
nop
xor $37, %r9
mov $45, %rcx
...
nop
inc %r13
lea addresses_WC_ht+0x9cec, %r13
nop
nop
xor $14367, %rcx
mov (%r13), %r15w
...
nop
inc %rsi
lea addresses_WT_ht+0x106ec, %r12
clflush (%r12)
nop
sub $12861, %r13
mov (%r12), %rdi
...
{'OP': 'REPM', 'src': {'type': 'addresses_D_ht', 'congruent': 5, 'same': False}, 'dst': {'type': 'addresses_WT_ht', 'congruent': 9, 'same': True}}
