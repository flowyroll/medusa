...
nop
add %r15, %r15
lea addresses_WC_ht+0x4c9e, %rax
nop
nop
nop
nop
...
nop
sub $64592, %r14
lea addresses_A_ht+0x13fcc, %rsi
lea addresses_WC_ht+0x1c646, %rdi
add %r10, %r10
mov $51, %rcx
rep movsq
nop
nop
xor %rax, %rax
lea addresses_UC_ht+0x1b6b6, %r15
nop
nop
sub $25594, %rbp
mov (%r15), %r10w
nop
and %rdi, %rdi
lea addresses_WC_ht+0x1c21e, %rsi
lea addresses_WC_ht+0x465e, %rdi
nop
nop
nop
nop
...
nop
and $31469, %rcx
lea addresses_UC_ht+0x1155e, %rsi
lea addresses_A_ht+0x1911e, %rdi
nop
nop
nop
add %rbp, %rbp
...
rep movsq
dec %r15
lea addresses_UC_ht+0x129de, %rbp
sub $51164, %r10
...
nop
and $30598, %rbp
lea addresses_normal_ht+0x1655e, %rdi
nop
nop
nop
nop
...
nop
dec %rsi
lea addresses_WT_ht+0xa3f2, %rsi
lea addresses_D_ht+0x1359e, %rdi
nop
nop
nop
xor %r10, %r10
...
rep movsb
and $7836, %rsi
lea addresses_WC_ht+0x8a3e, %r14
nop
nop
nop
cmp $52335, %rdi
...
nop
and %r14, %r14
lea addresses_UC_ht+0xfe1a, %rdi
nop
nop
xor $32277, %r15
vmovups (%rdi), %ymm7
...
nop
sub %r15, %r15
lea addresses_WC_ht+0x10e9e, %rdi
add $58685, %r15
...
nop
cmp $6153, %rsi
lea addresses_WC_ht+0xb19e, %rsi
lea addresses_A_ht+0x1099e, %rdi
dec %rax
mov $55, %rcx
rep movsb
nop
...
{'OP': 'REPM', 'src': {'same': False, 'congruent': 6, 'type': 'addresses_WC_ht'}, 'dst': {'same': True, 'congruent': 4, 'type': 'addresses_WC_ht'}}
{'OP': 'REPM', 'src': {'same': False, 'congruent': 0, 'type': 'addresses_UC_ht'}, 'dst': {'same': False, 'congruent': 6, 'type': 'addresses_A_ht'}}
...
{'OP': 'REPM', 'src': {'same': True, 'congruent': 1, 'type': 'addresses_WT_ht'}, 'dst': {'same': False, 'congruent': 9, 'type': 'addresses_D_ht'}}
