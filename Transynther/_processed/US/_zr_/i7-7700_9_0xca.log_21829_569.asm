...
push %rdi
push %rsi
lea addresses_normal_ht+0x73ec, %rdi
nop
nop
nop
nop
...
nop
add $47579, %rsi
lea addresses_normal_ht+0x16fa8, %rcx
nop
nop
nop
nop
...
nop
lfence
lea addresses_WC_ht+0x9b28, %rcx
clflush (%rcx)
nop
nop
nop
...
nop
cmp $47865, %rcx
lea addresses_D_ht+0x154a8, %rdi
nop
nop
mfence
mov (%rdi), %bp
...
nop
and %rdi, %rdi
lea addresses_WT_ht+0x150a8, %rcx
and $42251, %r13
mov (%rcx), %di
nop
sub %r13, %r13
lea addresses_A_ht+0x10cf2, %rbp
nop
nop
nop
nop
...
// Store
lea addresses_normal+0x10fa8, %rsi
nop
nop
nop
nop
...
{'src': {'congruent': 2, 'same': False, 'type': 'addresses_P'}, 'OP': 'REPM', 'dst': {'congruent': 8, 'same': False, 'type': 'addresses_RW'}}
...
{'OP': 'STOR', 'dst': {'congruent': 7, 'AVXalign': False, 'same': True, 'size': 1, 'NT': False, 'type': 'addresses_WC_ht'}}
