...
push %rdi
push %rsi
lea addresses_A_ht+0x13c08, %r11
inc %r10
vmovups (%r11), %ymm4
...
nop
add $16329, %r11
lea addresses_UC_ht+0xf90b, %rbp
nop
nop
nop
nop
...
nop
sub %rsi, %rsi
lea addresses_WT_ht+0xefab, %rdi
nop
nop
nop
nop
...
mov (%rdi), %rsi
sub %r10, %r10
lea addresses_WC_ht+0x2fab, %rsi
add $58565, %rbp
movb $0x61, (%rsi)
nop
nop
...
nop
and %rsi, %rsi
lea addresses_normal_ht+0x1a071, %rsi
lea addresses_A_ht+0x1a2b6, %rdi
clflush (%rsi)
nop
nop
nop
...
nop
sub %r12, %r12
lea addresses_normal_ht+0x3e5b, %r12
nop
nop
nop
nop
...
nop
inc %rbp
lea addresses_normal_ht+0x12ab2, %rsi
lea addresses_UC_ht+0x6423, %rdi
nop
nop
cmp %r10, %r10
mov $43, %rcx
...
nop
and %r12, %r12
lea addresses_A_ht+0x152ab, %r10
nop
nop
nop
nop
...
nop
sub $59316, %rbp
lea addresses_normal_ht+0x27ab, %r12
and %r10, %r10
movb $0x61, (%r12)
nop
nop
nop
add %rcx, %rcx
lea addresses_WC_ht+0x23ab, %r10
cmp %rsi, %rsi
mov (%r10), %rcx
nop
nop
nop
and %rcx, %rcx
lea addresses_WC_ht+0x1cceb, %rbp
nop
nop
nop
nop
...
nop
cmp %r11, %r11
lea addresses_D_ht+0xdfab, %rsi
lea addresses_D_ht+0x146fb, %rdi
add $20306, %r15
mov $122, %rcx
rep movsl
nop
sub $49857, %rdi
lea addresses_A_ht+0x1d78b, %rcx
nop
nop
sub %rdi, %rdi
mov (%rcx), %rbp
cmp $37421, %r10
lea addresses_WC_ht+0xc7ab, %r11
add %rdi, %rdi
vmovups (%r11), %ymm6
...
{'OP': 'LOAD', 'src': {'type': 'addresses_UC', 'AVXalign': False, 'congruent': 6, 'size': 8, 'same': True, 'NT': False}}
[Faulty Load]
...
{'OP': 'STOR', 'dst': {'type': 'addresses_WC_ht', 'AVXalign': True, 'congruent': 8, 'size': 1, 'same': False, 'NT': False}}
