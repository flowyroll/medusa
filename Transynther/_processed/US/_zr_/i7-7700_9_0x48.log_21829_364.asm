...
nop
add $10992, %rdi
lea addresses_UC_ht+0x14dd5, %rsi
lea addresses_D_ht+0x1efa1, %rdi
clflush (%rsi)
nop
nop
and %rax, %rax
...
rep movsw
dec %r13
lea addresses_WC_ht+0x1a652, %rsi
lea addresses_WC_ht+0xdef6, %rdi
nop
nop
add %r9, %r9
mov $69, %rcx
...
nop
add $11384, %rax
lea addresses_WC_ht+0x1e601, %r13
nop
nop
nop
sub %rsi, %rsi
...
nop
cmp %rax, %rax
lea addresses_normal_ht+0x1dda1, %r9
nop
nop
cmp %rdx, %rdx
vmovups (%r9), %ymm7
...
nop
add %r14, %r14
lea addresses_WT_ht+0xa521, %rsi
lea addresses_D_ht+0x1e1, %rdi
nop
add %r14, %r14
mov $25, %rcx
rep movsl
...
nop
dec %r9
lea addresses_UC_ht+0xdfc1, %rax
nop
sub $50550, %r13
movb (%rax), %cl
nop
...
lea addresses_A_ht+0x15dc1, %rdi
nop
and %r14, %r14
mov $77, %rcx
rep movsl
...
nop
add $17, %r9
lea addresses_normal_ht+0x1aa41, %r13
nop
sub %rdi, %rdi
mov (%r13), %rsi
nop
add $37849, %r9
lea addresses_WC_ht+0xbc1, %r9
nop
nop
nop
and %rsi, %rsi
...
// Load
lea addresses_normal+0xa409, %rdx
and %rbp, %rbp
movups (%rdx), %xmm2
vpextrq $1, %xmm2, %r15
...
{'OP': 'LOAD', 'src': {'type': 'addresses_WC_ht', 'AVXalign': False, 'congruent': 2, 'size': 4, 'same': False, 'NT': True}}
