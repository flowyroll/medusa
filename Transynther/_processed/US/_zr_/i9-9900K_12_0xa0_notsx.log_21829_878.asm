...
push %rcx
push %rsi
lea addresses_WC_ht+0x1d95f, %rsi
nop
nop
add %rbx, %rbx
...
nop
sub $60485, %r9
lea addresses_normal_ht+0x1b09f, %r10
nop
nop
nop
nop
...
nop
cmp $46124, %rbx
lea addresses_UC_ht+0x1899f, %r15
nop
nop
nop
nop
...
// Store
lea addresses_normal+0x17607, %r10
clflush (%r10)
nop
dec %r14
movl $0x51525354, (%r10)
