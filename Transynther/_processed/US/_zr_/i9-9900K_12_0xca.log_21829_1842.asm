...
lea addresses_WT_ht+0x65d8, %rdi
clflush (%rdi)
nop
nop
nop
...
nop
and $3803, %r14
lea addresses_WT_ht+0x135d8, %rdi
clflush (%rdi)
sub $26941, %rax
...
nop
sub %rcx, %rcx
lea addresses_normal_ht+0xfac5, %r9
nop
nop
nop
dec %rdi
...
nop
xor %rbp, %rbp
lea addresses_WC_ht+0xf648, %rcx
nop
nop
nop
dec %rax
...
nop
sub $53158, %rcx
lea addresses_normal_ht+0x13e98, %r9
nop
nop
xor $4547, %rdi
mov (%r9), %rbp
sub $40903, %rax
lea addresses_WC_ht+0x2f18, %rax
nop
and %rbp, %rbp
movb $0x61, (%rax)
nop
...
nop
cmp $4795, %rbp
lea addresses_WT_ht+0x12938, %r9
nop
nop
and $19714, %rdi
movw $0x6162, (%r9)
...
vmovups %ymm1, (%rcx)
sub $47139, %rsi
lea addresses_WC_ht+0x808, %rbp
and %r9, %r9
movw $0x6162, (%rbp)
nop
and %r9, %r9
lea addresses_UC_ht+0x165d8, %rsi
lea addresses_normal_ht+0xb3f, %rdi
clflush (%rdi)
nop
sub $44435, %r15
mov $76, %rcx
...
{'OP': 'STOR', 'dst': {'size': 16, 'NT': True, 'type': 'addresses_WT_ht', 'same': False, 'AVXalign': False, 'congruent': 7}}
{'OP': 'LOAD', 'src': {'size': 32, 'NT': False, 'type': 'addresses_normal_ht', 'same': False, 'AVXalign': True, 'congruent': 0}}
...
{'OP': 'REPM', 'src': {'same': False, 'type': 'addresses_UC_ht', 'congruent': 10}, 'dst': {'same': False, 'type': 'addresses_normal_ht', 'congruent': 0}}
{'00': 21829}
