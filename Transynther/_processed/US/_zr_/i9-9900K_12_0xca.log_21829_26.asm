...
push %rdx
push %rsi
lea addresses_normal_ht+0x4a5e, %rsi
lea addresses_D_ht+0x75ec, %rdi
nop
nop
nop
nop
...
nop
sub $58742, %r9
lea addresses_WT_ht+0x2f9e, %rsi
lea addresses_UC_ht+0x1ca5e, %rdi
cmp $62011, %r14
mov $99, %rcx
rep movsq
nop
...
// Store
lea addresses_normal+0x19a5e, %rbp
nop
nop
nop
nop
...
{'OP': 'REPM', 'src': {'same': False, 'type': 'addresses_WT_ht', 'congruent': 0}, 'dst': {'same': False, 'type': 'addresses_UC_ht', 'congruent': 10}}
{'00': 21829}
