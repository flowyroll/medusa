...
nop
cmp %r11, %r11
lea addresses_normal_ht+0x8fd7, %rdi
nop
inc %rbp
...
nop
sub $7591, %r14
lea addresses_WT_ht+0xc297, %rbp
nop
nop
xor $18707, %r14
movb $0x61, (%rbp)
...
nop
xor $63322, %r14
lea addresses_UC_ht+0xcac7, %rsi
lea addresses_WC_ht+0x13a17, %rdi
add $64841, %r8
mov $96, %rcx
rep movsq
nop
...
{'OP': 'STOR', 'dst': {'type': 'addresses_US', 'size': 1, 'AVXalign': True, 'NT': False, 'congruent': 0, 'same': False}}
[Faulty Load]
...
{'OP': 'REPM', 'src': {'type': 'addresses_UC_ht', 'congruent': 4, 'same': False}, 'dst': {'type': 'addresses_WC_ht', 'congruent': 4, 'same': False}}
