...
push %rdx
push %rsi
lea addresses_WT_ht+0x2882, %rdx
nop
nop
nop
nop
...
nop
dec %r10
lea addresses_WC_ht+0x16292, %rax
nop
cmp $15905, %r11
movups (%rax), %xmm2
vpextrq $0, %xmm2, %r9
...
nop
and %r11, %r11
lea addresses_WT_ht+0xa4b2, %rsi
lea addresses_UC_ht+0x2d32, %rdi
nop
nop
nop
nop
...
nop
cmp $4722, %rdi
lea addresses_A_ht+0x1e9f7, %rax
nop
nop
nop
nop
...
// Store
lea addresses_RW+0xfa82, %r14
inc %rax
movl $0x51525354, (%r14)
cmp $58958, %rdi

// Faulty Load
lea addresses_US+0xc8b2, %rdx
nop
nop
nop
inc %rax
...
{'src': {'congruent': 10, 'same': True, 'type': 'addresses_WT_ht'}, 'dst': {'congruent': 7, 'same': False, 'type': 'addresses_UC_ht'}, 'OP': 'REPM'}
...
{'src': {'NT': False, 'AVXalign': False, 'size': 8, 'congruent': 9, 'same': True, 'type': 'addresses_A_ht'}, 'OP': 'LOAD'}
{'00': 21829}
