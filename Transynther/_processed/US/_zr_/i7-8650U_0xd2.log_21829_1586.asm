...
push %rdx
push %rsi
lea addresses_WT_ht+0xd14d, %rsi
lea addresses_WT_ht+0x11dae, %rdi
nop
cmp %r9, %r9
mov $107, %rcx
rep movsb
...
nop
xor $40907, %r14
lea addresses_WC_ht+0x712d, %rsi
nop
nop
nop
xor %r13, %r13
...
nop
sub $35985, %r9
lea addresses_normal_ht+0x18dad, %rsi
lea addresses_UC_ht+0xd5ed, %rdi
clflush (%rsi)
nop
nop
nop
...
nop
xor %rdi, %rdi
lea addresses_D_ht+0x1b8ad, %rsi
nop
nop
nop
nop
...
nop
sub %r13, %r13
lea addresses_A_ht+0xde2d, %r9
nop
nop
inc %rdx
mov (%r9), %r14w
cmp $24052, %r13
lea addresses_A_ht+0x40ad, %rsi
nop
nop
nop
sub $45887, %r14
mov (%rsi), %rcx
cmp $49552, %r9
lea addresses_WT_ht+0x188ad, %r9
nop
nop
nop
nop
...
nop
add $56430, %rsi
lea addresses_D_ht+0x4cad, %rsi
lea addresses_D_ht+0x66ad, %rdi
nop
nop
add $8028, %rdx
mov $5, %rcx
...
nop
cmp $56649, %rdi
lea addresses_A_ht+0xe22d, %rdx
nop
xor %rcx, %rcx
movups (%rdx), %xmm5
vpextrq $0, %xmm5, %rbp
xor $56588, %rdx
lea addresses_UC_ht+0x187ed, %r9
cmp %rdi, %rdi
mov $0x6162636465666768, %rdx
movq %rdx, (%r9)
nop
