...
nop
xor %rcx, %rcx
lea addresses_D_ht+0x145d7, %rbx
nop
nop
nop
nop
...
nop
cmp $18208, %r15
lea addresses_D_ht+0x13884, %rdx
nop
nop
nop
nop
...
nop
dec %r15
lea addresses_WT_ht+0xadcc, %rdx
clflush (%rdx)
nop
nop
nop
...
movb $0x61, (%rdx)
dec %rdi
lea addresses_A_ht+0x14b4c, %r14
clflush (%r14)
nop
nop
xor $58136, %rdi
...
{'OP': 'STOR', 'dst': {'type': 'addresses_US', 'AVXalign': False, 'congruent': 10, 'size': 16, 'same': False, 'NT': True}}
...
{'OP': 'LOAD', 'src': {'type': 'addresses_A_ht', 'AVXalign': True, 'congruent': 10, 'size': 32, 'same': False, 'NT': True}}
{'OP': 'LOAD', 'src': {'type': 'addresses_D_ht', 'AVXalign': False, 'congruent': 4, 'size': 8, 'same': True, 'NT': True}}
{'00': 21829}
