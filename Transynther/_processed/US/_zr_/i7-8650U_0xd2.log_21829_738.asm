...
push %rdx
push %rsi
lea addresses_UC_ht+0x14dc, %r13
nop
nop
xor %rbx, %rbx
mov (%r13), %r8w
...
nop
and %r15, %r15
lea addresses_D_ht+0x1a4d2, %rdx
nop
nop
nop
nop
...
movw $0x6162, (%rdx)
xor $5574, %r11
lea addresses_normal_ht+0xdd66, %rsi
lea addresses_WC_ht+0x6e86, %rdi
nop
lfence
mov $42, %rcx
rep movsq
...
nop
xor $3450, %rdx
lea addresses_WC_ht+0x2b76, %r15
nop
nop
nop
nop
...
nop
inc %rsi
lea addresses_WC_ht+0x27f6, %rdx
clflush (%rdx)
nop
nop
and %r8, %r8
...
nop
dec %rsi
lea addresses_normal_ht+0x7976, %r11
nop
nop
sub $33643, %rcx
movl $0x61626364, (%r11)
...
nop
xor %rcx, %rcx
lea addresses_normal_ht+0x1baf6, %r11
xor %rdx, %rdx
movw $0x6162, (%r11)
add $29955, %rbx
lea addresses_A_ht+0x10da8, %r11
nop
nop
nop
add %r8, %r8
...
nop
and $21447, %rdi
lea addresses_normal_ht+0x5176, %rdx
nop
nop
nop
nop
...
mov (%r11), %ebx
and %rbx, %rbx
lea addresses_normal_ht+0x5576, %rsi
...
nop
mfence
lea addresses_WT_ht+0x10a16, %rcx
nop
nop
nop
nop
