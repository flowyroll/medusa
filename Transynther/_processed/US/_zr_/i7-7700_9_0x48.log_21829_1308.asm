...
push %rdi
push %rsi
lea addresses_WC_ht+0xff1c, %rcx
nop
xor %r12, %r12
vmovups (%rcx), %ymm4
...
nop
xor %r15, %r15
lea addresses_UC_ht+0x1912, %r9
nop
nop
cmp %r15, %r15
movl $0x61626364, (%r9)
inc %r12
lea addresses_WC_ht+0x11a52, %r12
add %r8, %r8
movl $0x61626364, (%r12)
nop
nop
nop
and $22963, %rcx
lea addresses_A_ht+0xcfea, %rsi
lea addresses_WT_ht+0x11112, %rdi
nop
nop
nop
nop
...
nop
add $8160, %rdi
lea addresses_WC_ht+0x5412, %rsi
nop
nop
add $28015, %r12
mov (%rsi), %r8w
nop
sub $45618, %r9
lea addresses_normal_ht+0x19f22, %rsi
lea addresses_UC_ht+0x40d5, %rdi
nop
nop
nop
xor $45992, %r13
...
{'OP': 'STOR', 'dst': {'type': 'addresses_UC_ht', 'AVXalign': False, 'congruent': 10, 'size': 4, 'same': True, 'NT': False}}
...
{'OP': 'LOAD', 'src': {'type': 'addresses_WC_ht', 'AVXalign': False, 'congruent': 8, 'size': 2, 'same': True, 'NT': False}}
