...
nop
and $35239, %rbp
lea addresses_WC_ht+0x1a496, %r13
sub $33450, %r9
mov (%r13), %eax
nop
nop
nop
sub $53171, %r13
lea addresses_A_ht+0x18fd6, %rsi
lea addresses_UC_ht+0xf486, %rdi
clflush (%rsi)
clflush (%rdi)
nop
cmp $60048, %r10
...
nop
xor $35972, %r9
lea addresses_UC_ht+0x44d6, %rsi
nop
nop
nop
xor %r10, %r10
...
lea addresses_A_ht+0x1a31b, %rdi
nop
nop
nop
nop
...
// Store
lea addresses_normal+0x1e3d6, %rax
nop
nop
nop
nop
...
{'OP': 'STOR', 'dst': {'type': 'addresses_US', 'size': 4, 'AVXalign': True, 'NT': False, 'congruent': 0, 'same': False}}
...
{'OP': 'REPM', 'src': {'type': 'addresses_A_ht', 'congruent': 8, 'same': False}, 'dst': {'type': 'addresses_UC_ht', 'congruent': 4, 'same': True}}
