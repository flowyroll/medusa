...
push %rdx
push %rsi
lea addresses_WT_ht+0x1dbda, %rsi
lea addresses_A_ht+0x12a5e, %rdi
nop
add %rdx, %rdx
mov $29, %rcx
rep movsq
...
nop
cmp %rdx, %rdx
lea addresses_WT_ht+0x7fda, %rsi
lea addresses_normal_ht+0x1cfda, %rdi
nop
nop
nop
nop
...
nop
dec %rbx
lea addresses_normal_ht+0xd45a, %r14
nop
nop
dec %rax
...
nop
add $45709, %rsi
lea addresses_D_ht+0x91ea, %rsi
lea addresses_UC_ht+0x481a, %rdi
nop
cmp %rbx, %rbx
mov $91, %rcx
rep movsw
...
nop
mfence
lea addresses_A_ht+0x7da, %rsi
lea addresses_WC_ht+0x571a, %rdi
nop
nop
add $40773, %r13
mov $82, %rcx
...
nop
dec %r13
lea addresses_UC_ht+0x2b13, %rdi
nop
cmp $47717, %rdx
movl $0x61626364, (%rdi)
nop
nop
inc %rcx
lea addresses_WC_ht+0x171da, %rsi
...
nop
xor $33325, %rdx
lea addresses_UC_ht+0xc7da, %rax
add $59946, %r14
movl $0x61626364, (%rax)
dec %r14
lea addresses_normal_ht+0x86a, %rdi
nop
nop
nop
nop
...
nop
and $23099, %r14
lea addresses_UC_ht+0x17f86, %r13
nop
nop
nop
cmp $61104, %rcx
...
nop
inc %rdx
lea addresses_normal_ht+0x189da, %r13
add $47029, %rsi
mov $0x6162636465666768, %r14
movq %r14, %xmm3
vmovups %ymm3, (%r13)
inc %rax
lea addresses_D_ht+0x117c2, %r14
nop
add $52890, %rdi
...
// REPMOV
lea addresses_UC+0x1c4a, %rsi
lea addresses_UC+0x148fa, %rdi
mfence
mov $85, %rcx
rep movsb
nop
...
{'src': {'type': 'addresses_PSE', 'same': False, 'size': 8, 'congruent': 1, 'NT': False, 'AVXalign': True}, 'OP': 'LOAD'}
{'src': {'type': 'addresses_UC', 'congruent': 2, 'same': False}, 'dst': {'type': 'addresses_UC', 'congruent': 5, 'same': False}, 'OP': 'REPM'}
[Faulty Load]
...
{'src': {'type': 'addresses_D_ht', 'same': False, 'size': 8, 'congruent': 3, 'NT': True, 'AVXalign': True}, 'OP': 'LOAD'}
