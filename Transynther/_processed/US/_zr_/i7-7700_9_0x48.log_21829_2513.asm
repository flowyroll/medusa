...
nop
cmp $15312, %r11
lea addresses_A_ht+0x1807, %rsi
lea addresses_WT_ht+0x1ed8, %rdi
nop
and %r12, %r12
mov $118, %rcx
rep movsb
...
nop
cmp $38556, %rsi
lea addresses_A_ht+0x1db11, %rcx
nop
nop
nop
add $4666, %rsi
...
nop
xor $1063, %r12
lea addresses_UC_ht+0xde11, %r12
nop
cmp $63969, %r11
movb $0x61, (%r12)
nop
nop
and $43765, %r15
lea addresses_A_ht+0x15ce1, %rdi
nop
nop
cmp %r10, %r10
...
nop
xor %r10, %r10
lea addresses_WC_ht+0xfa31, %rsi
nop
nop
nop
cmp %rdx, %rdx
...
nop
xor %r11, %r11
lea addresses_UC_ht+0xd2e9, %r11
nop
nop
nop
nop
...
{'OP': 'STOR', 'dst': {'type': 'addresses_A_ht', 'AVXalign': True, 'congruent': 2, 'size': 8, 'same': True, 'NT': False}}
{'OP': 'STOR', 'dst': {'type': 'addresses_WC_ht', 'AVXalign': False, 'congruent': 3, 'size': 2, 'same': False, 'NT': True}}
