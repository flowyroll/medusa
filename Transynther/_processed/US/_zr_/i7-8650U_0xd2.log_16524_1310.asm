...
nop
add %r12, %r12
lea addresses_UC_ht+0xddcf, %rbx
nop
add %r8, %r8
mov (%rbx), %r11d
nop
...
nop
add $35346, %r8
lea addresses_normal_ht+0x8ccf, %r11
nop
dec %rsi
vmovups (%r11), %ymm4
...
nop
dec %r9
lea addresses_normal_ht+0x1194b, %rsi
lea addresses_A_ht+0x126ff, %rdi
nop
nop
xor %rax, %rax
mov $0, %rcx
...
nop
and %rbx, %rbx
lea addresses_WT_ht+0x1a0b7, %rsi
lea addresses_WT_ht+0x8ff3, %rdi
clflush (%rdi)
nop
and $36142, %r8
mov $22, %rcx
...
// Store
lea addresses_normal+0x1c0cf, %r15
clflush (%r15)
nop
nop
nop
