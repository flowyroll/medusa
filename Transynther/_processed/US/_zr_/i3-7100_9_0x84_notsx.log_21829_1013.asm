...
push %rbp
push %rdi
lea addresses_normal_ht+0x83b6, %r8
nop
nop
nop
cmp $4764, %rbp
...
// Load
lea addresses_normal+0x573c, %rcx
nop
nop
nop
nop
...
{'dst': {'type': 'addresses_RW', 'same': False, 'size': 4, 'congruent': 3, 'NT': False, 'AVXalign': True}, 'OP': 'STOR'}
{'src': {'type': 'addresses_UC', 'same': False, 'size': 4, 'congruent': 4, 'NT': False, 'AVXalign': False}, 'OP': 'LOAD'}
