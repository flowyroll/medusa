...
nop
and $62011, %r12
lea addresses_UC_ht+0x9633, %rsi
nop
nop
nop
sub %rbx, %rbx
...
nop
dec %rsi
lea addresses_WT_ht+0x1cc7b, %r15
nop
inc %r12
movl $0x61626364, (%r15)
nop
...
nop
xor $12765, %rbx
lea addresses_UC_ht+0xfbf3, %r15
nop
nop
nop
nop
...
nop
and %rbx, %rbx
lea addresses_UC_ht+0x126f3, %r9
clflush (%r9)
nop
nop
add $57260, %rsi
...
nop
cmp %r15, %r15
lea addresses_WT_ht+0x3cb0, %r12
nop
nop
nop
nop
...
nop
xor $18984, %rsi
lea addresses_WC_ht+0x11633, %rsi
lea addresses_A_ht+0xe637, %rdi
nop
nop
nop
nop
...
{'OP': 'REPM', 'src': {'type': 'addresses_UC_ht', 'congruent': 1, 'same': False}, 'dst': {'type': 'addresses_D_ht', 'congruent': 7, 'same': True}}
