...
nop
inc %rdx
lea addresses_WT_ht+0x11a1c, %rax
nop
nop
sub $38693, %r11
...
nop
xor %r11, %r11
lea addresses_normal_ht+0x13cac, %rbx
nop
and %r10, %r10
movl $0x61626364, (%rbx)
sub %r8, %r8
lea addresses_WT_ht+0x1371c, %rsi
lea addresses_WC_ht+0x1ccbc, %rdi
cmp $13933, %rax
mov $99, %rcx
rep movsq
nop
...
nop
and %rcx, %rcx
lea addresses_WT_ht+0x194fc, %r10
clflush (%r10)
nop
nop
nop
...
nop
cmp $44541, %rbx
lea addresses_normal_ht+0xf21c, %rdi
nop
nop
nop
nop
...
{'dst': {'same': False, 'congruent': 4, 'type': 'addresses_WC_ht'}, 'OP': 'REPM', 'src': {'same': False, 'congruent': 8, 'type': 'addresses_WT_ht'}}
{'dst': {'same': False, 'NT': True, 'AVXalign': True, 'size': 2, 'type': 'addresses_A_ht', 'congruent': 5}, 'OP': 'STOR'}
