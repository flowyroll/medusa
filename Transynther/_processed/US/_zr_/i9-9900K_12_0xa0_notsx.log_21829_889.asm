...
push %rdi
push %rsi
lea addresses_UC_ht+0x118ff, %rsi
lea addresses_A_ht+0x1ed3f, %rdi
clflush (%rsi)
nop
nop
nop
...
nop
inc %rdi
lea addresses_WC_ht+0x6b3f, %rbx
clflush (%rbx)
nop
nop
nop
...
// Store
lea addresses_normal+0xccaf, %r8
nop
nop
nop
nop
...
{'OP': 'STOR', 'dst': {'type': 'addresses_UC', 'AVXalign': True, 'size': 1, 'NT': False, 'same': False, 'congruent': 9}}
{'src': {'type': 'addresses_US', 'AVXalign': False, 'size': 8, 'NT': True, 'same': False, 'congruent': 6}, 'OP': 'LOAD'}
