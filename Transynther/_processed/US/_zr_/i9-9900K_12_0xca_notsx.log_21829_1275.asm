...
push %rdi
push %rsi
lea addresses_WT_ht+0x1640c, %r14
nop
nop
nop
nop
...
nop
and $44059, %rbp
lea addresses_WT_ht+0x106f4, %rax
nop
nop
nop
nop
...
nop
sub $22274, %r14
lea addresses_WC_ht+0x158f4, %r13
nop
nop
dec %rsi
...
nop
xor $50368, %rdi
lea addresses_A_ht+0x1ee3c, %rbx
nop
nop
nop
nop
...
mov (%rbx), %edi
inc %rax
lea addresses_UC_ht+0x16313, %r14
nop
nop
cmp %rbp, %rbp
movl $0x61626364, (%r14)
...
<gen_faulty_load>
[REF]
{'OP': 'LOAD', 'src': {'same': False, 'type': 'addresses_US', 'NT': True, 'AVXalign': True, 'size': 1, 'congruent': 0}}
{'OP': 'STOR', 'dst': {'same': False, 'type': 'addresses_P', 'NT': False, 'AVXalign': False, 'size': 16, 'congruent': 4}}
{'OP': 'LOAD', 'src': {'same': False, 'type': 'addresses_D', 'NT': False, 'AVXalign': True, 'size': 32, 'congruent': 2}}
