...
push %rdi
push %rsi
lea addresses_WC_ht+0x11e7, %rsi
lea addresses_A_ht+0x6527, %rdi
nop
and %rax, %rax
mov $78, %rcx
rep movsb
inc %r9
lea addresses_D_ht+0x163e7, %rbx
nop
cmp %r15, %r15
movb (%rbx), %al
nop
...
nop
add $41472, %rcx
lea addresses_A_ht+0x6067, %rsi
lea addresses_WC_ht+0x19167, %rdi
nop
nop
nop
xor %r14, %r14
...
nop
xor %rax, %rax
lea addresses_WC_ht+0x11307, %rax
nop
nop
nop
nop
...
nop
sub %r15, %r15
lea addresses_WT_ht+0xf9e7, %rsi
nop
nop
nop
nop
...
nop
cmp %rsi, %rsi
lea addresses_WT_ht+0x13167, %r9
nop
nop
nop
nop
...
nop
and $57786, %rcx
lea addresses_WT_ht+0x154e7, %rdi
nop
nop
nop
nop
...
nop
cmp %rdi, %rdi
lea addresses_A_ht+0x1e8a7, %rsi
...
nop
sub %r9, %r9
lea addresses_normal_ht+0x9ecf, %rdi
nop
nop
nop
nop
...
mov (%rdi), %eax
dec %rdi
lea addresses_A_ht+0x19453, %rbx
nop
nop
nop
nop
...
<gen_prepare_buffer>
{'OP': 'REPM', 'src': {'type': 'addresses_WC_ht', 'congruent': 11, 'same': False}, 'dst': {'type': 'addresses_A_ht', 'congruent': 4, 'same': False}}
