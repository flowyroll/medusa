...
push %rdi
push %rsi
lea addresses_normal_ht+0x1b1b1, %r13
nop
cmp $17806, %rsi
...
lea addresses_normal_ht+0x7b3d, %rdi
nop
nop
nop
nop
...
nop
cmp %rcx, %rcx
lea addresses_WT_ht+0x1c5fd, %r15
clflush (%r15)
nop
nop
nop
...
nop
add %r15, %r15
lea addresses_WC_ht+0x12341, %rsi
nop
nop
nop
nop
...
nop
sub %r15, %r15
lea addresses_UC_ht+0xf871, %rsi
lea addresses_A_ht+0x194b1, %rdi
nop
nop
nop
inc %r9
...
nop
sub %r13, %r13
lea addresses_normal_ht+0x35f9, %r13
nop
nop
add %rcx, %rcx
mov $0x6162636465666768, %r15
...
nop
xor $20053, %r13
lea addresses_WT_ht+0x1b4b1, %r15
cmp $43134, %rcx
mov (%r15), %esi
nop
nop
...
{'OP': 'LOAD', 'src': {'type': 'addresses_WT_ht', 'AVXalign': False, 'congruent': 11, 'size': 4, 'same': False, 'NT': True}}
{'00': 21829}
