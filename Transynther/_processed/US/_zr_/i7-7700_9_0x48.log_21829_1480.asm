...
push %rdx
push %rsi
lea addresses_WC_ht+0xdf3b, %rsi
lea addresses_D_ht+0x153fb, %rdi
clflush (%rdi)
nop
nop
nop
...
nop
xor %r10, %r10
lea addresses_WC_ht+0xb21b, %rsi
lea addresses_WT_ht+0x1233b, %rdi
nop
nop
nop
sub $9261, %rbx
...
nop
inc %rdx
lea addresses_WC_ht+0x73fb, %rsi
lea addresses_WT_ht+0x1c4df, %rdi
nop
nop
cmp %rbx, %rbx
mov $90, %rcx
...
nop
and %r10, %r10
lea addresses_normal_ht+0x1b283, %rsi
sub $23339, %rdx
movw $0x6162, (%rsi)
nop
nop
nop
cmp %rdx, %rdx
lea addresses_UC_ht+0x94e1, %rbx
clflush (%rbx)
nop
nop
nop
...
nop
add $22431, %r11
lea addresses_WT_ht+0xe33b, %r11
nop
nop
nop
nop
...
<gen_prepare_buffer>
{'OP': 'REPM', 'src': {'type': 'addresses_WC_ht', 'congruent': 7, 'same': True}, 'dst': {'type': 'addresses_D_ht', 'congruent': 6, 'same': False}}
