...
nop
add $997, %r8
lea addresses_D_ht+0x1578d, %rsi
nop
nop
and %r10, %r10
...
nop
and %rsi, %rsi
lea addresses_normal_ht+0x1b0cd, %r10
nop
nop
nop
and %rcx, %rcx
...
nop
inc %rdi
lea addresses_A_ht+0x1a40d, %rsi
...
nop
dec %rax
lea addresses_WC_ht+0x1bd0d, %rcx
nop
nop
nop
and %rsi, %rsi
mov (%rcx), %rdi
sub %r10, %r10
lea addresses_UC_ht+0xff1b, %r12
nop
nop
nop
nop
...
nop
sub $59300, %rax
lea addresses_WC_ht+0x15b0d, %rsi
lea addresses_WT_ht+0xcbcd, %rdi
nop
nop
add $41862, %r14
mov $21, %rcx
...
{'OP': 'LOAD', 'src': {'type': 'addresses_WC_ht', 'size': 8, 'AVXalign': False, 'NT': True, 'congruent': 8, 'same': True}}
...
{'OP': 'REPM', 'src': {'type': 'addresses_WC_ht', 'congruent': 7, 'same': True}, 'dst': {'type': 'addresses_WT_ht', 'congruent': 5, 'same': False}}
{'00': 3156}
