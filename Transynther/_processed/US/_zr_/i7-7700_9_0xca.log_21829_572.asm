...
push %rdi
push %rsi
lea addresses_normal_ht+0xf06a, %rbx
cmp %r10, %r10
...
nop
sub %rax, %rax
lea addresses_WT_ht+0x111da, %r10
add $59452, %rax
movw $0x6162, (%r10)
cmp %r12, %r12
lea addresses_UC_ht+0x46af, %r12
cmp $14375, %rax
mov (%r12), %esi
nop
cmp $31446, %rsi
lea addresses_WC_ht+0x134de, %rbx
xor %rsi, %rsi
movb $0x61, (%rbx)
nop
nop
...
{'src': {'congruent': 6, 'AVXalign': False, 'same': False, 'size': 2, 'NT': False, 'type': 'addresses_NC'}, 'OP': 'LOAD'}
[Faulty Load]
...
{'src': {'congruent': 4, 'AVXalign': True, 'same': True, 'size': 1, 'NT': True, 'type': 'addresses_A_ht'}, 'OP': 'LOAD'}
...
{'OP': 'STOR', 'dst': {'congruent': 8, 'AVXalign': True, 'same': False, 'size': 16, 'NT': False, 'type': 'addresses_D_ht'}}
{'00': 21829}
