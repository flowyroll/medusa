...
nop
add %rdi, %rdi
lea addresses_D_ht+0x6c78, %rsi
lea addresses_UC_ht+0x4558, %rdi
xor %rbp, %rbp
mov $108, %rcx
rep movsq
nop
...
nop
add %rbp, %rbp
lea addresses_WC_ht+0xaf8, %rsi
lea addresses_normal_ht+0x778, %rdi
nop
cmp $38411, %r15
mov $43, %rcx
rep movsq
...
nop
dec %rcx
lea addresses_normal_ht+0xc038, %rbp
nop
dec %rdx
...
nop
dec %rbx
lea addresses_UC_ht+0x2c78, %rdi
nop
inc %rsi
movw $0x6162, (%rdi)
nop
...
nop
xor %rsi, %rsi
lea addresses_WT_ht+0xcc78, %r15
and $54381, %rdi
vmovups (%r15), %ymm4
