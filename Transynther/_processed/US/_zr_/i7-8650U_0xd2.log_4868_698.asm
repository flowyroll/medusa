...
mov (%r11), %r12
xor $21323, %rdi
lea addresses_WT_ht+0x60b6, %r13
nop
nop
and %r12, %r12
...
nop
cmp %r15, %r15
lea addresses_D_ht+0x13206, %r12
nop
nop
nop
nop
...
nop
cmp $22259, %r13
lea addresses_A_ht+0x1bee6, %rsi
lea addresses_normal_ht+0x11b66, %rdi
nop
nop
nop
nop
...
{'OP': 'STOR', 'dst': {'type': 'addresses_WT', 'size': 32, 'AVXalign': False, 'NT': True, 'congruent': 1, 'same': False}}
{'OP': 'STOR', 'dst': {'type': 'addresses_RW', 'size': 16, 'AVXalign': False, 'NT': True, 'congruent': 11, 'same': False}}
