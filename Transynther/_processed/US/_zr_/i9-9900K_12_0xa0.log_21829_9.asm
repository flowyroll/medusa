...
push %rdx
push %rsi
lea addresses_WT_ht+0x3ba3, %rsi
lea addresses_A_ht+0x1783a, %rdi
clflush (%rdi)
xor $4968, %r12
mov $36, %rcx
rep movsq
...
nop
xor %r12, %r12
lea addresses_WC_ht+0x15b22, %rsi
lea addresses_WT_ht+0x1c9a, %rdi
nop
sub %rdx, %rdx
mov $10, %rcx
rep movsb
...
nop
cmp $14570, %rdi
lea addresses_A_ht+0xc43a, %rsi
lea addresses_D_ht+0x113fa, %rdi
nop
nop
nop
add %rdx, %rdx
...
nop
sub $47958, %rcx
lea addresses_normal_ht+0xd3e8, %rdi
nop
add %rdx, %rdx
movl $0x61626364, (%rdi)
nop
...
nop
inc %rsi
lea addresses_A_ht+0x3132, %rsi
lea addresses_normal_ht+0xcdda, %rdi
clflush (%rsi)
nop
nop
nop
...
rep movsw
and $30290, %r12
lea addresses_A_ht+0x1243a, %r12
clflush (%r12)
sub $12799, %rdi
mov (%r12), %edx
nop
...
<gen_prepare_buffer>
{'src': {'same': False, 'congruent': 0, 'type': 'addresses_WT_ht'}, 'OP': 'REPM', 'dst': {'same': False, 'congruent': 11, 'type': 'addresses_A_ht'}}
...
{'src': {'same': False, 'congruent': 2, 'type': 'addresses_A_ht'}, 'OP': 'REPM', 'dst': {'same': False, 'congruent': 5, 'type': 'addresses_normal_ht'}}
