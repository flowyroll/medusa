...
nop
xor %r13, %r13
lea addresses_normal_ht+0x19217, %rsi
lea addresses_WT_ht+0x16097, %rdi
nop
nop
nop
nop
...
nop
dec %r12
lea addresses_WT_ht+0x6747, %rsi
nop
nop
xor $22997, %r11
mov $0x6162636465666768, %rax
...
nop
xor %rax, %rax
lea addresses_A_ht+0xdd47, %rsi
lea addresses_D_ht+0x17997, %rdi
nop
nop
nop
nop
...
nop
dec %r9
lea addresses_normal_ht+0xe2d7, %r13
nop
nop
nop
nop
...
movntdq %xmm6, (%r13)
sub $37377, %r12
lea addresses_D_ht+0x156f7, %rcx
nop
nop
nop
nop
...
nop
inc %rdi
lea addresses_normal_ht+0x5097, %rsi
lea addresses_WT_ht+0x1cc97, %rdi
nop
nop
xor $11406, %r8
mov $118, %rcx
...
nop
cmp %rax, %rax
lea addresses_normal_ht+0xb0bf, %rsi
lea addresses_WT_ht+0x13937, %rdi
nop
nop
sub %r8, %r8
mov $118, %rcx
...
nop
cmp %rcx, %rcx
lea addresses_WC_ht+0x1e1a7, %r11
nop
nop
nop
inc %r9
...
nop
add %r9, %r9
lea addresses_WT_ht+0x27af, %r9
nop
xor $34172, %r11
mov (%r9), %r12d
nop
add $44134, %r8
lea addresses_WT_ht+0xc557, %rsi
lea addresses_D_ht+0x1c097, %rdi
xor $31393, %r11
mov $2, %rcx
rep movsl
nop
xor %rcx, %rcx
lea addresses_D_ht+0x1097, %r12
clflush (%r12)
nop
nop
nop
...
{'OP': 'REPM', 'src': {'type': 'addresses_A_ht', 'congruent': 4, 'same': False}, 'dst': {'type': 'addresses_D_ht', 'congruent': 6, 'same': True}}
