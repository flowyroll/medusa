...
nop
dec %rcx
lea addresses_D_ht+0x1b105, %rcx
nop
nop
nop
nop
...
nop
inc %rbx
lea addresses_normal_ht+0x19d05, %rsi
lea addresses_D_ht+0x6105, %rdi
nop
nop
nop
sub $11605, %r8
...
rep movsl
add %rbx, %rbx
lea addresses_WC_ht+0x1bd05, %rsi
lea addresses_normal_ht+0x142bf, %rdi
nop
nop
nop
nop
...
nop
sub $9546, %rcx
lea addresses_A_ht+0x583f, %rsi
lea addresses_UC_ht+0x3e05, %rdi
clflush (%rsi)
nop
nop
inc %r8
...
// REPMOV
lea addresses_UC+0x7705, %rsi
lea addresses_D+0x1be45, %rdi
nop
nop
nop
nop
...
{'src': {'type': 'addresses_UC', 'congruent': 9, 'same': False}, 'OP': 'REPM', 'dst': {'type': 'addresses_D', 'congruent': 5, 'same': False}}
...
{'src': {'type': 'addresses_normal_ht', 'congruent': 7, 'same': False}, 'OP': 'REPM', 'dst': {'type': 'addresses_D_ht', 'congruent': 10, 'same': False}}
