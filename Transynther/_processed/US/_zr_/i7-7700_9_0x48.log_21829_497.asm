...
push %rdx
push %rsi
lea addresses_normal_ht+0x9e1c, %rsi
lea addresses_WT_ht+0x1170c, %rdi
nop
nop
nop
nop
...
nop
cmp $20641, %r10
lea addresses_WT_ht+0x12f0c, %rbx
nop
nop
nop
nop
...
nop
inc %r9
lea addresses_D_ht+0xdfbc, %rsi
nop
cmp %rdx, %rdx
movb (%rsi), %r10b
nop
sub $39459, %rsi
lea addresses_D_ht+0x19964, %rdi
nop
nop
nop
nop
...
lea addresses_normal_ht+0x540c, %rdi
nop
nop
cmp %r9, %r9
mov $104, %rcx
...
nop
sub $42225, %r9
lea addresses_UC_ht+0x16810, %rsi
lea addresses_WT_ht+0xd87c, %rdi
nop
nop
nop
nop
...
nop
inc %rdi
lea addresses_normal_ht+0xf3f4, %rsi
lea addresses_WC_ht+0x19d2c, %rdi
nop
nop
nop
xor %rdx, %rdx
...
rep movsw
dec %r10
lea addresses_UC_ht+0x14c1b, %rdx
nop
nop
nop
xor $48402, %r9
...
nop
xor $258, %r9
lea addresses_UC_ht+0x1bcc1, %r10
inc %rsi
mov (%r10), %rdx
nop
nop
...
{'OP': 'REPM', 'src': {'type': 'addresses_WT_ht', 'congruent': 11, 'same': False}, 'dst': {'type': 'addresses_normal_ht', 'congruent': 8, 'same': False}}
...
{'OP': 'STOR', 'dst': {'type': 'addresses_UC_ht', 'AVXalign': False, 'congruent': 0, 'size': 32, 'same': True, 'NT': True}}
