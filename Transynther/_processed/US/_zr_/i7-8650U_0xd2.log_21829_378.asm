...
nop
add %rcx, %rcx
lea addresses_UC_ht+0x123f4, %r12
nop
xor $51903, %rcx
movb $0x61, (%r12)
dec %rbp
lea addresses_D_ht+0x5fb4, %rcx
and $36734, %r10
mov (%rcx), %r12d
nop
nop
