...
nop
dec %rsi
lea addresses_UC_ht+0x1dcb2, %rsi
lea addresses_WC_ht+0x2e8c, %rdi
nop
nop
nop
nop
...
nop
dec %rdx
lea addresses_D_ht+0x1546d, %rdx
cmp %rax, %rax
...
lea addresses_A_ht+0x19192, %rdi
clflush (%rsi)
nop
nop
nop
...
nop
add %rsi, %rsi
lea addresses_WC_ht+0x5f1c, %rsi
lea addresses_A_ht+0x75bc, %rdi
nop
inc %r10
mov $52, %rcx
rep movsw
cmp %r9, %r9
lea addresses_UC_ht+0x681e, %rdi
nop
nop
nop
dec %r9
...
nop
dec %rdx
lea addresses_WT_ht+0x16612, %rsi
lea addresses_A_ht+0x10a1a, %rdi
xor %rax, %rax
mov $85, %rcx
rep movsw
nop
...
vpextrq $0, %xmm3, %rcx
xor %rsi, %rsi
lea addresses_WT_ht+0x6512, %rsi
lea addresses_UC_ht+0x121ae, %rdi
clflush (%rdi)
nop
nop
dec %r9
...
{'src': {'same': False, 'congruent': 5, 'type': 'addresses_UC_ht'}, 'OP': 'REPM', 'dst': {'same': False, 'congruent': 1, 'type': 'addresses_WC_ht'}}
...
{'src': {'same': False, 'congruent': 0, 'type': 'addresses_WC_ht'}, 'OP': 'REPM', 'dst': {'same': False, 'congruent': 1, 'type': 'addresses_A_ht'}}
...
{'src': {'same': False, 'congruent': 9, 'type': 'addresses_WT_ht'}, 'OP': 'REPM', 'dst': {'same': False, 'congruent': 2, 'type': 'addresses_A_ht'}}
...
{'src': {'same': False, 'congruent': 8, 'type': 'addresses_WT_ht'}, 'OP': 'REPM', 'dst': {'same': False, 'congruent': 2, 'type': 'addresses_UC_ht'}}
{'00': 21829}
