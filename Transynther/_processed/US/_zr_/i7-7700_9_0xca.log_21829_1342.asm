...
nop
sub $55330, %rdi
lea addresses_D_ht+0x1312a, %rsi
lea addresses_D_ht+0x9df6, %rdi
nop
nop
nop
add $41447, %r13
...
nop
sub %r9, %r9
lea addresses_normal_ht+0x131aa, %rsi
lea addresses_WT_ht+0x3cfa, %rdi
nop
nop
nop
nop
...
// Load
lea addresses_US+0x62ca, %r10
xor %rsi, %rsi
mov (%r10), %r9
xor %rsi, %rsi

// Load
lea addresses_UC+0x3ffa, %rax
nop
nop
nop
xor %r10, %r10
...
{'src': {'congruent': 11, 'same': False, 'type': 'addresses_D_ht'}, 'OP': 'REPM', 'dst': {'congruent': 2, 'same': False, 'type': 'addresses_D_ht'}}
{'src': {'congruent': 7, 'same': False, 'type': 'addresses_normal_ht'}, 'OP': 'REPM', 'dst': {'congruent': 4, 'same': False, 'type': 'addresses_WT_ht'}}
{'00': 21829}
