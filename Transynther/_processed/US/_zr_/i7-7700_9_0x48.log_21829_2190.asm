...
push %rdi
push %rsi
lea addresses_WT_ht+0x1d1cd, %rbp
clflush (%rbp)
nop
nop
nop
...
nop
and $21510, %rsi
lea addresses_WT_ht+0x1a35f, %r14
nop
nop
xor %r10, %r10
mov (%r14), %r12w
...
nop
sub %rsi, %rsi
lea addresses_WC_ht+0x9025, %rsi
lea addresses_UC_ht+0x1b4cd, %rdi
nop
mfence
mov $54, %rcx
rep movsb
lfence
lea addresses_D_ht+0x1017d, %rcx
add %r10, %r10
...
nop
and $39330, %r14
lea addresses_UC_ht+0xa04d, %r10
nop
add %r15, %r15
movl $0x61626364, (%r10)
nop
...
nop
inc %rsi
lea addresses_normal_ht+0x42e1, %rbp
nop
nop
nop
and %r14, %r14
...
nop
sub $56143, %r15
lea addresses_WC_ht+0x127bd, %r15
nop
nop
nop
nop
...
mov (%rdi), %ebp
mfence
lea addresses_A_ht+0x11dcd, %r15
nop
nop
sub $7726, %r14
mov (%r15), %bp
...
nop
xor %r15, %r15
lea addresses_UC_ht+0x25cd, %rsi
lea addresses_D_ht+0xa6fb, %rdi
nop
nop
nop
sub $47723, %r12
...
nop
sub %rbp, %rbp
lea addresses_A_ht+0x1974d, %rsi
lea addresses_A_ht+0xb1cd, %rdi
nop
nop
xor $12589, %r15
mov $100, %rcx
...
// Load
lea addresses_WC+0x148cd, %r14
and %r11, %r11
mov (%r14), %r12
add $62574, %r11

// Store
lea addresses_UC+0x31cd, %r13
clflush (%r13)
sub $60209, %rdx
movw $0x5152, (%r13)
nop
...
{'OP': 'LOAD', 'src': {'type': 'addresses_WC', 'AVXalign': False, 'congruent': 7, 'size': 8, 'same': False, 'NT': False}}
...
{'OP': 'STOR', 'dst': {'type': 'addresses_normal_ht', 'AVXalign': False, 'congruent': 2, 'size': 2, 'same': False, 'NT': True}}
...
{'OP': 'REPM', 'src': {'type': 'addresses_A_ht', 'congruent': 7, 'same': True}, 'dst': {'type': 'addresses_A_ht', 'congruent': 11, 'same': False}}
{'00': 21829}
