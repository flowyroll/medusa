...
nop
dec %r8
lea addresses_A_ht+0xd432, %rsi
lea addresses_UC_ht+0x465a, %rdi
cmp $61052, %rbp
mov $52, %rcx
rep movsq
nop
...
nop
add %r14, %r14
lea addresses_UC_ht+0x568a, %r14
inc %rsi
movb $0x61, (%r14)
nop
sub %rbp, %rbp
lea addresses_normal_ht+0x50da, %rsi
lea addresses_normal_ht+0x732a, %rdi
clflush (%rsi)
nop
nop
sub $5500, %r15
...
{'src': {'type': 'addresses_normal_ht', 'congruent': 0, 'same': False}, 'dst': {'type': 'addresses_normal_ht', 'congruent': 6, 'same': True}, 'OP': 'REPM'}
{'00': 21829}
