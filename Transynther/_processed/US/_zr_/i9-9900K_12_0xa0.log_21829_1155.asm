...
push %rdx
push %rsi
lea addresses_A_ht+0x1c3c8, %rsi
lea addresses_UC_ht+0x4fc8, %rdi
nop
nop
nop
nop
...
rep movsq
cmp %r10, %r10
lea addresses_WC_ht+0x1bcd8, %rdx
nop
nop
nop
add $5007, %r8
mov (%rdx), %ebp
cmp %r10, %r10
lea addresses_WT_ht+0x13a3b, %rbp
clflush (%rbp)
add $59289, %rsi
mov (%rbp), %cx
xor %rbp, %rbp
lea addresses_WC_ht+0x9148, %rsi
lea addresses_WT_ht+0x17cc8, %rdi
nop
nop
nop
nop
...
nop
and $63324, %r10
lea addresses_A_ht+0x189c8, %r15
nop
inc %rcx
mov (%r15), %r8
nop
...
nop
dec %r8
lea addresses_normal_ht+0x1cc50, %r8
nop
nop
add $31867, %r10
movups (%r8), %xmm2
...
nop
cmp $59711, %rsi
lea addresses_A_ht+0x116c8, %rdi
nop
nop
nop
nop
...
<gen_prepare_buffer>
{'src': {'same': False, 'congruent': 10, 'type': 'addresses_A_ht'}, 'OP': 'REPM', 'dst': {'same': False, 'congruent': 10, 'type': 'addresses_UC_ht'}}
