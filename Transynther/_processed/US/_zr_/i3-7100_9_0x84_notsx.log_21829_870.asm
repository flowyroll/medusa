...
nop
add $30191, %rbp
lea addresses_A_ht+0x65ec, %rsi
lea addresses_D_ht+0x92ec, %rdi
xor %rbx, %rbx
mov $123, %rcx
rep movsw
add $7371, %r13
lea addresses_WT_ht+0x1805c, %rdi
nop
nop
nop
nop
...
nop
sub $11672, %rbp
lea addresses_WC_ht+0x16f6c, %rbx
nop
nop
nop
nop
...
nop
add $36229, %rsi
lea addresses_D_ht+0x95ec, %rsi
lea addresses_normal_ht+0x1cbac, %rdi
nop
nop
nop
nop
...
nop
sub %rsi, %rsi
lea addresses_D_ht+0x18a6c, %rdi
nop
nop
and $4022, %rcx
movw $0x6162, (%rdi)
...
lea addresses_WC_ht+0xee2c, %rdi
nop
nop
nop
nop
...
nop
xor $42252, %rsi
lea addresses_A_ht+0x102ec, %rsi
lea addresses_normal_ht+0x3a6c, %rdi
nop
nop
sub $17038, %r13
mov $42, %rcx
...
{'src': {'type': 'addresses_normal_ht', 'congruent': 10, 'same': True}, 'dst': {'type': 'addresses_WC_ht', 'congruent': 6, 'same': False}, 'OP': 'REPM'}
{'src': {'type': 'addresses_A_ht', 'congruent': 4, 'same': False}, 'dst': {'type': 'addresses_normal_ht', 'congruent': 7, 'same': False}, 'OP': 'REPM'}
{'00': 21829}
