...
nop
and %rdx, %rdx
lea addresses_UC_ht+0x18fa6, %r12
nop
nop
nop
nop
...
nop
cmp $18491, %rdi
lea addresses_normal_ht+0x17d0e, %r11
nop
nop
nop
nop
...
nop
xor $17888, %rdi
lea addresses_WC_ht+0x7e56, %rdi
nop
nop
nop
nop
...
movb (%rdi), %dl
dec %rsi
lea addresses_normal_ht+0x30c4, %rsi
xor %rbp, %rbp
mov $0x6162636465666768, %r9
movq %r9, %xmm0
movups %xmm0, (%rsi)
nop
cmp $57780, %r12
lea addresses_A_ht+0xc2d2, %rsi
lea addresses_UC_ht+0x15d8e, %rdi
nop
add %r12, %r12
mov $106, %rcx
rep movsl
sub $28628, %rdi
lea addresses_normal_ht+0x1650e, %rsi
lea addresses_normal_ht+0xa80e, %rdi
nop
nop
nop
nop
...
rep movsb
and %r9, %r9
lea addresses_normal_ht+0x76de, %rsi
lea addresses_WC_ht+0x1cd1e, %rdi
nop
sub $52534, %rbp
mov $97, %rcx
rep movsl
nop
sub $31809, %r11
lea addresses_A_ht+0x1c24c, %r12
nop
nop
nop
nop
...
nop
and %r9, %r9
lea addresses_D_ht+0x1420e, %rsi
lea addresses_WC_ht+0x18d06, %rdi
nop
sub $34065, %r9
mov $86, %rcx
rep movsb
...
nop
dec %rcx
lea addresses_A_ht+0x11aae, %r11
nop
nop
dec %rsi
movl $0x61626364, (%r11)
...
{'src': {'type': 'addresses_D_ht', 'AVXalign': False, 'size': 8, 'NT': False, 'same': True, 'congruent': 7}, 'OP': 'LOAD'}
...
{'src': {'type': 'addresses_WC_ht', 'AVXalign': False, 'size': 1, 'NT': True, 'same': True, 'congruent': 2}, 'OP': 'LOAD'}
