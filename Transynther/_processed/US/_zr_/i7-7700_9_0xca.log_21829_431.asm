...
push %rdi
push %rsi
lea addresses_normal_ht+0x666f, %rsi
lea addresses_WC_ht+0x17c6f, %rdi
nop
nop
nop
nop
...
nop
inc %r15
lea addresses_UC_ht+0x9349, %rbp
nop
nop
nop
nop
...
nop
and $31433, %rbp
lea addresses_WT_ht+0x1306f, %rbx
nop
nop
dec %rdi
movl $0x61626364, (%rbx)
...
<gen_prepare_buffer>
{'src': {'congruent': 9, 'same': False, 'type': 'addresses_normal_ht'}, 'OP': 'REPM', 'dst': {'congruent': 9, 'same': False, 'type': 'addresses_WC_ht'}}
