...
push %rdi
push %rsi
lea addresses_UC_ht+0x2594, %r12
xor $911, %rax
...
nop
and $31725, %r14
lea addresses_A_ht+0x10b4, %rsi
lea addresses_WC_ht+0x37b4, %rdi
nop
nop
nop
nop
...
nop
and $52611, %rsi
lea addresses_WT_ht+0x173f4, %r14
nop
nop
nop
nop
...
vpextrq $0, %xmm5, %rsi
sub $41717, %r14
lea addresses_WT_ht+0x11034, %r14
nop
add $6313, %r12
movl $0x61626364, (%r14)
nop
nop
dec %r14
lea addresses_A_ht+0x15724, %rsi
lea addresses_normal_ht+0x8734, %rdi
nop
nop
nop
nop
...
rep movsb
sub %rcx, %rcx
lea addresses_normal_ht+0x7c14, %rdi
nop
nop
nop
nop
...
{'OP': 'STOR', 'dst': {'NT': False, 'same': False, 'congruent': 7, 'type': 'addresses_WT_ht', 'AVXalign': True, 'size': 4}}
{'src': {'same': False, 'congruent': 4, 'type': 'addresses_A_ht'}, 'OP': 'REPM', 'dst': {'same': False, 'congruent': 7, 'type': 'addresses_normal_ht'}}
