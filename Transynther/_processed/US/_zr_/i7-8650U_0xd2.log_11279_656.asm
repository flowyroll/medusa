...
push %rdi
push %rsi
lea addresses_D_ht+0x1772c, %rsi
lea addresses_UC_ht+0x9942, %rdi
nop
nop
nop
nop
...
nop
dec %r15
lea addresses_normal_ht+0xc20c, %r8
and %r15, %r15
...
nop
cmp %rbx, %rbx
lea addresses_normal_ht+0x1540c, %rsi
lea addresses_A_ht+0x26c6, %rdi
nop
nop
xor %r11, %r11
mov $23, %rcx
...
nop
cmp %rax, %rax
lea addresses_WC_ht+0x1ffc, %r15
nop
cmp $21704, %rcx
mov (%r15), %esi
nop
and $43418, %rbx
lea addresses_A_ht+0x1d7ec, %rcx
nop
nop
nop
sub %rax, %rax
...
nop
inc %r11
lea addresses_WT_ht+0x17f0e, %r11
clflush (%r11)
nop
add $59484, %rbx
mov (%r11), %rax
