...
push %rdi
push %rsi
lea addresses_normal_ht+0xbb83, %rsi
lea addresses_WC_ht+0x6b03, %rdi
nop
nop
nop
nop
...
<gen_prepare_buffer>
{'src': {'type': 'addresses_normal_ht', 'congruent': 7, 'same': False}, 'dst': {'type': 'addresses_WC_ht', 'congruent': 9, 'same': True}, 'OP': 'REPM'}
{'00': 21829}
