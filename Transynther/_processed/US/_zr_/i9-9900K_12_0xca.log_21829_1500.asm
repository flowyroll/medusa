...
nop
and $3375, %rcx
lea addresses_WC_ht+0xc873, %r11
nop
nop
nop
nop
...
vmovups %ymm1, (%r11)
add $18217, %rsi
lea addresses_UC_ht+0x18193, %rsi
lea addresses_UC_ht+0x1e3bc, %rdi
nop
nop
nop
nop
...
nop
cmp $54281, %rdx
lea addresses_D_ht+0x13d1f, %rcx
nop
nop
nop
xor $34618, %rsi
...
// Store
lea addresses_normal+0xd5f3, %rdi
nop
nop
nop
nop
...
// Store
lea addresses_normal+0x1c4f3, %r8
nop
nop
nop
cmp $30737, %rax
...
{'OP': 'LOAD', 'src': {'size': 16, 'NT': False, 'type': 'addresses_D', 'same': False, 'AVXalign': False, 'congruent': 10}}
{'OP': 'STOR', 'dst': {'size': 1, 'NT': False, 'type': 'addresses_normal', 'same': False, 'AVXalign': False, 'congruent': 5}}
{'OP': 'STOR', 'dst': {'size': 1, 'NT': False, 'type': 'addresses_P', 'same': False, 'AVXalign': False, 'congruent': 8}}
...
<gen_prepare_buffer>
{'OP': 'REPM', 'src': {'same': False, 'type': 'addresses_WT_ht', 'congruent': 9}, 'dst': {'same': True, 'type': 'addresses_WC_ht', 'congruent': 9}}
{'OP': 'REPM', 'src': {'same': True, 'type': 'addresses_WT_ht', 'congruent': 8}, 'dst': {'same': False, 'type': 'addresses_A_ht', 'congruent': 11}}
