...
lea addresses_normal_ht+0xb7ab, %rdi
nop
nop
add %r9, %r9
mov $74, %rcx
rep movsb
xor %rsi, %rsi
lea addresses_WC_ht+0xe303, %rdi
nop
inc %r14
...
nop
inc %rsi
lea addresses_UC_ht+0xe74b, %rsi
nop
nop
nop
add $51829, %r13
...
nop
add $41545, %rdi
lea addresses_normal_ht+0xdbeb, %rsi
lea addresses_A_ht+0x12c4b, %rdi
nop
and $37263, %rbp
mov $77, %rcx
rep movsw
