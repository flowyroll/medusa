...
push %rdi
push %rsi
lea addresses_normal_ht+0xf515, %rsi
lea addresses_A_ht+0xbd96, %rdi
inc %r14
mov $99, %rcx
rep movsw
nop
...
nop
inc %rdi
lea addresses_A_ht+0x13739, %rbx
nop
nop
nop
nop
...
nop
and $30728, %rbp
lea addresses_UC_ht+0x1de15, %rsi
nop
nop
nop
nop
...
nop
inc %rsi
lea addresses_normal_ht+0x1d97b, %rcx
nop
xor %r10, %r10
movl $0x61626364, (%rcx)
nop
...
nop
sub $52849, %rbx
lea addresses_WT_ht+0x2315, %rsi
lea addresses_UC_ht+0x1455, %rdi
nop
xor %r13, %r13
mov $77, %rcx
rep movsl
...
nop
cmp $34173, %rsi
lea addresses_WC_ht+0x73bd, %r13
nop
dec %rdi
mov (%r13), %rbp
nop
nop
xor %rcx, %rcx
lea addresses_WT_ht+0xa215, %rdi
nop
nop
nop
nop
...
nop
sub $12063, %rbp
lea addresses_normal_ht+0x1d515, %r10
nop
nop
nop
xor %r14, %r14
...
nop
and $54259, %r10
lea addresses_WT_ht+0x6765, %rsi
lea addresses_D_ht+0x87a9, %rdi
nop
nop
nop
xor $41714, %rbx
...
nop
sub %r14, %r14
lea addresses_WC_ht+0x1b1b1, %r13
clflush (%r13)
nop
nop
nop
...
{'OP': 'STOR', 'dst': {'type': 'addresses_NC', 'AVXalign': False, 'size': 16, 'NT': False, 'same': False, 'congruent': 2}}
