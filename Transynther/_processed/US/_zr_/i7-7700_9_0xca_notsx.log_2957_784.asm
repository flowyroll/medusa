...
// REPMOV
lea addresses_PSE+0x15d2d, %rsi
lea addresses_UC+0x1c921, %rdi
nop
nop
nop
nop
...
// REPMOV
lea addresses_US+0xbde1, %rsi
lea addresses_normal+0x1cfe1, %rdi
nop
nop
nop
nop
...
// Store
lea addresses_normal+0xacf3, %r10
nop
add $61846, %rbp
...
{'src': {'congruent': 2, 'same': False, 'type': 'addresses_PSE'}, 'dst': {'congruent': 4, 'same': False, 'type': 'addresses_UC'}, 'OP': 'REPM'}
{'dst': {'NT': False, 'AVXalign': False, 'size': 2, 'congruent': 11, 'same': False, 'type': 'addresses_P'}, 'OP': 'STOR'}
{'src': {'congruent': 0, 'same': True, 'type': 'addresses_US'}, 'dst': {'congruent': 9, 'same': False, 'type': 'addresses_normal'}, 'OP': 'REPM'}
