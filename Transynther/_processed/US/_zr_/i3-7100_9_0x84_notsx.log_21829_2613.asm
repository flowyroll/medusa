...
nop
and %rcx, %rcx
lea addresses_WC_ht+0x1c7ff, %rcx
nop
nop
nop
nop
...
nop
sub $47711, %rsi
lea addresses_WT_ht+0x17d4f, %rcx
nop
nop
nop
nop
...
movw $0x6162, (%rcx)
sub $23007, %r15
lea addresses_UC_ht+0x618f, %r15
nop
nop
cmp %r13, %r13
...
nop
sub $62547, %r15
lea addresses_UC_ht+0x1704f, %rdi
clflush (%rdi)
nop
nop
nop
...
nop
xor %rax, %rax
lea addresses_A_ht+0x15c47, %r14
nop
nop
nop
inc %r13
...
lea addresses_D_ht+0x1cd8f, %rdi
and %rbx, %rbx
mov $8, %rcx
rep movsq
and $26185, %rdi
...
{'src': {'type': 'addresses_UC_ht', 'same': False, 'size': 32, 'congruent': 6, 'NT': True, 'AVXalign': False}, 'OP': 'LOAD'}
...
{'dst': {'type': 'addresses_A_ht', 'same': False, 'size': 8, 'congruent': 1, 'NT': False, 'AVXalign': True}, 'OP': 'STOR'}
{'00': 21829}
