...
nop
sub %rdx, %rdx
lea addresses_UC_ht+0x14c11, %rsi
lea addresses_UC_ht+0x7c11, %rdi
nop
nop
nop
nop
...
nop
and %rcx, %rcx
lea addresses_WC_ht+0xb491, %rbp
add %rdx, %rdx
movl $0x61626364, (%rbp)
nop
nop
...
nop
sub $17131, %rdi
lea addresses_D_ht+0x1cc11, %rbp
xor $30929, %rsi
mov (%rbp), %bx
xor $848, %rbx
lea addresses_A_ht+0x5411, %r12
xor %rbp, %rbp
mov (%r12), %ebx
nop
nop
...
nop
and %rbp, %rbp
lea addresses_normal_ht+0x122d1, %r13
nop
nop
nop
sub %rcx, %rcx
...
nop
cmp %rcx, %rcx
lea addresses_D_ht+0x6211, %rsi
lea addresses_WT_ht+0x13411, %rdi
nop
nop
nop
cmp %rdx, %rdx
...
nop
cmp $60289, %rbx
lea addresses_WC_ht+0x1b205, %rsi
lea addresses_WT_ht+0xb811, %rdi
and %rbx, %rbx
mov $100, %rcx
rep movsq
nop
...
<gen_prepare_buffer>
{'OP': 'LOAD', 'src': {'type': 'addresses_D_ht', 'size': 1, 'AVXalign': True, 'NT': False, 'congruent': 9, 'same': True}}
