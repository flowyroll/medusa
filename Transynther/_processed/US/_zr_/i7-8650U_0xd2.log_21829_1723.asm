...
push %rdi
push %rsi
lea addresses_UC_ht+0x1ca40, %rsi
lea addresses_WC_ht+0x1972c, %rdi
clflush (%rdi)
nop
nop
nop
...
lea addresses_WC_ht+0x872c, %rdi
nop
nop
nop
inc %rbx
...
nop
inc %r9
lea addresses_UC_ht+0x14aac, %rbx
cmp $5070, %r14
movw $0x6162, (%rbx)
nop
nop
...
nop
xor %rbx, %rbx
lea addresses_normal_ht+0x1cf4, %rsi
lea addresses_D_ht+0x14c0c, %rdi
nop
nop
nop
nop
...
{'OP': 'STOR', 'dst': {'type': 'addresses_UC_ht', 'size': 2, 'AVXalign': False, 'NT': True, 'congruent': 5, 'same': False}}
{'OP': 'REPM', 'src': {'type': 'addresses_normal_ht', 'congruent': 2, 'same': False}, 'dst': {'type': 'addresses_D_ht', 'congruent': 2, 'same': True}}
{'00': 21829}
