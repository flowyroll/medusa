...
push %rdi
push %rsi
lea addresses_UC_ht+0xe3a1, %rbx
nop
add $12202, %r9
...
nop
add %rsi, %rsi
lea addresses_WC_ht+0x16239, %rsi
lea addresses_WT_ht+0x1551, %rdi
clflush (%rdi)
nop
nop
cmp $46258, %r15
...
rep movsl
xor $56111, %rdi
lea addresses_normal_ht+0x154c1, %r15
nop
add $43978, %r12
...
nop
add $55680, %rbx
lea addresses_WT_ht+0x14941, %rbx
nop
nop
cmp $59170, %r12
movw $0x6162, (%rbx)
...
nop
sub %rdi, %rdi
lea addresses_A_ht+0x12089, %rsi
lea addresses_UC_ht+0x15f41, %rdi
add %r10, %r10
mov $64, %rcx
rep movsw
nop
...
nop
xor $65475, %rcx
lea addresses_WC_ht+0x19341, %r12
nop
cmp %r15, %r15
mov (%r12), %rcx
nop
...
lea addresses_D_ht+0x15f0b, %rdi
nop
nop
nop
nop
...
movw $0x6162, (%rsi)
sub $51194, %r9
lea addresses_normal_ht+0x3a41, %rsi
nop
nop
and $54670, %r10
mov (%rsi), %cx
...
nop
xor $50875, %r10
lea addresses_normal_ht+0x14341, %rsi
lea addresses_UC_ht+0x8741, %rdi
nop
nop
nop
nop
...
nop
xor %r12, %r12
lea addresses_A_ht+0x12c1, %rsi
lea addresses_normal_ht+0xa6c1, %rdi
clflush (%rsi)
nop
nop
nop
...
{'OP': 'LOAD', 'src': {'type': 'addresses_UC', 'size': 4, 'AVXalign': False, 'NT': False, 'congruent': 8, 'same': False}}
...
<gen_prepare_buffer>
{'OP': 'LOAD', 'src': {'type': 'addresses_UC_ht', 'size': 32, 'AVXalign': True, 'NT': False, 'congruent': 3, 'same': False}}
...
{'OP': 'STOR', 'dst': {'type': 'addresses_WT_ht', 'size': 2, 'AVXalign': False, 'NT': False, 'congruent': 9, 'same': True}}
