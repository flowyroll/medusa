...
nop
sub %rdi, %rdi
lea addresses_A_ht+0x1c3cc, %r10
nop
cmp %rcx, %rcx
mov (%r10), %dx
nop
...
nop
xor $25949, %rdx
lea addresses_D_ht+0xe58c, %rdi
inc %rdx
movl $0x61626364, (%rdi)
nop
cmp $15211, %rdx
lea addresses_A_ht+0x16e8c, %rdi
nop
nop
inc %r11
...
nop
dec %rdx
lea addresses_UC_ht+0x1718c, %rsi
lea addresses_UC_ht+0x64cc, %rdi
clflush (%rdi)
nop
nop
add $41826, %rbx
...
{'OP': 'STOR', 'dst': {'type': 'addresses_D', 'size': 2, 'AVXalign': False, 'NT': True, 'congruent': 0, 'same': False}}
