...
lea addresses_WT_ht+0x8c70, %rdi
clflush (%rsi)
nop
cmp %r9, %r9
mov $79, %rcx
...
nop
dec %r11
lea addresses_normal_ht+0x19b0, %rbx
nop
dec %r15
movw $0x6162, (%rbx)
nop
nop
and %r9, %r9
lea addresses_normal_ht+0xd790, %rdi
nop
sub $11044, %rbx
vmovups (%rdi), %ymm1
...
movntdq %xmm5, (%rbx)
sub %r15, %r15
lea addresses_UC_ht+0x566a, %rsi
lea addresses_WC_ht+0x10404, %rdi
nop
nop
nop
dec %r12
...
nop
add %rdi, %rdi
lea addresses_normal_ht+0x1e770, %rsi
lea addresses_WC_ht+0x4b70, %rdi
nop
nop
cmp $56520, %r12
mov $2, %rcx
...
nop
sub %r15, %r15
lea addresses_UC_ht+0xba3c, %rcx
nop
nop
xor $47234, %r15
movl $0x61626364, (%rcx)
sub %r9, %r9
lea addresses_normal_ht+0xcf70, %rdi
sub %rbx, %rbx
...
nop
sub $4332, %r12
lea addresses_WT_ht+0x3750, %r15
nop
sub %rcx, %rcx
...
{'OP': 'STOR', 'dst': {'congruent': 1, 'AVXalign': False, 'same': True, 'size': 2, 'NT': False, 'type': 'addresses_normal_ht'}}
...
{'OP': 'STOR', 'dst': {'congruent': 4, 'AVXalign': False, 'same': False, 'size': 16, 'NT': True, 'type': 'addresses_A_ht'}}
{'src': {'congruent': 0, 'same': False, 'type': 'addresses_UC_ht'}, 'OP': 'REPM', 'dst': {'congruent': 2, 'same': False, 'type': 'addresses_WC_ht'}}
{'src': {'congruent': 7, 'same': True, 'type': 'addresses_normal_ht'}, 'OP': 'REPM', 'dst': {'congruent': 6, 'same': False, 'type': 'addresses_WC_ht'}}
