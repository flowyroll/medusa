...
push %rdi
push %rsi
lea addresses_WC_ht+0x18520, %rsi
lea addresses_UC_ht+0x1c5dc, %rdi
nop
dec %r13
mov $69, %rcx
rep movsw
...
lea addresses_WC_ht+0x186dc, %rdi
nop
nop
nop
nop
...
// Store
lea addresses_WT+0xcb1c, %rax
add $6119, %rdi
movb $0x51, (%rax)
sub $42763, %rax

// Store
lea addresses_US+0x12dc, %r14
nop
nop
cmp %r10, %r10
movl $0x51525354, (%r14)
...
<gen_prepare_buffer>
{'OP': 'REPM', 'src': {'type': 'addresses_WC_ht', 'congruent': 2, 'same': True}, 'dst': {'type': 'addresses_UC_ht', 'congruent': 11, 'same': False}}
