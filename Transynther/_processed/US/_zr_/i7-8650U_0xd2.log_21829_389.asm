...
push %rdi
push %rsi
lea addresses_WC_ht+0x1dce5, %rsi
lea addresses_A_ht+0x1bce5, %rdi
clflush (%rdi)
nop
nop
nop
...
nop
inc %r14
lea addresses_WC_ht+0x439f, %r10
nop
nop
nop
nop
...
nop
dec %rbp
lea addresses_normal_ht+0x146f5, %r10
and %rsi, %rsi
...
nop
xor %rdi, %rdi
lea addresses_D_ht+0x188a5, %r10
nop
nop
nop
nop
...
nop
sub $41347, %rcx
lea addresses_WC_ht+0x1ce5, %rsi
lea addresses_UC_ht+0x160e5, %rdi
nop
nop
nop
nop
...
nop
cmp %r12, %r12
lea addresses_normal_ht+0x1b2e5, %r12
clflush (%r12)
and $56929, %r10
...
movups %xmm7, (%r12)
dec %rbp
lea addresses_normal_ht+0xf4e5, %rsi
lea addresses_D_ht+0x1ee05, %rdi
clflush (%rsi)
nop
nop
nop
...
<gen_prepare_buffer>
{'OP': 'REPM', 'src': {'type': 'addresses_WC_ht', 'congruent': 10, 'same': False}, 'dst': {'type': 'addresses_A_ht', 'congruent': 10, 'same': False}}
