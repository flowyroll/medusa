...
push %rdi
push %rsi
lea addresses_UC_ht+0x481f, %rsi
lea addresses_normal_ht+0x1632f, %rdi
nop
inc %r10
mov $39, %rcx
rep movsb
...
nop
xor %r11, %r11
lea addresses_normal_ht+0x21f, %rsi
...
nop
add %rbp, %rbp
lea addresses_WT_ht+0x1c11f, %rsi
nop
sub $52216, %r15
movb $0x61, (%rsi)
nop
...
mov (%rdi), %r11d
add $56340, %r11
lea addresses_normal_ht+0x173f7, %r15
nop
nop
nop
nop
...
<gen_prepare_buffer>
{'OP': 'REPM', 'src': {'type': 'addresses_UC_ht', 'congruent': 7, 'same': False}, 'dst': {'type': 'addresses_normal_ht', 'congruent': 3, 'same': False}}
