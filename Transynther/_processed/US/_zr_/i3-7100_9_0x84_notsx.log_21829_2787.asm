...
push %rdi
push %rsi
lea addresses_D_ht+0x15238, %r11
nop
nop
nop
nop
...
nop
cmp %r11, %r11
lea addresses_WC_ht+0xf7de, %rsi
lea addresses_WC_ht+0xbe8c, %rdi
clflush (%rsi)
nop
nop
dec %r14
...
nop
cmp $26385, %r15
lea addresses_UC_ht+0xda1e, %r14
nop
nop
nop
sub %r11, %r11
...
nop
add $51172, %r14
lea addresses_UC_ht+0x16bde, %rax
nop
sub %r8, %r8
...
nop
xor $17533, %r14
lea addresses_D_ht+0x11b0e, %r11
clflush (%r11)
nop
nop
add $57044, %rax
...
nop
add %rcx, %rcx
lea addresses_UC_ht+0x1aafe, %rsi
nop
nop
nop
nop
...
// REPMOV
lea addresses_WC+0x1cfde, %rsi
lea addresses_WT+0x1c19e, %rdi
clflush (%rdi)
nop
nop
nop
...
{'src': {'type': 'addresses_WC', 'congruent': 7, 'same': False}, 'dst': {'type': 'addresses_WT', 'congruent': 6, 'same': False}, 'OP': 'REPM'}
...
{'src': {'type': 'addresses_WC_ht', 'congruent': 10, 'same': True}, 'dst': {'type': 'addresses_WC_ht', 'congruent': 1, 'same': True}, 'OP': 'REPM'}
...
{'src': {'type': 'addresses_D_ht', 'same': False, 'size': 1, 'congruent': 3, 'NT': False, 'AVXalign': True}, 'OP': 'LOAD'}
