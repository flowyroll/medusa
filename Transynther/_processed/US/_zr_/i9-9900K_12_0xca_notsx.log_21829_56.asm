...
push %rdx
push %rsi
lea addresses_UC_ht+0x1707d, %rsi
lea addresses_UC_ht+0x13d5d, %rdi
nop
nop
nop
nop
...
nop
add $54509, %r8
lea addresses_WT_ht+0x18d3, %r11
nop
nop
nop
nop
...
nop
and %r13, %r13
lea addresses_D_ht+0x5f5d, %rsi
lea addresses_UC_ht+0x15567, %rdi
clflush (%rsi)
nop
nop
nop
...
<gen_prepare_buffer>
{'OP': 'REPM', 'src': {'same': False, 'congruent': 4, 'type': 'addresses_UC_ht'}, 'dst': {'same': True, 'congruent': 8, 'type': 'addresses_UC_ht'}}
