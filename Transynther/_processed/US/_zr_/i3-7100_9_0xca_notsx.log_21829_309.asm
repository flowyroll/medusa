...
// Store
lea addresses_normal+0x147b6, %r13
nop
dec %r10
movl $0x51525354, (%r13)
nop
...
// Store
lea addresses_normal+0xd5b6, %rcx
nop
nop
nop
nop
...
<gen_prepare_buffer>
{'src': {'type': 'addresses_normal_ht', 'congruent': 6, 'same': False}, 'OP': 'REPM', 'dst': {'type': 'addresses_A_ht', 'congruent': 11, 'same': False}}
