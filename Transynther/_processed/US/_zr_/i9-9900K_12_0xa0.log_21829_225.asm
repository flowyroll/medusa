...
nop
inc %r9
lea addresses_WC_ht+0xee7c, %rsi
...
nop
cmp %rsi, %rsi
lea addresses_WT_ht+0x1595c, %rsi
lea addresses_WC_ht+0x1355c, %rdi
nop
inc %rbp
mov $52, %rcx
rep movsl
...
nop
xor $53101, %r11
lea addresses_WC_ht+0x1d05c, %rdi
nop
xor %r9, %r9
mov (%rdi), %rsi
nop
...
nop
inc %rcx
lea addresses_UC_ht+0x16d5c, %rax
clflush (%rax)
nop
nop
nop
...
nop
sub $30815, %rsi
lea addresses_normal_ht+0x1aeec, %r15
nop
nop
nop
nop
