...
nop
sub $4350, %r14
lea addresses_WC_ht+0xad92, %rax
nop
nop
nop
nop
...
nop
dec %rsi
lea addresses_WT_ht+0x5d12, %r11
nop
nop
and $60930, %r13
mov (%r11), %r14d
...
nop
sub $10781, %rsi
lea addresses_UC_ht+0xe712, %rsi
...
nop
add %r13, %r13
lea addresses_UC_ht+0x14f12, %rsi
...
nop
cmp %rdi, %rdi
lea addresses_WC_ht+0xc0be, %rcx
nop
nop
nop
nop
...
nop
add %rsi, %rsi
lea addresses_WC_ht+0xde52, %rsi
lea addresses_D_ht+0x102c2, %rdi
nop
nop
inc %r14
mov $54, %rcx
...
nop
dec %rsi
lea addresses_normal_ht+0x157da, %r8
nop
nop
nop
nop
...
{'OP': 'REPM', 'src': {'type': 'addresses_UC_ht', 'congruent': 8, 'same': False}, 'dst': {'type': 'addresses_D_ht', 'congruent': 3, 'same': False}}
