...
mov (%r12), %r11
xor $5991, %rdx
lea addresses_normal_ht+0xaf8c, %rdx
clflush (%rdx)
nop
nop
dec %rdi
...
nop
sub %r12, %r12
lea addresses_UC_ht+0x324e, %rsi
lea addresses_A_ht+0x1c45c, %rdi
nop
nop
nop
xor %r12, %r12
...
rep movsq
dec %rsi
lea addresses_UC_ht+0x21c, %rsi
lea addresses_normal_ht+0xae35, %rdi
nop
nop
nop
nop
...
nop
sub $42181, %r11
lea addresses_WC_ht+0x2500, %r12
nop
nop
dec %rdx
vmovups (%r12), %ymm1
...
nop
sub %r12, %r12
lea addresses_A_ht+0x1255c, %rsi
lea addresses_A_ht+0x1755c, %rdi
nop
nop
and $45227, %rbp
mov $8, %rcx
...
nop
inc %rsi
lea addresses_UC_ht+0x172ec, %rsi
nop
nop
nop
inc %rbp
