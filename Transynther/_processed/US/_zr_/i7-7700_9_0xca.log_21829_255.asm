...
nop
xor %r12, %r12
lea addresses_D_ht+0x189b6, %rcx
add %r8, %r8
...
nop
xor $34343, %rax
lea addresses_WC_ht+0x163b6, %rsi
lea addresses_D_ht+0x135b6, %rdi
nop
sub %r14, %r14
mov $36, %rcx
rep movsb
...
nop
xor $5866, %rdi
lea addresses_normal_ht+0x2db6, %rsi
nop
nop
nop
nop
...
nop
and $27273, %r8
lea addresses_WT_ht+0x37b6, %rsi
...
nop
add %rcx, %rcx
lea addresses_WC_ht+0x56e6, %r13
nop
nop
add %rsi, %rsi
movb (%r13), %r14b
...
{'OP': 'STOR', 'dst': {'congruent': 11, 'AVXalign': True, 'same': False, 'size': 16, 'NT': False, 'type': 'addresses_D_ht'}}
{'src': {'congruent': 9, 'same': True, 'type': 'addresses_WC_ht'}, 'OP': 'REPM', 'dst': {'congruent': 9, 'same': False, 'type': 'addresses_D_ht'}}
{'OP': 'STOR', 'dst': {'congruent': 10, 'AVXalign': False, 'same': False, 'size': 4, 'NT': False, 'type': 'addresses_normal_ht'}}
{'src': {'congruent': 8, 'same': True, 'type': 'addresses_WT_ht'}, 'OP': 'REPM', 'dst': {'congruent': 2, 'same': False, 'type': 'addresses_WC_ht'}}
