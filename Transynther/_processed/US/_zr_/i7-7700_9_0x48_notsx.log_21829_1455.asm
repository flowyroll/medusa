...
nop
cmp %rax, %rax
lea addresses_UC_ht+0x6481, %r10
nop
nop
nop
add $45701, %rdx
...
nop
and $10328, %rax
lea addresses_WC_ht+0x1a3f1, %rdx
nop
nop
sub %rsi, %rsi
mov (%rdx), %r13w
...
{'dst': {'same': False, 'NT': True, 'AVXalign': False, 'size': 1, 'type': 'addresses_P', 'congruent': 3}, 'OP': 'STOR'}
...
{'OP': 'LOAD', 'src': {'same': False, 'NT': False, 'AVXalign': True, 'size': 2, 'type': 'addresses_WC_ht', 'congruent': 4}}
{'00': 21829}
