...
nop
sub %r15, %r15
lea addresses_WT_ht+0x16093, %r9
nop
nop
nop
dec %rbp
...
nop
xor $62658, %r9
lea addresses_normal_ht+0x1e2d8, %r15
nop
add %r11, %r11
movw $0x6162, (%r15)
nop
...
nop
add %r11, %r11
lea addresses_D_ht+0x1448b, %r13
nop
nop
nop
inc %r9
...
{'src': {'congruent': 8, 'AVXalign': False, 'same': False, 'size': 1, 'NT': False, 'type': 'addresses_P'}, 'OP': 'LOAD'}
...
{'src': {'congruent': 2, 'AVXalign': True, 'same': True, 'size': 32, 'NT': False, 'type': 'addresses_D_ht'}, 'OP': 'LOAD'}
{'00': 21829}
