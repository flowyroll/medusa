...
nop
add $25863, %r11
lea addresses_UC_ht+0x7e00, %rsi
lea addresses_UC_ht+0x11c00, %rdi
sub %rdx, %rdx
mov $94, %rcx
rep movsq
nop
inc %rdi
lea addresses_WT_ht+0x11c00, %rsi
lea addresses_D_ht+0x11100, %rdi
and %r11, %r11
mov $107, %rcx
rep movsl
xor $56072, %rdi
lea addresses_D_ht+0x1292c, %rdi
clflush (%rdi)
nop
nop
and %rcx, %rcx
...
nop
xor $49909, %rcx
lea addresses_WC_ht+0x16f9b, %rdi
nop
and $64628, %rbp
mov (%rdi), %r11d
nop
inc %r11
lea addresses_D_ht+0x15c0, %rsi
lea addresses_D_ht+0x10900, %rdi
nop
nop
nop
nop
...
{'OP': 'LOAD', 'src': {'type': 'addresses_P', 'size': 16, 'AVXalign': False, 'NT': False, 'congruent': 6, 'same': False}}
{'OP': 'STOR', 'dst': {'type': 'addresses_UC', 'size': 1, 'AVXalign': True, 'NT': True, 'congruent': 11, 'same': False}}
