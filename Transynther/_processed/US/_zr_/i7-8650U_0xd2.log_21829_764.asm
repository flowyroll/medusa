...
rep movsw
xor $50580, %rdi
lea addresses_UC_ht+0x4ec4, %rax
nop
nop
nop
xor $65175, %r15
...
nop
inc %r14
lea addresses_normal_ht+0x10724, %rsi
...
nop
add %r14, %r14
lea addresses_WC_ht+0x14c24, %rdi
nop
nop
cmp $52602, %r15
...
nop
cmp %rcx, %rcx
lea addresses_WT_ht+0xcb44, %r15
nop
nop
nop
nop
...
nop
cmp %r13, %r13
lea addresses_WT_ht+0xcb24, %r15
dec %rdi
mov $0x6162636465666768, %rsi
movq %rsi, %xmm6
vmovups %ymm6, (%r15)
...
nop
dec %rsi
lea addresses_WT_ht+0x9e64, %rcx
clflush (%rcx)
nop
nop
add $25557, %r14
...
nop
and $53226, %rsi
lea addresses_WT_ht+0x15f0c, %rsi
lea addresses_D_ht+0xa794, %rdi
nop
nop
nop
nop
...
nop
cmp %rsi, %rsi
lea addresses_WT_ht+0x5474, %rsi
lea addresses_A_ht+0xfab8, %rdi
nop
nop
sub $57701, %rax
mov $102, %rcx
...
nop
and $50569, %r9
lea addresses_UC_ht+0xa94c, %r15
cmp %r9, %r9
movb (%r15), %r13b
nop
nop
...
{'OP': 'LOAD', 'src': {'type': 'addresses_NC', 'size': 32, 'AVXalign': True, 'NT': False, 'congruent': 1, 'same': False}}
...
{'OP': 'REPM', 'src': {'type': 'addresses_WT_ht', 'congruent': 2, 'same': False}, 'dst': {'type': 'addresses_D_ht', 'congruent': 4, 'same': True}}
