...
push %rdi
push %rsi
lea addresses_normal_ht+0x311, %r13
nop
nop
nop
nop
...
nop
add %r11, %r11
lea addresses_UC_ht+0x5f11, %rsi
nop
nop
nop
cmp $19803, %rdi
...
lea addresses_UC_ht+0x46e9, %rdi
nop
nop
nop
cmp $29928, %r13
...
vpextrq $1, %xmm2, %rbp
sub $29303, %r13
lea addresses_UC_ht+0x1d471, %rsi
lea addresses_WC_ht+0x1ce79, %rdi
nop
nop
nop
nop
...
nop
inc %r13
lea addresses_normal_ht+0x3311, %rsi
lea addresses_WC_ht+0xd4b9, %rdi
nop
nop
nop
dec %r11
...
nop
and %rcx, %rcx
lea addresses_normal_ht+0x19451, %rsi
nop
nop
and %rax, %rax
movw $0x6162, (%rsi)
...
nop
sub $56744, %rcx
lea addresses_WT_ht+0xf29b, %rax
xor $49170, %rdi
mov (%rax), %ebp
nop
nop
...
{'OP': 'REPM', 'src': {'type': 'addresses_normal_ht', 'congruent': 5, 'same': True}, 'dst': {'type': 'addresses_WC_ht', 'congruent': 3, 'same': False}}
