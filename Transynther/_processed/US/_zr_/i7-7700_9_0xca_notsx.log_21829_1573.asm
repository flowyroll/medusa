...
movq %rbx, (%r9)
add $50451, %r15
lea addresses_normal_ht+0x124ed, %rsi
lea addresses_A_ht+0xdd9d, %rdi
sub $39927, %r15
mov $58, %rcx
rep movsw
nop
...
nop
cmp %rdx, %rdx
lea addresses_WT_ht+0x1b99d, %r11
nop
nop
cmp %r14, %r14
mov $0x6162636465666768, %rbx
...
nop
add $28175, %rdx
lea addresses_WC_ht+0x1d068, %rsi
nop
nop
sub $9753, %rcx
movw $0x6162, (%rsi)
cmp $29293, %rdi
lea addresses_A_ht+0x1a79d, %rcx
nop
add %rsi, %rsi
movw $0x6162, (%rcx)
nop
...
nop
inc %rcx
lea addresses_UC_ht+0x1041d, %rsi
lea addresses_D_ht+0x1e5bb, %rdi
nop
nop
and $11679, %r15
mov $91, %rcx
rep movsw
and $26626, %rdi
lea addresses_A_ht+0x1bfd7, %rdi
clflush (%rdi)
nop
nop
nop
...
nop
add %rdi, %rdi
lea addresses_WT_ht+0x141ad, %r15
clflush (%r15)
and %rdx, %rdx
mov (%r15), %esi
nop
...
// Load
lea addresses_WT+0x1809d, %rax
cmp $56672, %rsi
movb (%rax), %r14b
cmp $6121, %r14

// Faulty Load
lea addresses_US+0x15f9d, %rsi
nop
nop
nop
nop
...
{'src': {'congruent': 4, 'same': True, 'type': 'addresses_normal_ht'}, 'dst': {'congruent': 9, 'same': False, 'type': 'addresses_A_ht'}, 'OP': 'REPM'}
{'dst': {'NT': False, 'AVXalign': False, 'size': 16, 'congruent': 8, 'same': False, 'type': 'addresses_WT_ht'}, 'OP': 'STOR'}
{'dst': {'NT': False, 'AVXalign': False, 'size': 2, 'congruent': 0, 'same': False, 'type': 'addresses_WC_ht'}, 'OP': 'STOR'}
{'dst': {'NT': False, 'AVXalign': True, 'size': 2, 'congruent': 11, 'same': False, 'type': 'addresses_A_ht'}, 'OP': 'STOR'}
{'src': {'NT': False, 'AVXalign': False, 'size': 2, 'congruent': 0, 'same': False, 'type': 'addresses_A_ht'}, 'OP': 'LOAD'}
{'src': {'congruent': 6, 'same': False, 'type': 'addresses_UC_ht'}, 'dst': {'congruent': 1, 'same': False, 'type': 'addresses_D_ht'}, 'OP': 'REPM'}
