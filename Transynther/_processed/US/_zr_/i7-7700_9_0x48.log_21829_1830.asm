...
nop
xor %rcx, %rcx
lea addresses_normal_ht+0x24a2, %rsi
...
vmovntdq %ymm7, (%rsi)
and %rcx, %rcx
lea addresses_D_ht+0x9202, %rsi
lea addresses_D_ht+0x15b62, %rdi
nop
nop
and $42792, %rax
mov $116, %rcx
...
nop
and $35894, %r12
lea addresses_UC_ht+0x11322, %r8
nop
nop
nop
inc %rax
...
nop
dec %r12
lea addresses_A_ht+0x10da2, %r10
cmp %rsi, %rsi
movups (%r10), %xmm0
vpextrq $1, %xmm0, %r8
nop
...
nop
cmp %r12, %r12
lea addresses_WT_ht+0x159e2, %rax
clflush (%rax)
nop
nop
xor $20752, %r12
movw $0x6162, (%rax)
xor %r12, %r12
lea addresses_WT_ht+0xe772, %rcx
nop
nop
nop
cmp $64792, %r10
...
movb (%rsi), %r8b
add %r8, %r8
lea addresses_UC_ht+0x1a322, %rax
nop
nop
nop
nop
