...
push %rdx
push %rsi
lea addresses_WC_ht+0x191ba, %rdx
nop
sub $12708, %rdi
mov $0x6162636465666768, %r14
movq %r14, (%rdx)
add %rbx, %rbx
lea addresses_UC_ht+0x1ee1a, %rsi
lea addresses_D_ht+0x1bb0a, %rdi
nop
nop
nop
nop
...
nop
dec %r14
lea addresses_UC_ht+0x237a, %rsi
nop
nop
nop
nop
...
mov (%rsi), %r14
dec %r14
lea addresses_normal_ht+0x1b5fa, %rdx
clflush (%rdx)
nop
nop
sub $36806, %rsi
...
nop
add $21808, %r12
lea addresses_WT_ht+0x3cc0, %rcx
clflush (%rcx)
nop
nop
cmp %r14, %r14
...
// Store
lea addresses_normal+0x72ba, %r12
clflush (%r12)
nop
nop
nop
...
{'OP': 'REPM', 'src': {'type': 'addresses_UC_ht', 'congruent': 5, 'same': True}, 'dst': {'type': 'addresses_D_ht', 'congruent': 4, 'same': False}}
