...
nop
cmp %rcx, %rcx
lea addresses_normal_ht+0x89c, %rsi
lea addresses_A_ht+0x1ee12, %rdi
nop
nop
nop
nop
...
nop
inc %rdi
lea addresses_WC_ht+0xff33, %rsi
nop
sub $3271, %rax
movw $0x6162, (%rsi)
nop
...
nop
xor %r11, %r11
lea addresses_normal_ht+0x1d4b0, %rsi
nop
nop
nop
nop
...
nop
sub %rcx, %rcx
lea addresses_D_ht+0x122da, %rsi
lea addresses_UC_ht+0xbeda, %rdi
nop
nop
nop
sub $5991, %r14
...
lea addresses_UC_ht+0x3009, %rdi
clflush (%rdi)
xor $14177, %r13
mov $106, %rcx
rep movsb
nop
add %r11, %r11
lea addresses_normal_ht+0x7cee, %rdi
nop
sub $49169, %r11
movw $0x6162, (%rdi)
nop
...
nop
and $17046, %r13
lea addresses_WT_ht+0x1c4da, %r14
clflush (%r14)
nop
nop
nop
...
nop
and %rax, %rax
lea addresses_UC_ht+0x1799e, %rsi
nop
nop
nop
nop
...
{'OP': 'STOR', 'dst': {'type': 'addresses_UC_ht', 'AVXalign': False, 'congruent': 8, 'size': 16, 'same': True, 'NT': False}}
