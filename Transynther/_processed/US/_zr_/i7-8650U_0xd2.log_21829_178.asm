...
push %rdx
push %rsi
lea addresses_UC_ht+0x17c72, %rsi
lea addresses_WT_ht+0x90b2, %rdi
xor $19581, %r14
mov $47, %rcx
rep movsl
nop
nop
inc %rsi
lea addresses_A_ht+0xcd3a, %rdx
and $26652, %r10
movb (%rdx), %r12b
nop
nop
add $7267, %rdi
lea addresses_UC_ht+0x1c3fe, %rcx
nop
nop
nop
nop
...
lea addresses_normal_ht+0xd25a, %rdi
clflush (%rdi)
nop
nop
nop
...
nop
sub %r12, %r12
lea addresses_D_ht+0x13b82, %rsi
nop
nop
nop
nop
...
nop
dec %rax
lea addresses_WT_ht+0xe0ba, %r14
nop
dec %rdi
...
// Store
lea addresses_normal+0xd3aa, %r12
nop
nop
nop
sub $15645, %rbp
...
{'OP': 'REPM', 'src': {'type': 'addresses_UC_ht', 'congruent': 0, 'same': True}, 'dst': {'type': 'addresses_normal_ht', 'congruent': 7, 'same': False}}
