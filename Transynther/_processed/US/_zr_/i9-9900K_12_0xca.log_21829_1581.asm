...
nop
xor %rdx, %rdx
lea addresses_normal_ht+0xe3a0, %rdx
nop
nop
nop
nop
...
nop
add $56261, %r11
lea addresses_D_ht+0x165e0, %r11
nop
nop
nop
nop
...
nop
and %rcx, %rcx
lea addresses_A_ht+0x15a70, %r12
nop
nop
nop
sub $12828, %r11
...
{'OP': 'STOR', 'dst': {'size': 8, 'NT': False, 'type': 'addresses_normal_ht', 'same': True, 'AVXalign': True, 'congruent': 4}}
