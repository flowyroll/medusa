...
push %rdi
push %rsi
lea addresses_D_ht+0x13307, %rsi
nop
and $45676, %r15
mov (%rsi), %r13w
nop
...
nop
xor %r11, %r11
lea addresses_UC_ht+0x1c107, %rsi
lea addresses_UC_ht+0x784f, %rdi
clflush (%rdi)
nop
add %r10, %r10
mov $46, %rcx
rep movsw
add $8287, %r10
lea addresses_WC_ht+0x13c07, %rdi
nop
nop
nop
sub $17891, %r10
...
nop
inc %r15
lea addresses_normal_ht+0xb487, %rcx
nop
nop
nop
nop
...
nop
inc %r11
lea addresses_WT_ht+0x55c7, %rsi
...
nop
add $8459, %rsi
lea addresses_WT_ht+0x14507, %r15
nop
nop
nop
nop
...
nop
sub $22294, %r10
lea addresses_A_ht+0x1ce4f, %rsi
...
nop
and %rbp, %rbp
lea addresses_WC_ht+0x1be07, %rbp
nop
nop
nop
nop
...
{'OP': 'REPM', 'src': {'type': 'addresses_WT_ht', 'congruent': 6, 'same': True}, 'dst': {'type': 'addresses_A_ht', 'congruent': 9, 'same': False}}
