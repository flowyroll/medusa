...
push %rdx
push %rsi
lea addresses_UC_ht+0xcec3, %r15
and $8874, %rsi
mov $0x6162636465666768, %rdx
movq %rdx, (%r15)
cmp $35612, %r9
lea addresses_A_ht+0x10c63, %rcx
nop
nop
and $64813, %r11
mov (%rcx), %r8w
sub %r8, %r8
lea addresses_UC_ht+0xa063, %rsi
lea addresses_UC_ht+0xd093, %rdi
inc %r9
mov $125, %rcx
rep movsq
nop
...
nop
cmp %r11, %r11
lea addresses_WT_ht+0x10bef, %rdx
add $19206, %r8
mov (%rdx), %r9d
nop
nop
