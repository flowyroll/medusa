...
push %rdi
push %rsi
lea addresses_UC_ht+0x7ce8, %r14
nop
nop
inc %r15
movw $0x6162, (%r14)
nop
and %r12, %r12
lea addresses_WT_ht+0xc028, %rsi
lea addresses_UC_ht+0x8528, %rdi
nop
add $1073, %rbp
mov $43, %rcx
rep movsb
...
nop
cmp %r15, %r15
lea addresses_WT_ht+0x7828, %r14
nop
nop
nop
nop
...
// Store
lea addresses_normal+0x1741a, %r13
nop
nop
nop
cmp %r10, %r10
...
{'src': {'type': 'addresses_WT_ht', 'AVXalign': True, 'size': 32, 'NT': False, 'same': False, 'congruent': 2}, 'OP': 'LOAD'}
{'00': 21829}
