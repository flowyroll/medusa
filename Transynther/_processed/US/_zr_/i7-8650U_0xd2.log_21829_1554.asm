...
nop
cmp %rdx, %rdx
lea addresses_normal_ht+0x180bc, %r10
nop
cmp %r9, %r9
movb $0x61, (%r10)
nop
...
nop
dec %r14
lea addresses_A_ht+0x1520c, %r12
nop
nop
xor $4377, %r14
mov (%r12), %r9d
...
nop
sub $17474, %rcx
lea addresses_WT_ht+0x18e23, %rsi
lea addresses_WT_ht+0xd40c, %rdi
clflush (%rdi)
nop
nop
nop
...
nop
xor %rsi, %rsi
lea addresses_UC_ht+0x19a0c, %r10
nop
nop
add %rdi, %rdi
movb $0x61, (%r10)
...
nop
xor %rax, %rax
lea addresses_UC_ht+0x1ec00, %r9
nop
dec %rcx
mov (%r9), %edi
nop
...
// Store
lea addresses_normal+0x626d, %r9
nop
nop
add $15111, %rbp
movl $0x51525354, (%r9)
...
// Store
lea addresses_normal+0x12fcc, %r8
nop
nop
cmp $10861, %r10
...
{'OP': 'STOR', 'dst': {'type': 'addresses_UC_ht', 'size': 1, 'AVXalign': False, 'NT': False, 'congruent': 8, 'same': True}}
