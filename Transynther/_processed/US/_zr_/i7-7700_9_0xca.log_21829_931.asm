...
nop
dec %r9
lea addresses_D_ht+0x12e2b, %rbx
nop
inc %r10
...
nop
xor $30547, %rbx
lea addresses_D_ht+0x162b, %rsi
lea addresses_UC_ht+0xebab, %rdi
cmp %r9, %r9
mov $67, %rcx
rep movsw
nop
