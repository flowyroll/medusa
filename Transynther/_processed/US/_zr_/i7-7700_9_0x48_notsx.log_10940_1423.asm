...
push %rdi
push %rsi
lea addresses_WT_ht+0xcf4a, %r10
sub %r14, %r14
mov $0x6162636465666768, %r12
movq %r12, (%r10)
cmp $62903, %rax
lea addresses_WT_ht+0xf968, %rsi
lea addresses_A_ht+0x1c9b8, %rdi
inc %r9
mov $115, %rcx
rep movsb
nop
...
nop
cmp %r9, %r9
lea addresses_WT_ht+0x73b8, %rax
nop
add %r9, %r9
...
nop
dec %r9
lea addresses_A_ht+0xe938, %rsi
lea addresses_WC_ht+0x14bdc, %rdi
nop
nop
cmp %r14, %r14
mov $85, %rcx
...
nop
cmp $18835, %rax
lea addresses_UC_ht+0xafb0, %r10
nop
cmp $3962, %rdi
mov $0x6162636465666768, %r12
movq %r12, (%r10)
sub $58190, %r9
lea addresses_D_ht+0x13268, %r10
nop
nop
dec %rcx
movw $0x6162, (%r10)
...
nop
dec %r9
lea addresses_normal_ht+0x5fe8, %rsi
lea addresses_UC_ht+0x10ad4, %rdi
nop
nop
add %r9, %r9
mov $37, %rcx
...
lea addresses_normal+0x3b8, %rdi
nop
nop
nop
add $64086, %r14
...
{'dst': {'same': False, 'congruent': 10, 'type': 'addresses_normal'}, 'OP': 'REPM', 'src': {'same': False, 'congruent': 4, 'type': 'addresses_WT'}}
[Faulty Load]
...
{'dst': {'same': False, 'congruent': 2, 'type': 'addresses_WC_ht'}, 'OP': 'REPM', 'src': {'same': False, 'congruent': 7, 'type': 'addresses_A_ht'}}
