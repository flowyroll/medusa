...
push %rdi
push %rsi
lea addresses_WC_ht+0x51ca, %r8
nop
sub %rdi, %rdi
movb (%r8), %r9b
nop
cmp %r15, %r15
lea addresses_A_ht+0x640e, %r10
clflush (%r10)
nop
nop
nop
...
nop
xor %rsi, %rsi
lea addresses_A_ht+0xa94a, %r10
nop
xor %rsi, %rsi
mov (%r10), %r14w
nop
xor $44209, %r9
lea addresses_WC_ht+0x40b2, %r9
clflush (%r9)
nop
nop
nop
...
nop
add %r14, %r14
lea addresses_WC_ht+0xcaca, %r10
clflush (%r10)
inc %r14
movb (%r10), %r9b
nop
...
nop
xor $52404, %r10
lea addresses_D_ht+0x15f4a, %r9
add $13962, %rsi
and $0xffffffffffffffc0, %r9
movntdqa (%r9), %xmm5
vpextrq $1, %xmm5, %r15
dec %r8
lea addresses_D_ht+0x15eaa, %rdi
clflush (%rdi)
nop
nop
nop
...
nop
add $55319, %r14
lea addresses_D_ht+0x11d5a, %rsi
lea addresses_normal_ht+0x1e7ca, %rdi
clflush (%rsi)
nop
nop
sub $40996, %r14
...
<gen_prepare_buffer>
{'OP': 'LOAD', 'src': {'size': 1, 'NT': True, 'type': 'addresses_WC_ht', 'same': False, 'AVXalign': False, 'congruent': 9}}
{'OP': 'STOR', 'dst': {'size': 2, 'NT': True, 'type': 'addresses_A_ht', 'same': False, 'AVXalign': False, 'congruent': 2}}
...
{'OP': 'REPM', 'src': {'same': False, 'type': 'addresses_D_ht', 'congruent': 4}, 'dst': {'same': False, 'type': 'addresses_normal_ht', 'congruent': 10}}
