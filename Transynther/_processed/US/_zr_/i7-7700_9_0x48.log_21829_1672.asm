...
nop
xor $39369, %rsi
lea addresses_WC_ht+0x1a643, %rbx
nop
nop
nop
nop
...
vpextrq $1, %xmm7, %rcx
and $41271, %rsi
lea addresses_WC_ht+0x1943, %rbx
xor $17804, %r9
mov (%rbx), %cx
sub %r10, %r10
lea addresses_WT_ht+0x15c43, %rbx
clflush (%rbx)
and $33375, %r9
movw $0x6162, (%rbx)
nop
add $2273, %r15
lea addresses_normal_ht+0x1a213, %rsi
lea addresses_A_ht+0x3343, %rdi
nop
nop
nop
nop
...
nop
cmp %rsi, %rsi
lea addresses_WT_ht+0x146f, %rsi
nop
nop
nop
nop
...
{'OP': 'REPM', 'src': {'type': 'addresses_normal_ht', 'congruent': 1, 'same': False}, 'dst': {'type': 'addresses_A_ht', 'congruent': 6, 'same': False}}
