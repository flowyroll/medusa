...
push %rdi
push %rsi
lea addresses_A_ht+0x1b95b, %rsi
lea addresses_WT_ht+0x1357d, %rdi
add %rbp, %rbp
mov $42, %rcx
rep movsb
inc %r14
lea addresses_WC_ht+0x10f8b, %r10
nop
nop
xor $32395, %r12
movw $0x6162, (%r10)
...
// Store
lea addresses_normal+0x18a5b, %rax
xor %rsi, %rsi
movw $0x5152, (%rax)
nop
sub %r10, %r10
...
{'OP': 'STOR', 'dst': {'type': 'addresses_WT', 'size': 32, 'AVXalign': False, 'NT': True, 'congruent': 8, 'same': False}}
[Faulty Load]
