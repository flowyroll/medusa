...
nop
sub $52085, %r14
lea addresses_UC_ht+0x131d2, %rbx
nop
sub %r9, %r9
movb $0x61, (%rbx)
nop
cmp $48812, %r10
lea addresses_A_ht+0x19f8a, %rsi
lea addresses_D_ht+0x9e62, %rdi
add %r10, %r10
mov $120, %rcx
rep movsl
nop
and $59825, %r8
lea addresses_A_ht+0x4122, %rcx
nop
nop
nop
xor %r8, %r8
...
nop
and $25834, %r9
lea addresses_UC_ht+0xa262, %rcx
nop
nop
add $14646, %r8
mov (%rcx), %bp
...
nop
dec %rcx
lea addresses_WT_ht+0x1ad62, %r8
nop
nop
xor %r9, %r9
mov (%r8), %si
...
nop
add %rcx, %rcx
lea addresses_normal_ht+0x42a2, %rbp
nop
xor $25899, %r10
mov (%rbp), %si
nop
...
// REPMOV
lea addresses_WT+0x5702, %rsi
lea addresses_normal+0xee62, %rdi
nop
nop
xor $59246, %r12
mov $79, %rcx
...
{'OP': 'REPM', 'src': {'type': 'addresses_WT', 'congruent': 5, 'same': False}, 'dst': {'type': 'addresses_normal', 'congruent': 10, 'same': False}}
[Faulty Load]
...
{'OP': 'REPM', 'src': {'type': 'addresses_A_ht', 'congruent': 3, 'same': True}, 'dst': {'type': 'addresses_A_ht', 'congruent': 9, 'same': False}}
