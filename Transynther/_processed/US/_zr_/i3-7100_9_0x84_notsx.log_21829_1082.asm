...
push %rdi
push %rsi
lea addresses_WT_ht+0x3e2e, %r13
nop
nop
sub %r10, %r10
mov (%r13), %r9w
...
nop
sub $20568, %r15
lea addresses_normal_ht+0xc22e, %rsi
lea addresses_A_ht+0x472e, %rdi
sub %r15, %r15
mov $94, %rcx
rep movsw
nop
nop
cmp $21799, %rsi
lea addresses_D_ht+0x14c2e, %rdi
and $5658, %r15
movl $0x61626364, (%rdi)
nop
nop
...
nop
cmp %rsi, %rsi
lea addresses_WC_ht+0x1d36, %r13
clflush (%r13)
nop
cmp %rsi, %rsi
movups (%r13), %xmm5
...
nop
cmp $16838, %rsi
lea addresses_D_ht+0x40e6, %rsi
lea addresses_normal_ht+0x13a8e, %rdi
nop
nop
nop
nop
...
nop
cmp $55643, %rsi
lea addresses_normal_ht+0xe3f6, %r9
cmp %r10, %r10
...
mov (%r13), %rdi
and %rcx, %rcx
lea addresses_normal_ht+0x142e, %r9
nop
nop
add $45988, %r10
mov $0x6162636465666768, %r13
...
nop
add %r10, %r10
lea addresses_WT_ht+0xc82e, %rsi
lea addresses_WC_ht+0xb42e, %rdi
xor %rbp, %rbp
mov $75, %rcx
rep movsb
nop
inc %r10
lea addresses_A_ht+0x1862e, %rbp
clflush (%rbp)
nop
nop
nop
...
{'src': {'type': 'addresses_WT_ht', 'congruent': 10, 'same': True}, 'dst': {'type': 'addresses_WC_ht', 'congruent': 11, 'same': False}, 'OP': 'REPM'}
