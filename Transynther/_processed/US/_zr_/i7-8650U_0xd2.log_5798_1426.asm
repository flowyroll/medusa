...
nop
add %rsi, %rsi
lea addresses_WT_ht+0x87ab, %rsi
lea addresses_D_ht+0x3fab, %rdi
and $12331, %r12
mov $3, %rcx
rep movsq
inc %rdi
lea addresses_normal_ht+0xf8dd, %rcx
nop
nop
nop
cmp %rdi, %rdi
...
nop
add $18487, %r13
lea addresses_WC_ht+0x101ab, %rsi
nop
nop
nop
add $17387, %rbx
...
nop
inc %r8
lea addresses_normal_ht+0x1a36b, %rsi
nop
cmp $25604, %rcx
...
nop
cmp %r12, %r12
lea addresses_D_ht+0x1a9a0, %rsi
nop
nop
cmp %rbx, %rbx
...
nop
dec %r12
lea addresses_WT_ht+0x5bcb, %rbx
nop
xor $21863, %rdi
movb $0x61, (%rbx)
nop
...
{'OP': 'STOR', 'dst': {'type': 'addresses_normal_ht', 'size': 16, 'AVXalign': False, 'NT': True, 'congruent': 4, 'same': True}}
...
{'OP': 'LOAD', 'src': {'type': 'addresses_normal_ht', 'size': 32, 'AVXalign': True, 'NT': False, 'congruent': 6, 'same': True}}
...
{'OP': 'STOR', 'dst': {'type': 'addresses_D_ht', 'size': 16, 'AVXalign': True, 'NT': False, 'congruent': 5, 'same': False}}
{'00': 5798}
