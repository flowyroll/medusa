...
push %rdi
push %rsi
lea addresses_UC_ht+0x38e3, %r11
nop
nop
nop
nop
...
nop
add %r12, %r12
lea addresses_WT_ht+0xa76b, %rsi
...
nop
and %rcx, %rcx
lea addresses_UC_ht+0x65d3, %rax
sub $51085, %rcx
movw $0x6162, (%rax)
nop
and $45236, %r12
lea addresses_A_ht+0x152cd, %r11
nop
and %rsi, %rsi
...
nop
add $57777, %rdi
lea addresses_WT_ht+0x154e3, %r12
clflush (%r12)
nop
nop
nop
...
{'OP': 'STOR', 'dst': {'type': 'addresses_UC_ht', 'AVXalign': False, 'size': 2, 'NT': True, 'same': False, 'congruent': 4}}
