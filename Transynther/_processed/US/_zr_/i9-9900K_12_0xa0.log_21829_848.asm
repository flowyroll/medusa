...
push %rdi
push %rsi
lea addresses_UC_ht+0xc503, %rsi
lea addresses_normal_ht+0xf233, %rdi
and $11204, %rax
mov $28, %rcx
rep movsl
add $21088, %r8
lea addresses_UC_ht+0x4dc3, %rsi
...
nop
add %r8, %r8
lea addresses_normal_ht+0x3573, %rdi
nop
nop
and %r13, %r13
movl $0x61626364, (%rdi)
...
nop
xor %r13, %r13
lea addresses_UC_ht+0x8db3, %rsi
clflush (%rsi)
nop
sub %rax, %rax
movw $0x6162, (%rsi)
nop
xor $10134, %r8
lea addresses_WC_ht+0xa4f9, %rsi
add $2503, %rcx
mov (%rsi), %rdi
nop
nop
...
nop
dec %rcx
lea addresses_A_ht+0x142e3, %r15
nop
nop
nop
nop
