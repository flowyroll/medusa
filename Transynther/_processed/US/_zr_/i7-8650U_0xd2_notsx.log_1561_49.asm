...
nop
sub %rsi, %rsi
lea addresses_A_ht+0x1521, %r10
cmp %r13, %r13
movl $0x61626364, (%r10)
nop
add $40731, %r13
lea addresses_A_ht+0xd921, %r9
sub %rdi, %rdi
movb $0x61, (%r9)
nop
nop
cmp $20712, %r13
lea addresses_normal_ht+0x1aba1, %rsi
lea addresses_D_ht+0x81a1, %rdi
nop
nop
nop
nop
...
nop
xor $65051, %r10
lea addresses_normal_ht+0x8561, %r10
nop
nop
nop
nop
...
nop
sub %r11, %r11
lea addresses_normal_ht+0x10325, %rdi
clflush (%rdi)
nop
nop
cmp %r13, %r13
...
// REPMOV
lea addresses_WC+0xeda1, %rsi
lea addresses_WC+0x103a1, %rdi
and $23401, %r10
mov $63, %rcx
rep movsw
nop
...
{'OP': 'REPM', 'src': {'type': 'addresses_WC', 'congruent': 8, 'same': False}, 'dst': {'type': 'addresses_WC', 'congruent': 10, 'same': False}}
[Faulty Load]
