...
nop
dec %r8
lea addresses_WC_ht+0x7c6f, %rdx
nop
sub %r10, %r10
movl $0x61626364, (%rdx)
add $3254, %rcx
lea addresses_normal_ht+0x14ac5, %r10
nop
nop
nop
nop
