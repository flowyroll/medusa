...
push %rdx
push %rsi
lea addresses_WC_ht+0x1df04, %r14
clflush (%r14)
nop
nop
nop
...
nop
dec %rsi
lea addresses_WT_ht+0x26d2, %r15
nop
nop
add $1296, %rsi
...
nop
cmp $50960, %rdx
lea addresses_UC_ht+0xe75c, %r14
and $29624, %rsi
mov (%r14), %r15
nop
nop
...
nop
add %r14, %r14
lea addresses_WC_ht+0xce8c, %rsi
lea addresses_A_ht+0x1f5c, %rdi
nop
nop
cmp %r15, %r15
mov $30, %rcx
...
<gen_prepare_buffer>
{'OP': 'STOR', 'dst': {'type': 'addresses_WC_ht', 'size': 1, 'AVXalign': False, 'NT': True, 'congruent': 1, 'same': False}}
