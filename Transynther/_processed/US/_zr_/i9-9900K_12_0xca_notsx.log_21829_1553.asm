...
nop
sub %rsi, %rsi
lea addresses_WT_ht+0x4b49, %r14
nop
nop
xor $52886, %r12
...
nop
cmp %r14, %r14
lea addresses_WT_ht+0x1c469, %r11
nop
nop
nop
nop
...
{'OP': 'STOR', 'dst': {'same': False, 'type': 'addresses_WT_ht', 'NT': True, 'AVXalign': False, 'size': 16, 'congruent': 7}}
