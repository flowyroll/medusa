...
nop
xor $57013, %r15
lea addresses_A_ht+0x125ed, %rsi
lea addresses_UC_ht+0x1df0d, %rdi
nop
sub %r15, %r15
mov $120, %rcx
rep movsw
...
nop
and $5306, %rdi
lea addresses_WT_ht+0x186d, %r13
nop
nop
nop
add $23815, %rsi
...
nop
inc %rsi
lea addresses_WC_ht+0x124ed, %r15
nop
sub $1901, %rcx
movw $0x6162, (%r15)
dec %r8
lea addresses_D_ht+0x18eed, %r8
nop
nop
add %r15, %r15
movw $0x6162, (%r8)
...
nop
sub $2884, %rsi
lea addresses_UC_ht+0x956d, %rcx
nop
nop
nop
xor $4774, %r13
...
nop
sub $47436, %rcx
lea addresses_WT_ht+0x35b1, %r14
nop
sub $63306, %rcx
...
{'OP': 'STOR', 'dst': {'type': 'addresses_WT_ht', 'AVXalign': True, 'congruent': 5, 'size': 1, 'same': False, 'NT': False}}
...
{'OP': 'STOR', 'dst': {'type': 'addresses_WT_ht', 'AVXalign': False, 'congruent': 0, 'size': 32, 'same': True, 'NT': False}}
{'00': 21829}
