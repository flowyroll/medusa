...
push %rdx
push %rsi
lea addresses_WC_ht+0x19a62, %rsi
nop
nop
nop
cmp $60444, %r10
...
nop
and %r11, %r11
lea addresses_normal_ht+0x15a4, %r15
nop
nop
nop
nop
...
nop
add $32572, %rsi
lea addresses_D_ht+0x11062, %rdx
and $3213, %rsi
movups (%rdx), %xmm5
vpextrq $1, %xmm5, %r13
nop
...
nop
add %r13, %r13
lea addresses_UC_ht+0x15262, %rsi
lea addresses_D_ht+0x9a62, %rdi
nop
sub $32878, %r9
mov $77, %rcx
rep movsl
...
nop
sub %r15, %r15
lea addresses_UC_ht+0x1e542, %r9
nop
nop
add %rcx, %rcx
