...
vpextrq $0, %xmm5, %r8
and $28184, %r8
lea addresses_normal_ht+0x1e27d, %r10
nop
add $26545, %r9
movw $0x6162, (%r10)
nop
...
nop
cmp $37757, %rdi
lea addresses_normal_ht+0x8e2d, %r11
nop
nop
add %r14, %r14
mov (%r11), %r8
nop
add $32289, %r10
lea addresses_WT_ht+0x1303d, %r14
nop
nop
nop
and $24342, %rcx
...
nop
cmp $8226, %rdi
lea addresses_A_ht+0x12c3d, %r14
nop
nop
nop
nop
...
nop
cmp $2876, %r11
lea addresses_UC_ht+0x1b9bd, %rcx
nop
nop
nop
nop
...
<gen_prepare_buffer>
{'OP': 'LOAD', 'src': {'type': 'addresses_A_ht', 'size': 32, 'AVXalign': False, 'NT': True, 'congruent': 11, 'same': True}}
