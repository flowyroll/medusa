...
push %rdi
push %rsi
lea addresses_WC_ht+0xef1b, %rsi
lea addresses_normal_ht+0x15b1b, %rdi
nop
add $53160, %rbx
mov $59, %rcx
rep movsq
and %r14, %r14
lea addresses_normal_ht+0x163c1, %r13
nop
nop
nop
add %r12, %r12
...
nop
and $13888, %rsi
lea addresses_WT_ht+0xb59b, %rsi
nop
nop
nop
nop
...
nop
sub $29266, %r13
lea addresses_WT_ht+0x1d0f7, %rsi
lea addresses_WC_ht+0x1946b, %rdi
nop
nop
lfence
mov $124, %rcx
...
nop
xor %rsi, %rsi
lea addresses_D_ht+0x11b82, %rsi
lea addresses_WC_ht+0x16f1b, %rdi
nop
nop
nop
nop
...
nop
add $41680, %r12
lea addresses_WT_ht+0x1e99b, %rsi
lea addresses_D_ht+0x87fb, %rdi
sub %rbp, %rbp
mov $20, %rcx
rep movsq
nop
...
nop
add %rsi, %rsi
lea addresses_normal_ht+0x1b3e5, %rcx
clflush (%rcx)
nop
nop
nop
...
nop
sub %rcx, %rcx
lea addresses_normal_ht+0xd365, %r13
nop
nop
nop
nop
...
nop
inc %r13
lea addresses_WT_ht+0x10c1b, %r14
nop
nop
nop
sub %r13, %r13
...
{'OP': 'STOR', 'dst': {'type': 'addresses_normal_ht', 'AVXalign': True, 'congruent': 1, 'size': 4, 'same': False, 'NT': False}}
