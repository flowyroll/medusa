...
push %rdx
push %rsi
lea addresses_WC_ht+0xf87e, %rsi
lea addresses_UC_ht+0x2122, %rdi
nop
nop
nop
nop
...
rep movsl
and %rdx, %rdx
lea addresses_UC_ht+0xf79e, %rsi
...
rep movsb
cmp %rdx, %rdx
lea addresses_normal_ht+0x79b3, %r11
nop
sub %rbp, %rbp
mov (%r11), %rdi
and $51699, %rcx
lea addresses_WC_ht+0x2c7e, %rdx
nop
nop
nop
nop
...
nop
dec %rdx
lea addresses_WC_ht+0x1e127, %rcx
clflush (%rcx)
nop
nop
nop
...
nop
sub $721, %rcx
lea addresses_normal_ht+0x17fe, %rcx
clflush (%rcx)
nop
sub $53620, %r11
mov (%rcx), %di
...
nop
lfence
lea addresses_normal_ht+0x15bfe, %rsi
lea addresses_normal_ht+0xb9ae, %rdi
nop
sub %r8, %r8
mov $26, %rcx
rep movsw
add %r11, %r11
lea addresses_WC_ht+0x10afe, %rbp
nop
inc %rdx
...
<gen_prepare_buffer>
{'src': {'type': 'addresses_WC_ht', 'congruent': 5, 'same': False}, 'OP': 'REPM', 'dst': {'type': 'addresses_UC_ht', 'congruent': 1, 'same': False}}
...
{'src': {'type': 'addresses_WC_ht', 'AVXalign': False, 'size': 2, 'NT': True, 'same': False, 'congruent': 0}, 'OP': 'LOAD'}
{'src': {'type': 'addresses_normal_ht', 'AVXalign': False, 'size': 2, 'NT': False, 'same': False, 'congruent': 8}, 'OP': 'LOAD'}
{'src': {'type': 'addresses_normal_ht', 'congruent': 8, 'same': False}, 'OP': 'REPM', 'dst': {'type': 'addresses_normal_ht', 'congruent': 3, 'same': False}}
