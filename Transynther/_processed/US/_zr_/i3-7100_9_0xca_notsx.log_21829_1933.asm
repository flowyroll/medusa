...
nop
sub %rcx, %rcx
lea addresses_normal_ht+0x19417, %r11
xor $46290, %rsi
movw $0x6162, (%r11)
nop
nop
...
{'OP': 'STOR', 'dst': {'same': False, 'congruent': 7, 'NT': True, 'type': 'addresses_WC', 'size': 8, 'AVXalign': False}}
