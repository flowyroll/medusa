...
nop
cmp %r13, %r13
lea addresses_WC_ht+0x1dd48, %rcx
and %r12, %r12
mov (%rcx), %esi
nop
nop
and %rdi, %rdi
lea addresses_WC_ht+0x36e5, %rax
nop
nop
nop
nop
...
movq %rcx, (%rax)
add %rdx, %rdx
lea addresses_A_ht+0x1d5d0, %r12
nop
nop
nop
nop
...
mov (%r12), %eax
dec %rax
lea addresses_UC_ht+0xe607, %rdi
cmp %rax, %rax
mov $0x6162636465666768, %r12
movq %r12, %xmm0
movups %xmm0, (%rdi)
add $50798, %rsi
lea addresses_WC_ht+0x2055, %r13
nop
sub %rdi, %rdi
movw $0x6162, (%r13)
nop
...
{'OP': 'STOR', 'dst': {'congruent': 3, 'AVXalign': True, 'same': False, 'size': 8, 'NT': False, 'type': 'addresses_WC_ht'}}
