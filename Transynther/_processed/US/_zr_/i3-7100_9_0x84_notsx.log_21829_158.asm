...
push %rdi
push %rsi
lea addresses_WT_ht+0xc04a, %rax
nop
nop
nop
nop
...
nop
xor $39225, %r12
lea addresses_A_ht+0xcb4a, %rsi
lea addresses_UC_ht+0x16a0e, %rdi
nop
nop
nop
cmp %r8, %r8
...
nop
cmp %r8, %r8
lea addresses_WC_ht+0xb84a, %r12
nop
nop
sub %r11, %r11
...
nop
add %rdi, %rdi
lea addresses_D_ht+0x1a84a, %r12
nop
nop
nop
nop
