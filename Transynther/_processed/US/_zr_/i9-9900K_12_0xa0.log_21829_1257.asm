...
push %rdi
push %rsi
lea addresses_D_ht+0x19984, %rax
nop
nop
add $50712, %rsi
...
vpextrq $1, %xmm5, %rdi
and $34695, %rax
lea addresses_WT_ht+0x16e78, %rsi
lea addresses_WC_ht+0x165d8, %rdi
nop
nop
nop
nop
...
nop
and $1409, %r11
lea addresses_WC_ht+0xfe38, %r13
nop
add $57574, %r9
vmovups (%r13), %ymm1
...
{'OP': 'STOR', 'dst': {'NT': True, 'same': False, 'congruent': 8, 'type': 'addresses_D', 'AVXalign': False, 'size': 8}}
...
<gen_prepare_buffer>
{'src': {'NT': False, 'same': False, 'congruent': 0, 'type': 'addresses_D_ht', 'AVXalign': True, 'size': 16}, 'OP': 'LOAD'}
