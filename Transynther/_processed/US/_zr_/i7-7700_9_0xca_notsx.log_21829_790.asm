...
push %rdx
push %rsi
lea addresses_A_ht+0x19209, %rsi
nop
nop
nop
nop
...
nop
dec %r10
lea addresses_normal_ht+0x56a1, %r13
nop
nop
nop
nop
...
nop
sub %r8, %r8
lea addresses_normal_ht+0x1f59, %rsi
...
// REPMOV
lea addresses_normal+0x4809, %rsi
lea addresses_WT+0x1f049, %rdi
clflush (%rsi)
dec %rbp
mov $6, %rcx
rep movsb
...
{'src': {'congruent': 9, 'same': False, 'type': 'addresses_normal'}, 'dst': {'congruent': 5, 'same': False, 'type': 'addresses_WT'}, 'OP': 'REPM'}
[Faulty Load]
