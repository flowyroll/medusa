...
nop
xor $31701, %rax
lea addresses_WC_ht+0x1a820, %rsi
lea addresses_A_ht+0x13eda, %rdi
nop
xor $32524, %rax
mov $2, %rcx
rep movsl
...
nop
and %rsi, %rsi
lea addresses_WC_ht+0x126da, %r9
nop
nop
nop
nop
...
lea addresses_D_ht+0x615a, %rdi
inc %rbx
mov $103, %rcx
rep movsw
nop
add $57097, %r9
lea addresses_D_ht+0xfeda, %r15
nop
nop
nop
nop
...
nop
xor %r15, %r15
lea addresses_WT_ht+0x36da, %rsi
lea addresses_WC_ht+0x1d1ba, %rdi
nop
sub $32221, %rbx
mov $30, %rcx
rep movsw
...
nop
cmp %rax, %rax
lea addresses_WT_ht+0x60b8, %rdi
nop
add %r14, %r14
movb $0x61, (%rdi)
nop
...
nop
xor %rcx, %rcx
lea addresses_D_ht+0x152c2, %rdi
nop
nop
nop
nop
...
nop
dec %r9
lea addresses_UC_ht+0x19eda, %r14
nop
and $40686, %rdi
mov $0x6162636465666768, %rax
movq %rax, (%r14)
...
nop
cmp %r9, %r9
lea addresses_A_ht+0x561a, %rsi
lea addresses_UC_ht+0x8082, %rdi
clflush (%rsi)
nop
nop
nop
...
nop
sub %r9, %r9
lea addresses_WC_ht+0x131da, %rsi
...
<gen_prepare_buffer>
{'src': {'type': 'addresses_A_ht', 'congruent': 5, 'same': True}, 'OP': 'REPM', 'dst': {'type': 'addresses_UC_ht', 'congruent': 0, 'same': False}}
...
{'src': {'type': 'addresses_D_ht', 'AVXalign': False, 'size': 1, 'NT': True, 'same': True, 'congruent': 10}, 'OP': 'LOAD'}
...
{'src': {'type': 'addresses_WT_ht', 'congruent': 10, 'same': False}, 'OP': 'REPM', 'dst': {'type': 'addresses_WC_ht', 'congruent': 5, 'same': False}}
{'src': {'type': 'addresses_WT_ht', 'congruent': 6, 'same': False}, 'OP': 'REPM', 'dst': {'type': 'addresses_WT_ht', 'congruent': 10, 'same': True}}
...
{'src': {'type': 'addresses_A_ht', 'congruent': 6, 'same': False}, 'OP': 'REPM', 'dst': {'type': 'addresses_UC_ht', 'congruent': 3, 'same': False}}
{'src': {'type': 'addresses_WC_ht', 'congruent': 7, 'same': False}, 'OP': 'REPM', 'dst': {'type': 'addresses_WC_ht', 'congruent': 2, 'same': False}}
{'00': 21829}
