...
push %rdx
push %rsi
lea addresses_UC_ht+0xe968, %rcx
nop
nop
nop
nop
...
nop
cmp %r10, %r10
lea addresses_normal_ht+0xf500, %r9
nop
nop
add $42959, %rdx
mov (%r9), %r12w
nop
sub %rdx, %rdx
lea addresses_UC_ht+0x1c263, %r9
nop
nop
nop
nop
...
nop
and $24487, %rdx
lea addresses_D_ht+0xc868, %rsi
lea addresses_normal_ht+0x179e8, %rdi
nop
cmp $19207, %r9
mov $70, %rcx
rep movsq
...
{'src': {'congruent': 7, 'AVXalign': True, 'same': False, 'size': 8, 'NT': False, 'type': 'addresses_RW'}, 'OP': 'LOAD'}
[Faulty Load]
...
{'src': {'congruent': 7, 'same': False, 'type': 'addresses_D_ht'}, 'OP': 'REPM', 'dst': {'congruent': 11, 'same': False, 'type': 'addresses_normal_ht'}}
{'00': 21829}
