...
nop
cmp %rax, %rax
lea addresses_UC_ht+0x14977, %rdx
nop
nop
cmp $19598, %rsi
mov (%rdx), %di
nop
xor $6783, %rcx
lea addresses_WC_ht+0x4ba3, %rbp
add %r8, %r8
mov (%rbp), %ax
nop
nop
sub %rbp, %rbp
lea addresses_WC_ht+0x10d2f, %r8
add %rsi, %rsi
...
<gen_prepare_buffer>
{'src': {'congruent': 10, 'same': False, 'type': 'addresses_D_ht'}, 'dst': {'congruent': 1, 'same': False, 'type': 'addresses_A_ht'}, 'OP': 'REPM'}
