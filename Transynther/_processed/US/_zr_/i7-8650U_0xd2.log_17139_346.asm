...
vpextrq $1, %xmm1, %rax
and %rcx, %rcx
lea addresses_WC_ht+0x9322, %rsi
lea addresses_A_ht+0x556a, %rdi
nop
nop
xor %r12, %r12
mov $20, %rcx
rep movsb
xor %rax, %rax
lea addresses_normal_ht+0xb10a, %rsi
nop
inc %rax
movb $0x61, (%rsi)
nop
...
nop
sub $5102, %r9
lea addresses_UC_ht+0x1b10a, %rdi
nop
nop
nop
and $16713, %rax
...
vpextrq $1, %xmm6, %rcx
xor $40301, %rcx
lea addresses_WC_ht+0x15f0a, %r13
nop
nop
nop
nop
...
nop
cmp %rcx, %rcx
lea addresses_normal_ht+0xe50a, %rsi
lea addresses_WC_ht+0x1ed0a, %rdi
clflush (%rdi)
nop
nop
nop
...
nop
and %rcx, %rcx
lea addresses_D_ht+0x7824, %rsi
lea addresses_UC_ht+0xabb2, %rdi
nop
nop
cmp %r15, %r15
mov $14, %rcx
