...
push %rdx
push %rsi
lea addresses_UC_ht+0x1866e, %rcx
nop
nop
nop
xor %rdx, %rdx
...
nop
inc %r8
lea addresses_UC_ht+0x1276, %rsi
nop
nop
nop
add %r10, %r10
...
nop
add %rax, %rax
lea addresses_WC_ht+0x9c56, %rdx
nop
nop
nop
cmp %rsi, %rsi
...
{'OP': 'STOR', 'dst': {'type': 'addresses_WC', 'AVXalign': True, 'congruent': 6, 'size': 8, 'same': False, 'NT': False}}
