...
push %rdx
push %rsi
lea addresses_normal_ht+0xda01, %rsi
nop
nop
nop
nop
...
nop
add %r10, %r10
lea addresses_D_ht+0x19001, %rdx
nop
nop
nop
nop
...
nop
and %rax, %rax
lea addresses_WT_ht+0x72fb, %rsi
nop
nop
nop
nop
...
nop
cmp %rsi, %rsi
lea addresses_D_ht+0x18b3d, %rsi
lea addresses_WC_ht+0x1e641, %rdi
nop
nop
nop
nop
...
nop
cmp $35701, %r12
lea addresses_A_ht+0x1b521, %rsi
nop
nop
nop
inc %r13
...
movl $0x61626364, (%r9)
add %rdi, %rdi
lea addresses_UC_ht+0xd501, %r12
nop
nop
nop
add $41467, %rdx
...
nop
xor $58351, %rsi
lea addresses_WC_ht+0x7959, %r13
clflush (%r13)
nop
nop
nop
...
nop
inc %r10
lea addresses_UC_ht+0x2701, %rsi
lea addresses_D_ht+0x14b01, %rdi
clflush (%rsi)
nop
nop
nop
...
{'src': {'congruent': 1, 'same': False, 'type': 'addresses_D_ht'}, 'OP': 'REPM', 'dst': {'congruent': 6, 'same': False, 'type': 'addresses_WC_ht'}}
{'src': {'congruent': 4, 'AVXalign': False, 'same': False, 'size': 16, 'NT': False, 'type': 'addresses_A_ht'}, 'OP': 'LOAD'}
{'OP': 'STOR', 'dst': {'congruent': 2, 'AVXalign': False, 'same': True, 'size': 4, 'NT': False, 'type': 'addresses_A_ht'}}
...
{'src': {'congruent': 9, 'same': False, 'type': 'addresses_UC_ht'}, 'OP': 'REPM', 'dst': {'congruent': 9, 'same': False, 'type': 'addresses_D_ht'}}
{'00': 21829}
