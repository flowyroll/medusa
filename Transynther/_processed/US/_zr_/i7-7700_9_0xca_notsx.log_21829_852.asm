...
push %rdi
push %rsi
lea addresses_WT_ht+0xcf81, %rsi
lea addresses_D_ht+0x13385, %rdi
nop
cmp %r9, %r9
mov $11, %rcx
rep movsq
nop
add %rbx, %rbx
lea addresses_WC_ht+0x122d, %r15
nop
add %r14, %r14
movb $0x61, (%r15)
nop
sub %rbx, %rbx
lea addresses_WC_ht+0xf2ed, %r14
nop
nop
nop
nop
...
{'src': {'congruent': 0, 'same': False, 'type': 'addresses_P'}, 'dst': {'congruent': 5, 'same': False, 'type': 'addresses_UC'}, 'OP': 'REPM'}
