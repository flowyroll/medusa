...
rep movsq
dec %rsi
lea addresses_WC_ht+0xf2e4, %rsi
nop
inc %r11
movl $0x61626364, (%rsi)
nop
...
nop
add $64271, %rdx
lea addresses_WT_ht+0x100d4, %rsi
lea addresses_UC_ht+0x11104, %rdi
nop
xor $3426, %r14
mov $1, %rcx
rep movsw
...
nop
sub %r9, %r9
lea addresses_WC_ht+0x1db84, %rcx
nop
nop
cmp %rdx, %rdx
mov (%rcx), %r9d
