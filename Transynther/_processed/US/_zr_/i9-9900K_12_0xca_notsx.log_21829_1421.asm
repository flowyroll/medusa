...
push %rdi
push %rsi
lea addresses_normal_ht+0x3178, %r15
nop
nop
add %r14, %r14
movl $0x61626364, (%r15)
...
nop
inc %r9
lea addresses_D_ht+0x10d10, %rdi
nop
nop
nop
nop
...
movb $0x61, (%rdi)
cmp $32997, %rdi
lea addresses_WC_ht+0x19010, %rsi
lea addresses_WT_ht+0x38fc, %rdi
nop
nop
and %r10, %r10
mov $36, %rcx
...
nop
xor %r9, %r9
lea addresses_D_ht+0x9e10, %rsi
lea addresses_D_ht+0x1d6f0, %rdi
nop
nop
xor $18741, %r15
mov $4, %rcx
...
// Store
lea addresses_PSE+0x1f7d0, %rbp
sub %rdx, %rdx
movl $0x51525354, (%rbp)
dec %r14

// Faulty Load
lea addresses_US+0x1fe10, %r14
nop
nop
nop
nop
...
{'OP': 'REPM', 'src': {'same': False, 'congruent': 9, 'type': 'addresses_WC_ht'}, 'dst': {'same': False, 'congruent': 2, 'type': 'addresses_WT_ht'}}
...
{'OP': 'STOR', 'dst': {'same': False, 'type': 'addresses_A_ht', 'NT': True, 'AVXalign': False, 'size': 16, 'congruent': 8}}
