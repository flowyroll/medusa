...
push %rdx
push %rsi
lea addresses_WC_ht+0x1c170, %rsi
lea addresses_WC_ht+0x2250, %rdi
nop
nop
nop
nop
...
nop
add $36615, %rdx
lea addresses_WT_ht+0x5018, %rsi
lea addresses_WC_ht+0x13110, %rdi
nop
nop
nop
nop
...
{'OP': 'REPM', 'src': {'type': 'addresses_WT_ht', 'congruent': 2, 'same': False}, 'dst': {'type': 'addresses_WC_ht', 'congruent': 8, 'same': True}}
