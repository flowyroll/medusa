...
push %rdx
push %rsi
lea addresses_WT_ht+0x57c7, %rdi
nop
add $31480, %rbp
movw $0x6162, (%rdi)
nop
cmp $29777, %rbp
lea addresses_WC_ht+0x108f, %rdx
xor $44883, %rdi
mov (%rdx), %ebp
nop
nop
...
nop
xor $45262, %rsi
lea addresses_normal_ht+0x5a91, %r15
nop
nop
nop
nop
...
nop
xor $52313, %rsi
lea addresses_WC_ht+0x1d0c7, %rdx
xor %rsi, %rsi
movups (%rdx), %xmm3
vpextrq $0, %xmm3, %r15
nop
...
nop
cmp %r15, %r15
lea addresses_UC_ht+0xa0c7, %rsi
lea addresses_WC_ht+0x10d7, %rdi
nop
nop
add %rbp, %rbp
mov $50, %rcx
...
rep movsl
sub $63181, %rsi
lea addresses_UC_ht+0xc3c7, %rcx
nop
nop
nop
sub $55879, %r15
...
{'dst': {'same': False, 'NT': False, 'AVXalign': False, 'size': 4, 'type': 'addresses_P', 'congruent': 11}, 'OP': 'STOR'}
...
{'dst': {'same': False, 'congruent': 9, 'type': 'addresses_A_ht'}, 'OP': 'REPM', 'src': {'same': True, 'congruent': 10, 'type': 'addresses_A_ht'}}
