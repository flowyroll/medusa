...
push %rcx
push %rdx
lea addresses_WC_ht+0x147cd, %r15
clflush (%r15)
xor $6704, %rdx
...
nop
and %rdx, %rdx
lea addresses_WC_ht+0x1b8ab, %rcx
nop
nop
inc %r9
...
nop
dec %r9
lea addresses_D_ht+0x3cbd, %r13
add %r8, %r8
mov $0x6162636465666768, %r9
movq %r9, (%r13)
and $35474, %r9
lea addresses_WC_ht+0x18d4d, %r13
nop
nop
and $43943, %rcx
movb (%r13), %r11b
...
{'src': {'type': 'addresses_P', 'congruent': 0, 'same': False}, 'OP': 'REPM', 'dst': {'type': 'addresses_A', 'congruent': 5, 'same': False}}
[Faulty Load]
...
{'src': {'same': True, 'congruent': 6, 'NT': False, 'type': 'addresses_WC_ht', 'size': 1, 'AVXalign': False}, 'OP': 'LOAD'}
{'00': 18309}
