...
push %rdx
push %rsi
lea addresses_normal_ht+0x99a3, %rsi
lea addresses_WC_ht+0x12f03, %rdi
nop
nop
nop
add $51309, %rdx
...
nop
dec %rsi
lea addresses_WC_ht+0x4603, %rbp
nop
nop
nop
nop
...
nop
and $37211, %rdi
lea addresses_WT_ht+0x1dc03, %rbp
nop
nop
nop
xor %r10, %r10
...
nop
add $5084, %rsi
lea addresses_WC_ht+0x1a13, %rcx
lfence
movw $0x6162, (%rcx)
nop
sub $8016, %rdi
lea addresses_WT_ht+0xda03, %rax
nop
add $59535, %rbp
mov (%rax), %si
nop
...
nop
and %rdi, %rdi
lea addresses_normal_ht+0x1e72b, %rax
dec %rcx
movb $0x61, (%rax)
nop
nop
nop
xor $13404, %rdx
lea addresses_WT_ht+0x4003, %rsi
lea addresses_WC_ht+0x1ae03, %rdi
nop
xor %rbp, %rbp
mov $37, %rcx
rep movsl
...
nop
xor %rdi, %rdi
lea addresses_WT_ht+0x12a83, %rsi
...
nop
dec %rdi
lea addresses_D_ht+0x195e0, %r11
nop
add $39740, %rdx
movb $0x61, (%r11)
nop
dec %rdi
lea addresses_UC_ht+0x9aa3, %rcx
nop
add $63924, %rax
mov (%rcx), %ebp
and %rax, %rax
lea addresses_UC_ht+0x1d603, %rsi
nop
nop
xor $13324, %r11
...
{'OP': 'STOR', 'dst': {'same': False, 'type': 'addresses_NC', 'NT': False, 'AVXalign': True, 'size': 4, 'congruent': 4}}
...
{'OP': 'REPM', 'src': {'same': True, 'congruent': 8, 'type': 'addresses_WT_ht'}, 'dst': {'same': False, 'congruent': 9, 'type': 'addresses_WC_ht'}}
{'OP': 'REPM', 'src': {'same': False, 'congruent': 4, 'type': 'addresses_WT_ht'}, 'dst': {'same': True, 'congruent': 11, 'type': 'addresses_A_ht'}}
...
{'OP': 'STOR', 'dst': {'same': False, 'type': 'addresses_UC_ht', 'NT': True, 'AVXalign': False, 'size': 8, 'congruent': 10}}
{'00': 3000}
