...
push %rdx
push %rsi
lea addresses_UC_ht+0x39b4, %r13
nop
nop
nop
and %rax, %rax
...
nop
sub $14780, %rax
lea addresses_UC_ht+0x19d34, %rsi
nop
nop
nop
nop
...
nop
sub $41672, %r14
lea addresses_WC_ht+0x6bb4, %rsi
lea addresses_A_ht+0x1eef4, %rdi
clflush (%rdi)
nop
nop
nop
...
nop
cmp $55095, %rdx
lea addresses_WT_ht+0xe5b4, %rsi
...
nop
sub %rdi, %rdi
lea addresses_WC_ht+0x1bbf4, %rcx
nop
add %r14, %r14
mov (%rcx), %rbx
nop
dec %r14
lea addresses_A_ht+0x15db4, %rsi
lea addresses_normal_ht+0x1e5b4, %rdi
and $36800, %r14
mov $65, %rcx
rep movsb
nop
...
nop
sub $53571, %r14
lea addresses_WT_ht+0x15cb4, %r14
clflush (%r14)
nop
nop
inc %r13
...
nop
cmp %rdx, %rdx
lea addresses_normal_ht+0x3f08, %rdx
nop
nop
cmp %rdi, %rdi
movb (%rdx), %bl
...
nop
and $64460, %rsi
lea addresses_WT_ht+0xd2b4, %rsi
lea addresses_normal_ht+0x1b2b4, %rdi
nop
nop
nop
nop
...
nop
sub $35588, %rax
lea addresses_A_ht+0x16db4, %rbx
nop
nop
nop
nop
...
nop
inc %rbx
lea addresses_UC_ht+0xf29a, %rdi
nop
nop
nop
nop
...
nop
add %rdi, %rdi
lea addresses_D_ht+0x1abb4, %rdi
nop
nop
nop
nop
...
nop
and $44200, %rdx
lea addresses_normal_ht+0x2334, %rdx
nop
nop
nop
add %r14, %r14
...
{'src': {'type': 'addresses_WC', 'congruent': 11, 'same': False}, 'dst': {'type': 'addresses_P', 'congruent': 11, 'same': False}, 'OP': 'REPM'}
...
{'src': {'type': 'addresses_WC_ht', 'congruent': 9, 'same': True}, 'dst': {'type': 'addresses_A_ht', 'congruent': 5, 'same': False}, 'OP': 'REPM'}
{'src': {'type': 'addresses_WT_ht', 'congruent': 11, 'same': False}, 'dst': {'type': 'addresses_normal_ht', 'congruent': 4, 'same': False}, 'OP': 'REPM'}
...
{'src': {'type': 'addresses_normal_ht', 'same': True, 'size': 1, 'congruent': 2, 'NT': True, 'AVXalign': False}, 'OP': 'LOAD'}
