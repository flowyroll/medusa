...
nop
xor %r13, %r13
lea addresses_WC_ht+0xf098, %r14
nop
dec %rsi
vmovups (%r14), %ymm0
...
vpextrq $0, %xmm0, %r15
cmp $52107, %r13
lea addresses_WC_ht+0xb5f0, %rsi
lea addresses_WT_ht+0xb30, %rdi
nop
nop
dec %rax
mov $120, %rcx
...
nop
add $40935, %r9
lea addresses_UC_ht+0x13720, %rsi
lea addresses_normal_ht+0x3a70, %rdi
nop
nop
nop
nop
...
nop
inc %r9
lea addresses_UC_ht+0x150f0, %r9
nop
nop
nop
nop
...
nop
and $38431, %r15
lea addresses_WC_ht+0x1eb1c, %r15
nop
nop
nop
dec %r9
...
vmovups %ymm6, (%r15)
add $12927, %rdi
lea addresses_A_ht+0x4120, %rsi
lea addresses_normal_ht+0x12ff0, %rdi
clflush (%rdi)
nop
nop
nop
...
{'src': {'type': 'addresses_WC_ht', 'congruent': 11, 'same': False}, 'dst': {'type': 'addresses_WT_ht', 'congruent': 5, 'same': False}, 'OP': 'REPM'}
...
{'src': {'type': 'addresses_A_ht', 'congruent': 4, 'same': True}, 'dst': {'type': 'addresses_normal_ht', 'congruent': 9, 'same': False}, 'OP': 'REPM'}
{'00': 21829}
