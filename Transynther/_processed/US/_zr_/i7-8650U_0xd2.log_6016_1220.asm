...
push %rdx
push %rsi
lea addresses_WT_ht+0xbb73, %rsi
nop
nop
nop
nop
...
movups %xmm0, (%r9)
and %rdx, %rdx
lea addresses_D_ht+0x18728, %rdx
nop
sub $45764, %rax
...
nop
add %rdx, %rdx
lea addresses_WT_ht+0x1c000, %rsi
lea addresses_D_ht+0x1a400, %rdi
nop
nop
mfence
mov $98, %rcx
...
{'OP': 'REPM', 'src': {'type': 'addresses_WT_ht', 'congruent': 11, 'same': False}, 'dst': {'type': 'addresses_D_ht', 'congruent': 7, 'same': False}}
{'00': 6016}
