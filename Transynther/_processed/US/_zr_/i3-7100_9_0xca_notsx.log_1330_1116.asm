...
nop
cmp $50782, %r12
lea addresses_UC_ht+0x1918, %rax
clflush (%rax)
cmp %r14, %r14
...
nop
xor %r14, %r14
lea addresses_normal_ht+0x1d6e4, %rbx
nop
and $6283, %rsi
movw $0x6162, (%rbx)
nop
nop
inc %r14
lea addresses_D_ht+0x3f80, %rsi
lea addresses_A_ht+0xdf9e, %rdi
clflush (%rdi)
nop
nop
nop
...
nop
and %r14, %r14
lea addresses_normal_ht+0x1de6c, %r14
nop
nop
nop
nop
...
nop
mfence
lea addresses_WT_ht+0x12100, %rax
clflush (%rax)
and $62283, %rsi
and $0xffffffffffffffc0, %rax
vmovntdqa (%rax), %ymm5
...
vpextrq $1, %xmm5, %rcx
xor %r12, %r12
lea addresses_UC_ht+0x6bf8, %r11
add %r12, %r12
mov (%r11), %di
nop
nop
nop
sub $39457, %rbx
lea addresses_WC_ht+0x1b858, %rcx
nop
nop
nop
nop
...
{'OP': 'STOR', 'dst': {'same': False, 'congruent': 4, 'NT': False, 'type': 'addresses_UC_ht', 'size': 32, 'AVXalign': True}}
...
{'src': {'same': False, 'congruent': 5, 'NT': False, 'type': 'addresses_UC_ht', 'size': 2, 'AVXalign': True}, 'OP': 'LOAD'}
