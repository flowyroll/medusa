...
push %rdi
push %rsi
lea addresses_UC_ht+0x1b6ed, %rsi
clflush (%rsi)
nop
nop
nop
...
nop
inc %r13
lea addresses_A_ht+0x13eed, %r14
nop
nop
nop
xor %r15, %r15
...
nop
mfence
lea addresses_WT_ht+0x14086, %rsi
lea addresses_D_ht+0x2f3d, %rdi
nop
nop
nop
nop
...
nop
dec %rcx
lea addresses_UC_ht+0x75ad, %rsi
nop
nop
nop
xor $46265, %r15
...
nop
add %r8, %r8
lea addresses_A_ht+0x1056d, %rdi
nop
nop
nop
nop
...
nop
sub $2660, %r13
lea addresses_UC_ht+0xdeed, %rdi
nop
sub $2242, %r15
...
nop
and $50473, %r15
lea addresses_WC_ht+0x8eed, %rsi
nop
nop
inc %r8
mov (%rsi), %ecx
nop
cmp $42826, %rbx
lea addresses_D_ht+0x1782d, %r14
nop
nop
cmp %r13, %r13
mov $0x6162636465666768, %rbx
...
<gen_prepare_buffer>
{'OP': 'LOAD', 'src': {'same': False, 'NT': True, 'AVXalign': True, 'size': 8, 'type': 'addresses_UC_ht', 'congruent': 11}}
