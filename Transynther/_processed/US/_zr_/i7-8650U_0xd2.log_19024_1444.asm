...
nop
cmp %r10, %r10
lea addresses_normal_ht+0x4787, %rcx
cmp $27579, %r15
mov (%rcx), %si
dec %rax
lea addresses_UC_ht+0x4d87, %rsi
lea addresses_normal_ht+0x161c7, %rdi
nop
nop
nop
nop
...
lea addresses_A_ht+0x17647, %rdi
nop
add %rbx, %rbx
mov $62, %rcx
rep movsq
...
nop
and %r10, %r10
lea addresses_normal_ht+0x19c87, %rsi
lea addresses_WT_ht+0xde87, %rdi
nop
nop
cmp $20514, %rax
mov $71, %rcx
...
{'OP': 'STOR', 'dst': {'type': 'addresses_WT', 'size': 8, 'AVXalign': True, 'NT': False, 'congruent': 9, 'same': False}}
[Faulty Load]
