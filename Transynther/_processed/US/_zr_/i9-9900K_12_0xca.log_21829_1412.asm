...
push %rdi
push %rsi
lea addresses_WT_ht+0xa745, %r15
clflush (%r15)
nop
nop
nop
...
nop
and $26071, %rax
lea addresses_WC_ht+0x1180d, %r12
nop
nop
nop
add $61921, %r14
...
nop
and $13117, %rax
lea addresses_WT_ht+0x13f8d, %rax
clflush (%rax)
nop
nop
nop
...
nop
cmp %r14, %r14
lea addresses_A_ht+0x173ed, %rsi
lea addresses_A_ht+0xc8ac, %rdi
nop
nop
dec %r12
mov $104, %rcx
...
nop
xor %rdi, %rdi
lea addresses_UC_ht+0x9e0d, %rsi
lea addresses_WC_ht+0xe80d, %rdi
nop
nop
nop
nop
...
nop
inc %rsi
lea addresses_normal_ht+0x610d, %r15
nop
nop
nop
nop
...
nop
add %rdi, %rdi
lea addresses_D_ht+0xc78d, %rdi
cmp %r12, %r12
movw $0x6162, (%rdi)
nop
nop
sub %rcx, %rcx
lea addresses_WC_ht+0x8b68, %r11
nop
nop
nop
nop
...
nop
xor %rsi, %rsi
lea addresses_UC_ht+0xd44d, %rdi
nop
nop
nop
nop
...
{'OP': 'LOAD', 'src': {'size': 8, 'NT': True, 'type': 'addresses_WT_ht', 'same': False, 'AVXalign': False, 'congruent': 7}}
{'OP': 'REPM', 'src': {'same': False, 'type': 'addresses_A_ht', 'congruent': 5}, 'dst': {'same': True, 'type': 'addresses_A_ht', 'congruent': 0}}
{'OP': 'REPM', 'src': {'same': False, 'type': 'addresses_UC_ht', 'congruent': 7}, 'dst': {'same': True, 'type': 'addresses_WC_ht', 'congruent': 11}}
{'OP': 'LOAD', 'src': {'size': 2, 'NT': False, 'type': 'addresses_normal_ht', 'same': False, 'AVXalign': False, 'congruent': 8}}
{'OP': 'STOR', 'dst': {'size': 2, 'NT': True, 'type': 'addresses_D_ht', 'same': False, 'AVXalign': False, 'congruent': 3}}
