...
nop
sub $23536, %r8
lea addresses_A_ht+0x1b256, %rcx
nop
cmp $56112, %rdi
...
nop
cmp %rdx, %rdx
lea addresses_WC_ht+0x702d, %rsi
lea addresses_UC_ht+0x960d, %rdi
nop
and %r13, %r13
mov $79, %rcx
rep movsq
