...
push %rdx
push %rsi
lea addresses_WT_ht+0x19f49, %rsi
lea addresses_WT_ht+0x9481, %rdi
clflush (%rdi)
nop
sub %rbp, %rbp
mov $3, %rcx
...
mov (%r9), %bp
inc %r9
lea addresses_UC_ht+0xd841, %rbp
nop
nop
and $32586, %rdx
movb (%rbp), %r15b
cmp %r9, %r9
lea addresses_WT_ht+0x166c1, %rbp
sub $51448, %rdx
mov (%rbp), %esi
nop
nop
...
nop
sub $31590, %rsi
lea addresses_UC_ht+0x1a271, %rcx
nop
sub %rbp, %rbp
movb $0x61, (%rcx)
nop
cmp %rdi, %rdi
lea addresses_A_ht+0x1dcb7, %rsi
nop
xor %r9, %r9
mov (%rsi), %edi
nop
...
nop
xor $38342, %rdx
lea addresses_UC_ht+0x16891, %rsi
nop
add %rdx, %rdx
movb $0x61, (%rsi)
nop
...
nop
cmp %rdx, %rdx
lea addresses_A_ht+0x1a641, %rsi
nop
nop
nop
nop
...
nop
and %rsi, %rsi
lea addresses_WT_ht+0x7241, %rsi
lea addresses_A_ht+0x13c41, %rdi
clflush (%rdi)
nop
nop
nop
...
rep movsq
cmp %rdi, %rdi
lea addresses_normal_ht+0x13a41, %r9
nop
nop
nop
inc %rcx
...
<gen_prepare_buffer>
{'OP': 'REPM', 'src': {'same': False, 'type': 'addresses_WT_ht', 'congruent': 2}, 'dst': {'same': False, 'type': 'addresses_WT_ht', 'congruent': 5}}
...
{'OP': 'REPM', 'src': {'same': False, 'type': 'addresses_WT_ht', 'congruent': 11}, 'dst': {'same': True, 'type': 'addresses_A_ht', 'congruent': 7}}
