...
push %rdx
push %rsi
lea addresses_D_ht+0x4707, %rsi
lea addresses_D_ht+0x884a, %rdi
nop
nop
nop
dec %r8
...
nop
xor $5351, %rdx
lea addresses_WT_ht+0x1d643, %rax
nop
nop
add %r13, %r13
mov (%rax), %si
...
nop
xor $59366, %rcx
lea addresses_WC_ht+0xa7c7, %r13
clflush (%r13)
nop
nop
nop
...
movq %rdi, (%r13)
cmp %rsi, %rsi
lea addresses_WC_ht+0xfdba, %rdx
nop
nop
nop
nop
...
nop
xor $53948, %r8
lea addresses_A_ht+0x1abcf, %rsi
lea addresses_UC_ht+0x3b12, %rdi
nop
sub %r15, %r15
mov $20, %rcx
rep movsl
...
nop
inc %rdx
lea addresses_WT_ht+0x1c1c7, %rsi
lea addresses_A_ht+0x17c7, %rdi
and $35997, %r8
mov $57, %rcx
rep movsl
nop
