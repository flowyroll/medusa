...
nop
sub %rbp, %rbp
lea addresses_WC_ht+0x1a677, %rsi
lea addresses_WC_ht+0x3cd7, %rdi
nop
and %r14, %r14
mov $30, %rcx
rep movsq
cmp $46621, %rbp
lea addresses_UC_ht+0xa077, %r14
nop
nop
nop
nop
...
nop
xor $55160, %rax
lea addresses_A_ht+0x10507, %rdi
nop
nop
nop
nop
...
movq %rsi, (%rdi)
add $7914, %rax
lea addresses_WT_ht+0x1b877, %rsi
lea addresses_D_ht+0x10db7, %rdi
nop
nop
nop
xor %r14, %r14
...
nop
dec %rsi
lea addresses_D_ht+0x1d987, %rsi
...
nop
xor %rax, %rax
lea addresses_WT_ht+0x1e77, %rbx
sub %rdi, %rdi
mov (%rbx), %r14d
nop
nop
...
{'OP': 'REPM', 'src': {'type': 'addresses_WC_ht', 'congruent': 6, 'same': True}, 'dst': {'type': 'addresses_WC_ht', 'congruent': 5, 'same': False}}
{'OP': 'STOR', 'dst': {'type': 'addresses_UC_ht', 'AVXalign': False, 'congruent': 7, 'size': 16, 'same': False, 'NT': True}}
{'OP': 'REPM', 'src': {'type': 'addresses_A_ht', 'congruent': 2, 'same': False}, 'dst': {'type': 'addresses_D_ht', 'congruent': 5, 'same': False}}
{'OP': 'STOR', 'dst': {'type': 'addresses_D_ht', 'AVXalign': True, 'congruent': 9, 'size': 1, 'same': False, 'NT': False}}
...
{'OP': 'STOR', 'dst': {'type': 'addresses_WT_ht', 'AVXalign': False, 'congruent': 10, 'size': 8, 'same': True, 'NT': False}}
