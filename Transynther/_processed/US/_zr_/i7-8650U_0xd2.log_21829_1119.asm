...
push %rdi
push %rsi
lea addresses_UC_ht+0x19090, %rax
nop
add $60345, %r10
movb $0x61, (%rax)
nop
...
nop
add $4396, %r14
lea addresses_A_ht+0x1e4d0, %rax
add $51328, %rbx
movl $0x61626364, (%rax)
nop
nop
nop
sub $15437, %r14
lea addresses_WT_ht+0x10230, %r10
cmp %r8, %r8
...
nop
inc %rbx
lea addresses_D_ht+0x1b630, %r10
nop
nop
nop
sub %r9, %r9
...
nop
cmp $12235, %r14
lea addresses_normal_ht+0x11a0, %rsi
lea addresses_WC_ht+0x12ef0, %rdi
nop
nop
nop
add %rbp, %rbp
...
nop
cmp $53970, %r8
lea addresses_WC_ht+0x1add0, %rsi
...
nop
cmp $28205, %rax
lea addresses_UC_ht+0x133f9, %rsi
lea addresses_WC_ht+0xba30, %rdi
dec %r14
mov $6, %rcx
rep movsq
nop
nop
sub %r9, %r9
lea addresses_UC_ht+0x14364, %r10
nop
nop
nop
nop
