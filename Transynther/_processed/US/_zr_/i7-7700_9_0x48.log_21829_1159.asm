...
nop
sub $52437, %rsi
lea addresses_WT_ht+0x1ed19, %rdx
nop
nop
nop
dec %r14
...
nop
xor $33134, %rbx
lea addresses_UC_ht+0x137c3, %rbx
nop
nop
nop
add $47404, %rdx
...
nop
inc %rdx
lea addresses_A_ht+0x1b049, %rsi
lea addresses_WC_ht+0xa259, %rdi
nop
and $29643, %r11
mov $18, %rcx
rep movsb
...
nop
cmp %rbx, %rbx
lea addresses_WC_ht+0xca19, %r14
nop
nop
sub %r11, %r11
movl $0x61626364, (%r14)
nop
add %r14, %r14
lea addresses_normal_ht+0x1f99, %r11
and $43982, %rbx
...
lea addresses_WC_ht+0x5219, %rdi
clflush (%rsi)
nop
nop
nop
...
nop
sub %r11, %r11
lea addresses_normal_ht+0x5915, %r8
nop
nop
nop
and $47966, %rsi
...
// Store
lea addresses_normal+0x6b95, %r8
add $37004, %r15
...
// Store
lea addresses_RW+0x3cc5, %rbp
cmp %rsi, %rsi
movw $0x5152, (%rbp)
xor $55860, %rbp

// Faulty Load
lea addresses_US+0x19c19, %r13
nop
nop
nop
nop
...
{'OP': 'STOR', 'dst': {'type': 'addresses_normal', 'AVXalign': False, 'congruent': 2, 'size': 32, 'same': False, 'NT': True}}
...
{'OP': 'STOR', 'dst': {'type': 'addresses_WC_ht', 'AVXalign': False, 'congruent': 6, 'size': 4, 'same': False, 'NT': True}}
