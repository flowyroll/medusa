...
nop
xor %rdx, %rdx
lea addresses_UC_ht+0x17909, %rsi
lea addresses_A_ht+0x1b83d, %rdi
nop
nop
nop
nop
...
nop
sub $40228, %rdx
lea addresses_WT_ht+0x12e3d, %rax
nop
nop
nop
nop
...
nop
add $7122, %rbp
lea addresses_WC_ht+0xeebd, %rsi
lea addresses_A_ht+0x1903d, %rdi
clflush (%rdi)
nop
nop
add $56925, %r12
