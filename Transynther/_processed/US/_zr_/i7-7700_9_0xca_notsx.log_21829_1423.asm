...
push %rdx
push %rsi
lea addresses_UC_ht+0x5cd4, %rsi
...
nop
and $8715, %rcx
lea addresses_normal_ht+0x7f12, %rbx
nop
nop
nop
cmp $3437, %rsi
...
nop
sub $21002, %rcx
lea addresses_WT_ht+0x17284, %rbx
nop
nop
nop
nop
...
{'src': {'NT': False, 'AVXalign': False, 'size': 16, 'congruent': 2, 'same': False, 'type': 'addresses_RW'}, 'OP': 'LOAD'}
