...
nop
cmp $46215, %r8
lea addresses_A_ht+0x16335, %rsi
add $22129, %rcx
movups (%rsi), %xmm7
vpextrq $0, %xmm7, %rbp
nop
...
nop
inc %r11
lea addresses_UC_ht+0x15ecd, %r11
and %rdi, %rdi
movb $0x61, (%r11)
sub %rcx, %rcx
lea addresses_WC_ht+0x16c13, %rsi
lea addresses_D_ht+0xa3b5, %rdi
nop
nop
and %r12, %r12
mov $98, %rcx
rep movsb
cmp %rbp, %rbp
lea addresses_WC_ht+0x5e35, %rdi
inc %r8
...
{'OP': 'STOR', 'dst': {'congruent': 4, 'AVXalign': False, 'same': False, 'size': 4, 'NT': True, 'type': 'addresses_P'}}
...
{'src': {'congruent': 0, 'same': False, 'type': 'addresses_WC_ht'}, 'OP': 'REPM', 'dst': {'congruent': 10, 'same': True, 'type': 'addresses_D_ht'}}
