...
push %rdi
push %rsi
lea addresses_D_ht+0x10192, %rax
nop
nop
nop
nop
...
nop
and %r8, %r8
lea addresses_D_ht+0x9dd2, %rsi
lea addresses_D_ht+0x4212, %rdi
nop
xor %r15, %r15
mov $5, %rcx
rep movsl
...
nop
sub $34997, %rdi
lea addresses_normal_ht+0x2992, %rcx
nop
nop
nop
nop
...
nop
inc %r15
lea addresses_D_ht+0x5792, %rsi
lea addresses_WC_ht+0xa218, %rdi
clflush (%rdi)
nop
nop
sub $25827, %r10
...
nop
dec %rsi
lea addresses_UC_ht+0x1c792, %rsi
nop
nop
nop
add $43779, %r15
...
nop
xor %r8, %r8
lea addresses_WT_ht+0xc0d2, %rsi
lea addresses_A_ht+0x3530, %rdi
nop
inc %rax
mov $11, %rcx
rep movsl
nop
add $28650, %rax
lea addresses_WT_ht+0x29be, %rsi
lea addresses_WT_ht+0xb792, %rdi
clflush (%rdi)
cmp $55623, %rax
mov $97, %rcx
rep movsb
xor %rbp, %rbp
lea addresses_WC_ht+0x8312, %r10
nop
nop
nop
nop
...
nop
dec %r8
lea addresses_UC_ht+0x18be8, %rsi
lea addresses_normal_ht+0x18ae6, %rdi
nop
nop
nop
xor %rbp, %rbp
...
nop
dec %r10
lea addresses_UC_ht+0x19d46, %r8
nop
nop
nop
cmp $31049, %r10
...
nop
inc %rcx
lea addresses_UC_ht+0x1732e, %rbp
cmp %r8, %r8
movb $0x61, (%rbp)
cmp $3376, %r8
lea addresses_UC_ht+0x33bb, %r15
cmp %r8, %r8
movups (%r15), %xmm7
vpextrq $0, %xmm7, %r10
nop
...
{'OP': 'STOR', 'dst': {'same': False, 'type': 'addresses_normal_ht', 'NT': False, 'AVXalign': True, 'size': 16, 'congruent': 8}}
...
{'OP': 'REPM', 'src': {'same': False, 'congruent': 5, 'type': 'addresses_WT_ht'}, 'dst': {'same': False, 'congruent': 0, 'type': 'addresses_A_ht'}}
...
{'OP': 'STOR', 'dst': {'same': False, 'type': 'addresses_UC_ht', 'NT': False, 'AVXalign': True, 'size': 16, 'congruent': 2}}
