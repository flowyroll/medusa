...
lea addresses_D_ht+0x188b2, %rdi
nop
nop
nop
nop
...
rep movsq
and %rax, %rax
lea addresses_normal_ht+0x5832, %rcx
nop
nop
nop
and %rax, %rax
...
nop
cmp $23329, %rdi
lea addresses_D_ht+0x115b2, %rsi
lea addresses_D_ht+0x95f2, %rdi
nop
dec %rbp
mov $87, %rcx
rep movsb
...
nop
add %rbp, %rbp
lea addresses_WT_ht+0x2f32, %rdi
nop
nop
nop
and $5156, %rcx
...
nop
sub %rdi, %rdi
lea addresses_WT_ht+0x140b2, %rbp
nop
nop
nop
nop
...
nop
xor %rbp, %rbp
lea addresses_A_ht+0x1e9e2, %rsi
nop
nop
nop
nop
...
nop
dec %r10
lea addresses_A_ht+0x14d70, %rax
nop
sub $39782, %rcx
mov $0x6162636465666768, %rdi
movq %rdi, (%rax)
xor $56602, %rdi
lea addresses_D_ht+0x12a32, %rsi
lea addresses_normal_ht+0xe732, %rdi
nop
nop
nop
nop
...
nop
cmp $33014, %rbp
lea addresses_normal_ht+0x692, %r10
nop
nop
add %rsi, %rsi
vmovups (%r10), %ymm5
...
nop
xor %r13, %r13
lea addresses_normal_ht+0xe7b2, %rsi
lea addresses_WT_ht+0x16866, %rdi
nop
nop
nop
nop
...
// Store
lea addresses_normal+0x1bbe6, %r12
nop
nop
nop
and $12193, %rbx
...
<gen_prepare_buffer>
{'src': {'congruent': 1, 'same': False, 'type': 'addresses_WT_ht'}, 'dst': {'congruent': 7, 'same': False, 'type': 'addresses_D_ht'}, 'OP': 'REPM'}
{'dst': {'NT': False, 'AVXalign': False, 'size': 8, 'congruent': 8, 'same': False, 'type': 'addresses_normal_ht'}, 'OP': 'STOR'}
{'src': {'congruent': 7, 'same': False, 'type': 'addresses_D_ht'}, 'dst': {'congruent': 5, 'same': False, 'type': 'addresses_D_ht'}, 'OP': 'REPM'}
{'src': {'NT': False, 'AVXalign': True, 'size': 2, 'congruent': 11, 'same': False, 'type': 'addresses_A_ht'}, 'OP': 'LOAD'}
...
{'src': {'NT': True, 'AVXalign': True, 'size': 8, 'congruent': 1, 'same': False, 'type': 'addresses_A_ht'}, 'OP': 'LOAD'}
{'src': {'NT': False, 'AVXalign': False, 'size': 32, 'congruent': 5, 'same': False, 'type': 'addresses_normal_ht'}, 'OP': 'LOAD'}
{'src': {'congruent': 4, 'same': False, 'type': 'addresses_normal_ht'}, 'dst': {'congruent': 1, 'same': False, 'type': 'addresses_WT_ht'}, 'OP': 'REPM'}
