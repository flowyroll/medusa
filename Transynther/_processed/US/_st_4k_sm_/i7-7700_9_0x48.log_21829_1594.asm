...
push %rdx
push %rsi
lea addresses_D_ht+0x15f52, %r11
nop
nop
nop
and %rax, %rax
...
movups %xmm7, (%r11)
and %rdx, %rdx
lea addresses_WT_ht+0x15f88, %r10
nop
nop
nop
nop
...
movb $0x61, (%r10)
sub $56251, %r15
lea addresses_WC_ht+0x1d6d2, %rdx
nop
cmp $58457, %r10
movb $0x61, (%rdx)
nop
...
nop
xor $1299, %rsi
lea addresses_normal_ht+0x16352, %r8
clflush (%r8)
nop
nop
nop
...
nop
and %rsi, %rsi
lea addresses_D_ht+0x195d2, %r10
nop
nop
nop
dec %r8
...
nop
xor %r8, %r8
lea addresses_UC_ht+0x706a, %r11
xor $20132, %rax
mov (%r11), %r10w
nop
nop
add $54058, %r10
lea addresses_UC_ht+0x1320e, %r15
nop
nop
nop
xor %rdx, %rdx
...
nop
and %r8, %r8
lea addresses_A_ht+0xe6cd, %rsi
lea addresses_WT_ht+0x1db52, %rdi
nop
nop
nop
nop
...
nop
sub $51355, %r15
lea addresses_WC_ht+0x10852, %rdx
sub $25550, %r10
vmovups (%rdx), %ymm3
vextracti128 $0, %ymm3, %xmm3
vpextrq $0, %xmm3, %rcx
and %r10, %r10
lea addresses_normal_ht+0xccd2, %r15
clflush (%r15)
nop
nop
nop
...
nop
xor $21596, %rcx
lea addresses_UC_ht+0x5c72, %rax
nop
xor %r10, %r10
mov (%rax), %edx
nop
and %rsi, %rsi
lea addresses_D_ht+0x1ef52, %r11
cmp $49426, %r10
...
nop
xor $64840, %rdx
lea addresses_WT_ht+0x10552, %rsi
lea addresses_WC_ht+0x11b52, %rdi
clflush (%rdi)
inc %r15
mov $106, %rcx
rep movsq
...
{'OP': 'STOR', 'dst': {'type': 'addresses_PSE', 'AVXalign': False, 'congruent': 7, 'size': 1, 'same': False, 'NT': True}}
...
<gen_prepare_buffer>
{'OP': 'STOR', 'dst': {'type': 'addresses_D_ht', 'AVXalign': False, 'congruent': 10, 'size': 16, 'same': True, 'NT': False}}
...
{'OP': 'REPM', 'src': {'type': 'addresses_A_ht', 'congruent': 0, 'same': False}, 'dst': {'type': 'addresses_WT_ht', 'congruent': 11, 'same': True}}
