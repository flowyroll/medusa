...
push %rbx
push %rsi
lea addresses_UC_ht+0x148bd, %r9
inc %r13
movw $0x6162, (%r9)
cmp %r12, %r12
lea addresses_normal_ht+0x1207d, %rbx
nop
nop
nop
nop
...
<gen_prepare_buffer>
{'OP': 'STOR', 'dst': {'type': 'addresses_UC_ht', 'size': 2, 'AVXalign': False, 'NT': False, 'congruent': 5, 'same': True}}
{'OP': 'LOAD', 'src': {'type': 'addresses_normal_ht', 'size': 2, 'AVXalign': True, 'NT': False, 'congruent': 11, 'same': False}}
{'58': 2620}
