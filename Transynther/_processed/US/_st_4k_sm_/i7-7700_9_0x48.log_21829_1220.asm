...
push %rdx
push %rsi
lea addresses_WC_ht+0x13f50, %rbp
nop
nop
nop
nop
...
nop
cmp $51753, %r12
lea addresses_WT_ht+0x3a90, %rsi
lea addresses_WT_ht+0x12150, %rdi
nop
nop
nop
add %r12, %r12
...
nop
add %rdi, %rdi
lea addresses_normal_ht+0xc310, %rsi
lea addresses_WT_ht+0xe710, %rdi
nop
nop
nop
nop
...
nop
xor %rdi, %rdi
lea addresses_D_ht+0x171a0, %r14
clflush (%r14)
nop
nop
nop
...
nop
sub %r11, %r11
lea addresses_D_ht+0x14150, %r14
nop
cmp %rcx, %rcx
...
nop
xor %rdx, %rdx
lea addresses_WT_ht+0x10490, %rsi
lea addresses_D_ht+0x4250, %rdi
nop
nop
add $42792, %r11
mov $121, %rcx
...
nop
cmp %rsi, %rsi
lea addresses_D_ht+0x1df50, %rsi
nop
nop
sub %r12, %r12
movb (%rsi), %cl
...
nop
inc %rdx
lea addresses_A_ht+0x1d050, %rsi
nop
dec %r12
movb $0x61, (%rsi)
nop
...
// Load
lea addresses_normal+0x15c6e, %r8
sub $41608, %rsi
mov (%r8), %rdx
nop
nop
...
{'OP': 'LOAD', 'src': {'type': 'addresses_US', 'AVXalign': False, 'congruent': 3, 'size': 8, 'same': False, 'NT': False}}
{'OP': 'STOR', 'dst': {'type': 'addresses_WC', 'AVXalign': False, 'congruent': 11, 'size': 4, 'same': False, 'NT': True}}
[Faulty Load]
...
{'OP': 'LOAD', 'src': {'type': 'addresses_D_ht', 'AVXalign': False, 'congruent': 3, 'size': 4, 'same': True, 'NT': True}}
{'OP': 'REPM', 'src': {'type': 'addresses_UC_ht', 'congruent': 3, 'same': True}, 'dst': {'type': 'addresses_A_ht', 'congruent': 11, 'same': False}}
{'OP': 'LOAD', 'src': {'type': 'addresses_A_ht', 'AVXalign': False, 'congruent': 3, 'size': 4, 'same': False, 'NT': False}}
{'OP': 'LOAD', 'src': {'type': 'addresses_D_ht', 'AVXalign': False, 'congruent': 8, 'size': 32, 'same': False, 'NT': True}}
...
{'OP': 'STOR', 'dst': {'type': 'addresses_A_ht', 'AVXalign': True, 'congruent': 8, 'size': 1, 'same': False, 'NT': False}}
