...
push %rdx
push %rsi
lea addresses_WC_ht+0x14c8d, %r11
add %rbx, %rbx
...
nop
and $3880, %rcx
lea addresses_normal_ht+0x1e4fb, %rdx
nop
nop
nop
nop
...
nop
cmp %r11, %r11
lea addresses_A_ht+0x1ac8d, %rcx
dec %r8
mov (%rcx), %dx
nop
nop
nop
add $47212, %rcx
lea addresses_normal_ht+0xecd, %rsi
lea addresses_D_ht+0x114f1, %rdi
nop
nop
nop
nop
