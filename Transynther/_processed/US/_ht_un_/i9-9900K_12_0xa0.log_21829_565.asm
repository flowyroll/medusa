...
push %rdx
push %rsi
lea addresses_WT_ht+0x14422, %rsi
lea addresses_UC_ht+0x136a0, %rdi
clflush (%rsi)
nop
nop
nop
...
nop
and %rsi, %rsi
lea addresses_WC_ht+0xb100, %r13
nop
nop
nop
xor $11928, %r9
...
nop
cmp $24702, %r13
lea addresses_D_ht+0x11e80, %rcx
nop
nop
nop
nop
...
nop
xor %rdx, %rdx
lea addresses_WT_ht+0x5d00, %rcx
nop
nop
add %rdx, %rdx
mov (%rcx), %di
...
// Store
lea addresses_normal+0x10b60, %r9
nop
nop
nop
nop
