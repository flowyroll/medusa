...
push %rdx
push %rsi
lea addresses_A_ht+0x11161, %rsi
lea addresses_UC_ht+0x124d1, %rdi
clflush (%rsi)
nop
nop
add %r14, %r14
...
nop
cmp %r14, %r14
lea addresses_UC_ht+0x1da61, %rsi
lea addresses_WT_ht+0x139a1, %rdi
nop
nop
nop
nop
...
nop
xor $32751, %r9
lea addresses_WC_ht+0x3361, %rsi
lea addresses_WC_ht+0x19571, %rdi
clflush (%rsi)
nop
nop
and %r9, %r9
...
nop
cmp %r14, %r14
lea addresses_WT_ht+0x17347, %rcx
sub $26437, %rsi
movw $0x6162, (%rcx)
nop
nop
xor %rdx, %rdx
lea addresses_UC_ht+0x156e1, %rsi
nop
nop
nop
nop
...
// Store
lea addresses_normal+0xef61, %rdx
nop
nop
nop
and $34638, %r11
...
{'dst': {'NT': False, 'AVXalign': False, 'size': 2, 'congruent': 9, 'same': False, 'type': 'addresses_P'}, 'OP': 'STOR'}
...
{'dst': {'NT': False, 'AVXalign': True, 'size': 1, 'congruent': 4, 'same': False, 'type': 'addresses_A'}, 'OP': 'STOR'}
{'dst': {'NT': False, 'AVXalign': False, 'size': 16, 'congruent': 10, 'same': False, 'type': 'addresses_normal'}, 'OP': 'STOR'}
{'dst': {'NT': True, 'AVXalign': False, 'size': 2, 'congruent': 7, 'same': False, 'type': 'addresses_A'}, 'OP': 'STOR'}
[Faulty Load]
...
{'src': {'congruent': 11, 'same': False, 'type': 'addresses_WC_ht'}, 'dst': {'congruent': 1, 'same': False, 'type': 'addresses_WC_ht'}, 'OP': 'REPM'}
